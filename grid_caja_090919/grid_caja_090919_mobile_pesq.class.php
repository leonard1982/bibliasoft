...
class grid_caja_090919_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_caja_090919_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_caja_090919_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_caja_090919_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_caja_090919/grid_caja_090919_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_caja_090919_ajax_search.js"></script>
 <script type="text/javascript" src="grid_caja_090919_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_caja_090919_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_caja_090919']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_caja_090919']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_caja_090919']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_caja_090919']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_caja_090919']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_caja_090919", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_cond']; 
          $documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['documento']; 
          $documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['documento_cond']; 
          $banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['banco']; 
          $banco_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['banco_cond']; 
          $detalle = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['detalle']; 
          $detalle_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['detalle_cond']; 
          $resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['resolucion']; 
          $resolucion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['resolucion_cond']; 
          $creado_inicio_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_dia']; 
          $creado_inicio_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_mes']; 
          $creado_inicio_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_ano']; 
          $creado_inicio_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_hor']; 
          $creado_inicio_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_min']; 
          $creado_inicio_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_seg']; 
          $creado_inicio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_cond']; 
          $creado_fin_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_dia']; 
          $creado_fin_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_mes']; 
          $creado_fin_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_ano']; 
          $creado_fin_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_hor']; 
          $creado_fin_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_min']; 
          $creado_fin_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_seg']; 
          $creado_fin_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['cliente_cond']; 
          $ie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['ie']; 
          $ie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['ie_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['NM_operador']; 
      } 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_documento"  <?php echo $str_hide_documento?>><?php
      ...
      $documento_look = substr($this->Db->qstr($documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct documento from (SELECT      idcaja,     fecha,     jornada,     detalle,     nota,     cantidad,     documento,     cierredia,     totaldia,     arqueo,     saldo, resolucion, idrc, idrp,     if(cantidad<0,'Egreso','Ingreso') as ie,     creado as creado,     creado as creado_inicio,     creado as creado_fin,     banco,     coalesce(                      if             (                 idrp is not null or idrp > 0,                 (select rp.client from pagos rp where rp.idpago=idrp),                 if                 (                     idrc is not null or idrp > 0,                     (select rc.cliente from recibocaja rc where rc.idrecibo=idrc),                     if                     (                         nota='VENTA',                         (select v.idcli from facturaven v where v.resolucion=resolucion and v.numfacven=documento),                         if                         (                             nota='COMPRA',                             (select c.idprov from facturacom c where c.idfaccom=documento),                             '1'                         )                     )                 )              )      ,usuario) as cliente FROM      caja  ) nm_sel_esp where documento = '$documento_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['banco'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['banco'][] = trim($rs->fields[0]);
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_detalle"  <?php echo $str_hide_detalle?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'][] = "BASE";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'][] = "R. CAJA";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'][] = "FAC. CONTADO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'][] = "PAGO FAC";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'][] = "OTROS PAGOS";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'][] = "CUADRE";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'][] = "PED. CONTADO";
 ?>
<?php if (!isset($detalle)) {$detalle = explode(";", $detalle);} ?>
 <SELECT class="scFilterObjectEven" id="SC_detalle" name="detalle[]"  size="7" multiple>
 <OPTION value="BASE##@@BASE" <?php if (in_array("BASE", $detalle)) { echo " selected" ;} ?>>BASE</option>
 <OPTION value="R. CAJA##@@RECIBO DE CAJA" <?php if (in_array("R. CAJA", $detalle)) { echo " selected" ;} ?>>RECIBO DE CAJA</option>
 <OPTION value="FAC. CONTADO##@@FACTURA CONTADO" <?php if (in_array("FAC. CONTADO", $detalle)) { echo " selected" ;} ?>>FACTURA CONTADO</option>
 <OPTION value="PAGO FAC##@@PAGO DE FACTURA" <?php if (in_array("PAGO FAC", $detalle)) { echo " selected" ;} ?>>PAGO DE FACTURA</option>
 <OPTION value="OTROS PAGOS##@@OTROS PAGOS" <?php if (in_array("OTROS PAGOS", $detalle)) { echo " selected" ;} ?>>OTROS PAGOS</option>
 <OPTION value="CUADRE##@@CUADRE" <?php if (in_array("CUADRE", $detalle)) { echo " selected" ;} ?>>CUADRE</option>
 <OPTION value="PED. CONTADO##@@PED. CONTADO" <?php if (in_array("PED. CONTADO", $detalle)) { echo " selected" ;} ?>>PED. CONTADO</option>
 </SELECT>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_resolucion_cond" name="resolucion_cond" onChange="nm_campos_between(document.getElementById('id_vis_resolucion'), this, 'resolucion')">
       <OPTION value="eq" <?php if ("eq" == $resolucion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_resolucion"  <?php echo $str_hide_resolucion?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['resolucion'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['resolucion'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_resolucion">
      <SELECT class="scFilterObjectOdd" id="SC_resolucion" name="resolucion[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ie"  <?php echo $str_hide_ie?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['ie'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['ie'][] = "Ingreso";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['ie'][] = "Egreso";
 ?>
...
?>
<?php
   if (is_file("grid_caja_090919_help.txt"))
   {
      $Arq_WebHelp = file("grid_caja_090919_help.txt"); 
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['sc_modal'])
       {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'detalle[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'resolucion[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
 ...
 {
    $('#SC_creado_fin_dia').bind('change', function() {sc_grid_caja_090919_valida_dia(this)});
    $('#SC_creado_fin_hor').bind('change', function() {sc_grid_caja_090919_valida_hora(this)});
    $('#SC_creado_fin_mes').bind('change', function() {sc_grid_caja_090919_valida_mes(this)});
    $('#SC_creado_fin_min').bind('change', function() {sc_grid_caja_090919_valida_min(this)});
    $('#SC_creado_inicio_dia').bind('change', function() {sc_grid_caja_090919_valida_dia(this)});
    $('#SC_creado_inicio_hor').bind('change', function() {sc_grid_caja_090919_valida_hora(this)});
    $('#SC_creado_inicio_mes').bind('change', function() {sc_grid_caja_090919_valida_mes(this)});
    $('#SC_creado_inicio_min').bind('change', function() {sc_grid_caja_090919_valida_min(this)});
    $('#SC_fecha_dia').bind('change', function() {sc_grid_caja_090919_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_caja_090919_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_caja_090919_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_caja_090919_valida_mes(this)});
 }
 function sc_grid_caja_090919_valida_dia(obj)
 {
 ...
 function sc_grid_caja_090919_valida_mes(obj)
 {
 ...
 function sc_grid_caja_090919_valida_hora(obj)
 {
 ...
 function sc_grid_caja_090919_valida_min(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv2/grid_caja_090919";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (is_array($banco)) {
          foreach ($banco as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['banco'])) {
      ...
      if (is_array($detalle)) {
          foreach ($detalle as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['detalle'])) {
      ...
      if (is_array($resolucion)) {
          foreach ($resolucion as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['resolucion'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['psq_check_ret']['ie'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Ie : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['documento'] = $documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['documento_cond'] = $documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['banco'] = $banco; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['banco_cond'] = $banco_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['detalle'] = $detalle; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['detalle_cond'] = $detalle_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['resolucion'] = $resolucion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['resolucion_cond'] = $resolucion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_dia'] = $creado_inicio_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_mes'] = $creado_inicio_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_ano'] = $creado_inicio_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_hor'] = $creado_inicio_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_min'] = $creado_inicio_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_seg'] = $creado_inicio_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_cond'] = $creado_inicio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_dia'] = $creado_fin_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_mes'] = $creado_fin_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_ano'] = $creado_fin_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_hor'] = $creado_fin_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_min'] = $creado_fin_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_seg'] = $creado_fin_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_cond'] = $creado_fin_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['ie'] = $ie; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['ie_cond'] = $ie_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($documento != '') {
      ...
      $this->cmp_formatado['banco'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['banco'];
      $this->cmp_formatado['banco_input_2'] = $banco_input_2;
      $this->cmp_formatado['detalle'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['detalle'];
      $this->cmp_formatado['detalle_input_2'] = $detalle_input_2;
      $this->cmp_formatado['resolucion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['resolucion'];
    ...
    if ($cliente != '') {
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['fecha_input_2'] = $val[1];
      ...
      if (is_array($banco) && count($banco) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label['banco'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (is_array($detalle) && count($detalle) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label['detalle'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if (is_array($resolucion) && count($resolucion) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $nmgp_tab_label['resolucion'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      ...
      if ($creado_inicio_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio'] = $val[0];
          ...
          if ($creado_inicio_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_inicio_input_2'] = $val[1];
      ...
      if ($creado_fin_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin'] = $val[0];
          ...
          if ($creado_fin_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']['creado_fin_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_090919']['cond_pesq'] .= $this->NM_operador;
