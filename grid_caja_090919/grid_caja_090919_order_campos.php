<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_caja_090919']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_caja_090919_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_caja_090919_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['idrp'] = "on";
   $tab_def_campos['idrp'] = "idrp";
   $tab_labels["idrp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["idrp"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["idrp"] : "CE";
   $tab_ger_campos['idrc'] = "on";
   $tab_def_campos['idrc'] = "idrc";
   $tab_labels["idrc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["idrc"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["idrc"] : "RC";
   $tab_ger_campos['detalle'] = "on";
   $tab_def_campos['detalle'] = "detalle";
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["detalle"] : "Detalle";
   $tab_ger_campos['nota'] = "on";
   $tab_def_campos['nota'] = "nota";
   $tab_labels["nota"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["nota"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["nota"] : "Nota";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["resolucion"] : "Prefijo";
   $tab_ger_campos['documento'] = "on";
   $tab_def_campos['documento'] = "documento";
   $tab_labels["documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["documento"] : "Documento";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "cliente";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["cliente"] : "Tercero";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["cantidad"] : "Valor I/E";
   $tab_ger_campos['banco'] = "on";
   $tab_def_campos['banco'] = "banco";
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["banco"] : "Banco";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['labels']["creado"] : "Creado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_caja_090919_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_caja_090919']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
