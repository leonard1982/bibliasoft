...
$old_error_handler = set_error_handler("form_cloud_exclusiones_scriptcase_error_handler");

function form_cloud_exclusiones_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_cloud_exclusiones']['contr_erro']) && $_SESSION['scriptcase']['form_cloud_exclusiones']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_cloud_exclusiones->contr_form_cloud_exclusiones->Apl_com_erro = true;
            if ($inicial_form_cloud_exclusiones->contr_form_cloud_exclusiones->NM_ajax_flag)
            {
                $inicial_form_cloud_exclusiones->contr_form_cloud_exclusiones->NM_ajax_info['errList']['geral_form_cloud_exclusiones'][] = $msg;
                return;
            }
            form_cloud_exclusiones_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_cloud_exclusiones_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_cloud_exclusiones'])  && '' != $_SESSION['scriptcase']['error_icon']['form_cloud_exclusiones'])  ? $_SESSION['scriptcase']['error_icon']['form_cloud_exclusiones']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_cloud_exclusiones']) && '' != $_SESSION['scriptcase']['error_span_title']['form_cloud_exclusiones']) ? $_SESSION['scriptcase']['error_span_title']['form_cloud_exclusiones'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_cloud_exclusiones']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_cloud_exclusiones']) ? $_SESSION['scriptcase']['error_icon_title']['form_cloud_exclusiones'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_cloud_exclusiones']['error_buffer'] .= ob_get_flush();
}
