...
class grid_recibos_detalle_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_recibos_detalle']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_recibos_detalle']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_detalle']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $Busca_temp = NM_conv_charset($Busca_temp, $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->valor_a_pagar = $Busca_temp['valor_a_pagar']; 
          $tmp_pos = strpos($this->valor_a_pagar, "##@@");
          if ($tmp_pos !== false && !is_array($this->valor_a_pagar))
          {
              $this->valor_a_pagar = substr($this->valor_a_pagar, 0, $tmp_pos);
          }
          $this->id_recibo_detalle = $Busca_temp['id_recibo_detalle']; 
          $tmp_pos = strpos($this->id_recibo_detalle, "##@@");
          if ($tmp_pos !== false && !is_array($this->id_recibo_detalle))
          {
              $this->id_recibo_detalle = substr($this->id_recibo_detalle, 0, $tmp_pos);
          }
   ...
   {
      global $nada, $nm_lang , $documento, $concepto;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_detalle']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_detalle']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(valor_a_pagar) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_detalle']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_detalle']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_detalle']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_detalle']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_detalle']['contr_total_geral'] = "OK";
   } 
