<?php
@session_start() ;
$_SESSION['scriptcase']['grid_recibos_detalle']['sc_process_barr'] = true;
require_once('../grid_recibos_detalle/index.php');
unset($_SESSION['scriptcase']['grid_recibos_detalle']['sc_process_barr']);
$ExportCtrl = new grid_recibos_detalle_export_control;
$ExportCtrl->Export_barr();

class grid_recibos_detalle_export_control
{
