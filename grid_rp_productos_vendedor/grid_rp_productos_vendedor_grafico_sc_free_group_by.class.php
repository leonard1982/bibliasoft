...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['v_nombres'] = "Vendedor";
      $prep_label['p_nompro'] = "Producto";
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
