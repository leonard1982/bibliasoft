<?php
@session_start() ;
$_SESSION['scriptcase']['grid_rp_productos_vendedor']['sc_process_barr'] = true;
require_once('../grid_rp_productos_vendedor/index.php');
unset($_SESSION['scriptcase']['grid_rp_productos_vendedor']['sc_process_barr']);
$ExportCtrl = new grid_rp_productos_vendedor_export_control;
$ExportCtrl->Export_barr();

class grid_rp_productos_vendedor_export_control
{
