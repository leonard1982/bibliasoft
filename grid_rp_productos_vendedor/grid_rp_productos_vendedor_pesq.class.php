...
class grid_rp_productos_vendedor_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_rp_productos_vendedor_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_rp_productos_vendedor_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_rp_productos_vendedor_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_p_nompro')
      {
          $p_nompro = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_p_nompro($p_nompro);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_grupo($grupo)
   {
      ...
      $nm_comando = "select distinct g.nomgrupo from " . $this->Ini->nm_tabela . " where f.tipo in('FV') and  g.nomgrupo like '%" . $grupo . "%' order by g.nomgrupo"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_p_nompro($p_nompro)
   {
      $p_nompro = substr($this->Db->qstr($p_nompro), 1, -1);
            $p_nompro_look = substr($this->Db->qstr($p_nompro), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select nompro from productos where  nompro like '%" . $p_nompro . "%' order by codigobar, nompro"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "d_cantidad";$Nm_numeric[] = "d_valorpar";$Nm_numeric[] = "month(f_fechaven)";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Reporte Productos x Vendedor</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_rp_productos_vendedor/grid_rp_productos_vendedor_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_rp_productos_vendedor_ajax_search.js"></script>
 <script type="text/javascript" src="grid_rp_productos_vendedor_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_rp_productos_vendedor_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_rp_productos_vendedor']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_rp_productos_vendedor']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['ajax_nav'])
           { 
...
function scJQCalendarAdd() {
  $("#sc_f_fechaven_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_f_fechaven_dia').value + '/';
          var_dt_ini += document.getElementById('SC_f_fechaven_mes').value + '/';
          var_dt_ini += document.getElementById('SC_f_fechaven_ano').value;
          document.getElementById('sc_f_fechaven_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_f_fechaven_dia').value = aParts[0];
          document.getElementById('SC_f_fechaven_mes').value = aParts[1];
          document.getElementById('SC_f_fechaven_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_f_fechaven_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_f_fechaven_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_f_fechaven_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_f_fechaven_input_2_ano').value;
          document.getElementById('sc_f_fechaven_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_f_fechaven_input_2_dia').value = aParts[0];
          document.getElementById('SC_f_fechaven_input_2_mes').value = aParts[1];
          document.getElementById('SC_f_fechaven_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_periodo#NMF#' + search_get_Dselelect('SC_periodo_dest') + '@NMF@';
  ...
  str_out += 'SC_v_nombres_cond#NMF#' + search_get_sel_txt('SC_v_nombres_cond') + '@NMF@';
  str_out += 'SC_v_nombres#NMF#' + search_get_Dselelect('SC_v_nombres_dest') + '@NMF@';
  str_out += 'SC_grupo_cond#NMF#' + search_get_sel_txt('SC_grupo_cond') + '@NMF@';
  str_out += 'SC_grupo#NMF#' + search_get_text('SC_grupo') + '@NMF@';
  str_out += 'id_ac_grupo#NMF#' + search_get_title('select2-id_ac_grupo-container') + '@NMF@';
  str_out += 'SC_p_nompro_cond#NMF#' + search_get_sel_txt('SC_p_nompro_cond') + '@NMF@';
  str_out += 'SC_p_nompro#NMF#' + search_get_text('SC_p_nompro') + '@NMF@';
  str_out += 'id_ac_p_nompro#NMF#' + search_get_text('id_ac_p_nompro') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-grupo").on("focus", function() {
  }).on("blur", function() {
   ...
   $("#SC_grupo").val(e.params.data.id);
  });
   scClass = $("#id_ac_p_nompro").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_p_nompro").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_p_nompro",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Reporte Productos x Vendedor</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__presentation_chart_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $f_fechaven_cond, $f_fechaven, $f_fechaven_dia, $f_fechaven_mes, $f_fechaven_ano, $f_fechaven_input_2_dia, $f_fechaven_input_2_mes, $f_fechaven_input_2_ano,
             $v_nombres_cond, $v_nombres,
             $grupo_cond, $grupo, $grupo_autocomp,
             $p_nompro_cond, $p_nompro, $p_nompro_autocomp,
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_rp_productos_vendedor']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_rp_productos_vendedor']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_rp_productos_vendedor']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_rp_productos_vendedor", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $periodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['periodo']; 
          $periodo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['periodo_cond']; 
          $f_fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_dia']; 
          $f_fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_mes']; 
          $f_fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_ano']; 
          $f_fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_input_2_dia']; 
          $f_fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_input_2_mes']; 
          $f_fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_input_2_ano']; 
          $f_fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_cond']; 
          $v_nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['v_nombres']; 
          $v_nombres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['v_nombres_cond']; 
          $grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['grupo']; 
          $grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['grupo_cond']; 
          $p_nompro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['p_nompro']; 
          $p_nompro_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['p_nompro_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($v_nombres_cond) || empty($v_nombres_cond))
      {
         $v_nombres_cond = "eq";
      }
      ...
      if (!isset($p_nompro_cond) || empty($p_nompro_cond))
      {
         $p_nompro_cond = "qp";
      }
      ...
      $str_hide_v_nombres = (in_array($v_nombres_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_grupo = (in_array($grupo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_p_nompro = (in_array($p_nompro_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_v_nombres = ('bw' == $v_nombres_cond) ? $display_aberto : $display_fechado;
      $str_display_grupo = ('bw' == $grupo_cond) ? $display_aberto : $display_fechado;
      $str_display_p_nompro = ('bw' == $p_nompro_cond) ? $display_aberto : $display_fechado;
      ...
      if (is_array($periodo) && !empty($periodo))
      {
         $tmp_array = array();
         $periodo_val_str = "";
         foreach ($periodo as $tmp_val_cmp)
         {
            if ("" != $periodo_val_str)
            {
               $periodo_val_str .= ",";
      ...
      // v_nombres
      if (is_array($v_nombres) && !empty($v_nombres))
      {
         $tmp_array = array();
         $v_nombres_val_str = "";
         foreach ($v_nombres as $tmp_val_cmp)
         {
            if ("" != $v_nombres_val_str)
            {
               $v_nombres_val_str .= ",";
            }
            $tmp_pos = strpos($tmp_val_cmp, "##@@");
      ...
      if (!isset($p_nompro) || $p_nompro == "")
      {
          $p_nompro = "";
      }
      if (isset($p_nompro) && !empty($p_nompro))
      {
         $tmp_pos = strpos($p_nompro, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $p_nompro = substr($p_nompro, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_periodo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['periodo'])) ? $this->New_label['periodo'] : "Periodo"; ?> <span class="scFilterRequiredOdd">*</span></TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "2";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "3";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "4";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "5";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "6";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "7";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "8";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "9";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "10";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "11";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'][] = "12";
 ?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_periodo_orig" name="periodo_orig" size=7 multiple onDblClick="nm_add_sel('periodo_orig', 'periodo_dest', 'N', '')">
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("1", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="1##@@ENERO" <?php echo $periodo_sel; ?>>ENERO</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("2", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="2##@@FEBRERO" <?php echo $periodo_sel; ?>>FEBRERO</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("3", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="3##@@MARZO" <?php echo $periodo_sel; ?>>MARZO</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("4", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="4##@@ABRIL" <?php echo $periodo_sel; ?>>ABRIL</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("5", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="5##@@MAYO" <?php echo $periodo_sel; ?>>MAYO</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("6", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="6##@@JUNIO" <?php echo $periodo_sel; ?>>JUNIO</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("7", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="7##@@JULIO" <?php echo $periodo_sel; ?>>JULIO</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("8", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="8##@@AGOSTO" <?php echo $periodo_sel; ?>>AGOSTO</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("9", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="9##@@SEPTIEMBRE" <?php echo $periodo_sel; ?>>SEPTIEMBRE</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("10", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="10##@@OCTUBRE" <?php echo $periodo_sel; ?>>OCTUBRE</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("11", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="11##@@NOVIEMBRE" <?php echo $periodo_sel; ?>>NOVIEMBRE</option>
<?php
    if (is_array($periodo) && !empty($periodo))
    {
        $periodo_sel = (in_array("12", $periodo)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="12##@@DICIEMBRE" <?php echo $periodo_sel; ?>>DICIEMBRE</option>
 </SELECT>
   </td>
   <td align="center">
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('periodo_orig', 'periodo_dest', 'N', '');", "nm_add_all('periodo_orig', 'periodo_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('periodo_orig', 'periodo_dest', 'N', '');", "nm_add_sel('periodo_orig', 'periodo_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('periodo_dest', 'periodo_orig', 'N', '');", "nm_del_sel('periodo_dest', 'periodo_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('periodo_dest', 'periodo_orig', 'N', '');", "nm_del_all('periodo_dest', 'periodo_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_periodo_dest" name="periodo_dest" size=7 multiple onDblClick="nm_del_sel('periodo_dest', 'periodo_orig', 'N', '')">"
<?php if (in_array("1", $periodo)) { ?> <OPTION value="1##@@ENERO" >ENERO</option>
<?php
      }
?>
<?php if (in_array("2", $periodo)) { ?> <OPTION value="2##@@FEBRERO" >FEBRERO</option>
<?php
      }
?>
<?php if (in_array("3", $periodo)) { ?> <OPTION value="3##@@MARZO" >MARZO</option>
<?php
      }
?>
<?php if (in_array("4", $periodo)) { ?> <OPTION value="4##@@ABRIL" >ABRIL</option>
<?php
      }
?>
<?php if (in_array("5", $periodo)) { ?> <OPTION value="5##@@MAYO" >MAYO</option>
<?php
      }
?>
<?php if (in_array("6", $periodo)) { ?> <OPTION value="6##@@JUNIO" >JUNIO</option>
<?php
      }
?>
<?php if (in_array("7", $periodo)) { ?> <OPTION value="7##@@JULIO" >JULIO</option>
<?php
      }
?>
<?php if (in_array("8", $periodo)) { ?> <OPTION value="8##@@AGOSTO" >AGOSTO</option>
<?php
      }
?>
<?php if (in_array("9", $periodo)) { ?> <OPTION value="9##@@SEPTIEMBRE" >SEPTIEMBRE</option>
<?php
      }
?>
<?php if (in_array("10", $periodo)) { ?> <OPTION value="10##@@OCTUBRE" >OCTUBRE</option>
<?php
      }
?>
<?php if (in_array("11", $periodo)) { ?> <OPTION value="11##@@NOVIEMBRE" >NOVIEMBRE</option>
<?php
      }
?>
<?php if (in_array("12", $periodo)) { ?> <OPTION value="12##@@DICIEMBRE" >DICIEMBRE</option>
<?php
      }
?>
    </select>
    <input type="hidden" id="SC_periodo" name="periodo" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.periodo_dest.selectedIndex = -1;</script>
      ...
      <TD id='SC_f_fechaven_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['f_fechaven'])) ? $this->New_label['f_fechaven'] : "Fecha"; ?></TD>
      
      <INPUT type="hidden" id="SC_f_fechaven_cond" name="f_fechaven_cond" value="bw">
...
<?php
  ...
  {
?>
<span id='id_date_part_f_fechaven_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_f_fechaven_dia" name="f_fechaven_dia" value="<?php echo NM_encode_input($f_fechaven_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_f_fechaven_mes" name="f_fechaven_mes" value="<?php echo NM_encode_input($f_fechaven_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_f_fechaven_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_f_fechaven_ano" name="f_fechaven_ano" value="<?php echo NM_encode_input($f_fechaven_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_f_fechaven_jq">
</span>
...
?>
        <SPAN id="id_css_f_fechaven"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_f_fechaven"  <?php echo $str_display_f_fechaven; ?> class="scFilterFieldFontEven">
...
<?php
  ...
  {
?>
<span id='id_date_part_f_fechaven_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_f_fechaven_input_2_dia" name="f_fechaven_input_2_dia" value="<?php echo NM_encode_input($f_fechaven_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_f_fechaven_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_f_fechaven_input_2_mes" name="f_fechaven_input_2_mes" value="<?php echo NM_encode_input($f_fechaven_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_f_fechaven_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_f_fechaven_input_2_ano" name="f_fechaven_input_2_ano" value="<?php echo NM_encode_input($f_fechaven_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_f_fechaven_jq2">
</span>
...
?>
      ...
      <TD id='SC_v_nombres_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['v_nombres'])) ? $this->New_label['v_nombres'] : "Vendedor"; ?></TD>
      
      <INPUT type="hidden" id="SC_v_nombres_cond" name="v_nombres_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_v_nombres" <?php echo $str_hide_v_nombres?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['v_nombres'])) ? $this->New_label['v_nombres'] : "Vendedor";
 $nmgp_tab_label .= "v_nombres?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $v_nombres_look = substr($this->Db->qstr($v_nombres), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT nombres FROM terceros  WHERE empleado='SI' ORDER BY nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['v_nombres'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['v_nombres'][] = trim($rs->fields[0]);
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_v_nombres_orig" name="v_nombres_orig" size=7 multiple onDblClick="nm_add_sel('v_nombres_orig', 'v_nombres_dest', 'N' , '')">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $v_nombres_sel = "";
               foreach ($v_nombres as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $v_nombres_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
            ...
            {
               $v_nombres_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $v_nombres_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('v_nombres_orig', 'v_nombres_dest', 'N', '');", "nm_add_all('v_nombres_orig', 'v_nombres_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('v_nombres_orig', 'v_nombres_dest', 'N', '');", "nm_add_sel('v_nombres_orig', 'v_nombres_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('v_nombres_dest', 'v_nombres_orig', 'N', '');", "nm_del_sel('v_nombres_dest', 'v_nombres_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('v_nombres_dest', 'v_nombres_orig', 'N', '');", "nm_del_all('v_nombres_dest', 'v_nombres_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_v_nombres_dest" name="v_nombres_dest" size=7 multiple  onDblClick="nm_del_sel('v_nombres_dest', 'v_nombres_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_v_nombres" name="v_nombres" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.v_nombres_dest.selectedIndex = -1;</script>
<?php
?>
      ...
      <INPUT type="hidden" id="SC_grupo_cond" name="grupo_cond" value="qp">
...
<?php
      ...
      $grupo_look = substr($this->Db->qstr($grupo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct g.nomgrupo from " . $this->Ini->nm_tabela . " where f.tipo in('FV') and g.nomgrupo = '$grupo_look' order by g.nomgrupo"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_grupo" name="grupo" value="<?php echo NM_encode_input($grupo) ?>"  size=50 alt="{datatype: 'text', maxLength: 90, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-grupo" id="id_ac_grupo" name="grupo_autocomp"><?php if ('' !=  $grupo) { ?><option value="<?php echo $grupo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_p_nompro_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['p_nompro'])) ? $this->New_label['p_nompro'] : "Producto"; ?></TD>
      
      <INPUT type="hidden" id="SC_p_nompro_cond" name="p_nompro_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_p_nompro" <?php echo $str_hide_p_nompro?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['p_nompro'])) ? $this->New_label['p_nompro'] : "Producto";
 $nmgp_tab_label .= "p_nompro?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $p_nompro_look = substr($this->Db->qstr($p_nompro), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select nompro from productos where nompro = '$p_nompro_look' order by codigobar, nompro"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$p_nompro]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$p_nompro];
      }
      else
      {
          $sAutocompValue = $p_nompro;
      }
?>
<INPUT  type="text" id="SC_p_nompro" name="p_nompro" value="<?php echo NM_encode_input($p_nompro) ?>"  size=50 alt="{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_p_nompro" name="p_nompro_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
...
<?php
   if (is_file("grid_rp_productos_vendedor_help.txt"))
   {
      $Arq_WebHelp = file("grid_rp_productos_vendedor_help.txt"); 
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['sc_modal'])
       {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('periodo_dest', 'periodo');
   nm_pack('v_nombres_dest', 'v_nombres');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_del_all('periodo_dest', 'periodo_orig', 'N', '');
   document.F1.f_fechaven_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_f_fechaven'), document.F1.f_fechaven_cond, 'f_fechaven');
   document.F1.f_fechaven_dia.value = "";
   document.F1.f_fechaven_mes.value = "";
   document.F1.f_fechaven_ano.value = "";
   document.F1.f_fechaven_input_2_dia.value = "";
   document.F1.f_fechaven_input_2_mes.value = "";
   document.F1.f_fechaven_input_2_ano.value = "";
   document.F1.v_nombres_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_v_nombres'), document.F1.v_nombres_cond, 'v_nombres');
   nm_del_all('v_nombres_dest', 'v_nombres_orig', 'N', '');
   document.F1.grupo_cond.value = 'qp';
   ...
   $('#select2-id_ac_grupo-container').html('<?php echo $this->Val_init_grupo['desc'] ?>');;
   document.F1.p_nompro_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_p_nompro'), document.F1.p_nompro_cond, 'p_nompro');
   document.F1.p_nompro.value = "";
   document.F1.p_nompro_autocomp.value = "";
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_f_fechaven_dia').bind('change', function() {sc_grid_rp_productos_vendedor_valida_dia(this)});
    $('#SC_f_fechaven_input_2_dia').bind('change', function() {sc_grid_rp_productos_vendedor_valida_dia(this)});
    $('#SC_f_fechaven_input_2_mes').bind('change', function() {sc_grid_rp_productos_vendedor_valida_mes(this)});
    $('#SC_f_fechaven_mes').bind('change', function() {sc_grid_rp_productos_vendedor_valida_mes(this)});
 }
 function sc_grid_rp_productos_vendedor_valida_dia(obj)
 {
 ...
 function sc_grid_rp_productos_vendedor_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_rp_productos_vendedor";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_rp_productos_vendedor/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_v_nombres_cond'] = 'cond';
      $tp_fields['SC_v_nombres'] = 'dselect';
      $tp_fields['SC_grupo_cond'] = 'cond';
      $tp_fields['SC_grupo'] = 'text_aut';
      $tp_fields['id_ac_grupo'] = 'select2_aut';
      $tp_fields['SC_p_nompro_cond'] = 'cond';
      $tp_fields['SC_p_nompro'] = 'text_aut';
      $tp_fields['id_ac_p_nompro'] = 'text_aut';
   ...
   {
      global $periodo_cond, $periodo,
             $f_fechaven_cond, $f_fechaven, $f_fechaven_dia, $f_fechaven_mes, $f_fechaven_ano, $f_fechaven_input_2_dia, $f_fechaven_input_2_mes, $f_fechaven_input_2_ano,
             $v_nombres_cond, $v_nombres,
             $grupo_cond, $grupo, $grupo_autocomp,
             $p_nompro_cond, $p_nompro, $p_nompro_autocomp, $nmgp_tab_label;
      ...
      if (!empty($p_nompro_autocomp) && empty($p_nompro))
      {
          $p_nompro = $p_nompro_autocomp;
      }
      if (!empty($periodo))
      {
          $periodo = explode("@?@", $periodo);
      ...
      if (!isset($f_fechaven_input_2_dia) || $f_fechaven_input_2_dia == "")
      {
          $f_fechaven_input_2_dia = $f_fechaven_dia;
      }
      if (!isset($f_fechaven_input_2_mes) || $f_fechaven_input_2_mes == "")
      {
          $f_fechaven_input_2_mes = $f_fechaven_mes;
      }
      if (!isset($f_fechaven_input_2_ano) || $f_fechaven_input_2_ano == "")
      {
          $f_fechaven_input_2_ano = $f_fechaven_ano;
      }
      $v_nombres_cond_salva = $v_nombres_cond; 
      if (!isset($v_nombres_input_2) || $v_nombres_input_2 == "")
      {
          $v_nombres_input_2 = $v_nombres;
      }
      ...
      $p_nompro_cond_salva = $p_nompro_cond; 
      if (!isset($p_nompro_input_2) || $p_nompro_input_2 == "")
      {
          $p_nompro_input_2 = $p_nompro;
      }
      if (!$this->NM_ajax_flag || $this->NM_ajax_opcao != "ajax_grid_search")
      {
          if ($periodo_cond != "nu" && $periodo_cond != "nn" && $periodo_cond != "ep" && $periodo_cond != "ne")
          {
              if (empty($periodo))
              {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Periodo : " . $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
              }
          }
      }
      if (is_array($periodo)) {
          foreach ($periodo as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['periodo'])) {
      ...
      if (is_array($v_nombres)) {
          foreach ($v_nombres as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['psq_check_ret']['v_nombres'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['periodo'] = $periodo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['periodo_cond'] = $periodo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_dia'] = $f_fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_mes'] = $f_fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_ano'] = $f_fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_input_2_dia'] = $f_fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_input_2_mes'] = $f_fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_input_2_ano'] = $f_fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_cond'] = $f_fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['v_nombres'] = $v_nombres; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['v_nombres_cond'] = $v_nombres_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['grupo'] = $grupo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['grupo_cond'] = $grupo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['p_nompro'] = $p_nompro; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['p_nompro_cond'] = $p_nompro_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['periodo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['periodo'];
      $this->cmp_formatado['periodo_input_2'] = $periodo_input_2;
      $this->cmp_formatado['v_nombres'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['v_nombres'];
      $this->cmp_formatado['v_nombres_input_2'] = $v_nombres_input_2;
      $nmgp_def_dados = array();
    if ($grupo != '') {
      $grupo_look = substr($this->Db->qstr($grupo), 1, -1); 
      $nmgp_def_dados = array(); 
    ...
    if ($p_nompro != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['p_nompro'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['p_nompro'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['p_nompro'] = $p_nompro;
      }
      ...
      if (is_array($periodo) && count($periodo) != 0)
      {
         foreach ($periodo as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($periodo_cond == "df" || $periodo_cond == "np")
         {
             $this->comando        .= " month(f.fechaven) not in (";
             $this->comando_sum    .= " month(f.fechaven) not in (";
             $this->comando_filtro .= " month(f.fechaven) not in (";
         }
         else
         {
             $this->comando        .= " month(f.fechaven) in (";
             $this->comando_sum    .= " month(f.fechaven) in (";
             $this->comando_filtro .= " month(f.fechaven) in (";
         }
         $x                     = count($periodo);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$periodo_cond]) ? $Lang_descr[$periodo_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label['periodo'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($periodo) || $periodo_cond == "nu" || $periodo_cond == "nn" || $periodo_cond == "ep" || $periodo_cond == "ne")
      {
         $this->monta_condicao("month(f.fechaven)", $periodo_cond, $periodo, "", "periodo");
      }
      ...
      if ($f_fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['f_fechaven'], "YYYY-MM-DD");
          $this->cmp_formatado['f_fechaven'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($f_fechaven_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']['f_fechaven_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['f_fechaven_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['f_fechaven_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($v_nombres_cond == "nu" || $v_nombres_cond == "nn" || $v_nombres_cond == "ep" || $v_nombres_cond == "ne")
      {
          $v_nombres = array();
      }
      if (is_array($v_nombres) && count($v_nombres) != 0)
      {
         foreach ($v_nombres as $i => $dados)
         {
            $tmp_pos = strpos($dados, "##@@");
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
      ...
      {
         $this->and_or();
         if ($v_nombres_cond == "df" || $v_nombres_cond == "np")
         {
             $this->comando        .= " v.nombres not in (";
             $this->comando_sum    .= " v.nombres not in (";
             $this->comando_filtro .= " v.nombres not in (";
         }
         else
         {
             $this->comando        .= " v.nombres in (";
             $this->comando_sum    .= " v.nombres in (";
             $this->comando_filtro .= " v.nombres in (";
         }
         $x                     = count($v_nombres);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr['df'] = $this->Ini->Nm_lang['lang_srch_diff'];
         $Lang_descr['np'] = $this->Ini->Nm_lang['lang_srch_not_like'];
         $Lang_descr_final = isset($Lang_descr[$v_nombres_cond]) ? $Lang_descr[$v_nombres_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $nmgp_tab_label['v_nombres'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($v_nombres) || $v_nombres_cond == "nu" || $v_nombres_cond == "nn" || $v_nombres_cond == "ep" || $v_nombres_cond == "ne")
      {
         $this->monta_condicao("v.nombres", $v_nombres_cond, $v_nombres, "", "v_nombres");
      }
      ...
      {
         $this->monta_condicao("g.nomgrupo", $grupo_cond, $grupo, "", "grupo");
      }
      ...
      if (isset($p_nompro) && !empty($p_nompro))
      { 
           $p_nompro = strtoupper($p_nompro);
      } 
      if (isset($p_nompro) || $p_nompro_cond == "nu" || $p_nompro_cond == "nn" || $p_nompro_cond == "ep" || $p_nompro_cond == "ne")
      {
         $this->monta_condicao("p.nompro", $p_nompro_cond, $p_nompro, "", "p_nompro");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['where_pesq'];
