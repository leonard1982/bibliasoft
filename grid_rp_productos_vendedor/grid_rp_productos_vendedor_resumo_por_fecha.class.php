...
class grid_rp_productos_vendedor_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_f_fechaven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['arr_total']['f_fechaven'];
      }
      else
      {
          $this->array_total_f_fechaven = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['arr_total']['f_fechaven'] = $this->array_total_f_fechaven;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['labels']['f_fechaven'] = $Lab_f_fechaven; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_order']['por_fecha']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_order']['por_fecha'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_order']['por_fecha'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['por_fecha'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['por_fecha'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['por_fecha'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['por_fecha'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['por_fecha'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['por_fecha'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['por_fecha'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_f_fechaven as $i_f_fechaven => $d_f_fechaven) {
           if (!in_array($i_f_fechaven, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_f_fechaven[5] ] = $d_f_fechaven[4];
               $this->comp_label[0][ $d_f_fechaven[5] ] = $d_f_fechaven[4];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'f_fechaven', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_f_fechaven => $l_f_fechaven) {
           if (isset($this->array_total_f_fechaven[$i_f_fechaven])) {
               $this->comp_group[$i_f_fechaven] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_f_fechaven;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_por_fecha("res");
      ...
      ksort($this->array_total_f_fechaven);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_total, $quebra_f_fechaven, $quebra_f_fechaven_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_f_fechaven[$quebra_f_fechaven_orig]))
      {
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][0] = 1;
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][1] = $sum_cantidad;
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][2] = $sum_total;
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][3] = 1;
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][4] = $quebra_f_fechaven;
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][5] = $quebra_f_fechaven_orig;
      }
      else
      {
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][0]++;
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][1] += $sum_cantidad;
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][2] += $sum_total;
         $this->array_total_f_fechaven[$quebra_f_fechaven_orig][3]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'f_fechaven');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->f_fechaven_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->f_fechaven, $Format_tst);
            $this->f_fechaven = $this->Ini->GB_date_format($TP_Time . $this->f_fechaven, $Format_tst, $Prefix_dat);
            nmgp_Form_Num_Val($this->periodo, "", "", "0", "", "", "", "N:", "") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->total, $this->f_fechaven, $this->f_fechaven_orig);
            }
   }
//
