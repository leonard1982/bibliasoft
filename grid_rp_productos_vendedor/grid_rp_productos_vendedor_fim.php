...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_rp_productos_vendedor"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_rp_productos_vendedor"]);
   }
