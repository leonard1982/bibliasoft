...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['contr_label_graf']['periodo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['contr_label_graf']['periodo']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['contr_label_graf']['periodo'];
      }
   }
