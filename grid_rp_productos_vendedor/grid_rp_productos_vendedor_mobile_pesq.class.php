...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "f.fechaven";$Nm_datas[] = "f_fechaven";$Nm_numeric[] = "d_cantidad";$Nm_numeric[] = "d_valorpar";$Nm_numeric[] = "month(f_fechaven)";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_periodo"  <?php echo $str_hide_periodo?>> 
<?php
 ...
 ?>
<?php if (!isset($periodo)) {$periodo = explode(";", $periodo);} ?>
 <SELECT class="scFilterObjectOdd" id="SC_periodo" name="periodo[]"  size="7" multiple>
 <OPTION value="1##@@ENERO" <?php if (in_array("1", $periodo)) { echo " selected" ;} ?>>ENERO</option>
 <OPTION value="2##@@FEBRERO" <?php if (in_array("2", $periodo)) { echo " selected" ;} ?>>FEBRERO</option>
 <OPTION value="3##@@MARZO" <?php if (in_array("3", $periodo)) { echo " selected" ;} ?>>MARZO</option>
 <OPTION value="4##@@ABRIL" <?php if (in_array("4", $periodo)) { echo " selected" ;} ?>>ABRIL</option>
 <OPTION value="5##@@MAYO" <?php if (in_array("5", $periodo)) { echo " selected" ;} ?>>MAYO</option>
 <OPTION value="6##@@JUNIO" <?php if (in_array("6", $periodo)) { echo " selected" ;} ?>>JUNIO</option>
 <OPTION value="7##@@JULIO" <?php if (in_array("7", $periodo)) { echo " selected" ;} ?>>JULIO</option>
 <OPTION value="8##@@AGOSTO" <?php if (in_array("8", $periodo)) { echo " selected" ;} ?>>AGOSTO</option>
 <OPTION value="9##@@SEPTIEMBRE" <?php if (in_array("9", $periodo)) { echo " selected" ;} ?>>SEPTIEMBRE</option>
 <OPTION value="10##@@OCTUBRE" <?php if (in_array("10", $periodo)) { echo " selected" ;} ?>>OCTUBRE</option>
 <OPTION value="11##@@NOVIEMBRE" <?php if (in_array("11", $periodo)) { echo " selected" ;} ?>>NOVIEMBRE</option>
 <OPTION value="12##@@DICIEMBRE" <?php if (in_array("12", $periodo)) { echo " selected" ;} ?>>DICIEMBRE</option>
 </SELECT>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_f_fechaven"  <?php echo $str_hide_f_fechaven?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_f_fechaven"  <?php echo $str_display_f_fechaven; ?> class="scFilterFieldFontEven">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_v_nombres"  <?php echo $str_hide_v_nombres?>>
<?php
...
?>
   <span id="idAjaxSelect_v_nombres">
      <SELECT class="scFilterObjectOdd" id="SC_v_nombres" name="v_nombres[]"  size="7" multiple>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_p_nompro"  <?php echo $str_hide_p_nompro?>><?php
      if ($p_nompro != "")
      {
      $p_nompro_look = substr($this->Db->qstr($p_nompro), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'periodo[]')
      {
   ...
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'v_nombres[]')
      {
          while (document.F1.elements[i].selectedIndex != -1)
          {
              aa = document.F1.elements[i].selectedIndex;
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "v_nombres" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
