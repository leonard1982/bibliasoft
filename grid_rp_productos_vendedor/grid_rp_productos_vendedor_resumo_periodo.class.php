...
class grid_rp_productos_vendedor_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_periodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['arr_total']['periodo'];
      }
      else
      {
          $this->array_total_periodo = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['arr_total']['periodo'] = $this->array_total_periodo;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['labels']['periodo'] = $Lab_periodo; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_order']['periodo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_order']['periodo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_order']['periodo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['periodo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['periodo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['periodo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['periodo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['periodo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['periodo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['summarizing_fields_display']['periodo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_periodo as $i_periodo => $d_periodo) {
           if (!in_array($i_periodo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_periodo[5] ] = $d_periodo[4];
               $this->comp_label[0][ $d_periodo[5] ] = $d_periodo[4];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_periodo => $l_periodo) {
           if (isset($this->array_total_periodo[$i_periodo])) {
               $this->comp_group[$i_periodo] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_periodo;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_periodo("res");
      ...
      ksort($this->array_total_periodo);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rp_productos_vendedor']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_total, $quebra_periodo, $quebra_periodo_orig)
   {
      //----- Periodo
      if (!isset($this->array_total_periodo[$quebra_periodo_orig]))
      {
         $this->array_total_periodo[$quebra_periodo_orig][0] = 1;
         $this->array_total_periodo[$quebra_periodo_orig][1] = $sum_cantidad;
         $this->array_total_periodo[$quebra_periodo_orig][2] = $sum_total;
         $this->array_total_periodo[$quebra_periodo_orig][3] = 1;
         $this->array_total_periodo[$quebra_periodo_orig][4] = $quebra_periodo;
         $this->array_total_periodo[$quebra_periodo_orig][5] = $quebra_periodo_orig;
      }
      else
      {
         $this->array_total_periodo[$quebra_periodo_orig][0]++;
         $this->array_total_periodo[$quebra_periodo_orig][1] += $sum_cantidad;
         $this->array_total_periodo[$quebra_periodo_orig][2] += $sum_total;
         $this->array_total_periodo[$quebra_periodo_orig][3]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'periodo');
     $campos_order = $this->Ini->Get_date_order_groupby("month(f.fechaven)", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->total, $this->periodo, $this->periodo_orig);
            }
   }
//
