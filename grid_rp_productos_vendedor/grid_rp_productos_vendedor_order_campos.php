...
<?php
   ...
   $Ord_Cmp = new grid_rp_productos_vendedor_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_rp_productos_vendedor_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["periodo"] : "Periodo";
   ...
   $tab_labels["f_fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["f_fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["f_fechaven"] : "Fecha";
   $tab_ger_campos['v_nombres'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['v_nombres'] = "v_nombres";
   }
   else
   {
       $tab_def_campos['v_nombres'] = "v.nombres";
   }
   $tab_labels["v_nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["v_nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["v_nombres"] : "Vendedor";
   ...
   $tab_labels["grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["grupo"] : "Grupo";
   ...
   $tab_labels["p_nompro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["p_nompro"])) ? $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["p_nompro"] : "Producto";
   ...
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["cantidad"] : "Cantidad";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_rp_productos_vendedor_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_rp_productos_vendedor']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
