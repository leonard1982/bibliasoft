...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_recibos_ingcaja_detalle"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_recibos_ingcaja_detalle_submit_form(y, z);
...
{
   nm_field_disabled("factura_=disabled", "U");
