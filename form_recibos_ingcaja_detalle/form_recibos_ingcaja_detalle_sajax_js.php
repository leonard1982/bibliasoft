  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recibos_ingcaja_detalle" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_recibos_ingcaja_detalle_form();
	}
  ...
  function do_ajax_form_recibos_ingcaja_detalle_validate_id_detalle_(iNumLinha)
  {
    var nomeCampo_id_detalle_ = "id_detalle_" + iNumLinha;
    var var_id_detalle_ = scAjaxGetFieldHidden(nomeCampo_id_detalle_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ingcaja_detalle_validate_id_detalle_(var_id_detalle_, iNumLinha, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_validate_id_detalle__cb);
  } // do_ajax_form_recibos_ingcaja_detalle_validate_id_detalle_

  function do_ajax_form_recibos_ingcaja_detalle_validate_id_detalle__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ingcaja_detalle_validate_id_detalle__cb

  // ---------- Validate id_recibo_
  function do_ajax_form_recibos_ingcaja_detalle_validate_id_recibo_(iNumLinha)
  {
    var nomeCampo_id_recibo_ = "id_recibo_" + iNumLinha;
    var var_id_recibo_ = scAjaxGetFieldText(nomeCampo_id_recibo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ingcaja_detalle_validate_id_recibo_(var_id_recibo_, iNumLinha, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_validate_id_recibo__cb);
  } // do_ajax_form_recibos_ingcaja_detalle_validate_id_recibo_

  function do_ajax_form_recibos_ingcaja_detalle_validate_id_recibo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_recibo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_recibo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_recibo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_recibo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ingcaja_detalle_validate_id_recibo__cb

  // ---------- Validate factura_
  function do_ajax_form_recibos_ingcaja_detalle_validate_factura_(iNumLinha)
  {
    var nomeCampo_factura_ = "factura_" + iNumLinha;
    var var_factura_ = scAjaxGetFieldSelect(nomeCampo_factura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ingcaja_detalle_validate_factura_(var_factura_, iNumLinha, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_validate_factura__cb);
  } // do_ajax_form_recibos_ingcaja_detalle_validate_factura_

  function do_ajax_form_recibos_ingcaja_detalle_validate_factura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "factura_" + iLineNumber;
    }
    else
    {
      sFieldValid = "factura_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "factura_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "factura_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ingcaja_detalle_validate_factura__cb

  // ---------- Validate documento_
  function do_ajax_form_recibos_ingcaja_detalle_validate_documento_(iNumLinha)
  {
    var nomeCampo_documento_ = "documento_" + iNumLinha;
    var var_documento_ = scAjaxGetFieldHidden(nomeCampo_documento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ingcaja_detalle_validate_documento_(var_documento_, iNumLinha, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_validate_documento__cb);
  } // do_ajax_form_recibos_ingcaja_detalle_validate_documento_

  function do_ajax_form_recibos_ingcaja_detalle_validate_documento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ingcaja_detalle_validate_documento__cb

  // ---------- Validate valor_factura_
  function do_ajax_form_recibos_ingcaja_detalle_validate_valor_factura_(iNumLinha)
  {
    var nomeCampo_valor_factura_ = "valor_factura_" + iNumLinha;
    var var_valor_factura_ = scAjaxGetFieldText(nomeCampo_valor_factura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ingcaja_detalle_validate_valor_factura_(var_valor_factura_, iNumLinha, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_validate_valor_factura__cb);
  } // do_ajax_form_recibos_ingcaja_detalle_validate_valor_factura_

  function do_ajax_form_recibos_ingcaja_detalle_validate_valor_factura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valor_factura_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valor_factura_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valor_factura_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valor_factura_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ingcaja_detalle_validate_valor_factura__cb

  // ---------- Validate valor_pagado_
  function do_ajax_form_recibos_ingcaja_detalle_validate_valor_pagado_(iNumLinha)
  {
    var nomeCampo_valor_pagado_ = "valor_pagado_" + iNumLinha;
    var var_valor_pagado_ = scAjaxGetFieldText(nomeCampo_valor_pagado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ingcaja_detalle_validate_valor_pagado_(var_valor_pagado_, iNumLinha, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_validate_valor_pagado__cb);
  } // do_ajax_form_recibos_ingcaja_detalle_validate_valor_pagado_

  function do_ajax_form_recibos_ingcaja_detalle_validate_valor_pagado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valor_pagado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valor_pagado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valor_pagado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valor_pagado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ingcaja_detalle_validate_valor_pagado__cb

  // ---------- Validate saldo_factura_
  function do_ajax_form_recibos_ingcaja_detalle_validate_saldo_factura_(iNumLinha)
  {
    var nomeCampo_saldo_factura_ = "saldo_factura_" + iNumLinha;
    var var_saldo_factura_ = scAjaxGetFieldText(nomeCampo_saldo_factura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ingcaja_detalle_validate_saldo_factura_(var_saldo_factura_, iNumLinha, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_validate_saldo_factura__cb);
  } // do_ajax_form_recibos_ingcaja_detalle_validate_saldo_factura_

  function do_ajax_form_recibos_ingcaja_detalle_validate_saldo_factura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "saldo_factura_" + iLineNumber;
    }
    else
    {
      sFieldValid = "saldo_factura_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "saldo_factura_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "saldo_factura_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ingcaja_detalle_validate_saldo_factura__cb

  // ---------- Event onchange factura_
  function do_ajax_form_recibos_ingcaja_detalle_event_factura__onchange(iSeqForm)
  {
    var var_factura_ = scAjaxGetFieldSelect("factura_" + iSeqForm);
    var var_valor_factura_ = scAjaxGetFieldText("valor_factura_" + iSeqForm);
    var var_valor_pagado_ = scAjaxGetFieldText("valor_pagado_" + iSeqForm);
    var var_saldo_factura_ = scAjaxGetFieldText("saldo_factura_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_recibos_ingcaja_detalle_event_factura__onchange(var_factura_, var_valor_factura_, var_valor_pagado_, var_saldo_factura_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_recibos_ingcaja_detalle_event_factura__onchange_cb);
  } // do_ajax_form_recibos_ingcaja_detalle_event_factura__onchange

  function do_ajax_form_recibos_ingcaja_detalle_event_factura__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_ingcaja_detalle_event_factura__onchange_cb_after_alert);
  } // do_ajax_form_recibos_ingcaja_detalle_event_factura__onchange_cb
  function do_ajax_form_recibos_ingcaja_detalle_event_factura__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_ingcaja_detalle_event_factura__onchange_cb_after_alert

  // ---------- Event onchange valor_factura_
  function do_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange(iSeqForm)
  {
    var var_factura_ = scAjaxGetFieldSelect("factura_" + iSeqForm);
    var var_valor_pagado_ = scAjaxGetFieldText("valor_pagado_" + iSeqForm);
    var var_valor_factura_ = scAjaxGetFieldText("valor_factura_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange(var_factura_, var_valor_pagado_, var_valor_factura_, var_saldo_factura_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange_cb);
  } // do_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange

  function do_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange_cb_after_alert);
  } // do_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange_cb
  function do_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_ingcaja_detalle_event_valor_factura__onchange_cb_after_alert

  // ---------- Event onchange valor_pagado_
  function do_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange(iSeqForm)
  {
    var var_factura_ = scAjaxGetFieldSelect("factura_" + iSeqForm);
    var var_valor_pagado_ = scAjaxGetFieldText("valor_pagado_" + iSeqForm);
    var var_valor_factura_ = scAjaxGetFieldText("valor_factura_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange(var_factura_, var_valor_pagado_, var_valor_factura_, var_saldo_factura_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange_cb);
  } // do_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange

  function do_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange_cb_after_alert);
  } // do_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange_cb
  function do_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_ingcaja_detalle_event_valor_pagado__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_recibos_ingcaja_detalle_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_recibos_ingcaja_detalle_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_ingcaja_detalle_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_add_new_line_cb);
  } // do_ajax_form_recibos_ingcaja_detalle_add_new_line

  function do_ajax_form_recibos_ingcaja_detalle_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_recibos_ingcaja_detalle_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_recibos_ingcaja_detalle_backup_line(iNumLinha)
  {
    var var_id_detalle_ = scAjaxGetFieldHidden("id_detalle_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ingcaja_detalle_backup_line(var_id_detalle_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_backup_line_cb);
  } // do_ajax_form_recibos_ingcaja_detalle_backup_line

  function do_ajax_form_recibos_ingcaja_detalle_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_recibos_ingcaja_detalle_backup_line_cb

  function do_ajax_form_recibos_ingcaja_detalle_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_recibos_ingcaja_detalle_cancel_insert

  function do_ajax_form_recibos_ingcaja_detalle_cancel_update(iSeqVert)
  {
    do_ajax_form_recibos_ingcaja_detalle_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_recibos_ingcaja_detalle_cancel_update

  function do_ajax_form_recibos_ingcaja_detalle_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_recibos_ingcaja_detalle_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_recibos_ingcaja_detalle_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_recibos_ingcaja_detalle_table_refresh(var_id_detalle_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_table_refresh_cb);
  } //  do_ajax_form_recibos_ingcaja_detalle_table_refresh

  function do_ajax_form_recibos_ingcaja_detalle_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_recibos_ingcaja_detalle_table_refresh_cb_after_alert);
  } // do_ajax_form_recibos_ingcaja_detalle_table_refresh_cb
  function do_ajax_form_recibos_ingcaja_detalle_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_recibos_ingcaja_detalle_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_recibos_ingcaja_detalle_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_recibos_ingcaja_detalle_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_detalle_ = scAjaxGetFieldHidden("id_detalle_" + iNumLinha);
    var var_id_recibo_ = scAjaxGetFieldText("id_recibo_" + iNumLinha);
    var var_factura_ = scAjaxGetFieldSelect("factura_" + iNumLinha);
    var var_documento_ = scAjaxGetFieldHidden("documento_" + iNumLinha);
    var var_valor_factura_ = scAjaxGetFieldText("valor_factura_" + iNumLinha);
    var var_valor_pagado_ = scAjaxGetFieldText("valor_pagado_" + iNumLinha);
    var var_saldo_factura_ = scAjaxGetFieldText("saldo_factura_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_recibos_ingcaja_detalle_submit_form(var_id_detalle_, var_id_recibo_, var_factura_, var_documento_, var_valor_factura_, var_valor_pagado_, var_saldo_factura_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recibos_ingcaja_detalle_submit_form_cb);
  } // do_ajax_form_recibos_ingcaja_detalle_submit_form

  function do_ajax_form_recibos_ingcaja_detalle_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("id_recibo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("factura_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("documento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valor_factura_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valor_pagado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("saldo_factura_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_ingcaja_detalle_submit_form_cb_after_alert);
  } // do_ajax_form_recibos_ingcaja_detalle_submit_form_cb
  function do_ajax_form_recibos_ingcaja_detalle_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_ingcaja_detalle_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_recibos_ingcaja_detalle_navigate_form()
  {
    perform_ajax_form_recibos_ingcaja_detalle_navigate_form();
  }

  function perform_ajax_form_recibos_ingcaja_detalle_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_recibos_ingcaja_detalle_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("id_recibo_" + iNavForm);
      scAjaxHideErrorDisplay("factura_" + iNavForm);
      scAjaxHideErrorDisplay("documento_" + iNavForm);
      scAjaxHideErrorDisplay("valor_factura_" + iNavForm);
      scAjaxHideErrorDisplay("valor_pagado_" + iNavForm);
      scAjaxHideErrorDisplay("saldo_factura_" + iNavForm);
    }
    var var_id_detalle_ = document.F2.id_detalle_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_recibos_ingcaja_detalle_navigate_form(var_id_detalle_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_ingcaja_detalle_navigate_form_cb);
  } // do_ajax_form_recibos_ingcaja_detalle_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_ingcaja_detalle']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recibos_ingcaja_detalle_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recibos_ingcaja_detalle_navigate_form_cb_after_alert);
  } // do_ajax_form_recibos_ingcaja_detalle_navigate_form_cb
  function do_ajax_form_recibos_ingcaja_detalle_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_recibos_ingcaja_detalle_navigate_form_cb_after_alert
  function sc_hide_form_recibos_ingcaja_detalle_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_recibo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "factura_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "documento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_factura_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_pagado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "saldo_factura_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["id_recibo_" + iNumLinha] = {"label": "Id Recibo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["factura_" + iNumLinha] = {"label": "Factura<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["documento_" + iNumLinha] = {"label": "<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valor_factura_" + iNumLinha] = {"label": "Valor pte. a cancelar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valor_pagado_" + iNumLinha] = {"label": "Valor Pagado<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["saldo_factura_" + iNumLinha] = {"label": "Saldo Factura<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_detalle_"][iNumLinha] = "id_detalle_" + iNumLinha;
    ajax_field_mult["id_recibo_"][iNumLinha] = "id_recibo_" + iNumLinha;
    ajax_field_mult["factura_"][iNumLinha] = "factura_" + iNumLinha;
    ajax_field_mult["documento_"][iNumLinha] = "documento_" + iNumLinha;
    ajax_field_mult["valor_factura_"][iNumLinha] = "valor_factura_" + iNumLinha;
    ajax_field_mult["valor_pagado_"][iNumLinha] = "valor_pagado_" + iNumLinha;
    ajax_field_mult["saldo_factura_"][iNumLinha] = "saldo_factura_" + iNumLinha;
    ajax_field_id["factura_" + iNumLinha] = new Array("hidden_field_label_factura_", "hidden_field_data_factura_" + iNumLinha);
    ajax_field_id["documento_" + iNumLinha] = new Array("hidden_field_label_documento_", "hidden_field_data_documento_" + iNumLinha);
    ajax_field_id["valor_factura_" + iNumLinha] = new Array("hidden_field_label_valor_factura_", "hidden_field_data_valor_factura_" + iNumLinha);
    ajax_field_id["valor_pagado_" + iNumLinha] = new Array("hidden_field_label_valor_pagado_", "hidden_field_data_valor_pagado_" + iNumLinha);
    ajax_field_id["saldo_factura_" + iNumLinha] = new Array("hidden_field_label_saldo_factura_", "hidden_field_data_saldo_factura_" + iNumLinha);
    ajax_error_count["id_detalle_" + iNumLinha] = "off";
    ajax_error_count["id_recibo_" + iNumLinha] = "off";
    ajax_error_count["factura_" + iNumLinha] = "off";
    ajax_error_count["documento_" + iNumLinha] = "off";
    ajax_error_count["valor_factura_" + iNumLinha] = "off";
    ajax_error_count["valor_pagado_" + iNumLinha] = "off";
    ajax_error_count["saldo_factura_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_detalle_" + iNumLinha] = "on";
    ajax_read_only["id_recibo_" + iNumLinha] = "off";
    ajax_read_only["factura_" + iNumLinha] = "off";
    ajax_read_only["documento_" + iNumLinha] = "off";
    ajax_read_only["valor_factura_" + iNumLinha] = "off";
    ajax_read_only["valor_pagado_" + iNumLinha] = "off";
    ajax_read_only["saldo_factura_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_detalle_" + iNumLinha] = "on";
    ajax_read_only["id_recibo_" + iNumLinha] = "on";
    ajax_read_only["factura_" + iNumLinha] = "on";
    ajax_read_only["documento_" + iNumLinha] = "on";
    ajax_read_only["valor_factura_" + iNumLinha] = "on";
    ajax_read_only["valor_pagado_" + iNumLinha] = "on";
    ajax_read_only["saldo_factura_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["id_recibo_" + iNumLinha] = null;
    ajax_error_list["factura_" + iNumLinha] = null;
    ajax_error_list["documento_" + iNumLinha] = null;
    ajax_error_list["valor_factura_" + iNumLinha] = null;
    ajax_error_list["valor_pagado_" + iNumLinha] = null;
    ajax_error_list["saldo_factura_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "id_recibo_": new Array(),
    "factura_": new Array(),
    "documento_": new Array(),
    "valor_factura_": new Array(),
    "valor_pagado_": new Array(),
    "saldo_factura_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["id_recibo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_recibo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_recibo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_recibo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_recibo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["factura_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["factura_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["factura_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["factura_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["factura_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["valor_factura_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valor_factura_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valor_factura_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valor_factura_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valor_factura_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["valor_pagado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valor_pagado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valor_pagado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valor_pagado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valor_pagado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["saldo_factura_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["saldo_factura_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["saldo_factura_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["saldo_factura_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["saldo_factura_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_factura_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_recibo_'])) ? $this->nmgp_cmp_readonly['id_recibo_'] : 'off';
?>
    scAjaxFieldRead("id_recibo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['factura_'])) ? $this->nmgp_cmp_readonly['factura_'] : 'off';
?>
    scAjaxFieldRead("factura_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valor_factura_'])) ? $this->nmgp_cmp_readonly['valor_factura_'] : 'off';
?>
    scAjaxFieldRead("valor_factura_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valor_pagado_'])) ? $this->nmgp_cmp_readonly['valor_pagado_'] : 'off';
?>
    scAjaxFieldRead("valor_pagado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['saldo_factura_'])) ? $this->nmgp_cmp_readonly['saldo_factura_'] : 'off';
?>
    scAjaxFieldRead("saldo_factura_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_detalle_" + iSeq, "on");
    scAjaxFieldRead("id_recibo_" + iSeq, "on");
    scAjaxFieldRead("factura_" + iSeq, "on");
    scAjaxFieldRead("documento_" + iSeq, "on");
    scAjaxFieldRead("valor_factura_" + iSeq, "on");
    scAjaxFieldRead("valor_pagado_" + iSeq, "on");
    scAjaxFieldRead("saldo_factura_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_detalle_" + iRow] || "on" == ajax_error_count["id_recibo_" + iRow] || "on" == ajax_error_count["factura_" + iRow] || "on" == ajax_error_count["documento_" + iRow] || "on" == ajax_error_count["valor_factura_" + iRow] || "on" == ajax_error_count["valor_pagado_" + iRow] || "on" == ajax_error_count["saldo_factura_" + iRow]))
    {
      ...
      $("#hidden_field_data_id_recibo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_factura_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_documento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_factura_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_pagado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_saldo_factura_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_detalle_" + iRow] && "off" == ajax_error_count["id_recibo_" + iRow] && "off" == ajax_error_count["factura_" + iRow] && "off" == ajax_error_count["documento_" + iRow] && "off" == ajax_error_count["valor_factura_" + iRow] && "off" == ajax_error_count["valor_pagado_" + iRow] && "off" == ajax_error_count["saldo_factura_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_detalle_" + iRow] = "off";
        ajax_error_count["id_recibo_" + iRow] = "off";
        ajax_error_count["factura_" + iRow] = "off";
        ajax_error_count["documento_" + iRow] = "off";
        ajax_error_count["valor_factura_" + iRow] = "off";
        ajax_error_count["valor_pagado_" + iRow] = "off";
        ajax_error_count["saldo_factura_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_recibo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_factura_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_documento_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_factura_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_pagado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_saldo_factura_" + iRow).removeClass("scFormErrorLine");
    }
  }
