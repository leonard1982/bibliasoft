...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_venta']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pagar_venta"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_hacer_pago()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('¿Está seguro?, Pago no se puede deshacer', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_hacer_pago_ok, sc_btn_hacer_pago_cancel)
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_venta']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_pagar_venta_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_pagar_venta_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
