  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pagar_venta" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate caja
  function do_ajax_form_pagar_venta_validate_caja()
  {
    var nomeCampo_caja = "caja";
    var var_caja = scAjaxGetFieldHidden(nomeCampo_caja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_caja(var_caja, var_script_case_init, do_ajax_form_pagar_venta_validate_caja_cb);
  } // do_ajax_form_pagar_venta_validate_caja

  function do_ajax_form_pagar_venta_validate_caja_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_caja_cb

  // ---------- Validate fechaven
  function do_ajax_form_pagar_venta_validate_fechaven()
  {
    var nomeCampo_fechaven = "fechaven";
    var var_fechaven = scAjaxGetFieldHidden(nomeCampo_fechaven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_fechaven(var_fechaven, var_script_case_init, do_ajax_form_pagar_venta_validate_fechaven_cb);
  } // do_ajax_form_pagar_venta_validate_fechaven

  function do_ajax_form_pagar_venta_validate_fechaven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_fechaven_cb

  // ---------- Validate resolucion
  function do_ajax_form_pagar_venta_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_pagar_venta_validate_resolucion_cb);
  } // do_ajax_form_pagar_venta_validate_resolucion

  function do_ajax_form_pagar_venta_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_resolucion_cb

  // ---------- Validate numfacven
  function do_ajax_form_pagar_venta_validate_numfacven()
  {
    var nomeCampo_numfacven = "numfacven";
    var var_numfacven = scAjaxGetFieldHidden(nomeCampo_numfacven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_numfacven(var_numfacven, var_script_case_init, do_ajax_form_pagar_venta_validate_numfacven_cb);
  } // do_ajax_form_pagar_venta_validate_numfacven

  function do_ajax_form_pagar_venta_validate_numfacven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_numfacven_cb

  // ---------- Validate idcli
  function do_ajax_form_pagar_venta_validate_idcli()
  {
    var nomeCampo_idcli = "idcli";
    var var_idcli = scAjaxGetFieldSelect(nomeCampo_idcli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_idcli(var_idcli, var_script_case_init, do_ajax_form_pagar_venta_validate_idcli_cb);
  } // do_ajax_form_pagar_venta_validate_idcli

  function do_ajax_form_pagar_venta_validate_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_idcli_cb

  // ---------- Validate total
  function do_ajax_form_pagar_venta_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_total(var_total, var_script_case_init, do_ajax_form_pagar_venta_validate_total_cb);
  } // do_ajax_form_pagar_venta_validate_total

  function do_ajax_form_pagar_venta_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_total_cb

  // ---------- Validate adicional
  function do_ajax_form_pagar_venta_validate_adicional()
  {
    var nomeCampo_adicional = "adicional";
    var var_adicional = scAjaxGetFieldText(nomeCampo_adicional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_adicional(var_adicional, var_script_case_init, do_ajax_form_pagar_venta_validate_adicional_cb);
  } // do_ajax_form_pagar_venta_validate_adicional

  function do_ajax_form_pagar_venta_validate_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_adicional_cb

  // ---------- Validate asentada
  function do_ajax_form_pagar_venta_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldText(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_pagar_venta_validate_asentada_cb);
  } // do_ajax_form_pagar_venta_validate_asentada

  function do_ajax_form_pagar_venta_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_asentada_cb

  // ---------- Validate pagada
  function do_ajax_form_pagar_venta_validate_pagada()
  {
    var nomeCampo_pagada = "pagada";
    var var_pagada = scAjaxGetFieldText(nomeCampo_pagada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_pagada(var_pagada, var_script_case_init, do_ajax_form_pagar_venta_validate_pagada_cb);
  } // do_ajax_form_pagar_venta_validate_pagada

  function do_ajax_form_pagar_venta_validate_pagada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pagada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_pagada_cb

  // ---------- Validate banco
  function do_ajax_form_pagar_venta_validate_banco()
  {
    var nomeCampo_banco = "banco";
    var var_banco = scAjaxGetFieldText(nomeCampo_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_banco(var_banco, var_script_case_init, do_ajax_form_pagar_venta_validate_banco_cb);
  } // do_ajax_form_pagar_venta_validate_banco

  function do_ajax_form_pagar_venta_validate_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banco";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_banco_cb

  // ---------- Validate adicional2
  function do_ajax_form_pagar_venta_validate_adicional2()
  {
    var nomeCampo_adicional2 = "adicional2";
    var var_adicional2 = scAjaxGetFieldText(nomeCampo_adicional2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_adicional2(var_adicional2, var_script_case_init, do_ajax_form_pagar_venta_validate_adicional2_cb);
  } // do_ajax_form_pagar_venta_validate_adicional2

  function do_ajax_form_pagar_venta_validate_adicional2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_adicional2_cb

  // ---------- Validate adicional3
  function do_ajax_form_pagar_venta_validate_adicional3()
  {
    var nomeCampo_adicional3 = "adicional3";
    var var_adicional3 = scAjaxGetFieldText(nomeCampo_adicional3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_adicional3(var_adicional3, var_script_case_init, do_ajax_form_pagar_venta_validate_adicional3_cb);
  } // do_ajax_form_pagar_venta_validate_adicional3

  function do_ajax_form_pagar_venta_validate_adicional3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_adicional3_cb

  // ---------- Validate obspago
  function do_ajax_form_pagar_venta_validate_obspago()
  {
    var nomeCampo_obspago = "obspago";
    var var_obspago = scAjaxGetFieldText(nomeCampo_obspago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_obspago(var_obspago, var_script_case_init, do_ajax_form_pagar_venta_validate_obspago_cb);
  } // do_ajax_form_pagar_venta_validate_obspago

  function do_ajax_form_pagar_venta_validate_obspago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "obspago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_obspago_cb

  // ---------- Validate detallepag
  function do_ajax_form_pagar_venta_validate_detallepag()
  {
    var nomeCampo_detallepag = "detallepag";
    var var_detallepag = scAjaxGetFieldText(nomeCampo_detallepag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_validate_detallepag(var_detallepag, var_script_case_init, do_ajax_form_pagar_venta_validate_detallepag_cb);
  } // do_ajax_form_pagar_venta_validate_detallepag

  function do_ajax_form_pagar_venta_validate_detallepag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_validate_detallepag_cb

  // ---------- Event onchange adicional2
  function do_ajax_form_pagar_venta_event_adicional2_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_pagar_venta_event_adicional2_onchange(var_adicional2, var_total, var_adicional3, var_script_case_init, do_ajax_form_pagar_venta_event_adicional2_onchange_cb);
  } // do_ajax_form_pagar_venta_event_adicional2_onchange

  function do_ajax_form_pagar_venta_event_adicional2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "adicional2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagar_venta_event_adicional2_onchange_cb_after_alert);
  } // do_ajax_form_pagar_venta_event_adicional2_onchange_cb
  function do_ajax_form_pagar_venta_event_adicional2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pagar_venta_event_adicional2_onchange_cb_after_alert

  // ---------- Event onchange pagar
  function do_ajax_form_pagar_venta_event_pagar_onchange()
  {
    var var_adicional2 = scAjaxGetFieldText("adicional2");
    var var_total = scAjaxGetFieldText("total");
    var var_adicional3 = scAjaxGetFieldText("adicional3");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pagar_venta_event_pagar_onchange(var_adicional2, var_total, var_adicional3, var_obspago, var_fechaven, var_numfacven, var_resolucion, var_script_case_init, do_ajax_form_pagar_venta_event_pagar_onchange_cb);
  } // do_ajax_form_pagar_venta_event_pagar_onchange

  function do_ajax_form_pagar_venta_event_pagar_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pagar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagar_venta_event_pagar_onchange_cb_after_alert);
  } // do_ajax_form_pagar_venta_event_pagar_onchange_cb
  function do_ajax_form_pagar_venta_event_pagar_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pagar_venta_event_pagar_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pagar_venta_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pagar_venta_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_caja = scAjaxGetFieldHidden("caja");
    var var_fechaven = scAjaxGetFieldHidden("fechaven");
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_numfacven = scAjaxGetFieldHidden("numfacven");
    ...
    scAjaxProcOn();
    x_ajax_form_pagar_venta_submit_form(var_caja, var_fechaven, var_resolucion, var_numfacven, var_idcli, var_total, var_adicional, var_asentada, var_pagada, var_banco, var_adicional2, var_adicional3, var_obspago, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pagar_venta_submit_form_cb);
  } // do_ajax_form_pagar_venta_submit_form

  function do_ajax_form_pagar_venta_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pagar_venta_submit_form_cb_after_alert);
  } // do_ajax_form_pagar_venta_submit_form_cb
  function do_ajax_form_pagar_venta_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pagar_venta_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detallepagos_contado"] = "off";

  function do_ajax_form_pagar_venta_navigate_form()
  {
    perform_ajax_form_pagar_venta_navigate_form();
  }

  function perform_ajax_form_pagar_venta_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_pagar_venta_navigate_form(var_idfacven, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagar_venta_navigate_form_cb);
  } // do_ajax_form_pagar_venta_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_venta']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pagar_venta_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pagar_venta_navigate_form_cb_after_alert);
  } // do_ajax_form_pagar_venta_navigate_form_cb
  function do_ajax_form_pagar_venta_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_pagar_venta_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pagar_venta_navigate_form_cb_after_alert
  function sc_hide_form_pagar_venta_form()
  {
  ...
  ajax_field_list[9] = "banco";
  ajax_field_list[10] = "adicional2";
  ajax_field_list[11] = "adicional3";
  ajax_field_list[12] = "obspago";
  ajax_field_list[13] = "detallepag";
  ...
  var ajax_error_list = {
    "caja": {"label": "Caja N°", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_id = {
    "caja": new Array("hidden_field_label_caja", "hidden_field_data_caja"),
