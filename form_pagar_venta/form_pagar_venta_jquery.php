...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idfacven' + iSeqRow).bind('change', function() { sc_form_pagar_venta_idfacven_onchange(this, iSeqRow) });
  $('#id_sc_field_numfacven' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_numfacven_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_pagar_venta_numfacven_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pagar_venta_numfacven_onfocus(this, iSeqRow) });
  $('#id_sc_field_nremision' + iSeqRow).bind('change', function() { sc_form_pagar_venta_nremision_onchange(this, iSeqRow) });
  $('#id_sc_field_credito' + iSeqRow).bind('change', function() { sc_form_pagar_venta_credito_onchange(this, iSeqRow) });
  $('#id_sc_field_fechaven' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_fechaven_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pagar_venta_fechaven_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pagar_venta_fechaven_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechavenc' + iSeqRow).bind('change', function() { sc_form_pagar_venta_fechavenc_onchange(this, iSeqRow) });
  $('#id_sc_field_idcli' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_idcli_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_pagar_venta_idcli_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pagar_venta_idcli_onfocus(this, iSeqRow) });
  $('#id_sc_field_subtotal' + iSeqRow).bind('change', function() { sc_form_pagar_venta_subtotal_onchange(this, iSeqRow) });
  $('#id_sc_field_valoriva' + iSeqRow).bind('change', function() { sc_form_pagar_venta_valoriva_onchange(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_total_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_pagar_venta_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pagada' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pagada_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_pagar_venta_pagada_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_asentada' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_asentada_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pagar_venta_asentada_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pagar_venta_asentada_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('change', function() { sc_form_pagar_venta_observaciones_onchange(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('change', function() { sc_form_pagar_venta_saldo_onchange(this, iSeqRow) });
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_adicional_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_pagar_venta_adicional_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pagar_venta_adicional_onfocus(this, iSeqRow) });
  $('#id_sc_field_formapago' + iSeqRow).bind('change', function() { sc_form_pagar_venta_formapago_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_adicional3' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_adicional3_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_pagar_venta_adicional3_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_obspago' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_obspago_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_pagar_venta_obspago_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_pagar_venta_obspago_onfocus(this, iSeqRow) });
  $('#id_sc_field_vendedor' + iSeqRow).bind('change', function() { sc_form_pagar_venta_vendedor_onchange(this, iSeqRow) });
  $('#id_sc_field_pedido' + iSeqRow).bind('change', function() { sc_form_pagar_venta_pedido_onchange(this, iSeqRow) });
  $('#id_sc_field_resolucion' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_resolucion_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_pagar_venta_resolucion_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pagar_venta_resolucion_onfocus(this, iSeqRow) });
  $('#id_sc_field_dircliente' + iSeqRow).bind('change', function() { sc_form_pagar_venta_dircliente_onchange(this, iSeqRow) });
  $('#id_sc_field_imconsumo' + iSeqRow).bind('change', function() { sc_form_pagar_venta_imconsumo_onchange(this, iSeqRow) });
  $('#id_sc_field_retefuente' + iSeqRow).bind('change', function() { sc_form_pagar_venta_retefuente_onchange(this, iSeqRow) });
  $('#id_sc_field_reteiva' + iSeqRow).bind('change', function() { sc_form_pagar_venta_reteiva_onchange(this, iSeqRow) });
  $('#id_sc_field_reteica' + iSeqRow).bind('change', function() { sc_form_pagar_venta_reteica_onchange(this, iSeqRow) });
  $('#id_sc_field_cree' + iSeqRow).bind('change', function() { sc_form_pagar_venta_cree_onchange(this, iSeqRow) });
  $('#id_sc_field_espos' + iSeqRow).bind('change', function() { sc_form_pagar_venta_espos_onchange(this, iSeqRow) });
  $('#id_sc_field_cufe' + iSeqRow).bind('change', function() { sc_form_pagar_venta_cufe_onchange(this, iSeqRow) });
  $('#id_sc_field_enlacepdf' + iSeqRow).bind('change', function() { sc_form_pagar_venta_enlacepdf_onchange(this, iSeqRow) });
  $('#id_sc_field_estado' + iSeqRow).bind('change', function() { sc_form_pagar_venta_estado_onchange(this, iSeqRow) });
  $('#id_sc_field_avisos' + iSeqRow).bind('change', function() { sc_form_pagar_venta_avisos_onchange(this, iSeqRow) });
  $('#id_sc_field_creado' + iSeqRow).bind('change', function() { sc_form_pagar_venta_creado_onchange(this, iSeqRow) });
  $('#id_sc_field_creado_hora' + iSeqRow).bind('change', function() { sc_form_pagar_venta_creado_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_editado' + iSeqRow).bind('change', function() { sc_form_pagar_venta_editado_onchange(this, iSeqRow) });
  $('#id_sc_field_editado_hora' + iSeqRow).bind('change', function() { sc_form_pagar_venta_editado_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_usuario_crea' + iSeqRow).bind('change', function() { sc_form_pagar_venta_usuario_crea_onchange(this, iSeqRow) });
  $('#id_sc_field_dias_decredito' + iSeqRow).bind('change', function() { sc_form_pagar_venta_dias_decredito_onchange(this, iSeqRow) });
  $('#id_sc_field_banco' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_banco_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_pagar_venta_banco_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_detallepag' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_detallepag_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_pagar_venta_detallepag_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pagar_venta_detallepag_onfocus(this, iSeqRow) });
  $('#id_sc_field_pagar' + iSeqRow).bind('change', function() { sc_form_pagar_venta_pagar_onchange(this, iSeqRow) });
  $('#id_sc_field_caja' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_caja_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_pagar_venta_caja_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_pagar_venta_caja_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_pagar_venta_idfacven_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_numfacven_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_nremision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_credito_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_fechaven_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_fechavenc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_idcli_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_subtotal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_valoriva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_pagada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_asentada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_saldo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_adicional_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_formapago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_adicional3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_obspago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_vendedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_pedido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_resolucion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_dircliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_imconsumo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_retefuente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_reteiva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_reteica_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_cree_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_espos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_cufe_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_enlacepdf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_avisos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_creado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_creado_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_editado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_editado_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_usuario_crea_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_pagar_venta_dias_decredito_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_banco_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_detallepag_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_pagar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pagar_venta_caja_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_pagar_venta_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pagar_venta_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pagar_venta_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pagar_venta_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pagar_venta')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
