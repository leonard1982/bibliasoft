...
;
		...
		if(isset($this->r3[0][0]))
		{
			...
			for($i=0;$i<$vreg;$i++)
			{
				...
				$vdetalle[$i]["precio"]       = round(number_format(($vparcvta/$vcanlista) / ((intval($vporciva)/100)+1),25,'.',''),$vcal_valores_decimales);
