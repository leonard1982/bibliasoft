<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_pedidos_compras']['sc_process_barr'] = true;
require_once('../pdfreport_pedidos_compras/index.php');
unset($_SESSION['scriptcase']['pdfreport_pedidos_compras']['sc_process_barr']);
$ExportCtrl = new pdfreport_pedidos_compras_export_control;
$ExportCtrl->Export_barr();

class pdfreport_pedidos_compras_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['pdfreport_pedidos_compras']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['pdfreport_pedidos_compras']['glo_nm_path_imag_temp'];
