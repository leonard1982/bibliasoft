...
class pdfreport_pedidos_compras_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_pedidos_compras.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['pdfreport_pedidos_compras']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_compras']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_compras']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_compras']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_compras']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_compras']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_compras']['rtf_name']);
      }
...
$_SESSION['scriptcase']['pdfreport_pedidos_compras']['contr_erro'] = 'off'; 
   ...
   function NM_export_dircliente()
   {
         ...
         $this->dircliente = html_entity_decode($this->dircliente, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
   ...
   function NM_export_detallepedido_fl_valorunit()
   {
         ...
         $this->detallepedido_fl_valorunit = NM_charset_to_utf8($this->detallepedido_fl_valorunit);
         $this->detallepedido_fl_valorunit = str_replace('<', '&lt;', $this->detallepedido_fl_valorunit);
         $this->detallepedido_fl_valorunit = str_replace('>', '&gt;', $this->detallepedido_fl_valorunit);
         $this->Texto_tag .= "<td>" . $this->detallepedido_fl_valorunit . "</td>\r\n";
   }
   ...
   function NM_export_detallepedido_fl_valorpar()
   {
         ...
         $this->detallepedido_fl_valorpar = NM_charset_to_utf8($this->detallepedido_fl_valorpar);
         $this->detallepedido_fl_valorpar = str_replace('<', '&lt;', $this->detallepedido_fl_valorpar);
         $this->detallepedido_fl_valorpar = str_replace('>', '&gt;', $this->detallepedido_fl_valorpar);
         $this->Texto_tag .= "<td>" . $this->detallepedido_fl_valorpar . "</td>\r\n";
   }
   ...
   function NM_export_detallepedido_fl_descuento()
   {
         ...
         $this->detallepedido_fl_descuento = NM_charset_to_utf8($this->detallepedido_fl_descuento);
         $this->detallepedido_fl_descuento = str_replace('<', '&lt;', $this->detallepedido_fl_descuento);
         $this->detallepedido_fl_descuento = str_replace('>', '&gt;', $this->detallepedido_fl_descuento);
         $this->Texto_tag .= "<td>" . $this->detallepedido_fl_descuento . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_compras']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_compras']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
