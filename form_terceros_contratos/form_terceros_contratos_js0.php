<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_ter_cont" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_ter_cont']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_contratos']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_terceros_contratos"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_copiar = false;
function sc_btn_copiar()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_copiar(); }, 500);
      return;
    }
    if (Crtl_btn_copiar) {return;}
    scJs_confirm("<?php echo html_entity_decode('Contrato será copiado', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_copiar_ok, sc_btn_copiar_cancel)
}
function sc_btn_copiar_cancel()
{
}
function sc_btn_copiar_ok()
{
    Crtl_btn_copiar = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?copiar?@?";
    document.F1.action = "./";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_contratos']['where_detal']))
  {
?>  
