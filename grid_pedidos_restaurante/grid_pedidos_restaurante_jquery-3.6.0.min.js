...
function grid_pedidos_restaurante_copiar_a_fv_getValue(seqRow) {
  seqRow = scSeqNormalize(seqRow);
  return $("#id_sc_field_copiar_a_fv" + seqRow).find("i").attr("src");
}

function grid_pedidos_restaurante_copiar_a_fv_setValue(newValue, seqRow) {
  seqRow = scSeqNormalize(seqRow);
  $("#id_sc_field_copiar_a_fv" + seqRow).find("img").attr("src", newValue);
}
...
function grid_pedidos_restaurante_getValue(field, seqRow) {
  ...
  if ("copiar_a_fv" == field) {
    SC_tmp = grid_pedidos_restaurante_copiar_a_fv_getValue(seqRow);
  }
...
function grid_pedidos_restaurante_setValue(field, newValue, seqRow) {
  ...
  if ("copiar_a_fv" == field) {
    grid_pedidos_restaurante_copiar_a_fv_setValue(newValue, seqRow);
  }
  if ("prefijo_ped" == field) {
