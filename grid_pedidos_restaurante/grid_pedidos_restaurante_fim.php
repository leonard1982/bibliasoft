...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_pedidos_restaurante"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_pedidos_restaurante"]);
   }
