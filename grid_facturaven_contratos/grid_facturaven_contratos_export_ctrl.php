<?php
@session_start() ;
$_SESSION['scriptcase']['grid_facturaven_contratos']['sc_process_barr'] = true;
require_once('../grid_facturaven_contratos/index.php');
unset($_SESSION['scriptcase']['grid_facturaven_contratos']['sc_process_barr']);
$ExportCtrl = new grid_facturaven_contratos_export_control;
$ExportCtrl->Export_barr();

class grid_facturaven_contratos_export_control
{
