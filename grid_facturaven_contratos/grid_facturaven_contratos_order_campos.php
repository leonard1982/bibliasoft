...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_contratos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_contratos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['barrio'] = "barrio";
   $tab_labels["barrio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["barrio"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["barrio"] : "Barrio";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['numero2'] = "on";
   $tab_def_campos['numero2'] = "numero2";
   $tab_labels["numero2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["numero2"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["numero2"] : "Número";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['direccion2'] = "on";
   $tab_def_campos['direccion2'] = "direccion2";
   $tab_labels["direccion2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["direccion2"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["direccion2"] : "Dirección";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["total"] : "Total";
   ...
   $tab_labels["a4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["a4"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["a4"] : "Ver";
   $tab_ger_campos['numcontrato'] = "on";
   $tab_def_campos['numcontrato'] = "numcontrato";
   $tab_labels["numcontrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["numcontrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["numcontrato"] : "Código";
   $tab_ger_campos['nc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['nc'] = "nc";
   }
   else
   {
       $tab_def_campos['nc'] = "";
   }
   $tab_labels["nc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["nc"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["nc"] : "Anular";
   $tab_ger_campos['pdf_nc'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['pdf_nc'] = "pdf_nc";
   }
   else
   {
       $tab_def_campos['pdf_nc'] = "";
   }
   $tab_labels["pdf_nc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["pdf_nc"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["pdf_nc"] : "PDF NC";
   ...
   $tab_labels["avisos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["avisos"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["avisos"] : "Avisos";
   $tab_ger_campos['ing_terceros'] = "on";
   $tab_def_campos['ing_terceros'] = "ing_terceros";
   $tab_labels["ing_terceros"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["ing_terceros"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['labels']["ing_terceros"] : "Ing Terceros";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_contratos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturaven_contratos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
