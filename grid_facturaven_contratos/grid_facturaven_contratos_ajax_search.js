...
Table_sv_fil[2] = "zona";
Table_sv_fil[3] = "barrio";
Table_sv_fil[4] = "fechaven";
Table_sv_fil[5] = "numcontrato";
Table_sv_fil[6] = "idcli";
Table_sv_fil[7] = "asentada";
Table_sv_fil[8] = "resolucion";
Table_sv_fil[9] = "enviada";
...
function ajax_refresh_field(fields, parms, Proc_on)
{
    ...
    $.ajax({
     ...
     .done(function(json_ref_fil) {
        ...
        if (fields.lastIndexOf('asentada') != -1) {
           $("#SC_asentada").select2('destroy');
           Sc_carga_select2_asentada();
        }
        if (fields.lastIndexOf('resolucion') != -1) {
           $("#SC_resolucion").select2('destroy');
           Sc_carga_select2_resolucion();
        }
        if (fields.lastIndexOf('periodo') != -1) {
           $("#SC_periodo").select2('destroy');
           Sc_carga_select2_periodo();
        }
        if (fields.lastIndexOf('anio') != -1) {
           $("#SC_anio").select2('destroy');
           Sc_carga_select2_anio();
        }
        if (fields.lastIndexOf('barrio') != -1) {
           $("#SC_barrio").select2('destroy');
           Sc_carga_select2_barrio();
        }
        if (fields.lastIndexOf('zona') != -1) {
           $("#SC_zona").select2('destroy');
           Sc_carga_select2_zona();
        }
        if (fields.lastIndexOf('enviada') != -1) {
           $("#SC_enviada").select2('destroy');
