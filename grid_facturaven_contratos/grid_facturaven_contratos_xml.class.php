...
$_SESSION['scriptcase']['grid_facturaven_contratos']['contr_erro'] = 'off'; 
      ...
      while (!$rs->EOF)
      {
         ...
         $this->periodo = $rs->fields[41] ;  
         $this->periodo = (string)$this->periodo;
         $this->anio = $rs->fields[42] ;  
