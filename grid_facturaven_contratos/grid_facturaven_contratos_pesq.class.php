...
?>
<?php echo $SC_Label ?><br><span id="id_hide_anio"  <?php echo $str_hide_anio?>> 
<?php
...
?>
<?php echo $SC_Label ?> <span class="scFilterRequiredOdd">*</span><br><span id="id_hide_zona"  <?php echo $str_hide_zona?>>
<?php
...
?>
<?php echo $SC_Label ?><br><span id="id_hide_barrio"  <?php echo $str_hide_barrio?>>
<?php
      $barrio_look = substr($this->Db->qstr($barrio), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT b.descripcion FROM barrios b inner join zona_clientes z on b.cod_zona=z.codigo WHERE z.nombre='$zona' ORDER BY b.descripcion ASC"; 
...
?>
   <span id="idAjaxSelect_barrio">
      <SELECT class="scFilterObjectOdd" id="SC_barrio" name="barrio"  size="1">
...
?>
      ...
      <TD id='SC_numcontrato_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numcontrato'])) ? $this->New_label['numcontrato'] : "Número Contrato (CodCliente)"; ?></TD>
      
      <INPUT type="hidden" id="SC_numcontrato_cond" name="numcontrato_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numcontrato" <?php echo $str_hide_numcontrato?> valign="top">
...
?>
<INPUT  type="text" id="SC_numcontrato" name="numcontrato" value="<?php echo NM_encode_input($numcontrato) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_idcli_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcli'])) ? $this->New_label['idcli'] : "Cliente"; ?></TD>
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idcli" name="idcli_autocomp" size="60"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_asentada_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['asentada'])) ? $this->New_label['asentada'] : "Asentada"; ?></TD>
...
<?php
 ...
 <OPTION value="0##@@NO"<?php if ($asentada == "0") { echo " selected" ;} ?>>NO</option>
      ...
      <TD id='SC_resolucion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['resolucion'])) ? $this->New_label['resolucion'] : "Prefijo"; ?></TD>
...
?>
      ...
      <TD id='SC_enviada_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['enviada'])) ? $this->New_label['enviada'] : "Enviada"; ?></TD>
      
      <INPUT type="hidden" id="SC_enviada_cond" name="enviada_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_enviada" <?php echo $str_hide_enviada?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
?>
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "barrio" : return ('class="scFilterObjectOdd"'); break;
