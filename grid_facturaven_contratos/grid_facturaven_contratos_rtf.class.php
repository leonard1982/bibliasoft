...
class grid_facturaven_contratos_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
$_SESSION['scriptcase']['grid_facturaven_contratos']['contr_erro'] = 'off'; 
   ...
   function NM_export_nc()
   {
         ...
         $this->nc = str_replace('<', '&lt;', $this->nc);
         $this->nc = str_replace('>', '&gt;', $this->nc);
         $this->Texto_tag .= "<td>" . $this->nc . "</td>\r\n";
   }
   //----- pdf_nc
   function NM_export_pdf_nc()
   {
         $this->pdf_nc = NM_charset_to_utf8($this->pdf_nc);
         $this->pdf_nc = str_replace('<', '&lt;', $this->pdf_nc);
         $this->pdf_nc = str_replace('>', '&gt;', $this->pdf_nc);
         $this->Texto_tag .= "<td>" . $this->pdf_nc . "</td>\r\n";
   }
   //----- avisos
