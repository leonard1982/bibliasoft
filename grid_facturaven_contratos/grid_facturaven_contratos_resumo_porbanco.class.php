...
$_SESSION['scriptcase']['grid_facturaven_contratos']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['arr_total']['banco'];
      }
      else
      {
          $this->array_total_banco = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['arr_total']['banco'] = $this->array_total_banco;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['labels']['banco'] = $Lab_banco; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_order']['porbanco']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_order']['porbanco'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_order']['porbanco'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_display']['porbanco'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_display']['porbanco'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_display']['porbanco'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_display']['porbanco'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_display']['porbanco'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_display']['porbanco'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_contratos']['summarizing_fields_display']['porbanco'] as $i_sum => $d_sum)
           {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_adicional, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $quebra_banco, $quebra_banco_orig)
   {
      //----- Caja
      if (!isset($this->array_total_banco[$quebra_banco_orig]))
      {
         ...
         $this->array_total_banco[$quebra_banco_orig][5] = $sum_base_iva_19;
         $this->array_total_banco[$quebra_banco_orig][6] = $sum_valor_iva_19;
         $this->array_total_banco[$quebra_banco_orig][7] = $sum_base_iva_5;
         $this->array_total_banco[$quebra_banco_orig][8] = $sum_valor_iva_5;
         $this->array_total_banco[$quebra_banco_orig][9] = $sum_excento;
...
$_SESSION['scriptcase']['grid_facturaven_contratos']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->adicional, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->banco, $this->banco_orig);
            }
   }
//
