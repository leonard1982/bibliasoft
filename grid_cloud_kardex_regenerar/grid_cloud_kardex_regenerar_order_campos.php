...
<?php
   ...
   $Ord_Cmp = new grid_cloud_kardex_regenerar_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cloud_kardex_regenerar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_cloud_kardex_regenerar_json.php");
   }
   ...
   $tab_def_campos['fecha_validacion'] = "fecha_validacion";
   $tab_labels["fecha_validacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['labels']["fecha_validacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['labels']["fecha_validacion"] : "Fecha";
   $tab_ger_campos['numero_fe'] = "on";
   $tab_def_campos['numero_fe'] = "numero_fe";
   $tab_labels["numero_fe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['labels']["numero_fe"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['labels']["numero_fe"] : "Numero Fe";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['labels']["tercero"] : "Tercero";
   $tab_ger_campos['cufe'] = "on";
   $tab_def_campos['cufe'] = "cufe";
   $tab_labels["cufe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['labels']["cufe"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['labels']["cufe"] : "Cufe";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> cloud_kardex</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cloud_kardex_regenerar_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_regenerar']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
