<?php
@session_start() ;
$_SESSION['scriptcase']['grid_reciboingreso_seleccionar_factura']['sc_process_barr'] = true;
require_once('../grid_reciboingreso_seleccionar_factura/index.php');
unset($_SESSION['scriptcase']['grid_reciboingreso_seleccionar_factura']['sc_process_barr']);
$ExportCtrl = new grid_reciboingreso_seleccionar_factura_export_control;
$ExportCtrl->Export_barr();

class grid_reciboingreso_seleccionar_factura_export_control
{
