  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_nota_credito" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate prefijo
  function do_ajax_nota_credito_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nota_credito_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_nota_credito_validate_prefijo_cb);
  } // do_ajax_nota_credito_validate_prefijo

  function do_ajax_nota_credito_validate_prefijo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nota_credito_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_nota_credito_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nota_credito_validate_numero(var_numero, var_script_case_init, do_ajax_nota_credito_validate_numero_cb);
  } // do_ajax_nota_credito_validate_numero

  function do_ajax_nota_credito_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nota_credito_validate_numero_cb

  // ---------- Validate factura
  function do_ajax_nota_credito_validate_factura()
  {
    var nomeCampo_factura = "factura";
    var var_factura = scAjaxGetFieldHidden(nomeCampo_factura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nota_credito_validate_factura(var_factura, var_script_case_init, do_ajax_nota_credito_validate_factura_cb);
  } // do_ajax_nota_credito_validate_factura

  function do_ajax_nota_credito_validate_factura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factura";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nota_credito_validate_factura_cb

  // ---------- Validate fecha_nota
  function do_ajax_nota_credito_validate_fecha_nota()
  {
    var nomeCampo_fecha_nota = "fecha_nota";
    var var_fecha_nota = scAjaxGetFieldHidden(nomeCampo_fecha_nota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nota_credito_validate_fecha_nota(var_fecha_nota, var_script_case_init, do_ajax_nota_credito_validate_fecha_nota_cb);
  } // do_ajax_nota_credito_validate_fecha_nota

  function do_ajax_nota_credito_validate_fecha_nota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_nota";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nota_credito_validate_fecha_nota_cb

  // ---------- Validate obs
  function do_ajax_nota_credito_validate_obs()
  {
    var nomeCampo_obs = "obs";
    var var_obs = scAjaxGetFieldHidden(nomeCampo_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nota_credito_validate_obs(var_obs, var_script_case_init, do_ajax_nota_credito_validate_obs_cb);
  } // do_ajax_nota_credito_validate_obs

  function do_ajax_nota_credito_validate_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "obs";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nota_credito_validate_obs_cb

  // ---------- Event onchange prefijo
  function do_ajax_nota_credito_event_prefijo_onchange()
  {
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    var var_numero = scAjaxGetFieldText("numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_nota_credito_event_prefijo_onchange(var_prefijo, var_numero, var_script_case_init, do_ajax_nota_credito_event_prefijo_onchange_cb);
  } // do_ajax_nota_credito_event_prefijo_onchange

  function do_ajax_nota_credito_event_prefijo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_nota_credito_event_prefijo_onchange_cb_after_alert);
  } // do_ajax_nota_credito_event_prefijo_onchange_cb
  function do_ajax_nota_credito_event_prefijo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_nota_credito_event_prefijo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_nota_credito_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_nota_credito_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    ...
    var var_fecha_nota = scAjaxGetFieldHidden("fecha_nota");
    var var_obs = scAjaxGetFieldHidden("obs");
    ...
    scAjaxProcOn();
    x_ajax_nota_credito_submit_form(var_prefijo, var_numero, var_factura, var_fecha_nota, var_obs, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_nota_credito_submit_form_cb);
  } // do_ajax_nota_credito_submit_form

  function do_ajax_nota_credito_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_nota_credito_submit_form_cb_after_alert);
  } // do_ajax_nota_credito_submit_form_cb
  function do_ajax_nota_credito_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_nota_credito_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_nota_credito_navigate_form()
  {
    perform_ajax_nota_credito_navigate_form();
  }

  function perform_ajax_nota_credito_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_nota_credito_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['nota_credito']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_nota_credito_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_nota_credito_navigate_form_cb_after_alert);
  } // do_ajax_nota_credito_navigate_form_cb
  function do_ajax_nota_credito_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_nota_credito_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_nota_credito_navigate_form_cb_after_alert
  function sc_hide_nota_credito_form()
  {
  ...
  ajax_field_list[2] = "factura";
  ajax_field_list[3] = "fecha_nota";
  ajax_field_list[4] = "obs";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "prefijo": {"label": "Prefijo NC:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numero": {"label": "Nota número:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "factura": {"label": "Factura para anular:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_nota": {"label": "Fecha:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "obs": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "fecha_nota": new Array("hidden_field_label_fecha_nota", "hidden_field_data_fecha_nota"),
