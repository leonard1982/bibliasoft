...
$old_error_handler = set_error_handler("nota_credito_mob_scriptcase_error_handler");

function nota_credito_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['nota_credito_mob']['contr_erro']) && $_SESSION['scriptcase']['nota_credito_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_nota_credito_mob->contr_nota_credito_mob->Apl_com_erro = true;
            if ($inicial_nota_credito_mob->contr_nota_credito_mob->NM_ajax_flag)
            {
                $inicial_nota_credito_mob->contr_nota_credito_mob->NM_ajax_info['errList']['geral_nota_credito_mob'][] = $msg;
                return;
            }
            nota_credito_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function nota_credito_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['nota_credito_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['nota_credito_mob'])  ? $_SESSION['scriptcase']['error_icon']['nota_credito_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['nota_credito_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['nota_credito_mob']) ? $_SESSION['scriptcase']['error_span_title']['nota_credito_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['nota_credito_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['nota_credito_mob']) ? $_SESSION['scriptcase']['error_icon_title']['nota_credito_mob'] : '';
?>
