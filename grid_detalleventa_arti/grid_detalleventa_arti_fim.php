...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleventa_arti"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleventa_arti"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleventa_arti</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_arti']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_detalleventa_arti' || $achou)
          {
