...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detalleventa_arti"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detalleventa_arti"]);
   }
