...
<?php
 ...
 <OPTION value="FV##@@FACTURA"<?php if ($tipo == "FV") { echo " selected" ;} ?>>FACTURA</option>
      ...
      <TD id='SC_fechaven_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : "Fecha"; ?></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fechaven"  <?php echo $str_display_fechaven; ?> class="scFilterFieldFontEven">
...
?>
      ...
      <TD id='SC_inicio_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['inicio'])) ? $this->New_label['inicio'] : "Fecha y hora inicio:"; ?></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_fin_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fin'])) ? $this->New_label['fin'] : "Fecha y hora fin:"; ?></TD>
