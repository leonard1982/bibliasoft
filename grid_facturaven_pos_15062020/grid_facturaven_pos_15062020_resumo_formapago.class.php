...
$_SESSION['scriptcase']['grid_facturaven_pos_15062020']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_credito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['arr_total']['credito'];
      }
      else
      {
          $this->array_total_credito = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_order']['formapago']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_order']['formapago'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_order']['formapago'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_display']['formapago'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_display']['formapago'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_display']['formapago'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_display']['formapago'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_display']['formapago'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_display']['formapago'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['summarizing_fields_display']['formapago'] as $i_sum => $d_sum)
           {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['pivot_order_level'] = -1;
       }
