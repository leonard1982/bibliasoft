<?php
@session_start() ;
$_SESSION['scriptcase']['grid_facturaven_pos_15062020']['sc_process_barr'] = true;
require_once('../grid_facturaven_pos_15062020/index.php');
unset($_SESSION['scriptcase']['grid_facturaven_pos_15062020']['sc_process_barr']);
$ExportCtrl = new grid_facturaven_pos_15062020_export_control;
$ExportCtrl->Export_barr();

class grid_facturaven_pos_15062020_export_control
{
