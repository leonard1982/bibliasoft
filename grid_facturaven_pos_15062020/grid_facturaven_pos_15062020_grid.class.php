<?php
class grid_facturaven_pos_15062020_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['charts_html'] = '';
   ...
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
      {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
       { 
           include_once($this->Ini->path_embutida . "grid_facturaven_pos_15062020/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
           include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_facturaven_pos_15062020_resumo();
       $this->Res->Db     = $this->Db;
       ...
       if (!$this->Proc_link_res && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != 'pdf' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != 'print')
       { 
           $this->html_interativ_search();
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ajax_nav'])
           { 
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       $nm_saida->saida("      <TD class=\"scGridRefinedSearchMolduraResult\" valign='top'>\r\n");
       $nm_saida->saida("       <table width='100%' cellspacing=0 cellpadding=0>\r\n");
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_facturaven_pos_15062020'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
           $this->nmgp_embbed_placeholder_top();
       } 
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['save_grid']))
       {
           $this->refresh_interativ_search();
       }
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['graf_pdf'] == "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
       { 
           ...
           elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && $Gera_graf)
           { 
               $this->grafico_pdf();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = "grid";
           } 
       ...
       { 
           ...
           if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf")
           { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_pdf']['all_label'] : "N";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_facturaven_pos_15062020/grid_facturaven_pos_15062020_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['force_toolbar']);
   } 
   ...
   {
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1)
       {
           $this->width_tabula_quebra  = (((count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) - 1) * 13) + 3) . "px";
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['mostra_edit'] = "N";
   }
   $this->NM_cont_emb_linha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['emb_linha'];
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = "muda_qt_linhas";
   } 
       ob_start(); 
...
$_SESSION['scriptcase']['grid_facturaven_pos_15062020']['contr_erro'] = 'off'; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_sql_btn_run'] = array(); 
   $this->NM_btn_run_show = ($this->Ini->SC_Link_View || $this->grid_emb_form || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida']) ? false : true;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq']) 
   { 
      $this->nmgp_botoes['Eliminar'] = "off";
      $this->nmgp_botoes['Reversar'] = "off";
      $this->nmgp_botoes['Asentar'] = "off";
   } 
   if ($this->nmgp_botoes['Eliminar'] != "on" && $this->nmgp_botoes['Reversar'] != "on" && $this->nmgp_botoes['Asentar'] != "on") 
   { 
      $this->NM_btn_run_show = false;
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "print" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf") 
   { 
      $this->NM_btn_run_show = false;
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_facturaven_pos_15062020/grid_facturaven_pos_15062020_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_facturaven_pos_15062020_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] = 15;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "fecha") 
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "fecha") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra']['fechaven']["fechaven"] = "asc"; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       { 
           ...
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
               ...
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra'][$cmp_var][$SC_Sql_col] = $SC_Sql_order;
               }
           }
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "formapago") 
   {
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra']['credito']["credito"] = "asc"; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "porcliente") 
   {
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra']['idcli']["idcli"] = "asc"; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "_NM_SC_") 
   {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['prim_cons'] || !empty($nmgp_parms))  
   { 
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao']       = "igual" ; 
...
// 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'] == "all") 
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['contr_array_resumo']))  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_desc']; 
   } 
   ...
   {
       $nmgp_order_by = " order by credito";
   }
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_facturaven_pos_15062020_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_facturaven_pos_15062020_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_facturaven_pos_15062020_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_facturaven_pos_15062020_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_facturaven_pos_15062020_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid']) . ";\r\n");
           }
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
...
$nm_saida->saida("}\r\n");
       ...
       $write_css = true;
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_pos_15062020_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
       {
 ...
 { 
       ...
       elseif ($this->NM_opcao == "print" || $this->Print_All)
       {
           ...
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_pos_15062020_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_facturaven_pos_15062020_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_facturaven_pos_15062020/grid_facturaven_pos_15062020_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_facturaven_pos_15062020_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && !$this->Print_All)
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "fecha")
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['pdf_res'])
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               ...
               {
                   $groupByLabel = sprintf("F.Pago", "credito");
                   $nm_saida->saida("          <div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">{$groupByLabel}</H1></div>\r\n");
               } 
           }
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "formapago")
   ...
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print") 
       { 
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_facturaven_pos_15062020\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_facturaven_pos_15062020\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_facturaven_pos_15062020\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_facturaven_pos_15062020\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_facturaven_pos_15062020\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_facturaven_pos_15062020\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
   }  
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida']) ? "grid_facturaven_pos_15062020_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   { 
     ...
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf_vert']) 
     {
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_facturaven_pos_15062020__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_facturaven_pos_15062020-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_label']) { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] != "pdf") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_imprimir_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_facturaven_pos_15062020_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_credito()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'credito')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
 ...
 function NM_label_tipo()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'tipo')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_resolucion()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'resolucion')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_numfacven()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'numfacven')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_fechaven()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'fechaven')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_idcli()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'idcli')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_vendedor()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'vendedor')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_idfacven()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'idfacven')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_fechavenc()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'fechavenc')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_asentada()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_cmp'] == 'asentada')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['credito'])) ? $this->New_label['credito'] : "F.Pago"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['credito'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tipo'])) ? $this->New_label['tipo'] : "Tipo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['tipo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['resolucion'])) ? $this->New_label['resolucion'] : "PJ"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['resolucion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "No"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['numfacven'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : "Fecha"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['fechaven'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['idcli'])) ? $this->New_label['idcli'] : "Cliente"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['idcli'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['total'])) ? $this->New_label['total'] : "Total"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['vendedor'])) ? $this->New_label['vendedor'] : "Vendedor"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['vendedor'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['banco'])) ? $this->New_label['banco'] : "Caja"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['banco'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['editarpos'])) ? $this->New_label['editarpos'] : "Editar"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['editarpos'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['imprimircopia'])) ? $this->New_label['imprimircopia'] : "POS"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['imprimircopia'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['a4'])) ? $this->New_label['a4'] : "A4"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['a4'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['idfacven'])) ? $this->New_label['idfacven'] : "Idfacven"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['idfacven'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fechavenc'])) ? $this->New_label['fechavenc'] : "Fechavenc"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['fechavenc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['subtotal'])) ? $this->New_label['subtotal'] : "SubTotal"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['subtotal'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['valoriva'])) ? $this->New_label['valoriva'] : "IVA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['valoriva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pagada'])) ? $this->New_label['pagada'] : "Pagada"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['pagada'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asentada'])) ? $this->New_label['asentada'] : "Asentada"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['asentada'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['observaciones'])) ? $this->New_label['observaciones'] : "Observaciones"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['observaciones'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['saldo'])) ? $this->New_label['saldo'] : "Saldo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['saldo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['adicional'])) ? $this->New_label['adicional'] : "Desc."; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['adicional'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['adicional2'])) ? $this->New_label['adicional2'] : "Adicional 2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['adicional2'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['adicional3'])) ? $this->New_label['adicional3'] : "Adicional 3"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['adicional3'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['creado'])) ? $this->New_label['creado'] : "Creado"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['creado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['editado'])) ? $this->New_label['editado'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['editado'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['usuario_crea'])) ? $this->New_label['usuario_crea'] : "Usuario Crea"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['usuario_crea'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cod_cuenta'])) ? $this->New_label['cod_cuenta'] : "Cod Cuenta"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['cod_cuenta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['imprimir'])) ? $this->New_label['imprimir'] : "PDF"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['labels']['imprimir'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_15062020']['lig_edit'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_refresh'] = false;
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_facturaven_pos_15062020#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['cab_embutida'] != "S")
               {
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_facturaven_pos_15062020\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_facturaven_pos_15062020\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_facturaven_pos_15062020', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_facturaven_pos_15062020', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_facturaven_pos_15062020', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" &&
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_facturaven_pos_15062020\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_facturaven_pos_15062020\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_facturaven_pos_15062020\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_facturaven_pos_15062020\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
       $nm_saida->saida("</TABLE>\r\n");
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_facturaven_pos_15062020\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_facturaven_pos_15062020\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_facturaven_pos_15062020#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-5fe7b166\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Page_break_PDF'] = array();
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] == 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "fecha") 
   { 
   ...
   $this->SC_bot[]     = "tipo"; 
   $this->SC_top[]     = "tipo"; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] == 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       $Nivel_gb = 1;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] == 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "formapago") 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] == 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "porcliente") 
   { 
       if (isset($this->idcli))
       {
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          $this->NM_field_style = array();
          $this->NM_cont_emb_linha++;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['emb_linha']++;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_facturaven_pos_15062020_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          {
              $this->SC_seq_btn_run++;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_sql_btn_run'][$this->SC_seq_btn_run] = $this->rs_grid->fields;
          }
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final'] + 1; 
          ...
          {  
              ...
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby']]['fechaven'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Page_break_PDF']['fechaven'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $Format_tst = $this->Ini->Get_Gb_date_format('fecha', 'fechaven');
          ...
          {  
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
          ...
          {  
              ...
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby']]['credito'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Page_break_PDF']['credito'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->credito_Old = $this->credito ; 
          ...
          {  
              ...
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby']]['idcli'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Page_break_PDF']['idcli'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->idcli_Old = $this->idcli ; 
...
$_SESSION['scriptcase']['grid_facturaven_pos_15062020']['contr_erro'] = 'off';
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
              { 
                 if ($this->pdf_all_label == "S" && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] == "_NM_SC_")) 
                 { } 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['mostra_edit'] != "N"){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  NOWRAP align=\"center\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr><td style=\"padding: 0px\"><img id=\"b_open_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_close_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">\r\n");
          $nm_saida->saida("<img id=\"b_close_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_open_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">\r\n");
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] != "pdf"){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  NOWRAP align=\"center\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\"><img id=\"b_open_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:''\" onclick=\"document.getElementById('b_open_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_close_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">\r\n");
          $nm_saida->saida("<img id=\"b_close_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "\" style=\"display:none\" onclick=\"document.getElementById('b_close_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; document.getElementById('b_open_emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = ''; document.getElementById('emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "').style.display = 'none'; return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">\r\n");
          $nm_saida->saida("</TD>\r\n");
 } 
          ...
          { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] != "pdf")
              { 
                  $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:none\">\r\n");
              } 
              else 
              { 
                  $nm_saida->saida("<TR  class=\"" . $this->css_line_back . "\" id=\"emb_grid_facturaven_pos_15062020_linha_" . $this->NM_cont_emb_linha . "\"  style=\"display:''\">\r\n");
              } 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
 ...
 function NM_grid_credito()
 {
      ...
      if (!isset($this->NM_cmp_hidden['credito']) || $this->NM_cmp_hidden['credito'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && !empty($conteudo)) 
          { 
              ...
              $Style_credito = "";
          if (isset($this->NM_field_style["credito"]) && !empty($this->NM_field_style["credito"]))
          {
              $Style_credito .= $this->NM_field_style["credito"];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'])
          {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_credito_grid_line . "\"  style=\"" . $this->Css_Cmp['css_credito_grid_line'] . $Style_credito . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_credito_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_resolucion()
 {
      ...
      if (!isset($this->NM_cmp_hidden['resolucion']) || $this->NM_cmp_hidden['resolucion'] != "off") { 
          ...
          { 
              ...
              $conteudo = $str_tem_display; 
              $Style_resolucion = "";
          if (isset($this->NM_field_style["resolucion"]) && !empty($this->NM_field_style["resolucion"]))
          {
              $Style_resolucion .= $this->NM_field_style["resolucion"];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'])
          {
              $this->SC_nowrap = "NOWRAP";
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_resolucion_grid_line . "\"  style=\"" . $this->Css_Cmp['css_resolucion_grid_line'] . $Style_resolucion . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_resolucion_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_numfacven()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_numfacven_grid_line . "\"  style=\"" . $this->Css_Cmp['css_numfacven_grid_line'] . $Style_numfacven . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\">\r\n");
 if (!$this->Ini->Proc_print && !$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;"){ $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Ind_lig_mult']++;
       ...
       if (isset($this->Ini->sc_lig_md5["pdfreport_facturaven"]) && $this->Ini->sc_lig_md5["pdfreport_facturaven"] == "S") {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['under_dashboard'] && isset($linkTarget))
           {
               if ('' != $Parms_Lig)
               {
                   $Parms_Lig .= '*scout';
               }
               $Parms_Lig .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['remove_border'] ? '1' : '0');
           }
           $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_facturaven_pos_15062020@SC_par@" . md5($Parms_Lig);
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
       } else {
           $Md5_Lig = "nmgp_lig_edit_lapis?#?S?@?par_numfacventa?#?" . str_replace("'", "@aspass@", $this->idfacven) . "?@?";
       }
   $nm_saida->saida("<a id=\"id_sc_field_numfacven_" . $this->SC_seq_page . "\" href=\"javascript:nm_gp_submit5('" . $this->Ini->link_pdfreport_facturaven_cons . "', '$this->nm_location', '$Md5_Lig', '" . (isset($linkTarget) ? $linkTarget : '_blank') . "', 'inicio', '0', '0', '', 'pdfreport_facturaven', '" . $this->SC_ancora . "')\" onMouseover=\"nm_mostra_hint(this, event, 'Ver Factura de Venta')\" onMouseOut=\"nm_apaga_hint()\" class=\"" . $this->Ini->cor_link_dados . $this->css_sep . $this->css_numfacven_grid_line . "\" style=\"" . $this->Css_Cmp['css_numfacven_grid_line'] . $Style_numfacven . "\">" . $conteudo . "</a>\r\n");
} else {
 ...
 function NM_grid_detalleventa()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_detalleventa_grid_line . "\"  style=\"" . $this->Css_Cmp['css_detalleventa_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          if (!$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] != "pdf")
          { 
              $link_div = "";
          ...
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
              { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['emb_lig_aba'] = array_merge($this->Ini->Init_apl_lig, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle']['emb_lig_aba']);
              }
              else 
              { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle']['embutida_treeview'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] != "pdf")
          { 
 ...
 function NM_grid_a4()
 {
      ...
      if (!isset($this->NM_cmp_hidden['a4']) || $this->NM_cmp_hidden['a4'] != "off") { 
          ...
          { 
              ...
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['doc_word'] || $this->Img_embbed || $this->Ini->sc_export_ajax_img) 
              { 
 ...
 {
   $this->NM_colspan  = 30;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] || $this->NM_btn_run_show)
   {
       $this->NM_colspan++;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_pdf'] == "pdf")
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 { global
   ...
   { 
       ...
       if ($this->SC_tab_quebra > 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida_grid'])
       {
 ...
 function quebra_credito_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   $tot_credito = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['credito'] : 0;
 ...
 function quebra_fechaven_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fechaven = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fechaven'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_fechaven = 0; 
   $cont_quebra_fechaven++;
   $nm_nivel_book_pdf = "";
 ...
 function quebra_fechavenc_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fechavenc = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fechavenc'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_idcli_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_idcli = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['idcli'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_pagada_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_pagada = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['pagada'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_asentada_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_asentada = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['asentada'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_resolucion_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_resolucion = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['resolucion'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_vendedor_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_vendedor = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['vendedor'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_tipo_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_tipo = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['tipo'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
 ...
 function quebra_geral_fecha_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      = $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][0];
   $tit_lin_sumariza_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][0];
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "total" && (!isset($this->NM_cmp_hidden['total']) || $this->NM_cmp_hidden['total'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][2] ; 
      nmgp_Form_Num_Val($conteudo, ",", ",", "0", "S", "2", "$", "V:3:12", "-"); 
    ...
    if ($Cada_cmp == "subtotal" && (!isset($this->NM_cmp_hidden['subtotal']) || $this->NM_cmp_hidden['subtotal'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][3] ; 
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
    ...
    if ($Cada_cmp == "valoriva" && (!isset($this->NM_cmp_hidden['valoriva']) || $this->NM_cmp_hidden['valoriva'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][4] ; 
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
    ...
    if ($Cada_cmp == "adicional" && (!isset($this->NM_cmp_hidden['adicional']) || $this->NM_cmp_hidden['adicional'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['tot_geral'][5] ; 
      nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
 ...
 function quebra_geral__NM_SC__bot() 
 {
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['group_2'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_facturaven_pos_15062020/grid_facturaven_pos_15062020_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_facturaven_pos_15062020/grid_facturaven_pos_15062020_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_facturaven_pos_15062020/grid_facturaven_pos_15062020_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_facturaven_pos_15062020/grid_facturaven_pos_15062020_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_2_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
          $Q_free  = false;
          ...
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Groupby_hide']))
              {
                  $Q_count++;
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
        {
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
      ...
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['SC_Ind_Groupby'] != "_NM_SC_")
          {
      ...
      { 
           if (isset($this->Ini->sc_lig_md5["terceros_cliente"]) && $this->Ini->sc_lig_md5["terceros_cliente"] == "S") {
               ...
               $btn_value = "Nuevo Cliente";
               if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($btn_value))
               {
                   $btn_value = sc_convert_encoding($btn_value, $_SESSION['scriptcase']['charset'], "UTF-8");
               }
               $btn_hint = "Nuevo Cliente";
               if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($btn_hint))
               {
                   $btn_hint = sc_convert_encoding($btn_hint, $_SESSION['scriptcase']['charset'], "UTF-8");
               }
          $nm_saida->saida("<img src=\"" . $this->Ini->path_botoes . "/scriptcase__NM__ico__NM__user_add_32.png\"  id=\"sc_SC_btn_1_top\" onClick=\"nm_gp_submit5('" . $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('terceros_cliente') . "/index.php', '$this->nm_location', '" . $Md5_Lig . "', '_blank', '', '', '', '', 'terceros_cliente');; return false\" border=\"0px\" title=\"" . $btn_hint . "\" style=\"vertical-align: middle;cursor: pointer;\" align=\"absmiddle\">\r\n");
          $NM_btn = true;
      } 
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
      ...
      { 
           if (isset($this->Ini->sc_lig_md5["frm_pos"]) && $this->Ini->sc_lig_md5["frm_pos"] == "S") {
               ...
               $btn_hint = "Nueva factura POS";
               if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($btn_hint))
               {
                   $btn_hint = sc_convert_encoding($btn_hint, $_SESSION['scriptcase']['charset'], "UTF-8");
               }
          $nm_saida->saida("<img src=\"" . $this->Ini->path_botoes . "/scriptcase__NM__ico__NM__cashier_32.png\"  id=\"sc_SC_btn_0_top\" onClick=\"nm_gp_submit5('" . $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('frm_pos') . "/index.php', '$this->nm_location', '" . $Md5_Lig . "', '_self', '', '', '', '', 'frm_pos');; return false\" border=\"0px\" title=\"" . $btn_hint . "\" style=\"vertical-align: middle;cursor: pointer;\" align=\"absmiddle\">\r\n");
          $NM_btn = true;
      } 
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
      ...
      { 
               ...
               $btn_hint = "Asentar una factura";
               if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($btn_hint))
               {
                   $btn_hint = sc_convert_encoding($btn_hint, $_SESSION['scriptcase']['charset'], "UTF-8");
               }
          $nm_saida->saida("<img src=\"" . $this->Ini->path_botoes . "/scriptcase__NM__ico__NM__data_into_32.png\"  id=\"sc_Asentar_top\" onClick=\"sc_btn_Asentar();; return false\" border=\"0px\" title=\"" . $btn_hint . "\" style=\"vertical-align: middle;cursor: pointer;\" align=\"absmiddle\">\r\n");
          $NM_btn = true;
      } 
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
      ...
      { 
          ...
          $nm_saida->saida("<img src=\"" . $this->Ini->path_botoes . "/scriptcase__NM__ico__NM__data_out_32.png\"  id=\"sc_Reversar_top\" onClick=\"sc_btn_Reversar();; return false\" border=\"0px\" title=\"" . $btn_hint . "\" style=\"vertical-align: middle;cursor: pointer;\" align=\"absmiddle\">\r\n");
          $NM_btn = true;
      } 
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
      ...
      { 
               ...
               $btn_hint = "Eliminar una factura";
               if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($btn_hint))
               {
                   $btn_hint = sc_convert_encoding($btn_hint, $_SESSION['scriptcase']['charset'], "UTF-8");
               }
          $nm_saida->saida("<img src=\"" . $this->Ini->path_botoes . "/scriptcase__NM__ico__NM__garbage_delete_32.png\"  id=\"sc_Eliminar_top\" onClick=\"sc_btn_Eliminar();; return false\" border=\"0px\" title=\"" . $btn_hint . "\" style=\"vertical-align: middle;cursor: pointer;\" align=\"absmiddle\">\r\n");
          $NM_btn = true;
      } 
      if (is_file($this->Ini->root . $this->Ini->path_img_global . $this->Ini->Img_sep_grid))
      {
      ...
      { 
           if (isset($this->Ini->sc_lig_md5["control_copiar_documento_como"]) && $this->Ini->sc_lig_md5["control_copiar_documento_como"] == "S") {
               $Parms_Lig  = "script_case_init*scin" . NM_encode_input($this->Ini->sc_page) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout";
               $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_facturaven_pos_15062020@SC_par@" . md5($Parms_Lig);
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
           } else {
               $Md5_Lig  = "script_case_init*scin" . NM_encode_input($this->Ini->sc_page) . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scoutsc_redir_atualiz*scinok*scoutsc_redir_insert*scinok*scoutNMSC_modal*scinok*scout";
           }
      ...
      if ($this->nmgp_botoes['gridsave'] == "on" && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          if (is_file("grid_facturaven_pos_15062020_help.txt") && !$this->grid_emb_form)
          {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 15) ? " selected" : "";
              $nm_saida->saida("           <option value=\"15\" " . $obj_sel . ">15</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 50) ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 100) ? " selected" : "";
              $nm_saida->saida("           <option value=\"100\" " . $obj_sel . ">100</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 200) ? " selected" : "";
              $nm_saida->saida("           <option value=\"200\" " . $obj_sel . ">200</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 300) ? " selected" : "";
              $nm_saida->saida("           <option value=\"300\" " . $obj_sel . ">300</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 500) ? " selected" : "";
              $nm_saida->saida("           <option value=\"500\" " . $obj_sel . ">500</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == 1000) ? " selected" : "";
              $nm_saida->saida("           <option value=\"1000\" " . $obj_sel . ">1000</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] == all) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['nav']))
          {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
   ...
   function nmgp_embbed_placeholder_bot()
   {
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $str_value = preg_replace('/'. $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ] .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ]))) == 0)
                    {
                        $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campos_busca'][ $field ]));
                    }
                }
            }
        }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('numfacven', 'idcli', 'observaciones'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $str_value = preg_replace('/'. $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][2] .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
   ...
   {
       global $nm_saida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_sql']   = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['fechaven'] = (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : 'Fecha';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_sql']['fechaven']   = "fechaven";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['total'] = (isset($this->New_label['total'])) ? $this->New_label['total'] : 'Total';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_sql']['total']   = "total";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['idcli'] = (isset($this->New_label['idcli'])) ? $this->New_label['idcli'] : 'Cliente';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_sql']['idcli']   = "idcli";
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']["fechaven"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']["fechaven"])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['fechaven'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_pesq']))
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_pesq'];
       }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_resumo'])) 
   { 
       if (empty($tmp_where)) 
       { 
           $tmp_where = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_resumo']; 
       } 
       else
       { 
           $tmp_where .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['where_resumo'] . ")"; 
       } 
   } 
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']['fechaven'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']['fechaven']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['fechaven']) . "','fechaven','id_int_search_fechaven','fechaven', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['fechaven']) . "','fechaven','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'fechaven', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['fechaven']) . "','fechaven','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'fechaven', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       if (count($result) > 1)
       {
           ...
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['fechaven']) . "','fechaven','id_int_search_fechaven','fechaven', '');", "nm_proc_int_search('chbx', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['fechaven']) . "','fechaven','id_int_search_fechaven','fechaven', '');", "app_int_search_fechaven", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']["total"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']["total"])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['total'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
   ...
   { 
       ...
       $nm_comando .= " order by total DESC";
       $result = array();
       $range_max = false;
       $range_min = false;
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']['total'])) ? "" : "none";
     ...
     if(count($result) >=2)
     {
       ...
       $range_min = $range_min - ($range_min % 1000);
       $range_max = $range_max - (($range_max - $range_min) % 1000) + 1000;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['refin_slider_total'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['refin_slider_total']['min'] = $range_min;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['refin_slider_total']['max'] = $range_max;
           $range_min_orig = $range_min;
           $range_max_orig = $range_max;
       }
       else {
           $range_min_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['refin_slider_total']['min'];
           $range_max_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['refin_slider_total']['max'];
       }
       $lin_obj  .= "   <div class='scGridRefinedSearchCampo'>";
           ...
           nmgp_Form_Num_Val($range_min_formatado, ",", ",", "0", "S", "2", "", "N:12", "-") ; 
           nmgp_Form_Num_Val($range_max_formatado, ",", ",", "0", "S", "2", "", "N:12", "-") ; 
...
";
      ...
      $lin_obj  .= "            val_format1 = JS_Format_Num_Val( ui.values[ 0 ], ',', ',', '0', 'S', '2', '', 'N:12', '-');";
      $lin_obj  .= "            val_format2 = JS_Format_Num_Val( ui.values[ 1 ], ',', ',', '0', 'S', '2', '', 'N:12', '-');";
      $lin_obj  .= "            $( '#id_slider_total_values_min' ).html(val_format1);";
      $lin_obj  .= "            $( '#id_slider_total_values_max' ).html(val_format2);";
      $lin_obj  .= "        },";
      $lin_obj  .= "    });";
      $lin_obj  .= "nm_expand_int_search('total');";
      $lin_obj  .= "        adjustMobile();";
      $lin_obj  .= "});";
      $lin_obj  .= "</SCRIPT>";
       $lin_obj  .= "   </div>";
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       $lin_obj  .= "   </div></td></tr>";
           ...
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('range', 'bw','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['total']) . "','total','id_int_search_total','total', '');", "nm_proc_int_search('range', 'bw','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['total']) . "','total','id_int_search_total','total', '');", "app_int_search_range_total", "", "", "display: $disp_btn_range", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $lin_obj .= "      </div>";
           $lin_obj .= "     </td>";
           $lin_obj .= "    </tr>";
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']["idcli"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']["idcli"])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['idcli'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
   ...
   { 
       ...
       $nm_comando .= " order by idcli DESC";
       $result = array();
       $range_max = false;
       $range_min = false;
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']['idcli'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           $lin_obj  .= "  <table cellspacing=0 cellpadding=0>";
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['interativ_search']['idcli']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['idcli']) . "','idcli','id_int_search_idcli','idcli', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['idcli']) . "','idcli','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'idcli', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['idcli']) . "','idcli','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'idcli', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
...
";
      $lin_obj  .= "$( document ).ready(function() {";
      $lin_obj  .= "nm_expand_int_search('idcli');";
      $lin_obj  .= "    adjustMobile();";
      $lin_obj  .= "});";
      $lin_obj  .= "</SCRIPT>";
       $lin_obj  .= "   </div></td></tr>";
       ...
       if (count($result) > 1)
       {
           ...
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['idcli']) . "','idcli','id_int_search_idcli','idcli', '');", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['int_search_label']['idcli']) . "','idcli','id_int_search_idcli','idcli', '');", "app_int_search_idcli", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
...
//--- 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_facturaven_pos_15062020\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_facturaven_pos_15062020\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </div>\r\n");
   ...
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['ajax_nav'])
       {
   ...
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_facturaven_pos_15062020', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_facturaven_pos_15062020\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_facturaven_pos_15062020_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['sc_modal']) || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['dashboard_info']['under_dashboard'])) {
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_facturaven_pos_15062020';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_facturaven_pos_15062020');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_facturaven_pos_15062020');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_facturaven_pos_15062020');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_facturaven_pos_15062020');} \r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret']) )
   {
      ...
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos_15062020']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_facturaven_pos_15062020_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_15062020']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_facturaven_pos_15062020')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_facturaven_pos_15062020', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
