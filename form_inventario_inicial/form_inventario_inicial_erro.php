...
$old_error_handler = set_error_handler("form_inventario_inicial_scriptcase_error_handler");

function form_inventario_inicial_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_inventario_inicial']['contr_erro']) && $_SESSION['scriptcase']['form_inventario_inicial']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_inventario_inicial;
            $inicial_form_inventario_inicial->contr_form_inventario_inicial->Apl_com_erro = true;
            if ($inicial_form_inventario_inicial->contr_form_inventario_inicial->NM_ajax_flag)
            {
                $inicial_form_inventario_inicial->contr_form_inventario_inicial->NM_ajax_info['errList']['geral_form_inventario_inicial'][] = $msg;
                return;
            }
            form_inventario_inicial_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_inventario_inicial_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_inventario_inicial'])  && '' != $_SESSION['scriptcase']['error_icon']['form_inventario_inicial'])  ? $_SESSION['scriptcase']['error_icon']['form_inventario_inicial']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_inventario_inicial']) && '' != $_SESSION['scriptcase']['error_span_title']['form_inventario_inicial']) ? $_SESSION['scriptcase']['error_span_title']['form_inventario_inicial'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_inventario_inicial']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_inventario_inicial']) ? $_SESSION['scriptcase']['error_icon_title']['form_inventario_inicial'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_inventario_inicial']['error_buffer'] .= ob_get_flush();
}
