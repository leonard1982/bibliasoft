  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_inventario_inicial" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_inventario_inicial_form();
	}
...
?>
  ...
  function do_ajax_form_inventario_inicial_validate_cod_barras_(iNumLinha)
  {
    var nomeCampo_cod_barras_ = "cod_barras_" + iNumLinha;
    var var_cod_barras_ = scAjaxGetFieldText(nomeCampo_cod_barras_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_cod_barras_(var_cod_barras_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_cod_barras__cb);
  } // do_ajax_form_inventario_inicial_validate_cod_barras_

  function do_ajax_form_inventario_inicial_validate_cod_barras__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_cod_barras__cb

  // ---------- Validate idpro_
  function do_ajax_form_inventario_inicial_validate_idpro_(iNumLinha)
  {
  } // do_ajax_form_inventario_inicial_validate_idpro_

  function do_ajax_form_inventario_inicial_validate_idpro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_idpro__cb

  // ---------- Validate colores_
  function do_ajax_form_inventario_inicial_validate_colores_(iNumLinha)
  {
    var nomeCampo_colores_ = "colores_" + iNumLinha;
    var var_colores_ = scAjaxGetFieldSelect(nomeCampo_colores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_colores_(var_colores_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_colores__cb);
  } // do_ajax_form_inventario_inicial_validate_colores_

  function do_ajax_form_inventario_inicial_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_form_inventario_inicial_validate_tallas_(iNumLinha)
  {
    var nomeCampo_tallas_ = "tallas_" + iNumLinha;
    var var_tallas_ = scAjaxGetFieldSelect(nomeCampo_tallas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_tallas_(var_tallas_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_tallas__cb);
  } // do_ajax_form_inventario_inicial_validate_tallas_

  function do_ajax_form_inventario_inicial_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_form_inventario_inicial_validate_sabor_(iNumLinha)
  {
    var nomeCampo_sabor_ = "sabor_" + iNumLinha;
    var var_sabor_ = scAjaxGetFieldSelect(nomeCampo_sabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_sabor_(var_sabor_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_sabor__cb);
  } // do_ajax_form_inventario_inicial_validate_sabor_

  function do_ajax_form_inventario_inicial_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_sabor__cb

  // ---------- Validate cantidad_
  function do_ajax_form_inventario_inicial_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_cantidad__cb);
  } // do_ajax_form_inventario_inicial_validate_cantidad_

  function do_ajax_form_inventario_inicial_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_cantidad__cb

  // ---------- Validate costo_
  function do_ajax_form_inventario_inicial_validate_costo_(iNumLinha)
  {
    var nomeCampo_costo_ = "costo_" + iNumLinha;
    var var_costo_ = scAjaxGetFieldText(nomeCampo_costo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_costo_(var_costo_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_costo__cb);
  } // do_ajax_form_inventario_inicial_validate_costo_

  function do_ajax_form_inventario_inicial_validate_costo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_costo__cb

  // ---------- Validate valorparcial_
  function do_ajax_form_inventario_inicial_validate_valorparcial_(iNumLinha)
  {
    var nomeCampo_valorparcial_ = "valorparcial_" + iNumLinha;
    var var_valorparcial_ = scAjaxGetFieldText(nomeCampo_valorparcial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_valorparcial_(var_valorparcial_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_valorparcial__cb);
  } // do_ajax_form_inventario_inicial_validate_valorparcial_

  function do_ajax_form_inventario_inicial_validate_valorparcial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_valorparcial__cb

  // ---------- Validate tipo_
  function do_ajax_form_inventario_inicial_validate_tipo_(iNumLinha)
  {
    var nomeCampo_tipo_ = "tipo_" + iNumLinha;
    var var_tipo_ = scAjaxGetFieldSelect(nomeCampo_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_tipo_(var_tipo_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_tipo__cb);
  } // do_ajax_form_inventario_inicial_validate_tipo_

  function do_ajax_form_inventario_inicial_validate_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_tipo__cb

  // ---------- Validate idbod_
  function do_ajax_form_inventario_inicial_validate_idbod_(iNumLinha)
  {
    var nomeCampo_idbod_ = "idbod_" + iNumLinha;
    var var_idbod_ = scAjaxGetFieldSelect(nomeCampo_idbod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_idbod_(var_idbod_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_idbod__cb);
  } // do_ajax_form_inventario_inicial_validate_idbod_

  function do_ajax_form_inventario_inicial_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_idbod__cb

  // ---------- Validate fecha_
  function do_ajax_form_inventario_inicial_validate_fecha_(iNumLinha)
  {
    var nomeCampo_fecha_ = "fecha_" + iNumLinha;
    var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_fecha_(var_fecha_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_fecha__cb);
  } // do_ajax_form_inventario_inicial_validate_fecha_

  function do_ajax_form_inventario_inicial_validate_fecha__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_fecha__cb

  // ---------- Validate detalle_
  function do_ajax_form_inventario_inicial_validate_detalle_(iNumLinha)
  {
    var nomeCampo_detalle_ = "detalle_" + iNumLinha;
    var var_detalle_ = scAjaxGetFieldText(nomeCampo_detalle_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_validate_detalle_(var_detalle_, iNumLinha, var_script_case_init, do_ajax_form_inventario_inicial_validate_detalle__cb);
  } // do_ajax_form_inventario_inicial_validate_detalle_

  function do_ajax_form_inventario_inicial_validate_detalle__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_validate_detalle__cb

  // ---------- Refresh idpro_
  function do_ajax_form_inventario_inicial_refresh_idpro_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_inventario_inicial_refresh_idpro_(var_idpro_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_inventario_inicial_refresh_idpro__cb);
  } // do_ajax_form_inventario_inicial_refresh_idpro_

  function do_ajax_form_inventario_inicial_refresh_idpro__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_inventario_inicial_refresh_idpro__cb

  // ---------- Event onchange cantidad_
  function do_ajax_form_inventario_inicial_event_cantidad__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_inventario_inicial_event_cantidad__onchange(var_costo_, var_cantidad_, var_valorparcial_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_inventario_inicial_event_cantidad__onchange_cb);
  } // do_ajax_form_inventario_inicial_event_cantidad__onchange

  function do_ajax_form_inventario_inicial_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inventario_inicial_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_inventario_inicial_event_cantidad__onchange_cb
  function do_ajax_form_inventario_inicial_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_inventario_inicial_event_cantidad__onchange_cb_after_alert

  // ---------- Event onfocus cantidad_
  function do_ajax_form_inventario_inicial_event_cantidad__onfocus(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_costo_ = scAjaxGetFieldText("costo_" + iSeqForm);
    var var_valorparcial_ = scAjaxGetFieldText("valorparcial_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_inventario_inicial_event_cantidad__onfocus(var_cantidad_, var_costo_, var_valorparcial_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_inventario_inicial_event_cantidad__onfocus_cb);
  } // do_ajax_form_inventario_inicial_event_cantidad__onfocus

  function do_ajax_form_inventario_inicial_event_cantidad__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inventario_inicial_event_cantidad__onfocus_cb_after_alert);
  } // do_ajax_form_inventario_inicial_event_cantidad__onfocus_cb
  function do_ajax_form_inventario_inicial_event_cantidad__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_inventario_inicial_event_cantidad__onfocus_cb_after_alert

  // ---------- Event onchange cod_barras_
  function do_ajax_form_inventario_inicial_event_cod_barras__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_inventario_inicial_event_cod_barras__onchange(var_cod_barras_, var_idpro_, var_costo_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_inventario_inicial_event_cod_barras__onchange_cb);
  } // do_ajax_form_inventario_inicial_event_cod_barras__onchange

  function do_ajax_form_inventario_inicial_event_cod_barras__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inventario_inicial_event_cod_barras__onchange_cb_after_alert);
  } // do_ajax_form_inventario_inicial_event_cod_barras__onchange_cb
  function do_ajax_form_inventario_inicial_event_cod_barras__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_inventario_inicial_event_cod_barras__onchange_cb_after_alert

  // ---------- Event onchange costo_
  function do_ajax_form_inventario_inicial_event_costo__onchange(iSeqForm)
  {
    var var_costo_ = scAjaxGetFieldText("costo_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_valorparcial_ = scAjaxGetFieldText("valorparcial_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_inventario_inicial_event_costo__onchange(var_costo_, var_cantidad_, var_valorparcial_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_inventario_inicial_event_costo__onchange_cb);
  } // do_ajax_form_inventario_inicial_event_costo__onchange

  function do_ajax_form_inventario_inicial_event_costo__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inventario_inicial_event_costo__onchange_cb_after_alert);
  } // do_ajax_form_inventario_inicial_event_costo__onchange_cb
  function do_ajax_form_inventario_inicial_event_costo__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_inventario_inicial_event_costo__onchange_cb_after_alert

  // ---------- Event onchange idpro_
  function do_ajax_form_inventario_inicial_event_idpro__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_costo_ = scAjaxGetFieldText("costo_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_inventario_inicial_event_idpro__onchange(var_idpro_, var_costo_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_inventario_inicial_event_idpro__onchange_cb);
  } // do_ajax_form_inventario_inicial_event_idpro__onchange

  function do_ajax_form_inventario_inicial_event_idpro__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inventario_inicial_event_idpro__onchange_cb_after_alert);
  } // do_ajax_form_inventario_inicial_event_idpro__onchange_cb
  function do_ajax_form_inventario_inicial_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_inventario_inicial_refresh_idpro_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_inventario_inicial_event_idpro__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_inventario_inicial_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_inventario_inicial_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_inventario_inicial_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_inventario_inicial_add_new_line_cb);
  } // do_ajax_form_inventario_inicial_add_new_line

  function do_ajax_form_inventario_inicial_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_inventario_inicial_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_inventario_inicial_backup_line(iNumLinha)
  {
    var var_idinv_ = scAjaxGetFieldText("idinv_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_inventario_inicial_backup_line(var_idinv_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_inventario_inicial_backup_line_cb);
  } // do_ajax_form_inventario_inicial_backup_line

  function do_ajax_form_inventario_inicial_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_inventario_inicial_backup_line_cb

  function do_ajax_form_inventario_inicial_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_inventario_inicial_cancel_insert

  function do_ajax_form_inventario_inicial_cancel_update(iSeqVert)
  {
    do_ajax_form_inventario_inicial_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_inventario_inicial_cancel_update

  function do_ajax_form_inventario_inicial_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_inventario_inicial_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_inventario_inicial_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inventario_inicial_table_refresh(var_idinv_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inventario_inicial_table_refresh_cb);
  } //  do_ajax_form_inventario_inicial_table_refresh

  function do_ajax_form_inventario_inicial_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_inventario_inicial_table_refresh_cb_after_alert);
  } // do_ajax_form_inventario_inicial_table_refresh_cb
  function do_ajax_form_inventario_inicial_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_inventario_inicial_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_inventario_inicial_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_inventario_inicial_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_inventario_inicial_submit_form(var_cod_barras_, var_idpro_, var_colores_, var_tallas_, var_sabor_, var_cantidad_, var_costo_, var_valorparcial_, var_tipo_, var_idbod_, var_fecha_, var_detalle_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_inventario_inicial_submit_form_cb);
  } // do_ajax_form_inventario_inicial_submit_form

  function do_ajax_form_inventario_inicial_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_inventario_inicial_submit_form_cb_after_alert);
  } // do_ajax_form_inventario_inicial_submit_form_cb
  function do_ajax_form_inventario_inicial_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_inventario_inicial_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_inventario_inicial_navigate_form()
  {
    perform_ajax_form_inventario_inicial_navigate_form();
  }

  function perform_ajax_form_inventario_inicial_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_inventario_inicial_navigate_form(var_idinv_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_inventario_inicial_navigate_form_cb);
  } // do_ajax_form_inventario_inicial_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_inventario_inicial']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_inventario_inicial_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_inventario_inicial_navigate_form_cb_after_alert);
  } // do_ajax_form_inventario_inicial_navigate_form_cb
  function do_ajax_form_inventario_inicial_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_inventario_inicial_navigate_form_cb_after_alert
  function sc_hide_form_inventario_inicial_form()
  {
  ...
  function do_ajax_form_inventario_inicial_lkpedt_refresh_idpro_(iSeq)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_row = iSeq;
    var nmgp_refresh_fields = "idpro_";
    x_ajax_form_inventario_inicial_lkpedt_refresh_idpro_(var_idpro_, nmgp_refresh_row, nmgp_refresh_fields, var_script_case_init, do_ajax_form_inventario_inicial_lkpedt_refresh_idpro__cb);
  } // do_ajax_form_inventario_inicial_lkpedt_refresh_idpro_

  function do_ajax_form_inventario_inicial_lkpedt_refresh_idpro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_inventario_inicial_lkpedt_refresh_idpro__cb
