...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idinv_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_idinv__onchange(this, iSeqRow) });
  $('#id_sc_field_fecha_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_fecha__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_inventario_inicial_fecha__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_inventario_inicial_fecha__onfocus(this, iSeqRow) });
  $('#id_sc_field_cantidad_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_cantidad__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_inventario_inicial_cantidad__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_inventario_inicial_cantidad__onfocus(this, iSeqRow) });
  $('#id_sc_field_idpro_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_idpro__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_inventario_inicial_idpro__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_inventario_inicial_idpro__onfocus(this, iSeqRow) });
  $('#id_sc_field_costo_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_costo__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_inventario_inicial_costo__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_inventario_inicial_costo__onfocus(this, iSeqRow) });
  $('#id_sc_field_valorparcial_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_valorparcial__onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_inventario_inicial_valorparcial__onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_inventario_inicial_valorparcial__onfocus(this, iSeqRow) });
  $('#id_sc_field_idbod_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_idbod__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_inventario_inicial_idbod__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_inventario_inicial_idbod__onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_tipo__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_inventario_inicial_tipo__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_inventario_inicial_tipo__onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_detalle__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_inventario_inicial_detalle__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_inventario_inicial_detalle__onfocus(this, iSeqRow) });
  $('#id_sc_field_idmov_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_idmov__onchange(this, iSeqRow) });
  $('#id_sc_field_idfaccom_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_idfaccom__onchange(this, iSeqRow) });
  $('#id_sc_field_nufacvta_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_nufacvta__onchange(this, iSeqRow) });
  $('#id_sc_field_remision_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_remision__onchange(this, iSeqRow) });
  $('#id_sc_field_nupro_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_nupro__onchange(this, iSeqRow) });
  $('#id_sc_field_iddetalle_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_iddetalle__onchange(this, iSeqRow) });
  $('#id_sc_field_lote_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_lote__onchange(this, iSeqRow) });
  $('#id_sc_field_fechafab_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_fechafab__onchange(this, iSeqRow) });
  $('#id_sc_field_fechavenc_' + iSeqRow).bind('change', function() { sc_form_inventario_inicial_fechavenc__onchange(this, iSeqRow) });
  $('#id_sc_field_colores_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_colores__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_inventario_inicial_colores__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_inventario_inicial_colores__onfocus(this, iSeqRow) });
  $('#id_sc_field_tallas_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_tallas__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_inventario_inicial_tallas__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_inventario_inicial_tallas__onfocus(this, iSeqRow) });
  $('#id_sc_field_sabor_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_sabor__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_inventario_inicial_sabor__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_inventario_inicial_sabor__onfocus(this, iSeqRow) });
  $('#id_sc_field_cod_barras_' + iSeqRow).bind('blur', function() { sc_form_inventario_inicial_cod_barras__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_inventario_inicial_cod_barras__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_inventario_inicial_cod_barras__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_inventario_inicial_idinv__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_fecha__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_fecha_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_fecha__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_fecha__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_cantidad__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_cantidad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_cantidad__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_inventario_inicial_event_cantidad__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_cantidad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
  do_ajax_form_inventario_inicial_event_cantidad__onfocus(iSeqRow);
}

function sc_form_inventario_inicial_idpro__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_idpro_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_idpro__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_inventario_inicial_event_idpro__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_idpro__onfocus(oThis, iSeqRow) {
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_costo__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_costo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_costo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_inventario_inicial_event_costo__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_costo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_valorparcial__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_valorparcial_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_valorparcial__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_valorparcial__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_idbod__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_idbod_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_idbod__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_idbod__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_tipo__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_tipo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_tipo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_tipo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_detalle__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_detalle_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_detalle__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_detalle__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_idmov__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_idfaccom__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_nufacvta__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_remision__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_nupro__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_iddetalle__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_lote__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_fechafab__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_fechavenc__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_inventario_inicial_colores__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_colores_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_colores__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_colores__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_tallas__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_tallas_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_tallas__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_tallas__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_sabor__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_sabor_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_sabor__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_sabor__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_inventario_inicial_cod_barras__onblur(oThis, iSeqRow) {
  do_ajax_form_inventario_inicial_validate_cod_barras_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_inventario_inicial_cod_barras__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_inventario_inicial_event_cod_barras__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_inventario_inicial_cod_barras__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_inventario_inicial_form" + pageNo).hide();
}
...
?>
  ...
  $("#id_sc_field_fechafab_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_inventario_inicial_validate_fechafab_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_inventario_inicial_validate_fechavenc_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_inventario_inicial')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
