...
function scHidePage(pageNo) {
	$("#id_form_comandas_estado_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_hora_inicio" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_comandas_estado_mob_validate_hora_inicio(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_hora_final" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_comandas_estado_mob_validate_hora_final(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_comandas_estado_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
