  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_seleccionar_cajas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_seleccionar_cajas_mob_form();
	}
...
?>
  ...
  // ---------- Validate cajas
  function do_ajax_control_seleccionar_cajas_mob_validate_cajas()
  {
    var nomeCampo_cajas = "cajas";
    var var_cajas = scAjaxGetFieldSelect(nomeCampo_cajas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_seleccionar_cajas_mob_validate_cajas(var_cajas, var_script_case_init, do_ajax_control_seleccionar_cajas_mob_validate_cajas_cb);
  } // do_ajax_control_seleccionar_cajas_mob_validate_cajas

  function do_ajax_control_seleccionar_cajas_mob_validate_cajas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_seleccionar_cajas_mob_validate_cajas_cb

  // ---------- Event onchange cajas
  function do_ajax_control_seleccionar_cajas_mob_event_cajas_onchange()
  {
    var var_cajas = scAjaxGetFieldSelect("cajas");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_control_seleccionar_cajas_mob_event_cajas_onchange(var_cajas, var_script_case_init, do_ajax_control_seleccionar_cajas_mob_event_cajas_onchange_cb);
  } // do_ajax_control_seleccionar_cajas_mob_event_cajas_onchange

  function do_ajax_control_seleccionar_cajas_mob_event_cajas_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cajas";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_seleccionar_cajas_mob_event_cajas_onchange_cb_after_alert);
  } // do_ajax_control_seleccionar_cajas_mob_event_cajas_onchange_cb
  function do_ajax_control_seleccionar_cajas_mob_event_cajas_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_control_seleccionar_cajas_mob_event_cajas_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_seleccionar_cajas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_seleccionar_cajas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cajas = scAjaxGetFieldSelect("cajas");
    ...
    scAjaxProcOn();
    x_ajax_control_seleccionar_cajas_mob_submit_form(var_cajas, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_seleccionar_cajas_mob_submit_form_cb);
  } // do_ajax_control_seleccionar_cajas_mob_submit_form

  function do_ajax_control_seleccionar_cajas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_seleccionar_cajas_mob_submit_form_cb_after_alert);
  } // do_ajax_control_seleccionar_cajas_mob_submit_form_cb
  function do_ajax_control_seleccionar_cajas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_seleccionar_cajas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_seleccionar_cajas_mob_navigate_form()
  {
    perform_ajax_control_seleccionar_cajas_mob_navigate_form();
  }

  function perform_ajax_control_seleccionar_cajas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_seleccionar_cajas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_seleccionar_cajas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_seleccionar_cajas_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_seleccionar_cajas_mob_navigate_form_cb
  function do_ajax_control_seleccionar_cajas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_seleccionar_cajas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_seleccionar_cajas_mob_navigate_form_cb_after_alert
  function sc_hide_control_seleccionar_cajas_mob_form()
  {
  ...
  ajax_field_list[0] = "cajas";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "cajas": {"label": "Caja", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["cajas"][1] = "cajas";

  var ajax_field_id = {
    "cajas": new Array("hidden_field_label_cajas", "hidden_field_data_cajas")
  };
