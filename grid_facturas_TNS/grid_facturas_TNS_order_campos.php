...
<?php
   ...
   $Ord_Cmp = new grid_facturas_TNS_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturas_TNS_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['factura'] = "K.CODPREFIJO||' '||K.NUMERO";
   }
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["factura"] : "FACTURA";
   $tab_ger_campos['k_fecha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['k_fecha'] = "k_fecha";
   }
   else
   {
       $tab_def_campos['k_fecha'] = "K.FECHA";
   }
   $tab_labels["k_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["k_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["k_fecha"] : "FECHA";
   $tab_ger_campos['c_nit'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['c_nit'] = "c_nit";
   }
   else
   {
       $tab_def_campos['c_nit'] = "C.NIT";
   }
   $tab_labels["c_nit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["c_nit"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["c_nit"] : "NIT";
   ...
   {
       $tab_def_campos['cliente'] = "C.NOMBRE";
   }
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["cliente"] : "CLIENTE";
   ...
   {
       $tab_def_campos['asentada'] = "K.FECASENTAD";
   }
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["asentada"] : "ASENTADA";
   $tab_ger_campos['k_total'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['k_total'] = "k_total";
   }
   else
   {
       $tab_def_campos['k_total'] = "K.TOTAL";
   }
   $tab_labels["k_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["k_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["k_total"] : "TOTAL";
   ...
   $tab_labels["cufe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["cufe"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["cufe"] : "CUFE";
   ...
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["estado"] : "ESTADO";
   $tab_ger_campos['enlace'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['enlace'] = "enlace";
   }
   else
   {
       $tab_def_campos['enlace'] = "''";
   }
   $tab_labels["enlace"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["enlace"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["enlace"] : "ENLACE";
   $tab_ger_campos['consulta'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['consulta'] = "consulta";
   }
   else
   {
       $tab_def_campos['consulta'] = "";
   }
   $tab_labels["consulta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["consulta"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["consulta"] : "Consulta";
   ...
   $tab_labels["pdf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["pdf"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['labels']["pdf"] : "PDF";
   $tab_ger_campos['consulta'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturas_TNS_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturas_TNS']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
