...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "k_total";$Nm_numeric[] = "k_kardexid";$Nm_numeric[] = "k_total";$Nm_numeric[] = "k_kardexid";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_cliente"  <?php echo $str_hide_cliente?>><?php
      if ($cliente != "")
      {
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_factura"  <?php echo $str_hide_factura?>><?php
      if ($factura != "")
      {
      $factura_look = substr($this->Db->qstr($factura), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_k_fecha"  <?php echo $str_hide_k_fecha?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_k_fecha"  <?php echo $str_display_k_fecha; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_c_nit"  <?php echo $str_hide_c_nit?>><?php
      if ($c_nit != "")
      {
      $c_nit_look = substr($this->Db->qstr($c_nit), 1, -1); 
      $nmgp_def_dados = array(); 
