...
class grid_terceros_cuentas_101219_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['arr_total']['usuario'];
      }
      else
      {
          $this->array_total_usuario = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['arr_total']['usuario'] = $this->array_total_usuario;
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Usuario")),
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_USUARIO_ASESOR("res", $this->array_total_usuario);
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_valor_total, $quebra_usuario, $quebra_usuario_orig)
   {
      //----- Usuario
      if (!isset($this->array_total_usuario[$quebra_usuario_orig]))
      {
         $this->array_total_usuario[$quebra_usuario_orig][0] = 1;
         $this->array_total_usuario[$quebra_usuario_orig][1] = $sum_valor_total;
...
$_SESSION['scriptcase']['grid_terceros_cuentas_101219']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->valor_total, $this->usuario, $this->usuario_orig);
            }
   }
//
