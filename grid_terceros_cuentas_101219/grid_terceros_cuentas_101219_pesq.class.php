...
class grid_terceros_cuentas_101219_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_terceros_cuentas_101219_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_terceros_cuentas_101219_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_terceros_cuentas_101219_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_terceros_cuentas_101219_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_terceros_cuentas_101219/grid_terceros_cuentas_101219_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_terceros_cuentas_101219_ajax_search.js"></script>
 <script type="text/javascript" src="grid_terceros_cuentas_101219_ajax.js"></script>
 <script type="text/javascript">
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Documentos</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $prefijo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['prefijo']; 
          $prefijo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['prefijo_cond']; 
          $numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['numero']; 
          $numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['numero_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_cond']; 
          $tercero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tercero']; 
          $tercero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tercero_cond']; 
          $ie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['ie']; 
          $ie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['ie_cond']; 
          $tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tipo']; 
          $tipo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tipo_cond']; 
          $numero_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['numero_documento']; 
          $numero_documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['numero_documento_cond']; 
          $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['usuario']; 
          $usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['usuario_cond']; 
          $tipo_tercero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tipo_tercero']; 
          $tipo_tercero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tipo_tercero_cond']; 
          $pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['pagada']; 
          $pagada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['pagada_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['NM_operador']; 
      } 
...
<?php
   if (is_file("grid_terceros_cuentas_101219_help.txt"))
   {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['prefijo'])) ? $this->New_label['prefijo'] : "PJ"; ?></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['prefijo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['prefijo'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['tercero'])) ? $this->New_label['tercero'] : "Tercero"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tercero" name="tercero_autocomp" size="60" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['ie'])) ? $this->New_label['ie'] : "IE"; ?></TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['ie'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['ie'][] = "INGRESO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['ie'][] = "EGRESO";
 ?>
 ...
 <OPTION value="EGRESO##@@EGRESO"<?php if ($ie == "EGRESO") { echo " selected" ;} ?>>EGRESO</option>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['tipo'])) ? $this->New_label['tipo'] : "Tipo"; ?></TD>
     <TD class="scFilterFieldEven"> 
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo'][] = "FV";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo'][] = "RS";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo'][] = "FC";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo'][] = "CE";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo'][] = "RC";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo'][] = "OO";
 ?>
 ...
 <OPTION value="OO##@@GENERAL"<?php if ($tipo == "OO") { echo " selected" ;} ?>>GENERAL</option>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['numero_documento'])) ? $this->New_label['numero_documento'] : "Documento"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_usuario" name="usuario_autocomp" size="60" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['tipo_tercero'])) ? $this->New_label['tipo_tercero'] : "Tipo Tercero"; ?></TD>
      
      <INPUT type="hidden" id="SC_tipo_tercero_cond" name="tipo_tercero_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_tipo_tercero" <?php echo $str_hide_tipo_tercero?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo_tercero'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo_tercero'][] = "CLIENTES";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo_tercero'][] = "PROVEEDORES";
 ?>
 ...
 <OPTION value="PROVEEDORES##@@PROVEEDORES"<?php if ($tipo_tercero == "PROVEEDORES") { echo " selected" ;} ?>>PROVEEDORES</option>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['pagada'])) ? $this->New_label['pagada'] : "Pagada"; ?></TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['pagada'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['pagada'][] = "NO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['pagada'][] = "SI";
 ?>
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['opc_psq'] && !$this->aba_iframe))
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['orig_pesq'] == "grid")
   {
...
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_terceros_cuentas_101219_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_terceros_cuentas_101219_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_terceros_cuentas_101219_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_terceros_cuentas_101219_valida_mes(this)});
 }
 function sc_grid_terceros_cuentas_101219_valida_dia(obj)
 {
 ...
 function sc_grid_terceros_cuentas_101219_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['prefijo'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['ie'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['tipo_tercero'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['psq_check_ret']['pagada'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['prefijo'] = $prefijo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['prefijo_cond'] = $prefijo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['numero'] = $numero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['numero_cond'] = $numero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tercero'] = $tercero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tercero_cond'] = $tercero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['ie'] = $ie; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['ie_cond'] = $ie_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tipo'] = $tipo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tipo_cond'] = $tipo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['numero_documento'] = $numero_documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['numero_documento_cond'] = $numero_documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['usuario'] = $usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['usuario_cond'] = $usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tipo_tercero'] = $tipo_tercero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['tipo_tercero_cond'] = $tipo_tercero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['pagada'] = $pagada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['pagada_cond'] = $pagada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      if ($fecha_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']['fecha_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['where_pesq_ant'] = $this->comando . $this->comando_fim;
