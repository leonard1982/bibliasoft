 ...
 */
    include_once('grid_terceros_cuentas_101219_session.php');
    session_start();
    $SC_apl_proc = "grid_terceros_cuentas_101219";
...
<form name="config_prt" method="post" action="grid_terceros_cuentas_101219_config_print.php">
<?php
