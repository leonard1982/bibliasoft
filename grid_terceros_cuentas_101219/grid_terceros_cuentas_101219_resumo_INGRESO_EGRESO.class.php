...
class grid_terceros_cuentas_101219_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_ie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['arr_total']['ie'];
      }
      else
      {
          $this->array_total_ie = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['arr_total']['ie'] = $this->array_total_ie;
   ...
   function completeMatrix()
   {
       ...
       foreach ($this->array_total_ie as $i_ie => $d_ie) {
           if (!in_array($i_ie, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_ie[3] ] = $d_ie[2];
               $this->comp_label[0][ $d_ie[3] ] = $d_ie[2];
           }
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("IE")),
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_INGRESO_EGRESO("res", $this->array_total_ie);
...
//--- 
   ...
   function adiciona_registro($sum_valor_total, $quebra_ie, $quebra_ie_orig)
   {
      ...
      if (!isset($this->array_total_ie[$quebra_ie_orig]))
      {
         ...
         $this->array_total_ie[$quebra_ie_orig][2] = $quebra_ie;
         $this->array_total_ie[$quebra_ie_orig][3] = $quebra_ie_orig;
      }
      else
      {
