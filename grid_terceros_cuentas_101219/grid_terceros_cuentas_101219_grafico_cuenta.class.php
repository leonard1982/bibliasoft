...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Cuenta";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['contr_label_graf']['cod_cuenta']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['contr_label_graf']['cod_cuenta']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['contr_label_graf']['cod_cuenta'];
      }
   }
