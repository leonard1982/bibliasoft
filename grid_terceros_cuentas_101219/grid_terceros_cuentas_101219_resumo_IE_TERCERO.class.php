...
class grid_terceros_cuentas_101219_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_tercero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['arr_total']['tercero'];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_101219']['arr_total']['tercero'] = $this->array_total_tercero;
   ...
   function completeMatrix()
   {
       ...
       foreach ($this->array_total_tercero as $i_tercero => $d_tercero) {
           ...
           foreach ($this->array_total_ie[$i_tercero] as $i_ie => $d_ie) {
               if (!in_array($i_ie, $this->comp_label[1][ $d_tercero[3] ], true)) {
                   $this->comp_index[1][ $d_ie[3] ] = $d_ie[2];
                   $this->comp_label[1][ $d_tercero[3] ][ $d_ie[3] ] = $d_ie[2];
               }
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_IE_TERCERO("res", $this->array_total_tercero, $this->array_total_ie);
...
//--- 
   ...
   function adiciona_registro($sum_valor_total, $quebra_tercero, $quebra_ie, $quebra_tercero_orig, $quebra_ie_orig)
   {
      ...
      if (!isset($this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig]))
      {
         ...
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][2] = $quebra_ie;
         $this->array_total_ie[$quebra_tercero_orig][$quebra_ie_orig][3] = $quebra_ie_orig;
      }
      else
      {
