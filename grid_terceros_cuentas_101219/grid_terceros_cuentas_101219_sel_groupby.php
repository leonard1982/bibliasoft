<?php
   ...
   $Sel_Groupby = new grid_terceros_cuentas_101219_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_terceros_cuentas_101219_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['pivot_tabular']);
   }
   if ($opc_ret == "resumo")
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_display'] as $i_sum => $d_sum)
       {
           $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_display'][$i_sum]['display'] = in_array($i_sum, $summ_fields);
       }
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_order'] = $summ_fields;
   }
?>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_terceros_cuentas_101219_sel_groupby.php",
    data: {
...
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_control'] as $l_field => $d_field)
    {
...
{
?>
   $("#sc_id_summ_available").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_display']) * 29 ?>px");
   $("#sc_id_summ_selected").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_display']) * 29 ?>px");
<?php
}
?>
  }
...
<?php
    ...
    $iTabCount            = 0;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Groupby_hide']))
        {
...
?>
 <tr id="sc_id_static_groupby">
  <td>
<?php
     if (!in_array("INGRESO_EGRESO", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Groupby_hide']))
     {
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="INGRESO_EGRESO" id="sc_id_sel_groupby_INGRESO_EGRESO"<?php echo $check ?> /><label for="sc_id_sel_groupby_INGRESO_EGRESO" style="font-weight: bold">INGRESO/EGRESO</label>
      <br />
      <span style="padding-left: 30px">IE</span>
      <br /><br />
<?php
     }
?>
<?php
     if (!in_array("TERCERO", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Groupby_hide']))
     {
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="TERCERO" id="sc_id_sel_groupby_TERCERO"<?php echo $check ?> /><label for="sc_id_sel_groupby_TERCERO" style="font-weight: bold">TERCERO</label>
      <br />
      <span style="padding-left: 30px">Tercero</span>
      <br /><br />
<?php
     }
?>
<?php
     if (!in_array("IE_TERCERO", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Groupby_hide']))
     {
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="IE_TERCERO" id="sc_id_sel_groupby_IE_TERCERO"<?php echo $check ?> /><label for="sc_id_sel_groupby_IE_TERCERO" style="font-weight: bold">IE/TERCERO</label>
      <br />
      <span style="padding-left: 30px">Tercero, IE</span>
      <br /><br />
<?php
     }
?>
<?php
     if (!in_array("USUARIO_ASESOR", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Groupby_hide']))
     {
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="USUARIO_ASESOR" id="sc_id_sel_groupby_USUARIO_ASESOR"<?php echo $check ?> /><label for="sc_id_sel_groupby_USUARIO_ASESOR" style="font-weight: bold">USUARIO/ASESOR</label>
      <br />
      <span style="padding-left: 30px">Usuario</span>
      <br /><br />
<?php
     }
?>
<?php
     if (!in_array("cuenta", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Groupby_hide']))
     {
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="cuenta" id="sc_id_sel_groupby_cuenta"<?php echo $check ?> /><label for="sc_id_sel_groupby_cuenta" style="font-weight: bold">Por Cuenta</label>
      <br />
      <span style="padding-left: 30px">Cuenta</span>
      <br /><br />
<?php
     }
?>
<?php
     if (!in_array("tercero_cuenta", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Groupby_hide']))
     {
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="tercero_cuenta" id="sc_id_sel_groupby_tercero_cuenta"<?php echo $check ?> /><label for="sc_id_sel_groupby_tercero_cuenta" style="font-weight: bold">Por Tercero/Cuenta</label>
      <br />
      <span style="padding-left: 30px">Tercero, Cuenta</span>
      <br /><br />
<?php
     }
?>
<?php
     if (!in_array("_NM_SC_", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['SC_Groupby_hide']))
     {
        if ($opc_ret != "resumo")
        {
...
?>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" name="sel_groupby" value="_NM_SC_" id="sc_id_sel_groupby__NM_SC_"<?php echo $check ?> /><label for="sc_id_sel_groupby__NM_SC_" style="font-weight: bold"><?php echo $this->Nm_lang['lang_othr_groupby_none'] ?></label>
      <br />
...
<?php
        foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_order'] as $i_sum)
        {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_display'][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas_101219']['summarizing_fields_display'][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
