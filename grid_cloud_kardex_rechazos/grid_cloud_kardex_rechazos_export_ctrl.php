<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cloud_kardex_rechazos']['sc_process_barr'] = true;
require_once('../grid_cloud_kardex_rechazos/index.php');
unset($_SESSION['scriptcase']['grid_cloud_kardex_rechazos']['sc_process_barr']);
$ExportCtrl = new grid_cloud_kardex_rechazos_export_control;
$ExportCtrl->Export_barr();

class grid_cloud_kardex_rechazos_export_control
{
