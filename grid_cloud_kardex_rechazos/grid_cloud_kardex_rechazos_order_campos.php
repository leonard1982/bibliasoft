...
<?php
   ...
   $Ord_Cmp = new grid_cloud_kardex_rechazos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cloud_kardex_rechazos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_cloud_kardex'] = "id_cloud_kardex";
   $tab_labels["id_cloud_kardex"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["id_cloud_kardex"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["id_cloud_kardex"] : "Id";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['prefijo'] = "on";
   $tab_def_campos['prefijo'] = "prefijo";
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["prefijo"] : "PJ";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["numero"] : "#";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["tercero"] : "Tercero";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["estado"] : "Estado";
   $tab_ger_campos['avisos'] = "on";
   $tab_def_campos['avisos'] = "avisos";
   $tab_labels["avisos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["avisos"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['labels']["avisos"] : "Avisos";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cloud_kardex_rechazos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_rechazos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
