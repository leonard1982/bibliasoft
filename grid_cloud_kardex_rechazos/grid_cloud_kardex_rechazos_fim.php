...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_kardex_rechazos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_kardex_rechazos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_rechazos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_rechazos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_rechazos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_rechazos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_rechazos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cloud_kardex_rechazos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_rechazos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_rechazos']['embutida_filho'] as $ind => $sc_init)
          {
