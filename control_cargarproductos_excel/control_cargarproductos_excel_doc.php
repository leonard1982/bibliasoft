<?php
   ...
   include_once 'control_cargarproductos_excel_doc_name.php';
   ...
   if ($nm_cod_doc == "documento_db")
   {
       ...
       $trab_doc = $root . $_SESSION['scriptcase']['control_cargarproductos_excel']['glo_nm_path_imag_temp'] . "/" . $index_file;
