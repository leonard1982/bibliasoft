<form name="F2" method=post 
               action="control_cargarproductos_excel_mob.php" 
               target="_self"> 
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['control_cargarproductos_excel_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="control_cargarproductos_excel_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
function sc_btn_btn_limpiar() 
{ 
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_limpiar(); }, 500);
      return;
    }
    location.href = "../control_cargarproductos_excel/";
} 
function sc_btn_btn_limpiar_cancel()
{
}
function sc_btn_btn_limpiar_ok()
{
    location.href = "../control_cargarproductos_excel/";
}
 NM_tp_critica(1);
...
function nm_saida_glo()
{
  ...
  document.F4.action = "control_cargarproductos_excel_mob_fim.php";
  document.F4.submit();
}
...
function nm_mostra_doc(campo1, campo2, campo3)
{
    ...
    NovaJanela = window.open ("control_cargarproductos_excel_mob_doc.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nm_cod_doc=" + campo1 + "&nm_nome_doc=" + encodeURIComponent(campo2) + "&nm_cod_apl=" + campo3, "sc_name_download_iframe", "resizable, scrollbars");
}
