  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_cargarproductos_excel_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_cargarproductos_excel_mob_form();
	}
...
?>
  ...
  // ---------- Validate logo
  function do_ajax_control_cargarproductos_excel_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_cargarproductos_excel_mob_validate_logo(var_logo, var_script_case_init, do_ajax_control_cargarproductos_excel_mob_validate_logo_cb);
  } // do_ajax_control_cargarproductos_excel_mob_validate_logo

  function do_ajax_control_cargarproductos_excel_mob_validate_logo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cargarproductos_excel_mob_validate_logo_cb

  // ---------- Validate archivo
  function do_ajax_control_cargarproductos_excel_mob_validate_archivo()
  {
    var nomeCampo_archivo = "archivo";
    var var_archivo = scAjaxGetFieldText(nomeCampo_archivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_cargarproductos_excel_mob_validate_archivo(var_archivo, var_script_case_init, do_ajax_control_cargarproductos_excel_mob_validate_archivo_cb);
  } // do_ajax_control_cargarproductos_excel_mob_validate_archivo

  function do_ajax_control_cargarproductos_excel_mob_validate_archivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "archivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cargarproductos_excel_mob_validate_archivo_cb

  // ---------- Validate m
  function do_ajax_control_cargarproductos_excel_mob_validate_m()
  {
    var nomeCampo_m = "m";
    var var_m = scAjaxGetFieldHidden(nomeCampo_m);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_cargarproductos_excel_mob_validate_m(var_m, var_script_case_init, do_ajax_control_cargarproductos_excel_mob_validate_m_cb);
  } // do_ajax_control_cargarproductos_excel_mob_validate_m

  function do_ajax_control_cargarproductos_excel_mob_validate_m_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "m";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_cargarproductos_excel_mob_validate_m_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_cargarproductos_excel_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_cargarproductos_excel_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_logo = "";
    var var_archivo = scAjaxGetFieldText("archivo");
    var var_m = scAjaxGetFieldHidden("m");
    var var_archivo_ul_name = scAjaxSpecCharProtect(document.F1.archivo_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_archivo_ul_type = document.F1.archivo_ul_type.value;
    var var_archivo_salva = scAjaxSpecCharProtect(document.F1.archivo_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_archivo_limpa = document.F1.archivo_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_control_cargarproductos_excel_mob_submit_form(var_logo, var_archivo, var_m, var_archivo_ul_name, var_archivo_ul_type, var_archivo_salva, var_archivo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_cargarproductos_excel_mob_submit_form_cb);
  } // do_ajax_control_cargarproductos_excel_mob_submit_form

  function do_ajax_control_cargarproductos_excel_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.archivo_limpa && document.F1.archivo_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldDocument("archivo", oImgTemp, "", "");
      }
      else if (document.getElementById("id_ajax_doc_archivo") && "" != document.getElementById("id_ajax_doc_archivo").innerHTML)
      {
        document.getElementById("id_ajax_doc_archivo").style.display = "";
      }
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_cargarproductos_excel_mob_submit_form_cb_after_alert);
  } // do_ajax_control_cargarproductos_excel_mob_submit_form_cb
  function do_ajax_control_cargarproductos_excel_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_cargarproductos_excel_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_cargarproductos_excel_mob_navigate_form()
  {
    perform_ajax_control_cargarproductos_excel_mob_navigate_form();
  }

  function perform_ajax_control_cargarproductos_excel_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_cargarproductos_excel_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_cargarproductos_excel_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_cargarproductos_excel_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_cargarproductos_excel_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_cargarproductos_excel_mob_navigate_form_cb
  function do_ajax_control_cargarproductos_excel_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_cargarproductos_excel_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_cargarproductos_excel_mob_navigate_form_cb_after_alert
  function sc_hide_control_cargarproductos_excel_mob_form()
  {
  ...
  var ajax_error_list = {
    "logo": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "archivo": {"label": "Seleccione un archivo a importar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "m": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["archivo"][1] = "archivo";
  ajax_field_mult["m"][1] = "m";

  var ajax_field_id = {
    "logo": new Array("hidden_field_label_logo", "hidden_field_data_logo"),
    "archivo": new Array("hidden_field_label_archivo", "hidden_field_data_archivo"),
