...
class grid_ventas_ubicacion_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_ventas_ubicacion']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_ventas_ubicacion']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(coalesce(dp.valorpar,0)) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_total_geral'] = "OK";
   } 
   ...
   //---- 
   function quebra_geral_fechaubicacion($res_limit=false)
   {
      global $nada, $nm_lang ;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_total_geral'] == "OK") 
      { 
   ...
   //-----  p_fechaven
   function quebra_p_fechaven_sc_free_group_by($p_fechaven, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_p_fechaven = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(coalesce(dp.valorpar,0)) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq']; 
      } 
      ...
      $tot_p_fechaven[0] = NM_encode_input(sc_strip_script($p_fechaven)) ; 
      $tot_p_fechaven[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_p_fechaven[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_p_fechaven;
   } 

   //-----  ubicacion
   function quebra_ubicacion_sc_free_group_by($ubicacion, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb;
      $tot_ubicacion = array() ;  
      ...
      $tot_ubicacion[0] = sc_strip_script($ubicacion) ; 
      $tot_ubicacion[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_ubicacion[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_ubicacion;
   } 

   //-----  ubicacion
   function quebra_ubicacion_ubicacion($ubicacion, $arg_sum_ubicacion) 
   {
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq'])) 
      { 
         $nm_comando .= " where b.bodega" . $arg_sum_ubicacion ; 
      } 
      else 
      { 
         $nm_comando .= " and b.bodega" . $arg_sum_ubicacion ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //-----  p_fechaven
   function quebra_p_fechaven_fecha($p_fechaven, $arg_sum_p_fechaven) 
   {
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq'])) 
      { 
         $nm_comando .= " where " .  $this->Sc_groupby_p_fechaven . $arg_sum_p_fechaven ; 
      } 
      else 
      { 
         $nm_comando .= " and " .  $this->Sc_groupby_p_fechaven . $arg_sum_p_fechaven ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   //-----  p_fechaven
   function quebra_p_fechaven_fechaubicacion($p_fechaven, $arg_sum_p_fechaven) 
   {
      global $tot_p_fechaven;
      $tot_p_fechaven = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
   ...
   //-----  ubicacion
   function quebra_ubicacion_fechaubicacion($p_fechaven, $ubicacion, $arg_sum_p_fechaven, $arg_sum_ubicacion) 
   {
      global $tot_ubicacion;
      $tot_ubicacion = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq'])) 
      { 
         $nm_comando .= " where " .  $this->Sc_groupby_p_fechaven . $arg_sum_p_fechaven . " and b.bodega" . $arg_sum_ubicacion ; 
      } 
      else 
      { 
         $nm_comando .= " and " .  $this->Sc_groupby_p_fechaven . $arg_sum_p_fechaven . " and b.bodega" . $arg_sum_ubicacion ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('p_fechaven' => "p.fechaven",'ubicacion' => "b.bodega");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('total' => 'N','p10' => 'N','p20' => 'N','p30' => 'N','p40' => 'N','p50' => 'N','p60' => 'N','p70' => 'N','p80' => 'N','p90' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(coalesce(dp.valorpar,0))#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1)#@#cmps_quebras#@# from (";
         $comando .= "select coalesce(dp.valorpar,0) as SC_metric1, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['p_fechaven']['reg'] = "S";
      $format_dimensions['p_fechaven']['msk'] = "";
      $format_dimensions['ubicacion']['reg'] = "S";
      $format_dimensions['ubicacion']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
   ...
   function Calc_resumo_ubicacion($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('ubicacion' => "b.bodega");
      $cmps_quebra_atual = array("ubicacion");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Calc_resumo_fecha($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('p_fechaven' => "p.fechaven");
      $cmps_quebra_atual = array("p_fechaven");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   //----- 
   function Calc_resumo_fechaubicacion($destino_resumo)
   {
      global $nm_lang;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('p_fechaven' => "p.fechaven",'ubicacion' => "b.bodega");
      $cmps_quebra_atual = array("p_fechaven","ubicacion");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
      ...
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          ...
          $this->Res_Totaliza_fechaubicacion($ind_qb, $cmp_gb, $arr_tots, $group, $join, $cmps_gb, $cmps_gb1, $cmps_gb2, $cmps_gbS, $cmp_dim, $cmps_quebra_atual, $cmp_sql_def);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
   ...
   function Res_Totaliza_fechaubicacion($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      $sc_having = ((isset($parms_sub_sel['having']))) ? "  having " . $parms_sub_sel['having'] : "";
      $Tem_estat_manual = false;
      $where_ok = $this->sc_where_atual;
      ...
      while (!$rt->EOF)
      {
          ...
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              $prep_look  = $Cada_dim . "_SC_look";
              $$prep_look = $rt->fields[$Ind_sql];
              $SC_prep = $this->Ini->Get_format_dimension($Ind_sql, 'fechaubicacion', $Cada_dim, $rt, $format_dimensions[$Cada_dim]['reg'], $format_dimensions[$Cada_dim]['msk']);
              $SC_orig = $Cada_dim . "_orig";
              $SC_graf = "val_grafico_" . $Cada_dim;
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
          ...
          {
              $where_ok = (empty($this->sc_where_atual)) ? " where " . $sql_where : $this->sc_where_atual . " and " . $sql_where;
              $vl_statistic = $this->Calc_statist_manual_fechaubicacion($where_ok);
              foreach ($vl_statistic as $ind => $val)
              {
                  $rt->fields[$ind] = $val;
              }
