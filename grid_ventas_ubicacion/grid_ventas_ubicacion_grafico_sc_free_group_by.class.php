...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $prep_label    = array();
      $prep_label['p_fechaven'] = "" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "";
      $prep_label['ubicacion'] = "Ubicación";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
