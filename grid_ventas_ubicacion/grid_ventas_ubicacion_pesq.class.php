...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "coalesce(dp_valorpar,0)";$Nm_numeric[] = "(dp_valorpar * 0_10)";$Nm_numeric[] = "(dp_valorpar * 0_20)";$Nm_numeric[] = "(dp_valorpar * 0_30)";$Nm_numeric[] = "(dp_valorpar * 0_40)";$Nm_numeric[] = "(dp_valorpar * 0_50)";$Nm_numeric[] = "(dp_valorpar * 0_60)";$Nm_numeric[] = "(dp_valorpar * 0_70)";$Nm_numeric[] = "(dp_valorpar * 0_80)";$Nm_numeric[] = "(dp_valorpar * 0_90)";
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_p_fechaven_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['p_fechaven'])) ? $this->New_label['p_fechaven'] : "Fecha"; ?></TD>
      
      <INPUT type="hidden" id="SC_p_fechaven_cond" name="p_fechaven_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_p_fechaven" <?php echo $str_hide_p_fechaven?> valign="top">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_p_fechaven"  <?php echo $str_display_p_fechaven; ?> class="scFilterFieldFontOdd">
...
?>
      ...
      <TD id='SC_ubicacion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['ubicacion'])) ? $this->New_label['ubicacion'] : "Ubicación"; ?></TD>
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_ubicacion_orig" name="ubicacion_orig" size=10 multiple onDblClick="nm_add_sel('ubicacion_orig', 'ubicacion_dest', 'N' , '')">
<?php
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($ubicacion) && !empty($ubicacion))
            {
               ...
               foreach ($ubicacion as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $ubicacion_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('ubicacion_orig', 'ubicacion_dest', 'N', '');", "nm_add_all('ubicacion_orig', 'ubicacion_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('ubicacion_orig', 'ubicacion_dest', 'N', '');", "nm_add_sel('ubicacion_orig', 'ubicacion_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('ubicacion_dest', 'ubicacion_orig', 'N', '');", "nm_del_sel('ubicacion_dest', 'ubicacion_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('ubicacion_dest', 'ubicacion_orig', 'N', '');", "nm_del_all('ubicacion_dest', 'ubicacion_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_ubicacion_dest" name="ubicacion_dest" size=10 multiple  onDblClick="nm_del_sel('ubicacion_dest', 'ubicacion_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_ubicacion" name="ubicacion" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.ubicacion_dest.selectedIndex = -1;</script>
<?php
?>
...
?>
 ...
 {
   nm_pack('ubicacion_dest', 'ubicacion');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_del_all('ubicacion_dest', 'ubicacion_orig', 'N', '');
 }
