...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_label_graf']['ubicacion']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_label_graf']['ubicacion']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_label_graf']['ubicacion'];
      }
   }
