...
class grid_ventas_ubicacion_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_ventas_ubicacion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_ventas_ubicacion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_ventas_ubicacion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "p.fechaven";$Nm_datas[] = "p_fechaven";$Nm_numeric[] = "coalesce(dp_valorpar,0)";$Nm_numeric[] = "(dp_valorpar * 0_10)";$Nm_numeric[] = "(dp_valorpar * 0_20)";$Nm_numeric[] = "(dp_valorpar * 0_30)";$Nm_numeric[] = "(dp_valorpar * 0_40)";$Nm_numeric[] = "(dp_valorpar * 0_50)";$Nm_numeric[] = "(dp_valorpar * 0_60)";$Nm_numeric[] = "(dp_valorpar * 0_70)";$Nm_numeric[] = "(dp_valorpar * 0_80)";$Nm_numeric[] = "(dp_valorpar * 0_90)";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_ventas_ubicacion/grid_ventas_ubicacion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_ventas_ubicacion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_ventas_ubicacion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_ventas_ubicacion_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_ventas_ubicacion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_ventas_ubicacion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_p_fechaven_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_p_fechaven_dia').value + '/';
          var_dt_ini += document.getElementById('SC_p_fechaven_mes').value + '/';
          var_dt_ini += document.getElementById('SC_p_fechaven_ano').value;
          document.getElementById('sc_p_fechaven_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_p_fechaven_dia').value = aParts[0];
          document.getElementById('SC_p_fechaven_mes').value = aParts[1];
          document.getElementById('SC_p_fechaven_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_p_fechaven_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_p_fechaven_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_p_fechaven_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_p_fechaven_input_2_ano').value;
          document.getElementById('sc_p_fechaven_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_p_fechaven_input_2_dia').value = aParts[0];
          document.getElementById('SC_p_fechaven_input_2_mes').value = aParts[1];
          document.getElementById('SC_p_fechaven_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_p_fechaven_cond#NMF#' + search_get_sel_txt('SC_p_fechaven_cond') + '@NMF@';
  str_out += 'SC_p_fechaven_dia#NMF#' + search_get_sel_txt('SC_p_fechaven_dia') + '@NMF@';
  str_out += 'SC_p_fechaven_mes#NMF#' + search_get_sel_txt('SC_p_fechaven_mes') + '@NMF@';
  str_out += 'SC_p_fechaven_ano#NMF#' + search_get_sel_txt('SC_p_fechaven_ano') + '@NMF@';
  str_out += 'SC_p_fechaven_input_2_dia#NMF#' + search_get_sel_txt('SC_p_fechaven_input_2_dia') + '@NMF@';
  str_out += 'SC_p_fechaven_input_2_mes#NMF#' + search_get_sel_txt('SC_p_fechaven_input_2_mes') + '@NMF@';
  str_out += 'SC_p_fechaven_input_2_ano#NMF#' + search_get_sel_txt('SC_p_fechaven_input_2_ano') + '@NMF@';
  str_out += 'SC_ubicacion_cond#NMF#' + search_get_sel_txt('SC_ubicacion_cond') + '@NMF@';
  str_out += 'SC_ubicacion#NMF#' + search_get_Dselelect('SC_ubicacion_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Ventas por Ubicación</span></td>
...
<?php
   ...
   {
      global 
             $p_fechaven_cond, $p_fechaven, $p_fechaven_dia, $p_fechaven_mes, $p_fechaven_ano, $p_fechaven_input_2_dia, $p_fechaven_input_2_mes, $p_fechaven_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $p_fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_dia']; 
          $p_fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_mes']; 
          $p_fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_ano']; 
          $p_fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_input_2_dia']; 
          $p_fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_input_2_mes']; 
          $p_fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_input_2_ano']; 
          $p_fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_cond']; 
          $ubicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['ubicacion']; 
          $ubicacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['ubicacion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['NM_operador']; 
      } 
      if (!isset($p_fechaven_cond) || empty($p_fechaven_cond))
      {
         $p_fechaven_cond = "bw";
      }
      ...
      $str_hide_p_fechaven = (in_array($p_fechaven_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_ubicacion = (in_array($ubicacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_p_fechaven = ('bw' == $p_fechaven_cond) ? $display_aberto : $display_fechado;
      $str_display_ubicacion = ('bw' == $ubicacion_cond) ? $display_aberto : $display_fechado;

      // ubicacion
      if (is_array($ubicacion) && !empty($ubicacion))
      {
         $tmp_array = array();
         $ubicacion_val_str = "";
         foreach ($ubicacion as $tmp_val_cmp)
         {
            if ("" != $ubicacion_val_str)
            {
               $ubicacion_val_str .= ",";
            }
      ...
      if (!isset($p_fechaven) || $p_fechaven == "")
      {
          $p_fechaven = "";
      }
      if (isset($p_fechaven) && !empty($p_fechaven))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_p_fechaven_cond" name="p_fechaven_cond" value="bw">
 ...
 $nmgp_tab_label .= "p_fechaven?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_p_fechaven"  <?php echo $str_hide_p_fechaven?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fechaven_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fechaven_dia" name="p_fechaven_dia" value="<?php echo NM_encode_input($p_fechaven_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fechaven_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fechaven_mes" name="p_fechaven_mes" value="<?php echo NM_encode_input($p_fechaven_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fechaven_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fechaven_ano" name="p_fechaven_ano" value="<?php echo NM_encode_input($p_fechaven_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_p_fechaven_jq">
</span>
...
?>
        <SPAN id="id_css_p_fechaven"  class="scFilterFieldFontOdd">
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_p_fechaven"  <?php echo $str_display_p_fechaven; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fechaven_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fechaven_input_2_dia" name="p_fechaven_input_2_dia" value="<?php echo NM_encode_input($p_fechaven_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fechaven_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fechaven_input_2_mes" name="p_fechaven_input_2_mes" value="<?php echo NM_encode_input($p_fechaven_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fechaven_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fechaven_input_2_ano" name="p_fechaven_input_2_ano" value="<?php echo NM_encode_input($p_fechaven_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_p_fechaven_jq2">
</span>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ubicacion"  <?php echo $str_hide_ubicacion?>>
<?php
      $ubicacion_look = substr($this->Db->qstr($ubicacion), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT bodega  FROM bodegas  ORDER BY bodega"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['psq_check_ret']['ubicacion'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['psq_check_ret']['ubicacion'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_ubicacion">
      <SELECT class="scFilterObjectEven" id="SC_ubicacion" name="ubicacion[]"  size="10" multiple>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $ubicacion_sel = "";
               foreach ($ubicacion as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $ubicacion_sel = "selected";
                       break;
                   }
               }
            }
            ...
            {
               $ubicacion_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $ubicacion_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
   if (is_file("grid_ventas_ubicacion_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.p_fechaven_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_p_fechaven'), document.F1.p_fechaven_cond, 'p_fechaven');
   document.F1.p_fechaven_dia.value = "";
   document.F1.p_fechaven_mes.value = "";
   document.F1.p_fechaven_ano.value = "";
   document.F1.p_fechaven_input_2_dia.value = "";
   document.F1.p_fechaven_input_2_mes.value = "";
   document.F1.p_fechaven_input_2_ano.value = "";
   document.F1.ubicacion_cond.value = 'in';
   nm_campos_between(document.getElementById('id_vis_ubicacion'), document.F1.ubicacion_cond, 'ubicacion');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'ubicacion[]')
      {
 ...
 {
    $('#SC_p_fechaven_dia').bind('change', function() {sc_grid_ventas_ubicacion_valida_dia(this)});
    $('#SC_p_fechaven_input_2_dia').bind('change', function() {sc_grid_ventas_ubicacion_valida_dia(this)});
    $('#SC_p_fechaven_input_2_mes').bind('change', function() {sc_grid_ventas_ubicacion_valida_mes(this)});
    $('#SC_p_fechaven_mes').bind('change', function() {sc_grid_ventas_ubicacion_valida_mes(this)});
 }
 function sc_grid_ventas_ubicacion_valida_dia(obj)
 {
 ...
 function sc_grid_ventas_ubicacion_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_p_fechaven_cond'] = 'cond';
      $tp_fields['SC_p_fechaven_dia'] = 'text';
      $tp_fields['SC_p_fechaven_mes'] = 'text';
      $tp_fields['SC_p_fechaven_ano'] = 'text';
      $tp_fields['SC_p_fechaven_input_2_dia'] = 'text';
      $tp_fields['SC_p_fechaven_input_2_mes'] = 'text';
      $tp_fields['SC_p_fechaven_input_2_ano'] = 'text';
      $tp_fields['SC_ubicacion_cond'] = 'cond';
      $tp_fields['SC_ubicacion'] = 'dselect';
   ...
   {
      global $p_fechaven_cond, $p_fechaven, $p_fechaven_dia, $p_fechaven_mes, $p_fechaven_ano, $p_fechaven_input_2_dia, $p_fechaven_input_2_mes, $p_fechaven_input_2_ano,
      ...
      $p_fechaven_cond_salva = $p_fechaven_cond; 
      if (!isset($p_fechaven_input_2_dia) || $p_fechaven_input_2_dia == "")
      {
          $p_fechaven_input_2_dia = $p_fechaven_dia;
      }
      if (!isset($p_fechaven_input_2_mes) || $p_fechaven_input_2_mes == "")
      {
          $p_fechaven_input_2_mes = $p_fechaven_mes;
      }
      if (!isset($p_fechaven_input_2_ano) || $p_fechaven_input_2_ano == "")
      {
          $p_fechaven_input_2_ano = $p_fechaven_ano;
      }
      ...
      if (is_array($ubicacion)) {
          foreach ($ubicacion as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['psq_check_ret']['ubicacion'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_dia'] = $p_fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_mes'] = $p_fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_ano'] = $p_fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_input_2_dia'] = $p_fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_input_2_mes'] = $p_fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_input_2_ano'] = $p_fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_cond'] = $p_fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['ubicacion'] = $ubicacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['ubicacion_cond'] = $ubicacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['ubicacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['ubicacion'];
      $this->cmp_formatado['ubicacion_input_2'] = $ubicacion_input_2;

      //----- $p_fechaven
      $this->Date_part = false;
      if ($p_fechaven_cond != "bi_TP")
      {
          $p_fechaven_cond = strtoupper($p_fechaven_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $p_fechaven_ano;
          $Dtxt .= $p_fechaven_mes;
          $Dtxt .= $p_fechaven_dia;
          $val[0]['ano'] = $p_fechaven_ano;
          $val[0]['mes'] = $p_fechaven_mes;
          $val[0]['dia'] = $p_fechaven_dia;
          if ($p_fechaven_cond == "BW")
          {
              $val[1]['ano'] = $p_fechaven_input_2_ano;
              $val[1]['mes'] = $p_fechaven_input_2_mes;
              $val[1]['dia'] = $p_fechaven_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $p_fechaven_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $p_fechaven_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $p_fechaven = $val[0];
          $this->cmp_formatado['p_fechaven'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['p_fechaven'], "YYYY-MM-DD");
          $this->cmp_formatado['p_fechaven'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($p_fechaven_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $p_fechaven_input_2     = $val[1];
              $this->cmp_formatado['p_fechaven_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']['p_fechaven_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['p_fechaven_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['p_fechaven_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $p_fechaven_cond == "NU" || $p_fechaven_cond == "NN"|| $p_fechaven_cond == "EP"|| $p_fechaven_cond == "NE")
          {
              $this->monta_condicao("p.fechaven", $p_fechaven_cond, $p_fechaven, $p_fechaven_input_2, 'p_fechaven', 'DATE');
          }
      }
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($ubicacion_cond == "nu" || $ubicacion_cond == "nn" || $ubicacion_cond == "ep" || $ubicacion_cond == "ne")
      {
          $ubicacion = array();
      }
      if (is_array($ubicacion) && count($ubicacion) != 0)
      {
         foreach ($ubicacion as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($ubicacion_cond == "df" || $ubicacion_cond == "np")
         {
         ...
         $Lang_descr_final = isset($Lang_descr[$ubicacion_cond]) ? $Lang_descr[$ubicacion_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $nmgp_tab_label['ubicacion'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($ubicacion) || $ubicacion_cond == "nu" || $ubicacion_cond == "nn" || $ubicacion_cond == "ep" || $ubicacion_cond == "ne")
      {
         $this->monta_condicao("b.bodega", $ubicacion_cond, $ubicacion, "", "ubicacion");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_pesq'];
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "ubicacion" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
