...
class grid_ventas_ubicacion_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_ubicacion = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_ubicacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total']['ubicacion'];
      }
      else
      {
          $this->array_total_ubicacion = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total']['ubicacion'] = $this->array_total_ubicacion;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_ubicacion = "ubicacion";
       }
       else
       {
       $Lab_ubicacion = "Ubicación";
       }
       $this->comp_field = array(
           $Lab_ubicacion,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['ubicacion'] = $Lab_ubicacion; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['ubicacion']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['ubicacion'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['ubicacion'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['ubicacion'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['ubicacion'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['ubicacion'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['ubicacion'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['ubicacion'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['ubicacion'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['ubicacion'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_ubicacion as $i_ubicacion => $d_ubicacion) {
           if (!in_array($i_ubicacion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_ubicacion[4] ] = $d_ubicacion[3];
               $this->comp_label[0][ $d_ubicacion[4] ] = $d_ubicacion[3];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'ubicacion', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_ubicacion => $l_ubicacion) {
           if (isset($this->array_total_ubicacion[$i_ubicacion])) {
               $this->comp_group[$i_ubicacion] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_ubicacion;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_ubicacion)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      ksort($this->array_total_ubicacion);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_ubicacion, $quebra_ubicacion_orig)
   {
      //----- Ubicación
      if (!isset($this->array_total_ubicacion[$quebra_ubicacion_orig]))
      {
         $this->array_total_ubicacion[$quebra_ubicacion_orig][0] = 1;
         $this->array_total_ubicacion[$quebra_ubicacion_orig][1] = $sum_total;
         $this->array_total_ubicacion[$quebra_ubicacion_orig][2] = 1;
         $this->array_total_ubicacion[$quebra_ubicacion_orig][3] = $quebra_ubicacion;
         $this->array_total_ubicacion[$quebra_ubicacion_orig][4] = $quebra_ubicacion_orig;
      }
      else
      {
         $this->array_total_ubicacion[$quebra_ubicacion_orig][0]++;
         $this->array_total_ubicacion[$quebra_ubicacion_orig][1] += $sum_total;
         $this->array_total_ubicacion[$quebra_ubicacion_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'ubicacion');
     $campos_order = $this->Ini->Get_date_order_groupby("b.bodega", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->ubicacion_orig = $this->ubicacion;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->ubicacion, $this->ubicacion_orig);
            }
   }
//
