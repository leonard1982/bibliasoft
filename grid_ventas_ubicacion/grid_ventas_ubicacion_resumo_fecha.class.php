...
class grid_ventas_ubicacion_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_p_fechaven = array();
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_ventas_ubicacion']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_ventas_ubicacion']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_total_geral'] == "OK")
      {
          $this->array_total_p_fechaven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total']['p_fechaven'];
      }
      else
      {
          $this->array_total_p_fechaven = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total']['p_fechaven'] = $this->array_total_p_fechaven;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['json_use_label'])
       {
          $Lab_p_fechaven = "p.fechaven";
       }
       else
       {
       $Lab_p_fechaven = "Fecha";
       }
       $this->comp_field = array(
           $Lab_p_fechaven,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p_fechaven'] = $Lab_p_fechaven; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p_fechaven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p_fechaven'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['ubicacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['ubicacion'] = "Ubicación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['dp_observ']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['dp_observ'] = "Observ"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p10']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p10'] = "P 10"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p20']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p20'] = "P 20"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p30']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p30'] = "P 30"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p40']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p40'] = "P 40"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p50']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p50'] = "P 50"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p60']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p60'] = "P 60"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p70']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p70'] = "P 70"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p80']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p80'] = "P 80"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p90']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['labels']['p90'] = "P 90"; 
       }
       //-----
       $this->comp_field_nm = array(
           'p_fechaven' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['fecha']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['fecha'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['fecha'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fecha'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fecha'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fecha'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fecha'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fecha'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fecha'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fecha'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_p_fechaven as $i_p_fechaven => $d_p_fechaven) {
           if (!in_array($i_p_fechaven, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_p_fechaven[4] ] = $d_p_fechaven[3];
               $this->comp_label[0][ $d_p_fechaven[4] ] = $d_p_fechaven[3];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'p_fechaven', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_p_fechaven => $l_p_fechaven) {
           if (isset($this->array_total_p_fechaven[$i_p_fechaven])) {
               $this->comp_group[$i_p_fechaven] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_p_fechaven;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_ventas_ubicacion@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_p_fechaven)),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_ventas_ubicacion_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_ventas_ubicacion_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_ventas_ubicacion_total.class.php"); 
      }
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] = "print";
      ...
      $this->Total   = new grid_ventas_ubicacion_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_p_fechaven);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_ventas_ubicacion/grid_ventas_ubicacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ventas_ubicacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_ventas_ubicacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ventas_ubicacion_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ventas_ubicacion/grid_ventas_ubicacion_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_ventas_ubicacion/grid_ventas_ubicacion_config_graf_flash.php?nome_apl=grid_ventas_ubicacion&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_ventas_ubicacion_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_ventas_ubicacion']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_ventas_ubicacion']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_ventas_ubicacion_config_pivot.php?nome_apl=grid_ventas_ubicacion&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_ventas_ubicacion_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_ventas_ubicacion/grid_ventas_ubicacion_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $p_fechaven = $Busca_temp['p_fechaven']; 
          $tmp_pos = strpos($p_fechaven, "##@@");
          if ($tmp_pos !== false && !is_array($p_fechaven))
          {
              $p_fechaven = substr($p_fechaven, 0, $tmp_pos);
          }
          $p_fechaven_2 = $Busca_temp['p_fechaven_input_2']; 
   ...
   function monta_rodape()
   {
      ...
      $nm_cab_filtro   = ""; 
      $nm_cab_filtrobr = ""; 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca']))
      { 
        $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['campos_busca'];
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_p_fechaven, $quebra_p_fechaven_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_p_fechaven[$quebra_p_fechaven_orig]))
      {
         $this->array_total_p_fechaven[$quebra_p_fechaven_orig][0] = 1;
         $this->array_total_p_fechaven[$quebra_p_fechaven_orig][1] = $sum_total;
         $this->array_total_p_fechaven[$quebra_p_fechaven_orig][2] = 1;
         $this->array_total_p_fechaven[$quebra_p_fechaven_orig][3] = $quebra_p_fechaven;
         $this->array_total_p_fechaven[$quebra_p_fechaven_orig][4] = $quebra_p_fechaven_orig;
      }
      else
      {
         $this->array_total_p_fechaven[$quebra_p_fechaven_orig][0]++;
         $this->array_total_p_fechaven[$quebra_p_fechaven_orig][1] += $sum_total;
         $this->array_total_p_fechaven[$quebra_p_fechaven_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'p_fechaven');
     $campos_order = $this->Ini->Get_date_order_groupby("p.fechaven", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->p_fechaven = $rs_res->fields[0] ;  
            $this->ubicacion = $rs_res->fields[1] ;  
            $this->total = $rs_res->fields[2] ;  
            $this->total =  str_replace(",", ".", $this->total);
            $this->dp_observ = $rs_res->fields[3] ;  
            ...
            $this->p_fechaven_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->p_fechaven, $Format_tst);
            $this->p_fechaven = $this->Ini->GB_date_format($TP_Time . $this->p_fechaven, $Format_tst, $Prefix_dat);
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->p_fechaven, $this->p_fechaven_orig);
            }
   }
//
