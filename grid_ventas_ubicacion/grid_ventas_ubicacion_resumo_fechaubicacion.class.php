...
class grid_ventas_ubicacion_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['fechaubicacion']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['fechaubicacion'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_order']['fechaubicacion'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fechaubicacion'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fechaubicacion'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fechaubicacion'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fechaubicacion'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fechaubicacion'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fechaubicacion'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['summarizing_fields_display']['fechaubicacion'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_p_fechaven as $i_p_fechaven => $d_p_fechaven) {
           ...
           foreach ($this->array_total_ubicacion[$i_p_fechaven] as $i_ubicacion => $d_ubicacion) {
               if (!in_array($i_ubicacion, $this->comp_label[1][ $d_p_fechaven[4] ], true)) {
                   $this->comp_index[1][ $d_ubicacion[4] ] = $d_ubicacion[3];
                   $this->comp_label[1][ $d_p_fechaven[4] ][ $d_ubicacion[4] ] = $d_ubicacion[3];
               }
           }
       }
       ...
       foreach ($this->comp_label[0] as $i_p_fechaven => $l_p_fechaven) {
           ...
           foreach ($this->comp_label[1][$i_p_fechaven] as $i_ubicacion => $l_ubicacion) {
               if (isset($this->array_total_ubicacion[$i_p_fechaven][$i_ubicacion])) {
                   $this->comp_group[$i_p_fechaven][$i_ubicacion] = array();
               }
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas_ubicacion']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fechaubicacion("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_p_fechaven, $quebra_ubicacion, $quebra_p_fechaven_orig, $quebra_ubicacion_orig)
   {
      ...
      //----- Ubicación
      if (!isset($this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig]))
      {
         $this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig][0] = 1;
         $this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig][1] = $sum_total;
         $this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig][2] = 1;
         $this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig][3] = $quebra_ubicacion;
         $this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig][4] = $quebra_ubicacion_orig;
      }
      else
      {
         $this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig][0]++;
         $this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig][1] += $sum_total;
         $this->array_total_ubicacion[$quebra_p_fechaven_orig][$quebra_ubicacion_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->p_fechaven, $this->ubicacion, $this->p_fechaven_orig,  $this->ubicacion_orig);
            }
   }
//
