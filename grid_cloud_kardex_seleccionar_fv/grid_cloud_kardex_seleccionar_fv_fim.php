...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_kardex_seleccionar_fv"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_kardex_seleccionar_fv"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_seleccionar_fv']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_seleccionar_fv']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_seleccionar_fv']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_seleccionar_fv']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_seleccionar_fv']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cloud_kardex_seleccionar_fv</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_seleccionar_fv']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex_seleccionar_fv']['embutida_filho'] as $ind => $sc_init)
          {
