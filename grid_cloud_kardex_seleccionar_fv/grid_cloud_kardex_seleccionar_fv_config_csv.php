...
*/
    ...
    include_once('grid_cloud_kardex_seleccionar_fv_session.php');
    session_start();
    $_SESSION['scriptcase']['grid_cloud_kardex_seleccionar_fv']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
    //check tmp
    if(empty($_SESSION['scriptcase']['grid_cloud_kardex_seleccionar_fv']['glo_nm_path_imag_temp']))
    {
        $str_path_apl_url = $_SERVER['PHP_SELF'];
        $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
        $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
        $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
        /*check tmp*/$_SESSION['scriptcase']['grid_cloud_kardex_seleccionar_fv']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    $SC_cod_proj = "FACILWEB_FE_73";
    $SC_apl_proc = "grid_cloud_kardex_seleccionar_fv";
