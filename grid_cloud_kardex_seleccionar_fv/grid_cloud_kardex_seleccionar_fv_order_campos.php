...
<?php
   ...
   $Ord_Cmp = new grid_cloud_kardex_seleccionar_fv_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cloud_kardex_seleccionar_fv_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['ndoc'] = "ndoc";
   }
   else
   {
       $tab_def_campos['ndoc'] = "concat(tipo,'/',prefijo,'/',numero)";
   }
   $tab_labels["ndoc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['labels']["ndoc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['labels']["ndoc"] : "FV/TNS";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['labels']["tercero"] : "TERCERO";
   ...
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['labels']["nombre"] : "NOMBRE";
   $tab_ger_campos['numero_fe'] = "on";
   $tab_def_campos['numero_fe'] = "numero_fe";
   $tab_labels["numero_fe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['labels']["numero_fe"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['labels']["numero_fe"] : "FV/FE";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cloud_kardex_seleccionar_fv_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex_seleccionar_fv']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
