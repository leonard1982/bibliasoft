<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cloud_kardex_seleccionar_fv']['sc_process_barr'] = true;
require_once('../grid_cloud_kardex_seleccionar_fv/index.php');
unset($_SESSION['scriptcase']['grid_cloud_kardex_seleccionar_fv']['sc_process_barr']);
$ExportCtrl = new grid_cloud_kardex_seleccionar_fv_export_control;
$ExportCtrl->Export_barr();

class grid_cloud_kardex_seleccionar_fv_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_cloud_kardex_seleccionar_fv']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_cloud_kardex_seleccionar_fv']['glo_nm_path_imag_temp'];
