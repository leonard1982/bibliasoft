...
<?php
   ...
   $Ord_Cmp = new grid_empresas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_empresas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['nombre_empresa'] = "nombre_empresa";
   $tab_labels["nombre_empresa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["nombre_empresa"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["nombre_empresa"] : "Empresa";
   $tab_ger_campos['creada'] = "on";
   $tab_def_campos['creada'] = "creada";
   $tab_labels["creada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["creada"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["creada"] : "Creada";
   $tab_ger_campos['copiada_como'] = "on";
   $tab_def_campos['copiada_como'] = "copiada_como";
   $tab_labels["copiada_como"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["copiada_como"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["copiada_como"] : "Copiada Como";
   $tab_ger_campos['sinmovimiento'] = "on";
   $tab_def_campos['sinmovimiento'] = "sinmovimiento";
   $tab_labels["sinmovimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["sinmovimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["sinmovimiento"] : "Sin Movimiento";
   $tab_ger_campos['tipo_negocio'] = "on";
   $tab_def_campos['tipo_negocio'] = "tipo_negocio";
   $tab_labels["tipo_negocio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["tipo_negocio"])) ? $_SESSION['sc_session'][$sc_init]['grid_empresas']['labels']["tipo_negocio"] : "Tipo Negocio";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_empresas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_empresas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_empresas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_empresas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
