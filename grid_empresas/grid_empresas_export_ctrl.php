<?php
@session_start() ;
$_SESSION['scriptcase']['grid_empresas']['sc_process_barr'] = true;
require_once('../grid_empresas/index.php');
unset($_SESSION['scriptcase']['grid_empresas']['sc_process_barr']);
$ExportCtrl = new grid_empresas_export_control;
$ExportCtrl->Export_barr();

class grid_empresas_export_control
{
