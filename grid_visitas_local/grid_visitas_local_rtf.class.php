...
class grid_visitas_local_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_visitas_local.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_visitas_local']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visitas_local']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visitas_local']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visitas_local']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visitas_local']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visitas_local']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visitas_local']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_visitas_local']['contr_erro'] = 'off'; 
   ...
   function NM_export_fecha_hora()
   {
         ...
         $this->fecha_hora = str_replace('<', '&lt;', $this->fecha_hora);
         $this->fecha_hora = str_replace('>', '&gt;', $this->fecha_hora);
         $this->Texto_tag .= "<td>" . $this->fecha_hora . "</td>\r\n";
   }
   //----- gps_llegada
   function NM_export_gps_llegada()
   {
         ...
         $this->gps_llegada = str_replace('<', '&lt;', $this->gps_llegada);
         $this->gps_llegada = str_replace('>', '&gt;', $this->gps_llegada);
         $this->Texto_tag .= "<td>" . $this->gps_llegada . "</td>\r\n";
   }
   //----- fecha_hora_salida
   function NM_export_fecha_hora_salida()
   {
         ...
         $this->fecha_hora_salida = str_replace('<', '&lt;', $this->fecha_hora_salida);
         $this->fecha_hora_salida = str_replace('>', '&gt;', $this->fecha_hora_salida);
         $this->Texto_tag .= "<td>" . $this->fecha_hora_salida . "</td>\r\n";
   }
   //----- gps_salida
   function NM_export_gps_salida()
   {
         ...
         $this->gps_salida = str_replace('<', '&lt;', $this->gps_salida);
         $this->gps_salida = str_replace('>', '&gt;', $this->gps_salida);
         $this->Texto_tag .= "<td>" . $this->gps_salida . "</td>\r\n";
   }
   //----- usuario
   ...
   function NM_export_id_visitas()
   {
         ...
         $this->id_visitas = str_replace('<', '&lt;', $this->id_visitas);
         $this->id_visitas = str_replace('>', '&gt;', $this->id_visitas);
         $this->Texto_tag .= "<td>" . $this->id_visitas . "</td>\r\n";
   }
   //----- codigo_cliente
   ...
   function NM_export_latitude()
   {
         ...
         $this->latitude = str_replace('>', '&gt;', $this->latitude);
         $this->Texto_tag .= "<td>" . $this->latitude . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_visitas_local']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_visitas_local']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
