...
<?php
   ...
   $Ord_Cmp = new grid_visitas_local_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_visitas_local_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha_hora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["fecha_hora"])) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["fecha_hora"] : "Llegada";
   ...
   $tab_labels["gps_llegada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["gps_llegada"])) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["gps_llegada"] : "Posición";
   $tab_ger_campos['fecha_hora_salida'] = "on";
   $tab_def_campos['fecha_hora_salida'] = "fecha_hora_salida";
   $tab_labels["fecha_hora_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["fecha_hora_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["fecha_hora_salida"] : "Salida";
   ...
   $tab_labels["gps_salida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["gps_salida"])) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["gps_salida"] : "Posición";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['nombre_cliente'] = "on";
   $tab_def_campos['nombre_cliente'] = "nombre_cliente";
   $tab_labels["nombre_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["nombre_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["nombre_cliente"] : "Cliente";
   $tab_ger_campos['concepto'] = "on";
   $tab_def_campos['concepto'] = "concepto";
   $tab_labels["concepto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["concepto"])) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["concepto"] : "Concepto";
   $tab_ger_campos['observacion'] = "on";
   $tab_def_campos['observacion'] = "observacion";
   $tab_labels["observacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["observacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['labels']["observacion"] : "Observacion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_visitas_local_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_visitas_local']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
