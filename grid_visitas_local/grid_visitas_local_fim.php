...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_visitas_local"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_visitas_local"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_visitas_local']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_visitas_local']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_visitas_local']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_visitas_local']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_visitas_local']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_visitas_local</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_visitas_local']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_visitas_local']['embutida_filho'] as $ind => $sc_init)
          {
