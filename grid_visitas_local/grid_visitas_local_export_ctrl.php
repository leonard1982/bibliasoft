<?php
@session_start() ;
$_SESSION['scriptcase']['grid_visitas_local']['sc_process_barr'] = true;
require_once('../grid_visitas_local/index.php');
unset($_SESSION['scriptcase']['grid_visitas_local']['sc_process_barr']);
$ExportCtrl = new grid_visitas_local_export_control;
$ExportCtrl->Export_barr();

class grid_visitas_local_export_control
{
