  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_rotacion_vent" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_rotacion_vent_form();
	}
...
?>
  ...
  // ---------- Validate fechamen
  function do_ajax_control_rotacion_vent_validate_fechamen()
  {
    var nomeCampo_fechamen = "fechamen";
    var var_fechamen = scAjaxGetFieldText(nomeCampo_fechamen);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fechamen = scAjaxGetFieldText(nomeCampo_fechamen);
      x_ajax_control_rotacion_vent_validate_fechamen(var_fechamen, var_script_case_init, do_ajax_control_rotacion_vent_validate_fechamen_cb);
    }, 200);
  } // do_ajax_control_rotacion_vent_validate_fechamen

  function do_ajax_control_rotacion_vent_validate_fechamen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechamen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_rotacion_vent_validate_fechamen_cb

  // ---------- Validate fechamay
  function do_ajax_control_rotacion_vent_validate_fechamay()
  {
    var nomeCampo_fechamay = "fechamay";
    var var_fechamay = scAjaxGetFieldText(nomeCampo_fechamay);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_fechamay = scAjaxGetFieldText(nomeCampo_fechamay);
      x_ajax_control_rotacion_vent_validate_fechamay(var_fechamay, var_script_case_init, do_ajax_control_rotacion_vent_validate_fechamay_cb);
    }, 200);
  } // do_ajax_control_rotacion_vent_validate_fechamay

  function do_ajax_control_rotacion_vent_validate_fechamay_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechamay";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors || ($("#ui-datepicker-div").length && $("#ui-datepicker-div").filter(":visible").length))
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_rotacion_vent_validate_fechamay_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_rotacion_vent_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_rotacion_vent_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fechamen = scAjaxGetFieldText("fechamen");
    var var_fechamay = scAjaxGetFieldText("fechamay");
    ...
    scAjaxProcOn();
    x_ajax_control_rotacion_vent_submit_form(var_fechamen, var_fechamay, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_rotacion_vent_submit_form_cb);
  } // do_ajax_control_rotacion_vent_submit_form

  function do_ajax_control_rotacion_vent_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_rotacion_vent']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_rotacion_vent']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_rotacion_vent']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_rotacion_vent_submit_form_cb_after_alert);
  } // do_ajax_control_rotacion_vent_submit_form_cb
  function do_ajax_control_rotacion_vent_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_rotacion_vent_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_rotacion_vent_navigate_form()
  {
    perform_ajax_control_rotacion_vent_navigate_form();
  }

  function perform_ajax_control_rotacion_vent_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_rotacion_vent_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_rotacion_vent']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_rotacion_vent_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_rotacion_vent_navigate_form_cb_after_alert);
  } // do_ajax_control_rotacion_vent_navigate_form_cb
  function do_ajax_control_rotacion_vent_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_rotacion_vent_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_rotacion_vent_navigate_form_cb_after_alert
  function sc_hide_control_rotacion_vent_form()
  {
  ...
  ajax_field_list[0] = "fechamen";
  ajax_field_list[1] = "fechamay";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "fechamen": {"label": "Desde", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechamay": {"label": "Hasta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["fechamen"][1] = "fechamen";
  ajax_field_mult["fechamay"][1] = "fechamay";

  var ajax_field_id = {
    "fechamen": new Array("hidden_field_label_fechamen", "hidden_field_data_fechamen"),
    "fechamay": new Array("hidden_field_label_fechamay", "hidden_field_data_fechamay")
  };
