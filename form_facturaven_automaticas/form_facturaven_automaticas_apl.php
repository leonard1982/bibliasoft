<?php
//
class form_facturaven_automaticas_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['form_facturaven_automaticas_detalleventa_script_case_init'] ]['form_facturaven_automaticas_detalleventa']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['form_facturaven_automaticas_detalleventa_script_case_init'] ]['form_facturaven_automaticas_detalleventa']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_facturaven_automaticas_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_facturaven_automaticas']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_facturaven_automaticas'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_facturaven_automaticas']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_facturaven_automaticas']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_facturaven_automaticas') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_facturaven_automaticas']['label'] = "Factura Automática";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_facturaven_automaticas")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_facturaven_automaticas']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_facturaven_automaticas'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_facturaven_automaticas']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_facturaven_automaticas'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_facturaven_automaticas'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_facturaven_automaticas", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_facturaven_automaticas/form_facturaven_automaticas_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_facturaven_automaticas_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_facturaven_automaticas_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_facturaven_automaticas_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_facturaven_automaticas/form_facturaven_automaticas_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_facturaven_automaticas_erro.class.php"); 
      }
      $this->Erro      = new form_facturaven_automaticas_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao']))
         { 
             if ($this->idfacven != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_facturaven_automaticas']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['form_facturaven_automaticas_detalleventa_script_case_init'] ]['form_facturaven_automaticas_detalleventa']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['form_facturaven_automaticas_detalleventa_script_case_init'] ]['form_facturaven_automaticas_detalleventa']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['form_facturaven_automaticas_detalleventa_script_case_init'] ]['form_facturaven_automaticas_detalleventa']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['form_facturaven_automaticas_detalleventa_script_case_init'] ]['form_facturaven_automaticas_detalleventa']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_facturaven_automaticas_detalleventa') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_facturaven_automaticas_detalleventa') . "/form_facturaven_automaticas_detalleventa_apl.php");
          $this->form_facturaven_automaticas_detalleventa = new form_facturaven_automaticas_detalleventa_apl;
      }
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_facturaven_automaticas']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_facturaven_automaticas']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_facturaven_automaticas.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_facturaven_automaticas_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_facturaven_automaticas"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_facturaven_automaticas']) || !is_array($this->NM_ajax_info['errList']['geral_form_facturaven_automaticas']))
              {
                  $this->NM_ajax_info['errList']['geral_form_facturaven_automaticas'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_facturaven_automaticas'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_resolucion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
               if (!empty($this->resolucion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_resolucion']) && !in_array($this->resolucion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_resolucion']))
               {
                   $hasError = true;
    ...
    function ValidateField_credito(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['php_cmp_required']['credito']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['php_cmp_required']['credito'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_dias_decredito(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['php_cmp_required']['dias_decredito']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['php_cmp_required']['dias_decredito'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_idcli(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idcli) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_idcli']) && !in_array($this->idcli, $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_idcli']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_dircliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->dircliente == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['php_cmp_required']['dircliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['php_cmp_required']['dircliente'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->dircliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_dircliente']) && !in_array($this->dircliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_dircliente']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['dircliente']))
    ...
    function ValidateField_vendedor(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->vendedor, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_tipo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['php_cmp_required']['tipo'] == "on")) 
      { 
          if ($this->tipo == "")  
          { 
              $hasError = true;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idfacven']['keyVal'] = form_facturaven_automaticas_pack_protect_string($this->nmgp_dados_form['idfacven']);
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total'] < 0)
              {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['resolucion']['valList'][$i] = form_facturaven_automaticas_pack_protect_string($v);
          }
...
$aLookup[] = array(form_facturaven_automaticas_pack_protect_string('1') => str_replace('<', '&lt;',form_facturaven_automaticas_pack_protect_string("Crédito")));
$aLookup[] = array(form_facturaven_automaticas_pack_protect_string('2') => str_replace('<', '&lt;',form_facturaven_automaticas_pack_protect_string("Contado")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_credito'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_credito'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['credito']['valList'][$i] = form_facturaven_automaticas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idcli']['valList'][$i] = form_facturaven_automaticas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['dircliente']['valList'][$i] = form_facturaven_automaticas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_facturaven_automaticas_pack_protect_string('SI') => str_replace('<', '&lt;',form_facturaven_automaticas_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['Lookup_activo'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['activo']['valList'][$i] = form_facturaven_automaticas_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idfacven)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opcao'] = '';
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idfacven)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
    ...
    if ("incluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_facturaven_automaticas']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_facturaven_automaticas']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_facturaven_automaticas_detalleventa->ini_controle();
              if ($this->form_facturaven_automaticas_detalleventa->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "insert" || $this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['select'] = ""; 
              } 
          } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas_detalleventa']['embutida_parms'] = "didfacven*scin" . $this->nmgp_dados_form['idfacven'] . "*scoutNM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_facturaven_automaticas_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_facturaven_automaticas = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['total'] = $qt_geral_reg_form_facturaven_automaticas;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_facturaven_automaticas_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_facturaven_automaticas_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_facturaven_automaticas_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas']['masterValue']))
{
