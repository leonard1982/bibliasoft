  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_facturaven_automaticas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_facturaven_automaticas_mob_form();
	}
...
?>
  ...
  // ---------- Validate resolucion
  function do_ajax_form_facturaven_automaticas_mob_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_resolucion_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_resolucion

  function do_ajax_form_facturaven_automaticas_mob_validate_resolucion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_resolucion_cb

  // ---------- Validate formapago
  function do_ajax_form_facturaven_automaticas_mob_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldText(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_formapago(var_formapago, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_formapago_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_formapago

  function do_ajax_form_facturaven_automaticas_mob_validate_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_formapago_cb

  // ---------- Validate fechaven
  function do_ajax_form_facturaven_automaticas_mob_validate_fechaven()
  {
    var nomeCampo_fechaven = "fechaven";
    var var_fechaven = scAjaxGetFieldText(nomeCampo_fechaven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_fechaven(var_fechaven, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_fechaven_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_fechaven

  function do_ajax_form_facturaven_automaticas_mob_validate_fechaven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_fechaven_cb

  // ---------- Validate credito
  function do_ajax_form_facturaven_automaticas_mob_validate_credito()
  {
    var nomeCampo_credito = "credito";
    var var_credito = scAjaxGetFieldSelect(nomeCampo_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_credito(var_credito, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_credito_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_credito

  function do_ajax_form_facturaven_automaticas_mob_validate_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "credito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_credito_cb

  // ---------- Validate dias_decredito
  function do_ajax_form_facturaven_automaticas_mob_validate_dias_decredito()
  {
    var nomeCampo_dias_decredito = "dias_decredito";
    var var_dias_decredito = scAjaxGetFieldText(nomeCampo_dias_decredito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_dias_decredito(var_dias_decredito, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_dias_decredito_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_dias_decredito

  function do_ajax_form_facturaven_automaticas_mob_validate_dias_decredito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_dias_decredito_cb

  // ---------- Validate id_clasificacion
  function do_ajax_form_facturaven_automaticas_mob_validate_id_clasificacion()
  {
    var nomeCampo_id_clasificacion = "id_clasificacion";
    var var_id_clasificacion = scAjaxGetFieldSelect(nomeCampo_id_clasificacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_id_clasificacion(var_id_clasificacion, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_id_clasificacion_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_id_clasificacion

  function do_ajax_form_facturaven_automaticas_mob_validate_id_clasificacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_id_clasificacion_cb

  // ---------- Validate idcli
  function do_ajax_form_facturaven_automaticas_mob_validate_idcli()
  {
    var nomeCampo_idcli = "idcli";
    var var_idcli = scAjaxGetFieldSelect(nomeCampo_idcli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_idcli(var_idcli, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_idcli_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_idcli

  function do_ajax_form_facturaven_automaticas_mob_validate_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_idcli_cb

  // ---------- Validate dircliente
  function do_ajax_form_facturaven_automaticas_mob_validate_dircliente()
  {
    var nomeCampo_dircliente = "dircliente";
    var var_dircliente = scAjaxGetFieldSelect(nomeCampo_dircliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_dircliente(var_dircliente, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_dircliente_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_dircliente

  function do_ajax_form_facturaven_automaticas_mob_validate_dircliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_dircliente_cb

  // ---------- Validate subtotal
  function do_ajax_form_facturaven_automaticas_mob_validate_subtotal()
  {
    var nomeCampo_subtotal = "subtotal";
    var var_subtotal = scAjaxGetFieldText(nomeCampo_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_subtotal(var_subtotal, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_subtotal_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_subtotal

  function do_ajax_form_facturaven_automaticas_mob_validate_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_subtotal_cb

  // ---------- Validate valoriva
  function do_ajax_form_facturaven_automaticas_mob_validate_valoriva()
  {
    var nomeCampo_valoriva = "valoriva";
    var var_valoriva = scAjaxGetFieldText(nomeCampo_valoriva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_valoriva(var_valoriva, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_valoriva_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_valoriva

  function do_ajax_form_facturaven_automaticas_mob_validate_valoriva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_valoriva_cb

  // ---------- Validate total
  function do_ajax_form_facturaven_automaticas_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_total(var_total, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_total_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_total

  function do_ajax_form_facturaven_automaticas_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_total_cb

  // ---------- Validate observaciones
  function do_ajax_form_facturaven_automaticas_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_observaciones_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_observaciones

  function do_ajax_form_facturaven_automaticas_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_observaciones_cb

  // ---------- Validate vendedor
  function do_ajax_form_facturaven_automaticas_mob_validate_vendedor()
  {
    var nomeCampo_vendedor = "vendedor";
    var var_vendedor = scAjaxGetFieldText(nomeCampo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_vendedor(var_vendedor, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_vendedor_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_vendedor

  function do_ajax_form_facturaven_automaticas_mob_validate_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_vendedor_cb

  // ---------- Validate numfacven
  function do_ajax_form_facturaven_automaticas_mob_validate_numfacven()
  {
    var nomeCampo_numfacven = "numfacven";
    var var_numfacven = scAjaxGetFieldText(nomeCampo_numfacven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_numfacven(var_numfacven, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_numfacven_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_numfacven

  function do_ajax_form_facturaven_automaticas_mob_validate_numfacven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_numfacven_cb

  // ---------- Validate idfacven
  function do_ajax_form_facturaven_automaticas_mob_validate_idfacven()
  {
    var nomeCampo_idfacven = "idfacven";
    var var_idfacven = scAjaxGetFieldHidden(nomeCampo_idfacven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_idfacven(var_idfacven, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_idfacven_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_idfacven

  function do_ajax_form_facturaven_automaticas_mob_validate_idfacven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_idfacven_cb

  // ---------- Validate tipo
  function do_ajax_form_facturaven_automaticas_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_tipo_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_tipo

  function do_ajax_form_facturaven_automaticas_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_tipo_cb

  // ---------- Validate detalle
  function do_ajax_form_facturaven_automaticas_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_detalle_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_detalle

  function do_ajax_form_facturaven_automaticas_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_detalle_cb

  // ---------- Validate activo
  function do_ajax_form_facturaven_automaticas_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldCheckbox(nomeCampo_activo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_automaticas_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_validate_activo_cb);
  } // do_ajax_form_facturaven_automaticas_mob_validate_activo

  function do_ajax_form_facturaven_automaticas_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_validate_activo_cb

  // ---------- Refresh idcli
  function do_ajax_form_facturaven_automaticas_mob_refresh_idcli()
  {
    var var_idcli = scAjaxGetFieldSelect("idcli");
    var var_nmgp_refresh_fields = "dircliente";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_facturaven_automaticas_mob_refresh_idcli(var_idcli, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_refresh_idcli_cb);
  } // do_ajax_form_facturaven_automaticas_mob_refresh_idcli

  function do_ajax_form_facturaven_automaticas_mob_refresh_idcli_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_automaticas_mob_refresh_idcli_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_facturaven_automaticas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_facturaven_automaticas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_facturaven_automaticas_mob_submit_form(var_resolucion, var_formapago, var_fechaven, var_credito, var_dias_decredito, var_id_clasificacion, var_idcli, var_dircliente, var_subtotal, var_valoriva, var_total, var_observaciones, var_vendedor, var_numfacven, var_idfacven, var_tipo, var_activo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_facturaven_automaticas_mob_submit_form_cb);
  } // do_ajax_form_facturaven_automaticas_mob_submit_form

  function do_ajax_form_facturaven_automaticas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_facturaven_automaticas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_facturaven_automaticas_mob_submit_form_cb
  function do_ajax_form_facturaven_automaticas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_facturaven_automaticas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_facturaven_automaticas_detalleventa_mob"] = "off";

  function do_ajax_form_facturaven_automaticas_mob_navigate_form()
  {
    perform_ajax_form_facturaven_automaticas_mob_navigate_form();
  }

  function perform_ajax_form_facturaven_automaticas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_facturaven_automaticas_detalleventa_mob"] = "on";
    x_ajax_form_facturaven_automaticas_mob_navigate_form(var_idfacven, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_automaticas_mob_navigate_form_cb);
  } // do_ajax_form_facturaven_automaticas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_automaticas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_facturaven_automaticas_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_facturaven_automaticas_detalleventa_mob"] && "nmsc_iframe_liga_form_facturaven_automaticas_detalleventa_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_facturaven_automaticas_detalleventa_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_facturaven_automaticas_detalleventa_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_facturaven_automaticas_detalleventa_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_facturaven_automaticas_detalleventa_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_facturaven_automaticas_detalleventa_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_facturaven_automaticas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_facturaven_automaticas_mob_navigate_form_cb
  function do_ajax_form_facturaven_automaticas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_facturaven_automaticas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_facturaven_automaticas_mob_navigate_form_cb_after_alert
  function sc_hide_form_facturaven_automaticas_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_facturaven_automaticas_detalleventa_mob"])
    {
      return true;
    }
    return false;
