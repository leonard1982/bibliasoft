...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_facturaven_automaticas_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_facturaven_automaticas_mob_submit_form(var_resolucion, var_formapago, var_fechaven, var_credito, var_dias_decredito, var_idcli, var_dircliente, var_subtotal, var_valoriva, var_total, var_observaciones, var_vendedor, var_numfacven, var_idfacven, var_tipo, var_id_clasificacion, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_facturaven_automaticas_mob_submit_form_cb);
