...
function sc_form_facturaven_automaticas_id_clasificacion_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_automaticas_validate_id_clasificacion();
  scCssBlur(oThis);
}

function sc_form_facturaven_automaticas_id_clasificacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_facturaven_automaticas_id_clasificacion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
