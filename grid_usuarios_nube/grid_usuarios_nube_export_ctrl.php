<?php
@session_start() ;
$_SESSION['scriptcase']['grid_usuarios_nube']['sc_process_barr'] = true;
require_once('../grid_usuarios_nube/index.php');
unset($_SESSION['scriptcase']['grid_usuarios_nube']['sc_process_barr']);
$ExportCtrl = new grid_usuarios_nube_export_control;
$ExportCtrl->Export_barr();

class grid_usuarios_nube_export_control
{
