...
<?php
   ...
   $Ord_Cmp = new grid_usuarios_nube_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_usuarios_nube_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['password'] = "on";
   $tab_def_campos['password'] = "password";
   $tab_labels["password"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["password"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["password"] : "Password";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "nombre";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["nombre"] : "Nombre";
   $tab_ger_campos['correo'] = "on";
   $tab_def_campos['correo'] = "correo";
   $tab_labels["correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["correo"] : "Correo";
   $tab_ger_campos['telefono'] = "on";
   $tab_def_campos['telefono'] = "telefono";
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["telefono"] : "Telefono";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["tercero"] : "Tercero";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["resolucion"] : "Prefijo";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['labels']["activo"] : "Activo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_usuarios_nube_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_usuarios_nube']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
