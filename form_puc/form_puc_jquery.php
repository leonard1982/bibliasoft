...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_puc_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_puc_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_puc_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo_' + iSeqRow).bind('blur', function() { sc_form_puc_codigo__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_puc_codigo__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_puc_codigo__onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_' + iSeqRow).bind('blur', function() { sc_form_puc_nombre__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_puc_nombre__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_puc_nombre__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_puc_id__onblur(oThis, iSeqRow) {
  do_ajax_form_puc_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_puc_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_puc_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_puc_codigo__onblur(oThis, iSeqRow) {
  do_ajax_form_puc_validate_codigo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_puc_codigo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_puc_codigo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_puc_nombre__onblur(oThis, iSeqRow) {
  do_ajax_form_puc_validate_nombre_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_puc_nombre__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_puc_nombre__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_puc')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
