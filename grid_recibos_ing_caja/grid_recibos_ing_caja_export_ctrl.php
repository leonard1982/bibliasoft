<?php
@session_start() ;
$_SESSION['scriptcase']['grid_recibos_ing_caja']['sc_process_barr'] = true;
require_once('../grid_recibos_ing_caja/index.php');
unset($_SESSION['scriptcase']['grid_recibos_ing_caja']['sc_process_barr']);
$ExportCtrl = new grid_recibos_ing_caja_export_control;
$ExportCtrl->Export_barr();

class grid_recibos_ing_caja_export_control
{
