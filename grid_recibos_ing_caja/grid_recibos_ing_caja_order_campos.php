...
<?php
   ...
   $Ord_Cmp = new grid_recibos_ing_caja_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_recibos_ing_caja_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numero_rc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["numero_rc"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["numero_rc"] : "Número Rc.";
   $tab_ger_campos['fecha_rc'] = "on";
   $tab_def_campos['fecha_rc'] = "fecha_rc";
   $tab_labels["fecha_rc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["fecha_rc"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["fecha_rc"] : "Fecha";
   $tab_ger_campos['contrato'] = "on";
   $tab_def_campos['contrato'] = "contrato";
   $tab_labels["contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["contrato"] : "Contrato N°";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["tercero"] : "Titular";
   $tab_ger_campos['monto_rc'] = "on";
   $tab_def_campos['monto_rc'] = "monto_rc";
   $tab_labels["monto_rc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["monto_rc"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["monto_rc"] : "Monto Rc";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['labels']["imprimir"] : "imprimir";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_recibos_ing_caja_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_recibos_ing_caja']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
