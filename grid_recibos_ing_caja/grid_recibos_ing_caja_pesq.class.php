  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fecha_rc_cond" name="fecha_rc_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_rc'), this, 'fecha_rc')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fecha_rc" <?php echo $str_hide_fecha_rc?> valign="top">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fecha_rc"  <?php echo $str_display_fecha_rc; ?> class="scFilterFieldFontOdd">
