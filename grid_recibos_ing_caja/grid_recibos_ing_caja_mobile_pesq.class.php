...
class grid_recibos_ing_caja_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_recibos_ing_caja_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_recibos_ing_caja_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_recibos_ing_caja_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha_rc";$Nm_datas[] = "fecha_rc";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";$Nm_numeric[] = "id_recibo";$Nm_numeric[] = "numero_rc";$Nm_numeric[] = "contrato";$Nm_numeric[] = "monto_rc";$Nm_numeric[] = "id_banco";
      ...
      $Nm_datas[] = "fecha_rc";$Nm_datas[] = "fecha_rc";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "recibos_ing_caja.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Lista de Recibos de Ingreso a caja</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_recibos_ing_caja/grid_recibos_ing_caja_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_recibos_ing_caja_ajax_search.js"></script>
 <script type="text/javascript" src="grid_recibos_ing_caja_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_recibos_ing_caja_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_recibos_ing_caja']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_recibos_ing_caja']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_fecha_rc_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fecha_rc_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_rc_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_rc_ano').value;
          document.getElementById('sc_fecha_rc_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fecha_rc_dia').value = aParts[0];
          document.getElementById('SC_fecha_rc_mes').value = aParts[1];
          document.getElementById('SC_fecha_rc_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fecha_rc_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fecha_rc_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_rc_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fecha_rc_input_2_ano').value;
          document.getElementById('sc_fecha_rc_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fecha_rc_input_2_dia').value = aParts[0];
          document.getElementById('SC_fecha_rc_input_2_mes').value = aParts[1];
          document.getElementById('SC_fecha_rc_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fecha_rc_cond#NMF#' + search_get_sel_txt('SC_fecha_rc_cond') + '@NMF@';
  str_out += 'SC_fecha_rc_dia#NMF#' + search_get_sel_txt('SC_fecha_rc_dia') + '@NMF@';
  str_out += 'SC_fecha_rc_mes#NMF#' + search_get_sel_txt('SC_fecha_rc_mes') + '@NMF@';
  str_out += 'SC_fecha_rc_ano#NMF#' + search_get_sel_txt('SC_fecha_rc_ano') + '@NMF@';
  str_out += 'SC_fecha_rc_input_2_dia#NMF#' + search_get_sel_txt('SC_fecha_rc_input_2_dia') + '@NMF@';
  str_out += 'SC_fecha_rc_input_2_mes#NMF#' + search_get_sel_txt('SC_fecha_rc_input_2_mes') + '@NMF@';
  str_out += 'SC_fecha_rc_input_2_ano#NMF#' + search_get_sel_txt('SC_fecha_rc_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Lista de Recibos de Ingreso a caja</span></td>
...
<?php
   ...
   {
      global 
             $fecha_rc_cond, $fecha_rc, $fecha_rc_dia, $fecha_rc_mes, $fecha_rc_ano, $fecha_rc_input_2_dia, $fecha_rc_input_2_mes, $fecha_rc_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fecha_rc_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_dia']; 
          $fecha_rc_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_mes']; 
          $fecha_rc_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_ano']; 
          $fecha_rc_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_input_2_dia']; 
          $fecha_rc_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_input_2_mes']; 
          $fecha_rc_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_input_2_ano']; 
          $fecha_rc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fecha_rc_cond) || empty($fecha_rc_cond))
      {
         $fecha_rc_cond = "eq";
      }
      ...
      $str_hide_fecha_rc = (in_array($fecha_rc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fecha_rc = ('bw' == $fecha_rc_cond) ? $display_aberto : $display_fechado;

      if (!isset($fecha_rc) || $fecha_rc == "")
      {
          $fecha_rc = "";
      }
      if (isset($fecha_rc) && !empty($fecha_rc))
      {
         $tmp_pos = strpos($fecha_rc, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fecha_rc = substr($fecha_rc, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
 ...
 $nmgp_tab_label .= "fecha_rc?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_fecha_rc_cond" name="fecha_rc_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_rc'), this, 'fecha_rc')">
       <OPTION value="eq" <?php if ("eq" == $fecha_rc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $fecha_rc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $fecha_rc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fecha_rc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_fecha_rc"  <?php echo $str_hide_fecha_rc?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_rc_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_rc_dia" name="fecha_rc_dia" value="<?php echo NM_encode_input($fecha_rc_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_rc_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_rc_mes" name="fecha_rc_mes" value="<?php echo NM_encode_input($fecha_rc_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_rc_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_rc_ano" name="fecha_rc_ano" value="<?php echo NM_encode_input($fecha_rc_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterSubmit: true}">
 <INPUT type="hidden" id="sc_fecha_rc_jq">
</span>
...
?>
        <SPAN id="id_css_fecha_rc"  class="scFilterFieldFontOdd">
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fecha_rc"  <?php echo $str_display_fecha_rc; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_rc_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_rc_input_2_dia" name="fecha_rc_input_2_dia" value="<?php echo NM_encode_input($fecha_rc_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_rc_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_rc_input_2_mes" name="fecha_rc_input_2_mes" value="<?php echo NM_encode_input($fecha_rc_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterSubmit: true}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fecha_rc_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fecha_rc_input_2_ano" name="fecha_rc_input_2_ano" value="<?php echo NM_encode_input($fecha_rc_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterSubmit: true}">
 <INPUT type="hidden" id="sc_fecha_rc_jq2">
</span>
...
?>
<?php
   if (is_file("grid_recibos_ing_caja_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_recibos_ing_caja']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_recibos_ing_caja']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fecha_rc_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fecha_rc'), document.F1.fecha_rc_cond, 'fecha_rc');
   document.F1.fecha_rc_dia.value = "";
   document.F1.fecha_rc_mes.value = "";
   document.F1.fecha_rc_ano.value = "";
   document.F1.fecha_rc_input_2_dia.value = "";
   document.F1.fecha_rc_input_2_mes.value = "";
   document.F1.fecha_rc_input_2_ano.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_fecha_rc_dia').bind('change', function() {sc_grid_recibos_ing_caja_valida_dia(this)});
    $('#SC_fecha_rc_input_2_dia').bind('change', function() {sc_grid_recibos_ing_caja_valida_dia(this)});
    $('#SC_fecha_rc_input_2_mes').bind('change', function() {sc_grid_recibos_ing_caja_valida_mes(this)});
    $('#SC_fecha_rc_mes').bind('change', function() {sc_grid_recibos_ing_caja_valida_mes(this)});
 }
 function sc_grid_recibos_ing_caja_valida_dia(obj)
 {
 ...
 function sc_grid_recibos_ing_caja_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_recibos_ing_caja";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_recibos_ing_caja/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fecha_rc_cond'] = 'cond';
      $tp_fields['SC_fecha_rc_dia'] = 'text';
      $tp_fields['SC_fecha_rc_mes'] = 'text';
      $tp_fields['SC_fecha_rc_ano'] = 'text';
      $tp_fields['SC_fecha_rc_input_2_dia'] = 'text';
      $tp_fields['SC_fecha_rc_input_2_mes'] = 'text';
      $tp_fields['SC_fecha_rc_input_2_ano'] = 'text';
   ...
   {
      global $fecha_rc_cond, $fecha_rc, $fecha_rc_dia, $fecha_rc_mes, $fecha_rc_ano, $fecha_rc_input_2_dia, $fecha_rc_input_2_mes, $fecha_rc_input_2_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $fecha_rc_cond_salva = $fecha_rc_cond; 
      if (!isset($fecha_rc_input_2_dia) || $fecha_rc_input_2_dia == "")
      {
          $fecha_rc_input_2_dia = $fecha_rc_dia;
      }
      if (!isset($fecha_rc_input_2_mes) || $fecha_rc_input_2_mes == "")
      {
          $fecha_rc_input_2_mes = $fecha_rc_mes;
      }
      if (!isset($fecha_rc_input_2_ano) || $fecha_rc_input_2_ano == "")
      {
          $fecha_rc_input_2_ano = $fecha_rc_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_dia'] = $fecha_rc_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_mes'] = $fecha_rc_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_ano'] = $fecha_rc_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_input_2_dia'] = $fecha_rc_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_input_2_mes'] = $fecha_rc_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_input_2_ano'] = $fecha_rc_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_cond'] = $fecha_rc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($fecha_rc_cond != "bi_TP")
      {
          $fecha_rc_cond = strtoupper($fecha_rc_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fecha_rc_ano;
          $Dtxt .= $fecha_rc_mes;
          $Dtxt .= $fecha_rc_dia;
          $val[0]['ano'] = $fecha_rc_ano;
          $val[0]['mes'] = $fecha_rc_mes;
          $val[0]['dia'] = $fecha_rc_dia;
          if ($fecha_rc_cond == "BW")
          {
              $val[1]['ano'] = $fecha_rc_input_2_ano;
              $val[1]['mes'] = $fecha_rc_input_2_mes;
              $val[1]['dia'] = $fecha_rc_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $fecha_rc_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $fecha_rc_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fecha_rc = $val[0];
          $this->cmp_formatado['fecha_rc'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fecha_rc'], "YYYY-MM-DD");
          $this->cmp_formatado['fecha_rc'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($fecha_rc_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fecha_rc_input_2     = $val[1];
              $this->cmp_formatado['fecha_rc_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']['fecha_rc_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fecha_rc_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['fecha_rc_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $fecha_rc_cond == "NU" || $fecha_rc_cond == "NN"|| $fecha_rc_cond == "EP"|| $fecha_rc_cond == "NE")
          {
              $this->monta_condicao("fecha_rc", $fecha_rc_cond, $fecha_rc, $fecha_rc_input_2, 'fecha_rc', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recibos_ing_caja']['cond_pesq'] .= $this->NM_operador;
