...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_numero_contrato_cond" name="numero_contrato_cond" onChange="nm_campos_between(document.getElementById('id_vis_numero_contrato'), this, 'numero_contrato')">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numero_contrato" id="id_ac_numero_contrato" name="numero_contrato_autocomp"><?php if ('' !=  $numero_contrato) { ?><option value="<?php echo $numero_contrato ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numero_contrato"  <?php echo $str_display_numero_contrato; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numero_contrato_input_2" name="numero_contrato_input_2" value="<?php echo NM_encode_input($numero_contrato_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: true}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_cliente_cond" name="cliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_cliente'), this, 'cliente')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_fecha_contrato_cond" name="fecha_contrato_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_contrato'), this, 'fecha_contrato')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_fecha_inicio_cond" name="fecha_inicio_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_inicio'), this, 'fecha_inicio')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_fecha_corte_cond" name="fecha_corte_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha_corte'), this, 'fecha_corte')">
      ...
      <br><span id="id_hide_fecha_corte"  <?php echo $str_hide_fecha_corte?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_estado_cond" name="estado_cond" onChange="nm_campos_between(document.getElementById('id_vis_estado'), this, 'estado')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_activo_cond" name="activo_cond" onChange="nm_campos_between(document.getElementById('id_vis_activo'), this, 'activo')">
       <OPTION value="eq" <?php if ("eq" == $activo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_activo"  <?php echo $str_hide_activo?>><?php
      if ($activo != "")
      {
      $activo_look = substr($this->Db->qstr($activo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_zona"  <?php echo $str_hide_zona?>><?php
      if ($zona != "")
      {
      $zona_look = substr($this->Db->qstr($zona), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_barrio_cond" name="barrio_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrio'), this, 'barrio')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_motivo_cond" name="motivo_cond" onChange="nm_campos_between(document.getElementById('id_vis_motivo'), this, 'motivo')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_precinto_cond" name="precinto_cond" onChange="nm_campos_between(document.getElementById('id_vis_precinto'), this, 'precinto')">
      ...
      <br><span id="id_hide_precinto"  <?php echo $str_hide_precinto?>><?php
      if ($precinto != "")
      {
      $precinto_look = substr($this->Db->qstr($precinto), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_codigo_cli_cond" name="codigo_cli_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_cli'), this, 'codigo_cli')">
      ...
      <br><span id="id_hide_codigo_cli"  <?php echo $str_hide_codigo_cli?>><?php
      if ($codigo_cli != "")
      {
      $codigo_cli_look = substr($this->Db->qstr($codigo_cli), 1, -1); 
      $nmgp_def_dados = array(); 
