...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_terceros_contratos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_terceros_contratos"]);
   }
