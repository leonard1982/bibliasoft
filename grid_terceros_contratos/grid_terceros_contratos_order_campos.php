...
<?php
   ...
   $Ord_Cmp = new grid_terceros_contratos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_terceros_contratos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numero_contrato"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["numero_contrato"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["numero_contrato"] : "Número Contrato";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "cliente";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["cliente"] : "Cliente";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['fecha_inicio'] = "on";
   $tab_def_campos['fecha_inicio'] = "fecha_inicio";
   $tab_labels["fecha_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["fecha_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["fecha_inicio"] : "Fecha Inicio";
   $tab_ger_campos['saldoactual'] = "on";
   $tab_def_campos['saldoactual'] = "saldoactual";
   $tab_labels["saldoactual"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["saldoactual"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["saldoactual"] : "Saldoactual";
   $tab_ger_campos['zona'] = "on";
   $tab_def_campos['zona'] = "zona";
   $tab_labels["zona"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["zona"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["zona"] : "Zona";
   $tab_ger_campos['barrio'] = "on";
   $tab_def_campos['barrio'] = "barrio";
   $tab_labels["barrio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["barrio"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["barrio"] : "Barrio";
   $tab_ger_campos['codigo_cli'] = "on";
   $tab_def_campos['codigo_cli'] = "codigo_cli";
   $tab_labels["codigo_cli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["codigo_cli"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["codigo_cli"] : "Código cliente";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['labels']["activo"] : "Activo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_terceros_contratos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_terceros_contratos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
