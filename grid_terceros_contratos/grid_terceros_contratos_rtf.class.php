...
class grid_terceros_contratos_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   nm_limpa_str_grid_terceros_contratos($cadapar[1]);
                   nm_protect_num_grid_terceros_contratos($cadapar[0], $cadapar[1]);
                   if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                   $Tmp_par   = $cadapar[0];
                   $$Tmp_par = $cadapar[1];
                   if ($Tmp_par == "nmgp_opcao")
                   {
                       $_SESSION['sc_session'][$script_case_init]['grid_terceros_contratos']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      require_once($this->Ini->path_aplicacao . "grid_terceros_contratos_total.class.php"); 
      $this->Tot      = new grid_terceros_contratos_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['SC_Ind_Groupby'];
      if (method_exists($this->Tot,$Gb_geral))
      {
          $this->Tot->$Gb_geral();
          $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['tot_geral'][1];
      }
      if (!$this->Ini->sc_export_ajax) {
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_terceros_contratos']['glo_nm_path_imag_temp'] . "/");
      ...
      $this->Arquivo   .= "_grid_terceros_contratos";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_terceros_contratos.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_contratos']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_contratos']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_contratos']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['usr_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['php_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['campos_busca'];
          ...
          $this->numero_contrato_2 = $Busca_temp['numero_contrato_input_2']; 
          ...
          $this->fecha_contrato = $Busca_temp['fecha_contrato']; 
          $tmp_pos = strpos($this->fecha_contrato, "##@@");
          if ($tmp_pos !== false && !is_array($this->fecha_contrato))
          {
              $this->fecha_contrato = substr($this->fecha_contrato, 0, $tmp_pos);
          }
          $this->fecha_contrato_2 = $Busca_temp['fecha_contrato_input_2']; 
          ...
          $this->fecha_corte = $Busca_temp['fecha_corte']; 
          $tmp_pos = strpos($this->fecha_corte, "##@@");
          if ($tmp_pos !== false && !is_array($this->fecha_corte))
          {
              $this->fecha_corte = substr($this->fecha_corte, 0, $tmp_pos);
          }
          $this->fecha_corte_2 = $Busca_temp['fecha_corte_input_2']; 
          ...
          $this->precinto = $Busca_temp['precinto']; 
          $tmp_pos = strpos($this->precinto, "##@@");
          if ($tmp_pos !== false && !is_array($this->precinto))
          {
              $this->precinto = substr($this->precinto, 0, $tmp_pos);
          }
          $this->codigo_cli = $Busca_temp['codigo_cli']; 
          $tmp_pos = strpos($this->codigo_cli, "##@@");
          if ($tmp_pos !== false && !is_array($this->codigo_cli))
          {
              $this->codigo_cli = substr($this->codigo_cli, 0, $tmp_pos);
          }
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['rtf_name']);
      }
      ...
      $this->Texto_tag .= "<tr>\r\n";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['field_order'] as $Cada_col)
      { 
          ...
          if ($Cada_col == "codigo_cli" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
          ...
          $SC_Label = (isset($this->New_label['fecha_factura'])) ? $this->New_label['fecha_factura'] : "Fecha Factura"; 
      ...
      { 
          $nmgp_select = "SELECT numero_contrato, cliente, direccion, str_replace (convert(char(10),fecha_inicio,102), '.', '-') + ' ' + convert(char(8),fecha_inicio,20), saldoactual, zona, barrio, codigo_cli, activo, id_ter_cont, str_replace (convert(char(10),fecha_contrato,102), '.', '-') + ' ' + convert(char(8),fecha_contrato,20), str_replace (convert(char(10),fecha_corte,102), '.', '-') + ' ' + convert(char(8),fecha_corte,20), estado, telefono, motivo, str_replace (convert(char(10),fecha_limitepago,102), '.', '-') + ' ' + convert(char(8),fecha_limitepago,20), str_replace (convert(char(10),fecha_ultimopago,102), '.', '-') + ' ' + convert(char(8),fecha_ultimopago,20), valorpagado, saldoanterior, mesultimafactura, observaciones, valor_ultimafactura, mensualidad, precinto, correo, str_replace (convert(char(10),fecha_factura,102), '.', '-') + ' ' + convert(char(8),fecha_factura,20) from " . $this->Ini->nm_tabela; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nmgp_select = "SELECT numero_contrato, cliente, direccion, fecha_inicio, saldoactual, zona, barrio, codigo_cli, activo, id_ter_cont, fecha_contrato, fecha_corte, estado, telefono, motivo, fecha_limitepago, fecha_ultimopago, valorpagado, saldoanterior, mesultimafactura, observaciones, valor_ultimafactura, mensualidad, precinto, correo, fecha_factura from " . $this->Ini->nm_tabela; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
       $nmgp_select = "SELECT numero_contrato, cliente, direccion, convert(char(23),fecha_inicio,121), saldoactual, zona, barrio, codigo_cli, activo, id_ter_cont, convert(char(23),fecha_contrato,121), convert(char(23),fecha_corte,121), estado, telefono, motivo, convert(char(23),fecha_limitepago,121), convert(char(23),fecha_ultimopago,121), valorpagado, saldoanterior, mesultimafactura, observaciones, valor_ultimafactura, mensualidad, precinto, correo, convert(char(23),fecha_factura,121) from " . $this->Ini->nm_tabela; 
      } 
      ...
      { 
          $nmgp_select = "SELECT numero_contrato, cliente, direccion, EXTEND(fecha_inicio, YEAR TO DAY), saldoactual, zona, barrio, codigo_cli, activo, id_ter_cont, EXTEND(fecha_contrato, YEAR TO DAY), EXTEND(fecha_corte, YEAR TO DAY), estado, telefono, motivo, EXTEND(fecha_limitepago, YEAR TO DAY), EXTEND(fecha_ultimopago, YEAR TO DAY), valorpagado, saldoanterior, mesultimafactura, observaciones, valor_ultimafactura, mensualidad, precinto, correo, EXTEND(fecha_factura, YEAR TO DAY) from " . $this->Ini->nm_tabela; 
      } 
      else 
      { 
          $nmgp_select = "SELECT numero_contrato, cliente, direccion, fecha_inicio, saldoactual, zona, barrio, codigo_cli, activo, id_ter_cont, fecha_contrato, fecha_corte, estado, telefono, motivo, fecha_limitepago, fecha_ultimopago, valorpagado, saldoanterior, mesultimafactura, observaciones, valor_ultimafactura, mensualidad, precinto, correo, fecha_factura from " . $this->Ini->nm_tabela; 
      } 
      $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['where_pesq'];
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->zona = $rs->fields[5] ;  
         $this->barrio = $rs->fields[6] ;  
         $this->codigo_cli = $rs->fields[7] ;  
         $this->activo = $rs->fields[8] ;  
         $this->id_ter_cont = $rs->fields[9] ;  
         $this->id_ter_cont = (string)$this->id_ter_cont;
         $this->fecha_contrato = $rs->fields[10] ;  
         $this->fecha_corte = $rs->fields[11] ;  
         ...
         $this->mesultimafactura = $rs->fields[19] ;  
         $this->observaciones = $rs->fields[20] ;  
         $this->valor_ultimafactura = $rs->fields[21] ;  
         ...
         $this->fecha_factura = $rs->fields[25] ;  
         //----- lookup - cliente
         ...
         $_SESSION['scriptcase']['grid_terceros_contratos']['contr_erro'] = 'on';
 $sql_1 = "SELECT nombre from zona_clientes where codigo = '".$this->zona ."'";
$sql_2 = "SELECT descripcion from barrios where codigo = '".$this->barrio ."'";
...
;
if(isset($this->ds1[0][0]))
	{
	$this->zona  = $this->ds1[0][0];
	}
else
	{
	$this->zona  = "N/A";
...
if(isset($this->ds2[0][0]))
	{
	$this->barrio  = $this->ds2[0][0];
	}
else
	{
	$this->barrio  = "N/A";
	}
$_SESSION['scriptcase']['grid_terceros_contratos']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['field_order'] as $Cada_col)
         { 
      ...
      $this->Texto_tag .= "</table>\r\n";
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   //----- numero_contrato
   function NM_export_numero_contrato()
   {
         ...
         $this->numero_contrato = str_replace('<', '&lt;', $this->numero_contrato);
         $this->numero_contrato = str_replace('>', '&gt;', $this->numero_contrato);
         $this->Texto_tag .= "<td>" . $this->numero_contrato . "</td>\r\n";
   }
   //----- cliente
   ...
   function NM_export_saldoactual()
   {
         ...
         $this->saldoactual = str_replace('<', '&lt;', $this->saldoactual);
         $this->saldoactual = str_replace('>', '&gt;', $this->saldoactual);
         $this->Texto_tag .= "<td>" . $this->saldoactual . "</td>\r\n";
   }
   //----- zona
   ...
   //----- codigo_cli
   function NM_export_codigo_cli()
   {
         $this->codigo_cli = html_entity_decode($this->codigo_cli, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->codigo_cli = strip_tags($this->codigo_cli);
         $this->codigo_cli = NM_charset_to_utf8($this->codigo_cli);
         $this->codigo_cli = str_replace('<', '&lt;', $this->codigo_cli);
         $this->codigo_cli = str_replace('>', '&gt;', $this->codigo_cli);
         $this->Texto_tag .= "<td>" . $this->codigo_cli . "</td>\r\n";
   }
   //----- activo
   ...
   function NM_export_id_ter_cont()
   {
         ...
         $this->id_ter_cont = str_replace('<', '&lt;', $this->id_ter_cont);
         $this->id_ter_cont = str_replace('>', '&gt;', $this->id_ter_cont);
         $this->Texto_tag .= "<td>" . $this->id_ter_cont . "</td>\r\n";
   }
   //----- fecha_contrato
   function NM_export_fecha_contrato()
   {
         ...
         $this->fecha_contrato = NM_charset_to_utf8($this->fecha_contrato);
         $this->fecha_contrato = str_replace('<', '&lt;', $this->fecha_contrato);
         $this->fecha_contrato = str_replace('>', '&gt;', $this->fecha_contrato);
         $this->Texto_tag .= "<td>" . $this->fecha_contrato . "</td>\r\n";
   }
   //----- fecha_corte
   function NM_export_fecha_corte()
   {
         ...
         $this->fecha_corte = NM_charset_to_utf8($this->fecha_corte);
         $this->fecha_corte = str_replace('<', '&lt;', $this->fecha_corte);
         $this->fecha_corte = str_replace('>', '&gt;', $this->fecha_corte);
         $this->Texto_tag .= "<td>" . $this->fecha_corte . "</td>\r\n";
   }
   //----- estado
   ...
   function NM_export_fecha_limitepago()
   {
         ...
         $this->fecha_limitepago = NM_charset_to_utf8($this->fecha_limitepago);
         $this->fecha_limitepago = str_replace('<', '&lt;', $this->fecha_limitepago);
         $this->fecha_limitepago = str_replace('>', '&gt;', $this->fecha_limitepago);
         $this->Texto_tag .= "<td>" . $this->fecha_limitepago . "</td>\r\n";
   }
   //----- fecha_ultimopago
   function NM_export_fecha_ultimopago()
   {
         ...
         $this->fecha_ultimopago = NM_charset_to_utf8($this->fecha_ultimopago);
         $this->fecha_ultimopago = str_replace('<', '&lt;', $this->fecha_ultimopago);
         $this->fecha_ultimopago = str_replace('>', '&gt;', $this->fecha_ultimopago);
         $this->Texto_tag .= "<td>" . $this->fecha_ultimopago . "</td>\r\n";
   }
   //----- valorpagado
   function NM_export_valorpagado()
   {
         ...
         $this->valorpagado = str_replace('<', '&lt;', $this->valorpagado);
         $this->valorpagado = str_replace('>', '&gt;', $this->valorpagado);
         $this->Texto_tag .= "<td>" . $this->valorpagado . "</td>\r\n";
   }
   //----- saldoanterior
   function NM_export_saldoanterior()
   {
         ...
         $this->saldoanterior = str_replace('<', '&lt;', $this->saldoanterior);
         $this->saldoanterior = str_replace('>', '&gt;', $this->saldoanterior);
         $this->Texto_tag .= "<td>" . $this->saldoanterior . "</td>\r\n";
   }
   //----- mesultimafactura
   function NM_export_mesultimafactura()
   {
         ...
         $this->mesultimafactura = str_replace('<', '&lt;', $this->mesultimafactura);
         $this->mesultimafactura = str_replace('>', '&gt;', $this->mesultimafactura);
         $this->Texto_tag .= "<td>" . $this->mesultimafactura . "</td>\r\n";
   }
   //----- observaciones
   ...
   function NM_export_valor_ultimafactura()
   {
         ...
         $this->valor_ultimafactura = str_replace('<', '&lt;', $this->valor_ultimafactura);
         $this->valor_ultimafactura = str_replace('>', '&gt;', $this->valor_ultimafactura);
         $this->Texto_tag .= "<td>" . $this->valor_ultimafactura . "</td>\r\n";
   }
   //----- mensualidad
   function NM_export_mensualidad()
   {
             nmgp_Form_Num_Val($this->mensualidad, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "2", "S", "2", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
         $this->mensualidad = NM_charset_to_utf8($this->mensualidad);
         $this->mensualidad = str_replace('<', '&lt;', $this->mensualidad);
         $this->mensualidad = str_replace('>', '&gt;', $this->mensualidad);
         $this->Texto_tag .= "<td>" . $this->mensualidad . "</td>\r\n";
   }
   //----- precinto
   function NM_export_precinto()
   {
         ...
         $this->precinto = str_replace('<', '&lt;', $this->precinto);
         $this->precinto = str_replace('>', '&gt;', $this->precinto);
         $this->Texto_tag .= "<td>" . $this->precinto . "</td>\r\n";
   }
   //----- correo
   ...
   function NM_export_fecha_factura()
   {
         ...
         $this->fecha_factura = NM_charset_to_utf8($this->fecha_factura);
         $this->fecha_factura = str_replace('<', '&lt;', $this->fecha_factura);
         $this->fecha_factura = str_replace('>', '&gt;', $this->fecha_factura);
         $this->Texto_tag .= "<td>" . $this->fecha_factura . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_contratos'][$path_doc_md5][1] = $this->Tit_doc;
...
<form name="Fdown" method="get" action="grid_terceros_contratos_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_terceros_contratos"> 
