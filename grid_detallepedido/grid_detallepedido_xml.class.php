...
$_SESSION['scriptcase']['grid_detallepedido']['contr_erro'] = 'off'; 
   ...
   function NM_export_idbod()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->look_idbod))
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->look_idbod) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->look_idbod) . "\"";
         }
   }
   //----- cantidad
