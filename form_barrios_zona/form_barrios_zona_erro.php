...
$old_error_handler = set_error_handler("form_barrios_zona_scriptcase_error_handler");

function form_barrios_zona_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_barrios_zona']['contr_erro']) && $_SESSION['scriptcase']['form_barrios_zona']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_barrios_zona;
            $inicial_form_barrios_zona->contr_form_barrios_zona->Apl_com_erro = true;
            if ($inicial_form_barrios_zona->contr_form_barrios_zona->NM_ajax_flag)
            {
                $inicial_form_barrios_zona->contr_form_barrios_zona->NM_ajax_info['errList']['geral_form_barrios_zona'][] = $msg;
                return;
            }
            form_barrios_zona_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_barrios_zona_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_barrios_zona'])  && '' != $_SESSION['scriptcase']['error_icon']['form_barrios_zona'])  ? $_SESSION['scriptcase']['error_icon']['form_barrios_zona']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_barrios_zona']) && '' != $_SESSION['scriptcase']['error_span_title']['form_barrios_zona']) ? $_SESSION['scriptcase']['error_span_title']['form_barrios_zona'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_barrios_zona']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_barrios_zona']) ? $_SESSION['scriptcase']['error_icon_title']['form_barrios_zona'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_barrios_zona']['error_buffer'] .= ob_get_flush();
}
