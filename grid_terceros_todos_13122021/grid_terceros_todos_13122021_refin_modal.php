...
class refin_search_modal
{
   function init_modal()
   {
       ...
       $label_cmp     = $_SESSION['sc_session'][$this->sc_init]['grid_terceros_todos_13122021']['int_search_label'][$cmp_process];
       $lim_col       = 3;
       $qtd_col       = 0;
...
<?php
       ...
       $bol_submit_onclick = false;
           ...
           $arr_field = $_SESSION['sc_session'][$this->sc_init]['grid_terceros_todos_13122021']['int_search_dados'][$cmp_process]; 
                    foreach ($arr_field as $cada_opc => $dados_opc)
                    {
                        if(!isset($_SESSION['sc_session'][$this->sc_init]['grid_terceros_todos_13122021']['interativ_search'][$cmp_process]['val_sel']) || !in_array($cada_opc, $_SESSION['sc_session'][$this->sc_init]['grid_terceros_todos_13122021']['interativ_search'][$cmp_process]['val_sel']))
                        {
    ...
    <div class="scGridRefinedSearchMoldura">
        <div>
            ...
            <div class="scGridRefinedSearchMolduraResult scGridRefinedSearchCampo" style="overflow-y: scroll;">
                <div style="display: flex; flex-flow: row wrap;">
                    ...
                    foreach ($arr_field as $cada_opc => $dados_opc)
                    {
                        ...
                        $checked = (isset($_SESSION['sc_session'][$this->sc_init]['grid_terceros_todos_13122021']['interativ_search'][$cmp_process]['val_sel']) && in_array($cada_opc, $_SESSION['sc_session'][$this->sc_init]['grid_terceros_todos_13122021']['interativ_search'][$cmp_process]['val_sel'])) ? " checked" : "";
                        $evt  = "";
            ...
            <div class="scGridRefinedSearchToolbar" style="text-align: center;">
                ...
                <input class='scAppDivToolbarInput' style='margin:0px' type='checkbox' checked='checked' onclick="refinedSearchCheckUncheckAllModal('<?php echo $cmp_process; ?>', true); this.checked=true;" \>
                <input class='scAppDivToolbarInput' style='margin:0px' type='checkbox'                   onclick="refinedSearchCheckUncheckAllModal('<?php echo $cmp_process; ?>', false); this.checked=false;" \>
                </span>
