<?php
   include_once('grid_terceros_todos_13122021_session.php');
   session_start();
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_todos_13122021"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_todos_13122021"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['terceros'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_terceros_todos_13122021</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_terceros_todos_13122021']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_terceros_todos_13122021' || $achou)
          {
