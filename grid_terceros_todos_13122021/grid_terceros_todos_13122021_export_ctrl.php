<?php
@session_start() ;
$_SESSION['scriptcase']['grid_terceros_todos_13122021']['sc_process_barr'] = true;
require_once('../grid_terceros_todos_13122021/index.php');
unset($_SESSION['scriptcase']['grid_terceros_todos_13122021']['sc_process_barr']);
$ExportCtrl = new grid_terceros_todos_13122021_export_control;
$ExportCtrl->Export_barr();

class grid_terceros_todos_13122021_export_control
{
