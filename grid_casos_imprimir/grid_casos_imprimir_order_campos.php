...
<?php
   ...
   $Ord_Cmp = new grid_casos_imprimir_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_casos_imprimir_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["fecha"] : "FECHA";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["numero"] : "CASO NÚMERO";
   $tab_ger_campos['codigo_cliente'] = "on";
   $tab_def_campos['codigo_cliente'] = "codigo_cliente";
   $tab_labels["codigo_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["codigo_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["codigo_cliente"] : "CONTRATO";
   ...
   $tab_labels["zona"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["zona"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["zona"] : "ZONA";
   ...
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["direccion"] : "DIRECCIÓN";
   ...
   $tab_labels["telefono"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["telefono"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["telefono"] : "TELÉFONO";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["estado"] : "ESTADO";
   $tab_ger_campos['prioridad'] = "on";
   $tab_def_campos['prioridad'] = "prioridad";
   $tab_labels["prioridad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["prioridad"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["prioridad"] : "PRIORIDAD";
   $tab_ger_campos['asignado_tercero'] = "on";
   $tab_def_campos['asignado_tercero'] = "asignado_tercero";
   $tab_labels["asignado_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["asignado_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["asignado_tercero"] : "ASIGNADO A:";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['labels']["observaciones"] : "OBSERVACIONES";
   $tab_ger_campos['zona'] = "none";
   $tab_ger_campos['direccion'] = "none";
   $tab_ger_campos['telefono'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_casos_imprimir']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_casos_imprimir']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_casos_imprimir']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_casos_imprimir_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_casos_imprimir']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
