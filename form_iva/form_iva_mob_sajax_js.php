  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_iva_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate trifa
  function do_ajax_form_iva_mob_validate_trifa()
  {
    var nomeCampo_trifa = "trifa";
    var var_trifa = scAjaxGetFieldText(nomeCampo_trifa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_trifa(var_trifa, var_script_case_init, do_ajax_form_iva_mob_validate_trifa_cb);
  } // do_ajax_form_iva_mob_validate_trifa

  function do_ajax_form_iva_mob_validate_trifa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_trifa_cb

  // ---------- Validate tipo_impuesto
  function do_ajax_form_iva_mob_validate_tipo_impuesto()
  {
    var nomeCampo_tipo_impuesto = "tipo_impuesto";
    var var_tipo_impuesto = scAjaxGetFieldText(nomeCampo_tipo_impuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_tipo_impuesto(var_tipo_impuesto, var_script_case_init, do_ajax_form_iva_mob_validate_tipo_impuesto_cb);
  } // do_ajax_form_iva_mob_validate_tipo_impuesto

  function do_ajax_form_iva_mob_validate_tipo_impuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_tipo_impuesto_cb

  // ---------- Validate codigo
  function do_ajax_form_iva_mob_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_iva_mob_validate_codigo_cb);
  } // do_ajax_form_iva_mob_validate_codigo

  function do_ajax_form_iva_mob_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_codigo_cb

  // ---------- Validate id_pucaux_compras
  function do_ajax_form_iva_mob_validate_id_pucaux_compras()
  {
    var nomeCampo_id_pucaux_compras = "id_pucaux_compras";
    var var_id_pucaux_compras = scAjaxGetFieldSelect(nomeCampo_id_pucaux_compras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_id_pucaux_compras(var_id_pucaux_compras, var_script_case_init, do_ajax_form_iva_mob_validate_id_pucaux_compras_cb);
  } // do_ajax_form_iva_mob_validate_id_pucaux_compras

  function do_ajax_form_iva_mob_validate_id_pucaux_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_pucaux_compras";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_id_pucaux_compras_cb

  // ---------- Validate puc_dv_compras
  function do_ajax_form_iva_mob_validate_puc_dv_compras()
  {
    var nomeCampo_puc_dv_compras = "puc_dv_compras";
    var var_puc_dv_compras = scAjaxGetFieldSelect(nomeCampo_puc_dv_compras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_puc_dv_compras(var_puc_dv_compras, var_script_case_init, do_ajax_form_iva_mob_validate_puc_dv_compras_cb);
  } // do_ajax_form_iva_mob_validate_puc_dv_compras

  function do_ajax_form_iva_mob_validate_puc_dv_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_puc_dv_compras_cb

  // ---------- Validate puc_compras
  function do_ajax_form_iva_mob_validate_puc_compras()
  {
    var nomeCampo_puc_compras = "puc_compras";
    var var_puc_compras = scAjaxGetFieldSelect(nomeCampo_puc_compras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_puc_compras(var_puc_compras, var_script_case_init, do_ajax_form_iva_mob_validate_puc_compras_cb);
  } // do_ajax_form_iva_mob_validate_puc_compras

  function do_ajax_form_iva_mob_validate_puc_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_puc_compras_cb

  // ---------- Validate id_pucaux_ventas
  function do_ajax_form_iva_mob_validate_id_pucaux_ventas()
  {
    var nomeCampo_id_pucaux_ventas = "id_pucaux_ventas";
    var var_id_pucaux_ventas = scAjaxGetFieldSelect(nomeCampo_id_pucaux_ventas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_id_pucaux_ventas(var_id_pucaux_ventas, var_script_case_init, do_ajax_form_iva_mob_validate_id_pucaux_ventas_cb);
  } // do_ajax_form_iva_mob_validate_id_pucaux_ventas

  function do_ajax_form_iva_mob_validate_id_pucaux_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_pucaux_ventas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_id_pucaux_ventas_cb

  // ---------- Validate id_pucaux_nc
  function do_ajax_form_iva_mob_validate_id_pucaux_nc()
  {
    var nomeCampo_id_pucaux_nc = "id_pucaux_nc";
    var var_id_pucaux_nc = scAjaxGetFieldSelect(nomeCampo_id_pucaux_nc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_id_pucaux_nc(var_id_pucaux_nc, var_script_case_init, do_ajax_form_iva_mob_validate_id_pucaux_nc_cb);
  } // do_ajax_form_iva_mob_validate_id_pucaux_nc

  function do_ajax_form_iva_mob_validate_id_pucaux_nc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_id_pucaux_nc_cb

  // ---------- Validate id_pucaux_nd
  function do_ajax_form_iva_mob_validate_id_pucaux_nd()
  {
    var nomeCampo_id_pucaux_nd = "id_pucaux_nd";
    var var_id_pucaux_nd = scAjaxGetFieldSelect(nomeCampo_id_pucaux_nd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_id_pucaux_nd(var_id_pucaux_nd, var_script_case_init, do_ajax_form_iva_mob_validate_id_pucaux_nd_cb);
  } // do_ajax_form_iva_mob_validate_id_pucaux_nd

  function do_ajax_form_iva_mob_validate_id_pucaux_nd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_id_pucaux_nd_cb

  // ---------- Validate id_pucaux_exec
  function do_ajax_form_iva_mob_validate_id_pucaux_exec()
  {
    var nomeCampo_id_pucaux_exec = "id_pucaux_exec";
    var var_id_pucaux_exec = scAjaxGetFieldSelect(nomeCampo_id_pucaux_exec);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_iva_mob_validate_id_pucaux_exec(var_id_pucaux_exec, var_script_case_init, do_ajax_form_iva_mob_validate_id_pucaux_exec_cb);
  } // do_ajax_form_iva_mob_validate_id_pucaux_exec

  function do_ajax_form_iva_mob_validate_id_pucaux_exec_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_pucaux_exec";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_iva_mob_validate_id_pucaux_exec_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_iva_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_iva_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_id_pucaux_compras = scAjaxGetFieldSelect("id_pucaux_compras");
    var var_puc_dv_compras = scAjaxGetFieldSelect("puc_dv_compras");
    var var_puc_compras = scAjaxGetFieldSelect("puc_compras");
    var var_id_pucaux_ventas = scAjaxGetFieldSelect("id_pucaux_ventas");
    var var_id_pucaux_nc = scAjaxGetFieldSelect("id_pucaux_nc");
    var var_id_pucaux_nd = scAjaxGetFieldSelect("id_pucaux_nd");
    var var_id_pucaux_exec = scAjaxGetFieldSelect("id_pucaux_exec");
    ...
    scAjaxProcOn();
    x_ajax_form_iva_mob_submit_form(var_trifa, var_tipo_impuesto, var_codigo, var_id_pucaux_compras, var_puc_dv_compras, var_puc_compras, var_id_pucaux_ventas, var_id_pucaux_nc, var_id_pucaux_nd, var_id_pucaux_exec, var_idiva, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_iva_mob_submit_form_cb);
  } // do_ajax_form_iva_mob_submit_form

  function do_ajax_form_iva_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_iva_mob_submit_form_cb_after_alert);
  } // do_ajax_form_iva_mob_submit_form_cb
  function do_ajax_form_iva_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_iva_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_iva_mob_navigate_form()
  {
    perform_ajax_form_iva_mob_navigate_form();
  }

  function perform_ajax_form_iva_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_iva_mob_navigate_form(var_idiva, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_iva_mob_navigate_form_cb);
  } // do_ajax_form_iva_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_iva_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_iva_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_iva_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_iva_mob_navigate_form_cb
  function do_ajax_form_iva_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('trifa');
...
{
?>
    do_ajax_form_iva_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_iva_mob_navigate_form_cb_after_alert
  function sc_hide_form_iva_mob_form()
  {
  ...
  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_compras()
  {
    var var_id_pucaux_compras = scAjaxGetFieldSelect("id_pucaux_compras");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_compras";
    x_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_compras(var_id_pucaux_compras, nmgp_refresh_fields, var_script_case_init, do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_compras_cb);
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_compras

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_compras_cb

  function do_ajax_form_iva_mob_lkpedt_refresh_puc_dv_compras()
  {
    var var_puc_dv_compras = scAjaxGetFieldSelect("puc_dv_compras");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "puc_dv_compras";
    x_ajax_form_iva_mob_lkpedt_refresh_puc_dv_compras(var_puc_dv_compras, nmgp_refresh_fields, var_script_case_init, do_ajax_form_iva_mob_lkpedt_refresh_puc_dv_compras_cb);
  } // do_ajax_form_iva_mob_lkpedt_refresh_puc_dv_compras

  function do_ajax_form_iva_mob_lkpedt_refresh_puc_dv_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_iva_mob_lkpedt_refresh_puc_dv_compras_cb

  function do_ajax_form_iva_mob_lkpedt_refresh_puc_compras()
  {
    var var_puc_compras = scAjaxGetFieldSelect("puc_compras");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "puc_compras";
    x_ajax_form_iva_mob_lkpedt_refresh_puc_compras(var_puc_compras, nmgp_refresh_fields, var_script_case_init, do_ajax_form_iva_mob_lkpedt_refresh_puc_compras_cb);
  } // do_ajax_form_iva_mob_lkpedt_refresh_puc_compras

  function do_ajax_form_iva_mob_lkpedt_refresh_puc_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_iva_mob_lkpedt_refresh_puc_compras_cb

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_ventas()
  {
    var var_id_pucaux_ventas = scAjaxGetFieldSelect("id_pucaux_ventas");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_ventas";
    x_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_ventas(var_id_pucaux_ventas, nmgp_refresh_fields, var_script_case_init, do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_ventas_cb);
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_ventas

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_ventas_cb

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nc()
  {
    var var_id_pucaux_nc = scAjaxGetFieldSelect("id_pucaux_nc");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_nc";
    x_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nc(var_id_pucaux_nc, nmgp_refresh_fields, var_script_case_init, do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nc_cb);
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nc

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nc_cb

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nd()
  {
    var var_id_pucaux_nd = scAjaxGetFieldSelect("id_pucaux_nd");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_nd";
    x_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nd(var_id_pucaux_nd, nmgp_refresh_fields, var_script_case_init, do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nd_cb);
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nd

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_nd_cb

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_exec()
  {
    var var_id_pucaux_exec = scAjaxGetFieldSelect("id_pucaux_exec");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_pucaux_exec";
    x_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_exec(var_id_pucaux_exec, nmgp_refresh_fields, var_script_case_init, do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_exec_cb);
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_exec

  function do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_exec_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_iva_mob_lkpedt_refresh_id_pucaux_exec_cb
  ...
  ajax_field_list[3] = "id_pucaux_compras";
  ajax_field_list[4] = "puc_dv_compras";
  ajax_field_list[5] = "puc_compras";
  ajax_field_list[6] = "id_pucaux_ventas";
  ajax_field_list[7] = "id_pucaux_nc";
  ajax_field_list[8] = "id_pucaux_nd";
  ajax_field_list[9] = "id_pucaux_exec";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "trifa": {"label": "Tasa Impuesto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "id_pucaux_compras": {"label": "Auxiliar Compras", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puc_dv_compras": {"label": "Auxiliar NC Compras", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puc_compras": {"label": "Auxiliar ND Compras", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_pucaux_ventas": {"label": "Auxiliar Ventas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_pucaux_nc": {"label": "Auxuliar NC Ventas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "id_pucaux_exec": {"label": "Auxiliar Exentos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "id_pucaux_compras": new Array("hidden_field_label_id_pucaux_compras", "hidden_field_data_id_pucaux_compras"),
    ...
    "id_pucaux_ventas": new Array("hidden_field_label_id_pucaux_ventas", "hidden_field_data_id_pucaux_ventas"),
    ...
    "id_pucaux_exec": new Array("hidden_field_label_id_pucaux_exec", "hidden_field_data_id_pucaux_exec")
  };
  ...
  var ajax_read_only = {
    ...
    "tipo_impuesto": "off",
    "codigo": "off",
    "id_pucaux_compras": "off",
    "puc_dv_compras": "off",
    "puc_compras": "off",
    "id_pucaux_ventas": "off",
    "id_pucaux_nc": "off",
    "id_pucaux_nd": "off",
    "id_pucaux_exec": "off"
  };
