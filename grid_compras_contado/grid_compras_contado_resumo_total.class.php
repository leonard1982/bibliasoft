...
$_SESSION['scriptcase']['grid_compras_contado']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['arr_total']['total'];
      }
      else
      {
          $this->array_total_total = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_order']['total']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_order']['total'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_order']['total'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_display']['total'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_display']['total'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_display']['total'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_display']['total'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_display']['total'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_display']['total'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['summarizing_fields_display']['total'] as $i_sum => $d_sum)
           {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_val_ret, $sum_val_ica, $sum_val_retiva, $sum_total, $sum_a_pagar, $sum_subtotal, $sum_valoriva, $quebra_total, $quebra_total_orig)
   {
      //----- Total
      if (!isset($this->array_total_total[$quebra_total_orig]))
      {
         $this->array_total_total[$quebra_total_orig][0] = 1;
         $this->array_total_total[$quebra_total_orig][1] = $sum_val_ret;
         $this->array_total_total[$quebra_total_orig][2] = $sum_val_ica;
         $this->array_total_total[$quebra_total_orig][3] = $sum_val_retiva;
         $this->array_total_total[$quebra_total_orig][4] = $sum_total;
         $this->array_total_total[$quebra_total_orig][5] = $sum_a_pagar;
         $this->array_total_total[$quebra_total_orig][6] = $sum_subtotal;
         $this->array_total_total[$quebra_total_orig][7] = $sum_valoriva;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['arr_total']['total'] as $campo_total => $dados_total)
      {
         $this->array_total_total[$campo_total][3] = $dados_total[1];
         $this->array_total_total[$campo_total][5] = $dados_total[2];
         $this->array_total_total[$campo_total][6] = $dados_total[3];
         $this->array_total_total[$campo_total][2] = $dados_total[4];
         $this->array_total_total[$campo_total][8] = $dados_total[5];
         $this->array_total_total[$campo_total][7] = $dados_total[6];
         $this->array_total_total[$campo_total][4] = $dados_total[7];
...
$_SESSION['scriptcase']['grid_compras_contado']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->val_ret, $this->val_ica, $this->val_retiva, $this->total, $this->a_pagar, $this->subtotal, $this->valoriva, $this->total, $this->total_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_compras_contado']['contr_erro'] = 'off';
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_contado']['arr_total']['total'] = $this->array_total_total;
      }
   }
