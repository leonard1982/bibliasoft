...
<?php
   ...
   $Ord_Cmp = new grid_compras_contado_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_compras_contado_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['idfaccom'] = "on";
   $tab_def_campos['idfaccom'] = "idfaccom";
   $tab_labels["idfaccom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["idfaccom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["idfaccom"] : "Compra No.";
   $tab_ger_campos['numfacom'] = "on";
   $tab_def_campos['numfacom'] = "numfacom";
   $tab_labels["numfacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["numfacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["numfacom"] : "Número documento";
   $tab_ger_campos['id_pedidocom'] = "on";
   $tab_def_campos['id_pedidocom'] = "id_pedidocom";
   $tab_labels["id_pedidocom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["id_pedidocom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["id_pedidocom"] : "Pedido";
   $tab_ger_campos['fechacom'] = "on";
   $tab_def_campos['fechacom'] = "fechacom";
   $tab_labels["fechacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["fechacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["fechacom"] : "Fecha";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['idprov'] = "on";
   $tab_def_campos['idprov'] = "idprov";
   $tab_labels["idprov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["idprov"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["idprov"] : "Proveedor";
   $tab_ger_campos['val_ret'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['val_ret'] = "val_ret";
   }
   else
   {
       $tab_def_campos['val_ret'] = "";
   }
   $tab_labels["val_ret"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["val_ret"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["val_ret"] : "$ Retención";
   $tab_ger_campos['val_ica'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['val_ica'] = "val_ica";
   }
   else
   {
       $tab_def_campos['val_ica'] = "";
   }
   $tab_labels["val_ica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["val_ica"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["val_ica"] : "$ ReteICA";
   $tab_ger_campos['val_retiva'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['val_retiva'] = "val_retiva";
   }
   else
   {
       $tab_def_campos['val_retiva'] = "";
   }
   $tab_labels["val_retiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["val_retiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["val_retiva"] : "$ ReteIVA";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["total"] : "Total";
   $tab_ger_campos['a_pagar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['a_pagar'] = "a_pagar";
   }
   else
   {
       $tab_def_campos['a_pagar'] = "";
   }
   $tab_labels["a_pagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["a_pagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["a_pagar"] : "Val a Pagar";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['formapago'] = "on";
   $tab_def_campos['formapago'] = "formapago";
   $tab_labels["formapago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["formapago"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['labels']["formapago"] : "Formapago";
   $tab_ger_campos['val_ret'] = "none";
   $tab_ger_campos['val_ica'] = "none";
   $tab_ger_campos['val_retiva'] = "none";
   $tab_ger_campos['a_pagar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_compras_contado_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_compras_contado']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
