...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fechacom_cond" name="fechacom_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechacom'), this, 'fechacom')">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechacom"  <?php echo $str_display_fechacom; ?> class="scFilterFieldFontEven">
