...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_compras_contado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_compras_contado"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['fac_compras'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_compras_contado']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_compras_contado']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_compras_contado']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_compras_contado']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_compras_contado']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_compras_contado</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_compras_contado']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_compras_contado']['embutida_filho'] as $ind => $sc_init)
          {
