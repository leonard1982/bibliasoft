...
function scEventControl_onCalculator_total_cuenta() {
  if (!_scCalculatorControl["id_sc_field_total_cuenta"]) {
    ...
    do_ajax_form_reciboingreso_020822_mob_event_total_cuenta_onblur();
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idrecibo' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_idrecibo_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_reciboingreso_020822_idrecibo_onfocus(this, iSeqRow) });
  $('#id_sc_field_nurecibo' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_nurecibo_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_reciboingreso_020822_nurecibo_onfocus(this, iSeqRow) });
  $('#id_sc_field_nufac' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_nufac_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_reciboingreso_020822_nufac_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_reciboingreso_020822_nufac_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_cliente_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_reciboingreso_020822_cliente_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_reciboingreso_020822_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecharecibo' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_fecharecibo_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_reciboingreso_020822_fecharecibo_onfocus(this, iSeqRow) });
  $('#id_sc_field_monto' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_monto_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_reciboingreso_020822_monto_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_reciboingreso_020822_monto_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldofac' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_saldofac_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_reciboingreso_020822_saldofac_onfocus(this, iSeqRow) });
  $('#id_sc_field_obser' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_obser_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_reciboingreso_020822_obser_onfocus(this, iSeqRow) });
  $('#id_sc_field_concepto' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_concepto_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_reciboingreso_020822_concepto_onfocus(this, iSeqRow) });
  $('#id_sc_field_resolucion' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_resolucion_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_reciboingreso_020822_resolucion_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_reciboingreso_020822_resolucion_onfocus(this, iSeqRow) });
  $('#id_sc_field_rete' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_rete_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_reciboingreso_020822_rete_onchange(this, iSeqRow) })
                                  .bind('click', function() { sc_form_reciboingreso_020822_rete_onclick(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_reciboingreso_020822_rete_onfocus(this, iSeqRow) });
  $('#id_sc_field_descu' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_descu_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_reciboingreso_020822_descu_onchange(this, iSeqRow) })
                                   .bind('click', function() { sc_form_reciboingreso_020822_descu_onclick(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_reciboingreso_020822_descu_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentado' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_asentado_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_reciboingreso_020822_asentado_onchange(this, iSeqRow) })
                                      .bind('click', function() { sc_form_reciboingreso_020822_asentado_onclick(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_reciboingreso_020822_asentado_onfocus(this, iSeqRow) });
  $('#id_sc_field_porc_rete' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_porc_rete_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_reciboingreso_020822_porc_rete_onchange(this, iSeqRow) })
                                       .bind('click', function() { sc_form_reciboingreso_020822_porc_rete_onclick(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_reciboingreso_020822_porc_rete_onfocus(this, iSeqRow) });
  $('#id_sc_field_val_ica' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_val_ica_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_reciboingreso_020822_val_ica_onchange(this, iSeqRow) })
                                     .bind('click', function() { sc_form_reciboingreso_020822_val_ica_onclick(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_reciboingreso_020822_val_ica_onfocus(this, iSeqRow) });
  $('#id_sc_field_por_ica' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_por_ica_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_reciboingreso_020822_por_ica_onchange(this, iSeqRow) })
                                     .bind('click', function() { sc_form_reciboingreso_020822_por_ica_onclick(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_reciboingreso_020822_por_ica_onfocus(this, iSeqRow) });
  $('#id_sc_field_por_retiva' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_por_retiva_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_reciboingreso_020822_por_retiva_onchange(this, iSeqRow) })
                                        .bind('click', function() { sc_form_reciboingreso_020822_por_retiva_onclick(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_reciboingreso_020822_por_retiva_onfocus(this, iSeqRow) });
  $('#id_sc_field_val_retiva' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_val_retiva_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_reciboingreso_020822_val_retiva_onchange(this, iSeqRow) })
                                        .bind('click', function() { sc_form_reciboingreso_020822_val_retiva_onclick(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_reciboingreso_020822_val_retiva_onfocus(this, iSeqRow) });
  $('#id_sc_field_banco_id' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_banco_id_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_reciboingreso_020822_banco_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_concepto' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_id_concepto_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_reciboingreso_020822_id_concepto_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_reciboingreso_020822_id_concepto_onfocus(this, iSeqRow) });
  $('#id_sc_field_ncuenta_tercero' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_ncuenta_tercero_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_reciboingreso_020822_ncuenta_tercero_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_reciboingreso_020822_ncuenta_tercero_onfocus(this, iSeqRow) });
  $('#id_sc_field_doc_cobrado' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_doc_cobrado_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_reciboingreso_020822_doc_cobrado_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_reciboingreso_020822_doc_cobrado_onfocus(this, iSeqRow) });
  $('#id_sc_field_detallepagos' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_detallepagos_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_reciboingreso_020822_detallepagos_onfocus(this, iSeqRow) });
  $('#id_sc_field_relleno' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_relleno_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_reciboingreso_020822_relleno_onfocus(this, iSeqRow) });
  $('#id_sc_field_titulo' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_titulo_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_reciboingreso_020822_titulo_onfocus(this, iSeqRow) });
  $('#id_sc_field_total_cuenta' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_total_cuenta_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_reciboingreso_020822_total_cuenta_onfocus(this, iSeqRow) });
  $('#id_sc_field_valcobrar' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_valcobrar_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_reciboingreso_020822_valcobrar_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_reciboingreso_020822_valcobrar_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_base' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_valor_base_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_reciboingreso_020822_valor_base_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_iva' + iSeqRow).bind('blur', function() { sc_form_reciboingreso_020822_valor_iva_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_reciboingreso_020822_valor_iva_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_reciboingreso_020822_idrecibo_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_idrecibo();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_idrecibo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_nurecibo_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_nurecibo();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_nurecibo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_nufac_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_nufac();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_nufac_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_nufac_onchange();
}

function sc_form_reciboingreso_020822_nufac_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_cliente_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_cliente();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_cliente_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_cliente_onchange();
}

function sc_form_reciboingreso_020822_cliente_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_fecharecibo_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_fecharecibo();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_fecharecibo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_monto_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_monto();
  scCssBlur(oThis);
  do_ajax_form_reciboingreso_020822_mob_event_monto_onblur();
}

function sc_form_reciboingreso_020822_monto_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_monto_onchange();
}

function sc_form_reciboingreso_020822_monto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_saldofac_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_saldofac();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_saldofac_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_obser_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_obser();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_obser_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_concepto_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_concepto();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_concepto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_resolucion_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_resolucion();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_resolucion_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_resolucion_onchange();
}

function sc_form_reciboingreso_020822_resolucion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_rete_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_rete();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_rete_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_rete_onchange();
}

function sc_form_reciboingreso_020822_rete_onclick(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_rete_onclick();
}

function sc_form_reciboingreso_020822_rete_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_descu_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_descu();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_descu_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_descu_onchange();
}

function sc_form_reciboingreso_020822_descu_onclick(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_descu_onclick();
}

function sc_form_reciboingreso_020822_descu_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_asentado_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_asentado();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_asentado_onchange(oThis, iSeqRow) {
  sc_asentado_onchange();
  do_ajax_form_reciboingreso_020822_mob_event_asentado_onchange();
}

function sc_form_reciboingreso_020822_asentado_onclick(oThis, iSeqRow) {
  sc_asentado_onclick();
}

function sc_form_reciboingreso_020822_asentado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_porc_rete_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_porc_rete();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_porc_rete_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_porc_rete_onchange();
}

function sc_form_reciboingreso_020822_porc_rete_onclick(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_porc_rete_onclick();
}

function sc_form_reciboingreso_020822_porc_rete_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_val_ica_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_val_ica();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_val_ica_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_val_ica_onchange();
}

function sc_form_reciboingreso_020822_val_ica_onclick(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_val_ica_onclick();
}

function sc_form_reciboingreso_020822_val_ica_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_por_ica_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_por_ica();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_por_ica_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_por_ica_onchange();
}

function sc_form_reciboingreso_020822_por_ica_onclick(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_por_ica_onclick();
}

function sc_form_reciboingreso_020822_por_ica_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_por_retiva_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_por_retiva();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_por_retiva_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_por_retiva_onchange();
}

function sc_form_reciboingreso_020822_por_retiva_onclick(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_por_retiva_onclick();
}

function sc_form_reciboingreso_020822_por_retiva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_val_retiva_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_val_retiva();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_val_retiva_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_val_retiva_onchange();
}

function sc_form_reciboingreso_020822_val_retiva_onclick(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_val_retiva_onclick();
}

function sc_form_reciboingreso_020822_val_retiva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_banco_id_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_banco_id();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_banco_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_id_concepto_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_id_concepto();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_id_concepto_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_id_concepto_onchange();
}

function sc_form_reciboingreso_020822_id_concepto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_ncuenta_tercero_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_ncuenta_tercero();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_ncuenta_tercero_onchange(oThis, iSeqRow) {
  sc_ncuenta_tercero_onchange();
  do_ajax_form_reciboingreso_020822_mob_event_ncuenta_tercero_onchange();
}

function sc_form_reciboingreso_020822_ncuenta_tercero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_doc_cobrado_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_doc_cobrado();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_doc_cobrado_onchange(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_event_doc_cobrado_onchange();
}

function sc_form_reciboingreso_020822_doc_cobrado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_detallepagos_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_detallepagos();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_detallepagos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_relleno_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_relleno();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_relleno_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_titulo_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_titulo();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_titulo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_total_cuenta_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_total_cuenta();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_total_cuenta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_valcobrar_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_valcobrar();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_valcobrar_onchange(oThis, iSeqRow) {
  sc_valcobrar_onchange();
}

function sc_form_reciboingreso_020822_valcobrar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_valor_base_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_valor_base();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_valor_base_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_reciboingreso_020822_valor_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_reciboingreso_020822_mob_validate_valor_iva();
  scCssBlur(oThis);
}

function sc_form_reciboingreso_020822_valor_iva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_reciboingreso_020822_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecharecibo" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_reciboingreso_020822_mob_validate_fecharecibo(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_reciboingreso_020822_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_reciboingreso_020822_mob_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_reciboingreso_020822_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
