  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_KARDEX_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate kardexid
  function do_ajax_form_KARDEX_mob_validate_kardexid()
  {
    var nomeCampo_kardexid = "kardexid";
    var var_kardexid = scAjaxGetFieldHidden(nomeCampo_kardexid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_KARDEX_mob_validate_kardexid(var_kardexid, var_script_case_init, do_ajax_form_KARDEX_mob_validate_kardexid_cb);
  } // do_ajax_form_KARDEX_mob_validate_kardexid

  function do_ajax_form_KARDEX_mob_validate_kardexid_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_KARDEX_mob_validate_kardexid_cb

  // ---------- Validate codcomp
  function do_ajax_form_KARDEX_mob_validate_codcomp()
  {
    var nomeCampo_codcomp = "codcomp";
    var var_codcomp = scAjaxGetFieldHidden(nomeCampo_codcomp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_KARDEX_mob_validate_codcomp(var_codcomp, var_script_case_init, do_ajax_form_KARDEX_mob_validate_codcomp_cb);
  } // do_ajax_form_KARDEX_mob_validate_codcomp

  function do_ajax_form_KARDEX_mob_validate_codcomp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codcomp";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_KARDEX_mob_validate_codcomp_cb

  // ---------- Validate codprefijo
  function do_ajax_form_KARDEX_mob_validate_codprefijo()
  {
    var nomeCampo_codprefijo = "codprefijo";
    var var_codprefijo = scAjaxGetFieldHidden(nomeCampo_codprefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_KARDEX_mob_validate_codprefijo(var_codprefijo, var_script_case_init, do_ajax_form_KARDEX_mob_validate_codprefijo_cb);
  } // do_ajax_form_KARDEX_mob_validate_codprefijo

  function do_ajax_form_KARDEX_mob_validate_codprefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_KARDEX_mob_validate_codprefijo_cb

  // ---------- Validate numero
  function do_ajax_form_KARDEX_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_KARDEX_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_KARDEX_mob_validate_numero_cb);
  } // do_ajax_form_KARDEX_mob_validate_numero

  function do_ajax_form_KARDEX_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_KARDEX_mob_validate_numero_cb

  // ---------- Validate sn_cufe
  function do_ajax_form_KARDEX_mob_validate_sn_cufe()
  {
    var nomeCampo_sn_cufe = "sn_cufe";
    var var_sn_cufe = scAjaxGetFieldText(nomeCampo_sn_cufe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_KARDEX_mob_validate_sn_cufe(var_sn_cufe, var_script_case_init, do_ajax_form_KARDEX_mob_validate_sn_cufe_cb);
  } // do_ajax_form_KARDEX_mob_validate_sn_cufe

  function do_ajax_form_KARDEX_mob_validate_sn_cufe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sn_cufe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_KARDEX_mob_validate_sn_cufe_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_KARDEX_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_KARDEX_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_KARDEX_mob_submit_form(var_kardexid, var_codcomp, var_codprefijo, var_numero, var_sn_cufe, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_KARDEX_mob_submit_form_cb);
  } // do_ajax_form_KARDEX_mob_submit_form

  function do_ajax_form_KARDEX_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_KARDEX_mob_submit_form_cb_after_alert);
  } // do_ajax_form_KARDEX_mob_submit_form_cb
  function do_ajax_form_KARDEX_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_KARDEX_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_KARDEX_mob_navigate_form()
  {
    perform_ajax_form_KARDEX_mob_navigate_form();
  }

  function perform_ajax_form_KARDEX_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_KARDEX_mob_navigate_form(var_kardexid, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_KARDEX_mob_navigate_form_cb);
  } // do_ajax_form_KARDEX_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_KARDEX_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_KARDEX_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_KARDEX_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_KARDEX_mob_navigate_form_cb
  function do_ajax_form_KARDEX_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_KARDEX_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_KARDEX_mob_navigate_form_cb_after_alert
  function sc_hide_form_KARDEX_mob_form()
  {
