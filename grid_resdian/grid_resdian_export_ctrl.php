<?php
@session_start() ;
$_SESSION['scriptcase']['grid_resdian']['sc_process_barr'] = true;
require_once('../grid_resdian/index.php');
unset($_SESSION['scriptcase']['grid_resdian']['sc_process_barr']);
$ExportCtrl = new grid_resdian_export_control;
$ExportCtrl->Export_barr();

class grid_resdian_export_control
{
