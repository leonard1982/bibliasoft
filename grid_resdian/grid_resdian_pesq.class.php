...
class grid_resdian_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_resdian_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_resdian_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_resdian_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idres')
      {
          $idres = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idres($idres);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_resolucion')
      {
          $resolucion = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_resolucion($resolucion);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_rangofac')
      {
          $rangofac = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_rangofac($rangofac);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_fecha')
      {
          $fecha = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_fecha($fecha);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_idres($idres)
   {
      $idres = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idres);
      $idres = substr($this->Db->qstr($idres), 1, -1);
            $idres_look = substr($this->Db->qstr($idres), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Idres from " . $this->Ini->nm_tabela . " where resolucion>0 and   CAST (Idres AS TEXT)  like '%" . $idres . "%' order by Idres"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Idres from " . $this->Ini->nm_tabela . " where resolucion>0 and   CAST (Idres AS VARCHAR)  like '%" . $idres . "%' order by Idres"; 
      }
      else
      {
          $nm_comando = "select distinct Idres from " . $this->Ini->nm_tabela . " where resolucion>0 and  Idres like '%" . $idres . "%' order by Idres"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_resolucion($resolucion)
   {
      $resolucion = substr($this->Db->qstr($resolucion), 1, -1);
            $resolucion_look = substr($this->Db->qstr($resolucion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct resolucion from " . $this->Ini->nm_tabela . " where resolucion>0 and  resolucion like '%" . $resolucion . "%' order by resolucion"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_rangofac($rangofac)
   {
      $rangofac = substr($this->Db->qstr($rangofac), 1, -1);
            $rangofac_look = substr($this->Db->qstr($rangofac), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct rangofac from " . $this->Ini->nm_tabela . " where resolucion>0 and  rangofac like '%" . $rangofac . "%' order by rangofac"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_fecha($fecha)
   {
      $fecha = substr($this->Db->qstr($fecha), 1, -1);
            $fecha_look = substr($this->Db->qstr($fecha), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct fecha from " . $this->Ini->nm_tabela . " where resolucion>0 and  fecha like '%" . $fecha . "%' order by fecha"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "fec_vencimiento";$Nm_datas[] = "fec_vencimiento";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_resdian/grid_resdian_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_resdian_ajax_search.js"></script>
 <script type="text/javascript" src="grid_resdian_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_resdian_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resdian']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_resdian']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idres_cond#NMF#' + search_get_sel_txt('SC_idres_cond') + '@NMF@';
  str_out += 'SC_idres#NMF#' + search_get_text('SC_idres') + '@NMF@';
  str_out += 'id_ac_idres#NMF#' + search_get_title('select2-id_ac_idres-container') + '@NMF@';
  str_out += 'SC_idres_input_2#NMF#' + search_get_text('SC_idres_input_2') + '@NMF@';
  str_out += 'SC_resolucion_cond#NMF#' + search_get_sel_txt('SC_resolucion_cond') + '@NMF@';
  str_out += 'SC_resolucion#NMF#' + search_get_text('SC_resolucion') + '@NMF@';
  str_out += 'id_ac_resolucion#NMF#' + search_get_title('select2-id_ac_resolucion-container') + '@NMF@';
  str_out += 'SC_rangofac_cond#NMF#' + search_get_sel_txt('SC_rangofac_cond') + '@NMF@';
  str_out += 'SC_rangofac#NMF#' + search_get_text('SC_rangofac') + '@NMF@';
  str_out += 'id_ac_rangofac#NMF#' + search_get_title('select2-id_ac_rangofac-container') + '@NMF@';
  str_out += 'SC_fecha_cond#NMF#' + search_get_sel_txt('SC_fecha_cond') + '@NMF@';
  str_out += 'SC_fecha#NMF#' + search_get_text('SC_fecha') + '@NMF@';
  str_out += 'id_ac_fecha#NMF#' + search_get_title('select2-id_ac_fecha-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-resolucion").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_resolucion",
      max_itens: "10",
   ...
   $("#SC_resolucion").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-rangofac").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_rangofac",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_rangofac").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-fecha").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_fecha",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_fecha").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-idres").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idres",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Lista de Resoluciones</span></td>
...
<?php
   ...
   {
      global 
             $idres_cond, $idres, $idres_input_2, $idres_autocomp,
             $resolucion_cond, $resolucion, $resolucion_autocomp,
             $rangofac_cond, $rangofac, $rangofac_autocomp,
             $fecha_cond, $fecha, $fecha_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['idres']; 
          $idres_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['idres_input_2']; 
          $idres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['idres_cond']; 
          $resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['resolucion']; 
          $resolucion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['resolucion_cond']; 
          $rangofac = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['rangofac']; 
          $rangofac_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['rangofac_cond']; 
          $fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['fecha']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['fecha_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idres_cond) || empty($idres_cond))
      {
         $idres_cond = "gt";
      }
      ...
      if (!isset($rangofac_cond) || empty($rangofac_cond))
      {
         $rangofac_cond = "qp";
      }
      ...
      $str_hide_idres = (in_array($idres_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_resolucion = (in_array($resolucion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_rangofac = (in_array($rangofac_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fecha = (in_array($fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idres = ('bw' == $idres_cond) ? $display_aberto : $display_fechado;
      $str_display_resolucion = ('bw' == $resolucion_cond) ? $display_aberto : $display_fechado;
      $str_display_rangofac = ('bw' == $rangofac_cond) ? $display_aberto : $display_fechado;
      $str_display_fecha = ('bw' == $fecha_cond) ? $display_aberto : $display_fechado;

      if (!isset($idres) || $idres == "")
      {
          $idres = "";
      }
      if (isset($idres) && !empty($idres))
      {
         $tmp_pos = strpos($idres, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idres = substr($idres, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($rangofac) || $rangofac == "")
      {
          $rangofac = "";
      }
      if (isset($rangofac) && !empty($rangofac))
      {
         $tmp_pos = strpos($rangofac, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rangofac = substr($rangofac, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idres_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idres'])) ? $this->New_label['idres'] : "Idres"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idres_cond" name="idres_cond" onChange="nm_campos_between(document.getElementById('id_vis_idres'), this, 'idres')">
       <OPTION value="gt" <?php if ("gt" == $idres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idres_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idres" <?php echo $str_hide_idres?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idres'])) ? $this->New_label['idres'] : "Idres";
 $nmgp_tab_label .= "idres?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Idres from " . $this->Ini->nm_tabela . " where resolucion>0 and Idres = $idres_look order by Idres"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct Idres from " . $this->Ini->nm_tabela . " where resolucion>0 and Idres = $idres_look order by Idres"; 
      ...
      if (isset($nmgp_def_dados[0][$idres]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idres];
      }
      else
      {
            nmgp_Form_Num_Val($idres, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idres;
      }
?>
<INPUT  type="text" id="SC_idres" name="idres" value="<?php echo NM_encode_input($idres) ?>" size=2 alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idres" id="id_ac_idres" name="idres_autocomp"><?php if ('' !=  $idres) { ?><option value="<?php echo $idres ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idres"  <?php echo $str_display_idres; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idres_input_2" name="idres_input_2" value="<?php echo NM_encode_input($idres_input_2) ?>"  size=2 alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_resolucion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['resolucion'])) ? $this->New_label['resolucion'] : "Resolucion"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_resolucion_cond" name="resolucion_cond" onChange="nm_campos_between(document.getElementById('id_vis_resolucion'), this, 'resolucion')">
       <OPTION value="qp" <?php if ("qp" == $resolucion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $resolucion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $resolucion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $resolucion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $resolucion_look = substr($this->Db->qstr($resolucion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct resolucion from " . $this->Ini->nm_tabela . " where resolucion>0 and resolucion = '$resolucion_look' order by resolucion"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$resolucion]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$resolucion];
      }
      else
      {
          $sAutocompValue = $resolucion;
      }
?>
<INPUT  type="text" id="SC_resolucion" name="resolucion" value="<?php echo NM_encode_input($resolucion) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-resolucion" id="id_ac_resolucion" name="resolucion_autocomp"><?php if ('' !=  $resolucion) { ?><option value="<?php echo $resolucion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_rangofac_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rangofac'])) ? $this->New_label['rangofac'] : "Rangofac"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_rangofac_cond" name="rangofac_cond" onChange="nm_campos_between(document.getElementById('id_vis_rangofac'), this, 'rangofac')">
       <OPTION value="qp" <?php if ("qp" == $rangofac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $rangofac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $rangofac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $rangofac_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rangofac" <?php echo $str_hide_rangofac?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rangofac'])) ? $this->New_label['rangofac'] : "Rangofac";
 $nmgp_tab_label .= "rangofac?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $rangofac_look = substr($this->Db->qstr($rangofac), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct rangofac from " . $this->Ini->nm_tabela . " where resolucion>0 and rangofac = '$rangofac_look' order by rangofac"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$rangofac]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$rangofac];
      }
      else
      {
          $sAutocompValue = $rangofac;
      }
?>
<INPUT  type="text" id="SC_rangofac" name="rangofac" value="<?php echo NM_encode_input($rangofac) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-rangofac" id="id_ac_rangofac" name="rangofac_autocomp"><?php if ('' !=  $rangofac) { ?><option value="<?php echo $rangofac ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fecha_cond" name="fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha'), this, 'fecha')">
       ...
       <OPTION value="np" <?php if ("np" == $fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
...
<?php
      ...
      $fecha_look = substr($this->Db->qstr($fecha), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct fecha from " . $this->Ini->nm_tabela . " where resolucion>0 and fecha = '$fecha_look' order by fecha"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$fecha]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$fecha];
      }
      else
      {
          $sAutocompValue = $fecha;
      }
?>
<INPUT  type="text" id="SC_fecha" name="fecha" value="<?php echo NM_encode_input($fecha) ?>"  size=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-fecha" id="id_ac_fecha" name="fecha_autocomp"><?php if ('' !=  $fecha) { ?><option value="<?php echo $fecha ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
<?php
   if (is_file("grid_resdian_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_resdian']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_resdian']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idres_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idres'), document.F1.idres_cond, 'idres');
   document.F1.idres.value = "";
   document.F1.idres_autocomp.value = "";
   $('#select2-id_ac_idres-container').html('<?php echo $this->Val_init_idres['desc'] ?>');;
   document.F1.idres_input_2.value = "";
   document.F1.resolucion_cond.value = 'qp';
   ...
   document.F1.resolucion_autocomp.value = "";
   $('#select2-id_ac_resolucion-container').html('<?php echo $this->Val_init_resolucion['desc'] ?>');;
   document.F1.rangofac_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_rangofac'), document.F1.rangofac_cond, 'rangofac');
   document.F1.rangofac.value = "";
   document.F1.rangofac_autocomp.value = "";
   $('#select2-id_ac_rangofac-container').html('<?php echo $this->Val_init_rangofac['desc'] ?>');;
   document.F1.fecha_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_fecha'), document.F1.fecha_cond, 'fecha');
   document.F1.fecha.value = "";
   document.F1.fecha_autocomp.value = "";
   $('#select2-id_ac_fecha-container').html('<?php echo $this->Val_init_fecha['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_resdian";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idres_cond'] = 'cond';
      $tp_fields['SC_idres'] = 'text_aut';
      $tp_fields['id_ac_idres'] = 'select2_aut';
      $tp_fields['SC_idres_input_2'] = 'text';
      $tp_fields['SC_resolucion_cond'] = 'cond';
      $tp_fields['SC_resolucion'] = 'text_aut';
      $tp_fields['id_ac_resolucion'] = 'select2_aut';
      $tp_fields['SC_rangofac_cond'] = 'cond';
      $tp_fields['SC_rangofac'] = 'text_aut';
      $tp_fields['id_ac_rangofac'] = 'select2_aut';
      $tp_fields['SC_fecha_cond'] = 'cond';
      $tp_fields['SC_fecha'] = 'text_aut';
      $tp_fields['id_ac_fecha'] = 'select2_aut';
   ...
   {
      global $idres_cond, $idres, $idres_input_2, $idres_autocomp,
             $resolucion_cond, $resolucion, $resolucion_autocomp,
             $rangofac_cond, $rangofac, $rangofac_autocomp,
             $fecha_cond, $fecha, $fecha_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($idres_autocomp) && empty($idres))
      {
          $idres = $idres_autocomp;
      }
      if (!empty($resolucion_autocomp) && empty($resolucion))
      {
          $resolucion = $resolucion_autocomp;
      }
      if (!empty($rangofac_autocomp) && empty($rangofac))
      {
          $rangofac = $rangofac_autocomp;
      }
      if (!empty($fecha_autocomp) && empty($fecha))
      {
          $fecha = $fecha_autocomp;
      }
      $idres_cond_salva = $idres_cond; 
      if (!isset($idres_input_2) || $idres_input_2 == "")
      {
          $idres_input_2 = $idres;
      }
      ...
      $rangofac_cond_salva = $rangofac_cond; 
      if (!isset($rangofac_input_2) || $rangofac_input_2 == "")
      {
          $rangofac_input_2 = $rangofac;
      }
      ...
      if ($idres_cond != "in")
      {
          nm_limpa_numero($idres, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idres_cond != "in")
      {
          nm_limpa_numero($idres_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['idres'] = $idres; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['idres_input_2'] = $idres_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['idres_cond'] = $idres_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['resolucion'] = $resolucion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['resolucion_cond'] = $resolucion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['rangofac'] = $rangofac; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['rangofac_cond'] = $rangofac_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['fecha'] = $fecha; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca'] = $Temp_Busca;
      }
      if ($idres_cond != "in" && $idres_cond != "bw" && !empty($idres) && !is_numeric($idres))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idres";
      }
      if ($idres_cond == "bw" && ((!empty($idres) && !is_numeric($idres)) || (!empty($idres_input_2) && !is_numeric($idres_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idres";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $Conteudo = $idres_input_2;
      if (strtoupper($idres_cond) != "II" && strtoupper($idres_cond) != "QP" && strtoupper($idres_cond) != "NP" && strtoupper($idres_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idres_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($resolucion != '') {
      $resolucion_look = substr($this->Db->qstr($resolucion), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['resolucion'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['resolucion'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['resolucion'] = $resolucion;
      }
      $nmgp_def_dados = array();
    if ($rangofac != '') {
      $rangofac_look = substr($this->Db->qstr($rangofac), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['rangofac'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['rangofac'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['rangofac'] = $rangofac;
      }
      $nmgp_def_dados = array();
    if ($fecha != '') {
      $fecha_look = substr($this->Db->qstr($fecha), 1, -1); 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['fecha'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['fecha'] = $fecha;
      }

      //----- $idres
      $this->Date_part = false;
      if (isset($idres) || $idres_cond == "nu" || $idres_cond == "nn" || $idres_cond == "ep" || $idres_cond == "ne")
      {
         $this->monta_condicao("Idres", $idres_cond, $idres, $idres_input_2, "idres");
      }

      //----- $resolucion
      $this->Date_part = false;
      if (isset($resolucion) || $resolucion_cond == "nu" || $resolucion_cond == "nn" || $resolucion_cond == "ep" || $resolucion_cond == "ne")
      {
      ...
      //----- $rangofac
      $this->Date_part = false;
      if (isset($rangofac) || $rangofac_cond == "nu" || $rangofac_cond == "nn" || $rangofac_cond == "ep" || $rangofac_cond == "ne")
      {
         $this->monta_condicao("rangofac", $rangofac_cond, $rangofac, "", "rangofac");
      }

      //----- $fecha
      $this->Date_part = false;
      if (isset($fecha) || $fecha_cond == "nu" || $fecha_cond == "nn" || $fecha_cond == "ep" || $fecha_cond == "ne")
      {
         $this->monta_condicao("fecha", $fecha_cond, $fecha, "", "fecha");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_resdian']['cond_pesq'] .= $this->NM_operador;
