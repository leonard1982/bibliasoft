...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fec_vencimiento";$Nm_datas[] = "fec_vencimiento";$Nm_numeric[] = "idres";$Nm_numeric[] = "primerfactura";$Nm_numeric[] = "ultima_fac";$Nm_numeric[] = "vigencia";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idres_cond" name="idres_cond" onChange="nm_campos_between(document.getElementById('id_vis_idres'), this, 'idres')">
      ...
      <br><span id="id_hide_idres"  <?php echo $str_hide_idres?>><?php
      if ($idres != "")
      {
      $idres_look = substr($this->Db->qstr($idres), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idres" id="id_ac_idres" name="idres_autocomp"><?php if ('' !=  $idres) { ?><option value="<?php echo $idres ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idres"  <?php echo $str_display_idres; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idres_input_2" name="idres_input_2" value="<?php echo NM_encode_input($idres_input_2) ?>"  size=2 alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_resolucion_cond" name="resolucion_cond" onChange="nm_campos_between(document.getElementById('id_vis_resolucion'), this, 'resolucion')">
      ...
      <br><span id="id_hide_resolucion"  <?php echo $str_hide_resolucion?>><?php
      if ($resolucion != "")
      {
      $resolucion_look = substr($this->Db->qstr($resolucion), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rangofac_cond" name="rangofac_cond" onChange="nm_campos_between(document.getElementById('id_vis_rangofac'), this, 'rangofac')">
      ...
      <br><span id="id_hide_rangofac"  <?php echo $str_hide_rangofac?>><?php
      if ($rangofac != "")
      {
      $rangofac_look = substr($this->Db->qstr($rangofac), 1, -1); 
      $nmgp_def_dados = array(); 
