<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_resdian']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_resdian_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_resdian_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["resolucion"] : "Resolucion";
   $tab_ger_campos['rangofac'] = "on";
   $tab_def_campos['rangofac'] = "rangofac";
   $tab_labels["rangofac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["rangofac"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["rangofac"] : "Rangofac";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['fec_vencimiento'] = "on";
   $tab_def_campos['fec_vencimiento'] = "fec_vencimiento";
   $tab_labels["fec_vencimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["fec_vencimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["fec_vencimiento"] : "Fec Venc.";
   $tab_ger_campos['vigencia'] = "on";
   $tab_def_campos['vigencia'] = "vigencia";
   $tab_labels["vigencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["vigencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["vigencia"] : "Vig. (Meses)";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['prefijo'] = "on";
   $tab_def_campos['prefijo'] = "prefijo";
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["prefijo"] : "Prefijo";
   $tab_ger_campos['primerfactura'] = "on";
   $tab_def_campos['primerfactura'] = "primerfactura";
   $tab_labels["primerfactura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["primerfactura"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["primerfactura"] : "Primer factura";
   $tab_ger_campos['ultima_fac'] = "on";
   $tab_def_campos['ultima_fac'] = "ultima_fac";
   $tab_labels["ultima_fac"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["ultima_fac"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["ultima_fac"] : "Última Fac";
   $tab_ger_campos['activa'] = "on";
   $tab_def_campos['activa'] = "activa";
   $tab_labels["activa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["activa"])) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['labels']["activa"] : "Activa";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_resdian']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_resdian']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_resdian_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_resdian']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
