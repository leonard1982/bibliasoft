...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idtercero";$Nm_numeric[] = "saldo";$Nm_numeric[] = "saldoapagar";$Nm_numeric[] = "dv30";$Nm_numeric[] = "dv45";$Nm_numeric[] = "dv60";$Nm_numeric[] = "dv90";$Nm_numeric[] = "dv120";$Nm_numeric[] = "dv180";$Nm_numeric[] = "dv_siempre";$Nm_numeric[] = "idtercero";$Nm_numeric[] = "saldo";$Nm_numeric[] = "saldoapagar";$Nm_numeric[] = "dv30";$Nm_numeric[] = "dv45";$Nm_numeric[] = "dv60";$Nm_numeric[] = "dv90";$Nm_numeric[] = "dv120";$Nm_numeric[] = "dv180";$Nm_numeric[] = "dv_siempre";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_campos_cond" name="campos_cond" onChange="nm_campos_between(document.getElementById('id_vis_campos'), this, 'campos')">
       <OPTION value="eq" <?php if ("eq" == $campos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_campos"  <?php echo $str_hide_campos?>>
<?php
      $nmgp_def_dados = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_clasificacion_cond" name="clasificacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_clasificacion'), this, 'clasificacion')">
       <OPTION value="eq" <?php if ("eq" == $clasificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_clasificacion"  <?php echo $str_hide_clasificacion?>>
<?php
      $nmgp_def_dados = "";
