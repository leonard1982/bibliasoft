...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_terceros_cartera_por_edades"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_terceros_cartera_por_edades"]);
   }
