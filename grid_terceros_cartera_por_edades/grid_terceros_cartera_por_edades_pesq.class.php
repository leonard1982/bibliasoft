...
class grid_terceros_cartera_por_edades_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $NM_cmp_cons    = array();
   var $Tab_ger_campos = array();
   var $NM_cmp_ordem    = array();
   var $Tab_ord_campos  = array();
   var $Tab_ord_convert = array();
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      $this->gera_tab_fields();
      $this->gera_order_fields();
      $this->init();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_terceros_cartera_por_edades_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_terceros_cartera_por_edades_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_terceros_cartera_por_edades_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_documento')
      {
          $documento = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_documento($documento);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_documento($documento)
   {
      $documento = substr($this->Db->qstr($documento), 1, -1);
            $documento_look = substr($this->Db->qstr($documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct documento from (SELECT      idtercero,     documento,     nombres,     (saldo*-1) as saldo,     saldoapagar,     (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 1 and DATEDIFF(now(),fechavenc) <=30 and f.idcli=t.idtercero and f.saldo>0) as dv30, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 31 and DATEDIFF(now(),fechavenc) <=45 and f.idcli=t.idtercero and f.saldo>0) as dv45, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 46 and DATEDIFF(now(),fechavenc) <=60 and f.idcli=t.idtercero and f.saldo>0) as dv60, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 61 and DATEDIFF(now(),fechavenc) <=90 and f.idcli=t.idtercero and f.saldo>0) as dv90, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 91 and DATEDIFF(now(),fechavenc) <=120 and f.idcli=t.idtercero and f.saldo>0) as dv120, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 121 and DATEDIFF(now(),fechavenc) <=180 and f.idcli=t.idtercero and f.saldo>0) as dv180, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 181 and DATEDIFF(now(),fechavenc) <=99999 and f.idcli=t.idtercero and f.saldo>0) as dv_siempre FROM      terceros t WHERE     saldo<0) nm_sel_esp where  documento like '%" . $documento . "%'"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_nombres($nombres)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombres from (SELECT      idtercero,     documento,     nombres,     (saldo*-1) as saldo,     saldoapagar,     (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 1 and DATEDIFF(now(),fechavenc) <=30 and f.idcli=t.idtercero and f.saldo>0) as dv30, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 31 and DATEDIFF(now(),fechavenc) <=45 and f.idcli=t.idtercero and f.saldo>0) as dv45, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 46 and DATEDIFF(now(),fechavenc) <=60 and f.idcli=t.idtercero and f.saldo>0) as dv60, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 61 and DATEDIFF(now(),fechavenc) <=90 and f.idcli=t.idtercero and f.saldo>0) as dv90, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 91 and DATEDIFF(now(),fechavenc) <=120 and f.idcli=t.idtercero and f.saldo>0) as dv120, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 121 and DATEDIFF(now(),fechavenc) <=180 and f.idcli=t.idtercero and f.saldo>0) as dv180, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 181 and DATEDIFF(now(),fechavenc) <=99999 and f.idcli=t.idtercero and f.saldo>0) as dv_siempre FROM      terceros t WHERE     saldo<0) nm_sel_esp where  nombres like '%" . $nombres . "%'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Cartera Por Edades</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_terceros_cartera_por_edades/grid_terceros_cartera_por_edades_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_terceros_cartera_por_edades_ajax_search.js"></script>
 <script type="text/javascript" src="grid_terceros_cartera_por_edades_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript"> 
 ...
 //----------------------
 function nm_restaura_cmp(sOrig, sDest, Campo, Order)
 {
  // Recupera objetos
  ...
  for (i = 0; i < oOrig.length; i++)
  {
   if (Order == 'S')
   {
      Order = Campo.substr(0, 1);
      Campo = Campo.substr(1);
   }
   if (oOrig.options[i].value == Campo)
   {
 ...
 {
  obj_sel = document.F1.elements[v_str_field];
  if (1 < obj_sel.length)
  {
 ...
 {
     obj_sel = document.F1.elements[Odest];
     index   = obj_sel.selectedIndex;
     str_txt = obj_sel.options[index].text.substring(0, 1);
     document.F1.elements[Orad][(str_txt == '-') ? 1 : 0].checked = true;
 }
...
<script type="text/javascript" src="grid_terceros_cartera_por_edades_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_terceros_cartera_por_edades']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_terceros_cartera_por_edades']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_documento_cond#NMF#' + search_get_sel_txt('SC_documento_cond') + '@NMF@';
  str_out += 'SC_documento#NMF#' + search_get_text('SC_documento') + '@NMF@';
  str_out += 'id_ac_documento#NMF#' + search_get_title('select2-id_ac_documento-container') + '@NMF@';
  str_out += 'SC_nombres_cond#NMF#' + search_get_sel_txt('SC_nombres_cond') + '@NMF@';
  str_out += 'SC_nombres#NMF#' + search_get_text('SC_nombres') + '@NMF@';
  str_out += 'id_ac_nombres#NMF#' + search_get_title('select2-id_ac_nombres-container') + '@NMF@';
  str_out += 'SC_campos_cond#NMF#' + search_get_sel_txt('SC_campos_cond') + '@NMF@';
  str_out += 'SC_campos#NMF#' + search_get_Dselelect('SC_campos_dest') + '@NMF@';
  str_out += 'SC_clasificacion_cond#NMF#' + search_get_sel_txt('SC_clasificacion_cond') + '@NMF@';
  str_out += 'SC_clasificacion#NMF#' + search_get_Dselelect('SC_clasificacion_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Cartera Por Edades</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__calendar_52_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   {
      global 
             $documento_cond, $documento, $documento_autocomp,
             $nombres_cond, $nombres, $nombres_autocomp,
             $campos_cond, $campos,
             $clasificacion_cond, $clasificacion,
      ...
      if (isset($bprocessa) && ($bprocessa == "recarga" || $bprocessa == "save_form" || $bprocessa == "filter_delete"))
      {
          ...
          {
              $clasificacion = explode("@?@", $clasificacion);
          }
          else
          {
              $clasificacion = array();
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['documento']; 
          $documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['documento_cond']; 
          $nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['nombres']; 
          $nombres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['nombres_cond']; 
          $campos_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['campos_cond']; 
          $clasificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['clasificacion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_documento = (in_array($documento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombres = (in_array($nombres_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_campos = (in_array($campos_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_clasificacion = (in_array($clasificacion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      // clasificacion
      if (is_array($clasificacion) && !empty($clasificacion))
      {
         $tmp_array = array();
         $clasificacion_val_str = "";
         foreach ($clasificacion as $tmp_val_cmp)
         {
            if ("" != $clasificacion_val_str)
            {
               $clasificacion_val_str .= ",";
            }
            $tmp_pos = strpos($tmp_val_cmp, "##@@");
            ...
            $clasificacion_val_str .= "'$tmp_val_cmp'";
         }
         $clasificacion = $tmp_array;
      }
      else
      {
         $clasificacion_val_str = "''";
      ...
      if (!isset($clasificacion) || $clasificacion == "")
      {
          $clasificacion = array();
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_documento_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['documento'])) ? $this->New_label['documento'] : "Documento"; ?></TD>
      
      <INPUT type="hidden" id="SC_documento_cond" name="documento_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_documento" <?php echo $str_hide_documento?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['documento'])) ? $this->New_label['documento'] : "Documento";
 $nmgp_tab_label .= "documento?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $documento_look = substr($this->Db->qstr($documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct documento from (SELECT      idtercero,     documento,     nombres,     (saldo*-1) as saldo,     saldoapagar,     (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 1 and DATEDIFF(now(),fechavenc) <=30 and f.idcli=t.idtercero and f.saldo>0) as dv30, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 31 and DATEDIFF(now(),fechavenc) <=45 and f.idcli=t.idtercero and f.saldo>0) as dv45, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 46 and DATEDIFF(now(),fechavenc) <=60 and f.idcli=t.idtercero and f.saldo>0) as dv60, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 61 and DATEDIFF(now(),fechavenc) <=90 and f.idcli=t.idtercero and f.saldo>0) as dv90, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 91 and DATEDIFF(now(),fechavenc) <=120 and f.idcli=t.idtercero and f.saldo>0) as dv120, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 121 and DATEDIFF(now(),fechavenc) <=180 and f.idcli=t.idtercero and f.saldo>0) as dv180, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 181 and DATEDIFF(now(),fechavenc) <=99999 and f.idcli=t.idtercero and f.saldo>0) as dv_siempre FROM      terceros t WHERE     saldo<0) nm_sel_esp where documento = '$documento_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$documento]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$documento];
      }
      else
      {
          $sAutocompValue = $documento;
      }
?>
<INPUT  type="text" id="SC_documento" name="documento" value="<?php echo NM_encode_input($documento) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-documento" id="id_ac_documento" name="documento_autocomp"><?php if ('' !=  $documento) { ?><option value="<?php echo $documento ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_nombres_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nombres'])) ? $this->New_label['nombres'] : "Nombres"; ?></TD>
      
      <INPUT type="hidden" id="SC_nombres_cond" name="nombres_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombres" <?php echo $str_hide_nombres?> valign="top">
...
<?php
      ...
      $nombres_look = substr($this->Db->qstr($nombres), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombres from (SELECT      idtercero,     documento,     nombres,     (saldo*-1) as saldo,     saldoapagar,     (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 1 and DATEDIFF(now(),fechavenc) <=30 and f.idcli=t.idtercero and f.saldo>0) as dv30, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 31 and DATEDIFF(now(),fechavenc) <=45 and f.idcli=t.idtercero and f.saldo>0) as dv45, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 46 and DATEDIFF(now(),fechavenc) <=60 and f.idcli=t.idtercero and f.saldo>0) as dv60, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 61 and DATEDIFF(now(),fechavenc) <=90 and f.idcli=t.idtercero and f.saldo>0) as dv90, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 91 and DATEDIFF(now(),fechavenc) <=120 and f.idcli=t.idtercero and f.saldo>0) as dv120, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 121 and DATEDIFF(now(),fechavenc) <=180 and f.idcli=t.idtercero and f.saldo>0) as dv180, (SELECT sum(f.saldo)  FROM facturaven f  WHERE f.credito = 1 and f.pagada <> 'SI' and f.asentada=1  and DATEDIFF(now(),fechavenc) >= 181 and DATEDIFF(now(),fechavenc) <=99999 and f.idcli=t.idtercero and f.saldo>0) as dv_siempre FROM      terceros t WHERE     saldo<0) nm_sel_esp where nombres = '$nombres_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_nombres" name="nombres" value="<?php echo NM_encode_input($nombres) ?>"  size=50 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nombres" id="id_ac_nombres" name="nombres_autocomp"><?php if ('' !=  $nombres) { ?><option value="<?php echo $nombres ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_campos_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['campos'])) ? $this->New_label['campos'] : "Columnas"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_campos_cond" name="campos_cond" onChange="nm_campos_between(document.getElementById('id_vis_campos'), this, 'campos')">
       <OPTION value="eq" <?php if ("eq" == $campos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_campos" <?php echo $str_hide_campos?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['campos'])) ? $this->New_label['campos'] : "Columnas";
 $nmgp_tab_label .= "campos?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $nmgp_def_dados = "";
       foreach ($this->Tab_ger_campos as $T_campo => $T_opcoes)
       {
          if ($T_opcoes[0] != "none")
          {
              $nmgp_def_dados .= (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['labels'][$T_campo])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['labels'][$T_campo] : $T_opcoes[1];
              $nmgp_def_dados .= "?#?" . $T_campo . "?#?N?@?";
          }
       }
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_campos_orig" name="campos_orig" size=7 multiple onDblClick="nm_add_sel('campos_orig', 'campos_dest', 'N' , '')">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $campos_sel = "";
               foreach ($campos as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $campos_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
            ...
            {
               $campos_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod); ?>" <?php echo $campos_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('campos_orig', 'campos_dest', 'N', '');", "nm_add_all('campos_orig', 'campos_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('campos_orig', 'campos_dest', 'N', '');", "nm_add_sel('campos_orig', 'campos_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('campos_dest', 'campos_orig', 'N', '');", "nm_del_sel('campos_dest', 'campos_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('campos_dest', 'campos_orig', 'N', '');", "nm_del_all('campos_dest', 'campos_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_campos_dest" name="campos_dest" size=7 multiple  onDblClick="nm_del_sel('campos_dest', 'campos_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['field_order'] as $NM_cada_field)
      {
         foreach ($nm_opcoes as $nm_opcao)
         {
            if (!empty($nm_opcao))
            {
               ...
               list($nm_opc_val, $nm_opc_cod, $nm_opc_sel) = $temp_bug_list;
               if ($nm_opc_cod == "@ ") {$nm_opc_cod = trim($nm_opc_cod); }
               if (is_array($campos) && !empty($campos) && in_array($nm_opc_cod, $campos) && $nm_opc_cod == $NM_cada_field)
               {
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod); ?>" ><?php echo $nm_opc_val; ?></OPTION>
<?php
                   $NM_cmp_cons[] = $nm_opc_cod;
               }
            }
         }
      }
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_up", "nm_move_up('campos_dest');", "nm_move_up('campos_dest');", "bpassfld_up", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_down", "nm_move_down('campos_dest');", "nm_move_down('campos_dest');", "bpassfld_down", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <input type="hidden" id="SC_campos" name="campos" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.campos_dest.selectedIndex = -1;</script>
<?php
?>
      ...
      <TD id='SC_clasificacion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['clasificacion'])) ? $this->New_label['clasificacion'] : "clasificacion"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_clasificacion_cond" name="clasificacion_cond" onChange="nm_campos_between(document.getElementById('id_vis_clasificacion'), this, 'clasificacion')">
       <OPTION value="eq" <?php if ("eq" == $clasificacion_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_clasificacion" <?php echo $str_hide_clasificacion?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['clasificacion'])) ? $this->New_label['clasificacion'] : "clasificacion";
 $nmgp_tab_label .= "clasificacion?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $nmgp_def_dados = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['psq_check_ret']['clasificacion'] = array();
       foreach ($this->Tab_ord_campos as $T_campo => $T_opcoes)
       {
          if ($T_opcoes[0] != "none")
          {
              $nmgp_def_dados .= (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['labels'][$T_campo])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['labels'][$T_campo] : $T_opcoes[1];
              $nmgp_def_dados .= "?#?" . $T_opcoes[2] . "?#?N?@?";
          }
       }
       if (!isset($clasificacion) || empty($clasificacion))
       {
           $clasificacion = array();
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['ordem_select'] as $T_campo => $T_opcoes)
           {
              if (isset($this->Tab_ord_convert[$T_campo]))
              {
                  $class = "+";
                  if (strtolower($T_opcoes) == "desc")
                  {
                      $class = "-";
                  }
                  $clasificacion[] = $class . $T_campo;
              }
           }
       }
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_clasificacion_orig" name="clasificacion_orig" size=7 multiple onDblClick="nm_add_sel('clasificacion_orig', 'clasificacion_dest', 'N' , 'S')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($clasificacion) && !empty($clasificacion))
            {
               $clasificacion_sel = (in_array( "+" . $nm_opc_cod, $clasificacion) || in_array("-" . $nm_opc_cod, $clasificacion)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
            }
            else
            {
               $clasificacion_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['psq_check_ret']['clasificacion'][] = $nm_opc_cod;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod); ?>" <?php echo $clasificacion_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('clasificacion_orig', 'clasificacion_dest', 'N', 'S');", "nm_add_all('clasificacion_orig', 'clasificacion_dest', 'N', 'S');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('clasificacion_orig', 'clasificacion_dest', 'N', 'S');", "nm_add_sel('clasificacion_orig', 'clasificacion_dest', 'N', 'S');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('clasificacion_dest', 'clasificacion_orig', 'N', 'S');", "nm_del_sel('clasificacion_dest', 'clasificacion_orig', 'N', 'S');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('clasificacion_dest', 'clasificacion_orig', 'N', 'S');", "nm_del_all('clasificacion_dest', 'clasificacion_orig', 'N', 'S');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_clasificacion_dest" name="clasificacion_dest" size=7 multiple onDblClick="nm_del_sel('clasificacion_dest', 'clasificacion_orig', 'N' , 'S')"  onChange="nm_marca_radio('clasificacion_dest', 'clasificacion_ordem')">"
<?php
      if (is_array($clasificacion) && !empty($clasificacion))
      {
         foreach ($clasificacion as $nm_opc_cod)
         {
            $Ordem = substr($nm_opc_cod, 0, 1);
            $Nnome = substr($nm_opc_cod, 1);
            $Nnome = $this->Tab_ord_convert[$Nnome];
            $Nnome = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['labels'][$Onome])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['labels'][$Nnome] : $this->Tab_ord_campos[$Nnome][1];
            $nm_opc_val     = $Ordem . $Nnome;
            $NM_cmp_ordem[] = $nm_opc_cod;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod); ?>" ><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
...
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_up", "nm_move_up('clasificacion_dest');", "nm_move_up('clasificacion_dest');", "bpassfld_up", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_down", "nm_move_down('clasificacion_dest');", "nm_move_down('clasificacion_dest');", "bpassfld_down", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
   </td>
   <td class="scFilterFieldFontEven" align="center">
   <INPUT TYPE="radio" id="SC_clasificacion_ordem" name="clasificacion_ordem" onClick="nm_order_asc('clasificacion_dest'); ">ASC<br />
   <INPUT TYPE="radio" id="SC_clasificacion_ordem" name="clasificacion_ordem" onClick="nm_order_desc('clasificacion_dest'); ">DESC<br />
   </td>
   <td>
    <input type="hidden" id="SC_clasificacion" name="clasificacion" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.clasificacion_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
   if (is_file("grid_terceros_cartera_por_edades_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 NM_arr_campos_cons = new Array();
 NM_arr_campos_cons['0'] = 'documento';
 NM_arr_campos_cons['1'] = 'nombres';
 NM_arr_campos_cons['2'] = 'saldo';
 NM_arr_campos_cons['3'] = 'dv30';
 NM_arr_campos_cons['4'] = 'dv45';
 NM_arr_campos_cons['5'] = 'dv60';
 NM_arr_campos_cons['6'] = 'dv90';
 NM_arr_campos_cons['7'] = 'dv120';
 NM_arr_campos_cons['8'] = 'dv180';
 NM_arr_campos_cons['9'] = 'dv_siempre';
 NM_arr_campos_ordem = new Array();
<?php
  $ind = 0;
  foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['ordem_select_orig'] as $cada_cmp => $cada_order)
  {
      $cada_order = (strtolower(trim($cada_order)) == 'desc') ? '-' : '+';
      echo " NM_arr_campos_ordem[" . $ind . "] = '" .  $cada_order . $cada_cmp . "';\r\n";
      $ind++;
  }
?>
<?php
...
?>
 ...
 {
   nm_pack('campos_dest', 'campos');
   nm_pack('clasificacion_dest', 'clasificacion');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_documento'), document.F1.documento_cond, 'documento');
   document.F1.documento.value = "";
   document.F1.documento_autocomp.value = "";
   $('#select2-id_ac_documento-container').html('<?php echo $this->Val_init_documento['desc'] ?>');;
   document.F1.nombres_cond.value = 'qp';
   ...
   $('#select2-id_ac_nombres-container').html('<?php echo $this->Val_init_nombres['desc'] ?>');;
   nm_campos_between(document.getElementById('id_vis_campos'), document.F1.campos_cond, 'campos');
   nm_del_all('campos_dest', 'campos_orig', 'N', '');
   nm_campos_between(document.getElementById('id_vis_clasificacion'), document.F1.clasificacion_cond, 'clasificacion');
   nm_del_all('clasificacion_dest', 'clasificacion_orig', 'N', 'S');
   for (ic=0; ic < NM_arr_campos_cons.length; ic++)
   {
      nm_restaura_cmp('campos_orig', 'campos_dest', NM_arr_campos_cons[ic], '');
   }
   for (ic=0; ic < NM_arr_campos_ordem.length; ic++)
   {
      nm_restaura_cmp('clasificacion_orig', 'clasificacion_dest', NM_arr_campos_ordem[ic], 'S');
   }
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_terceros_cartera_por_edades";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_terceros_cartera_por_edades/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_documento_cond'] = 'cond';
      $tp_fields['SC_documento'] = 'text_aut';
      $tp_fields['id_ac_documento'] = 'select2_aut';
      $tp_fields['SC_nombres_cond'] = 'cond';
      $tp_fields['SC_nombres'] = 'text_aut';
      $tp_fields['id_ac_nombres'] = 'select2_aut';
      $tp_fields['SC_campos_cond'] = 'cond';
      $tp_fields['SC_campos'] = 'dselect';
      $tp_fields['SC_clasificacion_cond'] = 'cond';
      $tp_fields['SC_clasificacion'] = 'fil_order';
              ...
              if (substr($Cada_cmp[1], 0, 10) == "_NM_array_")
              {
                  if (substr($Cada_cmp[1], 0, 17) == "_NM_array_#NMARR#")
                  {
                      ...
                      foreach ($Sc_temp as $Cada_val)
                      {
                          ...
                          if ($Cada_cmp[0] == "SC_campos")
                          {
                              $val_a = (isset($this->Tab_ger_campos[$Cada_val])) ? sc_convert_encoding($this->Tab_ger_campos[$Cada_val][1], "UTF-8", $_SESSION['scriptcase']['charset']) : $Cada_val;
                          }
   ...
   {
      global $documento_cond, $documento, $documento_autocomp,
             $nombres_cond, $nombres, $nombres_autocomp,
             $campos_cond, $campos,
             $clasificacion_cond, $clasificacion, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($documento_autocomp) && empty($documento))
      {
          $documento = $documento_autocomp;
      }
      ...
      $documento_cond_salva = $documento_cond; 
      if (!isset($documento_input_2) || $documento_input_2 == "")
      {
          $documento_input_2 = $documento;
      }
      ...
      $campos_cond_salva = $campos_cond; 
      if (!isset($campos_input_2) || $campos_input_2 == "")
      {
          $campos_input_2 = $campos;
      }
      $clasificacion_cond_salva = $clasificacion_cond; 
      if (!isset($clasificacion_input_2) || $clasificacion_input_2 == "")
      {
          $clasificacion_input_2 = $clasificacion;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca'];
      }
      if (is_array($clasificacion));
      {
          foreach ($clasificacion as $Ord)
          {
              $Ord = substr($Ord, 1);
              if (!empty($Ord) && !in_array($Ord, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['psq_check_ret']['clasificacion'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "clasificacion : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['documento'] = $documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['documento_cond'] = $documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['nombres'] = $nombres; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['nombres_cond'] = $nombres_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['campos'] = $campos; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['campos_cond'] = $campos_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['clasificacion'] = $clasificacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['clasificacion_cond'] = $clasificacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($documento != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['documento'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['documento'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['documento'] = $documento;
      }
      $nmgp_def_dados = array();
    if ($nombres != '') {
      $nombres_look = substr($this->Db->qstr($nombres), 1, -1); 
      ...
      $this->cmp_formatado['campos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['campos'];
      $this->cmp_formatado['campos_input_2'] = $campos_input_2;
      $this->cmp_formatado['clasificacion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']['clasificacion'];
      $this->cmp_formatado['clasificacion_input_2'] = $clasificacion_input_2;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca'];
      }
      ...
      if (isset($documento) || $documento_cond == "nu" || $documento_cond == "nn" || $documento_cond == "ep" || $documento_cond == "ne")
      {
         $this->monta_condicao("documento", $documento_cond, $documento, "", "documento");
      }
      ...
      //----- $campos
      $this->Date_part = false;
   $Arr_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['field_order'];
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['field_order'] = array();
   foreach ($campos as $Campo_order)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['field_order'][] = $Campo_order;
   }
   foreach ($Arr_order as $Campo_order)
   {
       if (!in_array($Campo_order, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['field_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['field_order'][] = $Campo_order;
       }
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['usr_cmp_sel'] = array();
   foreach ($this->Tab_ger_campos as $Campo_cons => $Opc)
   {
       if (!in_array($Campo_cons, $campos) && $Opc != "none")
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['usr_cmp_sel'][$Campo_cons] = "off";
       }
   }
   ...
   foreach ($clasificacion as $Campo_sort)
   {
       $Ordem = (substr($Campo_sort, 0, 1) == "+") ? "asc" : "desc";
       $Campo = substr($Campo_sort, 1);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['ordem_select'][$Campo] = $Ordem;
   }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['cond_pesq'] .= $this->NM_operador;
   ...
   function gera_tab_fields()
   {
      $this->Tab_ger_campos['documento'][0] = "on";
      $this->Tab_ger_campos['documento'][1] = "Documento";
      $this->Tab_ger_campos['nombres'][0] = "on";
      $this->Tab_ger_campos['nombres'][1] = "Nombres";
      $this->Tab_ger_campos['saldo'][0] = "on";
      $this->Tab_ger_campos['saldo'][1] = "Saldo";
      $this->Tab_ger_campos['dv30'][0] = "on";
      $this->Tab_ger_campos['dv30'][1] = "30 Días";
      $this->Tab_ger_campos['dv45'][0] = "on";
      $this->Tab_ger_campos['dv45'][1] = "45 Días";
      $this->Tab_ger_campos['dv60'][0] = "on";
      $this->Tab_ger_campos['dv60'][1] = "60 Días";
      $this->Tab_ger_campos['dv90'][0] = "on";
      $this->Tab_ger_campos['dv90'][1] = "90 Días";
      $this->Tab_ger_campos['dv120'][0] = "on";
      $this->Tab_ger_campos['dv120'][1] = "120 Días";
      $this->Tab_ger_campos['dv180'][0] = "on";
      $this->Tab_ger_campos['dv180'][1] = "180 Días";
      $this->Tab_ger_campos['dv_siempre'][0] = "on";
      $this->Tab_ger_campos['dv_siempre'][1] = "Más de 180";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_cartera_por_edades']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_cartera_por_edades']['field_display']))
      {
           foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_cartera_por_edades']['field_display'] as $NM_cada_field => $NM_cada_opc)
           {
               if ($NM_cada_opc == "off")
               {
                  $this->Tab_ger_campos[$NM_cada_field][0] = "none";
               }
           }
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['usr_cmp_sel']))
      {
          ...
          {
              $this->Tab_ger_campos[$NM_cada_field][0] = $NM_cada_opc;
          }
      }
   }
   
   function gera_order_fields()
   {
      $this->Tab_ord_campos['documento'][0] = "on";
      $this->Tab_ord_campos['documento'][1] = "Documento";
      $this->Tab_ord_campos['documento'][2] = "documento";
      $this->Tab_ord_convert['documento']   = "documento";
      $this->Tab_ord_campos['nombres'][0] = "on";
      $this->Tab_ord_campos['nombres'][1] = "Nombres";
      $this->Tab_ord_campos['nombres'][2] = "nombres";
      $this->Tab_ord_convert['nombres']   = "nombres";
      $this->Tab_ord_campos['saldo'][0] = "on";
      $this->Tab_ord_campos['saldo'][1] = "Saldo";
      $this->Tab_ord_campos['saldo'][2] = "saldo";
      $this->Tab_ord_convert['saldo']   = "saldo";
      $this->Tab_ord_campos['dv30'][0] = "on";
      $this->Tab_ord_campos['dv30'][1] = "30 Días";
      $this->Tab_ord_campos['dv30'][2] = "dv30";
      $this->Tab_ord_convert['dv30']   = "dv30";
      $this->Tab_ord_campos['dv45'][0] = "on";
      $this->Tab_ord_campos['dv45'][1] = "45 Días";
      $this->Tab_ord_campos['dv45'][2] = "dv45";
      $this->Tab_ord_convert['dv45']   = "dv45";
      $this->Tab_ord_campos['dv60'][0] = "on";
      $this->Tab_ord_campos['dv60'][1] = "60 Días";
      $this->Tab_ord_campos['dv60'][2] = "dv60";
      $this->Tab_ord_convert['dv60']   = "dv60";
      $this->Tab_ord_campos['dv90'][0] = "on";
      $this->Tab_ord_campos['dv90'][1] = "90 Días";
      $this->Tab_ord_campos['dv90'][2] = "dv90";
      $this->Tab_ord_convert['dv90']   = "dv90";
      $this->Tab_ord_campos['dv120'][0] = "on";
      $this->Tab_ord_campos['dv120'][1] = "120 Días";
      $this->Tab_ord_campos['dv120'][2] = "dv120";
      $this->Tab_ord_convert['dv120']   = "dv120";
      $this->Tab_ord_campos['dv180'][0] = "on";
      $this->Tab_ord_campos['dv180'][1] = "180 Días";
      $this->Tab_ord_campos['dv180'][2] = "dv180";
      $this->Tab_ord_convert['dv180']   = "dv180";
      $this->Tab_ord_campos['dv_siempre'][0] = "on";
      $this->Tab_ord_campos['dv_siempre'][1] = "Más de 180";
      $this->Tab_ord_campos['dv_siempre'][2] = "dv_siempre";
      $this->Tab_ord_convert['dv_siempre']   = "dv_siempre";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_cartera_por_edades']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_cartera_por_edades']['field_display']))
      {
           foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_terceros_cartera_por_edades']['field_display'] as $NM_cada_field => $NM_cada_opc)
           {
               if ($NM_cada_opc == "off")
               {
                  $this->Tab_ord_campos[$NM_cada_field][0] = "none";
               }
           }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cartera_por_edades']['php_cmp_sel']))
