...
$old_error_handler = set_error_handler("form_tbl_sys_message_noti_scriptcase_error_handler");

function form_tbl_sys_message_noti_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tbl_sys_message_noti']['contr_erro']) && $_SESSION['scriptcase']['form_tbl_sys_message_noti']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_form_tbl_sys_message_noti;
            $inicial_form_tbl_sys_message_noti->contr_form_tbl_sys_message_noti->Apl_com_erro = true;
            if ($inicial_form_tbl_sys_message_noti->contr_form_tbl_sys_message_noti->NM_ajax_flag)
            {
                $inicial_form_tbl_sys_message_noti->contr_form_tbl_sys_message_noti->NM_ajax_info['errList']['geral_form_tbl_sys_message_noti'][] = $msg;
                return;
            }
            form_tbl_sys_message_noti_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tbl_sys_message_noti_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tbl_sys_message_noti'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tbl_sys_message_noti'])  ? $_SESSION['scriptcase']['error_icon']['form_tbl_sys_message_noti']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_tbl_sys_message_noti']) && '' != $_SESSION['scriptcase']['error_close']['form_tbl_sys_message_noti']) ? $_SESSION['scriptcase']['error_close']['form_tbl_sys_message_noti'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tbl_sys_message_noti']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tbl_sys_message_noti']) ? $_SESSION['scriptcase']['error_span_title']['form_tbl_sys_message_noti'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tbl_sys_message_noti']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tbl_sys_message_noti']) ? $_SESSION['scriptcase']['error_icon_title']['form_tbl_sys_message_noti'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tbl_sys_message_noti']['error_buffer'] .= ob_get_flush();
}
