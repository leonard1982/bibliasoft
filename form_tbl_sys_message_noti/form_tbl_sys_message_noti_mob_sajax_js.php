  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tbl_sys_message_noti_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tbl_sys_message_noti_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_tbl_sys_message_noti_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_sys_message_noti_mob_validate_id(var_id, var_script_case_init, do_ajax_form_tbl_sys_message_noti_mob_validate_id_cb);
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_id

  function do_ajax_form_tbl_sys_message_noti_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_id_cb

  // ---------- Validate cod_group
  function do_ajax_form_tbl_sys_message_noti_mob_validate_cod_group()
  {
    var nomeCampo_cod_group = "cod_group";
    var var_cod_group = scAjaxGetFieldText(nomeCampo_cod_group);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_sys_message_noti_mob_validate_cod_group(var_cod_group, var_script_case_init, do_ajax_form_tbl_sys_message_noti_mob_validate_cod_group_cb);
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_cod_group

  function do_ajax_form_tbl_sys_message_noti_mob_validate_cod_group_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_group";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_cod_group_cb

  // ---------- Validate text_message
  function do_ajax_form_tbl_sys_message_noti_mob_validate_text_message()
  {
    var nomeCampo_text_message = "text_message";
    var var_text_message = scAjaxGetFieldText(nomeCampo_text_message);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_sys_message_noti_mob_validate_text_message(var_text_message, var_script_case_init, do_ajax_form_tbl_sys_message_noti_mob_validate_text_message_cb);
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_text_message

  function do_ajax_form_tbl_sys_message_noti_mob_validate_text_message_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "text_message";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_text_message_cb

  // ---------- Validate start_date
  function do_ajax_form_tbl_sys_message_noti_mob_validate_start_date()
  {
    var nomeCampo_start_date = "start_date";
    var var_start_date = scAjaxGetFieldText(nomeCampo_start_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_sys_message_noti_mob_validate_start_date(var_start_date, var_script_case_init, do_ajax_form_tbl_sys_message_noti_mob_validate_start_date_cb);
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_start_date

  function do_ajax_form_tbl_sys_message_noti_mob_validate_start_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_start_date_cb

  // ---------- Validate end_date
  function do_ajax_form_tbl_sys_message_noti_mob_validate_end_date()
  {
    var nomeCampo_end_date = "end_date";
    var var_end_date = scAjaxGetFieldText(nomeCampo_end_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tbl_sys_message_noti_mob_validate_end_date(var_end_date, var_script_case_init, do_ajax_form_tbl_sys_message_noti_mob_validate_end_date_cb);
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_end_date

  function do_ajax_form_tbl_sys_message_noti_mob_validate_end_date_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tbl_sys_message_noti_mob_validate_end_date_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_tbl_sys_message_noti_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tbl_sys_message_noti_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_cod_group = scAjaxGetFieldText("cod_group");
    var var_text_message = scAjaxGetFieldText("text_message");
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_sys_message_noti_mob_submit_form(var_id, var_cod_group, var_text_message, var_start_date, var_end_date, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tbl_sys_message_noti_mob_submit_form_cb);
  } // do_ajax_form_tbl_sys_message_noti_mob_submit_form

  function do_ajax_form_tbl_sys_message_noti_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("cod_group");
      scAjaxHideErrorDisplay("text_message");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tbl_sys_message_noti_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tbl_sys_message_noti_mob_submit_form_cb
  function do_ajax_form_tbl_sys_message_noti_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tbl_sys_message_noti_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tbl_sys_message_noti_mob_navigate_form()
  {
    perform_ajax_form_tbl_sys_message_noti_mob_navigate_form();
  }

  function perform_ajax_form_tbl_sys_message_noti_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tbl_sys_message_noti_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tbl_sys_message_noti_mob_navigate_form_cb);
  } // do_ajax_form_tbl_sys_message_noti_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tbl_sys_message_noti_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tbl_sys_message_noti_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tbl_sys_message_noti_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tbl_sys_message_noti_mob_navigate_form_cb
  function do_ajax_form_tbl_sys_message_noti_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_tbl_sys_message_noti_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tbl_sys_message_noti_mob_navigate_form_cb_after_alert
  function sc_hide_form_tbl_sys_message_noti_mob_form()
  {
  ...
  ajax_field_list[1] = "cod_group";
  ajax_field_list[2] = "text_message";
  ajax_field_list[3] = "start_date";
  ajax_field_list[4] = "end_date";
  ...
  var ajax_error_list = {
    ...
    "cod_group": {"label": "Cod Group", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "text_message": {"label": "Text Message", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "start_date": {"label": "Start Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "end_date": {"label": "End Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id": new Array(),
    "cod_group": new Array(),
    "text_message": new Array(),
    "start_date": new Array(),
    "end_date": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["cod_group"][1] = "cod_group";
  ajax_field_mult["text_message"][1] = "text_message";
  ...
  var ajax_field_id = {
    ...
    "cod_group": new Array("hidden_field_label_cod_group", "hidden_field_data_cod_group"),
    "text_message": new Array("hidden_field_label_text_message", "hidden_field_data_text_message"),
