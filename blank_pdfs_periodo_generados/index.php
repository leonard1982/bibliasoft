...
if(!empty($vzona) and !empty($vanio) and !empty($vperiodo))
{
	...
	while ($archivo = readdir($directorio)) 
	{
		...
		else
		{
		 ...
		 echo "<div>";
		 echo "Descarga aquí el archivo en PDF <a href='".$vruta2."/".$archivo."'>".$archivo."</a>";
		 echo "</div><br>";
