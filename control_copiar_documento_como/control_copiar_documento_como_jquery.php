...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_control_copiar_documento_como_tipo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_control_copiar_documento_como_tipo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_prefijo' + iSeqRow).bind('blur', function() { sc_control_copiar_documento_como_prefijo_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_control_copiar_documento_como_prefijo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_control_copiar_documento_como_fecha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_control_copiar_documento_como_fecha_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cliente' + iSeqRow).bind('blur', function() { sc_control_copiar_documento_como_cliente_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_control_copiar_documento_como_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_asesor' + iSeqRow).bind('blur', function() { sc_control_copiar_documento_como_asesor_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_control_copiar_documento_como_asesor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_idpedido' + iSeqRow).bind('blur', function() { sc_control_copiar_documento_como_idpedido_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_control_copiar_documento_como_idpedido_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_idcliente_anterior' + iSeqRow).bind('blur', function() { sc_control_copiar_documento_como_idcliente_anterior_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_control_copiar_documento_como_idcliente_anterior_onchange(this, iSeqRow) })
...
function sc_control_copiar_documento_como_documento_onblur(oThis, iSeqRow) {
  do_ajax_control_copiar_documento_como_validate_documento();
  scCssBlur(oThis);
}

function sc_control_copiar_documento_como_documento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_control_copiar_documento_como_event_documento_onchange();
}
...
function sc_control_copiar_documento_como_tipo_onblur(oThis, iSeqRow) {
  do_ajax_control_copiar_documento_como_validate_tipo();
  scCssBlur(oThis);
}

function sc_control_copiar_documento_como_tipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_copiar_documento_como_prefijo_onblur(oThis, iSeqRow) {
  do_ajax_control_copiar_documento_como_validate_prefijo();
  scCssBlur(oThis);
}

function sc_control_copiar_documento_como_prefijo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_copiar_documento_como_fecha_onblur(oThis, iSeqRow) {
  do_ajax_control_copiar_documento_como_validate_fecha();
  scCssBlur(oThis);
}

function sc_control_copiar_documento_como_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_copiar_documento_como_cliente_onblur(oThis, iSeqRow) {
  do_ajax_control_copiar_documento_como_validate_cliente();
  scCssBlur(oThis);
}

function sc_control_copiar_documento_como_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_copiar_documento_como_asesor_onblur(oThis, iSeqRow) {
  do_ajax_control_copiar_documento_como_validate_asesor();
  scCssBlur(oThis);
}

function sc_control_copiar_documento_como_asesor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_copiar_documento_como_idpedido_onblur(oThis, iSeqRow) {
  do_ajax_control_copiar_documento_como_validate_idpedido();
  scCssBlur(oThis);
}

function sc_control_copiar_documento_como_idpedido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_control_copiar_documento_como_idcliente_anterior_onblur(oThis, iSeqRow) {
  do_ajax_control_copiar_documento_como_validate_idcliente_anterior();
  scCssBlur(oThis);
}

function sc_control_copiar_documento_como_idcliente_anterior_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_control_copiar_documento_como_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      setTimeout(function() { do_ajax_control_copiar_documento_como_validate_fecha(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_copiar_documento_como')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
