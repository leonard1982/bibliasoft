  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_copiar_documento_como" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_copiar_documento_como_form();
	}
  ...
  // ---------- Validate documento
  function do_ajax_control_copiar_documento_como_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldText(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_documento_como_validate_documento(var_documento, var_script_case_init, do_ajax_control_copiar_documento_como_validate_documento_cb);
  } // do_ajax_control_copiar_documento_como_validate_documento

  function do_ajax_control_copiar_documento_como_validate_documento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_documento_como_validate_documento_cb

  // ---------- Validate tipo
  function do_ajax_control_copiar_documento_como_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_documento_como_validate_tipo(var_tipo, var_script_case_init, do_ajax_control_copiar_documento_como_validate_tipo_cb);
  } // do_ajax_control_copiar_documento_como_validate_tipo

  function do_ajax_control_copiar_documento_como_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_documento_como_validate_tipo_cb

  // ---------- Validate prefijo
  function do_ajax_control_copiar_documento_como_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_documento_como_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_control_copiar_documento_como_validate_prefijo_cb);
  } // do_ajax_control_copiar_documento_como_validate_prefijo

  function do_ajax_control_copiar_documento_como_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_documento_como_validate_prefijo_cb

  // ---------- Validate fecha
  function do_ajax_control_copiar_documento_como_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_control_copiar_documento_como_validate_fecha(var_fecha, var_script_case_init, do_ajax_control_copiar_documento_como_validate_fecha_cb);
    }, 200);
  } // do_ajax_control_copiar_documento_como_validate_fecha

  function do_ajax_control_copiar_documento_como_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_documento_como_validate_fecha_cb

  // ---------- Validate cliente
  function do_ajax_control_copiar_documento_como_validate_cliente()
  {
  } // do_ajax_control_copiar_documento_como_validate_cliente

  function do_ajax_control_copiar_documento_como_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_documento_como_validate_cliente_cb

  // ---------- Validate asesor
  function do_ajax_control_copiar_documento_como_validate_asesor()
  {
    var nomeCampo_asesor = "asesor";
    var var_asesor = scAjaxGetFieldSelect(nomeCampo_asesor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_documento_como_validate_asesor(var_asesor, var_script_case_init, do_ajax_control_copiar_documento_como_validate_asesor_cb);
  } // do_ajax_control_copiar_documento_como_validate_asesor

  function do_ajax_control_copiar_documento_como_validate_asesor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asesor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_documento_como_validate_asesor_cb

  // ---------- Validate idpedido
  function do_ajax_control_copiar_documento_como_validate_idpedido()
  {
    var nomeCampo_idpedido = "idpedido";
    var var_idpedido = scAjaxGetFieldText(nomeCampo_idpedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_documento_como_validate_idpedido(var_idpedido, var_script_case_init, do_ajax_control_copiar_documento_como_validate_idpedido_cb);
  } // do_ajax_control_copiar_documento_como_validate_idpedido

  function do_ajax_control_copiar_documento_como_validate_idpedido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_documento_como_validate_idpedido_cb

  // ---------- Validate idcliente_anterior
  function do_ajax_control_copiar_documento_como_validate_idcliente_anterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_documento_como_validate_idcliente_anterior(var_idcliente_anterior, var_script_case_init, do_ajax_control_copiar_documento_como_validate_idcliente_anterior_cb);
  } // do_ajax_control_copiar_documento_como_validate_idcliente_anterior

  function do_ajax_control_copiar_documento_como_validate_idcliente_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_documento_como_validate_idcliente_anterior_cb

  // ---------- Event onchange documento
  function do_ajax_control_copiar_documento_como_event_documento_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_control_copiar_documento_como_event_documento_onchange(var_documento, var_idpedido, var_cliente, var_fecha, var_asesor, var_script_case_init, do_ajax_control_copiar_documento_como_event_documento_onchange_cb);
  } // do_ajax_control_copiar_documento_como_event_documento_onchange

  function do_ajax_control_copiar_documento_como_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_control_copiar_documento_como_event_documento_onchange_cb_after_alert);
  } // do_ajax_control_copiar_documento_como_event_documento_onchange_cb
  function do_ajax_control_copiar_documento_como_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_copiar_documento_como_event_documento_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_copiar_documento_como_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_copiar_documento_como_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_documento = scAjaxGetFieldText("documento");
    ...
    scAjaxProcOn();
    x_ajax_control_copiar_documento_como_submit_form(var_documento, var_tipo, var_prefijo, var_fecha, var_cliente, var_asesor, var_idpedido, var_idcliente_anterior, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_copiar_documento_como_submit_form_cb);
  } // do_ajax_control_copiar_documento_como_submit_form

  function do_ajax_control_copiar_documento_como_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_copiar_documento_como_submit_form_cb_after_alert);
  } // do_ajax_control_copiar_documento_como_submit_form_cb
  function do_ajax_control_copiar_documento_como_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_copiar_documento_como_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_copiar_documento_como_navigate_form()
  {
    perform_ajax_control_copiar_documento_como_navigate_form();
  }

  function perform_ajax_control_copiar_documento_como_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_documento_como']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_copiar_documento_como_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_copiar_documento_como_navigate_form_cb_after_alert);
  } // do_ajax_control_copiar_documento_como_navigate_form_cb
  function do_ajax_control_copiar_documento_como_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_copiar_documento_como_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_copiar_documento_como_navigate_form_cb_after_alert
  function sc_hide_control_copiar_documento_como_form()
  {
