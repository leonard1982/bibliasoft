  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_puc_auxiliares" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_puc_auxiliares_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_form_puc_auxiliares_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_puc_auxiliares_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_puc_auxiliares_validate_id__cb);
  } // do_ajax_form_puc_auxiliares_validate_id_

  function do_ajax_form_puc_auxiliares_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_puc_auxiliares_validate_id__cb

  // ---------- Validate id_puc_
  function do_ajax_form_puc_auxiliares_validate_id_puc_(iNumLinha)
  {
    var nomeCampo_id_puc_ = "id_puc_" + iNumLinha;
    var var_id_puc_ = scAjaxGetFieldSelect(nomeCampo_id_puc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_puc_auxiliares_validate_id_puc_(var_id_puc_, iNumLinha, var_script_case_init, do_ajax_form_puc_auxiliares_validate_id_puc__cb);
  } // do_ajax_form_puc_auxiliares_validate_id_puc_

  function do_ajax_form_puc_auxiliares_validate_id_puc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_puc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_puc_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_puc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_puc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_puc_auxiliares_validate_id_puc__cb

  // ---------- Validate codigo_
  function do_ajax_form_puc_auxiliares_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_puc_auxiliares_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_puc_auxiliares_validate_codigo__cb);
  } // do_ajax_form_puc_auxiliares_validate_codigo_

  function do_ajax_form_puc_auxiliares_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_puc_auxiliares_validate_codigo__cb

  // ---------- Validate nombre_
  function do_ajax_form_puc_auxiliares_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_puc_auxiliares_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_puc_auxiliares_validate_nombre__cb);
  } // do_ajax_form_puc_auxiliares_validate_nombre_

  function do_ajax_form_puc_auxiliares_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_puc_auxiliares_validate_nombre__cb

  // ---------- Event onchange id_puc_
  function do_ajax_form_puc_auxiliares_event_id_puc__onchange(iSeqForm)
  {
    var var_id_puc_ = scAjaxGetFieldSelect("id_puc_" + iSeqForm);
    var var_codigo_ = scAjaxGetFieldText("codigo_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_puc_auxiliares_event_id_puc__onchange(var_id_puc_, var_codigo_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_puc_auxiliares_event_id_puc__onchange_cb);
  } // do_ajax_form_puc_auxiliares_event_id_puc__onchange

  function do_ajax_form_puc_auxiliares_event_id_puc__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_puc_auxiliares_event_id_puc__onchange_cb_after_alert);
  } // do_ajax_form_puc_auxiliares_event_id_puc__onchange_cb
  function do_ajax_form_puc_auxiliares_event_id_puc__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_puc_auxiliares_event_id_puc__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_puc_auxiliares_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_puc_auxiliares_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_puc_auxiliares_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_puc_auxiliares_add_new_line_cb);
  } // do_ajax_form_puc_auxiliares_add_new_line

  function do_ajax_form_puc_auxiliares_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_puc_auxiliares_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_puc_auxiliares_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_puc_auxiliares_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_puc_auxiliares_backup_line_cb);
  } // do_ajax_form_puc_auxiliares_backup_line

  function do_ajax_form_puc_auxiliares_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_puc_auxiliares_backup_line_cb

  function do_ajax_form_puc_auxiliares_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_puc_auxiliares_cancel_insert

  function do_ajax_form_puc_auxiliares_cancel_update(iSeqVert)
  {
    do_ajax_form_puc_auxiliares_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_puc_auxiliares_cancel_update

  function do_ajax_form_puc_auxiliares_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_puc_auxiliares_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_puc_auxiliares_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_puc_auxiliares_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_puc_auxiliares_table_refresh_cb);
  } //  do_ajax_form_puc_auxiliares_table_refresh

  function do_ajax_form_puc_auxiliares_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_puc_auxiliares_table_refresh_cb_after_alert);
  } // do_ajax_form_puc_auxiliares_table_refresh_cb
  function do_ajax_form_puc_auxiliares_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_puc_auxiliares_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_puc_auxiliares_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_puc_auxiliares_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_id_puc_ = scAjaxGetFieldSelect("id_puc_" + iNumLinha);
...
?>
    x_ajax_form_puc_auxiliares_submit_form(var_id_, var_id_puc_, var_codigo_, var_nombre_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_puc_auxiliares_submit_form_cb);
  } // do_ajax_form_puc_auxiliares_submit_form

  function do_ajax_form_puc_auxiliares_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("id_puc_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_puc_auxiliares_submit_form_cb_after_alert);
  } // do_ajax_form_puc_auxiliares_submit_form_cb
  function do_ajax_form_puc_auxiliares_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_puc_auxiliares_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_puc_auxiliares_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_puc_auxiliares_navigate_form, function() {});
    } else {
      perform_ajax_form_puc_auxiliares_navigate_form();
    }
  }

  function perform_ajax_form_puc_auxiliares_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_puc_auxiliares_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("id_puc_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_puc_auxiliares_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_puc_auxiliares_navigate_form_cb);
  } // do_ajax_form_puc_auxiliares_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_puc_auxiliares']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_puc_auxiliares_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_puc_auxiliares_navigate_form_cb_after_alert);
  } // do_ajax_form_puc_auxiliares_navigate_form_cb
  function do_ajax_form_puc_auxiliares_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('id_puc_1');
...
?>
  ...
  } // do_ajax_form_puc_auxiliares_navigate_form_cb_after_alert
  function sc_hide_form_puc_auxiliares_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_puc_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["id_puc_" + iNumLinha] = {"label": "Cuenta Ppal.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_" + iNumLinha] = {"label": "Código Aux.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_puc_"][iNumLinha] = "id_puc_" + iNumLinha;
    ajax_field_mult["codigo_"][iNumLinha] = "codigo_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_id["id_puc_" + iNumLinha] = new Array("hidden_field_label_id_puc_", "hidden_field_data_id_puc_" + iNumLinha);
    ...
    ajax_error_count["id_puc_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["id_puc_" + iNumLinha] = "off";
...
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["id_puc_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["id_puc_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["id_puc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_puc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_puc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_puc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_puc_" + iNumLinha]["onfocus"] = new Array();
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_id_puc_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_puc_'])) ? $this->nmgp_cmp_readonly['id_puc_'] : 'off';
?>
    scAjaxFieldRead("id_puc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("id_puc_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["id_puc_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["nombre_" + iRow]))
    {
      ...
      $("#hidden_field_data_id_puc_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["id_puc_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["nombre_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["id_puc_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_puc_" + iRow).removeClass("scFormErrorLine");
