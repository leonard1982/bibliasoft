...
class grid_facturaven_pos_detalle_07122020_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_facturaven_pos_detalle_07122020.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_facturaven_pos_detalle_07122020']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle_07122020']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle_07122020']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle_07122020']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle_07122020']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle_07122020']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle_07122020']['rtf_name']);
      }
   ...
   function NM_export_idpro2()
   {
         ...
         $this->look_idpro2 = NM_charset_to_utf8($this->look_idpro2);
         $this->look_idpro2 = str_replace('<', '&lt;', $this->look_idpro2);
         $this->look_idpro2 = str_replace('>', '&gt;', $this->look_idpro2);
         $this->Texto_tag .= "<td>" . $this->look_idpro2 . "</td>\r\n";
   }
   //----- codigoprod
   ...
   {
         $this->look_und = html_entity_decode($this->look_und, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_und = strip_tags($this->look_und);
         $this->look_und = NM_charset_to_utf8($this->look_und);
         $this->look_und = str_replace('<', '&lt;', $this->look_und);
         $this->look_und = str_replace('>', '&gt;', $this->look_und);
         $this->Texto_tag .= "<td>" . $this->look_und . "</td>\r\n";
   }
   //----- valorunit
   ...
   function NM_export_tbase()
   {
         ...
         $this->tbase = NM_charset_to_utf8($this->tbase);
         $this->tbase = str_replace('<', '&lt;', $this->tbase);
         $this->tbase = str_replace('>', '&gt;', $this->tbase);
         $this->Texto_tag .= "<td>" . $this->tbase . "</td>\r\n";
   }
   //----- iva
   ...
   function NM_export_tneto()
   {
         ...
         $this->tneto = NM_charset_to_utf8($this->tneto);
         $this->tneto = str_replace('<', '&lt;', $this->tneto);
         $this->tneto = str_replace('>', '&gt;', $this->tneto);
         $this->Texto_tag .= "<td>" . $this->tneto . "</td>\r\n";
   }
   //----- adicional1
   function NM_export_adicional1()
   {
             nmgp_Form_Num_Val($this->adicional1, ",", ",", "0", "S", "2", "%", "V:3:3", "-"); 
         $this->adicional1 = NM_charset_to_utf8($this->adicional1);
         $this->adicional1 = str_replace('<', '&lt;', $this->adicional1);
         $this->adicional1 = str_replace('>', '&gt;', $this->adicional1);
         $this->Texto_tag .= "<td>" . $this->adicional1 . "</td>\r\n";
   }
   //----- descuento
   ...
   function NM_export_idbod()
   {
         ...
         $this->idbod = NM_charset_to_utf8($this->idbod);
         $this->idbod = str_replace('<', '&lt;', $this->idbod);
         $this->idbod = str_replace('>', '&gt;', $this->idbod);
         $this->Texto_tag .= "<td>" . $this->idbod . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle_07122020']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_detalle_07122020']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
