...
class grid_compras_dev_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_compras_dev.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_compras_dev']['contr_erro'] = 'off'; 
   ...
   function NM_export_num_ndevolucion()
   {
         ...
         $this->num_ndevolucion = NM_charset_to_utf8($this->num_ndevolucion);
         $this->num_ndevolucion = str_replace('<', '&lt;', $this->num_ndevolucion);
         $this->num_ndevolucion = str_replace('>', '&gt;', $this->num_ndevolucion);
         $this->Texto_tag .= "<td>" . $this->num_ndevolucion . "</td>\r\n";
   }
   //----- numfacom
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Lista Devoluciones en compras :: RTF</TITLE>
