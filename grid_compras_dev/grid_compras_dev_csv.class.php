...
class grid_compras_dev_csv
{
   ...
   function inicializa_vars()
   {
     global $nm_lang;
      ...
      $this->Tot      = new grid_compras_dev_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['SC_Ind_Groupby'];
      if (method_exists($this->Tot,$Gb_geral))
      {
          $this->Tot->$Gb_geral();
          $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][1];
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['SC_Ind_Groupby'] == "proveedor")
          {
              $this->sum_val_ret = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][2];
              $this->sum_val_ica = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][3];
              $this->sum_val_retiva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][4];
              $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][5];
              $this->sum_valoriva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][6];
              $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][7];
              $this->sum_a_pagar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][8];
          }
      ...
      $this->Arquivo  .= ".csv";
      $this->Tit_doc   = "grid_compras_dev.csv";
      ...
      if (!$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_return']);
          if ($this->Tem_csv_res) {
   ...
   function grava_arquivo()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name'] .= ".csv";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_name']);
      }
      ...
      { 
          ...
          { 
              ...
              if ($Cada_col == "num_ndevolucion" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
              {
...
$_SESSION['scriptcase']['grid_compras_dev']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          $this->Res = new grid_compras_dev_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_res_file']);
          }
          unlink($Arq_input);
   ...
   function NM_export_num_ndevolucion()
   {
      ...
      $col_sep = ($this->NM_prim_col > 0) ? $this->Delim_col : "";
      $conteudo = str_replace($this->Delim_dados, $this->Delim_dados . $this->Delim_dados, $this->num_ndevolucion);
      $this->csv_registro .= $col_sep . $this->Delim_dados . $conteudo . $this->Delim_dados;
      $this->NM_prim_col++;
   }
   //----- numfacom
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>Lista Devoluciones en compras :: CSV</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['csv_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
