...
<?php
   ...
   $Ord_Cmp = new grid_compras_dev_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_compras_dev_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['num_ndevolucion'] = "on";
   $tab_def_campos['num_ndevolucion'] = "num_ndevolucion";
   $tab_labels["num_ndevolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["num_ndevolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["num_ndevolucion"] : "# N.. de Dev.";
   $tab_ger_campos['numfacom'] = "on";
   $tab_def_campos['numfacom'] = "numfacom";
   $tab_labels["numfacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["numfacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["numfacom"] : "Número Compra";
   $tab_ger_campos['fechacom'] = "on";
   $tab_def_campos['fechacom'] = "fechacom";
   $tab_labels["fechacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["fechacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["fechacom"] : "Fecha";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["fechavenc"] : "F. de la Compra.";
   $tab_ger_campos['idprov'] = "on";
   $tab_def_campos['idprov'] = "idprov";
   $tab_labels["idprov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["idprov"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["idprov"] : "Proveedor";
   ...
   $tab_labels["val_ret"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["val_ret"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["val_ret"] : "$ Retención";
   ...
   $tab_labels["val_ica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["val_ica"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["val_ica"] : "$ ReteICA";
   ...
   $tab_labels["val_retiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["val_retiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["val_retiva"] : "$ ReteIVA";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["total"] : "Total";
   $tab_ger_campos['valoriva'] = "on";
   $tab_def_campos['valoriva'] = "valoriva";
   $tab_labels["valoriva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["valoriva"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["valoriva"] : "Valoriva";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_compras_dev_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_compras_dev']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
