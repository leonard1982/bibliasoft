...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_compras_dev"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_compras_dev"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['devfac_compras'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_compras_dev']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_compras_dev']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_compras_dev']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_compras_dev']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_compras_dev']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_compras_dev']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_compras_dev']['embutida_filho'] as $ind => $sc_init)
          {
