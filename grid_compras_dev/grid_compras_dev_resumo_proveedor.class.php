...
class grid_compras_dev_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['arr_total']['idprov'];
      }
      else
      {
          $this->array_total_idprov = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][5];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][2];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][6];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][3];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][4];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][7];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['tot_geral'][8];
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['json_use_label'])
       {
          $Lab_idprov = "idprov";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['num_ndevolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['num_ndevolucion'] = "# N.. de Dev."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['numfacom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['numfacom'] = "Número Compra"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['fechacom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['fechacom'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['fechavenc'] = "F. de la Compra."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['idprov']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['idprov'] = "Proveedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['val_ret']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['val_ret'] = "$ Retención"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['val_ica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['val_ica'] = "$ ReteICA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['val_retiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['val_retiva'] = "$ ReteIVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['detalle_dev']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['detalle_dev'] = "detalle_dev"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['idfaccom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['idfaccom'] = "Compra No."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['subtotal'] = "Subtotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['asentada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['asentada'] = "Asentada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['formapago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['formapago'] = "Formapago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['retencion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['retencion'] = "Retención %"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['reteica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['reteica'] = "Reteica"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['reteiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['reteiva'] = "Reteiva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['a_pagar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['a_pagar'] = "Val a Pagar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['devolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['devolucion'] = "Devolución"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['id_pedidocom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['labels']['id_pedidocom'] = "Pedido"; 
       }
       //-----
       $this->comp_field_nm = array(
           'idprov' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_order']['proveedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_order']['proveedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_order']['proveedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_display']['proveedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_display']['proveedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_display']['proveedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_display']['proveedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_display']['proveedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_display']['proveedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['summarizing_fields_display']['proveedor'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['pivot_tabular_label'];
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_compras_dev/grid_compras_dev_config_graf_flash.php?nome_apl=grid_compras_dev&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_val_ret, $sum_val_ica, $sum_val_retiva, $sum_total, $sum_valoriva, $sum_subtotal, $sum_a_pagar, $quebra_idprov, $quebra_idprov_orig)
   {
      //----- Proveedor
      if (!isset($this->array_total_idprov[$quebra_idprov_orig]))
      {
         ...
         $this->array_total_idprov[$quebra_idprov_orig][7] = $sum_a_pagar;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['arr_total']['idprov'] as $campo_idprov => $dados_idprov)
      {
         ...
         $this->array_total_idprov[$campo_idprov][8] = $dados_idprov[7];
...
$_SESSION['scriptcase']['grid_compras_dev']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->val_ret, $this->val_ica, $this->val_retiva, $this->total, $this->valoriva, $this->subtotal, $this->a_pagar, $this->idprov, $this->idprov_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_compras_dev']['contr_erro'] = 'off';
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['arr_total']['idprov'] = $this->array_total_idprov;
      }
   }
