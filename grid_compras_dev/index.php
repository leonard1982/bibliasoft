   ...
   function controle($linhas = 0)
   {
      ...
      { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_dev']['int_search_dados'] = array();
          } 
      } 
