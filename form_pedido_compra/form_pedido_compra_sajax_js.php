  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pedido_compra" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pedido_compra_form();
	}
  ...
  function do_ajax_form_pedido_compra_validate_prefijo_ped()
  {
    var nomeCampo_prefijo_ped = "prefijo_ped";
    var var_prefijo_ped = scAjaxGetFieldSelect(nomeCampo_prefijo_ped);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_prefijo_ped(var_prefijo_ped, var_script_case_init, do_ajax_form_pedido_compra_validate_prefijo_ped_cb);
  } // do_ajax_form_pedido_compra_validate_prefijo_ped

  function do_ajax_form_pedido_compra_validate_prefijo_ped_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_prefijo_ped_cb

  // ---------- Validate numpedido
  function do_ajax_form_pedido_compra_validate_numpedido()
  {
    var nomeCampo_numpedido = "numpedido";
    var var_numpedido = scAjaxGetFieldText(nomeCampo_numpedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_numpedido(var_numpedido, var_script_case_init, do_ajax_form_pedido_compra_validate_numpedido_cb);
  } // do_ajax_form_pedido_compra_validate_numpedido

  function do_ajax_form_pedido_compra_validate_numpedido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_numpedido_cb

  // ---------- Validate asentada
  function do_ajax_form_pedido_compra_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldSelect(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_pedido_compra_validate_asentada_cb);
  } // do_ajax_form_pedido_compra_validate_asentada

  function do_ajax_form_pedido_compra_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_asentada_cb

  // ---------- Validate observaciones
  function do_ajax_form_pedido_compra_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_pedido_compra_validate_observaciones_cb);
  } // do_ajax_form_pedido_compra_validate_observaciones

  function do_ajax_form_pedido_compra_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_observaciones_cb

  // ---------- Validate idcli
  function do_ajax_form_pedido_compra_validate_idcli()
  {
  } // do_ajax_form_pedido_compra_validate_idcli

  function do_ajax_form_pedido_compra_validate_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_idcli_cb

  // ---------- Validate fechaven
  function do_ajax_form_pedido_compra_validate_fechaven()
  {
    var nomeCampo_fechaven = "fechaven";
    var var_fechaven = scAjaxGetFieldText(nomeCampo_fechaven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_fechaven(var_fechaven, var_script_case_init, do_ajax_form_pedido_compra_validate_fechaven_cb);
  } // do_ajax_form_pedido_compra_validate_fechaven

  function do_ajax_form_pedido_compra_validate_fechaven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_fechaven_cb

  // ---------- Validate fechavenc
  function do_ajax_form_pedido_compra_validate_fechavenc()
  {
    var nomeCampo_fechavenc = "fechavenc";
    var var_fechavenc = scAjaxGetFieldText(nomeCampo_fechavenc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_fechavenc(var_fechavenc, var_script_case_init, do_ajax_form_pedido_compra_validate_fechavenc_cb);
  } // do_ajax_form_pedido_compra_validate_fechavenc

  function do_ajax_form_pedido_compra_validate_fechavenc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_fechavenc_cb

  // ---------- Validate credito
  function do_ajax_form_pedido_compra_validate_credito()
  {
    var nomeCampo_credito = "credito";
    var var_credito = scAjaxGetFieldSelect(nomeCampo_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_credito(var_credito, var_script_case_init, do_ajax_form_pedido_compra_validate_credito_cb);
  } // do_ajax_form_pedido_compra_validate_credito

  function do_ajax_form_pedido_compra_validate_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "credito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_credito_cb

  // ---------- Validate facturado
  function do_ajax_form_pedido_compra_validate_facturado()
  {
    var nomeCampo_facturado = "facturado";
    var var_facturado = scAjaxGetFieldHidden(nomeCampo_facturado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_facturado(var_facturado, var_script_case_init, do_ajax_form_pedido_compra_validate_facturado_cb);
  } // do_ajax_form_pedido_compra_validate_facturado

  function do_ajax_form_pedido_compra_validate_facturado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_facturado_cb

  // ---------- Validate numfacven
  function do_ajax_form_pedido_compra_validate_numfacven()
  {
    var nomeCampo_numfacven = "numfacven";
    var var_numfacven = scAjaxGetFieldHidden(nomeCampo_numfacven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_numfacven(var_numfacven, var_script_case_init, do_ajax_form_pedido_compra_validate_numfacven_cb);
  } // do_ajax_form_pedido_compra_validate_numfacven

  function do_ajax_form_pedido_compra_validate_numfacven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_numfacven_cb

  // ---------- Validate subtotal
  function do_ajax_form_pedido_compra_validate_subtotal()
  {
    var nomeCampo_subtotal = "subtotal";
    var var_subtotal = scAjaxGetFieldHidden(nomeCampo_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_subtotal(var_subtotal, var_script_case_init, do_ajax_form_pedido_compra_validate_subtotal_cb);
  } // do_ajax_form_pedido_compra_validate_subtotal

  function do_ajax_form_pedido_compra_validate_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_subtotal_cb

  // ---------- Validate valoriva
  function do_ajax_form_pedido_compra_validate_valoriva()
  {
    var nomeCampo_valoriva = "valoriva";
    var var_valoriva = scAjaxGetFieldHidden(nomeCampo_valoriva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_valoriva(var_valoriva, var_script_case_init, do_ajax_form_pedido_compra_validate_valoriva_cb);
  } // do_ajax_form_pedido_compra_validate_valoriva

  function do_ajax_form_pedido_compra_validate_valoriva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_valoriva_cb

  // ---------- Validate total
  function do_ajax_form_pedido_compra_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_total(var_total, var_script_case_init, do_ajax_form_pedido_compra_validate_total_cb);
  } // do_ajax_form_pedido_compra_validate_total

  function do_ajax_form_pedido_compra_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_total_cb

  // ---------- Validate adicional
  function do_ajax_form_pedido_compra_validate_adicional()
  {
    var nomeCampo_adicional = "adicional";
    var var_adicional = scAjaxGetFieldHidden(nomeCampo_adicional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_adicional(var_adicional, var_script_case_init, do_ajax_form_pedido_compra_validate_adicional_cb);
  } // do_ajax_form_pedido_compra_validate_adicional

  function do_ajax_form_pedido_compra_validate_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_adicional_cb

  // ---------- Validate saldo
  function do_ajax_form_pedido_compra_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldHidden(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_pedido_compra_validate_saldo_cb);
  } // do_ajax_form_pedido_compra_validate_saldo

  function do_ajax_form_pedido_compra_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_saldo_cb

  // ---------- Validate detallepedidos
  function do_ajax_form_pedido_compra_validate_detallepedidos()
  {
    var nomeCampo_detallepedidos = "detallepedidos";
    var var_detallepedidos = scAjaxGetFieldText(nomeCampo_detallepedidos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedido_compra_validate_detallepedidos(var_detallepedidos, var_script_case_init, do_ajax_form_pedido_compra_validate_detallepedidos_cb);
  } // do_ajax_form_pedido_compra_validate_detallepedidos

  function do_ajax_form_pedido_compra_validate_detallepedidos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_validate_detallepedidos_cb

  // ---------- Refresh idcli
  function do_ajax_form_pedido_compra_refresh_idcli()
  {
    var var_idcli = scAjaxGetFieldText("idcli");
    var var_nmgp_refresh_fields = "dircliente";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pedido_compra_refresh_idcli(var_idcli, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_pedido_compra_refresh_idcli_cb);
  } // do_ajax_form_pedido_compra_refresh_idcli

  function do_ajax_form_pedido_compra_refresh_idcli_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedido_compra_refresh_idcli_cb

  // ---------- Event onchange asentada
  function do_ajax_form_pedido_compra_event_asentada_onchange()
  {
    var var_total = scAjaxGetFieldHidden("total");
    var var_asentada = scAjaxGetFieldSelect("asentada");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pedido_compra_event_asentada_onchange(var_total, var_asentada, var_script_case_init, do_ajax_form_pedido_compra_event_asentada_onchange_cb);
  } // do_ajax_form_pedido_compra_event_asentada_onchange

  function do_ajax_form_pedido_compra_event_asentada_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "asentada";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pedido_compra_event_asentada_onchange_cb_after_alert);
  } // do_ajax_form_pedido_compra_event_asentada_onchange_cb
  function do_ajax_form_pedido_compra_event_asentada_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pedido_compra_event_asentada_onchange_cb_after_alert

  // ---------- Event onchange credito
  function do_ajax_form_pedido_compra_event_credito_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pedido_compra_event_credito_onchange(var_idcli, var_credito, var_fechaven, var_fechavenc, var_script_case_init, do_ajax_form_pedido_compra_event_credito_onchange_cb);
  } // do_ajax_form_pedido_compra_event_credito_onchange

  function do_ajax_form_pedido_compra_event_credito_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "credito";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pedido_compra_event_credito_onchange_cb_after_alert);
  } // do_ajax_form_pedido_compra_event_credito_onchange_cb
  function do_ajax_form_pedido_compra_event_credito_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pedido_compra_event_credito_onchange_cb_after_alert

  // ---------- Event onchange fechaven
  function do_ajax_form_pedido_compra_event_fechaven_onchange()
  {
    var var_credito = scAjaxGetFieldSelect("credito");
    var var_fechaven = scAjaxGetFieldText("fechaven");
    var var_fechavenc = scAjaxGetFieldText("fechavenc");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pedido_compra_event_fechaven_onchange(var_credito, var_fechaven, var_fechavenc, var_script_case_init, do_ajax_form_pedido_compra_event_fechaven_onchange_cb);
  } // do_ajax_form_pedido_compra_event_fechaven_onchange

  function do_ajax_form_pedido_compra_event_fechaven_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fechaven";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pedido_compra_event_fechaven_onchange_cb_after_alert);
  } // do_ajax_form_pedido_compra_event_fechaven_onchange_cb
  function do_ajax_form_pedido_compra_event_fechaven_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pedido_compra_event_fechaven_onchange_cb_after_alert

  // ---------- Event onchange fechavenc
  function do_ajax_form_pedido_compra_event_fechavenc_onchange()
  {
    var var_credito = scAjaxGetFieldSelect("credito");
    var var_fechaven = scAjaxGetFieldText("fechaven");
    var var_fechavenc = scAjaxGetFieldText("fechavenc");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pedido_compra_event_fechavenc_onchange(var_credito, var_fechaven, var_fechavenc, var_script_case_init, do_ajax_form_pedido_compra_event_fechavenc_onchange_cb);
  } // do_ajax_form_pedido_compra_event_fechavenc_onchange

  function do_ajax_form_pedido_compra_event_fechavenc_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fechavenc";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pedido_compra_event_fechavenc_onchange_cb_after_alert);
  } // do_ajax_form_pedido_compra_event_fechavenc_onchange_cb
  function do_ajax_form_pedido_compra_event_fechavenc_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pedido_compra_event_fechavenc_onchange_cb_after_alert

  // ---------- Event onchange idcli
  function do_ajax_form_pedido_compra_event_idcli_onchange()
  {
    var var_idcli = scAjaxGetFieldText("id_ac_idcli");
    var var_fechaven = scAjaxGetFieldText("fechaven");
    var var_fechavenc = scAjaxGetFieldText("fechavenc");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pedido_compra_event_idcli_onchange(var_idcli, var_fechaven, var_fechavenc, var_credito, var_script_case_init, do_ajax_form_pedido_compra_event_idcli_onchange_cb);
  } // do_ajax_form_pedido_compra_event_idcli_onchange

  function do_ajax_form_pedido_compra_event_idcli_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idcli";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pedido_compra_event_idcli_onchange_cb_after_alert);
  } // do_ajax_form_pedido_compra_event_idcli_onchange_cb
  function do_ajax_form_pedido_compra_event_idcli_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_pedido_compra_refresh_idcli();
    scAjaxRedir();
  } // do_ajax_form_pedido_compra_event_idcli_onchange_cb_after_alert

  // ---------- Event onchange prefijo_ped
  function do_ajax_form_pedido_compra_event_prefijo_ped_onchange()
  {
    var var_total = scAjaxGetFieldHidden("total");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pedido_compra_event_prefijo_ped_onchange(var_total, var_prefijo_ped, var_numpedido, var_script_case_init, do_ajax_form_pedido_compra_event_prefijo_ped_onchange_cb);
  } // do_ajax_form_pedido_compra_event_prefijo_ped_onchange

  function do_ajax_form_pedido_compra_event_prefijo_ped_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijo_ped";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pedido_compra_event_prefijo_ped_onchange_cb_after_alert);
  } // do_ajax_form_pedido_compra_event_prefijo_ped_onchange_cb
  function do_ajax_form_pedido_compra_event_prefijo_ped_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pedido_compra_event_prefijo_ped_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pedido_compra_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pedido_compra_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_prefijo_ped = scAjaxGetFieldSelect("prefijo_ped");
    ...
    var var_fechavenc = scAjaxGetFieldText("fechavenc");
    var var_credito = scAjaxGetFieldSelect("credito");
    var var_facturado = scAjaxGetFieldHidden("facturado");
    ...
    scAjaxProcOn();
    x_ajax_form_pedido_compra_submit_form(var_prefijo_ped, var_numpedido, var_asentada, var_observaciones, var_idcli, var_fechaven, var_fechavenc, var_credito, var_facturado, var_numfacven, var_subtotal, var_valoriva, var_total, var_adicional, var_saldo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pedido_compra_submit_form_cb);
  } // do_ajax_form_pedido_compra_submit_form

  function do_ajax_form_pedido_compra_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pedido_compra_submit_form_cb_after_alert);
  } // do_ajax_form_pedido_compra_submit_form_cb
  function do_ajax_form_pedido_compra_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pedido_compra_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detallepedido_compra"] = "off";

  function do_ajax_form_pedido_compra_navigate_form()
  {
    perform_ajax_form_pedido_compra_navigate_form();
  }

  function perform_ajax_form_pedido_compra_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_detallepedido_compra"] = "on";
    x_ajax_form_pedido_compra_navigate_form(var_idpedido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pedido_compra_navigate_form_cb);
  } // do_ajax_form_pedido_compra_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pedido_compra_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detallepedido_compra"] && "nmsc_iframe_liga_form_detallepedido_compra" != scMasterDetailIframe["nmsc_iframe_liga_form_detallepedido_compra"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detallepedido_compra"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detallepedido_compra').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_detallepedido_compra').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_detallepedido_compra').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pedido_compra_navigate_form_cb_after_alert);
  } // do_ajax_form_pedido_compra_navigate_form_cb
  function do_ajax_form_pedido_compra_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('idcli');
...
{
?>
    do_ajax_form_pedido_compra_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pedido_compra_navigate_form_cb_after_alert
  function sc_hide_form_pedido_compra_form()
  {
  ...
  function do_ajax_form_pedido_compra_lkpedt_refresh_idcli()
  {
    var var_idcli = scAjaxGetFieldText("idcli");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "idcli";
    x_ajax_form_pedido_compra_lkpedt_refresh_idcli(var_idcli, nmgp_refresh_fields, var_script_case_init, do_ajax_form_pedido_compra_lkpedt_refresh_idcli_cb);
  } // do_ajax_form_pedido_compra_lkpedt_refresh_idcli

  function do_ajax_form_pedido_compra_lkpedt_refresh_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_pedido_compra_lkpedt_refresh_idcli_cb
  ...
  {
    if ("off" == scStatusDetail["form_detallepedido_compra"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[2] = "asentada";
  ajax_field_list[3] = "observaciones";
  ajax_field_list[4] = "idcli";
  ajax_field_list[5] = "fechaven";
  ajax_field_list[6] = "fechavenc";
  ajax_field_list[7] = "credito";
  ajax_field_list[8] = "facturado";
  ajax_field_list[9] = "numfacven";
  ajax_field_list[10] = "subtotal";
  ajax_field_list[11] = "valoriva";
  ajax_field_list[12] = "total";
  ajax_field_list[13] = "adicional";
  ajax_field_list[14] = "saldo";
  ajax_field_list[15] = "detallepedidos";
  ...
  var ajax_error_list = {
    "prefijo_ped": {"label": "PREFIJO DEL PEDIDO:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numpedido": {"label": "PEDIDO N°:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "observaciones": {"label": "OBSEERVACIONES:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcli": {"label": "EL PROVEEDOR:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechaven": {"label": "FECHA DEL PEDIDO:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "facturado": {"label": "PEDIDO YA FACTURADO?:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
