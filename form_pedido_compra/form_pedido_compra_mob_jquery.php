...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_numfacven' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_numfacven_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_pedido_compra_numfacven_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pedido_compra_numfacven_onfocus(this, iSeqRow) });
  $('#id_sc_field_credito' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_credito_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_pedido_compra_credito_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_pedido_compra_credito_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechaven' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_fechaven_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pedido_compra_fechaven_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pedido_compra_fechaven_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechavenc' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_fechavenc_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_pedido_compra_fechavenc_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pedido_compra_fechavenc_onfocus(this, iSeqRow) });
  $('#id_sc_field_idcli' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_idcli_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_pedido_compra_idcli_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pedido_compra_idcli_onfocus(this, iSeqRow) });
  $('#id_sc_field_subtotal' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_subtotal_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pedido_compra_subtotal_onfocus(this, iSeqRow) });
  $('#id_sc_field_valoriva' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_valoriva_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pedido_compra_valoriva_onfocus(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_total_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pedido_compra_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_facturado' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_facturado_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pedido_compra_facturado_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentada' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_asentada_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_pedido_compra_asentada_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pedido_compra_asentada_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_observaciones_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_pedido_compra_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_saldo_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pedido_compra_saldo_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_adicional_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pedido_compra_adicional_onfocus(this, iSeqRow) });
  $('#id_sc_field_numpedido' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_numpedido_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pedido_compra_numpedido_onfocus(this, iSeqRow) });
  $('#id_sc_field_prefijo_ped' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_prefijo_ped_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_pedido_compra_prefijo_ped_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_pedido_compra_prefijo_ped_onfocus(this, iSeqRow) });
  $('#id_sc_field_detallepedidos' + iSeqRow).bind('blur', function() { sc_form_pedido_compra_detallepedidos_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_pedido_compra_detallepedidos_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_pedido_compra_numfacven_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_numfacven();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_numfacven_onchange(oThis, iSeqRow) {
  lookup_numfacven();
}

function sc_form_pedido_compra_numfacven_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_credito_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_credito();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_credito_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_event_credito_onchange();
}

function sc_form_pedido_compra_credito_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_fechaven_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_fechaven();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_fechaven_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_event_fechaven_onchange();
}

function sc_form_pedido_compra_fechaven_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_fechavenc_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_fechavenc();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_fechavenc_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_event_fechavenc_onchange();
}

function sc_form_pedido_compra_fechavenc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_idcli_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_idcli();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_idcli_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_event_idcli_onchange();
}

function sc_form_pedido_compra_idcli_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_pedido_compra_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_subtotal();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_subtotal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_valoriva_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_valoriva();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_valoriva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_total_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_total();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_facturado_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_facturado();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_facturado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_asentada_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_asentada();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_asentada_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_event_asentada_onchange();
}

function sc_form_pedido_compra_asentada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_observaciones();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_saldo_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_saldo();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_saldo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_adicional_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_adicional();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_adicional_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_numpedido_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_numpedido();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_numpedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_prefijo_ped_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_prefijo_ped();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_prefijo_ped_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_event_prefijo_ped_onchange();
}

function sc_form_pedido_compra_prefijo_ped_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pedido_compra_detallepedidos_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_compra_mob_validate_detallepedidos();
  scCssBlur(oThis);
}

function sc_form_pedido_compra_detallepedidos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_field_detallepedidos(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_detallepedido_compra_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_detallepedido_compra_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_pedido_compra_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechaven" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pedido_compra_mob_validate_fechaven(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pedido_compra_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pedido_compra_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
