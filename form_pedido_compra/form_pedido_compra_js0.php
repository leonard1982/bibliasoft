...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pedido_compra"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_pdfreport_pedidos_compras_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "par_pedido*scin' + var_btn_imprimir_par_pedido + '*scout"; ?>', 'inicio', '_blank', '0', '0', 'pdfreport_pedidos_compras');
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_detal']))
  {
?>  
...
function lookup_numfacven(campo)
{
   ...
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_pedido_compra')?>/form_pedido_compra.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_numfacven, "numfacven", dados, false);
}
...
{
   nm_field_disabled("numpedido=disabled", "U");
