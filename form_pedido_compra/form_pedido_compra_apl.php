...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_pedido)) 
          {
              $_SESSION['par_pedido'] = $this->par_pedido;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_pedido_compra_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_pedido_compra']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_pedido_compra']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_pedido_compra'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_pedido_compra']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_pedido_compra']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_pedido_compra') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_pedido_compra']['label'] = "Editar Pedido de Compra";
      ...
      $_SESSION['scriptcase']['error_icon']['form_pedido_compra']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_pedido_compra'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_orig'] = " where tipo_doc='PC'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_pesq'] = " where tipo_doc='PC'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_pedido_compra']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_pedido_compra'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_pedido_compra'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_pedido_compra", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_pedido_compra/form_pedido_compra_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_pedido_compra_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_pedido_compra_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_pedido_compra_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_pedido_compra/form_pedido_compra_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_pedido_compra_erro.class.php"); 
      }
      $this->Erro      = new form_pedido_compra_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao']))
         { 
             if ($this->idpedido != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_pedido_compra']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['imprimir'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['botoes']['imprimir'];
          $this->nmgp_botoes['Eliminar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['botoes']['Eliminar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_detallepedido_compra') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_detallepedido_compra') . "/form_detallepedido_compra_apl.php");
          $this->form_detallepedido_compra = new form_detallepedido_compra_apl;
      }
      ...
      {
      $_SESSION['scriptcase']['form_pedido_compra']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_pedido_compra']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_pedido_compra']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_pedido_compra']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_idcli']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_idcli'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_idcli']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_idcli'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_pedido_compra_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_pedido_compra_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_idcli'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['idcli']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idcli = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['idcli'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['observaciones']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['observaciones'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['numfacven']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numfacven = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['numfacven'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['fechaven']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechaven = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['fechaven'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['fechavenc']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechavenc = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['fechavenc'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['credito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->credito = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['credito'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['prefijo_ped']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->prefijo_ped = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['prefijo_ped'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['facturado']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->facturado = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['facturado'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['asentada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['asentada'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['dircliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dircliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['dircliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['vendedor']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['vendedor'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['numpedido']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numpedido = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select']['numpedido'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_pedido_compra.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_pedido_compra_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_pedido_compra"> 
...
<?php
include_once("form_pedido_compra_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->idpedido) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_form']['idpedido']))
          {
              $varloc_btn_php['idpedido'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_form']['idpedido'];
          }
      }
      $nm_f_saida = "./";
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_pedido_compra']) || !is_array($this->NM_ajax_info['errList']['geral_form_pedido_compra']))
              {
                  $this->NM_ajax_info['errList']['geral_form_pedido_compra'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_pedido_compra'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_prefijo_ped(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
               if (!empty($this->prefijo_ped) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_prefijo_ped']) && !in_array($this->prefijo_ped, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_prefijo_ped']))
               {
                   $hasError = true;
    ...
    function ValidateField_idcli(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['php_cmp_required']['idcli']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['php_cmp_required']['idcli'] == "on")) 
      { 
          if ($this->idcli == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_credito(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['php_cmp_required']['credito']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['php_cmp_required']['credito'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_adicional(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['php_cmp_required']['adicional']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['php_cmp_required']['adicional'] == "on") 
           { 
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idpedido']['keyVal'] = form_pedido_compra_pack_protect_string($this->nmgp_dados_form['idpedido']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['foreign_key']['idpedid'] = $this->nmgp_dados_form['idpedido'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['where_filter'] = "idpedid = " . $this->nmgp_dados_form['idpedido'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['where_detal']  = "idpedid = " . $this->nmgp_dados_form['idpedido'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['form_detallepedido_compra_script_case_init'] ]['form_detallepedido_compra']['total']);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_prefijo_ped']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_prefijo_ped'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_prefijo_ped']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_prefijo_ped'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_prefijo_ped'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['prefijo_ped']['valList'][$i] = form_pedido_compra_pack_protect_string($v);
          }
...
$aLookup[] = array(form_pedido_compra_pack_protect_string('0') => str_replace('<', '&lt;',form_pedido_compra_pack_protect_string("No")));
$aLookup[] = array(form_pedido_compra_pack_protect_string('1') => str_replace('<', '&lt;',form_pedido_compra_pack_protect_string("Sí")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_asentada'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_asentada'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['asentada']['valList'][$i] = form_pedido_compra_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][form_pedido_compra_pack_protect_string(NM_charset_to_utf8($this->idcli))]) ? $aLookup[0][form_pedido_compra_pack_protect_string(NM_charset_to_utf8($this->idcli))] : "";
...
$aLookup[] = array(form_pedido_compra_pack_protect_string('2') => str_replace('<', '&lt;',form_pedido_compra_pack_protect_string("No")));
$aLookup[] = array(form_pedido_compra_pack_protect_string('1') => str_replace('<', '&lt;',form_pedido_compra_pack_protect_string("Sí")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_credito'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['Lookup_credito'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['credito']['valList'][$i] = form_pedido_compra_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_numfacven($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['numfacven'] = array(
              ...
              $this->NM_ajax_info['fldList']['numfacven']['lookupCons'] = form_pedido_compra_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
   ...
   function ajax_return_values_detallepedidos($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idpedido)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_pedido_compra';
...
$_SESSION['scriptcase']['form_pedido_compra']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_detallepedido_compra->ini_controle();
              if ($this->form_detallepedido_compra->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_pedido_compra']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['parms'] = "idpedido?#?$this->idpedido?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_form_pedido_compra = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total'] = $qt_geral_reg_form_pedido_compra;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idpedido))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_pedido_compra = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] > $qt_geral_reg_form_pedido_compra)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] = $qt_geral_reg_form_pedido_compra; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_pedido_compra) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] < $qt_geral_reg_form_pedido_compra;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_pedido_compra_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter_form'] . " and (tipo_doc='PC') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_pedido_compra = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['total'] = $qt_geral_reg_form_pedido_compra;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_pedido_compra_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_pedido_compra_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_pedido_compra_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedido_compra']['retorno_edit'] = "";
   }
