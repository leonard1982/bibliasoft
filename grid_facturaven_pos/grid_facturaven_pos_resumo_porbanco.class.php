...
$_SESSION['scriptcase']['grid_facturaven_pos']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['banco'];
      }
      else
      {
          $this->array_total_banco = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['banco'] = $this->array_total_banco;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['banco'] = $Lab_banco; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['porbanco']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['porbanco'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['porbanco'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porbanco'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porbanco'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porbanco'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porbanco'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porbanco'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porbanco'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porbanco'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_banco as $i_banco => $d_banco) {
           if (!in_array($i_banco, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_banco[7] ] = $d_banco[6];
               $this->comp_label[0][ $d_banco[7] ] = $d_banco[6];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_adicional, $quebra_banco, $quebra_banco_orig)
   {
      //----- Caja
      if (!isset($this->array_total_banco[$quebra_banco_orig]))
      {
         $this->array_total_banco[$quebra_banco_orig][0] = 1;
         $this->array_total_banco[$quebra_banco_orig][1] = $sum_total;
         $this->array_total_banco[$quebra_banco_orig][2] = $sum_subtotal;
         $this->array_total_banco[$quebra_banco_orig][3] = $sum_valoriva;
         $this->array_total_banco[$quebra_banco_orig][4] = $sum_adicional;
         $this->array_total_banco[$quebra_banco_orig][5] = 1;
         $this->array_total_banco[$quebra_banco_orig][6] = $quebra_banco;
         $this->array_total_banco[$quebra_banco_orig][7] = $quebra_banco_orig;
      }
      else
      {
         ...
         $this->array_total_banco[$quebra_banco_orig][3] += $sum_valoriva;
         $this->array_total_banco[$quebra_banco_orig][4] += $sum_adicional;
         $this->array_total_banco[$quebra_banco_orig][5]++;
      }
   }
...
$_SESSION['scriptcase']['grid_facturaven_pos']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->adicional, $this->banco, $this->banco_orig);
            }
   }
//
