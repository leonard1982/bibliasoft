...
$_SESSION['scriptcase']['grid_facturaven_pos']['contr_erro'] = 'off'; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['fechaven'] = $this->array_total_fechaven;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['fechavenc'] = $this->array_total_fechavenc;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['idcli'] = $this->array_total_idcli;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['pagada'] = $this->array_total_pagada;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['asentada'] = $this->array_total_asentada;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['tipo'] = $this->array_total_tipo;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['fechaven'] = $Lab_fechaven; 
       $prep_field['fechavenc'] = $Lab_fechavenc;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['fechavenc'] = $Lab_fechavenc; 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['pagada'] = $Lab_pagada; 
       $prep_field['asentada'] = $Lab_asentada;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['asentada'] = $Lab_asentada; 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['tipo'] = $Lab_tipo; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_facturaven_pos/grid_facturaven_pos_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_adicional, $quebra_credito, $quebra_fechaven, $quebra_fechavenc, $quebra_idcli, $quebra_pagada, $quebra_asentada, $quebra_resolucion, $quebra_vendedor, $quebra_tipo, $quebra_credito_orig, $quebra_fechaven_orig, $quebra_fechavenc_orig, $quebra_idcli_orig, $quebra_pagada_orig, $quebra_asentada_orig, $quebra_resolucion_orig, $quebra_vendedor_orig, $quebra_tipo_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
$_SESSION['scriptcase']['grid_facturaven_pos']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
