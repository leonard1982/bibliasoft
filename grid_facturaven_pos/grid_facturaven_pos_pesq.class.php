...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "fechaven";$Nm_datas[] = "fechaven";$Nm_datas[] = "fechavenc";$Nm_datas[] = "fechavenc";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";$Nm_datas[] = "inicio";$Nm_datas[] = "inicio";$Nm_datas[] = "fin";$Nm_datas[] = "fin";$Nm_datas[] = "fecha_validacion";$Nm_datas[] = "fecha_validacion";$Nm_datas[] = "fecha_pago";$Nm_datas[] = "fecha_pago";
...
?>
      ...
      <TD id='SC_id_clasificacion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_clasificacion'])) ? $this->New_label['id_clasificacion'] : "Clasificación"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_clasificacion_cond" name="id_clasificacion_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_clasificacion" <?php echo $str_hide_id_clasificacion?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_facturaven_pos";
