...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_facturaven_pos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_facturaven_pos"]);
   }
