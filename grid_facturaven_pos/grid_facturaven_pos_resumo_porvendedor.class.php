...
$_SESSION['scriptcase']['grid_facturaven_pos']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['vendedor'];
      }
      else
      {
          $this->array_total_vendedor = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['arr_total']['vendedor'] = $this->array_total_vendedor;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['vendedor'] = $Lab_vendedor; 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['numero2'] = "Número"; 
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['opciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['opciones'] = ""; 
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['sc_clasificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['sc_clasificacion'] = "Clasificación"; 
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['id_clasificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['id_clasificacion'] = "Id Clasificacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['fecha_pago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['fecha_pago'] = "Fecha Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['fec_pago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['labels']['fec_pago'] = "Fec Pago"; 
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['porvendedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['porvendedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_order']['porvendedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porvendedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porvendedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porvendedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porvendedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porvendedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porvendedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos']['summarizing_fields_display']['porvendedor'] as $i_sum => $d_sum)
           {
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $id_clasificacion = $Busca_temp['id_clasificacion']; 
          $tmp_pos = strpos($id_clasificacion, "##@@");
          if ($tmp_pos !== false && !is_array($id_clasificacion))
          {
              $id_clasificacion = substr($id_clasificacion, 0, $tmp_pos);
          }
          $fecha_pago = $Busca_temp['fecha_pago']; 
          $tmp_pos = strpos($fecha_pago, "##@@");
          if ($tmp_pos !== false && !is_array($fecha_pago))
          {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->enlacepdf = $rs_res->fields[34] ;  
            $this->id_trans_fe = $rs_res->fields[35] ;  
            $this->nomcli = $rs_res->fields[36] ;  
            $this->si_electronica = $rs_res->fields[37] ;  
            $this->nombre_cliente = $rs_res->fields[38] ;  
            $this->celular_ws = $rs_res->fields[39] ;  
            $this->dircliente = $rs_res->fields[40] ;  
            $this->fecha_pago = $rs_res->fields[41] ;  
            $this->fec_pago = $rs_res->fields[42] ;  
            $this->numfe = $rs_res->fields[43] ;  
