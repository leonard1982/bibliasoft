...
class grid_facturaven_pos_total
{
   ...
   function __construct($sc_page)
   {
      ...
      { 
          ...
          $fecha_pago_2 = $Busca_temp['fecha_pago_input_2']; 
   ...
   {
      global $nm_lang, $editarpos, $imprimircopia, $a4, $pdf, $enviar_tech, $enviar_propio, $reenviar, $restaurante, $envio_dataico, $opciones, $copiar, $existeentns, $imprimir, $sc_clasificacion, $regenerar_pdf_propio, $ver_xml_propio, $whatsapp_propio, $idcli, $pedido, $resolucion, $vendedor, $banco;
      $this->nm_data = new nm_data("es");
