<?php
   include_once('grid_facturaven_pos_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_facturaven_pos']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_facturaven_pos']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_facturaven_pos']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_facturaven_pos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_pos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_pos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_facturaven_pos_json.php");
   }
   ...
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["tipo"] : "Tipo";
   ...
   $tab_labels["direccion2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["direccion2"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["direccion2"] : "Dirección";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["total"] : "Total";
   ...
   $tab_labels["imprimircopia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["imprimircopia"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["imprimircopia"] : "Ticket";
   ...
   $tab_labels["a4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["a4"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["a4"] : "A4";
   ...
   $tab_labels["pdf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["pdf"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["pdf"] : "PDF";
   $tab_ger_campos['enviar_tech'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['enviar_tech'] = "enviar_tech";
   }
   else
   {
       $tab_def_campos['enviar_tech'] = "";
   }
   $tab_labels["enviar_tech"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["enviar_tech"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["enviar_tech"] : "Envío";
   $tab_ger_campos['enviar_propio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['enviar_propio'] = "enviar_propio";
   }
   else
   {
       $tab_def_campos['enviar_propio'] = "";
   }
   $tab_labels["enviar_propio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["enviar_propio"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["enviar_propio"] : "Acción";
   ...
   $tab_labels["reenviar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["reenviar"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["reenviar"] : "Reenviar";
   $tab_ger_campos['restaurante'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['restaurante'] = "restaurante";
   }
   else
   {
       $tab_def_campos['restaurante'] = "";
   }
   $tab_labels["restaurante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["restaurante"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['labels']["restaurante"] : "Terminal";
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['envio_dataico'] = "envio_dataico";
   }
   else
   {
   ...
   $tab_ger_campos['enviar_tech'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_pos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
