...
<?php
   ...
   $Ord_Cmp = new grid_inventario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inventario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["escombo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["escombo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["escombo"] : "Combo";
   $tab_ger_campos['idpro'] = "on";
   $tab_def_campos['idpro'] = "idpro";
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["idpro"] : "Producto";
   $tab_ger_campos['idcombo'] = "on";
   $tab_def_campos['idcombo'] = "idcombo";
   $tab_labels["idcombo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["idcombo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["idcombo"] : "De";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorparcial'] = "on";
   $tab_def_campos['valorparcial'] = "valorparcial";
   $tab_labels["valorparcial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["valorparcial"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["valorparcial"] : "V/Parcial";
   $tab_ger_campos['costo'] = "on";
   $tab_def_campos['costo'] = "costo";
   $tab_labels["costo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["costo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["costo"] : "Costo/U.";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["idbod"] : "Ubicación";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['detalle'] = "on";
   $tab_def_campos['detalle'] = "detalle";
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["detalle"] : "Detalle";
   $tab_ger_campos['inicio'] = "on";
   $tab_def_campos['inicio'] = "inicio";
   $tab_labels["inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['labels']["inicio"] : "Creado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inventario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inventario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inventario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inventario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
