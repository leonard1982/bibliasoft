...
class grid_inventario_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['grupo'];
      }
      else
      {
          $this->array_total_grupo = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_order']['grupofamilia']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_order']['grupofamilia'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_order']['grupofamilia'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['grupofamilia'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['grupofamilia'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['grupofamilia'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['grupofamilia'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['grupofamilia'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['grupofamilia'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['grupofamilia'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_grupo as $i_grupo => $d_grupo) {
           if (!in_array($i_grupo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_grupo[5] ] = $d_grupo[4];
               $this->comp_label[0][ $d_grupo[5] ] = $d_grupo[4];
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_grupofamilia("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_valorparcial, $quebra_grupo, $quebra_grupo_orig)
   {
      //----- Grupo
      if (!isset($this->array_total_grupo[$quebra_grupo_orig]))
      {
         ...
         $this->array_total_grupo[$quebra_grupo_orig][2] = $sum_valorparcial;
         $this->array_total_grupo[$quebra_grupo_orig][3] = 1;
         $this->array_total_grupo[$quebra_grupo_orig][4] = $quebra_grupo;
         $this->array_total_grupo[$quebra_grupo_orig][5] = $quebra_grupo_orig;
      }
      else
      {
         ...
         $this->array_total_grupo[$quebra_grupo_orig][1] += $sum_cantidad;
         $this->array_total_grupo[$quebra_grupo_orig][2] += $sum_valorparcial;
         $this->array_total_grupo[$quebra_grupo_orig][3]++;
      }
   }
...
$_SESSION['scriptcase']['grid_inventario']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->valorparcial, $this->grupo, $this->grupo_orig);
            }
   }
//
