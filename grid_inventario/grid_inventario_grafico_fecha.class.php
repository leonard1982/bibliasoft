...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['contr_label_graf']['fecha']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['contr_label_graf']['fecha']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['contr_label_graf']['fecha'];
      }
   }
