...
class grid_inventario_grafico
{
   ...
   //---- 
   function grid_inventario_grafico()
   {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Grupo";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['contr_label_graf']['grupo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['contr_label_graf']['grupo']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['contr_label_graf']['grupo'];
      }
   }
...
//
   function grafico_col($campo_grafico)
   {
     ...
     if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_lab']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_lab']))
     {
         $this->calcula_graf_col();
     }
     if ($campo_grafico == "cantidad")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['using_column_chart'] = "cantidad";
         $array_lab        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_lab']['cantidad'];
         $array_val[" "] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_val']['cantidad'];
         $this->Decimais = 3;
         $graf_lab  = "Artículo";
         $graf_val  = "Cantidad";
         $pos = true;
...
//
   ...
   {
     $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_lab'] = array();
     $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_val'] = array();
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $this->sc_proc_grid = true;
// GROUP BY idpro
     $nmgp_select = "SELECT idpro, SUM(cantidad) FROM (SELECT      idinv,     fecha,     cantidad,     idpro,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     costo,     valorparcial,     idcombo,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (select p.escombo from productos p where p.idprod=idpro) as escombo,     creado as inicio,     creado as fin,     idped FROM      inventario ) nm_sel_esp"; 
     ...
     {  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_lab']['cantidad'][] = trim($idpro); 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_val']['cantidad'][] = $sum_cantidad; 
         $rs_graf->MoveNext();
     }  
     $rs_graf->Close();
   }
...
<?php
   ...
   {
       $sChartTheme = '';
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['using_column_chart']) && "cantidad" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['using_column_chart'])
       {
       $sChartTheme = 'scriptcase__NM__sc_Color.php';
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['using_column_chart']);
       }
   ...
   function grafico_flash_xml($arr_param, $arr_series, $newline = "\r\n")
   {
       ...
       $sShowValues = " showValues=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_exibe_val'] . "\"";

       $bDisableLinks = false;
       if ($is_combinat)
       {
           if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['chart_combination_type'], array('angulargauge', 'msstepline', 'stackedarea', 'stackedbar2d', 'stackedbar3d', 'stackedcolumn2d', 'stackedcolumn3d')))
           {
               $bDisableLinks = true;
           }
       ...
       if ($chart_theme)
       {
           ...
           if ($chart_theme['css_chart_font_size'] && '' != $chart_theme['css_chart_font_size'] && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['parms_graf']['graf_font']))
           {
       ...
       {
           $chart_attr[] = "baseFontSize=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['parms_graf']['graf_font'] . "\"";
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['parms_graf']['chartpallet']) && false == $chart_theme)
       {
           $chart_attr[] = "palette=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['parms_graf']['chartpallet'] . "\"";
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['parms_graf']['graf_subtitle_val']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['parms_graf']['graf_subtitle_val'] == 'right')
       {
           $chart_attr[] = "legendPosition=\"RIGHT\"";
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_subtitle_val']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['graf_subtitle_val'] == 'right')
       {
           $chart_attr[] = "legendPosition=\"RIGHT\"";
       }
       ...
       {
           $s_xml .= " paletteColors=\"" . $this->getColorList($arr_series, $_SESSION["sc_session"][$this->Ini->sc_page]["grid_inventario"]["parms_graf"]["paletteColors"]) . "\"";
       }
       ...
       elseif (1 < sizeof($arr_series) || 'Radar' == $tipo || 'Step' == $arr_param['linha_forma'] || $is_combinat)
       {
           ...
           foreach ($arr_series as $arr_serie)
           {
               ...
               if ($is_combinat)
               {
                   ...
                   {
                       $readeras = " renderas=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['comb_field_display_type'][ ($arr_serie['summ_idx'] + 1) ] . "\"";
                   }
...
<?php
   ...
   function grafico_flash_chart($width, $height, $sFileLocal, $export, $arr_charts, $isPDF = 'N')
   {
      ...
      if ($_SESSION['scriptcase']['phantomjs_charts'] && "Y" == $isPDF)
      {
          ...
          $sPhantomCmd  = 'phantomjs "' . $this->Ini->root . $_SESSION['scriptcase']['grid_inventario']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js"';
          $iJsDelay     = 150;
          if ('win' != $aOS['os'])
          {
   ...
   {
       $fPhantomChart = @fopen($this->Ini->root . $_SESSION['scriptcase']['grid_inventario']['glo_nm_path_imag_temp'] . '/sc_pjs_php_' . $sTmpId . '.php', 'w');
   ...
   function getChartRenderer($bMulti, $bComb)
   {
       ...
       {
           $tmp_count = 0;
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_order'] as $i_sum)
           {
               if ('' != $i_sum && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display'][$i_sum]))
               {
                   $d_sum = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display'][$i_sum];
                   if ($d_sum['display'])
                   {
                       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_control'] as $l_field => $d_field)
                       {
