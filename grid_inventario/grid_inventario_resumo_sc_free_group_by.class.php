...
class grid_inventario_resumo
{
   ...
   var $array_total_colores;
   var $array_total_tallas;
   var $array_total_sabor;
   var $array_total_idcombo;
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['fecha'] = $this->array_total_fecha;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['tipo'] = $this->array_total_tipo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['detalle'] = $this->array_total_detalle;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['colores'] = $this->array_total_colores;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['tallas'] = $this->array_total_tallas;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['sabor'] = $this->array_total_sabor;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['idcombo'] = $this->array_total_idcombo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['arr_total']['grupo'] = $this->array_total_grupo;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['fecha'] = $Lab_fecha; 
       $prep_field['idpro'] = $Lab_idpro;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['idpro'] = $Lab_idpro; 
       $prep_field['idbod'] = $Lab_idbod;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['idbod'] = $Lab_idbod; 
       $prep_field['tipo'] = $Lab_tipo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['tipo'] = $Lab_tipo; 
       $prep_field['detalle'] = $Lab_detalle;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['detalle'] = $Lab_detalle; 
       $prep_field['colores'] = $Lab_colores;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['colores'] = $Lab_colores; 
       $prep_field['tallas'] = $Lab_tallas;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['tallas'] = $Lab_tallas; 
       $prep_field['sabor'] = $Lab_sabor;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['sabor'] = $Lab_sabor; 
       $prep_field['idcombo'] = $Lab_idcombo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['idcombo'] = $Lab_idcombo; 
       $prep_field['grupo'] = $Lab_grupo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['labels']['grupo'] = $Lab_grupo; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['idpro']['alin'] = "''";
       $Arr_parms['idpro']['link'] = "S";
       $Arr_parms['idbod']['alin'] = "''";
       $Arr_parms['idbod']['link'] = "S";
       $Arr_parms['tipo']['alin'] = "''";
       $Arr_parms['tipo']['link'] = "S";
       $Arr_parms['detalle']['alin'] = "''";
       $Arr_parms['detalle']['link'] = "S";
       $Arr_parms['colores']['alin'] = "''";
       $Arr_parms['colores']['link'] = "S";
       $Arr_parms['tallas']['alin'] = "''";
       $Arr_parms['tallas']['link'] = "S";
       $Arr_parms['sabor']['alin'] = "''";
       $Arr_parms['sabor']['link'] = "S";
       $Arr_parms['idcombo']['alin'] = "''";
       $Arr_parms['idcombo']['link'] = "S";
       ...
       $Arr_parms['idpro']['fill'] = "true";
       $Arr_parms['idpro']['order'] = "label";
       $Arr_parms['idpro']['order_start'] = 'asc';
       $Arr_parms['idpro']['order_invert'] = 'false';
       $Arr_parms['idpro']['order_enabled'] = 'false';
       $Arr_parms['idbod']['fill'] = "true";
       $Arr_parms['idbod']['order'] = "label";
       $Arr_parms['idbod']['order_start'] = 'asc';
       $Arr_parms['idbod']['order_invert'] = 'false';
       $Arr_parms['idbod']['order_enabled'] = 'false';
       ...
       $Arr_parms['colores']['fill'] = "true";
       $Arr_parms['colores']['order'] = "label";
       $Arr_parms['colores']['order_start'] = 'asc';
       $Arr_parms['colores']['order_invert'] = 'false';
       $Arr_parms['colores']['order_enabled'] = 'false';
       $Arr_parms['tallas']['fill'] = "true";
       $Arr_parms['tallas']['order'] = "label";
       $Arr_parms['tallas']['order_start'] = 'asc';
       $Arr_parms['tallas']['order_invert'] = 'false';
       $Arr_parms['tallas']['order_enabled'] = 'false';
       $Arr_parms['sabor']['fill'] = "true";
       $Arr_parms['sabor']['order'] = "label";
       $Arr_parms['sabor']['order_start'] = 'asc';
       $Arr_parms['sabor']['order_invert'] = 'false';
       $Arr_parms['sabor']['order_enabled'] = 'false';
       $Arr_parms['idcombo']['fill'] = "true";
       $Arr_parms['idcombo']['order'] = "label";
       $Arr_parms['idcombo']['order_start'] = 'asc';
       $Arr_parms['idcombo']['order_invert'] = 'false';
       $Arr_parms['idcombo']['order_enabled'] = 'false';
       ...
       $prep_links_fl['idpro'] = array(0 => 'idpro', 1 => '');
       $prep_links_fl['idbod'] = array(0 => 'idbod', 1 => '');
       $prep_links_fl['tipo'] = array(0 => 'tipo', 1 => '');
       $prep_links_fl['detalle'] = array(0 => 'detalle', 1 => '@aspass@');
       $prep_links_fl['colores'] = array(0 => 'colores', 1 => '');
       $prep_links_fl['tallas'] = array(0 => 'tallas', 1 => '');
       $prep_links_fl['sabor'] = array(0 => 'sabor', 1 => '');
       $prep_links_fl['idcombo'] = array(0 => 'idcombo', 1 => '');
       $prep_links_fl['grupo'] = array(0 => 'grupo', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'field_x'  => 'colores',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_colores)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'tallas',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_tallas)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'sabor',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_sabor)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
           ...
           '1' => array(
               ...
               'field_x'  => 'idcombo',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_idcombo)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '2' => array(
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_inventario/grid_inventario_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_valorparcial, $quebra_fecha, $quebra_idpro, $quebra_idbod, $quebra_tipo, $quebra_detalle, $quebra_colores, $quebra_tallas, $quebra_sabor, $quebra_idcombo, $quebra_grupo, $quebra_fecha_orig, $quebra_idpro_orig, $quebra_idbod_orig, $quebra_tipo_orig, $quebra_detalle_orig, $quebra_colores_orig, $quebra_tallas_orig, $quebra_sabor_orig, $quebra_idcombo_orig, $quebra_grupo_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          if (empty($sum_valorparcial)) {$sum_valorparcial = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_cantidad . ';
              $this->' . $arr_name . '[2] = ' . $sum_valorparcial . ';
              $this->' . $arr_name . '[3] = 1;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->colores_orig = $this->colores;
            $this->tallas_orig = $this->tallas;
            $this->sabor_orig = $this->sabor;
            $this->idcombo_orig = $this->idcombo;
            $this->grupo_orig = $this->grupo;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->valorparcial, $this->fecha, $this->idpro, $this->idbod, $this->tipo, $this->detalle, $this->colores, $this->tallas, $this->sabor, $this->idcombo, $this->grupo, $this->fecha_orig,  $this->idpro_orig,  $this->idbod_orig,  $this->tipo_orig,  $this->detalle_orig,  $this->colores_orig,  $this->tallas_orig,  $this->sabor_orig,  $this->idcombo_orig,  $this->grupo_orig);
            }
   }
//
