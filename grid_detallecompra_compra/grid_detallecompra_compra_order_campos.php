...
<?php
   ...
   $Ord_Cmp = new grid_detallecompra_compra_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallecompra_compra_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["idpro"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["colores"] : "Colores";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["tallas"] : "Tallas";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['vencimiento'] = "on";
   $tab_def_campos['vencimiento'] = "vencimiento";
   $tab_labels["vencimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["vencimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["vencimiento"] : "Vencimiento";
   $tab_ger_campos['lote'] = "on";
   $tab_def_campos['lote'] = "lote";
   $tab_labels["lote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["lote"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["lote"] : "Lote";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["idbod"] : "Bodega";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["valorunit"] : "Valor/U";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["valorpar"] : "Parcial";
   $tab_ger_campos['tasaiva'] = "on";
   $tab_def_campos['tasaiva'] = "tasaiva";
   $tab_labels["tasaiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["tasaiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["tasaiva"] : "IVA";
   $tab_ger_campos['tasadesc'] = "on";
   $tab_def_campos['tasadesc'] = "tasadesc";
   $tab_labels["tasadesc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["tasadesc"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['labels']["tasadesc"] : "Desc";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallecompra_compra_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallecompra_compra']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
