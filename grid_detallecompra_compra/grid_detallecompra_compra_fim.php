...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallecompra_compra"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallecompra_compra"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['detallecompra'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallecompra_compra</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallecompra_compra']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_detallecompra_compra' || $achou)
          {
