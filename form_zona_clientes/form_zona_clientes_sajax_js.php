  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_zona_clientes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_zona_clientes_form();
	}
  ...
  // ---------- Validate idzona_cliente_
  function do_ajax_form_zona_clientes_validate_idzona_cliente_(iNumLinha)
  {
    var nomeCampo_idzona_cliente_ = "idzona_cliente_" + iNumLinha;
    var var_idzona_cliente_ = scAjaxGetFieldHidden(nomeCampo_idzona_cliente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_zona_clientes_validate_idzona_cliente_(var_idzona_cliente_, iNumLinha, var_script_case_init, do_ajax_form_zona_clientes_validate_idzona_cliente__cb);
  } // do_ajax_form_zona_clientes_validate_idzona_cliente_

  function do_ajax_form_zona_clientes_validate_idzona_cliente__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idzona_cliente_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idzona_cliente_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idzona_cliente_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idzona_cliente_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_zona_clientes_validate_idzona_cliente__cb

  // ---------- Validate codigo_
  function do_ajax_form_zona_clientes_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_zona_clientes_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_zona_clientes_validate_codigo__cb);
  } // do_ajax_form_zona_clientes_validate_codigo_

  function do_ajax_form_zona_clientes_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_zona_clientes_validate_codigo__cb

  // ---------- Validate codigo_dep_
  function do_ajax_form_zona_clientes_validate_codigo_dep_(iNumLinha)
  {
  } // do_ajax_form_zona_clientes_validate_codigo_dep_

  function do_ajax_form_zona_clientes_validate_codigo_dep__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_dep_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_dep_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigo_dep_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_dep_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_zona_clientes_validate_codigo_dep__cb

  // ---------- Validate codigo_mun_
  function do_ajax_form_zona_clientes_validate_codigo_mun_(iNumLinha)
  {
  } // do_ajax_form_zona_clientes_validate_codigo_mun_

  function do_ajax_form_zona_clientes_validate_codigo_mun__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_mun_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_mun_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigo_mun_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_mun_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_zona_clientes_validate_codigo_mun__cb

  // ---------- Validate nombre_
  function do_ajax_form_zona_clientes_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldHidden(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_zona_clientes_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_zona_clientes_validate_nombre__cb);
  } // do_ajax_form_zona_clientes_validate_nombre_

  function do_ajax_form_zona_clientes_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_zona_clientes_validate_nombre__cb

  // ---------- Validate resolucion_
  function do_ajax_form_zona_clientes_validate_resolucion_(iNumLinha)
  {
    var nomeCampo_resolucion_ = "resolucion_" + iNumLinha;
    var var_resolucion_ = scAjaxGetFieldSelect(nomeCampo_resolucion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_zona_clientes_validate_resolucion_(var_resolucion_, iNumLinha, var_script_case_init, do_ajax_form_zona_clientes_validate_resolucion__cb);
  } // do_ajax_form_zona_clientes_validate_resolucion_

  function do_ajax_form_zona_clientes_validate_resolucion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "resolucion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "resolucion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "resolucion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "resolucion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_zona_clientes_validate_resolucion__cb

  // ---------- Event onchange codigo_dep_
  function do_ajax_form_zona_clientes_event_codigo_dep__onchange(iSeqForm)
  {
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_zona_clientes_event_codigo_dep__onchange(var_script_case_init, var_nmgp_refresh_row, do_ajax_form_zona_clientes_event_codigo_dep__onchange_cb);
  } // do_ajax_form_zona_clientes_event_codigo_dep__onchange

  function do_ajax_form_zona_clientes_event_codigo_dep__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_zona_clientes_event_codigo_dep__onchange_cb_after_alert);
  } // do_ajax_form_zona_clientes_event_codigo_dep__onchange_cb
  function do_ajax_form_zona_clientes_event_codigo_dep__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_zona_clientes_event_codigo_dep__onchange_cb_after_alert

  // ---------- Event onchange codigo_mun_
  function do_ajax_form_zona_clientes_event_codigo_mun__onchange(iSeqForm)
  {
    var var_codigo_mun_ = scAjaxGetFieldText("id_ac_codigo_mun_" + iSeqForm);
    var var_codigo_dep_ = scAjaxGetFieldText("id_ac_codigo_dep_" + iSeqForm);
    var var_nombre_ = scAjaxGetFieldHidden("nombre_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_zona_clientes_event_codigo_mun__onchange(var_codigo_mun_, var_codigo_dep_, var_nombre_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_zona_clientes_event_codigo_mun__onchange_cb);
  } // do_ajax_form_zona_clientes_event_codigo_mun__onchange

  function do_ajax_form_zona_clientes_event_codigo_mun__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_zona_clientes_event_codigo_mun__onchange_cb_after_alert);
  } // do_ajax_form_zona_clientes_event_codigo_mun__onchange_cb
  function do_ajax_form_zona_clientes_event_codigo_mun__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_zona_clientes_event_codigo_mun__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_zona_clientes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_zona_clientes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_zona_clientes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_zona_clientes_add_new_line_cb);
  } // do_ajax_form_zona_clientes_add_new_line

  function do_ajax_form_zona_clientes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_zona_clientes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_zona_clientes_backup_line(iNumLinha)
  {
    var var_idzona_cliente_ = scAjaxGetFieldHidden("idzona_cliente_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_zona_clientes_backup_line(var_idzona_cliente_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_zona_clientes_backup_line_cb);
  } // do_ajax_form_zona_clientes_backup_line

  function do_ajax_form_zona_clientes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_zona_clientes_backup_line_cb

  function do_ajax_form_zona_clientes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_zona_clientes_cancel_insert

  function do_ajax_form_zona_clientes_cancel_update(iSeqVert)
  {
    do_ajax_form_zona_clientes_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_zona_clientes_cancel_update

  function do_ajax_form_zona_clientes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_zona_clientes_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_zona_clientes_table_refresh()
  {
    var var_idzona_cliente_ = document.F2.idzona_cliente_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_zona_clientes_table_refresh(var_idzona_cliente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_zona_clientes_table_refresh_cb);
  } //  do_ajax_form_zona_clientes_table_refresh

  function do_ajax_form_zona_clientes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idzona_cliente_.value = scAjaxGetKeyValue("idzona_cliente_");
    ...
    scAjaxAlert(do_ajax_form_zona_clientes_table_refresh_cb_after_alert);
  } // do_ajax_form_zona_clientes_table_refresh_cb
  function do_ajax_form_zona_clientes_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_zona_clientes_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_zona_clientes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_zona_clientes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_codigo_dep_ = scAjaxGetFieldText("codigo_dep_" + iNumLinha);
    var var_codigo_mun_ = scAjaxGetFieldText("codigo_mun_" + iNumLinha);
    var var_nombre_ = scAjaxGetFieldHidden("nombre_" + iNumLinha);
    var var_resolucion_ = scAjaxGetFieldSelect("resolucion_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_zona_clientes_submit_form(var_idzona_cliente_, var_codigo_, var_codigo_dep_, var_codigo_mun_, var_nombre_, var_resolucion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_zona_clientes_submit_form_cb);
  } // do_ajax_form_zona_clientes_submit_form

  function do_ajax_form_zona_clientes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idzona_cliente_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_dep_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_mun_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("resolucion_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_zona_clientes_submit_form_cb_after_alert);
  } // do_ajax_form_zona_clientes_submit_form_cb
  function do_ajax_form_zona_clientes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_zona_clientes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_zona_clientes_navigate_form()
  {
    perform_ajax_form_zona_clientes_navigate_form();
  }

  function perform_ajax_form_zona_clientes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_zona_clientes_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idzona_cliente_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_dep_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_mun_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("resolucion_" + iNavForm);
    }
    var var_idzona_cliente_ = document.F2.idzona_cliente_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_zona_clientes_navigate_form(var_idzona_cliente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_zona_clientes_navigate_form_cb);
  } // do_ajax_form_zona_clientes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_zona_clientes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_zona_clientes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idzona_cliente_.value = scAjaxGetKeyValue("idzona_cliente_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_zona_clientes_navigate_form_cb_after_alert);
  } // do_ajax_form_zona_clientes_navigate_form_cb
  function do_ajax_form_zona_clientes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_zona_clientes_navigate_form_cb_after_alert
  function sc_hide_form_zona_clientes_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idzona_cliente_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_dep_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_mun_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "resolucion_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idzona_cliente_" + iNumLinha] = {"label": "Idzona Cliente<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_" + iNumLinha] = {"label": "Codigo Zona<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_dep_" + iNumLinha] = {"label": "Departamento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_mun_" + iNumLinha] = {"label": "Ciudad o Municipio<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_" + iNumLinha] = {"label": "Nombre zona<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["resolucion_" + iNumLinha] = {"label": "Prefijo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idzona_cliente_"][iNumLinha] = "idzona_cliente_" + iNumLinha;
    ajax_field_mult["codigo_"][iNumLinha] = "codigo_" + iNumLinha;
    ajax_field_mult["codigo_dep_"][iNumLinha] = "codigo_dep_" + iNumLinha;
    ajax_field_mult["codigo_mun_"][iNumLinha] = "codigo_mun_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["resolucion_"][iNumLinha] = "resolucion_" + iNumLinha;
    ajax_field_id["codigo_" + iNumLinha] = new Array("hidden_field_label_codigo_", "hidden_field_data_codigo_" + iNumLinha);
    ajax_field_id["codigo_dep_" + iNumLinha] = new Array("hidden_field_label_codigo_dep_", "hidden_field_data_codigo_dep_" + iNumLinha);
    ajax_field_id["codigo_mun_" + iNumLinha] = new Array("hidden_field_label_codigo_mun_", "hidden_field_data_codigo_mun_" + iNumLinha);
    ajax_field_id["nombre_" + iNumLinha] = new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_" + iNumLinha);
    ajax_field_id["resolucion_" + iNumLinha] = new Array("hidden_field_label_resolucion_", "hidden_field_data_resolucion_" + iNumLinha);
    ajax_error_count["idzona_cliente_" + iNumLinha] = "off";
    ajax_error_count["codigo_" + iNumLinha] = "off";
    ajax_error_count["codigo_dep_" + iNumLinha] = "off";
    ajax_error_count["codigo_mun_" + iNumLinha] = "off";
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["resolucion_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idzona_cliente_" + iNumLinha] = "on";
    ajax_read_only["codigo_" + iNumLinha] = "off";
    ajax_read_only["codigo_dep_" + iNumLinha] = "off";
    ajax_read_only["codigo_mun_" + iNumLinha] = "off";
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["resolucion_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["codigo_dep_" + iNumLinha] = "on";
    ajax_read_only["codigo_mun_" + iNumLinha] = "on";
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["resolucion_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idzona_cliente_" + iNumLinha] = null;
    ajax_error_list["codigo_" + iNumLinha] = null;
    ajax_error_list["codigo_dep_" + iNumLinha] = null;
    ajax_error_list["codigo_mun_" + iNumLinha] = null;
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["resolucion_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idzona_cliente_": new Array(),
    "codigo_": new Array(),
    "codigo_dep_": new Array(),
    "codigo_mun_": new Array(),
    "nombre_": new Array(),
    "resolucion_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idzona_cliente_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idzona_cliente_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idzona_cliente_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idzona_cliente_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idzona_cliente_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["codigo_dep_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_dep_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_dep_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_dep_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_dep_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["codigo_mun_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_mun_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_mun_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_mun_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_mun_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["resolucion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["resolucion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["resolucion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["resolucion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["resolucion_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_codigo_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idzona_cliente_'])) ? $this->nmgp_cmp_readonly['idzona_cliente_'] : 'on';
?>
    scAjaxFieldRead("idzona_cliente_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_dep_'])) ? $this->nmgp_cmp_readonly['codigo_dep_'] : 'off';
?>
    scAjaxFieldRead("codigo_dep_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_mun_'])) ? $this->nmgp_cmp_readonly['codigo_mun_'] : 'off';
?>
    scAjaxFieldRead("codigo_mun_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['resolucion_'])) ? $this->nmgp_cmp_readonly['resolucion_'] : 'off';
?>
    scAjaxFieldRead("resolucion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idzona_cliente_" + iSeq, "on");
    scAjaxFieldRead("codigo_" + iSeq, "on");
    scAjaxFieldRead("codigo_dep_" + iSeq, "on");
    scAjaxFieldRead("codigo_mun_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("resolucion_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idzona_cliente_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["codigo_dep_" + iRow] || "on" == ajax_error_count["codigo_mun_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["resolucion_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idzona_cliente_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_dep_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_mun_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_resolucion_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idzona_cliente_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["codigo_dep_" + iRow] && "off" == ajax_error_count["codigo_mun_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["resolucion_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idzona_cliente_" + iRow] = "off";
        ajax_error_count["codigo_" + iRow] = "off";
        ajax_error_count["codigo_dep_" + iRow] = "off";
        ajax_error_count["codigo_mun_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["resolucion_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idzona_cliente_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_dep_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_mun_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_resolucion_" + iRow).removeClass("scFormErrorLine");
    }
  }
