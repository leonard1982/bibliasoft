  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_mov_inv_fisico_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_mov_inv_fisico_mob_form();
	}
...
?>
  ...
  // ---------- Validate prefijonota
  function do_ajax_form_mov_inv_fisico_mob_validate_prefijonota()
  {
    var nomeCampo_prefijonota = "prefijonota";
    var var_prefijonota = scAjaxGetFieldSelect(nomeCampo_prefijonota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_prefijonota(var_prefijonota, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_prefijonota_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_prefijonota

  function do_ajax_form_mov_inv_fisico_mob_validate_prefijonota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijonota";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_prefijonota_cb

  // ---------- Validate numeronota
  function do_ajax_form_mov_inv_fisico_mob_validate_numeronota()
  {
    var nomeCampo_numeronota = "numeronota";
    var var_numeronota = scAjaxGetFieldText(nomeCampo_numeronota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_numeronota(var_numeronota, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_numeronota_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_numeronota

  function do_ajax_form_mov_inv_fisico_mob_validate_numeronota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numeronota";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_numeronota_cb

  // ---------- Validate idtipotran
  function do_ajax_form_mov_inv_fisico_mob_validate_idtipotran()
  {
    var nomeCampo_idtipotran = "idtipotran";
    var var_idtipotran = scAjaxGetFieldSelect(nomeCampo_idtipotran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_idtipotran(var_idtipotran, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_idtipotran_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_idtipotran

  function do_ajax_form_mov_inv_fisico_mob_validate_idtipotran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipotran";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_idtipotran_cb

  // ---------- Validate fecha
  function do_ajax_form_mov_inv_fisico_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_fecha_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_fecha

  function do_ajax_form_mov_inv_fisico_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_fecha_cb

  // ---------- Validate idboddes
  function do_ajax_form_mov_inv_fisico_mob_validate_idboddes()
  {
    var nomeCampo_idboddes = "idboddes";
    var var_idboddes = scAjaxGetFieldSelect(nomeCampo_idboddes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_idboddes(var_idboddes, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_idboddes_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_idboddes

  function do_ajax_form_mov_inv_fisico_mob_validate_idboddes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idboddes";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_idboddes_cb

  // ---------- Validate observaciones
  function do_ajax_form_mov_inv_fisico_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_observaciones_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_observaciones

  function do_ajax_form_mov_inv_fisico_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_observaciones_cb

  // ---------- Validate detalle
  function do_ajax_form_mov_inv_fisico_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_detalle_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_detalle

  function do_ajax_form_mov_inv_fisico_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_detalle_cb

  // ---------- Validate idmov
  function do_ajax_form_mov_inv_fisico_mob_validate_idmov()
  {
    var nomeCampo_idmov = "idmov";
    var var_idmov = scAjaxGetFieldHidden(nomeCampo_idmov);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_idmov(var_idmov, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_idmov_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_idmov

  function do_ajax_form_mov_inv_fisico_mob_validate_idmov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmov";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_idmov_cb

  // ---------- Validate idpro
  function do_ajax_form_mov_inv_fisico_mob_validate_idpro()
  {
    var nomeCampo_idpro = "idpro";
    var var_idpro = scAjaxGetFieldText(nomeCampo_idpro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_idpro(var_idpro, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_idpro_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_idpro

  function do_ajax_form_mov_inv_fisico_mob_validate_idpro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_idpro_cb

  // ---------- Validate cantidad
  function do_ajax_form_mov_inv_fisico_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_cantidad_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_cantidad

  function do_ajax_form_mov_inv_fisico_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_cantidad_cb

  // ---------- Validate idbodorig
  function do_ajax_form_mov_inv_fisico_mob_validate_idbodorig()
  {
    var nomeCampo_idbodorig = "idbodorig";
    var var_idbodorig = scAjaxGetFieldText(nomeCampo_idbodorig);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_idbodorig(var_idbodorig, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_idbodorig_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_idbodorig

  function do_ajax_form_mov_inv_fisico_mob_validate_idbodorig_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbodorig";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_idbodorig_cb

  // ---------- Validate tallas
  function do_ajax_form_mov_inv_fisico_mob_validate_tallas()
  {
    var nomeCampo_tallas = "tallas";
    var var_tallas = scAjaxGetFieldText(nomeCampo_tallas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_tallas(var_tallas, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_tallas_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_tallas

  function do_ajax_form_mov_inv_fisico_mob_validate_tallas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tallas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_tallas_cb

  // ---------- Validate colores
  function do_ajax_form_mov_inv_fisico_mob_validate_colores()
  {
    var nomeCampo_colores = "colores";
    var var_colores = scAjaxGetFieldText(nomeCampo_colores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_colores(var_colores, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_colores_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_colores

  function do_ajax_form_mov_inv_fisico_mob_validate_colores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "colores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_colores_cb

  // ---------- Validate sabor
  function do_ajax_form_mov_inv_fisico_mob_validate_sabor()
  {
    var nomeCampo_sabor = "sabor";
    var var_sabor = scAjaxGetFieldText(nomeCampo_sabor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_mov_inv_fisico_mob_validate_sabor(var_sabor, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_validate_sabor_cb);
  } // do_ajax_form_mov_inv_fisico_mob_validate_sabor

  function do_ajax_form_mov_inv_fisico_mob_validate_sabor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sabor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_validate_sabor_cb

  // ---------- Refresh idpro
  function do_ajax_form_mov_inv_fisico_mob_refresh_idpro()
  {
    var var_idpro = scAjaxGetFieldText("idpro");
    var var_nmgp_refresh_fields = "idbodorig";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_inv_fisico_mob_refresh_idpro(var_idpro, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_refresh_idpro_cb);
  } // do_ajax_form_mov_inv_fisico_mob_refresh_idpro

  function do_ajax_form_mov_inv_fisico_mob_refresh_idpro_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_mov_inv_fisico_mob_refresh_idpro_cb

  // ---------- Event onchange idboddes
  function do_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange()
  {
    var var_idmov = scAjaxGetFieldHidden("idmov");
    var var_idboddes = scAjaxGetFieldSelect("idboddes");
    var var_idbodorig = scAjaxGetFieldText("idbodorig");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange(var_idmov, var_idboddes, var_idbodorig, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange_cb);
  } // do_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange

  function do_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idboddes";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange_cb_after_alert);
  } // do_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange_cb
  function do_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_mov_inv_fisico_mob_event_idboddes_onchange_cb_after_alert

  // ---------- Event onfocus idboddes
  function do_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus()
  {
    var var_idboddes = scAjaxGetFieldSelect("idboddes");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus(var_idboddes, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus_cb);
  } // do_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus

  function do_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idboddes";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus_cb_after_alert);
  } // do_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus_cb
  function do_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_mov_inv_fisico_mob_event_idboddes_onfocus_cb_after_alert

  // ---------- Event onchange prefijonota
  function do_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange()
  {
    var var_idmov = scAjaxGetFieldHidden("idmov");
    var var_prefijonota = scAjaxGetFieldSelect("prefijonota");
    var var_numeronota = scAjaxGetFieldText("numeronota");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange(var_idmov, var_prefijonota, var_numeronota, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange_cb);
  } // do_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange

  function do_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijonota";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange_cb_after_alert);
  } // do_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange_cb
  function do_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_mov_inv_fisico_mob_event_prefijonota_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_mov_inv_fisico_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_mov_inv_fisico_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_prefijonota = scAjaxGetFieldSelect("prefijonota");
    ...
    var var_idbodorig = scAjaxGetFieldText("idbodorig");
    var var_tallas = scAjaxGetFieldText("tallas");
    var var_colores = scAjaxGetFieldText("colores");
    var var_sabor = scAjaxGetFieldText("sabor");
    ...
    scAjaxProcOn();
    x_ajax_form_mov_inv_fisico_mob_submit_form(var_prefijonota, var_numeronota, var_idtipotran, var_fecha, var_idboddes, var_observaciones, var_idmov, var_idpro, var_cantidad, var_idbodorig, var_tallas, var_colores, var_sabor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_mov_inv_fisico_mob_submit_form_cb);
  } // do_ajax_form_mov_inv_fisico_mob_submit_form

  function do_ajax_form_mov_inv_fisico_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_mov_inv_fisico_mob_submit_form_cb_after_alert);
  } // do_ajax_form_mov_inv_fisico_mob_submit_form_cb
  function do_ajax_form_mov_inv_fisico_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_mov_inv_fisico_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_inventario_fisico_mob"] = "off";

  function do_ajax_form_mov_inv_fisico_mob_navigate_form()
  {
    perform_ajax_form_mov_inv_fisico_mob_navigate_form();
  }

  function perform_ajax_form_mov_inv_fisico_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_inventario_fisico_mob"] = "on";
    x_ajax_form_mov_inv_fisico_mob_navigate_form(var_idmov, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_mov_inv_fisico_mob_navigate_form_cb);
  } // do_ajax_form_mov_inv_fisico_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_mov_inv_fisico_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_mov_inv_fisico_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_inventario_fisico_mob"] && "nmsc_iframe_liga_form_inventario_fisico_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_inventario_fisico_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_inventario_fisico_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_inventario_fisico_mob').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_inventario_fisico_mob').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_inventario_fisico_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_mov_inv_fisico_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_mov_inv_fisico_mob_navigate_form_cb
  function do_ajax_form_mov_inv_fisico_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('fecha');
...
{
?>
    do_ajax_form_mov_inv_fisico_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_mov_inv_fisico_mob_navigate_form_cb_after_alert
  function sc_hide_form_mov_inv_fisico_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_inventario_fisico_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "prefijonota";
  ajax_field_list[1] = "numeronota";
  ajax_field_list[2] = "idtipotran";
  ajax_field_list[3] = "fecha";
  ajax_field_list[4] = "idboddes";
  ajax_field_list[5] = "observaciones";
  ajax_field_list[6] = "detalle";
  ajax_field_list[7] = "idmov";
  ajax_field_list[8] = "idpro";
  ajax_field_list[9] = "cantidad";
  ajax_field_list[10] = "idbodorig";
  ajax_field_list[11] = "tallas";
  ajax_field_list[12] = "colores";
  ajax_field_list[13] = "sabor";
  ...
  var ajax_error_list = {
    ...
    "numeronota": {"label": "NÚMERO NOTA:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idtipotran": {"label": "CONCEPTO AJUSTE:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha": {"label": "FECHA:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idboddes": {"label": "LUGAR INVENTARIO:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idmov": {"label": "MOV", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tallas": {"label": "Tallas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "colores": {"label": "Colores", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "prefijonota": new Array(),
    "numeronota": new Array(),
  ...
  var ajax_field_id = {
    "prefijonota": new Array("hidden_field_label_prefijonota", "hidden_field_data_prefijonota"),
    "numeronota": new Array("hidden_field_label_numeronota", "hidden_field_data_numeronota"),
    "idtipotran": new Array("hidden_field_label_idtipotran", "hidden_field_data_idtipotran"),
    "fecha": new Array("hidden_field_label_fecha", "hidden_field_data_fecha"),
    "idboddes": new Array("hidden_field_label_idboddes", "hidden_field_data_idboddes"),
