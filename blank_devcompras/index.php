<?php
   include_once('blank_devcompras_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_devcompras']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_devcompras_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_devcompras"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20190322"; 
      $this->nm_hr_criacao   = "082839"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_devcompras']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_devcompras']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_devcompras']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_devcompras';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_devcompras']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_devcompras']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_devcompras']['actual_lang']) || $_SESSION['scriptcase']['blank_devcompras']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_devcompras']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_devcompras_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_devcompras"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_devcompras"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_devcompras']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_devcompras']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_devcompras']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blank_devcompras_erro.class.php"); 
      $this->Erro = new blank_devcompras_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_devcompras'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_devcompras']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_devcompras']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_devcompras']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_devcompras']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_devcompras']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_devcompras']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_devcompras']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_devcompras']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_devcompras']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['embutida_init']) 
      {
          if (!isset($_SESSION['gPIdcompra'])) 
          {
              $this->nm_falta_var .= "gPIdcompra; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_devcompras']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_devcompras']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_devcompras_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_devcompras']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_devcompras']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_devcompras']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_devcompras'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_devcompras']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_devcompras']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_devcompras') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_devcompras']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_devcompras']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_devcompras']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_devcompras']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_devcompras_erro.class.php"); 
      $this->Erro      = new blank_devcompras_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['blank_devcompras']['contr_erro'] = 'on';
if (!isset($_SESSION['gPIdcompra'])) {$_SESSION['gPIdcompra'] = "";}
if (!isset($this->sc_temp_gPIdcompra)) {$this->sc_temp_gPIdcompra = (isset($_SESSION['gPIdcompra'])) ? $_SESSION['gPIdcompra'] : "";}
 $idCompra=$this->sc_temp_gPIdcompra;
$vNfac='';
$vFec='';
$vFven='';
$vIdT='';
...
$vND='';
      ...
      { 
          $nm_select = "select * from facturacom where idfaccom=$idCompra"; 
      }
...
if($this->ds_fc[0][0]>0)
	{
	$vNfac=$this->ds_fc[0][1];
	$vFec=$this->ds_fc[0][3];
	$vFven=$this->ds_fc[0][4];
	$vIdT=$this->ds_fc[0][5];
	$vND=$this->ds_fc[0][22];
	 
      $nm_select = "select documento, nombres from terceros where idtercero=$vIdT"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dt_ter = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
;
	$vElProv.=$this->dt_ter[0][0].' - '.$this->dt_ter[0][1];
	$vSub=$this->ds_fc[0][6];
	$vIVA=$this->ds_fc[0][7];
	$vTotal=$this->ds_fc[0][8];
...
$vIVA= number_format($vIVA,0,",",".");
$vSub= number_format($vSub,0,",",".");

$vproducto=""; $vcantidad=""; $vunit="";$vdesc=''; $vparcial=""; $viva_u='';
$vcolor='';$vtalla=''; $vsabor=''; $fec_venci=''; $lote=''; $vserial='';
 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_select = "select idpro, cantidad, valorunit, valorpar, iva, descuento, str_replace (convert(char(10),vencimiento,102), '.', '-') + ' ' + convert(char(8),vencimiento,20), lote, serial_codbarra from detallecompra where num_ndevolucion=$idCompra"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select idpro, cantidad, valorunit, valorpar, iva, descuento, convert(char(23),vencimiento,121), lote, serial_codbarra from detallecompra where num_ndevolucion=$idCompra"; 
      }
      else
      { 
          $nm_select = "select idpro, cantidad, valorunit, valorpar, iva, descuento, vencimiento, lote, serial_codbarra from detallecompra where num_ndevolucion=$idCompra"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
...
<html>
	<head>
		...
		<body>
		  <div class="ticket">
	<p class="centrado">NOTA DEVOLUCION <?php echo " No.: ",$vND;?>
    <p class="centrado">COMPRA AFECTADA <?php echo " No.: ",$vNfac;?>
      <!--br>Registrado con FacilWeb
      <breaseing@outlook.com, www.solucionesnavarro.com-->
	  <br><br><?php echo "PROVEEDOR: ", $vElProv;?>
		<br><?php  echo "FECHA DE DEVOLUCION: ",$vFec;?>
		<br><?php  echo "FECHA DE LA COMPRA: ",$vFven;?>
		<br><?php  ?>
	 </p>
    <table>
      <thead>
     <tr> <td WIDTH="370" 
	   		 HEIGHT="20"> <font face="arial black" size=3>
				<?php echo "Descripción del Producto";?></font> </td>
		 <td WIDTH="80" 
	   		 HEIGHT="20"> <font face="arial black" size=3>
				<?php echo "Cantidad";?></font> </td>
		 <td WIDTH="80" 
	   		 HEIGHT="20"> <font face="arial black" size=3>
				<?php echo "$ Cos.  Unit.";?></font> </td>
		 <td WIDTH="115" 
	   		 HEIGHT="20"> <font face="arial black" size=3>
				<?php echo "$ Des.  Unit.";?></font> </td>
		 <td WIDTH="80" 
	   		 HEIGHT="20"> <font face="arial black" size=3>
				<?php echo "$ Subt.";?></font> </td>
         <!-- <th class="cantidad">&nbsp  &nbsp Artículo </th>
          <th class="producto">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Cant. </th>
          <th class="precio">&nbsp $$ Unit.</th>
		  <th class="desc">&nbsp $$ DescxUn.</th>
		  <th class="sub">&nbsp &nbsp $$ V. Par.</th> -->
        </tr>
      </thead>
		<?php
		...
		foreach($this->ds  as $ads)
			{
			 $vproducto.=$ads[0]; 
      $nm_select = "select nompro from productos where idprod=$vproducto"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
			 $vproducto=substr($this->des , 6);
			 $vproducto.=$ads[6].'  '.$ads[7].' '.$ads[8];
			 $vcantidad.=$ads[1];
			 $vunit.=$ads[2];
			 $vdesc.=$ads[5];
			 $vparcial.=$ads[3];
			 $vcantidad= number_format($vcantidad,2,",",".");
			 $vunit= number_format($vunit,0,",",".");
			 $vparcial= number_format($vparcial,0,",",".");
			 $vdesc= number_format($vdesc,0,",",".");
		     ?>
		<table>
	 	  <tr>
          	<td WIDTH="400" 
	   		 HEIGHT="20"><font face="arial" size=2>
				<?php echo $vproducto, " "; $vproducto="";?></font>
			</td>
			<td WIDTH="60" 
	   		 HEIGHT="20"><font face="arial" size=2>
				<?php echo " ", $vcantidad," "; $vcantidad="";?></font>
			</td>  
			<!--</td>-->
			<td WIDTH="100" 
	   		 HEIGHT="20"><font face="arial" size=2>
				<?php echo " $", $vunit, " "; $vunit="";?></font>
			</td>
			  
			<td WIDTH="90" 
	   		 HEIGHT="20"><font face="arial" size=2>
				<?php echo " $", $vdesc, " "; $vdesc="";?></font>
			</td>
			
			<td WIDTH="60" 
	   		 HEIGHT="20"><font face="arial" size=2>
				<?php echo " $", $vparcial; $vparcial="";?></font>
			</td> 
         </tr>
        </table>
		...
		<p><br>Subtotal: $<?php echo $vSub;?><!--muestra totales y demas-->
			<br>IVA: $<?php echo $vIVA;?>
			<br>Total: $<?php echo $vTotal;?>
	        
		<p> </p>
		<p> ____________________________________________________________________</p>
    
    </table>
    <p class="centrado"><?php echo "  ";?><!--br¡GRACIAS POR SU COMPRA!-->
		<br>facilweb@solucionesnavarro.com
      <br>easeing@outlook.com 
	 <br>Cúcuta - Colombia</p>
...
<?php
if (isset($this->sc_temp_gPIdcompra)) {$_SESSION['gPIdcompra'] = $this->sc_temp_gPIdcompra;}
$_SESSION['scriptcase']['blank_devcompras']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_devcompras($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_devcompras']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_devcompras") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_devcompras']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['blank_devcompras']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   if (isset($_POST["gPIdcompra"])) 
   {
       $_SESSION["gPIdcompra"] = $_POST["gPIdcompra"];
       nm_limpa_str_blank_devcompras($_SESSION["gPIdcompra"]);
   }
   if (!isset($_POST["gPIdcompra"]) && isset($_POST["gpidcompra"])) 
   {
       $_SESSION["gPIdcompra"] = $_POST["gpidcompra"];
       nm_limpa_str_blank_devcompras($_SESSION["gPIdcompra"]);
   }
   if (isset($_GET["gPIdcompra"])) 
   {
       $_SESSION["gPIdcompra"] = $_GET["gPIdcompra"];
       nm_limpa_str_blank_devcompras($_SESSION["gPIdcompra"]);
   }
   if (!isset($_GET["gPIdcompra"]) && isset($_GET["gpidcompra"])) 
   {
       $_SESSION["gPIdcompra"] = $_GET["gpidcompra"];
       nm_limpa_str_blank_devcompras($_SESSION["gPIdcompra"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_devcompras']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_devcompras']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_devcompras']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_devcompras";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_devcompras' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_devcompras']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_devcompras']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_devcompras']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_devcompras']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_devcompras']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_devcompras' == $sReferer || 'blank_devcompras_' == substr($sReferer, 0, 17))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_devcompras']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_devcompras')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_devcompras']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_devcompras']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_devcompras_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_devcompras($cadapar[1]);
       ...
       if (!isset($gPIdcompra) && isset($gpidcompra)) 
       {
           $_SESSION["gPIdcompra"] = $gpidcompra;
       }
       if (isset($gPIdcompra)) 
       {
           $_SESSION['gPIdcompra'] = $gPIdcompra;
   ...
   $contr_blank_devcompras = new blank_devcompras_apl();
   $contr_blank_devcompras->controle();
//
   function nm_limpa_str_blank_devcompras(&$str)
   {
