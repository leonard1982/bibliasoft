<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_facturaven_resp_30072018']['sc_process_barr'] = true;
require_once('../pdfreport_facturaven_resp_30072018/index.php');
unset($_SESSION['scriptcase']['pdfreport_facturaven_resp_30072018']['sc_process_barr']);
$ExportCtrl = new pdfreport_facturaven_resp_30072018_export_control;
$ExportCtrl->Export_barr();

class pdfreport_facturaven_resp_30072018_export_control
{
