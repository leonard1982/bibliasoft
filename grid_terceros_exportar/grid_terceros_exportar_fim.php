...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_exportar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_exportar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_terceros_exportar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['embutida_filho'] as $ind => $sc_init)
          {
