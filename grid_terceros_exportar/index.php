...
// 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/grid_terceros_exportar';
...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_terceros_exportar']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "grid_terceros_exportar/grid_terceros_exportar_erro.class.php"); 
      } 
      else 
      { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "grid_terceros_exportar/grid_terceros_exportar_lookup.class.php"); 
      } 
      else 
      { 
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['campos_busca']      = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['grid_pesq']         = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['Grid_search']       = "";
...
//----------------------------------->
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_terceros_exportar/grid_terceros_exportar_xls.class.php"); 
          } 
          else 
          { 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_terceros_exportar/grid_terceros_exportar_xml.class.php"); 
          } 
          else 
          { 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_terceros_exportar/grid_terceros_exportar_json.class.php"); 
          } 
          else 
          { 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_terceros_exportar/grid_terceros_exportar_csv.class.php"); 
          } 
          else 
          { 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . grid_terceros_exportar . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_terceros_exportar/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_exportar']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_terceros_exportar/grid_terceros_exportar_grid.class.php"); 
          } 
          else 
          { 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_terceros_exportar']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_terceros_exportar']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['grid_terceros_exportar']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/grid_terceros_exportar/'))
   {
       $_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['initialize'] = true;
   }
   else
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_terceros_exportar']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
