...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_categoria_' + iSeqRow).bind('blur', function() { sc_form_presupuesto_categorias_id_categoria__onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_presupuesto_categorias_id_categoria__onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_presupuesto_categorias_id_categoria__onfocus(this, iSeqRow) });
  $('#id_sc_field_descripcion_' + iSeqRow).bind('blur', function() { sc_form_presupuesto_categorias_descripcion__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_presupuesto_categorias_descripcion__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_presupuesto_categorias_descripcion__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_presupuesto_categorias_id_categoria__onblur(oThis, iSeqRow) {
  do_ajax_form_presupuesto_categorias_validate_id_categoria_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_presupuesto_categorias_id_categoria__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_presupuesto_categorias_id_categoria__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_presupuesto_categorias_descripcion__onblur(oThis, iSeqRow) {
  do_ajax_form_presupuesto_categorias_validate_descripcion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_presupuesto_categorias_descripcion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_presupuesto_categorias_descripcion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_form_presupuesto_categorias_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_presupuesto_categorias')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
