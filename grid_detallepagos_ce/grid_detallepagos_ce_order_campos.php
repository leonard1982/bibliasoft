...
<?php
   ...
   $Ord_Cmp = new grid_detallepagos_ce_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallepagos_ce_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idfp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["idfp"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["idfp"] : "Forma de pago";
   $tab_ger_campos['monto'] = "on";
   $tab_def_campos['monto'] = "monto";
   $tab_labels["monto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["monto"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["monto"] : "Monto";
   $tab_ger_campos['banco'] = "on";
   $tab_def_campos['banco'] = "banco";
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["banco"] : "Banco";
   $tab_ger_campos['numcheque'] = "on";
   $tab_def_campos['numcheque'] = "numcheque";
   $tab_labels["numcheque"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["numcheque"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["numcheque"] : "Numero cheque";
   $tab_ger_campos['fechacob'] = "on";
   $tab_def_campos['fechacob'] = "fechacob";
   $tab_labels["fechacob"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["fechacob"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['labels']["fechacob"] : "Fecha del cheque";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallepagos_ce_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallepagos_ce']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
