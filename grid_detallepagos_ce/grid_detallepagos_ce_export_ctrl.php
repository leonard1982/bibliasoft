<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallepagos_ce']['sc_process_barr'] = true;
require_once('../grid_detallepagos_ce/index.php');
unset($_SESSION['scriptcase']['grid_detallepagos_ce']['sc_process_barr']);
$ExportCtrl = new grid_detallepagos_ce_export_control;
$ExportCtrl->Export_barr();

class grid_detallepagos_ce_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_detallepagos_ce']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_detallepagos_ce']['glo_nm_path_imag_temp'];
