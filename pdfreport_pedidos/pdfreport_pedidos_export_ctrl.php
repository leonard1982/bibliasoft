<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_pedidos']['sc_process_barr'] = true;
require_once('../pdfreport_pedidos/index.php');
unset($_SESSION['scriptcase']['pdfreport_pedidos']['sc_process_barr']);
$ExportCtrl = new pdfreport_pedidos_export_control;
$ExportCtrl->Export_barr();

class pdfreport_pedidos_export_control
{
