...
class pdfreport_pedidos_grid
{
   ...
   var $detalleventa_fl_adicional1 = array();
   var $detalleventa_fl_factor = array();
   var $detalleventa_fl_idbod = array();
   var $detalleventa_fl_iddet = array();
   var $detalleventa_fl_idpedid = array();
   var $detalleventa_fl_iva = array();
   var $detalleventa_fl_unidadmayor = array();
   var $detalleventa_idpro = array();
   var $detalleventa_j_nompro = array();
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_pedidos']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_pedidos", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   { 
       ...
       $this->fechavenc[0] = $Busca_temp['fechavenc']; 
       $tmp_pos = strpos($this->fechavenc[0], "##@@");
       if ($tmp_pos !== false && !is_array($this->fechavenc[0]))
       {
           $this->fechavenc[0] = substr($this->fechavenc[0], 0, $tmp_pos);
       }
       $fechavenc_2 = $Busca_temp['fechavenc_input_2']; 
       $this->fechavenc_2 = $Busca_temp['fechavenc_input_2']; 
       $this->detalleventa[0] = $Busca_temp['detalleventa']; 
       $tmp_pos = strpos($this->detalleventa[0], "##@@");
       if ($tmp_pos !== false && !is_array($this->detalleventa[0]))
       {
           $this->detalleventa[0] = substr($this->detalleventa[0], 0, $tmp_pos);
       }
   } 
   else 
   { 
...
$_SESSION['scriptcase']['pdfreport_pedidos']['contr_erro'] = 'off'; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_pedidos']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_pedidos']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_pedidos']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_pedidos']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_orig'] = " where idpedido=" . $_SESSION['par_numero'] . "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_pesq_filtro'] = "";
   }   
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['order_grid'] = $nmgp_order_by;
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['idpedido'] = "idpedido";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['credito'] = "Credito";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['fechaven'] = "Fechaven";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['fechavenc'] = "Fechavenc";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['idcli'] = "Idcli";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['subtotal'] = "Subtotal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['valoriva'] = "Valoriva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['total'] = "Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['facturado'] = "Facturado";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['asentada'] = "Asentada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['observaciones'] = "Observaciones";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['saldo'] = "Saldo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['adicional'] = "Adicional";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['adicional2'] = "Adicional 2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['adicional3'] = "Adicional 3";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa'] = "detalleventa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_cantidad'] = "Cantidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_fl_adicional'] = "Adicional";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_fl_adicional1'] = "Adicional 1";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_fl_factor'] = "Factor";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_fl_idbod'] = "Idbod";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_fl_iddet'] = "Iddet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_fl_idpedid'] = "Idpedid";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_fl_iva'] = "Iva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_fl_unidadmayor'] = "Unidadmayor";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_idpro'] = "Idpro";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_j_nompro'] = "Nompro";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_parcial'] = "Parcial";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_unidad'] = "Unidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['detalleventa_valorunita'] = "Valorunita";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['direccion'] = "direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['documento'] = "documento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['empresa'] = "empresa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['etiqueta'] = "etiqueta";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['fechares'] = "fechares";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['ladireccion'] = "ladireccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['municipio'] = "municipio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['numnit'] = "numnit";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['numtele'] = "numtele";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['prefijo'] = "prefijo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['rangofac'] = "rangofac";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['resolucion'] = "resolucion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['labels']['telefono'] = "telefono";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_pedidos']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_pedidos']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_pedidos']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf->AddPage();
      $this->Pdf_init();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['qt_col_grid']) 
      {  
          ...
          $this->credito[$this->nm_grid_colunas] = $this->rs_grid->fields[1] ;  
          $this->credito[$this->nm_grid_colunas] = (string)$this->credito[$this->nm_grid_colunas];
          $this->fechaven[$this->nm_grid_colunas] = $this->rs_grid->fields[2] ;  
          $this->fechavenc[$this->nm_grid_colunas] = $this->rs_grid->fields[3] ;  
          $this->idcli[$this->nm_grid_colunas] = $this->rs_grid->fields[4] ;  
          $this->idcli[$this->nm_grid_colunas] = (string)$this->idcli[$this->nm_grid_colunas];
          $this->subtotal[$this->nm_grid_colunas] = $this->rs_grid->fields[5] ;  
          ...
          $this->valoriva[$this->nm_grid_colunas] = $this->rs_grid->fields[6] ;  
          ...
          $this->total[$this->nm_grid_colunas] = $this->rs_grid->fields[7] ;  
          ...
          $this->facturado[$this->nm_grid_colunas] = $this->rs_grid->fields[8] ;  
          $this->asentada[$this->nm_grid_colunas] = $this->rs_grid->fields[9] ;  
          $this->asentada[$this->nm_grid_colunas] = (string)$this->asentada[$this->nm_grid_colunas];
          $this->observaciones[$this->nm_grid_colunas] = $this->rs_grid->fields[10] ;  
          $this->saldo[$this->nm_grid_colunas] = $this->rs_grid->fields[11] ;  
          ...
          $this->adicional[$this->nm_grid_colunas] = $this->rs_grid->fields[12] ;  
          ...
          $this->adicional2[$this->nm_grid_colunas] = $this->rs_grid->fields[13] ;  
          ...
          $this->adicional3[$this->nm_grid_colunas] = $this->rs_grid->fields[14] ;  
          ...
          $this->detalleventa_fl_adicional1[$this->nm_grid_colunas] = array();
          $this->detalleventa_fl_factor[$this->nm_grid_colunas] = array();
          $this->detalleventa_fl_idbod[$this->nm_grid_colunas] = array();
          $this->detalleventa_fl_iddet[$this->nm_grid_colunas] = array();
          $this->detalleventa_fl_idpedid[$this->nm_grid_colunas] = array();
          ...
          $this->detalleventa_j_nompro[$this->nm_grid_colunas] = array();
          ...
          $this->Lookup->lookup_detalleventa($this->detalleventa[$this->nm_grid_colunas] , $this->idpedido[$this->nm_grid_colunas], $array_detalleventa); 
          $NM_ind = 0;
          $this->detalleventa = array();
          foreach ($array_detalleventa as $cada_subselect) 
          {
              $this->detalleventa[$this->nm_grid_colunas][$NM_ind] = "";
              $this->detalleventa_fl_iddet[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[0];
              $this->detalleventa_fl_idpedid[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[1];
              $this->detalleventa_idpro[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[2];
              $this->detalleventa_j_nompro[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[3];
              ...
              $this->detalleventa_fl_idbod[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[9];
              $this->detalleventa_cantidad[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[10];
              $this->detalleventa_fl_iva[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[11];
              $this->detalleventa_fl_adicional[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[12];
              $this->detalleventa_fl_adicional1[$this->nm_grid_colunas][$NM_ind] = $cada_subselect[13];
              $NM_ind++;
          }
...
$this->etiqueta[$this->nm_grid_colunas] ="Descuento aplicado"; 
      ...
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->des[$this->nm_grid_colunas] = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->des[$this->nm_grid_colunas] = false;
...
;
$this->resolucion[$this->nm_grid_colunas] =" Res.DIAN ".substr($this->des[$this->nm_grid_colunas] , 10);
...
;
$this->rangofac[$this->nm_grid_colunas] ="Rango Autorizado: ".substr($this->des[$this->nm_grid_colunas] , 8);
...
;
$this->fechares[$this->nm_grid_colunas] ="Vigencia ".substr($this->des[$this->nm_grid_colunas] , 5);
...
;
$this->prefijo[$this->nm_grid_colunas] =substr($this->des[$this->nm_grid_colunas] , 7);
$_SESSION['scriptcase']['pdfreport_pedidos']['contr_erro'] = 'off';
          ...
          $this->nm_gera_mask($this->idpedido[$this->nm_grid_colunas], "xxx"); 
          ...
          foreach ($this->detalleventa_fl_adicional1[$this->nm_grid_colunas] as $NM_ind => $Dados) 
          {
          if ($this->detalleventa_fl_adicional1[$this->nm_grid_colunas][$NM_ind] === "") 
          { 
              $this->detalleventa_fl_adicional1[$this->nm_grid_colunas][$NM_ind] = "" ;  
          } 
          else    
          { 
              nmgp_Form_Num_Val($this->detalleventa_fl_adicional1[$this->nm_grid_colunas][$NM_ind], $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
              $this->detalleventa_fl_adicional1[$this->nm_grid_colunas][$NM_ind] = $this->SC_conv_utf8($this->detalleventa_fl_adicional1[$this->nm_grid_colunas][$NM_ind]);
          }
          ...
          foreach ($this->detalleventa_fl_idbod[$this->nm_grid_colunas] as $NM_ind => $Dados) 
          {
          if ($this->detalleventa_fl_idbod[$this->nm_grid_colunas][$NM_ind] === "") 
          { 
              $this->detalleventa_fl_idbod[$this->nm_grid_colunas][$NM_ind] = "" ;  
          } 
          else    
          { 
              nmgp_Form_Num_Val($this->detalleventa_fl_idbod[$this->nm_grid_colunas][$NM_ind], $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
              $this->detalleventa_fl_idbod[$this->nm_grid_colunas][$NM_ind] = $this->SC_conv_utf8($this->detalleventa_fl_idbod[$this->nm_grid_colunas][$NM_ind]);
          }
          foreach ($this->detalleventa_fl_iddet[$this->nm_grid_colunas] as $NM_ind => $Dados) 
          {
          if ($this->detalleventa_fl_iddet[$this->nm_grid_colunas][$NM_ind] === "") 
          { 
              $this->detalleventa_fl_iddet[$this->nm_grid_colunas][$NM_ind] = "" ;  
          } 
          else    
          { 
              nmgp_Form_Num_Val($this->detalleventa_fl_iddet[$this->nm_grid_colunas][$NM_ind], $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
              $this->detalleventa_fl_iddet[$this->nm_grid_colunas][$NM_ind] = $this->SC_conv_utf8($this->detalleventa_fl_iddet[$this->nm_grid_colunas][$NM_ind]);
          }
          foreach ($this->detalleventa_fl_idpedid[$this->nm_grid_colunas] as $NM_ind => $Dados) 
          {
          if ($this->detalleventa_fl_idpedid[$this->nm_grid_colunas][$NM_ind] === "") 
          { 
              $this->detalleventa_fl_idpedid[$this->nm_grid_colunas][$NM_ind] = "" ;  
          } 
          else    
          { 
              nmgp_Form_Num_Val($this->detalleventa_fl_idpedid[$this->nm_grid_colunas][$NM_ind], $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
              $this->detalleventa_fl_idpedid[$this->nm_grid_colunas][$NM_ind] = $this->SC_conv_utf8($this->detalleventa_fl_idpedid[$this->nm_grid_colunas][$NM_ind]);
          }
          ...
          foreach ($this->detalleventa_j_nompro[$this->nm_grid_colunas] as $NM_ind => $Dados) 
          {
          if ($this->detalleventa_j_nompro[$this->nm_grid_colunas][$NM_ind] === "") 
          { 
              $this->detalleventa_j_nompro[$this->nm_grid_colunas][$NM_ind] = "" ;  
          } 
              $this->detalleventa_j_nompro[$this->nm_grid_colunas][$NM_ind] = $this->SC_conv_utf8($this->detalleventa_j_nompro[$this->nm_grid_colunas][$NM_ind]);
          }
          ...
          { 
            ...
            $cell_observaciones = array('posx' => 5, 'posy' => 118, 'data' => $this->observaciones[$this->nm_grid_colunas], 'width'      => 90, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_empresa = array('posx' => 10, 'posy' => 4, 'data' => $this->SC_conv_utf8('' . $_SESSION['pdfreport_pedidos']['empresa_nombre'] . ''), 'width'      => 140, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_numnit = array('posx' => 10, 'posy' => 7, 'data' => $this->SC_conv_utf8('' . $_SESSION['pdfreport_pedidos']['nit'] . ''), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_ladireccion = array('posx' => 10, 'posy' => 10, 'data' => $this->SC_conv_utf8('' . $_SESSION['pdfreport_pedidos']['direccion1'] . ''), 'width'      => 100, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_numtele = array('posx' => 10, 'posy' => 13, 'data' => $this->SC_conv_utf8('' . $_SESSION['pdfreport_pedidos']['telefono1'] . ''), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_detalleventa_unidad = array('posx' => 16, 'posy' => 57.5, 'data' => $this->detalleventa_unidad[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Helvetica', 'font_size'  => 7, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_detalleventa_j_nompro = array('posx' => 30, 'posy' => 57, 'data' => $this->detalleventa_j_nompro[$this->nm_grid_colunas], 'width'      => 80, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_pedidonumero = array('posx' => 180, 'posy' => 8, 'data' => $this->idpedido[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Helvetica', 'font_size'  => 14, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
...
{
	$this->Pdf->Image('../_lib/img/Remision_proforma_pedido_SIMPLIFICADO.png',1,1,216, 279, 'png');
}
else
{
	$this->Pdf->Image("../_lib/img/Remision_proforma_pedido.png", 1, 1, 216, 279, 'png', '', '', false, 300, '', false, false, 0);
}
            ...
            foreach ($this->detalleventa[$this->nm_grid_colunas] as $NM_ind => $Dados)
            {
                ...
                $this->Pdf->SetFont($cell_detalleventa_j_nompro['font_type'], $cell_detalleventa_j_nompro['font_style'], $cell_detalleventa_j_nompro['font_size']);
                if (!empty($cell_detalleventa_j_nompro['posx']))
                {
                    $this->Pdf->SetX($cell_detalleventa_j_nompro['posx']);
                }
                $atu_X = $this->Pdf->GetX();
                $atu_Y = $this->Pdf->GetY();
                $this->Pdf->SetTextColor($cell_detalleventa_j_nompro['color_r'], $cell_detalleventa_j_nompro['color_g'], $cell_detalleventa_j_nompro['color_b']);
                $this->Pdf->writeHTMLCell($cell_detalleventa_j_nompro['width'], 0, $atu_X, $atu_Y, $this->detalleventa_j_nompro[$this->nm_grid_colunas][$NM_ind], 0, 0, false, true, $cell_detalleventa_j_nompro['align']);
                $this->Pdf->SetY($atu_Y);
                if (!isset($max_Y) || empty($max_Y) || $this->Pdf->GetY() < $max_Y )
                {
                    $max_Y = $this->Pdf->GetY();
            ...
            $this->Pdf->SetFont($cell_pedidonumero['font_type'], $cell_pedidonumero['font_style'], $cell_pedidonumero['font_size']);
            $this->pdf_text_color($cell_pedidonumero['data'], $cell_pedidonumero['color_r'], $cell_pedidonumero['color_g'], $cell_pedidonumero['color_b']);
            if (!empty($cell_pedidonumero['posx']) && !empty($cell_pedidonumero['posy']))
            {
                $this->Pdf->SetXY($cell_pedidonumero['posx'], $cell_pedidonumero['posy']);
            }
            elseif (!empty($cell_pedidonumero['posx']))
            {
                $this->Pdf->SetX($cell_pedidonumero['posx']);
            }
            elseif (!empty($cell_pedidonumero['posy']))
            {
                $this->Pdf->SetY($cell_pedidonumero['posy']);
            }
            $this->Pdf->Cell($cell_pedidonumero['width'], 0, $cell_pedidonumero['data'], 0, 0, $cell_pedidonumero['align']);
