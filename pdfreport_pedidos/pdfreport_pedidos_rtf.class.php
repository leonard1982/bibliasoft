...
class pdfreport_pedidos_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['SC_Ind_Groupby'];
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_pedidos.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['pdfreport_pedidos']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['rtf_name']);
      }
...
$_SESSION['scriptcase']['pdfreport_pedidos']['contr_erro'] = 'off'; 
   ...
   {
             nmgp_Form_Num_Val($this->detalleventa_fl_adicional1, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         $this->detalleventa_fl_adicional1 = NM_charset_to_utf8($this->detalleventa_fl_adicional1);
         $this->detalleventa_fl_adicional1 = str_replace('<', '&lt;', $this->detalleventa_fl_adicional1);
         $this->detalleventa_fl_adicional1 = str_replace('>', '&gt;', $this->detalleventa_fl_adicional1);
         $this->Texto_tag .= "<td>" . $this->detalleventa_fl_adicional1 . "</td>\r\n";
   }
   ...
   {
             nmgp_Form_Num_Val($this->detalleventa_fl_idbod, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         $this->detalleventa_fl_idbod = NM_charset_to_utf8($this->detalleventa_fl_idbod);
         $this->detalleventa_fl_idbod = str_replace('<', '&lt;', $this->detalleventa_fl_idbod);
         $this->detalleventa_fl_idbod = str_replace('>', '&gt;', $this->detalleventa_fl_idbod);
         $this->Texto_tag .= "<td>" . $this->detalleventa_fl_idbod . "</td>\r\n";
   }
   ...
   {
             nmgp_Form_Num_Val($this->detalleventa_fl_idpedid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
         $this->detalleventa_fl_idpedid = NM_charset_to_utf8($this->detalleventa_fl_idpedid);
         $this->detalleventa_fl_idpedid = str_replace('<', '&lt;', $this->detalleventa_fl_idpedid);
         $this->detalleventa_fl_idpedid = str_replace('>', '&gt;', $this->detalleventa_fl_idpedid);
         $this->Texto_tag .= "<td>" . $this->detalleventa_fl_idpedid . "</td>\r\n";
   }
   //----- detalleventa_fl_iva
   ...
   function NM_export_detalleventa_j_nompro()
   {
         ...
         $this->detalleventa_j_nompro = str_replace('<', '&lt;', $this->detalleventa_j_nompro);
         $this->detalleventa_j_nompro = str_replace('>', '&gt;', $this->detalleventa_j_nompro);
         $this->Texto_tag .= "<td>" . $this->detalleventa_j_nompro . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
