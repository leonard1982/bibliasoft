  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_terceros_contratos_motivoscorte" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_terceros_contratos_motivoscorte_form();
	}
...
?>
  ...
  // ---------- Validate id_motivo_
  function do_ajax_form_terceros_contratos_motivoscorte_validate_id_motivo_(iNumLinha)
  {
    var nomeCampo_id_motivo_ = "id_motivo_" + iNumLinha;
    var var_id_motivo_ = scAjaxGetFieldHidden(nomeCampo_id_motivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contratos_motivoscorte_validate_id_motivo_(var_id_motivo_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contratos_motivoscorte_validate_id_motivo__cb);
  } // do_ajax_form_terceros_contratos_motivoscorte_validate_id_motivo_

  function do_ajax_form_terceros_contratos_motivoscorte_validate_id_motivo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_motivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_motivo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_motivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_motivo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contratos_motivoscorte_validate_id_motivo__cb

  // ---------- Validate codigo_motivo_
  function do_ajax_form_terceros_contratos_motivoscorte_validate_codigo_motivo_(iNumLinha)
  {
    var nomeCampo_codigo_motivo_ = "codigo_motivo_" + iNumLinha;
    var var_codigo_motivo_ = scAjaxGetFieldText(nomeCampo_codigo_motivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contratos_motivoscorte_validate_codigo_motivo_(var_codigo_motivo_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contratos_motivoscorte_validate_codigo_motivo__cb);
  } // do_ajax_form_terceros_contratos_motivoscorte_validate_codigo_motivo_

  function do_ajax_form_terceros_contratos_motivoscorte_validate_codigo_motivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_motivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_motivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigo_motivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_motivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contratos_motivoscorte_validate_codigo_motivo__cb

  // ---------- Validate descripcion_motivo_
  function do_ajax_form_terceros_contratos_motivoscorte_validate_descripcion_motivo_(iNumLinha)
  {
    var nomeCampo_descripcion_motivo_ = "descripcion_motivo_" + iNumLinha;
    var var_descripcion_motivo_ = scAjaxGetFieldText(nomeCampo_descripcion_motivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contratos_motivoscorte_validate_descripcion_motivo_(var_descripcion_motivo_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contratos_motivoscorte_validate_descripcion_motivo__cb);
  } // do_ajax_form_terceros_contratos_motivoscorte_validate_descripcion_motivo_

  function do_ajax_form_terceros_contratos_motivoscorte_validate_descripcion_motivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descripcion_motivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descripcion_motivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descripcion_motivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descripcion_motivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contratos_motivoscorte_validate_descripcion_motivo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_terceros_contratos_motivoscorte_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_terceros_contratos_motivoscorte_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_terceros_contratos_motivoscorte_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_terceros_contratos_motivoscorte_add_new_line_cb);
  } // do_ajax_form_terceros_contratos_motivoscorte_add_new_line

  function do_ajax_form_terceros_contratos_motivoscorte_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_terceros_contratos_motivoscorte_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_terceros_contratos_motivoscorte_backup_line(iNumLinha)
  {
    var var_id_motivo_ = scAjaxGetFieldHidden("id_motivo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contratos_motivoscorte_backup_line(var_id_motivo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_terceros_contratos_motivoscorte_backup_line_cb);
  } // do_ajax_form_terceros_contratos_motivoscorte_backup_line

  function do_ajax_form_terceros_contratos_motivoscorte_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_terceros_contratos_motivoscorte_backup_line_cb

  function do_ajax_form_terceros_contratos_motivoscorte_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_terceros_contratos_motivoscorte_cancel_insert

  function do_ajax_form_terceros_contratos_motivoscorte_cancel_update(iSeqVert)
  {
    do_ajax_form_terceros_contratos_motivoscorte_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_terceros_contratos_motivoscorte_cancel_update

  function do_ajax_form_terceros_contratos_motivoscorte_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_terceros_contratos_motivoscorte_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_terceros_contratos_motivoscorte_table_refresh()
  {
    var var_id_motivo_ = document.F2.id_motivo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_contratos_motivoscorte_table_refresh(var_id_motivo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_contratos_motivoscorte_table_refresh_cb);
  } //  do_ajax_form_terceros_contratos_motivoscorte_table_refresh

  function do_ajax_form_terceros_contratos_motivoscorte_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_motivo_.value = scAjaxGetKeyValue("id_motivo_");
    ...
    scAjaxAlert(do_ajax_form_terceros_contratos_motivoscorte_table_refresh_cb_after_alert);
  } // do_ajax_form_terceros_contratos_motivoscorte_table_refresh_cb
  function do_ajax_form_terceros_contratos_motivoscorte_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_terceros_contratos_motivoscorte_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_terceros_contratos_motivoscorte_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_terceros_contratos_motivoscorte_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_motivo_ = scAjaxGetFieldHidden("id_motivo_" + iNumLinha);
    var var_codigo_motivo_ = scAjaxGetFieldText("codigo_motivo_" + iNumLinha);
    var var_descripcion_motivo_ = scAjaxGetFieldText("descripcion_motivo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_terceros_contratos_motivoscorte_submit_form(var_id_motivo_, var_codigo_motivo_, var_descripcion_motivo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_terceros_contratos_motivoscorte_submit_form_cb);
  } // do_ajax_form_terceros_contratos_motivoscorte_submit_form

  function do_ajax_form_terceros_contratos_motivoscorte_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_motivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_motivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descripcion_motivo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_terceros_contratos_motivoscorte_submit_form_cb_after_alert);
  } // do_ajax_form_terceros_contratos_motivoscorte_submit_form_cb
  function do_ajax_form_terceros_contratos_motivoscorte_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_terceros_contratos_motivoscorte_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_terceros_contratos_motivoscorte_navigate_form()
  {
    perform_ajax_form_terceros_contratos_motivoscorte_navigate_form();
  }

  function perform_ajax_form_terceros_contratos_motivoscorte_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_terceros_contratos_motivoscorte_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_motivo_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_motivo_" + iNavForm);
      scAjaxHideErrorDisplay("descripcion_motivo_" + iNavForm);
    }
    var var_id_motivo_ = document.F2.id_motivo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_terceros_contratos_motivoscorte_navigate_form(var_id_motivo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_contratos_motivoscorte_navigate_form_cb);
  } // do_ajax_form_terceros_contratos_motivoscorte_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_contratos_motivoscorte']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_terceros_contratos_motivoscorte_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_motivo_.value = scAjaxGetKeyValue("id_motivo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_terceros_contratos_motivoscorte_navigate_form_cb_after_alert);
  } // do_ajax_form_terceros_contratos_motivoscorte_navigate_form_cb
  function do_ajax_form_terceros_contratos_motivoscorte_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_terceros_contratos_motivoscorte_navigate_form_cb_after_alert
  function sc_hide_form_terceros_contratos_motivoscorte_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_motivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_motivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_motivo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_motivo_" + iNumLinha] = {"label": "Id Motivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_motivo_" + iNumLinha] = {"label": "Código Motivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["descripcion_motivo_" + iNumLinha] = {"label": "Descripción Motivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_motivo_"][iNumLinha] = "id_motivo_" + iNumLinha;
    ajax_field_mult["codigo_motivo_"][iNumLinha] = "codigo_motivo_" + iNumLinha;
    ajax_field_mult["descripcion_motivo_"][iNumLinha] = "descripcion_motivo_" + iNumLinha;
    ajax_field_id["codigo_motivo_" + iNumLinha] = new Array("hidden_field_label_codigo_motivo_", "hidden_field_data_codigo_motivo_" + iNumLinha);
    ajax_field_id["descripcion_motivo_" + iNumLinha] = new Array("hidden_field_label_descripcion_motivo_", "hidden_field_data_descripcion_motivo_" + iNumLinha);
    ajax_error_count["id_motivo_" + iNumLinha] = "off";
    ajax_error_count["codigo_motivo_" + iNumLinha] = "off";
    ajax_error_count["descripcion_motivo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_motivo_" + iNumLinha] = "on";
    ajax_read_only["codigo_motivo_" + iNumLinha] = "off";
    ajax_read_only["descripcion_motivo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_motivo_" + iNumLinha] = "on";
    ajax_read_only["codigo_motivo_" + iNumLinha] = "on";
    ajax_read_only["descripcion_motivo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_motivo_" + iNumLinha] = null;
    ajax_error_list["codigo_motivo_" + iNumLinha] = null;
    ajax_error_list["descripcion_motivo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_motivo_": new Array(),
    "codigo_motivo_": new Array(),
    "descripcion_motivo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_motivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_motivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_motivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_motivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_motivo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["codigo_motivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_motivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_motivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_motivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_motivo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["descripcion_motivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descripcion_motivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descripcion_motivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descripcion_motivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descripcion_motivo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_motivo_'])) ? $this->nmgp_cmp_readonly['id_motivo_'] : 'on';
?>
    scAjaxFieldRead("id_motivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_motivo_'])) ? $this->nmgp_cmp_readonly['codigo_motivo_'] : 'off';
?>
    scAjaxFieldRead("codigo_motivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descripcion_motivo_'])) ? $this->nmgp_cmp_readonly['descripcion_motivo_'] : 'off';
?>
    scAjaxFieldRead("descripcion_motivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_motivo_" + iSeq, "on");
    scAjaxFieldRead("codigo_motivo_" + iSeq, "on");
    scAjaxFieldRead("descripcion_motivo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_motivo_" + iRow] || "on" == ajax_error_count["codigo_motivo_" + iRow] || "on" == ajax_error_count["descripcion_motivo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_motivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_motivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_motivo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_motivo_" + iRow] && "off" == ajax_error_count["codigo_motivo_" + iRow] && "off" == ajax_error_count["descripcion_motivo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_motivo_" + iRow] = "off";
        ajax_error_count["codigo_motivo_" + iRow] = "off";
        ajax_error_count["descripcion_motivo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_motivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_motivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_motivo_" + iRow).removeClass("scFormErrorLine");
    }
  }
