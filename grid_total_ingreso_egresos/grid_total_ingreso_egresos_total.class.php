...
class grid_total_ingreso_egresos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_total_ingreso_egresos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_total_ingreso_egresos']['campos_busca']))
      { 
