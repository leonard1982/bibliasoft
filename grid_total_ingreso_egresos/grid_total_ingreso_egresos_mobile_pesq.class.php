...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "month(fecha)";$Nm_numeric[] = "sum(if(cantidad>0,cantidad,0))";$Nm_numeric[] = "sum(if(cantidad<0,cantidad,0))";$Nm_numeric[] = "sum(cantidad)";$Nm_numeric[] = "month(fecha)";$Nm_numeric[] = "sum(if(cantidad>0,cantidad,0))";$Nm_numeric[] = "sum(if(cantidad<0,cantidad,0))";$Nm_numeric[] = "sum(cantidad)";
...
<?php
 ...
 ?>
<?php if (!isset($fecha)) {$fecha = explode("", $fecha);} ?>
 <SELECT class="scFilterObjectOdd" id="SC_fecha" name="fecha[]"  size="7" multiple>
 <OPTION value="1##@@ENERO" <?php if (in_array("1", $fecha)) { echo " selected" ;} ?>>ENERO</option>
 <OPTION value="2##@@FEBRERO" <?php if (in_array("2", $fecha)) { echo " selected" ;} ?>>FEBRERO</option>
 <OPTION value="3##@@MARZO" <?php if (in_array("3", $fecha)) { echo " selected" ;} ?>>MARZO</option>
 <OPTION value="4##@@ABRIL" <?php if (in_array("4", $fecha)) { echo " selected" ;} ?>>ABRIL</option>
 <OPTION value="5##@@MAYO" <?php if (in_array("5", $fecha)) { echo " selected" ;} ?>>MAYO</option>
 <OPTION value="6##@@JUNIO" <?php if (in_array("6", $fecha)) { echo " selected" ;} ?>>JUNIO</option>
 <OPTION value="7##@@JULIO" <?php if (in_array("7", $fecha)) { echo " selected" ;} ?>>JULIO</option>
 <OPTION value="8##@@AGOSTO" <?php if (in_array("8", $fecha)) { echo " selected" ;} ?>>AGOSTO</option>
 <OPTION value="9##@@SEPTIEMBRE" <?php if (in_array("9", $fecha)) { echo " selected" ;} ?>>SEPTIEMBRE</option>
 <OPTION value="10##@@OCTUBRE" <?php if (in_array("10", $fecha)) { echo " selected" ;} ?>>OCTUBRE</option>
 <OPTION value="11##@@NOVIEMBRE" <?php if (in_array("11", $fecha)) { echo " selected" ;} ?>>NOVIEMBRE</option>
 <OPTION value="12##@@DICIEMBRE" <?php if (in_array("12", $fecha)) { echo " selected" ;} ?>>DICIEMBRE</option>
 </SELECT>
 </TD>
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'fecha[]')
      {
