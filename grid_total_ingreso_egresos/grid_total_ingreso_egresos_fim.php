...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_total_ingreso_egresos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_total_ingreso_egresos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_total_ingreso_egresos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_total_ingreso_egresos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_total_ingreso_egresos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_total_ingreso_egresos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_total_ingreso_egresos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_total_ingreso_egresos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_total_ingreso_egresos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_total_ingreso_egresos']['embutida_filho'] as $ind => $sc_init)
          {
