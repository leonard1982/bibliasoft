...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_total_ingreso_egresos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_total_ingreso_egresos"]);
   }
