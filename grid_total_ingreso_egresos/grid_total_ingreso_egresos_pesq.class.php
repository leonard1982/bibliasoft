...
class grid_total_ingreso_egresos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
    ...
    {
      global $fecha_cond, $fecha;
      $_SESSION['scriptcase']['grid_total_ingreso_egresos']['contr_erro'] = 'on';
 $fecha  = date("m");
      ...
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_total_ingreso_egresos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_total_ingreso_egresos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_total_ingreso_egresos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Total Ingresos/Egresos/Periodo</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_total_ingreso_egresos/grid_total_ingreso_egresos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_total_ingreso_egresos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_total_ingreso_egresos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_total_ingreso_egresos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_total_ingreso_egresos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_total_ingreso_egresos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_fecha#NMF#' + search_get_Dselelect('SC_fecha_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Total Ingresos/Egresos/Periodo</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__document_pulse_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_total_ingreso_egresos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']['fecha']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']['fecha_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']['NM_operador']; 
      } 
      ...
      // fecha
      if (is_array($fecha) && !empty($fecha))
      {
         $tmp_array = array();
         $fecha_val_str = "";
         foreach ($fecha as $tmp_val_cmp)
         {
            if ("" != $fecha_val_str)
            {
               $fecha_val_str .= ",";
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fecha_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Periodo"; ?></TD>
      ...
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fecha" <?php echo $str_hide_fecha?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Periodo";
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "2";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "3";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "4";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "5";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "6";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "7";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "8";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "9";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "10";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "11";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'][] = "12";
 ?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_fecha_orig" name="fecha_orig" size=7 multiple onDblClick="nm_add_sel('fecha_orig', 'fecha_dest', 'N', '')">
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("1", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="1##@@ENERO" <?php echo $fecha_sel; ?>>ENERO</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("2", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="2##@@FEBRERO" <?php echo $fecha_sel; ?>>FEBRERO</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("3", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="3##@@MARZO" <?php echo $fecha_sel; ?>>MARZO</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("4", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="4##@@ABRIL" <?php echo $fecha_sel; ?>>ABRIL</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("5", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="5##@@MAYO" <?php echo $fecha_sel; ?>>MAYO</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("6", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="6##@@JUNIO" <?php echo $fecha_sel; ?>>JUNIO</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("7", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="7##@@JULIO" <?php echo $fecha_sel; ?>>JULIO</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("8", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="8##@@AGOSTO" <?php echo $fecha_sel; ?>>AGOSTO</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("9", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="9##@@SEPTIEMBRE" <?php echo $fecha_sel; ?>>SEPTIEMBRE</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("10", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="10##@@OCTUBRE" <?php echo $fecha_sel; ?>>OCTUBRE</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("11", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="11##@@NOVIEMBRE" <?php echo $fecha_sel; ?>>NOVIEMBRE</option>
<?php
    if (is_array($fecha) && !empty($fecha))
    {
        $fecha_sel = (in_array("12", $fecha)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="12##@@DICIEMBRE" <?php echo $fecha_sel; ?>>DICIEMBRE</option>
 </SELECT>
   </td>
   <td align="center">
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('fecha_orig', 'fecha_dest', 'N', '');", "nm_add_all('fecha_orig', 'fecha_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('fecha_orig', 'fecha_dest', 'N', '');", "nm_add_sel('fecha_orig', 'fecha_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('fecha_dest', 'fecha_orig', 'N', '');", "nm_del_sel('fecha_dest', 'fecha_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('fecha_dest', 'fecha_orig', 'N', '');", "nm_del_all('fecha_dest', 'fecha_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_fecha_dest" name="fecha_dest" size=7 multiple onDblClick="nm_del_sel('fecha_dest', 'fecha_orig', 'N', '')">"
<?php if (in_array("1", $fecha)) { ?> <OPTION value="1##@@ENERO" >ENERO</option>
<?php
      }
?>
<?php if (in_array("2", $fecha)) { ?> <OPTION value="2##@@FEBRERO" >FEBRERO</option>
<?php
      }
?>
<?php if (in_array("3", $fecha)) { ?> <OPTION value="3##@@MARZO" >MARZO</option>
<?php
      }
?>
<?php if (in_array("4", $fecha)) { ?> <OPTION value="4##@@ABRIL" >ABRIL</option>
<?php
      }
?>
<?php if (in_array("5", $fecha)) { ?> <OPTION value="5##@@MAYO" >MAYO</option>
<?php
      }
?>
<?php if (in_array("6", $fecha)) { ?> <OPTION value="6##@@JUNIO" >JUNIO</option>
<?php
      }
?>
<?php if (in_array("7", $fecha)) { ?> <OPTION value="7##@@JULIO" >JULIO</option>
<?php
      }
?>
<?php if (in_array("8", $fecha)) { ?> <OPTION value="8##@@AGOSTO" >AGOSTO</option>
<?php
      }
?>
<?php if (in_array("9", $fecha)) { ?> <OPTION value="9##@@SEPTIEMBRE" >SEPTIEMBRE</option>
<?php
      }
?>
<?php if (in_array("10", $fecha)) { ?> <OPTION value="10##@@OCTUBRE" >OCTUBRE</option>
<?php
      }
?>
<?php if (in_array("11", $fecha)) { ?> <OPTION value="11##@@NOVIEMBRE" >NOVIEMBRE</option>
<?php
      }
?>
<?php if (in_array("12", $fecha)) { ?> <OPTION value="12##@@DICIEMBRE" >DICIEMBRE</option>
<?php
      }
?>
    </select>
    <input type="hidden" id="SC_fecha" name="fecha" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.fecha_dest.selectedIndex = -1;</script>
...
<?php
   if (is_file("grid_total_ingreso_egresos_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['sc_modal'])
       {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_del_all('fecha_dest', 'fecha_orig', 'N', '');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_total_ingreso_egresos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_total_ingreso_egresos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $fecha_cond, $fecha, $nmgp_tab_label;
      ...
      if (is_array($fecha)) {
          foreach ($fecha as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['psq_check_ret']['fecha'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']['fecha'] = $fecha; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $this->cmp_formatado['fecha'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']['fecha'];
      $this->cmp_formatado['fecha_input_2'] = $fecha_input_2;
      ...
      if (is_array($fecha) && count($fecha) != 0)
      {
         foreach ($fecha as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($fecha_cond == "df" || $fecha_cond == "np")
         {
             $this->comando        .= " month(fecha) not in (";
             $this->comando_sum    .= " caja.month(fecha) not in (";
             $this->comando_filtro .= " month(fecha) not in (";
         }
         else
         {
             $this->comando        .= " month(fecha) in (";
             $this->comando_sum    .= " caja.month(fecha) in (";
             $this->comando_filtro .= " month(fecha) in (";
         }
         $x                     = count($fecha);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$fecha_cond]) ? $Lang_descr[$fecha_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $nmgp_tab_label['fecha'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($fecha) || $fecha_cond == "nu" || $fecha_cond == "nn" || $fecha_cond == "ep" || $fecha_cond == "ne")
      {
         $this->monta_condicao("month(fecha)", $fecha_cond, $fecha, "", "fecha");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_total_ingreso_egresos']['cond_pesq'] .= $this->NM_operador;
