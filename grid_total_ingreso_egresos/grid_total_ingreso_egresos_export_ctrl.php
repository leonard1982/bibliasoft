<?php
@session_start() ;
$_SESSION['scriptcase']['grid_total_ingreso_egresos']['sc_process_barr'] = true;
require_once('../grid_total_ingreso_egresos/index.php');
unset($_SESSION['scriptcase']['grid_total_ingreso_egresos']['sc_process_barr']);
$ExportCtrl = new grid_total_ingreso_egresos_export_control;
$ExportCtrl->Export_barr();

class grid_total_ingreso_egresos_export_control
{
