...
class grid_casos_vistacontrato_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_casos_vistacontrato']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_casos_vistacontrato']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $asignado_tercero;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['contr_total_geral'] = "OK";
   } 
   ...
   function quebra_fecha_sc_free_group_by($fecha, $Where_qb, $Cmp_Name) 
   {
      ...
      global $$Var_name_gb, $asignado_tercero;
      $tot_fecha = array() ;  
      $tot_fecha[0] = $fecha ; 
   }
   //-----  codigo_cliente
