...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_casos_vistacontrato"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_casos_vistacontrato"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_casos_vistacontrato']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_casos_vistacontrato']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_casos_vistacontrato']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_casos_vistacontrato']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_casos_vistacontrato']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_casos_vistacontrato</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_casos_vistacontrato']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_casos_vistacontrato']['embutida_filho'] as $ind => $sc_init)
          {
