...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_casos_vistacontrato"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_casos_vistacontrato"]);
   }
