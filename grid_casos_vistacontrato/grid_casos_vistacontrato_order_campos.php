<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_casos_vistacontrato_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_casos_vistacontrato_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["numero"] : "Caso";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_converte["estado"]   = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["estado"] : "Estado";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_converte["valor"]   = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["valor"] : "Valor";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_converte["observaciones"]   = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['imprimir'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['imprimir'] = "imprimir";
       $tab_converte["imprimir"]   = "imprimir";
   }
   else
   {
       $tab_def_campos['imprimir'] = "";
       $tab_converte[""]   = "imprimir";
   }
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['labels']["imprimir"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
function Sel_processa_form()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos;
   ...
   $str_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Grid_Facilweb_Detalle/Grid_Facilweb_Detalle";
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_casos_vistacontrato_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_casos_vistacontrato']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
