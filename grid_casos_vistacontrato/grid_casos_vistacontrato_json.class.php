...
class grid_casos_vistacontrato_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_casos_vistacontrato/grid_casos_vistacontrato_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_return']);
      ...
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_casos_vistacontrato.json";
...
$_SESSION['scriptcase']['grid_casos_vistacontrato']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_name']);
      }
...
$_SESSION['scriptcase']['grid_casos_vistacontrato']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_casos_vistacontrato_res_json.class.php");
              $this->Res = new grid_casos_vistacontrato_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_res_grid']);
          } 
      }
   ...
   function NM_export_codigo_cliente()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->codigo_cliente;
   }
   //----- prioridad
   function NM_export_prioridad()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->prioridad;
   }
   //----- tipo_caso
   function NM_export_tipo_caso()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tipo_caso;
   }
   //----- medio
   function NM_export_medio()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->medio;
   }
   //----- asignado_tercero
   function NM_export_asignado_tercero()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_asignado_tercero;
   }
   //----- fecha_asignacion
   function NM_export_fecha_asignacion()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fecha_asignacion;
   }
   //----- fecha_cierre
   ...
   function NM_export_cedula_tercero()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->cedula_tercero;
   }
   //----- notificado
   function NM_export_notificado()
   {
         $this->notificado = NM_charset_to_utf8($this->notificado);
         if ($this->Json_use_label)
         {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->notificado;
   }
   //----- notificar
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
