<?php
@session_start() ;
$_SESSION['scriptcase']['grid_casos_vistacontrato']['sc_process_barr'] = true;
require_once('../grid_casos_vistacontrato/index.php');
unset($_SESSION['scriptcase']['grid_casos_vistacontrato']['sc_process_barr']);
$ExportCtrl = new grid_casos_vistacontrato_export_control;
$ExportCtrl->Export_barr();

class grid_casos_vistacontrato_export_control
{
