...
class grid_casos_vistacontrato_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_codigo_cliente;
   var $array_total_estado;
   var $array_total_prioridad;
   var $array_total_tipo_caso;
   var $array_total_medio;
   var $array_total_asignado_tercero;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_codigo_cliente   = array();
      $this->array_total_estado           = array();
      $this->array_total_prioridad        = array();
      $this->array_total_tipo_caso        = array();
      $this->array_total_medio            = array();
      $this->array_total_asignado_tercero = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$this->Graf         = new grid_casos_vistacontrato_grafico();
		$this->Graf->Db     = $this->Db;
		$this->Graf->Erro   = $this->Erro;
		$this->Graf->Ini    = $this->Ini;
		$this->Graf->Lookup = $this->Lookup;

		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_casos_vistacontrato']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_casos_vistacontrato']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
...
$_SESSION['scriptcase']['grid_casos_vistacontrato']['contr_erro'] = 'off'; 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total']['fecha'] = $this->array_total_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total']['codigo_cliente'] = $this->array_total_codigo_cliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total']['estado'] = $this->array_total_estado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total']['prioridad'] = $this->array_total_prioridad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total']['tipo_caso'] = $this->array_total_tipo_caso;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total']['medio'] = $this->array_total_medio;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total']['asignado_tercero'] = $this->array_total_asignado_tercero;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['json_use_label'])
       {
          $Lab_fecha = "fecha";
          $Lab_codigo_cliente = "codigo_cliente";
          $Lab_estado = "estado";
          $Lab_prioridad = "prioridad";
          $Lab_tipo_caso = "tipo_caso";
          $Lab_medio = "medio";
          $Lab_asignado_tercero = "asignado_tercero";
       }
       else
       {
       $Lab_fecha = "Fecha";
       $Lab_codigo_cliente = "Cod/Cliente";
       $Lab_estado = "Estado";
       $Lab_prioridad = "Prioridad";
       $Lab_tipo_caso = "Tipo Caso";
       $Lab_medio = "Medio";
       $Lab_asignado_tercero = "Asignado a:";
       }
       $prep_field = array();
       $prep_field['fecha'] = $Lab_fecha;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['fecha'] = $Lab_fecha; 
       $prep_field['codigo_cliente'] = $Lab_codigo_cliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['codigo_cliente'] = $Lab_codigo_cliente; 
       $prep_field['estado'] = $Lab_estado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['estado'] = $Lab_estado; 
       $prep_field['prioridad'] = $Lab_prioridad;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['prioridad'] = $Lab_prioridad; 
       $prep_field['tipo_caso'] = $Lab_tipo_caso;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['tipo_caso'] = $Lab_tipo_caso; 
       $prep_field['medio'] = $Lab_medio;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['medio'] = $Lab_medio; 
       $prep_field['asignado_tercero'] = $Lab_asignado_tercero;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['asignado_tercero'] = $Lab_asignado_tercero; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['numero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['numero'] = "Caso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['valor'] = "Valor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['imprimir']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['imprimir'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['id_caso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['id_caso'] = "Id Caso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['codigo_cliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['codigo_cliente'] = "Cod/Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['prioridad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['prioridad'] = "Prioridad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['tipo_caso']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['tipo_caso'] = "Tipo Caso"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['medio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['medio'] = "Medio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['asignado_tercero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['asignado_tercero'] = "Asignado a:"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['fecha_asignacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['fecha_asignacion'] = "Fecha Asignacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['fecha_cierre']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['fecha_cierre'] = "Fecha Cierre"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['cedula_tercero']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['cedula_tercero'] = "Cedula Tercero"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['notificado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['notificado'] = "Notificado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['notificar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['labels']['notificar'] = ""; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['codigo_cliente']['alin'] = "''";
       $Arr_parms['codigo_cliente']['link'] = "S";
       $Arr_parms['estado']['alin'] = "''";
       $Arr_parms['estado']['link'] = "S";
       $Arr_parms['prioridad']['alin'] = "''";
       $Arr_parms['prioridad']['link'] = "S";
       $Arr_parms['tipo_caso']['alin'] = "''";
       $Arr_parms['tipo_caso']['link'] = "S";
       $Arr_parms['medio']['alin'] = "''";
       $Arr_parms['medio']['link'] = "S";
       $Arr_parms['asignado_tercero']['alin'] = "''";
       $Arr_parms['asignado_tercero']['link'] = "S";
       ...
       $Arr_parms['codigo_cliente']['fill'] = "true";
       $Arr_parms['codigo_cliente']['order'] = "label";
       $Arr_parms['codigo_cliente']['order_start'] = 'asc';
       $Arr_parms['codigo_cliente']['order_invert'] = 'false';
       $Arr_parms['codigo_cliente']['order_enabled'] = 'false';
       $Arr_parms['estado']['fill'] = "true";
       $Arr_parms['estado']['order'] = "label";
       $Arr_parms['estado']['order_start'] = 'asc';
       $Arr_parms['estado']['order_invert'] = 'false';
       $Arr_parms['estado']['order_enabled'] = 'false';
       $Arr_parms['prioridad']['fill'] = "true";
       $Arr_parms['prioridad']['order'] = "label";
       $Arr_parms['prioridad']['order_start'] = 'asc';
       $Arr_parms['prioridad']['order_invert'] = 'false';
       $Arr_parms['prioridad']['order_enabled'] = 'false';
       $Arr_parms['tipo_caso']['fill'] = "true";
       $Arr_parms['tipo_caso']['order'] = "label";
       $Arr_parms['tipo_caso']['order_start'] = 'asc';
       $Arr_parms['tipo_caso']['order_invert'] = 'false';
       $Arr_parms['tipo_caso']['order_enabled'] = 'false';
       $Arr_parms['medio']['fill'] = "true";
       $Arr_parms['medio']['order'] = "label";
       $Arr_parms['medio']['order_start'] = 'asc';
       $Arr_parms['medio']['order_invert'] = 'false';
       $Arr_parms['medio']['order_enabled'] = 'false';
       $Arr_parms['asignado_tercero']['fill'] = "true";
       $Arr_parms['asignado_tercero']['order'] = "label";
       $Arr_parms['asignado_tercero']['order_start'] = 'asc';
       $Arr_parms['asignado_tercero']['order_invert'] = 'false';
       $Arr_parms['asignado_tercero']['order_enabled'] = 'false';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['codigo_cliente'] = array(0 => 'codigo_cliente', 1 => '@aspass@');
       $prep_links_fl['estado'] = array(0 => 'estado', 1 => '@aspass@');
       $prep_links_fl['prioridad'] = array(0 => 'prioridad', 1 => '@aspass@');
       $prep_links_fl['tipo_caso'] = array(0 => 'tipo_caso', 1 => '@aspass@');
       $prep_links_fl['medio'] = array(0 => 'medio', 1 => '@aspass@');
       $prep_links_fl['asignado_tercero'] = array(0 => 'asignado_tercero', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_casos_vistacontrato@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] = "print";
      ...
      $this->Total   = new grid_casos_vistacontrato_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_casos_vistacontrato/grid_casos_vistacontrato_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_casos_vistacontrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_casos_vistacontrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_casos_vistacontrato_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['embutida'])
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_casos_vistacontrato/grid_casos_vistacontrato_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_casos_vistacontrato/grid_casos_vistacontrato_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_casos_vistacontrato/grid_casos_vistacontrato_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_casos_vistacontrato_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_casos_vistacontrato']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_casos_vistacontrato']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_casos_vistacontrato_config_pivot.php?nome_apl=grid_casos_vistacontrato&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_casos_vistacontrato_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_casos_vistacontrato_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_casos_vistacontrato_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_casos_vistacontrato/grid_casos_vistacontrato_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fecha_2 = $Busca_temp['fecha_input_2']; 
          $codigo_cliente = $Busca_temp['codigo_cliente']; 
          $tmp_pos = strpos($codigo_cliente, "##@@");
          if ($tmp_pos !== false && !is_array($codigo_cliente))
          {
          ...
          $prioridad = $Busca_temp['prioridad']; 
          $tmp_pos = strpos($prioridad, "##@@");
          if ($tmp_pos !== false && !is_array($prioridad))
          {
              $prioridad = substr($prioridad, 0, $tmp_pos);
          }
          $tipo_caso = $Busca_temp['tipo_caso']; 
          $tmp_pos = strpos($tipo_caso, "##@@");
          if ($tmp_pos !== false && !is_array($tipo_caso))
          {
              $tipo_caso = substr($tipo_caso, 0, $tmp_pos);
          }
          $medio = $Busca_temp['medio']; 
          $tmp_pos = strpos($medio, "##@@");
          if ($tmp_pos !== false && !is_array($medio))
          {
          ...
          $asignado_tercero = $Busca_temp['asignado_tercero']; 
          $tmp_pos = strpos($asignado_tercero, "##@@");
          if ($tmp_pos !== false && !is_array($asignado_tercero))
          {
              $asignado_tercero = substr($asignado_tercero, 0, $tmp_pos);
          }
          $fecha_asignacion = $Busca_temp['fecha_asignacion']; 
          $tmp_pos = strpos($fecha_asignacion, "##@@");
          if ($tmp_pos !== false && !is_array($fecha_asignacion))
          {
              $fecha_asignacion = substr($fecha_asignacion, 0, $tmp_pos);
          }
          $fecha_asignacion_2 = $Busca_temp['fecha_asignacion_input_2']; 
          $fecha_cierre = $Busca_temp['fecha_cierre']; 
          $tmp_pos = strpos($fecha_cierre, "##@@");
          if ($tmp_pos !== false && !is_array($fecha_cierre))
          {
              $fecha_cierre = substr($fecha_cierre, 0, $tmp_pos);
          }
          $fecha_cierre_2 = $Busca_temp['fecha_cierre_input_2']; 
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($quebra_fecha, $quebra_codigo_cliente, $quebra_estado, $quebra_prioridad, $quebra_tipo_caso, $quebra_medio, $quebra_asignado_tercero, $quebra_fecha_orig, $quebra_codigo_cliente_orig, $quebra_estado_orig, $quebra_prioridad_orig, $quebra_tipo_caso_orig, $quebra_medio_orig, $quebra_asignado_tercero_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_casos_vistacontrato']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->numero = $rs_res->fields[0] ;  
            $this->fecha = $rs_res->fields[1] ;  
            $this->estado = $rs_res->fields[2] ;  
            $this->valor = $rs_res->fields[3] ;  
            $this->valor =  str_replace(",", ".", $this->valor);
            $this->observaciones = $rs_res->fields[4] ;  
            $this->id_caso = $rs_res->fields[5] ;  
            $this->codigo_cliente = $rs_res->fields[6] ;  
            $this->prioridad = $rs_res->fields[7] ;  
            $this->tipo_caso = $rs_res->fields[8] ;  
            $this->medio = $rs_res->fields[9] ;  
            $this->asignado_tercero = $rs_res->fields[10] ;  
            $this->fecha_asignacion = $rs_res->fields[11] ;  
            $this->fecha_cierre = $rs_res->fields[12] ;  
            $this->cedula_tercero = $rs_res->fields[13] ;  
            $this->notificado = $rs_res->fields[14] ;  
            $this->fecha_orig = $this->fecha;
            $this->codigo_cliente_orig = $this->codigo_cliente;
            $this->estado_orig = $this->estado;
            $this->prioridad_orig = $this->prioridad;
            $this->tipo_caso_orig = $this->tipo_caso;
            $this->medio_orig = $this->medio;
            $this->asignado_tercero_orig = $this->asignado_tercero;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fecha, $this->codigo_cliente, $this->estado, $this->prioridad, $this->tipo_caso, $this->medio, $this->asignado_tercero, $this->fecha_orig,  $this->codigo_cliente_orig,  $this->estado_orig,  $this->prioridad_orig,  $this->tipo_caso_orig,  $this->medio_orig,  $this->asignado_tercero_orig);
            }
   }
//
