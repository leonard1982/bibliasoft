  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clasificacion_clientes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_clasificacion_clientes_form();
	}
...
?>
  ...
  // ---------- Validate idclasificacion_cliente_
  function do_ajax_form_clasificacion_clientes_validate_idclasificacion_cliente_(iNumLinha)
  {
    var nomeCampo_idclasificacion_cliente_ = "idclasificacion_cliente_" + iNumLinha;
    var var_idclasificacion_cliente_ = scAjaxGetFieldHidden(nomeCampo_idclasificacion_cliente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clasificacion_clientes_validate_idclasificacion_cliente_(var_idclasificacion_cliente_, iNumLinha, var_script_case_init, do_ajax_form_clasificacion_clientes_validate_idclasificacion_cliente__cb);
  } // do_ajax_form_clasificacion_clientes_validate_idclasificacion_cliente_

  function do_ajax_form_clasificacion_clientes_validate_idclasificacion_cliente__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idclasificacion_cliente_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idclasificacion_cliente_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idclasificacion_cliente_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idclasificacion_cliente_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clasificacion_clientes_validate_idclasificacion_cliente__cb

  // ---------- Validate codigo_
  function do_ajax_form_clasificacion_clientes_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clasificacion_clientes_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_clasificacion_clientes_validate_codigo__cb);
  } // do_ajax_form_clasificacion_clientes_validate_codigo_

  function do_ajax_form_clasificacion_clientes_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clasificacion_clientes_validate_codigo__cb

  // ---------- Validate nombre_
  function do_ajax_form_clasificacion_clientes_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clasificacion_clientes_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_clasificacion_clientes_validate_nombre__cb);
  } // do_ajax_form_clasificacion_clientes_validate_nombre_

  function do_ajax_form_clasificacion_clientes_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clasificacion_clientes_validate_nombre__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_clasificacion_clientes_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_clasificacion_clientes_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clasificacion_clientes_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_clasificacion_clientes_add_new_line_cb);
  } // do_ajax_form_clasificacion_clientes_add_new_line

  function do_ajax_form_clasificacion_clientes_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_clasificacion_clientes_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_clasificacion_clientes_backup_line(iNumLinha)
  {
    var var_idclasificacion_cliente_ = scAjaxGetFieldHidden("idclasificacion_cliente_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clasificacion_clientes_backup_line(var_idclasificacion_cliente_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_clasificacion_clientes_backup_line_cb);
  } // do_ajax_form_clasificacion_clientes_backup_line

  function do_ajax_form_clasificacion_clientes_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_clasificacion_clientes_backup_line_cb

  function do_ajax_form_clasificacion_clientes_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_clasificacion_clientes_cancel_insert

  function do_ajax_form_clasificacion_clientes_cancel_update(iSeqVert)
  {
    do_ajax_form_clasificacion_clientes_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_clasificacion_clientes_cancel_update

  function do_ajax_form_clasificacion_clientes_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_clasificacion_clientes_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_clasificacion_clientes_table_refresh()
  {
    var var_idclasificacion_cliente_ = document.F2.idclasificacion_cliente_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_clasificacion_clientes_table_refresh(var_idclasificacion_cliente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clasificacion_clientes_table_refresh_cb);
  } //  do_ajax_form_clasificacion_clientes_table_refresh

  function do_ajax_form_clasificacion_clientes_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idclasificacion_cliente_.value = scAjaxGetKeyValue("idclasificacion_cliente_");
    ...
    scAjaxAlert(do_ajax_form_clasificacion_clientes_table_refresh_cb_after_alert);
  } // do_ajax_form_clasificacion_clientes_table_refresh_cb
  function do_ajax_form_clasificacion_clientes_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_clasificacion_clientes_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_clasificacion_clientes_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_clasificacion_clientes_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_clasificacion_clientes_submit_form(var_idclasificacion_cliente_, var_codigo_, var_nombre_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clasificacion_clientes_submit_form_cb);
  } // do_ajax_form_clasificacion_clientes_submit_form

  function do_ajax_form_clasificacion_clientes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idclasificacion_cliente_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clasificacion_clientes_submit_form_cb_after_alert);
  } // do_ajax_form_clasificacion_clientes_submit_form_cb
  function do_ajax_form_clasificacion_clientes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clasificacion_clientes_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clasificacion_clientes_navigate_form()
  {
    perform_ajax_form_clasificacion_clientes_navigate_form();
  }

  function perform_ajax_form_clasificacion_clientes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idclasificacion_cliente_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_clasificacion_clientes_navigate_form(var_idclasificacion_cliente_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clasificacion_clientes_navigate_form_cb);
  } // do_ajax_form_clasificacion_clientes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clasificacion_clientes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clasificacion_clientes_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idclasificacion_cliente_.value = scAjaxGetKeyValue("idclasificacion_cliente_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clasificacion_clientes_navigate_form_cb_after_alert);
  } // do_ajax_form_clasificacion_clientes_navigate_form_cb
  function do_ajax_form_clasificacion_clientes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_clasificacion_clientes_navigate_form_cb_after_alert
  function sc_hide_form_clasificacion_clientes_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idclasificacion_cliente_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idclasificacion_cliente_" + iNumLinha] = {"label": "Idclasificacion Cliente<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idclasificacion_cliente_"][iNumLinha] = "idclasificacion_cliente_" + iNumLinha;
    ajax_field_mult["codigo_"][iNumLinha] = "codigo_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_id["idclasificacion_cliente_" + iNumLinha] = new Array("hidden_field_label_idclasificacion_cliente_", "hidden_field_data_idclasificacion_cliente_" + iNumLinha);
    ...
    ajax_error_count["idclasificacion_cliente_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idclasificacion_cliente_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idclasificacion_cliente_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "idclasificacion_cliente_": new Array(),
    "codigo_": new Array(),
    "nombre_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idclasificacion_cliente_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idclasificacion_cliente_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idclasificacion_cliente_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idclasificacion_cliente_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idclasificacion_cliente_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idclasificacion_cliente_'])) ? $this->nmgp_cmp_readonly['idclasificacion_cliente_'] : 'on';
?>
    scAjaxFieldRead("idclasificacion_cliente_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idclasificacion_cliente_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idclasificacion_cliente_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["nombre_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idclasificacion_cliente_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idclasificacion_cliente_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["nombre_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idclasificacion_cliente_" + iRow] = "off";
      ...
      $("#hidden_field_data_idclasificacion_cliente_" + iRow).removeClass("scFormErrorLine");
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idclasificacion_cliente_" == sIndex)
    {
