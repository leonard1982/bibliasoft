...
$old_error_handler = set_error_handler("form_tipo_producto_scriptcase_error_handler");

function form_tipo_producto_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_tipo_producto']['contr_erro']) && $_SESSION['scriptcase']['form_tipo_producto']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_tipo_producto->contr_form_tipo_producto->Apl_com_erro = true;
            if ($inicial_form_tipo_producto->contr_form_tipo_producto->NM_ajax_flag)
            {
                $inicial_form_tipo_producto->contr_form_tipo_producto->NM_ajax_info['errList']['geral_form_tipo_producto'][] = $msg;
                return;
            }
            form_tipo_producto_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_tipo_producto_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_tipo_producto'])  && '' != $_SESSION['scriptcase']['error_icon']['form_tipo_producto'])  ? $_SESSION['scriptcase']['error_icon']['form_tipo_producto']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_tipo_producto']) && '' != $_SESSION['scriptcase']['error_span_title']['form_tipo_producto']) ? $_SESSION['scriptcase']['error_span_title']['form_tipo_producto'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_tipo_producto']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_tipo_producto']) ? $_SESSION['scriptcase']['error_icon_title']['form_tipo_producto'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_tipo_producto']['error_buffer'] .= ob_get_flush();
}
