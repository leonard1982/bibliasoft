  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipo_producto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipo_producto_form();
	}
...
?>
  ...
  // ---------- Validate id_tipo_producto_
  function do_ajax_form_tipo_producto_validate_id_tipo_producto_(iNumLinha)
  {
    var nomeCampo_id_tipo_producto_ = "id_tipo_producto_" + iNumLinha;
    var var_id_tipo_producto_ = scAjaxGetFieldHidden(nomeCampo_id_tipo_producto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_producto_validate_id_tipo_producto_(var_id_tipo_producto_, iNumLinha, var_script_case_init, do_ajax_form_tipo_producto_validate_id_tipo_producto__cb);
  } // do_ajax_form_tipo_producto_validate_id_tipo_producto_

  function do_ajax_form_tipo_producto_validate_id_tipo_producto__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_tipo_producto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_tipo_producto_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_tipo_producto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_tipo_producto_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_producto_validate_id_tipo_producto__cb

  // ---------- Validate codigo_tp_
  function do_ajax_form_tipo_producto_validate_codigo_tp_(iNumLinha)
  {
    var nomeCampo_codigo_tp_ = "codigo_tp_" + iNumLinha;
    var var_codigo_tp_ = scAjaxGetFieldText(nomeCampo_codigo_tp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_producto_validate_codigo_tp_(var_codigo_tp_, iNumLinha, var_script_case_init, do_ajax_form_tipo_producto_validate_codigo_tp__cb);
  } // do_ajax_form_tipo_producto_validate_codigo_tp_

  function do_ajax_form_tipo_producto_validate_codigo_tp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_tp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_tp_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigo_tp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_tp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_producto_validate_codigo_tp__cb

  // ---------- Validate descripcion_tp_
  function do_ajax_form_tipo_producto_validate_descripcion_tp_(iNumLinha)
  {
    var nomeCampo_descripcion_tp_ = "descripcion_tp_" + iNumLinha;
    var var_descripcion_tp_ = scAjaxGetFieldText(nomeCampo_descripcion_tp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_producto_validate_descripcion_tp_(var_descripcion_tp_, iNumLinha, var_script_case_init, do_ajax_form_tipo_producto_validate_descripcion_tp__cb);
  } // do_ajax_form_tipo_producto_validate_descripcion_tp_

  function do_ajax_form_tipo_producto_validate_descripcion_tp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "descripcion_tp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "descripcion_tp_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "descripcion_tp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "descripcion_tp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipo_producto_validate_descripcion_tp__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipo_producto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipo_producto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipo_producto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipo_producto_add_new_line_cb);
  } // do_ajax_form_tipo_producto_add_new_line

  function do_ajax_form_tipo_producto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tipo_producto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipo_producto_backup_line(iNumLinha)
  {
    var var_id_tipo_producto_ = scAjaxGetFieldHidden("id_tipo_producto_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipo_producto_backup_line(var_id_tipo_producto_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipo_producto_backup_line_cb);
  } // do_ajax_form_tipo_producto_backup_line

  function do_ajax_form_tipo_producto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tipo_producto_backup_line_cb

  function do_ajax_form_tipo_producto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tipo_producto_cancel_insert

  function do_ajax_form_tipo_producto_cancel_update(iSeqVert)
  {
    do_ajax_form_tipo_producto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipo_producto_cancel_update

  function do_ajax_form_tipo_producto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipo_producto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipo_producto_table_refresh()
  {
    var var_id_tipo_producto_ = document.F2.id_tipo_producto_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipo_producto_table_refresh(var_id_tipo_producto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_producto_table_refresh_cb);
  } //  do_ajax_form_tipo_producto_table_refresh

  function do_ajax_form_tipo_producto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_tipo_producto_.value = scAjaxGetKeyValue("id_tipo_producto_");
    ...
    scAjaxAlert(do_ajax_form_tipo_producto_table_refresh_cb_after_alert);
  } // do_ajax_form_tipo_producto_table_refresh_cb
  function do_ajax_form_tipo_producto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipo_producto_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipo_producto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tipo_producto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_tipo_producto_ = scAjaxGetFieldHidden("id_tipo_producto_" + iNumLinha);
    var var_codigo_tp_ = scAjaxGetFieldText("codigo_tp_" + iNumLinha);
    var var_descripcion_tp_ = scAjaxGetFieldText("descripcion_tp_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tipo_producto_submit_form(var_id_tipo_producto_, var_codigo_tp_, var_descripcion_tp_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipo_producto_submit_form_cb);
  } // do_ajax_form_tipo_producto_submit_form

  function do_ajax_form_tipo_producto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_tipo_producto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_tp_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descripcion_tp_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tipo_producto_submit_form_cb_after_alert);
  } // do_ajax_form_tipo_producto_submit_form_cb
  function do_ajax_form_tipo_producto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipo_producto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipo_producto_navigate_form()
  {
    perform_ajax_form_tipo_producto_navigate_form();
  }

  function perform_ajax_form_tipo_producto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipo_producto_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_tipo_producto_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_tp_" + iNavForm);
      scAjaxHideErrorDisplay("descripcion_tp_" + iNavForm);
    }
    var var_id_tipo_producto_ = document.F2.id_tipo_producto_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipo_producto_navigate_form(var_id_tipo_producto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipo_producto_navigate_form_cb);
  } // do_ajax_form_tipo_producto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipo_producto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipo_producto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_tipo_producto_.value = scAjaxGetKeyValue("id_tipo_producto_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipo_producto_navigate_form_cb_after_alert);
  } // do_ajax_form_tipo_producto_navigate_form_cb
  function do_ajax_form_tipo_producto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_tipo_producto_navigate_form_cb_after_alert
  function sc_hide_form_tipo_producto_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_tipo_producto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_tp_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_tp_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_tipo_producto_" + iNumLinha] = {"label": "Id Tipo Producto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_tp_" + iNumLinha] = {"label": "Código TP<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["descripcion_tp_" + iNumLinha] = {"label": "Descripción<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_tipo_producto_"][iNumLinha] = "id_tipo_producto_" + iNumLinha;
    ajax_field_mult["codigo_tp_"][iNumLinha] = "codigo_tp_" + iNumLinha;
    ajax_field_mult["descripcion_tp_"][iNumLinha] = "descripcion_tp_" + iNumLinha;
    ajax_field_id["codigo_tp_" + iNumLinha] = new Array("hidden_field_label_codigo_tp_", "hidden_field_data_codigo_tp_" + iNumLinha);
    ajax_field_id["descripcion_tp_" + iNumLinha] = new Array("hidden_field_label_descripcion_tp_", "hidden_field_data_descripcion_tp_" + iNumLinha);
    ajax_error_count["id_tipo_producto_" + iNumLinha] = "off";
    ajax_error_count["codigo_tp_" + iNumLinha] = "off";
    ajax_error_count["descripcion_tp_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_tipo_producto_" + iNumLinha] = "on";
    ajax_read_only["codigo_tp_" + iNumLinha] = "off";
    ajax_read_only["descripcion_tp_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_tipo_producto_" + iNumLinha] = "on";
    ajax_read_only["codigo_tp_" + iNumLinha] = "on";
    ajax_read_only["descripcion_tp_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_tipo_producto_" + iNumLinha] = null;
    ajax_error_list["codigo_tp_" + iNumLinha] = null;
    ajax_error_list["descripcion_tp_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_tipo_producto_": new Array(),
    "codigo_tp_": new Array(),
    "descripcion_tp_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_tipo_producto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_tipo_producto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_tipo_producto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_tipo_producto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_tipo_producto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["codigo_tp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_tp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_tp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_tp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_tp_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["descripcion_tp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["descripcion_tp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["descripcion_tp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["descripcion_tp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["descripcion_tp_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_tipo_producto_'])) ? $this->nmgp_cmp_readonly['id_tipo_producto_'] : 'on';
?>
    scAjaxFieldRead("id_tipo_producto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_tp_'])) ? $this->nmgp_cmp_readonly['codigo_tp_'] : 'off';
?>
    scAjaxFieldRead("codigo_tp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descripcion_tp_'])) ? $this->nmgp_cmp_readonly['descripcion_tp_'] : 'off';
?>
    scAjaxFieldRead("descripcion_tp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_tipo_producto_" + iSeq, "on");
    scAjaxFieldRead("codigo_tp_" + iSeq, "on");
    scAjaxFieldRead("descripcion_tp_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_tipo_producto_" + iRow] || "on" == ajax_error_count["codigo_tp_" + iRow] || "on" == ajax_error_count["descripcion_tp_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_tipo_producto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_tp_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_tp_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_tipo_producto_" + iRow] && "off" == ajax_error_count["codigo_tp_" + iRow] && "off" == ajax_error_count["descripcion_tp_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_tipo_producto_" + iRow] = "off";
        ajax_error_count["codigo_tp_" + iRow] = "off";
        ajax_error_count["descripcion_tp_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_tipo_producto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_tp_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_tp_" + iRow).removeClass("scFormErrorLine");
    }
  }
