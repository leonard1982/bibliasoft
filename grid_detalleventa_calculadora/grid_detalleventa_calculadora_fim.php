...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detalleventa_calculadora"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detalleventa_calculadora"]);
   }
