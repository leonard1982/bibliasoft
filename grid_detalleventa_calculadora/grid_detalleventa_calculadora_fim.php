...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleventa_calculadora"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleventa_calculadora"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_calculadora']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleventa_calculadora']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_calculadora']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleventa_calculadora']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_calculadora']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detalleventa_calculadora</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_calculadora']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleventa_calculadora']['embutida_filho'] as $ind => $sc_init)
          {
