<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleventa_calculadora']['sc_process_barr'] = true;
require_once('../grid_detalleventa_calculadora/index.php');
unset($_SESSION['scriptcase']['grid_detalleventa_calculadora']['sc_process_barr']);
$ExportCtrl = new grid_detalleventa_calculadora_export_control;
$ExportCtrl->Export_barr();

class grid_detalleventa_calculadora_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_detalleventa_calculadora']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_detalleventa_calculadora']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> detalleventa</TITLE>
