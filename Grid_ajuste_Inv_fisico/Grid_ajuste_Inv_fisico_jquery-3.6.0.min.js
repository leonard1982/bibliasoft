...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_Grid_ajuste_Inv_fisico').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_Grid_ajuste_Inv_fisico').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_Grid_ajuste_Inv_fisico').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_Grid_ajuste_Inv_fisico').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_Grid_ajuste_Inv_fisico').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_Grid_ajuste_Inv_fisico').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_Grid_ajuste_Inv_fisico').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_Grid_ajuste_Inv_fisico').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_Grid_ajuste_Inv_fisico').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_Grid_ajuste_Inv_fisico').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_Grid_ajuste_Inv_fisico').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_Grid_ajuste_Inv_fisico').style.width  = '0px';
        if (oResp["setValue"]) {
