<?php
@session_start() ;
$_SESSION['scriptcase']['Grid_ajuste_Inv_fisico']['sc_process_barr'] = true;
require_once('../Grid_ajuste_Inv_fisico/index.php');
unset($_SESSION['scriptcase']['Grid_ajuste_Inv_fisico']['sc_process_barr']);
$ExportCtrl = new Grid_ajuste_Inv_fisico_export_control;
$ExportCtrl->Export_barr();

class Grid_ajuste_Inv_fisico_export_control
{
