...
//----- 
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mov_inv_fisico'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Grid_ajuste_Inv_fisico']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['Grid_ajuste_Inv_fisico']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['Grid_ajuste_Inv_fisico']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['Grid_ajuste_Inv_fisico']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['Grid_ajuste_Inv_fisico']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>Grid_ajuste_Inv_fisico</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['Grid_ajuste_Inv_fisico']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['Grid_ajuste_Inv_fisico']['embutida_filho'] as $ind => $sc_init)
          {
