...
<?php
   ...
   $Ord_Cmp = new Grid_ajuste_Inv_fisico_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class Grid_ajuste_Inv_fisico_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["prefijonota"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["prefijonota"])) ? $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["prefijonota"] : "Prefijo";
   $tab_ger_campos['numeronota'] = "on";
   $tab_def_campos['numeronota'] = "numeronota";
   $tab_labels["numeronota"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["numeronota"])) ? $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["numeronota"] : "Movimiento #";
   $tab_ger_campos['idtipotran'] = "on";
   $tab_def_campos['idtipotran'] = "idtipotran";
   $tab_labels["idtipotran"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["idtipotran"])) ? $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["idtipotran"] : "Concepto";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["fecha"] : "Fecha";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['labels']["imprimir"] : "Imprimir comprobante";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "Grid_ajuste_Inv_fisico_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['Grid_ajuste_Inv_fisico']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
