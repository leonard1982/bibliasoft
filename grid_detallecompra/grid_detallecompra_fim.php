...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallecompra"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallecompra"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallecompra']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallecompra']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallecompra</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallecompra']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallecompra']['embutida_filho'] as $ind => $sc_init)
          {
