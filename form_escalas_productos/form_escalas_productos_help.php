...
@session_start() ;
class form_escalas_productos_help
{
...
<?php echo "<b>Stock en el Factor</b><br>" . nl2br("SI PRODUCTO TIENE MOVIMIENTO, NO PERMITE BORRAR EL REGISTRO NI MODIFICAR EL FACTOR"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_escalas_productos_help();
?>
