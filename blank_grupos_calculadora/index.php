<?php
   include_once('blank_grupos_calculadora_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_grupos_calculadora_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_grupos_calculadora"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_grupos_calculadora']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_grupos_calculadora']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_grupos_calculadora']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_grupos_calculadora';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_grupos_calculadora']['actual_lang']) || $_SESSION['scriptcase']['blank_grupos_calculadora']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_grupos_calculadora']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_grupos_calculadora_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_grupos_calculadora"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_grupos_calculadora"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blank_grupos_calculadora_erro.class.php"); 
      $this->Erro = new blank_grupos_calculadora_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_grupos_calculadora'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_grupos_calculadora']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blank_grupos_calculadora_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_grupos_calculadora_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_grupos_calculadora']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_grupos_calculadora']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_grupos_calculadora']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_grupos_calculadora'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_grupos_calculadora']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_grupos_calculadora']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_grupos_calculadora') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_grupos_calculadora']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "blank_grupos_calculadora")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_grupos_calculadora']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_grupos_calculadora']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_grupos_calculadora']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_grupos_calculadora_erro.class.php"); 
      $this->Erro      = new blank_grupos_calculadora_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['blank_grupos_calculadora']['contr_erro'] = 'on';
...
<script>
	function fProductosGrupo(idgrupo)
	{
		$.post("../blank_productos_calculadora/index.php",{
	
			idgrupo:idgrupo
	
		},function(r){
			
			$("#listaparaseleccion").html(r);
		});
	
		console.log("fProductosGrupo: ");
		console.log("idgrupo: "+idgrupo);
	}
	
	function fAgregarItem(idprod,idfactura)
	{
		$.post("../frm_pos_gestionardetalle/index.php",{
			...
			console.log(r);
			document.getElementById('iddetalleventa').src = document.getElementById('iddetalleventa').src;
		});
	}
</script>
...
if(isset($_GET["idfacven"]))
{
	$idfactura = $_GET["idfacven"];
}
else
{
	$vsql = "select coalesce(max(numfacven),0) from facturaven where resolucion='1'";
...
;
	...
	if(isset($this->vultimonumero[0][0]))
	{
		...
		$vnumero = $this->vultimonumero[0][0];

		if($vnumero==0)
		{
			 
      $nm_select = "select primerfactura from resdian where Idres='1'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
			...
			{
				$vnumero = $this->vprimerafv[0][0];
			}
		}
		else
		{
			$vnumero = $this->vultimonumero[0][0]+1;
		}
	}

	$vsql2 = "INSERT INTO facturaven set numfacven='".$vnumero."',credito='2',fechaven=NOW(),idcli='1',formapago='EFECTIVO',vendedor='".$this->sc_temp_gidtercero."',resolucion='1',asentada='0',pagada='NO',espos='SI',subtotal='0',valoriva='0',total='0',banco='1',tipo='FV',observaciones='TEMPORAL'";
	...
	$vsql3 = "select max(idfacven) from facturaven where vendedor='".$this->sc_temp_gidtercero."' and resolucion='1'";
...
;
	...
	if(isset($this->vultimoid[0][0]))
	{
      ...
      $nm_select = "select nomgrupo,idgrupo,coalesce(imagen,'') from grupo where mostrar='SI' order by idgrupo desc"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vGrupos = array();
      $this->vgrupos = array();
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vGrupos[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vgrupos[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vGrupos = false;
          $this->vGrupos_erro = $this->Db->ErrorMsg();
          $this->vgrupos = false;
          $this->vgrupos_erro = $this->Db->ErrorMsg();
      } 
;

echo "<input id='idfactura' type='hidden' value='".$idfactura."' />";
echo "<table><tr><td><b>Mesa/Cliente</b></td><td><select class='form-control' id='idcliente' style='width:300px;'><option value='1'>VARIOS</option><option value='mesa1'>Mesa 1</option><option value='mesa2'>Mesa 2</option><option value='mesa3'>Mesa 3</option></select></td><td><button class='btn btn-success'>Imprimir Comanda</button></td><td><a href='../frm_pos_impresion_html/index.php?idfactura=$idfactura' target='_blank'><button class='btn btn-primary'>Imprimir Recibo</button></a></td><td><a href='../grid_facturaven_pos'><button class='btn btn-warning'>Volver</button></a></td></tr></table>";
echo "<br>";

echo "<div style='width:18%;padding:5px;border:2px solid #ededed;border-radius:10px;height:600px;display:inline-block;margin-right:10px;'>";
if(isset($this->vgrupos[0][0]))
{
	echo "<div style='overflow:auto;width:100%;height:590px;'>";
	
	for($i=0;$i<count($this->vgrupos );$i++)
	{
		$idgrupo = $this->vgrupos[$i][1];
		$vsql = "select imagen from grupo where idgrupo=$idgrupo";
		$vimagen = $this->vgrupos[$i][2];
		
		echo "<div onclick='fProductosGrupo(".$idgrupo.");' class='productosgrupo'>".$this->vgrupos[$i][0]."<br>";
		
		if(!empty($vimagen))
		{
			echo "<img src='../imagen_mostrar/index.php?sql=".$vsql."' width='60px'/>";
		}
...
echo "<center id='listaparaseleccion' style='width:40%;padding:5px;border:2px solid #ededed;border-radius:10px;height:600px;display:inline-block;margin-right:10px;'>";
echo "</center>";

echo "<div style='width:40%;padding:2px;border:2px solid #ededed;border-radius:10px;height:600px;display:inline-block;'>";
echo "<iframe id='iddetalleventa' src='../grid_detalleventa_calculadora/index.php?gidfactura=".$idfactura."' frameBorder='0' scrolling='0' style='width:100%;height:595px;'></iframe>";
echo "</div>";

echo "</center>";
if (isset($this->sc_temp_gidtercero)) {$_SESSION['gidtercero'] = $this->sc_temp_gidtercero;}
$_SESSION['scriptcase']['blank_grupos_calculadora']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_grupos_calculadora($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_grupos_calculadora']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_grupos_calculadora") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['blank_grupos_calculadora']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   if (isset($_POST["gidtercero"])) 
   {
       ...
       nm_limpa_str_blank_grupos_calculadora($_SESSION["gidtercero"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_grupos_calculadora";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_grupos_calculadora' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_grupos_calculadora' == $sReferer || 'blank_grupos_calculadora_' == substr($sReferer, 0, 25))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_grupos_calculadora')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_grupos_calculadora']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_grupos_calculadora_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_grupos_calculadora($cadapar[1]);
   ...
   $contr_blank_grupos_calculadora = new blank_grupos_calculadora_apl();
   $contr_blank_grupos_calculadora->controle();
//
   function nm_limpa_str_blank_grupos_calculadora(&$str)
   {
