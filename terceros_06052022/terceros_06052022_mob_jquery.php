...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'es_tecnico':
      case 'activo':
        sc_exib_ocult_pag('terceros_06052022_mob_form0');
        break;
      case 'credito':
      case 'cupo':
      case 'cupodis':
      ...
      case 'saldo':
      case 'afiliacion':
        sc_exib_ocult_pag('terceros_06052022_mob_form1');
        break;
      case 'es_cajero':
      case 'cupo_vendedor':
        sc_exib_ocult_pag('terceros_06052022_mob_form2');
        break;
      case 'autoretenedor':
      case 'creditoprov':
      case 'dias':
      ...
      case 'fechultcomp':
      case 'saldoapagar':
        sc_exib_ocult_pag('terceros_06052022_mob_form3');
        break;
      case 'codigo_ter':
      case 'zona_clientes':
      ...
      case 'nombre_empresa_bd':
        sc_exib_ocult_pag('terceros_06052022_mob_form4');
        break;
      case 'archivos':
        sc_exib_ocult_pag('terceros_06052022_mob_form5');
        break;
      case 'es_restaurante':
      case 'porcentaje_propina_sugerida':
        sc_exib_ocult_pag('terceros_06052022_mob_form6');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_fecha_registro_fe_hora' + iSeqRow).bind('blur', function() { sc_terceros_06052022_fecha_registro_fe_onblur(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros_06052022_fecha_registro_fe_onfocus(this, iSeqRow) });
...
function sc_terceros_06052022_idtercero_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_idtercero();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_documento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_documento();
  scCssBlur(oThis);
}

function sc_terceros_06052022_documento_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_documento_onchange();
}
...
function sc_terceros_06052022_nombres_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_nombres();
  scCssBlur(oThis);
  do_ajax_terceros_06052022_mob_event_nombres_onblur();
}

function sc_terceros_06052022_nombres_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_terceros_06052022_mob_event_nombres_onfocus();
}

function sc_terceros_06052022_direccion_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_direccion();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_tel_cel_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_tel_cel();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_nacimiento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_nacimiento();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_sexo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_sexo();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_urlmail_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_urlmail();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_fechault_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_fechault();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_saldo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_saldo();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_afiliacion_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_afiliacion();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_idmuni_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_idmuni();
  scCssBlur(oThis);
}

function sc_terceros_06052022_idmuni_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_refresh_idmuni();
}
...
function sc_terceros_06052022_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_observaciones();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_credito_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_credito();
  scCssBlur(oThis);
}

function sc_terceros_06052022_credito_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_credito_onchange();
}
...
function sc_terceros_06052022_cupo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_cupo();
  scCssBlur(oThis);
}

function sc_terceros_06052022_cupo_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_cupo_onchange();
}
...
function sc_terceros_06052022_listaprecios_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_listaprecios();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_loatiende_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_loatiende();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_efec_retencion_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_efec_retencion();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_regimen_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_regimen();
  scCssBlur(oThis);
}

function sc_terceros_06052022_regimen_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_regimen_onchange();
}
...
function sc_terceros_06052022_tipo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_tipo();
  scCssBlur(oThis);
}

function sc_terceros_06052022_tipo_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_tipo_onchange();
}
...
function sc_terceros_06052022_cliente_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_cliente();
  scCssBlur(oThis);
}

function sc_terceros_06052022_cliente_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_cliente_onchange();
}
...
function sc_terceros_06052022_empleado_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_empleado();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_proveedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_proveedor();
  scCssBlur(oThis);
}

function sc_terceros_06052022_proveedor_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_proveedor_onchange();
}
...
function sc_terceros_06052022_contacto_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_contacto();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_telefonos_prov_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_telefonos_prov();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_email_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_email();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_url_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_url();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_creditoprov_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_creditoprov();
  scCssBlur(oThis);
}

function sc_terceros_06052022_creditoprov_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_creditoprov_onchange();
}
...
function sc_terceros_06052022_dias_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_dias();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_fechultcomp_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_fechultcomp();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_saldoapagar_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_saldoapagar();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_autoretenedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_autoretenedor();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_tipo_documento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_tipo_documento();
  scCssBlur(oThis);
}

function sc_terceros_06052022_tipo_documento_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_tipo_documento_onchange();
}
...
function sc_terceros_06052022_dv_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_dv();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_nombre1_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_nombre1();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nombre1_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_nombre1_onchange();
}
...
function sc_terceros_06052022_nombre2_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_nombre2();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nombre2_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_nombre2_onchange();
}
...
function sc_terceros_06052022_apellido1_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_apellido1();
  scCssBlur(oThis);
}

function sc_terceros_06052022_apellido1_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_apellido1_onchange();
}
...
function sc_terceros_06052022_apellido2_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_apellido2();
  scCssBlur(oThis);
}

function sc_terceros_06052022_apellido2_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_apellido2_onchange();
}
...
function sc_terceros_06052022_sucur_cliente_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_sucur_cliente();
  scCssBlur(oThis);
}

function sc_terceros_06052022_sucur_cliente_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_sucur_cliente_onchange();
}
...
function sc_terceros_06052022_representante_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_representante();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_es_restaurante_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_es_restaurante();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_dias_credito_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_dias_credito();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_dias_mora_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_dias_mora();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_cupo_vendedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_cupo_vendedor();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_codigo_ter_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_codigo_ter();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_es_cajero_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_es_cajero();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_autorizado_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_autorizado();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_zona_clientes_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_zona_clientes();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_clasificacion_clientes_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_clasificacion_clientes();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_ciudad_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_ciudad();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_codigo_postal_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_codigo_postal();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_lenguaje_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_lenguaje();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_nombre_comercil_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_nombre_comercil();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nombre_comercil_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_nombre_comercil_onchange();
}
...
function sc_terceros_06052022_notificar_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_notificar();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_puc_auxiliar_deudores_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_puc_auxiliar_deudores();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_puc_retefuente_ventas_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_puc_retefuente_ventas();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_puc_retefuente_servicios_clie_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_puc_retefuente_servicios_clie();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_puc_auxiliar_proveedores_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_puc_auxiliar_proveedores();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_puc_retefuente_compras_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_puc_retefuente_compras();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_puc_retefuente_servicios_prov_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_puc_retefuente_servicios_prov();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_activo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_activo();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_es_tecnico_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_es_tecnico();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_codigo_tercero_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_codigo_tercero();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_porcentaje_propina_sugerida_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_porcentaje_propina_sugerida();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_correo_notificafe_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_correo_notificafe();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_celular_notificafe_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_celular_notificafe();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_id_plan_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_id_plan();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_valor_plan_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_valor_plan();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_fecha_registro_fe_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_fecha_registro_fe();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_nombre_contador_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_nombre_contador();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_estado_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_estado();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_si_nomina_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_si_nomina();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_si_factura_electronica_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_si_factura_electronica();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_nombre_empresa_bd_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_nombre_empresa_bd();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_n_trabajadores_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_n_trabajadores();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_archivos_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_archivos();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_c_postal_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_c_postal();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_ciiu_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_ciiu();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_cupodis_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_cupodis();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_departamento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_departamento();
  scCssBlur(oThis);
}

function sc_terceros_06052022_departamento_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_refresh_departamento();
}
...
function sc_terceros_06052022_detalle_tributario_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_detalle_tributario();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_r_social_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_r_social();
  scCssBlur(oThis);
}

function sc_terceros_06052022_r_social_onchange(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_event_r_social_onchange();
}
...
function sc_terceros_06052022_relleno2_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_relleno2();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_responsabilidad_fiscal_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_responsabilidad_fiscal();
  scCssBlur(oThis);
}
...
function sc_terceros_06052022_direcciones_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_mob_validate_direcciones();
  scCssBlur(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_terceros_06052022_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_nacimiento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_06052022_mob_validate_nacimiento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechault" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_06052022_mob_validate_fechault(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_afiliacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_06052022_mob_validate_afiliacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecha_registro_fe" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_06052022_mob_validate_fecha_registro_fe(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_con_actual" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_06052022_mob_validate_con_actual(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_06052022_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_archivo_cedula" + iSeqRow).fileupload({
    datatype: "json",
    url: "terceros_06052022_mob_ul_save.php",
    dropZone: "",
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'terceros_06052022_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
