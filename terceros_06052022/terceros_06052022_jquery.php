...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'es_tecnico':
      case 'activo':
        sc_exib_ocult_pag('terceros_06052022_form0');
        break;
      case 'credito':
      case 'cupo':
      case 'cupodis':
      ...
      case 'saldo':
      case 'afiliacion':
        sc_exib_ocult_pag('terceros_06052022_form1');
        break;
      case 'es_cajero':
      case 'cupo_vendedor':
        sc_exib_ocult_pag('terceros_06052022_form2');
        break;
      case 'autoretenedor':
      case 'creditoprov':
      case 'dias':
      ...
      case 'fechultcomp':
      case 'saldoapagar':
        sc_exib_ocult_pag('terceros_06052022_form3');
        break;
      case 'codigo_ter':
      case 'zona_clientes':
      ...
      case 'nombre_empresa_bd':
        sc_exib_ocult_pag('terceros_06052022_form4');
        break;
      case 'archivos':
        sc_exib_ocult_pag('terceros_06052022_form5');
        break;
      case 'es_restaurante':
      case 'porcentaje_propina_sugerida':
        sc_exib_ocult_pag('terceros_06052022_form6');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idtercero' + iSeqRow).bind('blur', function() { sc_terceros_06052022_idtercero_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_idtercero_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_idtercero_onfocus(this, iSeqRow) });
  $('#id_sc_field_documento' + iSeqRow).bind('blur', function() { sc_terceros_06052022_documento_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_documento_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_documento_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombres' + iSeqRow).bind('blur', function() { sc_terceros_06052022_nombres_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_nombres_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_nombres_onfocus(this, iSeqRow) });
  $('#id_sc_field_direccion' + iSeqRow).bind('blur', function() { sc_terceros_06052022_direccion_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_direccion_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_direccion_onfocus(this, iSeqRow) });
  $('#id_sc_field_tel_cel' + iSeqRow).bind('blur', function() { sc_terceros_06052022_tel_cel_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_tel_cel_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_tel_cel_onfocus(this, iSeqRow) });
  $('#id_sc_field_nacimiento' + iSeqRow).bind('blur', function() { sc_terceros_06052022_nacimiento_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_terceros_06052022_nacimiento_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros_06052022_nacimiento_onfocus(this, iSeqRow) });
  $('#id_sc_field_sexo' + iSeqRow).bind('blur', function() { sc_terceros_06052022_sexo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_terceros_06052022_sexo_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros_06052022_sexo_onfocus(this, iSeqRow) });
  $('#id_sc_field_urlmail' + iSeqRow).bind('blur', function() { sc_terceros_06052022_urlmail_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_urlmail_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_urlmail_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechault' + iSeqRow).bind('blur', function() { sc_terceros_06052022_fechault_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros_06052022_fechault_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros_06052022_fechault_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_terceros_06052022_saldo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_terceros_06052022_saldo_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_terceros_06052022_saldo_onfocus(this, iSeqRow) });
  $('#id_sc_field_afiliacion' + iSeqRow).bind('blur', function() { sc_terceros_06052022_afiliacion_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_terceros_06052022_afiliacion_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros_06052022_afiliacion_onfocus(this, iSeqRow) });
  $('#id_sc_field_idmuni' + iSeqRow).bind('blur', function() { sc_terceros_06052022_idmuni_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_terceros_06052022_idmuni_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_terceros_06052022_idmuni_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_terceros_06052022_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_06052022_observaciones_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros_06052022_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_credito' + iSeqRow).bind('blur', function() { sc_terceros_06052022_credito_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_credito_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_credito_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupo' + iSeqRow).bind('blur', function() { sc_terceros_06052022_cupo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_terceros_06052022_cupo_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros_06052022_cupo_onfocus(this, iSeqRow) });
  $('#id_sc_field_listaprecios' + iSeqRow).bind('blur', function() { sc_terceros_06052022_listaprecios_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_terceros_06052022_listaprecios_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_terceros_06052022_listaprecios_onfocus(this, iSeqRow) });
  $('#id_sc_field_loatiende' + iSeqRow).bind('blur', function() { sc_terceros_06052022_loatiende_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_loatiende_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_loatiende_onfocus(this, iSeqRow) });
  $('#id_sc_field_con_actual' + iSeqRow).bind('change', function() { sc_terceros_06052022_con_actual_onchange(this, iSeqRow) });
  $('#id_sc_field_con_actual_hora' + iSeqRow).bind('change', function() { sc_terceros_06052022_con_actual_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_efec_retencion' + iSeqRow).bind('blur', function() { sc_terceros_06052022_efec_retencion_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_06052022_efec_retencion_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros_06052022_efec_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_regimen' + iSeqRow).bind('blur', function() { sc_terceros_06052022_regimen_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_regimen_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_regimen_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_terceros_06052022_tipo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_terceros_06052022_tipo_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros_06052022_tipo_onfocus(this, iSeqRow) });
  $('#id_sc_field_cliente' + iSeqRow).bind('blur', function() { sc_terceros_06052022_cliente_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_cliente_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_empleado' + iSeqRow).bind('blur', function() { sc_terceros_06052022_empleado_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros_06052022_empleado_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros_06052022_empleado_onfocus(this, iSeqRow) });
  $('#id_sc_field_proveedor' + iSeqRow).bind('blur', function() { sc_terceros_06052022_proveedor_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_proveedor_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_proveedor_onfocus(this, iSeqRow) });
  $('#id_sc_field_contacto' + iSeqRow).bind('blur', function() { sc_terceros_06052022_contacto_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros_06052022_contacto_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros_06052022_contacto_onfocus(this, iSeqRow) });
  $('#id_sc_field_telefonos_prov' + iSeqRow).bind('blur', function() { sc_terceros_06052022_telefonos_prov_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_06052022_telefonos_prov_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros_06052022_telefonos_prov_onfocus(this, iSeqRow) });
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_terceros_06052022_email_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_terceros_06052022_email_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_terceros_06052022_email_onfocus(this, iSeqRow) });
  $('#id_sc_field_url' + iSeqRow).bind('blur', function() { sc_terceros_06052022_url_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_terceros_06052022_url_onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_terceros_06052022_url_onfocus(this, iSeqRow) });
  $('#id_sc_field_creditoprov' + iSeqRow).bind('blur', function() { sc_terceros_06052022_creditoprov_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_terceros_06052022_creditoprov_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros_06052022_creditoprov_onfocus(this, iSeqRow) });
  $('#id_sc_field_dias' + iSeqRow).bind('blur', function() { sc_terceros_06052022_dias_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_terceros_06052022_dias_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros_06052022_dias_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechultcomp' + iSeqRow).bind('blur', function() { sc_terceros_06052022_fechultcomp_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_terceros_06052022_fechultcomp_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros_06052022_fechultcomp_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldoapagar' + iSeqRow).bind('blur', function() { sc_terceros_06052022_saldoapagar_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_terceros_06052022_saldoapagar_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros_06052022_saldoapagar_onfocus(this, iSeqRow) });
  $('#id_sc_field_autoretenedor' + iSeqRow).bind('blur', function() { sc_terceros_06052022_autoretenedor_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_06052022_autoretenedor_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros_06052022_autoretenedor_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_documento' + iSeqRow).bind('blur', function() { sc_terceros_06052022_tipo_documento_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_06052022_tipo_documento_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros_06052022_tipo_documento_onfocus(this, iSeqRow) });
  $('#id_sc_field_dv' + iSeqRow).bind('blur', function() { sc_terceros_06052022_dv_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_terceros_06052022_dv_onchange(this, iSeqRow) })
                                .bind('focus', function() { sc_terceros_06052022_dv_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre1' + iSeqRow).bind('blur', function() { sc_terceros_06052022_nombre1_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_nombre1_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_nombre1_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre2' + iSeqRow).bind('blur', function() { sc_terceros_06052022_nombre2_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_nombre2_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_nombre2_onfocus(this, iSeqRow) });
  $('#id_sc_field_apellido1' + iSeqRow).bind('blur', function() { sc_terceros_06052022_apellido1_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_apellido1_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_apellido1_onfocus(this, iSeqRow) });
  $('#id_sc_field_apellido2' + iSeqRow).bind('blur', function() { sc_terceros_06052022_apellido2_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_apellido2_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_apellido2_onfocus(this, iSeqRow) });
  $('#id_sc_field_sucur_cliente' + iSeqRow).bind('blur', function() { sc_terceros_06052022_sucur_cliente_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_06052022_sucur_cliente_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros_06052022_sucur_cliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_representante' + iSeqRow).bind('blur', function() { sc_terceros_06052022_representante_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_06052022_representante_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros_06052022_representante_onfocus(this, iSeqRow) });
  $('#id_sc_field_imagenter' + iSeqRow).bind('change', function() { sc_terceros_06052022_imagenter_onchange(this, iSeqRow) });
  $('#id_sc_field_es_restaurante' + iSeqRow).bind('blur', function() { sc_terceros_06052022_es_restaurante_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_06052022_es_restaurante_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros_06052022_es_restaurante_onfocus(this, iSeqRow) });
  $('#id_sc_field_dias_credito' + iSeqRow).bind('blur', function() { sc_terceros_06052022_dias_credito_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_terceros_06052022_dias_credito_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_terceros_06052022_dias_credito_onfocus(this, iSeqRow) });
  $('#id_sc_field_dias_mora' + iSeqRow).bind('blur', function() { sc_terceros_06052022_dias_mora_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_dias_mora_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_dias_mora_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupo_vendedor' + iSeqRow).bind('blur', function() { sc_terceros_06052022_cupo_vendedor_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_06052022_cupo_vendedor_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros_06052022_cupo_vendedor_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo_ter' + iSeqRow).bind('blur', function() { sc_terceros_06052022_codigo_ter_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_terceros_06052022_codigo_ter_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros_06052022_codigo_ter_onfocus(this, iSeqRow) });
  $('#id_sc_field_es_cajero' + iSeqRow).bind('blur', function() { sc_terceros_06052022_es_cajero_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_es_cajero_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_es_cajero_onfocus(this, iSeqRow) });
  $('#id_sc_field_autorizado' + iSeqRow).bind('blur', function() { sc_terceros_06052022_autorizado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_terceros_06052022_autorizado_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros_06052022_autorizado_onfocus(this, iSeqRow) });
  $('#id_sc_field_zona_clientes' + iSeqRow).bind('blur', function() { sc_terceros_06052022_zona_clientes_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_06052022_zona_clientes_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros_06052022_zona_clientes_onfocus(this, iSeqRow) });
  $('#id_sc_field_clasificacion_clientes' + iSeqRow).bind('blur', function() { sc_terceros_06052022_clasificacion_clientes_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_terceros_06052022_clasificacion_clientes_onchange(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros_06052022_clasificacion_clientes_onfocus(this, iSeqRow) });
  $('#id_sc_field_creado' + iSeqRow).bind('change', function() { sc_terceros_06052022_creado_onchange(this, iSeqRow) });
  $('#id_sc_field_creado_hora' + iSeqRow).bind('change', function() { sc_terceros_06052022_creado_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_disponible' + iSeqRow).bind('change', function() { sc_terceros_06052022_disponible_onchange(this, iSeqRow) });
  $('#id_sc_field_id_pedido_tmp' + iSeqRow).bind('change', function() { sc_terceros_06052022_id_pedido_tmp_onchange(this, iSeqRow) });
  $('#id_sc_field_n_pedido_tmp' + iSeqRow).bind('change', function() { sc_terceros_06052022_n_pedido_tmp_onchange(this, iSeqRow) });
  $('#id_sc_field_total_pedido_tmp' + iSeqRow).bind('change', function() { sc_terceros_06052022_total_pedido_tmp_onchange(this, iSeqRow) });
  $('#id_sc_field_obs_pedido_tmp' + iSeqRow).bind('change', function() { sc_terceros_06052022_obs_pedido_tmp_onchange(this, iSeqRow) });
  $('#id_sc_field_vend_pedido_tmp' + iSeqRow).bind('change', function() { sc_terceros_06052022_vend_pedido_tmp_onchange(this, iSeqRow) });
  $('#id_sc_field_ciudad' + iSeqRow).bind('blur', function() { sc_terceros_06052022_ciudad_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_terceros_06052022_ciudad_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_terceros_06052022_ciudad_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo_postal' + iSeqRow).bind('blur', function() { sc_terceros_06052022_codigo_postal_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_terceros_06052022_codigo_postal_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_terceros_06052022_codigo_postal_onfocus(this, iSeqRow) });
  $('#id_sc_field_lenguaje' + iSeqRow).bind('blur', function() { sc_terceros_06052022_lenguaje_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros_06052022_lenguaje_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros_06052022_lenguaje_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_comercil' + iSeqRow).bind('blur', function() { sc_terceros_06052022_nombre_comercil_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_terceros_06052022_nombre_comercil_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_terceros_06052022_nombre_comercil_onfocus(this, iSeqRow) });
  $('#id_sc_field_notificar' + iSeqRow).bind('blur', function() { sc_terceros_06052022_notificar_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_notificar_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_notificar_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_auxiliar_deudores' + iSeqRow).bind('blur', function() { sc_terceros_06052022_puc_auxiliar_deudores_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_terceros_06052022_puc_auxiliar_deudores_onchange(this, iSeqRow) })
                                                   .bind('focus', function() { sc_terceros_06052022_puc_auxiliar_deudores_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_retefuente_ventas' + iSeqRow).bind('blur', function() { sc_terceros_06052022_puc_retefuente_ventas_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_terceros_06052022_puc_retefuente_ventas_onchange(this, iSeqRow) })
                                                   .bind('focus', function() { sc_terceros_06052022_puc_retefuente_ventas_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_retefuente_servicios_clie' + iSeqRow).bind('blur', function() { sc_terceros_06052022_puc_retefuente_servicios_clie_onblur(this, iSeqRow) })
                                                           .bind('change', function() { sc_terceros_06052022_puc_retefuente_servicios_clie_onchange(this, iSeqRow) })
                                                           .bind('focus', function() { sc_terceros_06052022_puc_retefuente_servicios_clie_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_auxiliar_proveedores' + iSeqRow).bind('blur', function() { sc_terceros_06052022_puc_auxiliar_proveedores_onblur(this, iSeqRow) })
                                                      .bind('change', function() { sc_terceros_06052022_puc_auxiliar_proveedores_onchange(this, iSeqRow) })
                                                      .bind('focus', function() { sc_terceros_06052022_puc_auxiliar_proveedores_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_retefuente_compras' + iSeqRow).bind('blur', function() { sc_terceros_06052022_puc_retefuente_compras_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_terceros_06052022_puc_retefuente_compras_onchange(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros_06052022_puc_retefuente_compras_onfocus(this, iSeqRow) });
  $('#id_sc_field_puc_retefuente_servicios_prov' + iSeqRow).bind('blur', function() { sc_terceros_06052022_puc_retefuente_servicios_prov_onblur(this, iSeqRow) })
                                                           .bind('change', function() { sc_terceros_06052022_puc_retefuente_servicios_prov_onchange(this, iSeqRow) })
                                                           .bind('focus', function() { sc_terceros_06052022_puc_retefuente_servicios_prov_onfocus(this, iSeqRow) });
  $('#id_sc_field_nube' + iSeqRow).bind('change', function() { sc_terceros_06052022_nube_onchange(this, iSeqRow) });
  $('#id_sc_field_latitude' + iSeqRow).bind('change', function() { sc_terceros_06052022_latitude_onchange(this, iSeqRow) });
  $('#id_sc_field_longitude' + iSeqRow).bind('change', function() { sc_terceros_06052022_longitude_onchange(this, iSeqRow) });
  $('#id_sc_field_activo' + iSeqRow).bind('blur', function() { sc_terceros_06052022_activo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_terceros_06052022_activo_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_terceros_06052022_activo_onfocus(this, iSeqRow) });
  $('#id_sc_field_es_tecnico' + iSeqRow).bind('blur', function() { sc_terceros_06052022_es_tecnico_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_terceros_06052022_es_tecnico_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros_06052022_es_tecnico_onfocus(this, iSeqRow) });
  $('#id_sc_field_codigo_tercero' + iSeqRow).bind('blur', function() { sc_terceros_06052022_codigo_tercero_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_06052022_codigo_tercero_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros_06052022_codigo_tercero_onfocus(this, iSeqRow) });
  $('#id_sc_field_porcentaje_propina_sugerida' + iSeqRow).bind('blur', function() { sc_terceros_06052022_porcentaje_propina_sugerida_onblur(this, iSeqRow) })
                                                         .bind('change', function() { sc_terceros_06052022_porcentaje_propina_sugerida_onchange(this, iSeqRow) })
                                                         .bind('focus', function() { sc_terceros_06052022_porcentaje_propina_sugerida_onfocus(this, iSeqRow) });
  $('#id_sc_field_correo_notificafe' + iSeqRow).bind('blur', function() { sc_terceros_06052022_correo_notificafe_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_terceros_06052022_correo_notificafe_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_terceros_06052022_correo_notificafe_onfocus(this, iSeqRow) });
  $('#id_sc_field_celular_notificafe' + iSeqRow).bind('blur', function() { sc_terceros_06052022_celular_notificafe_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_terceros_06052022_celular_notificafe_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_terceros_06052022_celular_notificafe_onfocus(this, iSeqRow) });
  $('#id_sc_field_archivo_cedula' + iSeqRow).bind('blur', function() { sc_terceros_06052022_archivo_cedula_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_06052022_archivo_cedula_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros_06052022_archivo_cedula_onfocus(this, iSeqRow) });
  $('#id_sc_field_archivo_rut' + iSeqRow).bind('blur', function() { sc_terceros_06052022_archivo_rut_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_terceros_06052022_archivo_rut_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros_06052022_archivo_rut_onfocus(this, iSeqRow) });
  $('#id_sc_field_archivo_nit' + iSeqRow).bind('blur', function() { sc_terceros_06052022_archivo_nit_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_terceros_06052022_archivo_nit_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros_06052022_archivo_nit_onfocus(this, iSeqRow) });
  $('#id_sc_field_archivo_pago' + iSeqRow).bind('blur', function() { sc_terceros_06052022_archivo_pago_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_terceros_06052022_archivo_pago_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_terceros_06052022_archivo_pago_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_plan' + iSeqRow).bind('blur', function() { sc_terceros_06052022_id_plan_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_id_plan_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_id_plan_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor_plan' + iSeqRow).bind('blur', function() { sc_terceros_06052022_valor_plan_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_terceros_06052022_valor_plan_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_terceros_06052022_valor_plan_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_registro_fe' + iSeqRow).bind('blur', function() { sc_terceros_06052022_fecha_registro_fe_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_terceros_06052022_fecha_registro_fe_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_terceros_06052022_fecha_registro_fe_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_registro_fe_hora' + iSeqRow).bind('blur', function() { sc_terceros_06052022_fecha_registro_fe_hora_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_terceros_06052022_fecha_registro_fe_hora_onchange(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros_06052022_fecha_registro_fe_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_contador' + iSeqRow).bind('blur', function() { sc_terceros_06052022_nombre_contador_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_terceros_06052022_nombre_contador_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_terceros_06052022_nombre_contador_onfocus(this, iSeqRow) });
  $('#id_sc_field_estado' + iSeqRow).bind('blur', function() { sc_terceros_06052022_estado_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_terceros_06052022_estado_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_terceros_06052022_estado_onfocus(this, iSeqRow) });
  $('#id_sc_field_si_nomina' + iSeqRow).bind('blur', function() { sc_terceros_06052022_si_nomina_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_terceros_06052022_si_nomina_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_terceros_06052022_si_nomina_onfocus(this, iSeqRow) });
  $('#id_sc_field_si_factura_electronica' + iSeqRow).bind('blur', function() { sc_terceros_06052022_si_factura_electronica_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_terceros_06052022_si_factura_electronica_onchange(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros_06052022_si_factura_electronica_onfocus(this, iSeqRow) });
  $('#id_sc_field_nombre_empresa_bd' + iSeqRow).bind('blur', function() { sc_terceros_06052022_nombre_empresa_bd_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_terceros_06052022_nombre_empresa_bd_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_terceros_06052022_nombre_empresa_bd_onfocus(this, iSeqRow) });
  $('#id_sc_field_n_trabajadores' + iSeqRow).bind('blur', function() { sc_terceros_06052022_n_trabajadores_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_terceros_06052022_n_trabajadores_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_terceros_06052022_n_trabajadores_onfocus(this, iSeqRow) });
  $('#id_sc_field_archivos' + iSeqRow).bind('blur', function() { sc_terceros_06052022_archivos_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros_06052022_archivos_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros_06052022_archivos_onfocus(this, iSeqRow) });
  $('#id_sc_field_c_postal' + iSeqRow).bind('blur', function() { sc_terceros_06052022_c_postal_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros_06052022_c_postal_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros_06052022_c_postal_onfocus(this, iSeqRow) });
  $('#id_sc_field_ciiu' + iSeqRow).bind('blur', function() { sc_terceros_06052022_ciiu_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_terceros_06052022_ciiu_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_terceros_06052022_ciiu_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupodis' + iSeqRow).bind('blur', function() { sc_terceros_06052022_cupodis_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_terceros_06052022_cupodis_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_terceros_06052022_cupodis_onfocus(this, iSeqRow) });
  $('#id_sc_field_departamento' + iSeqRow).bind('blur', function() { sc_terceros_06052022_departamento_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_terceros_06052022_departamento_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_terceros_06052022_departamento_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle_tributario' + iSeqRow).bind('blur', function() { sc_terceros_06052022_detalle_tributario_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_terceros_06052022_detalle_tributario_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_terceros_06052022_detalle_tributario_onfocus(this, iSeqRow) });
  $('#id_sc_field_r_social' + iSeqRow).bind('blur', function() { sc_terceros_06052022_r_social_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros_06052022_r_social_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros_06052022_r_social_onfocus(this, iSeqRow) });
  $('#id_sc_field_relleno2' + iSeqRow).bind('blur', function() { sc_terceros_06052022_relleno2_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_terceros_06052022_relleno2_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_terceros_06052022_relleno2_onfocus(this, iSeqRow) });
  $('#id_sc_field_responsabilidad_fiscal' + iSeqRow).bind('blur', function() { sc_terceros_06052022_responsabilidad_fiscal_onblur(this, iSeqRow) })
                                                    .bind('change', function() { sc_terceros_06052022_responsabilidad_fiscal_onchange(this, iSeqRow) })
                                                    .bind('focus', function() { sc_terceros_06052022_responsabilidad_fiscal_onfocus(this, iSeqRow) });
  $('#id_sc_field_sucursales' + iSeqRow).bind('change', function() { sc_terceros_06052022_sucursales_onchange(this, iSeqRow) });
  $('#id_sc_field_direcciones' + iSeqRow).bind('blur', function() { sc_terceros_06052022_direcciones_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_terceros_06052022_direcciones_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_terceros_06052022_direcciones_onfocus(this, iSeqRow) });
...
function sc_terceros_06052022_idtercero_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_idtercero();
  scCssBlur(oThis);
}

function sc_terceros_06052022_idtercero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_idtercero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_documento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_documento();
  scCssBlur(oThis);
}

function sc_terceros_06052022_documento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_documento_onchange();
}

function sc_terceros_06052022_documento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_nombres_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_nombres();
  scCssBlur(oThis);
  do_ajax_terceros_06052022_event_nombres_onblur();
}

function sc_terceros_06052022_nombres_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_nombres_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_terceros_06052022_event_nombres_onfocus();
}

function sc_terceros_06052022_direccion_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_direccion();
  scCssBlur(oThis);
}

function sc_terceros_06052022_direccion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_direccion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_tel_cel_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_tel_cel();
  scCssBlur(oThis);
}

function sc_terceros_06052022_tel_cel_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_tel_cel_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_nacimiento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_nacimiento();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nacimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_nacimiento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_sexo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_sexo();
  scCssBlur(oThis);
}

function sc_terceros_06052022_sexo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_sexo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_urlmail_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_urlmail();
  scCssBlur(oThis);
}

function sc_terceros_06052022_urlmail_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_urlmail_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_fechault_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_fechault();
  scCssBlur(oThis);
}

function sc_terceros_06052022_fechault_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_fechault_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_saldo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_saldo();
  scCssBlur(oThis);
}

function sc_terceros_06052022_saldo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_saldo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_afiliacion_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_afiliacion();
  scCssBlur(oThis);
}

function sc_terceros_06052022_afiliacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_afiliacion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_idmuni_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_idmuni();
  scCssBlur(oThis);
}

function sc_terceros_06052022_idmuni_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_refresh_idmuni();
}

function sc_terceros_06052022_idmuni_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_observaciones();
  scCssBlur(oThis);
}

function sc_terceros_06052022_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_credito_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_credito();
  scCssBlur(oThis);
}

function sc_terceros_06052022_credito_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_credito_onchange();
}

function sc_terceros_06052022_credito_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_cupo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_cupo();
  scCssBlur(oThis);
}

function sc_terceros_06052022_cupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_cupo_onchange();
}

function sc_terceros_06052022_cupo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_listaprecios_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_listaprecios();
  scCssBlur(oThis);
}

function sc_terceros_06052022_listaprecios_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_listaprecios_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_loatiende_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_loatiende();
  scCssBlur(oThis);
}

function sc_terceros_06052022_loatiende_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_loatiende_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_con_actual_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_con_actual_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_efec_retencion_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_efec_retencion();
  scCssBlur(oThis);
}

function sc_terceros_06052022_efec_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_efec_retencion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_regimen_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_regimen();
  scCssBlur(oThis);
}

function sc_terceros_06052022_regimen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_regimen_onchange();
}

function sc_terceros_06052022_regimen_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_tipo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_tipo();
  scCssBlur(oThis);
}

function sc_terceros_06052022_tipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_tipo_onchange();
}

function sc_terceros_06052022_tipo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_cliente_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_cliente();
  scCssBlur(oThis);
}

function sc_terceros_06052022_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_cliente_onchange();
}

function sc_terceros_06052022_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_empleado_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_empleado();
  scCssBlur(oThis);
}

function sc_terceros_06052022_empleado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_empleado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_proveedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_proveedor();
  scCssBlur(oThis);
}

function sc_terceros_06052022_proveedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_proveedor_onchange();
}

function sc_terceros_06052022_proveedor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_contacto_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_contacto();
  scCssBlur(oThis);
}

function sc_terceros_06052022_contacto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_contacto_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_telefonos_prov_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_telefonos_prov();
  scCssBlur(oThis);
}

function sc_terceros_06052022_telefonos_prov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_telefonos_prov_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_email_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_email();
  scCssBlur(oThis);
}

function sc_terceros_06052022_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_email_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_url_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_url();
  scCssBlur(oThis);
}

function sc_terceros_06052022_url_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_url_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_creditoprov_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_creditoprov();
  scCssBlur(oThis);
}

function sc_terceros_06052022_creditoprov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_creditoprov_onchange();
}

function sc_terceros_06052022_creditoprov_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_dias_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_dias();
  scCssBlur(oThis);
}

function sc_terceros_06052022_dias_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_dias_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_fechultcomp_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_fechultcomp();
  scCssBlur(oThis);
}

function sc_terceros_06052022_fechultcomp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_fechultcomp_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_saldoapagar_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_saldoapagar();
  scCssBlur(oThis);
}

function sc_terceros_06052022_saldoapagar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_saldoapagar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_autoretenedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_autoretenedor();
  scCssBlur(oThis);
}

function sc_terceros_06052022_autoretenedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_autoretenedor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_tipo_documento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_tipo_documento();
  scCssBlur(oThis);
}

function sc_terceros_06052022_tipo_documento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_tipo_documento_onchange();
}

function sc_terceros_06052022_tipo_documento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_dv_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_dv();
  scCssBlur(oThis);
}

function sc_terceros_06052022_dv_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_dv_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_nombre1_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_nombre1();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nombre1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_nombre1_onchange();
}

function sc_terceros_06052022_nombre1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_nombre2_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_nombre2();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nombre2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_nombre2_onchange();
}

function sc_terceros_06052022_nombre2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_apellido1_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_apellido1();
  scCssBlur(oThis);
}

function sc_terceros_06052022_apellido1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_apellido1_onchange();
}

function sc_terceros_06052022_apellido1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_apellido2_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_apellido2();
  scCssBlur(oThis);
}

function sc_terceros_06052022_apellido2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_apellido2_onchange();
}

function sc_terceros_06052022_apellido2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_sucur_cliente_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_sucur_cliente();
  scCssBlur(oThis);
}

function sc_terceros_06052022_sucur_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_sucur_cliente_onchange();
}

function sc_terceros_06052022_sucur_cliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_representante_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_representante();
  scCssBlur(oThis);
}

function sc_terceros_06052022_representante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_representante_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_imagenter_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_es_restaurante_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_es_restaurante();
  scCssBlur(oThis);
}

function sc_terceros_06052022_es_restaurante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_es_restaurante_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_dias_credito_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_dias_credito();
  scCssBlur(oThis);
}

function sc_terceros_06052022_dias_credito_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_dias_credito_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_dias_mora_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_dias_mora();
  scCssBlur(oThis);
}

function sc_terceros_06052022_dias_mora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_dias_mora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_cupo_vendedor_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_cupo_vendedor();
  scCssBlur(oThis);
}

function sc_terceros_06052022_cupo_vendedor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_cupo_vendedor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_codigo_ter_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_codigo_ter();
  scCssBlur(oThis);
}

function sc_terceros_06052022_codigo_ter_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_codigo_ter_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_es_cajero_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_es_cajero();
  scCssBlur(oThis);
}

function sc_terceros_06052022_es_cajero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_es_cajero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_autorizado_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_autorizado();
  scCssBlur(oThis);
}

function sc_terceros_06052022_autorizado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_autorizado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_zona_clientes_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_zona_clientes();
  scCssBlur(oThis);
}

function sc_terceros_06052022_zona_clientes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_zona_clientes_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_clasificacion_clientes_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_clasificacion_clientes();
  scCssBlur(oThis);
}

function sc_terceros_06052022_clasificacion_clientes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_clasificacion_clientes_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_creado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_creado_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_disponible_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_id_pedido_tmp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_n_pedido_tmp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_total_pedido_tmp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_obs_pedido_tmp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_vend_pedido_tmp_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_ciudad_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_ciudad();
  scCssBlur(oThis);
}

function sc_terceros_06052022_ciudad_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_ciudad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_codigo_postal_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_codigo_postal();
  scCssBlur(oThis);
}

function sc_terceros_06052022_codigo_postal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_codigo_postal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_lenguaje_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_lenguaje();
  scCssBlur(oThis);
}

function sc_terceros_06052022_lenguaje_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_lenguaje_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_nombre_comercil_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_nombre_comercil();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nombre_comercil_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_nombre_comercil_onchange();
}

function sc_terceros_06052022_nombre_comercil_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_notificar_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_notificar();
  scCssBlur(oThis);
}

function sc_terceros_06052022_notificar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_notificar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_puc_auxiliar_deudores_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_puc_auxiliar_deudores();
  scCssBlur(oThis);
}

function sc_terceros_06052022_puc_auxiliar_deudores_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_puc_auxiliar_deudores_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_puc_retefuente_ventas_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_puc_retefuente_ventas();
  scCssBlur(oThis);
}

function sc_terceros_06052022_puc_retefuente_ventas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_puc_retefuente_ventas_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_puc_retefuente_servicios_clie_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_puc_retefuente_servicios_clie();
  scCssBlur(oThis);
}

function sc_terceros_06052022_puc_retefuente_servicios_clie_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_puc_retefuente_servicios_clie_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_puc_auxiliar_proveedores_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_puc_auxiliar_proveedores();
  scCssBlur(oThis);
}

function sc_terceros_06052022_puc_auxiliar_proveedores_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_puc_auxiliar_proveedores_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_puc_retefuente_compras_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_puc_retefuente_compras();
  scCssBlur(oThis);
}

function sc_terceros_06052022_puc_retefuente_compras_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_puc_retefuente_compras_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_puc_retefuente_servicios_prov_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_puc_retefuente_servicios_prov();
  scCssBlur(oThis);
}

function sc_terceros_06052022_puc_retefuente_servicios_prov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_puc_retefuente_servicios_prov_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_nube_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_latitude_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_longitude_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_activo_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_activo();
  scCssBlur(oThis);
}

function sc_terceros_06052022_activo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_activo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_es_tecnico_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_es_tecnico();
  scCssBlur(oThis);
}

function sc_terceros_06052022_es_tecnico_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_es_tecnico_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_codigo_tercero_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_codigo_tercero();
  scCssBlur(oThis);
}

function sc_terceros_06052022_codigo_tercero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_codigo_tercero_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_porcentaje_propina_sugerida_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_porcentaje_propina_sugerida();
  scCssBlur(oThis);
}

function sc_terceros_06052022_porcentaje_propina_sugerida_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_porcentaje_propina_sugerida_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_correo_notificafe_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_correo_notificafe();
  scCssBlur(oThis);
}

function sc_terceros_06052022_correo_notificafe_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_correo_notificafe_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_celular_notificafe_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_celular_notificafe();
  scCssBlur(oThis);
}

function sc_terceros_06052022_celular_notificafe_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_celular_notificafe_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_archivo_cedula_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_terceros_06052022_archivo_cedula_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_archivo_cedula_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_archivo_rut_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_terceros_06052022_archivo_rut_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_archivo_rut_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_archivo_nit_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_terceros_06052022_archivo_nit_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_archivo_nit_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_archivo_pago_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_terceros_06052022_archivo_pago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_archivo_pago_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_terceros_06052022_id_plan_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_id_plan();
  scCssBlur(oThis);
}

function sc_terceros_06052022_id_plan_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_id_plan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_valor_plan_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_valor_plan();
  scCssBlur(oThis);
}

function sc_terceros_06052022_valor_plan_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_valor_plan_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_fecha_registro_fe_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_fecha_registro_fe();
  scCssBlur(oThis);
}

function sc_terceros_06052022_fecha_registro_fe_hora_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_fecha_registro_fe();
  scCssBlur(oThis);
}

function sc_terceros_06052022_fecha_registro_fe_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_fecha_registro_fe_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_fecha_registro_fe_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_fecha_registro_fe_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_nombre_contador_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_nombre_contador();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nombre_contador_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_nombre_contador_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_estado_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_estado();
  scCssBlur(oThis);
}

function sc_terceros_06052022_estado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_estado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_si_nomina_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_si_nomina();
  scCssBlur(oThis);
}

function sc_terceros_06052022_si_nomina_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_si_nomina_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_si_factura_electronica_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_si_factura_electronica();
  scCssBlur(oThis);
}

function sc_terceros_06052022_si_factura_electronica_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_si_factura_electronica_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_nombre_empresa_bd_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_nombre_empresa_bd();
  scCssBlur(oThis);
}

function sc_terceros_06052022_nombre_empresa_bd_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_nombre_empresa_bd_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_n_trabajadores_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_n_trabajadores();
  scCssBlur(oThis);
}

function sc_terceros_06052022_n_trabajadores_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_n_trabajadores_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_archivos_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_archivos();
  scCssBlur(oThis);
}

function sc_terceros_06052022_archivos_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_archivos_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_c_postal_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_c_postal();
  scCssBlur(oThis);
}

function sc_terceros_06052022_c_postal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_c_postal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_ciiu_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_ciiu();
  scCssBlur(oThis);
}

function sc_terceros_06052022_ciiu_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_ciiu_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_cupodis_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_cupodis();
  scCssBlur(oThis);
}

function sc_terceros_06052022_cupodis_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_cupodis_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_departamento_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_departamento();
  scCssBlur(oThis);
}

function sc_terceros_06052022_departamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_refresh_departamento();
}

function sc_terceros_06052022_departamento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_detalle_tributario_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_detalle_tributario();
  scCssBlur(oThis);
}

function sc_terceros_06052022_detalle_tributario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_detalle_tributario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_r_social_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_r_social();
  scCssBlur(oThis);
}

function sc_terceros_06052022_r_social_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_terceros_06052022_event_r_social_onchange();
}

function sc_terceros_06052022_r_social_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_relleno2_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_relleno2();
  scCssBlur(oThis);
}

function sc_terceros_06052022_relleno2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_relleno2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_responsabilidad_fiscal_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_responsabilidad_fiscal();
  scCssBlur(oThis);
}

function sc_terceros_06052022_responsabilidad_fiscal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_responsabilidad_fiscal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_terceros_06052022_sucursales_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_direcciones_onblur(oThis, iSeqRow) {
  do_ajax_terceros_06052022_validate_direcciones();
  scCssBlur(oThis);
}

function sc_terceros_06052022_direcciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_terceros_06052022_direcciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_terceros_06052022_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_nacimiento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_06052022_validate_nacimiento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechault" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_06052022_validate_fechault(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_afiliacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_terceros_06052022_validate_afiliacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecha_registro_fe" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_06052022_validate_fecha_registro_fe(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_con_actual" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_06052022_validate_con_actual(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_terceros_06052022_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_archivo_cedula" + iSeqRow).fileupload({
    datatype: "json",
    url: "terceros_06052022_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'terceros_06052022')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
