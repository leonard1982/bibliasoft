<div id="terceros_06052022_mob_form3" style='<?php echo ($this->tabCssClass["terceros_06052022_mob_form3"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_06052022_mob']['Lookup_autoretenedor'][] = 'SI'; ?>
 <option  value="NO" <?php  if ($this->autoretenedor == "NO") { echo " selected" ;} ?><?php  if (empty($this->autoretenedor)) { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_06052022_mob']['Lookup_autoretenedor'][] = 'NO'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_06052022_mob']['Lookup_creditoprov'][] = 'SI'; ?>
 <option  value="NO" <?php  if ($this->creditoprov == "NO") { echo " selected" ;} ?><?php  if (empty($this->creditoprov)) { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_06052022_mob']['Lookup_creditoprov'][] = 'NO'; ?>
 </select></span>
</span><?php  }?>
