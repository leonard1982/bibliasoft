...
$old_error_handler = set_error_handler("terceros_06052022_scriptcase_error_handler");

function terceros_06052022_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['terceros_06052022']['contr_erro']) && $_SESSION['scriptcase']['terceros_06052022']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_terceros_06052022->contr_terceros_06052022->Apl_com_erro = true;
            if ($inicial_terceros_06052022->contr_terceros_06052022->NM_ajax_flag)
            {
                $inicial_terceros_06052022->contr_terceros_06052022->NM_ajax_info['errList']['geral_terceros_06052022'][] = $msg;
                return;
            }
            terceros_06052022_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function terceros_06052022_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['terceros_06052022'])  && '' != $_SESSION['scriptcase']['error_icon']['terceros_06052022'])  ? $_SESSION['scriptcase']['error_icon']['terceros_06052022']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['terceros_06052022']) && '' != $_SESSION['scriptcase']['error_close']['terceros_06052022']) ? $_SESSION['scriptcase']['error_close']['terceros_06052022'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['terceros_06052022']) && '' != $_SESSION['scriptcase']['error_span_title']['terceros_06052022']) ? $_SESSION['scriptcase']['error_span_title']['terceros_06052022'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['terceros_06052022']) && '' != $_SESSION['scriptcase']['error_icon_title']['terceros_06052022']) ? $_SESSION['scriptcase']['error_icon_title']['terceros_06052022'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['terceros_06052022']['error_buffer'] .= ob_get_flush();
}
