...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_terceros']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_terceros']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_terceros']['embutida_filho'] as $ind => $sc_init)
          {
