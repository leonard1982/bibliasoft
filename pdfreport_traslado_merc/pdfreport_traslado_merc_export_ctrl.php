<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_traslado_merc']['sc_process_barr'] = true;
require_once('../pdfreport_traslado_merc/index.php');
unset($_SESSION['scriptcase']['pdfreport_traslado_merc']['sc_process_barr']);
$ExportCtrl = new pdfreport_traslado_merc_export_control;
$ExportCtrl->Export_barr();

class pdfreport_traslado_merc_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - movimiento</TITLE>
