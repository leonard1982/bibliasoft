<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_facturaven_anterior']['sc_process_barr'] = true;
require_once('../pdfreport_facturaven_anterior/index.php');
unset($_SESSION['scriptcase']['pdfreport_facturaven_anterior']['sc_process_barr']);
$ExportCtrl = new pdfreport_facturaven_anterior_export_control;
$ExportCtrl->Export_barr();

class pdfreport_facturaven_anterior_export_control
{
