...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_plancuentas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_plancuentas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_plancuentas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_plancuentas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_plancuentas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_plancuentas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_plancuentas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_plancuentas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_plancuentas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_plancuentas']['embutida_filho'] as $ind => $sc_init)
          {
