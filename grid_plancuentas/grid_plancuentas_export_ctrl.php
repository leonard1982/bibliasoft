<?php
@session_start() ;
$_SESSION['scriptcase']['grid_plancuentas']['sc_process_barr'] = true;
require_once('../grid_plancuentas/index.php');
unset($_SESSION['scriptcase']['grid_plancuentas']['sc_process_barr']);
$ExportCtrl = new grid_plancuentas_export_control;
$ExportCtrl->Export_barr();

class grid_plancuentas_export_control
{
