...
class pdfreport_facturaven_errorLEO_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_facturaven_errorLEO.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['pdfreport_facturaven_errorLEO']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_errorLEO']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_errorLEO']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_errorLEO']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_errorLEO']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_errorLEO']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_errorLEO']['rtf_name']);
      }
...
$_SESSION['scriptcase']['pdfreport_facturaven_errorLEO']['contr_erro'] = 'off'; 
   ...
   function NM_export_idcli()
   {
         ...
         $this->idcli = NM_charset_to_utf8($this->idcli);
         $this->idcli = str_replace('<', '&lt;', $this->idcli);
         $this->idcli = str_replace('>', '&gt;', $this->idcli);
         $this->Texto_tag .= "<td>" . $this->idcli . "</td>\r\n";
   }
   //----- subtotal
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_errorLEO']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_errorLEO']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
