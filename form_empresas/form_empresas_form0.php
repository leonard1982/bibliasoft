...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_password_admin_label" id="hidden_field_label_password_admin" style="<?php echo $sStyleHidden_password_admin; ?>"><span id="id_label_password_admin"><?php echo $this->nm_new_label['password_admin']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_empresas']['php_cmp_required']['password_admin']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresas']['php_cmp_required']['password_admin'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_password_admin_line" id="hidden_field_data_password_admin" style="<?php echo $sStyleHidden_password_admin; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_password_admin_line" style="vertical-align: top;padding: 0px">
