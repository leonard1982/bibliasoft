  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_empresas" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idempresa
  function do_ajax_form_empresas_validate_idempresa()
  {
    var nomeCampo_idempresa = "idempresa";
    var var_idempresa = scAjaxGetFieldHidden(nomeCampo_idempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_idempresa(var_idempresa, var_script_case_init, do_ajax_form_empresas_validate_idempresa_cb);
  } // do_ajax_form_empresas_validate_idempresa

  function do_ajax_form_empresas_validate_idempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idempresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_idempresa_cb

  // ---------- Validate nit
  function do_ajax_form_empresas_validate_nit()
  {
    var nomeCampo_nit = "nit";
    var var_nit = scAjaxGetFieldText(nomeCampo_nit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_nit(var_nit, var_script_case_init, do_ajax_form_empresas_validate_nit_cb);
  } // do_ajax_form_empresas_validate_nit

  function do_ajax_form_empresas_validate_nit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_nit_cb

  // ---------- Validate nombre
  function do_ajax_form_empresas_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldHidden(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_empresas_validate_nombre_cb);
  } // do_ajax_form_empresas_validate_nombre

  function do_ajax_form_empresas_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_nombre_cb

  // ---------- Validate nombre_empresa
  function do_ajax_form_empresas_validate_nombre_empresa()
  {
    var nomeCampo_nombre_empresa = "nombre_empresa";
    var var_nombre_empresa = scAjaxGetFieldText(nomeCampo_nombre_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_nombre_empresa(var_nombre_empresa, var_script_case_init, do_ajax_form_empresas_validate_nombre_empresa_cb);
  } // do_ajax_form_empresas_validate_nombre_empresa

  function do_ajax_form_empresas_validate_nombre_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_nombre_empresa_cb

  // ---------- Validate observaciones
  function do_ajax_form_empresas_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_empresas_validate_observaciones_cb);
  } // do_ajax_form_empresas_validate_observaciones

  function do_ajax_form_empresas_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_observaciones_cb

  // ---------- Validate creada
  function do_ajax_form_empresas_validate_creada()
  {
    var nomeCampo_creada = "creada";
    var nomeCampo_creada_hora = "creada_hora";
    var var_creada = scAjaxGetFieldHidden(nomeCampo_creada);
    var var_creada_hora = scAjaxGetFieldHidden(nomeCampo_creada_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_creada(var_creada, var_creada_hora, var_script_case_init, do_ajax_form_empresas_validate_creada_cb);
  } // do_ajax_form_empresas_validate_creada

  function do_ajax_form_empresas_validate_creada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_creada_cb

  // ---------- Validate sinmovimiento
  function do_ajax_form_empresas_validate_sinmovimiento()
  {
    var nomeCampo_sinmovimiento = "sinmovimiento";
    var var_sinmovimiento = scAjaxGetFieldCheckbox(nomeCampo_sinmovimiento, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_sinmovimiento(var_sinmovimiento, var_script_case_init, do_ajax_form_empresas_validate_sinmovimiento_cb);
  } // do_ajax_form_empresas_validate_sinmovimiento

  function do_ajax_form_empresas_validate_sinmovimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sinmovimiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_sinmovimiento_cb

  // ---------- Validate copiada_como
  function do_ajax_form_empresas_validate_copiada_como()
  {
    var nomeCampo_copiada_como = "copiada_como";
    var var_copiada_como = scAjaxGetFieldSelect(nomeCampo_copiada_como);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_copiada_como(var_copiada_como, var_script_case_init, do_ajax_form_empresas_validate_copiada_como_cb);
  } // do_ajax_form_empresas_validate_copiada_como

  function do_ajax_form_empresas_validate_copiada_como_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "copiada_como";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_copiada_como_cb

  // ---------- Validate tipo_negocio
  function do_ajax_form_empresas_validate_tipo_negocio()
  {
    var nomeCampo_tipo_negocio = "tipo_negocio";
    var var_tipo_negocio = scAjaxGetFieldSelect(nomeCampo_tipo_negocio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_tipo_negocio(var_tipo_negocio, var_script_case_init, do_ajax_form_empresas_validate_tipo_negocio_cb);
  } // do_ajax_form_empresas_validate_tipo_negocio

  function do_ajax_form_empresas_validate_tipo_negocio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_negocio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_tipo_negocio_cb

  // ---------- Validate predeterminada
  function do_ajax_form_empresas_validate_predeterminada()
  {
    var nomeCampo_predeterminada = "predeterminada";
    var var_predeterminada = scAjaxGetFieldCheckbox(nomeCampo_predeterminada, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_predeterminada(var_predeterminada, var_script_case_init, do_ajax_form_empresas_validate_predeterminada_cb);
  } // do_ajax_form_empresas_validate_predeterminada

  function do_ajax_form_empresas_validate_predeterminada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_predeterminada_cb

  // ---------- Validate password
  function do_ajax_form_empresas_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_password(var_password, var_script_case_init, do_ajax_form_empresas_validate_password_cb);
  } // do_ajax_form_empresas_validate_password

  function do_ajax_form_empresas_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_empresas_validate_celular()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_celular(var_celular, var_script_case_init, do_ajax_form_empresas_validate_celular_cb);
  } // do_ajax_form_empresas_validate_celular

  function do_ajax_form_empresas_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_celular_cb

  // ---------- Validate correo
  function do_ajax_form_empresas_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_correo(var_correo, var_script_case_init, do_ajax_form_empresas_validate_correo_cb);
  } // do_ajax_form_empresas_validate_correo

  function do_ajax_form_empresas_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_validate_correo_cb

  // ---------- Validate comentario
  function do_ajax_form_empresas_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldText(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_empresas_validate_comentario_cb);
  } // do_ajax_form_empresas_validate_comentario

  function do_ajax_form_empresas_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_empresas_event_predeterminada_onclick()
  {
    ...
    var var_idempresa = scAjaxGetFieldHidden("idempresa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresas_event_predeterminada_onclick(var_predeterminada, var_idempresa, var_script_case_init, do_ajax_form_empresas_event_predeterminada_onclick_cb);
  } // do_ajax_form_empresas_event_predeterminada_onclick

  function do_ajax_form_empresas_event_predeterminada_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "predeterminada";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresas_event_predeterminada_onclick_cb_after_alert);
  } // do_ajax_form_empresas_event_predeterminada_onclick_cb
  function do_ajax_form_empresas_event_predeterminada_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresas_event_predeterminada_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_empresas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empresas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idempresa = scAjaxGetFieldHidden("idempresa");
    ...
    var var_creada = scAjaxGetFieldHidden("creada");
    var var_creada_hora = scAjaxGetFieldHidden("creada_hora");
    var var_sinmovimiento = scAjaxGetFieldCheckbox("sinmovimiento", ";");
    var var_copiada_como = scAjaxGetFieldSelect("copiada_como");
  ...
  function do_ajax_form_empresas_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idempresa");
      ...
      scAjaxHideErrorDisplay("creada");
      scAjaxHideErrorDisplay("sinmovimiento");
      scAjaxHideErrorDisplay("copiada_como");
...
?>
  ...
  } // do_ajax_form_empresas_submit_form_cb
  function do_ajax_form_empresas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_empresas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_empresas_navigate_form()
  {
    perform_ajax_form_empresas_navigate_form();
  }

  function perform_ajax_form_empresas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_empresas_navigate_form(var_idempresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_empresas_navigate_form_cb);
  } // do_ajax_form_empresas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_empresas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idempresa.value = scAjaxGetKeyValue("idempresa");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_empresas_navigate_form_cb_after_alert);
  } // do_ajax_form_empresas_navigate_form_cb
  function do_ajax_form_empresas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_empresas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_empresas_navigate_form_cb_after_alert
  function sc_hide_form_empresas_form()
  {
  ...
  ajax_field_list[0] = "idempresa";
  ajax_field_list[1] = "nit";
  ajax_field_list[2] = "nombre";
  ajax_field_list[3] = "nombre_empresa";
  ajax_field_list[4] = "observaciones";
  ajax_field_list[5] = "creada";
  ajax_field_list[6] = "sinmovimiento";
  ajax_field_list[7] = "copiada_como";
  ...
  var ajax_error_list = {
    ...
    "nombre": {"label": "Nombre Archivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre_empresa": {"label": "Nombre Empresa (BD)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "creada": {"label": "Creada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sinmovimiento": {"label": "Sin movimientos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "copiada_como": {"label": " Copiada como", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "creada": new Array(),
    "sinmovimiento": new Array(),
    "copiada_como": new Array(),
  ...
  ajax_field_mult["creada"][1] = "creada";
  ajax_field_mult["sinmovimiento"][1] = "sinmovimiento";
  ajax_field_mult["copiada_como"][1] = "copiada_como";
  ...
  var ajax_field_id = {
    ...
    "creada": new Array("hidden_field_label_creada", "hidden_field_data_creada", "hidden_field_label_creada_hora", "hidden_field_data_creada_hora"),
    "sinmovimiento": new Array("hidden_field_label_sinmovimiento", "hidden_field_data_sinmovimiento"),
    "copiada_como": new Array("hidden_field_label_copiada_como", "hidden_field_data_copiada_como"),
