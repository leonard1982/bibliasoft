...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_empresas_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_empresas_mob_submit_form(var_idempresa, var_nit, var_nombre, var_nombre_empresa, var_observaciones, var_creada, var_creada_hora, var_sinmovimiento, var_copiada_como, var_tipo_negocio, var_predeterminada, var_password, var_celular, var_correo, var_comentario, var_entorno, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_empresas_mob_submit_form_cb);
