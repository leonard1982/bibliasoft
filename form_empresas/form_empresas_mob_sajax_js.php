  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_empresas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_empresas_mob_form();
	}
...
?>
  ...
  // ---------- Validate idempresa
  function do_ajax_form_empresas_mob_validate_idempresa()
  {
    var nomeCampo_idempresa = "idempresa";
    var var_idempresa = scAjaxGetFieldHidden(nomeCampo_idempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_idempresa(var_idempresa, var_script_case_init, do_ajax_form_empresas_mob_validate_idempresa_cb);
  } // do_ajax_form_empresas_mob_validate_idempresa

  function do_ajax_form_empresas_mob_validate_idempresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_idempresa_cb

  // ---------- Validate nit
  function do_ajax_form_empresas_mob_validate_nit()
  {
    var nomeCampo_nit = "nit";
    var var_nit = scAjaxGetFieldText(nomeCampo_nit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_nit(var_nit, var_script_case_init, do_ajax_form_empresas_mob_validate_nit_cb);
  } // do_ajax_form_empresas_mob_validate_nit

  function do_ajax_form_empresas_mob_validate_nit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_nit_cb

  // ---------- Validate nombre
  function do_ajax_form_empresas_mob_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldHidden(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_empresas_mob_validate_nombre_cb);
  } // do_ajax_form_empresas_mob_validate_nombre

  function do_ajax_form_empresas_mob_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_nombre_cb

  // ---------- Validate nombre_empresa
  function do_ajax_form_empresas_mob_validate_nombre_empresa()
  {
    var nomeCampo_nombre_empresa = "nombre_empresa";
    var var_nombre_empresa = scAjaxGetFieldText(nomeCampo_nombre_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_nombre_empresa(var_nombre_empresa, var_script_case_init, do_ajax_form_empresas_mob_validate_nombre_empresa_cb);
  } // do_ajax_form_empresas_mob_validate_nombre_empresa

  function do_ajax_form_empresas_mob_validate_nombre_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_nombre_empresa_cb

  // ---------- Validate observaciones
  function do_ajax_form_empresas_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_empresas_mob_validate_observaciones_cb);
  } // do_ajax_form_empresas_mob_validate_observaciones

  function do_ajax_form_empresas_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_observaciones_cb

  // ---------- Validate creada
  function do_ajax_form_empresas_mob_validate_creada()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_creada(var_creada, var_creada_hora, var_script_case_init, do_ajax_form_empresas_mob_validate_creada_cb);
  } // do_ajax_form_empresas_mob_validate_creada

  function do_ajax_form_empresas_mob_validate_creada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_creada_cb

  // ---------- Validate sinmovimiento
  function do_ajax_form_empresas_mob_validate_sinmovimiento()
  {
    var nomeCampo_sinmovimiento = "sinmovimiento";
    var var_sinmovimiento = scAjaxGetFieldCheckbox(nomeCampo_sinmovimiento, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_sinmovimiento(var_sinmovimiento, var_script_case_init, do_ajax_form_empresas_mob_validate_sinmovimiento_cb);
  } // do_ajax_form_empresas_mob_validate_sinmovimiento

  function do_ajax_form_empresas_mob_validate_sinmovimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_sinmovimiento_cb

  // ---------- Validate copiada_como
  function do_ajax_form_empresas_mob_validate_copiada_como()
  {
    var nomeCampo_copiada_como = "copiada_como";
    var var_copiada_como = scAjaxGetFieldSelect(nomeCampo_copiada_como);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_copiada_como(var_copiada_como, var_script_case_init, do_ajax_form_empresas_mob_validate_copiada_como_cb);
  } // do_ajax_form_empresas_mob_validate_copiada_como

  function do_ajax_form_empresas_mob_validate_copiada_como_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_copiada_como_cb

  // ---------- Validate tipo_negocio
  function do_ajax_form_empresas_mob_validate_tipo_negocio()
  {
    var nomeCampo_tipo_negocio = "tipo_negocio";
    var var_tipo_negocio = scAjaxGetFieldSelect(nomeCampo_tipo_negocio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_tipo_negocio(var_tipo_negocio, var_script_case_init, do_ajax_form_empresas_mob_validate_tipo_negocio_cb);
  } // do_ajax_form_empresas_mob_validate_tipo_negocio

  function do_ajax_form_empresas_mob_validate_tipo_negocio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_tipo_negocio_cb

  // ---------- Validate predeterminada
  function do_ajax_form_empresas_mob_validate_predeterminada()
  {
    var nomeCampo_predeterminada = "predeterminada";
    var var_predeterminada = scAjaxGetFieldCheckbox(nomeCampo_predeterminada, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_predeterminada(var_predeterminada, var_script_case_init, do_ajax_form_empresas_mob_validate_predeterminada_cb);
  } // do_ajax_form_empresas_mob_validate_predeterminada

  function do_ajax_form_empresas_mob_validate_predeterminada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_predeterminada_cb

  // ---------- Validate password
  function do_ajax_form_empresas_mob_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_password(var_password, var_script_case_init, do_ajax_form_empresas_mob_validate_password_cb);
  } // do_ajax_form_empresas_mob_validate_password

  function do_ajax_form_empresas_mob_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_password_cb

  // ---------- Validate celular
  function do_ajax_form_empresas_mob_validate_celular()
  {
    var nomeCampo_celular = "celular";
    var var_celular = scAjaxGetFieldText(nomeCampo_celular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_celular(var_celular, var_script_case_init, do_ajax_form_empresas_mob_validate_celular_cb);
  } // do_ajax_form_empresas_mob_validate_celular

  function do_ajax_form_empresas_mob_validate_celular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "celular";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_celular_cb

  // ---------- Validate correo
  function do_ajax_form_empresas_mob_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_correo(var_correo, var_script_case_init, do_ajax_form_empresas_mob_validate_correo_cb);
  } // do_ajax_form_empresas_mob_validate_correo

  function do_ajax_form_empresas_mob_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_correo_cb

  // ---------- Validate comentario
  function do_ajax_form_empresas_mob_validate_comentario()
  {
    var nomeCampo_comentario = "comentario";
    var var_comentario = scAjaxGetFieldText(nomeCampo_comentario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_comentario(var_comentario, var_script_case_init, do_ajax_form_empresas_mob_validate_comentario_cb);
  } // do_ajax_form_empresas_mob_validate_comentario

  function do_ajax_form_empresas_mob_validate_comentario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_comentario_cb

  // ---------- Validate entorno
  function do_ajax_form_empresas_mob_validate_entorno()
  {
    var nomeCampo_entorno = "entorno";
    var var_entorno = scAjaxGetFieldSelect(nomeCampo_entorno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_entorno(var_entorno, var_script_case_init, do_ajax_form_empresas_mob_validate_entorno_cb);
  } // do_ajax_form_empresas_mob_validate_entorno

  function do_ajax_form_empresas_mob_validate_entorno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "entorno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_entorno_cb

  // ---------- Validate nomina
  function do_ajax_form_empresas_mob_validate_nomina()
  {
    var nomeCampo_nomina = "nomina";
    var var_nomina = scAjaxGetFieldCheckbox(nomeCampo_nomina, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_nomina(var_nomina, var_script_case_init, do_ajax_form_empresas_mob_validate_nomina_cb);
  } // do_ajax_form_empresas_mob_validate_nomina

  function do_ajax_form_empresas_mob_validate_nomina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomina";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_nomina_cb

  // ---------- Validate codempresa
  function do_ajax_form_empresas_mob_validate_codempresa()
  {
    var nomeCampo_codempresa = "codempresa";
    var var_codempresa = scAjaxGetFieldText(nomeCampo_codempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_codempresa(var_codempresa, var_script_case_init, do_ajax_form_empresas_mob_validate_codempresa_cb);
  } // do_ajax_form_empresas_mob_validate_codempresa

  function do_ajax_form_empresas_mob_validate_codempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_codempresa_cb

  // ---------- Validate nombre_empresa_nomina
  function do_ajax_form_empresas_mob_validate_nombre_empresa_nomina()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_nombre_empresa_nomina(var_nombre_empresa_nomina, var_script_case_init, do_ajax_form_empresas_mob_validate_nombre_empresa_nomina_cb);
  } // do_ajax_form_empresas_mob_validate_nombre_empresa_nomina

  function do_ajax_form_empresas_mob_validate_nombre_empresa_nomina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_nombre_empresa_nomina_cb

  // ---------- Event onclick predeterminada
  function do_ajax_form_empresas_mob_event_predeterminada_onclick()
  {
    var var_predeterminada = scAjaxGetFieldCheckbox("predeterminada", ";");
    var var_idempresa = scAjaxGetFieldHidden("idempresa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_empresas_mob_event_predeterminada_onclick(var_predeterminada, var_idempresa, var_script_case_init, do_ajax_form_empresas_mob_event_predeterminada_onclick_cb);
  } // do_ajax_form_empresas_mob_event_predeterminada_onclick

  function do_ajax_form_empresas_mob_event_predeterminada_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "predeterminada";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_empresas_mob_event_predeterminada_onclick_cb_after_alert);
  } // do_ajax_form_empresas_mob_event_predeterminada_onclick_cb
  function do_ajax_form_empresas_mob_event_predeterminada_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_empresas_mob_event_predeterminada_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_empresas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_empresas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idempresa = scAjaxGetFieldHidden("idempresa");
    ...
    scAjaxProcOn();
    x_ajax_form_empresas_mob_submit_form(var_idempresa, var_nit, var_nombre, var_nombre_empresa, var_observaciones, var_creada, var_creada_hora, var_sinmovimiento, var_copiada_como, var_tipo_negocio, var_predeterminada, var_password, var_celular, var_correo, var_comentario, var_entorno, var_nomina, var_codempresa, var_nombre_empresa_nomina, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_empresas_mob_submit_form_cb);
  } // do_ajax_form_empresas_mob_submit_form

  function do_ajax_form_empresas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_empresas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_empresas_mob_submit_form_cb
  function do_ajax_form_empresas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_empresas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_empresas_mob_navigate_form()
  {
    perform_ajax_form_empresas_mob_navigate_form();
  }

  function perform_ajax_form_empresas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_empresas_mob_navigate_form(var_idempresa, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_empresas_mob_navigate_form_cb);
  } // do_ajax_form_empresas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_empresas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_empresas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_empresas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_empresas_mob_navigate_form_cb
  function do_ajax_form_empresas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_empresas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_empresas_mob_navigate_form_cb_after_alert
  function sc_hide_form_empresas_mob_form()
  {
