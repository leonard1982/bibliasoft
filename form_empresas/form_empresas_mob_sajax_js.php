...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function do_ajax_form_empresas_mob_validate_password_admin()
  {
    var nomeCampo_password_admin = "password_admin";
    var var_password_admin = scAjaxGetFieldText(nomeCampo_password_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_empresas_mob_validate_password_admin(var_password_admin, var_script_case_init, do_ajax_form_empresas_mob_validate_password_admin_cb);
  } // do_ajax_form_empresas_mob_validate_password_admin

  function do_ajax_form_empresas_mob_validate_password_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_empresas_mob_validate_password_admin_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_empresas_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_empresas_mob_submit_form(var_idempresa, var_nit, var_nombre, var_nombre_empresa, var_observaciones, var_creada, var_creada_hora, var_sinmovimiento, var_copiada_como, var_tipo_negocio, var_predeterminada, var_password, var_password_admin, var_celular, var_correo, var_comentario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_empresas_mob_submit_form_cb);
