...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idempresa' + iSeqRow).bind('blur', function() { sc_form_empresas_idempresa_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_empresas_idempresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre' + iSeqRow).bind('blur', function() { sc_form_empresas_nombre_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_empresas_nombre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre_empresa' + iSeqRow).bind('blur', function() { sc_form_empresas_nombre_empresa_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_empresas_nombre_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_empresas_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_empresas_observaciones_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_creada' + iSeqRow).bind('blur', function() { sc_form_empresas_creada_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_empresas_creada_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_empresas_creada_onfocus(this, iSeqRow) });
  $('#id_sc_field_creada_hora' + iSeqRow).bind('blur', function() { sc_form_empresas_creada_hora_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_empresas_creada_hora_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_empresas_creada_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_actualizada' + iSeqRow).bind('change', function() { sc_form_empresas_actualizada_onchange(this, iSeqRow) });
  $('#id_sc_field_actualizada_hora' + iSeqRow).bind('change', function() { sc_form_empresas_actualizada_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_copiada_como' + iSeqRow).bind('blur', function() { sc_form_empresas_copiada_como_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_empresas_copiada_como_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sinmovimiento' + iSeqRow).bind('blur', function() { sc_form_empresas_sinmovimiento_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_empresas_sinmovimiento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo_negocio' + iSeqRow).bind('blur', function() { sc_form_empresas_tipo_negocio_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_empresas_tipo_negocio_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_predeterminada' + iSeqRow).bind('blur', function() { sc_form_empresas_predeterminada_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_empresas_predeterminada_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_password' + iSeqRow).bind('blur', function() { sc_form_empresas_password_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_empresas_password_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nit' + iSeqRow).bind('blur', function() { sc_form_empresas_nit_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_empresas_nit_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_correo' + iSeqRow).bind('blur', function() { sc_form_empresas_correo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_empresas_correo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_comentario' + iSeqRow).bind('blur', function() { sc_form_empresas_comentario_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_empresas_comentario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_password_admin' + iSeqRow).bind('blur', function() { sc_form_empresas_password_admin_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_empresas_password_admin_onchange(this, iSeqRow) })
...
function sc_form_empresas_idempresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_nombre_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_creada_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_empresas_validate_creada();
  scCssBlur(oThis);
}

function sc_form_empresas_creada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empresas_creada_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_creada_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_empresas_actualizada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_empresas_actualizada_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_copiada_como_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_sinmovimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_tipo_negocio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_predeterminada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_password_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_nit_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_correo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_comentario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_celular_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_empresas_password_admin_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_empresas_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_actualizada" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_empresas_validate_actualizada(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_empresas')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
