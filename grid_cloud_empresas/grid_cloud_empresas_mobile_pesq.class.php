...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_empresa";$Nm_numeric[] = "id_empresa";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ccnit"  <?php echo $str_hide_ccnit?>><?php
      if ($ccnit != "")
      {
      $ccnit_look = substr($this->Db->qstr($ccnit), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nombre_razonsocial"  <?php echo $str_hide_nombre_razonsocial?>><?php
