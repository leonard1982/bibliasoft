...
<?php
   ...
   $Ord_Cmp = new grid_cloud_empresas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cloud_empresas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["ccnit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["ccnit"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["ccnit"] : "Código Empresa";
   $tab_ger_campos['nombre_razonsocial'] = "on";
   $tab_def_campos['nombre_razonsocial'] = "nombre_razonsocial";
   $tab_labels["nombre_razonsocial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["nombre_razonsocial"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["nombre_razonsocial"] : "Nombre para mostrar";
   $tab_ger_campos['celular'] = "on";
   $tab_def_campos['celular'] = "celular";
   $tab_labels["celular"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["celular"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["celular"] : "Celular";
   $tab_ger_campos['correo'] = "on";
   $tab_def_campos['correo'] = "correo";
   $tab_labels["correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["correo"] : "Correo";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["activo"] : "Activo";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["creado"] : "Creado";
   $tab_ger_campos['editado'] = "on";
   $tab_def_campos['editado'] = "editado";
   $tab_labels["editado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["editado"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['labels']["editado"] : "Editado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cloud_empresas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cloud_empresas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
