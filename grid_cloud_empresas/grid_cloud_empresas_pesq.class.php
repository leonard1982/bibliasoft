...
class grid_cloud_empresas_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cloud_empresas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cloud_empresas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cloud_empresas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_ccnit')
      {
          $ccnit = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_ccnit($ccnit);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nombre_razonsocial')
      {
          $nombre_razonsocial = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nombre_razonsocial($nombre_razonsocial);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_ccnit($ccnit)
   {
      $ccnit = substr($this->Db->qstr($ccnit), 1, -1);
            $ccnit_look = substr($this->Db->qstr($ccnit), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ccnit from " . $this->Ini->nm_tabela . " where  ccnit like '%" . $ccnit . "%' order by ccnit"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_nombre_razonsocial($nombre_razonsocial)
   {
      $nombre_razonsocial = substr($this->Db->qstr($nombre_razonsocial), 1, -1);
            $nombre_razonsocial_look = substr($this->Db->qstr($nombre_razonsocial), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre_razonsocial from " . $this->Ini->nm_tabela . " where  nombre_razonsocial like '%" . $nombre_razonsocial . "%' order by nombre_razonsocial"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cloud_empresas/grid_cloud_empresas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cloud_empresas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cloud_empresas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_cloud_empresas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cloud_empresas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cloud_empresas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_ccnit_cond#NMF#' + search_get_sel_txt('SC_ccnit_cond') + '@NMF@';
  str_out += 'SC_ccnit#NMF#' + search_get_text('SC_ccnit') + '@NMF@';
  str_out += 'id_ac_ccnit#NMF#' + search_get_text('id_ac_ccnit') + '@NMF@';
  str_out += 'SC_nombre_razonsocial_cond#NMF#' + search_get_sel_txt('SC_nombre_razonsocial_cond') + '@NMF@';
  str_out += 'SC_nombre_razonsocial#NMF#' + search_get_text('SC_nombre_razonsocial') + '@NMF@';
  str_out += 'id_ac_nombre_razonsocial#NMF#' + search_get_text('id_ac_nombre_razonsocial') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_ccnit").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_ccnit").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_ccnit",
          max_itens: "10",
          cod_desc: "N",
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_ccnit").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_nombre_razonsocial").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_nombre_razonsocial").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_nombre_razonsocial",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
     ...
     select: function (event, ui) {
       $("#SC_nombre_razonsocial").val(ui.item.value);
       $(this).val(ui.item.label);
       event.preventDefault();
     },
     focus: function (event, ui) {
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_nombre_razonsocial").val( $(this).val() );
       }
     }
   });
 });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Empresas</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__companies.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   {
      global 
             $ccnit_cond, $ccnit, $ccnit_autocomp,
             $nombre_razonsocial_cond, $nombre_razonsocial, $nombre_razonsocial_autocomp,
             $activo_cond, $activo,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_empresas']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_empresas']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_empresas']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_cloud_empresas", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $ccnit = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['ccnit']; 
          $ccnit_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['ccnit_cond']; 
          $nombre_razonsocial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['nombre_razonsocial']; 
          $nombre_razonsocial_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['nombre_razonsocial_cond']; 
          $activo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['activo']; 
          $activo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['activo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['NM_operador']; 
      } 
      if (!isset($ccnit_cond) || empty($ccnit_cond))
      {
         $ccnit_cond = "qp";
      }
      if (!isset($nombre_razonsocial_cond) || empty($nombre_razonsocial_cond))
      {
         $nombre_razonsocial_cond = "qp";
      }
      ...
      $str_hide_ccnit = (in_array($ccnit_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nombre_razonsocial = (in_array($nombre_razonsocial_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_activo = (in_array($activo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($ccnit) || $ccnit == "")
      {
          $ccnit = "";
      }
      if (isset($ccnit) && !empty($ccnit))
      {
         $tmp_pos = strpos($ccnit, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $ccnit = substr($ccnit, 0, $tmp_pos);
         }
      }
      if (!isset($nombre_razonsocial) || $nombre_razonsocial == "")
      {
          $nombre_razonsocial = "";
      }
      if (isset($nombre_razonsocial) && !empty($nombre_razonsocial))
      {
         $tmp_pos = strpos($nombre_razonsocial, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nombre_razonsocial = substr($nombre_razonsocial, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_ccnit_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['ccnit'])) ? $this->New_label['ccnit'] : "Código Empresa"; ?></TD>
      
      <INPUT type="hidden" id="SC_ccnit_cond" name="ccnit_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ccnit" <?php echo $str_hide_ccnit?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['ccnit'])) ? $this->New_label['ccnit'] : "Código Empresa";
 $nmgp_tab_label .= "ccnit?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $ccnit_look = substr($this->Db->qstr($ccnit), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct ccnit from " . $this->Ini->nm_tabela . " where ccnit = '$ccnit_look' order by ccnit"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$ccnit]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$ccnit];
      }
      else
      {
          $sAutocompValue = $ccnit;
      }
?>
<INPUT  type="text" id="SC_ccnit" name="ccnit" value="<?php echo NM_encode_input($ccnit) ?>"  size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ccnit" name="ccnit_autocomp" size="20"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_nombre_razonsocial_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nombre_razonsocial'])) ? $this->New_label['nombre_razonsocial'] : "Nombre para mostrar"; ?></TD>
      
      <INPUT type="hidden" id="SC_nombre_razonsocial_cond" name="nombre_razonsocial_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nombre_razonsocial" <?php echo $str_hide_nombre_razonsocial?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nombre_razonsocial'])) ? $this->New_label['nombre_razonsocial'] : "Nombre para mostrar";
 $nmgp_tab_label .= "nombre_razonsocial?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<?php
      if ($nombre_razonsocial != "")
      {
      $nombre_razonsocial_look = substr($this->Db->qstr($nombre_razonsocial), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nombre_razonsocial from " . $this->Ini->nm_tabela . " where nombre_razonsocial = '$nombre_razonsocial_look' order by nombre_razonsocial"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$nombre_razonsocial]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nombre_razonsocial];
      }
      else
      {
          $sAutocompValue = $nombre_razonsocial;
      }
?>
<INPUT  type="text" id="SC_nombre_razonsocial" name="nombre_razonsocial" value="<?php echo NM_encode_input($nombre_razonsocial) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombre_razonsocial" name="nombre_razonsocial_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['psq_check_ret']['activo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['psq_check_ret']['activo'][] = "SI";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['psq_check_ret']['activo'][] = "NO";
 ?>
...
?>
<?php
   if (is_file("grid_cloud_empresas_help.txt"))
   {
      $Arq_WebHelp = file("grid_cloud_empresas_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_empresas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_empresas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_empresas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_empresas']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.ccnit_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_ccnit'), document.F1.ccnit_cond, 'ccnit');
   document.F1.ccnit.value = "";
   document.F1.ccnit_autocomp.value = "";
   document.F1.nombre_razonsocial_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nombre_razonsocial'), document.F1.nombre_razonsocial_cond, 'nombre_razonsocial');
   document.F1.nombre_razonsocial.value = "";
   document.F1.nombre_razonsocial_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEB_FE_73/grid_cloud_empresas";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_ccnit_cond'] = 'cond';
      $tp_fields['SC_ccnit'] = 'text_aut';
      $tp_fields['id_ac_ccnit'] = 'text_aut';
      $tp_fields['SC_nombre_razonsocial_cond'] = 'cond';
      $tp_fields['SC_nombre_razonsocial'] = 'text_aut';
      $tp_fields['id_ac_nombre_razonsocial'] = 'text_aut';
   ...
   {
      global $ccnit_cond, $ccnit, $ccnit_autocomp,
             $nombre_razonsocial_cond, $nombre_razonsocial, $nombre_razonsocial_autocomp,
      ...
      if (!empty($ccnit_autocomp) && empty($ccnit))
      {
          $ccnit = $ccnit_autocomp;
      }
      if (!empty($nombre_razonsocial_autocomp) && empty($nombre_razonsocial))
      {
          $nombre_razonsocial = $nombre_razonsocial_autocomp;
      }
      $ccnit_cond_salva = $ccnit_cond; 
      if (!isset($ccnit_input_2) || $ccnit_input_2 == "")
      {
          $ccnit_input_2 = $ccnit;
      }
      $nombre_razonsocial_cond_salva = $nombre_razonsocial_cond; 
      if (!isset($nombre_razonsocial_input_2) || $nombre_razonsocial_input_2 == "")
      {
          $nombre_razonsocial_input_2 = $nombre_razonsocial;
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['psq_check_ret']['activo'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['ccnit'] = $ccnit; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['ccnit_cond'] = $ccnit_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['nombre_razonsocial'] = $nombre_razonsocial; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['nombre_razonsocial_cond'] = $nombre_razonsocial_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['activo'] = $activo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['activo_cond'] = $activo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($ccnit != '') {
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['ccnit'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['ccnit'] = $ccnit;
      }
      $nmgp_def_dados = array();
    if ($nombre_razonsocial != '') {
      $nombre_razonsocial_look = substr($this->Db->qstr($nombre_razonsocial), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nombre_razonsocial'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nombre_razonsocial'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['nombre_razonsocial'] = $nombre_razonsocial;
      }
      $Conteudo = $activo;
      ...
      if (isset($ccnit) || $ccnit_cond == "nu" || $ccnit_cond == "nn" || $ccnit_cond == "ep" || $ccnit_cond == "ne")
      {
         $this->monta_condicao("ccnit", $ccnit_cond, $ccnit, "", "ccnit");
      }

      //----- $nombre_razonsocial
      $this->Date_part = false;
      if (isset($nombre_razonsocial) || $nombre_razonsocial_cond == "nu" || $nombre_razonsocial_cond == "nn" || $nombre_razonsocial_cond == "ep" || $nombre_razonsocial_cond == "ne")
      {
         $this->monta_condicao("nombre_razonsocial", $nombre_razonsocial_cond, $nombre_razonsocial, "", "nombre_razonsocial");
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_empresas']['where_pesq'];
