  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pedidos_cambia_clienteyvendedor_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pedidos_cambia_clienteyvendedor_mob_form();
	}
  ...
  // ---------- Validate fechaven
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_fechaven()
  {
    var nomeCampo_fechaven = "fechaven";
    var var_fechaven = scAjaxGetFieldHidden(nomeCampo_fechaven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_fechaven(var_fechaven, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_fechaven_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_fechaven

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_fechaven_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_fechaven_cb

  // ---------- Validate prefijo_ped
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_prefijo_ped()
  {
    var nomeCampo_prefijo_ped = "prefijo_ped";
    var var_prefijo_ped = scAjaxGetFieldSelect(nomeCampo_prefijo_ped);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_prefijo_ped(var_prefijo_ped, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_prefijo_ped_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_prefijo_ped

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_prefijo_ped_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_prefijo_ped_cb

  // ---------- Validate numpedido
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_numpedido()
  {
    var nomeCampo_numpedido = "numpedido";
    var var_numpedido = scAjaxGetFieldText(nomeCampo_numpedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_numpedido(var_numpedido, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_numpedido_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_numpedido

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_numpedido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_numpedido_cb

  // ---------- Validate idcli
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idcli()
  {
    var nomeCampo_idcli = "idcli";
    var var_idcli = scAjaxGetFieldSelect(nomeCampo_idcli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idcli(var_idcli, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idcli_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idcli

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idcli_cb

  // ---------- Validate vendedor
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_vendedor()
  {
    var nomeCampo_vendedor = "vendedor";
    var var_vendedor = scAjaxGetFieldSelect(nomeCampo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_vendedor(var_vendedor, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_vendedor_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_vendedor

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_vendedor_cb

  // ---------- Validate disponible_en_movil
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_disponible_en_movil()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_disponible_en_movil(var_disponible_en_movil, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_disponible_en_movil_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_disponible_en_movil

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_disponible_en_movil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_disponible_en_movil_cb

  // ---------- Validate idpedido
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idpedido()
  {
    var nomeCampo_idpedido = "idpedido";
    var var_idpedido = scAjaxGetFieldHidden(nomeCampo_idpedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idpedido(var_idpedido, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idpedido_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idpedido

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idpedido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_validate_idpedido_cb

  // ---------- Event onchange disponible_en_movil
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange(var_disponible_en_movil, var_idpedido, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "disponible_en_movil";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange_cb_after_alert);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange_cb
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_event_disponible_en_movil_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form(var_fechaven, var_prefijo_ped, var_numpedido, var_idcli, var_vendedor, var_disponible_en_movil, var_idpedido, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form_cb
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form()
  {
    perform_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form();
  }

  function perform_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form(var_idpedido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form_cb);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pedidos_cambia_clienteyvendedor_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form_cb
  function do_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pedidos_cambia_clienteyvendedor_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pedidos_cambia_clienteyvendedor_mob_navigate_form_cb_after_alert
  function sc_hide_form_pedidos_cambia_clienteyvendedor_mob_form()
  {
