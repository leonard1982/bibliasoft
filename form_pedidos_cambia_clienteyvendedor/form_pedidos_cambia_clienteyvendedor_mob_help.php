<?php
include_once('form_pedidos_cambia_clienteyvendedor_mob_session.php');
@session_start() ;
class form_pedidos_cambia_clienteyvendedor_mob_help
{
...
$exec_help = new form_pedidos_cambia_clienteyvendedor_mob_help();
?>
