 ...
 */
   ...
   // scriptcase
   include_once('blank_copia_exito_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['blank_copia_exito']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['blank_copia_exito']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['blank_copia_exito']['upload_field_info'][ $_POST['param_field'] ];
