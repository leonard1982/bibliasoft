<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_movimiento']['sc_process_barr'] = true;
require_once('../pdfreport_movimiento/index.php');
unset($_SESSION['scriptcase']['pdfreport_movimiento']['sc_process_barr']);
$ExportCtrl = new pdfreport_movimiento_export_control;
$ExportCtrl->Export_barr();

class pdfreport_movimiento_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['pdfreport_movimiento']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['pdfreport_movimiento']['glo_nm_path_imag_temp'];
