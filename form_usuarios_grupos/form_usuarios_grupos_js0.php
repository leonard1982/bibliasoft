<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idusuarios_grupos_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idusuarios_grupos_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_usuarios_grupos"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_grupos']['where_detal']))
  {
?>  
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_usuarios_grupos_submit_form(y, z);
