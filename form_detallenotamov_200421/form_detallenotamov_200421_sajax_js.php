  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallenotamov_200421" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallenotamov_200421_form();
	}
...
?>
  ...
  // ---------- Validate producto_
  function do_ajax_form_detallenotamov_200421_validate_producto_(iNumLinha)
  {
  } // do_ajax_form_detallenotamov_200421_validate_producto_

  function do_ajax_form_detallenotamov_200421_validate_producto__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_producto__cb

  // ---------- Validate colores_
  function do_ajax_form_detallenotamov_200421_validate_colores_(iNumLinha)
  {
    var nomeCampo_colores_ = "colores_" + iNumLinha;
    var var_colores_ = scAjaxGetFieldSelect(nomeCampo_colores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_colores_(var_colores_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_colores__cb);
  } // do_ajax_form_detallenotamov_200421_validate_colores_

  function do_ajax_form_detallenotamov_200421_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_form_detallenotamov_200421_validate_tallas_(iNumLinha)
  {
    var nomeCampo_tallas_ = "tallas_" + iNumLinha;
    var var_tallas_ = scAjaxGetFieldSelect(nomeCampo_tallas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_tallas_(var_tallas_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_tallas__cb);
  } // do_ajax_form_detallenotamov_200421_validate_tallas_

  function do_ajax_form_detallenotamov_200421_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_form_detallenotamov_200421_validate_sabor_(iNumLinha)
  {
    var nomeCampo_sabor_ = "sabor_" + iNumLinha;
    var var_sabor_ = scAjaxGetFieldSelect(nomeCampo_sabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_sabor_(var_sabor_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_sabor__cb);
  } // do_ajax_form_detallenotamov_200421_validate_sabor_

  function do_ajax_form_detallenotamov_200421_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_sabor__cb

  // ---------- Validate destino_
  function do_ajax_form_detallenotamov_200421_validate_destino_(iNumLinha)
  {
    var nomeCampo_destino_ = "destino_" + iNumLinha;
    var var_destino_ = scAjaxGetFieldText(nomeCampo_destino_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_destino_(var_destino_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_destino__cb);
  } // do_ajax_form_detallenotamov_200421_validate_destino_

  function do_ajax_form_detallenotamov_200421_validate_destino__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_destino__cb

  // ---------- Validate fechavenc_
  function do_ajax_form_detallenotamov_200421_validate_fechavenc_(iNumLinha)
  {
    var nomeCampo_fechavenc_ = "fechavenc_" + iNumLinha;
    var var_fechavenc_ = scAjaxGetFieldText(nomeCampo_fechavenc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_fechavenc_(var_fechavenc_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_fechavenc__cb);
  } // do_ajax_form_detallenotamov_200421_validate_fechavenc_

  function do_ajax_form_detallenotamov_200421_validate_fechavenc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fechavenc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fechavenc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fechavenc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fechavenc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_fechavenc__cb

  // ---------- Validate lote_
  function do_ajax_form_detallenotamov_200421_validate_lote_(iNumLinha)
  {
    var nomeCampo_lote_ = "lote_" + iNumLinha;
    var var_lote_ = scAjaxGetFieldText(nomeCampo_lote_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_lote_(var_lote_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_lote__cb);
  } // do_ajax_form_detallenotamov_200421_validate_lote_

  function do_ajax_form_detallenotamov_200421_validate_lote__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_lote__cb

  // ---------- Validate codigobar_
  function do_ajax_form_detallenotamov_200421_validate_codigobar_(iNumLinha)
  {
    var nomeCampo_codigobar_ = "codigobar_" + iNumLinha;
    var var_codigobar_ = scAjaxGetFieldText(nomeCampo_codigobar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_codigobar_(var_codigobar_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_codigobar__cb);
  } // do_ajax_form_detallenotamov_200421_validate_codigobar_

  function do_ajax_form_detallenotamov_200421_validate_codigobar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_codigobar__cb

  // ---------- Validate presentacion_
  function do_ajax_form_detallenotamov_200421_validate_presentacion_(iNumLinha)
  {
    var nomeCampo_presentacion_ = "presentacion_" + iNumLinha;
    var var_presentacion_ = scAjaxGetFieldHidden(nomeCampo_presentacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_presentacion_(var_presentacion_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_presentacion__cb);
  } // do_ajax_form_detallenotamov_200421_validate_presentacion_

  function do_ajax_form_detallenotamov_200421_validate_presentacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_presentacion__cb

  // ---------- Validate cantidad_
  function do_ajax_form_detallenotamov_200421_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_cantidad__cb);
  } // do_ajax_form_detallenotamov_200421_validate_cantidad_

  function do_ajax_form_detallenotamov_200421_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_cantidad__cb

  // ---------- Validate stock_
  function do_ajax_form_detallenotamov_200421_validate_stock_(iNumLinha)
  {
    var nomeCampo_stock_ = "stock_" + iNumLinha;
    var var_stock_ = scAjaxGetFieldHidden(nomeCampo_stock_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_validate_stock_(var_stock_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_200421_validate_stock__cb);
  } // do_ajax_form_detallenotamov_200421_validate_stock_

  function do_ajax_form_detallenotamov_200421_validate_stock__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_validate_stock__cb

  // ---------- Refresh producto_
  function do_ajax_form_detallenotamov_200421_refresh_producto_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_refresh_producto_(var_producto_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_detallenotamov_200421_refresh_producto__cb);
  } // do_ajax_form_detallenotamov_200421_refresh_producto_

  function do_ajax_form_detallenotamov_200421_refresh_producto__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_200421_refresh_producto__cb

  // ---------- Event onblur cantidad_
  function do_ajax_form_detallenotamov_200421_event_cantidad__onblur(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_stock_ = scAjaxGetFieldHidden("stock_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_cantidad__onblur(var_cantidad_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_cantidad__onblur_cb);
  } // do_ajax_form_detallenotamov_200421_event_cantidad__onblur

  function do_ajax_form_detallenotamov_200421_event_cantidad__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_cantidad__onblur_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_cantidad__onblur_cb
  function do_ajax_form_detallenotamov_200421_event_cantidad__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_cantidad__onblur_cb_after_alert

  // ---------- Event onchange cantidad_
  function do_ajax_form_detallenotamov_200421_event_cantidad__onchange(iSeqForm)
  {
    ...
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_stock_ = scAjaxGetFieldHidden("stock_" + iSeqForm);
    var var_fechavenc_ = scAjaxGetFieldText("fechavenc_" + iSeqForm);
    var var_lote_ = scAjaxGetFieldText("lote_" + iSeqForm);
    var var_codigobar_ = scAjaxGetFieldText("codigobar_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_cantidad__onchange(var_producto_, var_colores_, var_tallas_, var_sabor_, var_cantidad_, var_stock_, var_fechavenc_, var_lote_, var_codigobar_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_cantidad__onchange_cb);
  } // do_ajax_form_detallenotamov_200421_event_cantidad__onchange

  function do_ajax_form_detallenotamov_200421_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_cantidad__onchange_cb
  function do_ajax_form_detallenotamov_200421_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_cantidad__onchange_cb_after_alert

  // ---------- Event onchange codigobar_
  function do_ajax_form_detallenotamov_200421_event_codigobar__onchange(iSeqForm)
  {
    var var_producto_ = scAjaxGetFieldText("id_ac_producto_" + iSeqForm);
    var var_lote_ = scAjaxGetFieldText("lote_" + iSeqForm);
    var var_codigobar_ = scAjaxGetFieldText("codigobar_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_codigobar__onchange(var_producto_, var_lote_, var_codigobar_, var_colores_, var_tallas_, var_sabor_, var_fechavenc_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_codigobar__onchange_cb);
  } // do_ajax_form_detallenotamov_200421_event_codigobar__onchange

  function do_ajax_form_detallenotamov_200421_event_codigobar__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_codigobar__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_codigobar__onchange_cb
  function do_ajax_form_detallenotamov_200421_event_codigobar__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_codigobar__onchange_cb_after_alert

  // ---------- Event onchange colores_
  function do_ajax_form_detallenotamov_200421_event_colores__onchange(iSeqForm)
  {
    var var_producto_ = scAjaxGetFieldText("id_ac_producto_" + iSeqForm);
    var var_lote_ = scAjaxGetFieldText("lote_" + iSeqForm);
    var var_codigobar_ = scAjaxGetFieldText("codigobar_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_colores__onchange(var_producto_, var_lote_, var_codigobar_, var_colores_, var_tallas_, var_sabor_, var_fechavenc_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_colores__onchange_cb);
  } // do_ajax_form_detallenotamov_200421_event_colores__onchange

  function do_ajax_form_detallenotamov_200421_event_colores__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_colores__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_colores__onchange_cb
  function do_ajax_form_detallenotamov_200421_event_colores__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_colores__onchange_cb_after_alert

  // ---------- Event onchange fechavenc_
  function do_ajax_form_detallenotamov_200421_event_fechavenc__onchange(iSeqForm)
  {
    var var_producto_ = scAjaxGetFieldText("id_ac_producto_" + iSeqForm);
    var var_lote_ = scAjaxGetFieldText("lote_" + iSeqForm);
    var var_codigobar_ = scAjaxGetFieldText("codigobar_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_fechavenc__onchange(var_producto_, var_lote_, var_codigobar_, var_colores_, var_tallas_, var_sabor_, var_fechavenc_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_fechavenc__onchange_cb);
  } // do_ajax_form_detallenotamov_200421_event_fechavenc__onchange

  function do_ajax_form_detallenotamov_200421_event_fechavenc__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_fechavenc__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_fechavenc__onchange_cb
  function do_ajax_form_detallenotamov_200421_event_fechavenc__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_fechavenc__onchange_cb_after_alert

  // ---------- Event onchange lote_
  function do_ajax_form_detallenotamov_200421_event_lote__onchange(iSeqForm)
  {
    var var_producto_ = scAjaxGetFieldText("id_ac_producto_" + iSeqForm);
    var var_lote_ = scAjaxGetFieldText("lote_" + iSeqForm);
    var var_codigobar_ = scAjaxGetFieldText("codigobar_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_lote__onchange(var_producto_, var_lote_, var_codigobar_, var_colores_, var_tallas_, var_sabor_, var_fechavenc_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_lote__onchange_cb);
  } // do_ajax_form_detallenotamov_200421_event_lote__onchange

  function do_ajax_form_detallenotamov_200421_event_lote__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_lote__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_lote__onchange_cb
  function do_ajax_form_detallenotamov_200421_event_lote__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_lote__onchange_cb_after_alert

  // ---------- Event onchange producto_
  function do_ajax_form_detallenotamov_200421_event_producto__onchange(iSeqForm)
  {
    var var_fechavenc_ = scAjaxGetFieldText("fechavenc_" + iSeqForm);
    var var_producto_ = scAjaxGetFieldText("id_ac_producto_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_producto__onchange(var_fechavenc_, var_producto_, var_presentacion_, var_lote_, var_codigobar_, var_colores_, var_tallas_, var_sabor_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_producto__onchange_cb);
  } // do_ajax_form_detallenotamov_200421_event_producto__onchange

  function do_ajax_form_detallenotamov_200421_event_producto__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_producto__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_producto__onchange_cb
  function do_ajax_form_detallenotamov_200421_event_producto__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_detallenotamov_200421_refresh_producto_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_producto__onchange_cb_after_alert

  // ---------- Event onchange sabor_
  function do_ajax_form_detallenotamov_200421_event_sabor__onchange(iSeqForm)
  {
    var var_producto_ = scAjaxGetFieldText("id_ac_producto_" + iSeqForm);
    var var_lote_ = scAjaxGetFieldText("lote_" + iSeqForm);
    var var_codigobar_ = scAjaxGetFieldText("codigobar_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_sabor__onchange(var_producto_, var_lote_, var_codigobar_, var_colores_, var_tallas_, var_sabor_, var_fechavenc_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_sabor__onchange_cb);
  } // do_ajax_form_detallenotamov_200421_event_sabor__onchange

  function do_ajax_form_detallenotamov_200421_event_sabor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_sabor__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_sabor__onchange_cb
  function do_ajax_form_detallenotamov_200421_event_sabor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_sabor__onchange_cb_after_alert

  // ---------- Event onchange tallas_
  function do_ajax_form_detallenotamov_200421_event_tallas__onchange(iSeqForm)
  {
    var var_producto_ = scAjaxGetFieldText("id_ac_producto_" + iSeqForm);
    var var_lote_ = scAjaxGetFieldText("lote_" + iSeqForm);
    var var_codigobar_ = scAjaxGetFieldText("codigobar_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_event_tallas__onchange(var_producto_, var_lote_, var_codigobar_, var_colores_, var_tallas_, var_sabor_, var_fechavenc_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_200421_event_tallas__onchange_cb);
  } // do_ajax_form_detallenotamov_200421_event_tallas__onchange

  function do_ajax_form_detallenotamov_200421_event_tallas__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_event_tallas__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_event_tallas__onchange_cb
  function do_ajax_form_detallenotamov_200421_event_tallas__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_200421_event_tallas__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallenotamov_200421_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallenotamov_200421_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_200421_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallenotamov_200421_add_new_line_cb);
  } // do_ajax_form_detallenotamov_200421_add_new_line

  function do_ajax_form_detallenotamov_200421_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallenotamov_200421_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallenotamov_200421_backup_line(iNumLinha)
  {
    var var_idnota_ = scAjaxGetFieldText("idnota_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_200421_backup_line(var_idnota_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallenotamov_200421_backup_line_cb);
  } // do_ajax_form_detallenotamov_200421_backup_line

  function do_ajax_form_detallenotamov_200421_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallenotamov_200421_backup_line_cb

  function do_ajax_form_detallenotamov_200421_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallenotamov_200421_cancel_insert

  function do_ajax_form_detallenotamov_200421_cancel_update(iSeqVert)
  {
    do_ajax_form_detallenotamov_200421_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallenotamov_200421_cancel_update

  function do_ajax_form_detallenotamov_200421_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallenotamov_200421_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallenotamov_200421_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallenotamov_200421_table_refresh(var_idnota_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallenotamov_200421_table_refresh_cb);
  } //  do_ajax_form_detallenotamov_200421_table_refresh

  function do_ajax_form_detallenotamov_200421_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_detallenotamov_200421_table_refresh_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_table_refresh_cb
  function do_ajax_form_detallenotamov_200421_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detallenotamov_200421_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallenotamov_200421_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallenotamov_200421_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_fechavenc_ = scAjaxGetFieldText("fechavenc_" + iNumLinha);
    ...
    var var_stock_ = scAjaxGetFieldHidden("stock_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_detallenotamov_200421_submit_form(var_producto_, var_colores_, var_tallas_, var_sabor_, var_destino_, var_fechavenc_, var_lote_, var_codigobar_, var_presentacion_, var_cantidad_, var_stock_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detallenotamov_200421_submit_form_cb);
  } // do_ajax_form_detallenotamov_200421_submit_form

  function do_ajax_form_detallenotamov_200421_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("fechavenc_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_200421_submit_form_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_submit_form_cb
  function do_ajax_form_detallenotamov_200421_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallenotamov_200421_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallenotamov_200421_navigate_form()
  {
    perform_ajax_form_detallenotamov_200421_navigate_form();
  }

  function perform_ajax_form_detallenotamov_200421_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fechavenc_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallenotamov_200421_navigate_form(var_idnota_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallenotamov_200421_navigate_form_cb);
  } // do_ajax_form_detallenotamov_200421_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallenotamov_200421']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallenotamov_200421_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallenotamov_200421_navigate_form_cb_after_alert);
  } // do_ajax_form_detallenotamov_200421_navigate_form_cb
  function do_ajax_form_detallenotamov_200421_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_detallenotamov_200421_navigate_form_cb_after_alert
  function sc_hide_form_detallenotamov_200421_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fechavenc_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["fechavenc_" + iNumLinha] = {"label": "F. Vencimiento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["codigobar_" + iNumLinha] = {"label": "Cod barras o serial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["stock_" + iNumLinha] = {"label": "Stock Origen<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["fechavenc_"][iNumLinha] = "fechavenc_" + iNumLinha;
    ...
    ajax_field_id["fechavenc_" + iNumLinha] = new Array("hidden_field_label_fechavenc_", "hidden_field_data_fechavenc_" + iNumLinha);
    ...
    ajax_error_count["fechavenc_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fechavenc_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["fechavenc_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fechavenc_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fechavenc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fechavenc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fechavenc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fechavenc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fechavenc_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fechavenc_'])) ? $this->nmgp_cmp_readonly['fechavenc_'] : 'off';
?>
    scAjaxFieldRead("fechavenc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("fechavenc_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["producto_" + iRow] || "on" == ajax_error_count["colores_" + iRow] || "on" == ajax_error_count["tallas_" + iRow] || "on" == ajax_error_count["sabor_" + iRow] || "on" == ajax_error_count["destino_" + iRow] || "on" == ajax_error_count["fechavenc_" + iRow] || "on" == ajax_error_count["lote_" + iRow] || "on" == ajax_error_count["codigobar_" + iRow] || "on" == ajax_error_count["presentacion_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["stock_" + iRow]))
    {
      ...
      $("#hidden_field_data_fechavenc_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["producto_" + iRow] && "off" == ajax_error_count["colores_" + iRow] && "off" == ajax_error_count["tallas_" + iRow] && "off" == ajax_error_count["sabor_" + iRow] && "off" == ajax_error_count["destino_" + iRow] && "off" == ajax_error_count["fechavenc_" + iRow] && "off" == ajax_error_count["lote_" + iRow] && "off" == ajax_error_count["codigobar_" + iRow] && "off" == ajax_error_count["presentacion_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["stock_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["fechavenc_" + iRow] = "off";
      ...
      $("#hidden_field_data_fechavenc_" + iRow).removeClass("scFormErrorLine");
