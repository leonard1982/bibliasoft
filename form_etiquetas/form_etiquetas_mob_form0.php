...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_etiquetas_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_etiquetas_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
<body class="scFormPage" style="<?php echo $remove_margin . $str_iframe_body . $vertical_center; ?>">
<?php

if (isset($_SESSION['scriptcase']['form_etiquetas']['error_buffer']) && '' != $_SESSION['scriptcase']['form_etiquetas']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_etiquetas']['error_buffer'];
}
...
<?php
 include_once("form_etiquetas_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_etiquetas_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_etiquetas_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_etiquetas_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['fast_search'][2] : "";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['group_group_2']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['group_group_2']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['group_group_2']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['group_group_2']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['group_group_2'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label'][''];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['copy']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['copy']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['copy']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['copy']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['copy'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idetiqueta_line" id="hidden_field_data_idetiqueta" style="<?php echo $sStyleHidden_idetiqueta; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idetiqueta_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idetiqueta_label" style=""><span id="id_label_idetiqueta"><?php echo $this->nm_new_label['idetiqueta']; ?></span></span><br><span id="id_read_on_idetiqueta" class="css_idetiqueta_line" style="<?php echo $sStyleReadLab_idetiqueta; ?>"><?php echo $this->form_format_readonly("idetiqueta", $this->form_encode_input($this->idetiqueta)); ?></span><span id="id_read_off_idetiqueta" class="css_read_off_idetiqueta" style="<?php echo $sStyleReadInp_idetiqueta; ?>"><input type="hidden" name="idetiqueta" value="<?php echo $this->form_encode_input($idetiqueta) . "\">"?><span id="id_ajax_label_idetiqueta"><?php echo nl2br($idetiqueta); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nombre_configuracion_line" id="hidden_field_data_nombre_configuracion" style="<?php echo $sStyleHidden_nombre_configuracion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nombre_configuracion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nombre_configuracion_label" style=""><span id="id_label_nombre_configuracion"><?php echo $this->nm_new_label['nombre_configuracion']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idfamilia_line" id="hidden_field_data_idfamilia" style="<?php echo $sStyleHidden_idfamilia; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idfamilia_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idfamilia_label" style=""><span id="id_label_idfamilia"><?php echo $this->nm_new_label['idfamilia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['idfamilia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['idfamilia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["idfamilia"]) &&  $this->nmgp_cmp_readonly["idfamilia"] == "on") { 
 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_idfamilia']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_idfamilia'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_idfamilia']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_idfamilia'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_idfamilia'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_idfamilia'][] = '0'; 
...
<span id="id_read_on_codigo" class="sc-ui-readonly-codigo css_codigo_line" style="<?php echo $sStyleReadLab_codigo; ?>"><?php echo $this->form_format_readonly("codigo", $this->form_encode_input($this->codigo)); ?></span><span id="id_read_off_codigo" class="css_read_off_codigo<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_codigo; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=40"; } ?> maxlength=40 alt="{datatype: 'text', maxLength: 40, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_etiquetas_mob*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_productos"]) && $this->Ini->sc_lig_md5["grid_productos"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_etiquetas_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_size_letra_descripcion_line" id="hidden_field_data_size_letra_descripcion" style="<?php echo $sStyleHidden_size_letra_descripcion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_size_letra_descripcion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_size_letra_descripcion_label" style=""><span id="id_label_size_letra_descripcion"><?php echo $this->nm_new_label['size_letra_descripcion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_descripcion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_descripcion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_letra_line" id="hidden_field_data_tipo_letra" style="<?php echo $sStyleHidden_tipo_letra; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_letra_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipo_letra_label" style=""><span id="id_label_tipo_letra"><?php echo $this->nm_new_label['tipo_letra']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['tipo_letra']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['tipo_letra'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_letra'][] = 'Arial'; ?>
 <option  value="Helvetica" <?php  if ($this->tipo_letra == "Helvetica") { echo " selected" ;} ?>>Helvetica</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_letra'][] = 'Helvetica'; ?>
 <option  value="sans" <?php  if ($this->tipo_letra == "sans") { echo " selected" ;} ?>>sans-serif</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_letra'][] = 'sans'; ?>
 <option  value="Tahoma" <?php  if ($this->tipo_letra == "Tahoma") { echo " selected" ;} ?>>Tahoma</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_letra'][] = 'Tahoma'; ?>
 <option  value="Georgia" <?php  if ($this->tipo_letra == "Georgia") { echo " selected" ;} ?>>Georgia</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_letra'][] = 'Georgia'; ?>
 <option  value="Verdana" <?php  if ($this->tipo_letra == "Verdana") { echo " selected" ;} ?>>Verdana</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_letra'][] = 'Verdana'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_columnas_line" id="hidden_field_data_columnas" style="<?php echo $sStyleHidden_columnas; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_columnas_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_columnas_label" style=""><span id="id_label_columnas"><?php echo $this->nm_new_label['columnas']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['columnas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['columnas'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_codigo_line" id="hidden_field_data_tipo_codigo" style="<?php echo $sStyleHidden_tipo_codigo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_codigo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipo_codigo_label" style=""><span id="id_label_tipo_codigo"><?php echo $this->nm_new_label['tipo_codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['tipo_codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['tipo_codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_codigo'][] = 'TYPE_EAN_13'; ?>
 <option  value="TYPE_EAN_8" <?php  if ($this->tipo_codigo == "TYPE_EAN_8") { echo " selected" ;} ?>>TYPE_EAN_8</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_codigo'][] = 'TYPE_EAN_8'; ?>
 <option  value="TYPE_EAN_5" <?php  if ($this->tipo_codigo == "TYPE_EAN_5") { echo " selected" ;} ?>>TYPE_EAN_5</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_codigo'][] = 'TYPE_EAN_5'; ?>
 <option  value="TYPE_CODE_39" <?php  if ($this->tipo_codigo == "TYPE_CODE_39") { echo " selected" ;} ?>>TYPE_CODE_39</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_codigo'][] = 'TYPE_CODE_39'; ?>
 <option  value="TYPE_CODE_128" <?php  if ($this->tipo_codigo == "TYPE_CODE_128") { echo " selected" ;} ?>>TYPE_CODE_128</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_codigo'][] = 'TYPE_CODE_128'; ?>
 <option  value="TYPE_CODE_11" <?php  if ($this->tipo_codigo == "TYPE_CODE_11") { echo " selected" ;} ?>>TYPE_CODE_11</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_codigo'][] = 'TYPE_CODE_11'; ?>
 <option  value="TYPE_PHARMA_CODE" <?php  if ($this->tipo_codigo == "TYPE_PHARMA_CODE") { echo " selected" ;} ?>>TYPE_PHARMA_CODE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_codigo'][] = 'TYPE_PHARMA_CODE'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_tipo_imagen_line" id="hidden_field_data_tipo_imagen" style="<?php echo $sStyleHidden_tipo_imagen; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tipo_imagen_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_tipo_imagen_label" style=""><span id="id_label_tipo_imagen"><?php echo $this->nm_new_label['tipo_imagen']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['tipo_imagen']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['tipo_imagen'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_imagen'][] = 'BarcodeGeneratorPNG'; ?>
 <option  value="BarcodeGeneratorSVG" <?php  if ($this->tipo_imagen == "BarcodeGeneratorSVG") { echo " selected" ;} ?>>SVG</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_imagen'][] = 'BarcodeGeneratorSVG'; ?>
 <option  value="BarcodeGeneratorJPG" <?php  if ($this->tipo_imagen == "BarcodeGeneratorJPG") { echo " selected" ;} ?>>JPG</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_imagen'][] = 'BarcodeGeneratorJPG'; ?>
 <option  value="BarcodeGeneratorHTML" <?php  if ($this->tipo_imagen == "BarcodeGeneratorHTML") { echo " selected" ;} ?>>HTML</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_tipo_imagen'][] = 'BarcodeGeneratorHTML'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_altura_line" id="hidden_field_data_altura" style="<?php echo $sStyleHidden_altura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_altura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_altura_label" style=""><span id="id_label_altura"><?php echo $this->nm_new_label['altura']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['altura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['altura'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_anchura_line" id="hidden_field_data_anchura" style="<?php echo $sStyleHidden_anchura; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_anchura_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_anchura_label" style=""><span id="id_label_anchura"><?php echo $this->nm_new_label['anchura']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['anchura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['anchura'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_precio_line" id="hidden_field_data_precio" style="<?php echo $sStyleHidden_precio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_precio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_precio_label" style=""><span id="id_label_precio"><?php echo $this->nm_new_label['precio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['precio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['precio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_precio'][] = ''; ?>
 <option value="">Ver Precio</option>
 <option  value="preciomen" <?php  if ($this->precio == "preciomen") { echo " selected" ;} ?>>PRECIO1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_precio'][] = 'preciomen'; ?>
 <option  value="preciomen2" <?php  if ($this->precio == "preciomen2") { echo " selected" ;} ?>>PRECIO2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_precio'][] = 'preciomen2'; ?>
 <option  value="preciomen3" <?php  if ($this->precio == "preciomen3") { echo " selected" ;} ?>>PRECIO3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_precio'][] = 'preciomen3'; ?>
 <option  value="preciofull" <?php  if ($this->precio == "preciofull") { echo " selected" ;} ?>>PRECIOM1</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_precio'][] = 'preciofull'; ?>
 <option  value="precio2" <?php  if ($this->precio == "precio2") { echo " selected" ;} ?>>PRECIOM2</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_precio'][] = 'precio2'; ?>
 <option  value="preciomay" <?php  if ($this->precio == "preciomay") { echo " selected" ;} ?>>PRECIOM3</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_precio'][] = 'preciomay'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_ver_codigo'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormDataOdd css_ver_descripcion_line" id="hidden_field_data_ver_descripcion" style="<?php echo $sStyleHidden_ver_descripcion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ver_descripcion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ver_descripcion_label" style=""><span id="id_label_ver_descripcion"><?php echo $this->nm_new_label['ver_descripcion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['ver_descripcion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['ver_descripcion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_ver_descripcion'][] = 'SI'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_personalizado1_line" id="hidden_field_data_personalizado1" style="<?php echo $sStyleHidden_personalizado1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_personalizado1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_personalizado1_label" style=""><span id="id_label_personalizado1"><?php echo $this->nm_new_label['personalizado1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_personalizado2_line" id="hidden_field_data_personalizado2" style="<?php echo $sStyleHidden_personalizado2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_personalizado2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_personalizado2_label" style=""><span id="id_label_personalizado2"><?php echo $this->nm_new_label['personalizado2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_personalizado3_line" id="hidden_field_data_personalizado3" style="<?php echo $sStyleHidden_personalizado3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_personalizado3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_personalizado3_label" style=""><span id="id_label_personalizado3"><?php echo $this->nm_new_label['personalizado3']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_espaciado_line" id="hidden_field_data_espaciado" style="<?php echo $sStyleHidden_espaciado; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_espaciado_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_espaciado_label" style=""><span id="id_label_espaciado"><?php echo $this->nm_new_label['espaciado']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['espaciado']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['espaciado'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ancho_descripcion_line" id="hidden_field_data_ancho_descripcion" style="<?php echo $sStyleHidden_ancho_descripcion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ancho_descripcion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ancho_descripcion_label" style=""><span id="id_label_ancho_descripcion"><?php echo $this->nm_new_label['ancho_descripcion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['ancho_descripcion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['ancho_descripcion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_size_letra_codigo_line" id="hidden_field_data_size_letra_codigo" style="<?php echo $sStyleHidden_size_letra_codigo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_size_letra_codigo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_size_letra_codigo_label" style=""><span id="id_label_size_letra_codigo"><?php echo $this->nm_new_label['size_letra_codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_size_letra_precio_line" id="hidden_field_data_size_letra_precio" style="<?php echo $sStyleHidden_size_letra_precio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_size_letra_precio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_size_letra_precio_label" style=""><span id="id_label_size_letra_precio"><?php echo $this->nm_new_label['size_letra_precio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_precio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_precio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_size_letra_perso1_line" id="hidden_field_data_size_letra_perso1" style="<?php echo $sStyleHidden_size_letra_perso1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_size_letra_perso1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_size_letra_perso1_label" style=""><span id="id_label_size_letra_perso1"><?php echo $this->nm_new_label['size_letra_perso1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_perso1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_perso1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_size_letra_perso2_line" id="hidden_field_data_size_letra_perso2" style="<?php echo $sStyleHidden_size_letra_perso2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_size_letra_perso2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_size_letra_perso2_label" style=""><span id="id_label_size_letra_perso2"><?php echo $this->nm_new_label['size_letra_perso2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_perso2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_perso2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_size_letra_perso3_line" id="hidden_field_data_size_letra_perso3" style="<?php echo $sStyleHidden_size_letra_perso3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_size_letra_perso3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_size_letra_perso3_label" style=""><span id="id_label_size_letra_perso3"><?php echo $this->nm_new_label['size_letra_perso3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_perso3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['size_letra_perso3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_posicion_codigo_line" id="hidden_field_data_posicion_codigo" style="<?php echo $sStyleHidden_posicion_codigo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_posicion_codigo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_posicion_codigo_label" style=""><span id="id_label_posicion_codigo"><?php echo $this->nm_new_label['posicion_codigo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_codigo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_codigo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_posicion_descripcion_line" id="hidden_field_data_posicion_descripcion" style="<?php echo $sStyleHidden_posicion_descripcion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_posicion_descripcion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_posicion_descripcion_label" style=""><span id="id_label_posicion_descripcion"><?php echo $this->nm_new_label['posicion_descripcion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_descripcion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_descripcion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_posicion_precio_line" id="hidden_field_data_posicion_precio" style="<?php echo $sStyleHidden_posicion_precio; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_posicion_precio_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_posicion_precio_label" style=""><span id="id_label_posicion_precio"><?php echo $this->nm_new_label['posicion_precio']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_precio']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_precio'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_posicion_perso1_line" id="hidden_field_data_posicion_perso1" style="<?php echo $sStyleHidden_posicion_perso1; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_posicion_perso1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_posicion_perso1_label" style=""><span id="id_label_posicion_perso1"><?php echo $this->nm_new_label['posicion_perso1']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_perso1']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_perso1'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_posicion_perso2_line" id="hidden_field_data_posicion_perso2" style="<?php echo $sStyleHidden_posicion_perso2; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_posicion_perso2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_posicion_perso2_label" style=""><span id="id_label_posicion_perso2"><?php echo $this->nm_new_label['posicion_perso2']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_perso2']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_perso2'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_posicion_perso3_line" id="hidden_field_data_posicion_perso3" style="<?php echo $sStyleHidden_posicion_perso3; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_posicion_perso3_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_posicion_perso3_label" style=""><span id="id_label_posicion_perso3"><?php echo $this->nm_new_label['posicion_perso3']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_perso3']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['posicion_perso3'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_alineacion_line" id="hidden_field_data_alineacion" style="<?php echo $sStyleHidden_alineacion; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_alineacion_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_alineacion_label" style=""><span id="id_label_alineacion"><?php echo $this->nm_new_label['alineacion']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['alineacion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['php_cmp_required']['alineacion'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_alineacion'][] = 'center'; ?>
 <option  value="left" <?php  if ($this->alineacion == "left") { echo " selected" ;} ?>>LEFT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_alineacion'][] = 'left'; ?>
 <option  value="right" <?php  if ($this->alineacion == "right") { echo " selected" ;} ?>>RIGHT</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['Lookup_alineacion'][] = 'right'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_copias_line" id="hidden_field_data_copias" style="<?php echo $sStyleHidden_copias; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_copias_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_copias_label" style=""><span id="id_label_copias"><?php echo $this->nm_new_label['copias']; ?></span></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_etiquetas_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_etiquetas_mob");
 parent.scAjaxDetailHeight("form_etiquetas_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
