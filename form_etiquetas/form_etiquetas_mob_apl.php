...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['scriptcase']['error_icon']['form_etiquetas_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['sc_max_reg']) == "all")
      {
...
//------------ 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_etiquetas_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_etiquetas_mob']['reg_start'] + 1;
