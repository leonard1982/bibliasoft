<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mov_trasladoprod_almacen']['sc_process_barr'] = true;
require_once('../grid_mov_trasladoprod_almacen/index.php');
unset($_SESSION['scriptcase']['grid_mov_trasladoprod_almacen']['sc_process_barr']);
$ExportCtrl = new grid_mov_trasladoprod_almacen_export_control;
$ExportCtrl->Export_barr();

class grid_mov_trasladoprod_almacen_export_control
{
