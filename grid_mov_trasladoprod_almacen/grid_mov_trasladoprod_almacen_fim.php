...
//----- 
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mov_trasladodeproduccion'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mov_trasladoprod_almacen']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mov_trasladoprod_almacen']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mov_trasladoprod_almacen']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mov_trasladoprod_almacen']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mov_trasladoprod_almacen']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_mov_trasladoprod_almacen</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mov_trasladoprod_almacen']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mov_trasladoprod_almacen']['embutida_filho'] as $ind => $sc_init)
          {
