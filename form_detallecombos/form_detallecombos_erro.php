...
$old_error_handler = set_error_handler("form_detallecombos_scriptcase_error_handler");

function form_detallecombos_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_detallecombos']['contr_erro']) && $_SESSION['scriptcase']['form_detallecombos']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_detallecombos->contr_form_detallecombos->Apl_com_erro = true;
            if ($inicial_form_detallecombos->contr_form_detallecombos->NM_ajax_flag)
            {
                $inicial_form_detallecombos->contr_form_detallecombos->NM_ajax_info['errList']['geral_form_detallecombos'][] = $msg;
                return;
            }
            form_detallecombos_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_detallecombos_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_detallecombos'])  && '' != $_SESSION['scriptcase']['error_icon']['form_detallecombos'])  ? $_SESSION['scriptcase']['error_icon']['form_detallecombos']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_detallecombos']) && '' != $_SESSION['scriptcase']['error_close']['form_detallecombos']) ? $_SESSION['scriptcase']['error_close']['form_detallecombos'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_detallecombos']) && '' != $_SESSION['scriptcase']['error_span_title']['form_detallecombos']) ? $_SESSION['scriptcase']['error_span_title']['form_detallecombos'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_detallecombos']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_detallecombos']) ? $_SESSION['scriptcase']['error_icon_title']['form_detallecombos'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_detallecombos']['error_buffer'] .= ob_get_flush();
}
