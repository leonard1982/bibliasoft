...
function scEventControl_active(iSeqRow) {
  if (scEventControl_data["idcombo_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idcombo_" + iSeqRow]["change"]) {
    return true;
  }
...
function scEventControl_onFocus(oField, iSeq) {
  ...
  if ("idproducto_" + iSeq == fieldName) {
    scEventControl_data[fieldName]["change"]   = true;
    scEventControl_data[fieldName]["original"] = $(oField).val();
    scEventControl_data[fieldName]["calculated"] = $(oField).val();
    return;
  }
  if ("total_" + iSeq == fieldName) {
    scEventControl_data[fieldName]["change"]   = true;
    scEventControl_data[fieldName]["original"] = $(oField).val();
    scEventControl_data[fieldName]["calculated"] = $(oField).val();
    return;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_iddetallecombo_' + iSeqRow).bind('change', function() { sc_form_detallecombos_iddetallecombo__onchange(this, iSeqRow) });
  $('#id_sc_field_idcombo_' + iSeqRow).bind('blur', function() { sc_form_detallecombos_idcombo__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_detallecombos_idcombo__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_detallecombos_idcombo__onfocus(this, iSeqRow) });
  $('#id_sc_field_idproducto_' + iSeqRow).bind('blur', function() { sc_form_detallecombos_idproducto__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_detallecombos_idproducto__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_detallecombos_idproducto__onfocus(this, iSeqRow) });
...
function sc_form_detallecombos_idcombo__onblur(oThis, iSeqRow) {
  do_ajax_form_detallecombos_validate_idcombo_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_detallecombos_idcombo__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_detallecombos_idcombo__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_detallecombos_idproducto__onblur(oThis, iSeqRow) {
  do_ajax_form_detallecombos_validate_idproducto_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_detallecombos_idproducto__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_detallecombos_event_idproducto__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_detallecombos_idproducto__onfocus(oThis, iSeqRow) {
  scCssFocus(oThis, iSeqRow);
}

function sc_form_detallecombos_cantidad__onblur(oThis, iSeqRow) {
  do_ajax_form_detallecombos_validate_cantidad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_detallecombos_cantidad__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_detallecombos_event_cantidad__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_form_detallecombos_cantidad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function sc_form_detallecombos_creado__hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detallecombos_actualizado__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_detallecombos_actualizado__hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_idcombo_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_form_detallecombos_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_creado_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_detallecombos_validate_creado_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_actualizado_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_detallecombos_validate_actualizado_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_detallecombos')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
