  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallecombos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallecombos_form();
	}
...
?>
  ...
  // ---------- Validate idcombo_
  function do_ajax_form_detallecombos_validate_idcombo_(iNumLinha)
  {
    var nomeCampo_idcombo_ = "idcombo_" + iNumLinha;
    var var_idcombo_ = scAjaxGetFieldText(nomeCampo_idcombo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallecombos_validate_idcombo_(var_idcombo_, iNumLinha, var_script_case_init, do_ajax_form_detallecombos_validate_idcombo__cb);
  } // do_ajax_form_detallecombos_validate_idcombo_

  function do_ajax_form_detallecombos_validate_idcombo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idcombo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcombo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idcombo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcombo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallecombos_validate_idcombo__cb

  // ---------- Validate idproducto_
  function do_ajax_form_detallecombos_validate_idproducto_(iNumLinha)
  {
  } // do_ajax_form_detallecombos_validate_idproducto_

  function do_ajax_form_detallecombos_validate_idproducto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
  ...
  function do_ajax_form_detallecombos_validate_cantidad_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallecombos_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detallecombos_validate_cantidad__cb);
  } // do_ajax_form_detallecombos_validate_cantidad_

  function do_ajax_form_detallecombos_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
  ...
  function do_ajax_form_detallecombos_event_cantidad__onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallecombos_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_detallecombos_event_cantidad__onchange_cb
  function do_ajax_form_detallecombos_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallecombos_event_cantidad__onchange_cb_after_alert

  // ---------- Event onchange idproducto_
  ...
  function do_ajax_form_detallecombos_event_idproducto__onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallecombos_event_idproducto__onchange_cb_after_alert);
  } // do_ajax_form_detallecombos_event_idproducto__onchange_cb
  function do_ajax_form_detallecombos_event_idproducto__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallecombos_event_idproducto__onchange_cb_after_alert
  ...
  function do_ajax_form_detallecombos_event_total__onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallecombos_event_total__onchange_cb_after_alert);
  } // do_ajax_form_detallecombos_event_total__onchange_cb
  function do_ajax_form_detallecombos_event_total__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallecombos_event_total__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallecombos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallecombos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallecombos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallecombos_add_new_line_cb);
  } // do_ajax_form_detallecombos_add_new_line

  function do_ajax_form_detallecombos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallecombos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallecombos_backup_line(iNumLinha)
  {
    var var_iddetallecombo_ = scAjaxGetFieldText("iddetallecombo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallecombos_backup_line(var_iddetallecombo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallecombos_backup_line_cb);
  } // do_ajax_form_detallecombos_backup_line

  function do_ajax_form_detallecombos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallecombos_backup_line_cb

  function do_ajax_form_detallecombos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallecombos_cancel_insert

  function do_ajax_form_detallecombos_cancel_update(iSeqVert)
  {
    do_ajax_form_detallecombos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallecombos_cancel_update

  function do_ajax_form_detallecombos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallecombos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallecombos_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallecombos_table_refresh(var_iddetallecombo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallecombos_table_refresh_cb);
  } //  do_ajax_form_detallecombos_table_refresh

  function do_ajax_form_detallecombos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.iddetallecombo_.value = scAjaxGetKeyValue("iddetallecombo_");
    ...
    scAjaxAlert(do_ajax_form_detallecombos_table_refresh_cb_after_alert);
  } // do_ajax_form_detallecombos_table_refresh_cb
  function do_ajax_form_detallecombos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_detallecombos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallecombos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallecombos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallecombos_submit_form_cb_after_alert);
  } // do_ajax_form_detallecombos_submit_form_cb
  function do_ajax_form_detallecombos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallecombos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallecombos_navigate_form()
  {
    perform_ajax_form_detallecombos_navigate_form();
  }

  function perform_ajax_form_detallecombos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallecombos_navigate_form(var_iddetallecombo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallecombos_navigate_form_cb);
  } // do_ajax_form_detallecombos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallecombos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallecombos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddetallecombo_.value = scAjaxGetKeyValue("iddetallecombo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallecombos_navigate_form_cb_after_alert);
  } // do_ajax_form_detallecombos_navigate_form_cb
  function do_ajax_form_detallecombos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_detallecombos_navigate_form_cb_after_alert
  function sc_hide_form_detallecombos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idcombo_" + iNumLinha;
    iTotCampos++;
...
?>
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idcombo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcombo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcombo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcombo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcombo_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcombo_'])) ? $this->nmgp_cmp_readonly['idcombo_'] : 'off';
?>
    scAjaxFieldRead("idcombo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
