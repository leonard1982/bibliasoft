...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_numeric[] = "idcomprobante";$Nm_numeric[] = "total_debito";$Nm_numeric[] = "total_credito";$Nm_numeric[] = "asentada";$Nm_numeric[] = "sucursal";$Nm_numeric[] = "usuario";
...
?>
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_1"><?php echo $Img_tit_blk_i ?>grid_comprobantes<?php echo $Img_tit_blk_f ?></TD>
