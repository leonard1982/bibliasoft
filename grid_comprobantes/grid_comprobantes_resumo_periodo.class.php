...
class grid_comprobantes_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_periodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['arr_total']['periodo'];
      }
      else
      {
          $this->array_total_periodo = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['arr_total']['periodo'] = $this->array_total_periodo;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_order']['periodo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_order']['periodo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_order']['periodo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_display']['periodo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_display']['periodo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_display']['periodo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_display']['periodo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_display']['periodo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_display']['periodo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_comprobantes']['summarizing_fields_display']['periodo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'periodo', 'prot' => '@aspass@'),
       );
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total_debito, $sum_total_credito, $quebra_periodo, $quebra_periodo_orig)
   {
      //----- Periodo
      if (!isset($this->array_total_periodo[$quebra_periodo_orig]))
      {
         $this->array_total_periodo[$quebra_periodo_orig][0] = 1;
         $this->array_total_periodo[$quebra_periodo_orig][1] = $sum_total_debito;
         $this->array_total_periodo[$quebra_periodo_orig][2] = $sum_total_credito;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = $this->Ini->Get_date_order_groupby("periodo", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_comprobantes']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total_debito, $this->total_credito, $this->periodo, $this->periodo_orig);
            }
   }
//
