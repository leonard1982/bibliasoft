...
function sc_form_detallepedido_220621_iddet_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_iddet();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_idpedid_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_idpedid();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_idpro_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_idpro();
  scCssBlur(oThis);
}

function sc_form_detallepedido_220621_idpro_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_idpro_onchange();
}
...
function sc_form_detallepedido_220621_unidadmayor_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_unidadmayor();
  scCssBlur(oThis);
}

function sc_form_detallepedido_220621_unidadmayor_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_unidadmayor_onchange();
}
...
function sc_form_detallepedido_220621_factor_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_factor();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_idbod_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_idbod();
  scCssBlur(oThis);
  do_ajax_form_detallepedido_220621_mob_event_idbod_onblur();
}

function sc_form_detallepedido_220621_idbod_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_idbod_onchange();
}
...
function sc_form_detallepedido_220621_costop_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_costop();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_cantidad_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_cantidad();
  scCssBlur(oThis);
  do_ajax_form_detallepedido_220621_mob_event_cantidad_onblur();
}

function sc_form_detallepedido_220621_cantidad_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_cantidad_onchange();
}

function sc_form_detallepedido_220621_cantidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_form_detallepedido_220621_mob_event_cantidad_onfocus();
}

function sc_form_detallepedido_220621_valorunit_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_valorunit();
  scCssBlur(oThis);
}

function sc_form_detallepedido_220621_valorunit_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_valorunit_onchange();
}
...
function sc_form_detallepedido_220621_valorpar_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_valorpar();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_iva();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_descuento_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_descuento();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_adicional_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_adicional();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_adicional1_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_adicional1();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_colores_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_colores();
  scCssBlur(oThis);
}

function sc_form_detallepedido_220621_colores_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_colores_onchange();
}
...
function sc_form_detallepedido_220621_tallas_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_tallas();
  scCssBlur(oThis);
}

function sc_form_detallepedido_220621_tallas_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_tallas_onchange();
}
...
function sc_form_detallepedido_220621_sabor_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_sabor();
  scCssBlur(oThis);
}

function sc_form_detallepedido_220621_sabor_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_sabor_onchange();
}
...
function sc_form_detallepedido_220621_estado_comanda_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_estado_comanda();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_obs_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_obs();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_stockubica_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_stockubica();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_unidad_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_unidad();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_descrip_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_descrip();
  scCssBlur(oThis);
}
...
function sc_form_detallepedido_220621_autorizarborrado_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_validate_autorizarborrado();
  scCssBlur(oThis);
}

function sc_form_detallepedido_220621_autorizarborrado_onclick(oThis, iSeqRow) {
  do_ajax_form_detallepedido_220621_mob_event_autorizarborrado_onclick();
}
...
function scHidePage(pageNo) {
	$("#id_form_detallepedido_220621_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_hora_inicio" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_detallepedido_220621_mob_validate_hora_inicio(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_hora_final" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_detallepedido_220621_mob_validate_hora_final(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_detallepedido_220621_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
