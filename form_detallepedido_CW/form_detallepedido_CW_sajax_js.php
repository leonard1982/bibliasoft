  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallepedido_CW" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallepedido_CW_form();
	}
...
?>
  ...
  // ---------- Validate iddet_
  function do_ajax_form_detallepedido_CW_validate_iddet_(iNumLinha)
  {
    var nomeCampo_iddet_ = "iddet_" + iNumLinha;
    var var_iddet_ = scAjaxGetFieldHidden(nomeCampo_iddet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_CW_validate_iddet_(var_iddet_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_CW_validate_iddet__cb);
  } // do_ajax_form_detallepedido_CW_validate_iddet_

  function do_ajax_form_detallepedido_CW_validate_iddet__cb(sResp)
  {
  ...
  function do_ajax_form_detallepedido_CW_validate_idbod_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_CW_validate_idbod_(var_idbod_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_CW_validate_idbod__cb);
  } // do_ajax_form_detallepedido_CW_validate_idbod_

  function do_ajax_form_detallepedido_CW_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_CW_validate_idbod__cb

  // ---------- Validate observ_
  function do_ajax_form_detallepedido_CW_validate_observ_(iNumLinha)
  {
    var nomeCampo_observ_ = "observ_" + iNumLinha;
    var var_observ_ = scAjaxGetFieldText(nomeCampo_observ_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_CW_validate_observ_(var_observ_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_CW_validate_observ__cb);
  } // do_ajax_form_detallepedido_CW_validate_observ_

  function do_ajax_form_detallepedido_CW_validate_observ__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
  ...
  function do_ajax_form_detallepedido_CW_validate_cantidad_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_CW_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_CW_validate_cantidad__cb);
  } // do_ajax_form_detallepedido_CW_validate_cantidad_

  function do_ajax_form_detallepedido_CW_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_CW_validate_cantidad__cb

  // ---------- Validate valorunit_
  function do_ajax_form_detallepedido_CW_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldText(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_CW_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_CW_validate_valorunit__cb);
  } // do_ajax_form_detallepedido_CW_validate_valorunit_

  function do_ajax_form_detallepedido_CW_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_CW_validate_valorunit__cb

  // ---------- Validate valorpar_
  function do_ajax_form_detallepedido_CW_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldHidden(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_CW_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_CW_validate_valorpar__cb);
  } // do_ajax_form_detallepedido_CW_validate_valorpar_

  function do_ajax_form_detallepedido_CW_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
  ...
  function do_ajax_form_detallepedido_CW_validate_adicional_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_CW_validate_adicional_(var_adicional_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_CW_validate_adicional__cb);
  } // do_ajax_form_detallepedido_CW_validate_adicional_

  function do_ajax_form_detallepedido_CW_validate_adicional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
  ...
  function do_ajax_form_detallepedido_CW_event_cantidad__onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_CW_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_CW_event_cantidad__onchange_cb
  function do_ajax_form_detallepedido_CW_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  function do_ajax_form_detallepedido_CW_event_idpro__onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_CW_event_idpro__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_CW_event_idpro__onchange_cb
  function do_ajax_form_detallepedido_CW_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  function do_ajax_form_detallepedido_CW_event_valorunit__onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_CW_event_valorunit__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_CW_event_valorunit__onchange_cb
  function do_ajax_form_detallepedido_CW_event_valorunit__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_CW_event_valorunit__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallepedido_CW_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallepedido_CW_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_CW_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallepedido_CW_add_new_line_cb);
  } // do_ajax_form_detallepedido_CW_add_new_line

  function do_ajax_form_detallepedido_CW_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  // ---------- backup_line
  function do_ajax_form_detallepedido_CW_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_CW_backup_line(var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallepedido_CW_backup_line_cb);
  } // do_ajax_form_detallepedido_CW_backup_line

  function do_ajax_form_detallepedido_CW_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallepedido_CW_backup_line_cb

  function do_ajax_form_detallepedido_CW_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallepedido_CW_cancel_insert

  function do_ajax_form_detallepedido_CW_cancel_update(iSeqVert)
  {
    do_ajax_form_detallepedido_CW_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallepedido_CW_cancel_update

  function do_ajax_form_detallepedido_CW_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallepedido_CW_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallepedido_CW_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepedido_CW_table_refresh(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepedido_CW_table_refresh_cb);
  } //  do_ajax_form_detallepedido_CW_table_refresh

  function do_ajax_form_detallepedido_CW_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_detallepedido_CW_table_refresh_cb_after_alert);
  } // do_ajax_form_detallepedido_CW_table_refresh_cb
  function do_ajax_form_detallepedido_CW_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detallepedido_CW_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallepedido_CW_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallepedido_CW_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_CW_submit_form_cb_after_alert);
  } // do_ajax_form_detallepedido_CW_submit_form_cb
  function do_ajax_form_detallepedido_CW_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallepedido_CW_submit_form_cb_after_alert
  ...
  function perform_ajax_form_detallepedido_CW_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepedido_CW_navigate_form(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepedido_CW_navigate_form_cb);
  } // do_ajax_form_detallepedido_CW_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido_CW']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallepedido_CW_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallepedido_CW_navigate_form_cb_after_alert);
  } // do_ajax_form_detallepedido_CW_navigate_form_cb
...
?>
  ...
  } // do_ajax_form_detallepedido_CW_navigate_form_cb_after_alert
  function sc_hide_form_detallepedido_CW_form()
  {
