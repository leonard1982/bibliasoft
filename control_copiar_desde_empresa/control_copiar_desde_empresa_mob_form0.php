...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bok", "scBtnFn_sys_format_ok()", "scBtnFn_sys_format_ok()", "sub_form_b", "", "Copiar", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "Copiar", "sc-unique-btn-2", "", "");?>
