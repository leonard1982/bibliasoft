...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("control_copiar_desde_empresa_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('control_copiar_desde_empresa_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("control_copiar_desde_empresa_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['control_copiar_desde_empresa'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['control_copiar_desde_empresa'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['empty_filter'] = true;
       }
  }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_empresa_label" id="hidden_field_label_empresa" style="<?php echo $sStyleHidden_empresa; ?>"><span id="id_label_empresa"><?php echo $this->nm_new_label['empresa']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['php_cmp_required']['empresa']) || $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['php_cmp_required']['empresa'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_empresa_line" id="hidden_field_data_empresa" style="<?php echo $sStyleHidden_empresa; ?>">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["empresa"]) &&  $this->nmgp_cmp_readonly["empresa"] == "on") { 
 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['Lookup_empresa']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['Lookup_empresa'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['Lookup_empresa']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['Lookup_empresa'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Ini->nm_db_conn_facilweb->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['Lookup_empresa'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['Lookup_empresa'][] = ''; 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['Lookup_terceros'][] = 'SI'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['Lookup_productos'][] = 'SI'; ?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['btn_label']['ok'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("control_copiar_desde_empresa");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("control_copiar_desde_empresa");
 parent.scAjaxDetailHeight("control_copiar_desde_empresa", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
