  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_copiar_desde_empresa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_copiar_desde_empresa_form();
	}
...
?>
  ...
  // ---------- Validate empresa
  function do_ajax_control_copiar_desde_empresa_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldSelect(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_desde_empresa_validate_empresa(var_empresa, var_script_case_init, do_ajax_control_copiar_desde_empresa_validate_empresa_cb);
  } // do_ajax_control_copiar_desde_empresa_validate_empresa

  function do_ajax_control_copiar_desde_empresa_validate_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_desde_empresa_validate_empresa_cb

  // ---------- Validate terceros
  function do_ajax_control_copiar_desde_empresa_validate_terceros()
  {
    var nomeCampo_terceros = "terceros";
    var var_terceros = scAjaxGetFieldCheckbox(nomeCampo_terceros, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_desde_empresa_validate_terceros(var_terceros, var_script_case_init, do_ajax_control_copiar_desde_empresa_validate_terceros_cb);
  } // do_ajax_control_copiar_desde_empresa_validate_terceros

  function do_ajax_control_copiar_desde_empresa_validate_terceros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_desde_empresa_validate_terceros_cb

  // ---------- Validate tercero
  function do_ajax_control_copiar_desde_empresa_validate_tercero()
  {
    var nomeCampo_tercero = "tercero";
    var var_tercero = scAjaxGetFieldText(nomeCampo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_desde_empresa_validate_tercero(var_tercero, var_script_case_init, do_ajax_control_copiar_desde_empresa_validate_tercero_cb);
  } // do_ajax_control_copiar_desde_empresa_validate_tercero

  function do_ajax_control_copiar_desde_empresa_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_desde_empresa_validate_tercero_cb

  // ---------- Validate productos
  function do_ajax_control_copiar_desde_empresa_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldCheckbox(nomeCampo_productos, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_desde_empresa_validate_productos(var_productos, var_script_case_init, do_ajax_control_copiar_desde_empresa_validate_productos_cb);
  } // do_ajax_control_copiar_desde_empresa_validate_productos

  function do_ajax_control_copiar_desde_empresa_validate_productos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_desde_empresa_validate_productos_cb

  // ---------- Validate producto
  function do_ajax_control_copiar_desde_empresa_validate_producto()
  {
    var nomeCampo_producto = "producto";
    var var_producto = scAjaxGetFieldText(nomeCampo_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_desde_empresa_validate_producto(var_producto, var_script_case_init, do_ajax_control_copiar_desde_empresa_validate_producto_cb);
  } // do_ajax_control_copiar_desde_empresa_validate_producto

  function do_ajax_control_copiar_desde_empresa_validate_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_desde_empresa_validate_producto_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_copiar_desde_empresa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_copiar_desde_empresa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_control_copiar_desde_empresa_submit_form(var_empresa, var_terceros, var_tercero, var_productos, var_producto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_copiar_desde_empresa_submit_form_cb);
  } // do_ajax_control_copiar_desde_empresa_submit_form

  function do_ajax_control_copiar_desde_empresa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_copiar_desde_empresa_submit_form_cb_after_alert);
  } // do_ajax_control_copiar_desde_empresa_submit_form_cb
  function do_ajax_control_copiar_desde_empresa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_copiar_desde_empresa_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_copiar_desde_empresa_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_copiar_desde_empresa_navigate_form, function() {});
    } else {
      perform_ajax_control_copiar_desde_empresa_navigate_form();
    }
  }

  function perform_ajax_control_copiar_desde_empresa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_desde_empresa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_copiar_desde_empresa_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_copiar_desde_empresa_navigate_form_cb_after_alert);
  } // do_ajax_control_copiar_desde_empresa_navigate_form_cb
  function do_ajax_control_copiar_desde_empresa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_copiar_desde_empresa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_copiar_desde_empresa_navigate_form_cb_after_alert
  function sc_hide_control_copiar_desde_empresa_form()
  {
