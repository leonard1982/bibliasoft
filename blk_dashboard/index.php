<?php
   include_once('blk_dashboard_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blk_dashboard']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blk_dashboard_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blk_dashboard"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blk_dashboard']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blk_dashboard']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blk_dashboard']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blk_dashboard';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blk_dashboard']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blk_dashboard']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blk_dashboard']['actual_lang']) || $_SESSION['scriptcase']['blk_dashboard']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blk_dashboard']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blk_dashboard_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blk_dashboard"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blk_dashboard"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blk_dashboard']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blk_dashboard']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blk_dashboard']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blk_dashboard_erro.class.php"); 
      $this->Erro = new blk_dashboard_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blk_dashboard'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blk_dashboard']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao']) && $_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blk_dashboard']['glo_nm_perfil']) && $_SESSION['scriptcase']['blk_dashboard']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blk_dashboard']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blk_dashboard']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blk_dashboard']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blk_dashboard']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blk_dashboard']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blk_dashboard']['glo_nm_perfil'];
      }
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blk_dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv_2022', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blk_dashboard']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blk_dashboard_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blk_dashboard']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blk_dashboard']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blk_dashboard']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blk_dashboard'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blk_dashboard']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blk_dashboard']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blk_dashboard') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blk_dashboard']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blk_dashboard']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blk_dashboard']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blk_dashboard']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blk_dashboard_erro.class.php"); 
      $this->Erro      = new blk_dashboard_erro();
...
<html lang="es" dir="ltr">
	...
	<body>
				...
				<div class="row pt-4">
						...
						<div class="card expenses-card overflow-hidden"> 
							...
							<div class="chart-wrapper">
								<div class="chart-container">
									<canvas id="chart_total_ventas" class="overflow-hidden" width="340" height="185"></canvas>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-8 col-md-12">
						...
						<div id="indicadores_deck" class="card">
							<div class="card-body">
								<div class="row mb-5">
									<div class="indica col-12 col-sm d-flex mb-4 mb-sm-0">
										<i class="bx bxs-cart-add fs-60 text-info icon-dropshadow-info mr-3"></i>
										<div class="mt-0">
											<h6>Fac. POS</h6>
											<h3 id="i_pos" class="mb-0 font-weight-bold"></h3>
										</div>
									</div>
									<div class="indica col-12 col-sm d-flex mb-4 mb-sm-0">
										<i class="bx bx-receipt fs-60 text-primary icon-dropshadow-primary mr-3"></i>
										<div class="mt-0">
											<h6>Fac. Electroníca</h6>
											<h3 id="i_fe" class="mb-0 font-weight-bold"></h3>
										</div>
									</div>
									<div class="indica col-12 col-sm d-flex">
										<i class="bx bx-target-lock fs-60 text-warning icon-dropshadow-warning mr-3"></i>
										<div class="mt-0"> <h6>Notas Credito</h6>
											<h3 id="i_ncredito" class="mb-0 font-weight-bold"></h3>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="indica col-12 col-sm d-flex mb-4 mb-sm-0">
										<i class="bx bx-task fs-60 text-success icon-dropshadow-success mr-3"></i>
										<div class="mt-0">
											<h6>Doc. Soporte</h6>
											<h3 id="i_dsoporte" class="mb-0 font-weight-bold"></h3>
										</div>
									</div>
									<div class="indica col-12 col-sm d-flex mb-4 mb-sm-0">
										<i class="bx bx-task-x fs-60 text-danger icon-dropshadow-danger mr-3"></i>
										<div class="mt-0">
											<h6>Ajuste Doc. Soporte</h6>
											<h3 id="i_aj_dsoporte" class="mb-0 font-weight-bold"></h3>
										</div>
									</div>
									<div class="indica col-12 col-sm d-flex">
										<i class="bx bxs-cart-download fs-60 text-secondary icon-dropshadow-secondary mr-3"></i>
										<div class="mt-0"> <h6>Nota POS</h6>
											<h3 id="i_n_pos" class="mb-0 font-weight-bold"></h3>
										</div>
									</div>
								</div>
							</div>
						...
						<div id="indicadores_card" class="row">
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body text-center p-4">
										<span class="fs-45 icon-muted">
											<i class="bx bx-spreadsheet icon-dropshadow-success text-success"></i>
										</span>
										<p class=" mb-1 ">Nomina</p>
										<h2 id="i_nomina" class="fs-24 font-weight-bold"></h2>
									</div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body text-center p-4">
										<span class="fs-45 icon-muted">
											<i class="bx bxs-report icon-dropshadow-warning text-warning"></i>
										</span>
										<p class="mb-1 ">Nomina Ajuste</p>
										<h2 id="i_aj_nomina" class="fs-24 font-weight-bold"></h2>
									</div>
								</div>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-12">
								<div class="card">
									<div class="card-body text-center p-4">
										<span class="fs-45 icon-muted">
											<i class="bx bx-archive icon-dropshadow-danger text-danger"></i>
										</span>
										<p class=" mb-1 ">Total Folios Consumindos</p>
										<h2 id="i_folios" class="fs-24 font-weight-bold"></h2>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="card">
							...
							<div class="card-body mx-auto text-center">
								<div class="overflow-hidden">
									<div id="canvasDoughnut3" class="chart-container">
									</div>
								</div>
							</div>
		...
		<!-- chart js-->
		<script src="<?php echo sc_url_library('prj', 'menu', 'assets/plugins/charts/jquery.sparkline.min.js') ?>"></script>
		<script src="<?php echo sc_url_library('prj', 'menu', 'assets/plugins/charts/echarts.js') ?>"></script>
		<script src="<?php echo sc_url_library('prj', 'menu', 'assets/plugins/charts/circle-progress.min.js') ?>"></script>
		<script src="<?php echo sc_url_library('prj', 'menu', 'assets/plugins/charts/chart.min.js') ?>"></script>
		<script src="<?php echo sc_url_library('prj', 'menu', 'assets/plugins/charts/chart.bundle.js') ?>"></script>


		<script src="<?php echo sc_url_library('prj', 'menu', 'assets/plugins/charts/index3.js') ?>"></script>

		<!-- custom js-->
		<script src="<?php echo sc_url_library('prj', 'menu', 'assets/js/custom_dashboard.js') ?>"></script>
		...
		<script>
			...
			function renderVentasXMes(){

				let data = data_ventas.data
				let labels = arrayColumn(data , 'labels');
				let values = arrayColumn(data , 'values');
				let total = values.reduce(function(preVal, currentVal, i, v){
					return preVal + currentVal;
				});
				document.getElementById( "total_ventas" ).textContent = '$' + formatNumber(total);

				console.log(labels)
				console.log(values)
				
				var ctx = document.getElementById( "chart_total_ventas" );
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blk_dashboard($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blk_dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blk_dashboard") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blk_dashboard']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv_2022'])) {
               $_SESSION['scriptcase']['blk_dashboard']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv_2022'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blk_dashboard']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blk_dashboard']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blk_dashboard']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blk_dashboard";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blk_dashboard' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blk_dashboard']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blk_dashboard']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blk_dashboard']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blk_dashboard']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blk_dashboard']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blk_dashboard' == $sReferer || 'blk_dashboard_' == substr($sReferer, 0, 14))
       {
           $_SESSION['sc_session'][$script_case_init]['blk_dashboard']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blk_dashboard')
   {
       $_SESSION['sc_session'][$script_case_init]['blk_dashboard']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blk_dashboard']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blk_dashboard_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blk_dashboard($cadapar[1]);
   ...
   $contr_blk_dashboard = new blk_dashboard_apl();
   $contr_blk_dashboard->controle();
//
   function nm_limpa_str_blk_dashboard(&$str)
   {
