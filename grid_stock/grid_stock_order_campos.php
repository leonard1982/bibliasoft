...
<?php
   ...
   $Ord_Cmp = new grid_stock_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_stock_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["colores"] : "Colores";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["tallas"] : "Tallas";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["idbod"] : "Ubicación del artículo";
   ...
   {
       $tab_def_campos['cantidad'] = "sum(cantidad)";
   }
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_stock']['labels']["cantidad"] : "Cantidad";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_stock']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_stock']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_stock']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_stock_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_stock']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
