...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_stock"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_stock"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_stock']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_stock']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_stock']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_stock']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_stock']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_stock']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_stock']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_stock']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_stock']['embutida_filho'] as $ind => $sc_init)
          {
