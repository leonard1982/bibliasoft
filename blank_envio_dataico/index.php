				...
				else
				{
					...
					if(isset($vrespuesta->errors[0]->error))
					{
						...
						if($vvalidando)
						{
							...
							{
								if($vr->invoice->dian_status=="DIAN_ACEPTADO" or $vparametros["modo"]==1)
								{
									$vsiyadian = true;
