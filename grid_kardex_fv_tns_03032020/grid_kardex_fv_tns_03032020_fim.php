...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_fv_tns_03032020"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_fv_tns_03032020"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns_03032020']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns_03032020']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns_03032020']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns_03032020']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns_03032020']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kardex_fv_tns_03032020</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns_03032020']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns_03032020']['embutida_filho'] as $ind => $sc_init)
          {
