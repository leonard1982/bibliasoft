...
class grid_kardex_fv_tns_03032020_csv
{
   var $Db;
   var $Erro;
   var $Ini;
...
$_SESSION['scriptcase']['grid_kardex_fv_tns_03032020']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          require_once($this->Ini->path_aplicacao . "grid_kardex_fv_tns_03032020_res_csv.class.php");
          $this->Res = new grid_kardex_fv_tns_03032020_res_csv();
          $this->prep_modulos("Res");
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_03032020']['csv_res_grid'] = true;
          $this->Res->monta_csv();
      } 
      if (!$this->Ini->sc_export_ajax) {
      ...
      { 
          ...
          { 
              $str_zip    = "";
              $Arq_res    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_03032020']['csv_res_file'];
              ...
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_03032020']['csv_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns_03032020']['csv_res_file']);
          }
          unlink($Arq_input);
