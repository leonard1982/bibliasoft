  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_configuraciones_print_pos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_configuraciones_print_pos_mob_form();
	}
...
?>
  ...
  function do_ajax_form_configuraciones_print_pos_mob_validate_idconfprintpos()
  {
    ...
    x_ajax_form_configuraciones_print_pos_mob_validate_idconfprintpos(var_idconfprintpos, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_idconfprintpos_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_idconfprintpos

  function do_ajax_form_configuraciones_print_pos_mob_validate_idconfprintpos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_idconfprintpos_cb

  // ---------- Validate tipo_doc
  function do_ajax_form_configuraciones_print_pos_mob_validate_tipo_doc()
  {
    var nomeCampo_tipo_doc = "tipo_doc";
    var var_tipo_doc = scAjaxGetFieldSelect(nomeCampo_tipo_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_tipo_doc(var_tipo_doc, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_tipo_doc_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_tipo_doc

  function do_ajax_form_configuraciones_print_pos_mob_validate_tipo_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_tipo_doc_cb

  // ---------- Validate texto_fuente
  function do_ajax_form_configuraciones_print_pos_mob_validate_texto_fuente()
  {
    var nomeCampo_texto_fuente = "texto_fuente";
    var var_texto_fuente = scAjaxGetFieldSelect(nomeCampo_texto_fuente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_texto_fuente(var_texto_fuente, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_texto_fuente_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_texto_fuente

  function do_ajax_form_configuraciones_print_pos_mob_validate_texto_fuente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_texto_fuente_cb

  // ---------- Validate texto_tamanio
  function do_ajax_form_configuraciones_print_pos_mob_validate_texto_tamanio()
  {
    var nomeCampo_texto_tamanio = "texto_tamanio";
    var var_texto_tamanio = scAjaxGetFieldText(nomeCampo_texto_tamanio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_texto_tamanio(var_texto_tamanio, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_texto_tamanio_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_texto_tamanio

  function do_ajax_form_configuraciones_print_pos_mob_validate_texto_tamanio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_texto_tamanio_cb

  // ---------- Validate porcentajeopx
  function do_ajax_form_configuraciones_print_pos_mob_validate_porcentajeopx()
  {
    var nomeCampo_porcentajeopx = "porcentajeopx";
    var var_porcentajeopx = scAjaxGetFieldRadio(nomeCampo_porcentajeopx);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_porcentajeopx(var_porcentajeopx, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_porcentajeopx_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_porcentajeopx

  function do_ajax_form_configuraciones_print_pos_mob_validate_porcentajeopx_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_porcentajeopx_cb

  // ---------- Validate logo
  function do_ajax_form_configuraciones_print_pos_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldRadio(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_logo(var_logo, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_logo_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_logo

  function do_ajax_form_configuraciones_print_pos_mob_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_logo_cb

  // ---------- Validate texto_cabecera
  function do_ajax_form_configuraciones_print_pos_mob_validate_texto_cabecera()
  {
    var nomeCampo_texto_cabecera = "texto_cabecera";
    var var_texto_cabecera = scAjaxGetFieldEditorHtml(nomeCampo_texto_cabecera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_texto_cabecera(var_texto_cabecera, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_texto_cabecera_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_texto_cabecera

  function do_ajax_form_configuraciones_print_pos_mob_validate_texto_cabecera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_texto_cabecera_cb

  // ---------- Validate texto_pie
  function do_ajax_form_configuraciones_print_pos_mob_validate_texto_pie()
  {
    var nomeCampo_texto_pie = "texto_pie";
    var var_texto_pie = scAjaxGetFieldEditorHtml(nomeCampo_texto_pie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_texto_pie(var_texto_pie, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_texto_pie_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_texto_pie

  function do_ajax_form_configuraciones_print_pos_mob_validate_texto_pie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_texto_pie_cb

  // ---------- Validate archo_ticket
  function do_ajax_form_configuraciones_print_pos_mob_validate_archo_ticket()
  {
    var nomeCampo_archo_ticket = "archo_ticket";
    var var_archo_ticket = scAjaxGetFieldText(nomeCampo_archo_ticket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_archo_ticket(var_archo_ticket, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_archo_ticket_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_archo_ticket

  function do_ajax_form_configuraciones_print_pos_mob_validate_archo_ticket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_archo_ticket_cb

  // ---------- Validate ticket_pjopx
  function do_ajax_form_configuraciones_print_pos_mob_validate_ticket_pjopx()
  {
    var nomeCampo_ticket_pjopx = "ticket_pjopx";
    var var_ticket_pjopx = scAjaxGetFieldRadio(nomeCampo_ticket_pjopx);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_ticket_pjopx(var_ticket_pjopx, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_ticket_pjopx_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_ticket_pjopx

  function do_ajax_form_configuraciones_print_pos_mob_validate_ticket_pjopx_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_ticket_pjopx_cb

  // ---------- Validate predeterminada
  function do_ajax_form_configuraciones_print_pos_mob_validate_predeterminada()
  {
    var nomeCampo_predeterminada = "predeterminada";
    var var_predeterminada = scAjaxGetFieldSelect(nomeCampo_predeterminada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_predeterminada(var_predeterminada, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_predeterminada_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_predeterminada

  function do_ajax_form_configuraciones_print_pos_mob_validate_predeterminada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_predeterminada_cb

  // ---------- Validate tipo_vista
  function do_ajax_form_configuraciones_print_pos_mob_validate_tipo_vista()
  {
    var nomeCampo_tipo_vista = "tipo_vista";
    var var_tipo_vista = scAjaxGetFieldSelect(nomeCampo_tipo_vista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_tipo_vista(var_tipo_vista, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_tipo_vista_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_tipo_vista

  function do_ajax_form_configuraciones_print_pos_mob_validate_tipo_vista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_tipo_vista_cb

  // ---------- Validate impresion_directa
  function do_ajax_form_configuraciones_print_pos_mob_validate_impresion_directa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_impresion_directa(var_impresion_directa, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_impresion_directa_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_impresion_directa

  function do_ajax_form_configuraciones_print_pos_mob_validate_impresion_directa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_impresion_directa_cb

  // ---------- Validate tipo_impresora
  function do_ajax_form_configuraciones_print_pos_mob_validate_tipo_impresora()
  {
    var nomeCampo_tipo_impresora = "tipo_impresora";
    var var_tipo_impresora = scAjaxGetFieldSelect(nomeCampo_tipo_impresora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_tipo_impresora(var_tipo_impresora, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_tipo_impresora_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_tipo_impresora

  function do_ajax_form_configuraciones_print_pos_mob_validate_tipo_impresora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_tipo_impresora_cb

  // ---------- Validate nombre_impresora
  function do_ajax_form_configuraciones_print_pos_mob_validate_nombre_impresora()
  {
    var nomeCampo_nombre_impresora = "nombre_impresora";
    var var_nombre_impresora = scAjaxGetFieldText(nomeCampo_nombre_impresora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_mob_validate_nombre_impresora(var_nombre_impresora, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_validate_nombre_impresora_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_validate_nombre_impresora

  function do_ajax_form_configuraciones_print_pos_mob_validate_nombre_impresora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_mob_validate_nombre_impresora_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_configuraciones_print_pos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_configuraciones_print_pos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_configuraciones_print_pos_mob_submit_form(var_idconfprintpos, var_tipo_doc, var_texto_fuente, var_texto_tamanio, var_porcentajeopx, var_logo, var_texto_cabecera, var_texto_pie, var_archo_ticket, var_ticket_pjopx, var_predeterminada, var_tipo_vista, var_impresion_directa, var_tipo_impresora, var_nombre_impresora, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_configuraciones_print_pos_mob_submit_form_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_submit_form

  function do_ajax_form_configuraciones_print_pos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_configuraciones_print_pos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_configuraciones_print_pos_mob_submit_form_cb
  function do_ajax_form_configuraciones_print_pos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_configuraciones_print_pos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_configuraciones_print_pos_mob_navigate_form()
  {
    perform_ajax_form_configuraciones_print_pos_mob_navigate_form();
  }

  function perform_ajax_form_configuraciones_print_pos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_configuraciones_print_pos_mob_navigate_form(var_idconfprintpos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_configuraciones_print_pos_mob_navigate_form_cb);
  } // do_ajax_form_configuraciones_print_pos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_print_pos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_configuraciones_print_pos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_configuraciones_print_pos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_configuraciones_print_pos_mob_navigate_form_cb
  function do_ajax_form_configuraciones_print_pos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_configuraciones_print_pos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_configuraciones_print_pos_mob_navigate_form_cb_after_alert
  function sc_hide_form_configuraciones_print_pos_mob_form()
  {
