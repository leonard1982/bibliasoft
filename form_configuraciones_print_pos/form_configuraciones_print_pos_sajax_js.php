  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_configuraciones_print_pos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_configuraciones_print_pos_form();
	}
  ...
  // ---------- Validate idconfprintpos
  function do_ajax_form_configuraciones_print_pos_validate_idconfprintpos()
  {
    var nomeCampo_idconfprintpos = "idconfprintpos";
    var var_idconfprintpos = scAjaxGetFieldHidden(nomeCampo_idconfprintpos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_idconfprintpos(var_idconfprintpos, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_idconfprintpos_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_idconfprintpos

  function do_ajax_form_configuraciones_print_pos_validate_idconfprintpos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idconfprintpos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_idconfprintpos_cb

  // ---------- Validate tipo_doc
  function do_ajax_form_configuraciones_print_pos_validate_tipo_doc()
  {
    var nomeCampo_tipo_doc = "tipo_doc";
    var var_tipo_doc = scAjaxGetFieldSelect(nomeCampo_tipo_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_tipo_doc(var_tipo_doc, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_tipo_doc_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_tipo_doc

  function do_ajax_form_configuraciones_print_pos_validate_tipo_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_doc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_tipo_doc_cb

  // ---------- Validate texto_fuente
  function do_ajax_form_configuraciones_print_pos_validate_texto_fuente()
  {
    var nomeCampo_texto_fuente = "texto_fuente";
    var var_texto_fuente = scAjaxGetFieldSelect(nomeCampo_texto_fuente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_texto_fuente(var_texto_fuente, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_texto_fuente_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_texto_fuente

  function do_ajax_form_configuraciones_print_pos_validate_texto_fuente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_fuente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_texto_fuente_cb

  // ---------- Validate texto_tamanio
  function do_ajax_form_configuraciones_print_pos_validate_texto_tamanio()
  {
    var nomeCampo_texto_tamanio = "texto_tamanio";
    var var_texto_tamanio = scAjaxGetFieldText(nomeCampo_texto_tamanio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_texto_tamanio(var_texto_tamanio, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_texto_tamanio_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_texto_tamanio

  function do_ajax_form_configuraciones_print_pos_validate_texto_tamanio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_tamanio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_texto_tamanio_cb

  // ---------- Validate porcentajeopx
  function do_ajax_form_configuraciones_print_pos_validate_porcentajeopx()
  {
    var nomeCampo_porcentajeopx = "porcentajeopx";
    var var_porcentajeopx = scAjaxGetFieldRadio(nomeCampo_porcentajeopx);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_porcentajeopx(var_porcentajeopx, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_porcentajeopx_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_porcentajeopx

  function do_ajax_form_configuraciones_print_pos_validate_porcentajeopx_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "porcentajeopx";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_porcentajeopx_cb

  // ---------- Validate logo
  function do_ajax_form_configuraciones_print_pos_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldRadio(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_logo(var_logo, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_logo_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_logo

  function do_ajax_form_configuraciones_print_pos_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_logo_cb

  // ---------- Validate texto_cabecera
  function do_ajax_form_configuraciones_print_pos_validate_texto_cabecera()
  {
    var nomeCampo_texto_cabecera = "texto_cabecera";
    var var_texto_cabecera = scAjaxGetFieldEditorHtml(nomeCampo_texto_cabecera);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_texto_cabecera(var_texto_cabecera, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_texto_cabecera_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_texto_cabecera

  function do_ajax_form_configuraciones_print_pos_validate_texto_cabecera_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_cabecera";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_texto_cabecera_cb

  // ---------- Validate texto_pie
  function do_ajax_form_configuraciones_print_pos_validate_texto_pie()
  {
    var nomeCampo_texto_pie = "texto_pie";
    var var_texto_pie = scAjaxGetFieldEditorHtml(nomeCampo_texto_pie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_texto_pie(var_texto_pie, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_texto_pie_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_texto_pie

  function do_ajax_form_configuraciones_print_pos_validate_texto_pie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "texto_pie";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_texto_pie_cb

  // ---------- Validate archo_ticket
  function do_ajax_form_configuraciones_print_pos_validate_archo_ticket()
  {
    var nomeCampo_archo_ticket = "archo_ticket";
    var var_archo_ticket = scAjaxGetFieldText(nomeCampo_archo_ticket);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_archo_ticket(var_archo_ticket, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_archo_ticket_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_archo_ticket

  function do_ajax_form_configuraciones_print_pos_validate_archo_ticket_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "archo_ticket";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_archo_ticket_cb

  // ---------- Validate ticket_pjopx
  function do_ajax_form_configuraciones_print_pos_validate_ticket_pjopx()
  {
    var nomeCampo_ticket_pjopx = "ticket_pjopx";
    var var_ticket_pjopx = scAjaxGetFieldRadio(nomeCampo_ticket_pjopx);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_ticket_pjopx(var_ticket_pjopx, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_ticket_pjopx_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_ticket_pjopx

  function do_ajax_form_configuraciones_print_pos_validate_ticket_pjopx_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ticket_pjopx";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_ticket_pjopx_cb

  // ---------- Validate predeterminada
  function do_ajax_form_configuraciones_print_pos_validate_predeterminada()
  {
    var nomeCampo_predeterminada = "predeterminada";
    var var_predeterminada = scAjaxGetFieldSelect(nomeCampo_predeterminada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_predeterminada(var_predeterminada, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_predeterminada_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_predeterminada

  function do_ajax_form_configuraciones_print_pos_validate_predeterminada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "predeterminada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_predeterminada_cb

  // ---------- Validate tipo_vista
  function do_ajax_form_configuraciones_print_pos_validate_tipo_vista()
  {
    var nomeCampo_tipo_vista = "tipo_vista";
    var var_tipo_vista = scAjaxGetFieldSelect(nomeCampo_tipo_vista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_tipo_vista(var_tipo_vista, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_tipo_vista_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_tipo_vista

  function do_ajax_form_configuraciones_print_pos_validate_tipo_vista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_vista";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_tipo_vista_cb

  // ---------- Validate impresion_directa
  function do_ajax_form_configuraciones_print_pos_validate_impresion_directa()
  {
    var nomeCampo_impresion_directa = "impresion_directa";
    var var_impresion_directa = scAjaxGetFieldCheckbox(nomeCampo_impresion_directa, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_impresion_directa(var_impresion_directa, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_impresion_directa_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_impresion_directa

  function do_ajax_form_configuraciones_print_pos_validate_impresion_directa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "impresion_directa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_impresion_directa_cb

  // ---------- Validate tipo_impresora
  function do_ajax_form_configuraciones_print_pos_validate_tipo_impresora()
  {
    var nomeCampo_tipo_impresora = "tipo_impresora";
    var var_tipo_impresora = scAjaxGetFieldSelect(nomeCampo_tipo_impresora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_tipo_impresora(var_tipo_impresora, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_tipo_impresora_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_tipo_impresora

  function do_ajax_form_configuraciones_print_pos_validate_tipo_impresora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_impresora";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_tipo_impresora_cb

  // ---------- Validate nombre_impresora
  function do_ajax_form_configuraciones_print_pos_validate_nombre_impresora()
  {
    var nomeCampo_nombre_impresora = "nombre_impresora";
    var var_nombre_impresora = scAjaxGetFieldText(nomeCampo_nombre_impresora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_print_pos_validate_nombre_impresora(var_nombre_impresora, var_script_case_init, do_ajax_form_configuraciones_print_pos_validate_nombre_impresora_cb);
  } // do_ajax_form_configuraciones_print_pos_validate_nombre_impresora

  function do_ajax_form_configuraciones_print_pos_validate_nombre_impresora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_impresora";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_print_pos_validate_nombre_impresora_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_configuraciones_print_pos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_configuraciones_print_pos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idconfprintpos = scAjaxGetFieldHidden("idconfprintpos");
    var var_tipo_doc = scAjaxGetFieldSelect("tipo_doc");
    var var_texto_fuente = scAjaxGetFieldSelect("texto_fuente");
    var var_texto_tamanio = scAjaxGetFieldText("texto_tamanio");
    var var_porcentajeopx = scAjaxGetFieldRadio("porcentajeopx");
    var var_logo = scAjaxGetFieldRadio("logo");
    var var_texto_cabecera = scAjaxGetFieldEditorHtml("texto_cabecera");
    var var_texto_pie = scAjaxGetFieldEditorHtml("texto_pie");
    var var_archo_ticket = scAjaxGetFieldText("archo_ticket");
    var var_ticket_pjopx = scAjaxGetFieldRadio("ticket_pjopx");
    var var_predeterminada = scAjaxGetFieldSelect("predeterminada");
    var var_tipo_vista = scAjaxGetFieldSelect("tipo_vista");
    var var_impresion_directa = scAjaxGetFieldCheckbox("impresion_directa", ";");
    var var_tipo_impresora = scAjaxGetFieldSelect("tipo_impresora");
    var var_nombre_impresora = scAjaxGetFieldText("nombre_impresora");
    ...
    scAjaxProcOn();
    x_ajax_form_configuraciones_print_pos_submit_form(var_idconfprintpos, var_tipo_doc, var_texto_fuente, var_texto_tamanio, var_porcentajeopx, var_logo, var_texto_cabecera, var_texto_pie, var_archo_ticket, var_ticket_pjopx, var_predeterminada, var_tipo_vista, var_impresion_directa, var_tipo_impresora, var_nombre_impresora, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_configuraciones_print_pos_submit_form_cb);
  } // do_ajax_form_configuraciones_print_pos_submit_form

  function do_ajax_form_configuraciones_print_pos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idconfprintpos");
      scAjaxHideErrorDisplay("tipo_doc");
      scAjaxHideErrorDisplay("texto_fuente");
      scAjaxHideErrorDisplay("texto_tamanio");
      scAjaxHideErrorDisplay("porcentajeopx");
      scAjaxHideErrorDisplay("logo");
      scAjaxHideErrorDisplay("texto_cabecera");
      scAjaxHideErrorDisplay("texto_pie");
      scAjaxHideErrorDisplay("archo_ticket");
      scAjaxHideErrorDisplay("ticket_pjopx");
      scAjaxHideErrorDisplay("predeterminada");
      scAjaxHideErrorDisplay("tipo_vista");
      scAjaxHideErrorDisplay("impresion_directa");
      scAjaxHideErrorDisplay("tipo_impresora");
      scAjaxHideErrorDisplay("nombre_impresora");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_configuraciones_print_pos_submit_form_cb_after_alert);
  } // do_ajax_form_configuraciones_print_pos_submit_form_cb
  function do_ajax_form_configuraciones_print_pos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_configuraciones_print_pos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_configuraciones_print_pos_navigate_form()
  {
    perform_ajax_form_configuraciones_print_pos_navigate_form();
  }

  function perform_ajax_form_configuraciones_print_pos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo_impresora");
    scAjaxHideErrorDisplay("nombre_impresora");
    var var_idconfprintpos = document.F2.idconfprintpos.value;
    ...
    scAjaxProcOn();
    x_ajax_form_configuraciones_print_pos_navigate_form(var_idconfprintpos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_configuraciones_print_pos_navigate_form_cb);
  } // do_ajax_form_configuraciones_print_pos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_print_pos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_configuraciones_print_pos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idconfprintpos.value = scAjaxGetKeyValue("idconfprintpos");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_configuraciones_print_pos_navigate_form_cb_after_alert);
  } // do_ajax_form_configuraciones_print_pos_navigate_form_cb
  function do_ajax_form_configuraciones_print_pos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_configuraciones_print_pos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_configuraciones_print_pos_navigate_form_cb_after_alert
  function sc_hide_form_configuraciones_print_pos_form()
  {
  ...
  ajax_field_list[0] = "idconfprintpos";
  ajax_field_list[1] = "tipo_doc";
  ajax_field_list[2] = "texto_fuente";
  ajax_field_list[3] = "texto_tamanio";
  ajax_field_list[4] = "porcentajeopx";
  ajax_field_list[5] = "logo";
  ajax_field_list[6] = "texto_cabecera";
  ajax_field_list[7] = "texto_pie";
  ajax_field_list[8] = "archo_ticket";
  ajax_field_list[9] = "ticket_pjopx";
  ajax_field_list[10] = "predeterminada";
  ajax_field_list[11] = "tipo_vista";
  ajax_field_list[12] = "impresion_directa";
  ajax_field_list[13] = "tipo_impresora";
  ajax_field_list[14] = "nombre_impresora";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idconfprintpos": {"label": "No Formato", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_doc": {"label": "Tipo Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_fuente": {"label": "Fuente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_tamanio": {"label": "Size", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "porcentajeopx": {"label": "Tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "logo": {"label": "Mostrar Logo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_cabecera": {"label": "Texto Cabecera", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "texto_pie": {"label": "Texto Pie de Página", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "archo_ticket": {"label": "Archo Ticket", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ticket_pjopx": {"label": "Tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "tipo_vista": {"label": "Tipo Vista", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "impresion_directa": {"label": "Impresión Directa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_impresora": {"label": "Tipo Impresora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre_impresora": {"label": "Nombre Impresora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idconfprintpos": new Array(),
    "tipo_doc": new Array(),
    "texto_fuente": new Array(),
    "texto_tamanio": new Array(),
    "porcentajeopx": new Array(),
    "logo": new Array(),
    "texto_cabecera": new Array(),
    "texto_pie": new Array(),
    "archo_ticket": new Array(),
    "ticket_pjopx": new Array(),
    "predeterminada": new Array(),
    "tipo_vista": new Array(),
    "impresion_directa": new Array(),
    "tipo_impresora": new Array(),
    "nombre_impresora": new Array()
  };
  ajax_field_mult["idconfprintpos"][1] = "idconfprintpos";
  ajax_field_mult["tipo_doc"][1] = "tipo_doc";
  ajax_field_mult["texto_fuente"][1] = "texto_fuente";
  ajax_field_mult["texto_tamanio"][1] = "texto_tamanio";
  ajax_field_mult["porcentajeopx"][1] = "porcentajeopx";
  ajax_field_mult["logo"][1] = "logo";
  ajax_field_mult["texto_cabecera"][1] = "texto_cabecera";
  ajax_field_mult["texto_pie"][1] = "texto_pie";
  ajax_field_mult["archo_ticket"][1] = "archo_ticket";
  ajax_field_mult["ticket_pjopx"][1] = "ticket_pjopx";
  ajax_field_mult["predeterminada"][1] = "predeterminada";
  ajax_field_mult["tipo_vista"][1] = "tipo_vista";
  ajax_field_mult["impresion_directa"][1] = "impresion_directa";
  ajax_field_mult["tipo_impresora"][1] = "tipo_impresora";
  ajax_field_mult["nombre_impresora"][1] = "nombre_impresora";

  var ajax_field_id = {
    "idconfprintpos": new Array("hidden_field_label_idconfprintpos", "hidden_field_data_idconfprintpos"),
    "tipo_doc": new Array("hidden_field_label_tipo_doc", "hidden_field_data_tipo_doc"),
    "texto_fuente": new Array("hidden_field_label_texto_fuente", "hidden_field_data_texto_fuente"),
    "texto_tamanio": new Array("hidden_field_label_texto_tamanio", "hidden_field_data_texto_tamanio"),
    "porcentajeopx": new Array("hidden_field_label_porcentajeopx", "hidden_field_data_porcentajeopx"),
    "logo": new Array("hidden_field_label_logo", "hidden_field_data_logo"),
    "texto_cabecera": new Array("hidden_field_label_texto_cabecera", "hidden_field_data_texto_cabecera"),
    "texto_pie": new Array("hidden_field_label_texto_pie", "hidden_field_data_texto_pie"),
    "archo_ticket": new Array("hidden_field_label_archo_ticket", "hidden_field_data_archo_ticket"),
    "ticket_pjopx": new Array("hidden_field_label_ticket_pjopx", "hidden_field_data_ticket_pjopx"),
    "predeterminada": new Array("hidden_field_label_predeterminada", "hidden_field_data_predeterminada"),
    "tipo_vista": new Array("hidden_field_label_tipo_vista", "hidden_field_data_tipo_vista"),
    "impresion_directa": new Array("hidden_field_label_impresion_directa", "hidden_field_data_impresion_directa"),
    "tipo_impresora": new Array("hidden_field_label_tipo_impresora", "hidden_field_data_tipo_impresora"),
    "nombre_impresora": new Array("hidden_field_label_nombre_impresora", "hidden_field_data_nombre_impresora")
  };
  ...
  var ajax_read_only = {
    ...
    "predeterminada": "off",
    "tipo_vista": "off",
    "impresion_directa": "off",
    "tipo_impresora": "off",
    "nombre_impresora": "off"
  };
