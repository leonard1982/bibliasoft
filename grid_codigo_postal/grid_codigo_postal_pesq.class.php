...
class grid_codigo_postal_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_codigo_postal_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_codigo_postal_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_codigo_postal_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_codigo_postal')
      {
          $codigo_postal = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_codigo_postal($codigo_postal);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_barrios_contenidos')
      {
          $barrios_contenidos = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_barrios_contenidos($barrios_contenidos);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idmuni')
      {
          $idmuni = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idmuni($idmuni);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_codigo_postal($codigo_postal)
   {
      $codigo_postal = substr($this->Db->qstr($codigo_postal), 1, -1);
            $codigo_postal_look = substr($this->Db->qstr($codigo_postal), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigo_postal from " . $this->Ini->nm_tabela . " where  codigo_postal like '%" . $codigo_postal . "%' order by codigo_postal"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_barrios_contenidos($barrios_contenidos)
   {
      $barrios_contenidos = substr($this->Db->qstr($barrios_contenidos), 1, -1);
            $barrios_contenidos_look = substr($this->Db->qstr($barrios_contenidos), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct barrios_contenidos from " . $this->Ini->nm_tabela . " where  barrios_contenidos like '%" . $barrios_contenidos . "%' order by barrios_contenidos"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_idmuni($idmuni)
   {
      $idmuni = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idmuni);
      $idmuni = substr($this->Db->qstr($idmuni), 1, -1);
            $idmuni_look = substr($this->Db->qstr($idmuni), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idmuni from " . $this->Ini->nm_tabela . " where   CAST (idmuni AS TEXT)  like '%" . $idmuni . "%' order by idmuni"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idmuni from " . $this->Ini->nm_tabela . " where   CAST (idmuni AS VARCHAR)  like '%" . $idmuni . "%' order by idmuni"; 
      }
      else
      {
          $nm_comando = "select distinct idmuni from " . $this->Ini->nm_tabela . " where  idmuni like '%" . $idmuni . "%' order by idmuni"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_codigo_postal/grid_codigo_postal_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_codigo_postal_ajax_search.js"></script>
 <script type="text/javascript" src="grid_codigo_postal_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_codigo_postal_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_codigo_postal']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_codigo_postal']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_codigo_postal_cond#NMF#' + search_get_sel_txt('SC_codigo_postal_cond') + '@NMF@';
  str_out += 'SC_codigo_postal#NMF#' + search_get_text('SC_codigo_postal') + '@NMF@';
  str_out += 'id_ac_codigo_postal#NMF#' + search_get_title('select2-id_ac_codigo_postal-container') + '@NMF@';
  str_out += 'SC_barrios_contenidos_cond#NMF#' + search_get_sel_txt('SC_barrios_contenidos_cond') + '@NMF@';
  str_out += 'SC_barrios_contenidos#NMF#' + search_get_text('SC_barrios_contenidos') + '@NMF@';
  str_out += 'id_ac_barrios_contenidos#NMF#' + search_get_title('select2-id_ac_barrios_contenidos-container') + '@NMF@';
  str_out += 'SC_idmuni_cond#NMF#' + search_get_sel_txt('SC_idmuni_cond') + '@NMF@';
  str_out += 'SC_idmuni#NMF#' + search_get_text('SC_idmuni') + '@NMF@';
  str_out += 'id_ac_idmuni#NMF#' + search_get_title('select2-id_ac_idmuni-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-idmuni").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idmuni",
      max_itens: "10",
   ...
   $("#SC_idmuni").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-codigo_postal").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_codigo_postal",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_codigo_postal").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-barrios_contenidos").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_barrios_contenidos",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_barrios_contenidos").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>CONSULTA CÓDIGOS POSTALES</span></td>
...
<?php
   ...
   {
      global 
             $codigo_postal_cond, $codigo_postal, $codigo_postal_autocomp,
             $barrios_contenidos_cond, $barrios_contenidos, $barrios_contenidos_autocomp,
             $idmuni_cond, $idmuni, $idmuni_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $codigo_postal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['codigo_postal']; 
          $codigo_postal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['codigo_postal_cond']; 
          $barrios_contenidos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['barrios_contenidos']; 
          $barrios_contenidos_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['barrios_contenidos_cond']; 
          $idmuni = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['idmuni']; 
          $idmuni_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['idmuni_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['NM_operador']; 
      } 
      if (!isset($codigo_postal_cond) || empty($codigo_postal_cond))
      {
         $codigo_postal_cond = "eq";
      }
      if (!isset($barrios_contenidos_cond) || empty($barrios_contenidos_cond))
      {
         $barrios_contenidos_cond = "qp";
      }
      if (!isset($idmuni_cond) || empty($idmuni_cond))
      {
         $idmuni_cond = "eq";
      }
      ...
      $str_hide_codigo_postal = (in_array($codigo_postal_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_barrios_contenidos = (in_array($barrios_contenidos_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idmuni = (in_array($idmuni_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($codigo_postal) || $codigo_postal == "")
      {
          $codigo_postal = "";
      }
      if (isset($codigo_postal) && !empty($codigo_postal))
      {
         $tmp_pos = strpos($codigo_postal, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $codigo_postal = substr($codigo_postal, 0, $tmp_pos);
         }
      }
      if (!isset($barrios_contenidos) || $barrios_contenidos == "")
      {
          $barrios_contenidos = "";
      }
      if (isset($barrios_contenidos) && !empty($barrios_contenidos))
      {
         $tmp_pos = strpos($barrios_contenidos, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $barrios_contenidos = substr($barrios_contenidos, 0, $tmp_pos);
         }
      }
      if (!isset($idmuni) || $idmuni == "")
      {
          $idmuni = "";
      }
      if (isset($idmuni) && !empty($idmuni))
      {
         $tmp_pos = strpos($idmuni, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idmuni = substr($idmuni, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_codigo_postal_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codigo_postal'])) ? $this->New_label['codigo_postal'] : "Codigo Postal"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_codigo_postal_cond" name="codigo_postal_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_postal'), this, 'codigo_postal')">
       <OPTION value="eq" <?php if ("eq" == $codigo_postal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $codigo_postal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $codigo_postal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigo_postal" <?php echo $str_hide_codigo_postal?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['codigo_postal'])) ? $this->New_label['codigo_postal'] : "Codigo Postal";
 $nmgp_tab_label .= "codigo_postal?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $codigo_postal_look = substr($this->Db->qstr($codigo_postal), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigo_postal from " . $this->Ini->nm_tabela . " where codigo_postal = '$codigo_postal_look' order by codigo_postal"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$codigo_postal]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$codigo_postal];
      }
      else
      {
          $sAutocompValue = $codigo_postal;
      }
?>
<INPUT  type="text" id="SC_codigo_postal" name="codigo_postal" value="<?php echo NM_encode_input($codigo_postal) ?>"  size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-codigo_postal" id="id_ac_codigo_postal" name="codigo_postal_autocomp"><?php if ('' !=  $codigo_postal) { ?><option value="<?php echo $codigo_postal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_barrios_contenidos_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['barrios_contenidos'])) ? $this->New_label['barrios_contenidos'] : "Barrios Contenidos"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="sc-js-input scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_barrios_contenidos_cond" name="barrios_contenidos_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrios_contenidos'), this, 'barrios_contenidos')">
       <OPTION value="qp" <?php if ("qp" == $barrios_contenidos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $barrios_contenidos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $barrios_contenidos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $barrios_contenidos_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_barrios_contenidos" <?php echo $str_hide_barrios_contenidos?> valign="top">
 ...
 $nmgp_tab_label .= "barrios_contenidos?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<?php
      if ($barrios_contenidos != "")
      {
      $barrios_contenidos_look = substr($this->Db->qstr($barrios_contenidos), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct barrios_contenidos from " . $this->Ini->nm_tabela . " where barrios_contenidos = '$barrios_contenidos_look' order by barrios_contenidos"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$barrios_contenidos]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$barrios_contenidos];
      }
      else
      {
          $sAutocompValue = $barrios_contenidos;
      }
?>
<INPUT  type="text" id="SC_barrios_contenidos" name="barrios_contenidos" value="<?php echo NM_encode_input($barrios_contenidos) ?>"  size=50 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-barrios_contenidos" id="id_ac_barrios_contenidos" name="barrios_contenidos_autocomp"><?php if ('' !=  $barrios_contenidos) { ?><option value="<?php echo $barrios_contenidos ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_idmuni_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idmuni'])) ? $this->New_label['idmuni'] : "Municipio"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="sc-js-input scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_idmuni_cond" name="idmuni_cond" onChange="nm_campos_between(document.getElementById('id_vis_idmuni'), this, 'idmuni')">
       <OPTION value="eq" <?php if ("eq" == $idmuni_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idmuni" <?php echo $str_hide_idmuni?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idmuni'])) ? $this->New_label['idmuni'] : "Municipio";
 $nmgp_tab_label .= "idmuni?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $idmuni_look = substr($this->Db->qstr($idmuni), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idmuni))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idmuni from " . $this->Ini->nm_tabela . " where idmuni = $idmuni_look order by idmuni"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idmuni from " . $this->Ini->nm_tabela . " where idmuni = $idmuni_look order by idmuni"; 
      ...
      if (isset($nmgp_def_dados[0][$idmuni]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idmuni];
      }
      else
      {
            nmgp_Form_Num_Val($idmuni, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idmuni;
      }
?>
<INPUT  type="text" id="SC_idmuni" name="idmuni" value="<?php echo NM_encode_input($idmuni) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterSubmit: true}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idmuni" id="id_ac_idmuni" name="idmuni_autocomp"><?php if ('' !=  $idmuni) { ?><option value="<?php echo $idmuni ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
<?php
   if (is_file("grid_codigo_postal_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_codigo_postal']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_codigo_postal']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_codigo_postal']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_codigo_postal']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.codigo_postal_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_codigo_postal'), document.F1.codigo_postal_cond, 'codigo_postal');
   document.F1.codigo_postal.value = "";
   document.F1.codigo_postal_autocomp.value = "";
   $('#select2-id_ac_codigo_postal-container').html('<?php echo $this->Val_init_codigo_postal['desc'] ?>');;
   document.F1.barrios_contenidos_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_barrios_contenidos'), document.F1.barrios_contenidos_cond, 'barrios_contenidos');
   document.F1.barrios_contenidos.value = "";
   document.F1.barrios_contenidos_autocomp.value = "";
   $('#select2-id_ac_barrios_contenidos-container').html('<?php echo $this->Val_init_barrios_contenidos['desc'] ?>');;
   document.F1.idmuni_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_idmuni'), document.F1.idmuni_cond, 'idmuni');
   document.F1.idmuni.value = "";
   document.F1.idmuni_autocomp.value = "";
   $('#select2-id_ac_idmuni-container').html('<?php echo $this->Val_init_idmuni['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_codigo_postal";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_codigo_postal_cond'] = 'cond';
      $tp_fields['SC_codigo_postal'] = 'text_aut';
      $tp_fields['id_ac_codigo_postal'] = 'select2_aut';
      $tp_fields['SC_barrios_contenidos_cond'] = 'cond';
      $tp_fields['SC_barrios_contenidos'] = 'text_aut';
      $tp_fields['id_ac_barrios_contenidos'] = 'select2_aut';
      $tp_fields['SC_idmuni_cond'] = 'cond';
      $tp_fields['SC_idmuni'] = 'text_aut';
      $tp_fields['id_ac_idmuni'] = 'select2_aut';
   ...
   {
      global $codigo_postal_cond, $codigo_postal, $codigo_postal_autocomp,
             $barrios_contenidos_cond, $barrios_contenidos, $barrios_contenidos_autocomp,
             $idmuni_cond, $idmuni, $idmuni_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($codigo_postal_autocomp) && empty($codigo_postal))
      {
          $codigo_postal = $codigo_postal_autocomp;
      }
      if (!empty($barrios_contenidos_autocomp) && empty($barrios_contenidos))
      {
          $barrios_contenidos = $barrios_contenidos_autocomp;
      }
      if (!empty($idmuni_autocomp) && empty($idmuni))
      {
          $idmuni = $idmuni_autocomp;
      }
      $codigo_postal_cond_salva = $codigo_postal_cond; 
      if (!isset($codigo_postal_input_2) || $codigo_postal_input_2 == "")
      {
          $codigo_postal_input_2 = $codigo_postal;
      }
      $barrios_contenidos_cond_salva = $barrios_contenidos_cond; 
      if (!isset($barrios_contenidos_input_2) || $barrios_contenidos_input_2 == "")
      {
          $barrios_contenidos_input_2 = $barrios_contenidos;
      }
      $idmuni_cond_salva = $idmuni_cond; 
      if (!isset($idmuni_input_2) || $idmuni_input_2 == "")
      {
          $idmuni_input_2 = $idmuni;
      }
      if ($idmuni_cond != "in")
      {
          nm_limpa_numero($idmuni, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['codigo_postal'] = $codigo_postal; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['codigo_postal_cond'] = $codigo_postal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['barrios_contenidos'] = $barrios_contenidos; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['barrios_contenidos_cond'] = $barrios_contenidos_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['idmuni'] = $idmuni; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['idmuni_cond'] = $idmuni_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca'] = $Temp_Busca;
      }
      if ($idmuni_cond != "in" && $idmuni_cond != "bw" && !empty($idmuni) && !is_numeric($idmuni))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Municipio";
      }
      if ($idmuni_cond == "bw" && ((!empty($idmuni) && !is_numeric($idmuni)) || (!empty($idmuni_input_2) && !is_numeric($idmuni_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Municipio";
      }
      if (!empty($this->Campos_Mens_erro)) 
    ...
    if ($codigo_postal != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['codigo_postal'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['codigo_postal'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['codigo_postal'] = $codigo_postal;
      }
      $nmgp_def_dados = array();
    if ($barrios_contenidos != '') {
      $barrios_contenidos_look = substr($this->Db->qstr($barrios_contenidos), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['barrios_contenidos'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['barrios_contenidos'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['barrios_contenidos'] = $barrios_contenidos;
      }
      $nmgp_def_dados = array();
    if ($idmuni != '') {
      $idmuni_look = substr($this->Db->qstr($idmuni), 1, -1); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idmuni'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['idmuni'] = $cmp1;
      }
      else
      {
          $cmp1 = $idmuni;
      ...
      if (isset($codigo_postal) || $codigo_postal_cond == "nu" || $codigo_postal_cond == "nn" || $codigo_postal_cond == "ep" || $codigo_postal_cond == "ne")
      {
         $this->monta_condicao("codigo_postal", $codigo_postal_cond, $codigo_postal, "", "codigo_postal");
      }

      //----- $barrios_contenidos
      $this->Date_part = false;
      if (isset($barrios_contenidos) || $barrios_contenidos_cond == "nu" || $barrios_contenidos_cond == "nn" || $barrios_contenidos_cond == "ep" || $barrios_contenidos_cond == "ne")
      {
         $this->monta_condicao("barrios_contenidos", $barrios_contenidos_cond, $barrios_contenidos, "", "barrios_contenidos");
      }

      //----- $idmuni
      $this->Date_part = false;
      if (isset($idmuni) || $idmuni_cond == "nu" || $idmuni_cond == "nn" || $idmuni_cond == "ep" || $idmuni_cond == "ne")
      {
         $this->monta_condicao("idmuni", $idmuni_cond, $idmuni, "", "idmuni");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_codigo_postal']['where_pesq'];
