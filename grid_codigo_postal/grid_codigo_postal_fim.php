...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_codigo_postal"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_codigo_postal"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_codigo_postal</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_codigo_postal']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_codigo_postal' || $achou)
          {
