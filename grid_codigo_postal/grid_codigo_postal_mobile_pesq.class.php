...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id_cod_postal";$Nm_numeric[] = "idmuni";$Nm_numeric[] = "id_cod_postal";$Nm_numeric[] = "idmuni";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_codigo_postal_cond" name="codigo_postal_cond" onChange="nm_campos_between(document.getElementById('id_vis_codigo_postal'), this, 'codigo_postal')">
      ...
      <br><span id="id_hide_codigo_postal"  <?php echo $str_hide_codigo_postal?>><?php
      if ($codigo_postal != "")
      {
      $codigo_postal_look = substr($this->Db->qstr($codigo_postal), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterSubmit: true}" id="SC_barrios_contenidos_cond" name="barrios_contenidos_cond" onChange="nm_campos_between(document.getElementById('id_vis_barrios_contenidos'), this, 'barrios_contenidos')">
      ...
      <br><span id="id_hide_barrios_contenidos"  <?php echo $str_hide_barrios_contenidos?>><?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterSubmit: true}" id="SC_idmuni_cond" name="idmuni_cond" onChange="nm_campos_between(document.getElementById('id_vis_idmuni'), this, 'idmuni')">
       <OPTION value="eq" <?php if ("eq" == $idmuni_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idmuni"  <?php echo $str_hide_idmuni?>><?php
      if ($idmuni != "")
      {
      $idmuni_look = substr($this->Db->qstr($idmuni), 1, -1); 
      $nmgp_def_dados = array(); 
