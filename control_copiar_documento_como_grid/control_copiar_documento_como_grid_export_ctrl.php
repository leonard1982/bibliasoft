<?php
@session_start() ;
$_SESSION['scriptcase']['control_copiar_documento_como_grid']['sc_process_barr'] = true;
require_once('../control_copiar_documento_como_grid/index.php');
unset($_SESSION['scriptcase']['control_copiar_documento_como_grid']['sc_process_barr']);
$ExportCtrl = new control_copiar_documento_como_grid_export_control;
$ExportCtrl->Export_barr();

class control_copiar_documento_como_grid_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['control_copiar_documento_como_grid']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['control_copiar_documento_como_grid']['glo_nm_path_imag_temp'];
