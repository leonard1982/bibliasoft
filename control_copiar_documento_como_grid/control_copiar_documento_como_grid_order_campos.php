...
<?php
   ...
   $Ord_Cmp = new control_copiar_documento_como_grid_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class control_copiar_documento_como_grid_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['documento'] = "concat(p.tipo_doc,'/',r.prefijo,'/',p.numpedido)";
   }
   $tab_labels["documento"]   = (isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["documento"])) ? $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["documento"] : "Documento";
   $tab_ger_campos['p_fechaven'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_fechaven'] = "p_fechaven";
   }
   else
   {
       $tab_def_campos['p_fechaven'] = "p.fechaven";
   }
   $tab_labels["p_fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["p_fechaven"])) ? $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["p_fechaven"] : "Fecha";
   ...
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["cliente"] : "Cliente";
   $tab_ger_campos['p_total'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_total'] = "p_total";
   }
   else
   {
       $tab_def_campos['p_total'] = "p.total";
   }
   $tab_labels["p_total"]   = (isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["p_total"])) ? $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["p_total"] : "Total";
   ...
   {
       $tab_def_campos['asesor'] = "v.nombres";
   }
   $tab_labels["asesor"]   = (isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["asesor"])) ? $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['labels']["asesor"] : "Asesor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "control_copiar_documento_como_grid_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['control_copiar_documento_como_grid']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
