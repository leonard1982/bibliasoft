<?php
@session_start() ;
$_SESSION['scriptcase']['grid_CORREOS_VALIDADOS']['sc_process_barr'] = true;
require_once('../grid_CORREOS_VALIDADOS/index.php');
unset($_SESSION['scriptcase']['grid_CORREOS_VALIDADOS']['sc_process_barr']);
$ExportCtrl = new grid_CORREOS_VALIDADOS_export_control;
$ExportCtrl->Export_barr();

class grid_CORREOS_VALIDADOS_export_control
{
