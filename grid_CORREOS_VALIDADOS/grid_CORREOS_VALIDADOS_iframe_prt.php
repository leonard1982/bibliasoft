...
if (!isset($_SESSION['sc_session']))
{
    ...
    if (is_file($root . $_SESSION['scriptcase']['grid_CORREOS_VALIDADOS']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"))
    {
?>
<html>
 <body>
...
<html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
 <head>
  <title>grid_CORREOS_VALIDADOS :: PRINT</title>
