...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_valido_cond" name="valido_cond" onChange="nm_campos_between(document.getElementById('id_vis_valido'), this, 'valido')">
      ...
      <br><span id="id_hide_valido"  <?php echo $str_hide_valido?>><?php
      if ($valido != "")
      {
      $valido_look = substr($this->Db->qstr($valido), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nit_cond" name="nit_cond" onChange="nm_campos_between(document.getElementById('id_vis_nit'), this, 'nit')">
