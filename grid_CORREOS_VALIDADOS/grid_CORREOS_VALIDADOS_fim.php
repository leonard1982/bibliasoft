...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_CORREOS_VALIDADOS"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_CORREOS_VALIDADOS"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_CORREOS_VALIDADOS'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_CORREOS_VALIDADOS']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_CORREOS_VALIDADOS']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_CORREOS_VALIDADOS']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_CORREOS_VALIDADOS']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_CORREOS_VALIDADOS']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_CORREOS_VALIDADOS</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_CORREOS_VALIDADOS']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_CORREOS_VALIDADOS']['embutida_filho'] as $ind => $sc_init)
          {
