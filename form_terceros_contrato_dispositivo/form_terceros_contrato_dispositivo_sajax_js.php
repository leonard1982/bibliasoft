  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_terceros_contrato_dispositivo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_terceros_contrato_dispositivo_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_form_terceros_contrato_dispositivo_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contrato_dispositivo_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_validate_id__cb);
  } // do_ajax_form_terceros_contrato_dispositivo_validate_id_

  function do_ajax_form_terceros_contrato_dispositivo_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contrato_dispositivo_validate_id__cb

  // ---------- Validate contrato_
  function do_ajax_form_terceros_contrato_dispositivo_validate_contrato_(iNumLinha)
  {
    var nomeCampo_contrato_ = "contrato_" + iNumLinha;
    var var_contrato_ = scAjaxGetFieldText(nomeCampo_contrato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contrato_dispositivo_validate_contrato_(var_contrato_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_validate_contrato__cb);
  } // do_ajax_form_terceros_contrato_dispositivo_validate_contrato_

  function do_ajax_form_terceros_contrato_dispositivo_validate_contrato__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "contrato_" + iLineNumber;
    }
    else
    {
      sFieldValid = "contrato_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "contrato_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "contrato_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contrato_dispositivo_validate_contrato__cb

  // ---------- Validate codigo_
  function do_ajax_form_terceros_contrato_dispositivo_validate_codigo_(iNumLinha)
  {
  } // do_ajax_form_terceros_contrato_dispositivo_validate_codigo_

  function do_ajax_form_terceros_contrato_dispositivo_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contrato_dispositivo_validate_codigo__cb

  // ---------- Validate observacion_
  function do_ajax_form_terceros_contrato_dispositivo_validate_observacion_(iNumLinha)
  {
    var nomeCampo_observacion_ = "observacion_" + iNumLinha;
    var var_observacion_ = scAjaxGetFieldText(nomeCampo_observacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contrato_dispositivo_validate_observacion_(var_observacion_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_validate_observacion__cb);
  } // do_ajax_form_terceros_contrato_dispositivo_validate_observacion_

  function do_ajax_form_terceros_contrato_dispositivo_validate_observacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "observacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "observacion_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "observacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "observacion_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contrato_dispositivo_validate_observacion__cb

  // ---------- Validate precinto_
  function do_ajax_form_terceros_contrato_dispositivo_validate_precinto_(iNumLinha)
  {
    var nomeCampo_precinto_ = "precinto_" + iNumLinha;
    var var_precinto_ = scAjaxGetFieldText(nomeCampo_precinto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contrato_dispositivo_validate_precinto_(var_precinto_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_validate_precinto__cb);
  } // do_ajax_form_terceros_contrato_dispositivo_validate_precinto_

  function do_ajax_form_terceros_contrato_dispositivo_validate_precinto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "precinto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "precinto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "precinto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "precinto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contrato_dispositivo_validate_precinto__cb

  // ---------- Validate color_precinto_
  function do_ajax_form_terceros_contrato_dispositivo_validate_color_precinto_(iNumLinha)
  {
    var nomeCampo_color_precinto_ = "color_precinto_" + iNumLinha;
    var var_color_precinto_ = scAjaxGetFieldText(nomeCampo_color_precinto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contrato_dispositivo_validate_color_precinto_(var_color_precinto_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_validate_color_precinto__cb);
  } // do_ajax_form_terceros_contrato_dispositivo_validate_color_precinto_

  function do_ajax_form_terceros_contrato_dispositivo_validate_color_precinto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "color_precinto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "color_precinto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "color_precinto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "color_precinto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contrato_dispositivo_validate_color_precinto__cb

  // ---------- Validate rgb_
  function do_ajax_form_terceros_contrato_dispositivo_validate_rgb_(iNumLinha)
  {
    var nomeCampo_rgb_ = "rgb_" + iNumLinha;
    var var_rgb_ = scAjaxGetFieldHidden(nomeCampo_rgb_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contrato_dispositivo_validate_rgb_(var_rgb_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_validate_rgb__cb);
  } // do_ajax_form_terceros_contrato_dispositivo_validate_rgb_

  function do_ajax_form_terceros_contrato_dispositivo_validate_rgb__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "rgb_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "rgb_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contrato_dispositivo_validate_rgb__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_terceros_contrato_dispositivo_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_terceros_contrato_dispositivo_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_terceros_contrato_dispositivo_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_add_new_line_cb);
  } // do_ajax_form_terceros_contrato_dispositivo_add_new_line

  function do_ajax_form_terceros_contrato_dispositivo_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_terceros_contrato_dispositivo_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_terceros_contrato_dispositivo_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contrato_dispositivo_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_backup_line_cb);
  } // do_ajax_form_terceros_contrato_dispositivo_backup_line

  function do_ajax_form_terceros_contrato_dispositivo_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_terceros_contrato_dispositivo_backup_line_cb

  function do_ajax_form_terceros_contrato_dispositivo_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_terceros_contrato_dispositivo_cancel_insert

  function do_ajax_form_terceros_contrato_dispositivo_cancel_update(iSeqVert)
  {
    do_ajax_form_terceros_contrato_dispositivo_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_terceros_contrato_dispositivo_cancel_update

  function do_ajax_form_terceros_contrato_dispositivo_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_terceros_contrato_dispositivo_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_terceros_contrato_dispositivo_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_contrato_dispositivo_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_table_refresh_cb);
  } //  do_ajax_form_terceros_contrato_dispositivo_table_refresh

  function do_ajax_form_terceros_contrato_dispositivo_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_terceros_contrato_dispositivo_table_refresh_cb_after_alert);
  } // do_ajax_form_terceros_contrato_dispositivo_table_refresh_cb
  function do_ajax_form_terceros_contrato_dispositivo_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_terceros_contrato_dispositivo_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_terceros_contrato_dispositivo_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_terceros_contrato_dispositivo_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_contrato_ = scAjaxGetFieldText("contrato_" + iNumLinha);
    var var_codigo_ = scAjaxGetFieldText("codigo_" + iNumLinha);
    var var_observacion_ = scAjaxGetFieldText("observacion_" + iNumLinha);
    var var_precinto_ = scAjaxGetFieldText("precinto_" + iNumLinha);
    var var_color_precinto_ = scAjaxGetFieldText("color_precinto_" + iNumLinha);
    var var_rgb_ = scAjaxGetFieldHidden("rgb_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_terceros_contrato_dispositivo_submit_form(var_id_, var_contrato_, var_codigo_, var_observacion_, var_precinto_, var_color_precinto_, var_rgb_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_terceros_contrato_dispositivo_submit_form_cb);
  } // do_ajax_form_terceros_contrato_dispositivo_submit_form

  function do_ajax_form_terceros_contrato_dispositivo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("contrato_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("observacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("precinto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("color_precinto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("rgb_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_terceros_contrato_dispositivo_submit_form_cb_after_alert);
  } // do_ajax_form_terceros_contrato_dispositivo_submit_form_cb
  function do_ajax_form_terceros_contrato_dispositivo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_terceros_contrato_dispositivo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_terceros_contrato_dispositivo_navigate_form()
  {
    perform_ajax_form_terceros_contrato_dispositivo_navigate_form();
  }

  function perform_ajax_form_terceros_contrato_dispositivo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("contrato_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_" + iNavForm);
      scAjaxHideErrorDisplay("observacion_" + iNavForm);
      scAjaxHideErrorDisplay("precinto_" + iNavForm);
      scAjaxHideErrorDisplay("color_precinto_" + iNavForm);
      scAjaxHideErrorDisplay("rgb_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_contrato_dispositivo_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_contrato_dispositivo_navigate_form_cb);
  } // do_ajax_form_terceros_contrato_dispositivo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_contrato_dispositivo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_terceros_contrato_dispositivo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_terceros_contrato_dispositivo_navigate_form_cb_after_alert);
  } // do_ajax_form_terceros_contrato_dispositivo_navigate_form_cb
  function do_ajax_form_terceros_contrato_dispositivo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('contrato_1');
...
?>
  ...
  } // do_ajax_form_terceros_contrato_dispositivo_navigate_form_cb_after_alert
  function sc_hide_form_terceros_contrato_dispositivo_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "contrato_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "observacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "precinto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "color_precinto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "rgb_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["contrato_" + iNumLinha] = {"label": "Contrato<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_" + iNumLinha] = {"label": "Dispositivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["observacion_" + iNumLinha] = {"label": "Observación<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["precinto_" + iNumLinha] = {"label": "Precinto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["color_precinto_" + iNumLinha] = {"label": "Color Precinto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["rgb_" + iNumLinha] = {"label": "<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["contrato_"][iNumLinha] = "contrato_" + iNumLinha;
    ajax_field_mult["codigo_"][iNumLinha] = "codigo_" + iNumLinha;
    ajax_field_mult["observacion_"][iNumLinha] = "observacion_" + iNumLinha;
    ajax_field_mult["precinto_"][iNumLinha] = "precinto_" + iNumLinha;
    ajax_field_mult["color_precinto_"][iNumLinha] = "color_precinto_" + iNumLinha;
    ajax_field_mult["rgb_"][iNumLinha] = "rgb_" + iNumLinha;
    ajax_field_id["contrato_" + iNumLinha] = new Array("hidden_field_label_contrato_", "hidden_field_data_contrato_" + iNumLinha);
    ajax_field_id["codigo_" + iNumLinha] = new Array("hidden_field_label_codigo_", "hidden_field_data_codigo_" + iNumLinha);
    ajax_field_id["observacion_" + iNumLinha] = new Array("hidden_field_label_observacion_", "hidden_field_data_observacion_" + iNumLinha);
    ajax_field_id["precinto_" + iNumLinha] = new Array("hidden_field_label_precinto_", "hidden_field_data_precinto_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["contrato_" + iNumLinha] = "off";
    ajax_error_count["codigo_" + iNumLinha] = "off";
    ajax_error_count["observacion_" + iNumLinha] = "off";
    ajax_error_count["precinto_" + iNumLinha] = "off";
    ajax_error_count["color_precinto_" + iNumLinha] = "off";
    ajax_error_count["rgb_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["contrato_" + iNumLinha] = "off";
    ajax_read_only["codigo_" + iNumLinha] = "off";
    ajax_read_only["observacion_" + iNumLinha] = "off";
    ajax_read_only["precinto_" + iNumLinha] = "off";
    ajax_read_only["color_precinto_" + iNumLinha] = "off";
    ajax_read_only["rgb_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["contrato_" + iNumLinha] = "on";
    ajax_read_only["codigo_" + iNumLinha] = "on";
    ajax_read_only["observacion_" + iNumLinha] = "on";
    ajax_read_only["precinto_" + iNumLinha] = "on";
    ajax_read_only["color_precinto_" + iNumLinha] = "on";
    ajax_read_only["rgb_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["contrato_" + iNumLinha] = null;
    ajax_error_list["codigo_" + iNumLinha] = null;
    ajax_error_list["observacion_" + iNumLinha] = null;
    ajax_error_list["precinto_" + iNumLinha] = null;
    ajax_error_list["color_precinto_" + iNumLinha] = null;
    ajax_error_list["rgb_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "contrato_": new Array(),
    "codigo_": new Array(),
    "observacion_": new Array(),
    "precinto_": new Array(),
    "color_precinto_": new Array(),
    "rgb_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["contrato_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["contrato_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["contrato_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["contrato_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["contrato_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["observacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["observacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["observacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["observacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["observacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["precinto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["precinto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["precinto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["precinto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["precinto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["color_precinto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["color_precinto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["color_precinto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["color_precinto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["color_precinto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["rgb_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["rgb_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["rgb_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["rgb_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["rgb_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['contrato_'])) ? $this->nmgp_cmp_readonly['contrato_'] : 'off';
?>
    scAjaxFieldRead("contrato_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['observacion_'])) ? $this->nmgp_cmp_readonly['observacion_'] : 'off';
?>
    scAjaxFieldRead("observacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['precinto_'])) ? $this->nmgp_cmp_readonly['precinto_'] : 'off';
?>
    scAjaxFieldRead("precinto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['color_precinto_'])) ? $this->nmgp_cmp_readonly['color_precinto_'] : 'off';
?>
    scAjaxFieldRead("color_precinto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['rgb_'])) ? $this->nmgp_cmp_readonly['rgb_'] : 'off';
?>
    scAjaxFieldRead("rgb_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("contrato_" + iSeq, "on");
    scAjaxFieldRead("codigo_" + iSeq, "on");
    scAjaxFieldRead("observacion_" + iSeq, "on");
    scAjaxFieldRead("precinto_" + iSeq, "on");
    scAjaxFieldRead("color_precinto_" + iSeq, "on");
    scAjaxFieldRead("rgb_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["contrato_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["observacion_" + iRow] || "on" == ajax_error_count["precinto_" + iRow] || "on" == ajax_error_count["color_precinto_" + iRow] || "on" == ajax_error_count["rgb_" + iRow]))
    {
      ...
      $("#hidden_field_data_contrato_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_observacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_precinto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_color_precinto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_rgb_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["contrato_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["observacion_" + iRow] && "off" == ajax_error_count["precinto_" + iRow] && "off" == ajax_error_count["color_precinto_" + iRow] && "off" == ajax_error_count["rgb_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["contrato_" + iRow] = "off";
        ajax_error_count["codigo_" + iRow] = "off";
        ajax_error_count["observacion_" + iRow] = "off";
        ajax_error_count["precinto_" + iRow] = "off";
        ajax_error_count["color_precinto_" + iRow] = "off";
        ajax_error_count["rgb_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_contrato_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_observacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_precinto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_color_precinto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_rgb_" + iRow).removeClass("scFormErrorLine");
    }
  }
