  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_programar_descuentos_generales_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_programar_descuentos_generales_mob_form();
	}
  ...
  // ---------- Validate id_programar
  function do_ajax_form_programar_descuentos_generales_mob_validate_id_programar()
  {
    var nomeCampo_id_programar = "id_programar";
    var var_id_programar = scAjaxGetFieldHidden(nomeCampo_id_programar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_descuentos_generales_mob_validate_id_programar(var_id_programar, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_validate_id_programar_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_validate_id_programar

  function do_ajax_form_programar_descuentos_generales_mob_validate_id_programar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_programar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_descuentos_generales_mob_validate_id_programar_cb

  // ---------- Validate desde
  function do_ajax_form_programar_descuentos_generales_mob_validate_desde()
  {
    var nomeCampo_desde = "desde";
    var var_desde = scAjaxGetFieldText(nomeCampo_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_descuentos_generales_mob_validate_desde(var_desde, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_validate_desde_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_validate_desde

  function do_ajax_form_programar_descuentos_generales_mob_validate_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desde";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_descuentos_generales_mob_validate_desde_cb

  // ---------- Validate hasta
  function do_ajax_form_programar_descuentos_generales_mob_validate_hasta()
  {
    var nomeCampo_hasta = "hasta";
    var var_hasta = scAjaxGetFieldText(nomeCampo_hasta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_descuentos_generales_mob_validate_hasta(var_hasta, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_validate_hasta_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_validate_hasta

  function do_ajax_form_programar_descuentos_generales_mob_validate_hasta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hasta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_descuentos_generales_mob_validate_hasta_cb

  // ---------- Validate porcentaje
  function do_ajax_form_programar_descuentos_generales_mob_validate_porcentaje()
  {
    var nomeCampo_porcentaje = "porcentaje";
    var var_porcentaje = scAjaxGetFieldText(nomeCampo_porcentaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_descuentos_generales_mob_validate_porcentaje(var_porcentaje, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_validate_porcentaje_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_validate_porcentaje

  function do_ajax_form_programar_descuentos_generales_mob_validate_porcentaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "porcentaje";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_descuentos_generales_mob_validate_porcentaje_cb

  // ---------- Validate usuario
  function do_ajax_form_programar_descuentos_generales_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldHidden(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_descuentos_generales_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_validate_usuario_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_validate_usuario

  function do_ajax_form_programar_descuentos_generales_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_descuentos_generales_mob_validate_usuario_cb

  // ---------- Validate cajas_afectadas
  function do_ajax_form_programar_descuentos_generales_mob_validate_cajas_afectadas()
  {
    var nomeCampo_cajas_afectadas = "cajas_afectadas";
    var var_cajas_afectadas = scAjaxGetFieldSelect(nomeCampo_cajas_afectadas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_descuentos_generales_mob_validate_cajas_afectadas(var_cajas_afectadas, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_validate_cajas_afectadas_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_validate_cajas_afectadas

  function do_ajax_form_programar_descuentos_generales_mob_validate_cajas_afectadas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cajas_afectadas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_descuentos_generales_mob_validate_cajas_afectadas_cb

  // ---------- Validate activo
  function do_ajax_form_programar_descuentos_generales_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldCheckbox(nomeCampo_activo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_descuentos_generales_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_validate_activo_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_validate_activo

  function do_ajax_form_programar_descuentos_generales_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_descuentos_generales_mob_validate_activo_cb

  // ---------- Validate creado
  function do_ajax_form_programar_descuentos_generales_mob_validate_creado()
  {
    var nomeCampo_creado = "creado";
    var var_creado = scAjaxGetFieldText(nomeCampo_creado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_programar_descuentos_generales_mob_validate_creado(var_creado, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_validate_creado_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_validate_creado

  function do_ajax_form_programar_descuentos_generales_mob_validate_creado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_programar_descuentos_generales_mob_validate_creado_cb

  // ---------- Event onchange desde
  function do_ajax_form_programar_descuentos_generales_mob_event_desde_onchange()
  {
    var var_hasta = scAjaxGetFieldText("hasta");
    var var_desde = scAjaxGetFieldText("desde");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_programar_descuentos_generales_mob_event_desde_onchange(var_hasta, var_desde, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_event_desde_onchange_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_event_desde_onchange

  function do_ajax_form_programar_descuentos_generales_mob_event_desde_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "desde";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_programar_descuentos_generales_mob_event_desde_onchange_cb_after_alert);
  } // do_ajax_form_programar_descuentos_generales_mob_event_desde_onchange_cb
  function do_ajax_form_programar_descuentos_generales_mob_event_desde_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_programar_descuentos_generales_mob_event_desde_onchange_cb_after_alert

  // ---------- Event onchange hasta
  function do_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange()
  {
    var var_hasta = scAjaxGetFieldText("hasta");
    var var_desde = scAjaxGetFieldText("desde");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange(var_hasta, var_desde, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange

  function do_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "hasta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange_cb_after_alert);
  } // do_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange_cb
  function do_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_programar_descuentos_generales_mob_event_hasta_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_programar_descuentos_generales_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_programar_descuentos_generales_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_programar = scAjaxGetFieldHidden("id_programar");
    var var_desde = scAjaxGetFieldText("desde");
    var var_hasta = scAjaxGetFieldText("hasta");
    var var_porcentaje = scAjaxGetFieldText("porcentaje");
    var var_usuario = scAjaxGetFieldHidden("usuario");
    var var_cajas_afectadas = scAjaxGetFieldSelect("cajas_afectadas");
    ...
    scAjaxProcOn();
    x_ajax_form_programar_descuentos_generales_mob_submit_form(var_id_programar, var_desde, var_hasta, var_porcentaje, var_usuario, var_cajas_afectadas, var_activo, var_creado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_programar_descuentos_generales_mob_submit_form_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_submit_form

  function do_ajax_form_programar_descuentos_generales_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_programar");
      scAjaxHideErrorDisplay("desde");
      scAjaxHideErrorDisplay("hasta");
      scAjaxHideErrorDisplay("porcentaje");
      scAjaxHideErrorDisplay("usuario");
      scAjaxHideErrorDisplay("cajas_afectadas");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_programar_descuentos_generales_mob_submit_form_cb_after_alert);
  } // do_ajax_form_programar_descuentos_generales_mob_submit_form_cb
  function do_ajax_form_programar_descuentos_generales_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_programar_descuentos_generales_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_programar_descuentos_generales_mob_navigate_form()
  {
    perform_ajax_form_programar_descuentos_generales_mob_navigate_form();
  }

  function perform_ajax_form_programar_descuentos_generales_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("activo");
    scAjaxHideErrorDisplay("creado");
    var var_id_programar = document.F2.id_programar.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_programar_descuentos_generales_mob_navigate_form(var_id_programar, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_programar_descuentos_generales_mob_navigate_form_cb);
  } // do_ajax_form_programar_descuentos_generales_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_programar_descuentos_generales_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_programar_descuentos_generales_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_programar.value = scAjaxGetKeyValue("id_programar");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_programar_descuentos_generales_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_programar_descuentos_generales_mob_navigate_form_cb
  function do_ajax_form_programar_descuentos_generales_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_programar_descuentos_generales_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_programar_descuentos_generales_mob_navigate_form_cb_after_alert
  function sc_hide_form_programar_descuentos_generales_mob_form()
  {
  ...
  ajax_field_list[0] = "id_programar";
  ajax_field_list[1] = "desde";
  ajax_field_list[2] = "hasta";
  ajax_field_list[3] = "porcentaje";
  ajax_field_list[4] = "usuario";
  ajax_field_list[5] = "cajas_afectadas";
  ajax_field_list[6] = "activo";
  ajax_field_list[7] = "creado";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_programar": {"label": "Id Programar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "porcentaje": {"label": "Porcentaje", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario": {"label": "Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cajas_afectadas": {"label": "Cajas Afectadas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "id_programar": new Array(),
    "desde": new Array(),
    "hasta": new Array(),
    "porcentaje": new Array(),
    "usuario": new Array(),
    "cajas_afectadas": new Array(),
    "activo": new Array(),
    "creado": new Array()
  };
  ajax_field_mult["id_programar"][1] = "id_programar";
  ajax_field_mult["desde"][1] = "desde";
  ajax_field_mult["hasta"][1] = "hasta";
  ajax_field_mult["porcentaje"][1] = "porcentaje";
  ajax_field_mult["usuario"][1] = "usuario";
  ajax_field_mult["cajas_afectadas"][1] = "cajas_afectadas";
  ...
  var ajax_field_id = {
    ...
    "porcentaje": new Array("hidden_field_label_porcentaje", "hidden_field_data_porcentaje"),
    "usuario": new Array("hidden_field_label_usuario", "hidden_field_data_usuario"),
    "cajas_afectadas": new Array("hidden_field_label_cajas_afectadas", "hidden_field_data_cajas_afectadas"),
