...
$old_error_handler = set_error_handler("form_programar_descuentos_generales_scriptcase_error_handler");

function form_programar_descuentos_generales_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_programar_descuentos_generales']['contr_erro']) && $_SESSION['scriptcase']['form_programar_descuentos_generales']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_programar_descuentos_generales->contr_form_programar_descuentos_generales->Apl_com_erro = true;
            if ($inicial_form_programar_descuentos_generales->contr_form_programar_descuentos_generales->NM_ajax_flag)
            {
                $inicial_form_programar_descuentos_generales->contr_form_programar_descuentos_generales->NM_ajax_info['errList']['geral_form_programar_descuentos_generales'][] = $msg;
                return;
            }
            form_programar_descuentos_generales_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_programar_descuentos_generales_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_programar_descuentos_generales'])  && '' != $_SESSION['scriptcase']['error_icon']['form_programar_descuentos_generales'])  ? $_SESSION['scriptcase']['error_icon']['form_programar_descuentos_generales']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_programar_descuentos_generales']) && '' != $_SESSION['scriptcase']['error_span_title']['form_programar_descuentos_generales']) ? $_SESSION['scriptcase']['error_span_title']['form_programar_descuentos_generales'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_programar_descuentos_generales']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_programar_descuentos_generales']) ? $_SESSION['scriptcase']['error_icon_title']['form_programar_descuentos_generales'] : '';
?>
