...
class grid_clientes_mini_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_clientes_mini.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_clientes_mini']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes_mini']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes_mini']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes_mini']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes_mini']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes_mini']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes_mini']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_clientes_mini']['contr_erro'] = 'off'; 
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes_mini']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_clientes_mini']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
