...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_clientes_mini"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_clientes_mini"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_clientes_mini'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_mini']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_clientes_mini']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_mini']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_clientes_mini']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_clientes_mini']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_clientes_mini</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_clientes_mini']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_clientes_mini']['embutida_filho'] as $ind => $sc_init)
          {
