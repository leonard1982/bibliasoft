<?php
@session_start() ;
$_SESSION['scriptcase']['grid_clientes_mini']['sc_process_barr'] = true;
require_once('../grid_clientes_mini/index.php');
unset($_SESSION['scriptcase']['grid_clientes_mini']['sc_process_barr']);
$ExportCtrl = new grid_clientes_mini_export_control;
$ExportCtrl->Export_barr();

class grid_clientes_mini_export_control
{
