 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idgrup_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idgrup'])) ? $this->New_label['idgrup'] : "Grupo"; ?></TD>
...
?>
<INPUT  type="text" id="SC_producto" name="producto" value="<?php echo NM_encode_input($producto) ?>"  size=50 alt="{datatype: 'text', maxLength: 723, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
$style_cond_in = ($existencia_cond != "in") ? " style=\"display: none;\"" : ""; 
?>
<INPUT  type="text" id="SC_existencia_IN" name="existencia_IN" value="<?php echo NM_encode_input($existencia_IN) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '0123456789,', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd"<?php echo $style_cond_in ?>>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_existencia"  <?php echo $str_display_existencia; ?> class="scFilterFieldFontOdd">
