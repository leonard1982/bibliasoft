<?php
@session_start() ;
$_SESSION['scriptcase']['grid_costo_inventario']['sc_process_barr'] = true;
require_once('../grid_costo_inventario/index.php');
unset($_SESSION['scriptcase']['grid_costo_inventario']['sc_process_barr']);
$ExportCtrl = new grid_costo_inventario_export_control;
$ExportCtrl->Export_barr();

class grid_costo_inventario_export_control
{
