...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Grupo";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['contr_label_graf']['idgrup']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['contr_label_graf']['idgrup']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['contr_label_graf']['idgrup'];
      }
   }
