...
class grid_costo_inventario_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_costo_inventario_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_costo_inventario_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_costo_inventario_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   {
      $idgrup = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idgrup);
      $idgrup = substr($this->Db->qstr($idgrup), 1, -1);
            $idgrup_look = substr($this->Db->qstr($idgrup), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idgrup from " . $this->Ini->nm_tabela . " where   CAST (idgrup AS TEXT)  like '%" . $idgrup . "%' order by idgrup"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idgrup from " . $this->Ini->nm_tabela . " where   CAST (idgrup AS VARCHAR)  like '%" . $idgrup . "%' order by idgrup"; 
      }
      else
      {
          $nm_comando = "select distinct idgrup from " . $this->Ini->nm_tabela . " where  idgrup like '%" . $idgrup . "%' order by idgrup"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_existencia($existencia)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct stockmen from " . $this->Ini->nm_tabela . " where   CAST (stockmen AS TEXT)  like '%" . $existencia . "%' order by stockmen"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct stockmen from " . $this->Ini->nm_tabela . " where   CAST (stockmen AS VARCHAR)  like '%" . $existencia . "%' order by stockmen"; 
      }
      else
      {
          $nm_comando = "select distinct stockmen from " . $this->Ini->nm_tabela . " where  stockmen like '%" . $existencia . "%' order by stockmen"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idgrup";$Nm_numeric[] = "stockmen";$Nm_numeric[] = "costomen";$Nm_numeric[] = "(costomen*stockmen)";$Nm_numeric[] = "idgrup";$Nm_numeric[] = "stockmen";$Nm_numeric[] = "costomen";$Nm_numeric[] = "(costomen*stockmen)";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_costo_inventario/grid_costo_inventario_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_costo_inventario_ajax_search.js"></script>
 <script type="text/javascript" src="grid_costo_inventario_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_costo_inventario_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_costo_inventario']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_costo_inventario']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'id_ac_idgrup#NMF#' + search_get_title('select2-id_ac_idgrup-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-idgrup").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   $("#SC_idgrup").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Costo Total del Inventario</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idgrup = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['idgrup']; 
          $idgrup_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['idgrup_cond']; 
          $producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['producto']; 
          $producto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['producto_cond']; 
          $existencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['existencia']; 
          $existencia_IN = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['existencia_IN']; 
          $existencia_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['existencia_input_2']; 
          $existencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['existencia_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <INPUT type="hidden" id="SC_idgrup_cond" name="idgrup_cond" value="qp">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_idgrup"  <?php echo $str_hide_idgrup?>><?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idgrup from " . $this->Ini->nm_tabela . " where idgrup = $idgrup_look order by idgrup"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idgrup from " . $this->Ini->nm_tabela . " where idgrup = $idgrup_look order by idgrup"; 
      ...
      {
            nmgp_Form_Num_Val($idgrup, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idgrup;
      }
?>
<INPUT  type="text" id="SC_idgrup" name="idgrup" value="<?php echo NM_encode_input($idgrup) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idgrup" id="id_ac_idgrup" name="idgrup_autocomp"><?php if ('' !=  $idgrup) { ?><option value="<?php echo $idgrup ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_producto"  <?php echo $str_hide_producto?>><INPUT  type="text" id="SC_producto" name="producto" value="<?php echo NM_encode_input($producto) ?>"  size=50 alt="{datatype: 'text', maxLength: 723, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct stockmen from " . $this->Ini->nm_tabela . " where stockmen = $existencia_look order by stockmen"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct stockmen from " . $this->Ini->nm_tabela . " where stockmen = $existencia_look order by stockmen"; 
...
?>
<INPUT  type="text" id="SC_existencia" name="existencia" value="<?php echo NM_encode_input($existencia) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-existencia" id="id_ac_existencia" name="existencia_autocomp"<?php echo $style_cond_in ?>><?php if ('' !=  $existencia) { ?><option value="<?php echo $existencia ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
<?php
$style_cond_in = ($existencia_cond != "in") ? " style=\"display: none;\"" : ""; 
?>
<INPUT  type="text" id="SC_existencia_IN" name="existencia_IN" value="<?php echo NM_encode_input($existencia_IN) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '0123456789,', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd"<?php echo $style_cond_in ?>>         <BR>
        <SPAN id="id_vis_existencia"  <?php echo $str_display_existencia; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_existencia_input_2" name="existencia_input_2" value="<?php echo NM_encode_input($existencia_input_2) ?>"  size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php
   if (is_file("grid_costo_inventario_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_costo_inventario']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_costo_inventario']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idgrup_cond.value = 'qp';
   ...
   $('#select2-id_ac_idgrup-container').html('<?php echo $this->Val_init_idgrup['desc'] ?>');;
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['id_ac_idgrup'] = 'select2_aut';
   ...
   function trata_campos()
   {
      global $idgrup_cond, $idgrup, $idgrup_autocomp,
             $producto_cond, $producto,
             $existencia_cond, $existencia, $existencia_input_2, $existencia_autocomp, $existencia_IN, $nmgp_tab_label;
      ...
      if ($idgrup_cond != "in")
      {
          nm_limpa_numero($idgrup, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['idgrup'] = $idgrup; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['idgrup_cond'] = $idgrup_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['producto'] = $producto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['producto_cond'] = $producto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['existencia'] = $existencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['existencia_input_2'] = $existencia_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['existencia_IN'] = $existencia_IN; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['existencia_cond'] = $existencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      {
         $this->monta_condicao("concat(codigoprod,'-',nompro)", $producto_cond, $producto, "", "producto");
      }
      ...
      {
         $this->monta_condicao("stockmen", $existencia_cond, $existencia, $existencia_input_2, "existencia");
      }
      if ($existencia_cond == "in")
      {
          $existencia = $Cmp_save;
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['cond_pesq'] .= $this->NM_operador;
