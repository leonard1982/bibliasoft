...
class grid_costo_inventario_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idgrup = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['arr_total']['idgrup'];
      }
      else
      {
          $this->array_total_idgrup = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_order']['grupo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_order']['grupo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_order']['grupo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_display']['grupo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_display']['grupo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_display']['grupo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_display']['grupo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_display']['grupo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_display']['grupo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['summarizing_fields_display']['grupo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_idgrup as $i_idgrup => $d_idgrup) {
           if (!in_array($i_idgrup, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idgrup[5] ] = $d_idgrup[4];
               $this->comp_label[0][ $d_idgrup[5] ] = $d_idgrup[4];
           }
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_costo_inventario']['pivot_order_level'] = -1;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_idgrup => $l_idgrup) {
           if (isset($this->array_total_idgrup[$i_idgrup])) {
               $this->comp_group[$i_idgrup] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_idgrup;
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_existencia, $sum_costo_total, $quebra_idgrup, $quebra_idgrup_orig)
   {
      //----- Grupo
      if (!isset($this->array_total_idgrup[$quebra_idgrup_orig]))
      {
         $this->array_total_idgrup[$quebra_idgrup_orig][0] = 1;
         $this->array_total_idgrup[$quebra_idgrup_orig][1] = $sum_existencia;
         $this->array_total_idgrup[$quebra_idgrup_orig][2] = $sum_costo_total;
         $this->array_total_idgrup[$quebra_idgrup_orig][3] = 1;
         $this->array_total_idgrup[$quebra_idgrup_orig][4] = $quebra_idgrup;
         $this->array_total_idgrup[$quebra_idgrup_orig][5] = $quebra_idgrup_orig;
      }
      else
      {
         $this->array_total_idgrup[$quebra_idgrup_orig][0]++;
         $this->array_total_idgrup[$quebra_idgrup_orig][1] += $sum_existencia;
         $this->array_total_idgrup[$quebra_idgrup_orig][2] += $sum_costo_total;
         $this->array_total_idgrup[$quebra_idgrup_orig][3]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'idgrup');
     $campos_order = $this->Ini->Get_date_order_groupby("idgrup", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            nmgp_Form_Num_Val($this->costou, "", "", "", "", "", "", "V::", "") ; 
            nmgp_Form_Num_Val($this->costo_total, "", "", "", "", "", "", "V::", "") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->existencia, $this->costo_total, $this->idgrup, $this->idgrup_orig);
            }
   }
//
