...
<?php
   ...
   $Ord_Cmp = new grid_costo_inventario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_costo_inventario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['producto'] = "concat(codigoprod,'-',nompro)";
   }
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["producto"] : "Producto";
   ...
   {
       $tab_def_campos['existencia'] = "stockmen";
   }
   $tab_labels["existencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["existencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["existencia"] : "Existencia";
   $tab_ger_campos['unimen'] = "on";
   $tab_def_campos['unimen'] = "unimen";
   $tab_labels["unimen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["unimen"])) ? $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["unimen"] : "Unidad";
   $tab_ger_campos['costou'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['costou'] = "costou";
   }
   else
   {
       $tab_def_campos['costou'] = "costomen";
   }
   $tab_labels["costou"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["costou"])) ? $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["costou"] : "Costo";
   $tab_ger_campos['costo_total'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['costo_total'] = "costo_total";
   }
   else
   {
       $tab_def_campos['costo_total'] = "(costomen*stockmen)";
   }
   $tab_labels["costo_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["costo_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['labels']["costo_total"] : "Costo Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_costo_inventario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_costo_inventario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
