...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_costo_inventario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_costo_inventario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_costo_inventario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_costo_inventario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_costo_inventario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_costo_inventario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_costo_inventario']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_costo_inventario</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_costo_inventario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_costo_inventario']['embutida_filho'] as $ind => $sc_init)
          {
