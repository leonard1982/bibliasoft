<?php
@session_start() ;
$_SESSION['scriptcase']['grid_devoluciones_xdevolucion']['sc_process_barr'] = true;
require_once('../grid_devoluciones_xdevolucion/index.php');
unset($_SESSION['scriptcase']['grid_devoluciones_xdevolucion']['sc_process_barr']);
$ExportCtrl = new grid_devoluciones_xdevolucion_export_control;
$ExportCtrl->Export_barr();

class grid_devoluciones_xdevolucion_export_control
{
