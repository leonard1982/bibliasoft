...
class grid_devoluciones_xdevolucion_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_devoluciones_xdevolucion_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_devoluciones_xdevolucion_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_devoluciones_xdevolucion_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_numerodev')
      {
          $numerodev = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_numerodev($numerodev);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_numerodev($numerodev)
   {
      $numerodev = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $numerodev);
      $numerodev = substr($this->Db->qstr($numerodev), 1, -1);
            $numerodev_look = substr($this->Db->qstr($numerodev), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numerodev from " . $this->Ini->nm_tabela . " where   CAST (numerodev AS TEXT)  like '%" . $numerodev . "%' order by numerodev"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numerodev from " . $this->Ini->nm_tabela . " where   CAST (numerodev AS VARCHAR)  like '%" . $numerodev . "%' order by numerodev"; 
      }
      else
      {
          $nm_comando = "select distinct numerodev from " . $this->Ini->nm_tabela . " where  numerodev like '%" . $numerodev . "%' order by numerodev"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_numfacven($numfacven)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where   CAST (numfacven AS TEXT)  like '%" . $numfacven . "%' order by numfacven"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where   CAST (numfacven AS VARCHAR)  like '%" . $numfacven . "%' order by numfacven"; 
      }
      else
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where  numfacven like '%" . $numfacven . "%' order by numfacven"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Lista de devoluciones en Ventas</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_devoluciones_xdevolucion/grid_devoluciones_xdevolucion_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_devoluciones_xdevolucion_ajax_search.js"></script>
 <script type="text/javascript" src="grid_devoluciones_xdevolucion_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_devoluciones_xdevolucion_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_devoluciones_xdevolucion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_devoluciones_xdevolucion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_numerodev_cond#NMF#' + search_get_sel_txt('SC_numerodev_cond') + '@NMF@';
  str_out += 'SC_numerodev#NMF#' + search_get_text('SC_numerodev') + '@NMF@';
  str_out += 'id_ac_numerodev#NMF#' + search_get_title('select2-id_ac_numerodev-container') + '@NMF@';
  str_out += 'SC_numerodev_input_2#NMF#' + search_get_text('SC_numerodev_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-numerodev").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_numerodev",
      max_itens: "10",
   ...
   $("#SC_numerodev").val(e.params.data.id);
  });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Lista de devoluciones en Ventas</span></td>
...
<?php
   ...
   {
      global 
             $numerodev_cond, $numerodev, $numerodev_input_2, $numerodev_autocomp,
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_devoluciones_xdevolucion']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_devoluciones_xdevolucion']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_devoluciones_xdevolucion']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_devoluciones_xdevolucion", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $numerodev = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numerodev']; 
          $numerodev_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numerodev_input_2']; 
          $numerodev_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numerodev_cond']; 
          $numfacven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numfacven']; 
          $numfacven_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numfacven_input_2']; 
          $numfacven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numfacven_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['NM_operador']; 
      } 
      if (!isset($numerodev_cond) || empty($numerodev_cond))
      {
         $numerodev_cond = "gt";
      }
      ...
      $str_hide_numerodev = (in_array($numerodev_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_numerodev = ('bw' == $numerodev_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($numerodev) || $numerodev == "")
      {
          $numerodev = "";
      }
      if (isset($numerodev) && !empty($numerodev))
      {
         $tmp_pos = strpos($numerodev, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $numerodev = substr($numerodev, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_numerodev_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numerodev'])) ? $this->New_label['numerodev'] : "Recibo devolución"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_numerodev_cond" name="numerodev_cond" onChange="nm_campos_between(document.getElementById('id_vis_numerodev'), this, 'numerodev')">
       <OPTION value="gt" <?php if ("gt" == $numerodev_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $numerodev_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $numerodev_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $numerodev_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numerodev" <?php echo $str_hide_numerodev?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['numerodev'])) ? $this->New_label['numerodev'] : "Recibo devolución";
 $nmgp_tab_label .= "numerodev?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
      ...
      $numerodev_look = substr($this->Db->qstr($numerodev), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($numerodev))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numerodev from " . $this->Ini->nm_tabela . " where numerodev = $numerodev_look order by numerodev"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numerodev from " . $this->Ini->nm_tabela . " where numerodev = $numerodev_look order by numerodev"; 
      ...
      if (isset($nmgp_def_dados[0][$numerodev]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$numerodev];
      }
      else
      {
            nmgp_Form_Num_Val($numerodev, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $numerodev;
      }
?>
<INPUT  type="text" id="SC_numerodev" name="numerodev" value="<?php echo NM_encode_input($numerodev) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numerodev" id="id_ac_numerodev" name="numerodev_autocomp"><?php if ('' !=  $numerodev) { ?><option value="<?php echo $numerodev ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_numerodev"  <?php echo $str_display_numerodev; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numerodev_input_2" name="numerodev_input_2" value="<?php echo NM_encode_input($numerodev_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_numfacven_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "Factura de venta"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_numfacven_cond" name="numfacven_cond" onChange="nm_campos_between(document.getElementById('id_vis_numfacven'), this, 'numfacven')">
       <OPTION value="gt" <?php if ("gt" == $numfacven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $numfacven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where numfacven = $numfacven_look order by numfacven"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where numfacven = $numfacven_look order by numfacven"; 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numfacven" id="id_ac_numfacven" name="numfacven_autocomp"><?php if ('' !=  $numfacven) { ?><option value="<?php echo $numfacven ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_numfacven"  <?php echo $str_display_numfacven; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numfacven_input_2" name="numfacven_input_2" value="<?php echo NM_encode_input($numfacven_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_fecha_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha devolución"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fecha_cond" name="fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecha'), this, 'fecha')">
...
?>
<?php
   if (is_file("grid_devoluciones_xdevolucion_help.txt"))
   {
      $Arq_WebHelp = file("grid_devoluciones_xdevolucion_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_devoluciones_xdevolucion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_devoluciones_xdevolucion']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.numerodev_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_numerodev'), document.F1.numerodev_cond, 'numerodev');
   document.F1.numerodev.value = "";
   document.F1.numerodev_autocomp.value = "";
   $('#select2-id_ac_numerodev-container').html('<?php echo $this->Val_init_numerodev['desc'] ?>');;
   document.F1.numerodev_input_2.value = "";
   document.F1.numfacven_cond.value = 'gt';
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_devoluciones_xdevolucion_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_devoluciones_xdevolucion_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_devoluciones_xdevolucion_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_devoluciones_xdevolucion_valida_mes(this)});
 }
 function sc_grid_devoluciones_xdevolucion_valida_dia(obj)
 {
 ...
 function sc_grid_devoluciones_xdevolucion_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_devoluciones_xdevolucion";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_devoluciones_xdevolucion/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_numerodev_cond'] = 'cond';
      $tp_fields['SC_numerodev'] = 'text_aut';
      $tp_fields['id_ac_numerodev'] = 'select2_aut';
      $tp_fields['SC_numerodev_input_2'] = 'text';
   ...
   {
      global $numerodev_cond, $numerodev, $numerodev_input_2, $numerodev_autocomp,
             $numfacven_cond, $numfacven, $numfacven_input_2, $numfacven_autocomp,
             $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($numerodev_autocomp) && empty($numerodev))
      {
          $numerodev = $numerodev_autocomp;
      }
      if (!empty($numfacven_autocomp) && empty($numfacven))
      {
          $numfacven = $numfacven_autocomp;
      }
      $numerodev_cond_salva = $numerodev_cond; 
      if (!isset($numerodev_input_2) || $numerodev_input_2 == "")
      {
          $numerodev_input_2 = $numerodev;
      }
      ...
      if ($numerodev_cond != "in")
      {
          nm_limpa_numero($numerodev, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($numerodev_cond != "in")
      {
          nm_limpa_numero($numerodev_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numerodev'] = $numerodev; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numerodev_input_2'] = $numerodev_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numerodev_cond'] = $numerodev_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numfacven'] = $numfacven; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numfacven_input_2'] = $numfacven_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['numfacven_cond'] = $numfacven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca'] = $Temp_Busca;
      }
      if ($numerodev_cond != "in" && $numerodev_cond != "bw" && !empty($numerodev) && !is_numeric($numerodev))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Recibo devolución";
      }
      if ($numerodev_cond == "bw" && ((!empty($numerodev) && !is_numeric($numerodev)) || (!empty($numerodev_input_2) && !is_numeric($numerodev_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Recibo devolución";
      }
      if ($numfacven_cond != "in" && $numfacven_cond != "bw" && !empty($numfacven) && !is_numeric($numfacven))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Factura de venta";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['numerodev'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['numerodev'] = $cmp1;
      }
      else
      {
          $cmp1 = $numerodev;
      ...
      $Conteudo = $numerodev_input_2;
      if (strtoupper($numerodev_cond) != "II" && strtoupper($numerodev_cond) != "QP" && strtoupper($numerodev_cond) != "NP" && strtoupper($numerodev_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['numerodev_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($numfacven != '') {
      $numfacven_look = substr($this->Db->qstr($numfacven), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (isset($numerodev) || $numerodev_cond == "nu" || $numerodev_cond == "nn" || $numerodev_cond == "ep" || $numerodev_cond == "ne")
      {
         $this->monta_condicao("numerodev", $numerodev_cond, $numerodev, $numerodev_input_2, "numerodev");
      }
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']['fecha_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_devoluciones_xdevolucion']['cond_pesq'] .= $this->NM_operador;
