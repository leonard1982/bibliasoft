<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_devoluciones_xdevolucion']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_devoluciones_xdevolucion_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_devoluciones_xdevolucion_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['numerodev'] = "on";
   $tab_def_campos['numerodev'] = "numerodev";
   $tab_labels["numerodev"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["numerodev"])) ? $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["numerodev"] : "Recibo devolución";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["resolucion"] : "Prefijo Fac";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["numfacven"] : "Factura de venta";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["fecha"] : "Fecha devolución";
   $tab_ger_campos['vunit'] = "on";
   $tab_def_campos['vunit'] = "vunit";
   $tab_labels["vunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["vunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['labels']["vunit"] : "Valor total devolución";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_devoluciones_xdevolucion_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_devoluciones_xdevolucion']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
