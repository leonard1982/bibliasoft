...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_numeric[] = "iddevol";$Nm_numeric[] = "numerodev";$Nm_numeric[] = "numfacven";$Nm_numeric[] = "idinven";$Nm_numeric[] = "idpro";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "vunit";$Nm_numeric[] = "vparc";$Nm_numeric[] = "viva";$Nm_numeric[] = "vdesc";$Nm_numeric[] = "idbod";$Nm_numeric[] = "resolucion";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_numerodev_cond" name="numerodev_cond" onChange="nm_campos_between(document.getElementById('id_vis_numerodev'), this, 'numerodev')">
      ...
      <br><span id="id_hide_numerodev"  <?php echo $str_hide_numerodev?>><?php
      if ($numerodev != "")
      {
      $numerodev_look = substr($this->Db->qstr($numerodev), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numerodev" id="id_ac_numerodev" name="numerodev_autocomp"><?php if ('' !=  $numerodev) { ?><option value="<?php echo $numerodev ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numerodev"  <?php echo $str_display_numerodev; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numfacven_cond" name="numfacven_cond" onChange="nm_campos_between(document.getElementById('id_vis_numfacven'), this, 'numfacven')">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numfacven" id="id_ac_numfacven" name="numfacven_autocomp"><?php if ('' !=  $numfacven) { ?><option value="<?php echo $numfacven ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numfacven"  <?php echo $str_display_numfacven; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_numfacven_input_2" name="numfacven_input_2" value="<?php echo NM_encode_input($numfacven_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
