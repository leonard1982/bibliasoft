<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_facturaven_160119_01']['sc_process_barr'] = true;
require_once('../pdfreport_facturaven_160119_01/index.php');
unset($_SESSION['scriptcase']['pdfreport_facturaven_160119_01']['sc_process_barr']);
$ExportCtrl = new pdfreport_facturaven_160119_01_export_control;
$ExportCtrl->Export_barr();

class pdfreport_facturaven_160119_01_export_control
{
