<?php
@session_start() ;
$_SESSION['scriptcase']['grid_recibos_formapago']['sc_process_barr'] = true;
require_once('../grid_recibos_formapago/index.php');
unset($_SESSION['scriptcase']['grid_recibos_formapago']['sc_process_barr']);
$ExportCtrl = new grid_recibos_formapago_export_control;
$ExportCtrl->Export_barr();

class grid_recibos_formapago_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_recibos_formapago']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_recibos_formapago']['glo_nm_path_imag_temp'];
...
<form name="Fdown" method="get" action="grid_recibos_formapago_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($script_case_init); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_recibos_formapago"> 
