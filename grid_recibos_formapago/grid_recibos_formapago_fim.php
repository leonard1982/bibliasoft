...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_recibos_formapago"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_recibos_formapago"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_recibos_formapago'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_recibos_formapago</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_recibos_formapago']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_recibos_formapago' || $achou)
          {
