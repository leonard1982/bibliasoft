...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_recibos_formapago"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_recibos_formapago"]);
   }
