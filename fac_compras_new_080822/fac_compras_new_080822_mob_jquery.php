...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'creado':
      case 'editado':
        sc_exib_ocult_pag('fac_compras_new_080822_mob_form0');
        break;
      case 'detalle':
        sc_exib_ocult_pag('fac_compras_new_080822_mob_form1');
        break;
      case 'detallenc':
        sc_exib_ocult_pag('fac_compras_new_080822_mob_form2');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idfaccom' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_idfaccom_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new_080822_idfaccom_onfocus(this, iSeqRow) });
  $('#id_sc_field_numfacom' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_numfacom_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new_080822_numfacom_onfocus(this, iSeqRow) });
  $('#id_sc_field_formapago' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_formapago_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_new_080822_formapago_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechacom' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_fechacom_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new_080822_fechacom_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechavenc' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_fechavenc_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_new_080822_fechavenc_onfocus(this, iSeqRow) });
  $('#id_sc_field_idprov' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_idprov_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_fac_compras_new_080822_idprov_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_new_080822_idprov_onfocus(this, iSeqRow) });
  $('#id_sc_field_subtotal' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_subtotal_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new_080822_subtotal_onfocus(this, iSeqRow) });
  $('#id_sc_field_valoriva' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_valoriva_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new_080822_valoriva_onfocus(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_total_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_new_080822_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_pagada' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_pagada_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_new_080822_pagada_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentada' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_asentada_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new_080822_asentada_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new_080822_asentada_onfocus(this, iSeqRow) });
  $('#id_sc_field_control' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_control_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new_080822_control_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_observaciones_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_fac_compras_new_080822_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_saldo_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_new_080822_saldo_onfocus(this, iSeqRow) });
  $('#id_sc_field_anulada' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_anulada_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new_080822_anulada_onfocus(this, iSeqRow) });
  $('#id_sc_field_es_remision' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_es_remision_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_new_080822_es_remision_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_pedidocom' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_id_pedidocom_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_fac_compras_new_080822_id_pedidocom_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_fac_compras_new_080822_id_pedidocom_onfocus(this, iSeqRow) });
  $('#id_sc_field_retencion' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_retencion_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_new_080822_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_reteica' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_reteica_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new_080822_reteica_onfocus(this, iSeqRow) });
  $('#id_sc_field_reteiva' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_reteiva_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new_080822_reteiva_onfocus(this, iSeqRow) });
  $('#id_sc_field_usuario' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_usuario_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new_080822_usuario_onfocus(this, iSeqRow) });
  $('#id_sc_field_banco' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_banco_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_new_080822_banco_onfocus(this, iSeqRow) });
  $('#id_sc_field_creado' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_creado_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_new_080822_creado_onfocus(this, iSeqRow) });
  $('#id_sc_field_creado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_creado_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_new_080822_creado_onfocus(this, iSeqRow) });
  $('#id_sc_field_editado' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_editado_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new_080822_editado_onfocus(this, iSeqRow) });
  $('#id_sc_field_editado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_editado_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_fac_compras_new_080822_editado_onfocus(this, iSeqRow) });
  $('#id_sc_field_cod_cuenta' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_cod_cuenta_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_fac_compras_new_080822_cod_cuenta_onfocus(this, iSeqRow) });
  $('#id_sc_field_prefijo_com' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_prefijo_com_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_new_080822_prefijo_com_onfocus(this, iSeqRow) });
  $('#id_sc_field_numero_com' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_numero_com_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_fac_compras_new_080822_numero_com_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_com' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_tipo_com_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_new_080822_tipo_com_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_new_080822_tipo_com_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_comafec' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_id_comafec_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_fac_compras_new_080822_id_comafec_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_fac_compras_new_080822_id_comafec_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_detalle_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_new_080822_detalle_onfocus(this, iSeqRow) });
  $('#id_sc_field_prefijo_delpedido' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_prefijo_delpedido_onblur(this, iSeqRow) })
                                               .bind('focus', function() { sc_fac_compras_new_080822_prefijo_delpedido_onfocus(this, iSeqRow) });
  $('#id_sc_field_detallenc' + iSeqRow).bind('blur', function() { sc_fac_compras_new_080822_detallenc_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_new_080822_detallenc_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_fac_compras_new_080822_idfaccom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_idfaccom();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_idfaccom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_numfacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_numfacom();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_numfacom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_formapago_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_formapago();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_formapago_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_fechacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_fechacom();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_fechacom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_fechavenc_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_fechavenc();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_fechavenc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_idprov_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_idprov();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_idprov_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_event_idprov_onchange();
}

function sc_fac_compras_new_080822_idprov_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_subtotal();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_subtotal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_valoriva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_valoriva();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_valoriva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_total_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_total();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_pagada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_pagada();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_pagada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_asentada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_asentada();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_asentada_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_event_asentada_onchange();
}

function sc_fac_compras_new_080822_asentada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_control_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_control();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_control_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_observaciones();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_saldo_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_saldo();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_saldo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_anulada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_anulada();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_anulada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_es_remision_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_es_remision();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_es_remision_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_id_pedidocom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_id_pedidocom();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_id_pedidocom_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_event_id_pedidocom_onchange();
}

function sc_fac_compras_new_080822_id_pedidocom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_retencion_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_retencion();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_retencion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_reteica_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_reteica();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_reteica_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_reteiva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_reteiva();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_reteiva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_usuario_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_usuario();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_banco_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_banco();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_banco_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_creado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_creado();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_080822_creado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_fac_compras_new_080822_editado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_editado();
  scCssBlur(oThis);
}
...
function sc_fac_compras_new_080822_editado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_fac_compras_new_080822_cod_cuenta_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_cod_cuenta();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_cod_cuenta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_prefijo_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_prefijo_com();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_prefijo_com_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_numero_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_numero_com();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_numero_com_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_tipo_com_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_tipo_com();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_tipo_com_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_event_tipo_com_onchange();
}

function sc_fac_compras_new_080822_tipo_com_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_id_comafec_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_id_comafec();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_id_comafec_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_event_id_comafec_onchange();
}

function sc_fac_compras_new_080822_id_comafec_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_detalle_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_detalle();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_detalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_prefijo_delpedido_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_prefijo_delpedido();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_prefijo_delpedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_new_080822_detallenc_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_new_080822_mob_validate_detallenc();
  scCssBlur(oThis);
}

function sc_fac_compras_new_080822_detallenc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_fac_compras_new_080822_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechacom" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_080822_mob_validate_fechacom(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_080822_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_080822_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_new_080822_mob_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'fac_compras_new_080822_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
