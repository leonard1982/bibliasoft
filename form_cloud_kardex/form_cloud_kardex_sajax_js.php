  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_kardex" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_kardex_form();
	}
  ...
  // ---------- Validate prefijo
  function do_ajax_form_cloud_kardex_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldText(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_cloud_kardex_validate_prefijo_cb);
  } // do_ajax_form_cloud_kardex_validate_prefijo

  function do_ajax_form_cloud_kardex_validate_prefijo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_cloud_kardex_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_numero(var_numero, var_script_case_init, do_ajax_form_cloud_kardex_validate_numero_cb);
  } // do_ajax_form_cloud_kardex_validate_numero

  function do_ajax_form_cloud_kardex_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_numero_cb

  // ---------- Validate tercero
  function do_ajax_form_cloud_kardex_validate_tercero()
  {
    var nomeCampo_tercero = "tercero";
    var var_tercero = scAjaxGetFieldText(nomeCampo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_tercero(var_tercero, var_script_case_init, do_ajax_form_cloud_kardex_validate_tercero_cb);
  } // do_ajax_form_cloud_kardex_validate_tercero

  function do_ajax_form_cloud_kardex_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_tercero_cb

  // ---------- Validate cufe
  function do_ajax_form_cloud_kardex_validate_cufe()
  {
    var nomeCampo_cufe = "cufe";
    var var_cufe = scAjaxGetFieldText(nomeCampo_cufe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_cufe(var_cufe, var_script_case_init, do_ajax_form_cloud_kardex_validate_cufe_cb);
  } // do_ajax_form_cloud_kardex_validate_cufe

  function do_ajax_form_cloud_kardex_validate_cufe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cufe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_cufe_cb

  // ---------- Validate enlace_pdf
  function do_ajax_form_cloud_kardex_validate_enlace_pdf()
  {
    var nomeCampo_enlace_pdf = "enlace_pdf";
    var var_enlace_pdf = scAjaxGetFieldText(nomeCampo_enlace_pdf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_enlace_pdf(var_enlace_pdf, var_script_case_init, do_ajax_form_cloud_kardex_validate_enlace_pdf_cb);
  } // do_ajax_form_cloud_kardex_validate_enlace_pdf

  function do_ajax_form_cloud_kardex_validate_enlace_pdf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enlace_pdf";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_enlace_pdf_cb

  // ---------- Validate estado
  function do_ajax_form_cloud_kardex_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldText(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_estado(var_estado, var_script_case_init, do_ajax_form_cloud_kardex_validate_estado_cb);
  } // do_ajax_form_cloud_kardex_validate_estado

  function do_ajax_form_cloud_kardex_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_estado_cb

  // ---------- Validate avisos
  function do_ajax_form_cloud_kardex_validate_avisos()
  {
    var nomeCampo_avisos = "avisos";
    var var_avisos = scAjaxGetFieldText(nomeCampo_avisos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_avisos(var_avisos, var_script_case_init, do_ajax_form_cloud_kardex_validate_avisos_cb);
  } // do_ajax_form_cloud_kardex_validate_avisos

  function do_ajax_form_cloud_kardex_validate_avisos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avisos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_avisos_cb

  // ---------- Validate xml
  function do_ajax_form_cloud_kardex_validate_xml()
  {
    var nomeCampo_xml = "xml";
    var var_xml = scAjaxGetFieldText(nomeCampo_xml);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_xml(var_xml, var_script_case_init, do_ajax_form_cloud_kardex_validate_xml_cb);
  } // do_ajax_form_cloud_kardex_validate_xml

  function do_ajax_form_cloud_kardex_validate_xml_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "xml";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_xml_cb

  // ---------- Validate numero_fe
  function do_ajax_form_cloud_kardex_validate_numero_fe()
  {
    var nomeCampo_numero_fe = "numero_fe";
    var var_numero_fe = scAjaxGetFieldText(nomeCampo_numero_fe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_validate_numero_fe(var_numero_fe, var_script_case_init, do_ajax_form_cloud_kardex_validate_numero_fe_cb);
  } // do_ajax_form_cloud_kardex_validate_numero_fe

  function do_ajax_form_cloud_kardex_validate_numero_fe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_fe";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_validate_numero_fe_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_kardex_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_kardex_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_kardex_submit_form(var_prefijo, var_numero, var_tercero, var_cufe, var_enlace_pdf, var_estado, var_avisos, var_xml, var_numero_fe, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_kardex_submit_form_cb);
  } // do_ajax_form_cloud_kardex_submit_form

  function do_ajax_form_cloud_kardex_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("enlace_pdf");
      scAjaxHideErrorDisplay("estado");
      scAjaxHideErrorDisplay("avisos");
      scAjaxHideErrorDisplay("xml");
      scAjaxHideErrorDisplay("numero_fe");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_kardex_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_kardex_submit_form_cb
  function do_ajax_form_cloud_kardex_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_kardex_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_kardex_navigate_form()
  {
    perform_ajax_form_cloud_kardex_navigate_form();
  }

  function perform_ajax_form_cloud_kardex_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_kardex_navigate_form(var_id_cloud_kardex, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_kardex_navigate_form_cb);
  } // do_ajax_form_cloud_kardex_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_kardex']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_kardex_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_kardex_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_kardex_navigate_form_cb
  function do_ajax_form_cloud_kardex_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_kardex_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cloud_kardex_navigate_form_cb_after_alert
  function sc_hide_form_cloud_kardex_form()
  {
  ...
  ajax_field_list[2] = "tercero";
  ajax_field_list[3] = "cufe";
  ajax_field_list[4] = "enlace_pdf";
  ajax_field_list[5] = "estado";
  ajax_field_list[6] = "avisos";
  ajax_field_list[7] = "xml";
  ajax_field_list[8] = "numero_fe";
  ...
  var ajax_error_list = {
    ...
    "enlace_pdf": {"label": "PDF", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "numero_fe": {"label": "Numero Fe", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "enlace_pdf": new Array("hidden_field_label_enlace_pdf", "hidden_field_data_enlace_pdf"),
    ...
    "numero_fe": new Array("hidden_field_label_numero_fe", "hidden_field_data_numero_fe")
  };
