  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pagar_venta_pos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pagar_venta_pos_form();
	}
  ...
  // ---------- Validate fechaven
  function do_ajax_form_pagar_venta_pos_validate_fechaven()
  {
    var nomeCampo_fechaven = "fechaven";
    var var_fechaven = scAjaxGetFieldHidden(nomeCampo_fechaven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_fechaven(var_fechaven, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_fechaven_cb);
  } // do_ajax_form_pagar_venta_pos_validate_fechaven

  function do_ajax_form_pagar_venta_pos_validate_fechaven_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_fechaven_cb

  // ---------- Validate resolucion
  function do_ajax_form_pagar_venta_pos_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_resolucion_cb);
  } // do_ajax_form_pagar_venta_pos_validate_resolucion

  function do_ajax_form_pagar_venta_pos_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_resolucion_cb

  // ---------- Validate numfacven
  function do_ajax_form_pagar_venta_pos_validate_numfacven()
  {
    var nomeCampo_numfacven = "numfacven";
    var var_numfacven = scAjaxGetFieldHidden(nomeCampo_numfacven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_numfacven(var_numfacven, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_numfacven_cb);
  } // do_ajax_form_pagar_venta_pos_validate_numfacven

  function do_ajax_form_pagar_venta_pos_validate_numfacven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_numfacven_cb

  // ---------- Validate idcli
  function do_ajax_form_pagar_venta_pos_validate_idcli()
  {
    var nomeCampo_idcli = "idcli";
    var var_idcli = scAjaxGetFieldSelect(nomeCampo_idcli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_idcli(var_idcli, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_idcli_cb);
  } // do_ajax_form_pagar_venta_pos_validate_idcli

  function do_ajax_form_pagar_venta_pos_validate_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_idcli_cb

  // ---------- Validate total
  function do_ajax_form_pagar_venta_pos_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_total(var_total, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_total_cb);
  } // do_ajax_form_pagar_venta_pos_validate_total

  function do_ajax_form_pagar_venta_pos_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_total_cb

  // ---------- Validate adicional
  function do_ajax_form_pagar_venta_pos_validate_adicional()
  {
    var nomeCampo_adicional = "adicional";
    var var_adicional = scAjaxGetFieldText(nomeCampo_adicional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_adicional(var_adicional, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_adicional_cb);
  } // do_ajax_form_pagar_venta_pos_validate_adicional

  function do_ajax_form_pagar_venta_pos_validate_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_adicional_cb

  // ---------- Validate asentada
  function do_ajax_form_pagar_venta_pos_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldText(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_asentada_cb);
  } // do_ajax_form_pagar_venta_pos_validate_asentada

  function do_ajax_form_pagar_venta_pos_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_asentada_cb

  // ---------- Validate pagada
  function do_ajax_form_pagar_venta_pos_validate_pagada()
  {
    var nomeCampo_pagada = "pagada";
    var var_pagada = scAjaxGetFieldText(nomeCampo_pagada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_pagada(var_pagada, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_pagada_cb);
  } // do_ajax_form_pagar_venta_pos_validate_pagada

  function do_ajax_form_pagar_venta_pos_validate_pagada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pagada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_pagada_cb

  // ---------- Validate adicional2
  function do_ajax_form_pagar_venta_pos_validate_adicional2()
  {
    var nomeCampo_adicional2 = "adicional2";
    var var_adicional2 = scAjaxGetFieldText(nomeCampo_adicional2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_adicional2(var_adicional2, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_adicional2_cb);
  } // do_ajax_form_pagar_venta_pos_validate_adicional2

  function do_ajax_form_pagar_venta_pos_validate_adicional2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_adicional2_cb

  // ---------- Validate adicional3
  function do_ajax_form_pagar_venta_pos_validate_adicional3()
  {
    var nomeCampo_adicional3 = "adicional3";
    var var_adicional3 = scAjaxGetFieldText(nomeCampo_adicional3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_adicional3(var_adicional3, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_adicional3_cb);
  } // do_ajax_form_pagar_venta_pos_validate_adicional3

  function do_ajax_form_pagar_venta_pos_validate_adicional3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_adicional3_cb

  // ---------- Validate obspago
  function do_ajax_form_pagar_venta_pos_validate_obspago()
  {
    var nomeCampo_obspago = "obspago";
    var var_obspago = scAjaxGetFieldText(nomeCampo_obspago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_obspago(var_obspago, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_obspago_cb);
  } // do_ajax_form_pagar_venta_pos_validate_obspago

  function do_ajax_form_pagar_venta_pos_validate_obspago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "obspago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_obspago_cb

  // ---------- Validate detallepag
  function do_ajax_form_pagar_venta_pos_validate_detallepag()
  {
    var nomeCampo_detallepag = "detallepag";
    var var_detallepag = scAjaxGetFieldText(nomeCampo_detallepag);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_venta_pos_validate_detallepag(var_detallepag, var_script_case_init, do_ajax_form_pagar_venta_pos_validate_detallepag_cb);
  } // do_ajax_form_pagar_venta_pos_validate_detallepag

  function do_ajax_form_pagar_venta_pos_validate_detallepag_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_venta_pos_validate_detallepag_cb

  // ---------- Event onchange adicional2
  function do_ajax_form_pagar_venta_pos_event_adicional2_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_pagar_venta_pos_event_adicional2_onchange(var_adicional2, var_total, var_adicional3, var_script_case_init, do_ajax_form_pagar_venta_pos_event_adicional2_onchange_cb);
  } // do_ajax_form_pagar_venta_pos_event_adicional2_onchange

  function do_ajax_form_pagar_venta_pos_event_adicional2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "adicional2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagar_venta_pos_event_adicional2_onchange_cb_after_alert);
  } // do_ajax_form_pagar_venta_pos_event_adicional2_onchange_cb
  function do_ajax_form_pagar_venta_pos_event_adicional2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pagar_venta_pos_event_adicional2_onchange_cb_after_alert

  // ---------- Event onchange pagar
  function do_ajax_form_pagar_venta_pos_event_pagar_onchange()
  {
    var var_adicional2 = scAjaxGetFieldText("adicional2");
    var var_total = scAjaxGetFieldText("total");
    var var_adicional3 = scAjaxGetFieldText("adicional3");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pagar_venta_pos_event_pagar_onchange(var_adicional2, var_total, var_adicional3, var_obspago, var_fechaven, var_numfacven, var_resolucion, var_script_case_init, do_ajax_form_pagar_venta_pos_event_pagar_onchange_cb);
  } // do_ajax_form_pagar_venta_pos_event_pagar_onchange

  function do_ajax_form_pagar_venta_pos_event_pagar_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pagar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagar_venta_pos_event_pagar_onchange_cb_after_alert);
  } // do_ajax_form_pagar_venta_pos_event_pagar_onchange_cb
  function do_ajax_form_pagar_venta_pos_event_pagar_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pagar_venta_pos_event_pagar_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pagar_venta_pos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pagar_venta_pos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fechaven = scAjaxGetFieldHidden("fechaven");
    ...
    scAjaxProcOn();
    x_ajax_form_pagar_venta_pos_submit_form(var_fechaven, var_resolucion, var_numfacven, var_idcli, var_total, var_adicional, var_asentada, var_pagada, var_adicional2, var_adicional3, var_obspago, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pagar_venta_pos_submit_form_cb);
  } // do_ajax_form_pagar_venta_pos_submit_form

  function do_ajax_form_pagar_venta_pos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_venta_pos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_venta_pos']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_venta_pos']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pagar_venta_pos_submit_form_cb_after_alert);
  } // do_ajax_form_pagar_venta_pos_submit_form_cb
  function do_ajax_form_pagar_venta_pos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pagar_venta_pos_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detallepagos_contado"] = "off";

  function do_ajax_form_pagar_venta_pos_navigate_form()
  {
    perform_ajax_form_pagar_venta_pos_navigate_form();
  }

  function perform_ajax_form_pagar_venta_pos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_detallepagos_contado"] = "on";
    x_ajax_form_pagar_venta_pos_navigate_form(var_idfacven, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagar_venta_pos_navigate_form_cb);
  } // do_ajax_form_pagar_venta_pos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_venta_pos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pagar_venta_pos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detallepagos_contado"] && "nmsc_iframe_liga_form_detallepagos_contado" != scMasterDetailIframe["nmsc_iframe_liga_form_detallepagos_contado"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detallepagos_contado"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detallepagos_contado').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_detallepagos_contado').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_detallepagos_contado').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pagar_venta_pos_navigate_form_cb_after_alert);
  } // do_ajax_form_pagar_venta_pos_navigate_form_cb
  function do_ajax_form_pagar_venta_pos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_pagar_venta_pos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pagar_venta_pos_navigate_form_cb_after_alert
  function sc_hide_form_pagar_venta_pos_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detallepagos_contado"])
    {
      return true;
    }
    return false;
