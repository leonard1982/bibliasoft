...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_numfacven' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_numfacven_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pagar_venta_pos_numfacven_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechaven' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_fechaven_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pagar_venta_pos_fechaven_onfocus(this, iSeqRow) });
  $('#id_sc_field_idcli' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_idcli_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pagar_venta_pos_idcli_onfocus(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_total_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pagar_venta_pos_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_pagada' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_pagada_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_pagar_venta_pos_pagada_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentada' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_asentada_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pagar_venta_pos_asentada_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_adicional_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pagar_venta_pos_adicional_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional2' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_adicional2_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_pagar_venta_pos_adicional2_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pagar_venta_pos_adicional2_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional3' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_adicional3_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pagar_venta_pos_adicional3_onfocus(this, iSeqRow) });
  $('#id_sc_field_obspago' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_obspago_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_pagar_venta_pos_obspago_onfocus(this, iSeqRow) });
  $('#id_sc_field_resolucion' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_resolucion_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pagar_venta_pos_resolucion_onfocus(this, iSeqRow) });
  $('#id_sc_field_detallepag' + iSeqRow).bind('blur', function() { sc_form_pagar_venta_pos_detallepag_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pagar_venta_pos_detallepag_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_pagar_venta_pos_numfacven_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_numfacven();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_numfacven_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_fechaven_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_fechaven();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_fechaven_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_idcli_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_idcli();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_idcli_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_total_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_total();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_pagada_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_pagada();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_pagada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_asentada_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_asentada();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_asentada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_adicional_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_adicional();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_adicional_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_adicional2_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_adicional2();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_adicional2_onchange(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_event_adicional2_onchange();
}

function sc_form_pagar_venta_pos_adicional2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_adicional3_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_adicional3();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_adicional3_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_obspago_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_obspago();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_obspago_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_resolucion_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_resolucion();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_resolucion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_venta_pos_detallepag_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_venta_pos_mob_validate_detallepag();
  scCssBlur(oThis);
}

function sc_form_pagar_venta_pos_detallepag_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_pagar_venta_pos_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pagar_venta_pos_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pagar_venta_pos_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
