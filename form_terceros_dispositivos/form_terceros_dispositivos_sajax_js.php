  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_terceros_dispositivos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_terceros_dispositivos_form();
	}
  ...
  // ---------- Validate id_dispositivo_
  function do_ajax_form_terceros_dispositivos_validate_id_dispositivo_(iNumLinha)
  {
    var nomeCampo_id_dispositivo_ = "id_dispositivo_" + iNumLinha;
    var var_id_dispositivo_ = scAjaxGetFieldHidden(nomeCampo_id_dispositivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_dispositivos_validate_id_dispositivo_(var_id_dispositivo_, iNumLinha, var_script_case_init, do_ajax_form_terceros_dispositivos_validate_id_dispositivo__cb);
  } // do_ajax_form_terceros_dispositivos_validate_id_dispositivo_

  function do_ajax_form_terceros_dispositivos_validate_id_dispositivo__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_dispositivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_dispositivo_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_dispositivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_dispositivo_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_dispositivos_validate_id_dispositivo__cb

  // ---------- Validate codigo_dispositivo_
  function do_ajax_form_terceros_dispositivos_validate_codigo_dispositivo_(iNumLinha)
  {
    var nomeCampo_codigo_dispositivo_ = "codigo_dispositivo_" + iNumLinha;
    var var_codigo_dispositivo_ = scAjaxGetFieldText(nomeCampo_codigo_dispositivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_dispositivos_validate_codigo_dispositivo_(var_codigo_dispositivo_, iNumLinha, var_script_case_init, do_ajax_form_terceros_dispositivos_validate_codigo_dispositivo__cb);
  } // do_ajax_form_terceros_dispositivos_validate_codigo_dispositivo_

  function do_ajax_form_terceros_dispositivos_validate_codigo_dispositivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_dispositivo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_dispositivo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigo_dispositivo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_dispositivo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_dispositivos_validate_codigo_dispositivo__cb

  // ---------- Validate nombre_
  function do_ajax_form_terceros_dispositivos_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_dispositivos_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_terceros_dispositivos_validate_nombre__cb);
  } // do_ajax_form_terceros_dispositivos_validate_nombre_

  function do_ajax_form_terceros_dispositivos_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_dispositivos_validate_nombre__cb

  // ---------- Validate marca_
  function do_ajax_form_terceros_dispositivos_validate_marca_(iNumLinha)
  {
    var nomeCampo_marca_ = "marca_" + iNumLinha;
    var var_marca_ = scAjaxGetFieldText(nomeCampo_marca_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_dispositivos_validate_marca_(var_marca_, iNumLinha, var_script_case_init, do_ajax_form_terceros_dispositivos_validate_marca__cb);
  } // do_ajax_form_terceros_dispositivos_validate_marca_

  function do_ajax_form_terceros_dispositivos_validate_marca__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "marca_" + iLineNumber;
    }
    else
    {
      sFieldValid = "marca_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "marca_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "marca_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_dispositivos_validate_marca__cb

  // ---------- Validate serial_
  function do_ajax_form_terceros_dispositivos_validate_serial_(iNumLinha)
  {
    var nomeCampo_serial_ = "serial_" + iNumLinha;
    var var_serial_ = scAjaxGetFieldText(nomeCampo_serial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_dispositivos_validate_serial_(var_serial_, iNumLinha, var_script_case_init, do_ajax_form_terceros_dispositivos_validate_serial__cb);
  } // do_ajax_form_terceros_dispositivos_validate_serial_

  function do_ajax_form_terceros_dispositivos_validate_serial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "serial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "serial_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "serial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "serial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_dispositivos_validate_serial__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_terceros_dispositivos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_terceros_dispositivos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_terceros_dispositivos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_terceros_dispositivos_add_new_line_cb);
  } // do_ajax_form_terceros_dispositivos_add_new_line

  function do_ajax_form_terceros_dispositivos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_terceros_dispositivos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_terceros_dispositivos_backup_line(iNumLinha)
  {
    var var_id_dispositivo_ = scAjaxGetFieldHidden("id_dispositivo_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_dispositivos_backup_line(var_id_dispositivo_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_terceros_dispositivos_backup_line_cb);
  } // do_ajax_form_terceros_dispositivos_backup_line

  function do_ajax_form_terceros_dispositivos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_terceros_dispositivos_backup_line_cb

  function do_ajax_form_terceros_dispositivos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_terceros_dispositivos_cancel_insert

  function do_ajax_form_terceros_dispositivos_cancel_update(iSeqVert)
  {
    do_ajax_form_terceros_dispositivos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_terceros_dispositivos_cancel_update

  function do_ajax_form_terceros_dispositivos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_terceros_dispositivos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_terceros_dispositivos_table_refresh()
  {
    var var_id_dispositivo_ = document.F2.id_dispositivo_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_dispositivos_table_refresh(var_id_dispositivo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_dispositivos_table_refresh_cb);
  } //  do_ajax_form_terceros_dispositivos_table_refresh

  function do_ajax_form_terceros_dispositivos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_dispositivo_.value = scAjaxGetKeyValue("id_dispositivo_");
    ...
    scAjaxAlert(do_ajax_form_terceros_dispositivos_table_refresh_cb_after_alert);
  } // do_ajax_form_terceros_dispositivos_table_refresh_cb
  function do_ajax_form_terceros_dispositivos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_terceros_dispositivos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_terceros_dispositivos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_terceros_dispositivos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_dispositivo_ = scAjaxGetFieldHidden("id_dispositivo_" + iNumLinha);
    var var_codigo_dispositivo_ = scAjaxGetFieldText("codigo_dispositivo_" + iNumLinha);
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_marca_ = scAjaxGetFieldText("marca_" + iNumLinha);
    var var_serial_ = scAjaxGetFieldText("serial_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_terceros_dispositivos_submit_form(var_id_dispositivo_, var_codigo_dispositivo_, var_nombre_, var_marca_, var_serial_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_terceros_dispositivos_submit_form_cb);
  } // do_ajax_form_terceros_dispositivos_submit_form

  function do_ajax_form_terceros_dispositivos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_dispositivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_dispositivo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("marca_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("serial_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_terceros_dispositivos_submit_form_cb_after_alert);
  } // do_ajax_form_terceros_dispositivos_submit_form_cb
  function do_ajax_form_terceros_dispositivos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_terceros_dispositivos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_terceros_dispositivos_navigate_form()
  {
    perform_ajax_form_terceros_dispositivos_navigate_form();
  }

  function perform_ajax_form_terceros_dispositivos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_terceros_dispositivos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_dispositivo_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_dispositivo_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("marca_" + iNavForm);
      scAjaxHideErrorDisplay("serial_" + iNavForm);
    }
    var var_id_dispositivo_ = document.F2.id_dispositivo_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_dispositivos_navigate_form(var_id_dispositivo_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_dispositivos_navigate_form_cb);
  } // do_ajax_form_terceros_dispositivos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_dispositivos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_terceros_dispositivos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_dispositivo_.value = scAjaxGetKeyValue("id_dispositivo_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_terceros_dispositivos_navigate_form_cb_after_alert);
  } // do_ajax_form_terceros_dispositivos_navigate_form_cb
  function do_ajax_form_terceros_dispositivos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_terceros_dispositivos_navigate_form_cb_after_alert
  function sc_hide_form_terceros_dispositivos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_dispositivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_dispositivo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "marca_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "serial_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_dispositivo_" + iNumLinha] = {"label": "Id Dispositivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_dispositivo_" + iNumLinha] = {"label": "Código Dispositivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_" + iNumLinha] = {"label": "Nombre o tipo dispositivo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["marca_" + iNumLinha] = {"label": "Marca<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["serial_" + iNumLinha] = {"label": "IP o MAC<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_dispositivo_"][iNumLinha] = "id_dispositivo_" + iNumLinha;
    ajax_field_mult["codigo_dispositivo_"][iNumLinha] = "codigo_dispositivo_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["marca_"][iNumLinha] = "marca_" + iNumLinha;
    ajax_field_mult["serial_"][iNumLinha] = "serial_" + iNumLinha;
    ajax_field_id["codigo_dispositivo_" + iNumLinha] = new Array("hidden_field_label_codigo_dispositivo_", "hidden_field_data_codigo_dispositivo_" + iNumLinha);
    ajax_field_id["nombre_" + iNumLinha] = new Array("hidden_field_label_nombre_", "hidden_field_data_nombre_" + iNumLinha);
    ajax_field_id["marca_" + iNumLinha] = new Array("hidden_field_label_marca_", "hidden_field_data_marca_" + iNumLinha);
    ajax_field_id["serial_" + iNumLinha] = new Array("hidden_field_label_serial_", "hidden_field_data_serial_" + iNumLinha);
    ajax_error_count["id_dispositivo_" + iNumLinha] = "off";
    ajax_error_count["codigo_dispositivo_" + iNumLinha] = "off";
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["marca_" + iNumLinha] = "off";
    ajax_error_count["serial_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_dispositivo_" + iNumLinha] = "on";
    ajax_read_only["codigo_dispositivo_" + iNumLinha] = "off";
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["marca_" + iNumLinha] = "off";
    ajax_read_only["serial_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_dispositivo_" + iNumLinha] = "on";
    ajax_read_only["codigo_dispositivo_" + iNumLinha] = "on";
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["marca_" + iNumLinha] = "on";
    ajax_read_only["serial_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_dispositivo_" + iNumLinha] = null;
    ajax_error_list["codigo_dispositivo_" + iNumLinha] = null;
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["marca_" + iNumLinha] = null;
    ajax_error_list["serial_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_dispositivo_": new Array(),
    "codigo_dispositivo_": new Array(),
    "nombre_": new Array(),
    "marca_": new Array(),
    "serial_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_dispositivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_dispositivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_dispositivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_dispositivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_dispositivo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["codigo_dispositivo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_dispositivo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_dispositivo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_dispositivo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_dispositivo_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["marca_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["marca_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["marca_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["marca_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["marca_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["serial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["serial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["serial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["serial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["serial_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_dispositivo_'])) ? $this->nmgp_cmp_readonly['id_dispositivo_'] : 'on';
?>
    scAjaxFieldRead("id_dispositivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_dispositivo_'])) ? $this->nmgp_cmp_readonly['codigo_dispositivo_'] : 'off';
?>
    scAjaxFieldRead("codigo_dispositivo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['marca_'])) ? $this->nmgp_cmp_readonly['marca_'] : 'off';
?>
    scAjaxFieldRead("marca_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['serial_'])) ? $this->nmgp_cmp_readonly['serial_'] : 'off';
?>
    scAjaxFieldRead("serial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_dispositivo_" + iSeq, "on");
    scAjaxFieldRead("codigo_dispositivo_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("marca_" + iSeq, "on");
    scAjaxFieldRead("serial_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_dispositivo_" + iRow] || "on" == ajax_error_count["codigo_dispositivo_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["marca_" + iRow] || "on" == ajax_error_count["serial_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_dispositivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_dispositivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_marca_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_serial_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_dispositivo_" + iRow] && "off" == ajax_error_count["codigo_dispositivo_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["marca_" + iRow] && "off" == ajax_error_count["serial_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_dispositivo_" + iRow] = "off";
        ajax_error_count["codigo_dispositivo_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["marca_" + iRow] = "off";
        ajax_error_count["serial_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_dispositivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_dispositivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_marca_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_serial_" + iRow).removeClass("scFormErrorLine");
    }
  }
