...
class grid_inventario_130521_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['grupo'];
      }
      else
      {
          $this->array_total_grupo = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['grupofamilia']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['grupofamilia'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['grupofamilia'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['grupofamilia'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['grupofamilia'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['grupofamilia'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['grupofamilia'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['grupofamilia'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['grupofamilia'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['grupofamilia'] as $i_sum => $d_sum)
           {
