...
class grid_inventario_130521_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['fecha'] = $this->array_total_fecha;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['tipo'] = $this->array_total_tipo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['detalle'] = $this->array_total_detalle;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['colores'] = $this->array_total_colores;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['tallas'] = $this->array_total_tallas;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['sabor'] = $this->array_total_sabor;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['idcombo'] = $this->array_total_idcombo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['grupo'] = $this->array_total_grupo;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['fecha'] = $Lab_fecha; 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['tipo'] = $Lab_tipo; 
       $prep_field['detalle'] = $Lab_detalle;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['detalle'] = $Lab_detalle; 
       $prep_field['colores'] = $Lab_colores;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['colores'] = $Lab_colores; 
       $prep_field['tallas'] = $Lab_tallas;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['tallas'] = $Lab_tallas; 
       $prep_field['sabor'] = $Lab_sabor;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['sabor'] = $Lab_sabor; 
       $prep_field['idcombo'] = $Lab_idcombo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idcombo'] = $Lab_idcombo; 
       $prep_field['grupo'] = $Lab_grupo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['grupo'] = $Lab_grupo; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_inventario_130521/grid_inventario_130521_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   function adiciona_registro($sum_cantidad, $sum_valorparcial, $quebra_fecha, $quebra_idpro, $quebra_idbod, $quebra_tipo, $quebra_detalle, $quebra_colores, $quebra_tallas, $quebra_sabor, $quebra_idcombo, $quebra_grupo, $quebra_fecha_orig, $quebra_idpro_orig, $quebra_idbod_orig, $quebra_tipo_orig, $quebra_detalle_orig, $quebra_colores_orig, $quebra_tallas_orig, $quebra_sabor_orig, $quebra_idcombo_orig, $quebra_grupo_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
