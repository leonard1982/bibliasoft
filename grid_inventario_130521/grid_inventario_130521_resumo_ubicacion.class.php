...
class grid_inventario_130521_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_idpro;
   var $array_total_idbod;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_idpro = array();
      $this->array_total_idbod = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_inventario_130521'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_inventario_130521'];
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_inventario_130521']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_inventario_130521']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['campos_busca'];
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['contr_total_geral'] == "OK")
      {
          $this->array_total_idpro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['idpro'];
          $this->array_total_idbod = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['idbod'];
      }
      else
      {
          $this->array_total_idpro = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['idpro'] = $this->array_total_idpro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total']['idbod'] = $this->array_total_idbod;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['json_use_label'])
       {
          $Lab_idpro = "idpro";
          $Lab_idbod = "idbod";
       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idpro'] = $Lab_idpro; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idbod'] = $Lab_idbod; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['escombo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['escombo'] = "Combo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idpro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idpro'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idcombo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idcombo'] = "De"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['cantidad'] = "Cantidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['costo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['costo'] = "Costo/U."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['valorparcial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['valorparcial'] = "V/Parcial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idbod']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idbod'] = "Ubicación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['detalle']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['detalle'] = "Detalle"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['inicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['inicio'] = "Creado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['fechavenc'] = "Vence"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['lote2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['lote2'] = "Lote"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['fecha'] = "Fecha Doc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idmov']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idmov'] = "Idmov"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['nufacvta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['nufacvta'] = "Factura"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['colores']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['colores'] = "Color"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['tallas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['tallas'] = "Talla"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['sabor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['sabor'] = "Sabor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['grupo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['grupo'] = "Grupo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idped']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idped'] = "Pedido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['documento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['documento'] = "Documento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idinv']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idinv'] = "Idinv"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idfaccom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['idfaccom'] = "Idfaccom"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['fin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['labels']['fin'] = "Fin"; 
       }
       //-----
       $this->comp_field_nm = array(
           'idpro' => 0,
       ...
       $this->comp_sum = array(
           ...
           4 => "V/Parcial(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['ubicacion']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['ubicacion'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_order']['ubicacion'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['ubicacion'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['ubicacion'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['ubicacion'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['ubicacion'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['ubicacion'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['ubicacion'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['summarizing_fields_display']['ubicacion'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           4 => array('field' => "valorparcial", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_idpro as $i_idpro => $d_idpro) {
           if (!in_array($i_idpro, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idpro[5] ] = $d_idpro[4];
               $this->comp_label[0][ $d_idpro[5] ] = $d_idpro[4];
           }
           foreach ($this->array_total_idbod[$i_idpro] as $i_idbod => $d_idbod) {
               if (!in_array($i_idbod, $this->comp_label[1][ $d_idpro[5] ], true)) {
                   $this->comp_index[1][ $d_idbod[5] ] = $d_idbod[4];
                   $this->comp_label[1][ $d_idpro[5] ][ $d_idbod[5] ] = $d_idbod[4];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'idpro', 'prot' => ''),
           array('name' => 'idbod', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_idpro => $l_idpro) {
           if (isset($this->array_total_idpro[$i_idpro])) {
               $this->comp_group[$i_idpro] = array();
           }
           foreach ($this->comp_label[1][$i_idpro] as $i_idbod => $l_idbod) {
               if (isset($this->array_total_idbod[$i_idpro][$i_idbod])) {
                   $this->comp_group[$i_idpro][$i_idbod] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_idpro;
       }
       elseif (1 == $level) {
           $return = $this->array_total_idbod;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_inventario_130521@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['proc_pdf_vert'])
   {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_idpro)),
           ...
           '0|3' => array(
               'title'    => $this->getChartText(strip_tags("V/Parcial(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'idpro',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_idpro)),
               'label_y'  => $this->getChartText(strip_tags("V/Parcial(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
           ...
           '1|1' => array(
               ...
               'field_x'  => 'idbod',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_idbod)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '1|2' => array(
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_inventario_130521_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_inventario_130521_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['proc_pdf_vert']){ 
   ...
   function formatValue($total, $valor_campo)
   {
       ...
       if ($total == 2)
       {
           nmgp_Form_Num_Val($valor_campo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "3", "S", "", "", "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']);
       }
       if ($total == 3)
       {
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_inventario_130521']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_inventario_130521']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_inventario_130521']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_inventario_130521']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_inventario_130521_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_inventario_130521_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_ubicacion("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_idpro);
      ksort($this->array_total_idbod);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_inventario_130521_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_inventario_130521_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_inventario_130521_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_inventario_130521/grid_inventario_130521_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_inventario_130521_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_inventario_130521_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_inventario_130521_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['num_css'] . '.css');
...
$nm_saida->saida("      url: \"grid_inventario_130521_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inventario_130521/grid_inventario_130521_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inventario_130521/grid_inventario_130521_config_graf_flash.php?nome_apl=grid_inventario_130521&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_inventario_130521/grid_inventario_130521_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_inventario_130521/grid_inventario_130521_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_inventario_130521_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_inventario_130521']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_inventario_130521']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_inventario_130521_config_pivot.php?nome_apl=grid_inventario_130521&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_inventario_130521_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_inventario_130521/grid_inventario_130521_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_inventario_130521_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_inventario_130521_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_inventario_130521_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['grid_inventario_130521_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_inventario_130521@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_inventario_130521_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_inventario_130521/grid_inventario_130521_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_inventario_130521_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_inventario_130521_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $idpro = $Busca_temp['idpro']; 
          $tmp_pos = strpos($idpro, "##@@");
          if ($tmp_pos !== false && !is_array($idpro))
          {
          ...
          $fecha_2 = $Busca_temp['fecha_input_2']; 
          $cantidad = $Busca_temp['cantidad']; 
          $tmp_pos = strpos($cantidad, "##@@");
          if ($tmp_pos !== false && !is_array($cantidad))
          {
              $cantidad = substr($cantidad, 0, $tmp_pos);
          }
          $cantidad_2 = $Busca_temp['cantidad_input_2']; 
          $idbod = $Busca_temp['idbod']; 
          $tmp_pos = strpos($idbod, "##@@");
          if ($tmp_pos !== false && !is_array($idbod))
          {
              $idbod = substr($idbod, 0, $tmp_pos);
          }
          $idcombo = $Busca_temp['idcombo']; 
          $tmp_pos = strpos($idcombo, "##@@");
          if ($tmp_pos !== false && !is_array($idcombo))
          {
              $idcombo = substr($idcombo, 0, $tmp_pos);
          }
          $escombo = $Busca_temp['escombo']; 
          $tmp_pos = strpos($escombo, "##@@");
          if ($tmp_pos !== false && !is_array($escombo))
          {
          ...
          $fechavenc = $Busca_temp['fechavenc']; 
          $tmp_pos = strpos($fechavenc, "##@@");
          if ($tmp_pos !== false && !is_array($fechavenc))
          {
              $fechavenc = substr($fechavenc, 0, $tmp_pos);
          }
          $fechavenc_2 = $Busca_temp['fechavenc_input_2']; 
          $lote2 = $Busca_temp['lote2']; 
          $tmp_pos = strpos($lote2, "##@@");
          if ($tmp_pos !== false && !is_array($lote2))
          {
              $lote2 = substr($lote2, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_valorparcial, $quebra_idpro, $quebra_idbod, $quebra_idpro_orig, $quebra_idbod_orig)
   {
      //----- Producto
      if (!isset($this->array_total_idpro[$quebra_idpro_orig]))
      {
         $this->array_total_idpro[$quebra_idpro_orig][0] = 1;
         $this->array_total_idpro[$quebra_idpro_orig][1] = $sum_cantidad;
         $this->array_total_idpro[$quebra_idpro_orig][2] = $sum_valorparcial;
         $this->array_total_idpro[$quebra_idpro_orig][3] = 1;
         $this->array_total_idpro[$quebra_idpro_orig][4] = $quebra_idpro;
         $this->array_total_idpro[$quebra_idpro_orig][5] = $quebra_idpro_orig;
      }
      else
      {
         $this->array_total_idpro[$quebra_idpro_orig][0]++;
         $this->array_total_idpro[$quebra_idpro_orig][1] += $sum_cantidad;
         $this->array_total_idpro[$quebra_idpro_orig][2] += $sum_valorparcial;
         $this->array_total_idpro[$quebra_idpro_orig][3]++;
      }
      //----- Ubicación
      if (!isset($this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig]))
      {
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][0] = 1;
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][1] = $sum_cantidad;
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][2] = $sum_valorparcial;
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][3] = 1;
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][4] = $quebra_idbod;
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][5] = $quebra_idbod_orig;
      }
      else
      {
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][0]++;
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][1] += $sum_cantidad;
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][2] += $sum_valorparcial;
         $this->array_total_idbod[$quebra_idpro_orig][$quebra_idbod_orig][3]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT escombo, idpro, idcombo, cantidad, costo, valorparcial, idbod, tipo, detalle, inicio, str_replace (convert(char(10),fechavenc,102), '.', '-') + ' ' + convert(char(8),fechavenc,20), lote2, str_replace (convert(char(10),fecha,102), '.', '-') + ' ' + convert(char(8),fecha,20), idmov, nufacvta, colores, tallas, sabor, grupo, idped, idinv from (SELECT      idinv,     fecha,     cantidad,     idpro,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     costo,     valorparcial,     idcombo,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (select p.escombo from productos p where p.idprod=idpro) as escombo,     creado as inicio,     creado as fin,     idped,     fechavenc,     lote2 FROM      inventario ) nm_sel_esp"; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT escombo, idpro, idcombo, cantidad, costo, valorparcial, idbod, tipo, detalle, inicio, fechavenc, lote2, fecha, idmov, nufacvta, colores, tallas, sabor, grupo, idped, idinv from (SELECT      idinv,     fecha,     cantidad,     idpro,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     costo,     valorparcial,     idcombo,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (select p.escombo from productos p where p.idprod=idpro) as escombo,     creado as inicio,     creado as fin,     idped,     fechavenc,     lote2 FROM      inventario ) nm_sel_esp"; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT escombo, idpro, idcombo, cantidad, costo, valorparcial, idbod, tipo, detalle, inicio, convert(char(23),fechavenc,121), lote2, convert(char(23),fecha,121), idmov, nufacvta, colores, tallas, sabor, grupo, idped, idinv from (SELECT      idinv,     fecha,     cantidad,     idpro,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     costo,     valorparcial,     idcombo,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (select p.escombo from productos p where p.idprod=idpro) as escombo,     creado as inicio,     creado as fin,     idped,     fechavenc,     lote2 FROM      inventario ) nm_sel_esp"; 
     } 
     else 
     { 
         $nmgp_select = "SELECT escombo, idpro, idcombo, cantidad, costo, valorparcial, idbod, tipo, detalle, inicio, fechavenc, lote2, fecha, idmov, nufacvta, colores, tallas, sabor, grupo, idped, idinv from (SELECT      idinv,     fecha,     cantidad,     idpro,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     costo,     valorparcial,     idcombo,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (select p.escombo from productos p where p.idprod=idpro) as escombo,     creado as inicio,     creado as fin,     idped,     fechavenc,     lote2 FROM      inventario ) nm_sel_esp"; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_130521']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'idpro');
     $campos_order = $this->Ini->Get_date_order_groupby("idpro", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'idbod');
     $campos_order = $this->Ini->Get_date_order_groupby("idbod", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->escombo = $rs_res->fields[0] ;  
            $this->idpro = $rs_res->fields[1] ;  
            $this->idcombo = $rs_res->fields[2] ;  
            $this->cantidad = $rs_res->fields[3] ;  
            $this->cantidad =  str_replace(",", ".", $this->cantidad);
            $this->costo = $rs_res->fields[4] ;  
            $this->costo =  str_replace(",", ".", $this->costo);
            $this->valorparcial = $rs_res->fields[5] ;  
            $this->valorparcial =  str_replace(",", ".", $this->valorparcial);
            $this->idbod = $rs_res->fields[6] ;  
            $this->tipo = $rs_res->fields[7] ;  
            $this->detalle = $rs_res->fields[8] ;  
            $this->inicio = $rs_res->fields[9] ;  
            $this->fechavenc = $rs_res->fields[10] ;  
            $this->lote2 = $rs_res->fields[11] ;  
            $this->fecha = $rs_res->fields[12] ;  
            $this->idmov = $rs_res->fields[13] ;  
            $this->nufacvta = $rs_res->fields[14] ;  
            $this->colores = $rs_res->fields[15] ;  
            $this->tallas = $rs_res->fields[16] ;  
            $this->sabor = $rs_res->fields[17] ;  
            $this->grupo = $rs_res->fields[18] ;  
            $this->idped = $rs_res->fields[19] ;  
            $this->idinv = $rs_res->fields[20] ;  
            ...
            $_SESSION['scriptcase']['grid_inventario_130521']['contr_erro'] = 'on';
 if($this->escombo =="SI")
{
...
$_SESSION['scriptcase']['grid_inventario_130521']['contr_erro'] = 'off'; 
            $this->idpro_orig = $this->idpro;
            $this->idbod_orig = $this->idbod;
            $this->idpro = $this->look_idpro ;
            $this->idcombo = $this->look_idcombo ;
            $this->idbod = $this->look_idbod ;
            $this->tipo = $this->look_tipo ;
            $this->colores = $this->look_colores ;
            $this->tallas = $this->look_tallas ;
            $this->sabor = $this->look_sabor ;
            $this->grupo = $this->look_grupo ;
            nmgp_Form_Num_Val($this->tipo, "", "", "0", "", "", "", "N:", "") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->valorparcial, $this->idpro, $this->idbod, $this->idpro_orig,  $this->idbod_orig);
            }
   }
//
