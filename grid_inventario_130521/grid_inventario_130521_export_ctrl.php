<?php
@session_start() ;
$_SESSION['scriptcase']['grid_inventario_130521']['sc_process_barr'] = true;
require_once('../grid_inventario_130521/index.php');
unset($_SESSION['scriptcase']['grid_inventario_130521']['sc_process_barr']);
$ExportCtrl = new grid_inventario_130521_export_control;
$ExportCtrl->Export_barr();

class grid_inventario_130521_export_control
{
