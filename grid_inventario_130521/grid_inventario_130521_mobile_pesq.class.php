...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_datas[] = "fechavenc";$Nm_datas[] = "fechavenc";$Nm_numeric[] = "idinv";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "idpro";$Nm_numeric[] = "idbod";$Nm_numeric[] = "tipo";$Nm_numeric[] = "idmov";$Nm_numeric[] = "idfaccom";$Nm_numeric[] = "nufacvta";$Nm_numeric[] = "colores";$Nm_numeric[] = "tallas";$Nm_numeric[] = "sabor";$Nm_numeric[] = "costo";$Nm_numeric[] = "valorparcial";$Nm_numeric[] = "idcombo";$Nm_numeric[] = "grupo";$Nm_numeric[] = "idped";
...
<HTML>
<HEAD>
 <TITLE> -Rotación del inventario</TITLE>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_idpro"  <?php echo $str_hide_idpro?>><?php
      if ($idpro != "")
      {
      $idpro_look = substr($this->Db->qstr($idpro), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cantidad" id="id_ac_cantidad" name="cantidad_autocomp"><?php if ('' !=  $cantidad) { ?><option value="<?php echo $cantidad ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_cantidad"  <?php echo $str_display_cantidad; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_cantidad_input_2" name="cantidad_input_2" value="<?php echo NM_encode_input($cantidad_input_2) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_idcombo"  <?php echo $str_hide_idcombo?>><?php
      if ($idcombo != "")
      {
      $idcombo_look = substr($this->Db->qstr($idcombo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_lote2"  <?php echo $str_hide_lote2?>><?php
      if ($lote2 != "")
      {
      $lote2_look = substr($this->Db->qstr($lote2), 1, -1); 
      $nmgp_def_dados = array(); 
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_inventario_130521";
