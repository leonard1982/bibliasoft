...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_inventario_130521"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_inventario_130521"]);
   }
