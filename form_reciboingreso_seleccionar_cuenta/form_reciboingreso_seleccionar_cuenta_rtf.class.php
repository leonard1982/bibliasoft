...
class form_reciboingreso_seleccionar_cuenta_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   nm_limpa_str_form_reciboingreso_seleccionar_cuenta($cadapar[1]);
                   nm_protect_num_form_reciboingreso_seleccionar_cuenta($cadapar[0], $cadapar[1]);
                   if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                   $Tmp_par   = $cadapar[0];
                   $$Tmp_par = $cadapar[1];
                   if ($Tmp_par == "nmgp_opcao")
                   {
                       $_SESSION['sc_session'][$script_case_init]['form_reciboingreso_seleccionar_cuenta']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      require_once($this->Ini->path_aplicacao . "form_reciboingreso_seleccionar_cuenta_total.class.php"); 
      ...
      $this->Arquivo   .= "_form_reciboingreso_seleccionar_cuenta";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "form_reciboingreso_seleccionar_cuenta.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['rtf_name']);
      }
      ...
      { 
          ...
          if ($Cada_col == "saldo3" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $SC_Label = NM_charset_to_utf8($SC_Label);
              $SC_Label = str_replace('<', '&lt;', $SC_Label);
              $SC_Label = str_replace('>', '&gt;', $SC_Label);
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->saldo3 = (string)$this->saldo3;
          ...
          { 
              ...
              { 
                  $this->observaciones = file_get_contents($rs_grid->fields[7]);  
              } 
          } 
         elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
         { 
             $this->observaciones = $this->Db->BlobDecode($rs->fields[7]) ;  
         } 
         elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
         { 
             $this->observaciones = $this->Db->BlobDecode($rs->fields[7]) ;  
...
$_SESSION['scriptcase']['form_reciboingreso_seleccionar_cuenta']['contr_erro'] = 'off'; 
      ...
      $this->Texto_tag .= "</table>\r\n";
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   //----- nro
   function NM_export_nro()
   {
         ...
         $this->nro = str_replace('<', '&lt;', $this->nro);
         $this->nro = str_replace('>', '&gt;', $this->nro);
         $this->Texto_tag .= "<td>" . $this->nro . "</td>\r\n";
   }
   //----- fecha
   ...
   //----- saldo3
   function NM_export_saldo3()
   {
             nmgp_Form_Num_Val($this->saldo3, ",", ",", "0", "S", "2", "$", "V:3:3", "-"); 
         $this->saldo3 = NM_charset_to_utf8($this->saldo3);
         $this->saldo3 = str_replace('<', '&lt;', $this->saldo3);
         $this->saldo3 = str_replace('>', '&gt;', $this->saldo3);
         $this->Texto_tag .= "<td>" . $this->saldo3 . "</td>\r\n";
   }
   //----- observaciones
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_reciboingreso_seleccionar_cuenta'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>Cuentas por cobrar :: RTF</TITLE>
...
<form name="Fdown" method="get" action="form_reciboingreso_seleccionar_cuenta_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_reciboingreso_seleccionar_cuenta"> 
