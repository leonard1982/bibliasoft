<?php
   include_once('form_reciboingreso_seleccionar_cuenta_session.php');
   session_start();
   $_SESSION['scriptcase']['form_reciboingreso_seleccionar_cuenta']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['form_reciboingreso_seleccionar_cuenta']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['form_reciboingreso_seleccionar_cuenta']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['form_reciboingreso_seleccionar_cuenta']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new form_reciboingreso_seleccionar_cuenta_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class form_reciboingreso_seleccionar_cuenta_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("form_reciboingreso_seleccionar_cuenta_json.php");
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['nro'] = "on";
   $tab_def_campos['nro'] = "nro";
   $tab_labels["nro"]   = (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["nro"])) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["nro"] : "N Cuenta";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["tercero"] : "Tercero";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['numero_documento'] = "on";
   $tab_def_campos['numero_documento'] = "numero_documento";
   $tab_labels["numero_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["numero_documento"])) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["numero_documento"] : "No Documento";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["valor_total"] : "Total";
   $tab_ger_campos['saldo3'] = "on";
   $tab_def_campos['saldo3'] = "saldo3";
   $tab_labels["saldo3"]   = (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["saldo3"])) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["saldo3"] : "Saldo";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "form_reciboingreso_seleccionar_cuenta_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['form_reciboingreso_seleccionar_cuenta']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
