  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_datosemp_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_datosemp_mob_form();
	}
...
?>
  ...
  // ---------- Validate codigo_te
  function do_ajax_form_datosemp_mob_validate_codigo_te()
  {
    var nomeCampo_codigo_te = "codigo_te";
    var var_codigo_te = scAjaxGetFieldSelect(nomeCampo_codigo_te);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_codigo_te(var_codigo_te, var_script_case_init, do_ajax_form_datosemp_mob_validate_codigo_te_cb);
  } // do_ajax_form_datosemp_mob_validate_codigo_te

  function do_ajax_form_datosemp_mob_validate_codigo_te_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_codigo_te_cb

  // ---------- Validate sucursal
  function do_ajax_form_datosemp_mob_validate_sucursal()
  {
    var nomeCampo_sucursal = "sucursal";
    var var_sucursal = scAjaxGetFieldSelect(nomeCampo_sucursal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_sucursal(var_sucursal, var_script_case_init, do_ajax_form_datosemp_mob_validate_sucursal_cb);
  } // do_ajax_form_datosemp_mob_validate_sucursal

  function do_ajax_form_datosemp_mob_validate_sucursal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_sucursal_cb

  // ---------- Validate razonsoc
  function do_ajax_form_datosemp_mob_validate_razonsoc()
  {
    var nomeCampo_razonsoc = "razonsoc";
    var var_razonsoc = scAjaxGetFieldText(nomeCampo_razonsoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_razonsoc(var_razonsoc, var_script_case_init, do_ajax_form_datosemp_mob_validate_razonsoc_cb);
  } // do_ajax_form_datosemp_mob_validate_razonsoc

  function do_ajax_form_datosemp_mob_validate_razonsoc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_razonsoc_cb

  // ---------- Validate nombre_comercial
  function do_ajax_form_datosemp_mob_validate_nombre_comercial()
  {
    var nomeCampo_nombre_comercial = "nombre_comercial";
    var var_nombre_comercial = scAjaxGetFieldText(nomeCampo_nombre_comercial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_nombre_comercial(var_nombre_comercial, var_script_case_init, do_ajax_form_datosemp_mob_validate_nombre_comercial_cb);
  } // do_ajax_form_datosemp_mob_validate_nombre_comercial

  function do_ajax_form_datosemp_mob_validate_nombre_comercial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_nombre_comercial_cb

  // ---------- Validate regimen
  function do_ajax_form_datosemp_mob_validate_regimen()
  {
    var nomeCampo_regimen = "regimen";
    var var_regimen = scAjaxGetFieldSelect(nomeCampo_regimen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_regimen(var_regimen, var_script_case_init, do_ajax_form_datosemp_mob_validate_regimen_cb);
  } // do_ajax_form_datosemp_mob_validate_regimen

  function do_ajax_form_datosemp_mob_validate_regimen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regimen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_regimen_cb

  // ---------- Validate naturaleza
  function do_ajax_form_datosemp_mob_validate_naturaleza()
  {
    var nomeCampo_naturaleza = "naturaleza";
    var var_naturaleza = scAjaxGetFieldSelect(nomeCampo_naturaleza);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_naturaleza(var_naturaleza, var_script_case_init, do_ajax_form_datosemp_mob_validate_naturaleza_cb);
  } // do_ajax_form_datosemp_mob_validate_naturaleza

  function do_ajax_form_datosemp_mob_validate_naturaleza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_naturaleza_cb

  // ---------- Validate tipo_documento
  function do_ajax_form_datosemp_mob_validate_tipo_documento()
  {
    var nomeCampo_tipo_documento = "tipo_documento";
    var var_tipo_documento = scAjaxGetFieldSelect(nomeCampo_tipo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_tipo_documento(var_tipo_documento, var_script_case_init, do_ajax_form_datosemp_mob_validate_tipo_documento_cb);
  } // do_ajax_form_datosemp_mob_validate_tipo_documento

  function do_ajax_form_datosemp_mob_validate_tipo_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_tipo_documento_cb

  // ---------- Validate nit
  function do_ajax_form_datosemp_mob_validate_nit()
  {
    var nomeCampo_nit = "nit";
    var var_nit = scAjaxGetFieldText(nomeCampo_nit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_nit(var_nit, var_script_case_init, do_ajax_form_datosemp_mob_validate_nit_cb);
  } // do_ajax_form_datosemp_mob_validate_nit

  function do_ajax_form_datosemp_mob_validate_nit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_nit_cb

  // ---------- Validate dv
  function do_ajax_form_datosemp_mob_validate_dv()
  {
    var nomeCampo_dv = "dv";
    var var_dv = scAjaxGetFieldText(nomeCampo_dv);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_dv(var_dv, var_script_case_init, do_ajax_form_datosemp_mob_validate_dv_cb);
  } // do_ajax_form_datosemp_mob_validate_dv

  function do_ajax_form_datosemp_mob_validate_dv_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dv";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_dv_cb

  // ---------- Validate correo
  function do_ajax_form_datosemp_mob_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_correo(var_correo, var_script_case_init, do_ajax_form_datosemp_mob_validate_correo_cb);
  } // do_ajax_form_datosemp_mob_validate_correo

  function do_ajax_form_datosemp_mob_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_correo_cb

  // ---------- Validate iddatos
  function do_ajax_form_datosemp_mob_validate_iddatos()
  {
    var nomeCampo_iddatos = "iddatos";
    var var_iddatos = scAjaxGetFieldHidden(nomeCampo_iddatos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_iddatos(var_iddatos, var_script_case_init, do_ajax_form_datosemp_mob_validate_iddatos_cb);
  } // do_ajax_form_datosemp_mob_validate_iddatos

  function do_ajax_form_datosemp_mob_validate_iddatos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iddatos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_iddatos_cb

  // ---------- Validate nompais
  function do_ajax_form_datosemp_mob_validate_nompais()
  {
    var nomeCampo_nompais = "nompais";
    var var_nompais = scAjaxGetFieldSelect(nomeCampo_nompais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_nompais(var_nompais, var_script_case_init, do_ajax_form_datosemp_mob_validate_nompais_cb);
  } // do_ajax_form_datosemp_mob_validate_nompais

  function do_ajax_form_datosemp_mob_validate_nompais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nompais";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_nompais_cb

  // ---------- Validate nom_depto
  function do_ajax_form_datosemp_mob_validate_nom_depto()
  {
    var nomeCampo_nom_depto = "nom_depto";
    var var_nom_depto = scAjaxGetFieldSelect(nomeCampo_nom_depto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_nom_depto(var_nom_depto, var_script_case_init, do_ajax_form_datosemp_mob_validate_nom_depto_cb);
  } // do_ajax_form_datosemp_mob_validate_nom_depto

  function do_ajax_form_datosemp_mob_validate_nom_depto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_nom_depto_cb

  // ---------- Validate municipio
  function do_ajax_form_datosemp_mob_validate_municipio()
  {
    var nomeCampo_municipio = "municipio";
    var var_municipio = scAjaxGetFieldSelect(nomeCampo_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_municipio(var_municipio, var_script_case_init, do_ajax_form_datosemp_mob_validate_municipio_cb);
  } // do_ajax_form_datosemp_mob_validate_municipio

  function do_ajax_form_datosemp_mob_validate_municipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_municipio_cb

  // ---------- Validate ciudad
  function do_ajax_form_datosemp_mob_validate_ciudad()
  {
    var nomeCampo_ciudad = "ciudad";
    var var_ciudad = scAjaxGetFieldSelect(nomeCampo_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_ciudad(var_ciudad, var_script_case_init, do_ajax_form_datosemp_mob_validate_ciudad_cb);
  } // do_ajax_form_datosemp_mob_validate_ciudad

  function do_ajax_form_datosemp_mob_validate_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_ciudad_cb

  // ---------- Validate direccion
  function do_ajax_form_datosemp_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_datosemp_mob_validate_direccion_cb);
  } // do_ajax_form_datosemp_mob_validate_direccion

  function do_ajax_form_datosemp_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_direccion_cb

  // ---------- Validate codigo_postal
  function do_ajax_form_datosemp_mob_validate_codigo_postal()
  {
    var nomeCampo_codigo_postal = "codigo_postal";
    var var_codigo_postal = scAjaxGetFieldText(nomeCampo_codigo_postal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_codigo_postal(var_codigo_postal, var_script_case_init, do_ajax_form_datosemp_mob_validate_codigo_postal_cb);
  } // do_ajax_form_datosemp_mob_validate_codigo_postal

  function do_ajax_form_datosemp_mob_validate_codigo_postal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_codigo_postal_cb

  // ---------- Validate telefono
  function do_ajax_form_datosemp_mob_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_datosemp_mob_validate_telefono_cb);
  } // do_ajax_form_datosemp_mob_validate_telefono

  function do_ajax_form_datosemp_mob_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_telefono_cb

  // ---------- Validate logo
  function do_ajax_form_datosemp_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_logo(var_logo, var_script_case_init, do_ajax_form_datosemp_mob_validate_logo_cb);
  } // do_ajax_form_datosemp_mob_validate_logo

  function do_ajax_form_datosemp_mob_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_logo_cb

  // ---------- Validate ruta_logo
  function do_ajax_form_datosemp_mob_validate_ruta_logo()
  {
    var nomeCampo_ruta_logo = "ruta_logo";
    var var_ruta_logo = scAjaxGetFieldText(nomeCampo_ruta_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_ruta_logo(var_ruta_logo, var_script_case_init, do_ajax_form_datosemp_mob_validate_ruta_logo_cb);
  } // do_ajax_form_datosemp_mob_validate_ruta_logo

  function do_ajax_form_datosemp_mob_validate_ruta_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_ruta_logo_cb

  // ---------- Validate detalle_trib
  function do_ajax_form_datosemp_mob_validate_detalle_trib()
  {
    var nomeCampo_detalle_trib = "detalle_trib";
    var var_detalle_trib = scAjaxGetFieldSelect(nomeCampo_detalle_trib);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_detalle_trib(var_detalle_trib, var_script_case_init, do_ajax_form_datosemp_mob_validate_detalle_trib_cb);
  } // do_ajax_form_datosemp_mob_validate_detalle_trib

  function do_ajax_form_datosemp_mob_validate_detalle_trib_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_detalle_trib_cb

  // ---------- Validate codigos_ciiu
  function do_ajax_form_datosemp_mob_validate_codigos_ciiu()
  {
    var nomeCampo_codigos_ciiu = "codigos_ciiu";
    var var_codigos_ciiu = scAjaxGetFieldSelect(nomeCampo_codigos_ciiu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_codigos_ciiu(var_codigos_ciiu, var_script_case_init, do_ajax_form_datosemp_mob_validate_codigos_ciiu_cb);
  } // do_ajax_form_datosemp_mob_validate_codigos_ciiu

  function do_ajax_form_datosemp_mob_validate_codigos_ciiu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_codigos_ciiu_cb

  // ---------- Validate ciiu
  function do_ajax_form_datosemp_mob_validate_ciiu()
  {
    var nomeCampo_ciiu = "ciiu";
    var var_ciiu = scAjaxGetFieldText(nomeCampo_ciiu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_ciiu(var_ciiu, var_script_case_init, do_ajax_form_datosemp_mob_validate_ciiu_cb);
  } // do_ajax_form_datosemp_mob_validate_ciiu

  function do_ajax_form_datosemp_mob_validate_ciiu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciiu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_ciiu_cb

  // ---------- Validate responsab_trib
  function do_ajax_form_datosemp_mob_validate_responsab_trib()
  {
    var nomeCampo_responsab_trib = "responsab_trib";
    var var_responsab_trib = scAjaxGetFieldText(nomeCampo_responsab_trib);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_datosemp_mob_validate_responsab_trib(var_responsab_trib, var_script_case_init, do_ajax_form_datosemp_mob_validate_responsab_trib_cb);
  } // do_ajax_form_datosemp_mob_validate_responsab_trib

  function do_ajax_form_datosemp_mob_validate_responsab_trib_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_validate_responsab_trib_cb

  // ---------- Refresh nom_depto
  function do_ajax_form_datosemp_mob_refresh_nom_depto()
  {
    var var_nom_depto = scAjaxGetFieldSelect("nom_depto");
    var var_nmgp_refresh_fields = "municipio";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_datosemp_mob_refresh_nom_depto(var_nom_depto, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_datosemp_mob_refresh_nom_depto_cb);
  } // do_ajax_form_datosemp_mob_refresh_nom_depto

  function do_ajax_form_datosemp_mob_refresh_nom_depto_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_datosemp_mob_refresh_municipio();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_refresh_nom_depto_cb

  // ---------- Refresh municipio
  function do_ajax_form_datosemp_mob_refresh_municipio()
  {
    var var_municipio = scAjaxGetFieldSelect("municipio");
    var var_nmgp_refresh_fields = "ciudad_#fld#_codigo_postal";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_datosemp_mob_refresh_municipio(var_municipio, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_datosemp_mob_refresh_municipio_cb);
  } // do_ajax_form_datosemp_mob_refresh_municipio

  function do_ajax_form_datosemp_mob_refresh_municipio_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_datosemp_mob_refresh_municipio_cb

  // ---------- Event onchange nit
  function do_ajax_form_datosemp_mob_event_nit_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_datosemp_mob_event_nit_onchange(var_tipo_documento, var_nit, var_dv, var_script_case_init, do_ajax_form_datosemp_mob_event_nit_onchange_cb);
  } // do_ajax_form_datosemp_mob_event_nit_onchange

  function do_ajax_form_datosemp_mob_event_nit_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nit";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_datosemp_mob_event_nit_onchange_cb_after_alert);
  } // do_ajax_form_datosemp_mob_event_nit_onchange_cb
  function do_ajax_form_datosemp_mob_event_nit_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_datosemp_mob_event_nit_onchange_cb_after_alert

  // ---------- Event onchange tipo_documento
  function do_ajax_form_datosemp_mob_event_tipo_documento_onchange()
  {
    var var_tipo_documento = scAjaxGetFieldSelect("tipo_documento");
    var var_nit = scAjaxGetFieldText("nit");
    var var_dv = scAjaxGetFieldText("dv");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_datosemp_mob_event_tipo_documento_onchange(var_tipo_documento, var_nit, var_dv, var_script_case_init, do_ajax_form_datosemp_mob_event_tipo_documento_onchange_cb);
  } // do_ajax_form_datosemp_mob_event_tipo_documento_onchange

  function do_ajax_form_datosemp_mob_event_tipo_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo_documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_datosemp_mob_event_tipo_documento_onchange_cb_after_alert);
  } // do_ajax_form_datosemp_mob_event_tipo_documento_onchange_cb
  function do_ajax_form_datosemp_mob_event_tipo_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_datosemp_mob_event_tipo_documento_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_datosemp_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_datosemp_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_datosemp_mob_submit_form(var_codigo_te, var_sucursal, var_razonsoc, var_nombre_comercial, var_regimen, var_naturaleza, var_tipo_documento, var_nit, var_dv, var_correo, var_iddatos, var_nompais, var_nom_depto, var_municipio, var_ciudad, var_direccion, var_codigo_postal, var_telefono, var_logo, var_ruta_logo, var_detalle_trib, var_codigos_ciiu, var_ciiu, var_responsab_trib, var_logo_ul_name, var_logo_ul_type, var_ruta_logo_ul_name, var_ruta_logo_ul_type, var_logo_limpa, var_ruta_logo_salva, var_ruta_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_datosemp_mob_submit_form_cb);
  } // do_ajax_form_datosemp_mob_submit_form

  function do_ajax_form_datosemp_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_datosemp_mob_submit_form_cb_after_alert);
  } // do_ajax_form_datosemp_mob_submit_form_cb
  function do_ajax_form_datosemp_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_datosemp_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_datosemp_mob_navigate_form()
  {
    perform_ajax_form_datosemp_mob_navigate_form();
  }

  function perform_ajax_form_datosemp_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_datosemp_mob_navigate_form(var_iddatos, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_datosemp_mob_navigate_form_cb);
  } // do_ajax_form_datosemp_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_datosemp_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_datosemp_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_datosemp_mob_navigate_form_cb
  function do_ajax_form_datosemp_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_datosemp_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_datosemp_mob_navigate_form_cb_after_alert
  function sc_hide_form_datosemp_mob_form()
  {
  ...
  function do_ajax_form_datosemp_mob_lkpedt_refresh_sucursal()
  {
    var var_sucursal = scAjaxGetFieldSelect("sucursal");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "sucursal";
    x_ajax_form_datosemp_mob_lkpedt_refresh_sucursal(var_sucursal, nmgp_refresh_fields, var_script_case_init, do_ajax_form_datosemp_mob_lkpedt_refresh_sucursal_cb);
  } // do_ajax_form_datosemp_mob_lkpedt_refresh_sucursal

  function do_ajax_form_datosemp_mob_lkpedt_refresh_sucursal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_datosemp_mob_lkpedt_refresh_sucursal_cb
