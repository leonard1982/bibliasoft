...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_datosemp']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_datosemp']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_datosemp']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_datosemp']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_datosemp']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_datosemp']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_datosemp']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_datosemp']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->gbd_seleccionada)) 
          {
              $_SESSION['gbd_seleccionada'] = $this->gbd_seleccionada;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_datosemp']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_datosemp']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_datosemp']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_datosemp']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_datosemp']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_datosemp']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_datosemp']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_datosemp']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_datosemp']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_datosemp_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_datosemp']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_datosemp']['upload_field_info']['logo'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_datosemp',
      ...
      $_SESSION['sc_session'][$script_case_init]['form_datosemp']['upload_field_info']['ruta_logo'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_datosemp',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_modal']))
      {
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_datosemp']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_datosemp'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_datosemp']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_datosemp']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_datosemp') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_datosemp']['label'] = "DATOS DE LA EMPRESA";
      ...
      $_SESSION['scriptcase']['error_icon']['form_datosemp']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_datosemp'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_field_ul_name'][$this->logo_ul_name]))
          {
              $this->NM_ajax_info['param']['logo_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_field_ul_name'][$this->logo_ul_name];
          }
      ...
      elseif (isset($this->logo_ul_name) && '' != $this->logo_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_field_ul_name'][$this->logo_ul_name]))
          {
              $this->logo_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_field_ul_name'][$this->logo_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_field_ul_name'][$this->ruta_logo_ul_name]))
          {
              $this->NM_ajax_info['param']['ruta_logo_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_field_ul_name'][$this->ruta_logo_ul_name];
          }
      ...
      elseif (isset($this->ruta_logo_ul_name) && '' != $this->ruta_logo_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_field_ul_name'][$this->ruta_logo_ul_name]))
          {
              $this->ruta_logo_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_field_ul_name'][$this->ruta_logo_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_orig'] = " where iddatos=1";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_pesq'] = " where iddatos=1";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_datosemp']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_datosemp'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_datosemp'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_datosemp", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_datosemp_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_datosemp_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_datosemp/form_datosemp_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_datosemp_erro.class.php"); 
      }
      $this->Erro      = new form_datosemp_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opcao']))
         { 
             if ($this->iddatos != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_datosemp']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['botoes']['sc_btn_0'];
          $this->nmgp_botoes['btn_recargar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['botoes']['btn_recargar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['form_datosemp']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_datosemp']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_datosemp']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_datosemp']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_datosemp.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_datosemp_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_datosemp"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_datosemp']) || !is_array($this->NM_ajax_info['errList']['geral_form_datosemp']))
              {
                  $this->NM_ajax_info['errList']['geral_form_datosemp'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_datosemp'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_codigo_te(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
               if (!empty($this->codigo_te) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_codigo_te']) && !in_array($this->codigo_te, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_codigo_te']))
               {
                   $hasError = true;
    ...
    function ValidateField_sucursal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->sucursal) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_sucursal']) && !in_array($this->sucursal, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_sucursal']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_razonsoc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['php_cmp_required']['razonsoc']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['php_cmp_required']['razonsoc'] == "on")) 
      { 
          if ($this->razonsoc == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_nit(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['php_cmp_required']['nit']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['php_cmp_required']['nit'] == "on")) 
      { 
          if ($this->nit == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_nompais(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->nompais) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_nompais']) && !in_array($this->nompais, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_nompais']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_nom_depto(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->nom_depto) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_nom_depto']) && !in_array($this->nom_depto, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_nom_depto']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_municipio(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->municipio) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_municipio']) && !in_array($this->municipio, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_municipio']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_ciudad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->ciudad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_ciudad']) && !in_array($this->ciudad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_ciudad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_detalle_trib(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->detalle_trib) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_detalle_trib']) && !in_array($this->detalle_trib, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_detalle_trib']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_codigos_ciiu(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->codigos_ciiu) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_codigos_ciiu']) && !in_array($this->codigos_ciiu, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_codigos_ciiu']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
//--------------------------------------------------------------------------------------
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['iddatos']['keyVal'] = form_datosemp_pack_protect_string($this->nmgp_dados_form['iddatos']);
          }
   } // ajax_return_values
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_datosemp_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_datosemp_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['codigo_te']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sucursal']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_datosemp_pack_protect_string('0') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("No responsable de IVA")));
$aLookup[] = array(form_datosemp_pack_protect_string('1') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Responsable de IVA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_regimen'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_regimen'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['regimen']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_datosemp_pack_protect_string('1') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Natural")));
$aLookup[] = array(form_datosemp_pack_protect_string('2') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Jurídica")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_naturaleza'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_naturaleza'][] = '2';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['naturaleza']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_datosemp_pack_protect_string('11') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Registro civil de nacimiento")));
$aLookup[] = array(form_datosemp_pack_protect_string('12') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Tarjeta de identidad")));
$aLookup[] = array(form_datosemp_pack_protect_string('13') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Cédula de ciudadanía")));
$aLookup[] = array(form_datosemp_pack_protect_string('21') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Tarjeta de Extranjería")));
$aLookup[] = array(form_datosemp_pack_protect_string('22') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Cédula de extranjería")));
$aLookup[] = array(form_datosemp_pack_protect_string('31') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Nit")));
$aLookup[] = array(form_datosemp_pack_protect_string('41') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Pasaporte")));
$aLookup[] = array(form_datosemp_pack_protect_string('42') => str_replace('<', '&lt;',form_datosemp_pack_protect_string("Tipo de documento extranjero")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_tipo_documento'][] = '11';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_tipo_documento'][] = '12';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_tipo_documento'][] = '13';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_tipo_documento'][] = '21';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_tipo_documento'][] = '22';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_tipo_documento'][] = '31';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_tipo_documento'][] = '41';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_tipo_documento'][] = '42';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_documento']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['nompais']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['nom_depto']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['municipio']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_datosemp_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_datosemp_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['ciudad']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_datosemp_pack_protect_string('') => str_replace('<', '&lt;',form_datosemp_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['Lookup_detalle_trib'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['detalle_trib']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['codigos_ciiu']['valList'][$i] = form_datosemp_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_responsab_trib($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->iddatos)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['logo_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('codigo_te', 'sucursal', 'razonsoc', 'nombre_comercial', 'regimen', 'naturaleza', 'tipo_documento', 'nit', 'dv', 'correo', 'iddatos', 'nompais', 'nom_depto', 'municipio', 'ciudad', 'direccion', 'codigo_postal', 'telefono', 'logo', 'detalle_trib', 'codigos_ciiu', 'ciiu', 'responsab_trib'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_datosemp']['contr_erro'] = 'off'; 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['parms'] = "iddatos?#?$this->iddatos?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "insert" || $this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start']) ;  
              } 
          } 
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['parms'] = "iddatos?#?$this->iddatos?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['sub_dir'][0]  = "/logos/" . $_SESSION['gbd_seleccionada'] . "/";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['reg_start'] < $qt_geral_reg_form_datosemp;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out_ruta_logo))
       {
        ...
        $this->initFormPages();
    include_once("form_datosemp_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter_form'] . " and (iddatos=1) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_datosemp = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['total'] = $qt_geral_reg_form_datosemp;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_datosemp_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_datosemp_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_datosemp_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_datosemp']['masterValue']))
{
