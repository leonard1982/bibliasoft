  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_marca" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_marca_
  function do_ajax_form_marca_validate_id_marca_(iNumLinha)
  {
    var nomeCampo_id_marca_ = "id_marca_" + iNumLinha;
    var var_id_marca_ = scAjaxGetFieldHidden(nomeCampo_id_marca_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_marca_validate_id_marca_(var_id_marca_, iNumLinha, var_script_case_init, do_ajax_form_marca_validate_id_marca__cb);
  } // do_ajax_form_marca_validate_id_marca_

  function do_ajax_form_marca_validate_id_marca__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_marca_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_marca_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_marca_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_marca_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_marca_validate_id_marca__cb

  // ---------- Validate cod_marca_
  function do_ajax_form_marca_validate_cod_marca_(iNumLinha)
  {
    var nomeCampo_cod_marca_ = "cod_marca_" + iNumLinha;
    var var_cod_marca_ = scAjaxGetFieldText(nomeCampo_cod_marca_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_marca_validate_cod_marca_(var_cod_marca_, iNumLinha, var_script_case_init, do_ajax_form_marca_validate_cod_marca__cb);
  } // do_ajax_form_marca_validate_cod_marca_

  function do_ajax_form_marca_validate_cod_marca__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "cod_marca_" + iLineNumber;
    }
    else
    {
      sFieldValid = "cod_marca_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "cod_marca_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "cod_marca_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_marca_validate_cod_marca__cb

  // ---------- Validate nombre_marca_
  function do_ajax_form_marca_validate_nombre_marca_(iNumLinha)
  {
    var nomeCampo_nombre_marca_ = "nombre_marca_" + iNumLinha;
    var var_nombre_marca_ = scAjaxGetFieldText(nomeCampo_nombre_marca_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_marca_validate_nombre_marca_(var_nombre_marca_, iNumLinha, var_script_case_init, do_ajax_form_marca_validate_nombre_marca__cb);
  } // do_ajax_form_marca_validate_nombre_marca_

  function do_ajax_form_marca_validate_nombre_marca__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nombre_marca_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nombre_marca_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nombre_marca_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nombre_marca_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_marca_validate_nombre_marca__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_marca_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_marca_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_marca_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_marca_add_new_line_cb);
  } // do_ajax_form_marca_add_new_line

  function do_ajax_form_marca_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_marca_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_marca_backup_line(iNumLinha)
  {
    var var_id_marca_ = scAjaxGetFieldHidden("id_marca_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_marca_backup_line(var_id_marca_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_marca_backup_line_cb);
  } // do_ajax_form_marca_backup_line

  function do_ajax_form_marca_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_marca_backup_line_cb

  function do_ajax_form_marca_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_marca_cancel_insert

  function do_ajax_form_marca_cancel_update(iSeqVert)
  {
    do_ajax_form_marca_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_marca_cancel_update

  function do_ajax_form_marca_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_marca_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_marca_table_refresh()
  {
    var var_id_marca_ = document.F2.id_marca_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_marca_table_refresh(var_id_marca_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_marca_table_refresh_cb);
  } //  do_ajax_form_marca_table_refresh

  function do_ajax_form_marca_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_marca_.value = scAjaxGetKeyValue("id_marca_");
    ...
    scAjaxAlert(do_ajax_form_marca_table_refresh_cb_after_alert);
  } // do_ajax_form_marca_table_refresh_cb
  function do_ajax_form_marca_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_marca_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_marca_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_marca_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_marca_ = scAjaxGetFieldHidden("id_marca_" + iNumLinha);
    var var_cod_marca_ = scAjaxGetFieldText("cod_marca_" + iNumLinha);
    var var_nombre_marca_ = scAjaxGetFieldText("nombre_marca_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_marca_submit_form(var_id_marca_, var_cod_marca_, var_nombre_marca_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_marca_submit_form_cb);
  } // do_ajax_form_marca_submit_form

  function do_ajax_form_marca_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_marca_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("cod_marca_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_marca_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_marca_submit_form_cb_after_alert);
  } // do_ajax_form_marca_submit_form_cb
  function do_ajax_form_marca_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_marca_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_marca_navigate_form()
  {
    perform_ajax_form_marca_navigate_form();
  }

  function perform_ajax_form_marca_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_marca_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_marca_" + iNavForm);
      scAjaxHideErrorDisplay("cod_marca_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_marca_" + iNavForm);
    }
    var var_id_marca_ = document.F2.id_marca_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_marca_navigate_form(var_id_marca_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_marca_navigate_form_cb);
  } // do_ajax_form_marca_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_marca']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_marca_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_marca_.value = scAjaxGetKeyValue("id_marca_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_marca_navigate_form_cb_after_alert);
  } // do_ajax_form_marca_navigate_form_cb
  function do_ajax_form_marca_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_marca_navigate_form_cb_after_alert
  function sc_hide_form_marca_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_marca_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cod_marca_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_marca_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_marca_" + iNumLinha] = {"label": "Id Marca<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cod_marca_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_marca_" + iNumLinha] = {"label": "Nombre  o Marca<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_marca_"][iNumLinha] = "id_marca_" + iNumLinha;
    ajax_field_mult["cod_marca_"][iNumLinha] = "cod_marca_" + iNumLinha;
    ajax_field_mult["nombre_marca_"][iNumLinha] = "nombre_marca_" + iNumLinha;
    ajax_field_id["cod_marca_" + iNumLinha] = new Array("hidden_field_label_cod_marca_", "hidden_field_data_cod_marca_" + iNumLinha);
    ajax_field_id["nombre_marca_" + iNumLinha] = new Array("hidden_field_label_nombre_marca_", "hidden_field_data_nombre_marca_" + iNumLinha);
    ajax_error_count["id_marca_" + iNumLinha] = "off";
    ajax_error_count["cod_marca_" + iNumLinha] = "off";
    ajax_error_count["nombre_marca_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_marca_" + iNumLinha] = "on";
    ajax_read_only["cod_marca_" + iNumLinha] = "off";
    ajax_read_only["nombre_marca_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_marca_" + iNumLinha] = "on";
    ajax_read_only["cod_marca_" + iNumLinha] = "on";
    ajax_read_only["nombre_marca_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_marca_" + iNumLinha] = null;
    ajax_error_list["cod_marca_" + iNumLinha] = null;
    ajax_error_list["nombre_marca_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_marca_": new Array(),
    "cod_marca_": new Array(),
    "nombre_marca_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_marca_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_marca_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_marca_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_marca_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_marca_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["cod_marca_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["cod_marca_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["cod_marca_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["cod_marca_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["cod_marca_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nombre_marca_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nombre_marca_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nombre_marca_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nombre_marca_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nombre_marca_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_marca_'])) ? $this->nmgp_cmp_readonly['id_marca_'] : 'on';
?>
    scAjaxFieldRead("id_marca_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cod_marca_'])) ? $this->nmgp_cmp_readonly['cod_marca_'] : 'off';
?>
    scAjaxFieldRead("cod_marca_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_marca_'])) ? $this->nmgp_cmp_readonly['nombre_marca_'] : 'off';
?>
    scAjaxFieldRead("nombre_marca_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_marca_" + iSeq, "on");
    scAjaxFieldRead("cod_marca_" + iSeq, "on");
    scAjaxFieldRead("nombre_marca_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_marca_" + iRow] || "on" == ajax_error_count["cod_marca_" + iRow] || "on" == ajax_error_count["nombre_marca_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_marca_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_cod_marca_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_marca_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_marca_" + iRow] && "off" == ajax_error_count["cod_marca_" + iRow] && "off" == ajax_error_count["nombre_marca_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_marca_" + iRow] = "off";
        ajax_error_count["cod_marca_" + iRow] = "off";
        ajax_error_count["nombre_marca_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_marca_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_cod_marca_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_marca_" + iRow).removeClass("scFormErrorLine");
    }
  }
