  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_conceptos_documentos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_conceptos_documentos_form();
	}
...
?>
  ...
  function do_ajax_form_conceptos_documentos_validate_id_concepto()
  {
    var nomeCampo_id_concepto = "id_concepto";
    var var_id_concepto = scAjaxGetFieldHidden(nomeCampo_id_concepto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conceptos_documentos_validate_id_concepto(var_id_concepto, var_script_case_init, do_ajax_form_conceptos_documentos_validate_id_concepto_cb);
  } // do_ajax_form_conceptos_documentos_validate_id_concepto

  function do_ajax_form_conceptos_documentos_validate_id_concepto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conceptos_documentos_validate_id_concepto_cb

  // ---------- Validate codigo
  function do_ajax_form_conceptos_documentos_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conceptos_documentos_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_conceptos_documentos_validate_codigo_cb);
  } // do_ajax_form_conceptos_documentos_validate_codigo

  function do_ajax_form_conceptos_documentos_validate_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conceptos_documentos_validate_codigo_cb

  // ---------- Validate concepto
  function do_ajax_form_conceptos_documentos_validate_concepto()
  {
    var nomeCampo_concepto = "concepto";
    var var_concepto = scAjaxGetFieldText(nomeCampo_concepto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conceptos_documentos_validate_concepto(var_concepto, var_script_case_init, do_ajax_form_conceptos_documentos_validate_concepto_cb);
  } // do_ajax_form_conceptos_documentos_validate_concepto

  function do_ajax_form_conceptos_documentos_validate_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conceptos_documentos_validate_concepto_cb

  // ---------- Validate tipo
  function do_ajax_form_conceptos_documentos_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conceptos_documentos_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_conceptos_documentos_validate_tipo_cb);
  } // do_ajax_form_conceptos_documentos_validate_tipo

  function do_ajax_form_conceptos_documentos_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conceptos_documentos_validate_tipo_cb

  // ---------- Validate np
  function do_ajax_form_conceptos_documentos_validate_np()
  {
    var nomeCampo_np = "np";
    var var_np = scAjaxGetFieldCheckbox(nomeCampo_np, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conceptos_documentos_validate_np(var_np, var_script_case_init, do_ajax_form_conceptos_documentos_validate_np_cb);
  } // do_ajax_form_conceptos_documentos_validate_np

  function do_ajax_form_conceptos_documentos_validate_np_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "np";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conceptos_documentos_validate_np_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_conceptos_documentos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_conceptos_documentos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_concepto = scAjaxGetFieldHidden("id_concepto");
    ...
    var var_np = scAjaxGetFieldCheckbox("np", ";");
    ...
    scAjaxProcOn();
    x_ajax_form_conceptos_documentos_submit_form(var_id_concepto, var_codigo, var_concepto, var_tipo, var_np, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_conceptos_documentos_submit_form_cb);
  } // do_ajax_form_conceptos_documentos_submit_form

  function do_ajax_form_conceptos_documentos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_conceptos_documentos_submit_form_cb_after_alert);
  } // do_ajax_form_conceptos_documentos_submit_form_cb
  function do_ajax_form_conceptos_documentos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_conceptos_documentos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_conceptos_documentos_navigate_form()
  {
    perform_ajax_form_conceptos_documentos_navigate_form();
  }

  function perform_ajax_form_conceptos_documentos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo");
    scAjaxHideErrorDisplay("np");
    var var_id_concepto = document.F2.id_concepto.value;
    ...
    scAjaxProcOn();
    x_ajax_form_conceptos_documentos_navigate_form(var_id_concepto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_conceptos_documentos_navigate_form_cb);
  } // do_ajax_form_conceptos_documentos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_conceptos_documentos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_conceptos_documentos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_concepto.value = scAjaxGetKeyValue("id_concepto");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_conceptos_documentos_navigate_form_cb_after_alert);
  } // do_ajax_form_conceptos_documentos_navigate_form_cb
  function do_ajax_form_conceptos_documentos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_conceptos_documentos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_conceptos_documentos_navigate_form_cb_after_alert
  function sc_hide_form_conceptos_documentos_form()
  {
  ...
  ajax_field_list[0] = "id_concepto";
  ajax_field_list[1] = "codigo";
  ajax_field_list[2] = "concepto";
  ajax_field_list[3] = "tipo";
  ajax_field_list[4] = "np";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_concepto": {"label": "Id Concepto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codigo": {"label": "Codigo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "concepto": {"label": "Tipo Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo": {"label": "I/E", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "np": {"label": "NP", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "np": new Array("hidden_field_label_np", "hidden_field_data_np")
  };
