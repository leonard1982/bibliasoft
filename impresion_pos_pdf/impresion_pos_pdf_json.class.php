...
class impresion_pos_pdf_json
{
   ...
   function monta_json()
   {
      ...
      $this->grava_arquivo();
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida'])
      {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['SC_Gb_Free_cmp']))
      {
          $this->Tem_json_res  = false;
      }
      if (!is_file($this->Ini->root . $this->Ini->path_link . "impresion_pos_pdf/impresion_pos_pdf_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_format'];
      }
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_return']);
      ...
      $this->Arq_zip      = $this->Arquivo . "_impresion_pos_pdf.zip";
      $this->Arquivo     .= "_impresion_pos_pdf";
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "impresion_pos_pdf.json";
      $this->Tit_zip      = "impresion_pos_pdf.zip";
   }
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "impresion_pos_pdf_res_json.class.php");
              $this->Res = new impresion_pos_pdf_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_res_grid']);
          } 
      }
   ...
   function NM_export_vendedor()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->vendedor;
   }
   //----- numero
   ...
   function NM_export_resoluciondian()
   {
         ...
         {
             $SC_Label = "resoluciondian"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->resoluciondian;
   }
   //----- rango
   ...
   function NM_export_impuestos()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->impuestos;
   }
   //----- impuestos_tipo_iva
   function NM_export_impuestos_tipo_iva()
   {
         ...
         {
             $SC_Label = "impuestos_tipo_iva"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->impuestos_tipo_iva;
   }
   //----- impuestos_valor_iva
   function NM_export_impuestos_valor_iva()
   {
         ...
         {
             $SC_Label = "impuestos_valor_iva"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->impuestos_valor_iva;
   }
   //----- impuestos_base
   function NM_export_impuestos_base()
   {
         ...
         {
             $SC_Label = "impuestos_base"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->impuestos_base;
   }
   //----- impuestos_total
   function NM_export_impuestos_total()
   {
         ...
         {
             $SC_Label = "impuestos_total"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->impuestos_total;
   }
   //----- detalle_p_codigobar
   function NM_export_detalle_p_codigobar()
   {
         ...
         {
             $SC_Label = "detalle_p_codigobar"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->detalle_p_codigobar;
   }
   //----- detalle_p_nompro
   ...
   function NM_export_detalle_d_cantidad()
   {
         ...
         {
             $SC_Label = "detalle_d_cantidad"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->detalle_d_cantidad;
   }
   //----- detalle_d_valorunit
   function NM_export_detalle_d_valorunit()
   {
         ...
         {
             $SC_Label = "detalle_d_valorunit"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->detalle_d_valorunit;
   }
   //----- detalle_d_valorpar
   function NM_export_detalle_d_valorpar()
   {
         ...
         {
             $SC_Label = "detalle_d_valorpar"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->detalle_d_valorpar;
   }
   //----- detalle_linea
   function NM_export_detalle_linea()
   {
         ...
         {
             $SC_Label = "detalle_linea"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->detalle_linea;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> -  :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
