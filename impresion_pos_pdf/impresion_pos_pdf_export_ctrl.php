<?php
@session_start() ;
$_SESSION['scriptcase']['impresion_pos_pdf']['sc_process_barr'] = true;
require_once('../impresion_pos_pdf/index.php');
unset($_SESSION['scriptcase']['impresion_pos_pdf']['sc_process_barr']);
$ExportCtrl = new impresion_pos_pdf_export_control;
$ExportCtrl->Export_barr();

class impresion_pos_pdf_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['impresion_pos_pdf']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['impresion_pos_pdf']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - </TITLE>
