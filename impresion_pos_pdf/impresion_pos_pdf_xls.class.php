...
class impresion_pos_pdf_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "impresion_pos_pdf/impresion_pos_pdf_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "impresion_pos_pdf_res_xls.class.php");
              $this->Res_xls = new impresion_pos_pdf_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_impresion_pos_pdf.zip";
          $this->Arquivo   .= "_impresion_pos_pdf" . $this->Xls_tp;
          $this->Tit_doc    = "impresion_pos_pdf" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_resoluciondian()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->resoluciondian, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->resoluciondian, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- rango
   ...
   function NM_export_impuestos()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->impuestos, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->impuestos, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- impuestos_tipo_iva
   function NM_export_impuestos_tipo_iva()
   {
         ...
         if (is_numeric($this->impuestos_tipo_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->impuestos_tipo_iva);
         $this->Xls_col++;
   }
   //----- impuestos_valor_iva
   function NM_export_impuestos_valor_iva()
   {
         ...
         if (is_numeric($this->impuestos_valor_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->impuestos_valor_iva);
         $this->Xls_col++;
   }
   //----- impuestos_base
   function NM_export_impuestos_base()
   {
         ...
         if (is_numeric($this->impuestos_base))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->impuestos_base);
         $this->Xls_col++;
   }
   //----- impuestos_total
   function NM_export_impuestos_total()
   {
         ...
         if (is_numeric($this->impuestos_total))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->impuestos_total);
         $this->Xls_col++;
   }
   //----- detalle_p_codigobar
   function NM_export_detalle_p_codigobar()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalle_p_codigobar, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalle_p_codigobar, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- detalle_p_nompro
   function NM_export_detalle_p_nompro()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalle_p_nompro, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalle_p_nompro, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- detalle_d_cantidad
   function NM_export_detalle_d_cantidad()
   {
         ...
         if (is_numeric($this->detalle_d_cantidad))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalle_d_cantidad);
         $this->Xls_col++;
   }
   //----- detalle_d_valorunit
   function NM_export_detalle_d_valorunit()
   {
         ...
         if (is_numeric($this->detalle_d_valorunit))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalle_d_valorunit);
         $this->Xls_col++;
   }
   //----- detalle_d_valorpar
   function NM_export_detalle_d_valorpar()
   {
         ...
         if (is_numeric($this->detalle_d_valorpar))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalle_d_valorpar);
         $this->Xls_col++;
   }
   //----- detalle_linea
   function NM_export_detalle_linea()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalle_linea, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalle_linea, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fechaven
   ...
   //----- resoluciondian
   function NM_sub_cons_resoluciondian()
   {
         $this->resoluciondian = html_entity_decode($this->resoluciondian, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->resoluciondian = strip_tags($this->resoluciondian);
         $this->resoluciondian = NM_charset_to_utf8($this->resoluciondian);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->resoluciondian;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
         $this->impuestos = NM_charset_to_utf8($this->impuestos);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->impuestos;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- impuestos_tipo_iva
   function NM_sub_cons_impuestos_tipo_iva()
   {
         $this->impuestos_tipo_iva = NM_charset_to_utf8($this->impuestos_tipo_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->impuestos_tipo_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- impuestos_valor_iva
   function NM_sub_cons_impuestos_valor_iva()
   {
         $this->impuestos_valor_iva = NM_charset_to_utf8($this->impuestos_valor_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->impuestos_valor_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- impuestos_base
   function NM_sub_cons_impuestos_base()
   {
         $this->impuestos_base = NM_charset_to_utf8($this->impuestos_base);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->impuestos_base;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- impuestos_total
   function NM_sub_cons_impuestos_total()
   {
         $this->impuestos_total = NM_charset_to_utf8($this->impuestos_total);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->impuestos_total;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalle_p_codigobar
   function NM_sub_cons_detalle_p_codigobar()
   {
         $this->detalle_p_codigobar = html_entity_decode($this->detalle_p_codigobar, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalle_p_codigobar = strip_tags($this->detalle_p_codigobar);
         $this->detalle_p_codigobar = NM_charset_to_utf8($this->detalle_p_codigobar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_p_codigobar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detalle_p_nompro
   function NM_sub_cons_detalle_p_nompro()
   {
         $this->detalle_p_nompro = html_entity_decode($this->detalle_p_nompro, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalle_p_nompro = strip_tags($this->detalle_p_nompro);
         $this->detalle_p_nompro = NM_charset_to_utf8($this->detalle_p_nompro);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_p_nompro;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detalle_d_cantidad
   function NM_sub_cons_detalle_d_cantidad()
   {
         $this->detalle_d_cantidad = NM_charset_to_utf8($this->detalle_d_cantidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_d_cantidad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalle_d_valorunit
   function NM_sub_cons_detalle_d_valorunit()
   {
         $this->detalle_d_valorunit = NM_charset_to_utf8($this->detalle_d_valorunit);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_d_valorunit;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalle_d_valorpar
   function NM_sub_cons_detalle_d_valorpar()
   {
         $this->detalle_d_valorpar = NM_charset_to_utf8($this->detalle_d_valorpar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_d_valorpar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalle_linea
   function NM_sub_cons_detalle_linea()
   {
         $this->detalle_linea = html_entity_decode($this->detalle_linea, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalle_linea = strip_tags($this->detalle_linea);
         $this->detalle_linea = NM_charset_to_utf8($this->detalle_linea);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_linea;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['impresion_pos_pdf']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
