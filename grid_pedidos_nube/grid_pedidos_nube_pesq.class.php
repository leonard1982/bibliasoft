...
class grid_pedidos_nube_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_pedidos_nube_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_pedidos_nube_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_pedidos_nube_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cod_cliente')
      {
          $cod_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cod_cliente($cod_cliente);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_cod_cliente($cod_cliente)
   {
      $cod_cliente = substr($this->Db->qstr($cod_cliente), 1, -1);
            $cod_cliente_look = substr($this->Db->qstr($cod_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select documento, nombres from terceros where  nombres like '%" . $cod_cliente . "%' order by nombres"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_pedidos_nube/grid_pedidos_nube_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_pedidos_nube_ajax_search.js"></script>
 <script type="text/javascript" src="grid_pedidos_nube_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_pedidos_nube_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pedidos_nube']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pedidos_nube']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_cod_cliente_cond#NMF#' + search_get_sel_txt('SC_cod_cliente_cond') + '@NMF@';
  str_out += 'SC_cod_cliente#NMF#' + search_get_text('SC_cod_cliente') + '@NMF@';
  str_out += 'id_ac_cod_cliente#NMF#' + search_get_text('id_ac_cod_cliente') + '@NMF@';
  ...
  str_out += 'SC_descargado_nube_cond#NMF#' + search_get_sel_txt('SC_descargado_nube_cond') + '@NMF@';
  str_out += 'SC_descargado_nube#NMF#' + search_get_select('SC_descargado_nube') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_cod_cliente").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_cod_cliente").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_cod_cliente",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       ...
       $("#SC_cod_cliente").val(ui.item.value);
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Pedidos en la Nube</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $cod_cliente_cond, $cod_cliente, $cod_cliente_autocomp,
             $vendedor_cond, $vendedor,
             $descargado_nube_cond, $descargado_nube,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_cond']; 
          $cod_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['cod_cliente']; 
          $cod_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['cod_cliente_cond']; 
          $vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['vendedor']; 
          $vendedor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['vendedor_cond']; 
          $descargado_nube = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['descargado_nube']; 
          $descargado_nube_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['descargado_nube_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fechaven_cond) || empty($fechaven_cond))
      {
         $fechaven_cond = "bw";
      }
      if (!isset($cod_cliente_cond) || empty($cod_cliente_cond))
      {
         $cod_cliente_cond = "eq";
      }
      ...
      if (!isset($descargado_nube_cond) || empty($descargado_nube_cond))
      {
         $descargado_nube_cond = "eq";
      }
      ...
      $str_hide_cod_cliente = (in_array($cod_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_vendedor = (in_array($vendedor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descargado_nube = (in_array($descargado_nube_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_fechaven = ('bw' == $fechaven_cond) ? $display_aberto : $display_fechado;
      $str_display_cod_cliente = ('bw' == $cod_cliente_cond) ? $display_aberto : $display_fechado;
      $str_display_vendedor = ('bw' == $vendedor_cond) ? $display_aberto : $display_fechado;
      $str_display_descargado_nube = ('bw' == $descargado_nube_cond) ? $display_aberto : $display_fechado;
      ...
      if (isset($cod_cliente) && !empty($cod_cliente))
      {
         $tmp_pos = strpos($cod_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $cod_cliente = substr($cod_cliente, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($descargado_nube) || $descargado_nube == "")
      {
          $descargado_nube = "";
      }
      if (isset($descargado_nube) && !empty($descargado_nube))
      {
         $tmp_pos = strpos($descargado_nube, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $descargado_nube = substr($descargado_nube, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
?>
      ...
      <TD id='SC_cod_cliente_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['cod_cliente'])) ? $this->New_label['cod_cliente'] : "Cliente"; ?></TD>
      
      <INPUT type="hidden" id="SC_cod_cliente_cond" name="cod_cliente_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cod_cliente" <?php echo $str_hide_cod_cliente?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['cod_cliente'])) ? $this->New_label['cod_cliente'] : "Cliente";
 $nmgp_tab_label .= "cod_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $cod_cliente_look = substr($this->Db->qstr($cod_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select documento, nombres from terceros where documento = '$cod_cliente_look' order by nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$cod_cliente]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cod_cliente];
      }
      else
      {
          $sAutocompValue = $cod_cliente;
      }
?>
<INPUT  type="text" id="SC_cod_cliente" name="cod_cliente" value="<?php echo NM_encode_input($cod_cliente) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_cod_cliente" name="cod_cliente_autocomp" size="60"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['psq_check_ret']['vendedor'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['psq_check_ret']['vendedor'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD id='SC_descargado_nube_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['descargado_nube'])) ? $this->New_label['descargado_nube'] : "Descargado"; ?></TD>
      
      <INPUT type="hidden" id="SC_descargado_nube_cond" name="descargado_nube_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_descargado_nube" <?php echo $str_hide_descargado_nube?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['descargado_nube'])) ? $this->New_label['descargado_nube'] : "Descargado";
 $nmgp_tab_label .= "descargado_nube?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['psq_check_ret']['descargado_nube'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['psq_check_ret']['descargado_nube'][] = "SI";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['psq_check_ret']['descargado_nube'][] = "NO";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_descargado_nube"  name="descargado_nube"  size="1">
 <OPTION value="">TODOS</option>
 <OPTION value="SI##@@SI"<?php if ($descargado_nube == "SI") { echo " selected" ;} ?>>SI</option>
 <OPTION value="NO##@@NO"<?php if ($descargado_nube == "NO") { echo " selected" ;} ?>>NO</option>
 </SELECT>
...
<?php
   if (is_file("grid_pedidos_nube_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_nube']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_nube']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_nube']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_nube']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cod_cliente_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_cod_cliente'), document.F1.cod_cliente_cond, 'cod_cliente');
   document.F1.cod_cliente.value = "";
   document.F1.cod_cliente_autocomp.value = "";
   ...
   document.F1.descargado_nube_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_descargado_nube'), document.F1.descargado_nube_cond, 'descargado_nube');
   document.F1.descargado_nube.value = "";
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    ...
    if (Field == 'all' || Field == 'descargado_nube') {
       Sc_carga_select2_descargado_nube();
    }
 }
 ...
 function Sc_carga_select2_descargado_nube()
 {
  $("#SC_descargado_nube").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 {
    $('#SC_fechaven_dia').bind('change', function() {sc_grid_pedidos_nube_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_grid_pedidos_nube_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_grid_pedidos_nube_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_grid_pedidos_nube_valida_mes(this)});
 }
 function sc_grid_pedidos_nube_valida_dia(obj)
 {
 ...
 function sc_grid_pedidos_nube_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_pedidos_nube";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_cod_cliente_cond'] = 'cond';
      $tp_fields['SC_cod_cliente'] = 'text_aut';
      $tp_fields['id_ac_cod_cliente'] = 'text_aut';
      $tp_fields['SC_vendedor_cond'] = 'cond';
      $tp_fields['SC_vendedor'] = 'select';
      $tp_fields['SC_descargado_nube_cond'] = 'cond';
      $tp_fields['SC_descargado_nube'] = 'select';
   ...
   function trata_campos()
   {
      global $fechaven_cond, $fechaven, $fechaven_dia, $fechaven_mes, $fechaven_ano, $fechaven_input_2_dia, $fechaven_input_2_mes, $fechaven_input_2_ano,
             $cod_cliente_cond, $cod_cliente, $cod_cliente_autocomp,
             $vendedor_cond, $vendedor,
             $descargado_nube_cond, $descargado_nube, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($cod_cliente_autocomp) && empty($cod_cliente))
      {
          $cod_cliente = $cod_cliente_autocomp;
      }
      ...
      $cod_cliente_cond_salva = $cod_cliente_cond; 
      if (!isset($cod_cliente_input_2) || $cod_cliente_input_2 == "")
      {
          $cod_cliente_input_2 = $cod_cliente;
      }
      ...
      $descargado_nube_cond_salva = $descargado_nube_cond; 
      if (!isset($descargado_nube_input_2) || $descargado_nube_input_2 == "")
      {
          $descargado_nube_input_2 = $descargado_nube;
      }
      $tmp_pos = strpos($vendedor, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $vendedor;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['psq_check_ret']['vendedor'])) {
      ...
      $tmp_pos = strpos($descargado_nube, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $descargado_nube;
      }
      else {
          $L_lookup = substr($descargado_nube, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['psq_check_ret']['descargado_nube'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Descargado : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['cod_cliente'] = $cod_cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['cod_cliente_cond'] = $cod_cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['vendedor'] = $vendedor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['vendedor_cond'] = $vendedor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['descargado_nube'] = $descargado_nube; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['descargado_nube_cond'] = $descargado_nube_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($cod_cliente != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['cod_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['cod_cliente'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['cod_cliente'] = $cod_cliente;
      }
      $Conteudo = $vendedor;
      ...
      $Conteudo = $descargado_nube;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['descargado_nube'] = $Conteudo;
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']['fechaven_input_2'] = $val[1];
      ...
      if (isset($cod_cliente) && !empty($cod_cliente))
      { 
           $cod_cliente = strtoupper($cod_cliente);
      } 
      if (isset($cod_cliente) || $cod_cliente_cond == "nu" || $cod_cliente_cond == "nn" || $cod_cliente_cond == "ep" || $cod_cliente_cond == "ne")
      {
         $this->monta_condicao("cod_cliente", $cod_cliente_cond, $cod_cliente, "", "cod_cliente");
      }
      ...
      //----- $descargado_nube
      $this->Date_part = false;
      if (isset($descargado_nube))
      {
         $this->monta_condicao("descargado_nube", $descargado_nube_cond, $descargado_nube, "", "descargado_nube");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_nube']['where_pesq'];
