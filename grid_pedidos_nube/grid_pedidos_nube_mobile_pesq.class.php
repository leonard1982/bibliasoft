...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_cod_cliente"  <?php echo $str_hide_cod_cliente?>><?php
      if ($cod_cliente != "")
      {
      $cod_cliente_look = substr($this->Db->qstr($cod_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_descargado_nube"  <?php echo $str_hide_descargado_nube?>> 
<?php
