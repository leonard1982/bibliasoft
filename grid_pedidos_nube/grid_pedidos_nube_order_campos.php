...
<?php
   ...
   $Ord_Cmp = new grid_pedidos_nube_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pedidos_nube_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["prefijo"] : "Prefijo";
   $tab_ger_campos['numpedido'] = "on";
   $tab_def_campos['numpedido'] = "numpedido";
   $tab_labels["numpedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["numpedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["numpedido"] : "Número";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['cod_cliente'] = "on";
   $tab_def_campos['cod_cliente'] = "cod_cliente";
   $tab_labels["cod_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["cod_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["cod_cliente"] : "Cliente";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["total"] : "Total";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["vendedor"] : "Vendedor";
   $tab_ger_campos['descargado_nube'] = "on";
   $tab_def_campos['descargado_nube'] = "descargado_nube";
   $tab_labels["descargado_nube"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["descargado_nube"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['labels']["descargado_nube"] : "Descargado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pedidos_nube_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pedidos_nube']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
