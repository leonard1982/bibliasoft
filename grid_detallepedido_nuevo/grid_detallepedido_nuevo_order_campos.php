<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_detallepedido_nuevo_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_detallepedido_nuevo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["idpro"]   = "idpro";
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["idpro"] : "Producto";
   $tab_ger_campos['unidadmayor'] = "on";
   $tab_def_campos['unidadmayor'] = "unidadmayor";
   $tab_converte["unidadmayor"]   = "unidadmayor";
   $tab_labels["unidadmayor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["unidadmayor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["unidadmayor"] : "Unidadmayor";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_converte["idbod"]   = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["idbod"] : "Bodega";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_converte["cantidad"]   = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_converte["valorunit"]   = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["valorunit"] : "V/Unitario";
   $tab_ger_campos['adicional'] = "on";
   $tab_def_campos['adicional'] = "adicional";
   $tab_converte["adicional"]   = "adicional";
   $tab_labels["adicional"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["adicional"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["adicional"] : "IVA";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_converte["descuento"]   = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["descuento"] : "Desc";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_converte["valorpar"]   = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['labels']["valorpar"] : " Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_detallepedido_nuevo_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_detallepedido_nuevo']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
