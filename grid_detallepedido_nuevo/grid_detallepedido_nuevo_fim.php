...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallepedido_nuevo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallepedido_nuevo"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_detallepedido'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallepedido_nuevo</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_nuevo']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_detallepedido_nuevo' || $achou)
          {
