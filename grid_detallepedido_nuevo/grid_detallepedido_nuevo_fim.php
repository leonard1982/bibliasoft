...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallepedido_nuevo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallepedido_nuevo"]);
   }
