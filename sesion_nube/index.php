<?php
   include_once('sesion_nube_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['sesion_nube']['glo_nm_perfil']          = "conn_nube";
   $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['sesion_nube']['glo_con_conn_facilweb']         = "conn_facilweb";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['sesion_nube']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['sesion_nube']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['sesion_nube']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['sesion_nube']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['sesion_nube']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['sesion_nube']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class sesion_nube_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "sesion_nube"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['sesion_nube']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['sesion_nube']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['sesion_nube']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/sesion_nube';
      ...
      $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['sesion_nube']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['sesion_nube']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['sesion_nube']['actual_lang']) || $_SESSION['scriptcase']['sesion_nube']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['sesion_nube']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("sesion_nube_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["sesion_nube"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["sesion_nube"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['sesion_nube']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['sesion_nube']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['sesion_nube']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "sesion_nube_erro.class.php"); 
      $this->Erro = new sesion_nube_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('sesion_nube'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['sesion_nube']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      $this->conectExtra();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao']) && $_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['sesion_nube']['glo_nm_perfil']) && $_SESSION['scriptcase']['sesion_nube']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['sesion_nube']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['sesion_nube']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['sesion_nube']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['sesion_nube']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['sesion_nube']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['sesion_nube']['glo_nm_perfil'];
      }
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['sesion_nube']['glo_con_conn_facilweb'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_conn_facilweb['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_facilweb['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_facilweb['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_facilweb['senha']                  = $_SESSION['scriptcase']['glo_senha'];
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['sesion_nube']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['sesion_nube']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['sesion_nube']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new sesion_nube_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['sesion_nube']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['sesion_nube']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['sesion_nube']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['sesion_nube'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sesion_nube']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sesion_nube']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('sesion_nube') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['sesion_nube']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['sesion_nube']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['sesion_nube']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['sesion_nube']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "sesion_nube_erro.class.php"); 
      $this->Erro      = new sesion_nube_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['sesion_nube']['contr_erro'] = 'on';
 ;
;
;
;
...
<head>
	...
	<style>
		...
		.formatotabla3 tr:nth-of-type(odd) { 
		background: #fff; 
		}
		.formatotabla3 th { 
		background: #29abe2; 
      ...
      $nm_select = "SELECT id_menu FROM permisos_aplicaciones_menu"; 
...
;
		...
		{
			for($i=0;$i<count($this->vpermisos );$i++)
			{
				echo ".".$this->vpermisos[$i][0]."{display:none;}";
			}	
		}
		?>
	</style>
	<script>
		...
		function fObtenerPosicion(data)
		{
			function exito(pos)
			{   
				...
				jQuery.ajax({
					...
					success: function (r) {                               
						...
						if(obj.campos_vacios=='NO')
						{
						if(obj.existe=='SI')
						{
						alertify.alert('', 'El número de identificación ya existe!!!', function(){ });
						}
						else
						{
						}
						...
						{
						alertify.alert('', 'Debe diligencias los campos con (*) asterisco!!!', function(){ });
						}
					...
					.fail(function(error){
						...
						alertify.alert('', 'No es posible conectarse con el servidor!!!', function(){ });
					})
					.always(function(){
			...
			{ 
				...
				alertify.alert('', 'Debe permitir el acceso a la ubicación!!!', function(){  });
		...
		var frm_formbcliente = "";
		    frm_formbcliente += "<form id='frm_agregarcliente' class='form' style='width:100%;'>";
			frm_formbcliente += "<table border='0' width='100%'>"; 
			frm_formbcliente += "<tr>"; 
			frm_formbcliente += "<td style='width:40px;'>"; 
			frm_formbcliente += "<input type='button' value='X' class='btn btn-danger' onclick='$(\"#txt_buscarcliente\").val(\"\");$(\"#div_rbuscarclientes\").html(\"\");'/>"; 
			frm_formbcliente += "</td>"; 
			frm_formbcliente += "<td>"; 
			frm_formbcliente += "<input id='txt_buscarcliente' name='txt_buscarcliente' type='text' class='form-control' placeholder='Buscar Cliente' style='width:100%;' />"; 
			frm_formbcliente += "</td>"; 
			frm_formbcliente += "<td style='text-align:right;width:40px;'>"; 
		    frm_formbcliente += "<input onclick='fBuscarCliente($(\"#txt_buscarcliente\").val());' type='button' class='btn btn-primary' value='B'/>"; 
			frm_formbcliente += "</td>"; 
			frm_formbcliente += "</tr>"; 
			frm_formbcliente += "</table>"; 
		    frm_formbcliente += "<br><div id='div_rbuscarclientes' style='height:300px;overflow:auto;width:100%;'></div>";
		    frm_formbcliente += "</form>";
		
		var frm_form  = "";
		    frm_form += "<form class='form' id='frm_crearcliente'>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='sc_tipoc'>Tipo Identificación*</label>";
		    frm_form += "<select id='sc_tipoc' name='sc_tipoc' type='text' class='form-control'>";
		    frm_form += "<option value='13'>Cédula</option>";
		    frm_form += "<option value='31'>NIT</option>";
		    frm_form += "</select>";
		    frm_form += "</div>";
		
		    frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_identificacionc'>CC/NIT*</label>";
		    frm_form += "<input id='txt_identificacionc' name='txt_identificacionc' type='text' class='form-control' placeholder='CC/NIT' />";
		    frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_nombresc'>Razón Social*</label>";
		    frm_form += "<input id='txt_nombresc' name='txt_nombresc' type='text' class='form-control' placeholder='Nombres' />";
			frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_apellido1c'>Apellido1*</label>";
		    frm_form += "<input id='txt_apellido1c' name='txt_apellido1c' type='text' class='form-control' placeholder='Apellido1' />";
			frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_apellido2c'>Apellido2</label>";
		    frm_form += "<input id='txt_apellido2c' name='txt_apellido2c' type='text' class='form-control' placeholder='Apellido2' />";
			frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_nombre1c'>Nombre1*</label>";
		    frm_form += "<input id='txt_nombre1c' name='txt_nombre1c' type='text' class='form-control' placeholder='Nombre1' />";
			frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_nombre2c'>Nombre2</label>";
		    frm_form += "<input id='txt_nombre2c' name='txt_nombre2c' type='text' class='form-control' placeholder='Nombre2' />";
			frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_direccionc'>Dirección*</label>";
		    frm_form += "<input id='txt_direccionc' name='txt_direccionc' type='text' class='form-control' placeholder='Dirección' />";
			frm_form += "</div>";		
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_telefonoc'>Teléfono</label>";
		    frm_form += "<input id='txt_telefonoc' name='txt_telefonoc' type='text' class='form-control' placeholder='Teléfono' />";
			frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='txt_correoc'>Correo</label>";
		    frm_form += "<input id='txt_correoc' name='txt_correoc' type='text' class='form-control' placeholder='Correo' />";
			frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='sc_municipioc'>Municipio</label>";
		    frm_form += "<select id='sc_municipioc' name='sc_municipioc' class='form-control'>";
			frm_form += "<option value='828' selected='selected'>CUCUTA</option>";
			frm_form += "<option value='829'>ABREGO</option>";
			frm_form += "<option value='830'>ARBOLEDAS</option>";
			frm_form += "<option value='831'>BOCHALEMA</option>";
			frm_form += "<option value='832'>BUCARASICA</option>";
			frm_form += "<option value='833'>CACOTA</option>";
			frm_form += "<option value='834'>CACHIRA</option>";
			frm_form += "<option value='835'>CHINACOTA</option>";
			frm_form += "<option value='836'>CHITAGA</option>";
			frm_form += "<option value='837'>CONVENCION</option>";
			frm_form += "<option value='838'>CUCUTILLA</option>";
			frm_form += "<option value='839'>DURANIA</option>";
			frm_form += "<option value='840'>EL CARMEN</option>";
			frm_form += "<option value='841'>EL TARRA</option>";
			frm_form += "<option value='842'>EL ZULIA</option>";
			frm_form += "<option value='843'>GRAMALOTE</option>";
			frm_form += "<option value='844'>HACARI</option>";
			frm_form += "<option value='845'>HERRAN</option>";
			frm_form += "<option value='846'>LABATECA</option>";
			frm_form += "<option value='847'>LA ESPERANZA</option>";
			frm_form += "<option value='848'>LA PLAYA</option>";
			frm_form += "<option value='849'>LOS PATIOS</option>";
			frm_form += "<option value='850'>LOURDES</option>";
			frm_form += "<option value='851'>MUTISCUA</option>";
			frm_form += "<option value='852'>OCAŃA</option>";
			frm_form += "<option value='853'>PAMPLONA</option>";
			frm_form += "<option value='854'>PAMPLONITA</option>";
			frm_form += "<option value='855'>PUERTO SANTANDER</option>";
			frm_form += "<option value='856'>RAGONVALIA</option>";
			frm_form += "<option value='857'>SALAZAR</option>";
			frm_form += "<option value='858'>SAN CALIXTO</option>";
			frm_form += "<option value='859'>SAN CAYETANO</option>";
			frm_form += "<option value='860'>SANTIAGO</option>";
			frm_form += "<option value='861'>SARDINATA</option>";
			frm_form += "<option value='862'>SILOS</option>";
			frm_form += "<option value='863'>TEORAMA</option>";
			frm_form += "<option value='864'>TIBU</option>";
			frm_form += "<option value='865'>TOLEDO</option>";
			frm_form += "<option value='866'>VILLA CARO</option>";
			frm_form += "<option value='867'>VILLA DEL ROSARIO</option>";
			frm_form += "</select>";
			frm_form += "</div>";
		
			frm_form += "<div class='form-group'>";
		    frm_form += "<label for='sc_gpsc'>Obtener Posición GPS</label>";
		    frm_form += "<select id='sc_gpsc' name='sc_gpsc' type='text' class='form-control'>";
		    frm_form += "<option>NO</option>";
		    frm_form += "<option>SI</option>";
		    frm_form += "</select>";
		    frm_form += "</div>";
		
		    frm_form += "</form>";
		
		function fEditarCliente(data)
		{
			jQuery.ajax({
				type: "POST", 
				url: '../cEditarCliente/index.php',
				data:data,
				timeout: 5000,
				success: function (r) {                               
		...
		function fConsultaCrearCliente(data)
		{
			jQuery.ajax({
					type: "POST", 
					url: '../cCrearCliente/index.php',
					...
					success: function (r) {                               
						...
						if(obj.existe=='SI')
						{
							alertify.alert('', 'El número de identificación ya existe!!!', function(){ 
								...
								alertify.confirm('Crear Cliente', frm_form, function(){fCrearCliente($('#frm_crearcliente').serialize());$('.ajs-close').click();return false; }
		...
		function fCrearCliente(data)
		{
			if($('#sc_gpsc').val()=='NO')
			{
				fConsultaCrearCliente(data);
			}
			else
			{
				fObtenerPosicion(data);
			}
		}
		
		function fEditarClienteCargar(documento)
		{
			$.post("../cEditarClienteCargar/index.php",{
				
				documento:documento
		
			},function(r){
		
				console.log("Log data fEditarCliente: ");
			    console.log(r);
				...
				if(isJson(r))
				{
					...
					if(obj.nregistros>0)
					{
						...
						frm_form2  = "<form class='form' id='frm_editarcliente'>";
						frm_form2 += "<input id='codtercero' name='codtercero' type='hidden' value='"+obj.datos[1]+"'/>";
						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='sc_tipo'>Tipo Identificación</label>";
						frm_form2 += "<select id='sc_tipo' name='sc_tipo' type='text' class='form-control'>";
						if(obj.datos[0]==13)
						{
						frm_form2 += "<option value='13' selected='selected'>Cédula</option>";
						frm_form2 += "<option value='31'>NIT</option>";
						}
						else
						{
						frm_form2 += "<option value='13'>Cédula</option>";
						frm_form2 += "<option value='31' selected='selected'>NIT</option>";
						}
						frm_form2 += "</select>";
						frm_form2 += "</div>";

						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_identificacion'>CC/NIT</label>";
						frm_form2 += "<input id='txt_identificacion' name='txt_identificacion' type='text' class='form-control' placeholder='CC/NIT' value='"+obj.datos[1]+"'/>";
						frm_form2 += "</div>";

						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_nombres'>Razón Social</label>";
						frm_form2 += "<input id='txt_nombres' name='txt_nombres' type='text' class='form-control' placeholder='Nombres'   value='"+obj.datos[2]+"' />";
						frm_form2 += "</div>";
		
						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_apellido1'>Apellido1*</label>";
						frm_form2 += "<input id='txt_apellido1' name='txt_apellido1' type='text' class='form-control' placeholder='Apellido1'  value='"+obj.datos[10]+"' />";
						frm_form2 += "</div>";

						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_apellido2'>Apellido2</label>";
						frm_form2 += "<input id='txt_apellido2' name='txt_apellido2' type='text' class='form-control' placeholder='Apellido2'  value='"+obj.datos[11]+"' />";
						frm_form2 += "</div>";

						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_nombre1'>Nombre1*</label>";
						frm_form2 += "<input id='txt_nombre1' name='txt_nombre1' type='text' class='form-control' placeholder='Nombre1'  value='"+obj.datos[8]+"' />";
						frm_form2 += "</div>";

						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_nombre2'>Nombre2</label>";
						frm_form2 += "<input id='txt_nombre2' name='txt_nombre2' type='text' class='form-control' placeholder='Nombre2'  value='"+obj.datos[9]+"' />";
						frm_form2 += "</div>";
		
		
						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_direccion'>Dirección</label>";
						frm_form2 += "<input id='txt_direccion' name='txt_direccion' type='text' class='form-control' placeholder='Dirección'  value='"+obj.datos[3]+"'/>";
						frm_form2 += "</div>";		

						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_telefono'>Teléfono</label>";
						frm_form2 += "<input id='txt_telefono' name='txt_telefono' type='text' class='form-control' placeholder='Teléfono'  value='"+obj.datos[4]+"'/>";
						frm_form2 += "</div>";

						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='txt_correo'>Correo</label>";
						frm_form2 += "<input id='txt_correo' name='txt_correo' type='text' class='form-control' placeholder='Correo'   value='"+obj.datos[5]+"'/>";
						frm_form2 += "</div>";
		
						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<label for='sc_municipio'>Municipio</label>";
						frm_form2 += "<select id='sc_municipio' name='sc_municipio' type='text' class='form-control'>";
						frm_form2 += "<option value='828'>CUCUTA</option>";
						frm_form2 += "<option value='829'>ABREGO</option>";
						frm_form2 += "<option value='830'>ARBOLEDAS</option>";
						frm_form2 += "<option value='831'>BOCHALEMA</option>";
						frm_form2 += "<option value='832'>BUCARASICA</option>";
						frm_form2 += "<option value='833'>CACOTA</option>";
						frm_form2 += "<option value='834'>CACHIRA</option>";
						frm_form2 += "<option value='835'>CHINACOTA</option>";
						frm_form2 += "<option value='836'>CHITAGA</option>";
						frm_form2 += "<option value='837'>CONVENCION</option>";
						frm_form2 += "<option value='838'>CUCUTILLA</option>";
						frm_form2 += "<option value='839'>DURANIA</option>";
						frm_form2 += "<option value='840'>EL CARMEN</option>";
						frm_form2 += "<option value='841'>EL TARRA</option>";
						frm_form2 += "<option value='842'>EL ZULIA</option>";
						frm_form2 += "<option value='843'>GRAMALOTE</option>";
						frm_form2 += "<option value='844'>HACARI</option>";
						frm_form2 += "<option value='845'>HERRAN</option>";
						frm_form2 += "<option value='846'>LABATECA</option>";
						frm_form2 += "<option value='847'>LA ESPERANZA</option>";
						frm_form2 += "<option value='848'>LA PLAYA</option>";
						frm_form2 += "<option value='849'>LOS PATIOS</option>";
						frm_form2 += "<option value='850'>LOURDES</option>";
						frm_form2 += "<option value='851'>MUTISCUA</option>";
						frm_form2 += "<option value='852'>OCAŃA</option>";
						frm_form2 += "<option value='853'>PAMPLONA</option>";
						frm_form2 += "<option value='854'>PAMPLONITA</option>";
						frm_form2 += "<option value='855'>PUERTO SANTANDER</option>";
						frm_form2 += "<option value='856'>RAGONVALIA</option>";
						frm_form2 += "<option value='857'>SALAZAR</option>";
						frm_form2 += "<option value='858'>SAN CALIXTO</option>";
						frm_form2 += "<option value='859'>SAN CAYETANO</option>";
						frm_form2 += "<option value='860'>SANTIAGO</option>";
						frm_form2 += "<option value='861'>SARDINATA</option>";
						frm_form2 += "<option value='862'>SILOS</option>";
						frm_form2 += "<option value='863'>TEORAMA</option>";
						frm_form2 += "<option value='864'>TIBU</option>";
						frm_form2 += "<option value='865'>TOLEDO</option>";
						frm_form2 += "<option value='866'>VILLA CARO</option>";
						frm_form2 += "<option value='867'>VILLA DEL ROSARIO</option>";
						frm_form2 += "</select>";
						frm_form2 += "</div>";
						
						if(!$.isEmptyObject(obj.datos[6]) && !$.isEmptyObject(obj.datos[7]))
						{
						frm_form2 += "<div class='form-group'>";
						frm_form2 += "<a target='_blank' href='https://www.solucionesnavarro.net/app/php/cMarcadorMapa.php?latitude="+obj.datos[6]+"&longitude="+obj.datos[7]+"&cliente="+obj.datos[2]+"'><img src='../_lib/img/fw_ico_posicion_geografica.png' style='width:30px;'/></a>";
						frm_form2 += "</div>";
						}

						frm_form2 += "</form>";
						
						alertify.confirm('Editar', frm_form2, function(){ fEditarCliente($('#frm_editarcliente').serialize());$('.ajs-close').click();return false; }
                , function(){ }).set('labels', {ok:'Guardar', cancel:'Cancelar'}); 
						
						$('#sc_municipio').val(obj.datos[12]);

					}
					else
					{
						alertify.alert('', 'No se pudo cargar el cliente!!!', function(){ });
					}
		
				}
				else
				{
					alertify.alert('', 'Los datos recibidos no tiene el formato adecuado!!!', function(){ });
				}
			});
		}
		...
		{
			var vemp = $('#s_empresa').val();
			$.post("../cCambiarEmpresaNube/index.php",{
					
				empresa:vemp
		
			},function(r){
					
				console.log('Log data al cambiar empresa inicio sesion: ');
				console.log(r);
		
				jQuery.ajax({
					type: "POST", 
					url: '../cValidarInicioSesion/index.php',
					...
					success: function (r) {                               
						...
						if(obj.si_credenciales_ok=='SI')
						{
							if(obj.si_parametrizacion=='SI')
							{
								if(obj.si_tiene_tercero=='SI')
								{
									$('.ulogueado').text('USUARIO: '+obj.ulogueado);
		
									if(!$.isEmptyObject(obj.permisos))
									{
										if(obj.permisos.length>0)
										{
											for(i=0;i<obj.permisos.length;i++)
											{
												$("."+obj.permisos[ i]).css("display","block");
											}
										}
									}
									cambiarPagina('p_menu');
								}
								else
								{
									alertify.alert('', 'El usuario no tiene tercero relacionado en la Nube!!!', function(){ });
								}
							}
							else
							{
								alertify.alert('', 'La empresa no esta parametrizada en la Nube!!!', function(){ });
							}
						}
						else
						{
							alertify.alert('', 'Credenciales inválidas!!!', function(){ });
						}
					}
				})
				.done(function(){
		...
		function fBuscarClientes()
		{
			var buscar = $('#txt_buscarclientes').val();
				
			$.post('../cListaClientes/index.php',{
				...
				console.log(r);
				$('#div_contenidoclientes').html(r);
			});
		}
		
		function fBuscarRutas()
		{
			var buscar = $('#txt_buscarrutas').val();
				
			$.post('../cListaRutas/index.php',{

				txt_buscarrutas:buscar

			},function(r){

				console.log(r);
				$('#div_contenidorutas').html(r);
			});
		}
		
		function fBuscarProductos()
		{
			var buscar = $('#txt_buscarproductos').val();
				
			$.post('../cListaProductos/index.php',{
				...
				console.log(r);
				$('#div_contenidoproductos').html(r);
			});
		}
		
		function fEliminarPedido(idpedido,npedido)
		{
			alertify.confirm('', '¿Desea borrar el pedido No: '+npedido+'?'
				, function(){ 
					
					jQuery.ajax({
						type: "POST", 
						url: '../cEliminarPedido/index.php',
						...
						success: function (r) {                               
							...
							if(obj.tienedetalle=='SI')
							{
								alertify.alert('', 'No se pude borrar un pedido con detalle!!!', function(){ });
							}
							else
							{
			...
			if(!$.isEmptyObject(idpedido))
			{
				jQuery.ajax({
					...
					success: function (r) {                               
						...
						if(!$.isEmptyObject(obj.idpedido))
						{
		
							if(obj.asentada=="1")
							{
								alert("No se puede editar un pedido asentado!!!");
							}
							else
							{
								$("#idpedido").val(obj.idpedido);
								$("#cod_cliente").val(obj.cod_cliente);
								$("#lbl_npedido").text(obj.npedido);
								$("#lbl_fecha").text(obj.fecha);
								$("#lbl_nomcliente").text(obj.nomcliente);
								$("#txt_observaciones").val(obj.observaciones);

								cambiarPagina('p_frm_pedidos');
								fCargarDetalle();
							}
						}
						else
		...
		function fActualizarObservaciones()
		{
			...
			jQuery.ajax({
			type: "POST", 
			url: '../cEditarObservacionesPedido/index.php',
			data:'idpedido='+idpedido+'&observaciones='+observaciones,
			timeout: 5000,
			success: function(r){                               

				console.log(r);
				alertify.alert('', 'Observación actualizada!!!', function(){ });
			}
			})
			.done(function(){
		...
		function fEditarClientePedido(cod_cliente)
		{
			...
			jQuery.ajax({
			type: "POST", 
			url: '../cEditarClientePedido/index.php',
			data:'idpedido='+idpedido+'&cod_cliente='+cod_cliente,
			timeout: 5000,
			success: function(r){                               
		...
		function fBuscarCliente(indicio)
		{
			jQuery.ajax({
			type: "POST", 
			url: '../cListaClientesPedido/index.php',
			...
			if(!$.isEmptyObject(r))
			{
			$('#div_rbuscarclientes').html(r);
			}
			else
			{
			$('#div_rbuscarclientes').html('<p>No se encontraron registros!!!</p>');
			}
		...
		function fInsertarItem(codigobar,precio,cantidad)
		{
			console.log("Codigo: "+codigobar+" -- precio: "+precio+" -- cantidad: "+cantidad);
		
			if(isNaN(cantidad))
			{
				alertify.alert('', 'Por favor digite solo números!!!', function(){ });
			}
			else
			{
				...
				if($.isEmptyObject(codigobar) || codigobar==0)
				{
					mensaje += "Debe especificar un código para el producto.<br>";
				}

				if($.isEmptyObject(cantidad) || cantidad==0)
				{
					mensaje += "Debe especificar una cantidad.<br>";
				}

				if($.isEmptyObject(precio) || precio==0)
				{
					mensaje += "Debe especificar un precio.<br>";
				}

				if(!$.isEmptyObject(mensaje))
				{
				...
				else
				{
					jQuery.ajax({
						type: "POST", 
						url: '../cInsertarItem/index.php',
						data:'idpedido='+idpedido+'&codigobar='+codigobar+'&precio='+precio+'&cantidad='+cantidad,
						timeout: 5000,
						success: function (r) {                               

							console.log(r);

							$("#txt_buscarproductoped").val("");
							$("#div_contenidodetalleped").html("");
		...
		function fCargarDetalle()
		{
			var idpedido = $('#idpedido').val();
			
			jQuery.ajax({
				type: "POST", 
				url: '../cCargarDetalle/index.php',
				data:'idpedido='+idpedido,
				timeout: 5000,
				success: function (r) {                               
		...
		function fEliminarItem(iddet,descripcion)
		{
		
			var idpedido = $('#idpedido').val();
		
			alertify.confirm('', '¿Desea eliminar el producto: '+descripcion+' del pedido?'
				,function(){
					
					jQuery.ajax({
						type: "POST", 
						url: '../cEliminarItem/index.php',
						data:'iddet='+iddet+'&idpedido='+idpedido,
						timeout: 5000,
						success: function (r) {                               
		...
		function fCrearPedido()
		{
			jQuery.ajax({
					type: "POST", 
					url: '../cCrearPedido/index.php',
					data:'ok=',
					timeout: 5000,
					success: function (r) {                               
						...
						{
							alertify.alert('', 'No se pudo crear el pedido!!!', function(){ });
						}
		...
		function fBuscarProducto()
		{
			jQuery.ajax({
					type: "POST", 
					url: '../cBuscarProducto/index.php',
					data:$('#frm_buscarproductoped').serialize(),
					timeout: 5000,
					success: function (r) {                               
						...
						if(!$.isEmptyObject(r))
						{
							$('#div_contenidodetalleped').html(r);
						}
						else
						{
							$('#div_contenidodetalleped').html('<p>No se encontraron registros!!!</p>');
						}
		...
		$(document).ready(function(){
			...
			$('#btn_buscarruta').click(function(){
				
				fBuscarRutas();
			});
		
			$('#btn_buscarproducto').click(function(e){
				
				e.preventDefault();
		
				console.log($('#frm_buscarproducto').serialize());
		
				fBuscarProducto();
		
			});
		
			$('#txt_buscarproductoped').keypress(function(e){
			...
			$('#s_empresa').change(function(){
				...
				$.post("../cCambiarEmpresaNube/index.php",{
					...
					console.log('Log data al cambiar empresa: ');
					console.log(r);
				});
			});
		
			$('#btn_buscarclientes').click(function(e){
			...
			$('#txt_buscarclientes').keypress(function(e){
			...
			$('#btn_buscarproductos').click(function(e){
			...
			$('#txt_buscarproductos').keypress(function(e){
			...
			$('.m_clientes').click(function(e){
				
				$('nav').animate({
					left: '-100%'
				});
				contador = 1;
				cambiarPagina('p_clientes');
			});
		
			$('.m_productos').click(function(e){
				
				$('nav').animate({
					left: '-100%'
				});
				contador = 1;
				cambiarPagina('p_productos');
			});
		
			$('.m_pedidos').click(function(e){
				
				$('nav').animate({
					left: '-100%'
				});
				contador = 1;
				cambiarPagina('p_pedidos');
			});
		
			$('.m_rutas').click(function(e){
				
				$('nav').animate({
					left: '-100%'
				});
				contador = 1;
				cambiarPagina('p_rutas');
			});
		
			$('.m_cerrar').click(function(e){
			
				$('.menu').click();
				cambiarPagina('p_inicio');
																			   
				$.post("../cCerrarSesionMovil/index.php",{
			...
			$('#btn_buscarpedidos').click(function(e){
				
				e.preventDefault();
		
				jQuery.ajax({
					type: "POST", 
					url: '../cListaPedidos/index.php',
					data:$('#frm_form_pedidos').serialize(),
					timeout: 5000,
					success: function (r) {                               
						...
						if(!$.isEmptyObject(r))
						{
							$('#div_contenidopedidos').html(r);
						}
						else
						{
							$('#div_contenidopedidos').html('<p>No se encontraron registros!!!</p>');
						}
...
<body>
	...
	<div id="p_inicio" data-role="page">
	<br>
	<div class='container'>
		<form class='form' id='frm_form'>
			<div class='form-group'>
				<center>
				<img src='../_lib/img/fw_ico_nube3.png' style='width:180px;'/>
				</center>
			</div>
			<div class='form-group'>
				<label for='s_empresa'>Empresa</label>
				<select id='s_empresa' name='s_empresa' data-role="none" class='form-control form-control-sm' required='required'>
				<?php
				 
      $nm_select = "select nombre,nombre_empresa,predeterminada from empresas order by predeterminada asc,idempresa desc"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;						
				if(isset($this->vempresas[0][0]))
				{
					...
					$arr_conn['database'] = $empresa;
					sc_connection_edit("conn_nube", $arr_conn); 
				}
				?>
				</select>
			</div>
			<div class='form-group'>
				...
				<input id='txt_usuario' name='txt_usuario' type='text' placeholder='Usuario' class='form-control' required='required'/>
			</div>
			<div class='form-group'>
				<label for='txt_password'>Contraseña</label>
				<input id='txt_password' name='txt_password' type='password' placeholder='Contraseña' class='form-control' required='required'/>
			</div>
			<div class="form-check" style="text-align:center;">
				<input type="checkbox" class="form-check-input" id="chk_recordarme" name="chk_recordarme">
				<label class="form-check-label" for="chk_recordarme">Recordarme</label>
			</div>
			<button id='btn_ingresar' style='float:right;' type="button" class="btn btn-primary">Ingresar</button>
		</form>
	</div>
	</div>
	<!-- FIN PAGINA INICIO -->
	...
	<!--INICIO PAGINA MENU -->
	<div id="p_menu" data-role="page">
		<div data-role="header">
		<header>
		<div class="menu_bar" style='background:#29abe2;color:white;'>
			<img class='menu' src='../_lib/img/fw_ico_menu.png' style='width:50px;position:fixed;'/>
			<a href="#" class="bt-menu" style='font-size:20px;text-align:center;padding:10px;color:white;'><b>FACILWEB</b></a>
		</div>

		<nav class="nav_menu">
			<ul>
				<li><a href="#" class="enlace"><span class="icon-house enlace"></span><span class="ulogueado">USUARIO: </span></a></li>
				<li><a href="#" class="m_menu enlace"><span class="icon-rocket"></span>INICIO</a></li>
				<li><a href="#" class="m_pedidos enlace"><span class="icon-house"></span>PEDIDOS</a></li>
				<li><a href="#" class="m_clientes enlace"><span class="icon-suitcase"></span>CLIENTES</a></li>
				<li><a href="#" class="m_productos enlace"><span class="icon-rocket"></span>PRODUCTOS</a></li>
				<li><a href="#" class="m_rutas enlace"><span class="icon-rocket"></span>RUTAS</a></li>
				<!--<li><a href="#" class="enlace"><span class="icon-rocket"></span>VISITAS</a></li>-->
				<!--<li><a href="#" class="enlace"><span class="icon-rocket"></span>CONTRASEÑA</a></li>-->
				<li><a href="#" class="m_cerrar enlace" ><span class="icon-mail"></span>CERRAR SESIÓN</a></li>
			</ul>
		</nav>
		</header>
		</div>
		<div data-role="content">
			<div id='contenido'>
				...
				<br>
				<center>
				<img src='../_lib/img/fw_ico_nube3.png'/>
				</center>
			</div>
		</div>
	</div>
	...
	<div id="p_clientes" data-role="page">
		<div data-role="header">
		<header>
		<div class="menu_bar" style='background:#29abe2;color:white;'>
			...
			<tr>
			<td style='width:50px;'>
			<img class='menu' src='../_lib/img/fw_ico_menu.png' style='width:50px;'/>
			</td>
			<td style='text-align:center;'>
			<a href="#" style='font-size:20px;text-align:center;padding:3px;color:white;'><b>FACILWEB</b></a>
			</td>
			<td style='width:50px;'>
			<input type='button' value='Crear' class='btn btn-primary' style='margin-right:5px;' onclick="alertify.confirm('Crear Cliente', frm_form, function(){ fCrearCliente($('#frm_crearcliente').serialize());$('.ajs-close').click();return false; }
                , function(){ }).set('labels', {ok:'Guardar', cancel:'Cancelar'});"/>
			</td>
			</tr>
			</table>
		...
		<div data-role="content">
			<form style='margin-bottom:15px;'>
				...
				<tr>
				<td style='width:40px;'>
				<input type='button' value='X' class='btn btn-danger' onclick='$("#txt_buscarclientes").val("");$("#div_contenidoclientes").html("");'/>
				</td>
				<td>
				<input id='txt_buscarclientes' name='txt_buscarclientes' type='text' class='form-control' placeholder='Digite un indicio' style='width:100%;' />
				</td>
				<td style='text-align:right;width:75px;'>
				<input id='btn_buscarclientes' type='button' class='btn btn-primary' value='Buscar'/>
				</td>
				</tr>
				</table>
			</form>
			<div id='div_contenidoclientes'>
	...
	<div id="p_productos" data-role="page">
		<div data-role="header">
		<header>
		<div class="menu_bar" style='background:#29abe2;color:white;'>
			<table border='0' width='100%'>
		...
		<div data-role="content">
			<form style='margin-bottom:15px;'>
				...
				<tr>
				<td style='width:40px;'>
				<input type='button' value='X' class='btn btn-danger' onclick='$("#txt_buscarproductos").val("");$("#div_contenidoproductos").html("");'/>
				</td>
				<td>
				<input id='txt_buscarproductos' name='txt_buscarproductos' type='text' class='form-control' placeholder='Digite un indicio' style='width:100%;' />
				</td>
				<td style='text-align:right;width:75px;'>
				<input id='btn_buscarproductos' type='button' class='btn btn-primary' value='Buscar'/>
				</td>
				</tr>
				</table>
			</form>
			<div id='div_contenidoproductos'>
	...
	<div id="p_pedidos" data-role="page">
		<div data-role="header">
		<header>
		<div class="menu_bar" style='background:#29abe2;color:white;'>
			<table border='0' width='100%'>
			...
			<td style='text-align:right;width:75px;padding-right:10px;'>
				<input type='button' class='btn btn-primary' value='Nuevo' onclick="fCrearPedido();"/>
			</td>
			</tr>
			</table>
		</div>
		...
		<div data-role="content">
			<form id='frm_form_pedidos' method='POST' style='margin-bottom:15px;'>
				...
				<tr>
				<td>
				<label for='fechapedidos'>Fecha del pedido: </label>
				</td>
				<td>
				<input id='fechapedidos' name='fechapedidos' type='date' class='form-control' required='required' value="<?php echo date('Y-m-d'); ?>" style='margin-bottom:5px;'/>
				</td>
				</tr>
				</table>
				</td>
				...
				<tr>
				<td style='width:40px;'>
				<input type='button' value='X' class='btn btn-danger' onclick='$("#txt_buscarpedidos").val("");$("#div_contenidopedidos").html("");'/>
				</td>
				<td>
				<input id='txt_buscarpedidos' name='txt_buscarpedidos' type='text' class='form-control' placeholder='Digite un indicio' style='width:100%;' />
				</td>
				<td style='text-align:right;width:75px;'>
				<input id='btn_buscarpedidos' type='button' class='btn btn-primary' value='Buscar'/>
				</td>
				</tr>
				</table>
			</form>
			<div id='div_contenidopedidos'>
			</div>
		</div>
	</div>
	<!--FIN PAGINA PEDIDOS-->
	
	<!--INICIO PAGINA FRM PEDIDOS -->
	<div id="p_frm_pedidos" data-role="page">
		<div data-role="header">
		<header>
		<div class="menu_bar" style='background:#29abe2;color:white;'>
			<table border='0' width='100%'>
			...
			<!--<img class='menu' src='../_lib/img/fw_ico_menu.png' style='width:50px;'/>-->
			<input type="button" value="VOLVER" class="btn btn-primary" onclick="cambiarPagina('p_pedidos');$('#btn_buscarpedidos').click();" />
			</td>
			<td style='text-align:center;'>
			<a href="#" style='font-size:20px;text-align:center;padding:3px;color:white;'><b>FACILWEB</b></a>
			</td>
		...
		<nav class="nav_menu">
			<ul>
				<li><a href="#" class="enlace"><span class="icon-house enlace"></span><span class="ulogueado">USUARIO: </span></a></li>
				<li><a href="#" onclick="cambiarPagina('p_pedidos');$('#btn_buscarpedidos').click();" class='enlace'><span class="icon-home"></span>VOLVER</a></li>
			</ul>
		</nav>
		-->
		</header>
		...
		<div data-role="content">
			<form method='POST'>
				...
				<input id='cod_cliente' name='cod_cliente' type='hidden' />
				...
				<tr>
				<td>
					<label id='lbl_nomcliente'></label>
				</td>
				<td style='width:40px;'>
					<img src='../_lib/img/scriptcase__NM__ico__NM__user_find_32.png' style='width:30px;' onclick="alertify.confirm('Buscar Cliente', frm_formbcliente, function(){$('.ajs-close').click();return false; }
						, function(){ }).set('labels', {ok:'ok', cancel:'Cerrar'});"/>
				</td>
				</tr>
				</table>
				...
				<tr>
				<td>
					<textArea id="txt_observaciones" name="txt_observaciones" class="form-control" style="width:95%;"></textArea>
				</td>
				<td style="width:30px;">
					<input type="button" class="btn btn-primary" value="E" onclick="fActualizarObservaciones();" />
				</td>
				</tr>
				</table>
			</form>

			<form id='frm_buscarproductoped' style='margin-top:5px;'>
				<table border='0' width='100%'>
				<tr>
				<td style='width:40px;'>
				<input type='button' value='X' class='btn btn-danger' onclick='$("#txt_buscarproductoped").val("");$("#div_contenidodetalleped").html("");'/>
				</td>
				<td>
				<input id='txt_buscarproductoped' name='txt_buscarproductoped' type='text' class='form-control' placeholder='Buscar Producto' style='width:100%;' autocomplete="off" />
				</td>
				<td style='text-align:right;width:75px;'>
				<input id='btn_buscarproducto' type='button' class='btn btn-primary' value='Buscar'/>
				</td>
				</tr>
				</table>
			</form>
			<div id='div_contenidodetalleped'  style='margin-top:5px;'></div>
			<div id='div_detalleped'  style='margin-top:5px;'></div>
		</div>
	</div>
	<!--FIN PAGINA FRM PEDIDOS-->
	
	<!--INICIO PAGINA RUTAS -->
	<div id="p_rutas" data-role="page">
		<div data-role="header">
		<header>
		<div class="menu_bar" style='background:#29abe2;color:white;'>
			<table border='0' width='100%'>
			...
			<td style='text-align:center;'>
			<a href="#" style='font-size:20px;text-align:center;padding:3px;color:white;'><b>RUTAS</b></a>
			</td>
			<td style='width:50px;'>
		...
		<div data-role="content">
			<form style='margin-bottom:15px;'>
				...
				<tr>
				<td style='width:40px;'>
				<input type='button' value='X' class='btn btn-danger' onclick='$("#txt_buscarrutas").val("");$("#div_contenidorutas").html("");'/>
				</td>
				<td>
				<select id='txt_buscarrutas' name='txt_buscarrutas' class='form-control' data-role="none" style='width:100%;'>
				...
				<td style='text-align:right;width:75px;'>
				<input id='btn_buscarruta' type='button' class='btn btn-primary' value='Listar'/>
				</td>
				</tr>
				</table>
			</form>
			<div id='div_contenidorutas'>
...
<?php
$_SESSION['scriptcase']['sesion_nube']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_sesion_nube($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['sesion_nube']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "sesion_nube") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['sesion_nube']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['sesion_nube']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['sesion_nube']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['sesion_nube']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['sesion_nube']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "sesion_nube";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'sesion_nube' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['sesion_nube']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['sesion_nube']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['sesion_nube']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['sesion_nube']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['sesion_nube']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('sesion_nube' == $sReferer || 'sesion_nube_' == substr($sReferer, 0, 12))
       {
           $_SESSION['sc_session'][$script_case_init]['sesion_nube']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'sesion_nube')
   {
       $_SESSION['sc_session'][$script_case_init]['sesion_nube']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['sesion_nube']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/sesion_nube_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_sesion_nube($cadapar[1]);
   ...
   $contr_sesion_nube = new sesion_nube_apl();
   $contr_sesion_nube->controle();
//
   function nm_limpa_str_sesion_nube(&$str)
   {
