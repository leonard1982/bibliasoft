  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_autoriza_borrado_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_autoriza_borrado_mob_form();
	}
...
?>
  ...
  // ---------- Validate usuario
  function do_ajax_autoriza_borrado_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autoriza_borrado_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_autoriza_borrado_mob_validate_usuario_cb);
  } // do_ajax_autoriza_borrado_mob_validate_usuario

  function do_ajax_autoriza_borrado_mob_validate_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autoriza_borrado_mob_validate_usuario_cb

  // ---------- Validate clave
  function do_ajax_autoriza_borrado_mob_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldText(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autoriza_borrado_mob_validate_clave(var_clave, var_script_case_init, do_ajax_autoriza_borrado_mob_validate_clave_cb);
  } // do_ajax_autoriza_borrado_mob_validate_clave

  function do_ajax_autoriza_borrado_mob_validate_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clave";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autoriza_borrado_mob_validate_clave_cb

  // ---------- Validate id_detalle
  function do_ajax_autoriza_borrado_mob_validate_id_detalle()
  {
    var nomeCampo_id_detalle = "id_detalle";
    var var_id_detalle = scAjaxGetFieldText(nomeCampo_id_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autoriza_borrado_mob_validate_id_detalle(var_id_detalle, var_script_case_init, do_ajax_autoriza_borrado_mob_validate_id_detalle_cb);
  } // do_ajax_autoriza_borrado_mob_validate_id_detalle

  function do_ajax_autoriza_borrado_mob_validate_id_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_detalle";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autoriza_borrado_mob_validate_id_detalle_cb

  // ---------- Validate producto
  function do_ajax_autoriza_borrado_mob_validate_producto()
  {
    var nomeCampo_producto = "producto";
    var var_producto = scAjaxGetFieldHidden(nomeCampo_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autoriza_borrado_mob_validate_producto(var_producto, var_script_case_init, do_ajax_autoriza_borrado_mob_validate_producto_cb);
  } // do_ajax_autoriza_borrado_mob_validate_producto

  function do_ajax_autoriza_borrado_mob_validate_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autoriza_borrado_mob_validate_producto_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_autoriza_borrado_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_autoriza_borrado_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_usuario = scAjaxGetFieldText("usuario");
    var var_clave = scAjaxGetFieldText("clave");
    var var_id_detalle = scAjaxGetFieldText("id_detalle");
    var var_producto = scAjaxGetFieldHidden("producto");
    ...
    scAjaxProcOn();
    x_ajax_autoriza_borrado_mob_submit_form(var_usuario, var_clave, var_id_detalle, var_producto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_autoriza_borrado_mob_submit_form_cb);
  } // do_ajax_autoriza_borrado_mob_submit_form

  function do_ajax_autoriza_borrado_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_autoriza_borrado_mob_submit_form_cb_after_alert);
  } // do_ajax_autoriza_borrado_mob_submit_form_cb
  function do_ajax_autoriza_borrado_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_autoriza_borrado_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_autoriza_borrado_mob_navigate_form()
  {
    perform_ajax_autoriza_borrado_mob_navigate_form();
  }

  function perform_ajax_autoriza_borrado_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_autoriza_borrado_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['autoriza_borrado_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_autoriza_borrado_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_autoriza_borrado_mob_navigate_form_cb_after_alert);
  } // do_ajax_autoriza_borrado_mob_navigate_form_cb
  function do_ajax_autoriza_borrado_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_autoriza_borrado_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_autoriza_borrado_mob_navigate_form_cb_after_alert
  function sc_hide_autoriza_borrado_mob_form()
  {
  ...
  ajax_field_list[1] = "clave";
  ajax_field_list[2] = "id_detalle";
  ajax_field_list[3] = "producto";
  ...
  var ajax_error_list = {
    ...
    "clave": {"label": "Contraseña", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_detalle": {"label": "ID del Detalle", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "producto": {"label": "Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["id_detalle"][1] = "id_detalle";
