...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____mfactura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____mfactura"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['mfactura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['mfactura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['mfactura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['mfactura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['mfactura']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['mfactura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['mfactura']['embutida_filho'] as $ind => $sc_init)
          {
