<?php
@session_start() ;
$_SESSION['scriptcase']['mfactura']['sc_process_barr'] = true;
require_once('../mfactura/index.php');
unset($_SESSION['scriptcase']['mfactura']['sc_process_barr']);
$ExportCtrl = new mfactura_export_control;
$ExportCtrl->Export_barr();

class mfactura_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['mfactura']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['mfactura']['glo_nm_path_imag_temp'];
