...
<?php
   ...
   $Ord_Cmp = new grid_casos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_casos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["zona"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["zona"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["zona"] : "Zona";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["numero"] : "No Caso";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['codigo_cliente'] = "on";
   $tab_def_campos['codigo_cliente'] = "codigo_cliente";
   $tab_labels["codigo_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["codigo_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["codigo_cliente"] : "No Cliente";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["estado"] : "Estado";
   $tab_ger_campos['prioridad'] = "on";
   $tab_def_campos['prioridad'] = "prioridad";
   $tab_labels["prioridad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["prioridad"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["prioridad"] : "Prioridad";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["valor"] : "Valor";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['factura'] = "on";
   $tab_def_campos['factura'] = "factura";
   $tab_labels["factura"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["factura"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["factura"] : "Factura";
   ...
   $tab_labels["notificar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["notificar"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["notificar"] : "";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['labels']["imprimir"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_casos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_casos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_casos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_casos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
