  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_seg_apps_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_seg_apps_mob_form();
	}
...
?>
  ...
  // ---------- Validate idapp
  function do_ajax_form_seg_apps_mob_validate_idapp()
  {
    var nomeCampo_idapp = "idapp";
    var var_idapp = scAjaxGetFieldHidden(nomeCampo_idapp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_idapp(var_idapp, var_script_case_init, do_ajax_form_seg_apps_mob_validate_idapp_cb);
  } // do_ajax_form_seg_apps_mob_validate_idapp

  function do_ajax_form_seg_apps_mob_validate_idapp_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_idapp_cb

  // ---------- Validate app_name
  function do_ajax_form_seg_apps_mob_validate_app_name()
  {
    var nomeCampo_app_name = "app_name";
    var var_app_name = scAjaxGetFieldText(nomeCampo_app_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_app_name(var_app_name, var_script_case_init, do_ajax_form_seg_apps_mob_validate_app_name_cb);
  } // do_ajax_form_seg_apps_mob_validate_app_name

  function do_ajax_form_seg_apps_mob_validate_app_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_app_name_cb

  // ---------- Validate app_name2
  function do_ajax_form_seg_apps_mob_validate_app_name2()
  {
    var nomeCampo_app_name2 = "app_name2";
    var var_app_name2 = scAjaxGetFieldText(nomeCampo_app_name2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_app_name2(var_app_name2, var_script_case_init, do_ajax_form_seg_apps_mob_validate_app_name2_cb);
  } // do_ajax_form_seg_apps_mob_validate_app_name2

  function do_ajax_form_seg_apps_mob_validate_app_name2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "app_name2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_app_name2_cb

  // ---------- Validate app_link
  function do_ajax_form_seg_apps_mob_validate_app_link()
  {
    var nomeCampo_app_link = "app_link";
    var var_app_link = scAjaxGetFieldText(nomeCampo_app_link);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_app_link(var_app_link, var_script_case_init, do_ajax_form_seg_apps_mob_validate_app_link_cb);
  } // do_ajax_form_seg_apps_mob_validate_app_link

  function do_ajax_form_seg_apps_mob_validate_app_link_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "app_link";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_app_link_cb

  // ---------- Validate idapptype
  function do_ajax_form_seg_apps_mob_validate_idapptype()
  {
    var nomeCampo_idapptype = "idapptype";
    var var_idapptype = scAjaxGetFieldSelect(nomeCampo_idapptype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_idapptype(var_idapptype, var_script_case_init, do_ajax_form_seg_apps_mob_validate_idapptype_cb);
  } // do_ajax_form_seg_apps_mob_validate_idapptype

  function do_ajax_form_seg_apps_mob_validate_idapptype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idapptype";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_idapptype_cb

  // ---------- Validate description
  function do_ajax_form_seg_apps_mob_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_description(var_description, var_script_case_init, do_ajax_form_seg_apps_mob_validate_description_cb);
  } // do_ajax_form_seg_apps_mob_validate_description

  function do_ajax_form_seg_apps_mob_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_description_cb

  // ---------- Validate app_parentid
  function do_ajax_form_seg_apps_mob_validate_app_parentid()
  {
    var nomeCampo_app_parentid = "app_parentid";
    var var_app_parentid = scAjaxGetFieldSelect(nomeCampo_app_parentid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_app_parentid(var_app_parentid, var_script_case_init, do_ajax_form_seg_apps_mob_validate_app_parentid_cb);
  } // do_ajax_form_seg_apps_mob_validate_app_parentid

  function do_ajax_form_seg_apps_mob_validate_app_parentid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "app_parentid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_app_parentid_cb

  // ---------- Validate app_order
  function do_ajax_form_seg_apps_mob_validate_app_order()
  {
    var nomeCampo_app_order = "app_order";
    var var_app_order = scAjaxGetFieldText(nomeCampo_app_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_app_order(var_app_order, var_script_case_init, do_ajax_form_seg_apps_mob_validate_app_order_cb);
  } // do_ajax_form_seg_apps_mob_validate_app_order

  function do_ajax_form_seg_apps_mob_validate_app_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "app_order";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_app_order_cb

  // ---------- Validate app_icon
  function do_ajax_form_seg_apps_mob_validate_app_icon()
  {
    var nomeCampo_app_icon = "app_icon";
    var var_app_icon = scAjaxGetFieldText(nomeCampo_app_icon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_app_icon(var_app_icon, var_script_case_init, do_ajax_form_seg_apps_mob_validate_app_icon_cb);
  } // do_ajax_form_seg_apps_mob_validate_app_icon

  function do_ajax_form_seg_apps_mob_validate_app_icon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "app_icon";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_app_icon_cb

  // ---------- Validate app_badge
  function do_ajax_form_seg_apps_mob_validate_app_badge()
  {
    var nomeCampo_app_badge = "app_badge";
    var var_app_badge = scAjaxGetFieldText(nomeCampo_app_badge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_app_badge(var_app_badge, var_script_case_init, do_ajax_form_seg_apps_mob_validate_app_badge_cb);
  } // do_ajax_form_seg_apps_mob_validate_app_badge

  function do_ajax_form_seg_apps_mob_validate_app_badge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "app_badge";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_app_badge_cb

  // ---------- Validate color
  function do_ajax_form_seg_apps_mob_validate_color()
  {
    var nomeCampo_color = "color";
    var var_color = scAjaxGetFieldRadio(nomeCampo_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_mob_validate_color(var_color, var_script_case_init, do_ajax_form_seg_apps_mob_validate_color_cb);
  } // do_ajax_form_seg_apps_mob_validate_color

  function do_ajax_form_seg_apps_mob_validate_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_mob_validate_color_cb

  // ---------- Event onchange app_name
  function do_ajax_form_seg_apps_mob_event_app_name_onchange()
  {
    var var_app_link = scAjaxGetFieldText("app_link");
    var var_app_name = scAjaxGetFieldText("app_name");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_seg_apps_mob_event_app_name_onchange(var_app_link, var_app_name, var_script_case_init, do_ajax_form_seg_apps_mob_event_app_name_onchange_cb);
  } // do_ajax_form_seg_apps_mob_event_app_name_onchange

  function do_ajax_form_seg_apps_mob_event_app_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "app_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_seg_apps_mob_event_app_name_onchange_cb_after_alert);
  } // do_ajax_form_seg_apps_mob_event_app_name_onchange_cb
  function do_ajax_form_seg_apps_mob_event_app_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_seg_apps_mob_event_app_name_onchange_cb_after_alert

  // ---------- Event onchange app_parentid
  function do_ajax_form_seg_apps_mob_event_app_parentid_onchange()
  {
    var var_app_parentid = scAjaxGetFieldSelect("app_parentid");
    var var_app_order = scAjaxGetFieldText("app_order");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_seg_apps_mob_event_app_parentid_onchange(var_app_parentid, var_app_order, var_script_case_init, do_ajax_form_seg_apps_mob_event_app_parentid_onchange_cb);
  } // do_ajax_form_seg_apps_mob_event_app_parentid_onchange

  function do_ajax_form_seg_apps_mob_event_app_parentid_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "app_parentid";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_seg_apps_mob_event_app_parentid_onchange_cb_after_alert);
  } // do_ajax_form_seg_apps_mob_event_app_parentid_onchange_cb
  function do_ajax_form_seg_apps_mob_event_app_parentid_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_seg_apps_mob_event_app_parentid_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_seg_apps_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_seg_apps_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idapp = scAjaxGetFieldHidden("idapp");
    var var_app_name = scAjaxGetFieldText("app_name");
    var var_app_name2 = scAjaxGetFieldText("app_name2");
    var var_app_link = scAjaxGetFieldText("app_link");
    var var_idapptype = scAjaxGetFieldSelect("idapptype");
    var var_description = scAjaxGetFieldText("description");
    var var_app_parentid = scAjaxGetFieldSelect("app_parentid");
    var var_app_order = scAjaxGetFieldText("app_order");
    var var_app_icon = scAjaxGetFieldText("app_icon");
    var var_app_badge = scAjaxGetFieldText("app_badge");
    var var_color = scAjaxGetFieldRadio("color");
    ...
    scAjaxProcOn();
    x_ajax_form_seg_apps_mob_submit_form(var_idapp, var_app_name, var_app_name2, var_app_link, var_idapptype, var_description, var_app_parentid, var_app_order, var_app_icon, var_app_badge, var_color, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_seg_apps_mob_submit_form_cb);
  } // do_ajax_form_seg_apps_mob_submit_form

  function do_ajax_form_seg_apps_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idapp");
      scAjaxHideErrorDisplay("app_name");
      scAjaxHideErrorDisplay("app_name2");
      scAjaxHideErrorDisplay("app_link");
      scAjaxHideErrorDisplay("idapptype");
      scAjaxHideErrorDisplay("description");
      scAjaxHideErrorDisplay("app_parentid");
      scAjaxHideErrorDisplay("app_order");
      scAjaxHideErrorDisplay("app_icon");
      scAjaxHideErrorDisplay("app_badge");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_seg_apps_mob_submit_form_cb_after_alert);
  } // do_ajax_form_seg_apps_mob_submit_form_cb
  function do_ajax_form_seg_apps_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_seg_apps_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_seg_apps_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_seg_apps_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_seg_apps_mob_navigate_form();
    }
  }

  function perform_ajax_form_seg_apps_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("app_badge");
    scAjaxHideErrorDisplay("color");
    var var_idapp = document.F2.idapp.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_seg_apps_mob_navigate_form(var_idapp, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_seg_apps_mob_navigate_form_cb);
  } // do_ajax_form_seg_apps_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_seg_apps_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_seg_apps_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idapp.value = scAjaxGetKeyValue("idapp");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_seg_apps_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_seg_apps_mob_navigate_form_cb
  function do_ajax_form_seg_apps_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_seg_apps_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_seg_apps_mob_navigate_form_cb_after_alert
  function sc_hide_form_seg_apps_mob_form()
  {
  ...
  ajax_field_list[0] = "idapp";
  ajax_field_list[1] = "app_name";
  ajax_field_list[2] = "app_name2";
  ajax_field_list[3] = "app_link";
  ajax_field_list[4] = "idapptype";
  ajax_field_list[5] = "description";
  ajax_field_list[6] = "app_parentid";
  ajax_field_list[7] = "app_order";
  ajax_field_list[8] = "app_icon";
  ajax_field_list[9] = "app_badge";
  ajax_field_list[10] = "color";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idapp": {"label": "Idapp", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "app_name": {"label": "App Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "app_name2": {"label": "App Name 2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "app_link": {"label": "App Link", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idapptype": {"label": "Tipo Aplicación", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "app_parentid": {"label": "Modulo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "app_order": {"label": "App Order", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "app_icon": {"label": "App Icon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "app_badge": {"label": "App Badge", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "app_parentid": new Array(),
    "app_order": new Array(),
    "app_icon": new Array(),
    "app_badge": new Array(),
    "color": new Array()
  };
  ajax_field_mult["idapp"][1] = "idapp";
  ajax_field_mult["app_name"][1] = "app_name";
  ajax_field_mult["app_name2"][1] = "app_name2";
  ajax_field_mult["app_link"][1] = "app_link";
  ajax_field_mult["idapptype"][1] = "idapptype";
  ajax_field_mult["description"][1] = "description";
  ajax_field_mult["app_parentid"][1] = "app_parentid";
  ajax_field_mult["app_order"][1] = "app_order";
  ajax_field_mult["app_icon"][1] = "app_icon";
  ajax_field_mult["app_badge"][1] = "app_badge";
  ajax_field_mult["color"][1] = "color";

  var ajax_field_id = {
    "idapp": new Array("hidden_field_label_idapp", "hidden_field_data_idapp"),
    "app_name": new Array("hidden_field_label_app_name", "hidden_field_data_app_name"),
    "app_name2": new Array("hidden_field_label_app_name2", "hidden_field_data_app_name2"),
    "app_link": new Array("hidden_field_label_app_link", "hidden_field_data_app_link"),
    "idapptype": new Array("hidden_field_label_idapptype", "hidden_field_data_idapptype"),
    "description": new Array("hidden_field_label_description", "hidden_field_data_description"),
    "app_parentid": new Array("hidden_field_label_app_parentid", "hidden_field_data_app_parentid"),
    "app_order": new Array("hidden_field_label_app_order", "hidden_field_data_app_order"),
    "app_icon": new Array("hidden_field_label_app_icon", "hidden_field_data_app_icon"),
    "app_badge": new Array("hidden_field_label_app_badge", "hidden_field_data_app_badge"),
