  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_seg_apps" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idapp
  function do_ajax_form_seg_apps_validate_idapp()
  {
    var nomeCampo_idapp = "idapp";
    var var_idapp = scAjaxGetFieldHidden(nomeCampo_idapp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_idapp(var_idapp, var_script_case_init, do_ajax_form_seg_apps_validate_idapp_cb);
  } // do_ajax_form_seg_apps_validate_idapp

  function do_ajax_form_seg_apps_validate_idapp_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_idapp_cb

  // ---------- Validate app_name
  function do_ajax_form_seg_apps_validate_app_name()
  {
    var nomeCampo_app_name = "app_name";
    var var_app_name = scAjaxGetFieldText(nomeCampo_app_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_app_name(var_app_name, var_script_case_init, do_ajax_form_seg_apps_validate_app_name_cb);
  } // do_ajax_form_seg_apps_validate_app_name

  function do_ajax_form_seg_apps_validate_app_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_app_name_cb

  // ---------- Validate app_name2
  function do_ajax_form_seg_apps_validate_app_name2()
  {
    var nomeCampo_app_name2 = "app_name2";
    var var_app_name2 = scAjaxGetFieldText(nomeCampo_app_name2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_app_name2(var_app_name2, var_script_case_init, do_ajax_form_seg_apps_validate_app_name2_cb);
  } // do_ajax_form_seg_apps_validate_app_name2

  function do_ajax_form_seg_apps_validate_app_name2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_app_name2_cb

  // ---------- Validate app_link
  function do_ajax_form_seg_apps_validate_app_link()
  {
    var nomeCampo_app_link = "app_link";
    var var_app_link = scAjaxGetFieldText(nomeCampo_app_link);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_app_link(var_app_link, var_script_case_init, do_ajax_form_seg_apps_validate_app_link_cb);
  } // do_ajax_form_seg_apps_validate_app_link

  function do_ajax_form_seg_apps_validate_app_link_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_app_link_cb

  // ---------- Validate idapptype
  function do_ajax_form_seg_apps_validate_idapptype()
  {
    var nomeCampo_idapptype = "idapptype";
    var var_idapptype = scAjaxGetFieldSelect(nomeCampo_idapptype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_idapptype(var_idapptype, var_script_case_init, do_ajax_form_seg_apps_validate_idapptype_cb);
  } // do_ajax_form_seg_apps_validate_idapptype

  function do_ajax_form_seg_apps_validate_idapptype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_idapptype_cb

  // ---------- Validate description
  function do_ajax_form_seg_apps_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldText(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_description(var_description, var_script_case_init, do_ajax_form_seg_apps_validate_description_cb);
  } // do_ajax_form_seg_apps_validate_description

  function do_ajax_form_seg_apps_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_description_cb

  // ---------- Validate app_parentid
  function do_ajax_form_seg_apps_validate_app_parentid()
  {
    var nomeCampo_app_parentid = "app_parentid";
    var var_app_parentid = scAjaxGetFieldSelect(nomeCampo_app_parentid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_app_parentid(var_app_parentid, var_script_case_init, do_ajax_form_seg_apps_validate_app_parentid_cb);
  } // do_ajax_form_seg_apps_validate_app_parentid

  function do_ajax_form_seg_apps_validate_app_parentid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_app_parentid_cb

  // ---------- Validate app_order
  function do_ajax_form_seg_apps_validate_app_order()
  {
    var nomeCampo_app_order = "app_order";
    var var_app_order = scAjaxGetFieldText(nomeCampo_app_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_app_order(var_app_order, var_script_case_init, do_ajax_form_seg_apps_validate_app_order_cb);
  } // do_ajax_form_seg_apps_validate_app_order

  function do_ajax_form_seg_apps_validate_app_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_app_order_cb

  // ---------- Validate app_icon
  function do_ajax_form_seg_apps_validate_app_icon()
  {
    var nomeCampo_app_icon = "app_icon";
    var var_app_icon = scAjaxGetFieldText(nomeCampo_app_icon);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_app_icon(var_app_icon, var_script_case_init, do_ajax_form_seg_apps_validate_app_icon_cb);
  } // do_ajax_form_seg_apps_validate_app_icon

  function do_ajax_form_seg_apps_validate_app_icon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_app_icon_cb

  // ---------- Validate app_badge
  function do_ajax_form_seg_apps_validate_app_badge()
  {
    var nomeCampo_app_badge = "app_badge";
    var var_app_badge = scAjaxGetFieldText(nomeCampo_app_badge);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_app_badge(var_app_badge, var_script_case_init, do_ajax_form_seg_apps_validate_app_badge_cb);
  } // do_ajax_form_seg_apps_validate_app_badge

  function do_ajax_form_seg_apps_validate_app_badge_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_app_badge_cb

  // ---------- Validate color
  function do_ajax_form_seg_apps_validate_color()
  {
    var nomeCampo_color = "color";
    var var_color = scAjaxGetFieldRadio(nomeCampo_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_seg_apps_validate_color(var_color, var_script_case_init, do_ajax_form_seg_apps_validate_color_cb);
  } // do_ajax_form_seg_apps_validate_color

  function do_ajax_form_seg_apps_validate_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_seg_apps_validate_color_cb

  // ---------- Event onchange app_name
  function do_ajax_form_seg_apps_event_app_name_onchange()
  {
    var var_app_link = scAjaxGetFieldText("app_link");
    var var_app_name = scAjaxGetFieldText("app_name");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_seg_apps_event_app_name_onchange(var_app_link, var_app_name, var_script_case_init, do_ajax_form_seg_apps_event_app_name_onchange_cb);
  } // do_ajax_form_seg_apps_event_app_name_onchange

  function do_ajax_form_seg_apps_event_app_name_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "app_name";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_seg_apps_event_app_name_onchange_cb_after_alert);
  } // do_ajax_form_seg_apps_event_app_name_onchange_cb
  function do_ajax_form_seg_apps_event_app_name_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_seg_apps_event_app_name_onchange_cb_after_alert

  // ---------- Event onchange app_parentid
  function do_ajax_form_seg_apps_event_app_parentid_onchange()
  {
    var var_app_parentid = scAjaxGetFieldSelect("app_parentid");
    var var_app_order = scAjaxGetFieldText("app_order");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_seg_apps_event_app_parentid_onchange(var_app_parentid, var_app_order, var_script_case_init, do_ajax_form_seg_apps_event_app_parentid_onchange_cb);
  } // do_ajax_form_seg_apps_event_app_parentid_onchange

  function do_ajax_form_seg_apps_event_app_parentid_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "app_parentid";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_seg_apps_event_app_parentid_onchange_cb_after_alert);
  } // do_ajax_form_seg_apps_event_app_parentid_onchange_cb
  function do_ajax_form_seg_apps_event_app_parentid_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_seg_apps_event_app_parentid_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_seg_apps_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_seg_apps_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_seg_apps_submit_form(var_idapp, var_app_name, var_app_name2, var_app_link, var_idapptype, var_description, var_app_parentid, var_app_order, var_app_icon, var_app_badge, var_color, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_seg_apps_submit_form_cb);
  } // do_ajax_form_seg_apps_submit_form

  function do_ajax_form_seg_apps_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_seg_apps_submit_form_cb_after_alert);
  } // do_ajax_form_seg_apps_submit_form_cb
  function do_ajax_form_seg_apps_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_seg_apps_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_seg_apps_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_seg_apps_navigate_form, function() {});
    } else {
      perform_ajax_form_seg_apps_navigate_form();
    }
  }

  function perform_ajax_form_seg_apps_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_seg_apps_navigate_form(var_idapp, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_seg_apps_navigate_form_cb);
  } // do_ajax_form_seg_apps_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_seg_apps']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_seg_apps_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_seg_apps_navigate_form_cb_after_alert);
  } // do_ajax_form_seg_apps_navigate_form_cb
  function do_ajax_form_seg_apps_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_seg_apps_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_seg_apps_navigate_form_cb_after_alert
  function sc_hide_form_seg_apps_form()
  {
