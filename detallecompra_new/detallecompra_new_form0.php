<?php
class detallecompra_new_form extends detallecompra_new_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>detallecompra_new/detallecompra_new_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("detallecompra_new_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('detallecompra_new_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idpro_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idpro_" != sId ? sId.substr(6) : "";
   sc_detallecompra_new_idpro__onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("detallecompra_new_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['detallecompra_new'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['detallecompra_new'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['empty_filter'] = true;
       }
       echo "<tr><td>";
  }
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_detallecompra_new);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_detallecompra_new = $this->form_vert_detallecompra_new;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_detallecompra_new))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_detallecompra_new as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->colores_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['colores_'];
       $this->tallas_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['tallas_'];
       $this->sabor_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['sabor_'];
       $this->descr_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['descr_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->cod_barras_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['cod_barras_']; 
       ...
       $this->idpro_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['idpro_']; 
       $idpro_ = $this->idpro_; 
       $sStyleHidden_idpro_ = '';
       ...
       $this->ver_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['ver_']; 
       $ver_ = $this->ver_; 
       if (!isset($this->nmgp_cmp_hidden['ver_']))
       {
           $this->nmgp_cmp_hidden['ver_'] = 'off';
       ...
       $this->presentacion_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['presentacion_']; 
       ...
       $this->cantidad_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['cantidad_']; 
       ...
       $this->valorunit_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['valorunit_']; 
       ...
       $this->porc_desc_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['porc_desc_']; 
       ...
       $this->descuento_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['descuento_']; 
       ...
       $this->valorpar_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['valorpar_']; 
       ...
       $this->iva_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['iva_']; 
       $iva_ = $this->iva_; 
       $sStyleHidden_iva_ = '';
       ...
       $this->idbod_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['idbod_']; 
       $idbod_ = $this->idbod_; 
       $sStyleHidden_idbod_ = '';
       ...
       $this->tasadesc_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['tasadesc_']; 
       ...
       $this->devuelto_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['devuelto_']; 
       ...
       $this->vencimiento_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['vencimiento_']; 
       ...
       $this->lote_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['lote_']; 
       $lote_ = $this->lote_; 
       if (!isset($this->nmgp_cmp_hidden['lote_']))
       {
           $this->nmgp_cmp_hidden['lote_'] = 'off';
       ...
       $this->serial_codbarra_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['serial_codbarra_']; 
       ...
       $this->iddet_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['iddet_']; 
       $iddet_ = $this->iddet_; 
       if (!isset($this->nmgp_cmp_hidden['iddet_']))
       {
           $this->nmgp_cmp_hidden['iddet_'] = 'off';
       ...
       $this->idfaccom_ = $this->form_vert_detallecompra_new[$sc_seq_vert]['idfaccom_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_detallecompra_new_add_new_line(" . $sc_seq_vert . ")", "do_ajax_detallecompra_new_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_detallecompra_new_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_detallecompra_new_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_detallecompra_new_cancel_update(" . $sc_seq_vert . ")", "do_ajax_detallecompra_new_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idpro_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idpro_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idpro_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idpro_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idpro_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   if (isset($this->Ini->sc_lig_md5["form_productos"]) && $this->Ini->sc_lig_md5["form_productos"] == "S") {
       $Parms_Lig  = "SC_glo_par_regimen_emp*scinregimen_emp*scoutnm_evt_ret_edit*scindo_ajax_detallecompra_new_lkpedt_refresh_idpro_*scoutnmgp_url_saida*scin*scoutnm_evt_ret_row*scin" . $sc_seq_vert . "*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@detallecompra_new@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_regimen_emp*scinregimen_emp*scoutnm_evt_ret_edit*scindo_ajax_detallecompra_new_lkpedt_refresh_idpro_*scoutnmgp_url_saida*scin*scoutnm_evt_ret_row*scin" . $sc_seq_vert . "*scoutsc_redir_atualiz*scinok*scout";
   }
?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idbod_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idbod_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idbod_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idbod_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['Lookup_idbod_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php   
   ...
   { 
       ...
       $this->form_vert_detallecompra_new = $guarda_form_vert_detallecompra_new;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("detallecompra_new");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("detallecompra_new");
 parent.scAjaxDetailHeight("detallecompra_new", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['sc_modal'])
{
?>
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			...
			do_ajax_detallecompra_new_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
