...
$_SESSION['scriptcase']['grid_facturaven']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_idcli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['arr_total']['idcli'];
      }
      else
      {
          $this->array_total_idcli = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['arr_total']['idcli'] = $this->array_total_idcli;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_order']['idcli']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_order']['idcli'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_order']['idcli'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['idcli'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['idcli'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['idcli'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['idcli'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['idcli'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['idcli'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['idcli'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_idcli("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $quebra_idcli, $quebra_idcli_orig)
   {
      //----- Cliente
      if (!isset($this->array_total_idcli[$quebra_idcli_orig]))
      {
         $this->array_total_idcli[$quebra_idcli_orig][0] = 1;
         $this->array_total_idcli[$quebra_idcli_orig][1] = $sum_base_iva_19;
         $this->array_total_idcli[$quebra_idcli_orig][2] = $sum_valor_iva_19;
         $this->array_total_idcli[$quebra_idcli_orig][3] = $sum_base_iva_5;
         $this->array_total_idcli[$quebra_idcli_orig][4] = $sum_valor_iva_5;
         $this->array_total_idcli[$quebra_idcli_orig][5] = $sum_excento;
...
$_SESSION['scriptcase']['grid_facturaven']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->idcli, $this->idcli_orig);
            }
   }
//
