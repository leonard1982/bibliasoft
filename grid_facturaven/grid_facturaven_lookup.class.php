<?php
class grid_facturaven_lookup
{
//  
   function lookup_tipo_doc(&$conteudo , $idfacven, &$nm_array_retorno_lookup) 
   {
...
//  
   ...
   {   
      ...
      $nm_comando = "select documento from terceros where idtercero = $vendedor order by documento" ; 
      $conteudo = "" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
...
//  
   function lookup_direccion(&$conteudo , $idcli, &$nm_array_retorno_lookup) 
   {
      $nm_array_retorno_lookup = array();
      if (trim($idcli) === "")
      { 
...
//  
   function lookup_documento(&$conteudo , $idcli, &$nm_array_retorno_lookup) 
   {
      $nm_array_retorno_lookup = array();
      if (trim($idcli) === "")
      { 
...
//  
   function lookup_idcli_idcli(&$conteudo , $idcli) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $idcli; 
...
//  
   function lookup_prefijo_resolucion(&$conteudo , $resolucion) 
   {   
      static $save_conteudo = "" ; 
      static $save_conteudo1 = "" ; 
      $tst_cache = $resolucion; 
