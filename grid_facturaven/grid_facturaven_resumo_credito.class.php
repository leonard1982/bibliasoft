...
$_SESSION['scriptcase']['grid_facturaven']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_credito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['arr_total']['credito'];
      }
      else
      {
          $this->array_total_credito = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['arr_total']['credito'] = $this->array_total_credito;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_order']['credito']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_order']['credito'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_order']['credito'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['credito'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['credito'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['credito'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['credito'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['credito'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['credito'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven']['summarizing_fields_display']['credito'] as $i_sum => $d_sum)
           {
