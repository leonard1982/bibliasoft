<?php
//__NM__para extraer o comprimir zip, rar, gzip__NM__FUNCTION__NM__//
/**
 * Class Extractor
 *
    ...
    public static function extractRarArchive($archive, $destination){
        ...
        if($rar = RarArchive::open($archive)){
            ...
            if (is_writeable($destination . '/')) {
                ...
                $rar->close();
                $GLOBALS['status'] = array('success' => 'Archivo extraido con exito.');
                return true;
            }else{
                $GLOBALS['status'] = array('error' => 'no se puede escribir en el directorio.');
                return false;
            }
        }else{
            $GLOBALS['status'] = array('error' => 'No se puede leer el archivl.');
            return false;
        }
    }
