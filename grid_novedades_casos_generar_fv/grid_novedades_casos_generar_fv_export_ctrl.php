<?php
@session_start() ;
$_SESSION['scriptcase']['grid_novedades_casos_generar_fv']['sc_process_barr'] = true;
require_once('../grid_novedades_casos_generar_fv/index.php');
unset($_SESSION['scriptcase']['grid_novedades_casos_generar_fv']['sc_process_barr']);
$ExportCtrl = new grid_novedades_casos_generar_fv_export_control;
$ExportCtrl->Export_barr();

class grid_novedades_casos_generar_fv_export_control
{
