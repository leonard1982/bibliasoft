<?php
   include_once('grid_novedades_casos_generar_fv_session.php');
   session_start();
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_novedades_casos_generar_fv"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_novedades_casos_generar_fv"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_novedades_casos_generar_fv</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_novedades_casos_generar_fv']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_novedades_casos_generar_fv' || $achou)
          {
