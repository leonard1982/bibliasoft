...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_novedades_casos_generar_fv"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_novedades_casos_generar_fv"]);
   }
