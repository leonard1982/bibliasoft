<?php
   include_once('grid_cartera_cliente_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_cartera_cliente']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_cartera_cliente']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_cartera_cliente']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_cartera_cliente']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_cartera_cliente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cartera_cliente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_cartera_cliente_json.php");
   }
   ...
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["resolucion"] : "Prefijo";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["numfacven"] : "Factura";
   $tab_ger_campos['nremision'] = "on";
   $tab_def_campos['nremision'] = "nremision";
   $tab_labels["nremision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["nremision"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["nremision"] : "Remisión #";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["credito"] : "Crédito";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["fechaven"] : "Fecha Factura";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["fechavenc"] : "Fecha vencimiento";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["total"] : "Total";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["saldo"] : "Saldo";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>CARTERA DEL CLIENTE</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cartera_cliente_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cartera_cliente']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
