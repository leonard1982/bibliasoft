...
class grid_compras_SD_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'];
      }
      else
      {
          $this->array_total_idprov = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][5];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][2];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][6];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][3];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][4];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][8];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][7];
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['json_use_label'])
       {
          $Lab_idprov = "idprov";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['numfacom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['numfacom'] = "Número"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['fechacom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['fechacom'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['fechavenc'] = "Fecha venc."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['formapago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['formapago'] = "Formapago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['idprov']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['idprov'] = "Proveedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_ret']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_ret'] = "$ Retención"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_ica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_ica'] = "$ ReteICA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_retiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_retiva'] = "$ ReteIVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['a_pagar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['a_pagar'] = "Val a Pagar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['idfaccom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['idfaccom'] = "Compra No."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['subtotal'] = "Subtotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['asentada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['asentada'] = "Asentada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['retencion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['retencion'] = "Retención %"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['reteica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['reteica'] = "Reteica"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['reteiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['reteiva'] = "Reteiva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['devolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['devolucion'] = "Devolución"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['id_pedidocom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['id_pedidocom'] = "Pedido"; 
       }
       //-----
       $this->comp_field_nm = array(
           'idprov' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_order']['proveedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_order']['proveedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_order']['proveedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_display']['proveedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_display']['proveedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_display']['proveedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_display']['proveedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_display']['proveedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_display']['proveedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['summarizing_fields_display']['proveedor'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_tabular_label'];
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_config_graf_flash.php?nome_apl=grid_compras_SD&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_val_ret, $sum_val_ica, $sum_val_retiva, $sum_total, $sum_valoriva, $sum_a_pagar, $sum_subtotal, $quebra_idprov, $quebra_idprov_orig)
   {
      //----- Proveedor
      if (!isset($this->array_total_idprov[$quebra_idprov_orig]))
      {
         ...
         $this->array_total_idprov[$quebra_idprov_orig][5] = $sum_valoriva;
         $this->array_total_idprov[$quebra_idprov_orig][6] = $sum_a_pagar;
         $this->array_total_idprov[$quebra_idprov_orig][7] = $sum_subtotal;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'] as $campo_idprov => $dados_idprov)
      {
         ...
         $this->array_total_idprov[$campo_idprov][4] = $dados_idprov[5];
         $this->array_total_idprov[$campo_idprov][8] = $dados_idprov[6];
         $this->array_total_idprov[$campo_idprov][7] = $dados_idprov[7];
...
$_SESSION['scriptcase']['grid_compras_SD']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->val_ret, $this->val_ica, $this->val_retiva, $this->total, $this->valoriva, $this->a_pagar, $this->subtotal, $this->idprov, $this->idprov_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_compras_SD']['contr_erro'] = 'off';
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'] = $this->array_total_idprov;
      }
   }
