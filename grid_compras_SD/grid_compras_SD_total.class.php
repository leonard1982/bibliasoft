...
class grid_compras_SD_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_compras_SD']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_compras_SD']['campos_busca']))
      { 
