...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Total";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['contr_label_graf']['total']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['contr_label_graf']['total']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['contr_label_graf']['total'];
      }
   }
