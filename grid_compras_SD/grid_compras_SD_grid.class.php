...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   clearstatcache();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "proveedor" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "total" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "_NM_SC_")
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
       { 
          include_once($this->Ini->path_embutida . "grid_compras_SD/" . $this->Ini->Apl_resumo); 
       } 
       else 
       { 
          include_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
       } 
       $this->Res         = new grid_compras_SD_resumo();
       $this->Res->Db     = $this->Db;
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['charts_html'] = '';
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
   { 
   ...
   { 
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pdf_res'])
       {
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       if (!$this->Proc_link_res && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != 'pdf' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != 'print')
       { 
       $nm_saida->saida("     <TR>\r\n");
       $nm_saida->saida("      <TD class=\"scGridRefinedSearchPadding\" valign='top'>\r\n");
           $this->html_interativ_search();
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ajax_nav'])
           { 
               $tb_disp = (!empty($this->nm_grid_sem_reg) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_int_search']) ? 'none' : '';
               $this->Ini->Arr_result['setDisplay'][] = array('field' => 'TB_Interativ_Search', 'value' => $tb_disp);
           } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_int_search'] = false;
       $nm_saida->saida("      </TD>\r\n");
       $nm_saida->saida("      <TD class=\"scGridRefinedSearchMolduraResult\" valign='top'>\r\n");
       $nm_saida->saida("       <table width='100%' cellspacing=0 cellpadding=0>\r\n");
       } 
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_compras_SD'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
           $this->nmgp_embbed_placeholder_top();
       } 
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['save_grid']))
       {
           $this->refresh_interativ_search();
       }
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               $this->Res->monta_resumo(true);
               require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
               $this->Graf  = new grid_compras_SD_grafico();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['graf_pdf'] == "S" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
       { 
           if (isset($_GET['flash_graf']) && 'pdf' == $_GET['flash_graf'] && $Gera_graf)
           {
               $this->grafico_pdf_flash();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "grid";
           } 
           elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" && $Gera_graf)
           { 
               $this->grafico_pdf();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "grid";
           } 
       ...
       { 
           ...
           if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf")
           { 
               $flag_apaga_pdf_log = FALSE;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "igual";
           } 
           $this->nm_fim_grid($flag_apaga_pdf_log);
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_pdf']['all_label'] : "N";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['doc_word'])
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['force_toolbar']);
   } 
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_compras_SD", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq_ant'];  
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_compras_SD'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_compras_SD'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_compras_SD/grid_compras_SD_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_compras_SD_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] = 20;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "proveedor") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_select'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_select']['idfaccom'] = 'DESC'; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_select_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_select']; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "total") 
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "proveedor") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_quebra']['idprov']["idprov"] = "asc"; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "total") 
   {
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_quebra'] = array(); 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_quebra']['total']["total"] = "asc"; 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "_NM_SC_") 
   {
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['prim_cons'] = false;  
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao']       = "igual" ; 
...
// 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "proveedor" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "total" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_") 
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'] == "all") 
       { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "total")
       { 
           $this->totaliza_php_total() ; 
       } 
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "_NM_SC_")
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "proveedor" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "total" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_") 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['contr_array_resumo']))  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['contr_array_resumo'] = "NAO";
           } 
       }
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][1] ;  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       $this->numfacom = $this->rs_grid->fields[0] ;  
       $this->fechacom = $this->rs_grid->fields[1] ;  
       $this->fechavenc = $this->rs_grid->fields[2] ;  
       $this->formapago = $this->rs_grid->fields[3] ;  
       $this->pagada = $this->rs_grid->fields[4] ;  
       $this->idprov = $this->rs_grid->fields[5] ;  
       ...
       $this->valoriva = $this->rs_grid->fields[7] ;  
       ...
       $this->retencion = $this->rs_grid->fields[13] ;  
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>Lista Facturas o entradas compras :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_compras_SD_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_compras_SD_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_compras_SD_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_compras_SD_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_compras_SD_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Lista Facturas o entradas compras</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_compras_SD_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_compras_SD_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_compras_SD_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid']) . ";\r\n");
           }
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
     ...
     if (!$_SESSION['scriptcase']['proc_mobile']) { 
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"grid_compras_SD_save_grid.php\",\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_compras_SD_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
       {
 ...
 { 
       ...
       elseif ($this->NM_opcao == "print" || $this->Print_All)
       {
           ...
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_compras_SD_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_compras_SD_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_compras_SD_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
           $nm_saida->saida("  <body class=\"" . $this->css_scGridPage . "\" " . $str_iframe_body . " style=\"" . $remove_margin . $vertical_center . $css_body . "\">\r\n");
       }
       $nm_saida->saida("  " . $this->Ini->Ajax_result_set . "\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !$this->Print_All)
       { 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['doc_word'])
       { 
   ...
   else
   {
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print") 
       { 
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD  colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_A_grid_compras_SD\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_A_grid_compras_SD\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
           $nm_saida->saida("    <TR>\r\n");
           $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
           $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_E_grid_compras_SD\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_E_grid_compras_SD\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    <td style=\"padding: 0px;  vertical-align: top;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\"><tr>\r\n");
           $nm_saida->saida("    <TD colspan=3 style=\"padding: 0px; border-width: 0px; vertical-align: top;\" width=1>\r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_AL_grid_compras_SD\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_AL_grid_compras_SD\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
           $nm_saida->saida("    </TD>\r\n");
           $nm_saida->saida("    </TR>\r\n");
        } 
   }  
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_compras_SD']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_compras_SD']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_compras_SD']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_compras_SD']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida']) ? "grid_compras_SD_" : "";
   $this->css_sep = " ";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
       $_SESSION['scriptcase']['saida_html'] = "";
   } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sv_dt_head']['fix'] = $nm_data_fixa;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")
   { 
       $nm_saida->saida("  <TD class=\"" . $this->css_scGridTabelaTd . "\" colspan=3 style=\"vertical-align: top\">\r\n");
   } 
   else 
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>Lista Facturas o entradas compras</span></td>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_compras_SD__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_compras_SD-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_devolucion_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_devolucion_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_devolucion_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_compras_SD_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_numfacom()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp'] == 'numfacom')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] == "desc")
          {
 ...
 function NM_label_fechacom()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp'] == 'fechacom')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_fechavenc()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp'] == 'fechavenc')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_formapago()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_formapago_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_formapago_label'] . "\" NOWRAP WIDTH=\"1px\">" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_pagada()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_pagada_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_pagada_label'] . "\" NOWRAP WIDTH=\"1px\">" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_idprov()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp'] == 'idprov')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_total()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_total_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_total_label'] . "\" NOWRAP WIDTH=\"1px\">" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_valoriva()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_valoriva_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_valoriva_label'] . "\" NOWRAP WIDTH=\"1px\">" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 ...
 function NM_label_observaciones()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_observaciones_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_observaciones_label'] . "\" NOWRAP WIDTH=\"5px\">" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_idfaccom()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_idfaccom_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_idfaccom_label'] . "\" NOWRAP>\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp'] == 'idfaccom')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_subtotal()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_cmp'] == 'subtotal')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_asentada()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_asentada_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_asentada_label'] . "\" NOWRAP>" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_saldo()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_saldo_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_saldo_label'] . "\" NOWRAP>" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_retencion()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_retencion_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_retencion_label'] . "\" NOWRAP>" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_reteica()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_reteica_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_reteica_label'] . "\" NOWRAP>" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
 function NM_label_reteiva()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_reteiva_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_reteiva_label'] . "\" NOWRAP>" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['numfacom'])) ? $this->New_label['numfacom'] : "Número"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['numfacom'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fechacom'])) ? $this->New_label['fechacom'] : "Fecha"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['fechacom'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fechavenc'])) ? $this->New_label['fechavenc'] : "Fecha venc."; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['fechavenc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['formapago'])) ? $this->New_label['formapago'] : "Formapago"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['formapago'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['pagada'])) ? $this->New_label['pagada'] : "Pagada"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['pagada'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['idprov'])) ? $this->New_label['idprov'] : "Proveedor"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['idprov'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['val_ret'])) ? $this->New_label['val_ret'] : "$ Retención"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_ret'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['val_ica'])) ? $this->New_label['val_ica'] : "$ ReteICA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_ica'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['val_retiva'])) ? $this->New_label['val_retiva'] : "$ ReteIVA"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['val_retiva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['total'])) ? $this->New_label['total'] : "Total"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['valoriva'])) ? $this->New_label['valoriva'] : "Valoriva"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['valoriva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['a_pagar'])) ? $this->New_label['a_pagar'] : "Val a Pagar"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['a_pagar'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['observaciones'])) ? $this->New_label['observaciones'] : "Observaciones"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['observaciones'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['idfaccom'])) ? $this->New_label['idfaccom'] : "Compra No."; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['idfaccom'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['subtotal'])) ? $this->New_label['subtotal'] : "Subtotal"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['subtotal'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['asentada'])) ? $this->New_label['asentada'] : "Asentada"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['asentada'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['saldo'])) ? $this->New_label['saldo'] : "Saldo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['saldo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['retencion'])) ? $this->New_label['retencion'] : "Retención %"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['retencion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['reteica'])) ? $this->New_label['reteica'] : "Reteica"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['reteica'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['reteiva'])) ? $this->New_label['reteiva'] : "Reteiva"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['reteiva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['devolucion'])) ? $this->New_label['devolucion'] : "Devolución"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['labels']['devolucion'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_SD']['lig_edit'];
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ajax_nav'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_refresh'])
   {
       $this->refresh_interativ_search();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_refresh'] = false;
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_compras_SD#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['cab_embutida'] != "S")
               {
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_compras_SD\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_compras_SD\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           ...
           { 
               ...
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_A_grid_compras_SD', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_D_grid_compras_SD', 'value' => 'NM_Blank_Page.htm');
               $this->Ini->Arr_result['setSrc'][] = array('field' => 'nmsc_iframe_liga_E_grid_compras_SD', 'value' => 'NM_Blank_Page.htm');
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  </td></tr>\r\n");
           if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" &&
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_DL_grid_compras_SD\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_DL_grid_compras_SD\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("</TD>\r\n");
               $nm_saida->saida("    <TD style=\"padding: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_D_grid_compras_SD\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_D_grid_compras_SD\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
               $nm_saida->saida("    </TD>\r\n");
               $nm_saida->saida("    </TR>\r\n");
           } 
       $nm_saida->saida("</TABLE>\r\n");
...
else
{
      ...
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_EL_grid_compras_SD\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_EL_grid_compras_SD\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
       ...
       $nm_id_aplicacao = " id=\"apl_grid_compras_SD#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-740a2779\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Page_break_PDF'] = array();
       }
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "proveedor") 
   {
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_compras_SD_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->Lookup->lookup_asentada($this->look_asentada); 
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final'] + 1; 
          $this->SC_sep_quebra = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['rows_emb']++;
          if ($this->idprov !== $this->idprov_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "proveedor") 
          {  
              ...
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby']]['idprov'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Page_break_PDF']['idprov'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->idprov_Old = $this->idprov ; 
          ...
          if ($this->total !== $this->total_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "total") 
          {  
              ...
              if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby']]['total'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Page_break_PDF']['total'] == "S")
              {
                  $this->nm_quebra_pagina("pagina"); 
              }
              $this->total_Old = $this->total ; 
...
$_SESSION['scriptcase']['grid_compras_SD']['contr_erro'] = 'off';
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
              elseif (($nm_houve_quebra == "S" || ($this->nm_inicio_pag == 0)) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
              { 
                 if ($this->pdf_all_label == "S" && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "_NM_SC_")) 
                 { } 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_devolucion_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"display:" . $FieldDisp . ";" . $this->Css_Cmp['css_devolucion_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida(" $Cod_Btn</TD>\r\n");
 } 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['mostra_edit'] != "N"){ 
              ...
              if (isset($this->Ini->sc_lig_md5["fac_compras"]) && $this->Ini->sc_lig_md5["fac_compras"] == "S")
              {
                  ...
                  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['under_dashboard'] && isset($linkTarget))
                  {
                      if ('' != $Parms_Edt && '?@?' != substr($Parms_Edt, -3) && '*scout' != substr($Parms_Edt, -6))
                      {
                          $Parms_Edt .= '*scout';
                      }
                      $Parms_Edt .= 'under_dashboard*scin1*scoutdashboard_app*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['dashboard_app'] . '*scoutown_widget*scin' . $linkTarget . '*scoutparent_widget*scin' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['own_widget'] . '*scoutcompact_mode*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['compact_mode'] ? '1' : '0') . '*scoutremove_margin*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['remove_margin'] ? '1' : '0') . '*scoutremove_border*scin' . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['remove_border'] ? '1' : '0');
                  }
                  $Md5_Edt    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_compras_SD@SC_par@" . md5($Parms_Edt);
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Lig_Md5'][md5($Parms_Edt)] = $Parms_Edt;
              }
              else
              {
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['mostra_edit'] == "N"){ 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   if ($this->rs_grid->EOF) 
   { 
       if (isset($this->idprov_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "proveedor")
       {
           $this->quebra_idprov_proveedor_top() ; 
       }
       if (isset($this->idprov_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "proveedor")
       ...
       if (isset($this->total_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "total")
       {
           $this->quebra_total_total_top() ; 
       }
       if (isset($this->total_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "total")
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] . "_bot";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && empty($this->nm_grid_sem_reg) && 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print") 
   { 
       $nm_saida->saida("</TABLE></TD>\r\n");
       $nm_saida->saida("<TD style=\"padding: 0px; border-width: 0px;\" valign=\"top\" width=1>\r\n");
 ...
 function NM_grid_numfacom()
 {
      ...
      if (!isset($this->NM_cmp_hidden['numfacom']) || $this->NM_cmp_hidden['numfacom'] != "off") { 
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && !empty($conteudo)) 
          { 
 ...
 if (!$this->Ini->Proc_print && !$this->Ini->SC_Link_View && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && $_SESSION['scriptcase']['contr_link_emb'] != "pdf" && $conteudo != "&nbsp;"){ $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Ind_lig_mult']++;
       $linkTarget = isset($this->Ini->sc_lig_target['C_@scinf_numfacom_@scinf_blank_compras']) ? $this->Ini->sc_lig_target['C_@scinf_numfacom_@scinf_blank_compras'] : (isset($this->Ini->sc_lig_target['C_@scinf_numfacom']) ? $this->Ini->sc_lig_target['C_@scinf_numfacom'] : null);
       if (isset($this->Ini->sc_lig_md5["blank_compras"]) && $this->Ini->sc_lig_md5["blank_compras"] == "S") {
           $Parms_Lig = "nmgp_lig_edit_lapis?#?S?@?gpidcompra?#?" . str_replace("'", "@aspass@", $this->idfaccom) . "?@?";
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['under_dashboard'] && isset($linkTarget))
           {
               if ('' != $Parms_Lig)
               {
           ...
           $Md5_Lig    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_compras_SD@SC_par@" . md5($Parms_Lig);
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
       } else {
           $Md5_Lig = "nmgp_lig_edit_lapis?#?S?@?gpidcompra?#?" . str_replace("'", "@aspass@", $this->idfaccom) . "?@?";
       }
   $nm_saida->saida("<a  id=\"id_sc_field_numfacom_" . $this->SC_seq_page . "\" href=\"javascript:nm_gp_submit5('" . $this->Ini->link_blank_compras_blk . "', '$this->nm_location', '$Md5_Lig', '" . (isset($linkTarget) ? $linkTarget : '_blank') . "', '', '0', '0', '', 'blank_compras', '" . $this->SC_ancora . "')\" onMouseover=\"nm_mostra_hint(this, event, '')\" onMouseOut=\"nm_apaga_hint()\" class=\"" . $this->Ini->cor_link_dados . $this->css_sep . $this->css_numfacom_grid_line . "\" style=\"" . $this->Css_Cmp['css_numfacom_grid_line'] . "\">" . $conteudo . "</a>\r\n");
} else {
 ...
 function NM_grid_pagada()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_pagada_grid_line . "\"  style=\"" . $this->Css_Cmp['css_pagada_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"  WIDTH=\"1px\"  HEIGHT=\"0px\"><span id=\"id_sc_field_pagada_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_idprov()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_idprov_grid_line . "\"  style=\"" . $this->Css_Cmp['css_idprov_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"  WIDTH=\"5px\"  HEIGHT=\"0px\"><span id=\"id_sc_field_idprov_" . $this->SC_seq_page . "\">\r\n");
if (strlen($conteudo) > 20 && $conteudo != "&nbsp;") {
   $nm_saida->saida("" . sc_substr(strip_tags($conteudo), 0, 20) . nmButtonOutput($this->arr_buttons, "bqtd_bytes", "", "", "bidprov", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "" . str_replace('"', '&quot;', strip_tags($conteudo)) . "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "") . "\r\n");
} else {
 ...
 function NM_grid_valoriva()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_valoriva_grid_line . "\"  style=\"" . $this->Css_Cmp['css_valoriva_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  WIDTH=\"1px\"  HEIGHT=\"0px\"><span id=\"id_sc_field_valoriva_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
...
if (strlen($conteudo) > 15 && $conteudo != "&nbsp;") {
 ...
 function NM_grid_idfaccom()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_idfaccom_grid_line . "\"  style=\"" . $this->Css_Cmp['css_idfaccom_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\"><span id=\"id_sc_field_idfaccom_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_devolucion()
 {
      ...
      if (!isset($this->NM_cmp_hidden['devolucion']) || $this->NM_cmp_hidden['devolucion'] != "off") { 
          ...
          { 
              ...
              elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['doc_word'] || $this->Img_embbed || $this->Ini->sc_export_ajax_img) 
              { 
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_idprov_proveedor($idprov) 
 {
   ...
   $tot_idprov[0] = $idprov;
   $tot_idprov[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'][$idprov][0];
   $tot_idprov[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'][$idprov][1];
   $tot_idprov[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'][$idprov][2];
   $tot_idprov[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'][$idprov][3];
   $tot_idprov[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'][$idprov][4];
   $tot_idprov[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'][$idprov][5];
   $tot_idprov[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'][$idprov][6];
   $tot_idprov[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'][$idprov][7];
   $conteudo = $tot_idprov[0] ;  
   $this->count_idprov = $tot_idprov[1];
   $this->sum_idprov_val_ret = $tot_idprov[2];
   $this->sum_idprov_val_ica = $tot_idprov[3];
   $this->sum_idprov_val_retiva = $tot_idprov[4];
   $this->sum_idprov_total = $tot_idprov[5];
   $this->sum_idprov_valoriva = $tot_idprov[6];
   $this->sum_idprov_a_pagar = $tot_idprov[7];
   $this->sum_idprov_subtotal = $tot_idprov[8];
 ...
 function quebra_total_total($total) 
 {
   ...
   $tot_total[0] = $total;
   $tot_total[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'][$total][0];
   $tot_total[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'][$total][1];
   $tot_total[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'][$total][2];
   $tot_total[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'][$total][3];
   $tot_total[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'][$total][4];
   $tot_total[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'][$total][5];
   $tot_total[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'][$total][6];
   $tot_total[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'][$total][7];
   $conteudo = $tot_total[0] ;  
   $this->count_total = $tot_total[1];
   $this->sum_total_val_ret = $tot_total[2];
   $this->sum_total_val_ica = $tot_total[3];
   $this->sum_total_val_retiva = $tot_total[4];
   $this->sum_total_total = $tot_total[5];
   $this->sum_total_valoriva = $tot_total[6];
   $this->sum_total_a_pagar = $tot_total[7];
   $this->sum_total_subtotal = $tot_total[8];
 ...
 { global
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_compras_SD_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_compras_SD_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_compras_SD_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_compras_SD, 'grid_compras_SD'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_compras_SD_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_compras_SD_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_compras_SD_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_compras_SD, 'grid_compras_SD'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_compras_SD'][$this->NM_cont_body]['1'] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_compras_SD_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ind_tree'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_compras_SD'][$this->NM_cont_body]['1'] = 'bot';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_compras_SD_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 { global 
   ...
   $nm_sub_totais = "<table style=\"padding: 0px; spacing: 2px; border-width: 0px;\">" . $nm_sub_totais . "</tr></table>";
       ...
       $nm_saida->saida("    </TR>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_geral_proveedor_bot() 
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" && !$this->Print_All)
   {
      $nm_nivel_book_pdf = "<div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" .  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][0] . "</H1></div>";
   }
   $tit_lin_sumariza      =  $nm_nivel_book_pdf . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][1] . ")";
   $tit_lin_sumariza_orig =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][1] . ")";
       $nm_saida->saida("    <TR class=\"" . $this->css_scGridTotal . "\">\r\n");
   $nm_sub_totais = "";
   $nm_saida->saida("    <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\">&nbsp;</TD>\r\n");
   $this->NM_calc_span();
   $colspan = $this->NM_colspan - 1;
   $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][8]; 
   nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
   ...
   $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][2]; 
   nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "1", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
   ...
   $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][3]; 
   nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "1", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
   ...
   $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][6]; 
   nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
   ...
   $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][4]; 
   nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "1", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
   ...
   $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][5]; 
   nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "2", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
   ...
   $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][7]; 
   nmgp_Form_Num_Val($conteudo, $_SESSION['scriptcase']['reg_conf']['grup_val'], $_SESSION['scriptcase']['reg_conf']['dec_val'], "0", "S", "1", $_SESSION['scriptcase']['reg_conf']['monet_simb'], "V:" . $_SESSION['scriptcase']['reg_conf']['monet_f_pos'] . ":" . $_SESSION['scriptcase']['reg_conf']['monet_f_neg'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit']) ; 
 ...
 function quebra_geral__NM_SC__bot() 
 {
   ...
   function totaliza_php_proveedor()
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['contr_total_geral'] == "OK")
      {
          return;
      }
      //----- 
...
$_SESSION['scriptcase']['grid_compras_SD']['contr_erro'] = 'off';
         ...
         $this->Res->adiciona_registro(NM_encode_input(sc_strip_script($this->val_ret)), NM_encode_input(sc_strip_script($this->val_ica)), NM_encode_input(sc_strip_script($this->val_retiva)), NM_encode_input(sc_strip_script($this->total)), NM_encode_input(sc_strip_script($this->valoriva)), NM_encode_input(sc_strip_script($this->a_pagar)), NM_encode_input(sc_strip_script($this->subtotal)), sc_strip_script($this->GB_idprov), sc_strip_script($idprov_orig));
         $this->rs_grid->MoveNext();
      }
      $this->Res->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][2] = $this->Res->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][3] = $this->Res->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][4] = $this->Res->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][5] = $this->Res->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][6] = $this->Res->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][7] = $this->Res->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][8] = $this->Res->array_total_geral[7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][0] = "Total compras";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['tot_geral'][1] = $this->Res->array_total_geral[0];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "proveedor")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['idprov'] = $this->Res->array_total_idprov;
      }
   }
...
$_SESSION['scriptcase']['grid_compras_SD']['contr_erro'] = 'off';
         ...
         $this->Res->adiciona_registro(NM_encode_input(sc_strip_script($this->val_ret)), NM_encode_input(sc_strip_script($this->val_ica)), NM_encode_input(sc_strip_script($this->val_retiva)), NM_encode_input(sc_strip_script($this->total)), NM_encode_input(sc_strip_script($this->valoriva)), NM_encode_input(sc_strip_script($this->a_pagar)), NM_encode_input(sc_strip_script($this->subtotal)), NM_encode_input(sc_strip_script($this->GB_total)), NM_encode_input(sc_strip_script($total_orig)));
         $this->rs_grid->MoveNext();
      }
      $this->Res->finaliza_arrays();
      $this->rs_grid->Close();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] == "total")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['arr_total']['total'] = $this->Res->array_total_total;
      }
   }
...
$_SESSION['scriptcase']['grid_compras_SD']['contr_erro'] = 'off';
         ...
         $this->GB_total = $this->total;
         nmgp_Form_Num_Val($this->GB_total, "", "", "", "", "", "", "V::", "") ; 
         $this->Res->adiciona_registro(NM_encode_input(sc_strip_script($this->val_ret)), NM_encode_input(sc_strip_script($this->val_ica)), NM_encode_input(sc_strip_script($this->val_retiva)), NM_encode_input(sc_strip_script($this->total)), NM_encode_input(sc_strip_script($this->valoriva)), NM_encode_input(sc_strip_script($this->a_pagar)), NM_encode_input(sc_strip_script($this->subtotal)));
         $this->rs_grid->MoveNext();
      }
      $this->Res->finaliza_arrays();
      $this->rs_grid->Close();
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ajax_nav'])
          {
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
          {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['filter'] == "on"  && !$this->grid_emb_form)
      {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['SC_Ind_Groupby'] != "_NM_SC_")
        {
          if ($this->nmgp_botoes['summary'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_resumo'])) {
      ...
      if ($this->nmgp_botoes['gridsave'] == "on" && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          if (is_file("grid_compras_SD_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_compras_SD_help.txt"); 
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] == 50) ? " selected" : "";
              $nm_saida->saida("           <option value=\"50\" " . $obj_sel . ">50</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] == 100) ? " selected" : "";
              $nm_saida->saida("           <option value=\"100\" " . $obj_sel . ">100</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] == 500) ? " selected" : "";
              $nm_saida->saida("           <option value=\"500\" " . $obj_sel . ">500</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] == all) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['nav']))
          {
   ...
   function nmgp_embbed_placeholder_bot()
   {
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $str_value = preg_replace('/'. $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ] .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ]))) == 0)
                    {
                        $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campos_busca'][ $field ]));
                    }
                }
            }
        }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('numfacom', 'idprov', 'pagada', 'observaciones', 'id_pedidocom'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $str_value = preg_replace('/'. $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][2] .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
   ...
   {
       global $nm_saida;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_sql']   = array();
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search'] = array();
       }
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechacom'] = (isset($this->New_label['fechacom'])) ? $this->New_label['fechacom'] : 'Fecha';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_sql']['fechacom']   = "fechacom";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechavenc'] = (isset($this->New_label['fechavenc'])) ? $this->New_label['fechavenc'] : 'Fecha venc.';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_sql']['fechavenc']   = "fechavenc";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['idprov'] = (isset($this->New_label['idprov'])) ? $this->New_label['idprov'] : 'Proveedor';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_sql']['idprov']   = "idprov";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['total'] = (isset($this->New_label['total'])) ? $this->New_label['total'] : 'Total';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_sql']['total']   = "total";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['pagada'] = (isset($this->New_label['pagada'])) ? $this->New_label['pagada'] : 'Pagada';
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_sql']['pagada']   = "pagada";
       ...
       $lin_obj = $this->interativ_search_fechacom();
       $nm_saida->saida("" . $lin_obj . "\r\n");
       $lin_obj = $this->interativ_search_fechavenc();
       $nm_saida->saida("" . $lin_obj . "\r\n");
       $lin_obj = $this->interativ_search_idprov();
       $nm_saida->saida("" . $lin_obj . "\r\n");
   ...
   function interativ_search_fechacom()
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["fechacom"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["fechacom"])) ? "none" : "";
       ...
       $lin_obj .= "         <tr>";
       $lin_obj .= "          <td nowrap>";
       $lin_obj .= "              <span id=\"id_expand_fechacom\" style=\"display: " .  $exp_disp . ";\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer; padding:0px 2px 0px 0px;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_show . "\" BORDER=\"0\" onclick=\"nm_toggle_int_search('fechacom')\"/>   </span>";
       $lin_obj .= "              <span id=\"id_retract_fechacom\" style=\"display: none;\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_hide . "\" BORDER=\"0\" onclick=\"nm_toggle_int_search('fechacom')\"/>   </span>";
       $lin_obj .= "              <INPUT class='" . $this->css_scAppDivToolbarInput . "' style=\"display: none;\" type=\"checkbox\" id=\"id_int_search_fechacom_ck\" name=\"int_search_fechacom_ck[]\" value=\"\" checked onclick=\"nm_change_mult_int_search('fechacom');\">";
       $lin_obj .= "              <span style=\"cursor: pointer;\" onclick=\"nm_toggle_int_search('fechacom')\">";
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechacom'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       $lin_obj .= "              <span id=\"id_clear_fechacom\" style=\"display: " .  $cle_disp . ";\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_close . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear','','','fechacom', '', 'fechacom', '')\"/>   </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "         </tr>";
       $lin_obj .= "        </table>";
       $lin_obj .= "     </td></tr>";
       ...
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq']))
       {
           $tmp_where = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_pesq'];
       }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_resumo'])) 
   { 
       if (empty($tmp_where)) 
       { 
           $tmp_where = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_resumo']; 
       } 
       else
       { 
           $tmp_where .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['where_resumo'] . ")"; 
       } 
   } 
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['fechacom'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           if($qtd_see_more > 0 && $qtd_result_see_more >= $qtd_see_more && !$bol_open_see_more)
           {
               ...
               $lin_obj  .= "    <a href=\"javascript:toggleSeeMore('fechacom');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
               $lin_obj  .= "   </div>";
           ...
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['fechacom']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechacom']) . "','fechacom','id_int_search_fechacom','fechacom', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechacom']) . "','fechacom','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'fechacom', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechacom']) . "','fechacom','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'fechacom', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
           ...
           $lin_mult .= "    <INPUT class='" . $this->css_scAppDivToolbarInput . "' type=\"checkbox\" id=\"id_int_search_fechacom\" name=\"int_search_fechacom[]\" value=\"" . NM_encode_input($dados . "##@@" . $formatado) . "\" checked><span class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</span>";
           if(!empty($veja_mais_link))
           {
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       {
           $disp_chk = "none";
           $lin_obj  .= "   <tr><td><div class='scGridRefinedSearchMolduraResult' id=\"id_tab_fechacom_chk\" style=\"display: " . $disp_chk . ";\">";
           $lin_obj  .= $lin_mult;
           $lin_obj  .= "   </div></td></tr>";
       }
       if (count($result) > 1)
       {
           ...
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bmultiselect", "nm_mult_int_search('fechacom');", "nm_mult_int_search('fechacom');", "mult_int_search_fechacom", "", "", "display: $disp_link", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "multiselect", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechacom']) . "','fechacom','id_int_search_fechacom','fechacom', '');", "nm_proc_int_search('chbx', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechacom']) . "','fechacom','id_int_search_fechacom','fechacom', '');", "app_int_search_fechacom", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["fechavenc"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["fechavenc"])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechavenc'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
   ...
   { 
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['fechavenc'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           $lin_obj  .= "  <table cellspacing=0 cellpadding=0>";
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['fechavenc']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechavenc']) . "','fechavenc','id_int_search_fechavenc','fechavenc', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechavenc']) . "','fechavenc','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'fechavenc', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechavenc']) . "','fechavenc','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'fechavenc', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       if (count($result) > 1)
       {
           ...
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechavenc']) . "','fechavenc','id_int_search_fechavenc','fechavenc', '');", "nm_proc_int_search('chbx', 'dt','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['fechavenc']) . "','fechavenc','id_int_search_fechavenc','fechavenc', '');", "app_int_search_fechavenc", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   function interativ_search_idprov()
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["idprov"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["idprov"])) ? "none" : "";
       ...
       $lin_obj .= "         <tr>";
       $lin_obj .= "          <td nowrap>";
       $lin_obj .= "              <span id=\"id_expand_idprov\" style=\"display: " .  $exp_disp . ";\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer; padding:0px 2px 0px 0px;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_show . "\" BORDER=\"0\" onclick=\"nm_toggle_int_search('idprov')\"/>   </span>";
       $lin_obj .= "              <span id=\"id_retract_idprov\" style=\"display: none;\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_hide . "\" BORDER=\"0\" onclick=\"nm_toggle_int_search('idprov')\"/>   </span>";
       $lin_obj .= "              <INPUT class='" . $this->css_scAppDivToolbarInput . "' style=\"display: none;\" type=\"checkbox\" id=\"id_int_search_idprov_ck\" name=\"int_search_idprov_ck[]\" value=\"\" checked onclick=\"nm_change_mult_int_search('idprov');\">";
       $lin_obj .= "              <span style=\"cursor: pointer;\" onclick=\"nm_toggle_int_search('idprov')\">";
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['idprov'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
       $lin_obj .= "              <span id=\"id_clear_idprov\" style=\"display: " .  $cle_disp . ";\">&nbsp;&nbsp;<IMG align='absmiddle' style=\"cursor: pointer;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_close . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('clear','','','idprov', '', 'idprov', '')\"/>   </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "         </tr>";
       $lin_obj .= "        </table>";
       $lin_obj .= "     </td></tr>";
   ...
   { 
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['idprov'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           if($qtd_see_more > 0 && $qtd_result_see_more >= $qtd_see_more && !$bol_open_see_more)
           {
               ...
               $lin_obj  .= "    <a href=\"javascript:toggleSeeMore('idprov');\" class='scGridRefinedSearchVejaMaisFont'>". $this->Ini->Nm_lang['lang_othr_refinedsearch_see_more'] ."</a>";
               $lin_obj  .= "   </div>";
           ...
           $lin_obj  .= "  <table cellspacing=0 cellpadding=0>";
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['idprov']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['idprov']) . "','idprov','id_int_search_idprov','idprov', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['idprov']) . "','idprov','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'idprov', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['idprov']) . "','idprov','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'idprov', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
           $lin_obj  .= "   </div>";
           $lin_mult .= "   <div><label class='scGridRefinedSearchCampo' style='display: block;'>";
           $lin_mult .= "    <INPUT class='" . $this->css_scAppDivToolbarInput . "' type=\"checkbox\" id=\"id_int_search_idprov\" name=\"int_search_idprov[]\" value=\"" . NM_encode_input($dados . "##@@" . $formatado) . "\" checked><span class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</span>";
           if(!empty($veja_mais_link))
           {
               $lin_mult .= "    <span class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</span>";
           }
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       {
           $disp_chk = "none";
           $lin_obj  .= "   <tr><td><div class='scGridRefinedSearchMolduraResult' id=\"id_tab_idprov_chk\" style=\"display: " . $disp_chk . ";\">";
           $lin_obj  .= $lin_mult;
           $lin_obj  .= "   </div></td></tr>";
       }
       if (count($result) > 1)
       {
           ...
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bmultiselect", "nm_mult_int_search('idprov');", "nm_mult_int_search('idprov');", "mult_int_search_idprov", "", "", "display: $disp_link", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "multiselect", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['idprov']) . "','idprov','id_int_search_idprov','idprov', '');", "nm_proc_int_search('chbx', 'nn','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['idprov']) . "','idprov','id_int_search_idprov','idprov', '');", "app_int_search_idprov", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["total"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["total"])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['total'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
   ...
   { 
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['total'])) ? "" : "none";
     ...
     if(count($result) >=2)
     {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['refin_slider_total'])) {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['refin_slider_total']['min'] = $range_min;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['refin_slider_total']['max'] = $range_max;
           $range_min_orig = $range_min;
           $range_max_orig = $range_max;
       }
       else {
           $range_min_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['refin_slider_total']['min'];
           $range_max_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['refin_slider_total']['max'];
       }
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       $lin_obj  .= "   </div></td></tr>";
           ...
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('range', 'bw','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['total']) . "','total','id_int_search_total','total', '');", "nm_proc_int_search('range', 'bw','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['total']) . "','total','id_int_search_total','total', '');", "app_int_search_range_total", "", "", "display: $disp_btn_range", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
           $lin_obj .= "      </div>";
           $lin_obj .= "     </td>";
           $lin_obj .= "    </tr>";
   ...
   {
       $cle_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["pagada"])) ? "" : "none";
       $exp_disp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']["pagada"])) ? "none" : "";
       ...
       $lin_obj .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['pagada'];
       $lin_obj .= "              </span>";
       $lin_obj .= "          </td>";
       $lin_obj .= "          <td align='right'>";
   ...
   { 
       ...
       $lin_mult  = "";
       $disp_link = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['pagada'])) ? "" : "none";
       ...
       foreach ($result as $dados => $qtd_result)
       {
           ...
           $lin_obj  .= "  <table cellspacing=0 cellpadding=0>";
           $lin_obj  .= "   <tr>";
           if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['interativ_search']['pagada']))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <IMG align='absmiddle' style=\"cursor: pointer; position:relative; opacity:0;\" SRC=\"" . $this->Ini->path_img_global . "/" . $this->Ini->refinedsearch_campo_close_icon . "\" BORDER=\"0\" onclick=\"nm_proc_int_search('uncheck', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['pagada']) . "','pagada','id_int_search_pagada','pagada', '" . NM_encode_input($dados . "##@@" . $formatado) . "');\"/>";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "   <td>";
           $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['pagada']) . "','pagada','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'pagada', '');\" class='scGridRefinedSearchCampoFont'>" . $formatado_exib . "</a> ";
           $lin_obj  .= "   </td>";
           if(!empty($veja_mais_link))
           {
               $lin_obj  .= "   <td>";
               $lin_obj  .= "    <a href=\"javascript:nm_proc_int_search('link','tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['pagada']) . "','pagada','" . NM_encode_input(NM_encode_input_js($dados . "##@@" . $formatado)) . "', 'pagada', '');\" class='scGridRefinedSearchQuantidade'>" . $veja_mais_link . "</a> ";
               $lin_obj  .= "   </td>";
           }
           $lin_obj  .= "    </tr>";
           $lin_obj  .= "   </table>";
...
";
      ...
      $lin_obj  .= "</SCRIPT>";
       ...
       if (count($result) > 1)
       {
           ...
           $lin_obj .= $Cod_Btn; 
           $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_apply", "nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['pagada']) . "','pagada','id_int_search_pagada','pagada', '');", "nm_proc_int_search('chbx', 'tx','" . str_replace(array("'",'"'), array('__sasp__','__dasp__'), $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['int_search_label']['pagada']) . "','pagada','id_int_search_pagada','pagada', '');", "app_int_search_pagada", "", "", "display: none", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
           $lin_obj .= $Cod_Btn; 
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_compras_SD_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_compras_SD_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" &&
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao_print'] != "print" && !$this->Print_All) 
   { 
      $nm_saida->saida("     <tr><td colspan=3  class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\"> \r\n");
      $nm_saida->saida("     <iframe class=\"css_iframes\" id=\"nmsc_iframe_liga_B_grid_compras_SD\" marginWidth=\"0px\" marginHeight=\"0px\" frameborder=\"0\" valign=\"top\" height=\"0px\" width=\"0px\" name=\"nm_iframe_liga_B_grid_compras_SD\" scrolling=\"auto\" src=\"NM_Blank_Page.htm\"></iframe>\r\n");
      $nm_saida->saida("     </td></tr> \r\n");
   } 
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </div>\r\n");
   ...
   $nm_saida->saida("   </TABLE>\r\n");
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['ajax_nav'])
       {
   ...
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_compras_SD', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_compras_SD\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_compras_SD_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_compras_SD_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_compras_SD/grid_compras_SD_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_compras_SD_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("      {\r\n");
   $nm_saida->saida("          NM_ancor_ult_lig = ancor;\r\n");
   $nm_saida->saida("          par_modal = '?&nmgp_outra_jan=true&nmgp_url_saida=modal&SC_lig_apl_orig=grid_compras_SD';\r\n");
   $nm_saida->saida("          if (opc != null && opc != '') \r\n");
   $nm_saida->saida("          {\r\n");
   ...
   $nm_saida->saida("          return;\r\n");
   $nm_saida->saida("      }\r\n");
   $nm_saida->saida("      if (pos == \"A\") {obj = document.getElementById('nmsc_iframe_liga_A_grid_compras_SD');} \r\n");
   $nm_saida->saida("      if (pos == \"B\") {obj = document.getElementById('nmsc_iframe_liga_B_grid_compras_SD');} \r\n");
   $nm_saida->saida("      if (pos == \"E\") {obj = document.getElementById('nmsc_iframe_liga_E_grid_compras_SD');} \r\n");
   $nm_saida->saida("      if (pos == \"D\") {obj = document.getElementById('nmsc_iframe_liga_D_grid_compras_SD');} \r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['grid_compras_SD_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_compras_SD@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_compras_SD_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_compras_SD_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_compras_SD']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_compras_SD_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_SD']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_compras_SD')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_compras_SD', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
