<?php
   include_once('grid_compras_SD_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_compras_SD']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_compras_SD']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_compras_SD']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_compras_SD']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_compras_SD_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_compras_SD_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_compras_SD_json.php");
   }
   ...
   $tab_labels["numfacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["numfacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["numfacom"] : "Número";
   $tab_ger_campos['fechacom'] = "on";
   $tab_def_campos['fechacom'] = "fechacom";
   $tab_labels["fechacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["fechacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["fechacom"] : "Fecha";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["fechavenc"] : "Fecha venc.";
   $tab_ger_campos['formapago'] = "on";
   $tab_def_campos['formapago'] = "formapago";
   $tab_labels["formapago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["formapago"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["formapago"] : "Formapago";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['idprov'] = "on";
   $tab_def_campos['idprov'] = "idprov";
   $tab_labels["idprov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["idprov"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["idprov"] : "Proveedor";
   ...
   $tab_labels["val_ret"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["val_ret"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["val_ret"] : "$ Retención";
   ...
   $tab_labels["val_ica"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["val_ica"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["val_ica"] : "$ ReteICA";
   ...
   $tab_labels["val_retiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["val_retiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["val_retiva"] : "$ ReteIVA";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["total"] : "Total";
   $tab_ger_campos['valoriva'] = "on";
   $tab_def_campos['valoriva'] = "valoriva";
   $tab_labels["valoriva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["valoriva"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["valoriva"] : "Valoriva";
   ...
   $tab_labels["a_pagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["a_pagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["a_pagar"] : "Val a Pagar";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>Lista Facturas o entradas compras</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_compras_SD_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_compras_SD']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
