...
<?php
   ...
   $Ord_Cmp = new grid_nit_facilweb_vs_tns_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_nit_facilweb_vs_tns_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["t_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['labels']["t_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['labels']["t_documento"] : "Documento";
   $tab_ger_campos['t_dv'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_dv'] = "t_dv";
   }
   else
   {
       $tab_def_campos['t_dv'] = "t.dv";
   }
   $tab_labels["t_dv"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['labels']["t_dv"])) ? $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['labels']["t_dv"] : "Dv";
   $tab_ger_campos['t_nombres'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['t_nombres'] = "t_nombres";
   }
   else
   {
       $tab_def_campos['t_nombres'] = "t.nombres";
   }
   $tab_labels["t_nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['labels']["t_nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['labels']["t_nombres"] : "Nombres";
   ...
   $tab_labels["tns"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['labels']["tns"])) ? $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['labels']["tns"] : "TNS";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>Nit Facilweb Vs TNS</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_nit_facilweb_vs_tns_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_nit_facilweb_vs_tns']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
