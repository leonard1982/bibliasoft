...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_nit_facilweb_vs_tns"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_nit_facilweb_vs_tns"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_nit_facilweb_vs_tns']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_nit_facilweb_vs_tns']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_nit_facilweb_vs_tns']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_nit_facilweb_vs_tns']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_nit_facilweb_vs_tns']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_nit_facilweb_vs_tns</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_nit_facilweb_vs_tns']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_nit_facilweb_vs_tns']['embutida_filho'] as $ind => $sc_init)
          {
