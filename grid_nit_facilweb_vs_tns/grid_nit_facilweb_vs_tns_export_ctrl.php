<?php
@session_start() ;
$_SESSION['scriptcase']['grid_nit_facilweb_vs_tns']['sc_process_barr'] = true;
require_once('../grid_nit_facilweb_vs_tns/index.php');
unset($_SESSION['scriptcase']['grid_nit_facilweb_vs_tns']['sc_process_barr']);
$ExportCtrl = new grid_nit_facilweb_vs_tns_export_control;
$ExportCtrl->Export_barr();

class grid_nit_facilweb_vs_tns_export_control
{
