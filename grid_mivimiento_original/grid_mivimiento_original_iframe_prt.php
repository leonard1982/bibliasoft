...
if (!isset($_SESSION['sc_session']))
{
    ...
    if (is_file($root . $_SESSION['scriptcase']['grid_mivimiento_original']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
    {
?>
<html>
 <body>
...
<html<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
 <head>
  <title>grid_mivimiento_original :: PRINT</title>
