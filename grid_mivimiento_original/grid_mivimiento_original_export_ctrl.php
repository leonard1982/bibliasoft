<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mivimiento_original']['sc_process_barr'] = true;
require_once('../grid_mivimiento_original/index.php');
unset($_SESSION['scriptcase']['grid_mivimiento_original']['sc_process_barr']);
$ExportCtrl = new grid_mivimiento_original_export_control;
$ExportCtrl->Export_barr();

class grid_mivimiento_original_export_control
{
