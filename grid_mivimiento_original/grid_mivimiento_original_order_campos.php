...
<?php
   ...
   $Ord_Cmp = new grid_mivimiento_original_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mivimiento_original_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["idpro"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["cantidad"] : "Cantidad";
   ...
   $tab_labels["presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["presentacion"] : "Presentación";
   $tab_ger_campos['idbodorig'] = "on";
   $tab_def_campos['idbodorig'] = "idbodorig";
   $tab_labels["idbodorig"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["idbodorig"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["idbodorig"] : "Origen";
   $tab_ger_campos['idboddes'] = "on";
   $tab_def_campos['idboddes'] = "idboddes";
   $tab_labels["idboddes"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["idboddes"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["idboddes"] : "Destino";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["fecha"] : "Fecha";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['labels']["imprimir"] : "Imprimir comprobante";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mivimiento_original_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_mivimiento_original']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
