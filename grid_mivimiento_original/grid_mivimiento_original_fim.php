...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_mivimiento_original"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_mivimiento_original"]);
   }
