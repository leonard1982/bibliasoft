...
class grid_log_pedidos_borrados_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_log_pedidos_borrados']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_log_pedidos_borrados']['campos_busca']))
      { 
   ...
   function quebra_geral_sc_free_group_by($res_limit=false)
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
   ...
   function quebra_anio_sc_free_group_by($anio, $Where_qb, $Cmp_Name) 
   {
      ...
      $tot_anio[0] = NM_encode_input(sc_strip_script($anio)) ; 
      $tot_anio[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_anio[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_anio[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_anio;
   } 
   ...
   function quebra_mesa_cliente_sc_free_group_by($mesa_cliente, $Where_qb, $Cmp_Name) 
   {
      ...
      $tot_mesa_cliente[0] = sc_strip_script($mesa_cliente) ; 
      $tot_mesa_cliente[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_mesa_cliente[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_mesa_cliente[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_mesa_cliente;
   } 
   ...
   function quebra_descr_sc_free_group_by($descr, $Where_qb, $Cmp_Name) 
   {
      ...
      $tot_descr[0] = sc_strip_script($descr) ; 
      $tot_descr[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_descr[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_descr[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_descr;
   } 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('anio' => "anio",'periodo' => "periodo",'fechaven' => "fechaven",'numero' => "numero",'mesa_cliente' => "mesa_cliente",'descr' => "descr",'vendedor' => "vendedor");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['anio']['reg'] = "S";
      $format_dimensions['anio']['msk'] = "";
      ...
      $format_dimensions['mesa_cliente']['reg'] = "S";
      $format_dimensions['mesa_cliente']['msk'] = "";
      $format_dimensions['descr']['reg'] = "S";
      $format_dimensions['descr']['msk'] = "";
