<?php
class grid_log_pedidos_borrados_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['charts_html'] = '';
   ...
   { 
       ...
       $this->Res         = new grid_log_pedidos_borrados_resumo();
       $this->Res->Db     = $this->Db;
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_log_pedidos_borrados'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'];
       if ($nmgrp_apl_opcao != "pdf")
       { 
           $this->nmgp_barra_top();
           $this->nmgp_embbed_placeholder_top();
       } 
       if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != 'print')
       { 
           if ($this->Ini->grid_search_change_fil)
           { 
               $seq_search = 1;
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'] as $cmp => $def)
               {
                  $Seq_grid      = $seq_search;
                  $Cmp_grid      = $cmp;
       ...
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['save_grid']);
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pdf_res'] && (!isset($_GET['flash_graf']) || 'chart' != $_GET['flash_graf']))
       {
           $this->grid();
       }
       if ($nmgrp_apl_opcao != "pdf")
       ...
       { 
           if (isset($_GET['flash_graf']) && 'chart' == $_GET['flash_graf'])
           {
               ...
               $this->Graf  = new grid_log_pedidos_borrados_grafico();
       ...
       { 
           if (isset($_GET['flash_graf']) && 'pdf' == $_GET['flash_graf'] && $Gera_graf)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "grid";
           } 
           elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf" && $Gera_graf)
           { 
               $this->grafico_pdf();
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "grid";
           } 
       ...
       { 
           ...
           if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf")
           { 
               $flag_apaga_pdf_log = FALSE;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "igual";
           } 
           $this->nm_fim_grid($flag_apaga_pdf_log);
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_pdf']['label_group'] : "N";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_pdf']['all_cab'] : "S";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_pdf']['all_label'] : "S";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   foreach ($NM_css as $cada_css)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['doc_word'])
       { 
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'] .= "anio?#?" . "Año" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'] .= "periodo?#?" . "Periodo" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'] .= "fechaven?#?" . "Fecha" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'] .= "mesa_cliente?#?" . "Mesa/Cliente" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'] .= "descr?#?" . "Producto" . "?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'] .= "vendedor?#?" . "Vendedor" . "?@?";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_search_add']))
   {
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'];
       ...
       $Seq_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_search_add']['seq'];
       $Cmp_grid      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_search_add']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_search_add']);
       exit;
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dyn_search_aut_comp']))
   {
       $NM_func_aut_comp = "lookup_ajax_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dyn_search_aut_comp']['cmp'];
       ...
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dyn_search_aut_comp']);
       exit;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['force_toolbar']))
   { 
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_edit'] == 'N'))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['mostra_edit'] = "N";
   }
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'] = 0;
   }
   elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['emb_tree_no']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['emb_tree_no'])
   { 
       $this->NM_emb_tree_no = true; 
   }
   $this->aba_iframe = false;
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_log_pedidos_borrados", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   $this->Cmps_ord_def['anio'] = " desc";
   $this->Cmps_ord_def['periodo'] = " desc";
   $this->Cmps_ord_def['fechaven'] = " desc";
   $this->Cmps_ord_def['numero'] = " asc";
   $this->Cmps_ord_def['mesa_cliente'] = " asc";
   $this->Cmps_ord_def['descr'] = " asc";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_ant'];  
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_log_pedidos_borrados'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_log_pedidos_borrados'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_log_pedidos_borrados_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'] = 10;
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid']; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby'] == "sc_free_group_by") 
   {
       ...
       { 
           ...
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_sql'] as $cmp_var => $resto)
           {
   ...
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "inicio" ;  
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_grid'] = ""; 
                       $ordem = ($ordem == "asc") ? "desc" : "asc";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao']       = "igual" ; 
...
// 
   ...
   $this->arg_sum_anio = "";
   $this->count_anio = 0;
   $this->sum_anio_cantidad = 0;
   $this->sum_anio_valorpar = 0;
   $this->arg_sum_periodo = "";
   $this->count_periodo = 0;
   $this->sum_periodo_cantidad = 0;
   $this->sum_periodo_valorpar = 0;
   $this->arg_sum_fechaven = "";
   $this->count_fechaven = 0;
   $this->sum_fechaven_cantidad = 0;
   $this->sum_fechaven_valorpar = 0;
   $this->arg_sum_numero = "";
   $this->count_numero = 0;
   $this->sum_numero_cantidad = 0;
   $this->sum_numero_valorpar = 0;
   $this->arg_sum_mesa_cliente = "";
   $this->count_mesa_cliente = 0;
   $this->sum_mesa_cliente_cantidad = 0;
   $this->sum_mesa_cliente_valorpar = 0;
   $this->arg_sum_descr = "";
   $this->count_descr = 0;
   $this->sum_descr_cantidad = 0;
   $this->sum_descr_valorpar = 0;
   $this->arg_sum_vendedor = "";
   $this->count_vendedor = 0;
   $this->sum_vendedor_cantidad = 0;
   $this->sum_vendedor_valorpar = 0;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['tot_geral'][1] ;  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "final" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'] == "all") 
   { 
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['contr_total_geral'] = "NAO";
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_total']);
       $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby'];
       $this->Tot->$Gb_geral();
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['contr_array_resumo']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['contr_array_resumo'] = "NAO";
       } 
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['tot_geral'][1];
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_total'] = $rt_grid->fields[0];  
       
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_desc']; 
   } 
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final']; 
   ...
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<HEAD>
 <TITLE>Pedidos Borrados :: PDF</TITLE>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_log_pedidos_borrados_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_log_pedidos_borrados_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_log_pedidos_borrados_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_log_pedidos_borrados_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_log_pedidos_borrados_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       $nm_saida->saida("  <HEAD>\r\n");
       $nm_saida->saida("   <TITLE>Pedidos Borrados</TITLE>\r\n");
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_log_pedidos_borrados_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_log_pedidos_borrados_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_log_pedidos_borrados_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid']) . ";\r\n");
           }
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_log_pedidos_borrados-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-79862820\");\r\n");
           ...
           if ($nmgrp_apl_opcao != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != 'print' && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']))
           { 
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               $nm_saida->saida("       $('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ancor_save'] . "').addClass('" . $this->css_scGridFieldOver . "');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
     ...
     if (!$_SESSION['scriptcase']['proc_mobile']) { 
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"grid_log_pedidos_borrados_save_grid.php\",\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_log_pedidos_borrados_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
       {
 ...
 { 
       ...
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_log_pedidos_borrados_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_log_pedidos_borrados_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_log_pedidos_borrados_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_log_pedidos_borrados']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_log_pedidos_borrados']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_log_pedidos_borrados']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_log_pedidos_borrados']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida']) ? "grid_log_pedidos_borrados_" : "";
   $this->css_sep = " ";
   ...
   $this->css_mesa_cliente_label = $compl_css_emb . "css_mesa_cliente_label";
   $this->css_mesa_cliente_grid_line = $compl_css_emb . "css_mesa_cliente_grid_line";
   $this->css_descr_label = $compl_css_emb . "css_descr_label";
   $this->css_descr_grid_line = $compl_css_emb . "css_descr_grid_line";
...
//----- 
 function cabecalho_normal()
 {
   global
          $nm_saida;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['maximized'])
   {
       return; 
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['cab']))
   {
       return; 
   }
   $nm_cab_filtro   = ""; 
   ...
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_filtro'];
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq']))
   {  
       $pos       = 0;
       $trab_pos  = false;
       $pos_tmp   = true; 
       $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'];
       while ($pos_tmp)
       {
          $pos = strpos($tmp, "##*@@", $pos);
          if ($pos !== false)
       ...
       $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
       $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
       $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'], 0, $trab_pos);
   ...
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sv_dt_head']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sv_dt_head'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sv_dt_head']['fix'] = $nm_data_fixa;
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sv_dt_head'] as $ind => $val)
   {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sv_dt_head']['fix'] != $nm_data_fixa)
   {
       $nm_refresch_cab_rod = true;
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ajax_nav'] && $nm_refresch_cab_rod)
   { 
   ...
   { 
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf']) 
     { 
         $this->NM_calc_span();
           $nm_saida->saida("   <TD colspan=\"" . $this->NM_colspan . "\" class=\"" . $this->css_scGridTabelaTd . "\" style=\"vertical-align: top\">\r\n");
     } 
     else if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf_vert']) 
     {
   ...
   $nm_saida->saida("    	<tr>\r\n");
   $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>Pedidos Borrados</span></td>\r\n");
...
// 
 function label_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['exibe_titulos'] != "S")
   { 
   } 
   else 
   { 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_label'])
      { 
   ...
   $nm_saida->saida("    <TR id=\"tit_grid_log_pedidos_borrados__SCCS__" . $nm_seq_titulos . "\" align=\"center\" class=\"" . $this->css_scGridLabel . " sc-ui-grid-header-row sc-ui-grid-header-row-grid_log_pedidos_borrados-" . $tmp_header_row . "\">\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_label']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_vendedor_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq']) { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_vendedor_label'] . "\" >&nbsp;</TD>\r\n");
   } 
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['field_order'] as $Cada_label)
   { 
   ...
   $nm_saida->saida("</TR>\r\n");
     ...
     { 
         ...
         { 
             ...
             foreach ($NM_css as $cada_css)
             {
                 $css_emb .= ".grid_log_pedidos_borrados_" . substr($cada_css, 1);
             }
             $css_emb .= "</style>";
             $Cod_Html = $css_emb . $Cod_Html;
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cols_emb'] = count($Nm_temp) - 1;
             if ($contr_embutida) 
             { 
     ...
     $NM_seq_lab = 1;
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels'] as $NM_cmp => $NM_lab)
     {
         if (empty($NM_lab) || $NM_lab == "&nbsp;")
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels'][$NM_cmp] = "No_Label" . $NM_seq_lab;
             $NM_seq_lab++;
         }
     } 
   } 
 ...
 function NM_label_anio()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_anio_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_anio_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp'] == 'anio')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] == "desc")
          {
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('anio')\" class=\"" . $this->css_scGridLabelLink . "\"" . $Css_compl_sort . ">" . $link_img . "</a>\r\n");
   }
   else
   {
 ...
 function NM_label_periodo()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_periodo_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_periodo_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp'] == 'periodo')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('periodo')\" class=\"" . $this->css_scGridLabelLink . "\"" . $Css_compl_sort . ">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_fechaven()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp'] == 'fechaven')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_numero()
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp'] == 'numero')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
 ...
 function NM_label_mesa_cliente()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['mesa_cliente'])) ? $this->New_label['mesa_cliente'] : "Mesa/Cliente"; 
   if (!isset($this->NM_cmp_hidden['mesa_cliente']) || $this->NM_cmp_hidden['mesa_cliente'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_mesa_cliente_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_mesa_cliente_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp'] == 'mesa_cliente')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('mesa_cliente')\" class=\"" . $this->css_scGridLabelLink . "\"" . $Css_compl_sort . ">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_descr()
 {
   global $nm_saida;
   $SC_Label = (isset($this->New_label['descr'])) ? $this->New_label['descr'] : "Producto"; 
   if (!isset($this->NM_cmp_hidden['descr']) || $this->NM_cmp_hidden['descr'] != "off") { 
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_descr_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_descr_label'] . "\" >\r\n");
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf")
   {
      $link_img = "";
      $nome_img = $this->Ini->Label_sort;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_cmp'] == 'descr')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ordem_label'] == "desc")
          {
              $nome_img = $this->Ini->Label_sort_desc;
   ...
   $nm_saida->saida("<a href=\"javascript:nm_gp_submit2('descr')\" class=\"" . $this->css_scGridLabelLink . "\"" . $Css_compl_sort . ">" . $link_img . "</a>\r\n");
   }
   else
   {
   $nm_saida->saida("" . nl2br($SC_Label) . "\r\n");
 ...
 function NM_label_cantidad()
 {
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridLabelFont . $this->css_sep . $this->css_cantidad_label . "\"  style=\"" . $this->css_scGridLabelNowrap . "" . $this->Css_Cmp['css_cantidad_label'] . "\" >" . nl2br($SC_Label) . "</TD>\r\n");
   } 
 }
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ini_cor_grid']);
       }
   }
...
// 
   $SC_Label = (isset($this->New_label['anio'])) ? $this->New_label['anio'] : "Año"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['anio'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['periodo'])) ? $this->New_label['periodo'] : "Periodo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['periodo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : "Fecha"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['fechaven'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['numero'])) ? $this->New_label['numero'] : "Numero"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['numero'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['mesa_cliente'])) ? $this->New_label['mesa_cliente'] : "Mesa/Cliente"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['mesa_cliente'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['descr'])) ? $this->New_label['descr'] : "Producto"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['descr'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cantidad'])) ? $this->New_label['cantidad'] : "Cantidad"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['cantidad'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['valorpar'])) ? $this->New_label['valorpar'] : "Valor Línea"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['valorpar'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['vendedor'])) ? $this->New_label['vendedor'] : "Vendedor"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['labels']['vendedor'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_log_pedidos_borrados']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
       {
           ...
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cols_emb'];
               }
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_log_pedidos_borrados#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               ...
               $nm_id_aplicacao = "";
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cab_embutida'] != "S")
               {
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['force_toolbar'] = true;
           } 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ajax_nav'])
           { 
               $_SESSION['scriptcase']['saida_html'] = "";
           } 
           $nm_saida->saida("  " . $this->nm_grid_sem_reg . "\r\n");
...
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_log_pedidos_borrados#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf_vert'])
{
}
else
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf']) { 
 ...
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf']) { 
   ...
   $nm_saida->saida("   <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-79862820\" align=\"center\" " . $nm_id_aplicacao . " width=\"100%\">\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf_vert']) { 
    $nm_saida->saida("</thead>\r\n");
 }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] && $this->pdf_all_label != "S" && $this->pdf_label_group != "S") 
   { 
      $this->label_grid($linhas);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_grid'])
...
// 
   ...
   $this->Break_pag_pdf['sc_free_group_by']['fechaven'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['fechaven'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['numero'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['numero'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['mesa_cliente'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['mesa_cliente'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['descr'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['descr'] = "N";
   $this->Break_pag_pdf['sc_free_group_by']['vendedor'] = "N";
   $this->Break_pag_prt['sc_free_group_by']['vendedor'] = "N";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Config_Page_break_PDF'] = "S";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Page_break_PDF'] = array();
       }
   }
   $this->SC_top       = array();
   $this->SC_bot       = array();
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          $this->Rows_span = 1;
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_log_pedidos_borrados_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          {  
              ...
              {
                  $cmp = $SC_lst_Gby[0];
                  if ($this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['doc_word'] && $this->Break_pag_prt[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby']][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
                  elseif (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Page_break_PDF'][$cmp] == "S")
                  {
                      $this->nm_quebra_pagina("pagina"); 
                  }
              }
          ...
          else
          {
              ...
              {
                  if ($this->nm_inicio_pag == 0 && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_grid'])
                  {
                      $nm_houve_quebra = "N";
                  } 
              } 
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_grid'])
          {
             $NM_destaque ="";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dado_psq_ret'];
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_grid']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_scGridBlockBg . "\" style=\"width: " . $this->width_tabula_quebra . "; display:" . $this->width_tabula_display . ";\"  style=\"" . $this->Css_Cmp['css_vendedor_grid_line'] . "\" NOWRAP align=\"\" valign=\"\"   HEIGHT=\"0px\">&nbsp;</TD>\r\n");
 }
 if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq']){ 
          $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . "\"  style=\"" . $this->Css_Cmp['css_vendedor_grid_line'] . "\" NOWRAP align=\"left\" valign=\"top\" WIDTH=\"1px\"  HEIGHT=\"0px\">\r\n");
 $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcapture", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "document.Fpesq.nm_ret_psq.value='" . $teste . "'; nm_escreve_window();", "", "Rad_psq", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
          $nm_saida->saida(" $Cod_Btn</TD>\r\n");
 } 
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['mostra_edit'] != "N"){ 
              $Sc_parent = ($this->grid_emb_form || $this->grid_emb_form_full) ? "S" : "";
              $Parms_Det  = "nmgp_chave_det?#?" . $this->anio . "*PDet*" . $this->periodo . "*PDet*" . $this->numero . "*PDet*" . $this->mesa_cliente . "*PDet*" . $this->descr . "*PDet*" . $this->cantidad . "*PDet*" . $this->valorpar . "*PDet*" . $this->vendedor . "?@?Sc_seq_det?#?" . $this->SC_seq_register . "?#?";
              $Md5_Det    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_log_pedidos_borrados@SC_par@" . md5($Parms_Det);
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Lig_Md5'][md5($Parms_Det)] = $Parms_Det;
 ...
 if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['mostra_edit'] == "N"){ 
          ...
          $nm_saida->saida("</TR>\r\n");
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_grid'] && $this->nm_prim_linha)
          { 
              $nm_saida->saida("##NM@@"); 
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
 ...
 function NM_grid_fechaven()
 {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_fechaven_grid_line . "\"  style=\"" . $this->Css_Cmp['css_fechaven_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_fechaven_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_mesa_cliente()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['mesa_cliente']) || $this->NM_cmp_hidden['mesa_cliente'] != "off") { 
          $conteudo = sc_strip_script($this->mesa_cliente); 
          $conteudo_original = sc_strip_script($this->mesa_cliente); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'mesa_cliente', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'mesa_cliente', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'])
          {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_mesa_cliente_grid_line . "\"  style=\"" . $this->Css_Cmp['css_mesa_cliente_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_mesa_cliente_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 function NM_grid_descr()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['descr']) || $this->NM_cmp_hidden['descr'] != "off") { 
          $conteudo = sc_strip_script($this->descr); 
          $conteudo_original = sc_strip_script($this->descr); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'descr', $str_tem_display, $conteudo_original); 
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'descr', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'])
          {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_descr_grid_line . "\"  style=\"" . $this->Css_Cmp['css_descr_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_descr_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_grid_valorpar()
 {
      global $nm_saida;
      if (!isset($this->NM_cmp_hidden['valorpar']) || $this->NM_cmp_hidden['valorpar'] != "off") { 
          $nm_cor_num = ($this->valorpar < 0) ? "color:#FF0000;" : "";
          ...
          { 
              ...
              $str_tem_display = $this->getFieldHighlight('advanced_search', 'valorpar', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'])
          {
   ...
   $nm_saida->saida("     <TD rowspan=\"" . $this->Rows_span . "\" class=\"" . $this->css_line_fonf . $this->css_sep . $this->css_valorpar_grid_line . "\"  style=\"" . $nm_cor_num . "" . $this->Css_Cmp['css_valorpar_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\"><span id=\"id_sc_field_valorpar_" . $this->SC_seq_page . "\">" . $conteudo . "</span></TD>\r\n");
      }
 }
 ...
 function NM_calc_span()
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_pdf'] == "pdf")
   {
       $this->NM_colspan--;
   } 
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['print_navigator'] == "Netscape")
            {
        ...
        if ($nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'])
        {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf']) { 
           }
           else
           {
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf_vert']) { 
                $nm_saida->saida("     <thead>\r\n");
               }
               $this->cabecalho();
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf_vert']) { 
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] && ($this->pdf_all_cab == "S" || $this->pdf_all_label == "S")) { 
            $nm_saida->saida(" <thead> \r\n");
            if ($this->pdf_all_cab == "S")
            {
                $this->cabecalho();
            }
            if ($this->pdf_all_label == "S" && $nm_parms != "resumo" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_grid'])
            {
                $this->label_grid();
            }
            $nm_saida->saida(" </thead> \r\n");
        }
        if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] && $nm_parms != "resumo" && $nm_parms != "pagina" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_grid'])
        {
            $this->label_grid();
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['proc_pdf'] && $this->pdf_label_group != "S" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida_grid'])
        {
            $this->nm_inicio_pag = 0;
        }
    }
 ...
 function quebra_anio_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   $tot_anio = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['anio'] : 0;
   ...
   $link_div   = "";
   $link_div_2 = "";
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
       ...
       $link_div .= "<img id=\"b_open_grid_log_pedidos_borrados_" . $this->NM_cont_body . "\" style=\"display:none\" onclick=\"document.getElementById('b_open_grid_log_pedidos_borrados_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_close_grid_log_pedidos_borrados_" . $this->NM_cont_body . "').style.display = ''; NM_liga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_log_pedidos_borrados, 'grid_log_pedidos_borrados'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_exp . "\">";
       $link_div .= "<img id=\"b_close_grid_log_pedidos_borrados_" . $this->NM_cont_body . "\" style=\"display:''\" onclick=\"document.getElementById('b_close_grid_log_pedidos_borrados_" . $this->NM_cont_body . "').style.display = 'none'; document.getElementById('b_open_grid_log_pedidos_borrados_" . $this->NM_cont_body . "').style.display = ''; NM_apaga_tbody(" . $this->NM_cont_body . ", NM_tab_grid_log_pedidos_borrados, 'grid_log_pedidos_borrados'); return false;\" src=\"" . $this->Ini->path_img_global . "/" . $this->Ini->Tree_img_col . "\">";
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['anio']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   $this->NM_calc_span();
   ...
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_anio . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['anio'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['anio']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
 ...
 function quebra_anio_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_anio = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['anio'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "valorpar" && (!isset($this->NM_cmp_hidden['valorpar']) || $this->NM_cmp_hidden['valorpar'] != "off"))
    {
      ...
      $conteudo =  $tot_anio[3] ; 
      nmgp_Form_Num_Val($conteudo, ",", ",", "0", "S", "2", "$", "V:3:12", "-"); 
       $nm_saida->saida("     <TD class=\"" . $this->css_scGridSubtotalFont . " css_valorpar_sub_tot\"  NOWRAP >" . $conteudo . "</TD>\r\n");
     }
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = false;
       $nm_saida->saida("    </TBODY>");
   }
 ...
 function quebra_periodo_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_periodo = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['periodo'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['periodo']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\" NOWRAP " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_periodo . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['periodo'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['periodo']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_periodo_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_periodo = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['periodo'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
 ...
 function quebra_fechaven_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fechaven = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['fechaven'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['fechaven']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\" NOWRAP " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_fechaven . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['fechaven'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['fechaven']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_fechaven_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_fechaven = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['fechaven'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
 ...
 function quebra_numero_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_numero = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['numero'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['numero']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_numero . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['numero'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['numero']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_numero_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_numero = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['numero'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
 ...
 function quebra_mesa_cliente_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_mesa_cliente = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['mesa_cliente'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_mesa_cliente = 0; 
   $cont_quebra_mesa_cliente++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['rows_emb']++;
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['mesa_cliente']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $colspan = $this->NM_colspan;
   $this->Label_mesa_cliente = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_mesa_cliente .= "<tr>"; 
       $this->Label_mesa_cliente .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_mesa_cliente .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_mesa_cliente .= "</tr>"; 
   } 
   $this->Label_mesa_cliente .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\"  " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_mesa_cliente . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['mesa_cliente'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['mesa_cliente']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_mesa_cliente_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_mesa_cliente = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['mesa_cliente'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
 ...
 function quebra_descr_sc_free_group_by_top($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_descr = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['descr'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   static $cont_quebra_descr = 0; 
   $cont_quebra_descr++;
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_old = "";
   $nm_fecha_pdf_new = "";
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['descr']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   $colspan = $this->NM_colspan;
   $this->Label_descr = "<table>"; 
   $Cmps_gb = $this->$Cmps_Gb_Free;
   foreach ($Cmps_gb as $cada_campo) 
   { 
       $this->Label_descr .= "<tr>"; 
       $this->Label_descr .= "<td>" . $cada_campo['lab'] . "</td><td> => </td>";
       $this->Label_descr .= "<td>" . $cada_campo['cmp'] . "</td>";
       $this->Label_descr .= "</tr>"; 
   } 
   $this->Label_descr .= "</table>"; 
   $nm_saida->saida("    <TR >\r\n");
   $nm_saida->saida("     <TD class=\"" . $this->css_scGridBlock . "\" style=\"text-align:left;\"  style=\"text-align: left;\"  " . "colspan=\"" . $colspan . "\"" . " align=\"\">\r\n");
   $nm_saida->saida("       " . $link_div . "\r\n");
   $nm_saida->saida("        " . $nm_nivel_book_pdf . $nm_fecha_pdf_new  . $this->Label_descr . $nm_fecha_pdf_old . "\r\n");
   $nm_saida->saida("       " . $link_div_2 . "\r\n");
   $nm_saida->saida("     </TD>\r\n");
   $nm_saida->saida("    </TR>\r\n");
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['descr'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['descr']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_descr_sc_free_group_by_bot($Cmp_Name) 
 {
   $Var_name_gb  = "SC_tot_" . $Cmp_Name;
   $Cmps_Gb_Free = "campos_quebra_" . $Cmp_Name;
   $Desc_Gb_Ant  = $Cmp_Name . "_ant_desc";
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_descr = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['descr'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
 ...
 function quebra_vendedor_sc_free_group_by_top($Cmp_Name) 
 {
   ...
   global
          ...
          $nm_saida, $$Var_name_gb;
   $tot_vendedor = $$Var_name_gb;
   $this->SC_tab_quebra = (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Gb_Free_cmp']) > 1) ? 10 * $this->Tab_Nv_tree['vendedor'] : 0;
   $Desc_Gb_Ant = $this->$Cmps_Gb_Free[0]['cmp'];
   ...
   if ('' != $this->Ini->Tree_img_col && '' != $this->Ini->Tree_img_exp && !$this->Ini->Proc_print && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['vendedor']] = 'top';
       $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_top\" style=\"display:''\">");
   }
   $nm_nivel_book_pdf = "";
   $nm_fecha_pdf_new  = "";
   ...
   {
       $nm_saida->saida("    </TBODY>");
       if ($this->Ult_qb_free == $this->Tab_Nv_tree['vendedor'])
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
           $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
           $_SESSION['sc_session'][$this->Ini->sc_page]['NM_arr_tree']['grid_log_pedidos_borrados'][$this->NM_cont_body][$this->Tab_Nv_tree['vendedor']] = 'bot';
           $nm_saida->saida("    <TBODY id=\"tbody_grid_log_pedidos_borrados_" . $this->NM_cont_body . "_bot\" style=\"display:''\">");
           $this->NM_tbody_open = true;
       }
   }
 ...
 function quebra_vendedor_sc_free_group_by_bot($Cmp_Name) 
 {
   ...
   global 
          ...
          $nm_saida, $$Var_name_gb;
   $tot_vendedor = $$Var_name_gb;
   if ($this->Ult_qb_free != $this->Tab_Nv_tree['vendedor'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$this->NM_emb_tree_no)
   {
       $this->NM_tbody_open = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree']++;
       $this->NM_cont_body = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ind_tree'];
 ...
 function quebra_geral_sc_free_group_by_bot() 
 {
   ...
   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['field_order'] as $Cada_cmp)
   {
    ...
    if ($Cada_cmp == "valorpar" && (!isset($this->NM_cmp_hidden['valorpar']) || $this->NM_cmp_hidden['valorpar'] != "off"))
    {
      ...
      $conteudo =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['tot_geral'][3] ; 
      nmgp_Form_Num_Val($conteudo, ",", ",", "0", "S", "2", "$", "V:3:12", "-"); 
   ...
   function nmgp_barra_top_normal()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ajax_nav'])
          {
          ...
          $SC_Label_atu['anio'] = (isset($this->New_label['anio'])) ? $this->New_label['anio'] : 'Año'; 
          $SC_Label_atu['periodo'] = (isset($this->New_label['periodo'])) ? $this->New_label['periodo'] : 'Periodo'; 
          $SC_Label_atu['fechaven'] = (isset($this->New_label['fechaven'])) ? $this->New_label['fechaven'] : 'Fecha'; 
          $SC_Label_atu['numero'] = (isset($this->New_label['numero'])) ? $this->New_label['numero'] : 'Numero'; 
          $SC_Label_atu['mesa_cliente'] = (isset($this->New_label['mesa_cliente'])) ? $this->New_label['mesa_cliente'] : 'Mesa/Cliente'; 
          $SC_Label_atu['descr'] = (isset($this->New_label['descr'])) ? $this->New_label['descr'] : 'Producto'; 
          $SC_Label_atu['cantidad'] = (isset($this->New_label['cantidad'])) ? $this->New_label['cantidad'] : 'Cantidad'; 
          $SC_Label_atu['valorpar'] = (isset($this->New_label['valorpar'])) ? $this->New_label['valorpar'] : 'Valor Línea'; 
          $SC_Label_atu['vendedor'] = (isset($this->New_label['vendedor'])) ? $this->New_label['vendedor'] : 'Vendedor'; 
      ...
      if ($this->nmgp_botoes['sel_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $pos_path = strrpos($this->Ini->path_prod, "/");
      $path_fields = $this->Ini->root . substr($this->Ini->path_prod, 0, $pos_path) . "/conf/fields/";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcolumns", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnSelCamposShow('" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_sel_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&path_fields=" . $path_fields . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "selcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          else
          {
              ...
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_Groupby_hide']))
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_sel_groupby.php?opc_ret=igual&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
      }
      if ($this->nmgp_botoes['group_1'] == "on" && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           $Cod_Btn\r\n");
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          $Tem_word_res = "s";
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_cor=CO&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          $Tem_xls_res = "s";
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "xls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_log_pedidos_borrados&nm_tp_xls=xlsx&nm_tot_xls=S&nm_res_cons=" . $Tem_xls_res . "&nm_ini_xls_res=grid,resume&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=S&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          $Tem_xml_res = "s";
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "xml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_xml_res . "&nm_ini_xml_res=grid,resume&nm_all_modules=grid,resume,chart&nm_xml_tag=tag&nm_xml_label=S&language=&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          $Tem_csv_res = "s";
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "csv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=" . $Tem_csv_res . "&nm_ini_csv_res=grid,resume&nm_all_modules=grid,resume,chart&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full)
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao_print'] != "print") 
      {
          ...
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'];
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['qtline'] == "on" && $this->Ini->Apl_paginacao != "FULL")
          {
              ...
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'] == 10) ? " selected" : "";
              $nm_saida->saida("           <option value=\"10\" " . $obj_sel . ">10</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'] == 20) ? " selected" : "";
              $nm_saida->saida("           <option value=\"20\" " . $obj_sel . ">20</option>\r\n");
              $obj_sel = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'] == 50) ? " selected" : "";
          ...
          $nm_saida->saida("         </td> \r\n");
          $nm_saida->saida("          <td class=\"" . $this->css_scGridToolbarPadd . "\" nowrap valign=\"middle\" align=\"center\" width=\"33%\"> \r\n");
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if (empty($this->nm_grid_sem_reg) && $this->nmgp_botoes['navpage'] == "on" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['nav']) && $this->Ini->Apl_paginacao != "FULL" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'] != "all")
          {
              $Reg_Page  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['qt_lin_grid'];
              $Max_link   = 5;
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['nav']))
          {
   ...
   function html_grid_search()
   {
       ...
       $str_display = empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'])?'none':'';
       if(!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ajax_nav'])
       {
          $nm_saida->saida("   <tr id=\"NM_Grid_Search\" ajax='' style='display:" . $str_display . "'>\r\n");
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ajax_nav'] && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']))
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'] as $cmp => $def)
           {
           ...
           if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['save_grid']))
           {
               return;
           }
           else
       ...
       $nm_saida->saida("            <input type=\"hidden\" name=\"parm\" value=\"\"/> \r\n");
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']))
            {
                foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'] as $cmp => $def)
                {
                    if (isset($def['label'])) {
                        ...
                        if ($cmp == "anio")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "anio";
                           $lin_obj = $this->grid_search_anio($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "periodo")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "periodo";
                           $lin_obj = $this->grid_search_periodo($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "fechaven")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "fechaven";
                           $lin_obj = $this->grid_search_fechaven($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "mesa_cliente")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "mesa_cliente";
                           $lin_obj = $this->grid_search_mesa_cliente($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "descr")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "descr";
                           $lin_obj = $this->grid_search_descr($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
                        if ($cmp == "vendedor")
                        {
                           $this->grid_search_dat[$this->grid_search_seq] = "vendedor";
                           $lin_obj = $this->grid_search_vendedor($this->grid_search_seq, 'N', $def['opc'], $def['val'], $def['label']);
                           $nm_saida->saida("" . $lin_obj . "\r\n");
                        }
       ...
       { 
           ...
           $_SESSION['scriptcase']['saida_html'] = "";
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['save_grid']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']))
           { 
   ...
   {
       global $nm_saida;
       $this->Cmps_select2_grid = array('anio','periodo');
       $lin_obj  = "";
   ...
   {
       $lin_obj  = "";
       $All_cmp_search = array('anio','periodo','fechaven','mesa_cliente','descr','vendedor');
       $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'];
       if (!empty($nmgp_tab_label))
       {
          $nm_tab_campos = explode("?@?", $nmgp_tab_label);
       ...
       if (count($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']) < 6)
       {
           $lin_obj .= "<table id='id_grid_search_all_cmp' cellpadding=0 cellspacing=0>";
           foreach ($All_cmp_search as $cada_cmp)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$cada_cmp]))
               {
                   $lin_obj .= "  <tr>";
   ...
   function grid_search_anio($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_anio_" . $ind . "' style='display:none'>";
       ...
       $lin_obj .= "       <select id='grid_search_anio_cond_" . $ind . "' name='cond_grid_search_anio_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       ...
       $lin_obj .= "       <span id=\"grid_anio_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['anio'] = array();
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "TODOS?#??#?N?@?"; 
       $nmgp_def_dados .= "2020?#?2020?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['anio'][] = "2020";
       $nmgp_def_dados .= "2021?#?2021?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['anio'][] = "2021";
       $nmgp_def_dados .= "2022?#?2022?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['anio'][] = "2022";
       $nmgp_def_dados .= "2023?#?2023?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['anio'][] = "2023";
       $nmgp_def_dados .= "2024?#?2024?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['anio'][] = "2024";
       $nmgp_def_dados .= "2025?#?2025?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['anio'][] = "2025";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_anio_val_" . $ind . "\" name=\"val_grid_search_anio_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       ...
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $anio_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $anio_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function grid_search_periodo($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_periodo_" . $ind . "' style='display:none'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_periodo_cond_" . $ind . "' name='cond_grid_search_periodo_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_periodo_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'] = array();
       $nmgp_def_dados  = ""; 
       $nmgp_def_dados .= "TODOS?#??#?N?@?"; 
       $nmgp_def_dados .= "ENERO?#?1?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "1";
       $nmgp_def_dados .= "FEBRERO?#?2?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "2";
       $nmgp_def_dados .= "MARZO?#?3?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "3";
       $nmgp_def_dados .= "ABRIL?#?4?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "4";
       $nmgp_def_dados .= "MAYO?#?5?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "5";
       $nmgp_def_dados .= "JUNIO?#?6?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "6";
       $nmgp_def_dados .= "JULIO?#?7?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "7";
       $nmgp_def_dados .= "AGOSTO?#?8?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "8";
       $nmgp_def_dados .= "SEPTIEMBRE?#?9?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "9";
       $nmgp_def_dados .= "OCTUBRE?#?10?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "10";
       $nmgp_def_dados .= "NOVIEMBRE?#?11?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "11";
       $nmgp_def_dados .= "DICIEMBRE?#?12?#?N?@?";
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'][] = "12";
       $lin_obj .= "    <SELECT class='" . $this->css_scAppDivToolbarInput . "' id=\"grid_search_periodo_val_" . $ind . "\" name=\"val_grid_search_periodo_" . $ind . "\"  size=1>";
       $delimitador = "##@@";
       $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
       $nm_opcoes  = explode("?@?", $nm_opcoesx);
       $val = isset($val[0]) ? $val[0] : array();
       foreach ($nm_opcoes as $nm_opcao)
       {
          if (!empty($nm_opcao))
          {
             ...
             {
                $periodo_sel = ("S" == $nm_opc_sel) ? " selected" : "";
             }
             $lin_obj .= "       <OPTION value=\"" . NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val) . "\"" . $periodo_sel . ">" . $nm_opc_val . "</OPTION>";
          }
       }
       $lin_obj .= "    </SELECT>";
       $lin_obj .= "       </span>";
   ...
   function grid_search_fechaven($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_fechaven_" . $ind . "' style='display:none'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_fechaven_cond_" . $ind . "' name='cond_grid_search_fechaven_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       ...
       $lin_obj .= "       <span id=\"grid_fechaven_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $Form_base          = "ddmmyyyy";
       $date_format_show   = "";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           if (substr($Part_date, 0,1) == "y")
           {
               ...
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fechaven_ano_val_" . $ind . "' name='val_grid_search_fechaven_ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fechaven_mes_val_" . $ind . "' name='val_grid_search_fechaven_mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fechaven_dia_val_" . $ind . "' name='val_grid_search_fechaven_dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "     <input type=\"hidden\" id=\"sc_grid_fechaven_jq_" . $ind . "\">";
       $lin_obj .= "&nbsp;";
       ...
       $lin_obj .= "       <span id=\"grid_fechaven_in_2_" . $ind . "\" style=\"display:" . $display_in_2 . "\">";
       ...
       foreach ($Tmp_date as $Ind => $Part_date)
       {
           ...
           {
               $val_cmp = (isset($val_r['ano'])) ? $val_r['ano'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fechaven_v2__ano_val_" . $ind . "' name='val_grid_search_fechaven_v2__ano_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=4 alt=\"{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "m")
           {
               $val_cmp = (isset($val_r['mes'])) ? $val_r['mes'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fechaven_v2__mes_val_" . $ind . "' name='val_grid_search_fechaven_v2__mes_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
           if (substr($Part_date, 0,1) == "d")
           {
               $val_cmp = (isset($val_r['dia'])) ? $val_r['dia'] : "";
               $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_fechaven_v2__dia_val_" . $ind . "' name='val_grid_search_fechaven_v2__dia_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=2 alt=\"{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, " . $AutoTab . ", enterTab: false}\">";
           }
       }
       $lin_obj .= "     <input type=\"hidden\" id=\"sc_grid_fechaven_v2__jq_" . $ind . "\">";
       $lin_obj .= "&nbsp;";
       $lin_obj .= "" . $date_format_show . "";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
   ...
   function grid_search_mesa_cliente($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_mesa_cliente_" . $ind . "' style='display:none'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_mesa_cliente_cond_" . $ind . "' name='cond_grid_search_mesa_cliente_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_mesa_cliente_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $mesa_cliente = $val_cmp;
       if ($mesa_cliente != "")
       {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       {
           $sAutocompValue = $nmgp_def_dados[0][$mesa_cliente];
       }
       else
       {
   ...
   function grid_search_descr($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_descr_" . $ind . "' style='display:none'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_descr_cond_" . $ind . "' name='cond_grid_search_descr_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_descr_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $descr = $val_cmp;
       if ($descr != "")
       {
      ...
      if ($rs = $this->Db->SelectLimit($nm_comando, 10, 0)) 
       ...
       if (isset($nmgp_def_dados[0][$descr]))
       {
           $sAutocompValue = $nmgp_def_dados[0][$descr];
       }
       else
       {
           $sAutocompValue = $val_cmp;
       ...
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $lin_obj .= "     <input  type=\"text\" class='sc-js-input " . $this->css_scAppDivToolbarInput . "' id='grid_search_descr_val_" . $ind . "' name='val_grid_search_descr_" . $ind . "' value=\"" . NM_encode_input($val_cmp) . "\" size=50 alt=\"{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\" style='display: none'>";
       $tmp_pos = strpos($val_cmp, "##@@");
       if ($tmp_pos !== false) {
           $val_cmp = substr($val_cmp, ($tmp_pos + 4));
           $sAutocompValue = substr($sAutocompValue, ($tmp_pos + 4));
       }
       $lin_obj .= "     <input class='sc-js-input " . $this->css_scAppDivToolbarInput . "' type='text' id='id_ac_grid_descr" . $ind . "' name='val_grid_search_descr_autocomp" . $ind . "' size='50' value='" . NM_encode_input($sAutocompValue) . "' alt=\"{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}\">";
       $lin_obj .= "       </span>";
       $lin_obj .= "          </div>";
       $lin_obj .= "          <div class='scGridFilterTagListFilterBar'>";
       $lin_obj .= nmButtonOutput($this->arr_buttons, "bapply_appdiv", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "closeAllTags();setTimeout(function() {nm_proc_grid_search($ind, 'proc_grid_search', 'grid_search')}, 200);", "grid_search_apply_" . $ind . "", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
   ...
   function grid_search_vendedor($ind, $ajax, $opc="", $val=array(), $label='')
   {
       $lin_obj  = "";
       $lin_obj .= "     <div class='scGridFilterTagListFilter' id='grid_search_vendedor_" . $ind . "' style='display:none'>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterLabel'>". NM_encode_input($label) ." <span class='scGridFilterTagListFilterLabelClose' onclick='closeAllTags(this);'></span></div>";
       $lin_obj .= "         <div class='scGridFilterTagListFilterInputs'>";
       if (empty($opc))
       {
       ...
       $lin_obj .= "       <select id='grid_search_vendedor_cond_" . $ind . "' name='cond_grid_search_vendedor_" . $ind . "' class='" . $this->css_scAppDivToolbarInput . "' style='vertical-align: middle; display: none'>";
       $selected = ($opc == "eq") ? " selected" : "";
       $lin_obj .= "        <option value='eq'" . $selected . ">" . $this->Ini->Nm_lang['lang_srch_exac'] . "</option>";
       $lin_obj .= "       </select>";
       if ($opc == "nu" || $opc == "nn" || $opc == "ep" || $opc == "ne")
       ...
       $lin_obj .= "       <span id=\"grid_vendedor_" . $ind . "\" style=\"display:" . $display_in_1 . "\">";
       $val_cmp = (isset($val[0][0])) ? $val[0][0] : "";
       $vendedor = $val_cmp;
       if ($vendedor != "")
       {
   ...
   function lookup_ajax_mesa_cliente($mesa_cliente)
   {
       $mesa_cliente = substr($this->Db->qstr($mesa_cliente), 1, -1);
       $this->NM_case_insensitive = false;
       $mesa_cliente_look = substr($this->Db->qstr($mesa_cliente), 1, -1); 
       $nmgp_def_dados = array(); 
   ...
   function lookup_ajax_descr($descr)
   {
       $descr = substr($this->Db->qstr($descr), 1, -1);
       $this->NM_case_insensitive = false;
       $descr_look = substr($this->Db->qstr($descr), 1, -1); 
       $nmgp_def_dados = array(); 
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv2/grid_log_pedidos_borrados";
   ...
   function JS_grid_search()
   {
       ...
       $nm_saida->saida(" function sc_grid_log_pedidos_borrados_valida_mes(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida(" function sc_grid_log_pedidos_borrados_valida_dia(obj)\r\n");
       $nm_saida->saida(" {\r\n");
       ...
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida(" }\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fechaven_mes'] =  'sc_grid_log_pedidos_borrados_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fechaven_dia'] =  'sc_grid_log_pedidos_borrados_valida_dia(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fechaven_v2__mes'] =  'sc_grid_log_pedidos_borrados_valida_mes(this)';\r\n");
       $nm_saida->saida("     Tab_evt_grid_search['fechaven_v2__dia'] =  'sc_grid_log_pedidos_borrados_valida_dia(this)';\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ajax_nav'])
       { 
           ...
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fechaven_mes']", 'value' => 'sc_grid_log_pedidos_borrados_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fechaven_dia']", 'value' => 'sc_grid_log_pedidos_borrados_valida_dia(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fechaven_v2__mes']", 'value' => 'sc_grid_log_pedidos_borrados_valida_mes(this)');
           $this->Ini->Arr_result['setVar'][] = array('var' => "Tab_evt_grid_search['fechaven_v2__dia']", 'value' => 'sc_grid_log_pedidos_borrados_valida_dia(this)');
       } 
       $nm_saida->saida("     function Sc_carga_select2_grid_anio(SEQ)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("      $(\"#grid_search_anio_val_\" + SEQ).select2(\r\n");
       $nm_saida->saida("        {\r\n");
       ...
       $nm_saida->saida("      );\r\n");
       $nm_saida->saida("     }\r\n");
       $nm_saida->saida("     function Sc_carga_select2_grid_periodo(SEQ)\r\n");
       $nm_saida->saida("     {\r\n");
       $nm_saida->saida("      $(\"#grid_search_periodo_val_\" + SEQ).select2(\r\n");
       $nm_saida->saida("        {\r\n");
       $nm_saida->saida("          language: {\r\n");
       $nm_saida->saida("            noResults: function() {\r\n");
       $nm_saida->saida("              return \"" . $this->Ini->Nm_lang['lang_autocomp_notfound'] . "\";\r\n");
       ...
       $nm_saida->saida("                 if (tmp == 'fechaven')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     cps[x] = 'fechaven_dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fechaven_mes';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fechaven_v2__dia';\r\n");
       $nm_saida->saida("                     x++;\r\n");
       $nm_saida->saida("                     cps[x] = 'fechaven_v2__mes';\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                     $('#sc_grid_fechaven_jq_' + i).datepicker({\r\n");
       $nm_saida->saida("                        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("                          var_dt_ini  = document.getElementById('grid_search_fechaven_dia_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_fechaven_mes_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_fechaven_ano_val_' + i_calendar).value;\r\n");
       $nm_saida->saida("                          document.getElementById('sc_grid_fechaven_jq_' + i_calendar).value = var_dt_ini;\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("                          aParts  = dateText.split(\"/\");\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_fechaven_dia_val_' + i_calendar).value = aParts[0];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_fechaven_mes_val_' + i_calendar).value = aParts[1];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_fechaven_ano_val_' + i_calendar).value = aParts[2];\r\n");
       $nm_saida->saida("                        },\r\n");
       ...
       $nm_saida->saida("                     });\r\n");
       $nm_saida->saida("                     var i_calendar = i;\r\n");
       $nm_saida->saida("                     $('#sc_grid_fechaven_v2__jq_' + i).datepicker({\r\n");
       $nm_saida->saida("                        beforeShow: function(input, inst) {\r\n");
       $nm_saida->saida("                          var_dt_ini  = document.getElementById('grid_search_fechaven_v2__dia_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_fechaven_v2__mes_val_' + i_calendar).value + '/';\r\n");
       $nm_saida->saida("                          var_dt_ini += document.getElementById('grid_search_fechaven_v2__ano_val_' + i_calendar).value;\r\n");
       $nm_saida->saida("                          document.getElementById('sc_grid_fechaven_v2__jq_' + i_calendar).value = var_dt_ini;\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        onClose: function(dateText, inst) {\r\n");
       $nm_saida->saida("                          aParts  = dateText.split(\"/\");\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_fechaven_v2__dia_val_' + i_calendar).value = aParts[0];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_fechaven_v2__mes_val_' + i_calendar).value = aParts[1];\r\n");
       $nm_saida->saida("                          document.getElementById('grid_search_fechaven_v2__ano_val_' + i_calendar).value = aParts[2];\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        showWeek: true,\r\n");
       $nm_saida->saida("                        numberOfMonths: 1,\r\n");
       $nm_saida->saida("                        changeMonth: true,\r\n");
       ...
       $nm_saida->saida("             {\r\n");
       $nm_saida->saida("                 tmp = Tab_obj_grid_search[i];\r\n");
       $nm_saida->saida("                 if (tmp == 'mesa_cliente')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_mesa_cliente = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_mesa_cliente\" + i).autocomplete({\r\n");
       ...
       $nm_saida->saida("                             field: \"mesa_cliente\",\r\n");
       ...
       $nm_saida->saida("                          $(\"#grid_search_mesa_cliente_val_\" + x_mesa_cliente).val(ui.item.value);\r\n");
       ...
       $nm_saida->saida("                             $(\"#grid_search_mesa_cliente_val_\" + x_mesa_cliente).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'descr')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_descr = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_descr\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#grid_search_descr_val_\" + x_descr).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#grid_search_descr_val_\" + x_descr).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (tmp == 'vendedor')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                      var x_vendedor = i;\r\n");
       $nm_saida->saida("                      $(\"#id_ac_grid_vendedor\" + i).autocomplete({\r\n");
       $nm_saida->saida("                        minLength: 1,\r\n");
       $nm_saida->saida("                        source: function (request, response) {\r\n");
       $nm_saida->saida("                        $.ajax({\r\n");
       $nm_saida->saida("                          url: \"index.php\",\r\n");
       ...
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        select: function (event, ui) {\r\n");
       $nm_saida->saida("                          $(\"#grid_search_vendedor_val_\" + x_vendedor).val(ui.item.value);\r\n");
       $nm_saida->saida("                          $(this).val(ui.item.label);\r\n");
       $nm_saida->saida("                          event.preventDefault();\r\n");
       $nm_saida->saida("                        },\r\n");
       $nm_saida->saida("                        focus: function (event, ui) {\r\n");
       ...
       $nm_saida->saida("                        change: function (event, ui) {\r\n");
       $nm_saida->saida("                          if (null == ui.item) {\r\n");
       $nm_saida->saida("                             $(\"#grid_search_vendedor_val_\" + x_vendedor).val( $(this).val() );\r\n");
       $nm_saida->saida("                          }\r\n");
       $nm_saida->saida("                        }\r\n");
       $nm_saida->saida("                      });\r\n");
       $nm_saida->saida("                 }\r\n");
       ...
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'anio')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_select(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'periodo')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     result  = grid_search_get_select(obj_dyn + i, '');\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'fechaven')\r\n");
       $nm_saida->saida("                 {\r\n");
       ...
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'mesa_cliente')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'descr')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
       $nm_saida->saida("                 if (Tab_obj_grid_search[i] == 'vendedor')\r\n");
       $nm_saida->saida("                 {\r\n");
       $nm_saida->saida("                     obj_ac  = 'id_ac_grid_' + Tab_obj_grid_search[i] + i;\r\n");
       $nm_saida->saida("                     result  = grid_search_get_text(obj_dyn + i, obj_ac);\r\n");
       $nm_saida->saida("                 }\r\n");
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ]))) == 0)
                    {
                        $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][ $field ]));
                    }
                }
            }
        }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('anio', 'periodo', 'fechaven', 'numero', 'mesa_cliente', 'descr', 'cantidad', 'valorpar', 'vendedor'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $keywords = preg_quote($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][2], '/');
                        $str_value = preg_replace('/'. $keywords .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_log_pedidos_borrados_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_log_pedidos_borrados_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   ...
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       $nm_saida->saida("   document.getElementById('first_bot').disabled = true;\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
       ...
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               $nm_saida->saida("   document.getElementById('forward_bot').disabled = true;\r\n");
               $nm_saida->saida("   document.getElementById('forward_bot').className = \"scButton_" . $this->arr_buttons['bcons_avanca']['style'] . " disabled\";\r\n");
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_log_pedidos_borrados', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_log_pedidos_borrados\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_log_pedidos_borrados_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_log_pedidos_borrados_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_log_pedidos_borrados/grid_log_pedidos_borrados_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_log_pedidos_borrados_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_log_pedidos_borrados_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_log_pedidos_borrados@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_log_pedidos_borrados_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_log_pedidos_borrados_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_log_pedidos_borrados']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_log_pedidos_borrados_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_log_pedidos_borrados')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_log_pedidos_borrados', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
