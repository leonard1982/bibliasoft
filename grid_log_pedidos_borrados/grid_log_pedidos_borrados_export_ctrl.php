<?php
@session_start() ;
$_SESSION['scriptcase']['grid_log_pedidos_borrados']['sc_process_barr'] = true;
require_once('../grid_log_pedidos_borrados/index.php');
unset($_SESSION['scriptcase']['grid_log_pedidos_borrados']['sc_process_barr']);
$ExportCtrl = new grid_log_pedidos_borrados_export_control;
$ExportCtrl->Export_barr();

class grid_log_pedidos_borrados_export_control
{
