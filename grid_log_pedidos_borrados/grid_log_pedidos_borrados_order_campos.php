...
<?php
   ...
   $Ord_Cmp = new grid_log_pedidos_borrados_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_log_pedidos_borrados_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["anio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["anio"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["anio"] : "Año";
   $tab_ger_campos['periodo'] = "on";
   $tab_def_campos['periodo'] = "periodo";
   $tab_labels["periodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["periodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["periodo"] : "Periodo";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["numero"] : "Numero";
   $tab_ger_campos['mesa_cliente'] = "on";
   $tab_def_campos['mesa_cliente'] = "mesa_cliente";
   $tab_labels["mesa_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["mesa_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["mesa_cliente"] : "Mesa/Cliente";
   $tab_ger_campos['descr'] = "on";
   $tab_def_campos['descr'] = "descr";
   $tab_labels["descr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["descr"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["descr"] : "Producto";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["valorpar"] : "Valor Línea";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['labels']["vendedor"] : "Vendedor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_log_pedidos_borrados_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_log_pedidos_borrados']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
