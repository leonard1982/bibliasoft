...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_log_pedidos_borrados"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_log_pedidos_borrados"]);
   }
