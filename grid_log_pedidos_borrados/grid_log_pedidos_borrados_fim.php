...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_log_pedidos_borrados"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_log_pedidos_borrados"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_log_pedidos_borrados']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_log_pedidos_borrados']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_log_pedidos_borrados']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_log_pedidos_borrados']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_log_pedidos_borrados']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_log_pedidos_borrados</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_log_pedidos_borrados']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_log_pedidos_borrados']['embutida_filho'] as $ind => $sc_init)
          {
