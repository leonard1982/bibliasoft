...
class grid_log_pedidos_borrados_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_log_pedidos_borrados_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_log_pedidos_borrados_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_log_pedidos_borrados_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_mesa_cliente')
      {
          $mesa_cliente = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_mesa_cliente($mesa_cliente);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_descr')
      {
          $descr = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_descr($descr);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   {
      $mesa_cliente = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $mesa_cliente);
   ...
   {
      $vendedor = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $vendedor);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fechaven";$Nm_datas[] = "fechaven";$Nm_numeric[] = "anio";$Nm_numeric[] = "periodo";$Nm_numeric[] = "mesa_cliente";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "valorpar";$Nm_numeric[] = "vendedor";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "fechaven";$Nm_datas[] = "fechaven";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_log_pedidos_borrados/grid_log_pedidos_borrados_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_log_pedidos_borrados_ajax_search.js"></script>
 <script type="text/javascript" src="grid_log_pedidos_borrados_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_log_pedidos_borrados_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_log_pedidos_borrados']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_log_pedidos_borrados']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_mesa_cliente_cond#NMF#' + search_get_sel_txt('SC_mesa_cliente_cond') + '@NMF@';
  str_out += 'SC_mesa_cliente#NMF#' + search_get_text('SC_mesa_cliente') + '@NMF@';
  str_out += 'id_ac_mesa_cliente#NMF#' + search_get_text('id_ac_mesa_cliente') + '@NMF@';
  str_out += 'SC_descr_cond#NMF#' + search_get_sel_txt('SC_descr_cond') + '@NMF@';
  str_out += 'SC_descr#NMF#' + search_get_text('SC_descr') + '@NMF@';
  str_out += 'id_ac_descr#NMF#' + search_get_text('id_ac_descr') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_mesa_cliente").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_mesa_cliente").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_mesa_cliente",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_mesa_cliente").val(ui.item.value);
     ...
     change: function (event, ui) {
       if (null == ui.item) {
          $("#SC_mesa_cliente").val( $(this).val() );
       }
     }
   });
   scClass = $("#id_ac_descr").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_descr").autocomplete({
     minLength: 1,
     classes: { 'ui-autocomplete': scClass + 'Ac' },
     source: function (request, response) {
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_descr",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Pedidos Borrados</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $mesa_cliente_cond, $mesa_cliente, $mesa_cliente_autocomp,
             $descr_cond, $descr, $descr_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $anio = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['anio']; 
          $anio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['anio_cond']; 
          $periodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['periodo']; 
          $periodo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['periodo_cond']; 
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_cond']; 
          $mesa_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['mesa_cliente']; 
          $mesa_cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['mesa_cliente_cond']; 
          $descr = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['descr']; 
          $descr_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['descr_cond']; 
          $vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['vendedor']; 
          $vendedor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['vendedor_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($mesa_cliente_cond) || empty($mesa_cliente_cond))
      {
         $mesa_cliente_cond = "eq";
      }
      if (!isset($descr_cond) || empty($descr_cond))
      {
         $descr_cond = "eq";
      }
      ...
      $str_hide_mesa_cliente = (in_array($mesa_cliente_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_descr = (in_array($descr_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_mesa_cliente = ('bw' == $mesa_cliente_cond) ? $display_aberto : $display_fechado;
      $str_display_descr = ('bw' == $descr_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($mesa_cliente) || $mesa_cliente == "")
      {
          $mesa_cliente = "";
      }
      if (isset($mesa_cliente) && !empty($mesa_cliente))
      {
         $tmp_pos = strpos($mesa_cliente, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $mesa_cliente = substr($mesa_cliente, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($descr, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $descr = substr($descr, 0, $tmp_pos);
         }
      }
...
?>
      ...
      <INPUT type="hidden" id="SC_mesa_cliente_cond" name="mesa_cliente_cond" value="eq">

    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['mesa_cliente'])) ? $this->New_label['mesa_cliente'] : "Mesa/Cliente";
 $nmgp_tab_label .= "mesa_cliente?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_mesa_cliente"  <?php echo $str_hide_mesa_cliente?>><?php
      if ($mesa_cliente != "")
      {
      $mesa_cliente_look = substr($this->Db->qstr($mesa_cliente), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      {
            nmgp_Form_Num_Val($mesa_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $mesa_cliente;
      }
?>
<INPUT  type="text" id="SC_mesa_cliente" name="mesa_cliente" value="<?php echo NM_encode_input($mesa_cliente) ?>" size=50 alt="{datatype: 'integer', maxLength: 360, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_mesa_cliente" name="mesa_cliente_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 360, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_descr_cond" name="descr_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['descr'])) ? $this->New_label['descr'] : "Producto";
 $nmgp_tab_label .= "descr?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_descr"  <?php echo $str_hide_descr?>><?php
      if ($descr != "")
      {
      $descr_look = substr($this->Db->qstr($descr), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      {
          $sAutocompValue = $descr;
      }
?>
<INPUT  type="text" id="SC_descr" name="descr" value="<?php echo NM_encode_input($descr) ?>"  size=50 alt="{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_descr" name="descr_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_vendedor"  <?php echo $str_hide_vendedor?>><?php
      if ($vendedor != "")
      {
      $vendedor_look = substr($this->Db->qstr($vendedor), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      {
            nmgp_Form_Num_Val($vendedor, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $vendedor;
      }
?>
<INPUT  type="text" id="SC_vendedor" name="vendedor" value="<?php echo NM_encode_input($vendedor) ?>" size=50 alt="{datatype: 'integer', maxLength: 360, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_vendedor" name="vendedor_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 360, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
<?php
   if (is_file("grid_log_pedidos_borrados_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opc_psq'])
   {
...
?>
   <?php echo nmButtonOutput($this->arr_buttons, "bpesquisa", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "document.F1.bprocessa.value='pesq'; setTimeout(function() {nm_submit_form()}, 200);", "sc_b_pesq_bot", "", "Generar", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "" . $this->Ini->Nm_lang['lang_btns_srch_lone_hint'] . "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
    </td>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.mesa_cliente_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_mesa_cliente'), document.F1.mesa_cliente_cond, 'mesa_cliente');
   document.F1.mesa_cliente.value = "";
   document.F1.mesa_cliente_autocomp.value = "";
   document.F1.descr_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_descr'), document.F1.descr_cond, 'descr');
   document.F1.descr.value = "";
   document.F1.descr_autocomp.value = "";
 ...
 {
    $('#SC_fechaven_dia').bind('change', function() {sc_grid_log_pedidos_borrados_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_grid_log_pedidos_borrados_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_grid_log_pedidos_borrados_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_grid_log_pedidos_borrados_valida_mes(this)});
 }
 function sc_grid_log_pedidos_borrados_valida_dia(obj)
 {
 ...
 function sc_grid_log_pedidos_borrados_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_log_pedidos_borrados/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_mesa_cliente_cond'] = 'cond';
      $tp_fields['SC_mesa_cliente'] = 'text_aut';
      $tp_fields['id_ac_mesa_cliente'] = 'text_aut';
      $tp_fields['SC_descr_cond'] = 'cond';
      $tp_fields['SC_descr'] = 'text_aut';
      $tp_fields['id_ac_descr'] = 'text_aut';
   ...
   function trata_campos()
   {
      global $anio_cond, $anio,
             ...
             $mesa_cliente_cond, $mesa_cliente, $mesa_cliente_autocomp,
             $descr_cond, $descr, $descr_autocomp,
             $vendedor_cond, $vendedor, $vendedor_autocomp, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq'] = array();
      if (!empty($mesa_cliente_autocomp) && empty($mesa_cliente))
      {
          $mesa_cliente = $mesa_cliente_autocomp;
      }
      if (!empty($descr_autocomp) && empty($descr))
      {
          $descr = $descr_autocomp;
      }
      ...
      $mesa_cliente_cond_salva = $mesa_cliente_cond; 
      if (!isset($mesa_cliente_input_2) || $mesa_cliente_input_2 == "")
      {
          $mesa_cliente_input_2 = $mesa_cliente;
      }
      $descr_cond_salva = $descr_cond; 
      if (!isset($descr_input_2) || $descr_input_2 == "")
      {
          $descr_input_2 = $descr;
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['anio'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['psq_check_ret']['periodo'])) {
      ...
      if ($mesa_cliente_cond != "in")
      {
          nm_limpa_numero($mesa_cliente, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($vendedor_cond != "in")
      {
          nm_limpa_numero($vendedor, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['anio'] = $anio; 
      if (is_array($anio) && !empty($anio))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0] = $anio;
      }
      elseif ($anio_cond_salva == "nu" || $anio_cond_salva == "nn" || $anio_cond_salva == "ep" || $anio_cond_salva == "ne" || !empty($anio))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0][0] = $anio;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['anio_cond'] = $anio_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['cmp'] = "anio"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['opc'] = $anio_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['anio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['periodo'] = $periodo; 
      if (is_array($periodo) && !empty($periodo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0] = $periodo;
      }
      elseif ($periodo_cond_salva == "nu" || $periodo_cond_salva == "nn" || $periodo_cond_salva == "ep" || $periodo_cond_salva == "ne" || !empty($periodo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0][0] = $periodo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['periodo_cond'] = $periodo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['cmp'] = "periodo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['opc'] = $periodo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['periodo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      if (!empty($fechaven_dia) || !empty($fechaven_mes) || !empty($fechaven_ano) || $fechaven_cond_salva == "nu" || $fechaven_cond_salva == "nn" || $fechaven_cond_salva == "ep" || $fechaven_cond_salva == "ne")
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $fechaven_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $fechaven_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $fechaven_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $fechaven_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $fechaven_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $fechaven_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['cmp'] = "fechaven"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['opc'] = $fechaven_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['fechaven'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['mesa_cliente'] = $mesa_cliente; 
      if (is_array($mesa_cliente) && !empty($mesa_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0] = $mesa_cliente;
      }
      elseif ($mesa_cliente_cond_salva == "nu" || $mesa_cliente_cond_salva == "nn" || $mesa_cliente_cond_salva == "ep" || $mesa_cliente_cond_salva == "ne" || !empty($mesa_cliente))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0][0] = $mesa_cliente;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['mesa_cliente_cond'] = $mesa_cliente_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['cmp'] = "mesa_cliente"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['opc'] = $mesa_cliente_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['mesa_cliente'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['descr'] = $descr; 
      if (is_array($descr) && !empty($descr))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0] = $descr;
      }
      elseif ($descr_cond_salva == "nu" || $descr_cond_salva == "nn" || $descr_cond_salva == "ep" || $descr_cond_salva == "ne" || !empty($descr))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0][0] = $descr;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['descr_cond'] = $descr_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['cmp'] = "descr"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['opc'] = $descr_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['descr'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['vendedor'] = $vendedor; 
      if (is_array($vendedor) && !empty($vendedor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0] = $vendedor;
      }
      elseif ($vendedor_cond_salva == "nu" || $vendedor_cond_salva == "nn" || $vendedor_cond_salva == "ep" || $vendedor_cond_salva == "ne" || !empty($vendedor))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['val'][0][0] = $vendedor;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['vendedor_cond'] = $vendedor_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['cmp'] = "vendedor"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid]['opc'] = $vendedor_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['vendedor'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'] = $Temp_Busca;
      }
      if ($mesa_cliente_cond != "in" && $mesa_cliente_cond != "bw" && !empty($mesa_cliente) && !is_numeric($mesa_cliente))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Mesa/Cliente";
      }
      if ($mesa_cliente_cond == "bw" && ((!empty($mesa_cliente) && !is_numeric($mesa_cliente)) || (!empty($mesa_cliente_input_2) && !is_numeric($mesa_cliente_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Mesa/Cliente";
      }
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['mesa_cliente'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['mesa_cliente'] = $cmp1;
      }
      else
      {
          $cmp1 = $mesa_cliente;
    ...
    if ($descr != '') {
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['descr'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['descr'] = $descr;
      }
      $nmgp_def_dados = array();
    if ($vendedor != '') {
      $vendedor_look = substr($this->Db->qstr($vendedor), 1, -1); 
   ...
   { 
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']['fechaven_input_2'] = $val[1];
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['fechaven']['label'] = $nmgp_tab_label['fechaven'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['fechaven']['descr'] = $nmgp_tab_label['fechaven'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['grid_pesq']['fechaven']['hint']  = $nmgp_tab_label['fechaven'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }

      //----- $mesa_cliente
      $this->Date_part = false;
      if (isset($mesa_cliente) || $mesa_cliente_cond == "nu" || $mesa_cliente_cond == "nn" || $mesa_cliente_cond == "ep" || $mesa_cliente_cond == "ne")
      {
         $this->monta_condicao("mesa_cliente", $mesa_cliente_cond, $mesa_cliente, "", "mesa_cliente");
      }

      //----- $descr
      $this->Date_part = false;
      if (isset($descr) || $descr_cond == "nu" || $descr_cond == "nn" || $descr_cond == "ep" || $descr_cond == "ne")
      {
         $this->monta_condicao("descr", $descr_cond, $descr, "", "descr");
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_dyn_search'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_filtro'] = "";
      }
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_log_pedidos_borrados']['where_pesq'];
