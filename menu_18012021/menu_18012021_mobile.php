...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_18012021"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_18012021"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_18012021"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_18012021_menuData["data"]) && is_array($menu_18012021_menuData["data"]) && !empty($menu_18012021_menuData["data"]))
    {
        foreach($menu_18012021_menuData["data"] as $arr_item)
        {
...
<table width="100%" height="67px" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($menu_18012021_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
