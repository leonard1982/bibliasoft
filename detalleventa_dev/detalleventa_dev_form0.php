<?php
class detalleventa_dev_form extends detalleventa_dev_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Elimine el item que no va a devolver"); } else { echo strip_tags("Elimine el item que no va a devolver"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>detalleventa_dev/detalleventa_dev_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("detalleventa_dev_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['last'] : 'off'); ?>";
...
function navpage_atualiza(str_navpage)
{
 ...
 function nm_field_disabled(Fields, Opt, Seq, Opcao) {
  ...
  for (i=0; i < Field.length; i++)
  {
     ...
     if (F_name == "colores_")
     {
        for (ii=ini; ii < xx; ii++)
        {
            cmp_name = "colores_" + ii + "_autocomp";
            $('input[name=' + cmp_name + ']').prop("disabled", F_opc);
            if (F_opc == "disabled" || F_opc == true) {
                $('input[name=' + cmp_name + ']').addClass("scFormInputDisabledMult");
            }
            ...
            cmp_name = "colores_" + ii + "_autocomp_cap";
            $('input[id=' + cmp_name + ']').prop("disabled", F_opc);
            if (F_opc == "disabled" || F_opc == true) {
                $('#' + cmp_name).hide();
            }
     ...
     if (F_name == "tallas_")
     {
        for (ii=ini; ii < xx; ii++)
        {
            ...
            cmp_name = "tallas_" + ii + "_autocomp_cap";
            $('input[id=' + cmp_name + ']').prop("disabled", F_opc);
            if (F_opc == "disabled" || F_opc == true) {
                $('#' + cmp_name).hide();
            }
     ...
     if (F_name == "sabor_")
     {
        for (ii=ini; ii < xx; ii++)
        {
            ...
            cmp_name = "sabor_" + ii + "_autocomp_cap";
            $('input[id=' + cmp_name + ']').prop("disabled", F_opc);
            if (F_opc == "disabled" || F_opc == true) {
                $('#' + cmp_name).hide();
            }
     ...
     if (F_name == "idbod_")
     {
        for (ii=ini; ii < xx; ii++)
        {
            ...
            cmp_name = "idbod_" + ii + "_autocomp_cap";
            $('input[id=' + cmp_name + ']').prop("disabled", F_opc);
            if (F_opc == "disabled" || F_opc == true) {
                $('#' + cmp_name).hide();
            }
     ...
     if (F_name == "unidadmayor_")
     {
        for (ii=ini; ii < xx; ii++)
        {
            cmp_name = "unidadmayor_" + ii;
     ...
     if (F_name == "valorunit_")
     {
        for (ii=ini; ii < xx; ii++)
        {
            cmp_name = "valorunit_" + ii;
            $('input[name=' + cmp_name + ']').prop("disabled", F_opc);
            if (F_opc == "disabled" || F_opc == true) {
                $('input[name=' + cmp_name + ']').addClass("scFormInputDisabledMult");
            }
 ...
 function nm_field_disabled_reset() {
  for (var i = 0; i < iAjaxNewLine; i++) {
    ...
    nm_field_disabled("idbod_=enabled", "", i);
    nm_field_disabled("unidadmayor_=enabled", "", i);
    nm_field_disabled("cantidad_=enabled", "", i);
    nm_field_disabled("valorunit_=enabled", "", i);
  }
 } // nm_field_disabled_reset
<?php

include_once('detalleventa_dev_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idpro_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idpro_" != sId ? sId.substr(6) : "";
   sc_detalleventa_dev_idpro__onfocus("id_sc_field_" + sId, sRow);
  ...
  var iSeq_idbod_ = $(".sc-ui-autocomp-idbod_", elem).attr("id").substr(12);

  $(".sc-ui-autocomp-idbod_", elem).on("focus", function() {
   var sId = $(this).attr("id").substr(6);
   scEventControl_data[sId]["autocomp"] = true;
  }).on("blur", function() {
   var sId = $(this).attr("id").substr(6), sRow = "idbod_" != sId ? sId.substr(6) : "";
   if ("" == $(this).val()) {
    $("#id_sc_field_" + sId).val("");
   }
   scEventControl_data[sId]["autocomp"] = false;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      term: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idbod_",
      script_case_init: document.F2.script_case_init.value
     }
     return query;
    }
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idbod_" != sId ? sId.substr(6) : "";
   sc_detalleventa_dev_idbod__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  var iSeq_colores_ = $(".sc-ui-autocomp-colores_", elem).attr("id").substr(14);

  $(".sc-ui-autocomp-colores_", elem).on("focus", function() {
   var sId = $(this).attr("id").substr(6);
   scEventControl_data[sId]["autocomp"] = true;
  }).on("blur", function() {
   var sId = $(this).attr("id").substr(6), sRow = "colores_" != sId ? sId.substr(8) : "";
   if ("" == $(this).val()) {
    $("#id_sc_field_" + sId).val("");
   }
   scEventControl_data[sId]["autocomp"] = false;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      term: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_colores_?@?idpro_?#?" + scAjaxGetFieldText("idpro_" + iSeq_colores_) + "",
      script_case_init: document.F2.script_case_init.value
     }
     return query;
    }
   ...
   var sId = $(this).attr("id").substr(6), sRow = "colores_" != sId ? sId.substr(8) : "";
   sc_detalleventa_dev_colores__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  var iSeq_tallas_ = $(".sc-ui-autocomp-tallas_", elem).attr("id").substr(13);

  $(".sc-ui-autocomp-tallas_", elem).on("focus", function() {
   var sId = $(this).attr("id").substr(6);
   scEventControl_data[sId]["autocomp"] = true;
  }).on("blur", function() {
   var sId = $(this).attr("id").substr(6), sRow = "tallas_" != sId ? sId.substr(7) : "";
   if ("" == $(this).val()) {
    $("#id_sc_field_" + sId).val("");
   }
   scEventControl_data[sId]["autocomp"] = false;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      term: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_tallas_?@?idpro_?#?" + scAjaxGetFieldText("idpro_" + iSeq_tallas_) + "",
      script_case_init: document.F2.script_case_init.value
     }
     return query;
    }
   ...
   var sId = $(this).attr("id").substr(6), sRow = "tallas_" != sId ? sId.substr(7) : "";
   sc_detalleventa_dev_tallas__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  var iSeq_sabor_ = $(".sc-ui-autocomp-sabor_", elem).attr("id").substr(12);

  $(".sc-ui-autocomp-sabor_", elem).on("focus", function() {
   var sId = $(this).attr("id").substr(6);
   scEventControl_data[sId]["autocomp"] = true;
  }).on("blur", function() {
   var sId = $(this).attr("id").substr(6), sRow = "sabor_" != sId ? sId.substr(6) : "";
   if ("" == $(this).val()) {
    $("#id_sc_field_" + sId).val("");
   }
   scEventControl_data[sId]["autocomp"] = false;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      term: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_sabor_?@?idpro_?#?" + scAjaxGetFieldText("idpro_" + iSeq_sabor_) + "",
      script_case_init: document.F2.script_case_init.value
     }
     return query;
    }
   ...
   var sId = $(this).attr("id").substr(6), sRow = "sabor_" != sId ? sId.substr(6) : "";
   sc_detalleventa_dev_sabor__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("detalleventa_dev_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['detalleventa_dev'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['detalleventa_dev'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Elimine el item que no va a devolver"; } else { echo "Elimine el item que no va a devolver"; } ?></span></td>
            <td id="lin1_col2" class="scFormHeaderFont"><span><?php echo "Modifique la cantidad según sea el caso" ?></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['balterarsel']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['balterarsel']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['balterarsel']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['balterarsel']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['balterarsel'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['bexcluirsel']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['bexcluirsel']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['bexcluirsel']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['bexcluirsel']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['bexcluirsel'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['sc_btn_0']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['sc_btn_0']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['sc_btn_0']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['sc_btn_0']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['sc_btn_0'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['empty_filter'] = true;
       }
       echo "<tr><td>";
  }
?>
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['cantidad_']) && $this->nmgp_cmp_hidden['cantidad_'] == 'off') { $sStyleHidden_cantidad_ = 'display: none'; }
      ...
      if (!isset($this->nm_new_label['cantidad_'])) {
          $this->nm_new_label['cantidad_'] = "Cantidad a devolver"; } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_detalleventa_dev);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_detalleventa_dev = $this->form_vert_detalleventa_dev;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_detalleventa_dev))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_detalleventa_dev as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->iddet_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['iddet_'];
       $this->numfac_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['numfac_'];
       $this->remision_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['remision_'];
       $this->devuelto_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['devuelto_'];
       $this->iddev_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['iddev_'];
       $this->procesado_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['procesado_'];
       ...
       elseif ($Line_Add)
       {
        ...
        $this->idpro_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['idpro_']; 
       $idpro_ = $this->idpro_; 
       $sStyleHidden_idpro_ = '';
       ...
       $this->colores_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['colores_']; 
       ...
       $this->tallas_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['tallas_']; 
       ...
       $this->sabor_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['sabor_']; 
       $sabor_ = $this->sabor_; 
       $sStyleHidden_sabor_ = '';
       ...
       $this->idbod_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['idbod_']; 
       $idbod_ = $this->idbod_; 
       $sStyleHidden_idbod_ = '';
       ...
       $this->unidadmayor_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['unidadmayor_']; 
       ...
       $this->stockubica_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['stockubica_']; 
       ...
       $this->unidad_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['unidad_']; 
       ...
       $this->cantidad_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['cantidad_']; 
       ...
       $this->valorunit_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['valorunit_']; 
       ...
       $this->valorpar_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['valorpar_']; 
       ...
       $this->descuento_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['descuento_']; 
       ...
       $this->adicional_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['adicional_']; 
       ...
       $this->adicional1_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['adicional1_']; 
       ...
       $this->factor_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['factor_']; 
       ...
       $this->iva_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['iva_']; 
       $iva_ = $this->iva_; 
       $sStyleHidden_iva_ = '';
       ...
       $this->costop_ = $this->form_vert_detalleventa_dev[$sc_seq_vert]['costop_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_detalleventa_dev_add_new_line(" . $sc_seq_vert . ")", "do_ajax_detalleventa_dev_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_detalleventa_dev_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_detalleventa_dev_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_detalleventa_dev_cancel_update(" . $sc_seq_vert . ")", "do_ajax_detalleventa_dev_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idpro_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idpro_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idpro_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idpro_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idpro_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<input type="hidden" name="colores_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($colores_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly_colores_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["colores_"]) &&  $this->nmgp_cmp_readonly["colores_"] == "on") { 
 ...
 ?>
<input type="hidden" name="colores_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($colores_) . "\">" . $colores_ . ""; ?>
<?php } else { ?>
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_colores_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_colores_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_colores_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_colores_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_colores_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$sAutocompValue = (isset($aLookup[0][$this->colores_])) ? $aLookup[0][$this->colores_] : $this->colores_;
$colores__look = (isset($aLookup[0][$this->colores_])) ? $aLookup[0][$this->colores_] : $this->colores_;
?>
<span id="id_read_on_colores_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-colores_<?php echo $sc_seq_vert ?> css_colores__line" style="<?php echo $sStyleReadLab_colores_; ?>"><?php echo $this->form_format_readonly("colores_", str_replace("<", "&lt;", $colores__look)); ?></span><span id="id_read_off_colores_<?php echo $sc_seq_vert ?>" class="css_read_off_colores_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_colores_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_colores__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="display: none;" id="id_sc_field_colores_<?php echo $sc_seq_vert ?>" type=text name="colores_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($colores_) ?>"
...
$sAutocompValue = (isset($aLookup[0][$this->colores_])) ? $aLookup[0][$this->colores_] : '';
$colores__look = (isset($aLookup[0][$this->colores_])) ? $aLookup[0][$this->colores_] : '';
?>
<select id="id_ac_colores_<?php echo $sc_seq_vert; ?>" class="scFormObjectOddMult sc-ui-autocomp-colores_ css_colores__obj sc-js-input"><?php if ('' != $this->colores_) { ?><option value="<?php echo $this->colores_ ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select></span><?php } ?>
...
<input type="hidden" name="tallas_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($tallas_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly_tallas_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["tallas_"]) &&  $this->nmgp_cmp_readonly["tallas_"] == "on") { 
 ...
 ?>
<input type="hidden" name="tallas_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($tallas_) . "\">" . $tallas_ . ""; ?>
<?php } else { ?>
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_tallas_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_tallas_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_tallas_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_tallas_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_tallas_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$sAutocompValue = (isset($aLookup[0][$this->tallas_])) ? $aLookup[0][$this->tallas_] : $this->tallas_;
$tallas__look = (isset($aLookup[0][$this->tallas_])) ? $aLookup[0][$this->tallas_] : $this->tallas_;
?>
<span id="id_read_on_tallas_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-tallas_<?php echo $sc_seq_vert ?> css_tallas__line" style="<?php echo $sStyleReadLab_tallas_; ?>"><?php echo $this->form_format_readonly("tallas_", str_replace("<", "&lt;", $tallas__look)); ?></span><span id="id_read_off_tallas_<?php echo $sc_seq_vert ?>" class="css_read_off_tallas_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_tallas_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_tallas__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="display: none;" id="id_sc_field_tallas_<?php echo $sc_seq_vert ?>" type=text name="tallas_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($tallas_) ?>"
...
$sAutocompValue = (isset($aLookup[0][$this->tallas_])) ? $aLookup[0][$this->tallas_] : '';
$tallas__look = (isset($aLookup[0][$this->tallas_])) ? $aLookup[0][$this->tallas_] : '';
?>
<select id="id_ac_tallas_<?php echo $sc_seq_vert; ?>" class="scFormObjectOddMult sc-ui-autocomp-tallas_ css_tallas__obj sc-js-input"><?php if ('' != $this->tallas_) { ?><option value="<?php echo $this->tallas_ ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select></span><?php } ?>
...
<input type="hidden" name="sabor_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($sabor_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
...
<?php if ($bTestReadOnly_sabor_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["sabor_"]) &&  $this->nmgp_cmp_readonly["sabor_"] == "on") { 
 ...
 ?>
<input type="hidden" name="sabor_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($sabor_) . "\">" . $sabor_ . ""; ?>
<?php } else { ?>
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_sabor_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_sabor_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_sabor_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_sabor_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_sabor_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$sAutocompValue = (isset($aLookup[0][$this->sabor_])) ? $aLookup[0][$this->sabor_] : $this->sabor_;
$sabor__look = (isset($aLookup[0][$this->sabor_])) ? $aLookup[0][$this->sabor_] : $this->sabor_;
?>
<span id="id_read_on_sabor_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-sabor_<?php echo $sc_seq_vert ?> css_sabor__line" style="<?php echo $sStyleReadLab_sabor_; ?>"><?php echo $this->form_format_readonly("sabor_", str_replace("<", "&lt;", $sabor__look)); ?></span><span id="id_read_off_sabor_<?php echo $sc_seq_vert ?>" class="css_read_off_sabor_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sabor_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_sabor__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="display: none;" id="id_sc_field_sabor_<?php echo $sc_seq_vert ?>" type=text name="sabor_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($sabor_) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=2"; } ?> maxlength=2 style="display: none" alt="{datatype: 'text', maxLength: 2, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" >
<?php
$aRecData['sabor_'] = $this->sabor_;
$aLookup = array();
...
$sAutocompValue = (isset($aLookup[0][$this->sabor_])) ? $aLookup[0][$this->sabor_] : '';
$sabor__look = (isset($aLookup[0][$this->sabor_])) ? $aLookup[0][$this->sabor_] : '';
?>
<select id="id_ac_sabor_<?php echo $sc_seq_vert; ?>" class="scFormObjectOddMult sc-ui-autocomp-sabor_ css_sabor__obj sc-js-input"><?php if ('' != $this->sabor_) { ?><option value="<?php echo $this->sabor_ ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select></span><?php } ?>
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idbod_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idbod_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idbod_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idbod_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_idbod_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
$sAutocompValue = (isset($aLookup[0][$unformatted_value_idbod_])) ? $aLookup[0][$unformatted_value_idbod_] : $this->idbod_;
$idbod__look = (isset($aLookup[0][$unformatted_value_idbod_])) ? $aLookup[0][$unformatted_value_idbod_] : $this->idbod_;
?>
<span id="id_read_on_idbod_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-idbod_<?php echo $sc_seq_vert ?> css_idbod__line" style="<?php echo $sStyleReadLab_idbod_; ?>"><?php echo $this->form_format_readonly("idbod_", str_replace("<", "&lt;", $idbod__look)); ?></span><span id="id_read_off_idbod_<?php echo $sc_seq_vert ?>" class="css_read_off_idbod_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_idbod_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_idbod__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="display: none;" id="id_sc_field_idbod_<?php echo $sc_seq_vert ?>" type=text name="idbod_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($idbod_) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=2"; } ?> style="display: none" alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['idbod_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['idbod_']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['idbod_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'center', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" >
<?php
$aRecData['idbod_'] = $this->idbod_;
$aLookup = array();
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
$sAutocompValue = (isset($aLookup[0][$unformatted_value_idbod_])) ? $aLookup[0][$unformatted_value_idbod_] : '';
$idbod__look = (isset($aLookup[0][$unformatted_value_idbod_])) ? $aLookup[0][$unformatted_value_idbod_] : '';
?>
<select id="id_ac_idbod_<?php echo $sc_seq_vert; ?>" class="scFormObjectOddMult sc-ui-autocomp-idbod_ css_idbod__obj sc-js-input"><?php if ('' != $unformatted_value_idbod_) { ?><option value="<?php echo $unformatted_value_idbod_ ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select></span><?php } ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_unidadmayor_'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->unidadmayor_ == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_unidadmayor_'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_cantidad_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-cantidad_<?php echo $sc_seq_vert ?> css_cantidad__line" style="<?php echo $sStyleReadLab_cantidad_; ?>"><?php echo $this->form_format_readonly("cantidad_", $this->form_encode_input($this->cantidad_)); ?></span><span id="id_read_off_cantidad_<?php echo $sc_seq_vert ?>" class="css_read_off_cantidad_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_cantidad_; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=8"; } ?> alt="{datatype: 'decimal', maxLength: 12, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['cantidad_']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['cantidad_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['cantidad_']['symbol_fmt']; ?>, manualDecimals: true, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['cantidad_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'center', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php   
   ...
   { 
       ...
       $this->form_vert_detalleventa_dev = $guarda_form_vert_detalleventa_dev;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("detalleventa_dev");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("detalleventa_dev");
 parent.scAjaxDetailHeight("detalleventa_dev", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_modal'])
{
?>
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			...
			do_ajax_detalleventa_dev_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
