...
class detalleventa_dev_apl
{
   ...
   var $form_vert_detalleventa_dev = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_numfacventa)) 
          {
              $_SESSION['par_numfacventa'] = $this->par_numfacventa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new detalleventa_dev_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['detalleventa_dev']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['detalleventa_dev']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['detalleventa_dev'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detalleventa_dev']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detalleventa_dev']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('detalleventa_dev') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detalleventa_dev']['label'] = "Elimine el item que no va a devolver";
      ...
      $_SESSION['scriptcase']['error_icon']['detalleventa_dev']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['detalleventa_dev'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_orig'] = " where numfac=" . $_SESSION['par_numfacventa'] . " and procesado<1";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_pesq'] = " where numfac=" . $_SESSION['par_numfacventa'] . " and procesado<1";
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detalleventa_dev']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['detalleventa_dev'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['detalleventa_dev'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("detalleventa_dev", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'detalleventa_dev_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'detalleventa_dev_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'detalleventa_dev/detalleventa_dev_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "detalleventa_dev_erro.class.php"); 
      }
      $this->Erro      = new detalleventa_dev_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opcao']))
         { 
             if ($this->iddet_ != "" || $this->iddev_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['detalleventa_dev']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['detalleventa_dev']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['detalleventa_dev']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['detalleventa_dev']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_form'][$sc_seq_vert];
             ...
             if ($this->nmgp_opcao == "incluir"){$this->unidadmayor_ = $this->nmgp_dados_form['unidadmayor_'];} 
             if ($this->nmgp_opcao == "incluir"){$this->idbod_ = $this->nmgp_dados_form['idbod_'];} 
             ...
             if ($this->nmgp_opcao == "incluir"){$this->colores_ = $this->nmgp_dados_form['colores_'];} 
             if ($this->nmgp_opcao == "incluir"){$this->tallas_ = $this->nmgp_dados_form['tallas_'];} 
             if ($this->nmgp_opcao == "incluir"){$this->sabor_ = $this->nmgp_dados_form['sabor_'];} 
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_detalleventa_dev']) || !is_array($this->NM_ajax_info['errList']['geral_detalleventa_dev']))
                  {
                      $this->NM_ajax_info['errList']['geral_detalleventa_dev'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_detalleventa_dev'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_detalleventa_dev'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_detalleventa_dev'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_redir_atualiz'] == "ok")
          {
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(detalleventa_dev_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', detalleventa_dev_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         { 
             $GLOBALS["idpro_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['idpro_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["colores_" . $sc_seq_vert]))
         { 
             $GLOBALS["colores_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['colores_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["tallas_" . $sc_seq_vert]))
         { 
             $GLOBALS["tallas_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['tallas_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["sabor_" . $sc_seq_vert]))
         { 
             $GLOBALS["sabor_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['sabor_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["idbod_" . $sc_seq_vert]))
         { 
             $GLOBALS["idbod_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['idbod_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["unidadmayor_" . $sc_seq_vert]))
         { 
             $GLOBALS["unidadmayor_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['unidadmayor_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["cantidad_" . $sc_seq_vert]))
         { 
             $GLOBALS["cantidad_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['cantidad_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["valorunit_" . $sc_seq_vert]))
         { 
             $GLOBALS["valorunit_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['valorunit_'];
         } 
         ...
         if (isset($this->tallas_)) { $this->nm_limpa_alfa($this->tallas_); }
         if (isset($this->sabor_)) { $this->nm_limpa_alfa($this->sabor_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['idpro_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'][$sc_seq_vert]['idpro_']))
             { 
                 $this->idpro_ = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['idpro_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['colores_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'][$sc_seq_vert]['colores_']))
             { 
                 $this->colores_ = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['colores_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['tallas_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'][$sc_seq_vert]['tallas_']))
             { 
                 $this->tallas_ = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['tallas_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['sabor_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'][$sc_seq_vert]['sabor_']))
             { 
                 $this->sabor_ = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['sabor_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['idbod_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'][$sc_seq_vert]['idbod_']))
             { 
                 $this->idbod_ = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['idbod_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['unidadmayor_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'][$sc_seq_vert]['unidadmayor_']))
             { 
                 $this->unidadmayor_ = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['unidadmayor_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['cantidad_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'][$sc_seq_vert]['cantidad_']))
             { 
                 $this->cantidad_ = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['cantidad_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['valorunit_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'][$sc_seq_vert]['valorunit_']))
             { 
                 $this->valorunit_ = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['valorunit_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['colores_'] =  $this->colores_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['tallas_'] =  $this->tallas_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['sabor_'] =  $this->sabor_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['unidadmayor_'] =  $this->unidadmayor_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['stockubica_'] =  $this->stockubica_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['unidad_'] =  $this->unidad_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['valorunit_'] =  $this->valorunit_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['valorpar_'] =  $this->valorpar_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['adicional_'] =  $this->adicional_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['adicional1_'] =  $this->adicional1_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['factor_'] =  $this->factor_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['iva_'] =  $this->iva_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['costop_'] =  $this->costop_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['numfac_'] =  $this->numfac_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['remision_'] =  $this->remision_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['devuelto_'] =  $this->devuelto_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['iddev_'] =  $this->iddev_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['procesado_'] =  $this->procesado_; 
         }
         $sc_seq_vert++; 
      } 
...
$_SESSION['scriptcase']['detalleventa_dev']['contr_erro'] = 'off'; 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_detalleventa_dev);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (isset($this->unidadmayor_))
          { 
              $SV_unidadmayor_ = $this->unidadmayor_;
          } 
          ...
          if (isset($SV_unidadmayor_) && $this->nmgp_opcao != "recarga")
          { 
              $this->unidadmayor_ = $SV_unidadmayor_;
          } 
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "detalleventa_dev.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Elimine el item que no va a devolver") ?></TITLE>
...
<form name="Fdown" method="get" action="detalleventa_dev_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="detalleventa_dev"> 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opc_ant'] == "incluir")
      {
...
;
$sal=$this->des[0][0]-$this->sc_temp_vtotal;
$this->trae_saldo();
     ...
     $nm_select ="update devventa set idbod=1 where numfacven=$id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$_SESSION['scriptcase']['detalleventa_dev']['contr_erro'] = 'off'; 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total']);
    echo ob_get_clean();
?>
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_detalleventa_dev'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if (!isset($this->sc_temp_par_numfacventa)) {$this->sc_temp_par_numfacventa = (isset($_SESSION['par_numfacventa'])) ? $_SESSION['par_numfacventa'] : "";}
  if ($this->sc_evento == "excluir" || $this->sc_evento == "delete")
	{
	goto a;}
if($this->cantidad_ >$this->cantidad_  or $this->cantidad_ ==0)
	{
		
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "¡Cantida se excede, o producto ya fue devuelto!";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_detalleventa_dev';
  } elseif ('submit_form' == $this->NM_ajax_opcao) {
   $sErrorIndex = 'geral_detalleventa_dev';
  } else {
   $sErrorIndex = substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
  }
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "¡Cantida se excede, o producto ya fue devuelto!";
 }
;
	}
else
...
$sql="SELECT fecha FROM devventa WHERE numfacven=$this->sc_temp_par_numfacventa";
 
      $nm_select = $sql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->dts = $this->Db->Execute($nm_select)) 
      { }
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->dts = false;
...
if($this->unidadmayor_ =='NO' and $this->factor_ >0)
	...
	if($this->colores_ >0)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->dts', cantidad=$cant, idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=1, detalle='Devolución en Venta', idmov=1, nufacvta=$this->sc_temp_par_numfacventa, iddetalle=$last_id, lote='Null', colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->dts', cantidad=$cant, idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=1, detalle='Devolución en Venta', idmov=1, nufacvta=$this->sc_temp_par_numfacventa, iddetalle=$last_id, lote='Null', colores=$this->colores_ , tallas=$this->tallas_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->dts', cantidad=$cant, idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=1, detalle='Devolución en Venta', idmov=1, nufacvta=$this->sc_temp_par_numfacventa, iddetalle=$last_id, lote='Null', colores=$this->colores_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->dts', cantidad=$cant, idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=1, detalle='Devolución en Venta', idmov=1, nufacvta=$this->sc_temp_par_numfacventa, iddetalle=$last_id, lote='Null'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="update detalleventa set devuelto=$cant where iddet=$this->iddet_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	{ 
     ...
     $nm_select ="INSERT inventario SET fecha='$this->dts', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ ,tipo=1, detalle='Devolución en Venta', idmov=1,   	nufacvta=$this->sc_temp_par_numfacventa, iddetalle=$last_id, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->dts', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=1, detalle='Devolución en Venta', idmov=1, nufacvta=$this->sc_temp_par_numfacventa, iddetalle=$last_id, lote='Null', colores=$this->colores_ , tallas=$this->tallas_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->dts', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=1, detalle='Devolución en Venta', idmov=1, nufacvta=$this->sc_temp_par_numfacventa, iddetalle=$last_id, lote='Null', colores=$this->colores_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$this->dts', cantidad=$this->cantidad_ , idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=($this->valorpar_ -$this->descuento_ ), idbod=$this->idbod_ , tipo=1, detalle='Devolución en Venta', idmov=1, nufacvta=$this->sc_temp_par_numfacventa, iddetalle=$last_id, lote='Null'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="update detalleventa set devuelto=$this->cantidad_  where iddet=$this->iddet_ "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$_SESSION['scriptcase']['detalleventa_dev']['contr_erro'] = 'off'; 
    ...
    function ValidateField_unidadmayor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['php_cmp_required']['unidadmayor_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['php_cmp_required']['unidadmayor_'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_factor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['php_cmp_required']['factor_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['php_cmp_required']['factor_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Factor" ; 
              if (!isset($Campos_Erros['factor_']))
    ...
    function ValidateField_costop_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['php_cmp_required']['costop_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['php_cmp_required']['costop_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Costop" ; 
              if (!isset($Campos_Erros['costop_']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['iddet_']['keyVal'] = detalleventa_dev_pack_protect_string($this->nmgp_dados_form['iddet_']);
              $this->NM_ajax_info['fldList']['iddev_']['keyVal'] = detalleventa_dev_pack_protect_string($this->nmgp_dados_form['iddev_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['idpro_'] = $this->idpro_;
                  }
                  if (isset($this->NM_ajax_changed['colores_']) && $this->NM_ajax_changed['colores_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['colores_'] = $this->colores_;
                  }
                  if (isset($this->NM_ajax_changed['tallas_']) && $this->NM_ajax_changed['tallas_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['tallas_'] = $this->tallas_;
                  }
                  if (isset($this->NM_ajax_changed['sabor_']) && $this->NM_ajax_changed['sabor_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['sabor_'] = $this->sabor_;
                  }
                  if (isset($this->NM_ajax_changed['idbod_']) && $this->NM_ajax_changed['idbod_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['idbod_'] = $this->idbod_;
                  }
                  if (isset($this->NM_ajax_changed['unidadmayor_']) && $this->NM_ajax_changed['unidadmayor_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['unidadmayor_'] = $this->unidadmayor_;
                  }
                  if (isset($this->NM_ajax_changed['stockubica_']) && $this->NM_ajax_changed['stockubica_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['stockubica_'] = $this->stockubica_;
                  }
                  if (isset($this->NM_ajax_changed['unidad_']) && $this->NM_ajax_changed['unidad_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['unidad_'] = $this->unidad_;
                  }
                  if (isset($this->NM_ajax_changed['cantidad_']) && $this->NM_ajax_changed['cantidad_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['valorunit_']) && $this->NM_ajax_changed['valorunit_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['valorunit_'] = $this->valorunit_;
                  }
                  if (isset($this->NM_ajax_changed['valorpar_']) && $this->NM_ajax_changed['valorpar_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['valorpar_'] = $this->valorpar_;
                  }
                  if (isset($this->NM_ajax_changed['descuento_']) && $this->NM_ajax_changed['descuento_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['descuento_'] = $this->descuento_;
                  }
                  if (isset($this->NM_ajax_changed['adicional_']) && $this->NM_ajax_changed['adicional_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['adicional_'] = $this->adicional_;
                  }
                  if (isset($this->NM_ajax_changed['adicional1_']) && $this->NM_ajax_changed['adicional1_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['adicional1_'] = $this->adicional1_;
                  }
                  if (isset($this->NM_ajax_changed['factor_']) && $this->NM_ajax_changed['factor_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['factor_'] = $this->factor_;
                  }
                  if (isset($this->NM_ajax_changed['iva_']) && $this->NM_ajax_changed['iva_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['iva_'] = $this->iva_;
                  }
                  if (isset($this->NM_ajax_changed['costop_']) && $this->NM_ajax_changed['costop_'])
                  {
                      $this->form_vert_detalleventa_dev[$this->nmgp_refresh_row]['costop_'] = $this->costop_;
                  }
              }
          }
          ...
          foreach($this->form_vert_detalleventa_dev as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idpro_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][detalleventa_dev_pack_protect_string($aRecData['idpro_'])]),
              );
              }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['colores_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][detalleventa_dev_pack_protect_string($aRecData['colores_'])]),
              );
              }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['tallas_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][detalleventa_dev_pack_protect_string($aRecData['tallas_'])]),
              );
              }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['sabor_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][detalleventa_dev_pack_protect_string($aRecData['sabor_'])]),
              );
              }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][detalleventa_dev_pack_protect_string($aRecData['idbod_'])]),
              );
              }
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("unidadmayor_", $this->nmgp_refresh_fields)))
              {
                  ...
                  $aLookup = array();
$aLookup[] = array(detalleventa_dev_pack_protect_string('NO') => str_replace('<', '&lt;',detalleventa_dev_pack_protect_string("NO")));
$aLookup[] = array(detalleventa_dev_pack_protect_string('SI') => str_replace('<', '&lt;',detalleventa_dev_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_unidadmayor_'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_unidadmayor_'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['unidadmayor_' . $sc_seq_vert]['valList'][$i] = detalleventa_dev_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  $this->actualiza_stock();
      ...
      $nm_select = "select colores, tallas, sabores from productos where idprod=$this->idpro_ "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
     if ($this->idpro_ != "")
...
$_SESSION['scriptcase']['detalleventa_dev']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['idpro_'] = $this->idpro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['colores_'] = $this->colores_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['tallas_'] = $this->tallas_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['sabor_'] = $this->sabor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['idbod_'] = $this->idbod_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['unidadmayor_'] = $this->unidadmayor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['valorunit_'] = $this->valorunit_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['valorpar_'] = $this->valorpar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['descuento_'] = $this->descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['adicional_'] = $this->adicional_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['adicional1_'] = $this->adicional1_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['factor_'] = $this->factor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['iva_'] = $this->iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert]['costop_'] = $this->costop_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idpro_', 'colores_', 'tallas_', 'sabor_', 'idbod_', 'unidadmayor_', 'stockubica_', 'unidad_', 'cantidad_', 'valorunit_', 'valorpar_', 'descuento_', 'adicional_', 'adicional1_', 'factor_', 'iva_', 'costop_'), $aDoNotUpdate);
...
$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['Lookup_unidadmayor_'][] = 'SI';
          ...
          {
              if (key($aValData) == detalleventa_dev_pack_protect_string(NM_charset_to_utf8($this->unidadmayor_)))
              {
          ...
          $tmpLabel_unidadmayor_ = $sLabelTemp;
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['detalleventa_dev']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['parms'] = "iddet_?#?$this->iddet_?@?iddev_?#?$this->iddev_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['detalleventa_dev']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_detalleventa_dev = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter'] . ")";
          }
      }
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total']))
          {
              ...
              $qt_geral_reg_detalleventa_dev = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total'] = $qt_geral_reg_detalleventa_dev;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet_) && !empty($this->iddev_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_detalleventa_dev = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_detalleventa_dev) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] > $qt_geral_reg_detalleventa_dev)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = $qt_geral_reg_detalleventa_dev - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = ($qt_geral_reg_detalleventa_dev + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['parms'] = "iddet_?#?$this->iddet_?@?iddev_?#?$this->iddev_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_detalleventa_dev[$sc_seq_vert]['colores_'] =  $this->colores_; 
          ...
          ksort ($this->form_vert_detalleventa_dev); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] < (($qt_geral_reg_detalleventa_dev + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['embutida_multi']) 
          { 
          } 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
if($this->cantidad_ >$this->sc_temp_edit_cantidad)
 ...
 if (!isset($this->Campos_Mens_erro)){$this->Campos_Mens_erro = "";}
 if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "¡Cantidad excede la compra o ya fué devuelto!";
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_detalleventa_dev';
  ...
  $this->NM_ajax_info['errList'][$sErrorIndex][] = "¡Cantidad excede la compra o ya fué devuelto!";
 }
;
	}
...
;
$saldocli=$this->da[0][0]-$this->sc_temp_vtotal;
...
$a=$this->numfac_ ; 
$sql="SELECT sum(valorpar), sum(iva), sum(descuento) FROM detalleventaself WHERE numfac=$this->numfac_  and procesado<1";
...
if(!empty($this->ds[0][0]))
{
     ...
     $nm_select ="UPDATE devventa SET vunit=$total, vparc=$sub, viva=$iva, vdesc=$desc WHERE numfacven=$this->numfac_  order by numerodev desc limit 1"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	$this->sc_master_value('vunit', $total);
	$this->sc_master_value('vparc', $sub);
	$this->sc_master_value('viva', $iva);
	$this->sc_master_value('vdesc', $desc);
}

else
	{
	
     $nm_select ="UPDATE devventa SET vunit=0, vparc=0, viva=0, vdesc=0 WHERE numfacven=$this->numfac_  order by numerodev desc limit 1"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
if ($this->colores_ !=null)
	{
	if ($this->tallas_ !=null)
		{
		if($this->sabor_ !=null)
			{
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter_form'] . " and (numfac=" . $_SESSION['par_numfacventa'] . " and procesado<1) and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_detalleventa_dev = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['total'] = $qt_geral_reg_detalleventa_dev;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          detalleventa_dev_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "detalleventa_dev_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['nm_run_menu'] = 2;
       $nmgp_saida_form = "detalleventa_dev_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['masterValue']))
{
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_dev']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
