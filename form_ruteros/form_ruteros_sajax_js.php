  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ruteros" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate dia_semana
  function do_ajax_form_ruteros_validate_dia_semana()
  {
    var nomeCampo_dia_semana = "dia_semana";
    var var_dia_semana = scAjaxGetFieldSelect(nomeCampo_dia_semana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_validate_dia_semana(var_dia_semana, var_script_case_init, do_ajax_form_ruteros_validate_dia_semana_cb);
  } // do_ajax_form_ruteros_validate_dia_semana

  function do_ajax_form_ruteros_validate_dia_semana_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_validate_dia_semana_cb

  // ---------- Validate asesor_zona
  function do_ajax_form_ruteros_validate_asesor_zona()
  {
    var nomeCampo_asesor_zona = "asesor_zona";
    var var_asesor_zona = scAjaxGetFieldSelect(nomeCampo_asesor_zona);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_validate_asesor_zona(var_asesor_zona, var_script_case_init, do_ajax_form_ruteros_validate_asesor_zona_cb);
  } // do_ajax_form_ruteros_validate_asesor_zona

  function do_ajax_form_ruteros_validate_asesor_zona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_validate_asesor_zona_cb

  // ---------- Validate cliente
  function do_ajax_form_ruteros_validate_cliente()
  {
  } // do_ajax_form_ruteros_validate_cliente

  function do_ajax_form_ruteros_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_validate_cliente_cb

  // ---------- Validate nom_cliente
  function do_ajax_form_ruteros_validate_nom_cliente()
  {
    var nomeCampo_nom_cliente = "nom_cliente";
    var var_nom_cliente = scAjaxGetFieldText(nomeCampo_nom_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_validate_nom_cliente(var_nom_cliente, var_script_case_init, do_ajax_form_ruteros_validate_nom_cliente_cb);
  } // do_ajax_form_ruteros_validate_nom_cliente

  function do_ajax_form_ruteros_validate_nom_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_validate_nom_cliente_cb

  // ---------- Validate direccion
  function do_ajax_form_ruteros_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_ruteros_validate_direccion_cb);
  } // do_ajax_form_ruteros_validate_direccion

  function do_ajax_form_ruteros_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_validate_direccion_cb

  // ---------- Validate barrio
  function do_ajax_form_ruteros_validate_barrio()
  {
  } // do_ajax_form_ruteros_validate_barrio

  function do_ajax_form_ruteros_validate_barrio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "barrio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_validate_barrio_cb

  // ---------- Validate razon_social
  function do_ajax_form_ruteros_validate_razon_social()
  {
    var nomeCampo_razon_social = "razon_social";
    var var_razon_social = scAjaxGetFieldText(nomeCampo_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_validate_razon_social(var_razon_social, var_script_case_init, do_ajax_form_ruteros_validate_razon_social_cb);
  } // do_ajax_form_ruteros_validate_razon_social

  function do_ajax_form_ruteros_validate_razon_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_validate_razon_social_cb

  // ---------- Validate telefono
  function do_ajax_form_ruteros_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_ruteros_validate_telefono_cb);
  } // do_ajax_form_ruteros_validate_telefono

  function do_ajax_form_ruteros_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_validate_telefono_cb

  // ---------- Event onchange cliente
  function do_ajax_form_ruteros_event_cliente_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_ruteros_event_cliente_onchange(var_cliente, var_nom_cliente, var_direccion, var_razon_social, var_telefono, var_script_case_init, do_ajax_form_ruteros_event_cliente_onchange_cb);
  } // do_ajax_form_ruteros_event_cliente_onchange

  function do_ajax_form_ruteros_event_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ruteros_event_cliente_onchange_cb_after_alert);
  } // do_ajax_form_ruteros_event_cliente_onchange_cb
  function do_ajax_form_ruteros_event_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_ruteros_event_cliente_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ruteros_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ruteros_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_ruteros_submit_form(var_dia_semana, var_asesor_zona, var_cliente, var_nom_cliente, var_direccion, var_barrio, var_razon_social, var_telefono, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ruteros_submit_form_cb);
  } // do_ajax_form_ruteros_submit_form

  function do_ajax_form_ruteros_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ruteros_submit_form_cb_after_alert);
  } // do_ajax_form_ruteros_submit_form_cb
  function do_ajax_form_ruteros_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ruteros_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ruteros_navigate_form()
  {
    perform_ajax_form_ruteros_navigate_form();
  }

  function perform_ajax_form_ruteros_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ruteros_navigate_form(var_id_rutero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ruteros_navigate_form_cb);
  } // do_ajax_form_ruteros_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ruteros']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ruteros_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ruteros_navigate_form_cb_after_alert);
  } // do_ajax_form_ruteros_navigate_form_cb
  function do_ajax_form_ruteros_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_ruteros_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ruteros_navigate_form_cb_after_alert
  function sc_hide_form_ruteros_form()
  {
  ...
  function do_ajax_form_ruteros_lkpedt_refresh_cliente()
  {
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "cliente";
    x_ajax_form_ruteros_lkpedt_refresh_cliente(var_cliente, nmgp_refresh_fields, var_script_case_init, do_ajax_form_ruteros_lkpedt_refresh_cliente_cb);
  } // do_ajax_form_ruteros_lkpedt_refresh_cliente

  function do_ajax_form_ruteros_lkpedt_refresh_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_ruteros_lkpedt_refresh_cliente_cb

  function do_ajax_form_ruteros_lkpedt_refresh_barrio()
  {
    var var_barrio = scAjaxGetFieldText("barrio");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "barrio";
    x_ajax_form_ruteros_lkpedt_refresh_barrio(var_barrio, nmgp_refresh_fields, var_script_case_init, do_ajax_form_ruteros_lkpedt_refresh_barrio_cb);
  } // do_ajax_form_ruteros_lkpedt_refresh_barrio

  function do_ajax_form_ruteros_lkpedt_refresh_barrio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_ruteros_lkpedt_refresh_barrio_cb
