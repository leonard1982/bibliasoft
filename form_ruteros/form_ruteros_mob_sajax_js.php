  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ruteros_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate dia_semana
  function do_ajax_form_ruteros_mob_validate_dia_semana()
  {
    var nomeCampo_dia_semana = "dia_semana";
    var var_dia_semana = scAjaxGetFieldSelect(nomeCampo_dia_semana);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_mob_validate_dia_semana(var_dia_semana, var_script_case_init, do_ajax_form_ruteros_mob_validate_dia_semana_cb);
  } // do_ajax_form_ruteros_mob_validate_dia_semana

  function do_ajax_form_ruteros_mob_validate_dia_semana_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dia_semana";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_mob_validate_dia_semana_cb

  // ---------- Validate asesor_zona
  function do_ajax_form_ruteros_mob_validate_asesor_zona()
  {
    var nomeCampo_asesor_zona = "asesor_zona";
    var var_asesor_zona = scAjaxGetFieldSelect(nomeCampo_asesor_zona);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_mob_validate_asesor_zona(var_asesor_zona, var_script_case_init, do_ajax_form_ruteros_mob_validate_asesor_zona_cb);
  } // do_ajax_form_ruteros_mob_validate_asesor_zona

  function do_ajax_form_ruteros_mob_validate_asesor_zona_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asesor_zona";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_mob_validate_asesor_zona_cb

  // ---------- Validate cliente
  function do_ajax_form_ruteros_mob_validate_cliente()
  {
  } // do_ajax_form_ruteros_mob_validate_cliente

  function do_ajax_form_ruteros_mob_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_mob_validate_cliente_cb

  // ---------- Validate nom_cliente
  function do_ajax_form_ruteros_mob_validate_nom_cliente()
  {
    var nomeCampo_nom_cliente = "nom_cliente";
    var var_nom_cliente = scAjaxGetFieldText(nomeCampo_nom_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_mob_validate_nom_cliente(var_nom_cliente, var_script_case_init, do_ajax_form_ruteros_mob_validate_nom_cliente_cb);
  } // do_ajax_form_ruteros_mob_validate_nom_cliente

  function do_ajax_form_ruteros_mob_validate_nom_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nom_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_mob_validate_nom_cliente_cb

  // ---------- Validate direccion
  function do_ajax_form_ruteros_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_ruteros_mob_validate_direccion_cb);
  } // do_ajax_form_ruteros_mob_validate_direccion

  function do_ajax_form_ruteros_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_mob_validate_direccion_cb

  // ---------- Validate barrio
  function do_ajax_form_ruteros_mob_validate_barrio()
  {
  } // do_ajax_form_ruteros_mob_validate_barrio

  function do_ajax_form_ruteros_mob_validate_barrio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "barrio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_mob_validate_barrio_cb

  // ---------- Validate razon_social
  function do_ajax_form_ruteros_mob_validate_razon_social()
  {
    var nomeCampo_razon_social = "razon_social";
    var var_razon_social = scAjaxGetFieldText(nomeCampo_razon_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_mob_validate_razon_social(var_razon_social, var_script_case_init, do_ajax_form_ruteros_mob_validate_razon_social_cb);
  } // do_ajax_form_ruteros_mob_validate_razon_social

  function do_ajax_form_ruteros_mob_validate_razon_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_mob_validate_razon_social_cb

  // ---------- Validate telefono
  function do_ajax_form_ruteros_mob_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ruteros_mob_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_ruteros_mob_validate_telefono_cb);
  } // do_ajax_form_ruteros_mob_validate_telefono

  function do_ajax_form_ruteros_mob_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ruteros_mob_validate_telefono_cb

  // ---------- Event onchange cliente
  function do_ajax_form_ruteros_mob_event_cliente_onchange()
  {
    var var_cliente = scAjaxGetFieldText("id_ac_cliente");
    var var_nom_cliente = scAjaxGetFieldText("nom_cliente");
    ...
    scAjaxProcOn(true);
    x_ajax_form_ruteros_mob_event_cliente_onchange(var_cliente, var_nom_cliente, var_direccion, var_razon_social, var_telefono, var_script_case_init, do_ajax_form_ruteros_mob_event_cliente_onchange_cb);
  } // do_ajax_form_ruteros_mob_event_cliente_onchange

  function do_ajax_form_ruteros_mob_event_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ruteros_mob_event_cliente_onchange_cb_after_alert);
  } // do_ajax_form_ruteros_mob_event_cliente_onchange_cb
  function do_ajax_form_ruteros_mob_event_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_ruteros_mob_event_cliente_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ruteros_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ruteros_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_dia_semana = scAjaxGetFieldSelect("dia_semana");
    var var_asesor_zona = scAjaxGetFieldSelect("asesor_zona");
    ...
    var var_razon_social = scAjaxGetFieldText("razon_social");
    var var_telefono = scAjaxGetFieldText("telefono");
    var var_id_rutero = scAjaxGetFieldText("id_rutero");
    ...
    scAjaxProcOn();
    x_ajax_form_ruteros_mob_submit_form(var_dia_semana, var_asesor_zona, var_cliente, var_nom_cliente, var_direccion, var_barrio, var_razon_social, var_telefono, var_id_rutero, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ruteros_mob_submit_form_cb);
  } // do_ajax_form_ruteros_mob_submit_form

  function do_ajax_form_ruteros_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("dia_semana");
      scAjaxHideErrorDisplay("asesor_zona");
      scAjaxHideErrorDisplay("cliente");
      scAjaxHideErrorDisplay("nom_cliente");
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ruteros_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ruteros_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ruteros_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ruteros_mob_submit_form_cb_after_alert);
  } // do_ajax_form_ruteros_mob_submit_form_cb
  function do_ajax_form_ruteros_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ruteros_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ruteros_mob_navigate_form()
  {
    perform_ajax_form_ruteros_mob_navigate_form();
  }

  function perform_ajax_form_ruteros_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("razon_social");
    scAjaxHideErrorDisplay("telefono");
    var var_id_rutero = document.F2.id_rutero.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ruteros_mob_navigate_form(var_id_rutero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ruteros_mob_navigate_form_cb);
  } // do_ajax_form_ruteros_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ruteros_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ruteros_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_rutero.value = scAjaxGetKeyValue("id_rutero");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ruteros_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_ruteros_mob_navigate_form_cb
  function do_ajax_form_ruteros_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_ruteros_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_ruteros_mob_navigate_form_cb_after_alert
  function sc_hide_form_ruteros_mob_form()
  {
  ...
  function do_ajax_form_ruteros_mob_lkpedt_refresh_cliente()
  {
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "cliente";
    x_ajax_form_ruteros_mob_lkpedt_refresh_cliente(var_cliente, nmgp_refresh_fields, var_script_case_init, do_ajax_form_ruteros_mob_lkpedt_refresh_cliente_cb);
  } // do_ajax_form_ruteros_mob_lkpedt_refresh_cliente

  function do_ajax_form_ruteros_mob_lkpedt_refresh_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_ruteros_mob_lkpedt_refresh_cliente_cb

  function do_ajax_form_ruteros_mob_lkpedt_refresh_barrio()
  {
    var var_barrio = scAjaxGetFieldText("barrio");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "barrio";
    x_ajax_form_ruteros_mob_lkpedt_refresh_barrio(var_barrio, nmgp_refresh_fields, var_script_case_init, do_ajax_form_ruteros_mob_lkpedt_refresh_barrio_cb);
  } // do_ajax_form_ruteros_mob_lkpedt_refresh_barrio

  function do_ajax_form_ruteros_mob_lkpedt_refresh_barrio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_ruteros_mob_lkpedt_refresh_barrio_cb
  ...
  ajax_field_list[0] = "dia_semana";
  ajax_field_list[1] = "asesor_zona";
  ajax_field_list[2] = "cliente";
  ajax_field_list[3] = "nom_cliente";
  ajax_field_list[4] = "direccion";
  ajax_field_list[5] = "barrio";
  ...
  var ajax_error_list = {
    "dia_semana": {"label": "Dia Semana", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "asesor_zona": {"label": "Asesor/Zona", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cliente": {"label": "Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nom_cliente": {"label": "Nom Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "asesor_zona": new Array(),
    "cliente": new Array(),
    "nom_cliente": new Array(),
    "direccion": new Array(),
    "barrio": new Array(),
    "razon_social": new Array(),
    "telefono": new Array()
  };
  ajax_field_mult["dia_semana"][1] = "dia_semana";
  ajax_field_mult["asesor_zona"][1] = "asesor_zona";
  ajax_field_mult["cliente"][1] = "cliente";
  ajax_field_mult["nom_cliente"][1] = "nom_cliente";
  ...
  var ajax_field_id = {
    "dia_semana": new Array("hidden_field_label_dia_semana", "hidden_field_data_dia_semana"),
    "asesor_zona": new Array("hidden_field_label_asesor_zona", "hidden_field_data_asesor_zona"),
