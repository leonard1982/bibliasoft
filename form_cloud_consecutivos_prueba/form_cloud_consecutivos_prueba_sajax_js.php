  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_consecutivos_prueba" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_consecutivos_prueba_form();
	}
  ...
  function do_ajax_form_cloud_consecutivos_prueba_validate_id_consecutivo()
  {
    ...
    x_ajax_form_cloud_consecutivos_prueba_validate_id_consecutivo(var_id_consecutivo, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_validate_id_consecutivo_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_validate_id_consecutivo

  function do_ajax_form_cloud_consecutivos_prueba_validate_id_consecutivo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_validate_id_consecutivo_cb

  // ---------- Validate tipodoc
  function do_ajax_form_cloud_consecutivos_prueba_validate_tipodoc()
  {
    var nomeCampo_tipodoc = "tipodoc";
    var var_tipodoc = scAjaxGetFieldSelect(nomeCampo_tipodoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_validate_tipodoc(var_tipodoc, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_validate_tipodoc_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_validate_tipodoc

  function do_ajax_form_cloud_consecutivos_prueba_validate_tipodoc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipodoc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_validate_tipodoc_cb

  // ---------- Validate prefijo
  function do_ajax_form_cloud_consecutivos_prueba_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldText(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_validate_prefijo_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_validate_prefijo

  function do_ajax_form_cloud_consecutivos_prueba_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_cloud_consecutivos_prueba_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_validate_numero(var_numero, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_validate_numero_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_validate_numero

  function do_ajax_form_cloud_consecutivos_prueba_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_validate_numero_cb

  // ---------- Validate doc_tns
  function do_ajax_form_cloud_consecutivos_prueba_validate_doc_tns()
  {
    var nomeCampo_doc_tns = "doc_tns";
    var var_doc_tns = scAjaxGetFieldText(nomeCampo_doc_tns);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_validate_doc_tns(var_doc_tns, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_validate_doc_tns_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_validate_doc_tns

  function do_ajax_form_cloud_consecutivos_prueba_validate_doc_tns_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doc_tns";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_validate_doc_tns_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_consecutivos_prueba_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_consecutivos_prueba_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_consecutivos_prueba_submit_form(var_id_consecutivo, var_tipodoc, var_prefijo, var_numero, var_doc_tns, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_consecutivos_prueba_submit_form_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_submit_form

  function do_ajax_form_cloud_consecutivos_prueba_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_consecutivos_prueba_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_consecutivos_prueba_submit_form_cb
  function do_ajax_form_cloud_consecutivos_prueba_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_consecutivos_prueba_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_consecutivos_prueba_navigate_form()
  {
    perform_ajax_form_cloud_consecutivos_prueba_navigate_form();
  }

  function perform_ajax_form_cloud_consecutivos_prueba_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_consecutivos_prueba_navigate_form(var_id_consecutivo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_navigate_form_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_consecutivos_prueba']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_consecutivos_prueba_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_consecutivos_prueba_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_consecutivos_prueba_navigate_form_cb
  function do_ajax_form_cloud_consecutivos_prueba_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_cloud_consecutivos_prueba_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cloud_consecutivos_prueba_navigate_form_cb_after_alert
  function sc_hide_form_cloud_consecutivos_prueba_form()
  {
