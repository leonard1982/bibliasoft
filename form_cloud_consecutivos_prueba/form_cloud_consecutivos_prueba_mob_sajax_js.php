  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_consecutivos_prueba_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_consecutivos_prueba_mob_form();
	}
  ...
  // ---------- Validate id_consecutivo
  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_id_consecutivo()
  {
    var nomeCampo_id_consecutivo = "id_consecutivo";
    var var_id_consecutivo = scAjaxGetFieldHidden(nomeCampo_id_consecutivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_mob_validate_id_consecutivo(var_id_consecutivo, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_mob_validate_id_consecutivo_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_id_consecutivo

  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_id_consecutivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_consecutivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_id_consecutivo_cb

  // ---------- Validate tipodoc
  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_tipodoc()
  {
    var nomeCampo_tipodoc = "tipodoc";
    var var_tipodoc = scAjaxGetFieldSelect(nomeCampo_tipodoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_mob_validate_tipodoc(var_tipodoc, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_mob_validate_tipodoc_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_tipodoc

  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_tipodoc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipodoc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_tipodoc_cb

  // ---------- Validate prefijo
  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldText(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_mob_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_mob_validate_prefijo_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_prefijo

  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_mob_validate_numero_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_numero

  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_numero_cb

  // ---------- Validate doc_tns
  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_doc_tns()
  {
    var nomeCampo_doc_tns = "doc_tns";
    var var_doc_tns = scAjaxGetFieldText(nomeCampo_doc_tns);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_consecutivos_prueba_mob_validate_doc_tns(var_doc_tns, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_mob_validate_doc_tns_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_doc_tns

  function do_ajax_form_cloud_consecutivos_prueba_mob_validate_doc_tns_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "doc_tns";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_consecutivos_prueba_mob_validate_doc_tns_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_consecutivos_prueba_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_consecutivos_prueba_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_consecutivo = scAjaxGetFieldHidden("id_consecutivo");
    ...
    var var_doc_tns = scAjaxGetFieldText("doc_tns");
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_consecutivos_prueba_mob_submit_form(var_id_consecutivo, var_tipodoc, var_prefijo, var_numero, var_doc_tns, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_consecutivos_prueba_mob_submit_form_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_submit_form

  function do_ajax_form_cloud_consecutivos_prueba_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_consecutivos_prueba_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_submit_form_cb
  function do_ajax_form_cloud_consecutivos_prueba_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_consecutivos_prueba_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_consecutivos_prueba_mob_navigate_form()
  {
    perform_ajax_form_cloud_consecutivos_prueba_mob_navigate_form();
  }

  function perform_ajax_form_cloud_consecutivos_prueba_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("numero");
    scAjaxHideErrorDisplay("doc_tns");
    var var_id_consecutivo = document.F2.id_consecutivo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_consecutivos_prueba_mob_navigate_form(var_id_consecutivo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_consecutivos_prueba_mob_navigate_form_cb);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_consecutivos_prueba_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_consecutivos_prueba_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_consecutivo.value = scAjaxGetKeyValue("id_consecutivo");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_consecutivos_prueba_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_consecutivos_prueba_mob_navigate_form_cb
  function do_ajax_form_cloud_consecutivos_prueba_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_cloud_consecutivos_prueba_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cloud_consecutivos_prueba_mob_navigate_form_cb_after_alert
  function sc_hide_form_cloud_consecutivos_prueba_mob_form()
  {
  ...
  ajax_field_list[0] = "id_consecutivo";
  ajax_field_list[1] = "tipodoc";
  ajax_field_list[2] = "prefijo";
  ajax_field_list[3] = "numero";
  ajax_field_list[4] = "doc_tns";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_consecutivo": {"label": "Id Consecutivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipodoc": {"label": "Tipo Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "doc_tns": {"label": "Doc Tns", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_consecutivo": new Array(),
    "tipodoc": new Array(),
    "prefijo": new Array(),
    "numero": new Array(),
    "doc_tns": new Array()
  };
  ajax_field_mult["id_consecutivo"][1] = "id_consecutivo";
  ajax_field_mult["tipodoc"][1] = "tipodoc";
  ajax_field_mult["prefijo"][1] = "prefijo";
  ajax_field_mult["numero"][1] = "numero";
  ajax_field_mult["doc_tns"][1] = "doc_tns";
  ...
  var ajax_field_id = {
    ...
    "doc_tns": new Array("hidden_field_label_doc_tns", "hidden_field_data_doc_tns")
  };
