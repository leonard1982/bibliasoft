...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_contabilidad_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_contabilidad_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
var Crtl_btn_asentar = false;
function sc_btn_asentar()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_asentar(); }, 500);
      return;
    }
    if (Crtl_btn_asentar) {return;}
    scJs_confirm("<?php echo html_entity_decode('Desea asentar?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_asentar_ok, sc_btn_asentar_cancel)
}
function sc_btn_asentar_cancel()
{
}
function sc_btn_asentar_ok()
{
    Crtl_btn_asentar = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?asentar?@?";
    document.F1.action = "form_contabilidad_mob.php";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_desasentar = false;
function sc_btn_desasentar()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_desasentar(); }, 500);
      return;
    }
    if (Crtl_btn_desasentar) {return;}
    scJs_confirm("<?php echo html_entity_decode('Desea desasentar el comprobante?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_desasentar_ok, sc_btn_desasentar_cancel)
}
function sc_btn_desasentar_cancel()
{
}
function sc_btn_desasentar_ok()
{
    Crtl_btn_desasentar = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?desasentar?@?";
    document.F1.action = "form_contabilidad_mob.php";
    document.F1.target = "_self";
    document.F1.submit();
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contabilidad_mob']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("importado=disabled", "");
