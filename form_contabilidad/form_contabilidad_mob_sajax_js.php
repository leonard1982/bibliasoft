  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contabilidad_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contabilidad_mob_form();
	}
...
?>
  ...
  // ---------- Validate tipodoc
  function do_ajax_form_contabilidad_mob_validate_tipodoc()
  {
    var nomeCampo_tipodoc = "tipodoc";
    var var_tipodoc = scAjaxGetFieldSelect(nomeCampo_tipodoc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_tipodoc(var_tipodoc, var_script_case_init, do_ajax_form_contabilidad_mob_validate_tipodoc_cb);
  } // do_ajax_form_contabilidad_mob_validate_tipodoc

  function do_ajax_form_contabilidad_mob_validate_tipodoc_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_tipodoc_cb

  // ---------- Validate prefijo
  function do_ajax_form_contabilidad_mob_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_contabilidad_mob_validate_prefijo_cb);
  } // do_ajax_form_contabilidad_mob_validate_prefijo

  function do_ajax_form_contabilidad_mob_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_contabilidad_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_contabilidad_mob_validate_numero_cb);
  } // do_ajax_form_contabilidad_mob_validate_numero

  function do_ajax_form_contabilidad_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_numero_cb

  // ---------- Validate fecha
  function do_ajax_form_contabilidad_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_contabilidad_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_contabilidad_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_contabilidad_mob_validate_fecha

  function do_ajax_form_contabilidad_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_fecha_cb

  // ---------- Validate total_debito
  function do_ajax_form_contabilidad_mob_validate_total_debito()
  {
    var nomeCampo_total_debito = "total_debito";
    var var_total_debito = scAjaxGetFieldText(nomeCampo_total_debito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_total_debito(var_total_debito, var_script_case_init, do_ajax_form_contabilidad_mob_validate_total_debito_cb);
  } // do_ajax_form_contabilidad_mob_validate_total_debito

  function do_ajax_form_contabilidad_mob_validate_total_debito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_total_debito_cb

  // ---------- Validate total_credito
  function do_ajax_form_contabilidad_mob_validate_total_credito()
  {
    var nomeCampo_total_credito = "total_credito";
    var var_total_credito = scAjaxGetFieldText(nomeCampo_total_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_total_credito(var_total_credito, var_script_case_init, do_ajax_form_contabilidad_mob_validate_total_credito_cb);
  } // do_ajax_form_contabilidad_mob_validate_total_credito

  function do_ajax_form_contabilidad_mob_validate_total_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_total_credito_cb

  // ---------- Validate notas
  function do_ajax_form_contabilidad_mob_validate_notas()
  {
    var nomeCampo_notas = "notas";
    var var_notas = scAjaxGetFieldText(nomeCampo_notas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_notas(var_notas, var_script_case_init, do_ajax_form_contabilidad_mob_validate_notas_cb);
  } // do_ajax_form_contabilidad_mob_validate_notas

  function do_ajax_form_contabilidad_mob_validate_notas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_notas_cb

  // ---------- Validate importado
  function do_ajax_form_contabilidad_mob_validate_importado()
  {
    var nomeCampo_importado = "importado";
    var var_importado = scAjaxGetFieldCheckbox(nomeCampo_importado, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_importado(var_importado, var_script_case_init, do_ajax_form_contabilidad_mob_validate_importado_cb);
  } // do_ajax_form_contabilidad_mob_validate_importado

  function do_ajax_form_contabilidad_mob_validate_importado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "importado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_importado_cb

  // ---------- Validate id
  function do_ajax_form_contabilidad_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_id(var_id, var_script_case_init, do_ajax_form_contabilidad_mob_validate_id_cb);
  } // do_ajax_form_contabilidad_mob_validate_id

  function do_ajax_form_contabilidad_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_id_cb

  // ---------- Validate asentada
  function do_ajax_form_contabilidad_mob_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldText(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_contabilidad_mob_validate_asentada_cb);
  } // do_ajax_form_contabilidad_mob_validate_asentada

  function do_ajax_form_contabilidad_mob_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_asentada_cb

  // ---------- Validate periodo
  function do_ajax_form_contabilidad_mob_validate_periodo()
  {
    var nomeCampo_periodo = "periodo";
    var var_periodo = scAjaxGetFieldText(nomeCampo_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_periodo(var_periodo, var_script_case_init, do_ajax_form_contabilidad_mob_validate_periodo_cb);
  } // do_ajax_form_contabilidad_mob_validate_periodo

  function do_ajax_form_contabilidad_mob_validate_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periodo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_periodo_cb

  // ---------- Validate usuario
  function do_ajax_form_contabilidad_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_contabilidad_mob_validate_usuario_cb);
  } // do_ajax_form_contabilidad_mob_validate_usuario

  function do_ajax_form_contabilidad_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_usuario_cb

  // ---------- Validate tercero
  function do_ajax_form_contabilidad_mob_validate_tercero()
  {
    var nomeCampo_tercero = "tercero";
    var var_tercero = scAjaxGetFieldText(nomeCampo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_tercero(var_tercero, var_script_case_init, do_ajax_form_contabilidad_mob_validate_tercero_cb);
  } // do_ajax_form_contabilidad_mob_validate_tercero

  function do_ajax_form_contabilidad_mob_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_tercero_cb

  // ---------- Validate creado
  function do_ajax_form_contabilidad_mob_validate_creado()
  {
    var nomeCampo_creado = "creado";
    var var_creado = scAjaxGetFieldText(nomeCampo_creado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_creado(var_creado, var_script_case_init, do_ajax_form_contabilidad_mob_validate_creado_cb);
  } // do_ajax_form_contabilidad_mob_validate_creado

  function do_ajax_form_contabilidad_mob_validate_creado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_creado_cb

  // ---------- Validate actualizado
  function do_ajax_form_contabilidad_mob_validate_actualizado()
  {
    var nomeCampo_actualizado = "actualizado";
    var var_actualizado = scAjaxGetFieldText(nomeCampo_actualizado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_actualizado(var_actualizado, var_script_case_init, do_ajax_form_contabilidad_mob_validate_actualizado_cb);
  } // do_ajax_form_contabilidad_mob_validate_actualizado

  function do_ajax_form_contabilidad_mob_validate_actualizado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "actualizado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_actualizado_cb

  // ---------- Validate detalle
  function do_ajax_form_contabilidad_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_contabilidad_mob_validate_detalle_cb);
  } // do_ajax_form_contabilidad_mob_validate_detalle

  function do_ajax_form_contabilidad_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_mob_validate_detalle_cb

  // ---------- Event onclick notas
  function do_ajax_form_contabilidad_mob_event_notas_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_contabilidad_mob_event_notas_onclick(var_asentada, var_fecha, var_periodo, var_script_case_init, do_ajax_form_contabilidad_mob_event_notas_onclick_cb);
  } // do_ajax_form_contabilidad_mob_event_notas_onclick

  function do_ajax_form_contabilidad_mob_event_notas_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "notas";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contabilidad_mob_event_notas_onclick_cb_after_alert);
  } // do_ajax_form_contabilidad_mob_event_notas_onclick_cb
  function do_ajax_form_contabilidad_mob_event_notas_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contabilidad_mob_event_notas_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contabilidad_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contabilidad_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_total_debito = scAjaxGetFieldText("total_debito");
    var var_total_credito = scAjaxGetFieldText("total_credito");
    var var_notas = scAjaxGetFieldText("notas");
    var var_importado = scAjaxGetFieldCheckbox("importado", ";");
    ...
    var var_actualizado = scAjaxGetFieldText("actualizado");
    ...
    scAjaxProcOn();
    x_ajax_form_contabilidad_mob_submit_form(var_tipodoc, var_prefijo, var_numero, var_fecha, var_total_debito, var_total_credito, var_notas, var_importado, var_id, var_asentada, var_periodo, var_usuario, var_tercero, var_creado, var_actualizado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contabilidad_mob_submit_form_cb);
  } // do_ajax_form_contabilidad_mob_submit_form

  function do_ajax_form_contabilidad_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("importado");
      ...
      scAjaxHideErrorDisplay("actualizado");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contabilidad_mob_submit_form_cb_after_alert);
  } // do_ajax_form_contabilidad_mob_submit_form_cb
  function do_ajax_form_contabilidad_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contabilidad_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_contabilidad_detalle"] = "off";

  function do_ajax_form_contabilidad_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contabilidad_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_contabilidad_mob_navigate_form();
    }
  }

  function perform_ajax_form_contabilidad_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_contabilidad_detalle"] = "on";
    x_ajax_form_contabilidad_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contabilidad_mob_navigate_form_cb);
  } // do_ajax_form_contabilidad_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contabilidad_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contabilidad_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_contabilidad_detalle"] && "nmsc_iframe_liga_grid_contabilidad_detalle" != scMasterDetailIframe["nmsc_iframe_liga_grid_contabilidad_detalle"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_contabilidad_detalle"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_contabilidad_detalle').contentWindow.nm_move('apl_detalhe', true, '500');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contabilidad_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_contabilidad_mob_navigate_form_cb
  function do_ajax_form_contabilidad_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_contabilidad_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_contabilidad_mob_navigate_form_cb_after_alert
  function sc_hide_form_contabilidad_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_contabilidad_detalle"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[4] = "total_debito";
  ajax_field_list[5] = "total_credito";
  ajax_field_list[6] = "notas";
  ajax_field_list[7] = "importado";
  ajax_field_list[8] = "id";
  ajax_field_list[9] = "asentada";
  ajax_field_list[10] = "periodo";
  ajax_field_list[11] = "usuario";
  ajax_field_list[12] = "tercero";
  ajax_field_list[13] = "creado";
  ajax_field_list[14] = "actualizado";
  ...
  var ajax_error_list = {
    "tipodoc": {"label": "Tipo doc.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "total_debito": {"label": "Total Débito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "total_credito": {"label": "Total Crédito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "notas": {"label": "Notas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "importado": {"label": "Importado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "actualizado": {"label": "Actualizado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["importado"][1] = "importado";
  ...
  ajax_field_mult["actualizado"][1] = "actualizado";
  ...
  var ajax_field_id = {
    ...
    "importado": new Array("hidden_field_label_importado", "hidden_field_data_importado"),
