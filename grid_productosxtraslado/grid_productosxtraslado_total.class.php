...
class grid_productosxtraslado_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_productosxtraslado']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_productosxtraslado']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $fl_idpro, $fl_idbod;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(fl.valorpar) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_pesq']; 
      } 
      ...
      if ($rt->fields[0] == 0)
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['interativ_search']))
          {
              $Contrl_Interat = 1;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['interativ_search'] = array();
              $this->quebra_geral_fecha();
          }
          
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['contr_total_geral'] = "OK";
   } 
   ...
   //-----  p_fecha
   function quebra_p_fecha_fecha($p_fecha, $arg_sum_p_fecha) 
   {
      global $tot_p_fecha, $fl_idpro, $fl_idbod;
      $tot_p_fecha = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(fl.valorpar) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_pesq']; 
      ...
      { 
         $nm_comando .= " where " .  $this->Sc_groupby_p_fecha . $arg_sum_p_fecha ; 
      } 
      else 
      { 
         $nm_comando .= " and " .  $this->Sc_groupby_p_fecha . $arg_sum_p_fecha ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_p_fecha[0] = NM_encode_input(sc_strip_script($p_fecha)) ; 
      $tot_p_fecha[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_p_fecha[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
   } 

   //-----  fl_idpro
   function quebra_fl_idpro_producto($fl_idpro, $arg_sum_fl_idpro) 
   {
      global $tot_fl_idpro, $fl_idpro, $fl_idbod;
      $tot_fl_idpro = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(fl.valorpar) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_pesq']; 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_pesq'])) 
      { 
         $nm_comando .= " where fl.idpro" . $arg_sum_fl_idpro ; 
      } 
      else 
      { 
         $nm_comando .= " and fl.idpro" . $arg_sum_fl_idpro ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_fl_idpro[0] = sc_strip_script($fl_idpro) ; 
      $tot_fl_idpro[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_fl_idpro[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
   } 
   ...
   {
      global $nm_lang, $fl_idpro, $fl_idbod;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('p_fecha' => "p.fecha");
      $cmps_quebra_atual = array("p_fecha");
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_fecha($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('fl_iddet' => 'N','fl_numproducc' => 'N','fl_idpro' => 'N','fl_idbod' => 'N','fl_costop' => 'N','fl_cantidad' => 'N','fl_valorpar' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(fl.valorpar)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1)#@#cmps_quebras#@# from (";
         $comando .= "select fl.valorpar as SC_metric1, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['p_fecha']['reg'] = "S";
      $format_dimensions['p_fecha']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
   ...
   function Calc_resumo_producto($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('fl_idpro' => "fl.idpro");
      $cmps_quebra_atual = array("fl_idpro");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_producto($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $format_dimensions = array();
      $format_dimensions['fl_idpro']['reg'] = "S";
      $format_dimensions['fl_idpro']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
              if ($Cada_dim == "fl_idpro") {
                  $this->Lookup->lookup_producto_fl_idpro($$Cada_dim,  $fl_idpro);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
