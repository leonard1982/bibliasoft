...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['contr_label_graf']['p_fecha']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['contr_label_graf']['p_fecha']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['contr_label_graf']['p_fecha'];
      }
   }
