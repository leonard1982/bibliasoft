...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_productosxtraslado"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_productosxtraslado"]);
   }
