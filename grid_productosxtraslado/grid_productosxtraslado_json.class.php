...
class grid_productosxtraslado_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_json()
   {
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_productosxtraslado/grid_productosxtraslado_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_format'];
      }
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_return']);
      ...
      $this->Arq_zip      = $this->Arquivo . "_grid_productosxtraslado.zip";
      $this->Arquivo     .= "_grid_productosxtraslado";
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_productosxtraslado.json";
      $this->Tit_zip      = "grid_productosxtraslado.zip";
   }
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_name']);
      }
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_productosxtraslado_res_json.class.php");
              $this->Res = new grid_productosxtraslado_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_res_grid']);
          } 
      }
   ...
   function NM_export_fl_numproducc()
   {
         ...
         {
             $SC_Label = "fl_numproducc"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fl_numproducc;
   }
   //----- p_fecha
   function NM_export_p_fecha()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->p_fecha;
   }
   //----- fl_idpro
   function NM_export_fl_idpro()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_fl_idpro;
   }
   //----- fl_idbod
   function NM_export_fl_idbod()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->look_fl_idbod;
   }
   //----- fl_cantidad
   function NM_export_fl_cantidad()
   {
         ...
         {
             $SC_Label = "fl_cantidad"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fl_cantidad;
   }
   //----- fl_costop
   function NM_export_fl_costop()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fl_costop;
   }
   //----- fl_valorpar
   function NM_export_fl_valorpar()
   {
         ...
         {
             $SC_Label = "fl_valorpar"; 
         }
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fl_valorpar;
   }
   //----- fl_iddet
   function NM_export_fl_iddet()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fl_iddet;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Materia Prima x N° de traslado :: JSON</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
