...
class grid_productosxtraslado_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_productosxtraslado/grid_productosxtraslado_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_productosxtraslado_res_xls.class.php");
              $this->Res_xls = new grid_productosxtraslado_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_productosxtraslado.zip";
          $this->Arquivo   .= "_grid_productosxtraslado" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_fl_idpro = ($this->fl_idpro == "") ? " is null " : " = " . $this->fl_idpro;
          ...
          {  
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
          ...
          {  
              if (isset($this->fl_idpro_Old) && !$prim_gb)
              {
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_fl_numproducc()
   {
         ...
         if (is_numeric($this->fl_numproducc))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fl_numproducc);
         $this->Xls_col++;
   }
   //----- p_fecha
   ...
   function NM_export_fl_idpro()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_fl_idpro, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_fl_idpro, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fl_idbod
   function NM_export_fl_idbod()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_fl_idbod, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->look_fl_idbod, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fl_cantidad
   ...
   function NM_export_fl_costop()
   {
         ...
         if (is_numeric($this->fl_costop))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fl_costop);
         $this->Xls_col++;
   }
   //----- fl_valorpar
   function NM_export_fl_valorpar()
   {
         ...
         if (is_numeric($this->fl_valorpar))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fl_valorpar);
         $this->Xls_col++;
   }
   //----- fl_iddet
   function NM_export_fl_iddet()
   {
         ...
         if (is_numeric($this->fl_iddet))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->fl_iddet);
         $this->Xls_col++;
   }
   //----- fl_numproducc
   function NM_sub_cons_fl_numproducc()
   {
         $this->fl_numproducc = NM_charset_to_utf8($this->fl_numproducc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fl_numproducc;
   ...
   //----- fl_idpro
   function NM_sub_cons_fl_idpro()
   {
         $this->look_fl_idpro = html_entity_decode($this->look_fl_idpro, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_fl_idpro = strip_tags($this->look_fl_idpro);
         $this->look_fl_idpro = NM_charset_to_utf8($this->look_fl_idpro);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_fl_idpro;
   ...
   //----- fl_idbod
   function NM_sub_cons_fl_idbod()
   {
         $this->look_fl_idbod = html_entity_decode($this->look_fl_idbod, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->look_fl_idbod = strip_tags($this->look_fl_idbod);
         $this->look_fl_idbod = NM_charset_to_utf8($this->look_fl_idbod);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_fl_idbod;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- fl_costop
   function NM_sub_cons_fl_costop()
   {
         $this->fl_costop = NM_charset_to_utf8($this->fl_costop);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fl_costop;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- fl_valorpar
   function NM_sub_cons_fl_valorpar()
   {
         $this->fl_valorpar = NM_charset_to_utf8($this->fl_valorpar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fl_valorpar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- fl_iddet
   function NM_sub_cons_fl_iddet()
   {
         $this->fl_iddet = NM_charset_to_utf8($this->fl_iddet);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fl_iddet;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['nolabel'])
       {
 ...
 function quebra_fl_idpro_producto($fl_idpro) 
 {
   ...
   function quebra_p_fecha_fecha_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_p_fecha_fl_valorpar;
               $prim_cmp = false;
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_fl_idpro_producto_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_fl_idpro_fl_valorpar;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_geral_fecha_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "fl_valorpar" && (!isset($this->NM_cmp_hidden['fl_valorpar']) || $this->NM_cmp_hidden['fl_valorpar'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productosxtraslado']['tot_geral'][2];
               $prim_cmp = false;
