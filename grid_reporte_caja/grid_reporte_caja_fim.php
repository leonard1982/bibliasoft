...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reporte_caja"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reporte_caja"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_caja']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_caja']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_caja']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_caja']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reporte_caja']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_caja']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reporte_caja']['embutida_filho'] as $ind => $sc_init)
          {
