...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['nom_docu'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['fecha'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nom_empresa'])) ? $this->New_label['nom_empresa'] : "nom_empresa"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['nom_empresa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['direccion'])) ? $this->New_label['direccion'] : "direccion"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['correo'])) ? $this->New_label['correo'] : "correo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['correo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['telefono'])) ? $this->New_label['telefono'] : "telefono"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et1'])) ? $this->New_label['et1'] : "et1"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et1'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['res'])) ? $this->New_label['res'] : "res"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['res'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et2'])) ? $this->New_label['et2'] : "et2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et2'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['documento'])) ? $this->New_label['documento'] : "documento"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['documento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et3'])) ? $this->New_label['et3'] : "et3"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et3'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['rango'])) ? $this->New_label['rango'] : "rango"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['rango'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et4'])) ? $this->New_label['et4'] : "et4"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et4'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cant_fact'])) ? $this->New_label['cant_fact'] : "cant_fact"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['cant_fact'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et5'])) ? $this->New_label['et5'] : "et5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['total'])) ? $this->New_label['total'] : "total"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et6'])) ? $this->New_label['et6'] : "et6"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et6'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et7'])) ? $this->New_label['et7'] : "et7"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et7'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et8'])) ? $this->New_label['et8'] : "et8"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et8'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et9'])) ? $this->New_label['et9'] : "et9"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et9'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['can_efec'])) ? $this->New_label['can_efec'] : "can_efec"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['can_efec'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_efec'])) ? $this->New_label['med_efec'] : "med_efec"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['med_efec'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_efec'])) ? $this->New_label['porc_efec'] : "porc_efec"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['porc_efec'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tot_efec'])) ? $this->New_label['tot_efec'] : "tot_efec"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['tot_efec'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['c_tarj'])) ? $this->New_label['c_tarj'] : "c_tarj"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['c_tarj'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_tarj'])) ? $this->New_label['med_tarj'] : "med_tarj"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['med_tarj'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_tarj'])) ? $this->New_label['porc_tarj'] : "porc_tarj"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['porc_tarj'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tarjeta'])) ? $this->New_label['tarjeta'] : "tarjeta"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['tarjeta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['c_cheq'])) ? $this->New_label['c_cheq'] : "c_cheq"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['c_cheq'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_cheq'])) ? $this->New_label['med_cheq'] : "med_cheq"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['med_cheq'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_cheq'])) ? $this->New_label['porc_cheq'] : "porc_cheq"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['porc_cheq'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cheque'])) ? $this->New_label['cheque'] : "cheque"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['cheque'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['c_tra'])) ? $this->New_label['c_tra'] : "c_tra"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['c_tra'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_tran'])) ? $this->New_label['med_tran'] : "med_tran"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['med_tran'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_tran'])) ? $this->New_label['porc_tran'] : "porc_tran"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['porc_tran'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['trans'])) ? $this->New_label['trans'] : "trans"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['trans'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['c_credito'])) ? $this->New_label['c_credito'] : "c_credito"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['c_credito'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_cred'])) ? $this->New_label['med_cred'] : "med_cred"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['med_cred'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_credito'])) ? $this->New_label['porc_credito'] : "porc_credito"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['porc_credito'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['credito'])) ? $this->New_label['credito'] : "credito"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['credito'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et10'])) ? $this->New_label['et10'] : "et10"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et10'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['total_vtas'])) ? $this->New_label['total_vtas'] : "total_vtas"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['total_vtas'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_iva'])) ? $this->New_label['et_iva'] : "et_iva"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_base'])) ? $this->New_label['et_base'] : "et_base"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_base'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_val_iva'])) ? $this->New_label['et_val_iva'] : "et_val_iva"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_val_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['etiva_19'])) ? $this->New_label['etiva_19'] : "etiva_19"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['etiva_19'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['base19'])) ? $this->New_label['base19'] : "base19"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['base19'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['iva_19'])) ? $this->New_label['iva_19'] : "iva_19"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['iva_19'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['etiva_5'])) ? $this->New_label['etiva_5'] : "etiva_5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['etiva_5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['base5'])) ? $this->New_label['base5'] : "base5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['base5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['iva_5'])) ? $this->New_label['iva_5'] : "iva_5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['iva_5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['etexc_0'])) ? $this->New_label['etexc_0'] : "etexc_0"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['etexc_0'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['base0'])) ? $this->New_label['base0'] : "base0"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['base0'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['iva_0'])) ? $this->New_label['iva_0'] : "iva_0"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['iva_0'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_tot'])) ? $this->New_label['et_tot'] : "et_tot"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_tot'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tot_base'])) ? $this->New_label['tot_base'] : "tot_base"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['tot_base'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tot_iva'])) ? $this->New_label['tot_iva'] : "tot_iva"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['tot_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et20'])) ? $this->New_label['et20'] : "et20"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et20'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_vac'])) ? $this->New_label['et_vac'] : "et_vac"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_vac'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_imb'])) ? $this->New_label['et_imb'] : "et_imb"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_imb'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['imp_bol'])) ? $this->New_label['imp_bol'] : "imp_bol"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['imp_bol'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_ic'])) ? $this->New_label['et_ic'] : "et_ic"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_ic'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['imp_consumo'])) ? $this->New_label['imp_consumo'] : "imp_consumo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['imp_consumo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_ic_dev'])) ? $this->New_label['et_ic_dev'] : "et_ic_dev"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_ic_dev'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['imp_consumo_dev'])) ? $this->New_label['imp_consumo_dev'] : "imp_consumo_dev"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['imp_consumo_dev'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_tot_inc'])) ? $this->New_label['et_tot_inc'] : "et_tot_inc"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_tot_inc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tot_inc'])) ? $this->New_label['tot_inc'] : "tot_inc"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['tot_inc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_vn'])) ? $this->New_label['et_vn'] : "et_vn"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_vn'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['venta_netas'])) ? $this->New_label['venta_netas'] : "venta_netas"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['venta_netas'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_reg'])) ? $this->New_label['et_reg'] : "et_reg"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_reg'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['vent_reg'])) ? $this->New_label['vent_reg'] : "vent_reg"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['vent_reg'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_anuladas'])) ? $this->New_label['fac_anuladas'] : "fac_anuladas"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['fac_anuladas'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['f_anul'])) ? $this->New_label['f_anul'] : "f_anul"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['f_anul'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_obs'])) ? $this->New_label['et_obs'] : "et_obs"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_obs'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['obs'])) ? $this->New_label['obs'] : "obs"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['obs'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_fech_imp'])) ? $this->New_label['et_fech_imp'] : "et_fech_imp"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_fech_imp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fecha_imp'])) ? $this->New_label['fecha_imp'] : "fecha_imp"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['fecha_imp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_ubic'])) ? $this->New_label['et_ubic'] : "et_ubic"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_ubic'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ubicacion'])) ? $this->New_label['ubicacion'] : "ubicacion"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['ubicacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_equipo'])) ? $this->New_label['et_equipo'] : "et_equipo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_equipo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nom_equipo'])) ? $this->New_label['nom_equipo'] : "nom_equipo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['nom_equipo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_serial'])) ? $this->New_label['et_serial'] : "et_serial"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_serial'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['serial'])) ? $this->New_label['serial'] : "serial"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['serial'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_fin2'])) ? $this->New_label['et_fin2'] : "et_fin2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['labels']['et_fin2'] = $SC_Label; 
   ...
   if (!empty($this->nm_grid_sem_reg))
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'])
       {
           ...
           else
           {
               ...
               $nm_id_aplicacao = "";
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridFieldOdd . "\"  style=\"padding: 0px; font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\" colspan = \"84\" align=\"center\">\r\n");
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_c_tra_grid_line . "\"  style=\"" . $this->Css_Cmp['css_c_tra_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'c_tra', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_med_tran_grid_line . "\"  style=\"" . $this->Css_Cmp['css_med_tran_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'med_tran', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_porc_tran_grid_line . "\"  style=\"" . $this->Css_Cmp['css_porc_tran_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porc_tran', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_trans_grid_line . "\"  style=\"" . $this->Css_Cmp['css_trans_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'trans', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_imb_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_imb_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_imb', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_imp_bol_grid_line . "\"  style=\"" . $this->Css_Cmp['css_imp_bol_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'imp_bol', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['ajax_nav'])
          {
      ...
      $Tem_pdf_res = "n";
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_caja/grid_reporte_caja_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=" . s . "&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=4&password=n&summary_export_columns=N&pdf_zip=N&origem=cons&language=es&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_reporte_caja&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_caja/grid_reporte_caja_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=PC&nm_cor=PB&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_reporte_caja/grid_reporte_caja_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_reporte_caja/grid_reporte_caja_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opc_psq'])
   ...
   function nmgp_barra_bot_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opcao_print'] != "print") 
      {
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['opc_liga']['nav']))
          {
