<?php
   ...
   session_start();
    ...
    $exportEmail = new exportEmail_grid_reporte_caja(); 
   
class exportEmail_grid_reporte_caja
{
  ...
  'from_name' => 'FACILWEB - REPORTE POS FISCAL',
),
                          'message' => [
...
<HEAD>
 <TITLE><?php echo "Reporte POS Fiscal"; ?></TITLE>
...
?>
            ...
            function html_export_email_send()
            {
                $.ajax({
                    type: 'POST',
                    url: 'grid_reporte_caja_export_email.php',
