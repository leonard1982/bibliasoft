...
<?php
   ...
   $Ord_Cmp = new grid_kardex_nc_tns_consultar_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_kardex_nc_tns_consultar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codcomp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["codcomp"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["codcomp"] : "TIPO";
   $tab_ger_campos['codprefijo'] = "on";
   $tab_def_campos['codprefijo'] = "CODPREFIJO";
   $tab_labels["codprefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["codprefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["codprefijo"] : "PJ/TNS";
   ...
   $tab_labels["pj_fe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["pj_fe"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["pj_fe"] : "PJ/FE";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "NUMERO";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["numero"] : "#";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "FECHA";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["fecha"] : "FECHA";
   $tab_ger_campos['nit_tercero'] = "on";
   $tab_def_campos['nit_tercero'] = "NIT_TERCERO";
   $tab_labels["nit_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["nit_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["nit_tercero"] : "ID";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "NOMBRE";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["nombre"] : "NOMBRE";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "TOTAL";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['labels']["total"] : "TOTAL";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_kardex_nc_tns_consultar_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_kardex_nc_tns_consultar']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
