...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_nc_tns_consultar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_nc_tns_consultar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_consultar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_consultar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_consultar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_consultar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_consultar']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kardex_nc_tns_consultar</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_consultar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns_consultar']['embutida_filho'] as $ind => $sc_init)
          {
