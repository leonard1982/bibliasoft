  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pagar_pedido_270519" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pagar_pedido_270519_form();
	}
  ...
  // ---------- Validate idpedido
  function do_ajax_form_pagar_pedido_270519_validate_idpedido()
  {
    var nomeCampo_idpedido = "idpedido";
    var var_idpedido = scAjaxGetFieldHidden(nomeCampo_idpedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_idpedido(var_idpedido, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_idpedido_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_idpedido

  function do_ajax_form_pagar_pedido_270519_validate_idpedido_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_idpedido_cb

  // ---------- Validate fechaven
  function do_ajax_form_pagar_pedido_270519_validate_fechaven()
  {
    var nomeCampo_fechaven = "fechaven";
    var var_fechaven = scAjaxGetFieldText(nomeCampo_fechaven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_fechaven(var_fechaven, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_fechaven_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_fechaven

  function do_ajax_form_pagar_pedido_270519_validate_fechaven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_fechaven_cb

  // ---------- Validate prefijo_ped
  function do_ajax_form_pagar_pedido_270519_validate_prefijo_ped()
  {
    var nomeCampo_prefijo_ped = "prefijo_ped";
    var var_prefijo_ped = scAjaxGetFieldSelect(nomeCampo_prefijo_ped);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_prefijo_ped(var_prefijo_ped, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_prefijo_ped_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_prefijo_ped

  function do_ajax_form_pagar_pedido_270519_validate_prefijo_ped_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_prefijo_ped_cb

  // ---------- Validate numpedido
  function do_ajax_form_pagar_pedido_270519_validate_numpedido()
  {
    var nomeCampo_numpedido = "numpedido";
    var var_numpedido = scAjaxGetFieldText(nomeCampo_numpedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_numpedido(var_numpedido, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_numpedido_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_numpedido

  function do_ajax_form_pagar_pedido_270519_validate_numpedido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_numpedido_cb

  // ---------- Validate adicional
  function do_ajax_form_pagar_pedido_270519_validate_adicional()
  {
    var nomeCampo_adicional = "adicional";
    var var_adicional = scAjaxGetFieldText(nomeCampo_adicional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_adicional(var_adicional, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_adicional_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_adicional

  function do_ajax_form_pagar_pedido_270519_validate_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_adicional_cb

  // ---------- Validate total
  function do_ajax_form_pagar_pedido_270519_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_total(var_total, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_total_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_total

  function do_ajax_form_pagar_pedido_270519_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_total_cb

  // ---------- Validate idcli
  function do_ajax_form_pagar_pedido_270519_validate_idcli()
  {
    var nomeCampo_idcli = "idcli";
    var var_idcli = scAjaxGetFieldSelect(nomeCampo_idcli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_idcli(var_idcli, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_idcli_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_idcli

  function do_ajax_form_pagar_pedido_270519_validate_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_idcli_cb

  // ---------- Validate obspago
  function do_ajax_form_pagar_pedido_270519_validate_obspago()
  {
    var nomeCampo_obspago = "obspago";
    var var_obspago = scAjaxGetFieldText(nomeCampo_obspago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_obspago(var_obspago, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_obspago_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_obspago

  function do_ajax_form_pagar_pedido_270519_validate_obspago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "obspago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_obspago_cb

  // ---------- Validate asentada
  function do_ajax_form_pagar_pedido_270519_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldText(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_asentada_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_asentada

  function do_ajax_form_pagar_pedido_270519_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_asentada_cb

  // ---------- Validate formapago
  function do_ajax_form_pagar_pedido_270519_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldSelect(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_formapago(var_formapago, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_formapago_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_formapago

  function do_ajax_form_pagar_pedido_270519_validate_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_formapago_cb

  // ---------- Validate adicional2
  function do_ajax_form_pagar_pedido_270519_validate_adicional2()
  {
    var nomeCampo_adicional2 = "adicional2";
    var var_adicional2 = scAjaxGetFieldText(nomeCampo_adicional2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_adicional2(var_adicional2, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_adicional2_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_adicional2

  function do_ajax_form_pagar_pedido_270519_validate_adicional2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_adicional2_cb

  // ---------- Validate adicional3
  function do_ajax_form_pagar_pedido_270519_validate_adicional3()
  {
    var nomeCampo_adicional3 = "adicional3";
    var var_adicional3 = scAjaxGetFieldText(nomeCampo_adicional3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_270519_validate_adicional3(var_adicional3, var_script_case_init, do_ajax_form_pagar_pedido_270519_validate_adicional3_cb);
  } // do_ajax_form_pagar_pedido_270519_validate_adicional3

  function do_ajax_form_pagar_pedido_270519_validate_adicional3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_270519_validate_adicional3_cb

  // ---------- Event onchange adicional2
  function do_ajax_form_pagar_pedido_270519_event_adicional2_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_pagar_pedido_270519_event_adicional2_onchange(var_adicional2, var_total, var_adicional3, var_script_case_init, do_ajax_form_pagar_pedido_270519_event_adicional2_onchange_cb);
  } // do_ajax_form_pagar_pedido_270519_event_adicional2_onchange

  function do_ajax_form_pagar_pedido_270519_event_adicional2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "adicional2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagar_pedido_270519_event_adicional2_onchange_cb_after_alert);
  } // do_ajax_form_pagar_pedido_270519_event_adicional2_onchange_cb
  function do_ajax_form_pagar_pedido_270519_event_adicional2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pagar_pedido_270519_event_adicional2_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pagar_pedido_270519_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pagar_pedido_270519_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_pagar_pedido_270519_submit_form(var_idpedido, var_fechaven, var_prefijo_ped, var_numpedido, var_adicional, var_total, var_idcli, var_obspago, var_asentada, var_formapago, var_adicional2, var_adicional3, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pagar_pedido_270519_submit_form_cb);
  } // do_ajax_form_pagar_pedido_270519_submit_form

  function do_ajax_form_pagar_pedido_270519_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pagar_pedido_270519_submit_form_cb_after_alert);
  } // do_ajax_form_pagar_pedido_270519_submit_form_cb
  function do_ajax_form_pagar_pedido_270519_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pagar_pedido_270519_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pagar_pedido_270519_navigate_form()
  {
    perform_ajax_form_pagar_pedido_270519_navigate_form();
  }

  function perform_ajax_form_pagar_pedido_270519_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pagar_pedido_270519_navigate_form(var_idpedido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagar_pedido_270519_navigate_form_cb);
  } // do_ajax_form_pagar_pedido_270519_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pagar_pedido_270519_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pagar_pedido_270519_navigate_form_cb_after_alert);
  } // do_ajax_form_pagar_pedido_270519_navigate_form_cb
  function do_ajax_form_pagar_pedido_270519_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_pagar_pedido_270519_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pagar_pedido_270519_navigate_form_cb_after_alert
  function sc_hide_form_pagar_pedido_270519_form()
  {
