...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pagar_pedido_270519"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
var Crtl_btn_btnpagar = false;
function sc_btn_btnpagar()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btnpagar(); }, 500);
      return;
    }
    if (Crtl_btn_btnpagar) {return;}
    sc_btn_btnpagar_ok();
}
function sc_btn_btnpagar_cancel()
{
}
function sc_btn_btnpagar_ok()
{
    Crtl_btn_btnpagar = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?btnpagar?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
var Crtl_btn_hacerpago = false;
function sc_btn_hacerpago()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_hacerpago(); }, 500);
      return;
    }
    if (Crtl_btn_hacerpago) {return;}
    sc_btn_hacerpago_ok();
}
function sc_btn_hacerpago_cancel()
{
}
function sc_btn_hacerpago_ok()
{
    Crtl_btn_hacerpago = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?hacerpago?@?";
    document.F1.action = "./";
    document.F1.target = "_self";
    document.F1.submit();
}
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_pagar_pedido_270519_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_pagar_pedido_270519_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
