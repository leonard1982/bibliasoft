...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['run_iframe'] != "R")
{
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['hacerpago'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = '';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_disabled']['hacerpago']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_disabled']['hacerpago']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_label']['hacerpago']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_label']['hacerpago']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_label']['hacerpago'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "hacerpago", "scBtnFn_hacerpago()", "scBtnFn_hacerpago()", "sc_hacerpago_top", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if ($opcao_botoes != "novo") {
        $sCondStyle = ($this->nmgp_botoes['btnpagar'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = '';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_disabled']['btnpagar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_disabled']['btnpagar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_label']['btnpagar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_label']['btnpagar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_270519_mob']['btn_label']['btnpagar'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "btnpagar", "scBtnFn_btnpagar()", "scBtnFn_btnpagar()", "sc_btnpagar_bot", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
