...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_nc_tns"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_nc_tns"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kardex_nc_tns</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kardex_nc_tns']['embutida_filho'] as $ind => $sc_init)
          {
