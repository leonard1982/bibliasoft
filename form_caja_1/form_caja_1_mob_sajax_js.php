  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_caja_1_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idcaja
  function do_ajax_form_caja_1_mob_validate_idcaja()
  {
    var nomeCampo_idcaja = "idcaja";
    var var_idcaja = scAjaxGetFieldHidden(nomeCampo_idcaja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_idcaja(var_idcaja, var_script_case_init, do_ajax_form_caja_1_mob_validate_idcaja_cb);
  } // do_ajax_form_caja_1_mob_validate_idcaja

  function do_ajax_form_caja_1_mob_validate_idcaja_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_idcaja_cb

  // ---------- Validate fecha
  function do_ajax_form_caja_1_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_caja_1_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_caja_1_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_caja_1_mob_validate_fecha

  function do_ajax_form_caja_1_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_fecha_cb

  // ---------- Validate jornada
  function do_ajax_form_caja_1_mob_validate_jornada()
  {
    var nomeCampo_jornada = "jornada";
    var var_jornada = scAjaxGetFieldText(nomeCampo_jornada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_jornada(var_jornada, var_script_case_init, do_ajax_form_caja_1_mob_validate_jornada_cb);
  } // do_ajax_form_caja_1_mob_validate_jornada

  function do_ajax_form_caja_1_mob_validate_jornada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jornada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_jornada_cb

  // ---------- Validate detalle
  function do_ajax_form_caja_1_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_caja_1_mob_validate_detalle_cb);
  } // do_ajax_form_caja_1_mob_validate_detalle

  function do_ajax_form_caja_1_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_detalle_cb

  // ---------- Validate nota
  function do_ajax_form_caja_1_mob_validate_nota()
  {
    var nomeCampo_nota = "nota";
    var var_nota = scAjaxGetFieldText(nomeCampo_nota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_nota(var_nota, var_script_case_init, do_ajax_form_caja_1_mob_validate_nota_cb);
  } // do_ajax_form_caja_1_mob_validate_nota

  function do_ajax_form_caja_1_mob_validate_nota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nota";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_nota_cb

  // ---------- Validate cantidad
  function do_ajax_form_caja_1_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_caja_1_mob_validate_cantidad_cb);
  } // do_ajax_form_caja_1_mob_validate_cantidad

  function do_ajax_form_caja_1_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_cantidad_cb

  // ---------- Validate documento
  function do_ajax_form_caja_1_mob_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldText(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_documento(var_documento, var_script_case_init, do_ajax_form_caja_1_mob_validate_documento_cb);
  } // do_ajax_form_caja_1_mob_validate_documento

  function do_ajax_form_caja_1_mob_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_documento_cb

  // ---------- Validate cierredia
  function do_ajax_form_caja_1_mob_validate_cierredia()
  {
    var nomeCampo_cierredia = "cierredia";
    var var_cierredia = scAjaxGetFieldText(nomeCampo_cierredia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_cierredia(var_cierredia, var_script_case_init, do_ajax_form_caja_1_mob_validate_cierredia_cb);
  } // do_ajax_form_caja_1_mob_validate_cierredia

  function do_ajax_form_caja_1_mob_validate_cierredia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_cierredia_cb

  // ---------- Validate totaldia
  function do_ajax_form_caja_1_mob_validate_totaldia()
  {
    var nomeCampo_totaldia = "totaldia";
    var var_totaldia = scAjaxGetFieldText(nomeCampo_totaldia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_totaldia(var_totaldia, var_script_case_init, do_ajax_form_caja_1_mob_validate_totaldia_cb);
  } // do_ajax_form_caja_1_mob_validate_totaldia

  function do_ajax_form_caja_1_mob_validate_totaldia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_totaldia_cb

  // ---------- Validate arqueo
  function do_ajax_form_caja_1_mob_validate_arqueo()
  {
    var nomeCampo_arqueo = "arqueo";
    var var_arqueo = scAjaxGetFieldText(nomeCampo_arqueo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_arqueo(var_arqueo, var_script_case_init, do_ajax_form_caja_1_mob_validate_arqueo_cb);
  } // do_ajax_form_caja_1_mob_validate_arqueo

  function do_ajax_form_caja_1_mob_validate_arqueo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "arqueo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_arqueo_cb

  // ---------- Validate saldo
  function do_ajax_form_caja_1_mob_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldText(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_mob_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_caja_1_mob_validate_saldo_cb);
  } // do_ajax_form_caja_1_mob_validate_saldo

  function do_ajax_form_caja_1_mob_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_mob_validate_saldo_cb

  // ---------- Event onchange documento
  function do_ajax_form_caja_1_mob_event_documento_onchange()
  {
    var var_detalle = scAjaxGetFieldText("detalle");
    var var_documento = scAjaxGetFieldText("documento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_1_mob_event_documento_onchange(var_detalle, var_documento, var_script_case_init, do_ajax_form_caja_1_mob_event_documento_onchange_cb);
  } // do_ajax_form_caja_1_mob_event_documento_onchange

  function do_ajax_form_caja_1_mob_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_1_mob_event_documento_onchange_cb_after_alert);
  } // do_ajax_form_caja_1_mob_event_documento_onchange_cb
  function do_ajax_form_caja_1_mob_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_1_mob_event_documento_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_caja_1_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_caja_1_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_caja_1_mob_submit_form(var_idcaja, var_fecha, var_jornada, var_detalle, var_nota, var_cantidad, var_documento, var_cierredia, var_totaldia, var_arqueo, var_saldo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_caja_1_mob_submit_form_cb);
  } // do_ajax_form_caja_1_mob_submit_form

  function do_ajax_form_caja_1_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_caja_1_mob_submit_form_cb_after_alert);
  } // do_ajax_form_caja_1_mob_submit_form_cb
  function do_ajax_form_caja_1_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_caja_1_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_caja_1_mob_navigate_form()
  {
    perform_ajax_form_caja_1_mob_navigate_form();
  }

  function perform_ajax_form_caja_1_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_caja_1_mob_navigate_form(var_idcaja, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_caja_1_mob_navigate_form_cb);
  } // do_ajax_form_caja_1_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_caja_1_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_caja_1_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_caja_1_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_caja_1_mob_navigate_form_cb
  function do_ajax_form_caja_1_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_caja_1_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_caja_1_mob_navigate_form_cb_after_alert
  function sc_hide_form_caja_1_mob_form()
  {
