  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_caja_1" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idcaja
  function do_ajax_form_caja_1_validate_idcaja()
  {
    var nomeCampo_idcaja = "idcaja";
    var var_idcaja = scAjaxGetFieldHidden(nomeCampo_idcaja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_idcaja(var_idcaja, var_script_case_init, do_ajax_form_caja_1_validate_idcaja_cb);
  } // do_ajax_form_caja_1_validate_idcaja

  function do_ajax_form_caja_1_validate_idcaja_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_idcaja_cb

  // ---------- Validate fecha
  function do_ajax_form_caja_1_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_caja_1_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_caja_1_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_caja_1_validate_fecha

  function do_ajax_form_caja_1_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_fecha_cb

  // ---------- Validate jornada
  function do_ajax_form_caja_1_validate_jornada()
  {
    var nomeCampo_jornada = "jornada";
    var var_jornada = scAjaxGetFieldText(nomeCampo_jornada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_jornada(var_jornada, var_script_case_init, do_ajax_form_caja_1_validate_jornada_cb);
  } // do_ajax_form_caja_1_validate_jornada

  function do_ajax_form_caja_1_validate_jornada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "jornada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_jornada_cb

  // ---------- Validate detalle
  function do_ajax_form_caja_1_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_caja_1_validate_detalle_cb);
  } // do_ajax_form_caja_1_validate_detalle

  function do_ajax_form_caja_1_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_detalle_cb

  // ---------- Validate nota
  function do_ajax_form_caja_1_validate_nota()
  {
    var nomeCampo_nota = "nota";
    var var_nota = scAjaxGetFieldText(nomeCampo_nota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_nota(var_nota, var_script_case_init, do_ajax_form_caja_1_validate_nota_cb);
  } // do_ajax_form_caja_1_validate_nota

  function do_ajax_form_caja_1_validate_nota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nota";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_nota_cb

  // ---------- Validate cantidad
  function do_ajax_form_caja_1_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_caja_1_validate_cantidad_cb);
  } // do_ajax_form_caja_1_validate_cantidad

  function do_ajax_form_caja_1_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_cantidad_cb

  // ---------- Validate documento
  function do_ajax_form_caja_1_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldText(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_documento(var_documento, var_script_case_init, do_ajax_form_caja_1_validate_documento_cb);
  } // do_ajax_form_caja_1_validate_documento

  function do_ajax_form_caja_1_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_documento_cb

  // ---------- Validate cierredia
  function do_ajax_form_caja_1_validate_cierredia()
  {
    var nomeCampo_cierredia = "cierredia";
    var var_cierredia = scAjaxGetFieldText(nomeCampo_cierredia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_cierredia(var_cierredia, var_script_case_init, do_ajax_form_caja_1_validate_cierredia_cb);
  } // do_ajax_form_caja_1_validate_cierredia

  function do_ajax_form_caja_1_validate_cierredia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_cierredia_cb

  // ---------- Validate totaldia
  function do_ajax_form_caja_1_validate_totaldia()
  {
    var nomeCampo_totaldia = "totaldia";
    var var_totaldia = scAjaxGetFieldText(nomeCampo_totaldia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_totaldia(var_totaldia, var_script_case_init, do_ajax_form_caja_1_validate_totaldia_cb);
  } // do_ajax_form_caja_1_validate_totaldia

  function do_ajax_form_caja_1_validate_totaldia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "totaldia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_totaldia_cb

  // ---------- Validate arqueo
  function do_ajax_form_caja_1_validate_arqueo()
  {
    var nomeCampo_arqueo = "arqueo";
    var var_arqueo = scAjaxGetFieldText(nomeCampo_arqueo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_arqueo(var_arqueo, var_script_case_init, do_ajax_form_caja_1_validate_arqueo_cb);
  } // do_ajax_form_caja_1_validate_arqueo

  function do_ajax_form_caja_1_validate_arqueo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "arqueo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_arqueo_cb

  // ---------- Validate saldo
  function do_ajax_form_caja_1_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldText(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_1_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_caja_1_validate_saldo_cb);
  } // do_ajax_form_caja_1_validate_saldo

  function do_ajax_form_caja_1_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_1_validate_saldo_cb

  // ---------- Event onchange documento
  function do_ajax_form_caja_1_event_documento_onchange()
  {
    var var_detalle = scAjaxGetFieldText("detalle");
    var var_documento = scAjaxGetFieldText("documento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_1_event_documento_onchange(var_detalle, var_documento, var_script_case_init, do_ajax_form_caja_1_event_documento_onchange_cb);
  } // do_ajax_form_caja_1_event_documento_onchange

  function do_ajax_form_caja_1_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_1_event_documento_onchange_cb_after_alert);
  } // do_ajax_form_caja_1_event_documento_onchange_cb
  function do_ajax_form_caja_1_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_1_event_documento_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_caja_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_caja_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcaja = scAjaxGetFieldHidden("idcaja");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_jornada = scAjaxGetFieldText("jornada");
    var var_detalle = scAjaxGetFieldText("detalle");
    var var_nota = scAjaxGetFieldText("nota");
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_documento = scAjaxGetFieldText("documento");
    var var_cierredia = scAjaxGetFieldText("cierredia");
    var var_totaldia = scAjaxGetFieldText("totaldia");
    var var_arqueo = scAjaxGetFieldText("arqueo");
    ...
    scAjaxProcOn();
    x_ajax_form_caja_1_submit_form(var_idcaja, var_fecha, var_jornada, var_detalle, var_nota, var_cantidad, var_documento, var_cierredia, var_totaldia, var_arqueo, var_saldo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_caja_1_submit_form_cb);
  } // do_ajax_form_caja_1_submit_form

  function do_ajax_form_caja_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("jornada");
      ...
      scAjaxHideErrorDisplay("totaldia");
      scAjaxHideErrorDisplay("arqueo");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_caja_1_submit_form_cb_after_alert);
  } // do_ajax_form_caja_1_submit_form_cb
  function do_ajax_form_caja_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_caja_1_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_caja_1_navigate_form()
  {
    perform_ajax_form_caja_1_navigate_form();
  }

  function perform_ajax_form_caja_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_caja_1_navigate_form(var_idcaja, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_caja_1_navigate_form_cb);
  } // do_ajax_form_caja_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_caja_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_caja_1_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_caja_1_navigate_form_cb_after_alert);
  } // do_ajax_form_caja_1_navigate_form_cb
  function do_ajax_form_caja_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_caja_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_caja_1_navigate_form_cb_after_alert
  function sc_hide_form_caja_1_form()
  {
  ...
  ajax_field_list[0] = "idcaja";
  ajax_field_list[1] = "fecha";
  ajax_field_list[2] = "jornada";
  ajax_field_list[3] = "detalle";
  ajax_field_list[4] = "nota";
  ajax_field_list[5] = "cantidad";
  ajax_field_list[6] = "documento";
  ajax_field_list[7] = "cierredia";
  ajax_field_list[8] = "totaldia";
  ajax_field_list[9] = "arqueo";
  ajax_field_list[10] = "saldo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idcaja": {"label": "Idcaja", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "jornada": {"label": "Jornada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detalle": {"label": "Detalle", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nota": {"label": "Nota", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "cierredia": {"label": "Cierredia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "totaldia": {"label": "Totaldia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "arqueo": {"label": "Arqueo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["jornada"][1] = "jornada";
  ...
  ajax_field_mult["totaldia"][1] = "totaldia";
  ajax_field_mult["arqueo"][1] = "arqueo";
  ...
  var ajax_field_id = {
    ...
    "jornada": new Array("hidden_field_label_jornada", "hidden_field_data_jornada"),
    ...
    "totaldia": new Array("hidden_field_label_totaldia", "hidden_field_data_totaldia"),
    "arqueo": new Array("hidden_field_label_arqueo", "hidden_field_data_arqueo"),
