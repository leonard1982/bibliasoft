  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_terceros_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_terceros_mob_form();
	}
  ...
  // ---------- Validate id_cloud_tercero
  function do_ajax_form_cloud_terceros_mob_validate_id_cloud_tercero()
  {
    var nomeCampo_id_cloud_tercero = "id_cloud_tercero";
    var var_id_cloud_tercero = scAjaxGetFieldHidden(nomeCampo_id_cloud_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_id_cloud_tercero(var_id_cloud_tercero, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_id_cloud_tercero_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_id_cloud_tercero

  function do_ajax_form_cloud_terceros_mob_validate_id_cloud_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_cloud_tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_id_cloud_tercero_cb

  // ---------- Validate documento
  function do_ajax_form_cloud_terceros_mob_validate_documento()
  {
  } // do_ajax_form_cloud_terceros_mob_validate_documento

  function do_ajax_form_cloud_terceros_mob_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_documento_cb

  // ---------- Validate nombres
  function do_ajax_form_cloud_terceros_mob_validate_nombres()
  {
  } // do_ajax_form_cloud_terceros_mob_validate_nombres

  function do_ajax_form_cloud_terceros_mob_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_nombres_cb

  // ---------- Validate id_empresa
  function do_ajax_form_cloud_terceros_mob_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldText(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_id_empresa_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_id_empresa

  function do_ajax_form_cloud_terceros_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_id_empresa_cb

  // ---------- Validate cod_departamento
  function do_ajax_form_cloud_terceros_mob_validate_cod_departamento()
  {
    var nomeCampo_cod_departamento = "cod_departamento";
    var var_cod_departamento = scAjaxGetFieldSelect(nomeCampo_cod_departamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_cod_departamento(var_cod_departamento, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_cod_departamento_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_cod_departamento

  function do_ajax_form_cloud_terceros_mob_validate_cod_departamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_departamento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_cod_departamento_cb

  // ---------- Validate cod_municipio
  function do_ajax_form_cloud_terceros_mob_validate_cod_municipio()
  {
    var nomeCampo_cod_municipio = "cod_municipio";
    var var_cod_municipio = scAjaxGetFieldSelect(nomeCampo_cod_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_cod_municipio(var_cod_municipio, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_cod_municipio_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_cod_municipio

  function do_ajax_form_cloud_terceros_mob_validate_cod_municipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_municipio";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_cod_municipio_cb

  // ---------- Validate cod_postal
  function do_ajax_form_cloud_terceros_mob_validate_cod_postal()
  {
    var nomeCampo_cod_postal = "cod_postal";
    var var_cod_postal = scAjaxGetFieldText(nomeCampo_cod_postal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_cod_postal(var_cod_postal, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_cod_postal_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_cod_postal

  function do_ajax_form_cloud_terceros_mob_validate_cod_postal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_postal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_cod_postal_cb

  // ---------- Validate cod_regimen
  function do_ajax_form_cloud_terceros_mob_validate_cod_regimen()
  {
    var nomeCampo_cod_regimen = "cod_regimen";
    var var_cod_regimen = scAjaxGetFieldSelect(nomeCampo_cod_regimen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_cod_regimen(var_cod_regimen, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_cod_regimen_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_cod_regimen

  function do_ajax_form_cloud_terceros_mob_validate_cod_regimen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_regimen";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_cod_regimen_cb

  // ---------- Validate detalle_tributario
  function do_ajax_form_cloud_terceros_mob_validate_detalle_tributario()
  {
    var nomeCampo_detalle_tributario = "detalle_tributario";
    var var_detalle_tributario = scAjaxGetFieldSelectMult(nomeCampo_detalle_tributario, ",");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_detalle_tributario(var_detalle_tributario, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_detalle_tributario_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_detalle_tributario

  function do_ajax_form_cloud_terceros_mob_validate_detalle_tributario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_detalle_tributario_cb

  // ---------- Validate responsabilidades_fiscales
  function do_ajax_form_cloud_terceros_mob_validate_responsabilidades_fiscales()
  {
    var nomeCampo_responsabilidades_fiscales = "responsabilidades_fiscales";
    var var_responsabilidades_fiscales = scAjaxGetFieldSelectMult(nomeCampo_responsabilidades_fiscales, ",");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_responsabilidades_fiscales(var_responsabilidades_fiscales, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_responsabilidades_fiscales_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_responsabilidades_fiscales

  function do_ajax_form_cloud_terceros_mob_validate_responsabilidades_fiscales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "responsabilidades_fiscales";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_responsabilidades_fiscales_cb

  // ---------- Validate cod_pais
  function do_ajax_form_cloud_terceros_mob_validate_cod_pais()
  {
    var nomeCampo_cod_pais = "cod_pais";
    var var_cod_pais = scAjaxGetFieldText(nomeCampo_cod_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_cod_pais(var_cod_pais, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_cod_pais_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_cod_pais

  function do_ajax_form_cloud_terceros_mob_validate_cod_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_pais";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_cod_pais_cb

  // ---------- Validate cod_lenguaje
  function do_ajax_form_cloud_terceros_mob_validate_cod_lenguaje()
  {
    var nomeCampo_cod_lenguaje = "cod_lenguaje";
    var var_cod_lenguaje = scAjaxGetFieldText(nomeCampo_cod_lenguaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_mob_validate_cod_lenguaje(var_cod_lenguaje, var_script_case_init, do_ajax_form_cloud_terceros_mob_validate_cod_lenguaje_cb);
  } // do_ajax_form_cloud_terceros_mob_validate_cod_lenguaje

  function do_ajax_form_cloud_terceros_mob_validate_cod_lenguaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_lenguaje";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_validate_cod_lenguaje_cb

  // ---------- Refresh cod_departamento
  function do_ajax_form_cloud_terceros_mob_refresh_cod_departamento()
  {
    var var_cod_departamento = scAjaxGetFieldSelect("cod_departamento");
    var var_nmgp_refresh_fields = "cod_municipio";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_mob_refresh_cod_departamento(var_cod_departamento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_cloud_terceros_mob_refresh_cod_departamento_cb);
  } // do_ajax_form_cloud_terceros_mob_refresh_cod_departamento

  function do_ajax_form_cloud_terceros_mob_refresh_cod_departamento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_mob_refresh_cod_departamento_cb

  // ---------- Event onchange cod_departamento
  function do_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange()
  {
    var var_cod_departamento = scAjaxGetFieldSelect("cod_departamento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange(var_cod_departamento, var_script_case_init, do_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange_cb);
  } // do_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange

  function do_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_departamento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange_cb_after_alert);
  } // do_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange_cb
  function do_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_cloud_terceros_mob_refresh_cod_departamento();
  ...
  } // do_ajax_form_cloud_terceros_mob_event_cod_departamento_onchange_cb_after_alert

  // ---------- Event onchange cod_municipio
  function do_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange()
  {
    var var_cod_municipio = scAjaxGetFieldSelect("cod_municipio");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange(var_cod_municipio, var_script_case_init, do_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange_cb);
  } // do_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange

  function do_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_municipio";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange_cb_after_alert);
  } // do_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange_cb
  function do_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_terceros_mob_event_cod_municipio_onchange_cb_after_alert

  // ---------- Event onchange documento
  function do_ajax_form_cloud_terceros_mob_event_documento_onchange()
  {
    var var_documento = scAjaxGetFieldText("documento");
    var var_nombres = scAjaxGetFieldText("nombres");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_mob_event_documento_onchange(var_documento, var_nombres, var_script_case_init, do_ajax_form_cloud_terceros_mob_event_documento_onchange_cb);
  } // do_ajax_form_cloud_terceros_mob_event_documento_onchange

  function do_ajax_form_cloud_terceros_mob_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_terceros_mob_event_documento_onchange_cb_after_alert);
  } // do_ajax_form_cloud_terceros_mob_event_documento_onchange_cb
  function do_ajax_form_cloud_terceros_mob_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cloud_terceros_mob_event_documento_onchange_cb_after_alert

  // ---------- Event onchange nombres
  function do_ajax_form_cloud_terceros_mob_event_nombres_onchange()
  {
    var var_nombres = scAjaxGetFieldText("nombres");
    var var_documento = scAjaxGetFieldText("documento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_mob_event_nombres_onchange(var_nombres, var_documento, var_script_case_init, do_ajax_form_cloud_terceros_mob_event_nombres_onchange_cb);
  } // do_ajax_form_cloud_terceros_mob_event_nombres_onchange

  function do_ajax_form_cloud_terceros_mob_event_nombres_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombres";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_terceros_mob_event_nombres_onchange_cb_after_alert);
  } // do_ajax_form_cloud_terceros_mob_event_nombres_onchange_cb
  function do_ajax_form_cloud_terceros_mob_event_nombres_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cloud_terceros_mob_event_nombres_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_terceros_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_terceros_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_cloud_tercero = scAjaxGetFieldHidden("id_cloud_tercero");
    var var_documento = scAjaxGetFieldText("documento");
    var var_nombres = scAjaxGetFieldText("nombres");
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_cod_departamento = scAjaxGetFieldSelect("cod_departamento");
    var var_cod_municipio = scAjaxGetFieldSelect("cod_municipio");
    var var_cod_postal = scAjaxGetFieldText("cod_postal");
    var var_cod_regimen = scAjaxGetFieldSelect("cod_regimen");
    var var_detalle_tributario = scAjaxGetFieldSelectMult("detalle_tributario", ",");
    var var_responsabilidades_fiscales = scAjaxGetFieldSelectMult("responsabilidades_fiscales", ",");
    var var_cod_pais = scAjaxGetFieldText("cod_pais");
    var var_cod_lenguaje = scAjaxGetFieldText("cod_lenguaje");
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_terceros_mob_submit_form(var_id_cloud_tercero, var_documento, var_nombres, var_id_empresa, var_cod_departamento, var_cod_municipio, var_cod_postal, var_cod_regimen, var_detalle_tributario, var_responsabilidades_fiscales, var_cod_pais, var_cod_lenguaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_terceros_mob_submit_form_cb);
  } // do_ajax_form_cloud_terceros_mob_submit_form

  function do_ajax_form_cloud_terceros_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_cloud_tercero");
      scAjaxHideErrorDisplay("documento");
      scAjaxHideErrorDisplay("nombres");
      scAjaxHideErrorDisplay("id_empresa");
      scAjaxHideErrorDisplay("cod_departamento");
      scAjaxHideErrorDisplay("cod_municipio");
      scAjaxHideErrorDisplay("cod_postal");
      scAjaxHideErrorDisplay("cod_regimen");
      scAjaxHideErrorDisplay("detalle_tributario");
      scAjaxHideErrorDisplay("responsabilidades_fiscales");
      scAjaxHideErrorDisplay("cod_pais");
      scAjaxHideErrorDisplay("cod_lenguaje");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_terceros_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_terceros_mob_submit_form_cb
  function do_ajax_form_cloud_terceros_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_terceros_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_terceros_mob_navigate_form()
  {
    perform_ajax_form_cloud_terceros_mob_navigate_form();
  }

  function perform_ajax_form_cloud_terceros_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cod_pais");
    scAjaxHideErrorDisplay("cod_lenguaje");
    var var_id_cloud_tercero = document.F2.id_cloud_tercero.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cloud_terceros_mob_navigate_form(var_id_cloud_tercero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_terceros_mob_navigate_form_cb);
  } // do_ajax_form_cloud_terceros_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_terceros_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_terceros_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_cloud_tercero.value = scAjaxGetKeyValue("id_cloud_tercero");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_terceros_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_terceros_mob_navigate_form_cb
  function do_ajax_form_cloud_terceros_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_cloud_terceros_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cloud_terceros_mob_navigate_form_cb_after_alert
  function sc_hide_form_cloud_terceros_mob_form()
  {
  ...
  ajax_field_list[0] = "id_cloud_tercero";
  ajax_field_list[1] = "documento";
  ajax_field_list[2] = "nombres";
  ajax_field_list[3] = "id_empresa";
  ajax_field_list[4] = "cod_departamento";
  ajax_field_list[5] = "cod_municipio";
  ajax_field_list[6] = "cod_postal";
  ajax_field_list[7] = "cod_regimen";
  ajax_field_list[8] = "detalle_tributario";
  ajax_field_list[9] = "responsabilidades_fiscales";
  ajax_field_list[10] = "cod_pais";
  ajax_field_list[11] = "cod_lenguaje";
  ...
  var ajax_error_list = {
    "id_cloud_tercero": {"label": "Id Cloud Tercero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "documento": {"label": "Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "cod_departamento": {"label": "Departamento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cod_municipio": {"label": "Municipio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cod_postal": {"label": "Código Postal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cod_regimen": {"label": "Regimen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "responsabilidades_fiscales": {"label": "Responsabilidades Fiscales", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cod_pais": {"label": "Pais", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cod_lenguaje": {"label": "Lenguaje", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_cloud_tercero": new Array(),
    "documento": new Array(),
    "nombres": new Array(),
    "id_empresa": new Array(),
    "cod_departamento": new Array(),
    "cod_municipio": new Array(),
    "cod_postal": new Array(),
    "cod_regimen": new Array(),
    "detalle_tributario": new Array(),
    "responsabilidades_fiscales": new Array(),
    "cod_pais": new Array(),
    "cod_lenguaje": new Array()
  };
  ajax_field_mult["id_cloud_tercero"][1] = "id_cloud_tercero";
  ajax_field_mult["documento"][1] = "documento";
  ajax_field_mult["nombres"][1] = "nombres";
  ajax_field_mult["id_empresa"][1] = "id_empresa";
  ajax_field_mult["cod_departamento"][1] = "cod_departamento";
  ajax_field_mult["cod_municipio"][1] = "cod_municipio";
  ajax_field_mult["cod_postal"][1] = "cod_postal";
  ajax_field_mult["cod_regimen"][1] = "cod_regimen";
  ajax_field_mult["detalle_tributario"][1] = "detalle_tributario";
  ajax_field_mult["responsabilidades_fiscales"][1] = "responsabilidades_fiscales";
  ajax_field_mult["cod_pais"][1] = "cod_pais";
  ajax_field_mult["cod_lenguaje"][1] = "cod_lenguaje";
  ...
  var ajax_field_id = {
    ...
    "cod_departamento": new Array("hidden_field_label_cod_departamento", "hidden_field_data_cod_departamento"),
    "cod_municipio": new Array("hidden_field_label_cod_municipio", "hidden_field_data_cod_municipio"),
    "cod_postal": new Array("hidden_field_label_cod_postal", "hidden_field_data_cod_postal"),
    "cod_regimen": new Array("hidden_field_label_cod_regimen", "hidden_field_data_cod_regimen"),
    "detalle_tributario": new Array("hidden_field_label_detalle_tributario", "hidden_field_data_detalle_tributario"),
    "responsabilidades_fiscales": new Array("hidden_field_label_responsabilidades_fiscales", "hidden_field_data_responsabilidades_fiscales")
  };
  ...
  var ajax_read_only = {
    ...
    "nombres": "off",
    "id_empresa": "off",
    "cod_departamento": "off",
    "cod_municipio": "off",
    "cod_postal": "off",
    "cod_regimen": "off",
    "detalle_tributario": "off",
    "responsabilidades_fiscales": "off",
    "cod_pais": "off",
    "cod_lenguaje": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("responsabilidades_fiscales" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
