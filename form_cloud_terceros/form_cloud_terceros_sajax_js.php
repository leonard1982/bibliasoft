  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_terceros" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_terceros_form();
	}
  ...
  function do_ajax_form_cloud_terceros_validate_id_cloud_tercero()
  {
    ...
    x_ajax_form_cloud_terceros_validate_id_cloud_tercero(var_id_cloud_tercero, var_script_case_init, do_ajax_form_cloud_terceros_validate_id_cloud_tercero_cb);
  } // do_ajax_form_cloud_terceros_validate_id_cloud_tercero

  function do_ajax_form_cloud_terceros_validate_id_cloud_tercero_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_id_cloud_tercero_cb

  // ---------- Validate documento
  function do_ajax_form_cloud_terceros_validate_documento()
  {
  } // do_ajax_form_cloud_terceros_validate_documento

  function do_ajax_form_cloud_terceros_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_documento_cb

  // ---------- Validate nombres
  function do_ajax_form_cloud_terceros_validate_nombres()
  {
  } // do_ajax_form_cloud_terceros_validate_nombres

  function do_ajax_form_cloud_terceros_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_nombres_cb

  // ---------- Validate id_empresa
  function do_ajax_form_cloud_terceros_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldText(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_terceros_validate_id_empresa_cb);
  } // do_ajax_form_cloud_terceros_validate_id_empresa

  function do_ajax_form_cloud_terceros_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_id_empresa_cb

  // ---------- Validate cod_departamento
  function do_ajax_form_cloud_terceros_validate_cod_departamento()
  {
    var nomeCampo_cod_departamento = "cod_departamento";
    var var_cod_departamento = scAjaxGetFieldSelect(nomeCampo_cod_departamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_cod_departamento(var_cod_departamento, var_script_case_init, do_ajax_form_cloud_terceros_validate_cod_departamento_cb);
  } // do_ajax_form_cloud_terceros_validate_cod_departamento

  function do_ajax_form_cloud_terceros_validate_cod_departamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_cod_departamento_cb

  // ---------- Validate cod_municipio
  function do_ajax_form_cloud_terceros_validate_cod_municipio()
  {
    var nomeCampo_cod_municipio = "cod_municipio";
    var var_cod_municipio = scAjaxGetFieldSelect(nomeCampo_cod_municipio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_cod_municipio(var_cod_municipio, var_script_case_init, do_ajax_form_cloud_terceros_validate_cod_municipio_cb);
  } // do_ajax_form_cloud_terceros_validate_cod_municipio

  function do_ajax_form_cloud_terceros_validate_cod_municipio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_cod_municipio_cb

  // ---------- Validate cod_postal
  function do_ajax_form_cloud_terceros_validate_cod_postal()
  {
    var nomeCampo_cod_postal = "cod_postal";
    var var_cod_postal = scAjaxGetFieldText(nomeCampo_cod_postal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_cod_postal(var_cod_postal, var_script_case_init, do_ajax_form_cloud_terceros_validate_cod_postal_cb);
  } // do_ajax_form_cloud_terceros_validate_cod_postal

  function do_ajax_form_cloud_terceros_validate_cod_postal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_cod_postal_cb

  // ---------- Validate cod_regimen
  function do_ajax_form_cloud_terceros_validate_cod_regimen()
  {
    var nomeCampo_cod_regimen = "cod_regimen";
    var var_cod_regimen = scAjaxGetFieldSelect(nomeCampo_cod_regimen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_cod_regimen(var_cod_regimen, var_script_case_init, do_ajax_form_cloud_terceros_validate_cod_regimen_cb);
  } // do_ajax_form_cloud_terceros_validate_cod_regimen

  function do_ajax_form_cloud_terceros_validate_cod_regimen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_cod_regimen_cb

  // ---------- Validate detalle_tributario
  function do_ajax_form_cloud_terceros_validate_detalle_tributario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_detalle_tributario(var_detalle_tributario, var_script_case_init, do_ajax_form_cloud_terceros_validate_detalle_tributario_cb);
  } // do_ajax_form_cloud_terceros_validate_detalle_tributario

  function do_ajax_form_cloud_terceros_validate_detalle_tributario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_detalle_tributario_cb

  // ---------- Validate responsabilidades_fiscales
  function do_ajax_form_cloud_terceros_validate_responsabilidades_fiscales()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_responsabilidades_fiscales(var_responsabilidades_fiscales, var_script_case_init, do_ajax_form_cloud_terceros_validate_responsabilidades_fiscales_cb);
  } // do_ajax_form_cloud_terceros_validate_responsabilidades_fiscales

  function do_ajax_form_cloud_terceros_validate_responsabilidades_fiscales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_responsabilidades_fiscales_cb

  // ---------- Validate cod_pais
  function do_ajax_form_cloud_terceros_validate_cod_pais()
  {
    var nomeCampo_cod_pais = "cod_pais";
    var var_cod_pais = scAjaxGetFieldText(nomeCampo_cod_pais);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_cod_pais(var_cod_pais, var_script_case_init, do_ajax_form_cloud_terceros_validate_cod_pais_cb);
  } // do_ajax_form_cloud_terceros_validate_cod_pais

  function do_ajax_form_cloud_terceros_validate_cod_pais_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_cod_pais_cb

  // ---------- Validate cod_lenguaje
  function do_ajax_form_cloud_terceros_validate_cod_lenguaje()
  {
    var nomeCampo_cod_lenguaje = "cod_lenguaje";
    var var_cod_lenguaje = scAjaxGetFieldText(nomeCampo_cod_lenguaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_terceros_validate_cod_lenguaje(var_cod_lenguaje, var_script_case_init, do_ajax_form_cloud_terceros_validate_cod_lenguaje_cb);
  } // do_ajax_form_cloud_terceros_validate_cod_lenguaje

  function do_ajax_form_cloud_terceros_validate_cod_lenguaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_validate_cod_lenguaje_cb

  // ---------- Refresh cod_departamento
  function do_ajax_form_cloud_terceros_refresh_cod_departamento()
  {
    var var_cod_departamento = scAjaxGetFieldSelect("cod_departamento");
    var var_nmgp_refresh_fields = "cod_municipio";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_refresh_cod_departamento(var_cod_departamento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_cloud_terceros_refresh_cod_departamento_cb);
  } // do_ajax_form_cloud_terceros_refresh_cod_departamento

  function do_ajax_form_cloud_terceros_refresh_cod_departamento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_terceros_refresh_cod_departamento_cb

  // ---------- Event onchange cod_departamento
  function do_ajax_form_cloud_terceros_event_cod_departamento_onchange()
  {
    var var_cod_departamento = scAjaxGetFieldSelect("cod_departamento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_event_cod_departamento_onchange(var_cod_departamento, var_script_case_init, do_ajax_form_cloud_terceros_event_cod_departamento_onchange_cb);
  } // do_ajax_form_cloud_terceros_event_cod_departamento_onchange

  function do_ajax_form_cloud_terceros_event_cod_departamento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_departamento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_terceros_event_cod_departamento_onchange_cb_after_alert);
  } // do_ajax_form_cloud_terceros_event_cod_departamento_onchange_cb
  function do_ajax_form_cloud_terceros_event_cod_departamento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_cloud_terceros_refresh_cod_departamento();
  ...
  } // do_ajax_form_cloud_terceros_event_cod_departamento_onchange_cb_after_alert

  // ---------- Event onchange cod_municipio
  function do_ajax_form_cloud_terceros_event_cod_municipio_onchange()
  {
    var var_cod_municipio = scAjaxGetFieldSelect("cod_municipio");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_event_cod_municipio_onchange(var_cod_municipio, var_script_case_init, do_ajax_form_cloud_terceros_event_cod_municipio_onchange_cb);
  } // do_ajax_form_cloud_terceros_event_cod_municipio_onchange

  function do_ajax_form_cloud_terceros_event_cod_municipio_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_municipio";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_terceros_event_cod_municipio_onchange_cb_after_alert);
  } // do_ajax_form_cloud_terceros_event_cod_municipio_onchange_cb
  function do_ajax_form_cloud_terceros_event_cod_municipio_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_terceros_event_cod_municipio_onchange_cb_after_alert

  // ---------- Event onchange documento
  function do_ajax_form_cloud_terceros_event_documento_onchange()
  {
    var var_documento = scAjaxGetFieldText("documento");
    var var_nombres = scAjaxGetFieldText("nombres");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_event_documento_onchange(var_documento, var_nombres, var_script_case_init, do_ajax_form_cloud_terceros_event_documento_onchange_cb);
  } // do_ajax_form_cloud_terceros_event_documento_onchange

  function do_ajax_form_cloud_terceros_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_terceros_event_documento_onchange_cb_after_alert);
  } // do_ajax_form_cloud_terceros_event_documento_onchange_cb
  function do_ajax_form_cloud_terceros_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cloud_terceros_event_documento_onchange_cb_after_alert

  // ---------- Event onchange nombres
  function do_ajax_form_cloud_terceros_event_nombres_onchange()
  {
    var var_nombres = scAjaxGetFieldText("nombres");
    var var_documento = scAjaxGetFieldText("documento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_terceros_event_nombres_onchange(var_nombres, var_documento, var_script_case_init, do_ajax_form_cloud_terceros_event_nombres_onchange_cb);
  } // do_ajax_form_cloud_terceros_event_nombres_onchange

  function do_ajax_form_cloud_terceros_event_nombres_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombres";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_terceros_event_nombres_onchange_cb_after_alert);
  } // do_ajax_form_cloud_terceros_event_nombres_onchange_cb
  function do_ajax_form_cloud_terceros_event_nombres_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cloud_terceros_event_nombres_onchange_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_terceros_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_terceros_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_terceros_submit_form(var_id_cloud_tercero, var_documento, var_nombres, var_id_empresa, var_cod_departamento, var_cod_municipio, var_cod_postal, var_cod_regimen, var_detalle_tributario, var_responsabilidades_fiscales, var_cod_pais, var_cod_lenguaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_terceros_submit_form_cb);
  } // do_ajax_form_cloud_terceros_submit_form

  function do_ajax_form_cloud_terceros_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_terceros_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_terceros_submit_form_cb
  function do_ajax_form_cloud_terceros_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_terceros_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_terceros_navigate_form()
  {
    perform_ajax_form_cloud_terceros_navigate_form();
  }

  function perform_ajax_form_cloud_terceros_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cloud_terceros_navigate_form(var_id_cloud_tercero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_terceros_navigate_form_cb);
  } // do_ajax_form_cloud_terceros_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_terceros']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_terceros_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_terceros_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_terceros_navigate_form_cb
  function do_ajax_form_cloud_terceros_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_cloud_terceros_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cloud_terceros_navigate_form_cb_after_alert
  function sc_hide_form_cloud_terceros_form()
  {
