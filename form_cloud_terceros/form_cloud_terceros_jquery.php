...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_cloud_tercero' + iSeqRow).bind('blur', function() { sc_form_cloud_terceros_id_cloud_tercero_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_cloud_terceros_id_cloud_tercero_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_id_empresa' + iSeqRow).bind('blur', function() { sc_form_cloud_terceros_id_empresa_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_cloud_terceros_id_empresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cod_pais' + iSeqRow).bind('blur', function() { sc_form_cloud_terceros_cod_pais_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_cloud_terceros_cod_pais_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cod_postal' + iSeqRow).bind('blur', function() { sc_form_cloud_terceros_cod_postal_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_cloud_terceros_cod_postal_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cod_lenguaje' + iSeqRow).bind('blur', function() { sc_form_cloud_terceros_cod_lenguaje_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_cloud_terceros_cod_lenguaje_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_cloud_terceros_cod_lenguaje_onfocus(this, iSeqRow) });
  $('#id_sc_field_cod_tipo_establecimiento' + iSeqRow).bind('change', function() { sc_form_cloud_terceros_cod_tipo_establecimiento_onchange(this, iSeqRow) });
  $('#id_sc_field_cod_ciiu' + iSeqRow).bind('change', function() { sc_form_cloud_terceros_cod_ciiu_onchange(this, iSeqRow) });
  $('#id_sc_field_cod_regimen' + iSeqRow).bind('blur', function() { sc_form_cloud_terceros_cod_regimen_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_cloud_terceros_cod_regimen_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_cloud_terceros_cod_regimen_onfocus(this, iSeqRow) });
  $('#id_sc_field_tipo_persona' + iSeqRow).bind('change', function() { sc_form_cloud_terceros_tipo_persona_onchange(this, iSeqRow) });
  $('#id_sc_field_detalle_tributario' + iSeqRow).bind('blur', function() { sc_form_cloud_terceros_detalle_tributario_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_cloud_terceros_detalle_tributario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_responsabilidades_fiscales' + iSeqRow).bind('blur', function() { sc_form_cloud_terceros_responsabilidades_fiscales_onblur(this, iSeqRow) })
                                                        .bind('change', function() { sc_form_cloud_terceros_responsabilidades_fiscales_onchange(this, iSeqRow) })
...
function sc_form_cloud_terceros_id_cloud_tercero_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_id_cloud_tercero();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_id_cloud_tercero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cloud_terceros_documento_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_documento();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_documento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_cloud_terceros_event_documento_onchange();
}
...
function sc_form_cloud_terceros_nombres_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_nombres();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_nombres_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_cloud_terceros_event_nombres_onchange();
}
...
function sc_form_cloud_terceros_id_empresa_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_id_empresa();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_id_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cloud_terceros_cod_pais_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_cod_pais();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_cod_pais_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cloud_terceros_cod_departamento_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_cod_departamento();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_cod_departamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_cloud_terceros_event_cod_departamento_onchange();
}
...
function sc_form_cloud_terceros_cod_municipio_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_cod_municipio();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_cod_municipio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_form_cloud_terceros_event_cod_municipio_onchange();
}
...
function sc_form_cloud_terceros_cod_postal_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_cod_postal();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_cod_postal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cloud_terceros_cod_lenguaje_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_cod_lenguaje();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_cod_lenguaje_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cloud_terceros_cod_tipo_establecimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cloud_terceros_cod_ciiu_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cloud_terceros_cod_regimen_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_cod_regimen();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_cod_regimen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cloud_terceros_tipo_persona_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_cloud_terceros_detalle_tributario_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_detalle_tributario();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_detalle_tributario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_cloud_terceros_responsabilidades_fiscales_onblur(oThis, iSeqRow) {
  do_ajax_form_cloud_terceros_validate_responsabilidades_fiscales();
  scCssBlur(oThis);
}

function sc_form_cloud_terceros_responsabilidades_fiscales_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_cloud_terceros_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_cloud_terceros')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
