<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['blank_inicio']['glo_nm_perfil']          = "conn_mysql";
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_hr_criacao   = "082434"; 
      $this->nm_autor_alt    = "admin"; 
      $this->nm_dt_ult_alt   = "20210710"; 
      $this->nm_hr_ult_alt   = "215008"; 
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_inicio']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEB_FE_73', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
<script src="<?php echo sc_url_library('prj', 'cookie', 'js.cookie.min.js'); ?>"></script>
<script>
...
else 
{
	...
	$.post("../reset/index.php",{ok:""},function(r){
...
$(document).ready(function(){
	...
	var iniciar = getParameterByName('iniciar');
	
	if($.isEmptyObject(iniciar))
	{
		$("#mensaje").html("ESTAMOS VALIDANDO SU LICENCIA, ESPERE POR FAVOR...");
		$.post("../blank_validar_serial/index.php",function(r){
			...
			{
				case "sinconexion":
					alert('No hay conexión con el servidor de licencias.');
				break;
				case "sinlicencia":
					location.href = "../control_activacion";
				break;
				case "sinserial":
					location.href = "../control_activacion";
				break;
				case "licencia":
					$("#mensaje").html("LICENCIA VALIDADA.");
					location.href = "../blank_iniciar_sesion";
				break;	
				case "":
					location.href = "../control_activacion";
				break;
...
<div class="container-fluid">
    	<div class="row">
			<center>
					<img src="../_lib/img/grp__NM__img__NM__fw_fe_gif.gif" style="margin-top:120px;"/>
					<h1 id="mensaje"></h1>
					<br>
					<button class="btn btn-primay" onclick="location.href='../blank_inicio';">Iniciar Sesión</button>
			</center>
		</div>
	</div>
<?php
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_inicio']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_inicio']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_FACILWEB_FE_73'])) {
               $_SESSION['scriptcase']['blank_inicio']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEB_FE_73'];
           }
       }
   }
