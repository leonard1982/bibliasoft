<?php
   include_once('cEnviarFactura_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_perfil']          = "conn_facilweb";
   $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['cEnviarFactura']['glo_con_conn_mysql']         = "conn_mysql";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class cEnviarFactura_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "cEnviarFactura"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20190513"; 
      $this->nm_hr_criacao   = "091209"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['cEnviarFactura']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['cEnviarFactura']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['cEnviarFactura']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/cEnviarFactura';
      ...
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['cEnviarFactura']['actual_lang']) || $_SESSION['scriptcase']['cEnviarFactura']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['cEnviarFactura']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("cEnviarFactura_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["cEnviarFactura"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["cEnviarFactura"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "cEnviarFactura_erro.class.php"); 
      $this->Erro = new cEnviarFactura_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('cEnviarFactura'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['cEnviarFactura']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      $this->conectExtra();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao']) && $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_perfil']) && $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['cEnviarFactura']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['cEnviarFactura']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_perfil'];
      }
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['cEnviarFactura']['glo_con_conn_mysql'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_conn_mysql['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_mysql['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_mysql['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_mysql['senha']                  = $_SESSION['scriptcase']['glo_senha'];
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['cEnviarFactura']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['cEnviarFactura']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new cEnviarFactura_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['cEnviarFactura']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['cEnviarFactura']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cEnviarFactura']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['cEnviarFactura'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cEnviarFactura']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cEnviarFactura']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('cEnviarFactura') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['cEnviarFactura']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['cEnviarFactura']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['cEnviarFactura']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['cEnviarFactura']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "cEnviarFactura_erro.class.php"); 
      $this->Erro      = new cEnviarFactura_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['cEnviarFactura']['contr_erro'] = 'on';
 if(isset($_POST["idfacven"]))
{
	...
	$vmensaje    = "";
      ...
      { 
          $this->vToken = false;
          $this->vToken_erro = $this->Ini->nm_db_conn_mysql->ErrorMsg();
          $this->vtoken = false;
          $this->vtoken_erro = $this->Ini->nm_db_conn_mysql->ErrorMsg();
      } 
;
	...
	if(isset($this->vtoken[0][0]))
	{
      ...
      { 
          $nm_select = "select c.tipo_documento, c.documento, c.nombre1,c.nombre2,concat(c.apellido1,' ',c.apellido2) as apellido, dp.departamento, m.municipio,c.direccion, c.tel_cel, c.urlmail,(if(c.regimen='SIM','0','2')) as regimen,(if(c.tipo='NAT','2','1')) as tipopersona,str_replace (convert(char(10),f.fechaven,102), '.', '-') + ' ' + convert(char(8),f.fechaven,20),coalesce(str_replace (convert(char(10),f.fechaven,102), '.', '-') + ' ' + convert(char(8),f.fechaven,20)c,0) as vence,f.numfacven,r.prefijo,f.subtotal,f.total,f.adicional as descuentototal from facturaven f inner join terceros c on f.idcli=c.idtercero inner join municipio m on c.idmuni=m.idmun inner join departamento dp on m.iddepar=dp.iddep inner join resdian r on f.resolucion=r.Idres where f.idfacven='".$vidfacven."'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_con_conn_mysql['tpbanco']), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select c.tipo_documento, c.documento, c.nombre1,c.nombre2,concat(c.apellido1,' ',c.apellido2) as apellido, dp.departamento, m.municipio,c.direccion, c.tel_cel, c.urlmail,(if(c.regimen='SIM','0','2')) as regimen,(if(c.tipo='NAT','2','1')) as tipopersona,convert(char(23),f.fechaven,121),coalesce(convert(char(23),f.fechaven,121)c,0) as vence,f.numfacven,r.prefijo,f.subtotal,f.total,f.adicional as descuentototal from facturaven f inner join terceros c on f.idcli=c.idtercero inner join municipio m on c.idmuni=m.idmun inner join departamento dp on m.iddepar=dp.iddep inner join resdian r on f.resolucion=r.Idres where f.idfacven='".$vidfacven."'"; 
      }
      else
      { 
          $nm_select = "select c.tipo_documento, c.documento, c.nombre1,c.nombre2,concat(c.apellido1,' ',c.apellido2) as apellido, dp.departamento, m.municipio,c.direccion, c.tel_cel, c.urlmail,(if(c.regimen='SIM','0','2')) as regimen,(if(c.tipo='NAT','2','1')) as tipopersona,f.fechaven,coalesce(f.fechavenc,0) as vence,f.numfacven,r.prefijo,f.subtotal,f.total,f.adicional as descuentototal from facturaven f inner join terceros c on f.idcli=c.idtercero inner join municipio m on c.idmuni=m.idmun inner join departamento dp on m.iddepar=dp.iddep inner join resdian r on f.resolucion=r.Idres where f.idfacven='".$vidfacven."'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vDatosFV = array();
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vDatosFV[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vdatosfv[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vDatosFV = false;
          $this->vDatosFV_erro = $this->Ini->nm_db_conn_mysql->ErrorMsg();
          $this->vdatosfv = false;
          $this->vdatosfv_erro = $this->Ini->nm_db_conn_mysql->ErrorMsg();
      } 
;
		...
		if(isset($this->vdatosfv[0][0]))
		{

			$factura = new FacturaGeneral();
			$factura->cliente->tipoIdentificacion = intval($this->vdatosfv[0][0]);
			$factura->cliente->numeroDocumento    = intval($this->vdatosfv[0][1]);
			$factura->cliente->nombreRazonSocial  = $this->vdatosfv[0][2];
			$factura->cliente->segundoNombre      = $this->vdatosfv[0][3];
			$factura->cliente->apellido           = $this->vdatosfv[0][4]; 
			$factura->cliente->departamento       = $this->vdatosfv[0][5];
			$factura->cliente->ciudad             = $this->vdatosfv[0][6];
			$factura->cliente->direccion 		  = $this->vdatosfv[0][7];
			$factura->cliente->telefono           = $this->vdatosfv[0][8];
			$factura->cliente->email              = $this->vdatosfv[0][9];
			$factura->cliente->notificar          = "SI";
			$factura->cliente->pais               = "CO";
			$factura->cliente->regimen            = intval($this->vdatosfv[0][10]);
			$factura->cliente->tipoPersona        = intval($this->vdatosfv[0][11]);
			
			
			 
      $nm_select = "select d.cantidad,p.codigobar,p.nompro,d.adicional1 as descuento,d.iva, d.valorpar, (d.valorpar-d.iva) as base,d.valorunit,(if(p.unidmaymen='SI',p.unimay,p.unimen)) as unidad,d.adicional as porcentajeiva,(if(iv.tipo_impuesto='CONSUMO','03','01')) as codigoimpuesto from detalleventa d inner join productos p on d.idpro=p.idprod inner join iva iv on p.idiva=iv.idiva where d.numfac='".$vidfacven."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vDetalle = array();
      $this->vdetalle = array();
...
;
			...
			{				
				...
				for($i=0;$i<count($this->vdetalle );$i++)
				{
					...
					$factDetalle->descuento              = $this->vdetalle[$i][3];
					$factDetalle->detalleAdicionalNombre = "";
					$factDetalle->detalleAdicionalValor  = "";
					$factDetalle->impuestosDetalles[$i]  = $this->vdetalle[$i][4];
					$factDetalle->precioTotal            = $this->vdetalle[$i][5];
					$factDetalle->precioTotalSinImpuestos= $this->vdetalle[$i][6];
					$factDetalle->precioVentaUnitario    = $this->vdetalle[$i][7];
					$factDetalle->seriales               = "";
					$factDetalle->unidadMedida           = $this->vdetalle[$i][8];
					
					$objFactImp->baseImponibleTOTALImp   = $this->vdetalle[$i][6];
					$objFactImp->codigoTOTALImp          = $this->vdetalle[$i][10];
					$objFactImp->controlInterno          = "";
					$objFactImp->porcentajeTOTALImp      = $this->vdetalle[$i][9];
					$objFactImp->valorTOTALImp           = $this->vdetalle[$i][4];

				   $factDetalle->impuestosDetalles[$i] = $objFactImp;
      ...
      $nm_select = "select (if(iv.tipo_impuesto='CONSUMO','03','01')) as codigoimpuesto,iv.trifa as porcentaje,sum(valorpar-iva) as base,sum(iva) as iva from detalleventa d inner join productos p on d.idpro=p.idprod inner join iva iv on p.idiva=iv.idiva where numfac='".$vidfacven."' group by iv.tipo_impuesto,iv.trifa"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vImpGenerales = array();
      $this->vimpgenerales = array();
      if ($SCrx = $this->Ini->nm_db_conn_mysql->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vImpGenerales[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vimpgenerales[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vImpGenerales = false;
          $this->vImpGenerales_erro = $this->Ini->nm_db_conn_mysql->ErrorMsg();
          $this->vimpgenerales = false;
          $this->vimpgenerales_erro = $this->Ini->nm_db_conn_mysql->ErrorMsg();
      } 
;
			
			if(isset($this->vimpgenerales[0][0]))
			{
				for($i=0;$i<count($this->vimpgenerales );$i++)
				{
					$objImpGen->baseImponibleTOTALImp = $this->vimpgenerales[$i][2];
					$objImpGen->codigoTOTALImp        = $this->vimpgenerales[$i][0];
					$objImpGen->controlInterno        = "";
					$objImpGen->porcentajeTOTALImp    = $this->vimpgenerales[$i][1];
					$objImpGen->valorTOTALImp         = $this->vimpgenerales[$i][3];
			...
			$factura->medioPago            = "10";
			$factura->moneda               = "COP";
			$factura->rangoNumeracion      = $this->vdatosfv[0][15]."-1"; 
			$factura->tipoDocumento        = '01';
			$factura->totalDescuentos      = $this->vdatosfv[0][18];
			$factura->totalSinImpuestos    = $this->vdatosfv[0][16];
			$factura->importeTotal         = $this->vdatosfv[0][17];
			$factura->uuidDocumentoModificado ="";
			$factura->icoterms             = "";
			$factura->propina              = "0.00";
			$factura->cliente->subDivision = "";
			$factura->consecutivoDocumento = intval($this->vdatosfv[0][14]);
			$vfechaemision                 = $this->vdatosfv[0][12].date(' H:i:s');
			...
			$vfechavencimiento             = "";
			if($this->vdatosfv[0][13]>0)
			{
				$vfechavencimiento         = $this->vdatosfv[0][13].date(' H:i:s');
				$vfechavencimiento         = date_create($vfechavencimiento);
				$vfechavencimiento         = date_format($vfechavencimiento,'Y-m-d H:i:s');
			}
			else
			{
				$vfechavencimiento         = strtotime("+1 day", strtotime($vfechaemision));
				$vfechavencimiento         = date("Y-m-d H:i:s",$vfechavencimiento);
			}
			
			if($this->vdatosfv[0][12]==$this->vdatosfv[0][13])
			{
				$vfechavencimiento         = strtotime("+1 day", strtotime($vfechaemision));
				$vfechavencimiento         = date("Y-m-d H:i:s",$vfechavencimiento);
			}
			$factura->fechaVencimiento     = $vfechavencimiento;
			...
			$params;
			 ...
			 $params = array(
				 "tokenEmpresa" => $vtokenempresa,
				 "tokenPassword" =>$vtokenpassword,
				 "factura" => $factura,
				 "adjuntos" => "0");
			...
			$vmensaje    = $resultado["mensaje"];
	
			
			switch($resultado["codigo"])
			{
				case 200:
					$vmensaje = "La factura electronica ha sido generada satisfactoriamente, En breves momentos consulte la direccion de correo electronica suministrada";
				break;
				
				case 117:
					$vmensaje = "La fecha u hora de emision de la factura no debe ser mayor a la fecha del sistema";
				break;
				
				case 115:
					$vmensaje = "El numero consecutivo de la factura ya se encuentra registrada en el sistema";
				break;
			...
			echo json_encode(array("codigo"=>$codigoerror,"mensaje"=>$vmensaje,"factura"=>$factura));
			
		}
	}
}
$_SESSION['scriptcase']['cEnviarFactura']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_cEnviarFactura($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['cEnviarFactura']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "cEnviarFactura") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['cEnviarFactura']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "cEnviarFactura";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'cEnviarFactura' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('cEnviarFactura' == $sReferer || 'cEnviarFactura_' == substr($sReferer, 0, 15))
       {
           $_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'cEnviarFactura')
   {
       $_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['cEnviarFactura']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/cEnviarFactura_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_cEnviarFactura($cadapar[1]);
   ...
   $contr_cEnviarFactura = new cEnviarFactura_apl();
   $contr_cEnviarFactura->controle();
//
   function nm_limpa_str_cEnviarFactura(&$str)
   {
