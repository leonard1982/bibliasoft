...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_' + iSeqRow).bind('blur', function() { sc_form_terceros_historial_estados_id__onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_terceros_historial_estados_id__onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_terceros_historial_estados_id__onfocus(this, iSeqRow) });
  $('#id_sc_field_estado_' + iSeqRow).bind('blur', function() { sc_form_terceros_historial_estados_estado__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_terceros_historial_estados_estado__onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_terceros_historial_estados_estado__onfocus(this, iSeqRow) });
  $('#id_sc_field_color_' + iSeqRow).bind('blur', function() { sc_form_terceros_historial_estados_color__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_terceros_historial_estados_color__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_terceros_historial_estados_color__onfocus(this, iSeqRow) });
  $('#id_sc_field_creado_' + iSeqRow).bind('change', function() { sc_form_terceros_historial_estados_creado__onchange(this, iSeqRow) });
  $('#id_sc_field_creado__hora' + iSeqRow).bind('change', function() { sc_form_terceros_historial_estados_creado__hora_onchange(this, iSeqRow) });
  $('#id_sc_field_actualizado_' + iSeqRow).bind('change', function() { sc_form_terceros_historial_estados_actualizado__onchange(this, iSeqRow) });
  $('#id_sc_field_actualizado__hora' + iSeqRow).bind('change', function() { sc_form_terceros_historial_estados_actualizado__hora_onchange(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_terceros_historial_estados_id__onblur(oThis, iSeqRow) {
  do_ajax_form_terceros_historial_estados_validate_id_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_terceros_historial_estados_id__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_terceros_historial_estados_id__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_terceros_historial_estados_estado__onblur(oThis, iSeqRow) {
  do_ajax_form_terceros_historial_estados_validate_estado_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_terceros_historial_estados_estado__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_terceros_historial_estados_estado__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_terceros_historial_estados_color__onblur(oThis, iSeqRow) {
  do_ajax_form_terceros_historial_estados_validate_color_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_terceros_historial_estados_color__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_form_terceros_historial_estados_color__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_form_terceros_historial_estados_creado__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_terceros_historial_estados_creado__hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_terceros_historial_estados_actualizado__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_terceros_historial_estados_actualizado__hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_terceros_historial_estados_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_creado_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_terceros_historial_estados_validate_creado_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_actualizado_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_terceros_historial_estados_validate_actualizado_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_terceros_historial_estados')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
