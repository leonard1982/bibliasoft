  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_facturaven_soporte_pago" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_facturaven_soporte_pago_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_form_facturaven_soporte_pago_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_soporte_pago_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_soporte_pago_validate_id__cb);
  } // do_ajax_form_facturaven_soporte_pago_validate_id_

  function do_ajax_form_facturaven_soporte_pago_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_soporte_pago_validate_id__cb

  // ---------- Validate archivo_
  function do_ajax_form_facturaven_soporte_pago_validate_archivo_(iNumLinha)
  {
    var nomeCampo_archivo_ = "archivo_" + iNumLinha;
    var var_archivo_ = scAjaxGetFieldText(nomeCampo_archivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_soporte_pago_validate_archivo_(var_archivo_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_soporte_pago_validate_archivo__cb);
  } // do_ajax_form_facturaven_soporte_pago_validate_archivo_

  function do_ajax_form_facturaven_soporte_pago_validate_archivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_soporte_pago_validate_archivo__cb

  // ---------- Validate fechayhora_
  function do_ajax_form_facturaven_soporte_pago_validate_fechayhora_(iNumLinha)
  {
    var nomeCampo_fechayhora_ = "fechayhora_" + iNumLinha;
    var var_fechayhora_ = scAjaxGetFieldHidden(nomeCampo_fechayhora_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_soporte_pago_validate_fechayhora_(var_fechayhora_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_soporte_pago_validate_fechayhora__cb);
  } // do_ajax_form_facturaven_soporte_pago_validate_fechayhora_

  function do_ajax_form_facturaven_soporte_pago_validate_fechayhora__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fechayhora_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fechayhora_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fechayhora_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fechayhora_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_soporte_pago_validate_fechayhora__cb

  // ---------- Validate id_venta_
  function do_ajax_form_facturaven_soporte_pago_validate_id_venta_(iNumLinha)
  {
    var nomeCampo_id_venta_ = "id_venta_" + iNumLinha;
    var var_id_venta_ = scAjaxGetFieldText(nomeCampo_id_venta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_soporte_pago_validate_id_venta_(var_id_venta_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_soporte_pago_validate_id_venta__cb);
  } // do_ajax_form_facturaven_soporte_pago_validate_id_venta_

  function do_ajax_form_facturaven_soporte_pago_validate_id_venta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_venta_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_venta_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_venta_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_venta_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_soporte_pago_validate_id_venta__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_facturaven_soporte_pago_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_facturaven_soporte_pago_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_facturaven_soporte_pago_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_facturaven_soporte_pago_add_new_line_cb);
  } // do_ajax_form_facturaven_soporte_pago_add_new_line

  function do_ajax_form_facturaven_soporte_pago_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_facturaven_soporte_pago_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_facturaven_soporte_pago_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_id_venta_ = scAjaxGetFieldText("id_venta_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_soporte_pago_backup_line(var_id_, var_id_venta_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_facturaven_soporte_pago_backup_line_cb);
  } // do_ajax_form_facturaven_soporte_pago_backup_line

  function do_ajax_form_facturaven_soporte_pago_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_facturaven_soporte_pago_backup_line_cb

  function do_ajax_form_facturaven_soporte_pago_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_facturaven_soporte_pago_cancel_insert

  function do_ajax_form_facturaven_soporte_pago_cancel_update(iSeqVert)
  {
    do_ajax_form_facturaven_soporte_pago_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_facturaven_soporte_pago_cancel_update

  function do_ajax_form_facturaven_soporte_pago_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_facturaven_soporte_pago_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_facturaven_soporte_pago_table_refresh()
  {
    var var_id_ = document.F2.id_.value;
    var var_id_venta_ = document.F2.id_venta_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_facturaven_soporte_pago_table_refresh(var_id_, var_id_venta_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_soporte_pago_table_refresh_cb);
  } //  do_ajax_form_facturaven_soporte_pago_table_refresh

  function do_ajax_form_facturaven_soporte_pago_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_venta_.value = scAjaxGetKeyValue("id_venta_");
    ...
    scAjaxAlert(do_ajax_form_facturaven_soporte_pago_table_refresh_cb_after_alert);
  } // do_ajax_form_facturaven_soporte_pago_table_refresh_cb
  function do_ajax_form_facturaven_soporte_pago_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_facturaven_soporte_pago_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_facturaven_soporte_pago_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_facturaven_soporte_pago_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_fechayhora_ = scAjaxGetFieldHidden("fechayhora_" + iNumLinha);
    var var_id_venta_ = scAjaxGetFieldText("id_venta_" + iNumLinha);
...
?>
    x_ajax_form_facturaven_soporte_pago_submit_form(var_id_, var_archivo_, var_fechayhora_, var_id_venta_, var_archivo__ul_name, var_archivo__ul_type, var_archivo__salva, var_archivo__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_facturaven_soporte_pago_submit_form_cb);
  } // do_ajax_form_facturaven_soporte_pago_submit_form

  function do_ajax_form_facturaven_soporte_pago_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("fechayhora_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_venta_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_facturaven_soporte_pago_submit_form_cb_after_alert);
  } // do_ajax_form_facturaven_soporte_pago_submit_form_cb
  function do_ajax_form_facturaven_soporte_pago_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_facturaven_soporte_pago_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_facturaven_soporte_pago_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_facturaven_soporte_pago_navigate_form, function() {});
    } else {
      perform_ajax_form_facturaven_soporte_pago_navigate_form();
    }
  }

  function perform_ajax_form_facturaven_soporte_pago_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_facturaven_soporte_pago_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fechayhora_" + iNavForm);
      scAjaxHideErrorDisplay("id_venta_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_id_venta_ = document.F2.id_venta_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_facturaven_soporte_pago_navigate_form(var_id_, var_id_venta_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_soporte_pago_navigate_form_cb);
  } // do_ajax_form_facturaven_soporte_pago_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_soporte_pago']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_facturaven_soporte_pago_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_venta_.value = scAjaxGetKeyValue("id_venta_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_facturaven_soporte_pago_navigate_form_cb_after_alert);
  } // do_ajax_form_facturaven_soporte_pago_navigate_form_cb
  function do_ajax_form_facturaven_soporte_pago_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_facturaven_soporte_pago_navigate_form_cb_after_alert
  function sc_hide_form_facturaven_soporte_pago_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fechayhora_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_venta_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["fechayhora_" + iNumLinha] = {"label": "Fecha<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_venta_" + iNumLinha] = {"label": "Id Venta<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["archivo_"][iNumLinha] = "archivo_" + iNumLinha;
    ajax_field_mult["fechayhora_"][iNumLinha] = "fechayhora_" + iNumLinha;
    ajax_field_mult["id_venta_"][iNumLinha] = "id_venta_" + iNumLinha;
    ...
    ajax_error_count["fechayhora_" + iNumLinha] = "off";
    ajax_error_count["id_venta_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["fechayhora_" + iNumLinha] = "off";
    ajax_read_only["id_venta_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ...
    ajax_read_only["fechayhora_" + iNumLinha] = "on";
    ajax_read_only["id_venta_" + iNumLinha] = "on";
<?php
}
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fechayhora_" + iNumLinha] = null;
    ajax_error_list["id_venta_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fechayhora_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fechayhora_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fechayhora_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fechayhora_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fechayhora_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_venta_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_venta_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_venta_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_venta_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_venta_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fechayhora_'])) ? $this->nmgp_cmp_readonly['fechayhora_'] : 'off';
?>
    scAjaxFieldRead("fechayhora_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_venta_'])) ? $this->nmgp_cmp_readonly['id_venta_'] : 'on';
?>
    scAjaxFieldRead("id_venta_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("fechayhora_" + iSeq, "on");
    scAjaxFieldRead("id_venta_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["archivo_" + iRow] || "on" == ajax_error_count["fechayhora_" + iRow] || "on" == ajax_error_count["id_venta_" + iRow]))
    {
      ...
      $("#hidden_field_data_archivo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fechayhora_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_venta_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["archivo_" + iRow] && "off" == ajax_error_count["fechayhora_" + iRow] && "off" == ajax_error_count["id_venta_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["archivo_" + iRow] = "off";
        ajax_error_count["fechayhora_" + iRow] = "off";
        ajax_error_count["id_venta_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_archivo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fechayhora_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_venta_" + iRow).removeClass("scFormErrorLine");
    }
  }
