  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tareas_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_tarea
  function do_ajax_form_tareas_mob_validate_id_tarea()
  {
    var nomeCampo_id_tarea = "id_tarea";
    var var_id_tarea = scAjaxGetFieldHidden(nomeCampo_id_tarea);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tareas_mob_validate_id_tarea(var_id_tarea, var_script_case_init, do_ajax_form_tareas_mob_validate_id_tarea_cb);
  } // do_ajax_form_tareas_mob_validate_id_tarea

  function do_ajax_form_tareas_mob_validate_id_tarea_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tareas_mob_validate_id_tarea_cb

  // ---------- Validate fecha
  function do_ajax_form_tareas_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tareas_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_tareas_mob_validate_fecha_cb);
  } // do_ajax_form_tareas_mob_validate_fecha

  function do_ajax_form_tareas_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tareas_mob_validate_fecha_cb

  // ---------- Validate asesor
  function do_ajax_form_tareas_mob_validate_asesor()
  {
    var nomeCampo_asesor = "asesor";
    var var_asesor = scAjaxGetFieldText(nomeCampo_asesor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tareas_mob_validate_asesor(var_asesor, var_script_case_init, do_ajax_form_tareas_mob_validate_asesor_cb);
  } // do_ajax_form_tareas_mob_validate_asesor

  function do_ajax_form_tareas_mob_validate_asesor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asesor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tareas_mob_validate_asesor_cb

  // ---------- Validate descripcion
  function do_ajax_form_tareas_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tareas_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_tareas_mob_validate_descripcion_cb);
  } // do_ajax_form_tareas_mob_validate_descripcion

  function do_ajax_form_tareas_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tareas_mob_validate_descripcion_cb

  // ---------- Validate realizada
  function do_ajax_form_tareas_mob_validate_realizada()
  {
    var nomeCampo_realizada = "realizada";
    var var_realizada = scAjaxGetFieldCheckbox(nomeCampo_realizada, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tareas_mob_validate_realizada(var_realizada, var_script_case_init, do_ajax_form_tareas_mob_validate_realizada_cb);
  } // do_ajax_form_tareas_mob_validate_realizada

  function do_ajax_form_tareas_mob_validate_realizada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tareas_mob_validate_realizada_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tareas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tareas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_tareas_mob_submit_form(var_id_tarea, var_fecha, var_asesor, var_descripcion, var_realizada, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tareas_mob_submit_form_cb);
  } // do_ajax_form_tareas_mob_submit_form

  function do_ajax_form_tareas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tareas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tareas_mob_submit_form_cb
  function do_ajax_form_tareas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tareas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tareas_mob_navigate_form()
  {
    perform_ajax_form_tareas_mob_navigate_form();
  }

  function perform_ajax_form_tareas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_tareas_mob_navigate_form(var_id_tarea, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tareas_mob_navigate_form_cb);
  } // do_ajax_form_tareas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tareas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tareas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tareas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tareas_mob_navigate_form_cb
  function do_ajax_form_tareas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tareas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_tareas_mob_navigate_form_cb_after_alert
  function sc_hide_form_tareas_mob_form()
  {
