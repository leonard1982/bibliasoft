...
<?php
   ...
   $Ord_Cmp = new grid_iva_260422_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_iva_260422_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trifa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["trifa"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["trifa"] : "Tasa";
   $tab_ger_campos['tipo_impuesto'] = "on";
   $tab_def_campos['tipo_impuesto'] = "tipo_impuesto";
   $tab_labels["tipo_impuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["tipo_impuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["tipo_impuesto"] : "Tipo Impuesto";
   $tab_ger_campos['puc'] = "on";
   $tab_def_campos['puc'] = "puc";
   $tab_labels["puc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["puc"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["puc"] : "Cuenta Ventas";
   $tab_ger_campos['puc_dv_ventas'] = "on";
   $tab_def_campos['puc_dv_ventas'] = "puc_dv_ventas";
   $tab_labels["puc_dv_ventas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["puc_dv_ventas"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["puc_dv_ventas"] : "Cuenta  Devolución Ventas";
   $tab_ger_campos['puc_compras'] = "on";
   $tab_def_campos['puc_compras'] = "puc_compras";
   $tab_labels["puc_compras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["puc_compras"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["puc_compras"] : "Cuenta Compras";
   $tab_ger_campos['puc_dv_compras'] = "on";
   $tab_def_campos['puc_dv_compras'] = "puc_dv_compras";
   $tab_labels["puc_dv_compras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["puc_dv_compras"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['labels']["puc_dv_compras"] : "Cuenta Devolución Compras";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_iva_260422_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_iva_260422']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
