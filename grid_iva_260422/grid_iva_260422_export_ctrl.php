<?php
@session_start() ;
$_SESSION['scriptcase']['grid_iva_260422']['sc_process_barr'] = true;
require_once('../grid_iva_260422/index.php');
unset($_SESSION['scriptcase']['grid_iva_260422']['sc_process_barr']);
$ExportCtrl = new grid_iva_260422_export_control;
$ExportCtrl->Export_barr();

class grid_iva_260422_export_control
{
