...
class pdfreport_movimiento_bodegas_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "pdfreport_movimiento_bodegas.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['pdfreport_movimiento_bodegas']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['rtf_name']);
      }
   ...
   function NM_export_idtipotran()
   {
         ...
         $this->look_idtipotran = str_replace('<', '&lt;', $this->look_idtipotran);
         $this->look_idtipotran = str_replace('>', '&gt;', $this->look_idtipotran);
         $this->Texto_tag .= "<td>" . $this->look_idtipotran . "</td>\r\n";
   }
   //----- fecha
   ...
   function NM_export_idpro()
   {
         ...
         $this->idpro = NM_charset_to_utf8($this->idpro);
         $this->idpro = str_replace('<', '&lt;', $this->idpro);
         $this->idpro = str_replace('>', '&gt;', $this->idpro);
         $this->Texto_tag .= "<td>" . $this->idpro . "</td>\r\n";
   }
   //----- cantidad
   ...
   function NM_export_numeronota()
   {
         ...
         $this->numeronota = NM_charset_to_utf8($this->numeronota);
         $this->numeronota = str_replace('<', '&lt;', $this->numeronota);
         $this->numeronota = str_replace('>', '&gt;', $this->numeronota);
         $this->Texto_tag .= "<td>" . $this->numeronota . "</td>\r\n";
   }
   //----- prefijonota
   function NM_export_prefijonota()
   {
         ...
         $this->look_prefijonota = str_replace('<', '&lt;', $this->look_prefijonota);
         $this->look_prefijonota = str_replace('>', '&gt;', $this->look_prefijonota);
         $this->Texto_tag .= "<td>" . $this->look_prefijonota . "</td>\r\n";
   }
   //----- detalle
   ...
   function NM_export_detalle_fl_idnota()
   {
         ...
         $this->detalle_fl_idnota = NM_charset_to_utf8($this->detalle_fl_idnota);
         $this->detalle_fl_idnota = str_replace('<', '&lt;', $this->detalle_fl_idnota);
         $this->detalle_fl_idnota = str_replace('>', '&gt;', $this->detalle_fl_idnota);
         $this->Texto_tag .= "<td>" . $this->detalle_fl_idnota . "</td>\r\n";
   }
   //----- detalle_fl_idmovi
   function NM_export_detalle_fl_idmovi()
   {
         ...
         $this->detalle_fl_idmovi = NM_charset_to_utf8($this->detalle_fl_idmovi);
         $this->detalle_fl_idmovi = str_replace('<', '&lt;', $this->detalle_fl_idmovi);
         $this->detalle_fl_idmovi = str_replace('>', '&gt;', $this->detalle_fl_idmovi);
         $this->Texto_tag .= "<td>" . $this->detalle_fl_idmovi . "</td>\r\n";
   }
   //----- detalle_fl_producto
   function NM_export_detalle_fl_producto()
   {
         ...
         $this->detalle_fl_producto = NM_charset_to_utf8($this->detalle_fl_producto);
         $this->detalle_fl_producto = str_replace('<', '&lt;', $this->detalle_fl_producto);
         $this->detalle_fl_producto = str_replace('>', '&gt;', $this->detalle_fl_producto);
         $this->Texto_tag .= "<td>" . $this->detalle_fl_producto . "</td>\r\n";
   }
   //----- detalle_p_nompro
   ...
   function NM_export_detalle_fl_destino()
   {
         ...
         $this->detalle_fl_destino = NM_charset_to_utf8($this->detalle_fl_destino);
         $this->detalle_fl_destino = str_replace('<', '&lt;', $this->detalle_fl_destino);
         $this->detalle_fl_destino = str_replace('>', '&gt;', $this->detalle_fl_destino);
         $this->Texto_tag .= "<td>" . $this->detalle_fl_destino . "</td>\r\n";
   }
   //----- detalle_fl_cantidad
   ...
   function NM_export_detalle_fl_presentacion()
   {
         ...
         $this->detalle_fl_presentacion = html_entity_decode($this->detalle_fl_presentacion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalle_fl_presentacion = NM_charset_to_utf8($this->detalle_fl_presentacion);
         $this->detalle_fl_presentacion = str_replace('<', '&lt;', $this->detalle_fl_presentacion);
         $this->detalle_fl_presentacion = str_replace('>', '&gt;', $this->detalle_fl_presentacion);
         $this->Texto_tag .= "<td>" . $this->detalle_fl_presentacion . "</td>\r\n";
   }
   //----- detalle_fl_colores
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> - movimiento :: RTF</TITLE>
