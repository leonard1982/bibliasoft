<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_movimiento_bodegas']['sc_process_barr'] = true;
require_once('../pdfreport_movimiento_bodegas/index.php');
unset($_SESSION['scriptcase']['pdfreport_movimiento_bodegas']['sc_process_barr']);
$ExportCtrl = new pdfreport_movimiento_bodegas_export_control;
$ExportCtrl->Export_barr();

class pdfreport_movimiento_bodegas_export_control
{
