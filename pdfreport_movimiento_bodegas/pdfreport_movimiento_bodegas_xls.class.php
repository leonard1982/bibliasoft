...
class pdfreport_movimiento_bodegas_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "pdfreport_movimiento_bodegas/pdfreport_movimiento_bodegas_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              ...
              $this->Res_xls = new pdfreport_movimiento_bodegas_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pdfreport_movimiento_bodegas.zip";
          $this->Arquivo   .= "_pdfreport_movimiento_bodegas" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['pdfreport_movimiento_bodegas']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_idpro()
   {
         ...
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idpro);
         $this->Xls_col++;
   }
   //----- cantidad
   ...
   function NM_export_detalle_fl_idnota()
   {
         ...
         if (is_numeric($this->detalle_fl_idnota))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalle_fl_idnota);
         $this->Xls_col++;
   }
   //----- detalle_fl_idmovi
   function NM_export_detalle_fl_idmovi()
   {
         ...
         if (is_numeric($this->detalle_fl_idmovi))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalle_fl_idmovi);
         $this->Xls_col++;
   }
   //----- detalle_fl_producto
   function NM_export_detalle_fl_producto()
   {
         ...
         if (is_numeric($this->detalle_fl_producto))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalle_fl_producto);
         $this->Xls_col++;
   }
   //----- detalle_p_nompro
   function NM_export_detalle_p_nompro()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->detalle_p_nompro))
      {
   ...
   function NM_export_detalle_fl_destino()
   {
         ...
         if (is_numeric($this->detalle_fl_destino))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detalle_fl_destino);
         $this->Xls_col++;
   }
   //----- detalle_fl_cantidad
   ...
   function NM_export_detalle_fl_presentacion()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
      if (!empty($this->detalle_fl_presentacion))
      {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalle_fl_presentacion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detalle_fl_presentacion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- detalle_fl_colores
   ...
   //----- detalle_fl_idnota
   function NM_sub_cons_detalle_fl_idnota()
   {
         $this->detalle_fl_idnota = NM_charset_to_utf8($this->detalle_fl_idnota);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_fl_idnota;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalle_fl_idmovi
   function NM_sub_cons_detalle_fl_idmovi()
   {
         $this->detalle_fl_idmovi = NM_charset_to_utf8($this->detalle_fl_idmovi);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_fl_idmovi;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalle_fl_producto
   function NM_sub_cons_detalle_fl_producto()
   {
         $this->detalle_fl_producto = NM_charset_to_utf8($this->detalle_fl_producto);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_fl_producto;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalle_fl_destino
   function NM_sub_cons_detalle_fl_destino()
   {
         $this->detalle_fl_destino = NM_charset_to_utf8($this->detalle_fl_destino);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_fl_destino;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detalle_fl_presentacion
   function NM_sub_cons_detalle_fl_presentacion()
   {
      if (!empty($this->detalle_fl_presentacion))
      {
         if ($this->detalle_fl_presentacion !== "&nbsp;") 
         ...
         $this->detalle_fl_presentacion = html_entity_decode($this->detalle_fl_presentacion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detalle_fl_presentacion = NM_charset_to_utf8($this->detalle_fl_presentacion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detalle_fl_presentacion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_movimiento_bodegas']['nolabel'])
       {
