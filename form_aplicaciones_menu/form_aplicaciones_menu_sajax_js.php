  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aplicaciones_menu" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aplicaciones_menu_form();
	}
...
?>
  ...
  // ---------- Validate idaplicacion_
  function do_ajax_form_aplicaciones_menu_validate_idaplicacion_(iNumLinha)
  {
    var nomeCampo_idaplicacion_ = "idaplicacion_" + iNumLinha;
    var var_idaplicacion_ = scAjaxGetFieldHidden(nomeCampo_idaplicacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_menu_validate_idaplicacion_(var_idaplicacion_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_menu_validate_idaplicacion__cb);
  } // do_ajax_form_aplicaciones_menu_validate_idaplicacion_

  function do_ajax_form_aplicaciones_menu_validate_idaplicacion__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idaplicacion_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idaplicacion_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idaplicacion_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idaplicacion_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_menu_validate_idaplicacion__cb

  // ---------- Validate item_menu_
  function do_ajax_form_aplicaciones_menu_validate_item_menu_(iNumLinha)
  {
    var nomeCampo_item_menu_ = "item_menu_" + iNumLinha;
    var var_item_menu_ = scAjaxGetFieldText(nomeCampo_item_menu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_menu_validate_item_menu_(var_item_menu_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_menu_validate_item_menu__cb);
  } // do_ajax_form_aplicaciones_menu_validate_item_menu_

  function do_ajax_form_aplicaciones_menu_validate_item_menu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "item_menu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "item_menu_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "item_menu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "item_menu_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_menu_validate_item_menu__cb

  // ---------- Validate nombre_
  function do_ajax_form_aplicaciones_menu_validate_nombre_(iNumLinha)
  {
    var nomeCampo_nombre_ = "nombre_" + iNumLinha;
    var var_nombre_ = scAjaxGetFieldText(nomeCampo_nombre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_menu_validate_nombre_(var_nombre_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_menu_validate_nombre__cb);
  } // do_ajax_form_aplicaciones_menu_validate_nombre_

  function do_ajax_form_aplicaciones_menu_validate_nombre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_menu_validate_nombre__cb

  // ---------- Validate descripcion_
  function do_ajax_form_aplicaciones_menu_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_menu_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_menu_validate_descripcion__cb);
  } // do_ajax_form_aplicaciones_menu_validate_descripcion_

  function do_ajax_form_aplicaciones_menu_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_menu_validate_descripcion__cb

  // ---------- Validate imagen_
  function do_ajax_form_aplicaciones_menu_validate_imagen_(iNumLinha)
  {
    var nomeCampo_imagen_ = "imagen_" + iNumLinha;
    var var_imagen_ = scAjaxGetFieldText(nomeCampo_imagen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_menu_validate_imagen_(var_imagen_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_menu_validate_imagen__cb);
  } // do_ajax_form_aplicaciones_menu_validate_imagen_

  function do_ajax_form_aplicaciones_menu_validate_imagen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "imagen_" + iLineNumber;
    }
    else
    {
      sFieldValid = "imagen_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "imagen_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "imagen_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_menu_validate_imagen__cb

  // ---------- Validate modulo_
  function do_ajax_form_aplicaciones_menu_validate_modulo_(iNumLinha)
  {
    var nomeCampo_modulo_ = "modulo_" + iNumLinha;
    var var_modulo_ = scAjaxGetFieldSelect(nomeCampo_modulo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_menu_validate_modulo_(var_modulo_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_menu_validate_modulo__cb);
  } // do_ajax_form_aplicaciones_menu_validate_modulo_

  function do_ajax_form_aplicaciones_menu_validate_modulo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "modulo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "modulo_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "modulo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "modulo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_menu_validate_modulo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_aplicaciones_menu_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_aplicaciones_menu_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aplicaciones_menu_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_aplicaciones_menu_add_new_line_cb);
  } // do_ajax_form_aplicaciones_menu_add_new_line

  function do_ajax_form_aplicaciones_menu_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_aplicaciones_menu_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_aplicaciones_menu_backup_line(iNumLinha)
  {
    var var_idaplicacion_ = scAjaxGetFieldHidden("idaplicacion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_menu_backup_line(var_idaplicacion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_aplicaciones_menu_backup_line_cb);
  } // do_ajax_form_aplicaciones_menu_backup_line

  function do_ajax_form_aplicaciones_menu_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_aplicaciones_menu_backup_line_cb

  function do_ajax_form_aplicaciones_menu_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_aplicaciones_menu_cancel_insert

  function do_ajax_form_aplicaciones_menu_cancel_update(iSeqVert)
  {
    do_ajax_form_aplicaciones_menu_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_aplicaciones_menu_cancel_update

  function do_ajax_form_aplicaciones_menu_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_aplicaciones_menu_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_aplicaciones_menu_table_refresh()
  {
    var var_idaplicacion_ = document.F2.idaplicacion_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_aplicaciones_menu_table_refresh(var_idaplicacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aplicaciones_menu_table_refresh_cb);
  } //  do_ajax_form_aplicaciones_menu_table_refresh

  function do_ajax_form_aplicaciones_menu_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idaplicacion_.value = scAjaxGetKeyValue("idaplicacion_");
    ...
    scAjaxAlert(do_ajax_form_aplicaciones_menu_table_refresh_cb_after_alert);
  } // do_ajax_form_aplicaciones_menu_table_refresh_cb
  function do_ajax_form_aplicaciones_menu_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_aplicaciones_menu_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_aplicaciones_menu_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_aplicaciones_menu_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idaplicacion_ = scAjaxGetFieldHidden("idaplicacion_" + iNumLinha);
    var var_item_menu_ = scAjaxGetFieldText("item_menu_" + iNumLinha);
    var var_nombre_ = scAjaxGetFieldText("nombre_" + iNumLinha);
    var var_descripcion_ = scAjaxGetFieldText("descripcion_" + iNumLinha);
    var var_imagen_ = scAjaxGetFieldText("imagen_" + iNumLinha);
    var var_modulo_ = scAjaxGetFieldSelect("modulo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_aplicaciones_menu_submit_form(var_idaplicacion_, var_item_menu_, var_nombre_, var_descripcion_, var_imagen_, var_modulo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aplicaciones_menu_submit_form_cb);
  } // do_ajax_form_aplicaciones_menu_submit_form

  function do_ajax_form_aplicaciones_menu_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idaplicacion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("item_menu_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descripcion_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("imagen_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("modulo_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aplicaciones_menu_submit_form_cb_after_alert);
  } // do_ajax_form_aplicaciones_menu_submit_form_cb
  function do_ajax_form_aplicaciones_menu_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aplicaciones_menu_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aplicaciones_menu_navigate_form()
  {
    perform_ajax_form_aplicaciones_menu_navigate_form();
  }

  function perform_ajax_form_aplicaciones_menu_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idaplicacion_" + iNavForm);
      scAjaxHideErrorDisplay("item_menu_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_" + iNavForm);
      scAjaxHideErrorDisplay("descripcion_" + iNavForm);
      scAjaxHideErrorDisplay("imagen_" + iNavForm);
      scAjaxHideErrorDisplay("modulo_" + iNavForm);
    }
    var var_idaplicacion_ = document.F2.idaplicacion_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aplicaciones_menu_navigate_form(var_idaplicacion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aplicaciones_menu_navigate_form_cb);
  } // do_ajax_form_aplicaciones_menu_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aplicaciones_menu']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aplicaciones_menu_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idaplicacion_.value = scAjaxGetKeyValue("idaplicacion_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aplicaciones_menu_navigate_form_cb_after_alert);
  } // do_ajax_form_aplicaciones_menu_navigate_form_cb
  function do_ajax_form_aplicaciones_menu_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_aplicaciones_menu_navigate_form_cb_after_alert
  function sc_hide_form_aplicaciones_menu_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idaplicacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "item_menu_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descripcion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "imagen_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "modulo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idaplicacion_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["item_menu_" + iNumLinha] = {"label": "Id Item Menu<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_" + iNumLinha] = {"label": "Nombre SC<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["imagen_" + iNumLinha] = {"label": "Imágen<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["modulo_" + iNumLinha] = {"label": "Modulo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idaplicacion_"][iNumLinha] = "idaplicacion_" + iNumLinha;
    ajax_field_mult["item_menu_"][iNumLinha] = "item_menu_" + iNumLinha;
    ajax_field_mult["nombre_"][iNumLinha] = "nombre_" + iNumLinha;
    ajax_field_mult["descripcion_"][iNumLinha] = "descripcion_" + iNumLinha;
    ajax_field_mult["imagen_"][iNumLinha] = "imagen_" + iNumLinha;
    ajax_field_mult["modulo_"][iNumLinha] = "modulo_" + iNumLinha;
    ajax_field_id["idaplicacion_" + iNumLinha] = new Array("hidden_field_label_idaplicacion_", "hidden_field_data_idaplicacion_" + iNumLinha);
    ajax_field_id["item_menu_" + iNumLinha] = new Array("hidden_field_label_item_menu_", "hidden_field_data_item_menu_" + iNumLinha);
    ...
    ajax_field_id["imagen_" + iNumLinha] = new Array("hidden_field_label_imagen_", "hidden_field_data_imagen_" + iNumLinha);
    ajax_field_id["modulo_" + iNumLinha] = new Array("hidden_field_label_modulo_", "hidden_field_data_modulo_" + iNumLinha);
    ajax_error_count["idaplicacion_" + iNumLinha] = "off";
    ajax_error_count["item_menu_" + iNumLinha] = "off";
    ajax_error_count["nombre_" + iNumLinha] = "off";
    ajax_error_count["descripcion_" + iNumLinha] = "off";
    ajax_error_count["imagen_" + iNumLinha] = "off";
    ajax_error_count["modulo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idaplicacion_" + iNumLinha] = "on";
    ajax_read_only["item_menu_" + iNumLinha] = "off";
    ajax_read_only["nombre_" + iNumLinha] = "off";
    ajax_read_only["descripcion_" + iNumLinha] = "off";
    ajax_read_only["imagen_" + iNumLinha] = "off";
    ajax_read_only["modulo_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idaplicacion_" + iNumLinha] = "on";
    ajax_read_only["item_menu_" + iNumLinha] = "on";
    ajax_read_only["nombre_" + iNumLinha] = "on";
    ajax_read_only["descripcion_" + iNumLinha] = "on";
    ajax_read_only["imagen_" + iNumLinha] = "on";
    ajax_read_only["modulo_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idaplicacion_" + iNumLinha] = null;
    ajax_error_list["item_menu_" + iNumLinha] = null;
    ajax_error_list["nombre_" + iNumLinha] = null;
    ajax_error_list["descripcion_" + iNumLinha] = null;
    ajax_error_list["imagen_" + iNumLinha] = null;
    ajax_error_list["modulo_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idaplicacion_": new Array(),
    "item_menu_": new Array(),
    "nombre_": new Array(),
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idaplicacion_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idaplicacion_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idaplicacion_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idaplicacion_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idaplicacion_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["item_menu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["item_menu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["item_menu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["item_menu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["item_menu_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["imagen_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["imagen_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["imagen_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["imagen_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["imagen_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["modulo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["modulo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["modulo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["modulo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["modulo_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idaplicacion_'])) ? $this->nmgp_cmp_readonly['idaplicacion_'] : 'on';
?>
    scAjaxFieldRead("idaplicacion_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['item_menu_'])) ? $this->nmgp_cmp_readonly['item_menu_'] : 'off';
?>
    scAjaxFieldRead("item_menu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['imagen_'])) ? $this->nmgp_cmp_readonly['imagen_'] : 'off';
?>
    scAjaxFieldRead("imagen_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['modulo_'])) ? $this->nmgp_cmp_readonly['modulo_'] : 'off';
?>
    scAjaxFieldRead("modulo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idaplicacion_" + iSeq, "on");
    scAjaxFieldRead("item_menu_" + iSeq, "on");
    scAjaxFieldRead("nombre_" + iSeq, "on");
    scAjaxFieldRead("descripcion_" + iSeq, "on");
    scAjaxFieldRead("imagen_" + iSeq, "on");
    scAjaxFieldRead("modulo_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idaplicacion_" + iRow] || "on" == ajax_error_count["item_menu_" + iRow] || "on" == ajax_error_count["nombre_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["imagen_" + iRow] || "on" == ajax_error_count["modulo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idaplicacion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_item_menu_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_imagen_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_modulo_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idaplicacion_" + iRow] && "off" == ajax_error_count["item_menu_" + iRow] && "off" == ajax_error_count["nombre_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["imagen_" + iRow] && "off" == ajax_error_count["modulo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idaplicacion_" + iRow] = "off";
        ajax_error_count["item_menu_" + iRow] = "off";
        ajax_error_count["nombre_" + iRow] = "off";
        ajax_error_count["descripcion_" + iRow] = "off";
        ajax_error_count["imagen_" + iRow] = "off";
        ajax_error_count["modulo_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idaplicacion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_item_menu_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_imagen_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_modulo_" + iRow).removeClass("scFormErrorLine");
    }
  }
