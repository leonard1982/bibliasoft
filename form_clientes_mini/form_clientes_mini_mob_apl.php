<?php
//
class form_clientes_mini_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['clasificacion_clientes']))
          {
              $this->clasificacion_clientes = $this->NM_ajax_info['param']['clasificacion_clientes'];
          }
          if (isset($this->NM_ajax_info['param']['codigo_postal']))
          {
              $this->codigo_postal = $this->NM_ajax_info['param']['codigo_postal'];
          }
          if (isset($this->NM_ajax_info['param']['codigo_tercero']))
          {
              $this->codigo_tercero = $this->NM_ajax_info['param']['codigo_tercero'];
          }
          ...
          {
              $this->lenguaje = $this->NM_ajax_info['param']['lenguaje'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['nombre_comercil']))
          {
              $this->nombre_comercil = $this->NM_ajax_info['param']['nombre_comercil'];
          }
          if (isset($this->NM_ajax_info['param']['nombres']))
          {
              $this->nombres = $this->NM_ajax_info['param']['nombres'];
          }
          if (isset($this->NM_ajax_info['param']['notificar']))
          {
              $this->notificar = $this->NM_ajax_info['param']['notificar'];
          }
          if (isset($this->NM_ajax_info['param']['observaciones']))
          {
              $this->observaciones = $this->NM_ajax_info['param']['observaciones'];
          }
          if (isset($this->NM_ajax_info['param']['r_social']))
          {
              $this->r_social = $this->NM_ajax_info['param']['r_social'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['zona_clientes']))
          {
              $this->zona_clientes = $this->NM_ajax_info['param']['zona_clientes'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['embutida_parms'];
          unset($_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['embutida_parms']);
      } 
      ...
      { 
          ...
          while (!empty($todo[$ix]))
          {
             ...
             if (1 < sizeof($cadapar))
             {
                if (substr($cadapar[0], 0, 11) == "SC_glo_par_")
                {
                 ...
                 nm_limpa_str_form_clientes_mini_mob($cadapar[1]);
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->pa)) 
          {
              $_SESSION['pa'] = $this->pa;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['parms']))
      {
          if ((!isset($this->nmgp_opcao) || ($this->nmgp_opcao != "incluir" && $this->nmgp_opcao != "alterar" && $this->nmgp_opcao != "excluir" && $this->nmgp_opcao != "novo" && $this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")) && (!isset($this->NM_ajax_opcao) || $this->NM_ajax_opcao == ""))
          {
              $todox = str_replace("?#?@?@?", "?#?@ ?@?", $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['parms']);
              $todo  = explode("?@?", $todox);
              $ix = 0;
              while (!empty($todo[$ix]))
              {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_clientes_mini_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['initialize'])
          {
              $_SESSION['scriptcase']['form_clientes_mini_mob']['contr_erro'] = 'on';
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_idtercero != $this->idtercero || (isset($bFlagRead_idtercero) && $bFlagRead_idtercero)))
    {
        $this->ajax_return_values_idtercero(true);
    }
}
$_SESSION['scriptcase']['form_clientes_mini_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_clientes_mini_mob']['upload_field_info']['imagenter'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_clientes_mini_mob',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clientes_mini_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_clientes_mini_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clientes_mini_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clientes_mini_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_clientes_mini_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_clientes_mini_mob']['label'] = "Editar Cliente";
      ...
      $_SESSION['scriptcase']['error_icon']['form_clientes_mini_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_clientes_mini_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_field_ul_name'][$this->imagenter_ul_name]))
          {
              $this->NM_ajax_info['param']['imagenter_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_field_ul_name'][$this->imagenter_ul_name];
          }
      ...
      elseif (isset($this->imagenter_ul_name) && '' != $this->imagenter_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_field_ul_name'][$this->imagenter_ul_name]))
          {
              $this->imagenter_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_field_ul_name'][$this->imagenter_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_clientes_mini_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clientes_mini_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_clientes_mini_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_form'];
          ...
          if (!isset($this->credito)){$this->credito = $this->nmgp_dados_form['credito'];} 
          if (!isset($this->cupo)){$this->cupo = $this->nmgp_dados_form['cupo'];} 
          if (!isset($this->listaprecios)){$this->listaprecios = $this->nmgp_dados_form['listaprecios'];} 
          if (!isset($this->loatiende)){$this->loatiende = $this->nmgp_dados_form['loatiende'];} 
          ...
          if (!isset($this->dias_credito)){$this->dias_credito = $this->nmgp_dados_form['dias_credito'];} 
          if (!isset($this->dias_mora)){$this->dias_mora = $this->nmgp_dados_form['dias_mora'];} 
          if (!isset($this->cupo_vendedor)){$this->cupo_vendedor = $this->nmgp_dados_form['cupo_vendedor'];} 
          if (!isset($this->codigo_ter)){$this->codigo_ter = $this->nmgp_dados_form['codigo_ter'];} 
          if (!isset($this->es_cajero)){$this->es_cajero = $this->nmgp_dados_form['es_cajero'];} 
          if (!isset($this->autorizado)){$this->autorizado = $this->nmgp_dados_form['autorizado'];} 
          if (!isset($this->zona_clientes)){$this->zona_clientes = $this->nmgp_dados_form['zona_clientes'];} 
          if (!isset($this->clasificacion_clientes)){$this->clasificacion_clientes = $this->nmgp_dados_form['clasificacion_clientes'];} 
          ...
          if (!isset($this->n_pedido_tmp)){$this->n_pedido_tmp = $this->nmgp_dados_form['n_pedido_tmp'];} 
          if (!isset($this->total_pedido_tmp)){$this->total_pedido_tmp = $this->nmgp_dados_form['total_pedido_tmp'];} 
          if (!isset($this->obs_pedido_tmp)){$this->obs_pedido_tmp = $this->nmgp_dados_form['obs_pedido_tmp'];} 
          if (!isset($this->vend_pedido_tmp)){$this->vend_pedido_tmp = $this->nmgp_dados_form['vend_pedido_tmp'];} 
          if (!isset($this->puc_auxiliar_deudores)){$this->puc_auxiliar_deudores = $this->nmgp_dados_form['puc_auxiliar_deudores'];} 
          if (!isset($this->puc_retefuente_ventas)){$this->puc_retefuente_ventas = $this->nmgp_dados_form['puc_retefuente_ventas'];} 
          if (!isset($this->puc_retefuente_servicios_clie)){$this->puc_retefuente_servicios_clie = $this->nmgp_dados_form['puc_retefuente_servicios_clie'];} 
          if (!isset($this->puc_auxiliar_proveedores)){$this->puc_auxiliar_proveedores = $this->nmgp_dados_form['puc_auxiliar_proveedores'];} 
          if (!isset($this->puc_retefuente_compras)){$this->puc_retefuente_compras = $this->nmgp_dados_form['puc_retefuente_compras'];} 
          if (!isset($this->puc_retefuente_servicios_prov)){$this->puc_retefuente_servicios_prov = $this->nmgp_dados_form['puc_retefuente_servicios_prov'];} 
          ...
          if (!isset($this->es_tecnico)){$this->es_tecnico = $this->nmgp_dados_form['es_tecnico'];} 
          if (!isset($this->archivos)){$this->archivos = $this->nmgp_dados_form['archivos'];} 
          if (!isset($this->ciiu)){$this->ciiu = $this->nmgp_dados_form['ciiu'];} 
          if (!isset($this->cupodis)){$this->cupodis = $this->nmgp_dados_form['cupodis'];} 
          if (!isset($this->detalle_tributario)){$this->detalle_tributario = $this->nmgp_dados_form['detalle_tributario'];} 
          if (!isset($this->relleno2)){$this->relleno2 = $this->nmgp_dados_form['relleno2'];} 
          if (!isset($this->responsabilidad_fiscal)){$this->responsabilidad_fiscal = $this->nmgp_dados_form['responsabilidad_fiscal'];} 
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_clientes_mini_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_clientes_mini_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_clientes_mini_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_clientes_mini/form_clientes_mini_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_clientes_mini_mob_erro.class.php"); 
      }
      $this->Erro      = new form_clientes_mini_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao']))
         { 
             if ($this->idtercero != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_clientes_mini_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['form_clientes_mini_mob']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_clientes_mini_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_clientes_mini_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->idtercero)) { $this->nm_limpa_alfa($this->idtercero); }
      ...
      if (isset($this->lenguaje)) { $this->nm_limpa_alfa($this->lenguaje); }
      if (isset($this->nombre_comercil)) { $this->nm_limpa_alfa($this->nombre_comercil); }
      if (isset($this->notificar)) { $this->nm_limpa_alfa($this->notificar); }
      if (isset($this->codigo_tercero)) { $this->nm_limpa_alfa($this->codigo_tercero); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select'];
     }
   }
   ...
   function loadFieldConfig()
   {
      ...
      //-- dias_credito
      $this->field_config['dias_credito']               = array();
      $this->field_config['dias_credito']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dias_credito']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dias_credito']['symbol_dec'] = '';
      $this->field_config['dias_credito']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dias_credito']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- dias_mora
      $this->field_config['dias_mora']               = array();
      $this->field_config['dias_mora']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['dias_mora']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['dias_mora']['symbol_dec'] = '';
      $this->field_config['dias_mora']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['dias_mora']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- cupo_vendedor
      $this->field_config['cupo_vendedor']               = array();
      $this->field_config['cupo_vendedor']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['cupo_vendedor']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['cupo_vendedor']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['cupo_vendedor']['symbol_mon'] = $_SESSION['scriptcase']['reg_conf']['monet_simb'];
      $this->field_config['cupo_vendedor']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['cupo_vendedor']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- creado
      ...
      //-- id_pedido_tmp
      $this->field_config['id_pedido_tmp']               = array();
      $this->field_config['id_pedido_tmp']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['id_pedido_tmp']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['id_pedido_tmp']['symbol_dec'] = '';
      $this->field_config['id_pedido_tmp']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['id_pedido_tmp']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- total_pedido_tmp
      $this->field_config['total_pedido_tmp']               = array();
      $this->field_config['total_pedido_tmp']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_val'];
      $this->field_config['total_pedido_tmp']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['unid_mont_group_digit'];
      $this->field_config['total_pedido_tmp']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_val'];
      $this->field_config['total_pedido_tmp']['symbol_mon'] = '';
      $this->field_config['total_pedido_tmp']['format_pos'] = $_SESSION['scriptcase']['reg_conf']['monet_f_pos'];
      $this->field_config['total_pedido_tmp']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['monet_f_neg'];
      //-- cupodis
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_notificar' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'notificar');
          }
          ...
          if ('validate_idtercero' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idtercero');
          }
          if ('validate_nombre_comercil' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'nombre_comercil');
          }
          ...
          if ('validate_lenguaje' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'lenguaje');
          }
          if ('validate_es_restaurante' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'es_restaurante');
          }
          if ('validate_r_social' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'r_social');
          }
          form_clientes_mini_mob_pack_ajax_response();
          exit;
      }
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_nombre_comercil_onchange' == $this->NM_ajax_opcao)
          {
              $this->nombre_comercil_onChange();
          }
          if ('event_proveedor_onchange' == $this->NM_ajax_opcao)
          {
              $this->proveedor_onChange();
          }
          if ('event_r_social_onchange' == $this->NM_ajax_opcao)
          {
              $this->r_social_onChange();
          }
          if ('event_regimen_onchange' == $this->NM_ajax_opcao)
          {
              $this->regimen_onChange();
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          if (is_array($this->es_cajero))
          {
              ...
              if ($this->es_cajero_1 != "") 
              { 
                  foreach ($this->es_cajero_1 as $dados_es_cajero_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->es_cajero .= ";";
                      } 
                      $this->es_cajero .= $dados_es_cajero_1;
                      $x++ ; 
                  } 
              } 
          } 
          if (is_array($this->autorizado))
          {
              ...
              $this->autorizado = ""; 
              if ($this->autorizado_1 != "") 
              { 
                  foreach ($this->autorizado_1 as $dados_autorizado_1 ) 
                  { 
                      if ($x != 0)
                      { 
                          $this->autorizado .= ";";
                      } 
                      $this->autorizado .= $dados_autorizado_1;
                      $x++ ; 
                  } 
              } 
          } 
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['cupodis']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cupodis = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['cupodis'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['cupo']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cupo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['cupo'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['cliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['cliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['dias']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->dias = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['dias'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['autorizado']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->autorizado = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['autorizado'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['documento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->documento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['documento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['tipo_documento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->tipo_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['tipo_documento'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['nombres']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['nombres'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['credito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->credito = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['credito'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['regimen']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->regimen = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']['regimen'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_clientes_mini_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Editar Cliente") ?></TITLE>
...
<form name="Fdown" method="get" action="form_clientes_mini_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_clientes_mini_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_clientes_mini_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
   ...
   function Recupera_Nome_Campo($campo) 
   {
       switch($campo)
       {
           ...
           case 'es_cajero':
               ...
               break;
           case 'autorizado':
               return "Autorizar Ventas";
               break;
           case 'zona_clientes':
               return "Zona Tercero";
               break;
           case 'clasificacion_clientes':
               return "Clasificacion Tercero";
               break;
           case 'creado':
               return "Creado";
               break;
           ...
           case 'puc_auxiliar_proveedores':
               return "PUC Auxiliar Proveedores";
               break;
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_clientes_mini_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_clientes_mini_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_clientes_mini_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_clientes_mini_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'notificar' == $filtro)) || (is_array($filtro) && in_array('notificar', $filtro)))
        $this->ValidateField_notificar($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'idtercero' == $filtro)) || (is_array($filtro) && in_array('idtercero', $filtro)))
        $this->ValidateField_idtercero($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ((!is_array($filtro) && ('' == $filtro || 'nombre_comercil' == $filtro)) || (is_array($filtro) && in_array('nombre_comercil', $filtro)))
        $this->ValidateField_nombre_comercil($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'lenguaje' == $filtro)) || (is_array($filtro) && in_array('lenguaje', $filtro)))
        $this->ValidateField_lenguaje($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'r_social' == $filtro)) || (is_array($filtro) && in_array('r_social', $filtro)))
        $this->ValidateField_r_social($Campos_Crit, $Campos_Falta, $Campos_Erros);
      $this->upload_img_doc($Campos_Crit, $Campos_Falta, $Campos_Erros);
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->imagenter && "S" != $this->imagenter_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_clientes_mini_mob_doc_name.php';
                }
    ...
    function ValidateField_documento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['php_cmp_required']['documento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['php_cmp_required']['documento'] == "on")) 
      { 
          if ($this->documento == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "No Documento" ; 
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "No Documento " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 14 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['documento']))
              {
                  $Campos_Erros['documento'] = array();
              }
...
;
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "No Documento " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['documento']))
              {
                  $Campos_Erros['documento'] = array();
              }
    ...
    function ValidateField_tipo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['php_cmp_required']['tipo'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Tipo persona" ;
    ...
    function ValidateField_regimen(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['php_cmp_required']['regimen']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['php_cmp_required']['regimen'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Régimen" ;
          if (!isset($Campos_Erros['regimen']))
          {
              $Campos_Erros['regimen'] = array();
          }
          $Campos_Erros['regimen'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['regimen']) || !is_array($this->NM_ajax_info['errList']['regimen']))
                  {
                      $this->NM_ajax_info['errList']['regimen'] = array();
                  }
                  $this->NM_ajax_info['errList']['regimen'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
        } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_nombres(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Nombre ó Razón Social " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_direccion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->direccion) > 120) 
          { 
              $hasError = true;
              $Campos_Crit .= "Dirección " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['direccion']))
              {
                  $Campos_Erros['direccion'] = array();
              }
              $Campos_Erros['direccion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['direccion'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_codigo_tercero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      $this->codigo_tercero = sc_strtoupper($this->codigo_tercero); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->codigo_tercero) > 10) 
          { 
              $hasError = true;
              $Campos_Crit .= "Código Tercero " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['codigo_tercero']))
              {
                  $Campos_Erros['codigo_tercero'] = array();
              }
              $Campos_Erros['codigo_tercero'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['codigo_tercero']) || !is_array($this->NM_ajax_info['errList']['codigo_tercero']))
              {
                  $this->NM_ajax_info['errList']['codigo_tercero'] = array();
              }
              $this->NM_ajax_info['errList']['codigo_tercero'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 10 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
      $Teste_trab = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ÁÉÍÓÚÀÈÌÒÙÃÕÂÊÎÔÛÄËÏÖÜÑÝÿ¨´`^~.-_";
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $Teste_trab = NM_conv_charset($Teste_trab, $_SESSION['scriptcase']['charset'], "UTF-8");
      }
;
      $Teste_trab = $Teste_trab . chr(10) . chr(13) ; 
      $Teste_compara = $this->codigo_tercero ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->codigo_tercero, $_SESSION['scriptcase']['charset']); $x++) 
          { 
               for ($y = 0; $y < mb_strlen($Teste_trab, $_SESSION['scriptcase']['charset']); $y++) 
               { 
                    if (sc_substr($Teste_compara, $x, 1) == sc_substr($Teste_trab, $y, 1) ) 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Código Tercero " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['codigo_tercero']))
              {
                  $Campos_Erros['codigo_tercero'] = array();
              }
              $Campos_Erros['codigo_tercero'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['codigo_tercero']) || !is_array($this->NM_ajax_info['errList']['codigo_tercero']))
              {
                  $this->NM_ajax_info['errList']['codigo_tercero'] = array();
              }
              $this->NM_ajax_info['errList']['codigo_tercero'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'codigo_tercero';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_codigo_tercero
    ...
    function ValidateField_sexo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['php_cmp_required']['sexo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['php_cmp_required']['sexo'] == "on")
        { 
          $hasError = true;
          $Campos_Falta[] = "Género" ;
    ...
    function ValidateField_notificar(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->notificar == "" && $this->nmgp_opcao != "excluir")
      { 
      } 
        if ($hasError) {
            global $sc_seq_vert;
...
;
    ...
    function ValidateField_idtercero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      ...
      { 
          ...
          { 
              $iTestSize = 10;
              if (strlen($this->idtercero) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Idtercero: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['idtercero']))
                  {
                      $Campos_Erros['idtercero'] = array();
                  }
                  $Campos_Erros['idtercero'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['idtercero']) || !is_array($this->NM_ajax_info['errList']['idtercero']))
                  {
                      $this->NM_ajax_info['errList']['idtercero'] = array();
                  }
                  $this->NM_ajax_info['errList']['idtercero'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idtercero, 10, 0, -0, 9999999999, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Idtercero; " ; 
                  if (!isset($Campos_Erros['idtercero']))
                  {
                      $Campos_Erros['idtercero'] = array();
                  }
                  $Campos_Erros['idtercero'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['idtercero']) || !is_array($this->NM_ajax_info['errList']['idtercero']))
                  {
                      $this->NM_ajax_info['errList']['idtercero'] = array();
                  }
                  $this->NM_ajax_info['errList']['idtercero'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
    ...
    } // ValidateField_idtercero

    function ValidateField_nombre_comercil(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      $this->nombre_comercil = sc_strtoupper($this->nombre_comercil); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->nombre_comercil) > 120) 
          { 
              $hasError = true;
              $Campos_Crit .= "Nombre Comercial " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['nombre_comercil']))
              {
                  $Campos_Erros['nombre_comercil'] = array();
              }
              $Campos_Erros['nombre_comercil'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['nombre_comercil']) || !is_array($this->NM_ajax_info['errList']['nombre_comercil']))
              {
                  $this->NM_ajax_info['errList']['nombre_comercil'] = array();
              }
              $this->NM_ajax_info['errList']['nombre_comercil'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
      $Teste_trab = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789ÁÉÍÓÚÀÈÌÒÙÃÕÂÊÎÔÛÄËÏÖÜÑÝÿ¨´`^~ .,-_";
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
...
;
      $Teste_trab = $Teste_trab . chr(10) . chr(13) ; 
      $Teste_compara = $this->nombre_comercil ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->nombre_comercil, $_SESSION['scriptcase']['charset']); $x++) 
          { 
               for ($y = 0; $y < mb_strlen($Teste_trab, $_SESSION['scriptcase']['charset']); $y++) 
               { 
                    if (sc_substr($Teste_compara, $x, 1) == sc_substr($Teste_trab, $y, 1) ) 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Nombre Comercial " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['nombre_comercil']))
              {
                  $Campos_Erros['nombre_comercil'] = array();
              }
              $Campos_Erros['nombre_comercil'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['nombre_comercil']) || !is_array($this->NM_ajax_info['errList']['nombre_comercil']))
              {
                  $this->NM_ajax_info['errList']['nombre_comercil'] = array();
              }
              $this->NM_ajax_info['errList']['nombre_comercil'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'nombre_comercil';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_nombre_comercil
...
;
    ...
    function ValidateField_departamento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->departamento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_departamento']) && !in_array($this->departamento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_departamento']))
               {
                   $hasError = true;
    ...
    function ValidateField_idmuni(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idmuni) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_idmuni']) && !in_array($this->idmuni, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_idmuni']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_ciudad(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->ciudad) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_ciudad']) && !in_array($this->ciudad, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_ciudad']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_codigo_postal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->codigo_postal) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_codigo_postal']) && !in_array($this->codigo_postal, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_codigo_postal']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $Campos_Erros['codigo_postal'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $this->NM_ajax_info['errList']['codigo_postal'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_observaciones(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->observaciones) > 20000) 
          { 
              $hasError = true;
              $Campos_Crit .= "Observaciones " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20000 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['observaciones']))
              {
                  $Campos_Erros['observaciones'] = array();
              }
              $Campos_Erros['observaciones'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20000 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              ...
              $this->NM_ajax_info['errList']['observaciones'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20000 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_lenguaje(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->lenguaje) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_lenguaje']) && !in_array($this->lenguaje, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_lenguaje']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['lenguaje']))
                   {
                       $Campos_Erros['lenguaje'] = array();
                   }
                   $Campos_Erros['lenguaje'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['lenguaje']) || !is_array($this->NM_ajax_info['errList']['lenguaje']))
                   {
                       $this->NM_ajax_info['errList']['lenguaje'] = array();
                   }
                   $this->NM_ajax_info['errList']['lenguaje'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'lenguaje';
    ...
    function ValidateField_es_restaurante(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_es_restaurante']) && !in_array($this->es_restaurante, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_es_restaurante']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_r_social(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      $this->r_social = sc_strtoupper($this->r_social); 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->r_social) > 120) 
          { 
              $hasError = true;
              $Campos_Crit .= "Nombre/Razón Social " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['r_social']))
              {
                  $Campos_Erros['r_social'] = array();
              }
              $Campos_Erros['r_social'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['r_social']) || !is_array($this->NM_ajax_info['errList']['r_social']))
              {
                  $this->NM_ajax_info['errList']['r_social'] = array();
              }
              $this->NM_ajax_info['errList']['r_social'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 120 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
...
//--------------------------------------------------------------------------------------
   function upload_img_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros, $filtro = '') 
   {
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      if ($this->nmgp_opcao == "incluir" && $this->imagenter == "" &&  $this->imagenter_limpa != "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_clone']['imagenter']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_clone']['imagenter']))
      { 
          $this->imagenter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_clone']['imagenter'];
      } 
      ...
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_form']['imagenter']) && $this->imagenter_limpa != "S")
          {
              $this->imagenter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_form']['imagenter'];
          }
      } 
   }
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['nombre_comercil'] = $this->nombre_comercil;
    ...
    $this->nmgp_dados_form['lenguaje'] = $this->lenguaje;
    $this->nmgp_dados_form['es_restaurante'] = $this->es_restaurante;
    $this->nmgp_dados_form['r_social'] = $this->r_social;
    ...
    $this->nmgp_dados_form['dias_credito'] = $this->dias_credito;
    $this->nmgp_dados_form['dias_mora'] = $this->dias_mora;
    $this->nmgp_dados_form['cupo_vendedor'] = $this->cupo_vendedor;
    $this->nmgp_dados_form['codigo_ter'] = $this->codigo_ter;
    $this->nmgp_dados_form['es_cajero'] = $this->es_cajero;
    $this->nmgp_dados_form['autorizado'] = $this->autorizado;
    $this->nmgp_dados_form['zona_clientes'] = $this->zona_clientes;
    $this->nmgp_dados_form['clasificacion_clientes'] = $this->clasificacion_clientes;
    ...
    $this->nmgp_dados_form['n_pedido_tmp'] = $this->n_pedido_tmp;
    $this->nmgp_dados_form['total_pedido_tmp'] = $this->total_pedido_tmp;
    $this->nmgp_dados_form['obs_pedido_tmp'] = $this->obs_pedido_tmp;
    $this->nmgp_dados_form['vend_pedido_tmp'] = $this->vend_pedido_tmp;
    $this->nmgp_dados_form['puc_auxiliar_deudores'] = $this->puc_auxiliar_deudores;
    $this->nmgp_dados_form['puc_retefuente_ventas'] = $this->puc_retefuente_ventas;
    $this->nmgp_dados_form['puc_retefuente_servicios_clie'] = $this->puc_retefuente_servicios_clie;
    $this->nmgp_dados_form['puc_auxiliar_proveedores'] = $this->puc_auxiliar_proveedores;
    $this->nmgp_dados_form['puc_retefuente_compras'] = $this->puc_retefuente_compras;
    $this->nmgp_dados_form['puc_retefuente_servicios_prov'] = $this->puc_retefuente_servicios_prov;
    ...
    $this->nmgp_dados_form['es_tecnico'] = $this->es_tecnico;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_form'] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['dias_credito'] = $this->dias_credito;
      nm_limpa_numero($this->dias_credito, $this->field_config['dias_credito']['symbol_grp']) ; 
      $this->Before_unformat['dias_mora'] = $this->dias_mora;
      nm_limpa_numero($this->dias_mora, $this->field_config['dias_mora']['symbol_grp']) ; 
      $this->Before_unformat['cupo_vendedor'] = $this->cupo_vendedor;
      if (!empty($this->field_config['cupo_vendedor']['symbol_dec']))
      {
         $this->sc_remove_currency($this->cupo_vendedor, $this->field_config['cupo_vendedor']['symbol_dec'], $this->field_config['cupo_vendedor']['symbol_grp'], $this->field_config['cupo_vendedor']['symbol_mon']);
         nm_limpa_valor($this->cupo_vendedor, $this->field_config['cupo_vendedor']['symbol_dec'], $this->field_config['cupo_vendedor']['symbol_grp']);
      }
      ...
      $this->Before_unformat['id_pedido_tmp'] = $this->id_pedido_tmp;
      nm_limpa_numero($this->id_pedido_tmp, $this->field_config['id_pedido_tmp']['symbol_grp']) ; 
      $this->Before_unformat['total_pedido_tmp'] = $this->total_pedido_tmp;
      if (!empty($this->field_config['total_pedido_tmp']['symbol_dec']))
      {
         $this->sc_remove_currency($this->total_pedido_tmp, $this->field_config['total_pedido_tmp']['symbol_dec'], $this->field_config['total_pedido_tmp']['symbol_grp'], $this->field_config['total_pedido_tmp']['symbol_mon']);
         nm_limpa_valor($this->total_pedido_tmp, $this->field_config['total_pedido_tmp']['symbol_dec'], $this->field_config['total_pedido_tmp']['symbol_grp']);
      }
   ...
   function nm_clear_val($Nome_Campo)
   {
      ...
      if ($Nome_Campo == "dias_credito")
      {
          nm_limpa_numero($this->dias_credito, $this->field_config['dias_credito']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "dias_mora")
      {
          nm_limpa_numero($this->dias_mora, $this->field_config['dias_mora']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "cupo_vendedor")
      {
          if (!empty($this->field_config['cupo_vendedor']['symbol_dec']))
          {
             $this->sc_remove_currency($this->cupo_vendedor, $this->field_config['cupo_vendedor']['symbol_dec'], $this->field_config['cupo_vendedor']['symbol_grp'], $this->field_config['cupo_vendedor']['symbol_mon']);
      ...
      if ($Nome_Campo == "id_pedido_tmp")
      {
          nm_limpa_numero($this->id_pedido_tmp, $this->field_config['id_pedido_tmp']['symbol_grp']) ; 
      }
      if ($Nome_Campo == "total_pedido_tmp")
      {
          if (!empty($this->field_config['total_pedido_tmp']['symbol_dec']))
          {
             $this->sc_remove_currency($this->total_pedido_tmp, $this->field_config['total_pedido_tmp']['symbol_dec'], $this->field_config['total_pedido_tmp']['symbol_grp'], $this->field_config['total_pedido_tmp']['symbol_mon']);
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->idtercero || (!empty($format_fields) && isset($format_fields['idtercero'])))
      {
          nmgp_Form_Num_Val($this->idtercero, $this->field_config['idtercero']['symbol_grp'], $this->field_config['idtercero']['symbol_dec'], "0", "S", $this->field_config['idtercero']['format_neg'], "", "", "-", $this->field_config['idtercero']['symbol_fmt']) ; 
      }
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_nombre_comercil();
          ...
          $this->ajax_return_values_lenguaje();
          $this->ajax_return_values_es_restaurante();
          $this->ajax_return_values_r_social();
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              $this->NM_ajax_info['clearUpload']      = 'S';
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['idtercero']['keyVal'] = form_clientes_mini_mob_pack_protect_string($this->nmgp_dados_form['idtercero']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['embutida_pai']        = "form_clientes_mini_mob";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['embutida_form_parms'] = "gcctercero*scin" . $this->nmgp_dados_form['documento'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_cab*scinN*scoutNMSC_nav*scinN*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['grid_gestor_archivos_tercero_script_case_init'] ]['grid_gestor_archivos_tercero']['total']);
              }
          }
...
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('11') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Registtro civil de nacimiento")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('12') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Tarjeta de identidad")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('13') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Cédula de ciudadanía")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('21') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Tarjeta de Extranjería")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('22') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Cédula de extranjería")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('31') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Nit")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('41') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Pasaporte")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('42') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Tipo de documento extranjero")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('43') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Definido por la DIAN")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '11';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '12';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '13';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '21';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '22';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '31';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '41';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '42';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo_documento'][] = '43';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipo_documento']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('NAT') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("NATURAL")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('JUR') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("JURÍDICA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo'][] = 'NAT';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_tipo'][] = 'JUR';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"tipo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('SIM') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("NO RESPONSABLE")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('COMUN') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("RESPONSABLE")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_regimen'][] = 'SIM';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_regimen'][] = 'COMUN';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['regimen']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_direccion($bForce = false)
   {
          ...
          //----- codigo_tercero
   function ajax_return_values_codigo_tercero($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("codigo_tercero", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->codigo_tercero);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['codigo_tercero'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
...
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('M') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Masculino")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('F') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Femenino")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('O') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("Otro")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_sexo'][] = 'M';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_sexo'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_sexo'][] = 'O';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"sexo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['sexo']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          //----- notificar
   function ajax_return_values_notificar($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("notificar", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->notificar);
              $aLookup = array();
              $this->_tmp_lookup_notificar = $this->notificar;

$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("SI")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('NO') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_notificar'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_notificar'][] = 'NO';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"notificar\"";
          if (isset($this->NM_ajax_info['select_html']['notificar']) && !empty($this->NM_ajax_info['select_html']['notificar']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['notificar']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->notificar == $sValue)
                  {
                      $this->_tmp_lookup_notificar = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['notificar'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['notificar']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['notificar']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['notificar']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['notificar']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['notificar']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_idtercero($bForce = false)
   {
          ...
          //----- nombre_comercil
   function ajax_return_values_nombre_comercil($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("nombre_comercil", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->nombre_comercil);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['nombre_comercil'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_clientes_mini_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clientes_mini_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['departamento']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idmuni']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_clientes_mini_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_clientes_mini_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['ciudad']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_codigo_postal($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("codigo_postal", $this->nmgp_refresh_fields)) || $bForce)
          {
              ...
              $aLookup = array();
              $this->_tmp_lookup_codigo_postal = $this->codigo_postal;
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"codigo_postal\"";
          if (isset($this->NM_ajax_info['select_html']['codigo_postal']) && !empty($this->NM_ajax_info['select_html']['codigo_postal']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['codigo_postal']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->codigo_postal == $sValue)
                  {
                      $this->_tmp_lookup_codigo_postal = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['codigo_postal']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['codigo_postal']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['codigo_postal']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['codigo_postal']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['codigo_postal']['labList'] = $aLabel;
          }
   }
   ...
   function ajax_return_values_observaciones($bForce = false)
   {
          ...
          //----- lenguaje
   function ajax_return_values_lenguaje($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("lenguaje", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->lenguaje);
              $aLookup = array();
              $this->_tmp_lookup_lenguaje = $this->lenguaje;
...
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_lenguaje'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"lenguaje\"";
          if (isset($this->NM_ajax_info['select_html']['lenguaje']) && !empty($this->NM_ajax_info['select_html']['lenguaje']))
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['lenguaje']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->lenguaje == $sValue)
                  {
                      $this->_tmp_lookup_lenguaje = $sLabel;
                  }
          ...
          $aLookup  = $sLookup;
          $this->NM_ajax_info['fldList']['lenguaje'] = array(
                       'row'    => '',
               'type'    => 'select',
               'valList' => array($sTmpValue),
               'optList' => $aLookup,
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['lenguaje']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['lenguaje']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['lenguaje']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['lenguaje']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['lenguaje']['labList'] = $aLabel;
          }
   }
...
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('NO') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("NO")));
$aLookup[] = array(form_clientes_mini_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_clientes_mini_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_es_restaurante'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_es_restaurante'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['es_restaurante']['valList'][$i] = form_clientes_mini_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          //----- r_social
   function ajax_return_values_r_social($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("r_social", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->r_social);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['r_social'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($this->form_encode_input($sTmpValue)),
              );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  {
      if ($this->sc_evento == "novo" || $this->sc_evento == "incluir" || ($this->nmgp_opcao == "nada" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opc_ant']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opc_ant'] == "novo") || (isset($GLOBALS['erro_incl']) && 1 == $GLOBALS['erro_incl']))
      {
      }
      else
      {
          ...
          {
              $this->nmgp_cmp_hidden["idtercero"] = "off"; $this->NM_ajax_info['fieldDisplay']['idtercero'] = 'off';
          }
      }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_r_social = $this->r_social;
...
if (!isset($this->sc_temp_gidtercero)) {$this->sc_temp_gidtercero = (isset($_SESSION['gidtercero'])) ? $_SESSION['gidtercero'] : "";}
  $vGrupo=0;
      ...
      $nm_select = "select grupo from usuarios where tercero=$this->sc_temp_gidtercero"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->da_con = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                      $this->da_con[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->da_con = false;
          $this->da_con_erro = $this->Db->ErrorMsg();
      } 
;
if(isset($this->da_con[0][0]))
	{
	$vGrupo=$this->da_con[0][0];
	if($vGrupo==1)
		{
		$this->sc_ajax_javascript('nm_field_disabled', array("autorizado=", ""));
;
		}
	else
		{
		$this->sc_ajax_javascript('nm_field_disabled', array("autorizado=disabled", ""));
;
		}
	}
...
if($this->documento !="")
	{
      ...
      $nm_select = "select regimen from terceros where idtercero=$this->idtercero "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dt_t = array();
     if ($this->idtercero != "")
     { 
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->dt_t[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->dt_t = false;
          $this->dt_t_erro = $this->Db->ErrorMsg();
      } 
     } 
;
	if(isset($this->dt_t[0][0]))
		{
		$this->regimen =$this->dt_t[0][0];
		}
	...
	$buscar="SELECT iddepar FROM municipio WHERE idmun = $this->idmuni ";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->ds_dep[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->ds_dep = false;
          $this->ds_dep_erro = $this->Db->ErrorMsg();
      } 
;
	$this->departamento =$this->ds_dep[0][0];
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_dv != $this->dv || (isset($bFlagRead_dv) && $bFlagRead_dv)))
    {
    ...
    if (($original_r_social != $this->r_social || (isset($bFlagRead_r_social) && $bFlagRead_r_social)))
    {
        $this->ajax_return_values_r_social(true);
    }
    if (($original_regimen != $this->regimen || (isset($bFlagRead_regimen) && $bFlagRead_regimen)))
    {
...
//
   ...
   { 
      ...
      $this->cupo_vendedor = str_replace($sc_parm1, $sc_parm2, $this->cupo_vendedor); 
      $this->total_pedido_tmp = str_replace($sc_parm1, $sc_parm2, $this->total_pedido_tmp); 
   ...
   { 
      ...
      $this->cupo_vendedor = "'" . $this->cupo_vendedor . "'";
      $this->total_pedido_tmp = "'" . $this->total_pedido_tmp . "'";
...
//----------- 
   ...
   {
      global $sc_where;
      $sc_where_pos = " WHERE ((idtercero > $this->idtercero))";
      if ('' != $sc_where)
      {
      ...
      if ('' != $this->idtercero)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($this->nmgp_opcao != "incluir")  
      {
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_clone']['imagenter']);
      }
      if (!empty($this->sc_force_zero))
      {
          foreach ($this->sc_force_zero as $i_force_zero => $sc_force_zero_field)
...
if(isset($this->ds_ter[0][0]) or isset($this->ds_ter[0][1]) or isset($this->ds_ter[0][2]))
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_clientes_mini_mob';
...
$_SESSION['scriptcase']['form_clientes_mini_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['nombre_comercil'] = $this->nombre_comercil;
      ...
      $NM_val_form['lenguaje'] = $this->lenguaje;
      $NM_val_form['es_restaurante'] = $this->es_restaurante;
      $NM_val_form['r_social'] = $this->r_social;
      ...
      $NM_val_form['dias_credito'] = $this->dias_credito;
      $NM_val_form['dias_mora'] = $this->dias_mora;
      $NM_val_form['cupo_vendedor'] = $this->cupo_vendedor;
      $NM_val_form['codigo_ter'] = $this->codigo_ter;
      $NM_val_form['es_cajero'] = $this->es_cajero;
      $NM_val_form['autorizado'] = $this->autorizado;
      $NM_val_form['zona_clientes'] = $this->zona_clientes;
      $NM_val_form['clasificacion_clientes'] = $this->clasificacion_clientes;
      $NM_val_form['creado'] = $this->creado;
      $NM_val_form['disponible'] = $this->disponible;
      $NM_val_form['id_pedido_tmp'] = $this->id_pedido_tmp;
      $NM_val_form['n_pedido_tmp'] = $this->n_pedido_tmp;
      $NM_val_form['total_pedido_tmp'] = $this->total_pedido_tmp;
      $NM_val_form['obs_pedido_tmp'] = $this->obs_pedido_tmp;
      $NM_val_form['vend_pedido_tmp'] = $this->vend_pedido_tmp;
      $NM_val_form['puc_auxiliar_deudores'] = $this->puc_auxiliar_deudores;
      $NM_val_form['puc_retefuente_ventas'] = $this->puc_retefuente_ventas;
      $NM_val_form['puc_retefuente_servicios_clie'] = $this->puc_retefuente_servicios_clie;
      $NM_val_form['puc_auxiliar_proveedores'] = $this->puc_auxiliar_proveedores;
      $NM_val_form['puc_retefuente_compras'] = $this->puc_retefuente_compras;
      $NM_val_form['puc_retefuente_servicios_prov'] = $this->puc_retefuente_servicios_prov;
      ...
      $NM_val_form['es_tecnico'] = $this->es_tecnico;
      ...
      if ($this->nmgp_opcao == "alterar")
      {
      if ($this->dias_credito === "" || is_null($this->dias_credito))  
      { 
          $this->dias_credito = 0;
          $this->sc_force_zero[] = 'dias_credito';
      } 
      }
      if ($this->nmgp_opcao == "alterar")
      {
      if ($this->dias_mora === "" || is_null($this->dias_mora))  
      { 
          $this->dias_mora = 0;
          $this->sc_force_zero[] = 'dias_mora';
      } 
      }
      if ($this->nmgp_opcao == "alterar")
      {
      if ($this->cupo_vendedor === "" || is_null($this->cupo_vendedor))  
      { 
          $this->cupo_vendedor = 0;
          $this->sc_force_zero[] = 'cupo_vendedor';
      } 
      }
      if ($this->nmgp_opcao == "alterar")
      {
      ...
      if ($this->nmgp_opcao == "alterar")
      {
      if ($this->zona_clientes === "" || is_null($this->zona_clientes))  
      { 
          $this->zona_clientes = 0;
          $this->sc_force_zero[] = 'zona_clientes';
      } 
      }
      if ($this->nmgp_opcao == "alterar")
      {
      if ($this->clasificacion_clientes === "" || is_null($this->clasificacion_clientes))  
      { 
          $this->clasificacion_clientes = 0;
          $this->sc_force_zero[] = 'clasificacion_clientes';
      } 
      }
      if ($this->id_pedido_tmp === "" || is_null($this->id_pedido_tmp))  
      { 
          $this->id_pedido_tmp = 0;
          $this->sc_force_zero[] = 'id_pedido_tmp';
      } 
      if ($this->total_pedido_tmp === "" || is_null($this->total_pedido_tmp))  
      { 
          $this->total_pedido_tmp = 0;
          $this->sc_force_zero[] = 'total_pedido_tmp';
      } 
      if ($this->nmgp_opcao == "alterar")
      {
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          if ($this->nmgp_opcao == "alterar") 
          {
              ...
              if ($this->nacimiento == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->nacimiento = "null"; 
                  $NM_val_null[] = "nacimiento";
              } 
          ...
          if ($this->nmgp_opcao == "alterar") 
          {
              ...
              if ($this->fechault == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->fechault = "null"; 
                  $NM_val_null[] = "fechault";
              } 
          ...
          if ($this->nmgp_opcao == "alterar") 
          {
              ...
              if ($this->afiliacion == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->afiliacion = "null"; 
                  $NM_val_null[] = "afiliacion";
              } 
          ...
          if ($this->nmgp_opcao == "alterar") 
          {
              ...
              if ($this->fechultcomp == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->fechultcomp = "null"; 
                  $NM_val_null[] = "fechultcomp";
              } 
          ...
          $this->codigo_ter_before_qstr = $this->codigo_ter;
          $this->codigo_ter = substr($this->Db->qstr($this->codigo_ter), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->codigo_ter == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->codigo_ter = "null"; 
                  $NM_val_null[] = "codigo_ter";
              } 
          }
          $this->es_cajero_before_qstr = $this->es_cajero;
          $this->es_cajero = substr($this->Db->qstr($this->es_cajero), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->es_cajero == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->es_cajero = "null"; 
                  $NM_val_null[] = "es_cajero";
              } 
          }
          $this->autorizado_before_qstr = $this->autorizado;
          $this->autorizado = substr($this->Db->qstr($this->autorizado), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->autorizado == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->autorizado = "null"; 
                  $NM_val_null[] = "autorizado";
              } 
          }
          if ($this->nmgp_opcao == "alterar") 
          {
          ...
          $this->disponible_before_qstr = $this->disponible;
          $this->disponible = substr($this->Db->qstr($this->disponible), 1, -1); 
          if ($this->disponible == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->disponible = "null"; 
              $NM_val_null[] = "disponible";
          } 
          $this->n_pedido_tmp_before_qstr = $this->n_pedido_tmp;
          $this->n_pedido_tmp = substr($this->Db->qstr($this->n_pedido_tmp), 1, -1); 
          if ($this->n_pedido_tmp == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->n_pedido_tmp = "null"; 
              $NM_val_null[] = "n_pedido_tmp";
          } 
          $this->obs_pedido_tmp_before_qstr = $this->obs_pedido_tmp;
          $this->obs_pedido_tmp = substr($this->Db->qstr($this->obs_pedido_tmp), 1, -1); 
          if ($this->obs_pedido_tmp == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->obs_pedido_tmp = "null"; 
              $NM_val_null[] = "obs_pedido_tmp";
          } 
          $this->vend_pedido_tmp_before_qstr = $this->vend_pedido_tmp;
          $this->vend_pedido_tmp = substr($this->Db->qstr($this->vend_pedido_tmp), 1, -1); 
          if ($this->vend_pedido_tmp == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->vend_pedido_tmp = "null"; 
              $NM_val_null[] = "vend_pedido_tmp";
          } 
          ...
          $this->lenguaje_before_qstr = $this->lenguaje;
          $this->lenguaje = substr($this->Db->qstr($this->lenguaje), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->lenguaje == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->lenguaje = "null"; 
                  $NM_val_null[] = "lenguaje";
              } 
          }
          $this->nombre_comercil_before_qstr = $this->nombre_comercil;
          $this->nombre_comercil = substr($this->Db->qstr($this->nombre_comercil), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->nombre_comercil == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->nombre_comercil = "null"; 
                  $NM_val_null[] = "nombre_comercil";
              } 
          }
          $this->notificar_before_qstr = $this->notificar;
          $this->notificar = substr($this->Db->qstr($this->notificar), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->notificar == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->notificar = "null"; 
                  $NM_val_null[] = "notificar";
              } 
          }
          $this->puc_auxiliar_deudores_before_qstr = $this->puc_auxiliar_deudores;
          $this->puc_auxiliar_deudores = substr($this->Db->qstr($this->puc_auxiliar_deudores), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->puc_auxiliar_deudores == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->puc_auxiliar_deudores = "null"; 
                  $NM_val_null[] = "puc_auxiliar_deudores";
              } 
          }
          $this->puc_retefuente_ventas_before_qstr = $this->puc_retefuente_ventas;
          $this->puc_retefuente_ventas = substr($this->Db->qstr($this->puc_retefuente_ventas), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->puc_retefuente_ventas == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->puc_retefuente_ventas = "null"; 
                  $NM_val_null[] = "puc_retefuente_ventas";
              } 
          }
          $this->puc_retefuente_servicios_clie_before_qstr = $this->puc_retefuente_servicios_clie;
          $this->puc_retefuente_servicios_clie = substr($this->Db->qstr($this->puc_retefuente_servicios_clie), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->puc_retefuente_servicios_clie == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->puc_retefuente_servicios_clie = "null"; 
                  $NM_val_null[] = "puc_retefuente_servicios_clie";
              } 
          }
          $this->puc_auxiliar_proveedores_before_qstr = $this->puc_auxiliar_proveedores;
          $this->puc_auxiliar_proveedores = substr($this->Db->qstr($this->puc_auxiliar_proveedores), 1, -1); 
          if ($this->puc_auxiliar_proveedores == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->puc_auxiliar_proveedores = "null"; 
              $NM_val_null[] = "puc_auxiliar_proveedores";
          } 
          $this->puc_retefuente_compras_before_qstr = $this->puc_retefuente_compras;
          $this->puc_retefuente_compras = substr($this->Db->qstr($this->puc_retefuente_compras), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->puc_retefuente_compras == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->puc_retefuente_compras = "null"; 
                  $NM_val_null[] = "puc_retefuente_compras";
              } 
          }
          $this->puc_retefuente_servicios_prov_before_qstr = $this->puc_retefuente_servicios_prov;
          $this->puc_retefuente_servicios_prov = substr($this->Db->qstr($this->puc_retefuente_servicios_prov), 1, -1); 
          if ($this->nmgp_opcao == "alterar") 
          {
              if ($this->puc_retefuente_servicios_prov == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
              { 
                  $this->puc_retefuente_servicios_prov = "null"; 
                  $NM_val_null[] = "puc_retefuente_servicios_prov";
              } 
          }
          ...
          $this->es_tecnico_before_qstr = $this->es_tecnico;
          $this->es_tecnico = substr($this->Db->qstr($this->es_tecnico), 1, -1); 
          if ($this->es_tecnico == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->es_tecnico = "null"; 
              $NM_val_null[] = "es_tecnico";
          } 
          $this->codigo_tercero_before_qstr = $this->codigo_tercero;
          $this->codigo_tercero = substr($this->Db->qstr($this->codigo_tercero), 1, -1); 
          if ($this->codigo_tercero == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->codigo_tercero = "null"; 
              $NM_val_null[] = "codigo_tercero";
          } 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          $aUpdateOk = array();
              ...
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_ukey'] . " No Documento"); 
                  $this->nmgp_opcao = "nada"; 
                  $aUpdateOk[] = 'documento';
                  $rsUni->Close();
              }
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "documento = '$this->documento', nombres = '$this->nombres', direccion = '$this->direccion', tel_cel = '$this->tel_cel', sexo = '$this->sexo', urlmail = '$this->urlmail', idmuni = $this->idmuni, observaciones = '$this->observaciones', regimen = '$this->regimen', tipo = '$this->tipo', tipo_documento = '$this->tipo_documento', dv = $this->dv, nombre1 = '$this->nombre1', nombre2 = '$this->nombre2', apellido1 = '$this->apellido1', apellido2 = '$this->apellido2', representante = '$this->representante', es_restaurante = '$this->es_restaurante', codigo_postal = '$this->codigo_postal', lenguaje = '$this->lenguaje', nombre_comercil = '$this->nombre_comercil', notificar = '$this->notificar', codigo_tercero = '$this->codigo_tercero'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['credito']) && $NM_val_form['credito'] != $this->nmgp_dados_select['credito']) 
              { 
                  $SC_fields_update[] = "credito = '$this->credito'"; 
              } 
              if (isset($NM_val_form['cupo']) && $NM_val_form['cupo'] != $this->nmgp_dados_select['cupo']) 
              { 
                  $SC_fields_update[] = "cupo = $this->cupo"; 
              } 
              ...
              if (isset($NM_val_form['loatiende']) && $NM_val_form['loatiende'] != $this->nmgp_dados_select['loatiende']) 
              { 
                  $SC_fields_update[] = "loatiende = $this->loatiende"; 
              } 
              ...
              if (isset($NM_val_form['dias_credito']) && $NM_val_form['dias_credito'] != $this->nmgp_dados_select['dias_credito']) 
              { 
                  $SC_fields_update[] = "dias_credito = $this->dias_credito"; 
              } 
              if (isset($NM_val_form['dias_mora']) && $NM_val_form['dias_mora'] != $this->nmgp_dados_select['dias_mora']) 
              { 
                  $SC_fields_update[] = "dias_mora = $this->dias_mora"; 
              } 
              if (isset($NM_val_form['cupo_vendedor']) && $NM_val_form['cupo_vendedor'] != $this->nmgp_dados_select['cupo_vendedor']) 
              { 
                  $SC_fields_update[] = "cupo_vendedor = $this->cupo_vendedor"; 
              } 
              if (isset($NM_val_form['codigo_ter']) && $NM_val_form['codigo_ter'] != $this->nmgp_dados_select['codigo_ter']) 
              { 
                  $SC_fields_update[] = "codigo_ter = '$this->codigo_ter'"; 
              } 
              if (isset($NM_val_form['es_cajero']) && $NM_val_form['es_cajero'] != $this->nmgp_dados_select['es_cajero']) 
              { 
                  $SC_fields_update[] = "es_cajero = '$this->es_cajero'"; 
              } 
              if (isset($NM_val_form['autorizado']) && $NM_val_form['autorizado'] != $this->nmgp_dados_select['autorizado']) 
              { 
                  $SC_fields_update[] = "autorizado = '$this->autorizado'"; 
              } 
              if (isset($NM_val_form['zona_clientes']) && $NM_val_form['zona_clientes'] != $this->nmgp_dados_select['zona_clientes']) 
              { 
                  $SC_fields_update[] = "zona_clientes = $this->zona_clientes"; 
              } 
              if (isset($NM_val_form['clasificacion_clientes']) && $NM_val_form['clasificacion_clientes'] != $this->nmgp_dados_select['clasificacion_clientes']) 
              { 
                  $SC_fields_update[] = "clasificacion_clientes = $this->clasificacion_clientes"; 
              } 
              if (isset($NM_val_form['puc_auxiliar_deudores']) && $NM_val_form['puc_auxiliar_deudores'] != $this->nmgp_dados_select['puc_auxiliar_deudores']) 
              { 
                  $SC_fields_update[] = "puc_auxiliar_deudores = '$this->puc_auxiliar_deudores'"; 
              } 
              if (isset($NM_val_form['puc_retefuente_ventas']) && $NM_val_form['puc_retefuente_ventas'] != $this->nmgp_dados_select['puc_retefuente_ventas']) 
              { 
                  $SC_fields_update[] = "puc_retefuente_ventas = '$this->puc_retefuente_ventas'"; 
              } 
              if (isset($NM_val_form['puc_retefuente_servicios_clie']) && $NM_val_form['puc_retefuente_servicios_clie'] != $this->nmgp_dados_select['puc_retefuente_servicios_clie']) 
              { 
                  $SC_fields_update[] = "puc_retefuente_servicios_clie = '$this->puc_retefuente_servicios_clie'"; 
              } 
              if (isset($NM_val_form['puc_retefuente_compras']) && $NM_val_form['puc_retefuente_compras'] != $this->nmgp_dados_select['puc_retefuente_compras']) 
              { 
                  $SC_fields_update[] = "puc_retefuente_compras = '$this->puc_retefuente_compras'"; 
              } 
              if (isset($NM_val_form['puc_retefuente_servicios_prov']) && $NM_val_form['puc_retefuente_servicios_prov'] != $this->nmgp_dados_select['puc_retefuente_servicios_prov']) 
              { 
                  $SC_fields_update[] = "puc_retefuente_servicios_prov = '$this->puc_retefuente_servicios_prov'"; 
              } 
              ...
              { 
                  $SC_fields_update[] = "latitude = '$this->latitude'"; 
              } 
              if (isset($NM_val_form['longitude']) && $NM_val_form['longitude'] != $this->nmgp_dados_select['longitude']) 
              { 
                  $SC_fields_update[] = "longitude = '$this->longitude'"; 
              } 
              if (isset($NM_val_form['activo']) && $NM_val_form['activo'] != $this->nmgp_dados_select['activo']) 
              { 
                  $SC_fields_update[] = "activo = '$this->activo'"; 
              } 
              if (isset($NM_val_form['es_tecnico']) && $NM_val_form['es_tecnico'] != $this->nmgp_dados_select['es_tecnico']) 
              { 
                  $SC_fields_update[] = "es_tecnico = '$this->es_tecnico'"; 
              } 
              $aDoNotUpdate = array();
              $temp_cmd_sql = "";
              ...
              $this->codigo_ter = $this->codigo_ter_before_qstr;
              $this->es_cajero = $this->es_cajero_before_qstr;
              $this->autorizado = $this->autorizado_before_qstr;
              $this->disponible = $this->disponible_before_qstr;
              $this->n_pedido_tmp = $this->n_pedido_tmp_before_qstr;
              $this->obs_pedido_tmp = $this->obs_pedido_tmp_before_qstr;
              $this->vend_pedido_tmp = $this->vend_pedido_tmp_before_qstr;
              $this->ciudad = $this->ciudad_before_qstr;
              $this->codigo_postal = $this->codigo_postal_before_qstr;
              $this->lenguaje = $this->lenguaje_before_qstr;
              $this->nombre_comercil = $this->nombre_comercil_before_qstr;
              $this->notificar = $this->notificar_before_qstr;
              $this->puc_auxiliar_deudores = $this->puc_auxiliar_deudores_before_qstr;
              $this->puc_retefuente_ventas = $this->puc_retefuente_ventas_before_qstr;
              $this->puc_retefuente_servicios_clie = $this->puc_retefuente_servicios_clie_before_qstr;
              $this->puc_auxiliar_proveedores = $this->puc_auxiliar_proveedores_before_qstr;
              $this->puc_retefuente_compras = $this->puc_retefuente_compras_before_qstr;
              $this->puc_retefuente_servicios_prov = $this->puc_retefuente_servicios_prov_before_qstr;
              ...
              $this->es_tecnico = $this->es_tecnico_before_qstr;
              $this->codigo_tercero = $this->codigo_tercero_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['imagenter_salva'] = array(
                      'row'     => '',
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['lenguaje'])) { $this->lenguaje = $NM_val_form['lenguaje']; }
              elseif (isset($this->lenguaje)) { $this->nm_limpa_alfa($this->lenguaje); }
              if     (isset($NM_val_form) && isset($NM_val_form['nombre_comercil'])) { $this->nombre_comercil = $NM_val_form['nombre_comercil']; }
              elseif (isset($this->nombre_comercil)) { $this->nm_limpa_alfa($this->nombre_comercil); }
              if     (isset($NM_val_form) && isset($NM_val_form['notificar'])) { $this->notificar = $NM_val_form['notificar']; }
              elseif (isset($this->notificar)) { $this->nm_limpa_alfa($this->notificar); }
              if     (isset($NM_val_form) && isset($NM_val_form['codigo_tercero'])) { $this->codigo_tercero = $NM_val_form['codigo_tercero']; }
              elseif (isset($this->codigo_tercero)) { $this->nm_limpa_alfa($this->codigo_tercero); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('imagenter', 'tipo_documento', 'documento', 'dv', 'tipo', 'regimen', 'nombres', 'direccion', 'codigo_tercero', 'sexo', 'notificar', 'nombre1', 'nombre2', 'apellido1', 'apellido2', 'tel_cel', 'urlmail', 'idtercero', 'nombre_comercil', 'representante', 'departamento', 'idmuni', 'ciudad', 'codigo_postal', 'observaciones', 'lenguaje', 'es_restaurante', 'r_social'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          $aInsertOk = array(); 
              ...
              elseif (0 < $rsUni->fields[0])
              {
                  $this->Erro->mensagem (__FILE__, __LINE__, "critica", $this->Ini->Nm_lang['lang_errm_inst_uniq'] . " No Documento"); 
                  $this->nmgp_opcao = "nada"; 
                  $GLOBALS["erro_incl"] = 1; 
                  $aInsertOk[] = 'documento';
                  $rsUni->Close();
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              { 
                  ...
                  if ($this->documento != "")
                  { 
                       $compl_insert     .= ", documento";
                       $compl_insert_val .= ", '$this->documento'";
                  } 
                  if ($this->nombres != "")
                  { 
                       $compl_insert     .= ", nombres";
                       $compl_insert_val .= ", '$this->nombres'";
                  } 
                  if ($this->direccion != "")
                  { 
                       $compl_insert     .= ", direccion";
                       $compl_insert_val .= ", '$this->direccion'";
                  } 
                  if ($this->tel_cel != "")
                  { 
                       $compl_insert     .= ", tel_cel";
                       $compl_insert_val .= ", '$this->tel_cel'";
                  } 
                  if ($this->nacimiento != "")
                  { 
                       $compl_insert     .= ", nacimiento";
                       $compl_insert_val .= ", #$this->nacimiento#";
                  } 
                  if ($this->sexo != "")
                  { 
                       $compl_insert     .= ", sexo";
                       $compl_insert_val .= ", '$this->sexo'";
                  } 
                  if ($this->urlmail != "")
                  { 
                       $compl_insert     .= ", urlmail";
                       $compl_insert_val .= ", '$this->urlmail'";
                  } 
                  if ($this->fechault != "")
                  { 
                       $compl_insert     .= ", fechault";
                       $compl_insert_val .= ", #$this->fechault#";
                  } 
                  if ($this->afiliacion != "")
                  { 
                       $compl_insert     .= ", afiliacion";
                       $compl_insert_val .= ", #$this->afiliacion#";
                  } 
                  if ($this->idmuni != "")
                  { 
                       $compl_insert     .= ", idmuni";
                       $compl_insert_val .= ", $this->idmuni";
                  } 
                  if ($this->observaciones != "")
                  { 
                       $compl_insert     .= ", observaciones";
                       $compl_insert_val .= ", '$this->observaciones'";
                  } 
                  if ($this->credito != "")
                  { 
                  ...
                  { 
                       $compl_insert     .= ", cupo";
                       $compl_insert_val .= ", $this->cupo";
                  } 
                  if ($this->listaprecios != "")
                  { 
                       $compl_insert     .= ", listaprecios";
                       $compl_insert_val .= ", $this->listaprecios";
                  } 
                  if ($this->loatiende != "")
                  { 
                       $compl_insert     .= ", loatiende";
                       $compl_insert_val .= ", $this->loatiende";
                  } 
                  if ($this->efec_retencion != "")
                  { 
                       $compl_insert     .= ", efec_retencion";
                       $compl_insert_val .= ", '$this->efec_retencion'";
                  } 
                  if ($this->regimen != "")
                  { 
                       $compl_insert     .= ", regimen";
                       $compl_insert_val .= ", '$this->regimen'";
                  } 
                  if ($this->tipo != "")
                  { 
                       $compl_insert     .= ", tipo";
                  ...
                  if ($this->cliente != "")
                  { 
                       $compl_insert     .= ", cliente";
                       $compl_insert_val .= ", '$this->cliente'";
                  } 
                  if ($this->empleado != "")
                  { 
                       $compl_insert     .= ", empleado";
                       $compl_insert_val .= ", '$this->empleado'";
                  } 
                  if ($this->proveedor != "")
                  { 
                       $compl_insert     .= ", proveedor";
                       $compl_insert_val .= ", '$this->proveedor'";
                  } 
                  if ($this->contacto != "")
                  { 
                       $compl_insert     .= ", contacto";
                       $compl_insert_val .= ", '$this->contacto'";
                  } 
                  if ($this->telefonos_prov != "")
                  { 
                       $compl_insert     .= ", telefonos_prov";
                       $compl_insert_val .= ", '$this->telefonos_prov'";
                  } 
                  if ($this->email != "")
                  { 
                       $compl_insert     .= ", email";
                       $compl_insert_val .= ", '$this->email'";
                  } 
                  if ($this->url != "")
                  { 
                       $compl_insert     .= ", url";
                       $compl_insert_val .= ", '$this->url'";
                  } 
                  if ($this->creditoprov != "")
                  { 
                       $compl_insert     .= ", creditoprov";
                       $compl_insert_val .= ", '$this->creditoprov'";
                  } 
                  if ($this->dias != "")
                  { 
                       $compl_insert     .= ", dias";
                       $compl_insert_val .= ", $this->dias";
                  } 
                  if ($this->fechultcomp != "")
                  { 
                       $compl_insert     .= ", fechultcomp";
                       $compl_insert_val .= ", #$this->fechultcomp#";
                  } 
                  if ($this->saldoapagar != "")
                  { 
                       $compl_insert     .= ", saldoapagar";
                       $compl_insert_val .= ", $this->saldoapagar";
                  } 
                  if ($this->autoretenedor != "")
                  { 
                       $compl_insert     .= ", autoretenedor";
                       $compl_insert_val .= ", '$this->autoretenedor'";
                  } 
                  if ($this->tipo_documento != "")
                  { 
                       $compl_insert     .= ", tipo_documento";
                       $compl_insert_val .= ", '$this->tipo_documento'";
                  } 
                  if ($this->dv != "")
                  { 
                       $compl_insert     .= ", dv";
                       $compl_insert_val .= ", $this->dv";
                  } 
                  if ($this->nombre1 != "")
                  { 
                       $compl_insert     .= ", nombre1";
                       $compl_insert_val .= ", '$this->nombre1'";
                  } 
                  if ($this->nombre2 != "")
                  { 
                       $compl_insert     .= ", nombre2";
                       $compl_insert_val .= ", '$this->nombre2'";
                  } 
                  if ($this->apellido1 != "")
                  { 
                       $compl_insert     .= ", apellido1";
                       $compl_insert_val .= ", '$this->apellido1'";
                  } 
                  if ($this->apellido2 != "")
                  { 
                       $compl_insert     .= ", apellido2";
                       $compl_insert_val .= ", '$this->apellido2'";
                  } 
                  if ($this->sucur_cliente != "")
                  { 
                       $compl_insert     .= ", sucur_cliente";
                       $compl_insert_val .= ", '$this->sucur_cliente'";
                  } 
                  if ($this->representante != "")
                  { 
                       $compl_insert     .= ", representante";
                       $compl_insert_val .= ", '$this->representante'";
                  } 
                  if ($this->imagenter != "")
                  { 
                       $compl_insert     .= ", imagenter";
                       $compl_insert_val .= ", '$this->imagenter'";
                  } 
                  if ($this->es_restaurante != "")
                  { 
                       $compl_insert     .= ", es_restaurante";
                       $compl_insert_val .= ", '$this->es_restaurante'";
                  } 
                  if ($this->dias_credito != "")
                  { 
                       $compl_insert     .= ", dias_credito";
                       $compl_insert_val .= ", $this->dias_credito";
                  } 
                  if ($this->dias_mora != "")
                  { 
                       $compl_insert     .= ", dias_mora";
                       $compl_insert_val .= ", $this->dias_mora";
                  } 
                  if ($this->cupo_vendedor != "")
                  { 
                       $compl_insert     .= ", cupo_vendedor";
                       $compl_insert_val .= ", $this->cupo_vendedor";
                  } 
                  if ($this->codigo_ter != "")
                  { 
                       $compl_insert     .= ", codigo_ter";
                       $compl_insert_val .= ", '$this->codigo_ter'";
                  } 
                  if ($this->es_cajero != "")
                  { 
                       $compl_insert     .= ", es_cajero";
                       $compl_insert_val .= ", '$this->es_cajero'";
                  } 
                  if ($this->autorizado != "")
                  { 
                       $compl_insert     .= ", autorizado";
                       $compl_insert_val .= ", '$this->autorizado'";
                  } 
                  if ($this->zona_clientes != "")
                  { 
                       $compl_insert     .= ", zona_clientes";
                       $compl_insert_val .= ", $this->zona_clientes";
                  } 
                  if ($this->clasificacion_clientes != "")
                  { 
                       $compl_insert     .= ", clasificacion_clientes";
                       $compl_insert_val .= ", $this->clasificacion_clientes";
                  } 
                  if ($this->codigo_postal != "")
                  { 
                       $compl_insert     .= ", codigo_postal";
                       $compl_insert_val .= ", '$this->codigo_postal'";
                  } 
                  if ($this->lenguaje != "")
                  { 
                       $compl_insert     .= ", lenguaje";
                       $compl_insert_val .= ", '$this->lenguaje'";
                  } 
                  if ($this->nombre_comercil != "")
                  { 
                       $compl_insert     .= ", nombre_comercil";
                       $compl_insert_val .= ", '$this->nombre_comercil'";
                  } 
                  if ($this->notificar != "")
                  { 
                       $compl_insert     .= ", notificar";
                       $compl_insert_val .= ", '$this->notificar'";
                  } 
                  if ($this->puc_auxiliar_deudores != "")
                  { 
                       $compl_insert     .= ", puc_auxiliar_deudores";
                       $compl_insert_val .= ", '$this->puc_auxiliar_deudores'";
                  } 
                  if ($this->puc_retefuente_ventas != "")
                  { 
                       $compl_insert     .= ", puc_retefuente_ventas";
                       $compl_insert_val .= ", '$this->puc_retefuente_ventas'";
                  } 
                  if ($this->puc_retefuente_servicios_clie != "")
                  { 
                       $compl_insert     .= ", puc_retefuente_servicios_clie";
                       $compl_insert_val .= ", '$this->puc_retefuente_servicios_clie'";
                  } 
                  if ($this->puc_retefuente_compras != "")
                  { 
                       $compl_insert     .= ", puc_retefuente_compras";
                       $compl_insert_val .= ", '$this->puc_retefuente_compras'";
                  } 
                  if ($this->puc_retefuente_servicios_prov != "")
                  { 
                       $compl_insert     .= ", puc_retefuente_servicios_prov";
                       $compl_insert_val .= ", '$this->puc_retefuente_servicios_prov'";
                  } 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (nube, latitude, longitude, activo, es_tecnico, codigo_tercero $compl_insert) VALUES ('$this->nube', '$this->latitude', '$this->longitude', '$this->activo', '$this->es_tecnico', '$this->codigo_tercero' $compl_insert_val)"; 
              }
              ...
              { 
                  ...
                  { 
                       $compl_insert     .= ", nacimiento";
                       $compl_insert_val .= ", " . $this->Ini->date_delim . $this->nacimiento . $this->Ini->date_delim1 . "";
                  } 
                  if ($this->sexo != "")
                  { 
                       $compl_insert     .= ", sexo";
                  ...
                  { 
                       $compl_insert     .= ", fechault";
                       $compl_insert_val .= ", " . $this->Ini->date_delim . $this->fechault . $this->Ini->date_delim1 . "";
                  } 
                  if ($this->afiliacion != "")
                  { 
                       $compl_insert     .= ", afiliacion";
                       $compl_insert_val .= ", " . $this->Ini->date_delim . $this->afiliacion . $this->Ini->date_delim1 . "";
                  } 
                  if ($this->idmuni != "")
                  { 
                       $compl_insert     .= ", idmuni";
                  ...
                  { 
                       $compl_insert     .= ", fechultcomp";
                       $compl_insert_val .= ", " . $this->Ini->date_delim . $this->fechultcomp . $this->Ini->date_delim1 . "";
                  } 
                  if ($this->saldoapagar != "")
                  { 
                       $compl_insert     .= ", saldoapagar";
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "nube, latitude, longitude, activo, es_tecnico, codigo_tercero $compl_insert) VALUES (" . $NM_seq_auto . "'$this->nube', '$this->latitude', '$this->longitude', '$this->activo', '$this->es_tecnico', '$this->codigo_tercero' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $compl_insert     = ""; 
                  ...
                  { 
                       $compl_insert     .= ", nacimiento";
                       $compl_insert_val .= ", EXTEND('$this->nacimiento', YEAR TO DAY)";
                  } 
                  if ($this->sexo != "")
                  { 
                       $compl_insert     .= ", sexo";
                  ...
                  { 
                       $compl_insert     .= ", fechault";
                       $compl_insert_val .= ", EXTEND('$this->fechault', YEAR TO DAY)";
                  } 
                  if ($this->afiliacion != "")
                  { 
                       $compl_insert     .= ", afiliacion";
                       $compl_insert_val .= ", EXTEND('$this->afiliacion', YEAR TO DAY)";
                  } 
                  if ($this->idmuni != "")
                  { 
                       $compl_insert     .= ", idmuni";
                  ...
                  { 
                       $compl_insert     .= ", fechultcomp";
                       $compl_insert_val .= ", EXTEND('$this->fechultcomp', YEAR TO DAY)";
                  } 
                  if ($this->saldoapagar != "")
                  { 
                       $compl_insert     .= ", saldoapagar";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_clientes_mini_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['parms'] = "idtercero?#?$this->idtercero?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_clientes_mini_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total'] = $qt_geral_reg_form_clientes_mini_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idtercero))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_clientes_mini_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] > $qt_geral_reg_form_clientes_mini_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] = $qt_geral_reg_form_clientes_mini_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start']) ;  
              } 
          } 
          ...
          { 
              ...
              $this->dias_credito = $rs->fields[43] ; 
              $this->nmgp_dados_select['dias_credito'] = $this->dias_credito;
              $this->dias_mora = $rs->fields[44] ; 
              $this->nmgp_dados_select['dias_mora'] = $this->dias_mora;
              $this->cupo_vendedor = trim($rs->fields[45]) ; 
              $this->nmgp_dados_select['cupo_vendedor'] = $this->cupo_vendedor;
              $this->codigo_ter = $rs->fields[46] ; 
              $this->nmgp_dados_select['codigo_ter'] = $this->codigo_ter;
              $this->es_cajero = $rs->fields[47] ; 
              $this->nmgp_dados_select['es_cajero'] = $this->es_cajero;
              $this->autorizado = $rs->fields[48] ; 
              $this->nmgp_dados_select['autorizado'] = $this->autorizado;
              $this->zona_clientes = $rs->fields[49] ; 
              $this->nmgp_dados_select['zona_clientes'] = $this->zona_clientes;
              $this->clasificacion_clientes = $rs->fields[50] ; 
              $this->nmgp_dados_select['clasificacion_clientes'] = $this->clasificacion_clientes;
              $this->creado = $rs->fields[51] ; 
              ...
              $this->disponible = $rs->fields[52] ; 
              $this->nmgp_dados_select['disponible'] = $this->disponible;
              $this->id_pedido_tmp = $rs->fields[53] ; 
              $this->nmgp_dados_select['id_pedido_tmp'] = $this->id_pedido_tmp;
              $this->n_pedido_tmp = $rs->fields[54] ; 
              $this->nmgp_dados_select['n_pedido_tmp'] = $this->n_pedido_tmp;
              $this->total_pedido_tmp = trim($rs->fields[55]) ; 
              $this->nmgp_dados_select['total_pedido_tmp'] = $this->total_pedido_tmp;
              $this->obs_pedido_tmp = $rs->fields[56] ; 
              $this->nmgp_dados_select['obs_pedido_tmp'] = $this->obs_pedido_tmp;
              $this->vend_pedido_tmp = $rs->fields[57] ; 
              $this->nmgp_dados_select['vend_pedido_tmp'] = $this->vend_pedido_tmp;
              $this->ciudad = $rs->fields[58] ; 
              $this->nmgp_dados_select['ciudad'] = $this->ciudad;
              $this->codigo_postal = $rs->fields[59] ; 
              $this->nmgp_dados_select['codigo_postal'] = $this->codigo_postal;
              $this->lenguaje = $rs->fields[60] ; 
              $this->nmgp_dados_select['lenguaje'] = $this->lenguaje;
              $this->nombre_comercil = $rs->fields[61] ; 
              $this->nmgp_dados_select['nombre_comercil'] = $this->nombre_comercil;
              $this->notificar = $rs->fields[62] ; 
              $this->nmgp_dados_select['notificar'] = $this->notificar;
              $this->puc_auxiliar_deudores = $rs->fields[63] ; 
              $this->nmgp_dados_select['puc_auxiliar_deudores'] = $this->puc_auxiliar_deudores;
              $this->puc_retefuente_ventas = $rs->fields[64] ; 
              $this->nmgp_dados_select['puc_retefuente_ventas'] = $this->puc_retefuente_ventas;
              $this->puc_retefuente_servicios_clie = $rs->fields[65] ; 
              $this->nmgp_dados_select['puc_retefuente_servicios_clie'] = $this->puc_retefuente_servicios_clie;
              $this->puc_auxiliar_proveedores = $rs->fields[66] ; 
              $this->nmgp_dados_select['puc_auxiliar_proveedores'] = $this->puc_auxiliar_proveedores;
              $this->puc_retefuente_compras = $rs->fields[67] ; 
              $this->nmgp_dados_select['puc_retefuente_compras'] = $this->puc_retefuente_compras;
              $this->puc_retefuente_servicios_prov = $rs->fields[68] ; 
              $this->nmgp_dados_select['puc_retefuente_servicios_prov'] = $this->puc_retefuente_servicios_prov;
              $this->nube = $rs->fields[69] ; 
              $this->nmgp_dados_select['nube'] = $this->nube;
              $this->latitude = $rs->fields[70] ; 
              $this->nmgp_dados_select['latitude'] = $this->latitude;
              $this->longitude = $rs->fields[71] ; 
              $this->nmgp_dados_select['longitude'] = $this->longitude;
              $this->activo = $rs->fields[72] ; 
              $this->nmgp_dados_select['activo'] = $this->activo;
              $this->es_tecnico = $rs->fields[73] ; 
              $this->nmgp_dados_select['es_tecnico'] = $this->es_tecnico;
              $this->codigo_tercero = $rs->fields[74] ; 
              $this->nmgp_dados_select['codigo_tercero'] = $this->codigo_tercero;
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              $this->nm_troca_decimal(",", ".");
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['parms'] = "idtercero?#?$this->idtercero?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['sub_dir'][0]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['reg_start'] < $qt_geral_reg_form_clientes_mini_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              $this->n_pedido_tmp = "";  
              $this->nmgp_dados_form["n_pedido_tmp"] = $this->n_pedido_tmp;
              $this->total_pedido_tmp = "";  
              $this->nmgp_dados_form["total_pedido_tmp"] = $this->total_pedido_tmp;
              $this->obs_pedido_tmp = "";  
              $this->nmgp_dados_form["obs_pedido_tmp"] = $this->obs_pedido_tmp;
              $this->vend_pedido_tmp = "";  
              $this->nmgp_dados_form["vend_pedido_tmp"] = $this->vend_pedido_tmp;
              $this->ciudad = "";  
              $this->nmgp_dados_form["ciudad"] = $this->ciudad;
              $this->codigo_postal = "";  
              $this->nmgp_dados_form["codigo_postal"] = $this->codigo_postal;
              $this->lenguaje = "Español, Castellano";  
              $this->nmgp_dados_form["lenguaje"] = $this->lenguaje;
              $this->nombre_comercil = "";  
              $this->nmgp_dados_form["nombre_comercil"] = $this->nombre_comercil;
              $this->notificar = "";  
              $this->nmgp_dados_form["notificar"] = $this->notificar;
              $this->puc_auxiliar_deudores = "";  
              $this->nmgp_dados_form["puc_auxiliar_deudores"] = $this->puc_auxiliar_deudores;
              $this->puc_retefuente_ventas = "";  
              $this->nmgp_dados_form["puc_retefuente_ventas"] = $this->puc_retefuente_ventas;
              $this->puc_retefuente_servicios_clie = "";  
              $this->nmgp_dados_form["puc_retefuente_servicios_clie"] = $this->puc_retefuente_servicios_clie;
              $this->puc_auxiliar_proveedores = "";  
              $this->nmgp_dados_form["puc_auxiliar_proveedores"] = $this->puc_auxiliar_proveedores;
              $this->puc_retefuente_compras = "";  
              $this->nmgp_dados_form["puc_retefuente_compras"] = $this->puc_retefuente_compras;
              $this->puc_retefuente_servicios_prov = "";  
              $this->nmgp_dados_form["puc_retefuente_servicios_prov"] = $this->puc_retefuente_servicios_prov;
              $this->nube = "";  
              $this->nmgp_dados_form["nube"] = $this->nube;
              $this->latitude = "";  
              ...
              $this->departamento = "";  
              $this->nmgp_dados_form["departamento"] = $this->departamento;
              $this->detalle_tributario = "";  
              $this->nmgp_dados_form["detalle_tributario"] = $this->detalle_tributario;
              $this->relleno2 = "";  
              $this->nmgp_dados_form["relleno2"] = $this->relleno2;
              $this->responsabilidad_fiscal = "";  
              $this->nmgp_dados_form["responsabilidad_fiscal"] = $this->responsabilidad_fiscal;
              $this->sucursales = "";  
              $this->nmgp_dados_form["sucursales"] = $this->sucursales;
              $this->r_social = "";  
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_select'];
                  ...
                  $this->tel_cel = $this->nmgp_dados_select['tel_cel'];  
                  $this->nacimiento = $this->nmgp_dados_select['nacimiento'];  
                  $this->sexo = $this->nmgp_dados_select['sexo'];  
                  $this->urlmail = $this->nmgp_dados_select['urlmail'];  
                  $this->fechault = $this->nmgp_dados_select['fechault'];  
                  $this->saldo = $this->nmgp_dados_select['saldo'];  
                  $this->afiliacion = $this->nmgp_dados_select['afiliacion'];  
                  $this->idmuni = $this->nmgp_dados_select['idmuni'];  
                  $this->observaciones = $this->nmgp_dados_select['observaciones'];  
                  $this->credito = $this->nmgp_dados_select['credito'];  
                  $this->cupo = $this->nmgp_dados_select['cupo'];  
                  $this->listaprecios = $this->nmgp_dados_select['listaprecios'];  
                  $this->loatiende = $this->nmgp_dados_select['loatiende'];  
                  $this->con_actual = $this->nmgp_dados_select['con_actual'];  
                  $this->efec_retencion = $this->nmgp_dados_select['efec_retencion'];  
                  ...
                  $this->contacto = $this->nmgp_dados_select['contacto'];  
                  $this->telefonos_prov = $this->nmgp_dados_select['telefonos_prov'];  
                  $this->email = $this->nmgp_dados_select['email'];  
                  $this->url = $this->nmgp_dados_select['url'];  
                  $this->creditoprov = $this->nmgp_dados_select['creditoprov'];  
                  $this->dias = $this->nmgp_dados_select['dias'];  
                  $this->fechultcomp = $this->nmgp_dados_select['fechultcomp'];  
                  $this->saldoapagar = $this->nmgp_dados_select['saldoapagar'];  
                  $this->autoretenedor = $this->nmgp_dados_select['autoretenedor'];  
                  $this->tipo_documento = $this->nmgp_dados_select['tipo_documento'];  
                  $this->dv = $this->nmgp_dados_select['dv'];  
                  $this->nombre1 = $this->nmgp_dados_select['nombre1'];  
                  $this->nombre2 = $this->nmgp_dados_select['nombre2'];  
                  $this->apellido1 = $this->nmgp_dados_select['apellido1'];  
                  $this->apellido2 = $this->nmgp_dados_select['apellido2'];  
                  $this->sucur_cliente = $this->nmgp_dados_select['sucur_cliente'];  
                  $this->representante = $this->nmgp_dados_select['representante'];  
                  $this->imagenter = $this->nmgp_dados_select['imagenter'];  
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dados_clone']['imagenter'] = $this->nmgp_dados_select['imagenter'];  
                  $this->es_restaurante = $this->nmgp_dados_select['es_restaurante'];  
                  $this->dias_credito = $this->nmgp_dados_select['dias_credito'];  
                  $this->dias_mora = $this->nmgp_dados_select['dias_mora'];  
                  $this->cupo_vendedor = $this->nmgp_dados_select['cupo_vendedor'];  
                  $this->codigo_ter = $this->nmgp_dados_select['codigo_ter'];  
                  $this->es_cajero = $this->nmgp_dados_select['es_cajero'];  
                  $this->autorizado = $this->nmgp_dados_select['autorizado'];  
                  $this->zona_clientes = $this->nmgp_dados_select['zona_clientes'];  
                  $this->clasificacion_clientes = $this->nmgp_dados_select['clasificacion_clientes'];  
                  $this->creado = $this->nmgp_dados_select['creado'];  
                  $this->disponible = $this->nmgp_dados_select['disponible'];  
                  $this->id_pedido_tmp = $this->nmgp_dados_select['id_pedido_tmp'];  
                  $this->n_pedido_tmp = $this->nmgp_dados_select['n_pedido_tmp'];  
                  $this->total_pedido_tmp = $this->nmgp_dados_select['total_pedido_tmp'];  
                  $this->obs_pedido_tmp = $this->nmgp_dados_select['obs_pedido_tmp'];  
                  $this->vend_pedido_tmp = $this->nmgp_dados_select['vend_pedido_tmp'];  
                  $this->ciudad = $this->nmgp_dados_select['ciudad'];  
                  $this->codigo_postal = $this->nmgp_dados_select['codigo_postal'];  
                  $this->lenguaje = $this->nmgp_dados_select['lenguaje'];  
                  $this->nombre_comercil = $this->nmgp_dados_select['nombre_comercil'];  
                  $this->notificar = $this->nmgp_dados_select['notificar'];  
                  $this->puc_auxiliar_deudores = $this->nmgp_dados_select['puc_auxiliar_deudores'];  
                  $this->puc_retefuente_ventas = $this->nmgp_dados_select['puc_retefuente_ventas'];  
                  $this->puc_retefuente_servicios_clie = $this->nmgp_dados_select['puc_retefuente_servicios_clie'];  
                  $this->puc_auxiliar_proveedores = $this->nmgp_dados_select['puc_auxiliar_proveedores'];  
                  $this->puc_retefuente_compras = $this->nmgp_dados_select['puc_retefuente_compras'];  
                  $this->puc_retefuente_servicios_prov = $this->nmgp_dados_select['puc_retefuente_servicios_prov'];  
                  ...
                  $this->es_tecnico = $this->nmgp_dados_select['es_tecnico'];  
                  $this->codigo_tercero = $this->nmgp_dados_select['codigo_tercero'];  
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idtercero) from " . $this->Ini->nm_tabela . " where idtercero < $this->idtercero" . $str_where_filter; 
         $rs = $this->Db->Execute("select max(idtercero) from " . $this->Ini->nm_tabela . " where idtercero < $this->idtercero" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idtercero) from " . $this->Ini->nm_tabela . " where idtercero < $this->idtercero" . $str_where_filter; 
     ...
     { 
         $this->idtercero = substr($this->Db->qstr($rs->fields[0]), 1, -1); 
         $rs->Close();  
         $this->nmgp_opcao = "igual";  
         return ;  
     } 
...
//-- 
   ...
   {  
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idtercero) from " . $this->Ini->nm_tabela . " where idtercero > $this->idtercero" . $str_where_filter; 
         $rs = $this->Db->Execute("select min(idtercero) from " . $this->Ini->nm_tabela . " where idtercero > $this->idtercero" . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idtercero) from " . $this->Ini->nm_tabela . " where idtercero > $this->idtercero" . $str_where_filter; 
...
//-- 
   ...
   {   
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idtercero) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select min(idtercero) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select min(idtercero) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
...
//-- 
   ...
   { 
     ...
     if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idtercero) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
         $rs = $this->Db->Execute("select max(idtercero) from " . $this->Ini->nm_tabela . " " . $str_where_filter); 
     }  
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     {
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = "select max(idtercero) from " . $this->Ini->nm_tabela . " " . $str_where_filter; 
     ...
     return ;  
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$this->sc_temp_id_tercero=$this->idtercero ;
if($this->sc_temp_id_tercero>0)
	{
	$escliente=$this->cliente ;
	if($escliente=='SI')
		{
		$this->credito ='NO';
		$this->cupodis =0;
		...
		$this->nmgp_cmp_hidden["cupodis"] = "on"; $this->NM_ajax_info['fieldDisplay']['cupodis'] = 'on';
		$this->nmgp_cmp_hidden["cupo"] = "on"; $this->NM_ajax_info['fieldDisplay']['cupo'] = 'on';
		$this->sc_ajax_javascript('nm_field_disabled', array("cupodis=disabled;cupo=disabled", ""));
;
		$this->nmgp_cmp_hidden["faccredito"] = "on"; $this->NM_ajax_info['fieldDisplay']['faccredito'] = 'on';
		$this->nmgp_cmp_hidden["efec_retencion"] = "on"; $this->NM_ajax_info['fieldDisplay']['efec_retencion'] = 'on';
		$this->nmgp_cmp_hidden["listaprecios"] = "on"; $this->NM_ajax_info['fieldDisplay']['listaprecios'] = 'on';
...
if (isset($this->sc_temp_id_tercero)) { $_SESSION['id_tercero'] = $this->sc_temp_id_tercero;}
$_SESSION['scriptcase']['form_clientes_mini_mob']['contr_erro'] = 'off';
$modificado_idtercero = $this->idtercero;
$this->nm_formatar_campos('idtercero');
if ($original_idtercero !== $modificado_idtercero || isset($this->nmgp_cmp_readonly['idtercero']) || (isset($bFlagRead_idtercero) && $bFlagRead_idtercero))
{
    $this->ajax_return_values_idtercero(true);
}
...
$this->nm_formatar_campos('tipo_documento', 'dv', 'documento');
...
function nombre_comercil_onChange()
{
$_SESSION['scriptcase']['form_clientes_mini_mob']['contr_erro'] = 'on';
  
$original_tipo = $this->tipo;
$original_nombres = $this->nombres;
$original_nombre_comercil = $this->nombre_comercil;

if($this->tipo <>'NAT')
{
	$this->nombres =$this->nombre_comercil ;
}

$modificado_tipo = $this->tipo;
$modificado_nombres = $this->nombres;
$modificado_nombre_comercil = $this->nombre_comercil;
$this->nm_formatar_campos('tipo', 'nombres', 'nombre_comercil');
...
if ($original_nombre_comercil !== $modificado_nombre_comercil || isset($this->nmgp_cmp_readonly['nombre_comercil']) || (isset($bFlagRead_nombre_comercil) && $bFlagRead_nombre_comercil))
{
    $this->ajax_return_values_nombre_comercil(true);
}
...
if($this->tipo =='NAT')
{
	if(isset($this->r_social ) and (!empty($this->r_social ) and $this->r_social <>' '))
		{
		if(isset($this->nombre2 )and (!empty($this->nombre2 ) and $this->nombre2 <>' '))
			{
			if(isset($this->apellido2 )and (!empty($this->apellido2 ) and $this->apellido2 <>' '))
				{
				$this->nombres =$this->r_social .'/'.$this->nombre1 .' '.$this->nombre2 .' '.$this->apellido1 .' '.$this->apellido2 ;
				}
			else
				{
				$this->nombres =$this->r_social .'/'.$this->nombre1 .' '.$this->nombre2 .' '.$this->apellido1 ;
				}
			}
		else
			{
			if(isset($this->apellido2 )and (!empty($this->apellido2 ) and $this->apellido2 <>' '))
				{
				$this->nombres =$this->r_social .'/'.$this->nombre1 .' '.$this->apellido1 .' '.$this->apellido2 ;
				}
			else
				{
				$this->nombres =$this->r_social .'/'.$this->nombre1 .' '.$this->apellido1 ;
				}
			}
		}
	...
	else
		{
			if(isset($this->nombre2 )and (!empty($this->nombre2 ) and $this->nombre2 <>' '))
				...
				if(isset($this->apellido2 )and (!empty($this->apellido2 ) and $this->apellido2 <>' '))
					{
					$this->nombres =$this->nombre1 .' '.$this->nombre2 .' '.$this->apellido1 .' '.$this->apellido2 ;
					}
				else
					{
					$this->nombres =$this->nombre1 .' '.$this->nombre2 .' '.$this->apellido1 ;
					}
				}
			else
				{
				if(isset($this->apellido2 )and (!empty($this->apellido2 ) and $this->apellido2 <>' '))
					{
					$this->nombres =$this->nombre1 .' '.$this->apellido1 .' '.$this->apellido2 ;
					}
				else
					{
					$this->nombres =$this->nombre1 .' '.$this->apellido1 ;
					}
				}
		}
...
$modificado_tipo = $this->tipo;
$modificado_r_social = $this->r_social;
$modificado_nombre2 = $this->nombre2;
$modificado_apellido2 = $this->apellido2;
$modificado_nombres = $this->nombres;
$modificado_nombre1 = $this->nombre1;
$modificado_apellido1 = $this->apellido1;
$this->nm_formatar_campos('tipo', 'r_social', 'nombre2', 'apellido2', 'nombres', 'nombre1', 'apellido1');
if ($original_tipo !== $modificado_tipo || isset($this->nmgp_cmp_readonly['tipo']) || (isset($bFlagRead_tipo) && $bFlagRead_tipo))
{
    $this->ajax_return_values_tipo(true);
}
if ($original_r_social !== $modificado_r_social || isset($this->nmgp_cmp_readonly['r_social']) || (isset($bFlagRead_r_social) && $bFlagRead_r_social))
{
    $this->ajax_return_values_r_social(true);
}
if ($original_nombre2 !== $modificado_nombre2 || isset($this->nmgp_cmp_readonly['nombre2']) || (isset($bFlagRead_nombre2) && $bFlagRead_nombre2))
...
$this->NM_ajax_info['event_field'] = 'r';
form_clientes_mini_mob_pack_ajax_response();
exit;
...
if($this->regimen =='COMUN')
	{
	$this->tipo_documento ='31';
	$this->fDigitoVerif();
	}
else
	{
	$this->tipo_documento ='13';
	$this->dv =NULL;
	}
...
$modificado_dv = $this->dv;
$modificado_documento = $this->documento;
$this->nm_formatar_campos('regimen', 'tipo_documento', 'dv', 'documento');
...
$this->NM_ajax_info['event_field'] = 'regimen';
form_clientes_mini_mob_pack_ajax_response();
exit;
...
$this->nm_formatar_campos('idtercero', 'idmuni', 'direccion', 'tel_cel');
if ($original_idtercero !== $modificado_idtercero || isset($this->nmgp_cmp_readonly['idtercero']) || (isset($bFlagRead_idtercero) && $bFlagRead_idtercero))
{
    $this->ajax_return_values_idtercero(true);
}
...
$original_tipo_documento = $this->tipo_documento;
$original_nombre_comercil = $this->nombre_comercil;
$original_representante = $this->representante;
$original_nombre1 = $this->nombre1;
$original_apellido1 = $this->apellido1;
$original_nombre2 = $this->nombre2;
$original_apellido2 = $this->apellido2;
...
if($this->tipo =='JUR')
	...
	$this->sc_field_readonly("representante", 'off');
	$this->sc_field_readonly("nombre1", 'on');
	$this->sc_field_readonly("apellido1", 'on');
	$this->sc_field_readonly("nombre2", 'on');
	$this->sc_field_readonly("apellido2", 'on');
	$this->sc_field_readonly("r_social", 'on');
	}
else
	{
	$this->nmgp_cmp_hidden["efec_retencion"] = "on"; $this->NM_ajax_info['fieldDisplay']['efec_retencion'] = 'on';
...
;
	$this->efec_retencion ='N';
	$this->sc_field_readonly("nombre_comercil", 'on');
	$this->sc_field_readonly("representante", 'on');
	$this->sc_field_readonly("nombre1", 'off');
	$this->sc_field_readonly("apellido1", 'off');
	$this->sc_field_readonly("nombre2", 'off');
	$this->sc_field_readonly("apellido2", 'off');
	$this->sc_field_readonly("r_social", 'off');
...
$modificado_tipo_documento = $this->tipo_documento;
$modificado_nombre_comercil = $this->nombre_comercil;
$modificado_representante = $this->representante;
$modificado_nombre1 = $this->nombre1;
$modificado_apellido1 = $this->apellido1;
$modificado_nombre2 = $this->nombre2;
$modificado_apellido2 = $this->apellido2;
...
$modificado_documento = $this->documento;
$modificado_dv = $this->dv;
$this->nm_formatar_campos('tipo', 'regimen', 'tipo_documento', 'nombre_comercil', 'representante', 'nombre1', 'apellido1', 'nombre2', 'apellido2', 'r_social', 'documento', 'dv');
if ($original_tipo !== $modificado_tipo || isset($this->nmgp_cmp_readonly['tipo']) || (isset($bFlagRead_tipo) && $bFlagRead_tipo))
{
    $this->ajax_return_values_tipo(true);
}
...
if ($original_representante !== $modificado_representante || isset($this->nmgp_cmp_readonly['representante']) || (isset($bFlagRead_representante) && $bFlagRead_representante))
{
    $this->ajax_return_values_representante(true);
}
if ($original_nombre1 !== $modificado_nombre1 || isset($this->nmgp_cmp_readonly['nombre1']) || (isset($bFlagRead_nombre1) && $bFlagRead_nombre1))
{
    $this->ajax_return_values_nombre1(true);
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out1_imagenter))
       {
        ...
        $this->initFormPages();
    include_once("form_clientes_mini_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   {
       $nmgp_def_dados  = "";
       $nmgp_def_dados .= "NO RESPONSABLE?#?SIM?#?N?@?";
       $nmgp_def_dados .= "RESPONSABLE?#?COMUN?#?N?@?";
       $todo = explode("?@?", $nmgp_def_dados);
       return $todo;
   ...
   function Form_lookup_notificar()
   {
       $nmgp_def_dados  = "";
...
{ 
   ...
   function Form_lookup_codigo_postal()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['Lookup_codigo_postal']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_clientes_mini_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['total'] = $qt_geral_reg_form_clientes_mini_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_clientes_mini_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_clientes_mini_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_clientes_mini_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['masterValue']))
{
  ...
  exit;
    ...
    function sc_set_focus($sFieldName)
    {
        ...
        $aFocus = array(
                        ...
                        'urlmail' => 'urlmail',
                        'idtercero' => 'idtercero',
                        'nombre_comercil' => 'nombre_comercil',
