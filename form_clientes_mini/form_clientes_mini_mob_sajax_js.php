  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_clientes_mini_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_clientes_mini_mob_form();
	}
  ...
  // ---------- Validate imagenter
  function do_ajax_form_clientes_mini_mob_validate_imagenter()
  {
    var nomeCampo_imagenter = "imagenter";
    var var_imagenter = scAjaxGetFieldText(nomeCampo_imagenter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_imagenter(var_imagenter, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_imagenter_cb);
  } // do_ajax_form_clientes_mini_mob_validate_imagenter

  function do_ajax_form_clientes_mini_mob_validate_imagenter_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_imagenter_cb

  // ---------- Validate tipo_documento
  function do_ajax_form_clientes_mini_mob_validate_tipo_documento()
  {
    var nomeCampo_tipo_documento = "tipo_documento";
    var var_tipo_documento = scAjaxGetFieldSelect(nomeCampo_tipo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_tipo_documento(var_tipo_documento, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_tipo_documento_cb);
  } // do_ajax_form_clientes_mini_mob_validate_tipo_documento

  function do_ajax_form_clientes_mini_mob_validate_tipo_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_tipo_documento_cb

  // ---------- Validate documento
  function do_ajax_form_clientes_mini_mob_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldText(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_documento(var_documento, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_documento_cb);
  } // do_ajax_form_clientes_mini_mob_validate_documento

  function do_ajax_form_clientes_mini_mob_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_documento_cb

  // ---------- Validate dv
  function do_ajax_form_clientes_mini_mob_validate_dv()
  {
    var nomeCampo_dv = "dv";
    var var_dv = scAjaxGetFieldText(nomeCampo_dv);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_dv(var_dv, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_dv_cb);
  } // do_ajax_form_clientes_mini_mob_validate_dv

  function do_ajax_form_clientes_mini_mob_validate_dv_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dv";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_dv_cb

  // ---------- Validate tipo
  function do_ajax_form_clientes_mini_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_tipo_cb);
  } // do_ajax_form_clientes_mini_mob_validate_tipo

  function do_ajax_form_clientes_mini_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_tipo_cb

  // ---------- Validate regimen
  function do_ajax_form_clientes_mini_mob_validate_regimen()
  {
    var nomeCampo_regimen = "regimen";
    var var_regimen = scAjaxGetFieldSelect(nomeCampo_regimen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_regimen(var_regimen, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_regimen_cb);
  } // do_ajax_form_clientes_mini_mob_validate_regimen

  function do_ajax_form_clientes_mini_mob_validate_regimen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regimen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_regimen_cb

  // ---------- Validate nombres
  function do_ajax_form_clientes_mini_mob_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldText(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_nombres(var_nombres, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_nombres_cb);
  } // do_ajax_form_clientes_mini_mob_validate_nombres

  function do_ajax_form_clientes_mini_mob_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_nombres_cb

  // ---------- Validate direccion
  function do_ajax_form_clientes_mini_mob_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_direccion(var_direccion, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_direccion_cb);
  } // do_ajax_form_clientes_mini_mob_validate_direccion

  function do_ajax_form_clientes_mini_mob_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_direccion_cb

  // ---------- Validate codigo_tercero
  function do_ajax_form_clientes_mini_mob_validate_codigo_tercero()
  {
    var nomeCampo_codigo_tercero = "codigo_tercero";
    var var_codigo_tercero = scAjaxGetFieldText(nomeCampo_codigo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_codigo_tercero(var_codigo_tercero, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_codigo_tercero_cb);
  } // do_ajax_form_clientes_mini_mob_validate_codigo_tercero

  function do_ajax_form_clientes_mini_mob_validate_codigo_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_codigo_tercero_cb

  // ---------- Validate sexo
  function do_ajax_form_clientes_mini_mob_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldSelect(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_sexo_cb);
  } // do_ajax_form_clientes_mini_mob_validate_sexo

  function do_ajax_form_clientes_mini_mob_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_sexo_cb

  // ---------- Validate notificar
  function do_ajax_form_clientes_mini_mob_validate_notificar()
  {
    var nomeCampo_notificar = "notificar";
    var var_notificar = scAjaxGetFieldSelect(nomeCampo_notificar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_notificar(var_notificar, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_notificar_cb);
  } // do_ajax_form_clientes_mini_mob_validate_notificar

  function do_ajax_form_clientes_mini_mob_validate_notificar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_notificar_cb

  // ---------- Validate nombre1
  function do_ajax_form_clientes_mini_mob_validate_nombre1()
  {
    var nomeCampo_nombre1 = "nombre1";
    var var_nombre1 = scAjaxGetFieldText(nomeCampo_nombre1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_nombre1(var_nombre1, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_nombre1_cb);
  } // do_ajax_form_clientes_mini_mob_validate_nombre1

  function do_ajax_form_clientes_mini_mob_validate_nombre1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_nombre1_cb

  // ---------- Validate nombre2
  function do_ajax_form_clientes_mini_mob_validate_nombre2()
  {
    var nomeCampo_nombre2 = "nombre2";
    var var_nombre2 = scAjaxGetFieldText(nomeCampo_nombre2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_nombre2(var_nombre2, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_nombre2_cb);
  } // do_ajax_form_clientes_mini_mob_validate_nombre2

  function do_ajax_form_clientes_mini_mob_validate_nombre2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_nombre2_cb

  // ---------- Validate apellido1
  function do_ajax_form_clientes_mini_mob_validate_apellido1()
  {
    var nomeCampo_apellido1 = "apellido1";
    var var_apellido1 = scAjaxGetFieldText(nomeCampo_apellido1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_apellido1(var_apellido1, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_apellido1_cb);
  } // do_ajax_form_clientes_mini_mob_validate_apellido1

  function do_ajax_form_clientes_mini_mob_validate_apellido1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_apellido1_cb

  // ---------- Validate apellido2
  function do_ajax_form_clientes_mini_mob_validate_apellido2()
  {
    var nomeCampo_apellido2 = "apellido2";
    var var_apellido2 = scAjaxGetFieldText(nomeCampo_apellido2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_apellido2(var_apellido2, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_apellido2_cb);
  } // do_ajax_form_clientes_mini_mob_validate_apellido2

  function do_ajax_form_clientes_mini_mob_validate_apellido2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_apellido2_cb

  // ---------- Validate tel_cel
  function do_ajax_form_clientes_mini_mob_validate_tel_cel()
  {
    var nomeCampo_tel_cel = "tel_cel";
    var var_tel_cel = scAjaxGetFieldText(nomeCampo_tel_cel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_tel_cel(var_tel_cel, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_tel_cel_cb);
  } // do_ajax_form_clientes_mini_mob_validate_tel_cel

  function do_ajax_form_clientes_mini_mob_validate_tel_cel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tel_cel";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_tel_cel_cb

  // ---------- Validate urlmail
  function do_ajax_form_clientes_mini_mob_validate_urlmail()
  {
    var nomeCampo_urlmail = "urlmail";
    var var_urlmail = scAjaxGetFieldText(nomeCampo_urlmail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_urlmail(var_urlmail, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_urlmail_cb);
  } // do_ajax_form_clientes_mini_mob_validate_urlmail

  function do_ajax_form_clientes_mini_mob_validate_urlmail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "urlmail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_urlmail_cb

  // ---------- Validate idtercero
  function do_ajax_form_clientes_mini_mob_validate_idtercero()
  {
    var nomeCampo_idtercero = "idtercero";
    var var_idtercero = scAjaxGetFieldText(nomeCampo_idtercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_idtercero(var_idtercero, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_idtercero_cb);
  } // do_ajax_form_clientes_mini_mob_validate_idtercero

  function do_ajax_form_clientes_mini_mob_validate_idtercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_idtercero_cb

  // ---------- Validate nombre_comercil
  function do_ajax_form_clientes_mini_mob_validate_nombre_comercil()
  {
    var nomeCampo_nombre_comercil = "nombre_comercil";
    var var_nombre_comercil = scAjaxGetFieldText(nomeCampo_nombre_comercil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_nombre_comercil(var_nombre_comercil, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_nombre_comercil_cb);
  } // do_ajax_form_clientes_mini_mob_validate_nombre_comercil

  function do_ajax_form_clientes_mini_mob_validate_nombre_comercil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_nombre_comercil_cb

  // ---------- Validate representante
  function do_ajax_form_clientes_mini_mob_validate_representante()
  {
    var nomeCampo_representante = "representante";
    var var_representante = scAjaxGetFieldText(nomeCampo_representante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_representante(var_representante, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_representante_cb);
  } // do_ajax_form_clientes_mini_mob_validate_representante

  function do_ajax_form_clientes_mini_mob_validate_representante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_representante_cb

  // ---------- Validate departamento
  function do_ajax_form_clientes_mini_mob_validate_departamento()
  {
    var nomeCampo_departamento = "departamento";
    var var_departamento = scAjaxGetFieldSelect(nomeCampo_departamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_departamento(var_departamento, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_departamento_cb);
  } // do_ajax_form_clientes_mini_mob_validate_departamento

  function do_ajax_form_clientes_mini_mob_validate_departamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_departamento_cb

  // ---------- Validate idmuni
  function do_ajax_form_clientes_mini_mob_validate_idmuni()
  {
    var nomeCampo_idmuni = "idmuni";
    var var_idmuni = scAjaxGetFieldSelect(nomeCampo_idmuni);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_idmuni(var_idmuni, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_idmuni_cb);
  } // do_ajax_form_clientes_mini_mob_validate_idmuni

  function do_ajax_form_clientes_mini_mob_validate_idmuni_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmuni";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_idmuni_cb

  // ---------- Validate ciudad
  function do_ajax_form_clientes_mini_mob_validate_ciudad()
  {
    var nomeCampo_ciudad = "ciudad";
    var var_ciudad = scAjaxGetFieldSelect(nomeCampo_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_ciudad(var_ciudad, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_ciudad_cb);
  } // do_ajax_form_clientes_mini_mob_validate_ciudad

  function do_ajax_form_clientes_mini_mob_validate_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_ciudad_cb

  // ---------- Validate codigo_postal
  function do_ajax_form_clientes_mini_mob_validate_codigo_postal()
  {
    var nomeCampo_codigo_postal = "codigo_postal";
    var var_codigo_postal = scAjaxGetFieldSelect(nomeCampo_codigo_postal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_codigo_postal(var_codigo_postal, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_codigo_postal_cb);
  } // do_ajax_form_clientes_mini_mob_validate_codigo_postal

  function do_ajax_form_clientes_mini_mob_validate_codigo_postal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_codigo_postal_cb

  // ---------- Validate observaciones
  function do_ajax_form_clientes_mini_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_observaciones_cb);
  } // do_ajax_form_clientes_mini_mob_validate_observaciones

  function do_ajax_form_clientes_mini_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_observaciones_cb

  // ---------- Validate lenguaje
  function do_ajax_form_clientes_mini_mob_validate_lenguaje()
  {
    var nomeCampo_lenguaje = "lenguaje";
    var var_lenguaje = scAjaxGetFieldSelect(nomeCampo_lenguaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_lenguaje(var_lenguaje, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_lenguaje_cb);
  } // do_ajax_form_clientes_mini_mob_validate_lenguaje

  function do_ajax_form_clientes_mini_mob_validate_lenguaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_lenguaje_cb

  // ---------- Validate es_restaurante
  function do_ajax_form_clientes_mini_mob_validate_es_restaurante()
  {
    var nomeCampo_es_restaurante = "es_restaurante";
    var var_es_restaurante = scAjaxGetFieldRadio(nomeCampo_es_restaurante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_es_restaurante(var_es_restaurante, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_es_restaurante_cb);
  } // do_ajax_form_clientes_mini_mob_validate_es_restaurante

  function do_ajax_form_clientes_mini_mob_validate_es_restaurante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_es_restaurante_cb

  // ---------- Validate r_social
  function do_ajax_form_clientes_mini_mob_validate_r_social()
  {
    var nomeCampo_r_social = "r_social";
    var var_r_social = scAjaxGetFieldText(nomeCampo_r_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_clientes_mini_mob_validate_r_social(var_r_social, var_script_case_init, do_ajax_form_clientes_mini_mob_validate_r_social_cb);
  } // do_ajax_form_clientes_mini_mob_validate_r_social

  function do_ajax_form_clientes_mini_mob_validate_r_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_validate_r_social_cb

  // ---------- Refresh departamento
  function do_ajax_form_clientes_mini_mob_refresh_departamento()
  {
    var var_departamento = scAjaxGetFieldSelect("departamento");
    var var_nmgp_refresh_fields = "idmuni";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_refresh_departamento(var_departamento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clientes_mini_mob_refresh_departamento_cb);
  } // do_ajax_form_clientes_mini_mob_refresh_departamento

  function do_ajax_form_clientes_mini_mob_refresh_departamento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_refresh_departamento_cb

  // ---------- Refresh idmuni
  function do_ajax_form_clientes_mini_mob_refresh_idmuni()
  {
    var var_idmuni = scAjaxGetFieldSelect("idmuni");
    var var_nmgp_refresh_fields = "ciudad_#fld#_codigo_postal";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_refresh_idmuni(var_idmuni, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_clientes_mini_mob_refresh_idmuni_cb);
  } // do_ajax_form_clientes_mini_mob_refresh_idmuni

  function do_ajax_form_clientes_mini_mob_refresh_idmuni_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_clientes_mini_mob_refresh_idmuni_cb

  // ---------- Event onchange apellido1
  function do_ajax_form_clientes_mini_mob_event_apellido1_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_apellido1 = scAjaxGetFieldText("apellido1");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_apellido1_onchange(var_nombre1, var_apellido1, var_script_case_init, do_ajax_form_clientes_mini_mob_event_apellido1_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_apellido1_onchange

  function do_ajax_form_clientes_mini_mob_event_apellido1_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apellido1";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_apellido1_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_apellido1_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_apellido1_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_apellido1_onchange_cb_after_alert

  // ---------- Event onchange apellido2
  function do_ajax_form_clientes_mini_mob_event_apellido2_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_apellido2 = scAjaxGetFieldText("apellido2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_apellido2_onchange(var_nombre1, var_apellido2, var_script_case_init, do_ajax_form_clientes_mini_mob_event_apellido2_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_apellido2_onchange

  function do_ajax_form_clientes_mini_mob_event_apellido2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apellido2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_apellido2_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_apellido2_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_apellido2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_apellido2_onchange_cb_after_alert

  // ---------- Event onchange cliente
  function do_ajax_form_clientes_mini_mob_event_cliente_onchange()
  {
    var var_idtercero = scAjaxGetFieldText("idtercero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_cliente_onchange(var_idtercero, var_script_case_init, do_ajax_form_clientes_mini_mob_event_cliente_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_cliente_onchange

  function do_ajax_form_clientes_mini_mob_event_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_cliente_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_cliente_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_cliente_onchange_cb_after_alert

  // ---------- Event onchange credito
  function do_ajax_form_clientes_mini_mob_event_credito_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_credito_onchange(var_script_case_init, do_ajax_form_clientes_mini_mob_event_credito_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_credito_onchange

  function do_ajax_form_clientes_mini_mob_event_credito_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "credito";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_credito_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_credito_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_credito_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_credito_onchange_cb_after_alert

  // ---------- Event onchange creditoprov
  function do_ajax_form_clientes_mini_mob_event_creditoprov_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_creditoprov_onchange(var_script_case_init, do_ajax_form_clientes_mini_mob_event_creditoprov_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_creditoprov_onchange

  function do_ajax_form_clientes_mini_mob_event_creditoprov_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_creditoprov_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_creditoprov_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_creditoprov_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_creditoprov_onchange_cb_after_alert

  // ---------- Event onchange cupo
  function do_ajax_form_clientes_mini_mob_event_cupo_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_cupo_onchange(var_script_case_init, do_ajax_form_clientes_mini_mob_event_cupo_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_cupo_onchange

  function do_ajax_form_clientes_mini_mob_event_cupo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cupo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_cupo_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_cupo_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_cupo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_cupo_onchange_cb_after_alert

  // ---------- Event onchange documento
  function do_ajax_form_clientes_mini_mob_event_documento_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_documento_onchange(var_tipo_documento, var_dv, var_documento, var_script_case_init, do_ajax_form_clientes_mini_mob_event_documento_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_documento_onchange

  function do_ajax_form_clientes_mini_mob_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_documento_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_documento_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_documento_onchange_cb_after_alert

  // ---------- Event onchange nombre1
  function do_ajax_form_clientes_mini_mob_event_nombre1_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_nombre1_onchange(var_nombre1, var_script_case_init, do_ajax_form_clientes_mini_mob_event_nombre1_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_nombre1_onchange

  function do_ajax_form_clientes_mini_mob_event_nombre1_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre1";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_nombre1_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_nombre1_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_nombre1_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_nombre1_onchange_cb_after_alert

  // ---------- Event onchange nombre2
  function do_ajax_form_clientes_mini_mob_event_nombre2_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_nombre2 = scAjaxGetFieldText("nombre2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_nombre2_onchange(var_nombre1, var_nombre2, var_script_case_init, do_ajax_form_clientes_mini_mob_event_nombre2_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_nombre2_onchange

  function do_ajax_form_clientes_mini_mob_event_nombre2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_nombre2_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_nombre2_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_nombre2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_nombre2_onchange_cb_after_alert

  // ---------- Event onchange nombre_comercil
  function do_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange(var_tipo, var_nombres, var_nombre_comercil, var_script_case_init, do_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange

  function do_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre_comercil";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_nombre_comercil_onchange_cb_after_alert

  // ---------- Event onchange proveedor
  function do_ajax_form_clientes_mini_mob_event_proveedor_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_proveedor_onchange(var_script_case_init, do_ajax_form_clientes_mini_mob_event_proveedor_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_proveedor_onchange

  function do_ajax_form_clientes_mini_mob_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_proveedor_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_proveedor_onchange_cb_after_alert

  // ---------- Event onchange r_social
  function do_ajax_form_clientes_mini_mob_event_r_social_onchange()
  {
    var var_tipo = scAjaxGetFieldSelect("tipo");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_r_social_onchange(var_tipo, var_r_social, var_nombre2, var_apellido2, var_nombres, var_nombre1, var_apellido1, var_script_case_init, do_ajax_form_clientes_mini_mob_event_r_social_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_r_social_onchange

  function do_ajax_form_clientes_mini_mob_event_r_social_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "r_social";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_r_social_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_r_social_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_r_social_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_r_social_onchange_cb_after_alert

  // ---------- Event onchange regimen
  function do_ajax_form_clientes_mini_mob_event_regimen_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_regimen_onchange(var_regimen, var_tipo_documento, var_dv, var_documento, var_script_case_init, do_ajax_form_clientes_mini_mob_event_regimen_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_regimen_onchange

  function do_ajax_form_clientes_mini_mob_event_regimen_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "regimen";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_regimen_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_regimen_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_regimen_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_regimen_onchange_cb_after_alert

  // ---------- Event onchange sucur_cliente
  function do_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange()
  {
    var var_idtercero = scAjaxGetFieldText("idtercero");
    var var_idmuni = scAjaxGetFieldSelect("idmuni");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange(var_idtercero, var_idmuni, var_direccion, var_tel_cel, var_script_case_init, do_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange

  function do_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_sucur_cliente_onchange_cb_after_alert

  // ---------- Event onchange tipo_documento
  function do_ajax_form_clientes_mini_mob_event_tipo_documento_onchange()
  {
    var var_tipo_documento = scAjaxGetFieldSelect("tipo_documento");
    var var_dv = scAjaxGetFieldText("dv");
    var var_documento = scAjaxGetFieldText("documento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_tipo_documento_onchange(var_tipo_documento, var_dv, var_documento, var_script_case_init, do_ajax_form_clientes_mini_mob_event_tipo_documento_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_tipo_documento_onchange

  function do_ajax_form_clientes_mini_mob_event_tipo_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo_documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_tipo_documento_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_tipo_documento_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_tipo_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_tipo_documento_onchange_cb_after_alert

  // ---------- Event onchange tipo
  function do_ajax_form_clientes_mini_mob_event_tipo_onchange()
  {
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_regimen = scAjaxGetFieldSelect("regimen");
    var var_tipo_documento = scAjaxGetFieldSelect("tipo_documento");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_clientes_mini_mob_event_tipo_onchange(var_tipo, var_regimen, var_tipo_documento, var_nombre_comercil, var_representante, var_nombre1, var_apellido1, var_nombre2, var_apellido2, var_r_social, var_documento, var_dv, var_script_case_init, do_ajax_form_clientes_mini_mob_event_tipo_onchange_cb);
  } // do_ajax_form_clientes_mini_mob_event_tipo_onchange

  function do_ajax_form_clientes_mini_mob_event_tipo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_event_tipo_onchange_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_event_tipo_onchange_cb
  function do_ajax_form_clientes_mini_mob_event_tipo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_clientes_mini_mob_event_tipo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_clientes_mini_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_clientes_mini_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_clientes_mini_mob_submit_form(var_imagenter, var_tipo_documento, var_documento, var_dv, var_tipo, var_regimen, var_nombres, var_direccion, var_codigo_tercero, var_sexo, var_notificar, var_nombre1, var_nombre2, var_apellido1, var_apellido2, var_tel_cel, var_urlmail, var_idtercero, var_nombre_comercil, var_representante, var_departamento, var_idmuni, var_ciudad, var_codigo_postal, var_observaciones, var_lenguaje, var_es_restaurante, var_r_social, var_imagenter_ul_name, var_imagenter_ul_type, var_imagenter_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_clientes_mini_mob_submit_form_cb);
  } // do_ajax_form_clientes_mini_mob_submit_form

  function do_ajax_form_clientes_mini_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_clientes_mini_mob_submit_form_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_submit_form_cb
  function do_ajax_form_clientes_mini_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_clientes_mini_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_clientes_mini_mob_navigate_form()
  {
    perform_ajax_form_clientes_mini_mob_navigate_form();
  }

  function perform_ajax_form_clientes_mini_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_clientes_mini_mob_navigate_form(var_idtercero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_clientes_mini_mob_navigate_form_cb);
  } // do_ajax_form_clientes_mini_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_clientes_mini_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_clientes_mini_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_clientes_mini_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_clientes_mini_mob_navigate_form_cb
  function do_ajax_form_clientes_mini_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_clientes_mini_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_clientes_mini_mob_navigate_form_cb_after_alert
  function sc_hide_form_clientes_mini_mob_form()
  {
  ...
  function do_ajax_form_clientes_mini_mob_lkpedt_refresh_zona_clientes()
  {
    var var_zona_clientes = scAjaxGetFieldSelect("zona_clientes");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "zona_clientes";
    x_ajax_form_clientes_mini_mob_lkpedt_refresh_zona_clientes(var_zona_clientes, nmgp_refresh_fields, var_script_case_init, do_ajax_form_clientes_mini_mob_lkpedt_refresh_zona_clientes_cb);
  } // do_ajax_form_clientes_mini_mob_lkpedt_refresh_zona_clientes

  function do_ajax_form_clientes_mini_mob_lkpedt_refresh_zona_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_clientes_mini_mob_lkpedt_refresh_zona_clientes_cb

  function do_ajax_form_clientes_mini_mob_lkpedt_refresh_clasificacion_clientes()
  {
    var var_clasificacion_clientes = scAjaxGetFieldSelect("clasificacion_clientes");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "clasificacion_clientes";
    x_ajax_form_clientes_mini_mob_lkpedt_refresh_clasificacion_clientes(var_clasificacion_clientes, nmgp_refresh_fields, var_script_case_init, do_ajax_form_clientes_mini_mob_lkpedt_refresh_clasificacion_clientes_cb);
  } // do_ajax_form_clientes_mini_mob_lkpedt_refresh_clasificacion_clientes

  function do_ajax_form_clientes_mini_mob_lkpedt_refresh_clasificacion_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_clientes_mini_mob_lkpedt_refresh_clasificacion_clientes_cb
