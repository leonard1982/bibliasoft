...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detalle_notainv_130521"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detalle_notainv_130521"]);
   }
