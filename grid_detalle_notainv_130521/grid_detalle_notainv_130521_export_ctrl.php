<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalle_notainv_130521']['sc_process_barr'] = true;
require_once('../grid_detalle_notainv_130521/index.php');
unset($_SESSION['scriptcase']['grid_detalle_notainv_130521']['sc_process_barr']);
$ExportCtrl = new grid_detalle_notainv_130521_export_control;
$ExportCtrl->Export_barr();

class grid_detalle_notainv_130521_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_detalle_notainv_130521']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_detalle_notainv_130521']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - inventarioself</TITLE>
