...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421_mob']['opc_ant'] = "inicio";
      }
      ...
      $_SESSION['scriptcase']['error_icon']['form_usuarios_210421_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421_mob']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421_mob']['sc_max_reg']) == "all")
      {
...
if(isset($this->vsiexiste[0][0]))
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_usuarios_210421_mob';
...
//------------ 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_usuarios_210421_mob) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421_mob']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421_mob']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421_mob']['reg_start'] + 1;
