...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'grupocomanda':
      case 'banco_movil':
        sc_exib_ocult_pag('form_usuarios_210421_form0');
        break;
      case 'acceso_inventario':
      case 'acceso_gerencial':
      case 'acceso_restaurante':
        sc_exib_ocult_pag('form_usuarios_210421_form1');
        break;
      case 'nombre_pc':
      case 'nombre_impre':
        sc_exib_ocult_pag('form_usuarios_210421_form2');
        break;
      case 'ubicacion':
      case 'n_equipo':
      case 'serial':
        sc_exib_ocult_pag('form_usuarios_210421_form3');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idusuarios' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_idusuarios_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_usuarios_210421_idusuarios_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_usuarios_210421_idusuarios_onfocus(this, iSeqRow) });
  $('#id_sc_field_creacion' + iSeqRow).bind('change', function() { sc_form_usuarios_210421_creacion_onchange(this, iSeqRow) });
  $('#id_sc_field_creacion_hora' + iSeqRow).bind('change', function() { sc_form_usuarios_210421_creacion_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_usuario' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_usuario_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_usuarios_210421_usuario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_password' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_password_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_usuarios_210421_password_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_nombre_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_usuarios_210421_nombre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_correo' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_correo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_usuarios_210421_correo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_telefono' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_telefono_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_usuarios_210421_telefono_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_resolucion' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_resolucion_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_usuarios_210421_resolucion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_activo' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_activo_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_usuarios_210421_activo_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_usuarios_210421_activo_onfocus(this, iSeqRow) });
  $('#id_sc_field_ultima_actualizacion' + iSeqRow).bind('change', function() { sc_form_usuarios_210421_ultima_actualizacion_onchange(this, iSeqRow) });
  $('#id_sc_field_ultima_actualizacion_hora' + iSeqRow).bind('change', function() { sc_form_usuarios_210421_ultima_actualizacion_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_grupocomanda' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_grupocomanda_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_usuarios_210421_grupocomanda_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre_pc' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_nombre_pc_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_usuarios_210421_nombre_pc_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre_impre' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_nombre_impre_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_usuarios_210421_nombre_impre_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_usuarios_210421_nombre_impre_onfocus(this, iSeqRow) });
  $('#id_sc_field_sesion_id' + iSeqRow).bind('change', function() { sc_form_usuarios_210421_sesion_id_onchange(this, iSeqRow) });
  $('#id_sc_field_acceso_inventario' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_acceso_inventario_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_usuarios_210421_acceso_inventario_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_acceso_gerencial' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_acceso_gerencial_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_usuarios_210421_acceso_gerencial_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_acceso_restaurante' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_acceso_restaurante_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_usuarios_210421_acceso_restaurante_onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_usuarios_210421_acceso_restaurante_onfocus(this, iSeqRow) });
  $('#id_sc_field_sesion_id_movil' + iSeqRow).bind('change', function() { sc_form_usuarios_210421_sesion_id_movil_onchange(this, iSeqRow) });
  $('#id_sc_field_banco_movil' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_banco_movil_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_usuarios_210421_banco_movil_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ubicacion' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_ubicacion_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_usuarios_210421_ubicacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_n_equipo' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_n_equipo_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_usuarios_210421_n_equipo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_serial' + iSeqRow).bind('blur', function() { sc_form_usuarios_210421_serial_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_usuarios_210421_serial_onchange(this, iSeqRow) })
...
function sc_form_usuarios_210421_idusuarios_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_creacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_usuarios_210421_creacion_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_password_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_nombre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_correo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_telefono_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_resolucion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_activo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_ultima_actualizacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_usuarios_210421_ultima_actualizacion_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_grupocomanda_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_nombre_pc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_nombre_impre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_sesion_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_acceso_inventario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_acceso_gerencial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_acceso_restaurante_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_sesion_id_movil_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_banco_movil_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_ubicacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_n_equipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_usuarios_210421_serial_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_usuarios_210421_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_creacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_usuarios_210421_validate_creacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_ultima_actualizacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_usuarios_210421_validate_ultima_actualizacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_usuarios_210421')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
