...
@session_start() ;
class form_usuarios_210421_mob_help
{
...
<?php echo "<b>Caja Predeterminada</b><br>" . nl2br("Podemos predeterminar una caja para un usuario siempre y cuando no se use apertura y cierre de caja. También podemos usarla para asignar una caja a un usuario móvil FACILWEB."); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_usuarios_210421_mob_help();
?>
