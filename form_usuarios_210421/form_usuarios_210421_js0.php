<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idusuarios" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idusuarios']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_usuarios_210421"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
function sc_btn_permisos()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_permisos(); }, 500);
      return;
    }
    sc_btn_permisos_ok();
}
function sc_btn_permisos_cancel()
{
}
function sc_btn_permisos_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_form_aplicaciones_permisos_edit; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout"; ?>', '', '_self', '0', '0', 'form_aplicaciones_permisos');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_detal']))
  {
?>  
...
{
    NovaJanela = window.open ("form_usuarios_210421_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
{
    document.getElementById('form_usuarios_210421_form0').style.width='1px';
    document.getElementById('form_usuarios_210421_form0').style.height='0px';
    document.getElementById('form_usuarios_210421_form0').style.display='none';
    document.getElementById('form_usuarios_210421_form0').style.overflow='scroll';
    document.getElementById('form_usuarios_210421_form1').style.width='1px';
    document.getElementById('form_usuarios_210421_form1').style.height='0px';
    document.getElementById('form_usuarios_210421_form1').style.display='none';
    document.getElementById('form_usuarios_210421_form1').style.overflow='scroll';
    document.getElementById('form_usuarios_210421_form2').style.width='1px';
    document.getElementById('form_usuarios_210421_form2').style.height='0px';
    document.getElementById('form_usuarios_210421_form2').style.display='none';
    document.getElementById('form_usuarios_210421_form2').style.overflow='scroll';
    document.getElementById('form_usuarios_210421_form3').style.width='1px';
    document.getElementById('form_usuarios_210421_form3').style.height='0px';
    document.getElementById('form_usuarios_210421_form3').style.display='none';
    document.getElementById('form_usuarios_210421_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['pdf_view']) {
?>
