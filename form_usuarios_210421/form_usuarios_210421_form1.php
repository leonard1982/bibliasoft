<div id="form_usuarios_210421_form1" style='<?php echo ($this->tabCssClass["form_usuarios_210421_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_acceso_inventario_label" id="hidden_field_label_acceso_inventario" style="<?php echo $sStyleHidden_acceso_inventario; ?>"><span id="id_label_acceso_inventario"><?php echo $this->nm_new_label['acceso_inventario']; ?></span></TD>
    <TD class="scFormDataOdd css_acceso_inventario_line" id="hidden_field_data_acceso_inventario" style="<?php echo $sStyleHidden_acceso_inventario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acceso_inventario_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_acceso_inventario'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_acceso_gerencial_label" id="hidden_field_label_acceso_gerencial" style="<?php echo $sStyleHidden_acceso_gerencial; ?>"><span id="id_label_acceso_gerencial"><?php echo $this->nm_new_label['acceso_gerencial']; ?></span></TD>
    <TD class="scFormDataOdd css_acceso_gerencial_line" id="hidden_field_data_acceso_gerencial" style="<?php echo $sStyleHidden_acceso_gerencial; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acceso_gerencial_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_acceso_gerencial'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_acceso_restaurante_label" id="hidden_field_label_acceso_restaurante" style="<?php echo $sStyleHidden_acceso_restaurante; ?>"><span id="id_label_acceso_restaurante"><?php echo $this->nm_new_label['acceso_restaurante']; ?></span></TD>
    <TD class="scFormDataOdd css_acceso_restaurante_line" id="hidden_field_data_acceso_restaurante" style="<?php echo $sStyleHidden_acceso_restaurante; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_acceso_restaurante_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_acceso_restaurante'][] = 'SI'; ?>
