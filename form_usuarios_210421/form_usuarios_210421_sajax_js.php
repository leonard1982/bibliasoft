  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_usuarios_210421" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_usuarios_210421_form();
	}
...
?>
  ...
  // ---------- Validate idusuarios
  function do_ajax_form_usuarios_210421_validate_idusuarios()
  {
    var nomeCampo_idusuarios = "idusuarios";
    var var_idusuarios = scAjaxGetFieldHidden(nomeCampo_idusuarios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_idusuarios(var_idusuarios, var_script_case_init, do_ajax_form_usuarios_210421_validate_idusuarios_cb);
  } // do_ajax_form_usuarios_210421_validate_idusuarios

  function do_ajax_form_usuarios_210421_validate_idusuarios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idusuarios";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_idusuarios_cb

  // ---------- Validate usuario
  function do_ajax_form_usuarios_210421_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_usuarios_210421_validate_usuario_cb);
  } // do_ajax_form_usuarios_210421_validate_usuario

  function do_ajax_form_usuarios_210421_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_usuario_cb

  // ---------- Validate password
  function do_ajax_form_usuarios_210421_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_password(var_password, var_script_case_init, do_ajax_form_usuarios_210421_validate_password_cb);
  } // do_ajax_form_usuarios_210421_validate_password

  function do_ajax_form_usuarios_210421_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_password_cb

  // ---------- Validate nombre
  function do_ajax_form_usuarios_210421_validate_nombre()
  {
    var nomeCampo_nombre = "nombre";
    var var_nombre = scAjaxGetFieldText(nomeCampo_nombre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_nombre(var_nombre, var_script_case_init, do_ajax_form_usuarios_210421_validate_nombre_cb);
  } // do_ajax_form_usuarios_210421_validate_nombre

  function do_ajax_form_usuarios_210421_validate_nombre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_nombre_cb

  // ---------- Validate correo
  function do_ajax_form_usuarios_210421_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_correo(var_correo, var_script_case_init, do_ajax_form_usuarios_210421_validate_correo_cb);
  } // do_ajax_form_usuarios_210421_validate_correo

  function do_ajax_form_usuarios_210421_validate_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "correo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_correo_cb

  // ---------- Validate telefono
  function do_ajax_form_usuarios_210421_validate_telefono()
  {
    var nomeCampo_telefono = "telefono";
    var var_telefono = scAjaxGetFieldText(nomeCampo_telefono);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_telefono(var_telefono, var_script_case_init, do_ajax_form_usuarios_210421_validate_telefono_cb);
  } // do_ajax_form_usuarios_210421_validate_telefono

  function do_ajax_form_usuarios_210421_validate_telefono_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_telefono_cb

  // ---------- Validate tercero
  function do_ajax_form_usuarios_210421_validate_tercero()
  {
    var nomeCampo_tercero = "tercero";
    var var_tercero = scAjaxGetFieldSelect(nomeCampo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_tercero(var_tercero, var_script_case_init, do_ajax_form_usuarios_210421_validate_tercero_cb);
  } // do_ajax_form_usuarios_210421_validate_tercero

  function do_ajax_form_usuarios_210421_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_tercero_cb

  // ---------- Validate resolucion
  function do_ajax_form_usuarios_210421_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_usuarios_210421_validate_resolucion_cb);
  } // do_ajax_form_usuarios_210421_validate_resolucion

  function do_ajax_form_usuarios_210421_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_resolucion_cb

  // ---------- Validate grupo
  function do_ajax_form_usuarios_210421_validate_grupo()
  {
    var nomeCampo_grupo = "grupo";
    var var_grupo = scAjaxGetFieldSelect(nomeCampo_grupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_grupo(var_grupo, var_script_case_init, do_ajax_form_usuarios_210421_validate_grupo_cb);
  } // do_ajax_form_usuarios_210421_validate_grupo

  function do_ajax_form_usuarios_210421_validate_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grupo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_grupo_cb

  // ---------- Validate activo
  function do_ajax_form_usuarios_210421_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldCheckbox(nomeCampo_activo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_activo(var_activo, var_script_case_init, do_ajax_form_usuarios_210421_validate_activo_cb);
  } // do_ajax_form_usuarios_210421_validate_activo

  function do_ajax_form_usuarios_210421_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_activo_cb

  // ---------- Validate grupocomanda
  function do_ajax_form_usuarios_210421_validate_grupocomanda()
  {
    var nomeCampo_grupocomanda = "grupocomanda";
    var var_grupocomanda = scAjaxGetFieldSelect(nomeCampo_grupocomanda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_grupocomanda(var_grupocomanda, var_script_case_init, do_ajax_form_usuarios_210421_validate_grupocomanda_cb);
  } // do_ajax_form_usuarios_210421_validate_grupocomanda

  function do_ajax_form_usuarios_210421_validate_grupocomanda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grupocomanda";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_grupocomanda_cb

  // ---------- Validate banco_movil
  function do_ajax_form_usuarios_210421_validate_banco_movil()
  {
    var nomeCampo_banco_movil = "banco_movil";
    var var_banco_movil = scAjaxGetFieldSelect(nomeCampo_banco_movil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_banco_movil(var_banco_movil, var_script_case_init, do_ajax_form_usuarios_210421_validate_banco_movil_cb);
  } // do_ajax_form_usuarios_210421_validate_banco_movil

  function do_ajax_form_usuarios_210421_validate_banco_movil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banco_movil";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_banco_movil_cb

  // ---------- Validate acceso_inventario
  function do_ajax_form_usuarios_210421_validate_acceso_inventario()
  {
    var nomeCampo_acceso_inventario = "acceso_inventario";
    var var_acceso_inventario = scAjaxGetFieldCheckbox(nomeCampo_acceso_inventario, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_acceso_inventario(var_acceso_inventario, var_script_case_init, do_ajax_form_usuarios_210421_validate_acceso_inventario_cb);
  } // do_ajax_form_usuarios_210421_validate_acceso_inventario

  function do_ajax_form_usuarios_210421_validate_acceso_inventario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "acceso_inventario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_acceso_inventario_cb

  // ---------- Validate acceso_gerencial
  function do_ajax_form_usuarios_210421_validate_acceso_gerencial()
  {
    var nomeCampo_acceso_gerencial = "acceso_gerencial";
    var var_acceso_gerencial = scAjaxGetFieldCheckbox(nomeCampo_acceso_gerencial, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_acceso_gerencial(var_acceso_gerencial, var_script_case_init, do_ajax_form_usuarios_210421_validate_acceso_gerencial_cb);
  } // do_ajax_form_usuarios_210421_validate_acceso_gerencial

  function do_ajax_form_usuarios_210421_validate_acceso_gerencial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "acceso_gerencial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_acceso_gerencial_cb

  // ---------- Validate acceso_restaurante
  function do_ajax_form_usuarios_210421_validate_acceso_restaurante()
  {
    var nomeCampo_acceso_restaurante = "acceso_restaurante";
    var var_acceso_restaurante = scAjaxGetFieldCheckbox(nomeCampo_acceso_restaurante, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_acceso_restaurante(var_acceso_restaurante, var_script_case_init, do_ajax_form_usuarios_210421_validate_acceso_restaurante_cb);
  } // do_ajax_form_usuarios_210421_validate_acceso_restaurante

  function do_ajax_form_usuarios_210421_validate_acceso_restaurante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "acceso_restaurante";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_acceso_restaurante_cb

  // ---------- Validate nombre_pc
  function do_ajax_form_usuarios_210421_validate_nombre_pc()
  {
    var nomeCampo_nombre_pc = "nombre_pc";
    var var_nombre_pc = scAjaxGetFieldText(nomeCampo_nombre_pc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_nombre_pc(var_nombre_pc, var_script_case_init, do_ajax_form_usuarios_210421_validate_nombre_pc_cb);
  } // do_ajax_form_usuarios_210421_validate_nombre_pc

  function do_ajax_form_usuarios_210421_validate_nombre_pc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_nombre_pc_cb

  // ---------- Validate nombre_impre
  function do_ajax_form_usuarios_210421_validate_nombre_impre()
  {
    var nomeCampo_nombre_impre = "nombre_impre";
    var var_nombre_impre = scAjaxGetFieldText(nomeCampo_nombre_impre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_nombre_impre(var_nombre_impre, var_script_case_init, do_ajax_form_usuarios_210421_validate_nombre_impre_cb);
  } // do_ajax_form_usuarios_210421_validate_nombre_impre

  function do_ajax_form_usuarios_210421_validate_nombre_impre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_nombre_impre_cb

  // ---------- Validate ubicacion
  function do_ajax_form_usuarios_210421_validate_ubicacion()
  {
    var nomeCampo_ubicacion = "ubicacion";
    var var_ubicacion = scAjaxGetFieldText(nomeCampo_ubicacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_ubicacion(var_ubicacion, var_script_case_init, do_ajax_form_usuarios_210421_validate_ubicacion_cb);
  } // do_ajax_form_usuarios_210421_validate_ubicacion

  function do_ajax_form_usuarios_210421_validate_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_ubicacion_cb

  // ---------- Validate n_equipo
  function do_ajax_form_usuarios_210421_validate_n_equipo()
  {
    var nomeCampo_n_equipo = "n_equipo";
    var var_n_equipo = scAjaxGetFieldText(nomeCampo_n_equipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_n_equipo(var_n_equipo, var_script_case_init, do_ajax_form_usuarios_210421_validate_n_equipo_cb);
  } // do_ajax_form_usuarios_210421_validate_n_equipo

  function do_ajax_form_usuarios_210421_validate_n_equipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "n_equipo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_n_equipo_cb

  // ---------- Validate serial
  function do_ajax_form_usuarios_210421_validate_serial()
  {
    var nomeCampo_serial = "serial";
    var var_serial = scAjaxGetFieldText(nomeCampo_serial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_usuarios_210421_validate_serial(var_serial, var_script_case_init, do_ajax_form_usuarios_210421_validate_serial_cb);
  } // do_ajax_form_usuarios_210421_validate_serial

  function do_ajax_form_usuarios_210421_validate_serial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_usuarios_210421_validate_serial_cb

  // ---------- Event onchange grupo
  function do_ajax_form_usuarios_210421_event_grupo_onchange()
  {
    var var_grupo = scAjaxGetFieldSelect("grupo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_usuarios_210421_event_grupo_onchange(var_grupo, var_script_case_init, do_ajax_form_usuarios_210421_event_grupo_onchange_cb);
  } // do_ajax_form_usuarios_210421_event_grupo_onchange

  function do_ajax_form_usuarios_210421_event_grupo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "grupo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_usuarios_210421_event_grupo_onchange_cb_after_alert);
  } // do_ajax_form_usuarios_210421_event_grupo_onchange_cb
  function do_ajax_form_usuarios_210421_event_grupo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_usuarios_210421_event_grupo_onchange_cb_after_alert

  // ---------- Event onchange tercero
  function do_ajax_form_usuarios_210421_event_tercero_onchange()
  {
    var var_idusuarios = scAjaxGetFieldHidden("idusuarios");
    var var_tercero = scAjaxGetFieldSelect("tercero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_usuarios_210421_event_tercero_onchange(var_idusuarios, var_tercero, var_script_case_init, do_ajax_form_usuarios_210421_event_tercero_onchange_cb);
  } // do_ajax_form_usuarios_210421_event_tercero_onchange

  function do_ajax_form_usuarios_210421_event_tercero_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tercero";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_usuarios_210421_event_tercero_onchange_cb_after_alert);
  } // do_ajax_form_usuarios_210421_event_tercero_onchange_cb
  function do_ajax_form_usuarios_210421_event_tercero_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_usuarios_210421_event_tercero_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_usuarios_210421_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_usuarios_210421_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idusuarios = scAjaxGetFieldHidden("idusuarios");
    ...
    var var_grupocomanda = scAjaxGetFieldSelect("grupocomanda");
    var var_banco_movil = scAjaxGetFieldSelect("banco_movil");
    var var_acceso_inventario = scAjaxGetFieldCheckbox("acceso_inventario", ";");
    var var_acceso_gerencial = scAjaxGetFieldCheckbox("acceso_gerencial", ";");
    var var_acceso_restaurante = scAjaxGetFieldCheckbox("acceso_restaurante", ";");
    ...
    var var_n_equipo = scAjaxGetFieldText("n_equipo");
    ...
    scAjaxProcOn();
    x_ajax_form_usuarios_210421_submit_form(var_idusuarios, var_usuario, var_password, var_nombre, var_correo, var_telefono, var_tercero, var_resolucion, var_grupo, var_activo, var_grupocomanda, var_banco_movil, var_acceso_inventario, var_acceso_gerencial, var_acceso_restaurante, var_nombre_pc, var_nombre_impre, var_ubicacion, var_n_equipo, var_serial, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_usuarios_210421_submit_form_cb);
  } // do_ajax_form_usuarios_210421_submit_form

  function do_ajax_form_usuarios_210421_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idusuarios");
      ...
      scAjaxHideErrorDisplay("grupo");
      scAjaxHideErrorDisplay("activo");
      scAjaxHideErrorDisplay("grupocomanda");
      scAjaxHideErrorDisplay("banco_movil");
      scAjaxHideErrorDisplay("acceso_inventario");
      scAjaxHideErrorDisplay("acceso_gerencial");
      scAjaxHideErrorDisplay("acceso_restaurante");
      scAjaxHideErrorDisplay("nombre_pc");
      scAjaxHideErrorDisplay("nombre_impre");
      scAjaxHideErrorDisplay("ubicacion");
      scAjaxHideErrorDisplay("n_equipo");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_usuarios_210421_submit_form_cb_after_alert);
  } // do_ajax_form_usuarios_210421_submit_form_cb
  function do_ajax_form_usuarios_210421_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_usuarios_210421_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_usuarios_210421_navigate_form()
  {
    perform_ajax_form_usuarios_210421_navigate_form();
  }

  function perform_ajax_form_usuarios_210421_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("n_equipo");
    scAjaxHideErrorDisplay("serial");
    var var_idusuarios = document.F2.idusuarios.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_usuarios_210421_navigate_form(var_idusuarios, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_usuarios_210421_navigate_form_cb);
  } // do_ajax_form_usuarios_210421_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_usuarios_210421_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idusuarios.value = scAjaxGetKeyValue("idusuarios");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_usuarios_210421_navigate_form_cb_after_alert);
  } // do_ajax_form_usuarios_210421_navigate_form_cb
  function do_ajax_form_usuarios_210421_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_usuarios_210421_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_usuarios_210421_navigate_form_cb_after_alert
  function sc_hide_form_usuarios_210421_form()
  {
  ...
  function do_ajax_form_usuarios_210421_lkpedt_refresh_tercero()
  {
    var var_tercero = scAjaxGetFieldSelect("tercero");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "tercero";
    x_ajax_form_usuarios_210421_lkpedt_refresh_tercero(var_tercero, nmgp_refresh_fields, var_script_case_init, do_ajax_form_usuarios_210421_lkpedt_refresh_tercero_cb);
  } // do_ajax_form_usuarios_210421_lkpedt_refresh_tercero

  function do_ajax_form_usuarios_210421_lkpedt_refresh_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_usuarios_210421_lkpedt_refresh_tercero_cb

  function do_ajax_form_usuarios_210421_lkpedt_refresh_resolucion()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "resolucion";
    x_ajax_form_usuarios_210421_lkpedt_refresh_resolucion(var_resolucion, nmgp_refresh_fields, var_script_case_init, do_ajax_form_usuarios_210421_lkpedt_refresh_resolucion_cb);
  } // do_ajax_form_usuarios_210421_lkpedt_refresh_resolucion

  function do_ajax_form_usuarios_210421_lkpedt_refresh_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_usuarios_210421_lkpedt_refresh_resolucion_cb

  function do_ajax_form_usuarios_210421_lkpedt_refresh_grupo()
  {
    var var_grupo = scAjaxGetFieldSelect("grupo");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "grupo";
    x_ajax_form_usuarios_210421_lkpedt_refresh_grupo(var_grupo, nmgp_refresh_fields, var_script_case_init, do_ajax_form_usuarios_210421_lkpedt_refresh_grupo_cb);
  } // do_ajax_form_usuarios_210421_lkpedt_refresh_grupo

  function do_ajax_form_usuarios_210421_lkpedt_refresh_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_usuarios_210421_lkpedt_refresh_grupo_cb

  function do_ajax_form_usuarios_210421_lkpedt_refresh_banco_movil()
  {
    var var_banco_movil = scAjaxGetFieldSelect("banco_movil");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "banco_movil";
    x_ajax_form_usuarios_210421_lkpedt_refresh_banco_movil(var_banco_movil, nmgp_refresh_fields, var_script_case_init, do_ajax_form_usuarios_210421_lkpedt_refresh_banco_movil_cb);
  } // do_ajax_form_usuarios_210421_lkpedt_refresh_banco_movil

  function do_ajax_form_usuarios_210421_lkpedt_refresh_banco_movil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_usuarios_210421_lkpedt_refresh_banco_movil_cb
  ...
  ajax_field_list[0] = "idusuarios";
  ajax_field_list[1] = "usuario";
  ajax_field_list[2] = "password";
  ajax_field_list[3] = "nombre";
  ajax_field_list[4] = "correo";
  ajax_field_list[5] = "telefono";
  ajax_field_list[6] = "tercero";
  ajax_field_list[7] = "resolucion";
  ajax_field_list[8] = "grupo";
  ajax_field_list[9] = "activo";
  ajax_field_list[10] = "grupocomanda";
  ajax_field_list[11] = "banco_movil";
  ajax_field_list[12] = "acceso_inventario";
  ajax_field_list[13] = "acceso_gerencial";
  ajax_field_list[14] = "acceso_restaurante";
  ajax_field_list[15] = "nombre_pc";
  ajax_field_list[16] = "nombre_impre";
  ajax_field_list[17] = "ubicacion";
  ajax_field_list[18] = "n_equipo";
  ajax_field_list[19] = "serial";
  ...
  var ajax_error_list = {
    "idusuarios": {"label": "Idusuarios", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "grupo": {"label": "Grupo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "activo": {"label": "Activo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "grupocomanda": {"label": "Grupo Comanda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "banco_movil": {"label": "Caja Predeterminada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "acceso_inventario": {"label": "Acceso Inventario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "acceso_gerencial": {"label": "Acceso Gerencial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "acceso_restaurante": {"label": "Acceso Restaurante", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "ubicacion": {"label": "Ubicación del PC", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "n_equipo": {"label": "Nombre del PC", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "grupo": new Array(),
    "activo": new Array(),
    "grupocomanda": new Array(),
    "banco_movil": new Array(),
    "acceso_inventario": new Array(),
    "acceso_gerencial": new Array(),
    "acceso_restaurante": new Array(),
    "nombre_pc": new Array(),
  ...
  ajax_field_mult["idusuarios"][1] = "idusuarios";
  ...
  ajax_field_mult["grupo"][1] = "grupo";
  ajax_field_mult["activo"][1] = "activo";
  ajax_field_mult["grupocomanda"][1] = "grupocomanda";
  ajax_field_mult["banco_movil"][1] = "banco_movil";
  ajax_field_mult["acceso_inventario"][1] = "acceso_inventario";
  ajax_field_mult["acceso_gerencial"][1] = "acceso_gerencial";
  ajax_field_mult["acceso_restaurante"][1] = "acceso_restaurante";
  ajax_field_mult["nombre_pc"][1] = "nombre_pc";
  ajax_field_mult["nombre_impre"][1] = "nombre_impre";
  ajax_field_mult["ubicacion"][1] = "ubicacion";
  ajax_field_mult["n_equipo"][1] = "n_equipo";
  ...
  var ajax_field_id = {
    ...
    "grupo": new Array("hidden_field_label_grupo", "hidden_field_data_grupo"),
    "activo": new Array("hidden_field_label_activo", "hidden_field_data_activo"),
    "grupocomanda": new Array("hidden_field_label_grupocomanda", "hidden_field_data_grupocomanda"),
    "banco_movil": new Array("hidden_field_label_banco_movil", "hidden_field_data_banco_movil"),
    "acceso_inventario": new Array("hidden_field_label_acceso_inventario", "hidden_field_data_acceso_inventario"),
    "acceso_gerencial": new Array("hidden_field_label_acceso_gerencial", "hidden_field_data_acceso_gerencial"),
    "acceso_restaurante": new Array("hidden_field_label_acceso_restaurante", "hidden_field_data_acceso_restaurante"),
    ...
    "n_equipo": new Array("hidden_field_label_n_equipo", "hidden_field_data_n_equipo"),
  ...
  var ajax_read_only = {
    ...
    "grupocomanda": "off",
    "banco_movil": "off",
    "acceso_inventario": "off",
    "acceso_gerencial": "off",
    "acceso_restaurante": "off",
    "nombre_pc": "off",
    "nombre_impre": "off",
    "ubicacion": "off",
    "n_equipo": "off",
