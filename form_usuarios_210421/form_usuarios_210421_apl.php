<?php
//
class form_usuarios_210421_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_usuarios_210421_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_usuarios_210421']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_usuarios_210421']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_usuarios_210421'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_usuarios_210421']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_usuarios_210421']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_usuarios_210421') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_usuarios_210421']['label'] = "Usuario";
      ...
      $_SESSION['scriptcase']['error_icon']['form_usuarios_210421']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_usuarios_210421'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_usuarios_210421']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_usuarios_210421'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_usuarios_210421'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_usuarios_210421", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_usuarios_210421_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_usuarios_210421_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_usuarios_210421/form_usuarios_210421_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_usuarios_210421_erro.class.php"); 
      }
      $this->Erro      = new form_usuarios_210421_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao']))
         { 
             if ($this->idusuarios != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_usuarios_210421']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['permisos'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['botoes']['permisos'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_usuarios_210421']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_usuarios_210421']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select']['grupo']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select']['grupo'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select']['usuario']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select']['usuario'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select']['activo']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->activo = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select']['activo'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_usuarios_210421.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_usuarios_210421_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_usuarios_210421"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_usuarios_210421']) || !is_array($this->NM_ajax_info['errList']['geral_form_usuarios_210421']))
              {
                  $this->NM_ajax_info['errList']['geral_form_usuarios_210421'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_usuarios_210421'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_usuario(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['usuario']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['usuario'] == "on")) 
      { 
          if ($this->usuario == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_password(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['password']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['password'] == "on")) 
      { 
          if ($this->password == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_nombre(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['nombre']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['nombre'] == "on")) 
      { 
          if ($this->nombre == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_correo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['correo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['correo'] == "on")) 
      { 
          if ($this->correo == "")  
          { 
              $hasError = true;
...
;
    ...
    function ValidateField_tercero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->tercero == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['tercero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['tercero'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->tercero) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_tercero']) && !in_array($this->tercero, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_tercero']))
          {
              $hasError = true;
    ...
    function ValidateField_resolucion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->resolucion == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['resolucion']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['resolucion'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->resolucion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_resolucion']) && !in_array($this->resolucion, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_resolucion']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['resolucion']))
    ...
    function ValidateField_grupo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->grupo == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['grupo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['php_cmp_required']['grupo'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Grupo" ; 
          ...
          if (!empty($this->grupo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_grupo']) && !in_array($this->grupo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_grupo']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['grupo']))
    ...
    function ValidateField_grupocomanda(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->grupocomanda) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_grupocomanda']) && !in_array($this->grupocomanda, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_grupocomanda']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_banco_movil(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->banco_movil) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_banco_movil']) && !in_array($this->banco_movil, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_banco_movil']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
...
;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idusuarios']['keyVal'] = form_usuarios_210421_pack_protect_string($this->nmgp_dados_form['idusuarios']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_usuarios_210421_pack_protect_string('') => str_replace('<', '&lt;',form_usuarios_210421_pack_protect_string('SELECCIONE')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_tercero'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_usuarios_210421_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_usuarios_210421_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tercero']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['resolucion']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_grupo'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['grupo']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_210421_pack_protect_string('S') => str_replace('<', '&lt;',form_usuarios_210421_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_activo'][] = 'S';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['activo']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_grupocomanda'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['grupocomanda']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['banco_movil']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_210421_pack_protect_string('SI') => str_replace('<', '&lt;',form_usuarios_210421_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_acceso_inventario'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['acceso_inventario']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_210421_pack_protect_string('SI') => str_replace('<', '&lt;',form_usuarios_210421_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_acceso_gerencial'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['acceso_gerencial']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_usuarios_210421_pack_protect_string('SI') => str_replace('<', '&lt;',form_usuarios_210421_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['Lookup_acceso_restaurante'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['acceso_restaurante']['valList'][$i] = form_usuarios_210421_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_serial($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
  ...
  function nm_proc_onload($bFormat = true)
  {
      ...
      $_SESSION['scriptcase']['form_usuarios_210421']['contr_erro'] = 'on';
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idusuarios)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
if(isset($this->vsiexiste[0][0]))
{
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_usuarios_210421';
...
$_SESSION['scriptcase']['form_usuarios_210421']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['parms'] = "idusuarios?#?$this->idusuarios?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_usuarios_210421 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total'] = $qt_geral_reg_form_usuarios_210421;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idusuarios))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_usuarios_210421 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] > $qt_geral_reg_form_usuarios_210421)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] = $qt_geral_reg_form_usuarios_210421; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_usuarios_210421) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] < $qt_geral_reg_form_usuarios_210421;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
        include_once("form_usuarios_210421_form0.php");
        include_once("form_usuarios_210421_form1.php");
        include_once("form_usuarios_210421_form2.php");
        include_once("form_usuarios_210421_form3.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_usuarios_210421 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['total'] = $qt_geral_reg_form_usuarios_210421;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_usuarios_210421_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_usuarios_210421_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_usuarios_210421_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_usuarios_210421']['masterValue']))
{
