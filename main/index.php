<?php
   include_once('main_session.php');
   @ini_set('session.cookie_httponly', 0);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['main']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['main']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['main']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['main']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['main']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['main']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['main']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['main']['glo_con_conn_mysql_1']         = "conn_mysql_1";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['main']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['main']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['main']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['main']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['main']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['main']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['main']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['main']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['main']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['main']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
...
class main_ini
{
   ...
   var $nm_db_conn_mysql_1;
   var $nm_con_conn_mysql_1 = array();
   var $sc_page;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['main']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "main"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      $this->nm_grupo        = "FACILWEBv2"; 
      $this->nm_grupo_versao = "1"; 
      $this->nm_autor        = "chucho"; 
      $this->nm_script_by    = "netmake";
      $this->nm_script_type  = "PHP";
      $this->nm_versao_sc    = "v9"; 
      $this->nm_tp_lic_sc    = "ep_bronze"; 
      $this->nm_dt_criacao   = "20220307"; 
      $this->nm_hr_criacao   = "171324"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['main']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['main']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['main']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['main']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['main']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['main']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['main']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['main']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['main']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/main';
      ...
      $_SESSION['sc_session'][$this->sc_page]['main']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['main']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['main']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['main']['actual_lang']) || $_SESSION['scriptcase']['main']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['main']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("main_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['main']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['main']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['main']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['main']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['main']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['main']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['main']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['main']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["main"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["main"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['main']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['main']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['main']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['main']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['main']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['main']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "main_erro.class.php"); 
      $this->Erro = new main_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('main'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['main']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['main']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['main']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['main']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['main']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['main']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['main']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['main']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      $this->conectExtra();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['main']['glo_nm_conexao']) && $_SESSION['scriptcase']['main']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['main']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['main']['glo_nm_perfil']) && $_SESSION['scriptcase']['main']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['main']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['main']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['main']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['main']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['main']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['main']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['main']['glo_nm_conexao']))
      {
          ...
          db_conect_devel('conn_mysql_1', $this->root . $this->path_prod, 'FACILWEBv2', 2, $this->force_db_utf8); 
          $this->nm_con_conn_mysql_1['servidor']    = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_mysql_1['usuario']     = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_mysql_1['banco']       = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_mysql_1['senha']       = $_SESSION['scriptcase']['glo_senha'];
          $this->nm_con_conn_mysql_1['tpbanco']     = $_SESSION['scriptcase']['glo_tpbanco'];
          $this->nm_con_conn_mysql_1['decimal']     = $_SESSION['scriptcase']['glo_decimal_db'];
          $this->nm_con_conn_mysql_1['SC_sep_date'] = $_SESSION['scriptcase']['glo_date_separator'];
          $this->nm_con_conn_mysql_1['protect']     = $_SESSION['scriptcase']['glo_senha_protect'];
          $this->nm_con_conn_mysql_1['glo_database_encoding'] = isset($_SESSION['scriptcase']['glo_database_encoding'])?$_SESSION['scriptcase']['glo_database_encoding']:'';
      ...
      if (isset($_SESSION['scriptcase']['main']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['main']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['main']['glo_nm_perfil'];
      }
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['main']['glo_con_conn_mysql_1'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_conn_mysql_1['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_mysql_1['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_mysql_1['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_mysql_1['senha']                  = $_SESSION['scriptcase']['glo_senha'];
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['main']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['main']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['main']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['main']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['main']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['main']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function conectExtra()
   {
      ...
      $databaseEncoding = $this->force_db_utf8 ? 'utf8' : $this->nm_con_conn_mysql_1['glo_database_encoding'];
      $this->nm_db_conn_mysql_1 = db_conect($this->nm_con_conn_mysql_1['tpbanco'], $this->nm_con_conn_mysql_1['servidor'], $this->nm_con_conn_mysql_1['usuario'], $this->nm_con_conn_mysql_1['senha'], $this->nm_con_conn_mysql_1['banco'], $this->nm_con_conn_mysql_1['protect'], 'S', 'N', '', $databaseEncoding); 
      if (in_array(strtolower($this->nm_con_conn_mysql_1['tpbanco']), $this->nm_bases_ibase))
      {
          if (function_exists('ibase_timefmt'))
          {
              ibase_timefmt('%Y-%m-%d %H:%M:%S');
      ...
      if (in_array(strtolower($this->nm_con_conn_mysql_1['tpbanco']), $this->nm_bases_sybase))
      {
          $this->nm_db_conn_mysql_1->fetchMode = ADODB_FETCH_BOTH;
          $this->nm_db_conn_mysql_1->Execute("set dateformat ymd");
          $this->nm_db_conn_mysql_1->Execute("set quoted_identifier ON");
      } 
      if (in_array(strtolower($this->nm_con_conn_mysql_1['tpbanco']), $this->nm_bases_mssql))
      {
          $this->nm_db_conn_mysql_1->Execute("set dateformat ymd");
      } 
      if (in_array(strtolower($this->nm_con_conn_mysql_1['tpbanco']), $this->nm_bases_oracle))
      {
          $this->nm_db_conn_mysql_1->Execute("alter session set nls_date_format = 'yyyy-mm-dd hh24:mi:ss'");
          $this->nm_db_conn_mysql_1->Execute("alter session set nls_numeric_characters = '.,'");
          $this->nm_con_conn_mysql_1['decimal'] = "."; 
      } 
      if (!$_SESSION['sc_session'][$this->sc_page]['main']['embutida'])
      {
          if (substr($_POST['nmgp_opcao'], 0, 5) == "ajax_")
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['main']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['main']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['main']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['main']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['main']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new main_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['main']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['main']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['main']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['main'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['main']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['main']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('main') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['main']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['main']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['main']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['main']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "main_erro.class.php"); 
      $this->Erro      = new main_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      $_SESSION['scriptcase']['main']['contr_erro'] = 'on';
 ?>
...
<html>
  <head>
    ...
    <meta name="description" content="FACILWEB">
    <meta name="author" content="FACILWEB" />
    
	  <?php
	  $_SESSION['modulo']="start";
	  $vfavicon=sc_url_library("prj", "librerias", "assets/img/favicon.png");
	  $vlogo= sc_url_library("prj", "imagenes", "logo.png");
	  $var1= sc_url_library("prj", "librerias", "assets/css/bootstrap.min.css");
	  $var2= sc_url_library("prj", "librerias", "assets/plugins/font-awesome-4.6.3/css/font-awesome.min.css");
	  $var3= sc_url_library("prj", "librerias", "assets/plugins/datatables/dataTables.bootstrap.css");
      $var4= sc_url_library("prj", "librerias", "assets/plugins/datepicker/datepicker.min.css");
	  $var5= sc_url_library("prj", "librerias", "assets/plugins/chosen/css/chosen.min.css");
	  $var6= sc_url_library("prj", "librerias", "assets/css/AdminLTE.min.css");
	  $var7= sc_url_library("prj", "librerias", "assets/css/skins/skin-blue.min.css");
	  $var8= sc_url_library("prj", "librerias", "assets/plugins/datepicker/datepicker3.css");
	  $var9= sc_url_library("prj", "librerias", "assets/css/style.css");

	  	$var10= sc_url_library("prj", "librerias", "assets/plugins/jQuery/jQuery-2.1.3.min.js");
		$var11= sc_url_library("prj", "librerias", "assets/js/bootstrap.min.js");
		$var12= sc_url_library("prj", "librerias", "assets/plugins/datepicker/bootstrap-datepicker.js");
		$var13= sc_url_library("prj", "librerias", "assets/plugins/chosen/js/chosen.jquery.min.js");
		$var14= sc_url_library("prj", "librerias", "assets/plugins/datatables/jquery.dataTables.js");
		$var15= sc_url_library("prj", "librerias", "assets/plugins/datatables/dataTables.bootstrap.js");
		$var16= sc_url_library("prj", "librerias", "assets/plugins/datepicker/bootstrap-datepicker.min.js");
		$var17= sc_url_library("prj", "librerias", "assets/plugins/slimScroll/jquery.slimscroll.min.js");
		$var18= sc_url_library("prj", "librerias", "assets/plugins/fastclick/fastclick.min.js");
		$var19= sc_url_library("prj", "librerias", "assets/js/jquery.maskMoney.min.js");
		$var20= sc_url_library("prj", "librerias", "assets/js/app.min.js");
	 ?> 
	
    <!-- favicon -->
    <link rel="shortcut icon" href="<?php echo $vfavicon; ?>" />
    <!-- Bootstrap 3.3.2 -->
    <link href="<?php echo $var1; ?>" rel="stylesheet" type="text/css" />    
    <!-- FontAwesome 4.3.0 -->
    <link href="<?php echo $var2; ?>" rel="stylesheet" type="text/css" />  
    <!-- DATA TABLES -->
    <link href="<?php echo $var3; ?>" rel="stylesheet" type="text/css" />
    <!-- Datepicker -->
    <link href="<?php echo $var4; ?>" rel="stylesheet" type="text/css" />
    <!-- Chosen Select -->
    <link rel="stylesheet" type="text/css" href="<?php echo $var5; ?>" />
    <!-- Theme style -->
    <link href="<?php echo $var6; ?>" rel="stylesheet" type="text/css" />
    <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
    <link href="<?php echo $var7; ?>" rel="stylesheet" type="text/css" />
    <!-- Date Picker -->
    <link href="<?php echo $var8; ?>" rel="stylesheet" type="text/css" />
    <!-- Custom CSS -->
    <link href="<?php echo $var9; ?>" rel="stylesheet" type="text/css" />
    
	 <!-- jQuery 2.1.3 -->
    <script src="<?php echo $var10; ?>"></script>
    <!-- Bootstrap 3.3.2 JS -->
    <script src="<?php echo $var11; ?>" type="text/javascript"></script>    
    <!-- datepicker -->
    <script src="<?php echo $var12; ?>" type="text/javascript"></script>
    <!-- chosen select -->
    <script src="<?php echo $var13; ?>"></script>
    <!-- DATA TABES SCRIPT -->
    <script src="<?php echo $var14; ?>" type="text/javascript"></script>
    <script src="<?php echo $var15; ?>" type="text/javascript"></script>
    <!-- Datepicker -->
    <script src="<?php echo $var16; ?>" type="text/javascript"></script>
    <!-- Slimscroll -->
    <script src="<?php echo $var17; ?>" type="text/javascript"></script>
    <!-- FastClick -->
    <script src='<?php echo $var18; ?>'></script>
    <!-- maskMoney -->
    <script src="<?php echo $var19; ?>"></script>
    <!-- AdminLTE App -->
    <script src="<?php echo $var20; ?>" type="text/javascript"></script>
	...
	<style>
	  ...
	  <?php
		$vsql="select item from menu_arbol where enlace is not null";
      ...
      $this->vArray = array();
      $this->varray = array();
      if ($SCrx = $this->Ini->nm_db_conn_mysql_1->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 { 
                        $this->vArray[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->varray[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vArray = false;
          $this->vArray_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
          $this->varray = false;
          $this->varray_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
      } 
;
		...
		for($it=0;$it<count($this->varray );$it++){
			$arrayitems[$it]=$this->varray[$it][0];
			}
	  ?>
	  
    <script language="javascript">
					
				function MostrarTab(evt, opcion,enlace){
				 var arrayboton=<?php echo json_encode($arrayitems); ?>;	
				 var cantidad= arrayboton.length;
				 var btn="btn_"+opcion;
				 var iframe="";
				 for(var i=0;i<cantidad;i++){
				 	if(arrayboton[ i]==opcion){
						btn="btn_"+arrayboton[ i];
						iframe="iframe_"+arrayboton[ i];
						document.getElementById(btn).style.background = "#2871b5";
						document.getElementById(btn).style.color = "white";
						document.getElementById(iframe).style.display = "block";
				  		document.getElementById(iframe).src = enlace;
					}else{
						btn="btn_"+arrayboton[ i];
						iframe="iframe_"+arrayboton[ i];
						document.getElementById(iframe).style.display = "none";
						document.getElementById(btn).style.background = "#CFD1CD";
		...
		function openIframe(evt, enlace,boton){ 
					 var arrayboton=<?php echo json_encode($arrayitems); ?>;	
					 var cantidad= arrayboton.length;
					 var btn="btn_"+boton;
					var iframe="";
					 for(var i=0;i<cantidad;i++){
						if(arrayboton[ i]==boton){
							btn="btn_"+arrayboton[ i];
							iframe="iframe_"+arrayboton[ i];
							document.getElementById(btn).style.background = "#2871b5";	
							document.getElementById(btn).style.color = "white";	
	...
	$(document).ready(function(){
		...
		$(".iframetabs").css("height",window.innerHeight);
	});
    </script>
  ...
  <body class="skin-blue fixed">
    <div class="wrapper">
      <header class="main-header">
        <!-- Logo -->
        <a href="../beranda" class="logo" style="background:#2871b5;">
          <img style="margin-top:-15px;margin-right:5px;width:80px;height:40px;" src="<?php echo $vlogo; ?>" alt="Logo"> 
          <span style="font-size:20px">FACILWEB</span>
        </a>
		<nav class="navbar navbar-static-top" role="navigation" style="background:#2871b5;">
          <!-- Sidebar toggle button-->
          <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
            <span class="sr-only">Toggle navigation</span>
          </a>
          	<div class="navbar-custom-menu" style="background:#2871b5;">
              ...
              <li class="dropdown user user-menu">
				  ...
				  <ul class="dropdown-menu">
					...
					<li class="user-footer">
					  <div class="pull-left">
						<a style="width:80px" href="../profile" class="btn btn-default btn-flat">Perfil</a>
					  </div>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar" style="background:#2871b5;color:white;">
	        <!-- MENU LATERAL  -->
            <ul class="sidebar-menu">
				<li class="header" style="background:#2871b5;color:white;" >MENU</li>
					...
					<?php
						...
						$vdescripcion='';
						$vposicion='';
						$vmodulo=$_SESSION['modulo'];
				
						$vsql="SELECT descripcion,posicion,icono FROM menu_arbol WHERE length(posicion)=1";
      ...
      { 
          $this->vMenu = false;
          $this->vMenu_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
          $this->vmenu = false;
          $this->vmenu_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
      } 
;										
							...
							for($i=0;$i<count($this->vmenu );$i++) { 
								$vdescripcion=$this->vmenu[$i][0];
								
								$vposicion=$this->vmenu[$i][1];
								$vicono=$this->vmenu[$i][2];

								?>
									<li>
											<a href="javascript:void(0);">
												<i class="fa <?php echo $vicono;  ?>"></i> <span><?php echo $vdescripcion;  ?></span> <i class="fa fa-angle-left pull-right"></i>
											</a>
											<ul class="treeview-menu">
												<?php
													$vsql="SELECT descripcion,enlace,posicion,item,icono FROM menu_arbol WHERE length(posicion)=3 and posicion like '$vposicion%' ";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vMenu1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vmenu1[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vMenu1 = false;
          $this->vMenu1_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
          $this->vmenu1 = false;
          $this->vmenu1_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
      } 
;

													for($j=0;$j<count($this->vmenu1 );$j++) {
														$vdescripcion1=$this->vmenu1[$j][0];
														$venlace=$this->vmenu1[$j][1];
														$vposicion1=$this->vmenu1[$j][2];
														$vitem1=$this->vmenu1[$j][3];
														$vicono1=$this->vmenu1[$j][4];
														if(empty($venlace) || is_null($venlace) || $venlace==''){
															echo "<script>console.log('Console: " .$vdescripcion1. "' );</script>";
													?>	
												        <a href="javascript:void(0);">
															<li><i class="fa <?php echo $vicono1;?>"></i><span><?php echo $vdescripcion1;?></span><i class="fa fa-angle-left pull-right"></i>
														</a>		
													<?php
														}else{
															echo "<script>console.log('Console1: " . $venlace .$vitem1. "' );</script>";
														?>	
														
												<li><a class="submenu" onclick="MostrarTab(event,'<?php echo $vitem1; ?>','<?php echo $venlace; ?>')"><i class="fa <?php echo $vicono1;?>"></i><span style="padding-top:10px;"><?php echo $vdescripcion1;?></span></a>
													...
													?>		
															<ul class="treeview-menu">
																<?php
																	$vsql="SELECT descripcion,enlace,posicion,item,icono FROM menu_arbol WHERE length(posicion)=5 and posicion like '$vposicion1%' ";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vMenu2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vmenu2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vMenu2 = false;
          $this->vMenu2_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
          $this->vmenu2 = false;
          $this->vmenu2_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
      } 
;
																	...
																	for($k=0;$k<count($this->vmenu2 );$k++) {
																		$vdescripcion2=$this->vmenu2[$k][0];
																		$venlace2=$this->vmenu2[$k][1];
																		$vposicion2=$this->vmenu2[$k][2];
																		$vitem2=$this->vmenu2[$k][3];
																		$vicono2=$this->vmenu2[$k][4];
																		
																	?>	
																		<li><a class="submenu" onclick="MostrarTab(event,'<?php echo $vitem2; ?>','<?php echo $venlace2; ?>')"><i class="fa <?php echo $vicono2;?>"></i><span style="padding-top:10px;"><?php echo $vdescripcion2;?></span></a>
      ...
      <div id="contenido" class="content-wrapper" style="background:white;">
			
        	<!-- CREO LAS TABS DE MANERA AUTOMATICA -->
				<?php  
			  	    $vcont = 0;
					$vsql="select descripcion,enlace,item from menu_arbol where enlace is not null";
					 
      $nm_select = $vsql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vTabs_Items = array();
      $this->vtabs_items = array();
      if ($SCrx = $this->Ini->nm_db_conn_mysql_1->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vTabs_Items[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vtabs_items[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vTabs_Items = false;
          $this->vTabs_Items_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
          $this->vtabs_items = false;
          $this->vtabs_items_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
      } 
;
					for($t=0;$t<count($this->vtabs_items );$t++)
					{
						if($t==0)
						{
							echo "<div style='display:inline-block;'>";
						}
						$vTdescripcion=$this->vtabs_items[$t][0];
						$vTenlace=$this->vtabs_items[$t][1];
						$vTitem=$this->vtabs_items[$t][2];
						$vTiframe="iframe_".$vTitem;
						
						echo "<div class='tab' id=".$vTitem." style='display:none;'>";
						echo "<button id='btn_".$vTitem."' class='tablinks' onclick='openIframe(event,\"".$vTenlace."\",\"".$vTitem."\" );'>".$vTdescripcion."</button>";
						echo "<button style='padding: 2px 6px;border:1px solid black;border: none;
				  outline: none;' onclick='document.getElementById(\"".$vTitem."\").style.display=\"none\";'>X</button>";
						echo "</div>";
						$vcont++;
					}
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vIframe[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->viframe[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vIframe = false;
          $this->vIframe_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
          $this->viframe = false;
          $this->viframe_erro = $this->Ini->nm_db_conn_mysql_1->ErrorMsg();
      } 
;
					for($t=0;$t<count($this->viframe );$t++)
					{
						$vIframe=$this->viframe[$t][2];
						$vEnlace=$this->viframe[$t][1];
						echo "<iframe id='iframe_".$vIframe."'  class='iframetabs' width='100%' height='250px' src='$vEnlace' scrolling='yes'></iframe>";
					}	
          ...
          <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                    <a type="button" class="btn btn-danger" href="../logout/index.php">Si, Salir</a>
      ...
      <!--<footer class="main-footer">
        <strong>Copyright &copy; <?php echo date('Y');?> - <a href="http://www.facilwebnube.com" target="_blank">FACILWEB</a>.</strong>
      </footer> -->
    </div><!-- ./wrapper -->
...
<?php
$_SESSION['scriptcase']['main']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       $this->Ini->nm_db_conn_mysql_1->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['main']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['main']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "main") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['main']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['main']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['main']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['main']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['main']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['main']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['main']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "main";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'main' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['main']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['main']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['main']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['main']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['main']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('main' == $sReferer || 'main_' == substr($sReferer, 0, 5))
       {
           $_SESSION['sc_session'][$script_case_init]['main']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'main')
   {
       $_SESSION['sc_session'][$script_case_init]['main']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['main']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/main_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
   ...
   $contr_main = new main_apl();
   $contr_main->controle();
//
   function nm_limpa_str_main(&$str)
   {
