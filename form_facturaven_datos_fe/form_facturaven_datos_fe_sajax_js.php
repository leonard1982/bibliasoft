  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_facturaven_datos_fe" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_facturaven_datos_fe_form();
	}
...
?>
  ...
  function do_ajax_form_facturaven_datos_fe_validate_advertencia()
  {
  } // do_ajax_form_facturaven_datos_fe_validate_advertencia

  function do_ajax_form_facturaven_datos_fe_validate_advertencia_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_advertencia_cb

  // ---------- Validate cufe
  function do_ajax_form_facturaven_datos_fe_validate_cufe()
  {
    var nomeCampo_cufe = "cufe";
    var var_cufe = scAjaxGetFieldText(nomeCampo_cufe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_cufe(var_cufe, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_cufe_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_cufe

  function do_ajax_form_facturaven_datos_fe_validate_cufe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cufe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_cufe_cb

  // ---------- Validate enlacepdf
  function do_ajax_form_facturaven_datos_fe_validate_enlacepdf()
  {
    var nomeCampo_enlacepdf = "enlacepdf";
    var var_enlacepdf = scAjaxGetFieldText(nomeCampo_enlacepdf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_enlacepdf(var_enlacepdf, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_enlacepdf_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_enlacepdf

  function do_ajax_form_facturaven_datos_fe_validate_enlacepdf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_enlacepdf_cb

  // ---------- Validate estado
  function do_ajax_form_facturaven_datos_fe_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_estado(var_estado, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_estado_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_estado

  function do_ajax_form_facturaven_datos_fe_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_estado_cb

  // ---------- Validate avisos
  function do_ajax_form_facturaven_datos_fe_validate_avisos()
  {
    var nomeCampo_avisos = "avisos";
    var var_avisos = scAjaxGetFieldText(nomeCampo_avisos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_avisos(var_avisos, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_avisos_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_avisos

  function do_ajax_form_facturaven_datos_fe_validate_avisos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avisos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_avisos_cb

  // ---------- Validate qr_base64
  function do_ajax_form_facturaven_datos_fe_validate_qr_base64()
  {
    var nomeCampo_qr_base64 = "qr_base64";
    var var_qr_base64 = scAjaxGetFieldText(nomeCampo_qr_base64);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_qr_base64(var_qr_base64, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_qr_base64_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_qr_base64

  function do_ajax_form_facturaven_datos_fe_validate_qr_base64_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_qr_base64_cb

  // ---------- Validate id_trans_fe
  function do_ajax_form_facturaven_datos_fe_validate_id_trans_fe()
  {
    var nomeCampo_id_trans_fe = "id_trans_fe";
    var var_id_trans_fe = scAjaxGetFieldText(nomeCampo_id_trans_fe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_id_trans_fe(var_id_trans_fe, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_id_trans_fe_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_id_trans_fe

  function do_ajax_form_facturaven_datos_fe_validate_id_trans_fe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_id_trans_fe_cb

  // ---------- Validate fecha_validacion
  function do_ajax_form_facturaven_datos_fe_validate_fecha_validacion()
  {
    var nomeCampo_fecha_validacion = "fecha_validacion";
    var var_fecha_validacion = scAjaxGetFieldText(nomeCampo_fecha_validacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_fecha_validacion(var_fecha_validacion, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_fecha_validacion_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_fecha_validacion

  function do_ajax_form_facturaven_datos_fe_validate_fecha_validacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_fecha_validacion_cb

  // ---------- Validate proveedor
  function do_ajax_form_facturaven_datos_fe_validate_proveedor()
  {
    var nomeCampo_proveedor = "proveedor";
    var var_proveedor = scAjaxGetFieldSelect(nomeCampo_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_proveedor(var_proveedor, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_proveedor_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_proveedor

  function do_ajax_form_facturaven_datos_fe_validate_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_proveedor_cb

  // ---------- Validate token
  function do_ajax_form_facturaven_datos_fe_validate_token()
  {
    var nomeCampo_token = "token";
    var var_token = scAjaxGetFieldText(nomeCampo_token);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_token(var_token, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_token_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_token

  function do_ajax_form_facturaven_datos_fe_validate_token_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "token";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_token_cb

  // ---------- Validate password
  function do_ajax_form_facturaven_datos_fe_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_password(var_password, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_password_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_password

  function do_ajax_form_facturaven_datos_fe_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_password_cb

  // ---------- Validate servidor
  function do_ajax_form_facturaven_datos_fe_validate_servidor()
  {
    var nomeCampo_servidor = "servidor";
    var var_servidor = scAjaxGetFieldText(nomeCampo_servidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_validate_servidor(var_servidor, var_script_case_init, do_ajax_form_facturaven_datos_fe_validate_servidor_cb);
  } // do_ajax_form_facturaven_datos_fe_validate_servidor

  function do_ajax_form_facturaven_datos_fe_validate_servidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_validate_servidor_cb

  // ---------- Event onchange proveedor
  function do_ajax_form_facturaven_datos_fe_event_proveedor_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_facturaven_datos_fe_event_proveedor_onchange(var_proveedor, var_servidor, var_token, var_password, var_script_case_init, do_ajax_form_facturaven_datos_fe_event_proveedor_onchange_cb);
  } // do_ajax_form_facturaven_datos_fe_event_proveedor_onchange

  function do_ajax_form_facturaven_datos_fe_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "proveedor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_facturaven_datos_fe_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_form_facturaven_datos_fe_event_proveedor_onchange_cb
  function do_ajax_form_facturaven_datos_fe_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_facturaven_datos_fe_event_proveedor_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_facturaven_datos_fe_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_facturaven_datos_fe_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_facturaven_datos_fe_submit_form(var_advertencia, var_cufe, var_enlacepdf, var_estado, var_avisos, var_qr_base64, var_id_trans_fe, var_fecha_validacion, var_proveedor, var_token, var_password, var_servidor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_facturaven_datos_fe_submit_form_cb);
  } // do_ajax_form_facturaven_datos_fe_submit_form

  function do_ajax_form_facturaven_datos_fe_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_facturaven_datos_fe_submit_form_cb_after_alert);
  } // do_ajax_form_facturaven_datos_fe_submit_form_cb
  function do_ajax_form_facturaven_datos_fe_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_facturaven_datos_fe_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_facturaven_datos_fe_navigate_form()
  {
    perform_ajax_form_facturaven_datos_fe_navigate_form();
  }

  function perform_ajax_form_facturaven_datos_fe_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_facturaven_datos_fe_navigate_form(var_idfacven, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_datos_fe_navigate_form_cb);
  } // do_ajax_form_facturaven_datos_fe_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_datos_fe']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_facturaven_datos_fe_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_facturaven_datos_fe_navigate_form_cb_after_alert);
  } // do_ajax_form_facturaven_datos_fe_navigate_form_cb
  function do_ajax_form_facturaven_datos_fe_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_facturaven_datos_fe_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_facturaven_datos_fe_navigate_form_cb_after_alert
  function sc_hide_form_facturaven_datos_fe_form()
  {
