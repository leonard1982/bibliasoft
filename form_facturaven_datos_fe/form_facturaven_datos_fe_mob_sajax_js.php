  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_facturaven_datos_fe_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_facturaven_datos_fe_mob_form();
	}
...
?>
  ...
  // ---------- Validate advertencia
  function do_ajax_form_facturaven_datos_fe_mob_validate_advertencia()
  {
  } // do_ajax_form_facturaven_datos_fe_mob_validate_advertencia

  function do_ajax_form_facturaven_datos_fe_mob_validate_advertencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "advertencia";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_advertencia_cb

  // ---------- Validate cufe
  function do_ajax_form_facturaven_datos_fe_mob_validate_cufe()
  {
    var nomeCampo_cufe = "cufe";
    var var_cufe = scAjaxGetFieldText(nomeCampo_cufe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_cufe(var_cufe, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_cufe_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_cufe

  function do_ajax_form_facturaven_datos_fe_mob_validate_cufe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cufe";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_cufe_cb

  // ---------- Validate enlacepdf
  function do_ajax_form_facturaven_datos_fe_mob_validate_enlacepdf()
  {
    var nomeCampo_enlacepdf = "enlacepdf";
    var var_enlacepdf = scAjaxGetFieldText(nomeCampo_enlacepdf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_enlacepdf(var_enlacepdf, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_enlacepdf_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_enlacepdf

  function do_ajax_form_facturaven_datos_fe_mob_validate_enlacepdf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "enlacepdf";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_enlacepdf_cb

  // ---------- Validate estado
  function do_ajax_form_facturaven_datos_fe_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_estado_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_estado

  function do_ajax_form_facturaven_datos_fe_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_estado_cb

  // ---------- Validate avisos
  function do_ajax_form_facturaven_datos_fe_mob_validate_avisos()
  {
    var nomeCampo_avisos = "avisos";
    var var_avisos = scAjaxGetFieldText(nomeCampo_avisos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_avisos(var_avisos, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_avisos_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_avisos

  function do_ajax_form_facturaven_datos_fe_mob_validate_avisos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "avisos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_avisos_cb

  // ---------- Validate qr_base64
  function do_ajax_form_facturaven_datos_fe_mob_validate_qr_base64()
  {
    var nomeCampo_qr_base64 = "qr_base64";
    var var_qr_base64 = scAjaxGetFieldText(nomeCampo_qr_base64);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_qr_base64(var_qr_base64, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_qr_base64_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_qr_base64

  function do_ajax_form_facturaven_datos_fe_mob_validate_qr_base64_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "qr_base64";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_qr_base64_cb

  // ---------- Validate id_trans_fe
  function do_ajax_form_facturaven_datos_fe_mob_validate_id_trans_fe()
  {
    var nomeCampo_id_trans_fe = "id_trans_fe";
    var var_id_trans_fe = scAjaxGetFieldText(nomeCampo_id_trans_fe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_id_trans_fe(var_id_trans_fe, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_id_trans_fe_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_id_trans_fe

  function do_ajax_form_facturaven_datos_fe_mob_validate_id_trans_fe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_trans_fe";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_id_trans_fe_cb

  // ---------- Validate fecha_validacion
  function do_ajax_form_facturaven_datos_fe_mob_validate_fecha_validacion()
  {
    var nomeCampo_fecha_validacion = "fecha_validacion";
    var var_fecha_validacion = scAjaxGetFieldText(nomeCampo_fecha_validacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_fecha_validacion(var_fecha_validacion, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_fecha_validacion_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_fecha_validacion

  function do_ajax_form_facturaven_datos_fe_mob_validate_fecha_validacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_validacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_fecha_validacion_cb

  // ---------- Validate proveedor
  function do_ajax_form_facturaven_datos_fe_mob_validate_proveedor()
  {
    var nomeCampo_proveedor = "proveedor";
    var var_proveedor = scAjaxGetFieldSelect(nomeCampo_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_proveedor(var_proveedor, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_proveedor_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_proveedor

  function do_ajax_form_facturaven_datos_fe_mob_validate_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_proveedor_cb

  // ---------- Validate token
  function do_ajax_form_facturaven_datos_fe_mob_validate_token()
  {
    var nomeCampo_token = "token";
    var var_token = scAjaxGetFieldText(nomeCampo_token);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_token(var_token, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_token_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_token

  function do_ajax_form_facturaven_datos_fe_mob_validate_token_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "token";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_token_cb

  // ---------- Validate password
  function do_ajax_form_facturaven_datos_fe_mob_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_password(var_password, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_password_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_password

  function do_ajax_form_facturaven_datos_fe_mob_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_password_cb

  // ---------- Validate servidor
  function do_ajax_form_facturaven_datos_fe_mob_validate_servidor()
  {
    var nomeCampo_servidor = "servidor";
    var var_servidor = scAjaxGetFieldText(nomeCampo_servidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_datos_fe_mob_validate_servidor(var_servidor, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_validate_servidor_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_validate_servidor

  function do_ajax_form_facturaven_datos_fe_mob_validate_servidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_datos_fe_mob_validate_servidor_cb

  // ---------- Event onchange proveedor
  function do_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange()
  {
    var var_proveedor = scAjaxGetFieldSelect("proveedor");
    var var_servidor = scAjaxGetFieldText("servidor");
    var var_token = scAjaxGetFieldText("token");
    var var_password = scAjaxGetFieldText("password");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange(var_proveedor, var_servidor, var_token, var_password, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange

  function do_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "proveedor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange_cb
  function do_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_facturaven_datos_fe_mob_event_proveedor_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_facturaven_datos_fe_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_facturaven_datos_fe_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_advertencia = scAjaxGetFieldHidden("advertencia");
    var var_cufe = scAjaxGetFieldText("cufe");
    var var_enlacepdf = scAjaxGetFieldText("enlacepdf");
    var var_estado = scAjaxGetFieldSelect("estado");
    var var_avisos = scAjaxGetFieldText("avisos");
    var var_qr_base64 = scAjaxGetFieldText("qr_base64");
    var var_id_trans_fe = scAjaxGetFieldText("id_trans_fe");
    var var_fecha_validacion = scAjaxGetFieldText("fecha_validacion");
    var var_proveedor = scAjaxGetFieldSelect("proveedor");
    var var_token = scAjaxGetFieldText("token");
    var var_password = scAjaxGetFieldText("password");
    var var_servidor = scAjaxGetFieldText("servidor");
    ...
    scAjaxProcOn();
    x_ajax_form_facturaven_datos_fe_mob_submit_form(var_advertencia, var_cufe, var_enlacepdf, var_estado, var_avisos, var_qr_base64, var_id_trans_fe, var_fecha_validacion, var_proveedor, var_token, var_password, var_servidor, var_idfacven, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_facturaven_datos_fe_mob_submit_form_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_submit_form

  function do_ajax_form_facturaven_datos_fe_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("advertencia");
      scAjaxHideErrorDisplay("cufe");
      scAjaxHideErrorDisplay("enlacepdf");
      scAjaxHideErrorDisplay("estado");
      scAjaxHideErrorDisplay("avisos");
      scAjaxHideErrorDisplay("qr_base64");
      scAjaxHideErrorDisplay("id_trans_fe");
      scAjaxHideErrorDisplay("fecha_validacion");
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_datos_fe_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_datos_fe_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_datos_fe_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_facturaven_datos_fe_mob_submit_form_cb_after_alert);
  } // do_ajax_form_facturaven_datos_fe_mob_submit_form_cb
  function do_ajax_form_facturaven_datos_fe_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_facturaven_datos_fe_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_facturaven_datos_fe_mob_navigate_form()
  {
    perform_ajax_form_facturaven_datos_fe_mob_navigate_form();
  }

  function perform_ajax_form_facturaven_datos_fe_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_facturaven_datos_fe_mob_navigate_form(var_idfacven, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_datos_fe_mob_navigate_form_cb);
  } // do_ajax_form_facturaven_datos_fe_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_datos_fe_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_facturaven_datos_fe_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_facturaven_datos_fe_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_facturaven_datos_fe_mob_navigate_form_cb
  function do_ajax_form_facturaven_datos_fe_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_facturaven_datos_fe_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_facturaven_datos_fe_mob_navigate_form_cb_after_alert
  function sc_hide_form_facturaven_datos_fe_mob_form()
  {
  ...
  ajax_field_list[0] = "advertencia";
  ajax_field_list[1] = "cufe";
  ajax_field_list[2] = "enlacepdf";
  ajax_field_list[3] = "estado";
  ajax_field_list[4] = "avisos";
  ajax_field_list[5] = "qr_base64";
  ajax_field_list[6] = "id_trans_fe";
  ajax_field_list[7] = "fecha_validacion";
  ajax_field_list[8] = "proveedor";
  ajax_field_list[9] = "token";
  ajax_field_list[10] = "password";
  ajax_field_list[11] = "servidor";
  ...
  var ajax_error_list = {
    "advertencia": {"label": "Advertencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cufe": {"label": "CUFE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "enlacepdf": {"label": "Enlace PDF", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estado": {"label": "Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "avisos": {"label": "Avisos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "qr_base64": {"label": "QR Base 64", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_trans_fe": {"label": "Id Trans Fe", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_validacion": {"label": "Fecha Validacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "servidor": {"label": "Servidor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "advertencia": new Array(),
    "cufe": new Array(),
    "enlacepdf": new Array(),
    "estado": new Array(),
    "avisos": new Array(),
    "qr_base64": new Array(),
    "id_trans_fe": new Array(),
    "fecha_validacion": new Array(),
    "proveedor": new Array(),
    "token": new Array(),
    "password": new Array(),
    "servidor": new Array()
  };
  ajax_field_mult["advertencia"][1] = "advertencia";
  ajax_field_mult["cufe"][1] = "cufe";
  ajax_field_mult["enlacepdf"][1] = "enlacepdf";
  ajax_field_mult["estado"][1] = "estado";
  ajax_field_mult["avisos"][1] = "avisos";
  ajax_field_mult["qr_base64"][1] = "qr_base64";
  ajax_field_mult["id_trans_fe"][1] = "id_trans_fe";
  ajax_field_mult["fecha_validacion"][1] = "fecha_validacion";
  ...
  var ajax_field_id = {
    "advertencia": new Array("hidden_field_label_advertencia", "hidden_field_data_advertencia"),
    "cufe": new Array("hidden_field_label_cufe", "hidden_field_data_cufe"),
    "enlacepdf": new Array("hidden_field_label_enlacepdf", "hidden_field_data_enlacepdf"),
    "estado": new Array("hidden_field_label_estado", "hidden_field_data_estado"),
    "avisos": new Array("hidden_field_label_avisos", "hidden_field_data_avisos"),
    "qr_base64": new Array("hidden_field_label_qr_base64", "hidden_field_data_qr_base64"),
    "id_trans_fe": new Array("hidden_field_label_id_trans_fe", "hidden_field_data_id_trans_fe"),
    "fecha_validacion": new Array("hidden_field_label_fecha_validacion", "hidden_field_data_fecha_validacion"),
    "proveedor": new Array("hidden_field_label_proveedor", "hidden_field_data_proveedor"),
    "token": new Array("hidden_field_label_token", "hidden_field_data_token"),
