...
<?php
   ...
   $Ord_Cmp = new grid_caja_informe_pos_03092021_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_caja_informe_pos_03092021_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["banco"] : "Banco/Caja";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["cantidad"] : "Facturado";
   ...
   $tab_labels["efectivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["efectivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["efectivo"] : "Efectivo";
   ...
   $tab_labels["tarjeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["tarjeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["tarjeta"] : "Tarjeta Cred/Deb";
   ...
   $tab_labels["cheques"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["cheques"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["cheques"] : "Cheques u otros";
   ...
   $tab_labels["formas_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["formas_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['labels']["formas_pago"] : "Total formas de Pago";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_caja_informe_pos_03092021_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_caja_informe_pos_03092021']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
