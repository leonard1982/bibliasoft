...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_caja_informe_pos_03092021"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_caja_informe_pos_03092021"]);
   }
