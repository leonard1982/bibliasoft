...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_caja_informe_pos_03092021"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_caja_informe_pos_03092021"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_caja_informe_pos_03092021</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_caja_informe_pos_03092021']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_caja_informe_pos_03092021' || $achou)
          {
