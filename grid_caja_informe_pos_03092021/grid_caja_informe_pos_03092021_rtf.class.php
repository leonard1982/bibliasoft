...
class grid_caja_informe_pos_03092021_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_caja_informe_pos_03092021.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_caja_informe_pos_03092021']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos_03092021']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos_03092021']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos_03092021']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos_03092021']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos_03092021']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos_03092021']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_caja_informe_pos_03092021']['contr_erro'] = 'off'; 
   ...
   function NM_export_formas_pago()
   {
         ...
         $this->formas_pago = str_replace('<', '&lt;', $this->formas_pago);
         $this->formas_pago = str_replace('>', '&gt;', $this->formas_pago);
         $this->Texto_tag .= "<td>" . $this->formas_pago . "</td>\r\n";
   }
   //----- detalle
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos_03092021']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos_03092021']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<HEAD>
 <TITLE>Resumen diario POS (Ventas de Contado) :: RTF</TITLE>
