...
@session_start() ;
class form_movimiento_conv_mob_help
{
...
<?php echo "<b>Concepto del ajuste</b><br>" . nl2br("FORMATO DE NOTA PARA CONVERTIR UN PRODUCTO EN OTRO DE ESCALA MENOR. EJ: BULTO DE CEMENTO EN CEMENTO X KG - ESCALA 42"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_movimiento_conv_mob_help();
?>
