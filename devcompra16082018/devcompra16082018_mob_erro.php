...
$old_error_handler = set_error_handler("devcompra16082018_mob_scriptcase_error_handler");

function devcompra16082018_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['devcompra16082018_mob']['contr_erro']) && $_SESSION['scriptcase']['devcompra16082018_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_devcompra16082018_mob->contr_devcompra16082018_mob->Apl_com_erro = true;
            if ($inicial_devcompra16082018_mob->contr_devcompra16082018_mob->NM_ajax_flag)
            {
                $inicial_devcompra16082018_mob->contr_devcompra16082018_mob->NM_ajax_info['errList']['geral_devcompra16082018_mob'][] = $msg;
                return;
            }
            devcompra16082018_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function devcompra16082018_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['devcompra16082018_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['devcompra16082018_mob'])  ? $_SESSION['scriptcase']['error_icon']['devcompra16082018_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['devcompra16082018_mob']) && '' != $_SESSION['scriptcase']['error_close']['devcompra16082018_mob']) ? $_SESSION['scriptcase']['error_close']['devcompra16082018_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['devcompra16082018_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['devcompra16082018_mob']) ? $_SESSION['scriptcase']['error_span_title']['devcompra16082018_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['devcompra16082018_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['devcompra16082018_mob']) ? $_SESSION['scriptcase']['error_icon_title']['devcompra16082018_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['devcompra16082018']['error_buffer'] .= ob_get_flush();
}
