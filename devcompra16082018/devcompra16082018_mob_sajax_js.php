  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_devcompra16082018_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_devcompra16082018_mob_form();
	}
...
?>
  ...
  // ---------- Validate proveedor
  function do_ajax_devcompra16082018_mob_validate_proveedor()
  {
    var nomeCampo_proveedor = "proveedor";
    var var_proveedor = scAjaxGetFieldSelect(nomeCampo_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devcompra16082018_mob_validate_proveedor(var_proveedor, var_script_case_init, do_ajax_devcompra16082018_mob_validate_proveedor_cb);
  } // do_ajax_devcompra16082018_mob_validate_proveedor

  function do_ajax_devcompra16082018_mob_validate_proveedor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devcompra16082018_mob_validate_proveedor_cb

  // ---------- Validate compra
  function do_ajax_devcompra16082018_mob_validate_compra()
  {
    var nomeCampo_compra = "compra";
    var var_compra = scAjaxGetFieldSelect(nomeCampo_compra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devcompra16082018_mob_validate_compra(var_compra, var_script_case_init, do_ajax_devcompra16082018_mob_validate_compra_cb);
  } // do_ajax_devcompra16082018_mob_validate_compra

  function do_ajax_devcompra16082018_mob_validate_compra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "compra";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devcompra16082018_mob_validate_compra_cb

  // ---------- Refresh proveedor
  function do_ajax_devcompra16082018_mob_refresh_proveedor()
  {
    var var_proveedor = scAjaxGetFieldSelect("proveedor");
    var var_nmgp_refresh_fields = "compra";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devcompra16082018_mob_refresh_proveedor(var_proveedor, var_nmgp_refresh_fields, var_script_case_init, do_ajax_devcompra16082018_mob_refresh_proveedor_cb);
  } // do_ajax_devcompra16082018_mob_refresh_proveedor

  function do_ajax_devcompra16082018_mob_refresh_proveedor_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devcompra16082018_mob_refresh_proveedor_cb

  // ---------- Event onchange proveedor
  function do_ajax_devcompra16082018_mob_event_proveedor_onchange()
  {
    var var_proveedor = scAjaxGetFieldSelect("proveedor");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devcompra16082018_mob_event_proveedor_onchange(var_proveedor, var_script_case_init, do_ajax_devcompra16082018_mob_event_proveedor_onchange_cb);
  } // do_ajax_devcompra16082018_mob_event_proveedor_onchange

  function do_ajax_devcompra16082018_mob_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "proveedor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_devcompra16082018_mob_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_devcompra16082018_mob_event_proveedor_onchange_cb
  function do_ajax_devcompra16082018_mob_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_devcompra16082018_mob_refresh_proveedor();
    scAjaxRedir();
  } // do_ajax_devcompra16082018_mob_event_proveedor_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_devcompra16082018_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_devcompra16082018_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_proveedor = scAjaxGetFieldSelect("proveedor");
    var var_compra = scAjaxGetFieldSelect("compra");
    ...
    scAjaxProcOn();
    x_ajax_devcompra16082018_mob_submit_form(var_proveedor, var_compra, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_devcompra16082018_mob_submit_form_cb);
  } // do_ajax_devcompra16082018_mob_submit_form

  function do_ajax_devcompra16082018_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devcompra16082018_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devcompra16082018_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['devcompra16082018_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_devcompra16082018_mob_submit_form_cb_after_alert);
  } // do_ajax_devcompra16082018_mob_submit_form_cb
  function do_ajax_devcompra16082018_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_devcompra16082018_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_devcompra16082018_mob_navigate_form()
  {
    perform_ajax_devcompra16082018_mob_navigate_form();
  }

  function perform_ajax_devcompra16082018_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_devcompra16082018_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['devcompra16082018_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_devcompra16082018_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_devcompra16082018_mob_navigate_form_cb_after_alert);
  } // do_ajax_devcompra16082018_mob_navigate_form_cb
  function do_ajax_devcompra16082018_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_devcompra16082018_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_devcompra16082018_mob_navigate_form_cb_after_alert
  function sc_hide_devcompra16082018_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "compra": {"label": "No de Documento Compra", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["compra"][1] = "compra";

  var ajax_field_id = {
    "proveedor": new Array("hidden_field_label_proveedor", "hidden_field_data_proveedor"),
    "compra": new Array("hidden_field_label_compra", "hidden_field_data_compra")
  };
