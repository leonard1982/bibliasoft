...
$old_error_handler = set_error_handler("devcompra16082018_scriptcase_error_handler");

function devcompra16082018_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['devcompra16082018']['contr_erro']) && $_SESSION['scriptcase']['devcompra16082018']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_devcompra16082018;
            $inicial_devcompra16082018->contr_devcompra16082018->Apl_com_erro = true;
            if ($inicial_devcompra16082018->contr_devcompra16082018->NM_ajax_flag)
            {
                $inicial_devcompra16082018->contr_devcompra16082018->NM_ajax_info['errList']['geral_devcompra16082018'][] = $msg;
                return;
            }
            devcompra16082018_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function devcompra16082018_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['devcompra16082018'])  && '' != $_SESSION['scriptcase']['error_icon']['devcompra16082018'])  ? $_SESSION['scriptcase']['error_icon']['devcompra16082018']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['devcompra16082018']) && '' != $_SESSION['scriptcase']['error_close']['devcompra16082018']) ? $_SESSION['scriptcase']['error_close']['devcompra16082018'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['devcompra16082018']) && '' != $_SESSION['scriptcase']['error_span_title']['devcompra16082018']) ? $_SESSION['scriptcase']['error_span_title']['devcompra16082018'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['devcompra16082018']) && '' != $_SESSION['scriptcase']['error_icon_title']['devcompra16082018']) ? $_SESSION['scriptcase']['error_icon_title']['devcompra16082018'] : '';
?>
