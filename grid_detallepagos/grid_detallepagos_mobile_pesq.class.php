...
class grid_detallepagos_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detallepagos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detallepagos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detallepagos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_iddetall')
      {
          $iddetall = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_iddetall($iddetall);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idfact')
      {
          $idfact = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idfact($idfact);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idrc')
      {
          $idrc = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idrc($idrc);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idfp')
      {
          $idfp = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idfp($idfp);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_iddetall($iddetall)
   {
      $iddetall = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $iddetall);
      $iddetall = substr($this->Db->qstr($iddetall), 1, -1);
            $iddetall_look = substr($this->Db->qstr($iddetall), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and   CAST (iddetall AS TEXT)  like '%" . $iddetall . "%' order by iddetall"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and   CAST (iddetall AS VARCHAR)  like '%" . $iddetall . "%' order by iddetall"; 
      }
      else
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and  iddetall like '%" . $iddetall . "%' order by iddetall"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_idfact($idfact)
   {
      $idfact = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idfact);
      $idfact = substr($this->Db->qstr($idfact), 1, -1);
            $idfact_look = substr($this->Db->qstr($idfact), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and   CAST (idfact AS TEXT)  like '%" . $idfact . "%' order by idfact"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and   CAST (idfact AS VARCHAR)  like '%" . $idfact . "%' order by idfact"; 
      }
      else
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and  idfact like '%" . $idfact . "%' order by idfact"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_idrc($idrc)
   {
      $idrc = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idrc);
      $idrc = substr($this->Db->qstr($idrc), 1, -1);
            $idrc_look = substr($this->Db->qstr($idrc), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and   CAST (idrc AS TEXT)  like '%" . $idrc . "%' order by idrc"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and   CAST (idrc AS VARCHAR)  like '%" . $idrc . "%' order by idrc"; 
      }
      else
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and  idrc like '%" . $idrc . "%' order by idrc"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_idfp($idfp)
   {
      $idfp = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idfp);
      $idfp = substr($this->Db->qstr($idfp), 1, -1);
            $idfp_look = substr($this->Db->qstr($idfp), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and   CAST (idfp AS TEXT)  like '%" . $idfp . "%' order by idfp"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and   CAST (idfp AS VARCHAR)  like '%" . $idfp . "%' order by idfp"; 
      }
      else
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and  idfp like '%" . $idfp . "%' order by idfp"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fechacob";$Nm_datas[] = "fechacob";$Nm_numeric[] = "iddetall";$Nm_numeric[] = "idfact";$Nm_numeric[] = "idrc";$Nm_numeric[] = "idfp";$Nm_numeric[] = "monto";
      ...
      $Nm_datas[] = "fechacob";$Nm_datas[] = "fechacob";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detallepagos/grid_detallepagos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detallepagos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detallepagos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detallepagos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallepagos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallepagos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_iddetall_cond#NMF#' + search_get_sel_txt('SC_iddetall_cond') + '@NMF@';
  str_out += 'SC_iddetall#NMF#' + search_get_text('SC_iddetall') + '@NMF@';
  str_out += 'id_ac_iddetall#NMF#' + search_get_title('select2-id_ac_iddetall-container') + '@NMF@';
  str_out += 'SC_iddetall_input_2#NMF#' + search_get_text('SC_iddetall_input_2') + '@NMF@';
  str_out += 'SC_idfact_cond#NMF#' + search_get_sel_txt('SC_idfact_cond') + '@NMF@';
  str_out += 'SC_idfact#NMF#' + search_get_text('SC_idfact') + '@NMF@';
  str_out += 'id_ac_idfact#NMF#' + search_get_title('select2-id_ac_idfact-container') + '@NMF@';
  str_out += 'SC_idfact_input_2#NMF#' + search_get_text('SC_idfact_input_2') + '@NMF@';
  str_out += 'SC_idrc_cond#NMF#' + search_get_sel_txt('SC_idrc_cond') + '@NMF@';
  str_out += 'SC_idrc#NMF#' + search_get_text('SC_idrc') + '@NMF@';
  str_out += 'id_ac_idrc#NMF#' + search_get_title('select2-id_ac_idrc-container') + '@NMF@';
  str_out += 'SC_idrc_input_2#NMF#' + search_get_text('SC_idrc_input_2') + '@NMF@';
  str_out += 'SC_idfp_cond#NMF#' + search_get_sel_txt('SC_idfp_cond') + '@NMF@';
  str_out += 'SC_idfp#NMF#' + search_get_text('SC_idfp') + '@NMF@';
  str_out += 'id_ac_idfp#NMF#' + search_get_title('select2-id_ac_idfp-container') + '@NMF@';
  str_out += 'SC_idfp_input_2#NMF#' + search_get_text('SC_idfp_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-idfact").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idfact",
      max_itens: "10",
   ...
   $("#SC_idfact").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-idfp").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idfp",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_idfp").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-iddetall").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_iddetall",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_iddetall").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-idrc").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idrc",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - detallepagos</span></td>
...
<?php
   ...
   {
      global 
             $iddetall_cond, $iddetall, $iddetall_input_2, $iddetall_autocomp,
             $idfact_cond, $idfact, $idfact_input_2, $idfact_autocomp,
             $idrc_cond, $idrc, $idrc_input_2, $idrc_autocomp,
             $idfp_cond, $idfp, $idfp_input_2, $idfp_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_detallepagos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $iddetall = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['iddetall']; 
          $iddetall_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['iddetall_input_2']; 
          $iddetall_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['iddetall_cond']; 
          $idfact = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfact']; 
          $idfact_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfact_input_2']; 
          $idfact_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfact_cond']; 
          $idrc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idrc']; 
          $idrc_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idrc_input_2']; 
          $idrc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idrc_cond']; 
          $idfp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfp']; 
          $idfp_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfp_input_2']; 
          $idfp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfp_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['NM_operador']; 
      } 
      if (!isset($iddetall_cond) || empty($iddetall_cond))
      {
         $iddetall_cond = "gt";
      }
      if (!isset($idfact_cond) || empty($idfact_cond))
      {
         $idfact_cond = "gt";
      }
      if (!isset($idrc_cond) || empty($idrc_cond))
      {
         $idrc_cond = "gt";
      }
      if (!isset($idfp_cond) || empty($idfp_cond))
      {
         $idfp_cond = "gt";
      }
      ...
      $str_hide_iddetall = (in_array($iddetall_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idfact = (in_array($idfact_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idrc = (in_array($idrc_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idfp = (in_array($idfp_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_iddetall = ('bw' == $iddetall_cond) ? $display_aberto : $display_fechado;
      $str_display_idfact = ('bw' == $idfact_cond) ? $display_aberto : $display_fechado;
      $str_display_idrc = ('bw' == $idrc_cond) ? $display_aberto : $display_fechado;
      $str_display_idfp = ('bw' == $idfp_cond) ? $display_aberto : $display_fechado;

      if (!isset($iddetall) || $iddetall == "")
      {
          $iddetall = "";
      }
      if (isset($iddetall) && !empty($iddetall))
      {
         $tmp_pos = strpos($iddetall, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $iddetall = substr($iddetall, 0, $tmp_pos);
         }
      }
      if (!isset($idfact) || $idfact == "")
      {
          $idfact = "";
      }
      if (isset($idfact) && !empty($idfact))
      {
         $tmp_pos = strpos($idfact, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idfact = substr($idfact, 0, $tmp_pos);
         }
      }
      if (!isset($idrc) || $idrc == "")
      {
...
?>
 ...
 $nmgp_tab_label .= "iddetall?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_iddetall_cond" name="iddetall_cond" onChange="nm_campos_between(document.getElementById('id_vis_iddetall'), this, 'iddetall')">
       <OPTION value="gt" <?php if ("gt" == $iddetall_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $iddetall_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $iddetall_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $iddetall_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_iddetall"  <?php echo $str_hide_iddetall?>><?php
      if ($iddetall != "")
      {
      $iddetall_look = substr($this->Db->qstr($iddetall), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($iddetall))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and iddetall = $iddetall_look order by iddetall"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and iddetall = $iddetall_look order by iddetall"; 
      ...
      if (isset($nmgp_def_dados[0][$iddetall]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$iddetall];
      }
      else
      {
            nmgp_Form_Num_Val($iddetall, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $iddetall;
      }
?>
<INPUT  type="text" id="SC_iddetall" name="iddetall" value="<?php echo NM_encode_input($iddetall) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-iddetall" id="id_ac_iddetall" name="iddetall_autocomp"><?php if ('' !=  $iddetall) { ?><option value="<?php echo $iddetall ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_iddetall"  <?php echo $str_display_iddetall; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_iddetall_input_2" name="iddetall_input_2" value="<?php echo NM_encode_input($iddetall_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "idfact?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idfact_cond" name="idfact_cond" onChange="nm_campos_between(document.getElementById('id_vis_idfact'), this, 'idfact')">
       <OPTION value="gt" <?php if ("gt" == $idfact_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idfact_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idfact_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idfact_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idfact"  <?php echo $str_hide_idfact?>><?php
      if ($idfact != "")
      {
      $idfact_look = substr($this->Db->qstr($idfact), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and idfact = $idfact_look order by idfact"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and idfact = $idfact_look order by idfact"; 
      ...
      if (isset($nmgp_def_dados[0][$idfact]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idfact];
      }
      else
      {
            nmgp_Form_Num_Val($idfact, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idfact;
      }
?>
<INPUT  type="text" id="SC_idfact" name="idfact" value="<?php echo NM_encode_input($idfact) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-idfact" id="id_ac_idfact" name="idfact_autocomp"><?php if ('' !=  $idfact) { ?><option value="<?php echo $idfact ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idfact"  <?php echo $str_display_idfact; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idfact_input_2" name="idfact_input_2" value="<?php echo NM_encode_input($idfact_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idrc_cond" name="idrc_cond" onChange="nm_campos_between(document.getElementById('id_vis_idrc'), this, 'idrc')">
       <OPTION value="gt" <?php if ("gt" == $idrc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idrc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idrc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idrc_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idrc"  <?php echo $str_hide_idrc?>><?php
      if ($idrc != "")
      {
      $idrc_look = substr($this->Db->qstr($idrc), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and idrc = $idrc_look order by idrc"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and idrc = $idrc_look order by idrc"; 
      ...
      if (isset($nmgp_def_dados[0][$idrc]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idrc];
      }
      else
      {
            nmgp_Form_Num_Val($idrc, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idrc;
      }
?>
<INPUT  type="text" id="SC_idrc" name="idrc" value="<?php echo NM_encode_input($idrc) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idrc" id="id_ac_idrc" name="idrc_autocomp"><?php if ('' !=  $idrc) { ?><option value="<?php echo $idrc ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idrc"  <?php echo $str_display_idrc; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idrc_input_2" name="idrc_input_2" value="<?php echo NM_encode_input($idrc_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idfp_cond" name="idfp_cond" onChange="nm_campos_between(document.getElementById('id_vis_idfp'), this, 'idfp')">
       <OPTION value="gt" <?php if ("gt" == $idfp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idfp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idfp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idfp_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idfp"  <?php echo $str_hide_idfp?>><?php
      if ($idfp != "")
      {
      $idfp_look = substr($this->Db->qstr($idfp), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and idfp = $idfp_look order by idfp"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idfact=" . $_SESSION['par_idfa'] . " and  idfact<>0 and idfp = $idfp_look order by idfp"; 
      ...
      if (isset($nmgp_def_dados[0][$idfp]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idfp];
      }
      else
      {
            nmgp_Form_Num_Val($idfp, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idfp;
      }
?>
<INPUT  type="text" id="SC_idfp" name="idfp" value="<?php echo NM_encode_input($idfp) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-idfp" id="id_ac_idfp" name="idfp_autocomp"><?php if ('' !=  $idfp) { ?><option value="<?php echo $idfp ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idfp"  <?php echo $str_display_idfp; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idfp_input_2" name="idfp_input_2" value="<?php echo NM_encode_input($idfp_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<?php
   if (is_file("grid_detallepagos_help.txt"))
   {
      $Arq_WebHelp = file("grid_detallepagos_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.iddetall_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_iddetall'), document.F1.iddetall_cond, 'iddetall');
   document.F1.iddetall.value = "";
   document.F1.iddetall_autocomp.value = "";
   $('#select2-id_ac_iddetall-container').html('<?php echo $this->Val_init_iddetall['desc'] ?>');;
   document.F1.iddetall_input_2.value = "";
   document.F1.idfact_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idfact'), document.F1.idfact_cond, 'idfact');
   document.F1.idfact.value = "";
   document.F1.idfact_autocomp.value = "";
   $('#select2-id_ac_idfact-container').html('<?php echo $this->Val_init_idfact['desc'] ?>');;
   document.F1.idfact_input_2.value = "";
   document.F1.idrc_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idrc'), document.F1.idrc_cond, 'idrc');
   document.F1.idrc.value = "";
   document.F1.idrc_autocomp.value = "";
   $('#select2-id_ac_idrc-container').html('<?php echo $this->Val_init_idrc['desc'] ?>');;
   document.F1.idrc_input_2.value = "";
   document.F1.idfp_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idfp'), document.F1.idfp_cond, 'idfp');
   document.F1.idfp.value = "";
   document.F1.idfp_autocomp.value = "";
   $('#select2-id_ac_idfp-container').html('<?php echo $this->Val_init_idfp['desc'] ?>');;
   document.F1.idfp_input_2.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_detallepagos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_iddetall_cond'] = 'cond';
      $tp_fields['SC_iddetall'] = 'text_aut';
      $tp_fields['id_ac_iddetall'] = 'select2_aut';
      $tp_fields['SC_iddetall_input_2'] = 'text';
      $tp_fields['SC_idfact_cond'] = 'cond';
      $tp_fields['SC_idfact'] = 'text_aut';
      $tp_fields['id_ac_idfact'] = 'select2_aut';
      $tp_fields['SC_idfact_input_2'] = 'text';
      $tp_fields['SC_idrc_cond'] = 'cond';
      $tp_fields['SC_idrc'] = 'text_aut';
      $tp_fields['id_ac_idrc'] = 'select2_aut';
      $tp_fields['SC_idrc_input_2'] = 'text';
      $tp_fields['SC_idfp_cond'] = 'cond';
      $tp_fields['SC_idfp'] = 'text_aut';
      $tp_fields['id_ac_idfp'] = 'select2_aut';
      $tp_fields['SC_idfp_input_2'] = 'text';
   ...
   {
      global $iddetall_cond, $iddetall, $iddetall_input_2, $iddetall_autocomp,
             $idfact_cond, $idfact, $idfact_input_2, $idfact_autocomp,
             $idrc_cond, $idrc, $idrc_input_2, $idrc_autocomp,
             $idfp_cond, $idfp, $idfp_input_2, $idfp_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($iddetall_autocomp) && empty($iddetall))
      {
          $iddetall = $iddetall_autocomp;
      }
      if (!empty($idfact_autocomp) && empty($idfact))
      {
          $idfact = $idfact_autocomp;
      }
      if (!empty($idrc_autocomp) && empty($idrc))
      {
          $idrc = $idrc_autocomp;
      }
      if (!empty($idfp_autocomp) && empty($idfp))
      {
          $idfp = $idfp_autocomp;
      }
      $iddetall_cond_salva = $iddetall_cond; 
      if (!isset($iddetall_input_2) || $iddetall_input_2 == "")
      {
          $iddetall_input_2 = $iddetall;
      }
      $idfact_cond_salva = $idfact_cond; 
      if (!isset($idfact_input_2) || $idfact_input_2 == "")
      {
          $idfact_input_2 = $idfact;
      }
      $idrc_cond_salva = $idrc_cond; 
      if (!isset($idrc_input_2) || $idrc_input_2 == "")
      {
          $idrc_input_2 = $idrc;
      }
      $idfp_cond_salva = $idfp_cond; 
      if (!isset($idfp_input_2) || $idfp_input_2 == "")
      {
          $idfp_input_2 = $idfp;
      }
      if ($iddetall_cond != "in")
      {
          nm_limpa_numero($iddetall, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($iddetall_cond != "in")
      {
          nm_limpa_numero($iddetall_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idfact_cond != "in")
      {
          nm_limpa_numero($idfact, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idfact_cond != "in")
      {
          nm_limpa_numero($idfact_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idrc_cond != "in")
      {
          nm_limpa_numero($idrc, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idrc_cond != "in")
      {
          nm_limpa_numero($idrc_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idfp_cond != "in")
      {
          nm_limpa_numero($idfp, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idfp_cond != "in")
      {
          nm_limpa_numero($idfp_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['iddetall'] = $iddetall; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['iddetall_input_2'] = $iddetall_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['iddetall_cond'] = $iddetall_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfact'] = $idfact; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfact_input_2'] = $idfact_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfact_cond'] = $idfact_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idrc'] = $idrc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idrc_input_2'] = $idrc_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idrc_cond'] = $idrc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfp'] = $idfp; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfp_input_2'] = $idfp_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['idfp_cond'] = $idfp_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca'] = $Temp_Busca;
      }
      if ($iddetall_cond != "in" && $iddetall_cond != "bw" && !empty($iddetall) && !is_numeric($iddetall))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Iddetall";
      }
      if ($iddetall_cond == "bw" && ((!empty($iddetall) && !is_numeric($iddetall)) || (!empty($iddetall_input_2) && !is_numeric($iddetall_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Iddetall";
      }
      if ($idfact_cond != "in" && $idfact_cond != "bw" && !empty($idfact) && !is_numeric($idfact))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Factura N°";
      }
      if ($idfact_cond == "bw" && ((!empty($idfact) && !is_numeric($idfact)) || (!empty($idfact_input_2) && !is_numeric($idfact_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Factura N°";
      }
      if ($idrc_cond != "in" && $idrc_cond != "bw" && !empty($idrc) && !is_numeric($idrc))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Recibo Caja N°";
      }
      if ($idrc_cond == "bw" && ((!empty($idrc) && !is_numeric($idrc)) || (!empty($idrc_input_2) && !is_numeric($idrc_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Recibo Caja N°";
      }
      if ($idfp_cond != "in" && $idfp_cond != "bw" && !empty($idfp) && !is_numeric($idfp))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Forma de pago";
      }
      if ($idfp_cond == "bw" && ((!empty($idfp) && !is_numeric($idfp)) || (!empty($idfp_input_2) && !is_numeric($idfp_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Forma de pago";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['iddetall'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['iddetall'] = $cmp1;
      }
      else
      {
          $cmp1 = $iddetall;
      ...
      $Conteudo = $iddetall_input_2;
      if (strtoupper($iddetall_cond) != "II" && strtoupper($iddetall_cond) != "QP" && strtoupper($iddetall_cond) != "NP" && strtoupper($iddetall_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['iddetall_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idfact != '') {
      $idfact_look = substr($this->Db->qstr($idfact), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idfact'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['idfact'] = $cmp1;
      }
      else
      {
          $cmp1 = $idfact;
      ...
      $Conteudo = $idfact_input_2;
      if (strtoupper($idfact_cond) != "II" && strtoupper($idfact_cond) != "QP" && strtoupper($idfact_cond) != "NP" && strtoupper($idfact_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idfact_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idrc != '') {
      $idrc_look = substr($this->Db->qstr($idrc), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      $Conteudo = $idrc_input_2;
      if (strtoupper($idrc_cond) != "II" && strtoupper($idrc_cond) != "QP" && strtoupper($idrc_cond) != "NP" && strtoupper($idrc_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idrc_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idfp != '') {
      $idfp_look = substr($this->Db->qstr($idfp), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      $Conteudo = $idfp_input_2;
      if (strtoupper($idfp_cond) != "II" && strtoupper($idfp_cond) != "QP" && strtoupper($idfp_cond) != "NP" && strtoupper($idfp_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idfp_input_2'] = $Conteudo;

      //----- $iddetall
      $this->Date_part = false;
      if (isset($iddetall) || $iddetall_cond == "nu" || $iddetall_cond == "nn" || $iddetall_cond == "ep" || $iddetall_cond == "ne")
      {
         $this->monta_condicao("iddetall", $iddetall_cond, $iddetall, $iddetall_input_2, "iddetall");
      }

      //----- $idfact
      $this->Date_part = false;
      if (isset($idfact) || $idfact_cond == "nu" || $idfact_cond == "nn" || $idfact_cond == "ep" || $idfact_cond == "ne")
      {
         $this->monta_condicao("idfact", $idfact_cond, $idfact, $idfact_input_2, "idfact");
      }

      //----- $idrc
      $this->Date_part = false;
      if (isset($idrc) || $idrc_cond == "nu" || $idrc_cond == "nn" || $idrc_cond == "ep" || $idrc_cond == "ne")
      {
         $this->monta_condicao("idrc", $idrc_cond, $idrc, $idrc_input_2, "idrc");
      }

      //----- $idfp
      $this->Date_part = false;
      if (isset($idfp) || $idfp_cond == "nu" || $idfp_cond == "nn" || $idfp_cond == "ep" || $idfp_cond == "ne")
      {
         $this->monta_condicao("idfp", $idfp_cond, $idfp, $idfp_input_2, "idfp");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['cond_pesq'] .= $this->NM_operador;
