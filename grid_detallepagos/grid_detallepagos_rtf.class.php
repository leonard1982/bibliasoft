...
class grid_detallepagos_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      require_once($this->Ini->path_aplicacao . "grid_detallepagos_total.class.php"); 
      $this->Tot      = new grid_detallepagos_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['SC_Ind_Groupby'];
      if (method_exists($this->Tot,$Gb_geral))
      {
          $this->Tot->$Gb_geral();
          $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['tot_geral'][1];
      }
      if (!$this->Ini->sc_export_ajax) {
      ...
      $this->Arquivo   .= "_grid_detallepagos";
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_detallepagos.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['usr_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['php_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['campos_busca'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['rtf_name']);
      }
      ...
      $this->Texto_tag .= "<tr>\r\n";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['field_order'] as $Cada_col)
      { 
      ...
      { 
          $nmgp_select = "SELECT idfact, idfp, monto, banco, numcheque, str_replace (convert(char(10),fechacob,102), '.', '-') + ' ' + convert(char(8),fechacob,20), iddetall, idrc from " . $this->Ini->nm_tabela; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nmgp_select = "SELECT idfact, idfp, monto, banco, numcheque, fechacob, iddetall, idrc from " . $this->Ini->nm_tabela; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
       $nmgp_select = "SELECT idfact, idfp, monto, banco, numcheque, convert(char(23),fechacob,121), iddetall, idrc from " . $this->Ini->nm_tabela; 
      } 
      ...
      { 
          $nmgp_select = "SELECT idfact, idfp, monto, banco, numcheque, EXTEND(fechacob, YEAR TO DAY), iddetall, idrc from " . $this->Ini->nm_tabela; 
      } 
      else 
      { 
          $nmgp_select = "SELECT idfact, idfp, monto, banco, numcheque, fechacob, iddetall, idrc from " . $this->Ini->nm_tabela; 
      } 
      $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq'];
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->Texto_tag .= "<tr>\r\n";
         $this->idfact = $rs->fields[0] ;  
         $this->idfact = (string)$this->idfact;
         $this->idfp = $rs->fields[1] ;  
         $this->idfp = (string)$this->idfp;
         $this->monto = $rs->fields[2] ;  
         ...
         $this->banco = $rs->fields[3] ;  
         $this->numcheque = $rs->fields[4] ;  
         $this->fechacob = $rs->fields[5] ;  
         $this->iddetall = $rs->fields[6] ;  
         ...
         $_SESSION['scriptcase']['grid_detallepagos']['contr_erro'] = 'on';
 if($this->idfact >0)
	{
...
$_SESSION['scriptcase']['grid_detallepagos']['contr_erro'] = 'off'; 
   ...
   function NM_export_idrc()
   {
         ...
         $this->idrc = NM_charset_to_utf8($this->idrc);
         $this->idrc = str_replace('<', '&lt;', $this->idrc);
         $this->idrc = str_replace('>', '&gt;', $this->idrc);
         $this->Texto_tag .= "<td>" . $this->idrc . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos'][$path_doc_md5][1] = $this->Tit_doc;
