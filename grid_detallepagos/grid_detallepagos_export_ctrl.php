<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallepagos']['sc_process_barr'] = true;
require_once('../grid_detallepagos/index.php');
unset($_SESSION['scriptcase']['grid_detallepagos']['sc_process_barr']);
$ExportCtrl = new grid_detallepagos_export_control;
$ExportCtrl->Export_barr();

class grid_detallepagos_export_control
{
