<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_produccion']['sc_process_barr'] = true;
require_once('../pdfreport_produccion/index.php');
unset($_SESSION['scriptcase']['pdfreport_produccion']['sc_process_barr']);
$ExportCtrl = new pdfreport_produccion_export_control;
$ExportCtrl->Export_barr();

class pdfreport_produccion_export_control
{
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - produccion</TITLE>
