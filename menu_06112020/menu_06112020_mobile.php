...
<html>
    <head>
        ...
        <title>Facturación y manejo de Inventarios - [empresa]</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_06112020"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_SweetBlue_facilwebv2/Sc9_SweetBlue_facilwebv2_menuMobile.css" />
        <link rel="stylesheet"  href="<?php echo $this->url_css; ?>Sc9_SweetBlue_facilwebv2/Sc9_SweetBlue_facilwebv2_menuMobile<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" />
        <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
        <script src="<?php echo $_SESSION["scriptcase"]["menu_06112020"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_06112020"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_06112020_menuData["data"]) && is_array($menu_06112020_menuData["data"]) && !empty($menu_06112020_menuData["data"]))
    {
        foreach($menu_06112020_menuData["data"] as $arr_item)
        {
...
<table width="100%" height="67px" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($menu_06112020_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
