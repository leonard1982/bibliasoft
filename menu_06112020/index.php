...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_06112020']['glo_nm_perfil']         = "conn_mysql";
    $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo']      = "";
    $_SESSION['scriptcase']['menu_06112020']['glo_con_conn_facilweb'] = "conn_facilweb";
...
class menu_06112020_class
{
 ...
 function menu_06112020_menu()
 {
    global $menu_06112020_menuData, $nm_data_fixa;
...
$path_img_old   = $str_root . $path_link . "menu_06112020/img";
...
include_once(dirname(__FILE__) . "/menu_06112020_erro.class.php"); 
$this->Erro = new menu_06112020_erro();
$str_path = substr($_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_06112020']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_06112020_menuData         = array();
$menu_06112020_menuData['path'] = array();
$menu_06112020_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_06112020_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_06112020_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_06112020_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_06112020_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_06112020_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_06112020_menuData['url']['web']   = str_replace("\\", '/', $menu_06112020_menuData['url']['web']);
$menu_06112020_menuData['path']['root'] = substr($menu_06112020_menuData['path']['sys'],  0, -1 * strlen($menu_06112020_menuData['url']['web']));
$menu_06112020_menuData['path']['app']  = substr($menu_06112020_menuData['path']['sys'],  0, strrpos($menu_06112020_menuData['path']['sys'],  '/'));
$menu_06112020_menuData['path']['link'] = substr($menu_06112020_menuData['path']['app'],  0, strrpos($menu_06112020_menuData['path']['app'],  '/'));
$menu_06112020_menuData['path']['link'] = substr($menu_06112020_menuData['path']['link'], 0, strrpos($menu_06112020_menuData['path']['link'], '/')) . '/';
$menu_06112020_menuData['path']['app'] .= '/';
$menu_06112020_menuData['url']['app']   = substr($menu_06112020_menuData['url']['web'],  0, strrpos($menu_06112020_menuData['url']['web'],  '/'));
$menu_06112020_menuData['url']['link']  = substr($menu_06112020_menuData['url']['app'],  0, strrpos($menu_06112020_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] == "S")
{
    $menu_06112020_menuData['url']['link']  = substr($menu_06112020_menuData['url']['link'], 0, strrpos($menu_06112020_menuData['url']['link'], '/'));
}
$menu_06112020_menuData['url']['link']  .= '/';
$menu_06112020_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_06112020']['sc_apl_link'] = $menu_06112020_menuData['url']['link'];
...
include_once("menu_06112020_toolbar.php");
...
if ($_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_06112020";
     $_SESSION['scriptcase']['menu_apls']['menu_06112020'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_06112020']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_06112020']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_06112020']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_06112020']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_06112020']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_06112020']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_06112020']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_06112020']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
{
    $_SESSION['sc_session'][1]['menu_06112020']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_06112020']['init']))
{
    $_SESSION['sc_session'][1]['menu_06112020']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_06112020']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_06112020']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_06112020'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_06112020'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_06112020'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
...
if (isset($_SESSION['scriptcase']['glo_perfil']) && !empty($_SESSION['scriptcase']['glo_perfil']))
{
    ...
    carrega_perfil($_SESSION['scriptcase']['menu_06112020']['glo_con_conn_facilweb'], $path_libs, "S");
    $this->nm_con_conn_facilweb['servidor']    = $_SESSION['scriptcase']['glo_servidor'];
    $this->nm_con_conn_facilweb['usuario']     = $_SESSION['scriptcase']['glo_usuario'];
    $this->nm_con_conn_facilweb['banco']       = $_SESSION['scriptcase']['glo_banco'];
    $this->nm_con_conn_facilweb['senha']       = $_SESSION['scriptcase']['glo_senha'];
...
$_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
...
if (!isset($this->sc_temp_gusuariologueado)) {$this->sc_temp_gusuariologueado = (isset($_SESSION['gusuariologueado'])) ? $_SESSION['gusuariologueado'] : "";}
  ?>
<!--<script src="<?php //echo sc_url_library('prj', 'js', 'js_notificaciones/jquery.min.js'); ?>"></script>-->
<!--<script src="<?php //echo sc_url_library('prj', 'js', 'js_notificaciones/popper.min.js'); ?>"></script>-->
<!--<link rel="stylesheet" type="text/css" href="<?php //echo sc_url_library('prj', 'js', 'js_notificaciones/bootstrap.min.css'); ?>">-->
<!--<script src="<?php //echo sc_url_library('prj', 'js', 'js_notificaciones/bootstrap.min.js'); ?>"></script>-->
...
<script>
	$(document).ready(function(){
		...
		$("#Iframe_control").hover(function(){
				
				console.log("Log de ocultar menu: ");
				console.log($("#bmenu").css("display"));
				if($("#bmenu").css("display")=="none")
				{
					$("#bmenu").click();
...
unset($_SESSION['scriptcase']['sc_menu_disable']['menu_06112020']);if(empty($this->sc_temp_gusuariologueado))
{
 ...
 {
$this->nmgp_redireciona_form($menu_06112020_menuData['url']['link'] . $this->tab_grupo[0] . "" . SC_dir_app_name('blank_iniciar_sesion') . "/", "menu_06112020.php", "","_self", 440, 630);
 };
}
else
{
...
{
    $_SESSION['scriptcase']['sc_menu_del']['menu_06112020'][] = trim($Cada_del);
}
...
foreach ($NM_tmp_dis as $Cada_dis)
{
    ...
    if (!in_array($Cada_dis, $_SESSION['scriptcase']['sc_menu_disable']['menu_06112020']))
    {
      ...
      $nm_select = "select desactivar_control_sesion from configuraciones where desactivar_control_sesion='NO' order by idconfiguraciones desc limit 1"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vDatosNube = array();
      $this->vdatosnube = array();
...
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_06112020'))
{
    $_SESSION['sc_session'][1]['menu_06112020']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_06112020'] = "javascript:window.close()";
}
/* MenÃº de configuraciÃ³n de las variables */
$menu_06112020_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("blank_copias_diarias") . "/blank_copias_diarias_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_copias_diarias']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['blank_copias_diarias'] = "on";
    }
}
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[59]))
{
 ...
 $nm_var_lab[60] = "Facturación POS - ADMIN";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[70]))
{
 ...
 $nm_var_lab[71] = "Documentos varios";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[72]))
{
 ...
 $nm_var_lab[73] = "Lista Documentos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[73]))
{
 ...
 $nm_var_lab[74] = "Recalcular Ventas";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[75]))
{
 ...
 $nm_var_lab[76] = "Lista Facturas Por Cobrar";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[76]))
{
 ...
 $nm_var_lab[77] = "Recibo de Ingreso a Caja";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[77]))
{
 ...
 $nm_var_lab[78] = "Documentos Cartera";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[78]))
{
 ...
 $nm_var_lab[79] = "Recibo de Ingreso a Caja (Remisiones)";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[79]))
{
 ...
 $nm_var_lab[80] = "Lista de Recibos de Ingreso a Caja";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[80]))
{
 ...
 $nm_var_lab[81] = "Recalcular Documentos (Cartera/Tesorería)";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[82]))
{
 ...
 $nm_var_lab[83] = "Lista de Facturas Por Pagar";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[83]))
{
 ...
 $nm_var_lab[84] = "Obligaciones por proveedor";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[84]))
{
 ...
 $nm_var_lab[85] = "Documentos Tesorería";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[85]))
{
 ...
 $nm_var_lab[86] = "Base y cuadre de Caja";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[86]))
{
 ...
 $nm_var_lab[87] = "Comprobante de Egreso";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[87]))
{
 ...
 $nm_var_lab[88] = "Lista comprobantes de Egreso";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[88]))
{
 ...
 $nm_var_lab[89] = "Lista comprobantes de Egreso - Beta";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[89]))
{
 ...
 $nm_var_lab[90] = "Lista Movimientos de caja";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[91]))
{
 ...
 $nm_var_lab[92] = "Conceptos RC y CE";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[94]))
{
 ...
 $nm_var_lab[95] = "Grupos Contables";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[95]))
{
 ...
 $nm_var_lab[96] = "P1 - Generar CC de Compras";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[96]))
{
 ...
 $nm_var_lab[97] = "P2 - Generar CC de Ventas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[97]))
{
 ...
 $nm_var_lab[98] = "P3 - Generar Comprobantes a TNS";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[100]))
{
 ...
 $nm_var_lab[101] = "Total Ingresos/Egresos/Periodo";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[101]))
{
 ...
 $nm_var_lab[102] = "ABC de Clientes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[102]))
{
 ...
 $nm_var_lab[103] = "ABC de Productos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[104]))
{
 ...
 $nm_var_lab[105] = "Costo Total del Inventario";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[105]))
{
 ...
 $nm_var_lab[106] = "Rotación de Inventario";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[106]))
{
 ...
 $nm_var_lab[107] = "Inventario Físico por Producto";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[107]))
{
 ...
 $nm_var_lab[108] = "Existencias por bodega";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[109]))
{
 ...
 $nm_var_lab[110] = "Productos/Pedido";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[110]))
{
 ...
 $nm_var_lab[111] = "Vencimiento de Productos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[111]))
{
 ...
 $nm_var_lab[112] = "Saldos por  Periodo";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[112]))
{
 ...
 $nm_var_lab[113] = "Existencia por Lote/Vencimiento/Serial";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[114]))
{
 ...
 $nm_var_lab[115] = "Venta por Vendedor/Producto";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[115]))
{
 ...
 $nm_var_lab[116] = "Ventas Totales por Caja";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[117]))
{
 ...
 $nm_var_lab[118] = "Informe Caja POS";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[118]))
{
 ...
 $nm_var_lab[119] = "Venta/Costo/Ganancia";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[119]))
{
 ...
 $nm_var_lab[120] = "Grid/Ventas/Ubicación";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[120]))
{
 ...
 $nm_var_lab[121] = "Ventas por Producto";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[121]))
{
 ...
 $nm_var_lab[122] = "Ventas por Grupo/Familia";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[122]))
{
 ...
 $nm_var_lab[123] = "Ventas por Cliente";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[123]))
{
 ...
 $nm_var_lab[124] = "Ventas por Vendedor";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[124]))
{
 ...
 $nm_var_lab[125] = "Recarcular Reporte Flujo/Caja";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[127]))
{
 ...
 $nm_var_lab[128] = "Cartera por Edades";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[133]))
{
 ...
 $nm_var_lab[134] = "Listar contratos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[134]))
{
 ...
 $nm_var_lab[135] = "Generar facturas del periodo";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[135]))
{
 ...
 $nm_var_lab[136] = "Lista de facturas contratos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[137]))
{
 ...
 $nm_var_lab[138] = "Asignar Dispositivo";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[142]))
{
 ...
 $nm_var_lab[143] = "Clasificaciones";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[148]))
{
 ...
 $nm_var_lab[149] = "Correo Electrónico";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[149]))
{
 ...
 $nm_var_lab[150] = "Gestión de Archivos/Documentos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[150]))
{
 ...
 $nm_var_lab[151] = "Configuraciones";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[151]))
{
 ...
 $nm_var_lab[152] = "Configurar Empresa";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[154]))
{
 ...
 $nm_var_lab[155] = "Configuración Impresión POS";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[157]))
{
 ...
 $nm_var_lab[158] = "Resolución Dian";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[158]))
{
 ...
 $nm_var_lab[159] = "Tablas de retenciones e Impuestos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[160]))
{
 ...
 $nm_var_lab[161] = "Tabla Retefuente";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[162]))
{
 ...
 $nm_var_lab[163] = "Tabla de Auto Retenciones";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[163]))
{
 ...
 $nm_var_lab[164] = "Centro de Costos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[164]))
{
 ...
 $nm_var_lab[165] = "Prefijos Documentos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[165]))
{
 ...
 $nm_var_lab[166] = "Bodegas o Almacén";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[170]))
{
 ...
 $nm_var_lab[171] = "Grupos de usuarios";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[171]))
{
 ...
 $nm_var_lab[172] = "Permisos/Menú/Móvil";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[173]))
{
 ...
 $nm_var_lab[174] = "Lista Aplicaciones Menú";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[174]))
{
 ...
 $nm_var_lab[175] = "Aplicaciones/Menú/Móvil";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[177]))
{
 ...
 $nm_var_lab[178] = "Recalcular Existencias";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[178]))
{
 ...
 $nm_var_lab[179] = "Recalcular Existencias (Lote/Vencimiento/Serial)";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[179]))
{
 ...
 $nm_var_lab[180] = "Hacer Copia de Seguridad";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[180]))
{
 ...
 $nm_var_lab[181] = "Restaurar Copia de Seguridad";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[181]))
{
 ...
 $nm_var_lab[182] = "Optimizar Base de Datos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[183]))
{
 ...
 $nm_var_lab[184] = "Reiniciar Base de Datos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[184]))
{
 ...
 $nm_var_lab[185] = "Resetear Inventario";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[185]))
{
 ...
 $nm_var_lab[186] = "Tipo de Documentos";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[186]))
{
 ...
 $nm_var_lab[187] = "Manejador de BD";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[188]))
{
 ...
 $nm_var_lab[189] = "Editar Municipios";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[189]))
{
 ...
 $nm_var_lab[190] = "Unidades de Medida";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[190]))
{
 ...
 $nm_var_lab[191] = "Tipo de Producto";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[191]))
{
 ...
 $nm_var_lab[192] = "Importar de TNS";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[192]))
{
 ...
 $nm_var_lab[193] = "1. Importar grupo de articulos de TNS";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[193]))
{
 ...
 $nm_var_lab[194] = "2. Importar tipos de IVA";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[194]))
{
 ...
 $nm_var_lab[195] = "3. Importar plan de cuentas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[195]))
{
 ...
 $nm_var_lab[196] = "4. Importar grupos contables";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[196]))
{
 ...
 $nm_var_lab[197] = "5. Importar articulos de TNS";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[197]))
{
 ...
 $nm_var_lab[198] = "6. Importar terceros de TNS";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[198]))
{
 ...
 $nm_var_lab[199] = "7. Importar inventario de TNS";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[199]))
{
 ...
 $nm_var_lab[200] = "Log Auditoría de Usuarios";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[202]))
{
 ...
 $nm_var_lab[203] = "Buscar Actualizaciones";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[203]))
{
 ...
 $nm_var_lab[204] = "Descargar Anydesk";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[70]))
{
 ...
 $nm_var_hint[71] = "Pedido, cotizaciones, Proformas";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[73]))
{
 ...
 $nm_var_hint[74] = "Recalcular Ventas";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[76]))
{
 ...
 $nm_var_hint[77] = "Cobro facturas de venta...";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[77]))
{
 ...
 $nm_var_hint[78] = "Cuenta Terceros";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[80]))
{
 ...
 $nm_var_hint[81] = "Recalcular Documentos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[84]))
{
 ...
 $nm_var_hint[85] = "Documentos Tesorería";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[93]))
{
 ...
 $nm_var_hint[94] = "Plan de Cuentas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[94]))
{
 ...
 $nm_var_hint[95] = "Grupos Contables";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[96]))
{
 ...
 $nm_var_hint[97] = "Generar Comprobantes Contables de Ventas";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[100]))
{
 ...
 $nm_var_hint[101] = "Total Ingresos/Egresos/Periodo";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[101]))
{
 ...
 $nm_var_hint[102] = "ABC de Clientes";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[102]))
{
 ...
 $nm_var_hint[103] = "ABC de Productos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[104]))
{
 ...
 $nm_var_hint[105] = "Costo Total del Inventario";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[105]))
{
 ...
 $nm_var_hint[106] = "Rotación de Inventario";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[106]))
{
 ...
 $nm_var_hint[107] = "Inventario Físico por Producto";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[107]))
{
 ...
 $nm_var_hint[108] = "Existencias por bodega";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[115]))
{
 ...
 $nm_var_hint[116] = "Ventas Totales por Caja";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[117]))
{
 ...
 $nm_var_hint[118] = "Informe Caja POS";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[126]))
{
 ...
 $nm_var_hint[127] = "Saldo Terceros";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[128]))
{
 ...
 $nm_var_hint[129] = "Gestión Relación Clientes";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[134]))
{
 ...
 $nm_var_hint[135] = "Generar facturas del periodo";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[135]))
{
 ...
 $nm_var_hint[136] = "Lista de Facturas";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[140]))
{
 ...
 $nm_var_hint[141] = "Seguimiento/Historial";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[142]))
{
 ...
 $nm_var_hint[143] = "Clasificaciones";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[148]))
{
 ...
 $nm_var_hint[149] = "Correo Electrónico";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[149]))
{
 ...
 $nm_var_hint[150] = "Gestión de Archivos/Documentos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[171]))
{
 ...
 $nm_var_hint[172] = "Permisos/Menú/Móvil";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[174]))
{
 ...
 $nm_var_hint[175] = "Aplicaciones/Menú/Móvil";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[184]))
{
 ...
 $nm_var_hint[185] = "Resetear Inventario";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[185]))
{
 ...
 $nm_var_hint[186] = "Tipo de Documentos";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[188]))
{
 ...
 $nm_var_hint[189] = "Editar Municipios";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[189]))
{
 ...
 $nm_var_hint[190] = "Unidades de Medida";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[190]))
{
 ...
 $nm_var_hint[191] = "Tipo de Producto";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[194]))
{
 ...
 $nm_var_hint[195] = "3. Importar Plan de Cuentas";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[195]))
{
 ...
 $nm_var_hint[196] = "4. Importar Grupos Contables";
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[202]))
{
 ...
 $nm_var_hint[203] = "Buscar Actualizaciones";
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_hint[203]))
{
 ...
 $nm_var_hint[204] = "Descargar Anydesk";
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_06112020'];
$menu_06112020_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "|usr__NM__bg__NM__community_users_12977.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['terceros']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['terceros']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_2|..|" . $nm_var_lab[1] . "|menu_06112020_form_php.php?sc_item_menu=item_2&sc_apl_menu=terceros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "|grp__NM__ico__NM__user_add_12818.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_80|..|" . $nm_var_lab[2] . "|menu_06112020_form_php.php?sc_item_menu=item_80&sc_apl_menu=grid_terceros_todos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "|usr__NM__bg__NM__groups_people_people_1715.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_3|..|" . $nm_var_lab[3] . "|menu_06112020_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "|usr__NM__ico__NM__user_program_group_15361.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_6|..|" . $nm_var_lab[4] . "|menu_06112020_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_terceros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "|usr__NM__bg__NM__checklist_25365.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vendedores']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vendedores']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_58|..|" . $nm_var_lab[5] . "|menu_06112020_form_php.php?sc_item_menu=item_58&sc_apl_menu=grid_vendedores&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "|usr__NM__bg__NM__technicalsupport_support_representative_person_people_woman_1643.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_151|..|" . $nm_var_lab[6] . "|menu_06112020_form_php.php?sc_item_menu=item_151&sc_apl_menu=form_clasificacion_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "|scriptcase__NM__ico__NM__id_cards_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_152|..|" . $nm_var_lab[7] . "|menu_06112020_form_php.php?sc_item_menu=item_152&sc_apl_menu=form_zona_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[7] . "|scriptcase__NM__ico__NM__earth_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['terceros_mesas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['terceros_mesas']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_100|..|" . $nm_var_lab[8] . "|menu_06112020_form_php.php?sc_item_menu=item_100&sc_apl_menu=terceros_mesas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[8] . "|grp__NM__ico__NM__icon-mesa-de-restaurante-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_126|..|" . $nm_var_lab[9] . "|menu_06112020_form_php.php?sc_item_menu=item_126&sc_apl_menu=blank_cargar_terceros_desde_excel&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[9] . "|grp__NM__ico__NM__icons8-ms-excel-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ruteros']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ruteros']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_183|..|" . $nm_var_lab[10] . "|menu_06112020_form_php.php?sc_item_menu=item_183&sc_apl_menu=grid_ruteros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[10] . "|scriptcase__NM__ico__NM__id_cards_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_230|..|" . $nm_var_lab[11] . "|menu_06112020_form_php.php?sc_item_menu=item_230&sc_apl_menu=blank_cargar_ruteros_desde_excel&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[11] . "|scriptcase__NM__ico__NM__import_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_4|.|" . $nm_var_lab[12] . "||" . $nm_var_hint[12] . "|usr__NM__bg__NM__vendedor_epartidordepizzas_person_1645.png|_self|\n";
$menu_06112020_menuData['data'] .= "item_5|..|" . $nm_var_lab[13] . "||" . $nm_var_hint[13] . "|usr__NM__bg__NM__addusergroup_1251.png|_self|\n";
$menu_06112020_menuData['data'] .= "item_7|.|" . $nm_var_lab[14] . "||" . $nm_var_hint[14] . "|scriptcase__NM__ico__NM__product_green_32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_productos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_productos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_8|..|" . $nm_var_lab[15] . "|menu_06112020_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[15] . "|usr__NM__bg__NM__shipping_products_22121.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_84|..|" . $nm_var_lab[16] . "|menu_06112020_form_php.php?sc_item_menu=item_84&sc_apl_menu=form_productos_simple&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[16] . "|usr__NM__bg__NM__1455554405_line-34_icon-icons.com_53300 (1).png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_9|..|" . $nm_var_lab[17] . "|menu_06112020_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[17] . "|scriptcase__NM__ico__NM__clipboard_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_marca']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_marca']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_146|..|" . $nm_var_lab[18] . "|menu_06112020_form_php.php?sc_item_menu=item_146&sc_apl_menu=form_marca&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[18] . "|scriptcase__NM__ico__NM__ticket_blue_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_linea']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_linea']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_147|..|" . $nm_var_lab[19] . "|menu_06112020_form_php.php?sc_item_menu=item_147&sc_apl_menu=form_linea&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[19] . "|scriptcase__NM__ico__NM__bookmarks_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_10|..|" . $nm_var_lab[20] . "||" . $nm_var_hint[20] . "|usr__NM__bg__NM__warehause_products_safety_5996.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_23|...|" . $nm_var_lab[21] . "|menu_06112020_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_grupo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[21] . "|usr__NM__bg__NM__Icon_Business_Set_00004_A_icon-icons.com_59844.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_grupo']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_grupo']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_24|...|" . $nm_var_lab[22] . "|menu_06112020_form_php.php?sc_item_menu=item_24&sc_apl_menu=form_grupo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[22] . "|usr__NM__bg__NM__warehause_products_safety_5996.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_74|..|" . $nm_var_lab[23] . "|menu_06112020_form_php.php?sc_item_menu=item_74&sc_apl_menu=form_productos_editarprecios&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[23] . "|scriptcase__NM__ico__NM__address_book_edit_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_77|..|" . $nm_var_lab[24] . "|menu_06112020_form_php.php?sc_item_menu=item_77&sc_apl_menu=blank_actualizar_precios_excel&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[24] . "|scriptcase__NM__ico__NM__clipboard_next_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_108|..|" . $nm_var_lab[25] . "|menu_06112020_form_php.php?sc_item_menu=item_108&sc_apl_menu=control_cargarproductos_excel&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[25] . "|grp__NM__ico__NM__icons8-ms-excel-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_210|..|" . $nm_var_lab[26] . "|menu_06112020_form_php.php?sc_item_menu=item_210&sc_apl_menu=form_productos_editarproveedor&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[26] . "|scriptcase__NM__ico__NM__registry_edit_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_215|..|" . $nm_var_lab[27] . "|menu_06112020_form_php.php?sc_item_menu=item_215&sc_apl_menu=consultar_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[27] . "|scriptcase__NM__ico__NM__find_text_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_231|..|" . $nm_var_lab[28] . "|menu_06112020_form_php.php?sc_item_menu=item_231&sc_apl_menu=form_productos_fast_gcontable&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[28] . "|scriptcase__NM__ico__NM__cubes_blue_edit_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_11|.|" . $nm_var_lab[29] . "||" . $nm_var_hint[29] . "|usr__NM__bg__NM__blue_stock_folder_12352.png|_self|\n";
$menu_06112020_menuData['data'] .= "item_17|..|" . $nm_var_lab[30] . "||" . $nm_var_hint[30] . "|usr__NM__bg__NM__shopping_cart_full_22024.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['fac_compras']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['fac_compras']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_19|..|" . $nm_var_lab[31] . "|menu_06112020_form_php.php?sc_item_menu=item_19&sc_apl_menu=fac_compras&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[31] . "|usr__NM__ico__NM__shoppingcart_below_compra_12831.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_compras']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_compras']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_32|...|" . $nm_var_lab[32] . "|menu_06112020_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_compras&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[32] . "|usr__NM__ico__NM__table_1061.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_85|...|" . $nm_var_lab[33] . "|menu_06112020_form_php.php?sc_item_menu=item_85&sc_apl_menu=form_pedido_compra&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[33] . "|grp__NM__ico__NM__list_992.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_86|...|" . $nm_var_lab[34] . "|menu_06112020_form_php.php?sc_item_menu=item_86&sc_apl_menu=grid_pedidos_compras&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[34] . "|grp__NM__ico__NM__filter_list_21446.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_compras_dev']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_compras_dev']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_43|...|" . $nm_var_lab[35] . "|menu_06112020_form_php.php?sc_item_menu=item_43&sc_apl_menu=grid_compras_dev&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[35] . "|usr__NM__ico__NM__go-back256_24856.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_142|..|" . $nm_var_lab[36] . "|menu_06112020_form_php.php?sc_item_menu=item_142&sc_apl_menu=control_codbarras_filtro&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[36] . "|scriptcase__NM__ico__NM__barcode_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_41|..|" . $nm_var_lab[37] . "|menu_06112020_form_php.php?sc_item_menu=item_41&sc_apl_menu=grid_inventario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[37] . "|usr__NM__bg__NM__mimetypes_office_spreadsheet_table_xls_381.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_13|..|" . $nm_var_lab[38] . "||" . $nm_var_hint[38] . "|usr__NM__bg__NM__Inventory-maintenance_25374.png|_self|\n";
$menu_06112020_menuData['data'] .= "item_55|...|" . $nm_var_lab[39] . "||" . $nm_var_hint[39] . "|usr__NM__ico__NM__Childish-Gears_24975.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_produccion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_produccion']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_51|....|" . $nm_var_lab[40] . "|menu_06112020_form_php.php?sc_item_menu=item_51&sc_apl_menu=form_produccion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[40] . "|usr__NM__ico__NM__Factory_icon-icons.com_52104.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produccion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_produccion']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_52|....|" . $nm_var_lab[41] . "|menu_06112020_form_php.php?sc_item_menu=item_52&sc_apl_menu=grid_produccion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[41] . "|usr__NM__ico__NM__list_notes_930.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_53|....|" . $nm_var_lab[42] . "|menu_06112020_form_php.php?sc_item_menu=item_53&sc_apl_menu=grid_productosxtraslado&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[42] . "|usr__NM__ico__NM__icons8-trigo-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_54|....|" . $nm_var_lab[43] . "|menu_06112020_form_php.php?sc_item_menu=item_54&sc_apl_menu=form_mov_trasladodeproduccion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[43] . "|usr__NM__ico__NM__if-food-c216-2427860_85697.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_56|....|" . $nm_var_lab[44] . "|menu_06112020_form_php.php?sc_item_menu=item_56&sc_apl_menu=grid_mov_trasladoprod_almacen&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[44] . "|usr__NM__ico__NM__medical-36_icon-icons.com_73889.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_57|....|" . $nm_var_lab[45] . "|menu_06112020_form_php.php?sc_item_menu=item_57&sc_apl_menu=grid_detallenotamov_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[45] . "|usr__NM__ico__NM__FastFood_FrenchFries_26372.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_movimiento']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_movimiento']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_33|...|" . $nm_var_lab[46] . "|menu_06112020_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_movimiento&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[46] . "|usr__NM__ico__NM__move_23058.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_ajusteinv']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ajusteinv']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_30|...|" . $nm_var_lab[47] . "|menu_06112020_form_php.php?sc_item_menu=item_30&sc_apl_menu=form_ajusteinv&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[47] . "|usr__NM__bg__NM__1491254081-19document-list_82931.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_35|....|" . $nm_var_lab[48] . "|menu_06112020_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_mov_ajusteinv&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[48] . "|usr__NM__ico__NM__korganizer_task_tasks_list_9501.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_82|....|" . $nm_var_lab[49] . "|menu_06112020_form_php.php?sc_item_menu=item_82&sc_apl_menu=Grid_ajuste_Inv_fisico&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[49] . "|grp__NM__bg__NM__inventario_fisico.jpeg|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_12|....|" . $nm_var_lab[50] . "|menu_06112020_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_inventario_inical&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[50] . "|scriptcase__NM__ico__NM__form_yellow_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_15|....|" . $nm_var_lab[51] . "|menu_06112020_form_php.php?sc_item_menu=item_15&sc_apl_menu=form_inventario_inicial&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[51] . "|scriptcase__NM__ico__NM__form_yellow_edit_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_34|....|" . $nm_var_lab[52] . "|menu_06112020_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_inventario_final&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[52] . "|usr__NM__bg__NM__1491254081-19document-list_82931.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_98|....|" . $nm_var_lab[53] . "|menu_06112020_form_php.php?sc_item_menu=item_98&sc_apl_menu=grid_ajuste_notapos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[53] . "|grp__NM__ico__NM__icon_nota-icons.com_55995.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_99|....|" . $nm_var_lab[54] . "|menu_06112020_form_php.php?sc_item_menu=item_99&sc_apl_menu=form_notainv_ajuste&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[54] . "|grp__NM__ico__NM__icon_notepad_78436.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipotransfe']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipotransfe']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_31|...|" . $nm_var_lab[55] . "|menu_06112020_form_php.php?sc_item_menu=item_31&sc_apl_menu=form_tipotransfe&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[55] . "|scriptcase__NM__ico__NM__form_blue_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_14|.|" . $nm_var_lab[56] . "||" . $nm_var_hint[56] . "|usr__NM__bg__NM__business_salesreport_salesreport_negocio_2353.png|_self|\n";
$menu_06112020_menuData['data'] .= "item_16|..|" . $nm_var_lab[57] . "||" . $nm_var_hint[57] . "|usr__NM__ico__NM__cashier_icon-icons.com_53629.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_facturaven']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_facturaven']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_36|...|" . $nm_var_lab[58] . "|menu_06112020_form_php.php?sc_item_menu=item_36&sc_apl_menu=form_facturaven&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[58] . "|usr__NM__bg__NM__invoice_22150 (1).png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_38|...|" . $nm_var_lab[59] . "|menu_06112020_form_php.php?sc_item_menu=item_38&sc_apl_menu=blank_grid_pos_usuario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[59] . "|usr__NM__bg__NM__invoice_78456.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_132|...|" . $nm_var_lab[60] . "|menu_06112020_form_php.php?sc_item_menu=item_132&sc_apl_menu=grid_facturaven_pos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[60] . "|scriptcase__NM__ico__NM__cashier_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['lectordeprecios']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['lectordeprecios']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_134|...|" . $nm_var_lab[61] . "|menu_06112020_form_php.php?sc_item_menu=item_134&sc_apl_menu=lectordeprecios&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[61] . "|scriptcase__NM__ico__NM__handheld_device_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_remisiones']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_remisiones']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_62|...|" . $nm_var_lab[62] . "|menu_06112020_form_php.php?sc_item_menu=item_62&sc_apl_menu=form_remisiones&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[62] . "|usr__NM__ico__NM__ic-payreceipt_97584.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_42|...|" . $nm_var_lab[63] . "|menu_06112020_form_php.php?sc_item_menu=item_42&sc_apl_menu=grid_facturaven&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[63] . "|usr__NM__bg__NM__Sales-by-payment-method_25410.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_37|...|" . $nm_var_lab[64] . "|menu_06112020_form_php.php?sc_item_menu=item_37&sc_apl_menu=grid_ventas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[64] . "|usr__NM__bg__NM__invoice_78456.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_remi']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_remi']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_63|...|" . $nm_var_lab[65] . "|menu_06112020_form_php.php?sc_item_menu=item_63&sc_apl_menu=grid_remi&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[65] . "|usr__NM__ico__NM__ic-ad_97607.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_40|...|" . $nm_var_lab[66] . "||" . $nm_var_hint[66] . "|usr__NM__ico__NM__shoppingcart_to_compra_12829.png|_self|\n";
...
{
    $menu_06112020_menuData['data'] .= "item_184|...|" . $nm_var_lab[67] . "|menu_06112020_form_php.php?sc_item_menu=item_184&sc_apl_menu=grid_programar_descuentos_generales&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[67] . "|scriptcase__NM__ico__NM__calendar_down_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_48|..|" . $nm_var_lab[68] . "||" . $nm_var_hint[68] . "|grp__NM__ico__NM__note_102351.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_notas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_notas']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_177|...|" . $nm_var_lab[69] . "|menu_06112020_form_php.php?sc_item_menu=item_177&sc_apl_menu=form_notas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[69] . "|scriptcase__NM__ico__NM__document_attachment_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_NC_ND']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_NC_ND']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_178|...|" . $nm_var_lab[70] . "|menu_06112020_form_php.php?sc_item_menu=item_178&sc_apl_menu=grid_NC_ND&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[70] . "|scriptcase__NM__ico__NM__document_find_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_64|..|" . $nm_var_lab[71] . "||" . $nm_var_hint[71] . "|usr__NM__ico__NM__ilustracoes_04-12_icon-icons.com_75471.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_pedido']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_pedido']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_65|...|" . $nm_var_lab[72] . "|menu_06112020_form_php.php?sc_item_menu=item_65&sc_apl_menu=form_pedido&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[72] . "|usr__NM__ico__NM__list_992.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_66|...|" . $nm_var_lab[73] . "|menu_06112020_form_php.php?sc_item_menu=item_66&sc_apl_menu=blank_iframe_pedidos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[73] . "|usr__NM__ico__NM__ilustracoes_04-14_icon-icons.com_75468.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_153|..|" . $nm_var_lab[74] . "|menu_06112020_form_php.php?sc_item_menu=item_153&sc_apl_menu=blank_recalcular_ventas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[74] . "|scriptcase__NM__ico__NM__calculator_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_45|.|" . $nm_var_lab[75] . "||" . $nm_var_hint[75] . "|grp__NM__ico__NM__icons8-comprar-por-dinero-32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cartera']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cartera']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_50|..|" . $nm_var_lab[76] . "|menu_06112020_form_php.php?sc_item_menu=item_50&sc_apl_menu=grid_cartera&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[76] . "|grp__NM__ico__NM__icons8-cuenta-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_44|..|" . $nm_var_lab[77] . "|menu_06112020_form_php.php?sc_item_menu=item_44&sc_apl_menu=form_reciboingreso&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[77] . "|usr__NM__ico__NM__Banking_00011_A_icon-icons.com_59831.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_154|..|" . $nm_var_lab[78] . "|menu_06112020_form_php.php?sc_item_menu=item_154&sc_apl_menu=grid_terceros_cuentas_porcobrar&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[78] . "|scriptcase__NM__ico__NM__briefcase_document_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_67|..|" . $nm_var_lab[79] . "|menu_06112020_form_php.php?sc_item_menu=item_67&sc_apl_menu=form_reciboingreso_remis&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[79] . "|usr__NM__ico__NM__Banking_00011_A_icon-icons.com_59831.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_47|..|" . $nm_var_lab[80] . "|menu_06112020_form_php.php?sc_item_menu=item_47&sc_apl_menu=grid_reciboingreso&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[80] . "|grp__NM__ico__NM__icons8-cuenta-32-2.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_174|..|" . $nm_var_lab[81] . "|menu_06112020_form_php.php?sc_item_menu=item_174&sc_apl_menu=blank_recalcular_cuentas_principal&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[81] . "|scriptcase__NM__ico__NM__calculator_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_59|.|" . $nm_var_lab[82] . "||" . $nm_var_hint[82] . "|grp__NM__ico__NM__icons8-caja-registradora-32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cuentaspagar']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cuentaspagar']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_109|..|" . $nm_var_lab[83] . "|menu_06112020_form_php.php?sc_item_menu=item_109&sc_apl_menu=grid_cuentaspagar&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[83] . "|grp__NM__ico__NM__icons8-reembolso-32-.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tesoreria']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tesoreria']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_111|..|" . $nm_var_lab[84] . "|menu_06112020_form_php.php?sc_item_menu=item_111&sc_apl_menu=grid_tesoreria&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[84] . "|grp__NM__ico__NM__icons8-obligaciones-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_192|..|" . $nm_var_lab[85] . "|menu_06112020_form_php.php?sc_item_menu=item_192&sc_apl_menu=grid_terceros_cuentas_porpagar&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[85] . "|scriptcase__NM__ico__NM__briefcase2_document_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_lista']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_lista']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_60|..|" . $nm_var_lab[86] . "|menu_06112020_form_php.php?sc_item_menu=item_60&sc_apl_menu=grid_caja_lista&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[86] . "|grp__NM__ico__NM__icons8-caja-registradora-40.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_hacerpagos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_hacerpagos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_112|..|" . $nm_var_lab[87] . "|menu_06112020_form_php.php?sc_item_menu=item_112&sc_apl_menu=form_hacerpagos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[87] . "|grp__NM__ico__NM__1486564168-finance-bank-check_81495.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pagos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pagos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_113|..|" . $nm_var_lab[88] . "|menu_06112020_form_php.php?sc_item_menu=item_113&sc_apl_menu=grid_pagos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[88] . "|grp__NM__ico__NM__icons8-factura-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pagos_master']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pagos_master']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_176|..|" . $nm_var_lab[89] . "|menu_06112020_form_php.php?sc_item_menu=item_176&sc_apl_menu=grid_pagos_master&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[89] . "|grp__NM__ico__NM__icons8-factura-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_caja']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_caja']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_61|..|" . $nm_var_lab[90] . "|menu_06112020_form_php.php?sc_item_menu=item_61&sc_apl_menu=grid_caja&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[90] . "|grp__NM__ico__NM__icons8-flujo-de-fondos-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_bancos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_bancos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_127|..|" . $nm_var_lab[91] . "|menu_06112020_form_php.php?sc_item_menu=item_127&sc_apl_menu=grid_bancos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[91] . "|grp__NM__ico__NM__Bank_icon-icons.com_74914.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_128|..|" . $nm_var_lab[92] . "|menu_06112020_form_php.php?sc_item_menu=item_128&sc_apl_menu=form_pagos_conceptos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[92] . "|grp__NM__ico__NM__head-brains_icon-icons.com_53022.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_160|.|" . $nm_var_lab[93] . "||" . $nm_var_hint[93] . "|scriptcase__NM__ico__NM__book_green_32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_plancuentas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_plancuentas']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_159|..|" . $nm_var_lab[94] . "|menu_06112020_form_php.php?sc_item_menu=item_159&sc_apl_menu=grid_plancuentas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[94] . "|scriptcase__NM__ico__NM__address_book3_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_161|..|" . $nm_var_lab[95] . "|menu_06112020_form_php.php?sc_item_menu=item_161&sc_apl_menu=grid_grupos_contables&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[95] . "|scriptcase__NM__ico__NM__books_blue_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_229|..|" . $nm_var_lab[96] . "|menu_06112020_form_php.php?sc_item_menu=item_229&sc_apl_menu=grid_facturacom_genera_comprobantes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[96] . "|scriptcase__NM__ico__NM__book_green_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_228|..|" . $nm_var_lab[97] . "|menu_06112020_form_php.php?sc_item_menu=item_228&sc_apl_menu=grid_facturaven_genera_comprobantes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[97] . "|scriptcase__NM__ico__NM__book_yellow_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_comprobantes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_comprobantes']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_162|..|" . $nm_var_lab[98] . "|menu_06112020_form_php.php?sc_item_menu=item_162&sc_apl_menu=grid_comprobantes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[98] . "|scriptcase__NM__ico__NM__book_red_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_75|.|" . $nm_var_lab[99] . "||" . $nm_var_hint[99] . "|usr__NM__ico__NM__ilustracoes_04-14_icon-icons.com_75468.png|_self|\n";
$menu_06112020_menuData['data'] .= "item_200|..|" . $nm_var_lab[100] . "||" . $nm_var_hint[100] . "|scriptcase__NM__ico__NM__invoice_dollar_32.png|_self|\n";
...
{
    $menu_06112020_menuData['data'] .= "item_194|...|" . $nm_var_lab[101] . "|menu_06112020_form_php.php?sc_item_menu=item_194&sc_apl_menu=grid_total_ingreso_egresos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[101] . "|scriptcase__NM__ico__NM__document_pulse_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_abc_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_abc_clientes']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_199|...|" . $nm_var_lab[102] . "|menu_06112020_form_php.php?sc_item_menu=item_199&sc_apl_menu=grid_abc_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[102] . "|scriptcase__NM__ico__NM__users_family_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_198|...|" . $nm_var_lab[103] . "|menu_06112020_form_php.php?sc_item_menu=item_198&sc_apl_menu=grid_abc_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[103] . "|scriptcase__NM__ico__NM__components_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_143|..|" . $nm_var_lab[104] . "||" . $nm_var_hint[104] . "|scriptcase__NM__ico__NM__cubes_32.png|_self|\n";
...
{
    $menu_06112020_menuData['data'] .= "item_188|...|" . $nm_var_lab[105] . "|menu_06112020_form_php.php?sc_item_menu=item_188&sc_apl_menu=grid_costo_inventario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[105] . "|scriptcase__NM__ico__NM__currency_dollar_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_187|...|" . $nm_var_lab[106] . "|menu_06112020_form_php.php?sc_item_menu=item_187&sc_apl_menu=grid_rotacion_inventario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[106] . "|scriptcase__NM__ico__NM__box_next_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_144|...|" . $nm_var_lab[107] . "|menu_06112020_form_php.php?sc_item_menu=item_144&sc_apl_menu=grid_inventario_fisico_porproducto&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[107] . "|usr__NM__ico__NM__Abacus_35794.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_189|...|" . $nm_var_lab[108] . "|menu_06112020_form_php.php?sc_item_menu=item_189&sc_apl_menu=grid_productos_por_bodega&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[108] . "|scriptcase__NM__ico__NM__box_view_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_141|...|" . $nm_var_lab[109] . "|menu_06112020_form_php.php?sc_item_menu=item_141&sc_apl_menu=grid_semanas_venta&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[109] . "|scriptcase__NM__ico__NM__calendar_5_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_107|...|" . $nm_var_lab[110] . "|menu_06112020_form_php.php?sc_item_menu=item_107&sc_apl_menu=grid_reporte_productos_pedido&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[110] . "|scriptcase__NM__ico__NM__chart_column_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_118|...|" . $nm_var_lab[111] . "|menu_06112020_form_php.php?sc_item_menu=item_118&sc_apl_menu=grid_reporte_productos_fechavencimiento&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[111] . "|scriptcase__NM__ico__NM__date_time_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_saldos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_saldos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_129|...|" . $nm_var_lab[112] . "|menu_06112020_form_php.php?sc_item_menu=item_129&sc_apl_menu=grid_saldos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[112] . "|scriptcase__NM__ico__NM__money2_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_133|...|" . $nm_var_lab[113] . "|menu_06112020_form_php.php?sc_item_menu=item_133&sc_apl_menu=grid_vencimiento_lote&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[113] . "|scriptcase__NM__ico__NM__barcode_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_136|..|" . $nm_var_lab[114] . "||" . $nm_var_hint[114] . "|scriptcase__NM__ico__NM__invoice_dollar_32.png|_self|\n";
...
{
    $menu_06112020_menuData['data'] .= "item_219|...|" . $nm_var_lab[115] . "|menu_06112020_form_php.php?sc_item_menu=item_219&sc_apl_menu=grid_rp_productos_vendedor&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[115] . "|scriptcase__NM__ico__NM__presentation_chart_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_181|...|" . $nm_var_lab[116] . "|menu_06112020_form_php.php?sc_item_menu=item_181&sc_apl_menu=blank_reporte_caja_filtro&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[116] . "|scriptcase__NM__ico__NM__cashier_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_informe']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_informe']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_148|...|" . $nm_var_lab[117] . "|menu_06112020_form_php.php?sc_item_menu=item_148&sc_apl_menu=grid_caja_informe&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[117] . "|scriptcase__NM__ico__NM__invoice_dollar_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_149|...|" . $nm_var_lab[118] . "|menu_06112020_form_php.php?sc_item_menu=item_149&sc_apl_menu=grid_caja_informe_pos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[118] . "|scriptcase__NM__ico__NM__money_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_76|...|" . $nm_var_lab[119] . "|menu_06112020_form_php.php?sc_item_menu=item_76&sc_apl_menu=grid_report_refventacostogarancia&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[119] . "|usr__NM__ico__NM__construction_project_plan_building_architect_design_develop-64_icon-icons.com_60255.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_115|...|" . $nm_var_lab[120] . "|menu_06112020_form_php.php?sc_item_menu=item_115&sc_apl_menu=grid_ventas_ubicacion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[120] . "|scriptcase__NM__ico__NM__chart_donut_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_137|...|" . $nm_var_lab[121] . "|menu_06112020_form_php.php?sc_item_menu=item_137&sc_apl_menu=grid_ventas_por_articulo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[121] . "|scriptcase__NM__ico__NM__box_next_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_138|...|" . $nm_var_lab[122] . "|menu_06112020_form_php.php?sc_item_menu=item_138&sc_apl_menu=grid_ventas_por_familia&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[122] . "|scriptcase__NM__ico__NM__cubes_green_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_139|...|" . $nm_var_lab[123] . "|menu_06112020_form_php.php?sc_item_menu=item_139&sc_apl_menu=grid_ventas_por_cliente&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[123] . "|scriptcase__NM__ico__NM__businesspeople2_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_140|...|" . $nm_var_lab[124] . "|menu_06112020_form_php.php?sc_item_menu=item_140&sc_apl_menu=grid_ventas_por_vendedor&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[124] . "|scriptcase__NM__ico__NM__user_find_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_182|...|" . $nm_var_lab[125] . "|menu_06112020_form_php.php?sc_item_menu=item_182&sc_apl_menu=blank_recalcular_flujo_caja_principal&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[125] . "|scriptcase__NM__ico__NM__server_to_client_critical_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_179|..|" . $nm_var_lab[126] . "||" . $nm_var_hint[126] . "|scriptcase__NM__ico__NM__notebook3_32.png|_self|\n";
...
{
    $menu_06112020_menuData['data'] .= "item_195|...|" . $nm_var_lab[127] . "|menu_06112020_form_php.php?sc_item_menu=item_195&sc_apl_menu=grid_saldo_terceros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[127] . "|scriptcase__NM__ico__NM__users2_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_180|...|" . $nm_var_lab[128] . "|menu_06112020_form_php.php?sc_item_menu=item_180&sc_apl_menu=grid_terceros_cartera_por_edades&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[128] . "|scriptcase__NM__ico__NM__calendar_52_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_203|.|" . $nm_var_lab[129] . "||" . $nm_var_hint[129] . "|scriptcase__NM__ico__NM__user_headset_32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tareas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tareas']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_209|..|" . $nm_var_lab[130] . "|menu_06112020_form_php.php?sc_item_menu=item_209&sc_apl_menu=grid_tareas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[130] . "|scriptcase__NM__ico__NM__checkbox_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_contactos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_contactos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_204|..|" . $nm_var_lab[131] . "|menu_06112020_form_php.php?sc_item_menu=item_204&sc_apl_menu=grid_contactos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[131] . "|scriptcase__NM__ico__NM__contacts.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_205|..|" . $nm_var_lab[132] . "|menu_06112020_form_php.php?sc_item_menu=item_205&sc_apl_menu=grid_pedidos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[132] . "|scriptcase__NM__ico__NM__document_edit_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_220|..|" . $nm_var_lab[133] . "||" . $nm_var_hint[133] . "|scriptcase__NM__ico__NM__clipboard2_32.png|_self|\n";
...
{
    $menu_06112020_menuData['data'] .= "item_221|...|" . $nm_var_lab[134] . "|menu_06112020_form_php.php?sc_item_menu=item_221&sc_apl_menu=grid_terceros_contratos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[134] . "|scriptcase__NM__ico__NM__clipboard_24.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_233|...|" . $nm_var_lab[135] . "|menu_06112020_form_php.php?sc_item_menu=item_233&sc_apl_menu=grid_terceros_contratos_generar_fv&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[135] . "|scriptcase__NM__ico__NM__printer_ok_24.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_234|...|" . $nm_var_lab[136] . "|menu_06112020_form_php.php?sc_item_menu=item_234&sc_apl_menu=grid_facturaven_contratos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[136] . "|scriptcase__NM__ico__NM__document_preferences_24.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_224|...|" . $nm_var_lab[137] . "|menu_06112020_form_php.php?sc_item_menu=item_224&sc_apl_menu=form_terceros_dispositivos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[137] . "|scriptcase__NM__ico__NM__hard_drive_24.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_225|...|" . $nm_var_lab[138] . "|menu_06112020_form_php.php?sc_item_menu=item_225&sc_apl_menu=form_terceros_contrato_dispositivo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[138] . "|scriptcase__NM__ico__NM__hard_drive_edit_24.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_226|...|" . $nm_var_lab[139] . "|menu_06112020_form_php.php?sc_item_menu=item_226&sc_apl_menu=form_terceros_contratos_estado&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[139] . "|scriptcase__NM__ico__NM__code_24.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_227|...|" . $nm_var_lab[140] . "|menu_06112020_form_php.php?sc_item_menu=item_227&sc_apl_menu=form_terceros_contratos_motivoscorte&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[140] . "|scriptcase__NM__ico__NM__bookmark_blue_delete_24.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_206|..|" . $nm_var_lab[141] . "|menu_06112020_form_php.php?sc_item_menu=item_206&sc_apl_menu=grid_historiales_crm&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[141] . "|scriptcase__NM__ico__NM__history2_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_casos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_casos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_216|..|" . $nm_var_lab[142] . "|menu_06112020_form_php.php?sc_item_menu=item_216&sc_apl_menu=grid_casos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[142] . "|scriptcase__NM__ico__NM__ticket_blue_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_clasificacion_clientes']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_clasificacion_clientes']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_207|..|" . $nm_var_lab[143] . "|menu_06112020_form_php.php?sc_item_menu=item_207&sc_apl_menu=form_clasificacion_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[143] . "|scriptcase__NM__ico__NM__id_cards_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_208|..|" . $nm_var_lab[144] . "||" . $nm_var_hint[144] . "|scriptcase__NM__ico__NM__bookmarks_32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_casos_estado']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_casos_estado']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_217|..|" . $nm_var_lab[145] . "|menu_06112020_form_php.php?sc_item_menu=item_217&sc_apl_menu=form_casos_estado&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[145] . "|scriptcase__NM__ico__NM__trafficlight_red_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_218|..|" . $nm_var_lab[146] . "|menu_06112020_form_php.php?sc_item_menu=item_218&sc_apl_menu=form_casos_prioridad&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[146] . "|scriptcase__NM__ico__NM__stopwatch_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_26|.|" . $nm_var_lab[147] . "||" . $nm_var_hint[147] . "|usr__NM__bg__NM__company_22169.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_calendario']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_calendario']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_117|..|" . $nm_var_lab[148] . "|menu_06112020_form_php.php?sc_item_menu=item_117&sc_apl_menu=blank_calendario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[148] . "|grp__NM__ico__NM__icons8-directorio-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_201|..|" . $nm_var_lab[149] . "|menu_06112020_form_php.php?sc_item_menu=item_201&sc_apl_menu=../_lib/libraries/grp/correo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[149] . "|scriptcase__NM__ico__NM__airmail_closed_32.png|" . $this->menu_06112020_target('_blank') . "|" . "\n";
...
{
    $menu_06112020_menuData['data'] .= "item_202|..|" . $nm_var_lab[150] . "|menu_06112020_form_php.php?sc_item_menu=item_202&sc_apl_menu=grid_gestor_archivos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[150] . "|scriptcase__NM__ico__NM__document_refresh_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_79|..|" . $nm_var_lab[151] . "||" . $nm_var_hint[151] . "|scriptcase__NM__ico__NM__documents_gear_32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_datosemp']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_datosemp']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_28|...|" . $nm_var_lab[152] . "|menu_06112020_form_php.php?sc_item_menu=item_28&sc_apl_menu=form_datosemp&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[152] . "|usr__NM__bg__NM__Folder_Gear_icon-icons.com_75794.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_190|...|" . $nm_var_lab[153] . "|menu_06112020_form_php.php?sc_item_menu=item_190&sc_apl_menu=grid_sucursales_todas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[153] . "|scriptcase__NM__ico__NM__sc_menu_home3_e.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_consecutivos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_consecutivos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_193|...|" . $nm_var_lab[154] . "|menu_06112020_form_php.php?sc_item_menu=item_193&sc_apl_menu=form_consecutivos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[154] . "|scriptcase__NM__ico__NM__document_refresh_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_130|...|" . $nm_var_lab[155] . "|menu_06112020_form_php.php?sc_item_menu=item_130&sc_apl_menu=grid_configuraciones_print_pos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[155] . "|scriptcase__NM__ico__NM__printer3_edit_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_101|...|" . $nm_var_lab[156] . "|menu_06112020_form_php.php?sc_item_menu=item_101&sc_apl_menu=form_configuraciones&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[156] . "|scriptcase__NM__ico__NM__documents_gear_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_webservicefe']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_webservicefe']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_102|...|" . $nm_var_lab[157] . "|menu_06112020_form_php.php?sc_item_menu=item_102&sc_apl_menu=form_webservicefe&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[157] . "|scriptcase__NM__ico__NM__server_mail_download_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_resdian']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_resdian']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_29|...|" . $nm_var_lab[158] . "|menu_06112020_form_php.php?sc_item_menu=item_29&sc_apl_menu=grid_resdian&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[158] . "|usr__NM__bg__NM__Dian (1).png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_121|...|" . $nm_var_lab[159] . "||" . $nm_var_hint[159] . "|grp__NM__ico__NM__icons8-impuesto-32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_iva']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_iva']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_73|....|" . $nm_var_lab[160] . "|menu_06112020_form_php.php?sc_item_menu=item_73&sc_apl_menu=grid_iva&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[160] . "|usr__NM__bg__NM__1486394955-13-tax_80558.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_122|....|" . $nm_var_lab[161] . "|menu_06112020_form_php.php?sc_item_menu=item_122&sc_apl_menu=form_tiporetefuente&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[161] . "|grp__NM__ico__NM__Cost-per-Click-(CPC)_icon-icons.com_53723.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipoica']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipoica']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_123|....|" . $nm_var_lab[162] . "|menu_06112020_form_php.php?sc_item_menu=item_123&sc_apl_menu=form_tipoica&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[162] . "|grp__NM__ico__NM__1486564172-finance-loan-money_81492.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_124|....|" . $nm_var_lab[163] . "|menu_06112020_form_php.php?sc_item_menu=item_124&sc_apl_menu=form_tipoautoretencion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[163] . "|grp__NM__ico__NM__business-color_money-coins_icon-icons.com_53446.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_c_costos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_c_costos']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_125|....|" . $nm_var_lab[164] . "|menu_06112020_form_php.php?sc_item_menu=item_125&sc_apl_menu=form_c_costos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[164] . "|grp__NM__ico__NM__icons8-costoso-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_83|...|" . $nm_var_lab[165] . "|menu_06112020_form_php.php?sc_item_menu=item_83&sc_apl_menu=form_prefijos_documentos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[165] . "|grp__NM__bg__NM__prefijos.jpeg|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_bodegas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_bodegas']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_27|...|" . $nm_var_lab[166] . "|menu_06112020_form_php.php?sc_item_menu=item_27&sc_apl_menu=form_bodegas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[166] . "|usr__NM__bg__NM__1486504365-building-business-store.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_SN_BALANZA']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_SN_BALANZA']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_232|...|" . $nm_var_lab[167] . "|menu_06112020_form_php.php?sc_item_menu=item_232&sc_apl_menu=form_SN_BALANZA&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[167] . "|scriptcase__NM__ico__NM__card_terminal_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_71|..|" . $nm_var_lab[168] . "||" . $nm_var_hint[168] . "|scriptcase__NM__ico__NM__users3_32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_usuarios']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_usuarios']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_68|...|" . $nm_var_lab[169] . "|menu_06112020_form_php.php?sc_item_menu=item_68&sc_apl_menu=grid_usuarios&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[169] . "|scriptcase__NM__ico__NM__users3_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_69|...|" . $nm_var_lab[170] . "|menu_06112020_form_php.php?sc_item_menu=item_69&sc_apl_menu=form_usuarios&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[170] . "|scriptcase__NM__ico__NM__users4_add_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_70|...|" . $nm_var_lab[171] . "|menu_06112020_form_php.php?sc_item_menu=item_70&sc_apl_menu=form_usuarios_grupos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[171] . "|scriptcase__NM__ico__NM__users_family_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_185|...|" . $nm_var_lab[172] . "|menu_06112020_form_php.php?sc_item_menu=item_185&sc_apl_menu=form_permisos_menu_movil&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[172] . "|scriptcase__NM__ico__NM__user_mobilephone_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_72|...|" . $nm_var_lab[173] . "|menu_06112020_form_php.php?sc_item_menu=item_72&sc_apl_menu=grid_aplicaciones_menu_asignarpermisos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[173] . "|scriptcase__NM__ico__NM__lock_preferences_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_120|...|" . $nm_var_lab[174] . "|menu_06112020_form_php.php?sc_item_menu=item_120&sc_apl_menu=form_aplicaciones_menu&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[174] . "|scriptcase__NM__ico__NM__code_php_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_186|...|" . $nm_var_lab[175] . "|menu_06112020_form_php.php?sc_item_menu=item_186&sc_apl_menu=form_permisos_aplicaciones_menu&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[175] . "|scriptcase__NM__ico__NM__code_colored_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_empresas']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_empresas']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_91|..|" . $nm_var_lab[176] . "|menu_06112020_form_php.php?sc_item_menu=item_91&sc_apl_menu=grid_empresas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[176] . "|scriptcase__NM__ico__NM__companies.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_21|.|" . $nm_var_lab[177] . "||" . $nm_var_hint[177] . "|usr__NM__bg__NM__systempackages_config_configuration_9436.png|_self|\n";
...
{
    $menu_06112020_menuData['data'] .= "item_22|..|" . $nm_var_lab[178] . "|menu_06112020_form_php.php?sc_item_menu=item_22&sc_apl_menu=blank_recalcular_lfs_principal&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[178] . "|usr__NM__ico__NM__Abacus_35794.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_lfs_principal']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_lfs_principal']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_131|..|" . $nm_var_lab[179] . "|menu_06112020_form_php.php?sc_item_menu=item_131&sc_apl_menu=blank_recalcular_lfs_principal&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[179] . "|scriptcase__NM__ico__NM__barcode_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_78|..|" . $nm_var_lab[180] . "|menu_06112020_form_php.php?sc_item_menu=item_78&sc_apl_menu=blank_hacer_backup&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[180] . "|scriptcase__NM__ico__NM__floppy_disk2_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_87|..|" . $nm_var_lab[181] . "|menu_06112020_form_php.php?sc_item_menu=item_87&sc_apl_menu=blank_restaurar_backup&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[181] . "|scriptcase__NM__ico__NM__data_into_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_145|..|" . $nm_var_lab[182] . "|menu_06112020_form_php.php?sc_item_menu=item_145&sc_apl_menu=blank_optimizar_bd&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[182] . "|scriptcase__NM__ico__NM__data_refresh_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_196|..|" . $nm_var_lab[183] . "||" . $nm_var_hint[183] . "|scriptcase__NM__ico__NM__bolt_32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_limpiar_bd']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_limpiar_bd']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_81|..|" . $nm_var_lab[184] . "|menu_06112020_form_php.php?sc_item_menu=item_81&sc_apl_menu=blank_limpiar_bd&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[184] . "|scriptcase__NM__ico__NM__data_replace_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_175|...|" . $nm_var_lab[185] . "|menu_06112020_form_php.php?sc_item_menu=item_175&sc_apl_menu=form_notainv_ceros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[185] . "|grp__NM__ico__NM__systemreboot_94645.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_191|...|" . $nm_var_lab[186] . "|menu_06112020_form_php.php?sc_item_menu=item_191&sc_apl_menu=grid_conceptos_documentos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[186] . "|scriptcase__NM__ico__NM__document_into_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_114|...|" . $nm_var_lab[187] . "|menu_06112020_form_php.php?sc_item_menu=item_114&sc_apl_menu=blank_iframe_phpmyadmin&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[187] . "|scriptcase__NM__ico__NM__data_table_32.png|" . $this->menu_06112020_target('_blank') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_197|...|" . $nm_var_lab[188] . "|menu_06112020_form_php.php?sc_item_menu=item_197&sc_apl_menu=blank_copias_nube_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[188] . "|grp__NM__ico__NM__fw_ico_nube.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_municipio']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_municipio']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_211|...|" . $nm_var_lab[189] . "|menu_06112020_form_php.php?sc_item_menu=item_211&sc_apl_menu=form_municipio&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[189] . "|scriptcase__NM__ico__NM__environment_information_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_213|...|" . $nm_var_lab[190] . "|menu_06112020_form_php.php?sc_item_menu=item_213&sc_apl_menu=form_unidades_medida&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[190] . "|scriptcase__NM__ico__NM__drawing_utensils_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_214|...|" . $nm_var_lab[191] . "|menu_06112020_form_php.php?sc_item_menu=item_214&sc_apl_menu=form_tipo_producto&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[191] . "|scriptcase__NM__ico__NM__components_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_93|..|" . $nm_var_lab[192] . "||" . $nm_var_hint[192] . "|grp__NM__ico__NM__icon-contabilidad-32-3.png|_self|\n";
...
{
    $menu_06112020_menuData['data'] .= "item_94|..|" . $nm_var_lab[193] . "|menu_06112020_form_php.php?sc_item_menu=item_94&sc_apl_menu=grid_importar_grupos_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[193] . "|grp__NM__ico__NM__icon-contabilidad-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_97|...|" . $nm_var_lab[194] . "|menu_06112020_form_php.php?sc_item_menu=item_97&sc_apl_menu=grid_importar_tipoiva_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[194] . "|grp__NM__ico__NM__icon-contabilidad-32-2.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_157|...|" . $nm_var_lab[195] . "|menu_06112020_form_php.php?sc_item_menu=item_157&sc_apl_menu=grid_importar_plan_cuentas_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[195] . "|scriptcase__NM__ico__NM__book_blue_open_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_158|...|" . $nm_var_lab[196] . "|menu_06112020_form_php.php?sc_item_menu=item_158&sc_apl_menu=grid_importar_grupos_contables_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[196] . "|scriptcase__NM__ico__NM__books_blue_edit_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_95|...|" . $nm_var_lab[197] . "|menu_06112020_form_php.php?sc_item_menu=item_95&sc_apl_menu=grid_importar_articulos_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[197] . "|grp__NM__ico__NM__icon-recibo-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_96|...|" . $nm_var_lab[198] . "|menu_06112020_form_php.php?sc_item_menu=item_96&sc_apl_menu=grid_importar_terceros_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[198] . "|grp__NM__ico__NM__icons8-contabilidad-32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_103|...|" . $nm_var_lab[199] . "|menu_06112020_form_php.php?sc_item_menu=item_103&sc_apl_menu=grid_productos_facilweb_importinvtns&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[199] . "|scriptcase__NM__ico__NM__import_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_log']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_log']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_135|..|" . $nm_var_lab[200] . "|menu_06112020_form_php.php?sc_item_menu=item_135&sc_apl_menu=grid_log&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[200] . "|scriptcase__NM__ico__NM__user_find_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

$menu_06112020_menuData['data'] .= "item_104|..|" . $nm_var_lab[201] . "||" . $nm_var_hint[201] . "|scriptcase__NM__ico__NM__help2_32.png|_self|\n";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_soporte']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_soporte']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_155|...|" . $nm_var_lab[202] . "|menu_06112020_form_php.php?sc_item_menu=item_155&sc_apl_menu=blank_soporte&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[202] . "|scriptcase__NM__ico__NM__user_headset_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}
...
{
    $menu_06112020_menuData['data'] .= "item_212|...|" . $nm_var_lab[203] . "|menu_06112020_form_php.php?sc_item_menu=item_212&sc_apl_menu=blank_buscar_actualizaciones&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[203] . "|scriptcase__NM__ico__NM__download_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_anydesk']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_anydesk']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_156|...|" . $nm_var_lab[204] . "|menu_06112020_form_php.php?sc_item_menu=item_156&sc_apl_menu=blank_anydesk&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[204] . "|grp__NM__ico__NM__fw_ico_anydesk.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_46|...|" . $nm_var_lab[205] . "|menu_06112020_form_php.php?sc_item_menu=item_46&sc_apl_menu=blank&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[205] . "|usr__NM__ico__NM__copyright_icon-icons.com_76791.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_ayuda']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_ayuda']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_105|...|" . $nm_var_lab[206] . "|menu_06112020_form_php.php?sc_item_menu=item_105&sc_apl_menu=blank_ayuda&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[206] . "|scriptcase__NM__ico__NM__book_blue_find_32.png|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_slider']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_slider']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_150|...|" . $nm_var_lab[207] . "|menu_06112020_form_php.php?sc_item_menu=item_150&sc_apl_menu=blank_slider&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[207] . "|grp__NM__ico__NM__favicon.ico|" . $this->menu_06112020_target('_self') . "|" . "\n";
}

if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_fin_sesion']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_fin_sesion']) == "on")
{
    $menu_06112020_menuData['data'] .= "item_20|.|" . $nm_var_lab[208] . "|menu_06112020_form_php.php?sc_item_menu=item_20&sc_apl_menu=blank_fin_sesion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[208] . "|scriptcase__NM__ico__NM__exit_32.png|" . $this->menu_06112020_target('_parent') . "|" . "\n";
}


$menu_06112020_menuData['data'] = array();
$str_disabled = "N";
$str_link = "#";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_2&sc_apl_menu=terceros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['terceros']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['terceros']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_06112020_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_06112020_target('_self') . "\"",
        'sc_id'    => "item_2",
        'disabled' => $str_disabled,
        'display'     => "",
        'display_position'=> "",
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_80&sc_apl_menu=grid_terceros_todos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_todos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_todos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_3&sc_apl_menu=grid_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_6&sc_apl_menu=grid_terceros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_58&sc_apl_menu=grid_vendedores&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vendedores']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vendedores']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_151&sc_apl_menu=form_clasificacion_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_clasificacion_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_clasificacion_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_152&sc_apl_menu=form_zona_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_zona_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_zona_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_100&sc_apl_menu=terceros_mesas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['terceros_mesas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['terceros_mesas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_126&sc_apl_menu=blank_cargar_terceros_desde_excel&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_cargar_terceros_desde_excel']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_cargar_terceros_desde_excel']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_183&sc_apl_menu=grid_ruteros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ruteros']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ruteros']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_230&sc_apl_menu=blank_cargar_ruteros_desde_excel&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_cargar_ruteros_desde_excel']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_cargar_ruteros_desde_excel']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_productos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_productos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_84&sc_apl_menu=form_productos_simple&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_productos_simple']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_productos_simple']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_9&sc_apl_menu=grid_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_146&sc_apl_menu=form_marca&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_marca']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_marca']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_147&sc_apl_menu=form_linea&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_linea']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_linea']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_23&sc_apl_menu=grid_grupo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_grupo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_24&sc_apl_menu=form_grupo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_grupo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_grupo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_74&sc_apl_menu=form_productos_editarprecios&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_productos_editarprecios']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_productos_editarprecios']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_77&sc_apl_menu=blank_actualizar_precios_excel&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_actualizar_precios_excel']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_actualizar_precios_excel']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_108&sc_apl_menu=control_cargarproductos_excel&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_cargarproductos_excel']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_cargarproductos_excel']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_210&sc_apl_menu=form_productos_editarproveedor&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_productos_editarproveedor']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_productos_editarproveedor']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_215&sc_apl_menu=consultar_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['consultar_productos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['consultar_productos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_231&sc_apl_menu=form_productos_fast_gcontable&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_productos_fast_gcontable']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_productos_fast_gcontable']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_19&sc_apl_menu=fac_compras&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['fac_compras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['fac_compras']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_32&sc_apl_menu=grid_compras&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_compras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_compras']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_85&sc_apl_menu=form_pedido_compra&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_pedido_compra']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_pedido_compra']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_86&sc_apl_menu=grid_pedidos_compras&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos_compras']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos_compras']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_43&sc_apl_menu=grid_compras_dev&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_compras_dev']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_compras_dev']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_142&sc_apl_menu=control_codbarras_filtro&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['control_codbarras_filtro']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['control_codbarras_filtro']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_41&sc_apl_menu=grid_inventario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_51&sc_apl_menu=form_produccion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_produccion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_produccion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_52&sc_apl_menu=grid_produccion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_produccion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_produccion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_53&sc_apl_menu=grid_productosxtraslado&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productosxtraslado']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productosxtraslado']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_54&sc_apl_menu=form_mov_trasladodeproduccion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_mov_trasladodeproduccion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_mov_trasladodeproduccion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_56&sc_apl_menu=grid_mov_trasladoprod_almacen&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_mov_trasladoprod_almacen']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_mov_trasladoprod_almacen']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_57&sc_apl_menu=grid_detallenotamov_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_detallenotamov_productos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_detallenotamov_productos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_33&sc_apl_menu=grid_movimiento&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_movimiento']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_movimiento']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_30&sc_apl_menu=form_ajusteinv&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_ajusteinv']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_ajusteinv']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_35&sc_apl_menu=grid_mov_ajusteinv&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_mov_ajusteinv']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_mov_ajusteinv']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_82&sc_apl_menu=Grid_ajuste_Inv_fisico&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['Grid_ajuste_Inv_fisico']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['Grid_ajuste_Inv_fisico']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_12&sc_apl_menu=grid_inventario_inical&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario_inical']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario_inical']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_15&sc_apl_menu=form_inventario_inicial&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_inventario_inicial']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_inventario_inicial']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_34&sc_apl_menu=grid_inventario_final&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario_final']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario_final']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_98&sc_apl_menu=grid_ajuste_notapos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ajuste_notapos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ajuste_notapos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_99&sc_apl_menu=form_notainv_ajuste&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_notainv_ajuste']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_notainv_ajuste']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_31&sc_apl_menu=form_tipotransfe&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipotransfe']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipotransfe']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_36&sc_apl_menu=form_facturaven&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_facturaven']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_facturaven']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_38&sc_apl_menu=blank_grid_pos_usuario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_grid_pos_usuario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_grid_pos_usuario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_132&sc_apl_menu=grid_facturaven_pos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_pos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_pos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_134&sc_apl_menu=lectordeprecios&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['lectordeprecios']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['lectordeprecios']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_62&sc_apl_menu=form_remisiones&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_remisiones']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_remisiones']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_42&sc_apl_menu=grid_facturaven&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_37&sc_apl_menu=grid_ventas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_63&sc_apl_menu=grid_remi&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_remi']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_remi']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_184&sc_apl_menu=grid_programar_descuentos_generales&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_programar_descuentos_generales']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_programar_descuentos_generales']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_177&sc_apl_menu=form_notas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_notas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_notas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_178&sc_apl_menu=grid_NC_ND&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_NC_ND']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_NC_ND']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_65&sc_apl_menu=form_pedido&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_pedido']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_pedido']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_66&sc_apl_menu=blank_iframe_pedidos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_iframe_pedidos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_iframe_pedidos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_153&sc_apl_menu=blank_recalcular_ventas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_ventas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_ventas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_50&sc_apl_menu=grid_cartera&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cartera']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cartera']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_44&sc_apl_menu=form_reciboingreso&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_reciboingreso']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_reciboingreso']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_154&sc_apl_menu=grid_terceros_cuentas_porcobrar&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_cuentas_porcobrar']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_cuentas_porcobrar']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_67&sc_apl_menu=form_reciboingreso_remis&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_reciboingreso_remis']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_reciboingreso_remis']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_47&sc_apl_menu=grid_reciboingreso&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reciboingreso']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_reciboingreso']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_174&sc_apl_menu=blank_recalcular_cuentas_principal&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_cuentas_principal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_cuentas_principal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_109&sc_apl_menu=grid_cuentaspagar&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_cuentaspagar']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_cuentaspagar']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_111&sc_apl_menu=grid_tesoreria&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tesoreria']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tesoreria']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_192&sc_apl_menu=grid_terceros_cuentas_porpagar&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_cuentas_porpagar']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_cuentas_porpagar']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_60&sc_apl_menu=grid_caja_lista&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_lista']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_lista']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_112&sc_apl_menu=form_hacerpagos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_hacerpagos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_hacerpagos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_113&sc_apl_menu=grid_pagos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pagos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pagos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_176&sc_apl_menu=grid_pagos_master&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pagos_master']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pagos_master']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_61&sc_apl_menu=grid_caja&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_caja']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_caja']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_127&sc_apl_menu=grid_bancos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_bancos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_bancos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_128&sc_apl_menu=form_pagos_conceptos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_pagos_conceptos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_pagos_conceptos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_159&sc_apl_menu=grid_plancuentas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_plancuentas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_plancuentas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_161&sc_apl_menu=grid_grupos_contables&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_grupos_contables']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_grupos_contables']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_229&sc_apl_menu=grid_facturacom_genera_comprobantes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturacom_genera_comprobantes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_facturacom_genera_comprobantes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_228&sc_apl_menu=grid_facturaven_genera_comprobantes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_genera_comprobantes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_genera_comprobantes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_162&sc_apl_menu=grid_comprobantes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_comprobantes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_comprobantes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_194&sc_apl_menu=grid_total_ingreso_egresos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_total_ingreso_egresos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_total_ingreso_egresos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_199&sc_apl_menu=grid_abc_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_abc_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_abc_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_198&sc_apl_menu=grid_abc_productos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_abc_productos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_abc_productos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_188&sc_apl_menu=grid_costo_inventario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_costo_inventario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_costo_inventario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_187&sc_apl_menu=grid_rotacion_inventario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_rotacion_inventario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_rotacion_inventario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_144&sc_apl_menu=grid_inventario_fisico_porproducto&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario_fisico_porproducto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_inventario_fisico_porproducto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_189&sc_apl_menu=grid_productos_por_bodega&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_por_bodega']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_por_bodega']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_141&sc_apl_menu=grid_semanas_venta&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_semanas_venta']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_semanas_venta']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_107&sc_apl_menu=grid_reporte_productos_pedido&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_productos_pedido']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_productos_pedido']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_118&sc_apl_menu=grid_reporte_productos_fechavencimiento&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_productos_fechavencimiento']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_reporte_productos_fechavencimiento']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_129&sc_apl_menu=grid_saldos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_saldos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_saldos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_133&sc_apl_menu=grid_vencimiento_lote&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_vencimiento_lote']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_vencimiento_lote']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_219&sc_apl_menu=grid_rp_productos_vendedor&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_rp_productos_vendedor']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_rp_productos_vendedor']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_181&sc_apl_menu=blank_reporte_caja_filtro&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_reporte_caja_filtro']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_reporte_caja_filtro']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_148&sc_apl_menu=grid_caja_informe&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_informe']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_informe']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_149&sc_apl_menu=grid_caja_informe_pos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_informe_pos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_caja_informe_pos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_76&sc_apl_menu=grid_report_refventacostogarancia&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_report_refventacostogarancia']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_report_refventacostogarancia']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_115&sc_apl_menu=grid_ventas_ubicacion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_ubicacion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_ubicacion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_137&sc_apl_menu=grid_ventas_por_articulo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_por_articulo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_por_articulo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_138&sc_apl_menu=grid_ventas_por_familia&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_por_familia']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_por_familia']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_139&sc_apl_menu=grid_ventas_por_cliente&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_por_cliente']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_por_cliente']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_140&sc_apl_menu=grid_ventas_por_vendedor&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_por_vendedor']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_ventas_por_vendedor']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_182&sc_apl_menu=blank_recalcular_flujo_caja_principal&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_flujo_caja_principal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_flujo_caja_principal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_195&sc_apl_menu=grid_saldo_terceros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_saldo_terceros']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_saldo_terceros']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_180&sc_apl_menu=grid_terceros_cartera_por_edades&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_cartera_por_edades']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_cartera_por_edades']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_209&sc_apl_menu=grid_tareas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tareas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tareas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_204&sc_apl_menu=grid_contactos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_contactos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_contactos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_205&sc_apl_menu=grid_pedidos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_pedidos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_221&sc_apl_menu=grid_terceros_contratos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_contratos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_contratos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_233&sc_apl_menu=grid_terceros_contratos_generar_fv&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_contratos_generar_fv']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_terceros_contratos_generar_fv']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_234&sc_apl_menu=grid_facturaven_contratos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_contratos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_facturaven_contratos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_224&sc_apl_menu=form_terceros_dispositivos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_terceros_dispositivos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_terceros_dispositivos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_225&sc_apl_menu=form_terceros_contrato_dispositivo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_terceros_contrato_dispositivo']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_terceros_contrato_dispositivo']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_226&sc_apl_menu=form_terceros_contratos_estado&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_terceros_contratos_estado']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_terceros_contratos_estado']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_227&sc_apl_menu=form_terceros_contratos_motivoscorte&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_terceros_contratos_motivoscorte']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_terceros_contratos_motivoscorte']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_206&sc_apl_menu=grid_historiales_crm&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_historiales_crm']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_historiales_crm']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_216&sc_apl_menu=grid_casos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_casos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_casos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_207&sc_apl_menu=form_clasificacion_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_clasificacion_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_clasificacion_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_217&sc_apl_menu=form_casos_estado&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_casos_estado']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_casos_estado']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_218&sc_apl_menu=form_casos_prioridad&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_casos_prioridad']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_casos_prioridad']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_117&sc_apl_menu=blank_calendario&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_calendario']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_calendario']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_201&sc_apl_menu=../_lib/libraries/grp/correo&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
...
$menu_06112020_menuData['data'][] = array(
    ...
    'icon_aba' => $icon_aba,
    'icon_aba_inactive' => $icon_aba_inactive,
    'target'   => " item-target=\"" . $this->menu_06112020_target('_blank') . "\"",
    'sc_id'    => "item_201",
    'disabled' => $str_disabled,
    'display'     => "",
    'display_position'=> "",
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_202&sc_apl_menu=grid_gestor_archivos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_gestor_archivos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_gestor_archivos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_28&sc_apl_menu=form_datosemp&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_datosemp']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_datosemp']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_190&sc_apl_menu=grid_sucursales_todas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_sucursales_todas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_sucursales_todas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_193&sc_apl_menu=form_consecutivos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_consecutivos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_consecutivos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_130&sc_apl_menu=grid_configuraciones_print_pos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_configuraciones_print_pos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_configuraciones_print_pos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_101&sc_apl_menu=form_configuraciones&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_configuraciones']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_configuraciones']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_102&sc_apl_menu=form_webservicefe&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_webservicefe']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_webservicefe']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_29&sc_apl_menu=grid_resdian&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_resdian']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_resdian']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_73&sc_apl_menu=grid_iva&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_iva']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_iva']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_122&sc_apl_menu=form_tiporetefuente&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tiporetefuente']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tiporetefuente']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_123&sc_apl_menu=form_tipoica&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipoica']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipoica']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_124&sc_apl_menu=form_tipoautoretencion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipoautoretencion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipoautoretencion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_125&sc_apl_menu=form_c_costos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_c_costos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_c_costos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_83&sc_apl_menu=form_prefijos_documentos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_prefijos_documentos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_prefijos_documentos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_27&sc_apl_menu=form_bodegas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_bodegas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_bodegas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_232&sc_apl_menu=form_SN_BALANZA&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_SN_BALANZA']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_SN_BALANZA']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_68&sc_apl_menu=grid_usuarios&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_usuarios']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_usuarios']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_69&sc_apl_menu=form_usuarios&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_70&sc_apl_menu=form_usuarios_grupos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios_grupos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios_grupos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_185&sc_apl_menu=form_permisos_menu_movil&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_permisos_menu_movil']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_permisos_menu_movil']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_72&sc_apl_menu=grid_aplicaciones_menu_asignarpermisos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_aplicaciones_menu_asignarpermisos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_aplicaciones_menu_asignarpermisos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_120&sc_apl_menu=form_aplicaciones_menu&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_aplicaciones_menu']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_aplicaciones_menu']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_186&sc_apl_menu=form_permisos_aplicaciones_menu&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_permisos_aplicaciones_menu']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_permisos_aplicaciones_menu']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_91&sc_apl_menu=grid_empresas&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_empresas']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_empresas']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_22&sc_apl_menu=blank_recalcular_lfs_principal&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_lfs_principal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_lfs_principal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_131&sc_apl_menu=blank_recalcular_lfs_principal&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_lfs_principal']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_recalcular_lfs_principal']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_78&sc_apl_menu=blank_hacer_backup&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_hacer_backup']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_hacer_backup']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_87&sc_apl_menu=blank_restaurar_backup&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_restaurar_backup']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_restaurar_backup']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_145&sc_apl_menu=blank_optimizar_bd&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_optimizar_bd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_optimizar_bd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_81&sc_apl_menu=blank_limpiar_bd&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_limpiar_bd']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_limpiar_bd']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_175&sc_apl_menu=form_notainv_ceros&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_notainv_ceros']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_notainv_ceros']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_191&sc_apl_menu=grid_conceptos_documentos&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_conceptos_documentos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_conceptos_documentos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_114&sc_apl_menu=blank_iframe_phpmyadmin&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_iframe_phpmyadmin']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_iframe_phpmyadmin']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_197&sc_apl_menu=blank_copias_nube_clientes&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_copias_nube_clientes']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_copias_nube_clientes']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_211&sc_apl_menu=form_municipio&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_municipio']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_municipio']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_213&sc_apl_menu=form_unidades_medida&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_unidades_medida']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_unidades_medida']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_214&sc_apl_menu=form_tipo_producto&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_producto']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_tipo_producto']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_94&sc_apl_menu=grid_importar_grupos_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_grupos_TNS']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_grupos_TNS']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_97&sc_apl_menu=grid_importar_tipoiva_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_tipoiva_TNS']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_tipoiva_TNS']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_157&sc_apl_menu=grid_importar_plan_cuentas_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_plan_cuentas_TNS']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_plan_cuentas_TNS']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_158&sc_apl_menu=grid_importar_grupos_contables_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_grupos_contables_TNS']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_grupos_contables_TNS']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_95&sc_apl_menu=grid_importar_articulos_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_articulos_TNS']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_articulos_TNS']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_96&sc_apl_menu=grid_importar_terceros_TNS&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_terceros_TNS']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_importar_terceros_TNS']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_103&sc_apl_menu=grid_productos_facilweb_importinvtns&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_facilweb_importinvtns']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_productos_facilweb_importinvtns']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_135&sc_apl_menu=grid_log&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_log']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_log']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_155&sc_apl_menu=blank_soporte&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_soporte']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_soporte']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_212&sc_apl_menu=blank_buscar_actualizaciones&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_buscar_actualizaciones']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_buscar_actualizaciones']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_156&sc_apl_menu=blank_anydesk&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_anydesk']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_anydesk']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_46&sc_apl_menu=blank&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_105&sc_apl_menu=blank_ayuda&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_ayuda']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_ayuda']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_150&sc_apl_menu=blank_slider&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_slider']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_slider']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_06112020_form_php.php?sc_item_menu=item_20&sc_apl_menu=blank_fin_sesion&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['blank_fin_sesion']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['blank_fin_sesion']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_06112020_menuData['data'][] = array(
        ...
        'icon_aba' => $icon_aba,
        'icon_aba_inactive' => $icon_aba_inactive,
        'target'   => " item-target=\"" . $this->menu_06112020_target('_parent') . "\"",
        'sc_id'    => "item_20",
        'disabled' => $str_disabled,
        'display'     => "",
        'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_06112020']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_06112020']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_06112020');
    $menu_06112020_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_06112020_help.txt"))
{
    $Arq_WebHelp = file("menu_06112020_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_06112020_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_06112020_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_06112020']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_06112020']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_06112020_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_06112020']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_06112020_menuData['data'][$i_menu]);
       }
    ...
    $menu_06112020_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_06112020']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_06112020']))
{
    $disable_menu = false;
    foreach ($menu_06112020_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_06112020']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_06112020_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
foreach ($menu_06112020_menuData['data'] as $chave => $cada_menu)
{
        if($level_to_delete !== false && $menu_06112020_menuData['data'][$chave]['level'] > $level_to_delete)
        {
                unset($menu_06112020_menuData['data'][$chave]);
        }
        else
        {
                $level_to_delete = false;
                
                if ($menu_06112020_menuData['data'][$chave]['disabled'] == 'Y')
                {
                        $level_to_delete = $menu_06112020_menuData['data'][$chave]['level'];
                        unset($menu_06112020_menuData['data'][$chave]);
                }
        }
}
$menu_06112020_menuData['data'] = array_values($menu_06112020_menuData['data']);
$flag = 1;
while ($flag == 1)
{
    $flag = 0;
    foreach ($menu_06112020_menuData['data'] as $chave => $cada_menu)
    {
        if (!empty($cada_menu))
        {
            if (isset($menu_06112020_menuData['data'][$chave + 1]) && !empty($menu_06112020_menuData['data'][$chave + 1]))
            {
                if ($menu_06112020_menuData['data'][$chave]['link'] == "#")
                {
                    if ($menu_06112020_menuData['data'][$chave]['level'] >= $menu_06112020_menuData['data'][$chave + 1]['level'] )
                    {
                        unset($menu_06112020_menuData['data'][$chave]);
                        $flag = 1;
                    }
            ...
            elseif ($menu_06112020_menuData['data'][$chave]['link'] == "#")
            {
                unset($menu_06112020_menuData['data'][$chave]);
            }
        }
...
/* Cabecera HTML */
if ($menu_06112020_menuData['iframe'])
{
    $menu_06112020_menuData['height'] = '100%';
...
{
    $menu_06112020_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod']; ?>/third/jquery/js/jquery.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_06112020']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_sweetalert.css" />
<script type="text/javascript" src="menu_06112020_message.js"></script>
...
Iframe_atual = "menu_06112020_iframe";
...
<?php
 $seq = 0;
echo "Tab_iframes[" . $seq . "] = \"menu_06112020\";\r\n";
echo "Tab_labels['menu_06112020'] = \"Inicio\";\r\n";
echo "Tab_hints['menu_06112020'] = \"Inicio\";\r\n";
echo "Tab_abas['menu_06112020']   = \"none\";\r\n";
echo "Tab_refresh['menu_06112020']   = \"\";\r\n";
echo "Tab_icons['menu_06112020'] = \"scriptcase__NM__ico__NM__sc_menu_home_e.png\";\r\n";
echo "Tab_icons_inactive['menu_06112020'] = \"scriptcase__NM__ico__NM__sc_menu_home_d.png\";\r\n";
echo "Tab_icon_fa['menu_06112020']   = \"\";\r\n";
echo "Tab_icon_fa_inactive['menu_06112020']   = \"\";\r\n";
echo "Tab_display['menu_06112020']   = \"\";\r\n";
echo "Tab_display_position['menu_06112020']   = \"\";\r\n";
echo "Tab_links['menu_06112020']   = \"\";\r\n";
         $seq++;
 if(isset($menu_06112020_menuData['data']) && !empty($menu_06112020_menuData['data']))
 {
   foreach ($menu_06112020_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_06112020_menuData['data_vertical']) && !empty($menu_06112020_menuData['data_vertical']))
 {
   foreach ($menu_06112020_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_06112020_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_06112020'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_06112020').hide();
    if (str_id == "")
    {
        $('#iframe_menu_06112020').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            if (Tab_iframes[i] != 'menu_06112020') 
            {
                Iframe_atual = "menu_06112020_" + Tab_iframes[i] + '_iframe';
            }
...
function del_aba_td(str_id)
{
    ...
    if (Aba_atual == str_id)
    {
        ...
        if (str_id == "" && Aba_atual != "menu_06112020")
        {
            document.getElementById('iframe_menu_06112020').click();
        }
        else
        {
            mudaIframe(str_id);
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_06112020")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_06112020_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    str_id = str_id.replace('iframe_menu_06112020', 'menu_06112020');
    if (str_target == "menu_06112020_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
    ...
    if(str_target != '_blank' && $('#iframe_menu_06112020').length)
        $('#iframe_menu_06112020')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo $this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_06112020_menuData, $path_imag_cab); ?>  <tr class="scMenuHTableCss" id='idMenuLine'>
...
echo $this->menu_06112020_escreveMenu($menu_06112020_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
       </td></tr></table>
<?php
...
<?php
$link_default = "";
if (isset($_SESSION['scriptcase']['sc_apl_seg']['blank_copias_diarias']) && $_SESSION['scriptcase']['sc_apl_seg']['blank_copias_diarias'] == "on") 
{ 
    $SCR  = "";
    $link_default = " onclick=\"openMenuItem('iframe_menu_06112020');\" item-href=\"menu_06112020_form_php.php?sc_item_menu=menu_06112020&sc_apl_menu=blank_copias_diarias&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . "\"  item-target=\"menu_06112020_iframe\"";
} 
else
{ 
    $SCR  = ($NM_scr_iframe != "" ? $NM_scr_iframe : "menu_06112020_pag_ini.php");
} 
?>
      <iframe id="iframe_menu_06112020" name="menu_06112020_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo $SCR; ?>" <?php echo $link_default ?>></iframe>
<?php
 foreach ($menu_06112020_menuData['data'] as $ind => $dados_menu)
 {
     if ($dados_menu['link'] != "#")
     {
         echo "      <iframe id=\"iframe_" . $dados_menu['id'] . "\" name= \"menu_06112020_" . $dados_menu['id'] . "_iframe\" frameborder=\"0\" class=\"scMenuIframe\" style=\"display: none;width: 100%; height: 100%;\" src=\"\"></iframe>
";
     }
 }
}
...
{
    echo "<script>";
    echo "   document.getElementById('iframe_menu_06112020').click()";
    echo "</script>";
}
...
/* Control de Target */
function menu_06112020_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
      ...
      <div class='menu__container'>
        ...
        <?php
            ...
            for ($i = 0; $i < sizeof($aMenuItemList); $i++) {
                ...
                ?>
                    <a href="javascript:" onclick="openMenuItem('menu_06112020_<?php echo $aMenuItemList[$i]['id']; ?>');" item-href="<?php echo $aMenuItemList[$i]['link']; ?>" id="<?php echo $aMenuItemList[$i]['id']; ?>" title="<?php echo $aMenuItemList[$i]['hint']; ?>" <?php echo $aMenuItemList[$i]['target']; ?> class='menu__link <?php echo $sDisabledClass; ?>'><?php echo $str_item; ?></a>
                <?php
                if ($hasChildrens) {
                ?>
...
function menu_06112020_target($str_target)
{
    global $menu_06112020_menuData;
    ...
    elseif ($menu_06112020_menuData['iframe'])
    {
        return 'menu_06112020_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_06112020_menuData, $path_imag_cab)
{
}
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_06112020_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_06112020_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_06112020_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_06112020']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_06112020_target( $arr_item['target']) : "_self"; 
           }
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        return  $_SESSION['scriptcase']['menu_06112020']['sc_init'][$apl_menu];
   }
function fPermisos()
{
$_SESSION['scriptcase']['menu_06112020']['contr_erro'] = 'on';
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0)
   {
      ...
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][1]['menu_06112020'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      {
          $nm_apl_dest = str_replace(".php", "", $nm_apl_dest);
          $nm_apl_dest = $menu_06112020_menuData['url']['link'] . $this->tab_grupo[0] .$nm_apl_dest . "/" . $nm_apl_dest . ".php";
      }
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
...
$contr_menu_06112020 = new menu_06112020_class;
$contr_menu_06112020->menu_06112020_menu();
