  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sucursales" == sTestField)
        {
...
?>
  ...
  // ---------- Validate id_sucursal_
  function do_ajax_form_sucursales_validate_id_sucursal_(iNumLinha)
  {
    var nomeCampo_id_sucursal_ = "id_sucursal_" + iNumLinha;
    var var_id_sucursal_ = scAjaxGetFieldHidden(nomeCampo_id_sucursal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_validate_id_sucursal_(var_id_sucursal_, iNumLinha, var_script_case_init, do_ajax_form_sucursales_validate_id_sucursal__cb);
  } // do_ajax_form_sucursales_validate_id_sucursal_

  function do_ajax_form_sucursales_validate_id_sucursal__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_sucursal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_sucursal_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_sucursal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_sucursal_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_validate_id_sucursal__cb

  // ---------- Validate codigo_suc_
  function do_ajax_form_sucursales_validate_codigo_suc_(iNumLinha)
  {
    var nomeCampo_codigo_suc_ = "codigo_suc_" + iNumLinha;
    var var_codigo_suc_ = scAjaxGetFieldText(nomeCampo_codigo_suc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_validate_codigo_suc_(var_codigo_suc_, iNumLinha, var_script_case_init, do_ajax_form_sucursales_validate_codigo_suc__cb);
  } // do_ajax_form_sucursales_validate_codigo_suc_

  function do_ajax_form_sucursales_validate_codigo_suc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_suc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_suc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigo_suc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_suc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_validate_codigo_suc__cb

  // ---------- Validate observacion_suc_
  function do_ajax_form_sucursales_validate_observacion_suc_(iNumLinha)
  {
    var nomeCampo_observacion_suc_ = "observacion_suc_" + iNumLinha;
    var var_observacion_suc_ = scAjaxGetFieldText(nomeCampo_observacion_suc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_validate_observacion_suc_(var_observacion_suc_, iNumLinha, var_script_case_init, do_ajax_form_sucursales_validate_observacion_suc__cb);
  } // do_ajax_form_sucursales_validate_observacion_suc_

  function do_ajax_form_sucursales_validate_observacion_suc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "observacion_suc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "observacion_suc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "observacion_suc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "observacion_suc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_validate_observacion_suc__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_sucursales_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_sucursales_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_sucursales_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_sucursales_add_new_line_cb);
  } // do_ajax_form_sucursales_add_new_line

  function do_ajax_form_sucursales_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_sucursales_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_sucursales_backup_line(iNumLinha)
  {
    var var_id_sucursal_ = scAjaxGetFieldHidden("id_sucursal_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_backup_line(var_id_sucursal_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_sucursales_backup_line_cb);
  } // do_ajax_form_sucursales_backup_line

  function do_ajax_form_sucursales_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_sucursales_backup_line_cb

  function do_ajax_form_sucursales_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_sucursales_cancel_insert

  function do_ajax_form_sucursales_cancel_update(iSeqVert)
  {
    do_ajax_form_sucursales_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_sucursales_cancel_update

  function do_ajax_form_sucursales_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_sucursales_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_sucursales_table_refresh()
  {
    var var_id_sucursal_ = document.F2.id_sucursal_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sucursales_table_refresh(var_id_sucursal_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sucursales_table_refresh_cb);
  } //  do_ajax_form_sucursales_table_refresh

  function do_ajax_form_sucursales_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_sucursal_.value = scAjaxGetKeyValue("id_sucursal_");
    ...
    scAjaxAlert(do_ajax_form_sucursales_table_refresh_cb_after_alert);
  } // do_ajax_form_sucursales_table_refresh_cb
  function do_ajax_form_sucursales_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_sucursales_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_sucursales_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_sucursales_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_sucursal_ = scAjaxGetFieldHidden("id_sucursal_" + iNumLinha);
    var var_codigo_suc_ = scAjaxGetFieldText("codigo_suc_" + iNumLinha);
    var var_observacion_suc_ = scAjaxGetFieldText("observacion_suc_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_sucursales_submit_form(var_id_sucursal_, var_codigo_suc_, var_observacion_suc_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sucursales_submit_form_cb);
  } // do_ajax_form_sucursales_submit_form

  function do_ajax_form_sucursales_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_sucursal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_suc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("observacion_suc_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_sucursales_submit_form_cb_after_alert);
  } // do_ajax_form_sucursales_submit_form_cb
  function do_ajax_form_sucursales_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sucursales_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sucursales_navigate_form()
  {
    perform_ajax_form_sucursales_navigate_form();
  }

  function perform_ajax_form_sucursales_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_sucursales_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_sucursal_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_suc_" + iNavForm);
      scAjaxHideErrorDisplay("observacion_suc_" + iNavForm);
    }
    var var_id_sucursal_ = document.F2.id_sucursal_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_sucursales_navigate_form(var_id_sucursal_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sucursales_navigate_form_cb);
  } // do_ajax_form_sucursales_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sucursales']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sucursales_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_sucursal_.value = scAjaxGetKeyValue("id_sucursal_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sucursales_navigate_form_cb_after_alert);
  } // do_ajax_form_sucursales_navigate_form_cb
  function do_ajax_form_sucursales_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_sucursales_navigate_form_cb_after_alert
  function sc_hide_form_sucursales_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_sucursal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_suc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "observacion_suc_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_sucursal_" + iNumLinha] = {"label": "Id Sucursal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_suc_" + iNumLinha] = {"label": "CÓDIGO SUCURSAL<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["observacion_suc_" + iNumLinha] = {"label": "OBSERVACIÓN<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_sucursal_"][iNumLinha] = "id_sucursal_" + iNumLinha;
    ajax_field_mult["codigo_suc_"][iNumLinha] = "codigo_suc_" + iNumLinha;
    ajax_field_mult["observacion_suc_"][iNumLinha] = "observacion_suc_" + iNumLinha;
    ajax_field_id["codigo_suc_" + iNumLinha] = new Array("hidden_field_label_codigo_suc_", "hidden_field_data_codigo_suc_" + iNumLinha);
    ajax_field_id["observacion_suc_" + iNumLinha] = new Array("hidden_field_label_observacion_suc_", "hidden_field_data_observacion_suc_" + iNumLinha);
    ajax_error_count["id_sucursal_" + iNumLinha] = "off";
    ajax_error_count["codigo_suc_" + iNumLinha] = "off";
    ajax_error_count["observacion_suc_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_sucursal_" + iNumLinha] = "on";
    ajax_read_only["codigo_suc_" + iNumLinha] = "off";
    ajax_read_only["observacion_suc_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_sucursal_" + iNumLinha] = "on";
    ajax_read_only["codigo_suc_" + iNumLinha] = "on";
    ajax_read_only["observacion_suc_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_sucursal_" + iNumLinha] = null;
    ajax_error_list["codigo_suc_" + iNumLinha] = null;
    ajax_error_list["observacion_suc_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_sucursal_": new Array(),
    "codigo_suc_": new Array(),
    "observacion_suc_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_sucursal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_sucursal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_sucursal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_sucursal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_sucursal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["codigo_suc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_suc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_suc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_suc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_suc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["observacion_suc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["observacion_suc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["observacion_suc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["observacion_suc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["observacion_suc_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_codigo_suc_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_sucursal_'])) ? $this->nmgp_cmp_readonly['id_sucursal_'] : 'on';
?>
    scAjaxFieldRead("id_sucursal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_suc_'])) ? $this->nmgp_cmp_readonly['codigo_suc_'] : 'off';
?>
    scAjaxFieldRead("codigo_suc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['observacion_suc_'])) ? $this->nmgp_cmp_readonly['observacion_suc_'] : 'off';
?>
    scAjaxFieldRead("observacion_suc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_sucursal_" + iSeq, "on");
    scAjaxFieldRead("codigo_suc_" + iSeq, "on");
    scAjaxFieldRead("observacion_suc_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_sucursal_" + iRow] || "on" == ajax_error_count["codigo_suc_" + iRow] || "on" == ajax_error_count["observacion_suc_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_sucursal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_suc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_observacion_suc_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_sucursal_" + iRow] && "off" == ajax_error_count["codigo_suc_" + iRow] && "off" == ajax_error_count["observacion_suc_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_sucursal_" + iRow] = "off";
        ajax_error_count["codigo_suc_" + iRow] = "off";
        ajax_error_count["observacion_suc_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_id_sucursal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_suc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_observacion_suc_" + iRow).removeClass("scFormErrorLine");
    }
  }
