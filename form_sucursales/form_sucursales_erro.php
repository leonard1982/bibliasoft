...
$old_error_handler = set_error_handler("form_sucursales_scriptcase_error_handler");

function form_sucursales_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_sucursales']['contr_erro']) && $_SESSION['scriptcase']['form_sucursales']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_sucursales->contr_form_sucursales->Apl_com_erro = true;
            if ($inicial_form_sucursales->contr_form_sucursales->NM_ajax_flag)
            {
                $inicial_form_sucursales->contr_form_sucursales->NM_ajax_info['errList']['geral_form_sucursales'][] = $msg;
                return;
            }
            form_sucursales_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_sucursales_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_sucursales'])  && '' != $_SESSION['scriptcase']['error_icon']['form_sucursales'])  ? $_SESSION['scriptcase']['error_icon']['form_sucursales']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_sucursales']) && '' != $_SESSION['scriptcase']['error_span_title']['form_sucursales']) ? $_SESSION['scriptcase']['error_span_title']['form_sucursales'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_sucursales']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_sucursales']) ? $_SESSION['scriptcase']['error_icon_title']['form_sucursales'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_sucursales']['error_buffer'] .= ob_get_flush();
}
