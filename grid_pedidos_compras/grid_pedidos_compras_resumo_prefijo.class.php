...
class grid_pedidos_compras_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_prefijo_ped = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['arr_total']['prefijo_ped'];
      }
      else
      {
          $this->array_total_prefijo_ped = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['arr_total']['prefijo_ped'] = $this->array_total_prefijo_ped;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_order']['prefijo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_order']['prefijo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_order']['prefijo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_display']['prefijo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_display']['prefijo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_display']['prefijo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_display']['prefijo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_display']['prefijo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_display']['prefijo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['summarizing_fields_display']['prefijo'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_prefijo_ped as $i_prefijo_ped => $d_prefijo_ped) {
           if (!in_array($i_prefijo_ped, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_prefijo_ped[3] ] = $d_prefijo_ped[2];
               $this->comp_label[0][ $d_prefijo_ped[3] ] = $d_prefijo_ped[2];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_prefijo_ped, $quebra_prefijo_ped_orig)
   {
      //----- Prefijo
      if (!isset($this->array_total_prefijo_ped[$quebra_prefijo_ped_orig]))
      {
         $this->array_total_prefijo_ped[$quebra_prefijo_ped_orig][0] = 1;
         $this->array_total_prefijo_ped[$quebra_prefijo_ped_orig][1] = 1;
         $this->array_total_prefijo_ped[$quebra_prefijo_ped_orig][2] = $quebra_prefijo_ped;
         $this->array_total_prefijo_ped[$quebra_prefijo_ped_orig][3] = $quebra_prefijo_ped_orig;
      }
      else
      {
...
$_SESSION['scriptcase']['grid_pedidos_compras']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->prefijo_ped, $this->prefijo_ped_orig);
            }
   }
//
