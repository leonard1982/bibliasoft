...
class grid_pedidos_compras_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_pedidos_compras_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_pedidos_compras_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_pedidos_compras_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_prefijo_ped')
      {
          $prefijo_ped = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_prefijo_ped($prefijo_ped);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_prefijo_ped($prefijo_ped)
   {
      $prefijo_ped = substr($this->Db->qstr($prefijo_ped), 1, -1);
            $prefijo_ped_look = substr($this->Db->qstr($prefijo_ped), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct prefijo_ped from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and  prefijo_ped like '%" . $prefijo_ped . "%' order by prefijo_ped"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_numpedido($numpedido)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and  numpedido like '%" . $numpedido . "%' order by numpedido"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_numfacven($numfacven)
   {
      ...
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and   CAST (numfacven AS TEXT)  like '%" . $numfacven . "%' order by numfacven"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and   CAST (numfacven AS VARCHAR)  like '%" . $numfacven . "%' order by numfacven"; 
      }
      else
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and  numfacven like '%" . $numfacven . "%' order by numfacven"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Lista de pedidos de compra</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_pedidos_compras/grid_pedidos_compras_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_pedidos_compras_ajax_search.js"></script>
 <script type="text/javascript" src="grid_pedidos_compras_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_pedidos_compras_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pedidos_compras']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pedidos_compras']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_prefijo_ped_cond#NMF#' + search_get_sel_txt('SC_prefijo_ped_cond') + '@NMF@';
  str_out += 'SC_prefijo_ped#NMF#' + search_get_text('SC_prefijo_ped') + '@NMF@';
  str_out += 'id_ac_prefijo_ped#NMF#' + search_get_title('select2-id_ac_prefijo_ped-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-prefijo_ped").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_prefijo_ped",
      max_itens: "10",
   ...
   $("#SC_prefijo_ped").val(e.params.data.id);
  });
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Lista de pedidos de compra</span></td>
...
<?php
   ...
   {
      global 
             $prefijo_ped_cond, $prefijo_ped, $prefijo_ped_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $prefijo_ped = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['prefijo_ped']; 
          $prefijo_ped_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['prefijo_ped_cond']; 
          $numpedido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numpedido']; 
          $numpedido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numpedido_cond']; 
          $numfacven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numfacven']; 
          $numfacven_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numfacven_input_2']; 
          $numfacven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numfacven_cond']; 
          $fechavenc_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_dia']; 
          $fechavenc_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_mes']; 
          $fechavenc_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_ano']; 
          $fechavenc_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_input_2_dia']; 
          $fechavenc_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_input_2_mes']; 
          $fechavenc_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_input_2_ano']; 
          $fechavenc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_cond']; 
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['NM_operador']; 
      } 
      if (!isset($prefijo_ped_cond) || empty($prefijo_ped_cond))
      {
         $prefijo_ped_cond = "eq";
      }
      ...
      $str_hide_prefijo_ped = (in_array($prefijo_ped_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_prefijo_ped = ('bw' == $prefijo_ped_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($prefijo_ped) || $prefijo_ped == "")
      {
          $prefijo_ped = "";
      }
      if (isset($prefijo_ped) && !empty($prefijo_ped))
      {
...
?>
 ...
 $nmgp_tab_label .= "prefijo_ped?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_prefijo_ped_cond" name="prefijo_ped_cond" onChange="nm_campos_between(document.getElementById('id_vis_prefijo_ped'), this, 'prefijo_ped')">
       <OPTION value="eq" <?php if ("eq" == $prefijo_ped_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ii" <?php if ("ii" == $prefijo_ped_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $prefijo_ped_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_prefijo_ped"  <?php echo $str_hide_prefijo_ped?>><?php
      if ($prefijo_ped != "")
      {
      $prefijo_ped_look = substr($this->Db->qstr($prefijo_ped), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct prefijo_ped from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and prefijo_ped = '$prefijo_ped_look' order by prefijo_ped"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$prefijo_ped]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$prefijo_ped];
      }
      else
      {
          $sAutocompValue = $prefijo_ped;
      }
?>
<INPUT  type="text" id="SC_prefijo_ped" name="prefijo_ped" value="<?php echo NM_encode_input($prefijo_ped) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-prefijo_ped" id="id_ac_prefijo_ped" name="prefijo_ped_autocomp"><?php if ('' !=  $prefijo_ped) { ?><option value="<?php echo $prefijo_ped ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_numpedido_cond" name="numpedido_cond" onChange="nm_campos_between(document.getElementById('id_vis_numpedido'), this, 'numpedido')">
       <OPTION value="eq" <?php if ("eq" == $numpedido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $numpedido_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_numpedido"  <?php echo $str_hide_numpedido?>><?php
      if ($numpedido != "")
      {
      $numpedido_look = substr($this->Db->qstr($numpedido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and numpedido = '$numpedido_look' order by numpedido"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and numfacven = $numfacven_look order by numfacven"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PC' and numfacven = $numfacven_look order by numfacven"; 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numfacven" id="id_ac_numfacven" name="numfacven_autocomp"><?php if ('' !=  $numfacven) { ?><option value="<?php echo $numfacven ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_numfacven"  <?php echo $str_display_numfacven; ?> class="scFilterFieldFontOdd">
         ...
         <BR>
         <INPUT type="text" id="SC_numfacven_input_2" name="numfacven_input_2" value="<?php echo NM_encode_input($numfacven_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fechavenc_cond" name="fechavenc_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechavenc'), this, 'fechavenc')">
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechavenc_dia" name="fechavenc_dia" value="<?php echo NM_encode_input($fechavenc_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechavenc_mes" name="fechavenc_mes" value="<?php echo NM_encode_input($fechavenc_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechavenc_ano" name="fechavenc_ano" value="<?php echo NM_encode_input($fechavenc_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechavenc"  <?php echo $str_display_fechavenc; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechavenc_input_2_dia" name="fechavenc_input_2_dia" value="<?php echo NM_encode_input($fechavenc_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechavenc_input_2_mes" name="fechavenc_input_2_mes" value="<?php echo NM_encode_input($fechavenc_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_fechavenc_input_2_ano" name="fechavenc_input_2_ano" value="<?php echo NM_encode_input($fechavenc_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fechaven_cond" name="fechaven_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaven'), this, 'fechaven')">
...
?>
<?php
   if (is_file("grid_pedidos_compras_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_compras']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_compras']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_compras']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_compras']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.prefijo_ped_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_prefijo_ped'), document.F1.prefijo_ped_cond, 'prefijo_ped');
   document.F1.prefijo_ped.value = "";
   document.F1.prefijo_ped_autocomp.value = "";
   $('#select2-id_ac_prefijo_ped-container').html('<?php echo $this->Val_init_prefijo_ped['desc'] ?>');;
   document.F1.numpedido_cond.value = 'eq';
 ...
 {
    $('#SC_fechaven_dia').bind('change', function() {sc_grid_pedidos_compras_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_grid_pedidos_compras_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_grid_pedidos_compras_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_grid_pedidos_compras_valida_mes(this)});
    $('#SC_fechavenc_dia').bind('change', function() {sc_grid_pedidos_compras_valida_dia(this)});
    $('#SC_fechavenc_input_2_dia').bind('change', function() {sc_grid_pedidos_compras_valida_dia(this)});
    $('#SC_fechavenc_input_2_mes').bind('change', function() {sc_grid_pedidos_compras_valida_mes(this)});
    $('#SC_fechavenc_mes').bind('change', function() {sc_grid_pedidos_compras_valida_mes(this)});
 }
 function sc_grid_pedidos_compras_valida_dia(obj)
 {
 ...
 function sc_grid_pedidos_compras_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_pedidos_compras";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_prefijo_ped_cond'] = 'cond';
      $tp_fields['SC_prefijo_ped'] = 'text_aut';
      $tp_fields['id_ac_prefijo_ped'] = 'select2_aut';
   ...
   {
      global $prefijo_ped_cond, $prefijo_ped, $prefijo_ped_autocomp,
             $numpedido_cond, $numpedido, $numpedido_autocomp,
             $numfacven_cond, $numfacven, $numfacven_input_2, $numfacven_autocomp,
             $fechavenc_cond, $fechavenc, $fechavenc_dia, $fechavenc_mes, $fechavenc_ano, $fechavenc_input_2_dia, $fechavenc_input_2_mes, $fechavenc_input_2_ano,
      ...
      if (!empty($prefijo_ped_autocomp) && empty($prefijo_ped))
      {
          $prefijo_ped = $prefijo_ped_autocomp;
      }
      ...
      $prefijo_ped_cond_salva = $prefijo_ped_cond; 
      if (!isset($prefijo_ped_input_2) || $prefijo_ped_input_2 == "")
      {
          $prefijo_ped_input_2 = $prefijo_ped;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['prefijo_ped'] = $prefijo_ped; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['prefijo_ped_cond'] = $prefijo_ped_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numpedido'] = $numpedido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numpedido_cond'] = $numpedido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numfacven'] = $numfacven; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numfacven_input_2'] = $numfacven_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['numfacven_cond'] = $numfacven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_dia'] = $fechavenc_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_mes'] = $fechavenc_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_ano'] = $fechavenc_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_input_2_dia'] = $fechavenc_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_input_2_mes'] = $fechavenc_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_input_2_ano'] = $fechavenc_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_cond'] = $fechavenc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca'] = $Temp_Busca;
      }
      if ($numfacven_cond != "in" && $numfacven_cond != "bw" && !empty($numfacven) && !is_numeric($numfacven))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Factura No.";
      }
    ...
    if ($prefijo_ped != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['prefijo_ped'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['prefijo_ped'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['prefijo_ped'] = $prefijo_ped;
      }
      $nmgp_def_dados = array();
    if ($numpedido != '') {
      $numpedido_look = substr($this->Db->qstr($numpedido), 1, -1); 
   ...
   { 
      ...
      if (isset($prefijo_ped) || $prefijo_ped_cond == "nu" || $prefijo_ped_cond == "nn" || $prefijo_ped_cond == "ep" || $prefijo_ped_cond == "ne")
      {
         $this->monta_condicao("prefijo_ped", $prefijo_ped_cond, $prefijo_ped, "", "prefijo_ped");
      }
      ...
      if ($fechavenc_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc'] = $val[0];
          ...
          if ($fechavenc_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechavenc_input_2'] = $val[1];
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']['fechaven_input_2'] = $val[1];
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq'];
