...
class grid_pedidos_compras_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_pedidos_compras']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_pedidos_compras']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $prefijo_ped, $idcli, $numfacven, $nremision, $vendedor;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['where_pesq']; 
      } 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['contr_total_geral'] = "OK";
   } 
   ...
   {
      global $tot_prefijo_ped, $prefijo_ped, $idcli, $numfacven, $nremision, $vendedor;
      $tot_prefijo_ped = array() ;  
      $tot_prefijo_ped[0] = $prefijo_ped ; 
   }
   //-----  vendedor
   function quebra_vendedor_vendedor($vendedor, $arg_sum_vendedor) 
   {
      global $tot_vendedor, $prefijo_ped, $idcli, $numfacven, $nremision, $vendedor;
      $tot_vendedor = array() ;  
   ...
   {
      global $nm_lang, $facturado, $imprimir, $prefijo_ped, $idcli, $numfacven, $nremision, $vendedor;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('prefijo_ped' => "prefijo_ped");
      $cmps_quebra_atual = array("prefijo_ped");
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_prefijo($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('idpedido' => 'N','numfacven' => 'N','nremision' => 'N','credito' => 'N','idcli' => 'N','subtotal' => 'N','valoriva' => 'N','total' => 'N','asentada' => 'N','saldo' => 'N','adicional' => 'N','adicional2' => 'N','adicional3' => 'N','vendedor' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_compras']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['prefijo_ped']['reg'] = "S";
      $format_dimensions['prefijo_ped']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "prefijo_ped") {
                  $this->Lookup->lookup_prefijo_prefijo_ped($$Cada_dim,  $prefijo_ped);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
