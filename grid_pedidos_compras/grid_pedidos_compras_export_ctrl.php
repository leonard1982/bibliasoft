<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pedidos_compras']['sc_process_barr'] = true;
require_once('../grid_pedidos_compras/index.php');
unset($_SESSION['scriptcase']['grid_pedidos_compras']['sc_process_barr']);
$ExportCtrl = new grid_pedidos_compras_export_control;
$ExportCtrl->Export_barr();

class grid_pedidos_compras_export_control
{
