 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_prefijo_ped_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['prefijo_ped'])) ? $this->New_label['prefijo_ped'] : "Prefijo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_prefijo_ped_cond" name="prefijo_ped_cond" onChange="nm_campos_between(document.getElementById('id_vis_prefijo_ped'), this, 'prefijo_ped')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_prefijo_ped" <?php echo $str_hide_prefijo_ped?> valign="top">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-prefijo_ped" id="id_ac_prefijo_ped" name="prefijo_ped_autocomp"><?php if ('' !=  $prefijo_ped) { ?><option value="<?php echo $prefijo_ped ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_numpedido_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numpedido'])) ? $this->New_label['numpedido'] : "Pedido #"; ?></TD>
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numpedido" id="id_ac_numpedido" name="numpedido_autocomp"><?php if ('' !=  $numpedido) { ?><option value="<?php echo $numpedido ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_numfacven_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "Factura No."; ?></TD>
     <TD class="scFilterFieldOdd"> 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numfacven" id="id_ac_numfacven" name="numfacven_autocomp"><?php if ('' !=  $numfacven) { ?><option value="<?php echo $numfacven ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       ...
       <TR valign="top">
        <TD id="id_vis_numfacven"  <?php echo $str_display_numfacven; ?> class="scFilterFieldFontOdd">
         ...
         <BR>
         <INPUT type="text" id="SC_numfacven_input_2" name="numfacven_input_2" value="<?php echo NM_encode_input($numfacven_input_2) ?>"  size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_fechavenc_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fechavenc'])) ? $this->New_label['fechavenc'] : "Fecha vencimiento"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fechavenc_cond" name="fechavenc_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechavenc'), this, 'fechavenc')">
