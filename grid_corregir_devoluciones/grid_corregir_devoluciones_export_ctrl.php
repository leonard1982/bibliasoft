<?php
@session_start() ;
$_SESSION['scriptcase']['grid_corregir_devoluciones']['sc_process_barr'] = true;
require_once('../grid_corregir_devoluciones/index.php');
unset($_SESSION['scriptcase']['grid_corregir_devoluciones']['sc_process_barr']);
$ExportCtrl = new grid_corregir_devoluciones_export_control;
$ExportCtrl->Export_barr();

class grid_corregir_devoluciones_export_control
{
