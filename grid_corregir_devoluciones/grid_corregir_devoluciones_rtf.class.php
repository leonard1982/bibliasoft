...
class grid_corregir_devoluciones_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_corregir_devoluciones.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corregir_devoluciones']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corregir_devoluciones']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corregir_devoluciones']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corregir_devoluciones']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corregir_devoluciones']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corregir_devoluciones']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_corregir_devoluciones']['contr_erro'] = 'off'; 
   ...
   function NM_export_eliminar()
   {
         ...
         $this->eliminar = str_replace('<', '&lt;', $this->eliminar);
         $this->eliminar = str_replace('>', '&gt;', $this->eliminar);
         $this->Texto_tag .= "<td>" . $this->eliminar . "</td>\r\n";
   }
   //----- iddeta
   function NM_export_iddeta()
   {
         ...
         $this->iddeta = str_replace('<', '&lt;', $this->iddeta);
         $this->iddeta = str_replace('>', '&gt;', $this->iddeta);
         $this->Texto_tag .= "<td>" . $this->iddeta . "</td>\r\n";
   }
   //----- factor
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_corregir_devoluciones']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_corregir_devoluciones']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
