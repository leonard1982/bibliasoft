...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_corregir_devoluciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_corregir_devoluciones"]);
   }
