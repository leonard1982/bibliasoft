...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_corregir_devoluciones"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_corregir_devoluciones"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_corregir_devoluciones']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_corregir_devoluciones']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_corregir_devoluciones']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_corregir_devoluciones']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_corregir_devoluciones']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_corregir_devoluciones</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_corregir_devoluciones']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_corregir_devoluciones']['embutida_filho'] as $ind => $sc_init)
          {
