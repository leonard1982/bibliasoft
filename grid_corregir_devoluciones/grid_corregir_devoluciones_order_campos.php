<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_corregir_devoluciones']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_corregir_devoluciones_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_corregir_devoluciones_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["idpro"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["idbod"] : "Ubicación";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["valorunit"] : "Valor unit.";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["valorpar"] : "Valor parcial";
   $tab_ger_campos['iva'] = "on";
   $tab_def_campos['iva'] = "iva";
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["iva"] : "IVA";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["descuento"] : "Descuento";
   $tab_ger_campos['unidadmayor'] = "on";
   $tab_def_campos['unidadmayor'] = "unidadmayor";
   $tab_labels["unidadmayor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["unidadmayor"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["unidadmayor"] : "";
   $tab_ger_campos['eliminar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['eliminar'] = "eliminar";
   }
   else
   {
       $tab_def_campos['eliminar'] = "";
   }
   $tab_labels["eliminar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["eliminar"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["eliminar"] : "Deshacer Dev.";
   $tab_ger_campos['iddeta'] = "on";
   $tab_def_campos['iddeta'] = "iddeta";
   $tab_labels["iddeta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["iddeta"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["iddeta"] : "";
   $tab_ger_campos['factor'] = "on";
   $tab_def_campos['factor'] = "factor";
   $tab_labels["factor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["factor"])) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['labels']["factor"] : "";
   $tab_ger_campos['eliminar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - detalleventa</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_corregir_devoluciones_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_corregir_devoluciones']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
