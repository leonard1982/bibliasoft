...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            function imprimir() {
                ...
                if (comparar_fechas(fechaini, fechafin)){
                    ...
                    if ((fechaini=="") || (fechafin=="")) {
                        ...
                        location.href="imprimir_certificados.php?fechadesde=" + fechaini + "&fechahasta=" + fechafin + "&idproveedor=" + idproveedor;
                    }
                }
            }
            ...
            function nueva_multiple() {
                location.href="nueva_multiple.php";
            }
    ...
    <body onLoad="inicio()">
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">Buscar ENVIOS</div>
                    <div id="frmBusqueda">
                        <form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
                                <tr>
                                    ...
                                    <td width="70%"><a href="#"><img src="../img/ver.png" width="16" height="16" border="0" id="lupa" name="lupa" title="Seleccionar proveedor" vertical-align="baseline"></a>&nbsp;&nbsp;&nbsp;<input type="text" name="anombreproveedor" id="anombreproveedor" class="cajaGrandeR" readonly value="<?= $_SESSION['certiprov'] ?>"></td>
                                    <td width="5%"><input type="hidden" name="nidproveedor" id="nidproveedor" class="cajaPequenaR" value="<?= $_SESSION['certinid'] ?>"></td>
                                </tr>
                                <tr>
                                    <td width="25%">Desde</td>
                                    <td width="70%"><input id="fechadesde" type="text" class="cajaPequenaR" NAME="fechadesde" maxlength="10" readonly value="<?= $_SESSION['certifechini'] ?>"><img src="../img/calendario.png" name="Image1" width="16" height="16" border="0" id="Image1" onMouseOver="this.style.cursor='pointer'" title="Calendario">
                            ...
                            <div id="botonBusqueda">
                                ...
                                <?php } ?>
                                    <?php if ($permisos == 'escritura') { ?>
                                    <img src="../img/bt_nuevo_multiple.jpg" width="122" height="22" border="1" onClick="nueva_multiple()" onMouseOver="style.cursor=cursor">					
                                <?php } ?>
                                <?php if ($permisos == 'escritura') { ?>
