    ...
    <body>
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">INSERTAR ENVIO CERTIFICADO</div>
                    <div id="frmBusqueda">
                        <form id="formulario" name="formulario" method="post" action="guardar.php" enctype="multipart/form-data">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                                <tr>
                                    ...
                                    <td width="80%"><input id="fechaenvio" type="text" class="cajaPequenaR" NAME="fechaenvio" maxlength="10" readonly value="<?= $hoy ?>"><img src="../img/calendario.png" name="Image1" width="16" height="16" border="0" id="Image1" onMouseOver="this.style.cursor='pointer'" title="Calendario">
                                ...
                                <tr>
                                    <td>Proveedor</td>
                                    <td><a href="#"><img src="../img/ver.png" width="16" height="16" border="0" id="lupa" name="lupa" title="Seleccionar proveedor" vertical-align="baseline"></a>&nbsp;&nbsp;&nbsp;<input type="text" name="anombreproveedor" id="anombreproveedor" class="cajaGrandeR" readonly>
                                        <input type="hidden" name="nidproveedor" id="nidproveedor" class="cajaPequenaR"></td>
                                </tr>
                                <tr>
                                    <td>CIF</td>
                                    <td><input NAME="cif" type="text" class="cajaMedia" id="cif" maxlength="20"></td>
                                </tr>
                                <tr>
                                    <td>Direccion</td>
                                    <td><input NAME="direccion" type="text" class="cajaExtraGrande" id="direccion" maxlength="100"></td>
                                </tr>
                                <tr>
                                    <td>Codigo postal</td>
                                    <td><input NAME="cpproveedor" type="text" class="cajaPequena" id="cpproveedor" maxlength="5"></td>
                                </tr>
                                <tr>
                                    <td>Poblacion</td>
                                    <td><input NAME="poblacion" type="text" class="cajaExtraGrande" id="poblacion" maxlength="50"></td>
                                </tr>
                                <tr>
                                    <td>Provincia</td>
                                    <td><input NAME="provincia" type="text" class="cajaExtraGrande" id="provincia" maxlength="50"></td>
                                </tr>
                                <td>Cod. Envio (*)</td>
                                <td><input NAME="codigocer" type="text" class="cajaMedia" id="codigocer" maxlength="30"></td>
                                </tr>
                            </table>
                            <hr>
                            </div>
