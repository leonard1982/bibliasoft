...
$_SESSION['mantidtipoiva'] = $_POST['idtipoiva'];

$idtipoiva = $_POST["idtipoiva"];

$tasasiva = new tasasiva();

$resultado = $tasasiva->buscar($idtipoiva);
?>
<html>
    <head>
        ...
        <div id="container" style="display:none">			
            <div id="demo">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    <thead>
                        <tr>
                            <th width="33%">TIPO IGIC</th>
                            <th width="20%">% TASA</th>
                            <th width="20%">% ENTRE TASA</th>
                            <th width="15%">FECHA TASA</th>
<!--                            <th width="4%">&nbsp;</th>-->
                            <th width="6%">&nbsp;</th>
                            <th width="6%">&nbsp;</th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        while ($row = mysql_fetch_row($resultado)) {
                            ...
                            ?>
                            <tr class="<?= $fondolinea ?>">
                                <td width="33%"><div align="center"><?= $row[5] ?></div></td>
                                <td width="20%"><div align="center"><?= $row[2] ?></div></td>
                                <td width="20%"><div align="center"><?= $row[3] ?></div></td>
                                <td width="15%"><div align="center"><?= implota($row[4]) ?></div></td>
