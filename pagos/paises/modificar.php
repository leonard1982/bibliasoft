    ...
    <body>
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">MODIFICAR PAIS</div>
                    <div id="frmBusqueda">
                        <form id="formulario" name="formulario" method="post" action="guardar.php">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                                ...
                                <tr>
                                    ...
                                    <td width="36%"><input NAME="Adenominacion" type="text" class="cajaGrande" id="denominacion" maxlength="50" value="<?= $row[1] ?>"></td>
                                    <td width="50%"></td>
                                </tr>						
                            </table>
                            <hr>
