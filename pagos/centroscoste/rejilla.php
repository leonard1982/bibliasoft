...
$_SESSION['mantcentroden'] = $_POST["denominacion"];

$denominacion = $_POST["denominacion"];

$centroscoste = new centroscoste();

$resultado = $centroscoste->buscar($denominacion);
?>
<html>
    <head>
        <title>Centros de Coste</title>
        ...
        <div id="container" style="display:none">			
            <div id="demo">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    <thead>
                        <tr>
                            <th width="71%">DENOMINACION</th>
                            <th width="20%">CODIGO INTERNO</th>
<!--                            <th width="4%">&nbsp;</th>-->
                            <th width="6%">&nbsp;</th>
                            <th width="6%">&nbsp;</th>
                        </tr>
                    ...
                    <tbody>
                        ...
                        while ($row = mysql_fetch_row($resultado)) {
                            ...
                            ?>
                            <tr class="<?= $fondolinea ?>">
                                <td width="71%"><div align="center"><?= $row[2] ?></div></td>
