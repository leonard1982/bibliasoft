...
$_SESSION['mantidentidadsuc'] = $_POST['identidad'];
$_SESSION['mantdensuc'] = $_POST['denominacion'];
$_SESSION['mantidpaissuc'] = $_POST['idpais'];
$_SESSION['mantidprovsuc'] = $_POST['idprovincia'];
$_SESSION['mantidpobsuc'] = $_POST['idpoblacion'];
...
$resultado = $sucursales->buscar($identidad, $nombre, $idpais, $idprovincia, $idpoblacion);
?>
<html>
    <head>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    ...
                    <tbody>
                        ...
                        while ($row = mysql_fetch_row($resultado)) {
                            ...
                            ?>
                            <tr class="<?= $fondolinea ?>">
                                <td width="30%"><div align="center"><?= $row[16] ?> [<?= $row[3] ?>]</div></td>
                                <td width="30%"><div align="center"><?= $row[4] ?></div></td>
                                <td width="28%"><div align="center"><?= $row[13] ?></div></td>
