                        ...
                        <form id="formulario" name="formulario" method="post" action="guardar.php">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                                ...
                                <tr>
                                    ...
                                    <td width="36%"><input NAME="Adenominacion" type="text" class="cajaGrande" id="denominacion" maxlength="100" value="<?= $row[2] ?>"></td>
                                    <td width="50%"></td>
                                </tr>
                                <tr>
                                    <td width="14%">Codigo (*)</td>
                                    <td width="36%"><input NAME="Acodigoentidad" type="text" class="cajaPequena" id="codigoentidad" maxlength="4" value="<?= $row[1] ?>"></td>
                                    <td width="50%"></td>
                                </tr>						
                            </table>
                            <hr>
