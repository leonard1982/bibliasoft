...
$_SESSION['mantebden'] = $_POST["denominacion"];
$_SESSION['mantebce'] = $_POST["codigoentidad"];
...
$resultado = $entidades->buscar($codigoentidad, $denominacion);
?>
<html>
    <head>
        ...
        <div id="container" style="display:none">			
            <div id="demo">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                    <thead>
                        <tr>
                            <th width="76%">DENOMINACI&Oacute;N</th>
...
<!--                            <th width="4%">&nbsp;</th>-->
                    ...
                    <tbody>
                        ...
                        while ($row = mysql_fetch_row($resultado)) {
                            ...
                            ?>
                            <tr class="<?= $fondolinea ?>">
                                <td width="76%"><div align="center"><?= $row[2] ?></div></td>
                                <td width="15%"><div align="center"><?= $row[1] ?></div></td>
