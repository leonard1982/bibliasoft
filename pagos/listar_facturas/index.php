    ...
    <head>
        ...
        <script language="javascript">
            ...
            function imprimir() {
                ...
                var pagadas=document.getElementById("pagadas").value;
                    ...
                    if ((fechaini=="") || (fechafin=="")) {
                        ...
                        if (idproveedor=="") {
                            if (confirm("No ha elegido ningun proveedor. Saldra un listado con todos los proveedores. Desea continuar con la impresion?"))
                                location.href="imprimir_listado_facturas.php?fechadesde=" + fechaini + "&fechahasta=" + fechafin + "&idproveedor=" + idproveedor + "&pagadas=" + pagadas;
                        } else {
                            location.href="imprimir_listado_facturas.php?fechadesde=" + fechaini + "&fechahasta=" + fechafin + "&idproveedor=" + idproveedor + "&pagadas=" + pagadas; 
                        }    
                    }
    ...
    <body>
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">LISTADO FACTURAS</div>
                    <div id="frmBusqueda">
                        <form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
                                ...
                                <tr>
                                    <td width="25%">Imprimir pagadas</td>
                                    <td width="70%"><select name="pagadas" id="pagadas" class="comboPequeno">
