    ...
    <body onLoad="inicio()">
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">Buscar PROVEEDORES</div>
                    <div id="frmBusqueda">
                        <form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
                                <tr>
                                    <td>Nombre</td>
                                    <td><input id="nombre" name="nombre" type="text" class="cajaGrande" maxlength="200" value="<?= $_SESSION['mantprovnom'] ?>"></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>CIF</td>
                                    <td><input id="cif" name="cif" type="text" class="cajaMedia" maxlength="12" value="<?= $_SESSION['mantprovcif'] ?>"></td>
                                    <td>&nbsp;</td>
                                    <td>&nbsp;</td>
                                </tr>
                            </table>
