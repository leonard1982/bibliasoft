                    ...
                    if ((fechaini=="") || (fechafin=="")) {
                        ...
                        if (idproveedor=="") {
                            if (confirm("No ha elegido ningun proveedor. Saldra un listado con todos los proveedores. Desea continuar con la impresion?"))
                                location.href="imprimir_listado_transferencias.php?fechadesde=" + fechaini + "&fechahasta=" + fechafin + "&idproveedor=" + idproveedor;
                        } else {
                            location.href="imprimir_listado_transferencias.php?fechadesde=" + fechaini + "&fechahasta=" + fechafin + "&idproveedor=" + idproveedor; 
                        }    
                    }
    ...
    <body>
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">LISTADO TRANSFERENCIAS</div>
                    <div id="frmBusqueda">
