    ...
    <body>
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">INSERTAR MONEDA</div>
                    <div id="frmBusqueda">
                        <form id="formulario" name="formulario" method="post" action="guardar.php">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>
                                ...
                                <tr>
                                    <td width="14%">Codigo 1</td>
                                    <td width="36%"><input NAME="acodmoneda" type="text" class="cajaPequena" id="codigo1" maxlength="2"></td>
                                    <td width="50%"></td>
                                </tr>						
                            </table>
                            <hr>
