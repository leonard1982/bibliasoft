            ...
            function imprimir() {
                ...
                if (comparar_fechas(fechaini, fechafin)){
                    ...
                    if ((fechaini=="") || (fechafin=="")) {
                        ...
                        if (confirm("Las ordenes de pago pasaran a estar procesadas. Desea continuar con la impresion?")) location.href="imprimir_cartas_pago.php?fechadesde=" + fechaini + "&fechahasta=" + fechafin + "&idproveedor=" + idproveedor;
                    }
                }
            }
    ...
    <body onLoad="inicio()">
        <div id="pagina">
            <div id="zonaContenido">
                <div align="center">
                    <div id="tituloForm" class="header">Buscar CARTAS DE PAGO</div>
                    <div id="frmBusqueda">
                        <form id="form_busqueda" name="form_busqueda" method="post" action="rejilla.php" target="frame_rejilla">
                            ...
                            <table class="fuente8" width="98%" cellspacing=0 cellpadding=3 border=0>					
                                ...
                                <tr>
                                    <td width="25%">Mostrar impresas</td>
                                    <td width="70%"><select name="impresas" id="impresas" class="comboPequeno">
                                            <?php if ($_SESSION["impresas"] == "") { ?><option value="" selected>Todas</option><?php } else { ?><option value="">Todas</option><? } ?>
                                            <?php if ($_SESSION["impresas"] == "") { ?><option value="1" selected>Si</option><?php } else { ?><option value="1">Si</option><? } ?>
                                            <?php if ($_SESSION["impresas"] == "") { ?><option value="0" selected>No</option><?php } else { ?><option value="0">No</option><? } ?>
                                        </select></td>
                                    <td width="5%"></td>
                                </tr>
                            </table>
