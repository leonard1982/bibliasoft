...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_prefijos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_prefijos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cloud_prefijos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_prefijos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_prefijos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_prefijos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_prefijos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cloud_prefijos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_cloud_prefijos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_prefijos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cloud_prefijos']['embutida_filho'] as $ind => $sc_init)
          {
