...
class grid_cloud_prefijos_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_cloud_prefijos/grid_cloud_prefijos_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_cloud_prefijos_res_xls.class.php");
              $this->Res_xls = new grid_cloud_prefijos_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_cloud_prefijos.zip";
          $this->Arquivo   .= "_grid_cloud_prefijos" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_final()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->final, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->final, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vigencia
   ...
   function NM_export_tipo_resolucion()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipo_resolucion, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipo_resolucion, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- activa
   ...
   function NM_export_id_prefijo()
   {
         ...
         if (is_numeric($this->id_prefijo))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->id_prefijo);
         $this->Xls_col++;
   }
   //----- id_empresa
   ...
   function NM_export_cod_prefijo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cod_prefijo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->cod_prefijo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- prefijo_prueba
   function NM_export_prefijo_prueba()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->prefijo_prueba, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->prefijo_prueba, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- prefijo
   ...
   //----- final
   function NM_sub_cons_final()
   {
         $this->final = html_entity_decode($this->final, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->final = strip_tags($this->final);
         $this->final = NM_charset_to_utf8($this->final);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->final;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tipo_resolucion
   function NM_sub_cons_tipo_resolucion()
   {
         $this->tipo_resolucion = html_entity_decode($this->tipo_resolucion, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->tipo_resolucion = strip_tags($this->tipo_resolucion);
         $this->tipo_resolucion = NM_charset_to_utf8($this->tipo_resolucion);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tipo_resolucion;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- id_prefijo
   function NM_sub_cons_id_prefijo()
   {
         $this->id_prefijo = NM_charset_to_utf8($this->id_prefijo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->id_prefijo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- cod_prefijo
   function NM_sub_cons_cod_prefijo()
   {
         $this->cod_prefijo = html_entity_decode($this->cod_prefijo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->cod_prefijo = strip_tags($this->cod_prefijo);
         $this->cod_prefijo = NM_charset_to_utf8($this->cod_prefijo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cod_prefijo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- prefijo_prueba
   function NM_sub_cons_prefijo_prueba()
   {
         $this->prefijo_prueba = html_entity_decode($this->prefijo_prueba, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->prefijo_prueba = strip_tags($this->prefijo_prueba);
         $this->prefijo_prueba = NM_charset_to_utf8($this->prefijo_prueba);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->prefijo_prueba;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cloud_prefijos']['nolabel'])
       {
