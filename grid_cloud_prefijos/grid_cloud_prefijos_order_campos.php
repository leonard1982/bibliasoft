...
<?php
   ...
   $Ord_Cmp = new grid_cloud_prefijos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cloud_prefijos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["prefijo"] : "Prefijo";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["resolucion"] : "Resolucion";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['inicial'] = "on";
   $tab_def_campos['inicial'] = "inicial";
   $tab_labels["inicial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["inicial"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["inicial"] : "Inicial";
   $tab_ger_campos['final'] = "on";
   $tab_def_campos['final'] = "final";
   $tab_labels["final"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["final"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["final"] : "Final";
   $tab_ger_campos['vigencia'] = "on";
   $tab_def_campos['vigencia'] = "vigencia";
   $tab_labels["vigencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["vigencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["vigencia"] : "Vigencia";
   $tab_ger_campos['tipo_resolucion'] = "on";
   $tab_def_campos['tipo_resolucion'] = "tipo_resolucion";
   $tab_labels["tipo_resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["tipo_resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["tipo_resolucion"] : "Tipo Resolucion";
   $tab_ger_campos['activa'] = "on";
   $tab_def_campos['activa'] = "activa";
   $tab_labels["activa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["activa"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['labels']["activa"] : "Activa";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cloud_prefijos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cloud_prefijos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
