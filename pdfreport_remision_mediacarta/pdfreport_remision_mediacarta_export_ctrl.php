<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_remision_mediacarta']['sc_process_barr'] = true;
require_once('../pdfreport_remision_mediacarta/index.php');
unset($_SESSION['scriptcase']['pdfreport_remision_mediacarta']['sc_process_barr']);
$ExportCtrl = new pdfreport_remision_mediacarta_export_control;
$ExportCtrl->Export_barr();

class pdfreport_remision_mediacarta_export_control
{
