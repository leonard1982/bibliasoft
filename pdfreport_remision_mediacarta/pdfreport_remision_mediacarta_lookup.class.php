<?php
class pdfreport_remision_mediacarta_lookup
{
//  
...
//  
   function lookup_detalleventa(&$conteudo , $nremision, &$nm_array_retorno_lookup) 
   {
      ...
      $conteudo = "";
      $nm_comando = "SELECT 
   fl.remision, fl.cantidad,
   fl.idpro, p.nompro,  fl.unidadmayor, fl.factor,
...
remision=$nremision" ; 
      ...
      { 
          ...
          $a = 0; 
          $x = 0; 
          $nm_tmp_campos_select = explode(",", "fl.remision, fl.cantidad,
   fl.idpro, p.nompro,  fl.unidadmayor, fl.factor,
   if(fl.unidadmayor='NO' and fl.factor>0, p.unimen, p.unimay) as unidad,
   (fl.valorunit-fl.descuento-(fl.iva/fl.cantidad)) as valorunita,   (fl.valorpar-fl.descuento-fl.iva) as parcial, fl.iva, fl.adicional"); 
