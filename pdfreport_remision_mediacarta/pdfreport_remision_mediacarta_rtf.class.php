...
class pdfreport_remision_mediacarta_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
...
$_SESSION['scriptcase']['pdfreport_remision_mediacarta']['contr_erro'] = 'off'; 
   ...
   function NM_export_detalleventa_fl_remision()
   {
         ...
         $this->detalleventa_fl_remision = str_replace('<', '&lt;', $this->detalleventa_fl_remision);
         $this->detalleventa_fl_remision = str_replace('>', '&gt;', $this->detalleventa_fl_remision);
         $this->Texto_tag .= "<td>" . $this->detalleventa_fl_remision . "</td>\r\n";
   }
