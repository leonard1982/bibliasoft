...
class pdfreport_remision_mediacarta_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "pdfreport_remision_mediacarta/pdfreport_remision_mediacarta_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['json_format'];
      }
...
$_SESSION['scriptcase']['pdfreport_remision_mediacarta']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "pdfreport_remision_mediacarta_res_json.class.php");
              $this->Res = new pdfreport_remision_mediacarta_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_remision_mediacarta']['json_res_grid']);
          } 
      }
   ...
   function NM_export_detalleventa_fl_remision()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->detalleventa_fl_remision;
   }
