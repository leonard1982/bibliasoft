<?php
   include_once('grid_kardex_fv_tns_session.php');
   session_start();
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_fv_tns"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_kardex_fv_tns"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_kardex_fv_tns</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_kardex_fv_tns']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_kardex_fv_tns' || $achou)
          {
