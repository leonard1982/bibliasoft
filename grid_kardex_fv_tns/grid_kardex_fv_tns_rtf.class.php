...
class grid_kardex_fv_tns_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_kardex_fv_tns.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_kardex_fv_tns']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_kardex_fv_tns']['contr_erro'] = 'off'; 
   ...
   function NM_export_numfe()
   {
         ...
         $this->numfe = str_replace('<', '&lt;', $this->numfe);
         $this->numfe = str_replace('>', '&gt;', $this->numfe);
         $this->Texto_tag .= "<td>" . $this->numfe . "</td>\r\n";
   }
   //----- nombre
   ...
   function NM_export_ico_cliente()
   {
         ...
         $this->ico_cliente = str_replace('<', '&lt;', $this->ico_cliente);
         $this->ico_cliente = str_replace('>', '&gt;', $this->ico_cliente);
         $this->Texto_tag .= "<td>" . $this->ico_cliente . "</td>\r\n";
   }
   //----- total
   ...
   function NM_export_avisos()
   {
         ...
         $this->avisos = str_replace('<', '&lt;', $this->avisos);
         $this->avisos = str_replace('>', '&gt;', $this->avisos);
         $this->Texto_tag .= "<td>" . $this->avisos . "</td>\r\n";
   }
   //----- adjuntos
   function NM_export_adjuntos()
   {
         $this->adjuntos = NM_charset_to_utf8($this->adjuntos);
         $this->adjuntos = str_replace('<', '&lt;', $this->adjuntos);
         $this->adjuntos = str_replace('>', '&gt;', $this->adjuntos);
         $this->Texto_tag .= "<td>" . $this->adjuntos . "</td>\r\n";
   }
   //----- sc_field_0
   ...
   function NM_export_kardexid()
   {
         ...
         $this->kardexid = str_replace('<', '&lt;', $this->kardexid);
         $this->kardexid = str_replace('>', '&gt;', $this->kardexid);
         $this->Texto_tag .= "<td>" . $this->kardexid . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_kardex_fv_tns']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
