...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fecasentad_cond" name="fecasentad_cond" onChange="nm_campos_between(document.getElementById('id_vis_fecasentad'), this, 'fecasentad')">
