...
<?php
   ...
   $Ord_Cmp = new grid_kardex_fv_tns_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_kardex_fv_tns_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["num"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["num"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["num"] : "# TNS";
   ...
   $tab_labels["enviar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["enviar"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["enviar"] : "ENVIAR";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "FECHA";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["fecha"] : "FECHA";
   ...
   $tab_labels["numfe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["numfe"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["numfe"] : "DOC";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "NOMBRE";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["nombre"] : "NOMBRE";
   $tab_ger_campos['email2'] = "on";
   $tab_def_campos['email2'] = "EMAIL2";
   $tab_labels["email2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["email2"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["email2"] : "CORREO";
   ...
   $tab_labels["ico_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["ico_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["ico_cliente"] : "";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "TOTAL";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["total"] : "TOTAL";
   ...
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["detalle"] : "DETALLE";
   ...
   $tab_labels["pdf"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["pdf"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["pdf"] : "PDF";
   ...
   $tab_labels["avisos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["avisos"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["avisos"] : "XML";
   ...
   $tab_labels["adjuntos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["adjuntos"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["adjuntos"] : "";
   ...
   $tab_labels["sc_field_0"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["sc_field_0"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["sc_field_0"] : "";
   $tab_ger_campos['kardexid'] = "on";
   $tab_def_campos['kardexid'] = "KARDEXID";
   $tab_labels["kardexid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["kardexid"])) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['labels']["kardexid"] : "ID";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_kardex_fv_tns_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_kardex_fv_tns']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
