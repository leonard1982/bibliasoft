...
class grid_tesoreria_proveedor_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_tesoreria_proveedor_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_tesoreria_proveedor_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_tesoreria_proveedor_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_numfacom($numfacom)
   {
      ...
      $nm_comando = "select distinct numfacom from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and  numfacom like '%" . $numfacom . "%' order by numfacom"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_formapago($formapago)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct formapago from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and  formapago like '%" . $formapago . "%' order by formapago"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_pagada($pagada)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pagada from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and  pagada like '%" . $pagada . "%' order by pagada"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_saldo($saldo)
   {
      ...
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and   CAST (saldo AS TEXT)  like '%" . $saldo . "%' order by saldo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and   CAST (saldo AS VARCHAR)  like '%" . $saldo . "%' order by saldo"; 
      }
      else
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and  saldo like '%" . $saldo . "%' order by saldo"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - facturacom</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_tesoreria_proveedor/grid_tesoreria_proveedor_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_tesoreria_proveedor_ajax_search.js"></script>
 <script type="text/javascript" src="grid_tesoreria_proveedor_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_tesoreria_proveedor_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tesoreria_proveedor']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_tesoreria_proveedor']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> - facturacom</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $numfacom = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['numfacom']; 
          $numfacom_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['numfacom_cond']; 
          $formapago = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['formapago']; 
          $formapago_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['formapago_cond']; 
          $fechacom_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_dia']; 
          $fechacom_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_mes']; 
          $fechacom_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_ano']; 
          $fechacom_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_input_2_dia']; 
          $fechacom_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_input_2_mes']; 
          $fechacom_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_input_2_ano']; 
          $fechacom_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_cond']; 
          $pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['pagada']; 
          $pagada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['pagada_cond']; 
          $saldo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['saldo']; 
          $saldo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['saldo_input_2']; 
          $saldo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['saldo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['NM_operador']; 
      } 
  ...
  <TD width="100%" height="">
   ...
   <tr>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_numfacom_cond" name="numfacom_cond" onChange="nm_campos_between(document.getElementById('id_vis_numfacom'), this, 'numfacom')">
...
<?php
      ...
      $numfacom_look = substr($this->Db->qstr($numfacom), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numfacom from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and numfacom = '$numfacom_look' order by numfacom"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<?php
      ...
      $formapago_look = substr($this->Db->qstr($formapago), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct formapago from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and formapago = '$formapago_look' order by formapago"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-formapago" id="id_ac_formapago" name="formapago_autocomp"><?php if ('' !=  $formapago) { ?><option value="<?php echo $formapago ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fechacom_cond" name="fechacom_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechacom'), this, 'fechacom')">
...
?>
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_pagada_cond" name="pagada_cond" onChange="nm_campos_between(document.getElementById('id_vis_pagada'), this, 'pagada')">
...
<?php
      ...
      $pagada_look = substr($this->Db->qstr($pagada), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pagada from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and pagada = '$pagada_look' order by pagada"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and saldo = $saldo_look order by saldo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and idprov=" . $_SESSION['par_prov'] . " and saldo = $saldo_look order by saldo"; 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-saldo" id="id_ac_saldo" name="saldo_autocomp"><?php if ('' !=  $saldo) { ?><option value="<?php echo $saldo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
...
?>
<?php
   if (is_file("grid_tesoreria_proveedor_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_tesoreria_proveedor']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_tesoreria_proveedor']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fechacom_dia').bind('change', function() {sc_grid_tesoreria_proveedor_valida_dia(this)});
    $('#SC_fechacom_input_2_dia').bind('change', function() {sc_grid_tesoreria_proveedor_valida_dia(this)});
    $('#SC_fechacom_input_2_mes').bind('change', function() {sc_grid_tesoreria_proveedor_valida_mes(this)});
    $('#SC_fechacom_mes').bind('change', function() {sc_grid_tesoreria_proveedor_valida_mes(this)});
 }
 function sc_grid_tesoreria_proveedor_valida_dia(obj)
 {
 ...
 function sc_grid_tesoreria_proveedor_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_tesoreria_proveedor";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_tesoreria_proveedor/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['numfacom'] = $numfacom; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['numfacom_cond'] = $numfacom_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['formapago'] = $formapago; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['formapago_cond'] = $formapago_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_dia'] = $fechacom_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_mes'] = $fechacom_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_ano'] = $fechacom_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_input_2_dia'] = $fechacom_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_input_2_mes'] = $fechacom_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_input_2_ano'] = $fechacom_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_cond'] = $fechacom_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['pagada'] = $pagada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['pagada_cond'] = $pagada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['saldo'] = $saldo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['saldo_input_2'] = $saldo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['saldo_cond'] = $saldo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if ($fechacom_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom'] = $val[0];
          ...
          if ($fechacom_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']['fechacom_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_tesoreria_proveedor']['cond_pesq'] .= $this->NM_operador;
