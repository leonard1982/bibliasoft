...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_tesoreria_proveedor"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_tesoreria_proveedor"]);
   }
