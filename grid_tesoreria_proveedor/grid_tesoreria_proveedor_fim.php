...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_tesoreria_proveedor"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_tesoreria_proveedor"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tesoreria_proveedor']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tesoreria_proveedor']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tesoreria_proveedor']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tesoreria_proveedor']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tesoreria_proveedor']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tesoreria_proveedor</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tesoreria_proveedor']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tesoreria_proveedor']['embutida_filho'] as $ind => $sc_init)
          {
