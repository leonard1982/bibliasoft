...
<?php
   ...
   $Ord_Cmp = new grid_tesoreria_proveedor_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tesoreria_proveedor_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numfacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["numfacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["numfacom"] : "Número Compra";
   $tab_ger_campos['formapago'] = "on";
   $tab_def_campos['formapago'] = "formapago";
   $tab_labels["formapago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["formapago"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["formapago"] : "Forma de pago";
   $tab_ger_campos['fechacom'] = "on";
   $tab_def_campos['fechacom'] = "fechacom";
   $tab_labels["fechacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["fechacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["fechacom"] : "Fecha compra";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["fechavenc"] : "Fecha vencimiento";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["total"] : "Total";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["saldo"] : "Saldo";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tesoreria_proveedor_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tesoreria_proveedor']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
