<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tesoreria_proveedor']['sc_process_barr'] = true;
require_once('../grid_tesoreria_proveedor/index.php');
unset($_SESSION['scriptcase']['grid_tesoreria_proveedor']['sc_process_barr']);
$ExportCtrl = new grid_tesoreria_proveedor_export_control;
$ExportCtrl->Export_barr();

class grid_tesoreria_proveedor_export_control
{
