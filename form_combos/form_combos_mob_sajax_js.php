  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_combos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate codigobar
  function do_ajax_form_combos_mob_validate_codigobar()
  {
    var nomeCampo_codigobar = "codigobar";
    var var_codigobar = scAjaxGetFieldText(nomeCampo_codigobar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_mob_validate_codigobar(var_codigobar, var_script_case_init, do_ajax_form_combos_mob_validate_codigobar_cb);
  } // do_ajax_form_combos_mob_validate_codigobar

  function do_ajax_form_combos_mob_validate_codigobar_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_mob_validate_codigobar_cb

  // ---------- Validate nompro
  function do_ajax_form_combos_mob_validate_nompro()
  {
    var nomeCampo_nompro = "nompro";
    var var_nompro = scAjaxGetFieldText(nomeCampo_nompro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_mob_validate_nompro(var_nompro, var_script_case_init, do_ajax_form_combos_mob_validate_nompro_cb);
  } // do_ajax_form_combos_mob_validate_nompro

  function do_ajax_form_combos_mob_validate_nompro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nompro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_mob_validate_nompro_cb

  // ---------- Validate preciomen
  function do_ajax_form_combos_mob_validate_preciomen()
  {
    var nomeCampo_preciomen = "preciomen";
    var var_preciomen = scAjaxGetFieldHidden(nomeCampo_preciomen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_mob_validate_preciomen(var_preciomen, var_script_case_init, do_ajax_form_combos_mob_validate_preciomen_cb);
  } // do_ajax_form_combos_mob_validate_preciomen

  function do_ajax_form_combos_mob_validate_preciomen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_mob_validate_preciomen_cb

  // ---------- Validate escombo
  function do_ajax_form_combos_mob_validate_escombo()
  {
    var nomeCampo_escombo = "escombo";
    var var_escombo = scAjaxGetFieldCheckbox(nomeCampo_escombo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_mob_validate_escombo(var_escombo, var_script_case_init, do_ajax_form_combos_mob_validate_escombo_cb);
  } // do_ajax_form_combos_mob_validate_escombo

  function do_ajax_form_combos_mob_validate_escombo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "escombo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_mob_validate_escombo_cb

  // ---------- Validate maneja_tcs_lfs
  function do_ajax_form_combos_mob_validate_maneja_tcs_lfs()
  {
    var nomeCampo_maneja_tcs_lfs = "maneja_tcs_lfs";
    var var_maneja_tcs_lfs = scAjaxGetFieldText(nomeCampo_maneja_tcs_lfs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_mob_validate_maneja_tcs_lfs(var_maneja_tcs_lfs, var_script_case_init, do_ajax_form_combos_mob_validate_maneja_tcs_lfs_cb);
  } // do_ajax_form_combos_mob_validate_maneja_tcs_lfs

  function do_ajax_form_combos_mob_validate_maneja_tcs_lfs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_mob_validate_maneja_tcs_lfs_cb

  // ---------- Validate detalle
  function do_ajax_form_combos_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_combos_mob_validate_detalle_cb);
  } // do_ajax_form_combos_mob_validate_detalle

  function do_ajax_form_combos_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_mob_validate_detalle_cb

  // ---------- Validate idprod
  function do_ajax_form_combos_mob_validate_idprod()
  {
    var nomeCampo_idprod = "idprod";
    var var_idprod = scAjaxGetFieldHidden(nomeCampo_idprod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_mob_validate_idprod(var_idprod, var_script_case_init, do_ajax_form_combos_mob_validate_idprod_cb);
  } // do_ajax_form_combos_mob_validate_idprod

  function do_ajax_form_combos_mob_validate_idprod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idprod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_mob_validate_idprod_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_combos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_combos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_combos_mob_submit_form(var_codigobar, var_nompro, var_preciomen, var_escombo, var_maneja_tcs_lfs, var_idprod, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_combos_mob_submit_form_cb);
  } // do_ajax_form_combos_mob_submit_form

  function do_ajax_form_combos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("escombo");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_combos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_combos_mob_submit_form_cb
  function do_ajax_form_combos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_combos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detallecombos_mob"] = "off";

  function do_ajax_form_combos_mob_navigate_form()
  {
    perform_ajax_form_combos_mob_navigate_form();
  }

  function perform_ajax_form_combos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_detallecombos_mob"] = "on";
    x_ajax_form_combos_mob_navigate_form(var_idprod, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_combos_mob_navigate_form_cb);
  } // do_ajax_form_combos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_combos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_combos_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detallecombos_mob"] && "nmsc_iframe_liga_form_detallecombos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_detallecombos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detallecombos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detallecombos_mob').contentWindow.nm_move('apl_detalhe', true, '300');
        document.getElementById('nmsc_iframe_liga_form_detallecombos_mob').style.height = "300";
        document.getElementById('nmsc_iframe_liga_form_detallecombos_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_combos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_combos_mob_navigate_form_cb
  function do_ajax_form_combos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_combos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_combos_mob_navigate_form_cb_after_alert
  function sc_hide_form_combos_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detallecombos_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "nompro";
  ajax_field_list[2] = "preciomen";
  ajax_field_list[3] = "escombo";
  ajax_field_list[4] = "maneja_tcs_lfs";
  ajax_field_list[5] = "detalle";
  ajax_field_list[6] = "idprod";
  ...
  var ajax_error_list = {
    "codigobar": {"label": "Codigo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "preciomen": {"label": "Precio Venta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "escombo": {"label": "Es combo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["escombo"][1] = "escombo";
  ...
  var ajax_field_id = {
    ...
    "escombo": new Array("hidden_field_label_escombo", "hidden_field_data_escombo"),
