  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_combos" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_combos_validate_codigobar_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_validate_codigobar_cb
  ...
  function do_ajax_form_combos_validate_nompro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nompro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_validate_nompro_cb

  // ---------- Validate preciomen
  function do_ajax_form_combos_validate_preciomen()
  {
    var nomeCampo_preciomen = "preciomen";
    var var_preciomen = scAjaxGetFieldHidden(nomeCampo_preciomen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_validate_preciomen(var_preciomen, var_script_case_init, do_ajax_form_combos_validate_preciomen_cb);
  } // do_ajax_form_combos_validate_preciomen

  function do_ajax_form_combos_validate_preciomen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_validate_preciomen_cb

  // ---------- Validate escombo
  function do_ajax_form_combos_validate_escombo()
  {
    var nomeCampo_escombo = "escombo";
    var var_escombo = scAjaxGetFieldCheckbox(nomeCampo_escombo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_validate_escombo(var_escombo, var_script_case_init, do_ajax_form_combos_validate_escombo_cb);
  } // do_ajax_form_combos_validate_escombo

  function do_ajax_form_combos_validate_escombo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "escombo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_validate_escombo_cb

  // ---------- Validate maneja_tcs_lfs
  function do_ajax_form_combos_validate_maneja_tcs_lfs()
  {
    var nomeCampo_maneja_tcs_lfs = "maneja_tcs_lfs";
    var var_maneja_tcs_lfs = scAjaxGetFieldText(nomeCampo_maneja_tcs_lfs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_validate_maneja_tcs_lfs(var_maneja_tcs_lfs, var_script_case_init, do_ajax_form_combos_validate_maneja_tcs_lfs_cb);
  } // do_ajax_form_combos_validate_maneja_tcs_lfs

  function do_ajax_form_combos_validate_maneja_tcs_lfs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_validate_maneja_tcs_lfs_cb

  // ---------- Validate detalle
  function do_ajax_form_combos_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_combos_validate_detalle_cb);
  } // do_ajax_form_combos_validate_detalle

  function do_ajax_form_combos_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_validate_detalle_cb

  // ---------- Validate idprod
  function do_ajax_form_combos_validate_idprod()
  {
    var nomeCampo_idprod = "idprod";
    var var_idprod = scAjaxGetFieldHidden(nomeCampo_idprod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_combos_validate_idprod(var_idprod, var_script_case_init, do_ajax_form_combos_validate_idprod_cb);
  } // do_ajax_form_combos_validate_idprod

  function do_ajax_form_combos_validate_idprod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idprod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_combos_validate_idprod_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_combos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_combos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_combos_submit_form(var_codigobar, var_nompro, var_preciomen, var_escombo, var_maneja_tcs_lfs, var_idprod, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_combos_submit_form_cb);
  } // do_ajax_form_combos_submit_form

  function do_ajax_form_combos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_combos_submit_form_cb_after_alert);
  } // do_ajax_form_combos_submit_form_cb
  function do_ajax_form_combos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_combos_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detallecombos"] = "off";

  function do_ajax_form_combos_navigate_form()
  {
    perform_ajax_form_combos_navigate_form();
  }

  function perform_ajax_form_combos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_detallecombos"] = "on";
    x_ajax_form_combos_navigate_form(var_idprod, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_combos_navigate_form_cb);
  } // do_ajax_form_combos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_combos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_combos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detallecombos"] && "nmsc_iframe_liga_form_detallecombos" != scMasterDetailIframe["nmsc_iframe_liga_form_detallecombos"]) {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_combos_navigate_form_cb_after_alert);
  } // do_ajax_form_combos_navigate_form_cb
  function do_ajax_form_combos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_combos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_combos_navigate_form_cb_after_alert
  function sc_hide_form_combos_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detallecombos"])
    {
      return true;
    }
    return false;
