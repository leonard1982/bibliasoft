  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recibos_ing_caja" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_recibos_ing_caja_form();
	}
  ...
  // ---------- Validate id_recibo
  function do_ajax_form_recibos_ing_caja_validate_id_recibo()
  {
    var nomeCampo_id_recibo = "id_recibo";
    var var_id_recibo = scAjaxGetFieldHidden(nomeCampo_id_recibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_id_recibo(var_id_recibo, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_id_recibo_cb);
  } // do_ajax_form_recibos_ing_caja_validate_id_recibo

  function do_ajax_form_recibos_ing_caja_validate_id_recibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_recibo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_id_recibo_cb

  // ---------- Validate numero_rc
  function do_ajax_form_recibos_ing_caja_validate_numero_rc()
  {
    var nomeCampo_numero_rc = "numero_rc";
    var var_numero_rc = scAjaxGetFieldHidden(nomeCampo_numero_rc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_numero_rc(var_numero_rc, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_numero_rc_cb);
  } // do_ajax_form_recibos_ing_caja_validate_numero_rc

  function do_ajax_form_recibos_ing_caja_validate_numero_rc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero_rc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_numero_rc_cb

  // ---------- Validate fecha_rc
  function do_ajax_form_recibos_ing_caja_validate_fecha_rc()
  {
    var nomeCampo_fecha_rc = "fecha_rc";
    var var_fecha_rc = scAjaxGetFieldText(nomeCampo_fecha_rc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_fecha_rc(var_fecha_rc, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_fecha_rc_cb);
  } // do_ajax_form_recibos_ing_caja_validate_fecha_rc

  function do_ajax_form_recibos_ing_caja_validate_fecha_rc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_rc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_fecha_rc_cb

  // ---------- Validate contrato
  function do_ajax_form_recibos_ing_caja_validate_contrato()
  {
    var nomeCampo_contrato = "contrato";
    var var_contrato = scAjaxGetFieldText(nomeCampo_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_contrato(var_contrato, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_contrato_cb);
  } // do_ajax_form_recibos_ing_caja_validate_contrato

  function do_ajax_form_recibos_ing_caja_validate_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_contrato_cb

  // ---------- Validate tercero
  function do_ajax_form_recibos_ing_caja_validate_tercero()
  {
  } // do_ajax_form_recibos_ing_caja_validate_tercero

  function do_ajax_form_recibos_ing_caja_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_tercero_cb

  // ---------- Validate monto_rc
  function do_ajax_form_recibos_ing_caja_validate_monto_rc()
  {
    var nomeCampo_monto_rc = "monto_rc";
    var var_monto_rc = scAjaxGetFieldHidden(nomeCampo_monto_rc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_monto_rc(var_monto_rc, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_monto_rc_cb);
  } // do_ajax_form_recibos_ing_caja_validate_monto_rc

  function do_ajax_form_recibos_ing_caja_validate_monto_rc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "monto_rc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_monto_rc_cb

  // ---------- Validate id_banco
  function do_ajax_form_recibos_ing_caja_validate_id_banco()
  {
    var nomeCampo_id_banco = "id_banco";
    var var_id_banco = scAjaxGetFieldSelect(nomeCampo_id_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_id_banco(var_id_banco, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_id_banco_cb);
  } // do_ajax_form_recibos_ing_caja_validate_id_banco

  function do_ajax_form_recibos_ing_caja_validate_id_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_banco";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_id_banco_cb

  // ---------- Validate asentado
  function do_ajax_form_recibos_ing_caja_validate_asentado()
  {
    var nomeCampo_asentado = "asentado";
    var var_asentado = scAjaxGetFieldSelect(nomeCampo_asentado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_asentado(var_asentado, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_asentado_cb);
  } // do_ajax_form_recibos_ing_caja_validate_asentado

  function do_ajax_form_recibos_ing_caja_validate_asentado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_asentado_cb

  // ---------- Validate observacion
  function do_ajax_form_recibos_ing_caja_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_observacion_cb);
  } // do_ajax_form_recibos_ing_caja_validate_observacion

  function do_ajax_form_recibos_ing_caja_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_observacion_cb

  // ---------- Validate creado
  function do_ajax_form_recibos_ing_caja_validate_creado()
  {
    var nomeCampo_creado = "creado";
    var var_creado = scAjaxGetFieldText(nomeCampo_creado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_creado(var_creado, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_creado_cb);
  } // do_ajax_form_recibos_ing_caja_validate_creado

  function do_ajax_form_recibos_ing_caja_validate_creado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_creado_cb

  // ---------- Validate editado
  function do_ajax_form_recibos_ing_caja_validate_editado()
  {
    var nomeCampo_editado = "editado";
    var var_editado = scAjaxGetFieldText(nomeCampo_editado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_editado(var_editado, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_editado_cb);
  } // do_ajax_form_recibos_ing_caja_validate_editado

  function do_ajax_form_recibos_ing_caja_validate_editado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "editado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_editado_cb

  // ---------- Validate detalle1
  function do_ajax_form_recibos_ing_caja_validate_detalle1()
  {
    var nomeCampo_detalle1 = "detalle1";
    var var_detalle1 = scAjaxGetFieldText(nomeCampo_detalle1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_validate_detalle1(var_detalle1, var_script_case_init, do_ajax_form_recibos_ing_caja_validate_detalle1_cb);
  } // do_ajax_form_recibos_ing_caja_validate_detalle1

  function do_ajax_form_recibos_ing_caja_validate_detalle1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle1";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_validate_detalle1_cb

  // ---------- Event onchange asentado
  function do_ajax_form_recibos_ing_caja_event_asentado_onchange()
  {
    var var_asentado = scAjaxGetFieldSelect("asentado");
    var var_monto_rc = scAjaxGetFieldHidden("monto_rc");
    var var_id_recibo = scAjaxGetFieldHidden("id_recibo");
    var var_contrato = scAjaxGetFieldText("contrato");
    var var_fecha_rc = scAjaxGetFieldText("fecha_rc");
    var var_tercero = scAjaxGetFieldText("id_ac_tercero");
    var var_id_banco = scAjaxGetFieldSelect("id_banco");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_ing_caja_event_asentado_onchange(var_asentado, var_monto_rc, var_id_recibo, var_contrato, var_fecha_rc, var_tercero, var_id_banco, var_script_case_init, do_ajax_form_recibos_ing_caja_event_asentado_onchange_cb);
  } // do_ajax_form_recibos_ing_caja_event_asentado_onchange

  function do_ajax_form_recibos_ing_caja_event_asentado_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "asentado";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_ing_caja_event_asentado_onchange_cb_after_alert);
  } // do_ajax_form_recibos_ing_caja_event_asentado_onchange_cb
  function do_ajax_form_recibos_ing_caja_event_asentado_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_ing_caja_event_asentado_onchange_cb_after_alert

  // ---------- Event onchange contrato
  function do_ajax_form_recibos_ing_caja_event_contrato_onchange()
  {
    var var_contrato = scAjaxGetFieldText("contrato");
    var var_tercero = scAjaxGetFieldText("id_ac_tercero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_ing_caja_event_contrato_onchange(var_contrato, var_tercero, var_script_case_init, do_ajax_form_recibos_ing_caja_event_contrato_onchange_cb);
  } // do_ajax_form_recibos_ing_caja_event_contrato_onchange

  function do_ajax_form_recibos_ing_caja_event_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_ing_caja_event_contrato_onchange_cb_after_alert);
  } // do_ajax_form_recibos_ing_caja_event_contrato_onchange_cb
  function do_ajax_form_recibos_ing_caja_event_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_ing_caja_event_contrato_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recibos_ing_caja_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recibos_ing_caja_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_recibo = scAjaxGetFieldHidden("id_recibo");
    var var_numero_rc = scAjaxGetFieldHidden("numero_rc");
    var var_fecha_rc = scAjaxGetFieldText("fecha_rc");
    var var_contrato = scAjaxGetFieldText("contrato");
    ...
    var var_id_banco = scAjaxGetFieldSelect("id_banco");
    var var_asentado = scAjaxGetFieldSelect("asentado");
    var var_observacion = scAjaxGetFieldText("observacion");
    ...
    scAjaxProcOn();
    x_ajax_form_recibos_ing_caja_submit_form(var_id_recibo, var_numero_rc, var_fecha_rc, var_contrato, var_tercero, var_monto_rc, var_id_banco, var_asentado, var_observacion, var_creado, var_editado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recibos_ing_caja_submit_form_cb);
  } // do_ajax_form_recibos_ing_caja_submit_form

  function do_ajax_form_recibos_ing_caja_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_recibo");
      scAjaxHideErrorDisplay("numero_rc");
      scAjaxHideErrorDisplay("fecha_rc");
      scAjaxHideErrorDisplay("contrato");
      scAjaxHideErrorDisplay("tercero");
      scAjaxHideErrorDisplay("monto_rc");
      scAjaxHideErrorDisplay("id_banco");
      scAjaxHideErrorDisplay("asentado");
      scAjaxHideErrorDisplay("observacion");
      scAjaxHideErrorDisplay("creado");
      scAjaxHideErrorDisplay("editado");
      scAjaxHideErrorDisplay("detalle1");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recibos_ing_caja_submit_form_cb_after_alert);
  } // do_ajax_form_recibos_ing_caja_submit_form_cb
  function do_ajax_form_recibos_ing_caja_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_ing_caja_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_recibos_ingcaja_detalle"] = "off";

  function do_ajax_form_recibos_ing_caja_navigate_form()
  {
    perform_ajax_form_recibos_ing_caja_navigate_form();
  }

  function perform_ajax_form_recibos_ing_caja_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("editado");
    scAjaxHideErrorDisplay("detalle1");
    var var_id_recibo = document.F2.id_recibo.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_recibos_ingcaja_detalle"] = "on";
    x_ajax_form_recibos_ing_caja_navigate_form(var_id_recibo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_ing_caja_navigate_form_cb);
  } // do_ajax_form_recibos_ing_caja_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_ing_caja']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recibos_ing_caja_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_recibo.value = scAjaxGetKeyValue("id_recibo");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_recibos_ingcaja_detalle"] && "nmsc_iframe_liga_form_recibos_ingcaja_detalle" != scMasterDetailIframe["nmsc_iframe_liga_form_recibos_ingcaja_detalle"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_recibos_ingcaja_detalle"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_recibos_ingcaja_detalle').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_recibos_ingcaja_detalle').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_recibos_ingcaja_detalle').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recibos_ing_caja_navigate_form_cb_after_alert);
  } // do_ajax_form_recibos_ing_caja_navigate_form_cb
  function do_ajax_form_recibos_ing_caja_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_recibos_ing_caja_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_recibos_ing_caja_navigate_form_cb_after_alert
  function sc_hide_form_recibos_ing_caja_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_recibos_ingcaja_detalle"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_recibo";
  ajax_field_list[1] = "numero_rc";
  ajax_field_list[2] = "fecha_rc";
  ajax_field_list[3] = "contrato";
  ajax_field_list[4] = "tercero";
  ajax_field_list[5] = "monto_rc";
  ajax_field_list[6] = "id_banco";
  ajax_field_list[7] = "asentado";
  ajax_field_list[8] = "observacion";
  ajax_field_list[9] = "creado";
  ajax_field_list[10] = "editado";
  ajax_field_list[11] = "detalle1";
  ...
  var ajax_error_list = {
    "id_recibo": {"label": "Id Recibo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numero_rc": {"label": "Numero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_rc": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "monto_rc": {"label": "Monto Rc", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_banco": {"label": "Caja N°", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "observacion": {"label": "Observaciones:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "detalle1": {"label": "detalle1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "id_banco": new Array(),
    "asentado": new Array(),
    "observacion": new Array(),
    "creado": new Array(),
    "editado": new Array(),
    "detalle1": new Array()
  };
  ajax_field_mult["id_recibo"][1] = "id_recibo";
  ajax_field_mult["numero_rc"][1] = "numero_rc";
  ajax_field_mult["fecha_rc"][1] = "fecha_rc";
  ajax_field_mult["contrato"][1] = "contrato";
  ajax_field_mult["tercero"][1] = "tercero";
  ajax_field_mult["monto_rc"][1] = "monto_rc";
  ajax_field_mult["id_banco"][1] = "id_banco";
  ajax_field_mult["asentado"][1] = "asentado";
  ajax_field_mult["observacion"][1] = "observacion";
  ajax_field_mult["creado"][1] = "creado";
  ajax_field_mult["editado"][1] = "editado";
  ajax_field_mult["detalle1"][1] = "detalle1";

  var ajax_field_id = {
    "numero_rc": new Array("hidden_field_label_numero_rc", "hidden_field_data_numero_rc"),
    "fecha_rc": new Array("hidden_field_label_fecha_rc", "hidden_field_data_fecha_rc"),
    ...
    "monto_rc": new Array("hidden_field_label_monto_rc", "hidden_field_data_monto_rc"),
    "id_banco": new Array("hidden_field_label_id_banco", "hidden_field_data_id_banco"),
    "asentado": new Array("hidden_field_label_asentado", "hidden_field_data_asentado"),
    "observacion": new Array("hidden_field_label_observacion", "hidden_field_data_observacion"),
    "detalle1": new Array("hidden_field_label_detalle1", "hidden_field_data_detalle1")
  };
