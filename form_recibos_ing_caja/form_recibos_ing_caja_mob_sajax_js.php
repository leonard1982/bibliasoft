  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recibos_ing_caja_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_recibos_ing_caja_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_recibo
  function do_ajax_form_recibos_ing_caja_mob_validate_id_recibo()
  {
    var nomeCampo_id_recibo = "id_recibo";
    var var_id_recibo = scAjaxGetFieldHidden(nomeCampo_id_recibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_id_recibo(var_id_recibo, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_id_recibo_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_id_recibo

  function do_ajax_form_recibos_ing_caja_mob_validate_id_recibo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_id_recibo_cb

  // ---------- Validate numero_rc
  function do_ajax_form_recibos_ing_caja_mob_validate_numero_rc()
  {
    var nomeCampo_numero_rc = "numero_rc";
    var var_numero_rc = scAjaxGetFieldHidden(nomeCampo_numero_rc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_numero_rc(var_numero_rc, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_numero_rc_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_numero_rc

  function do_ajax_form_recibos_ing_caja_mob_validate_numero_rc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_numero_rc_cb

  // ---------- Validate fecha_rc
  function do_ajax_form_recibos_ing_caja_mob_validate_fecha_rc()
  {
    var nomeCampo_fecha_rc = "fecha_rc";
    var var_fecha_rc = scAjaxGetFieldText(nomeCampo_fecha_rc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_fecha_rc(var_fecha_rc, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_fecha_rc_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_fecha_rc

  function do_ajax_form_recibos_ing_caja_mob_validate_fecha_rc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_fecha_rc_cb

  // ---------- Validate contrato
  function do_ajax_form_recibos_ing_caja_mob_validate_contrato()
  {
    var nomeCampo_contrato = "contrato";
    var var_contrato = scAjaxGetFieldText(nomeCampo_contrato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_contrato(var_contrato, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_contrato_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_contrato

  function do_ajax_form_recibos_ing_caja_mob_validate_contrato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_contrato_cb

  // ---------- Validate tercero
  function do_ajax_form_recibos_ing_caja_mob_validate_tercero()
  {
  } // do_ajax_form_recibos_ing_caja_mob_validate_tercero

  function do_ajax_form_recibos_ing_caja_mob_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_tercero_cb

  // ---------- Validate monto_rc
  function do_ajax_form_recibos_ing_caja_mob_validate_monto_rc()
  {
    var nomeCampo_monto_rc = "monto_rc";
    var var_monto_rc = scAjaxGetFieldHidden(nomeCampo_monto_rc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_monto_rc(var_monto_rc, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_monto_rc_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_monto_rc

  function do_ajax_form_recibos_ing_caja_mob_validate_monto_rc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_monto_rc_cb

  // ---------- Validate id_banco
  function do_ajax_form_recibos_ing_caja_mob_validate_id_banco()
  {
    var nomeCampo_id_banco = "id_banco";
    var var_id_banco = scAjaxGetFieldSelect(nomeCampo_id_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_id_banco(var_id_banco, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_id_banco_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_id_banco

  function do_ajax_form_recibos_ing_caja_mob_validate_id_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_id_banco_cb

  // ---------- Validate asentado
  function do_ajax_form_recibos_ing_caja_mob_validate_asentado()
  {
    var nomeCampo_asentado = "asentado";
    var var_asentado = scAjaxGetFieldSelect(nomeCampo_asentado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_asentado(var_asentado, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_asentado_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_asentado

  function do_ajax_form_recibos_ing_caja_mob_validate_asentado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_asentado_cb

  // ---------- Validate observacion
  function do_ajax_form_recibos_ing_caja_mob_validate_observacion()
  {
    var nomeCampo_observacion = "observacion";
    var var_observacion = scAjaxGetFieldText(nomeCampo_observacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_observacion(var_observacion, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_observacion_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_observacion

  function do_ajax_form_recibos_ing_caja_mob_validate_observacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_observacion_cb

  // ---------- Validate creado
  function do_ajax_form_recibos_ing_caja_mob_validate_creado()
  {
    var nomeCampo_creado = "creado";
    var var_creado = scAjaxGetFieldText(nomeCampo_creado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_creado(var_creado, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_creado_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_creado

  function do_ajax_form_recibos_ing_caja_mob_validate_creado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_creado_cb

  // ---------- Validate editado
  function do_ajax_form_recibos_ing_caja_mob_validate_editado()
  {
    var nomeCampo_editado = "editado";
    var var_editado = scAjaxGetFieldText(nomeCampo_editado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_editado(var_editado, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_editado_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_editado

  function do_ajax_form_recibos_ing_caja_mob_validate_editado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "editado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_editado_cb

  // ---------- Validate detalle1
  function do_ajax_form_recibos_ing_caja_mob_validate_detalle1()
  {
    var nomeCampo_detalle1 = "detalle1";
    var var_detalle1 = scAjaxGetFieldText(nomeCampo_detalle1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_ing_caja_mob_validate_detalle1(var_detalle1, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_validate_detalle1_cb);
  } // do_ajax_form_recibos_ing_caja_mob_validate_detalle1

  function do_ajax_form_recibos_ing_caja_mob_validate_detalle1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_ing_caja_mob_validate_detalle1_cb

  // ---------- Event onchange asentado
  function do_ajax_form_recibos_ing_caja_mob_event_asentado_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_recibos_ing_caja_mob_event_asentado_onchange(var_asentado, var_monto_rc, var_id_recibo, var_contrato, var_fecha_rc, var_tercero, var_id_banco, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_event_asentado_onchange_cb);
  } // do_ajax_form_recibos_ing_caja_mob_event_asentado_onchange

  function do_ajax_form_recibos_ing_caja_mob_event_asentado_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "asentado";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_ing_caja_mob_event_asentado_onchange_cb_after_alert);
  } // do_ajax_form_recibos_ing_caja_mob_event_asentado_onchange_cb
  function do_ajax_form_recibos_ing_caja_mob_event_asentado_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_ing_caja_mob_event_asentado_onchange_cb_after_alert

  // ---------- Event onchange contrato
  function do_ajax_form_recibos_ing_caja_mob_event_contrato_onchange()
  {
    var var_contrato = scAjaxGetFieldText("contrato");
    var var_tercero = scAjaxGetFieldText("id_ac_tercero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_ing_caja_mob_event_contrato_onchange(var_contrato, var_tercero, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_event_contrato_onchange_cb);
  } // do_ajax_form_recibos_ing_caja_mob_event_contrato_onchange

  function do_ajax_form_recibos_ing_caja_mob_event_contrato_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "contrato";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_ing_caja_mob_event_contrato_onchange_cb_after_alert);
  } // do_ajax_form_recibos_ing_caja_mob_event_contrato_onchange_cb
  function do_ajax_form_recibos_ing_caja_mob_event_contrato_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_ing_caja_mob_event_contrato_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recibos_ing_caja_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recibos_ing_caja_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_recibo = scAjaxGetFieldHidden("id_recibo");
    ...
    scAjaxProcOn();
    x_ajax_form_recibos_ing_caja_mob_submit_form(var_id_recibo, var_numero_rc, var_fecha_rc, var_contrato, var_tercero, var_monto_rc, var_id_banco, var_asentado, var_observacion, var_creado, var_editado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recibos_ing_caja_mob_submit_form_cb);
  } // do_ajax_form_recibos_ing_caja_mob_submit_form

  function do_ajax_form_recibos_ing_caja_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recibos_ing_caja_mob_submit_form_cb_after_alert);
  } // do_ajax_form_recibos_ing_caja_mob_submit_form_cb
  function do_ajax_form_recibos_ing_caja_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_ing_caja_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_recibos_ingcaja_detalle_mob"] = "off";

  function do_ajax_form_recibos_ing_caja_mob_navigate_form()
  {
    perform_ajax_form_recibos_ing_caja_mob_navigate_form();
  }

  function perform_ajax_form_recibos_ing_caja_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_recibos_ingcaja_detalle_mob"] = "on";
    x_ajax_form_recibos_ing_caja_mob_navigate_form(var_id_recibo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_ing_caja_mob_navigate_form_cb);
  } // do_ajax_form_recibos_ing_caja_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_ing_caja_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recibos_ing_caja_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_recibos_ingcaja_detalle_mob"] && "nmsc_iframe_liga_form_recibos_ingcaja_detalle_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_recibos_ingcaja_detalle_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_recibos_ingcaja_detalle_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_recibos_ingcaja_detalle_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_recibos_ingcaja_detalle_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_recibos_ingcaja_detalle_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recibos_ing_caja_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_recibos_ing_caja_mob_navigate_form_cb
  function do_ajax_form_recibos_ing_caja_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_recibos_ing_caja_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_recibos_ing_caja_mob_navigate_form_cb_after_alert
  function sc_hide_form_recibos_ing_caja_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_recibos_ingcaja_detalle_mob"])
    {
      return true;
    }
    return false;
