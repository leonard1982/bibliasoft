...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_inventario_inical"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_inventario_inical"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_inical']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_inical']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_inical']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_inical']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inventario_inical']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_inventario_inical</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_inical']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inventario_inical']['embutida_filho'] as $ind => $sc_init)
          {
