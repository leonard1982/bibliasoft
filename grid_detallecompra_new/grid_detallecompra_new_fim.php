...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallecompra_new"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallecompra_new"]);
   }
