...
<?php
   ...
   $Ord_Cmp = new grid_detallecompra_new_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallecompra_new_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["idpro"] : "Producto";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["valorunit"] : "Costo unidad";
   $tab_ger_campos['porc_desc'] = "on";
   $tab_def_campos['porc_desc'] = "porc_desc";
   $tab_labels["porc_desc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["porc_desc"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["porc_desc"] : "% Desc. Un.";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["descuento"] : "Desc. x U.";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["valorpar"] : "Subtotal";
   $tab_ger_campos['tasaiva'] = "on";
   $tab_def_campos['tasaiva'] = "tasaiva";
   $tab_labels["tasaiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["tasaiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["tasaiva"] : "Tasa IVA";
   $tab_ger_campos['iva'] = "on";
   $tab_def_campos['iva'] = "iva";
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["iva"] : "IVA";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['labels']["total"] : "Total";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallecompra_new_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallecompra_new']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
