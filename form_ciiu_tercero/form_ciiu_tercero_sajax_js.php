  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ciiu_tercero" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ciiu_tercero_form();
	}
  ...
  function do_ajax_form_ciiu_tercero_validate_id_ciiu_ter()
  {
    var nomeCampo_id_ciiu_ter = "id_ciiu_ter";
    var var_id_ciiu_ter = scAjaxGetFieldHidden(nomeCampo_id_ciiu_ter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciiu_tercero_validate_id_ciiu_ter(var_id_ciiu_ter, var_script_case_init, do_ajax_form_ciiu_tercero_validate_id_ciiu_ter_cb);
  } // do_ajax_form_ciiu_tercero_validate_id_ciiu_ter

  function do_ajax_form_ciiu_tercero_validate_id_ciiu_ter_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciiu_tercero_validate_id_ciiu_ter_cb

  // ---------- Validate id_tercero
  function do_ajax_form_ciiu_tercero_validate_id_tercero()
  {
    var nomeCampo_id_tercero = "id_tercero";
    var var_id_tercero = scAjaxGetFieldText(nomeCampo_id_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciiu_tercero_validate_id_tercero(var_id_tercero, var_script_case_init, do_ajax_form_ciiu_tercero_validate_id_tercero_cb);
  } // do_ajax_form_ciiu_tercero_validate_id_tercero

  function do_ajax_form_ciiu_tercero_validate_id_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciiu_tercero_validate_id_tercero_cb

  // ---------- Validate codigo_ciiu
  function do_ajax_form_ciiu_tercero_validate_codigo_ciiu()
  {
    var nomeCampo_codigo_ciiu = "codigo_ciiu";
    var var_codigo_ciiu = scAjaxGetFieldSelect(nomeCampo_codigo_ciiu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciiu_tercero_validate_codigo_ciiu(var_codigo_ciiu, var_script_case_init, do_ajax_form_ciiu_tercero_validate_codigo_ciiu_cb);
  } // do_ajax_form_ciiu_tercero_validate_codigo_ciiu

  function do_ajax_form_ciiu_tercero_validate_codigo_ciiu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciiu_tercero_validate_codigo_ciiu_cb

  // ---------- Validate descripcion_ciiu
  function do_ajax_form_ciiu_tercero_validate_descripcion_ciiu()
  {
    var nomeCampo_descripcion_ciiu = "descripcion_ciiu";
    var var_descripcion_ciiu = scAjaxGetFieldText(nomeCampo_descripcion_ciiu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciiu_tercero_validate_descripcion_ciiu(var_descripcion_ciiu, var_script_case_init, do_ajax_form_ciiu_tercero_validate_descripcion_ciiu_cb);
  } // do_ajax_form_ciiu_tercero_validate_descripcion_ciiu

  function do_ajax_form_ciiu_tercero_validate_descripcion_ciiu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciiu_tercero_validate_descripcion_ciiu_cb

  // ---------- Event onchange codigo_ciiu
  function do_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange(var_codigo_ciiu, var_descripcion_ciiu, var_script_case_init, do_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange_cb);
  } // do_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange

  function do_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_ciiu";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange_cb_after_alert);
  } // do_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange_cb
  function do_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_ciiu_tercero_event_codigo_ciiu_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ciiu_tercero_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ciiu_tercero_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_ciiu_tercero_submit_form(var_id_ciiu_ter, var_id_tercero, var_codigo_ciiu, var_descripcion_ciiu, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ciiu_tercero_submit_form_cb);
  } // do_ajax_form_ciiu_tercero_submit_form

  function do_ajax_form_ciiu_tercero_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ciiu_tercero_submit_form_cb_after_alert);
  } // do_ajax_form_ciiu_tercero_submit_form_cb
  function do_ajax_form_ciiu_tercero_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ciiu_tercero_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ciiu_tercero_navigate_form()
  {
    perform_ajax_form_ciiu_tercero_navigate_form();
  }

  function perform_ajax_form_ciiu_tercero_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ciiu_tercero_navigate_form(var_id_ciiu_ter, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ciiu_tercero_navigate_form_cb);
  } // do_ajax_form_ciiu_tercero_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciiu_tercero']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ciiu_tercero_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ciiu_tercero_navigate_form_cb_after_alert);
  } // do_ajax_form_ciiu_tercero_navigate_form_cb
  function do_ajax_form_ciiu_tercero_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_ciiu_tercero_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ciiu_tercero_navigate_form_cb_after_alert
  function sc_hide_form_ciiu_tercero_form()
  {
