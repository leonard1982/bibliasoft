  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_ciiu_tercero_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_ciiu_tercero_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_ciiu_ter
  function do_ajax_form_ciiu_tercero_mob_validate_id_ciiu_ter()
  {
    var nomeCampo_id_ciiu_ter = "id_ciiu_ter";
    var var_id_ciiu_ter = scAjaxGetFieldHidden(nomeCampo_id_ciiu_ter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciiu_tercero_mob_validate_id_ciiu_ter(var_id_ciiu_ter, var_script_case_init, do_ajax_form_ciiu_tercero_mob_validate_id_ciiu_ter_cb);
  } // do_ajax_form_ciiu_tercero_mob_validate_id_ciiu_ter

  function do_ajax_form_ciiu_tercero_mob_validate_id_ciiu_ter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_ciiu_ter";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciiu_tercero_mob_validate_id_ciiu_ter_cb

  // ---------- Validate id_tercero
  function do_ajax_form_ciiu_tercero_mob_validate_id_tercero()
  {
    var nomeCampo_id_tercero = "id_tercero";
    var var_id_tercero = scAjaxGetFieldText(nomeCampo_id_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciiu_tercero_mob_validate_id_tercero(var_id_tercero, var_script_case_init, do_ajax_form_ciiu_tercero_mob_validate_id_tercero_cb);
  } // do_ajax_form_ciiu_tercero_mob_validate_id_tercero

  function do_ajax_form_ciiu_tercero_mob_validate_id_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciiu_tercero_mob_validate_id_tercero_cb

  // ---------- Validate codigo_ciiu
  function do_ajax_form_ciiu_tercero_mob_validate_codigo_ciiu()
  {
    var nomeCampo_codigo_ciiu = "codigo_ciiu";
    var var_codigo_ciiu = scAjaxGetFieldSelect(nomeCampo_codigo_ciiu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciiu_tercero_mob_validate_codigo_ciiu(var_codigo_ciiu, var_script_case_init, do_ajax_form_ciiu_tercero_mob_validate_codigo_ciiu_cb);
  } // do_ajax_form_ciiu_tercero_mob_validate_codigo_ciiu

  function do_ajax_form_ciiu_tercero_mob_validate_codigo_ciiu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo_ciiu";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciiu_tercero_mob_validate_codigo_ciiu_cb

  // ---------- Validate descripcion_ciiu
  function do_ajax_form_ciiu_tercero_mob_validate_descripcion_ciiu()
  {
    var nomeCampo_descripcion_ciiu = "descripcion_ciiu";
    var var_descripcion_ciiu = scAjaxGetFieldText(nomeCampo_descripcion_ciiu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_ciiu_tercero_mob_validate_descripcion_ciiu(var_descripcion_ciiu, var_script_case_init, do_ajax_form_ciiu_tercero_mob_validate_descripcion_ciiu_cb);
  } // do_ajax_form_ciiu_tercero_mob_validate_descripcion_ciiu

  function do_ajax_form_ciiu_tercero_mob_validate_descripcion_ciiu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descripcion_ciiu";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_ciiu_tercero_mob_validate_descripcion_ciiu_cb

  // ---------- Event onchange codigo_ciiu
  function do_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange()
  {
    var var_codigo_ciiu = scAjaxGetFieldSelect("codigo_ciiu");
    var var_descripcion_ciiu = scAjaxGetFieldText("descripcion_ciiu");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange(var_codigo_ciiu, var_descripcion_ciiu, var_script_case_init, do_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange_cb);
  } // do_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange

  function do_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_ciiu";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange_cb_after_alert);
  } // do_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange_cb
  function do_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_ciiu_tercero_mob_event_codigo_ciiu_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_ciiu_tercero_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_ciiu_tercero_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_ciiu_ter = scAjaxGetFieldHidden("id_ciiu_ter");
    ...
    scAjaxProcOn();
    x_ajax_form_ciiu_tercero_mob_submit_form(var_id_ciiu_ter, var_id_tercero, var_codigo_ciiu, var_descripcion_ciiu, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_ciiu_tercero_mob_submit_form_cb);
  } // do_ajax_form_ciiu_tercero_mob_submit_form

  function do_ajax_form_ciiu_tercero_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_ciiu_ter");
      scAjaxHideErrorDisplay("id_tercero");
      scAjaxHideErrorDisplay("codigo_ciiu");
      scAjaxHideErrorDisplay("descripcion_ciiu");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_ciiu_tercero_mob_submit_form_cb_after_alert);
  } // do_ajax_form_ciiu_tercero_mob_submit_form_cb
  function do_ajax_form_ciiu_tercero_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_ciiu_tercero_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_ciiu_tercero_mob_navigate_form()
  {
    perform_ajax_form_ciiu_tercero_mob_navigate_form();
  }

  function perform_ajax_form_ciiu_tercero_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("codigo_ciiu");
    scAjaxHideErrorDisplay("descripcion_ciiu");
    var var_id_ciiu_ter = document.F2.id_ciiu_ter.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_ciiu_tercero_mob_navigate_form(var_id_ciiu_ter, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_ciiu_tercero_mob_navigate_form_cb);
  } // do_ajax_form_ciiu_tercero_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciiu_tercero_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_ciiu_tercero_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_ciiu_ter.value = scAjaxGetKeyValue("id_ciiu_ter");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_ciiu_tercero_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_ciiu_tercero_mob_navigate_form_cb
  function do_ajax_form_ciiu_tercero_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_ciiu_tercero_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_ciiu_tercero_mob_navigate_form_cb_after_alert
  function sc_hide_form_ciiu_tercero_mob_form()
  {
  ...
  ajax_field_list[0] = "id_ciiu_ter";
  ajax_field_list[1] = "id_tercero";
  ajax_field_list[2] = "codigo_ciiu";
  ajax_field_list[3] = "descripcion_ciiu";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_ciiu_ter": {"label": "Id Ciiu Ter", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "codigo_ciiu": {"label": "Código CIIU", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descripcion_ciiu": {"label": "Descripción CIIU", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_ciiu_ter": new Array(),
    "id_tercero": new Array(),
    "codigo_ciiu": new Array(),
    "descripcion_ciiu": new Array()
  };
  ajax_field_mult["id_ciiu_ter"][1] = "id_ciiu_ter";
  ajax_field_mult["id_tercero"][1] = "id_tercero";
  ajax_field_mult["codigo_ciiu"][1] = "codigo_ciiu";
  ajax_field_mult["descripcion_ciiu"][1] = "descripcion_ciiu";

  var ajax_field_id = {
    "codigo_ciiu": new Array("hidden_field_label_codigo_ciiu", "hidden_field_data_codigo_ciiu")
  };
