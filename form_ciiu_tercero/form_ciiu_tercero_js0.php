<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_ciiu_ter" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_ciiu_ter']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciiu_tercero']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_ciiu_tercero"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_grid_codigos_ciiu_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "NMSC_inicial*scininicio*scout"; ?>', 'inicio', '_blank', '0', '0', 'grid_codigos_ciiu');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciiu_tercero']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciiu_tercero']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_ciiu_tercero']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_ciiu_tercero']['where_detal']))
  {
?>  
