...
class grid_caja_informe_pos_280819_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_caja_informe_pos_280819']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_caja_informe_pos_280819']['campos_busca']))
      { 
