...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['fac_compras_new03062022']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['fac_compras_new03062022']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['fac_compras_new03062022']['upload_field_info'][ $_POST['param_field'] ];
