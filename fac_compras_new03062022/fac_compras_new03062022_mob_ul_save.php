 ...
 */
   ...
   // scriptcase
   include_once('fac_compras_new03062022_mob_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['fac_compras_new03062022_mob']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['fac_compras_new03062022_mob']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['fac_compras_new03062022_mob']['upload_field_info'][ $_POST['param_field'] ];
