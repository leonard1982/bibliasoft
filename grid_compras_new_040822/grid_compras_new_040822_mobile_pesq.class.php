...
class grid_compras_new_040822_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_compras_new_040822_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_compras_new_040822_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_compras_new_040822_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idprov')
      {
          $idprov = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idprov($idprov);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_idprov($idprov)
   {
      $idprov = substr($this->Db->qstr($idprov), 1, -1);
            $idprov_look = substr($this->Db->qstr($idprov), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "select idtercero, documento + ' - ' + nombres from terceros where  documento + ' - ' + nombres like '%" . $idprov . "%' order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select idtercero, concat(documento,' - ',nombres) from terceros where  concat(documento,' - ',nombres) like '%" . $idprov . "%' order by documento, nombres" ; 
      } 
      ...
      { 
          $nm_comando = "select idtercero, documento||' - '||nombres from terceros where   CAST (documento||' - '||nombres AS TEXT)  like '%" . $idprov . "%' order by documento, nombres" ; 
      } 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>DOCUMENTOS COMPRAS</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_compras_new_040822/grid_compras_new_040822_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_compras_new_040822_ajax_search.js"></script>
 <script type="text/javascript" src="grid_compras_new_040822_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_compras_new_040822_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_compras_new_040822']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_compras_new_040822']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_idprov_cond#NMF#' + search_get_sel_txt('SC_idprov_cond') + '@NMF@';
  str_out += 'SC_idprov#NMF#' + search_get_text('SC_idprov') + '@NMF@';
  str_out += 'id_ac_idprov#NMF#' + search_get_text('id_ac_idprov') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-numfacom").on("focus", function() {
   ...
   scClass = $("#id_ac_idprov").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_idprov").autocomplete({
     minLength: 1,
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>DOCUMENTOS COMPRAS</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__shopping_cart_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $idprov_cond, $idprov, $idprov_autocomp,
             $pagada_cond, $pagada,
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fechacom_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_dia']; 
          $fechacom_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_mes']; 
          $fechacom_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_ano']; 
          $fechacom_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_input_2_dia']; 
          $fechacom_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_input_2_mes']; 
          $fechacom_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_input_2_ano']; 
          $fechacom_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_cond']; 
          $numfacom = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['numfacom']; 
          $numfacom_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['numfacom_cond']; 
          $idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['idprov']; 
          $idprov_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['idprov_cond']; 
          $pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['pagada']; 
          $pagada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['pagada_cond']; 
          $asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['asentada']; 
          $asentada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['asentada_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($idprov_cond) || empty($idprov_cond))
      {
         $idprov_cond = "eq";
      }
      ...
      $str_hide_idprov = (in_array($idprov_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_idprov = ('bw' == $idprov_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($idprov) || $idprov == "")
      {
          $idprov = "";
      }
      if (isset($idprov) && !empty($idprov))
      {
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fechacom"  <?php echo $str_hide_fechacom?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
      ...
      <INPUT type="hidden" id="SC_numfacom_cond" name="numfacom_cond" value="qp">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_numfacom"  <?php echo $str_hide_numfacom?>><?php
      if ($numfacom != "")
      {
      $numfacom_look = substr($this->Db->qstr($numfacom), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numfacom from (SELECT      idfaccom,     numfacom,     fechacom,     fechavenc,     idprov,     if(tipo_com='NC',subtotal*-1,subtotal) as subtotal,     if(tipo_com='NC',valoriva*-1,valoriva) as valoriva,     if(tipo_com='NC',total*-1,total) as total,     pagada,     asentada,     observaciones,     saldo,     id_pedidocom,     formapago, retencion, reteica, reteiva, cod_cuenta, tipo_com, prefijo_com, numero_com,  if(tipo_com='NC',coalesce((select sum(c.valorpar) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='0'),0)*-1,coalesce((select sum(c.valorpar) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='0'),0)) as excento,  if(tipo_com='NC',coalesce((select sum(c.valorpar) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='19'),0)*-1,coalesce((select sum(c.valorpar) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='19'),0)) as base_iva_19,  if(tipo_com='NC',coalesce((select sum(c.iva) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='19'),0) *-1,coalesce((select sum(c.iva) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='19'),0)) as valor_iva_19,  if(tipo_com='NC',coalesce((select sum(c.valorpar) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='5'),0)*-1,coalesce((select sum(c.valorpar) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='5'),0)) as base_iva_5,  if(tipo_com='NC',coalesce((select sum(c.iva) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='5'),0)*-1,coalesce((select sum(c.iva) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='5'),0)) as valor_iva_5,  if(tipo_com='NC',coalesce((select sum(c.valorpar) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='8'),0)*-1,coalesce((select sum(c.valorpar) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='8'),0)) as base_con_8,  if(tipo_com='NC',coalesce((select sum(c.iva) from detallecompra c where c.idfaccom=idfaccom and c.tasaiva='8'),0)*-1,coalesce((select sum(c.iva) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='8'),0)) as valor_con_8,  if(tipo_com='NC',(valoriva - coalesce((select sum(c.iva) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='8'),0) )*-1,(valoriva - coalesce((select sum(c.iva) from detallecompra c where c.idfaccom=p.idfaccom and c.tasaiva='8'),0) )) as t_iva  FROM      facturacom p ) nm_sel_esp where numfacom = '$numfacom_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numfacom" id="id_ac_numfacom" name="numfacom_autocomp"><?php if ('' !=  $numfacom) { ?><option value="<?php echo $numfacom ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
      ...
      <INPUT type="hidden" id="SC_idprov_cond" name="idprov_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['idprov'])) ? $this->New_label['idprov'] : "Proveedor";
 $nmgp_tab_label .= "idprov?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_idprov"  <?php echo $str_hide_idprov?>><?php
      if ($idprov != "")
      {
      $idprov_look = substr($this->Db->qstr($idprov), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "select idtercero, documento + ' - ' + nombres from terceros where idtercero = $idprov_look order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select idtercero, concat(documento,' - ',nombres) from terceros where idtercero = $idprov_look order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select idtercero, documento&' - '&nombres from terceros where idtercero = $idprov_look order by documento, nombres" ; 
      ...
      if (isset($nmgp_def_dados[0][$idprov]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idprov];
      }
      else
      {
          $sAutocompValue = $idprov;
      }
?>
<INPUT  type="text" id="SC_idprov" name="idprov" value="<?php echo NM_encode_input($idprov) ?>"  size=19 alt="{datatype: 'text', maxLength: 19, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idprov" name="idprov_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pagada"  <?php echo $str_hide_pagada?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['psq_check_ret']['pagada'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['psq_check_ret']['pagada'][] = "SI";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['psq_check_ret']['pagada'][] = "NO";
 ?>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['psq_check_ret']['asentada'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['psq_check_ret']['asentada'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['psq_check_ret']['asentada'][] = "0";
 ?>
...
<?php
   if (is_file("grid_compras_new_040822_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_040822']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_040822']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_040822']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_040822']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.numfacom_cond.value = 'qp';
   ...
   document.F1.idprov_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_idprov'), document.F1.idprov_cond, 'idprov');
   document.F1.idprov.value = "";
   document.F1.idprov_autocomp.value = "";
 ...
 {
    $('#SC_fechacom_dia').bind('change', function() {sc_grid_compras_new_040822_valida_dia(this)});
    $('#SC_fechacom_input_2_dia').bind('change', function() {sc_grid_compras_new_040822_valida_dia(this)});
    $('#SC_fechacom_input_2_mes').bind('change', function() {sc_grid_compras_new_040822_valida_mes(this)});
    $('#SC_fechacom_mes').bind('change', function() {sc_grid_compras_new_040822_valida_mes(this)});
 }
 function sc_grid_compras_new_040822_valida_dia(obj)
 {
 ...
 function sc_grid_compras_new_040822_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_compras_new_040822";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_compras_new_040822/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idprov_cond'] = 'cond';
      $tp_fields['SC_idprov'] = 'text_aut';
      $tp_fields['id_ac_idprov'] = 'text_aut';
   ...
   {
      global $fechacom_cond, $fechacom, $fechacom_dia, $fechacom_mes, $fechacom_ano, $fechacom_input_2_dia, $fechacom_input_2_mes, $fechacom_input_2_ano,
             $numfacom_cond, $numfacom, $numfacom_autocomp,
             $idprov_cond, $idprov, $idprov_autocomp,
             $pagada_cond, $pagada,
      ...
      if (!empty($idprov_autocomp) && empty($idprov))
      {
          $idprov = $idprov_autocomp;
      }
      ...
      $idprov_cond_salva = $idprov_cond; 
      if (!isset($idprov_input_2) || $idprov_input_2 == "")
      {
          $idprov_input_2 = $idprov;
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['psq_check_ret']['pagada'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['psq_check_ret']['asentada'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_dia'] = $fechacom_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_mes'] = $fechacom_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_ano'] = $fechacom_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_input_2_dia'] = $fechacom_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_input_2_mes'] = $fechacom_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_input_2_ano'] = $fechacom_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_cond'] = $fechacom_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['numfacom'] = $numfacom; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['numfacom_cond'] = $numfacom_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['idprov'] = $idprov; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['idprov_cond'] = $idprov_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['pagada'] = $pagada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['pagada_cond'] = $pagada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['asentada'] = $asentada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['asentada_cond'] = $asentada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca'] = $Temp_Busca;
      }
      if ($idprov_cond != "in" && $idprov_cond != "bw" && !empty($idprov) && !is_numeric($idprov))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Proveedor";
      }
      if ($idprov_cond == "bw" && ((!empty($idprov) && !is_numeric($idprov)) || (!empty($idprov_input_2) && !is_numeric($idprov_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Proveedor";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idprov'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['idprov'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['idprov'] = $idprov;
      }
      $Conteudo = $pagada;
      ...
      if ($fechacom_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom'] = $val[0];
          ...
          if ($fechacom_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']['fechacom_input_2'] = $val[1];
      ...
      if (isset($idprov) && !empty($idprov))
      { 
           $idprov = strtoupper($idprov);
      } 
      if (isset($idprov) || $idprov_cond == "nu" || $idprov_cond == "nn" || $idprov_cond == "ep" || $idprov_cond == "ne")
      {
         $this->monta_condicao("idprov", $idprov_cond, $idprov, "", "idprov");
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['fast_search']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['interativ_search'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['int_search_dados'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['where_pesq'];
