...
$_SESSION['scriptcase']['grid_compras_new_040822']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][7] = $this->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][8] = $this->array_total_geral[7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['contr_array_resumo'] = "OK";
