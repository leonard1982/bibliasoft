...
class grid_compras_new_040822_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_tipo_com = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['tipo_com'];
      }
      else
      {
          $this->array_total_tipo_com = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['tipo_com'] = $this->array_total_tipo_com;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_order']['tipo_com']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_order']['tipo_com'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_order']['tipo_com'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['tipo_com'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['tipo_com'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['tipo_com'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['tipo_com'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['tipo_com'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['tipo_com'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['tipo_com'] as $i_sum => $d_sum)
           {
