...
class grid_compras_new_040822_resumo
{
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_prefijo_com = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_prefijo_com = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['prefijo_com'];
      }
      else
      {
          $this->array_total_prefijo_com = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['prefijo_com'] = $this->array_total_prefijo_com;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_prefijo_com = "prefijo_com";
       }
       else
       {
       $Lab_prefijo_com = "Prefijo";
       }
       $this->comp_field = array(
           $Lab_prefijo_com,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_order']['prefijo_com']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_order']['prefijo_com'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_order']['prefijo_com'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['prefijo_com'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['prefijo_com'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['prefijo_com'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['prefijo_com'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['prefijo_com'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['prefijo_com'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['summarizing_fields_display']['prefijo_com'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_prefijo_com as $i_prefijo_com => $d_prefijo_com) {
           if (!in_array($i_prefijo_com, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_prefijo_com[2] ] = $d_prefijo_com[1];
               $this->comp_label[0][ $d_prefijo_com[2] ] = $d_prefijo_com[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'prefijo_com', 'prot' => '@aspass@'),
       );
       ...
       //-----
       foreach ($this->comp_label[0] as $i_prefijo_com => $l_prefijo_com) {
           if (isset($this->array_total_prefijo_com[$i_prefijo_com])) {
               $this->comp_group[$i_prefijo_com] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_prefijo_com;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_prefijo_com("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_prefijo_com);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($quebra_prefijo_com, $quebra_prefijo_com_orig)
   {
      //----- Prefijo
      if (!isset($this->array_total_prefijo_com[$quebra_prefijo_com_orig]))
      {
         $this->array_total_prefijo_com[$quebra_prefijo_com_orig][0] = 1;
         $this->array_total_prefijo_com[$quebra_prefijo_com_orig][1] = $quebra_prefijo_com;
         $this->array_total_prefijo_com[$quebra_prefijo_com_orig][2] = $quebra_prefijo_com_orig;
      }
      else
      {
         $this->array_total_prefijo_com[$quebra_prefijo_com_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'prefijo_com');
     $campos_order = $this->Ini->Get_date_order_groupby("prefijo_com", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_compras_new_040822']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->prefijo_com, $this->prefijo_com_orig);
            }
   }
//
