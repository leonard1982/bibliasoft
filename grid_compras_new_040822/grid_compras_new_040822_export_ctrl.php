<?php
@session_start() ;
$_SESSION['scriptcase']['grid_compras_new_040822']['sc_process_barr'] = true;
require_once('../grid_compras_new_040822/index.php');
unset($_SESSION['scriptcase']['grid_compras_new_040822']['sc_process_barr']);
$ExportCtrl = new grid_compras_new_040822_export_control;
$ExportCtrl->Export_barr();

class grid_compras_new_040822_export_control
{
