...
class grid_compras_new_040822_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "total" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "_NM_SC_")
          {
              $this->Tem_xls_res  = false;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_compras_new_040822/grid_compras_new_040822_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_compras_new_040822_res_xls.class.php");
              $this->Res_xls = new grid_compras_new_040822_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_compras_new_040822.zip";
          $this->Arquivo   .= "_grid_compras_new_040822" . $this->Xls_tp;
          $this->Tit_doc    = "grid_compras_new_040822" . $this->Xls_tp;
          $this->Tit_zip    = "grid_compras_new_040822.zip";
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "proveedor")
      {
          ...
          $this->Res = new grid_compras_new_040822_resumo("out");
          $this->prep_modulos("Res");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "total")
      {
          require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          $this->Res = new grid_compras_new_040822_resumo("out");
          $this->prep_modulos("Res");
      ...
      if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'], $this->GB_tot_php))
      {
          $Tot_Gb = "totaliza_php_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'];
          $this->$Tot_Gb();
      }
      else
      {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "total")
         {
         ...
         elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "_NM_SC_")
         {
             $this->arg_sum_fechacom = " = " . $this->Db->qstr($this->fechacom);
         }
         ...
         $this->arg_sum_asentada = ($this->asentada == "") ? " is null " : " = " . $this->asentada;
          if ($this->idprov !== $this->idprov_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "proveedor") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
          ...
          if ($Cmp_tst != $this->fechacom_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "fecha") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
          ...
          if ($this->pagada !== $this->pagada_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "pagada") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
          ...
          if ($this->asentada !== $this->asentada_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "asentada") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
          ...
          if (($this->tipo_com !== $this->tipo_com_Old || $NM_prim_qb) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "tipo_com") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
          ...
          if (($this->prefijo_com !== $this->prefijo_com_Old || $NM_prim_qb) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "prefijo_com") 
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                  $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
...
$_SESSION['scriptcase']['grid_compras_new_040822']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'])
      { 
      ...
      if ($this->groupby_show == "S") {
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['nolabel'])
       {
 ...
 function quebra_idprov_proveedor($idprov) 
 {
   ...
   $tot_idprov[0] = $idprov;
   $tot_idprov[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['idprov'][$idprov][0];
   $tot_idprov[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['idprov'][$idprov][1];
   $tot_idprov[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['idprov'][$idprov][2];
   $tot_idprov[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['idprov'][$idprov][3];
   $tot_idprov[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['idprov'][$idprov][4];
 ...
 function quebra_fechacom_fecha($fechacom) 
 {
   ...
   $tot_fechacom[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['fechacom'][$fechacom][0];
   $tot_fechacom[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['fechacom'][$fechacom][1];
   $tot_fechacom[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['fechacom'][$fechacom][2];
   $tot_fechacom[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['fechacom'][$fechacom][3];
   $tot_fechacom[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['fechacom'][$fechacom][4];
 ...
 function quebra_pagada_pagada($pagada) 
 {
   ...
   $tot_pagada[0] = $pagada;
   $tot_pagada[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['pagada'][$pagada][0];
   $tot_pagada[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['pagada'][$pagada][1];
   $tot_pagada[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['pagada'][$pagada][2];
   $tot_pagada[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['pagada'][$pagada][3];
   $tot_pagada[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['pagada'][$pagada][4];
 ...
 function quebra_asentada_asentada($asentada) 
 {
   ...
   $tot_asentada[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['asentada'][$asentada][0];
   $tot_asentada[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['asentada'][$asentada][1];
   $tot_asentada[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['asentada'][$asentada][2];
   $tot_asentada[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['asentada'][$asentada][3];
   $tot_asentada[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['asentada'][$asentada][4];
 ...
 function quebra_prefijo_com_prefijo_com($prefijo_com) 
 {
   ...
   function quebra_idprov_proveedor_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['field_order'] as $Cada_cmp)
       {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_proveedor_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "a_pagar" && (!isset($this->NM_cmp_hidden['a_pagar']) || $this->NM_cmp_hidden['a_pagar'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][2];
               $prim_cmp = false;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][3];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][4];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][5];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   function quebra_geral__NM_SC__bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][6];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][7];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][8];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
...
$_SESSION['scriptcase']['grid_compras_new_040822']['contr_erro'] = 'off';
      ...
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][2] = $this->Res->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][3] = $this->Res->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][4] = $this->Res->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][5] = $this->Res->array_total_geral[4];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][1] = $this->Res->array_total_geral[0];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "proveedor")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['idprov'] = $this->Res->array_total_idprov;
      }
   }
...
$_SESSION['scriptcase']['grid_compras_new_040822']['contr_erro'] = 'off';
     ...
     $this->fechacom = $this->Ini->GB_date_format($TP_Time . $fechacom_SV, $Format_tst, $Prefix_dat); 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "fecha")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['fechacom'] = $this->Res->array_total_fechacom;
      }
   }
...
$_SESSION['scriptcase']['grid_compras_new_040822']['contr_erro'] = 'off';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "pagada")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['pagada'] = $this->Res->array_total_pagada;
      }
   }
...
$_SESSION['scriptcase']['grid_compras_new_040822']['contr_erro'] = 'off';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['SC_Ind_Groupby'] == "asentada")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['arr_total']['asentada'] = $this->Res->array_total_asentada;
      }
   }
...
$_SESSION['scriptcase']['grid_compras_new_040822']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][4] = $this->Res->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][5] = $this->Res->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][6] = $this->Res->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][7] = $this->Res->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][8] = $this->Res->array_total_geral[7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][0] = "Total compras";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['tot_geral'][1] = $this->Res->array_total_geral[0];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['contr_total_geral'] = "OK";
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040822']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
