...
class grid_compras_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['arr_total']['total'];
      }
      else
      {
          $this->array_total_total = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_order']['total']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_order']['total'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_order']['total'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_display']['total'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_display']['total'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_display']['total'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_display']['total'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_display']['total'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_display']['total'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['summarizing_fields_display']['total'] as $i_sum => $d_sum)
           {
...
//--- 
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['arr_total']['total'] as $campo_total => $dados_total)
      {
...
$_SESSION['scriptcase']['grid_compras']['contr_erro'] = 'off';
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras']['arr_total']['total'] = $this->array_total_total;
      }
   }
