...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reciboingreso"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reciboingreso"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reciboingreso']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reciboingreso']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_reciboingreso</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reciboingreso']['embutida_filho'] as $ind => $sc_init)
          {
