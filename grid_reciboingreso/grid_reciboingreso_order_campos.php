...
<?php
   ...
   $Ord_Cmp = new grid_reciboingreso_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reciboingreso_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nurecibo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["nurecibo"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["nurecibo"] : "Número";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "cliente";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["cliente"] : "Cliente";
   $tab_ger_campos['fecharecibo'] = "on";
   $tab_def_campos['fecharecibo'] = "fecharecibo";
   $tab_labels["fecharecibo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["fecharecibo"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["fecharecibo"] : "Fecha";
   $tab_ger_campos['monto'] = "on";
   $tab_def_campos['monto'] = "monto";
   $tab_labels["monto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["monto"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["monto"] : "Pagado";
   $tab_ger_campos['banco_id'] = "on";
   $tab_def_campos['banco_id'] = "banco_id";
   $tab_labels["banco_id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["banco_id"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["banco_id"] : "Banco";
   $tab_ger_campos['doc_cobrado'] = "on";
   $tab_def_campos['doc_cobrado'] = "doc_cobrado";
   $tab_labels["doc_cobrado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["doc_cobrado"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["doc_cobrado"] : "Doc. Cobrado";
   $tab_ger_campos['ncuenta_tercero'] = "on";
   $tab_def_campos['ncuenta_tercero'] = "ncuenta_tercero";
   $tab_labels["ncuenta_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["ncuenta_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["ncuenta_tercero"] : "Cuenta";
   $tab_ger_campos['id_concepto'] = "on";
   $tab_def_campos['id_concepto'] = "id_concepto";
   $tab_labels["id_concepto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["id_concepto"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["id_concepto"] : "Concepto";
   $tab_ger_campos['asentado'] = "on";
   $tab_def_campos['asentado'] = "asentado";
   $tab_labels["asentado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["asentado"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["asentado"] : "Asentado";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['labels']["imprimir"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reciboingreso_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reciboingreso']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
