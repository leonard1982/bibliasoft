...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="terceros_ant_190422"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422']['where_detal']))
  {
?>  
...
{
    NovaJanela = window.open ("terceros_ant_190422_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
function nm_mostra_doc(campo1, campo2, campo3)
{
    ...
    NovaJanela = window.open ("terceros_ant_190422_doc.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nm_cod_doc=" + campo1 + "&nm_nome_doc=" + encodeURIComponent(campo2) + "&nm_cod_apl=" + campo3, "sc_name_download_iframe", "resizable, scrollbars");
}
...
{
    document.getElementById('terceros_ant_190422_form0').style.width='1px';
    document.getElementById('terceros_ant_190422_form0').style.height='0px';
    document.getElementById('terceros_ant_190422_form0').style.display='none';
    document.getElementById('terceros_ant_190422_form0').style.overflow='scroll';
    document.getElementById('terceros_ant_190422_form1').style.width='1px';
    document.getElementById('terceros_ant_190422_form1').style.height='0px';
    document.getElementById('terceros_ant_190422_form1').style.display='none';
    document.getElementById('terceros_ant_190422_form1').style.overflow='scroll';
    document.getElementById('terceros_ant_190422_form2').style.width='1px';
    document.getElementById('terceros_ant_190422_form2').style.height='0px';
    document.getElementById('terceros_ant_190422_form2').style.display='none';
    document.getElementById('terceros_ant_190422_form2').style.overflow='scroll';
    document.getElementById('terceros_ant_190422_form3').style.width='1px';
    document.getElementById('terceros_ant_190422_form3').style.height='0px';
    document.getElementById('terceros_ant_190422_form3').style.display='none';
    document.getElementById('terceros_ant_190422_form3').style.overflow='scroll';
    document.getElementById('terceros_ant_190422_form4').style.width='1px';
    document.getElementById('terceros_ant_190422_form4').style.height='0px';
    document.getElementById('terceros_ant_190422_form4').style.display='none';
    document.getElementById('terceros_ant_190422_form4').style.overflow='scroll';
    document.getElementById('terceros_ant_190422_form5').style.width='1px';
    document.getElementById('terceros_ant_190422_form5').style.height='0px';
    document.getElementById('terceros_ant_190422_form5').style.display='none';
    document.getElementById('terceros_ant_190422_form5').style.overflow='scroll';
    document.getElementById('terceros_ant_190422_form6').style.width='1px';
    document.getElementById('terceros_ant_190422_form6').style.height='0px';
    document.getElementById('terceros_ant_190422_form6').style.display='none';
    document.getElementById('terceros_ant_190422_form6').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422']['pdf_view']) {
?>
...
?>
   ...
   if ("terceros_ant_190422_form5" == N_pagina) {
