<div id="terceros_ant_190422_mob_form1" style='<?php echo ($this->tabCssClass["terceros_ant_190422_mob_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_credito'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->credito == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_credito'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_efec_retencion'][] = 'N'; ?>
 <option  value="S" <?php  if ($this->efec_retencion == "S") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_efec_retencion'][] = 'S'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_listaprecios'][] = '1'; ?>
 <option  value="2" <?php  if ($this->listaprecios == "2") { echo " selected" ;} ?>>Precio Intermedio</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_listaprecios'][] = '2'; ?>
 <option  value="3" <?php  if ($this->listaprecios == "3") { echo " selected" ;} ?>>Precio Mínimo</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_listaprecios'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_loatiende']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_loatiende'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_loatiende']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_loatiende'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_loatiende'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_loatiende'][] = ''; 
...
<span id="id_read_on_autorizado" class="css_autorizado_line" style="<?php echo $sStyleReadLab_autorizado; ?>"><?php echo $this->form_format_readonly("autorizado", $this->form_encode_input($autorizado_look)); ?></span><span id="id_read_off_autorizado" class="css_read_off_autorizado css_autorizado_line" style="<?php echo $sStyleReadInp_autorizado; ?>"><?php echo "<div id=\"idAjaxCheckbox_autorizado\" style=\"display: inline-block\" class=\"css_autorizado_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_autorizado'][] = 'SI'; ?>
...
<span id="id_read_on_sucur_cliente" class="css_sucur_cliente_line" style="<?php echo $sStyleReadLab_sucur_cliente; ?>"><?php echo $this->form_format_readonly("sucur_cliente", $this->form_encode_input($sucur_cliente_look)); ?></span><span id="id_read_off_sucur_cliente" class="css_read_off_sucur_cliente css_sucur_cliente_line" style="<?php echo $sStyleReadInp_sucur_cliente; ?>"><?php echo "<div id=\"idAjaxCheckbox_sucur_cliente\" style=\"display: inline-block\" class=\"css_sucur_cliente_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_sucur_cliente'][] = 'SI'; ?>
