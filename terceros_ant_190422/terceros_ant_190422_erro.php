...
$old_error_handler = set_error_handler("terceros_ant_190422_scriptcase_error_handler");

function terceros_ant_190422_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['terceros_ant_190422']['contr_erro']) && $_SESSION['scriptcase']['terceros_ant_190422']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_terceros_ant_190422->contr_terceros_ant_190422->Apl_com_erro = true;
            if ($inicial_terceros_ant_190422->contr_terceros_ant_190422->NM_ajax_flag)
            {
                $inicial_terceros_ant_190422->contr_terceros_ant_190422->NM_ajax_info['errList']['geral_terceros_ant_190422'][] = $msg;
                return;
            }
            terceros_ant_190422_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function terceros_ant_190422_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['terceros_ant_190422'])  && '' != $_SESSION['scriptcase']['error_icon']['terceros_ant_190422'])  ? $_SESSION['scriptcase']['error_icon']['terceros_ant_190422']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['terceros_ant_190422']) && '' != $_SESSION['scriptcase']['error_span_title']['terceros_ant_190422']) ? $_SESSION['scriptcase']['error_span_title']['terceros_ant_190422'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['terceros_ant_190422']) && '' != $_SESSION['scriptcase']['error_icon_title']['terceros_ant_190422']) ? $_SESSION['scriptcase']['error_icon_title']['terceros_ant_190422'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['terceros_ant_190422']['error_buffer'] .= ob_get_flush();
}
