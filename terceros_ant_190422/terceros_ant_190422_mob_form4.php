<div id="terceros_ant_190422_mob_form4" style='<?php echo ($this->tabCssClass["terceros_ant_190422_mob_form4"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_zona_clientes']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_zona_clientes'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_zona_clientes']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_zona_clientes'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_zona_clientes'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_zona_clientes'][] = '0'; 
   ...
   if (isset($this->Ini->sc_lig_md5["form_zona_clientes"]) && $this->Ini->sc_lig_md5["form_zona_clientes"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_terceros_ant_190422_mob_lkpedt_refresh_zona_clientes*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@terceros_ant_190422_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_terceros_ant_190422_mob_lkpedt_refresh_zona_clientes*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_clasificacion_clientes']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_clasificacion_clientes'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_clasificacion_clientes']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_clasificacion_clientes'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_clasificacion_clientes'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_clasificacion_clientes'][] = '0'; 
   echo "  <option value=\"0\">" . str_replace("<", "&lt;","SELECCIONE") . "</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   if (isset($this->Ini->sc_lig_md5["form_clasificacion_clientes"]) && $this->Ini->sc_lig_md5["form_clasificacion_clientes"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_terceros_ant_190422_mob_lkpedt_refresh_clasificacion_clientes*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@terceros_ant_190422_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_terceros_ant_190422_mob_lkpedt_refresh_clasificacion_clientes*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_deudores']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_deudores'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_deudores']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_deudores'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_deudores'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_ventas']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_ventas'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_ventas']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_ventas'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_ventas'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_clie']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_clie'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_clie']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_clie'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_clie'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_proveedores']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_proveedores'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_proveedores']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_proveedores'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_auxiliar_proveedores'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_compras']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_compras'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_compras']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_compras'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_compras'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_prov']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_prov'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_prov']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_prov'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_puc_retefuente_servicios_prov'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_id_plan']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_id_plan'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_id_plan']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_id_plan'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_id_plan'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_id_plan'][] = ''; 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_estado'][] = ''; ?>
 <option value="">SIN ESTADO</option>
 <option  value="PENDIENTE" <?php  if ($this->estado == "PENDIENTE") { echo " selected" ;} ?>>PENDIENTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_estado'][] = 'PENDIENTE'; ?>
 <option  value="ASIGNADO" <?php  if ($this->estado == "ASIGNADO") { echo " selected" ;} ?>>ASIGNADO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_estado'][] = 'ASIGNADO'; ?>
 <option  value="PRODUCCION" <?php  if ($this->estado == "PRODUCCION") { echo " selected" ;} ?>>PRODUCCION</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_estado'][] = 'PRODUCCION'; ?>
 <option  value="SUSPENDIDO" <?php  if ($this->estado == "SUSPENDIDO") { echo " selected" ;} ?>>SUSPENDIDO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_estado'][] = 'SUSPENDIDO'; ?>
 <option  value="INACTIVO" <?php  if ($this->estado == "INACTIVO") { echo " selected" ;} ?>>INACTIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_estado'][] = 'INACTIVO'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_si_nomina" class="css_si_nomina_line" style="<?php echo $sStyleReadLab_si_nomina; ?>"><?php echo $this->form_format_readonly("si_nomina", $this->form_encode_input($si_nomina_look)); ?></span><span id="id_read_off_si_nomina" class="css_read_off_si_nomina css_si_nomina_line" style="<?php echo $sStyleReadInp_si_nomina; ?>"><?php echo "<div id=\"idAjaxCheckbox_si_nomina\" style=\"display: inline-block\" class=\"css_si_nomina_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_si_nomina'][] = 'SI'; ?>
...
<span id="id_read_on_si_factura_electronica" class="css_si_factura_electronica_line" style="<?php echo $sStyleReadLab_si_factura_electronica; ?>"><?php echo $this->form_format_readonly("si_factura_electronica", $this->form_encode_input($si_factura_electronica_look)); ?></span><span id="id_read_off_si_factura_electronica" class="css_read_off_si_factura_electronica css_si_factura_electronica_line" style="<?php echo $sStyleReadInp_si_factura_electronica; ?>"><?php echo "<div id=\"idAjaxCheckbox_si_factura_electronica\" style=\"display: inline-block\" class=\"css_si_factura_electronica_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422_mob']['Lookup_si_factura_electronica'][] = 'SI'; ?>
