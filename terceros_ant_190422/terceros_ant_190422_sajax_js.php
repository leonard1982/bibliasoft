  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_terceros_ant_190422" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_terceros_ant_190422_form();
	}
...
?>
  ...
  // ---------- Validate tipo
  function do_ajax_terceros_ant_190422_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_tipo(var_tipo, var_script_case_init, do_ajax_terceros_ant_190422_validate_tipo_cb);
  } // do_ajax_terceros_ant_190422_validate_tipo

  function do_ajax_terceros_ant_190422_validate_tipo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_tipo_cb

  // ---------- Validate regimen
  function do_ajax_terceros_ant_190422_validate_regimen()
  {
    var nomeCampo_regimen = "regimen";
    var var_regimen = scAjaxGetFieldSelect(nomeCampo_regimen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_regimen(var_regimen, var_script_case_init, do_ajax_terceros_ant_190422_validate_regimen_cb);
  } // do_ajax_terceros_ant_190422_validate_regimen

  function do_ajax_terceros_ant_190422_validate_regimen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regimen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_regimen_cb

  // ---------- Validate tipo_documento
  function do_ajax_terceros_ant_190422_validate_tipo_documento()
  {
    var nomeCampo_tipo_documento = "tipo_documento";
    var var_tipo_documento = scAjaxGetFieldSelect(nomeCampo_tipo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_tipo_documento(var_tipo_documento, var_script_case_init, do_ajax_terceros_ant_190422_validate_tipo_documento_cb);
  } // do_ajax_terceros_ant_190422_validate_tipo_documento

  function do_ajax_terceros_ant_190422_validate_tipo_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_tipo_documento_cb

  // ---------- Validate documento
  function do_ajax_terceros_ant_190422_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldText(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_documento(var_documento, var_script_case_init, do_ajax_terceros_ant_190422_validate_documento_cb);
  } // do_ajax_terceros_ant_190422_validate_documento

  function do_ajax_terceros_ant_190422_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_documento_cb

  // ---------- Validate dv
  function do_ajax_terceros_ant_190422_validate_dv()
  {
    var nomeCampo_dv = "dv";
    var var_dv = scAjaxGetFieldText(nomeCampo_dv);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_dv(var_dv, var_script_case_init, do_ajax_terceros_ant_190422_validate_dv_cb);
  } // do_ajax_terceros_ant_190422_validate_dv

  function do_ajax_terceros_ant_190422_validate_dv_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dv";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_dv_cb

  // ---------- Validate imagenter
  function do_ajax_terceros_ant_190422_validate_imagenter()
  {
    var nomeCampo_imagenter = "imagenter";
    var var_imagenter = scAjaxGetFieldText(nomeCampo_imagenter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_imagenter(var_imagenter, var_script_case_init, do_ajax_terceros_ant_190422_validate_imagenter_cb);
  } // do_ajax_terceros_ant_190422_validate_imagenter

  function do_ajax_terceros_ant_190422_validate_imagenter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_imagenter_cb

  // ---------- Validate codigo_tercero
  function do_ajax_terceros_ant_190422_validate_codigo_tercero()
  {
    var nomeCampo_codigo_tercero = "codigo_tercero";
    var var_codigo_tercero = scAjaxGetFieldText(nomeCampo_codigo_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_codigo_tercero(var_codigo_tercero, var_script_case_init, do_ajax_terceros_ant_190422_validate_codigo_tercero_cb);
  } // do_ajax_terceros_ant_190422_validate_codigo_tercero

  function do_ajax_terceros_ant_190422_validate_codigo_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_codigo_tercero_cb

  // ---------- Validate sexo
  function do_ajax_terceros_ant_190422_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldSelect(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_sexo(var_sexo, var_script_case_init, do_ajax_terceros_ant_190422_validate_sexo_cb);
  } // do_ajax_terceros_ant_190422_validate_sexo

  function do_ajax_terceros_ant_190422_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_sexo_cb

  // ---------- Validate notificar
  function do_ajax_terceros_ant_190422_validate_notificar()
  {
    var nomeCampo_notificar = "notificar";
    var var_notificar = scAjaxGetFieldCheckbox(nomeCampo_notificar, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_notificar(var_notificar, var_script_case_init, do_ajax_terceros_ant_190422_validate_notificar_cb);
  } // do_ajax_terceros_ant_190422_validate_notificar

  function do_ajax_terceros_ant_190422_validate_notificar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_notificar_cb

  // ---------- Validate nombre1
  function do_ajax_terceros_ant_190422_validate_nombre1()
  {
    var nomeCampo_nombre1 = "nombre1";
    var var_nombre1 = scAjaxGetFieldText(nomeCampo_nombre1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_nombre1(var_nombre1, var_script_case_init, do_ajax_terceros_ant_190422_validate_nombre1_cb);
  } // do_ajax_terceros_ant_190422_validate_nombre1

  function do_ajax_terceros_ant_190422_validate_nombre1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_nombre1_cb

  // ---------- Validate nombre2
  function do_ajax_terceros_ant_190422_validate_nombre2()
  {
    var nomeCampo_nombre2 = "nombre2";
    var var_nombre2 = scAjaxGetFieldText(nomeCampo_nombre2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_nombre2(var_nombre2, var_script_case_init, do_ajax_terceros_ant_190422_validate_nombre2_cb);
  } // do_ajax_terceros_ant_190422_validate_nombre2

  function do_ajax_terceros_ant_190422_validate_nombre2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_nombre2_cb

  // ---------- Validate apellido1
  function do_ajax_terceros_ant_190422_validate_apellido1()
  {
    var nomeCampo_apellido1 = "apellido1";
    var var_apellido1 = scAjaxGetFieldText(nomeCampo_apellido1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_apellido1(var_apellido1, var_script_case_init, do_ajax_terceros_ant_190422_validate_apellido1_cb);
  } // do_ajax_terceros_ant_190422_validate_apellido1

  function do_ajax_terceros_ant_190422_validate_apellido1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_apellido1_cb

  // ---------- Validate apellido2
  function do_ajax_terceros_ant_190422_validate_apellido2()
  {
    var nomeCampo_apellido2 = "apellido2";
    var var_apellido2 = scAjaxGetFieldText(nomeCampo_apellido2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_apellido2(var_apellido2, var_script_case_init, do_ajax_terceros_ant_190422_validate_apellido2_cb);
  } // do_ajax_terceros_ant_190422_validate_apellido2

  function do_ajax_terceros_ant_190422_validate_apellido2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_apellido2_cb

  // ---------- Validate tel_cel
  function do_ajax_terceros_ant_190422_validate_tel_cel()
  {
    var nomeCampo_tel_cel = "tel_cel";
    var var_tel_cel = scAjaxGetFieldText(nomeCampo_tel_cel);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_tel_cel(var_tel_cel, var_script_case_init, do_ajax_terceros_ant_190422_validate_tel_cel_cb);
  } // do_ajax_terceros_ant_190422_validate_tel_cel

  function do_ajax_terceros_ant_190422_validate_tel_cel_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tel_cel";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_tel_cel_cb

  // ---------- Validate urlmail
  function do_ajax_terceros_ant_190422_validate_urlmail()
  {
    var nomeCampo_urlmail = "urlmail";
    var var_urlmail = scAjaxGetFieldText(nomeCampo_urlmail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_urlmail(var_urlmail, var_script_case_init, do_ajax_terceros_ant_190422_validate_urlmail_cb);
  } // do_ajax_terceros_ant_190422_validate_urlmail

  function do_ajax_terceros_ant_190422_validate_urlmail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "urlmail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_urlmail_cb

  // ---------- Validate idtercero
  function do_ajax_terceros_ant_190422_validate_idtercero()
  {
    var nomeCampo_idtercero = "idtercero";
    var var_idtercero = scAjaxGetFieldHidden(nomeCampo_idtercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_idtercero(var_idtercero, var_script_case_init, do_ajax_terceros_ant_190422_validate_idtercero_cb);
  } // do_ajax_terceros_ant_190422_validate_idtercero

  function do_ajax_terceros_ant_190422_validate_idtercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_idtercero_cb

  // ---------- Validate r_social
  function do_ajax_terceros_ant_190422_validate_r_social()
  {
    var nomeCampo_r_social = "r_social";
    var var_r_social = scAjaxGetFieldText(nomeCampo_r_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_r_social(var_r_social, var_script_case_init, do_ajax_terceros_ant_190422_validate_r_social_cb);
  } // do_ajax_terceros_ant_190422_validate_r_social

  function do_ajax_terceros_ant_190422_validate_r_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_r_social_cb

  // ---------- Validate nombres
  function do_ajax_terceros_ant_190422_validate_nombres()
  {
    var nomeCampo_nombres = "nombres";
    var var_nombres = scAjaxGetFieldHidden(nomeCampo_nombres);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_nombres(var_nombres, var_script_case_init, do_ajax_terceros_ant_190422_validate_nombres_cb);
  } // do_ajax_terceros_ant_190422_validate_nombres

  function do_ajax_terceros_ant_190422_validate_nombres_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombres";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_nombres_cb

  // ---------- Validate nombre_comercil
  function do_ajax_terceros_ant_190422_validate_nombre_comercil()
  {
    var nomeCampo_nombre_comercil = "nombre_comercil";
    var var_nombre_comercil = scAjaxGetFieldText(nomeCampo_nombre_comercil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_nombre_comercil(var_nombre_comercil, var_script_case_init, do_ajax_terceros_ant_190422_validate_nombre_comercil_cb);
  } // do_ajax_terceros_ant_190422_validate_nombre_comercil

  function do_ajax_terceros_ant_190422_validate_nombre_comercil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_nombre_comercil_cb

  // ---------- Validate representante
  function do_ajax_terceros_ant_190422_validate_representante()
  {
    var nomeCampo_representante = "representante";
    var var_representante = scAjaxGetFieldText(nomeCampo_representante);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_representante(var_representante, var_script_case_init, do_ajax_terceros_ant_190422_validate_representante_cb);
  } // do_ajax_terceros_ant_190422_validate_representante

  function do_ajax_terceros_ant_190422_validate_representante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_representante_cb

  // ---------- Validate direccion
  function do_ajax_terceros_ant_190422_validate_direccion()
  {
    var nomeCampo_direccion = "direccion";
    var var_direccion = scAjaxGetFieldText(nomeCampo_direccion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_direccion(var_direccion, var_script_case_init, do_ajax_terceros_ant_190422_validate_direccion_cb);
  } // do_ajax_terceros_ant_190422_validate_direccion

  function do_ajax_terceros_ant_190422_validate_direccion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_direccion_cb

  // ---------- Validate departamento
  function do_ajax_terceros_ant_190422_validate_departamento()
  {
    var nomeCampo_departamento = "departamento";
    var var_departamento = scAjaxGetFieldSelect(nomeCampo_departamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_departamento(var_departamento, var_script_case_init, do_ajax_terceros_ant_190422_validate_departamento_cb);
  } // do_ajax_terceros_ant_190422_validate_departamento

  function do_ajax_terceros_ant_190422_validate_departamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_departamento_cb

  // ---------- Validate idmuni
  function do_ajax_terceros_ant_190422_validate_idmuni()
  {
    var nomeCampo_idmuni = "idmuni";
    var var_idmuni = scAjaxGetFieldSelect(nomeCampo_idmuni);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_idmuni(var_idmuni, var_script_case_init, do_ajax_terceros_ant_190422_validate_idmuni_cb);
  } // do_ajax_terceros_ant_190422_validate_idmuni

  function do_ajax_terceros_ant_190422_validate_idmuni_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmuni";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_idmuni_cb

  // ---------- Validate ciudad
  function do_ajax_terceros_ant_190422_validate_ciudad()
  {
    var nomeCampo_ciudad = "ciudad";
    var var_ciudad = scAjaxGetFieldSelect(nomeCampo_ciudad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_ciudad(var_ciudad, var_script_case_init, do_ajax_terceros_ant_190422_validate_ciudad_cb);
  } // do_ajax_terceros_ant_190422_validate_ciudad

  function do_ajax_terceros_ant_190422_validate_ciudad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciudad";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_ciudad_cb

  // ---------- Validate codigo_postal
  function do_ajax_terceros_ant_190422_validate_codigo_postal()
  {
    var nomeCampo_codigo_postal = "codigo_postal";
    var var_codigo_postal = scAjaxGetFieldSelect(nomeCampo_codigo_postal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_codigo_postal(var_codigo_postal, var_script_case_init, do_ajax_terceros_ant_190422_validate_codigo_postal_cb);
  } // do_ajax_terceros_ant_190422_validate_codigo_postal

  function do_ajax_terceros_ant_190422_validate_codigo_postal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_codigo_postal_cb

  // ---------- Validate observaciones
  function do_ajax_terceros_ant_190422_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_terceros_ant_190422_validate_observaciones_cb);
  } // do_ajax_terceros_ant_190422_validate_observaciones

  function do_ajax_terceros_ant_190422_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_observaciones_cb

  // ---------- Validate lenguaje
  function do_ajax_terceros_ant_190422_validate_lenguaje()
  {
    var nomeCampo_lenguaje = "lenguaje";
    var var_lenguaje = scAjaxGetFieldSelect(nomeCampo_lenguaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_lenguaje(var_lenguaje, var_script_case_init, do_ajax_terceros_ant_190422_validate_lenguaje_cb);
  } // do_ajax_terceros_ant_190422_validate_lenguaje

  function do_ajax_terceros_ant_190422_validate_lenguaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_lenguaje_cb

  // ---------- Validate c_postal
  function do_ajax_terceros_ant_190422_validate_c_postal()
  {
    var nomeCampo_c_postal = "c_postal";
    var var_c_postal = scAjaxGetFieldText(nomeCampo_c_postal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_c_postal(var_c_postal, var_script_case_init, do_ajax_terceros_ant_190422_validate_c_postal_cb);
  } // do_ajax_terceros_ant_190422_validate_c_postal

  function do_ajax_terceros_ant_190422_validate_c_postal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_c_postal_cb

  // ---------- Validate correo_notificafe
  function do_ajax_terceros_ant_190422_validate_correo_notificafe()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_correo_notificafe(var_correo_notificafe, var_script_case_init, do_ajax_terceros_ant_190422_validate_correo_notificafe_cb);
  } // do_ajax_terceros_ant_190422_validate_correo_notificafe

  function do_ajax_terceros_ant_190422_validate_correo_notificafe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_correo_notificafe_cb

  // ---------- Validate celular_notificafe
  function do_ajax_terceros_ant_190422_validate_celular_notificafe()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_celular_notificafe(var_celular_notificafe, var_script_case_init, do_ajax_terceros_ant_190422_validate_celular_notificafe_cb);
  } // do_ajax_terceros_ant_190422_validate_celular_notificafe

  function do_ajax_terceros_ant_190422_validate_celular_notificafe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_celular_notificafe_cb

  // ---------- Validate cliente
  function do_ajax_terceros_ant_190422_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldCheckbox(nomeCampo_cliente, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_cliente(var_cliente, var_script_case_init, do_ajax_terceros_ant_190422_validate_cliente_cb);
  } // do_ajax_terceros_ant_190422_validate_cliente

  function do_ajax_terceros_ant_190422_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_cliente_cb

  // ---------- Validate proveedor
  function do_ajax_terceros_ant_190422_validate_proveedor()
  {
    var nomeCampo_proveedor = "proveedor";
    var var_proveedor = scAjaxGetFieldCheckbox(nomeCampo_proveedor, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_proveedor(var_proveedor, var_script_case_init, do_ajax_terceros_ant_190422_validate_proveedor_cb);
  } // do_ajax_terceros_ant_190422_validate_proveedor

  function do_ajax_terceros_ant_190422_validate_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_proveedor_cb

  // ---------- Validate empleado
  function do_ajax_terceros_ant_190422_validate_empleado()
  {
    var nomeCampo_empleado = "empleado";
    var var_empleado = scAjaxGetFieldCheckbox(nomeCampo_empleado, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_empleado(var_empleado, var_script_case_init, do_ajax_terceros_ant_190422_validate_empleado_cb);
  } // do_ajax_terceros_ant_190422_validate_empleado

  function do_ajax_terceros_ant_190422_validate_empleado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_empleado_cb

  // ---------- Validate es_tecnico
  function do_ajax_terceros_ant_190422_validate_es_tecnico()
  {
    var nomeCampo_es_tecnico = "es_tecnico";
    var var_es_tecnico = scAjaxGetFieldCheckbox(nomeCampo_es_tecnico, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_es_tecnico(var_es_tecnico, var_script_case_init, do_ajax_terceros_ant_190422_validate_es_tecnico_cb);
  } // do_ajax_terceros_ant_190422_validate_es_tecnico

  function do_ajax_terceros_ant_190422_validate_es_tecnico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_es_tecnico_cb

  // ---------- Validate activo
  function do_ajax_terceros_ant_190422_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldCheckbox(nomeCampo_activo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_activo(var_activo, var_script_case_init, do_ajax_terceros_ant_190422_validate_activo_cb);
  } // do_ajax_terceros_ant_190422_validate_activo

  function do_ajax_terceros_ant_190422_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_activo_cb

  // ---------- Validate credito
  function do_ajax_terceros_ant_190422_validate_credito()
  {
    var nomeCampo_credito = "credito";
    var var_credito = scAjaxGetFieldSelect(nomeCampo_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_credito(var_credito, var_script_case_init, do_ajax_terceros_ant_190422_validate_credito_cb);
  } // do_ajax_terceros_ant_190422_validate_credito

  function do_ajax_terceros_ant_190422_validate_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "credito";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_credito_cb

  // ---------- Validate cupo
  function do_ajax_terceros_ant_190422_validate_cupo()
  {
    var nomeCampo_cupo = "cupo";
    var var_cupo = scAjaxGetFieldText(nomeCampo_cupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_cupo(var_cupo, var_script_case_init, do_ajax_terceros_ant_190422_validate_cupo_cb);
  } // do_ajax_terceros_ant_190422_validate_cupo

  function do_ajax_terceros_ant_190422_validate_cupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cupo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_cupo_cb

  // ---------- Validate cupodis
  function do_ajax_terceros_ant_190422_validate_cupodis()
  {
    var nomeCampo_cupodis = "cupodis";
    var var_cupodis = scAjaxGetFieldText(nomeCampo_cupodis);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_cupodis(var_cupodis, var_script_case_init, do_ajax_terceros_ant_190422_validate_cupodis_cb);
  } // do_ajax_terceros_ant_190422_validate_cupodis

  function do_ajax_terceros_ant_190422_validate_cupodis_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cupodis";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_cupodis_cb

  // ---------- Validate dias_credito
  function do_ajax_terceros_ant_190422_validate_dias_credito()
  {
    var nomeCampo_dias_credito = "dias_credito";
    var var_dias_credito = scAjaxGetFieldText(nomeCampo_dias_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_dias_credito(var_dias_credito, var_script_case_init, do_ajax_terceros_ant_190422_validate_dias_credito_cb);
  } // do_ajax_terceros_ant_190422_validate_dias_credito

  function do_ajax_terceros_ant_190422_validate_dias_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_dias_credito_cb

  // ---------- Validate dias_mora
  function do_ajax_terceros_ant_190422_validate_dias_mora()
  {
    var nomeCampo_dias_mora = "dias_mora";
    var var_dias_mora = scAjaxGetFieldText(nomeCampo_dias_mora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_dias_mora(var_dias_mora, var_script_case_init, do_ajax_terceros_ant_190422_validate_dias_mora_cb);
  } // do_ajax_terceros_ant_190422_validate_dias_mora

  function do_ajax_terceros_ant_190422_validate_dias_mora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_dias_mora_cb

  // ---------- Validate efec_retencion
  function do_ajax_terceros_ant_190422_validate_efec_retencion()
  {
    var nomeCampo_efec_retencion = "efec_retencion";
    var var_efec_retencion = scAjaxGetFieldSelect(nomeCampo_efec_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_efec_retencion(var_efec_retencion, var_script_case_init, do_ajax_terceros_ant_190422_validate_efec_retencion_cb);
  } // do_ajax_terceros_ant_190422_validate_efec_retencion

  function do_ajax_terceros_ant_190422_validate_efec_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_efec_retencion_cb

  // ---------- Validate listaprecios
  function do_ajax_terceros_ant_190422_validate_listaprecios()
  {
    var nomeCampo_listaprecios = "listaprecios";
    var var_listaprecios = scAjaxGetFieldSelect(nomeCampo_listaprecios);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_listaprecios(var_listaprecios, var_script_case_init, do_ajax_terceros_ant_190422_validate_listaprecios_cb);
  } // do_ajax_terceros_ant_190422_validate_listaprecios

  function do_ajax_terceros_ant_190422_validate_listaprecios_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_listaprecios_cb

  // ---------- Validate loatiende
  function do_ajax_terceros_ant_190422_validate_loatiende()
  {
    var nomeCampo_loatiende = "loatiende";
    var var_loatiende = scAjaxGetFieldSelect(nomeCampo_loatiende);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_loatiende(var_loatiende, var_script_case_init, do_ajax_terceros_ant_190422_validate_loatiende_cb);
  } // do_ajax_terceros_ant_190422_validate_loatiende

  function do_ajax_terceros_ant_190422_validate_loatiende_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_loatiende_cb

  // ---------- Validate autorizado
  function do_ajax_terceros_ant_190422_validate_autorizado()
  {
    var nomeCampo_autorizado = "autorizado";
    var var_autorizado = scAjaxGetFieldCheckbox(nomeCampo_autorizado, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_autorizado(var_autorizado, var_script_case_init, do_ajax_terceros_ant_190422_validate_autorizado_cb);
  } // do_ajax_terceros_ant_190422_validate_autorizado

  function do_ajax_terceros_ant_190422_validate_autorizado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_autorizado_cb

  // ---------- Validate relleno2
  function do_ajax_terceros_ant_190422_validate_relleno2()
  {
    var nomeCampo_relleno2 = "relleno2";
    var var_relleno2 = scAjaxGetFieldHidden(nomeCampo_relleno2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_relleno2(var_relleno2, var_script_case_init, do_ajax_terceros_ant_190422_validate_relleno2_cb);
  } // do_ajax_terceros_ant_190422_validate_relleno2

  function do_ajax_terceros_ant_190422_validate_relleno2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_relleno2_cb

  // ---------- Validate nacimiento
  function do_ajax_terceros_ant_190422_validate_nacimiento()
  {
    var nomeCampo_nacimiento = "nacimiento";
    var var_nacimiento = scAjaxGetFieldText(nomeCampo_nacimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_nacimiento(var_nacimiento, var_script_case_init, do_ajax_terceros_ant_190422_validate_nacimiento_cb);
  } // do_ajax_terceros_ant_190422_validate_nacimiento

  function do_ajax_terceros_ant_190422_validate_nacimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_nacimiento_cb

  // ---------- Validate detalle_tributario
  function do_ajax_terceros_ant_190422_validate_detalle_tributario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_detalle_tributario(var_detalle_tributario, var_script_case_init, do_ajax_terceros_ant_190422_validate_detalle_tributario_cb);
  } // do_ajax_terceros_ant_190422_validate_detalle_tributario

  function do_ajax_terceros_ant_190422_validate_detalle_tributario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_detalle_tributario_cb

  // ---------- Validate responsabilidad_fiscal
  function do_ajax_terceros_ant_190422_validate_responsabilidad_fiscal()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_responsabilidad_fiscal(var_responsabilidad_fiscal, var_script_case_init, do_ajax_terceros_ant_190422_validate_responsabilidad_fiscal_cb);
  } // do_ajax_terceros_ant_190422_validate_responsabilidad_fiscal

  function do_ajax_terceros_ant_190422_validate_responsabilidad_fiscal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_responsabilidad_fiscal_cb

  // ---------- Validate ciiu
  function do_ajax_terceros_ant_190422_validate_ciiu()
  {
    var nomeCampo_ciiu = "ciiu";
    var var_ciiu = scAjaxGetFieldText(nomeCampo_ciiu);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_ciiu(var_ciiu, var_script_case_init, do_ajax_terceros_ant_190422_validate_ciiu_cb);
  } // do_ajax_terceros_ant_190422_validate_ciiu

  function do_ajax_terceros_ant_190422_validate_ciiu_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ciiu";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_ciiu_cb

  // ---------- Validate sucur_cliente
  function do_ajax_terceros_ant_190422_validate_sucur_cliente()
  {
    var nomeCampo_sucur_cliente = "sucur_cliente";
    var var_sucur_cliente = scAjaxGetFieldCheckbox(nomeCampo_sucur_cliente, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_sucur_cliente(var_sucur_cliente, var_script_case_init, do_ajax_terceros_ant_190422_validate_sucur_cliente_cb);
  } // do_ajax_terceros_ant_190422_validate_sucur_cliente

  function do_ajax_terceros_ant_190422_validate_sucur_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_sucur_cliente_cb

  // ---------- Validate sucursales
  function do_ajax_terceros_ant_190422_validate_sucursales()
  {
    var nomeCampo_sucursales = "sucursales";
    var var_sucursales = scAjaxGetFieldText(nomeCampo_sucursales);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_sucursales(var_sucursales, var_script_case_init, do_ajax_terceros_ant_190422_validate_sucursales_cb);
  } // do_ajax_terceros_ant_190422_validate_sucursales

  function do_ajax_terceros_ant_190422_validate_sucursales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_sucursales_cb

  // ---------- Validate fechault
  function do_ajax_terceros_ant_190422_validate_fechault()
  {
    var nomeCampo_fechault = "fechault";
    var var_fechault = scAjaxGetFieldText(nomeCampo_fechault);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_fechault(var_fechault, var_script_case_init, do_ajax_terceros_ant_190422_validate_fechault_cb);
  } // do_ajax_terceros_ant_190422_validate_fechault

  function do_ajax_terceros_ant_190422_validate_fechault_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_fechault_cb

  // ---------- Validate saldo
  function do_ajax_terceros_ant_190422_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldText(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_saldo(var_saldo, var_script_case_init, do_ajax_terceros_ant_190422_validate_saldo_cb);
  } // do_ajax_terceros_ant_190422_validate_saldo

  function do_ajax_terceros_ant_190422_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_saldo_cb

  // ---------- Validate afiliacion
  function do_ajax_terceros_ant_190422_validate_afiliacion()
  {
    var nomeCampo_afiliacion = "afiliacion";
    var var_afiliacion = scAjaxGetFieldText(nomeCampo_afiliacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_afiliacion(var_afiliacion, var_script_case_init, do_ajax_terceros_ant_190422_validate_afiliacion_cb);
  } // do_ajax_terceros_ant_190422_validate_afiliacion

  function do_ajax_terceros_ant_190422_validate_afiliacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_afiliacion_cb

  // ---------- Validate es_cajero
  function do_ajax_terceros_ant_190422_validate_es_cajero()
  {
    var nomeCampo_es_cajero = "es_cajero";
    var var_es_cajero = scAjaxGetFieldCheckbox(nomeCampo_es_cajero, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_es_cajero(var_es_cajero, var_script_case_init, do_ajax_terceros_ant_190422_validate_es_cajero_cb);
  } // do_ajax_terceros_ant_190422_validate_es_cajero

  function do_ajax_terceros_ant_190422_validate_es_cajero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_es_cajero_cb

  // ---------- Validate cupo_vendedor
  function do_ajax_terceros_ant_190422_validate_cupo_vendedor()
  {
    var nomeCampo_cupo_vendedor = "cupo_vendedor";
    var var_cupo_vendedor = scAjaxGetFieldText(nomeCampo_cupo_vendedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_cupo_vendedor(var_cupo_vendedor, var_script_case_init, do_ajax_terceros_ant_190422_validate_cupo_vendedor_cb);
  } // do_ajax_terceros_ant_190422_validate_cupo_vendedor

  function do_ajax_terceros_ant_190422_validate_cupo_vendedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_cupo_vendedor_cb

  // ---------- Validate autoretenedor
  function do_ajax_terceros_ant_190422_validate_autoretenedor()
  {
    var nomeCampo_autoretenedor = "autoretenedor";
    var var_autoretenedor = scAjaxGetFieldSelect(nomeCampo_autoretenedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_autoretenedor(var_autoretenedor, var_script_case_init, do_ajax_terceros_ant_190422_validate_autoretenedor_cb);
  } // do_ajax_terceros_ant_190422_validate_autoretenedor

  function do_ajax_terceros_ant_190422_validate_autoretenedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_autoretenedor_cb

  // ---------- Validate creditoprov
  function do_ajax_terceros_ant_190422_validate_creditoprov()
  {
    var nomeCampo_creditoprov = "creditoprov";
    var var_creditoprov = scAjaxGetFieldSelect(nomeCampo_creditoprov);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_creditoprov(var_creditoprov, var_script_case_init, do_ajax_terceros_ant_190422_validate_creditoprov_cb);
  } // do_ajax_terceros_ant_190422_validate_creditoprov

  function do_ajax_terceros_ant_190422_validate_creditoprov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_creditoprov_cb

  // ---------- Validate dias
  function do_ajax_terceros_ant_190422_validate_dias()
  {
    var nomeCampo_dias = "dias";
    var var_dias = scAjaxGetFieldText(nomeCampo_dias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_dias(var_dias, var_script_case_init, do_ajax_terceros_ant_190422_validate_dias_cb);
  } // do_ajax_terceros_ant_190422_validate_dias

  function do_ajax_terceros_ant_190422_validate_dias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "dias";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_dias_cb

  // ---------- Validate url
  function do_ajax_terceros_ant_190422_validate_url()
  {
    var nomeCampo_url = "url";
    var var_url = scAjaxGetFieldText(nomeCampo_url);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_url(var_url, var_script_case_init, do_ajax_terceros_ant_190422_validate_url_cb);
  } // do_ajax_terceros_ant_190422_validate_url

  function do_ajax_terceros_ant_190422_validate_url_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "url";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_url_cb

  // ---------- Validate contacto
  function do_ajax_terceros_ant_190422_validate_contacto()
  {
    var nomeCampo_contacto = "contacto";
    var var_contacto = scAjaxGetFieldText(nomeCampo_contacto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_contacto(var_contacto, var_script_case_init, do_ajax_terceros_ant_190422_validate_contacto_cb);
  } // do_ajax_terceros_ant_190422_validate_contacto

  function do_ajax_terceros_ant_190422_validate_contacto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_contacto_cb

  // ---------- Validate telefonos_prov
  function do_ajax_terceros_ant_190422_validate_telefonos_prov()
  {
    var nomeCampo_telefonos_prov = "telefonos_prov";
    var var_telefonos_prov = scAjaxGetFieldText(nomeCampo_telefonos_prov);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_telefonos_prov(var_telefonos_prov, var_script_case_init, do_ajax_terceros_ant_190422_validate_telefonos_prov_cb);
  } // do_ajax_terceros_ant_190422_validate_telefonos_prov

  function do_ajax_terceros_ant_190422_validate_telefonos_prov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_telefonos_prov_cb

  // ---------- Validate email
  function do_ajax_terceros_ant_190422_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_email(var_email, var_script_case_init, do_ajax_terceros_ant_190422_validate_email_cb);
  } // do_ajax_terceros_ant_190422_validate_email

  function do_ajax_terceros_ant_190422_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_email_cb

  // ---------- Validate fechultcomp
  function do_ajax_terceros_ant_190422_validate_fechultcomp()
  {
    var nomeCampo_fechultcomp = "fechultcomp";
    var var_fechultcomp = scAjaxGetFieldHidden(nomeCampo_fechultcomp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_fechultcomp(var_fechultcomp, var_script_case_init, do_ajax_terceros_ant_190422_validate_fechultcomp_cb);
  } // do_ajax_terceros_ant_190422_validate_fechultcomp

  function do_ajax_terceros_ant_190422_validate_fechultcomp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_fechultcomp_cb

  // ---------- Validate saldoapagar
  function do_ajax_terceros_ant_190422_validate_saldoapagar()
  {
    var nomeCampo_saldoapagar = "saldoapagar";
    var var_saldoapagar = scAjaxGetFieldHidden(nomeCampo_saldoapagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_saldoapagar(var_saldoapagar, var_script_case_init, do_ajax_terceros_ant_190422_validate_saldoapagar_cb);
  } // do_ajax_terceros_ant_190422_validate_saldoapagar

  function do_ajax_terceros_ant_190422_validate_saldoapagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_saldoapagar_cb

  // ---------- Validate codigo_ter
  function do_ajax_terceros_ant_190422_validate_codigo_ter()
  {
    var nomeCampo_codigo_ter = "codigo_ter";
    var var_codigo_ter = scAjaxGetFieldText(nomeCampo_codigo_ter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_codigo_ter(var_codigo_ter, var_script_case_init, do_ajax_terceros_ant_190422_validate_codigo_ter_cb);
  } // do_ajax_terceros_ant_190422_validate_codigo_ter

  function do_ajax_terceros_ant_190422_validate_codigo_ter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_codigo_ter_cb

  // ---------- Validate zona_clientes
  function do_ajax_terceros_ant_190422_validate_zona_clientes()
  {
    var nomeCampo_zona_clientes = "zona_clientes";
    var var_zona_clientes = scAjaxGetFieldSelect(nomeCampo_zona_clientes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_zona_clientes(var_zona_clientes, var_script_case_init, do_ajax_terceros_ant_190422_validate_zona_clientes_cb);
  } // do_ajax_terceros_ant_190422_validate_zona_clientes

  function do_ajax_terceros_ant_190422_validate_zona_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_zona_clientes_cb

  // ---------- Validate clasificacion_clientes
  function do_ajax_terceros_ant_190422_validate_clasificacion_clientes()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_clasificacion_clientes(var_clasificacion_clientes, var_script_case_init, do_ajax_terceros_ant_190422_validate_clasificacion_clientes_cb);
  } // do_ajax_terceros_ant_190422_validate_clasificacion_clientes

  function do_ajax_terceros_ant_190422_validate_clasificacion_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_clasificacion_clientes_cb

  // ---------- Validate puc_auxiliar_deudores
  function do_ajax_terceros_ant_190422_validate_puc_auxiliar_deudores()
  {
  } // do_ajax_terceros_ant_190422_validate_puc_auxiliar_deudores

  function do_ajax_terceros_ant_190422_validate_puc_auxiliar_deudores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_puc_auxiliar_deudores_cb

  // ---------- Validate puc_retefuente_ventas
  function do_ajax_terceros_ant_190422_validate_puc_retefuente_ventas()
  {
  } // do_ajax_terceros_ant_190422_validate_puc_retefuente_ventas

  function do_ajax_terceros_ant_190422_validate_puc_retefuente_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_puc_retefuente_ventas_cb

  // ---------- Validate puc_retefuente_servicios_clie
  function do_ajax_terceros_ant_190422_validate_puc_retefuente_servicios_clie()
  {
  } // do_ajax_terceros_ant_190422_validate_puc_retefuente_servicios_clie

  function do_ajax_terceros_ant_190422_validate_puc_retefuente_servicios_clie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_puc_retefuente_servicios_clie_cb

  // ---------- Validate puc_auxiliar_proveedores
  function do_ajax_terceros_ant_190422_validate_puc_auxiliar_proveedores()
  {
  } // do_ajax_terceros_ant_190422_validate_puc_auxiliar_proveedores

  function do_ajax_terceros_ant_190422_validate_puc_auxiliar_proveedores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_puc_auxiliar_proveedores_cb

  // ---------- Validate puc_retefuente_compras
  function do_ajax_terceros_ant_190422_validate_puc_retefuente_compras()
  {
  } // do_ajax_terceros_ant_190422_validate_puc_retefuente_compras

  function do_ajax_terceros_ant_190422_validate_puc_retefuente_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_puc_retefuente_compras_cb

  // ---------- Validate puc_retefuente_servicios_prov
  function do_ajax_terceros_ant_190422_validate_puc_retefuente_servicios_prov()
  {
  } // do_ajax_terceros_ant_190422_validate_puc_retefuente_servicios_prov

  function do_ajax_terceros_ant_190422_validate_puc_retefuente_servicios_prov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_puc_retefuente_servicios_prov_cb

  // ---------- Validate archivo_cedula
  function do_ajax_terceros_ant_190422_validate_archivo_cedula()
  {
    var nomeCampo_archivo_cedula = "archivo_cedula";
    var var_archivo_cedula = scAjaxGetFieldText(nomeCampo_archivo_cedula);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_archivo_cedula(var_archivo_cedula, var_script_case_init, do_ajax_terceros_ant_190422_validate_archivo_cedula_cb);
  } // do_ajax_terceros_ant_190422_validate_archivo_cedula

  function do_ajax_terceros_ant_190422_validate_archivo_cedula_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_archivo_cedula_cb

  // ---------- Validate archivo_rut
  function do_ajax_terceros_ant_190422_validate_archivo_rut()
  {
    var nomeCampo_archivo_rut = "archivo_rut";
    var var_archivo_rut = scAjaxGetFieldText(nomeCampo_archivo_rut);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_archivo_rut(var_archivo_rut, var_script_case_init, do_ajax_terceros_ant_190422_validate_archivo_rut_cb);
  } // do_ajax_terceros_ant_190422_validate_archivo_rut

  function do_ajax_terceros_ant_190422_validate_archivo_rut_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_archivo_rut_cb

  // ---------- Validate archivo_nit
  function do_ajax_terceros_ant_190422_validate_archivo_nit()
  {
    var nomeCampo_archivo_nit = "archivo_nit";
    var var_archivo_nit = scAjaxGetFieldText(nomeCampo_archivo_nit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_archivo_nit(var_archivo_nit, var_script_case_init, do_ajax_terceros_ant_190422_validate_archivo_nit_cb);
  } // do_ajax_terceros_ant_190422_validate_archivo_nit

  function do_ajax_terceros_ant_190422_validate_archivo_nit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_archivo_nit_cb

  // ---------- Validate archivo_pago
  function do_ajax_terceros_ant_190422_validate_archivo_pago()
  {
    var nomeCampo_archivo_pago = "archivo_pago";
    var var_archivo_pago = scAjaxGetFieldText(nomeCampo_archivo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_archivo_pago(var_archivo_pago, var_script_case_init, do_ajax_terceros_ant_190422_validate_archivo_pago_cb);
  } // do_ajax_terceros_ant_190422_validate_archivo_pago

  function do_ajax_terceros_ant_190422_validate_archivo_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_archivo_pago_cb

  // ---------- Validate id_plan
  function do_ajax_terceros_ant_190422_validate_id_plan()
  {
    var nomeCampo_id_plan = "id_plan";
    var var_id_plan = scAjaxGetFieldSelect(nomeCampo_id_plan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_id_plan(var_id_plan, var_script_case_init, do_ajax_terceros_ant_190422_validate_id_plan_cb);
  } // do_ajax_terceros_ant_190422_validate_id_plan

  function do_ajax_terceros_ant_190422_validate_id_plan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_plan";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_id_plan_cb

  // ---------- Validate valor_plan
  function do_ajax_terceros_ant_190422_validate_valor_plan()
  {
    var nomeCampo_valor_plan = "valor_plan";
    var var_valor_plan = scAjaxGetFieldText(nomeCampo_valor_plan);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_valor_plan(var_valor_plan, var_script_case_init, do_ajax_terceros_ant_190422_validate_valor_plan_cb);
  } // do_ajax_terceros_ant_190422_validate_valor_plan

  function do_ajax_terceros_ant_190422_validate_valor_plan_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_valor_plan_cb

  // ---------- Validate fecha_registro_fe
  function do_ajax_terceros_ant_190422_validate_fecha_registro_fe()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_fecha_registro_fe(var_fecha_registro_fe, var_script_case_init, do_ajax_terceros_ant_190422_validate_fecha_registro_fe_cb);
  } // do_ajax_terceros_ant_190422_validate_fecha_registro_fe

  function do_ajax_terceros_ant_190422_validate_fecha_registro_fe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_fecha_registro_fe_cb

  // ---------- Validate nombre_contador
  function do_ajax_terceros_ant_190422_validate_nombre_contador()
  {
    var nomeCampo_nombre_contador = "nombre_contador";
    var var_nombre_contador = scAjaxGetFieldText(nomeCampo_nombre_contador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_nombre_contador(var_nombre_contador, var_script_case_init, do_ajax_terceros_ant_190422_validate_nombre_contador_cb);
  } // do_ajax_terceros_ant_190422_validate_nombre_contador

  function do_ajax_terceros_ant_190422_validate_nombre_contador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_nombre_contador_cb

  // ---------- Validate estado
  function do_ajax_terceros_ant_190422_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_estado(var_estado, var_script_case_init, do_ajax_terceros_ant_190422_validate_estado_cb);
  } // do_ajax_terceros_ant_190422_validate_estado

  function do_ajax_terceros_ant_190422_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_estado_cb

  // ---------- Validate si_nomina
  function do_ajax_terceros_ant_190422_validate_si_nomina()
  {
    var nomeCampo_si_nomina = "si_nomina";
    var var_si_nomina = scAjaxGetFieldCheckbox(nomeCampo_si_nomina, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_si_nomina(var_si_nomina, var_script_case_init, do_ajax_terceros_ant_190422_validate_si_nomina_cb);
  } // do_ajax_terceros_ant_190422_validate_si_nomina

  function do_ajax_terceros_ant_190422_validate_si_nomina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_si_nomina_cb

  // ---------- Validate n_trabajadores
  function do_ajax_terceros_ant_190422_validate_n_trabajadores()
  {
    var nomeCampo_n_trabajadores = "n_trabajadores";
    var var_n_trabajadores = scAjaxGetFieldText(nomeCampo_n_trabajadores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_n_trabajadores(var_n_trabajadores, var_script_case_init, do_ajax_terceros_ant_190422_validate_n_trabajadores_cb);
  } // do_ajax_terceros_ant_190422_validate_n_trabajadores

  function do_ajax_terceros_ant_190422_validate_n_trabajadores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_n_trabajadores_cb

  // ---------- Validate si_factura_electronica
  function do_ajax_terceros_ant_190422_validate_si_factura_electronica()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_si_factura_electronica(var_si_factura_electronica, var_script_case_init, do_ajax_terceros_ant_190422_validate_si_factura_electronica_cb);
  } // do_ajax_terceros_ant_190422_validate_si_factura_electronica

  function do_ajax_terceros_ant_190422_validate_si_factura_electronica_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_si_factura_electronica_cb

  // ---------- Validate nombre_empresa_bd
  function do_ajax_terceros_ant_190422_validate_nombre_empresa_bd()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_nombre_empresa_bd(var_nombre_empresa_bd, var_script_case_init, do_ajax_terceros_ant_190422_validate_nombre_empresa_bd_cb);
  } // do_ajax_terceros_ant_190422_validate_nombre_empresa_bd

  function do_ajax_terceros_ant_190422_validate_nombre_empresa_bd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_nombre_empresa_bd_cb

  // ---------- Validate archivos
  function do_ajax_terceros_ant_190422_validate_archivos()
  {
    var nomeCampo_archivos = "archivos";
    var var_archivos = scAjaxGetFieldText(nomeCampo_archivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_archivos(var_archivos, var_script_case_init, do_ajax_terceros_ant_190422_validate_archivos_cb);
  } // do_ajax_terceros_ant_190422_validate_archivos

  function do_ajax_terceros_ant_190422_validate_archivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_archivos_cb

  // ---------- Validate es_restaurante
  function do_ajax_terceros_ant_190422_validate_es_restaurante()
  {
    var nomeCampo_es_restaurante = "es_restaurante";
    var var_es_restaurante = scAjaxGetFieldCheckbox(nomeCampo_es_restaurante, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_es_restaurante(var_es_restaurante, var_script_case_init, do_ajax_terceros_ant_190422_validate_es_restaurante_cb);
  } // do_ajax_terceros_ant_190422_validate_es_restaurante

  function do_ajax_terceros_ant_190422_validate_es_restaurante_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_es_restaurante_cb

  // ---------- Validate porcentaje_propina_sugerida
  function do_ajax_terceros_ant_190422_validate_porcentaje_propina_sugerida()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_terceros_ant_190422_validate_porcentaje_propina_sugerida(var_porcentaje_propina_sugerida, var_script_case_init, do_ajax_terceros_ant_190422_validate_porcentaje_propina_sugerida_cb);
  } // do_ajax_terceros_ant_190422_validate_porcentaje_propina_sugerida

  function do_ajax_terceros_ant_190422_validate_porcentaje_propina_sugerida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_validate_porcentaje_propina_sugerida_cb

  // ---------- Refresh departamento
  function do_ajax_terceros_ant_190422_refresh_departamento()
  {
    var var_departamento = scAjaxGetFieldSelect("departamento");
    var var_nmgp_refresh_fields = "idmuni";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_refresh_departamento(var_departamento, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_ant_190422_refresh_departamento_cb);
  } // do_ajax_terceros_ant_190422_refresh_departamento

  function do_ajax_terceros_ant_190422_refresh_departamento_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_terceros_ant_190422_refresh_idmuni();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_refresh_departamento_cb

  // ---------- Refresh idmuni
  function do_ajax_terceros_ant_190422_refresh_idmuni()
  {
    var var_idmuni = scAjaxGetFieldSelect("idmuni");
    var var_nmgp_refresh_fields = "ciudad_#fld#_codigo_postal";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_refresh_idmuni(var_idmuni, var_nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_ant_190422_refresh_idmuni_cb);
  } // do_ajax_terceros_ant_190422_refresh_idmuni

  function do_ajax_terceros_ant_190422_refresh_idmuni_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_terceros_ant_190422_refresh_idmuni_cb

  // ---------- Event onchange apellido1
  function do_ajax_terceros_ant_190422_event_apellido1_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_apellido1 = scAjaxGetFieldText("apellido1");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_apellido1_onchange(var_nombre1, var_apellido1, var_script_case_init, do_ajax_terceros_ant_190422_event_apellido1_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_apellido1_onchange

  function do_ajax_terceros_ant_190422_event_apellido1_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apellido1";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_apellido1_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_apellido1_onchange_cb
  function do_ajax_terceros_ant_190422_event_apellido1_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_apellido1_onchange_cb_after_alert

  // ---------- Event onchange apellido2
  function do_ajax_terceros_ant_190422_event_apellido2_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_apellido2 = scAjaxGetFieldText("apellido2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_apellido2_onchange(var_nombre1, var_apellido2, var_script_case_init, do_ajax_terceros_ant_190422_event_apellido2_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_apellido2_onchange

  function do_ajax_terceros_ant_190422_event_apellido2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apellido2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_apellido2_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_apellido2_onchange_cb
  function do_ajax_terceros_ant_190422_event_apellido2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_apellido2_onchange_cb_after_alert

  // ---------- Event onchange cliente
  function do_ajax_terceros_ant_190422_event_cliente_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_cliente_onchange(var_idtercero, var_cliente, var_credito, var_cupodis, var_cupo, var_efec_retencion, var_listaprecios, var_loatiende, var_proveedor, var_script_case_init, do_ajax_terceros_ant_190422_event_cliente_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_cliente_onchange

  function do_ajax_terceros_ant_190422_event_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_cliente_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_cliente_onchange_cb
  function do_ajax_terceros_ant_190422_event_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_cliente_onchange_cb_after_alert

  // ---------- Event onchange credito
  function do_ajax_terceros_ant_190422_event_credito_onchange()
  {
    var var_credito = scAjaxGetFieldSelect("credito");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_credito_onchange(var_credito, var_dias_credito, var_dias_mora, var_cupo, var_cupodis, var_script_case_init, do_ajax_terceros_ant_190422_event_credito_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_credito_onchange

  function do_ajax_terceros_ant_190422_event_credito_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "credito";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_credito_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_credito_onchange_cb
  function do_ajax_terceros_ant_190422_event_credito_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_credito_onchange_cb_after_alert

  // ---------- Event onchange creditoprov
  function do_ajax_terceros_ant_190422_event_creditoprov_onchange()
  {
    var var_creditoprov = scAjaxGetFieldSelect("creditoprov");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_creditoprov_onchange(var_creditoprov, var_script_case_init, do_ajax_terceros_ant_190422_event_creditoprov_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_creditoprov_onchange

  function do_ajax_terceros_ant_190422_event_creditoprov_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "creditoprov";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_creditoprov_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_creditoprov_onchange_cb
  function do_ajax_terceros_ant_190422_event_creditoprov_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_creditoprov_onchange_cb_after_alert

  // ---------- Event onchange cupo
  function do_ajax_terceros_ant_190422_event_cupo_onchange()
  {
    var var_cupodis = scAjaxGetFieldText("cupodis");
    var var_cupo = scAjaxGetFieldText("cupo");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_cupo_onchange(var_cupodis, var_cupo, var_saldo, var_script_case_init, do_ajax_terceros_ant_190422_event_cupo_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_cupo_onchange

  function do_ajax_terceros_ant_190422_event_cupo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cupo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_cupo_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_cupo_onchange_cb
  function do_ajax_terceros_ant_190422_event_cupo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_cupo_onchange_cb_after_alert

  // ---------- Event onchange documento
  function do_ajax_terceros_ant_190422_event_documento_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_documento_onchange(var_tipo_documento, var_dv, var_documento, var_script_case_init, do_ajax_terceros_ant_190422_event_documento_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_documento_onchange

  function do_ajax_terceros_ant_190422_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_documento_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_documento_onchange_cb
  function do_ajax_terceros_ant_190422_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_documento_onchange_cb_after_alert

  // ---------- Event onchange nombre1
  function do_ajax_terceros_ant_190422_event_nombre1_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_nombre1_onchange(var_nombre1, var_script_case_init, do_ajax_terceros_ant_190422_event_nombre1_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_nombre1_onchange

  function do_ajax_terceros_ant_190422_event_nombre1_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre1";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_nombre1_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_nombre1_onchange_cb
  function do_ajax_terceros_ant_190422_event_nombre1_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_nombre1_onchange_cb_after_alert

  // ---------- Event onchange nombre2
  function do_ajax_terceros_ant_190422_event_nombre2_onchange()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_nombre2 = scAjaxGetFieldText("nombre2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_nombre2_onchange(var_nombre1, var_nombre2, var_script_case_init, do_ajax_terceros_ant_190422_event_nombre2_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_nombre2_onchange

  function do_ajax_terceros_ant_190422_event_nombre2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_nombre2_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_nombre2_onchange_cb
  function do_ajax_terceros_ant_190422_event_nombre2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_nombre2_onchange_cb_after_alert

  // ---------- Event onchange nombre_comercil
  function do_ajax_terceros_ant_190422_event_nombre_comercil_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_nombre_comercil_onchange(var_tipo, var_nombres, var_nombre_comercil, var_script_case_init, do_ajax_terceros_ant_190422_event_nombre_comercil_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_nombre_comercil_onchange

  function do_ajax_terceros_ant_190422_event_nombre_comercil_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombre_comercil";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_nombre_comercil_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_nombre_comercil_onchange_cb
  function do_ajax_terceros_ant_190422_event_nombre_comercil_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_nombre_comercil_onchange_cb_after_alert

  // ---------- Event onblur nombres
  function do_ajax_terceros_ant_190422_event_nombres_onblur()
  {
    var var_nombres = scAjaxGetFieldHidden("nombres");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_nombres_onblur(var_nombres, var_script_case_init, do_ajax_terceros_ant_190422_event_nombres_onblur_cb);
  } // do_ajax_terceros_ant_190422_event_nombres_onblur

  function do_ajax_terceros_ant_190422_event_nombres_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombres";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_nombres_onblur_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_nombres_onblur_cb
  function do_ajax_terceros_ant_190422_event_nombres_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_nombres_onblur_cb_after_alert

  // ---------- Event onfocus nombres
  function do_ajax_terceros_ant_190422_event_nombres_onfocus()
  {
    var var_nombre1 = scAjaxGetFieldText("nombre1");
    var var_nombres = scAjaxGetFieldHidden("nombres");
    var var_nombre2 = scAjaxGetFieldText("nombre2");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_terceros_ant_190422_event_nombres_onfocus(var_nombre1, var_nombres, var_nombre2, var_apellido1, var_apellido2, var_tipo, var_script_case_init, do_ajax_terceros_ant_190422_event_nombres_onfocus_cb);
  } // do_ajax_terceros_ant_190422_event_nombres_onfocus

  function do_ajax_terceros_ant_190422_event_nombres_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "nombres";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_nombres_onfocus_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_nombres_onfocus_cb
  function do_ajax_terceros_ant_190422_event_nombres_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_nombres_onfocus_cb_after_alert

  // ---------- Event onchange proveedor
  function do_ajax_terceros_ant_190422_event_proveedor_onchange()
  {
    var var_proveedor = scAjaxGetFieldCheckbox("proveedor", ";");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_proveedor_onchange(var_proveedor, var_autoretenedor, var_creditoprov, var_dias, var_script_case_init, do_ajax_terceros_ant_190422_event_proveedor_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_proveedor_onchange

  function do_ajax_terceros_ant_190422_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "proveedor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_proveedor_onchange_cb
  function do_ajax_terceros_ant_190422_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_proveedor_onchange_cb_after_alert

  // ---------- Event onchange r_social
  function do_ajax_terceros_ant_190422_event_r_social_onchange()
  {
    var var_tipo = scAjaxGetFieldSelect("tipo");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_r_social_onchange(var_tipo, var_r_social, var_nombre2, var_apellido2, var_nombres, var_nombre1, var_apellido1, var_script_case_init, do_ajax_terceros_ant_190422_event_r_social_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_r_social_onchange

  function do_ajax_terceros_ant_190422_event_r_social_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "r_social";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_r_social_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_r_social_onchange_cb
  function do_ajax_terceros_ant_190422_event_r_social_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_r_social_onchange_cb_after_alert

  // ---------- Event onchange regimen
  function do_ajax_terceros_ant_190422_event_regimen_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_regimen_onchange(var_regimen, var_tipo_documento, var_dv, var_documento, var_script_case_init, do_ajax_terceros_ant_190422_event_regimen_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_regimen_onchange

  function do_ajax_terceros_ant_190422_event_regimen_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "regimen";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_regimen_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_regimen_onchange_cb
  function do_ajax_terceros_ant_190422_event_regimen_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_regimen_onchange_cb_after_alert

  // ---------- Event onchange sucur_cliente
  function do_ajax_terceros_ant_190422_event_sucur_cliente_onchange()
  {
    var var_idtercero = scAjaxGetFieldHidden("idtercero");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_sucur_cliente_onchange(var_idtercero, var_sucur_cliente, var_idmuni, var_direccion, var_tel_cel, var_script_case_init, do_ajax_terceros_ant_190422_event_sucur_cliente_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_sucur_cliente_onchange

  function do_ajax_terceros_ant_190422_event_sucur_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sucur_cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_sucur_cliente_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_sucur_cliente_onchange_cb
  function do_ajax_terceros_ant_190422_event_sucur_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_sucur_cliente_onchange_cb_after_alert

  // ---------- Event onchange tipo_documento
  function do_ajax_terceros_ant_190422_event_tipo_documento_onchange()
  {
    var var_tipo_documento = scAjaxGetFieldSelect("tipo_documento");
    var var_dv = scAjaxGetFieldText("dv");
    var var_documento = scAjaxGetFieldText("documento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_tipo_documento_onchange(var_tipo_documento, var_dv, var_documento, var_script_case_init, do_ajax_terceros_ant_190422_event_tipo_documento_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_tipo_documento_onchange

  function do_ajax_terceros_ant_190422_event_tipo_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo_documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_tipo_documento_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_tipo_documento_onchange_cb
  function do_ajax_terceros_ant_190422_event_tipo_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_tipo_documento_onchange_cb_after_alert

  // ---------- Event onchange tipo
  function do_ajax_terceros_ant_190422_event_tipo_onchange()
  {
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_regimen = scAjaxGetFieldSelect("regimen");
    var var_efec_retencion = scAjaxGetFieldSelect("efec_retencion");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_terceros_ant_190422_event_tipo_onchange(var_tipo, var_regimen, var_efec_retencion, var_tipo_documento, var_nombre_comercil, var_representante, var_nombre1, var_apellido1, var_nombre2, var_apellido2, var_r_social, var_documento, var_dv, var_script_case_init, do_ajax_terceros_ant_190422_event_tipo_onchange_cb);
  } // do_ajax_terceros_ant_190422_event_tipo_onchange

  function do_ajax_terceros_ant_190422_event_tipo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_terceros_ant_190422_event_tipo_onchange_cb_after_alert);
  } // do_ajax_terceros_ant_190422_event_tipo_onchange_cb
  function do_ajax_terceros_ant_190422_event_tipo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_terceros_ant_190422_event_tipo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_terceros_ant_190422_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_terceros_ant_190422_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_tipo = scAjaxGetFieldSelect("tipo");
  ...
  function do_ajax_terceros_ant_190422_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_terceros_ant_190422_submit_form_cb_after_alert);
  } // do_ajax_terceros_ant_190422_submit_form_cb
  function do_ajax_terceros_ant_190422_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_terceros_ant_190422_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_gestor_archivos_tercero"] = "off";

  function do_ajax_terceros_ant_190422_navigate_form()
  {
    perform_ajax_terceros_ant_190422_navigate_form();
  }

  function perform_ajax_terceros_ant_190422_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_terceros_ant_190422_navigate_form(var_idtercero, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_terceros_ant_190422_navigate_form_cb);
  } // do_ajax_terceros_ant_190422_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['terceros_ant_190422']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_terceros_ant_190422_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_terceros_ant_190422_navigate_form_cb_after_alert);
  } // do_ajax_terceros_ant_190422_navigate_form_cb
  function do_ajax_terceros_ant_190422_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_terceros_ant_190422_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
    scAjaxProcOff();
  } // do_ajax_terceros_ant_190422_navigate_form_cb_after_alert
  function sc_hide_terceros_ant_190422_form()
  {
  ...
  function do_ajax_terceros_ant_190422_lkpedt_refresh_zona_clientes()
  {
    var var_zona_clientes = scAjaxGetFieldSelect("zona_clientes");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "zona_clientes";
    x_ajax_terceros_ant_190422_lkpedt_refresh_zona_clientes(var_zona_clientes, nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_ant_190422_lkpedt_refresh_zona_clientes_cb);
  } // do_ajax_terceros_ant_190422_lkpedt_refresh_zona_clientes

  function do_ajax_terceros_ant_190422_lkpedt_refresh_zona_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_terceros_ant_190422_lkpedt_refresh_zona_clientes_cb

  function do_ajax_terceros_ant_190422_lkpedt_refresh_clasificacion_clientes()
  {
    var var_clasificacion_clientes = scAjaxGetFieldSelect("clasificacion_clientes");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "clasificacion_clientes";
    x_ajax_terceros_ant_190422_lkpedt_refresh_clasificacion_clientes(var_clasificacion_clientes, nmgp_refresh_fields, var_script_case_init, do_ajax_terceros_ant_190422_lkpedt_refresh_clasificacion_clientes_cb);
  } // do_ajax_terceros_ant_190422_lkpedt_refresh_clasificacion_clientes

  function do_ajax_terceros_ant_190422_lkpedt_refresh_clasificacion_clientes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_terceros_ant_190422_lkpedt_refresh_clasificacion_clientes_cb
