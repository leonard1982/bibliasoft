...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_numeric[] = "id_pago";$Nm_numeric[] = "numero";$Nm_numeric[] = "total";$Nm_numeric[] = "descuento";$Nm_numeric[] = "neto";$Nm_numeric[] = "usuario";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pagado_a"  <?php echo $str_hide_pagado_a?>><?php
      if ($pagado_a != "")
      {
      $pagado_a_look = substr($this->Db->qstr($pagado_a), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_pagador"  <?php echo $str_hide_pagador?>>
<?php
