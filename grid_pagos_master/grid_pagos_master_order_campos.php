...
<?php
   ...
   $Ord_Cmp = new grid_pagos_master_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pagos_master_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["prefijo"] : "Prefijo";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["numero"] : "Numero";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['pagado_a'] = "on";
   $tab_def_campos['pagado_a'] = "pagado_a";
   $tab_labels["pagado_a"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["pagado_a"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["pagado_a"] : "Pagado a";
   $tab_ger_campos['pagador'] = "on";
   $tab_def_campos['pagador'] = "pagador";
   $tab_labels["pagador"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["pagador"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["pagador"] : "Pagador";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["total"] : "Total";
   $tab_ger_campos['descuento'] = "on";
   $tab_def_campos['descuento'] = "descuento";
   $tab_labels["descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["descuento"] : "Descuento";
   $tab_ger_campos['neto'] = "on";
   $tab_def_campos['neto'] = "neto";
   $tab_labels["neto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["neto"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['labels']["neto"] : "Neto";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pagos_master_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pagos_master']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
