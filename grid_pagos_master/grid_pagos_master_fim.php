...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_pagos_master"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_pagos_master"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pagos_master'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pagos_master']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pagos_master']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pagos_master']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pagos_master']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pagos_master']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pagos_master']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pagos_master']['embutida_filho'] as $ind => $sc_init)
          {
