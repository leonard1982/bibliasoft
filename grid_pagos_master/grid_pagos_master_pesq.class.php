...
class grid_pagos_master_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_pagos_master_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_pagos_master_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_pagos_master_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_pagado_a')
      {
          $pagado_a = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_pagado_a($pagado_a);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_pagado_a($pagado_a)
   {
      $pagado_a = substr($this->Db->qstr($pagado_a), 1, -1);
            $pagado_a_look = substr($this->Db->qstr($pagado_a), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "select documento, documento + ' - ' + nombres from terceros where  documento + ' - ' + nombres like '%" . $pagado_a . "%' order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select documento, concat(documento,' - ',nombres) from terceros where  concat(documento,' - ',nombres) like '%" . $pagado_a . "%' order by documento, nombres" ; 
      } 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_pagos_master/grid_pagos_master_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_pagos_master_ajax_search.js"></script>
 <script type="text/javascript" src="grid_pagos_master_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_pagos_master_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pagos_master']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pagos_master']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_pagado_a_cond#NMF#' + search_get_sel_txt('SC_pagado_a_cond') + '@NMF@';
  str_out += 'SC_pagado_a#NMF#' + search_get_text('SC_pagado_a') + '@NMF@';
  str_out += 'id_ac_pagado_a#NMF#' + search_get_text('id_ac_pagado_a') + '@NMF@';
  str_out += 'SC_pagador_cond#NMF#' + search_get_sel_txt('SC_pagador_cond') + '@NMF@';
  str_out += 'SC_pagador#NMF#' + search_get_select('SC_pagador') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-numero").on("focus", function() {
   ...
   scClass = $("#id_ac_pagado_a").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_pagado_a").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          q: request.term,
          nmgp_opcao: "ajax_autocomp",
          nmgp_parms: "NM_ajax_opcao?#?autocomp_pagado_a",
          max_itens: "10",
          cod_desc: "N",
          script_case_init: <?php echo $this->Ini->sc_page ?>
        },
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Lista Pagos</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__currency_dollar_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $pagado_a_cond, $pagado_a, $pagado_a_autocomp,
             $pagador_cond, $pagador,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pagos_master']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_pagos_master']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_pagos_master']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_pagos_master", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $prefijo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['prefijo']; 
          $prefijo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['prefijo_cond']; 
          $numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['numero']; 
          $numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['numero_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_cond']; 
          $concepto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['concepto']; 
          $concepto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['concepto_cond']; 
          $pagado_a = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['pagado_a']; 
          $pagado_a_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['pagado_a_cond']; 
          $pagador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['pagador']; 
          $pagador_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['pagador_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($pagado_a_cond) || empty($pagado_a_cond))
      {
         $pagado_a_cond = "eq";
      }
      if (!isset($pagador_cond) || empty($pagador_cond))
      {
         $pagador_cond = "eq";
      }
      ...
      $str_hide_pagado_a = (in_array($pagado_a_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_pagador = (in_array($pagador_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_pagado_a = ('bw' == $pagado_a_cond) ? $display_aberto : $display_fechado;
      $str_display_pagador = ('bw' == $pagador_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($pagado_a) || $pagado_a == "")
      {
          $pagado_a = "";
      }
      if (isset($pagado_a) && !empty($pagado_a))
      {
         $tmp_pos = strpos($pagado_a, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pagado_a = substr($pagado_a, 0, $tmp_pos);
         }
      }
      if (!isset($pagador) || $pagador == "")
      {
          $pagador = "";
      }
      if (isset($pagador) && !empty($pagador))
      {
         $tmp_pos = strpos($pagador, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $pagador = substr($pagador, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['psq_check_ret']['prefijo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['psq_check_ret']['prefijo'][] = trim($rs->fields[0]);
...
?>
<INPUT  type="text" id="SC_numero" name="numero" value="<?php echo NM_encode_input($numero) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
...
?>
      ...
      <INPUT type="hidden" id="SC_concepto_cond" name="concepto_cond" value="qp">
...
?>
<INPUT  type="text" id="SC_concepto" name="concepto" value="<?php echo NM_encode_input($concepto) ?>"  size=50 alt="{datatype: 'text', maxLength: 300, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-concepto" id="id_ac_concepto" name="concepto_autocomp"><?php if ('' !=  $concepto) { ?><option value="<?php echo $concepto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_pagado_a_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pagado_a'])) ? $this->New_label['pagado_a'] : "Pagado a"; ?></TD>
      
      <INPUT type="hidden" id="SC_pagado_a_cond" name="pagado_a_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pagado_a" <?php echo $str_hide_pagado_a?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['pagado_a'])) ? $this->New_label['pagado_a'] : "Pagado a";
 $nmgp_tab_label .= "pagado_a?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "select documento, documento + ' - ' + nombres from terceros where documento = '$pagado_a_look' order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select documento, concat(documento,' - ',nombres) from terceros where documento = '$pagado_a_look' order by documento, nombres" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select documento, documento&' - '&nombres from terceros where documento = '$pagado_a_look' order by documento, nombres" ; 
      ...
      if (isset($nmgp_def_dados[0][$pagado_a]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$pagado_a];
      }
      else
      {
          $sAutocompValue = $pagado_a;
      }
?>
<INPUT  type="text" id="SC_pagado_a" name="pagado_a" value="<?php echo NM_encode_input($pagado_a) ?>"  size=14 alt="{datatype: 'text', maxLength: 14, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_pagado_a" name="pagado_a_autocomp" size="60"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_pagador_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['pagador'])) ? $this->New_label['pagador'] : "Pagador"; ?></TD>
      
      <INPUT type="hidden" id="SC_pagador_cond" name="pagador_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_pagador" <?php echo $str_hide_pagador?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['pagador'])) ? $this->New_label['pagador'] : "Pagador";
 $nmgp_tab_label .= "pagador?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $pagador_look = substr($this->Db->qstr($pagador), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['psq_check_ret']['pagador'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['psq_check_ret']['pagador'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_pagador">
      <SELECT class="scFilterObjectEven" id="SC_pagador" name="pagador"  size="1">
       <OPTION value="">SELECCIONE</OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $pagador)
            {
                    $pagador_sel = ($nm_opc_cod === $pagador) ? "selected" : "";
            }
            else
            {
               $pagador_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $pagador_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
   if (is_file("grid_pagos_master_help.txt"))
   {
      $Arq_WebHelp = file("grid_pagos_master_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pagos_master']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pagos_master']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.concepto_cond.value = 'qp';
   ...
   document.F1.pagado_a_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_pagado_a'), document.F1.pagado_a_cond, 'pagado_a');
   document.F1.pagado_a.value = "";
   document.F1.pagado_a_autocomp.value = "";
   document.F1.pagador_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_pagador'), document.F1.pagador_cond, 'pagador');
   document.F1.pagador.value = "";
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    ...
    if (Field == 'all' || Field == 'pagador') {
       Sc_carga_select2_pagador();
    }
 }
 ...
 function Sc_carga_select2_pagador()
 {
  $("#SC_pagador").select2(
    {
      language: {
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_pagos_master_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_pagos_master_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_pagos_master_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_pagos_master_valida_mes(this)});
 }
 function sc_grid_pagos_master_valida_dia(obj)
 {
 ...
 function sc_grid_pagos_master_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_pagos_master";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_pagado_a_cond'] = 'cond';
      $tp_fields['SC_pagado_a'] = 'text_aut';
      $tp_fields['id_ac_pagado_a'] = 'text_aut';
      $tp_fields['SC_pagador_cond'] = 'cond';
      $tp_fields['SC_pagador'] = 'select';
   ...
   function trata_campos()
   {
      global $prefijo_cond, $prefijo,
             ...
             $concepto_cond, $concepto, $concepto_autocomp,
             $pagado_a_cond, $pagado_a, $pagado_a_autocomp,
             $pagador_cond, $pagador, $nmgp_tab_label;
      ...
      if (!empty($pagado_a_autocomp) && empty($pagado_a))
      {
          $pagado_a = $pagado_a_autocomp;
      }
      ...
      $pagado_a_cond_salva = $pagado_a_cond; 
      if (!isset($pagado_a_input_2) || $pagado_a_input_2 == "")
      {
          $pagado_a_input_2 = $pagado_a;
      }
      $pagador_cond_salva = $pagador_cond; 
      if (!isset($pagador_input_2) || $pagador_input_2 == "")
      {
          $pagador_input_2 = $pagador;
      }
      $tmp_pos = strpos($prefijo, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $prefijo;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['psq_check_ret']['prefijo'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($pagador, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['psq_check_ret']['pagador'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Pagador : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['prefijo'] = $prefijo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['prefijo_cond'] = $prefijo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['numero'] = $numero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['numero_cond'] = $numero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['concepto'] = $concepto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['concepto_cond'] = $concepto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['pagado_a'] = $pagado_a; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['pagado_a_cond'] = $pagado_a_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['pagador'] = $pagador; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['pagador_cond'] = $pagador_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
    ...
    if ($concepto != '') {
      ...
      {
          $this->cmp_formatado['concepto'] = $concepto;
      }
      $nmgp_def_dados = array();
    if ($pagado_a != '') {
      $pagado_a_look = substr($this->Db->qstr($pagado_a), 1, -1); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['pagado_a'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['pagado_a'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['pagado_a'] = $pagado_a;
      }
      $Conteudo = $pagador;
      if (strpos($Conteudo, "##@@") !== false)
      {
      ...
      $this->cmp_formatado['pagador'] = $Conteudo;
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']['fecha_input_2'] = $val[1];
      ...
      //----- $pagado_a
      $this->Date_part = false;
      if (isset($pagado_a) || $pagado_a_cond == "nu" || $pagado_a_cond == "nn" || $pagado_a_cond == "ep" || $pagado_a_cond == "ne")
      {
         $this->monta_condicao("pagado_a", $pagado_a_cond, $pagado_a, "", "pagado_a");
      }
      ...
      if (isset($pagador))
      {
         $this->monta_condicao("pagador", $pagador_cond, $pagador, "", "pagador");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos_master']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "pagador" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
