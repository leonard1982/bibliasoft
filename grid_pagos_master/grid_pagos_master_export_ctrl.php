<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pagos_master']['sc_process_barr'] = true;
require_once('../grid_pagos_master/index.php');
unset($_SESSION['scriptcase']['grid_pagos_master']['sc_process_barr']);
$ExportCtrl = new grid_pagos_master_export_control;
$ExportCtrl->Export_barr();

class grid_pagos_master_export_control
{
