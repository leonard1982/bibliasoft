...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['contr_label_graf']['idpro']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['contr_label_graf']['idpro']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['contr_label_graf']['idpro'];
      }
   }
