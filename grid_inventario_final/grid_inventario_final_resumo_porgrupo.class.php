...
class grid_inventario_final_resumo
{
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_inventario_final']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_inventario_final']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['arr_total']['grupo'];
      }
      else
      {
          $this->array_total_grupo = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['tot_geral'][3];
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['arr_total']['grupo'] = $this->array_total_grupo;
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['json_use_label'])
       {
          $Lab_grupo = "grupo";
       }
       else
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['grupo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['grupo'] = "Grupo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['codigobar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['codigobar'] = "Codigo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['nompro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['nompro'] = "Descripción"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['colores']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['colores'] = "Color"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['tallas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['tallas'] = "Talla"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['sabor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['sabor'] = "Sabor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['cantidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['cantidad'] = "Cantidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['costoinv']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['costoinv'] = "Costo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['presentacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['presentacion'] = "Presentación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idbod']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idbod'] = "Ubicación"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idinv']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idinv'] = "Idinv"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['fecha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['fecha'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idpro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idpro'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['costo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['costo'] = "Costo unitario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['valorparcial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['valorparcial'] = "Valorparcial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['detalle']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['detalle'] = "Detalle"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idmov']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idmov'] = "Idmov"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idfaccom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['idfaccom'] = "Idfaccom"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['nufacvta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['labels']['nufacvta'] = "Nufacvta"; 
       }
       //-----
       $this->comp_field_nm = array(
           'grupo' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['porgrupo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['porgrupo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['porgrupo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porgrupo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porgrupo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porgrupo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porgrupo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porgrupo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porgrupo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porgrupo'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "costoinv", 'show' => true),
       );
       ...
       foreach ($this->array_total_grupo as $i_grupo => $d_grupo) {
           if (!in_array($i_grupo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_grupo[4] ] = $d_grupo[3];
               $this->comp_label[0][ $d_grupo[4] ] = $d_grupo[3];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_inventario_final@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Costo()")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'grupo',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_grupo)),
               'label_y'  => $this->getChartText(strip_tags("Costo()")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_orig']      = $this->comp_chart_data;
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_inventario_final_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_inventario_final_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['proc_pdf_vert']){ 
   ...
   function inicializa_vars()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['dashboard_refresh_after_chart'] = 'resumo';
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['doc_word']) 
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_inventario_final/grid_inventario_final_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_inventario_final']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_inventario_final']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_costoinv, $quebra_grupo, $quebra_grupo_orig)
   {
      //----- Grupo
      if (!isset($this->array_total_grupo[$quebra_grupo_orig]))
      {
         $this->array_total_grupo[$quebra_grupo_orig][0] = 1;
         $this->array_total_grupo[$quebra_grupo_orig][1] = $sum_cantidad;
         $this->array_total_grupo[$quebra_grupo_orig][2] = $sum_costoinv;
         $this->array_total_grupo[$quebra_grupo_orig][3] = $quebra_grupo;
         $this->array_total_grupo[$quebra_grupo_orig][4] = $quebra_grupo_orig;
      }
      else
      {
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = $this->Ini->Get_date_order_groupby("grupo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->colores = $rs_res->fields[3] ;  
            $this->tallas = $rs_res->fields[4] ;  
            $this->sabor = $rs_res->fields[5] ;  
            $this->cantidad = $rs_res->fields[6] ;  
            $this->cantidad =  str_replace(",", ".", $this->cantidad);
            $this->costoinv = $rs_res->fields[7] ;  
            $this->costoinv =  str_replace(",", ".", $this->costoinv);
            $this->idbod = $rs_res->fields[8] ;  
            $this->idinv = $rs_res->fields[9] ;  
            $this->fecha = $rs_res->fields[10] ;  
            $this->idpro = $rs_res->fields[11] ;  
            $this->costo = $rs_res->fields[12] ;  
            $this->valorparcial = $rs_res->fields[13] ;  
...
$_SESSION['scriptcase']['grid_inventario_final']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->costoinv, $this->grupo, $this->grupo_orig);
            }
   }
//
