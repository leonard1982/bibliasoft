...
class grid_inventario_final_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_inventario_final_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_inventario_final_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_inventario_final_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_cantidad($cantidad)
   {
      ...
      {
          $nm_comando = "select distinct cantidad from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where   CAST (cantidad AS TEXT)  like '%" . $cantidad . "%'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct cantidad from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where   CAST (cantidad AS VARCHAR)  like '%" . $cantidad . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct cantidad from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where  cantidad like '%" . $cantidad . "%'"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_codigobar($codigobar)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigobar from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where  codigobar like '%" . $codigobar . "%'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_nompro($nompro)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nompro from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where  nompro like '%" . $nompro . "%'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_numeric[] = "idinv";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "idpro";$Nm_numeric[] = "costo";$Nm_numeric[] = "valorparcial";$Nm_numeric[] = "idbod";$Nm_numeric[] = "tipo";$Nm_numeric[] = "idmov";$Nm_numeric[] = "idfaccom";$Nm_numeric[] = "nufacvta";$Nm_numeric[] = "colores";$Nm_numeric[] = "tallas";$Nm_numeric[] = "sabor";$Nm_numeric[] = "grupo";$Nm_numeric[] = "costoinv";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Inventario final al día:</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_inventario_final/grid_inventario_final_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_inventario_final_ajax_search.js"></script>
 <script type="text/javascript" src="grid_inventario_final_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_inventario_final_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_inventario_final']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_inventario_final']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_grupo#NMF#' + search_get_select('SC_grupo') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Inventario final al día:</span></td>
...
<?php
   ...
   {
      global 
             $cantidad_cond, $cantidad, $cantidad_autocomp,
             $idbod_cond, $idbod,
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_inventario_final']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_inventario_final']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_inventario_final']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_inventario_final", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cantidad = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['cantidad']; 
          $cantidad_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['cantidad_cond']; 
          $idbod = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['idbod']; 
          $idbod_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['idbod_cond']; 
          $codigobar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['codigobar']; 
          $codigobar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['codigobar_cond']; 
          $nompro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['nompro']; 
          $nompro_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['nompro_cond']; 
          $grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['grupo']; 
          $grupo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['grupo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['NM_operador']; 
      } 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cantidad_cond" name="cantidad_cond" onChange="nm_campos_between(document.getElementById('id_vis_cantidad'), this, 'cantidad')">
      ...
      <br><span id="id_hide_cantidad"  <?php echo $str_hide_cantidad?>><?php
      if ($cantidad != "")
      {
      $cantidad_look = substr($this->Db->qstr($cantidad), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct cantidad from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where cantidad = $cantidad_look"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct cantidad from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where cantidad = $cantidad_look"; 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cantidad" id="id_ac_cantidad" name="cantidad_autocomp"><?php if ('' !=  $cantidad) { ?><option value="<?php echo $cantidad ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_idbod"  <?php echo $str_hide_idbod?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['psq_check_ret']['idbod'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['psq_check_ret']['idbod'][] = trim($rs->fields[0]);
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_codigobar"  <?php echo $str_hide_codigobar?>><?php
      ...
      $codigobar_look = substr($this->Db->qstr($codigobar), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct codigobar from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where codigobar = '$codigobar_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_codigobar" name="codigobar" value="<?php echo NM_encode_input($codigobar) ?>"  size=60 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nompro"  <?php echo $str_hide_nompro?>><?php
      ...
      $nompro_look = substr($this->Db->qstr($nompro), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct nompro from (SELECT      idinv,     fecha,     cantidad,     idpro,     costo,     valorparcial,     idbod,     tipo,     detalle,     idmov,     idfaccom,     nufacvta,     colores,     tallas,     sabor,     (select p.codigobar from productos p where p.idprod=idpro) as codigobar,     (select p.nompro from productos p where p.idprod=idpro) as nompro,     (select p.idgrup from productos p where p.idprod=idpro) as grupo,     (costo*cantidad) as costoinv FROM      inventario GROUP BY idpro, idbod, colores, tallas, sabor) nm_sel_esp where nompro = '$nompro_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_nompro" name="nompro" value="<?php echo NM_encode_input($nompro) ?>"  size=60 alt="{datatype: 'text', maxLength: 600, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_grupo"  <?php echo $str_hide_grupo?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['psq_check_ret']['grupo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['psq_check_ret']['grupo'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
   <span id="idAjaxSelect_grupo">
      <SELECT class="scFilterObjectOdd" id="SC_grupo" name="grupo"  size="1">
       <OPTION value="">SELECCIONE</OPTION>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $grupo)
            {
                    $grupo_sel = ($nm_opc_cod === $grupo) ? "selected" : "";
            }
            else
            {
...
<?php
   if (is_file("grid_inventario_final_help.txt"))
   {
      $Arq_WebHelp = file("grid_inventario_final_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_inventario_final']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_inventario_final']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function Sc_carga_select2(Field)
 {
    ...
    if (Field == 'all' || Field == 'grupo') {
       Sc_carga_select2_grupo();
    }
 }
 ...
 function Sc_carga_select2_grupo()
 {
  $("#SC_grupo").select2(
    {
      language: {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_inventario_final";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_inventario_final/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $cantidad_cond, $cantidad, $cantidad_autocomp,
             $idbod_cond, $idbod,
             $codigobar_cond, $codigobar, $codigobar_autocomp,
             $nompro_cond, $nompro, $nompro_autocomp,
             $grupo_cond, $grupo, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['psq_check_ret']['idbod'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($grupo, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['psq_check_ret']['grupo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Grupo : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['cantidad'] = $cantidad; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['cantidad_cond'] = $cantidad_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['idbod'] = $idbod; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['idbod_cond'] = $idbod_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['codigobar'] = $codigobar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['codigobar_cond'] = $codigobar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['nompro'] = $nompro; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['nompro_cond'] = $nompro_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['grupo'] = $grupo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['grupo_cond'] = $grupo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
    ...
    if ($nompro != '') {
      ...
      $this->cmp_formatado['grupo'] = $Conteudo;

      //----- $cantidad
      $this->Date_part = false;
      if (isset($cantidad) || $cantidad_cond == "nu" || $cantidad_cond == "nn" || $cantidad_cond == "ep" || $cantidad_cond == "ne")
      {
         $this->monta_condicao("cantidad", $cantidad_cond, $cantidad, "", "cantidad");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "grupo" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
...
$sql="select unidmaymen, unimay, unimen from productos where idprod=$idpro ";
