...
class grid_inventario_final_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idbod = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['arr_total']['idbod'];
      }
      else
      {
          $this->array_total_idbod = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['arr_total']['idbod'] = $this->array_total_idbod;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['porbodega']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['porbodega'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['porbodega'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porbodega'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porbodega'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porbodega'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porbodega'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porbodega'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porbodega'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['porbodega'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_idbod as $i_idbod => $d_idbod) {
           if (!in_array($i_idbod, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idbod[4] ] = $d_idbod[3];
               $this->comp_label[0][ $d_idbod[4] ] = $d_idbod[3];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_idbod => $l_idbod) {
           if (isset($this->array_total_idbod[$i_idbod])) {
               $this->comp_group[$i_idbod] = array();
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_porbodega("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_costoinv, $quebra_idbod, $quebra_idbod_orig)
   {
      //----- Ubicación
      if (!isset($this->array_total_idbod[$quebra_idbod_orig]))
      {
         $this->array_total_idbod[$quebra_idbod_orig][0] = 1;
         $this->array_total_idbod[$quebra_idbod_orig][1] = $sum_cantidad;
         $this->array_total_idbod[$quebra_idbod_orig][2] = $sum_costoinv;
         $this->array_total_idbod[$quebra_idbod_orig][3] = $quebra_idbod;
         $this->array_total_idbod[$quebra_idbod_orig][4] = $quebra_idbod_orig;
      }
      else
      {
         $this->array_total_idbod[$quebra_idbod_orig][0]++;
         $this->array_total_idbod[$quebra_idbod_orig][1] += $sum_cantidad;
         $this->array_total_idbod[$quebra_idbod_orig][2] += $sum_costoinv;
      }
   }
...
$_SESSION['scriptcase']['grid_inventario_final']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->costoinv, $this->idbod, $this->idbod_orig);
            }
   }
//
