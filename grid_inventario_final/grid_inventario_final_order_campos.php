...
<?php
   ...
   $Ord_Cmp = new grid_inventario_final_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_inventario_final_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["grupo"] : "Grupo";
   $tab_ger_campos['codigobar'] = "on";
   $tab_def_campos['codigobar'] = "codigobar";
   $tab_labels["codigobar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["codigobar"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["codigobar"] : "Codigo";
   $tab_ger_campos['nompro'] = "on";
   $tab_def_campos['nompro'] = "nompro";
   $tab_labels["nompro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["nompro"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["nompro"] : "Descripción";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['costoinv'] = "on";
   $tab_def_campos['costoinv'] = "costoinv";
   $tab_labels["costoinv"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["costoinv"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["costoinv"] : "Costo";
   ...
   $tab_labels["presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["presentacion"] : "Presentación";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['labels']["idbod"] : "Ubicación";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_inventario_final_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_inventario_final']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
