...
class grid_inventario_final_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_idpro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['arr_total']['idpro'];
      }
      else
      {
          $this->array_total_idpro = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['articulos']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['articulos'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_order']['articulos'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['articulos'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['articulos'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['articulos'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['articulos'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['articulos'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['articulos'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['summarizing_fields_display']['articulos'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_idpro as $i_idpro => $d_idpro) {
           if (!in_array($i_idpro, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_idpro[4] ] = $d_idpro[3];
               $this->comp_label[0][ $d_idpro[4] ] = $d_idpro[3];
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_inventario_final']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_articulos("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $sum_costoinv, $quebra_idpro, $quebra_idpro_orig)
   {
      //----- Producto
      if (!isset($this->array_total_idpro[$quebra_idpro_orig]))
      {
         ...
         $this->array_total_idpro[$quebra_idpro_orig][2] = $sum_costoinv;
         $this->array_total_idpro[$quebra_idpro_orig][3] = $quebra_idpro;
         $this->array_total_idpro[$quebra_idpro_orig][4] = $quebra_idpro_orig;
      }
      else
      {
...
$_SESSION['scriptcase']['grid_inventario_final']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->costoinv, $this->idpro, $this->idpro_orig);
            }
   }
//
