...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_inventario_final"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_inventario_final"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_final']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_final']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_final']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_inventario_final']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_inventario_final']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_inventario_final</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_inventario_final']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_inventario_final']['embutida_filho'] as $ind => $sc_init)
          {
