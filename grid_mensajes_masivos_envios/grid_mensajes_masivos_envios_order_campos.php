...
<?php
   ...
   $Ord_Cmp = new grid_mensajes_masivos_envios_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_mensajes_masivos_envios_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["creado"] : "Creado";
   $tab_ger_campos['actualizado'] = "on";
   $tab_def_campos['actualizado'] = "actualizado";
   $tab_labels["actualizado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["actualizado"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["actualizado"] : "Actualizado";
   $tab_ger_campos['u_envio'] = "on";
   $tab_def_campos['u_envio'] = "u_envio";
   $tab_labels["u_envio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["u_envio"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["u_envio"] : "Último Envío";
   $tab_ger_campos['n_envios'] = "on";
   $tab_def_campos['n_envios'] = "n_envios";
   $tab_labels["n_envios"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["n_envios"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["n_envios"] : "# Envíos";
   $tab_ger_campos['id_mensaje'] = "on";
   $tab_def_campos['id_mensaje'] = "id_mensaje";
   $tab_labels["id_mensaje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["id_mensaje"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["id_mensaje"] : "Mensaje";
   $tab_ger_campos['clasificaciones_destino'] = "on";
   $tab_def_campos['clasificaciones_destino'] = "clasificaciones_destino";
   $tab_labels["clasificaciones_destino"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["clasificaciones_destino"])) ? $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['labels']["clasificaciones_destino"] : "Destino";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_mensajes_masivos_envios_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_mensajes_masivos_envios']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
