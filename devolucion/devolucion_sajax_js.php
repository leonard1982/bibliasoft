  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_devolucion" == sTestField)
        {
...
?>
  ...
  // ---------- Validate cantidad_
  function do_ajax_devolucion_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_devolucion_validate_cantidad__cb);
  } // do_ajax_devolucion_validate_cantidad_

  function do_ajax_devolucion_validate_cantidad__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_cantidad__cb

  // ---------- Validate idpro_
  function do_ajax_devolucion_validate_idpro_(iNumLinha)
  {
  } // do_ajax_devolucion_validate_idpro_

  function do_ajax_devolucion_validate_idpro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_idpro__cb

  // ---------- Validate colores_
  function do_ajax_devolucion_validate_colores_(iNumLinha)
  {
  } // do_ajax_devolucion_validate_colores_

  function do_ajax_devolucion_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_devolucion_validate_tallas_(iNumLinha)
  {
  } // do_ajax_devolucion_validate_tallas_

  function do_ajax_devolucion_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_devolucion_validate_sabor_(iNumLinha)
  {
  } // do_ajax_devolucion_validate_sabor_

  function do_ajax_devolucion_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_sabor__cb

  // ---------- Validate idbod_
  function do_ajax_devolucion_validate_idbod_(iNumLinha)
  {
  } // do_ajax_devolucion_validate_idbod_

  function do_ajax_devolucion_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_idbod__cb

  // ---------- Validate valorunit_
  function do_ajax_devolucion_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldText(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_devolucion_validate_valorunit__cb);
  } // do_ajax_devolucion_validate_valorunit_

  function do_ajax_devolucion_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_valorunit__cb

  // ---------- Validate descuento_
  function do_ajax_devolucion_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldText(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_devolucion_validate_descuento__cb);
  } // do_ajax_devolucion_validate_descuento_

  function do_ajax_devolucion_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_descuento__cb

  // ---------- Validate valorpar_
  function do_ajax_devolucion_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldText(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_devolucion_validate_valorpar__cb);
  } // do_ajax_devolucion_validate_valorpar_

  function do_ajax_devolucion_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_valorpar__cb

  // ---------- Validate iva_
  function do_ajax_devolucion_validate_iva_(iNumLinha)
  {
    var nomeCampo_iva_ = "iva_" + iNumLinha;
    var var_iva_ = scAjaxGetFieldText(nomeCampo_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_validate_iva_(var_iva_, iNumLinha, var_script_case_init, do_ajax_devolucion_validate_iva__cb);
  } // do_ajax_devolucion_validate_iva_

  function do_ajax_devolucion_validate_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_iva__cb

  // ---------- Validate tasaiva_
  function do_ajax_devolucion_validate_tasaiva_(iNumLinha)
  {
    var nomeCampo_tasaiva_ = "tasaiva_" + iNumLinha;
    var var_tasaiva_ = scAjaxGetFieldText(nomeCampo_tasaiva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_validate_tasaiva_(var_tasaiva_, iNumLinha, var_script_case_init, do_ajax_devolucion_validate_tasaiva__cb);
  } // do_ajax_devolucion_validate_tasaiva_

  function do_ajax_devolucion_validate_tasaiva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_tasaiva__cb

  // ---------- Validate tasadesc_
  function do_ajax_devolucion_validate_tasadesc_(iNumLinha)
  {
    var nomeCampo_tasadesc_ = "tasadesc_" + iNumLinha;
    var var_tasadesc_ = scAjaxGetFieldText(nomeCampo_tasadesc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_validate_tasadesc_(var_tasadesc_, iNumLinha, var_script_case_init, do_ajax_devolucion_validate_tasadesc__cb);
  } // do_ajax_devolucion_validate_tasadesc_

  function do_ajax_devolucion_validate_tasadesc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_tasadesc__cb

  // ---------- Validate devuelto_
  function do_ajax_devolucion_validate_devuelto_(iNumLinha)
  {
    var nomeCampo_devuelto_ = "devuelto_" + iNumLinha;
    var var_devuelto_ = scAjaxGetFieldText(nomeCampo_devuelto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_validate_devuelto_(var_devuelto_, iNumLinha, var_script_case_init, do_ajax_devolucion_validate_devuelto__cb);
  } // do_ajax_devolucion_validate_devuelto_

  function do_ajax_devolucion_validate_devuelto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devolucion_validate_devuelto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_devolucion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_devolucion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devolucion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_devolucion_add_new_line_cb);
  } // do_ajax_devolucion_add_new_line

  function do_ajax_devolucion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_devolucion_add_new_line_cb

  // ---------- backup_line
  function do_ajax_devolucion_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldText("iddet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devolucion_backup_line(var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_devolucion_backup_line_cb);
  } // do_ajax_devolucion_backup_line

  function do_ajax_devolucion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_devolucion_backup_line_cb

  function do_ajax_devolucion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_devolucion_cancel_insert

  function do_ajax_devolucion_cancel_update(iSeqVert)
  {
    do_ajax_devolucion_backup_line(iSeqVert);
...
?>
  } // do_ajax_devolucion_cancel_update

  function do_ajax_devolucion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_devolucion_restore_buttons

  // ---------- table_refresh
  function do_ajax_devolucion_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_devolucion_table_refresh(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_devolucion_table_refresh_cb);
  } //  do_ajax_devolucion_table_refresh

  function do_ajax_devolucion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_devolucion_table_refresh_cb_after_alert);
  } // do_ajax_devolucion_table_refresh_cb
  function do_ajax_devolucion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_devolucion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_devolucion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_devolucion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_valorpar_ = scAjaxGetFieldText("valorpar_" + iNumLinha);
...
?>
    x_ajax_devolucion_submit_form(var_cantidad_, var_idpro_, var_colores_, var_tallas_, var_sabor_, var_idbod_, var_valorunit_, var_descuento_, var_valorpar_, var_iva_, var_tasaiva_, var_tasadesc_, var_devuelto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_devolucion_submit_form_cb);
  } // do_ajax_devolucion_submit_form

  function do_ajax_devolucion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_devolucion_submit_form_cb_after_alert);
  } // do_ajax_devolucion_submit_form_cb
  function do_ajax_devolucion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_devolucion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_devolucion_navigate_form()
  {
    perform_ajax_devolucion_navigate_form();
  }

  function perform_ajax_devolucion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_devolucion_navigate_form(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_devolucion_navigate_form_cb);
  } // do_ajax_devolucion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_devolucion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_devolucion_navigate_form_cb_after_alert);
  } // do_ajax_devolucion_navigate_form_cb
  function do_ajax_devolucion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_devolucion_navigate_form_cb_after_alert
  function sc_hide_devolucion_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["descuento_" + iNumLinha] = {"label": "Desc X Und<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["idpro_" + iRow] || "on" == ajax_error_count["colores_" + iRow] || "on" == ajax_error_count["tallas_" + iRow] || "on" == ajax_error_count["sabor_" + iRow] || "on" == ajax_error_count["idbod_" + iRow] || "on" == ajax_error_count["valorunit_" + iRow] || "on" == ajax_error_count["descuento_" + iRow] || "on" == ajax_error_count["valorpar_" + iRow] || "on" == ajax_error_count["iva_" + iRow] || "on" == ajax_error_count["tasaiva_" + iRow] || "on" == ajax_error_count["tasadesc_" + iRow] || "on" == ajax_error_count["devuelto_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["idpro_" + iRow] && "off" == ajax_error_count["colores_" + iRow] && "off" == ajax_error_count["tallas_" + iRow] && "off" == ajax_error_count["sabor_" + iRow] && "off" == ajax_error_count["idbod_" + iRow] && "off" == ajax_error_count["valorunit_" + iRow] && "off" == ajax_error_count["descuento_" + iRow] && "off" == ajax_error_count["valorpar_" + iRow] && "off" == ajax_error_count["iva_" + iRow] && "off" == ajax_error_count["tasaiva_" + iRow] && "off" == ajax_error_count["tasadesc_" + iRow] && "off" == ajax_error_count["devuelto_" + iRow]))
    {
      if (bErrorRow)
      {
