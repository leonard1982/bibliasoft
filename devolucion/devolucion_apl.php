...
class devolucion_apl
{
   ...
   var $form_vert_devolucion = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['devolucion']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['devolucion']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['devolucion']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['devolucion']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['devolucion']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['devolucion']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['devolucion']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['devolucion']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idfaccom)) 
          {
              $_SESSION['par_idfaccom'] = $this->par_idfaccom;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['devolucion']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['devolucion']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['devolucion']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['devolucion']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['devolucion']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['devolucion']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['devolucion']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['devolucion']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['devolucion']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new devolucion_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['devolucion']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['devolucion']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['devolucion'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devolucion']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devolucion']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('devolucion') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devolucion']['label'] = "Devoluciones en Compra";
      ...
      $this->arr_buttons['ejecutar']['hint']             = "";
      $this->arr_buttons['ejecutar']['type']             = "button";
      $this->arr_buttons['ejecutar']['value']            = "Ejecutar";
      $this->arr_buttons['ejecutar']['display']          = "only_text";
      $this->arr_buttons['ejecutar']['display_position'] = "text_right";
      $this->arr_buttons['ejecutar']['style']            = "default";
      $this->arr_buttons['ejecutar']['image']            = "";


      $_SESSION['scriptcase']['error_icon']['devolucion']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['devolucion'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['Ejecutar'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_orig'] = " where idfaccom=" . $_SESSION['par_idfaccom'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_pesq'] = " where idfaccom=" . $_SESSION['par_idfaccom'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devolucion']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['devolucion'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['devolucion'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("devolucion", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'devolucion_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'devolucion_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'devolucion/devolucion_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "devolucion_erro.class.php"); 
      }
      $this->Erro      = new devolucion_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao']))
         { 
             if ($this->iddet_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "novo")  
      {
          $this->nmgp_botoes['Ejecutar'] = "off";
      }
      elseif ($this->nmgp_opcao == "incluir")  
      {
          $this->nmgp_botoes['Ejecutar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['botoes']['Ejecutar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['devolucion']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['devolucion']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['devolucion']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['devolucion']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      { 
          if ($nm_call_php == "Ejecutar")
          { 
              $this->sc_btn_Ejecutar();
          } 
          $this->NM_close_db(); 
          exit;
      } 
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_devolucion']) || !is_array($this->NM_ajax_info['errList']['geral_devolucion']))
                  {
                      $this->NM_ajax_info['errList']['geral_devolucion'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_devolucion'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_devolucion'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_devolucion'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_redir_atualiz'] == "ok")
          {
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idpro_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idpro_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idpro_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idpro_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(devolucion_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', devolucion_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idpro_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idbod_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idbod_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idbod_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idbod_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_idbod_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{
   $this->idpro_ = $this->form_vert_devolucion[$sc_seq_vert]['idpro_'];
}
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_colores_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_colores_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_colores_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_colores_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_colores_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_tallas_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_tallas_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_tallas_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_tallas_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_tallas_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
{ 
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_sabor_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_sabor_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_sabor_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_sabor_'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['Lookup_sabor_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         { 
             $GLOBALS["cantidad_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['cantidad_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["idpro_" . $sc_seq_vert]))
         { 
             $GLOBALS["idpro_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['idpro_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["colores_" . $sc_seq_vert]))
         { 
             $GLOBALS["colores_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['colores_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["tallas_" . $sc_seq_vert]))
         { 
             $GLOBALS["tallas_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['tallas_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["sabor_" . $sc_seq_vert]))
         { 
             $GLOBALS["sabor_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['sabor_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["idbod_" . $sc_seq_vert]))
         { 
             $GLOBALS["idbod_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['idbod_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["valorunit_" . $sc_seq_vert]))
         { 
             $GLOBALS["valorunit_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['valorunit_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["descuento_" . $sc_seq_vert]))
         { 
             $GLOBALS["descuento_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['descuento_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["valorpar_" . $sc_seq_vert]))
         { 
             $GLOBALS["valorpar_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['valorpar_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["iva_" . $sc_seq_vert]))
         { 
             $GLOBALS["iva_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['iva_'];
         } 
         ...
         if (isset($this->tallas_)) { $this->nm_limpa_alfa($this->tallas_); }
         if (isset($this->sabor_)) { $this->nm_limpa_alfa($this->sabor_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['cantidad_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['cantidad_']))
             { 
                 $this->cantidad_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['cantidad_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['idpro_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['idpro_']))
             { 
                 $this->idpro_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['idpro_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['colores_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['colores_']))
             { 
                 $this->colores_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['colores_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['tallas_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['tallas_']))
             { 
                 $this->tallas_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['tallas_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['sabor_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['sabor_']))
             { 
                 $this->sabor_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['sabor_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['idbod_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['idbod_']))
             { 
                 $this->idbod_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['idbod_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['valorunit_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['valorunit_']))
             { 
                 $this->valorunit_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['valorunit_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['descuento_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['descuento_']))
             { 
                 $this->descuento_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['descuento_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['valorpar_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['valorpar_']))
             { 
                 $this->valorpar_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['valorpar_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['iva_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'][$sc_seq_vert]['iva_']))
             { 
                 $this->iva_ = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['iva_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_devolucion[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_devolucion[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_devolucion[$sc_seq_vert]['colores_'] =  $this->colores_; 
             $this->form_vert_devolucion[$sc_seq_vert]['tallas_'] =  $this->tallas_; 
             $this->form_vert_devolucion[$sc_seq_vert]['sabor_'] =  $this->sabor_; 
             $this->form_vert_devolucion[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
             $this->form_vert_devolucion[$sc_seq_vert]['valorunit_'] =  $this->valorunit_; 
             $this->form_vert_devolucion[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_devolucion[$sc_seq_vert]['valorpar_'] =  $this->valorpar_; 
             $this->form_vert_devolucion[$sc_seq_vert]['iva_'] =  $this->iva_; 
             $this->form_vert_devolucion[$sc_seq_vert]['tasaiva_'] =  $this->tasaiva_; 
             $this->form_vert_devolucion[$sc_seq_vert]['tasadesc_'] =  $this->tasadesc_; 
             $this->form_vert_devolucion[$sc_seq_vert]['devuelto_'] =  $this->devuelto_; 
             $this->form_vert_devolucion[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_devolucion[$sc_seq_vert]['idfaccom_'] =  $this->idfaccom_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_devolucion);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (isset($this->idbod_))
          { 
              $SV_idbod_ = $this->idbod_;
          } 
          if (isset($this->valorunit_))
          { 
              $SV_valorunit_ = $this->valorunit_;
          } 
          if (isset($this->descuento_))
          { 
              $SV_descuento_ = $this->descuento_;
          } 
          if (isset($this->valorpar_))
          { 
              $SV_valorpar_ = $this->valorpar_;
          } 
          if (isset($this->iva_))
          { 
              $SV_iva_ = $this->iva_;
          ...
          if (isset($SV_idbod_) && $this->nmgp_opcao != "recarga")
          { 
              $this->idbod_ = $SV_idbod_;
          } 
          if (isset($SV_valorunit_) && $this->nmgp_opcao != "recarga")
          { 
              $this->valorunit_ = $SV_valorunit_;
          } 
          if (isset($SV_descuento_) && $this->nmgp_opcao != "recarga")
          { 
              $this->descuento_ = $SV_descuento_;
          } 
          if (isset($SV_valorpar_) && $this->nmgp_opcao != "recarga")
          { 
              $this->valorpar_ = $SV_valorpar_;
          } 
          if (isset($SV_iva_) && $this->nmgp_opcao != "recarga")
          { 
              $this->iva_ = $SV_iva_;
          } 
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "devolucion.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Devoluciones en Compra") ?></TITLE>
...
<form name="Fdown" method="get" action="devolucion_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="devolucion"> 
...
<?php
include_once("devolucion_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opc_ant'] == "incluir")
      {
...
$ta=0;
$sa=0;
$a=$this->sc_temp_par_idfaccom;
 
      $nm_select = "select numfacom from facturacom where idfaccom=$a"; 
...
;
$numfact=substr($this->des , 9);

 
      $nm_select = "select * from detallecompraself where idfaccom=$a"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
...
if(!empty($this->ds[0][0]))
   {
     ...
     $nm_select ="UPDATE detallecompraself set devuelto=$cantidad where iddet=$id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     ...
     $nm_select ="UPDATE detallecompra set devuelto=$cantidad where iddet=$id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="update facturacom set observaciones='MERCANCIA DEVUELTA',anulada='DEVUELTA' where idfaccom=$a"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="insert detallecompra set idfaccom=$idfac, idpro=$idproducto, idbod=$bod, cantidad=($cantidad*-1), valorunit=$vunit, valorpar=($vparcial*-1), iva=($iva*-1), descuento=$desc, tasaiva=$tiva, tasadesc=$tdes, devuelto=$cantidad, colores=$col, tallas=$ta, sabor=$sa"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT inventario SET fecha='$fech', cantidad=($cantidad*-1), idpro=$idproducto, costo=$vunit, 		valorparcial=($vparcial*-1), idbod=$bod, tipo=2, detalle='Devolución en Compra', idmov=1,  		idfaccom=$a, nufacvta=0, iddetalle=$id, colores=$col, tallas=$ta, sabor=$sa"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      ;
		...
		$this->actualiza_stock($idproducto, $cantidad);
		
		 
      $nm_select = "select 	idprov from facturacom where idfaccom=$a"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->des = $this->Db->Execute($nm_select)) 
      { }
...
;
		$idprove=substr($this->des , 6); 
		
		 
      $nm_select = "select saldoapagar from terceros where idtercero=$idprove"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
		$saldo=substr($this->ds , 11);
		$totaldes=$vparcial+$iva;
		$descontar=$saldo-$totaldes;
		  
     $nm_select ="update terceros set saldoapagar=$descontar where idtercero=$idprove"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      $nm_select = "select saldo from facturacom where idfaccom=$a"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
		$salfac=substr($this->dt , 5);
		$descfac=$salfac-$totaldes;
		
     $nm_select ="update facturacom set saldo=$descfac where idfaccom=$a"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="INSERT devcompra SET fecha='$fech', numfaccom='$numfact', idinven=0, idpro=$idproducto, cantidad=($cantidad*-1)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="delete from detallecompraself where iddet=$id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('devcompra') . "/", $this->nm_location, "_blank?#?" . NM_encode_input("") . "?@?","_self", '', 440, 630);
 };
	}
if (isset($this->sc_temp_par_idfaccom)) { $_SESSION['par_idfaccom'] = $this->sc_temp_par_idfaccom;}
$_SESSION['scriptcase']['devolucion']['contr_erro'] = 'off'; 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_devolucion'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
;
      ...
      $Teste_compara = $this->colores_ ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->colores_, $_SESSION['scriptcase']['charset']); $x++) 
          { 
          ...
          { 
              ...
              $Campos_Erros['colores_'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['colores_']) || !is_array($this->NM_ajax_info['errList']['colores_']))
              {
                  $this->NM_ajax_info['errList']['colores_'] = array();
              }
              $this->NM_ajax_info['errList']['colores_'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
...
;
      $Teste_trab = $Teste_trab . chr(10) . chr(13) ; 
      $Teste_compara = $this->tallas_ ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->tallas_, $_SESSION['scriptcase']['charset']); $x++) 
          { 
               for ($y = 0; $y < mb_strlen($Teste_trab, $_SESSION['scriptcase']['charset']); $y++) 
               { 
                    if (sc_substr($Teste_compara, $x, 1) == sc_substr($Teste_trab, $y, 1) ) 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Talla " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['tallas_']))
              {
                  $Campos_Erros['tallas_'] = array();
              }
              $Campos_Erros['tallas_'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['tallas_']) || !is_array($this->NM_ajax_info['errList']['tallas_']))
              {
                  $this->NM_ajax_info['errList']['tallas_'] = array();
              }
              $this->NM_ajax_info['errList']['tallas_'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
...
;
      $Teste_trab = $Teste_trab . chr(10) . chr(13) ; 
      $Teste_compara = $this->sabor_ ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          $Teste_critica = 0 ; 
          for ($x = 0; $x < mb_strlen($this->sabor_, $_SESSION['scriptcase']['charset']); $x++) 
          { 
               for ($y = 0; $y < mb_strlen($Teste_trab, $_SESSION['scriptcase']['charset']); $y++) 
               { 
                    if (sc_substr($Teste_compara, $x, 1) == sc_substr($Teste_trab, $y, 1) ) 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "Sabor " . $this->Ini->Nm_lang['lang_errm_ivch']; 
              if (!isset($Campos_Erros['sabor_']))
              {
                  $Campos_Erros['sabor_'] = array();
              }
              $Campos_Erros['sabor_'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
              if (!isset($this->NM_ajax_info['errList']['sabor_']) || !is_array($this->NM_ajax_info['errList']['sabor_']))
              {
                  $this->NM_ajax_info['errList']['sabor_'] = array();
              }
              $this->NM_ajax_info['errList']['sabor_'][] = $this->Ini->Nm_lang['lang_errm_ivch'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_descuento_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "Desc X Und: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_iva_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->iva_, 11, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "IVA; " ; 
                  if (!isset($Campos_Erros['iva_']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['iddet_']['keyVal'] = devolucion_pack_protect_string($this->nmgp_dados_form['iddet_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_devolucion[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['idpro_']) && $this->NM_ajax_changed['idpro_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['idpro_'] = $this->idpro_;
                  }
                  if (isset($this->NM_ajax_changed['colores_']) && $this->NM_ajax_changed['colores_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['colores_'] = $this->colores_;
                  }
                  if (isset($this->NM_ajax_changed['tallas_']) && $this->NM_ajax_changed['tallas_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['tallas_'] = $this->tallas_;
                  }
                  if (isset($this->NM_ajax_changed['sabor_']) && $this->NM_ajax_changed['sabor_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['sabor_'] = $this->sabor_;
                  }
                  if (isset($this->NM_ajax_changed['idbod_']) && $this->NM_ajax_changed['idbod_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['idbod_'] = $this->idbod_;
                  }
                  if (isset($this->NM_ajax_changed['valorunit_']) && $this->NM_ajax_changed['valorunit_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['valorunit_'] = $this->valorunit_;
                  }
                  if (isset($this->NM_ajax_changed['descuento_']) && $this->NM_ajax_changed['descuento_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['descuento_'] = $this->descuento_;
                  }
                  if (isset($this->NM_ajax_changed['valorpar_']) && $this->NM_ajax_changed['valorpar_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['valorpar_'] = $this->valorpar_;
                  }
                  if (isset($this->NM_ajax_changed['iva_']) && $this->NM_ajax_changed['iva_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['iva_'] = $this->iva_;
                  }
                  if (isset($this->NM_ajax_changed['tasaiva_']) && $this->NM_ajax_changed['tasaiva_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['tasaiva_'] = $this->tasaiva_;
                  }
                  if (isset($this->NM_ajax_changed['tasadesc_']) && $this->NM_ajax_changed['tasadesc_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['tasadesc_'] = $this->tasadesc_;
                  }
                  if (isset($this->NM_ajax_changed['devuelto_']) && $this->NM_ajax_changed['devuelto_'])
                  {
                      $this->form_vert_devolucion[$this->nmgp_refresh_row]['devuelto_'] = $this->devuelto_;
                  }
              }
          }
          ...
          foreach($this->form_vert_devolucion as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idpro_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][devolucion_pack_protect_string($aRecData['idpro_'])]),
              );
              }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['colores_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][devolucion_pack_protect_string($aRecData['colores_'])]),
              );
              }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['tallas_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][devolucion_pack_protect_string($aRecData['tallas_'])]),
              );
              }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['sabor_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][devolucion_pack_protect_string($aRecData['sabor_'])]),
              );
              }
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][devolucion_pack_protect_string($aRecData['idbod_'])]),
              );
              }
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      {
          $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert];
          if ($this->nmgp_dados_select['cantidad_'] == $this->cantidad_ &&
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['idpro_'] = $this->idpro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['colores_'] = $this->colores_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['tallas_'] = $this->tallas_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['sabor_'] = $this->sabor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['idbod_'] = $this->idbod_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['valorunit_'] = $this->valorunit_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['descuento_'] = $this->descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['valorpar_'] = $this->valorpar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['iva_'] = $this->iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['tasaiva_'] = $this->tasaiva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['tasadesc_'] = $this->tasadesc_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert]['devuelto_'] = $this->devuelto_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "idpro = $this->idpro_, idbod = $this->idbod_, cantidad = $this->cantidad_, valorunit = $this->valorunit_, valorpar = $this->valorpar_, iva = $this->iva_, descuento = $this->descuento_, tasaiva = $this->tasaiva_, tasadesc = $this->tasadesc_, devuelto = $this->devuelto_, colores = $this->colores_, tallas = $this->tallas_, sabor = $this->sabor_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('cantidad_', 'idpro_', 'colores_', 'tallas_', 'sabor_', 'idbod_', 'valorunit_', 'descuento_', 'valorpar_', 'iva_', 'tasaiva_', 'tasadesc_', 'devuelto_'), $aDoNotUpdate);
      ...
      { 
          ...
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (iddet, idfaccom, idpro, idbod, cantidad, valorunit, valorpar, iva, descuento, tasaiva, tasadesc, devuelto, colores, tallas, sabor) VALUES ($this->iddet_, $this->idfaccom_, $this->idpro_, $this->idbod_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->tasaiva_, $this->tasadesc_, $this->devuelto_, $this->colores_, $this->tallas_, $this->sabor_)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "iddet, idfaccom, idpro, idbod, cantidad, valorunit, valorpar, iva, descuento, tasaiva, tasadesc, devuelto, colores, tallas, sabor) VALUES (" . $NM_seq_auto . "$this->iddet_, $this->idfaccom_, $this->idpro_, $this->idbod_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->tasaiva_, $this->tasadesc_, $this->devuelto_, $this->colores_, $this->tallas_, $this->sabor_)"; 
              }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $tmpLabel_idbod_ = $val_output;
                  ...
                  $this->NM_ajax_info['fldList']['valorpar_' . $this->nmgp_refresh_row]['type']    = 'text';
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['devolucion']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['parms'] = "iddet_?#?$this->iddet_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devolucion']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['devolucion']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_devolucion = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter'] . ")";
          }
      }
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total']))
          {
              ...
              $qt_geral_reg_devolucion = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total'] = $qt_geral_reg_devolucion;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_devolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_devolucion) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] > $qt_geral_reg_devolucion)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = $qt_geral_reg_devolucion - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = ($qt_geral_reg_devolucion + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT iddet, idfaccom, idpro, idbod, cantidad, valorunit, valorpar, iva, descuento, tasaiva, tasadesc, devuelto, colores, tallas, sabor from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT iddet, idfaccom, idpro, idbod, cantidad, valorunit, valorpar, iva, descuento, tasaiva, tasadesc, devuelto, colores, tallas, sabor from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          {
              $sc_seq_vert = 0; 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['empty_filter'] = true;
              }
          }
          else
          {
          ...
          { 
              ...
              $this->nmgp_dados_select['valorunit_'] = $this->valorunit_;
              $this->valorpar_ = trim($rs->fields[6]) ; 
              $this->nmgp_dados_select['valorpar_'] = $this->valorpar_;
              $this->iva_ = $rs->fields[7] ; 
              $this->nmgp_dados_select['iva_'] = $this->iva_;
              $this->descuento_ = trim($rs->fields[8]) ; 
              $this->nmgp_dados_select['descuento_'] = $this->descuento_;
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['parms'] = "iddet_?#?$this->iddet_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_devolucion[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_devolucion[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
          ...
          ksort ($this->form_vert_devolucion); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] < (($qt_geral_reg_devolucion + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['embutida_multi']) 
          { 
          } 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }

//
function actualiza_saldo($parcial, $valiva)
{
$_SESSION['scriptcase']['devolucion']['contr_erro'] = 'on';
if (!isset($this->sc_temp_par_idfaccom)) {$this->sc_temp_par_idfaccom = (isset($_SESSION['par_idfaccom'])) ? $_SESSION['par_idfaccom'] : "";}
  
$idfac=$this->sc_temp_par_idfaccom;
 
      $nm_select = "select 	idprov from facturacom where idfaccom=$idfac"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->des = $this->Db->Execute($nm_select)) 
      { }
...
;
$idprove=substr($this->des , 6); 
$this->nm_mens_alert[] = "el proveedor: $idprove"; $this->nm_params_alert[] = array(); if ($this->NM_ajax_flag) { $this->sc_ajax_alert("el proveedor: $idprove"); } 
      $nm_select = "select saldoapagar from terceros where idtercero=$idprove"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
...
;
$totaldes=$parcial+$valiva;
$descontar=$this->ds[0][0]-$totaldes;
if (isset($this->sc_temp_par_idfaccom)) { $_SESSION['par_idfaccom'] = $this->sc_temp_par_idfaccom;}
$_SESSION['scriptcase']['devolucion']['contr_erro'] = 'off';
}
function actualiza_stock($id, $cantidad)
{
$_SESSION['scriptcase']['devolucion']['contr_erro'] = 'on';
  
 
      $nm_select = "SELECT stockmen FROM productos WHERE idprod=$id"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
$sql="UPDATE productos SET stockmen = ($cant-$cantidad)  WHERE idprod=$id";
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("iddet_", "idfaccom_", "idpro_", "idbod_", "cantidad_", "valorunit_", "valorpar_", "iva_", "descuento_", "tasaiva_", "tasadesc_", "devuelto_"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter_form'] . " and (idfaccom=" . $_SESSION['par_idfaccom'] . ") and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where idfaccom=" . $_SESSION['par_idfaccom'] . " and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) AS countTest from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      $rt = $this->Db->Execute($nmgp_select) ; 
      ...
      $qt_geral_reg_devolucion = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['total'] = $qt_geral_reg_devolucion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          devolucion_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "devolucion_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['nm_run_menu'] = 2;
       $nmgp_saida_form = "devolucion_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['devolucion']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function getButtonIds($buttonName) {
        switch ($buttonName) {
            case "bexcluirsel":
                return array("sc_b_del_t.sc-unique-btn-1");
                break;
            case "ejecutar":
                return array("sc_Ejecutar_top");
                break;
            case "help":
