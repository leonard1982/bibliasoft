  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pagar_pedido_CW_210422" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pagar_pedido_CW_210422_form();
	}
...
?>
  ...
  // ---------- Validate idpedido
  function do_ajax_form_pagar_pedido_CW_210422_validate_idpedido()
  {
    var nomeCampo_idpedido = "idpedido";
    var var_idpedido = scAjaxGetFieldHidden(nomeCampo_idpedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_idpedido(var_idpedido, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_idpedido_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_idpedido

  function do_ajax_form_pagar_pedido_CW_210422_validate_idpedido_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_idpedido_cb

  // ---------- Validate fechaven
  function do_ajax_form_pagar_pedido_CW_210422_validate_fechaven()
  {
    var nomeCampo_fechaven = "fechaven";
    var var_fechaven = scAjaxGetFieldText(nomeCampo_fechaven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_fechaven(var_fechaven, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_fechaven_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_fechaven

  function do_ajax_form_pagar_pedido_CW_210422_validate_fechaven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_fechaven_cb

  // ---------- Validate prefijo_ped
  function do_ajax_form_pagar_pedido_CW_210422_validate_prefijo_ped()
  {
    var nomeCampo_prefijo_ped = "prefijo_ped";
    var var_prefijo_ped = scAjaxGetFieldSelect(nomeCampo_prefijo_ped);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_prefijo_ped(var_prefijo_ped, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_prefijo_ped_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_prefijo_ped

  function do_ajax_form_pagar_pedido_CW_210422_validate_prefijo_ped_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_prefijo_ped_cb

  // ---------- Validate numpedido
  function do_ajax_form_pagar_pedido_CW_210422_validate_numpedido()
  {
    var nomeCampo_numpedido = "numpedido";
    var var_numpedido = scAjaxGetFieldText(nomeCampo_numpedido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_numpedido(var_numpedido, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_numpedido_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_numpedido

  function do_ajax_form_pagar_pedido_CW_210422_validate_numpedido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_numpedido_cb

  // ---------- Validate adicional
  function do_ajax_form_pagar_pedido_CW_210422_validate_adicional()
  {
    var nomeCampo_adicional = "adicional";
    var var_adicional = scAjaxGetFieldText(nomeCampo_adicional);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_adicional(var_adicional, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_adicional_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_adicional

  function do_ajax_form_pagar_pedido_CW_210422_validate_adicional_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_adicional_cb

  // ---------- Validate total
  function do_ajax_form_pagar_pedido_CW_210422_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldText(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_total(var_total, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_total_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_total

  function do_ajax_form_pagar_pedido_CW_210422_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_total_cb

  // ---------- Validate idcli
  function do_ajax_form_pagar_pedido_CW_210422_validate_idcli()
  {
    var nomeCampo_idcli = "idcli";
    var var_idcli = scAjaxGetFieldSelect(nomeCampo_idcli);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_idcli(var_idcli, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_idcli_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_idcli

  function do_ajax_form_pagar_pedido_CW_210422_validate_idcli_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcli";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_idcli_cb

  // ---------- Validate obspago
  function do_ajax_form_pagar_pedido_CW_210422_validate_obspago()
  {
    var nomeCampo_obspago = "obspago";
    var var_obspago = scAjaxGetFieldText(nomeCampo_obspago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_obspago(var_obspago, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_obspago_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_obspago

  function do_ajax_form_pagar_pedido_CW_210422_validate_obspago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "obspago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_obspago_cb

  // ---------- Validate asentada
  function do_ajax_form_pagar_pedido_CW_210422_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldText(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_asentada_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_asentada

  function do_ajax_form_pagar_pedido_CW_210422_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_asentada_cb

  // ---------- Validate formapago
  function do_ajax_form_pagar_pedido_CW_210422_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldSelect(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_formapago(var_formapago, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_formapago_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_formapago

  function do_ajax_form_pagar_pedido_CW_210422_validate_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_formapago_cb

  // ---------- Validate adicional2
  function do_ajax_form_pagar_pedido_CW_210422_validate_adicional2()
  {
    var nomeCampo_adicional2 = "adicional2";
    var var_adicional2 = scAjaxGetFieldText(nomeCampo_adicional2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_adicional2(var_adicional2, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_adicional2_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_adicional2

  function do_ajax_form_pagar_pedido_CW_210422_validate_adicional2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adicional2";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_adicional2_cb

  // ---------- Validate adicional3
  function do_ajax_form_pagar_pedido_CW_210422_validate_adicional3()
  {
    var nomeCampo_adicional3 = "adicional3";
    var var_adicional3 = scAjaxGetFieldText(nomeCampo_adicional3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_adicional3(var_adicional3, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_adicional3_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_adicional3

  function do_ajax_form_pagar_pedido_CW_210422_validate_adicional3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adicional3";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_adicional3_cb

  // ---------- Validate creado_en_movil
  function do_ajax_form_pagar_pedido_CW_210422_validate_creado_en_movil()
  {
    var nomeCampo_creado_en_movil = "creado_en_movil";
    var var_creado_en_movil = scAjaxGetFieldText(nomeCampo_creado_en_movil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_creado_en_movil(var_creado_en_movil, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_creado_en_movil_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_creado_en_movil

  function do_ajax_form_pagar_pedido_CW_210422_validate_creado_en_movil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_creado_en_movil_cb

  // ---------- Validate disponible_en_movil
  function do_ajax_form_pagar_pedido_CW_210422_validate_disponible_en_movil()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagar_pedido_CW_210422_validate_disponible_en_movil(var_disponible_en_movil, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_validate_disponible_en_movil_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_validate_disponible_en_movil

  function do_ajax_form_pagar_pedido_CW_210422_validate_disponible_en_movil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagar_pedido_CW_210422_validate_disponible_en_movil_cb

  // ---------- Event onchange adicional2
  function do_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange()
  {
    var var_adicional2 = scAjaxGetFieldText("adicional2");
    var var_total = scAjaxGetFieldText("total");
    var var_adicional3 = scAjaxGetFieldText("adicional3");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange(var_adicional2, var_total, var_adicional3, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange

  function do_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "adicional2";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange_cb_after_alert);
  } // do_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange_cb
  function do_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pagar_pedido_CW_210422_event_adicional2_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pagar_pedido_CW_210422_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pagar_pedido_CW_210422_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_adicional = scAjaxGetFieldText("adicional");
    var var_total = scAjaxGetFieldText("total");
    var var_idcli = scAjaxGetFieldSelect("idcli");
    var var_obspago = scAjaxGetFieldText("obspago");
    var var_asentada = scAjaxGetFieldText("asentada");
    ...
    scAjaxProcOn();
    x_ajax_form_pagar_pedido_CW_210422_submit_form(var_idpedido, var_fechaven, var_prefijo_ped, var_numpedido, var_adicional, var_total, var_idcli, var_obspago, var_asentada, var_formapago, var_adicional2, var_adicional3, var_creado_en_movil, var_disponible_en_movil, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pagar_pedido_CW_210422_submit_form_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_submit_form

  function do_ajax_form_pagar_pedido_CW_210422_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("obspago");
      scAjaxHideErrorDisplay("asentada");
      scAjaxHideErrorDisplay("formapago");
      scAjaxHideErrorDisplay("adicional2");
      scAjaxHideErrorDisplay("adicional3");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pagar_pedido_CW_210422_submit_form_cb_after_alert);
  } // do_ajax_form_pagar_pedido_CW_210422_submit_form_cb
  function do_ajax_form_pagar_pedido_CW_210422_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pagar_pedido_CW_210422_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pagar_pedido_CW_210422_navigate_form()
  {
    perform_ajax_form_pagar_pedido_CW_210422_navigate_form();
  }

  function perform_ajax_form_pagar_pedido_CW_210422_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pagar_pedido_CW_210422_navigate_form(var_idpedido, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagar_pedido_CW_210422_navigate_form_cb);
  } // do_ajax_form_pagar_pedido_CW_210422_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagar_pedido_CW_210422']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pagar_pedido_CW_210422_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pagar_pedido_CW_210422_navigate_form_cb_after_alert);
  } // do_ajax_form_pagar_pedido_CW_210422_navigate_form_cb
  function do_ajax_form_pagar_pedido_CW_210422_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_pagar_pedido_CW_210422_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pagar_pedido_CW_210422_navigate_form_cb_after_alert
  function sc_hide_form_pagar_pedido_CW_210422_form()
  {
  ...
  ajax_field_list[1] = "fechaven";
  ajax_field_list[2] = "prefijo_ped";
  ajax_field_list[3] = "numpedido";
  ajax_field_list[4] = "adicional";
  ajax_field_list[5] = "total";
  ajax_field_list[6] = "idcli";
  ajax_field_list[7] = "obspago";
  ajax_field_list[8] = "asentada";
  ajax_field_list[9] = "formapago";
  ajax_field_list[10] = "adicional2";
  ajax_field_list[11] = "adicional3";
  ...
  var ajax_error_list = {
    ...
    "prefijo_ped": {"label": "Prefijo Ped", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numpedido": {"label": "Pedido #", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "total": {"label": "Total Venta", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcli": {"label": "Cliente", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "obspago": {"label": "Notas del Pago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "formapago": {"label": "Formapago", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "adicional2": {"label": "Ingresar Cantidad Pagada", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "adicional3": {"label": "Cambio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "asentada": new Array(),
    "formapago": new Array(),
    "adicional2": new Array(),
    "adicional3": new Array(),
  ...
  ajax_field_mult["obspago"][1] = "obspago";
  ajax_field_mult["asentada"][1] = "asentada";
  ajax_field_mult["formapago"][1] = "formapago";
  ajax_field_mult["adicional2"][1] = "adicional2";
  ajax_field_mult["adicional3"][1] = "adicional3";
  ...
  var ajax_field_id = {
    ...
    "obspago": new Array("hidden_field_label_obspago", "hidden_field_data_obspago"),
    "formapago": new Array("hidden_field_label_formapago", "hidden_field_data_formapago"),
    "adicional2": new Array("hidden_field_label_adicional2", "hidden_field_data_adicional2"),
    "adicional3": new Array("hidden_field_label_adicional3", "hidden_field_data_adicional3")
  };
