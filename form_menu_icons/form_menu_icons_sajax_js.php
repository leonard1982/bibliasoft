  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_menu_icons" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_menu_icons_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_icons_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_menu_icons_validate_descripcion_cb);
  } // do_ajax_form_menu_icons_validate_descripcion

  function do_ajax_form_menu_icons_validate_descripcion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_icons_validate_descripcion_cb

  // ---------- Validate palabra_clave
  function do_ajax_form_menu_icons_validate_palabra_clave()
  {
    var nomeCampo_palabra_clave = "palabra_clave";
    var var_palabra_clave = scAjaxGetFieldText(nomeCampo_palabra_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_menu_icons_validate_palabra_clave(var_palabra_clave, var_script_case_init, do_ajax_form_menu_icons_validate_palabra_clave_cb);
  } // do_ajax_form_menu_icons_validate_palabra_clave

  function do_ajax_form_menu_icons_validate_palabra_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "palabra_clave";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_icons_validate_palabra_clave_cb

  // ---------- Validate icon
  function do_ajax_form_menu_icons_validate_icon()
  {
  } // do_ajax_form_menu_icons_validate_icon

  function do_ajax_form_menu_icons_validate_icon_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icon";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_menu_icons_validate_icon_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_menu_icons_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_menu_icons_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_descripcion = scAjaxGetFieldText("descripcion");
    var var_palabra_clave = scAjaxGetFieldText("palabra_clave");
    var var_icon = scAjaxGetFieldHidden("icon");
    var var_descripcion_ul_name = scAjaxSpecCharProtect(document.F1.descripcion_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_descripcion_ul_type = document.F1.descripcion_ul_type.value;
    var var_descripcion_salva = scAjaxSpecCharProtect(document.F1.descripcion_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_descripcion_limpa = document.F1.descripcion_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_menu_icons_submit_form(var_descripcion, var_palabra_clave, var_icon, var_descripcion_ul_name, var_descripcion_ul_type, var_descripcion_salva, var_descripcion_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_menu_icons_submit_form_cb);
  } // do_ajax_form_menu_icons_submit_form

  function do_ajax_form_menu_icons_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("palabra_clave");
      scAjaxHideErrorDisplay("icon");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.descripcion_limpa && document.F1.descripcion_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("descripcion", oImgTemp, "", "", "", "N");
      }
    document.F1.descripcion_ul_name.value = '';
    document.F1.descripcion_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_menu_icons_submit_form_cb_after_alert);
  } // do_ajax_form_menu_icons_submit_form_cb
  function do_ajax_form_menu_icons_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_menu_icons_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_menu_icons_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_menu_icons_navigate_form, function() {});
    } else {
      perform_ajax_form_menu_icons_navigate_form();
    }
  }

  function perform_ajax_form_menu_icons_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("palabra_clave");
    scAjaxHideErrorDisplay("icon");
    var var_id_icon = document.F2.id_icon.value;
    ...
    scAjaxProcOn();
    x_ajax_form_menu_icons_navigate_form(var_id_icon, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_menu_icons_navigate_form_cb);
  } // do_ajax_form_menu_icons_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_menu_icons']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_menu_icons_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_icon.value = scAjaxGetKeyValue("id_icon");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_menu_icons_navigate_form_cb_after_alert);
  } // do_ajax_form_menu_icons_navigate_form_cb
  function do_ajax_form_menu_icons_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_menu_icons_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_menu_icons_navigate_form_cb_after_alert
  function sc_hide_form_menu_icons_form()
  {
  ...
  ajax_field_list[1] = "palabra_clave";
  ajax_field_list[2] = "icon";
  ...
  var ajax_error_list = {
    ...
    "palabra_clave": {"label": "Palabras Claves", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "icon": {"label": "icon", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "palabra_clave": new Array(),
    "icon": new Array()
  };
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["palabra_clave"][1] = "palabra_clave";
  ajax_field_mult["icon"][1] = "icon";

  var ajax_field_id = {
    "descripcion": new Array("hidden_field_label_descripcion", "hidden_field_data_descripcion"),
    "palabra_clave": new Array("hidden_field_label_palabra_clave", "hidden_field_data_palabra_clave"),
    "icon": new Array("hidden_field_label_icon", "hidden_field_data_icon")
  };
