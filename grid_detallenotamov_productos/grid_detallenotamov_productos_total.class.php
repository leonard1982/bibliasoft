...
class grid_detallenotamov_productos_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_detallenotamov_productos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_detallenotamov_productos']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $fl_producto, $fl_colores, $fl_tallas, $fl_sabor, $fl_destino;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(fl.cantidad) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq']; 
      } 
      ...
      if ($rt->fields[0] == 0)
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['interativ_search']))
          {
              $Contrl_Interat = 1;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['interativ_search'] = array();
              $this->quebra_geral_fecha();
          }
          
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['contr_total_geral'] = "OK";
   } 
   ...
   {
      global $tot_p_fecha, $fl_producto, $fl_colores, $fl_tallas, $fl_sabor, $fl_destino;
      $tot_p_fecha = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(fl.cantidad) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq']; 
   ...
   //-----  fl_producto
   function quebra_fl_producto_producto($fl_producto, $arg_sum_fl_producto) 
   {
      global $tot_fl_producto, $fl_producto, $fl_colores, $fl_tallas, $fl_sabor, $fl_destino;
      $tot_fl_producto = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(fl.cantidad) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq']; 
      } 
      ...
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq'])) 
      { 
         $nm_comando .= " where fl.producto" . $arg_sum_fl_producto ; 
      } 
      else 
      { 
         $nm_comando .= " and fl.producto" . $arg_sum_fl_producto ; 
      } 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = '';
      if (!$rt = $this->Db->Execute($nm_comando)) 
      ...
      $tot_fl_producto[0] = NM_encode_input(sc_strip_script($fl_producto)) ; 
      $tot_fl_producto[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_fl_producto[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
   } 
   ...
   {
      global $nm_lang, $fl_producto, $fl_colores, $fl_tallas, $fl_sabor, $fl_destino;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['SC_Ind_Groupby'];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_fecha($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('fl_idnota' => 'N','fl_idmovi' => 'N','fl_producto' => 'N','fl_destino' => 'N','fl_cantidad' => 'N','fl_colores' => 'N','fl_tallas' => 'N','fl_sabor' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(fl.cantidad)#@#cmps_quebras#@# from " . $this->Ini->nm_tabela . " " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1)#@#cmps_quebras#@# from (";
         $comando .= "select fl.cantidad as SC_metric1, " . $cmps_quebras1 . " from " . $this->Ini->nm_tabela . " " .  $where_ok . ") SC_sel1 INNER JOIN (";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
   ...
   function Calc_resumo_producto($destino_resumo)
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq'];
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['SC_Ind_Groupby'];
      $cmp_sql_def   = array('fl_producto' => "fl.producto");
      $cmps_quebra_atual = array("fl_producto");
      $ult_cmp_quebra_atual = $cmps_quebra_atual[(count($cmps_quebra_atual) - 1)];
      $arr_tots = "";
      $join     = "";
      $group    = "";
   ...
   function Res_Totaliza_producto($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $format_dimensions = array();
      $format_dimensions['fl_producto']['reg'] = "S";
      $format_dimensions['fl_producto']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              $$Cada_dim = $SC_prep['fmt'];
              $$SC_orig = $SC_prep['orig'];
              if ($Cada_dim == "fl_producto") {
                  $this->Lookup->lookup_producto_fl_producto($$Cada_dim,  $fl_producto);
              }
              if (null === $$Cada_dim)
              {
                  $$Cada_dim = '';
