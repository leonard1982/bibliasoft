...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallenotamov_productos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallenotamov_productos"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallenotamov_productos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallenotamov_productos']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_detallenotamov_productos' || $achou)
          {
