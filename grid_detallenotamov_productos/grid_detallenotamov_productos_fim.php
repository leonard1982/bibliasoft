...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallenotamov_productos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallenotamov_productos"]);
   }
