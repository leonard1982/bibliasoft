...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- 
      $this->array_total_fl_producto = array();
      //---- 
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Artículo";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['contr_label_graf']['fl_producto']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['contr_label_graf']['fl_producto']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['contr_label_graf']['fl_producto'];
      }
   }
