 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_p_fecha_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['p_fecha'])) ? $this->New_label['p_fecha'] : "Fecha"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_p_fecha_cond" name="p_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_fecha'), this, 'p_fecha')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_p_fecha" <?php echo $str_hide_p_fecha?> valign="top">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_p_fecha"  <?php echo $str_display_p_fecha; ?> class="scFilterFieldFontOdd">
...
?>
      ...
      <TD id='SC_fl_producto_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fl_producto'])) ? $this->New_label['fl_producto'] : "Artículo"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_fl_producto_cond" name="fl_producto_cond" onChange="nm_campos_between(document.getElementById('id_vis_fl_producto'), this, 'fl_producto')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fl_producto" <?php echo $str_hide_fl_producto?> valign="top">
