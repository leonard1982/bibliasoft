<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallenotamov_productos']['sc_process_barr'] = true;
require_once('../grid_detallenotamov_productos/index.php');
unset($_SESSION['scriptcase']['grid_detallenotamov_productos']['sc_process_barr']);
$ExportCtrl = new grid_detallenotamov_productos_export_control;
$ExportCtrl->Export_barr();

class grid_detallenotamov_productos_export_control
{
