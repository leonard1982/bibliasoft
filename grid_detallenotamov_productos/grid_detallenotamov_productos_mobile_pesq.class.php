...
class grid_detallenotamov_productos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detallenotamov_productos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detallenotamov_productos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detallenotamov_productos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_fl_producto')
      {
          $fl_producto = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_fl_producto($fl_producto);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_fl_producto($fl_producto)
   {
      $fl_producto = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $fl_producto);
      $fl_producto = substr($this->Db->qstr($fl_producto), 1, -1);
            $fl_producto_look = substr($this->Db->qstr($fl_producto), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct fl.producto from " . $this->Ini->nm_tabela . " where   CAST (fl.producto AS TEXT)  like '%" . $fl_producto . "%' order by fl.producto"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct fl.producto from " . $this->Ini->nm_tabela . " where   CAST (fl.producto AS VARCHAR)  like '%" . $fl_producto . "%' order by fl.producto"; 
      }
      else
      {
          $nm_comando = "select distinct fl.producto from " . $this->Ini->nm_tabela . " where  fl.producto like '%" . $fl_producto . "%' order by fl.producto"; 
      }
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "p.fecha";$Nm_datas[] = "p_fecha";$Nm_numeric[] = "fl_idnota";$Nm_numeric[] = "fl_idmovi";$Nm_numeric[] = "fl_producto";$Nm_numeric[] = "fl_destino";$Nm_numeric[] = "fl_cantidad";$Nm_numeric[] = "fl_colores";$Nm_numeric[] = "fl_tallas";$Nm_numeric[] = "fl_sabor";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "p.fecha";$Nm_datas[] = "p_fecha";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detallenotamov_productos/grid_detallenotamov_productos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detallenotamov_productos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detallenotamov_productos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detallenotamov_productos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallenotamov_productos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallenotamov_productos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_p_fecha_cond#NMF#' + search_get_sel_txt('SC_p_fecha_cond') + '@NMF@';
  str_out += 'SC_p_fecha_dia#NMF#' + search_get_sel_txt('SC_p_fecha_dia') + '@NMF@';
  str_out += 'SC_p_fecha_mes#NMF#' + search_get_sel_txt('SC_p_fecha_mes') + '@NMF@';
  str_out += 'SC_p_fecha_ano#NMF#' + search_get_sel_txt('SC_p_fecha_ano') + '@NMF@';
  str_out += 'SC_p_fecha_input_2_dia#NMF#' + search_get_sel_txt('SC_p_fecha_input_2_dia') + '@NMF@';
  str_out += 'SC_p_fecha_input_2_mes#NMF#' + search_get_sel_txt('SC_p_fecha_input_2_mes') + '@NMF@';
  str_out += 'SC_p_fecha_input_2_ano#NMF#' + search_get_sel_txt('SC_p_fecha_input_2_ano') + '@NMF@';
  str_out += 'SC_fl_producto_cond#NMF#' + search_get_sel_txt('SC_fl_producto_cond') + '@NMF@';
  str_out += 'SC_fl_producto#NMF#' + search_get_text('SC_fl_producto') + '@NMF@';
  str_out += 'id_ac_fl_producto#NMF#' + search_get_title('select2-id_ac_fl_producto-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-fl_producto").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_fl_producto",
      max_itens: "10",
   ...
   $("#SC_fl_producto").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Productos terminados x traslado</span></td>
...
<?php
   ...
   {
      global 
             $p_fecha_cond, $p_fecha, $p_fecha_dia, $p_fecha_mes, $p_fecha_ano, $p_fecha_input_2_dia, $p_fecha_input_2_mes, $p_fecha_input_2_ano,
             $fl_producto_cond, $fl_producto, $fl_producto_autocomp,
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $p_fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_dia']; 
          $p_fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_mes']; 
          $p_fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_ano']; 
          $p_fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_input_2_dia']; 
          $p_fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_input_2_mes']; 
          $p_fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_input_2_ano']; 
          $p_fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_cond']; 
          $fl_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['fl_producto']; 
          $fl_producto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['fl_producto_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['NM_operador']; 
      } 
      if (!isset($p_fecha_cond) || empty($p_fecha_cond))
      {
         $p_fecha_cond = "eq";
      }
      if (!isset($fl_producto_cond) || empty($fl_producto_cond))
      {
         $fl_producto_cond = "eq";
      }
      ...
      $str_hide_p_fecha = (in_array($p_fecha_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_fl_producto = (in_array($fl_producto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_p_fecha = ('bw' == $p_fecha_cond) ? $display_aberto : $display_fechado;
      $str_display_fl_producto = ('bw' == $fl_producto_cond) ? $display_aberto : $display_fechado;

      if (!isset($p_fecha) || $p_fecha == "")
      {
          $p_fecha = "";
      }
      if (isset($p_fecha) && !empty($p_fecha))
      {
      ...
      if (!isset($fl_producto) || $fl_producto == "")
      {
          $fl_producto = "";
      }
      if (isset($fl_producto) && !empty($fl_producto))
      {
...
?>
 ...
 $nmgp_tab_label .= "p_fecha?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_p_fecha_cond" name="p_fecha_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_fecha'), this, 'p_fecha')">
       <OPTION value="eq" <?php if ("eq" == $p_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $p_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $p_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $p_fecha_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_p_fecha"  <?php echo $str_hide_p_fecha?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecha_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fecha_dia" name="p_fecha_dia" value="<?php echo NM_encode_input($p_fecha_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecha_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fecha_mes" name="p_fecha_mes" value="<?php echo NM_encode_input($p_fecha_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecha_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fecha_ano" name="p_fecha_ano" value="<?php echo NM_encode_input($p_fecha_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_p_fecha"  class="scFilterFieldFontOdd">
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_p_fecha"  <?php echo $str_display_p_fecha; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecha_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fecha_input_2_dia" name="p_fecha_input_2_dia" value="<?php echo NM_encode_input($p_fecha_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecha_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fecha_input_2_mes" name="p_fecha_input_2_mes" value="<?php echo NM_encode_input($p_fecha_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecha_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_p_fecha_input_2_ano" name="p_fecha_input_2_ano" value="<?php echo NM_encode_input($p_fecha_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
 ...
 $SC_Label = (isset($this->New_label['fl_producto'])) ? $this->New_label['fl_producto'] : "Artículo";
 $nmgp_tab_label .= "fl_producto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fl_producto_cond" name="fl_producto_cond" onChange="nm_campos_between(document.getElementById('id_vis_fl_producto'), this, 'fl_producto')">
       <OPTION value="eq" <?php if ("eq" == $fl_producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $fl_producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_fl_producto"  <?php echo $str_hide_fl_producto?>><?php
      if ($fl_producto != "")
      {
      $fl_producto_look = substr($this->Db->qstr($fl_producto), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($fl_producto))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct fl.producto from " . $this->Ini->nm_tabela . " where fl.producto = $fl_producto_look order by fl.producto"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct fl.producto from " . $this->Ini->nm_tabela . " where fl.producto = $fl_producto_look order by fl.producto"; 
      ...
      if (isset($nmgp_def_dados[0][$fl_producto]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$fl_producto];
      }
      else
      {
            nmgp_Form_Num_Val($fl_producto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $fl_producto;
      }
?>
<INPUT  type="text" id="SC_fl_producto" name="fl_producto" value="<?php echo NM_encode_input($fl_producto) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-fl_producto" id="id_ac_fl_producto" name="fl_producto_autocomp"><?php if ('' !=  $fl_producto) { ?><option value="<?php echo $fl_producto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<?php
   if (is_file("grid_detallenotamov_productos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallenotamov_productos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detallenotamov_productos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallenotamov_productos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detallenotamov_productos']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.p_fecha_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_p_fecha'), document.F1.p_fecha_cond, 'p_fecha');
   document.F1.p_fecha_dia.value = "";
   document.F1.p_fecha_mes.value = "";
   document.F1.p_fecha_ano.value = "";
   document.F1.p_fecha_input_2_dia.value = "";
   document.F1.p_fecha_input_2_mes.value = "";
   document.F1.p_fecha_input_2_ano.value = "";
   document.F1.fl_producto_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fl_producto'), document.F1.fl_producto_cond, 'fl_producto');
   document.F1.fl_producto.value = "";
   document.F1.fl_producto_autocomp.value = "";
   $('#select2-id_ac_fl_producto-container').html('<?php echo $this->Val_init_fl_producto['desc'] ?>');;
   Sc_carga_select2('all');
 }
 ...
 {
    $('#SC_p_fecha_dia').bind('change', function() {sc_grid_detallenotamov_productos_valida_dia(this)});
    $('#SC_p_fecha_input_2_dia').bind('change', function() {sc_grid_detallenotamov_productos_valida_dia(this)});
    $('#SC_p_fecha_input_2_mes').bind('change', function() {sc_grid_detallenotamov_productos_valida_mes(this)});
    $('#SC_p_fecha_mes').bind('change', function() {sc_grid_detallenotamov_productos_valida_mes(this)});
 }
 function sc_grid_detallenotamov_productos_valida_dia(obj)
 {
 ...
 function sc_grid_detallenotamov_productos_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_orig'] = "";
      }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_p_fecha_cond'] = 'cond';
      $tp_fields['SC_p_fecha_dia'] = 'text';
      $tp_fields['SC_p_fecha_mes'] = 'text';
      $tp_fields['SC_p_fecha_ano'] = 'text';
      $tp_fields['SC_p_fecha_input_2_dia'] = 'text';
      $tp_fields['SC_p_fecha_input_2_mes'] = 'text';
      $tp_fields['SC_p_fecha_input_2_ano'] = 'text';
      $tp_fields['SC_fl_producto_cond'] = 'cond';
      $tp_fields['SC_fl_producto'] = 'text_aut';
      $tp_fields['id_ac_fl_producto'] = 'select2_aut';
   ...
   {
      global $p_fecha_cond, $p_fecha, $p_fecha_dia, $p_fecha_mes, $p_fecha_ano, $p_fecha_input_2_dia, $p_fecha_input_2_mes, $p_fecha_input_2_ano,
             $fl_producto_cond, $fl_producto, $fl_producto_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($fl_producto_autocomp) && empty($fl_producto))
      {
          $fl_producto = $fl_producto_autocomp;
      }
      $p_fecha_cond_salva = $p_fecha_cond; 
      if (!isset($p_fecha_input_2_dia) || $p_fecha_input_2_dia == "")
      {
          $p_fecha_input_2_dia = $p_fecha_dia;
      }
      if (!isset($p_fecha_input_2_mes) || $p_fecha_input_2_mes == "")
      {
          $p_fecha_input_2_mes = $p_fecha_mes;
      }
      if (!isset($p_fecha_input_2_ano) || $p_fecha_input_2_ano == "")
      {
          $p_fecha_input_2_ano = $p_fecha_ano;
      }
      $fl_producto_cond_salva = $fl_producto_cond; 
      if (!isset($fl_producto_input_2) || $fl_producto_input_2 == "")
      {
          $fl_producto_input_2 = $fl_producto;
      }
      if ($fl_producto_cond != "in")
      {
          nm_limpa_numero($fl_producto, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_dia'] = $p_fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_mes'] = $p_fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_ano'] = $p_fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_input_2_dia'] = $p_fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_input_2_mes'] = $p_fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_input_2_ano'] = $p_fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_cond'] = $p_fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['fl_producto'] = $fl_producto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['fl_producto_cond'] = $fl_producto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca'] = $Temp_Busca;
      }
      if ($fl_producto_cond != "in" && $fl_producto_cond != "bw" && !empty($fl_producto) && !is_numeric($fl_producto))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Artículo";
      }
      if ($fl_producto_cond == "bw" && ((!empty($fl_producto) && !is_numeric($fl_producto)) || (!empty($fl_producto_input_2) && !is_numeric($fl_producto_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Artículo";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['fl_producto'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['fl_producto'] = $cmp1;
      }
      else
      {
          $cmp1 = $fl_producto;
      ...
      if ($p_fecha_cond != "bi_TP")
      {
          $p_fecha_cond = strtoupper($p_fecha_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $p_fecha_ano;
          $Dtxt .= $p_fecha_mes;
          $Dtxt .= $p_fecha_dia;
          $val[0]['ano'] = $p_fecha_ano;
          $val[0]['mes'] = $p_fecha_mes;
          $val[0]['dia'] = $p_fecha_dia;
          if ($p_fecha_cond == "BW")
          {
              $val[1]['ano'] = $p_fecha_input_2_ano;
              $val[1]['mes'] = $p_fecha_input_2_mes;
              $val[1]['dia'] = $p_fecha_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $p_fecha_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $p_fecha_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $p_fecha = $val[0];
          $this->cmp_formatado['p_fecha'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['p_fecha'], "YYYY-MM-DD");
          $this->cmp_formatado['p_fecha'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($p_fecha_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $p_fecha_input_2     = $val[1];
              $this->cmp_formatado['p_fecha_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']['p_fecha_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['p_fecha_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['p_fecha_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $p_fecha_cond == "NU" || $p_fecha_cond == "NN"|| $p_fecha_cond == "EP"|| $p_fecha_cond == "NE")
          {
              $this->monta_condicao("p.fecha", $p_fecha_cond, $p_fecha, $p_fecha_input_2, 'p_fecha', 'DATE');
          }
      }

      //----- $fl_producto
      $this->Date_part = false;
      if (isset($fl_producto) || $fl_producto_cond == "nu" || $fl_producto_cond == "nn" || $fl_producto_cond == "ep" || $fl_producto_cond == "ne")
      {
         $this->monta_condicao("fl.producto", $fl_producto_cond, $fl_producto, "", "fl_producto");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq_fast'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['where_pesq'];
