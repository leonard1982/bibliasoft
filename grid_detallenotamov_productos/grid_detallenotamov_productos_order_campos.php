...
<?php
   ...
   $Ord_Cmp = new grid_detallenotamov_productos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallenotamov_productos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['fl_idmovi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_idmovi'] = "fl_idmovi";
   }
   else
   {
       $tab_def_campos['fl_idmovi'] = "fl.idmovi";
   }
   $tab_labels["fl_idmovi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_idmovi"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_idmovi"] : "Nota Inv.";
   $tab_ger_campos['p_fecha'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_fecha'] = "p_fecha";
   }
   else
   {
       $tab_def_campos['p_fecha'] = "p.fecha";
   }
   $tab_labels["p_fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["p_fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["p_fecha"] : "Fecha";
   $tab_ger_campos['fl_producto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_producto'] = "fl_producto";
   }
   else
   {
       $tab_def_campos['fl_producto'] = "fl.producto";
   }
   $tab_labels["fl_producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_producto"] : "Artículo";
   $tab_ger_campos['fl_colores'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_colores'] = "fl_colores";
   }
   else
   {
       $tab_def_campos['fl_colores'] = "fl.colores";
   }
   $tab_labels["fl_colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_colores"] : "Colores";
   $tab_ger_campos['fl_tallas'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_tallas'] = "fl_tallas";
   }
   else
   {
       $tab_def_campos['fl_tallas'] = "fl.tallas";
   }
   $tab_labels["fl_tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_tallas"] : "Tallas";
   $tab_ger_campos['fl_sabor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_sabor'] = "fl_sabor";
   }
   else
   {
       $tab_def_campos['fl_sabor'] = "fl.sabor";
   }
   $tab_labels["fl_sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_sabor"] : "Sabor";
   $tab_ger_campos['fl_cantidad'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_cantidad'] = "fl_cantidad";
   }
   else
   {
       $tab_def_campos['fl_cantidad'] = "fl.cantidad";
   }
   $tab_labels["fl_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_cantidad"] : "Cantidad";
   $tab_ger_campos['fl_presentacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_presentacion'] = "fl_presentacion";
   }
   else
   {
       $tab_def_campos['fl_presentacion'] = "fl.presentacion";
   }
   $tab_labels["fl_presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_presentacion"] : "Presentación/Unidad";
   $tab_ger_campos['fl_destino'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fl_destino'] = "fl_destino";
   }
   else
   {
       $tab_def_campos['fl_destino'] = "fl.destino";
   }
   $tab_labels["fl_destino"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_destino"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['labels']["fl_destino"] : "Destino";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallenotamov_productos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallenotamov_productos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
