...
class grid_detallenotamov_productos_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fl_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['arr_total']['fl_producto'];
      }
      else
      {
          $this->array_total_fl_producto = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['arr_total']['fl_producto'] = $this->array_total_fl_producto;
   ...
   function completeMatrix()
   {
       ...
       {
          $Lab_fl_producto = "fl.producto";
       }
       else
       {
       $Lab_fl_producto = "Artículo";
       }
       $this->comp_field = array(
           $Lab_fl_producto,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_order']['producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_order']['producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_order']['producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_display']['producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_display']['producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_display']['producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_display']['producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_display']['producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_display']['producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['summarizing_fields_display']['producto'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_fl_producto as $i_fl_producto => $d_fl_producto) {
           if (!in_array($i_fl_producto, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fl_producto[4] ] = $d_fl_producto[3];
               $this->comp_label[0][ $d_fl_producto[4] ] = $d_fl_producto[3];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_fl_producto => $l_fl_producto) {
           if (isset($this->array_total_fl_producto[$i_fl_producto])) {
               $this->comp_group[$i_fl_producto] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_fl_producto;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_fl_producto)),
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      ksort($this->array_total_fl_producto);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov_productos']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_fl_cantidad, $quebra_fl_producto, $quebra_fl_producto_orig)
   {
      //----- Artículo
      if (!isset($this->array_total_fl_producto[$quebra_fl_producto_orig]))
      {
         $this->array_total_fl_producto[$quebra_fl_producto_orig][0] = 1;
         $this->array_total_fl_producto[$quebra_fl_producto_orig][1] = $sum_fl_cantidad;
         $this->array_total_fl_producto[$quebra_fl_producto_orig][2] = 1;
         $this->array_total_fl_producto[$quebra_fl_producto_orig][3] = $quebra_fl_producto;
         $this->array_total_fl_producto[$quebra_fl_producto_orig][4] = $quebra_fl_producto_orig;
      }
      else
      {
         $this->array_total_fl_producto[$quebra_fl_producto_orig][0]++;
         $this->array_total_fl_producto[$quebra_fl_producto_orig][1] += $sum_fl_cantidad;
         $this->array_total_fl_producto[$quebra_fl_producto_orig][2]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'fl_producto');
     $campos_order = $this->Ini->Get_date_order_groupby("fl.producto", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fl_producto_orig = $this->fl_producto;
            $this->fl_producto = $this->look_fl_producto ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->fl_cantidad, $this->fl_producto, $this->fl_producto_orig);
            }
   }
//
