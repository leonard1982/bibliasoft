<?php
   ...
   session_start();
    ...
    $exportEmail = new exportEmail_grid_reporte_impuestos(); 
   
class exportEmail_grid_reporte_impuestos
{
...
<HEAD>
 <TITLE><?php echo "Reporte Impuestos"; ?></TITLE>
...
?>
            ...
            function html_export_email_send()
            {
                $.ajax({
                    type: 'POST',
                    url: 'grid_reporte_impuestos_export_email.php',
