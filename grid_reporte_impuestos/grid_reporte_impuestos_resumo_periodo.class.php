...
class grid_reporte_impuestos_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['dashboard_info']['under_dashboard'] ? "off" : "on";
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_reporte_impuestos']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_reporte_impuestos']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['contr_total_geral'] == "OK")
      {
          $this->array_total_fechaven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['arr_total']['fechaven'];
      }
      else
      {
          $this->array_total_fechaven = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][4];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][5];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][6];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][7];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][8];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][9];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][10];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['arr_total']['fechaven'] = $this->array_total_fechaven;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['json_use_label'])
       {
       ...
       {
       $Lab_fechaven = "Fecha";
       $Lab_fechaven =  sprintf("" . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMM'] . "", $Lab_fechaven);
       }
       $this->comp_field = array(
           $Lab_fechaven,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['fechaven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['fechaven'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['numero2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['numero2'] = "Numero 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['idcli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['idcli'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['subtotal'] = "SubTotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['valoriva'] = "Impuesto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['base_iva_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['base_iva_19'] = "Base 19"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['valor_iva_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['valor_iva_19'] = "IVA 19"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['base_iva_5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['base_iva_5'] = "Base 5"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['valor_iva_5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['valor_iva_5'] = "IVA 5"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['excento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['excento'] = "Exento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['ing_terceros']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['ing_terceros'] = "Ing/Terceros"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['idfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['idfacven'] = "Idfacven"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['numfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['numfacven'] = "Numfacven"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['credito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['credito'] = "Credito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['fechavenc'] = "Fechavenc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['adicional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['adicional'] = "Adicional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['adicional2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['adicional2'] = "Adicional 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['adicional3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['adicional3'] = "Adicional 3"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['adicional4']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['adicional4'] = "Adicional 4"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['vendedor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['vendedor'] = "Vendedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['creado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['creado'] = "Creado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['editado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['editado'] = "Editado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['usuario_crea']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['usuario_crea'] = "Usuario Crea"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['inicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['inicio'] = "Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['fin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['fin'] = "Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['dias_decredito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['dias_decredito'] = "Dias Decredito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['fecha_validacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['fecha_validacion'] = "Fecha Validacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['cufe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['cufe'] = "Cufe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['direccion'] = "Direccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['periodo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['periodo'] = "Periodo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['anio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['anio'] = "Anio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['documento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['documento'] = "Documento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['correo_receptor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['correo_receptor'] = "Correo que recibe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['asunto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['asunto'] = "Asunto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['mensaje']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['labels']['mensaje'] = "Mensaje"; 
       }
       //-----
       $this->comp_field_nm = array(
           'fechaven' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Impuesto (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           4 => "Total (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           5 => "Base 19 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           6 => "IVA 19 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           7 => "Base 5 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           8 => "IVA 5 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           9 => "Exento (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           10 => "Ing/Terceros (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_order']['periodo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_order']['periodo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_order']['periodo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_display']['periodo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_display']['periodo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_display']['periodo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_display']['periodo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_display']['periodo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_display']['periodo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['summarizing_fields_display']['periodo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "subtotal", 'show' => true),
           3 => array('field' => "valoriva", 'show' => true),
           4 => array('field' => "total", 'show' => true),
           5 => array('field' => "base_iva_19", 'show' => true),
           6 => array('field' => "valor_iva_19", 'show' => true),
           7 => array('field' => "base_iva_5", 'show' => true),
           8 => array('field' => "valor_iva_5", 'show' => true),
           9 => array('field' => "excento", 'show' => true),
           10 => array('field' => "ing_terceros", 'show' => true),
       );
       ...
       $this->comp_sum_css = array(
           ...
           3 => "css_valoriva_sum",
           4 => "css_total_sum",
           5 => "css_base_iva_19_sum",
           6 => "css_valor_iva_19_sum",
           7 => "css_base_iva_5_sum",
           8 => "css_valor_iva_5_sum",
           9 => "css_excento_sum",
           10 => "css_ing_terceros_sum",
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_reporte_impuestos@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("SubTotal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("SubTotal (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Impuesto (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("Impuesto (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
           ...
           '0|4' => array(
               'title'    => $this->getChartText(strip_tags("Base 19 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[5],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("Base 19 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(4),
           ),
           '0|5' => array(
               'title'    => $this->getChartText(strip_tags("IVA 19 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[6],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("IVA 19 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(5),
           ),
           '0|6' => array(
               'title'    => $this->getChartText(strip_tags("Base 5 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[7],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("Base 5 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(6),
           ),
           '0|7' => array(
               'title'    => $this->getChartText(strip_tags("IVA 5 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[8],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("IVA 5 (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(7),
           ),
           '0|8' => array(
               'title'    => $this->getChartText(strip_tags("Exento (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[9],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("Exento (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'format'   => $this->formatChartValue(8),
           ),
           '0|9' => array(
               'title'    => $this->getChartText(strip_tags("Ing/Terceros (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[10],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("Ing/Terceros (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_reporte_impuestos_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_reporte_impuestos_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_reporte_impuestos_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_reporte_impuestos/grid_reporte_impuestos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_impuestos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_reporte_impuestos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_impuestos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['num_css'] . '.css');
...
$nm_saida->saida("}\r\n");
     ...
     if (!$_SESSION['scriptcase']['proc_mobile']) { 
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          ...
          {
          $nm_saida->saida("            <style>\r\n");
          $nm_saida->saida("             #save_grid_top{ padding-right: 20px }\r\n");
          $nm_saida->saida("            </style>\r\n");
          $nm_saida->saida("            <div id='id_save_grid_div_top' style='display:inline-block'>\r\n");
          }
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgridsave", "scBtnSaveGridShow('res', 'Y', 'top', 'extended', '');", "scBtnSaveGridShow('res', 'Y', 'top', 'extended', '');", "save_grid_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          if ($save_grid_format == 'simplified' && !$_SESSION['scriptcase']['proc_mobile'])
          {
      ...
      if ($this->nmgp_botoes['reload'] == 'on' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['opc_psq'] && !$this->grid_emb_form)
      {
         ...
         if (is_file("grid_reporte_impuestos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_reporte_impuestos']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_reporte_impuestos']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_reporte_impuestos_config_pivot.php?nome_apl=grid_reporte_impuestos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_impuestos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_reporte_impuestos/grid_reporte_impuestos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_impuestos']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
   ...
   //---- 
   function adiciona_registro($sum_subtotal, $sum_valoriva, $sum_total, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $sum_ing_terceros, $quebra_fechaven, $quebra_fechaven_orig)
   {
      ...
      if (!isset($this->array_total_fechaven[$quebra_fechaven_orig]))
      {
         ...
         $this->array_total_fechaven[$quebra_fechaven_orig][9] = $sum_ing_terceros;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->fechaven = $this->Ini->GB_date_format($TP_Time . $this->fechaven, $Format_tst, $Prefix_dat, "N", "F/Y");
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->subtotal, $this->valoriva, $this->total, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->ing_terceros, $this->fechaven, $this->fechaven_orig);
            }
   }
//
