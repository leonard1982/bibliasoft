...
<?php
   ...
   $Ord_Cmp = new grid_programar_descuentos_generales_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_programar_descuentos_generales_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["desde"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["desde"])) ? $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["desde"] : "Desde";
   $tab_ger_campos['hasta'] = "on";
   $tab_def_campos['hasta'] = "hasta";
   $tab_labels["hasta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["hasta"])) ? $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["hasta"] : "Hasta";
   $tab_ger_campos['porcentaje'] = "on";
   $tab_def_campos['porcentaje'] = "porcentaje";
   $tab_labels["porcentaje"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["porcentaje"])) ? $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["porcentaje"] : "Porcentaje";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['activo'] = "on";
   $tab_def_campos['activo'] = "activo";
   $tab_labels["activo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["activo"])) ? $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['labels']["activo"] : "Activo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_programar_descuentos_generales_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_programar_descuentos_generales']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
