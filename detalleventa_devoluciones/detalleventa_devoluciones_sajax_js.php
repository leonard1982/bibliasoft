  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_detalleventa_devoluciones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_detalleventa_devoluciones_form();
	}
...
?>
  ...
  // ---------- Validate idpro_
  function do_ajax_detalleventa_devoluciones_validate_idpro_(iNumLinha)
  {
  } // do_ajax_detalleventa_devoluciones_validate_idpro_

  function do_ajax_detalleventa_devoluciones_validate_idpro__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_idpro__cb

  // ---------- Validate colores_
  function do_ajax_detalleventa_devoluciones_validate_colores_(iNumLinha)
  {
  } // do_ajax_detalleventa_devoluciones_validate_colores_

  function do_ajax_detalleventa_devoluciones_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_detalleventa_devoluciones_validate_tallas_(iNumLinha)
  {
  } // do_ajax_detalleventa_devoluciones_validate_tallas_

  function do_ajax_detalleventa_devoluciones_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_detalleventa_devoluciones_validate_sabor_(iNumLinha)
  {
  } // do_ajax_detalleventa_devoluciones_validate_sabor_

  function do_ajax_detalleventa_devoluciones_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_sabor__cb

  // ---------- Validate idbod_
  function do_ajax_detalleventa_devoluciones_validate_idbod_(iNumLinha)
  {
  } // do_ajax_detalleventa_devoluciones_validate_idbod_

  function do_ajax_detalleventa_devoluciones_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_idbod__cb

  // ---------- Validate unidadmayor_
  function do_ajax_detalleventa_devoluciones_validate_unidadmayor_(iNumLinha)
  {
    ...
    x_ajax_detalleventa_devoluciones_validate_unidadmayor_(var_unidadmayor_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_unidadmayor__cb);
  } // do_ajax_detalleventa_devoluciones_validate_unidadmayor_

  function do_ajax_detalleventa_devoluciones_validate_unidadmayor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_unidadmayor__cb

  // ---------- Validate stockubica_
  function do_ajax_detalleventa_devoluciones_validate_stockubica_(iNumLinha)
  {
    var nomeCampo_stockubica_ = "stockubica_" + iNumLinha;
    var var_stockubica_ = scAjaxGetFieldHidden(nomeCampo_stockubica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_stockubica_(var_stockubica_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_stockubica__cb);
  } // do_ajax_detalleventa_devoluciones_validate_stockubica_

  function do_ajax_detalleventa_devoluciones_validate_stockubica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_stockubica__cb

  // ---------- Validate unidad_
  function do_ajax_detalleventa_devoluciones_validate_unidad_(iNumLinha)
  {
    var nomeCampo_unidad_ = "unidad_" + iNumLinha;
    var var_unidad_ = scAjaxGetFieldHidden(nomeCampo_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_unidad_(var_unidad_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_unidad__cb);
  } // do_ajax_detalleventa_devoluciones_validate_unidad_

  function do_ajax_detalleventa_devoluciones_validate_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_unidad__cb

  // ---------- Validate cantidad_
  function do_ajax_detalleventa_devoluciones_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_cantidad__cb);
  } // do_ajax_detalleventa_devoluciones_validate_cantidad_

  function do_ajax_detalleventa_devoluciones_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_cantidad__cb

  // ---------- Validate valorunit_
  function do_ajax_detalleventa_devoluciones_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldText(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_valorunit__cb);
  } // do_ajax_detalleventa_devoluciones_validate_valorunit_

  function do_ajax_detalleventa_devoluciones_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_valorunit__cb

  // ---------- Validate valorpar_
  function do_ajax_detalleventa_devoluciones_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldHidden(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_valorpar__cb);
  } // do_ajax_detalleventa_devoluciones_validate_valorpar_

  function do_ajax_detalleventa_devoluciones_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_valorpar__cb

  // ---------- Validate descuento_
  function do_ajax_detalleventa_devoluciones_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldHidden(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_descuento__cb);
  } // do_ajax_detalleventa_devoluciones_validate_descuento_

  function do_ajax_detalleventa_devoluciones_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_descuento__cb

  // ---------- Validate adicional_
  function do_ajax_detalleventa_devoluciones_validate_adicional_(iNumLinha)
  {
    var nomeCampo_adicional_ = "adicional_" + iNumLinha;
    var var_adicional_ = scAjaxGetFieldText(nomeCampo_adicional_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_adicional_(var_adicional_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_adicional__cb);
  } // do_ajax_detalleventa_devoluciones_validate_adicional_

  function do_ajax_detalleventa_devoluciones_validate_adicional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_adicional__cb

  // ---------- Validate adicional1_
  function do_ajax_detalleventa_devoluciones_validate_adicional1_(iNumLinha)
  {
    var nomeCampo_adicional1_ = "adicional1_" + iNumLinha;
    var var_adicional1_ = scAjaxGetFieldText(nomeCampo_adicional1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_adicional1_(var_adicional1_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_adicional1__cb);
  } // do_ajax_detalleventa_devoluciones_validate_adicional1_

  function do_ajax_detalleventa_devoluciones_validate_adicional1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_adicional1__cb

  // ---------- Validate factor_
  function do_ajax_detalleventa_devoluciones_validate_factor_(iNumLinha)
  {
    var nomeCampo_factor_ = "factor_" + iNumLinha;
    var var_factor_ = scAjaxGetFieldText(nomeCampo_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_factor_(var_factor_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_factor__cb);
  } // do_ajax_detalleventa_devoluciones_validate_factor_

  function do_ajax_detalleventa_devoluciones_validate_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_factor__cb

  // ---------- Validate iva_
  function do_ajax_detalleventa_devoluciones_validate_iva_(iNumLinha)
  {
    var nomeCampo_iva_ = "iva_" + iNumLinha;
    var var_iva_ = scAjaxGetFieldHidden(nomeCampo_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_iva_(var_iva_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_iva__cb);
  } // do_ajax_detalleventa_devoluciones_validate_iva_

  function do_ajax_detalleventa_devoluciones_validate_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_iva__cb

  // ---------- Validate costop_
  function do_ajax_detalleventa_devoluciones_validate_costop_(iNumLinha)
  {
    var nomeCampo_costop_ = "costop_" + iNumLinha;
    var var_costop_ = scAjaxGetFieldText(nomeCampo_costop_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_costop_(var_costop_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_costop__cb);
  } // do_ajax_detalleventa_devoluciones_validate_costop_

  function do_ajax_detalleventa_devoluciones_validate_costop__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_costop__cb

  // ---------- Validate fech_
  function do_ajax_detalleventa_devoluciones_validate_fech_(iNumLinha)
  {
    var nomeCampo_fech_ = "fech_" + iNumLinha;
    var var_fech_ = scAjaxGetFieldText(nomeCampo_fech_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_validate_fech_(var_fech_, iNumLinha, var_script_case_init, do_ajax_detalleventa_devoluciones_validate_fech__cb);
  } // do_ajax_detalleventa_devoluciones_validate_fech_

  function do_ajax_detalleventa_devoluciones_validate_fech__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fech_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fech_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_validate_fech__cb

  // ---------- Refresh idpro_
  function do_ajax_detalleventa_devoluciones_refresh_idpro_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_detalleventa_devoluciones_refresh_idpro_(var_idpro_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_detalleventa_devoluciones_refresh_idpro__cb);
  } // do_ajax_detalleventa_devoluciones_refresh_idpro_

  function do_ajax_detalleventa_devoluciones_refresh_idpro__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detalleventa_devoluciones_refresh_idpro__cb

  // ---------- Event onchange cantidad_
  function do_ajax_detalleventa_devoluciones_event_cantidad__onchange(iSeqForm)
  {
    ...
    var var_colores_ = scAjaxGetFieldText("id_ac_colores_" + iSeqForm);
    var var_tallas_ = scAjaxGetFieldText("id_ac_tallas_" + iSeqForm);
    var var_sabor_ = scAjaxGetFieldText("id_ac_sabor_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldText("id_ac_idbod_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_detalleventa_devoluciones_event_cantidad__onchange(var_cantidad_, var_idpro_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_valorunit_, var_colores_, var_tallas_, var_sabor_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalleventa_devoluciones_event_cantidad__onchange_cb);
  } // do_ajax_detalleventa_devoluciones_event_cantidad__onchange

  function do_ajax_detalleventa_devoluciones_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalleventa_devoluciones_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_detalleventa_devoluciones_event_cantidad__onchange_cb
  function do_ajax_detalleventa_devoluciones_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalleventa_devoluciones_event_cantidad__onchange_cb_after_alert

  // ---------- Event onfocus cantidad_
  function do_ajax_detalleventa_devoluciones_event_cantidad__onfocus(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_detalleventa_devoluciones_event_cantidad__onfocus(var_cantidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_detalleventa_devoluciones_event_cantidad__onfocus_cb);
  } // do_ajax_detalleventa_devoluciones_event_cantidad__onfocus

  function do_ajax_detalleventa_devoluciones_event_cantidad__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalleventa_devoluciones_event_cantidad__onfocus_cb_after_alert);
  } // do_ajax_detalleventa_devoluciones_event_cantidad__onfocus_cb
  function do_ajax_detalleventa_devoluciones_event_cantidad__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detalleventa_devoluciones_event_cantidad__onfocus_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_detalleventa_devoluciones_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_detalleventa_devoluciones_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detalleventa_devoluciones_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_detalleventa_devoluciones_add_new_line_cb);
  } // do_ajax_detalleventa_devoluciones_add_new_line

  function do_ajax_detalleventa_devoluciones_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("idpro_=disabled;valorunit_=disabled", "", iAjaxNewLine);
    nm_field_disabled("cantidad_=disabled", "I", iAjaxNewLine, 'novo');
  } // do_ajax_detalleventa_devoluciones_add_new_line_cb

  // ---------- backup_line
  function do_ajax_detalleventa_devoluciones_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldText("iddet_" + iNumLinha);
    var var_iddev_ = scAjaxGetFieldText("iddev_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detalleventa_devoluciones_backup_line(var_iddet_, var_iddev_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_detalleventa_devoluciones_backup_line_cb);
  } // do_ajax_detalleventa_devoluciones_backup_line

  function do_ajax_detalleventa_devoluciones_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_detalleventa_devoluciones_backup_line_cb

  function do_ajax_detalleventa_devoluciones_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_detalleventa_devoluciones_cancel_insert

  function do_ajax_detalleventa_devoluciones_cancel_update(iSeqVert)
  {
    do_ajax_detalleventa_devoluciones_backup_line(iSeqVert);
...
?>
  } // do_ajax_detalleventa_devoluciones_cancel_update

  function do_ajax_detalleventa_devoluciones_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_detalleventa_devoluciones_restore_buttons

  // ---------- table_refresh
  function do_ajax_detalleventa_devoluciones_table_refresh()
  {
    var var_iddet_ = document.F2.iddet_.value;
    var var_iddev_ = document.F2.iddev_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_detalleventa_devoluciones_table_refresh(var_iddet_, var_iddev_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_detalleventa_devoluciones_table_refresh_cb);
  } //  do_ajax_detalleventa_devoluciones_table_refresh

  function do_ajax_detalleventa_devoluciones_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.iddev_.value = scAjaxGetKeyValue("iddev_");
    ...
    scAjaxAlert(do_ajax_detalleventa_devoluciones_table_refresh_cb_after_alert);
  } // do_ajax_detalleventa_devoluciones_table_refresh_cb
  function do_ajax_detalleventa_devoluciones_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_detalleventa_devoluciones_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_detalleventa_devoluciones_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_detalleventa_devoluciones_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_colores_ = scAjaxGetFieldText("colores_" + iNumLinha);
    var var_tallas_ = scAjaxGetFieldText("tallas_" + iNumLinha);
    var var_sabor_ = scAjaxGetFieldText("sabor_" + iNumLinha);
    ...
    var var_fech_ = scAjaxGetFieldText("fech_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_detalleventa_devoluciones_submit_form(var_idpro_, var_colores_, var_tallas_, var_sabor_, var_idbod_, var_unidadmayor_, var_stockubica_, var_unidad_, var_cantidad_, var_valorunit_, var_valorpar_, var_descuento_, var_adicional_, var_adicional1_, var_factor_, var_iva_, var_costop_, var_fech_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_detalleventa_devoluciones_submit_form_cb);
  } // do_ajax_detalleventa_devoluciones_submit_form

  function do_ajax_detalleventa_devoluciones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("fech_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detalleventa_devoluciones_submit_form_cb_after_alert);
  } // do_ajax_detalleventa_devoluciones_submit_form_cb
  function do_ajax_detalleventa_devoluciones_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_detalleventa_devoluciones_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_detalleventa_devoluciones_navigate_form()
  {
    perform_ajax_detalleventa_devoluciones_navigate_form();
  }

  function perform_ajax_detalleventa_devoluciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_detalleventa_devoluciones_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("fech_" + iNavForm);
    }
    var var_iddet_ = document.F2.iddet_.value;
    var var_iddev_ = document.F2.iddev_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_detalleventa_devoluciones_navigate_form(var_iddet_, var_iddev_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_detalleventa_devoluciones_navigate_form_cb);
  } // do_ajax_detalleventa_devoluciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_detalleventa_devoluciones_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.iddev_.value = scAjaxGetKeyValue("iddev_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_detalleventa_devoluciones_navigate_form_cb_after_alert);
  } // do_ajax_detalleventa_devoluciones_navigate_form_cb
  function do_ajax_detalleventa_devoluciones_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_detalleventa_devoluciones_navigate_form_cb_after_alert
  function sc_hide_detalleventa_devoluciones_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fech_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["cantidad_" + iNumLinha] = {"label": "Cantidad a devolver<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["fech_" + iNumLinha] = {"label": "fech<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["fech_"][iNumLinha] = "fech_" + iNumLinha;
    ...
    ajax_error_count["fech_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["fech_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["fech_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["fech_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["fech_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fech_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fech_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fech_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fech_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fech_'])) ? $this->nmgp_cmp_readonly['fech_'] : 'off';
?>
    scAjaxFieldRead("fech_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idpro_" + iRow] || "on" == ajax_error_count["colores_" + iRow] || "on" == ajax_error_count["tallas_" + iRow] || "on" == ajax_error_count["sabor_" + iRow] || "on" == ajax_error_count["idbod_" + iRow] || "on" == ajax_error_count["unidadmayor_" + iRow] || "on" == ajax_error_count["stockubica_" + iRow] || "on" == ajax_error_count["unidad_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["valorunit_" + iRow] || "on" == ajax_error_count["valorpar_" + iRow] || "on" == ajax_error_count["descuento_" + iRow] || "on" == ajax_error_count["adicional_" + iRow] || "on" == ajax_error_count["adicional1_" + iRow] || "on" == ajax_error_count["factor_" + iRow] || "on" == ajax_error_count["iva_" + iRow] || "on" == ajax_error_count["costop_" + iRow] || "on" == ajax_error_count["fech_" + iRow]))
    {
      ...
      $("#hidden_field_data_fech_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idpro_" + iRow] && "off" == ajax_error_count["colores_" + iRow] && "off" == ajax_error_count["tallas_" + iRow] && "off" == ajax_error_count["sabor_" + iRow] && "off" == ajax_error_count["idbod_" + iRow] && "off" == ajax_error_count["unidadmayor_" + iRow] && "off" == ajax_error_count["stockubica_" + iRow] && "off" == ajax_error_count["unidad_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["valorunit_" + iRow] && "off" == ajax_error_count["valorpar_" + iRow] && "off" == ajax_error_count["descuento_" + iRow] && "off" == ajax_error_count["adicional_" + iRow] && "off" == ajax_error_count["adicional1_" + iRow] && "off" == ajax_error_count["factor_" + iRow] && "off" == ajax_error_count["iva_" + iRow] && "off" == ajax_error_count["costop_" + iRow] && "off" == ajax_error_count["fech_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["fech_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_fech_" + iRow).removeClass("scFormErrorLine");
    }
  }
