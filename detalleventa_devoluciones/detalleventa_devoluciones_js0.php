...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="detalleventa_devoluciones"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_detalleventa_devoluciones_submit_form(y, z);
...
{
   nm_field_disabled("idpro_=disabled;valorunit_=disabled", "");
