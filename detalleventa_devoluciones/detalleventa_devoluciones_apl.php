...
$_SESSION['scriptcase']['detalleventa_devoluciones']['contr_erro'] = 'off';
      ...
      $_SESSION['scriptcase']['error_icon']['detalleventa_devoluciones']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
if($this->cantidad_ >$this->sc_temp_edit_cantidad)
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_detalleventa_devoluciones' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
