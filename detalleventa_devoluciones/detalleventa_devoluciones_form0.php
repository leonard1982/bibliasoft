<?php
class detalleventa_devoluciones_form extends detalleventa_devoluciones_apl
{
function Form_Init()
{
...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Elimine el item que no va a devolver"); } else { echo strip_tags("Elimine el item que no va a devolver y dele actualizar a los otros items"); } ?></TITLE>
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>detalleventa_devoluciones/detalleventa_devoluciones_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('detalleventa_devoluciones_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-idpro_", elem).on("focus", function() {
   ...
   width: "300px",
   ajax: {
    url: "detalleventa_devoluciones.php",
    dataType: "json",
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idpro_" != sId ? sId.substr(6) : "";
   sc_detalleventa_devoluciones_idpro__onfocus("id_sc_field_" + sId, sRow);
  ...
  $(".sc-ui-autocomp-idbod_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "idbod_" != sId ? sId.substr(6) : "";
   sc_detalleventa_devoluciones_idbod__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-colores_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "colores_" != sId ? sId.substr(8) : "";
   sc_detalleventa_devoluciones_colores__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-tallas_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "tallas_" != sId ? sId.substr(7) : "";
   sc_detalleventa_devoluciones_tallas__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
  ...
  $(".sc-ui-autocomp-sabor_", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "sabor_" != sId ? sId.substr(6) : "";
   sc_detalleventa_devoluciones_sabor__onfocus("id_sc_field_" + sId, sRow);
  }).on("select2:close", function(e) {
   var sId = $(this).attr("id").substr(6);
   $("#id_sc_field_" + sId).trigger("blur");
  }).on("select2:select", function(e) {
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("detalleventa_devoluciones_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['detalleventa_devoluciones'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['detalleventa_devoluciones'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Elimine el item que no va a devolver"; } else { echo "Elimine el item que no va a devolver y dele actualizar a los otros items"; } ?></span></td>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['sc_btn_0']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['sc_btn_0']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['sc_btn_0']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['sc_btn_0']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['sc_btn_0'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
   ...
   if (!isset($this->nmgp_cmp_hidden['fech_']))
   {
       $this->nmgp_cmp_hidden['fech_'] = 'off';
   }
?>
...
<?php
 ...
 ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['fech_']) && $this->nmgp_cmp_hidden['fech_'] == 'off') { $sStyleHidden_fech_ = 'display: none'; }
      if (1 || !isset($this->nmgp_cmp_hidden['fech_']) || $this->nmgp_cmp_hidden['fech_'] == 'on') {
      if (!isset($this->nm_new_label['fech_'])) {
          $this->nm_new_label['fech_'] = "fech"; } ?>
<?php
          $date_format_show = strtolower(str_replace(';', ' ', $this->field_config['fech_']['date_format']));
...
?>
    ...
    <TD class="scFormLabelOddMult css_fech__label" id="hidden_field_label_fech_" style="<?php echo $sStyleHidden_fech_; ?>" > <?php echo $this->nm_new_label['fech_'] ?><br><span class="scFormDataHelpOddMult"><?php echo $date_format_show ?></span> </TD>
   <?php } ?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_detalleventa_devoluciones);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_detalleventa_devoluciones = $this->form_vert_detalleventa_devoluciones;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_detalleventa_devoluciones))
   {
       $sc_seq_vert = 0;
   }
   foreach ($this->form_vert_detalleventa_devoluciones as $sc_seq_vert => $sc_lixo)
   {
       $this->loadRecordState($sc_seq_vert);
       $this->iddet_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['iddet_'];
       $this->numfac_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['numfac_'];
       $this->remision_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['remision_'];
       $this->devuelto_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['devuelto_'];
       $this->iddev_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['iddev_'];
       $this->procesado_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['procesado_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           ...
           $this->nmgp_cmp_readonly['fech_'] = true;
       }
       elseif ($Line_Add)
       {
           ...
           if (!isset($this->nmgp_cmp_readonly['fech_']) || $this->nmgp_cmp_readonly['fech_'] != "on") {$this->nmgp_cmp_readonly['fech_'] = false;}
       }
       ...
       $this->colores_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['colores_']; 
       ...
       $this->tallas_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['tallas_']; 
       ...
       $this->sabor_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['sabor_']; 
       $sabor_ = $this->sabor_; 
       $sStyleHidden_sabor_ = '';
       ...
       $this->idbod_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['idbod_']; 
       $idbod_ = $this->idbod_; 
       $sStyleHidden_idbod_ = '';
       ...
       $this->unidadmayor_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['unidadmayor_']; 
       ...
       $this->stockubica_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['stockubica_']; 
       ...
       $this->unidad_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['unidad_']; 
       ...
       $this->cantidad_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['cantidad_']; 
       ...
       $this->valorunit_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['valorunit_']; 
       ...
       $this->valorpar_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['valorpar_']; 
       ...
       $this->descuento_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['descuento_']; 
       ...
       $this->adicional_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['adicional_']; 
       ...
       $this->adicional1_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['adicional1_']; 
       ...
       $this->factor_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['factor_']; 
       ...
       $this->iva_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['iva_']; 
       $iva_ = $this->iva_; 
       $sStyleHidden_iva_ = '';
       ...
       $this->costop_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['costop_']; 
       ...
       $this->fech_ = $this->form_vert_detalleventa_devoluciones[$sc_seq_vert]['fech_']; 
       $fech_ = $this->fech_; 
       if (!isset($this->nmgp_cmp_hidden['fech_']))
       {
           $this->nmgp_cmp_hidden['fech_'] = 'off';
       ...
       $sStyleHidden_fech_ = '';
       if (isset($sCheckRead_fech_))
       {
           unset($sCheckRead_fech_);
       }
       if (isset($this->nmgp_cmp_readonly['fech_']))
       {
           $sCheckRead_fech_ = $this->nmgp_cmp_readonly['fech_'];
       }
       if (isset($this->nmgp_cmp_hidden['fech_']) && $this->nmgp_cmp_hidden['fech_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['fech_']);
           $sStyleHidden_fech_ = 'display: none;';
       }
       $bTestReadOnly_fech_ = true;
       $sStyleReadLab_fech_ = 'display: none;';
       $sStyleReadInp_fech_ = '';
       if (isset($this->nmgp_cmp_readonly['fech_']) && $this->nmgp_cmp_readonly['fech_'] == 'on')
       {
           $bTestReadOnly_fech_ = false;
           unset($this->nmgp_cmp_readonly['fech_']);
           $sStyleReadLab_fech_ = '';
           $sStyleReadInp_fech_ = 'display: none;';
       }
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_detalleventa_devoluciones_add_new_line(" . $sc_seq_vert . ")", "do_ajax_detalleventa_devoluciones_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_detalleventa_devoluciones_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_detalleventa_devoluciones_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_detalleventa_devoluciones_cancel_update(" . $sc_seq_vert . ")", "do_ajax_detalleventa_devoluciones_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['Lookup_unidadmayor_'][] = 'NO'; ?>
 <option  value="SI" <?php  if ($this->unidadmayor_ == "SI") { echo " selected" ;} ?>>SI</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['Lookup_unidadmayor_'][] = 'SI'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_costop_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-costop_<?php echo $sc_seq_vert ?> css_costop__line" style="<?php echo $sStyleReadLab_costop_; ?>"><?php echo $this->form_format_readonly("costop_", $this->form_encode_input($this->costop_)); ?></span><span id="id_read_off_costop_<?php echo $sc_seq_vert ?>" class="css_read_off_costop_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_costop_; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=12"; } ?> alt="{datatype: 'decimal', maxLength: 12, precision: 0, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['costop_']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['costop_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['costop_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['costop_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['fech_']) && $this->nmgp_cmp_hidden['fech_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="fech_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($fech_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_fech__line" id="hidden_field_data_fech_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_fech_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_fech__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_fech_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["fech_"]) &&  $this->nmgp_cmp_readonly["fech_"] == "on") { 

 ?>
<input type="hidden" name="fech_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($fech_) . "\">" . $fech_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_fech_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-fech_<?php echo $sc_seq_vert ?> css_fech__line" style="<?php echo $sStyleReadLab_fech_; ?>"><?php echo $this->form_format_readonly("fech_", $this->form_encode_input($fech_)); ?></span><span id="id_read_off_fech_<?php echo $sc_seq_vert ?>" class="css_read_off_fech_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_fech_; ?>"><?php
$tmp_form_data = $this->field_config['fech_']['date_format'];
...
?>
 ...
 <input class="sc-js-input scFormObjectOddMult css_fech__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_fech_<?php echo $sc_seq_vert ?>" type=text name="fech_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($fech_) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'date', dateSep: '<?php echo $this->field_config['fech_']['date_sep']; ?>', dateFormat: '<?php echo $this->field_config['fech_']['date_format']; ?>', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_fech_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_fech_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
       ...
       if (isset($sCheckRead_fech_))
       {
           $this->nmgp_cmp_readonly['fech_'] = $sCheckRead_fech_;
       }
       if ('display: none;' == $sStyleHidden_fech_)
       {
           $this->nmgp_cmp_hidden['fech_'] = 'off';
       }
   ...
   { 
       ...
       $this->form_vert_detalleventa_devoluciones = $guarda_form_vert_detalleventa_devoluciones;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("detalleventa_devoluciones");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("detalleventa_devoluciones");
 parent.scAjaxDetailHeight("detalleventa_devoluciones", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			...
			do_ajax_detalleventa_devoluciones_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['detalleventa_devoluciones']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
