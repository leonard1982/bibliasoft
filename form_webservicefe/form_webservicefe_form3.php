...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['Lookup_envio_credenciales'][] = 'SI'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['Lookup_plantillas_correo'][] = 'SI'; ?>
