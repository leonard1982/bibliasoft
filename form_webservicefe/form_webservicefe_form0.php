...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['last'] : 'off'); ?>";
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['help'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['btn_label']['exit'];
        }
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_webservicefe_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_webservicefe_form0' => array(
            'title' => "Producción",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_webservicefe_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_webservicefe_form1' => array(
            'title' => "Pruebas",
        ...
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Producción' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_webservicefe_form0']['class'] = 'scTabInactive';
                        }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_webservicefe_form0"]['class'];
?>
   <li id="id_form_webservicefe_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_webservicefe_form0')">
     Producción
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_webservicefe_form1"]['class'];
?>
   <li id="id_form_webservicefe_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_webservicefe_form1')">
     Pruebas
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_webservicefe_form2"]['class'];
?>
...
<?php
    $css_celula = $this->tabCssClass["form_webservicefe_form3"]['class'];
?>
...
<div id="form_webservicefe_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
