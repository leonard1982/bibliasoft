...
$old_error_handler = set_error_handler("form_webservicefe_scriptcase_error_handler");

function form_webservicefe_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_webservicefe']['contr_erro']) && $_SESSION['scriptcase']['form_webservicefe']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_webservicefe->contr_form_webservicefe->Apl_com_erro = true;
            if ($inicial_form_webservicefe->contr_form_webservicefe->NM_ajax_flag)
            {
                $inicial_form_webservicefe->contr_form_webservicefe->NM_ajax_info['errList']['geral_form_webservicefe'][] = $msg;
                return;
            }
            form_webservicefe_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_webservicefe_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_webservicefe'])  && '' != $_SESSION['scriptcase']['error_icon']['form_webservicefe'])  ? $_SESSION['scriptcase']['error_icon']['form_webservicefe']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_webservicefe']) && '' != $_SESSION['scriptcase']['error_close']['form_webservicefe']) ? $_SESSION['scriptcase']['error_close']['form_webservicefe'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_webservicefe']) && '' != $_SESSION['scriptcase']['error_span_title']['form_webservicefe']) ? $_SESSION['scriptcase']['error_span_title']['form_webservicefe'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_webservicefe']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_webservicefe']) ? $_SESSION['scriptcase']['error_icon_title']['form_webservicefe'] : '';
?>
