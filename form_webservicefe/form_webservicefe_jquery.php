  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'password_anterior':
        sc_exib_ocult_pag('form_webservicefe_form3');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idwebservicefe' + iSeqRow).bind('change', function() { sc_form_webservicefe_idwebservicefe_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_servidor1' + iSeqRow).bind('blur', function() { sc_form_webservicefe_servidor1_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_webservicefe_servidor1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_servidor2' + iSeqRow).bind('blur', function() { sc_form_webservicefe_servidor2_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_webservicefe_servidor2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tokenempresa' + iSeqRow).bind('blur', function() { sc_form_webservicefe_tokenempresa_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_webservicefe_tokenempresa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tokenpassword' + iSeqRow).bind('blur', function() { sc_form_webservicefe_tokenpassword_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_webservicefe_tokenpassword_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_servidor_prueba1' + iSeqRow).bind('blur', function() { sc_form_webservicefe_servidor_prueba1_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_webservicefe_servidor_prueba1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_servidor_prueba2' + iSeqRow).bind('blur', function() { sc_form_webservicefe_servidor_prueba2_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_webservicefe_servidor_prueba2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_token_prueba' + iSeqRow).bind('blur', function() { sc_form_webservicefe_token_prueba_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_webservicefe_token_prueba_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_password_prueba' + iSeqRow).bind('blur', function() { sc_form_webservicefe_password_prueba_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_webservicefe_password_prueba_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_modo' + iSeqRow).bind('blur', function() { sc_form_webservicefe_modo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_webservicefe_modo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_enviar_dian' + iSeqRow).bind('blur', function() { sc_form_webservicefe_enviar_dian_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_webservicefe_enviar_dian_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_enviar_cliente' + iSeqRow).bind('blur', function() { sc_form_webservicefe_enviar_cliente_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_webservicefe_enviar_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_servidor3' + iSeqRow).bind('blur', function() { sc_form_webservicefe_servidor3_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_webservicefe_servidor3_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_servidor_anterior1' + iSeqRow).bind('blur', function() { sc_form_webservicefe_servidor_anterior1_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_webservicefe_servidor_anterior1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_servidor_anterior2' + iSeqRow).bind('blur', function() { sc_form_webservicefe_servidor_anterior2_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_webservicefe_servidor_anterior2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_servidor_anterior3' + iSeqRow).bind('blur', function() { sc_form_webservicefe_servidor_anterior3_onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_form_webservicefe_servidor_anterior3_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_token_anterior' + iSeqRow).bind('blur', function() { sc_form_webservicefe_token_anterior_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_webservicefe_token_anterior_onchange(this, iSeqRow) })
...
function sc_form_webservicefe_servidor1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_servidor2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_tokenempresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_tokenpassword_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_servidor_prueba1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_servidor_prueba2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_token_prueba_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_password_prueba_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_modo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_enviar_dian_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_enviar_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_servidor3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_servidor_prueba3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_servidor_anterior1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_servidor_anterior2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_servidor_anterior3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_token_anterior_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_webservicefe_password_anterior_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_webservicefe_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_webservicefe')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
