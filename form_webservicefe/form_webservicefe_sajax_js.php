  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_webservicefe" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_webservicefe_form();
	}
...
?>
  ...
  // ---------- Validate proveedor
  function do_ajax_form_webservicefe_validate_proveedor()
  {
    var nomeCampo_proveedor = "proveedor";
    var var_proveedor = scAjaxGetFieldSelect(nomeCampo_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_proveedor(var_proveedor, var_script_case_init, do_ajax_form_webservicefe_validate_proveedor_cb);
  } // do_ajax_form_webservicefe_validate_proveedor

  function do_ajax_form_webservicefe_validate_proveedor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_proveedor_cb

  // ---------- Validate modo
  function do_ajax_form_webservicefe_validate_modo()
  {
    var nomeCampo_modo = "modo";
    var var_modo = scAjaxGetFieldSelect(nomeCampo_modo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_modo(var_modo, var_script_case_init, do_ajax_form_webservicefe_validate_modo_cb);
  } // do_ajax_form_webservicefe_validate_modo

  function do_ajax_form_webservicefe_validate_modo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_modo_cb

  // ---------- Validate servidor1
  function do_ajax_form_webservicefe_validate_servidor1()
  {
    var nomeCampo_servidor1 = "servidor1";
    var var_servidor1 = scAjaxGetFieldText(nomeCampo_servidor1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor1(var_servidor1, var_script_case_init, do_ajax_form_webservicefe_validate_servidor1_cb);
  } // do_ajax_form_webservicefe_validate_servidor1

  function do_ajax_form_webservicefe_validate_servidor1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor1_cb

  // ---------- Validate servidor2
  function do_ajax_form_webservicefe_validate_servidor2()
  {
    var nomeCampo_servidor2 = "servidor2";
    var var_servidor2 = scAjaxGetFieldText(nomeCampo_servidor2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor2(var_servidor2, var_script_case_init, do_ajax_form_webservicefe_validate_servidor2_cb);
  } // do_ajax_form_webservicefe_validate_servidor2

  function do_ajax_form_webservicefe_validate_servidor2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor2_cb

  // ---------- Validate servidor3
  function do_ajax_form_webservicefe_validate_servidor3()
  {
    var nomeCampo_servidor3 = "servidor3";
    var var_servidor3 = scAjaxGetFieldText(nomeCampo_servidor3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor3(var_servidor3, var_script_case_init, do_ajax_form_webservicefe_validate_servidor3_cb);
  } // do_ajax_form_webservicefe_validate_servidor3

  function do_ajax_form_webservicefe_validate_servidor3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor3_cb

  // ---------- Validate servidor4
  function do_ajax_form_webservicefe_validate_servidor4()
  {
    var nomeCampo_servidor4 = "servidor4";
    var var_servidor4 = scAjaxGetFieldText(nomeCampo_servidor4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor4(var_servidor4, var_script_case_init, do_ajax_form_webservicefe_validate_servidor4_cb);
  } // do_ajax_form_webservicefe_validate_servidor4

  function do_ajax_form_webservicefe_validate_servidor4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "servidor4";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor4_cb

  // ---------- Validate servidor5
  function do_ajax_form_webservicefe_validate_servidor5()
  {
    var nomeCampo_servidor5 = "servidor5";
    var var_servidor5 = scAjaxGetFieldText(nomeCampo_servidor5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor5(var_servidor5, var_script_case_init, do_ajax_form_webservicefe_validate_servidor5_cb);
  } // do_ajax_form_webservicefe_validate_servidor5

  function do_ajax_form_webservicefe_validate_servidor5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "servidor5";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor5_cb

  // ---------- Validate tokenempresa
  function do_ajax_form_webservicefe_validate_tokenempresa()
  {
    var nomeCampo_tokenempresa = "tokenempresa";
    var var_tokenempresa = scAjaxGetFieldText(nomeCampo_tokenempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_tokenempresa(var_tokenempresa, var_script_case_init, do_ajax_form_webservicefe_validate_tokenempresa_cb);
  } // do_ajax_form_webservicefe_validate_tokenempresa

  function do_ajax_form_webservicefe_validate_tokenempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_tokenempresa_cb

  // ---------- Validate tokenpassword
  function do_ajax_form_webservicefe_validate_tokenpassword()
  {
    var nomeCampo_tokenpassword = "tokenpassword";
    var var_tokenpassword = scAjaxGetFieldText(nomeCampo_tokenpassword);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_tokenpassword(var_tokenpassword, var_script_case_init, do_ajax_form_webservicefe_validate_tokenpassword_cb);
  } // do_ajax_form_webservicefe_validate_tokenpassword

  function do_ajax_form_webservicefe_validate_tokenpassword_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_tokenpassword_cb

  // ---------- Validate url_api_pdfs
  function do_ajax_form_webservicefe_validate_url_api_pdfs()
  {
    var nomeCampo_url_api_pdfs = "url_api_pdfs";
    var var_url_api_pdfs = scAjaxGetFieldText(nomeCampo_url_api_pdfs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_url_api_pdfs(var_url_api_pdfs, var_script_case_init, do_ajax_form_webservicefe_validate_url_api_pdfs_cb);
  } // do_ajax_form_webservicefe_validate_url_api_pdfs

  function do_ajax_form_webservicefe_validate_url_api_pdfs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_url_api_pdfs_cb

  // ---------- Validate url_api_sendmail
  function do_ajax_form_webservicefe_validate_url_api_sendmail()
  {
    var nomeCampo_url_api_sendmail = "url_api_sendmail";
    var var_url_api_sendmail = scAjaxGetFieldText(nomeCampo_url_api_sendmail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_url_api_sendmail(var_url_api_sendmail, var_script_case_init, do_ajax_form_webservicefe_validate_url_api_sendmail_cb);
  } // do_ajax_form_webservicefe_validate_url_api_sendmail

  function do_ajax_form_webservicefe_validate_url_api_sendmail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_url_api_sendmail_cb

  // ---------- Validate servidor_prueba1
  function do_ajax_form_webservicefe_validate_servidor_prueba1()
  {
    var nomeCampo_servidor_prueba1 = "servidor_prueba1";
    var var_servidor_prueba1 = scAjaxGetFieldText(nomeCampo_servidor_prueba1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor_prueba1(var_servidor_prueba1, var_script_case_init, do_ajax_form_webservicefe_validate_servidor_prueba1_cb);
  } // do_ajax_form_webservicefe_validate_servidor_prueba1

  function do_ajax_form_webservicefe_validate_servidor_prueba1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor_prueba1_cb

  // ---------- Validate servidor_prueba2
  function do_ajax_form_webservicefe_validate_servidor_prueba2()
  {
    var nomeCampo_servidor_prueba2 = "servidor_prueba2";
    var var_servidor_prueba2 = scAjaxGetFieldText(nomeCampo_servidor_prueba2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor_prueba2(var_servidor_prueba2, var_script_case_init, do_ajax_form_webservicefe_validate_servidor_prueba2_cb);
  } // do_ajax_form_webservicefe_validate_servidor_prueba2

  function do_ajax_form_webservicefe_validate_servidor_prueba2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor_prueba2_cb

  // ---------- Validate servidor_prueba3
  function do_ajax_form_webservicefe_validate_servidor_prueba3()
  {
    var nomeCampo_servidor_prueba3 = "servidor_prueba3";
    var var_servidor_prueba3 = scAjaxGetFieldText(nomeCampo_servidor_prueba3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor_prueba3(var_servidor_prueba3, var_script_case_init, do_ajax_form_webservicefe_validate_servidor_prueba3_cb);
  } // do_ajax_form_webservicefe_validate_servidor_prueba3

  function do_ajax_form_webservicefe_validate_servidor_prueba3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor_prueba3_cb

  // ---------- Validate token_prueba
  function do_ajax_form_webservicefe_validate_token_prueba()
  {
    var nomeCampo_token_prueba = "token_prueba";
    var var_token_prueba = scAjaxGetFieldText(nomeCampo_token_prueba);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_token_prueba(var_token_prueba, var_script_case_init, do_ajax_form_webservicefe_validate_token_prueba_cb);
  } // do_ajax_form_webservicefe_validate_token_prueba

  function do_ajax_form_webservicefe_validate_token_prueba_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_token_prueba_cb

  // ---------- Validate password_prueba
  function do_ajax_form_webservicefe_validate_password_prueba()
  {
    var nomeCampo_password_prueba = "password_prueba";
    var var_password_prueba = scAjaxGetFieldText(nomeCampo_password_prueba);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_password_prueba(var_password_prueba, var_script_case_init, do_ajax_form_webservicefe_validate_password_prueba_cb);
  } // do_ajax_form_webservicefe_validate_password_prueba

  function do_ajax_form_webservicefe_validate_password_prueba_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_password_prueba_cb

  // ---------- Validate enviar_dian
  function do_ajax_form_webservicefe_validate_enviar_dian()
  {
    var nomeCampo_enviar_dian = "enviar_dian";
    var var_enviar_dian = scAjaxGetFieldCheckbox(nomeCampo_enviar_dian, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_enviar_dian(var_enviar_dian, var_script_case_init, do_ajax_form_webservicefe_validate_enviar_dian_cb);
  } // do_ajax_form_webservicefe_validate_enviar_dian

  function do_ajax_form_webservicefe_validate_enviar_dian_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_enviar_dian_cb

  // ---------- Validate enviar_cliente
  function do_ajax_form_webservicefe_validate_enviar_cliente()
  {
    var nomeCampo_enviar_cliente = "enviar_cliente";
    var var_enviar_cliente = scAjaxGetFieldCheckbox(nomeCampo_enviar_cliente, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_enviar_cliente(var_enviar_cliente, var_script_case_init, do_ajax_form_webservicefe_validate_enviar_cliente_cb);
  } // do_ajax_form_webservicefe_validate_enviar_cliente

  function do_ajax_form_webservicefe_validate_enviar_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_enviar_cliente_cb

  // ---------- Validate proveedor_anterior
  function do_ajax_form_webservicefe_validate_proveedor_anterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_proveedor_anterior(var_proveedor_anterior, var_script_case_init, do_ajax_form_webservicefe_validate_proveedor_anterior_cb);
  } // do_ajax_form_webservicefe_validate_proveedor_anterior

  function do_ajax_form_webservicefe_validate_proveedor_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_proveedor_anterior_cb

  // ---------- Validate servidor_anterior1
  function do_ajax_form_webservicefe_validate_servidor_anterior1()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor_anterior1(var_servidor_anterior1, var_script_case_init, do_ajax_form_webservicefe_validate_servidor_anterior1_cb);
  } // do_ajax_form_webservicefe_validate_servidor_anterior1

  function do_ajax_form_webservicefe_validate_servidor_anterior1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor_anterior1_cb

  // ---------- Validate servidor_anterior2
  function do_ajax_form_webservicefe_validate_servidor_anterior2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor_anterior2(var_servidor_anterior2, var_script_case_init, do_ajax_form_webservicefe_validate_servidor_anterior2_cb);
  } // do_ajax_form_webservicefe_validate_servidor_anterior2

  function do_ajax_form_webservicefe_validate_servidor_anterior2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor_anterior2_cb

  // ---------- Validate servidor_anterior3
  function do_ajax_form_webservicefe_validate_servidor_anterior3()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_servidor_anterior3(var_servidor_anterior3, var_script_case_init, do_ajax_form_webservicefe_validate_servidor_anterior3_cb);
  } // do_ajax_form_webservicefe_validate_servidor_anterior3

  function do_ajax_form_webservicefe_validate_servidor_anterior3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_servidor_anterior3_cb

  // ---------- Validate token_anterior
  function do_ajax_form_webservicefe_validate_token_anterior()
  {
    var nomeCampo_token_anterior = "token_anterior";
    var var_token_anterior = scAjaxGetFieldText(nomeCampo_token_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_token_anterior(var_token_anterior, var_script_case_init, do_ajax_form_webservicefe_validate_token_anterior_cb);
  } // do_ajax_form_webservicefe_validate_token_anterior

  function do_ajax_form_webservicefe_validate_token_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_token_anterior_cb

  // ---------- Validate password_anterior
  function do_ajax_form_webservicefe_validate_password_anterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_password_anterior(var_password_anterior, var_script_case_init, do_ajax_form_webservicefe_validate_password_anterior_cb);
  } // do_ajax_form_webservicefe_validate_password_anterior

  function do_ajax_form_webservicefe_validate_password_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_password_anterior_cb

  // ---------- Validate envio_credenciales
  function do_ajax_form_webservicefe_validate_envio_credenciales()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_envio_credenciales(var_envio_credenciales, var_script_case_init, do_ajax_form_webservicefe_validate_envio_credenciales_cb);
  } // do_ajax_form_webservicefe_validate_envio_credenciales

  function do_ajax_form_webservicefe_validate_envio_credenciales_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_envio_credenciales_cb

  // ---------- Validate copia_factura_a
  function do_ajax_form_webservicefe_validate_copia_factura_a()
  {
    var nomeCampo_copia_factura_a = "copia_factura_a";
    var var_copia_factura_a = scAjaxGetFieldText(nomeCampo_copia_factura_a);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_copia_factura_a(var_copia_factura_a, var_script_case_init, do_ajax_form_webservicefe_validate_copia_factura_a_cb);
  } // do_ajax_form_webservicefe_validate_copia_factura_a

  function do_ajax_form_webservicefe_validate_copia_factura_a_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_copia_factura_a_cb

  // ---------- Validate plantillas_correo
  function do_ajax_form_webservicefe_validate_plantillas_correo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_plantillas_correo(var_plantillas_correo, var_script_case_init, do_ajax_form_webservicefe_validate_plantillas_correo_cb);
  } // do_ajax_form_webservicefe_validate_plantillas_correo

  function do_ajax_form_webservicefe_validate_plantillas_correo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_validate_plantillas_correo_cb

  // ---------- Validate plantilla_pordefecto
  function do_ajax_form_webservicefe_validate_plantilla_pordefecto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_validate_plantilla_pordefecto(var_plantilla_pordefecto, var_script_case_init, do_ajax_form_webservicefe_validate_plantilla_pordefecto_cb);
  } // do_ajax_form_webservicefe_validate_plantilla_pordefecto

  function do_ajax_form_webservicefe_validate_plantilla_pordefecto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_webservicefe_event_proveedor_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_webservicefe_event_proveedor_onchange(var_proveedor, var_servidor1, var_servidor2, var_servidor3, var_tokenempresa, var_tokenpassword, var_servidor_prueba1, var_servidor_prueba2, var_servidor_prueba3, var_token_prueba, var_password_prueba, var_url_api_pdfs, var_url_api_sendmail, var_script_case_init, do_ajax_form_webservicefe_event_proveedor_onchange_cb);
  } // do_ajax_form_webservicefe_event_proveedor_onchange

  function do_ajax_form_webservicefe_event_proveedor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "proveedor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_webservicefe_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_form_webservicefe_event_proveedor_onchange_cb
  function do_ajax_form_webservicefe_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_webservicefe_event_proveedor_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_webservicefe_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_webservicefe_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_proveedor = scAjaxGetFieldSelect("proveedor");
    ...
    var var_servidor2 = scAjaxGetFieldText("servidor2");
    var var_servidor3 = scAjaxGetFieldText("servidor3");
    var var_servidor4 = scAjaxGetFieldText("servidor4");
    var var_servidor5 = scAjaxGetFieldText("servidor5");
    var var_tokenempresa = scAjaxGetFieldText("tokenempresa");
    var var_tokenpassword = scAjaxGetFieldText("tokenpassword");
    var var_url_api_pdfs = scAjaxGetFieldText("url_api_pdfs");
    var var_url_api_sendmail = scAjaxGetFieldText("url_api_sendmail");
    ...
    scAjaxProcOn();
    x_ajax_form_webservicefe_submit_form(var_proveedor, var_modo, var_servidor1, var_servidor2, var_servidor3, var_servidor4, var_servidor5, var_tokenempresa, var_tokenpassword, var_url_api_pdfs, var_url_api_sendmail, var_servidor_prueba1, var_servidor_prueba2, var_servidor_prueba3, var_token_prueba, var_password_prueba, var_enviar_dian, var_enviar_cliente, var_proveedor_anterior, var_servidor_anterior1, var_servidor_anterior2, var_servidor_anterior3, var_token_anterior, var_password_anterior, var_envio_credenciales, var_copia_factura_a, var_plantillas_correo, var_plantilla_pordefecto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_webservicefe_submit_form_cb);
  } // do_ajax_form_webservicefe_submit_form

  function do_ajax_form_webservicefe_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("servidor4");
      scAjaxHideErrorDisplay("servidor5");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_webservicefe_submit_form_cb_after_alert);
  } // do_ajax_form_webservicefe_submit_form_cb
  function do_ajax_form_webservicefe_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_webservicefe_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_webservicefe_navigate_form()
  {
    perform_ajax_form_webservicefe_navigate_form();
  }

  function perform_ajax_form_webservicefe_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_webservicefe_navigate_form(var_idwebservicefe, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_webservicefe_navigate_form_cb);
  } // do_ajax_form_webservicefe_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_webservicefe_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_webservicefe_navigate_form_cb_after_alert);
  } // do_ajax_form_webservicefe_navigate_form_cb
  function do_ajax_form_webservicefe_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_webservicefe_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_webservicefe_navigate_form_cb_after_alert
  function sc_hide_form_webservicefe_form()
  {
  ...
  ajax_field_list[5] = "servidor4";
  ajax_field_list[6] = "servidor5";
  ajax_field_list[7] = "tokenempresa";
  ajax_field_list[8] = "tokenpassword";
  ajax_field_list[9] = "url_api_pdfs";
  ajax_field_list[10] = "url_api_sendmail";
  ajax_field_list[11] = "servidor_prueba1";
  ajax_field_list[12] = "servidor_prueba2";
  ajax_field_list[13] = "servidor_prueba3";
  ajax_field_list[14] = "token_prueba";
  ajax_field_list[15] = "password_prueba";
  ajax_field_list[16] = "enviar_dian";
  ajax_field_list[17] = "enviar_cliente";
  ajax_field_list[18] = "proveedor_anterior";
  ajax_field_list[19] = "servidor_anterior1";
  ajax_field_list[20] = "servidor_anterior2";
  ajax_field_list[21] = "servidor_anterior3";
  ajax_field_list[22] = "token_anterior";
  ajax_field_list[23] = "password_anterior";
  ajax_field_list[24] = "envio_credenciales";
  ajax_field_list[25] = "copia_factura_a";
  ajax_field_list[26] = "plantillas_correo";
  ajax_field_list[27] = "plantilla_pordefecto";
  ...
  var ajax_error_list = {
    ...
    "servidor4": {"label": "Servidor 4", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "servidor5": {"label": "Servidor 5", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["servidor4"][1] = "servidor4";
  ajax_field_mult["servidor5"][1] = "servidor5";
  ...
  var ajax_field_id = {
    ...
    "servidor4": new Array("hidden_field_label_servidor4", "hidden_field_data_servidor4"),
    "servidor5": new Array("hidden_field_label_servidor5", "hidden_field_data_servidor5"),
