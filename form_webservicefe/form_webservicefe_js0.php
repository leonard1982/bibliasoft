<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idwebservicefe" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idwebservicefe']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_webservicefe"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_webservicefe_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_webservicefe_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
...
{
    NovaJanela = window.open ("form_webservicefe_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
{
    document.getElementById('form_webservicefe_form0').style.width='1px';
    document.getElementById('form_webservicefe_form0').style.height='0px';
    document.getElementById('form_webservicefe_form0').style.display='none';
    document.getElementById('form_webservicefe_form0').style.overflow='scroll';
    document.getElementById('form_webservicefe_form1').style.width='1px';
    document.getElementById('form_webservicefe_form1').style.height='0px';
    document.getElementById('form_webservicefe_form1').style.display='none';
    document.getElementById('form_webservicefe_form1').style.overflow='scroll';
    document.getElementById('form_webservicefe_form2').style.width='1px';
    document.getElementById('form_webservicefe_form2').style.height='0px';
    document.getElementById('form_webservicefe_form2').style.display='none';
    document.getElementById('form_webservicefe_form2').style.overflow='scroll';
    document.getElementById('form_webservicefe_form3').style.width='1px';
    document.getElementById('form_webservicefe_form3').style.height='0px';
    document.getElementById('form_webservicefe_form3').style.display='none';
    document.getElementById('form_webservicefe_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe']['pdf_view']) {
?>
