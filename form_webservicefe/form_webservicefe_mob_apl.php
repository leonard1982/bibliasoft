...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_webservicefe_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_webservicefe_mob']['opc_ant'] = "inicio";
      }
      ...
      $_SESSION['scriptcase']['error_icon']['form_webservicefe_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
<?php
        ...
        include_once("form_webservicefe_mob_form3.php");
        $this->hideFormPages();
 }
