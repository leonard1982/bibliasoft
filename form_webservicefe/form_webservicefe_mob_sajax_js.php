  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_webservicefe_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_webservicefe_mob_form();
	}
...
?>
  ...
  // ---------- Validate proveedor
  function do_ajax_form_webservicefe_mob_validate_proveedor()
  {
    var nomeCampo_proveedor = "proveedor";
    var var_proveedor = scAjaxGetFieldSelect(nomeCampo_proveedor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_proveedor(var_proveedor, var_script_case_init, do_ajax_form_webservicefe_mob_validate_proveedor_cb);
  } // do_ajax_form_webservicefe_mob_validate_proveedor

  function do_ajax_form_webservicefe_mob_validate_proveedor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_proveedor_cb

  // ---------- Validate modo
  function do_ajax_form_webservicefe_mob_validate_modo()
  {
    var nomeCampo_modo = "modo";
    var var_modo = scAjaxGetFieldSelect(nomeCampo_modo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_modo(var_modo, var_script_case_init, do_ajax_form_webservicefe_mob_validate_modo_cb);
  } // do_ajax_form_webservicefe_mob_validate_modo

  function do_ajax_form_webservicefe_mob_validate_modo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "modo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_modo_cb

  // ---------- Validate servidor1
  function do_ajax_form_webservicefe_mob_validate_servidor1()
  {
    var nomeCampo_servidor1 = "servidor1";
    var var_servidor1 = scAjaxGetFieldText(nomeCampo_servidor1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor1(var_servidor1, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor1_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor1

  function do_ajax_form_webservicefe_mob_validate_servidor1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor1_cb

  // ---------- Validate servidor2
  function do_ajax_form_webservicefe_mob_validate_servidor2()
  {
    var nomeCampo_servidor2 = "servidor2";
    var var_servidor2 = scAjaxGetFieldText(nomeCampo_servidor2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor2(var_servidor2, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor2_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor2

  function do_ajax_form_webservicefe_mob_validate_servidor2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor2_cb

  // ---------- Validate servidor3
  function do_ajax_form_webservicefe_mob_validate_servidor3()
  {
    var nomeCampo_servidor3 = "servidor3";
    var var_servidor3 = scAjaxGetFieldText(nomeCampo_servidor3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor3(var_servidor3, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor3_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor3

  function do_ajax_form_webservicefe_mob_validate_servidor3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor3_cb

  // ---------- Validate servidor4
  function do_ajax_form_webservicefe_mob_validate_servidor4()
  {
    var nomeCampo_servidor4 = "servidor4";
    var var_servidor4 = scAjaxGetFieldText(nomeCampo_servidor4);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor4(var_servidor4, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor4_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor4

  function do_ajax_form_webservicefe_mob_validate_servidor4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor4_cb

  // ---------- Validate servidor5
  function do_ajax_form_webservicefe_mob_validate_servidor5()
  {
    var nomeCampo_servidor5 = "servidor5";
    var var_servidor5 = scAjaxGetFieldText(nomeCampo_servidor5);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor5(var_servidor5, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor5_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor5

  function do_ajax_form_webservicefe_mob_validate_servidor5_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor5_cb

  // ---------- Validate tokenempresa
  function do_ajax_form_webservicefe_mob_validate_tokenempresa()
  {
    var nomeCampo_tokenempresa = "tokenempresa";
    var var_tokenempresa = scAjaxGetFieldText(nomeCampo_tokenempresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_tokenempresa(var_tokenempresa, var_script_case_init, do_ajax_form_webservicefe_mob_validate_tokenempresa_cb);
  } // do_ajax_form_webservicefe_mob_validate_tokenempresa

  function do_ajax_form_webservicefe_mob_validate_tokenempresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_tokenempresa_cb

  // ---------- Validate tokenpassword
  function do_ajax_form_webservicefe_mob_validate_tokenpassword()
  {
    var nomeCampo_tokenpassword = "tokenpassword";
    var var_tokenpassword = scAjaxGetFieldText(nomeCampo_tokenpassword);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_tokenpassword(var_tokenpassword, var_script_case_init, do_ajax_form_webservicefe_mob_validate_tokenpassword_cb);
  } // do_ajax_form_webservicefe_mob_validate_tokenpassword

  function do_ajax_form_webservicefe_mob_validate_tokenpassword_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_webservicefe_mob_validate_servidor_prueba1()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor_prueba1(var_servidor_prueba1, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor_prueba1_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor_prueba1

  function do_ajax_form_webservicefe_mob_validate_servidor_prueba1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor_prueba1_cb

  // ---------- Validate servidor_prueba2
  function do_ajax_form_webservicefe_mob_validate_servidor_prueba2()
  {
    var nomeCampo_servidor_prueba2 = "servidor_prueba2";
    var var_servidor_prueba2 = scAjaxGetFieldText(nomeCampo_servidor_prueba2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor_prueba2(var_servidor_prueba2, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor_prueba2_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor_prueba2

  function do_ajax_form_webservicefe_mob_validate_servidor_prueba2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor_prueba2_cb

  // ---------- Validate servidor_prueba3
  function do_ajax_form_webservicefe_mob_validate_servidor_prueba3()
  {
    var nomeCampo_servidor_prueba3 = "servidor_prueba3";
    var var_servidor_prueba3 = scAjaxGetFieldText(nomeCampo_servidor_prueba3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor_prueba3(var_servidor_prueba3, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor_prueba3_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor_prueba3

  function do_ajax_form_webservicefe_mob_validate_servidor_prueba3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor_prueba3_cb

  // ---------- Validate token_prueba
  function do_ajax_form_webservicefe_mob_validate_token_prueba()
  {
    var nomeCampo_token_prueba = "token_prueba";
    var var_token_prueba = scAjaxGetFieldText(nomeCampo_token_prueba);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_token_prueba(var_token_prueba, var_script_case_init, do_ajax_form_webservicefe_mob_validate_token_prueba_cb);
  } // do_ajax_form_webservicefe_mob_validate_token_prueba

  function do_ajax_form_webservicefe_mob_validate_token_prueba_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_token_prueba_cb

  // ---------- Validate password_prueba
  function do_ajax_form_webservicefe_mob_validate_password_prueba()
  {
    var nomeCampo_password_prueba = "password_prueba";
    var var_password_prueba = scAjaxGetFieldText(nomeCampo_password_prueba);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_password_prueba(var_password_prueba, var_script_case_init, do_ajax_form_webservicefe_mob_validate_password_prueba_cb);
  } // do_ajax_form_webservicefe_mob_validate_password_prueba

  function do_ajax_form_webservicefe_mob_validate_password_prueba_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_password_prueba_cb

  // ---------- Validate enviar_dian
  function do_ajax_form_webservicefe_mob_validate_enviar_dian()
  {
    var nomeCampo_enviar_dian = "enviar_dian";
    var var_enviar_dian = scAjaxGetFieldCheckbox(nomeCampo_enviar_dian, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_enviar_dian(var_enviar_dian, var_script_case_init, do_ajax_form_webservicefe_mob_validate_enviar_dian_cb);
  } // do_ajax_form_webservicefe_mob_validate_enviar_dian

  function do_ajax_form_webservicefe_mob_validate_enviar_dian_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_enviar_dian_cb

  // ---------- Validate enviar_cliente
  function do_ajax_form_webservicefe_mob_validate_enviar_cliente()
  {
    var nomeCampo_enviar_cliente = "enviar_cliente";
    var var_enviar_cliente = scAjaxGetFieldCheckbox(nomeCampo_enviar_cliente, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_enviar_cliente(var_enviar_cliente, var_script_case_init, do_ajax_form_webservicefe_mob_validate_enviar_cliente_cb);
  } // do_ajax_form_webservicefe_mob_validate_enviar_cliente

  function do_ajax_form_webservicefe_mob_validate_enviar_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_webservicefe_mob_validate_proveedor_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_proveedor_anterior_cb

  // ---------- Validate servidor_anterior1
  function do_ajax_form_webservicefe_mob_validate_servidor_anterior1()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor_anterior1(var_servidor_anterior1, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor_anterior1_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor_anterior1

  function do_ajax_form_webservicefe_mob_validate_servidor_anterior1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor_anterior1_cb

  // ---------- Validate servidor_anterior2
  function do_ajax_form_webservicefe_mob_validate_servidor_anterior2()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor_anterior2(var_servidor_anterior2, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor_anterior2_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor_anterior2

  function do_ajax_form_webservicefe_mob_validate_servidor_anterior2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor_anterior2_cb

  // ---------- Validate servidor_anterior3
  function do_ajax_form_webservicefe_mob_validate_servidor_anterior3()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_servidor_anterior3(var_servidor_anterior3, var_script_case_init, do_ajax_form_webservicefe_mob_validate_servidor_anterior3_cb);
  } // do_ajax_form_webservicefe_mob_validate_servidor_anterior3

  function do_ajax_form_webservicefe_mob_validate_servidor_anterior3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_servidor_anterior3_cb

  // ---------- Validate token_anterior
  function do_ajax_form_webservicefe_mob_validate_token_anterior()
  {
    var nomeCampo_token_anterior = "token_anterior";
    var var_token_anterior = scAjaxGetFieldText(nomeCampo_token_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_token_anterior(var_token_anterior, var_script_case_init, do_ajax_form_webservicefe_mob_validate_token_anterior_cb);
  } // do_ajax_form_webservicefe_mob_validate_token_anterior

  function do_ajax_form_webservicefe_mob_validate_token_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_webservicefe_mob_validate_token_anterior_cb

  // ---------- Validate password_anterior
  function do_ajax_form_webservicefe_mob_validate_password_anterior()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_webservicefe_mob_validate_password_anterior(var_password_anterior, var_script_case_init, do_ajax_form_webservicefe_mob_validate_password_anterior_cb);
  } // do_ajax_form_webservicefe_mob_validate_password_anterior

  function do_ajax_form_webservicefe_mob_validate_password_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange(var_proveedor_anterior, var_servidor_anterior1, var_servidor_anterior2, var_servidor_anterior3, var_script_case_init, do_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange_cb);
  } // do_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange

  function do_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "proveedor_anterior";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange_cb_after_alert);
  } // do_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange_cb
  function do_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_webservicefe_mob_event_proveedor_anterior_onchange_cb_after_alert
  ...
  function do_ajax_form_webservicefe_mob_event_proveedor_onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_webservicefe_mob_event_proveedor_onchange_cb_after_alert);
  } // do_ajax_form_webservicefe_mob_event_proveedor_onchange_cb
  function do_ajax_form_webservicefe_mob_event_proveedor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_webservicefe_mob_event_proveedor_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_webservicefe_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_webservicefe_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_proveedor = scAjaxGetFieldSelect("proveedor");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_webservicefe_mob_submit_form_cb_after_alert);
  } // do_ajax_form_webservicefe_mob_submit_form_cb
  function do_ajax_form_webservicefe_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_webservicefe_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_webservicefe_mob_navigate_form()
  {
    perform_ajax_form_webservicefe_mob_navigate_form();
  }

  function perform_ajax_form_webservicefe_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_webservicefe_mob_navigate_form(var_idwebservicefe, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_webservicefe_mob_navigate_form_cb);
  } // do_ajax_form_webservicefe_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_webservicefe_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_webservicefe_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_webservicefe_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_webservicefe_mob_navigate_form_cb
  function do_ajax_form_webservicefe_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_webservicefe_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_webservicefe_mob_navigate_form_cb_after_alert
  function sc_hide_form_webservicefe_mob_form()
  {
