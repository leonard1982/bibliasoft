...
class grid_pagos_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_client = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['arr_total']['client'];
      }
      else
      {
          $this->array_total_client = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['arr_total']['client'] = $this->array_total_client;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_order']['tercero']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_order']['tercero'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_order']['tercero'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_display']['tercero'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_display']['tercero'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_display']['tercero'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_display']['tercero'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_display']['tercero'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_display']['tercero'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['summarizing_fields_display']['tercero'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_client as $i_client => $d_client) {
           if (!in_array($i_client, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_client[5] ] = $d_client[4];
               $this->comp_label[0][ $d_client[5] ] = $d_client[4];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_client => $l_client) {
           if (isset($this->array_total_client[$i_client])) {
               $this->comp_group[$i_client] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_client;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_client)),
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_montocan, $sum_ret, $quebra_client, $quebra_client_orig)
   {
      //----- Proveedor
      if (!isset($this->array_total_client[$quebra_client_orig]))
      {
         $this->array_total_client[$quebra_client_orig][0] = 1;
         $this->array_total_client[$quebra_client_orig][1] = $sum_montocan;
         $this->array_total_client[$quebra_client_orig][2] = $sum_ret;
         $this->array_total_client[$quebra_client_orig][3] = 1;
         $this->array_total_client[$quebra_client_orig][4] = $quebra_client;
         $this->array_total_client[$quebra_client_orig][5] = $quebra_client_orig;
      }
      else
      {
         $this->array_total_client[$quebra_client_orig][0]++;
         $this->array_total_client[$quebra_client_orig][1] += $sum_montocan;
         $this->array_total_client[$quebra_client_orig][2] += $sum_ret;
         $this->array_total_client[$quebra_client_orig][3]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'client');
     $campos_order = $this->Ini->Get_date_order_groupby("client", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_pagos']['contr_erro'] = 'off'; 
            $this->client_orig = $this->client;
            $this->client = $this->look_client ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->montocan, $this->ret, $this->client, $this->client_orig);
            }
   }
//
