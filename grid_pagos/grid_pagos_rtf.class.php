...
class grid_pagos_rtf
{
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_pagos']['contr_erro'] = 'off'; 
   ...
   function NM_export_ncuenta_tercero()
   {
         ...
         $this->ncuenta_tercero = str_replace('<', '&lt;', $this->ncuenta_tercero);
         $this->ncuenta_tercero = str_replace('>', '&gt;', $this->ncuenta_tercero);
         $this->Texto_tag .= "<td>" . $this->ncuenta_tercero . "</td>\r\n";
   }
   //----- ret
   ...
   function NM_export_id_concepto()
   {
         ...
         $this->look_id_concepto = str_replace('<', '&lt;', $this->look_id_concepto);
         $this->look_id_concepto = str_replace('>', '&gt;', $this->look_id_concepto);
         $this->Texto_tag .= "<td>" . $this->look_id_concepto . "</td>\r\n";
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
