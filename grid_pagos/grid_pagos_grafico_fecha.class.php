...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['contr_label_graf']['fecpago']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['contr_label_graf']['fecpago']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pagos']['contr_label_graf']['fecpago'];
      }
   }
