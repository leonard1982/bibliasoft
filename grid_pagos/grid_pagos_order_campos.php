...
<?php
   ...
   $Ord_Cmp = new grid_pagos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pagos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numpago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["numpago"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["numpago"] : "CE N°";
   $tab_ger_campos['fecpago'] = "on";
   $tab_def_campos['fecpago'] = "fecpago";
   $tab_labels["fecpago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["fecpago"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["fecpago"] : "Fecha";
   $tab_ger_campos['client'] = "on";
   $tab_def_campos['client'] = "client";
   $tab_labels["client"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["client"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["client"] : "Proveedor";
   $tab_ger_campos['montocan'] = "on";
   $tab_def_campos['montocan'] = "montocan";
   $tab_labels["montocan"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["montocan"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["montocan"] : "Valor";
   $tab_ger_campos['docapagar'] = "on";
   $tab_def_campos['docapagar'] = "docapagar";
   $tab_labels["docapagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["docapagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["docapagar"] : "Doc";
   $tab_ger_campos['ncuenta_tercero'] = "on";
   $tab_def_campos['ncuenta_tercero'] = "ncuenta_tercero";
   $tab_labels["ncuenta_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["ncuenta_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["ncuenta_tercero"] : "Cuenta";
   $tab_ger_campos['ret'] = "on";
   $tab_def_campos['ret'] = "ret";
   $tab_labels["ret"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["ret"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["ret"] : "Retenc. Efect.";
   $tab_ger_campos['descuent'] = "on";
   $tab_def_campos['descuent'] = "descuent";
   $tab_labels["descuent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["descuent"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["descuent"] : "Descuento";
   $tab_ger_campos['asent'] = "on";
   $tab_def_campos['asent'] = "asent";
   $tab_labels["asent"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["asent"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["asent"] : "Asentado";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['labels']["imprimir"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pagos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pagos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pagos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pagos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
