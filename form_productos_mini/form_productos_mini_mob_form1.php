<div id="form_productos_mini_mob_form1" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_imagen_line" id="hidden_field_data_imagen" style="<?php echo $sStyleHidden_imagen; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_imagen_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_imagen_label"><span id="id_label_imagen"><?php echo $this->nm_new_label['imagen']; ?></span></span><br>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_cod_cuenta']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_cod_cuenta'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_cod_cuenta']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_cod_cuenta'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_cod_cuenta'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
else
{
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_cod_cuenta'][] = ''; 
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idprod_line" id="hidden_field_data_idprod" style="<?php echo $sStyleHidden_idprod; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idprod_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idprod_label"><span id="id_label_idprod"><?php echo $this->nm_new_label['idprod']; ?></span></span><br><span id="id_read_on_idprod" class="css_idprod_line" style="<?php echo $sStyleReadLab_idprod; ?>"><?php echo $this->form_encode_input($this->idprod); ?></span><span id="id_read_off_idprod" style="<?php echo $sStyleReadInp_idprod; ?>"><input type="hidden" name="idprod" value="<?php echo $this->form_encode_input($idprod) . "\">"?><span id="id_ajax_label_idprod"><?php echo nl2br($idprod); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_marca_line" id="hidden_field_data_id_marca" style="<?php echo $sStyleHidden_id_marca; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_marca_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_marca_label"><span id="id_label_id_marca"><?php echo $this->nm_new_label['id_marca']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["id_marca"]) &&  $this->nmgp_cmp_readonly["id_marca"] == "on") { 
 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_marca']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_marca'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_marca']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_marca'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_marca'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
else
{
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_marca'][] = ''; 
   echo "  <option value=\"\">SELECCIONE</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   if (isset($this->Ini->sc_lig_md5["form_marca"]) && $this->Ini->sc_lig_md5["form_marca"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_mini_mob_lkpedt_refresh_id_marca*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       ...
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_mini_mob_lkpedt_refresh_id_marca*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_id_linea_line" id="hidden_field_data_id_linea" style="<?php echo $sStyleHidden_id_linea; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_linea_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_id_linea_label"><span id="id_label_id_linea"><?php echo $this->nm_new_label['id_linea']; ?></span></span><br>
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["id_linea"]) &&  $this->nmgp_cmp_readonly["id_linea"] == "on") { 
 
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_linea']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_linea'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_linea']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_linea'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando)) 
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_linea'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
else
{
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lookup_id_linea'][] = ''; 
   echo "  <option value=\"\">SELECCIONE</option>" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
   ...
   if (isset($this->Ini->sc_lig_md5["form_linea"]) && $this->Ini->sc_lig_md5["form_linea"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_mini_mob_lkpedt_refresh_id_linea*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos_mini_mob@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_mini_mob_lkpedt_refresh_id_linea*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['run_iframe'] != "R")
{
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['mostra_cab'] != "N"))
  {
?>
</td></tr> 
...
<script> 
<?php
 $NM_pag_atual = "form_productos_mini_mob_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_productos_mini_mob_form" . $this->nmgp_ancora;
 }
?>
