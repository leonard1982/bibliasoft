  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_productos_mini_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_productos_mini_mob_form();
	}
  ...
  // ---------- Validate codigobar
  function do_ajax_form_productos_mini_mob_validate_codigobar()
  {
    var nomeCampo_codigobar = "codigobar";
    var var_codigobar = scAjaxGetFieldText(nomeCampo_codigobar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_codigobar(var_codigobar, var_script_case_init, do_ajax_form_productos_mini_mob_validate_codigobar_cb);
  } // do_ajax_form_productos_mini_mob_validate_codigobar

  function do_ajax_form_productos_mini_mob_validate_codigobar_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_codigobar_cb

  // ---------- Validate codigoprod
  function do_ajax_form_productos_mini_mob_validate_codigoprod()
  {
    var nomeCampo_codigoprod = "codigoprod";
    var var_codigoprod = scAjaxGetFieldText(nomeCampo_codigoprod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_codigoprod(var_codigoprod, var_script_case_init, do_ajax_form_productos_mini_mob_validate_codigoprod_cb);
  } // do_ajax_form_productos_mini_mob_validate_codigoprod

  function do_ajax_form_productos_mini_mob_validate_codigoprod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_codigoprod_cb

  // ---------- Validate nompro
  function do_ajax_form_productos_mini_mob_validate_nompro()
  {
    var nomeCampo_nompro = "nompro";
    var var_nompro = scAjaxGetFieldText(nomeCampo_nompro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_nompro(var_nompro, var_script_case_init, do_ajax_form_productos_mini_mob_validate_nompro_cb);
  } // do_ajax_form_productos_mini_mob_validate_nompro

  function do_ajax_form_productos_mini_mob_validate_nompro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nompro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_nompro_cb

  // ---------- Validate idgrup
  function do_ajax_form_productos_mini_mob_validate_idgrup()
  {
    var nomeCampo_idgrup = "idgrup";
    var var_idgrup = scAjaxGetFieldSelect(nomeCampo_idgrup);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_idgrup(var_idgrup, var_script_case_init, do_ajax_form_productos_mini_mob_validate_idgrup_cb);
  } // do_ajax_form_productos_mini_mob_validate_idgrup

  function do_ajax_form_productos_mini_mob_validate_idgrup_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idgrup";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_idgrup_cb

  // ---------- Validate idpro1
  function do_ajax_form_productos_mini_mob_validate_idpro1()
  {
  } // do_ajax_form_productos_mini_mob_validate_idpro1

  function do_ajax_form_productos_mini_mob_validate_idpro1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpro1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_idpro1_cb

  // ---------- Validate tipo_producto
  function do_ajax_form_productos_mini_mob_validate_tipo_producto()
  {
    var nomeCampo_tipo_producto = "tipo_producto";
    var var_tipo_producto = scAjaxGetFieldSelect(nomeCampo_tipo_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_tipo_producto(var_tipo_producto, var_script_case_init, do_ajax_form_productos_mini_mob_validate_tipo_producto_cb);
  } // do_ajax_form_productos_mini_mob_validate_tipo_producto

  function do_ajax_form_productos_mini_mob_validate_tipo_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_tipo_producto_cb

  // ---------- Validate idpro2
  function do_ajax_form_productos_mini_mob_validate_idpro2()
  {
  } // do_ajax_form_productos_mini_mob_validate_idpro2

  function do_ajax_form_productos_mini_mob_validate_idpro2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpro2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_idpro2_cb

  // ---------- Validate otro
  function do_ajax_form_productos_mini_mob_validate_otro()
  {
    var nomeCampo_otro = "otro";
    var var_otro = scAjaxGetFieldSelect(nomeCampo_otro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_otro(var_otro, var_script_case_init, do_ajax_form_productos_mini_mob_validate_otro_cb);
  } // do_ajax_form_productos_mini_mob_validate_otro

  function do_ajax_form_productos_mini_mob_validate_otro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "otro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_otro_cb

  // ---------- Validate otro2
  function do_ajax_form_productos_mini_mob_validate_otro2()
  {
    var nomeCampo_otro2 = "otro2";
    var var_otro2 = scAjaxGetFieldText(nomeCampo_otro2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_otro2(var_otro2, var_script_case_init, do_ajax_form_productos_mini_mob_validate_otro2_cb);
  } // do_ajax_form_productos_mini_mob_validate_otro2

  function do_ajax_form_productos_mini_mob_validate_otro2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "otro2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_otro2_cb

  // ---------- Validate precio_editable
  function do_ajax_form_productos_mini_mob_validate_precio_editable()
  {
    var nomeCampo_precio_editable = "precio_editable";
    var var_precio_editable = scAjaxGetFieldSelect(nomeCampo_precio_editable);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_precio_editable(var_precio_editable, var_script_case_init, do_ajax_form_productos_mini_mob_validate_precio_editable_cb);
  } // do_ajax_form_productos_mini_mob_validate_precio_editable

  function do_ajax_form_productos_mini_mob_validate_precio_editable_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_precio_editable_cb

  // ---------- Validate maneja_tcs_lfs
  function do_ajax_form_productos_mini_mob_validate_maneja_tcs_lfs()
  {
    var nomeCampo_maneja_tcs_lfs = "maneja_tcs_lfs";
    var var_maneja_tcs_lfs = scAjaxGetFieldRadio(nomeCampo_maneja_tcs_lfs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_maneja_tcs_lfs(var_maneja_tcs_lfs, var_script_case_init, do_ajax_form_productos_mini_mob_validate_maneja_tcs_lfs_cb);
  } // do_ajax_form_productos_mini_mob_validate_maneja_tcs_lfs

  function do_ajax_form_productos_mini_mob_validate_maneja_tcs_lfs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_maneja_tcs_lfs_cb

  // ---------- Validate stockmen
  function do_ajax_form_productos_mini_mob_validate_stockmen()
  {
    var nomeCampo_stockmen = "stockmen";
    var var_stockmen = scAjaxGetFieldHidden(nomeCampo_stockmen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_stockmen(var_stockmen, var_script_case_init, do_ajax_form_productos_mini_mob_validate_stockmen_cb);
  } // do_ajax_form_productos_mini_mob_validate_stockmen

  function do_ajax_form_productos_mini_mob_validate_stockmen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_stockmen_cb

  // ---------- Validate unidmaymen
  function do_ajax_form_productos_mini_mob_validate_unidmaymen()
  {
    var nomeCampo_unidmaymen = "unidmaymen";
    var var_unidmaymen = scAjaxGetFieldRadio(nomeCampo_unidmaymen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_unidmaymen(var_unidmaymen, var_script_case_init, do_ajax_form_productos_mini_mob_validate_unidmaymen_cb);
  } // do_ajax_form_productos_mini_mob_validate_unidmaymen

  function do_ajax_form_productos_mini_mob_validate_unidmaymen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_unidmaymen_cb

  // ---------- Validate unimay
  function do_ajax_form_productos_mini_mob_validate_unimay()
  {
    var nomeCampo_unimay = "unimay";
    var var_unimay = scAjaxGetFieldText(nomeCampo_unimay);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_unimay(var_unimay, var_script_case_init, do_ajax_form_productos_mini_mob_validate_unimay_cb);
  } // do_ajax_form_productos_mini_mob_validate_unimay

  function do_ajax_form_productos_mini_mob_validate_unimay_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unimay";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_unimay_cb

  // ---------- Validate unimen
  function do_ajax_form_productos_mini_mob_validate_unimen()
  {
    var nomeCampo_unimen = "unimen";
    var var_unimen = scAjaxGetFieldText(nomeCampo_unimen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_unimen(var_unimen, var_script_case_init, do_ajax_form_productos_mini_mob_validate_unimen_cb);
  } // do_ajax_form_productos_mini_mob_validate_unimen

  function do_ajax_form_productos_mini_mob_validate_unimen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unimen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_unimen_cb

  // ---------- Validate unidad_ma
  function do_ajax_form_productos_mini_mob_validate_unidad_ma()
  {
  } // do_ajax_form_productos_mini_mob_validate_unidad_ma

  function do_ajax_form_productos_mini_mob_validate_unidad_ma_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_unidad_ma_cb

  // ---------- Validate unidad_
  function do_ajax_form_productos_mini_mob_validate_unidad_()
  {
  } // do_ajax_form_productos_mini_mob_validate_unidad_

  function do_ajax_form_productos_mini_mob_validate_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unidad_";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_unidad__cb

  // ---------- Validate multiple_escala
  function do_ajax_form_productos_mini_mob_validate_multiple_escala()
  {
    var nomeCampo_multiple_escala = "multiple_escala";
    var var_multiple_escala = scAjaxGetFieldRadio(nomeCampo_multiple_escala);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_multiple_escala(var_multiple_escala, var_script_case_init, do_ajax_form_productos_mini_mob_validate_multiple_escala_cb);
  } // do_ajax_form_productos_mini_mob_validate_multiple_escala

  function do_ajax_form_productos_mini_mob_validate_multiple_escala_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_multiple_escala_cb

  // ---------- Validate en_base_a
  function do_ajax_form_productos_mini_mob_validate_en_base_a()
  {
    var nomeCampo_en_base_a = "en_base_a";
    var var_en_base_a = scAjaxGetFieldRadio(nomeCampo_en_base_a);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_en_base_a(var_en_base_a, var_script_case_init, do_ajax_form_productos_mini_mob_validate_en_base_a_cb);
  } // do_ajax_form_productos_mini_mob_validate_en_base_a

  function do_ajax_form_productos_mini_mob_validate_en_base_a_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_en_base_a_cb

  // ---------- Validate costomen
  function do_ajax_form_productos_mini_mob_validate_costomen()
  {
    var nomeCampo_costomen = "costomen";
    var var_costomen = scAjaxGetFieldText(nomeCampo_costomen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_costomen(var_costomen, var_script_case_init, do_ajax_form_productos_mini_mob_validate_costomen_cb);
  } // do_ajax_form_productos_mini_mob_validate_costomen

  function do_ajax_form_productos_mini_mob_validate_costomen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_costomen_cb

  // ---------- Validate costo_prom
  function do_ajax_form_productos_mini_mob_validate_costo_prom()
  {
    var nomeCampo_costo_prom = "costo_prom";
    var var_costo_prom = scAjaxGetFieldHidden(nomeCampo_costo_prom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_costo_prom(var_costo_prom, var_script_case_init, do_ajax_form_productos_mini_mob_validate_costo_prom_cb);
  } // do_ajax_form_productos_mini_mob_validate_costo_prom

  function do_ajax_form_productos_mini_mob_validate_costo_prom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_costo_prom_cb

  // ---------- Validate recmayamen
  function do_ajax_form_productos_mini_mob_validate_recmayamen()
  {
    var nomeCampo_recmayamen = "recmayamen";
    var var_recmayamen = scAjaxGetFieldText(nomeCampo_recmayamen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_recmayamen(var_recmayamen, var_script_case_init, do_ajax_form_productos_mini_mob_validate_recmayamen_cb);
  } // do_ajax_form_productos_mini_mob_validate_recmayamen

  function do_ajax_form_productos_mini_mob_validate_recmayamen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_recmayamen_cb

  // ---------- Validate idiva
  function do_ajax_form_productos_mini_mob_validate_idiva()
  {
    var nomeCampo_idiva = "idiva";
    var var_idiva = scAjaxGetFieldSelect(nomeCampo_idiva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_idiva(var_idiva, var_script_case_init, do_ajax_form_productos_mini_mob_validate_idiva_cb);
  } // do_ajax_form_productos_mini_mob_validate_idiva

  function do_ajax_form_productos_mini_mob_validate_idiva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idiva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_idiva_cb

  // ---------- Validate existencia
  function do_ajax_form_productos_mini_mob_validate_existencia()
  {
    var nomeCampo_existencia = "existencia";
    var var_existencia = scAjaxGetFieldHidden(nomeCampo_existencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_existencia(var_existencia, var_script_case_init, do_ajax_form_productos_mini_mob_validate_existencia_cb);
  } // do_ajax_form_productos_mini_mob_validate_existencia

  function do_ajax_form_productos_mini_mob_validate_existencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_existencia_cb

  // ---------- Validate u_menor
  function do_ajax_form_productos_mini_mob_validate_u_menor()
  {
    var nomeCampo_u_menor = "u_menor";
    var var_u_menor = scAjaxGetFieldHidden(nomeCampo_u_menor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_u_menor(var_u_menor, var_script_case_init, do_ajax_form_productos_mini_mob_validate_u_menor_cb);
  } // do_ajax_form_productos_mini_mob_validate_u_menor

  function do_ajax_form_productos_mini_mob_validate_u_menor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "u_menor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_u_menor_cb

  // ---------- Validate activo
  function do_ajax_form_productos_mini_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldRadio(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_productos_mini_mob_validate_activo_cb);
  } // do_ajax_form_productos_mini_mob_validate_activo

  function do_ajax_form_productos_mini_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_activo_cb

  // ---------- Validate preciofull
  function do_ajax_form_productos_mini_mob_validate_preciofull()
  {
    var nomeCampo_preciofull = "preciofull";
    var var_preciofull = scAjaxGetFieldText(nomeCampo_preciofull);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_preciofull(var_preciofull, var_script_case_init, do_ajax_form_productos_mini_mob_validate_preciofull_cb);
  } // do_ajax_form_productos_mini_mob_validate_preciofull

  function do_ajax_form_productos_mini_mob_validate_preciofull_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_preciofull_cb

  // ---------- Validate precio2
  function do_ajax_form_productos_mini_mob_validate_precio2()
  {
    var nomeCampo_precio2 = "precio2";
    var var_precio2 = scAjaxGetFieldText(nomeCampo_precio2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_precio2(var_precio2, var_script_case_init, do_ajax_form_productos_mini_mob_validate_precio2_cb);
  } // do_ajax_form_productos_mini_mob_validate_precio2

  function do_ajax_form_productos_mini_mob_validate_precio2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "precio2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_precio2_cb

  // ---------- Validate preciomay
  function do_ajax_form_productos_mini_mob_validate_preciomay()
  {
    var nomeCampo_preciomay = "preciomay";
    var var_preciomay = scAjaxGetFieldText(nomeCampo_preciomay);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_preciomay(var_preciomay, var_script_case_init, do_ajax_form_productos_mini_mob_validate_preciomay_cb);
  } // do_ajax_form_productos_mini_mob_validate_preciomay

  function do_ajax_form_productos_mini_mob_validate_preciomay_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_preciomay_cb

  // ---------- Validate preciomen
  function do_ajax_form_productos_mini_mob_validate_preciomen()
  {
    var nomeCampo_preciomen = "preciomen";
    var var_preciomen = scAjaxGetFieldText(nomeCampo_preciomen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_preciomen(var_preciomen, var_script_case_init, do_ajax_form_productos_mini_mob_validate_preciomen_cb);
  } // do_ajax_form_productos_mini_mob_validate_preciomen

  function do_ajax_form_productos_mini_mob_validate_preciomen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_preciomen_cb

  // ---------- Validate preciomen2
  function do_ajax_form_productos_mini_mob_validate_preciomen2()
  {
    var nomeCampo_preciomen2 = "preciomen2";
    var var_preciomen2 = scAjaxGetFieldText(nomeCampo_preciomen2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_preciomen2(var_preciomen2, var_script_case_init, do_ajax_form_productos_mini_mob_validate_preciomen2_cb);
  } // do_ajax_form_productos_mini_mob_validate_preciomen2

  function do_ajax_form_productos_mini_mob_validate_preciomen2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_preciomen2_cb

  // ---------- Validate preciomen3
  function do_ajax_form_productos_mini_mob_validate_preciomen3()
  {
    var nomeCampo_preciomen3 = "preciomen3";
    var var_preciomen3 = scAjaxGetFieldText(nomeCampo_preciomen3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_mini_mob_validate_preciomen3(var_preciomen3, var_script_case_init, do_ajax_form_productos_mini_mob_validate_preciomen3_cb);
  } // do_ajax_form_productos_mini_mob_validate_preciomen3

  function do_ajax_form_productos_mini_mob_validate_preciomen3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_mini_mob_validate_preciomen3_cb

  // ---------- Event onchange colores
  function do_ajax_form_productos_mini_mob_event_colores_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_colores_onchange(var_script_case_init, do_ajax_form_productos_mini_mob_event_colores_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_colores_onchange

  function do_ajax_form_productos_mini_mob_event_colores_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "colores";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_colores_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_colores_onchange_cb
  function do_ajax_form_productos_mini_mob_event_colores_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_colores_onchange_cb_after_alert

  // ---------- Event onclick control_costo
  function do_ajax_form_productos_mini_mob_event_control_costo_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_control_costo_onclick(var_recmayamen, var_idiva, var_unidmaymen, var_costomen, var_script_case_init, do_ajax_form_productos_mini_mob_event_control_costo_onclick_cb);
  } // do_ajax_form_productos_mini_mob_event_control_costo_onclick

  function do_ajax_form_productos_mini_mob_event_control_costo_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_control_costo_onclick_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_control_costo_onclick_cb
  function do_ajax_form_productos_mini_mob_event_control_costo_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_control_costo_onclick_cb_after_alert

  // ---------- Event onclick en_base_a
  function do_ajax_form_productos_mini_mob_event_en_base_a_onclick()
  {
    var var_en_base_a = scAjaxGetFieldRadio("en_base_a");
    var var_unidmaymen = scAjaxGetFieldRadio("unidmaymen");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_en_base_a_onclick(var_en_base_a, var_unidmaymen, var_script_case_init, do_ajax_form_productos_mini_mob_event_en_base_a_onclick_cb);
  } // do_ajax_form_productos_mini_mob_event_en_base_a_onclick

  function do_ajax_form_productos_mini_mob_event_en_base_a_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "en_base_a";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_en_base_a_onclick_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_en_base_a_onclick_cb
  function do_ajax_form_productos_mini_mob_event_en_base_a_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_en_base_a_onclick_cb_after_alert

  // ---------- Event onchange fecha_vencimiento
  function do_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange(var_script_case_init, do_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange

  function do_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange_cb
  function do_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_fecha_vencimiento_onchange_cb_after_alert

  // ---------- Event onchange idpro1
  function do_ajax_form_productos_mini_mob_event_idpro1_onchange()
  {
    var var_idpro2 = scAjaxGetFieldText("id_ac_idpro2");
    var var_idpro1 = scAjaxGetFieldText("id_ac_idpro1");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_idpro1_onchange(var_idpro2, var_idpro1, var_script_case_init, do_ajax_form_productos_mini_mob_event_idpro1_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_idpro1_onchange

  function do_ajax_form_productos_mini_mob_event_idpro1_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpro1";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_idpro1_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_idpro1_onchange_cb
  function do_ajax_form_productos_mini_mob_event_idpro1_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_idpro1_onchange_cb_after_alert

  // ---------- Event onchange lote
  function do_ajax_form_productos_mini_mob_event_lote_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_lote_onchange(var_script_case_init, do_ajax_form_productos_mini_mob_event_lote_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_lote_onchange

  function do_ajax_form_productos_mini_mob_event_lote_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "lote";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_lote_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_lote_onchange_cb
  function do_ajax_form_productos_mini_mob_event_lote_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_lote_onchange_cb_after_alert

  // ---------- Event onclick maneja_tcs_lfs
  function do_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick(var_maneja_tcs_lfs, var_codigobar, var_nompro, var_script_case_init, do_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick_cb);
  } // do_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick

  function do_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "maneja_tcs_lfs";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick_cb
  function do_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_maneja_tcs_lfs_onclick_cb_after_alert

  // ---------- Event onclick multiple_escala
  function do_ajax_form_productos_mini_mob_event_multiple_escala_onclick()
  {
    var var_multiple_escala = scAjaxGetFieldRadio("multiple_escala");
    var var_unidmaymen = scAjaxGetFieldRadio("unidmaymen");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_multiple_escala_onclick(var_multiple_escala, var_unidmaymen, var_script_case_init, do_ajax_form_productos_mini_mob_event_multiple_escala_onclick_cb);
  } // do_ajax_form_productos_mini_mob_event_multiple_escala_onclick

  function do_ajax_form_productos_mini_mob_event_multiple_escala_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "multiple_escala";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_multiple_escala_onclick_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_multiple_escala_onclick_cb
  function do_ajax_form_productos_mini_mob_event_multiple_escala_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_multiple_escala_onclick_cb_after_alert

  // ---------- Event onchange otro
  function do_ajax_form_productos_mini_mob_event_otro_onchange()
  {
    var var_otro = scAjaxGetFieldSelect("otro");
    var var_otro2 = scAjaxGetFieldText("otro2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_otro_onchange(var_otro, var_otro2, var_script_case_init, do_ajax_form_productos_mini_mob_event_otro_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_otro_onchange

  function do_ajax_form_productos_mini_mob_event_otro_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "otro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_otro_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_otro_onchange_cb
  function do_ajax_form_productos_mini_mob_event_otro_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_otro_onchange_cb_after_alert

  // ---------- Event onchange por_preciominimo
  function do_ajax_form_productos_mini_mob_event_por_preciominimo_onchange()
  {
    var var_recmayamen = scAjaxGetFieldText("recmayamen");
    var var_idiva = scAjaxGetFieldSelect("idiva");
    var var_unidmaymen = scAjaxGetFieldRadio("unidmaymen");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_por_preciominimo_onchange(var_recmayamen, var_idiva, var_unidmaymen, var_costomen, var_script_case_init, do_ajax_form_productos_mini_mob_event_por_preciominimo_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_por_preciominimo_onchange

  function do_ajax_form_productos_mini_mob_event_por_preciominimo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_por_preciominimo_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_por_preciominimo_onchange_cb
  function do_ajax_form_productos_mini_mob_event_por_preciominimo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_por_preciominimo_onchange_cb_after_alert

  // ---------- Event onchange recmayamen
  function do_ajax_form_productos_mini_mob_event_recmayamen_onchange()
  {
    var var_recmayamen = scAjaxGetFieldText("recmayamen");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_recmayamen_onchange(var_recmayamen, var_script_case_init, do_ajax_form_productos_mini_mob_event_recmayamen_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_recmayamen_onchange

  function do_ajax_form_productos_mini_mob_event_recmayamen_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "recmayamen";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_recmayamen_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_recmayamen_onchange_cb
  function do_ajax_form_productos_mini_mob_event_recmayamen_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_recmayamen_onchange_cb_after_alert

  // ---------- Event onchange sabores
  function do_ajax_form_productos_mini_mob_event_sabores_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_sabores_onchange(var_script_case_init, do_ajax_form_productos_mini_mob_event_sabores_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_sabores_onchange

  function do_ajax_form_productos_mini_mob_event_sabores_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sabores";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_sabores_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_sabores_onchange_cb
  function do_ajax_form_productos_mini_mob_event_sabores_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_sabores_onchange_cb_after_alert

  // ---------- Event onchange serial_codbarras
  function do_ajax_form_productos_mini_mob_event_serial_codbarras_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_serial_codbarras_onchange(var_script_case_init, do_ajax_form_productos_mini_mob_event_serial_codbarras_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_serial_codbarras_onchange

  function do_ajax_form_productos_mini_mob_event_serial_codbarras_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_serial_codbarras_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_serial_codbarras_onchange_cb
  function do_ajax_form_productos_mini_mob_event_serial_codbarras_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_serial_codbarras_onchange_cb_after_alert

  // ---------- Event onchange tallas
  function do_ajax_form_productos_mini_mob_event_tallas_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_tallas_onchange(var_script_case_init, do_ajax_form_productos_mini_mob_event_tallas_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_tallas_onchange

  function do_ajax_form_productos_mini_mob_event_tallas_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tallas";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_tallas_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_tallas_onchange_cb
  function do_ajax_form_productos_mini_mob_event_tallas_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_tallas_onchange_cb_after_alert

  // ---------- Event onchange unidad_
  function do_ajax_form_productos_mini_mob_event_unidad__onchange()
  {
    var var_unimen = scAjaxGetFieldText("unimen");
    var var_unidad_ = scAjaxGetFieldText("id_ac_unidad_");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_unidad__onchange(var_unimen, var_unidad_, var_script_case_init, do_ajax_form_productos_mini_mob_event_unidad__onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_unidad__onchange

  function do_ajax_form_productos_mini_mob_event_unidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "unidad_";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_unidad__onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_unidad__onchange_cb
  function do_ajax_form_productos_mini_mob_event_unidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_unidad__onchange_cb_after_alert

  // ---------- Event onchange unidad_ma
  function do_ajax_form_productos_mini_mob_event_unidad_ma_onchange()
  {
    var var_unimay = scAjaxGetFieldText("unimay");
    var var_unidad_ma = scAjaxGetFieldText("id_ac_unidad_ma");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_unidad_ma_onchange(var_unimay, var_unidad_ma, var_script_case_init, do_ajax_form_productos_mini_mob_event_unidad_ma_onchange_cb);
  } // do_ajax_form_productos_mini_mob_event_unidad_ma_onchange

  function do_ajax_form_productos_mini_mob_event_unidad_ma_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "unidad_ma";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_unidad_ma_onchange_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_unidad_ma_onchange_cb
  function do_ajax_form_productos_mini_mob_event_unidad_ma_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_unidad_ma_onchange_cb_after_alert

  // ---------- Event onclick unidmaymen
  function do_ajax_form_productos_mini_mob_event_unidmaymen_onclick()
  {
    var var_unidmaymen = scAjaxGetFieldRadio("unidmaymen");
    var var_recmayamen = scAjaxGetFieldText("recmayamen");
    var var_multiple_escala = scAjaxGetFieldRadio("multiple_escala");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_mini_mob_event_unidmaymen_onclick(var_unidmaymen, var_recmayamen, var_multiple_escala, var_en_base_a, var_unidad_ma, var_preciofull, var_precio2, var_preciomay, var_script_case_init, do_ajax_form_productos_mini_mob_event_unidmaymen_onclick_cb);
  } // do_ajax_form_productos_mini_mob_event_unidmaymen_onclick

  function do_ajax_form_productos_mini_mob_event_unidmaymen_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "unidmaymen";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_mini_mob_event_unidmaymen_onclick_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_event_unidmaymen_onclick_cb
  function do_ajax_form_productos_mini_mob_event_unidmaymen_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_productos_mini_mob_event_unidmaymen_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_productos_mini_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_productos_mini_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_codigobar = scAjaxGetFieldText("codigobar");
    ...
    scAjaxProcOn();
    x_ajax_form_productos_mini_mob_submit_form(var_codigobar, var_codigoprod, var_nompro, var_idgrup, var_idpro1, var_tipo_producto, var_idpro2, var_otro, var_otro2, var_precio_editable, var_maneja_tcs_lfs, var_stockmen, var_unidmaymen, var_unimay, var_unimen, var_unidad_ma, var_unidad_, var_multiple_escala, var_en_base_a, var_costomen, var_costo_prom, var_recmayamen, var_idiva, var_existencia, var_u_menor, var_activo, var_preciofull, var_precio2, var_preciomay, var_preciomen, var_preciomen2, var_preciomen3, var_idprod, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_productos_mini_mob_submit_form_cb);
  } // do_ajax_form_productos_mini_mob_submit_form

  function do_ajax_form_productos_mini_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_productos_mini_mob_submit_form_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_submit_form_cb
  function do_ajax_form_productos_mini_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_productos_mini_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_productos_mini_mob_navigate_form()
  {
    perform_ajax_form_productos_mini_mob_navigate_form();
  }

  function perform_ajax_form_productos_mini_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_productos_mini_mob_navigate_form(var_idprod, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_mini_mob_navigate_form_cb);
  } // do_ajax_form_productos_mini_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_mini_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_productos_mini_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_productos_mini_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_productos_mini_mob_navigate_form_cb
  function do_ajax_form_productos_mini_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_productos_mini_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_productos_mini_mob_navigate_form_cb_after_alert
  function sc_hide_form_productos_mini_mob_form()
  {
  ...
  function do_ajax_form_productos_mini_mob_lkpedt_refresh_idpro1()
  {
    var var_idpro1 = scAjaxGetFieldText("idpro1");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "idpro1";
    x_ajax_form_productos_mini_mob_lkpedt_refresh_idpro1(var_idpro1, nmgp_refresh_fields, var_script_case_init, do_ajax_form_productos_mini_mob_lkpedt_refresh_idpro1_cb);
  } // do_ajax_form_productos_mini_mob_lkpedt_refresh_idpro1

  function do_ajax_form_productos_mini_mob_lkpedt_refresh_idpro1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_productos_mini_mob_lkpedt_refresh_idpro1_cb

  function do_ajax_form_productos_mini_mob_lkpedt_refresh_id_marca()
  {
    var var_id_marca = scAjaxGetFieldSelect("id_marca");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_marca";
    x_ajax_form_productos_mini_mob_lkpedt_refresh_id_marca(var_id_marca, nmgp_refresh_fields, var_script_case_init, do_ajax_form_productos_mini_mob_lkpedt_refresh_id_marca_cb);
  } // do_ajax_form_productos_mini_mob_lkpedt_refresh_id_marca

  function do_ajax_form_productos_mini_mob_lkpedt_refresh_id_marca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_productos_mini_mob_lkpedt_refresh_id_marca_cb

  function do_ajax_form_productos_mini_mob_lkpedt_refresh_id_linea()
  {
    var var_id_linea = scAjaxGetFieldSelect("id_linea");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_linea";
    x_ajax_form_productos_mini_mob_lkpedt_refresh_id_linea(var_id_linea, nmgp_refresh_fields, var_script_case_init, do_ajax_form_productos_mini_mob_lkpedt_refresh_id_linea_cb);
  } // do_ajax_form_productos_mini_mob_lkpedt_refresh_id_linea

  function do_ajax_form_productos_mini_mob_lkpedt_refresh_id_linea_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_productos_mini_mob_lkpedt_refresh_id_linea_cb
