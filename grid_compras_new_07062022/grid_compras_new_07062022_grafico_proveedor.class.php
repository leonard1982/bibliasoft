...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['idprov']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['idprov']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['idprov'];
      }
   }
