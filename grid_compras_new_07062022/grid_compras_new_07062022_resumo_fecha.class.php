...
class grid_compras_new_07062022_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_fechacom = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_compras_new_07062022'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_compras_new_07062022'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_07062022']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_07062022']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_07062022']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_compras_new_07062022']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_compras_new_07062022']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['campos_busca'];
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_compras_new_07062022", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_total_geral'] == "OK")
      {
          $this->array_total_fechacom = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['fechacom'];
      }
      else
      {
          $this->array_total_fechacom = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][4];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][5];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['json_use_label'])
       {
          $Lab_fechacom = "fechacom";
       }
       else
       {
       $Lab_fechacom = "Fecha";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['tipo_com']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['tipo_com'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['prefijo_com']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['prefijo_com'] = "Prefijo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['numero_com']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['numero_com'] = "Consecutivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['numfacom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['numfacom'] = "Ref. Compra"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['formapago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['formapago'] = "F.Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['fechacom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['fechacom'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['fechavenc'] = "Vence"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['pagos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['pagos'] = "Abonos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['idprov']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['idprov'] = "Proveedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['asentada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['asentada'] = "Asentada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['detalle']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['detalle'] = "detalle"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['idfaccom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['idfaccom'] = "#"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['subtotal'] = "Subtotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['id_pedidocom']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['id_pedidocom'] = "Pedido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['retencion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['retencion'] = "Retención %"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['reteica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['reteica'] = "Reteica"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['reteiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['reteiva'] = "Reteiva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['cod_cuenta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['cod_cuenta'] = "Cod Cuenta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['a_pagar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['a_pagar'] = "Val a Pagar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['base0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['base0'] = "Base 0%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['base19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['base19'] = "Base 19%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['base5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['base5'] = "Base 5%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['devolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['devolucion'] = "Devolución"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['iva_0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['iva_0'] = "IVA 0%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['iva_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['iva_19'] = "IVA 19%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['iva_5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['iva_5'] = "IVA 5%"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['val_ica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['val_ica'] = "$ ReteICA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['val_ret']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['val_ret'] = "$ Retención"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['val_retiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['val_retiva'] = "$ ReteIVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['tasa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['labels']['tasa'] = "Tasa %"; 
       }
       //-----
       $this->comp_field_nm = array(
           'fechacom' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Valor Retención(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           4 => "$ ReteICA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           5 => "$ ReteIVA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           6 => "Val a Pagar(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['fecha']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['fecha'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['fecha'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['fecha'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['fecha'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['fecha'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['fecha'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['fecha'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['fecha'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['fecha'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "val_ret", 'show' => true),
           4 => array('field' => "val_ica", 'show' => true),
           5 => array('field' => "val_retiva", 'show' => true),
           6 => array('field' => "a_pagar", 'show' => true),
       );
       ...
       //-----
       foreach ($this->array_total_fechacom as $i_fechacom => $d_fechacom) {
           if (!in_array($i_fechacom, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_fechacom[7] ] = $d_fechacom[6];
               $this->comp_label[0][ $d_fechacom[7] ] = $d_fechacom[6];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'fechacom', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_fechacom => $l_fechacom) {
           if (isset($this->array_total_fechacom[$i_fechacom])) {
               $this->comp_group[$i_fechacom] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_fechacom;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_compras_new_07062022@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['proc_pdf_vert'])
   {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_fechacom)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Valor Retención(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechacom',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechacom)),
               'label_y'  => $this->getChartText(strip_tags("Valor Retención(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(2),
           ),
           '0|3' => array(
               'title'    => $this->getChartText(strip_tags("$ ReteICA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechacom',
               'field_y'  => $this->comp_sum_nm[4],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechacom)),
               'label_y'  => $this->getChartText(strip_tags("$ ReteICA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(3),
           ),
           '0|4' => array(
               'title'    => $this->getChartText(strip_tags("$ ReteIVA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechacom',
               'field_y'  => $this->comp_sum_nm[5],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechacom)),
               'label_y'  => $this->getChartText(strip_tags("$ ReteIVA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(4),
           ),
           '0|5' => array(
               'title'    => $this->getChartText(strip_tags("Val a Pagar(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechacom',
               'field_y'  => $this->comp_sum_nm[6],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechacom)),
               'label_y'  => $this->getChartText(strip_tags("Val a Pagar(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_compras_new_07062022_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_compras_new_07062022_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_compras_new_07062022']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_compras_new_07062022']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_compras_new_07062022']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_compras_new_07062022']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_compras_new_07062022_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_compras_new_07062022_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_fechacom = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['fechacom'];
      krsort($this->array_total_fechacom);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>DOCUMENTOS COMPRAS</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_compras_new_07062022_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_compras_new_07062022_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_compras_new_07062022_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_compras_new_07062022/grid_compras_new_07062022_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_compras_new_07062022_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_compras_new_07062022_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_compras_new_07062022_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['num_css'] . '.css');
...
$nm_saida->saida("      url: \"grid_compras_new_07062022_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_compras_new_07062022/grid_compras_new_07062022_config_graf_flash.php?nome_apl=grid_compras_new_07062022&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_compras_new_07062022/grid_compras_new_07062022_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_compras_new_07062022/grid_compras_new_07062022_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_compras_new_07062022_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_compras_new_07062022_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_compras_new_07062022']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_compras_new_07062022']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_compras_new_07062022_config_pivot.php?nome_apl=grid_compras_new_07062022&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_compras_new_07062022_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_compras_new_07062022/grid_compras_new_07062022_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_compras_new_07062022_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_compras_new_07062022_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_compras_new_07062022_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['grid_compras_new_07062022_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_compras_new_07062022@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_compras_new_07062022_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_compras_new_07062022/grid_compras_new_07062022_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_compras_new_07062022_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_compras_new_07062022_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fechacom = $Busca_temp['fechacom']; 
          $tmp_pos = strpos($fechacom, "##@@");
          if ($tmp_pos !== false && !is_array($fechacom))
          {
              $fechacom = substr($fechacom, 0, $tmp_pos);
          }
          $fechacom_2 = $Busca_temp['fechacom_input_2']; 
          $numfacom = $Busca_temp['numfacom']; 
          $tmp_pos = strpos($numfacom, "##@@");
          if ($tmp_pos !== false && !is_array($numfacom))
          {
              $numfacom = substr($numfacom, 0, $tmp_pos);
          }
          $idprov = $Busca_temp['idprov']; 
          $tmp_pos = strpos($idprov, "##@@");
          if ($tmp_pos !== false && !is_array($idprov))
          {
              $idprov = substr($idprov, 0, $tmp_pos);
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['cond_pesq'], 0, $trab_pos);
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("          DOCUMENTOS COMPRAS\r\n");
      $nm_saida->saida("        </TD>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva, $quebra_fechacom, $quebra_fechacom_orig)
   {
      //----- " . $this->Ini->Nm_lang['lang_othr_cons_title_YYYYMMDD2'] . "
      if (!isset($this->array_total_fechacom[$quebra_fechacom_orig]))
      {
         $this->array_total_fechacom[$quebra_fechacom_orig][0] = 1;
         $this->array_total_fechacom[$quebra_fechacom_orig][1] = $sum_a_pagar;
         $this->array_total_fechacom[$quebra_fechacom_orig][2] = $sum_val_ica;
         $this->array_total_fechacom[$quebra_fechacom_orig][3] = $sum_val_ret;
         $this->array_total_fechacom[$quebra_fechacom_orig][4] = $sum_val_retiva;
         $this->array_total_fechacom[$quebra_fechacom_orig][5] = 1;
         $this->array_total_fechacom[$quebra_fechacom_orig][6] = $quebra_fechacom;
         $this->array_total_fechacom[$quebra_fechacom_orig][7] = $quebra_fechacom_orig;
      }
      else
      {
         $this->array_total_fechacom[$quebra_fechacom_orig][0]++;
         $this->array_total_fechacom[$quebra_fechacom_orig][1] += $sum_a_pagar;
         $this->array_total_fechacom[$quebra_fechacom_orig][2] += $sum_val_ica;
         $this->array_total_fechacom[$quebra_fechacom_orig][3] += $sum_val_ret;
         $this->array_total_fechacom[$quebra_fechacom_orig][4] += $sum_val_retiva;
         $this->array_total_fechacom[$quebra_fechacom_orig][5]++;
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         $this->array_total_geral[0] = 1;
         $this->array_total_geral[1] = $sum_a_pagar;
         $this->array_total_geral[2] = $sum_val_ica;
         $this->array_total_geral[3] = $sum_val_ret;
         $this->array_total_geral[4] = $sum_val_retiva;
         $this->array_total_geral[5] = 1;
      }
      else
      {
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['fechacom'] as $campo_fechacom => $dados_fechacom)
      {
         $this->array_total_fechacom[$campo_fechacom][5] = $dados_fechacom[1];
         $this->array_total_fechacom[$campo_fechacom][3] = $dados_fechacom[2];
         $this->array_total_fechacom[$campo_fechacom][2] = $dados_fechacom[3];
         $this->array_total_fechacom[$campo_fechacom][4] = $dados_fechacom[4];
         $this->array_total_fechacom[$campo_fechacom][1] = $dados_fechacom[5];
      }
   }
   //---- 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT tipo_com, prefijo_com, numero_com, numfacom, formapago, str_replace (convert(char(10),fechacom,102), '.', '-') + ' ' + convert(char(8),fechacom,20), str_replace (convert(char(10),fechavenc,102), '.', '-') + ' ' + convert(char(8),fechavenc,20), pagada, idprov, if(tipo_com='NC',total*-1,total) as total, asentada, idfaccom, if(tipo_com='NC',subtotal*-1,subtotal) as subtotal, if(tipo_com='NC',valoriva*-1,valoriva) as valoriva, observaciones, saldo, id_pedidocom, retencion, reteica, reteiva, cod_cuenta from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT tipo_com, prefijo_com, numero_com, numfacom, formapago, fechacom, fechavenc, pagada, idprov, if(tipo_com='NC',total*-1,total) as total, asentada, idfaccom, if(tipo_com='NC',subtotal*-1,subtotal) as subtotal, if(tipo_com='NC',valoriva*-1,valoriva) as valoriva, observaciones, saldo, id_pedidocom, retencion, reteica, reteiva, cod_cuenta from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT tipo_com, prefijo_com, numero_com, numfacom, formapago, convert(char(23),fechacom,121), convert(char(23),fechavenc,121), pagada, idprov, if(tipo_com='NC',total*-1,total) as total, asentada, idfaccom, if(tipo_com='NC',subtotal*-1,subtotal) as subtotal, if(tipo_com='NC',valoriva*-1,valoriva) as valoriva, observaciones, saldo, id_pedidocom, retencion, reteica, reteiva, cod_cuenta from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT tipo_com, prefijo_com, numero_com, numfacom, formapago, fechacom, fechavenc, pagada, idprov, if(tipo_com='NC',total*-1,total) as total, asentada, idfaccom, if(tipo_com='NC',subtotal*-1,subtotal) as subtotal, if(tipo_com='NC',valoriva*-1,valoriva) as valoriva, observaciones, saldo, id_pedidocom, retencion, reteica, reteiva, cod_cuenta from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'fechacom');
     $campos_order = $this->Ini->Get_date_order_groupby("fechacom", 'desc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->tipo_com = $rs_res->fields[0] ;  
            $this->prefijo_com = $rs_res->fields[1] ;  
            $this->numero_com = $rs_res->fields[2] ;  
            $this->numfacom = $rs_res->fields[3] ;  
            $this->formapago = $rs_res->fields[4] ;  
            $this->fechacom = $rs_res->fields[5] ;  
            $this->fechavenc = $rs_res->fields[6] ;  
            $this->pagada = $rs_res->fields[7] ;  
            $this->idprov = $rs_res->fields[8] ;  
            $this->total = $rs_res->fields[9] ;  
            $this->total =  str_replace(",", ".", $this->total);
            $this->asentada = $rs_res->fields[10] ;  
            $this->idfaccom = $rs_res->fields[11] ;  
            ...
            $this->id_pedidocom = $rs_res->fields[16] ;  
            $this->retencion = $rs_res->fields[17] ;  
...
$_SESSION['scriptcase']['grid_compras_new_07062022']['contr_erro'] = 'off'; 
            ...
            $this->fechacom_orig = $this->Ini->Get_arg_groupby($TP_Time . $this->fechacom, $Format_tst);
            $this->fechacom = $this->Ini->GB_date_format($TP_Time . $this->fechacom, $Format_tst, $Prefix_dat);
            $this->idprov = $this->look_idprov ;
            $this->asentada = $this->look_asentada ;
            nmgp_Form_Num_Val($this->asentada, "", "", "0", "", "", "", "N:", "") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->a_pagar, $this->val_ica, $this->val_ret, $this->val_retiva, $this->fechacom, $this->fechacom_orig);
            }
   }
//
   ...
   function totaliza_php_fecha()
   {
      ...
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_total_geral'] == "OK")
      {
          return;
      }
      //----- 
      ...
      { 
         $nmgp_select = "SELECT tipo_com, prefijo_com, numero_com, numfacom, formapago, EXTEND(fechacom, YEAR TO DAY), EXTEND(fechavenc, YEAR TO DAY), pagada, idprov, if(tipo_com='NC',total*-1,total) as total, asentada, idfaccom, if(tipo_com='NC',subtotal*-1,subtotal) as subtotal, if(tipo_com='NC',valoriva*-1,valoriva) as valoriva, observaciones, saldo, id_pedidocom, retencion, reteica, reteiva, cod_cuenta from " . $this->Ini->nm_tabela; 
      } 
      else 
      { 
         $nmgp_select = "SELECT tipo_com, prefijo_com, numero_com, numfacom, formapago, fechacom, fechavenc, pagada, idprov, if(tipo_com='NC',total*-1,total) as total, asentada, idfaccom, if(tipo_com='NC',subtotal*-1,subtotal) as subtotal, if(tipo_com='NC',valoriva*-1,valoriva) as valoriva, observaciones, saldo, id_pedidocom, retencion, reteica, reteiva, cod_cuenta from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['ordem_grid']) 
        {
   ...
   $campos_order = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['ordem_desc']; 
   } 
   ...
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['order_grid'] = $nmgp_order_by;
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
...
$_SESSION['scriptcase']['grid_compras_new_07062022']['contr_erro'] = 'off';
     ...
     $this->fechacom = $this->Ini->GB_date_format($TP_Time . $fechacom_SV, $Format_tst, $Prefix_dat); 
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->a_pagar)), NM_encode_input(sc_strip_script($this->val_ica)), NM_encode_input(sc_strip_script($this->val_ret)), NM_encode_input(sc_strip_script($this->val_retiva)), NM_encode_input(sc_strip_script($this->fechacom)), NM_encode_input(sc_strip_script($fechacom_orig)));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][4] = $this->array_total_geral[3];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][5] = $this->array_total_geral[4];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][0] = "Total compras";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][1] = $this->array_total_geral[0];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['SC_Ind_Groupby'] == "fecha")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['fechacom'] = $this->array_total_fechacom;
      }
   }
