<?php
@session_start() ;
$_SESSION['scriptcase']['grid_compras_new_07062022']['sc_process_barr'] = true;
require_once('../grid_compras_new_07062022/index.php');
unset($_SESSION['scriptcase']['grid_compras_new_07062022']['sc_process_barr']);
$ExportCtrl = new grid_compras_new_07062022_export_control;
$ExportCtrl->Export_barr();

class grid_compras_new_07062022_export_control
{
