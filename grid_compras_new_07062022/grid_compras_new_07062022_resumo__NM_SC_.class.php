...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva)
   {
      //----- Total
...
$_SESSION['scriptcase']['grid_compras_new_07062022']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][6] = $this->array_total_geral[5];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][7] = $this->array_total_geral[6];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['tot_geral'][8] = $this->array_total_geral[7];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_array_resumo'] = "OK";
