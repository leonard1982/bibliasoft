...
class grid_compras_new_07062022_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_prefijo_com = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['prefijo_com'];
      }
      else
      {
          $this->array_total_prefijo_com = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['prefijo_com'] = $this->array_total_prefijo_com;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['prefijo_com']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['prefijo_com'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['prefijo_com'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['prefijo_com'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['prefijo_com'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['prefijo_com'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['prefijo_com'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['prefijo_com'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['prefijo_com'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['prefijo_com'] as $i_sum => $d_sum)
           {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total'][$cmp_gb];
      }
