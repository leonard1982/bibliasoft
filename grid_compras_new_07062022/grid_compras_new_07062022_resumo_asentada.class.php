...
class grid_compras_new_07062022_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['asentada'];
      }
      else
      {
          $this->array_total_asentada = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['asentada']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['asentada'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_order']['asentada'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['asentada'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['asentada'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['asentada'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['asentada'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['asentada'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['asentada'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['summarizing_fields_display']['asentada'] as $i_sum => $d_sum)
           {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva, $quebra_asentada, $quebra_asentada_orig)
   {
      //----- Asentada
      if (!isset($this->array_total_asentada[$quebra_asentada_orig]))
      {
         $this->array_total_asentada[$quebra_asentada_orig][0] = 1;
         $this->array_total_asentada[$quebra_asentada_orig][1] = $sum_a_pagar;
         $this->array_total_asentada[$quebra_asentada_orig][2] = $sum_val_ica;
         $this->array_total_asentada[$quebra_asentada_orig][3] = $sum_val_ret;
         $this->array_total_asentada[$quebra_asentada_orig][4] = $sum_val_retiva;
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['asentada'] as $campo_asentada => $dados_asentada)
      {
         $this->array_total_asentada[$campo_asentada][5] = $dados_asentada[1];
         $this->array_total_asentada[$campo_asentada][3] = $dados_asentada[2];
         $this->array_total_asentada[$campo_asentada][2] = $dados_asentada[3];
         $this->array_total_asentada[$campo_asentada][4] = $dados_asentada[4];
         $this->array_total_asentada[$campo_asentada][1] = $dados_asentada[5];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_compras_new_07062022']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->a_pagar, $this->val_ica, $this->val_ret, $this->val_retiva, $this->asentada, $this->asentada_orig);
            }
   }
//
...
$_SESSION['scriptcase']['grid_compras_new_07062022']['contr_erro'] = 'off';
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->a_pagar)), NM_encode_input(sc_strip_script($this->val_ica)), NM_encode_input(sc_strip_script($this->val_ret)), NM_encode_input(sc_strip_script($this->val_retiva)), NM_encode_input(sc_strip_script($this->GB_asentada)), NM_encode_input(sc_strip_script($asentada_orig)));
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['arr_total']['asentada'] = $this->array_total_asentada;
      }
   }
