...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Tipo";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['tipo_com']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['tipo_com']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['tipo_com'];
      }
   }
