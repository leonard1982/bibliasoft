...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Pagada";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['pagada']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['pagada']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_07062022']['contr_label_graf']['pagada'];
      }
   }
