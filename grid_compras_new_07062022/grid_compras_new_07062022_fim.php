...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_compras_new_07062022"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_compras_new_07062022"]);
   }
