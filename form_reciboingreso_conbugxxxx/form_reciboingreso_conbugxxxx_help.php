<?php
include_once('form_reciboingreso_conbugxxxx_session.php');
@session_start() ;
class form_reciboingreso_conbugxxxx_help
{
...
<?php echo "<b>A Cobrar</b><br>" . nl2br("Si el cobro es solo un abono a la factura, se recomienda dejar las tasas de retenciones que trae de la factura, pero colocar los valores (Valor retención, valor retenido ICA, Valor rete IVA y Descuento) en 0."); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_reciboingreso_conbugxxxx_help();
?>
