...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_importar_tipoiva_TNS"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_importar_tipoiva_TNS"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_importar_tipoiva_TNS']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_importar_tipoiva_TNS']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_importar_tipoiva_TNS']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_importar_tipoiva_TNS']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_importar_tipoiva_TNS']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_importar_tipoiva_TNS</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_importar_tipoiva_TNS']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_importar_tipoiva_TNS']['embutida_filho'] as $ind => $sc_init)
          {
