<?php
class pdfreport_facturaven_rosell_301018_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_facturaven_rosell_301018']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_facturaven_rosell_301018", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['campos_busca']))
   { 
       $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['campos_busca'];
   ...
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq_filtro'];
   $_SESSION['scriptcase']['pdfreport_facturaven_rosell_301018']['contr_erro'] = 'on';
...
$_SESSION['pdfreport_facturaven_rosell_301018']['empresa_nombre']=$this->sc_temp_empresa;
$_SESSION['pdfreport_facturaven_rosell_301018']['nit']=$this->sc_temp_nit;
$_SESSION['pdfreport_facturaven_rosell_301018']['direccion1']=$this->sc_temp_direccion;
$_SESSION['pdfreport_facturaven_rosell_301018']['telefono1']=$this->sc_temp_tele;
...
$_SESSION['scriptcase']['pdfreport_facturaven_rosell_301018']['contr_erro'] = 'off'; 
   $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
   $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
   $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
   $_SESSION['scriptcase']['contr_link_emb'] = $this->nm_location;
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_facturaven_rosell_301018']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_facturaven_rosell_301018']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_facturaven_rosell_301018']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_facturaven_rosell_301018']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['prim_cons'] || !empty($nmgp_parms))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['prim_cons'] = false;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_orig'] = "";  
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_orig'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['cond_pesq']         = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq_filtro'] = "";
   }   
   if  (!empty($this->nm_where_dinamico)) 
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq'];  
//----- 
   ...
   $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq']; 
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['order_grid'] = $nmgp_order_by;
...
// 
 function Pdf_image()
 {
   ...
   $this->Pdf->Image($this->NM_raiz_img . $this->Ini->path_img_global . "/usr__NM__bg__NM__Factura_sinlogo.png", "1", "1", "216", "279", '', '', '', false, 300, '', false, false, 0);
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['idfacven'] = "Idfacven";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['numfacven'] = "Numfacven";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['credito'] = "Credito";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['fechaven'] = "Fechaven";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['fechavenc'] = "Fechavenc";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['idcli'] = "Idcli";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['subtotal'] = "Subtotal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['valoriva'] = "Valoriva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['total'] = "Total";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['pagada'] = "Pagada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['asentada'] = "Asentada";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['observaciones'] = "Observaciones";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['saldo'] = "Saldo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['adicional'] = "Adicional";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['adicional2'] = "Adicional 2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['adicional3'] = "Adicional 3";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['resolucion'] = "Resolucion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['dircliente'] = "Dircliente";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['logo'] = "Logo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['colores'] = "colores";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['colores_iddet'] = "Iddet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['colores_iddet2'] = "Iddet 2";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa'] = "detalleventa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_cantidad'] = "Cantidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_fl_adicional'] = "Adicional";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_fl_factor'] = "Factor";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_fl_iva'] = "Iva";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_fl_unidadmayor'] = "Unidadmayor";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_idpro'] = "Idpro";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_p_codigobar'] = "Codigobar";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_p_nompro'] = "Nompro";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_parcial'] = "Parcial";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_unidad'] = "Unidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['detalleventa_valorunita'] = "Valorunita";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['digito'] = "digito";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['direccion'] = "direccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['documento'] = "documento";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['empresa'] = "empresa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['etiqueta'] = "etiqueta";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['fechares'] = "fechares";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['ladireccion'] = "ladireccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['municipio'] = "municipio";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['nomsucursal'] = "nomsucursal";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['numnit'] = "numnit";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['numtele'] = "numtele";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['prefijo'] = "prefijo";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['rangofac'] = "rangofac";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['tallas'] = "tallas";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['tallas_iddet'] = "Iddet";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['telefono'] = "telefono";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['labels']['npagina'] = "npagina";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_facturaven_rosell_301018']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_facturaven_rosell_301018']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_facturaven_rosell_301018']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_facturaven_rosell_301018']['qt_col_grid']) 
      {  
...
$_SESSION['scriptcase']['pdfreport_facturaven_rosell_301018']['contr_erro'] = 'off';
          ...
          foreach ($this->tallas_iddet[$this->nm_grid_colunas] as $NM_ind => $Dados) 
          {
            ...
            $cell_email = array('posx' => 125, 'posy' => 35, 'data' => $this->SC_conv_utf8('e-mail: rossellsbsas@gmail.com'), 'width'      => 0, 'align'      => 'C', 'font_type'  => 'Helvetica', 'font_size'  => 10, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            ...
            $cell_ladireccion = array('posx' => 120, 'posy' => 25, 'data' => $this->SC_conv_utf8('' . $_SESSION['direccion'] . ''), 'width'      => 90, 'align'      => 'C', 'font_type'  => 'Helvetica', 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => B);
            $cell_resolucion = array('posx' => 10, 'posy' => 45, 'data' => $this->resolucion[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_rangofac = array('posx' => 60, 'posy' => 45, 'data' => $this->rangofac[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_fechares = array('posx' => 140, 'posy' => 45, 'data' => $this->fechares[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Courier', 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_ctas_banco = array('posx' => 20, 'posy' => 230, 'data' => $this->SC_conv_utf8('CUENTAS DISPONIBLES PARA CONSIGNAR A ROSSELL SHOES & BAGS S.A.S'), 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Helvetica', 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_davivienda = array('posx' => 20, 'posy' => 234, 'data' => $this->SC_conv_utf8('CTA. CORRIENTE DAVIVIENDA 0676-6999-0706 ROSSELL NIT.9011444579'), 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Helvetica', 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_bancolombia = array('posx' => 20, 'posy' => 238, 'data' => $this->SC_conv_utf8('CTA. CORRIENTE BANCOLOMBIA 820-8832-6049 ROSSELL NIT.901144457'), 'width'      => 0, 'align'      => 'L', 'font_type'  => 'Helvetica', 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_cucuta = array('posx' => 125, 'posy' => 39, 'data' => $this->SC_conv_utf8('Cúcuta -Col.'), 'width'      => 0, 'align'      => 'C', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_nota = array('posx' => 20, 'posy' => 241, 'data' => $this->SC_conv_utf8('Por favor reportar el pago una vez sea realizado, de no hacerlo no se tendrá en cuenta'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_info = array('posx' => 120, 'posy' => 270, 'data' => $this->SC_conv_utf8('- Facturado con Facilweb-'), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
...
$cell_fecha_impresion = array('posx' => 10, 'posy' => 270, 'data' => 'Fecha de impresión: '.date("d-m-Y H:i:s"), 'width'      => 100, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 9, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $this->Pdf->SetFont($cell_info['font_type'], $cell_info['font_style'], $cell_info['font_size']);
            $this->pdf_text_color($cell_info['data'], $cell_info['color_r'], $cell_info['color_g'], $cell_info['color_b']);
            if (!empty($cell_info['posx']) && !empty($cell_info['posy']))
            {
                $this->Pdf->SetXY($cell_info['posx'], $cell_info['posy']);
            }
            elseif (!empty($cell_info['posx']))
            {
                $this->Pdf->SetX($cell_info['posx']);
            }
            elseif (!empty($cell_info['posy']))
            {
                $this->Pdf->SetY($cell_info['posy']);
            }
            $this->Pdf->Cell($cell_info['width'], 0, $cell_info['data'], 0, 0, $cell_info['align']);
            ...
            $this->Pdf->Cell($cell_fecha_impresion['width'], 0, $cell_fecha_impresion['data'], 0, 0, $cell_fecha_impresion['align']);
            			...
            			$this->Pdf->SetY(84);
						$this->Pdf->Image("../_lib/img/usr__NM__bg__NM__Factura_sinlogo.png", 0, 0, 216, 279, '', '', '', false, 300, '', false, false, 0);
						$this->sc_temp_gcontadorfactura=1;
				}
