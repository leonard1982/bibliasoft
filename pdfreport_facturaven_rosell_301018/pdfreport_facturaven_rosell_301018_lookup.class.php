<?php
class pdfreport_facturaven_rosell_301018_lookup
{
//  
...
//  
   function lookup_detalleventa(&$conteudo , $gconsolidaritems, &$nm_array_retorno_lookup) 
   {
      $nm_array_retorno_lookup = array();
      $conteudo = "";
      $nm_comando = "" . $_SESSION['gconsolidaritems'] . "" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
      { 
