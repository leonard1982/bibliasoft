<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_facturaven_rosell_301018']['sc_process_barr'] = true;
require_once('../pdfreport_facturaven_rosell_301018/index.php');
unset($_SESSION['scriptcase']['pdfreport_facturaven_rosell_301018']['sc_process_barr']);
$ExportCtrl = new pdfreport_facturaven_rosell_301018_export_control;
$ExportCtrl->Export_barr();

class pdfreport_facturaven_rosell_301018_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['pdfreport_facturaven_rosell_301018']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['pdfreport_facturaven_rosell_301018']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_chart_titl'] ?> - facturaven</TITLE>
