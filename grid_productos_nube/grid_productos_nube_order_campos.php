...
<?php
   ...
   $Ord_Cmp = new grid_productos_nube_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_productos_nube_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigobar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["codigobar"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["codigobar"] : "Código";
   $tab_ger_campos['nompro'] = "on";
   $tab_def_campos['nompro'] = "nompro";
   $tab_labels["nompro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["nompro"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["nompro"] : "Descripción";
   $tab_ger_campos['idgrup'] = "on";
   $tab_def_campos['idgrup'] = "idgrup";
   $tab_labels["idgrup"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["idgrup"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["idgrup"] : "Grupo/Familia";
   $tab_ger_campos['preciomen'] = "on";
   $tab_def_campos['preciomen'] = "preciomen";
   $tab_labels["preciomen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciomen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciomen"] : "Precio1";
   $tab_ger_campos['preciomen2'] = "on";
   $tab_def_campos['preciomen2'] = "preciomen2";
   $tab_labels["preciomen2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciomen2"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciomen2"] : "Precio2";
   $tab_ger_campos['preciomen3'] = "on";
   $tab_def_campos['preciomen3'] = "preciomen3";
   $tab_labels["preciomen3"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciomen3"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciomen3"] : "Precio3";
   $tab_ger_campos['unimen'] = "on";
   $tab_def_campos['unimen'] = "unimen";
   $tab_labels["unimen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["unimen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["unimen"] : "U/Menor";
   $tab_ger_campos['existencia_menor'] = "on";
   $tab_def_campos['existencia_menor'] = "existencia_menor";
   $tab_labels["existencia_menor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["existencia_menor"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["existencia_menor"] : "Existencia";
   $tab_ger_campos['preciofull'] = "on";
   $tab_def_campos['preciofull'] = "preciofull";
   $tab_labels["preciofull"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciofull"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciofull"] : "Precio M1";
   $tab_ger_campos['precio2'] = "on";
   $tab_def_campos['precio2'] = "precio2";
   $tab_labels["precio2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["precio2"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["precio2"] : "Precio M2";
   $tab_ger_campos['preciomay'] = "on";
   $tab_def_campos['preciomay'] = "preciomay";
   $tab_labels["preciomay"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciomay"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["preciomay"] : "Precio M3";
   $tab_ger_campos['unimay'] = "on";
   $tab_def_campos['unimay'] = "unimay";
   $tab_labels["unimay"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["unimay"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["unimay"] : "U/Mayor";
   $tab_ger_campos['stockmen'] = "on";
   $tab_def_campos['stockmen'] = "stockmen";
   $tab_labels["stockmen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["stockmen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['labels']["stockmen"] : "Existencia";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_productos_nube_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_productos_nube']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
