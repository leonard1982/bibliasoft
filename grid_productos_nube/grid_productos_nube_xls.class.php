...
class grid_productos_nube_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_productos_nube/grid_productos_nube_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_productos_nube_res_xls.class.php");
              $this->Res_xls = new grid_productos_nube_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_productos_nube.zip";
          $this->Arquivo   .= "_grid_productos_nube" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['grid_productos_nube']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_preciomen2()
   {
         ...
         if (is_numeric($this->preciomen2))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->preciomen2);
         $this->Xls_col++;
   }
   //----- preciomen3
   function NM_export_preciomen3()
   {
         ...
         if (is_numeric($this->preciomen3))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->preciomen3);
         $this->Xls_col++;
   }
   //----- unimen
   ...
   function NM_export_existencia_menor()
   {
         ...
         if (is_numeric($this->existencia_menor))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.000';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->existencia_menor);
         $this->Xls_col++;
   }
   //----- preciofull
   function NM_export_preciofull()
   {
         ...
         if (is_numeric($this->preciofull))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->preciofull);
         $this->Xls_col++;
   }
   //----- precio2
   function NM_export_precio2()
   {
         ...
         if (is_numeric($this->precio2))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->precio2);
         $this->Xls_col++;
   }
   //----- preciomay
   ...
   //----- preciomen
   function NM_sub_cons_preciomen()
   {
         $this->preciomen = NM_charset_to_utf8($this->preciomen);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->preciomen;
   ...
   //----- preciomen2
   function NM_sub_cons_preciomen2()
   {
         $this->preciomen2 = NM_charset_to_utf8($this->preciomen2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->preciomen2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- preciomen3
   function NM_sub_cons_preciomen3()
   {
         $this->preciomen3 = NM_charset_to_utf8($this->preciomen3);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->preciomen3;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- existencia_menor
   function NM_sub_cons_existencia_menor()
   {
         $this->existencia_menor = NM_charset_to_utf8($this->existencia_menor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->existencia_menor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- preciofull
   function NM_sub_cons_preciofull()
   {
         $this->preciofull = NM_charset_to_utf8($this->preciofull);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->preciofull;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- precio2
   function NM_sub_cons_precio2()
   {
         $this->precio2 = NM_charset_to_utf8($this->precio2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->precio2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- preciomay
   function NM_sub_cons_preciomay()
   {
         $this->preciomay = NM_charset_to_utf8($this->preciomay);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->preciomay;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- stockmen
   function NM_sub_cons_stockmen()
   {
         $this->stockmen = NM_charset_to_utf8($this->stockmen);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->stockmen;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.000";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_nube']['nolabel'])
       {
