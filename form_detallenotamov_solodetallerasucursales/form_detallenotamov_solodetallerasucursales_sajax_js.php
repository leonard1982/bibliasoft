  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallenotamov_solodetallerasucursales" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallenotamov_solodetallerasucursales_form();
	}
  ...
  // ---------- Validate producto_
  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_producto_(iNumLinha)
  {
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_producto_

  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_producto__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "producto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "producto_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "producto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "producto_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_producto__cb

  // ---------- Validate colores_
  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_colores_(iNumLinha)
  {
    var nomeCampo_colores_ = "colores_" + iNumLinha;
    var var_colores_ = scAjaxGetFieldSelect(nomeCampo_colores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_solodetallerasucursales_validate_colores_(var_colores_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_validate_colores__cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_colores_

  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_tallas_(iNumLinha)
  {
    var nomeCampo_tallas_ = "tallas_" + iNumLinha;
    var var_tallas_ = scAjaxGetFieldSelect(nomeCampo_tallas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_solodetallerasucursales_validate_tallas_(var_tallas_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_validate_tallas__cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_tallas_

  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_sabor_(iNumLinha)
  {
    var nomeCampo_sabor_ = "sabor_" + iNumLinha;
    var var_sabor_ = scAjaxGetFieldSelect(nomeCampo_sabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_solodetallerasucursales_validate_sabor_(var_sabor_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_validate_sabor__cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_sabor_

  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_sabor__cb

  // ---------- Validate destino_
  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_destino_(iNumLinha)
  {
    var nomeCampo_destino_ = "destino_" + iNumLinha;
    var var_destino_ = scAjaxGetFieldText(nomeCampo_destino_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_solodetallerasucursales_validate_destino_(var_destino_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_validate_destino__cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_destino_

  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_destino__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "destino_" + iLineNumber;
    }
    else
    {
      sFieldValid = "destino_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "destino_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "destino_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_destino__cb

  // ---------- Validate presentacion_
  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_presentacion_(iNumLinha)
  {
    var nomeCampo_presentacion_ = "presentacion_" + iNumLinha;
    var var_presentacion_ = scAjaxGetFieldHidden(nomeCampo_presentacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_solodetallerasucursales_validate_presentacion_(var_presentacion_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_validate_presentacion__cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_presentacion_

  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_presentacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_presentacion__cb

  // ---------- Validate cantidad_
  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_solodetallerasucursales_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_validate_cantidad__cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_cantidad_

  function do_ajax_form_detallenotamov_solodetallerasucursales_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_validate_cantidad__cb

  // ---------- Refresh producto_
  function do_ajax_form_detallenotamov_solodetallerasucursales_refresh_producto_(iSeqForm)
  {
    var var_producto_ = scAjaxGetFieldText("producto_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "colores__#fld#_tallas__#fld#_sabor_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_solodetallerasucursales_refresh_producto_(var_producto_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_refresh_producto__cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_refresh_producto_

  function do_ajax_form_detallenotamov_solodetallerasucursales_refresh_producto__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_refresh_producto__cb

  // ---------- Event onchange producto_
  function do_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange(iSeqForm)
  {
    var var_producto_ = scAjaxGetFieldText("id_ac_producto_" + iSeqForm);
    var var_presentacion_ = scAjaxGetFieldHidden("presentacion_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange(var_producto_, var_presentacion_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange_cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange

  function do_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange_cb_after_alert);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange_cb
  function do_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_detallenotamov_solodetallerasucursales_refresh_producto_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_detallenotamov_solodetallerasucursales_event_producto__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallenotamov_solodetallerasucursales_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallenotamov_solodetallerasucursales_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallenotamov_solodetallerasucursales_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_add_new_line_cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_add_new_line

  function do_ajax_form_detallenotamov_solodetallerasucursales_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallenotamov_solodetallerasucursales_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallenotamov_solodetallerasucursales_backup_line(iNumLinha)
  {
    var var_idnota_ = scAjaxGetFieldText("idnota_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotamov_solodetallerasucursales_backup_line(var_idnota_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_backup_line_cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_backup_line

  function do_ajax_form_detallenotamov_solodetallerasucursales_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallenotamov_solodetallerasucursales_backup_line_cb

  function do_ajax_form_detallenotamov_solodetallerasucursales_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallenotamov_solodetallerasucursales_cancel_insert

  function do_ajax_form_detallenotamov_solodetallerasucursales_cancel_update(iSeqVert)
  {
    do_ajax_form_detallenotamov_solodetallerasucursales_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallenotamov_solodetallerasucursales_cancel_update

  function do_ajax_form_detallenotamov_solodetallerasucursales_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallenotamov_solodetallerasucursales_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallenotamov_solodetallerasucursales_table_refresh()
  {
    var var_idnota_ = document.F2.idnota_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallenotamov_solodetallerasucursales_table_refresh(var_idnota_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_table_refresh_cb);
  } //  do_ajax_form_detallenotamov_solodetallerasucursales_table_refresh

  function do_ajax_form_detallenotamov_solodetallerasucursales_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idnota_.value = scAjaxGetKeyValue("idnota_");
    ...
    scAjaxAlert(do_ajax_form_detallenotamov_solodetallerasucursales_table_refresh_cb_after_alert);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_table_refresh_cb
  function do_ajax_form_detallenotamov_solodetallerasucursales_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detallenotamov_solodetallerasucursales_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallenotamov_solodetallerasucursales_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallenotamov_solodetallerasucursales_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_producto_ = scAjaxGetFieldText("producto_" + iNumLinha);
    ...
    var var_destino_ = scAjaxGetFieldText("destino_" + iNumLinha);
...
?>
    x_ajax_form_detallenotamov_solodetallerasucursales_submit_form(var_producto_, var_colores_, var_tallas_, var_sabor_, var_destino_, var_presentacion_, var_cantidad_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detallenotamov_solodetallerasucursales_submit_form_cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_submit_form

  function do_ajax_form_detallenotamov_solodetallerasucursales_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("producto_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("destino_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotamov_solodetallerasucursales_submit_form_cb_after_alert);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_submit_form_cb
  function do_ajax_form_detallenotamov_solodetallerasucursales_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallenotamov_solodetallerasucursales_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallenotamov_solodetallerasucursales_navigate_form()
  {
    perform_ajax_form_detallenotamov_solodetallerasucursales_navigate_form();
  }

  function perform_ajax_form_detallenotamov_solodetallerasucursales_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallenotamov_solodetallerasucursales_navigate_form(var_idnota_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallenotamov_solodetallerasucursales_navigate_form_cb);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallenotamov_solodetallerasucursales']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallenotamov_solodetallerasucursales_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idnota_.value = scAjaxGetKeyValue("idnota_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallenotamov_solodetallerasucursales_navigate_form_cb_after_alert);
  } // do_ajax_form_detallenotamov_solodetallerasucursales_navigate_form_cb
  function do_ajax_form_detallenotamov_solodetallerasucursales_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_detallenotamov_solodetallerasucursales_navigate_form_cb_after_alert
  function sc_hide_form_detallenotamov_solodetallerasucursales_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "producto_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "destino_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "presentacion_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "cantidad_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["producto_" + iNumLinha] = {"label": "Producto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["colores_" + iNumLinha] = {"label": "Colores<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tallas_" + iNumLinha] = {"label": "Tallas<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["destino_" + iNumLinha] = {"label": "Destino<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["presentacion_" + iNumLinha] = {"label": "Presentacion<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["producto_"][iNumLinha] = "producto_" + iNumLinha;
    ...
    ajax_field_mult["destino_"][iNumLinha] = "destino_" + iNumLinha;
    ajax_field_mult["presentacion_"][iNumLinha] = "presentacion_" + iNumLinha;
    ajax_field_mult["cantidad_"][iNumLinha] = "cantidad_" + iNumLinha;
    ajax_field_id["producto_" + iNumLinha] = new Array("hidden_field_label_producto_", "hidden_field_data_producto_" + iNumLinha);
...
?>
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["producto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["producto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["producto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["producto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["producto_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["destino_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["destino_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["destino_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["destino_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["destino_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['producto_'])) ? $this->nmgp_cmp_readonly['producto_'] : 'off';
?>
    scAjaxFieldRead("producto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['destino_'])) ? $this->nmgp_cmp_readonly['destino_'] : 'off';
?>
    scAjaxFieldRead("destino_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["producto_" + iRow] || "on" == ajax_error_count["colores_" + iRow] || "on" == ajax_error_count["tallas_" + iRow] || "on" == ajax_error_count["sabor_" + iRow] || "on" == ajax_error_count["destino_" + iRow] || "on" == ajax_error_count["presentacion_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_producto_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_destino_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["producto_" + iRow] && "off" == ajax_error_count["colores_" + iRow] && "off" == ajax_error_count["tallas_" + iRow] && "off" == ajax_error_count["sabor_" + iRow] && "off" == ajax_error_count["destino_" + iRow] && "off" == ajax_error_count["presentacion_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["producto_" + iRow] = "off";
        ajax_error_count["colores_" + iRow] = "off";
        ajax_error_count["tallas_" + iRow] = "off";
        ajax_error_count["sabor_" + iRow] = "off";
        ajax_error_count["destino_" + iRow] = "off";
      ...
      $("#hidden_field_data_producto_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_destino_" + iRow).removeClass("scFormErrorLine");
