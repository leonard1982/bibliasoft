  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_autorizacion" == sTestField)
        {
...
?>
  ...
  // ---------- Validate usuario
  function do_ajax_autorizacion_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizacion_validate_usuario(var_usuario, var_script_case_init, do_ajax_autorizacion_validate_usuario_cb);
  } // do_ajax_autorizacion_validate_usuario

  function do_ajax_autorizacion_validate_usuario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizacion_validate_usuario_cb

  // ---------- Validate clave
  function do_ajax_autorizacion_validate_clave()
  {
    var nomeCampo_clave = "clave";
    var var_clave = scAjaxGetFieldText(nomeCampo_clave);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizacion_validate_clave(var_clave, var_script_case_init, do_ajax_autorizacion_validate_clave_cb);
  } // do_ajax_autorizacion_validate_clave

  function do_ajax_autorizacion_validate_clave_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "clave";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizacion_validate_clave_cb

  // ---------- Validate cliente
  function do_ajax_autorizacion_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldHidden(nomeCampo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_autorizacion_validate_cliente(var_cliente, var_script_case_init, do_ajax_autorizacion_validate_cliente_cb);
  } // do_ajax_autorizacion_validate_cliente

  function do_ajax_autorizacion_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_autorizacion_validate_cliente_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_autorizacion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_autorizacion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_autorizacion_submit_form(var_usuario, var_clave, var_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_autorizacion_submit_form_cb);
  } // do_ajax_autorizacion_submit_form

  function do_ajax_autorizacion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_autorizacion_submit_form_cb_after_alert);
  } // do_ajax_autorizacion_submit_form_cb
  function do_ajax_autorizacion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_autorizacion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_autorizacion_navigate_form()
  {
    perform_ajax_autorizacion_navigate_form();
  }

  function perform_ajax_autorizacion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['autorizacion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_autorizacion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_autorizacion_navigate_form_cb_after_alert);
  } // do_ajax_autorizacion_navigate_form_cb
  function do_ajax_autorizacion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_autorizacion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_autorizacion_navigate_form_cb_after_alert
  function sc_hide_autorizacion_form()
  {
