...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("Comprobante"); } else { echo strip_tags("Comprobante"); } ?></TITLE>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_comprobantes/form_comprobantes_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_comprobantes_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_comprobantes_jquery.php');
 ...
 function toggleBlock(e) {
  ...
  if (show_block[block_id]) {
    if ("hidden_bloco_2" == block_id) {
      scAjaxDetailHeight("grid_comprobantes_detalle_1", "300");
    }
  }
 }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_comprobantes_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_comprobantes'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_comprobantes'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php if ($this->nmgp_opcao == "novo") { echo "Comprobante"; } else { echo "Comprobante"; } ?></span></td>
            <td id="lin1_col2" class="scFormHeaderFont"><span><?php if ($this->Ini->Export_img_zip) {$this->Ini->Img_export_zip[] = $this->Ini->root . $this->Ini->path_imag_cab . '/scriptcase__NM__ico__NM__book_red_32.png';echo '<IMG SRC="scriptcase__NM__ico__NM__book_red_32.png';}else{ echo '<IMG SRC="' . $this->Ini->path_imag_cab  . '/scriptcase__NM__ico__NM__book_red_32.png';}?>" BORDER="0"/></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-5';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['empty_filter'] = true;
       }
  }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['Lookup_tipo'][] = ''; ?>
 <option value=""></option>
 <option  value="FV" <?php  if ($this->tipo == "FV") { echo " selected" ;} ?>>FV</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['Lookup_tipo'][] = 'FV'; ?>
 <option  value="FC" <?php  if ($this->tipo == "FC") { echo " selected" ;} ?>>FC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['Lookup_tipo'][] = 'FC'; ?>
 <option  value="RC" <?php  if ($this->tipo == "RC") { echo " selected" ;} ?>>RC</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['Lookup_tipo'][] = 'RC'; ?>
 <option  value="CE" <?php  if ($this->tipo == "CE") { echo " selected" ;} ?>>CE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['Lookup_tipo'][] = 'CE'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_prefijo" class="sc-ui-readonly-prefijo css_prefijo_line" style="<?php echo $sStyleReadLab_prefijo; ?>"><?php echo $this->form_format_readonly("prefijo", $this->form_encode_input($this->prefijo)); ?></span><span id="id_read_off_prefijo" class="css_read_off_prefijo<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_prefijo; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=4"; } ?> maxlength=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: 'upper', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['Lookup_asentada'][] = '1'; ?>
 <option  value="0" <?php  if ($this->asentada == "0") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['Lookup_asentada'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php $sStyleHidden_creado_dumb = ('' == $sStyleHidden_creado) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_creado_dumb" style="<?php echo $sStyleHidden_creado_dumb; ?>"></TD>
...
<?php $sStyleHidden_periodo_dumb = ('' == $sStyleHidden_periodo) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_periodo_dumb" style="<?php echo $sStyleHidden_periodo_dumb; ?>"></TD>
...
<?php echo $observaciones; ?>
   ...
   <?php
    ...
    {
        $this->nm_new_label['total_debito'] = "Total Debito";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
   ...
   <?php
    ...
    {
        $this->nm_new_label['total_credito'] = "Total Credito";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php $sStyleHidden_total_debito_dumb = ('' == $sStyleHidden_total_debito) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_total_debito_dumb" style="<?php echo $sStyleHidden_total_debito_dumb; ?>"></TD>
...
<?php
   ...
   $d = $this->d;
   $sStyleHidden_d = '';
   if (isset($this->nmgp_cmp_hidden['d']) && $this->nmgp_cmp_hidden['d'] == 'off')
   {
       unset($this->nmgp_cmp_hidden['d']);
       $sStyleHidden_d = 'display: none;';
   }
   $bTestReadOnly = true;
   $sStyleReadLab_d = 'display: none;';
   $sStyleReadInp_d = '';
   if (/*$this->nmgp_opcao != "novo" && */isset($this->nmgp_cmp_readonly['d']) && $this->nmgp_cmp_readonly['d'] == 'on')
   {
       $bTestReadOnly = false;
       unset($this->nmgp_cmp_readonly['d']);
       $sStyleReadLab_d = '';
       $sStyleReadInp_d = 'display: none;';
   }
?>
<?php if (isset($this->nmgp_cmp_hidden['d']) && $this->nmgp_cmp_hidden['d'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="d" value="<?php echo $this->form_encode_input($d) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOdd css_d_line" id="hidden_field_data_d" style="<?php echo $sStyleHidden_d; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td width="100%" class="scFormDataFontOdd css_d_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_d_label" style=""><span id="id_label_d"><?php echo $this->nm_new_label['d']; ?></span></span><br>
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_d'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_d'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['grid_comprobantes_detalle_1_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_d'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['grid_comprobantes_detalle_1_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['grid_comprobantes_detalle_1_script_case_init'] ]['grid_comprobantes_detalle_1']['embutida_form_full']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['grid_comprobantes_detalle_1_script_case_init'] ]['grid_comprobantes_detalle_1']['embutida_form']       = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['grid_comprobantes_detalle_1_script_case_init'] ]['grid_comprobantes_detalle_1']['embutida_pai']        = "form_comprobantes";
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['grid_comprobantes_detalle_1_script_case_init'] ]['grid_comprobantes_detalle_1']['embutida_form_parms'] = "gidcomprobante*scin" . $this->nmgp_dados_form['idcomprobante'] . "*scoutNMSC_inicial*scininicio*scout";
 if (isset($this->Ini->sc_lig_md5["grid_comprobantes_detalle_1"]) && $this->Ini->sc_lig_md5["grid_comprobantes_detalle_1"] == "S") {
     $Parms_Lig  = "gidcomprobante*scin" . $this->nmgp_dados_form['idcomprobante'] . "*scoutNMSC_inicial*scininicio*scout";
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_comprobantes@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "gidcomprobante*scin" . $this->nmgp_dados_form['idcomprobante'] . "*scoutNMSC_inicial*scininicio*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_comprobantes_empty.htm' : $this->Ini->link_grid_comprobantes_detalle_1_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=300' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_d']) && 'nmsc_iframe_liga_grid_comprobantes_detalle_1' != $this->Ini->sc_lig_target['C_@scinf_d'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_d'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['grid_comprobantes_detalle_1_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
    scOpenMasterDetail("<?php echo $this->Ini->sc_lig_target['C_@scinf_d'] ?>", "<?php echo $sDetailSrc; ?>");
});
</script>
<?php
}
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_grid_comprobantes_detalle_1"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="300" width="100%" name="nmsc_iframe_liga_grid_comprobantes_detalle_1"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_d_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_d_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_comprobantes");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_comprobantes");
 parent.scAjaxDetailHeight("form_comprobantes", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
