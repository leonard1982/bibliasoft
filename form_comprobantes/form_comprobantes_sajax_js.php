  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_comprobantes" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_comprobantes_form();
	}
...
?>
  ...
  // ---------- Validate tipo
  function do_ajax_form_comprobantes_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_comprobantes_validate_tipo_cb);
  } // do_ajax_form_comprobantes_validate_tipo

  function do_ajax_form_comprobantes_validate_tipo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_tipo_cb

  // ---------- Validate prefijo
  function do_ajax_form_comprobantes_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldText(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_comprobantes_validate_prefijo_cb);
  } // do_ajax_form_comprobantes_validate_prefijo

  function do_ajax_form_comprobantes_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_comprobantes_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_numero(var_numero, var_script_case_init, do_ajax_form_comprobantes_validate_numero_cb);
  } // do_ajax_form_comprobantes_validate_numero

  function do_ajax_form_comprobantes_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_numero_cb

  // ---------- Validate creado
  function do_ajax_form_comprobantes_validate_creado()
  {
    var nomeCampo_creado = "creado";
    var var_creado = scAjaxGetFieldText(nomeCampo_creado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_creado(var_creado, var_script_case_init, do_ajax_form_comprobantes_validate_creado_cb);
  } // do_ajax_form_comprobantes_validate_creado

  function do_ajax_form_comprobantes_validate_creado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_creado_cb

  // ---------- Validate asentada
  function do_ajax_form_comprobantes_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldSelect(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_comprobantes_validate_asentada_cb);
  } // do_ajax_form_comprobantes_validate_asentada

  function do_ajax_form_comprobantes_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_asentada_cb

  // ---------- Validate fecha
  function do_ajax_form_comprobantes_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_comprobantes_validate_fecha_cb);
  } // do_ajax_form_comprobantes_validate_fecha

  function do_ajax_form_comprobantes_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_fecha_cb

  // ---------- Validate periodo
  function do_ajax_form_comprobantes_validate_periodo()
  {
    var nomeCampo_periodo = "periodo";
    var var_periodo = scAjaxGetFieldText(nomeCampo_periodo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_periodo(var_periodo, var_script_case_init, do_ajax_form_comprobantes_validate_periodo_cb);
  } // do_ajax_form_comprobantes_validate_periodo

  function do_ajax_form_comprobantes_validate_periodo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "periodo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_periodo_cb

  // ---------- Validate usuario
  function do_ajax_form_comprobantes_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_comprobantes_validate_usuario_cb);
  } // do_ajax_form_comprobantes_validate_usuario

  function do_ajax_form_comprobantes_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_usuario_cb

  // ---------- Validate observaciones
  function do_ajax_form_comprobantes_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_comprobantes_validate_observaciones_cb);
  } // do_ajax_form_comprobantes_validate_observaciones

  function do_ajax_form_comprobantes_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_observaciones_cb

  // ---------- Validate total_debito
  function do_ajax_form_comprobantes_validate_total_debito()
  {
    var nomeCampo_total_debito = "total_debito";
    var var_total_debito = scAjaxGetFieldHidden(nomeCampo_total_debito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_total_debito(var_total_debito, var_script_case_init, do_ajax_form_comprobantes_validate_total_debito_cb);
  } // do_ajax_form_comprobantes_validate_total_debito

  function do_ajax_form_comprobantes_validate_total_debito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_total_debito_cb

  // ---------- Validate total_credito
  function do_ajax_form_comprobantes_validate_total_credito()
  {
    var nomeCampo_total_credito = "total_credito";
    var var_total_credito = scAjaxGetFieldHidden(nomeCampo_total_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_total_credito(var_total_credito, var_script_case_init, do_ajax_form_comprobantes_validate_total_credito_cb);
  } // do_ajax_form_comprobantes_validate_total_credito

  function do_ajax_form_comprobantes_validate_total_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_total_credito_cb

  // ---------- Validate d
  function do_ajax_form_comprobantes_validate_d()
  {
    var nomeCampo_d = "d";
    var var_d = scAjaxGetFieldText(nomeCampo_d);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_comprobantes_validate_d(var_d, var_script_case_init, do_ajax_form_comprobantes_validate_d_cb);
  } // do_ajax_form_comprobantes_validate_d

  function do_ajax_form_comprobantes_validate_d_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "d";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_comprobantes_validate_d_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_comprobantes_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_comprobantes_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_comprobantes_submit_form(var_tipo, var_prefijo, var_numero, var_creado, var_asentada, var_fecha, var_periodo, var_usuario, var_observaciones, var_total_debito, var_total_credito, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_comprobantes_submit_form_cb);
  } // do_ajax_form_comprobantes_submit_form

  function do_ajax_form_comprobantes_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_comprobantes_submit_form_cb_after_alert);
  } // do_ajax_form_comprobantes_submit_form_cb
  function do_ajax_form_comprobantes_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_comprobantes_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_comprobantes_detalle_1"] = "off";

  function do_ajax_form_comprobantes_navigate_form()
  {
    perform_ajax_form_comprobantes_navigate_form();
  }

  function perform_ajax_form_comprobantes_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_comprobantes_navigate_form(var_idcomprobante, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_comprobantes_navigate_form_cb);
  } // do_ajax_form_comprobantes_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_comprobantes']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_comprobantes_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_comprobantes_navigate_form_cb_after_alert);
  } // do_ajax_form_comprobantes_navigate_form_cb
  function do_ajax_form_comprobantes_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_comprobantes_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_comprobantes_navigate_form_cb_after_alert
  function sc_hide_form_comprobantes_form()
  {
