...
function scEventControl_onCalculator_presupuesto_venta() {
  if (!_scCalculatorControl["id_sc_field_presupuesto_venta"]) {
    ...
    do_ajax_form_grupo_event_presupuesto_venta_onblur();
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idgrupo' + iSeqRow).bind('blur', function() { sc_form_grupo_idgrupo_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_grupo_idgrupo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nomgrupo' + iSeqRow).bind('blur', function() { sc_form_grupo_nomgrupo_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_grupo_nomgrupo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_codigogru' + iSeqRow).bind('blur', function() { sc_form_grupo_codigogru_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_grupo_codigogru_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_imagen' + iSeqRow).bind('blur', function() { sc_form_grupo_imagen_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_grupo_imagen_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_mostrar' + iSeqRow).bind('blur', function() { sc_form_grupo_mostrar_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_grupo_mostrar_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_comanda' + iSeqRow).bind('blur', function() { sc_form_grupo_comanda_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_grupo_comanda_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ruta_impresora' + iSeqRow).bind('blur', function() { sc_form_grupo_ruta_impresora_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_grupo_ruta_impresora_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_presupuesto_venta' + iSeqRow).bind('blur', function() { sc_form_grupo_presupuesto_venta_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_grupo_presupuesto_venta_onchange(this, iSeqRow) })
...
function sc_form_grupo_idgrupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_grupo_nomgrupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_grupo_codigogru_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_grupo_imagen_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_grupo_mostrar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_grupo_comanda_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_grupo_ruta_impresora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_grupo_presupuesto_venta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_grupo_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_grupo')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
