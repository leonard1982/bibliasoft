...
?>
  ...
  // ---------- Validate idgrupo
  function do_ajax_form_grupo_mob_validate_idgrupo()
  {
    var nomeCampo_idgrupo = "idgrupo";
    var var_idgrupo = scAjaxGetFieldHidden(nomeCampo_idgrupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_idgrupo(var_idgrupo, var_script_case_init, do_ajax_form_grupo_mob_validate_idgrupo_cb);
  } // do_ajax_form_grupo_mob_validate_idgrupo

  function do_ajax_form_grupo_mob_validate_idgrupo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_idgrupo_cb

  // ---------- Validate codigogru
  function do_ajax_form_grupo_mob_validate_codigogru()
  {
    var nomeCampo_codigogru = "codigogru";
    var var_codigogru = scAjaxGetFieldText(nomeCampo_codigogru);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_codigogru(var_codigogru, var_script_case_init, do_ajax_form_grupo_mob_validate_codigogru_cb);
  } // do_ajax_form_grupo_mob_validate_codigogru

  function do_ajax_form_grupo_mob_validate_codigogru_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_codigogru_cb

  // ---------- Validate nomgrupo
  function do_ajax_form_grupo_mob_validate_nomgrupo()
  {
    var nomeCampo_nomgrupo = "nomgrupo";
    var var_nomgrupo = scAjaxGetFieldText(nomeCampo_nomgrupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_nomgrupo(var_nomgrupo, var_script_case_init, do_ajax_form_grupo_mob_validate_nomgrupo_cb);
  } // do_ajax_form_grupo_mob_validate_nomgrupo

  function do_ajax_form_grupo_mob_validate_nomgrupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_nomgrupo_cb

  // ---------- Validate imagen
  function do_ajax_form_grupo_mob_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_grupo_mob_validate_imagen_cb);
  } // do_ajax_form_grupo_mob_validate_imagen

  function do_ajax_form_grupo_mob_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_imagen_cb

  // ---------- Validate mostrar
  function do_ajax_form_grupo_mob_validate_mostrar()
  {
    var nomeCampo_mostrar = "mostrar";
    var var_mostrar = scAjaxGetFieldRadio(nomeCampo_mostrar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_mostrar(var_mostrar, var_script_case_init, do_ajax_form_grupo_mob_validate_mostrar_cb);
  } // do_ajax_form_grupo_mob_validate_mostrar

  function do_ajax_form_grupo_mob_validate_mostrar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mostrar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_mostrar_cb

  // ---------- Validate comanda
  function do_ajax_form_grupo_mob_validate_comanda()
  {
    var nomeCampo_comanda = "comanda";
    var var_comanda = scAjaxGetFieldRadio(nomeCampo_comanda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_comanda(var_comanda, var_script_case_init, do_ajax_form_grupo_mob_validate_comanda_cb);
  } // do_ajax_form_grupo_mob_validate_comanda

  function do_ajax_form_grupo_mob_validate_comanda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "comanda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_comanda_cb

  // ---------- Validate ruta_impresora
  function do_ajax_form_grupo_mob_validate_ruta_impresora()
  {
    var nomeCampo_ruta_impresora = "ruta_impresora";
    var var_ruta_impresora = scAjaxGetFieldText(nomeCampo_ruta_impresora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_ruta_impresora(var_ruta_impresora, var_script_case_init, do_ajax_form_grupo_mob_validate_ruta_impresora_cb);
  } // do_ajax_form_grupo_mob_validate_ruta_impresora

  function do_ajax_form_grupo_mob_validate_ruta_impresora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_ruta_impresora_cb

  // ---------- Validate presupuesto_venta
  function do_ajax_form_grupo_mob_validate_presupuesto_venta()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_mob_validate_presupuesto_venta(var_presupuesto_venta, var_script_case_init, do_ajax_form_grupo_mob_validate_presupuesto_venta_cb);
  } // do_ajax_form_grupo_mob_validate_presupuesto_venta

  function do_ajax_form_grupo_mob_validate_presupuesto_venta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_mob_validate_presupuesto_venta_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_grupo_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_mob_submit_form(var_idgrupo, var_codigogru, var_nomgrupo, var_imagen, var_mostrar, var_comanda, var_ruta_impresora, var_presupuesto_venta, var_imagen_ul_name, var_imagen_ul_type, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_grupo_mob_submit_form_cb);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_grupo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_grupo_mob_submit_form_cb
  function do_ajax_form_grupo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_grupo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_grupo_mob_navigate_form()
  {
    perform_ajax_form_grupo_mob_navigate_form();
  }

  function perform_ajax_form_grupo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_mob_navigate_form(var_idgrupo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grupo_mob_navigate_form_cb);
  } // do_ajax_form_grupo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_grupo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_grupo_mob_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_grupo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_grupo_mob_navigate_form_cb
  function do_ajax_form_grupo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_grupo_mob_navigate_form_cb_after_alert
  function sc_hide_form_grupo_mob_form()
  {
