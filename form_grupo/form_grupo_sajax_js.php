  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_grupo" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate idgrupo
  function do_ajax_form_grupo_validate_idgrupo()
  {
    var nomeCampo_idgrupo = "idgrupo";
    var var_idgrupo = scAjaxGetFieldHidden(nomeCampo_idgrupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_idgrupo(var_idgrupo, var_script_case_init, do_ajax_form_grupo_validate_idgrupo_cb);
  } // do_ajax_form_grupo_validate_idgrupo

  function do_ajax_form_grupo_validate_idgrupo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_idgrupo_cb

  // ---------- Validate codigogru
  function do_ajax_form_grupo_validate_codigogru()
  {
    var nomeCampo_codigogru = "codigogru";
    var var_codigogru = scAjaxGetFieldText(nomeCampo_codigogru);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_codigogru(var_codigogru, var_script_case_init, do_ajax_form_grupo_validate_codigogru_cb);
  } // do_ajax_form_grupo_validate_codigogru

  function do_ajax_form_grupo_validate_codigogru_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigogru";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_codigogru_cb

  // ---------- Validate nomgrupo
  function do_ajax_form_grupo_validate_nomgrupo()
  {
    var nomeCampo_nomgrupo = "nomgrupo";
    var var_nomgrupo = scAjaxGetFieldText(nomeCampo_nomgrupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_nomgrupo(var_nomgrupo, var_script_case_init, do_ajax_form_grupo_validate_nomgrupo_cb);
  } // do_ajax_form_grupo_validate_nomgrupo

  function do_ajax_form_grupo_validate_nomgrupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nomgrupo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_nomgrupo_cb

  // ---------- Validate imagen
  function do_ajax_form_grupo_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldText(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_grupo_validate_imagen_cb);
  } // do_ajax_form_grupo_validate_imagen

  function do_ajax_form_grupo_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_imagen_cb

  // ---------- Validate mostrar
  function do_ajax_form_grupo_validate_mostrar()
  {
    var nomeCampo_mostrar = "mostrar";
    var var_mostrar = scAjaxGetFieldRadio(nomeCampo_mostrar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_mostrar(var_mostrar, var_script_case_init, do_ajax_form_grupo_validate_mostrar_cb);
  } // do_ajax_form_grupo_validate_mostrar

  function do_ajax_form_grupo_validate_mostrar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mostrar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_mostrar_cb

  // ---------- Validate comanda
  function do_ajax_form_grupo_validate_comanda()
  {
    var nomeCampo_comanda = "comanda";
    var var_comanda = scAjaxGetFieldRadio(nomeCampo_comanda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_comanda(var_comanda, var_script_case_init, do_ajax_form_grupo_validate_comanda_cb);
  } // do_ajax_form_grupo_validate_comanda

  function do_ajax_form_grupo_validate_comanda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "comanda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_comanda_cb

  // ---------- Validate ruta_impresora
  function do_ajax_form_grupo_validate_ruta_impresora()
  {
    var nomeCampo_ruta_impresora = "ruta_impresora";
    var var_ruta_impresora = scAjaxGetFieldText(nomeCampo_ruta_impresora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_ruta_impresora(var_ruta_impresora, var_script_case_init, do_ajax_form_grupo_validate_ruta_impresora_cb);
  } // do_ajax_form_grupo_validate_ruta_impresora

  function do_ajax_form_grupo_validate_ruta_impresora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruta_impresora";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_ruta_impresora_cb

  // ---------- Validate presupuesto_venta
  function do_ajax_form_grupo_validate_presupuesto_venta()
  {
    var nomeCampo_presupuesto_venta = "presupuesto_venta";
    var var_presupuesto_venta = scAjaxGetFieldText(nomeCampo_presupuesto_venta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_validate_presupuesto_venta(var_presupuesto_venta, var_script_case_init, do_ajax_form_grupo_validate_presupuesto_venta_cb);
  } // do_ajax_form_grupo_validate_presupuesto_venta

  function do_ajax_form_grupo_validate_presupuesto_venta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "presupuesto_venta";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_validate_presupuesto_venta_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_grupo_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_grupo_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idgrupo = scAjaxGetFieldHidden("idgrupo");
    var var_codigogru = scAjaxGetFieldText("codigogru");
    var var_nomgrupo = scAjaxGetFieldText("nomgrupo");
    var var_imagen = scAjaxGetFieldText("imagen");
    var var_mostrar = scAjaxGetFieldRadio("mostrar");
    var var_comanda = scAjaxGetFieldRadio("comanda");
    var var_ruta_impresora = scAjaxGetFieldText("ruta_impresora");
    var var_presupuesto_venta = scAjaxGetFieldText("presupuesto_venta");
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_submit_form(var_idgrupo, var_codigogru, var_nomgrupo, var_imagen, var_mostrar, var_comanda, var_ruta_impresora, var_presupuesto_venta, var_imagen_ul_name, var_imagen_ul_type, var_imagen_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_grupo_submit_form_cb);
  } // do_ajax_form_grupo_submit_form

  function do_ajax_form_grupo_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("codigogru");
      scAjaxHideErrorDisplay("nomgrupo");
      scAjaxHideErrorDisplay("imagen");
      scAjaxHideErrorDisplay("mostrar");
      scAjaxHideErrorDisplay("comanda");
      scAjaxHideErrorDisplay("ruta_impresora");
      scAjaxHideErrorDisplay("presupuesto_venta");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_grupo_submit_form_cb_after_alert);
  } // do_ajax_form_grupo_submit_form_cb
  function do_ajax_form_grupo_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_grupo_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_grupo_navigate_form()
  {
    perform_ajax_form_grupo_navigate_form();
  }

  function perform_ajax_form_grupo_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ruta_impresora");
    scAjaxHideErrorDisplay("presupuesto_venta");
    var var_idgrupo = document.F2.idgrupo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_navigate_form(var_idgrupo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grupo_navigate_form_cb);
  } // do_ajax_form_grupo_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_grupo']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_grupo_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idgrupo.value = scAjaxGetKeyValue("idgrupo");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_grupo_navigate_form_cb_after_alert);
  } // do_ajax_form_grupo_navigate_form_cb
  function do_ajax_form_grupo_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_grupo_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_grupo_navigate_form_cb_after_alert
  function sc_hide_form_grupo_form()
  {
  ...
  ajax_field_list[0] = "idgrupo";
  ajax_field_list[1] = "codigogru";
  ajax_field_list[2] = "nomgrupo";
  ajax_field_list[3] = "imagen";
  ajax_field_list[4] = "mostrar";
  ajax_field_list[5] = "comanda";
  ajax_field_list[6] = "ruta_impresora";
  ajax_field_list[7] = "presupuesto_venta";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "idgrupo": {"label": "Idgrupo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codigogru": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nomgrupo": {"label": "Grupo o Familia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "imagen": {"label": "Imágen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mostrar": {"label": "Mostrar en Móvil", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "comanda": {"label": "Utilizar en comanda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ruta_impresora": {"label": "Ruta Impresora  Comanda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "presupuesto_venta": {"label": "Presupuesto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "mostrar": new Array(),
    "comanda": new Array(),
    "ruta_impresora": new Array(),
    "presupuesto_venta": new Array()
  };
  ajax_field_mult["idgrupo"][1] = "idgrupo";
  ajax_field_mult["codigogru"][1] = "codigogru";
  ajax_field_mult["nomgrupo"][1] = "nomgrupo";
  ajax_field_mult["imagen"][1] = "imagen";
  ajax_field_mult["mostrar"][1] = "mostrar";
  ajax_field_mult["comanda"][1] = "comanda";
  ajax_field_mult["ruta_impresora"][1] = "ruta_impresora";
  ajax_field_mult["presupuesto_venta"][1] = "presupuesto_venta";

  var ajax_field_id = {
    "codigogru": new Array("hidden_field_label_codigogru", "hidden_field_data_codigogru"),
    "nomgrupo": new Array("hidden_field_label_nomgrupo", "hidden_field_data_nomgrupo"),
    "imagen": new Array("hidden_field_label_imagen", "hidden_field_data_imagen"),
    "mostrar": new Array("hidden_field_label_mostrar", "hidden_field_data_mostrar"),
    "comanda": new Array("hidden_field_label_comanda", "hidden_field_data_comanda"),
    "ruta_impresora": new Array("hidden_field_label_ruta_impresora", "hidden_field_data_ruta_impresora"),
    "presupuesto_venta": new Array("hidden_field_label_presupuesto_venta", "hidden_field_data_presupuesto_venta")
  };
