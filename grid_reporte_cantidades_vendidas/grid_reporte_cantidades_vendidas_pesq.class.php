 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_f_fechaven_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['f_fechaven'])) ? $this->New_label['f_fechaven'] : "Fechaven"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_f_fechaven_cond" name="f_fechaven_cond" onChange="nm_campos_between(document.getElementById('id_vis_f_fechaven'), this, 'f_fechaven')">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_f_fechaven"  <?php echo $str_display_f_fechaven; ?> class="scFilterFieldFontOdd">
...
?>
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_factura_cond" name="factura_cond" onChange="nm_campos_between(document.getElementById('id_vis_factura'), this, 'factura')">
...
?>
<INPUT  type="text" id="SC_factura" name="factura" value="<?php echo NM_encode_input($factura) ?>"  size=50 alt="{datatype: 'text', maxLength: 93, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
