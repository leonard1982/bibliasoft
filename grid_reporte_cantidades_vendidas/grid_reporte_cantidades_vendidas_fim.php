...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_reporte_cantidades_vendidas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_reporte_cantidades_vendidas"]);
   }
