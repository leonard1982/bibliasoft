...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reporte_cantidades_vendidas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reporte_cantidades_vendidas"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_reporte_cantidades_vendidas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reporte_cantidades_vendidas']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_reporte_cantidades_vendidas' || $achou)
          {
