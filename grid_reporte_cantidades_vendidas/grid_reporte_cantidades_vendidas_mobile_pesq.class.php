...
class grid_reporte_cantidades_vendidas_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_reporte_cantidades_vendidas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_reporte_cantidades_vendidas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_reporte_cantidades_vendidas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "f.fechaven";$Nm_datas[] = "f_fechaven";$Nm_numeric[] = "d_cantidad";$Nm_numeric[] = "month(f_fechaven)";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_reporte_cantidades_vendidas/grid_reporte_cantidades_vendidas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_reporte_cantidades_vendidas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_reporte_cantidades_vendidas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_reporte_cantidades_vendidas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_reporte_cantidades_vendidas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_reporte_cantidades_vendidas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $f_fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_dia']; 
          $f_fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_mes']; 
          $f_fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_ano']; 
          $f_fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_input_2_dia']; 
          $f_fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_input_2_mes']; 
          $f_fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_input_2_ano']; 
          $f_fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_cond']; 
          $factura = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['factura']; 
          $factura_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['factura_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['cliente_cond']; 
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['codigo']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['codigo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['NM_operador']; 
      } 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_f_fechaven_cond" name="f_fechaven_cond" onChange="nm_campos_between(document.getElementById('id_vis_f_fechaven'), this, 'f_fechaven')">
       <OPTION value="eq" <?php if ("eq" == $f_fechaven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $f_fechaven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $f_fechaven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $f_fechaven_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_f_fechaven"  <?php echo $str_hide_f_fechaven?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_f_fechaven"  <?php echo $str_display_f_fechaven; ?> class="scFilterFieldFontOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_f_fechaven_input_2_dia" name="f_fechaven_input_2_dia" value="<?php echo NM_encode_input($f_fechaven_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_f_fechaven_input_2_mes" name="f_fechaven_input_2_mes" value="<?php echo NM_encode_input($f_fechaven_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_f_fechaven_input_2_ano" name="f_fechaven_input_2_ano" value="<?php echo NM_encode_input($f_fechaven_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_factura_cond" name="factura_cond" onChange="nm_campos_between(document.getElementById('id_vis_factura'), this, 'factura')">
       <OPTION value="qp" <?php if ("qp" == $factura_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $factura_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $factura_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $factura_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_factura"  <?php echo $str_hide_factura?>><INPUT  type="text" id="SC_factura" name="factura" value="<?php echo NM_encode_input($factura) ?>"  size=50 alt="{datatype: 'text', maxLength: 93, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>"  size=50 alt="{datatype: 'text', maxLength: 75, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
...
?>
<?php
   if (is_file("grid_reporte_cantidades_vendidas_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_cantidades_vendidas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_cantidades_vendidas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_f_fechaven_dia').bind('change', function() {sc_grid_reporte_cantidades_vendidas_valida_dia(this)});
    $('#SC_f_fechaven_input_2_dia').bind('change', function() {sc_grid_reporte_cantidades_vendidas_valida_dia(this)});
    $('#SC_f_fechaven_input_2_mes').bind('change', function() {sc_grid_reporte_cantidades_vendidas_valida_mes(this)});
    $('#SC_f_fechaven_mes').bind('change', function() {sc_grid_reporte_cantidades_vendidas_valida_mes(this)});
 }
 function sc_grid_reporte_cantidades_vendidas_valida_dia(obj)
 {
 ...
 function sc_grid_reporte_cantidades_vendidas_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_reporte_cantidades_vendidas";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_reporte_cantidades_vendidas/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $f_fechaven_cond, $f_fechaven, $f_fechaven_dia, $f_fechaven_mes, $f_fechaven_ano, $f_fechaven_input_2_dia, $f_fechaven_input_2_mes, $f_fechaven_input_2_ano,
             $factura_cond, $factura,
             $cliente_cond, $cliente, $cliente_autocomp,
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_dia'] = $f_fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_mes'] = $f_fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_ano'] = $f_fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_input_2_dia'] = $f_fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_input_2_mes'] = $f_fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_input_2_ano'] = $f_fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_cond'] = $f_fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['factura'] = $factura; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['factura_cond'] = $factura_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $factura;
      $this->cmp_formatado['factura'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($cliente != '') {
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
    ...
    if ($codigo != '') {
      ...
      if ($f_fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven'] = $val[0];
          ...
          if ($f_fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']['f_fechaven_input_2'] = $val[1];
      ...
      {
         $this->monta_condicao("concat(r.prefijo,'/',f.numfacven)", $factura_cond, $factura, "", "factura");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_cantidades_vendidas']['cond_pesq'] .= $this->NM_operador;
