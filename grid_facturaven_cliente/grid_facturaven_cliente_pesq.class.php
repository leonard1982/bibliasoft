...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numfacven" id="id_ac_numfacven" name="numfacven_autocomp"><?php if ('' !=  $numfacven) { ?><option value="<?php echo $numfacven ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_nremision_cond" name="nremision_cond" onChange="nm_campos_between(document.getElementById('id_vis_nremision'), this, 'nremision')">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nremision" id="id_ac_nremision" name="nremision_autocomp"><?php if ('' !=  $nremision) { ?><option value="<?php echo $nremision ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
     ...
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_pagada_cond" name="pagada_cond" onChange="nm_campos_between(document.getElementById('id_vis_pagada'), this, 'pagada')">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-pagada" id="id_ac_pagada" name="pagada_autocomp"><?php if ('' !=  $pagada) { ?><option value="<?php echo $pagada ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_credito_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['credito'])) ? $this->New_label['credito'] : "Credito"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_credito_cond" name="credito_cond" onChange="nm_campos_between(document.getElementById('id_vis_credito'), this, 'credito')">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-saldo" id="id_ac_saldo" name="saldo_autocomp"><?php if ('' !=  $saldo) { ?><option value="<?php echo $saldo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       ...
       <TR valign="top">
        <TD id="id_vis_saldo"  <?php echo $str_display_saldo; ?> class="scFilterFieldFontOdd">
         ...
         <BR>
         <INPUT type="text" id="SC_saldo_input_2" name="saldo_input_2" value="<?php echo NM_encode_input($saldo_input_2) ?>"  size=14 alt="{datatype: 'integer', maxLength: 14, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
...
?>
      ...
      <TD id='SC_fechavenc_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechavenc'])) ? $this->New_label['fechavenc'] : "F. Vencimiento"; ?></TD>
     <TD class="scFilterFieldOdd"> 
