<?php
class grid_facturaven_cliente_lookup
{
//  
...
//  
   ...
   {   
      ...
      { 
          $nm_comando = "SELECT documento + \" - \" + nombres + \" - \" + tel_cel  FROM terceros where idtercero = $idcli order by documento, nombres, tel_cel" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT concat(documento, \" - \",nombres,  \" - \",tel_cel)  FROM terceros where idtercero = $idcli order by documento, nombres, tel_cel" ; 
      } 
