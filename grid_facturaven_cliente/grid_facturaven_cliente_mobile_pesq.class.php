...
class grid_facturaven_cliente_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_facturaven_cliente_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_facturaven_cliente_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_facturaven_cliente_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_numfacven($numfacven)
   {
      ...
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where   CAST (numfacven AS TEXT)  like '%" . $numfacven . "%'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where   CAST (numfacven AS VARCHAR)  like '%" . $numfacven . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where  numfacven like '%" . $numfacven . "%'"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_nremision($nremision)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where   CAST (nremision AS TEXT)  like '%" . $nremision . "%'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where   CAST (nremision AS VARCHAR)  like '%" . $nremision . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where  nremision like '%" . $nremision . "%'"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_pagada($pagada)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pagada from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where  pagada like '%" . $pagada . "%'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_credito($credito)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct credito from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where   CAST (credito AS TEXT)  like '%" . $credito . "%'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct credito from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where   CAST (credito AS VARCHAR)  like '%" . $credito . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct credito from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where  credito like '%" . $credito . "%'"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_saldo($saldo)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct saldo from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where   CAST (saldo AS TEXT)  like '%" . $saldo . "%'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldo from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where   CAST (saldo AS VARCHAR)  like '%" . $saldo . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct saldo from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where  saldo like '%" . $saldo . "%'"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_facturaven_cliente/grid_facturaven_cliente_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_facturaven_cliente_ajax_search.js"></script>
 <script type="text/javascript" src="grid_facturaven_cliente_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_facturaven_cliente_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_facturaven_cliente']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_facturaven_cliente']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>FACTURAS DEL CLIENTE</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $credito_cond, $credito, $credito_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $numfacven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['numfacven']; 
          $numfacven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['numfacven_cond']; 
          $nremision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['nremision']; 
          $nremision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['nremision_cond']; 
          $pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['pagada']; 
          $pagada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['pagada_cond']; 
          $credito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['credito']; 
          $credito_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['credito_cond']; 
          $saldo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['saldo']; 
          $saldo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['saldo_input_2']; 
          $saldo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['saldo_cond']; 
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_cond']; 
          $fechavenc_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_dia']; 
          $fechavenc_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_mes']; 
          $fechavenc_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_ano']; 
          $fechavenc_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_input_2_dia']; 
          $fechavenc_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_input_2_mes']; 
          $fechavenc_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_input_2_ano']; 
          $fechavenc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['NM_operador']; 
      } 
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_numfacven_cond" name="numfacven_cond" onChange="nm_campos_between(document.getElementById('id_vis_numfacven'), this, 'numfacven')">
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where numfacven = $numfacven_look"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where numfacven = $numfacven_look"; 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nremision_cond" name="nremision_cond" onChange="nm_campos_between(document.getElementById('id_vis_nremision'), this, 'nremision')">
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where nremision = $nremision_look"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct nremision from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where nremision = $nremision_look"; 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_pagada_cond" name="pagada_cond" onChange="nm_campos_between(document.getElementById('id_vis_pagada'), this, 'pagada')">
      ...
      $pagada_look = substr($this->Db->qstr($pagada), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct pagada from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where pagada = '$pagada_look'"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_pagada" name="pagada" value="<?php echo NM_encode_input($pagada) ?>"  size=24 alt="{datatype: 'text', maxLength: 24, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_credito_cond" name="credito_cond" onChange="nm_campos_between(document.getElementById('id_vis_credito'), this, 'credito')">
       <OPTION value="eq" <?php if ("eq" == $credito_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_credito"  <?php echo $str_hide_credito?>><?php
      if ($credito != "")
      {
      $credito_look = substr($this->Db->qstr($credito), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct credito from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where credito = $credito_look"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct credito from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where credito = $credito_look"; 
...
?>
<INPUT  type="text" id="SC_credito" name="credito" value="<?php echo NM_encode_input($credito) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-credito" id="id_ac_credito" name="credito_autocomp"><?php if ('' !=  $credito) { ?><option value="<?php echo $credito ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct saldo from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where saldo = $saldo_look"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldo from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE      idcli = " . $_SESSION['par_cliente'] . " ORDER BY idfacven DESC) ) nm_sel_esp where saldo = $saldo_look"; 
...
?>
<INPUT  type="text" id="SC_saldo" name="saldo" value="<?php echo NM_encode_input($saldo) ?>" size=14 alt="{datatype: 'integer', maxLength: 14, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-saldo" id="id_ac_saldo" name="saldo_autocomp"><?php if ('' !=  $saldo) { ?><option value="<?php echo $saldo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_saldo"  <?php echo $str_display_saldo; ?> class="scFilterFieldFontOdd">
         ...
         <BR>
         <INPUT type="text" id="SC_saldo_input_2" name="saldo_input_2" value="<?php echo NM_encode_input($saldo_input_2) ?>"  size=14 alt="{datatype: 'integer', maxLength: 14, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_fechaven_cond" name="fechaven_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechaven'), this, 'fechaven')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fechavenc_cond" name="fechavenc_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechavenc'), this, 'fechavenc')">
...
?>
<?php
   if (is_file("grid_facturaven_cliente_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_cliente']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_cliente']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fechaven_dia').bind('change', function() {sc_grid_facturaven_cliente_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_grid_facturaven_cliente_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_grid_facturaven_cliente_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_grid_facturaven_cliente_valida_mes(this)});
    $('#SC_fechavenc_dia').bind('change', function() {sc_grid_facturaven_cliente_valida_dia(this)});
    $('#SC_fechavenc_input_2_dia').bind('change', function() {sc_grid_facturaven_cliente_valida_dia(this)});
    $('#SC_fechavenc_input_2_mes').bind('change', function() {sc_grid_facturaven_cliente_valida_mes(this)});
    $('#SC_fechavenc_mes').bind('change', function() {sc_grid_facturaven_cliente_valida_mes(this)});
 }
 function sc_grid_facturaven_cliente_valida_dia(obj)
 {
 ...
 function sc_grid_facturaven_cliente_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_facturaven_cliente";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_facturaven_cliente/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   {
      global $numfacven_cond, $numfacven, $numfacven_autocomp,
             $nremision_cond, $nremision, $nremision_autocomp,
             $pagada_cond, $pagada, $pagada_autocomp,
             $credito_cond, $credito, $credito_autocomp,
             $saldo_cond, $saldo, $saldo_input_2, $saldo_autocomp,
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['numfacven'] = $numfacven; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['numfacven_cond'] = $numfacven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['nremision'] = $nremision; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['nremision_cond'] = $nremision_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['pagada'] = $pagada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['pagada_cond'] = $pagada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['credito'] = $credito; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['credito_cond'] = $credito_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['saldo'] = $saldo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['saldo_input_2'] = $saldo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['saldo_cond'] = $saldo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_dia'] = $fechavenc_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_mes'] = $fechavenc_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_ano'] = $fechavenc_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_input_2_dia'] = $fechavenc_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_input_2_mes'] = $fechavenc_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_input_2_ano'] = $fechavenc_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_cond'] = $fechavenc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca'] = $Temp_Busca;
      }
      ...
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Credito";
      }
   ...
   { 
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechaven_input_2'] = $val[1];
      ...
      if ($fechavenc_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc'] = $val[0];
          ...
          if ($fechavenc_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']['fechavenc_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_cliente']['cond_pesq'] .= $this->NM_operador;
