<?php
   include_once('grid_grupo_session.php');
   session_start();
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_grupo"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_grupo"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_grupo'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_grupo']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_grupo']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupo']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_grupo']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupo']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_grupo']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_grupo']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_grupo']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_grupo']['embutida_filho'] as $ind => $sc_init)
          {
