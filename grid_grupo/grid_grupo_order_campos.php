<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_grupo']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_grupo_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_grupo_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['codigogru'] = "on";
   $tab_def_campos['codigogru'] = "codigogru";
   $tab_labels["codigogru"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["codigogru"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["codigogru"] : "Código";
   $tab_ger_campos['nomgrupo'] = "on";
   $tab_def_campos['nomgrupo'] = "nomgrupo";
   $tab_labels["nomgrupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["nomgrupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["nomgrupo"] : "Grupo o Familia";
   $tab_ger_campos['imagen'] = "on";
   $tab_def_campos['imagen'] = "imagen";
   $tab_labels["imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["imagen"] : "Imágen";
   $tab_ger_campos['mostrar'] = "on";
   $tab_def_campos['mostrar'] = "mostrar";
   $tab_labels["mostrar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["mostrar"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["mostrar"] : "Mos. en Móvil";
   $tab_ger_campos['comanda'] = "on";
   $tab_def_campos['comanda'] = "comanda";
   $tab_labels["comanda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["comanda"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["comanda"] : "M. en comanda";
   $tab_ger_campos['presupuesto_venta'] = "on";
   $tab_def_campos['presupuesto_venta'] = "presupuesto_venta";
   $tab_labels["presupuesto_venta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["presupuesto_venta"])) ? $_SESSION['sc_session'][$sc_init]['grid_grupo']['labels']["presupuesto_venta"] : "Presupuesto";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_grupo']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_grupo']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>Grupo o Familia de Productos</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_grupo_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_grupo']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
