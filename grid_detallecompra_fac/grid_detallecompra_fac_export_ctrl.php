<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallecompra_fac']['sc_process_barr'] = true;
require_once('../grid_detallecompra_fac/index.php');
unset($_SESSION['scriptcase']['grid_detallecompra_fac']['sc_process_barr']);
$ExportCtrl = new grid_detallecompra_fac_export_control;
$ExportCtrl->Export_barr();

class grid_detallecompra_fac_export_control
{
