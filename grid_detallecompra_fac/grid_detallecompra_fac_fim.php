...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallecompra_fac"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_detallecompra_fac"]);
   }
