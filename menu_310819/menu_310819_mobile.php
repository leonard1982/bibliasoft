...
<html>
    <head>
        ...
        <link rel="stylesheet"  href="<?php echo $_SESSION["scriptcase"]["menu_310819"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.css" />
        ...
        <link rel="stylesheet" href="<?php echo $_SESSION['scriptcase']['menu_310819']['glo_nm_path_prod']; ?>/third/font-awesome/css/all.min.css" type="text/css" media="screen" />
        <script src="<?php echo $_SESSION["scriptcase"]["menu_310819"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.js"></script>
        ...
        <script src="<?php echo $_SESSION["scriptcase"]["menu_310819"]["glo_nm_path_prod"]; ?>/third/jquery.mobile/jquery.mobile-1.2.0.min.js"></script>
    <style>
    <?php
    if(isset($menu_310819_menuData["data"]) && is_array($menu_310819_menuData["data"]) && !empty($menu_310819_menuData["data"]))
    {
        foreach($menu_310819_menuData["data"] as $arr_item)
        {
...
<table width="100%" height="67px" class="scMenuHHeader">
    ...
    <?php
        escreveMenuMobile($menu_310819_menuData["data"], $this->path_imag_apl);
    ?>
	<?php
