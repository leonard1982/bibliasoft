<?php
   include_once('grid_cuentaspagar_contado_seleccionar_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_cuentaspagar_contado_seleccionar']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_cuentaspagar_contado_seleccionar']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_cuentaspagar_contado_seleccionar']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_cuentaspagar_contado_seleccionar']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_cuentaspagar_contado_seleccionar_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cuentaspagar_contado_seleccionar_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_cuentaspagar_contado_seleccionar_json.php");
   }
   ...
   $tab_labels["idprov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["idprov"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["idprov"] : "Proveedor";
   $tab_ger_campos['numfacom'] = "on";
   $tab_def_campos['numfacom'] = "numfacom";
   $tab_labels["numfacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["numfacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["numfacom"] : "Número Compra";
   $tab_ger_campos['formapago'] = "on";
   $tab_def_campos['formapago'] = "formapago";
   $tab_labels["formapago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["formapago"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["formapago"] : "Forma de pago";
   $tab_ger_campos['fechacom'] = "on";
   $tab_def_campos['fechacom'] = "fechacom";
   $tab_labels["fechacom"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["fechacom"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["fechacom"] : "Fecha compra";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["fechavenc"] : "Fecha vencimiento";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["total"] : "Total";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["saldo"] : "Saldo";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['seleccion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['seleccion'] = "seleccion";
   }
   else
   {
       $tab_def_campos['seleccion'] = "concat (idprov,'/',numfacom)";
   }
   $tab_labels["seleccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["seleccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['labels']["seleccion"] : "";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cuentaspagar_contado_seleccionar_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cuentaspagar_contado_seleccionar']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
