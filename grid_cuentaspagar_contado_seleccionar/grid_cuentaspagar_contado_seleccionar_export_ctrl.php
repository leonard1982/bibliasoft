<?php
@session_start() ;
$_SESSION['scriptcase']['grid_cuentaspagar_contado_seleccionar']['sc_process_barr'] = true;
require_once('../grid_cuentaspagar_contado_seleccionar/index.php');
unset($_SESSION['scriptcase']['grid_cuentaspagar_contado_seleccionar']['sc_process_barr']);
$ExportCtrl = new grid_cuentaspagar_contado_seleccionar_export_control;
$ExportCtrl->Export_barr();

class grid_cuentaspagar_contado_seleccionar_export_control
{
