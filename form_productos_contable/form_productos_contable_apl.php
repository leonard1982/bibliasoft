<?php
//
class form_productos_contable_apl
{
   ...
   var $form_vert_form_productos_contable = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_productos_contable']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_productos_contable']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_productos_contable']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_productos_contable']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_productos_contable_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_productos_contable']['upload_field_info']['imagenprod_'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_productos_contable',
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_productos_contable']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_productos_contable'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_productos_contable']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_productos_contable']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_productos_contable') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_productos_contable']['label'] = "Editar Contable Productos";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_productos_contable")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_productos_contable']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_productos_contable'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_productos_contable']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_productos_contable'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_productos_contable'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_productos_contable", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_productos_contable_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_productos_contable_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_productos_contable/form_productos_contable_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_productos_contable_erro.class.php"); 
      }
      $this->Erro      = new form_productos_contable_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_max_reg']) == "all")
      {
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao']))
         { 
             if ($this->idprod_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_productos_contable']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_productos_contable']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function loadFieldConfig()
   {
      ...
      $this->field_config['preciomen_']['symbol_mon'] = '';
      ...
      $this->field_config['preciomen2_']['symbol_mon'] = '';
      ...
      $this->field_config['preciomen3_']['symbol_mon'] = '';
      ...
      $this->field_config['preciomay_']['symbol_mon'] = '';
      ...
      $this->field_config['preciofull_']['symbol_mon'] = '';
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_form'][$sc_seq_vert];
             $this->idprod_ = $this->nmgp_dados_form['idprod_']; 
             if ($this->nmgp_opcao == "incluir"){$this->codigobar_ = $this->nmgp_dados_form['codigobar_'];} 
             $this->codigoprod_ = $this->nmgp_dados_form['codigoprod_']; 
             if ($this->nmgp_opcao == "incluir"){$this->nompro_ = $this->nmgp_dados_form['nompro_'];} 
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_productos_contable']) || !is_array($this->NM_ajax_info['errList']['geral_form_productos_contable']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_productos_contable'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_productos_contable'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_productos_contable'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_productos_contable'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_redir_atualiz'] == "ok")
          {
      ...
      { 
         ...
         { 
             $GLOBALS["codigobar_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['codigobar_'];
         } 
         if ($this->nmgp_opcao == "recarga" && !isset($GLOBALS["nompro_" . $sc_seq_vert]))
         { 
             $GLOBALS["nompro_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['nompro_'];
         } 
         ...
         if (isset($this->idiva_)) { $this->nm_limpa_alfa($this->idiva_); }
         if (isset($this->cod_cuenta_)) { $this->nm_limpa_alfa($this->cod_cuenta_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['codigobar_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_disabled'][$sc_seq_vert]['codigobar_']))
             { 
                 $this->codigobar_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['codigobar_'];
             } 
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['nompro_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_disabled'][$sc_seq_vert]['nompro_']))
             { 
                 $this->nompro_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['nompro_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_productos_contable[$sc_seq_vert]['codigobar_'] =  $this->codigobar_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['nompro_'] =  $this->nompro_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['idiva_'] =  $this->idiva_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['cod_cuenta_'] =  $this->cod_cuenta_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['idprod_'] =  $this->idprod_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['codigoprod_'] =  $this->codigoprod_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['unidmaymen_'] =  $this->unidmaymen_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['unimay_'] =  $this->unimay_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['unimen_'] =  $this->unimen_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['costomay_'] =  $this->costomay_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['costomen_'] =  $this->costomen_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['recmayamen_'] =  $this->recmayamen_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['preciomen_'] =  $this->preciomen_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['preciomen2_'] =  $this->preciomen2_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['preciomen3_'] =  $this->preciomen3_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['precio2_'] =  $this->precio2_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['preciomay_'] =  $this->preciomay_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['preciofull_'] =  $this->preciofull_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['stockmay_'] =  $this->stockmay_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['stockmen_'] =  $this->stockmen_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['idgrup_'] =  $this->idgrup_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['idpro1_'] =  $this->idpro1_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['idpro2_'] =  $this->idpro2_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['otro_'] =  $this->otro_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['otro2_'] =  $this->otro2_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['colores_'] =  $this->colores_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['tallas_'] =  $this->tallas_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['sabores_'] =  $this->sabores_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['imagenprod_'] =  $this->imagenprod_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['imagenprod__limpa'] =  $this->imagenprod__limpa; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['imconsumo_'] =  $this->imconsumo_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['escombo_'] =  $this->escombo_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['idcombo_'] =  $this->idcombo_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['precio_editable_'] =  $this->precio_editable_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['fecha_vencimiento_'] =  $this->fecha_vencimiento_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['fecha_fab_'] =  $this->fecha_fab_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['lote_'] =  $this->lote_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['serial_codbarras_'] =  $this->serial_codbarras_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['maneja_tcs_lfs_'] =  $this->maneja_tcs_lfs_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['control_costo_'] =  $this->control_costo_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['por_preciominimo_'] =  $this->por_preciominimo_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['id_marca_'] =  $this->id_marca_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['id_linea_'] =  $this->id_linea_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['ultima_compra_'] =  $this->ultima_compra_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['n_ultcompra_'] =  $this->n_ultcompra_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['ultima_venta_'] =  $this->ultima_venta_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['n_ultventa_'] =  $this->n_ultventa_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['codigobar2_'] =  $this->codigobar2_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['codigobar3_'] =  $this->codigobar3_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['nube_'] =  $this->nube_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['existencia_'] =  $this->existencia_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['multiple_escala_'] =  $this->multiple_escala_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['en_base_a_'] =  $this->en_base_a_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['activo_'] =  $this->activo_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['tipo_producto_'] =  $this->tipo_producto_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['costo_prom_'] =  $this->costo_prom_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['imagen_'] =  $this->imagen_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_productos_contable);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          if (isset($this->nompro_))
          { 
              $SV_nompro_ = $this->nompro_;
          } 
          $this->nm_tira_formatacao();
          ...
          if (isset($SV_nompro_) && $this->nmgp_opcao != "recarga")
          { 
              $this->nompro_ = $SV_nompro_;
          } 
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_productos_contable.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Editar Contable Productos") ?></TITLE>
...
<form name="Fdown" method="get" action="form_productos_contable_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_productos_contable"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_form_productos_contable'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_idiva_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idiva_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['Lookup_idiva_']) && !in_array($this->idiva_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['Lookup_idiva_']))
               {
                   $hasError = true;
    ...
    function ValidateField_cod_cuenta_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->cod_cuenta_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['Lookup_cod_cuenta_']) && !in_array($this->cod_cuenta_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['Lookup_cod_cuenta_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $Campos_Erros['cod_cuenta_'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   ...
                   $this->NM_ajax_info['errList']['cod_cuenta_'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['idprod_']['keyVal'] = form_productos_contable_pack_protect_string($this->nmgp_dados_form['idprod_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_productos_contable[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_productos_contable[$this->nmgp_refresh_row]['codigobar_'] = $this->codigobar_;
                  }
                  if (isset($this->NM_ajax_changed['nompro_']) && $this->NM_ajax_changed['nompro_'])
                  {
                      $this->form_vert_form_productos_contable[$this->nmgp_refresh_row]['nompro_'] = $this->nompro_;
                  }
                  if (isset($this->NM_ajax_changed['idiva_']) && $this->NM_ajax_changed['idiva_'])
                  {
                      $this->form_vert_form_productos_contable[$this->nmgp_refresh_row]['idiva_'] = $this->idiva_;
                  }
                  if (isset($this->NM_ajax_changed['cod_cuenta_']) && $this->NM_ajax_changed['cod_cuenta_'])
                  {
                      $this->form_vert_form_productos_contable[$this->nmgp_refresh_row]['cod_cuenta_'] = $this->cod_cuenta_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_productos_contable as $sc_seq_vert => $aRecData)
          {
...
else
{
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_productos_contable_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_productos_contable_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idiva_' . $sc_seq_vert]['valList'][$i] = form_productos_contable_pack_protect_string($v);
          }
...
$aLookup[] = array(form_productos_contable_pack_protect_string('') => str_replace('<', '&lt;',form_productos_contable_pack_protect_string('Sin Grupo Contable')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['Lookup_cod_cuenta_'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"cod_cuenta_\"";
          if (isset($this->NM_ajax_info['select_html']['cod_cuenta_']) && !empty($this->NM_ajax_info['select_html']['cod_cuenta_']))
          {
              eval("\$sSelComp = \"" . str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['cod_cuenta_']) . "\";");
          }
          $sLookup = '';
          foreach ($aLookup as $aOption)
          {
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['cod_cuenta_' . $sc_seq_vert]['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['cod_cuenta_' . $sc_seq_vert]['valList'][$i] = form_productos_contable_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['codigobar_'] = $this->codigobar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['nompro_'] = $this->nompro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['idiva_'] = $this->idiva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert]['cod_cuenta_'] = $this->cod_cuenta_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "codigobar = '$this->codigobar_', nompro = '$this->nompro_', idiva = $this->idiva_, cod_cuenta = '$this->cod_cuenta_'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $SC_fields_update[] = "imagen = '$this->imagen_'"; 
              } 
              $aDoNotUpdate = array();
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('codigobar_', 'nompro_', 'idiva_', 'cod_cuenta_'), $aDoNotUpdate);
      ...
      { 
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (codigobar, codigoprod, nompro, unimay, unimen, costomay, preciomen, preciomen2, preciomen3, precio2, preciomay, preciofull, idgrup, idpro1, idpro2, idiva, otro, otro2, imagenprod, idcombo, cod_cuenta, ultima_compra, n_ultcompra, ultima_venta, n_ultventa, codigobar2, codigobar3, tipo_producto, imagen $compl_insert) VALUES ('$this->codigobar_', '$this->codigoprod_', '$this->nompro_', '$this->unimay_', '$this->unimen_', $this->costomay_, $this->preciomen_, $this->preciomen2_, $this->preciomen3_, $this->precio2_, $this->preciomay_, $this->preciofull_, $this->idgrup_, $this->idpro1_, $this->idpro2_, $this->idiva_, $this->otro_, $this->otro2_, '$this->imagenprod_', $this->idcombo_, '$this->cod_cuenta_', #$this->ultima_compra_#, '$this->n_ultcompra_', #$this->ultima_venta_#, '$this->n_ultventa_', '$this->codigobar2_', '$this->codigobar3_', '$this->tipo_producto_', '$this->imagen_' $compl_insert_val)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "codigobar, codigoprod, nompro, unimay, unimen, costomay, preciomen, preciomen2, preciomen3, precio2, preciomay, preciofull, idgrup, idpro1, idpro2, idiva, otro, otro2, imagenprod, idcombo, cod_cuenta, ultima_compra, n_ultcompra, ultima_venta, n_ultventa, codigobar2, codigobar3, tipo_producto, imagen $compl_insert) VALUES (" . $NM_seq_auto . "'$this->codigobar_', '$this->codigoprod_', '$this->nompro_', '$this->unimay_', '$this->unimen_', $this->costomay_, $this->preciomen_, $this->preciomen2_, $this->preciomen3_, $this->precio2_, $this->preciomay_, $this->preciofull_, $this->idgrup_, $this->idpro1_, $this->idpro2_, $this->idiva_, $this->otro_, $this->otro2_, EMPTY_BLOB(), $this->idcombo_, '$this->cod_cuenta_', " . $this->Ini->date_delim . $this->ultima_compra_ . $this->Ini->date_delim1 . ", '$this->n_ultcompra_', " . $this->Ini->date_delim . $this->ultima_venta_ . $this->Ini->date_delim1 . ", '$this->n_ultventa_', '$this->codigobar2_', '$this->codigobar3_', '$this->tipo_producto_', '$this->imagen_' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $compl_insert     = ""; 
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_productos_contable_pack_protect_string(NM_charset_to_utf8($this->idiva_)))
              {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_productos_contable_pack_protect_string(NM_charset_to_utf8($this->cod_cuenta_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_cod_cuenta_ = $sLabelTemp;
                  $this->NM_ajax_info['fldList']['cod_cuenta_' . $this->nmgp_refresh_row]['type']    = 'select';
                  ...
                  $this->NM_ajax_info['fldList']['cod_cuenta_' . $this->nmgp_refresh_row]['labList'] = array($tmpLabel_cod_cuenta_);
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['parms'] = "idprod_?#?$this->idprod_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_productos_contable']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_productos_contable = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter'] . ")";
          }
      }
      $sc_where = "";
      if ('' != $sc_where_filter)
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total']))
          {
              ...
              $qt_geral_reg_form_productos_contable = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total'] = $qt_geral_reg_form_productos_contable;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idprod_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_productos_contable = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_productos_contable) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] > $qt_geral_reg_form_productos_contable)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = $qt_geral_reg_form_productos_contable - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = ($qt_geral_reg_form_productos_contable + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['ordem_ord'] = ' asc'; 
      ...
      else
      {
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              $this->por_preciominimo_ = $rs->fields[39] ; 
              ...
              $this->costo_prom_ = $rs->fields[54] ; 
              $this->nmgp_dados_select['costo_prom_'] = $this->costo_prom_;
              $this->imagen_ = $rs->fields[55] ; 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['parms'] = "idprod_?#?$this->idprod_?@?";
              } 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['sub_dir'][0]  = "";
              $this->nm_proc_onload_record($sc_seq_vert);
              $this->storeRecordState($sc_seq_vert);
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_productos_contable[$sc_seq_vert]['codigobar_'] =  $this->codigobar_; 
             $this->form_vert_form_productos_contable[$sc_seq_vert]['nompro_'] =  $this->nompro_; 
          ...
          ksort ($this->form_vert_form_productos_contable); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] < (($qt_geral_reg_form_productos_contable + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['embutida_multi']) 
          { 
          } 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['table_refresh'] = true;
   ...
   else
   {
    ...
    function form_highlight_search_quicksearch(&$result, $field, $value)
    {
        ...
        elseif ($field == $this->nmgp_fast_search && in_array($field, array("codigobar_", "codigoprod_", "nompro_"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['csrf_token'];
    }
...
else
{
   ...
   function Form_lookup_cod_cuenta_()
   {
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['Lookup_cod_cuenta_']))
{
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['empty_filter']);
      ...
      foreach ($fields as $field) {
          if ($field == "SC_all_Cmp" || $field == "codigobar_") 
          {
              $this->SC_monta_condicao($comando, "codigobar", $arg_search, $data_search);
          }
          if ($field == "SC_all_Cmp" || $field == "codigoprod_") 
          {
              $this->SC_monta_condicao($comando, "codigoprod", $arg_search, $data_search);
          }
          if ($field == "SC_all_Cmp" || $field == "nompro_") 
          {
              $this->SC_monta_condicao($comando, "nompro", $arg_search, $data_search);
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_productos_contable = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['total'] = $qt_geral_reg_form_productos_contable;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_productos_contable_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_productos_contable_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_productos_contable_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['masterValue']))
{
