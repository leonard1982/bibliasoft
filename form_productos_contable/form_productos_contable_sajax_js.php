  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_productos_contable" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_productos_contable_form();
	}
  ...
  // ---------- Validate codigobar_
  function do_ajax_form_productos_contable_validate_codigobar_(iNumLinha)
  {
    var nomeCampo_codigobar_ = "codigobar_" + iNumLinha;
    var var_codigobar_ = scAjaxGetFieldHidden(nomeCampo_codigobar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_contable_validate_codigobar_(var_codigobar_, iNumLinha, var_script_case_init, do_ajax_form_productos_contable_validate_codigobar__cb);
  } // do_ajax_form_productos_contable_validate_codigobar_

  function do_ajax_form_productos_contable_validate_codigobar__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_contable_validate_codigobar__cb

  // ---------- Validate nompro_
  function do_ajax_form_productos_contable_validate_nompro_(iNumLinha)
  {
    var nomeCampo_nompro_ = "nompro_" + iNumLinha;
    var var_nompro_ = scAjaxGetFieldHidden(nomeCampo_nompro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_contable_validate_nompro_(var_nompro_, iNumLinha, var_script_case_init, do_ajax_form_productos_contable_validate_nompro__cb);
  } // do_ajax_form_productos_contable_validate_nompro_

  function do_ajax_form_productos_contable_validate_nompro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_contable_validate_nompro__cb

  // ---------- Validate idiva_
  function do_ajax_form_productos_contable_validate_idiva_(iNumLinha)
  {
    var nomeCampo_idiva_ = "idiva_" + iNumLinha;
    var var_idiva_ = scAjaxGetFieldSelect(nomeCampo_idiva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_contable_validate_idiva_(var_idiva_, iNumLinha, var_script_case_init, do_ajax_form_productos_contable_validate_idiva__cb);
  } // do_ajax_form_productos_contable_validate_idiva_

  function do_ajax_form_productos_contable_validate_idiva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_contable_validate_idiva__cb

  // ---------- Validate cod_cuenta_
  function do_ajax_form_productos_contable_validate_cod_cuenta_(iNumLinha)
  {
    var nomeCampo_cod_cuenta_ = "cod_cuenta_" + iNumLinha;
    var var_cod_cuenta_ = scAjaxGetFieldSelect(nomeCampo_cod_cuenta_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_contable_validate_cod_cuenta_(var_cod_cuenta_, iNumLinha, var_script_case_init, do_ajax_form_productos_contable_validate_cod_cuenta__cb);
  } // do_ajax_form_productos_contable_validate_cod_cuenta_

  function do_ajax_form_productos_contable_validate_cod_cuenta__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_productos_contable_validate_cod_cuenta__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_productos_contable_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_productos_contable_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_productos_contable_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_productos_contable_add_new_line_cb);
  } // do_ajax_form_productos_contable_add_new_line

  function do_ajax_form_productos_contable_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("codigobar_=disabled;nompro_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_productos_contable_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_productos_contable_backup_line(iNumLinha)
  {
    var var_idprod_ = scAjaxGetFieldText("idprod_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_productos_contable_backup_line(var_idprod_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_productos_contable_backup_line_cb);
  } // do_ajax_form_productos_contable_backup_line

  function do_ajax_form_productos_contable_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_productos_contable_backup_line_cb

  function do_ajax_form_productos_contable_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_productos_contable_cancel_insert

  function do_ajax_form_productos_contable_cancel_update(iSeqVert)
  {
    do_ajax_form_productos_contable_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_productos_contable_cancel_update

  function do_ajax_form_productos_contable_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_productos_contable_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_productos_contable_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_productos_contable_table_refresh(var_idprod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_contable_table_refresh_cb);
  } //  do_ajax_form_productos_contable_table_refresh

  function do_ajax_form_productos_contable_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_productos_contable_table_refresh_cb_after_alert);
  } // do_ajax_form_productos_contable_table_refresh_cb
  function do_ajax_form_productos_contable_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_productos_contable_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_productos_contable_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_productos_contable_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_codigobar_ = scAjaxGetFieldHidden("codigobar_" + iNumLinha);
    var var_nompro_ = scAjaxGetFieldHidden("nompro_" + iNumLinha);
    var var_idiva_ = scAjaxGetFieldSelect("idiva_" + iNumLinha);
    var var_cod_cuenta_ = scAjaxGetFieldSelect("cod_cuenta_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_productos_contable_submit_form(var_codigobar_, var_nompro_, var_idiva_, var_cod_cuenta_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_productos_contable_submit_form_cb);
  } // do_ajax_form_productos_contable_submit_form

  function do_ajax_form_productos_contable_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_productos_contable_submit_form_cb_after_alert);
  } // do_ajax_form_productos_contable_submit_form_cb
  function do_ajax_form_productos_contable_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_productos_contable_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_productos_contable_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_productos_contable_navigate_form, function() {});
    } else {
      perform_ajax_form_productos_contable_navigate_form();
    }
  }

  function perform_ajax_form_productos_contable_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_productos_contable_navigate_form(var_idprod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_productos_contable_navigate_form_cb);
  } // do_ajax_form_productos_contable_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos_contable']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_productos_contable_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_productos_contable_navigate_form_cb_after_alert);
  } // do_ajax_form_productos_contable_navigate_form_cb
  function do_ajax_form_productos_contable_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_productos_contable_navigate_form_cb_after_alert
  function sc_hide_form_productos_contable_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["idiva_" + iNumLinha] = {"label": "Impuesto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigobar_" + iRow] || "on" == ajax_error_count["nompro_" + iRow] || "on" == ajax_error_count["idiva_" + iRow] || "on" == ajax_error_count["cod_cuenta_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigobar_" + iRow] && "off" == ajax_error_count["nompro_" + iRow] && "off" == ajax_error_count["idiva_" + iRow] && "off" == ajax_error_count["cod_cuenta_" + iRow]))
    {
      if (bErrorRow)
      {
