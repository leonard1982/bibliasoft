...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_iddet_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_iddet__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_detallecompra_new_nc_iddet__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_detallecompra_new_nc_iddet__onfocus(this, iSeqRow) });
  $('#id_sc_field_idfaccom_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_idfaccom__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_detallecompra_new_nc_idfaccom__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_detallecompra_new_nc_idfaccom__onfocus(this, iSeqRow) });
  $('#id_sc_field_idpro_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_idpro__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_detallecompra_new_nc_idpro__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_detallecompra_new_nc_idpro__onfocus(this, iSeqRow) });
  $('#id_sc_field_idbod_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_idbod__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_detallecompra_new_nc_idbod__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_detallecompra_new_nc_idbod__onfocus(this, iSeqRow) });
  $('#id_sc_field_cantidad_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_cantidad__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_detallecompra_new_nc_cantidad__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_detallecompra_new_nc_cantidad__onfocus(this, iSeqRow) });
  $('#id_sc_field_valorunit_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_valorunit__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_detallecompra_new_nc_valorunit__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_detallecompra_new_nc_valorunit__onfocus(this, iSeqRow) });
  $('#id_sc_field_valorpar_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_valorpar__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_detallecompra_new_nc_valorpar__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_detallecompra_new_nc_valorpar__onfocus(this, iSeqRow) });
  $('#id_sc_field_iva_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_iva__onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_detallecompra_new_nc_iva__onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_detallecompra_new_nc_iva__onfocus(this, iSeqRow) });
  $('#id_sc_field_descuento_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_descuento__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_detallecompra_new_nc_descuento__onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_detallecompra_new_nc_descuento__onfocus(this, iSeqRow) });
  $('#id_sc_field_tasaiva_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_tasaiva__onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_detallecompra_new_nc_tasaiva__onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_detallecompra_new_nc_tasaiva__onfocus(this, iSeqRow) });
  $('#id_sc_field_tasadesc_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_tasadesc__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_detallecompra_new_nc_tasadesc__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_detallecompra_new_nc_tasadesc__onfocus(this, iSeqRow) });
  $('#id_sc_field_devuelto_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_devuelto__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_detallecompra_new_nc_devuelto__onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_detallecompra_new_nc_devuelto__onfocus(this, iSeqRow) });
  $('#id_sc_field_colores_' + iSeqRow).bind('change', function() { sc_detallecompra_new_nc_colores__onchange(this, iSeqRow) });
  $('#id_sc_field_tallas_' + iSeqRow).bind('change', function() { sc_detallecompra_new_nc_tallas__onchange(this, iSeqRow) });
  $('#id_sc_field_sabor_' + iSeqRow).bind('change', function() { sc_detallecompra_new_nc_sabor__onchange(this, iSeqRow) });
  $('#id_sc_field_vencimiento_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_vencimiento__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_detallecompra_new_nc_vencimiento__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_detallecompra_new_nc_vencimiento__onfocus(this, iSeqRow) });
  $('#id_sc_field_lote_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_lote__onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_detallecompra_new_nc_lote__onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_detallecompra_new_nc_lote__onfocus(this, iSeqRow) });
  $('#id_sc_field_descr_' + iSeqRow).bind('change', function() { sc_detallecompra_new_nc_descr__onchange(this, iSeqRow) });
  $('#id_sc_field_fecha_fab_' + iSeqRow).bind('change', function() { sc_detallecompra_new_nc_fecha_fab__onchange(this, iSeqRow) });
  $('#id_sc_field_serial_codbarra_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_serial_codbarra__onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_detallecompra_new_nc_serial_codbarra__onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_detallecompra_new_nc_serial_codbarra__onfocus(this, iSeqRow) });
  $('#id_sc_field_porc_desc_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_porc_desc__onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_detallecompra_new_nc_porc_desc__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_presentacion_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_presentacion__onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_detallecompra_new_nc_presentacion__onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_detallecompra_new_nc_presentacion__onfocus(this, iSeqRow) });
  $('#id_sc_field_ver_' + iSeqRow).bind('blur', function() { sc_detallecompra_new_nc_ver__onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_detallecompra_new_nc_ver__onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_detallecompra_new_nc_ver__onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_detallecompra_new_nc_iddet__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_iddet_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_iddet__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_iddet__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_idfaccom__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_idfaccom_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_idfaccom__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_idfaccom__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_idpro__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_idpro_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_idpro__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra_new_nc_event_idpro__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_idpro__onfocus(oThis, iSeqRow) {
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_idbod__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_idbod_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_idbod__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_idbod__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_cantidad__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_cantidad_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_cantidad__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra_new_nc_event_cantidad__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_cantidad__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
  do_ajax_detallecompra_new_nc_event_cantidad__onfocus(iSeqRow);
}

function sc_detallecompra_new_nc_valorunit__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_valorunit_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
  do_ajax_detallecompra_new_nc_event_valorunit__onblur(iSeqRow);
}

function sc_detallecompra_new_nc_valorunit__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra_new_nc_event_valorunit__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_valorunit__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_valorpar__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_valorpar_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_valorpar__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_valorpar__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_iva__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_iva_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_iva__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_iva__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_descuento__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_descuento_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_descuento__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra_new_nc_event_descuento__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_descuento__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_tasaiva__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_tasaiva_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_tasaiva__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_tasaiva__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_tasadesc__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_tasadesc_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_tasadesc__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_tasadesc__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_devuelto__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_devuelto_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_devuelto__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_devuelto__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_colores__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_detallecompra_new_nc_tallas__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_detallecompra_new_nc_sabor__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_detallecompra_new_nc_vencimiento__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_vencimiento_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_vencimiento__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_vencimiento__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_lote__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_lote_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_lote__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_lote__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_descr__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_detallecompra_new_nc_fecha_fab__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_detallecompra_new_nc_serial_codbarra__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_serial_codbarra_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_serial_codbarra__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_serial_codbarra__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_porc_desc__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_porc_desc_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_porc_desc__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra_new_nc_event_porc_desc__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_porc_desc__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_unidad_c__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_detallecompra_new_nc_num_ndevolucion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra_new_nc_cod_barras__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra_new_nc_event_cod_barras__onchange(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_cod_barras__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_presentacion__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_presentacion_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_presentacion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  lookup_presentacion_(iSeqRow);
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_presentacion__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_ver__onblur(oThis, iSeqRow) {
  do_ajax_detallecompra_new_nc_validate_ver_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_detallecompra_new_nc_ver__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_detallecompra_new_nc_ver__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}
...
function scHidePage(pageNo) {
	$("#id_detallecompra_new_nc_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha_fab_" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_detallecompra_new_nc_validate_fecha_fab_(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'detallecompra_new_nc')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
