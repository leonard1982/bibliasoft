...
$old_error_handler = set_error_handler("detallecompra_new_nc_scriptcase_error_handler");

function detallecompra_new_nc_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['detallecompra_new_nc']['contr_erro']) && $_SESSION['scriptcase']['detallecompra_new_nc']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_detallecompra_new_nc->contr_detallecompra_new_nc->Apl_com_erro = true;
            if ($inicial_detallecompra_new_nc->contr_detallecompra_new_nc->NM_ajax_flag)
            {
                $inicial_detallecompra_new_nc->contr_detallecompra_new_nc->NM_ajax_info['errList']['geral_detallecompra_new_nc'][] = $msg;
                return;
            }
            detallecompra_new_nc_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function detallecompra_new_nc_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['detallecompra_new_nc'])  && '' != $_SESSION['scriptcase']['error_icon']['detallecompra_new_nc'])  ? $_SESSION['scriptcase']['error_icon']['detallecompra_new_nc']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['detallecompra_new_nc']) && '' != $_SESSION['scriptcase']['error_span_title']['detallecompra_new_nc']) ? $_SESSION['scriptcase']['error_span_title']['detallecompra_new_nc'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['detallecompra_new_nc']) && '' != $_SESSION['scriptcase']['error_icon_title']['detallecompra_new_nc']) ? $_SESSION['scriptcase']['error_icon_title']['detallecompra_new_nc'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['detallecompra_new_nc']['error_buffer'] .= ob_get_flush();
}
