<?php
@session_start() ;
$_SESSION['scriptcase']['grid_productos_facilweb_importinvtns']['sc_process_barr'] = true;
require_once('../grid_productos_facilweb_importinvtns/index.php');
unset($_SESSION['scriptcase']['grid_productos_facilweb_importinvtns']['sc_process_barr']);
$ExportCtrl = new grid_productos_facilweb_importinvtns_export_control;
$ExportCtrl->Export_barr();

class grid_productos_facilweb_importinvtns_export_control
{
...
<HEAD>
 <TITLE>Lista Productos ya Importados</TITLE>
