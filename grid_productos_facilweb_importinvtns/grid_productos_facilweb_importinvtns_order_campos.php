...
<?php
   ...
   $Ord_Cmp = new grid_productos_facilweb_importinvtns_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_productos_facilweb_importinvtns_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigobar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["codigobar"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["codigobar"] : "Codigo";
   $tab_ger_campos['nompro'] = "on";
   $tab_def_campos['nompro'] = "nompro";
   $tab_labels["nompro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["nompro"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["nompro"] : "Descripcion";
   ...
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["estado"] : "Estado";
   $tab_ger_campos['existenciaentns'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['existenciaentns'] = "existenciaentns";
   }
   else
   {
       $tab_def_campos['existenciaentns'] = "SELECT SUM(EXISTENC) FROM MATERIALSUC WHERE MATID=(SELECT M.MATID FROM MATERIAL M WHERE M.CODIGO='{codigobar}')";
   }
   $tab_labels["existenciaentns"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["existenciaentns"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["existenciaentns"] : "Existencia en TNS";
   $tab_ger_campos['unimen'] = "on";
   $tab_def_campos['unimen'] = "unimen";
   $tab_labels["unimen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["unimen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["unimen"] : "Detal";
   $tab_ger_campos['unimay'] = "on";
   $tab_def_campos['unimay'] = "unimay";
   $tab_labels["unimay"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["unimay"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['labels']["unimay"] : "Mayor";
   $tab_ger_campos['estado'] = "none";
   $tab_ger_campos['existenciaentns'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_productos_facilweb_importinvtns_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_productos_facilweb_importinvtns']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
