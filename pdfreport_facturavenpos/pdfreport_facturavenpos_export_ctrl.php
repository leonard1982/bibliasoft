<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_facturavenpos']['sc_process_barr'] = true;
require_once('../pdfreport_facturavenpos/index.php');
unset($_SESSION['scriptcase']['pdfreport_facturavenpos']['sc_process_barr']);
$ExportCtrl = new pdfreport_facturavenpos_export_control;
$ExportCtrl->Export_barr();

class pdfreport_facturavenpos_export_control
{
