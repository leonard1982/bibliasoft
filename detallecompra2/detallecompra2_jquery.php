...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_iddet' + iSeqRow).bind('change', function() { sc_detallecompra2_iddet_onchange(this, iSeqRow) });
  $('#id_sc_field_idfaccom' + iSeqRow).bind('blur', function() { sc_detallecompra2_idfaccom_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_detallecompra2_idfaccom_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_idbod' + iSeqRow).bind('blur', function() { sc_detallecompra2_idbod_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_detallecompra2_idbod_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_valorpar' + iSeqRow).bind('blur', function() { sc_detallecompra2_valorpar_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_detallecompra2_valorpar_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_iva' + iSeqRow).bind('blur', function() { sc_detallecompra2_iva_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_detallecompra2_iva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_descuento' + iSeqRow).bind('blur', function() { sc_detallecompra2_descuento_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_detallecompra2_descuento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tasaiva' + iSeqRow).bind('blur', function() { sc_detallecompra2_tasaiva_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_detallecompra2_tasaiva_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tasadesc' + iSeqRow).bind('blur', function() { sc_detallecompra2_tasadesc_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_detallecompra2_tasadesc_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_devuelto' + iSeqRow).bind('blur', function() { sc_detallecompra2_devuelto_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_detallecompra2_devuelto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_vencimiento' + iSeqRow).bind('blur', function() { sc_detallecompra2_vencimiento_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_detallecompra2_vencimiento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lote' + iSeqRow).bind('blur', function() { sc_detallecompra2_lote_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_detallecompra2_lote_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_presentacion' + iSeqRow).bind('blur', function() { sc_detallecompra2_presentacion_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_detallecompra2_presentacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_codbarra' + iSeqRow).bind('blur', function() { sc_detallecompra2_codbarra_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_detallecompra2_codbarra_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_mensaje' + iSeqRow).bind('blur', function() { sc_detallecompra2_mensaje_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_detallecompra2_mensaje_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_detallecompra2_mensaje_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_detallecompra2_iddet_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_detallecompra2_idfaccom_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_idfaccom();
  scCssBlur(oThis);
}

function sc_detallecompra2_idfaccom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_idpro_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_idpro();
  scCssBlur(oThis);
}

function sc_detallecompra2_idpro_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra2_event_idpro_onchange();
}
...
function sc_detallecompra2_idbod_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_idbod();
  scCssBlur(oThis);
}

function sc_detallecompra2_idbod_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_valorpar_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_valorpar();
  scCssBlur(oThis);
}

function sc_detallecompra2_valorpar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_iva_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_iva();
  scCssBlur(oThis);
}

function sc_detallecompra2_iva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_descuento_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_descuento();
  scCssBlur(oThis);
}

function sc_detallecompra2_descuento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_tasaiva_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_tasaiva();
  scCssBlur(oThis);
}

function sc_detallecompra2_tasaiva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_tasadesc_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_tasadesc();
  scCssBlur(oThis);
}

function sc_detallecompra2_tasadesc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_devuelto_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_devuelto();
  scCssBlur(oThis);
}

function sc_detallecompra2_devuelto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_colores_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_colores();
  scCssBlur(oThis);
}

function sc_detallecompra2_colores_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra2_event_colores_onchange();
}
...
function sc_detallecompra2_tallas_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_tallas();
  scCssBlur(oThis);
}

function sc_detallecompra2_tallas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra2_event_tallas_onchange();
}
...
function sc_detallecompra2_sabor_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_sabor();
  scCssBlur(oThis);
}

function sc_detallecompra2_sabor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra2_event_sabor_onchange();
}
...
function sc_detallecompra2_vencimiento_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_vencimiento();
  scCssBlur(oThis);
}

function sc_detallecompra2_vencimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_lote_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_lote();
  scCssBlur(oThis);
}

function sc_detallecompra2_lote_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_presentacion_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_presentacion();
  scCssBlur(oThis);
}

function sc_detallecompra2_presentacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_autocompletar_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_autocompletar();
  scCssBlur(oThis);
}

function sc_detallecompra2_autocompletar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_detallecompra2_event_autocompletar_onchange();
}
...
function sc_detallecompra2_codbarra_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_codbarra();
  scCssBlur(oThis);
}

function sc_detallecompra2_codbarra_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_detallecompra2_mensaje_onblur(oThis, iSeqRow) {
  do_ajax_detallecompra2_validate_mensaje();
  scCssBlur(oThis);
}

function sc_detallecompra2_mensaje_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_detallecompra2_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_vencimiento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_detallecompra2_validate_vencimiento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'detallecompra2')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
