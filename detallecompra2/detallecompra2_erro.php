...
$old_error_handler = set_error_handler("detallecompra2_scriptcase_error_handler");

function detallecompra2_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['detallecompra2']['contr_erro']) && $_SESSION['scriptcase']['detallecompra2']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_detallecompra2->contr_detallecompra2->Apl_com_erro = true;
            if ($inicial_detallecompra2->contr_detallecompra2->NM_ajax_flag)
            {
                $inicial_detallecompra2->contr_detallecompra2->NM_ajax_info['errList']['geral_detallecompra2'][] = $msg;
                return;
            }
            detallecompra2_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function detallecompra2_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['detallecompra2'])  && '' != $_SESSION['scriptcase']['error_icon']['detallecompra2'])  ? $_SESSION['scriptcase']['error_icon']['detallecompra2']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['detallecompra2']) && '' != $_SESSION['scriptcase']['error_close']['detallecompra2']) ? $_SESSION['scriptcase']['error_close']['detallecompra2'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['detallecompra2']) && '' != $_SESSION['scriptcase']['error_span_title']['detallecompra2']) ? $_SESSION['scriptcase']['error_span_title']['detallecompra2'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['detallecompra2']) && '' != $_SESSION['scriptcase']['error_icon_title']['detallecompra2']) ? $_SESSION['scriptcase']['error_icon_title']['detallecompra2'] : '';
?>
