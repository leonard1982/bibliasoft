  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_detallecompra2_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_detallecompra2_mob_form();
	}
  ...
  // ---------- Validate autocompletar
  function do_ajax_detallecompra2_mob_validate_autocompletar()
  {
  } // do_ajax_detallecompra2_mob_validate_autocompletar

  function do_ajax_detallecompra2_mob_validate_autocompletar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "autocompletar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_autocompletar_cb

  // ---------- Validate codbarra
  function do_ajax_detallecompra2_mob_validate_codbarra()
  {
    var nomeCampo_codbarra = "codbarra";
    var var_codbarra = scAjaxGetFieldText(nomeCampo_codbarra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_codbarra(var_codbarra, var_script_case_init, do_ajax_detallecompra2_mob_validate_codbarra_cb);
  } // do_ajax_detallecompra2_mob_validate_codbarra

  function do_ajax_detallecompra2_mob_validate_codbarra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codbarra";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_codbarra_cb

  // ---------- Validate presentacion
  function do_ajax_detallecompra2_mob_validate_presentacion()
  {
    var nomeCampo_presentacion = "presentacion";
    var var_presentacion = scAjaxGetFieldText(nomeCampo_presentacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_presentacion(var_presentacion, var_script_case_init, do_ajax_detallecompra2_mob_validate_presentacion_cb);
  } // do_ajax_detallecompra2_mob_validate_presentacion

  function do_ajax_detallecompra2_mob_validate_presentacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "presentacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_presentacion_cb

  // ---------- Validate mensaje
  function do_ajax_detallecompra2_mob_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_detallecompra2_mob_validate_mensaje_cb);
  } // do_ajax_detallecompra2_mob_validate_mensaje

  function do_ajax_detallecompra2_mob_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_mensaje_cb

  // ---------- Validate colores
  function do_ajax_detallecompra2_mob_validate_colores()
  {
    var nomeCampo_colores = "colores";
    var var_colores = scAjaxGetFieldSelect(nomeCampo_colores);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_colores(var_colores, var_script_case_init, do_ajax_detallecompra2_mob_validate_colores_cb);
  } // do_ajax_detallecompra2_mob_validate_colores

  function do_ajax_detallecompra2_mob_validate_colores_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "colores";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_colores_cb

  // ---------- Validate tallas
  function do_ajax_detallecompra2_mob_validate_tallas()
  {
    var nomeCampo_tallas = "tallas";
    var var_tallas = scAjaxGetFieldSelect(nomeCampo_tallas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_tallas(var_tallas, var_script_case_init, do_ajax_detallecompra2_mob_validate_tallas_cb);
  } // do_ajax_detallecompra2_mob_validate_tallas

  function do_ajax_detallecompra2_mob_validate_tallas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tallas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_tallas_cb

  // ---------- Validate sabor
  function do_ajax_detallecompra2_mob_validate_sabor()
  {
    var nomeCampo_sabor = "sabor";
    var var_sabor = scAjaxGetFieldSelect(nomeCampo_sabor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_sabor(var_sabor, var_script_case_init, do_ajax_detallecompra2_mob_validate_sabor_cb);
  } // do_ajax_detallecompra2_mob_validate_sabor

  function do_ajax_detallecompra2_mob_validate_sabor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sabor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_sabor_cb

  // ---------- Validate cantidad
  function do_ajax_detallecompra2_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_detallecompra2_mob_validate_cantidad_cb);
  } // do_ajax_detallecompra2_mob_validate_cantidad

  function do_ajax_detallecompra2_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_cantidad_cb

  // ---------- Validate idbod
  function do_ajax_detallecompra2_mob_validate_idbod()
  {
    var nomeCampo_idbod = "idbod";
    var var_idbod = scAjaxGetFieldSelect(nomeCampo_idbod);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_idbod(var_idbod, var_script_case_init, do_ajax_detallecompra2_mob_validate_idbod_cb);
  } // do_ajax_detallecompra2_mob_validate_idbod

  function do_ajax_detallecompra2_mob_validate_idbod_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbod";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_idbod_cb

  // ---------- Validate valorunit
  function do_ajax_detallecompra2_mob_validate_valorunit()
  {
    var nomeCampo_valorunit = "valorunit";
    var var_valorunit = scAjaxGetFieldText(nomeCampo_valorunit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_valorunit(var_valorunit, var_script_case_init, do_ajax_detallecompra2_mob_validate_valorunit_cb);
  } // do_ajax_detallecompra2_mob_validate_valorunit

  function do_ajax_detallecompra2_mob_validate_valorunit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_valorunit_cb

  // ---------- Validate valorpar
  function do_ajax_detallecompra2_mob_validate_valorpar()
  {
    var nomeCampo_valorpar = "valorpar";
    var var_valorpar = scAjaxGetFieldText(nomeCampo_valorpar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_valorpar(var_valorpar, var_script_case_init, do_ajax_detallecompra2_mob_validate_valorpar_cb);
  } // do_ajax_detallecompra2_mob_validate_valorpar

  function do_ajax_detallecompra2_mob_validate_valorpar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_valorpar_cb

  // ---------- Validate iva
  function do_ajax_detallecompra2_mob_validate_iva()
  {
    var nomeCampo_iva = "iva";
    var var_iva = scAjaxGetFieldText(nomeCampo_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_iva(var_iva, var_script_case_init, do_ajax_detallecompra2_mob_validate_iva_cb);
  } // do_ajax_detallecompra2_mob_validate_iva

  function do_ajax_detallecompra2_mob_validate_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_iva_cb

  // ---------- Validate tasaiva
  function do_ajax_detallecompra2_mob_validate_tasaiva()
  {
    var nomeCampo_tasaiva = "tasaiva";
    var var_tasaiva = scAjaxGetFieldText(nomeCampo_tasaiva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_tasaiva(var_tasaiva, var_script_case_init, do_ajax_detallecompra2_mob_validate_tasaiva_cb);
  } // do_ajax_detallecompra2_mob_validate_tasaiva

  function do_ajax_detallecompra2_mob_validate_tasaiva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tasaiva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_tasaiva_cb

  // ---------- Validate lote
  function do_ajax_detallecompra2_mob_validate_lote()
  {
    var nomeCampo_lote = "lote";
    var var_lote = scAjaxGetFieldText(nomeCampo_lote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_lote(var_lote, var_script_case_init, do_ajax_detallecompra2_mob_validate_lote_cb);
  } // do_ajax_detallecompra2_mob_validate_lote

  function do_ajax_detallecompra2_mob_validate_lote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lote";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_lote_cb

  // ---------- Validate vencimiento
  function do_ajax_detallecompra2_mob_validate_vencimiento()
  {
    var nomeCampo_vencimiento = "vencimiento";
    var var_vencimiento = scAjaxGetFieldText(nomeCampo_vencimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_vencimiento(var_vencimiento, var_script_case_init, do_ajax_detallecompra2_mob_validate_vencimiento_cb);
  } // do_ajax_detallecompra2_mob_validate_vencimiento

  function do_ajax_detallecompra2_mob_validate_vencimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vencimiento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_vencimiento_cb

  // ---------- Validate idfaccom
  function do_ajax_detallecompra2_mob_validate_idfaccom()
  {
    var nomeCampo_idfaccom = "idfaccom";
    var var_idfaccom = scAjaxGetFieldText(nomeCampo_idfaccom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_idfaccom(var_idfaccom, var_script_case_init, do_ajax_detallecompra2_mob_validate_idfaccom_cb);
  } // do_ajax_detallecompra2_mob_validate_idfaccom

  function do_ajax_detallecompra2_mob_validate_idfaccom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_idfaccom_cb

  // ---------- Validate descuento
  function do_ajax_detallecompra2_mob_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldText(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_descuento(var_descuento, var_script_case_init, do_ajax_detallecompra2_mob_validate_descuento_cb);
  } // do_ajax_detallecompra2_mob_validate_descuento

  function do_ajax_detallecompra2_mob_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_descuento_cb

  // ---------- Validate tasadesc
  function do_ajax_detallecompra2_mob_validate_tasadesc()
  {
    var nomeCampo_tasadesc = "tasadesc";
    var var_tasadesc = scAjaxGetFieldText(nomeCampo_tasadesc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_tasadesc(var_tasadesc, var_script_case_init, do_ajax_detallecompra2_mob_validate_tasadesc_cb);
  } // do_ajax_detallecompra2_mob_validate_tasadesc

  function do_ajax_detallecompra2_mob_validate_tasadesc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_tasadesc_cb

  // ---------- Validate devuelto
  function do_ajax_detallecompra2_mob_validate_devuelto()
  {
    var nomeCampo_devuelto = "devuelto";
    var var_devuelto = scAjaxGetFieldText(nomeCampo_devuelto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_devuelto(var_devuelto, var_script_case_init, do_ajax_detallecompra2_mob_validate_devuelto_cb);
  } // do_ajax_detallecompra2_mob_validate_devuelto

  function do_ajax_detallecompra2_mob_validate_devuelto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_devuelto_cb

  // ---------- Validate idpro
  function do_ajax_detallecompra2_mob_validate_idpro()
  {
    var nomeCampo_idpro = "idpro";
    var var_idpro = scAjaxGetFieldSelect(nomeCampo_idpro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_detallecompra2_mob_validate_idpro(var_idpro, var_script_case_init, do_ajax_detallecompra2_mob_validate_idpro_cb);
  } // do_ajax_detallecompra2_mob_validate_idpro

  function do_ajax_detallecompra2_mob_validate_idpro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_validate_idpro_cb

  // ---------- Refresh idpro
  function do_ajax_detallecompra2_mob_refresh_idpro()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_nmgp_refresh_fields = "colores_#fld#_tallas_#fld#_sabor";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detallecompra2_mob_refresh_idpro(var_idpro, var_nmgp_refresh_fields, var_script_case_init, do_ajax_detallecompra2_mob_refresh_idpro_cb);
  } // do_ajax_detallecompra2_mob_refresh_idpro

  function do_ajax_detallecompra2_mob_refresh_idpro_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_detallecompra2_mob_refresh_idpro_cb

  // ---------- Event onchange autocompletar
  function do_ajax_detallecompra2_mob_event_autocompletar_onchange()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_autocompletar = scAjaxGetFieldText("id_ac_autocompletar");
    ...
    var var_valorpar = scAjaxGetFieldText("valorpar");
    ...
    var var_vencimiento = scAjaxGetFieldText("vencimiento");
    var var_presentacion = scAjaxGetFieldText("presentacion");
    var var_codbarra = scAjaxGetFieldText("codbarra");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detallecompra2_mob_event_autocompletar_onchange(var_idpro, var_autocompletar, var_cantidad, var_tasaiva, var_valorunit, var_valorpar, var_iva, var_tasadesc, var_devuelto, var_idbod, var_lote, var_vencimiento, var_presentacion, var_codbarra, var_colores, var_tallas, var_sabor, var_script_case_init, do_ajax_detallecompra2_mob_event_autocompletar_onchange_cb);
  } // do_ajax_detallecompra2_mob_event_autocompletar_onchange

  function do_ajax_detallecompra2_mob_event_autocompletar_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "autocompletar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detallecompra2_mob_event_autocompletar_onchange_cb_after_alert);
  } // do_ajax_detallecompra2_mob_event_autocompletar_onchange_cb
  function do_ajax_detallecompra2_mob_event_autocompletar_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detallecompra2_mob_event_autocompletar_onchange_cb_after_alert

  // ---------- Event onchange cantidad
  function do_ajax_detallecompra2_mob_event_cantidad_onchange()
  {
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_colores = scAjaxGetFieldSelect("colores");
    var var_tallas = scAjaxGetFieldSelect("tallas");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detallecompra2_mob_event_cantidad_onchange(var_idpro, var_colores, var_tallas, var_sabor, var_valorunit, var_cantidad, var_valorpar, var_tasaiva, var_iva, var_script_case_init, do_ajax_detallecompra2_mob_event_cantidad_onchange_cb);
  } // do_ajax_detallecompra2_mob_event_cantidad_onchange

  function do_ajax_detallecompra2_mob_event_cantidad_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detallecompra2_mob_event_cantidad_onchange_cb_after_alert);
  } // do_ajax_detallecompra2_mob_event_cantidad_onchange_cb
  function do_ajax_detallecompra2_mob_event_cantidad_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detallecompra2_mob_event_cantidad_onchange_cb_after_alert

  // ---------- Event onfocus cantidad
  function do_ajax_detallecompra2_mob_event_cantidad_onfocus()
  {
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_codbarra = scAjaxGetFieldText("codbarra");
    var var_presentacion = scAjaxGetFieldText("presentacion");
    ...
    var var_tasaiva = scAjaxGetFieldText("tasaiva");
    var var_idpro = scAjaxGetFieldSelect("idpro");
    var var_autocompletar = scAjaxGetFieldText("autocompletar");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_detallecompra2_mob_event_cantidad_onfocus(var_cantidad, var_codbarra, var_presentacion, var_valorunit, var_tasaiva, var_idpro, var_autocompletar, var_mensaje, var_valorpar, var_iva, var_tasadesc, var_devuelto, var_idbod, var_lote, var_vencimiento, var_script_case_init, do_ajax_detallecompra2_mob_event_cantidad_onfocus_cb);
  } // do_ajax_detallecompra2_mob_event_cantidad_onfocus

  function do_ajax_detallecompra2_mob_event_cantidad_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detallecompra2_mob_event_cantidad_onfocus_cb_after_alert);
  } // do_ajax_detallecompra2_mob_event_cantidad_onfocus_cb
  function do_ajax_detallecompra2_mob_event_cantidad_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detallecompra2_mob_event_cantidad_onfocus_cb_after_alert

  // ---------- Event onchange colores
  function do_ajax_detallecompra2_mob_event_colores_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detallecompra2_mob_event_colores_onchange(var_script_case_init, do_ajax_detallecompra2_mob_event_colores_onchange_cb);
  } // do_ajax_detallecompra2_mob_event_colores_onchange

  function do_ajax_detallecompra2_mob_event_colores_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "colores";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detallecompra2_mob_event_colores_onchange_cb_after_alert);
  } // do_ajax_detallecompra2_mob_event_colores_onchange_cb
  function do_ajax_detallecompra2_mob_event_colores_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detallecompra2_mob_event_colores_onchange_cb_after_alert

  // ---------- Event onchange idpro
  function do_ajax_detallecompra2_mob_event_idpro_onchange()
  {
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_tasaiva = scAjaxGetFieldText("tasaiva");
    var var_valorunit = scAjaxGetFieldText("valorunit");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detallecompra2_mob_event_idpro_onchange(var_cantidad, var_tasaiva, var_valorunit, var_valorpar, var_iva, var_tasadesc, var_devuelto, var_idbod, var_lote, var_vencimiento, var_presentacion, var_idpro, var_colores, var_tallas, var_sabor, var_script_case_init, do_ajax_detallecompra2_mob_event_idpro_onchange_cb);
  } // do_ajax_detallecompra2_mob_event_idpro_onchange

  function do_ajax_detallecompra2_mob_event_idpro_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detallecompra2_mob_event_idpro_onchange_cb_after_alert);
  } // do_ajax_detallecompra2_mob_event_idpro_onchange_cb
  function do_ajax_detallecompra2_mob_event_idpro_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_detallecompra2_mob_refresh_idpro();
    scAjaxRedir();
  } // do_ajax_detallecompra2_mob_event_idpro_onchange_cb_after_alert

  // ---------- Event onchange sabor
  function do_ajax_detallecompra2_mob_event_sabor_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detallecompra2_mob_event_sabor_onchange(var_script_case_init, do_ajax_detallecompra2_mob_event_sabor_onchange_cb);
  } // do_ajax_detallecompra2_mob_event_sabor_onchange

  function do_ajax_detallecompra2_mob_event_sabor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sabor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detallecompra2_mob_event_sabor_onchange_cb_after_alert);
  } // do_ajax_detallecompra2_mob_event_sabor_onchange_cb
  function do_ajax_detallecompra2_mob_event_sabor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detallecompra2_mob_event_sabor_onchange_cb_after_alert

  // ---------- Event onchange tallas
  function do_ajax_detallecompra2_mob_event_tallas_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detallecompra2_mob_event_tallas_onchange(var_script_case_init, do_ajax_detallecompra2_mob_event_tallas_onchange_cb);
  } // do_ajax_detallecompra2_mob_event_tallas_onchange

  function do_ajax_detallecompra2_mob_event_tallas_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tallas";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detallecompra2_mob_event_tallas_onchange_cb_after_alert);
  } // do_ajax_detallecompra2_mob_event_tallas_onchange_cb
  function do_ajax_detallecompra2_mob_event_tallas_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detallecompra2_mob_event_tallas_onchange_cb_after_alert

  // ---------- Event onchange valorunit
  function do_ajax_detallecompra2_mob_event_valorunit_onchange()
  {
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_valorpar = scAjaxGetFieldText("valorpar");
    var var_valorunit = scAjaxGetFieldText("valorunit");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_detallecompra2_mob_event_valorunit_onchange(var_cantidad, var_valorpar, var_valorunit, var_tasaiva, var_iva, var_script_case_init, do_ajax_detallecompra2_mob_event_valorunit_onchange_cb);
  } // do_ajax_detallecompra2_mob_event_valorunit_onchange

  function do_ajax_detallecompra2_mob_event_valorunit_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "valorunit";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_detallecompra2_mob_event_valorunit_onchange_cb_after_alert);
  } // do_ajax_detallecompra2_mob_event_valorunit_onchange_cb
  function do_ajax_detallecompra2_mob_event_valorunit_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_detallecompra2_mob_event_valorunit_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_detallecompra2_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_detallecompra2_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_autocompletar = scAjaxGetFieldText("autocompletar");
    ...
    var var_lote = scAjaxGetFieldText("lote");
    var var_vencimiento = scAjaxGetFieldText("vencimiento");
    var var_idfaccom = scAjaxGetFieldText("idfaccom");
    ...
    scAjaxProcOn();
    x_ajax_detallecompra2_mob_submit_form(var_autocompletar, var_codbarra, var_presentacion, var_mensaje, var_colores, var_tallas, var_sabor, var_cantidad, var_idbod, var_valorunit, var_valorpar, var_iva, var_tasaiva, var_lote, var_vencimiento, var_idfaccom, var_descuento, var_tasadesc, var_devuelto, var_idpro, var_iddet, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_detallecompra2_mob_submit_form_cb);
  } // do_ajax_detallecompra2_mob_submit_form

  function do_ajax_detallecompra2_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("autocompletar");
      scAjaxHideErrorDisplay("codbarra");
      ...
      scAjaxHideErrorDisplay("vencimiento");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_detallecompra2_mob_submit_form_cb_after_alert);
  } // do_ajax_detallecompra2_mob_submit_form_cb
  function do_ajax_detallecompra2_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_detallecompra2_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_detallecompra2_mob_navigate_form()
  {
    perform_ajax_detallecompra2_mob_navigate_form();
  }

  function perform_ajax_detallecompra2_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_detallecompra2_mob_navigate_form(var_iddet, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_detallecompra2_mob_navigate_form_cb);
  } // do_ajax_detallecompra2_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra2_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_detallecompra2_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_detallecompra2_mob_navigate_form_cb_after_alert);
  } // do_ajax_detallecompra2_mob_navigate_form_cb
  function do_ajax_detallecompra2_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_detallecompra2_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_detallecompra2_mob_navigate_form_cb_after_alert
  function sc_hide_detallecompra2_mob_form()
  {
  ...
  ajax_field_list[0] = "autocompletar";
  ajax_field_list[1] = "codbarra";
  ajax_field_list[2] = "presentacion";
  ajax_field_list[3] = "mensaje";
  ajax_field_list[4] = "colores";
  ajax_field_list[5] = "tallas";
  ajax_field_list[6] = "sabor";
  ajax_field_list[7] = "cantidad";
  ajax_field_list[8] = "idbod";
  ajax_field_list[9] = "valorunit";
  ajax_field_list[10] = "valorpar";
  ajax_field_list[11] = "iva";
  ajax_field_list[12] = "tasaiva";
  ajax_field_list[13] = "lote";
  ajax_field_list[14] = "vencimiento";
  ajax_field_list[15] = "idfaccom";
  ajax_field_list[16] = "descuento";
  ajax_field_list[17] = "tasadesc";
  ajax_field_list[18] = "devuelto";
  ajax_field_list[19] = "idpro";
  ...
  var ajax_error_list = {
    "autocompletar": {"label": "Buscar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codbarra": {"label": "Codigo de Barras", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "valorunit": {"label": "Costo unitario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valorpar": {"label": "Subtotal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "iva": {"label": "Valor IVA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tasaiva": {"label": "Tasa IVA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lote": {"label": "Lote", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vencimiento": {"label": "Vence", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["autocompletar"][1] = "autocompletar";
  ajax_field_mult["codbarra"][1] = "codbarra";
  ...
  ajax_field_mult["vencimiento"][1] = "vencimiento";
  ...
  var ajax_field_id = {
    "autocompletar": new Array("hidden_field_label_autocompletar", "hidden_field_data_autocompletar"),
    "codbarra": new Array("hidden_field_label_codbarra", "hidden_field_data_codbarra"),
    ...
    "tasaiva": new Array("hidden_field_label_tasaiva", "hidden_field_data_tasaiva"),
    "lote": new Array("hidden_field_label_lote", "hidden_field_data_lote"),
    "vencimiento": new Array("hidden_field_label_vencimiento", "hidden_field_data_vencimiento")
  };
