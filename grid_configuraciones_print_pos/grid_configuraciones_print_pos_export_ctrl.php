<?php
@session_start() ;
$_SESSION['scriptcase']['grid_configuraciones_print_pos']['sc_process_barr'] = true;
require_once('../grid_configuraciones_print_pos/index.php');
unset($_SESSION['scriptcase']['grid_configuraciones_print_pos']['sc_process_barr']);
$ExportCtrl = new grid_configuraciones_print_pos_export_control;
$ExportCtrl->Export_barr();

class grid_configuraciones_print_pos_export_control
{
