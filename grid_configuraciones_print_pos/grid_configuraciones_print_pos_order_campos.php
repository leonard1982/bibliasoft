<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_configuraciones_print_pos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_configuraciones_print_pos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_configuraciones_print_pos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['idconfprintpos'] = "on";
   $tab_def_campos['idconfprintpos'] = "idconfprintpos";
   $tab_labels["idconfprintpos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["idconfprintpos"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["idconfprintpos"] : "Id";
   $tab_ger_campos['tipo_doc'] = "on";
   $tab_def_campos['tipo_doc'] = "tipo_doc";
   $tab_labels["tipo_doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["tipo_doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["tipo_doc"] : "Tipo Doc";
   $tab_ger_campos['texto_tamanio'] = "on";
   $tab_def_campos['texto_tamanio'] = "texto_tamanio";
   $tab_labels["texto_tamanio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["texto_tamanio"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["texto_tamanio"] : "Tamaño Texto";
   $tab_ger_campos['porcentajeopx'] = "on";
   $tab_def_campos['porcentajeopx'] = "porcentajeopx";
   $tab_labels["porcentajeopx"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["porcentajeopx"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["porcentajeopx"] : "% o PX";
   $tab_ger_campos['texto_fuente'] = "on";
   $tab_def_campos['texto_fuente'] = "texto_fuente";
   $tab_labels["texto_fuente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["texto_fuente"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["texto_fuente"] : "Fuente";
   $tab_ger_campos['logo'] = "on";
   $tab_def_campos['logo'] = "logo";
   $tab_labels["logo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["logo"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["logo"] : "Logo";
   $tab_ger_campos['texto_cabecera'] = "on";
   $tab_def_campos['texto_cabecera'] = "texto_cabecera";
   $tab_labels["texto_cabecera"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["texto_cabecera"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["texto_cabecera"] : "Texto Cabecera";
   $tab_ger_campos['texto_pie'] = "on";
   $tab_def_campos['texto_pie'] = "texto_pie";
   $tab_labels["texto_pie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["texto_pie"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["texto_pie"] : "Texto Pie";
   $tab_ger_campos['archo_ticket'] = "on";
   $tab_def_campos['archo_ticket'] = "archo_ticket";
   $tab_labels["archo_ticket"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["archo_ticket"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["archo_ticket"] : "Archo Ticket";
   $tab_ger_campos['ticket_pjopx'] = "on";
   $tab_def_campos['ticket_pjopx'] = "ticket_pjopx";
   $tab_labels["ticket_pjopx"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["ticket_pjopx"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["ticket_pjopx"] : "% o PX ";
   $tab_ger_campos['predeterminada'] = "on";
   $tab_def_campos['predeterminada'] = "predeterminada";
   $tab_labels["predeterminada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["predeterminada"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["predeterminada"] : "Predeterminada";
   $tab_ger_campos['tipo_vista'] = "on";
   $tab_def_campos['tipo_vista'] = "tipo_vista";
   $tab_labels["tipo_vista"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["tipo_vista"])) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['labels']["tipo_vista"] : "Tipo Vista";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_configuraciones_print_pos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_configuraciones_print_pos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
