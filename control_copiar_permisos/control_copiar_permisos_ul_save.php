 ...
 */
   ...
   // scriptcase
   include_once('control_copiar_permisos_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['control_copiar_permisos']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['control_copiar_permisos']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['control_copiar_permisos']['upload_field_info'][ $_POST['param_field'] ];
