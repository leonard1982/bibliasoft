...
@session_start() ;
class control_copiar_permisos_help
{
...
<?php echo "<b>Adicionar Permisos</b><br>" . nl2br("Adiciona los permisos faltantes al usuario destino desde el usuario origen, sino está activada esta opción reemplaza los permisos del usuario destino"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new control_copiar_permisos_help();
?>
