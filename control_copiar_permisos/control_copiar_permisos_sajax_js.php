  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_copiar_permisos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_copiar_permisos_form();
	}
...
?>
  ...
  // ---------- Validate usuario_origen
  function do_ajax_control_copiar_permisos_validate_usuario_origen()
  {
    var nomeCampo_usuario_origen = "usuario_origen";
    var var_usuario_origen = scAjaxGetFieldSelect(nomeCampo_usuario_origen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_permisos_validate_usuario_origen(var_usuario_origen, var_script_case_init, do_ajax_control_copiar_permisos_validate_usuario_origen_cb);
  } // do_ajax_control_copiar_permisos_validate_usuario_origen

  function do_ajax_control_copiar_permisos_validate_usuario_origen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_origen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_permisos_validate_usuario_origen_cb

  // ---------- Validate usuario_destino
  function do_ajax_control_copiar_permisos_validate_usuario_destino()
  {
    var nomeCampo_usuario_destino = "usuario_destino";
    var var_usuario_destino = scAjaxGetFieldSelect(nomeCampo_usuario_destino);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_permisos_validate_usuario_destino(var_usuario_destino, var_script_case_init, do_ajax_control_copiar_permisos_validate_usuario_destino_cb);
  } // do_ajax_control_copiar_permisos_validate_usuario_destino

  function do_ajax_control_copiar_permisos_validate_usuario_destino_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_destino";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_permisos_validate_usuario_destino_cb

  // ---------- Validate adicionar
  function do_ajax_control_copiar_permisos_validate_adicionar()
  {
    var nomeCampo_adicionar = "adicionar";
    var var_adicionar = scAjaxGetFieldCheckbox(nomeCampo_adicionar, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_copiar_permisos_validate_adicionar(var_adicionar, var_script_case_init, do_ajax_control_copiar_permisos_validate_adicionar_cb);
  } // do_ajax_control_copiar_permisos_validate_adicionar

  function do_ajax_control_copiar_permisos_validate_adicionar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "adicionar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_copiar_permisos_validate_adicionar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_copiar_permisos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_copiar_permisos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_usuario_origen = scAjaxGetFieldSelect("usuario_origen");
    var var_usuario_destino = scAjaxGetFieldSelect("usuario_destino");
    var var_adicionar = scAjaxGetFieldCheckbox("adicionar", ";");
    ...
    scAjaxProcOn();
    x_ajax_control_copiar_permisos_submit_form(var_usuario_origen, var_usuario_destino, var_adicionar, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_copiar_permisos_submit_form_cb);
  } // do_ajax_control_copiar_permisos_submit_form

  function do_ajax_control_copiar_permisos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_copiar_permisos_submit_form_cb_after_alert);
  } // do_ajax_control_copiar_permisos_submit_form_cb
  function do_ajax_control_copiar_permisos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_copiar_permisos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_copiar_permisos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_copiar_permisos_navigate_form, function() {});
    } else {
      perform_ajax_control_copiar_permisos_navigate_form();
    }
  }

  function perform_ajax_control_copiar_permisos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_copiar_permisos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_copiar_permisos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_copiar_permisos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_copiar_permisos_navigate_form_cb_after_alert);
  } // do_ajax_control_copiar_permisos_navigate_form_cb
  function do_ajax_control_copiar_permisos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_copiar_permisos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_copiar_permisos_navigate_form_cb_after_alert
  function sc_hide_control_copiar_permisos_form()
  {
  ...
  ajax_field_list[0] = "usuario_origen";
  ajax_field_list[1] = "usuario_destino";
  ajax_field_list[2] = "adicionar";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "usuario_origen": {"label": "Usuario Origen", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_destino": {"label": "Usuario Destino", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "adicionar": {"label": "Adicionar Permisos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "usuario_origen": new Array(),
    "usuario_destino": new Array(),
    "adicionar": new Array()
  };
  ajax_field_mult["usuario_origen"][1] = "usuario_origen";
  ajax_field_mult["usuario_destino"][1] = "usuario_destino";
  ajax_field_mult["adicionar"][1] = "adicionar";

  var ajax_field_id = {
    "usuario_origen": new Array("hidden_field_label_usuario_origen", "hidden_field_data_usuario_origen"),
    "usuario_destino": new Array("hidden_field_label_usuario_destino", "hidden_field_data_usuario_destino"),
    "adicionar": new Array("hidden_field_label_adicionar", "hidden_field_data_adicionar")
  };
