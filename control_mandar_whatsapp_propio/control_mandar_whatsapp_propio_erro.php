...
$old_error_handler = set_error_handler("control_mandar_whatsapp_propio_scriptcase_error_handler");

function control_mandar_whatsapp_propio_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['control_mandar_whatsapp_propio']['contr_erro']) && $_SESSION['scriptcase']['control_mandar_whatsapp_propio']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_control_mandar_whatsapp_propio->contr_control_mandar_whatsapp_propio->Apl_com_erro = true;
            if ($inicial_control_mandar_whatsapp_propio->contr_control_mandar_whatsapp_propio->NM_ajax_flag)
            {
                $inicial_control_mandar_whatsapp_propio->contr_control_mandar_whatsapp_propio->NM_ajax_info['errList']['geral_control_mandar_whatsapp_propio'][] = $msg;
                return;
            }
            control_mandar_whatsapp_propio_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function control_mandar_whatsapp_propio_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['control_mandar_whatsapp_propio'])  && '' != $_SESSION['scriptcase']['error_icon']['control_mandar_whatsapp_propio'])  ? $_SESSION['scriptcase']['error_icon']['control_mandar_whatsapp_propio']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['control_mandar_whatsapp_propio']) && '' != $_SESSION['scriptcase']['error_close']['control_mandar_whatsapp_propio']) ? $_SESSION['scriptcase']['error_close']['control_mandar_whatsapp_propio'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['control_mandar_whatsapp_propio']) && '' != $_SESSION['scriptcase']['error_span_title']['control_mandar_whatsapp_propio']) ? $_SESSION['scriptcase']['error_span_title']['control_mandar_whatsapp_propio'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['control_mandar_whatsapp_propio']) && '' != $_SESSION['scriptcase']['error_icon_title']['control_mandar_whatsapp_propio']) ? $_SESSION['scriptcase']['error_icon_title']['control_mandar_whatsapp_propio'] : '';
?>
