<?php
@session_start() ;
$_SESSION['scriptcase']['grid_remi']['sc_process_barr'] = true;
require_once('../grid_remi/index.php');
unset($_SESSION['scriptcase']['grid_remi']['sc_process_barr']);
$ExportCtrl = new grid_remi_export_control;
$ExportCtrl->Export_barr();

class grid_remi_export_control
{
