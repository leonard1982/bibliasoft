...
//  
   ...
   {   
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "SELECT nombres + \"  \" + documento  FROM terceros where idtercero = $vendedor order by nombres, documento" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT concat(nombres,\"  \", documento)  FROM terceros where idtercero = $vendedor order by nombres, documento" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "SELECT nombres&\"  \"&documento  FROM terceros where idtercero = $vendedor order by nombres, documento" ; 
