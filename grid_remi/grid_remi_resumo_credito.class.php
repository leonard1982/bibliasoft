...
class grid_remi_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_credito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['arr_total']['credito'];
      }
      else
      {
          $this->array_total_credito = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['arr_total']['credito'] = $this->array_total_credito;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_order']['credito']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_order']['credito'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_order']['credito'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_display']['credito'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_display']['credito'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_display']['credito'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_display']['credito'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_display']['credito'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_display']['credito'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_remi']['summarizing_fields_display']['credito'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_credito as $i_credito => $d_credito) {
           if (!in_array($i_credito, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_credito[4] ] = $d_credito[3];
               $this->comp_label[0][ $d_credito[4] ] = $d_credito[3];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $quebra_credito, $quebra_credito_orig)
   {
      //----- Crédito
      if (!isset($this->array_total_credito[$quebra_credito_orig]))
      {
         ...
         $this->array_total_credito[$quebra_credito_orig][2] = 1;
         $this->array_total_credito[$quebra_credito_orig][3] = $quebra_credito;
         $this->array_total_credito[$quebra_credito_orig][4] = $quebra_credito_orig;
      }
      else
      {
         $this->array_total_credito[$quebra_credito_orig][0]++;
         $this->array_total_credito[$quebra_credito_orig][1] += $sum_total;
         $this->array_total_credito[$quebra_credito_orig][2]++;
      }
   }
...
$_SESSION['scriptcase']['grid_remi']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->credito, $this->credito_orig);
            }
   }
//
