...
?>
      ...
      <TD id='SC_nremision_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nremision'])) ? $this->New_label['nremision'] : "Re. #"; ?></TD>
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nremision" id="id_ac_nremision" name="nremision_autocomp"><?php if ('' !=  $nremision) { ?><option value="<?php echo $nremision ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
      ...
      <TD id='SC_numfacven_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "No.factura"; ?></TD>
     <TD class="scFilterFieldOdd"> 
