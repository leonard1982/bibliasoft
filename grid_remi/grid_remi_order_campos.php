<?php
   include_once('grid_remi_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_remi']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_remi']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_remi']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_remi']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_remi_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_remi_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_remi_json.php");
   }
   ...
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["resolucion"] : "Prefijo";
   $tab_ger_campos['nremision'] = "on";
   $tab_def_campos['nremision'] = "nremision";
   $tab_labels["nremision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["nremision"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["nremision"] : "Re. #";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["numfacven"] : "No.factura";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["total"] : "Total Venta";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["credito"] : "Crédito";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["fechavenc"] : "Vencimiento";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["vendedor"] : "Vendedor";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['labels']["imprimir"] : "imprimir";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_remi']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_remi']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_remi']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
<HEAD>
 <TITLE>Remisiones de Venta</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_remi_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_remi']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
