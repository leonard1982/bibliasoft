<?php
@session_start() ;
$_SESSION['scriptcase']['form_hacerpagos_seleccionar_cuenta']['sc_process_barr'] = true;
require_once('../form_hacerpagos_seleccionar_cuenta/index.php');
unset($_SESSION['scriptcase']['form_hacerpagos_seleccionar_cuenta']['sc_process_barr']);
$ExportCtrl = new form_hacerpagos_seleccionar_cuenta_export_control;
$ExportCtrl->Export_barr();

class form_hacerpagos_seleccionar_cuenta_export_control
{
