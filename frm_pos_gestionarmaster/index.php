<?php
   include_once('frm_pos_gestionarmaster_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class frm_pos_gestionarmaster_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "frm_pos_gestionarmaster"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['frm_pos_gestionarmaster']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['frm_pos_gestionarmaster']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/frm_pos_gestionarmaster';
      ...
      $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['actual_lang']) || $_SESSION['scriptcase']['frm_pos_gestionarmaster']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['frm_pos_gestionarmaster']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("frm_pos_gestionarmaster_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["frm_pos_gestionarmaster"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["frm_pos_gestionarmaster"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "frm_pos_gestionarmaster_erro.class.php"); 
      $this->Erro = new frm_pos_gestionarmaster_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('frm_pos_gestionarmaster'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao']) && $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_perfil']) && $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['embutida_init']) 
      {
...
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv_2022', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['frm_pos_gestionarmaster']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class frm_pos_gestionarmaster_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new frm_pos_gestionarmaster_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['frm_pos_gestionarmaster']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['frm_pos_gestionarmaster']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['frm_pos_gestionarmaster']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['frm_pos_gestionarmaster'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['frm_pos_gestionarmaster']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['frm_pos_gestionarmaster']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('frm_pos_gestionarmaster') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['frm_pos_gestionarmaster']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "frm_pos_gestionarmaster")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['frm_pos_gestionarmaster']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['frm_pos_gestionarmaster']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['frm_pos_gestionarmaster']['exit'];
      ...
      include_once($this->Ini->path_aplicacao . 'baseDeDatos.php');
      $this->nm_data = new nm_data("es");
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "frm_pos_gestionarmaster_erro.class.php"); 
      $this->Erro      = new frm_pos_gestionarmaster_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['frm_pos_gestionarmaster']['contr_erro'] = 'on';
  ...
  if(isset($_POST['accion']))
{
	...
	if(isset($_POST['banco']))
	{
      ...
      $nm_select = "select u.banco_movil from usuarios u where u.tercero='".$this->sc_temp_gidtercero."'"; 
...
;
	...
	{
		if(!empty($this->vcajapredeterminada[0][0]) and $this->vcajapredeterminada[0][0]>0)
		{
      ...
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vCajaPredeterminada2 = array();
      $this->vcajapredeterminada2 = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vCajaPredeterminada2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vcajapredeterminada2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vCajaPredeterminada2 = false;
          $this->vCajaPredeterminada2_erro = $this->Db->ErrorMsg();
          $this->vcajapredeterminada2 = false;
          $this->vcajapredeterminada2_erro = $this->Db->ErrorMsg();
      } 
;
	
	if(isset($this->vcajapredeterminada2[0][0]))
	{
		if(!empty($this->vcajapredeterminada2[0][0]) and $this->vcajapredeterminada2[0][0]>0)
		{
			$vbanco = $this->vcajapredeterminada2[0][0];
		}
	}
...
;
	...
	$codcliente = "";
      ...
      $nm_select = "select idtercero,documento from terceros where documento='".$nitcliente."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vValidaTercero = array();
      $this->vvalidatercero = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vValidaTercero[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vvalidatercero[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vValidaTercero = false;
          $this->vValidaTercero_erro = $this->Db->ErrorMsg();
          $this->vvalidatercero = false;
          $this->vvalidatercero_erro = $this->Db->ErrorMsg();
      } 
;
	
	if(isset($this->vvalidatercero[0][0]))
	{
		$codcliente = $this->vvalidatercero[0][1];
		$idtercero  = $this->vvalidatercero[0][0];
		
		$vsql = "select coalesce(max(numfacven),0) from facturaven where resolucion='".$pj."'";

		 
      $nm_select = $vsql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vUltimoNumero = array();
      $this->vultimonumero = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vUltimoNumero[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vultimonumero[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vUltimoNumero = false;
          $this->vUltimoNumero_erro = $this->Db->ErrorMsg();
          $this->vultimonumero = false;
          $this->vultimonumero_erro = $this->Db->ErrorMsg();
      } 
;
      ...
      $nm_select = "select primerfactura from resdian where Idres='".$pj."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vPrimeraFV = array();
      $this->vprimerafv = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vPrimeraFV[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vprimerafv[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vPrimeraFV = false;
          $this->vPrimeraFV_erro = $this->Db->ErrorMsg();
          $this->vprimerafv = false;
          $this->vprimerafv_erro = $this->Db->ErrorMsg();
      } 
;
					if(isset($this->vprimerafv[0][0]))
					{
						$numero = $this->vprimerafv[0][0];
					}
				}
				else
				{
					$numero = $this->vultimonumero[0][0]+1;
				}
				
				$fecha = date("Y-m-d");

				$vsql2 = "INSERT INTO facturaven set numfacven='".$numero."',credito='2',fechaven='".$fecha."',idcli='".$idtercero."',formapago='EFECTIVO',vendedor='".$this->sc_temp_gidtercero."',resolucion='".$pj."',asentada='0',pagada='NO',espos='SI',subtotal='0',valoriva='0',total='0',banco='".$vbanco."',tipo='".$vtipodoc."',observaciones='TEMPORAL',aplica_propina='".$vaplica_propina."'";
     ...
     $nm_select = $vsql2; 
      ...
      ;
				...
				$vsql3 = "select max(idfacven) from facturaven where vendedor='".$this->sc_temp_gidtercero."' and resolucion='".$pj."'";

				 
      $nm_select = $vsql3; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vUltimoId = array();
      $this->vultimoid = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vUltimoId[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vultimoid[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vUltimoId = false;
          $this->vUltimoId_erro = $this->Db->ErrorMsg();
          $this->vultimoid = false;
          $this->vultimoid_erro = $this->Db->ErrorMsg();
      } 
;

				if(isset($this->vultimoid[0][0]))
				{

					$idfactura = $this->vultimoid[0][0];
				}
			}
			else
			{
				
				$vsql3 = "select v.idfacven,c.nombres,v.total,concat(p.prefijo,'/',v.numfacven) as numero,v.fechaven from facturaven v left join terceros c on v.idcli=c.idtercero left join resdian p on v.resolucion=p.Idres where v.numfacven='".$numero."' and v.vendedor='".$this->sc_temp_gidtercero."' and v.resolucion='".$pj."'";
...
;
				...
				if(isset($this->vinfodoc[0][0]))
				{
					...
					$vsql = "delete from caja where documento='".$vidfacven."'";
     ...
     $nm_select = $vsql; 
      ...
      ;
					...
					$vsql2 = "delete from facturaven where idfacven='".$vidfacven."'";
     ...
     $nm_select = "insert into log set usuario='".$this->sc_temp_gidtercero."',accion='ELIMINAR',observaciones='EL USUARIO ELIMINÓ LA VENTA: ".$vnumdoc.", CLIENTE: ".$vnomcli.", FECHA VENTA: ".$vfechaven.", TOTAL: ".$vtot."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	echo json_encode(array(
		...
		"idfactura" => $idfactura,
		"sqlinsert" => $vsql2,
		"resolucion"=> $this->sc_temp_gidresolucion,
		"vendedor"  => $this->sc_temp_gidtercero,
		"vsql"      => $vsql,
		"vsql3"     => $vsql3,
		"pj"        => $pj,
...
if(isset($_POST['pagarfacven'])){
    
    $idfactura  = $_POST['idfactura'];
	$formapago  = $_POST['formapago'];
	$sipropina  = $_POST['sipropina'];
	$this->fPagarFacVen($idfactura,$formapago,true,0,$sipropina);
}

if(isset($_POST['asentarfacven']))
{
    
    $idfactura  = $_POST['idfactura'];
	$pagado     = $_POST['pagado'];
	$vueltos    = $_POST['vueltos'];
	$asentar    = $_POST['asentar'];
	
		
	$this->fAsentar($idfactura,$asentar,$pagado,$vueltos,true,false);
}
...
;
	...
	if(isset($this->vconfiguraciones[0][0]))
	{
      ...
      $nm_select = "select (select c.nombres from terceros c where c.idtercero=f.idcli),(select c.documento from terceros c where c.idtercero=f.idcli),dias_decredito, f.total from facturaven f where f.idfacven='".$idfactura."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vclienteanterior = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          $nm_count = $SCrx->FieldCount();
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vclienteanterior[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vclienteanterior = false;
          $this->vclienteanterior_erro = $this->Db->ErrorMsg();
      } 
;
	
	if(isset($this->vclienteanterior[0][0]))
	{
		$clienteanterior    = $this->vclienteanterior[0][0];
		$nitclienteanterior = $this->vclienteanterior[0][1];
		$diasanteriores     = $this->vclienteanterior[0][2];
		$vtotal             = $this->vclienteanterior[0][3];
	}
	
	 
      $nm_select = "select idtercero,listaprecios,porcentaje_propina_sugerida from terceros where documento='".$identificacion."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vValidaTercero = array();
      $this->vvalidatercero = array();
...
;
	...
	if(isset($this->vvalidatercero[0][0]))
	{
		$nombrecliente = $this->vvalidatercero[0][0];
		$vidtercero    = $this->vvalidatercero[0][0];
		$vlistacliente = $this->vvalidatercero[0][1];
		if(intval($this->vvalidatercero[0][2])>0)
		{
			$vporcentaje_propina_sugerida = $this->vvalidatercero[0][2];
		}
		
		if($formapago==1)
		{
			 
      $nm_select = "select credito,dias_credito,cupo,porcentaje_propina_sugerida from terceros where idtercero='".$this->vvalidatercero[0][0] ."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiCredito = array();
      $this->vsicredito = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiCredito[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsicredito[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiCredito = false;
          $this->vSiCredito_erro = $this->Db->ErrorMsg();
          $this->vsicredito = false;
          $this->vsicredito_erro = $this->Db->ErrorMsg();
      } 
;
			
			if(isset($this->vsicredito[0][0]))
			{
				$vcr   = $this->vsicredito[0][0];
				$vdias = $this->vsicredito[0][1];
				$vcupo = $this->vsicredito[0][2];
				...
				if($vcr == "SI")
				{
					...
					if(intval($vporcentaje_propina_sugerida)>0)
					{
						$vvalor_propina = $vtotal * ($vporcentaje_propina_sugerida/100);
						$vvalor_propina = $vvalor_propina/100;
						$vvalor_propina = ceil($vvalor_propina);
						$vvalor_propina = $vvalor_propina*100;
					}
					
					$vsql = "update facturaven set idcli='".$vidtercero."',dias_decredito='".$vdias."' where idfacven='".$idfactura."'";
     ...
     $nm_select = $vsql; 
      ...
      ;
		...
		else
		{
			...
			$vsql = "update facturaven set idcli='".$vidtercero."' where idfacven='".$idfactura."'";
     ...
     $nm_select = $vsql; 
      ...
      ;
		...
		$vsql2 = "select nombres from terceros where documento='".$identificacion."'";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vNombres[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vnombres[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vNombres = false;
          $this->vNombres_erro = $this->Db->ErrorMsg();
          $this->vnombres = false;
          $this->vnombres_erro = $this->Db->ErrorMsg();
      } 
;

		if(isset($this->vnombres[0][0])) {

			$nombrecliente = $this->vnombres[0][0];
		}
	}
	...
	echo json_encode(array(
		...
		"nitclienteanterior" => $nitclienteanterior,
		"diasanteriores" => $diasanteriores,
		"preciolista"=>$vlistacliente,
...
if(isset($_POST['cambiarfecha'])){
	...
	$vsql = "update facturaven set fechaven='".$fecha."' where idfacven='".$idfactura."'";
...
if(isset($_POST['cambiarcreditocontado'])){
	...
	$vdiasfactura = 0;
      ...
      $nm_select = "select (select c.credito from terceros c where c.idtercero=v.idcli) as credito,(select c.cupo from terceros c where c.idtercero=v.idcli) as cupo,(select c.saldo from terceros c where c.idtercero=v.idcli) as saldo,v.total,coalesce((select c.dias_credito from terceros c where c.idtercero=v.idcli),'0') as dias_credito,v.fechavenc,v.dias_decredito from facturaven v where v.idfacven='".$idfactura."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vsicredito = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
;
	...
	if(isset($this->vsicredito[0][0]))
	{
		$vcupo  = $this->vsicredito[0][1];
		$vsaldo = $this->vsicredito[0][2];
		$vtotal = $this->vsicredito[0][3];
		$vdias  = $this->vsicredito[0][4];
		$vfechavenc   = $this->vsicredito[0][5];
		$vdiasfactura = $this->vsicredito[0][6];
			
		if($this->vsicredito[0][0]=="SI")
		{
			if($vcupo>0)
			{
				$vtotalsaldo = $vsaldo + $vtotal;
				if($vtotalsaldo > $vcupo)
				{
					$mensaje   = "El cliente no tiene cupo disponible.";
					$formapago = "2";
				}
				else
				{
		...
		{
			$formapago = "2";
			$mensaje   = "El cliente no tiene credito configurado.";
		}
		
		if($formapago==1)
		{
			$vsql = "update facturaven set credito='".$formapago."',formapago=null where idfacven='".$idfactura."'";
		}
		else
		{
			$vsql = "update facturaven set credito='".$formapago."',formapago='".$formapago2."',fechavenc=null,dias_decredito='0' where idfacven='".$idfactura."'";
		}
	...
	echo json_encode(array(
		...
		"cupo"=>$vcupo,
		"saldo"=>$vsaldo,
		"total_factura"=>$vtotal,
		"dias_credito"=>$vdias,
		"saldo_total"=>$vtotalsaldo,
		"mensaje"=>$mensaje,
		"vencimiento"=>$vfechavenc,
		"dias_factura"=>$vdiasfactura
	));
}

if(isset($_POST['cambiarvencimiento'])){
    
	$idfactura = $_POST['idfactura'];
	$vence     = $_POST['vence'];
	$dias      = $_POST['dias'];
	
	$vsql = "update facturaven set fechavenc='".$vence."',dias_decredito='".$dias."' where idfacven='".$idfactura."'";
...
if(isset($_POST['cargardocumento']))
{
    $idfactura      = $_POST['idfactura'];
	$numero         = "";
	$fecha          = "";
	...
	$vsql = "select 
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vFactura[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vfactura[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vFactura = false;
          $this->vFactura_erro = $this->Db->ErrorMsg();
          $this->vfactura = false;
          $this->vfactura_erro = $this->Db->ErrorMsg();
      } 
;
		
	if(isset($this->vfactura[0][0]))
	{
			
		$numero         = $this->vfactura[0][0];
		$fecha          = $this->vfactura[0][1];
		$idcliente      = $this->vfactura[0][2];
		$nombrecliente  = $this->vfactura[0][3];
		$creditocontado = $this->vfactura[0][4];
		$subtotal       = $this->vfactura[0][5];
		$iva            = $this->vfactura[0][6];
		$total          = $this->vfactura[0][7];
		$resolucion     = $this->vfactura[0][8];
		$vendedor       = $this->vfactura[0][10];
		$fechavenc      = $this->vfactura[0][11];
		$dias_decredito = $this->vfactura[0][12];
		$formapago      = $this->vfactura[0][13];
		$vtipo          = $this->vfactura[0][14];
		$vbanco         = $this->vfactura[0][15];
		$vobserva       = $this->vfactura[0][16]; 
		$vdircliente    = $this->vfactura[0][17]; 
		$vaplica_propina= $this->vfactura[0][19];
		
		
		if(intval($vporcentaje_propina_sugerida)>0)
		{
			$vvalor_propina = $total * ($vporcentaje_propina_sugerida/100);
			$vvalor_propina = $vvalor_propina/100;
			$vvalor_propina = ceil($vvalor_propina);
			$vvalor_propina = $vvalor_propina*100;
		}
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vB[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vb[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vB = false;
          $this->vB_erro = $this->Db->ErrorMsg();
          $this->vb = false;
          $this->vb_erro = $this->Db->ErrorMsg();
      } 
;

		if(isset($this->vb[0][0]))
		{
			if($this->vb[0][0]>1)
			{
				$vbloqueo = "SI";
...
if(isset($_POST["prefijo"]))
{
	...
	if(!empty($this->sc_temp_gidresolucion))
	{
		$predeterminada = $this->sc_temp_gidresolucion;
	}
	
	 
      $nm_select = "select Idres,prefijo from resdian where prefijo <> 'INVENT FI' and prefijo <> 'NOTA' and prefijo <> 'PEDIDO'  and prefijo <> 'COTI' and prefijo <> 'PROFORMA' and prefijo <> 'REMIS' and prefijo <> 'PED COMP' and activa='SI' and (pref_factura='SI' or (resolucion=0 and rangofac=0)) order by Idres desc"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vPrefijos[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vprefijos[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vPrefijos = false;
          $this->vPrefijos_erro = $this->Db->ErrorMsg();
          $this->vprefijos = false;
          $this->vprefijos_erro = $this->Db->ErrorMsg();
      } 
;
	
	if(isset($this->vprefijos[0][0]))
	{
		for($i=0;$i<count($this->vprefijos );$i++)
		{
			$prefijos[$this->vprefijos[$i][0]] = $this->vprefijos[$i][1];
		}
	}
	
	echo json_encode(array("prefijos"=>$prefijos,"predeterminada"=>$predeterminada));
}


if(isset($_POST["cambiarpj"]))
{
	$idfactura     = $_POST['idfactura'];
	...
	$vsql = "select ultima_fac from resdian where Idres='".$resolucion."'";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vUlt[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vult[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vUlt = false;
          $this->vUlt_erro = $this->Db->ErrorMsg();
          $this->vult = false;
          $this->vult_erro = $this->Db->ErrorMsg();
      } 
;
	if(isset($this->vult[0][0]))
	{
		$vultimafac = $this->vult[0][0];
	}
	
	$vsql1 = "select coalesce(max(numfacven),0) from facturaven where resolucion='".$resolucion."' and tipo='".$tipodocumento."'";
...
;
	...
	if(isset($this->vultimonumero[0][0]))
	{
		$numfacven = $this->vultimonumero[0][0];
	
		if($numfacven==0)
		{
			$vsql2 = "select primerfactura from resdian where Idres='".$resolucion."'";
...
;
			if(isset($this->vprimerafv[0][0]))
			{
				$numfacven = $this->vprimerafv[0][0];
			}
		}
		else
		{
			
			$vsql3 = "select count(*) from facturaven where resolucion='".$resolucion."'";
			 
      $nm_select = $vsql3; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vCantidad = array();
      $this->vcantidad = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vCantidad[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vcantidad[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vCantidad = false;
          $this->vCantidad_erro = $this->Db->ErrorMsg();
          $this->vcantidad = false;
          $this->vcantidad_erro = $this->Db->ErrorMsg();
      } 
;
			
			if(isset($this->vcantidad[0][0]))
			{
				if($this->vcantidad[0][0]>=1)
				{
					$numfacven = $numfacven+1;
				}
			}
		}

		$vsql4 = "update facturaven set resolucion='".$resolucion."',numfacven='".$numfacven."',tipo='".$tipodocumento."' where idfacven='".$idfactura."'";
     ...
     $nm_select = $vsql4; 
      ...
      ;
		...
		$vsql5 = "select numfacven from facturaven where idfacven='".$idfactura."'";
		 
      $nm_select = $vsql5; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vNumeroFacVen = array();
      $this->vnumerofacven = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vNumeroFacVen[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vnumerofacven[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vNumeroFacVen = false;
          $this->vNumeroFacVen_erro = $this->Db->ErrorMsg();
          $this->vnumerofacven = false;
          $this->vnumerofacven_erro = $this->Db->ErrorMsg();
      } 
;
	
		if(isset($this->vnumerofacven[0][0]))
		{
			$numfacven = $this->vnumerofacven[0][0];
		}
	}
	
	if($vultimafac>0)
	{
		$vdisponibles = $vultimafac - $numfacven;
	}
	
	echo json_encode(array("numero"=>$numfacven,"idfactura"=>$idfactura,"resolucion"=>$resolucion,"tipodocumento"=>$tipodocumento,"sql1"=>$vsql1,"sql2"=>$vsql2,"sql3"=>$vsql3,"sql4"=>$vsql4,"sql5"=>$vsql5,"ultima_fac"=>$vultimafac,"disponibles"=>$vdisponibles));
	
}

if(isset($_POST["cambiarcaja"]))
{
	$idfactura = $_POST['idfactura'];
	$banco     = $_POST['banco'];
...
if(isset($_POST["cargarvendedores"]))
{
	$registros = [];
	$predeterminado = "1";
	...
	{
		$predeterminado = $this->sc_temp_gidtercero;
	}
...
;
	...
	{
		for($i=0;$i<count($this->vdatos );$i++)
		{
			$registros[$this->vdatos[$i][0]] = $this->vdatos[$i][1];
		}
	}
	
	echo json_encode(array("registros"=>$registros,"predeterminada"=>$predeterminado));
}
...
if(isset($_POST["cajas"]))
{
	...
	$caja_bloqueada = "NO";
      ...
      $nm_select = "select u.banco_movil,u.grupo from usuarios u where u.tercero='".$this->sc_temp_gidtercero."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vCajaPredeterminada = array();
      $this->vcajapredeterminada = array();
...
;
	...
	if(isset($this->vcajapredeterminada[0][0]))
	{
		if(!empty($this->vcajapredeterminada[0][0]) and $this->vcajapredeterminada[0][0]>0)
		{
			$predeterminada = $this->vcajapredeterminada[0][0];
		}
		
		if($this->vcajapredeterminada[0][1]>1)
		{
			$caja_bloqueada = "SI";
		}
	}
	
	$vsql = "select idcaja_vta,codigo_banco from bancos where comportamiento='SI' or codigo_banco='00'";
	 
      $nm_select = $vsql; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vRegistros = array();
      $this->vregistros = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vRegistros[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vregistros[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vRegistros = false;
          $this->vRegistros_erro = $this->Db->ErrorMsg();
          $this->vregistros = false;
          $this->vregistros_erro = $this->Db->ErrorMsg();
      } 
;
	
	if(isset($this->vregistros[0][0]))
	{
		for($i=0;$i<count($this->vregistros );$i++)
		{
			$registros[$this->vregistros[$i][0]] = $this->vregistros[$i][1];
		}
	}
	
	echo json_encode(array("registros"=>$registros,"predeterminada"=>$predeterminada,"bloqueada"=>$caja_bloqueada));
}

if(isset($_POST["cambiarvendedor"]))
{
	$idfactura  = $_POST['idfactura'];
	$registro   = $_POST['registro'];
	
	$sql = "update facturaven set vendedor='".$registro."',banco=(coalesce((select idcaja_vta from bancos where cajero='".$registro."'),coalesce((select u.banco_movil from usuarios u where u.tercero='".$registro."'),'1'))) where idfacven='".$idfactura."'";
...
if(isset($_POST["pagarcredito"]))
{
	...
	$this->fAsentar($idfactura,$vasentar,0,0,true);
	
	
}

if(isset($_POST["abrircajon"]))
{
	$ruta_impresora = "";
	
	 
      $nm_select = "select nombre_pc,nombre_impre from usuarios where tercero='".$this->sc_temp_gidtercero."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vDatos = array();
      $this->vdatos = array();
...
;
	...
	if(isset($this->vdatos[0][0]))
	{
		if(!empty($this->vdatos[0][0]) and !empty($this->vdatos[0][1]))
		{
			$ruta_impresora = "\\\\".$this->vdatos[0][0]."\\".$this->vdatos[0][1];

			$escape       = chr(27);
			$cortar_papel = $escape."m";
			$string       = "/n";
			$string      .= $cortar_papel;

			$fp=fopen($ruta_impresora, "wb");
			fwrite($fp,utf8_decode($string));
			fclose($fp);

			
     $nm_select = "insert into log set usuario='".$this->sc_temp_gidtercero."',accion='ABRIR',observaciones='EL USUARIO ABRIÓ EL CAJÓN MONEDERO.'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	echo json_encode(array("impresora"=>$ruta_impresora));
}

if(isset($_POST["traermonto"]))
{
	$vmonto1   = 0;
	...
	$vidrecibo = "";
      ...
      { 
          $nm_select = "select f.total,concat(t.documento,' - ',t.nombres) as cliente,concat(r.prefijo,'/',f.numfacven) as documento,f.total,f.tipo,f.numfacven,f.idcli,str_replace (convert(char(10),f.fechaven,102), '.', '-') + ' ' + convert(char(8),f.fechaven,20),f.resolucion from facturaven f left join terceros t on f.idcli=t.idtercero left join resdian r on f.resolucion=r.Idres where f.idfacven='".$vidfacven."'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select f.total,concat(t.documento,' - ',t.nombres) as cliente,concat(r.prefijo,'/',f.numfacven) as documento,f.total,f.tipo,f.numfacven,f.idcli,convert(char(23),f.fechaven,121),f.resolucion from facturaven f left join terceros t on f.idcli=t.idtercero left join resdian r on f.resolucion=r.Idres where f.idfacven='".$vidfacven."'"; 
      }
      else
      { 
          $nm_select = "select f.total,concat(t.documento,' - ',t.nombres) as cliente,concat(r.prefijo,'/',f.numfacven) as documento,f.total,f.tipo,f.numfacven,f.idcli,f.fechaven,f.resolucion from facturaven f left join terceros t on f.idcli=t.idtercero left join resdian r on f.resolucion=r.Idres where f.idfacven='".$vidfacven."'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vMonto = array();
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vMonto[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vmonto[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vMonto = false;
          $this->vMonto_erro = $this->Db->ErrorMsg();
          $this->vmonto = false;
          $this->vmonto_erro = $this->Db->ErrorMsg();
      } 
;
	
	if(isset($this->vmonto[0][0]))
	{
		$vmonto1   = $this->vmonto[0][0];
		$vcliente  = $this->vmonto[0][1];
		$vtipo     = $this->vmonto[0][4];
		$vdoc      = $vtipo."/".$this->vmonto[0][2];
		$vtotal    = $this->vmonto[0][3];
		
		$vnufac    = $this->vmonto[0][5];
		$vidcli    = $this->vmonto[0][6];
		$vfecha    = $this->vmonto[0][7];
		$vresol    = $this->vmonto[0][8];
		
		$vcliente .= " -- Total: $".number_format($vtotal);
     ...
     $nm_select = "delete from recibocaja where obser='TEMPORAL' and usuario='".$this->sc_temp_gidtercero."' and asentado='NO' and (select d.iddetall from detallepagos d where d.idrc=idrecibo limit 1) is null"; 
      ...
      ;
		...
		$vsql = "insert into recibocaja set nurecibo=(select coalesce(max(rc.nurecibo),0)+1 from recibocaja rc), nufac='".$vnufac."', cliente='".$vidcli."', fecharecibo='".$vfecha."', monto='".$vtotal."', obser='TEMPORAL', saldofac='".$vtotal."', formapago='MIXTO', resolucion='".$vresol."', rete='0', descu='0', asentado='NO', porc_rete='0', val_ica='0', por_ica='0', por_retiva='0', val_retiva='0', banco_id='1', usuario='".$this->sc_temp_gidtercero."', id_concepto='0'";
     ...
     $nm_select = $vsql; 
      ...
      $nm_select = "select idrecibo from recibocaja where nufac='".$vnufac."' and cliente='".$vidcli."' and  fecharecibo='".$vfecha."' and monto='".$vtotal."' and obser='TEMPORAL' and saldofac='".$vtotal."' and formapago='MIXTO' and  resolucion='".$vresol."' and usuario='".$this->sc_temp_gidtercero."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vIdRC = array();
      $this->vidrc = array();
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vIdRC[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vidrc[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vIdRC = false;
          $this->vIdRC_erro = $this->Db->ErrorMsg();
          $this->vidrc = false;
          $this->vidrc_erro = $this->Db->ErrorMsg();
      } 
;
		
		if(isset($this->vidrc[0][0]))
		{
			$vidrecibo = $this->vidrc[0][0];
		}
	}
...
if(isset($_POST["insertardetallerecibo"]))
{

	$vidfact        = $_POST["idfact"];
	$this->vidrc          = $_POST["idrc"];
	$vidrc2         = $this->vidrc;
	$vidfps         = $_POST["idfps"];
	$vmontos        = $_POST["montos"]; 
	$vbancos        = $_POST["bancos"]; 
	$vnumcheques    = $_POST["numcheques"]; 
	$vfechacobs     = $_POST["fechacobs"]; 
	$vidbanco_cajas = $_POST["idbanco_cajas"];
	$vsql           = "";
	$contador       = 0;
	$vtotal         = 0;
	...
	for($i=0;$i<3;$i++)
	{
		if($vmontos[$i]>0)
		{
			...
			if(!empty($vnumcheques[$i]))
			{
				$vnumcheques[$i] = "'".$vnumcheques[$i]."'";
			}
			else
			{
				$vnumcheques[$i] = "null";
			...
			if(!empty($vfechacobs[$i]))
			{
				$vfechacobs[$i] = "'".$vfechacobs[$i]."'";
			}
			else
			{
				$vfechacobs[$i] = "null";
			...
			$vsql = "insert into detallepagos set idfact='".$vidfact."', idrc='".$vidrc2."', idfp='".$vidfps[$i]."', monto='".$vmontos[$i]."', banco=".$vbancos[$i].", numcheque=".$vnumcheques[$i].", fechacob=".$vfechacobs[$i].", idbanco_caja='".$vidbanco_cajas[$i]."'";
	...
	if($contador>0)
	{
     ...
     $nm_select = "update recibocaja set asentado='SI',obser=null where idrecibo='".$vidrc2."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
         ...
         $rf->Close();
      ;
		$this->fPagarFacVen($vidfact,2,false,$vidrc2);
		$this->fAsentar($vidfact,"SI",$vtotal,0,false);
	}
	...
	echo json_encode(
		...
		array(
			...
			"montos"        => $vmontos, 
			"bancos"        => $vbancos, 
			"numcheques"    => $vnumcheques, 
			"fechacobs"     => $vfechacobs,
			"idbanco_cajas" => $vidbanco_cajas,
			"contador"      => $contador,
			"sql"           => $vsql
		)
	);
...
;
	...
	{
		$vmensaje = "El numero del documento ya fue asignado a otro documento: ".$vtipodoc."/".$this->vsiexiste[0][0]."/".$vnumero;
		
		$vsql = "select numfacven from facturaven where idfacven='".$idfactura."'";
...
if(isset($_POST["cambiarobservacionmaster"]))
{
	$idfactura         = $_POST['idfactura'];
	$observacionmaster = strtoupper($_POST['observacionmaster']);
	
	$sql = "update facturaven set observaciones='".$observacionmaster."' where idfacven='".$idfactura."'";
...
if(isset($_POST["cargardirecciones"]))
{
	$registros = [];
	$predeterminada = "1";
	$vcliente = $_POST["clientedireccion"];
	
	$vsql = "select if(d.iddireccion is not null, d.iddireccion,0) as iddir,if(d.iddireccion is not null, d.direc,t.direccion) as direccion,t.idtercero,t.nombres,t.sucur_cliente from terceros t left join direccion d on t.idtercero=d.idter where t.idtercero=(select o.idtercero from terceros o where o.documento='".$vcliente."')";
...
;
	...
	if(isset($this->vdatos[0][0]))
	{
		for($i=0;$i<count($this->vdatos );$i++)
		{
			$registros[$i]["iddireccion"] = $this->vdatos[$i][0];
			$registros[$i]["direccion"]   = $this->vdatos[$i][1];
			$registros[$i]["idtercero"]   = $this->vdatos[$i][2];
			$registros[$i]["sucursal"]    = $this->vdatos[$i][4];
		}
	}
	
	echo json_encode(array("registros"=>$registros,"predeterminada"=>$predeterminada));
}

if(isset($_POST["cambiardireccion"]))
{
	$vidfactura  = $_POST["idfactura"];
	$vdircliente = $_POST["dircliente"];
	
	$vsql = "update facturaven set dircliente='".$vdircliente."' where idfacven='".$vidfactura."'";
...
$_SESSION['scriptcase']['frm_pos_gestionarmaster']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_frm_pos_gestionarmaster($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['frm_pos_gestionarmaster']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "frm_pos_gestionarmaster") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv_2022'])) {
               $_SESSION['scriptcase']['frm_pos_gestionarmaster']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv_2022'];
           }
       }
   }
   ...
   if (isset($_POST["gidtercero"])) 
   {
       ...
       nm_limpa_str_frm_pos_gestionarmaster($_SESSION["gidtercero"]);
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "frm_pos_gestionarmaster";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'frm_pos_gestionarmaster' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('frm_pos_gestionarmaster' == $sReferer || 'frm_pos_gestionarmaster_' == substr($sReferer, 0, 24))
       {
           $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'frm_pos_gestionarmaster')
   {
       $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['frm_pos_gestionarmaster']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/frm_pos_gestionarmaster_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_frm_pos_gestionarmaster($cadapar[1]);
   ...
   $contr_frm_pos_gestionarmaster = new frm_pos_gestionarmaster_apl();
   $contr_frm_pos_gestionarmaster->controle();
//
   function nm_limpa_str_frm_pos_gestionarmaster(&$str)
   {
