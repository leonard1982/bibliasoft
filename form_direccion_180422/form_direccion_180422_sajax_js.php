  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_direccion_180422" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_direccion_180422_form();
	}
...
?>
  ...
  // ---------- Validate idter_
  function do_ajax_form_direccion_180422_validate_idter_(iNumLinha)
  {
    var nomeCampo_idter_ = "idter_" + iNumLinha;
    var var_idter_ = scAjaxGetFieldText(nomeCampo_idter_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_idter_(var_idter_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_idter__cb);
  } // do_ajax_form_direccion_180422_validate_idter_

  function do_ajax_form_direccion_180422_validate_idter__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_idter__cb

  // ---------- Validate iddepar_
  function do_ajax_form_direccion_180422_validate_iddepar_(iNumLinha)
  {
    var nomeCampo_iddepar_ = "iddepar_" + iNumLinha;
    var var_iddepar_ = scAjaxGetFieldSelect(nomeCampo_iddepar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_iddepar_(var_iddepar_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_iddepar__cb);
  } // do_ajax_form_direccion_180422_validate_iddepar_

  function do_ajax_form_direccion_180422_validate_iddepar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_iddepar__cb

  // ---------- Validate idmuni_
  function do_ajax_form_direccion_180422_validate_idmuni_(iNumLinha)
  {
    var nomeCampo_idmuni_ = "idmuni_" + iNumLinha;
    var var_idmuni_ = scAjaxGetFieldSelect(nomeCampo_idmuni_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_idmuni_(var_idmuni_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_idmuni__cb);
  } // do_ajax_form_direccion_180422_validate_idmuni_

  function do_ajax_form_direccion_180422_validate_idmuni__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_idmuni__cb

  // ---------- Validate ciudad_
  function do_ajax_form_direccion_180422_validate_ciudad_(iNumLinha)
  {
    var nomeCampo_ciudad_ = "ciudad_" + iNumLinha;
    var var_ciudad_ = scAjaxGetFieldSelect(nomeCampo_ciudad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_ciudad_(var_ciudad_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_ciudad__cb);
  } // do_ajax_form_direccion_180422_validate_ciudad_

  function do_ajax_form_direccion_180422_validate_ciudad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_ciudad__cb

  // ---------- Validate direc_
  function do_ajax_form_direccion_180422_validate_direc_(iNumLinha)
  {
    var nomeCampo_direc_ = "direc_" + iNumLinha;
    var var_direc_ = scAjaxGetFieldText(nomeCampo_direc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_direc_(var_direc_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_direc__cb);
  } // do_ajax_form_direccion_180422_validate_direc_

  function do_ajax_form_direccion_180422_validate_direc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_direc__cb

  // ---------- Validate codigo_postal_
  function do_ajax_form_direccion_180422_validate_codigo_postal_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_codigo_postal_(var_codigo_postal_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_codigo_postal__cb);
  } // do_ajax_form_direccion_180422_validate_codigo_postal_

  function do_ajax_form_direccion_180422_validate_codigo_postal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_codigo_postal__cb

  // ---------- Validate telefono_
  function do_ajax_form_direccion_180422_validate_telefono_(iNumLinha)
  {
    var nomeCampo_telefono_ = "telefono_" + iNumLinha;
    var var_telefono_ = scAjaxGetFieldText(nomeCampo_telefono_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_telefono_(var_telefono_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_telefono__cb);
  } // do_ajax_form_direccion_180422_validate_telefono_

  function do_ajax_form_direccion_180422_validate_telefono__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_telefono__cb

  // ---------- Validate lenguaje_
  function do_ajax_form_direccion_180422_validate_lenguaje_(iNumLinha)
  {
    var nomeCampo_lenguaje_ = "lenguaje_" + iNumLinha;
    var var_lenguaje_ = scAjaxGetFieldSelect(nomeCampo_lenguaje_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_lenguaje_(var_lenguaje_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_lenguaje__cb);
  } // do_ajax_form_direccion_180422_validate_lenguaje_

  function do_ajax_form_direccion_180422_validate_lenguaje__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_lenguaje__cb

  // ---------- Validate obs_
  function do_ajax_form_direccion_180422_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_obs__cb);
  } // do_ajax_form_direccion_180422_validate_obs_

  function do_ajax_form_direccion_180422_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_obs__cb

  // ---------- Validate correo_
  function do_ajax_form_direccion_180422_validate_correo_(iNumLinha)
  {
    var nomeCampo_correo_ = "correo_" + iNumLinha;
    var var_correo_ = scAjaxGetFieldText(nomeCampo_correo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_correo_(var_correo_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_correo__cb);
  } // do_ajax_form_direccion_180422_validate_correo_

  function do_ajax_form_direccion_180422_validate_correo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_correo__cb

  // ---------- Validate correo_notificafe_
  function do_ajax_form_direccion_180422_validate_correo_notificafe_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_correo_notificafe_(var_correo_notificafe_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_correo_notificafe__cb);
  } // do_ajax_form_direccion_180422_validate_correo_notificafe_

  function do_ajax_form_direccion_180422_validate_correo_notificafe__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_correo_notificafe__cb

  // ---------- Validate celular_notificafe_
  function do_ajax_form_direccion_180422_validate_celular_notificafe_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_validate_celular_notificafe_(var_celular_notificafe_, iNumLinha, var_script_case_init, do_ajax_form_direccion_180422_validate_celular_notificafe__cb);
  } // do_ajax_form_direccion_180422_validate_celular_notificafe_

  function do_ajax_form_direccion_180422_validate_celular_notificafe__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_validate_celular_notificafe__cb

  // ---------- Refresh iddepar_
  function do_ajax_form_direccion_180422_refresh_iddepar_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_direccion_180422_refresh_iddepar_(var_iddepar_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_direccion_180422_refresh_iddepar__cb);
  } // do_ajax_form_direccion_180422_refresh_iddepar_

  function do_ajax_form_direccion_180422_refresh_iddepar__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_direccion_180422_refresh_idmuni_();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_refresh_iddepar__cb

  // ---------- Refresh idmuni_
  function do_ajax_form_direccion_180422_refresh_idmuni_(iSeqForm)
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_direccion_180422_refresh_idmuni_(var_idmuni_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_direccion_180422_refresh_idmuni__cb);
  } // do_ajax_form_direccion_180422_refresh_idmuni_

  function do_ajax_form_direccion_180422_refresh_idmuni__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_180422_refresh_idmuni__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_direccion_180422_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_direccion_180422_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_direccion_180422_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_direccion_180422_add_new_line_cb);
  } // do_ajax_form_direccion_180422_add_new_line

  function do_ajax_form_direccion_180422_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_direccion_180422_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_direccion_180422_backup_line(iNumLinha)
  {
    var var_iddireccion_ = scAjaxGetFieldText("iddireccion_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_180422_backup_line(var_iddireccion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_direccion_180422_backup_line_cb);
  } // do_ajax_form_direccion_180422_backup_line

  function do_ajax_form_direccion_180422_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_direccion_180422_backup_line_cb

  function do_ajax_form_direccion_180422_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_direccion_180422_cancel_insert

  function do_ajax_form_direccion_180422_cancel_update(iSeqVert)
  {
    do_ajax_form_direccion_180422_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_direccion_180422_cancel_update

  function do_ajax_form_direccion_180422_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_direccion_180422_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_direccion_180422_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_direccion_180422_table_refresh(var_iddireccion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_direccion_180422_table_refresh_cb);
  } //  do_ajax_form_direccion_180422_table_refresh

  function do_ajax_form_direccion_180422_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_direccion_180422_table_refresh_cb_after_alert);
  } // do_ajax_form_direccion_180422_table_refresh_cb
  function do_ajax_form_direccion_180422_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_direccion_180422_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_direccion_180422_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_direccion_180422_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_direccion_180422_submit_form(var_idter_, var_iddepar_, var_idmuni_, var_ciudad_, var_direc_, var_codigo_postal_, var_telefono_, var_lenguaje_, var_obs_, var_correo_, var_correo_notificafe_, var_celular_notificafe_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_direccion_180422_submit_form_cb);
  } // do_ajax_form_direccion_180422_submit_form

  function do_ajax_form_direccion_180422_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_direccion_180422_submit_form_cb_after_alert);
  } // do_ajax_form_direccion_180422_submit_form_cb
  function do_ajax_form_direccion_180422_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_direccion_180422_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_direccion_180422_navigate_form()
  {
    perform_ajax_form_direccion_180422_navigate_form();
  }

  function perform_ajax_form_direccion_180422_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_direccion_180422_navigate_form(var_iddireccion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_direccion_180422_navigate_form_cb);
  } // do_ajax_form_direccion_180422_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion_180422']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_direccion_180422_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_direccion_180422_navigate_form_cb_after_alert);
  } // do_ajax_form_direccion_180422_navigate_form_cb
  function do_ajax_form_direccion_180422_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_direccion_180422_navigate_form_cb_after_alert
  function sc_hide_form_direccion_180422_form()
  {
