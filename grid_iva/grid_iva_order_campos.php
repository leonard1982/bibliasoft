<?php
   include_once('grid_iva_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_iva']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_iva']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_iva']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_iva']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_iva_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_iva_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_iva_json.php");
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['trifa'] = "on";
   $tab_def_campos['trifa'] = "trifa";
   $tab_labels["trifa"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["trifa"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["trifa"] : "Tasa";
   $tab_ger_campos['tipo_impuesto'] = "on";
   $tab_def_campos['tipo_impuesto'] = "tipo_impuesto";
   $tab_labels["tipo_impuesto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["tipo_impuesto"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["tipo_impuesto"] : "Tipo Impuesto";
   $tab_ger_campos['puc'] = "on";
   $tab_def_campos['puc'] = "puc";
   $tab_labels["puc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["puc"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["puc"] : "Cuenta Ventas";
   $tab_ger_campos['puc_dv_ventas'] = "on";
   $tab_def_campos['puc_dv_ventas'] = "puc_dv_ventas";
   $tab_labels["puc_dv_ventas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["puc_dv_ventas"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["puc_dv_ventas"] : "Cuenta  Devolución Ventas";
   $tab_ger_campos['puc_compras'] = "on";
   $tab_def_campos['puc_compras'] = "puc_compras";
   $tab_labels["puc_compras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["puc_compras"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["puc_compras"] : "Cuenta Compras";
   $tab_ger_campos['puc_dv_compras'] = "on";
   $tab_def_campos['puc_dv_compras'] = "puc_dv_compras";
   $tab_labels["puc_dv_compras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["puc_dv_compras"])) ? $_SESSION['sc_session'][$sc_init]['grid_iva']['labels']["puc_dv_compras"] : "Cuenta Devolución Compras";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_iva']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_iva']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_iva']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_iva']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_iva']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_iva']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
