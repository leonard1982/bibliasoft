...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_iva"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_iva"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_iva'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_iva']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_iva']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_iva']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_iva']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_iva']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_iva']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_iva']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_iva']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_iva']['embutida_filho'] as $ind => $sc_init)
          {
