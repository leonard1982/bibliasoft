...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_conceptos_documentos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_conceptos_documentos"]);
   }
