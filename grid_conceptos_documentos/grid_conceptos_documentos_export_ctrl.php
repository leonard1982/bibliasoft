<?php
@session_start() ;
$_SESSION['scriptcase']['grid_conceptos_documentos']['sc_process_barr'] = true;
require_once('../grid_conceptos_documentos/index.php');
unset($_SESSION['scriptcase']['grid_conceptos_documentos']['sc_process_barr']);
$ExportCtrl = new grid_conceptos_documentos_export_control;
$ExportCtrl->Export_barr();

class grid_conceptos_documentos_export_control
{
