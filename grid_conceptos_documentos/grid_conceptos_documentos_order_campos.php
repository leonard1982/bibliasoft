...
<?php
   ...
   $Ord_Cmp = new grid_conceptos_documentos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_conceptos_documentos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['labels']["codigo"] : "Codigo";
   $tab_ger_campos['concepto'] = "on";
   $tab_def_campos['concepto'] = "concepto";
   $tab_labels["concepto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['labels']["concepto"])) ? $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['labels']["concepto"] : "Documento";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['np'] = "on";
   $tab_def_campos['np'] = "np";
   $tab_labels["np"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['labels']["np"])) ? $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['labels']["np"] : "(+/-)";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_conceptos_documentos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_conceptos_documentos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
