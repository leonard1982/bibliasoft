...
class grid_pedidos_self_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_pedidos_self_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_pedidos_self_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_pedidos_self_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_pedidos_self/grid_pedidos_self_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_pedidos_self_ajax_search.js"></script>
 <script type="text/javascript" src="grid_pedidos_self_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_pedidos_self_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pedidos_self']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pedidos_self']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  ...
  $("#sc_fechadocu_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechadocu_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechadocu_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechadocu_ano').value;
          document.getElementById('sc_fechadocu_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechadocu_dia').value = aParts[0];
          document.getElementById('SC_fechadocu_mes').value = aParts[1];
          document.getElementById('SC_fechadocu_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fechadocu_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechadocu_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechadocu_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechadocu_input_2_ano').value;
          document.getElementById('sc_fechadocu_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechadocu_input_2_dia').value = aParts[0];
          document.getElementById('SC_fechadocu_input_2_mes').value = aParts[1];
          document.getElementById('SC_fechadocu_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_fechadocu_cond#NMF#' + search_get_sel_txt('SC_fechadocu_cond') + '@NMF@';
  str_out += 'SC_fechadocu_dia#NMF#' + search_get_sel_txt('SC_fechadocu_dia') + '@NMF@';
  str_out += 'SC_fechadocu_mes#NMF#' + search_get_sel_txt('SC_fechadocu_mes') + '@NMF@';
  str_out += 'SC_fechadocu_ano#NMF#' + search_get_sel_txt('SC_fechadocu_ano') + '@NMF@';
  str_out += 'SC_fechadocu_input_2_dia#NMF#' + search_get_sel_txt('SC_fechadocu_input_2_dia') + '@NMF@';
  str_out += 'SC_fechadocu_input_2_mes#NMF#' + search_get_sel_txt('SC_fechadocu_input_2_mes') + '@NMF@';
  str_out += 'SC_fechadocu_input_2_ano#NMF#' + search_get_sel_txt('SC_fechadocu_input_2_ano') + '@NMF@';
  str_out += 'SC_fechadocu_hor#NMF#' + search_get_sel_txt('SC_fechadocu_hor') + '@NMF@';
  str_out += 'SC_fechadocu_min#NMF#' + search_get_sel_txt('SC_fechadocu_min') + '@NMF@';
  str_out += 'SC_fechadocu_seg#NMF#' + search_get_sel_txt('SC_fechadocu_seg') + '@NMF@';
  str_out += 'SC_fechadocu_input_2_hor#NMF#' + search_get_sel_txt('SC_fechadocu_input_2_hor') + '@NMF@';
  str_out += 'SC_fechadocu_input_2_min#NMF#' + search_get_sel_txt('SC_fechadocu_input_2_min') + '@NMF@';
  str_out += 'SC_fechadocu_input_2_seg#NMF#' + search_get_sel_txt('SC_fechadocu_input_2_seg') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Log Pedidos</span></td>
...
<?php
   ...
   {
      global 
             $fechadocu_cond, $fechadocu, $fechadocu_dia, $fechadocu_mes, $fechadocu_ano, $fechadocu_hor, $fechadocu_min, $fechadocu_seg, $fechadocu_input_2_dia, $fechadocu_input_2_mes, $fechadocu_input_2_ano, $fechadocu_input_2_min, $fechadocu_input_2_hor, $fechadocu_input_2_seg,
             ...
             $idcli_cond, $idcli, $idcli_input_2,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_self']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_self']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_self']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_pedidos_self", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fechadocu_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_dia']; 
          $fechadocu_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_mes']; 
          $fechadocu_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_ano']; 
          $fechadocu_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_dia']; 
          $fechadocu_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_mes']; 
          $fechadocu_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_ano']; 
          $fechadocu_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_hor']; 
          $fechadocu_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_min']; 
          $fechadocu_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_seg']; 
          $fechadocu_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_hor']; 
          $fechadocu_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_min']; 
          $fechadocu_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_seg']; 
          $fechadocu_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_cond']; 
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_cond']; 
          $idcli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['idcli']; 
          $idcli_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['idcli_input_2']; 
          $idcli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['idcli_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fechadocu_cond) || empty($fechadocu_cond))
      {
         $fechadocu_cond = "eq";
      }
      ...
      $str_hide_fechadocu = (in_array($fechadocu_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_fechadocu = ('bw' == $fechadocu_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($fechadocu) || $fechadocu == "")
      {
          $fechadocu = "";
      }
      if (isset($fechadocu) && !empty($fechadocu))
      {
         $tmp_pos = strpos($fechadocu, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $fechadocu = substr($fechadocu, 0, $tmp_pos);
         }
      }
...
?>
 ...
 $nmgp_tab_label .= "fechadocu?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fechadocu_cond" name="fechadocu_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechadocu'), this, 'fechadocu')">
       <OPTION value="eq" <?php if ("eq" == $fechadocu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $fechadocu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $fechadocu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $fechadocu_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_fechadocu"  <?php echo $str_hide_fechadocu?>>
<?php
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_dia" name="fechadocu_dia" value="<?php echo NM_encode_input($fechadocu_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_mes" name="fechadocu_mes" value="<?php echo NM_encode_input($fechadocu_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_ano" name="fechadocu_ano" value="<?php echo NM_encode_input($fechadocu_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_hor" name="fechadocu_hor" value="<?php echo NM_encode_input($fechadocu_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_min" name="fechadocu_min" value="<?php echo NM_encode_input($fechadocu_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_seg" name="fechadocu_seg" value="<?php echo NM_encode_input($fechadocu_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<INPUT type="hidden" id="sc_fechadocu_jq">
</span>
...
?>
        <SPAN id="id_css_fechadocu"  class="scFilterFieldFontOdd">
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_fechadocu"  <?php echo $str_display_fechadocu; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_input_2_dia" name="fechadocu_input_2_dia" value="<?php echo NM_encode_input($fechadocu_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_input_2_mes" name="fechadocu_input_2_mes" value="<?php echo NM_encode_input($fechadocu_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_input_2_ano" name="fechadocu_input_2_ano" value="<?php echo NM_encode_input($fechadocu_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_input_2_HH' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_input_2_hor" name="fechadocu_input_2_hor" value="<?php echo NM_encode_input($fechadocu_input_2_hor); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_input_2_II' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_input_2_min" name="fechadocu_input_2_min" value="<?php echo NM_encode_input($fechadocu_input_2_min); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_fechadocu_input_2_SS' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechadocu_input_2_seg" name="fechadocu_input_2_seg" value="<?php echo NM_encode_input($fechadocu_input_2_seg); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
<INPUT type="hidden" id="sc_fechadocu_jq2">
</span>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idcli_cond" name="idcli_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcli'), this, 'idcli')">
      ...
      <br><span id="id_hide_idcli"  <?php echo $str_hide_idcli?>><INPUT  type="text" id="SC_idcli" name="idcli" value="<?php echo NM_encode_input($idcli) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">         <BR>
        <SPAN id="id_vis_idcli"  <?php echo $str_display_idcli; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idcli_input_2" name="idcli_input_2" value="<?php echo NM_encode_input($idcli_input_2) ?>"    size="10" class="sc-js-input scFilterObjectOdd">         </SPAN>
...
<?php
   if (is_file("grid_pedidos_self_help.txt"))
   {
      $Arq_WebHelp = file("grid_pedidos_self_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_self']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_self']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fechadocu_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_fechadocu'), document.F1.fechadocu_cond, 'fechadocu');
   document.F1.fechadocu_dia.value = "";
   document.F1.fechadocu_mes.value = "";
   document.F1.fechadocu_ano.value = "";
   document.F1.fechadocu_input_2_dia.value = "";
   document.F1.fechadocu_input_2_mes.value = "";
   document.F1.fechadocu_input_2_ano.value = "";
   document.F1.fechadocu_hor.value = "";
   document.F1.fechadocu_min.value = "";
   document.F1.fechadocu_seg.value = "";
   document.F1.fechadocu_input_2_hor.value = "";
   document.F1.fechadocu_input_2_min.value = "";
   document.F1.fechadocu_input_2_seg.value = "";
 ...
 {
    $('#SC_fechadocu_dia').bind('change', function() {sc_grid_pedidos_self_valida_dia(this)});
    $('#SC_fechadocu_hor').bind('change', function() {sc_grid_pedidos_self_valida_hora(this)});
    $('#SC_fechadocu_input_2_dia').bind('change', function() {sc_grid_pedidos_self_valida_dia(this)});
    $('#SC_fechadocu_input_2_hor').bind('change', function() {sc_grid_pedidos_self_valida_hora(this)});
    $('#SC_fechadocu_input_2_mes').bind('change', function() {sc_grid_pedidos_self_valida_mes(this)});
    $('#SC_fechadocu_input_2_min').bind('change', function() {sc_grid_pedidos_self_valida_min(this)});
    $('#SC_fechadocu_input_2_seg').bind('change', function() {sc_grid_pedidos_self_valida_seg(this)});
    $('#SC_fechadocu_mes').bind('change', function() {sc_grid_pedidos_self_valida_mes(this)});
    $('#SC_fechadocu_min').bind('change', function() {sc_grid_pedidos_self_valida_min(this)});
    $('#SC_fechadocu_seg').bind('change', function() {sc_grid_pedidos_self_valida_seg(this)});
    $('#SC_fechaven_dia').bind('change', function() {sc_grid_pedidos_self_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_grid_pedidos_self_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_grid_pedidos_self_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_grid_pedidos_self_valida_mes(this)});
 }
 function sc_grid_pedidos_self_valida_dia(obj)
 {
 ...
 function sc_grid_pedidos_self_valida_mes(obj)
 {
 ...
 function sc_grid_pedidos_self_valida_hora(obj)
 {
 ...
 function sc_grid_pedidos_self_valida_min(obj)
 {
 ...
 function sc_grid_pedidos_self_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_pedidos_self";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_fechadocu_cond'] = 'cond';
      $tp_fields['SC_fechadocu_dia'] = 'text';
      $tp_fields['SC_fechadocu_mes'] = 'text';
      $tp_fields['SC_fechadocu_ano'] = 'text';
      $tp_fields['SC_fechadocu_input_2_dia'] = 'text';
      $tp_fields['SC_fechadocu_input_2_mes'] = 'text';
      $tp_fields['SC_fechadocu_input_2_ano'] = 'text';
      $tp_fields['SC_fechadocu_hor'] = 'text';
      $tp_fields['SC_fechadocu_min'] = 'text';
      $tp_fields['SC_fechadocu_seg'] = 'text';
      $tp_fields['SC_fechadocu_input_2_hor'] = 'text';
      $tp_fields['SC_fechadocu_input_2_min'] = 'text';
      $tp_fields['SC_fechadocu_input_2_seg'] = 'text';
   ...
   {
      global $fechadocu_cond, $fechadocu, $fechadocu_dia, $fechadocu_mes, $fechadocu_ano, $fechadocu_hor, $fechadocu_min, $fechadocu_seg, $fechadocu_input_2_dia, $fechadocu_input_2_mes, $fechadocu_input_2_ano, $fechadocu_input_2_min, $fechadocu_input_2_hor, $fechadocu_input_2_seg,
             $fechaven_cond, $fechaven, $fechaven_dia, $fechaven_mes, $fechaven_ano, $fechaven_input_2_dia, $fechaven_input_2_mes, $fechaven_input_2_ano,
             $idcli_cond, $idcli, $idcli_input_2, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $fechadocu_cond_salva = $fechadocu_cond; 
      if (!isset($fechadocu_input_2_dia) || $fechadocu_input_2_dia == "")
      {
          $fechadocu_input_2_dia = $fechadocu_dia;
      }
      if (!isset($fechadocu_input_2_mes) || $fechadocu_input_2_mes == "")
      {
          $fechadocu_input_2_mes = $fechadocu_mes;
      }
      if (!isset($fechadocu_input_2_ano) || $fechadocu_input_2_ano == "")
      {
          $fechadocu_input_2_ano = $fechadocu_ano;
      }
      if (!isset($fechadocu_input_2_hor) || $fechadocu_input_2_hor == "")
      {
          $fechadocu_input_2_hor = $fechadocu_hor;
      }
      if (!isset($fechadocu_input_2_min) || $fechadocu_input_2_min == "")
      {
          $fechadocu_input_2_min = $fechadocu_min;
      }
      if (!isset($fechadocu_input_2_seg) || $fechadocu_input_2_seg == "")
      {
          $fechadocu_input_2_seg = $fechadocu_seg;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_dia'] = $fechadocu_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_mes'] = $fechadocu_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_ano'] = $fechadocu_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_dia'] = $fechadocu_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_mes'] = $fechadocu_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_ano'] = $fechadocu_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_hor'] = $fechadocu_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_min'] = $fechadocu_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_seg'] = $fechadocu_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_hor'] = $fechadocu_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_min'] = $fechadocu_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2_seg'] = $fechadocu_input_2_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_cond'] = $fechadocu_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['idcli'] = $idcli; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['idcli_input_2'] = $idcli_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['idcli_cond'] = $idcli_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $Conteudo = $idcli;
      $this->cmp_formatado['idcli'] = $Conteudo;
      $Conteudo = $idcli_input_2;
      $this->cmp_formatado['idcli_input_2'] = $Conteudo;

      //----- $fechadocu
      $this->Date_part = false;
      if ($fechadocu_cond != "bi_TP")
      {
          $fechadocu_cond = strtoupper($fechadocu_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $fechadocu_ano;
          $Dtxt .= $fechadocu_mes;
          ...
          $Dtxt .= $fechadocu_min;
          $Dtxt .= $fechadocu_seg;
          $val[0]['ano'] = $fechadocu_ano;
          $val[0]['mes'] = $fechadocu_mes;
          $val[0]['dia'] = $fechadocu_dia;
          $val[0]['hor'] = $fechadocu_hor;
          $val[0]['min'] = $fechadocu_min;
          $val[0]['seg'] = $fechadocu_seg;
          if ($fechadocu_cond == "BW")
          {
              $val[1]['ano'] = $fechadocu_input_2_ano;
              $val[1]['mes'] = $fechadocu_input_2_mes;
              $val[1]['dia'] = $fechadocu_input_2_dia;
              $val[1]['hor'] = $fechadocu_input_2_hor;
              $val[1]['min'] = $fechadocu_input_2_min;
              $val[1]['seg'] = $fechadocu_input_2_seg;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DH", "TIMESTAMP", $fechadocu_cond, "", "datahora");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $fechadocu = $val[0];
          $this->cmp_formatado['fechadocu'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['fechadocu'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['fechadocu'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          if ($fechadocu_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $fechadocu_input_2     = $val[1];
              $this->cmp_formatado['fechadocu_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechadocu_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['fechadocu_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['fechadocu_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY his"));
          }
          if (!empty($Dtxt) || $fechadocu_cond == "NU" || $fechadocu_cond == "NN"|| $fechadocu_cond == "EP"|| $fechadocu_cond == "NE")
          {
              $this->monta_condicao("fechadocu", $fechadocu_cond, $fechadocu, $fechadocu_input_2, 'fechadocu', 'TIMESTAMP');
          }
      }
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']['fechaven_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_self']['cond_pesq'] .= $this->NM_operador;
