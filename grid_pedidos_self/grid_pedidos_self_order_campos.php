<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_pedidos_self']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_pedidos_self_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pedidos_self_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['prefijo_ped'] = "on";
   $tab_def_campos['prefijo_ped'] = "prefijo_ped";
   $tab_labels["prefijo_ped"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["prefijo_ped"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["prefijo_ped"] : "PJ";
   $tab_ger_campos['numpedido'] = "on";
   $tab_def_campos['numpedido'] = "numpedido";
   $tab_labels["numpedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["numpedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["numpedido"] : "Numero";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["credito"] : "Credito";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['subtotal'] = "on";
   $tab_def_campos['subtotal'] = "subtotal";
   $tab_labels["subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["subtotal"] : "Subtotal";
   $tab_ger_campos['valoriva'] = "on";
   $tab_def_campos['valoriva'] = "valoriva";
   $tab_labels["valoriva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["valoriva"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["valoriva"] : "Valoriva";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["total"] : "Total";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["observaciones"] : "Observaciones";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["saldo"] : "Saldo";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["vendedor"] : "Vendedor";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['fechadocu'] = "on";
   $tab_def_campos['fechadocu'] = "fechadocu";
   $tab_labels["fechadocu"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["fechadocu"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['labels']["fechadocu"] : "Creación";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pedidos_self_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pedidos_self']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
