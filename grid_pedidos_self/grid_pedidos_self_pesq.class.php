 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fechadocu_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechadocu'])) ? $this->New_label['fechadocu'] : "Creación"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_fechadocu_cond" name="fechadocu_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechadocu'), this, 'fechadocu')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fechadocu" <?php echo $str_hide_fechadocu?> valign="top">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fechadocu"  <?php echo $str_display_fechadocu; ?> class="scFilterFieldFontOdd">
...
?>
<INPUT  type="text" id="SC_idcli" name="idcli" value="<?php echo NM_encode_input($idcli) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idcli"  <?php echo $str_display_idcli; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idcli_input_2" name="idcli_input_2" value="<?php echo NM_encode_input($idcli_input_2) ?>"    size="10" class="sc-js-input scFilterObjectOdd">
