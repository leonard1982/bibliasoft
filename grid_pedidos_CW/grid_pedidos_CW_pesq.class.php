...
class grid_pedidos_CW_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_pedidos_CW_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_pedidos_CW_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_pedidos_CW_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_numpedido')
      {
          $numpedido = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_numpedido($numpedido);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_nremision')
      {
          $nremision = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_nremision($nremision);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_numpedido($numpedido)
   {
      $numpedido = substr($this->Db->qstr($numpedido), 1, -1);
            $numpedido_look = substr($this->Db->qstr($numpedido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and  numpedido like '%" . $numpedido . "%' order by numpedido"; 
   ...
   function lookup_ajax_numfacven($numfacven)
   {
      ...
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and   CAST (numfacven AS TEXT)  like '%" . $numfacven . "%' order by numfacven"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and   CAST (numfacven AS VARCHAR)  like '%" . $numfacven . "%' order by numfacven"; 
      }
      else
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and  numfacven like '%" . $numfacven . "%' order by numfacven"; 
      }
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
   ...
   function lookup_ajax_nremision($nremision)
   {
      $nremision = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $nremision);
      $nremision = substr($this->Db->qstr($nremision), 1, -1);
            $nremision_look = substr($this->Db->qstr($nremision), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct nremision from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and   CAST (nremision AS TEXT)  like '%" . $nremision . "%' order by nremision"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct nremision from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and   CAST (nremision AS VARCHAR)  like '%" . $nremision . "%' order by nremision"; 
      }
      else
      {
          $nm_comando = "select distinct nremision from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and  nremision like '%" . $nremision . "%' order by nremision"; 
      }
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idpedido";$Nm_numeric[] = "numfacven";$Nm_numeric[] = "nremision";$Nm_numeric[] = "credito";$Nm_numeric[] = "idcli";$Nm_numeric[] = "subtotal";$Nm_numeric[] = "valoriva";$Nm_numeric[] = "total";$Nm_numeric[] = "asentada";$Nm_numeric[] = "saldo";$Nm_numeric[] = "adicional";$Nm_numeric[] = "adicional2";$Nm_numeric[] = "adicional3";$Nm_numeric[] = "vendedor";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_pedidos_CW/grid_pedidos_CW_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_pedidos_CW_ajax_search.js"></script>
 <script type="text/javascript" src="grid_pedidos_CW_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_pedidos_CW_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pedidos_CW']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_pedidos_CW']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['ajax_nav'])
           { 
...
function scJQCalendarAdd() {
  ...
  $("#sc_creado_inicio_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_creado_inicio_dia').value + '/';
          var_dt_ini += document.getElementById('SC_creado_inicio_mes').value + '/';
          var_dt_ini += document.getElementById('SC_creado_inicio_ano').value;
          document.getElementById('sc_creado_inicio_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_creado_inicio_dia').value = aParts[0];
          document.getElementById('SC_creado_inicio_mes').value = aParts[1];
          document.getElementById('SC_creado_inicio_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_creado_fin_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_creado_fin_dia').value + '/';
          var_dt_ini += document.getElementById('SC_creado_fin_mes').value + '/';
          var_dt_ini += document.getElementById('SC_creado_fin_ano').value;
          document.getElementById('sc_creado_fin_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_creado_fin_dia').value = aParts[0];
          document.getElementById('SC_creado_fin_mes').value = aParts[1];
          document.getElementById('SC_creado_fin_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_numpedido_cond#NMF#' + search_get_sel_txt('SC_numpedido_cond') + '@NMF@';
  str_out += 'SC_numpedido#NMF#' + search_get_text('SC_numpedido') + '@NMF@';
  str_out += 'id_ac_numpedido#NMF#' + search_get_title('select2-id_ac_numpedido-container') + '@NMF@';
  ...
  str_out += 'SC_nremision_cond#NMF#' + search_get_sel_txt('SC_nremision_cond') + '@NMF@';
  str_out += 'SC_nremision#NMF#' + search_get_text('SC_nremision') + '@NMF@';
  str_out += 'id_ac_nremision#NMF#' + search_get_title('select2-id_ac_nremision-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-numpedido").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_numpedido",
      max_itens: "10",
   ...
   $("#SC_numpedido").val(e.params.data.id);
  });
  ...
  $(".sc-ui-autocomp-nremision").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_nremision",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_nremision").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Lista de pedidos</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $numpedido_cond, $numpedido, $numpedido_autocomp,
             $numfacven_cond, $numfacven, $numfacven_autocomp,
             $nremision_cond, $nremision, $nremision_autocomp,
             $creado_inicio_cond, $creado_inicio, $creado_inicio_dia, $creado_inicio_mes, $creado_inicio_ano, $creado_inicio_hor, $creado_inicio_min, $creado_inicio_seg,
             $creado_fin_cond, $creado_fin, $creado_fin_dia, $creado_fin_mes, $creado_fin_ano, $creado_fin_hor, $creado_fin_min, $creado_fin_seg,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_CW']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_CW']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_CW']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_pedidos_CW", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_cond']; 
          $numpedido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['numpedido']; 
          $numpedido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['numpedido_cond']; 
          $numfacven = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['numfacven']; 
          $numfacven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['numfacven_cond']; 
          $nremision = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['nremision']; 
          $nremision_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['nremision_cond']; 
          $creado_inicio_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_dia']; 
          $creado_inicio_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_mes']; 
          $creado_inicio_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_ano']; 
          $creado_inicio_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_hor']; 
          $creado_inicio_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_min']; 
          $creado_inicio_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_seg']; 
          $creado_inicio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_cond']; 
          $creado_fin_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_dia']; 
          $creado_fin_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_mes']; 
          $creado_fin_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_ano']; 
          $creado_fin_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_hor']; 
          $creado_fin_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_min']; 
          $creado_fin_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_seg']; 
          $creado_fin_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['NM_operador']; 
      } 
      if (!isset($fechaven_cond) || empty($fechaven_cond))
      {
         $fechaven_cond = "bw";
      }
      if (!isset($numpedido_cond) || empty($numpedido_cond))
      {
         $numpedido_cond = "qp";
      }
      ...
      if (!isset($nremision_cond) || empty($nremision_cond))
      {
         $nremision_cond = "qp";
      }
      if (!isset($creado_inicio_cond) || empty($creado_inicio_cond))
      {
         $creado_inicio_cond = "ge";
      }
      ...
      $str_hide_numpedido = (in_array($numpedido_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_numfacven = (in_array($numfacven_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_nremision = (in_array($nremision_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_numpedido = ('bw' == $numpedido_cond) ? $display_aberto : $display_fechado;
      $str_display_numfacven = ('bw' == $numfacven_cond) ? $display_aberto : $display_fechado;
      $str_display_nremision = ('bw' == $nremision_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($numpedido) || $numpedido == "")
      {
          $numpedido = "";
      }
      if (isset($numpedido) && !empty($numpedido))
      {
         $tmp_pos = strpos($numpedido, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $numpedido = substr($numpedido, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($nremision) || $nremision == "")
      {
          $nremision = "";
      }
      if (isset($nremision) && !empty($nremision))
      {
         $tmp_pos = strpos($nremision, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $nremision = substr($nremision, 0, $tmp_pos);
         }
      }
...
?>
      ...
      <TD id='SC_numpedido_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numpedido'])) ? $this->New_label['numpedido'] : "Número"; ?></TD>
      
      <INPUT type="hidden" id="SC_numpedido_cond" name="numpedido_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numpedido" <?php echo $str_hide_numpedido?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['numpedido'])) ? $this->New_label['numpedido'] : "Número";
 $nmgp_tab_label .= "numpedido?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $numpedido_look = substr($this->Db->qstr($numpedido), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numpedido from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and numpedido = '$numpedido_look' order by numpedido"; 
      foreach ($this->Ini->nm_col_dinamica as $nm_cada_col => $nm_nova_col)
      {
          $nm_comando = str_replace($nm_cada_col, $nm_nova_col, $nm_comando); 
      }
      ...
      if (isset($nmgp_def_dados[0][$numpedido]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$numpedido];
      }
      else
      {
          $sAutocompValue = $numpedido;
      }
?>
<INPUT  type="text" id="SC_numpedido" name="numpedido" value="<?php echo NM_encode_input($numpedido) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-numpedido" id="id_ac_numpedido" name="numpedido_autocomp"><?php if ('' !=  $numpedido) { ?><option value="<?php echo $numpedido ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_numfacven_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "Fac. No."; ?></TD>
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and numfacven = $numfacven_look order by numfacven"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct numfacven from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and numfacven = $numfacven_look order by numfacven"; 
...
?>
<INPUT  type="text" id="SC_numfacven" name="numfacven" value="<?php echo NM_encode_input($numfacven) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numfacven" id="id_ac_numfacven" name="numfacven_autocomp"><?php if ('' !=  $numfacven) { ?><option value="<?php echo $numfacven ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_nremision_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nremision'])) ? $this->New_label['nremision'] : "Remisión #"; ?></TD>
      
      <INPUT type="hidden" id="SC_nremision_cond" name="nremision_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nremision" <?php echo $str_hide_nremision?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['nremision'])) ? $this->New_label['nremision'] : "Remisión #";
 $nmgp_tab_label .= "nremision?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $nremision_look = substr($this->Db->qstr($nremision), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($nremision))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct nremision from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and nremision = $nremision_look order by nremision"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct nremision from " . $this->Ini->nm_tabela . " where tipo_doc='PV' and nremision = $nremision_look order by nremision"; 
      ...
      if (isset($nmgp_def_dados[0][$nremision]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$nremision];
      }
      else
      {
            nmgp_Form_Num_Val($nremision, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $nremision;
      }
?>
<INPUT  type="text" id="SC_nremision" name="nremision" value="<?php echo NM_encode_input($nremision) ?>" size=20 alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nremision" id="id_ac_nremision" name="nremision_autocomp"><?php if ('' !=  $nremision) { ?><option value="<?php echo $nremision ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_creado_inicio_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['creado_inicio'])) ? $this->New_label['creado_inicio'] : "Fecha y hora inicio"; ?></TD>
      
      <INPUT type="hidden" id="SC_creado_inicio_cond" name="creado_inicio_cond" value="ge">
     ...
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_creado_inicio" <?php echo $str_hide_creado_inicio?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['creado_inicio'])) ? $this->New_label['creado_inicio'] : "Fecha y hora inicio";
...
<?php
  $date_format_show = 'dd/mm/aaaa hh:ii';
  $date_format_show = str_replace("dd",   $this->Ini->Nm_lang['lang_othr_date_days'], $date_format_show);
  $date_format_show = str_replace("mm",   $this->Ini->Nm_lang['lang_othr_date_mnth'], $date_format_show);
  $date_format_show = str_replace("yyyy", $this->Ini->Nm_lang['lang_othr_date_year'], $date_format_show);
  $date_format_show = str_replace("aaaa", $this->Ini->Nm_lang['lang_othr_date_year'], $date_format_show);
...
<INPUT type="hidden" id="sc_creado_inicio_jq">
</span>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_creado_fin_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['creado_fin'])) ? $this->New_label['creado_fin'] : "Fecha y hora fin"; ?></TD>
      
      <INPUT type="hidden" id="SC_creado_fin_cond" name="creado_fin_cond" value="le">
     ...
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_creado_fin" <?php echo $str_hide_creado_fin?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['creado_fin'])) ? $this->New_label['creado_fin'] : "Fecha y hora fin";
...
<INPUT type="hidden" id="sc_creado_fin_jq">
</span>
...
<?php
   if (is_file("grid_pedidos_CW_help.txt"))
   {
      $Arq_WebHelp = file("grid_pedidos_CW_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_CW']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_CW']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_CW']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_pedidos_CW']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.numpedido_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_numpedido'), document.F1.numpedido_cond, 'numpedido');
   document.F1.numpedido.value = "";
   document.F1.numpedido_autocomp.value = "";
   $('#select2-id_ac_numpedido-container').html('<?php echo $this->Val_init_numpedido['desc'] ?>');;
   ...
   document.F1.nremision_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_nremision'), document.F1.nremision_cond, 'nremision');
   document.F1.nremision.value = "";
   document.F1.nremision_autocomp.value = "";
   $('#select2-id_ac_nremision-container').html('<?php echo $this->Val_init_nremision['desc'] ?>');;
   document.F1.creado_inicio_cond.value = 'ge';
   ...
   document.F1.creado_fin_cond.value = 'le';
 ...
 {
    $('#SC_creado_fin_dia').bind('change', function() {sc_grid_pedidos_CW_valida_dia(this)});
    $('#SC_creado_fin_hor').bind('change', function() {sc_grid_pedidos_CW_valida_hora(this)});
    $('#SC_creado_fin_mes').bind('change', function() {sc_grid_pedidos_CW_valida_mes(this)});
    $('#SC_creado_fin_min').bind('change', function() {sc_grid_pedidos_CW_valida_min(this)});
    $('#SC_creado_inicio_dia').bind('change', function() {sc_grid_pedidos_CW_valida_dia(this)});
    $('#SC_creado_inicio_hor').bind('change', function() {sc_grid_pedidos_CW_valida_hora(this)});
    $('#SC_creado_inicio_mes').bind('change', function() {sc_grid_pedidos_CW_valida_mes(this)});
    $('#SC_creado_inicio_min').bind('change', function() {sc_grid_pedidos_CW_valida_min(this)});
    $('#SC_fechaven_dia').bind('change', function() {sc_grid_pedidos_CW_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_grid_pedidos_CW_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_grid_pedidos_CW_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_grid_pedidos_CW_valida_mes(this)});
 }
 function sc_grid_pedidos_CW_valida_dia(obj)
 {
 ...
 function sc_grid_pedidos_CW_valida_mes(obj)
 {
 ...
 function sc_grid_pedidos_CW_valida_hora(obj)
 {
 ...
 function sc_grid_pedidos_CW_valida_min(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_pedidos_CW";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_numpedido_cond'] = 'cond';
      $tp_fields['SC_numpedido'] = 'text_aut';
      $tp_fields['id_ac_numpedido'] = 'select2_aut';
      $tp_fields['SC_numfacven_cond'] = 'cond';
      $tp_fields['SC_numfacven'] = 'text_aut';
      $tp_fields['id_ac_numfacven'] = 'select2_aut';
      $tp_fields['SC_nremision_cond'] = 'cond';
      $tp_fields['SC_nremision'] = 'text_aut';
      $tp_fields['id_ac_nremision'] = 'select2_aut';
   ...
   function trata_campos()
   {
      global $fechaven_cond, $fechaven, $fechaven_dia, $fechaven_mes, $fechaven_ano, $fechaven_input_2_dia, $fechaven_input_2_mes, $fechaven_input_2_ano,
             ...
             $nremision_cond, $nremision, $nremision_autocomp,
             $creado_inicio_cond, $creado_inicio, $creado_inicio_dia, $creado_inicio_mes, $creado_inicio_ano, $creado_inicio_hor, $creado_inicio_min, $creado_inicio_seg,
             $creado_fin_cond, $creado_fin, $creado_fin_dia, $creado_fin_mes, $creado_fin_ano, $creado_fin_hor, $creado_fin_min, $creado_fin_seg, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($numpedido_autocomp) && empty($numpedido))
      {
          $numpedido = $numpedido_autocomp;
      }
      if (!empty($numfacven_autocomp) && empty($numfacven))
      {
          $numfacven = $numfacven_autocomp;
      }
      if (!empty($nremision_autocomp) && empty($nremision))
      {
          $nremision = $nremision_autocomp;
      }
      ...
      $numpedido_cond_salva = $numpedido_cond; 
      if (!isset($numpedido_input_2) || $numpedido_input_2 == "")
      {
          $numpedido_input_2 = $numpedido;
      }
      ...
      $nremision_cond_salva = $nremision_cond; 
      if (!isset($nremision_input_2) || $nremision_input_2 == "")
      {
          $nremision_input_2 = $nremision;
      }
      $creado_inicio_cond_salva = $creado_inicio_cond; 
      $creado_fin_cond_salva = $creado_fin_cond; 
      $this->nm_tira_mask($numpedido, "xxx");
      if ($numfacven_cond != "in")
      {
          nm_limpa_numero($numfacven, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($nremision_cond != "in")
      {
          nm_limpa_numero($nremision, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['numpedido'] = $numpedido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['numpedido_cond'] = $numpedido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['numfacven'] = $numfacven; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['numfacven_cond'] = $numfacven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['nremision'] = $nremision; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['nremision_cond'] = $nremision_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_dia'] = $creado_inicio_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_mes'] = $creado_inicio_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_ano'] = $creado_inicio_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_hor'] = $creado_inicio_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_min'] = $creado_inicio_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_seg'] = $creado_inicio_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_cond'] = $creado_inicio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_dia'] = $creado_fin_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_mes'] = $creado_fin_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_ano'] = $creado_fin_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_hor'] = $creado_fin_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_min'] = $creado_fin_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_seg'] = $creado_fin_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_cond'] = $creado_fin_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca'] = $Temp_Busca;
      }
      if ($numfacven_cond != "in" && $numfacven_cond != "bw" && !empty($numfacven) && !is_numeric($numfacven))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Fac. No.";
      }
      if ($numfacven_cond == "bw" && ((!empty($numfacven) && !is_numeric($numfacven)) || (!empty($numfacven_input_2) && !is_numeric($numfacven_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Fac. No.";
      }
      if ($nremision_cond != "in" && $nremision_cond != "bw" && !empty($nremision) && !is_numeric($nremision))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Remisión #";
      }
      if ($nremision_cond == "bw" && ((!empty($nremision) && !is_numeric($nremision)) || (!empty($nremision_input_2) && !is_numeric($nremision_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Remisión #";
      }
      if (!empty($this->Campos_Mens_erro)) 
    ...
    if ($numpedido != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['numpedido'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['numpedido'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['numpedido'] = $numpedido;
      }
      $nmgp_def_dados = array();
    if ($numfacven != '') {
      $numfacven_look = substr($this->Db->qstr($numfacven), 1, -1); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['nremision'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['nremision'] = $cmp1;
      }
      else
      {
          $cmp1 = $nremision;
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['fechaven_input_2'] = $val[1];
      ...
      //----- $numpedido
      $this->Date_part = false;
      if (isset($numpedido) || $numpedido_cond == "nu" || $numpedido_cond == "nn" || $numpedido_cond == "ep" || $numpedido_cond == "ne")
      {
         $this->monta_condicao("numpedido", $numpedido_cond, $numpedido, "", "numpedido");
      }
      ...
      //----- $nremision
      $this->Date_part = false;
      if (isset($nremision) || $nremision_cond == "nu" || $nremision_cond == "nn" || $nremision_cond == "ep" || $nremision_cond == "ne")
      {
         $this->monta_condicao("nremision", $nremision_cond, $nremision, "", "nremision");
      }
      ...
      if ($creado_inicio_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "ND", "", $creado_inicio_cond, "yyyy-mm-dd hh:ii:ss", "datahora");
          $creado_inicio = $val[0];
          $this->cmp_formatado['creado_inicio'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['creado_inicio'], "AAAA-MM-DD HH:II:SS");
          $this->cmp_formatado['creado_inicio'] = $this->nm_data->FormataSaida("d/m/Y h:i");
          if ($creado_inicio_cond == "BW")
          {
              $creado_inicio_input_2     = $val[1];
              $this->cmp_formatado['creado_inicio_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_inicio_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['creado_inicio_input_2'], "AAAA-MM-DD HH:II:SS");
              $this->cmp_formatado['creado_inicio_input_2'] = $this->nm_data->FormataSaida("d/m/Y h:i");
          }
          if (!empty($Dtxt) || $creado_inicio_cond == "NU" || $creado_inicio_cond == "NN"|| $creado_inicio_cond == "EP"|| $creado_inicio_cond == "NE")
          {
              $this->monta_condicao("fechadocu", $creado_inicio_cond, $creado_inicio, $creado_inicio_input_2, 'creado_inicio', '');
          }
      }
      ...
      if ($creado_fin_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "ND", "", $creado_fin_cond, "yyyy-mm-dd hh:ii:ss", "datahora");
          $creado_fin = $val[0];
          $this->cmp_formatado['creado_fin'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['creado_fin'], "AAAA-MM-DD HH:II:SS");
          $this->cmp_formatado['creado_fin'] = $this->nm_data->FormataSaida("d/m/Y h:i");
          if ($creado_fin_cond == "BW")
          {
              $creado_fin_input_2     = $val[1];
              $this->cmp_formatado['creado_fin_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']['creado_fin_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['creado_fin_input_2'], "AAAA-MM-DD HH:II:SS");
              $this->cmp_formatado['creado_fin_input_2'] = $this->nm_data->FormataSaida("d/m/Y h:i");
          }
          if (!empty($Dtxt) || $creado_fin_cond == "NU" || $creado_fin_cond == "NN"|| $creado_fin_cond == "EP"|| $creado_fin_cond == "NE")
          {
              $this->monta_condicao("fechadocu", $creado_fin_cond, $creado_fin, $creado_fin_input_2, 'creado_fin', '');
          }
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['where_pesq'];
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if ($nm_target == "modal")
      {
          ...
          $par_modal = "?script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&nmgp_outra_jan=true&nmgp_url_saida=modal&NMSC_modal=ok&";
           if ((isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['embutida_form_full']) || (isset($this->grid_emb_form_full) && $this->grid_emb_form_full))
           {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['iframe_print'] )
      {
          $target = "_parent";
      }
...
{
$_SESSION['scriptcase']['grid_pedidos_CW']['contr_erro'] = 'on';
...
;
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $vcostoprod[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $vcostoprod = false;
          $vcostoprod_erro = $this->Db->ErrorMsg();
      } 
;
						
						if(isset($vcostoprod[0][0]))
						{
							$vsqlinv2 = "INSERT 
								  inventario 
								  SET 
