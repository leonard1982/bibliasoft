...
class grid_pedidos_CW_res_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Res        = new grid_pedidos_CW_resumo("out");
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['pivot_tabular'];
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['arr_export']['data'];
