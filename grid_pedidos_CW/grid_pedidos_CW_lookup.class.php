...
//  
   ...
   {   
      ...
      $nm_comando = "select prefijo from resdian where Idres = '" . substr($this->Db->qstr($prefijo_ped), 1 , -1) . "' order by prefijo" ; 
      $conteudo = "" ; 
...
//  
   function lookup_facturado(&$conteudo , $numfacven, &$nm_array_retorno_lookup) 
   {
      ...
      { 
          ...
          $a = 0; 
          $x = 0; 
          $nm_tmp_campos_select = explode(",", "fac.numfacven, \" - \", res.prefijo"); 
...
//  
   ...
   {   
      ...
      $nm_comando = "select nombres from terceros where idtercero = $vendedor order by nombres, documento" ; 
      $conteudo = "" ; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rx = $this->Db->Execute($nm_comando)) 
