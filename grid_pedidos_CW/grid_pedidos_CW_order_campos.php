...
<?php
   ...
   $Ord_Cmp = new grid_pedidos_CW_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pedidos_CW_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["prefijo_ped"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["prefijo_ped"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["prefijo_ped"] : "PJ";
   $tab_ger_campos['numpedido'] = "on";
   $tab_def_campos['numpedido'] = "numpedido";
   $tab_labels["numpedido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["numpedido"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["numpedido"] : "Número";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["asentada"] : "Asentado";
   ...
   {
       $tab_def_campos['facturado'] = "SELECT sc_concat(fac.numfacven, " - ", res.prefijo) 
FROM facturaven fac
left join resdian res on fac.resolucion=res.Idres
WHERE idfacven = {numfacven} 
ORDER BY fac.numfacven, fac.resolucion";
   }
   $tab_labels["facturado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["facturado"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["facturado"] : "Facturado";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["fechaven"] : "Fecha";
   ...
   {
       $tab_def_campos['creado'] = "fechadocu";
   }
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["creado"] : "Creado";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["fechavenc"] : "Vence";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["total"] : "Total";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["vendedor"] : "Vendedor";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["imprimir"] : "Imprimir";
   ...
   $tab_labels["pos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["pos"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["pos"] : "POS";
   ...
   $tab_labels["cobrar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["cobrar"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["cobrar"] : "Cobrar";
   $tab_ger_campos['observaciones'] = "on";
   $tab_def_campos['observaciones'] = "observaciones";
   $tab_labels["observaciones"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["observaciones"])) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['labels']["observaciones"] : "Observaciones";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pedidos_CW_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pedidos_CW']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
