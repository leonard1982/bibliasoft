...
$_SESSION['scriptcase']['grid_pedidos_CW']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['arr_total']['vendedor'];
      }
      else
      {
          $this->array_total_vendedor = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['arr_total']['vendedor'] = $this->array_total_vendedor;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_order']['vendedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_order']['vendedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_order']['vendedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_display']['vendedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_display']['vendedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_display']['vendedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_display']['vendedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_display']['vendedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_display']['vendedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_pedidos_CW']['summarizing_fields_display']['vendedor'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_vendedor as $i_vendedor => $d_vendedor) {
           if (!in_array($i_vendedor, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_vendedor[6] ] = $d_vendedor[5];
               $this->comp_label[0][ $d_vendedor[6] ] = $d_vendedor[5];
           }
       }
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_valoriva, $sum_saldo, $quebra_vendedor, $quebra_vendedor_orig)
   {
      //----- Vendedor
      if (!isset($this->array_total_vendedor[$quebra_vendedor_orig]))
      {
         ...
         $this->array_total_vendedor[$quebra_vendedor_orig][2] = $sum_valoriva;
         $this->array_total_vendedor[$quebra_vendedor_orig][3] = $sum_saldo;
         $this->array_total_vendedor[$quebra_vendedor_orig][4] = 1;
         $this->array_total_vendedor[$quebra_vendedor_orig][5] = $quebra_vendedor;
         $this->array_total_vendedor[$quebra_vendedor_orig][6] = $quebra_vendedor_orig;
      }
      else
      {
         ...
         $this->array_total_vendedor[$quebra_vendedor_orig][2] += $sum_valoriva;
         $this->array_total_vendedor[$quebra_vendedor_orig][3] += $sum_saldo;
         $this->array_total_vendedor[$quebra_vendedor_orig][4]++;
      }
   }
...
$_SESSION['scriptcase']['grid_pedidos_CW']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->valoriva, $this->saldo, $this->vendedor, $this->vendedor_orig);
            }
   }
//
