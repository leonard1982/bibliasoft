...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fechaven";$Nm_datas[] = "fechaven";$Nm_datas[] = "fechavenc";$Nm_datas[] = "fechavenc";$Nm_numeric[] = "idpedido";$Nm_numeric[] = "numfacven";$Nm_numeric[] = "nremision";$Nm_numeric[] = "credito";$Nm_numeric[] = "idcli";$Nm_numeric[] = "subtotal";$Nm_numeric[] = "valoriva";$Nm_numeric[] = "total";$Nm_numeric[] = "asentada";$Nm_numeric[] = "saldo";$Nm_numeric[] = "adicional";$Nm_numeric[] = "adicional2";$Nm_numeric[] = "adicional3";$Nm_numeric[] = "vendedor";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_fechaven"  <?php echo $str_hide_fechaven?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_numpedido"  <?php echo $str_hide_numpedido?>><?php
      if ($numpedido != "")
      {
      $numpedido_look = substr($this->Db->qstr($numpedido), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_numfacven"  <?php echo $str_hide_numfacven?>><?php
      if ($numfacven != "")
      {
      $numfacven_look = substr($this->Db->qstr($numfacven), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nremision"  <?php echo $str_hide_nremision?>><?php
      if ($nremision != "")
      {
      $nremision_look = substr($this->Db->qstr($nremision), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_creado_inicio"  <?php echo $str_hide_creado_inicio?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_creado_fin"  <?php echo $str_hide_creado_fin?>>
<?php
  $date_format_show = 'dd/mm/aaaa hh:ii';
  $date_format_show = str_replace("dd",   $this->Ini->Nm_lang['lang_othr_date_days'], $date_format_show);
  $date_format_show = str_replace("mm",   $this->Ini->Nm_lang['lang_othr_date_mnth'], $date_format_show);
