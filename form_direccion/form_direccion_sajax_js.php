  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_direccion" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idter_
  function do_ajax_form_direccion_validate_idter_(iNumLinha)
  {
    var nomeCampo_idter_ = "idter_" + iNumLinha;
    var var_idter_ = scAjaxGetFieldText(nomeCampo_idter_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_idter_(var_idter_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_idter__cb);
  } // do_ajax_form_direccion_validate_idter_

  function do_ajax_form_direccion_validate_idter__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idter_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idter_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idter_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idter_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_idter__cb

  // ---------- Validate iddepar_
  function do_ajax_form_direccion_validate_iddepar_(iNumLinha)
  {
    var nomeCampo_iddepar_ = "iddepar_" + iNumLinha;
    var var_iddepar_ = scAjaxGetFieldSelect(nomeCampo_iddepar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_iddepar_(var_iddepar_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_iddepar__cb);
  } // do_ajax_form_direccion_validate_iddepar_

  function do_ajax_form_direccion_validate_iddepar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "iddepar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "iddepar_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "iddepar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "iddepar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_iddepar__cb

  // ---------- Validate idmuni_
  function do_ajax_form_direccion_validate_idmuni_(iNumLinha)
  {
    var nomeCampo_idmuni_ = "idmuni_" + iNumLinha;
    var var_idmuni_ = scAjaxGetFieldSelect(nomeCampo_idmuni_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_idmuni_(var_idmuni_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_idmuni__cb);
  } // do_ajax_form_direccion_validate_idmuni_

  function do_ajax_form_direccion_validate_idmuni__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idmuni_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idmuni_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idmuni_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idmuni_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_idmuni__cb

  // ---------- Validate ciudad_
  function do_ajax_form_direccion_validate_ciudad_(iNumLinha)
  {
    var nomeCampo_ciudad_ = "ciudad_" + iNumLinha;
    var var_ciudad_ = scAjaxGetFieldSelect(nomeCampo_ciudad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_ciudad_(var_ciudad_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_ciudad__cb);
  } // do_ajax_form_direccion_validate_ciudad_

  function do_ajax_form_direccion_validate_ciudad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "ciudad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "ciudad_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "ciudad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "ciudad_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_ciudad__cb

  // ---------- Validate direc_
  function do_ajax_form_direccion_validate_direc_(iNumLinha)
  {
    var nomeCampo_direc_ = "direc_" + iNumLinha;
    var var_direc_ = scAjaxGetFieldText(nomeCampo_direc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_direc_(var_direc_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_direc__cb);
  } // do_ajax_form_direccion_validate_direc_

  function do_ajax_form_direccion_validate_direc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "direc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "direc_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "direc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "direc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_direc__cb

  // ---------- Validate codigo_postal_
  function do_ajax_form_direccion_validate_codigo_postal_(iNumLinha)
  {
    var nomeCampo_codigo_postal_ = "codigo_postal_" + iNumLinha;
    var var_codigo_postal_ = scAjaxGetFieldSelect(nomeCampo_codigo_postal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_codigo_postal_(var_codigo_postal_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_codigo_postal__cb);
  } // do_ajax_form_direccion_validate_codigo_postal_

  function do_ajax_form_direccion_validate_codigo_postal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_postal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_postal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigo_postal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_postal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_codigo_postal__cb

  // ---------- Validate telefono_
  function do_ajax_form_direccion_validate_telefono_(iNumLinha)
  {
    var nomeCampo_telefono_ = "telefono_" + iNumLinha;
    var var_telefono_ = scAjaxGetFieldText(nomeCampo_telefono_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_telefono_(var_telefono_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_telefono__cb);
  } // do_ajax_form_direccion_validate_telefono_

  function do_ajax_form_direccion_validate_telefono__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "telefono_" + iLineNumber;
    }
    else
    {
      sFieldValid = "telefono_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "telefono_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "telefono_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_telefono__cb

  // ---------- Validate lenguaje_
  function do_ajax_form_direccion_validate_lenguaje_(iNumLinha)
  {
    var nomeCampo_lenguaje_ = "lenguaje_" + iNumLinha;
    var var_lenguaje_ = scAjaxGetFieldSelect(nomeCampo_lenguaje_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_lenguaje_(var_lenguaje_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_lenguaje__cb);
  } // do_ajax_form_direccion_validate_lenguaje_

  function do_ajax_form_direccion_validate_lenguaje__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "lenguaje_" + iLineNumber;
    }
    else
    {
      sFieldValid = "lenguaje_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lenguaje_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lenguaje_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_lenguaje__cb

  // ---------- Validate obs_
  function do_ajax_form_direccion_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_obs__cb);
  } // do_ajax_form_direccion_validate_obs_

  function do_ajax_form_direccion_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_obs__cb

  // ---------- Validate correo_
  function do_ajax_form_direccion_validate_correo_(iNumLinha)
  {
    var nomeCampo_correo_ = "correo_" + iNumLinha;
    var var_correo_ = scAjaxGetFieldText(nomeCampo_correo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_correo_(var_correo_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_correo__cb);
  } // do_ajax_form_direccion_validate_correo_

  function do_ajax_form_direccion_validate_correo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "correo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "correo_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "correo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "correo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_correo__cb

  // ---------- Validate correo_notificafe_
  function do_ajax_form_direccion_validate_correo_notificafe_(iNumLinha)
  {
    var nomeCampo_correo_notificafe_ = "correo_notificafe_" + iNumLinha;
    var var_correo_notificafe_ = scAjaxGetFieldText(nomeCampo_correo_notificafe_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_correo_notificafe_(var_correo_notificafe_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_correo_notificafe__cb);
  } // do_ajax_form_direccion_validate_correo_notificafe_

  function do_ajax_form_direccion_validate_correo_notificafe__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "correo_notificafe_" + iLineNumber;
    }
    else
    {
      sFieldValid = "correo_notificafe_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "correo_notificafe_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "correo_notificafe_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_validate_correo_notificafe__cb

  // ---------- Validate celular_notificafe_
  function do_ajax_form_direccion_validate_celular_notificafe_(iNumLinha)
  {
    var nomeCampo_celular_notificafe_ = "celular_notificafe_" + iNumLinha;
    var var_celular_notificafe_ = scAjaxGetFieldText(nomeCampo_celular_notificafe_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_validate_celular_notificafe_(var_celular_notificafe_, iNumLinha, var_script_case_init, do_ajax_form_direccion_validate_celular_notificafe__cb);
  } // do_ajax_form_direccion_validate_celular_notificafe_

  function do_ajax_form_direccion_validate_celular_notificafe__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "celular_notificafe_" + iLineNumber;
    }
    else
    {
      sFieldValid = "celular_notificafe_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "celular_notificafe_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "celular_notificafe_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
  ...
  {
    var var_iddepar_ = scAjaxGetFieldSelect("iddepar_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "idmuni_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_direccion_refresh_iddepar_(var_iddepar_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_direccion_refresh_iddepar__cb);
  } // do_ajax_form_direccion_refresh_iddepar_

  function do_ajax_form_direccion_refresh_iddepar__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_form_direccion_refresh_idmuni_();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_refresh_iddepar__cb

  // ---------- Refresh idmuni_
  function do_ajax_form_direccion_refresh_idmuni_(iSeqForm)
  {
    var var_idmuni_ = scAjaxGetFieldSelect("idmuni_" + iSeqForm);
    var var_nmgp_refresh_row = iSeqForm;
    var var_nmgp_refresh_fields = "ciudad__#fld#_codigo_postal_";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_direccion_refresh_idmuni_(var_idmuni_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_direccion_refresh_idmuni__cb);
  } // do_ajax_form_direccion_refresh_idmuni_

  function do_ajax_form_direccion_refresh_idmuni__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_direccion_refresh_idmuni__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_direccion_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_direccion_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_direccion_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_direccion_add_new_line_cb);
  } // do_ajax_form_direccion_add_new_line

  function do_ajax_form_direccion_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_direccion_add_new_line_cb
  ...
  function do_ajax_form_direccion_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_direccion_backup_line(var_iddireccion_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_direccion_backup_line_cb);
  } // do_ajax_form_direccion_backup_line

  function do_ajax_form_direccion_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_direccion_backup_line_cb

  function do_ajax_form_direccion_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_direccion_cancel_insert

  function do_ajax_form_direccion_cancel_update(iSeqVert)
  {
    do_ajax_form_direccion_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_direccion_cancel_update

  function do_ajax_form_direccion_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_direccion_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_direccion_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_direccion_table_refresh(var_iddireccion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_direccion_table_refresh_cb);
  } //  do_ajax_form_direccion_table_refresh

  function do_ajax_form_direccion_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.iddireccion_.value = scAjaxGetKeyValue("iddireccion_");
    ...
    scAjaxAlert(do_ajax_form_direccion_table_refresh_cb_after_alert);
  } // do_ajax_form_direccion_table_refresh_cb
  function do_ajax_form_direccion_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_direccion_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_direccion_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_direccion_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idter_ = scAjaxGetFieldText("idter_" + iNumLinha);
    var var_iddepar_ = scAjaxGetFieldSelect("iddepar_" + iNumLinha);
    var var_idmuni_ = scAjaxGetFieldSelect("idmuni_" + iNumLinha);
    var var_ciudad_ = scAjaxGetFieldSelect("ciudad_" + iNumLinha);
    var var_direc_ = scAjaxGetFieldText("direc_" + iNumLinha);
    var var_codigo_postal_ = scAjaxGetFieldSelect("codigo_postal_" + iNumLinha);
    var var_telefono_ = scAjaxGetFieldText("telefono_" + iNumLinha);
    var var_lenguaje_ = scAjaxGetFieldSelect("lenguaje_" + iNumLinha);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idter_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("iddepar_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idmuni_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("ciudad_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("direc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codigo_postal_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("telefono_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lenguaje_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_direccion_submit_form_cb_after_alert);
  } // do_ajax_form_direccion_submit_form_cb
  function do_ajax_form_direccion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_direccion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_direccion_navigate_form()
  {
    perform_ajax_form_direccion_navigate_form();
  }

  function perform_ajax_form_direccion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idter_" + iNavForm);
      scAjaxHideErrorDisplay("iddepar_" + iNavForm);
      scAjaxHideErrorDisplay("idmuni_" + iNavForm);
      scAjaxHideErrorDisplay("ciudad_" + iNavForm);
      scAjaxHideErrorDisplay("direc_" + iNavForm);
      scAjaxHideErrorDisplay("codigo_postal_" + iNavForm);
      scAjaxHideErrorDisplay("telefono_" + iNavForm);
      scAjaxHideErrorDisplay("lenguaje_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_direccion_navigate_form(var_iddireccion_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_direccion_navigate_form_cb);
  } // do_ajax_form_direccion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_direccion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddireccion_.value = scAjaxGetKeyValue("iddireccion_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_direccion_navigate_form_cb_after_alert);
  } // do_ajax_form_direccion_navigate_form_cb
  function do_ajax_form_direccion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_direccion_navigate_form_cb_after_alert
  function sc_hide_form_direccion_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idter_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "iddepar_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idmuni_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "ciudad_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "direc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_postal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "telefono_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lenguaje_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "obs_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "correo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "correo_notificafe_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_field_mult["ciudad_"][iNumLinha] = "ciudad_" + iNumLinha;
    ajax_field_mult["direc_"][iNumLinha] = "direc_" + iNumLinha;
    ajax_field_mult["codigo_postal_"][iNumLinha] = "codigo_postal_" + iNumLinha;
    ajax_field_mult["telefono_"][iNumLinha] = "telefono_" + iNumLinha;
    ajax_field_mult["lenguaje_"][iNumLinha] = "lenguaje_" + iNumLinha;
    ...
    ajax_field_id["direc_" + iNumLinha] = new Array("hidden_field_label_direc_", "hidden_field_data_direc_" + iNumLinha);
    ajax_field_id["codigo_postal_" + iNumLinha] = new Array("hidden_field_label_codigo_postal_", "hidden_field_data_codigo_postal_" + iNumLinha);
    ajax_field_id["telefono_" + iNumLinha] = new Array("hidden_field_label_telefono_", "hidden_field_data_telefono_" + iNumLinha);
    ajax_field_id["obs_" + iNumLinha] = new Array("hidden_field_label_obs_", "hidden_field_data_obs_" + iNumLinha);
    ajax_field_id["correo_" + iNumLinha] = new Array("hidden_field_label_correo_", "hidden_field_data_correo_" + iNumLinha);
    ajax_field_id["correo_notificafe_" + iNumLinha] = new Array("hidden_field_label_correo_notificafe_", "hidden_field_data_correo_notificafe_" + iNumLinha);
    ajax_field_id["celular_notificafe_" + iNumLinha] = new Array("hidden_field_label_celular_notificafe_", "hidden_field_data_celular_notificafe_" + iNumLinha);
    ajax_error_count["idter_" + iNumLinha] = "off";
    ajax_error_count["iddepar_" + iNumLinha] = "off";
    ajax_error_count["idmuni_" + iNumLinha] = "off";
    ajax_error_count["ciudad_" + iNumLinha] = "off";
    ajax_error_count["direc_" + iNumLinha] = "off";
    ajax_error_count["codigo_postal_" + iNumLinha] = "off";
    ajax_error_count["telefono_" + iNumLinha] = "off";
    ajax_error_count["lenguaje_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idter_" + iNumLinha] = "off";
    ajax_read_only["iddepar_" + iNumLinha] = "off";
    ajax_read_only["idmuni_" + iNumLinha] = "off";
    ajax_read_only["ciudad_" + iNumLinha] = "off";
    ajax_read_only["direc_" + iNumLinha] = "off";
    ajax_read_only["codigo_postal_" + iNumLinha] = "off";
    ajax_read_only["telefono_" + iNumLinha] = "off";
    ajax_read_only["lenguaje_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idter_" + iNumLinha] = "on";
    ajax_read_only["iddepar_" + iNumLinha] = "on";
    ajax_read_only["idmuni_" + iNumLinha] = "on";
    ajax_read_only["ciudad_" + iNumLinha] = "on";
    ajax_read_only["direc_" + iNumLinha] = "on";
    ajax_read_only["codigo_postal_" + iNumLinha] = "on";
    ajax_read_only["telefono_" + iNumLinha] = "on";
    ajax_read_only["lenguaje_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idter_" + iNumLinha] = null;
    ajax_error_list["iddepar_" + iNumLinha] = null;
    ajax_error_list["idmuni_" + iNumLinha] = null;
    ajax_error_list["ciudad_" + iNumLinha] = null;
    ajax_error_list["direc_" + iNumLinha] = null;
    ajax_error_list["codigo_postal_" + iNumLinha] = null;
    ajax_error_list["telefono_" + iNumLinha] = null;
    ajax_error_list["lenguaje_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idter_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idter_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idter_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idter_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idter_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["iddepar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["iddepar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["iddepar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["iddepar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["iddepar_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idmuni_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idmuni_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idmuni_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idmuni_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idmuni_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["ciudad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["ciudad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["ciudad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["ciudad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["ciudad_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["direc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["direc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["direc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["direc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["direc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["codigo_postal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_postal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_postal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_postal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_postal_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["telefono_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["telefono_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["telefono_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["telefono_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["telefono_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["lenguaje_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lenguaje_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lenguaje_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lenguaje_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lenguaje_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["correo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["correo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["correo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["correo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["correo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["correo_notificafe_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["correo_notificafe_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["correo_notificafe_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["correo_notificafe_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["correo_notificafe_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["celular_notificafe_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["celular_notificafe_" + iNumLinha]["onblur"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idter_'])) ? $this->nmgp_cmp_readonly['idter_'] : 'off';
?>
    scAjaxFieldRead("idter_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['iddepar_'])) ? $this->nmgp_cmp_readonly['iddepar_'] : 'off';
?>
    scAjaxFieldRead("iddepar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idmuni_'])) ? $this->nmgp_cmp_readonly['idmuni_'] : 'off';
?>
    scAjaxFieldRead("idmuni_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['ciudad_'])) ? $this->nmgp_cmp_readonly['ciudad_'] : 'off';
?>
    scAjaxFieldRead("ciudad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['direc_'])) ? $this->nmgp_cmp_readonly['direc_'] : 'off';
?>
    scAjaxFieldRead("direc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_postal_'])) ? $this->nmgp_cmp_readonly['codigo_postal_'] : 'off';
?>
    scAjaxFieldRead("codigo_postal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['telefono_'])) ? $this->nmgp_cmp_readonly['telefono_'] : 'off';
?>
    scAjaxFieldRead("telefono_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lenguaje_'])) ? $this->nmgp_cmp_readonly['lenguaje_'] : 'off';
?>
    scAjaxFieldRead("lenguaje_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['correo_'])) ? $this->nmgp_cmp_readonly['correo_'] : 'off';
?>
    scAjaxFieldRead("correo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['correo_notificafe_'])) ? $this->nmgp_cmp_readonly['correo_notificafe_'] : 'off';
?>
    scAjaxFieldRead("correo_notificafe_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idter_" + iSeq, "on");
    scAjaxFieldRead("iddepar_" + iSeq, "on");
    scAjaxFieldRead("idmuni_" + iSeq, "on");
    scAjaxFieldRead("ciudad_" + iSeq, "on");
    scAjaxFieldRead("direc_" + iSeq, "on");
    scAjaxFieldRead("codigo_postal_" + iSeq, "on");
    scAjaxFieldRead("telefono_" + iSeq, "on");
    scAjaxFieldRead("lenguaje_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idter_" + iRow] || "on" == ajax_error_count["iddepar_" + iRow] || "on" == ajax_error_count["idmuni_" + iRow] || "on" == ajax_error_count["ciudad_" + iRow] || "on" == ajax_error_count["direc_" + iRow] || "on" == ajax_error_count["codigo_postal_" + iRow] || "on" == ajax_error_count["telefono_" + iRow] || "on" == ajax_error_count["lenguaje_" + iRow] || "on" == ajax_error_count["obs_" + iRow] || "on" == ajax_error_count["correo_" + iRow] || "on" == ajax_error_count["correo_notificafe_" + iRow] || "on" == ajax_error_count["celular_notificafe_" + iRow]))
    {
      ...
      $("#hidden_field_data_idter_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_iddepar_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idmuni_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_ciudad_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_direc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codigo_postal_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_telefono_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lenguaje_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idter_" + iRow] && "off" == ajax_error_count["iddepar_" + iRow] && "off" == ajax_error_count["idmuni_" + iRow] && "off" == ajax_error_count["ciudad_" + iRow] && "off" == ajax_error_count["direc_" + iRow] && "off" == ajax_error_count["codigo_postal_" + iRow] && "off" == ajax_error_count["telefono_" + iRow] && "off" == ajax_error_count["lenguaje_" + iRow] && "off" == ajax_error_count["obs_" + iRow] && "off" == ajax_error_count["correo_" + iRow] && "off" == ajax_error_count["correo_notificafe_" + iRow] && "off" == ajax_error_count["celular_notificafe_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idter_" + iRow] = "off";
        ajax_error_count["iddepar_" + iRow] = "off";
        ajax_error_count["idmuni_" + iRow] = "off";
        ajax_error_count["ciudad_" + iRow] = "off";
        ajax_error_count["direc_" + iRow] = "off";
        ajax_error_count["codigo_postal_" + iRow] = "off";
        ajax_error_count["telefono_" + iRow] = "off";
        ajax_error_count["lenguaje_" + iRow] = "off";
      ...
      $("#hidden_field_data_idter_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_iddepar_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idmuni_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_ciudad_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_direc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codigo_postal_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_telefono_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lenguaje_" + iRow).removeClass("scFormErrorLine");
