<?php
class form_direccion_form extends form_direccion_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_direccion/form_direccion_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_direccion_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_direccion_jquery.php');
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_direccion_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_direccion'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_direccion'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['empty_filter'] = true;
       }
       echo "<tr><td>";
  }
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_direccion);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_direccion = $this->form_vert_form_direccion;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_direccion))
   {
       $sc_seq_vert = 0;
   }
   ...
   foreach ($this->form_vert_form_direccion as $sc_seq_vert => $sc_lixo)
   {
       ...
       elseif ($Line_Add)
       {
        ...
        $this->idter_ = $this->form_vert_form_direccion[$sc_seq_vert]['idter_']; 
       $idter_ = $this->idter_; 
       if (!isset($this->nmgp_cmp_hidden['idter_']))
       {
           $this->nmgp_cmp_hidden['idter_'] = 'off';
       ...
       $this->iddepar_ = $this->form_vert_form_direccion[$sc_seq_vert]['iddepar_']; 
       ...
       $this->idmuni_ = $this->form_vert_form_direccion[$sc_seq_vert]['idmuni_']; 
       ...
       $this->ciudad_ = $this->form_vert_form_direccion[$sc_seq_vert]['ciudad_']; 
       ...
       $this->direc_ = $this->form_vert_form_direccion[$sc_seq_vert]['direc_']; 
       $direc_ = $this->direc_; 
       ...
       $this->codigo_postal_ = $this->form_vert_form_direccion[$sc_seq_vert]['codigo_postal_']; 
       ...
       $this->telefono_ = $this->form_vert_form_direccion[$sc_seq_vert]['telefono_']; 
       ...
       $this->lenguaje_ = $this->form_vert_form_direccion[$sc_seq_vert]['lenguaje_']; 
       ...
       $this->obs_ = $this->form_vert_form_direccion[$sc_seq_vert]['obs_']; 
       $obs_ = $this->obs_; 
       ...
       $this->correo_ = $this->form_vert_form_direccion[$sc_seq_vert]['correo_']; 
       ...
       $this->correo_notificafe_ = $this->form_vert_form_direccion[$sc_seq_vert]['correo_notificafe_']; 
       ...
       $this->celular_notificafe_ = $this->form_vert_form_direccion[$sc_seq_vert]['celular_notificafe_']; 
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_direccion_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_direccion_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_direccion_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_direccion_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_direccion_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_direccion_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_iddepar_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_iddepar_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_iddepar_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_iddepar_'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_iddepar_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_idmuni_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_idmuni_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_idmuni_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_idmuni_'] = array(); 
}
if ($this->iddepar_ != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_idmuni_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_ciudad_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_ciudad_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_ciudad_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_ciudad_'] = array(); 
}
if ($this->idmuni_ != "")
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_ciudad_'][] = $rs->fields[0];
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_codigo_postal_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_codigo_postal_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_codigo_postal_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_codigo_postal_'] = array(); 
}
if ($this->idmuni_ != "")
{ 
   $this->nm_clear_val("idmuni_");
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_codigo_postal_'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_lenguaje_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_lenguaje_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_lenguaje_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_lenguaje_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['Lookup_lenguaje_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php   
   ...
   { 
       ...
       $this->form_vert_form_direccion = $guarda_form_vert_form_direccion;
   } 
   if ($Table_refresh) 
   { 
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['btn_label']['last'];
        }
?>
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['masterValue']))
{
...
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_direccion");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_direccion");
 parent.scAjaxDetailHeight("form_direccion", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['sc_modal'])
{
?>
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			...
			do_ajax_form_direccion_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_direccion']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
