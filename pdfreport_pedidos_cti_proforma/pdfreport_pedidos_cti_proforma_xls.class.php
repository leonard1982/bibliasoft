...
class pdfreport_pedidos_cti_proforma_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "pdfreport_pedidos_cti_proforma/pdfreport_pedidos_cti_proforma_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "pdfreport_pedidos_cti_proforma_res_xls.class.php");
              $this->Res_xls = new pdfreport_pedidos_cti_proforma_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_pdfreport_pedidos_cti_proforma.zip";
          $this->Arquivo   .= "_pdfreport_pedidos_cti_proforma" . $this->Xls_tp;
          $this->Tit_doc    = "pdfreport_pedidos_cti_proforma" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['pdfreport_pedidos_cti_proforma']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
...
$_SESSION['scriptcase']['pdfreport_pedidos_cti_proforma']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_idpedido()
   {
         ...
         if (is_numeric($this->idpedido))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idpedido);
         $this->Xls_col++;
   }
   //----- numfacven
   ...
   function NM_export_obspago()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->obspago, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->obspago, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vendedor
   ...
   function NM_export_dircliente()
   {
         ...
         if (is_numeric($this->look_dircliente))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_dircliente);
         $this->Xls_col++;
   }
   //----- numpedido
   function NM_export_numpedido()
   {
         ...
         if (is_numeric($this->numpedido))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->numpedido);
         $this->Xls_col++;
   }
   //----- prefijo_ped
   function NM_export_prefijo_ped()
   {
         ...
         if (is_numeric($this->look_prefijo_ped))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_prefijo_ped);
         $this->Xls_col++;
   }
   //----- logo
   ...
   function NM_export_d_v()
   {
         ...
         if (is_numeric($this->d_v))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->d_v);
         $this->Xls_col++;
   }
   //----- detallepedido
   function NM_export_detallepedido()
   {
         ...
         if (is_numeric($this->detallepedido))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_unidad()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detallepedido_unidad, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detallepedido_unidad, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_valorunita()
   {
         ...
         if (is_numeric($this->detallepedido_valorunita))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_valorunita);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_parcial()
   {
         ...
         if (is_numeric($this->detallepedido_parcial))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_parcial);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_iddet()
   {
         ...
         if (is_numeric($this->detallepedido_fl_iddet))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_iddet);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_idpedid()
   {
         ...
         if (is_numeric($this->detallepedido_fl_idpedid))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_idpedid);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_idpro()
   {
         ...
         if (is_numeric($this->detallepedido_fl_idpro))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_idpro);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_j_nompro()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detallepedido_j_nompro, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detallepedido_j_nompro, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_j_codigobar()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detallepedido_j_codigobar, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detallepedido_j_codigobar, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_unidadmayor()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_unidadmayor, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_unidadmayor, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_factor()
   {
         ...
         if (is_numeric($this->detallepedido_fl_factor))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_factor);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_idbod()
   {
         ...
         if (is_numeric($this->detallepedido_fl_idbod))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_idbod);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_cantidad()
   {
         ...
         if (is_numeric($this->detallepedido_fl_cantidad))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_cantidad);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_iva()
   {
         ...
         if (is_numeric($this->detallepedido_fl_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_iva);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_adicional()
   {
         ...
         if (is_numeric($this->detallepedido_fl_adicional))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_adicional);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_adicional1()
   {
         ...
         if (is_numeric($this->detallepedido_fl_adicional1))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_adicional1);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_colores()
   {
         ...
         if (is_numeric($this->detallepedido_fl_colores))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_colores);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_tallas()
   {
         ...
         if (is_numeric($this->detallepedido_fl_tallas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_tallas);
         $this->Xls_col++;
   }
   ...
   function NM_export_detallepedido_fl_sabor()
   {
         ...
         if (is_numeric($this->detallepedido_fl_sabor))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->detallepedido_fl_sabor);
         $this->Xls_col++;
   }
   //----- idpedido
   ...
   //----- obspago
   function NM_sub_cons_obspago()
   {
         $this->obspago = html_entity_decode($this->obspago, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->obspago = strip_tags($this->obspago);
         $this->obspago = NM_charset_to_utf8($this->obspago);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->obspago;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
         $this->look_dircliente = NM_charset_to_utf8($this->look_dircliente);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_dircliente;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- numpedido
   function NM_sub_cons_numpedido()
   {
         $this->numpedido = NM_charset_to_utf8($this->numpedido);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->numpedido;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- prefijo_ped
   function NM_sub_cons_prefijo_ped()
   {
         $this->look_prefijo_ped = NM_charset_to_utf8($this->look_prefijo_ped);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_prefijo_ped;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- d_v
   function NM_sub_cons_d_v()
   {
         $this->d_v = NM_charset_to_utf8($this->d_v);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->d_v;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido
   function NM_sub_cons_detallepedido()
   {
         $this->detallepedido = NM_charset_to_utf8($this->detallepedido);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_unidad
   function NM_sub_cons_detallepedido_unidad()
   {
         $this->detallepedido_unidad = html_entity_decode($this->detallepedido_unidad, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detallepedido_unidad = strip_tags($this->detallepedido_unidad);
         $this->detallepedido_unidad = NM_charset_to_utf8($this->detallepedido_unidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_unidad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detallepedido_valorunita
   function NM_sub_cons_detallepedido_valorunita()
   {
         $this->detallepedido_valorunita = NM_charset_to_utf8($this->detallepedido_valorunita);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_valorunita;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_parcial
   function NM_sub_cons_detallepedido_parcial()
   {
         $this->detallepedido_parcial = NM_charset_to_utf8($this->detallepedido_parcial);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_parcial;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_iddet
   function NM_sub_cons_detallepedido_fl_iddet()
   {
         $this->detallepedido_fl_iddet = NM_charset_to_utf8($this->detallepedido_fl_iddet);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_iddet;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_idpedid
   function NM_sub_cons_detallepedido_fl_idpedid()
   {
         $this->detallepedido_fl_idpedid = NM_charset_to_utf8($this->detallepedido_fl_idpedid);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_idpedid;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_idpro
   function NM_sub_cons_detallepedido_fl_idpro()
   {
         $this->detallepedido_fl_idpro = NM_charset_to_utf8($this->detallepedido_fl_idpro);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_idpro;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_j_nompro
   function NM_sub_cons_detallepedido_j_nompro()
   {
         $this->detallepedido_j_nompro = html_entity_decode($this->detallepedido_j_nompro, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detallepedido_j_nompro = strip_tags($this->detallepedido_j_nompro);
         $this->detallepedido_j_nompro = NM_charset_to_utf8($this->detallepedido_j_nompro);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_j_nompro;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detallepedido_j_codigobar
   function NM_sub_cons_detallepedido_j_codigobar()
   {
         $this->detallepedido_j_codigobar = html_entity_decode($this->detallepedido_j_codigobar, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detallepedido_j_codigobar = strip_tags($this->detallepedido_j_codigobar);
         $this->detallepedido_j_codigobar = NM_charset_to_utf8($this->detallepedido_j_codigobar);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_j_codigobar;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_unidadmayor
   function NM_sub_cons_detallepedido_fl_unidadmayor()
   {
         $this->detallepedido_fl_unidadmayor = html_entity_decode($this->detallepedido_fl_unidadmayor, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->detallepedido_fl_unidadmayor = strip_tags($this->detallepedido_fl_unidadmayor);
         $this->detallepedido_fl_unidadmayor = NM_charset_to_utf8($this->detallepedido_fl_unidadmayor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_unidadmayor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_factor
   function NM_sub_cons_detallepedido_fl_factor()
   {
         $this->detallepedido_fl_factor = NM_charset_to_utf8($this->detallepedido_fl_factor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_factor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_idbod
   function NM_sub_cons_detallepedido_fl_idbod()
   {
         $this->detallepedido_fl_idbod = NM_charset_to_utf8($this->detallepedido_fl_idbod);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_idbod;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_cantidad
   function NM_sub_cons_detallepedido_fl_cantidad()
   {
         $this->detallepedido_fl_cantidad = NM_charset_to_utf8($this->detallepedido_fl_cantidad);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_cantidad;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_iva
   function NM_sub_cons_detallepedido_fl_iva()
   {
         $this->detallepedido_fl_iva = NM_charset_to_utf8($this->detallepedido_fl_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_adicional
   function NM_sub_cons_detallepedido_fl_adicional()
   {
         $this->detallepedido_fl_adicional = NM_charset_to_utf8($this->detallepedido_fl_adicional);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_adicional;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_adicional1
   function NM_sub_cons_detallepedido_fl_adicional1()
   {
         $this->detallepedido_fl_adicional1 = NM_charset_to_utf8($this->detallepedido_fl_adicional1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_adicional1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_colores
   function NM_sub_cons_detallepedido_fl_colores()
   {
         $this->detallepedido_fl_colores = NM_charset_to_utf8($this->detallepedido_fl_colores);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_colores;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_tallas
   function NM_sub_cons_detallepedido_fl_tallas()
   {
         $this->detallepedido_fl_tallas = NM_charset_to_utf8($this->detallepedido_fl_tallas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_tallas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- detallepedido_fl_sabor
   function NM_sub_cons_detallepedido_fl_sabor()
   {
         $this->detallepedido_fl_sabor = NM_charset_to_utf8($this->detallepedido_fl_sabor);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->detallepedido_fl_sabor;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_chart_titl'] ?> - pedidos :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_pedidos_cti_proforma']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
