...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_productos_galerias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_productos_galerias"]);
   }
