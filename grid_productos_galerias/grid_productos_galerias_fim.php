...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_galerias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_galerias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_galerias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_galerias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_galerias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_galerias']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_productos_galerias']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_productos_galerias</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_productos_galerias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_productos_galerias']['embutida_filho'] as $ind => $sc_init)
          {
