...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_reporte_caja_020521"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_reporte_caja_020521"]);
   }
