<?php
class grid_reporte_caja_020521_grid
{
   var $Ini;
   var $Erro;
   var $Db;
...
//--- 
 function monta_grid($linhas = 0)
 {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_init'])
   { 
        return; 
   } 
   $this->inicializa();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['charts_html'] = '';
   ...
   { 
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf_vert'])
            {
            } 
            else
            {
       ...
       $nmgrp_apl_opcao= (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['grid_reporte_caja_020521'])) ? "pdf" : $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'];
       unset ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['save_grid']);
       $this->grid();
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['print_all'] && empty($this->nm_grid_sem_reg) && ($Gera_res || $Gera_graf) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] != "sc_free_total")
       { 
       ...
       if (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "pdf")
       { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao_print'] == "print")
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao_ant'];
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao_print'] = "";
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'];
 }
...
//
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Ind_lig_mult'])) {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Ind_lig_mult'] = 0;
   }
   $this->Img_embbed      = false;
   $this->nm_data         = new nm_data("es");
   $this->pdf_label_group = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_pdf']['label_group'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_pdf']['label_group'] : "S";
   $this->pdf_all_cab     = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_pdf']['all_cab']))     ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_pdf']['all_cab'] : "N";
   $this->pdf_all_label   = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_pdf']['all_label']))   ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_pdf']['all_label'] : "N";
   ...
   $this->Css_Cmp = array();
   $NM_css = file($this->Ini->root . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_grid_" .strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css");
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'])
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Lig_Md5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Lig_Md5'] = array();
       }
   }
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != 'print')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Lig_Md5'] = array();
   }
   $this->force_toolbar = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['force_toolbar']))
   { 
       $this->force_toolbar = true;
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['force_toolbar']);
   } 
       $this->Tem_tab_vert = false;
   $this->width_tabula_quebra  = "0px";
   $this->width_tabula_display = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit'] != '')
   {
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit'] == "on")  {$_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit'] = "S";}
       if ($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit'] == "off") {$_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit'] = "N";}
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit'];
   }
   $this->grid_emb_form      = false;
   $this->grid_emb_form_full = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_form']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_form'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_form_full']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_form_full'])
       {
       ...
       else
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['mostra_edit'] = "N";
       }
   }
   if ($this->Ini->SC_Link_View || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'])
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['mostra_edit'] = "N";
   }
   $nm_tem_quebra = 0;
   ...
   $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['print_all'];
   if ($this->Print_All)
   {
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("grid_reporte_caja_020521", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
   ...
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['btn_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
       {
           $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
       }
   }
   $this->Proc_link_res = false;
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_resumo'])) 
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['doc_word'] || $this->Ini->sc_export_ajax_img)
   { 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "muda_qt_linhas")
   { 
       unset($rec);
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "muda_rec_linhas")
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] = "muda_qt_linhas";
   } 

   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['maximized']) {
       $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['dashboard_app'];
       if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_reporte_caja_020521'])) {
           $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_reporte_caja_020521'];
...
//
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'])
   { 
       include_once($this->Ini->path_embutida . "grid_reporte_caja_020521/grid_reporte_caja_020521_total.class.php"); 
   } 
   else 
   { 
       include_once($this->Ini->path_aplicacao . "grid_reporte_caja_020521_total.class.php"); 
   } 
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_pdf'] != "pdf")  
       { 
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_pdf'] = $_SESSION['scriptcase']['contr_link_emb'];
   } 
   ...
   if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_lin_grid']))
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_lin_grid'] = 10;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_col_grid'] = 1 ;  
   }   
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_lin_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['rows'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['rows']);
   }
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['cols']);
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['rows']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_lin_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['rows'];  
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_col_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['cols'];  
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "muda_qt_linhas") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao']  = "igual" ;  
       ...
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_lin_grid'] = $nmgp_quant_linhas ;  
       } 
       if (!empty($nmgp_quant_colunas)) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_col_grid'] = $nmgp_quant_colunas ;  
       } 
   }   
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_lin_grid'] * $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_col_grid']; 
   $this->nm_grid_slides_linha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_col_grid'];
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_select']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_select'] = array(); 
       } 
   }
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] == "sc_free_total") 
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_quebra']))  
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_quebra'] = array(); 
       } 
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_grid']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_desc'] = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_cmp']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_label'] = "";  
   }   
   if (!empty($nmgp_ordem))  
   { 
       ...
       { 
           ...
           foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_quebra'] as $campo => $resto) 
           {
               foreach($resto as $sqldef => $ordem) 
               {
                   ...
                   { 
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_quebra'][$campo][$nmgp_ordem] = $ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_cmp'] = $nmgp_ordem;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_label'] = trim($ordem);
                   }   
               }   
           }   
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_grid'] = $nmgp_ordem  ; 
           }
       }
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "ordem")  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] = "inicio" ;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_grid'])  
       { 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_desc'] != " desc")  
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_desc'] = " desc" ; 
           } 
           else   
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_desc'] = " asc" ;  
           } 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_desc'] = $this->Cmps_ord_def[$nmgp_ordem];  
       } 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_label'] = trim($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_desc']);  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_grid'];  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_cmp'] = $nmgp_ordem;  
   }  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] = 0 ;  
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final']  = 0 ;  
   }   
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_edit'])  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_edit'] = false;  
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "inicio") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] = "edit" ; 
       } 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   {   
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_pesq'] .= $this->nm_where_dinamico;
   }   
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_pesq_filtro'];
...
//--------- 
//
   $nmgp_opc_orig = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao']; 
   if (isset($rec)) 
   { 
       if ($rec == "ini") 
       { 
       ...
       elseif ($rec == "fim") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] = "final" ; 
       } 
       else 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] = "avanca" ; 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final'] = $rec; 
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final'] > 0) 
           { 
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final']-- ; 
           } 
       } 
   } 
   $this->NM_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao']; 
   if ($this->NM_opcao == "print") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao_print'] = "print" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao']       = "igual" ; 
...
// 
   ...
   $this->Tot->$Gb_geral();
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['tot_geral'][1];
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_dinamic']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_dinamic'] != $this->nm_where_dinamico)  
   { 
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['tot_geral']);
   } 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_dinamic'] = $this->nm_where_dinamico;  
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['tot_geral']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['where_pesq_ant'] || $nmgp_opc_orig == "edit") 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['tot_geral'][1] ;  
   $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['tot_geral'][1];
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid'] == "all") 
   { 
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid'] = $this->count_ger;
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao']       = "inicio";
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "pesq") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] = 0 ; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "final") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "retorna") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid']; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] < 0) 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] = 0 ; 
       } 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "avanca" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_total'] >  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final']) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao_print'] != "print" && substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'], 0, 7) != "detalhe" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf") 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] = "igual"; 
   } 
   $this->Rec_ini = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid']; 
   if ($this->Rec_ini < 0) 
   { 
       $this->Rec_ini = 0; 
   } 
   $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid'] + 1; 
   if ($this->Rec_fim > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_total']) 
   { 
       $this->Rec_fim = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_total']; 
   } 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] > 0) 
   { 
       $this->Rec_ini++ ; 
   } 
   $this->nmgp_reg_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio']; 
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] > 0) 
   { 
       $this->nmgp_reg_start--; 
   } 
...
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_grid']) 
        {
   ...
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ordem_desc']; 
   } 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['order_grid'] = $nmgp_order_by;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "pdf" || $this->Ini->Apl_paginacao == "FULL")
   {
   ...
   {
       $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, " . ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid'] + 2) . ", $this->nmgp_reg_start)" ; 
       $this->rs_grid = $this->Db->SelectLimit($nmgp_select, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid'] + 2, $this->nmgp_reg_start) ; 
   }  
   ...
   { 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final'] = $this->nmgp_reg_start ; 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['inicio'] != 0 && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf") 
       { 
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final']++ ; 
           $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final']; 
           $this->rs_grid->MoveNext(); 
           $this->fecha = $this->rs_grid->fields[0] ;  
       } 
   } 
   $this->nmgp_reg_inicial = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final'] + 1;
   $this->nmgp_reg_final   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final'] + $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid'];
   $this->nmgp_reg_final   = ($this->nmgp_reg_final > $this->count_ger) ? $this->count_ger : $this->nmgp_reg_final;
// 
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['doc_word'] && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['word_return']);
       ...
       if ($this->Ini->Proc_print && $this->Ini->Export_html_zip  && !$this->Ini->sc_export_ajax)
       {
           ...
           $this->pb->initialize();
           $this->pb->setReturnUrl("./");
           $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['print_return']);
           $this->pb->setTotalSteps($this->count_ger);
       }
       if (!$this->Ini->sc_export_ajax && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['pdf_res'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_pdf'] != "pdf")
       {
           //---------- Gauge ----------
?>
...
<?php
           ...
           $this->progress_pdf     = 0;
           $this->progress_res     = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['pivot_charts']) ? sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['pivot_charts']) : 0;
           ...
           if (-1 < $this->progress_grid)
           {
               ...
               grid_reporte_caja_020521_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
               grid_reporte_caja_020521_pdf_progress_call($this->Ini->path_js   . "\n", $this->Ini->Nm_lang);
               grid_reporte_caja_020521_pdf_progress_call($this->Ini->path_prod . "/img/\n", $this->Ini->Nm_lang);
               grid_reporte_caja_020521_pdf_progress_call($this->progress_tot   . "\n", $this->Ini->Nm_lang);
               ...
               grid_reporte_caja_020521_pdf_progress_call($this->progress_tot . "_#NM#_" . "1_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
...
$nm_saida->saida("                        <link rel=\"shortcut icon\" href=\"\">\r\n");
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'])
       { 
           $css_body = "";
       } 
       else 
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ajax_nav'] && !$this->Ini->sc_export_ajax)
       { 
           ...
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_reporte_caja_020521_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_reporte_caja_020521_ajax.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\" src=\"grid_reporte_caja_020521_message.js\"></script>\r\n");
           $nm_saida->saida("   <script type=\"text/javascript\">\r\n");
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] || $this->Ini->Apl_paginacao == "FULL")
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($this->count_ger) . ";\r\n");
           }
           else
           {
               $nm_saida->saida("   var scQtReg  = " . NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid']) . ";\r\n");
           }
           $gridWidthCorrection = '';
           ...
           $nm_saida->saida("   var gridHeaders = $(\".sc-ui-grid-header-row-grid_reporte_caja_020521-1\"), headerDisplayed = true;\r\n");
           ...
           $nm_saida->saida("   tableOriginal = document.getElementById(\"sc-ui-grid-body-4b2248bb\");\r\n");
           ...
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ancor_save']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ancor_save']))
           {
               $nm_saida->saida("       var catTopPosition = jQuery('#SC_ancor" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ancor_save'] . "').offset().top;\r\n");
               $nm_saida->saida("       jQuery('html, body').animate({scrollTop:catTopPosition}, 'fast');\r\n");
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ancor_save']);
           }
           if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
           {
     ...
     if (!$_SESSION['scriptcase']['proc_mobile']) { 
           ...
           $nm_saida->saida("       dataType: \"html\",\r\n");
           $nm_saida->saida("       url: \"grid_reporte_caja_020521_save_grid.php\",\r\n");
...
$nm_saida->saida("}\r\n");
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['num_css']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['num_css'] = rand(0, 1000);
       }
       $write_css = true;
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !$this->Print_All && $this->NM_opcao != "print" && $this->NM_opcao != "pdf")
       {
           $write_css = false;
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_pdf']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_pdf'])
       {
           $write_css = true;
       }
       if ($write_css) {$NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_caja_020521_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['num_css'] . '.css', 'w');}
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'])
       {
 ...
 { 
       ...
       elseif ($this->NM_opcao == "print" || $this->Print_All)
       {
           ...
           $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_reporte_caja_020521_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['num_css'] . '.css');
           foreach ($NM_css as $cada_css)
           {
       ...
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_imag_temp . "/sc_css_grid_reporte_caja_020521_grid_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['num_css'] . ".css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"../_lib/css/" . $_SESSION['scriptcase']['erro']['str_schema_dir'] . "\" type=\"text/css\" media=\"screen\" />\r\n");
       }
       ...
       if (!$write_css)
       {
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_grid_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
       }
       else
       {
           $nm_saida->saida("  <style type=\"text/css\">\r\n");
  ...
  if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf_vert'])
  {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && $this->Ini->nm_ger_css_emb)
   {
       ...
       foreach ($NM_css as $cada_css)
       {
           $cada_css = ".grid_reporte_caja_020521_" . substr($cada_css, 1);
              $nm_saida->saida("  " . str_replace("\r\n", "", $cada_css) . "\r\n");
       }
           $nm_saida->saida("  </style>\r\n");
   }
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'])
   { 
       if (!$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['doc_word'] && ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao_print'] == "print")) 
       {
           if ($this->Print_All) 
           {
               $nm_saida->saida(" <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
       ...
       {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
          $vertical_center = '';
           $nm_saida->saida("  <body class=\"" . $this->css_scGridPage . "\" " . $str_iframe_body . " style=\"" . $remove_margin . $vertical_center . $css_body . "\">\r\n");
       }
       $nm_saida->saida("  " . $this->Ini->Ajax_result_set . "\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && !$this->Print_All)
       { 
 ...
 {  
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_herda_css'] == "N")
   {
       if (($this->NM_opcao == "print" && $GLOBALS['nmgp_cor_print'] == "PB") || ($this->NM_opcao == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb") || ($_SESSION['scriptcase']['contr_link_emb'] == "pdf" &&  $GLOBALS['nmgp_tipo_pdf'] == "pb")) 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_reporte_caja_020521']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_reporte_caja_020521']) . "_";
           } 
       } 
       else 
       { 
           if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_reporte_caja_020521']))
           {
               $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_reporte_caja_020521']) . "_";
           } 
       }
   }
   $temp_css  = explode("/", $compl_css);
   ...
   $compl_css_emb = ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida']) ? "grid_reporte_caja_020521_" : "";
   $this->css_sep = " ";
   ...
   $this->css_res_label = $compl_css_emb . "css_res_label";
   $this->css_res_grid_line = $compl_css_emb . "css_res_grid_line";
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['rows_emb'] = 0;
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ini_cor_grid']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ini_cor_grid'] == "impar")
       {
           $this->Ini->qual_linha = "impar";
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ini_cor_grid']);
       }
   }
...
// 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['nom_docu'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['fecha'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nom_empresa'])) ? $this->New_label['nom_empresa'] : "nom_empresa"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['nom_empresa'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['direccion'])) ? $this->New_label['direccion'] : "direccion"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['direccion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['correo'])) ? $this->New_label['correo'] : "correo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['correo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['telefono'])) ? $this->New_label['telefono'] : "telefono"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['telefono'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et1'])) ? $this->New_label['et1'] : "et1"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et1'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['res'])) ? $this->New_label['res'] : "res"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['res'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et2'])) ? $this->New_label['et2'] : "et2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et2'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['documento'])) ? $this->New_label['documento'] : "documento"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['documento'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et3'])) ? $this->New_label['et3'] : "et3"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et3'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['rango'])) ? $this->New_label['rango'] : "rango"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['rango'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et4'])) ? $this->New_label['et4'] : "et4"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et4'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cant_fact'])) ? $this->New_label['cant_fact'] : "cant_fact"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['cant_fact'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et5'])) ? $this->New_label['et5'] : "et5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['total'])) ? $this->New_label['total'] : "total"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['total'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et6'])) ? $this->New_label['et6'] : "et6"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et6'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et7'])) ? $this->New_label['et7'] : "et7"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et7'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et8'])) ? $this->New_label['et8'] : "et8"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et8'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et9'])) ? $this->New_label['et9'] : "et9"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et9'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['can_efec'])) ? $this->New_label['can_efec'] : "can_efec"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['can_efec'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_efec'])) ? $this->New_label['med_efec'] : "med_efec"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['med_efec'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_efec'])) ? $this->New_label['porc_efec'] : "porc_efec"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['porc_efec'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tot_efec'])) ? $this->New_label['tot_efec'] : "tot_efec"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['tot_efec'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['c_tarj'])) ? $this->New_label['c_tarj'] : "c_tarj"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['c_tarj'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_tarj'])) ? $this->New_label['med_tarj'] : "med_tarj"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['med_tarj'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_tarj'])) ? $this->New_label['porc_tarj'] : "porc_tarj"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['porc_tarj'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tarjeta'])) ? $this->New_label['tarjeta'] : "tarjeta"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['tarjeta'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['c_cheq'])) ? $this->New_label['c_cheq'] : "c_cheq"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['c_cheq'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_cheq'])) ? $this->New_label['med_cheq'] : "med_cheq"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['med_cheq'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_cheq'])) ? $this->New_label['porc_cheq'] : "porc_cheq"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['porc_cheq'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['cheque'])) ? $this->New_label['cheque'] : "cheque"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['cheque'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['c_credito'])) ? $this->New_label['c_credito'] : "c_credito"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['c_credito'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['med_cred'])) ? $this->New_label['med_cred'] : "med_cred"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['med_cred'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['porc_credito'])) ? $this->New_label['porc_credito'] : "porc_credito"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['porc_credito'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['credito'])) ? $this->New_label['credito'] : "credito"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['credito'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et10'])) ? $this->New_label['et10'] : "et10"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et10'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['total_vtas'])) ? $this->New_label['total_vtas'] : "total_vtas"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['total_vtas'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_iva'])) ? $this->New_label['et_iva'] : "et_iva"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_base'])) ? $this->New_label['et_base'] : "et_base"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_base'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_val_iva'])) ? $this->New_label['et_val_iva'] : "et_val_iva"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_val_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['etiva_19'])) ? $this->New_label['etiva_19'] : "etiva_19"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['etiva_19'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['base19'])) ? $this->New_label['base19'] : "base19"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['base19'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['iva_19'])) ? $this->New_label['iva_19'] : "iva_19"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['iva_19'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['etiva_5'])) ? $this->New_label['etiva_5'] : "etiva_5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['etiva_5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['base5'])) ? $this->New_label['base5'] : "base5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['base5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['iva_5'])) ? $this->New_label['iva_5'] : "iva_5"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['iva_5'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['etexc_0'])) ? $this->New_label['etexc_0'] : "etexc_0"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['etexc_0'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['base0'])) ? $this->New_label['base0'] : "base0"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['base0'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['iva_0'])) ? $this->New_label['iva_0'] : "iva_0"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['iva_0'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_tot'])) ? $this->New_label['et_tot'] : "et_tot"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_tot'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tot_base'])) ? $this->New_label['tot_base'] : "tot_base"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['tot_base'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tot_iva'])) ? $this->New_label['tot_iva'] : "tot_iva"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['tot_iva'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et20'])) ? $this->New_label['et20'] : "et20"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et20'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_vac'])) ? $this->New_label['et_vac'] : "et_vac"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_vac'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_ic'])) ? $this->New_label['et_ic'] : "et_ic"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_ic'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['imp_consumo'])) ? $this->New_label['imp_consumo'] : "imp_consumo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['imp_consumo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_ic_dev'])) ? $this->New_label['et_ic_dev'] : "et_ic_dev"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_ic_dev'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['imp_consumo_dev'])) ? $this->New_label['imp_consumo_dev'] : "imp_consumo_dev"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['imp_consumo_dev'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_tot_inc'])) ? $this->New_label['et_tot_inc'] : "et_tot_inc"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_tot_inc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['tot_inc'])) ? $this->New_label['tot_inc'] : "tot_inc"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['tot_inc'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_vn'])) ? $this->New_label['et_vn'] : "et_vn"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_vn'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['venta_netas'])) ? $this->New_label['venta_netas'] : "venta_netas"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['venta_netas'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_reg'])) ? $this->New_label['et_reg'] : "et_reg"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_reg'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['vent_reg'])) ? $this->New_label['vent_reg'] : "vent_reg"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['vent_reg'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fac_anuladas'])) ? $this->New_label['fac_anuladas'] : "fac_anuladas"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['fac_anuladas'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['f_anul'])) ? $this->New_label['f_anul'] : "f_anul"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['f_anul'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_obs'])) ? $this->New_label['et_obs'] : "et_obs"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_obs'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['obs'])) ? $this->New_label['obs'] : "obs"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['obs'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_fech_imp'])) ? $this->New_label['et_fech_imp'] : "et_fech_imp"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_fech_imp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['fecha_imp'])) ? $this->New_label['fecha_imp'] : "fecha_imp"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['fecha_imp'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_ubic'])) ? $this->New_label['et_ubic'] : "et_ubic"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_ubic'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['ubicacion'])) ? $this->New_label['ubicacion'] : "ubicacion"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['ubicacion'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_equipo'])) ? $this->New_label['et_equipo'] : "et_equipo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_equipo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['nom_equipo'])) ? $this->New_label['nom_equipo'] : "nom_equipo"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['nom_equipo'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_serial'])) ? $this->New_label['et_serial'] : "et_serial"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_serial'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['serial'])) ? $this->New_label['serial'] : "serial"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['serial'] = $SC_Label; 
   $SC_Label = (isset($this->New_label['et_fin2'])) ? $this->New_label['et_fin2'] : "et_fin2"; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['labels']['et_fin2'] = $SC_Label; 
   if (!$this->grid_emb_form && isset($_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['grid_reporte_caja_020521']['lig_edit'];
   }
   if (!empty($this->nm_grid_sem_reg))
   {
       ...
       {
           $this->Lin_impressas++;
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_grid'])
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['cols_emb']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['cols_emb']))
               {
                   $cont_col = 0;
                   foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['field_order'] as $cada_field)
                   {
                       $cont_col++;
                   }
               ...
               {
                   $NM_span_sem_reg  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['cols_emb'];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['rows_emb']++;
           ...
           {
               $nm_saida->saida("<table id=\"apl_grid_reporte_caja_020521#?#$nm_seq_execucoes\" width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\">\r\n");
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridTabelaTd . " " . "\" style=\"font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\"><table style=\"padding: 0px; border-spacing: 0px; border-width: 0px; vertical-align: top;\" width=\"100%\">\r\n");
               $nm_id_aplicacao = "";
               $nm_saida->saida("  <tr><td class=\"" . $this->css_scGridFieldOdd . "\"  style=\"padding: 0px; font-family:" . $this->Ini->texto_fonte_tipo_impar . ";font-size:12px;color:#000000;\" colspan = \"78\" align=\"center\">\r\n");
       ...
       else
       {
           ...
           { 
               $this->force_toolbar = true;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['force_toolbar'] = true;
           } 
   ...
   { 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'])
{
}
else
{
       ...
       $nm_id_aplicacao = " id=\"apl_grid_reporte_caja_020521#?#1\"";
   } 
   $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "pdf") ? "padding: 0px !important;" : "";
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf_vert'])
{
}
else
{
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'])
   { 
...
{
   $nm_saida->saida("    <TABLE class=\"" . $this->css_scGridTabela . "\" id=\"sc-ui-grid-body-4b2248bb\" align=\"center\" width=\"100%\">\r\n");
}
// 
   $nm_quant_linhas = 0 ;
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Config_Page_break_PDF'] = "N";
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Page_break_PDF']))
   {
       if (isset($this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby']]))
       {
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] == "sc_free_group_by")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Gb_Free_cmp'] as $Cmp_gb => $resto)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Page_break_PDF'][$Cmp_gb] = $this->Break_pag_pdf['sc_free_group_by'][$Cmp_gb];
               }
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Page_break_PDF'] = $this->Break_pag_pdf[$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby']];
           }
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Page_break_PDF'] = array();
       }
   }
   ...
   while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['qt_reg_grid'] && ($linhas == 0 || $linhas > $this->Lin_impressas)) 
   {  
          ...
          //---------- Gauge ----------
          if (!$this->Ini->sc_export_ajax && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "pdf" && -1 < $this->progress_grid)
          {
              $this->progress_now++;
              if (0 == $this->progress_lim_now)
              {
               ...
               if (!NM_is_utf8($lang_protect))
               {
                  ...
                  grid_reporte_caja_020521_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $lang_protect . " " . $this->progress_now . "...\n", $this->Ini->Nm_lang);
          ...
          $this->fecha = $this->rs_grid->fields[0] ;  
          $this->SC_seq_page++; 
          $this->SC_seq_register = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final'] + 1; 
          if (!$ini_grid) {
...
$_SESSION['scriptcase']['grid_reporte_caja_020521']['contr_erro'] = 'off';
          ...
          $seq_det =  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['final']; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'])
          {
              $temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dado_psq_ret'];
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[0]) || $this->Ini->nm_hidden_blocos[0] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
     if ('' != $this->Ini->Block_img_exp && '' != $this->Ini->Block_img_col && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf")
     {
...
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_0_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_nom_docu_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nom_docu_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'nom_docu', $str_tem_display, $conteudo_original); 
          } 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_nom_empresa_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nom_empresa_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'nom_empresa', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_1_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
$nm_saida->saida("    <TD  style=\"border-width: 0px; border-style: none; \" height=\"\" valign=\"top\" width=\"100%\">\r\n");
$nm_saida->saida("     <TABLE style=\"padding: 0px; spacing: 0px; border-width: 0px; border-collapse:collapse;\" width=\"100%\">\r\n");
$nm_saida->saida("      <TR>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et1_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et1_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et1', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_res_grid_line . "\"  style=\"" . $this->Css_Cmp['css_res_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          $conteudo = sc_strip_script($this->res); 
          $conteudo_original = sc_strip_script($this->res); 
          if ($conteudo === "") 
          { 
              $conteudo = "&nbsp;" ;  
              $graf = "" ;  
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'res', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
          if (isset($this->NM_cmp_hidden['res']) && $this->NM_cmp_hidden['res'] == "off")
          {
              $conteudo = "&nbsp;";
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'])
...
$nm_saida->saida("     <span id=\"id_sc_field_res_" . $this->SC_seq_page . "\"><span >" . $conteudo . "</span></span>\r\n");
$nm_saida->saida("    </TD>\r\n");
$nm_saida->saida("   </tr><tr>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et2_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et2_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et2', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et3_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et3_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et3', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_rango_grid_line . "\"  style=\"" . $this->Css_Cmp['css_rango_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'rango', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et4_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et4_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et4', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_cant_fact_grid_line . "\"  style=\"" . $this->Css_Cmp['css_cant_fact_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'cant_fact', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et5_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et5_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et5', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[2]) || $this->Ini->nm_hidden_blocos[2] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_2_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et6_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et6_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et6', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et7_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et7_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et7', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et8_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et8_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et8', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et9_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et9_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et9', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_can_efec_grid_line . "\"  style=\"" . $this->Css_Cmp['css_can_efec_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'can_efec', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_med_efec_grid_line . "\"  style=\"" . $this->Css_Cmp['css_med_efec_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'med_efec', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_porc_efec_grid_line . "\"  style=\"" . $this->Css_Cmp['css_porc_efec_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porc_efec', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_tot_efec_grid_line . "\"  style=\"" . $this->Css_Cmp['css_tot_efec_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'tot_efec', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_c_tarj_grid_line . "\"  style=\"" . $this->Css_Cmp['css_c_tarj_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'c_tarj', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_med_tarj_grid_line . "\"  style=\"" . $this->Css_Cmp['css_med_tarj_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'med_tarj', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_porc_tarj_grid_line . "\"  style=\"" . $this->Css_Cmp['css_porc_tarj_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porc_tarj', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_c_cheq_grid_line . "\"  style=\"" . $this->Css_Cmp['css_c_cheq_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'c_cheq', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_med_cheq_grid_line . "\"  style=\"" . $this->Css_Cmp['css_med_cheq_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'med_cheq', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_porc_cheq_grid_line . "\"  style=\"" . $this->Css_Cmp['css_porc_cheq_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porc_cheq', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_cheque_grid_line . "\"  style=\"" . $this->Css_Cmp['css_cheque_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'cheque', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_c_credito_grid_line . "\"  style=\"" . $this->Css_Cmp['css_c_credito_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'c_credito', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_med_cred_grid_line . "\"  style=\"" . $this->Css_Cmp['css_med_cred_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'med_cred', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_porc_credito_grid_line . "\"  style=\"" . $this->Css_Cmp['css_porc_credito_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'porc_credito', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[3]) || $this->Ini->nm_hidden_blocos[3] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_3_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
$nm_saida->saida("    <TD  style=\"border-width: 0px; border-style: none; \" height=\"\" valign=\"top\" width=\"100%\">\r\n");
$nm_saida->saida("     <TABLE style=\"padding: 0px; spacing: 0px; border-width: 0px; border-collapse:collapse;\" width=\"100%\">\r\n");
$nm_saida->saida("      <TR>\r\n");
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et10_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et10_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et10', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_total_vtas_grid_line . "\"  style=\"" . $this->Css_Cmp['css_total_vtas_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'total_vtas', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[4]) || $this->Ini->nm_hidden_blocos[4] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_4_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_iva_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_iva_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_iva', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_base_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_base_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_base', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_val_iva_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_val_iva_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_val_iva', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_etiva_19_grid_line . "\"  style=\"" . $this->Css_Cmp['css_etiva_19_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'etiva_19', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_etiva_5_grid_line . "\"  style=\"" . $this->Css_Cmp['css_etiva_5_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'etiva_5', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_etexc_0_grid_line . "\"  style=\"" . $this->Css_Cmp['css_etexc_0_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'etexc_0', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_tot_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_tot_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_tot', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_tot_base_grid_line . "\"  style=\"" . $this->Css_Cmp['css_tot_base_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'tot_base', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_tot_iva_grid_line . "\"  style=\"" . $this->Css_Cmp['css_tot_iva_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'tot_iva', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[5]) || $this->Ini->nm_hidden_blocos[5] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_5_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et20_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et20_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et20', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_vac_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_vac_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_vac', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_ic_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_ic_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_ic', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_imp_consumo_grid_line . "\"  style=\"" . $this->Css_Cmp['css_imp_consumo_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'imp_consumo', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_ic_dev_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_ic_dev_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_ic_dev', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_imp_consumo_dev_grid_line . "\"  style=\"" . $this->Css_Cmp['css_imp_consumo_dev_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'imp_consumo_dev', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_tot_inc_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_tot_inc_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_tot_inc', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_tot_inc_grid_line . "\"  style=\"" . $this->Css_Cmp['css_tot_inc_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'tot_inc', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[6]) || $this->Ini->nm_hidden_blocos[6] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_6_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_vn_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_vn_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_vn', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_venta_netas_grid_line . "\"  style=\"" . $this->Css_Cmp['css_venta_netas_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'venta_netas', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_reg_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_reg_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_reg', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_vent_reg_grid_line . "\"  style=\"" . $this->Css_Cmp['css_vent_reg_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'vent_reg', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_fac_anuladas_grid_line . "\"  style=\"" . $this->Css_Cmp['css_fac_anuladas_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fac_anuladas', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_f_anul_grid_line . "\"  style=\"" . $this->Css_Cmp['css_f_anul_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'f_anul', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_obs_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_obs_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_obs', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[7]) || $this->Ini->nm_hidden_blocos[7] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_7_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_fech_imp_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_fech_imp_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_fech_imp', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_fecha_imp_grid_line . "\"  style=\"" . $this->Css_Cmp['css_fecha_imp_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'fecha_imp', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_ubic_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_ubic_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_ubic', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_equipo_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_equipo_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_equipo', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_nom_equipo_grid_line . "\"  style=\"" . $this->Css_Cmp['css_nom_equipo_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'nom_equipo', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_serial_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_serial_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_serial', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_serial_grid_line . "\"  style=\"" . $this->Css_Cmp['css_serial_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"top\"  >\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'serial', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    <table width=\"100%\" style=\"padding: 0px; border-spacing: 0px; border-width: 0px;\"><tr valign=\"top\"><td style=\"padding: 0px\" width=\"100%\" height=\"\">\r\n");
 if(!isset($this->Ini->nm_hidden_blocos[8]) || $this->Ini->nm_hidden_blocos[8] != "off")
 {
     ...
     $Img_tit_blk_f = "";
     $Collapse_blk  = "";
$nm_saida->saida("  <TABLE class=\"" . $this->css_scGridTabela . "\"  style=\"border-collapse:collapse;\" cellspacing=0px cellpadding=0px align=\"center\" id=\"grid_reporte_caja_020521_hidden_bloco_8_" . $this->nm_contr_album . "\" width=\"100%\" style=\"height: 100%\">\r\n");
$nm_saida->saida("   <TR>\r\n");
...
$nm_saida->saida("     <TD class=\"" . $this->css_line_back . $this->css_sep . $this->css_et_fin2_grid_line . "\"  style=\"" . $this->Css_Cmp['css_et_fin2_grid_line'] . "\" " . $this->SC_nowrap . " align=\"\" valign=\"middle\"   HEIGHT=\"0px\">\r\n");
          ...
          if(!empty($str_tem_display) && $str_tem_display != '&nbsp;' && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['proc_pdf'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && !empty($conteudo)) 
          { 
              $str_tem_display = $this->getFieldHighlight('quicksearch', 'et_fin2', $str_tem_display, $conteudo_original); 
          } 
              $conteudo = $str_tem_display; 
...
$nm_saida->saida("    </td></tr></table></td>\r\n");
   ...
   { 
       ...
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['exibe_total'] == "S")
       { 
           $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] . "_top";
           $this->$Gb_geral() ;
       } 
   }  
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida_grid'])
 ...
 function nm_quebra_pagina($nm_parms)
 {
    ...
    if (($this->Ini->nm_limite_lin > 0 && $this->Ini->nm_cont_lin > $this->Ini->nm_limite_lin) || $nm_parms == "pagina" || $nm_parms == "resumo" || $nm_parms == "total")
    {
        ...
        if ($this->Print_All)
        {
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['print_navigator']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['print_navigator'] == "Netscape")
            {
 ...
 function quebra_geral_sc_free_total_bot() 
 {
   ...
   function nmgp_barra_bot_normal()
   {
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $Tem_pdf_res = "n";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=PC&nm_cor=PB&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['pdf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
      $Tem_gb_pdf  = "s";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] == "sc_free_total")
      {
      ...
      $Tem_pdf_res = "n";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=" . s . "&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=4&password=n&summary_export_columns=N&pdf_zip=N&origem=cons&language=es&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_reporte_caja_020521&KeepThis=true&TB_iframe=true&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
      }
          if (is_file("grid_reporte_caja_020521_help.txt") && !$this->grid_emb_form)
          {
             $Arq_WebHelp = file("grid_reporte_caja_020521_help.txt"); 
      ...
      $nm_saida->saida("        </tr> \r\n");
      $nm_saida->saida("       </table> \r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ajax_nav'] && $this->force_toolbar)
      { 
   ...
   function nmgp_barra_top_mobile()
   {
      ...
      if (!$this->Ini->SC_Link_View && $this->nmgp_botoes['qsearch'] == "on")
      {
          ...
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][2] : "";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ajax_nav'])
          {
      ...
      $Tem_pdf_res = "n";
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "pdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&lpapel=0&apapel=0&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=XX&sc_ver_93=" . s . "&nm_tem_gb=" . $Tem_gb_pdf . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_pdf_res=grid&nm_all_modules=grid&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=4&password=n&summary_export_columns=N&pdf_zip=N&origem=cons&language=es&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_reporte_caja_020521&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['word'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_word_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] != "sc_free_total")
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "word_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=" . $Tem_word_res . "&nm_ini_word_res=grid&nm_all_modules=grid&password=n&origem=cons&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      if ($this->nmgp_botoes['xls'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xls_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['xml'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_xml_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['csv'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $Tem_csv_res = "n";
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['SC_Ind_Groupby'] != "sc_free_total")
      ...
      if ($this->nmgp_botoes['rtf'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
      ...
      if ($this->nmgp_botoes['print'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "print_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=PC&nm_cor=PB&password=n&language=es&nm_page=" . NM_encode_input($this->Ini->sc_page) . "&nm_res_cons=" . $Tem_pdf_res . "&nm_ini_prt_res=grid&nm_all_modules=grid&origem=cons&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if ($this->nmgp_botoes['sort_col'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'] && empty($this->nm_grid_sem_reg) && !$this->grid_emb_form)
      {
          ...
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bsort", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnOrderCamposShow('" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_order_campos.php?path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&use_alias=" . $UseAlias . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "ordcmp_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_2", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
              $NM_Gbtn = true;
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['b_sair'] || $this->grid_emb_form || $this->grid_emb_form_full || (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['dashboard_info']['under_dashboard']))
      {
         $this->nmgp_botoes['exit'] = "off"; 
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_psq'])
      ...
      {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_modal'])
        {
   ...
   function nmgp_barra_bot_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao_print'] != "print") 
      {
          if ($this->nmgp_botoes['first'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['back'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['nav']))
          {
              if ($this->Rec_ini == 0)
              {
          ...
          if ($this->nmgp_botoes['forward'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['nav']))
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcons_avanca", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "nm_gp_submit_rec('" . $this->Rec_fim . "');", "forward_bot", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
              $NM_btn = true;
          }
          if ($this->nmgp_botoes['last'] == "on" && empty($this->nm_grid_sem_reg) && $this->Ini->Apl_paginacao != "FULL" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['nav']))
          {
   ...
   function nmgp_embbed_placeholder_bot()
   {
    ...
    function getFieldHighlight($filter_type, $field, $str_value, $str_value_original='')
    {
        ...
        {
            if (
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ]) &&
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field . "_cond" ]) &&
                !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ]) &&
                (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field . "_cond"] == 'qp' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field . "_cond"] == 'eq' ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field . "_cond"] == 'ii'
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field . "_cond"] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $str_value = preg_replace('/'. $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ] .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field . "_cond"] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                ...
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field . "_cond"] == 'ii')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ], substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ]))) == 0)
                    {
                        $str_value = $str_html_ini. substr($str_value, 0, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ])) .$str_html_fim . substr($str_value, strlen($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campos_busca'][ $field ]));
                    }
                }
            }
        }
        ...
        {
            if(
                isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][0]) &&
                (
                    (
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][0] == 'SC_all_Cmp' &&
                    in_array($field, array('fecha', 'cantidad'))
                    ) ||
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][0] == $field ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][0], $field . '_VLS_') !== false ||
                    strpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][0], '_VLS_' . $field) !== false
                )
            )
            {
                if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][1] == 'qp')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    elseif(!empty($str_value_original) && $str_value_original != '&nbsp;' && strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][2], $str_value_original) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
                    }
                    else
                    {
                        $str_value = preg_replace('/'. $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][2] .'/i', $str_html_ini . '$0' . $str_html_fim, $str_value);
                    }
                }
                elseif($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][1] == 'eq')
                {
                    if(strcasecmp($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['fast_search'][2], $str_value) == 0)
                    {
                        $str_value = $str_html_ini. $str_value .$str_html_fim;
 ...
 function nm_fim_grid($flag_apaga_pdf_log = TRUE)
 {
   ...
   if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']))
   {
   ...
   $nm_saida->saida("   </body>\r\n");
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] == "pdf" || $this->Print_All)
   { 
   $nm_saida->saida("   </HTML>\r\n");
        return;
   } 
   ...
   if ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
   { 
   } 
   elseif ($this->Rec_ini == 0 && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
   { 
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ajax_nav'])
       {
   ...
   $nm_saida->saida("   if (typeof(scSetFixedHeaders) === typeof(function(){})) scSetFixedHeaders();\r\n");
   $nm_saida->saida("  });\r\n");
   if ($this->rs_grid->EOF && empty($this->nm_grid_sem_reg) && !$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf")
   {
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['nav']) && !$_SESSION['scriptcase']['proc_mobile'])
       { 
       } 
       elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opcao'] != "pdf" && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['opc_liga']['nav']) && $_SESSION['scriptcase']['proc_mobile'])
       { 
           { 
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['ajax_nav'])
               {
   ...
   if ($this->grid_emb_form || $this->grid_emb_form_full)
   {
       ...
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_reporte_caja_020521', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      }\r\n");
       $nm_saida->saida("   </script>\r\n");
   }
   $nm_saida->saida("   </HTML>\r\n");
...
//--- 
 function form_navegacao()
 {
   ...
   $nm_saida->saida("    <input type=\"hidden\" name=\"SC_lig_apl_orig\" value=\"grid_reporte_caja_020521\"/>\r\n");
   ...
   $nm_saida->saida("                     action=\"grid_reporte_caja_020521_pesq.class.php\" \r\n");
   $nm_saida->saida("                     target=\"_self\" style=\"display: none\"> \r\n");
   $nm_saida->saida("    <input type=\"hidden\" name=\"script_case_init\" value=\"" . NM_encode_input($this->Ini->sc_page) . "\"/> \r\n");
   $nm_saida->saida("   </form> \r\n");
   ...
   $nm_saida->saida("                     action=\"grid_reporte_caja_020521_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_reporte_caja_020521/grid_reporte_caja_020521_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
   $nm_saida->saida("       }\r\n");
   $nm_saida->saida("       else\r\n");
   $nm_saida->saida("       {\r\n");
   ...
   $nm_saida->saida("           document.Fdoc_word.action = \"grid_reporte_caja_020521_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("           document.F3.SC_module_export.value = z;\r\n");
   $nm_saida->saida("       }\r\n");
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['grid_reporte_caja_020521_iframe_params'] = array(
   ...
   $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_reporte_caja_020521@SC_par@" . md5($prep_parm_pdf);
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               document.Fprint.action = \"grid_reporte_caja_020521_export_ctrl.php\";\r\n");
   $nm_saida->saida("           }\r\n");
   $nm_saida->saida("           else\r\n");
   $nm_saida->saida("           {\r\n");
   ...
   $nm_saida->saida("           document.Fexport.action = \"grid_reporte_caja_020521_export_ctrl.php\";\r\n");
   ...
   $nm_saida->saida("   {\r\n");
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['form_psq_ret']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret']) )
   {
      $nm_saida->saida("      if (document.Fpesq.nm_ret_psq.value != \"\")\r\n");
      $nm_saida->saida("      {\r\n");
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['sc_modal'])
      {
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['iframe_ret_cap']))
         {
             $Iframe_cap = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['iframe_ret_cap'];
             unset($_SESSION['sc_session'][$script_case_init]['grid_reporte_caja_020521']['iframe_ret_cap']);
             $nm_saida->saida("           var Obj_Form  = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("           var Obj_Form1 = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("           var Obj_Doc   = parent.document.getElementById('" . $Iframe_cap . "').contentWindow;\r\n");
             $nm_saida->saida("           if (parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("           {\r\n");
             $nm_saida->saida("               var Obj_Readonly = parent.document.getElementById('" . $Iframe_cap . "').contentWindow.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("           }\r\n");
         }
         else
         {
             $nm_saida->saida("          var Obj_Form  = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . ";\r\n");
             $nm_saida->saida("          var Obj_Form1 = parent.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret']) . ";\r\n");
             $nm_saida->saida("          var Obj_Doc   = parent;\r\n");
             $nm_saida->saida("          if (parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . "\"))\r\n");
             $nm_saida->saida("          {\r\n");
             $nm_saida->saida("              var Obj_Readonly = parent.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . "\");\r\n");
             $nm_saida->saida("          }\r\n");
         }
      }
      else
      {
          $nm_saida->saida("          var Obj_Form  = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['form_psq_ret'] . "." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . ";\r\n");
          $nm_saida->saida("          var Obj_Form1 = opener.document." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['form_psq_ret'] . "." . str_replace("_autocomp", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret']) . ";\r\n");
          $nm_saida->saida("          var Obj_Doc   = opener;\r\n");
          $nm_saida->saida("          if (opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . "\"))\r\n");
          $nm_saida->saida("          {\r\n");
          $nm_saida->saida("              var Obj_Readonly = opener.document.getElementById(\"id_read_on_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['campo_psq_ret'] . "\");\r\n");
          $nm_saida->saida("          }\r\n");
      }
          $nm_saida->saida("          else\r\n");
          $nm_saida->saida("          {\r\n");
      ...
      $nm_saida->saida("              }\r\n");
     if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['js_apos_busca']))
     {
      $nm_saida->saida("              if (Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['js_apos_busca'] . ")\r\n");
      $nm_saida->saida("              {\r\n");
      $nm_saida->saida("                  Obj_Doc." . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['js_apos_busca'] . "();\r\n");
      $nm_saida->saida("              }\r\n");
   ...
   $nm_saida->saida("      document.F5.action = \"grid_reporte_caja_020521_fim.php\";\r\n");
   ...
   $nm_saida->saida("   }\r\n");
   if (($this->grid_emb_form || $this->grid_emb_form_full) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_020521']['reg_start']))
   {
       $nm_saida->saida("      $(document).ready(function(){\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailStatus('grid_reporte_caja_020521')\",50);\r\n");
       $nm_saida->saida("         setTimeout(\"parent.scAjaxDetailHeight('grid_reporte_caja_020521', $(document).innerHeight())\",50);\r\n");
       $nm_saida->saida("      })\r\n");
   }
   $nm_saida->saida("   </script>\r\n");
