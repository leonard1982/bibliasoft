<?php
@session_start() ;
$_SESSION['scriptcase']['grid_devventa']['sc_process_barr'] = true;
require_once('../grid_devventa/index.php');
unset($_SESSION['scriptcase']['grid_devventa']['sc_process_barr']);
$ExportCtrl = new grid_devventa_export_control;
$ExportCtrl->Export_barr();

class grid_devventa_export_control
{
