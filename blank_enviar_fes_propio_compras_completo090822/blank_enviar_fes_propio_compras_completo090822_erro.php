...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['blank_enviar_fes_propio_compras_completo090822']['contr_erro']) && $_SESSION['scriptcase']['blank_enviar_fes_propio_compras_completo090822']['contr_erro'] == 'on')
    {
