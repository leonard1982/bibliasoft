...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_terid_cond" name="terid_cond" onChange="nm_campos_between(document.getElementById('id_vis_terid'), this, 'terid')">
      ...
      <br><span id="id_hide_terid"  <?php echo $str_hide_terid?>><?php
      if ($terid != "")
      {
      $terid_look = substr($this->Db->qstr($terid), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-terid" id="id_ac_terid" name="terid_autocomp"><?php if ('' !=  $terid) { ?><option value="<?php echo $terid ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_terid"  <?php echo $str_display_terid; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_terid_input_2" name="terid_input_2" value="<?php echo NM_encode_input($terid_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nit_cond" name="nit_cond" onChange="nm_campos_between(document.getElementById('id_vis_nit'), this, 'nit')">
      ...
      <br><span id="id_hide_nit"  <?php echo $str_hide_nit?>><?php
      if ($nit != "")
      {
      $nit_look = substr($this->Db->qstr($nit), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_tipodociden_cond" name="tipodociden_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipodociden'), this, 'tipodociden')">
      ...
      <br><span id="id_hide_tipodociden"  <?php echo $str_hide_tipodociden?>><?php
      if ($tipodociden != "")
      {
      $tipodociden_look = substr($this->Db->qstr($tipodociden), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nittri_cond" name="nittri_cond" onChange="nm_campos_between(document.getElementById('id_vis_nittri'), this, 'nittri')">
      ...
      <br><span id="id_hide_nittri"  <?php echo $str_hide_nittri?>><?php
      if ($nittri != "")
      {
      $nittri_look = substr($this->Db->qstr($nittri), 1, -1); 
      $nmgp_def_dados = array(); 
