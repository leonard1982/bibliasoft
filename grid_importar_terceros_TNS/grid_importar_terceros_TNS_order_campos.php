<?php
   include_once('grid_importar_terceros_TNS_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_importar_terceros_TNS']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_importar_terceros_TNS']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_importar_terceros_TNS']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_importar_terceros_TNS']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_V2.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_importar_terceros_TNS_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_importar_terceros_TNS_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_importar_terceros_TNS_json.php");
   }
   ...
   $tab_def_campos['nit'] = "NIT";
   $tab_labels["nit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["nit"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["nit"] : "CODIGO";
   $tab_ger_campos['nittri'] = "on";
   $tab_def_campos['nittri'] = "NITTRI";
   $tab_labels["nittri"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["nittri"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["nittri"] : "CC/NIT";
   $tab_ger_campos['nombre'] = "on";
   $tab_def_campos['nombre'] = "NOMBRE";
   $tab_labels["nombre"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["nombre"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["nombre"] : "NOMBRE";
   $tab_ger_campos['cliente'] = "on";
   $tab_def_campos['cliente'] = "CLIENTE";
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["cliente"] : "CLIENTE";
   $tab_ger_campos['proveed'] = "on";
   $tab_def_campos['proveed'] = "PROVEED";
   $tab_labels["proveed"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["proveed"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["proveed"] : "PROVEED";
   $tab_ger_campos['empleado'] = "on";
   $tab_def_campos['empleado'] = "EMPLEADO";
   $tab_labels["empleado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["empleado"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["empleado"] : "EMPLEADO";
   $tab_ger_campos['otro'] = "on";
   $tab_def_campos['otro'] = "OTRO";
   $tab_labels["otro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["otro"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["otro"] : "OTRO";
   $tab_ger_campos['puc_deudores'] = "on";
   $tab_def_campos['puc_deudores'] = "PUC_DEUDORES";
   $tab_labels["puc_deudores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["puc_deudores"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["puc_deudores"] : "PUC DEUDORES";
   $tab_ger_campos['puc_retcli'] = "on";
   $tab_def_campos['puc_retcli'] = "PUC_RETCLI";
   $tab_labels["puc_retcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["puc_retcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["puc_retcli"] : "PUC RETCLI";
   $tab_ger_campos['puc_proveedores'] = "on";
   $tab_def_campos['puc_proveedores'] = "PUC_PROVEEDORES";
   $tab_labels["puc_proveedores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["puc_proveedores"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["puc_proveedores"] : "PUC PROVEEDORES";
   $tab_ger_campos['puc_retpro'] = "on";
   $tab_def_campos['puc_retpro'] = "PUC_RETPRO";
   $tab_labels["puc_retpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["puc_retpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["puc_retpro"] : "PUC RETPRO";
   $tab_ger_campos['inactivo'] = "on";
   $tab_def_campos['inactivo'] = "INACTIVO";
   $tab_labels["inactivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["inactivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["inactivo"] : "INACTIVO";
   ...
   {
       $tab_def_campos['estado'] = "";
   }
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['labels']["estado"] : "ESTADO";
   $tab_ger_campos['estado'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_importar_terceros_TNS_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_importar_terceros_TNS']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
