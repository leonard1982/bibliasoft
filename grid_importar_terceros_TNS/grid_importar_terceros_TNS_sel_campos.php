...
<?php
     ...
     if (!function_exists("NM_is_utf8"))
     {
      ...
      $Sel_Cmp = new grid_importar_terceros_TNS_sel_cmp($bol_sel_campos_include); 
      $Sel_Cmp->Sel_cmp_init();
      $Sel_Cmp->Sel_cmp_init_fields();
      $Sel_Cmp->Sel_cmp_process();
     
  }
class grid_importar_terceros_TNS_sel_cmp
{
...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      $tab_blk_campos[] = "puc_deudores";
      $tab_ger_campos['puc_retcli'] = "on";
      $tab_blk_campos[] = "puc_retcli";
      $tab_ger_campos['puc_proveedores'] = "on";
      $tab_blk_campos[] = "puc_proveedores";
      $tab_ger_campos['puc_retpro'] = "on";
      $tab_blk_campos[] = "puc_retpro";
      $tab_ger_campos['inactivo'] = "on";
      $tab_ger_campos['estado'] = "on";
      $tab_blk_campos[] = "estado";
      $tab_ger_campos['terid'] = "on";
      $tab_ger_campos['tipodociden'] = "on";
      $tab_ger_campos['ciudadrexp'] = "on";
      $tab_ger_campos['direcc1'] = "on";
      $tab_ger_campos['direcc2'] = "on";
      $tab_ger_campos['zona1'] = "on";
      $tab_ger_campos['zona2'] = "on";
      $tab_ger_campos['ciudad'] = "on";
      $tab_ger_campos['telef1'] = "on";
      $tab_ger_campos['telef2'] = "on";
      $tab_ger_campos['repleg'] = "on";
      $tab_ger_campos['vended'] = "on";
      $tab_ger_campos['cobra'] = "on";
      $tab_ger_campos['observ'] = "on";
      $tab_ger_campos['email'] = "on";
      $tab_ger_campos['beeper'] = "on";
      $tab_ger_campos['empbeeper'] = "on";
      $tab_ger_campos['celular'] = "on";
      $tab_ger_campos['empcelular'] = "on";
      $tab_ger_campos['fechcreac'] = "on";
      $tab_ger_campos['fechact'] = "on";
      $tab_ger_campos['fechultcom'] = "on";
      $tab_ger_campos['vrultcom'] = "on";
      $tab_ger_campos['nroultcom'] = "on";
      $tab_ger_campos['fechultven'] = "on";
      $tab_ger_campos['vrultven'] = "on";
      $tab_ger_campos['nroultven'] = "on";
      $tab_ger_campos['clasificaid'] = "on";
      $tab_ger_campos['maxcredcxp'] = "on";
      $tab_ger_campos['maxcredcxc'] = "on";
      $tab_ger_campos['porreten'] = "on";
      $tab_ger_campos['ctacli'] = "on";
      $tab_ger_campos['ctapro'] = "on";
      $tab_ger_campos['ctaretcli'] = "on";
      $tab_ger_campos['ctaretpro'] = "on";
      $tab_ger_campos['ctaretscli'] = "on";
      $tab_ger_campos['ctaretspro'] = "on";
      $tab_ger_campos['fecnaci'] = "on";
      $tab_ger_campos['codrecip'] = "on";
      $tab_ger_campos['porcrecip'] = "on";
      $tab_ger_campos['conductor'] = "on";
      $tab_ger_campos['tomador'] = "on";
      $tab_ger_campos['propietario'] = "on";
      $tab_ger_campos['inmpropietario'] = "on";
      $tab_ger_campos['inminquilino'] = "on";
      $tab_ger_campos['ciudaneid'] = "on";
      $tab_ger_campos['ciudadexp'] = "on";
      $tab_ger_campos['fiador'] = "on";
      $tab_ger_campos['nomregtri'] = "on";
      $tab_ger_campos['tarjetapuntos'] = "on";
      $tab_ger_campos['porcretven'] = "on";
      $tab_ger_campos['nombre1'] = "on";
      $tab_ger_campos['nombre2'] = "on";
      $tab_ger_campos['apellido1'] = "on";
      $tab_ger_campos['apellido2'] = "on";
      $tab_ger_campos['motivodevid'] = "on";
      $tab_ger_campos['fechinactivo'] = "on";
      $tab_ger_campos['maxcreddias'] = "on";
      $tab_ger_campos['nittriofi'] = "on";
      $tab_ger_campos['acteconomicaid'] = "on";
      $tab_ger_campos['mesa'] = "on";
      $tab_ger_campos['mostrador'] = "on";
      $tab_ger_campos['porcrivac'] = "on";
      $tab_ger_campos['porcrivav'] = "on";
      $tab_ger_campos['porcricac'] = "on";
      $tab_ger_campos['porcricav'] = "on";
      $tab_ger_campos['natjuridica'] = "on";
      $tab_ger_campos['barrioinid'] = "on";
      $tab_ger_campos['fecafilia'] = "on";
      $tab_ger_campos['porcrcreev'] = "on";
      $tab_ger_campos['porcrcreec'] = "on";
      $tab_ger_campos['tipocreev'] = "on";
      $tab_ger_campos['tipocreec'] = "on";
      $tab_ger_campos['numcue'] = "on";
      $tab_ger_campos['tipcue'] = "on";
      $tab_ger_campos['actcomerid'] = "on";
      $tab_ger_campos['fecultenvio'] = "on";
      $tab_ger_campos['consecterws'] = "on";
      $tab_ger_campos['feclegal'] = "on";
      $tab_ger_campos['emailemp'] = "on";
      $tab_ger_campos['pagweb'] = "on";
      $tab_ger_campos['eterritorial'] = "on";
      $tab_ger_campos['listaprecioid'] = "on";
      $tab_ger_campos['extlocal'] = "on";
      $tab_ger_campos['pep'] = "on";
      $tab_ger_campos['nomempresa'] = "on";
      $tab_ger_campos['fechaexp'] = "on";
      $tab_ger_campos['ocupid'] = "on";
      ...
      if (isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['php_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              if ($NM_cada_opc == "off")
              {
                 $tab_ger_campos[$NM_cada_field] = "none";
      ...
      if ($this->restore)
      {
          if (isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel_orig']) && !empty($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel_orig']))
          {
              foreach ($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel_orig'] as $NM_cada_field => $NM_cada_opc)
              {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel']))
          {
              foreach ($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
              {
                  $tab_ger_campos[$NM_cada_field] = $NM_cada_opc;
              }
          }
...
function Sel_processa_out()
{
   ...
   $arr_temp = array();
   if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel']))
   {
       $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel'] = array();
   }
   if($this->bol_sel_campos_include)
   {
       $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['export_sel_columns']['field_order'] = $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order'];
       $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['export_sel_columns']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel'];
   }
   $arr_order = $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order'];
   $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order'] = array();
   $campos_sel = explode("@?@", $this->campos_sel);
   foreach ($campos_sel as $campo_order)
   {
       if (isset($tab_ger_campos[$campo_order]))
       {
           $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order'][] = $campo_order;
       }
   }
   foreach ($arr_order as $campo_order)
   {
       if (!in_array($campo_order, $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order']))
       {
           $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order'][] = $campo_order;
       }
   }
   ...
   $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel'] = $arr_temp;
   if($this->bol_sel_campos_include)
   {
       return;
   }
...
?>
   $.ajax({
    type: "POST",
    url: "grid_importar_terceros_TNS_sel_campos.php",
    data: {
...
<?php
   ...
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if ($NM_cada_opc != "on")
           {
               $prep_combo[strtolower($NM_cada_field)] = $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['labels'][$NM_cada_field];
           }
       }
   }
   if ($this->restore)
...
<?php
   ...
   if ($this->restore && isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order_orig']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order_orig'] as $NM_cada_field)
       {
...
?>
                        <li class="sc_ui_litem <?php echo $str_class; ?>" id="sc_id_itemsel_<?php echo NM_encode_input($NM_cada_field); ?>"><?php echo $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['labels'][$NM_cada_field]; ?></li>
<?php
           }
       }
   }
   ...
   if (!$this->restore && isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order']))
   {
       foreach ($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order'] as $NM_cada_field)
       {
           if ($tab_ger_campos[$NM_cada_field] == "on")
           {
               $str_class = "scAppDivSelectFieldsDisabled";
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel']) && isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel_orig']) && $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel'] != $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel_orig']) {
      $disp_rest = "";
  }
  else {
      $order_orig = array();
      $order_atu  = array();
      foreach ($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order_orig'] as $ix => $cmp) {
          if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel_orig'][$cmp]) || $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel_orig'][$cmp] != "off") {
              $order_orig[] = $cmp;
          }
      }
      foreach ($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['field_order'] as $ix => $cmp) {
          if (!isset($_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel'][$cmp]) || $_SESSION['sc_session'][$this->sc_init]['grid_importar_terceros_TNS']['usr_cmp_sel'][$cmp] != "off") {
              $order_atu[] = $cmp;
          }
      }
