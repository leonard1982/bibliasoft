...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_pos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_pos"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_pos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_pos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_pos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_pos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_terceros_pos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_pos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_terceros_pos']['embutida_filho'] as $ind => $sc_init)
          {
