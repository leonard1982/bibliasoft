...
class chart_facturaven_resumo
{
   ...
   function initializeButtons()
   {
      ...
      $this->nmgp_botoes['chart_exit'] = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['under_dashboard'] ? "off" : "on";

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_facturaven'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['chart_facturaven'];
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_step']     = 'image';
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_step'] = 'end';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['chart_facturaven']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['where_pesq_filtro'];
     ...
     { 
       ...
       $this->fechaven_2 = $Busca_temp['fechaven_input_2']; 
         ...
         {
             ob_start();
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_combination_type'] = $_POST['fc_chart_type'];
         }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_y_axys']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_y_axys']))
       {
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_x_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_y_axys']             = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_order'] = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['comb_field_display_type']  = array();
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_display_values']     = array();

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_combination_type']        = 'column3d';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_combination_order_rule']  = '';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_combination_order_field'] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_y_axys'][0] = 0;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_y_axys'][1] = 1;
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['comb_field_display_type'][4] = '';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['comb_field_display_type'][2] = 'bar';
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['comb_field_display_type'][3] = '';

           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_display_values'][4] = null;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_display_values'][2] = true;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_display_values'][3] = null;


           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_order']['sc_free_group_by'][] = 4;
       }
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['tot_geral'][3];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['tot_geral'][1] == 0)
      {
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['arr_total']['fechaven'] = $this->array_total_fechaven;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['arr_total']['total'] = $this->array_total_total;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['fechaven'] = $Lab_fechaven; 
       $prep_field['total'] = $Lab_total;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['total'] = $Lab_total; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['idfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['idfacven'] = "Idfacven"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['numfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['numfacven'] = "Numfacven"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['nremision']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['nremision'] = "Nremision"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['credito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['credito'] = "Credito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['fechaven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['fechaven'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['fechavenc'] = "Fechavenc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['idcli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['idcli'] = "Idcli"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['subtotal'] = "Subtotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['valoriva'] = "Valoriva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['asentada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['asentada'] = "Asentada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['adicional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['adicional'] = "Adicional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['formapago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['formapago'] = "Formapago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['adicional2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['adicional2'] = "Adicional 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['adicional3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['adicional3'] = "Adicional 3"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['obspago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['obspago'] = "Obspago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['vendedor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['vendedor'] = "Vendedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['pedido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['pedido'] = "Pedido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['resolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['resolucion'] = "Resolucion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['dircliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['dircliente'] = "Dircliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['imconsumo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['imconsumo'] = "Imconsumo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['retefuente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['retefuente'] = "Retefuente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['reteiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['reteiva'] = "Reteiva"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['reteica']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['reteica'] = "Reteica"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['cree']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['cree'] = "Cree"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['espos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['espos'] = "Espos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['cufe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['cufe'] = "Cufe"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['enlacepdf']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['enlacepdf'] = "Enlacepdf"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['estado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['estado'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['avisos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['avisos'] = "Avisos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['creado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['creado'] = "Creado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['editado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['editado'] = "Editado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['usuario_crea']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['usuario_crea'] = "Usuario Crea"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['dias_decredito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['dias_decredito'] = "Dias Decredito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['banco']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['banco'] = "Banco"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['id_fact']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['id_fact'] = "Id Fact"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['enviada_a_tns']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['enviada_a_tns'] = "Enviada A Tns"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['fecha_a_tns']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['fecha_a_tns'] = "Fecha A Tns"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['factura_tns']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['factura_tns'] = "Factura Tns"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['creado_en_movil']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['creado_en_movil'] = "Creado En Movil"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['disponible_en_movil']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['disponible_en_movil'] = "Disponible En Movil"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['mot_nc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['mot_nc'] = "Mot Nc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['mot_nd']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['labels']['mot_nd'] = "Mot Nd"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       $this->comp_sum = array(
           2 => "",
           3 => "Adicional(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "adicional", 'show' => true),
      ...
      eval ($Str_gb);
       ...
       $Arr_parms['total']['alin'] = "''";
       $Arr_parms['total']['link'] = "S";
       ...
       $Arr_parms['total']['fill'] = "true";
       $Arr_parms['total']['order'] = "value";
       $Arr_parms['total']['order_start'] = 'asc';
       $Arr_parms['total']['order_invert'] = 'false';
       $Arr_parms['total']['order_enabled'] = 'false';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       $prep_links_fl['total'] = array(0 => 'total', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_facturaven@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '2' => array(
               'title'    => $this->getChartText(strip_tags("Adicional(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'fechaven',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_fechaven)),
               'label_y'  => $this->getChartText(strip_tags("Adicional(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_order']['sc_free_group_by'] as $i_summ_order)
       {
                   ...
                   foreach ($this->sc_comb_quick_index[$i_index_summ] as $i_index_comb_groupby)
                   {
                       ...
                       if (!isset($a_chart_combinations[$s_comb_index]))
                       {
                           $a_chart_combinations[$s_comb_index] = array(
                               ...
                               'label_x'     => '',
                               'label_y'     => '',
                               'xml_pholder' => sizeof($this->comp_y_axys) > $i_index_group + 1 ? 'sc_chart_facturaven_' . session_id() . '_!!!C_' . ($i_index_group + 1) . '_' . $s_index_comb . ('' == $s_index_comb ? '' : '_') . '__SC_PLACEHOLDER__!!!.json' : '',
                               'xml'         => 'sc_chart_facturaven_' . session_id() . '_!!!C_' . $i_index_group . '_' . $s_index_comb . '!!!.json',
                           );
                       }
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
	...
	function filterChartsByMultiseries() {
		...
		if ($applyFilter && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['summarizing_drill_down'])) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts'] as $chartIndex => $chartData) {
				$indexParts = explode('|', $chartIndex);
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_chart_facturaven_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_chart_facturaven_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      $this->monta_html_ini();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
      {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_facturaven']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['chart_facturaven']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_facturaven']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['chart_facturaven']) . "_";
               } 
           }
       }
   ...
   function resumo_final()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['ajax_nav'])
      {
   ...
   {
      $this->Tot_ger = false;
      require_once($this->Ini->path_aplicacao . "chart_facturaven_total.class.php"); 
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new chart_facturaven_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['arr_total'][$cmp_gb];
      }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_facturaven_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_facturaven_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"chart_facturaven_message.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "chart_facturaven/chart_facturaven_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_facturaven_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_chart_facturaven_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_facturaven_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['num_css'] . '.css');
...
$nm_saida->saida("      url: \"chart_facturaven_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_chart\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['embutida'])
      {
      ...
      $nm_saida->saida("function scChartImageExportShow(exportType) {\r\n");
          $nm_saida->saida("  scShowCombinationImage(" . count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['Labels_GB']) . ", exportType, '');\r\n");
      $nm_saida->saida("}\r\n");
...
;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_facturaven/chart_facturaven_config_pdf.php?nm_opc=pdf&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=chart&nm_all_modules=chart&password=n&summary_export_columns=N&pdf_zip=N&origem=chart&language=es&conf_socor=S&is_chart_app=Y&nm_label_group=S&nm_all_cab=N&nm_all_label=N&nm_orient_grid=2&script_case_init=" . $this->Ini->sc_page . "&app_name=chart_facturaven&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "chart_facturaven/chart_facturaven_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=chart&password=n&origem=chart&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['filter'] == 'on' && !$this->Ini->SC_Link_View && !$this->grid_emb_form)
      {
         ...
         if (is_file("chart_facturaven_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_facturaven']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['chart_facturaven']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
$nm_saida->saida("       scJs_alert('" . $mensagem . "', $jsonParams);\r\n");
      ...
      elseif ($this->Ini->Export_html_zip || ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['opcao'] == "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['graf_pdf'] == "S"))
      {
          $this->grafico_pdf();
      }
      else
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'chart_facturaven_config_pivot.php?nome_apl=chart_facturaven&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"chart_facturaven_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
          ...
          $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "chart_facturaven/chart_facturaven_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__cor_print=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
          $nm_saida->saida("       }\r\n");
          $nm_saida->saida("       else\r\n");
          $nm_saida->saida("       {\r\n");
          ...
          $nm_saida->saida("               document.Fprint.action = \"chart_facturaven_export_ctrl.php\";\r\n");
          $nm_saida->saida("           }\r\n");
          $nm_saida->saida("           else\r\n");
          $nm_saida->saida("           {\r\n");
          ...
          $nm_saida->saida("       document.Fexport.action = \"chart_facturaven_export_ctrl.php\";\r\n");
      ...
      if (!extension_loaded("zip"))
      {
          ...
          $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
          $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_facturaven_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@chart_facturaven@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
...
;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_chart_facturaven_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "chart_facturaven/chart_facturaven_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['skip_charts']))
   {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               chart_facturaven_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['this_chart_label'] = '';
           $this->Graf->monta_grafico($chart_index, 'pdf');
           if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['this_chart_label']) {
               $nm_saida->saida("<script type=\"text/javascript\">$(\"#$random_id\").html(\"{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['this_chart_label']}\")</script>\r\n");
           }
       ...
       if ($bChartFP)
       {
           ...
           chart_facturaven_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
       ...
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_list']))
   {
       $prim_graf = true;
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['chart_list'] as $arr_chart)
       {
           if (!$prim_graf)
           {
               $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
...
//--- 
 function grafico_bot()
 {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['graf_bot'] = true;
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['graf_first'] = true;
       require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
       $this->Graf  = new chart_facturaven_grafico();
       $this->Graf->Db     = $this->Db;
       $this->Graf->Erro   = $this->Erro;
       ...
       $nm_saida->saida("<TR>\r\n");
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts']);
       $sChartLang  = isset($this->Ini->Nm_lang['lang_pdff_pcht']) ? $this->Ini->Nm_lang['lang_pdff_pcht'] : 'Generating chart';
       if (!NM_is_utf8($sChartLang))
       {
           $sChartLang = sc_convert_encoding($sChartLang, "UTF-8", $_SESSION['scriptcase']['charset']);
      ...
      if ($bPDF && (!isset($this->progress_fp) || !$this->progress_fp))
      {
           ...
           chart_facturaven_pdf_progress_call("PDF\n", $this->Ini->Nm_lang);
           chart_facturaven_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_facturaven_pdf_progress_call("\n", $this->Ini->Nm_lang);
           chart_facturaven_pdf_progress_call("100\n", $this->Ini->Nm_lang);
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['pivot_charts'] as $chart_index => $chart_data)
       {
           ...
           if ($bPDF)
           {
               ...
               if ($this->progress_fp)
               {
                   chart_facturaven_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "/" . $iChartTotal . "...\n", $this->Ini->Nm_lang, true);
       ...
       $nm_saida->saida("</TD>\r\n");
       $nm_saida->saida("</TR>\r\n");
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['graf_bot'] = false;
       if ($bPDF && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['charts_html'])
       {
           $nm_saida->saida("<script type=\"text/javascript\">\r\n");
           $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['charts_html']}\r\n");
           $nm_saida->saida("</script>\r\n");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_adicional, $quebra_fechaven, $quebra_total, $quebra_fechaven_orig, $quebra_total_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->idfacven = $rs_res->fields[0] ;  
            $this->numfacven = $rs_res->fields[1] ;  
            $this->nremision = $rs_res->fields[2] ;  
            $this->credito = $rs_res->fields[3] ;  
            ...
            $this->formapago = $rs_res->fields[15] ;  
            $this->adicional2 = $rs_res->fields[16] ;  
            $this->adicional3 = $rs_res->fields[17] ;  
            $this->obspago = $rs_res->fields[18] ;  
            $this->vendedor = $rs_res->fields[19] ;  
            $this->pedido = $rs_res->fields[20] ;  
            $this->resolucion = $rs_res->fields[21] ;  
            $this->dircliente = $rs_res->fields[22] ;  
            $this->imconsumo = $rs_res->fields[23] ;  
            $this->retefuente = $rs_res->fields[24] ;  
            $this->reteiva = $rs_res->fields[25] ;  
            $this->reteica = $rs_res->fields[26] ;  
            $this->cree = $rs_res->fields[27] ;  
            $this->espos = $rs_res->fields[28] ;  
            $this->cufe = $rs_res->fields[29] ;  
            $this->enlacepdf = $rs_res->fields[30] ;  
            $this->estado = $rs_res->fields[31] ;  
            $this->avisos = $rs_res->fields[32] ;  
            $this->creado = $rs_res->fields[33] ;  
            $this->editado = $rs_res->fields[34] ;  
            $this->usuario_crea = $rs_res->fields[35] ;  
            $this->dias_decredito = $rs_res->fields[36] ;  
            $this->banco = $rs_res->fields[37] ;  
            $this->tipo = $rs_res->fields[38] ;  
            $this->id_fact = $rs_res->fields[39] ;  
            $this->enviada_a_tns = $rs_res->fields[40] ;  
            $this->fecha_a_tns = $rs_res->fields[41] ;  
            $this->factura_tns = $rs_res->fields[42] ;  
            $this->creado_en_movil = $rs_res->fields[43] ;  
            $this->disponible_en_movil = $rs_res->fields[44] ;  
            $this->mot_nc = $rs_res->fields[45] ;  
            $this->mot_nd = $rs_res->fields[46] ;  
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->adicional, $this->fechaven, $this->total, $this->fechaven_orig,  $this->total_orig);
            }
   }
//
