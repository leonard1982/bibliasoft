...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_facturaven']['cfg_graf']['graf_tipo']))
      {
