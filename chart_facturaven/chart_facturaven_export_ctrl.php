<?php
@session_start() ;
$_SESSION['scriptcase']['chart_facturaven']['sc_process_barr'] = true;
require_once('../chart_facturaven/index.php');
unset($_SESSION['scriptcase']['chart_facturaven']['sc_process_barr']);
$ExportCtrl = new chart_facturaven_export_control;
$ExportCtrl->Export_barr();

class chart_facturaven_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['chart_facturaven']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['chart_facturaven']['glo_nm_path_imag_temp'];
