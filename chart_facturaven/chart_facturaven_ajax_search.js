...
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_fechaven_cond") && search_get_sel_txt("SC_fechaven_cond").substring(0, 3) == "bi_") {
            formata_bi_fechaven(search_get_sel_txt("SC_fechaven_cond"), SC_fechaven_bi_opc, SC_fechaven_bi_dt);
        }
