  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_colorxproducto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_colorxproducto_form();
	}
...
?>
  ...
  // ---------- Validate idcol_
  function do_ajax_form_colorxproducto_validate_idcol_(iNumLinha)
  {
    var nomeCampo_idcol_ = "idcol_" + iNumLinha;
    var var_idcol_ = scAjaxGetFieldSelect(nomeCampo_idcol_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colorxproducto_validate_idcol_(var_idcol_, iNumLinha, var_script_case_init, do_ajax_form_colorxproducto_validate_idcol__cb);
  } // do_ajax_form_colorxproducto_validate_idcol_

  function do_ajax_form_colorxproducto_validate_idcol__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idcol_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcol_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idcol_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcol_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colorxproducto_validate_idcol__cb

  // ---------- Validate imagen_
  function do_ajax_form_colorxproducto_validate_imagen_(iNumLinha)
  {
    var nomeCampo_imagen_ = "imagen_" + iNumLinha;
    var var_imagen_ = scAjaxGetFieldHidden(nomeCampo_imagen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colorxproducto_validate_imagen_(var_imagen_, iNumLinha, var_script_case_init, do_ajax_form_colorxproducto_validate_imagen__cb);
  } // do_ajax_form_colorxproducto_validate_imagen_

  function do_ajax_form_colorxproducto_validate_imagen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colorxproducto_validate_imagen__cb

  // ---------- Event onchange idcol_
  function do_ajax_form_colorxproducto_event_idcol__onchange(iSeqForm)
  {
    var var_idcol_ = scAjaxGetFieldSelect("idcol_" + iSeqForm);
    var var_imagen_ = scAjaxGetFieldHidden("imagen_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_colorxproducto_event_idcol__onchange(var_idcol_, var_imagen_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_colorxproducto_event_idcol__onchange_cb);
  } // do_ajax_form_colorxproducto_event_idcol__onchange

  function do_ajax_form_colorxproducto_event_idcol__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_colorxproducto_event_idcol__onchange_cb_after_alert);
  } // do_ajax_form_colorxproducto_event_idcol__onchange_cb
  function do_ajax_form_colorxproducto_event_idcol__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_colorxproducto_event_idcol__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_colorxproducto_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_colorxproducto_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_colorxproducto_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_colorxproducto_add_new_line_cb);
  } // do_ajax_form_colorxproducto_add_new_line

  function do_ajax_form_colorxproducto_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    tb_init('#fldedt_idcol_' + iAjaxNewLine);
    scFocusField('' + iAjaxNewLine);

  } // do_ajax_form_colorxproducto_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_colorxproducto_backup_line(iNumLinha)
  {
    var var_idcolorproducto_ = scAjaxGetFieldText("idcolorproducto_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colorxproducto_backup_line(var_idcolorproducto_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_colorxproducto_backup_line_cb);
  } // do_ajax_form_colorxproducto_backup_line

  function do_ajax_form_colorxproducto_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_colorxproducto_backup_line_cb

  function do_ajax_form_colorxproducto_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_colorxproducto_cancel_insert

  function do_ajax_form_colorxproducto_cancel_update(iSeqVert)
  {
    do_ajax_form_colorxproducto_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_colorxproducto_cancel_update

  function do_ajax_form_colorxproducto_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_colorxproducto_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_colorxproducto_table_refresh()
  {
    var var_idcolorproducto_ = document.F2.idcolorproducto_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_colorxproducto_table_refresh(var_idcolorproducto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_colorxproducto_table_refresh_cb);
  } //  do_ajax_form_colorxproducto_table_refresh

  function do_ajax_form_colorxproducto_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idcolorproducto_.value = scAjaxGetKeyValue("idcolorproducto_");
    ...
    scAjaxAlert(do_ajax_form_colorxproducto_table_refresh_cb_after_alert);
  } // do_ajax_form_colorxproducto_table_refresh_cb
  function do_ajax_form_colorxproducto_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_colorxproducto_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_colorxproducto_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_colorxproducto_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idcol_ = scAjaxGetFieldSelect("idcol_" + iNumLinha);
    var var_imagen_ = scAjaxGetFieldHidden("imagen_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_colorxproducto_submit_form(var_idcol_, var_imagen_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_colorxproducto_submit_form_cb);
  } // do_ajax_form_colorxproducto_submit_form

  function do_ajax_form_colorxproducto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcol_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_colorxproducto_submit_form_cb_after_alert);
  } // do_ajax_form_colorxproducto_submit_form_cb
  function do_ajax_form_colorxproducto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_colorxproducto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_colorxproducto_navigate_form()
  {
    perform_ajax_form_colorxproducto_navigate_form();
  }

  function perform_ajax_form_colorxproducto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("idcol_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_colorxproducto_navigate_form(var_idcolorproducto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_colorxproducto_navigate_form_cb);
  } // do_ajax_form_colorxproducto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_colorxproducto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_colorxproducto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcolorproducto_.value = scAjaxGetKeyValue("idcolorproducto_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_colorxproducto_navigate_form_cb_after_alert);
  } // do_ajax_form_colorxproducto_navigate_form_cb
  function do_ajax_form_colorxproducto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_colorxproducto_navigate_form_cb_after_alert
  function sc_hide_form_colorxproducto_form()
  {
  ...
  function do_ajax_form_colorxproducto_lkpedt_refresh_idcol_(iSeq)
  {
    var var_idcol_ = scAjaxGetFieldSelect("idcol_");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_row = iSeq;
    var nmgp_refresh_fields = "idcol_";
    x_ajax_form_colorxproducto_lkpedt_refresh_idcol_(var_idcol_, nmgp_refresh_row, nmgp_refresh_fields, var_script_case_init, do_ajax_form_colorxproducto_lkpedt_refresh_idcol__cb);
  } // do_ajax_form_colorxproducto_lkpedt_refresh_idcol_

  function do_ajax_form_colorxproducto_lkpedt_refresh_idcol__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_colorxproducto_lkpedt_refresh_idcol__cb
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idcol_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "imagen_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idcol_" + iNumLinha] = {"label": "Color<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["imagen_" + iNumLinha] = {"label": "<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idcol_"][iNumLinha] = "idcol_" + iNumLinha;
    ajax_field_mult["imagen_"][iNumLinha] = "imagen_" + iNumLinha;
    ajax_field_id["idcol_" + iNumLinha] = new Array("hidden_field_label_idcol_", "hidden_field_data_idcol_" + iNumLinha);
    ajax_field_id["imagen_" + iNumLinha] = new Array("hidden_field_label_imagen_", "hidden_field_data_imagen_" + iNumLinha);
    ajax_error_count["idcol_" + iNumLinha] = "off";
    ajax_error_count["imagen_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idcol_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["idcol_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["idcol_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idcol_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcol_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcol_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcol_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcol_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcol_'])) ? $this->nmgp_cmp_readonly['idcol_'] : 'off';
?>
    scAjaxFieldRead("idcol_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("idcol_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idcol_" + iRow] || "on" == ajax_error_count["imagen_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcol_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idcol_" + iRow] && "off" == ajax_error_count["imagen_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idcol_" + iRow] = "off";
      ...
      $("#hidden_field_data_idcol_" + iRow).removeClass("scFormErrorLine");
