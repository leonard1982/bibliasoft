...
class grid_reporte_caja_04092021_json
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_reporte_caja_04092021/grid_reporte_caja_04092021_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_format'];
      }
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_return']);
      ...
      $this->Arquivo     .= "_grid_reporte_caja_04092021";
      $this->Arquivo     .= ".json";
      $this->Tit_doc      = "grid_reporte_caja_04092021.json";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name'] .= ".json";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_name']);
      }
...
$_SESSION['scriptcase']['grid_reporte_caja_04092021']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_reporte_caja_04092021_res_json.class.php");
              $this->Res = new grid_reporte_caja_04092021_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_res_grid']);
          } 
      }
   ...
   function NM_export_nom_docu()
   {
         ...
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->nom_docu;
   }
   //----- fecha
   ...
   function NM_export_nom_empresa()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->nom_empresa;
   }
   //----- direccion
   ...
   function NM_export_et1()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et1;
   }
   //----- res
   function NM_export_res()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->res;
   }
   //----- et2
   function NM_export_et2()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et2;
   }
   //----- documento
   ...
   function NM_export_et3()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et3;
   }
   //----- rango
   ...
   function NM_export_et4()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et4;
   }
   //----- cant_fact
   function NM_export_cant_fact()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->cant_fact;
   }
   //----- et5
   function NM_export_et5()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et5;
   }
   //----- total
   ...
   function NM_export_et6()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et6;
   }
   //----- et7
   function NM_export_et7()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et7;
   }
   //----- et8
   function NM_export_et8()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et8;
   }
   //----- et9
   function NM_export_et9()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et9;
   }
   //----- can_efec
   function NM_export_can_efec()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->can_efec;
   }
   //----- med_efec
   function NM_export_med_efec()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->med_efec;
   }
   //----- porc_efec
   function NM_export_porc_efec()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->porc_efec;
   }
   //----- tot_efec
   function NM_export_tot_efec()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tot_efec;
   }
   //----- c_tarj
   ...
   function NM_export_med_tarj()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->med_tarj;
   }
   //----- porc_tarj
   ...
   function NM_export_med_cheq()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->med_cheq;
   }
   //----- porc_cheq
   ...
   function NM_export_cheque()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->cheque;
   }
   //----- c_tra
   function NM_export_c_tra()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->c_tra;
   }
   //----- med_tran
   function NM_export_med_tran()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->med_tran;
   }
   //----- porc_tran
   function NM_export_porc_tran()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->porc_tran;
   }
   //----- trans
   function NM_export_trans()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->trans;
   }
   //----- c_credito
   ...
   function NM_export_med_cred()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->med_cred;
   }
   //----- porc_credito
   ...
   function NM_export_et10()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et10;
   }
   //----- total_vtas
   function NM_export_total_vtas()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->total_vtas;
   }
   //----- et_iva
   function NM_export_et_iva()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_iva;
   }
   //----- et_base
   function NM_export_et_base()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_base;
   }
   //----- et_val_iva
   function NM_export_et_val_iva()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_val_iva;
   }
   //----- etiva_19
   function NM_export_etiva_19()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->etiva_19;
   }
   //----- base19
   ...
   function NM_export_etiva_5()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->etiva_5;
   }
   //----- base5
   ...
   function NM_export_etexc_0()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->etexc_0;
   }
   //----- base0
   ...
   function NM_export_et_tot()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_tot;
   }
   //----- tot_base
   ...
   function NM_export_et20()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et20;
   }
   //----- et_vac
   function NM_export_et_vac()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_vac;
   }
   //----- et_imb
   function NM_export_et_imb()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_imb;
   }
   //----- imp_bol
   function NM_export_imp_bol()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->imp_bol;
   }
   //----- et_ic
   function NM_export_et_ic()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_ic;
   }
   //----- imp_consumo
   ...
   function NM_export_et_ic_dev()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_ic_dev;
   }
   //----- imp_consumo_dev
   function NM_export_imp_consumo_dev()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->imp_consumo_dev;
   }
   //----- et_tot_inc
   function NM_export_et_tot_inc()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_tot_inc;
   }
   //----- tot_inc
   function NM_export_tot_inc()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->tot_inc;
   }
   //----- et_vn
   function NM_export_et_vn()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_vn;
   }
   //----- venta_netas
   function NM_export_venta_netas()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->venta_netas;
   }
   //----- et_reg
   function NM_export_et_reg()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_reg;
   }
   //----- vent_reg
   function NM_export_vent_reg()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->vent_reg;
   }
   //----- fac_anuladas
   function NM_export_fac_anuladas()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fac_anuladas;
   }
   //----- f_anul
   function NM_export_f_anul()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->f_anul;
   }
   //----- et_obs
   function NM_export_et_obs()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_obs;
   }
   //----- obs
   ...
   function NM_export_et_fech_imp()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_fech_imp;
   }
   //----- fecha_imp
   function NM_export_fecha_imp()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->fecha_imp;
   }
   //----- et_ubic
   function NM_export_et_ubic()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_ubic;
   }
   //----- ubicacion
   ...
   function NM_export_et_equipo()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_equipo;
   }
   //----- nom_equipo
   function NM_export_nom_equipo()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->nom_equipo;
   }
   //----- et_serial
   function NM_export_et_serial()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_serial;
   }
   //----- serial
   function NM_export_serial()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->serial;
   }
   //----- et_fin2
   function NM_export_et_fin2()
   {
         ...
         $SC_Label = NM_charset_to_utf8($SC_Label); 
         $this->json_registro[$this->SC_seq_json][$SC_Label] = $this->et_fin2;
   }
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['json_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
