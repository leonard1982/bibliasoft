...
class grid_reporte_caja_04092021_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   nm_limpa_str_grid_reporte_caja_04092021($cadapar[1]);
                   nm_protect_num_grid_reporte_caja_04092021($cadapar[0], $cadapar[1]);
                   if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                   $Tmp_par   = $cadapar[0];
                   $$Tmp_par = $cadapar[1];
                   if ($Tmp_par == "nmgp_opcao")
                   {
                       $_SESSION['sc_session'][$script_case_init]['grid_reporte_caja_04092021']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      if (isset($elbanco)) 
      {
          ...
          nm_limpa_str_grid_reporte_caja_04092021($_SESSION["elbanco"]);
      }
      if (isset($lafecha)) 
      {
          $_SESSION['lafecha'] = $lafecha;
          nm_limpa_str_grid_reporte_caja_04092021($_SESSION["lafecha"]);
      }
      if (isset($elprefijo)) 
      {
          $_SESSION['elprefijo'] = $elprefijo;
          nm_limpa_str_grid_reporte_caja_04092021($_SESSION["elprefijo"]);
      }
      if (isset($gidtercero)) 
      {
          $_SESSION['gidtercero'] = $gidtercero;
          nm_limpa_str_grid_reporte_caja_04092021($_SESSION["gidtercero"]);
      }
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['SC_Ind_Groupby'] == "sc_free_total")
          {
              $this->Tem_xls_res  = false;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_reporte_caja_04092021/grid_reporte_caja_04092021_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_reporte_caja_04092021_res_xls.class.php");
              $this->Res_xls = new grid_reporte_caja_04092021_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_reporte_caja_04092021.zip";
          $this->Arquivo   .= "_grid_reporte_caja_04092021" . $this->Xls_tp;
          $this->Tit_doc    = "grid_reporte_caja_04092021" . $this->Xls_tp;
          $this->Tit_zip    = "grid_reporte_caja_04092021.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_reporte_caja_04092021_total.class.php"); 
      $this->Tot = new grid_reporte_caja_04092021_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['SC_Ind_Groupby'];
      $this->Tot->$Gb_geral();
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['tot_geral'][1];
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida'] && !$this->Ini->sc_export_ajax) {
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_reporte_caja_04092021']['glo_nm_path_imag_temp'] . "/");
          $this->pb->setProgressbarMd5($_GET['pbmd5']);
          $this->pb->initialize();
          $this->pb->setReturnUrl("./");
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['field_order'] as $Cada_cmp)
      {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['campos_busca'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['where_pesq'];
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['where_pesq'];
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['order_grid'];
     ...
     $nm_houve_quebra = "N";
         ...
         $_SESSION['scriptcase']['grid_reporte_caja_04092021']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['grid_reporte_caja_04092021']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   { 
      ...
      { 
          ...
          if ($Cada_col == "res" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
   ...
   function NM_export_nom_docu()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nom_docu, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nom_docu, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fecha
   ...
   function NM_export_nom_empresa()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nom_empresa, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nom_empresa, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- direccion
   ...
   function NM_export_et1()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et1, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et1, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- res
   function NM_export_res()
   {
      ...
      if (!empty($this->res))
      {
         ...
         $this->res = html_entity_decode($this->res, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->res = strip_tags($this->res);
         $this->res = NM_charset_to_utf8($this->res);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->res, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->res, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et2
   function NM_export_et2()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- documento
   ...
   function NM_export_et3()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et3, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et3, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- rango
   function NM_export_rango()
   {
         ...
         if (is_numeric($this->rango))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->rango);
         $this->Xls_col++;
   }
   //----- et4
   function NM_export_et4()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et4, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et4, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- cant_fact
   function NM_export_cant_fact()
   {
         ...
         if (is_numeric($this->cant_fact))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->cant_fact);
         $this->Xls_col++;
   }
   //----- et5
   function NM_export_et5()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et5, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et5, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- total
   ...
   function NM_export_et6()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et6, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et6, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et7
   function NM_export_et7()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et7, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et7, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et8
   function NM_export_et8()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et8, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et8, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et9
   function NM_export_et9()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et9, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et9, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- can_efec
   function NM_export_can_efec()
   {
         ...
         if (is_numeric($this->can_efec))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->can_efec);
         $this->Xls_col++;
   }
   //----- med_efec
   function NM_export_med_efec()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_efec, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_efec, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- porc_efec
   function NM_export_porc_efec()
   {
         ...
         if (is_numeric($this->porc_efec))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->porc_efec);
         $this->Xls_col++;
   }
   //----- tot_efec
   function NM_export_tot_efec()
   {
         ...
         if (is_numeric($this->tot_efec))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tot_efec);
         $this->Xls_col++;
   }
   //----- c_tarj
   function NM_export_c_tarj()
   {
         ...
         if (is_numeric($this->c_tarj))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_tarj);
         $this->Xls_col++;
   }
   //----- med_tarj
   function NM_export_med_tarj()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_tarj, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_tarj, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- porc_tarj
   function NM_export_porc_tarj()
   {
         ...
         if (is_numeric($this->porc_tarj))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->porc_tarj);
         $this->Xls_col++;
   }
   //----- tarjeta
   ...
   function NM_export_c_cheq()
   {
         ...
         if (is_numeric($this->c_cheq))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_cheq);
         $this->Xls_col++;
   }
   //----- med_cheq
   function NM_export_med_cheq()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_cheq, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_cheq, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- porc_cheq
   function NM_export_porc_cheq()
   {
         ...
         if (is_numeric($this->porc_cheq))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->porc_cheq);
         $this->Xls_col++;
   }
   //----- cheque
   ...
   function NM_export_c_tra()
   {
         ...
         if (is_numeric($this->c_tra))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_tra);
         $this->Xls_col++;
   }
   //----- med_tran
   function NM_export_med_tran()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_tran, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_tran, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- porc_tran
   function NM_export_porc_tran()
   {
         ...
         if (is_numeric($this->porc_tran))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->porc_tran);
         $this->Xls_col++;
   }
   //----- trans
   function NM_export_trans()
   {
         ...
         if (is_numeric($this->trans))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->trans);
         $this->Xls_col++;
   }
   //----- c_credito
   function NM_export_c_credito()
   {
         ...
         if (is_numeric($this->c_credito))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->c_credito);
         $this->Xls_col++;
   }
   //----- med_cred
   function NM_export_med_cred()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_cred, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->med_cred, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- porc_credito
   function NM_export_porc_credito()
   {
         ...
         if (is_numeric($this->porc_credito))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->porc_credito);
         $this->Xls_col++;
   }
   //----- credito
   function NM_export_credito()
   {
         ...
         if (is_numeric($this->credito))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->credito);
         $this->Xls_col++;
   }
   //----- et10
   function NM_export_et10()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et10, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et10, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- total_vtas
   function NM_export_total_vtas()
   {
         ...
         if (is_numeric($this->total_vtas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->total_vtas);
         $this->Xls_col++;
   }
   //----- et_iva
   function NM_export_et_iva()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_iva, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_iva, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et_base
   function NM_export_et_base()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_base, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_base, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et_val_iva
   function NM_export_et_val_iva()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_val_iva, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_val_iva, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- etiva_19
   function NM_export_etiva_19()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->etiva_19, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->etiva_19, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- base19
   ...
   function NM_export_etiva_5()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->etiva_5, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->etiva_5, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- base5
   ...
   function NM_export_etexc_0()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->etexc_0, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->etexc_0, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- base0
   ...
   function NM_export_et_tot()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_tot, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_tot, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tot_base
   function NM_export_tot_base()
   {
         ...
         if (is_numeric($this->tot_base))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tot_base);
         $this->Xls_col++;
   }
   //----- tot_iva
   function NM_export_tot_iva()
   {
         ...
         if (is_numeric($this->tot_iva))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tot_iva);
         $this->Xls_col++;
   }
   //----- et20
   function NM_export_et20()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et20, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et20, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et_vac
   function NM_export_et_vac()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_vac, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_vac, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et_imb
   function NM_export_et_imb()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_imb, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_imb, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- imp_bol
   function NM_export_imp_bol()
   {
         ...
         if (is_numeric($this->imp_bol))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->imp_bol);
         $this->Xls_col++;
   }
   //----- et_ic
   function NM_export_et_ic()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_ic, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_ic, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- imp_consumo
   function NM_export_imp_consumo()
   {
         ...
         if (is_numeric($this->imp_consumo))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->imp_consumo);
         $this->Xls_col++;
   }
   //----- et_ic_dev
   function NM_export_et_ic_dev()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_ic_dev, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_ic_dev, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- imp_consumo_dev
   function NM_export_imp_consumo_dev()
   {
         ...
         if (is_numeric($this->imp_consumo_dev))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->imp_consumo_dev);
         $this->Xls_col++;
   }
   //----- et_tot_inc
   function NM_export_et_tot_inc()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_tot_inc, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_tot_inc, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- tot_inc
   function NM_export_tot_inc()
   {
         ...
         if (is_numeric($this->tot_inc))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->tot_inc);
         $this->Xls_col++;
   }
   //----- et_vn
   function NM_export_et_vn()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_vn, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_vn, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- venta_netas
   function NM_export_venta_netas()
   {
         ...
         if (is_numeric($this->venta_netas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->venta_netas);
         $this->Xls_col++;
   }
   //----- et_reg
   function NM_export_et_reg()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_reg, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_reg, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- vent_reg
   function NM_export_vent_reg()
   {
         ...
         if (is_numeric($this->vent_reg))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->vent_reg);
         $this->Xls_col++;
   }
   //----- fac_anuladas
   function NM_export_fac_anuladas()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fac_anuladas, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fac_anuladas, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- f_anul
   function NM_export_f_anul()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->f_anul, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->f_anul, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et_obs
   function NM_export_et_obs()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_obs, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_obs, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- obs
   ...
   function NM_export_et_fech_imp()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_fech_imp, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_fech_imp, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- fecha_imp
   function NM_export_fecha_imp()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_imp, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->fecha_imp, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et_ubic
   function NM_export_et_ubic()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_ubic, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_ubic, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- ubicacion
   ...
   function NM_export_et_equipo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_equipo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_equipo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nom_equipo
   function NM_export_nom_equipo()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nom_equipo, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->nom_equipo, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et_serial
   function NM_export_et_serial()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_serial, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_serial, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- serial
   function NM_export_serial()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->serial, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->serial, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- et_fin2
   function NM_export_et_fin2()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_fin2, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->et_fin2, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nom_docu
   function NM_sub_cons_nom_docu()
   {
         $this->nom_docu = html_entity_decode($this->nom_docu, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nom_docu = strip_tags($this->nom_docu);
         $this->nom_docu = NM_charset_to_utf8($this->nom_docu);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nom_docu;
   ...
   //----- nom_empresa
   function NM_sub_cons_nom_empresa()
   {
         $this->nom_empresa = html_entity_decode($this->nom_empresa, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nom_empresa = strip_tags($this->nom_empresa);
         $this->nom_empresa = NM_charset_to_utf8($this->nom_empresa);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nom_empresa;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et1
   function NM_sub_cons_et1()
   {
         $this->et1 = html_entity_decode($this->et1, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et1 = strip_tags($this->et1);
         $this->et1 = NM_charset_to_utf8($this->et1);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et1;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   function NM_sub_cons_res()
   {
      if (!empty($this->res))
      {
         ...
         $this->res = strip_tags($this->res);
         $this->res = NM_charset_to_utf8($this->res);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->res;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et2
   function NM_sub_cons_et2()
   {
         $this->et2 = html_entity_decode($this->et2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et2 = strip_tags($this->et2);
         $this->et2 = NM_charset_to_utf8($this->et2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et3
   function NM_sub_cons_et3()
   {
         $this->et3 = html_entity_decode($this->et3, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et3 = strip_tags($this->et3);
         $this->et3 = NM_charset_to_utf8($this->et3);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et3;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- rango
   function NM_sub_cons_rango()
   {
         $this->rango = NM_charset_to_utf8($this->rango);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->rango;
   ...
   //----- et4
   function NM_sub_cons_et4()
   {
         $this->et4 = html_entity_decode($this->et4, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et4 = strip_tags($this->et4);
         $this->et4 = NM_charset_to_utf8($this->et4);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et4;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- cant_fact
   function NM_sub_cons_cant_fact()
   {
         $this->cant_fact = NM_charset_to_utf8($this->cant_fact);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->cant_fact;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- et5
   function NM_sub_cons_et5()
   {
         $this->et5 = html_entity_decode($this->et5, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et5 = strip_tags($this->et5);
         $this->et5 = NM_charset_to_utf8($this->et5);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et5;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et6
   function NM_sub_cons_et6()
   {
         $this->et6 = html_entity_decode($this->et6, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et6 = strip_tags($this->et6);
         $this->et6 = NM_charset_to_utf8($this->et6);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et6;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et7
   function NM_sub_cons_et7()
   {
         $this->et7 = html_entity_decode($this->et7, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et7 = strip_tags($this->et7);
         $this->et7 = NM_charset_to_utf8($this->et7);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et7;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et8
   function NM_sub_cons_et8()
   {
         $this->et8 = html_entity_decode($this->et8, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et8 = strip_tags($this->et8);
         $this->et8 = NM_charset_to_utf8($this->et8);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et8;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et9
   function NM_sub_cons_et9()
   {
         $this->et9 = html_entity_decode($this->et9, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et9 = strip_tags($this->et9);
         $this->et9 = NM_charset_to_utf8($this->et9);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et9;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- can_efec
   function NM_sub_cons_can_efec()
   {
         $this->can_efec = NM_charset_to_utf8($this->can_efec);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->can_efec;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- med_efec
   function NM_sub_cons_med_efec()
   {
         $this->med_efec = html_entity_decode($this->med_efec, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->med_efec = strip_tags($this->med_efec);
         $this->med_efec = NM_charset_to_utf8($this->med_efec);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->med_efec;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- porc_efec
   function NM_sub_cons_porc_efec()
   {
         $this->porc_efec = NM_charset_to_utf8($this->porc_efec);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->porc_efec;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- tot_efec
   function NM_sub_cons_tot_efec()
   {
         $this->tot_efec = NM_charset_to_utf8($this->tot_efec);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tot_efec;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- c_tarj
   function NM_sub_cons_c_tarj()
   {
         $this->c_tarj = NM_charset_to_utf8($this->c_tarj);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_tarj;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- med_tarj
   function NM_sub_cons_med_tarj()
   {
         $this->med_tarj = html_entity_decode($this->med_tarj, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->med_tarj = strip_tags($this->med_tarj);
         $this->med_tarj = NM_charset_to_utf8($this->med_tarj);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->med_tarj;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- porc_tarj
   function NM_sub_cons_porc_tarj()
   {
         $this->porc_tarj = NM_charset_to_utf8($this->porc_tarj);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->porc_tarj;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- c_cheq
   function NM_sub_cons_c_cheq()
   {
         $this->c_cheq = NM_charset_to_utf8($this->c_cheq);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_cheq;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- med_cheq
   function NM_sub_cons_med_cheq()
   {
         $this->med_cheq = html_entity_decode($this->med_cheq, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->med_cheq = strip_tags($this->med_cheq);
         $this->med_cheq = NM_charset_to_utf8($this->med_cheq);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->med_cheq;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- porc_cheq
   function NM_sub_cons_porc_cheq()
   {
         $this->porc_cheq = NM_charset_to_utf8($this->porc_cheq);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->porc_cheq;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- c_tra
   function NM_sub_cons_c_tra()
   {
         $this->c_tra = NM_charset_to_utf8($this->c_tra);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_tra;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- med_tran
   function NM_sub_cons_med_tran()
   {
         $this->med_tran = html_entity_decode($this->med_tran, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->med_tran = strip_tags($this->med_tran);
         $this->med_tran = NM_charset_to_utf8($this->med_tran);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->med_tran;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- porc_tran
   function NM_sub_cons_porc_tran()
   {
         $this->porc_tran = NM_charset_to_utf8($this->porc_tran);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->porc_tran;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- trans
   function NM_sub_cons_trans()
   {
         $this->trans = NM_charset_to_utf8($this->trans);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->trans;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- c_credito
   function NM_sub_cons_c_credito()
   {
         $this->c_credito = NM_charset_to_utf8($this->c_credito);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->c_credito;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- med_cred
   function NM_sub_cons_med_cred()
   {
         $this->med_cred = html_entity_decode($this->med_cred, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->med_cred = strip_tags($this->med_cred);
         $this->med_cred = NM_charset_to_utf8($this->med_cred);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->med_cred;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- porc_credito
   function NM_sub_cons_porc_credito()
   {
         $this->porc_credito = NM_charset_to_utf8($this->porc_credito);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->porc_credito;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- et10
   function NM_sub_cons_et10()
   {
         $this->et10 = html_entity_decode($this->et10, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et10 = strip_tags($this->et10);
         $this->et10 = NM_charset_to_utf8($this->et10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et10;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- total_vtas
   function NM_sub_cons_total_vtas()
   {
         $this->total_vtas = NM_charset_to_utf8($this->total_vtas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->total_vtas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- et_iva
   function NM_sub_cons_et_iva()
   {
         $this->et_iva = html_entity_decode($this->et_iva, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_iva = strip_tags($this->et_iva);
         $this->et_iva = NM_charset_to_utf8($this->et_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_base
   function NM_sub_cons_et_base()
   {
         $this->et_base = html_entity_decode($this->et_base, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_base = strip_tags($this->et_base);
         $this->et_base = NM_charset_to_utf8($this->et_base);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_base;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_val_iva
   function NM_sub_cons_et_val_iva()
   {
         $this->et_val_iva = html_entity_decode($this->et_val_iva, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_val_iva = strip_tags($this->et_val_iva);
         $this->et_val_iva = NM_charset_to_utf8($this->et_val_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_val_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- etiva_19
   function NM_sub_cons_etiva_19()
   {
         $this->etiva_19 = html_entity_decode($this->etiva_19, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->etiva_19 = strip_tags($this->etiva_19);
         $this->etiva_19 = NM_charset_to_utf8($this->etiva_19);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->etiva_19;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- etiva_5
   function NM_sub_cons_etiva_5()
   {
         $this->etiva_5 = html_entity_decode($this->etiva_5, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->etiva_5 = strip_tags($this->etiva_5);
         $this->etiva_5 = NM_charset_to_utf8($this->etiva_5);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->etiva_5;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- etexc_0
   function NM_sub_cons_etexc_0()
   {
         $this->etexc_0 = html_entity_decode($this->etexc_0, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->etexc_0 = strip_tags($this->etexc_0);
         $this->etexc_0 = NM_charset_to_utf8($this->etexc_0);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->etexc_0;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_tot
   function NM_sub_cons_et_tot()
   {
         $this->et_tot = html_entity_decode($this->et_tot, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_tot = strip_tags($this->et_tot);
         $this->et_tot = NM_charset_to_utf8($this->et_tot);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_tot;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tot_base
   function NM_sub_cons_tot_base()
   {
         $this->tot_base = NM_charset_to_utf8($this->tot_base);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tot_base;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- tot_iva
   function NM_sub_cons_tot_iva()
   {
         $this->tot_iva = NM_charset_to_utf8($this->tot_iva);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tot_iva;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- et20
   function NM_sub_cons_et20()
   {
         $this->et20 = html_entity_decode($this->et20, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et20 = strip_tags($this->et20);
         $this->et20 = NM_charset_to_utf8($this->et20);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et20;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_vac
   function NM_sub_cons_et_vac()
   {
         $this->et_vac = html_entity_decode($this->et_vac, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_vac = strip_tags($this->et_vac);
         $this->et_vac = NM_charset_to_utf8($this->et_vac);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_vac;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_imb
   function NM_sub_cons_et_imb()
   {
         $this->et_imb = html_entity_decode($this->et_imb, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_imb = strip_tags($this->et_imb);
         $this->et_imb = NM_charset_to_utf8($this->et_imb);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_imb;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- imp_bol
   function NM_sub_cons_imp_bol()
   {
         $this->imp_bol = NM_charset_to_utf8($this->imp_bol);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->imp_bol;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- et_ic
   function NM_sub_cons_et_ic()
   {
         $this->et_ic = html_entity_decode($this->et_ic, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_ic = strip_tags($this->et_ic);
         $this->et_ic = NM_charset_to_utf8($this->et_ic);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_ic;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- imp_consumo
   function NM_sub_cons_imp_consumo()
   {
         $this->imp_consumo = NM_charset_to_utf8($this->imp_consumo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->imp_consumo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- et_ic_dev
   function NM_sub_cons_et_ic_dev()
   {
         $this->et_ic_dev = html_entity_decode($this->et_ic_dev, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_ic_dev = strip_tags($this->et_ic_dev);
         $this->et_ic_dev = NM_charset_to_utf8($this->et_ic_dev);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_ic_dev;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- imp_consumo_dev
   function NM_sub_cons_imp_consumo_dev()
   {
         $this->imp_consumo_dev = NM_charset_to_utf8($this->imp_consumo_dev);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->imp_consumo_dev;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- et_tot_inc
   function NM_sub_cons_et_tot_inc()
   {
         $this->et_tot_inc = html_entity_decode($this->et_tot_inc, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_tot_inc = strip_tags($this->et_tot_inc);
         $this->et_tot_inc = NM_charset_to_utf8($this->et_tot_inc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_tot_inc;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- tot_inc
   function NM_sub_cons_tot_inc()
   {
         $this->tot_inc = NM_charset_to_utf8($this->tot_inc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tot_inc;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- et_vn
   function NM_sub_cons_et_vn()
   {
         $this->et_vn = html_entity_decode($this->et_vn, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_vn = strip_tags($this->et_vn);
         $this->et_vn = NM_charset_to_utf8($this->et_vn);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_vn;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- venta_netas
   function NM_sub_cons_venta_netas()
   {
         $this->venta_netas = NM_charset_to_utf8($this->venta_netas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->venta_netas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- et_reg
   function NM_sub_cons_et_reg()
   {
         $this->et_reg = html_entity_decode($this->et_reg, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_reg = strip_tags($this->et_reg);
         $this->et_reg = NM_charset_to_utf8($this->et_reg);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_reg;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- vent_reg
   function NM_sub_cons_vent_reg()
   {
         $this->vent_reg = NM_charset_to_utf8($this->vent_reg);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->vent_reg;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- fac_anuladas
   function NM_sub_cons_fac_anuladas()
   {
         $this->fac_anuladas = html_entity_decode($this->fac_anuladas, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fac_anuladas = strip_tags($this->fac_anuladas);
         $this->fac_anuladas = NM_charset_to_utf8($this->fac_anuladas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fac_anuladas;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- f_anul
   function NM_sub_cons_f_anul()
   {
         $this->f_anul = html_entity_decode($this->f_anul, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->f_anul = strip_tags($this->f_anul);
         $this->f_anul = NM_charset_to_utf8($this->f_anul);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->f_anul;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_obs
   function NM_sub_cons_et_obs()
   {
         $this->et_obs = html_entity_decode($this->et_obs, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_obs = strip_tags($this->et_obs);
         $this->et_obs = NM_charset_to_utf8($this->et_obs);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_obs;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_fech_imp
   function NM_sub_cons_et_fech_imp()
   {
         $this->et_fech_imp = html_entity_decode($this->et_fech_imp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_fech_imp = strip_tags($this->et_fech_imp);
         $this->et_fech_imp = NM_charset_to_utf8($this->et_fech_imp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_fech_imp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- fecha_imp
   function NM_sub_cons_fecha_imp()
   {
         $this->fecha_imp = html_entity_decode($this->fecha_imp, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->fecha_imp = strip_tags($this->fecha_imp);
         $this->fecha_imp = NM_charset_to_utf8($this->fecha_imp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->fecha_imp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_ubic
   function NM_sub_cons_et_ubic()
   {
         $this->et_ubic = html_entity_decode($this->et_ubic, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_ubic = strip_tags($this->et_ubic);
         $this->et_ubic = NM_charset_to_utf8($this->et_ubic);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_ubic;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_equipo
   function NM_sub_cons_et_equipo()
   {
         $this->et_equipo = html_entity_decode($this->et_equipo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_equipo = strip_tags($this->et_equipo);
         $this->et_equipo = NM_charset_to_utf8($this->et_equipo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_equipo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- nom_equipo
   function NM_sub_cons_nom_equipo()
   {
         $this->nom_equipo = html_entity_decode($this->nom_equipo, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->nom_equipo = strip_tags($this->nom_equipo);
         $this->nom_equipo = NM_charset_to_utf8($this->nom_equipo);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->nom_equipo;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_serial
   function NM_sub_cons_et_serial()
   {
         $this->et_serial = html_entity_decode($this->et_serial, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_serial = strip_tags($this->et_serial);
         $this->et_serial = NM_charset_to_utf8($this->et_serial);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_serial;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- serial
   function NM_sub_cons_serial()
   {
         $this->serial = html_entity_decode($this->serial, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->serial = strip_tags($this->serial);
         $this->serial = NM_charset_to_utf8($this->serial);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->serial;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- et_fin2
   function NM_sub_cons_et_fin2()
   {
         $this->et_fin2 = html_entity_decode($this->et_fin2, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->et_fin2 = strip_tags($this->et_fin2);
         $this->et_fin2 = NM_charset_to_utf8($this->et_fin2);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->et_fin2;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021'][$path_doc_md5][1] = $this->Tit_doc;
...
<form name="Fdown" method="get" action="grid_reporte_caja_04092021_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_reporte_caja_04092021"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<FORM name="F0" method=post action="./"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja_04092021']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
