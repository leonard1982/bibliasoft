  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detalleven_pos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detalleven_pos_form();
	}
...
?>
  ...
  // ---------- Validate idpro_
  function do_ajax_form_detalleven_pos_validate_idpro_(iNumLinha)
  {
  } // do_ajax_form_detalleven_pos_validate_idpro_

  function do_ajax_form_detalleven_pos_validate_idpro__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_idpro__cb

  // ---------- Validate idbod_
  function do_ajax_form_detalleven_pos_validate_idbod_(iNumLinha)
  {
    var nomeCampo_idbod_ = "idbod_" + iNumLinha;
    var var_idbod_ = scAjaxGetFieldSelect(nomeCampo_idbod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_idbod_(var_idbod_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_idbod__cb);
  } // do_ajax_form_detalleven_pos_validate_idbod_

  function do_ajax_form_detalleven_pos_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_idbod__cb

  // ---------- Validate stockubica_
  function do_ajax_form_detalleven_pos_validate_stockubica_(iNumLinha)
  {
    var nomeCampo_stockubica_ = "stockubica_" + iNumLinha;
    var var_stockubica_ = scAjaxGetFieldHidden(nomeCampo_stockubica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_stockubica_(var_stockubica_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_stockubica__cb);
  } // do_ajax_form_detalleven_pos_validate_stockubica_

  function do_ajax_form_detalleven_pos_validate_stockubica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_stockubica__cb

  // ---------- Validate cantidad_
  function do_ajax_form_detalleven_pos_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_cantidad__cb);
  } // do_ajax_form_detalleven_pos_validate_cantidad_

  function do_ajax_form_detalleven_pos_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_cantidad__cb

  // ---------- Validate valorunit_
  function do_ajax_form_detalleven_pos_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldHidden(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_valorunit__cb);
  } // do_ajax_form_detalleven_pos_validate_valorunit_

  function do_ajax_form_detalleven_pos_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_valorunit__cb

  // ---------- Validate valorpar_
  function do_ajax_form_detalleven_pos_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldHidden(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_valorpar__cb);
  } // do_ajax_form_detalleven_pos_validate_valorpar_

  function do_ajax_form_detalleven_pos_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_valorpar__cb

  // ---------- Validate descuento_
  function do_ajax_form_detalleven_pos_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldHidden(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_descuento__cb);
  } // do_ajax_form_detalleven_pos_validate_descuento_

  function do_ajax_form_detalleven_pos_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_descuento__cb

  // ---------- Validate iva_
  function do_ajax_form_detalleven_pos_validate_iva_(iNumLinha)
  {
    var nomeCampo_iva_ = "iva_" + iNumLinha;
    var var_iva_ = scAjaxGetFieldHidden(nomeCampo_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_iva_(var_iva_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_iva__cb);
  } // do_ajax_form_detalleven_pos_validate_iva_

  function do_ajax_form_detalleven_pos_validate_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_iva__cb

  // ---------- Validate adicional_
  function do_ajax_form_detalleven_pos_validate_adicional_(iNumLinha)
  {
    var nomeCampo_adicional_ = "adicional_" + iNumLinha;
    var var_adicional_ = scAjaxGetFieldText(nomeCampo_adicional_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_adicional_(var_adicional_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_adicional__cb);
  } // do_ajax_form_detalleven_pos_validate_adicional_

  function do_ajax_form_detalleven_pos_validate_adicional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_adicional__cb

  // ---------- Validate adicional1_
  function do_ajax_form_detalleven_pos_validate_adicional1_(iNumLinha)
  {
    var nomeCampo_adicional1_ = "adicional1_" + iNumLinha;
    var var_adicional1_ = scAjaxGetFieldText(nomeCampo_adicional1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_adicional1_(var_adicional1_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_adicional1__cb);
  } // do_ajax_form_detalleven_pos_validate_adicional1_

  function do_ajax_form_detalleven_pos_validate_adicional1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_adicional1__cb

  // ---------- Validate devuelto_
  function do_ajax_form_detalleven_pos_validate_devuelto_(iNumLinha)
  {
    var nomeCampo_devuelto_ = "devuelto_" + iNumLinha;
    var var_devuelto_ = scAjaxGetFieldText(nomeCampo_devuelto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_devuelto_(var_devuelto_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_devuelto__cb);
  } // do_ajax_form_detalleven_pos_validate_devuelto_

  function do_ajax_form_detalleven_pos_validate_devuelto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_devuelto__cb

  // ---------- Validate iddet_
  function do_ajax_form_detalleven_pos_validate_iddet_(iNumLinha)
  {
    var nomeCampo_iddet_ = "iddet_" + iNumLinha;
    var var_iddet_ = scAjaxGetFieldHidden(nomeCampo_iddet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_validate_iddet_(var_iddet_, iNumLinha, var_script_case_init, do_ajax_form_detalleven_pos_validate_iddet__cb);
  } // do_ajax_form_detalleven_pos_validate_iddet_

  function do_ajax_form_detalleven_pos_validate_iddet__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detalleven_pos_validate_iddet__cb

  // ---------- Event onchange cantidad_
  function do_ajax_form_detalleven_pos_event_cantidad__onchange(iSeqForm)
  {
    ...
    var var_valorunit_ = scAjaxGetFieldHidden("valorunit_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalleven_pos_event_cantidad__onchange(var_cantidad_, var_stockubica_, var_idpro_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_valorunit_, var_idbod_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalleven_pos_event_cantidad__onchange_cb);
  } // do_ajax_form_detalleven_pos_event_cantidad__onchange

  function do_ajax_form_detalleven_pos_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalleven_pos_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_detalleven_pos_event_cantidad__onchange_cb
  function do_ajax_form_detalleven_pos_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalleven_pos_event_cantidad__onchange_cb_after_alert

  // ---------- Event onfocus cantidad_
  function do_ajax_form_detalleven_pos_event_cantidad__onfocus(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_detalleven_pos_event_cantidad__onfocus(var_cantidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalleven_pos_event_cantidad__onfocus_cb);
  } // do_ajax_form_detalleven_pos_event_cantidad__onfocus

  function do_ajax_form_detalleven_pos_event_cantidad__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalleven_pos_event_cantidad__onfocus_cb_after_alert);
  } // do_ajax_form_detalleven_pos_event_cantidad__onfocus_cb
  function do_ajax_form_detalleven_pos_event_cantidad__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalleven_pos_event_cantidad__onfocus_cb_after_alert

  // ---------- Event onchange idbod_
  function do_ajax_form_detalleven_pos_event_idbod__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_stockubica_ = scAjaxGetFieldHidden("stockubica_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalleven_pos_event_idbod__onchange(var_idpro_, var_idbod_, var_stockubica_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalleven_pos_event_idbod__onchange_cb);
  } // do_ajax_form_detalleven_pos_event_idbod__onchange

  function do_ajax_form_detalleven_pos_event_idbod__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalleven_pos_event_idbod__onchange_cb_after_alert);
  } // do_ajax_form_detalleven_pos_event_idbod__onchange_cb
  function do_ajax_form_detalleven_pos_event_idbod__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalleven_pos_event_idbod__onchange_cb_after_alert

  // ---------- Event onchange idpro_
  function do_ajax_form_detalleven_pos_event_idpro__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldHidden("valorunit_" + iSeqForm);
    var var_adicional1_ = scAjaxGetFieldText("adicional1_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detalleven_pos_event_idpro__onchange(var_idpro_, var_valorunit_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_cantidad_, var_idbod_, var_stockubica_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detalleven_pos_event_idpro__onchange_cb);
  } // do_ajax_form_detalleven_pos_event_idpro__onchange

  function do_ajax_form_detalleven_pos_event_idpro__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalleven_pos_event_idpro__onchange_cb_after_alert);
  } // do_ajax_form_detalleven_pos_event_idpro__onchange_cb
  function do_ajax_form_detalleven_pos_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detalleven_pos_event_idpro__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detalleven_pos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detalleven_pos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detalleven_pos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detalleven_pos_add_new_line_cb);
  } // do_ajax_form_detalleven_pos_add_new_line

  function do_ajax_form_detalleven_pos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
...
?>
  } // do_ajax_form_detalleven_pos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detalleven_pos_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detalleven_pos_backup_line(var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detalleven_pos_backup_line_cb);
  } // do_ajax_form_detalleven_pos_backup_line

  function do_ajax_form_detalleven_pos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detalleven_pos_backup_line_cb

  function do_ajax_form_detalleven_pos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detalleven_pos_cancel_insert

  function do_ajax_form_detalleven_pos_cancel_update(iSeqVert)
  {
    do_ajax_form_detalleven_pos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detalleven_pos_cancel_update

  function do_ajax_form_detalleven_pos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detalleven_pos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detalleven_pos_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detalleven_pos_table_refresh(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detalleven_pos_table_refresh_cb);
  } //  do_ajax_form_detalleven_pos_table_refresh

  function do_ajax_form_detalleven_pos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_detalleven_pos_table_refresh_cb_after_alert);
  } // do_ajax_form_detalleven_pos_table_refresh_cb
  function do_ajax_form_detalleven_pos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detalleven_pos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detalleven_pos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detalleven_pos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_valorunit_ = scAjaxGetFieldHidden("valorunit_" + iNumLinha);
...
?>
    x_ajax_form_detalleven_pos_submit_form(var_idpro_, var_idbod_, var_stockubica_, var_cantidad_, var_valorunit_, var_valorpar_, var_descuento_, var_iva_, var_adicional_, var_adicional1_, var_devuelto_, var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detalleven_pos_submit_form_cb);
  } // do_ajax_form_detalleven_pos_submit_form

  function do_ajax_form_detalleven_pos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detalleven_pos_submit_form_cb_after_alert);
  } // do_ajax_form_detalleven_pos_submit_form_cb
  function do_ajax_form_detalleven_pos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detalleven_pos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detalleven_pos_navigate_form()
  {
    perform_ajax_form_detalleven_pos_navigate_form();
  }

  function perform_ajax_form_detalleven_pos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_detalleven_pos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detalleven_pos_navigate_form(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detalleven_pos_navigate_form_cb);
  } // do_ajax_form_detalleven_pos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleven_pos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detalleven_pos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detalleven_pos_navigate_form_cb_after_alert);
  } // do_ajax_form_detalleven_pos_navigate_form_cb
  function do_ajax_form_detalleven_pos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_detalleven_pos_navigate_form_cb_after_alert
  function sc_hide_form_detalleven_pos_form()
  {
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_idpro_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idpro_" + iRow] || "on" == ajax_error_count["idbod_" + iRow] || "on" == ajax_error_count["stockubica_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["valorunit_" + iRow] || "on" == ajax_error_count["valorpar_" + iRow] || "on" == ajax_error_count["descuento_" + iRow] || "on" == ajax_error_count["iva_" + iRow] || "on" == ajax_error_count["adicional_" + iRow] || "on" == ajax_error_count["adicional1_" + iRow] || "on" == ajax_error_count["devuelto_" + iRow] || "on" == ajax_error_count["iddet_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idpro_" + iRow] && "off" == ajax_error_count["idbod_" + iRow] && "off" == ajax_error_count["stockubica_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["valorunit_" + iRow] && "off" == ajax_error_count["valorpar_" + iRow] && "off" == ajax_error_count["descuento_" + iRow] && "off" == ajax_error_count["iva_" + iRow] && "off" == ajax_error_count["adicional_" + iRow] && "off" == ajax_error_count["adicional1_" + iRow] && "off" == ajax_error_count["devuelto_" + iRow] && "off" == ajax_error_count["iddet_" + iRow]))
    {
      if (bErrorRow)
      {
