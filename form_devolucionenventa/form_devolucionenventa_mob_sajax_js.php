  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_devolucionenventa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_devolucionenventa_mob_form();
	}
  ...
  // ---------- Validate numerodev
  function do_ajax_form_devolucionenventa_mob_validate_numerodev()
  {
    var nomeCampo_numerodev = "numerodev";
    var var_numerodev = scAjaxGetFieldHidden(nomeCampo_numerodev);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_numerodev(var_numerodev, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_numerodev_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_numerodev

  function do_ajax_form_devolucionenventa_mob_validate_numerodev_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numerodev";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_numerodev_cb

  // ---------- Validate fecha
  function do_ajax_form_devolucionenventa_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_fecha_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_fecha

  function do_ajax_form_devolucionenventa_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_fecha_cb

  // ---------- Validate resolucion
  function do_ajax_form_devolucionenventa_mob_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_resolucion_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_resolucion

  function do_ajax_form_devolucionenventa_mob_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_resolucion_cb

  // ---------- Validate numfacven
  function do_ajax_form_devolucionenventa_mob_validate_numfacven()
  {
    var nomeCampo_numfacven = "numfacven";
    var var_numfacven = scAjaxGetFieldSelect(nomeCampo_numfacven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_numfacven(var_numfacven, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_numfacven_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_numfacven

  function do_ajax_form_devolucionenventa_mob_validate_numfacven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_numfacven_cb

  // ---------- Validate costopro
  function do_ajax_form_devolucionenventa_mob_validate_costopro()
  {
    var nomeCampo_costopro = "costopro";
    var var_costopro = scAjaxGetFieldText(nomeCampo_costopro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_costopro(var_costopro, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_costopro_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_costopro

  function do_ajax_form_devolucionenventa_mob_validate_costopro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "costopro";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_costopro_cb

  // ---------- Validate fechafactura
  function do_ajax_form_devolucionenventa_mob_validate_fechafactura()
  {
    var nomeCampo_fechafactura = "fechafactura";
    var var_fechafactura = scAjaxGetFieldHidden(nomeCampo_fechafactura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_fechafactura(var_fechafactura, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_fechafactura_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_fechafactura

  function do_ajax_form_devolucionenventa_mob_validate_fechafactura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fechafactura";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_fechafactura_cb

  // ---------- Validate vdesc
  function do_ajax_form_devolucionenventa_mob_validate_vdesc()
  {
    var nomeCampo_vdesc = "vdesc";
    var var_vdesc = scAjaxGetFieldHidden(nomeCampo_vdesc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_vdesc(var_vdesc, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_vdesc_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_vdesc

  function do_ajax_form_devolucionenventa_mob_validate_vdesc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vdesc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_vdesc_cb

  // ---------- Validate vparc
  function do_ajax_form_devolucionenventa_mob_validate_vparc()
  {
    var nomeCampo_vparc = "vparc";
    var var_vparc = scAjaxGetFieldHidden(nomeCampo_vparc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_vparc(var_vparc, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_vparc_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_vparc

  function do_ajax_form_devolucionenventa_mob_validate_vparc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vparc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_vparc_cb

  // ---------- Validate viva
  function do_ajax_form_devolucionenventa_mob_validate_viva()
  {
    var nomeCampo_viva = "viva";
    var var_viva = scAjaxGetFieldHidden(nomeCampo_viva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_viva(var_viva, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_viva_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_viva

  function do_ajax_form_devolucionenventa_mob_validate_viva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "viva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_viva_cb

  // ---------- Validate vunit
  function do_ajax_form_devolucionenventa_mob_validate_vunit()
  {
    var nomeCampo_vunit = "vunit";
    var var_vunit = scAjaxGetFieldHidden(nomeCampo_vunit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_vunit(var_vunit, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_vunit_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_vunit

  function do_ajax_form_devolucionenventa_mob_validate_vunit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vunit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_vunit_cb

  // ---------- Validate observa
  function do_ajax_form_devolucionenventa_mob_validate_observa()
  {
    var nomeCampo_observa = "observa";
    var var_observa = scAjaxGetFieldText(nomeCampo_observa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_observa(var_observa, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_observa_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_observa

  function do_ajax_form_devolucionenventa_mob_validate_observa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_observa_cb

  // ---------- Validate actualiza
  function do_ajax_form_devolucionenventa_mob_validate_actualiza()
  {
    var nomeCampo_actualiza = "actualiza";
    var var_actualiza = scAjaxGetFieldCheckbox(nomeCampo_actualiza, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_actualiza(var_actualiza, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_actualiza_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_actualiza

  function do_ajax_form_devolucionenventa_mob_validate_actualiza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "actualiza";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_actualiza_cb

  // ---------- Validate detalle
  function do_ajax_form_devolucionenventa_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_devolucionenventa_mob_validate_detalle_cb);
  } // do_ajax_form_devolucionenventa_mob_validate_detalle

  function do_ajax_form_devolucionenventa_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_mob_validate_detalle_cb

  // ---------- Event onclick actualiza
  function do_ajax_form_devolucionenventa_mob_event_actualiza_onclick()
  {
    var var_numerodev = scAjaxGetFieldHidden("numerodev");
    var var_vunit = scAjaxGetFieldHidden("vunit");
    var var_vparc = scAjaxGetFieldHidden("vparc");
    var var_viva = scAjaxGetFieldHidden("viva");
    var var_vdesc = scAjaxGetFieldHidden("vdesc");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_mob_event_actualiza_onclick(var_numerodev, var_vunit, var_vparc, var_viva, var_vdesc, var_script_case_init, do_ajax_form_devolucionenventa_mob_event_actualiza_onclick_cb);
  } // do_ajax_form_devolucionenventa_mob_event_actualiza_onclick

  function do_ajax_form_devolucionenventa_mob_event_actualiza_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "actualiza";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_mob_event_actualiza_onclick_cb_after_alert);
  } // do_ajax_form_devolucionenventa_mob_event_actualiza_onclick_cb
  function do_ajax_form_devolucionenventa_mob_event_actualiza_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_mob_event_actualiza_onclick_cb_after_alert

  // ---------- Event onblur cantidad
  function do_ajax_form_devolucionenventa_mob_event_cantidad_onblur()
  {
    var var_vparc = scAjaxGetFieldHidden("vparc");
    var var_vunit = scAjaxGetFieldHidden("vunit");
    var var_viva = scAjaxGetFieldHidden("viva");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_mob_event_cantidad_onblur(var_vparc, var_vunit, var_viva, var_vdesc, var_script_case_init, do_ajax_form_devolucionenventa_mob_event_cantidad_onblur_cb);
  } // do_ajax_form_devolucionenventa_mob_event_cantidad_onblur

  function do_ajax_form_devolucionenventa_mob_event_cantidad_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_mob_event_cantidad_onblur_cb_after_alert);
  } // do_ajax_form_devolucionenventa_mob_event_cantidad_onblur_cb
  function do_ajax_form_devolucionenventa_mob_event_cantidad_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_mob_event_cantidad_onblur_cb_after_alert

  // ---------- Event onclick costopro
  function do_ajax_form_devolucionenventa_mob_event_costopro_onclick()
  {
    var var_numerodev = scAjaxGetFieldHidden("numerodev");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_numfacven = scAjaxGetFieldSelect("numfacven");
    var var_fechafactura = scAjaxGetFieldHidden("fechafactura");
    var var_vdesc = scAjaxGetFieldHidden("vdesc");
    var var_vparc = scAjaxGetFieldHidden("vparc");
    var var_viva = scAjaxGetFieldHidden("viva");
    var var_vunit = scAjaxGetFieldHidden("vunit");
    var var_observa = scAjaxGetFieldText("observa");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_mob_event_costopro_onclick(var_numerodev, var_fecha, var_resolucion, var_numfacven, var_fechafactura, var_vdesc, var_vparc, var_viva, var_vunit, var_observa, var_script_case_init, do_ajax_form_devolucionenventa_mob_event_costopro_onclick_cb);
  } // do_ajax_form_devolucionenventa_mob_event_costopro_onclick

  function do_ajax_form_devolucionenventa_mob_event_costopro_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "costopro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_mob_event_costopro_onclick_cb_after_alert);
  } // do_ajax_form_devolucionenventa_mob_event_costopro_onclick_cb
  function do_ajax_form_devolucionenventa_mob_event_costopro_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_mob_event_costopro_onclick_cb_after_alert

  // ---------- Event onchange idpro
  function do_ajax_form_devolucionenventa_mob_event_idpro_onchange()
  {
    var var_vunit = scAjaxGetFieldHidden("vunit");
    var var_vparc = scAjaxGetFieldHidden("vparc");
    var var_viva = scAjaxGetFieldHidden("viva");
    var var_vdesc = scAjaxGetFieldHidden("vdesc");
    var var_costopro = scAjaxGetFieldText("costopro");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_mob_event_idpro_onchange(var_vunit, var_vparc, var_viva, var_vdesc, var_costopro, var_script_case_init, do_ajax_form_devolucionenventa_mob_event_idpro_onchange_cb);
  } // do_ajax_form_devolucionenventa_mob_event_idpro_onchange

  function do_ajax_form_devolucionenventa_mob_event_idpro_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_mob_event_idpro_onchange_cb_after_alert);
  } // do_ajax_form_devolucionenventa_mob_event_idpro_onchange_cb
  function do_ajax_form_devolucionenventa_mob_event_idpro_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_mob_event_idpro_onchange_cb_after_alert

  // ---------- Event onchange numfacven
  function do_ajax_form_devolucionenventa_mob_event_numfacven_onchange()
  {
    var var_numfacven = scAjaxGetFieldSelect("numfacven");
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_costopro = scAjaxGetFieldText("costopro");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_mob_event_numfacven_onchange(var_numfacven, var_resolucion, var_costopro, var_vparc, var_viva, var_vunit, var_vdesc, var_fechafactura, var_script_case_init, do_ajax_form_devolucionenventa_mob_event_numfacven_onchange_cb);
  } // do_ajax_form_devolucionenventa_mob_event_numfacven_onchange

  function do_ajax_form_devolucionenventa_mob_event_numfacven_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "numfacven";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_mob_event_numfacven_onchange_cb_after_alert);
  } // do_ajax_form_devolucionenventa_mob_event_numfacven_onchange_cb
  function do_ajax_form_devolucionenventa_mob_event_numfacven_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_mob_event_numfacven_onchange_cb_after_alert

  // ---------- Event onchange resolucion
  function do_ajax_form_devolucionenventa_mob_event_resolucion_onchange()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_mob_event_resolucion_onchange(var_resolucion, var_script_case_init, do_ajax_form_devolucionenventa_mob_event_resolucion_onchange_cb);
  } // do_ajax_form_devolucionenventa_mob_event_resolucion_onchange

  function do_ajax_form_devolucionenventa_mob_event_resolucion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "resolucion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_mob_event_resolucion_onchange_cb_after_alert);
  } // do_ajax_form_devolucionenventa_mob_event_resolucion_onchange_cb
  function do_ajax_form_devolucionenventa_mob_event_resolucion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_mob_event_resolucion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_devolucionenventa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_devolucionenventa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_numerodev = scAjaxGetFieldHidden("numerodev");
    ...
    var var_vunit = scAjaxGetFieldHidden("vunit");
    var var_observa = scAjaxGetFieldText("observa");
    var var_actualiza = scAjaxGetFieldCheckbox("actualiza", ";");
    var var_iddevol = scAjaxGetFieldText("iddevol");
    ...
    scAjaxProcOn();
    x_ajax_form_devolucionenventa_mob_submit_form(var_numerodev, var_fecha, var_resolucion, var_numfacven, var_costopro, var_fechafactura, var_vdesc, var_vparc, var_viva, var_vunit, var_observa, var_actualiza, var_iddevol, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_devolucionenventa_mob_submit_form_cb);
  } // do_ajax_form_devolucionenventa_mob_submit_form

  function do_ajax_form_devolucionenventa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("numerodev");
      scAjaxHideErrorDisplay("fecha");
      scAjaxHideErrorDisplay("resolucion");
      scAjaxHideErrorDisplay("numfacven");
      scAjaxHideErrorDisplay("costopro");
      scAjaxHideErrorDisplay("fechafactura");
      scAjaxHideErrorDisplay("vdesc");
      scAjaxHideErrorDisplay("vparc");
      scAjaxHideErrorDisplay("viva");
      scAjaxHideErrorDisplay("vunit");
      scAjaxHideErrorDisplay("observa");
      scAjaxHideErrorDisplay("actualiza");
      scAjaxHideErrorDisplay("detalle");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_devolucionenventa_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_devolucionenventa_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devolucionenventa_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_devolucionenventa_mob_submit_form_cb_after_alert);
  } // do_ajax_form_devolucionenventa_mob_submit_form_cb
  function do_ajax_form_devolucionenventa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_devolucionenventa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_corregir_devoluciones"] = "off";

  function do_ajax_form_devolucionenventa_mob_navigate_form()
  {
    perform_ajax_form_devolucionenventa_mob_navigate_form();
  }

  function perform_ajax_form_devolucionenventa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("actualiza");
    scAjaxHideErrorDisplay("detalle");
    var var_iddevol = document.F2.iddevol.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_corregir_devoluciones"] = "on";
    x_ajax_form_devolucionenventa_mob_navigate_form(var_iddevol, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_devolucionenventa_mob_navigate_form_cb);
  } // do_ajax_form_devolucionenventa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devolucionenventa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_devolucionenventa_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iddevol.value = scAjaxGetKeyValue("iddevol");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_corregir_devoluciones"] && "nmsc_iframe_liga_grid_corregir_devoluciones" != scMasterDetailIframe["nmsc_iframe_liga_grid_corregir_devoluciones"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_corregir_devoluciones"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_corregir_devoluciones').contentWindow.nm_move('apl_detalhe', true, '600');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_devolucionenventa_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_devolucionenventa_mob_navigate_form_cb
  function do_ajax_form_devolucionenventa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_devolucionenventa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
    scAjaxProcOff();
  } // do_ajax_form_devolucionenventa_mob_navigate_form_cb_after_alert
  function sc_hide_form_devolucionenventa_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_corregir_devoluciones"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "numerodev";
  ajax_field_list[1] = "fecha";
  ajax_field_list[2] = "resolucion";
  ajax_field_list[3] = "numfacven";
  ajax_field_list[4] = "costopro";
  ajax_field_list[5] = "fechafactura";
  ajax_field_list[6] = "vdesc";
  ajax_field_list[7] = "vparc";
  ajax_field_list[8] = "viva";
  ajax_field_list[9] = "vunit";
  ajax_field_list[10] = "observa";
  ajax_field_list[11] = "actualiza";
  ajax_field_list[12] = "detalle";
  ...
  var ajax_error_list = {
    "numerodev": {"label": "Devolución", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha": {"label": "Fecha Dev.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "resolucion": {"label": "Prefijo Factura", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numfacven": {"label": "Factura N°.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "costopro": {"label": "Confirmar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fechafactura": {"label": "Fecha de la factura", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vdesc": {"label": "Descuento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vparc": {"label": "Subtotal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "viva": {"label": "Total IVA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vunit": {"label": "Valor total dev", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "observa": {"label": "Observaciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "actualiza": {"label": "Hacer Click después de eliminar items", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["numerodev"][1] = "numerodev";
  ajax_field_mult["fecha"][1] = "fecha";
  ajax_field_mult["resolucion"][1] = "resolucion";
  ajax_field_mult["numfacven"][1] = "numfacven";
  ajax_field_mult["costopro"][1] = "costopro";
  ajax_field_mult["fechafactura"][1] = "fechafactura";
  ajax_field_mult["vdesc"][1] = "vdesc";
  ajax_field_mult["vparc"][1] = "vparc";
  ajax_field_mult["viva"][1] = "viva";
  ajax_field_mult["vunit"][1] = "vunit";
  ajax_field_mult["observa"][1] = "observa";
  ajax_field_mult["actualiza"][1] = "actualiza";
  ajax_field_mult["detalle"][1] = "detalle";

  var ajax_field_id = {
    "numerodev": new Array("hidden_field_label_numerodev", "hidden_field_data_numerodev"),
    ...
    "costopro": new Array("hidden_field_label_costopro", "hidden_field_data_costopro"),
    "fechafactura": new Array("hidden_field_label_fechafactura", "hidden_field_data_fechafactura"),
    "vdesc": new Array("hidden_field_label_vdesc", "hidden_field_data_vdesc"),
    "vparc": new Array("hidden_field_label_vparc", "hidden_field_data_vparc"),
    "viva": new Array("hidden_field_label_viva", "hidden_field_data_viva"),
    "vunit": new Array("hidden_field_label_vunit", "hidden_field_data_vunit"),
    "observa": new Array("hidden_field_label_observa", "hidden_field_data_observa"),
    "actualiza": new Array("hidden_field_label_actualiza", "hidden_field_data_actualiza"),
