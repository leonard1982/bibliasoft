  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_devolucionenventa" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_devolucionenventa_form();
	}
...
?>
  ...
  // ---------- Validate numerodev
  function do_ajax_form_devolucionenventa_validate_numerodev()
  {
    var nomeCampo_numerodev = "numerodev";
    var var_numerodev = scAjaxGetFieldHidden(nomeCampo_numerodev);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_numerodev(var_numerodev, var_script_case_init, do_ajax_form_devolucionenventa_validate_numerodev_cb);
  } // do_ajax_form_devolucionenventa_validate_numerodev

  function do_ajax_form_devolucionenventa_validate_numerodev_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_numerodev_cb

  // ---------- Validate fecha
  function do_ajax_form_devolucionenventa_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_devolucionenventa_validate_fecha_cb);
  } // do_ajax_form_devolucionenventa_validate_fecha

  function do_ajax_form_devolucionenventa_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_fecha_cb

  // ---------- Validate resolucion
  function do_ajax_form_devolucionenventa_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldSelect(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_devolucionenventa_validate_resolucion_cb);
  } // do_ajax_form_devolucionenventa_validate_resolucion

  function do_ajax_form_devolucionenventa_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_resolucion_cb

  // ---------- Validate numfacven
  function do_ajax_form_devolucionenventa_validate_numfacven()
  {
    var nomeCampo_numfacven = "numfacven";
    var var_numfacven = scAjaxGetFieldSelect(nomeCampo_numfacven);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_numfacven(var_numfacven, var_script_case_init, do_ajax_form_devolucionenventa_validate_numfacven_cb);
  } // do_ajax_form_devolucionenventa_validate_numfacven

  function do_ajax_form_devolucionenventa_validate_numfacven_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_numfacven_cb

  // ---------- Validate costopro
  function do_ajax_form_devolucionenventa_validate_costopro()
  {
    var nomeCampo_costopro = "costopro";
    var var_costopro = scAjaxGetFieldText(nomeCampo_costopro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_costopro(var_costopro, var_script_case_init, do_ajax_form_devolucionenventa_validate_costopro_cb);
  } // do_ajax_form_devolucionenventa_validate_costopro

  function do_ajax_form_devolucionenventa_validate_costopro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_costopro_cb

  // ---------- Validate fechafactura
  function do_ajax_form_devolucionenventa_validate_fechafactura()
  {
    var nomeCampo_fechafactura = "fechafactura";
    var var_fechafactura = scAjaxGetFieldHidden(nomeCampo_fechafactura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_fechafactura(var_fechafactura, var_script_case_init, do_ajax_form_devolucionenventa_validate_fechafactura_cb);
  } // do_ajax_form_devolucionenventa_validate_fechafactura

  function do_ajax_form_devolucionenventa_validate_fechafactura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_fechafactura_cb

  // ---------- Validate vdesc
  function do_ajax_form_devolucionenventa_validate_vdesc()
  {
    var nomeCampo_vdesc = "vdesc";
    var var_vdesc = scAjaxGetFieldHidden(nomeCampo_vdesc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_vdesc(var_vdesc, var_script_case_init, do_ajax_form_devolucionenventa_validate_vdesc_cb);
  } // do_ajax_form_devolucionenventa_validate_vdesc

  function do_ajax_form_devolucionenventa_validate_vdesc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vdesc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_vdesc_cb

  // ---------- Validate vparc
  function do_ajax_form_devolucionenventa_validate_vparc()
  {
    var nomeCampo_vparc = "vparc";
    var var_vparc = scAjaxGetFieldHidden(nomeCampo_vparc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_vparc(var_vparc, var_script_case_init, do_ajax_form_devolucionenventa_validate_vparc_cb);
  } // do_ajax_form_devolucionenventa_validate_vparc

  function do_ajax_form_devolucionenventa_validate_vparc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vparc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_vparc_cb

  // ---------- Validate viva
  function do_ajax_form_devolucionenventa_validate_viva()
  {
    var nomeCampo_viva = "viva";
    var var_viva = scAjaxGetFieldHidden(nomeCampo_viva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_viva(var_viva, var_script_case_init, do_ajax_form_devolucionenventa_validate_viva_cb);
  } // do_ajax_form_devolucionenventa_validate_viva

  function do_ajax_form_devolucionenventa_validate_viva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "viva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_viva_cb

  // ---------- Validate vunit
  function do_ajax_form_devolucionenventa_validate_vunit()
  {
    var nomeCampo_vunit = "vunit";
    var var_vunit = scAjaxGetFieldHidden(nomeCampo_vunit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_vunit(var_vunit, var_script_case_init, do_ajax_form_devolucionenventa_validate_vunit_cb);
  } // do_ajax_form_devolucionenventa_validate_vunit

  function do_ajax_form_devolucionenventa_validate_vunit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vunit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_vunit_cb

  // ---------- Validate observa
  function do_ajax_form_devolucionenventa_validate_observa()
  {
    var nomeCampo_observa = "observa";
    var var_observa = scAjaxGetFieldText(nomeCampo_observa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_observa(var_observa, var_script_case_init, do_ajax_form_devolucionenventa_validate_observa_cb);
  } // do_ajax_form_devolucionenventa_validate_observa

  function do_ajax_form_devolucionenventa_validate_observa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_observa_cb

  // ---------- Validate actualiza
  function do_ajax_form_devolucionenventa_validate_actualiza()
  {
    var nomeCampo_actualiza = "actualiza";
    var var_actualiza = scAjaxGetFieldCheckbox(nomeCampo_actualiza, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_actualiza(var_actualiza, var_script_case_init, do_ajax_form_devolucionenventa_validate_actualiza_cb);
  } // do_ajax_form_devolucionenventa_validate_actualiza

  function do_ajax_form_devolucionenventa_validate_actualiza_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_actualiza_cb

  // ---------- Validate detalle
  function do_ajax_form_devolucionenventa_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_devolucionenventa_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_devolucionenventa_validate_detalle_cb);
  } // do_ajax_form_devolucionenventa_validate_detalle

  function do_ajax_form_devolucionenventa_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_devolucionenventa_validate_detalle_cb

  // ---------- Event onclick actualiza
  function do_ajax_form_devolucionenventa_event_actualiza_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_event_actualiza_onclick(var_numerodev, var_vunit, var_vparc, var_viva, var_vdesc, var_script_case_init, do_ajax_form_devolucionenventa_event_actualiza_onclick_cb);
  } // do_ajax_form_devolucionenventa_event_actualiza_onclick

  function do_ajax_form_devolucionenventa_event_actualiza_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "actualiza";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_event_actualiza_onclick_cb_after_alert);
  } // do_ajax_form_devolucionenventa_event_actualiza_onclick_cb
  function do_ajax_form_devolucionenventa_event_actualiza_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_event_actualiza_onclick_cb_after_alert

  // ---------- Event onblur cantidad
  function do_ajax_form_devolucionenventa_event_cantidad_onblur()
  {
    var var_vparc = scAjaxGetFieldHidden("vparc");
    var var_vunit = scAjaxGetFieldHidden("vunit");
    var var_viva = scAjaxGetFieldHidden("viva");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_event_cantidad_onblur(var_vparc, var_vunit, var_viva, var_vdesc, var_script_case_init, do_ajax_form_devolucionenventa_event_cantidad_onblur_cb);
  } // do_ajax_form_devolucionenventa_event_cantidad_onblur

  function do_ajax_form_devolucionenventa_event_cantidad_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_event_cantidad_onblur_cb_after_alert);
  } // do_ajax_form_devolucionenventa_event_cantidad_onblur_cb
  function do_ajax_form_devolucionenventa_event_cantidad_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_event_cantidad_onblur_cb_after_alert

  // ---------- Event onclick costopro
  function do_ajax_form_devolucionenventa_event_costopro_onclick()
  {
    var var_numerodev = scAjaxGetFieldHidden("numerodev");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_event_costopro_onclick(var_numerodev, var_fecha, var_resolucion, var_numfacven, var_fechafactura, var_vdesc, var_vparc, var_viva, var_vunit, var_observa, var_script_case_init, do_ajax_form_devolucionenventa_event_costopro_onclick_cb);
  } // do_ajax_form_devolucionenventa_event_costopro_onclick

  function do_ajax_form_devolucionenventa_event_costopro_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "costopro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_event_costopro_onclick_cb_after_alert);
  } // do_ajax_form_devolucionenventa_event_costopro_onclick_cb
  function do_ajax_form_devolucionenventa_event_costopro_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_event_costopro_onclick_cb_after_alert

  // ---------- Event onchange idpro
  function do_ajax_form_devolucionenventa_event_idpro_onchange()
  {
    var var_vunit = scAjaxGetFieldHidden("vunit");
    var var_vparc = scAjaxGetFieldHidden("vparc");
    var var_viva = scAjaxGetFieldHidden("viva");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_event_idpro_onchange(var_vunit, var_vparc, var_viva, var_vdesc, var_costopro, var_script_case_init, do_ajax_form_devolucionenventa_event_idpro_onchange_cb);
  } // do_ajax_form_devolucionenventa_event_idpro_onchange

  function do_ajax_form_devolucionenventa_event_idpro_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpro";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_event_idpro_onchange_cb_after_alert);
  } // do_ajax_form_devolucionenventa_event_idpro_onchange_cb
  function do_ajax_form_devolucionenventa_event_idpro_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_event_idpro_onchange_cb_after_alert

  // ---------- Event onchange numfacven
  function do_ajax_form_devolucionenventa_event_numfacven_onchange()
  {
    var var_numfacven = scAjaxGetFieldSelect("numfacven");
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_costopro = scAjaxGetFieldText("costopro");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_event_numfacven_onchange(var_numfacven, var_resolucion, var_costopro, var_vparc, var_viva, var_vunit, var_vdesc, var_fechafactura, var_script_case_init, do_ajax_form_devolucionenventa_event_numfacven_onchange_cb);
  } // do_ajax_form_devolucionenventa_event_numfacven_onchange

  function do_ajax_form_devolucionenventa_event_numfacven_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "numfacven";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_event_numfacven_onchange_cb_after_alert);
  } // do_ajax_form_devolucionenventa_event_numfacven_onchange_cb
  function do_ajax_form_devolucionenventa_event_numfacven_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_event_numfacven_onchange_cb_after_alert

  // ---------- Event onchange resolucion
  function do_ajax_form_devolucionenventa_event_resolucion_onchange()
  {
    var var_resolucion = scAjaxGetFieldSelect("resolucion");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_devolucionenventa_event_resolucion_onchange(var_resolucion, var_script_case_init, do_ajax_form_devolucionenventa_event_resolucion_onchange_cb);
  } // do_ajax_form_devolucionenventa_event_resolucion_onchange

  function do_ajax_form_devolucionenventa_event_resolucion_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "resolucion";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_devolucionenventa_event_resolucion_onchange_cb_after_alert);
  } // do_ajax_form_devolucionenventa_event_resolucion_onchange_cb
  function do_ajax_form_devolucionenventa_event_resolucion_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_devolucionenventa_event_resolucion_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_devolucionenventa_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_devolucionenventa_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_numerodev = scAjaxGetFieldHidden("numerodev");
    ...
    scAjaxProcOn();
    x_ajax_form_devolucionenventa_submit_form(var_numerodev, var_fecha, var_resolucion, var_numfacven, var_costopro, var_fechafactura, var_vdesc, var_vparc, var_viva, var_vunit, var_observa, var_actualiza, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_devolucionenventa_submit_form_cb);
  } // do_ajax_form_devolucionenventa_submit_form

  function do_ajax_form_devolucionenventa_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_devolucionenventa_submit_form_cb_after_alert);
  } // do_ajax_form_devolucionenventa_submit_form_cb
  function do_ajax_form_devolucionenventa_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_devolucionenventa_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_corregir_devoluciones"] = "off";

  function do_ajax_form_devolucionenventa_navigate_form()
  {
    perform_ajax_form_devolucionenventa_navigate_form();
  }

  function perform_ajax_form_devolucionenventa_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_devolucionenventa_navigate_form(var_iddevol, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_devolucionenventa_navigate_form_cb);
  } // do_ajax_form_devolucionenventa_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_devolucionenventa']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_devolucionenventa_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_devolucionenventa_navigate_form_cb_after_alert);
  } // do_ajax_form_devolucionenventa_navigate_form_cb
  function do_ajax_form_devolucionenventa_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_devolucionenventa_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_devolucionenventa_navigate_form_cb_after_alert
  function sc_hide_form_devolucionenventa_form()
  {
