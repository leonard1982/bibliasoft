...
$_SESSION['scriptcase']['grid_facturaven_pos_rapida']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_idcli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['arr_total']['idcli'];
      }
      else
      {
          $this->array_total_idcli = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_order']['porcliente']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_order']['porcliente'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_order']['porcliente'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_display']['porcliente'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_display']['porcliente'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_display']['porcliente'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_display']['porcliente'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_display']['porcliente'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_display']['porcliente'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_rapida']['summarizing_fields_display']['porcliente'] as $i_sum => $d_sum)
           {
