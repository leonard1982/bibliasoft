<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_facturaven_pos_rapida']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_pos_rapida_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_pos_rapida_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["credito"] : "F.P.";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["resolucion"] : "PJ";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["numfacven"] : "No";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["total"] : "Total";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["vendedor"] : "Vendedor";
   $tab_ger_campos['banco'] = "on";
   $tab_def_campos['banco'] = "banco";
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["banco"] : "Caja";
   ...
   $tab_labels["editarpos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["editarpos"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["editarpos"] : "Editar";
   ...
   $tab_labels["imprimircopia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["imprimircopia"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["imprimircopia"] : "POS";
   $tab_ger_campos['existeentns'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['existeentns'] = "existeentns";
   }
   else
   {
       $tab_def_campos['existeentns'] = "";
   }
   $tab_labels["existeentns"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["existeentns"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["existeentns"] : "TNS";
   ...
   $tab_labels["a4"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["a4"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['labels']["a4"] : "A4";
   $tab_ger_campos['editarpos'] = "none";
   $tab_ger_campos['imprimircopia'] = "none";
   $tab_ger_campos['existeentns'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_pos_rapida_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_rapida']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
