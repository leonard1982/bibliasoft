  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contacto_cotizaciones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contacto_cotizaciones_form();
	}
...
?>
  ...
  // ---------- Validate contacto_
  function do_ajax_form_contacto_cotizaciones_validate_contacto_(iNumLinha)
  {
    var nomeCampo_contacto_ = "contacto_" + iNumLinha;
    var var_contacto_ = scAjaxGetFieldText(nomeCampo_contacto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contacto_cotizaciones_validate_contacto_(var_contacto_, iNumLinha, var_script_case_init, do_ajax_form_contacto_cotizaciones_validate_contacto__cb);
  } // do_ajax_form_contacto_cotizaciones_validate_contacto_

  function do_ajax_form_contacto_cotizaciones_validate_contacto__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contacto_cotizaciones_validate_contacto__cb

  // ---------- Validate archivo_
  function do_ajax_form_contacto_cotizaciones_validate_archivo_(iNumLinha)
  {
    var nomeCampo_archivo_ = "archivo_" + iNumLinha;
    var var_archivo_ = scAjaxGetFieldText(nomeCampo_archivo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contacto_cotizaciones_validate_archivo_(var_archivo_, iNumLinha, var_script_case_init, do_ajax_form_contacto_cotizaciones_validate_archivo__cb);
  } // do_ajax_form_contacto_cotizaciones_validate_archivo_

  function do_ajax_form_contacto_cotizaciones_validate_archivo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contacto_cotizaciones_validate_archivo__cb

  // ---------- Validate observacion_
  function do_ajax_form_contacto_cotizaciones_validate_observacion_(iNumLinha)
  {
    var nomeCampo_observacion_ = "observacion_" + iNumLinha;
    var var_observacion_ = scAjaxGetFieldText(nomeCampo_observacion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contacto_cotizaciones_validate_observacion_(var_observacion_, iNumLinha, var_script_case_init, do_ajax_form_contacto_cotizaciones_validate_observacion__cb);
  } // do_ajax_form_contacto_cotizaciones_validate_observacion_

  function do_ajax_form_contacto_cotizaciones_validate_observacion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contacto_cotizaciones_validate_observacion__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_contacto_cotizaciones_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_contacto_cotizaciones_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contacto_cotizaciones_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_contacto_cotizaciones_add_new_line_cb);
  } // do_ajax_form_contacto_cotizaciones_add_new_line

  function do_ajax_form_contacto_cotizaciones_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_contacto_cotizaciones_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_contacto_cotizaciones_backup_line(iNumLinha)
  {
    var var_id_contacto_cotizaciones_ = scAjaxGetFieldText("id_contacto_cotizaciones_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contacto_cotizaciones_backup_line(var_id_contacto_cotizaciones_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_contacto_cotizaciones_backup_line_cb);
  } // do_ajax_form_contacto_cotizaciones_backup_line

  function do_ajax_form_contacto_cotizaciones_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_contacto_cotizaciones_backup_line_cb

  function do_ajax_form_contacto_cotizaciones_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_contacto_cotizaciones_cancel_insert

  function do_ajax_form_contacto_cotizaciones_cancel_update(iSeqVert)
  {
    do_ajax_form_contacto_cotizaciones_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_contacto_cotizaciones_cancel_update

  function do_ajax_form_contacto_cotizaciones_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_contacto_cotizaciones_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_contacto_cotizaciones_table_refresh()
  {
    var var_id_contacto_cotizaciones_ = document.F2.id_contacto_cotizaciones_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_contacto_cotizaciones_table_refresh(var_id_contacto_cotizaciones_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contacto_cotizaciones_table_refresh_cb);
  } //  do_ajax_form_contacto_cotizaciones_table_refresh

  function do_ajax_form_contacto_cotizaciones_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_contacto_cotizaciones_.value = scAjaxGetKeyValue("id_contacto_cotizaciones_");
    ...
    scAjaxAlert(do_ajax_form_contacto_cotizaciones_table_refresh_cb_after_alert);
  } // do_ajax_form_contacto_cotizaciones_table_refresh_cb
  function do_ajax_form_contacto_cotizaciones_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_contacto_cotizaciones_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_contacto_cotizaciones_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_contacto_cotizaciones_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_contacto_cotizaciones_submit_form(var_contacto_, var_archivo_, var_observacion_, var_archivo__ul_name, var_archivo__ul_type, var_archivo__salva, var_archivo__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contacto_cotizaciones_submit_form_cb);
  } // do_ajax_form_contacto_cotizaciones_submit_form

  function do_ajax_form_contacto_cotizaciones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contacto_cotizaciones_submit_form_cb_after_alert);
  } // do_ajax_form_contacto_cotizaciones_submit_form_cb
  function do_ajax_form_contacto_cotizaciones_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contacto_cotizaciones_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contacto_cotizaciones_navigate_form()
  {
    perform_ajax_form_contacto_cotizaciones_navigate_form();
  }

  function perform_ajax_form_contacto_cotizaciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_contacto_cotizaciones_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contacto_cotizaciones_navigate_form(var_id_contacto_cotizaciones_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contacto_cotizaciones_navigate_form_cb);
  } // do_ajax_form_contacto_cotizaciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contacto_cotizaciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contacto_cotizaciones_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_contacto_cotizaciones_.value = scAjaxGetKeyValue("id_contacto_cotizaciones_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contacto_cotizaciones_navigate_form_cb_after_alert);
  } // do_ajax_form_contacto_cotizaciones_navigate_form_cb
  function do_ajax_form_contacto_cotizaciones_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_contacto_cotizaciones_navigate_form_cb_after_alert
  function sc_hide_form_contacto_cotizaciones_form()
  {
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["contacto_" + iRow] || "on" == ajax_error_count["archivo_" + iRow] || "on" == ajax_error_count["observacion_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["contacto_" + iRow] && "off" == ajax_error_count["archivo_" + iRow] && "off" == ajax_error_count["observacion_" + iRow]))
    {
      if (bErrorRow)
      {
