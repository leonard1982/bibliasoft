<?php
//
class detallecompra_new_080822_apl
{
   ...
   var $form_vert_detallecompra_new_080822 = array();
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idfaccom)) 
          {
              $_SESSION['par_idfaccom'] = $this->par_idfaccom;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new detallecompra_new_080822_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['initialize'])
          {
              $_SESSION['scriptcase']['detallecompra_new_080822']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['detallecompra_new_080822']['contr_erro'] = 'off';
      ...
      $_SESSION['sc_session'][$script_case_init]['detallecompra_new_080822']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['detallecompra_new_080822']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['detallecompra_new_080822'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detallecompra_new_080822']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detallecompra_new_080822']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('detallecompra_new_080822') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['detallecompra_new_080822']['label'] = "Agregar Detalle";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "detallecompra_new_080822")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['detallecompra_new_080822']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['detallecompra_new_080822'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_orig'] = " where idfaccom=" . $_SESSION['par_idfaccom'] . "
and cantidad >0";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_pesq'] = " where idfaccom=" . $_SESSION['par_idfaccom'] . "
and cantidad >0";
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['detallecompra_new_080822']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['detallecompra_new_080822'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['detallecompra_new_080822'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("detallecompra_new_080822", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'detallecompra_new_080822_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'detallecompra_new_080822_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'detallecompra_new_080822/detallecompra_new_080822_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "detallecompra_new_080822_erro.class.php"); 
      }
      $this->Erro      = new detallecompra_new_080822_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opcao']))
         { 
             if ($this->iddet_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['final'];
      }
      else
      {
      }
...
if (!isset($this->sc_temp_par_idfaccom)) {$this->sc_temp_par_idfaccom = (isset($_SESSION['par_idfaccom'])) ? $_SESSION['par_idfaccom'] : "";}
      ...
      $nm_select = "select numfacom, tipo_com from facturacom where idfaccom=$this->sc_temp_par_idfaccom"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->des = array();
...
$_SESSION['scriptcase']['detallecompra_new_080822']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['detallecompra_new_080822']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['detallecompra_new_080822']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_form'][$sc_seq_vert];
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_detallecompra_new_080822']) || !is_array($this->NM_ajax_info['errList']['geral_detallecompra_new_080822']))
                  {
                      $this->NM_ajax_info['errList']['geral_detallecompra_new_080822'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_detallecompra_new_080822'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_detallecompra_new_080822'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_detallecompra_new_080822'][] = $this->Campos_Mens_erro;
                  }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_redir_atualiz'] == "ok")
          {
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(detallecompra_new_080822_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', detallecompra_new_080822_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         if (isset($this->serial_codbarra_)) { $this->nm_limpa_alfa($this->serial_codbarra_); }
         if (isset($this->porc_desc_)) { $this->nm_limpa_alfa($this->porc_desc_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert];
         }
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['cod_barras_'] =  $this->cod_barras_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['ver_'] =  $this->ver_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['presentacion_'] =  $this->presentacion_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['valorunit_'] =  $this->valorunit_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['porc_desc_'] =  $this->porc_desc_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['valorpar_'] =  $this->valorpar_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['iva_'] =  $this->iva_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['tasaiva_'] =  $this->tasaiva_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['tasadesc_'] =  $this->tasadesc_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['devuelto_'] =  $this->devuelto_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['vencimiento_'] =  $this->vencimiento_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['lote_'] =  $this->lote_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['serial_codbarra_'] =  $this->serial_codbarra_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['idfaccom_'] =  $this->idfaccom_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['colores_'] =  $this->colores_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['tallas_'] =  $this->tallas_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['sabor_'] =  $this->sabor_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['descr_'] =  $this->descr_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['fecha_fab_'] =  $this->fecha_fab_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['unidad_c_'] =  $this->unidad_c_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['num_ndevolucion_'] =  $this->num_ndevolucion_; 
         }
         $sc_seq_vert++; 
      } 
...
$_SESSION['scriptcase']['detallecompra_new_080822']['contr_erro'] = 'off'; 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_detallecompra_new_080822);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "detallecompra_new_080822.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="detallecompra_new_080822_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="detallecompra_new_080822"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              ...
              $this->NM_ajax_info['errList']['geral_detallecompra_new_080822'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
if(isset($this->ds_fls[0][0]) and $this->ds_fls[0][0]=='SI' )
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_detallecompra_new_080822';
...
;
    ...
    function ValidateField_idbod_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idbod_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['php_cmp_required']['idbod_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['php_cmp_required']['idbod_'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idbod_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['Lookup_idbod_']) && !in_array($this->idbod_, $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['Lookup_idbod_']))
          {
              $hasError = true;
    ...
    function ValidateField_idfaccom_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['php_cmp_required']['idfaccom_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['php_cmp_required']['idfaccom_'] == "on") 
           { 
              $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['iddet_']['keyVal'] = detallecompra_new_080822_pack_protect_string($this->nmgp_dados_form['iddet_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['cod_barras_'] = $this->cod_barras_;
                  }
                  if (isset($this->NM_ajax_changed['idpro_']) && $this->NM_ajax_changed['idpro_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['idpro_'] = $this->idpro_;
                  }
                  if (isset($this->NM_ajax_changed['ver_']) && $this->NM_ajax_changed['ver_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['ver_'] = $this->ver_;
                  }
                  if (isset($this->NM_ajax_changed['presentacion_']) && $this->NM_ajax_changed['presentacion_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['presentacion_'] = $this->presentacion_;
                  }
                  if (isset($this->NM_ajax_changed['cantidad_']) && $this->NM_ajax_changed['cantidad_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['valorunit_']) && $this->NM_ajax_changed['valorunit_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['valorunit_'] = $this->valorunit_;
                  }
                  if (isset($this->NM_ajax_changed['porc_desc_']) && $this->NM_ajax_changed['porc_desc_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['porc_desc_'] = $this->porc_desc_;
                  }
                  if (isset($this->NM_ajax_changed['descuento_']) && $this->NM_ajax_changed['descuento_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['descuento_'] = $this->descuento_;
                  }
                  if (isset($this->NM_ajax_changed['valorpar_']) && $this->NM_ajax_changed['valorpar_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['valorpar_'] = $this->valorpar_;
                  }
                  if (isset($this->NM_ajax_changed['iva_']) && $this->NM_ajax_changed['iva_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['iva_'] = $this->iva_;
                  }
                  if (isset($this->NM_ajax_changed['idbod_']) && $this->NM_ajax_changed['idbod_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['idbod_'] = $this->idbod_;
                  }
                  if (isset($this->NM_ajax_changed['tasaiva_']) && $this->NM_ajax_changed['tasaiva_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['tasaiva_'] = $this->tasaiva_;
                  }
                  if (isset($this->NM_ajax_changed['tasadesc_']) && $this->NM_ajax_changed['tasadesc_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['tasadesc_'] = $this->tasadesc_;
                  }
                  if (isset($this->NM_ajax_changed['devuelto_']) && $this->NM_ajax_changed['devuelto_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['devuelto_'] = $this->devuelto_;
                  }
                  if (isset($this->NM_ajax_changed['vencimiento_']) && $this->NM_ajax_changed['vencimiento_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['vencimiento_'] = $this->vencimiento_;
                  }
                  if (isset($this->NM_ajax_changed['lote_']) && $this->NM_ajax_changed['lote_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['lote_'] = $this->lote_;
                  }
                  if (isset($this->NM_ajax_changed['serial_codbarra_']) && $this->NM_ajax_changed['serial_codbarra_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['serial_codbarra_'] = $this->serial_codbarra_;
                  }
                  if (isset($this->NM_ajax_changed['iddet_']) && $this->NM_ajax_changed['iddet_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['iddet_'] = $this->iddet_;
                  }
                  if (isset($this->NM_ajax_changed['idfaccom_']) && $this->NM_ajax_changed['idfaccom_'])
                  {
                      $this->form_vert_detallecompra_new_080822[$this->nmgp_refresh_row]['idfaccom_'] = $this->idfaccom_;
                  }
              }
          }
          ...
          foreach($this->form_vert_detallecompra_new_080822 as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idpro_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][detallecompra_new_080822_pack_protect_string($aRecData['idpro_'])]),
              );
              }
          ...
          $aLookupOrig = $aLookup;
              ...
              $this->NM_ajax_info['fldList']['presentacion_' . $sc_seq_vert]['lookupCons'] = detallecompra_new_080822_pack_protect_string($conteudo);
              }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['valList'][$i] = detallecompra_new_080822_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->iddet_)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['detallecompra_new_080822']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['idpro_'] = $this->idpro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['valorunit_'] = $this->valorunit_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['porc_desc_'] = $this->porc_desc_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['descuento_'] = $this->descuento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['valorpar_'] = $this->valorpar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['iva_'] = $this->iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['idbod_'] = $this->idbod_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['tasaiva_'] = $this->tasaiva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['tasadesc_'] = $this->tasadesc_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['devuelto_'] = $this->devuelto_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['vencimiento_'] = $this->vencimiento_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['lote_'] = $this->lote_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['serial_codbarra_'] = $this->serial_codbarra_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['iddet_'] = $this->iddet_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert]['idfaccom_'] = $this->idfaccom_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          { 
              ...
              $this->serial_codbarra_ = $this->serial_codbarra__before_qstr;
              $this->unidad_c_ = $this->unidad_c__before_qstr;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_qtd']++; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_I_E']++; 
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total'] + 1; 
              $this->NM_gera_nav_page(); 
              $this->NM_ajax_info['navPage'] = $this->SC_nav_page; 
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $tmpLabel_idpro_ = $val_output;
                  ...
                  $this->lookup_presentacion_($conteudo);
                  $this->presentacion_ = $orig_presentacion_;
                  $this->NM_ajax_info['fldList']['presentacion_' . $this->nmgp_refresh_row]['lookupCons'] = detallecompra_new_080822_pack_protect_string($conteudo);
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == detallecompra_new_080822_pack_protect_string(NM_charset_to_utf8($this->idbod_)))
              {
          ...
          $tmpLabel_idbod_ = $sLabelTemp;
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['detallecompra_new_080822']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['parms'] = "iddet_?#?$this->iddet_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['detallecompra_new_080822']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_detallecompra_new_080822 = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter'] . ")";
          }
      }
...
and cantidad >0");
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total']))
          {
              ...
              $qt_geral_reg_detallecompra_new_080822 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total'] = $qt_geral_reg_detallecompra_new_080822;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_I_E'] = 0; 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_detallecompra_new_080822 = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_detallecompra_new_080822) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] += ($this->sc_max_reg + $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_I_E']); 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] > $qt_geral_reg_detallecompra_new_080822)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = $qt_geral_reg_detallecompra_new_080822 - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = ($qt_geral_reg_detallecompra_new_080822 + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe'] == "R")
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              $rs = $this->Db->Execute($nmgp_select) ; 
          } 
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          { 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['parms'] = "iddet_?#?$this->iddet_?@?";
              } 
              $this->nm_proc_onload_record($sc_seq_vert);
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['cod_barras_'] =  $this->cod_barras_; 
             $this->form_vert_detallecompra_new_080822[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
          ...
          ksort ($this->form_vert_detallecompra_new_080822); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] < (($qt_geral_reg_detallecompra_new_080822 + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['embutida_multi']) 
          { 
          } 
          else 
          { 
          ...
          { 
              ...
              $this->valorpar_ = "";  
              $this->iva_ = "";  
              $this->descuento_ = htmlentities("0.00");  
              $this->tasaiva_ = "";  
              $this->tasadesc_ = "";  
              $this->devuelto_ = "";  
              $this->vencimiento_ = "";  
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter_form'] . " and (idfaccom=" . $_SESSION['par_idfaccom'] . "
...
and cantidad >0 and (" . $comando . ")";
      ...
      $qt_geral_reg_detallecompra_new_080822 = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['total'] = $qt_geral_reg_detallecompra_new_080822;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          detallecompra_new_080822_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "detallecompra_new_080822_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['nm_run_menu'] = 2;
       $nmgp_saida_form = "detallecompra_new_080822_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['masterValue']))
{
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['detallecompra_new_080822']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
