  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_casos_prioridad" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_casos_prioridad_form();
	}
  ...
  // ---------- Validate id_prioridad_
  function do_ajax_form_casos_prioridad_validate_id_prioridad_(iNumLinha)
  {
    var nomeCampo_id_prioridad_ = "id_prioridad_" + iNumLinha;
    var var_id_prioridad_ = scAjaxGetFieldHidden(nomeCampo_id_prioridad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_prioridad_validate_id_prioridad_(var_id_prioridad_, iNumLinha, var_script_case_init, do_ajax_form_casos_prioridad_validate_id_prioridad__cb);
  } // do_ajax_form_casos_prioridad_validate_id_prioridad_

  function do_ajax_form_casos_prioridad_validate_id_prioridad__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_prioridad_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_prioridad_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_prioridad_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_prioridad_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_prioridad_validate_id_prioridad__cb

  // ---------- Validate codigo_
  function do_ajax_form_casos_prioridad_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_prioridad_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_casos_prioridad_validate_codigo__cb);
  } // do_ajax_form_casos_prioridad_validate_codigo_

  function do_ajax_form_casos_prioridad_validate_codigo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_prioridad_validate_codigo__cb

  // ---------- Validate descripcion_
  function do_ajax_form_casos_prioridad_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_prioridad_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_casos_prioridad_validate_descripcion__cb);
  } // do_ajax_form_casos_prioridad_validate_descripcion_

  function do_ajax_form_casos_prioridad_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_prioridad_validate_descripcion__cb

  // ---------- Validate color_
  function do_ajax_form_casos_prioridad_validate_color_(iNumLinha)
  {
    var nomeCampo_color_ = "color_" + iNumLinha;
    var var_color_ = scAjaxGetFieldText(nomeCampo_color_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_prioridad_validate_color_(var_color_, iNumLinha, var_script_case_init, do_ajax_form_casos_prioridad_validate_color__cb);
  } // do_ajax_form_casos_prioridad_validate_color_

  function do_ajax_form_casos_prioridad_validate_color__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_prioridad_validate_color__cb

  // ---------- Validate rgb_
  function do_ajax_form_casos_prioridad_validate_rgb_(iNumLinha)
  {
    var nomeCampo_rgb_ = "rgb_" + iNumLinha;
    var var_rgb_ = scAjaxGetFieldHidden(nomeCampo_rgb_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_prioridad_validate_rgb_(var_rgb_, iNumLinha, var_script_case_init, do_ajax_form_casos_prioridad_validate_rgb__cb);
  } // do_ajax_form_casos_prioridad_validate_rgb_

  function do_ajax_form_casos_prioridad_validate_rgb__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_prioridad_validate_rgb__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_casos_prioridad_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_casos_prioridad_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_prioridad_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_casos_prioridad_add_new_line_cb);
  } // do_ajax_form_casos_prioridad_add_new_line

  function do_ajax_form_casos_prioridad_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_casos_prioridad_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_casos_prioridad_backup_line(iNumLinha)
  {
    var var_id_prioridad_ = scAjaxGetFieldHidden("id_prioridad_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_prioridad_backup_line(var_id_prioridad_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_casos_prioridad_backup_line_cb);
  } // do_ajax_form_casos_prioridad_backup_line

  function do_ajax_form_casos_prioridad_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_casos_prioridad_backup_line_cb

  function do_ajax_form_casos_prioridad_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_casos_prioridad_cancel_insert

  function do_ajax_form_casos_prioridad_cancel_update(iSeqVert)
  {
    do_ajax_form_casos_prioridad_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_casos_prioridad_cancel_update

  function do_ajax_form_casos_prioridad_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_casos_prioridad_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_casos_prioridad_table_refresh()
  {
    var var_id_prioridad_ = document.F2.id_prioridad_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_casos_prioridad_table_refresh(var_id_prioridad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casos_prioridad_table_refresh_cb);
  } //  do_ajax_form_casos_prioridad_table_refresh

  function do_ajax_form_casos_prioridad_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_prioridad_.value = scAjaxGetKeyValue("id_prioridad_");
    ...
    scAjaxAlert(do_ajax_form_casos_prioridad_table_refresh_cb_after_alert);
  } // do_ajax_form_casos_prioridad_table_refresh_cb
  function do_ajax_form_casos_prioridad_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_casos_prioridad_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_casos_prioridad_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_casos_prioridad_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_casos_prioridad_submit_form(var_id_prioridad_, var_codigo_, var_descripcion_, var_color_, var_rgb_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_casos_prioridad_submit_form_cb);
  } // do_ajax_form_casos_prioridad_submit_form

  function do_ajax_form_casos_prioridad_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_prioridad_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_prioridad_submit_form_cb_after_alert);
  } // do_ajax_form_casos_prioridad_submit_form_cb
  function do_ajax_form_casos_prioridad_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_prioridad_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_casos_prioridad_navigate_form()
  {
    perform_ajax_form_casos_prioridad_navigate_form();
  }

  function perform_ajax_form_casos_prioridad_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_casos_prioridad_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_prioridad_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_casos_prioridad_navigate_form(var_id_prioridad_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casos_prioridad_navigate_form_cb);
  } // do_ajax_form_casos_prioridad_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_prioridad']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_casos_prioridad_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_prioridad_.value = scAjaxGetKeyValue("id_prioridad_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_casos_prioridad_navigate_form_cb_after_alert);
  } // do_ajax_form_casos_prioridad_navigate_form_cb
  function do_ajax_form_casos_prioridad_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_casos_prioridad_navigate_form_cb_after_alert
  function sc_hide_form_casos_prioridad_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_prioridad_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_error_list["id_prioridad_" + iNumLinha] = {"label": "Id Prioridad<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_prioridad_"][iNumLinha] = "id_prioridad_" + iNumLinha;
    ...
    ajax_error_count["id_prioridad_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["id_prioridad_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_prioridad_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_prioridad_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_prioridad_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_prioridad_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_prioridad_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_prioridad_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_prioridad_'])) ? $this->nmgp_cmp_readonly['id_prioridad_'] : 'on';
?>
    scAjaxFieldRead("id_prioridad_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("id_prioridad_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_prioridad_" + iRow] || "on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["color_" + iRow] || "on" == ajax_error_count["rgb_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_prioridad_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_prioridad_" + iRow] && "off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["color_" + iRow] && "off" == ajax_error_count["rgb_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_prioridad_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_prioridad_" + iRow).removeClass("scFormErrorLine");
