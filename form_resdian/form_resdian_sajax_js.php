  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_resdian" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate resolucion
  function do_ajax_form_resdian_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldText(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_resdian_validate_resolucion_cb);
  } // do_ajax_form_resdian_validate_resolucion

  function do_ajax_form_resdian_validate_resolucion_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_resolucion_cb

  // ---------- Validate rangofac
  function do_ajax_form_resdian_validate_rangofac()
  {
    var nomeCampo_rangofac = "rangofac";
    var var_rangofac = scAjaxGetFieldHidden(nomeCampo_rangofac);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_rangofac(var_rangofac, var_script_case_init, do_ajax_form_resdian_validate_rangofac_cb);
  } // do_ajax_form_resdian_validate_rangofac

  function do_ajax_form_resdian_validate_rangofac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_rangofac_cb

  // ---------- Validate fecha
  function do_ajax_form_resdian_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_resdian_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_resdian_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_resdian_validate_fecha

  function do_ajax_form_resdian_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_fecha_cb

  // ---------- Validate vigencia
  function do_ajax_form_resdian_validate_vigencia()
  {
    var nomeCampo_vigencia = "vigencia";
    var var_vigencia = scAjaxGetFieldText(nomeCampo_vigencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_vigencia(var_vigencia, var_script_case_init, do_ajax_form_resdian_validate_vigencia_cb);
  } // do_ajax_form_resdian_validate_vigencia

  function do_ajax_form_resdian_validate_vigencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_vigencia_cb

  // ---------- Validate fec_vencimiento
  function do_ajax_form_resdian_validate_fec_vencimiento()
  {
    var nomeCampo_fec_vencimiento = "fec_vencimiento";
    var var_fec_vencimiento = scAjaxGetFieldHidden(nomeCampo_fec_vencimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_fec_vencimiento(var_fec_vencimiento, var_script_case_init, do_ajax_form_resdian_validate_fec_vencimiento_cb);
  } // do_ajax_form_resdian_validate_fec_vencimiento

  function do_ajax_form_resdian_validate_fec_vencimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_fec_vencimiento_cb

  // ---------- Validate prefijo
  function do_ajax_form_resdian_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldText(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_resdian_validate_prefijo_cb);
  } // do_ajax_form_resdian_validate_prefijo

  function do_ajax_form_resdian_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_prefijo_cb

  // ---------- Validate primerfactura
  function do_ajax_form_resdian_validate_primerfactura()
  {
    var nomeCampo_primerfactura = "primerfactura";
    var var_primerfactura = scAjaxGetFieldText(nomeCampo_primerfactura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_primerfactura(var_primerfactura, var_script_case_init, do_ajax_form_resdian_validate_primerfactura_cb);
  } // do_ajax_form_resdian_validate_primerfactura

  function do_ajax_form_resdian_validate_primerfactura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_primerfactura_cb

  // ---------- Validate desde
  function do_ajax_form_resdian_validate_desde()
  {
    var nomeCampo_desde = "desde";
    var var_desde = scAjaxGetFieldText(nomeCampo_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_desde(var_desde, var_script_case_init, do_ajax_form_resdian_validate_desde_cb);
  } // do_ajax_form_resdian_validate_desde

  function do_ajax_form_resdian_validate_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desde";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_desde_cb

  // ---------- Validate ultima_fac
  function do_ajax_form_resdian_validate_ultima_fac()
  {
    var nomeCampo_ultima_fac = "ultima_fac";
    var var_ultima_fac = scAjaxGetFieldText(nomeCampo_ultima_fac);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_ultima_fac(var_ultima_fac, var_script_case_init, do_ajax_form_resdian_validate_ultima_fac_cb);
  } // do_ajax_form_resdian_validate_ultima_fac

  function do_ajax_form_resdian_validate_ultima_fac_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_ultima_fac_cb

  // ---------- Validate tipo
  function do_ajax_form_resdian_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_resdian_validate_tipo_cb);
  } // do_ajax_form_resdian_validate_tipo

  function do_ajax_form_resdian_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_tipo_cb

  // ---------- Validate prefijo_fe
  function do_ajax_form_resdian_validate_prefijo_fe()
  {
    var nomeCampo_prefijo_fe = "prefijo_fe";
    var var_prefijo_fe = scAjaxGetFieldSelect(nomeCampo_prefijo_fe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_prefijo_fe(var_prefijo_fe, var_script_case_init, do_ajax_form_resdian_validate_prefijo_fe_cb);
  } // do_ajax_form_resdian_validate_prefijo_fe

  function do_ajax_form_resdian_validate_prefijo_fe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_prefijo_fe_cb

  // ---------- Validate pref_factura
  function do_ajax_form_resdian_validate_pref_factura()
  {
    var nomeCampo_pref_factura = "pref_factura";
    var var_pref_factura = scAjaxGetFieldCheckbox(nomeCampo_pref_factura, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_pref_factura(var_pref_factura, var_script_case_init, do_ajax_form_resdian_validate_pref_factura_cb);
  } // do_ajax_form_resdian_validate_pref_factura

  function do_ajax_form_resdian_validate_pref_factura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_pref_factura_cb

  // ---------- Validate pref_ncr
  function do_ajax_form_resdian_validate_pref_ncr()
  {
    var nomeCampo_pref_ncr = "pref_ncr";
    var var_pref_ncr = scAjaxGetFieldCheckbox(nomeCampo_pref_ncr, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_pref_ncr(var_pref_ncr, var_script_case_init, do_ajax_form_resdian_validate_pref_ncr_cb);
  } // do_ajax_form_resdian_validate_pref_ncr

  function do_ajax_form_resdian_validate_pref_ncr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_pref_ncr_cb

  // ---------- Validate pref_ndb
  function do_ajax_form_resdian_validate_pref_ndb()
  {
    var nomeCampo_pref_ndb = "pref_ndb";
    var var_pref_ndb = scAjaxGetFieldCheckbox(nomeCampo_pref_ndb, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_pref_ndb(var_pref_ndb, var_script_case_init, do_ajax_form_resdian_validate_pref_ndb_cb);
  } // do_ajax_form_resdian_validate_pref_ndb

  function do_ajax_form_resdian_validate_pref_ndb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_resdian_validate_activa()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_activa(var_activa, var_script_case_init, do_ajax_form_resdian_validate_activa_cb);
  } // do_ajax_form_resdian_validate_activa

  function do_ajax_form_resdian_validate_activa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_activa_cb

  // ---------- Validate nombre_pc
  function do_ajax_form_resdian_validate_nombre_pc()
  {
    var nomeCampo_nombre_pc = "nombre_pc";
    var var_nombre_pc = scAjaxGetFieldText(nomeCampo_nombre_pc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_nombre_pc(var_nombre_pc, var_script_case_init, do_ajax_form_resdian_validate_nombre_pc_cb);
  } // do_ajax_form_resdian_validate_nombre_pc

  function do_ajax_form_resdian_validate_nombre_pc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_nombre_pc_cb

  // ---------- Validate nombre_impre
  function do_ajax_form_resdian_validate_nombre_impre()
  {
    var nomeCampo_nombre_impre = "nombre_impre";
    var var_nombre_impre = scAjaxGetFieldText(nomeCampo_nombre_impre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_nombre_impre(var_nombre_impre, var_script_case_init, do_ajax_form_resdian_validate_nombre_impre_cb);
  } // do_ajax_form_resdian_validate_nombre_impre

  function do_ajax_form_resdian_validate_nombre_impre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_nombre_impre_cb

  // ---------- Validate contador_pruebas
  function do_ajax_form_resdian_validate_contador_pruebas()
  {
    var nomeCampo_contador_pruebas = "contador_pruebas";
    var var_contador_pruebas = scAjaxGetFieldText(nomeCampo_contador_pruebas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_contador_pruebas(var_contador_pruebas, var_script_case_init, do_ajax_form_resdian_validate_contador_pruebas_cb);
  } // do_ajax_form_resdian_validate_contador_pruebas

  function do_ajax_form_resdian_validate_contador_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_contador_pruebas_cb

  // ---------- Validate texto_encabezado
  function do_ajax_form_resdian_validate_texto_encabezado()
  {
    var nomeCampo_texto_encabezado = "texto_encabezado";
    var var_texto_encabezado = scAjaxGetFieldText(nomeCampo_texto_encabezado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_texto_encabezado(var_texto_encabezado, var_script_case_init, do_ajax_form_resdian_validate_texto_encabezado_cb);
  } // do_ajax_form_resdian_validate_texto_encabezado

  function do_ajax_form_resdian_validate_texto_encabezado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_texto_encabezado_cb

  // ---------- Validate texto_pie_pagina
  function do_ajax_form_resdian_validate_texto_pie_pagina()
  {
    var nomeCampo_texto_pie_pagina = "texto_pie_pagina";
    var var_texto_pie_pagina = scAjaxGetFieldText(nomeCampo_texto_pie_pagina);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_resdian_validate_texto_pie_pagina(var_texto_pie_pagina, var_script_case_init, do_ajax_form_resdian_validate_texto_pie_pagina_cb);
  } // do_ajax_form_resdian_validate_texto_pie_pagina

  function do_ajax_form_resdian_validate_texto_pie_pagina_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_resdian_validate_texto_pie_pagina_cb

  // ---------- Event onchange vigencia
  function do_ajax_form_resdian_event_vigencia_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_resdian_event_vigencia_onchange(var_fecha, var_vigencia, var_fec_vencimiento, var_script_case_init, do_ajax_form_resdian_event_vigencia_onchange_cb);
  } // do_ajax_form_resdian_event_vigencia_onchange

  function do_ajax_form_resdian_event_vigencia_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "vigencia";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_resdian_event_vigencia_onchange_cb_after_alert);
  } // do_ajax_form_resdian_event_vigencia_onchange_cb
  function do_ajax_form_resdian_event_vigencia_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_resdian_event_vigencia_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_resdian_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_resdian_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
  ...
  function do_ajax_form_resdian_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_resdian_submit_form_cb_after_alert);
  } // do_ajax_form_resdian_submit_form_cb
  function do_ajax_form_resdian_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_resdian_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_resdian_navigate_form()
  {
    perform_ajax_form_resdian_navigate_form();
  }

  function perform_ajax_form_resdian_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_resdian_navigate_form(var_idres, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_resdian_navigate_form_cb);
  } // do_ajax_form_resdian_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_resdian_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_resdian_navigate_form_cb_after_alert);
  } // do_ajax_form_resdian_navigate_form_cb
  function do_ajax_form_resdian_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_resdian_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_resdian_navigate_form_cb_after_alert
  function sc_hide_form_resdian_form()
  {
