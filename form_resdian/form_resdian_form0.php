...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_resdian_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_resdian_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_resdian_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_resdian'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_resdian'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['maximized']))
  {
?>
<tr><td>
      ...
      <TABLE style="padding: 0px; border-spacing: 0px; border-width: 0px;" width="100%">
       <TR valign="middle">
        ...
        <TD align="left" class="scFormHeaderFont">
          <?php if ($this->nmgp_opcao == "novo") { echo "Nueva Resolución Dian"; } else { echo "Editar Resolución Dian"; } ?>
        </TD>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['empty_filter'] = true;
       }
  }
?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_tipo'][] = ''; ?>
 <option value=""></option>
 <option  value="AUTORIZACION" <?php  if ($this->tipo == "AUTORIZACION") { echo " selected" ;} ?>>AUTORIZACIÓN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_tipo'][] = 'AUTORIZACION'; ?>
 <option  value="HABILITACION" <?php  if ($this->tipo == "HABILITACION") { echo " selected" ;} ?>>HABILITACIÓN</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_tipo'][] = 'HABILITACION'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_prefijo_fe'][] = ''; ?>
 <option value="">Seleccione</option>
 <option  value="NF" <?php  if ($this->prefijo_fe == "NF") { echo " selected" ;} ?><?php  if (empty($this->prefijo_fe)) { echo " selected" ;} ?>>FACTURA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_prefijo_fe'][] = 'NF'; ?>
 <option  value="FC" <?php  if ($this->prefijo_fe == "FC") { echo " selected" ;} ?>>F. COMPUTADOR</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_prefijo_fe'][] = 'FC'; ?>
 <option  value="FP" <?php  if ($this->prefijo_fe == "FP") { echo " selected" ;} ?>>F. POS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_prefijo_fe'][] = 'FP'; ?>
 <option  value="FE" <?php  if ($this->prefijo_fe == "FE") { echo " selected" ;} ?>>ELECTRÓNICO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_prefijo_fe'][] = 'FE'; ?>
 </select></span>
</span><?php  }?>
...
<span id="id_read_on_pref_factura" class="css_pref_factura_line" style="<?php echo $sStyleReadLab_pref_factura; ?>"><?php echo $this->form_format_readonly("pref_factura", $this->form_encode_input($pref_factura_look)); ?></span><span id="id_read_off_pref_factura" class="css_read_off_pref_factura css_pref_factura_line" style="<?php echo $sStyleReadInp_pref_factura; ?>"><?php echo "<div id=\"idAjaxCheckbox_pref_factura\" style=\"display: inline-block\" class=\"css_pref_factura_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_pref_factura'][] = 'SI'; ?>
...
<span id="id_read_on_pref_ncr" class="css_pref_ncr_line" style="<?php echo $sStyleReadLab_pref_ncr; ?>"><?php echo $this->form_format_readonly("pref_ncr", $this->form_encode_input($pref_ncr_look)); ?></span><span id="id_read_off_pref_ncr" class="css_read_off_pref_ncr css_pref_ncr_line" style="<?php echo $sStyleReadInp_pref_ncr; ?>"><?php echo "<div id=\"idAjaxCheckbox_pref_ncr\" style=\"display: inline-block\" class=\"css_pref_ncr_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_pref_ncr'][] = 'SI'; ?>
...
<span id="id_read_on_pref_ndb" class="css_pref_ndb_line" style="<?php echo $sStyleReadLab_pref_ndb; ?>"><?php echo $this->form_format_readonly("pref_ndb", $this->form_encode_input($pref_ndb_look)); ?></span><span id="id_read_off_pref_ndb" class="css_read_off_pref_ndb css_pref_ndb_line" style="<?php echo $sStyleReadInp_pref_ndb; ?>"><?php echo "<div id=\"idAjaxCheckbox_pref_ndb\" style=\"display: inline-block\" class=\"css_pref_ndb_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_pref_ndb'][] = 'SI'; ?>
...
<span id="id_read_on_prefijo_com" class="css_prefijo_com_line" style="<?php echo $sStyleReadLab_prefijo_com; ?>"><?php echo $this->form_format_readonly("prefijo_com", $this->form_encode_input($prefijo_com_look)); ?></span><span id="id_read_off_prefijo_com" class="css_read_off_prefijo_com css_prefijo_com_line" style="<?php echo $sStyleReadInp_prefijo_com; ?>"><?php echo "<div id=\"idAjaxCheckbox_prefijo_com\" style=\"display: inline-block\" class=\"css_prefijo_com_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_prefijo_com'][] = 'SI'; ?>
...
<span id="id_read_on_prefijo_ajuscom" class="css_prefijo_ajuscom_line" style="<?php echo $sStyleReadLab_prefijo_ajuscom; ?>"><?php echo $this->form_format_readonly("prefijo_ajuscom", $this->form_encode_input($prefijo_ajuscom_look)); ?></span><span id="id_read_off_prefijo_ajuscom" class="css_read_off_prefijo_ajuscom css_prefijo_ajuscom_line" style="<?php echo $sStyleReadInp_prefijo_ajuscom; ?>"><?php echo "<div id=\"idAjaxCheckbox_prefijo_ajuscom\" style=\"display: inline-block\" class=\"css_prefijo_ajuscom_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_prefijo_ajuscom'][] = 'SI'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_activa'][] = 'SI'; ?>
 <option  value="NO" <?php  if ($this->activa == "NO") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['Lookup_activa'][] = 'NO'; ?>
 </select></span>
</span><?php  }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['texto_pie_pagina'] = "Texto Pié Página";
    }
?>
<?php
   $nm_cor_fun_cel  = ($nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['btn_label']['last'];
        }
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['masterValue']))
{
...
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['masterValue'] as $cmp_master => $val_master)
        {
?>
    dbParentFrame[0].contentWindow.scAjaxDetailValue('<?php echo $cmp_master ?>', '<?php echo $val_master ?>');
<?php
        }
        unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['masterValue']);
?>
}
<?php
    }
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_resdian");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_resdian");
 parent.scAjaxDetailHeight("form_resdian", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
{
<?php
if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['sc_modal'])
{
?>
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_resdian']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
