...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idres' + iSeqRow).bind('change', function() { sc_form_resdian_idres_onchange(this, iSeqRow) });
  $('#id_sc_field_resolucion' + iSeqRow).bind('blur', function() { sc_form_resdian_resolucion_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_resdian_resolucion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_rangofac' + iSeqRow).bind('blur', function() { sc_form_resdian_rangofac_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_resdian_rangofac_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_form_resdian_fecha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_resdian_fecha_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_prefijo' + iSeqRow).bind('blur', function() { sc_form_resdian_prefijo_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_resdian_prefijo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_primerfactura' + iSeqRow).bind('blur', function() { sc_form_resdian_primerfactura_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_resdian_primerfactura_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre_pc' + iSeqRow).bind('blur', function() { sc_form_resdian_nombre_pc_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_resdian_nombre_pc_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nombre_impre' + iSeqRow).bind('blur', function() { sc_form_resdian_nombre_impre_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_resdian_nombre_impre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fec_vencimiento' + iSeqRow).bind('blur', function() { sc_form_resdian_fec_vencimiento_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_resdian_fec_vencimiento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_prefijo_fe' + iSeqRow).bind('blur', function() { sc_form_resdian_prefijo_fe_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_resdian_prefijo_fe_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pref_factura' + iSeqRow).bind('blur', function() { sc_form_resdian_pref_factura_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_resdian_pref_factura_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pref_ncr' + iSeqRow).bind('blur', function() { sc_form_resdian_pref_ncr_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_resdian_pref_ncr_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pref_ndb' + iSeqRow).bind('blur', function() { sc_form_resdian_pref_ndb_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_resdian_pref_ndb_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_ultima_fac' + iSeqRow).bind('blur', function() { sc_form_resdian_ultima_fac_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_resdian_ultima_fac_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo' + iSeqRow).bind('blur', function() { sc_form_resdian_tipo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_resdian_tipo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_activa' + iSeqRow).bind('blur', function() { sc_form_resdian_activa_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_resdian_activa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_desde' + iSeqRow).bind('blur', function() { sc_form_resdian_desde_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_resdian_desde_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_contador_pruebas' + iSeqRow).bind('blur', function() { sc_form_resdian_contador_pruebas_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_resdian_contador_pruebas_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_texto_encabezado' + iSeqRow).bind('blur', function() { sc_form_resdian_texto_encabezado_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_resdian_texto_encabezado_onchange(this, iSeqRow) })
...
function sc_form_resdian_resolucion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_rangofac_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_prefijo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_primerfactura_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_nombre_pc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_nombre_impre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_fec_vencimiento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_prefijo_fe_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_pref_factura_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_pref_ncr_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_pref_ndb_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_ultima_fac_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_tipo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_activa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_desde_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_contador_pruebas_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_texto_encabezado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_resdian_texto_pie_pagina_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_resdian_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_resdian_validate_fecha(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_resdian')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
