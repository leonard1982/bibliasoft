...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idpedido' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_idpedido_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pagar_pedido_CW_idpedido_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechaven' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_fechaven_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pagar_pedido_CW_fechaven_onfocus(this, iSeqRow) });
  $('#id_sc_field_idcli' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_idcli_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pagar_pedido_CW_idcli_onfocus(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_total_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_pagar_pedido_CW_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentada' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_asentada_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_pagar_pedido_CW_asentada_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_adicional_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pagar_pedido_CW_adicional_onfocus(this, iSeqRow) });
  $('#id_sc_field_formapago' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_formapago_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pagar_pedido_CW_formapago_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional2' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_adicional2_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_pagar_pedido_CW_adicional2_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pagar_pedido_CW_adicional2_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional3' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_adicional3_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_pagar_pedido_CW_adicional3_onfocus(this, iSeqRow) });
  $('#id_sc_field_obspago' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_obspago_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_pagar_pedido_CW_obspago_onfocus(this, iSeqRow) });
  $('#id_sc_field_numpedido' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_numpedido_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_pagar_pedido_CW_numpedido_onfocus(this, iSeqRow) });
  $('#id_sc_field_prefijo_ped' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_prefijo_ped_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_pagar_pedido_CW_prefijo_ped_onfocus(this, iSeqRow) });
  $('#id_sc_field_creado_en_movil' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_creado_en_movil_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_pagar_pedido_CW_creado_en_movil_onfocus(this, iSeqRow) });
  $('#id_sc_field_disponible_en_movil' + iSeqRow).bind('blur', function() { sc_form_pagar_pedido_CW_disponible_en_movil_onblur(this, iSeqRow) })
                                                 .bind('focus', function() { sc_form_pagar_pedido_CW_disponible_en_movil_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_pagar_pedido_CW_idpedido_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_idpedido();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_idpedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_fechaven_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_fechaven();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_fechaven_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_idcli_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_idcli();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_idcli_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_total_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_total();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_asentada_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_asentada();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_asentada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_adicional_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_adicional();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_adicional_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_formapago_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_formapago();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_formapago_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_adicional2_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_adicional2();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_adicional2_onchange(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_event_adicional2_onchange();
}

function sc_form_pagar_pedido_CW_adicional2_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_adicional3_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_adicional3();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_adicional3_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_obspago_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_obspago();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_obspago_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_numpedido_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_numpedido();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_numpedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_prefijo_ped_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_prefijo_ped();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_prefijo_ped_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_creado_en_movil_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_creado_en_movil();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_creado_en_movil_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_pagar_pedido_CW_disponible_en_movil_onblur(oThis, iSeqRow) {
  do_ajax_form_pagar_pedido_CW_mob_validate_disponible_en_movil();
  scCssBlur(oThis);
}

function sc_form_pagar_pedido_CW_disponible_en_movil_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_pagar_pedido_CW_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pagar_pedido_CW_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechadocu" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pagar_pedido_CW_mob_validate_fechadocu(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pagar_pedido_CW_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
