  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_prefijos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_prefijos_form();
	}
  ...
  // ---------- Validate id_empresa
  function do_ajax_form_cloud_prefijos_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldSelect(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_prefijos_validate_id_empresa_cb);
  } // do_ajax_form_cloud_prefijos_validate_id_empresa

  function do_ajax_form_cloud_prefijos_validate_id_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_id_empresa_cb

  // ---------- Validate tipo
  function do_ajax_form_cloud_prefijos_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_cloud_prefijos_validate_tipo_cb);
  } // do_ajax_form_cloud_prefijos_validate_tipo

  function do_ajax_form_cloud_prefijos_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_tipo_cb

  // ---------- Validate cod_prefijo
  function do_ajax_form_cloud_prefijos_validate_cod_prefijo()
  {
    var nomeCampo_cod_prefijo = "cod_prefijo";
    var var_cod_prefijo = scAjaxGetFieldSelect(nomeCampo_cod_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_cod_prefijo(var_cod_prefijo, var_script_case_init, do_ajax_form_cloud_prefijos_validate_cod_prefijo_cb);
  } // do_ajax_form_cloud_prefijos_validate_cod_prefijo

  function do_ajax_form_cloud_prefijos_validate_cod_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_cod_prefijo_cb

  // ---------- Validate prefijo
  function do_ajax_form_cloud_prefijos_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldText(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_cloud_prefijos_validate_prefijo_cb);
  } // do_ajax_form_cloud_prefijos_validate_prefijo

  function do_ajax_form_cloud_prefijos_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_prefijo_cb

  // ---------- Validate prefijo_prueba
  function do_ajax_form_cloud_prefijos_validate_prefijo_prueba()
  {
    var nomeCampo_prefijo_prueba = "prefijo_prueba";
    var var_prefijo_prueba = scAjaxGetFieldText(nomeCampo_prefijo_prueba);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_prefijo_prueba(var_prefijo_prueba, var_script_case_init, do_ajax_form_cloud_prefijos_validate_prefijo_prueba_cb);
  } // do_ajax_form_cloud_prefijos_validate_prefijo_prueba

  function do_ajax_form_cloud_prefijos_validate_prefijo_prueba_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_prefijo_prueba_cb

  // ---------- Validate resolucion
  function do_ajax_form_cloud_prefijos_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldText(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_cloud_prefijos_validate_resolucion_cb);
  } // do_ajax_form_cloud_prefijos_validate_resolucion

  function do_ajax_form_cloud_prefijos_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_resolucion_cb

  // ---------- Validate fecha
  function do_ajax_form_cloud_prefijos_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_cloud_prefijos_validate_fecha_cb);
  } // do_ajax_form_cloud_prefijos_validate_fecha

  function do_ajax_form_cloud_prefijos_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_fecha_cb

  // ---------- Validate inicial
  function do_ajax_form_cloud_prefijos_validate_inicial()
  {
    var nomeCampo_inicial = "inicial";
    var var_inicial = scAjaxGetFieldText(nomeCampo_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_inicial(var_inicial, var_script_case_init, do_ajax_form_cloud_prefijos_validate_inicial_cb);
  } // do_ajax_form_cloud_prefijos_validate_inicial

  function do_ajax_form_cloud_prefijos_validate_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inicial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_inicial_cb

  // ---------- Validate final
  function do_ajax_form_cloud_prefijos_validate_final()
  {
    var nomeCampo_final = "final";
    var var_final = scAjaxGetFieldText(nomeCampo_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_final(var_final, var_script_case_init, do_ajax_form_cloud_prefijos_validate_final_cb);
  } // do_ajax_form_cloud_prefijos_validate_final

  function do_ajax_form_cloud_prefijos_validate_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "final";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_final_cb

  // ---------- Validate vigencia
  function do_ajax_form_cloud_prefijos_validate_vigencia()
  {
    var nomeCampo_vigencia = "vigencia";
    var var_vigencia = scAjaxGetFieldText(nomeCampo_vigencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_vigencia(var_vigencia, var_script_case_init, do_ajax_form_cloud_prefijos_validate_vigencia_cb);
  } // do_ajax_form_cloud_prefijos_validate_vigencia

  function do_ajax_form_cloud_prefijos_validate_vigencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_vigencia_cb

  // ---------- Validate tipo_resolucion
  function do_ajax_form_cloud_prefijos_validate_tipo_resolucion()
  {
    var nomeCampo_tipo_resolucion = "tipo_resolucion";
    var var_tipo_resolucion = scAjaxGetFieldSelect(nomeCampo_tipo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_tipo_resolucion(var_tipo_resolucion, var_script_case_init, do_ajax_form_cloud_prefijos_validate_tipo_resolucion_cb);
  } // do_ajax_form_cloud_prefijos_validate_tipo_resolucion

  function do_ajax_form_cloud_prefijos_validate_tipo_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_tipo_resolucion_cb

  // ---------- Validate activa
  function do_ajax_form_cloud_prefijos_validate_activa()
  {
    var nomeCampo_activa = "activa";
    var var_activa = scAjaxGetFieldCheckbox(nomeCampo_activa, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_activa(var_activa, var_script_case_init, do_ajax_form_cloud_prefijos_validate_activa_cb);
  } // do_ajax_form_cloud_prefijos_validate_activa

  function do_ajax_form_cloud_prefijos_validate_activa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_activa_cb

  // ---------- Validate contador
  function do_ajax_form_cloud_prefijos_validate_contador()
  {
    var nomeCampo_contador = "contador";
    var var_contador = scAjaxGetFieldHidden(nomeCampo_contador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_contador(var_contador, var_script_case_init, do_ajax_form_cloud_prefijos_validate_contador_cb);
  } // do_ajax_form_cloud_prefijos_validate_contador

  function do_ajax_form_cloud_prefijos_validate_contador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_contador_cb

  // ---------- Validate consecutivo_pruebas
  function do_ajax_form_cloud_prefijos_validate_consecutivo_pruebas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_consecutivo_pruebas(var_consecutivo_pruebas, var_script_case_init, do_ajax_form_cloud_prefijos_validate_consecutivo_pruebas_cb);
  } // do_ajax_form_cloud_prefijos_validate_consecutivo_pruebas

  function do_ajax_form_cloud_prefijos_validate_consecutivo_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_consecutivo_pruebas_cb

  // ---------- Validate head_note
  function do_ajax_form_cloud_prefijos_validate_head_note()
  {
    var nomeCampo_head_note = "head_note";
    var var_head_note = scAjaxGetFieldText(nomeCampo_head_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_head_note(var_head_note, var_script_case_init, do_ajax_form_cloud_prefijos_validate_head_note_cb);
  } // do_ajax_form_cloud_prefijos_validate_head_note

  function do_ajax_form_cloud_prefijos_validate_head_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_head_note_cb

  // ---------- Validate foot_note
  function do_ajax_form_cloud_prefijos_validate_foot_note()
  {
    var nomeCampo_foot_note = "foot_note";
    var var_foot_note = scAjaxGetFieldText(nomeCampo_foot_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_validate_foot_note(var_foot_note, var_script_case_init, do_ajax_form_cloud_prefijos_validate_foot_note_cb);
  } // do_ajax_form_cloud_prefijos_validate_foot_note

  function do_ajax_form_cloud_prefijos_validate_foot_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_validate_foot_note_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_prefijos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_prefijos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_prefijos_submit_form(var_id_empresa, var_tipo, var_cod_prefijo, var_prefijo, var_prefijo_prueba, var_resolucion, var_fecha, var_inicial, var_final, var_vigencia, var_tipo_resolucion, var_activa, var_contador, var_consecutivo_pruebas, var_head_note, var_foot_note, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_prefijos_submit_form_cb);
  } // do_ajax_form_cloud_prefijos_submit_form

  function do_ajax_form_cloud_prefijos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_prefijos_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_prefijos_submit_form_cb
  function do_ajax_form_cloud_prefijos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_prefijos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_prefijos_navigate_form()
  {
    perform_ajax_form_cloud_prefijos_navigate_form();
  }

  function perform_ajax_form_cloud_prefijos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_prefijos_navigate_form(var_id_prefijo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_prefijos_navigate_form_cb);
  } // do_ajax_form_cloud_prefijos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_prefijos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_prefijos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_prefijos_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_prefijos_navigate_form_cb
  function do_ajax_form_cloud_prefijos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_prefijos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cloud_prefijos_navigate_form_cb_after_alert
  function sc_hide_form_cloud_prefijos_form()
  {
