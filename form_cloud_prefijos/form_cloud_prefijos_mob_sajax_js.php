  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_prefijos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_prefijos_mob_form();
	}
  ...
  // ---------- Validate id_empresa
  function do_ajax_form_cloud_prefijos_mob_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldSelect(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_id_empresa_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_id_empresa

  function do_ajax_form_cloud_prefijos_mob_validate_id_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_id_empresa_cb

  // ---------- Validate tipo
  function do_ajax_form_cloud_prefijos_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_tipo_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_tipo

  function do_ajax_form_cloud_prefijos_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_tipo_cb

  // ---------- Validate cod_prefijo
  function do_ajax_form_cloud_prefijos_mob_validate_cod_prefijo()
  {
    var nomeCampo_cod_prefijo = "cod_prefijo";
    var var_cod_prefijo = scAjaxGetFieldSelect(nomeCampo_cod_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_cod_prefijo(var_cod_prefijo, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_cod_prefijo_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_cod_prefijo

  function do_ajax_form_cloud_prefijos_mob_validate_cod_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_prefijo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_cod_prefijo_cb

  // ---------- Validate prefijo
  function do_ajax_form_cloud_prefijos_mob_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldText(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_prefijo_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_prefijo

  function do_ajax_form_cloud_prefijos_mob_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_prefijo_cb

  // ---------- Validate prefijo_prueba
  function do_ajax_form_cloud_prefijos_mob_validate_prefijo_prueba()
  {
    var nomeCampo_prefijo_prueba = "prefijo_prueba";
    var var_prefijo_prueba = scAjaxGetFieldText(nomeCampo_prefijo_prueba);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_prefijo_prueba(var_prefijo_prueba, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_prefijo_prueba_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_prefijo_prueba

  function do_ajax_form_cloud_prefijos_mob_validate_prefijo_prueba_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo_prueba";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_prefijo_prueba_cb

  // ---------- Validate resolucion
  function do_ajax_form_cloud_prefijos_mob_validate_resolucion()
  {
    var nomeCampo_resolucion = "resolucion";
    var var_resolucion = scAjaxGetFieldText(nomeCampo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_resolucion(var_resolucion, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_resolucion_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_resolucion

  function do_ajax_form_cloud_prefijos_mob_validate_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_resolucion_cb

  // ---------- Validate fecha
  function do_ajax_form_cloud_prefijos_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_fecha_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_fecha

  function do_ajax_form_cloud_prefijos_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_fecha_cb

  // ---------- Validate inicial
  function do_ajax_form_cloud_prefijos_mob_validate_inicial()
  {
    var nomeCampo_inicial = "inicial";
    var var_inicial = scAjaxGetFieldText(nomeCampo_inicial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_inicial(var_inicial, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_inicial_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_inicial

  function do_ajax_form_cloud_prefijos_mob_validate_inicial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inicial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_inicial_cb

  // ---------- Validate final
  function do_ajax_form_cloud_prefijos_mob_validate_final()
  {
    var nomeCampo_final = "final";
    var var_final = scAjaxGetFieldText(nomeCampo_final);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_final(var_final, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_final_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_final

  function do_ajax_form_cloud_prefijos_mob_validate_final_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "final";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_final_cb

  // ---------- Validate vigencia
  function do_ajax_form_cloud_prefijos_mob_validate_vigencia()
  {
    var nomeCampo_vigencia = "vigencia";
    var var_vigencia = scAjaxGetFieldText(nomeCampo_vigencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_vigencia(var_vigencia, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_vigencia_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_vigencia

  function do_ajax_form_cloud_prefijos_mob_validate_vigencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_vigencia_cb

  // ---------- Validate tipo_resolucion
  function do_ajax_form_cloud_prefijos_mob_validate_tipo_resolucion()
  {
    var nomeCampo_tipo_resolucion = "tipo_resolucion";
    var var_tipo_resolucion = scAjaxGetFieldSelect(nomeCampo_tipo_resolucion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_tipo_resolucion(var_tipo_resolucion, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_tipo_resolucion_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_tipo_resolucion

  function do_ajax_form_cloud_prefijos_mob_validate_tipo_resolucion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_resolucion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_tipo_resolucion_cb

  // ---------- Validate activa
  function do_ajax_form_cloud_prefijos_mob_validate_activa()
  {
    var nomeCampo_activa = "activa";
    var var_activa = scAjaxGetFieldCheckbox(nomeCampo_activa, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_activa(var_activa, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_activa_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_activa

  function do_ajax_form_cloud_prefijos_mob_validate_activa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_activa_cb

  // ---------- Validate contador
  function do_ajax_form_cloud_prefijos_mob_validate_contador()
  {
    var nomeCampo_contador = "contador";
    var var_contador = scAjaxGetFieldHidden(nomeCampo_contador);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_contador(var_contador, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_contador_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_contador

  function do_ajax_form_cloud_prefijos_mob_validate_contador_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "contador";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_contador_cb

  // ---------- Validate consecutivo_pruebas
  function do_ajax_form_cloud_prefijos_mob_validate_consecutivo_pruebas()
  {
    var nomeCampo_consecutivo_pruebas = "consecutivo_pruebas";
    var var_consecutivo_pruebas = scAjaxGetFieldText(nomeCampo_consecutivo_pruebas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_consecutivo_pruebas(var_consecutivo_pruebas, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_consecutivo_pruebas_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_consecutivo_pruebas

  function do_ajax_form_cloud_prefijos_mob_validate_consecutivo_pruebas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "consecutivo_pruebas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_consecutivo_pruebas_cb

  // ---------- Validate head_note
  function do_ajax_form_cloud_prefijos_mob_validate_head_note()
  {
    var nomeCampo_head_note = "head_note";
    var var_head_note = scAjaxGetFieldText(nomeCampo_head_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_head_note(var_head_note, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_head_note_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_head_note

  function do_ajax_form_cloud_prefijos_mob_validate_head_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_head_note_cb

  // ---------- Validate foot_note
  function do_ajax_form_cloud_prefijos_mob_validate_foot_note()
  {
    var nomeCampo_foot_note = "foot_note";
    var var_foot_note = scAjaxGetFieldText(nomeCampo_foot_note);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_prefijos_mob_validate_foot_note(var_foot_note, var_script_case_init, do_ajax_form_cloud_prefijos_mob_validate_foot_note_cb);
  } // do_ajax_form_cloud_prefijos_mob_validate_foot_note

  function do_ajax_form_cloud_prefijos_mob_validate_foot_note_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foot_note";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_prefijos_mob_validate_foot_note_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_prefijos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_prefijos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_empresa = scAjaxGetFieldSelect("id_empresa");
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_cod_prefijo = scAjaxGetFieldSelect("cod_prefijo");
    var var_prefijo = scAjaxGetFieldText("prefijo");
    var var_prefijo_prueba = scAjaxGetFieldText("prefijo_prueba");
    var var_resolucion = scAjaxGetFieldText("resolucion");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_inicial = scAjaxGetFieldText("inicial");
    var var_final = scAjaxGetFieldText("final");
    var var_vigencia = scAjaxGetFieldText("vigencia");
    var var_tipo_resolucion = scAjaxGetFieldSelect("tipo_resolucion");
    var var_activa = scAjaxGetFieldCheckbox("activa", ";");
    var var_contador = scAjaxGetFieldHidden("contador");
    var var_consecutivo_pruebas = scAjaxGetFieldText("consecutivo_pruebas");
    var var_head_note = scAjaxGetFieldText("head_note");
    var var_foot_note = scAjaxGetFieldText("foot_note");
    var var_id_prefijo = scAjaxGetFieldText("id_prefijo");
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_prefijos_mob_submit_form(var_id_empresa, var_tipo, var_cod_prefijo, var_prefijo, var_prefijo_prueba, var_resolucion, var_fecha, var_inicial, var_final, var_vigencia, var_tipo_resolucion, var_activa, var_contador, var_consecutivo_pruebas, var_head_note, var_foot_note, var_id_prefijo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_prefijos_mob_submit_form_cb);
  } // do_ajax_form_cloud_prefijos_mob_submit_form

  function do_ajax_form_cloud_prefijos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("cod_prefijo");
      scAjaxHideErrorDisplay("prefijo");
      scAjaxHideErrorDisplay("prefijo_prueba");
      scAjaxHideErrorDisplay("resolucion");
      scAjaxHideErrorDisplay("fecha");
      scAjaxHideErrorDisplay("inicial");
      scAjaxHideErrorDisplay("final");
      scAjaxHideErrorDisplay("vigencia");
      scAjaxHideErrorDisplay("tipo_resolucion");
      scAjaxHideErrorDisplay("activa");
      scAjaxHideErrorDisplay("contador");
      scAjaxHideErrorDisplay("consecutivo_pruebas");
      scAjaxHideErrorDisplay("head_note");
      scAjaxHideErrorDisplay("foot_note");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_prefijos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_prefijos_mob_submit_form_cb
  function do_ajax_form_cloud_prefijos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_prefijos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_prefijos_mob_navigate_form()
  {
    perform_ajax_form_cloud_prefijos_mob_navigate_form();
  }

  function perform_ajax_form_cloud_prefijos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("head_note");
    scAjaxHideErrorDisplay("foot_note");
    var var_id_prefijo = document.F2.id_prefijo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_prefijos_mob_navigate_form(var_id_prefijo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_prefijos_mob_navigate_form_cb);
  } // do_ajax_form_cloud_prefijos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_prefijos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_prefijos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_prefijo.value = scAjaxGetKeyValue("id_prefijo");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_prefijos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_prefijos_mob_navigate_form_cb
  function do_ajax_form_cloud_prefijos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_prefijos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cloud_prefijos_mob_navigate_form_cb_after_alert
  function sc_hide_form_cloud_prefijos_mob_form()
  {
  ...
  ajax_field_list[2] = "cod_prefijo";
  ajax_field_list[3] = "prefijo";
  ajax_field_list[4] = "prefijo_prueba";
  ajax_field_list[5] = "resolucion";
  ajax_field_list[6] = "fecha";
  ajax_field_list[7] = "inicial";
  ajax_field_list[8] = "final";
  ajax_field_list[9] = "vigencia";
  ajax_field_list[10] = "tipo_resolucion";
  ajax_field_list[11] = "activa";
  ajax_field_list[12] = "contador";
  ajax_field_list[13] = "consecutivo_pruebas";
  ajax_field_list[14] = "head_note";
  ajax_field_list[15] = "foot_note";
  ...
  var ajax_error_list = {
    ...
    "cod_prefijo": {"label": "PJ/TNS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "prefijo": {"label": "PJ/FE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "prefijo_prueba": {"label": "Prefijo Prueba", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "resolucion": {"label": "Resolucion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inicial": {"label": "Inicial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "final": {"label": "Final", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vigencia": {"label": "Vig", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_resolucion": {"label": "Tipo Resolucion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "activa": {"label": "Activa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "contador": {"label": "Cont.", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "consecutivo_pruebas": {"label": "Cons. puebas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "head_note": {"label": "Texto cabecera", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "foot_note": {"label": "Texto pie de página", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "tipo": new Array(),
    "cod_prefijo": new Array(),
    "prefijo": new Array(),
    "prefijo_prueba": new Array(),
    "resolucion": new Array(),
    "fecha": new Array(),
    "inicial": new Array(),
    "final": new Array(),
    "vigencia": new Array(),
    "tipo_resolucion": new Array(),
    "activa": new Array(),
    "contador": new Array(),
    "consecutivo_pruebas": new Array(),
    "head_note": new Array(),
    "foot_note": new Array()
  };
  ajax_field_mult["id_empresa"][1] = "id_empresa";
  ajax_field_mult["tipo"][1] = "tipo";
  ajax_field_mult["cod_prefijo"][1] = "cod_prefijo";
  ajax_field_mult["prefijo"][1] = "prefijo";
  ajax_field_mult["prefijo_prueba"][1] = "prefijo_prueba";
  ajax_field_mult["resolucion"][1] = "resolucion";
  ajax_field_mult["fecha"][1] = "fecha";
  ajax_field_mult["inicial"][1] = "inicial";
  ajax_field_mult["final"][1] = "final";
  ajax_field_mult["vigencia"][1] = "vigencia";
  ajax_field_mult["tipo_resolucion"][1] = "tipo_resolucion";
  ajax_field_mult["activa"][1] = "activa";
  ajax_field_mult["contador"][1] = "contador";
  ajax_field_mult["consecutivo_pruebas"][1] = "consecutivo_pruebas";
  ajax_field_mult["head_note"][1] = "head_note";
  ajax_field_mult["foot_note"][1] = "foot_note";
  ...
  var ajax_field_id = {
    ...
    "cod_prefijo": new Array("hidden_field_label_cod_prefijo", "hidden_field_data_cod_prefijo"),
    "prefijo": new Array("hidden_field_label_prefijo", "hidden_field_data_prefijo"),
    "prefijo_prueba": new Array("hidden_field_label_prefijo_prueba", "hidden_field_data_prefijo_prueba"),
    ...
    "inicial": new Array("hidden_field_label_inicial", "hidden_field_data_inicial"),
    "final": new Array("hidden_field_label_final", "hidden_field_data_final"),
    "vigencia": new Array("hidden_field_label_vigencia", "hidden_field_data_vigencia"),
    "tipo_resolucion": new Array("hidden_field_label_tipo_resolucion", "hidden_field_data_tipo_resolucion"),
    "activa": new Array("hidden_field_label_activa", "hidden_field_data_activa"),
    "contador": new Array("hidden_field_label_contador", "hidden_field_data_contador"),
    "consecutivo_pruebas": new Array("hidden_field_label_consecutivo_pruebas", "hidden_field_data_consecutivo_pruebas"),
    "head_note": new Array("hidden_field_label_head_note", "hidden_field_data_head_note"),
    "foot_note": new Array("hidden_field_label_foot_note", "hidden_field_data_foot_note")
  };
