...
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_menu']['opc_pdf']['all_cab']     = (isset($aParams['pdf_all_cab']))     ? $aParams['pdf_all_cab']     : "S";
$_SESSION['sc_session'][$aParams['script_case_init']]['grid_menu']['opc_pdf']['all_label']   = (isset($aParams['pdf_all_label']))   ? $aParams['pdf_all_label']   : "S";
...
<head>
 <title><?php echo $Nm_lang['lang_othr_grid_title'] ?> cloud_empresas :: PDF</title>
