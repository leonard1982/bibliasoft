  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_copias_borrar_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_copias_borrar_mob_form();
	}
  ...
  // ---------- Validate id_copia
  function do_ajax_form_cloud_copias_borrar_mob_validate_id_copia()
  {
    var nomeCampo_id_copia = "id_copia";
    var var_id_copia = scAjaxGetFieldHidden(nomeCampo_id_copia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_mob_validate_id_copia(var_id_copia, var_script_case_init, do_ajax_form_cloud_copias_borrar_mob_validate_id_copia_cb);
  } // do_ajax_form_cloud_copias_borrar_mob_validate_id_copia

  function do_ajax_form_cloud_copias_borrar_mob_validate_id_copia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_copia";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_mob_validate_id_copia_cb

  // ---------- Validate fecha
  function do_ajax_form_cloud_copias_borrar_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_cloud_copias_borrar_mob_validate_fecha_cb);
  } // do_ajax_form_cloud_copias_borrar_mob_validate_fecha

  function do_ajax_form_cloud_copias_borrar_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_mob_validate_fecha_cb

  // ---------- Validate descripcion
  function do_ajax_form_cloud_copias_borrar_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_cloud_copias_borrar_mob_validate_descripcion_cb);
  } // do_ajax_form_cloud_copias_borrar_mob_validate_descripcion

  function do_ajax_form_cloud_copias_borrar_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_mob_validate_descripcion_cb

  // ---------- Validate id_empresa
  function do_ajax_form_cloud_copias_borrar_mob_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldText(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_mob_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_copias_borrar_mob_validate_id_empresa_cb);
  } // do_ajax_form_cloud_copias_borrar_mob_validate_id_empresa

  function do_ajax_form_cloud_copias_borrar_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_mob_validate_id_empresa_cb

  // ---------- Validate nombre_archivo
  function do_ajax_form_cloud_copias_borrar_mob_validate_nombre_archivo()
  {
    var nomeCampo_nombre_archivo = "nombre_archivo";
    var var_nombre_archivo = scAjaxGetFieldHidden(nomeCampo_nombre_archivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_mob_validate_nombre_archivo(var_nombre_archivo, var_script_case_init, do_ajax_form_cloud_copias_borrar_mob_validate_nombre_archivo_cb);
  } // do_ajax_form_cloud_copias_borrar_mob_validate_nombre_archivo

  function do_ajax_form_cloud_copias_borrar_mob_validate_nombre_archivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nombre_archivo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_mob_validate_nombre_archivo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_copias_borrar_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_copias_borrar_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_copia = scAjaxGetFieldHidden("id_copia");
    ...
    var var_nombre_archivo = scAjaxGetFieldHidden("nombre_archivo");
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_copias_borrar_mob_submit_form(var_id_copia, var_fecha, var_descripcion, var_id_empresa, var_nombre_archivo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_copias_borrar_mob_submit_form_cb);
  } // do_ajax_form_cloud_copias_borrar_mob_submit_form

  function do_ajax_form_cloud_copias_borrar_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_copias_borrar_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_copias_borrar_mob_submit_form_cb
  function do_ajax_form_cloud_copias_borrar_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_copias_borrar_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_copias_borrar_mob_navigate_form()
  {
    perform_ajax_form_cloud_copias_borrar_mob_navigate_form();
  }

  function perform_ajax_form_cloud_copias_borrar_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("id_empresa");
    scAjaxHideErrorDisplay("nombre_archivo");
    var var_id_copia = document.F2.id_copia.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_copias_borrar_mob_navigate_form(var_id_copia, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_copias_borrar_mob_navigate_form_cb);
  } // do_ajax_form_cloud_copias_borrar_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_copias_borrar_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_copias_borrar_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_copia.value = scAjaxGetKeyValue("id_copia");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_copias_borrar_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_copias_borrar_mob_navigate_form_cb
  function do_ajax_form_cloud_copias_borrar_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_copias_borrar_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cloud_copias_borrar_mob_navigate_form_cb_after_alert
  function sc_hide_form_cloud_copias_borrar_mob_form()
  {
  ...
  ajax_field_list[0] = "id_copia";
  ajax_field_list[1] = "fecha";
  ajax_field_list[2] = "descripcion";
  ajax_field_list[3] = "id_empresa";
  ajax_field_list[4] = "nombre_archivo";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_copia": {"label": "Id Copia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "nombre_archivo": {"label": "Nombre Archivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "nombre_archivo": new Array()
  };
  ajax_field_mult["id_copia"][1] = "id_copia";
  ajax_field_mult["fecha"][1] = "fecha";
  ajax_field_mult["descripcion"][1] = "descripcion";
  ajax_field_mult["id_empresa"][1] = "id_empresa";
  ajax_field_mult["nombre_archivo"][1] = "nombre_archivo";

  var ajax_field_id = {
    "fecha": new Array("hidden_field_label_fecha", "hidden_field_data_fecha"),
    "nombre_archivo": new Array("hidden_field_label_nombre_archivo", "hidden_field_data_nombre_archivo")
  };
