  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_copias_borrar" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_copias_borrar_form();
	}
  ...
  // ---------- Validate id_copia
  function do_ajax_form_cloud_copias_borrar_validate_id_copia()
  {
    var nomeCampo_id_copia = "id_copia";
    var var_id_copia = scAjaxGetFieldHidden(nomeCampo_id_copia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_validate_id_copia(var_id_copia, var_script_case_init, do_ajax_form_cloud_copias_borrar_validate_id_copia_cb);
  } // do_ajax_form_cloud_copias_borrar_validate_id_copia

  function do_ajax_form_cloud_copias_borrar_validate_id_copia_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_validate_id_copia_cb

  // ---------- Validate fecha
  function do_ajax_form_cloud_copias_borrar_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_cloud_copias_borrar_validate_fecha_cb);
  } // do_ajax_form_cloud_copias_borrar_validate_fecha

  function do_ajax_form_cloud_copias_borrar_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_validate_fecha_cb

  // ---------- Validate descripcion
  function do_ajax_form_cloud_copias_borrar_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_cloud_copias_borrar_validate_descripcion_cb);
  } // do_ajax_form_cloud_copias_borrar_validate_descripcion

  function do_ajax_form_cloud_copias_borrar_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_validate_descripcion_cb

  // ---------- Validate id_empresa
  function do_ajax_form_cloud_copias_borrar_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldText(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_copias_borrar_validate_id_empresa_cb);
  } // do_ajax_form_cloud_copias_borrar_validate_id_empresa

  function do_ajax_form_cloud_copias_borrar_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_validate_id_empresa_cb

  // ---------- Validate nombre_archivo
  function do_ajax_form_cloud_copias_borrar_validate_nombre_archivo()
  {
    var nomeCampo_nombre_archivo = "nombre_archivo";
    var var_nombre_archivo = scAjaxGetFieldHidden(nomeCampo_nombre_archivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_copias_borrar_validate_nombre_archivo(var_nombre_archivo, var_script_case_init, do_ajax_form_cloud_copias_borrar_validate_nombre_archivo_cb);
  } // do_ajax_form_cloud_copias_borrar_validate_nombre_archivo

  function do_ajax_form_cloud_copias_borrar_validate_nombre_archivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_copias_borrar_validate_nombre_archivo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_copias_borrar_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_copias_borrar_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_copias_borrar_submit_form(var_id_copia, var_fecha, var_descripcion, var_id_empresa, var_nombre_archivo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_copias_borrar_submit_form_cb);
  } // do_ajax_form_cloud_copias_borrar_submit_form

  function do_ajax_form_cloud_copias_borrar_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_copias_borrar_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_copias_borrar_submit_form_cb
  function do_ajax_form_cloud_copias_borrar_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_copias_borrar_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_copias_borrar_navigate_form()
  {
    perform_ajax_form_cloud_copias_borrar_navigate_form();
  }

  function perform_ajax_form_cloud_copias_borrar_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_copias_borrar_navigate_form(var_id_copia, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_copias_borrar_navigate_form_cb);
  } // do_ajax_form_cloud_copias_borrar_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_copias_borrar']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_copias_borrar_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_copias_borrar_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_copias_borrar_navigate_form_cb
  function do_ajax_form_cloud_copias_borrar_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_copias_borrar_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cloud_copias_borrar_navigate_form_cb_after_alert
  function sc_hide_form_cloud_copias_borrar_form()
  {
