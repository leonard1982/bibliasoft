 ...
 */
   ...
   // scriptcase
   include_once('form_cloud_copias_borrar_session.php');
   @session_start();
   // ----------
...
if (!isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_cloud_copias_borrar']['upload_field_info']) || !isset($_SESSION['sc_session'][ $_POST['param_seq'] ]['form_cloud_copias_borrar']['upload_field_info'][ $_POST['param_field'] ]))
{
    exit;
}

$aUploadInfo = $_SESSION['sc_session'][ $_POST['param_seq'] ]['form_cloud_copias_borrar']['upload_field_info'][ $_POST['param_field'] ];
