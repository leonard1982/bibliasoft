  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contabilidad_detalle_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contabilidad_detalle_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_contabilidad_detalle_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_detalle_mob_validate_id(var_id, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_validate_id_cb);
  } // do_ajax_form_contabilidad_detalle_mob_validate_id

  function do_ajax_form_contabilidad_detalle_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_detalle_mob_validate_id_cb

  // ---------- Validate id_contabilidad
  function do_ajax_form_contabilidad_detalle_mob_validate_id_contabilidad()
  {
    var nomeCampo_id_contabilidad = "id_contabilidad";
    var var_id_contabilidad = scAjaxGetFieldText(nomeCampo_id_contabilidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_detalle_mob_validate_id_contabilidad(var_id_contabilidad, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_validate_id_contabilidad_cb);
  } // do_ajax_form_contabilidad_detalle_mob_validate_id_contabilidad

  function do_ajax_form_contabilidad_detalle_mob_validate_id_contabilidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_detalle_mob_validate_id_contabilidad_cb

  // ---------- Validate id_puc
  function do_ajax_form_contabilidad_detalle_mob_validate_id_puc()
  {
    var nomeCampo_id_puc = "id_puc";
    var var_id_puc = scAjaxGetFieldSelect(nomeCampo_id_puc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_detalle_mob_validate_id_puc(var_id_puc, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_validate_id_puc_cb);
  } // do_ajax_form_contabilidad_detalle_mob_validate_id_puc

  function do_ajax_form_contabilidad_detalle_mob_validate_id_puc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_puc";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_detalle_mob_validate_id_puc_cb

  // ---------- Validate valor
  function do_ajax_form_contabilidad_detalle_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_detalle_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_validate_valor_cb);
  } // do_ajax_form_contabilidad_detalle_mob_validate_valor

  function do_ajax_form_contabilidad_detalle_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_detalle_mob_validate_valor_cb

  // ---------- Validate tipo
  function do_ajax_form_contabilidad_detalle_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_detalle_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_validate_tipo_cb);
  } // do_ajax_form_contabilidad_detalle_mob_validate_tipo

  function do_ajax_form_contabilidad_detalle_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_detalle_mob_validate_tipo_cb

  // ---------- Validate id_tercero
  function do_ajax_form_contabilidad_detalle_mob_validate_id_tercero()
  {
    var nomeCampo_id_tercero = "id_tercero";
    var var_id_tercero = scAjaxGetFieldSelect(nomeCampo_id_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_detalle_mob_validate_id_tercero(var_id_tercero, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_validate_id_tercero_cb);
  } // do_ajax_form_contabilidad_detalle_mob_validate_id_tercero

  function do_ajax_form_contabilidad_detalle_mob_validate_id_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_detalle_mob_validate_id_tercero_cb

  // ---------- Validate notas
  function do_ajax_form_contabilidad_detalle_mob_validate_notas()
  {
    var nomeCampo_notas = "notas";
    var var_notas = scAjaxGetFieldText(nomeCampo_notas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_detalle_mob_validate_notas(var_notas, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_validate_notas_cb);
  } // do_ajax_form_contabilidad_detalle_mob_validate_notas

  function do_ajax_form_contabilidad_detalle_mob_validate_notas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_detalle_mob_validate_notas_cb

  // ---------- Validate ndocumento
  function do_ajax_form_contabilidad_detalle_mob_validate_ndocumento()
  {
    var nomeCampo_ndocumento = "ndocumento";
    var var_ndocumento = scAjaxGetFieldText(nomeCampo_ndocumento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contabilidad_detalle_mob_validate_ndocumento(var_ndocumento, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_validate_ndocumento_cb);
  } // do_ajax_form_contabilidad_detalle_mob_validate_ndocumento

  function do_ajax_form_contabilidad_detalle_mob_validate_ndocumento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contabilidad_detalle_mob_validate_ndocumento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contabilidad_detalle_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contabilidad_detalle_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_contabilidad_detalle_mob_submit_form(var_id, var_id_contabilidad, var_id_puc, var_valor, var_tipo, var_id_tercero, var_notas, var_ndocumento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contabilidad_detalle_mob_submit_form_cb);
  } // do_ajax_form_contabilidad_detalle_mob_submit_form

  function do_ajax_form_contabilidad_detalle_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contabilidad_detalle_mob_submit_form_cb_after_alert);
  } // do_ajax_form_contabilidad_detalle_mob_submit_form_cb
  function do_ajax_form_contabilidad_detalle_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contabilidad_detalle_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contabilidad_detalle_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contabilidad_detalle_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_contabilidad_detalle_mob_navigate_form();
    }
  }

  function perform_ajax_form_contabilidad_detalle_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_contabilidad_detalle_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_navigate_form_cb);
  } // do_ajax_form_contabilidad_detalle_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contabilidad_detalle_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contabilidad_detalle_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contabilidad_detalle_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_contabilidad_detalle_mob_navigate_form_cb
  function do_ajax_form_contabilidad_detalle_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('id_puc');
...
{
?>
    do_ajax_form_contabilidad_detalle_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contabilidad_detalle_mob_navigate_form_cb_after_alert
  function sc_hide_form_contabilidad_detalle_mob_form()
  {
  ...
  function do_ajax_form_contabilidad_detalle_mob_lkpedt_refresh_id_puc()
  {
    var var_id_puc = scAjaxGetFieldSelect("id_puc");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "id_puc";
    x_ajax_form_contabilidad_detalle_mob_lkpedt_refresh_id_puc(var_id_puc, nmgp_refresh_fields, var_script_case_init, do_ajax_form_contabilidad_detalle_mob_lkpedt_refresh_id_puc_cb);
  } // do_ajax_form_contabilidad_detalle_mob_lkpedt_refresh_id_puc

  function do_ajax_form_contabilidad_detalle_mob_lkpedt_refresh_id_puc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_contabilidad_detalle_mob_lkpedt_refresh_id_puc_cb
