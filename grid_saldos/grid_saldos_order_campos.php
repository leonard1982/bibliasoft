...
<?php
   ...
   $Ord_Cmp = new grid_saldos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_saldos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["descr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["descr"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["descr"] : "Producto";
   $tab_ger_campos['id_bodega'] = "on";
   $tab_def_campos['id_bodega'] = "id_bodega";
   $tab_labels["id_bodega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["id_bodega"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["id_bodega"] : "BD";
   $tab_ger_campos['saldo_ene'] = "on";
   $tab_def_campos['saldo_ene'] = "saldo_ene";
   $tab_labels["saldo_ene"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_ene"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_ene"] : "Saldo";
   $tab_ger_campos['costo_ene'] = "on";
   $tab_def_campos['costo_ene'] = "costo_ene";
   $tab_labels["costo_ene"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_ene"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_ene"] : "Costo";
   $tab_ger_campos['saldo_feb'] = "on";
   $tab_def_campos['saldo_feb'] = "saldo_feb";
   $tab_labels["saldo_feb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_feb"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_feb"] : "Saldo";
   $tab_ger_campos['costo_feb'] = "on";
   $tab_def_campos['costo_feb'] = "costo_feb";
   $tab_labels["costo_feb"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_feb"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_feb"] : "Costo";
   $tab_ger_campos['saldo_marz'] = "on";
   $tab_def_campos['saldo_marz'] = "saldo_marz";
   $tab_labels["saldo_marz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_marz"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_marz"] : "Saldo";
   $tab_ger_campos['costo_marz'] = "on";
   $tab_def_campos['costo_marz'] = "costo_marz";
   $tab_labels["costo_marz"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_marz"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_marz"] : "Costo";
   $tab_ger_campos['saldo_abril'] = "on";
   $tab_def_campos['saldo_abril'] = "saldo_abril";
   $tab_labels["saldo_abril"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_abril"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_abril"] : "Saldo";
   $tab_ger_campos['costo_abril'] = "on";
   $tab_def_campos['costo_abril'] = "costo_abril";
   $tab_labels["costo_abril"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_abril"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_abril"] : "Costo";
   $tab_ger_campos['saldo_may'] = "on";
   $tab_def_campos['saldo_may'] = "saldo_may";
   $tab_labels["saldo_may"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_may"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_may"] : "Saldo";
   $tab_ger_campos['costo_may'] = "on";
   $tab_def_campos['costo_may'] = "costo_may";
   $tab_labels["costo_may"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_may"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_may"] : "Costo";
   $tab_ger_campos['saldo_jun'] = "on";
   $tab_def_campos['saldo_jun'] = "saldo_jun";
   $tab_labels["saldo_jun"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_jun"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_jun"] : "Saldo";
   $tab_ger_campos['costo_jun'] = "on";
   $tab_def_campos['costo_jun'] = "costo_jun";
   $tab_labels["costo_jun"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_jun"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_jun"] : "Costo";
   $tab_ger_campos['saldo_julio'] = "on";
   $tab_def_campos['saldo_julio'] = "saldo_julio";
   $tab_labels["saldo_julio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_julio"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_julio"] : "Saldo";
   $tab_ger_campos['costo_julio'] = "on";
   $tab_def_campos['costo_julio'] = "costo_julio";
   $tab_labels["costo_julio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_julio"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_julio"] : "Costo";
   $tab_ger_campos['saldo_agos'] = "on";
   $tab_def_campos['saldo_agos'] = "saldo_agos";
   $tab_labels["saldo_agos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_agos"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_agos"] : "Saldo";
   $tab_ger_campos['costo_agos'] = "on";
   $tab_def_campos['costo_agos'] = "costo_agos";
   $tab_labels["costo_agos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_agos"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_agos"] : "Costo";
   $tab_ger_campos['saldo_sep'] = "on";
   $tab_def_campos['saldo_sep'] = "saldo_sep";
   $tab_labels["saldo_sep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_sep"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_sep"] : "Saldo";
   $tab_ger_campos['costo_sep'] = "on";
   $tab_def_campos['costo_sep'] = "costo_sep";
   $tab_labels["costo_sep"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_sep"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_sep"] : "Costo";
   $tab_ger_campos['saldo_oct'] = "on";
   $tab_def_campos['saldo_oct'] = "saldo_oct";
   $tab_labels["saldo_oct"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_oct"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_oct"] : "Saldo";
   $tab_ger_campos['costo_oct'] = "on";
   $tab_def_campos['costo_oct'] = "costo_oct";
   $tab_labels["costo_oct"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_oct"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_oct"] : "Costo";
   $tab_ger_campos['saldo_nov'] = "on";
   $tab_def_campos['saldo_nov'] = "saldo_nov";
   $tab_labels["saldo_nov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_nov"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_nov"] : "Saldo";
   $tab_ger_campos['costo_nov'] = "on";
   $tab_def_campos['costo_nov'] = "costo_nov";
   $tab_labels["costo_nov"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_nov"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_nov"] : "Costo";
   $tab_ger_campos['saldo_dic'] = "on";
   $tab_def_campos['saldo_dic'] = "saldo_dic";
   $tab_labels["saldo_dic"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_dic"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["saldo_dic"] : "Saldo";
   $tab_ger_campos['costo_dic'] = "on";
   $tab_def_campos['costo_dic'] = "costo_dic";
   $tab_labels["costo_dic"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_dic"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["costo_dic"] : "Costo";
   $tab_ger_campos['anio'] = "on";
   $tab_def_campos['anio'] = "anio";
   $tab_labels["anio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["anio"])) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['labels']["anio"] : "Año";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_saldos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_saldos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_saldos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_saldos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
