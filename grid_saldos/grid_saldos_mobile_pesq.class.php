...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_id_prod"  <?php echo $str_hide_id_prod?>><?php
      if ($id_prod != "")
      {
      $id_prod_look = substr($this->Db->qstr($id_prod), 1, -1); 
      $nmgp_def_dados = array(); 
