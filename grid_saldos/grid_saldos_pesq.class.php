...
class grid_saldos_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_saldos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_saldos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_saldos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_id_prod')
      {
          $id_prod = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_id_prod($id_prod);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_id_prod($id_prod)
   {
      $id_prod = substr($this->Db->qstr($id_prod), 1, -1);
            $id_prod_look = substr($this->Db->qstr($id_prod), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "select idprod, codigobar + ' - ' + nompro from productos where  codigobar + ' - ' + nompro like '%" . $id_prod . "%' order by codigobar, nompro" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select idprod, concat(codigobar,' - ', nompro) from productos where  concat(codigobar,' - ', nompro) like '%" . $id_prod . "%' order by codigobar, nompro" ; 
      } 
      ...
      { 
          $nm_comando = "select idprod, codigobar||' - '||nompro from productos where   CAST (codigobar||' - '||nompro AS TEXT)  like '%" . $id_prod . "%' order by codigobar, nompro" ; 
      } 
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_saldos/grid_saldos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_saldos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_saldos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_saldos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_saldos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_saldos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_anio_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = '01/';
          var_dt_ini += '01/';
          var_dt_ini += document.getElementById('SC_anio_ano').value;
          document.getElementById('sc_anio_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_anio_ano').value = aParts[2];
    },
    numberOfMonths: 1,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_id_prod_cond#NMF#' + search_get_sel_txt('SC_id_prod_cond') + '@NMF@';
  str_out += 'SC_id_prod#NMF#' + search_get_text('SC_id_prod') + '@NMF@';
  str_out += 'id_ac_id_prod#NMF#' + search_get_text('id_ac_id_prod') + '@NMF@';
  str_out += 'SC_anio_cond#NMF#' + search_get_sel_txt('SC_anio_cond') + '@NMF@';
  str_out += 'SC_anio_dia#NMF#' + search_get_sel_txt('SC_anio_dia') + '@NMF@';
  str_out += 'SC_anio_mes#NMF#' + search_get_sel_txt('SC_anio_mes') + '@NMF@';
  str_out += 'SC_anio_ano#NMF#' + search_get_sel_txt('SC_anio_ano') + '@NMF@';
  str_out += 'SC_anio_input_2_dia#NMF#' + search_get_sel_txt('SC_anio_input_2_dia') + '@NMF@';
  str_out += 'SC_anio_input_2_mes#NMF#' + search_get_sel_txt('SC_anio_input_2_mes') + '@NMF@';
  str_out += 'SC_anio_input_2_ano#NMF#' + search_get_sel_txt('SC_anio_input_2_ano') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_id_prod").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_id_prod").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_id_prod",
          max_itens: "10",
          cod_desc: "N",
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Saldos por Periodo</span></td>
...
<?php
   ...
   {
      global 
             $id_prod_cond, $id_prod, $id_prod_autocomp,
             $anio_cond, $anio, $anio_dia, $anio_mes, $anio_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $id_prod = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['id_prod']; 
          $id_prod_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['id_prod_cond']; 
          $anio_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['anio_dia']; 
          $anio_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['anio_mes']; 
          $anio_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['anio_ano']; 
          $anio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['anio_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['NM_operador']; 
      } 
      if (!isset($id_prod_cond) || empty($id_prod_cond))
      {
         $id_prod_cond = "qp";
      }
      ...
      $str_hide_id_prod = (in_array($id_prod_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_anio = (in_array($anio_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($id_prod) || $id_prod == "")
      {
          $id_prod = "";
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_id_prod_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['id_prod'])) ? $this->New_label['id_prod'] : "Producto"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_prod_cond" name="id_prod_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_prod" <?php echo $str_hide_id_prod?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['id_prod'])) ? $this->New_label['id_prod'] : "Producto";
 $nmgp_tab_label .= "id_prod?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_comando = "select idprod, codigobar + ' - ' + nompro from productos where idprod = $id_prod_look order by codigobar, nompro" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "select idprod, concat(codigobar,' - ', nompro) from productos where idprod = $id_prod_look order by codigobar, nompro" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select idprod, codigobar&' - '&nompro from productos where idprod = $id_prod_look order by codigobar, nompro" ; 
      ...
      if (isset($nmgp_def_dados[0][$id_prod]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$id_prod];
      }
      else
      {
          $sAutocompValue = $id_prod;
      }
?>
<INPUT  type="text" id="SC_id_prod" name="id_prod" value="<?php echo NM_encode_input($id_prod) ?>"  size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_id_prod" name="id_prod_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_anio_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['anio'])) ? $this->New_label['anio'] : "Año"; ?></TD>
...
<?php
  ...
  {
?>
<span id='id_date_part_anio_AAAA' style='display: inline-block'>
<select class="scFilterObjectEven" id="SC_anio_ano" name="anio_ano">
  <option value=""></option>
<?php
  $Combo_ano_ini = 2017;
  ...
  {
?>
  <option value="<?php echo $I_ano; ?>"<?php  if ($anio_ano == $I_ano) { echo " selected" ;} ?>><?php echo $I_ano; ?></option>
<?php
  }
?>
</select>
<INPUT type="hidden" id="sc_anio_jq">
</span>
...
?>
        <SPAN id="id_css_anio" class="scFilterFieldFontEven">
...
<?php
   if (is_file("grid_saldos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_saldos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_saldos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.id_prod_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_id_prod'), document.F1.id_prod_cond, 'id_prod');
   document.F1.id_prod.value = "";
   document.F1.id_prod_autocomp.value = "";
   document.F1.anio_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_anio'), document.F1.anio_cond, 'anio');
   document.F1.anio_ano.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_id_prod_cond'] = 'cond';
      $tp_fields['SC_id_prod'] = 'text_aut';
      $tp_fields['id_ac_id_prod'] = 'text_aut';
      $tp_fields['SC_anio_cond'] = 'cond';
      $tp_fields['SC_anio_dia'] = 'text';
      $tp_fields['SC_anio_mes'] = 'text';
      $tp_fields['SC_anio_ano'] = 'text';
      $tp_fields['SC_anio_input_2_dia'] = 'text';
      $tp_fields['SC_anio_input_2_mes'] = 'text';
      $tp_fields['SC_anio_input_2_ano'] = 'text';
   ...
   {
      global $id_prod_cond, $id_prod, $id_prod_autocomp,
             $anio_cond, $anio, $anio_dia, $anio_mes, $anio_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($id_prod_autocomp) && empty($id_prod))
      {
          $id_prod = $id_prod_autocomp;
      }
      $id_prod_cond_salva = $id_prod_cond; 
      if (!isset($id_prod_input_2) || $id_prod_input_2 == "")
      {
          $id_prod_input_2 = $id_prod;
      }
      $anio_cond_salva = $anio_cond; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['id_prod'] = $id_prod; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['id_prod_cond'] = $id_prod_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['anio_dia'] = $anio_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['anio_mes'] = $anio_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['anio_ano'] = $anio_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['anio_cond'] = $anio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca'] = $Temp_Busca;
      }
      if ($id_prod_cond != "in" && $id_prod_cond != "bw" && !empty($id_prod) && !is_numeric($id_prod))
      {
      ...
      if ($id_prod_cond == "bw" && ((!empty($id_prod) && !is_numeric($id_prod)) || (!empty($id_prod_input_2) && !is_numeric($id_prod_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Producto";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['id_prod'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['id_prod'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['id_prod'] = $id_prod;
      }

      //----- $id_prod
      $this->Date_part = false;
      if (isset($id_prod) || $id_prod_cond == "nu" || $id_prod_cond == "nn" || $id_prod_cond == "ep" || $id_prod_cond == "ne")
      {
         $this->monta_condicao("id_prod", $id_prod_cond, $id_prod, "", "id_prod");
      }

      //----- $anio
      $this->Date_part = false;
      if (isset($anio_ano) || $anio_cond == "nu" || $anio_cond == "nn" || $anio_cond == "ep" || $anio_cond == "ne")
      {
         $this->monta_condicao("anio", $anio_cond, $anio_ano, "", "anio");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_saldos']['cond_pesq'] .= $this->NM_operador;
