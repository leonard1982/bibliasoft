  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_seg_permisos" == sTestField)
        {
...
?>
  ...
  function do_ajax_seg_permisos_validate_description_(iNumLinha)
  {
  } // do_ajax_seg_permisos_validate_description_

  function do_ajax_seg_permisos_validate_description__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_description__cb

  // ---------- Validate priv_access_
  function do_ajax_seg_permisos_validate_priv_access_(iNumLinha)
  {
    ...
    x_ajax_seg_permisos_validate_priv_access_(var_priv_access_, iNumLinha, var_script_case_init, do_ajax_seg_permisos_validate_priv_access__cb);
  } // do_ajax_seg_permisos_validate_priv_access_

  function do_ajax_seg_permisos_validate_priv_access__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_priv_access__cb

  // ---------- Validate priv_insert_
  function do_ajax_seg_permisos_validate_priv_insert_(iNumLinha)
  {
    var nomeCampo_priv_insert_ = "priv_insert_" + iNumLinha;
    var var_priv_insert_ = scAjaxGetFieldCheckbox(nomeCampo_priv_insert_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_permisos_validate_priv_insert_(var_priv_insert_, iNumLinha, var_script_case_init, do_ajax_seg_permisos_validate_priv_insert__cb);
  } // do_ajax_seg_permisos_validate_priv_insert_

  function do_ajax_seg_permisos_validate_priv_insert__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_priv_insert__cb

  // ---------- Validate priv_delete_
  function do_ajax_seg_permisos_validate_priv_delete_(iNumLinha)
  {
    var nomeCampo_priv_delete_ = "priv_delete_" + iNumLinha;
    var var_priv_delete_ = scAjaxGetFieldCheckbox(nomeCampo_priv_delete_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_permisos_validate_priv_delete_(var_priv_delete_, iNumLinha, var_script_case_init, do_ajax_seg_permisos_validate_priv_delete__cb);
  } // do_ajax_seg_permisos_validate_priv_delete_

  function do_ajax_seg_permisos_validate_priv_delete__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_priv_delete__cb

  // ---------- Validate priv_update_
  function do_ajax_seg_permisos_validate_priv_update_(iNumLinha)
  {
    var nomeCampo_priv_update_ = "priv_update_" + iNumLinha;
    var var_priv_update_ = scAjaxGetFieldCheckbox(nomeCampo_priv_update_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_permisos_validate_priv_update_(var_priv_update_, iNumLinha, var_script_case_init, do_ajax_seg_permisos_validate_priv_update__cb);
  } // do_ajax_seg_permisos_validate_priv_update_

  function do_ajax_seg_permisos_validate_priv_update__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_priv_update__cb

  // ---------- Validate priv_export_
  function do_ajax_seg_permisos_validate_priv_export_(iNumLinha)
  {
    var nomeCampo_priv_export_ = "priv_export_" + iNumLinha;
    var var_priv_export_ = scAjaxGetFieldCheckbox(nomeCampo_priv_export_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_permisos_validate_priv_export_(var_priv_export_, iNumLinha, var_script_case_init, do_ajax_seg_permisos_validate_priv_export__cb);
  } // do_ajax_seg_permisos_validate_priv_export_

  function do_ajax_seg_permisos_validate_priv_export__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_priv_export__cb

  // ---------- Validate priv_print_
  function do_ajax_seg_permisos_validate_priv_print_(iNumLinha)
  {
    var nomeCampo_priv_print_ = "priv_print_" + iNumLinha;
    var var_priv_print_ = scAjaxGetFieldCheckbox(nomeCampo_priv_print_, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_permisos_validate_priv_print_(var_priv_print_, iNumLinha, var_script_case_init, do_ajax_seg_permisos_validate_priv_print__cb);
  } // do_ajax_seg_permisos_validate_priv_print_

  function do_ajax_seg_permisos_validate_priv_print__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_priv_print__cb

  // ---------- Validate idusuarios_grupos_
  function do_ajax_seg_permisos_validate_idusuarios_grupos_(iNumLinha)
  {
    var nomeCampo_idusuarios_grupos_ = "idusuarios_grupos_" + iNumLinha;
    var var_idusuarios_grupos_ = scAjaxGetFieldText(nomeCampo_idusuarios_grupos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_permisos_validate_idusuarios_grupos_(var_idusuarios_grupos_, iNumLinha, var_script_case_init, do_ajax_seg_permisos_validate_idusuarios_grupos__cb);
  } // do_ajax_seg_permisos_validate_idusuarios_grupos_

  function do_ajax_seg_permisos_validate_idusuarios_grupos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idusuarios_grupos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idusuarios_grupos_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idusuarios_grupos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idusuarios_grupos_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_idusuarios_grupos__cb

  // ---------- Validate idapp_
  function do_ajax_seg_permisos_validate_idapp_(iNumLinha)
  {
    var nomeCampo_idapp_ = "idapp_" + iNumLinha;
    var var_idapp_ = scAjaxGetFieldText(nomeCampo_idapp_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_permisos_validate_idapp_(var_idapp_, iNumLinha, var_script_case_init, do_ajax_seg_permisos_validate_idapp__cb);
  } // do_ajax_seg_permisos_validate_idapp_

  function do_ajax_seg_permisos_validate_idapp__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idapp_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idapp_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idapp_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idapp_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_permisos_validate_idapp__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_seg_permisos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_seg_permisos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_seg_permisos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_seg_permisos_add_new_line_cb);
  } // do_ajax_seg_permisos_add_new_line

  function do_ajax_seg_permisos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_seg_permisos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_seg_permisos_backup_line(iNumLinha)
  {
    var var_idusuarios_grupos_ = scAjaxGetFieldText("idusuarios_grupos_" + iNumLinha);
    var var_idapp_ = scAjaxGetFieldText("idapp_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_permisos_backup_line(var_idusuarios_grupos_, var_idapp_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_seg_permisos_backup_line_cb);
  } // do_ajax_seg_permisos_backup_line

  function do_ajax_seg_permisos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_seg_permisos_backup_line_cb

  function do_ajax_seg_permisos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_seg_permisos_cancel_insert

  function do_ajax_seg_permisos_cancel_update(iSeqVert)
  {
    do_ajax_seg_permisos_backup_line(iSeqVert);
...
?>
  } // do_ajax_seg_permisos_cancel_update

  function do_ajax_seg_permisos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_seg_permisos_restore_buttons

  // ---------- table_refresh
  function do_ajax_seg_permisos_table_refresh()
  {
    var var_idusuarios_grupos_ = document.F2.idusuarios_grupos_.value;
    var var_idapp_ = document.F2.idapp_.value;
    ...
    scAjaxProcOn();
    x_ajax_seg_permisos_table_refresh(var_idusuarios_grupos_, var_idapp_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_seg_permisos_table_refresh_cb);
  } //  do_ajax_seg_permisos_table_refresh

  function do_ajax_seg_permisos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idusuarios_grupos_.value = scAjaxGetKeyValue("idusuarios_grupos_");
    document.F2.idapp_.value = scAjaxGetKeyValue("idapp_");
    ...
    scAjaxAlert(do_ajax_seg_permisos_table_refresh_cb_after_alert);
  } // do_ajax_seg_permisos_table_refresh_cb
  function do_ajax_seg_permisos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_seg_permisos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_seg_permisos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_seg_permisos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_description_ = scAjaxGetFieldHidden("description_" + iNumLinha);
...
?>
    x_ajax_seg_permisos_submit_form(var_description_, var_priv_access_, var_priv_insert_, var_priv_delete_, var_priv_update_, var_priv_export_, var_priv_print_, var_idusuarios_grupos_, var_idapp_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seg_permisos_submit_form_cb);
  } // do_ajax_seg_permisos_submit_form

  function do_ajax_seg_permisos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idusuarios_grupos_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idapp_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_seg_permisos_submit_form_cb_after_alert);
  } // do_ajax_seg_permisos_submit_form_cb
  function do_ajax_seg_permisos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_seg_permisos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_seg_permisos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_seg_permisos_navigate_form, function() {});
    } else {
      perform_ajax_seg_permisos_navigate_form();
    }
  }

  function perform_ajax_seg_permisos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idusuarios_grupos_" + iNavForm);
      scAjaxHideErrorDisplay("idapp_" + iNavForm);
    }
    var var_idusuarios_grupos_ = document.F2.idusuarios_grupos_.value;
    var var_idapp_ = document.F2.idapp_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_seg_permisos_navigate_form(var_idusuarios_grupos_, var_idapp_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_seg_permisos_navigate_form_cb);
  } // do_ajax_seg_permisos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['seg_permisos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_seg_permisos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idusuarios_grupos_.value = scAjaxGetKeyValue("idusuarios_grupos_" + var_last_index);
    document.F2.idapp_.value = scAjaxGetKeyValue("idapp_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_seg_permisos_navigate_form_cb_after_alert);
  } // do_ajax_seg_permisos_navigate_form_cb
  function do_ajax_seg_permisos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_seg_permisos_navigate_form_cb_after_alert
  function sc_hide_seg_permisos_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idusuarios_grupos_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idapp_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["description_" + iNumLinha] = {"label": "Descripción<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_access_" + iNumLinha] = {"label": "Acceso<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_insert_" + iNumLinha] = {"label": "Insertar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_delete_" + iNumLinha] = {"label": "Borrar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_update_" + iNumLinha] = {"label": "Actualizar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_export_" + iNumLinha] = {"label": "Exportar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["priv_print_" + iNumLinha] = {"label": "Imprimir<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idusuarios_grupos_" + iNumLinha] = {"label": "Idusuarios Grupos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idapp_" + iNumLinha] = {"label": "Idapp<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["idusuarios_grupos_"][iNumLinha] = "idusuarios_grupos_" + iNumLinha;
    ajax_field_mult["idapp_"][iNumLinha] = "idapp_" + iNumLinha;
    ...
    ajax_error_count["idusuarios_grupos_" + iNumLinha] = "off";
    ajax_error_count["idapp_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["idusuarios_grupos_" + iNumLinha] = "on";
    ajax_read_only["idapp_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idusuarios_grupos_" + iNumLinha] = null;
    ajax_error_list["idapp_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idusuarios_grupos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idusuarios_grupos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idusuarios_grupos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idusuarios_grupos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idusuarios_grupos_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idapp_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idapp_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idapp_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idapp_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idapp_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idusuarios_grupos_'])) ? $this->nmgp_cmp_readonly['idusuarios_grupos_'] : 'on';
?>
    scAjaxFieldRead("idusuarios_grupos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idapp_'])) ? $this->nmgp_cmp_readonly['idapp_'] : 'on';
?>
    scAjaxFieldRead("idapp_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("idusuarios_grupos_" + iSeq, "on");
    scAjaxFieldRead("idapp_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["description_" + iRow] || "on" == ajax_error_count["priv_access_" + iRow] || "on" == ajax_error_count["priv_insert_" + iRow] || "on" == ajax_error_count["priv_delete_" + iRow] || "on" == ajax_error_count["priv_update_" + iRow] || "on" == ajax_error_count["priv_export_" + iRow] || "on" == ajax_error_count["priv_print_" + iRow] || "on" == ajax_error_count["idusuarios_grupos_" + iRow] || "on" == ajax_error_count["idapp_" + iRow]))
    {
      ...
      $("#hidden_field_data_idusuarios_grupos_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idapp_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["description_" + iRow] && "off" == ajax_error_count["priv_access_" + iRow] && "off" == ajax_error_count["priv_insert_" + iRow] && "off" == ajax_error_count["priv_delete_" + iRow] && "off" == ajax_error_count["priv_update_" + iRow] && "off" == ajax_error_count["priv_export_" + iRow] && "off" == ajax_error_count["priv_print_" + iRow] && "off" == ajax_error_count["idusuarios_grupos_" + iRow] && "off" == ajax_error_count["idapp_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["idusuarios_grupos_" + iRow] = "off";
        ajax_error_count["idapp_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idusuarios_grupos_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idapp_" + iRow).removeClass("scFormErrorLine");
    }
  }
