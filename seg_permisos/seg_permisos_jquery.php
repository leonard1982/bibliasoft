...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["idusuarios_grupos_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
  scEventControl_data["idapp_" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
}
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["idusuarios_grupos_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idusuarios_grupos_" + iSeqRow]["change"]) {
    return true;
  }
  if (scEventControl_data["idapp_" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["idapp_" + iSeqRow]["change"]) {
    return true;
  }
  return false;
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idusuarios_grupos_' + iSeqRow).bind('blur', function() { sc_seg_permisos_idusuarios_grupos__onblur(this, iSeqRow) })
                                                .bind('change', function() { sc_seg_permisos_idusuarios_grupos__onchange(this, iSeqRow) })
                                                .bind('focus', function() { sc_seg_permisos_idusuarios_grupos__onfocus(this, iSeqRow) });
  $('#id_sc_field_idapp_' + iSeqRow).bind('blur', function() { sc_seg_permisos_idapp__onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_seg_permisos_idapp__onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_seg_permisos_idapp__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_access_' + iSeqRow).bind('blur', function() { sc_seg_permisos_priv_access__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_seg_permisos_priv_access__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_seg_permisos_priv_access__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_insert_' + iSeqRow).bind('blur', function() { sc_seg_permisos_priv_insert__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_seg_permisos_priv_insert__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_seg_permisos_priv_insert__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_delete_' + iSeqRow).bind('blur', function() { sc_seg_permisos_priv_delete__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_seg_permisos_priv_delete__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_seg_permisos_priv_delete__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_update_' + iSeqRow).bind('blur', function() { sc_seg_permisos_priv_update__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_seg_permisos_priv_update__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_seg_permisos_priv_update__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_export_' + iSeqRow).bind('blur', function() { sc_seg_permisos_priv_export__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_seg_permisos_priv_export__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_seg_permisos_priv_export__onfocus(this, iSeqRow) });
  $('#id_sc_field_priv_print_' + iSeqRow).bind('blur', function() { sc_seg_permisos_priv_print__onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_seg_permisos_priv_print__onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_seg_permisos_priv_print__onfocus(this, iSeqRow) });
  $('#id_sc_field_description_' + iSeqRow).bind('blur', function() { sc_seg_permisos_description__onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_seg_permisos_description__onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_seg_permisos_description__onfocus(this, iSeqRow) });
  $('#id_sc_field_parentorder_' + iSeqRow).bind('change', function() { sc_seg_permisos_parentorder__onchange(this, iSeqRow) });
  $('#id_sc_field_parentid_' + iSeqRow).bind('change', function() { sc_seg_permisos_parentid__onchange(this, iSeqRow) });
  $('#id_sc_field_strdescripcion_' + iSeqRow).bind('change', function() { sc_seg_permisos_strdescripcion__onchange(this, iSeqRow) });
...
function sc_seg_permisos_idusuarios_grupos__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_idusuarios_grupos_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_idusuarios_grupos__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_idusuarios_grupos__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_idapp__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_idapp_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_idapp__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_idapp__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_priv_access__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_priv_access_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_priv_access__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_priv_access__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_priv_insert__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_priv_insert_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_priv_insert__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_priv_insert__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_priv_delete__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_priv_delete_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_priv_delete__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_priv_delete__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_priv_update__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_priv_update_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_priv_update__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_priv_update__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_priv_export__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_priv_export_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_priv_export__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_priv_export__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_priv_print__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_priv_print_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_priv_print__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_priv_print__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_description__onblur(oThis, iSeqRow) {
  do_ajax_seg_permisos_validate_description_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_seg_permisos_description__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  nm_check_insert(iSeqRow);
}

function sc_seg_permisos_description__onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis, iSeqRow);
}

function sc_seg_permisos_parentorder__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_seg_permisos_parentid__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_seg_permisos_strdescripcion__onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("idusuarios_grupos_", "", status);
	displayChange_field("idapp_", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_idusuarios_grupos_(row, status);
	displayChange_field_idapp_(row, status);
}
...
function displayChange_field_idusuarios_grupos_(row, status) {
}

function displayChange_field_idapp_(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_seg_permisos_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'seg_permisos')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
