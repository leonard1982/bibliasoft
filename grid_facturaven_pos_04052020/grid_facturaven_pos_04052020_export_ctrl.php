<?php
@session_start() ;
$_SESSION['scriptcase']['grid_facturaven_pos_04052020']['sc_process_barr'] = true;
require_once('../grid_facturaven_pos_04052020/index.php');
unset($_SESSION['scriptcase']['grid_facturaven_pos_04052020']['sc_process_barr']);
$ExportCtrl = new grid_facturaven_pos_04052020_export_control;
$ExportCtrl->Export_barr();

class grid_facturaven_pos_04052020_export_control
{
