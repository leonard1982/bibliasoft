...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "F.Pago";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_04052020']['contr_label_graf']['credito']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_04052020']['contr_label_graf']['credito']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_04052020']['contr_label_graf']['credito'];
      }
   }
