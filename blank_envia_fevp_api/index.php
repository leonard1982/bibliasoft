<?php
   include_once('blank_envia_fevp_api_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_envia_fevp_api_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_envia_fevp_api"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
      ...
      $this->nm_dt_criacao   = "20190620"; 
      $this->nm_hr_criacao   = "085048"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_envia_fevp_api']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_envia_fevp_api']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_envia_fevp_api']['save_session']['data'] = '';
      } 
      $this->str_schema_all    = (isset($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['str_schema_all']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['str_schema_all'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['str_schema_all'] : "lemon_lfpd/lemon_lfpd";
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_envia_fevp_api';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_envia_fevp_api']['actual_lang']) || $_SESSION['scriptcase']['blank_envia_fevp_api']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_envia_fevp_api']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_envia_fevp_api_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_envia_fevp_api"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_envia_fevp_api"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['sc_outra_jan'])) 
          { 
...
<?php
      ...
      if (!isset($_SESSION['scriptcase'][$script_case_init]['blank_envia_fevp_api']['nm_contr_attrs']))
      {
          $_SESSION['scriptcase'][$script_case_init]['blank_envia_fevp_api']['nm_contr_attrs'] = "ok";
          $_SESSION['blank_envia_fevp_api']['documento'] = ""; 
          $_SESSION['blank_envia_fevp_api']['beneficiario'] = ""; 
          $_SESSION['blank_envia_fevp_api']['items'] = ""; 
          $_SESSION['blank_envia_fevp_api']['numbering'] = ""; 
          $_SESSION['blank_envia_fevp_api']['retentions'] = ""; 
          $_SESSION['blank_envia_fevp_api']['reportar_rete'] = ""; 
          $_SESSION['blank_envia_fevp_api']['mail_envio'] = ""; 
          $_SESSION['blank_envia_fevp_api']['totales'] = ""; 
          $_SESSION['blank_envia_fevp_api']['impuestos_totales'] = ""; 
      }
// 
      include_once($this->path_aplicacao . "blank_envia_fevp_api_erro.class.php"); 
      $this->Erro = new blank_envia_fevp_api_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_envia_fevp_api'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['embutida_init']) 
      {
          if (!isset($_SESSION['origen_llamado'])) 
          {
              $this->nm_falta_var .= "origen_llamado; ";
          }
          if (!isset($_SESSION['id_transacion_factura'])) 
          {
              $this->nm_falta_var .= "id_transacion_factura; ";
          }
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEB_FE_73', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_envia_fevp_api']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blank_envia_fevp_api_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_envia_fevp_api_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_envia_fevp_api']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_envia_fevp_api']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_envia_fevp_api']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_envia_fevp_api'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_envia_fevp_api']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_envia_fevp_api']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_envia_fevp_api') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_envia_fevp_api']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_envia_fevp_api']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_envia_fevp_api']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_envia_fevp_api']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_envia_fevp_api_erro.class.php"); 
      $this->Erro      = new blank_envia_fevp_api_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
if (!isset($_SESSION['id_transacion_factura'])) {$_SESSION['id_transacion_factura'] = "";}
if (!isset($this->sc_temp_id_transacion_factura)) {$this->sc_temp_id_transacion_factura = (isset($_SESSION['id_transacion_factura'])) ? $_SESSION['id_transacion_factura'] : "";}
  $documento = array();
$beneficiario = array();
$items = array();
$items3 = array();
...
$_SESSION['blank_envia_fevp_api']['beneficiario'] = $beneficiario;
$_SESSION['blank_envia_fevp_api']['items'] = $items;
$descuentos  = $descuentos;

$_SESSION['blank_envia_fevp_api']['totales'] =$totales;
$_SESSION['blank_envia_fevp_api']['numbering'] = $numbering;
$_SESSION['blank_envia_fevp_api']['retentions']=$retentions;
$_SESSION['blank_envia_fevp_api']['impuestos_totales'] = $detalles_impuestos;


$id_transacion_factura = $this->sc_temp_id_transacion_factura;

$this->datos_beneficiario($_SESSION['blank_envia_fevp_api']['beneficiario'], $id_transacion_factura); 
$this->detalles_facturados($_SESSION['blank_envia_fevp_api']['items'], $id_transacion_factura);
$this->impuestos_generales($_SESSION['blank_envia_fevp_api']['retentions'], $id_transacion_factura);
$this->impuestos_detallados($_SESSION['blank_envia_fevp_api']['impuestos_totales'], $id_transacion_factura);



$beneficiario = $_SESSION['blank_envia_fevp_api']['beneficiario'];


$busqueda = "SELECT txt_url_api, api_auth_token, int_api_tipo_operacion, txt_set_pruebas  FROM fe_datosgenerales where id_registro = '1'" ;
...
if ($this->rs  !== false)
{
	while (!$this->rs->EOF)
	{
		$txt_url_dataico = $this->rs->fields[0];
		$dataico_auth = $this->rs->fields[1];
		$dataico_modo = $this->rs->fields[2];  
		$set_pruebas = $this->rs->fields[3];
		$this->rs->MoveNext();
	}
	$this->rs->Close();
}
...
if($dataico_modo == 1)
{	
	$txt_url_dataico = $txt_url_dataico . "/" . $set_pruebas ;
}
...
$busqueda = "SELECT txt_prefijo, idFactura, fechaFactura, Id_resolucion, obsFactura, fechavencimiento, fechahora, subtotal  FROM facturacion where id_transacion_factura = " . $id_transacion_factura ;
...
if ($this->rs  !== false)
{
	while (!$this->rs->EOF)
	{
		$txt_prefijo = $this->rs->fields[0];
		$idFactura = $this->rs->fields[1];
		$fechaFactura = $this->rs->fields[2];  
		$Id_resolucion = $this->rs->fields[3];  
		$obsFactura = $this->rs->fields[4];
		$obsFactura = utf8_encode($obsFactura);  
		$fechavence = $this->rs->fields[5];
		$horafecha = $this->rs->fields[6]; 
		$subtotal_fact = $this->rs->fields[7];   

		$horafecha = substr($horafecha,11,8) ;  

		$newDate = date("Y-m-d", strtotime($fechaFactura));  
		$newDate2 = date("Y-m-d", strtotime($fechavence));  	   




		$documento['number'] = $idFactura ;  
		$documento['type_document_id'] = 1 ; 
		$documento['date'] = $newDate ; 
		$documento['time'] = $horafecha ;  
		if($obsFactura <> '')
		{	
			$documento['notes'] = $obsFactura ;	
		}  
		$documento = $this->datos_resolucion($documento, $id_transacion_factura);
...
$documento['customer'] = $_SESSION['blank_envia_fevp_api']['beneficiario'] ;




$busqueda = "select max(valor), codFormaPago,fecha_hora from pagos_facturas where codfactura = " . $id_transacion_factura ;
...
if ($this->rs  !== false)
{
	while (!$this->rs->EOF)
	{
		$forma_pago = $this->rs->fields[1];
		$fecha_pago = $this->rs->fields[2];   
		$this->rs->MoveNext();
	}
	$this->rs->Close();
}
...
$busqueda = "select api_id  from  forma_de_pago F where F.idTipoPago = " . $forma_pago ;
...
if ($this->rs  !== false)
{
	while (!$this->rs->EOF)
	{
		$forma_pago_txt = $this->rs->fields[0];
		$this->rs->MoveNext();
	}
	$this->rs->Close();
}
...
if($forma_pago == 0)
{
	$documento['payment_form']['payment_form_id'] = 2 ; 
}	
else
{
	$documento['payment_form']['payment_form_id'] =  1; 
}	
$documento['payment_form']['payment_method_id'] = $forma_pago_txt ; 
$documento['payment_form']['payment_due_date'] = $newDate ; 
$documento['payment_form']['duration_measure'] = 0 ; 





$subtotal_fact = number_format($subtotal_fact, 2, '.', '');  
$descuentos = array( 
	"discount_id" =>  '1',
	"charge_indicator" =>  false,
	"allowance_charge_reason" =>  "DESCUENTO GENERAL", 
	"amount" =>  "0.00", 
	"base_amount" =>  $subtotal_fact, 
);
$descuentos2  = array();
$descuentos2[0] = $descuentos;
$documento['allowance_charges'] =  $descuentos2 ;  


$documento['invoice_lines'] = $_SESSION['blank_envia_fevp_api']['items'] ; 
$documento['with_holding_tax_total'] = $_SESSION['blank_envia_fevp_api']['retentions'] ; 
$documento['legal_monetary_totals'] = $_SESSION['blank_envia_fevp_api']['totales'] ;  
$documento['tax_totals'] = $_SESSION['blank_envia_fevp_api']['impuestos_totales'] ;
...
$response = sc_webservice("curl", $txt_url_dataico , 80, "POST", $documento, array(CURLOPT_RETURNTRANSFER => true, CURLOPT_SSL_VERIFYPEER=>false, CURLOPT_HTTPHEADER => array(
	'Content-Type: application/json', 'Accept: application/json', 'Authorization: Bearer ' . $dataico_auth  ),), 30);
...
$this->evalua_json($response);
if (isset($this->sc_temp_id_transacion_factura)) {$_SESSION['id_transacion_factura'] = $this->sc_temp_id_transacion_factura;}
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
function datos_beneficiario($documento, $id_transacion_factura)
{
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
if (!isset($_SESSION['mail_envio'])) {$_SESSION['mail_envio'] = "";}
if (!isset($this->sc_temp_mail_envio)) {$this->sc_temp_mail_envio = (isset($_SESSION['mail_envio'])) ? $_SESSION['mail_envio'] : "";}
...
$busqueda = "SELECT idcliente, idempresa  FROM facturacion where id_transacion_factura = " . $id_transacion_factura ;
...
if ($rs  !== false)
{
	while (!$rs->EOF)
	{
		$idcliente = $rs->fields[0];
		$idempresa = $rs->fields[1];
		$rs->MoveNext();
	}
	$rs->Close();
...
$busqueda = "SELECT nomEmpresa, pais_r, cod_ciudad_r, dirEmpresa,  emailEmpresa , nitEmpresa, tipocontribuye, tipodocumento , telEmpresa, cod_r_actividad_economica, cod_r_oblicaciones_tributarias, cod_regimen_tributario, txt_zona_postal, txt_nombre_comercial,  cod_departamento, dv, tipo_juridica , txt_primer_nombre ,txt_otros_nombres ,  txt_primer_apellido , txt_otros_apellidos FROM empresa where idEmpresa = " . $idempresa ;
...
if ($rs  !== false)
{
	while (!$rs->EOF)
	{
		$documento['identification_number'] = $rs->fields[5] ;
		$documento['dv'] = $rs->fields[15] ;


		if($rs->fields[16] == 1)
		{ 
			$documento['type_organization_id'] = 1 ; 
			$txt1 = $rs->fields[0] ;
			$txt1 = utf8_encode($txt1);
			$documento['name'] = $txt1;

		}
		else
		{
			$documento['type_organization_id'] = 2 ;
			$documento['name'] = $rs->fields[17] . ' ' . $rs->fields[18]  . ' ' . $rs->fields[19] . ' ' . $rs->fields[20]  ;

		}
		$documento['phone'] = $rs->fields[8] ;	 	   
		$txt = $rs->fields[3] ;
		$txt = utf8_encode($txt);
		$documento['address'] = $txt ;  
		$documento['email'] = $rs->fields[4]; 
		$this->sc_temp_mail_envio = $rs->fields[4]; 
		$documento['merchant_registration'] = "0000000-00" ;  



		$documento['type_document_identification_id'] = $rs->fields[7] ; 


		$documento['type_regime_id'] = $rs->fields[11] ; 


		$departamento = (string)($rs->fields[14]) ;    
		$ciudad = $rs->fields[2] ;  
...
$busqueda = "SELECT D.cod_api FROM tipo_documento T where  T.codTipoDoc = '" . $documento['type_document_identification_id'] . "'" ;
...
if ($rs  !== false)
{
	while (!$rs->EOF)
	{
		$documento['type_document_identification_id'] = $rs->fields[0];
		$rs->MoveNext();
	}
	$rs->Close();
}
...
{
	$documento['type_document_identification_id'] = "6";  
}	

$_SESSION['blank_envia_fevp_api']['beneficiario'] = $documento;



$busqueda = "SELECT cod_api FROM fe_table_tipo_regimen where cod_dian = '" . $documento['type_regime_id'] . "'" ;
...
if ($rs  !== false)
{
	while (!$rs->EOF)
	{
		...
		$documento['type_regime_id'] = $rs->fields[0];
...
$busqueda = "SELECT id FROM api_municipalities  where code = '" . $ciudad . "'" ;
...
if ($rs  !== false)
{
	while (!$rs->EOF)
	{
		...
		$txt = $rs->fields[0] ;
		$txt = utf8_encode($txt); 
		$documento['municipality_id'] = (string)$txt;
		$rs->MoveNext();
	}
	$rs->Close();
}
...
$_SESSION['blank_envia_fevp_api']['beneficiario'] = $documento;
if (isset($this->sc_temp_mail_envio)) {$_SESSION['mail_envio'] = $this->sc_temp_mail_envio;}
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'off';
}
function datos_resolucion($documento, $id_transacion_factura)
{
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
  
$busqueda = "SELECT Id_resolucion  FROM facturacion where id_transacion_factura = " . $id_transacion_factura ;
...
if ($resolucion <> '0')
  {
    $busqueda = "SELECT numero_resolucion, Prefijo   FROM resoluciones_facturacion where id_resolucion = " . $resolucion ;
       ...
       while (!$rs->EOF)
         {
		     ...
		     $documento['resolution_number'] = $rs->fields[0];  
		     $documento['prefix'] = $rs->fields[1] ;		 
		     $documento['sendmail'] = True ;
...
function detalles_facturados($items, $id_transacion_factura)
{
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
if (!isset($_SESSION['origen_llamado'])) {$_SESSION['origen_llamado'] = "";}
if (!isset($this->sc_temp_origen_llamado)) {$this->sc_temp_origen_llamado = (isset($_SESSION['origen_llamado'])) ? $_SESSION['origen_llamado'] : "";}
  
$item2  = array();
$llamado_rutina = $this->sc_temp_origen_llamado;




$busqueda = "select cantidad, codservicio, Servicio, total, subTotal , valor_unitario, codunidad , porcentajeIva, totalIva, porcentajeipo, totalipo    from detallesfact where id_transacion_factura = " . $id_transacion_factura ;
...
if ($rs  !== false)
{
	while (!$rs->EOF)
	{
		...
		$codservicio = $rs->fields[1];
		$Servicio = $rs->fields[2];


		$total = $rs->fields[3];
		$subTotal = $rs->fields[4];

		$codunidad = $rs->fields[6];
		$porcentajeIva   = $rs->fields[7];
		$totalIva  = $rs->fields[8];  
		$porcentajeipo  = $rs->fields[9];
		$totalipo  = $rs->fields[10];
		$valor_unitario = $subTotal/$cantidad;

		$subTotal = number_format($subTotal, 2, '.', '');  
		$total = number_format($total, 2, '.', '');  
		$totalIva = number_format($totalIva, 2, '.', '');  
		$totalipo = number_format($totalipo, 2, '.', '');    
		$valor_unitario = number_format($valor_unitario, 2, '.', '');  


		if ($porcentajeIva <> '0' or  $porcentajeipo <> '0')   
		{
			if ($porcentajeIva <> '0' )
			{	  
				$impuestos = array( 
		...
		$allowance_charge[0] = $allowance_charges;


		$precioft = number_format($valor_unitario,2,'.','') ;
		...
		{ 
			$params = array(
				'unit_measure_id'=> 70,
				'invoiced_quantity' => (double)$cantidad,
				'line_extension_amount' =>  $subTotal, 
				'free_of_charge_indicator' =>  false,   



				'tax_totals' => $impuestos2,
				'description' => $Servicio ,
				'code' =>  "SKU-".$codservicio,  
				'type_item_identification_id' =>  4,   
				'price_amount' => (double)$precioft,
				'base_quantity' => 1  
...
$_SESSION['blank_envia_fevp_api']['items'] = $items2 ;
if (isset($this->sc_temp_origen_llamado)) {$_SESSION['origen_llamado'] = $this->sc_temp_origen_llamado;}
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'off';
}
function evalua_json($json_var)
{
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
...
$jsonIterator = new RecursiveIteratorIterator(
	new RecursiveArrayIterator(json_decode($json_var, TRUE)),
...
$llamado_rutina = $this->sc_temp_origen_llamado;
$ip_maquina =  $this->sc_temp_usr_email;
...
{ 
     ...
     $nm_select = "update facturacion  set cod_cufe = '" . $cufe . "', envia_fe = '0', txt_tipo_cufe = '', txt_consecutivo_reportado = '' where id_transacion_factura  = " . $id_transacion_factura; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     ...
     $nm_select = "delete from mensajeria where ip_maquina  = '" . $ip_maquina . "'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
         ...
         $rf->Close();
      ;
	$mensaje = "La factura electronica ha sido generada satisfactoriamente!!!  En breves momentos consulte el  correo  suministrado "  ;
	
     $nm_select = "insert into mensajeria (txt_mensaje, ip_maquina) values ('" . $mensaje  . "','" . $ip_maquina . "')"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('rep_facturacion_elect') . "/", $this->nm_location, "","_parent", 440, 630);
 };  
	}  
	if($llamado_rutina === '2')
	{
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('form_temporal_factura') . "/", $this->nm_location, "","_parent", 440, 630);
 }; 
	}	
	if($llamado_rutina === '3')
	{
 ...
 if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('form_rep_datos_check_out') . "/", $this->nm_location, "","_parent", 440, 630);
 };  
	}	
...
else
{
	echo "$IsValid" .  " <br />" ;
	echo "$string" .  " <br />" ;
	echo "$urlinvoicexml" .  " <br />" ;
	echo "$urlinvoicepdf" .  " <br />" ;
	echo "$cufe" .  " <br />" ;
...
function impuestos_detallados($factura, $id_transacion_factura)
{
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
...
$busqueda = "SELECT sum(totalIva), sum(subTotal), porcentajeIva FROM detallesfact where id_transacion_factura = " . $id_transacion_factura . " group by porcentajeIva Desc " ;
...
if ($rs  !== false)
{
	while (!$rs->EOF)
	{
		$totaliva = $rs->fields[0];
		$subtotal_iva = $rs->fields[1];
		$porcentaje = $rs->fields[2];

		$totaliva = number_format($totaliva, 2, '.', ''); 
		$subtotal_iva = number_format($subtotal_iva, 2, '.', ''); 
		if ( ($contador_impuestos == 0 and $porcentaje ==  0) or ($porcentaje <> 0) )
		{
			$params = array(
				'tax_id'=> 1,
				'tax_amount' => $totaliva,
				'percent' =>  $porcentaje, 
				'taxable_amount' =>  $subtotal_iva,   
			);



			$impuestos_totales[] = $params;
...
$busqueda = "SELECT sum(totalipo), sum(subTotal), porcentajeipo FROM detallesfact where id_transacion_factura = " . $id_transacion_factura . " and porcentajeipo <> 0 group by porcentajeipo Desc " ;
...
if ($rs  !== false)
{
	while (!$rs->EOF)
	{
		$totalipo = $rs->fields[0];
		$subtotal_ipo = $rs->fields[1];
		$porcentaje = $rs->fields[2];

        $totalipo = number_format($totalipo, 2, '.', ''); 
		$subtotal_ipo = number_format($subtotal_ipo, 2, '.', ''); 
...
$_SESSION['blank_envia_fevp_api']['impuestos_totales'] = $impuestos_totales ;
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'off';
}
function impuestos_generales($factura, $id_transacion_factura)
{
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
...
$busqueda = "SELECT iva, ipo,retefuente, reteiva , reteica, subtotal, total, base_retefuente, porcentaje_retefuente, porcentaje_reteica, porcentaje_reteiva, Id_resolucion, idFactura, fechaFactura FROM facturacion where id_transacion_factura = " . $id_transacion_factura ;
...
if ($rs  !== false)
{
   while (!$rs->EOF)
   {
     $iva = $rs->fields[0];
     $ipo = $rs->fields[1];
	 $retefuente = $rs->fields[2];
	 $reteiva = $rs->fields[3];
	 $reteica = $rs->fields[4];
	 $subtotal = $rs->fields[5];
	 $total = $rs->fields[6];
	 $base_retefuente   = $rs->fields[7];
	 $porcentaje_retefuente  = $rs->fields[8];
	 $porcentaje_reteica  = $rs->fields[9];
	 $porcentaje_reteiva = $rs->fields[10];
	 $Id_resolucion = $rs->fields[11];
     $idFactura = $rs->fields[12]; 
	 $fechaFactura = $rs->fields[13];
     ...
     $ipo = number_format($ipo, 2, '.', ''); 
	 $retefuente = number_format($retefuente, 2, '.', ''); 
	 $reteiva = number_format($reteiva, 2, '.', ''); 
	 $reteica = number_format($reteica, 2, '.', ''); 
	 $subtotal = number_format($subtotal, 2, '.', ''); 
	 $total = number_format($total, 2, '.', ''); 
	 $base_retefuente   = number_format($base_retefuente, 2, '.', ''); 
	 $porcentaje_retefuente  = number_format($porcentaje_retefuente, 2, '.', ''); 
	 $porcentaje_reteica  = number_format($porcentaje_reteica, 3, '.', ''); 
	 $porcentaje_reteiva = number_format($porcentaje_reteiva, 2, '.', ''); 
...
$_SESSION['blank_envia_fevp_api']['reportar_rete'] = 0;
	 
if ($retefuente <> '0')
   {	
    $tipo_impuesto = "6";
   	$porcentajeTOTALImp = number_format($porcentaje_retefuente, 2, '.', '');   
	$_SESSION['blank_envia_fevp_api']['reportar_rete'] = 1;	
	
	 $params = array(
          'tax_id' =>  $tipo_impuesto,
          'tax_amount' =>(double)$retefuente,
		  'percent' =>(double)$porcentajeTOTALImp,
		  'taxable_amount' =>(double)$base_retefuente
           );
...
if ($reteiva <> '0')
   {	
	...
	$tipo_impuesto = "5";
  	$porcentajeTOTALImp = number_format($porcentaje_reteiva, 2, '.', '');   
	
	$_SESSION['blank_envia_fevp_api']['reportar_rete'] = 1;	
	
	 $params = array(
          'tax_id' =>  $tipo_impuesto,
          'tax_amount' =>(double)$reteiva,
		  'percent' =>(double)$porcentajeTOTALImp,
		  'taxable_amount' =>(double)$base_retefuente
...
if ($reteica <> '0')
   {	
	...
	$tipo_impuesto = "7";
   	$porcentajeTOTALImp = number_format($porcentaje_reteica, 2, '.', '');   
	
	$_SESSION['blank_envia_fevp_api']['reportar_rete'] = 1;	
	
	 $params = array(
          'tax_category' =>  $tipo_impuesto,
          'tax_amount' =>(double)$reteica,
		  'tax_rate' => (double)$porcentajeTOTALImp,
		  'taxable_amount' =>(double)$base_retefuente
           );
...
$total_factura_con_impuestos = $subtotal + $iva + $ipo;

$total_factura_con_impuestos = number_format($total_factura_con_impuestos, 2, '.', '');  

   $params = array(
          'line_extension_amount' =>  $subtotal,
          'tax_exclusive_amount' => $subtotal,
		  'tax_inclusive_amount' => $total_factura_con_impuestos,
		  'allowance_total_amount' =>"0.00",
	      'charge_total_amount' =>"0.00",
	      'payable_amount' =>$total_factura_con_impuestos
           );
	   



$_SESSION['blank_envia_fevp_api']['totales'] = $params ;
$_SESSION['blank_envia_fevp_api']['retentions'] = $items2 ;
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'off';
}
function msgbox($titulo , $mensaje , $opcion){
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
  	
$javascript_title   = $titulo;       
$javascript_message = $mensaje;  
...
function meter_msgbox_planing($titulo , $mensaje , $ip_maquina){
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
  	

 
     $nm_select = "delete from  mensajes_planing where ip_maquina ='" . $ip_maquina . "'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "insert into mensajes_planing(ip_maquina,mensaje_mostrar,aplicacion) values ('" . $ip_maquina  .  "','" . $mensaje . "','" . $titulo . "')"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
function guardar_llamada_registro($ip_maquina,$tipo_llamada )
{
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
  
 
	
     $nm_select = "delete from  aux_llamada_registro where ip_maquina ='" . $ip_maquina . "'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	$insert_table  = 'aux_llamada_registro';     
    $insert_fields = array(   
...
function guardar_llamada_reserva($ip_maquina,$tipo_llamada )
{
$_SESSION['scriptcase']['blank_envia_fevp_api']['contr_erro'] = 'on';
  
 
	
     $nm_select = "delete from  aux_llamada_reserva where ip_maquina ='" . $ip_maquina . "'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
         ...
         $rf->Close();
      ;
	$insert_table  = 'aux_llamada_reserva';     
    $insert_fields = array(   
        'ip_maquina' => "'$ip_maquina'", 
	    'tipo_llamada' => "'$tipo_llamada'"
	                      );
   ...
   function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $alt_modal=0, $larg_modal=0, $opc="")
   {
      if (is_array($nm_apl_parms))
      {
          ...
          foreach ($nm_apl_parms as $par => $val)
          {
              ...
              elseif (substr($val, 0, 1) == "[")
              {
                  $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['blank_envia_fevp_api'][substr($val, 1, -1)];
              }
              else
              {
                  $tmp_parms .= $val;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_envia_fevp_api']['iframe_print']) && $_SESSION['sc_session'][$this->Ini->sc_page]['blank_envia_fevp_api']['iframe_print'] )
      {
          $target = "_parent";
      }
   ?>
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_envia_fevp_api($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_envia_fevp_api']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_envia_fevp_api") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEB_FE_73'])) {
               $_SESSION['scriptcase']['blank_envia_fevp_api']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEB_FE_73'];
           }
       }
   }
   ...
   {
       $_SESSION["mail_envio"] = $_POST["mail_envio"];
       nm_limpa_str_blank_envia_fevp_api($_SESSION["mail_envio"]);
   }
   if (isset($_GET["mail_envio"])) 
   {
       $_SESSION["mail_envio"] = $_GET["mail_envio"];
       nm_limpa_str_blank_envia_fevp_api($_SESSION["mail_envio"]);
   }
   if (!isset($_SESSION["mail_envio"])) 
   {
       $_SESSION["mail_envio"] = "";
   }
   if (isset($_POST["origen_llamado"])) 
   {
       $_SESSION["origen_llamado"] = $_POST["origen_llamado"];
       nm_limpa_str_blank_envia_fevp_api($_SESSION["origen_llamado"]);
   }
   if (isset($_GET["origen_llamado"])) 
   {
       $_SESSION["origen_llamado"] = $_GET["origen_llamado"];
       nm_limpa_str_blank_envia_fevp_api($_SESSION["origen_llamado"]);
   }
   if (!isset($_SESSION["origen_llamado"])) 
   {
       $_SESSION["origen_llamado"] = "";
   }
   if (isset($_POST["usr_email"])) 
   {
       $_SESSION["usr_email"] = $_POST["usr_email"];
       nm_limpa_str_blank_envia_fevp_api($_SESSION["usr_email"]);
   }
   ...
   if (isset($_POST["id_transacion_factura"])) 
   {
       $_SESSION["id_transacion_factura"] = $_POST["id_transacion_factura"];
       nm_limpa_str_blank_envia_fevp_api($_SESSION["id_transacion_factura"]);
   }
   if (isset($_GET["id_transacion_factura"])) 
   {
       $_SESSION["id_transacion_factura"] = $_GET["id_transacion_factura"];
       nm_limpa_str_blank_envia_fevp_api($_SESSION["id_transacion_factura"]);
   }
   if (!isset($_SESSION["id_transacion_factura"])) 
   {
       $_SESSION["id_transacion_factura"] = "";
   }
   if (!empty($glo_perfil))  
   { 
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_envia_fevp_api";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_envia_fevp_api' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_envia_fevp_api' == $sReferer || 'blank_envia_fevp_api_' == substr($sReferer, 0, 21))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_envia_fevp_api')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_envia_fevp_api']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_envia_fevp_api_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_envia_fevp_api($cadapar[1]);
       ...
       if (isset($mail_envio)) 
       {
           $_SESSION['mail_envio'] = $mail_envio;
           nm_limpa_str_blank_envia_fevp_api($_SESSION["mail_envio"]);
       }
       if (isset($origen_llamado)) 
       {
           $_SESSION['origen_llamado'] = $origen_llamado;
           nm_limpa_str_blank_envia_fevp_api($_SESSION["origen_llamado"]);
       }
       if (isset($usr_email)) 
       {
       ...
       if (isset($id_transacion_factura)) 
       {
           $_SESSION['id_transacion_factura'] = $id_transacion_factura;
           nm_limpa_str_blank_envia_fevp_api($_SESSION["id_transacion_factura"]);
       }
   } 
   $GLOBALS["NM_ERRO_IBASE"] = 0;  
   $contr_blank_envia_fevp_api = new blank_envia_fevp_api_apl();
   $contr_blank_envia_fevp_api->controle();
//
   function nm_limpa_str_blank_envia_fevp_api(&$str)
   {
