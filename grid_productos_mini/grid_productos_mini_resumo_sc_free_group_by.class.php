...
class grid_productos_mini_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_codigobar;
   var $array_total_nompro;
   var $array_total_unimay;
   var $array_total_unimen;
   var $array_total_idgrup;
   var $array_total_idpro1;
   var $array_total_idiva;
   var $array_total_escombo;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_codigobar = array();
      $this->array_total_nompro    = array();
      $this->array_total_unimay    = array();
      $this->array_total_unimen    = array();
      $this->array_total_idgrup    = array();
      $this->array_total_idpro1    = array();
      $this->array_total_idiva     = array();
      $this->array_total_escombo   = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_productos_mini'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_productos_mini'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_productos_mini']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_productos_mini']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_productos_mini']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$this->Graf         = new grid_productos_mini_grafico();
		$this->Graf->Db     = $this->Db;
		$this->Graf->Erro   = $this->Erro;
		$this->Graf->Ini    = $this->Ini;
		$this->Graf->Lookup = $this->Lookup;

		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_productos_mini']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_productos_mini']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['campos_busca'];
      ...
      $this->nm_where_dinamico = "";
       ob_start(); 
      $_SESSION['scriptcase']['grid_productos_mini']['contr_erro'] = 'on';
...
if (!isset($this->sc_temp_gusuario_logueo)) {$this->sc_temp_gusuario_logueo = (isset($_SESSION['gusuario_logueo'])) ? $_SESSION['gusuario_logueo'] : "";}
 $this->NM_cmp_hidden["agregarnotainv"] = "off";if (!isset($this->NM_ajax_event) || !$this->NM_ajax_event) {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['php_cmp_sel']["agregarnotainv"] = "off"; }
...
if(isset($this->vsiexiste[0][0]))
{
	...
	{
		$this->NM_cmp_hidden["agregarnotainv"] = "on";if (!isset($this->NM_ajax_event) || !$this->NM_ajax_event) {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['php_cmp_sel']["agregarnotainv"] = "on"; }
	}
}
...
$_SESSION['scriptcase']['grid_productos_mini']['contr_erro'] = 'off'; 
       $this->SC_Buf_onInit = ob_get_clean();; 
         if  (!empty($this->nm_where_dinamico)) 
         {   
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['where_pesq'] .= $this->nm_where_dinamico;
         }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_productos_mini", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total']['codigobar'] = $this->array_total_codigobar;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total']['nompro'] = $this->array_total_nompro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total']['unimay'] = $this->array_total_unimay;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total']['unimen'] = $this->array_total_unimen;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total']['idgrup'] = $this->array_total_idgrup;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total']['idpro1'] = $this->array_total_idpro1;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total']['idiva'] = $this->array_total_idiva;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total']['escombo'] = $this->array_total_escombo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['json_use_label'])
       {
          $Lab_codigobar = "codigobar";
          $Lab_nompro = "nompro";
          $Lab_unimay = "unimay";
          $Lab_unimen = "unimen";
          $Lab_idgrup = "idgrup";
       ...
       {
       $Lab_codigobar = "Código";
       $Lab_nompro = "Descripción";
       $Lab_unimay = "Und Mayor";
       $Lab_unimen = "Unidad";
       $Lab_idgrup = "Grupo o Familia";
       $Lab_idpro1 = "Proveedor";
       $Lab_idiva = "%IVA";
       $Lab_escombo = "Combo";
       }
       $prep_field = array();
       $prep_field['codigobar'] = $Lab_codigobar;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['codigobar'] = $Lab_codigobar; 
       $prep_field['nompro'] = $Lab_nompro;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['nompro'] = $Lab_nompro; 
       $prep_field['unimay'] = $Lab_unimay;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['unimay'] = $Lab_unimay; 
       $prep_field['unimen'] = $Lab_unimen;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['unimen'] = $Lab_unimen; 
       $prep_field['idgrup'] = $Lab_idgrup;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idgrup'] = $Lab_idgrup; 
       $prep_field['idpro1'] = $Lab_idpro1;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idpro1'] = $Lab_idpro1; 
       $prep_field['idiva'] = $Lab_idiva;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idiva'] = $Lab_idiva; 
       $prep_field['escombo'] = $Lab_escombo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['escombo'] = $Lab_escombo; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['imagen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['imagen'] = "Imagen"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['codigobar']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['codigobar'] = "Código"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['nompro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['nompro'] = "Descripción"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['existencia_menor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['existencia_menor'] = "Existencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['unimen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['unimen'] = "Unidad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciomen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciomen'] = "Precio Menudeo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idiva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idiva'] = "%IVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['btn_stock']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['btn_stock'] = "Stock"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idprod']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idprod'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['unimay']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['unimay'] = "Und Mayor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['costomen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['costomen'] = "Costo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['recmayamen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['recmayamen'] = "Factor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciofull']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciofull'] = "Precio Mayor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['stockmay']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['stockmay'] = "Stock Mayor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['stockmen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['stockmen'] = "Existencia Mayor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idgrup']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idgrup'] = "Grupo o Familia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idpro1']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idpro1'] = "Proveedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idpro2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['idpro2'] = "Proveedor 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['otro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['otro'] = "Descuento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['otro2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['otro2'] = "%  Desc."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['escombo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['escombo'] = "Combo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciomen2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciomen2'] = "$ Menudeo Especial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciomen3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciomen3'] = "$ Menudeo Mayor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['precio2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['precio2'] = "$ Mayor Especial"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciomay']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['preciomay'] = "$ Mayor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['agregarnotainv']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['agregarnotainv'] = "Nota"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['costomay']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['costomay'] = "Costomay"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['imagenprod']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['imagenprod'] = "Imágen"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['unidmaymen']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['unidmaymen'] = "Unidmaymen"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['sc_field_0']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['labels']['sc_field_0'] = "Existencia Menor"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       $this->comp_sum = array(
           ...
           3 => "Existencia Menor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           3 => array('field' => "existencia_menor", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css___nm_count_nm___cnt",
           3 => "css_existencia_menor_sum",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "__nm_count_nm___cnt",
           3 => "existencia_menor_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['codigobar']['alin'] = "''";
       $Arr_parms['codigobar']['link'] = "S";
       $Arr_parms['nompro']['alin'] = "''";
       $Arr_parms['nompro']['link'] = "S";
       $Arr_parms['unimay']['alin'] = "''";
       $Arr_parms['unimay']['link'] = "S";
       $Arr_parms['unimen']['alin'] = "''";
       $Arr_parms['unimen']['link'] = "S";
       $Arr_parms['idgrup']['alin'] = "''";
       $Arr_parms['idgrup']['link'] = "S";
       $Arr_parms['idpro1']['alin'] = "''";
       $Arr_parms['idpro1']['link'] = "S";
       $Arr_parms['idiva']['alin'] = "''";
       $Arr_parms['idiva']['link'] = "S";
       $Arr_parms['escombo']['alin'] = "''";
       $Arr_parms['escombo']['link'] = "S";
       $Arr_parms['codigobar']['fill'] = "true";
       $Arr_parms['codigobar']['order'] = "label";
       $Arr_parms['codigobar']['order_start'] = 'asc';
       $Arr_parms['codigobar']['order_invert'] = 'false';
       $Arr_parms['codigobar']['order_enabled'] = 'false';
       $Arr_parms['nompro']['fill'] = "true";
       $Arr_parms['nompro']['order'] = "label";
       $Arr_parms['nompro']['order_start'] = 'asc';
       $Arr_parms['nompro']['order_invert'] = 'false';
       $Arr_parms['nompro']['order_enabled'] = 'false';
       $Arr_parms['unimay']['fill'] = "true";
       $Arr_parms['unimay']['order'] = "label";
       $Arr_parms['unimay']['order_start'] = 'asc';
       $Arr_parms['unimay']['order_invert'] = 'false';
       $Arr_parms['unimay']['order_enabled'] = 'false';
       ...
       $Arr_parms['idpro1']['fill'] = "true";
       $Arr_parms['idpro1']['order'] = "label";
       $Arr_parms['idpro1']['order_start'] = 'asc';
       $Arr_parms['idpro1']['order_invert'] = 'false';
       $Arr_parms['idpro1']['order_enabled'] = 'false';
       $Arr_parms['idiva']['fill'] = "true";
       $Arr_parms['idiva']['order'] = "label";
       $Arr_parms['idiva']['order_start'] = 'asc';
       $Arr_parms['idiva']['order_invert'] = 'false';
       $Arr_parms['idiva']['order_enabled'] = 'false';
       $Arr_parms['escombo']['fill'] = "true";
       $Arr_parms['escombo']['order'] = "label";
       $Arr_parms['escombo']['order_start'] = 'asc';
       $Arr_parms['escombo']['order_invert'] = 'false';
       $Arr_parms['escombo']['order_enabled'] = 'false';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['codigobar'] = array(0 => 'codigobar', 1 => '@aspass@');
       $prep_links_fl['nompro'] = array(0 => 'nompro', 1 => '@aspass@');
       $prep_links_fl['unimay'] = array(0 => 'unimay', 1 => '@aspass@');
       $prep_links_fl['unimen'] = array(0 => 'unimen', 1 => '@aspass@');
       $prep_links_fl['idgrup'] = array(0 => 'idgrup', 1 => '');
       $prep_links_fl['idpro1'] = array(0 => 'idpro1', 1 => '');
       $prep_links_fl['idiva'] = array(0 => 'idiva', 1 => '');
       $prep_links_fl['escombo'] = array(0 => 'escombo', 1 => '@aspass@');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_productos_mini@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['proc_pdf_vert'])
   {
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_export']['data']  = $this->build_data;
           return;
       }

       $nm_saida->saida("<tr id=\"summary_body\">\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['ajax_nav'])
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
       } 
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function drawMatrixLabels()
   {
       ...
       $nm_saida->saida("    <script type=\"text/javascript\">\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['embutida'])
       { 
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_productos_mini']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_productos_mini']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_productos_mini']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_productos_mini']) . "_";
               } 
           }
       }
   ...
   {
      $this->Tot_ger = false;
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] = "print";
      ...
      $this->Total   = new grid_productos_mini_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_total'][$cmp_gb];
      }
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['doc_word'])
{
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_productos_mini_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_productos_mini_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_productos_mini_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_productos_mini/grid_productos_mini_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_productos_mini_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_productos_mini_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_productos_mini_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['num_css'] . '.css');
...
$nm_saida->saida("      url: \"grid_productos_mini_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_productos_mini/grid_productos_mini_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_productos_mini/grid_productos_mini_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=&nm_all_modules=grid&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_productos_mini/grid_productos_mini_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_productos_mini/grid_productos_mini_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_productos_mini_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_productos_mini_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_productos_mini']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_productos_mini']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_productos_mini_config_pivot.php?nome_apl=grid_productos_mini&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_productos_mini_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_productos_mini/grid_productos_mini_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_productos_mini_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_productos_mini_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_productos_mini_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['grid_productos_mini_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_productos_mini@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_productos_mini_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_productos_mini/grid_productos_mini_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $codigobar = $Busca_temp['codigobar']; 
          $tmp_pos = strpos($codigobar, "##@@");
          if ($tmp_pos !== false && !is_array($codigobar))
          {
              $codigobar = substr($codigobar, 0, $tmp_pos);
          }
          $nompro = $Busca_temp['nompro']; 
          $tmp_pos = strpos($nompro, "##@@");
          if ($tmp_pos !== false && !is_array($nompro))
          {
              $nompro = substr($nompro, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_existencia_menor, $quebra_codigobar, $quebra_nompro, $quebra_unimay, $quebra_unimen, $quebra_idgrup, $quebra_idpro1, $quebra_idiva, $quebra_escombo, $quebra_codigobar_orig, $quebra_nompro_orig, $quebra_unimay_orig, $quebra_unimen_orig, $quebra_idgrup_orig, $quebra_idpro1_orig, $quebra_idiva_orig, $quebra_escombo_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_existencia_menor)) {$sum_existencia_menor = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_existencia_menor . ';
              $this->' . $arr_name . '[2] = 1;
...
$_SESSION['scriptcase']['grid_productos_mini']['contr_erro'] = 'off'; 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->otro = $rs_res->fields[17] ;  
            $this->otro2 = $rs_res->fields[18] ;  
            $this->escombo = $rs_res->fields[19] ;  
            ...
            $this->idpro1_orig = $this->idpro1;
            $this->idiva_orig = $this->idiva;
            $this->escombo_orig = $this->escombo;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->existencia_menor, $this->codigobar, $this->nompro, $this->unimay, $this->unimen, $this->idgrup, $this->idpro1, $this->idiva, $this->escombo, $this->codigobar_orig,  $this->nompro_orig,  $this->unimay_orig,  $this->unimen_orig,  $this->idgrup_orig,  $this->idpro1_orig,  $this->idiva_orig,  $this->escombo_orig);
            }
   }
//
