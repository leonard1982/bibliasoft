 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_codigobar_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['codigobar'])) ? $this->New_label['codigobar'] : " Codigo"; ?></TD>
      
      <INPUT type="hidden" id="SC_codigobar_cond" name="codigobar_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_codigobar" <?php echo $str_hide_codigobar?> valign="top">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-codigobar" id="id_ac_codigobar" name="codigobar_autocomp"><?php if ('' !=  $codigobar) { ?><option value="<?php echo $codigobar ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_nompro_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nompro'])) ? $this->New_label['nompro'] : "Descripción"; ?></TD>
      
      <INPUT type="hidden" id="SC_nompro_cond" name="nompro_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nompro" <?php echo $str_hide_nompro?> valign="top">
