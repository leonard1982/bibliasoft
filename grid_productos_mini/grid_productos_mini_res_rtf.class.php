...
class grid_productos_mini_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   //---- 
   function grid_productos_mini_rtf()
   {
   ...
   function gera_texto_tag()
   {
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_mini']['arr_export']['data'];
       $b_display = false;
