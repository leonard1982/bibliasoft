...
<?php
   ...
   $Ord_Cmp = new grid_productos_mini_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_productos_mini_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["imagen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["imagen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["imagen"] : "Imagen";
   $tab_ger_campos['codigobar'] = "on";
   $tab_def_campos['codigobar'] = "codigobar";
   $tab_labels["codigobar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["codigobar"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["codigobar"] : "Código";
   $tab_ger_campos['nompro'] = "on";
   $tab_def_campos['nompro'] = "nompro";
   $tab_labels["nompro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["nompro"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["nompro"] : "Descripción";
   $tab_ger_campos['existencia_menor'] = "on";
   $tab_def_campos['existencia_menor'] = "existencia_menor";
   $tab_labels["existencia_menor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["existencia_menor"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["existencia_menor"] : "Existencia";
   $tab_ger_campos['unimen'] = "on";
   $tab_def_campos['unimen'] = "unimen";
   $tab_labels["unimen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["unimen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["unimen"] : "Unidad";
   $tab_ger_campos['preciomen'] = "on";
   $tab_def_campos['preciomen'] = "preciomen";
   $tab_labels["preciomen"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["preciomen"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["preciomen"] : "Precio Menudeo";
   $tab_ger_campos['idiva'] = "on";
   $tab_def_campos['idiva'] = "idiva";
   $tab_labels["idiva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["idiva"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["idiva"] : "%IVA";
   ...
   $tab_labels["btn_stock"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["btn_stock"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['labels']["btn_stock"] : "Stock";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_productos_mini_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_productos_mini']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
