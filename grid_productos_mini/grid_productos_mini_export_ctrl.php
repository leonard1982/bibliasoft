<?php
@session_start() ;
$_SESSION['scriptcase']['grid_productos_mini']['sc_process_barr'] = true;
require_once('../grid_productos_mini/index.php');
unset($_SESSION['scriptcase']['grid_productos_mini']['sc_process_barr']);
$ExportCtrl = new grid_productos_mini_export_control;
$ExportCtrl->Export_barr();

class grid_productos_mini_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_productos_mini']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_productos_mini']['glo_nm_path_imag_temp'];
