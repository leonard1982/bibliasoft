...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_mini"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_mini"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_productos_mini'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_productos_mini</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_productos_mini']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_productos_mini' || $achou)
          {
