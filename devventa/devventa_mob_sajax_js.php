  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_devventa_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate fechadev
  function do_ajax_devventa_mob_validate_fechadev()
  {
    var nomeCampo_fechadev = "fechadev";
    var var_fechadev = scAjaxGetFieldHidden(nomeCampo_fechadev);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devventa_mob_validate_fechadev(var_fechadev, var_script_case_init, do_ajax_devventa_mob_validate_fechadev_cb);
  } // do_ajax_devventa_mob_validate_fechadev

  function do_ajax_devventa_mob_validate_fechadev_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devventa_mob_validate_fechadev_cb

  // ---------- Validate cliente
  function do_ajax_devventa_mob_validate_cliente()
  {
  } // do_ajax_devventa_mob_validate_cliente

  function do_ajax_devventa_mob_validate_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devventa_mob_validate_cliente_cb

  // ---------- Validate prefijo
  function do_ajax_devventa_mob_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devventa_mob_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_devventa_mob_validate_prefijo_cb);
  } // do_ajax_devventa_mob_validate_prefijo

  function do_ajax_devventa_mob_validate_prefijo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prefijo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devventa_mob_validate_prefijo_cb

  // ---------- Validate factutaventa
  function do_ajax_devventa_mob_validate_factutaventa()
  {
    var nomeCampo_factutaventa = "factutaventa";
    var var_factutaventa = scAjaxGetFieldSelect(nomeCampo_factutaventa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devventa_mob_validate_factutaventa(var_factutaventa, var_script_case_init, do_ajax_devventa_mob_validate_factutaventa_cb);
  } // do_ajax_devventa_mob_validate_factutaventa

  function do_ajax_devventa_mob_validate_factutaventa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devventa_mob_validate_factutaventa_cb

  // ---------- Validate fechafactura
  function do_ajax_devventa_mob_validate_fechafactura()
  {
    var nomeCampo_fechafactura = "fechafactura";
    var var_fechafactura = scAjaxGetFieldHidden(nomeCampo_fechafactura);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devventa_mob_validate_fechafactura(var_fechafactura, var_script_case_init, do_ajax_devventa_mob_validate_fechafactura_cb);
  } // do_ajax_devventa_mob_validate_fechafactura

  function do_ajax_devventa_mob_validate_fechafactura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devventa_mob_validate_fechafactura_cb

  // ---------- Validate numdev
  function do_ajax_devventa_mob_validate_numdev()
  {
    var nomeCampo_numdev = "numdev";
    var var_numdev = scAjaxGetFieldText(nomeCampo_numdev);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_devventa_mob_validate_numdev(var_numdev, var_script_case_init, do_ajax_devventa_mob_validate_numdev_cb);
  } // do_ajax_devventa_mob_validate_numdev

  function do_ajax_devventa_mob_validate_numdev_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numdev";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devventa_mob_validate_numdev_cb

  // ---------- Refresh cliente
  function do_ajax_devventa_mob_refresh_cliente()
  {
    var var_cliente = scAjaxGetFieldText("cliente");
    var var_nmgp_refresh_fields = "prefijo";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devventa_mob_refresh_cliente(var_cliente, var_nmgp_refresh_fields, var_script_case_init, do_ajax_devventa_mob_refresh_cliente_cb);
  } // do_ajax_devventa_mob_refresh_cliente

  function do_ajax_devventa_mob_refresh_cliente_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetVariables();
    do_ajax_devventa_mob_refresh_prefijo();
    scAjaxShowDebug();
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devventa_mob_refresh_cliente_cb

  // ---------- Refresh prefijo
  function do_ajax_devventa_mob_refresh_prefijo()
  {
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    var var_nmgp_refresh_fields = "factutaventa";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devventa_mob_refresh_prefijo(var_prefijo, var_nmgp_refresh_fields, var_script_case_init, do_ajax_devventa_mob_refresh_prefijo_cb);
  } // do_ajax_devventa_mob_refresh_prefijo

  function do_ajax_devventa_mob_refresh_prefijo_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_devventa_mob_refresh_prefijo_cb

  // ---------- Event onchange cliente
  function do_ajax_devventa_mob_event_cliente_onchange()
  {
    var var_cliente = scAjaxGetFieldText("id_ac_cliente");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devventa_mob_event_cliente_onchange(var_cliente, var_script_case_init, do_ajax_devventa_mob_event_cliente_onchange_cb);
  } // do_ajax_devventa_mob_event_cliente_onchange

  function do_ajax_devventa_mob_event_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_devventa_mob_event_cliente_onchange_cb_after_alert);
  } // do_ajax_devventa_mob_event_cliente_onchange_cb
  function do_ajax_devventa_mob_event_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_devventa_mob_refresh_cliente();
    scAjaxRedir();
  } // do_ajax_devventa_mob_event_cliente_onchange_cb_after_alert

  // ---------- Event onchange factutaventa
  function do_ajax_devventa_mob_event_factutaventa_onchange()
  {
    var var_factutaventa = scAjaxGetFieldSelect("factutaventa");
    var var_fechafactura = scAjaxGetFieldHidden("fechafactura");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devventa_mob_event_factutaventa_onchange(var_factutaventa, var_fechafactura, var_script_case_init, do_ajax_devventa_mob_event_factutaventa_onchange_cb);
  } // do_ajax_devventa_mob_event_factutaventa_onchange

  function do_ajax_devventa_mob_event_factutaventa_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "factutaventa";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_devventa_mob_event_factutaventa_onchange_cb_after_alert);
  } // do_ajax_devventa_mob_event_factutaventa_onchange_cb
  function do_ajax_devventa_mob_event_factutaventa_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_devventa_mob_event_factutaventa_onchange_cb_after_alert

  // ---------- Event onchange prefijo
  function do_ajax_devventa_mob_event_prefijo_onchange()
  {
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_devventa_mob_event_prefijo_onchange(var_prefijo, var_script_case_init, do_ajax_devventa_mob_event_prefijo_onchange_cb);
  } // do_ajax_devventa_mob_event_prefijo_onchange

  function do_ajax_devventa_mob_event_prefijo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_devventa_mob_event_prefijo_onchange_cb_after_alert);
  } // do_ajax_devventa_mob_event_prefijo_onchange_cb
  function do_ajax_devventa_mob_event_prefijo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_devventa_mob_refresh_prefijo();
    scAjaxRedir();
  } // do_ajax_devventa_mob_event_prefijo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_devventa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_devventa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_devventa_mob_submit_form(var_fechadev, var_cliente, var_prefijo, var_factutaventa, var_fechafactura, var_numdev, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_devventa_mob_submit_form_cb);
  } // do_ajax_devventa_mob_submit_form

  function do_ajax_devventa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_devventa_mob_submit_form_cb_after_alert);
  } // do_ajax_devventa_mob_submit_form_cb
  function do_ajax_devventa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_devventa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_devventa_mob_navigate_form()
  {
    perform_ajax_devventa_mob_navigate_form();
  }

  function perform_ajax_devventa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['devventa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_devventa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_devventa_mob_navigate_form_cb_after_alert);
  } // do_ajax_devventa_mob_navigate_form_cb
  function do_ajax_devventa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_devventa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_devventa_mob_navigate_form_cb_after_alert
  function sc_hide_devventa_mob_form()
  {
