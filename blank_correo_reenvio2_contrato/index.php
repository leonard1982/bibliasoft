...
// 
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
;
		...
		if(isset($this->vsiplantilla[0][0]) and isset($this->vsiplantilla[0][1]) and isset($this->vsiplantilla[0][2]) and isset($this->vsiplantilla[0][3]))
		{
			...
			$vcuerpo   = str_replace('"',"'",$vcuerpo);
			$vcuerpo   = addslashes($vcuerpo);
			$vbotones  = $this->vsiplantilla[0][2];
			$vbotones  = str_replace('"',"'",$vbotones);
			$vbotones  = addslashes($vbotones);
			$vpie      = $this->vsiplantilla[0][3];
			$vpie      = str_replace('"',"'",$vpie);
			$vpie      = addslashes($vpie);
		}
	}
	...
	if(isset($this->vdata[0][0]))
	{
		...
		else
		{
			...
			curl_setopt_array($curl, array(
			  ...
			  CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
			  CURLOPT_CUSTOMREQUEST => 'POST',
			  CURLOPT_POSTFIELDS => '{"prefix": "'.$vprefijo.'","number": "'.$vnumero.'","alternate_email": "'.$vemail.'","html_header": "'.$vdatos["html_header"].'","html_body": "'.$vdatos["html_body"].'","html_buttons": "'.$vdatos["html_buttons"].'","html_footer": "'.$vdatos["html_footer"].'"}',
			  CURLOPT_HTTPHEADER => array(
				'Content-Type: application/json',
				'accept: application/json',
				'Authorization: Bearer '.$vtoken
