  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_kardex_adjuntos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_kardex_adjuntos_form();
	}
  ...
  // ---------- Validate id_adjunto_
  function do_ajax_form_cloud_kardex_adjuntos_validate_id_adjunto_(iNumLinha)
  {
    var nomeCampo_id_adjunto_ = "id_adjunto_" + iNumLinha;
    var var_id_adjunto_ = scAjaxGetFieldHidden(nomeCampo_id_adjunto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_adjuntos_validate_id_adjunto_(var_id_adjunto_, iNumLinha, var_script_case_init, do_ajax_form_cloud_kardex_adjuntos_validate_id_adjunto__cb);
  } // do_ajax_form_cloud_kardex_adjuntos_validate_id_adjunto_

  function do_ajax_form_cloud_kardex_adjuntos_validate_id_adjunto__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_adjunto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_adjunto_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_adjunto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_adjunto_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_adjuntos_validate_id_adjunto__cb

  // ---------- Validate id_cloud_kardex_
  function do_ajax_form_cloud_kardex_adjuntos_validate_id_cloud_kardex_(iNumLinha)
  {
    var nomeCampo_id_cloud_kardex_ = "id_cloud_kardex_" + iNumLinha;
    var var_id_cloud_kardex_ = scAjaxGetFieldText(nomeCampo_id_cloud_kardex_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_adjuntos_validate_id_cloud_kardex_(var_id_cloud_kardex_, iNumLinha, var_script_case_init, do_ajax_form_cloud_kardex_adjuntos_validate_id_cloud_kardex__cb);
  } // do_ajax_form_cloud_kardex_adjuntos_validate_id_cloud_kardex_

  function do_ajax_form_cloud_kardex_adjuntos_validate_id_cloud_kardex__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_cloud_kardex_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_cloud_kardex_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_cloud_kardex_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_cloud_kardex_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_adjuntos_validate_id_cloud_kardex__cb

  // ---------- Validate adjunto_
  function do_ajax_form_cloud_kardex_adjuntos_validate_adjunto_(iNumLinha)
  {
    var nomeCampo_adjunto_ = "adjunto_" + iNumLinha;
    var var_adjunto_ = scAjaxGetFieldText(nomeCampo_adjunto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_adjuntos_validate_adjunto_(var_adjunto_, iNumLinha, var_script_case_init, do_ajax_form_cloud_kardex_adjuntos_validate_adjunto__cb);
  } // do_ajax_form_cloud_kardex_adjuntos_validate_adjunto_

  function do_ajax_form_cloud_kardex_adjuntos_validate_adjunto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_kardex_adjuntos_validate_adjunto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cloud_kardex_adjuntos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cloud_kardex_adjuntos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_kardex_adjuntos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cloud_kardex_adjuntos_add_new_line_cb);
  } // do_ajax_form_cloud_kardex_adjuntos_add_new_line

  function do_ajax_form_cloud_kardex_adjuntos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cloud_kardex_adjuntos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cloud_kardex_adjuntos_backup_line(iNumLinha)
  {
    var var_id_adjunto_ = scAjaxGetFieldHidden("id_adjunto_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_kardex_adjuntos_backup_line(var_id_adjunto_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cloud_kardex_adjuntos_backup_line_cb);
  } // do_ajax_form_cloud_kardex_adjuntos_backup_line

  function do_ajax_form_cloud_kardex_adjuntos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cloud_kardex_adjuntos_backup_line_cb

  function do_ajax_form_cloud_kardex_adjuntos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cloud_kardex_adjuntos_cancel_insert

  function do_ajax_form_cloud_kardex_adjuntos_cancel_update(iSeqVert)
  {
    do_ajax_form_cloud_kardex_adjuntos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cloud_kardex_adjuntos_cancel_update

  function do_ajax_form_cloud_kardex_adjuntos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cloud_kardex_adjuntos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cloud_kardex_adjuntos_table_refresh()
  {
    var var_id_adjunto_ = document.F2.id_adjunto_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_kardex_adjuntos_table_refresh(var_id_adjunto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_kardex_adjuntos_table_refresh_cb);
  } //  do_ajax_form_cloud_kardex_adjuntos_table_refresh

  function do_ajax_form_cloud_kardex_adjuntos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_adjunto_.value = scAjaxGetKeyValue("id_adjunto_");
    ...
    scAjaxAlert(do_ajax_form_cloud_kardex_adjuntos_table_refresh_cb_after_alert);
  } // do_ajax_form_cloud_kardex_adjuntos_table_refresh_cb
  function do_ajax_form_cloud_kardex_adjuntos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_cloud_kardex_adjuntos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cloud_kardex_adjuntos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cloud_kardex_adjuntos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_adjunto_ = scAjaxGetFieldHidden("id_adjunto_" + iNumLinha);
    var var_id_cloud_kardex_ = scAjaxGetFieldText("id_cloud_kardex_" + iNumLinha);
...
?>
    x_ajax_form_cloud_kardex_adjuntos_submit_form(var_id_adjunto_, var_id_cloud_kardex_, var_adjunto_, var_adjunto__ul_name, var_adjunto__ul_type, var_adjunto__salva, var_adjunto__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_kardex_adjuntos_submit_form_cb);
  } // do_ajax_form_cloud_kardex_adjuntos_submit_form

  function do_ajax_form_cloud_kardex_adjuntos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_adjunto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_cloud_kardex_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_kardex_adjuntos_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_kardex_adjuntos_submit_form_cb
  function do_ajax_form_cloud_kardex_adjuntos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_kardex_adjuntos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_kardex_adjuntos_navigate_form()
  {
    perform_ajax_form_cloud_kardex_adjuntos_navigate_form();
  }

  function perform_ajax_form_cloud_kardex_adjuntos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("id_adjunto_" + iNavForm);
      scAjaxHideErrorDisplay("id_cloud_kardex_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cloud_kardex_adjuntos_navigate_form(var_id_adjunto_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_kardex_adjuntos_navigate_form_cb);
  } // do_ajax_form_cloud_kardex_adjuntos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_kardex_adjuntos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_kardex_adjuntos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_adjunto_.value = scAjaxGetKeyValue("id_adjunto_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_kardex_adjuntos_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_kardex_adjuntos_navigate_form_cb
  function do_ajax_form_cloud_kardex_adjuntos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cloud_kardex_adjuntos_navigate_form_cb_after_alert
  function sc_hide_form_cloud_kardex_adjuntos_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_adjunto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_cloud_kardex_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "adjunto_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_adjunto_" + iNumLinha] = {"label": "Id Adjunto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_cloud_kardex_" + iNumLinha] = {"label": "Id Cloud Kardex<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_adjunto_"][iNumLinha] = "id_adjunto_" + iNumLinha;
    ajax_field_mult["id_cloud_kardex_"][iNumLinha] = "id_cloud_kardex_" + iNumLinha;
    ...
    ajax_error_count["id_adjunto_" + iNumLinha] = "off";
    ajax_error_count["id_cloud_kardex_" + iNumLinha] = "off";
    ajax_error_count["adjunto_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_adjunto_" + iNumLinha] = "on";
    ajax_read_only["id_cloud_kardex_" + iNumLinha] = "off";
...
?>
    ajax_read_only["id_adjunto_" + iNumLinha] = "on";
    ajax_read_only["id_cloud_kardex_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_adjunto_" + iNumLinha] = null;
    ajax_error_list["id_cloud_kardex_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "id_adjunto_": new Array(),
    "id_cloud_kardex_": new Array(),
    "adjunto_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_adjunto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_adjunto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_adjunto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_adjunto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_adjunto_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_cloud_kardex_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_cloud_kardex_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_cloud_kardex_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_cloud_kardex_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_cloud_kardex_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_adjunto_'])) ? $this->nmgp_cmp_readonly['id_adjunto_'] : 'on';
?>
    scAjaxFieldRead("id_adjunto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_cloud_kardex_'])) ? $this->nmgp_cmp_readonly['id_cloud_kardex_'] : 'off';
?>
    scAjaxFieldRead("id_cloud_kardex_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("id_adjunto_" + iSeq, "on");
    scAjaxFieldRead("id_cloud_kardex_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_adjunto_" + iRow] || "on" == ajax_error_count["id_cloud_kardex_" + iRow] || "on" == ajax_error_count["adjunto_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_adjunto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_cloud_kardex_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_adjunto_" + iRow] && "off" == ajax_error_count["id_cloud_kardex_" + iRow] && "off" == ajax_error_count["adjunto_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_adjunto_" + iRow] = "off";
        ajax_error_count["id_cloud_kardex_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_adjunto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_cloud_kardex_" + iRow).removeClass("scFormErrorLine");
