  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_prefijos_documentos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_prefijos_documentos_form();
	}
  ...
  // ---------- Validate fecha_
  function do_ajax_form_prefijos_documentos_validate_fecha_(iNumLinha)
  {
    var nomeCampo_fecha_ = "fecha_" + iNumLinha;
    var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prefijos_documentos_validate_fecha_(var_fecha_, iNumLinha, var_script_case_init, do_ajax_form_prefijos_documentos_validate_fecha__cb);
  } // do_ajax_form_prefijos_documentos_validate_fecha_

  function do_ajax_form_prefijos_documentos_validate_fecha__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prefijos_documentos_validate_fecha__cb

  // ---------- Validate prefijo_
  function do_ajax_form_prefijos_documentos_validate_prefijo_(iNumLinha)
  {
    var nomeCampo_prefijo_ = "prefijo_" + iNumLinha;
    var var_prefijo_ = scAjaxGetFieldText(nomeCampo_prefijo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prefijos_documentos_validate_prefijo_(var_prefijo_, iNumLinha, var_script_case_init, do_ajax_form_prefijos_documentos_validate_prefijo__cb);
  } // do_ajax_form_prefijos_documentos_validate_prefijo_

  function do_ajax_form_prefijos_documentos_validate_prefijo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prefijos_documentos_validate_prefijo__cb

  // ---------- Validate primerfactura_
  function do_ajax_form_prefijos_documentos_validate_primerfactura_(iNumLinha)
  {
    var nomeCampo_primerfactura_ = "primerfactura_" + iNumLinha;
    var var_primerfactura_ = scAjaxGetFieldText(nomeCampo_primerfactura_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prefijos_documentos_validate_primerfactura_(var_primerfactura_, iNumLinha, var_script_case_init, do_ajax_form_prefijos_documentos_validate_primerfactura__cb);
  } // do_ajax_form_prefijos_documentos_validate_primerfactura_

  function do_ajax_form_prefijos_documentos_validate_primerfactura__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "primerfactura_" + iLineNumber;
    }
    else
    {
      sFieldValid = "primerfactura_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "primerfactura_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "primerfactura_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prefijos_documentos_validate_primerfactura__cb

  // ---------- Validate nombre_pc_
  function do_ajax_form_prefijos_documentos_validate_nombre_pc_(iNumLinha)
  {
    var nomeCampo_nombre_pc_ = "nombre_pc_" + iNumLinha;
    var var_nombre_pc_ = scAjaxGetFieldText(nomeCampo_nombre_pc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prefijos_documentos_validate_nombre_pc_(var_nombre_pc_, iNumLinha, var_script_case_init, do_ajax_form_prefijos_documentos_validate_nombre_pc__cb);
  } // do_ajax_form_prefijos_documentos_validate_nombre_pc_

  function do_ajax_form_prefijos_documentos_validate_nombre_pc__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nombre_pc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nombre_pc_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nombre_pc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nombre_pc_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prefijos_documentos_validate_nombre_pc__cb

  // ---------- Validate nombre_impre_
  function do_ajax_form_prefijos_documentos_validate_nombre_impre_(iNumLinha)
  {
    var nomeCampo_nombre_impre_ = "nombre_impre_" + iNumLinha;
    var var_nombre_impre_ = scAjaxGetFieldText(nomeCampo_nombre_impre_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prefijos_documentos_validate_nombre_impre_(var_nombre_impre_, iNumLinha, var_script_case_init, do_ajax_form_prefijos_documentos_validate_nombre_impre__cb);
  } // do_ajax_form_prefijos_documentos_validate_nombre_impre_

  function do_ajax_form_prefijos_documentos_validate_nombre_impre__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nombre_impre_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nombre_impre_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nombre_impre_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nombre_impre_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prefijos_documentos_validate_nombre_impre__cb

  // ---------- Validate fec_vencimiento_
  function do_ajax_form_prefijos_documentos_validate_fec_vencimiento_(iNumLinha)
  {
    var nomeCampo_fec_vencimiento_ = "fec_vencimiento_" + iNumLinha;
    var var_fec_vencimiento_ = scAjaxGetFieldText(nomeCampo_fec_vencimiento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prefijos_documentos_validate_fec_vencimiento_(var_fec_vencimiento_, iNumLinha, var_script_case_init, do_ajax_form_prefijos_documentos_validate_fec_vencimiento__cb);
  } // do_ajax_form_prefijos_documentos_validate_fec_vencimiento_

  function do_ajax_form_prefijos_documentos_validate_fec_vencimiento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "fec_vencimiento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "fec_vencimiento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "fec_vencimiento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "fec_vencimiento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_prefijos_documentos_validate_fec_vencimiento__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_prefijos_documentos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_prefijos_documentos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_prefijos_documentos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_prefijos_documentos_add_new_line_cb);
  } // do_ajax_form_prefijos_documentos_add_new_line

  function do_ajax_form_prefijos_documentos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_prefijos_documentos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_prefijos_documentos_backup_line(iNumLinha)
  {
    var var_idres_ = scAjaxGetFieldText("idres_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_prefijos_documentos_backup_line(var_idres_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_prefijos_documentos_backup_line_cb);
  } // do_ajax_form_prefijos_documentos_backup_line

  function do_ajax_form_prefijos_documentos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_prefijos_documentos_backup_line_cb

  function do_ajax_form_prefijos_documentos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_prefijos_documentos_cancel_insert

  function do_ajax_form_prefijos_documentos_cancel_update(iSeqVert)
  {
    do_ajax_form_prefijos_documentos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_prefijos_documentos_cancel_update

  function do_ajax_form_prefijos_documentos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_prefijos_documentos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_prefijos_documentos_table_refresh()
  {
    var var_idres_ = document.F2.idres_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_prefijos_documentos_table_refresh(var_idres_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prefijos_documentos_table_refresh_cb);
  } //  do_ajax_form_prefijos_documentos_table_refresh

  function do_ajax_form_prefijos_documentos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idres_.value = scAjaxGetKeyValue("idres_");
    ...
    scAjaxAlert(do_ajax_form_prefijos_documentos_table_refresh_cb_after_alert);
  } // do_ajax_form_prefijos_documentos_table_refresh_cb
  function do_ajax_form_prefijos_documentos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_prefijos_documentos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_prefijos_documentos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_prefijos_documentos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_primerfactura_ = scAjaxGetFieldText("primerfactura_" + iNumLinha);
    var var_nombre_pc_ = scAjaxGetFieldText("nombre_pc_" + iNumLinha);
    var var_nombre_impre_ = scAjaxGetFieldText("nombre_impre_" + iNumLinha);
    var var_fec_vencimiento_ = scAjaxGetFieldText("fec_vencimiento_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_prefijos_documentos_submit_form(var_fecha_, var_prefijo_, var_primerfactura_, var_nombre_pc_, var_nombre_impre_, var_fec_vencimiento_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_prefijos_documentos_submit_form_cb);
  } // do_ajax_form_prefijos_documentos_submit_form

  function do_ajax_form_prefijos_documentos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("primerfactura_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_pc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_impre_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("fec_vencimiento_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_prefijos_documentos_submit_form_cb_after_alert);
  } // do_ajax_form_prefijos_documentos_submit_form_cb
  function do_ajax_form_prefijos_documentos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_prefijos_documentos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_prefijos_documentos_navigate_form()
  {
    perform_ajax_form_prefijos_documentos_navigate_form();
  }

  function perform_ajax_form_prefijos_documentos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("primerfactura_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_pc_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_impre_" + iNavForm);
      scAjaxHideErrorDisplay("fec_vencimiento_" + iNavForm);
    }
    var var_idres_ = document.F2.idres_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_prefijos_documentos_navigate_form(var_idres_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_prefijos_documentos_navigate_form_cb);
  } // do_ajax_form_prefijos_documentos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_prefijos_documentos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_prefijos_documentos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idres_.value = scAjaxGetKeyValue("idres_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_prefijos_documentos_navigate_form_cb_after_alert);
  } // do_ajax_form_prefijos_documentos_navigate_form_cb
  function do_ajax_form_prefijos_documentos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_prefijos_documentos_navigate_form_cb_after_alert
  function sc_hide_form_prefijos_documentos_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "primerfactura_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_pc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_impre_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "fec_vencimiento_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["primerfactura_" + iNumLinha] = {"label": "# del Primer documento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_pc_" + iNumLinha] = {"label": "Nombre Pc de Red<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_impre_" + iNumLinha] = {"label": "Nombre Impresora de Red<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["fec_vencimiento_" + iNumLinha] = {"label": "Fec Vencimiento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["fecha_"][iNumLinha] = "fecha_" + iNumLinha;
    ajax_field_mult["prefijo_"][iNumLinha] = "prefijo_" + iNumLinha;
    ajax_field_mult["primerfactura_"][iNumLinha] = "primerfactura_" + iNumLinha;
    ajax_field_mult["nombre_pc_"][iNumLinha] = "nombre_pc_" + iNumLinha;
    ajax_field_mult["nombre_impre_"][iNumLinha] = "nombre_impre_" + iNumLinha;
    ajax_field_mult["fec_vencimiento_"][iNumLinha] = "fec_vencimiento_" + iNumLinha;
    ajax_field_id["prefijo_" + iNumLinha] = new Array("hidden_field_label_prefijo_", "hidden_field_data_prefijo_" + iNumLinha);
    ajax_field_id["primerfactura_" + iNumLinha] = new Array("hidden_field_label_primerfactura_", "hidden_field_data_primerfactura_" + iNumLinha);
    ajax_field_id["nombre_pc_" + iNumLinha] = new Array("hidden_field_label_nombre_pc_", "hidden_field_data_nombre_pc_" + iNumLinha);
    ajax_field_id["nombre_impre_" + iNumLinha] = new Array("hidden_field_label_nombre_impre_", "hidden_field_data_nombre_impre_" + iNumLinha);
    ajax_error_count["fecha_" + iNumLinha] = "off";
    ajax_error_count["prefijo_" + iNumLinha] = "off";
    ajax_error_count["primerfactura_" + iNumLinha] = "off";
    ajax_error_count["nombre_pc_" + iNumLinha] = "off";
    ajax_error_count["nombre_impre_" + iNumLinha] = "off";
    ajax_error_count["fec_vencimiento_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["primerfactura_" + iNumLinha] = "off";
    ajax_read_only["nombre_pc_" + iNumLinha] = "off";
    ajax_read_only["nombre_impre_" + iNumLinha] = "off";
    ajax_read_only["fec_vencimiento_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["primerfactura_" + iNumLinha] = "on";
    ajax_read_only["nombre_pc_" + iNumLinha] = "on";
    ajax_read_only["nombre_impre_" + iNumLinha] = "on";
    ajax_read_only["fec_vencimiento_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["primerfactura_" + iNumLinha] = null;
    ajax_error_list["nombre_pc_" + iNumLinha] = null;
    ajax_error_list["nombre_impre_" + iNumLinha] = null;
    ajax_error_list["fec_vencimiento_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "fecha_": new Array(),
    "prefijo_": new Array(),
    "primerfactura_": new Array(),
    "nombre_pc_": new Array(),
    "nombre_impre_": new Array(),
    "fec_vencimiento_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["primerfactura_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["primerfactura_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["primerfactura_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["primerfactura_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["primerfactura_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nombre_pc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nombre_pc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nombre_pc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nombre_pc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nombre_pc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nombre_impre_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nombre_impre_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nombre_impre_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nombre_impre_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nombre_impre_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["fec_vencimiento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["fec_vencimiento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["fec_vencimiento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["fec_vencimiento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["fec_vencimiento_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['primerfactura_'])) ? $this->nmgp_cmp_readonly['primerfactura_'] : 'off';
?>
    scAjaxFieldRead("primerfactura_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_pc_'])) ? $this->nmgp_cmp_readonly['nombre_pc_'] : 'off';
?>
    scAjaxFieldRead("nombre_pc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_impre_'])) ? $this->nmgp_cmp_readonly['nombre_impre_'] : 'off';
?>
    scAjaxFieldRead("nombre_impre_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['fec_vencimiento_'])) ? $this->nmgp_cmp_readonly['fec_vencimiento_'] : 'off';
?>
    scAjaxFieldRead("fec_vencimiento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("primerfactura_" + iSeq, "on");
    scAjaxFieldRead("nombre_pc_" + iSeq, "on");
    scAjaxFieldRead("nombre_impre_" + iSeq, "on");
    scAjaxFieldRead("fec_vencimiento_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["fecha_" + iRow] || "on" == ajax_error_count["prefijo_" + iRow] || "on" == ajax_error_count["primerfactura_" + iRow] || "on" == ajax_error_count["nombre_pc_" + iRow] || "on" == ajax_error_count["nombre_impre_" + iRow] || "on" == ajax_error_count["fec_vencimiento_" + iRow]))
    {
      ...
      $("#hidden_field_data_primerfactura_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_pc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_impre_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_fec_vencimiento_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["fecha_" + iRow] && "off" == ajax_error_count["prefijo_" + iRow] && "off" == ajax_error_count["primerfactura_" + iRow] && "off" == ajax_error_count["nombre_pc_" + iRow] && "off" == ajax_error_count["nombre_impre_" + iRow] && "off" == ajax_error_count["fec_vencimiento_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["fecha_" + iRow] = "off";
        ajax_error_count["prefijo_" + iRow] = "off";
        ajax_error_count["primerfactura_" + iRow] = "off";
        ajax_error_count["nombre_pc_" + iRow] = "off";
        ajax_error_count["nombre_impre_" + iRow] = "off";
        ajax_error_count["fec_vencimiento_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_primerfactura_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_pc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_impre_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_fec_vencimiento_" + iRow).removeClass("scFormErrorLine");
    }
  }
