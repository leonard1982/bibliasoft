<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="idtercero_cuenta" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idtercero_cuenta']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_porpagar_161219_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_terceros_cuentas_porpagar_161219_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?>
    ...
    {
        do_ajax_form_terceros_cuentas_porpagar_161219_mob_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_terceros_cuentas_porpagar_161219_mob_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
