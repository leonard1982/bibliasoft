...
?>
  ...
  function perform_ajax_form_terceros_cuentas_porpagar_161219_mob_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_terceros_cuentas_porpagar_161219_mob_navigate_form(var_idtercero_cuenta, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_mob_navigate_form_cb);
