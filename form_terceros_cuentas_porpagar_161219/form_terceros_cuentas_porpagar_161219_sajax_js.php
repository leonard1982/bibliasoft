  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_terceros_cuentas_porpagar_161219" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_terceros_cuentas_porpagar_161219_form();
	}
...
?>
  ...
  // ---------- Validate prefijo
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_prefijo()
  {
    var nomeCampo_prefijo = "prefijo";
    var var_prefijo = scAjaxGetFieldSelect(nomeCampo_prefijo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_prefijo(var_prefijo, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_prefijo_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_prefijo

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_prefijo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_prefijo_cb

  // ---------- Validate numero
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_numero(var_numero, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_cb

  // ---------- Validate fecha
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_fecha_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_fecha

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_fecha_cb

  // ---------- Validate cod_cuenta
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_cod_cuenta()
  {
    var nomeCampo_cod_cuenta = "cod_cuenta";
    var var_cod_cuenta = scAjaxGetFieldText(nomeCampo_cod_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_cod_cuenta(var_cod_cuenta, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_cod_cuenta_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_cod_cuenta

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_cod_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_cod_cuenta_cb

  // ---------- Validate tipo
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_tipo_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_tipo

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_tipo_cb

  // ---------- Validate tercero
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_tercero()
  {
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_tercero

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_tercero_cb

  // ---------- Validate numero_documento
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_documento()
  {
    var nomeCampo_numero_documento = "numero_documento";
    var var_numero_documento = scAjaxGetFieldText(nomeCampo_numero_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_documento(var_numero_documento, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_documento_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_documento

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_numero_documento_cb

  // ---------- Validate valor_total
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldText(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_valor_total_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_valor_total

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_valor_total_cb

  // ---------- Validate saldo
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldText(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_saldo_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_saldo

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_saldo_cb

  // ---------- Validate concepto
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_concepto()
  {
    var nomeCampo_concepto = "concepto";
    var var_concepto = scAjaxGetFieldSelect(nomeCampo_concepto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_concepto(var_concepto, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_concepto_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_concepto

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_concepto_cb

  // ---------- Validate observaciones
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_observaciones_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_observaciones

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_observaciones_cb

  // ---------- Validate usuario
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldSelect(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_usuario_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_usuario

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_usuario_cb

  // ---------- Validate automatico
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_automatico()
  {
    var nomeCampo_automatico = "automatico";
    var var_automatico = scAjaxGetFieldText(nomeCampo_automatico);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_automatico(var_automatico, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_automatico_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_automatico

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_automatico_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_automatico_cb

  // ---------- Validate pagada
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_pagada()
  {
    var nomeCampo_pagada = "pagada";
    var var_pagada = scAjaxGetFieldText(nomeCampo_pagada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_pagada(var_pagada, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_pagada_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_pagada

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_pagada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pagada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_pagada_cb

  // ---------- Validate idtercero_cuenta
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_idtercero_cuenta()
  {
    var nomeCampo_idtercero_cuenta = "idtercero_cuenta";
    var var_idtercero_cuenta = scAjaxGetFieldHidden(nomeCampo_idtercero_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_idtercero_cuenta(var_idtercero_cuenta, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_idtercero_cuenta_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_idtercero_cuenta

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_idtercero_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_idtercero_cuenta_cb

  // ---------- Validate ie
  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_ie()
  {
    var nomeCampo_ie = "ie";
    var var_ie = scAjaxGetFieldSelect(nomeCampo_ie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_cuentas_porpagar_161219_validate_ie(var_ie, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_validate_ie_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_ie

  function do_ajax_form_terceros_cuentas_porpagar_161219_validate_ie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ie";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_validate_ie_cb

  // ---------- Event onchange cod_cuenta
  function do_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange(var_cod_cuenta, var_tercero, var_valor_total, var_saldo, var_numero_documento, var_tipo, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange

  function do_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cod_cuenta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange_cb_after_alert);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange_cb
  function do_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_terceros_cuentas_porpagar_161219_event_cod_cuenta_onchange_cb_after_alert

  // ---------- Event onchange prefijo
  function do_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange(var_idtercero_cuenta, var_prefijo, var_numero, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange

  function do_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange_cb_after_alert);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange_cb
  function do_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_event_prefijo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_terceros_cuentas_porpagar_161219_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_terceros_cuentas_porpagar_161219_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_prefijo = scAjaxGetFieldSelect("prefijo");
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_cuentas_porpagar_161219_submit_form(var_prefijo, var_numero, var_fecha, var_cod_cuenta, var_tipo, var_tercero, var_numero_documento, var_valor_total, var_saldo, var_concepto, var_observaciones, var_usuario, var_automatico, var_pagada, var_idtercero_cuenta, var_ie, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_terceros_cuentas_porpagar_161219_submit_form_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_submit_form

  function do_ajax_form_terceros_cuentas_porpagar_161219_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_terceros_cuentas_porpagar_161219_submit_form_cb_after_alert);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_submit_form_cb
  function do_ajax_form_terceros_cuentas_porpagar_161219_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_terceros_cuentas_porpagar_161219_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_terceros_cuentas_porpagar_161219_navigate_form()
  {
    perform_ajax_form_terceros_cuentas_porpagar_161219_navigate_form();
  }

  function perform_ajax_form_terceros_cuentas_porpagar_161219_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_terceros_cuentas_porpagar_161219_navigate_form(var_idtercero_cuenta, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_navigate_form_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_cuentas_porpagar_161219']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_terceros_cuentas_porpagar_161219_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_terceros_cuentas_porpagar_161219_navigate_form_cb_after_alert);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_navigate_form_cb
  function do_ajax_form_terceros_cuentas_porpagar_161219_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_terceros_cuentas_porpagar_161219_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_terceros_cuentas_porpagar_161219_navigate_form_cb_after_alert
  function sc_hide_form_terceros_cuentas_porpagar_161219_form()
  {
  ...
  function do_ajax_form_terceros_cuentas_porpagar_161219_lkpedt_refresh_concepto()
  {
    var var_concepto = scAjaxGetFieldSelect("concepto");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "concepto";
    x_ajax_form_terceros_cuentas_porpagar_161219_lkpedt_refresh_concepto(var_concepto, nmgp_refresh_fields, var_script_case_init, do_ajax_form_terceros_cuentas_porpagar_161219_lkpedt_refresh_concepto_cb);
  } // do_ajax_form_terceros_cuentas_porpagar_161219_lkpedt_refresh_concepto

  function do_ajax_form_terceros_cuentas_porpagar_161219_lkpedt_refresh_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_terceros_cuentas_porpagar_161219_lkpedt_refresh_concepto_cb
