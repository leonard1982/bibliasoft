...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_121219']['contr_label_graf']['fechaven']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_121219']['contr_label_graf']['fechaven']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_121219']['contr_label_graf']['fechaven'];
      }
   }
