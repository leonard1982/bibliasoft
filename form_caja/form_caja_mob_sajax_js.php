  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_caja_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate fecha
  function do_ajax_form_caja_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_caja_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_caja_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_caja_mob_validate_fecha

  function do_ajax_form_caja_mob_validate_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_fecha_cb

  // ---------- Validate hora
  function do_ajax_form_caja_mob_validate_hora()
  {
    var nomeCampo_hora = "hora";
    var var_hora = scAjaxGetFieldText(nomeCampo_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_mob_validate_hora(var_hora, var_script_case_init, do_ajax_form_caja_mob_validate_hora_cb);
  } // do_ajax_form_caja_mob_validate_hora

  function do_ajax_form_caja_mob_validate_hora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_hora_cb

  // ---------- Validate detalle
  function do_ajax_form_caja_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldSelect(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_caja_mob_validate_detalle_cb);
  } // do_ajax_form_caja_mob_validate_detalle

  function do_ajax_form_caja_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_detalle_cb

  // ---------- Validate banco
  function do_ajax_form_caja_mob_validate_banco()
  {
    var nomeCampo_banco = "banco";
    var var_banco = scAjaxGetFieldSelect(nomeCampo_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_mob_validate_banco(var_banco, var_script_case_init, do_ajax_form_caja_mob_validate_banco_cb);
  } // do_ajax_form_caja_mob_validate_banco

  function do_ajax_form_caja_mob_validate_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banco";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_banco_cb

  // ---------- Validate usuario
  function do_ajax_form_caja_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldSelect(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_caja_mob_validate_usuario_cb);
  } // do_ajax_form_caja_mob_validate_usuario

  function do_ajax_form_caja_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_usuario_cb

  // ---------- Validate documento
  function do_ajax_form_caja_mob_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldHidden(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_mob_validate_documento(var_documento, var_script_case_init, do_ajax_form_caja_mob_validate_documento_cb);
  } // do_ajax_form_caja_mob_validate_documento

  function do_ajax_form_caja_mob_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_documento_cb

  // ---------- Validate cantidad
  function do_ajax_form_caja_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_caja_mob_validate_cantidad_cb);
  } // do_ajax_form_caja_mob_validate_cantidad

  function do_ajax_form_caja_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_cantidad_cb

  // ---------- Validate cierredia
  function do_ajax_form_caja_mob_validate_cierredia()
  {
    var nomeCampo_cierredia = "cierredia";
    var var_cierredia = scAjaxGetFieldSelect(nomeCampo_cierredia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_mob_validate_cierredia(var_cierredia, var_script_case_init, do_ajax_form_caja_mob_validate_cierredia_cb);
  } // do_ajax_form_caja_mob_validate_cierredia

  function do_ajax_form_caja_mob_validate_cierredia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cierredia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_cierredia_cb

  // ---------- Validate idcaja
  function do_ajax_form_caja_mob_validate_idcaja()
  {
    var nomeCampo_idcaja = "idcaja";
    var var_idcaja = scAjaxGetFieldHidden(nomeCampo_idcaja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_mob_validate_idcaja(var_idcaja, var_script_case_init, do_ajax_form_caja_mob_validate_idcaja_cb);
  } // do_ajax_form_caja_mob_validate_idcaja

  function do_ajax_form_caja_mob_validate_idcaja_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcaja";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_mob_validate_idcaja_cb

  // ---------- Event onchange arqueo
  function do_ajax_form_caja_mob_event_arqueo_onchange()
  {
    var var_cierredia = scAjaxGetFieldSelect("cierredia");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_mob_event_arqueo_onchange(var_cierredia, var_fecha, var_script_case_init, do_ajax_form_caja_mob_event_arqueo_onchange_cb);
  } // do_ajax_form_caja_mob_event_arqueo_onchange

  function do_ajax_form_caja_mob_event_arqueo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "arqueo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_mob_event_arqueo_onchange_cb_after_alert);
  } // do_ajax_form_caja_mob_event_arqueo_onchange_cb
  function do_ajax_form_caja_mob_event_arqueo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_mob_event_arqueo_onchange_cb_after_alert

  // ---------- Event onchange banco
  function do_ajax_form_caja_mob_event_banco_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_usuario = scAjaxGetFieldSelect("usuario");
    var var_banco = scAjaxGetFieldSelect("banco");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_mob_event_banco_onchange(var_detalle, var_usuario, var_banco, var_script_case_init, do_ajax_form_caja_mob_event_banco_onchange_cb);
  } // do_ajax_form_caja_mob_event_banco_onchange

  function do_ajax_form_caja_mob_event_banco_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "banco";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_mob_event_banco_onchange_cb_after_alert);
  } // do_ajax_form_caja_mob_event_banco_onchange_cb
  function do_ajax_form_caja_mob_event_banco_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_mob_event_banco_onchange_cb_after_alert

  // ---------- Event onchange cantidad
  function do_ajax_form_caja_mob_event_cantidad_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_mob_event_cantidad_onchange(var_detalle, var_cantidad, var_cierredia, var_script_case_init, do_ajax_form_caja_mob_event_cantidad_onchange_cb);
  } // do_ajax_form_caja_mob_event_cantidad_onchange

  function do_ajax_form_caja_mob_event_cantidad_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_mob_event_cantidad_onchange_cb_after_alert);
  } // do_ajax_form_caja_mob_event_cantidad_onchange_cb
  function do_ajax_form_caja_mob_event_cantidad_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_mob_event_cantidad_onchange_cb_after_alert

  // ---------- Event onchange cierredia
  function do_ajax_form_caja_mob_event_cierredia_onchange()
  {
    var var_cierredia = scAjaxGetFieldSelect("cierredia");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_mob_event_cierredia_onchange(var_cierredia, var_script_case_init, do_ajax_form_caja_mob_event_cierredia_onchange_cb);
  } // do_ajax_form_caja_mob_event_cierredia_onchange

  function do_ajax_form_caja_mob_event_cierredia_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cierredia";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_mob_event_cierredia_onchange_cb_after_alert);
  } // do_ajax_form_caja_mob_event_cierredia_onchange_cb
  function do_ajax_form_caja_mob_event_cierredia_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_mob_event_cierredia_onchange_cb_after_alert

  // ---------- Event onchange detalle
  function do_ajax_form_caja_mob_event_detalle_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_banco = scAjaxGetFieldSelect("banco");
    var var_usuario = scAjaxGetFieldSelect("usuario");
    var var_cierredia = scAjaxGetFieldSelect("cierredia");
    var var_documento = scAjaxGetFieldHidden("documento");
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_mob_event_detalle_onchange(var_detalle, var_banco, var_usuario, var_cierredia, var_documento, var_cantidad, var_script_case_init, do_ajax_form_caja_mob_event_detalle_onchange_cb);
  } // do_ajax_form_caja_mob_event_detalle_onchange

  function do_ajax_form_caja_mob_event_detalle_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "detalle";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_mob_event_detalle_onchange_cb_after_alert);
  } // do_ajax_form_caja_mob_event_detalle_onchange_cb
  function do_ajax_form_caja_mob_event_detalle_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_mob_event_detalle_onchange_cb_after_alert

  // ---------- Event onchange documento
  function do_ajax_form_caja_mob_event_documento_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_documento = scAjaxGetFieldHidden("documento");
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_mob_event_documento_onchange(var_detalle, var_documento, var_cantidad, var_script_case_init, do_ajax_form_caja_mob_event_documento_onchange_cb);
  } // do_ajax_form_caja_mob_event_documento_onchange

  function do_ajax_form_caja_mob_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_mob_event_documento_onchange_cb_after_alert);
  } // do_ajax_form_caja_mob_event_documento_onchange_cb
  function do_ajax_form_caja_mob_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_mob_event_documento_onchange_cb_after_alert

  // ---------- Event onchange fecha
  function do_ajax_form_caja_mob_event_fecha_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_mob_event_fecha_onchange(var_detalle, var_script_case_init, do_ajax_form_caja_mob_event_fecha_onchange_cb);
  } // do_ajax_form_caja_mob_event_fecha_onchange

  function do_ajax_form_caja_mob_event_fecha_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_mob_event_fecha_onchange_cb_after_alert);
  } // do_ajax_form_caja_mob_event_fecha_onchange_cb
  function do_ajax_form_caja_mob_event_fecha_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_mob_event_fecha_onchange_cb_after_alert

  // ---------- Event onchange usuario
  function do_ajax_form_caja_mob_event_usuario_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_usuario = scAjaxGetFieldSelect("usuario");
    var var_banco = scAjaxGetFieldSelect("banco");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_mob_event_usuario_onchange(var_detalle, var_usuario, var_banco, var_cierredia, var_documento, var_cantidad, var_script_case_init, do_ajax_form_caja_mob_event_usuario_onchange_cb);
  } // do_ajax_form_caja_mob_event_usuario_onchange

  function do_ajax_form_caja_mob_event_usuario_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "usuario";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_mob_event_usuario_onchange_cb_after_alert);
  } // do_ajax_form_caja_mob_event_usuario_onchange_cb
  function do_ajax_form_caja_mob_event_usuario_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_mob_event_usuario_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_caja_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_caja_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fecha = scAjaxGetFieldText("fecha");
    ...
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_cierredia = scAjaxGetFieldSelect("cierredia");
    var var_idcaja = scAjaxGetFieldHidden("idcaja");
    ...
    scAjaxProcOn();
    x_ajax_form_caja_mob_submit_form(var_fecha, var_hora, var_detalle, var_banco, var_usuario, var_documento, var_cantidad, var_cierredia, var_idcaja, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_caja_mob_submit_form_cb);
  } // do_ajax_form_caja_mob_submit_form

  function do_ajax_form_caja_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("cierredia");
      scAjaxHideErrorDisplay("idcaja");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_caja_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_caja_mob']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_caja_mob']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_caja_mob_submit_form_cb_after_alert);
  } // do_ajax_form_caja_mob_submit_form_cb
  function do_ajax_form_caja_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_caja_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_caja_mob_navigate_form()
  {
    perform_ajax_form_caja_mob_navigate_form();
  }

  function perform_ajax_form_caja_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("cierredia");
    scAjaxHideErrorDisplay("idcaja");
    var var_idcaja = document.F2.idcaja.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_caja_mob_navigate_form(var_idcaja, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_caja_mob_navigate_form_cb);
  } // do_ajax_form_caja_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_caja_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_caja_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcaja.value = scAjaxGetKeyValue("idcaja");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_caja_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_caja_mob_navigate_form_cb
  function do_ajax_form_caja_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_caja_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_caja_mob_navigate_form_cb_after_alert
  function sc_hide_form_caja_mob_form()
  {
  ...
  ajax_field_list[1] = "hora";
  ajax_field_list[2] = "detalle";
  ajax_field_list[3] = "banco";
  ajax_field_list[4] = "usuario";
  ajax_field_list[5] = "documento";
  ajax_field_list[6] = "cantidad";
  ajax_field_list[7] = "cierredia";
  ajax_field_list[8] = "idcaja";
  ...
  var ajax_error_list = {
    ...
    "usuario": {"label": "Usuario/Cajero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "cantidad": {"label": "Valor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cierredia": {"label": "Cuadrar Caja", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idcaja": {"label": "Consecutivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["cierredia"][1] = "cierredia";
  ajax_field_mult["idcaja"][1] = "idcaja";
  ...
  var ajax_field_id = {
    ...
    "cierredia": new Array("hidden_field_label_cierredia", "hidden_field_data_cierredia"),
    "idcaja": new Array("hidden_field_label_idcaja", "hidden_field_data_idcaja")
  };
