...
?>
  ...
  // ---------- Validate fecha
  function do_ajax_form_caja_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_caja_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_caja_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_caja_validate_fecha

  function do_ajax_form_caja_validate_fecha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_fecha_cb

  // ---------- Validate hora
  function do_ajax_form_caja_validate_hora()
  {
    var nomeCampo_hora = "hora";
    var var_hora = scAjaxGetFieldText(nomeCampo_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_validate_hora(var_hora, var_script_case_init, do_ajax_form_caja_validate_hora_cb);
  } // do_ajax_form_caja_validate_hora

  function do_ajax_form_caja_validate_hora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_hora_cb

  // ---------- Validate detalle
  function do_ajax_form_caja_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldSelect(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_caja_validate_detalle_cb);
  } // do_ajax_form_caja_validate_detalle

  function do_ajax_form_caja_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_detalle_cb

  // ---------- Validate banco
  function do_ajax_form_caja_validate_banco()
  {
    var nomeCampo_banco = "banco";
    var var_banco = scAjaxGetFieldSelect(nomeCampo_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_validate_banco(var_banco, var_script_case_init, do_ajax_form_caja_validate_banco_cb);
  } // do_ajax_form_caja_validate_banco

  function do_ajax_form_caja_validate_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banco";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_banco_cb

  // ---------- Validate usuario
  function do_ajax_form_caja_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldSelect(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_validate_usuario(var_usuario, var_script_case_init, do_ajax_form_caja_validate_usuario_cb);
  } // do_ajax_form_caja_validate_usuario

  function do_ajax_form_caja_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_usuario_cb

  // ---------- Validate documento
  function do_ajax_form_caja_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldHidden(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_validate_documento(var_documento, var_script_case_init, do_ajax_form_caja_validate_documento_cb);
  } // do_ajax_form_caja_validate_documento

  function do_ajax_form_caja_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_documento_cb

  // ---------- Validate cantidad
  function do_ajax_form_caja_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_caja_validate_cantidad_cb);
  } // do_ajax_form_caja_validate_cantidad

  function do_ajax_form_caja_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_cantidad_cb

  // ---------- Validate cierredia
  function do_ajax_form_caja_validate_cierredia()
  {
    var nomeCampo_cierredia = "cierredia";
    var var_cierredia = scAjaxGetFieldSelect(nomeCampo_cierredia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_validate_cierredia(var_cierredia, var_script_case_init, do_ajax_form_caja_validate_cierredia_cb);
  } // do_ajax_form_caja_validate_cierredia

  function do_ajax_form_caja_validate_cierredia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_cierredia_cb

  // ---------- Validate idcaja
  function do_ajax_form_caja_validate_idcaja()
  {
    var nomeCampo_idcaja = "idcaja";
    var var_idcaja = scAjaxGetFieldHidden(nomeCampo_idcaja);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caja_validate_idcaja(var_idcaja, var_script_case_init, do_ajax_form_caja_validate_idcaja_cb);
  } // do_ajax_form_caja_validate_idcaja

  function do_ajax_form_caja_validate_idcaja_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcaja";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caja_validate_idcaja_cb

  // ---------- Event onchange arqueo
  function do_ajax_form_caja_event_arqueo_onchange()
  {
    var var_cierredia = scAjaxGetFieldSelect("cierredia");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_event_arqueo_onchange(var_cierredia, var_fecha, var_script_case_init, do_ajax_form_caja_event_arqueo_onchange_cb);
  } // do_ajax_form_caja_event_arqueo_onchange

  function do_ajax_form_caja_event_arqueo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "arqueo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_event_arqueo_onchange_cb_after_alert);
  } // do_ajax_form_caja_event_arqueo_onchange_cb
  function do_ajax_form_caja_event_arqueo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_event_arqueo_onchange_cb_after_alert

  // ---------- Event onchange banco
  function do_ajax_form_caja_event_banco_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_event_banco_onchange(var_detalle, var_usuario, var_banco, var_script_case_init, do_ajax_form_caja_event_banco_onchange_cb);
  } // do_ajax_form_caja_event_banco_onchange

  function do_ajax_form_caja_event_banco_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "banco";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_event_banco_onchange_cb_after_alert);
  } // do_ajax_form_caja_event_banco_onchange_cb
  function do_ajax_form_caja_event_banco_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_event_banco_onchange_cb_after_alert

  // ---------- Event onchange cantidad
  function do_ajax_form_caja_event_cantidad_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_event_cantidad_onchange(var_detalle, var_cantidad, var_cierredia, var_script_case_init, do_ajax_form_caja_event_cantidad_onchange_cb);
  } // do_ajax_form_caja_event_cantidad_onchange

  function do_ajax_form_caja_event_cantidad_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_event_cantidad_onchange_cb_after_alert);
  } // do_ajax_form_caja_event_cantidad_onchange_cb
  function do_ajax_form_caja_event_cantidad_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_event_cantidad_onchange_cb_after_alert

  // ---------- Event onchange cierredia
  function do_ajax_form_caja_event_cierredia_onchange()
  {
    var var_cierredia = scAjaxGetFieldSelect("cierredia");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_event_cierredia_onchange(var_cierredia, var_script_case_init, do_ajax_form_caja_event_cierredia_onchange_cb);
  } // do_ajax_form_caja_event_cierredia_onchange

  function do_ajax_form_caja_event_cierredia_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cierredia";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_event_cierredia_onchange_cb_after_alert);
  } // do_ajax_form_caja_event_cierredia_onchange_cb
  function do_ajax_form_caja_event_cierredia_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_event_cierredia_onchange_cb_after_alert

  // ---------- Event onchange detalle
  function do_ajax_form_caja_event_detalle_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_banco = scAjaxGetFieldSelect("banco");
    var var_usuario = scAjaxGetFieldSelect("usuario");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_event_detalle_onchange(var_detalle, var_banco, var_usuario, var_cierredia, var_documento, var_cantidad, var_script_case_init, do_ajax_form_caja_event_detalle_onchange_cb);
  } // do_ajax_form_caja_event_detalle_onchange

  function do_ajax_form_caja_event_detalle_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "detalle";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_event_detalle_onchange_cb_after_alert);
  } // do_ajax_form_caja_event_detalle_onchange_cb
  function do_ajax_form_caja_event_detalle_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_event_detalle_onchange_cb_after_alert

  // ---------- Event onchange documento
  function do_ajax_form_caja_event_documento_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_documento = scAjaxGetFieldHidden("documento");
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_event_documento_onchange(var_detalle, var_documento, var_cantidad, var_script_case_init, do_ajax_form_caja_event_documento_onchange_cb);
  } // do_ajax_form_caja_event_documento_onchange

  function do_ajax_form_caja_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_event_documento_onchange_cb_after_alert);
  } // do_ajax_form_caja_event_documento_onchange_cb
  function do_ajax_form_caja_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_event_documento_onchange_cb_after_alert

  // ---------- Event onchange fecha
  function do_ajax_form_caja_event_fecha_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_event_fecha_onchange(var_detalle, var_script_case_init, do_ajax_form_caja_event_fecha_onchange_cb);
  } // do_ajax_form_caja_event_fecha_onchange

  function do_ajax_form_caja_event_fecha_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "fecha";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_event_fecha_onchange_cb_after_alert);
  } // do_ajax_form_caja_event_fecha_onchange_cb
  function do_ajax_form_caja_event_fecha_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_event_fecha_onchange_cb_after_alert

  // ---------- Event onchange usuario
  function do_ajax_form_caja_event_usuario_onchange()
  {
    var var_detalle = scAjaxGetFieldSelect("detalle");
    var var_usuario = scAjaxGetFieldSelect("usuario");
    var var_banco = scAjaxGetFieldSelect("banco");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_caja_event_usuario_onchange(var_detalle, var_usuario, var_banco, var_cierredia, var_documento, var_cantidad, var_script_case_init, do_ajax_form_caja_event_usuario_onchange_cb);
  } // do_ajax_form_caja_event_usuario_onchange

  function do_ajax_form_caja_event_usuario_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "usuario";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_caja_event_usuario_onchange_cb_after_alert);
  } // do_ajax_form_caja_event_usuario_onchange_cb
  function do_ajax_form_caja_event_usuario_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_caja_event_usuario_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_caja_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_caja_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_fecha = scAjaxGetFieldText("fecha");
    ...
    scAjaxProcOn();
    x_ajax_form_caja_submit_form(var_fecha, var_hora, var_detalle, var_banco, var_usuario, var_documento, var_cantidad, var_cierredia, var_idcaja, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_caja_submit_form_cb);
  } // do_ajax_form_caja_submit_form

  function do_ajax_form_caja_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_caja_submit_form_cb_after_alert);
  } // do_ajax_form_caja_submit_form_cb
  function do_ajax_form_caja_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_caja_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_caja_navigate_form()
  {
    perform_ajax_form_caja_navigate_form();
  }

  function perform_ajax_form_caja_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_caja_navigate_form(var_idcaja, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_caja_navigate_form_cb);
  } // do_ajax_form_caja_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_caja']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_caja_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_caja_navigate_form_cb_after_alert);
  } // do_ajax_form_caja_navigate_form_cb
  function do_ajax_form_caja_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_caja_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_caja_navigate_form_cb_after_alert
  function sc_hide_form_caja_form()
  {
