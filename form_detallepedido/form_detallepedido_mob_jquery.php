...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_iddet' + iSeqRow).bind('blur', function() { sc_form_detallepedido_iddet_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_detallepedido_iddet_onfocus(this, iSeqRow) });
  $('#id_sc_field_idpedid' + iSeqRow).bind('blur', function() { sc_form_detallepedido_idpedid_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_detallepedido_idpedid_onfocus(this, iSeqRow) });
  $('#id_sc_field_idpro' + iSeqRow).bind('blur', function() { sc_form_detallepedido_idpro_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_detallepedido_idpro_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_detallepedido_idpro_onfocus(this, iSeqRow) });
  $('#id_sc_field_unidadmayor' + iSeqRow).bind('blur', function() { sc_form_detallepedido_unidadmayor_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_detallepedido_unidadmayor_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_detallepedido_unidadmayor_onfocus(this, iSeqRow) });
  $('#id_sc_field_factor' + iSeqRow).bind('blur', function() { sc_form_detallepedido_factor_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_detallepedido_factor_onfocus(this, iSeqRow) });
  $('#id_sc_field_idbod' + iSeqRow).bind('blur', function() { sc_form_detallepedido_idbod_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_detallepedido_idbod_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_detallepedido_idbod_onfocus(this, iSeqRow) });
  $('#id_sc_field_costop' + iSeqRow).bind('blur', function() { sc_form_detallepedido_costop_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_detallepedido_costop_onfocus(this, iSeqRow) });
  $('#id_sc_field_cantidad' + iSeqRow).bind('blur', function() { sc_form_detallepedido_cantidad_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_detallepedido_cantidad_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_detallepedido_cantidad_onfocus(this, iSeqRow) });
  $('#id_sc_field_valorunit' + iSeqRow).bind('blur', function() { sc_form_detallepedido_valorunit_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_detallepedido_valorunit_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_detallepedido_valorunit_onfocus(this, iSeqRow) });
  $('#id_sc_field_valorpar' + iSeqRow).bind('blur', function() { sc_form_detallepedido_valorpar_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_detallepedido_valorpar_onfocus(this, iSeqRow) });
  $('#id_sc_field_iva' + iSeqRow).bind('blur', function() { sc_form_detallepedido_iva_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_detallepedido_iva_onfocus(this, iSeqRow) });
  $('#id_sc_field_descuento' + iSeqRow).bind('blur', function() { sc_form_detallepedido_descuento_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_detallepedido_descuento_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_form_detallepedido_adicional_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_detallepedido_adicional_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional1' + iSeqRow).bind('blur', function() { sc_form_detallepedido_adicional1_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_detallepedido_adicional1_onfocus(this, iSeqRow) });
  $('#id_sc_field_colores' + iSeqRow).bind('blur', function() { sc_form_detallepedido_colores_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_detallepedido_colores_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_detallepedido_colores_onfocus(this, iSeqRow) });
  $('#id_sc_field_tallas' + iSeqRow).bind('blur', function() { sc_form_detallepedido_tallas_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_detallepedido_tallas_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_detallepedido_tallas_onfocus(this, iSeqRow) });
  $('#id_sc_field_sabor' + iSeqRow).bind('blur', function() { sc_form_detallepedido_sabor_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_detallepedido_sabor_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_detallepedido_sabor_onfocus(this, iSeqRow) });
  $('#id_sc_field_estado_comanda' + iSeqRow).bind('blur', function() { sc_form_detallepedido_estado_comanda_onblur(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_detallepedido_estado_comanda_onfocus(this, iSeqRow) });
  $('#id_sc_field_obs' + iSeqRow).bind('blur', function() { sc_form_detallepedido_obs_onblur(this, iSeqRow) })
                                 .bind('focus', function() { sc_form_detallepedido_obs_onfocus(this, iSeqRow) });
  $('#id_sc_field_stockubica' + iSeqRow).bind('blur', function() { sc_form_detallepedido_stockubica_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_detallepedido_stockubica_onfocus(this, iSeqRow) });
  $('#id_sc_field_unidad' + iSeqRow).bind('blur', function() { sc_form_detallepedido_unidad_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_detallepedido_unidad_onfocus(this, iSeqRow) });
  $('#id_sc_field_descrip' + iSeqRow).bind('blur', function() { sc_form_detallepedido_descrip_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_detallepedido_descrip_onfocus(this, iSeqRow) });
  $('#id_sc_field_autorizarborrado' + iSeqRow).bind('blur', function() { sc_form_detallepedido_autorizarborrado_onblur(this, iSeqRow) })
                                              .bind('click', function() { sc_form_detallepedido_autorizarborrado_onclick(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_detallepedido_autorizarborrado_onfocus(this, iSeqRow) });
  $('.sc-ui-radio-autorizarborrado' + iSeqRow).on('click', function() { scMarkFormAsChanged(); });
} // scJQEventsAdd

function sc_form_detallepedido_iddet_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_iddet();
  scCssBlur(oThis);
}

function sc_form_detallepedido_iddet_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_idpedid_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_idpedid();
  scCssBlur(oThis);
}

function sc_form_detallepedido_idpedid_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_idpro_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_idpro();
  scCssBlur(oThis);
}

function sc_form_detallepedido_idpro_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_idpro_onchange();
}

function sc_form_detallepedido_idpro_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_detallepedido_unidadmayor_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_unidadmayor();
  scCssBlur(oThis);
}

function sc_form_detallepedido_unidadmayor_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_unidadmayor_onchange();
}

function sc_form_detallepedido_unidadmayor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_factor_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_factor();
  scCssBlur(oThis);
}

function sc_form_detallepedido_factor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_idbod_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_idbod();
  scCssBlur(oThis);
  do_ajax_form_detallepedido_mob_event_idbod_onblur();
}

function sc_form_detallepedido_idbod_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_idbod_onchange();
}

function sc_form_detallepedido_idbod_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_costop_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_costop();
  scCssBlur(oThis);
}

function sc_form_detallepedido_costop_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_cantidad_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_cantidad();
  scCssBlur(oThis);
  do_ajax_form_detallepedido_mob_event_cantidad_onblur();
}

function sc_form_detallepedido_cantidad_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_cantidad_onchange();
}

function sc_form_detallepedido_cantidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_form_detallepedido_mob_event_cantidad_onfocus();
}

function sc_form_detallepedido_valorunit_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_valorunit();
  scCssBlur(oThis);
}

function sc_form_detallepedido_valorunit_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_valorunit_onchange();
}

function sc_form_detallepedido_valorunit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_valorpar_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_valorpar();
  scCssBlur(oThis);
}

function sc_form_detallepedido_valorpar_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_iva();
  scCssBlur(oThis);
}

function sc_form_detallepedido_iva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_descuento_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_descuento();
  scCssBlur(oThis);
}

function sc_form_detallepedido_descuento_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_adicional_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_adicional();
  scCssBlur(oThis);
}

function sc_form_detallepedido_adicional_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_adicional1_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_adicional1();
  scCssBlur(oThis);
}

function sc_form_detallepedido_adicional1_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_colores_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_colores();
  scCssBlur(oThis);
}

function sc_form_detallepedido_colores_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_colores_onchange();
}

function sc_form_detallepedido_colores_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_tallas_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_tallas();
  scCssBlur(oThis);
}

function sc_form_detallepedido_tallas_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_tallas_onchange();
}

function sc_form_detallepedido_tallas_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_sabor_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_sabor();
  scCssBlur(oThis);
}

function sc_form_detallepedido_sabor_onchange(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_sabor_onchange();
}

function sc_form_detallepedido_sabor_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_estado_comanda_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_estado_comanda();
  scCssBlur(oThis);
}

function sc_form_detallepedido_estado_comanda_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_obs_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_obs();
  scCssBlur(oThis);
}

function sc_form_detallepedido_obs_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_stockubica_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_stockubica();
  scCssBlur(oThis);
}

function sc_form_detallepedido_stockubica_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_unidad_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_unidad();
  scCssBlur(oThis);
}

function sc_form_detallepedido_unidad_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_descrip_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_descrip();
  scCssBlur(oThis);
}

function sc_form_detallepedido_descrip_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_detallepedido_autorizarborrado_onblur(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_validate_autorizarborrado();
  scCssBlur(oThis);
}

function sc_form_detallepedido_autorizarborrado_onclick(oThis, iSeqRow) {
  do_ajax_form_detallepedido_mob_event_autorizarborrado_onclick();
}

function sc_form_detallepedido_autorizarborrado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_detallepedido_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_hora_inicio" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_detallepedido_mob_validate_hora_inicio(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_hora_final" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_detallepedido_mob_validate_hora_final(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_detallepedido_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
