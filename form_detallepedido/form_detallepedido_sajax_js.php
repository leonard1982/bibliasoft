  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallepedido" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallepedido_form();
	}
...
?>
  ...
  // ---------- Validate idpro_
  function do_ajax_form_detallepedido_validate_idpro_(iNumLinha)
  {
  } // do_ajax_form_detallepedido_validate_idpro_

  function do_ajax_form_detallepedido_validate_idpro__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_idpro__cb

  // ---------- Validate descrip_
  function do_ajax_form_detallepedido_validate_descrip_(iNumLinha)
  {
    var nomeCampo_descrip_ = "descrip_" + iNumLinha;
    var var_descrip_ = scAjaxGetFieldText(nomeCampo_descrip_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_descrip_(var_descrip_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_descrip__cb);
  } // do_ajax_form_detallepedido_validate_descrip_

  function do_ajax_form_detallepedido_validate_descrip__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_descrip__cb

  // ---------- Validate idbod_
  function do_ajax_form_detallepedido_validate_idbod_(iNumLinha)
  {
    var nomeCampo_idbod_ = "idbod_" + iNumLinha;
    var var_idbod_ = scAjaxGetFieldSelect(nomeCampo_idbod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_idbod_(var_idbod_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_idbod__cb);
  } // do_ajax_form_detallepedido_validate_idbod_

  function do_ajax_form_detallepedido_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_idbod__cb

  // ---------- Validate unidad_
  function do_ajax_form_detallepedido_validate_unidad_(iNumLinha)
  {
    var nomeCampo_unidad_ = "unidad_" + iNumLinha;
    var var_unidad_ = scAjaxGetFieldHidden(nomeCampo_unidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_unidad_(var_unidad_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_unidad__cb);
  } // do_ajax_form_detallepedido_validate_unidad_

  function do_ajax_form_detallepedido_validate_unidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_unidad__cb

  // ---------- Validate cantidad_
  function do_ajax_form_detallepedido_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_cantidad__cb);
  } // do_ajax_form_detallepedido_validate_cantidad_

  function do_ajax_form_detallepedido_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_cantidad__cb

  // ---------- Validate valorunit_
  function do_ajax_form_detallepedido_validate_valorunit_(iNumLinha)
  {
    var nomeCampo_valorunit_ = "valorunit_" + iNumLinha;
    var var_valorunit_ = scAjaxGetFieldText(nomeCampo_valorunit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_valorunit_(var_valorunit_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_valorunit__cb);
  } // do_ajax_form_detallepedido_validate_valorunit_

  function do_ajax_form_detallepedido_validate_valorunit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_valorunit__cb

  // ---------- Validate adicional_
  function do_ajax_form_detallepedido_validate_adicional_(iNumLinha)
  {
    var nomeCampo_adicional_ = "adicional_" + iNumLinha;
    var var_adicional_ = scAjaxGetFieldText(nomeCampo_adicional_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_adicional_(var_adicional_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_adicional__cb);
  } // do_ajax_form_detallepedido_validate_adicional_

  function do_ajax_form_detallepedido_validate_adicional__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_adicional__cb

  // ---------- Validate descuento_
  function do_ajax_form_detallepedido_validate_descuento_(iNumLinha)
  {
    var nomeCampo_descuento_ = "descuento_" + iNumLinha;
    var var_descuento_ = scAjaxGetFieldHidden(nomeCampo_descuento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_descuento_(var_descuento_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_descuento__cb);
  } // do_ajax_form_detallepedido_validate_descuento_

  function do_ajax_form_detallepedido_validate_descuento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_descuento__cb

  // ---------- Validate valorpar_
  function do_ajax_form_detallepedido_validate_valorpar_(iNumLinha)
  {
    var nomeCampo_valorpar_ = "valorpar_" + iNumLinha;
    var var_valorpar_ = scAjaxGetFieldHidden(nomeCampo_valorpar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_valorpar_(var_valorpar_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_valorpar__cb);
  } // do_ajax_form_detallepedido_validate_valorpar_

  function do_ajax_form_detallepedido_validate_valorpar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_valorpar__cb

  // ---------- Validate unidadmayor_
  function do_ajax_form_detallepedido_validate_unidadmayor_(iNumLinha)
  {
    var nomeCampo_unidadmayor_ = "unidadmayor_" + iNumLinha;
    var var_unidadmayor_ = scAjaxGetFieldSelect(nomeCampo_unidadmayor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_unidadmayor_(var_unidadmayor_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_unidadmayor__cb);
  } // do_ajax_form_detallepedido_validate_unidadmayor_

  function do_ajax_form_detallepedido_validate_unidadmayor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_unidadmayor__cb

  // ---------- Validate stockubica_
  function do_ajax_form_detallepedido_validate_stockubica_(iNumLinha)
  {
    var nomeCampo_stockubica_ = "stockubica_" + iNumLinha;
    var var_stockubica_ = scAjaxGetFieldHidden(nomeCampo_stockubica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_stockubica_(var_stockubica_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_stockubica__cb);
  } // do_ajax_form_detallepedido_validate_stockubica_

  function do_ajax_form_detallepedido_validate_stockubica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_stockubica__cb

  // ---------- Validate obs_
  function do_ajax_form_detallepedido_validate_obs_(iNumLinha)
  {
    var nomeCampo_obs_ = "obs_" + iNumLinha;
    var var_obs_ = scAjaxGetFieldText(nomeCampo_obs_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_obs_(var_obs_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_obs__cb);
  } // do_ajax_form_detallepedido_validate_obs_

  function do_ajax_form_detallepedido_validate_obs__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_obs__cb

  // ---------- Validate iddet_
  function do_ajax_form_detallepedido_validate_iddet_(iNumLinha)
  {
    var nomeCampo_iddet_ = "iddet_" + iNumLinha;
    var var_iddet_ = scAjaxGetFieldHidden(nomeCampo_iddet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_iddet_(var_iddet_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_iddet__cb);
  } // do_ajax_form_detallepedido_validate_iddet_

  function do_ajax_form_detallepedido_validate_iddet__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_iddet__cb

  // ---------- Validate colores_
  function do_ajax_form_detallepedido_validate_colores_(iNumLinha)
  {
    var nomeCampo_colores_ = "colores_" + iNumLinha;
    var var_colores_ = scAjaxGetFieldSelect(nomeCampo_colores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_colores_(var_colores_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_colores__cb);
  } // do_ajax_form_detallepedido_validate_colores_

  function do_ajax_form_detallepedido_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_form_detallepedido_validate_tallas_(iNumLinha)
  {
    var nomeCampo_tallas_ = "tallas_" + iNumLinha;
    var var_tallas_ = scAjaxGetFieldSelect(nomeCampo_tallas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_tallas_(var_tallas_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_tallas__cb);
  } // do_ajax_form_detallepedido_validate_tallas_

  function do_ajax_form_detallepedido_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_form_detallepedido_validate_sabor_(iNumLinha)
  {
    var nomeCampo_sabor_ = "sabor_" + iNumLinha;
    var var_sabor_ = scAjaxGetFieldSelect(nomeCampo_sabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_sabor_(var_sabor_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_sabor__cb);
  } // do_ajax_form_detallepedido_validate_sabor_

  function do_ajax_form_detallepedido_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_sabor__cb

  // ---------- Validate adicional1_
  function do_ajax_form_detallepedido_validate_adicional1_(iNumLinha)
  {
    var nomeCampo_adicional1_ = "adicional1_" + iNumLinha;
    var var_adicional1_ = scAjaxGetFieldText(nomeCampo_adicional1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_adicional1_(var_adicional1_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_adicional1__cb);
  } // do_ajax_form_detallepedido_validate_adicional1_

  function do_ajax_form_detallepedido_validate_adicional1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_adicional1__cb

  // ---------- Validate factor_
  function do_ajax_form_detallepedido_validate_factor_(iNumLinha)
  {
    var nomeCampo_factor_ = "factor_" + iNumLinha;
    var var_factor_ = scAjaxGetFieldText(nomeCampo_factor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_factor_(var_factor_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_factor__cb);
  } // do_ajax_form_detallepedido_validate_factor_

  function do_ajax_form_detallepedido_validate_factor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_factor__cb

  // ---------- Validate iva_
  function do_ajax_form_detallepedido_validate_iva_(iNumLinha)
  {
    var nomeCampo_iva_ = "iva_" + iNumLinha;
    var var_iva_ = scAjaxGetFieldHidden(nomeCampo_iva_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_iva_(var_iva_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_iva__cb);
  } // do_ajax_form_detallepedido_validate_iva_

  function do_ajax_form_detallepedido_validate_iva__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_iva__cb

  // ---------- Validate costop_
  function do_ajax_form_detallepedido_validate_costop_(iNumLinha)
  {
    var nomeCampo_costop_ = "costop_" + iNumLinha;
    var var_costop_ = scAjaxGetFieldText(nomeCampo_costop_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_costop_(var_costop_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_costop__cb);
  } // do_ajax_form_detallepedido_validate_costop_

  function do_ajax_form_detallepedido_validate_costop__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_costop__cb

  // ---------- Validate autorizarborrado_
  function do_ajax_form_detallepedido_validate_autorizarborrado_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_autorizarborrado_(var_autorizarborrado_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_autorizarborrado__cb);
  } // do_ajax_form_detallepedido_validate_autorizarborrado_

  function do_ajax_form_detallepedido_validate_autorizarborrado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_autorizarborrado__cb

  // ---------- Validate estado_comanda_
  function do_ajax_form_detallepedido_validate_estado_comanda_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_estado_comanda_(var_estado_comanda_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_estado_comanda__cb);
  } // do_ajax_form_detallepedido_validate_estado_comanda_

  function do_ajax_form_detallepedido_validate_estado_comanda__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_estado_comanda__cb

  // ---------- Validate idpedid_
  function do_ajax_form_detallepedido_validate_idpedid_(iNumLinha)
  {
    var nomeCampo_idpedid_ = "idpedid_" + iNumLinha;
    var var_idpedid_ = scAjaxGetFieldText(nomeCampo_idpedid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_validate_idpedid_(var_idpedid_, iNumLinha, var_script_case_init, do_ajax_form_detallepedido_validate_idpedid__cb);
  } // do_ajax_form_detallepedido_validate_idpedid_

  function do_ajax_form_detallepedido_validate_idpedid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_validate_idpedid__cb

  // ---------- Refresh idpro_
  function do_ajax_form_detallepedido_refresh_idpro_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_refresh_idpro_(var_idpro_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_detallepedido_refresh_idpro__cb);
  } // do_ajax_form_detallepedido_refresh_idpro_

  function do_ajax_form_detallepedido_refresh_idpro__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallepedido_refresh_idpro__cb

  // ---------- Event onchange adicional_
  function do_ajax_form_detallepedido_event_adicional__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_adicional__onchange(var_valorunit_, var_costop_, var_idpro_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_cantidad_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_adicional__onchange_cb);
  } // do_ajax_form_detallepedido_event_adicional__onchange

  function do_ajax_form_detallepedido_event_adicional__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_adicional__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_adicional__onchange_cb
  function do_ajax_form_detallepedido_event_adicional__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_adicional__onchange_cb_after_alert

  // ---------- Event onclick autorizarborrado_
  function do_ajax_form_detallepedido_event_autorizarborrado__onclick(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_autorizarborrado__onclick(var_idpro_, var_iddet_, var_estado_comanda_, var_idpedid_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_autorizarborrado__onclick_cb);
  } // do_ajax_form_detallepedido_event_autorizarborrado__onclick

  function do_ajax_form_detallepedido_event_autorizarborrado__onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_autorizarborrado__onclick_cb_after_alert);
  } // do_ajax_form_detallepedido_event_autorizarborrado__onclick_cb
  function do_ajax_form_detallepedido_event_autorizarborrado__onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_autorizarborrado__onclick_cb_after_alert

  // ---------- Event onblur cantidad_
  function do_ajax_form_detallepedido_event_cantidad__onblur(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_cantidad__onblur(var_idpro_, var_valorunit_, var_cantidad_, var_stockubica_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_idbod_, var_unidadmayor_, var_factor_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_cantidad__onblur_cb);
  } // do_ajax_form_detallepedido_event_cantidad__onblur

  function do_ajax_form_detallepedido_event_cantidad__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_cantidad__onblur_cb_after_alert);
  } // do_ajax_form_detallepedido_event_cantidad__onblur_cb
  function do_ajax_form_detallepedido_event_cantidad__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_cantidad__onblur_cb_after_alert

  // ---------- Event onchange cantidad_
  function do_ajax_form_detallepedido_event_cantidad__onchange(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_stockubica_ = scAjaxGetFieldHidden("stockubica_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_cantidad__onchange(var_cantidad_, var_stockubica_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_cantidad__onchange_cb);
  } // do_ajax_form_detallepedido_event_cantidad__onchange

  function do_ajax_form_detallepedido_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_cantidad__onchange_cb
  function do_ajax_form_detallepedido_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_cantidad__onchange_cb_after_alert

  // ---------- Event onfocus cantidad_
  function do_ajax_form_detallepedido_event_cantidad__onfocus(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_detallepedido_event_cantidad__onfocus(var_cantidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_cantidad__onfocus_cb);
  } // do_ajax_form_detallepedido_event_cantidad__onfocus

  function do_ajax_form_detallepedido_event_cantidad__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_cantidad__onfocus_cb_after_alert);
  } // do_ajax_form_detallepedido_event_cantidad__onfocus_cb
  function do_ajax_form_detallepedido_event_cantidad__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_cantidad__onfocus_cb_after_alert

  // ---------- Event onchange colores_
  function do_ajax_form_detallepedido_event_colores__onchange(iSeqForm)
  {
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_colores__onchange(var_colores_, var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_colores__onchange_cb);
  } // do_ajax_form_detallepedido_event_colores__onchange

  function do_ajax_form_detallepedido_event_colores__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_colores__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_colores__onchange_cb
  function do_ajax_form_detallepedido_event_colores__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_colores__onchange_cb_after_alert

  // ---------- Event onblur idbod_
  function do_ajax_form_detallepedido_event_idbod__onblur(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_unidadmayor_ = scAjaxGetFieldSelect("unidadmayor_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_idbod__onblur(var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_idbod__onblur_cb);
  } // do_ajax_form_detallepedido_event_idbod__onblur

  function do_ajax_form_detallepedido_event_idbod__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_idbod__onblur_cb_after_alert);
  } // do_ajax_form_detallepedido_event_idbod__onblur_cb
  function do_ajax_form_detallepedido_event_idbod__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_idbod__onblur_cb_after_alert

  // ---------- Event onchange idbod_
  function do_ajax_form_detallepedido_event_idbod__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    var var_unidadmayor_ = scAjaxGetFieldSelect("unidadmayor_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_idbod__onchange(var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_idbod__onchange_cb);
  } // do_ajax_form_detallepedido_event_idbod__onchange

  function do_ajax_form_detallepedido_event_idbod__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_idbod__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_idbod__onchange_cb
  function do_ajax_form_detallepedido_event_idbod__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_idbod__onchange_cb_after_alert

  // ---------- Event onchange idpro_
  function do_ajax_form_detallepedido_event_idpro__onchange(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_adicional_ = scAjaxGetFieldText("adicional_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_idpro__onchange(var_cantidad_, var_adicional_, var_idpro_, var_valorunit_, var_unidadmayor_, var_costop_, var_factor_, var_idbod_, var_adicional1_, var_descuento_, var_valorpar_, var_iva_, var_colores_, var_tallas_, var_sabor_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_idpro__onchange_cb);
  } // do_ajax_form_detallepedido_event_idpro__onchange

  function do_ajax_form_detallepedido_event_idpro__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_idpro__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_idpro__onchange_cb
  function do_ajax_form_detallepedido_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_detallepedido_refresh_idpro_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_idpro__onchange_cb_after_alert

  // ---------- Event onchange sabor_
  function do_ajax_form_detallepedido_event_sabor__onchange(iSeqForm)
  {
    var var_sabor_ = scAjaxGetFieldSelect("sabor_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_sabor__onchange(var_sabor_, var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_sabor__onchange_cb);
  } // do_ajax_form_detallepedido_event_sabor__onchange

  function do_ajax_form_detallepedido_event_sabor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_sabor__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_sabor__onchange_cb
  function do_ajax_form_detallepedido_event_sabor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_sabor__onchange_cb_after_alert

  // ---------- Event onchange tallas_
  function do_ajax_form_detallepedido_event_tallas__onchange(iSeqForm)
  {
    var var_tallas_ = scAjaxGetFieldSelect("tallas_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_idbod_ = scAjaxGetFieldSelect("idbod_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_tallas__onchange(var_tallas_, var_idpro_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_tallas__onchange_cb);
  } // do_ajax_form_detallepedido_event_tallas__onchange

  function do_ajax_form_detallepedido_event_tallas__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_tallas__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_tallas__onchange_cb
  function do_ajax_form_detallepedido_event_tallas__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_tallas__onchange_cb_after_alert

  // ---------- Event onchange unidadmayor_
  function do_ajax_form_detallepedido_event_unidadmayor__onchange(iSeqForm)
  {
    var var_unidadmayor_ = scAjaxGetFieldSelect("unidadmayor_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_unidadmayor__onchange(var_unidadmayor_, var_idpro_, var_valorunit_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_cantidad_, var_idbod_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_unidadmayor__onchange_cb);
  } // do_ajax_form_detallepedido_event_unidadmayor__onchange

  function do_ajax_form_detallepedido_event_unidadmayor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_unidadmayor__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_unidadmayor__onchange_cb
  function do_ajax_form_detallepedido_event_unidadmayor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_unidadmayor__onchange_cb_after_alert

  // ---------- Event onchange valorunit_
  function do_ajax_form_detallepedido_event_valorunit__onchange(iSeqForm)
  {
    var var_valorunit_ = scAjaxGetFieldText("valorunit_" + iSeqForm);
    var var_costop_ = scAjaxGetFieldText("costop_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_event_valorunit__onchange(var_valorunit_, var_costop_, var_idpro_, var_adicional1_, var_descuento_, var_valorpar_, var_adicional_, var_iva_, var_cantidad_, var_idbod_, var_unidadmayor_, var_factor_, var_stockubica_, var_unidad_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallepedido_event_valorunit__onchange_cb);
  } // do_ajax_form_detallepedido_event_valorunit__onchange

  function do_ajax_form_detallepedido_event_valorunit__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_event_valorunit__onchange_cb_after_alert);
  } // do_ajax_form_detallepedido_event_valorunit__onchange_cb
  function do_ajax_form_detallepedido_event_valorunit__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallepedido_event_valorunit__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallepedido_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallepedido_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallepedido_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallepedido_add_new_line_cb);
  } // do_ajax_form_detallepedido_add_new_line

  function do_ajax_form_detallepedido_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallepedido_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallepedido_backup_line(iNumLinha)
  {
    var var_iddet_ = scAjaxGetFieldHidden("iddet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallepedido_backup_line(var_iddet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallepedido_backup_line_cb);
  } // do_ajax_form_detallepedido_backup_line

  function do_ajax_form_detallepedido_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallepedido_backup_line_cb

  function do_ajax_form_detallepedido_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallepedido_cancel_insert

  function do_ajax_form_detallepedido_cancel_update(iSeqVert)
  {
    do_ajax_form_detallepedido_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallepedido_cancel_update

  function do_ajax_form_detallepedido_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallepedido_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallepedido_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepedido_table_refresh(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepedido_table_refresh_cb);
  } //  do_ajax_form_detallepedido_table_refresh

  function do_ajax_form_detallepedido_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_detallepedido_table_refresh_cb_after_alert);
  } // do_ajax_form_detallepedido_table_refresh_cb
  function do_ajax_form_detallepedido_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detallepedido_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallepedido_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallepedido_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_detallepedido_submit_form(var_idpro_, var_descrip_, var_idbod_, var_unidad_, var_cantidad_, var_valorunit_, var_adicional_, var_descuento_, var_valorpar_, var_unidadmayor_, var_stockubica_, var_obs_, var_iddet_, var_colores_, var_tallas_, var_sabor_, var_adicional1_, var_factor_, var_iva_, var_costop_, var_autorizarborrado_, var_estado_comanda_, var_idpedid_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detallepedido_submit_form_cb);
  } // do_ajax_form_detallepedido_submit_form

  function do_ajax_form_detallepedido_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallepedido_submit_form_cb_after_alert);
  } // do_ajax_form_detallepedido_submit_form_cb
  function do_ajax_form_detallepedido_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallepedido_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallepedido_navigate_form()
  {
    perform_ajax_form_detallepedido_navigate_form();
  }

  function perform_ajax_form_detallepedido_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallepedido_navigate_form(var_iddet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallepedido_navigate_form_cb);
  } // do_ajax_form_detallepedido_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallepedido']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallepedido_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallepedido_navigate_form_cb_after_alert);
  } // do_ajax_form_detallepedido_navigate_form_cb
  function do_ajax_form_detallepedido_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_detallepedido_navigate_form_cb_after_alert
  function sc_hide_form_detallepedido_form()
  {
