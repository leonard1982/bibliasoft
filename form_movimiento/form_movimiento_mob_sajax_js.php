  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_movimiento_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_movimiento_mob_form();
	}
  ...
  function do_ajax_form_movimiento_mob_validate_prefijonota()
  {
    var nomeCampo_prefijonota = "prefijonota";
    var var_prefijonota = scAjaxGetFieldSelect(nomeCampo_prefijonota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_mob_validate_prefijonota(var_prefijonota, var_script_case_init, do_ajax_form_movimiento_mob_validate_prefijonota_cb);
  } // do_ajax_form_movimiento_mob_validate_prefijonota

  function do_ajax_form_movimiento_mob_validate_prefijonota_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_validate_prefijonota_cb

  // ---------- Validate numeronota
  function do_ajax_form_movimiento_mob_validate_numeronota()
  {
    var nomeCampo_numeronota = "numeronota";
    var var_numeronota = scAjaxGetFieldText(nomeCampo_numeronota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_mob_validate_numeronota(var_numeronota, var_script_case_init, do_ajax_form_movimiento_mob_validate_numeronota_cb);
  } // do_ajax_form_movimiento_mob_validate_numeronota

  function do_ajax_form_movimiento_mob_validate_numeronota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_validate_numeronota_cb

  // ---------- Validate idtipotran
  function do_ajax_form_movimiento_mob_validate_idtipotran()
  {
    var nomeCampo_idtipotran = "idtipotran";
    var var_idtipotran = scAjaxGetFieldSelect(nomeCampo_idtipotran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_mob_validate_idtipotran(var_idtipotran, var_script_case_init, do_ajax_form_movimiento_mob_validate_idtipotran_cb);
  } // do_ajax_form_movimiento_mob_validate_idtipotran

  function do_ajax_form_movimiento_mob_validate_idtipotran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_validate_idtipotran_cb

  // ---------- Validate fecha
  function do_ajax_form_movimiento_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_movimiento_mob_validate_fecha_cb);
  } // do_ajax_form_movimiento_mob_validate_fecha

  function do_ajax_form_movimiento_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_validate_fecha_cb

  // ---------- Validate idbodorig
  function do_ajax_form_movimiento_mob_validate_idbodorig()
  {
    var nomeCampo_idbodorig = "idbodorig";
    var var_idbodorig = scAjaxGetFieldSelect(nomeCampo_idbodorig);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_mob_validate_idbodorig(var_idbodorig, var_script_case_init, do_ajax_form_movimiento_mob_validate_idbodorig_cb);
  } // do_ajax_form_movimiento_mob_validate_idbodorig

  function do_ajax_form_movimiento_mob_validate_idbodorig_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_validate_idbodorig_cb

  // ---------- Validate idboddes
  function do_ajax_form_movimiento_mob_validate_idboddes()
  {
    var nomeCampo_idboddes = "idboddes";
    var var_idboddes = scAjaxGetFieldSelect(nomeCampo_idboddes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_mob_validate_idboddes(var_idboddes, var_script_case_init, do_ajax_form_movimiento_mob_validate_idboddes_cb);
  } // do_ajax_form_movimiento_mob_validate_idboddes

  function do_ajax_form_movimiento_mob_validate_idboddes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_validate_idboddes_cb

  // ---------- Validate observaciones
  function do_ajax_form_movimiento_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_movimiento_mob_validate_observaciones_cb);
  } // do_ajax_form_movimiento_mob_validate_observaciones

  function do_ajax_form_movimiento_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_validate_observaciones_cb

  // ---------- Validate detalle
  function do_ajax_form_movimiento_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimiento_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_movimiento_mob_validate_detalle_cb);
  } // do_ajax_form_movimiento_mob_validate_detalle

  function do_ajax_form_movimiento_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_validate_detalle_cb

  // ---------- Refresh idbodorig
  function do_ajax_form_movimiento_mob_refresh_idbodorig()
  {
    var var_idbodorig = scAjaxGetFieldSelect("idbodorig");
    var var_nmgp_refresh_fields = "idboddes";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_movimiento_mob_refresh_idbodorig(var_idbodorig, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_movimiento_mob_refresh_idbodorig_cb);
  } // do_ajax_form_movimiento_mob_refresh_idbodorig

  function do_ajax_form_movimiento_mob_refresh_idbodorig_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimiento_mob_refresh_idbodorig_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_movimiento_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_movimiento_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_movimiento_mob_submit_form(var_prefijonota, var_numeronota, var_idtipotran, var_fecha, var_idbodorig, var_idboddes, var_observaciones, var_idmov, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_movimiento_mob_submit_form_cb);
  } // do_ajax_form_movimiento_mob_submit_form

  function do_ajax_form_movimiento_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_movimiento_mob_submit_form_cb_after_alert);
  } // do_ajax_form_movimiento_mob_submit_form_cb
  function do_ajax_form_movimiento_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_movimiento_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detallenotamov_mob"] = "off";

  function do_ajax_form_movimiento_mob_navigate_form()
  {
    perform_ajax_form_movimiento_mob_navigate_form();
  }

  function perform_ajax_form_movimiento_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_movimiento_mob_navigate_form(var_idmov, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_movimiento_mob_navigate_form_cb);
  } // do_ajax_form_movimiento_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movimiento_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_movimiento_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_movimiento_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_movimiento_mob_navigate_form_cb
  function do_ajax_form_movimiento_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('fecha');
...
{
?>
    do_ajax_form_movimiento_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_movimiento_mob_navigate_form_cb_after_alert
  function sc_hide_form_movimiento_mob_form()
  {
