  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallenota_convertir" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallenota_convertir_form();
	}
  ...
  // ---------- Validate id_detnc_
  function do_ajax_form_detallenota_convertir_validate_id_detnc_(iNumLinha)
  {
    var nomeCampo_id_detnc_ = "id_detnc_" + iNumLinha;
    var var_id_detnc_ = scAjaxGetFieldHidden(nomeCampo_id_detnc_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_id_detnc_(var_id_detnc_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_id_detnc__cb);
  } // do_ajax_form_detallenota_convertir_validate_id_detnc_

  function do_ajax_form_detallenota_convertir_validate_id_detnc__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_detnc_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_detnc_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_detnc_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_detnc_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_id_detnc__cb

  // ---------- Validate id_mov_
  function do_ajax_form_detallenota_convertir_validate_id_mov_(iNumLinha)
  {
    var nomeCampo_id_mov_ = "id_mov_" + iNumLinha;
    var var_id_mov_ = scAjaxGetFieldText(nomeCampo_id_mov_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_id_mov_(var_id_mov_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_id_mov__cb);
  } // do_ajax_form_detallenota_convertir_validate_id_mov_

  function do_ajax_form_detallenota_convertir_validate_id_mov__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_mov_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_mov_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_mov_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_mov_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_id_mov__cb

  // ---------- Validate id_prod_
  function do_ajax_form_detallenota_convertir_validate_id_prod_(iNumLinha)
  {
    var nomeCampo_id_prod_ = "id_prod_" + iNumLinha;
    var var_id_prod_ = scAjaxGetFieldSelect(nomeCampo_id_prod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_id_prod_(var_id_prod_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_id_prod__cb);
  } // do_ajax_form_detallenota_convertir_validate_id_prod_

  function do_ajax_form_detallenota_convertir_validate_id_prod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_prod_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_prod_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "id_prod_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_prod_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_id_prod__cb

  // ---------- Validate descripcion_
  function do_ajax_form_detallenota_convertir_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldSelect(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_descripcion__cb);
  } // do_ajax_form_detallenota_convertir_validate_descripcion_

  function do_ajax_form_detallenota_convertir_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_descripcion__cb

  // ---------- Validate origen_
  function do_ajax_form_detallenota_convertir_validate_origen_(iNumLinha)
  {
    var nomeCampo_origen_ = "origen_" + iNumLinha;
    var var_origen_ = scAjaxGetFieldText(nomeCampo_origen_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_origen_(var_origen_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_origen__cb);
  } // do_ajax_form_detallenota_convertir_validate_origen_

  function do_ajax_form_detallenota_convertir_validate_origen__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_origen__cb

  // ---------- Validate destino_
  function do_ajax_form_detallenota_convertir_validate_destino_(iNumLinha)
  {
    var nomeCampo_destino_ = "destino_" + iNumLinha;
    var var_destino_ = scAjaxGetFieldText(nomeCampo_destino_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_destino_(var_destino_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_destino__cb);
  } // do_ajax_form_detallenota_convertir_validate_destino_

  function do_ajax_form_detallenota_convertir_validate_destino__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_destino__cb

  // ---------- Validate stock_
  function do_ajax_form_detallenota_convertir_validate_stock_(iNumLinha)
  {
    var nomeCampo_stock_ = "stock_" + iNumLinha;
    var var_stock_ = scAjaxGetFieldHidden(nomeCampo_stock_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_stock_(var_stock_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_stock__cb);
  } // do_ajax_form_detallenota_convertir_validate_stock_

  function do_ajax_form_detallenota_convertir_validate_stock__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_stock__cb

  // ---------- Validate cantidad_
  function do_ajax_form_detallenota_convertir_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_cantidad__cb);
  } // do_ajax_form_detallenota_convertir_validate_cantidad_

  function do_ajax_form_detallenota_convertir_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_cantidad__cb

  // ---------- Validate escala_
  function do_ajax_form_detallenota_convertir_validate_escala_(iNumLinha)
  {
    var nomeCampo_escala_ = "escala_" + iNumLinha;
    var var_escala_ = scAjaxGetFieldText(nomeCampo_escala_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_escala_(var_escala_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_escala__cb);
  } // do_ajax_form_detallenota_convertir_validate_escala_

  function do_ajax_form_detallenota_convertir_validate_escala__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "escala_" + iLineNumber;
    }
    else
    {
      sFieldValid = "escala_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "escala_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "escala_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_escala__cb

  // ---------- Validate costo_
  function do_ajax_form_detallenota_convertir_validate_costo_(iNumLinha)
  {
    var nomeCampo_costo_ = "costo_" + iNumLinha;
    var var_costo_ = scAjaxGetFieldText(nomeCampo_costo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_validate_costo_(var_costo_, iNumLinha, var_script_case_init, do_ajax_form_detallenota_convertir_validate_costo__cb);
  } // do_ajax_form_detallenota_convertir_validate_costo_

  function do_ajax_form_detallenota_convertir_validate_costo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenota_convertir_validate_costo__cb

  // ---------- Event onchange descripcion_
  function do_ajax_form_detallenota_convertir_event_descripcion__onchange(iSeqForm)
  {
    var var_id_prod_ = scAjaxGetFieldSelect("id_prod_" + iSeqForm);
    var var_descripcion_ = scAjaxGetFieldSelect("descripcion_" + iSeqForm);
    ...
    scAjaxProcOn(true);
    x_ajax_form_detallenota_convertir_event_descripcion__onchange(var_id_prod_, var_descripcion_, var_costo_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenota_convertir_event_descripcion__onchange_cb);
  } // do_ajax_form_detallenota_convertir_event_descripcion__onchange

  function do_ajax_form_detallenota_convertir_event_descripcion__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenota_convertir_event_descripcion__onchange_cb_after_alert);
  } // do_ajax_form_detallenota_convertir_event_descripcion__onchange_cb
  function do_ajax_form_detallenota_convertir_event_descripcion__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenota_convertir_event_descripcion__onchange_cb_after_alert

  // ---------- Event onchange id_prod_
  function do_ajax_form_detallenota_convertir_event_id_prod__onchange(iSeqForm)
  {
    var var_id_prod_ = scAjaxGetFieldSelect("id_prod_" + iSeqForm);
    var var_descripcion_ = scAjaxGetFieldSelect("descripcion_" + iSeqForm);
    var var_costo_ = scAjaxGetFieldText("costo_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenota_convertir_event_id_prod__onchange(var_id_prod_, var_descripcion_, var_costo_, var_stock_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenota_convertir_event_id_prod__onchange_cb);
  } // do_ajax_form_detallenota_convertir_event_id_prod__onchange

  function do_ajax_form_detallenota_convertir_event_id_prod__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenota_convertir_event_id_prod__onchange_cb_after_alert);
  } // do_ajax_form_detallenota_convertir_event_id_prod__onchange_cb
  function do_ajax_form_detallenota_convertir_event_id_prod__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenota_convertir_event_id_prod__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallenota_convertir_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallenota_convertir_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallenota_convertir_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallenota_convertir_add_new_line_cb);
  } // do_ajax_form_detallenota_convertir_add_new_line

  function do_ajax_form_detallenota_convertir_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallenota_convertir_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallenota_convertir_backup_line(iNumLinha)
  {
    var var_id_detnc_ = scAjaxGetFieldHidden("id_detnc_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenota_convertir_backup_line(var_id_detnc_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallenota_convertir_backup_line_cb);
  } // do_ajax_form_detallenota_convertir_backup_line

  function do_ajax_form_detallenota_convertir_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallenota_convertir_backup_line_cb

  function do_ajax_form_detallenota_convertir_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallenota_convertir_cancel_insert

  function do_ajax_form_detallenota_convertir_cancel_update(iSeqVert)
  {
    do_ajax_form_detallenota_convertir_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallenota_convertir_cancel_update

  function do_ajax_form_detallenota_convertir_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallenota_convertir_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallenota_convertir_table_refresh()
  {
    var var_id_detnc_ = document.F2.id_detnc_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallenota_convertir_table_refresh(var_id_detnc_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallenota_convertir_table_refresh_cb);
  } //  do_ajax_form_detallenota_convertir_table_refresh

  function do_ajax_form_detallenota_convertir_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_detnc_.value = scAjaxGetKeyValue("id_detnc_");
    ...
    scAjaxAlert(do_ajax_form_detallenota_convertir_table_refresh_cb_after_alert);
  } // do_ajax_form_detallenota_convertir_table_refresh_cb
  function do_ajax_form_detallenota_convertir_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detallenota_convertir_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallenota_convertir_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallenota_convertir_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_detnc_ = scAjaxGetFieldHidden("id_detnc_" + iNumLinha);
    var var_id_mov_ = scAjaxGetFieldText("id_mov_" + iNumLinha);
    var var_id_prod_ = scAjaxGetFieldSelect("id_prod_" + iNumLinha);
    var var_descripcion_ = scAjaxGetFieldSelect("descripcion_" + iNumLinha);
    ...
    var var_escala_ = scAjaxGetFieldText("escala_" + iNumLinha);
...
?>
    x_ajax_form_detallenota_convertir_submit_form(var_id_detnc_, var_id_mov_, var_id_prod_, var_descripcion_, var_origen_, var_destino_, var_stock_, var_cantidad_, var_escala_, var_costo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detallenota_convertir_submit_form_cb);
  } // do_ajax_form_detallenota_convertir_submit_form

  function do_ajax_form_detallenota_convertir_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_detnc_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_mov_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("id_prod_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("escala_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenota_convertir_submit_form_cb_after_alert);
  } // do_ajax_form_detallenota_convertir_submit_form_cb
  function do_ajax_form_detallenota_convertir_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallenota_convertir_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallenota_convertir_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_detallenota_convertir_navigate_form, function() {});
    } else {
      perform_ajax_form_detallenota_convertir_navigate_form();
    }
  }

  function perform_ajax_form_detallenota_convertir_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    {
      scAjaxHideErrorDisplay("id_detnc_" + iNavForm);
      scAjaxHideErrorDisplay("id_mov_" + iNavForm);
      scAjaxHideErrorDisplay("id_prod_" + iNavForm);
      ...
      scAjaxHideErrorDisplay("escala_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallenota_convertir_navigate_form(var_id_detnc_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallenota_convertir_navigate_form_cb);
  } // do_ajax_form_detallenota_convertir_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallenota_convertir']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallenota_convertir_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_detnc_.value = scAjaxGetKeyValue("id_detnc_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallenota_convertir_navigate_form_cb_after_alert);
  } // do_ajax_form_detallenota_convertir_navigate_form_cb
  function do_ajax_form_detallenota_convertir_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_detallenota_convertir_navigate_form_cb_after_alert
  function sc_hide_form_detallenota_convertir_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_detnc_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_mov_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_prod_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "escala_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "costo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_detnc_" + iNumLinha] = {"label": "Id Detnc<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_mov_" + iNumLinha] = {"label": "Id Mov<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["id_prod_" + iNumLinha] = {"label": "Código P.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["stock_" + iNumLinha] = {"label": "Stock<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["escala_" + iNumLinha] = {"label": "Escala<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_detnc_"][iNumLinha] = "id_detnc_" + iNumLinha;
    ajax_field_mult["id_mov_"][iNumLinha] = "id_mov_" + iNumLinha;
    ajax_field_mult["id_prod_"][iNumLinha] = "id_prod_" + iNumLinha;
    ...
    ajax_field_mult["escala_"][iNumLinha] = "escala_" + iNumLinha;
    ajax_field_mult["costo_"][iNumLinha] = "costo_" + iNumLinha;
    ajax_field_id["id_prod_" + iNumLinha] = new Array("hidden_field_label_id_prod_", "hidden_field_data_id_prod_" + iNumLinha);
    ...
    ajax_field_id["escala_" + iNumLinha] = new Array("hidden_field_label_escala_", "hidden_field_data_escala_" + iNumLinha);
    ajax_field_id["costo_" + iNumLinha] = new Array("hidden_field_label_costo_", "hidden_field_data_costo_" + iNumLinha);
    ajax_error_count["id_detnc_" + iNumLinha] = "off";
    ajax_error_count["id_mov_" + iNumLinha] = "off";
    ajax_error_count["id_prod_" + iNumLinha] = "off";
    ...
    ajax_error_count["escala_" + iNumLinha] = "off";
    ajax_error_count["costo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_detnc_" + iNumLinha] = "on";
    ajax_read_only["id_mov_" + iNumLinha] = "on";
    ajax_read_only["id_prod_" + iNumLinha] = "off";
    ...
    ajax_read_only["escala_" + iNumLinha] = "off";
...
?>
    ajax_read_only["id_detnc_" + iNumLinha] = "on";
    ajax_read_only["id_mov_" + iNumLinha] = "on";
    ajax_read_only["id_prod_" + iNumLinha] = "on";
    ...
    ajax_read_only["escala_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_detnc_" + iNumLinha] = null;
    ajax_error_list["id_mov_" + iNumLinha] = null;
    ajax_error_list["id_prod_" + iNumLinha] = null;
    ...
    ajax_error_list["escala_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_detnc_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_detnc_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_detnc_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_detnc_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_detnc_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_mov_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_mov_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_mov_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_mov_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_mov_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["id_prod_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_prod_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_prod_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_prod_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_prod_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["escala_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["escala_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["escala_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["escala_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["escala_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_detnc_'])) ? $this->nmgp_cmp_readonly['id_detnc_'] : 'on';
?>
    scAjaxFieldRead("id_detnc_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_mov_'])) ? $this->nmgp_cmp_readonly['id_mov_'] : 'on';
?>
    scAjaxFieldRead("id_mov_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_prod_'])) ? $this->nmgp_cmp_readonly['id_prod_'] : 'off';
?>
    scAjaxFieldRead("id_prod_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['escala_'])) ? $this->nmgp_cmp_readonly['escala_'] : 'off';
?>
    scAjaxFieldRead("escala_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("id_detnc_" + iSeq, "on");
    scAjaxFieldRead("id_mov_" + iSeq, "on");
    scAjaxFieldRead("id_prod_" + iSeq, "on");
    ...
    scAjaxFieldRead("escala_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_detnc_" + iRow] || "on" == ajax_error_count["id_mov_" + iRow] || "on" == ajax_error_count["id_prod_" + iRow] || "on" == ajax_error_count["descripcion_" + iRow] || "on" == ajax_error_count["origen_" + iRow] || "on" == ajax_error_count["destino_" + iRow] || "on" == ajax_error_count["stock_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["escala_" + iRow] || "on" == ajax_error_count["costo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_detnc_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_mov_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_prod_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_origen_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_escala_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_detnc_" + iRow] && "off" == ajax_error_count["id_mov_" + iRow] && "off" == ajax_error_count["id_prod_" + iRow] && "off" == ajax_error_count["descripcion_" + iRow] && "off" == ajax_error_count["origen_" + iRow] && "off" == ajax_error_count["destino_" + iRow] && "off" == ajax_error_count["stock_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["escala_" + iRow] && "off" == ajax_error_count["costo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_detnc_" + iRow] = "off";
        ajax_error_count["id_mov_" + iRow] = "off";
        ajax_error_count["id_prod_" + iRow] = "off";
        ...
        ajax_error_count["escala_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_detnc_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_mov_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_id_prod_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_descripcion_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_origen_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_escala_" + iRow).removeClass("scFormErrorLine");
