...
class grid_caja_lista_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_total_geral'] == "OK")
      {
          ...
          $this->array_total_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['arr_total']['usuario'];
      }
      else
      {
          $this->array_total_fecha = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechayusuario']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechayusuario'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechayusuario'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechayusuario'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechayusuario'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechayusuario'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechayusuario'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechayusuario'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechayusuario'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechayusuario'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_fecha as $i_fecha => $d_fecha) {
           ...
           foreach ($this->array_total_usuario[$i_fecha] as $i_usuario => $d_usuario) {
               if (!in_array($i_usuario, $this->comp_label[1][ $d_fecha[4] ], true)) {
                   $this->comp_index[1][ $d_usuario[4] ] = $d_usuario[3];
                   $this->comp_label[1][ $d_fecha[4] ][ $d_usuario[4] ] = $d_usuario[3];
               }
           }
       }
       ...
       foreach ($this->comp_label[0] as $i_fecha => $l_fecha) {
           ...
           foreach ($this->comp_label[1][$i_fecha] as $i_usuario => $l_usuario) {
               if (isset($this->array_total_usuario[$i_fecha][$i_usuario])) {
                   $this->comp_group[$i_fecha][$i_usuario] = array();
               }
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fechayusuario("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $quebra_fecha, $quebra_usuario, $quebra_fecha_orig, $quebra_usuario_orig)
   {
      ...
      //----- Usuario
      if (!isset($this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig]))
      {
         $this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig][0] = 1;
         $this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig][1] = $sum_cantidad;
         $this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig][2] = 1;
         $this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig][3] = $quebra_usuario;
         $this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig][4] = $quebra_usuario_orig;
      }
      else
      {
         $this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig][0]++;
         $this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig][1] += $sum_cantidad;
         $this->array_total_usuario[$quebra_fecha_orig][$quebra_usuario_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->fecha, $this->usuario, $this->fecha_orig,  $this->usuario_orig);
            }
   }
//
