<?php
   include_once('grid_caja_lista_session.php');
   session_start();
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_caja_lista"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_caja_lista"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_caja'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_caja_lista']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_caja_lista' || $achou)
          {
