...
class grid_caja_lista_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_total_geral'] == "OK")
      {
          ...
          $this->array_total_detalle = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['arr_total']['detalle'];
      }
      else
      {
          $this->array_total_fecha = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechaydetalle']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechaydetalle'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechaydetalle'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaydetalle'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaydetalle'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaydetalle'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaydetalle'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaydetalle'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaydetalle'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaydetalle'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_fecha as $i_fecha => $d_fecha) {
           ...
           foreach ($this->array_total_detalle[$i_fecha] as $i_detalle => $d_detalle) {
               if (!in_array($i_detalle, $this->comp_label[1][ $d_fecha[4] ], true)) {
                   $this->comp_index[1][ $d_detalle[4] ] = $d_detalle[3];
                   $this->comp_label[1][ $d_fecha[4] ][ $d_detalle[4] ] = $d_detalle[3];
               }
           }
       }
       ...
       foreach ($this->comp_label[0] as $i_fecha => $l_fecha) {
           ...
           foreach ($this->comp_label[1][$i_fecha] as $i_detalle => $l_detalle) {
               if (isset($this->array_total_detalle[$i_fecha][$i_detalle])) {
                   $this->comp_group[$i_fecha][$i_detalle] = array();
               }
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fechaydetalle("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $quebra_fecha, $quebra_detalle, $quebra_fecha_orig, $quebra_detalle_orig)
   {
      ...
      //----- Detalle
      if (!isset($this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig]))
      {
         $this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig][0] = 1;
         $this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig][1] = $sum_cantidad;
         $this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig][2] = 1;
         $this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig][3] = $quebra_detalle;
         $this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig][4] = $quebra_detalle_orig;
      }
      else
      {
         $this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig][0]++;
         $this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig][1] += $sum_cantidad;
         $this->array_total_detalle[$quebra_fecha_orig][$quebra_detalle_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->fecha, $this->detalle, $this->fecha_orig,  $this->detalle_orig);
            }
   }
//
