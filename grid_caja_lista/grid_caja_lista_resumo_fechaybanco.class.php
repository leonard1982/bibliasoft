...
class grid_caja_lista_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['arr_total']['fecha'];
          $this->array_total_banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['arr_total']['banco'];
      }
      else
      {
          $this->array_total_fecha = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechaybanco']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechaybanco'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_order']['fechaybanco'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaybanco'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaybanco'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaybanco'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaybanco'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaybanco'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaybanco'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['summarizing_fields_display']['fechaybanco'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_fecha as $i_fecha => $d_fecha) {
           ...
           foreach ($this->array_total_banco[$i_fecha] as $i_banco => $d_banco) {
               if (!in_array($i_banco, $this->comp_label[1][ $d_fecha[4] ], true)) {
                   $this->comp_index[1][ $d_banco[4] ] = $d_banco[3];
                   $this->comp_label[1][ $d_fecha[4] ][ $d_banco[4] ] = $d_banco[3];
               }
           }
       }
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['pivot_order_level'] = -1;
       }
       ...
       foreach ($this->comp_label[0] as $i_fecha => $l_fecha) {
           ...
           foreach ($this->comp_label[1][$i_fecha] as $i_banco => $l_banco) {
               if (isset($this->array_total_banco[$i_fecha][$i_banco])) {
                   $this->comp_group[$i_fecha][$i_banco] = array();
               }
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_fechaybanco("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $quebra_fecha, $quebra_banco, $quebra_fecha_orig, $quebra_banco_orig)
   {
      ...
      //----- Banco
      if (!isset($this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig]))
      {
         $this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig][0] = 1;
         $this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig][1] = $sum_cantidad;
         $this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig][2] = 1;
         $this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig][3] = $quebra_banco;
         $this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig][4] = $quebra_banco_orig;
      }
      else
      {
         $this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig][0]++;
         $this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig][1] += $sum_cantidad;
         $this->array_total_banco[$quebra_fecha_orig][$quebra_banco_orig][2]++;
      }
   }
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $Format_tst = $this->Ini->Get_Gb_date_format('fechaybanco', 'fecha');
            $Prefix_dat = $this->Ini->Get_Gb_prefix_date_format('fechaybanco', 'fecha');
            ...
            nmgp_Form_Num_Val($this->cantidad, "", "", "", "", "", "", "V::", "") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->fecha, $this->banco, $this->fecha_orig,  $this->banco_orig);
            }
   }
//
