...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['fecha']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['fecha']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['fecha'];
      }
      $this->label[1] = "Usuario";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['usuario']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['usuario']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['usuario'];
      }
   }
