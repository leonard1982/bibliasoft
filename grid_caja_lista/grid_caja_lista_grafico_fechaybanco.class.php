...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label[1] = "Banco";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['banco']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['banco']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_lista']['contr_label_graf']['banco'];
      }
   }
