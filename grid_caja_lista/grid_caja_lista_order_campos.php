...
<?php
   ...
   $Ord_Cmp = new grid_caja_lista_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_caja_lista_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_seq[10] = "idcaja";
   $tab_labels["idcaja"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["idcaja"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["idcaja"] : "Id";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_def_seq[20] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['hora'] = "on";
   $tab_def_campos['hora'] = "hora";
   $tab_def_seq[160] = "hora";
   $tab_labels["hora"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["hora"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["hora"] : "Hora";
   $tab_ger_campos['detalle'] = "on";
   $tab_def_campos['detalle'] = "detalle";
   $tab_def_seq[40] = "detalle";
   $tab_labels["detalle"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["detalle"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["detalle"] : "Detalle";
   $tab_ger_campos['banco'] = "on";
   $tab_def_campos['banco'] = "banco";
   $tab_def_seq[190] = "banco";
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["banco"] : "Banco";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_def_seq[200] = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_def_seq[60] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['labels']["cantidad"] : "Cantidad";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caja_lista']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['ordem_select'] = array();
   }
...
function Sel_processa_out_regr($sel_regra)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['ordem_grid']   = "";
   ...
   foreach ($regras_ord as $cada_regra)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_caja_lista']['ordem_select'][$tab_def_seq[$seq]] = $ordem;
       }
   }
?>
    <script language="javascript"> 
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_caja_lista_order_campos.php",
    data: {
   ...
   <table class="<?php echo ($embbed)? '':'scGridTabela'; ?>" style="border-width: 0; border-collapse: collapse; width:100%;" cellspacing=0 cellpadding=0>
    ...
    <td>
     <select  name="sel_regra" id="id_sel_regra_sel_ord" size=1 class="scAppDivToolbarInput">
       <OPTION value=""></OPTION>
       <OPTION value="-;20;fecha">Fecha/Banco</OPTION>
    </select>
<?php
   if (!$embbed)
   {
