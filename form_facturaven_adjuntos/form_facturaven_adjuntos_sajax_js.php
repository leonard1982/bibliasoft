  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_facturaven_adjuntos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_facturaven_adjuntos_form();
	}
...
?>
  ...
  // ---------- Validate id_
  function do_ajax_form_facturaven_adjuntos_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_adjuntos_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_adjuntos_validate_id__cb);
  } // do_ajax_form_facturaven_adjuntos_validate_id_

  function do_ajax_form_facturaven_adjuntos_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_adjuntos_validate_id__cb

  // ---------- Validate idfacven_
  function do_ajax_form_facturaven_adjuntos_validate_idfacven_(iNumLinha)
  {
    var nomeCampo_idfacven_ = "idfacven_" + iNumLinha;
    var var_idfacven_ = scAjaxGetFieldText(nomeCampo_idfacven_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_adjuntos_validate_idfacven_(var_idfacven_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_adjuntos_validate_idfacven__cb);
  } // do_ajax_form_facturaven_adjuntos_validate_idfacven_

  function do_ajax_form_facturaven_adjuntos_validate_idfacven__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idfacven_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idfacven_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idfacven_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idfacven_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_adjuntos_validate_idfacven__cb

  // ---------- Validate adjunto_
  function do_ajax_form_facturaven_adjuntos_validate_adjunto_(iNumLinha)
  {
    var nomeCampo_adjunto_ = "adjunto_" + iNumLinha;
    var var_adjunto_ = scAjaxGetFieldText(nomeCampo_adjunto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_adjuntos_validate_adjunto_(var_adjunto_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_adjuntos_validate_adjunto__cb);
  } // do_ajax_form_facturaven_adjuntos_validate_adjunto_

  function do_ajax_form_facturaven_adjuntos_validate_adjunto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_adjuntos_validate_adjunto__cb

  // ---------- Validate creado_
  function do_ajax_form_facturaven_adjuntos_validate_creado_(iNumLinha)
  {
    var nomeCampo_creado_ = "creado_" + iNumLinha;
    var var_creado_ = scAjaxGetFieldHidden(nomeCampo_creado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_adjuntos_validate_creado_(var_creado_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_adjuntos_validate_creado__cb);
  } // do_ajax_form_facturaven_adjuntos_validate_creado_

  function do_ajax_form_facturaven_adjuntos_validate_creado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_adjuntos_validate_creado__cb

  // ---------- Validate actualizado_
  function do_ajax_form_facturaven_adjuntos_validate_actualizado_(iNumLinha)
  {
    var nomeCampo_actualizado_ = "actualizado_" + iNumLinha;
    var var_actualizado_ = scAjaxGetFieldHidden(nomeCampo_actualizado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_adjuntos_validate_actualizado_(var_actualizado_, iNumLinha, var_script_case_init, do_ajax_form_facturaven_adjuntos_validate_actualizado__cb);
  } // do_ajax_form_facturaven_adjuntos_validate_actualizado_

  function do_ajax_form_facturaven_adjuntos_validate_actualizado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "actualizado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "actualizado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "actualizado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "actualizado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_facturaven_adjuntos_validate_actualizado__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_facturaven_adjuntos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_facturaven_adjuntos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_facturaven_adjuntos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_facturaven_adjuntos_add_new_line_cb);
  } // do_ajax_form_facturaven_adjuntos_add_new_line

  function do_ajax_form_facturaven_adjuntos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_facturaven_adjuntos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_facturaven_adjuntos_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_facturaven_adjuntos_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_facturaven_adjuntos_backup_line_cb);
  } // do_ajax_form_facturaven_adjuntos_backup_line

  function do_ajax_form_facturaven_adjuntos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_facturaven_adjuntos_backup_line_cb

  function do_ajax_form_facturaven_adjuntos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_facturaven_adjuntos_cancel_insert

  function do_ajax_form_facturaven_adjuntos_cancel_update(iSeqVert)
  {
    do_ajax_form_facturaven_adjuntos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_facturaven_adjuntos_cancel_update

  function do_ajax_form_facturaven_adjuntos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_facturaven_adjuntos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_facturaven_adjuntos_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_facturaven_adjuntos_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_adjuntos_table_refresh_cb);
  } //  do_ajax_form_facturaven_adjuntos_table_refresh

  function do_ajax_form_facturaven_adjuntos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_facturaven_adjuntos_table_refresh_cb_after_alert);
  } // do_ajax_form_facturaven_adjuntos_table_refresh_cb
  function do_ajax_form_facturaven_adjuntos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_facturaven_adjuntos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_facturaven_adjuntos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_facturaven_adjuntos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_idfacven_ = scAjaxGetFieldText("idfacven_" + iNumLinha);
    var var_adjunto_ = scAjaxGetFieldText("adjunto_" + iNumLinha);
    var var_creado_ = scAjaxGetFieldHidden("creado_" + iNumLinha);
    var var_actualizado_ = scAjaxGetFieldHidden("actualizado_" + iNumLinha);
...
?>
    x_ajax_form_facturaven_adjuntos_submit_form(var_id_, var_idfacven_, var_adjunto_, var_creado_, var_actualizado_, var_adjunto__ul_name, var_adjunto__ul_type, var_adjunto__salva, var_adjunto__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_facturaven_adjuntos_submit_form_cb);
  } // do_ajax_form_facturaven_adjuntos_submit_form

  function do_ajax_form_facturaven_adjuntos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idfacven_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("adjunto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("creado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("actualizado_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_facturaven_adjuntos_submit_form_cb_after_alert);
  } // do_ajax_form_facturaven_adjuntos_submit_form_cb
  function do_ajax_form_facturaven_adjuntos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_facturaven_adjuntos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_facturaven_adjuntos_navigate_form()
  {
    perform_ajax_form_facturaven_adjuntos_navigate_form();
  }

  function perform_ajax_form_facturaven_adjuntos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_facturaven_adjuntos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idfacven_" + iNavForm);
      scAjaxHideErrorDisplay("adjunto_" + iNavForm);
      scAjaxHideErrorDisplay("creado_" + iNavForm);
      scAjaxHideErrorDisplay("actualizado_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_facturaven_adjuntos_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_facturaven_adjuntos_navigate_form_cb);
  } // do_ajax_form_facturaven_adjuntos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_facturaven_adjuntos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_facturaven_adjuntos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_facturaven_adjuntos_navigate_form_cb_after_alert);
  } // do_ajax_form_facturaven_adjuntos_navigate_form_cb
  function do_ajax_form_facturaven_adjuntos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_facturaven_adjuntos_navigate_form_cb_after_alert
  function sc_hide_form_facturaven_adjuntos_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idfacven_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "adjunto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "creado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "actualizado_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["idfacven_" + iNumLinha] = {"label": "Idfacven<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["creado_" + iNumLinha] = {"label": "Subido<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["actualizado_" + iNumLinha] = {"label": "Actualizado<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["idfacven_"][iNumLinha] = "idfacven_" + iNumLinha;
    ajax_field_mult["adjunto_"][iNumLinha] = "adjunto_" + iNumLinha;
    ajax_field_mult["creado_"][iNumLinha] = "creado_" + iNumLinha;
    ajax_field_mult["actualizado_"][iNumLinha] = "actualizado_" + iNumLinha;
    ajax_field_id["adjunto_" + iNumLinha] = new Array("hidden_field_label_adjunto_", "hidden_field_data_adjunto_" + iNumLinha);
    ajax_field_id["creado_" + iNumLinha] = new Array("hidden_field_label_creado_", "hidden_field_data_creado_" + iNumLinha);
    ajax_field_id["actualizado_" + iNumLinha] = new Array("hidden_field_label_actualizado_", "hidden_field_data_actualizado_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["idfacven_" + iNumLinha] = "off";
    ajax_error_count["adjunto_" + iNumLinha] = "off";
    ajax_error_count["creado_" + iNumLinha] = "off";
    ajax_error_count["actualizado_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["idfacven_" + iNumLinha] = "off";
    ajax_read_only["adjunto_" + iNumLinha] = "off";
    ajax_read_only["creado_" + iNumLinha] = "off";
    ajax_read_only["actualizado_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["idfacven_" + iNumLinha] = "on";
    ajax_read_only["adjunto_" + iNumLinha] = "on";
    ajax_read_only["creado_" + iNumLinha] = "on";
    ajax_read_only["actualizado_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idfacven_" + iNumLinha] = null;
    ajax_error_list["adjunto_" + iNumLinha] = null;
    ajax_error_list["creado_" + iNumLinha] = null;
    ajax_error_list["actualizado_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idfacven_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idfacven_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idfacven_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idfacven_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idfacven_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["actualizado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["actualizado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["actualizado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["actualizado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["actualizado_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idfacven_'])) ? $this->nmgp_cmp_readonly['idfacven_'] : 'off';
?>
    scAjaxFieldRead("idfacven_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['actualizado_'])) ? $this->nmgp_cmp_readonly['actualizado_'] : 'off';
?>
    scAjaxFieldRead("actualizado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("idfacven_" + iSeq, "on");
    scAjaxFieldRead("adjunto_" + iSeq, "on");
    scAjaxFieldRead("creado_" + iSeq, "on");
    scAjaxFieldRead("actualizado_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["idfacven_" + iRow] || "on" == ajax_error_count["adjunto_" + iRow] || "on" == ajax_error_count["creado_" + iRow] || "on" == ajax_error_count["actualizado_" + iRow]))
    {
      ...
      $("#hidden_field_data_idfacven_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_adjunto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_creado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_actualizado_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["idfacven_" + iRow] && "off" == ajax_error_count["adjunto_" + iRow] && "off" == ajax_error_count["creado_" + iRow] && "off" == ajax_error_count["actualizado_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["idfacven_" + iRow] = "off";
        ajax_error_count["adjunto_" + iRow] = "off";
        ajax_error_count["creado_" + iRow] = "off";
        ajax_error_count["actualizado_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idfacven_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_adjunto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_creado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_actualizado_" + iRow).removeClass("scFormErrorLine");
    }
  }
