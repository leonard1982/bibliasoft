<div id="form_productos_form1" style='<?php echo ($this->tabCssClass["form_productos_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php } else { ?>
<span id="id_read_off_imagen" class="css_read_off_imagen<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_imagen; ?>"><span style="display:none"><span id="sc-id-upload-select-imagen" class="fileinput-button fileinput-button-padding scButton_default">
...
<div id="id_sc_dragdrop_imagen" class="scFormDataDragNDrop"  style="<?php echo $sStyleReadInp_imagen ?>cursor:pointer" onclick="$('#id_sc_field_imagen').click()"><i class='fas fa-upload'></i><br/>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pucaux_inventario_label" id="hidden_field_label_id_pucaux_inventario" style="<?php echo $sStyleHidden_id_pucaux_inventario; ?>"><span id="id_label_id_pucaux_inventario"><?php echo $this->nm_new_label['id_pucaux_inventario']; ?></span></TD>
    <TD class="scFormDataOdd css_id_pucaux_inventario_line" id="hidden_field_data_id_pucaux_inventario" style="<?php echo $sStyleHidden_id_pucaux_inventario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pucaux_inventario_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_inventario*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       ...
       $Md5_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_inventario*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pucaux_ncc_label" id="hidden_field_label_id_pucaux_ncc" style="<?php echo $sStyleHidden_id_pucaux_ncc; ?>"><span id="id_label_id_pucaux_ncc"><?php echo $this->nm_new_label['id_pucaux_ncc']; ?></span></TD>
    <TD class="scFormDataOdd css_id_pucaux_ncc_line" id="hidden_field_data_id_pucaux_ncc" style="<?php echo $sStyleHidden_id_pucaux_ncc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pucaux_ncc_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_ncc*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_ncc*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pucaux_ndc_label" id="hidden_field_label_id_pucaux_ndc" style="<?php echo $sStyleHidden_id_pucaux_ndc; ?>"><span id="id_label_id_pucaux_ndc"><?php echo $this->nm_new_label['id_pucaux_ndc']; ?></span></TD>
    <TD class="scFormDataOdd css_id_pucaux_ndc_line" id="hidden_field_data_id_pucaux_ndc" style="<?php echo $sStyleHidden_id_pucaux_ndc; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pucaux_ndc_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_ndc*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_ndc*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pucaux_ingresos_label" id="hidden_field_label_id_pucaux_ingresos" style="<?php echo $sStyleHidden_id_pucaux_ingresos; ?>"><span id="id_label_id_pucaux_ingresos"><?php echo $this->nm_new_label['id_pucaux_ingresos']; ?></span></TD>
    <TD class="scFormDataOdd css_id_pucaux_ingresos_line" id="hidden_field_data_id_pucaux_ingresos" style="<?php echo $sStyleHidden_id_pucaux_ingresos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pucaux_ingresos_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_ingresos*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_ingresos*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_nc*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_nc*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_nd*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_nd*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_pucaux_costoventas_label" id="hidden_field_label_id_pucaux_costoventas" style="<?php echo $sStyleHidden_id_pucaux_costoventas; ?>"><span id="id_label_id_pucaux_costoventas"><?php echo $this->nm_new_label['id_pucaux_costoventas']; ?></span></TD>
    <TD class="scFormDataOdd css_id_pucaux_costoventas_line" id="hidden_field_data_id_pucaux_costoventas" style="<?php echo $sStyleHidden_id_pucaux_costoventas; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_pucaux_costoventas_line" style="vertical-align: top;padding: 0px">
...
<?php
   ...
   echo "\r" ; 
   if (isset($this->Ini->sc_lig_md5["form_puc_auxiliares"]) && $this->Ini->sc_lig_md5["form_puc_auxiliares"] == "S") {
       $Parms_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_costoventas*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "gidcta*scin0*scoutnm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_pucaux_costoventas*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_marca"]) && $this->Ini->sc_lig_md5["form_marca"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_marca*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_marca*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php
   ...
   if (isset($this->Ini->sc_lig_md5["form_linea"]) && $this->Ini->sc_lig_md5["form_linea"] == "S") {
       $Parms_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_linea*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_productos@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nm_evt_ret_edit*scindo_ajax_form_productos_lkpedt_refresh_id_linea*scoutnmgp_url_saida*scin*scoutsc_redir_atualiz*scinok*scout";
   }
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lookup_para_registro_fe'][] = 'SI'; ?>
 <option  value="NO" <?php  if ($this->para_registro_fe == "NO") { echo " selected" ;} ?>>NO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['Lookup_para_registro_fe'][] = 'NO'; ?>
 </select></span>
</span><?php  }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['birpara']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['birpara']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['birpara']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['birpara']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['birpara'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['btn_label']['last'];
        }
?>
...
<script> 
<?php
 $NM_pag_atual = "form_productos_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_productos_form" . $this->nmgp_ancora;
 }
?>
<?php
