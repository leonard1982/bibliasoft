...
function sc_form_productos_para_registro_fe_onblur(oThis, iSeqRow) {
  do_ajax_form_productos_mob_validate_para_registro_fe();
  scCssBlur(oThis);
}
...
function sc_form_productos_id_pucaux_inventario_onblur(oThis, iSeqRow) {
  do_ajax_form_productos_mob_validate_id_pucaux_inventario();
  scCssBlur(oThis);
}
...
function sc_form_productos_id_pucaux_ncc_onblur(oThis, iSeqRow) {
  do_ajax_form_productos_mob_validate_id_pucaux_ncc();
  scCssBlur(oThis);
}
...
function sc_form_productos_id_pucaux_ndc_onblur(oThis, iSeqRow) {
  do_ajax_form_productos_mob_validate_id_pucaux_ndc();
  scCssBlur(oThis);
}
...
function sc_form_productos_id_pucaux_ingresos_onblur(oThis, iSeqRow) {
  do_ajax_form_productos_mob_validate_id_pucaux_ingresos();
  scCssBlur(oThis);
}
...
function sc_form_productos_id_pucaux_nc_onblur(oThis, iSeqRow) {
  do_ajax_form_productos_mob_validate_id_pucaux_nc();
  scCssBlur(oThis);
}
...
function sc_form_productos_id_pucaux_nd_onblur(oThis, iSeqRow) {
  do_ajax_form_productos_mob_validate_id_pucaux_nd();
  scCssBlur(oThis);
}
...
function sc_form_productos_id_pucaux_costoventas_onblur(oThis, iSeqRow) {
  do_ajax_form_productos_mob_validate_id_pucaux_costoventas();
  scCssBlur(oThis);
}
