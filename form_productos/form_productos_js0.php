...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
{
    NovaJanela = window.open ("form_productos_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
{
    document.getElementById('form_productos_form0').style.width='1px';
    document.getElementById('form_productos_form0').style.height='0px';
    document.getElementById('form_productos_form0').style.display='none';
    document.getElementById('form_productos_form0').style.overflow='scroll';
    document.getElementById('form_productos_form1').style.width='1px';
    document.getElementById('form_productos_form1').style.height='0px';
    document.getElementById('form_productos_form1').style.display='none';
    document.getElementById('form_productos_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_productos']['pdf_view']) {
?>
