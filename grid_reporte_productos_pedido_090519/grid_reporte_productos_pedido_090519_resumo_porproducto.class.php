...
class grid_reporte_productos_pedido_090519_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['arr_total']['producto'];
      }
      else
      {
          $this->array_total_producto = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['arr_total']['producto'] = $this->array_total_producto;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['labels']['producto'] = $Lab_producto; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_order']['porproducto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_order']['porproducto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_order']['porproducto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porproducto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porproducto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porproducto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porproducto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porproducto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porproducto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porproducto'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_producto as $i_producto => $d_producto) {
           if (!in_array($i_producto, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_producto[6] ] = $d_producto[5];
               $this->comp_label[0][ $d_producto[6] ] = $d_producto[5];
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_porproducto("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_d_cantidad, $sum_costo_parcial, $sum_total, $quebra_producto, $quebra_producto_orig)
   {
      //----- Producto
      if (!isset($this->array_total_producto[$quebra_producto_orig]))
      {
         ...
         $this->array_total_producto[$quebra_producto_orig][2] = $sum_costo_parcial;
         $this->array_total_producto[$quebra_producto_orig][3] = $sum_total;
         $this->array_total_producto[$quebra_producto_orig][4] = 1;
         $this->array_total_producto[$quebra_producto_orig][5] = $quebra_producto;
         $this->array_total_producto[$quebra_producto_orig][6] = $quebra_producto_orig;
      }
      else
      {
         ...
         $this->array_total_producto[$quebra_producto_orig][2] += $sum_costo_parcial;
         $this->array_total_producto[$quebra_producto_orig][3] += $sum_total;
         $this->array_total_producto[$quebra_producto_orig][4]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = $this->Ini->Get_date_order_groupby("s.nompro", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->d_cantidad, $this->costo_parcial, $this->total, $this->producto, $this->producto_orig);
            }
   }
//
