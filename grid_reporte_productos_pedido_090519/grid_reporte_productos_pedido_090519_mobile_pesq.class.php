...
class grid_reporte_productos_pedido_090519_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_reporte_productos_pedido_090519_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_reporte_productos_pedido_090519_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_reporte_productos_pedido_090519_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_cliente($cliente)
   {
      ...
      $nm_comando = "select distinct t.nombres from " . $this->Ini->nm_tabela . " where p.tipo_doc='PV' and p.asentada='1' and  t.nombres like '%" . $cliente . "%' order by t.nombres"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_producto($producto)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct s.nompro from " . $this->Ini->nm_tabela . " where p.tipo_doc='PV' and p.asentada='1' and  s.nompro like '%" . $producto . "%' order by s.nompro"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "P.fechaven";$Nm_datas[] = "P_fechaven";$Nm_numeric[] = "d_cantidad";$Nm_numeric[] = "d_costop";$Nm_numeric[] = "(d_cantidad*d_costop)";$Nm_numeric[] = "d_valorpar";$Nm_numeric[] = "s_idgrup";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "P.fechaven";$Nm_datas[] = "P_fechaven";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Reporte Productos Pedido</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_reporte_productos_pedido_090519/grid_reporte_productos_pedido_090519_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_reporte_productos_pedido_090519_ajax_search.js"></script>
 <script type="text/javascript" src="grid_reporte_productos_pedido_090519_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_reporte_productos_pedido_090519_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_reporte_productos_pedido_090519']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_reporte_productos_pedido_090519']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Reporte Productos Pedido</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_reporte_productos_pedido_090519", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_cond']; 
          $numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['numero']; 
          $numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['numero_cond']; 
          $cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['cliente']; 
          $cliente_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['cliente_cond']; 
          $producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['producto']; 
          $producto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['producto_cond']; 
          $inicio_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_dia']; 
          $inicio_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_mes']; 
          $inicio_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_ano']; 
          $inicio_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_hor']; 
          $inicio_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_min']; 
          $inicio_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_seg']; 
          $inicio_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_cond']; 
          $fin_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_dia']; 
          $fin_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_mes']; 
          $fin_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_ano']; 
          $fin_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_hor']; 
          $fin_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_min']; 
          $fin_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_seg']; 
          $fin_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['NM_operador']; 
      } 
...
?>
      ...
      <INPUT type="hidden" id="SC_numero_cond" name="numero_cond" value="qp">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_numero"  <?php echo $str_hide_numero?>><INPUT  type="text" id="SC_numero" name="numero" value="<?php echo NM_encode_input($numero) ?>"  size=50 alt="{datatype: 'text', maxLength: 93, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_cliente"  <?php echo $str_hide_cliente?>><?php
      ...
      $cliente_look = substr($this->Db->qstr($cliente), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct t.nombres from " . $this->Ini->nm_tabela . " where p.tipo_doc='PV' and p.asentada='1' and t.nombres = '$cliente_look' order by t.nombres"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_cliente" name="cliente" value="<?php echo NM_encode_input($cliente) ?>"  size=50 alt="{datatype: 'text', maxLength: 360, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cliente" id="id_ac_cliente" name="cliente_autocomp"><?php if ('' !=  $cliente) { ?><option value="<?php echo $cliente ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <INPUT type="hidden" id="SC_producto_cond" name="producto_cond" value="qp">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_producto"  <?php echo $str_hide_producto?>><?php
      if ($producto != "")
      {
      $producto_look = substr($this->Db->qstr($producto), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct s.nompro from " . $this->Ini->nm_tabela . " where p.tipo_doc='PV' and p.asentada='1' and s.nompro = '$producto_look' order by s.nompro"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_producto" name="producto" value="<?php echo NM_encode_input($producto) ?>"  size=50 alt="{datatype: 'text', maxLength: 150, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-producto" id="id_ac_producto" name="producto_autocomp"><?php if ('' !=  $producto) { ?><option value="<?php echo $producto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
    ...
    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['fin'])) ? $this->New_label['fin'] : "Creado Fin";
...
<?php
   if (is_file("grid_reporte_productos_pedido_090519_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['sc_modal'])
       {
?>
...
<?php
   ...
   {
?>
          <?php echo nmButtonOutput($this->arr_buttons, "blimpar", "limpa_form();", "limpa_form();", "limpa_frm_bot", "", "Limpiar Busqueda", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
?>
<?php
   }
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.numero_cond.value = 'qp';
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_mes(this)});
    $('#SC_fin_dia').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_dia(this)});
    $('#SC_fin_hor').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_hora(this)});
    $('#SC_fin_mes').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_mes(this)});
    $('#SC_fin_min').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_min(this)});
    $('#SC_fin_seg').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_seg(this)});
    $('#SC_inicio_dia').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_dia(this)});
    $('#SC_inicio_hor').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_hora(this)});
    $('#SC_inicio_mes').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_mes(this)});
    $('#SC_inicio_min').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_min(this)});
    $('#SC_inicio_seg').bind('change', function() {sc_grid_reporte_productos_pedido_090519_valida_seg(this)});
 }
 function sc_grid_reporte_productos_pedido_090519_valida_dia(obj)
 {
 ...
 function sc_grid_reporte_productos_pedido_090519_valida_mes(obj)
 {
 ...
 function sc_grid_reporte_productos_pedido_090519_valida_hora(obj)
 {
 ...
 function sc_grid_reporte_productos_pedido_090519_valida_min(obj)
 {
 ...
 function sc_grid_reporte_productos_pedido_090519_valida_seg(obj)
 {
     if (obj.value != "" && (obj.value < 0 || obj.value > 59))
     {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_reporte_productos_pedido_090519";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_reporte_productos_pedido_090519/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      global $fecha_cond, $fecha, $fecha_dia, $fecha_mes, $fecha_ano, $fecha_input_2_dia, $fecha_input_2_mes, $fecha_input_2_ano,
             ...
             $producto_cond, $producto, $producto_autocomp,
             $inicio_cond, $inicio, $inicio_dia, $inicio_mes, $inicio_ano, $inicio_hor, $inicio_min, $inicio_seg,
             $fin_cond, $fin, $fin_dia, $fin_mes, $fin_ano, $fin_hor, $fin_min, $fin_seg, $nmgp_tab_label;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['numero'] = $numero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['numero_cond'] = $numero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['cliente'] = $cliente; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['cliente_cond'] = $cliente_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['producto'] = $producto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['producto_cond'] = $producto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_dia'] = $inicio_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_mes'] = $inicio_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_ano'] = $inicio_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_hor'] = $inicio_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_min'] = $inicio_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_seg'] = $inicio_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_cond'] = $inicio_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_dia'] = $fin_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_mes'] = $fin_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_ano'] = $fin_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_hor'] = $fin_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_min'] = $fin_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_seg'] = $fin_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_cond'] = $fin_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($producto != '') {
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fecha_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("P.fechaven", $fecha_cond, $fecha, $fecha_input_2, 'fecha', 'DATE');
          }
      }
      ...
      {
         $this->monta_condicao("concat(r.prefijo,' ',p.numpedido)", $numero_cond, $numero, "", "numero");
      }
      ...
      {
         $this->monta_condicao("t.nombres", $cliente_cond, $cliente, "", "cliente");
      }
      ...
      {
         $this->monta_condicao("s.nompro", $producto_cond, $producto, "", "producto");
      }
      ...
      if ($inicio_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio'] = $val[0];
          ...
          if ($inicio_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['inicio_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("p.fechadocu", $inicio_cond, $inicio, $inicio_input_2, 'inicio', 'TIMESTAMP');
          }
      }
      ...
      if ($fin_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin'] = $val[0];
          ...
          if ($fin_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']['fin_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("p.fechadocu", $fin_cond, $fin, $fin_input_2, 'fin', 'TIMESTAMP');
          }
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['where_pesq'];
