<?php
   include_once('grid_reporte_productos_pedido_090519_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_reporte_productos_pedido_090519']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_reporte_productos_pedido_090519']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_reporte_productos_pedido_090519']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_reporte_productos_pedido_090519']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new grid_reporte_productos_pedido_090519_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_reporte_productos_pedido_090519_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   {
       include_once("grid_reporte_productos_pedido_090519_json.php");
   }
   $this->Arr_result   = array();
   $this->static_gb_ok = "";
   
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['fecha'] = array('cmp' => "P.fechaven", 'ind' => 0, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['numero'] = array('cmp' => "concat(r.prefijo,' ',p.numpedido)", 'ind' => 1, 'format' => "");
           $tab_arr_groubby_cmp['cliente'] = array('cmp' => "t.nombres", 'ind' => 2, 'format' => "");
           $tab_arr_groubby_cmp['producto'] = array('cmp' => "s.nompro", 'ind' => 3, 'format' => "");
           $tab_arr_groubby_cmp['grupo'] = array('cmp' => "s.idgrup", 'ind' => 4, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "P.fechaven", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "concat(r.prefijo,' ',p.numpedido)", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "t.nombres", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "s.nompro", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "s.idgrup", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['numero'] = "Numero";
   $arr_campos_free['cliente'] = "Cliente";
   $arr_campos_free['producto'] = "Producto";
   $arr_campos_free['grupo'] = "Grupo";
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_reporte_productos_pedido_090519_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
<?php
    ...
    $iTabCount            = 1;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Groupby_hide']))
        {
...
<?php
     if (!in_array("porproducto", $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Groupby_hide']))
     {
         $this->static_gb_ok = "sc_id_sel_groupby_porproducto";
        if ($groupby_atual == "porproducto")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porproducto";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porproducto");display_btn_restore_gb();' name="sel_groupby" value="porproducto" id="sc_id_sel_groupby_porproducto"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porproducto">
        Por Producto
<?php
    $prep_labels = array();
    $prep_labels[] = "Producto";
?>
        <span>
...
?>
<?php
     if (!in_array("porcliente", $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Groupby_hide']))
     {
        if ($opc_ret != "resumo")
        {
...
?>
<?php
     if (!in_array("porpedido", $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "porpedido")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porpedido";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porpedido");display_btn_restore_gb();' name="sel_groupby" value="porpedido" id="sc_id_sel_groupby_porpedido"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porpedido">
        Por Pedido
<?php
    $prep_labels = array();
    $prep_labels[] = "Numero";
...
?>
<?php
     if (!in_array("porfecha", $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "porfecha")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porfecha";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porfecha");display_btn_restore_gb();' name="sel_groupby" value="porfecha" id="sc_id_sel_groupby_porfecha"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porfecha">
        Por Fecha
<?php
    $prep_labels = array();
    $prep_labels[] = "Fecha";
...
?>
<?php
     if (!in_array("porgrupo", $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "porgrupo")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porgrupo";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porgrupo");display_btn_restore_gb();' name="sel_groupby" value="porgrupo" id="sc_id_sel_groupby_porgrupo"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porgrupo">
        Por Grupo/Familia
<?php
    $prep_labels = array();
    $prep_labels[] = "Grupo";
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido_090519'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
