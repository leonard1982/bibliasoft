...
class grid_reporte_productos_pedido_090519_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_grupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['arr_total']['grupo'];
      }
      else
      {
          $this->array_total_grupo = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['arr_total']['grupo'] = $this->array_total_grupo;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['labels']['grupo'] = $Lab_grupo; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_order']['porgrupo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_order']['porgrupo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_order']['porgrupo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porgrupo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porgrupo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porgrupo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porgrupo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porgrupo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porgrupo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido_090519']['summarizing_fields_display']['porgrupo'] as $i_sum => $d_sum)
           {
