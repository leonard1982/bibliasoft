...
class form_detalleprod_apl
{
   ...
   var $form_vert_form_detalleprod = array();
...
//----- 
   function ini_controle()
   {
      ...
      $this->sc_conv_var['numproducc'] = "numproducc_";
      ...
      if (isset($this->gPar_numero) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['gPar_numero'] = $this->gPar_numero;
      }
      if (isset($this->gEdit_cantidad) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['gEdit_cantidad'] = $this->gEdit_cantidad;
      }
      if (isset($this->sw_1) && isset($this->NM_contr_var_session) && $this->NM_contr_var_session == "Yes") 
      {
          $_SESSION['sw_1'] = $this->sw_1;
      }
      if (isset($_POST["gPar_numero"]) && isset($this->gPar_numero)) 
      {
          $_SESSION['gPar_numero'] = $this->gPar_numero;
      }
      ...
      if (isset($_POST["gEdit_cantidad"]) && isset($this->gEdit_cantidad)) 
      {
          $_SESSION['gEdit_cantidad'] = $this->gEdit_cantidad;
      }
      ...
      if (isset($_POST["sw_1"]) && isset($this->sw_1)) 
      {
          $_SESSION['sw_1'] = $this->sw_1;
      }
      if (isset($_GET["gPar_numero"]) && isset($this->gPar_numero)) 
      {
          $_SESSION['gPar_numero'] = $this->gPar_numero;
      }
      ...
      if (isset($_GET["gEdit_cantidad"]) && isset($this->gEdit_cantidad)) 
      {
          $_SESSION['gEdit_cantidad'] = $this->gEdit_cantidad;
      }
      ...
      if (isset($_GET["sw_1"]) && isset($this->sw_1)) 
      {
          $_SESSION['sw_1'] = $this->sw_1;
      }
      ...
      { 
          ...
          if (!isset($this->gPar_numero) && isset($this->gpar_numero)) 
          {
              $this->gPar_numero = $this->gpar_numero;
          }
          if (isset($this->gPar_numero)) 
          {
              $_SESSION['gPar_numero'] = $this->gPar_numero;
          }
          if (!isset($this->gEdit_cantidad) && isset($this->gedit_cantidad)) 
          {
              $this->gEdit_cantidad = $this->gedit_cantidad;
          }
          if (isset($this->gEdit_cantidad)) 
          {
              $_SESSION['gEdit_cantidad'] = $this->gEdit_cantidad;
          }
          if (isset($this->sw_1)) 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_detalleprod']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (!isset($this->gPar_numero) && isset($this->gpar_numero)) 
          {
              $this->gPar_numero = $this->gpar_numero;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_detalleprod']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_detalleprod']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_detalleprod_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_detalleprod']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detalleprod']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_detalleprod'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleprod']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleprod']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_detalleprod') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_detalleprod']['label'] = "Traslado de Materia Prima a Producción";
      ...
      $_SESSION['scriptcase']['error_icon']['form_detalleprod']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_detalleprod'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_orig'] = " where numproducc=" . $_SESSION['gPar_numero'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_pesq'] = " where numproducc=" . $_SESSION['gPar_numero'] . "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_detalleprod']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detalleprod'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_detalleprod'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field . "_"] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field . "_"] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field . "_"] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['exit'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_detalleprod", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_detalleprod_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_detalleprod_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_detalleprod/form_detalleprod_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_detalleprod_erro.class.php"); 
      }
      $this->Erro      = new form_detalleprod_erro();
      $this->Erro->Ini = $this->Ini;
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_max_reg']) && strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_max_reg']) == "all")
      {
      ...
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opcao']))
         { 
             if ($this->iddet_ != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_evento = $this->nmgp_opcao;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_detalleprod']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_detalleprod']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
   ...
   function loadFieldConfig()
   {
      ...
      //-- idpro_
      $this->field_config['idpro_']               = array();
      $this->field_config['idpro_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['idpro_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['idpro_']['symbol_dec'] = '';
      $this->field_config['idpro_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['idpro_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- stock_
      ...
      $this->field_config['factor_']['symbol_grp'] = $_SESSION['scriptcase']['reg_conf']['grup_num'];
      $this->field_config['factor_']['symbol_fmt'] = $_SESSION['scriptcase']['reg_conf']['num_group_digit'];
      $this->field_config['factor_']['symbol_dec'] = $_SESSION['scriptcase']['reg_conf']['dec_num'];
      $this->field_config['factor_']['symbol_neg'] = $_SESSION['scriptcase']['reg_conf']['simb_neg'];
      $this->field_config['factor_']['format_neg'] = $_SESSION['scriptcase']['reg_conf']['neg_num'];
      //-- cantidad_
      ...
      $this->field_config['costop_']['symbol_mon'] = $_SESSION['scriptcase']['reg_conf']['monet_simb'];
   ...
   function controle()
   {
      ...
      if ($this->nmgp_opcao == "change_qtd_line")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_max_reg'] = $this->nmgp_max_line;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opc_edit'] = true;  
      ...
      if ($this->NM_ajax_flag && 'submit_form' == $this->NM_ajax_opcao)
      {
         ...
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_form'][$sc_seq_vert]))
         {
             $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_form'][$sc_seq_vert];
             $this->numproducc_ = $this->nmgp_dados_form['numproducc_']; 
         ...
         if ($Campos_Crit != "" || !empty($Campos_Falta) || $this->Campos_Mens_erro != "")
         {
             $this->NM_rollback_db();
              if ($this->NM_ajax_flag)
              {
                  if (!isset($this->NM_ajax_info['errList']['geral_form_detalleprod']) || !is_array($this->NM_ajax_info['errList']['geral_form_detalleprod']))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleprod'] = array();
                  }
                  if ($Campos_Crit != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleprod'][] = $Campos_Crit;
                  }
                  if (!empty($Campos_Falta))
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleprod'][] = $this->Formata_Campos_Falta($Campos_Falta);
                  }
                  if ($this->Campos_Mens_erro != "")
                  {
                      $this->NM_ajax_info['errList']['geral_form_detalleprod'][] = $this->Campos_Mens_erro;
                  }
              }
         }
         else
         ...
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_redir_atualiz'] == "ok")
          {
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idpro_']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idpro_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idpro_']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idpro_'] = array(); 
    }

   $old_value_idpro_ = $this->idpro_;
   ...
   $unformatted_value_idpro_ = $this->idpro_;
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_detalleprod_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_detalleprod_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idpro_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      { 
         ...
         { 
             $GLOBALS["idpro_" . $sc_seq_vert] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['idpro_'];
         } 
         ...
         if (isset($this->tallas_)) { $this->nm_limpa_alfa($this->tallas_); }
         if (isset($this->sabor_)) { $this->nm_limpa_alfa($this->sabor_); }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_form'])) 
         {
            $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_form'][$sc_seq_vert];
         }
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'])) 
         {
            $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert];
         }
         if ($this->nmgp_opcao != "recarga" && (!in_array($sc_seq_vert, $sc_check_excl) && !in_array($sc_seq_vert, $sc_check_incl) ))
         { }
         else
         {
             if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['idpro_']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_disabled'][$sc_seq_vert]['idpro_']))
             { 
                 $this->idpro_ = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['idpro_'];
             } 
             $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_disabled'] = array();
             $this->controle_form_vert(); 
             ...
             $this->form_vert_form_detalleprod[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['colores_'] =  $this->colores_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['tallas_'] =  $this->tallas_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['sabor_'] =  $this->sabor_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['idbod_'] =  $this->idbod_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['stock_'] =  $this->stock_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['unidad_'] =  $this->unidad_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['unidadmayor_'] =  $this->unidadmayor_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['factor_'] =  $this->factor_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['cantidad_'] =  $this->cantidad_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['costop_'] =  $this->costop_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['valorunit_'] =  $this->valorunit_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['valorpar_'] =  $this->valorpar_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['iva_'] =  $this->iva_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['iddet_'] =  $this->iddet_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['numproducc_'] =  $this->numproducc_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['descuento_'] =  $this->descuento_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['adicional_'] =  $this->adicional_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['adicional1_'] =  $this->adicional1_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['devuelto_'] =  $this->devuelto_; 
         }
         $sc_seq_vert++; 
      } 
      ...
      if ($this->NM_ajax_flag && 'table_refresh' == $this->NM_ajax_opcao)
      {
          ...
          $this->NM_ajax_info['rsSize'] = sizeof($this->form_vert_form_detalleprod);
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_detalleprod.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("Traslado de Materia Prima a Producción") ?></TITLE>
...
<form name="Fdown" method="get" action="form_detalleprod_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_detalleprod"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
      ...
      {
      $_SESSION['scriptcase']['form_detalleprod']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_detalleprod']['contr_erro'] = 'off'; 
    ...
    function ValidateField_idpro_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      nm_limpa_numero($this->idpro_, $this->field_config['idpro_']['symbol_grp']) ; 
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->idpro_ != '')  
          { 
              $iTestSize = 10;
              if (strlen($this->idpro_) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Artículo: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['idpro_']))
                  {
                      $Campos_Erros['idpro_'] = array();
                  }
                  $Campos_Erros['idpro_'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  ...
                  $this->NM_ajax_info['errList']['idpro_'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idpro_, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "Artículo; " ; 
                  if (!isset($Campos_Erros['idpro_']))
                  {
                      $Campos_Erros['idpro_'] = array();
                  }
    ...
    function ValidateField_colores_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->colores_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['colores_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['colores_'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Color" ; 
          ...
          $Campos_Erros['colores_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['colores_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->colores_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_colores_']) && !in_array($this->colores_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_colores_']))
          {
              $hasError = true;
    ...
    function ValidateField_tallas_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->tallas_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['tallas_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['tallas_'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Talla" ; 
          ...
          $Campos_Erros['tallas_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['tallas_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->tallas_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_tallas_']) && !in_array($this->tallas_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_tallas_']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['tallas_']))
    ...
    function ValidateField_sabor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->sabor_ == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['sabor_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['sabor_'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "Sabor" ; 
          ...
          $Campos_Erros['sabor_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
          ...
          $this->NM_ajax_info['errList']['sabor_'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
      }
          if (!empty($this->sabor_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_sabor_']) && !in_array($this->sabor_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_sabor_']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['sabor_']))
    ...
    function ValidateField_idbod_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idbod_) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idbod_']) && !in_array($this->idbod_, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idbod_']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_stock_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->stock_, -1))
              {
                  $iTestSize++;
                  $this->stock_ = '-' . substr($this->stock_, 0, -1);
              }
              ...
              if ($teste_validade->Valor($this->stock_, 18, 2, 0, 0, "S") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_unidadmayor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['unidadmayor_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['unidadmayor_'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_factor_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['factor_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['factor_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Factor" ; 
              if (!isset($Campos_Erros['factor_']))
    ...
    function ValidateField_costop_(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['costop_']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['php_cmp_required']['costop_'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "Costo" ; 
              if (!isset($Campos_Erros['costop_']))
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['numproducc_'] = $this->numproducc_;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_form'][$sc_seq_vert] = $this->nmgp_dados_form;
   }
   function nm_tira_formatacao()
   {
      ...
      $this->Before_unformat['idpro_'] = $this->idpro_;
      nm_limpa_numero($this->idpro_, $this->field_config['idpro_']['symbol_grp']) ; 
   ...
   {
      global $nm_form_submit;
      if ('' !== $this->idpro_ || (!empty($format_fields) && isset($format_fields['idpro_'])))
      {
          nmgp_Form_Num_Val($this->idpro_, $this->field_config['idpro_']['symbol_grp'], $this->field_config['idpro_']['symbol_dec'], "0", "S", $this->field_config['idpro_']['format_neg'], "", "", "-", $this->field_config['idpro_']['symbol_fmt']) ; 
      }
      ...
      if ('' !== $this->costop_ || (!empty($format_fields) && isset($format_fields['costop_'])))
      {
          ...
          $sMonSymb = $this->field_config['costop_']['symbol_mon'];
          $this->sc_add_currency($this->costop_, $sMonSymb, $this->field_config['costop_']['format_pos']); 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['iddet_']['keyVal'] = form_detalleprod_pack_protect_string($this->nmgp_dados_form['iddet_']);
          }
   } // ajax_return_values
   function ajax_return_values_all_vert()
   {
          ...
          {
              $this->form_vert_form_detalleprod[$this->nmgp_refresh_row] = $this->NM_ajax_info['param'];
              if ((isset($this->Embutida_ronly) && $this->Embutida_ronly) || $this->NM_ajax_force_values)
              {
                  ...
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['idpro_'] = $this->idpro_;
                  }
                  if (isset($this->NM_ajax_changed['colores_']) && $this->NM_ajax_changed['colores_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['colores_'] = $this->colores_;
                  }
                  if (isset($this->NM_ajax_changed['tallas_']) && $this->NM_ajax_changed['tallas_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['tallas_'] = $this->tallas_;
                  }
                  if (isset($this->NM_ajax_changed['sabor_']) && $this->NM_ajax_changed['sabor_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['sabor_'] = $this->sabor_;
                  }
                  if (isset($this->NM_ajax_changed['idbod_']) && $this->NM_ajax_changed['idbod_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['idbod_'] = $this->idbod_;
                  }
                  if (isset($this->NM_ajax_changed['stock_']) && $this->NM_ajax_changed['stock_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['stock_'] = $this->stock_;
                  }
                  if (isset($this->NM_ajax_changed['unidad_']) && $this->NM_ajax_changed['unidad_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['unidad_'] = $this->unidad_;
                  }
                  if (isset($this->NM_ajax_changed['unidadmayor_']) && $this->NM_ajax_changed['unidadmayor_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['unidadmayor_'] = $this->unidadmayor_;
                  }
                  if (isset($this->NM_ajax_changed['factor_']) && $this->NM_ajax_changed['factor_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['factor_'] = $this->factor_;
                  }
                  if (isset($this->NM_ajax_changed['cantidad_']) && $this->NM_ajax_changed['cantidad_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['cantidad_'] = $this->cantidad_;
                  }
                  if (isset($this->NM_ajax_changed['costop_']) && $this->NM_ajax_changed['costop_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['costop_'] = $this->costop_;
                  }
                  if (isset($this->NM_ajax_changed['valorunit_']) && $this->NM_ajax_changed['valorunit_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['valorunit_'] = $this->valorunit_;
                  }
                  if (isset($this->NM_ajax_changed['valorpar_']) && $this->NM_ajax_changed['valorpar_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['valorpar_'] = $this->valorpar_;
                  }
                  if (isset($this->NM_ajax_changed['iva_']) && $this->NM_ajax_changed['iva_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['iva_'] = $this->iva_;
                  }
                  if (isset($this->NM_ajax_changed['iddet_']) && $this->NM_ajax_changed['iddet_'])
                  {
                      $this->form_vert_form_detalleprod[$this->nmgp_refresh_row]['iddet_'] = $this->iddet_;
                  }
              }
          }
          ...
          foreach($this->form_vert_form_detalleprod as $sc_seq_vert => $aRecData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $this->NM_ajax_info['fldList']['idpro_' . $sc_seq_vert . '_autocomp'] = array(
               'type'    => 'text',
               'valList' => array($aLookup[0][form_detalleprod_pack_protect_string($aRecData['idpro_'])]),
              );
              }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_colores_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_colores_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_colores_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_colores_'] = array(); 
}
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   $this->idpro_ = $this->form_vert_form_detalleprod[$sc_seq_vert]['idpro_'];
}
$aLookup[] = array(form_detalleprod_pack_protect_string('0') => str_replace('<', '&lt;',form_detalleprod_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_colores_'][] = '0';
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_colores_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['colores_' . $sc_seq_vert]['valList'][$i] = form_detalleprod_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_tallas_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_tallas_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_tallas_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_tallas_'] = array(); 
}
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   $this->idpro_ = $this->form_vert_form_detalleprod[$sc_seq_vert]['idpro_'];
...
$aLookup[] = array(form_detalleprod_pack_protect_string('0') => str_replace('<', '&lt;',form_detalleprod_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_tallas_'][] = '0';
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_tallas_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['tallas_' . $sc_seq_vert]['valList'][$i] = form_detalleprod_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_sabor_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_sabor_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_sabor_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_sabor_'] = array(); 
}
if ('autocomp_' != substr($this->NM_ajax_opcao, 0, 9))
{
   $this->idpro_ = $this->form_vert_form_detalleprod[$sc_seq_vert]['idpro_'];
...
$aLookup[] = array(form_detalleprod_pack_protect_string('0') => str_replace('<', '&lt;',form_detalleprod_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_sabor_'][] = '0';
if ($this->idpro_ != "")
{ 
   $this->nm_clear_val("idpro_");
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_sabor_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['sabor_' . $sc_seq_vert]['valList'][$i] = form_detalleprod_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idbod_']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idbod_'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idbod_']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idbod_'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_idbod_'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbod_' . $sc_seq_vert]['valList'][$i] = form_detalleprod_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          $aLookupOrig = $aLookup;
              ...
              if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("unidadmayor_", $this->nmgp_refresh_fields)))
              {
                  ...
                  $aLookup = array();
$aLookup[] = array(form_detalleprod_pack_protect_string('SI') => str_replace('<', '&lt;',form_detalleprod_pack_protect_string("SI")));
$aLookup[] = array(form_detalleprod_pack_protect_string('NO') => str_replace('<', '&lt;',form_detalleprod_pack_protect_string("NO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_unidadmayor_'][] = 'SI';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_unidadmayor_'][] = 'NO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['unidadmayor_' . $sc_seq_vert]['valList'][$i] = form_detalleprod_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if (!isset($this->sc_temp_gEdit_cantidad)) {$this->sc_temp_gEdit_cantidad = (isset($_SESSION['gEdit_cantidad'])) ? $_SESSION['gEdit_cantidad'] : "";}
if (!isset($this->sc_temp_sw_1)) {$this->sc_temp_sw_1 = (isset($_SESSION['sw_1'])) ? $_SESSION['sw_1'] : "";}
if (!isset($this->sc_temp_gPar_numero)) {$this->sc_temp_gPar_numero = (isset($_SESSION['gPar_numero'])) ? $_SESSION['gPar_numero'] : "";}
  $this->numproducc_ =$this->sc_temp_gPar_numero;
$this->sc_temp_sw_1=0;
$this->sc_temp_gEdit_cantidad=0;
$this->ver_stock();
if (isset($this->sc_temp_gPar_numero)) { $_SESSION['gPar_numero'] = $this->sc_temp_gPar_numero;}
if (isset($this->sc_temp_sw_1)) { $_SESSION['sw_1'] = $this->sc_temp_sw_1;}
if (isset($this->sc_temp_gEdit_cantidad)) { $_SESSION['gEdit_cantidad'] = $this->sc_temp_gEdit_cantidad;}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_colores_ != $this->colores_ || (isset($bFlagRead_colores_) && $bFlagRead_colores_))&& isset($this->nmgp_refresh_row))
    {
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->iddet_)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$sql="select idinv from inventario where idpro=$this->idpro_  and nupro=$this->numproducc_  and colores=$this->colores_  and tallas=$this->tallas_  and sabor=$this->sabor_  and detalle='Traslado a Producción' and iddetalle=$this->iddet_ ";
...
if($this->unidadmayor_ =='NO' and $this->factor_ >0)
	...
	$cant=round($aux, 2);
     ...
     $nm_select ="UPDATE inventario SET cantidad=($cant*-1),  	valorparcial=$this->valorpar_ , idbod=$this->idbod_  WHERE idinv=$id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
else
	{
     ...
     $nm_select ="UPDATE inventario SET cantidad=($this->cantidad_ *-1),  	valorparcial=$this->valorpar_ , idbod=$this->idbod_  WHERE idinv=$id"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$sql="select idinv from inventario where idpro=$this->idpro_  and nupro=$this->numproducc_  and detalle='Traslado a Producción' and iddetalle=$this->iddet_ ";
...
if(isset($this->ds[0][0]))
	...
	$idInv=$this->ds[0][0];
     ...
     $nm_select ="DELETE FROM inventario WHERE idinv=$idInv"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$_SESSION['scriptcase']['form_detalleprod']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar")
      {
          ...
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['idpro_'] = $this->idpro_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['colores_'] = $this->colores_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['tallas_'] = $this->tallas_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['sabor_'] = $this->sabor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['idbod_'] = $this->idbod_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['unidadmayor_'] = $this->unidadmayor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['factor_'] = $this->factor_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['cantidad_'] = $this->cantidad_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['costop_'] = $this->costop_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['valorunit_'] = $this->valorunit_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['valorpar_'] = $this->valorpar_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['iva_'] = $this->iva_;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert]['iddet_'] = $this->iddet_;
          }
      }
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      $NM_val_form['numproducc_'] = $this->numproducc_;
      ...
      if ($this->numproducc_ === "" || is_null($this->numproducc_))  
      { 
          $this->numproducc_ = 0;
          $this->sc_force_zero[] = 'numproducc_';
      } 
      if ($this->idpro_ === "" || is_null($this->idpro_))  
      { 
          $this->idpro_ = 0;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "idpro = $this->idpro_, unidadmayor = '$this->unidadmayor_', factor = $this->factor_, idbod = $this->idbod_, costop = $this->costop_, cantidad = $this->cantidad_, valorunit = $this->valorunit_, valorpar = $this->valorpar_, iva = $this->iva_, colores = $this->colores_, tallas = $this->tallas_, sabor = $this->sabor_"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              if (isset($NM_val_form['numproducc_']) && $NM_val_form['numproducc_'] != $this->nmgp_dados_select['numproducc_']) 
              { 
                  $SC_fields_update[] = "numproducc = $this->numproducc_"; 
              } 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idpro_', 'colores_', 'tallas_', 'sabor_', 'idbod_', 'stock_', 'unidad_', 'unidadmayor_', 'factor_', 'cantidad_', 'costop_', 'valorunit_', 'valorpar_', 'iva_', 'iddet_'), $aDoNotUpdate);
      ...
      { 
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (numproducc, idpro, unidadmayor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor $compl_insert) VALUES ($this->numproducc_, $this->idpro_, '$this->unidadmayor_', $this->idbod_, $this->costop_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->adicional_, $this->adicional1_, $this->devuelto_, $this->colores_, $this->tallas_, $this->sabor_ $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $compl_insert     = ""; 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numproducc, idpro, unidadmayor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor $compl_insert) VALUES (" . $NM_seq_auto . "$this->numproducc_, $this->idpro_, '$this->unidadmayor_', $this->idbod_, $this->costop_, $this->cantidad_, $this->valorunit_, $this->valorpar_, $this->iva_, $this->descuento_, $this->adicional_, $this->adicional1_, $this->devuelto_, $this->colores_, $this->tallas_, $this->sabor_ $compl_insert_val)"; 
              }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              if (key($aValData) == form_detalleprod_pack_protect_string(NM_charset_to_utf8($this->colores_)))
              {
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleprod_pack_protect_string(NM_charset_to_utf8($this->tallas_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
{ 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleprod_pack_protect_string(NM_charset_to_utf8($this->sabor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleprod_pack_protect_string(NM_charset_to_utf8($this->idbod_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['Lookup_unidadmayor_'][] = 'NO';
          ...
          foreach ($aLookup as $aValData)
          {
              if (key($aValData) == form_detalleprod_pack_protect_string(NM_charset_to_utf8($this->unidadmayor_)))
              {
                  $sLabelTemp = current($aValData);
              }
          }
          $tmpLabel_unidadmayor_ = $sLabelTemp;
                  ...
                  $tmpLabel_costop_ = $this->costop_;
                  $this->NM_ajax_info['fldList']['costop_' . $this->nmgp_refresh_row]['type']    = 'label';
                  ...
                  $this->NM_ajax_info['fldList']['iva_' . $this->nmgp_refresh_row]['type']    = 'text';
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = 0; 
              }
...
$sql="SELECT fecha FROM produccion WHERE numero=$this->sc_temp_gPar_numero";
...
if($this->unidadmayor_ =='NO' and $this->factor_ >0)
	...
	$cant=round($aux, 2);
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=($cant*-1), idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=2, detalle='Traslado a Producción', idmov=1,  	nupro=$this->sc_temp_gPar_numero, iddetalle=$last_id, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ , idped=0, idcombo=0"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
else
	{
     ...
     $nm_select ="INSERT inventario SET fecha='$this->ds', cantidad=($this->cantidad_ *-1), idpro=$this->idpro_ , costo=$this->costop_ , 	valorparcial=$this->valorpar_ , idbod=$this->idbod_ , tipo=2, detalle='Traslado a Producción', idmov=1,  	nupro=$this->sc_temp_gPar_numero, iddetalle=$last_id, colores=$this->colores_ , tallas=$this->tallas_ , sabor=$this->sabor_ , idped=0, idcombo=0"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$_SESSION['scriptcase']['form_detalleprod']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['parms'] = "iddet_?#?$this->iddet_?@?"; 
      }
...
//---------- 
   ...
   { 
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['rows']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['rows']))
      {
          $this->sc_max_reg = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['rows'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['rows_ins']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['rows_ins']))
      {
          $this->sc_max_reg_incl = $_SESSION['scriptcase']['sc_apl_conf']['form_detalleprod']['rows_ins'];
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_qtd_reg']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_qtd_reg'])
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_liga_qtd_reg'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_max_reg']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_max_reg'] > 0 || strtolower($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_max_reg']) == "all"))
      {
          $this->sc_max_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_max_reg'];
      } 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
      $this->form_vert_form_detalleprod = array();
      if ($this->nmgp_opcao != "novo") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['parms'] = ""; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
      { 
          $GLOBALS["NM_ERRO_IBASE"] = 1;  
      ...
      {
          $this->nmgp_opcao = "avanca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] -= $this->sc_max_reg;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = 0;
      }
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total']);
          }
      }
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter'] . ")";
          }
      }
      $sc_where = trim("numproducc=" . $_SESSION['gPar_numero'] . "");
      ...
      if ('total' != $this->form_paginacao)
      {
          if ($this->app_is_initializing || $this->sc_teve_excl || $this->sc_teve_incl || (isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total']))
          {
              ...
              $qt_geral_reg_form_detalleprod = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total'] = $qt_geral_reg_form_detalleprod;
              $rt->Close();
          }
      if ((isset($_POST['master_nav']) && 'on' == $_POST['master_nav']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total']) || $this->sc_teve_excl || $this->sc_teve_incl)
      { 
          ...
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->iddet_))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_detalleprod = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total'];
      } 
      if ($this->nmgp_opcao == "inicio" || $this->nmgp_opcao == "ordem") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = 0; 
      } 
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_detalleprod) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if ($this->nmgp_opcao == "avanca")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] += $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] > $qt_geral_reg_form_detalleprod)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = $qt_geral_reg_form_detalleprod - $this->sc_max_reg; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = ($qt_geral_reg_form_detalleprod + 1) - $this->sc_max_reg; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] < 0)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] = 0; 
          }
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_cmp'] != $this->nmgp_ordem)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_cmp'] = $this->nmgp_ordem; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_ord'] = ' asc'; 
          }
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_ord'] == ' asc')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_ord'] = ' desc'; 
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_ord'] = ' asc'; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_cmp'])) 
      { 
          $sc_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_cmp'] . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['ordem_ord']; 
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT iddet, numproducc, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT iddet, numproducc, idpro, unidadmayor, factor, idbod, costop, cantidad, valorunit, valorpar, iva, descuento, adicional, adicional1, devuelto, colores, tallas, sabor from " . $this->Ini->nm_tabela . $sc_where . $sc_order_by; 
      ...
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe'] == "R")
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
              $rs = $this->Db->Execute($nmgp_select) ; 
          } 
          ...
          { 
              ...
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] . ")" ; 
                  $rs = $this->Db->SelectLimit($nmgp_select, $this->sc_max_reg, $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start']) ; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, $this->sc_max_reg, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] . ")" ; 
              ...
              { 
                  ...
                  if (!$rs === false && !$rs->EOF) 
                  { 
                      $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start']) ;  
                  } 
              } 
          } 
      }
          ...
          {
              $sc_seq_vert = 0; 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['empty_filter'] = true;
              }
          }
          else
          {
          ...
          { 
              ...
              $this->nmgp_dados_select['iddet_'] = $this->iddet_;
              $this->numproducc_ = $rs->fields[1] ; 
              $this->nmgp_dados_select['numproducc_'] = $this->numproducc_;
              $this->idpro_ = $rs->fields[2] ; 
              $this->nmgp_dados_select['idpro_'] = $this->idpro_;
              $this->unidadmayor_ = $rs->fields[3] ; 
              $this->nmgp_dados_select['unidadmayor_'] = $this->unidadmayor_;
              $this->factor_ = trim($rs->fields[4]) ; 
              $this->nmgp_dados_select['factor_'] = $this->factor_;
              $this->idbod_ = $rs->fields[5] ; 
              $this->nmgp_dados_select['idbod_'] = $this->idbod_;
              $this->costop_ = trim($rs->fields[6]) ; 
              $this->nmgp_dados_select['costop_'] = $this->costop_;
              $this->cantidad_ = trim($rs->fields[7]) ; 
              $this->nmgp_dados_select['cantidad_'] = $this->cantidad_;
              $this->valorunit_ = trim($rs->fields[8]) ; 
              $this->nmgp_dados_select['valorunit_'] = $this->valorunit_;
              $this->valorpar_ = trim($rs->fields[9]) ; 
              $this->nmgp_dados_select['valorpar_'] = $this->valorpar_;
              $this->iva_ = trim($rs->fields[10]) ; 
              $this->nmgp_dados_select['iva_'] = $this->iva_;
              $this->descuento_ = trim($rs->fields[11]) ; 
              $this->nmgp_dados_select['descuento_'] = $this->descuento_;
              $this->adicional_ = $rs->fields[12] ; 
              $this->nmgp_dados_select['adicional_'] = $this->adicional_;
              $this->adicional1_ = $rs->fields[13] ; 
              $this->nmgp_dados_select['adicional1_'] = $this->adicional1_;
              $this->devuelto_ = $rs->fields[14] ; 
              $this->nmgp_dados_select['devuelto_'] = $this->devuelto_;
              $this->colores_ = $rs->fields[15] ; 
              $this->nmgp_dados_select['colores_'] = $this->colores_;
              $this->tallas_ = $rs->fields[16] ; 
              $this->nmgp_dados_select['tallas_'] = $this->tallas_;
              $this->sabor_ = $rs->fields[17] ; 
              $this->nmgp_dados_select['sabor_'] = $this->sabor_;
              ...
              $this->numproducc_ = (string)$this->numproducc_; 
              ...
              if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['parms'])) 
              { 
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['parms'] = "iddet_?#?$this->iddet_?@?";
              } 
...
//
//-- 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dados_select'][$sc_seq_vert] = $this->nmgp_dados_select;
              $this->nm_guardar_campos();
              $this->nm_formatar_campos();
             $this->form_vert_form_detalleprod[$sc_seq_vert]['idpro_'] =  $this->idpro_; 
             $this->form_vert_form_detalleprod[$sc_seq_vert]['colores_'] =  $this->colores_; 
          ...
          ksort ($this->form_vert_form_detalleprod); 
          $rs->Close(); 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_qtd'] = $sc_seq_vert + $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] - 1;
          if ('total' == $this->form_paginacao)
          {
          ...
          {
              $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] + 1; 
              $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_qtd']; 
              $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total'] + 1; 
          }
          ...
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] < (($qt_geral_reg_form_detalleprod + 1) - $this->sc_max_reg);
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opcao'] = '';
          }
      } 
      if ($this->nmgp_opcao == "novo") 
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['embutida_multi']) 
          { 
          } 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['reg_start'] + $this->sc_max_reg;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'][$sc_seq_vert]['buttons'] = array(
                        'delete' => $this->nmgp_botoes['delete'],
                        'update' => $this->nmgp_botoes['update']
                );
        }
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
if($this->sc_temp_gEdit_cantidad<$cant and $cant>0)
	{
		$cant=$cant-$this->sc_temp_gEdit_cantidad;
		$sql="select stockmen from productos where idprod=$proid";
...
else if($this->sc_temp_gEdit_cantidad>$cant and $cant>0)
	{
		$cant=$this->sc_temp_gEdit_cantidad-$cant;
		$sql="select stockmen from productos where idprod=$proid";
...
$this->nm_formatar_campos('idpro_', 'colores_', 'tallas_', 'sabor_', 'cantidad_', 'stock_', 'costop_', 'valorpar_', 'idbod_', 'unidadmayor_', 'factor_', 'unidad_');
...
if($this->sc_temp_sw_1==0){
if($this->cantidad_ !=0){$this->sc_temp_gEdit_cantidad=$this->cantidad_ ;}
	$this->sc_temp_sw_1=1;
	}
...
$modificado_tallas_ = $this->tallas_;
$modificado_sabor_ = $this->sabor_;
$this->nm_formatar_campos('idpro_', 'idbod_', 'unidadmayor_', 'factor_', 'stock_', 'unidad_', 'colores_', 'tallas_', 'sabor_');
$this->nmgp_refresh_fields = array();
if ($original_idpro_ !== $modificado_idpro_ || isset($this->nmgp_cmp_readonly['idpro_']) || (isset($bFlagRead_idpro_) && $bFlagRead_idpro_))
{
    $this->nmgp_refresh_fields[] = 'idpro_';
...
$modificado_tallas_ = $this->tallas_;
$modificado_sabor_ = $this->sabor_;
$this->nm_formatar_campos('cantidad_', 'idpro_', 'idbod_', 'unidadmayor_', 'factor_', 'stock_', 'unidad_', 'colores_', 'tallas_', 'sabor_');
$this->nmgp_refresh_fields = array();
if ($original_cantidad_ !== $modificado_cantidad_ || isset($this->nmgp_cmp_readonly['cantidad_']) || (isset($bFlagRead_cantidad_) && $bFlagRead_cantidad_))
{
    $this->nmgp_refresh_fields[] = 'cantidad_';
...
$sql="select unidmaymen, costomen, recmayamen from productos where idprod=$this->idpro_ ";
...
; $a=$this->data[0][2]; 
if($this->data[0][0]=='SI' AND $this->data[0][2]>0)
	{
...
$modificado_tallas_ = $this->tallas_;
$modificado_sabor_ = $this->sabor_;
$this->nm_formatar_campos('idpro_', 'costop_', 'unidadmayor_', 'factor_', 'idbod_', 'stock_', 'unidad_', 'colores_', 'tallas_', 'sabor_');
$this->nmgp_refresh_fields = array();
if ($original_idpro_ !== $modificado_idpro_ || isset($this->nmgp_cmp_readonly['idpro_']) || (isset($bFlagRead_idpro_) && $bFlagRead_idpro_))
{
    $this->nmgp_refresh_fields[] = 'idpro_';
...
if($this->unidadmayor_ =='SI')
	{
	$sql="select unidmaymen, costomen from productos where idprod=$this->idpro_ ";
...
;
		if($this->data[0][0]=='SI')
			...
			{
			$this->unidadmayor_ ="NO";
			$this->nm_mens_alert[] = 'PRODUCTO NO MANEJA UNIDAD MAYOR/MENOR'; $this->nm_params_alert[] = array(); if ($this->NM_ajax_flag) { $this->sc_ajax_alert('PRODUCTO NO MANEJA UNIDAD MAYOR/MENOR'); }$this->costop_ =$this->data[0][1];
			$this->sc_set_focus('cantidad');
			}
	}
else
...
;
		if($this->data[0][0]=='SI')
			{
			$this->costop_ =round(($this->data[0][1]/$this->factor_ ), 0);
			$this->sc_set_focus('cantidad');
			}
		else
			{
...
$modificado_tallas_ = $this->tallas_;
$modificado_sabor_ = $this->sabor_;
$this->nm_formatar_campos('unidadmayor_', 'idpro_', 'costop_', 'factor_', 'cantidad_', 'valorpar_', 'idbod_', 'stock_', 'unidad_', 'colores_', 'tallas_', 'sabor_');
$this->nmgp_refresh_fields = array();
if ($original_unidadmayor_ !== $modificado_unidadmayor_ || isset($this->nmgp_cmp_readonly['unidadmayor_']) || (isset($bFlagRead_unidadmayor_) && $bFlagRead_unidadmayor_))
{
    $this->nmgp_refresh_fields[] = 'unidadmayor_';
...
$fac=$this->sc_temp_gPar_numero;
 
      $nm_select = "select sum(valorpar) from detalleprod where numproducc=$fac"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->dt = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
if(!empty($this->dt[0][0]))
	{
     ...
     $nm_select ="update produccion set vtotal=$tot where numero=$fac"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	$this->sc_master_value('vtotal', $tot);
	}
else
	{
	
     $nm_select ="update produccion set vtotal=0 where numero=$fac"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	if (!empty($this->colores_ ))
		...
		if (!empty($this->tallas_ ))
			...
			if(!empty($this->sabor_ ))
				...
				WHERE idpro = $this->idpro_  AND idbod=$idb and colores=$this->colores_  and tallas=$this->tallas_  and sabor=$this->sabor_ ";
				}
			else
				{
				$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
				WHERE idpro = $this->idpro_  AND idbod=$idb and colores=$this->colores_  and tallas=$this->tallas_ ";
				}
			}
		else
			{
			if(!empty($this->sabor_ ))
				{
				$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
				WHERE idpro = $this->idpro_  AND idbod=$idb and colores=$this->colores_  and sabor=$this->sabor_ ";
				}
			else
				{
				$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
				WHERE idpro = $this->idpro_  AND idbod=$idb and colores=$this->colores_ ";
				}
			}
		}
	else
		...
		if (!empty($this->tallas_ ))
			...
			if(!empty($this->sabor_ ))
				{
				$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
			WHERE idpro = $this->idpro_  AND idbod=$idb and tallas=$this->tallas_  and sabor=$this->sabor_ ";
				}
			else
				{
				$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
			WHERE idpro = $this->idpro_  AND idbod=$idb and tallas=$this->tallas_ ";
				}
			}
		else
			{
			$sql="SELECT SUM(cantidad) AS cantidad FROM inventario
			WHERE idpro = $this->idpro_  AND idbod=$idb ";
			}
		}
...
;
	...
	if(!empty($this->ds[0][0]))
		...
		if($this->unidadmayor_ =='NO' and $this->factor_ >0)
			{
			$this->stock_ =$this->ds[0][0]*$this->factor_ ;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
   ...
   {
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['table_refresh'] = true;
   ...
   else
   {
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("iddet_", "numproducc_", "idpro_", "unidadmayor_", "factor_", "idbod_", "costop_", "cantidad_", "valorunit_", "valorpar_", "iva_", "descuento_", "adicional_", "adicional1_", "devuelto_", "colores_", "tallas_", "sabor_"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          if ($field == "SC_all_Cmp") 
          {
              $data_lookup = $this->SC_lookup_numproducc_($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "numproducc", $arg_search, $data_lookup);
              }
          }
          if ($field == "SC_all_Cmp") 
          {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter_form'] . " and (numproducc=" . $_SESSION['gPar_numero'] . ") and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where numproducc=" . $_SESSION['gPar_numero'] . " and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) AS countTest from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      $rt = $this->Db->Execute($nmgp_select) ; 
      ...
      $qt_geral_reg_form_detalleprod = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['total'] = $qt_geral_reg_form_detalleprod;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_detalleprod_pack_ajax_response();
   ...
   function SC_lookup_numproducc_($condicao, $campo)
   {
       $result = array();
       $campo_orig = $campo;
       $campo  = substr($this->Db->qstr($campo), 1, -1);
       ...
       {
           $nm_comando = "SELECT numero, numero FROM produccion WHERE (CAST (numero AS TEXT) LIKE '%$campo%')" ; 
       }
       else
       {
           $nm_comando = "SELECT numero, numero FROM produccion WHERE (numero LIKE '%$campo%')" ; 
       }
       if ($condicao == "ii")
       {
   ...
   function SC_lookup_idpro_($condicao, $campo)
   {
       ...
       if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres) && ($condicao == "eq" || $condicao == "qp" || $condicao == "np" || $condicao == "ii" || $condicao == "df"))
       {
           $nm_comando = "SELECT concat(codigobar,\" - \",nompro), idprod FROM productos WHERE (CAST (idprod AS TEXT) LIKE '%$campo%') AND (activo like 'SI')" ; 
       }
       else
       {
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_detalleprod_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_detalleprod_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function sc_master_value($sIndex, $sValue)
    {
        ...
        $_SESSION['sc_session'][$this->Ini->sc_page]['form_detalleprod']['masterValue'] = $this->NM_ajax_info['masterValue'];
    } // sc_master_value
