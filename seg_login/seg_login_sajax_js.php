...
?>
  ...
  // ---------- Validate empresa
  function do_ajax_seg_login_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldSelect(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_login_validate_empresa(var_empresa, var_script_case_init, do_ajax_seg_login_validate_empresa_cb);
  } // do_ajax_seg_login_validate_empresa

  function do_ajax_seg_login_validate_empresa_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_login_validate_empresa_cb
  ...
  // ---------- Validate nit
  function do_ajax_seg_login_validate_nit()
  {
    var nomeCampo_nit = "nit";
    var var_nit = scAjaxGetFieldText(nomeCampo_nit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seg_login_validate_nit(var_nit, var_script_case_init, do_ajax_seg_login_validate_nit_cb);
  } // do_ajax_seg_login_validate_nit

  function do_ajax_seg_login_validate_nit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seg_login_validate_nit_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_seg_login_submit_form()
  {
    ...
    x_ajax_seg_login_submit_form(var_empresa, var_login, var_pswd, var_nit, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_seg_login_submit_form_cb);
...
?>
  ...
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_seg_login_navigate_form, function() {});
    } else {
