...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_empresa' + iSeqRow).bind('blur', function() { sc_seg_login_empresa_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_seg_login_empresa_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_seg_login_empresa_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_nit' + iSeqRow).bind('blur', function() { sc_seg_login_nit_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_seg_login_nit_onchange(this, iSeqRow) })
                                 .bind('focus', function() { sc_seg_login_nit_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_seg_login_empresa_onblur(oThis, iSeqRow) {
  do_ajax_seg_login_validate_empresa();
  scCssBlur(oThis);
}

function sc_seg_login_empresa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_seg_login_empresa_onfocus(oThis, iSeqRow) {
...
function sc_seg_login_nit_onblur(oThis, iSeqRow) {
  do_ajax_seg_login_validate_nit();
  scCssBlur(oThis);
}

function sc_seg_login_nit_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_seg_login_nit_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
