  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_colores" == sTestField)
        {
...
?>
  ...
  // ---------- Validate codigo
  function do_ajax_form_colores_validate_codigo()
  {
    var nomeCampo_codigo = "codigo";
    var var_codigo = scAjaxGetFieldText(nomeCampo_codigo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colores_validate_codigo(var_codigo, var_script_case_init, do_ajax_form_colores_validate_codigo_cb);
  } // do_ajax_form_colores_validate_codigo

  function do_ajax_form_colores_validate_codigo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colores_validate_codigo_cb

  // ---------- Validate color
  function do_ajax_form_colores_validate_color()
  {
    var nomeCampo_color = "color";
    var var_color = scAjaxGetFieldText(nomeCampo_color);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colores_validate_color(var_color, var_script_case_init, do_ajax_form_colores_validate_color_cb);
  } // do_ajax_form_colores_validate_color

  function do_ajax_form_colores_validate_color_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colores_validate_color_cb

  // ---------- Validate paleta
  function do_ajax_form_colores_validate_paleta()
  {
    var nomeCampo_paleta = "paleta";
    var var_paleta = scAjaxGetFieldText(nomeCampo_paleta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colores_validate_paleta(var_paleta, var_script_case_init, do_ajax_form_colores_validate_paleta_cb);
  } // do_ajax_form_colores_validate_paleta

  function do_ajax_form_colores_validate_paleta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paleta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colores_validate_paleta_cb

  // ---------- Validate imagen
  function do_ajax_form_colores_validate_imagen()
  {
    var nomeCampo_imagen = "imagen";
    var var_imagen = scAjaxGetFieldHidden(nomeCampo_imagen);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_colores_validate_imagen(var_imagen, var_script_case_init, do_ajax_form_colores_validate_imagen_cb);
  } // do_ajax_form_colores_validate_imagen

  function do_ajax_form_colores_validate_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagen";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_colores_validate_imagen_cb

  // ---------- Event onchange paleta
  function do_ajax_form_colores_event_paleta_onchange()
  {
    var var_paleta = scAjaxGetFieldText("paleta");
    var var_imagen = scAjaxGetFieldHidden("imagen");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_colores_event_paleta_onchange(var_paleta, var_imagen, var_script_case_init, do_ajax_form_colores_event_paleta_onchange_cb);
  } // do_ajax_form_colores_event_paleta_onchange

  function do_ajax_form_colores_event_paleta_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "paleta";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_colores_event_paleta_onchange_cb_after_alert);
  } // do_ajax_form_colores_event_paleta_onchange_cb
  function do_ajax_form_colores_event_paleta_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_colores_event_paleta_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_colores_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_colores_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_colores_submit_form(var_codigo, var_color, var_paleta, var_imagen, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_colores_submit_form_cb);
  } // do_ajax_form_colores_submit_form

  function do_ajax_form_colores_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("paleta");
      scAjaxHideErrorDisplay("imagen");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_colores']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_colores']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_colores']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_colores_submit_form_cb_after_alert);
  } // do_ajax_form_colores_submit_form_cb
  function do_ajax_form_colores_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_colores_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_colores_navigate_form()
  {
    perform_ajax_form_colores_navigate_form();
  }

  function perform_ajax_form_colores_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("paleta");
    scAjaxHideErrorDisplay("imagen");
    var var_idcolores = document.F2.idcolores.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_colores_navigate_form(var_idcolores, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_colores_navigate_form_cb);
  } // do_ajax_form_colores_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_colores']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_colores_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcolores.value = scAjaxGetKeyValue("idcolores");
    scAjaxSetSummary();
    scAjaxSetNavpage();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_colores_navigate_form_cb_after_alert);
  } // do_ajax_form_colores_navigate_form_cb
  function do_ajax_form_colores_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_colores_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_colores_navigate_form_cb_after_alert
  function sc_hide_form_colores_form()
  {
  ...
  ajax_field_list[1] = "color";
  ajax_field_list[2] = "paleta";
  ...
  var ajax_error_list = {
    ...
    "color": {"label": "Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "paleta": {"label": "Paleta ", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "imagen": {"label": "Seleccionar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["paleta"][1] = "paleta";
  ...
  var ajax_field_id = {
    ...
    "paleta": new Array("hidden_field_label_paleta", "hidden_field_data_paleta"),
