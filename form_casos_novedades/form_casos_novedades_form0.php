...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_casos_novedades_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_casos_novedades_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-id_producto", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "id_producto" != sId ? sId.substr(11) : "";
   sc_form_casos_novedades_id_producto_onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_casos_novedades_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_casos_novedades'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_casos_novedades'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-5';
        $buttonMacroLabel = "";
        
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_caso_label" id="hidden_field_label_id_caso" style="<?php echo $sStyleHidden_id_caso; ?>"><span id="id_label_id_caso"><?php echo $this->nm_new_label['id_caso']; ?></span></TD>
    <TD class="scFormDataOdd css_id_caso_line" id="hidden_field_data_id_caso" style="<?php echo $sStyleHidden_id_caso; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_caso_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['Lookup_tipo'][] = 'N'; ?>
 <option  value="S" <?php  if ($this->tipo == "S") { echo " selected" ;} ?>>SERVICIO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['Lookup_tipo'][] = 'S'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_producto_label" id="hidden_field_label_id_producto" style="<?php echo $sStyleHidden_id_producto; ?>"><span id="id_label_id_producto"><?php echo $this->nm_new_label['id_producto']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['php_cmp_required']['id_producto']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['php_cmp_required']['id_producto'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_id_producto_line" id="hidden_field_data_id_producto" style="<?php echo $sStyleHidden_id_producto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_producto_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cantidad_label" id="hidden_field_label_cantidad" style="<?php echo $sStyleHidden_cantidad; ?>"><span id="id_label_cantidad"><?php echo $this->nm_new_label['cantidad']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['php_cmp_required']['cantidad']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['php_cmp_required']['cantidad'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valor_label" id="hidden_field_label_valor" style="<?php echo $sStyleHidden_valor; ?>"><span id="id_label_valor"><?php echo $this->nm_new_label['valor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['php_cmp_required']['valor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['php_cmp_required']['valor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valor_imp_label" id="hidden_field_label_valor_imp" style="<?php echo $sStyleHidden_valor_imp; ?>"><span id="id_label_valor_imp"><?php echo $this->nm_new_label['valor_imp']; ?></span></TD>
    <TD class="scFormDataOdd css_valor_imp_line" id="hidden_field_data_valor_imp" style="<?php echo $sStyleHidden_valor_imp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valor_imp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tarifa_imp_label" id="hidden_field_label_tarifa_imp" style="<?php echo $sStyleHidden_tarifa_imp; ?>"><span id="id_label_tarifa_imp"><?php echo $this->nm_new_label['tarifa_imp']; ?></span></TD>
    <TD class="scFormDataOdd css_tarifa_imp_line" id="hidden_field_data_tarifa_imp" style="<?php echo $sStyleHidden_tarifa_imp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_tarifa_imp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_codigo_imp_label" id="hidden_field_label_codigo_imp" style="<?php echo $sStyleHidden_codigo_imp; ?>"><span id="id_label_codigo_imp"><?php echo $this->nm_new_label['codigo_imp']; ?></span></TD>
    <TD class="scFormDataOdd css_codigo_imp_line" id="hidden_field_data_codigo_imp" style="<?php echo $sStyleHidden_codigo_imp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_imp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_desc_imp_label" id="hidden_field_label_desc_imp" style="<?php echo $sStyleHidden_desc_imp; ?>"><span id="id_label_desc_imp"><?php echo $this->nm_new_label['desc_imp']; ?></span></TD>
    <TD class="scFormDataOdd css_desc_imp_line" id="hidden_field_data_desc_imp" style="<?php echo $sStyleHidden_desc_imp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_desc_imp_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_descr_label" id="hidden_field_label_descr" style="<?php echo $sStyleHidden_descr; ?>"><span id="id_label_descr"><?php echo $this->nm_new_label['descr']; ?></span></TD>
    <TD class="scFormDataOdd css_descr_line" id="hidden_field_data_descr" style="<?php echo $sStyleHidden_descr; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_descr_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cod_producto_label" id="hidden_field_label_cod_producto" style="<?php echo $sStyleHidden_cod_producto; ?>"><span id="id_label_cod_producto"><?php echo $this->nm_new_label['cod_producto']; ?></span></TD>
    <TD class="scFormDataOdd css_cod_producto_line" id="hidden_field_data_cod_producto" style="<?php echo $sStyleHidden_cod_producto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cod_producto_line" style="vertical-align: top;padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_casos_novedades");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_casos_novedades");
 parent.scAjaxDetailHeight("form_casos_novedades", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
