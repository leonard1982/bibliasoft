  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_casos_novedades_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_casos_novedades_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_caso
  function do_ajax_form_casos_novedades_mob_validate_id_caso()
  {
    var nomeCampo_id_caso = "id_caso";
    var var_id_caso = scAjaxGetFieldText(nomeCampo_id_caso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_id_caso(var_id_caso, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_id_caso_cb);
  } // do_ajax_form_casos_novedades_mob_validate_id_caso

  function do_ajax_form_casos_novedades_mob_validate_id_caso_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_id_caso_cb

  // ---------- Validate tipo
  function do_ajax_form_casos_novedades_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_tipo_cb);
  } // do_ajax_form_casos_novedades_mob_validate_tipo

  function do_ajax_form_casos_novedades_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_tipo_cb

  // ---------- Validate id_producto
  function do_ajax_form_casos_novedades_mob_validate_id_producto()
  {
  } // do_ajax_form_casos_novedades_mob_validate_id_producto

  function do_ajax_form_casos_novedades_mob_validate_id_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_producto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_id_producto_cb

  // ---------- Validate descripcion
  function do_ajax_form_casos_novedades_mob_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_descripcion_cb);
  } // do_ajax_form_casos_novedades_mob_validate_descripcion

  function do_ajax_form_casos_novedades_mob_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_descripcion_cb

  // ---------- Validate fecha
  function do_ajax_form_casos_novedades_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_fecha_cb);
  } // do_ajax_form_casos_novedades_mob_validate_fecha

  function do_ajax_form_casos_novedades_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_fecha_cb

  // ---------- Validate cantidad
  function do_ajax_form_casos_novedades_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_cantidad_cb);
  } // do_ajax_form_casos_novedades_mob_validate_cantidad

  function do_ajax_form_casos_novedades_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_cantidad_cb

  // ---------- Validate valor
  function do_ajax_form_casos_novedades_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_valor_cb);
  } // do_ajax_form_casos_novedades_mob_validate_valor

  function do_ajax_form_casos_novedades_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_valor_cb

  // ---------- Validate valor_imp
  function do_ajax_form_casos_novedades_mob_validate_valor_imp()
  {
    var nomeCampo_valor_imp = "valor_imp";
    var var_valor_imp = scAjaxGetFieldText(nomeCampo_valor_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_valor_imp(var_valor_imp, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_valor_imp_cb);
  } // do_ajax_form_casos_novedades_mob_validate_valor_imp

  function do_ajax_form_casos_novedades_mob_validate_valor_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor_imp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_valor_imp_cb

  // ---------- Validate tarifa_imp
  function do_ajax_form_casos_novedades_mob_validate_tarifa_imp()
  {
    var nomeCampo_tarifa_imp = "tarifa_imp";
    var var_tarifa_imp = scAjaxGetFieldText(nomeCampo_tarifa_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_tarifa_imp(var_tarifa_imp, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_tarifa_imp_cb);
  } // do_ajax_form_casos_novedades_mob_validate_tarifa_imp

  function do_ajax_form_casos_novedades_mob_validate_tarifa_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tarifa_imp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_tarifa_imp_cb

  // ---------- Validate codigo_imp
  function do_ajax_form_casos_novedades_mob_validate_codigo_imp()
  {
    var nomeCampo_codigo_imp = "codigo_imp";
    var var_codigo_imp = scAjaxGetFieldText(nomeCampo_codigo_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_codigo_imp(var_codigo_imp, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_codigo_imp_cb);
  } // do_ajax_form_casos_novedades_mob_validate_codigo_imp

  function do_ajax_form_casos_novedades_mob_validate_codigo_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo_imp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_codigo_imp_cb

  // ---------- Validate desc_imp
  function do_ajax_form_casos_novedades_mob_validate_desc_imp()
  {
    var nomeCampo_desc_imp = "desc_imp";
    var var_desc_imp = scAjaxGetFieldText(nomeCampo_desc_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_desc_imp(var_desc_imp, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_desc_imp_cb);
  } // do_ajax_form_casos_novedades_mob_validate_desc_imp

  function do_ajax_form_casos_novedades_mob_validate_desc_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desc_imp";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_desc_imp_cb

  // ---------- Validate descr
  function do_ajax_form_casos_novedades_mob_validate_descr()
  {
    var nomeCampo_descr = "descr";
    var var_descr = scAjaxGetFieldText(nomeCampo_descr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_descr(var_descr, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_descr_cb);
  } // do_ajax_form_casos_novedades_mob_validate_descr

  function do_ajax_form_casos_novedades_mob_validate_descr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_descr_cb

  // ---------- Validate cod_producto
  function do_ajax_form_casos_novedades_mob_validate_cod_producto()
  {
    var nomeCampo_cod_producto = "cod_producto";
    var var_cod_producto = scAjaxGetFieldText(nomeCampo_cod_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_mob_validate_cod_producto(var_cod_producto, var_script_case_init, do_ajax_form_casos_novedades_mob_validate_cod_producto_cb);
  } // do_ajax_form_casos_novedades_mob_validate_cod_producto

  function do_ajax_form_casos_novedades_mob_validate_cod_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cod_producto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_mob_validate_cod_producto_cb

  // ---------- Event onchange id_producto
  function do_ajax_form_casos_novedades_mob_event_id_producto_onchange()
  {
    var var_id_producto = scAjaxGetFieldText("id_ac_id_producto");
    var var_codigo_imp = scAjaxGetFieldText("codigo_imp");
    var var_valor = scAjaxGetFieldText("valor");
    var var_desc_imp = scAjaxGetFieldText("desc_imp");
    var var_tarifa_imp = scAjaxGetFieldText("tarifa_imp");
    var var_valor_imp = scAjaxGetFieldText("valor_imp");
    var var_descr = scAjaxGetFieldText("descr");
    var var_cod_producto = scAjaxGetFieldText("cod_producto");
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_novedades_mob_event_id_producto_onchange(var_id_producto, var_codigo_imp, var_valor, var_desc_imp, var_tarifa_imp, var_valor_imp, var_descr, var_cod_producto, var_cantidad, var_script_case_init, do_ajax_form_casos_novedades_mob_event_id_producto_onchange_cb);
  } // do_ajax_form_casos_novedades_mob_event_id_producto_onchange

  function do_ajax_form_casos_novedades_mob_event_id_producto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_producto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_novedades_mob_event_id_producto_onchange_cb_after_alert);
  } // do_ajax_form_casos_novedades_mob_event_id_producto_onchange_cb
  function do_ajax_form_casos_novedades_mob_event_id_producto_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_casos_novedades_mob_event_id_producto_onchange_cb_after_alert

  // ---------- Event onchange tipo
  function do_ajax_form_casos_novedades_mob_event_tipo_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_novedades_mob_event_tipo_onchange(var_tipo, var_id_producto, var_descripcion, var_cantidad, var_valor, var_script_case_init, do_ajax_form_casos_novedades_mob_event_tipo_onchange_cb);
  } // do_ajax_form_casos_novedades_mob_event_tipo_onchange

  function do_ajax_form_casos_novedades_mob_event_tipo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_novedades_mob_event_tipo_onchange_cb_after_alert);
  } // do_ajax_form_casos_novedades_mob_event_tipo_onchange_cb
  function do_ajax_form_casos_novedades_mob_event_tipo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_casos_novedades_mob_event_tipo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_casos_novedades_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_casos_novedades_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_caso = scAjaxGetFieldText("id_caso");
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_id_producto = scAjaxGetFieldText("id_producto");
    var var_descripcion = scAjaxGetFieldText("descripcion");
    ...
    var var_descr = scAjaxGetFieldText("descr");
    var var_cod_producto = scAjaxGetFieldText("cod_producto");
    var var_id_novedades = scAjaxGetFieldText("id_novedades");
    ...
    scAjaxProcOn();
    x_ajax_form_casos_novedades_mob_submit_form(var_id_caso, var_tipo, var_id_producto, var_descripcion, var_fecha, var_cantidad, var_valor, var_valor_imp, var_tarifa_imp, var_codigo_imp, var_desc_imp, var_descr, var_cod_producto, var_id_novedades, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_casos_novedades_mob_submit_form_cb);
  } // do_ajax_form_casos_novedades_mob_submit_form

  function do_ajax_form_casos_novedades_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_producto");
      ...
      scAjaxHideErrorDisplay("valor_imp");
      scAjaxHideErrorDisplay("tarifa_imp");
      scAjaxHideErrorDisplay("codigo_imp");
      scAjaxHideErrorDisplay("desc_imp");
      scAjaxHideErrorDisplay("descr");
      scAjaxHideErrorDisplay("cod_producto");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_casos_novedades_mob_submit_form_cb_after_alert);
  } // do_ajax_form_casos_novedades_mob_submit_form_cb
  function do_ajax_form_casos_novedades_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_novedades_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_casos_novedades_mob_navigate_form()
  {
    perform_ajax_form_casos_novedades_mob_navigate_form();
  }

  function perform_ajax_form_casos_novedades_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("descr");
    scAjaxHideErrorDisplay("cod_producto");
    var var_id_novedades = document.F2.id_novedades.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_casos_novedades_mob_navigate_form(var_id_novedades, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casos_novedades_mob_navigate_form_cb);
  } // do_ajax_form_casos_novedades_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_casos_novedades_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_novedades.value = scAjaxGetKeyValue("id_novedades");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_casos_novedades_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_casos_novedades_mob_navigate_form_cb
  function do_ajax_form_casos_novedades_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_casos_novedades_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_casos_novedades_mob_navigate_form_cb_after_alert
  function sc_hide_form_casos_novedades_mob_form()
  {
  ...
  ajax_field_list[0] = "id_caso";
  ajax_field_list[1] = "tipo";
  ajax_field_list[2] = "id_producto";
  ajax_field_list[3] = "descripcion";
  ajax_field_list[4] = "fecha";
  ajax_field_list[5] = "cantidad";
  ajax_field_list[6] = "valor";
  ajax_field_list[7] = "valor_imp";
  ajax_field_list[8] = "tarifa_imp";
  ajax_field_list[9] = "codigo_imp";
  ajax_field_list[10] = "desc_imp";
  ajax_field_list[11] = "descr";
  ajax_field_list[12] = "cod_producto";
  ...
  var ajax_error_list = {
    ...
    "id_producto": {"label": "Producto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "valor_imp": {"label": "Valor Imp", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tarifa_imp": {"label": "Tarifa Imp", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codigo_imp": {"label": "Codigo Imp", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "desc_imp": {"label": "Desc Imp", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descr": {"label": "Descr", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cod_producto": {"label": "Cod Producto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_caso": new Array(),
    "tipo": new Array(),
    "id_producto": new Array(),
    "descripcion": new Array(),
    "fecha": new Array(),
    "cantidad": new Array(),
    "valor": new Array(),
    "valor_imp": new Array(),
    "tarifa_imp": new Array(),
    "codigo_imp": new Array(),
    "desc_imp": new Array(),
    "descr": new Array(),
    "cod_producto": new Array()
  };
  ajax_field_mult["id_caso"][1] = "id_caso";
  ajax_field_mult["tipo"][1] = "tipo";
  ajax_field_mult["id_producto"][1] = "id_producto";
  ...
  ajax_field_mult["valor_imp"][1] = "valor_imp";
  ajax_field_mult["tarifa_imp"][1] = "tarifa_imp";
  ajax_field_mult["codigo_imp"][1] = "codigo_imp";
  ajax_field_mult["desc_imp"][1] = "desc_imp";
  ajax_field_mult["descr"][1] = "descr";
  ajax_field_mult["cod_producto"][1] = "cod_producto";

  var ajax_field_id = {
    "tipo": new Array("hidden_field_label_tipo", "hidden_field_data_tipo"),
    "id_producto": new Array("hidden_field_label_id_producto", "hidden_field_data_id_producto"),
