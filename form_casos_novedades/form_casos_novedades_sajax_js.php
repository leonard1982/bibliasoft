  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_casos_novedades" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_casos_novedades_form();
	}
...
?>
  ...
  // ---------- Validate id_caso
  function do_ajax_form_casos_novedades_validate_id_caso()
  {
    var nomeCampo_id_caso = "id_caso";
    var var_id_caso = scAjaxGetFieldText(nomeCampo_id_caso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_id_caso(var_id_caso, var_script_case_init, do_ajax_form_casos_novedades_validate_id_caso_cb);
  } // do_ajax_form_casos_novedades_validate_id_caso

  function do_ajax_form_casos_novedades_validate_id_caso_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_id_caso_cb

  // ---------- Validate tipo
  function do_ajax_form_casos_novedades_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_casos_novedades_validate_tipo_cb);
  } // do_ajax_form_casos_novedades_validate_tipo

  function do_ajax_form_casos_novedades_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_tipo_cb

  // ---------- Validate id_producto
  function do_ajax_form_casos_novedades_validate_id_producto()
  {
  } // do_ajax_form_casos_novedades_validate_id_producto

  function do_ajax_form_casos_novedades_validate_id_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_id_producto_cb

  // ---------- Validate descripcion
  function do_ajax_form_casos_novedades_validate_descripcion()
  {
    var nomeCampo_descripcion = "descripcion";
    var var_descripcion = scAjaxGetFieldText(nomeCampo_descripcion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_descripcion(var_descripcion, var_script_case_init, do_ajax_form_casos_novedades_validate_descripcion_cb);
  } // do_ajax_form_casos_novedades_validate_descripcion

  function do_ajax_form_casos_novedades_validate_descripcion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_descripcion_cb

  // ---------- Validate fecha
  function do_ajax_form_casos_novedades_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_casos_novedades_validate_fecha_cb);
  } // do_ajax_form_casos_novedades_validate_fecha

  function do_ajax_form_casos_novedades_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_fecha_cb

  // ---------- Validate cantidad
  function do_ajax_form_casos_novedades_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_form_casos_novedades_validate_cantidad_cb);
  } // do_ajax_form_casos_novedades_validate_cantidad

  function do_ajax_form_casos_novedades_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_cantidad_cb

  // ---------- Validate valor
  function do_ajax_form_casos_novedades_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_valor(var_valor, var_script_case_init, do_ajax_form_casos_novedades_validate_valor_cb);
  } // do_ajax_form_casos_novedades_validate_valor

  function do_ajax_form_casos_novedades_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_valor_cb

  // ---------- Validate valor_imp
  function do_ajax_form_casos_novedades_validate_valor_imp()
  {
    var nomeCampo_valor_imp = "valor_imp";
    var var_valor_imp = scAjaxGetFieldText(nomeCampo_valor_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_valor_imp(var_valor_imp, var_script_case_init, do_ajax_form_casos_novedades_validate_valor_imp_cb);
  } // do_ajax_form_casos_novedades_validate_valor_imp

  function do_ajax_form_casos_novedades_validate_valor_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_valor_imp_cb

  // ---------- Validate tarifa_imp
  function do_ajax_form_casos_novedades_validate_tarifa_imp()
  {
    var nomeCampo_tarifa_imp = "tarifa_imp";
    var var_tarifa_imp = scAjaxGetFieldText(nomeCampo_tarifa_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_tarifa_imp(var_tarifa_imp, var_script_case_init, do_ajax_form_casos_novedades_validate_tarifa_imp_cb);
  } // do_ajax_form_casos_novedades_validate_tarifa_imp

  function do_ajax_form_casos_novedades_validate_tarifa_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_tarifa_imp_cb

  // ---------- Validate codigo_imp
  function do_ajax_form_casos_novedades_validate_codigo_imp()
  {
    var nomeCampo_codigo_imp = "codigo_imp";
    var var_codigo_imp = scAjaxGetFieldText(nomeCampo_codigo_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_codigo_imp(var_codigo_imp, var_script_case_init, do_ajax_form_casos_novedades_validate_codigo_imp_cb);
  } // do_ajax_form_casos_novedades_validate_codigo_imp

  function do_ajax_form_casos_novedades_validate_codigo_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_codigo_imp_cb

  // ---------- Validate desc_imp
  function do_ajax_form_casos_novedades_validate_desc_imp()
  {
    var nomeCampo_desc_imp = "desc_imp";
    var var_desc_imp = scAjaxGetFieldText(nomeCampo_desc_imp);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_desc_imp(var_desc_imp, var_script_case_init, do_ajax_form_casos_novedades_validate_desc_imp_cb);
  } // do_ajax_form_casos_novedades_validate_desc_imp

  function do_ajax_form_casos_novedades_validate_desc_imp_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_desc_imp_cb

  // ---------- Validate descr
  function do_ajax_form_casos_novedades_validate_descr()
  {
    var nomeCampo_descr = "descr";
    var var_descr = scAjaxGetFieldText(nomeCampo_descr);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_descr(var_descr, var_script_case_init, do_ajax_form_casos_novedades_validate_descr_cb);
  } // do_ajax_form_casos_novedades_validate_descr

  function do_ajax_form_casos_novedades_validate_descr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descr";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_descr_cb

  // ---------- Validate cod_producto
  function do_ajax_form_casos_novedades_validate_cod_producto()
  {
    var nomeCampo_cod_producto = "cod_producto";
    var var_cod_producto = scAjaxGetFieldText(nomeCampo_cod_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_novedades_validate_cod_producto(var_cod_producto, var_script_case_init, do_ajax_form_casos_novedades_validate_cod_producto_cb);
  } // do_ajax_form_casos_novedades_validate_cod_producto

  function do_ajax_form_casos_novedades_validate_cod_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_novedades_validate_cod_producto_cb

  // ---------- Event onchange id_producto
  function do_ajax_form_casos_novedades_event_id_producto_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_casos_novedades_event_id_producto_onchange(var_id_producto, var_codigo_imp, var_valor, var_desc_imp, var_tarifa_imp, var_valor_imp, var_descr, var_cod_producto, var_cantidad, var_script_case_init, do_ajax_form_casos_novedades_event_id_producto_onchange_cb);
  } // do_ajax_form_casos_novedades_event_id_producto_onchange

  function do_ajax_form_casos_novedades_event_id_producto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_producto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_novedades_event_id_producto_onchange_cb_after_alert);
  } // do_ajax_form_casos_novedades_event_id_producto_onchange_cb
  function do_ajax_form_casos_novedades_event_id_producto_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_casos_novedades_event_id_producto_onchange_cb_after_alert

  // ---------- Event onchange tipo
  function do_ajax_form_casos_novedades_event_tipo_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_novedades_event_tipo_onchange(var_tipo, var_id_producto, var_descripcion, var_cantidad, var_valor, var_script_case_init, do_ajax_form_casos_novedades_event_tipo_onchange_cb);
  } // do_ajax_form_casos_novedades_event_tipo_onchange

  function do_ajax_form_casos_novedades_event_tipo_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "tipo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_novedades_event_tipo_onchange_cb_after_alert);
  } // do_ajax_form_casos_novedades_event_tipo_onchange_cb
  function do_ajax_form_casos_novedades_event_tipo_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_casos_novedades_event_tipo_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_casos_novedades_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_casos_novedades_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_casos_novedades_submit_form(var_id_caso, var_tipo, var_id_producto, var_descripcion, var_fecha, var_cantidad, var_valor, var_valor_imp, var_tarifa_imp, var_codigo_imp, var_desc_imp, var_descr, var_cod_producto, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_casos_novedades_submit_form_cb);
  } // do_ajax_form_casos_novedades_submit_form

  function do_ajax_form_casos_novedades_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_casos_novedades_submit_form_cb_after_alert);
  } // do_ajax_form_casos_novedades_submit_form_cb
  function do_ajax_form_casos_novedades_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_novedades_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_casos_novedades_navigate_form()
  {
    perform_ajax_form_casos_novedades_navigate_form();
  }

  function perform_ajax_form_casos_novedades_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_casos_novedades_navigate_form(var_id_novedades, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casos_novedades_navigate_form_cb);
  } // do_ajax_form_casos_novedades_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_novedades']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_casos_novedades_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_casos_novedades_navigate_form_cb_after_alert);
  } // do_ajax_form_casos_novedades_navigate_form_cb
  function do_ajax_form_casos_novedades_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_casos_novedades_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_casos_novedades_navigate_form_cb_after_alert
  function sc_hide_form_casos_novedades_form()
  {
