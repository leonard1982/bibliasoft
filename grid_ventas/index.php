...
// 
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_ventas']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_ventas']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
      ...
      $this->sc_lig_target["C_@scinf_nremision"] = '_blank';
      $this->sc_lig_target["C_@scinf_nremision_@scinf_pdfreport_remision"] = '_blank';
...
// 
      ...
      $this->arr_buttons_usr['SC_btn_0']['value']            = "Nueva Factura";
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_ventas']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      $this->Change_Menu = false;
       ...
       { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_ventas']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_ventas']['label'] = "Ventas";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Gb_date_format']['fecha']['fechaven'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Gb_date_format']['fecha']['fechaven'] = 'YYYYMMDD2';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Gb_def_sql']['fecha']['fechaven'] = 'fechaven';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Gb_date_format']['vencimiento']['fechavenc'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Gb_date_format']['vencimiento']['fechavenc'] = 'YYYYMMDD2';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Gb_def_sql']['vencimiento']['fechavenc'] = 'fechavenc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_All_Groupby'] = array('_NM_SC_' => 'grid', 'fecha' => 'all', 'vencimiento' => 'all', 'credito' => 'all', 'vendedor' => 'all');
      ...
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "fecha")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['Labels_GB'][] = "Fecha";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "vencimiento")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['Labels_GB'][] = "Vencimiento";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "credito")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['Labels_GB'][] = "Crédito";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "vendedor")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['Labels_GB'][] = "Vendedor";
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "_NM_SC_")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['fecha']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['fecha'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_order']['fecha'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['fecha'][3] = array('label' => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_order']['fecha'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_control']['fecha']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_control']['fecha'] = array(
               array(
                   'cmp_res' => "NM_Count",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['vencimiento']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['vencimiento'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_order']['vencimiento'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['vencimiento'][3] = array('label' => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_order']['vencimiento'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_control']['vencimiento']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_control']['vencimiento'] = array(
               array(
                   'cmp_res' => "NM_Count",
                   'label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['credito']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['credito'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_order']['credito'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['credito'][3] = array('label' => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_order']['credito'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_control']['credito']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_control']['credito'] = array(
               array(
                   'cmp_res' => "NM_Count",
                   'label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['vendedor']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['vendedor'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_order']['vendedor'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_display']['vendedor'][3] = array('label' => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_order']['vendedor'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_control']['vendedor']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['summarizing_fields_control']['vendedor'] = array(
               array(
                   'cmp_res' => "NM_Count",
                   'label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
                   'label_field' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "",
      ...
      $_SESSION['sc_session'][$script_case_init]['grid_ventas']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['graf_exibe_val']    = '0';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "pdf_res")) ? true : false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "prefijo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "numfacven";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "prefijo_rem";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "nremision";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "idcli";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "fechaven";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "total";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "pagada";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "asentada";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "credito";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "fechavenc";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'][] = "vendedor";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opc_liga']['inicial'];
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "fast_search")  
      { 
          $this->SC_fast_search($GLOBALS["nmgp_fast_search"], $GLOBALS["nmgp_cond_fast_search"], $GLOBALS["nmgp_arg_fast_search"]);
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_ant'] == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq'])
          { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['orig_pesq'] = 'grid';
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_refresh'] = true;
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "interativ_search")
      { 
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] = 'inicio';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_refresh'] = true;
      } 
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['campos_busca']      = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['grid_pesq']         = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['Grid_search']       = "";
...
//----------------------------------->
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_ventas/grid_ventas_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_ventas_res_xls.class.php"); 
          } 
          $this->xls  = new grid_ventas_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_ventas/grid_ventas_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_ventas_res_xml.class.php"); 
          } 
          $this->xml  = new grid_ventas_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_ventas/grid_ventas_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_ventas_json.class.php"); 
          } 
          $this->json  = new grid_ventas_json();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_ventas/grid_ventas_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_ventas_res_csv.class.php"); 
          } 
          $this->csv  = new grid_ventas_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_ventas/grid_ventas_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_ventas_rtf.class.php"); 
          } 
          $this->rtf  = new grid_ventas_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_ventas/grid_ventas_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_ventas_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_ventas_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'])
      {
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['use_pass_pdf'];
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_ventas']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          $tmp_cmd = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_fast'] = "";
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_orig'])) 
          {
              $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_orig']; 
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_filtro'] . ")"; 
              }
          }
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'] . ")"; 
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq'] = $tmp_cmd;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_fast'] = $comando;
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_orig'])) 
      {
          $tmp_cmd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_orig']; 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['fast_search'][0] = $in_fields;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['fast_search'][2] = $sv_data;
   }
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_sep_date']))
      {
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           ...
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
               {
                   ...
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           $prep = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_postgres))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
               }
           }
           elseif ($prep == "" && $delim != "")
           {
           ...
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           elseif ( $tmp[2] == "dt")
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_fast'] . ")";
          }
      }
      ...
      { 
          if (empty($tmp_where)) 
          { 
              $tmp_cmd = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo']; 
          } 
          else
          { 
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo'] . ")"; 
          } 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_ventas']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_ventas']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['grid_ventas']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_ventas']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_ventas']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
