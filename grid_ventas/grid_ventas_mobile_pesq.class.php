...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_fechavenc_cond" name="fechavenc_cond" onChange="nm_campos_between(document.getElementById('id_vis_fechavenc'), this, 'fechavenc')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectOdd" alt="{autoTab: false, enterTab: true}" id="SC_pagada_cond" name="pagada_cond" onChange="nm_campos_between(document.getElementById('id_vis_pagada'), this, 'pagada')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="sc-js-input SC_Cond_Selector scFilterObjectEven" alt="{autoTab: false, enterTab: true}" id="SC_credito_cond" name="credito_cond" onChange="nm_campos_between(document.getElementById('id_vis_credito'), this, 'credito')">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-credito" id="id_ac_credito" name="credito_autocomp"><?php if ('' !=  $credito) { ?><option value="<?php echo $credito ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_credito"  <?php echo $str_display_credito; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_credito_input_2" name="credito_input_2" value="<?php echo NM_encode_input($credito_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: true}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
