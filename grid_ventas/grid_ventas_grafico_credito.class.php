...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['contr_label_graf']['credito']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['contr_label_graf']['credito']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['contr_label_graf']['credito'];
      }
   }
