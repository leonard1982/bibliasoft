...
class grid_ventas_res_rtf
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_ventas.rtf";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['rtf_name']);
      }
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['pivot_group_by'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['pivot_tabular'];
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['arr_export']['data'];
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
