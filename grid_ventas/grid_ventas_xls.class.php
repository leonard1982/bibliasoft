...
class grid_ventas_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "_NM_SC_")
          {
              $this->Tem_xls_res  = false;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_ventas/grid_ventas_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_ventas_res_xls.class.php");
              $this->Res_xls = new grid_ventas_res_xls();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "fecha")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['tot_geral'][2];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "vencimiento")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['tot_geral'][2];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "credito")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['tot_geral'][2];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "vendedor")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['tot_geral'][2];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "_NM_SC_")
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'] && !$this->Ini->sc_export_ajax) {
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_ventas']['glo_nm_path_imag_temp'] . "/");
          $this->pb->setProgressbarMd5($_GET['pbmd5']);
          $this->pb->initialize();
          $this->pb->setReturnUrl("./");
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nmgp_select_count = "SELECT count(*) AS countTest from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      facturaven WHERE     numfacven!=0 ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      remisiones ORDER BY idfacven DESC) ) nm_sel_esp"; 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT numfacven, nremision, idcli, str_replace (convert(char(10),fechaven,102), '.', '-') + ' ' + convert(char(8),fechaven,20), total, pagada, asentada, credito, str_replace (convert(char(10),fechavenc,102), '.', '-') + ' ' + convert(char(8),fechavenc,20), vendedor, idfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      facturaven WHERE     numfacven!=0 ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      remisiones ORDER BY idfacven DESC) ) nm_sel_esp"; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nmgp_select = "SELECT numfacven, nremision, idcli, fechaven, total, pagada, asentada, credito, fechavenc, vendedor, idfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      facturaven WHERE     numfacven!=0 ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      remisiones ORDER BY idfacven DESC) ) nm_sel_esp"; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT numfacven, nremision, idcli, convert(char(23),fechaven,121), total, pagada, asentada, credito, convert(char(23),fechavenc,121), vendedor, idfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      facturaven WHERE     numfacven!=0 ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      remisiones ORDER BY idfacven DESC) ) nm_sel_esp"; 
      } 
      ...
      { 
          $nmgp_select = "SELECT numfacven, nremision, idcli, EXTEND(fechaven, YEAR TO DAY), total, pagada, asentada, credito, EXTEND(fechavenc, YEAR TO DAY), vendedor, idfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      facturaven WHERE     numfacven!=0 ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      remisiones ORDER BY idfacven DESC) ) nm_sel_esp"; 
       } 
      else 
      { 
          $nmgp_select = "SELECT numfacven, nremision, idcli, fechaven, total, pagada, asentada, credito, fechavenc, vendedor, idfacven from ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      facturaven WHERE     numfacven!=0 ORDER BY idfacven desc) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, vendedor FROM      remisiones ORDER BY idfacven DESC) ) nm_sel_esp"; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo'])) 
      { 
          if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_pesq'])) 
          { 
              $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo']; 
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['where_resumo'] . ")"; 
          } 
      } 
      ...
      while (!$rs->EOF)
      {
         ...
         elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "_NM_SC_")
         {
         ...
         $this->arg_sum_vendedor = ($this->vendedor == "") ? " is null " : " = " . $this->vendedor;
          ...
          if ($Cmp_tst != $this->fechaven_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "fecha") 
          {  
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
          ...
          if ($Cmp_tst != $this->fechavenc_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "vencimiento") 
          {  
          ...
          if ($this->credito !== $this->credito_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "credito") 
          {  
          ...
          if ($this->vendedor !== $this->vendedor_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "vendedor") 
          {  
     ...
     $nm_houve_quebra = "N";
         ...
         $_SESSION['scriptcase']['grid_ventas']['contr_erro'] = 'on';
  if($this->pagada =="SI"){
	
	$this->editar  = "<a href='#'></a>";
	
}else{
	$this->editar  = "<a href='../frm_pos/index.php?gidfactura=".$this->idfacven ."' >Editar</a>";
}
if($this->numfacven >0)
	{
	 
      $nm_select = "select resolucion from facturaven where idfacven=$this->idfacven  "; 
...
;
	$resol=$this->ds[0][0];
      ...
      $nm_select = "select prefijo from resdian where Idres=$resol"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
...
;
	...
	if($this->fechavenc  == NULL)
		{
		$this->fechavenc =$this->fechaven ;
		}
	}
else
	{
...
$_SESSION['scriptcase']['grid_ventas']['contr_erro'] = 'off'; 
      ...
      if ($this->groupby_show == "S") {
          $this->Xls_col = 0;
          $this->Xls_row++;
       if (isset($this->fechaven_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "fecha")
       {
           $this->quebra_fechaven_fecha_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->fechavenc_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "vencimiento")
       {
           $this->quebra_fechavenc_vencimiento_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->credito_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "credito")
       {
           $this->quebra_credito_credito_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->vendedor_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] == "vendedor")
       {
           $this->quebra_vendedor_vendedor_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "N° Fac."; 
          ...
          $SC_Label = (isset($this->New_label['prefijo_rem'])) ? $this->New_label['prefijo_rem'] : "Prefijo R."; 
          if ($Cada_col == "prefijo_rem" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              $this->count_span++;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
          ...
          $SC_Label = (isset($this->New_label['nremision'])) ? $this->New_label['nremision'] : "N° Remi."; 
   ...
   //----- prefijo_rem
   function NM_export_prefijo_rem()
   {
         $current_cell_ref = $this->calc_cell($this->Xls_col);
         if (!isset($this->NM_ctrl_style[$current_cell_ref])) {
             $this->NM_ctrl_style[$current_cell_ref]['ini'] = $this->Xls_row;
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->prefijo_rem = html_entity_decode($this->prefijo_rem, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->prefijo_rem = strip_tags($this->prefijo_rem);
         $this->prefijo_rem = NM_charset_to_utf8($this->prefijo_rem);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->prefijo_rem, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->prefijo_rem, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- nremision
   ...
   //----- prefijo_rem
   function NM_sub_cons_prefijo_rem()
   {
         $this->prefijo_rem = html_entity_decode($this->prefijo_rem, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->prefijo_rem = strip_tags($this->prefijo_rem);
         $this->prefijo_rem = NM_charset_to_utf8($this->prefijo_rem);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->prefijo_rem;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
 ...
 function quebra_vendedor_vendedor($vendedor) 
 {
   ...
   function quebra_fechaven_fecha_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'] as $Cada_cmp)
       {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_fecha_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "total" && (!isset($this->NM_cmp_hidden['total']) || $this->NM_cmp_hidden['total'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_ventas']['tot_geral'][2];
               $prim_cmp = false;
...
if($this->nremision >0)
	{
      ...
      $nm_select = "select resolucion from remisiones where idfacven=$this->nremision  "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds = array();
     if ($this->nremision !== "")
...
;
	$resolu=$this->ds[0][0];
      ...
      $nm_select = "select prefijo from resdian where Idres=$resolu"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($this->des = $this->Db->Execute($nm_select)) 
      { }
...
;
	$this->prefijo_rem =substr($this->des , 7);
	}
else
	{
	$this->prefijo_rem ="";
