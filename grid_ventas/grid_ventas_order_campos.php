...
<?php
   ...
   $Ord_Cmp = new grid_ventas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_ventas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["prefijo"] : "Prefijo";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["numfacven"] : "N° Fac.";
   $tab_ger_campos['prefijo_rem'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['prefijo_rem'] = "prefijo_rem";
   }
   else
   {
       $tab_def_campos['prefijo_rem'] = "";
   }
   $tab_labels["prefijo_rem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["prefijo_rem"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["prefijo_rem"] : "Prefijo R.";
   $tab_ger_campos['nremision'] = "on";
   $tab_def_campos['nremision'] = "nremision";
   $tab_labels["nremision"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["nremision"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["nremision"] : "N° Remi.";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["total"] : "Total";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["credito"] : "Crédito";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["fechavenc"] : "Vencimiento";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['labels']["vendedor"] : "Vendedor";
   $tab_ger_campos['prefijo'] = "none";
   $tab_ger_campos['prefijo_rem'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_ventas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_ventas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_ventas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_ventas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
