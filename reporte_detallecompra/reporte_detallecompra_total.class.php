...
class reporte_detallecompra_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['reporte_detallecompra']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['reporte_detallecompra']['campos_busca']))
      { 
