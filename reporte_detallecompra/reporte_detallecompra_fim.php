...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____reporte_detallecompra"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____reporte_detallecompra"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>reporte_detallecompra</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['reporte_detallecompra']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'reporte_detallecompra' || $achou)
          {
