<?php
@session_start() ;
$_SESSION['scriptcase']['reporte_detallecompra']['sc_process_barr'] = true;
require_once('../reporte_detallecompra/index.php');
unset($_SESSION['scriptcase']['reporte_detallecompra']['sc_process_barr']);
$ExportCtrl = new reporte_detallecompra_export_control;
$ExportCtrl->Export_barr();

class reporte_detallecompra_export_control
{
