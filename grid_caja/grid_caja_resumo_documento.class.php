...
class grid_caja_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order']['documento']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order']['documento'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order']['documento'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['documento'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['documento'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['documento'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['documento'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['documento'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['documento'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['documento'] as $i_sum => $d_sum)
           {
...
//--- 
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['documento'] as $campo_documento => $dados_documento)
      {
         $this->array_total_documento[$campo_documento][2] = $dados_documento[1];
         $this->array_total_documento[$campo_documento][1] = $dados_documento[2];
      }
   }
   //---- 
...
$_SESSION['scriptcase']['grid_caja']['contr_erro'] = 'off';
         ...
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->cantidad)), sc_strip_script($this->documento), sc_strip_script($documento_orig));
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['documento'] = $this->array_total_documento;
      }
