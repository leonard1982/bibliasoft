...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $prep_label['nota'] = "Nota";
      $prep_label['documento'] = "Número";
      $prep_label['resolucion'] = "PJ";
      $prep_label['ie'] = "Ie";
      $prep_label['banco'] = "Banco";
      $prep_label['cliente'] = "Tercero";
      $x = 0;
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $this->label[$x] = $prep_label[$cmp_gb];
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['contr_label_graf'][$cmp_gb]) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['contr_label_graf'][$cmp_gb]))
          {
             $this->label[$x] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['contr_label_graf'][$cmp_gb];
          }
          $x++;
      }
   }
