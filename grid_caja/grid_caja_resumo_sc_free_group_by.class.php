...
class grid_caja_resumo
{
     ...
     { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total'][$cmp_gb];
          }
      }
      else
      {
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['labels']['fecha'] = $Lab_fecha; 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['labels']['nota'] = $Lab_nota; 
       $prep_field['documento'] = $Lab_documento;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['labels']['documento'] = $Lab_documento; 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['labels']['ie'] = $Lab_ie; 
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['labels']['cliente'] = $Lab_cliente; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      $this->array_total_fecha = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['fecha'];
      $this->array_total_detalle = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['detalle'];
      $this->array_total_nota = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['nota'];
      $this->array_total_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['documento'];
      $this->array_total_resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['resolucion'];
      $this->array_total_ie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['ie'];
      $this->array_total_banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['banco'];
      $this->array_total_cliente = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['cliente'];
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_caja/grid_caja_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   function adiciona_registro($sum_cantidad, $quebra_fecha, $quebra_detalle, $quebra_nota, $quebra_documento, $quebra_resolucion, $quebra_ie, $quebra_banco, $quebra_cliente, $quebra_fecha_orig, $quebra_detalle_orig, $quebra_nota_orig, $quebra_documento_orig, $quebra_resolucion_orig, $quebra_ie_orig, $quebra_banco_orig, $quebra_cliente_orig)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
   ...
   function compat_arrays()
   {
      ...
      {
          $Arr_gb[]   = $cmp_gb;
          $Arr_name[] = "_SESSION['sc_session'][" . $this->Ini->sc_page . "]['grid_caja']['arr_total']['" .$cmp_gb . "']" . $Control;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
