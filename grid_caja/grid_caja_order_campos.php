...
<?php
   ...
   $Ord_Cmp = new grid_caja_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_caja_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['doc'] = "on";
   $tab_def_campos['doc'] = "doc";
   $tab_labels["doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["doc"] : "Número";
   $tab_ger_campos['nota'] = "on";
   $tab_def_campos['nota'] = "nota";
   $tab_labels["nota"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["nota"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["nota"] : "Nota";
   $tab_ger_campos['doc_pagado'] = "on";
   $tab_def_campos['doc_pagado'] = "doc_pagado";
   $tab_labels["doc_pagado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["doc_pagado"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["doc_pagado"] : "Doc Pagado";
   $tab_ger_campos['id_tercero'] = "on";
   $tab_def_campos['id_tercero'] = "id_tercero";
   $tab_labels["id_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["id_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["id_tercero"] : "Tercero";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["cantidad"] : "Valor";
   $tab_ger_campos['banco'] = "on";
   $tab_def_campos['banco'] = "banco";
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["banco"] : "Banco";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["creado"] : "Creado";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['labels']["total"] : "Total en Caja";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_caja']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_caja']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_caja']['contr_total_geral']  = "NAO";
   unset($_SESSION['sc_session'][$sc_init]['grid_caja']['tot_geral']);
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_caja_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_caja']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
