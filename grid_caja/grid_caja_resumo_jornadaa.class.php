...
class grid_caja_resumo
{
   ...
   var $count_ger;
   var $sum_cantidad;
   var $sc_proc_quebra_jornada;
   var $count_jornada;
   var $sum_jornada_cantidad;

   //---- 
   function grid_caja_resumo($tipo = "")
   {
      ...
      $this->array_total_jornada = array();
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
       ...
       $this->jornada = $Busca_temp['jornada']; 
       $tmp_pos = strpos($this->jornada, "##@@");
       if ($tmp_pos !== false && !is_array($this->jornada))
       {
           $this->jornada = substr($this->jornada, 0, $tmp_pos);
       }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      {
          $this->array_total_jornada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['jornada'];
      }
      else
      {
          $this->array_total_jornada = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['arr_total']['jornada'] = $this->array_total_jornada;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_order'];
       }
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
           }
       }
       else
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_display'] as $i_sum => $d_sum)
           {
               $this->comp_sum_display[$i_sum] = $d_sum['display'];
           }
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_control']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['summarizing_fields_control'] = array(
               'NM_Count' => array(
       ...
       //-----
       foreach ($this->array_total_jornada as $i_jornada => $d_jornada) {
           if (!in_array($i_jornada, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_jornada[3] ] = $d_jornada[2];
               $this->comp_label[0][ $d_jornada[3] ] = $d_jornada[2];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'jornada', 'prot' => '@aspass@'),
       );
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['pivot_order_level'] = 0;
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_jornada => $l_jornada) {
           if (isset($this->array_total_jornada[$i_jornada])) {
               $this->comp_group[$i_jornada] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_jornada;
       }
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|0' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'label_x'  => $this->getChartText(strip_tags("Jornada")),
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = 'sc_grid_caja_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.xml';
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = 'sc_grid_caja_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.xml';
   ...
   function resumo_init()
   {
      ...
      elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['opcao'] == "pdf" || $this->Print_All)
      {
          $this->monta_cabecalho();
      }
   }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_jornadaa("res", $this->array_total_jornada);
      ksort($this->array_total_jornada);
      if ("out" == $this->NM_tipo)
      {
         $this->total->quebra_geral();
      }
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rrtf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_caja/grid_caja_config_word.php?nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_caja/grid_caja_config_print.php?nm_opc=resumo&nm_cor=AM&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
              $nm_saida->saida("           </td></tr>\r\n");
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
...
{ 
      ...
      $nm_saida->saida("   {\r\n");
      $nm_saida->saida("       window.open('" . $this->Ini->path_link . "grid_caja/grid_caja_iframe_prt.php?path_botoes=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&script_case_session=" . session_id() . "&opcao=res_print&cor_print=' + cor,'','location=no,menubar,resizable,scrollbars,status=no,toolbar');\r\n");
      $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("  {\r\n");
      $nm_saida->saida("      window.location = \"" . $this->Ini->path_link . "grid_caja/grid_caja_iframe.php?nmgp_parms=" . $Md5_pdf . "&sc_tp_pdf=\" + z + \"&sc_parms_pdf=\" + p + \"&sc_graf_pdf=\" + g;\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja']['pivot_charts']))
   {
...
//--- 
   ...
   function monta_cabecalho()
   {
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $fecha_2 = $Busca_temp['fecha_input_2']; 
          $jornada = $Busca_temp['jornada']; 
          $tmp_pos = strpos($jornada, "##@@");
          if ($tmp_pos !== false)
          {
              $jornada = substr($jornada, 0, $tmp_pos);
          }
      ...
      $nm_saida->saida("    	<tr>\r\n");
      $nm_saida->saida("        	<td id=\"lin1_col1\" class=\"" . $this->css_scGridHeaderFont . "\"><span>Movimiento de caja</span></td>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_cantidad, $quebra_jornada, $quebra_jornada_orig)
   {
      //----- Jornada
      if (!isset($this->array_total_jornada[$quebra_jornada_orig]))
      {
         $this->array_total_jornada[$quebra_jornada_orig][0] = 1;
         $this->array_total_jornada[$quebra_jornada_orig][1] = $sum_cantidad;
         $this->array_total_jornada[$quebra_jornada_orig][2] = $quebra_jornada;
         $this->array_total_jornada[$quebra_jornada_orig][3] = $quebra_jornada_orig;
      }
      else
      {
         $this->array_total_jornada[$quebra_jornada_orig][0]++;
         $this->array_total_jornada[$quebra_jornada_orig][1] += $sum_cantidad;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT if(cantidad<0,'Egreso','Ingreso') as ie, str_replace (convert(char(10),fecha,102), '.', '-') + ' ' + convert(char(8),fecha,20), jornada, idrp, idrc, detalle, nota, resolucion, documento, cantidad, idcaja, cierredia, totaldia, arqueo, saldo from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT if(cantidad<0,'Egreso','Ingreso') as ie, fecha, jornada, idrp, idrc, detalle, nota, resolucion, documento, cantidad, idcaja, cierredia, totaldia, arqueo, saldo from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT if(cantidad<0,'Egreso','Ingreso') as ie, fecha, jornada, idrp, idrc, detalle, nota, resolucion, documento, cantidad, idcaja, cierredia, totaldia, arqueo, saldo from " . $this->Ini->nm_tabela; 
     ...
     $nmgp_order_by = " order by  jornada asc"; 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->ie = $rs_res->fields[0] ;  
            $this->fecha = $rs_res->fields[1] ;  
            $this->jornada = $rs_res->fields[2] ;  
            $this->idrp = $rs_res->fields[3] ;  
            $this->idrc = $rs_res->fields[4] ;  
            $this->detalle = $rs_res->fields[5] ;  
            $this->nota = $rs_res->fields[6] ;  
            $this->resolucion = $rs_res->fields[7] ;  
            $this->documento = $rs_res->fields[8] ;  
            $this->cantidad = $rs_res->fields[9] ;  
            $this->cantidad =  str_replace(",", ".", $this->cantidad);
            $this->idcaja = $rs_res->fields[10] ;  
            $this->cierredia = $rs_res->fields[11] ;  
            $this->totaldia = $rs_res->fields[12] ;  
            $this->totaldia =  str_replace(",", ".", $this->totaldia);
            $this->arqueo = $rs_res->fields[13] ;  
            $this->arqueo =  str_replace(",", ".", $this->arqueo);
            $this->saldo = $rs_res->fields[14] ;  
            $this->saldo =  str_replace(",", ".", $this->saldo);
            $this->fecha_orig = $this->fecha;
            $this->jornada_orig = $this->jornada;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->cantidad, $this->jornada, $this->jornada_orig);
            }
   }
//
