<?php
   include_once('blank_recalcular_cuentas_ajax_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_perfil']          = "conn_mysql";
   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class blank_recalcular_cuentas_ajax_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "blank_recalcular_cuentas_ajax"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/blank_recalcular_cuentas_ajax';
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['actual_lang']) || $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("blank_recalcular_cuentas_ajax_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_recalcular_cuentas_ajax"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["blank_recalcular_cuentas_ajax"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "blank_recalcular_cuentas_ajax_erro.class.php"); 
      $this->Erro = new blank_recalcular_cuentas_ajax_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('blank_recalcular_cuentas_ajax'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao']) && $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_perfil']) && $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv_2022', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['blank_recalcular_cuentas_ajax']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class blank_recalcular_cuentas_ajax_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle()
   {
      ...
      $this->Ini = new blank_recalcular_cuentas_ajax_ini(); 
      $this->Ini->init();
      $this->Change_Menu = false;
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['blank_recalcular_cuentas_ajax']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['blank_recalcular_cuentas_ajax']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_recalcular_cuentas_ajax']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['blank_recalcular_cuentas_ajax'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_recalcular_cuentas_ajax']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_recalcular_cuentas_ajax']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('blank_recalcular_cuentas_ajax') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['blank_recalcular_cuentas_ajax']['label'] = "" . $this->Ini->Nm_lang['lang_othr_blank_title'] . "";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "blank_recalcular_cuentas_ajax")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['blank_recalcular_cuentas_ajax']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['blank_recalcular_cuentas_ajax']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['blank_recalcular_cuentas_ajax']['exit'];
      ...
      $this->Db = $this->Ini->Db; 
      include_once($this->Ini->path_aplicacao . "blank_recalcular_cuentas_ajax_erro.class.php"); 
      $this->Erro      = new blank_recalcular_cuentas_ajax_erro();
      $this->Erro->Ini = $this->Ini;
//
      header("X-XSS-Protection: 1; mode=block");
      header("X-Frame-Options: SAMEORIGIN");
      $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['contr_erro'] = 'on';
 

 
      $nm_select = "select r.prefijo,f.numfacven,f.idcli,f.tipo,f.idfacven from facturaven f inner join resdian r on f.resolucion=r.Idres where f.credito='1' and f.asentada='1'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSaldosFV = array();
      $this->vsaldosfv = array();
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $this->vSaldosFV[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsaldosfv[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSaldosFV = false;
          $this->vSaldosFV_erro = $this->Db->ErrorMsg();
          $this->vsaldosfv = false;
          $this->vsaldosfv_erro = $this->Db->ErrorMsg();
      } 
;
if(isset($this->vsaldosfv[0][0]))
{
	$vc = count($this->vsaldosfv );
	
	for($i=0;$i<$vc;$i++)
	{
		$vpj  = $this->vsaldosfv[$i][0];
		$vnum = $this->vsaldosfv[$i][1];
		$vnd  = $vpj."/".$vnum;
		$vcli = $this->vsaldosfv[$i][2];
		$vtipo= $this->vsaldosfv[$i][3];
		$vidfac = $this->vsaldosfv[$i][4];
		
		 
      $nm_select = "select concat(prefijo,'/',numero) as cuenta from terceros_cuentas where tipo='".$vtipo."' and tercero='".$vcli."' and numero_documento='".$vnd."' and tipo='INGRESO'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiTC = array();
      $this->vsitc = array();
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiTC[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsitc[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiTC = false;
          $this->vSiTC_erro = $this->Db->ErrorMsg();
          $this->vsitc = false;
          $this->vsitc_erro = $this->Db->ErrorMsg();
      } 
;
		
		if(isset($this->vsitc[0][0]))
		{
			$vcu = $this->vsitc[0][0];
			
     $nm_select = "update facturaven set cod_cuenta='".$vcu."' where idfacven='".$vidfac."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      ...
      $nm_select = "select nurecibo,idrecibo from recibocaja where asentado='SI'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSaldosRC = array();
      $this->vsaldosrc = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSaldosRC[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsaldosrc[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSaldosRC = false;
          $this->vSaldosRC_erro = $this->Db->ErrorMsg();
          $this->vsaldosrc = false;
          $this->vsaldosrc_erro = $this->Db->ErrorMsg();
      } 
;
if(isset($this->vsaldosrc[0][0]))
{
	$vc = count($this->vsaldosrc );
	
	for($i=0;$i<$vc;$i++)
	{
		$vnurecibo = "00/".$this->vsaldosrc[$i][0];
		$vidrecibo = $this->vsaldosrc[$i][1];
		
		 
      $nm_select = "select concat(prefijo,'/',numero) as cuenta from terceros_cuentas where tipo='RC' and  numero_documento='".$vnurecibo."' and tipo='INGRESO'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiTC2 = array();
      $this->vsitc2 = array();
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiTC2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsitc2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiTC2 = false;
          $this->vSiTC2_erro = $this->Db->ErrorMsg();
          $this->vsitc2 = false;
          $this->vsitc2_erro = $this->Db->ErrorMsg();
      } 
;
		
		if(isset($this->vsitc2[0][0]))
		{
			$vcu = $this->vsitc2[0][0];
			
     $nm_select = "update recibocaja set cod_cuenta='".$vcu."' where idrecibo='".$vidrecibo."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      $nm_select = "select nufac,resolucion,cliente,idrecibo from recibocaja"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vRC = array();
      $this->vrc = array();
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vRC[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vrc[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vRC = false;
          $this->vRC_erro = $this->Db->ErrorMsg();
          $this->vrc = false;
          $this->vrc_erro = $this->Db->ErrorMsg();
      } 
;
if(isset($this->vrc[0][0]))
{
	$vc = count($this->vrc );
	...
	for($i=0;$i<$vc;$i++)
	{
      ...
      $nm_select = "select concat(f.tipo,'/',r.prefijo,'/',f.numfacven) as numdoc from facturaven f inner join resdian r on f.resolucion=r.Idres where f.resolucion='".$vresd."' and f.idcli='".$vidcli."' and f.numfacven='".$vnufac."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiFV = array();
      $this->vsifv = array();
...
;
     ...
     $nm_select = "update recibocaja set doc_cobrado='".$vdoc."' where idrecibo='".$vidrec."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql = "select idpago,numpago,client,fecpago,montocan,docapagar from pagos";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vCE2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vce2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vCE2 = false;
          $this->vCE2_erro = $this->Db->ErrorMsg();
          $this->vce2 = false;
          $this->vce2_erro = $this->Db->ErrorMsg();
      } 
;

if(isset($this->vce2[0][0]))
{
	$vcant   = count($this->vce2 );
	
	for($a=0;$a<$vcant;$a++)
	{
		$vidpago = $this->vce2[$a][0];
		$vnump   = $this->vce2[$a][1];
		$vnump   = $vnump+1;
		$vcli    = $this->vce2[$a][2];
		$vfec    = $this->vce2[$a][3];
		$vmonto  = $this->vce2[$a][4]; 
		$vdoc    = $this->vce2[$a][5];  
		
		$vsql    = "select idpago,numpago,client,fecpago from pagos where idpago<>'".$vidpago."' and client='".$vcli."' and fecpago='".$vfec."' and montocan='".$vmonto."' and docapagar='".$vdoc."'";
...
;
		...
		{	
			$vsql = "delete from pagos where idpago='".$this->vsiexis[0][0]."'";
		}
		
		$fecha_actual = $vfec;
		$fecha_actual = date("Y-m-d",strtotime($fecha_actual."+ 1 days")); 
		
		$vsql    = "select idpago,numpago,client,fecpago from pagos where idpago<>'".$vidpago."' and client='".$vcli."' and fecpago='".$fecha_actual."' and montocan='".$vmonto."' and docapagar='".$vdoc."' and numpago='".$vnump."'";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExis2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexis2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiExis2 = false;
          $this->vSiExis2_erro = $this->Db->ErrorMsg();
          $this->vsiexis2 = false;
          $this->vsiexis2_erro = $this->Db->ErrorMsg();
      } 
;
		
		if(isset($this->vsiexis2[0][0]))
		{	
			$vsql = "delete from pagos where idpago='".$this->vsiexis2[0][0]."'";
		}
	}
}

$vsql = "select numpago,client,idpago from pagos";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vCE3[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vce3[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vCE3 = false;
          $this->vCE3_erro = $this->Db->ErrorMsg();
          $this->vce3 = false;
          $this->vce3_erro = $this->Db->ErrorMsg();
      } 
;
if(isset($this->vce3[0][0]))
{	
	for($a=0;$a<$vcant;$a++)
	{
		$vcant   = count($this->vce3 );
		$vnupa   = "00/".$this->vce3[$a][0];
		$vcli    = $this->vce3[$a][1];
		$vidp    = $this->vce3[$a][2];
		
		 
      $nm_select = "select concat(prefijo,'/',numero) as num from terceros_cuentas where ie='EGRESO' and tercero='".$vcli."' and numero_documento='".$vnupa."' and tipo='CE'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiE = array();
      $this->vsie = array();
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiE[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsie[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiE = false;
          $this->vSiE_erro = $this->Db->ErrorMsg();
          $this->vsie = false;
          $this->vsie_erro = $this->Db->ErrorMsg();
      } 
;
		
		if(isset($this->vsie[0][0]))
		{
			$vcodc = $this->vsie[0][0];
			
     $nm_select = "update pagos set cod_cuenta='".$vcodc."' where idpago='".$vidp."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$vsql = "select concat('00/',p.numpago) as numero from facturacom fc inner join pagos p on p.iddocapagar=fc.idfaccom where fc.formapago='CONTADO'";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vCE[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vce[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vCE = false;
          $this->vCE_erro = $this->Db->ErrorMsg();
          $this->vce = false;
          $this->vce_erro = $this->Db->ErrorMsg();
      } 
;

if(isset($this->vce[0][0]))
{
	$vcant   = count($this->vce );
	
	for($a=0;$a<$vcant;$a++)
	{
		$vnupago = $this->vce[$a][0];
		$vsql    = "delete from terceros_cuentas where tipo='CE' and numero_documento='".$vnupago."'";
     ...
     $nm_select = "update facturacom set saldo=total where pagada='NO'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      $nm_select = "select numfacom,formapago,total,pagada,asentada,saldo from facturacom"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vfaccom = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vfaccom[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->vfaccom = false;
          $this->vfaccom_erro = $this->Db->ErrorMsg();
      } 
;

if(isset($this->vfaccom[0][0]))
{
	$vcant = count($this->vfaccom );
	for($i=0;$i<$vcant;$i++)
	{
		$vnum = $this->vfaccom[$i][0];
		$vfp  = $this->vfaccom[$i][1];
		$vtot = $this->vfaccom[$i][2];
		$vpag = $this->vfaccom[$i][3];
		$vase = $this->vfaccom[$i][4];
		$vsal = $this->vfaccom[$i][5];
		
		 
      $nm_select = "select idtercero_cuenta from terceros_cuentas where tipo='FC' and numero_documento='00/".$vnum."' and tipo='EGRESO'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExisteFC = array();
      $this->vsiexistefc = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiExisteFC[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiexistefc[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vSiExisteFC = false;
          $this->vSiExisteFC_erro = $this->Db->ErrorMsg();
          $this->vsiexistefc = false;
          $this->vsiexistefc_erro = $this->Db->ErrorMsg();
      } 
;
		
		if(isset($this->vsiexistefc[0][0]))
		{
			$vidcuenta = $this->vsiexistefc[0][0];
				
			if($vfp=='CONTADO')
			{
				
     $nm_select = "delete from terceros_cuentas where idtercero_cuenta='".$vidcuenta."' and tipo='EGRESO'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      ;
			...
			{
				$vsql = "update terceros_cuentas set valor_total='".$vtot."',saldo='".$vsal."' where idtercero_cuenta='".$vidcuenta."' and tipo='EGRESO'";
     ...
     $nm_select = "update terceros_cuentas set valor_total=(if(valor_total>0,valor_total*-1,valor_total)),saldo=(if(saldo>0,saldo*-1,saldo)) where tipo in ('RS','FV') and tipo='INGRESO'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "update terceros_cuentas set valor_total=(if(valor_total<0,valor_total*-1,valor_total)),saldo=(if(saldo<0,saldo*-1,saldo)) where tipo='FC' and tipo='EGRESO'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "update terceros_cuentas set cod_cuenta=concat(prefijo,'/',numero) where tipo in('RS','FV') and tipo='INGRESO'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "update terceros_cuentas set cod_cuenta=concat(prefijo,'/',numero) where tipo in('FC') and tipo='EGRESO'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "update facturacom set asentada=asentada"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "update facturaven set asentada=asentada"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "update recibocaja set asentado=asentado"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "update terceros t set t.saldo=coalesce((select sum(c.valor_total) from terceros_cuentas c where c.tercero=t.idtercero and c.ie='INGRESO' and c.asentada='SI'),0)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select = "update terceros t set t.saldoapagar=coalesce((select sum(c.valor_total) from terceros_cuentas c where c.tercero=t.idtercero and c.ie='EGRESO' and c.asentada='SI'),0)"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
      ...
      $nm_select = "select prefijo from resdian where fecha>0"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vPJs = array();
      $this->vpjs = array();
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vPJs[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vpjs[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vPJs = false;
          $this->vPJs_erro = $this->Db->ErrorMsg();
          $this->vpjs = false;
          $this->vpjs_erro = $this->Db->ErrorMsg();
      } 
;
if(isset($this->vpjs[0][0]))
{
	$vcontador = count($this->vpjs );
	
	for($i=0;$i<$vcontador;$i++)
	{
		
		$vprefi = $this->vpjs[$i][0];
		
		$vsql1 = "select max(numero) as consecutivo from terceros_cuentas where ie='EGRESO' and prefijo='".$vprefi."'";
...
;
      ...
      $nm_select = "select consecutivo from consecutivos where tipodoc='TE' and prefijo='".$vprefi."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExis = array();
      $this->vsiexis = array();
...
;
			if(isset($this->vsiexis[0][0]))
			{
				$vsql2 = "update consecutivos set consecutivo='".$this->vcon[0][0]."' where prefijo='".$vprefi."' and tipodoc='TE'";
     ...
     $nm_select = $vsql2; 
      ...
      ;
			...
			{
				$vsql2 = "insert into consecutivos set tipodoc='TE',prefijo='".$vprefi."',consecutivo='".$this->vcon[0][0]."'";
...
;
			if(!isset($this->vsiexis[0][0]))
			{
				$vsql2 = "insert into consecutivos set tipodoc='TE',prefijo='".$vprefi."',consecutivo='1'";
     ...
     $nm_select = $vsql2; 
      ...
      ;
		...
		$vsql3 = "select max(numero) as consecutivo from terceros_cuentas where ie='INGRESO' and prefijo='".$vprefi."'";
      ...
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vCon2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vcon2[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vCon2 = false;
          $this->vCon2_erro = $this->Db->ErrorMsg();
          $this->vcon2 = false;
          $this->vcon2_erro = $this->Db->ErrorMsg();
      } 
;
		if(isset($this->vcon2[0][0]))
		{
			 
      $nm_select = "select consecutivo from consecutivos where tipodoc='TI' and prefijo='".$vprefi."'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiExis2 = array();
      $this->vsiexis2 = array();
...
;
			if(isset($this->vsiexis2[0][0]))
			{
				$vsql4 = "update consecutivos set consecutivo='".$this->vcon2[0][0]."' where prefijo='".$vprefi."' and tipodoc='TI'";
     ...
     $nm_select = $vsql4; 
      ...
      ;
			...
			{
				$vsql4 = "insert into consecutivos set tipodoc='TI',prefijo='".$vprefi."',consecutivo='".$this->vcon2[0][0]."'";
...
;
			if(!isset($this->vsiexis2[0][0]))
			{
				$vsql4 = "insert into consecutivos set tipodoc='TI',prefijo='".$vprefi."',consecutivo='1'";
     ...
     $nm_select = $vsql4; 
      ...
      $nm_select = "select doc,idcaja from caja where detalle='DOC TESORERIA'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vListaCaja = array();
      $this->vlistacaja = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vListaCaja[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vlistacaja[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $this->vListaCaja = false;
          $this->vListaCaja_erro = $this->Db->ErrorMsg();
          $this->vlistacaja = false;
          $this->vlistacaja_erro = $this->Db->ErrorMsg();
      } 
;
if(isset($this->vlistacaja[0][0]))
{
	$vcontar = count($this->vlistacaja );
	for($i=0;$i<$vcontar;$i++)
	{
		$vcuenta = $this->vlistacaja[$i][0];
		$vidcaja = $this->vlistacaja[$i][1];
		$vpartes = explode("/",$vcuenta);
		$vpj = $vpartes[0];
		$vnum= $vpartes[1];
		
		 
      $nm_select = "select idtercero_cuenta from terceros_cuentas where prefijo='".$vpj."' and numero='".$vnum."' and ie='EGRESO'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->vSiEx = array();
      $this->vsiex = array();
      ...
      { 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $this->vSiEx[$SCy] [$SCx] = $SCrx->fields[$SCx];
                        $this->vsiex[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
      ...
      { 
          $this->vSiEx = false;
          $this->vSiEx_erro = $this->Db->ErrorMsg();
          $this->vsiex = false;
          $this->vsiex_erro = $this->Db->ErrorMsg();
      } 
;
		
		if(!isset($this->vsiex[0][0]))
		{
			
     $nm_select = "delete from caja where idcaja='".$vidcaja."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['contr_erro'] = 'off'; 
//--- 
       $this->Db->Close(); 
       if ($this->Change_Menu)
       {
...
//======= =========================
   ...
   if (!empty($_POST))
   {
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_blank_recalcular_cuentas_ajax($nmgp_val);
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "blank_recalcular_cuentas_ajax") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv_2022'])) {
               $_SESSION['scriptcase']['blank_recalcular_cuentas_ajax']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv_2022'];
           }
       }
   }
   ...
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['iframe_menu']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "blank_recalcular_cuentas_ajax";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'blank_recalcular_cuentas_ajax' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['iframe_menu'] = $salva_iframe;
   }

   if (!isset($_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('blank_recalcular_cuentas_ajax' == $sReferer || 'blank_recalcular_cuentas_ajax_' == substr($sReferer, 0, 30))
       {
           $_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['initialize'] = false;
       }
       else
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'blank_recalcular_cuentas_ajax')
   {
       $_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['blank_recalcular_cuentas_ajax']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/blank_recalcular_cuentas_ajax_erro.php");
   }
   if (!empty($nmgp_parms)) 
   { 
       ...
       while (!empty($todo[$ix]))
       {
            ...
            if (1 < sizeof($cadapar))
            {
                ...
                nm_limpa_str_blank_recalcular_cuentas_ajax($cadapar[1]);
   ...
   $contr_blank_recalcular_cuentas_ajax = new blank_recalcular_cuentas_ajax_apl();
   $contr_blank_recalcular_cuentas_ajax->controle();
//
   function nm_limpa_str_blank_recalcular_cuentas_ajax(&$str)
   {
