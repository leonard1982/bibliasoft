...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_facturaven_pos_mini"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_facturaven_pos_mini"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos_mini']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos_mini']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos_mini']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos_mini']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos_mini']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_facturaven_pos_mini</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos_mini']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_facturaven_pos_mini']['embutida_filho'] as $ind => $sc_init)
          {
