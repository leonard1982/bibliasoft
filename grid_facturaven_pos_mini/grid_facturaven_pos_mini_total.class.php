...
class grid_facturaven_pos_mini_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_facturaven_pos_mini']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_facturaven_pos_mini']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $idcli, $vendedor, $banco, $resolucion;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
      ...
      if ($rt->fields[0] == 0)
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['interativ_search']))
          {
              $Contrl_Interat = 1;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['interativ_search'] = array();
              $this->quebra_geral_fecha();
          }
          
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][0] = "Total venta y descuento"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][3] = $rt->fields[2]; 
      $rt->fields[3] = str_replace(",", ".", $rt->fields[3]);
      $rt->fields[3] = (string)$rt->fields[3]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][4] = $rt->fields[3]; 
      $rt->fields[4] = str_replace(",", ".", $rt->fields[4]);
      $rt->fields[4] = (string)$rt->fields[4]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][5] = $rt->fields[4]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['contr_total_geral'] = "OK";
   } 
   ...
   {
      global $tot_fechaven, $idcli, $vendedor, $banco, $resolucion;
      $tot_fechaven = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   function quebra_credito_sc_free_group_by($credito, $Where_qb, $Cmp_Name) 
   {
      ...
      global $$Var_name_gb, $idcli, $vendedor, $banco, $resolucion;
      $tot_credito = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   function quebra_idcli_sc_free_group_by($idcli, $Where_qb, $Cmp_Name) 
   {
      ...
      $tot_idcli[0] = NM_encode_input(sc_strip_script($idcli)) ; 
   ...
   {
      global $tot_credito, $idcli, $vendedor, $banco, $resolucion;
      $tot_credito = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   {
      global $tot_idcli, $idcli, $vendedor, $banco, $resolucion;
      $tot_idcli = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   {
      global $tot_resolucion, $idcli, $vendedor, $banco, $resolucion;
      $tot_resolucion = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   {
      global $tot_tipo, $idcli, $vendedor, $banco, $resolucion;
      $tot_tipo = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   {
      global $tot_vendedor, $idcli, $vendedor, $banco, $resolucion;
      $tot_vendedor = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   {
      global $tot_asentada, $idcli, $vendedor, $banco, $resolucion;
      $tot_asentada = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   {
      global $tot_pagada, $idcli, $vendedor, $banco, $resolucion;
      $tot_pagada = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   {
      global $tot_banco, $idcli, $vendedor, $banco, $resolucion;
      $tot_banco = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional) from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
   ...
   {
      global $nm_lang, $editarpos, $imprimircopia, $a4, $existeentns, $imprimir, $idcli, $vendedor, $banco, $resolucion;
      $this->nm_data = new nm_data("es");
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['sql_tot_res']);
      ...
      $ind_qb                = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['SC_Ind_Groupby'];
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_fecha($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('idfacven' => 'N','numfacven' => 'N','credito' => 'N','idcli' => 'N','subtotal' => 'N','valoriva' => 'N','total' => 'N','asentada' => 'N','saldo' => 'N','adicional' => 'N','adicional2' => 'N','adicional3' => 'N','resolucion' => 'N','vendedor' => 'N','usuario_crea' => 'N','banco' => 'N','dias_decredito' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(total), sum(subtotal), sum(valoriva), sum(adicional)#@#cmps_quebras#@# from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) sc_sel_esp " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1), sum(SC_metric2), sum(SC_metric3), sum(SC_metric4)#@#cmps_quebras#@# from (";
         $comando .= "select total as SC_metric1,subtotal as SC_metric2,valoriva as SC_metric3,adicional as SC_metric4, " . $cmps_quebras1 . " from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) sc_sel_esp1 " . $where_ok . ") SC_sel1 INNER JOIN (";
         $comando .= "select " . $cmps_quebras2 . " from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) sc_sel_esp2 " . $where_ok . " group by " . $group . $sc_having . ") SC_sel2 ";
         $comando .= " ON " . $join;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
