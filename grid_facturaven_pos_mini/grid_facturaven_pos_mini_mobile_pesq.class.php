...
class grid_facturaven_pos_mini_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_facturaven_pos_mini_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_facturaven_pos_mini_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_facturaven_pos_mini_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fechaven";$Nm_datas[] = "fechaven";$Nm_datas[] = "fechavenc";$Nm_datas[] = "fechavenc";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";$Nm_datas[] = "inicio";$Nm_datas[] = "inicio";$Nm_datas[] = "fin";$Nm_datas[] = "fin";$Nm_numeric[] = "idfacven";$Nm_numeric[] = "numfacven";$Nm_numeric[] = "credito";$Nm_numeric[] = "idcli";$Nm_numeric[] = "subtotal";$Nm_numeric[] = "valoriva";$Nm_numeric[] = "total";$Nm_numeric[] = "asentada";$Nm_numeric[] = "saldo";$Nm_numeric[] = "adicional";$Nm_numeric[] = "adicional2";$Nm_numeric[] = "adicional3";$Nm_numeric[] = "resolucion";$Nm_numeric[] = "vendedor";$Nm_numeric[] = "usuario_crea";$Nm_numeric[] = "banco";$Nm_numeric[] = "dias_decredito";
      ...
      $Nm_datas[] = "fechaven";$Nm_datas[] = "fechaven";$Nm_datas[] = "fechavenc";$Nm_datas[] = "fechavenc";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";$Nm_datas[] = "inicio";$Nm_datas[] = "inicio";$Nm_datas[] = "fin";$Nm_datas[] = "fin";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_facturaven_pos_mini/grid_facturaven_pos_mini_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_facturaven_pos_mini_ajax_search.js"></script>
 <script type="text/javascript" src="grid_facturaven_pos_mini_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_facturaven_pos_mini_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_facturaven_pos_mini']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_facturaven_pos_mini']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_facturaven_pos_mini", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['tipo']; 
          $tipo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['tipo_cond']; 
          $fechaven_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_dia']; 
          $fechaven_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_mes']; 
          $fechaven_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_ano']; 
          $fechaven_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_input_2_dia']; 
          $fechaven_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_input_2_mes']; 
          $fechaven_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_input_2_ano']; 
          $fechaven_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_cond']; 
          $idcli = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['idcli']; 
          $idcli_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['idcli_cond']; 
          $asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['asentada']; 
          $asentada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['asentada_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['NM_operador']; 
      } 
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['psq_check_ret']['tipo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['psq_check_ret']['tipo'][] = "RS";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['psq_check_ret']['tipo'][] = "FV";
 ?>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['psq_check_ret']['asentada'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['psq_check_ret']['asentada'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['psq_check_ret']['asentada'][] = "0";
 ?>
...
<?php
   if (is_file("grid_facturaven_pos_mini_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['sc_modal'])
       {
?>
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fechaven_dia').bind('change', function() {sc_grid_facturaven_pos_mini_valida_dia(this)});
    $('#SC_fechaven_input_2_dia').bind('change', function() {sc_grid_facturaven_pos_mini_valida_dia(this)});
    $('#SC_fechaven_input_2_mes').bind('change', function() {sc_grid_facturaven_pos_mini_valida_mes(this)});
    $('#SC_fechaven_mes').bind('change', function() {sc_grid_facturaven_pos_mini_valida_mes(this)});
 }
 function sc_grid_facturaven_pos_mini_valida_dia(obj)
 {
 ...
 function sc_grid_facturaven_pos_mini_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['psq_check_ret']['tipo'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['psq_check_ret']['asentada'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['tipo'] = $tipo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['tipo_cond'] = $tipo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_dia'] = $fechaven_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_mes'] = $fechaven_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_ano'] = $fechaven_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_input_2_dia'] = $fechaven_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_input_2_mes'] = $fechaven_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_input_2_ano'] = $fechaven_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_cond'] = $fechaven_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['idcli'] = $idcli; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['idcli_cond'] = $idcli_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['asentada'] = $asentada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['asentada_cond'] = $asentada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if ($fechaven_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven'] = $val[0];
          ...
          if ($fechaven_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']['fechaven_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'] .= $this->NM_operador;
