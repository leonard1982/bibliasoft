...
class grid_facturaven_pos_mini_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_facturaven_pos_mini'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_facturaven_pos_mini'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_mini']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_mini']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_mini']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_facturaven_pos_mini']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_facturaven_pos_mini']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['campos_busca'];
...
$_SESSION['scriptcase']['grid_facturaven_pos_mini']['contr_erro'] = 'off'; 
       $this->SC_Buf_onInit = ob_get_clean();; 
         ...
         {   
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq'] .= $this->nm_where_dinamico;
         }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['contr_total_geral'] == "OK")
      {
          $this->array_total_asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['arr_total']['asentada'];
      }
      else
      {
          $this->array_total_asentada = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][5];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][3];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][4];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['arr_total']['asentada'] = $this->array_total_asentada;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['json_use_label'])
       {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['asentada'] = $Lab_asentada; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['fechaven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['fechaven'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['numero2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['numero2'] = "No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['credito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['credito'] = "F.Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['idcli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['idcli'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['vendedor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['vendedor'] = "Vendedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['banco']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['banco'] = "Caja"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['detalleventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['detalleventa'] = "detalle"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['editarpos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['editarpos'] = "Editar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['imprimircopia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['imprimircopia'] = "POS"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['a4']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['a4'] = "A4"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['idfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['idfacven'] = "Idfacven"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['numfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['numfacven'] = "No"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['fechavenc'] = "Fechavenc"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['subtotal'] = "SubTotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['valoriva'] = "IVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['asentada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['asentada'] = "Asentada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['adicional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['adicional'] = "Desc."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['adicional2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['adicional2'] = "Adicional 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['adicional3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['adicional3'] = "Adicional 3"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['resolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['resolucion'] = "PJ"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['creado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['creado'] = "Creado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['editado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['editado'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['usuario_crea']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['usuario_crea'] = "Usuario Crea"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['inicio']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['inicio'] = "Inicio"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['fin']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['fin'] = "Fin"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['dias_decredito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['dias_decredito'] = "Dias Decredito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['cod_cuenta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['cod_cuenta'] = "Cod Cuenta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['existeentns']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['existeentns'] = "TNS"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['imprimir']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['imprimir'] = "PDF"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['enviada_a_tns']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['enviada_a_tns'] = "Enviada A Tns"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['fecha_a_tns']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['fecha_a_tns'] = "Fecha A Tns"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['factura_tns']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['labels']['factura_tns'] = "Factura Tns"; 
       }
       //-----
       $this->comp_field_nm = array(
           'asentada' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_order']['porasentada']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_order']['porasentada'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_order']['porasentada'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_display']['porasentada'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_display']['porasentada'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_display']['porasentada'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_display']['porasentada'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_display']['porasentada'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_display']['porasentada'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['summarizing_fields_display']['porasentada'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_asentada as $i_asentada => $d_asentada) {
           if (!in_array($i_asentada, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_asentada[7] ] = $d_asentada[6];
               $this->comp_label[0][ $d_asentada[7] ] = $d_asentada[6];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_facturaven_pos_mini@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['proc_pdf_vert'])
   {
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_facturaven_pos_mini_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_facturaven_pos_mini_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_facturaven_pos_mini']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_facturaven_pos_mini']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_facturaven_pos_mini']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_facturaven_pos_mini']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_facturaven_pos_mini_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      $this->Total   = new grid_facturaven_pos_mini_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_facturaven_pos_mini_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_facturaven_pos_mini_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_facturaven_pos_mini_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_facturaven_pos_mini/grid_facturaven_pos_mini_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_pos_mini_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_pos_mini_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_pos_mini_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['num_css'] . '.css');
...
$nm_saida->saida("      url: \"grid_facturaven_pos_mini_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "", "", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_facturaven_pos_mini/grid_facturaven_pos_mini_config_pdf.php?nm_opc=pdf_res&nm_target=0&nm_cor=cor&papel=1&orientacao=1&bookmarks=1&largura=1200&conf_larg=S&conf_fonte=10&grafico=S&sc_ver_93=" . s . "&nm_tem_gb=s&nm_res_cons=s&nm_ini_pdf_res=resume,chart&nm_all_modules=grid,resume,chart&password=n&summary_export_columns=N&nm_label_group=S&nm_all_cab=N&nm_all_label=N&pdf_zip=N&nm_orient_grid=2&origem=res&language=es&conf_socor=S&script_case_init=" . $this->Ini->sc_page . "&app_name=grid_facturaven_pos_mini&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_facturaven_pos_mini/grid_facturaven_pos_mini_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_facturaven_pos_mini/grid_facturaven_pos_mini_config_graf_flash.php?nome_apl=grid_facturaven_pos_mini&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_facturaven_pos_mini/grid_facturaven_pos_mini_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_facturaven_pos_mini/grid_facturaven_pos_mini_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_facturaven_pos_mini_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_facturaven_pos_mini_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_facturaven_pos_mini']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_facturaven_pos_mini']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_facturaven_pos_mini_config_pivot.php?nome_apl=grid_facturaven_pos_mini&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_facturaven_pos_mini_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_facturaven_pos_mini/grid_facturaven_pos_mini_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_facturaven_pos_mini_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_facturaven_pos_mini_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_facturaven_pos_mini_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['grid_facturaven_pos_mini_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_facturaven_pos_mini@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_pos_mini_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_facturaven_pos_mini/grid_facturaven_pos_mini_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_facturaven_pos_mini_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_facturaven_pos_mini_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_adicional, $quebra_asentada, $quebra_asentada_orig)
   {
      //----- Asentada
      if (!isset($this->array_total_asentada[$quebra_asentada_orig]))
      {
         $this->array_total_asentada[$quebra_asentada_orig][0] = 1;
         $this->array_total_asentada[$quebra_asentada_orig][1] = $sum_total;
         $this->array_total_asentada[$quebra_asentada_orig][2] = $sum_subtotal;
         $this->array_total_asentada[$quebra_asentada_orig][3] = $sum_valoriva;
         $this->array_total_asentada[$quebra_asentada_orig][4] = $sum_adicional;
         $this->array_total_asentada[$quebra_asentada_orig][5] = 1;
         $this->array_total_asentada[$quebra_asentada_orig][6] = $quebra_asentada;
         $this->array_total_asentada[$quebra_asentada_orig][7] = $quebra_asentada_orig;
      }
      else
      {
         ...
         $this->array_total_asentada[$quebra_asentada_orig][3] += $sum_valoriva;
         $this->array_total_asentada[$quebra_asentada_orig][4] += $sum_adicional;
         $this->array_total_asentada[$quebra_asentada_orig][5]++;
      }
   }
...
$_SESSION['scriptcase']['grid_facturaven_pos_mini']['contr_erro'] = 'off'; 
     ...
     { 
         $nmgp_select = "SELECT str_replace (convert(char(10),fechaven,102), '.', '-') + ' ' + convert(char(8),fechaven,20), numero2, credito, idcli, total, vendedor, banco, idfacven, numfacven, str_replace (convert(char(10),fechavenc,102), '.', '-') + ' ' + convert(char(8),fechavenc,20), subtotal, valoriva, pagada, asentada, observaciones, saldo, adicional, adicional2, adicional3, resolucion, str_replace (convert(char(10),creado,102), '.', '-') + ' ' + convert(char(8),creado,20), str_replace (convert(char(10),editado,102), '.', '-') + ' ' + convert(char(8),editado,20), usuario_crea, str_replace (convert(char(10),inicio,102), '.', '-') + ' ' + convert(char(8),inicio,20), str_replace (convert(char(10),fin,102), '.', '-') + ' ' + convert(char(8),fin,20), dias_decredito, tipo, cod_cuenta, enviada_a_tns, factura_tns from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp"; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT fechaven, numero2, credito, idcli, total, vendedor, banco, idfacven, numfacven, fechavenc, subtotal, valoriva, pagada, asentada, observaciones, saldo, adicional, adicional2, adicional3, resolucion, creado, editado, usuario_crea, inicio, fin, dias_decredito, tipo, cod_cuenta, enviada_a_tns, factura_tns from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp"; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT convert(char(23),fechaven,121), numero2, credito, idcli, total, vendedor, banco, idfacven, numfacven, convert(char(23),fechavenc,121), subtotal, valoriva, pagada, asentada, observaciones, saldo, adicional, adicional2, adicional3, resolucion, convert(char(23),creado,121), convert(char(23),editado,121), usuario_crea, convert(char(23),inicio,121), convert(char(23),fin,121), dias_decredito, tipo, cod_cuenta, enviada_a_tns, factura_tns from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp"; 
     } 
     else 
     { 
         $nmgp_select = "SELECT fechaven, numero2, credito, idcli, total, vendedor, banco, idfacven, numfacven, fechavenc, subtotal, valoriva, pagada, asentada, observaciones, saldo, adicional, adicional2, adicional3, resolucion, creado, editado, usuario_crea, inicio, fin, dias_decredito, tipo, cod_cuenta, enviada_a_tns, factura_tns from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,     vendedor,     creado,     editado,     usuario_crea,     creado as inicio,     creado as fin,     banco,     dias_decredito,     enviada_a_tns,     fecha_a_tns,     factura_tns,     tipo,     cod_cuenta,     concat(tipo,'/',(select r.prefijo from resdian r where r.Idres=f.resolucion),'/',numfacven) as numero2 FROM      facturaven f WHERE           espos = 'SI' ) nm_sel_esp"; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_pos_mini']['where_pesq']; 
     $campos_order = "";
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->numero2 = $rs_res->fields[1] ;  
            $this->credito = $rs_res->fields[2] ;  
            $this->idcli = $rs_res->fields[3] ;  
            $this->total = $rs_res->fields[4] ;  
            $this->total =  str_replace(",", ".", $this->total);
            $this->vendedor = $rs_res->fields[5] ;  
            $this->banco = $rs_res->fields[6] ;  
            $this->idfacven = $rs_res->fields[7] ;  
            $this->numfacven = $rs_res->fields[8] ;  
            ...
            $this->pagada = $rs_res->fields[12] ;  
            $this->asentada = $rs_res->fields[13] ;  
            $this->observaciones = $rs_res->fields[14] ;  
            $this->saldo = $rs_res->fields[15] ;  
            $this->saldo =  str_replace(",", ".", $this->saldo);
            $this->adicional = $rs_res->fields[16] ;  
            $this->adicional =  str_replace(",", ".", $this->adicional);
            $this->adicional2 = $rs_res->fields[17] ;  
            $this->adicional3 = $rs_res->fields[18] ;  
            $this->resolucion = $rs_res->fields[19] ;  
            $this->creado = $rs_res->fields[20] ;  
            $this->editado = $rs_res->fields[21] ;  
            $this->usuario_crea = $rs_res->fields[22] ;  
            $this->inicio = $rs_res->fields[23] ;  
            $this->fin = $rs_res->fields[24] ;  
            $this->dias_decredito = $rs_res->fields[25] ;  
            $this->tipo = $rs_res->fields[26] ;  
            $this->cod_cuenta = $rs_res->fields[27] ;  
            $this->enviada_a_tns = $rs_res->fields[28] ;  
            $this->factura_tns = $rs_res->fields[29] ;  
  ...
  if($this->tipo =="FV")
{
$this->NM_field_style["fechaven"] = "background-color:#cad9e9;font-size:15px;color:#000000;font-family:arial;font-weight:sans-serif;";
}

if($this->tipo =="RS")
{
$this->NM_field_style["fechaven"] = "background-color:#f0ad4e;font-size:15px;color:#000000;font-family:arial;font-weight:sans-serif;";
}

if($this->credito =="2")
{
$this->NM_field_style["credito"] = "background-color:#29abe2;font-size:15px;color:#000000;font-family:arial;font-weight:sans-serif;";
}
else
{
$this->NM_field_style["credito"] = "background-color:#ffa0a3;font-size:15px;color:#000000;font-family:arial;font-weight:sans-serif;";
}
...
if($this->asentada =="1")
{
	...
	$this->NM_field_style["numero2"] = "background-color:#33ff99;font-size:15px;color:#000000;font-family:arial;font-weight:sans-serif;";
...
$_SESSION['scriptcase']['grid_facturaven_pos_mini']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->adicional, $this->asentada, $this->asentada_orig);
            }
   }
//
