...
function scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['consultar_productos_ajax_autocompletar']['contr_erro']) && $_SESSION['scriptcase']['consultar_productos_ajax_autocompletar']['contr_erro'] == 'on')
    {
