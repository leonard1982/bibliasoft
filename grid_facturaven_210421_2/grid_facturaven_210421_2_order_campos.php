...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_210421_2_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_210421_2_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select_orig'] = array();
   }
...
ORDER BY tipo";
   ...
   $tab_labels["tipo_doc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["tipo_doc"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["tipo_doc"] : "TIPO";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["resolucion"] : "PJ";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["numfacven"] : "Número";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["total"] : "Total";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["pagada"] : "Pagada";
   $tab_ger_campos['asentada'] = "on";
   $tab_def_campos['asentada'] = "asentada";
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["credito"] : "Crédito";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["imprimir"] : "imprimir";
   ...
   $tab_labels["imprmirtirilla"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["imprmirtirilla"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['labels']["imprmirtirilla"] : "POS";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['graf_lab'] = "";
?>
    <script language="javascript"> 
<?php
   if (!$embbed)
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_210421_2_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturaven_210421_2']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
