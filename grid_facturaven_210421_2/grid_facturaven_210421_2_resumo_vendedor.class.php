...
class grid_facturaven_210421_2_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_facturaven_210421_2'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_facturaven_210421_2'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_210421_2']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_210421_2']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_210421_2']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$this->Graf         = new grid_facturaven_210421_2_grafico();
		$this->Graf->Db     = $this->Db;
		$this->Graf->Erro   = $this->Erro;
		$this->Graf->Ini    = $this->Ini;
		$this->Graf->Lookup = $this->Lookup;

		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_facturaven_210421_2']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_facturaven_210421_2']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['campos_busca'];
      ...
      $this->nm_where_dinamico = "";
       ob_start(); 
      $_SESSION['scriptcase']['grid_facturaven_210421_2']['contr_erro'] = 'on';
 ;
;
...
$_SESSION['scriptcase']['grid_facturaven_210421_2']['contr_erro'] = 'off'; 
       $this->SC_Buf_onInit = ob_get_clean();; 
         if  (!empty($this->nm_where_dinamico)) 
         {   
             $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['where_pesq'] .= $this->nm_where_dinamico;
         }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_facturaven_210421_2", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['contr_total_geral'] == "OK")
      {
          $this->array_total_vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['arr_total']['vendedor'];
      }
      else
      {
          $this->array_total_vendedor = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][1];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][2];
      $this->array_total_geral[2] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][3];
      $this->array_total_geral[3] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][4];
      $this->array_total_geral[4] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][5];
      $this->array_total_geral[5] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][6];
      $this->array_total_geral[6] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][7];
      $this->array_total_geral[7] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][8];
      $this->array_total_geral[8] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][9];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['arr_total']['vendedor'] = $this->array_total_vendedor;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['tipo_doc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['tipo_doc'] = "TIPO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['resolucion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['resolucion'] = "PJ"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['numfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['numfacven'] = "Número"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['idcli']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['idcli'] = "Cliente"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['fechaven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['fechaven'] = "Fecha"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['total'] = "Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['pagada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['pagada'] = "Pagada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['asentada']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['asentada'] = "Asentada"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['credito']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['credito'] = "Crédito"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['detalleventa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['detalleventa'] = "Venta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['imprimir']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['imprimir'] = "imprimir"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['imprmirtirilla']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['imprmirtirilla'] = "POS"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['idfacven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['idfacven'] = "Idfacven"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['fechavenc']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['fechavenc'] = "Vence"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['subtotal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['subtotal'] = "SubTotal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['valoriva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['valoriva'] = "Tot. Imp."; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['saldo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['saldo'] = "Saldo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['adicional']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['adicional'] = "Adicional"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['adicional2']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['adicional2'] = "Adicional 2"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['adicional3']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['adicional3'] = "Adicional 3"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['vendedor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['vendedor'] = "Vendedor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['pedido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['pedido'] = "Pedido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['base_iva_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['base_iva_19'] = "Base IVA 19"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['valor_iva_19']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['valor_iva_19'] = "Valor IVA 19"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['base_iva_5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['base_iva_5'] = "Base IVA 5"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['valor_iva_5']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['valor_iva_5'] = "Valor IVA 5"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['excento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['excento'] = "Excento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['base_con_8']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['base_con_8'] = "Base ICON. 8"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['valor_con_8']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['valor_con_8'] = "Valor ICON. 8"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['t_iva']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['t_iva'] = "T. IVA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['print']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['print'] = "print"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['tipo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['tipo'] = "Tipo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['enviarfe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['enviarfe'] = "Enviar"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['estadofe']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['estadofe'] = "Estado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['pdf']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['labels']['pdf'] = "PDF"; 
       }
       //-----
       $this->comp_field_nm = array(
           'vendedor' => 0,
       ...
       $this->comp_sum = array(
           ...
           3 => "Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           4 => "SubTotal(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           5 => "IVA(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           6 => "Base Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           7 => "Valor Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           8 => "Base Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           9 => "Valor Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           10 => "Excento(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_order']['vendedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_order']['vendedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_order']['vendedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['vendedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['vendedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['vendedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['vendedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['vendedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['vendedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['vendedor'] as $i_sum => $d_sum)
           {
       ...
       $this->comp_sum_lnk = array(
           ...
           4 => array('field' => "subtotal", 'show' => true),
           5 => array('field' => "valoriva", 'show' => true),
           6 => array('field' => "base_iva_19", 'show' => true),
           7 => array('field' => "valor_iva_19", 'show' => true),
           8 => array('field' => "base_iva_5", 'show' => true),
           9 => array('field' => "valor_iva_5", 'show' => true),
           10 => array('field' => "excento", 'show' => true),
       );
       ...
       $this->comp_sum_css = array(
           ...
           4 => "css_subtotal_sum",
           5 => "css_valoriva_sum",
           6 => "css_base_iva_19_sum",
           7 => "css_valor_iva_19_sum",
           8 => "css_base_iva_5_sum",
           9 => "css_valor_iva_5_sum",
           10 => "css_excento_sum",
       );
       ...
       //-----
       foreach ($this->array_total_vendedor as $i_vendedor => $d_vendedor) {
           if (!in_array($i_vendedor, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_vendedor[11] ] = $d_vendedor[10];
               $this->comp_label[0][ $d_vendedor[11] ] = $d_vendedor[10];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_vendedor => $l_vendedor) {
           if (isset($this->array_total_vendedor[$i_vendedor])) {
               $this->comp_group[$i_vendedor] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_vendedor;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_facturaven_210421_2@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['proc_pdf_vert'])
   {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           ...
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'vendedor',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_vendedor)),
               'label_y'  => $this->getChartText(strip_tags("Total Venta(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
           ...
           '0|5' => array(
               'title'    => $this->getChartText(strip_tags("Base Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'vendedor',
               'field_y'  => $this->comp_sum_nm[6],
               'label_x'  => $this->getChartText(strip_tags($Lab_vendedor)),
               'label_y'  => $this->getChartText(strip_tags("Base Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(5),
           ),
           '0|6' => array(
               'title'    => $this->getChartText(strip_tags("Valor Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'vendedor',
               'field_y'  => $this->comp_sum_nm[7],
               'label_x'  => $this->getChartText(strip_tags($Lab_vendedor)),
               'label_y'  => $this->getChartText(strip_tags("Valor Iva 19(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(6),
           ),
           '0|7' => array(
               'title'    => $this->getChartText(strip_tags("Base Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'vendedor',
               'field_y'  => $this->comp_sum_nm[8],
               'label_x'  => $this->getChartText(strip_tags($Lab_vendedor)),
               'label_y'  => $this->getChartText(strip_tags("Base Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(7),
           ),
           '0|8' => array(
               'title'    => $this->getChartText(strip_tags("Valor Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'vendedor',
               'field_y'  => $this->comp_sum_nm[9],
               'label_x'  => $this->getChartText(strip_tags($Lab_vendedor)),
               'label_y'  => $this->getChartText(strip_tags("Valor Iva 5(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_facturaven_210421_2_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_facturaven_210421_2_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['arr_export']['data']  = $this->build_data;
           return;
       }

       $nm_saida->saida("<tr id=\"summary_body\">\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['ajax_nav'])
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
       } 
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function drawMatrixLabels()
   {
       ...
       $nm_saida->saida("    <script type=\"text/javascript\">\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['embutida'])
       { 
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_facturaven_210421_2']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_facturaven_210421_2']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_facturaven_210421_2']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_facturaven_210421_2']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_facturaven_210421_2_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] = "print";
      ...
      $this->Total   = new grid_facturaven_210421_2_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_vendedor("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_vendedor);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['doc_word'])
{
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_facturaven_210421_2_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_facturaven_210421_2_jquery.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_facturaven_210421_2_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_facturaven_210421_2/grid_facturaven_210421_2_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_210421_2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_210421_2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_210421_2_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['num_css'] . '.css');
...
$nm_saida->saida("      url: \"grid_facturaven_210421_2_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_facturaven_210421_2/grid_facturaven_210421_2_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_facturaven_210421_2/grid_facturaven_210421_2_config_graf_flash.php?nome_apl=grid_facturaven_210421_2&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_facturaven_210421_2/grid_facturaven_210421_2_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_facturaven_210421_2/grid_facturaven_210421_2_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_facturaven_210421_2_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_facturaven_210421_2_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_facturaven_210421_2']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_facturaven_210421_2']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_facturaven_210421_2_config_pivot.php?nome_apl=grid_facturaven_210421_2&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_facturaven_210421_2_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_facturaven_210421_2/grid_facturaven_210421_2_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=\"+ str_type +\"&sAdd=__E__nmgp_cor_word=\" + cor + \"__E__SC_module_export=\" + SC_module_export + \"__E__nmgp_password=\" + password + \"&KeepThis=true&TB_iframe=true&modal=true\", bol_param);\r\n");
      $nm_saida->saida("       }\r\n");
      $nm_saida->saida("       else\r\n");
      $nm_saida->saida("       {\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_facturaven_210421_2_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_facturaven_210421_2_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_facturaven_210421_2_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['grid_facturaven_210421_2_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_facturaven_210421_2@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_facturaven_210421_2_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_facturaven_210421_2/grid_facturaven_210421_2_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_facturaven_210421_2_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_facturaven_210421_2_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $numfacven = $Busca_temp['numfacven']; 
          $tmp_pos = strpos($numfacven, "##@@");
          if ($tmp_pos !== false && !is_array($numfacven))
          {
          ...
          $observaciones = $Busca_temp['observaciones']; 
          $tmp_pos = strpos($observaciones, "##@@");
          if ($tmp_pos !== false && !is_array($observaciones))
          {
          ...
          $credito = $Busca_temp['credito']; 
          $tmp_pos = strpos($credito, "##@@");
          if ($tmp_pos !== false && !is_array($credito))
          {
              $credito = substr($credito, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $quebra_vendedor, $quebra_vendedor_orig)
   {
      //----- Vendedor
      if (!isset($this->array_total_vendedor[$quebra_vendedor_orig]))
      {
         $this->array_total_vendedor[$quebra_vendedor_orig][0] = 1;
         $this->array_total_vendedor[$quebra_vendedor_orig][1] = $sum_total;
         $this->array_total_vendedor[$quebra_vendedor_orig][2] = $sum_subtotal;
         $this->array_total_vendedor[$quebra_vendedor_orig][3] = $sum_valoriva;
         $this->array_total_vendedor[$quebra_vendedor_orig][4] = $sum_base_iva_19;
         $this->array_total_vendedor[$quebra_vendedor_orig][5] = $sum_valor_iva_19;
         $this->array_total_vendedor[$quebra_vendedor_orig][6] = $sum_base_iva_5;
         $this->array_total_vendedor[$quebra_vendedor_orig][7] = $sum_valor_iva_5;
         $this->array_total_vendedor[$quebra_vendedor_orig][8] = $sum_excento;
         $this->array_total_vendedor[$quebra_vendedor_orig][9] = 1;
         $this->array_total_vendedor[$quebra_vendedor_orig][10] = $quebra_vendedor;
         $this->array_total_vendedor[$quebra_vendedor_orig][11] = $quebra_vendedor_orig;
      }
      else
      {
         $this->array_total_vendedor[$quebra_vendedor_orig][0]++;
         $this->array_total_vendedor[$quebra_vendedor_orig][1] += $sum_total;
         $this->array_total_vendedor[$quebra_vendedor_orig][2] += $sum_subtotal;
         $this->array_total_vendedor[$quebra_vendedor_orig][3] += $sum_valoriva;
         $this->array_total_vendedor[$quebra_vendedor_orig][4] += $sum_base_iva_19;
         ...
         $this->array_total_vendedor[$quebra_vendedor_orig][7] += $sum_valor_iva_5;
         $this->array_total_vendedor[$quebra_vendedor_orig][8] += $sum_excento;
         $this->array_total_vendedor[$quebra_vendedor_orig][9]++;
      }
   }
...
$_SESSION['scriptcase']['grid_facturaven_210421_2']['contr_erro'] = 'off'; 
     ...
     { 
         $nmgp_select = "SELECT resolucion, numfacven, idcli, str_replace (convert(char(10),fechaven,102), '.', '-') + ' ' + convert(char(8),fechaven,20), total, pagada, asentada, credito, idfacven, str_replace (convert(char(10),fechavenc,102), '.', '-') + ' ' + convert(char(8),fechavenc,20), subtotal, valoriva, observaciones, saldo, adicional, adicional2, adicional3, vendedor, pedido, base_iva_19, valor_iva_19, base_iva_5, valor_iva_5, excento, base_con_8, valor_con_8, t_iva, tipo from (SELECT      idfacven,     numfacven,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,      vendedor,     pedido,      resolucion,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='19'),0) as base_iva_19,     coalesce((select sum(v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='19'),0) as valor_iva_19,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='5'),0) as base_iva_5,     coalesce((select sum(v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='5'),0) as valor_iva_5,     coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='0'),0) as excento,    tipo, coalesce((select sum(v.valorpar-v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='8'),0) as base_con_8, coalesce((select sum(v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='8'),0) as valor_con_8, (valoriva - coalesce((select sum(v.iva) from detalleventa v where v.numfac=idfacven and v.adicional='8'),0) ) as t_iva FROM      facturaven WHERE     numfacven!=0 ) nm_sel_esp"; 
     } 
     ...
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['where_pesq']; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'vendedor');
     $campos_order = $this->Ini->Get_date_order_groupby("vendedor", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->resolucion = $rs_res->fields[0] ;  
            $this->numfacven = $rs_res->fields[1] ;  
            $this->idcli = $rs_res->fields[2] ;  
            $this->fechaven = $rs_res->fields[3] ;  
            $this->total = $rs_res->fields[4] ;  
            $this->total =  str_replace(",", ".", $this->total);
            $this->pagada = $rs_res->fields[5] ;  
            $this->asentada = $rs_res->fields[6] ;  
            $this->credito = $rs_res->fields[7] ;  
            $this->idfacven = $rs_res->fields[8] ;  
            $this->fechavenc = $rs_res->fields[9] ;  
            $this->subtotal = $rs_res->fields[10] ;  
            $this->subtotal =  str_replace(",", ".", $this->subtotal);
            $this->valoriva = $rs_res->fields[11] ;  
            $this->valoriva =  str_replace(",", ".", $this->valoriva);
            $this->observaciones = $rs_res->fields[12] ;  
            $this->saldo = $rs_res->fields[13] ;  
            $this->saldo =  str_replace(",", ".", $this->saldo);
            $this->adicional = $rs_res->fields[14] ;  
            $this->adicional2 = $rs_res->fields[15] ;  
            $this->adicional3 = $rs_res->fields[16] ;  
            $this->vendedor = $rs_res->fields[17] ;  
            $this->pedido = $rs_res->fields[18] ;  
            $this->base_iva_19 = $rs_res->fields[19] ;  
            $this->base_iva_19 =  str_replace(",", ".", $this->base_iva_19);
            $this->valor_iva_19 = $rs_res->fields[20] ;  
            $this->valor_iva_19 =  str_replace(",", ".", $this->valor_iva_19);
            $this->base_iva_5 = $rs_res->fields[21] ;  
            $this->base_iva_5 =  str_replace(",", ".", $this->base_iva_5);
            $this->valor_iva_5 = $rs_res->fields[22] ;  
            $this->valor_iva_5 =  str_replace(",", ".", $this->valor_iva_5);
            $this->excento = $rs_res->fields[23] ;  
            $this->excento =  str_replace(",", ".", $this->excento);
            $this->base_con_8 = $rs_res->fields[24] ;  
            $this->base_con_8 =  str_replace(",", ".", $this->base_con_8);
            $this->valor_con_8 = $rs_res->fields[25] ;  
            $this->valor_con_8 =  str_replace(",", ".", $this->valor_con_8);
            $this->t_iva = $rs_res->fields[26] ;  
            $this->t_iva =  str_replace(",", ".", $this->t_iva);
            $this->tipo = $rs_res->fields[27] ;  
...
$_SESSION['scriptcase']['grid_facturaven_210421_2']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->vendedor, $this->vendedor_orig);
            }
   }
//
