...
class grid_facturaven_210421_2_resumo
{
   ...
   var $sum_tipo_base_iva_19;
   var $sum_tipo_valor_iva_19;
   var $sum_tipo_base_iva_5;
   var $sum_tipo_valor_iva_5;
   var $sum_tipo_excento;
...
$_SESSION['scriptcase']['grid_facturaven_210421_2']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['arr_total']['tipo'];
      }
      else
      {
          $this->array_total_tipo = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['arr_total']['tipo'] = $this->array_total_tipo;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_order']['tipo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_order']['tipo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_order']['tipo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['tipo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['tipo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['tipo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['tipo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['tipo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['tipo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['summarizing_fields_display']['tipo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_tipo as $i_tipo => $d_tipo) {
           if (!in_array($i_tipo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_tipo[11] ] = $d_tipo[10];
               $this->comp_label[0][ $d_tipo[11] ] = $d_tipo[10];
           }
       }
       ...
       //-----
       foreach ($this->comp_label[0] as $i_tipo => $l_tipo) {
           if (isset($this->array_total_tipo[$i_tipo])) {
               $this->comp_group[$i_tipo] = array();
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_tipo("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $quebra_tipo, $quebra_tipo_orig)
   {
      //----- Tipo
      if (!isset($this->array_total_tipo[$quebra_tipo_orig]))
      {
         $this->array_total_tipo[$quebra_tipo_orig][0] = 1;
         $this->array_total_tipo[$quebra_tipo_orig][1] = $sum_total;
         $this->array_total_tipo[$quebra_tipo_orig][2] = $sum_subtotal;
         $this->array_total_tipo[$quebra_tipo_orig][3] = $sum_valoriva;
         $this->array_total_tipo[$quebra_tipo_orig][4] = $sum_base_iva_19;
         $this->array_total_tipo[$quebra_tipo_orig][5] = $sum_valor_iva_19;
         $this->array_total_tipo[$quebra_tipo_orig][6] = $sum_base_iva_5;
         $this->array_total_tipo[$quebra_tipo_orig][7] = $sum_valor_iva_5;
         $this->array_total_tipo[$quebra_tipo_orig][8] = $sum_excento;
         $this->array_total_tipo[$quebra_tipo_orig][9] = 1;
         $this->array_total_tipo[$quebra_tipo_orig][10] = $quebra_tipo;
         $this->array_total_tipo[$quebra_tipo_orig][11] = $quebra_tipo_orig;
      }
      else
      {
         $this->array_total_tipo[$quebra_tipo_orig][0]++;
         $this->array_total_tipo[$quebra_tipo_orig][1] += $sum_total;
         $this->array_total_tipo[$quebra_tipo_orig][2] += $sum_subtotal;
         $this->array_total_tipo[$quebra_tipo_orig][3] += $sum_valoriva;
         $this->array_total_tipo[$quebra_tipo_orig][4] += $sum_base_iva_19;
         ...
         $this->array_total_tipo[$quebra_tipo_orig][7] += $sum_valor_iva_5;
         $this->array_total_tipo[$quebra_tipo_orig][8] += $sum_excento;
         $this->array_total_tipo[$quebra_tipo_orig][9]++;
      }
   }
...
$_SESSION['scriptcase']['grid_facturaven_210421_2']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'tipo');
     $campos_order = $this->Ini->Get_date_order_groupby("tipo", 'asc', $format, $campos_order);
...
$_SESSION['scriptcase']['grid_facturaven_210421_2']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->tipo, $this->tipo_orig);
            }
   }
//
