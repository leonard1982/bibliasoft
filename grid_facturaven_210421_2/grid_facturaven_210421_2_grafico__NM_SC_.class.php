...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "Tipo";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['contr_label_graf']['tipo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['contr_label_graf']['tipo']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_210421_2']['contr_label_graf']['tipo'];
      }
   }
