  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipoica" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate codigo_
  function do_ajax_form_tipoica_validate_codigo_(iNumLinha)
  {
    var nomeCampo_codigo_ = "codigo_" + iNumLinha;
    var var_codigo_ = scAjaxGetFieldText(nomeCampo_codigo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipoica_validate_codigo_(var_codigo_, iNumLinha, var_script_case_init, do_ajax_form_tipoica_validate_codigo__cb);
  } // do_ajax_form_tipoica_validate_codigo_

  function do_ajax_form_tipoica_validate_codigo__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipoica_validate_codigo__cb

  // ---------- Validate actividad_
  function do_ajax_form_tipoica_validate_actividad_(iNumLinha)
  {
    var nomeCampo_actividad_ = "actividad_" + iNumLinha;
    var var_actividad_ = scAjaxGetFieldText(nomeCampo_actividad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipoica_validate_actividad_(var_actividad_, iNumLinha, var_script_case_init, do_ajax_form_tipoica_validate_actividad__cb);
  } // do_ajax_form_tipoica_validate_actividad_

  function do_ajax_form_tipoica_validate_actividad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipoica_validate_actividad__cb

  // ---------- Validate porcica_
  function do_ajax_form_tipoica_validate_porcica_(iNumLinha)
  {
    var nomeCampo_porcica_ = "porcica_" + iNumLinha;
    var var_porcica_ = scAjaxGetFieldText(nomeCampo_porcica_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipoica_validate_porcica_(var_porcica_, iNumLinha, var_script_case_init, do_ajax_form_tipoica_validate_porcica__cb);
  } // do_ajax_form_tipoica_validate_porcica_

  function do_ajax_form_tipoica_validate_porcica__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "porcica_" + iLineNumber;
    }
    else
    {
      sFieldValid = "porcica_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "porcica_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "porcica_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipoica_validate_porcica__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_tipoica_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_tipoica_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_tipoica_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_tipoica_add_new_line_cb);
  } // do_ajax_form_tipoica_add_new_line

  function do_ajax_form_tipoica_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_tipoica_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_tipoica_backup_line(iNumLinha)
  {
    var var_id_ica_ = scAjaxGetFieldText("id_ica_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipoica_backup_line(var_id_ica_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_tipoica_backup_line_cb);
  } // do_ajax_form_tipoica_backup_line

  function do_ajax_form_tipoica_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_tipoica_backup_line_cb

  function do_ajax_form_tipoica_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_tipoica_cancel_insert

  function do_ajax_form_tipoica_cancel_update(iSeqVert)
  {
    do_ajax_form_tipoica_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_tipoica_cancel_update

  function do_ajax_form_tipoica_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_tipoica_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_tipoica_table_refresh()
  {
    var var_id_ica_ = document.F2.id_ica_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipoica_table_refresh(var_id_ica_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipoica_table_refresh_cb);
  } //  do_ajax_form_tipoica_table_refresh

  function do_ajax_form_tipoica_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_ica_.value = scAjaxGetKeyValue("id_ica_");
    ...
    scAjaxAlert(do_ajax_form_tipoica_table_refresh_cb_after_alert);
  } // do_ajax_form_tipoica_table_refresh_cb
  function do_ajax_form_tipoica_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_tipoica_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_tipoica_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_tipoica_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_porcica_ = scAjaxGetFieldText("porcica_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_tipoica_submit_form(var_codigo_, var_actividad_, var_porcica_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipoica_submit_form_cb);
  } // do_ajax_form_tipoica_submit_form

  function do_ajax_form_tipoica_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("porcica_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_tipoica_submit_form_cb_after_alert);
  } // do_ajax_form_tipoica_submit_form_cb
  function do_ajax_form_tipoica_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipoica_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipoica_navigate_form()
  {
    perform_ajax_form_tipoica_navigate_form();
  }

  function perform_ajax_form_tipoica_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_tipoica_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("porcica_" + iNavForm);
    }
    var var_id_ica_ = document.F2.id_ica_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_tipoica_navigate_form(var_id_ica_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipoica_navigate_form_cb);
  } // do_ajax_form_tipoica_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipoica']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipoica_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_ica_.value = scAjaxGetKeyValue("id_ica_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipoica_navigate_form_cb_after_alert);
  } // do_ajax_form_tipoica_navigate_form_cb
  function do_ajax_form_tipoica_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_tipoica_navigate_form_cb_after_alert
  function sc_hide_form_tipoica_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "porcica_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["porcica_" + iNumLinha] = {"label": "Tarifa x mil<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["codigo_"][iNumLinha] = "codigo_" + iNumLinha;
    ajax_field_mult["actividad_"][iNumLinha] = "actividad_" + iNumLinha;
    ajax_field_mult["porcica_"][iNumLinha] = "porcica_" + iNumLinha;
    ...
    ajax_field_id["porcica_" + iNumLinha] = new Array("hidden_field_label_porcica_", "hidden_field_data_porcica_" + iNumLinha);
    ajax_error_count["codigo_" + iNumLinha] = "off";
    ajax_error_count["actividad_" + iNumLinha] = "off";
    ajax_error_count["porcica_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["porcica_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["porcica_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["porcica_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["porcica_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["porcica_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["porcica_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["porcica_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["porcica_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['porcica_'])) ? $this->nmgp_cmp_readonly['porcica_'] : 'off';
?>
    scAjaxFieldRead("porcica_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("porcica_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["codigo_" + iRow] || "on" == ajax_error_count["actividad_" + iRow] || "on" == ajax_error_count["porcica_" + iRow]))
    {
      ...
      $("#hidden_field_data_porcica_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["codigo_" + iRow] && "off" == ajax_error_count["actividad_" + iRow] && "off" == ajax_error_count["porcica_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["codigo_" + iRow] = "off";
        ajax_error_count["actividad_" + iRow] = "off";
        ajax_error_count["porcica_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_porcica_" + iRow).removeClass("scFormErrorLine");
    }
  }
