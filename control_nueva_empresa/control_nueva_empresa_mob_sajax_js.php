  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_nueva_empresa_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_nueva_empresa_mob_form();
	}
  ...
  // ---------- Validate copiar_desde
  function do_ajax_control_nueva_empresa_mob_validate_copiar_desde()
  {
    var nomeCampo_copiar_desde = "copiar_desde";
    var var_copiar_desde = scAjaxGetFieldSelect(nomeCampo_copiar_desde);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_empresa_mob_validate_copiar_desde(var_copiar_desde, var_script_case_init, do_ajax_control_nueva_empresa_mob_validate_copiar_desde_cb);
  } // do_ajax_control_nueva_empresa_mob_validate_copiar_desde

  function do_ajax_control_nueva_empresa_mob_validate_copiar_desde_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "copiar_desde";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_empresa_mob_validate_copiar_desde_cb

  // ---------- Validate anio
  function do_ajax_control_nueva_empresa_mob_validate_anio()
  {
    var nomeCampo_anio = "anio";
    var var_anio = scAjaxGetFieldSelect(nomeCampo_anio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_empresa_mob_validate_anio(var_anio, var_script_case_init, do_ajax_control_nueva_empresa_mob_validate_anio_cb);
  } // do_ajax_control_nueva_empresa_mob_validate_anio

  function do_ajax_control_nueva_empresa_mob_validate_anio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_empresa_mob_validate_anio_cb

  // ---------- Validate ruta_bd_tns
  function do_ajax_control_nueva_empresa_mob_validate_ruta_bd_tns()
  {
    var nomeCampo_ruta_bd_tns = "ruta_bd_tns";
    var var_ruta_bd_tns = scAjaxGetFieldText(nomeCampo_ruta_bd_tns);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_nueva_empresa_mob_validate_ruta_bd_tns(var_ruta_bd_tns, var_script_case_init, do_ajax_control_nueva_empresa_mob_validate_ruta_bd_tns_cb);
  } // do_ajax_control_nueva_empresa_mob_validate_ruta_bd_tns

  function do_ajax_control_nueva_empresa_mob_validate_ruta_bd_tns_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruta_bd_tns";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_nueva_empresa_mob_validate_ruta_bd_tns_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_nueva_empresa_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_nueva_empresa_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_copiar_desde = scAjaxGetFieldSelect("copiar_desde");
    var var_anio = scAjaxGetFieldSelect("anio");
    var var_ruta_bd_tns = scAjaxGetFieldText("ruta_bd_tns");
    ...
    scAjaxProcOn();
    x_ajax_control_nueva_empresa_mob_submit_form(var_copiar_desde, var_anio, var_ruta_bd_tns, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_nueva_empresa_mob_submit_form_cb);
  } // do_ajax_control_nueva_empresa_mob_submit_form

  function do_ajax_control_nueva_empresa_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_nueva_empresa_mob_submit_form_cb_after_alert);
  } // do_ajax_control_nueva_empresa_mob_submit_form_cb
  function do_ajax_control_nueva_empresa_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_nueva_empresa_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_nueva_empresa_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_nueva_empresa_mob_navigate_form, function() {});
    } else {
      perform_ajax_control_nueva_empresa_mob_navigate_form();
    }
  }

  function perform_ajax_control_nueva_empresa_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_nueva_empresa_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_nueva_empresa_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_nueva_empresa_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_nueva_empresa_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_nueva_empresa_mob_navigate_form_cb
  function do_ajax_control_nueva_empresa_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_nueva_empresa_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_nueva_empresa_mob_navigate_form_cb_after_alert
  function sc_hide_control_nueva_empresa_mob_form()
  {
  ...
  ajax_field_list[0] = "copiar_desde";
  ajax_field_list[1] = "anio";
  ajax_field_list[2] = "ruta_bd_tns";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "copiar_desde": {"label": "Copiar desde", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "anio": {"label": "Año", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ruta_bd_tns": {"label": "Ruta base de datos TNS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "copiar_desde": new Array(),
    "anio": new Array(),
    "ruta_bd_tns": new Array()
  };
  ajax_field_mult["copiar_desde"][1] = "copiar_desde";
  ajax_field_mult["anio"][1] = "anio";
  ajax_field_mult["ruta_bd_tns"][1] = "ruta_bd_tns";

  var ajax_field_id = {
    "copiar_desde": new Array("hidden_field_label_copiar_desde", "hidden_field_data_copiar_desde"),
    "anio": new Array("hidden_field_label_anio", "hidden_field_data_anio"),
    "ruta_bd_tns": new Array("hidden_field_label_ruta_bd_tns", "hidden_field_data_ruta_bd_tns")
  };
