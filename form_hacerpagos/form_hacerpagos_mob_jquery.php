...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'detallepagos':
      case 'idpago':
        sc_exib_ocult_pag('form_hacerpagos_mob_form0');
        break;
      case 'archivos':
        sc_exib_ocult_pag('form_hacerpagos_mob_form1');
        break;
    }
  }
...
function sc_form_hacerpagos_idpago_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_idpago();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_numpago_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_numpago();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_client_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_client();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_client_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_client_onchange();
}
...
function sc_form_hacerpagos_fecpago_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_fecpago();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_montocan_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_montocan();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_ret_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_ret();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_ret_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_ret_onchange();
}

function sc_form_hacerpagos_ret_onclick(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_ret_onclick();
}
...
function sc_form_hacerpagos_descuent_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_descuent();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_descuent_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_descuent_onchange();
}

function sc_form_hacerpagos_descuent_onclick(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_descuent_onclick();
}
...
function sc_form_hacerpagos_docapagar_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_docapagar();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_docapagar_onchange(oThis, iSeqRow) {
  sc_docapagar_onchange();
  do_ajax_form_hacerpagos_mob_event_docapagar_onchange();
}
...
function sc_form_hacerpagos_iddocapagar_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_iddocapagar();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_iddocapagar_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_iddocapagar_onchange();
}
...
function sc_form_hacerpagos_saldodocumento_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_saldodocumento();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_conc_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_conc();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_obs_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_obs();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_asent_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_asent();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_asent_onchange(oThis, iSeqRow) {
  sc_asent_onchange();
  do_ajax_form_hacerpagos_mob_event_asent_onchange();
}
...
function sc_form_hacerpagos_porc_ret_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_porc_ret();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_porc_ret_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_porc_ret_onchange();
}

function sc_form_hacerpagos_porc_ret_onclick(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_porc_ret_onclick();
}
...
function sc_form_hacerpagos_val_ica_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_val_ica();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_val_ica_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_val_ica_onchange();
}

function sc_form_hacerpagos_val_ica_onclick(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_val_ica_onclick();
}
...
function sc_form_hacerpagos_porc_ica_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_porc_ica();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_porc_ica_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_porc_ica_onchange();
}

function sc_form_hacerpagos_porc_ica_onclick(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_porc_ica_onclick();
}
...
function sc_form_hacerpagos_porc_reteiva_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_porc_reteiva();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_porc_reteiva_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_porc_reteiva_onchange();
}

function sc_form_hacerpagos_porc_reteiva_onclick(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_porc_reteiva_onclick();
}
...
function sc_form_hacerpagos_val_reteiva_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_val_reteiva();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_val_reteiva_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_val_reteiva_onchange();
}

function sc_form_hacerpagos_val_reteiva_onclick(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_val_reteiva_onclick();
}
...
function sc_form_hacerpagos_banco_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_banco();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_id_concepto_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_id_concepto();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_id_concepto_onchange(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_event_id_concepto_onchange();
}
...
function sc_form_hacerpagos_ncuenta_tercero_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_ncuenta_tercero();
  scCssBlur(oThis);
}

function sc_form_hacerpagos_ncuenta_tercero_onchange(oThis, iSeqRow) {
  sc_ncuenta_tercero_onchange();
  do_ajax_form_hacerpagos_mob_event_ncuenta_tercero_onchange();
}
...
function sc_form_hacerpagos_cod_cuenta_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_cod_cuenta();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_detallepagos_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_detallepagos();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_titulo_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_titulo();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_total_cuenta_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_total_cuenta();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_valor_base_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_valor_base();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_valor_iva_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_valor_iva();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_valpagar_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_valpagar();
  scCssBlur(oThis);
}
...
function sc_form_hacerpagos_archivos_onblur(oThis, iSeqRow) {
  do_ajax_form_hacerpagos_mob_validate_archivos();
  scCssBlur(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_hacerpagos_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecpago" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_hacerpagos_mob_validate_fecpago(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_hacerpagos_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_actualizado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_hacerpagos_mob_validate_actualizado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_hacerpagos_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
