...
<?php echo "<b>Valor a Pagar</b><br>" . nl2br("Si el pago es sobre una compra, y es solo un abono, se recomienda dejar las tasas de retenciones que trae de la factura, pero colocar los valores (Valor retención, valor retenido ICA, Valor rete IVA y Descuento) en 0."); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_hacerpagos_help();
?>
