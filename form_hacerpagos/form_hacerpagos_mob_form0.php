...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['btn_disabled']['refrescar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['btn_disabled']['refrescar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['btn_label']['refrescar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['btn_label']['refrescar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_mob']['btn_label']['refrescar'];
        }
?>
