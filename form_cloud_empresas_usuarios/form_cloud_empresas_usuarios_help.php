...
@session_start() ;
class form_cloud_empresas_usuarios_help
{
...
<?php echo "<b>CodSucursal</b><br>" . nl2br("Código de la sucursal tal como aparece en Visual TNS"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_cloud_empresas_usuarios_help();
?>
