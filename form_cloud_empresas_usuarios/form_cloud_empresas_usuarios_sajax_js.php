  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_empresas_usuarios" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_empresas_usuarios_form();
	}
  ...
  // ---------- Validate id_empresa_
  function do_ajax_form_cloud_empresas_usuarios_validate_id_empresa_(iNumLinha)
  {
    var nomeCampo_id_empresa_ = "id_empresa_" + iNumLinha;
    var var_id_empresa_ = scAjaxGetFieldSelect(nomeCampo_id_empresa_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_id_empresa_(var_id_empresa_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_id_empresa__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_id_empresa_

  function do_ajax_form_cloud_empresas_usuarios_validate_id_empresa__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "id_empresa_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_empresa_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_empresa_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_empresa_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_id_empresa__cb

  // ---------- Validate usuario_
  function do_ajax_form_cloud_empresas_usuarios_validate_usuario_(iNumLinha)
  {
    var nomeCampo_usuario_ = "usuario_" + iNumLinha;
    var var_usuario_ = scAjaxGetFieldText(nomeCampo_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_usuario_(var_usuario_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_usuario__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_usuario_

  function do_ajax_form_cloud_empresas_usuarios_validate_usuario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_usuario__cb

  // ---------- Validate password_
  function do_ajax_form_cloud_empresas_usuarios_validate_password_(iNumLinha)
  {
    var nomeCampo_password_ = "password_" + iNumLinha;
    var var_password_ = scAjaxGetFieldText(nomeCampo_password_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_password_(var_password_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_password__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_password_

  function do_ajax_form_cloud_empresas_usuarios_validate_password__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "password_" + iLineNumber;
    }
    else
    {
      sFieldValid = "password_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "password_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "password_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_password__cb

  // ---------- Validate nombre_completo_
  function do_ajax_form_cloud_empresas_usuarios_validate_nombre_completo_(iNumLinha)
  {
    var nomeCampo_nombre_completo_ = "nombre_completo_" + iNumLinha;
    var var_nombre_completo_ = scAjaxGetFieldText(nomeCampo_nombre_completo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_nombre_completo_(var_nombre_completo_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_nombre_completo__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_nombre_completo_

  function do_ajax_form_cloud_empresas_usuarios_validate_nombre_completo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "nombre_completo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "nombre_completo_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "nombre_completo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "nombre_completo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_nombre_completo__cb

  // ---------- Validate celular_
  function do_ajax_form_cloud_empresas_usuarios_validate_celular_(iNumLinha)
  {
    var nomeCampo_celular_ = "celular_" + iNumLinha;
    var var_celular_ = scAjaxGetFieldText(nomeCampo_celular_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_celular_(var_celular_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_celular__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_celular_

  function do_ajax_form_cloud_empresas_usuarios_validate_celular__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "celular_" + iLineNumber;
    }
    else
    {
      sFieldValid = "celular_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "celular_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "celular_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_celular__cb

  // ---------- Validate correo_
  function do_ajax_form_cloud_empresas_usuarios_validate_correo_(iNumLinha)
  {
    var nomeCampo_correo_ = "correo_" + iNumLinha;
    var var_correo_ = scAjaxGetFieldText(nomeCampo_correo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_correo_(var_correo_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_correo__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_correo_

  function do_ajax_form_cloud_empresas_usuarios_validate_correo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_correo__cb

  // ---------- Validate prefijo_
  function do_ajax_form_cloud_empresas_usuarios_validate_prefijo_(iNumLinha)
  {
    var nomeCampo_prefijo_ = "prefijo_" + iNumLinha;
    var var_prefijo_ = scAjaxGetFieldText(nomeCampo_prefijo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_prefijo_(var_prefijo_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_prefijo__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_prefijo_

  function do_ajax_form_cloud_empresas_usuarios_validate_prefijo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_prefijo__cb

  // ---------- Validate codsucursal_
  function do_ajax_form_cloud_empresas_usuarios_validate_codsucursal_(iNumLinha)
  {
    var nomeCampo_codsucursal_ = "codsucursal_" + iNumLinha;
    var var_codsucursal_ = scAjaxGetFieldText(nomeCampo_codsucursal_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_codsucursal_(var_codsucursal_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_codsucursal__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_codsucursal_

  function do_ajax_form_cloud_empresas_usuarios_validate_codsucursal__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codsucursal_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codsucursal_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codsucursal_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codsucursal_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_codsucursal__cb

  // ---------- Validate activo_
  function do_ajax_form_cloud_empresas_usuarios_validate_activo_(iNumLinha)
  {
    var nomeCampo_activo_ = "activo_" + iNumLinha;
    var var_activo_ = scAjaxGetFieldSelect(nomeCampo_activo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_validate_activo_(var_activo_, iNumLinha, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_validate_activo__cb);
  } // do_ajax_form_cloud_empresas_usuarios_validate_activo_

  function do_ajax_form_cloud_empresas_usuarios_validate_activo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_empresas_usuarios_validate_activo__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_cloud_empresas_usuarios_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_cloud_empresas_usuarios_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cloud_empresas_usuarios_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_add_new_line_cb);
  } // do_ajax_form_cloud_empresas_usuarios_add_new_line

  function do_ajax_form_cloud_empresas_usuarios_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_cloud_empresas_usuarios_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_cloud_empresas_usuarios_backup_line(iNumLinha)
  {
    var var_id_empresa_usuario_ = scAjaxGetFieldText("id_empresa_usuario_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_empresas_usuarios_backup_line(var_id_empresa_usuario_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_backup_line_cb);
  } // do_ajax_form_cloud_empresas_usuarios_backup_line

  function do_ajax_form_cloud_empresas_usuarios_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_cloud_empresas_usuarios_backup_line_cb

  function do_ajax_form_cloud_empresas_usuarios_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_cloud_empresas_usuarios_cancel_insert

  function do_ajax_form_cloud_empresas_usuarios_cancel_update(iSeqVert)
  {
    do_ajax_form_cloud_empresas_usuarios_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_cloud_empresas_usuarios_cancel_update

  function do_ajax_form_cloud_empresas_usuarios_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_cloud_empresas_usuarios_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_cloud_empresas_usuarios_table_refresh()
  {
    var var_id_empresa_usuario_ = document.F2.id_empresa_usuario_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_empresas_usuarios_table_refresh(var_id_empresa_usuario_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_table_refresh_cb);
  } //  do_ajax_form_cloud_empresas_usuarios_table_refresh

  function do_ajax_form_cloud_empresas_usuarios_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.id_empresa_usuario_.value = scAjaxGetKeyValue("id_empresa_usuario_");
    ...
    scAjaxAlert(do_ajax_form_cloud_empresas_usuarios_table_refresh_cb_after_alert);
  } // do_ajax_form_cloud_empresas_usuarios_table_refresh_cb
  function do_ajax_form_cloud_empresas_usuarios_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_cloud_empresas_usuarios_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_cloud_empresas_usuarios_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_cloud_empresas_usuarios_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_id_empresa_ = scAjaxGetFieldSelect("id_empresa_" + iNumLinha);
    var var_usuario_ = scAjaxGetFieldText("usuario_" + iNumLinha);
    var var_password_ = scAjaxGetFieldText("password_" + iNumLinha);
    var var_nombre_completo_ = scAjaxGetFieldText("nombre_completo_" + iNumLinha);
    var var_celular_ = scAjaxGetFieldText("celular_" + iNumLinha);
    var var_correo_ = scAjaxGetFieldText("correo_" + iNumLinha);
    var var_prefijo_ = scAjaxGetFieldText("prefijo_" + iNumLinha);
    var var_codsucursal_ = scAjaxGetFieldText("codsucursal_" + iNumLinha);
    var var_activo_ = scAjaxGetFieldSelect("activo_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_cloud_empresas_usuarios_submit_form(var_id_empresa_, var_usuario_, var_password_, var_nombre_completo_, var_celular_, var_correo_, var_prefijo_, var_codsucursal_, var_activo_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_empresas_usuarios_submit_form_cb);
  } // do_ajax_form_cloud_empresas_usuarios_submit_form

  function do_ajax_form_cloud_empresas_usuarios_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_empresa_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("usuario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("password_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nombre_completo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("celular_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("correo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("prefijo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("codsucursal_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cloud_empresas_usuarios_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_empresas_usuarios_submit_form_cb
  function do_ajax_form_cloud_empresas_usuarios_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_empresas_usuarios_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_empresas_usuarios_navigate_form()
  {
    perform_ajax_form_cloud_empresas_usuarios_navigate_form();
  }

  function perform_ajax_form_cloud_empresas_usuarios_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_cloud_empresas_usuarios_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_empresa_" + iNavForm);
      scAjaxHideErrorDisplay("usuario_" + iNavForm);
      scAjaxHideErrorDisplay("password_" + iNavForm);
      scAjaxHideErrorDisplay("nombre_completo_" + iNavForm);
      scAjaxHideErrorDisplay("celular_" + iNavForm);
      scAjaxHideErrorDisplay("correo_" + iNavForm);
      scAjaxHideErrorDisplay("prefijo_" + iNavForm);
      scAjaxHideErrorDisplay("codsucursal_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_cloud_empresas_usuarios_navigate_form(var_id_empresa_usuario_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_empresas_usuarios_navigate_form_cb);
  } // do_ajax_form_cloud_empresas_usuarios_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_empresas_usuarios']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_empresas_usuarios_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_empresa_usuario_.value = scAjaxGetKeyValue("id_empresa_usuario_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_empresas_usuarios_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_empresas_usuarios_navigate_form_cb
  function do_ajax_form_cloud_empresas_usuarios_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_cloud_empresas_usuarios_navigate_form_cb_after_alert
  function sc_hide_form_cloud_empresas_usuarios_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_empresa_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "usuario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "password_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nombre_completo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "celular_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "correo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "prefijo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codsucursal_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "activo_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_empresa_" + iNumLinha] = {"label": "Empresa<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["password_" + iNumLinha] = {"label": "Password<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombre_completo_" + iNumLinha] = {"label": "Nombre Completo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["celular_" + iNumLinha] = {"label": "Celular<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["codsucursal_" + iNumLinha] = {"label": "CodSucursal<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["id_empresa_"][iNumLinha] = "id_empresa_" + iNumLinha;
    ajax_field_mult["usuario_"][iNumLinha] = "usuario_" + iNumLinha;
    ajax_field_mult["password_"][iNumLinha] = "password_" + iNumLinha;
    ajax_field_mult["nombre_completo_"][iNumLinha] = "nombre_completo_" + iNumLinha;
    ajax_field_mult["celular_"][iNumLinha] = "celular_" + iNumLinha;
    ajax_field_mult["correo_"][iNumLinha] = "correo_" + iNumLinha;
    ajax_field_mult["prefijo_"][iNumLinha] = "prefijo_" + iNumLinha;
    ajax_field_mult["codsucursal_"][iNumLinha] = "codsucursal_" + iNumLinha;
    ajax_field_mult["activo_"][iNumLinha] = "activo_" + iNumLinha;
    ajax_field_id["id_empresa_" + iNumLinha] = new Array("hidden_field_label_id_empresa_", "hidden_field_data_id_empresa_" + iNumLinha);
    ajax_field_id["usuario_" + iNumLinha] = new Array("hidden_field_label_usuario_", "hidden_field_data_usuario_" + iNumLinha);
    ajax_field_id["password_" + iNumLinha] = new Array("hidden_field_label_password_", "hidden_field_data_password_" + iNumLinha);
    ajax_field_id["nombre_completo_" + iNumLinha] = new Array("hidden_field_label_nombre_completo_", "hidden_field_data_nombre_completo_" + iNumLinha);
    ajax_field_id["celular_" + iNumLinha] = new Array("hidden_field_label_celular_", "hidden_field_data_celular_" + iNumLinha);
    ...
    ajax_field_id["codsucursal_" + iNumLinha] = new Array("hidden_field_label_codsucursal_", "hidden_field_data_codsucursal_" + iNumLinha);
    ajax_field_id["activo_" + iNumLinha] = new Array("hidden_field_label_activo_", "hidden_field_data_activo_" + iNumLinha);
    ajax_error_count["id_empresa_" + iNumLinha] = "off";
    ajax_error_count["usuario_" + iNumLinha] = "off";
    ajax_error_count["password_" + iNumLinha] = "off";
    ajax_error_count["nombre_completo_" + iNumLinha] = "off";
    ajax_error_count["celular_" + iNumLinha] = "off";
    ajax_error_count["correo_" + iNumLinha] = "off";
    ajax_error_count["prefijo_" + iNumLinha] = "off";
    ajax_error_count["codsucursal_" + iNumLinha] = "off";
    ajax_error_count["activo_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_empresa_" + iNumLinha] = "off";
    ajax_read_only["usuario_" + iNumLinha] = "off";
    ajax_read_only["password_" + iNumLinha] = "off";
    ajax_read_only["nombre_completo_" + iNumLinha] = "off";
    ajax_read_only["celular_" + iNumLinha] = "off";
    ajax_read_only["correo_" + iNumLinha] = "off";
    ajax_read_only["prefijo_" + iNumLinha] = "off";
    ajax_read_only["codsucursal_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["id_empresa_" + iNumLinha] = "on";
    ajax_read_only["usuario_" + iNumLinha] = "on";
    ajax_read_only["password_" + iNumLinha] = "on";
    ajax_read_only["nombre_completo_" + iNumLinha] = "on";
    ajax_read_only["celular_" + iNumLinha] = "on";
    ajax_read_only["correo_" + iNumLinha] = "on";
    ajax_read_only["prefijo_" + iNumLinha] = "on";
    ajax_read_only["codsucursal_" + iNumLinha] = "on";
...
?>
  ...
  {
    ajax_error_list["id_empresa_" + iNumLinha] = null;
    ajax_error_list["usuario_" + iNumLinha] = null;
    ajax_error_list["password_" + iNumLinha] = null;
    ajax_error_list["nombre_completo_" + iNumLinha] = null;
    ajax_error_list["celular_" + iNumLinha] = null;
    ajax_error_list["correo_" + iNumLinha] = null;
    ajax_error_list["prefijo_" + iNumLinha] = null;
    ajax_error_list["codsucursal_" + iNumLinha] = null;
  ...
  var ajax_field_mult = {
    "id_empresa_": new Array(),
    "usuario_": new Array(),
    "password_": new Array(),
    "nombre_completo_": new Array(),
    "celular_": new Array(),
    "correo_": new Array(),
    "prefijo_": new Array(),
    "codsucursal_": new Array(),
    "activo_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_empresa_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_empresa_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_empresa_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_empresa_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_empresa_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["password_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["password_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["password_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["password_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["password_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["nombre_completo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["nombre_completo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["nombre_completo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["nombre_completo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["nombre_completo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["celular_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["celular_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["celular_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["celular_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["celular_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["codsucursal_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codsucursal_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codsucursal_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codsucursal_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codsucursal_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_empresa_'])) ? $this->nmgp_cmp_readonly['id_empresa_'] : 'off';
?>
    scAjaxFieldRead("id_empresa_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['password_'])) ? $this->nmgp_cmp_readonly['password_'] : 'off';
?>
    scAjaxFieldRead("password_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['nombre_completo_'])) ? $this->nmgp_cmp_readonly['nombre_completo_'] : 'off';
?>
    scAjaxFieldRead("nombre_completo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['celular_'])) ? $this->nmgp_cmp_readonly['celular_'] : 'off';
?>
    scAjaxFieldRead("celular_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codsucursal_'])) ? $this->nmgp_cmp_readonly['codsucursal_'] : 'off';
?>
    scAjaxFieldRead("codsucursal_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  {
    scAjaxFieldRead("id_empresa_" + iSeq, "on");
    scAjaxFieldRead("usuario_" + iSeq, "on");
    scAjaxFieldRead("password_" + iSeq, "on");
    scAjaxFieldRead("nombre_completo_" + iSeq, "on");
    scAjaxFieldRead("celular_" + iSeq, "on");
    scAjaxFieldRead("correo_" + iSeq, "on");
    scAjaxFieldRead("prefijo_" + iSeq, "on");
    scAjaxFieldRead("codsucursal_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_empresa_" + iRow] || "on" == ajax_error_count["usuario_" + iRow] || "on" == ajax_error_count["password_" + iRow] || "on" == ajax_error_count["nombre_completo_" + iRow] || "on" == ajax_error_count["celular_" + iRow] || "on" == ajax_error_count["correo_" + iRow] || "on" == ajax_error_count["prefijo_" + iRow] || "on" == ajax_error_count["codsucursal_" + iRow] || "on" == ajax_error_count["activo_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_id_empresa_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_usuario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_password_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nombre_completo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_celular_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_correo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_prefijo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_codsucursal_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_empresa_" + iRow] && "off" == ajax_error_count["usuario_" + iRow] && "off" == ajax_error_count["password_" + iRow] && "off" == ajax_error_count["nombre_completo_" + iRow] && "off" == ajax_error_count["celular_" + iRow] && "off" == ajax_error_count["correo_" + iRow] && "off" == ajax_error_count["prefijo_" + iRow] && "off" == ajax_error_count["codsucursal_" + iRow] && "off" == ajax_error_count["activo_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_empresa_" + iRow] = "off";
        ajax_error_count["usuario_" + iRow] = "off";
        ajax_error_count["password_" + iRow] = "off";
        ajax_error_count["nombre_completo_" + iRow] = "off";
        ajax_error_count["celular_" + iRow] = "off";
        ajax_error_count["correo_" + iRow] = "off";
        ajax_error_count["prefijo_" + iRow] = "off";
        ajax_error_count["codsucursal_" + iRow] = "off";
      ...
      $("#hidden_field_data_id_empresa_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_usuario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_password_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nombre_completo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_celular_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_correo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_prefijo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_codsucursal_" + iRow).removeClass("scFormErrorLine");
