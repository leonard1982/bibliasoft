...
$old_error_handler = set_error_handler("form_permisos_aplicaciones_menu_scriptcase_error_handler");

function form_permisos_aplicaciones_menu_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['form_permisos_aplicaciones_menu']['contr_erro']) && $_SESSION['scriptcase']['form_permisos_aplicaciones_menu']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_permisos_aplicaciones_menu->contr_form_permisos_aplicaciones_menu->Apl_com_erro = true;
            if ($inicial_form_permisos_aplicaciones_menu->contr_form_permisos_aplicaciones_menu->NM_ajax_flag)
            {
                $inicial_form_permisos_aplicaciones_menu->contr_form_permisos_aplicaciones_menu->NM_ajax_info['errList']['geral_form_permisos_aplicaciones_menu'][] = $msg;
                return;
            }
            form_permisos_aplicaciones_menu_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_permisos_aplicaciones_menu_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_permisos_aplicaciones_menu'])  && '' != $_SESSION['scriptcase']['error_icon']['form_permisos_aplicaciones_menu'])  ? $_SESSION['scriptcase']['error_icon']['form_permisos_aplicaciones_menu']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_permisos_aplicaciones_menu']) && '' != $_SESSION['scriptcase']['error_close']['form_permisos_aplicaciones_menu']) ? $_SESSION['scriptcase']['error_close']['form_permisos_aplicaciones_menu'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_permisos_aplicaciones_menu']) && '' != $_SESSION['scriptcase']['error_span_title']['form_permisos_aplicaciones_menu']) ? $_SESSION['scriptcase']['error_span_title']['form_permisos_aplicaciones_menu'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_permisos_aplicaciones_menu']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_permisos_aplicaciones_menu']) ? $_SESSION['scriptcase']['error_icon_title']['form_permisos_aplicaciones_menu'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_permisos_aplicaciones_menu']['error_buffer'] .= ob_get_flush();
}
