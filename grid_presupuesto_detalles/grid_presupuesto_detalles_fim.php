...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_presupuesto_detalles"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_presupuesto_detalles"]);
   }
