...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_presupuesto_detalles"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_presupuesto_detalles"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_presupuesto_detalles'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_presupuesto_detalles</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_presupuesto_detalles']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_presupuesto_detalles' || $achou)
          {
