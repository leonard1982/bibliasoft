...
class grid_historiales_crm_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_historiales_crm.rtf";
   }
   //---- 
...
$_SESSION['scriptcase']['grid_historiales_crm']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['rtf_name']);
      }
...
$_SESSION['scriptcase']['grid_historiales_crm']['contr_erro'] = 'off'; 
   ...
   function NM_export_id_historial_crm()
   {
         ...
         $this->id_historial_crm = str_replace('<', '&lt;', $this->id_historial_crm);
         $this->id_historial_crm = str_replace('>', '&gt;', $this->id_historial_crm);
         $this->Texto_tag .= "<td>" . $this->id_historial_crm . "</td>\r\n";
   }
   //----- fecha
   ...
   function NM_export_atendido()
   {
         ...
         $this->look_atendido = str_replace('<', '&lt;', $this->look_atendido);
         $this->look_atendido = str_replace('>', '&gt;', $this->look_atendido);
         $this->Texto_tag .= "<td>" . $this->look_atendido . "</td>\r\n";
   }
   //----- id_contacto_tercero
   function NM_export_id_contacto_tercero()
   {
         ...
         $this->look_id_contacto_tercero = str_replace('<', '&lt;', $this->look_id_contacto_tercero);
         $this->look_id_contacto_tercero = str_replace('>', '&gt;', $this->look_id_contacto_tercero);
         $this->Texto_tag .= "<td>" . $this->look_id_contacto_tercero . "</td>\r\n";
   }
   //----- asesor
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
