...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_historiales_crm"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_historiales_crm"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_historiales_crm'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_historiales_crm']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_historiales_crm']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_historiales_crm']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_historiales_crm']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_historiales_crm']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_historiales_crm</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_historiales_crm']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_historiales_crm']['embutida_filho'] as $ind => $sc_init)
          {
