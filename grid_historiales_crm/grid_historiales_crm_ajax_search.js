...
Table_sv_fil[1] = "tipo";
Table_sv_fil[2] = "asesor";
Table_sv_fil[3] = "motivo";
Table_sv_fil[4] = "atendido";
Table_sv_fil[5] = "id_contacto_tercero";
Table_sv_fil[6] = "estado";
...
function ajax_refresh_field(fields, parms, Proc_on)
{
    ...
    $.ajax({
     ...
     .done(function(json_ref_fil) {
        ...
        if (fields.lastIndexOf('tipo') != -1) {
           $("#SC_tipo").select2('destroy');
           Sc_carga_select2_tipo();
        }
        if (fields.lastIndexOf('asesor') != -1) {
           $("#SC_asesor").select2('destroy');
           Sc_carga_select2_asesor();
        }
        if (fields.lastIndexOf('motivo') != -1) {
           $("#SC_motivo").select2('destroy');
           Sc_carga_select2_motivo();
        }
        if (fields.lastIndexOf('atendido') != -1) {
           $("#SC_atendido").select2('destroy');
