...
<?php
   ...
   $Ord_Cmp = new grid_historiales_crm_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_historiales_crm_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['id_historial_crm'] = "id_historial_crm";
   $tab_labels["id_historial_crm"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["id_historial_crm"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["id_historial_crm"] : "Id";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["tipo"] : "Tipo/Contacto";
   $tab_ger_campos['atendido'] = "on";
   $tab_def_campos['atendido'] = "atendido";
   $tab_labels["atendido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["atendido"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["atendido"] : "Atendido";
   $tab_ger_campos['id_contacto_tercero'] = "on";
   $tab_def_campos['id_contacto_tercero'] = "id_contacto_tercero";
   $tab_labels["id_contacto_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["id_contacto_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["id_contacto_tercero"] : "Contacto/Tercero";
   $tab_ger_campos['asesor'] = "on";
   $tab_def_campos['asesor'] = "asesor";
   $tab_labels["asesor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["asesor"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["asesor"] : "Asesor";
   $tab_ger_campos['motivo'] = "on";
   $tab_def_campos['motivo'] = "motivo";
   $tab_labels["motivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["motivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["motivo"] : "Motivo";
   $tab_ger_campos['cambiar_estado'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cambiar_estado'] = "cambiar_estado";
   }
   else
   {
       $tab_def_campos['cambiar_estado'] = "";
   }
   $tab_labels["cambiar_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["cambiar_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["cambiar_estado"] : "Estado";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["creado"] : "Creado";
   $tab_ger_campos['editado'] = "on";
   $tab_def_campos['editado'] = "editado";
   $tab_labels["editado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["editado"])) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['labels']["editado"] : "Editado";
   $tab_ger_campos['cambiar_estado'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_historiales_crm_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_historiales_crm']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
