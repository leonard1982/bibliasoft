...
class grid_historiales_crm_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_historiales_crm_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_historiales_crm_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_historiales_crm_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == "ajax_refresh_field")
      {
          ...
          if (in_array("id_contacto_tercero", $NMcmp_refr))
          {
              $list = array();
              $nmgp_def_dados = $this->lookup_ajax_id_contacto_tercero($atendido);
              ...
              $this->Arr_result['set_dselect'][] = array('field' => 'SC_id_contacto_tercero', 'value' => $list);
          }
      }
   }
   function lookup_ajax_id_contacto_tercero($atendido)
   {
      $tmp_pos = strpos($atendido, "##@@");
      if ($tmp_pos !== false)
      {
          $atendido = substr($atendido, 0, $tmp_pos);
      }
            $id_contacto_tercero_look = substr($this->Db->qstr($id_contacto_tercero), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "SELECT idtercero, nombres  FROM v_contactos_terceros  WHERE tipo='$atendido' ORDER BY nombres"; 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['id_contacto_tercero'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['id_contacto_tercero'][] = trim($rs->fields[0]);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_historiales_crm/grid_historiales_crm_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_historiales_crm_ajax_search.js"></script>
 <script type="text/javascript" src="grid_historiales_crm_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_historiales_crm_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_historiales_crm']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_historiales_crm']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_asesor_cond#NMF#' + search_get_sel_txt('SC_asesor_cond') + '@NMF@';
  str_out += 'SC_asesor#NMF#' + search_get_select('SC_asesor') + '@NMF@';
  str_out += 'SC_motivo_cond#NMF#' + search_get_sel_txt('SC_motivo_cond') + '@NMF@';
  str_out += 'SC_motivo#NMF#' + search_get_select('SC_motivo') + '@NMF@';
  str_out += 'SC_atendido_cond#NMF#' + search_get_sel_txt('SC_atendido_cond') + '@NMF@';
  str_out += 'SC_atendido#NMF#' + search_get_select('SC_atendido') + '@NMF@';
  str_out += 'SC_id_contacto_tercero_cond#NMF#' + search_get_sel_txt('SC_id_contacto_tercero_cond') + '@NMF@';
  str_out += 'SC_id_contacto_tercero#NMF#' + search_get_Dselelect('SC_id_contacto_tercero_dest') + '@NMF@';
 ...
 function nm_refresh_atendido(Proc_on)
 {
   var parms  = "";
   var fields = "id_contacto_tercero";
   parms += 'atendido#NMF#' + search_get_select('SC_atendido') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Casos CRM</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__history_edit_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $asesor_cond, $asesor,
             $motivo_cond, $motivo,
             $atendido_cond, $atendido,
             $id_contacto_tercero_cond, $id_contacto_tercero,
             $estado_cond, $estado,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      if (isset($bprocessa) && ($bprocessa == "recarga" || $bprocessa == "save_form" || $bprocessa == "filter_delete"))
      {
          if (!empty($id_contacto_tercero))
          {
              $id_contacto_tercero = explode("@?@", $id_contacto_tercero);
          }
          else
          {
              $id_contacto_tercero = array();
          }
      }
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_cond']; 
          $tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['tipo']; 
          $tipo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['tipo_cond']; 
          $asesor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['asesor']; 
          $asesor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['asesor_cond']; 
          $motivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['motivo']; 
          $motivo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['motivo_cond']; 
          $atendido = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['atendido']; 
          $atendido_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['atendido_cond']; 
          $id_contacto_tercero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['id_contacto_tercero']; 
          $id_contacto_tercero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['id_contacto_tercero_cond']; 
          $estado = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['estado']; 
          $estado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['estado_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($asesor_cond) || empty($asesor_cond))
      {
         $asesor_cond = "eq";
      }
      ...
      if (!isset($atendido_cond) || empty($atendido_cond))
      {
         $atendido_cond = "eq";
      }
      if (!isset($id_contacto_tercero_cond) || empty($id_contacto_tercero_cond))
      {
         $id_contacto_tercero_cond = "eq";
      }
      ...
      $str_hide_asesor = (in_array($asesor_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_motivo = (in_array($motivo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_atendido = (in_array($atendido_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_id_contacto_tercero = (in_array($id_contacto_tercero_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_asesor = ('bw' == $asesor_cond) ? $display_aberto : $display_fechado;
      $str_display_motivo = ('bw' == $motivo_cond) ? $display_aberto : $display_fechado;
      $str_display_atendido = ('bw' == $atendido_cond) ? $display_aberto : $display_fechado;
      $str_display_id_contacto_tercero = ('bw' == $id_contacto_tercero_cond) ? $display_aberto : $display_fechado;
      $str_display_estado = ('bw' == $estado_cond) ? $display_aberto : $display_fechado;

      // id_contacto_tercero
      if (is_array($id_contacto_tercero) && !empty($id_contacto_tercero))
      {
         $tmp_array = array();
         $id_contacto_tercero_val_str = "";
         foreach ($id_contacto_tercero as $tmp_val_cmp)
         {
            if ("" != $id_contacto_tercero_val_str)
            {
               $id_contacto_tercero_val_str .= ",";
            }
            ...
            $id_contacto_tercero_val_str .= "'$tmp_val_cmp'";
         }
         $id_contacto_tercero = $tmp_array;
      }
      else
      {
         $id_contacto_tercero_val_str = "";
      ...
      if (!isset($atendido) || $atendido == "")
      {
          $atendido = "";
      }
      if (isset($atendido) && !empty($atendido))
      {
         $tmp_pos = strpos($atendido, "##@@");
         if ($tmp_pos === false)
         { }
      ...
      if (!isset($id_contacto_tercero) || $id_contacto_tercero == "")
      {
          $id_contacto_tercero = array();
      }
...
?>
      ...
      <TD id='SC_tipo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['tipo'])) ? $this->New_label['tipo'] : "Tipo Contacto"; ?></TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['tipo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['tipo'][] = "TELEFONICO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['tipo'][] = "EMAIL";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['tipo'][] = "SMS";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['tipo'][] = "PRESENCIAL";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['tipo'][] = "WHATSAPP";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_tipo"  name="tipo"  size="1">
 <OPTION value="">TODOS</option>
 <OPTION value="TELEFONICO##@@TELEFONICO"<?php if ($tipo == "TELEFONICO") { echo " selected" ;} ?>>TELEFONICO</option>
 <OPTION value="EMAIL##@@EMAIL"<?php if ($tipo == "EMAIL") { echo " selected" ;} ?>>EMAIL</option>
 <OPTION value="SMS##@@SMS"<?php if ($tipo == "SMS") { echo " selected" ;} ?>>SMS</option>
 <OPTION value="PRESENCIAL##@@PRESENCIAL"<?php if ($tipo == "PRESENCIAL") { echo " selected" ;} ?>>PRESENCIAL</option>
 <OPTION value="WHATSAPP##@@WHATSAPP"<?php if ($tipo == "WHATSAPP") { echo " selected" ;} ?>>WHATSAPP</option>
 </SELECT>
      ...
      <TD id='SC_asesor_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['asesor'])) ? $this->New_label['asesor'] : "Asesor"; ?></TD>
      
      <INPUT type="hidden" id="SC_asesor_cond" name="asesor_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_asesor" <?php echo $str_hide_asesor?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['asesor'])) ? $this->New_label['asesor'] : "Asesor";
 $nmgp_tab_label .= "asesor?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $asesor_look = substr($this->Db->qstr($asesor), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['asesor'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['asesor'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_asesor">
      <SELECT class="scFilterObjectOdd" id="SC_asesor" name="asesor"  size="1">
       <OPTION value="">TODOS</OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $asesor)
            {
                    $asesor_sel = ($nm_opc_cod === $asesor) ? "selected" : "";
            }
            else
            {
               $asesor_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $asesor_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <INPUT type="hidden" id="SC_motivo_cond" name="motivo_cond" value="eq">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['motivo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['motivo'][] = "VENTA";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['motivo'][] = "ASISTENCIA";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['motivo'][] = "SOPORTE";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['motivo'][] = "COBRO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['motivo'][] = "DEMO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['motivo'][] = "DONACION";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_motivo"  name="motivo"  size="1">
 <OPTION value="">TODOS</option>
 <OPTION value="VENTA##@@VENTA"<?php if ($motivo == "VENTA") { echo " selected" ;} ?>>VENTA</option>
 <OPTION value="ASISTENCIA##@@ASISTENCIA"<?php if ($motivo == "ASISTENCIA") { echo " selected" ;} ?>>ASISTENCIA</option>
 <OPTION value="SOPORTE##@@SOPORTE"<?php if ($motivo == "SOPORTE") { echo " selected" ;} ?>>SOPORTE</option>
 <OPTION value="COBRO##@@COBRO"<?php if ($motivo == "COBRO") { echo " selected" ;} ?>>COBRO</option>
 <OPTION value="DEMO##@@DEMO"<?php if ($motivo == "DEMO") { echo " selected" ;} ?>>DEMO</option>
 <OPTION value="DONACION##@@DONACION"<?php if ($motivo == "DONACION") { echo " selected" ;} ?>>DONACION</option>
 </SELECT>
      ...
      <TD id='SC_atendido_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['atendido'])) ? $this->New_label['atendido'] : "Atendido"; ?></TD>
      
      <INPUT type="hidden" id="SC_atendido_cond" name="atendido_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_atendido" <?php echo $str_hide_atendido?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['atendido'])) ? $this->New_label['atendido'] : "Atendido";
 $nmgp_tab_label .= "atendido?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['atendido'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['atendido'][] = "contactos";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['atendido'][] = "terceros";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_atendido"  name="atendido" onChange="nm_refresh_atendido();" size="1">
 <OPTION value="">TODOS</option>
 <OPTION value="contactos##@@CONTACTO"<?php if ($atendido == "contactos") { echo " selected" ;} ?>>CONTACTO</option>
 <OPTION value="terceros##@@TERCERO"<?php if ($atendido == "terceros") { echo " selected" ;} ?>>TERCERO</option>
 </SELECT>
      ...
      <TD id='SC_id_contacto_tercero_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['id_contacto_tercero'])) ? $this->New_label['id_contacto_tercero'] : "Contacto/Tercero"; ?></TD>
      
      <INPUT type="hidden" id="SC_id_contacto_tercero_cond" name="id_contacto_tercero_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_id_contacto_tercero" <?php echo $str_hide_id_contacto_tercero?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['id_contacto_tercero'])) ? $this->New_label['id_contacto_tercero'] : "Contacto/Tercero";
 $nmgp_tab_label .= "id_contacto_tercero?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_id_contacto_tercero_orig" name="id_contacto_tercero_orig" size=7 multiple onDblClick="nm_add_sel('id_contacto_tercero_orig', 'id_contacto_tercero_dest', 'N' , '')">
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($id_contacto_tercero) && !empty($id_contacto_tercero))
            {
               $id_contacto_tercero_sel = "";
               foreach ($id_contacto_tercero as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $id_contacto_tercero_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
            ...
            {
               $id_contacto_tercero_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $id_contacto_tercero_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('id_contacto_tercero_orig', 'id_contacto_tercero_dest', 'N', '');", "nm_add_all('id_contacto_tercero_orig', 'id_contacto_tercero_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('id_contacto_tercero_orig', 'id_contacto_tercero_dest', 'N', '');", "nm_add_sel('id_contacto_tercero_orig', 'id_contacto_tercero_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('id_contacto_tercero_dest', 'id_contacto_tercero_orig', 'N', '');", "nm_del_sel('id_contacto_tercero_dest', 'id_contacto_tercero_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('id_contacto_tercero_dest', 'id_contacto_tercero_orig', 'N', '');", "nm_del_all('id_contacto_tercero_dest', 'id_contacto_tercero_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_id_contacto_tercero_dest" name="id_contacto_tercero_dest" size=7 multiple  onDblClick="nm_del_sel('id_contacto_tercero_dest', 'id_contacto_tercero_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_id_contacto_tercero" name="id_contacto_tercero" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.id_contacto_tercero_dest.selectedIndex = -1;</script>
<?php
?>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['estado'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['estado'][] = "PENDIENTE";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['estado'][] = "PROCESO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['estado'][] = "FINALIZADA";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['estado'][] = "RECHAZADA";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['estado'][] = "ESPERA";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_estado"  name="estado"  size="1">
 <OPTION value="">TODOS</option>
 <OPTION value="PENDIENTE##@@PENDIENTE"<?php if ($estado == "PENDIENTE") { echo " selected" ;} ?>>PENDIENTE</option>
 <OPTION value="PROCESO##@@PROCESO"<?php if ($estado == "PROCESO") { echo " selected" ;} ?>>PROCESO</option>
 <OPTION value="FINALIZADA##@@FINALIZADA"<?php if ($estado == "FINALIZADA") { echo " selected" ;} ?>>FINALIZADA</option>
 <OPTION value="RECHAZADA##@@RECHAZADA"<?php if ($estado == "RECHAZADA") { echo " selected" ;} ?>>RECHAZADA</option>
 <OPTION value="ESPERA##@@ESPERA"<?php if ($estado == "ESPERA") { echo " selected" ;} ?>>ESPERA</option>
 </SELECT>
...
<?php
   if (is_file("grid_historiales_crm_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_historiales_crm']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_historiales_crm']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('id_contacto_tercero_dest', 'id_contacto_tercero');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   document.F1.asesor_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_asesor'), document.F1.asesor_cond, 'asesor');
   document.F1.asesor.value = "";
   document.F1.motivo_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_motivo'), document.F1.motivo_cond, 'motivo');
   document.F1.motivo.value = "";
   document.F1.atendido_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_atendido'), document.F1.atendido_cond, 'atendido');
   document.F1.atendido.value = "";
   document.F1.id_contacto_tercero_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_id_contacto_tercero'), document.F1.id_contacto_tercero_cond, 'id_contacto_tercero');
   nm_del_all('id_contacto_tercero_dest', 'id_contacto_tercero_orig', 'N', '');
 ...
 function Sc_carga_select2(Field)
 {
    ...
    if (Field == 'all' || Field == 'asesor') {
       Sc_carga_select2_asesor();
    }
    if (Field == 'all' || Field == 'motivo') {
       Sc_carga_select2_motivo();
    }
    if (Field == 'all' || Field == 'atendido') {
       Sc_carga_select2_atendido();
    }
 ...
 function Sc_carga_select2_asesor()
 {
  $("#SC_asesor").select2(
    {
      language: {
 ...
 function Sc_carga_select2_motivo()
 {
  $("#SC_motivo").select2(
    {
      language: {
 ...
 function Sc_carga_select2_atendido()
 {
  $("#SC_atendido").select2(
    {
      language: {
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_historiales_crm_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_historiales_crm_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_historiales_crm_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_historiales_crm_valida_mes(this)});
 }
 function sc_grid_historiales_crm_valida_dia(obj)
 {
 ...
 function sc_grid_historiales_crm_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_historiales_crm";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_asesor_cond'] = 'cond';
      $tp_fields['SC_asesor'] = 'select';
      $tp_fields['SC_motivo_cond'] = 'cond';
      $tp_fields['SC_motivo'] = 'select';
      $tp_fields['SC_atendido_cond'] = 'cond';
      $tp_fields['SC_atendido'] = 'select';
      $tp_fields['SC_id_contacto_tercero_cond'] = 'cond';
      $tp_fields['SC_id_contacto_tercero'] = 'dselect';
   ...
   function trata_campos()
   {
      ...
      $asesor_cond_salva = $asesor_cond; 
      if (!isset($asesor_input_2) || $asesor_input_2 == "")
      {
          $asesor_input_2 = $asesor;
      }
      ...
      $atendido_cond_salva = $atendido_cond; 
      if (!isset($atendido_input_2) || $atendido_input_2 == "")
      {
          $atendido_input_2 = $atendido;
      }
      $id_contacto_tercero_cond_salva = $id_contacto_tercero_cond; 
      if (!isset($id_contacto_tercero_input_2) || $id_contacto_tercero_input_2 == "")
      {
          $id_contacto_tercero_input_2 = $id_contacto_tercero;
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['tipo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Tipo Contacto : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($asesor, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $asesor;
          ...
          $L_lookup = substr($asesor, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['asesor'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Asesor : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($motivo, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $motivo;
          ...
          $L_lookup = substr($motivo, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['motivo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Motivo : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($atendido, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $atendido;
          ...
          $L_lookup = substr($atendido, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['atendido'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Atendido : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (is_array($id_contacto_tercero)) {
          foreach ($id_contacto_tercero as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['id_contacto_tercero'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Contacto/Tercero : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['psq_check_ret']['estado'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['tipo'] = $tipo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['tipo_cond'] = $tipo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['asesor'] = $asesor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['asesor_cond'] = $asesor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['motivo'] = $motivo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['motivo_cond'] = $motivo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['atendido'] = $atendido; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['atendido_cond'] = $atendido_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['id_contacto_tercero'] = $id_contacto_tercero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['id_contacto_tercero_cond'] = $id_contacto_tercero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['estado'] = $estado; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['estado_cond'] = $estado_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['asesor'] = $Conteudo;
      $Conteudo = $motivo;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      ...
      $this->cmp_formatado['atendido'] = $Conteudo;
      $this->cmp_formatado['id_contacto_tercero'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['id_contacto_tercero'];
      $this->cmp_formatado['id_contacto_tercero_input_2'] = $id_contacto_tercero_input_2;
      $Conteudo = $estado;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']['fecha_input_2'] = $val[1];
      ...
      if (isset($asesor))
      {
         $this->monta_condicao("asesor", $asesor_cond, $asesor, "", "asesor");
      }
      ...
      if (isset($atendido))
      {
         $this->monta_condicao("atendido", $atendido_cond, $atendido, "", "atendido");
      }

      //----- $id_contacto_tercero
      $this->Date_part = false;
      $nm_aspas = "";
      if ($id_contacto_tercero_cond == "nu" || $id_contacto_tercero_cond == "nn" || $id_contacto_tercero_cond == "ep" || $id_contacto_tercero_cond == "ne")
      {
          $id_contacto_tercero = array();
      }
      if (is_array($id_contacto_tercero) && count($id_contacto_tercero) != 0)
      {
         foreach ($id_contacto_tercero as $i => $dados)
         {
            $tmp_pos = strpos($dados, "##@@");
            if (($tmp_pos === false && $dados == "") || $tmp_pos == 0)
            {
                unset($id_contacto_tercero[$i]);
            }
         }
      }
      if (is_array($id_contacto_tercero) && count($id_contacto_tercero) != 0)
      {
         $this->and_or();
         if ($id_contacto_tercero_cond == "df" || $id_contacto_tercero_cond == "np")
         {
             $this->comando        .= " id_contacto_tercero not in (";
             $this->comando_sum    .= " historiales_crm.id_contacto_tercero not in (";
             $this->comando_filtro .= " id_contacto_tercero not in (";
         }
         else
         {
             $this->comando        .= " id_contacto_tercero in (";
             $this->comando_sum    .= " historiales_crm.id_contacto_tercero in (";
             $this->comando_filtro .= " id_contacto_tercero in (";
         }
         $x                     = count($id_contacto_tercero);
         $xx                    = 0;
         $nm_cond               = "";
         foreach ($id_contacto_tercero as $i => $dados)
         {
         ...
         $Lang_descr_final = isset($Lang_descr[$id_contacto_tercero_cond]) ? $Lang_descr[$id_contacto_tercero_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $nmgp_tab_label['id_contacto_tercero'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($id_contacto_tercero) || $id_contacto_tercero_cond == "nu" || $id_contacto_tercero_cond == "nn" || $id_contacto_tercero_cond == "ep" || $id_contacto_tercero_cond == "ne")
      {
         $this->monta_condicao("id_contacto_tercero", $id_contacto_tercero_cond, $id_contacto_tercero, "", "id_contacto_tercero");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_historiales_crm']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "asesor" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
