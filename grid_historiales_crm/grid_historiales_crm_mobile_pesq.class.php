...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha";$Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";$Nm_numeric[] = "id_historial_crm";$Nm_numeric[] = "asesor";$Nm_numeric[] = "id_contacto_tercero";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_motivo"  <?php echo $str_hide_motivo?>> 
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_atendido"  <?php echo $str_hide_atendido?>> 
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_id_contacto_tercero"  <?php echo $str_hide_id_contacto_tercero?>>
<?php
      $id_contacto_tercero_look = substr($this->Db->qstr($id_contacto_tercero), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT idtercero, nombres  FROM v_contactos_terceros  WHERE tipo='$atendido' ORDER BY nombres"; 
...
?>
   <span id="idAjaxSelect_id_contacto_tercero">
      <SELECT class="scFilterObjectEven" id="SC_id_contacto_tercero" name="id_contacto_tercero[]"  size="7" multiple>
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
         ...
         if (!empty($nm_opcao))
         {
            ...
            if (is_array($id_contacto_tercero) && !empty($id_contacto_tercero))
            {
               ...
               foreach ($id_contacto_tercero as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $id_contacto_tercero_sel = "selected";
                       break;
                   }
               }
            }
...
?>
 ...
 function limpa_form()
 {
   ...
   {
      if (document.F1.elements[i].name == 'id_contacto_tercero[]')
      {
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         ...
         case "id_contacto_tercero" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
