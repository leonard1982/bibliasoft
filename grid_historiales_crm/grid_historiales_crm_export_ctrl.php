<?php
@session_start() ;
$_SESSION['scriptcase']['grid_historiales_crm']['sc_process_barr'] = true;
require_once('../grid_historiales_crm/index.php');
unset($_SESSION['scriptcase']['grid_historiales_crm']['sc_process_barr']);
$ExportCtrl = new grid_historiales_crm_export_control;
$ExportCtrl->Export_barr();

class grid_historiales_crm_export_control
{
