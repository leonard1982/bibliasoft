<?php
   include_once('grid_productos_imagen_session.php');
   session_start();
...
<?php
   ...
   $Ord_Cmp = new grid_productos_imagen_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_productos_imagen_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_productos_imagen_json.php");
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['imagen2'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['imagen2'] = "imagen2";
   }
   else
   {
       $tab_def_campos['imagen2'] = "";
   }
   $tab_labels["imagen2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['labels']["imagen2"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['labels']["imagen2"] : "Imagen";
   $tab_ger_campos['nompro'] = "on";
   $tab_def_campos['nompro'] = "nompro";
   $tab_labels["nompro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['labels']["nompro"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['labels']["nompro"] : "Descripción";
   ...
   {
       $tab_def_campos['cantidad'] = "";
   }
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['labels']["cantidad"] : "";
   $tab_ger_campos['imagen2'] = "none";
   $tab_ger_campos['cantidad'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_productos_imagen']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_productos_imagen']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_productos_imagen']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_productos_imagen_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_productos_imagen']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
