...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_imagen"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_imagen"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_imagen']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_imagen']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_imagen']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_imagen']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_productos_imagen']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_productos_imagen</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_productos_imagen']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_productos_imagen']['embutida_filho'] as $ind => $sc_init)
          {
