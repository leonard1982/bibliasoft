...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_030822']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="fac_compras_new_030822"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_030822']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_030822']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_030822']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_030822']['where_detal']))
  {
?>  
...
{
    document.getElementById('fac_compras_new_030822_form0').style.width='1px';
    document.getElementById('fac_compras_new_030822_form0').style.height='0px';
    document.getElementById('fac_compras_new_030822_form0').style.display='none';
    document.getElementById('fac_compras_new_030822_form0').style.overflow='scroll';
    document.getElementById('fac_compras_new_030822_form1').style.width='1px';
    document.getElementById('fac_compras_new_030822_form1').style.height='0px';
    document.getElementById('fac_compras_new_030822_form1').style.display='none';
    document.getElementById('fac_compras_new_030822_form1').style.overflow='scroll';
    document.getElementById('fac_compras_new_030822_form2').style.width='1px';
    document.getElementById('fac_compras_new_030822_form2').style.height='0px';
    document.getElementById('fac_compras_new_030822_form2').style.display='none';
    document.getElementById('fac_compras_new_030822_form2').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_new_030822']['pdf_view']) {
?>
...
?>
   ...
   if ("fac_compras_new_030822_form1" == N_pagina) {
     scAjaxDetailHeight("detallecompra_new", "600");
    }
   if ("fac_compras_new_030822_form2" == N_pagina) {
