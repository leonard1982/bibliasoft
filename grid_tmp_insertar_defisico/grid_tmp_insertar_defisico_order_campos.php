...
<?php
   ...
   $Ord_Cmp = new grid_tmp_insertar_defisico_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_tmp_insertar_defisico_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['fisicoid'] = "FISICOID";
   $tab_labels["fisicoid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["fisicoid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["fisicoid"] : "FISICOID";
   $tab_ger_campos['matid'] = "on";
   $tab_def_campos['matid'] = "MATID";
   $tab_labels["matid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["matid"])) ? $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["matid"] : "MATID";
   $tab_ger_campos['canmat'] = "on";
   $tab_def_campos['canmat'] = "CANMAT";
   $tab_labels["canmat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["canmat"])) ? $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["canmat"] : "CANMAT";
   $tab_ger_campos['tipund'] = "on";
   $tab_def_campos['tipund'] = "TIPUND";
   $tab_labels["tipund"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["tipund"])) ? $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["tipund"] : "TIPUND";
   $tab_ger_campos['canlista'] = "on";
   $tab_def_campos['canlista'] = "CANLISTA";
   $tab_labels["canlista"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["canlista"])) ? $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['labels']["canlista"] : "CANLISTA";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_tmp_insertar_defisico_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_tmp_insertar_defisico']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
