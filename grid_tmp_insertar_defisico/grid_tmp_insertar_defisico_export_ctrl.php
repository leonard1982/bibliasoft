<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tmp_insertar_defisico']['sc_process_barr'] = true;
require_once('../grid_tmp_insertar_defisico/index.php');
unset($_SESSION['scriptcase']['grid_tmp_insertar_defisico']['sc_process_barr']);
$ExportCtrl = new grid_tmp_insertar_defisico_export_control;
$ExportCtrl->Export_barr();

class grid_tmp_insertar_defisico_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_tmp_insertar_defisico']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_tmp_insertar_defisico']['glo_nm_path_imag_temp'];
