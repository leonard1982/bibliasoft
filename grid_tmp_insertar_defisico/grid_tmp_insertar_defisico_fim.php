<?php
   include_once('grid_tmp_insertar_defisico_session.php');
   session_start();
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_tmp_insertar_defisico"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_tmp_insertar_defisico"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_tmp_insertar_defisico</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tmp_insertar_defisico']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_tmp_insertar_defisico' || $achou)
          {
