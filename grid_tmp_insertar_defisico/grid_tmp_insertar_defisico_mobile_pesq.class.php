...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "matid";$Nm_numeric[] = "canlista";$Nm_numeric[] = "existencia";$Nm_numeric[] = "canmat";$Nm_numeric[] = "matid";$Nm_numeric[] = "canlista";$Nm_numeric[] = "existencia";$Nm_numeric[] = "canmat";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_fisicoid_cond" name="fisicoid_cond" onChange="nm_campos_between(document.getElementById('id_vis_fisicoid'), this, 'fisicoid')">
      ...
      <br><span id="id_hide_fisicoid"  <?php echo $str_hide_fisicoid?>><?php
      if ($fisicoid != "")
      {
      $fisicoid_look = substr($this->Db->qstr($fisicoid), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_matid_cond" name="matid_cond" onChange="nm_campos_between(document.getElementById('id_vis_matid'), this, 'matid')">
      ...
      <br><span id="id_hide_matid"  <?php echo $str_hide_matid?>><?php
      if ($matid != "")
      {
      $matid_look = substr($this->Db->qstr($matid), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-matid" id="id_ac_matid" name="matid_autocomp"><?php if ('' !=  $matid) { ?><option value="<?php echo $matid ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_matid"  <?php echo $str_display_matid; ?> class="scFilterFieldFontEven">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_canlista_cond" name="canlista_cond" onChange="nm_campos_between(document.getElementById('id_vis_canlista'), this, 'canlista')">
      ...
      <br><span id="id_hide_canlista"  <?php echo $str_hide_canlista?>><?php
      if ($canlista != "")
      {
      $canlista_look = substr($this->Db->qstr($canlista), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_tipund_cond" name="tipund_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipund'), this, 'tipund')">
      ...
      <br><span id="id_hide_tipund"  <?php echo $str_hide_tipund?>><?php
      if ($tipund != "")
      {
      $tipund_look = substr($this->Db->qstr($tipund), 1, -1); 
      $nmgp_def_dados = array(); 
