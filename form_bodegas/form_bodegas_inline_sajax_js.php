  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_bodegas_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_bodegas_inline_form();
	}
  ...
  // ---------- Validate bodega_
  function do_ajax_form_bodegas_inline_validate_bodega_()
  {
    var nomeCampo_bodega_ = "bodega_";
    var var_bodega_ = scAjaxGetFieldText(nomeCampo_bodega_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bodegas_inline_validate_bodega_(var_bodega_, var_script_case_init, do_ajax_form_bodegas_inline_validate_bodega__cb);
  } // do_ajax_form_bodegas_inline_validate_bodega_

  function do_ajax_form_bodegas_inline_validate_bodega__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bodegas_inline_validate_bodega__cb

  // ---------- Validate idbodega_
  function do_ajax_form_bodegas_inline_validate_idbodega_()
  {
    var nomeCampo_idbodega_ = "idbodega_";
    var var_idbodega_ = scAjaxGetFieldText(nomeCampo_idbodega_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bodegas_inline_validate_idbodega_(var_idbodega_, var_script_case_init, do_ajax_form_bodegas_inline_validate_idbodega__cb);
  } // do_ajax_form_bodegas_inline_validate_idbodega_

  function do_ajax_form_bodegas_inline_validate_idbodega__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bodegas_inline_validate_idbodega__cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_bodegas_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_bodegas_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_bodega_ = scAjaxGetFieldText("bodega_");
    var var_idbodega_ = scAjaxGetFieldText("idbodega_");
    ...
    scAjaxProcOn();
    x_ajax_form_bodegas_inline_submit_form(var_bodega_, var_idbodega_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_bodegas_inline_submit_form_cb);
  } // do_ajax_form_bodegas_inline_submit_form

  function do_ajax_form_bodegas_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("bodega_");
      scAjaxHideErrorDisplay("idbodega_");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_bodegas_inline_submit_form_cb_after_alert);
  } // do_ajax_form_bodegas_inline_submit_form_cb
  function do_ajax_form_bodegas_inline_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_bodegas_inline_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_bodegas_inline_navigate_form()
  {
    perform_ajax_form_bodegas_inline_navigate_form();
  }

  function perform_ajax_form_bodegas_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_bodegas_inline_navigate_form(var_idbodega_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bodegas_inline_navigate_form_cb);
  } // do_ajax_form_bodegas_inline_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_bodegas_inline']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_bodegas_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_bodegas_inline_navigate_form_cb_after_alert);
  } // do_ajax_form_bodegas_inline_navigate_form_cb
  function do_ajax_form_bodegas_inline_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_bodegas_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_bodegas_inline_navigate_form_cb_after_alert
  function sc_hide_form_bodegas_inline_form()
  {
  ...
  ajax_field_list[0] = "bodega_";
  ajax_field_list[1] = "idbodega_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "bodega_": {"label": "Bodega", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idbodega_": {"label": "Idbodega", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["bodega_"][1] = "bodega_";
  ajax_field_mult["idbodega_"][1] = "idbodega_";

  var ajax_field_id = {
    "bodega_": new Array("hidden_field_label_bodega_", "hidden_field_data_bodega_")
  };
