<?php
@session_start() ;
$_SESSION['scriptcase']['grid_mensajes_masivos']['sc_process_barr'] = true;
require_once('../grid_mensajes_masivos/index.php');
unset($_SESSION['scriptcase']['grid_mensajes_masivos']['sc_process_barr']);
$ExportCtrl = new grid_mensajes_masivos_export_control;
$ExportCtrl->Export_barr();

class grid_mensajes_masivos_export_control
{
