...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_mensajes_masivos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_mensajes_masivos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_mensajes_masivos'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_mensajes_masivos</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_mensajes_masivos']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_mensajes_masivos' || $achou)
          {
