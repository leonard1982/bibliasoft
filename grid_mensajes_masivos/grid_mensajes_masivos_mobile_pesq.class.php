...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "inicio";$Nm_datas[] = "inicio";$Nm_datas[] = "fin";$Nm_datas[] = "fin";$Nm_numeric[] = "id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_creado"  <?php echo $str_hide_creado?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
