...
class grid_mensajes_masivos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_mensajes_masivos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_mensajes_masivos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_mensajes_masivos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$campo_join]);
              return;
          }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "inicio";$Nm_datas[] = "inicio";$Nm_datas[] = "fin";$Nm_datas[] = "fin";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         $nome_sum = "mensajes_masivos.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> mensajes_masivos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_mensajes_masivos/grid_mensajes_masivos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_mensajes_masivos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_mensajes_masivos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_mensajes_masivos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_mensajes_masivos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_mensajes_masivos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['ajax_nav'])
           { 
...
function scJQCalendarAdd() {
  $("#sc_creado_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_creado_dia').value + '/';
          var_dt_ini += document.getElementById('SC_creado_mes').value + '/';
          var_dt_ini += document.getElementById('SC_creado_ano').value;
          document.getElementById('sc_creado_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_creado_dia').value = aParts[0];
          document.getElementById('SC_creado_mes').value = aParts[1];
          document.getElementById('SC_creado_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_creado_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_creado_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_creado_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_creado_input_2_ano').value;
          document.getElementById('sc_creado_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_creado_input_2_dia').value = aParts[0];
          document.getElementById('SC_creado_input_2_mes').value = aParts[1];
          document.getElementById('SC_creado_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_title'] ?> mensajes_masivos</span></td>
...
<?php
   ...
   function monta_form()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_mensajes_masivos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_mensajes_masivos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_mensajes_masivos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_mensajes_masivos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $creado_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_dia']; 
          $creado_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_mes']; 
          $creado_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_ano']; 
          $creado_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_dia']; 
          $creado_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_mes']; 
          $creado_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_ano']; 
          $creado_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_hor']; 
          $creado_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_min']; 
          $creado_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_seg']; 
          $creado_input_2_hor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_hor']; 
          $creado_input_2_min = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_min']; 
          $creado_input_2_seg = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_seg']; 
          $creado_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_cond']; 
          $descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['descripcion']; 
          $descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['descripcion_cond']; 
          $activo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['activo']; 
          $activo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['activo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['NM_operador']; 
      } 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_creado_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['creado'])) ? $this->New_label['creado'] : "Creado"; ?></TD>
      
      <INPUT type="hidden" id="SC_creado_cond" name="creado_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_creado" <?php echo $str_hide_creado?> valign="top">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_creado_ano" name="creado_ano" value="<?php echo NM_encode_input($creado_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_creado_jq">
</span>
...
?>
       ...
       <TR valign="top">
        <TD id="id_vis_creado"  <?php echo $str_display_creado; ?> class="scFilterFieldFontOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_creado_input_2_ano" name="creado_input_2_ano" value="<?php echo NM_encode_input($creado_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_creado_jq2">
</span>
...
?>
      ...
      <TD id='SC_descripcion_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['descripcion'])) ? $this->New_label['descripcion'] : "Descripcion"; ?></TD>
      
      <INPUT type="hidden" id="SC_descripcion_cond" name="descripcion_cond" value="qp">
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_descripcion" name="descripcion_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "select distinct activo from " . $this->Ini->nm_tabela . " order by activo"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['psq_check_ret']['activo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['psq_check_ret']['activo'][] = trim($rs->fields[0]);
...
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $activo)
            {
                    $activo_sel = ($nm_opc_cod === $activo) ? "selected" : "";
            }
            else
            {
               $activo_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $activo_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if (!$_SESSION['scriptcase']['proc_mobile'])
     {
...
<?php
   if (is_file("grid_mensajes_masivos_help.txt"))
   {
      $Arq_WebHelp = file("grid_mensajes_masivos_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_mensajes_masivos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_mensajes_masivos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_mensajes_masivos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_mensajes_masivos']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.creado_cond.value = 'bw';
 ...
 {
    $('#SC_creado_dia').bind('change', function() {sc_grid_mensajes_masivos_valida_dia(this)});
    $('#SC_creado_input_2_dia').bind('change', function() {sc_grid_mensajes_masivos_valida_dia(this)});
    $('#SC_creado_input_2_mes').bind('change', function() {sc_grid_mensajes_masivos_valida_mes(this)});
    $('#SC_creado_mes').bind('change', function() {sc_grid_mensajes_masivos_valida_mes(this)});
 }
 function sc_grid_mensajes_masivos_valida_dia(obj)
 {
 ...
 function sc_grid_mensajes_masivos_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_mensajes_masivos";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] = "";
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $nmgp_tab_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['pesq_tab_label'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_orig'] = "";
      }
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          $this->comando = "";
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_mensajes_masivos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq'] = array();
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['psq_check_ret']['activo'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_dia'] = $creado_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_mes'] = $creado_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_ano'] = $creado_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_dia'] = $creado_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_mes'] = $creado_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_ano'] = $creado_input_2_ano; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0][] = "D:" . $creado_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0][] = "M:" . $creado_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0][] = "Y:" . $creado_ano;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][1][] = "D:" . $creado_input_2_dia;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][1][] = "M:" . $creado_input_2_mes;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][1][] = "Y:" . $creado_input_2_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_hor'] = $creado_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_min'] = $creado_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_seg'] = $creado_seg; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_hor'] = $creado_input_2_hor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_min'] = $creado_input_2_min; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2_seg'] = $creado_input_2_seg; 
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0][] = "H:" . $creado_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0][] = "I:" . $creado_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0][] = "S:" . $creado_seg;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][1][] = "H:" . $creado_input_2_hor;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][1][] = "I:" . $creado_input_2_min;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][1][] = "S:" . $creado_input_2_seg;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_cond'] = $creado_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['cmp'] = "creado"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['opc'] = $creado_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq']['creado'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['descripcion'] = $descripcion; 
      if (is_array($descripcion) && !empty($descripcion))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0] = $descripcion;
      }
      ...
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0][0] = $descripcion;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['descripcion_cond'] = $descripcion_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['cmp'] = "descripcion"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['opc'] = $descripcion_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq']['descripcion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['activo'] = $activo; 
      if (is_array($activo) && !empty($activo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0] = $activo;
      }
      elseif ($activo_cond_salva == "nu" || $activo_cond_salva == "nn" || $activo_cond_salva == "ep" || $activo_cond_salva == "ne" || !empty($activo))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['val'][0][0] = $activo;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['activo_cond'] = $activo_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['cmp'] = "activo"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid]['opc'] = $activo_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq']['activo'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($descripcion != '') {
      ...
      if ($creado_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['creado'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['creado'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($creado_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']['creado_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['creado_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['creado_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq']['creado']['label'] = $nmgp_tab_label['creado'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq']['creado']['descr'] = $nmgp_tab_label['creado'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['grid_pesq']['creado']['hint']  = $nmgp_tab_label['creado'] . " " . $this->Ini->Nm_lang['lang_srch_ever'];
      }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_grid'] = $this->comando;
       if (empty($this->comando)) 
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_filtro'] = "";
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_orig'];
       }
       else
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_dyn_search'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_filtro'] = "";
      }
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_mensajes_masivos']['where_pesq'];
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "activo" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
