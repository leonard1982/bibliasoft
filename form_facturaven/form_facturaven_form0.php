...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "autorizar", "scBtnFn_autorizar()", "scBtnFn_autorizar()", "sc_autorizar_top", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_facturaven_empty.htm' : $this->Ini->link_form_detalleventa_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=1000';
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_detalleventa"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="1000" width="1250" name="nmsc_iframe_liga_form_detalleventa"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
