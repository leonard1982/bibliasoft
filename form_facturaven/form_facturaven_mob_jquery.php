...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["elpedido" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["elpedido" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["elpedido" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_numfacven' + iSeqRow).bind('blur', function() { sc_form_facturaven_numfacven_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_facturaven_numfacven_onfocus(this, iSeqRow) });
  $('#id_sc_field_nremision' + iSeqRow).bind('blur', function() { sc_form_facturaven_nremision_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_facturaven_nremision_onfocus(this, iSeqRow) });
  $('#id_sc_field_credito' + iSeqRow).bind('blur', function() { sc_form_facturaven_credito_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_facturaven_credito_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_facturaven_credito_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechaven' + iSeqRow).bind('blur', function() { sc_form_facturaven_fechaven_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_facturaven_fechaven_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_facturaven_fechaven_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechavenc' + iSeqRow).bind('blur', function() { sc_form_facturaven_fechavenc_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_facturaven_fechavenc_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_facturaven_fechavenc_onfocus(this, iSeqRow) });
  $('#id_sc_field_idcli' + iSeqRow).bind('blur', function() { sc_form_facturaven_idcli_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_facturaven_idcli_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_facturaven_idcli_onfocus(this, iSeqRow) });
  $('#id_sc_field_subtotal' + iSeqRow).bind('blur', function() { sc_form_facturaven_subtotal_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_facturaven_subtotal_onfocus(this, iSeqRow) });
  $('#id_sc_field_valoriva' + iSeqRow).bind('blur', function() { sc_form_facturaven_valoriva_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_facturaven_valoriva_onfocus(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_form_facturaven_total_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_facturaven_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_pagada' + iSeqRow).bind('blur', function() { sc_form_facturaven_pagada_onblur(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_facturaven_pagada_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentada' + iSeqRow).bind('blur', function() { sc_form_facturaven_asentada_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_facturaven_asentada_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_facturaven_asentada_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_facturaven_observaciones_onblur(this, iSeqRow) })
                                           .bind('focus', function() { sc_form_facturaven_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_form_facturaven_saldo_onblur(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_facturaven_saldo_onfocus(this, iSeqRow) });
  $('#id_sc_field_adicional' + iSeqRow).bind('blur', function() { sc_form_facturaven_adicional_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_facturaven_adicional_onfocus(this, iSeqRow) });
  $('#id_sc_field_vendedor' + iSeqRow).bind('blur', function() { sc_form_facturaven_vendedor_onblur(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_facturaven_vendedor_onfocus(this, iSeqRow) });
  $('#id_sc_field_pedido' + iSeqRow).bind('blur', function() { sc_form_facturaven_pedido_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_facturaven_pedido_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_facturaven_pedido_onfocus(this, iSeqRow) });
  $('#id_sc_field_resolucion' + iSeqRow).bind('blur', function() { sc_form_facturaven_resolucion_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_facturaven_resolucion_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_facturaven_resolucion_onfocus(this, iSeqRow) });
  $('#id_sc_field_dircliente' + iSeqRow).bind('blur', function() { sc_form_facturaven_dircliente_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_facturaven_dircliente_onfocus(this, iSeqRow) });
  $('#id_sc_field_imconsumo' + iSeqRow).bind('blur', function() { sc_form_facturaven_imconsumo_onblur(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_facturaven_imconsumo_onfocus(this, iSeqRow) });
  $('#id_sc_field_retefuente' + iSeqRow).bind('blur', function() { sc_form_facturaven_retefuente_onblur(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_facturaven_retefuente_onfocus(this, iSeqRow) });
  $('#id_sc_field_reteiva' + iSeqRow).bind('blur', function() { sc_form_facturaven_reteiva_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_facturaven_reteiva_onfocus(this, iSeqRow) });
  $('#id_sc_field_reteica' + iSeqRow).bind('blur', function() { sc_form_facturaven_reteica_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_facturaven_reteica_onfocus(this, iSeqRow) });
  $('#id_sc_field_cree' + iSeqRow).bind('blur', function() { sc_form_facturaven_cree_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_facturaven_cree_onfocus(this, iSeqRow) });
  $('#id_sc_field_dias_decredito' + iSeqRow).bind('blur', function() { sc_form_facturaven_dias_decredito_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_facturaven_dias_decredito_onchange(this, iSeqRow) })
                                            .bind('focus', function() { sc_form_facturaven_dias_decredito_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupo' + iSeqRow).bind('blur', function() { sc_form_facturaven_cupo_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_facturaven_cupo_onfocus(this, iSeqRow) });
  $('#id_sc_field_cupodis' + iSeqRow).bind('blur', function() { sc_form_facturaven_cupodis_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_facturaven_cupodis_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_form_facturaven_detalle_onblur(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_facturaven_detalle_onfocus(this, iSeqRow) });
  $('#id_sc_field_pref_pedido' + iSeqRow).bind('blur', function() { sc_form_facturaven_pref_pedido_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_facturaven_pref_pedido_onfocus(this, iSeqRow) });
  $('#id_sc_field_elpedido' + iSeqRow).bind('blur', function() { sc_form_facturaven_elpedido_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_facturaven_elpedido_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_form_facturaven_elpedido_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_facturaven_numfacven_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_numfacven();
  scCssBlur(oThis);
}

function sc_form_facturaven_numfacven_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_nremision_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_nremision();
  scCssBlur(oThis);
}

function sc_form_facturaven_nremision_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_credito_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_credito();
  scCssBlur(oThis);
}

function sc_form_facturaven_credito_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_credito_onchange();
}

function sc_form_facturaven_credito_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_fechaven_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_fechaven();
  scCssBlur(oThis);
}

function sc_form_facturaven_fechaven_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_fechaven_onchange();
}

function sc_form_facturaven_fechaven_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_fechavenc_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_fechavenc();
  scCssBlur(oThis);
}

function sc_form_facturaven_fechavenc_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_fechavenc_onchange();
}

function sc_form_facturaven_fechavenc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_idcli_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_idcli();
  scCssBlur(oThis);
}

function sc_form_facturaven_idcli_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_idcli_onchange();
}

function sc_form_facturaven_idcli_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_facturaven_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_subtotal();
  scCssBlur(oThis);
}

function sc_form_facturaven_subtotal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_valoriva_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_valoriva();
  scCssBlur(oThis);
}

function sc_form_facturaven_valoriva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_total_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_total();
  scCssBlur(oThis);
}

function sc_form_facturaven_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_pagada_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_pagada();
  scCssBlur(oThis);
}

function sc_form_facturaven_pagada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_asentada_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_asentada();
  scCssBlur(oThis);
}

function sc_form_facturaven_asentada_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_asentada_onchange();
}

function sc_form_facturaven_asentada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_observaciones();
  scCssBlur(oThis);
}

function sc_form_facturaven_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_saldo_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_saldo();
  scCssBlur(oThis);
}

function sc_form_facturaven_saldo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_adicional_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_adicional();
  scCssBlur(oThis);
}

function sc_form_facturaven_adicional_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_vendedor_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_vendedor();
  scCssBlur(oThis);
}

function sc_form_facturaven_vendedor_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_form_facturaven_pedido_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_pedido();
  scCssBlur(oThis);
}

function sc_form_facturaven_pedido_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_pedido_onchange();
}

function sc_form_facturaven_pedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_resolucion_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_resolucion();
  scCssBlur(oThis);
}

function sc_form_facturaven_resolucion_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_resolucion_onchange();
}

function sc_form_facturaven_resolucion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_dircliente_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_dircliente();
  scCssBlur(oThis);
}

function sc_form_facturaven_dircliente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_imconsumo_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_imconsumo();
  scCssBlur(oThis);
}

function sc_form_facturaven_imconsumo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_retefuente_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_retefuente();
  scCssBlur(oThis);
}

function sc_form_facturaven_retefuente_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_reteiva_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_reteiva();
  scCssBlur(oThis);
}

function sc_form_facturaven_reteiva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_reteica_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_reteica();
  scCssBlur(oThis);
}

function sc_form_facturaven_reteica_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_cree_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_cree();
  scCssBlur(oThis);
}

function sc_form_facturaven_cree_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_dias_decredito_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_dias_decredito();
  scCssBlur(oThis);
}

function sc_form_facturaven_dias_decredito_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_dias_decredito_onchange();
}

function sc_form_facturaven_dias_decredito_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_cupo_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_cupo();
  scCssBlur(oThis);
}

function sc_form_facturaven_cupo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_cupodis_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_cupodis();
  scCssBlur(oThis);
}

function sc_form_facturaven_cupodis_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_detalle_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_detalle();
  scCssBlur(oThis);
}

function sc_form_facturaven_detalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_pref_pedido_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_pref_pedido();
  scCssBlur(oThis);
}

function sc_form_facturaven_pref_pedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_facturaven_elpedido_onblur(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_validate_elpedido();
  scCssBlur(oThis);
}

function sc_form_facturaven_elpedido_onchange(oThis, iSeqRow) {
  do_ajax_form_facturaven_mob_event_elpedido_onchange();
}

function sc_form_facturaven_elpedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_0(status) {
	...
	displayChange_field("elpedido", "", status);
...
function displayChange_row(row, status) {
	...
	displayChange_field_elpedido(row, status);
...
function displayChange_field_elpedido(row, status) {
}
...
function displayChange_field_detalle(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_detalleventa_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_detalleventa_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_facturaven_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechaven" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_facturaven_mob_validate_fechaven(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_facturaven_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_facturaven_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_facturaven_mob_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_facturaven_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
