<?php
include_once('form_facturaven_session.php');
@session_start() ;
class form_facturaven_help
{
...
<?php echo "<b>DOCUMENTO A CARGAR?:</b><br>" . nl2br("Factura Pedidos, Cotizaciones y Proformas"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_facturaven_help();
?>
