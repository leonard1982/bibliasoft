...
<?php
   ...
   $Ord_Cmp = new grid_vencimiento_lote_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_vencimiento_lote_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["grupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["grupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["grupo"] : "Grupo";
   $tab_ger_campos['idbodega'] = "on";
   $tab_def_campos['idbodega'] = "idbodega";
   $tab_labels["idbodega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["idbodega"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["idbodega"] : "Bodega";
   $tab_ger_campos['idproducto'] = "on";
   $tab_def_campos['idproducto'] = "idproducto";
   $tab_labels["idproducto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["idproducto"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["idproducto"] : "Producto";
   $tab_ger_campos['fecha_vencimiento'] = "on";
   $tab_def_campos['fecha_vencimiento'] = "fecha_vencimiento";
   $tab_labels["fecha_vencimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["fecha_vencimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["fecha_vencimiento"] : "Vencimiento";
   $tab_ger_campos['dias_vencimiento'] = "on";
   $tab_def_campos['dias_vencimiento'] = "dias_vencimiento";
   $tab_labels["dias_vencimiento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["dias_vencimiento"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["dias_vencimiento"] : "Dias Vencimiento";
   $tab_ger_campos['fecha_fab'] = "on";
   $tab_def_campos['fecha_fab'] = "fecha_fab";
   $tab_labels["fecha_fab"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["fecha_fab"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["fecha_fab"] : "Fabricación";
   $tab_ger_campos['lote'] = "on";
   $tab_def_campos['lote'] = "lote";
   $tab_labels["lote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["lote"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["lote"] : "Lote";
   $tab_ger_campos['serial_codbarra'] = "on";
   $tab_def_campos['serial_codbarra'] = "serial_codbarra";
   $tab_labels["serial_codbarra"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["serial_codbarra"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["serial_codbarra"] : "Serial";
   $tab_ger_campos['existencia'] = "on";
   $tab_def_campos['existencia'] = "existencia";
   $tab_labels["existencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["existencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['labels']["existencia"] : "Existencia";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_vencimiento_lote_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_vencimiento_lote']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
