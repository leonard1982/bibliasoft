...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_vencimiento_lote"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_vencimiento_lote"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vencimiento_lote']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_vencimiento_lote']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_vencimiento_lote']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_vencimiento_lote']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_vencimiento_lote']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_vencimiento_lote</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_vencimiento_lote']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_vencimiento_lote']['embutida_filho'] as $ind => $sc_init)
          {
