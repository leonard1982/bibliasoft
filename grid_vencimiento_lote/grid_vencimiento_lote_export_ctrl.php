<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vencimiento_lote']['sc_process_barr'] = true;
require_once('../grid_vencimiento_lote/index.php');
unset($_SESSION['scriptcase']['grid_vencimiento_lote']['sc_process_barr']);
$ExportCtrl = new grid_vencimiento_lote_export_control;
$ExportCtrl->Export_barr();

class grid_vencimiento_lote_export_control
{
