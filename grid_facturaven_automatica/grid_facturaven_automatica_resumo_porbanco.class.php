...
$_SESSION['scriptcase']['grid_facturaven_automatica']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['arr_total']['banco'];
      }
      else
      {
          $this->array_total_banco = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['arr_total']['banco'] = $this->array_total_banco;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['labels']['banco'] = $Lab_banco; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_order']['porbanco']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_order']['porbanco'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_order']['porbanco'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porbanco'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porbanco'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porbanco'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porbanco'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porbanco'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porbanco'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porbanco'] as $i_sum => $d_sum)
           {
