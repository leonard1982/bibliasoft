...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_facturaven_automatica"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_facturaven_automatica"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_facturaven_automaticas'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_facturaven_automatica</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_facturaven_automatica']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_facturaven_automatica' || $achou)
          {
