...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_facturaven_automatica"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_facturaven_automatica"]);
   }
