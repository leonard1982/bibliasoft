...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_automatica_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_automatica_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["numfacven"] : "No";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["resolucion"] : "Prefijo";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["credito"] : "Forma Pago";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['direccion2'] = "on";
   $tab_def_campos['direccion2'] = "direccion2";
   $tab_labels["direccion2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["direccion2"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["direccion2"] : "Dirección";
   ...
   $tab_labels["copiar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["copiar"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['labels']["copiar"] : "Duplicar";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_automatica_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select'];
