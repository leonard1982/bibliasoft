...
$_SESSION['scriptcase']['grid_facturaven_automatica']['contr_erro'] = 'off'; 
      ...
      while (!$rs->EOF)
      {
         ...
         $this->fechaven = $rs->fields[6] ;  
         $this->fechavenc = $rs->fields[7] ;  
