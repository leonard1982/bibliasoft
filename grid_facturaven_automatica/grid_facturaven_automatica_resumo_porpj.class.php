...
$_SESSION['scriptcase']['grid_facturaven_automatica']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['arr_total']['resolucion'];
      }
      else
      {
          $this->array_total_resolucion = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['arr_total']['resolucion'] = $this->array_total_resolucion;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['labels']['resolucion'] = $Lab_resolucion; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_order']['porpj']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_order']['porpj'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_order']['porpj'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porpj'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porpj'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porpj'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porpj'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porpj'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porpj'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_automatica']['summarizing_fields_display']['porpj'] as $i_sum => $d_sum)
           {
