<?php
   include_once('grid_facturaven_automatica_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_facturaven_automatica']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_facturaven_automatica']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_facturaven_automatica']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_facturaven_automatica']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Sel_Groupby = new grid_facturaven_automatica_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_facturaven_automatica_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   {
       include_once("grid_facturaven_automatica_json.php");
   }
   $this->Arr_result   = array();
   $this->static_gb_ok = "";
   
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['credito'] = array('cmp' => "credito", 'ind' => 0, 'format' => "");
           $tab_arr_groubby_cmp['fechaven'] = array('cmp' => "fechaven", 'ind' => 1, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['fechavenc'] = array('cmp' => "fechavenc", 'ind' => 2, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['idcli'] = array('cmp' => "idcli", 'ind' => 3, 'format' => "");
           $tab_arr_groubby_cmp['pagada'] = array('cmp' => "pagada", 'ind' => 4, 'format' => "");
           $tab_arr_groubby_cmp['asentada'] = array('cmp' => "asentada", 'ind' => 5, 'format' => "");
           $tab_arr_groubby_cmp['resolucion'] = array('cmp' => "resolucion", 'ind' => 6, 'format' => "");
           $tab_arr_groubby_cmp['vendedor'] = array('cmp' => "vendedor", 'ind' => 7, 'format' => "");
           $tab_arr_groubby_cmp['tipo'] = array('cmp' => "tipo", 'ind' => 8, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "credito", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "fechaven", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "fechavenc", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "idcli", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "pagada", 'ord' => 'asc');
           $tab_arr_groubby_sql[5] = array('cmp' => "asentada", 'ord' => 'asc');
           $tab_arr_groubby_sql[6] = array('cmp' => "resolucion", 'ord' => 'asc');
           $tab_arr_groubby_sql[7] = array('cmp' => "vendedor", 'ord' => 'asc');
           $tab_arr_groubby_sql[8] = array('cmp' => "tipo", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['credito'] = "Forma Pago";
   $arr_campos_free['fechaven'] = "Fecha";
   $arr_campos_free['fechavenc'] = "Fechavenc";
   $arr_campos_free['idcli'] = "Cliente";
   $arr_campos_free['pagada'] = "Pagada";
   $arr_campos_free['asentada'] = "Asentada";
   $arr_campos_free['resolucion'] = "Prefijo";
   $arr_campos_free['vendedor'] = " Vendedor";
...
<HEAD>
 <TITLE>Facturas automáticas</TITLE>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_facturaven_automatica_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
<?php
    ...
    $iTabCount            = 1;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
        {
...
<?php
     if (!in_array("fecha", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
         $this->static_gb_ok = "sc_id_sel_groupby_fecha";
        if ($groupby_atual == "fecha")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_fecha";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_fecha");display_btn_restore_gb();' name="sel_groupby" value="fecha" id="sc_id_sel_groupby_fecha"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_fecha">
        Por Fecha
<?php
    $prep_labels = array();
    $prep_labels[] = "Fecha";
...
?>
<?php
     if (!in_array("formapago", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "formapago")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_formapago";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_formapago");display_btn_restore_gb();' name="sel_groupby" value="formapago" id="sc_id_sel_groupby_formapago"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_formapago">
        Forma de Pago
<?php
    $prep_labels = array();
    $prep_labels[] = "Forma Pago";
?>
        <span>
        <?php echo implode($prep_labels, ', ');?>
        </span>
...
?>
<?php
     if (!in_array("porcliente", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "porcliente")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porcliente";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porcliente");display_btn_restore_gb();' name="sel_groupby" value="porcliente" id="sc_id_sel_groupby_porcliente"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porcliente">
        Por Cliente
<?php
    $prep_labels = array();
    $prep_labels[] = "Cliente";
...
?>
<?php
     if (!in_array("porpj", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "porpj")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porpj";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porpj");display_btn_restore_gb();' name="sel_groupby" value="porpj" id="sc_id_sel_groupby_porpj"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porpj">
        Por Prefijo
<?php
    $prep_labels = array();
    $prep_labels[] = "Prefijo";
...
?>
<?php
     if (!in_array("portipo", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "portipo")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_portipo";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_portipo");display_btn_restore_gb();' name="sel_groupby" value="portipo" id="sc_id_sel_groupby_portipo"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_portipo">
        Por Tipo Doc
<?php
    $prep_labels = array();
    $prep_labels[] = "Tipo";
...
?>
<?php
     if (!in_array("porvendedor", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "porvendedor")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porvendedor";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porvendedor");display_btn_restore_gb();' name="sel_groupby" value="porvendedor" id="sc_id_sel_groupby_porvendedor"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porvendedor">
        Por Vendedor
<?php
    $prep_labels = array();
    $prep_labels[] = " Vendedor";
?>
        <span>
        <?php echo implode($prep_labels, ', ');?>
        </span>
...
?>
<?php
     if (!in_array("porasentada", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "porasentada")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porasentada";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porasentada");display_btn_restore_gb();' name="sel_groupby" value="porasentada" id="sc_id_sel_groupby_porasentada"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porasentada">
        Por Estado
<?php
    $prep_labels = array();
    $prep_labels[] = "Asentada";
?>
        <span>
        <?php echo implode($prep_labels, ', ');?>
        </span>
...
?>
<?php
     if (!in_array("pagada", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "pagada")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_pagada";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_pagada");display_btn_restore_gb();' name="sel_groupby" value="pagada" id="sc_id_sel_groupby_pagada"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_pagada">
        Pagada
<?php
    $prep_labels = array();
    $prep_labels[] = "Pagada";
...
?>
<?php
     if (!in_array("porbanco", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($groupby_atual == "porbanco")
        {
            $check = " checked";
            $bStartFree = false;
            $this->static_gb_ok = "sc_id_sel_groupby_porbanco";
        }
        else
        {
            $check = "";
...
?>
      <div>
      <input type="radio" class="scAppDivToolbarInput sc_ui_gby_selected" onclick='scShowTotalFields();change_actual_static("sc_id_sel_groupby_porbanco");display_btn_restore_gb();' name="sel_groupby" value="porbanco" id="sc_id_sel_groupby_porbanco"<?php echo $check ?> style='display:' />
      <label for="sc_id_sel_groupby_porbanco">
        Por Banco
<?php
    $prep_labels = array();
    $prep_labels[] = "Caja";
...
?>
<?php
     if (!in_array("_NM_SC_", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
        if ($opc_ret != "resumo")
        {
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['grid_facturaven_automatica'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
