...
<?php
   ...
   $Ord_Cmp = new seg_apps_grid_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class seg_apps_grid_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['iconaplicacion'] = "iconaplicacion";
   }
   else
   {
       $tab_def_campos['iconaplicacion'] = "";
   }
   $tab_labels["iconaplicacion"]   = (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["iconaplicacion"])) ? $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["iconaplicacion"] : "Icon";
   ...
   {
       $tab_def_campos['descripcion'] = "";
   }
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["descripcion"] : "Descripción";
   $tab_ger_campos['app_parentid'] = "on";
   $tab_def_campos['app_parentid'] = "app_parentid";
   $tab_labels["app_parentid"]   = (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["app_parentid"])) ? $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["app_parentid"] : "Modulo";
   $tab_ger_campos['app_link'] = "on";
   $tab_def_campos['app_link'] = "app_link";
   $tab_labels["app_link"]   = (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["app_link"])) ? $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["app_link"] : "Enlace";
   $tab_ger_campos['app_badge'] = "on";
   $tab_def_campos['app_badge'] = "app_badge";
   $tab_labels["app_badge"]   = (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["app_badge"])) ? $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["app_badge"] : "Etiqueta";
   $tab_ger_campos['idapptype'] = "on";
   $tab_def_campos['idapptype'] = "idapptype";
   $tab_labels["idapptype"]   = (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["idapptype"])) ? $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["idapptype"] : "Tipo de App";
   $tab_ger_campos['app_order'] = "on";
   $tab_def_campos['app_order'] = "app_order";
   $tab_labels["app_order"]   = (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["app_order"])) ? $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['labels']["app_order"] : "Orden";
   $tab_ger_campos['iconaplicacion'] = "none";
   $tab_ger_campos['descripcion'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "seg_apps_grid_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['seg_apps_grid']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
