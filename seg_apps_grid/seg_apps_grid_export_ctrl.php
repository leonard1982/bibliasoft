<?php
@session_start() ;
$_SESSION['scriptcase']['seg_apps_grid']['sc_process_barr'] = true;
require_once('../seg_apps_grid/index.php');
unset($_SESSION['scriptcase']['seg_apps_grid']['sc_process_barr']);
$ExportCtrl = new seg_apps_grid_export_control;
$ExportCtrl->Export_barr();

class seg_apps_grid_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['seg_apps_grid']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['seg_apps_grid']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> vmenuoptions</TITLE>
