...
?>
  ...
  // ---------- Validate idmun_
  function do_ajax_form_municipio_validate_idmun_(iNumLinha)
  {
    var nomeCampo_idmun_ = "idmun_" + iNumLinha;
    var var_idmun_ = scAjaxGetFieldHidden(nomeCampo_idmun_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_idmun_(var_idmun_, iNumLinha, var_script_case_init, do_ajax_form_municipio_validate_idmun__cb);
  } // do_ajax_form_municipio_validate_idmun_

  function do_ajax_form_municipio_validate_idmun__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idmun_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idmun_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idmun_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idmun_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_idmun__cb

  // ---------- Validate municipio_
  function do_ajax_form_municipio_validate_municipio_(iNumLinha)
  {
    var nomeCampo_municipio_ = "municipio_" + iNumLinha;
    var var_municipio_ = scAjaxGetFieldText(nomeCampo_municipio_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_municipio_(var_municipio_, iNumLinha, var_script_case_init, do_ajax_form_municipio_validate_municipio__cb);
  } // do_ajax_form_municipio_validate_municipio_

  function do_ajax_form_municipio_validate_municipio__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_municipio__cb

  // ---------- Validate iddepar_
  function do_ajax_form_municipio_validate_iddepar_(iNumLinha)
  {
    var nomeCampo_iddepar_ = "iddepar_" + iNumLinha;
    var var_iddepar_ = scAjaxGetFieldText(nomeCampo_iddepar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_iddepar_(var_iddepar_, iNumLinha, var_script_case_init, do_ajax_form_municipio_validate_iddepar__cb);
  } // do_ajax_form_municipio_validate_iddepar_

  function do_ajax_form_municipio_validate_iddepar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_iddepar__cb

  // ---------- Validate departamento_
  function do_ajax_form_municipio_validate_departamento_(iNumLinha)
  {
    var nomeCampo_departamento_ = "departamento_" + iNumLinha;
    var var_departamento_ = scAjaxGetFieldText(nomeCampo_departamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_departamento_(var_departamento_, iNumLinha, var_script_case_init, do_ajax_form_municipio_validate_departamento__cb);
  } // do_ajax_form_municipio_validate_departamento_

  function do_ajax_form_municipio_validate_departamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_departamento__cb

  // ---------- Validate codigo_dep_
  function do_ajax_form_municipio_validate_codigo_dep_(iNumLinha)
  {
    var nomeCampo_codigo_dep_ = "codigo_dep_" + iNumLinha;
    var var_codigo_dep_ = scAjaxGetFieldText(nomeCampo_codigo_dep_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_codigo_dep_(var_codigo_dep_, iNumLinha, var_script_case_init, do_ajax_form_municipio_validate_codigo_dep__cb);
  } // do_ajax_form_municipio_validate_codigo_dep_

  function do_ajax_form_municipio_validate_codigo_dep__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_codigo_dep__cb

  // ---------- Validate codigo_mu_
  function do_ajax_form_municipio_validate_codigo_mu_(iNumLinha)
  {
    var nomeCampo_codigo_mu_ = "codigo_mu_" + iNumLinha;
    var var_codigo_mu_ = scAjaxGetFieldText(nomeCampo_codigo_mu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_validate_codigo_mu_(var_codigo_mu_, iNumLinha, var_script_case_init, do_ajax_form_municipio_validate_codigo_mu__cb);
  } // do_ajax_form_municipio_validate_codigo_mu_

  function do_ajax_form_municipio_validate_codigo_mu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "codigo_mu_" + iLineNumber;
    }
    else
    {
      sFieldValid = "codigo_mu_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "codigo_mu_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "codigo_mu_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_municipio_validate_codigo_mu__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_municipio_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_municipio_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_municipio_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_municipio_add_new_line_cb);
  } // do_ajax_form_municipio_add_new_line

  function do_ajax_form_municipio_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_municipio_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_municipio_backup_line(iNumLinha)
  {
    var var_idmun_ = scAjaxGetFieldHidden("idmun_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_municipio_backup_line(var_idmun_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_municipio_backup_line_cb);
  } // do_ajax_form_municipio_backup_line

  function do_ajax_form_municipio_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_municipio_backup_line_cb

  function do_ajax_form_municipio_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_municipio_cancel_insert

  function do_ajax_form_municipio_cancel_update(iSeqVert)
  {
    do_ajax_form_municipio_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_municipio_cancel_update

  function do_ajax_form_municipio_restore_buttons()
  {
<?php
...
?>
  ...
  // ---------- table_refresh
  function do_ajax_form_municipio_table_refresh()
  {
    var var_idmun_ = document.F2.idmun_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_municipio_table_refresh(var_idmun_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_municipio_table_refresh_cb);
  } //  do_ajax_form_municipio_table_refresh

  function do_ajax_form_municipio_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idmun_.value = scAjaxGetKeyValue("idmun_");
    ...
    scAjaxAlert(do_ajax_form_municipio_table_refresh_cb_after_alert);
  } // do_ajax_form_municipio_table_refresh_cb
  function do_ajax_form_municipio_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_municipio_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_municipio_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_municipio_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_iddepar_ = scAjaxGetFieldText("iddepar_" + iNumLinha);
    ...
    var var_codigo_mu_ = scAjaxGetFieldText("codigo_mu_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_municipio_submit_form(var_idmun_, var_municipio_, var_iddepar_, var_departamento_, var_codigo_dep_, var_codigo_mu_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_municipio_submit_form_cb);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idmun_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("codigo_mu_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
  ...
  function perform_ajax_form_municipio_navigate_form()
  {
    ...
    {
      scAjaxHideErrorDisplay("idmun_" + iNavForm);
      ...
      scAjaxHideErrorDisplay("codigo_mu_" + iNavForm);
    }
    var var_idmun_ = document.F2.idmun_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    scAjaxProcOn();
    x_ajax_form_municipio_navigate_form(var_idmun_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_municipio_navigate_form_cb);
...
?>
  function do_ajax_form_municipio_navigate_form_cb(sResp)
  {
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmun_.value = scAjaxGetKeyValue("idmun_" + var_last_index);
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idmun_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "codigo_mu_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idmun_" + iNumLinha] = {"label": "Idmun<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["iddepar_" + iNumLinha] = {"label": "Cód. Int.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["codigo_dep_" + iNumLinha] = {"label": "Código Dep.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["codigo_mu_" + iNumLinha] = {"label": "Código Mun.<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idmun_"][iNumLinha] = "idmun_" + iNumLinha;
    ...
    ajax_field_mult["codigo_mu_"][iNumLinha] = "codigo_mu_" + iNumLinha;
    ...
    ajax_field_id["codigo_mu_" + iNumLinha] = new Array("hidden_field_label_codigo_mu_", "hidden_field_data_codigo_mu_" + iNumLinha);
    ajax_error_count["idmun_" + iNumLinha] = "off";
    ...
    ajax_error_count["codigo_mu_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idmun_" + iNumLinha] = "on";
    ajax_read_only["municipio_" + iNumLinha] = "off";
    ajax_read_only["iddepar_" + iNumLinha] = "off";
    ajax_read_only["departamento_" + iNumLinha] = "off";
    ajax_read_only["codigo_dep_" + iNumLinha] = "off";
    ajax_read_only["codigo_mu_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["codigo_mu_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idmun_" + iNumLinha] = null;
    ...
    ajax_error_list["codigo_mu_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idmun_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idmun_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idmun_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idmun_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idmun_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["codigo_mu_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["codigo_mu_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["codigo_mu_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["codigo_mu_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["codigo_mu_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idmun_'])) ? $this->nmgp_cmp_readonly['idmun_'] : 'on';
?>
    scAjaxFieldRead("idmun_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['municipio_'])) ? $this->nmgp_cmp_readonly['municipio_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['codigo_mu_'])) ? $this->nmgp_cmp_readonly['codigo_mu_'] : 'off';
?>
    scAjaxFieldRead("codigo_mu_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idmun_" + iSeq, "on");
    ...
    scAjaxFieldRead("codigo_mu_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idmun_" + iRow] || "on" == ajax_error_count["municipio_" + iRow] || "on" == ajax_error_count["iddepar_" + iRow] || "on" == ajax_error_count["departamento_" + iRow] || "on" == ajax_error_count["codigo_dep_" + iRow] || "on" == ajax_error_count["codigo_mu_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idmun_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_municipio_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_codigo_mu_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idmun_" + iRow] && "off" == ajax_error_count["municipio_" + iRow] && "off" == ajax_error_count["iddepar_" + iRow] && "off" == ajax_error_count["departamento_" + iRow] && "off" == ajax_error_count["codigo_dep_" + iRow] && "off" == ajax_error_count["codigo_mu_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idmun_" + iRow] = "off";
        ...
        ajax_error_count["codigo_mu_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idmun_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_municipio_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_codigo_mu_" + iRow).removeClass("scFormErrorLine");
    }
  }
