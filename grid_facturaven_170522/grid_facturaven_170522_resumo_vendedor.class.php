...
$_SESSION['scriptcase']['grid_facturaven_170522']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_vendedor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['arr_total']['vendedor'];
      }
      else
      {
          $this->array_total_vendedor = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['arr_total']['vendedor'] = $this->array_total_vendedor;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_order']['vendedor']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_order']['vendedor'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_order']['vendedor'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['vendedor'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['vendedor'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['vendedor'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['vendedor'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['vendedor'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['vendedor'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['vendedor'] as $i_sum => $d_sum)
           {
