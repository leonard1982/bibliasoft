...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "PJ";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['contr_label_graf']['resolucion']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['contr_label_graf']['resolucion']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['contr_label_graf']['resolucion'];
      }
   }
