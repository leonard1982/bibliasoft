...
$_SESSION['scriptcase']['grid_facturaven_170522']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['arr_total']['resolucion'];
      }
      else
      {
          $this->array_total_resolucion = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['arr_total']['resolucion'] = $this->array_total_resolucion;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_order']['prefijo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_order']['prefijo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_order']['prefijo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['prefijo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['prefijo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['prefijo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['prefijo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['prefijo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['prefijo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_170522']['summarizing_fields_display']['prefijo'] as $i_sum => $d_sum)
           {
