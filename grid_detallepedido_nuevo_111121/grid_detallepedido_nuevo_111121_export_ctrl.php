<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallepedido_nuevo_111121']['sc_process_barr'] = true;
require_once('../grid_detallepedido_nuevo_111121/index.php');
unset($_SESSION['scriptcase']['grid_detallepedido_nuevo_111121']['sc_process_barr']);
$ExportCtrl = new grid_detallepedido_nuevo_111121_export_control;
$ExportCtrl->Export_barr();

class grid_detallepedido_nuevo_111121_export_control
{
