<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_comandas']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_comandas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_comandas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['s_fechaven'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['s_fechaven'] = "s_fechaven";
   }
   else
   {
       $tab_def_campos['s_fechaven'] = "s.fechaven";
   }
   $tab_labels["s_fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["s_fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["s_fechaven"] : "Fecha";
   $tab_ger_campos['d_hora_inicio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['d_hora_inicio'] = "d_hora_inicio";
   }
   else
   {
       $tab_def_campos['d_hora_inicio'] = "d.hora_inicio";
   }
   $tab_labels["d_hora_inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["d_hora_inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["d_hora_inicio"] : "Hora Inicio";
   ...
   {
       $tab_def_campos['numero'] = "concat(r.prefijo,'--',s.numpedido)";
   }
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["numero"] : "Pedido";
   $tab_ger_campos['mesacliente'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['mesacliente'] = "mesacliente";
   }
   else
   {
       $tab_def_campos['mesacliente'] = "c.nombres";
   }
   $tab_labels["mesacliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["mesacliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["mesacliente"] : "Cliente";
   ...
   {
       $tab_def_campos['producto'] = "concat(p.codigobar,' -- ',p.nompro)";
   }
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["producto"] : "Producto";
   ...
   $tab_labels["d_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["d_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["d_cantidad"] : "Cantidad";
   $tab_ger_campos['d_observ'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['d_observ'] = "d_observ";
   }
   else
   {
       $tab_def_campos['d_observ'] = "d.observ";
   }
   $tab_labels["d_observ"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["d_observ"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["d_observ"] : "Observación";
   $tab_ger_campos['atendio'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['atendio'] = "atendio";
   }
   else
   {
       $tab_def_campos['atendio'] = "t.documento";
   }
   $tab_labels["atendio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["atendio"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["atendio"] : "Atendió";
   $tab_ger_campos['d_estado_comanda'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['d_estado_comanda'] = "d_estado_comanda";
   }
   else
   {
       $tab_def_campos['d_estado_comanda'] = "d.estado_comanda";
   }
   $tab_labels["d_estado_comanda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["d_estado_comanda"])) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['labels']["d_estado_comanda"] : "Estado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_comandas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_comandas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_comandas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_comandas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
