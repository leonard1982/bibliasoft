<?php
@session_start() ;
$_SESSION['scriptcase']['grid_comandas']['sc_process_barr'] = true;
require_once('../grid_comandas/index.php');
unset($_SESSION['scriptcase']['grid_comandas']['sc_process_barr']);
$ExportCtrl = new grid_comandas_export_control;
$ExportCtrl->Export_barr();

class grid_comandas_export_control
{
