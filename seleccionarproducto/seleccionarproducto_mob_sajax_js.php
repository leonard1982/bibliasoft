  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_seleccionarproducto_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_seleccionarproducto_mob_form();
	}
  ...
  // ---------- Validate producto
  function do_ajax_seleccionarproducto_mob_validate_producto()
  {
    var nomeCampo_producto = "producto";
    var var_producto = scAjaxGetFieldSelect(nomeCampo_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_producto(var_producto, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_producto_cb);
  } // do_ajax_seleccionarproducto_mob_validate_producto

  function do_ajax_seleccionarproducto_mob_validate_producto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_producto_cb

  // ---------- Validate cantidad
  function do_ajax_seleccionarproducto_mob_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_cantidad_cb);
  } // do_ajax_seleccionarproducto_mob_validate_cantidad

  function do_ajax_seleccionarproducto_mob_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_cantidad_cb

  // ---------- Validate precio
  function do_ajax_seleccionarproducto_mob_validate_precio()
  {
    var nomeCampo_precio = "precio";
    var var_precio = scAjaxGetFieldText(nomeCampo_precio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_precio(var_precio, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_precio_cb);
  } // do_ajax_seleccionarproducto_mob_validate_precio

  function do_ajax_seleccionarproducto_mob_validate_precio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "precio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_precio_cb

  // ---------- Validate stock
  function do_ajax_seleccionarproducto_mob_validate_stock()
  {
    var nomeCampo_stock = "stock";
    var var_stock = scAjaxGetFieldText(nomeCampo_stock);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_stock(var_stock, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_stock_cb);
  } // do_ajax_seleccionarproducto_mob_validate_stock

  function do_ajax_seleccionarproducto_mob_validate_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stock";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_stock_cb

  // ---------- Validate iva
  function do_ajax_seleccionarproducto_mob_validate_iva()
  {
    var nomeCampo_iva = "iva";
    var var_iva = scAjaxGetFieldText(nomeCampo_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_iva(var_iva, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_iva_cb);
  } // do_ajax_seleccionarproducto_mob_validate_iva

  function do_ajax_seleccionarproducto_mob_validate_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_iva_cb

  // ---------- Validate tdescuento
  function do_ajax_seleccionarproducto_mob_validate_tdescuento()
  {
    var nomeCampo_tdescuento = "tdescuento";
    var var_tdescuento = scAjaxGetFieldHidden(nomeCampo_tdescuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_tdescuento(var_tdescuento, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_tdescuento_cb);
  } // do_ajax_seleccionarproducto_mob_validate_tdescuento

  function do_ajax_seleccionarproducto_mob_validate_tdescuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_tdescuento_cb

  // ---------- Validate descuento
  function do_ajax_seleccionarproducto_mob_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldHidden(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_descuento(var_descuento, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_descuento_cb);
  } // do_ajax_seleccionarproducto_mob_validate_descuento

  function do_ajax_seleccionarproducto_mob_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_descuento_cb

  // ---------- Validate sidescuento
  function do_ajax_seleccionarproducto_mob_validate_sidescuento()
  {
    var nomeCampo_sidescuento = "sidescuento";
    var var_sidescuento = scAjaxGetFieldText(nomeCampo_sidescuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_sidescuento(var_sidescuento, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_sidescuento_cb);
  } // do_ajax_seleccionarproducto_mob_validate_sidescuento

  function do_ajax_seleccionarproducto_mob_validate_sidescuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_sidescuento_cb

  // ---------- Validate tiva
  function do_ajax_seleccionarproducto_mob_validate_tiva()
  {
    var nomeCampo_tiva = "tiva";
    var var_tiva = scAjaxGetFieldText(nomeCampo_tiva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_tiva(var_tiva, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_tiva_cb);
  } // do_ajax_seleccionarproducto_mob_validate_tiva

  function do_ajax_seleccionarproducto_mob_validate_tiva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tiva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_tiva_cb

  // ---------- Validate subtotal
  function do_ajax_seleccionarproducto_mob_validate_subtotal()
  {
    var nomeCampo_subtotal = "subtotal";
    var var_subtotal = scAjaxGetFieldText(nomeCampo_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_subtotal(var_subtotal, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_subtotal_cb);
  } // do_ajax_seleccionarproducto_mob_validate_subtotal

  function do_ajax_seleccionarproducto_mob_validate_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_subtotal_cb

  // ---------- Validate ahorro
  function do_ajax_seleccionarproducto_mob_validate_ahorro()
  {
    var nomeCampo_ahorro = "ahorro";
    var var_ahorro = scAjaxGetFieldText(nomeCampo_ahorro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_mob_validate_ahorro(var_ahorro, var_script_case_init, do_ajax_seleccionarproducto_mob_validate_ahorro_cb);
  } // do_ajax_seleccionarproducto_mob_validate_ahorro

  function do_ajax_seleccionarproducto_mob_validate_ahorro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ahorro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_mob_validate_ahorro_cb

  // ---------- Event onblur cantidad
  function do_ajax_seleccionarproducto_mob_event_cantidad_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_seleccionarproducto_mob_event_cantidad_onblur(var_cantidad, var_stock, var_producto, var_precio, var_sidescuento, var_tdescuento, var_descuento, var_iva, var_tiva, var_subtotal, var_ahorro, var_script_case_init, do_ajax_seleccionarproducto_mob_event_cantidad_onblur_cb);
  } // do_ajax_seleccionarproducto_mob_event_cantidad_onblur

  function do_ajax_seleccionarproducto_mob_event_cantidad_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_seleccionarproducto_mob_event_cantidad_onblur_cb_after_alert);
  } // do_ajax_seleccionarproducto_mob_event_cantidad_onblur_cb
  function do_ajax_seleccionarproducto_mob_event_cantidad_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_seleccionarproducto_mob_event_cantidad_onblur_cb_after_alert

  // ---------- Event onchange producto
  function do_ajax_seleccionarproducto_mob_event_producto_onchange()
  {
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_producto = scAjaxGetFieldSelect("producto");
    var var_precio = scAjaxGetFieldText("precio");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_seleccionarproducto_mob_event_producto_onchange(var_cantidad, var_producto, var_precio, var_stock, var_iva, var_sidescuento, var_tdescuento, var_tiva, var_script_case_init, do_ajax_seleccionarproducto_mob_event_producto_onchange_cb);
  } // do_ajax_seleccionarproducto_mob_event_producto_onchange

  function do_ajax_seleccionarproducto_mob_event_producto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "producto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_seleccionarproducto_mob_event_producto_onchange_cb_after_alert);
  } // do_ajax_seleccionarproducto_mob_event_producto_onchange_cb
  function do_ajax_seleccionarproducto_mob_event_producto_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_seleccionarproducto_mob_event_producto_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_seleccionarproducto_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_seleccionarproducto_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_producto = scAjaxGetFieldSelect("producto");
    ...
    scAjaxProcOn();
    x_ajax_seleccionarproducto_mob_submit_form(var_producto, var_cantidad, var_precio, var_stock, var_iva, var_tdescuento, var_descuento, var_sidescuento, var_tiva, var_subtotal, var_ahorro, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seleccionarproducto_mob_submit_form_cb);
  } // do_ajax_seleccionarproducto_mob_submit_form

  function do_ajax_seleccionarproducto_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_seleccionarproducto_mob_submit_form_cb_after_alert);
  } // do_ajax_seleccionarproducto_mob_submit_form_cb
  function do_ajax_seleccionarproducto_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_seleccionarproducto_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_seleccionarproducto_mob_navigate_form()
  {
    perform_ajax_seleccionarproducto_mob_navigate_form();
  }

  function perform_ajax_seleccionarproducto_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['seleccionarproducto_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_seleccionarproducto_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_seleccionarproducto_mob_navigate_form_cb_after_alert);
  } // do_ajax_seleccionarproducto_mob_navigate_form_cb
  function do_ajax_seleccionarproducto_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_seleccionarproducto_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_seleccionarproducto_mob_navigate_form_cb_after_alert
  function sc_hide_seleccionarproducto_mob_form()
  {
