  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_seleccionarproducto" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_seleccionarproducto_form();
	}
  ...
  // ---------- Validate producto
  function do_ajax_seleccionarproducto_validate_producto()
  {
    var nomeCampo_producto = "producto";
    var var_producto = scAjaxGetFieldSelect(nomeCampo_producto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_producto(var_producto, var_script_case_init, do_ajax_seleccionarproducto_validate_producto_cb);
  } // do_ajax_seleccionarproducto_validate_producto

  function do_ajax_seleccionarproducto_validate_producto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "producto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_producto_cb

  // ---------- Validate cantidad
  function do_ajax_seleccionarproducto_validate_cantidad()
  {
    var nomeCampo_cantidad = "cantidad";
    var var_cantidad = scAjaxGetFieldText(nomeCampo_cantidad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_cantidad(var_cantidad, var_script_case_init, do_ajax_seleccionarproducto_validate_cantidad_cb);
  } // do_ajax_seleccionarproducto_validate_cantidad

  function do_ajax_seleccionarproducto_validate_cantidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_cantidad_cb

  // ---------- Validate precio
  function do_ajax_seleccionarproducto_validate_precio()
  {
    var nomeCampo_precio = "precio";
    var var_precio = scAjaxGetFieldText(nomeCampo_precio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_precio(var_precio, var_script_case_init, do_ajax_seleccionarproducto_validate_precio_cb);
  } // do_ajax_seleccionarproducto_validate_precio

  function do_ajax_seleccionarproducto_validate_precio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "precio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_precio_cb

  // ---------- Validate stock
  function do_ajax_seleccionarproducto_validate_stock()
  {
    var nomeCampo_stock = "stock";
    var var_stock = scAjaxGetFieldText(nomeCampo_stock);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_stock(var_stock, var_script_case_init, do_ajax_seleccionarproducto_validate_stock_cb);
  } // do_ajax_seleccionarproducto_validate_stock

  function do_ajax_seleccionarproducto_validate_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "stock";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_stock_cb

  // ---------- Validate iva
  function do_ajax_seleccionarproducto_validate_iva()
  {
    var nomeCampo_iva = "iva";
    var var_iva = scAjaxGetFieldText(nomeCampo_iva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_iva(var_iva, var_script_case_init, do_ajax_seleccionarproducto_validate_iva_cb);
  } // do_ajax_seleccionarproducto_validate_iva

  function do_ajax_seleccionarproducto_validate_iva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_iva_cb

  // ---------- Validate tdescuento
  function do_ajax_seleccionarproducto_validate_tdescuento()
  {
    var nomeCampo_tdescuento = "tdescuento";
    var var_tdescuento = scAjaxGetFieldHidden(nomeCampo_tdescuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_tdescuento(var_tdescuento, var_script_case_init, do_ajax_seleccionarproducto_validate_tdescuento_cb);
  } // do_ajax_seleccionarproducto_validate_tdescuento

  function do_ajax_seleccionarproducto_validate_tdescuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tdescuento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_tdescuento_cb

  // ---------- Validate descuento
  function do_ajax_seleccionarproducto_validate_descuento()
  {
    var nomeCampo_descuento = "descuento";
    var var_descuento = scAjaxGetFieldHidden(nomeCampo_descuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_descuento(var_descuento, var_script_case_init, do_ajax_seleccionarproducto_validate_descuento_cb);
  } // do_ajax_seleccionarproducto_validate_descuento

  function do_ajax_seleccionarproducto_validate_descuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_descuento_cb

  // ---------- Validate sidescuento
  function do_ajax_seleccionarproducto_validate_sidescuento()
  {
    var nomeCampo_sidescuento = "sidescuento";
    var var_sidescuento = scAjaxGetFieldText(nomeCampo_sidescuento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_sidescuento(var_sidescuento, var_script_case_init, do_ajax_seleccionarproducto_validate_sidescuento_cb);
  } // do_ajax_seleccionarproducto_validate_sidescuento

  function do_ajax_seleccionarproducto_validate_sidescuento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sidescuento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_sidescuento_cb

  // ---------- Validate tiva
  function do_ajax_seleccionarproducto_validate_tiva()
  {
    var nomeCampo_tiva = "tiva";
    var var_tiva = scAjaxGetFieldText(nomeCampo_tiva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_tiva(var_tiva, var_script_case_init, do_ajax_seleccionarproducto_validate_tiva_cb);
  } // do_ajax_seleccionarproducto_validate_tiva

  function do_ajax_seleccionarproducto_validate_tiva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tiva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_tiva_cb

  // ---------- Validate subtotal
  function do_ajax_seleccionarproducto_validate_subtotal()
  {
    var nomeCampo_subtotal = "subtotal";
    var var_subtotal = scAjaxGetFieldText(nomeCampo_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_subtotal(var_subtotal, var_script_case_init, do_ajax_seleccionarproducto_validate_subtotal_cb);
  } // do_ajax_seleccionarproducto_validate_subtotal

  function do_ajax_seleccionarproducto_validate_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_subtotal_cb

  // ---------- Validate ahorro
  function do_ajax_seleccionarproducto_validate_ahorro()
  {
    var nomeCampo_ahorro = "ahorro";
    var var_ahorro = scAjaxGetFieldText(nomeCampo_ahorro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_seleccionarproducto_validate_ahorro(var_ahorro, var_script_case_init, do_ajax_seleccionarproducto_validate_ahorro_cb);
  } // do_ajax_seleccionarproducto_validate_ahorro

  function do_ajax_seleccionarproducto_validate_ahorro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ahorro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_seleccionarproducto_validate_ahorro_cb

  // ---------- Event onblur cantidad
  function do_ajax_seleccionarproducto_event_cantidad_onblur()
  {
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_stock = scAjaxGetFieldText("stock");
    var var_producto = scAjaxGetFieldSelect("producto");
    var var_precio = scAjaxGetFieldText("precio");
    var var_sidescuento = scAjaxGetFieldText("sidescuento");
    var var_tdescuento = scAjaxGetFieldHidden("tdescuento");
    var var_descuento = scAjaxGetFieldHidden("descuento");
    var var_iva = scAjaxGetFieldText("iva");
    var var_tiva = scAjaxGetFieldText("tiva");
    var var_subtotal = scAjaxGetFieldText("subtotal");
    var var_ahorro = scAjaxGetFieldText("ahorro");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_seleccionarproducto_event_cantidad_onblur(var_cantidad, var_stock, var_producto, var_precio, var_sidescuento, var_tdescuento, var_descuento, var_iva, var_tiva, var_subtotal, var_ahorro, var_script_case_init, do_ajax_seleccionarproducto_event_cantidad_onblur_cb);
  } // do_ajax_seleccionarproducto_event_cantidad_onblur

  function do_ajax_seleccionarproducto_event_cantidad_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cantidad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_seleccionarproducto_event_cantidad_onblur_cb_after_alert);
  } // do_ajax_seleccionarproducto_event_cantidad_onblur_cb
  function do_ajax_seleccionarproducto_event_cantidad_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_seleccionarproducto_event_cantidad_onblur_cb_after_alert

  // ---------- Event onchange producto
  function do_ajax_seleccionarproducto_event_producto_onchange()
  {
    var var_cantidad = scAjaxGetFieldText("cantidad");
    var var_producto = scAjaxGetFieldSelect("producto");
    var var_precio = scAjaxGetFieldText("precio");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_seleccionarproducto_event_producto_onchange(var_cantidad, var_producto, var_precio, var_stock, var_iva, var_sidescuento, var_tdescuento, var_tiva, var_script_case_init, do_ajax_seleccionarproducto_event_producto_onchange_cb);
  } // do_ajax_seleccionarproducto_event_producto_onchange

  function do_ajax_seleccionarproducto_event_producto_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "producto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_seleccionarproducto_event_producto_onchange_cb_after_alert);
  } // do_ajax_seleccionarproducto_event_producto_onchange_cb
  function do_ajax_seleccionarproducto_event_producto_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_seleccionarproducto_event_producto_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_seleccionarproducto_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_seleccionarproducto_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_producto = scAjaxGetFieldSelect("producto");
    ...
    scAjaxProcOn();
    x_ajax_seleccionarproducto_submit_form(var_producto, var_cantidad, var_precio, var_stock, var_iva, var_tdescuento, var_descuento, var_sidescuento, var_tiva, var_subtotal, var_ahorro, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_seleccionarproducto_submit_form_cb);
  } // do_ajax_seleccionarproducto_submit_form

  function do_ajax_seleccionarproducto_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_seleccionarproducto_submit_form_cb_after_alert);
  } // do_ajax_seleccionarproducto_submit_form_cb
  function do_ajax_seleccionarproducto_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_seleccionarproducto_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_seleccionarproducto_navigate_form()
  {
    perform_ajax_seleccionarproducto_navigate_form();
  }

  function perform_ajax_seleccionarproducto_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_seleccionarproducto_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['seleccionarproducto']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_seleccionarproducto_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_seleccionarproducto_navigate_form_cb_after_alert);
  } // do_ajax_seleccionarproducto_navigate_form_cb
  function do_ajax_seleccionarproducto_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_seleccionarproducto_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_seleccionarproducto_navigate_form_cb_after_alert
  function sc_hide_seleccionarproducto_form()
  {
  ...
  ajax_field_list[0] = "producto";
  ajax_field_list[1] = "cantidad";
  ajax_field_list[2] = "precio";
  ajax_field_list[3] = "stock";
  ajax_field_list[4] = "iva";
  ajax_field_list[5] = "tdescuento";
  ajax_field_list[6] = "descuento";
  ajax_field_list[7] = "sidescuento";
  ajax_field_list[8] = "tiva";
  ajax_field_list[9] = "subtotal";
  ajax_field_list[10] = "ahorro";
  ...
  var ajax_error_list = {
    "producto": {"label": "Producto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "precio": {"label": "Precio", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "stock": {"label": "Existencia", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "iva": {"label": "IVA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tdescuento": {"label": "% Descuento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "descuento": {"label": "Descuento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sidescuento": {"label": "sidescuento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tiva": {"label": "T_Iva", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "subtotal": {"label": "SU FACTURA VA EN:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ahorro": {"label": "DESCUENTO EN:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "stock": new Array(),
    "iva": new Array(),
    "tdescuento": new Array(),
    "descuento": new Array(),
    "sidescuento": new Array(),
    "tiva": new Array(),
    "subtotal": new Array(),
    "ahorro": new Array()
  };
  ajax_field_mult["producto"][1] = "producto";
  ajax_field_mult["cantidad"][1] = "cantidad";
  ajax_field_mult["precio"][1] = "precio";
  ajax_field_mult["stock"][1] = "stock";
  ajax_field_mult["iva"][1] = "iva";
  ajax_field_mult["tdescuento"][1] = "tdescuento";
  ajax_field_mult["descuento"][1] = "descuento";
  ajax_field_mult["sidescuento"][1] = "sidescuento";
  ajax_field_mult["tiva"][1] = "tiva";
  ajax_field_mult["subtotal"][1] = "subtotal";
  ajax_field_mult["ahorro"][1] = "ahorro";

  var ajax_field_id = {
    "producto": new Array("hidden_field_label_producto", "hidden_field_data_producto"),
    "cantidad": new Array("hidden_field_label_cantidad", "hidden_field_data_cantidad"),
    "precio": new Array("hidden_field_label_precio", "hidden_field_data_precio"),
    "tdescuento": new Array("hidden_field_label_tdescuento", "hidden_field_data_tdescuento"),
    "subtotal": new Array("hidden_field_label_subtotal", "hidden_field_data_subtotal"),
    "ahorro": new Array("hidden_field_label_ahorro", "hidden_field_data_ahorro")
  };
