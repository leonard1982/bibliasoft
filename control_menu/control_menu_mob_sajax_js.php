  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_menu_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate productos
  function do_ajax_control_menu_mob_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_productos(var_productos, var_script_case_init, do_ajax_control_menu_mob_validate_productos_cb);
  } // do_ajax_control_menu_mob_validate_productos

  function do_ajax_control_menu_mob_validate_productos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_productos_cb

  // ---------- Validate terceros
  function do_ajax_control_menu_mob_validate_terceros()
  {
    var nomeCampo_terceros = "terceros";
    var var_terceros = scAjaxGetFieldText(nomeCampo_terceros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_terceros(var_terceros, var_script_case_init, do_ajax_control_menu_mob_validate_terceros_cb);
  } // do_ajax_control_menu_mob_validate_terceros

  function do_ajax_control_menu_mob_validate_terceros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_terceros_cb

  // ---------- Validate ventas
  function do_ajax_control_menu_mob_validate_ventas()
  {
    var nomeCampo_ventas = "ventas";
    var var_ventas = scAjaxGetFieldText(nomeCampo_ventas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_ventas(var_ventas, var_script_case_init, do_ajax_control_menu_mob_validate_ventas_cb);
  } // do_ajax_control_menu_mob_validate_ventas

  function do_ajax_control_menu_mob_validate_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ventas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_ventas_cb

  // ---------- Validate compras
  function do_ajax_control_menu_mob_validate_compras()
  {
    var nomeCampo_compras = "compras";
    var var_compras = scAjaxGetFieldText(nomeCampo_compras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_compras(var_compras, var_script_case_init, do_ajax_control_menu_mob_validate_compras_cb);
  } // do_ajax_control_menu_mob_validate_compras

  function do_ajax_control_menu_mob_validate_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "compras";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_compras_cb

  // ---------- Validate copias
  function do_ajax_control_menu_mob_validate_copias()
  {
    var nomeCampo_copias = "copias";
    var var_copias = scAjaxGetFieldText(nomeCampo_copias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_copias(var_copias, var_script_case_init, do_ajax_control_menu_mob_validate_copias_cb);
  } // do_ajax_control_menu_mob_validate_copias

  function do_ajax_control_menu_mob_validate_copias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "copias";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_copias_cb

  // ---------- Validate empresa
  function do_ajax_control_menu_mob_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_empresa(var_empresa, var_script_case_init, do_ajax_control_menu_mob_validate_empresa_cb);
  } // do_ajax_control_menu_mob_validate_empresa

  function do_ajax_control_menu_mob_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_empresa_cb

  // ---------- Validate pagos
  function do_ajax_control_menu_mob_validate_pagos()
  {
    var nomeCampo_pagos = "pagos";
    var var_pagos = scAjaxGetFieldText(nomeCampo_pagos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_pagos(var_pagos, var_script_case_init, do_ajax_control_menu_mob_validate_pagos_cb);
  } // do_ajax_control_menu_mob_validate_pagos

  function do_ajax_control_menu_mob_validate_pagos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pagos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_pagos_cb

  // ---------- Validate cobros
  function do_ajax_control_menu_mob_validate_cobros()
  {
    var nomeCampo_cobros = "cobros";
    var var_cobros = scAjaxGetFieldText(nomeCampo_cobros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_cobros(var_cobros, var_script_case_init, do_ajax_control_menu_mob_validate_cobros_cb);
  } // do_ajax_control_menu_mob_validate_cobros

  function do_ajax_control_menu_mob_validate_cobros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cobros";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_cobros_cb

  // ---------- Validate notas_credito
  function do_ajax_control_menu_mob_validate_notas_credito()
  {
    var nomeCampo_notas_credito = "notas_credito";
    var var_notas_credito = scAjaxGetFieldText(nomeCampo_notas_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_notas_credito(var_notas_credito, var_script_case_init, do_ajax_control_menu_mob_validate_notas_credito_cb);
  } // do_ajax_control_menu_mob_validate_notas_credito

  function do_ajax_control_menu_mob_validate_notas_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_notas_credito_cb

  // ---------- Validate contratos
  function do_ajax_control_menu_mob_validate_contratos()
  {
    var nomeCampo_contratos = "contratos";
    var var_contratos = scAjaxGetFieldText(nomeCampo_contratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_contratos(var_contratos, var_script_case_init, do_ajax_control_menu_mob_validate_contratos_cb);
  } // do_ajax_control_menu_mob_validate_contratos

  function do_ajax_control_menu_mob_validate_contratos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_contratos_cb

  // ---------- Validate agenda
  function do_ajax_control_menu_mob_validate_agenda()
  {
    var nomeCampo_agenda = "agenda";
    var var_agenda = scAjaxGetFieldText(nomeCampo_agenda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_agenda(var_agenda, var_script_case_init, do_ajax_control_menu_mob_validate_agenda_cb);
  } // do_ajax_control_menu_mob_validate_agenda

  function do_ajax_control_menu_mob_validate_agenda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "agenda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_agenda_cb

  // ---------- Validate indices
  function do_ajax_control_menu_mob_validate_indices()
  {
    var nomeCampo_indices = "indices";
    var var_indices = scAjaxGetFieldText(nomeCampo_indices);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_indices(var_indices, var_script_case_init, do_ajax_control_menu_mob_validate_indices_cb);
  } // do_ajax_control_menu_mob_validate_indices

  function do_ajax_control_menu_mob_validate_indices_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "indices";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_indices_cb

  // ---------- Validate inventario
  function do_ajax_control_menu_mob_validate_inventario()
  {
    var nomeCampo_inventario = "inventario";
    var var_inventario = scAjaxGetFieldText(nomeCampo_inventario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_inventario(var_inventario, var_script_case_init, do_ajax_control_menu_mob_validate_inventario_cb);
  } // do_ajax_control_menu_mob_validate_inventario

  function do_ajax_control_menu_mob_validate_inventario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_inventario_cb

  // ---------- Validate documentos
  function do_ajax_control_menu_mob_validate_documentos()
  {
    var nomeCampo_documentos = "documentos";
    var var_documentos = scAjaxGetFieldText(nomeCampo_documentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_documentos(var_documentos, var_script_case_init, do_ajax_control_menu_mob_validate_documentos_cb);
  } // do_ajax_control_menu_mob_validate_documentos

  function do_ajax_control_menu_mob_validate_documentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_documentos_cb

  // ---------- Validate ventas_usuario
  function do_ajax_control_menu_mob_validate_ventas_usuario()
  {
    var nomeCampo_ventas_usuario = "ventas_usuario";
    var var_ventas_usuario = scAjaxGetFieldText(nomeCampo_ventas_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_mob_validate_ventas_usuario(var_ventas_usuario, var_script_case_init, do_ajax_control_menu_mob_validate_ventas_usuario_cb);
  } // do_ajax_control_menu_mob_validate_ventas_usuario

  function do_ajax_control_menu_mob_validate_ventas_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_mob_validate_ventas_usuario_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_menu_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_menu_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_productos = "";
    ...
    scAjaxProcOn();
    x_ajax_control_menu_mob_submit_form(var_productos, var_terceros, var_ventas, var_compras, var_copias, var_empresa, var_pagos, var_cobros, var_notas_credito, var_contratos, var_agenda, var_indices, var_inventario, var_documentos, var_ventas_usuario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_menu_mob_submit_form_cb);
  } // do_ajax_control_menu_mob_submit_form

  function do_ajax_control_menu_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_menu_mob_submit_form_cb_after_alert);
  } // do_ajax_control_menu_mob_submit_form_cb
  function do_ajax_control_menu_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_menu_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_menu_mob_navigate_form()
  {
    perform_ajax_control_menu_mob_navigate_form();
  }

  function perform_ajax_control_menu_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_menu_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_menu_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_menu_mob_navigate_form_cb_after_alert);
  } // do_ajax_control_menu_mob_navigate_form_cb
  function do_ajax_control_menu_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_menu_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_menu_mob_navigate_form_cb_after_alert
  function sc_hide_control_menu_mob_form()
  {
