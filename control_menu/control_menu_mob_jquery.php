...
function sc_control_menu_productos_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_productos();
  scCssBlur(oThis);
}
...
function sc_control_menu_terceros_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_terceros();
  scCssBlur(oThis);
}
...
function sc_control_menu_ventas_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_ventas();
  scCssBlur(oThis);
}
...
function sc_control_menu_compras_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_compras();
  scCssBlur(oThis);
}
...
function sc_control_menu_copias_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_copias();
  scCssBlur(oThis);
}
...
function sc_control_menu_empresa_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_empresa();
  scCssBlur(oThis);
}
...
function sc_control_menu_pagos_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_pagos();
  scCssBlur(oThis);
}
...
function sc_control_menu_cobros_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_cobros();
  scCssBlur(oThis);
}
...
function sc_control_menu_notas_credito_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_notas_credito();
  scCssBlur(oThis);
}
...
function sc_control_menu_contratos_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_contratos();
  scCssBlur(oThis);
}
...
function sc_control_menu_agenda_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_agenda();
  scCssBlur(oThis);
}
...
function sc_control_menu_indices_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_indices();
  scCssBlur(oThis);
}
...
function sc_control_menu_inventario_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_inventario();
  scCssBlur(oThis);
}
...
function sc_control_menu_documentos_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_documentos();
  scCssBlur(oThis);
}
...
function sc_control_menu_ventas_usuario_onblur(oThis, iSeqRow) {
  do_ajax_control_menu_mob_validate_ventas_usuario();
  scCssBlur(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_control_menu_mob_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'control_menu_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
