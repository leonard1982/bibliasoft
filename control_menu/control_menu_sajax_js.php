  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_menu" == sTestField)
        {
...
?>
  ...
  // ---------- Validate productos
  function do_ajax_control_menu_validate_productos()
  {
    var nomeCampo_productos = "productos";
    var var_productos = scAjaxGetFieldText(nomeCampo_productos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_productos(var_productos, var_script_case_init, do_ajax_control_menu_validate_productos_cb);
  } // do_ajax_control_menu_validate_productos

  function do_ajax_control_menu_validate_productos_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_productos_cb

  // ---------- Validate terceros
  function do_ajax_control_menu_validate_terceros()
  {
    var nomeCampo_terceros = "terceros";
    var var_terceros = scAjaxGetFieldText(nomeCampo_terceros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_terceros(var_terceros, var_script_case_init, do_ajax_control_menu_validate_terceros_cb);
  } // do_ajax_control_menu_validate_terceros

  function do_ajax_control_menu_validate_terceros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "terceros";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_terceros_cb

  // ---------- Validate ventas
  function do_ajax_control_menu_validate_ventas()
  {
    var nomeCampo_ventas = "ventas";
    var var_ventas = scAjaxGetFieldText(nomeCampo_ventas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_ventas(var_ventas, var_script_case_init, do_ajax_control_menu_validate_ventas_cb);
  } // do_ajax_control_menu_validate_ventas

  function do_ajax_control_menu_validate_ventas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ventas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_ventas_cb

  // ---------- Validate compras
  function do_ajax_control_menu_validate_compras()
  {
    var nomeCampo_compras = "compras";
    var var_compras = scAjaxGetFieldText(nomeCampo_compras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_compras(var_compras, var_script_case_init, do_ajax_control_menu_validate_compras_cb);
  } // do_ajax_control_menu_validate_compras

  function do_ajax_control_menu_validate_compras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "compras";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_compras_cb

  // ---------- Validate copias
  function do_ajax_control_menu_validate_copias()
  {
    var nomeCampo_copias = "copias";
    var var_copias = scAjaxGetFieldText(nomeCampo_copias);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_copias(var_copias, var_script_case_init, do_ajax_control_menu_validate_copias_cb);
  } // do_ajax_control_menu_validate_copias

  function do_ajax_control_menu_validate_copias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "copias";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_copias_cb

  // ---------- Validate empresa
  function do_ajax_control_menu_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldText(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_empresa(var_empresa, var_script_case_init, do_ajax_control_menu_validate_empresa_cb);
  } // do_ajax_control_menu_validate_empresa

  function do_ajax_control_menu_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_empresa_cb

  // ---------- Validate pagos
  function do_ajax_control_menu_validate_pagos()
  {
    var nomeCampo_pagos = "pagos";
    var var_pagos = scAjaxGetFieldText(nomeCampo_pagos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_pagos(var_pagos, var_script_case_init, do_ajax_control_menu_validate_pagos_cb);
  } // do_ajax_control_menu_validate_pagos

  function do_ajax_control_menu_validate_pagos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pagos";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_pagos_cb

  // ---------- Validate cobros
  function do_ajax_control_menu_validate_cobros()
  {
    var nomeCampo_cobros = "cobros";
    var var_cobros = scAjaxGetFieldText(nomeCampo_cobros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_cobros(var_cobros, var_script_case_init, do_ajax_control_menu_validate_cobros_cb);
  } // do_ajax_control_menu_validate_cobros

  function do_ajax_control_menu_validate_cobros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cobros";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_cobros_cb

  // ---------- Validate notas_credito
  function do_ajax_control_menu_validate_notas_credito()
  {
    var nomeCampo_notas_credito = "notas_credito";
    var var_notas_credito = scAjaxGetFieldText(nomeCampo_notas_credito);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_notas_credito(var_notas_credito, var_script_case_init, do_ajax_control_menu_validate_notas_credito_cb);
  } // do_ajax_control_menu_validate_notas_credito

  function do_ajax_control_menu_validate_notas_credito_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notas_credito";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_notas_credito_cb

  // ---------- Validate contratos
  function do_ajax_control_menu_validate_contratos()
  {
    var nomeCampo_contratos = "contratos";
    var var_contratos = scAjaxGetFieldText(nomeCampo_contratos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_contratos(var_contratos, var_script_case_init, do_ajax_control_menu_validate_contratos_cb);
  } // do_ajax_control_menu_validate_contratos

  function do_ajax_control_menu_validate_contratos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "contratos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_contratos_cb

  // ---------- Validate agenda
  function do_ajax_control_menu_validate_agenda()
  {
    var nomeCampo_agenda = "agenda";
    var var_agenda = scAjaxGetFieldText(nomeCampo_agenda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_agenda(var_agenda, var_script_case_init, do_ajax_control_menu_validate_agenda_cb);
  } // do_ajax_control_menu_validate_agenda

  function do_ajax_control_menu_validate_agenda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "agenda";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_agenda_cb

  // ---------- Validate indices
  function do_ajax_control_menu_validate_indices()
  {
    var nomeCampo_indices = "indices";
    var var_indices = scAjaxGetFieldText(nomeCampo_indices);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_indices(var_indices, var_script_case_init, do_ajax_control_menu_validate_indices_cb);
  } // do_ajax_control_menu_validate_indices

  function do_ajax_control_menu_validate_indices_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "indices";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_indices_cb

  // ---------- Validate inventario
  function do_ajax_control_menu_validate_inventario()
  {
    var nomeCampo_inventario = "inventario";
    var var_inventario = scAjaxGetFieldText(nomeCampo_inventario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_inventario(var_inventario, var_script_case_init, do_ajax_control_menu_validate_inventario_cb);
  } // do_ajax_control_menu_validate_inventario

  function do_ajax_control_menu_validate_inventario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inventario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_inventario_cb

  // ---------- Validate documentos
  function do_ajax_control_menu_validate_documentos()
  {
    var nomeCampo_documentos = "documentos";
    var var_documentos = scAjaxGetFieldText(nomeCampo_documentos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_documentos(var_documentos, var_script_case_init, do_ajax_control_menu_validate_documentos_cb);
  } // do_ajax_control_menu_validate_documentos

  function do_ajax_control_menu_validate_documentos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "documentos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_documentos_cb

  // ---------- Validate ventas_usuario
  function do_ajax_control_menu_validate_ventas_usuario()
  {
    var nomeCampo_ventas_usuario = "ventas_usuario";
    var var_ventas_usuario = scAjaxGetFieldText(nomeCampo_ventas_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_menu_validate_ventas_usuario(var_ventas_usuario, var_script_case_init, do_ajax_control_menu_validate_ventas_usuario_cb);
  } // do_ajax_control_menu_validate_ventas_usuario

  function do_ajax_control_menu_validate_ventas_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ventas_usuario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_menu_validate_ventas_usuario_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_menu_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_menu_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_productos = "";
    ...
    var var_pagos = "";
    var var_cobros = "";
    var var_notas_credito = "";
    var var_contratos = "";
    var var_agenda = "";
    var var_indices = "";
    var var_inventario = "";
    var var_documentos = "";
    var var_ventas_usuario = "";
    ...
    scAjaxProcOn();
    x_ajax_control_menu_submit_form(var_productos, var_terceros, var_ventas, var_compras, var_copias, var_empresa, var_pagos, var_cobros, var_notas_credito, var_contratos, var_agenda, var_indices, var_inventario, var_documentos, var_ventas_usuario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_menu_submit_form_cb);
  } // do_ajax_control_menu_submit_form

  function do_ajax_control_menu_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_menu_submit_form_cb_after_alert);
  } // do_ajax_control_menu_submit_form_cb
  function do_ajax_control_menu_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_menu_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_menu_navigate_form()
  {
    perform_ajax_control_menu_navigate_form();
  }

  function perform_ajax_control_menu_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_menu_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_menu']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_menu_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_menu_navigate_form_cb_after_alert);
  } // do_ajax_control_menu_navigate_form_cb
  function do_ajax_control_menu_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_menu_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_menu_navigate_form_cb_after_alert
  function sc_hide_control_menu_form()
  {
  ...
  ajax_field_list[0] = "productos";
  ajax_field_list[1] = "terceros";
  ajax_field_list[2] = "ventas";
  ajax_field_list[3] = "compras";
  ajax_field_list[4] = "copias";
  ajax_field_list[5] = "empresa";
  ajax_field_list[6] = "pagos";
  ajax_field_list[7] = "cobros";
  ajax_field_list[8] = "notas_credito";
  ajax_field_list[9] = "contratos";
  ajax_field_list[10] = "agenda";
  ajax_field_list[11] = "indices";
  ajax_field_list[12] = "inventario";
  ajax_field_list[13] = "documentos";
  ajax_field_list[14] = "ventas_usuario";
  ...
  var ajax_error_list = {
    ...
    "terceros": {"label": "Terceros", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ventas": {"label": "Ventas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "compras": {"label": "Compras (Doc. Soporte)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "copias": {"label": "Copias de seguridad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "empresa": {"label": "Datos de la empresa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "pagos": {"label": "Por pagar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cobros": {"label": "Por cobrar", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "notas_credito": {"label": "Notas Crédito/Débito", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "contratos": {"label": "Contratos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "agenda": {"label": "Agenda", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "indices": {"label": "RADIAN", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inventario": {"label": "Rotación Inventario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "documentos": {"label": "Gestión Documentos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ventas_usuario": {"label": "Ventas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "pagos": new Array(),
    "cobros": new Array(),
    "notas_credito": new Array(),
    "contratos": new Array(),
    "agenda": new Array(),
    "indices": new Array(),
    "inventario": new Array(),
    "documentos": new Array(),
    "ventas_usuario": new Array()
  };
  ajax_field_mult["productos"][1] = "productos";
  ajax_field_mult["terceros"][1] = "terceros";
  ajax_field_mult["ventas"][1] = "ventas";
  ajax_field_mult["compras"][1] = "compras";
  ajax_field_mult["copias"][1] = "copias";
  ajax_field_mult["empresa"][1] = "empresa";
  ajax_field_mult["pagos"][1] = "pagos";
  ajax_field_mult["cobros"][1] = "cobros";
  ajax_field_mult["notas_credito"][1] = "notas_credito";
  ajax_field_mult["contratos"][1] = "contratos";
  ajax_field_mult["agenda"][1] = "agenda";
  ajax_field_mult["indices"][1] = "indices";
  ajax_field_mult["inventario"][1] = "inventario";
  ajax_field_mult["documentos"][1] = "documentos";
  ajax_field_mult["ventas_usuario"][1] = "ventas_usuario";

  var ajax_field_id = {
    "productos": new Array("hidden_field_label_productos", "hidden_field_data_productos"),
    "terceros": new Array("hidden_field_label_terceros", "hidden_field_data_terceros"),
    "ventas": new Array("hidden_field_label_ventas", "hidden_field_data_ventas"),
    "compras": new Array("hidden_field_label_compras", "hidden_field_data_compras"),
    "copias": new Array("hidden_field_label_copias", "hidden_field_data_copias"),
    "empresa": new Array("hidden_field_label_empresa", "hidden_field_data_empresa"),
    "pagos": new Array("hidden_field_label_pagos", "hidden_field_data_pagos"),
    "cobros": new Array("hidden_field_label_cobros", "hidden_field_data_cobros"),
    "notas_credito": new Array("hidden_field_label_notas_credito", "hidden_field_data_notas_credito"),
    "contratos": new Array("hidden_field_label_contratos", "hidden_field_data_contratos"),
    "agenda": new Array("hidden_field_label_agenda", "hidden_field_data_agenda"),
    "indices": new Array("hidden_field_label_indices", "hidden_field_data_indices"),
    "inventario": new Array("hidden_field_label_inventario", "hidden_field_data_inventario"),
    "documentos": new Array("hidden_field_label_documentos", "hidden_field_data_documentos"),
    "ventas_usuario": new Array("hidden_field_label_ventas_usuario", "hidden_field_data_ventas_usuario")
  };
