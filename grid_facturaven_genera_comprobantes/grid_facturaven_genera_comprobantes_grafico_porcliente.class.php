...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_genera_comprobantes']['contr_label_graf']['idcli']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_genera_comprobantes']['contr_label_graf']['idcli']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_genera_comprobantes']['contr_label_graf']['idcli'];
      }
   }
