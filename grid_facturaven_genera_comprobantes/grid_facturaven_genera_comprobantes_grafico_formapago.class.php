...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label    = array();
      $this->label[0] = "F.P.";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_genera_comprobantes']['contr_label_graf']['credito']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_genera_comprobantes']['contr_label_graf']['credito']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_genera_comprobantes']['contr_label_graf']['credito'];
      }
   }
