<?php
   include_once('grid_facturaven_genera_comprobantes_session.php');
   session_start();
   $_SESSION['scriptcase']['grid_facturaven_genera_comprobantes']['glo_nm_path_imag_temp']  = "";
   //check tmp
   if(empty($_SESSION['scriptcase']['grid_facturaven_genera_comprobantes']['glo_nm_path_imag_temp']))
   {
       $str_path_apl_url = $_SERVER['PHP_SELF'];
       $str_path_apl_url = str_replace("\\", '/', $str_path_apl_url);
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/"));
       $str_path_apl_url = substr($str_path_apl_url, 0, strrpos($str_path_apl_url, "/")+1);
       /*check tmp*/$_SESSION['scriptcase']['grid_facturaven_genera_comprobantes']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
   }
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_facturaven_genera_comprobantes']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_genera_comprobantes_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_genera_comprobantes_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_facturaven_genera_comprobantes_json.php");
   }
   ...
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["fechaven"] : "Fecha";
   $tab_ger_campos['creado'] = "on";
   $tab_def_campos['creado'] = "creado";
   $tab_labels["creado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["creado"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["creado"] : "Creado";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["credito"] : "F.P.";
   $tab_ger_campos['fechavenc'] = "on";
   $tab_def_campos['fechavenc'] = "fechavenc";
   $tab_labels["fechavenc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["fechavenc"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["fechavenc"] : "Vence";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["resolucion"] : "PJ";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["numfacven"] : "No";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["total"] : "Total";
   $tab_ger_campos['banco'] = "on";
   $tab_def_campos['banco'] = "banco";
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["banco"] : "Caja";
   $tab_ger_campos['sicomprobante'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['sicomprobante'] = "sicomprobante";
   }
   else
   {
       $tab_def_campos['sicomprobante'] = "";
   }
   $tab_labels["sicomprobante"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["sicomprobante"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['labels']["sicomprobante"] : "¿CC?";
   $tab_ger_campos['sicomprobante'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_genera_comprobantes_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturaven_genera_comprobantes']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
