  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_terceros_historial_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_terceros_historial_mob_form();
	}
...
?>
  ...
  // ---------- Validate id
  function do_ajax_form_terceros_historial_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_historial_mob_validate_id(var_id, var_script_case_init, do_ajax_form_terceros_historial_mob_validate_id_cb);
  } // do_ajax_form_terceros_historial_mob_validate_id

  function do_ajax_form_terceros_historial_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_historial_mob_validate_id_cb

  // ---------- Validate fecha
  function do_ajax_form_terceros_historial_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_historial_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_terceros_historial_mob_validate_fecha_cb);
  } // do_ajax_form_terceros_historial_mob_validate_fecha

  function do_ajax_form_terceros_historial_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_historial_mob_validate_fecha_cb

  // ---------- Validate id_tercero
  function do_ajax_form_terceros_historial_mob_validate_id_tercero()
  {
    var nomeCampo_id_tercero = "id_tercero";
    var var_id_tercero = scAjaxGetFieldSelect(nomeCampo_id_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_historial_mob_validate_id_tercero(var_id_tercero, var_script_case_init, do_ajax_form_terceros_historial_mob_validate_id_tercero_cb);
  } // do_ajax_form_terceros_historial_mob_validate_id_tercero

  function do_ajax_form_terceros_historial_mob_validate_id_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_historial_mob_validate_id_tercero_cb

  // ---------- Validate notas
  function do_ajax_form_terceros_historial_mob_validate_notas()
  {
    var nomeCampo_notas = "notas";
    var var_notas = scAjaxGetFieldEditorHtml(nomeCampo_notas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_historial_mob_validate_notas(var_notas, var_script_case_init, do_ajax_form_terceros_historial_mob_validate_notas_cb);
  } // do_ajax_form_terceros_historial_mob_validate_notas

  function do_ajax_form_terceros_historial_mob_validate_notas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_historial_mob_validate_notas_cb

  // ---------- Validate fecha_limite
  function do_ajax_form_terceros_historial_mob_validate_fecha_limite()
  {
    var nomeCampo_fecha_limite = "fecha_limite";
    var var_fecha_limite = scAjaxGetFieldText(nomeCampo_fecha_limite);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_historial_mob_validate_fecha_limite(var_fecha_limite, var_script_case_init, do_ajax_form_terceros_historial_mob_validate_fecha_limite_cb);
  } // do_ajax_form_terceros_historial_mob_validate_fecha_limite

  function do_ajax_form_terceros_historial_mob_validate_fecha_limite_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_historial_mob_validate_fecha_limite_cb

  // ---------- Validate id_estado
  function do_ajax_form_terceros_historial_mob_validate_id_estado()
  {
    var nomeCampo_id_estado = "id_estado";
    var var_id_estado = scAjaxGetFieldSelect(nomeCampo_id_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_historial_mob_validate_id_estado(var_id_estado, var_script_case_init, do_ajax_form_terceros_historial_mob_validate_id_estado_cb);
  } // do_ajax_form_terceros_historial_mob_validate_id_estado

  function do_ajax_form_terceros_historial_mob_validate_id_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_historial_mob_validate_id_estado_cb

  // ---------- Validate asignado_a
  function do_ajax_form_terceros_historial_mob_validate_asignado_a()
  {
    var nomeCampo_asignado_a = "asignado_a";
    var var_asignado_a = scAjaxGetFieldSelect(nomeCampo_asignado_a);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_historial_mob_validate_asignado_a(var_asignado_a, var_script_case_init, do_ajax_form_terceros_historial_mob_validate_asignado_a_cb);
  } // do_ajax_form_terceros_historial_mob_validate_asignado_a

  function do_ajax_form_terceros_historial_mob_validate_asignado_a_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_historial_mob_validate_asignado_a_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_terceros_historial_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_terceros_historial_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_historial_mob_submit_form(var_id, var_fecha, var_id_tercero, var_notas, var_fecha_limite, var_id_estado, var_asignado_a, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_terceros_historial_mob_submit_form_cb);
  } // do_ajax_form_terceros_historial_mob_submit_form

  function do_ajax_form_terceros_historial_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_terceros_historial_mob_submit_form_cb_after_alert);
  } // do_ajax_form_terceros_historial_mob_submit_form_cb
  function do_ajax_form_terceros_historial_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_terceros_historial_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_terceros_historial_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_terceros_historial_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_terceros_historial_mob_navigate_form();
    }
  }

  function perform_ajax_form_terceros_historial_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_historial_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_historial_mob_navigate_form_cb);
  } // do_ajax_form_terceros_historial_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_historial_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_terceros_historial_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_terceros_historial_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_terceros_historial_mob_navigate_form_cb
  function do_ajax_form_terceros_historial_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_terceros_historial_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_terceros_historial_mob_navigate_form_cb_after_alert
  function sc_hide_form_terceros_historial_mob_form()
  {
