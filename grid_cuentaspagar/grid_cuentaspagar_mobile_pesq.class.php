...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_formapago"  <?php echo $str_hide_formapago?>> 
<?php
...
<?php if (!isset($pagada)) {$pagada = explode(";", $pagada);} ?>
 <SELECT class="scFilterObjectEven" id="SC_pagada" name="pagada[]"  size="7" multiple>
...
$style_cond_in = ($saldo_cond != "in") ? " style=\"display: none;\"" : ""; 
?>
<INPUT  type="text" id="SC_saldo_IN" name="saldo_IN" value="<?php echo NM_encode_input($saldo_IN) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '0123456789,', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd"<?php echo $style_cond_in ?>>         <BR>
