...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_cuentaspagar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_cuentaspagar"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cuentaspagar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cuentaspagar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cuentaspagar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cuentaspagar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cuentaspagar']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cuentaspagar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cuentaspagar']['embutida_filho'] as $ind => $sc_init)
          {
