...
class grid_cuentaspagar_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_cuentaspagar_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_cuentaspagar_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_cuentaspagar_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_numfacom($numfacom)
   {
      ...
      $nm_comando = "select distinct numfacom from " . $this->Ini->nm_tabela . " where saldo>0 and  numfacom like '%" . $numfacom . "%' order by numfacom"; 
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_saldo($saldo)
   {
      ...
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and   CAST (saldo AS TEXT)  like '%" . $saldo . "%' order by saldo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and   CAST (saldo AS VARCHAR)  like '%" . $saldo . "%' order by saldo"; 
      }
      else
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and  saldo like '%" . $saldo . "%' order by saldo"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_cuentaspagar/grid_cuentaspagar_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_cuentaspagar_ajax_search.js"></script>
 <script type="text/javascript" src="grid_cuentaspagar_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_cuentaspagar_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cuentaspagar']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_cuentaspagar']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['ajax_nav'])
           { 
...
function scJQCalendarAdd() {
  $("#sc_fechacom_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechacom_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechacom_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechacom_ano').value;
          document.getElementById('sc_fechacom_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechacom_dia').value = aParts[0];
          document.getElementById('SC_fechacom_mes').value = aParts[1];
          document.getElementById('SC_fechacom_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_fechacom_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_fechacom_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_fechacom_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_fechacom_input_2_ano').value;
          document.getElementById('sc_fechacom_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_fechacom_input_2_dia').value = aParts[0];
          document.getElementById('SC_fechacom_input_2_mes').value = aParts[1];
          document.getElementById('SC_fechacom_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_formapago#NMF#' + search_get_select('SC_formapago') + '@NMF@';
  ...
  str_out += 'SC_pagada#NMF#' + search_get_Dselelect('SC_pagada_dest') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['dashboard_info']['compact_mode'])
      {
          return;
      }
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
            ...
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__invoice_dollar_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $pagada_cond, $pagada,
             $saldo_cond, $saldo, $saldo_input_2, $saldo_autocomp, $saldo_IN,
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cuentaspagar']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_cuentaspagar']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_cuentaspagar']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_cuentaspagar", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $numfacom = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['numfacom']; 
          $numfacom_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['numfacom_cond']; 
          $formapago = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['formapago']; 
          $formapago_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['formapago_cond']; 
          $fechacom_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_dia']; 
          $fechacom_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_mes']; 
          $fechacom_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_ano']; 
          $fechacom_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_input_2_dia']; 
          $fechacom_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_input_2_mes']; 
          $fechacom_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_input_2_ano']; 
          $fechacom_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_cond']; 
          $pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['pagada']; 
          $pagada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['pagada_cond']; 
          $saldo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['saldo']; 
          $saldo_IN = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['saldo_IN']; 
          $saldo_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['saldo_input_2']; 
          $saldo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['saldo_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['NM_operador']; 
      } 
      ...
      // pagada
      if (is_array($pagada) && !empty($pagada))
      {
         $tmp_array = array();
         $pagada_val_str = "";
         foreach ($pagada as $tmp_val_cmp)
         {
            if ("" != $pagada_val_str)
            {
               $pagada_val_str .= ",";
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_numfacom_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['numfacom'])) ? $this->New_label['numfacom'] : "Número Compra"; ?></TD>
      
      <INPUT type="hidden" id="SC_numfacom_cond" name="numfacom_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_numfacom" <?php echo $str_hide_numfacom?> valign="top">
...
<?php
      ...
      $numfacom_look = substr($this->Db->qstr($numfacom), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numfacom from " . $this->Ini->nm_tabela . " where saldo>0 and numfacom = '$numfacom_look' order by numfacom"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-numfacom" id="id_ac_numfacom" name="numfacom_autocomp"><?php if ('' !=  $numfacom) { ?><option value="<?php echo $numfacom ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_formapago_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['formapago'])) ? $this->New_label['formapago'] : "Forma de pago"; ?></TD>
      
      <INPUT type="hidden" id="SC_formapago_cond" name="formapago_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_formapago" <?php echo $str_hide_formapago?> valign="top">
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['formapago'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['formapago'][] = "CONTADO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['formapago'][] = "CRÉDITO";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_formapago"  name="formapago"  size="1">
 <OPTION value="">TODOS</option>
 <OPTION value="CONTADO##@@CONTADO"<?php if ($formapago == "CONTADO") { echo " selected" ;} ?>>CONTADO</option>
 <OPTION value="CRÉDITO##@@CRÉDITO"<?php if ($formapago == "CRÉDITO") { echo " selected" ;} ?>>CRÉDITO</option>
 </SELECT>
      ...
      <TD id='SC_fechacom_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fechacom'])) ? $this->New_label['fechacom'] : "Fecha compra"; ?></TD>
      
      <INPUT type="hidden" id="SC_fechacom_cond" name="fechacom_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_fechacom" <?php echo $str_hide_fechacom?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechacom_ano" name="fechacom_ano" value="<?php echo NM_encode_input($fechacom_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fechacom_jq">
</span>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_fechacom"  <?php echo $str_display_fechacom; ?> class="scFilterFieldFontOdd">
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_fechacom_input_2_ano" name="fechacom_input_2_ano" value="<?php echo NM_encode_input($fechacom_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_fechacom_jq2">
</span>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['pagada'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['pagada'][] = "SI";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['pagada'][] = "NO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['pagada'][] = "AB";
 ?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectEven" id="SC_pagada_orig" name="pagada_orig" size=7 multiple onDblClick="nm_add_sel('pagada_orig', 'pagada_dest', 'N', '')">
<?php
    if (is_array($pagada) && !empty($pagada))
    {
        $pagada_sel = (in_array("SI", $pagada)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="SI##@@SI" <?php echo $pagada_sel; ?>>SI</option>
<?php
    if (is_array($pagada) && !empty($pagada))
    {
        $pagada_sel = (in_array("NO", $pagada)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="NO##@@NO" <?php echo $pagada_sel; ?>>NO</option>
<?php
    if (is_array($pagada) && !empty($pagada))
    {
        $pagada_sel = (in_array("AB", $pagada)) ? " disabled =\"disabled\" style=\"color: #A0A0A0\"" : "";
    }
?>
 <OPTION value="AB##@@ABONO" <?php echo $pagada_sel; ?>>ABONO</option>
 </SELECT>
   </td>
   <td align="center">
<?php
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('pagada_orig', 'pagada_dest', 'N', '');", "nm_add_all('pagada_orig', 'pagada_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('pagada_orig', 'pagada_dest', 'N', '');", "nm_add_sel('pagada_orig', 'pagada_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('pagada_dest', 'pagada_orig', 'N', '');", "nm_del_sel('pagada_dest', 'pagada_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('pagada_dest', 'pagada_orig', 'N', '');", "nm_del_all('pagada_dest', 'pagada_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectEven" id="SC_pagada_dest" name="pagada_dest" size=7 multiple onDblClick="nm_del_sel('pagada_dest', 'pagada_orig', 'N', '')">"
<?php if (in_array("SI", $pagada)) { ?> <OPTION value="SI##@@SI" >SI</option>
<?php
      }
?>
<?php if (in_array("NO", $pagada)) { ?> <OPTION value="NO##@@NO" >NO</option>
<?php
      }
?>
<?php if (in_array("AB", $pagada)) { ?> <OPTION value="AB##@@ABONO" >ABONO</option>
<?php
      }
?>
    </select>
    <input type="hidden" id="SC_pagada" name="pagada" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.pagada_dest.selectedIndex = -1;</script>
      ...
      <TD id='SC_saldo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['saldo'])) ? $this->New_label['saldo'] : "Saldo"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_saldo_cond" name="saldo_cond" onChange="nm_campos_between(document.getElementById('id_vis_saldo'), this, 'saldo')">
       ...
       <OPTION value="ii" <?php if ("ii" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_stts_with'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="df" <?php if ("df" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="ge" <?php if ("ge" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr_equl'] ?></OPTION>
       <OPTION value="le" <?php if ("le" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less_equl'] ?></OPTION>
       <OPTION value="in" <?php if ("in" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw_sevr'] ?></OPTION>
       <OPTION value="nu" <?php if ("nu" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_null'] ?></OPTION>
       <OPTION value="nn" <?php if ("nn" == $saldo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_nnul'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_saldo" <?php echo $str_hide_saldo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and saldo = $saldo_look order by saldo"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct saldo from " . $this->Ini->nm_tabela . " where saldo>0 and saldo = $saldo_look order by saldo"; 
...
<?php
$style_cond_in = ($saldo_cond == "in") ? " style=\"display: none;\"" : ""; 
?>
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-saldo" id="id_ac_saldo" name="saldo_autocomp"<?php echo $style_cond_in ?>><?php if ('' !=  $saldo) { ?><option value="<?php echo $saldo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
<?php
$style_cond_in = ($saldo_cond != "in") ? " style=\"display: none;\"" : ""; 
?>
<INPUT  type="text" id="SC_saldo_IN" name="saldo_IN" value="<?php echo NM_encode_input($saldo_IN) ?>" size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '0123456789,', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd"<?php echo $style_cond_in ?>>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_saldo"  <?php echo $str_display_saldo; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_saldo_input_2" name="saldo_input_2" value="<?php echo NM_encode_input($saldo_input_2) ?>"  size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
...
<?php
   if (is_file("grid_cuentaspagar_help.txt"))
   {
      $Arq_WebHelp = file("grid_cuentaspagar_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cuentaspagar']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cuentaspagar']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cuentaspagar']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_cuentaspagar']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.fechacom_cond.value = 'bw';
   ...
   nm_del_all('pagada_dest', 'pagada_orig', 'N', '');
   ...
   document.F1.saldo_IN.value = "";
   Sc_carga_select2('all');
 }
 function Sc_carga_select2(Field)
 {
    if (Field == 'all' || Field == 'formapago') {
       Sc_carga_select2_formapago();
    }
 }
 function Sc_carga_select2_formapago()
 {
  $("#SC_formapago").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 {
    $('#SC_fechacom_dia').bind('change', function() {sc_grid_cuentaspagar_valida_dia(this)});
    $('#SC_fechacom_input_2_dia').bind('change', function() {sc_grid_cuentaspagar_valida_dia(this)});
    $('#SC_fechacom_input_2_mes').bind('change', function() {sc_grid_cuentaspagar_valida_mes(this)});
    $('#SC_fechacom_mes').bind('change', function() {sc_grid_cuentaspagar_valida_mes(this)});
 }
 function sc_grid_cuentaspagar_valida_dia(obj)
 {
 ...
 function sc_grid_cuentaspagar_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_cuentaspagar";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      global $numfacom_cond, $numfacom, $numfacom_autocomp,
             ...
             $fechacom_cond, $fechacom, $fechacom_dia, $fechacom_mes, $fechacom_ano, $fechacom_input_2_dia, $fechacom_input_2_mes, $fechacom_input_2_ano,
             $pagada_cond, $pagada,
             $saldo_cond, $saldo, $saldo_input_2, $saldo_autocomp, $saldo_IN, $nmgp_tab_label;
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($formapago, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['formapago'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Forma de pago : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (is_array($pagada)) {
          foreach ($pagada as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['psq_check_ret']['pagada'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['numfacom'] = $numfacom; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['numfacom_cond'] = $numfacom_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['formapago'] = $formapago; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['formapago_cond'] = $formapago_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_dia'] = $fechacom_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_mes'] = $fechacom_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_ano'] = $fechacom_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_input_2_dia'] = $fechacom_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_input_2_mes'] = $fechacom_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_input_2_ano'] = $fechacom_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_cond'] = $fechacom_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['pagada'] = $pagada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['pagada_cond'] = $pagada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['saldo'] = $saldo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['saldo_input_2'] = $saldo_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['saldo_IN'] = $saldo_IN; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['saldo_cond'] = $saldo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca'] = $Temp_Busca;
      }
    ...
    if ($numfacom != '') {
      ...
      $this->cmp_formatado['formapago'] = $Conteudo;
      $this->cmp_formatado['pagada'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['pagada'];
      $this->cmp_formatado['pagada_input_2'] = $pagada_input_2;
      $nmgp_def_dados = array();
    if ($saldo != '') {
      $saldo_look = substr($this->Db->qstr($saldo), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if ($fechacom_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom'] = $val[0];
          ...
          if ($fechacom_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']['fechacom_input_2'] = $val[1];
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($pagada_cond == "nu" || $pagada_cond == "nn" || $pagada_cond == "ep" || $pagada_cond == "ne")
      {
          $pagada = array();
      }
      if (is_array($pagada) && count($pagada) != 0)
      {
         foreach ($pagada as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($pagada_cond == "df" || $pagada_cond == "np")
         {
             $this->comando        .= " pagada not in (";
             $this->comando_sum    .= " facturacom.pagada not in (";
             $this->comando_filtro .= " pagada not in (";
         }
         else
         {
             $this->comando        .= " pagada in (";
             $this->comando_sum    .= " facturacom.pagada in (";
             $this->comando_filtro .= " pagada in (";
         }
         $x                     = count($pagada);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$pagada_cond]) ? $Lang_descr[$pagada_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $nmgp_tab_label['pagada'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($pagada) || $pagada_cond == "nu" || $pagada_cond == "nn" || $pagada_cond == "ep" || $pagada_cond == "ne")
      {
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cuentaspagar']['where_pesq'];
