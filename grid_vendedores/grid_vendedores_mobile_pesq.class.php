...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "nacimiento";$Nm_datas[] = "nacimiento";$Nm_datas[] = "fechault";$Nm_datas[] = "fechault";$Nm_datas[] = "afiliacion";$Nm_datas[] = "afiliacion";$Nm_datas[] = "fechultcomp";$Nm_datas[] = "fechultcomp";$Nm_numeric[] = "idtercero";$Nm_numeric[] = "saldo";$Nm_numeric[] = "idmuni";$Nm_numeric[] = "cupo";$Nm_numeric[] = "listaprecios";$Nm_numeric[] = "loatiende";$Nm_numeric[] = "dias";$Nm_numeric[] = "saldoapagar";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_nombres_cond" name="nombres_cond" onChange="nm_campos_between(document.getElementById('id_vis_nombres'), this, 'nombres')">
