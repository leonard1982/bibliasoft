...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_historial"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_terceros_historial"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_terceros_historial'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_historial']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_historial']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_historial']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_terceros_historial']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_terceros_historial']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_terceros_historial</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_terceros_historial']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_terceros_historial']['embutida_filho'] as $ind => $sc_init)
          {
