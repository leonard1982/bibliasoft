...
<?php
   ...
   $Ord_Cmp = new grid_terceros_historial_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_terceros_historial_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['id_tercero'] = "on";
   $tab_def_campos['id_tercero'] = "id_tercero";
   $tab_labels["id_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["id_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["id_tercero"] : "Tercero";
   $tab_ger_campos['fecha_limite'] = "on";
   $tab_def_campos['fecha_limite'] = "fecha_limite";
   $tab_labels["fecha_limite"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["fecha_limite"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["fecha_limite"] : "Fecha Limite";
   $tab_ger_campos['id_estado'] = "on";
   $tab_def_campos['id_estado'] = "id_estado";
   $tab_labels["id_estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["id_estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["id_estado"] : "Estado";
   $tab_ger_campos['asignado_a'] = "on";
   $tab_def_campos['asignado_a'] = "asignado_a";
   $tab_labels["asignado_a"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["asignado_a"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["asignado_a"] : "Asignado A";
   $tab_ger_campos['id_usuario'] = "on";
   $tab_def_campos['id_usuario'] = "id_usuario";
   $tab_labels["id_usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["id_usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["id_usuario"] : "Usuario";
   $tab_ger_campos['notificar'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['notificar'] = "notificar";
   }
   else
   {
       $tab_def_campos['notificar'] = "";
   }
   $tab_labels["notificar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["notificar"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['labels']["notificar"] : "Notificar";
   $tab_ger_campos['notificar'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_terceros_historial_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_terceros_historial']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
