...
$_SESSION['scriptcase']['grid_facturaven_280521']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_credito = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['arr_total']['credito'];
      }
      else
      {
          $this->array_total_credito = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['arr_total']['credito'] = $this->array_total_credito;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['credito']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['credito'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['credito'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['credito'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['credito'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['credito'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['credito'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['credito'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['credito'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['credito'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_credito as $i_credito => $d_credito) {
           if (!in_array($i_credito, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_credito[11] ] = $d_credito[10];
               $this->comp_label[0][ $d_credito[11] ] = $d_credito[10];
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_credito("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $quebra_credito, $quebra_credito_orig)
   {
      //----- Crédito
      if (!isset($this->array_total_credito[$quebra_credito_orig]))
      {
         ...
         $this->array_total_credito[$quebra_credito_orig][4] = $sum_base_iva_19;
         $this->array_total_credito[$quebra_credito_orig][5] = $sum_valor_iva_19;
         $this->array_total_credito[$quebra_credito_orig][6] = $sum_base_iva_5;
         $this->array_total_credito[$quebra_credito_orig][7] = $sum_valor_iva_5;
         $this->array_total_credito[$quebra_credito_orig][8] = $sum_excento;
         $this->array_total_credito[$quebra_credito_orig][9] = 1;
         $this->array_total_credito[$quebra_credito_orig][10] = $quebra_credito;
         $this->array_total_credito[$quebra_credito_orig][11] = $quebra_credito_orig;
      }
      else
      {
         ...
         $this->array_total_credito[$quebra_credito_orig][7] += $sum_valor_iva_5;
         $this->array_total_credito[$quebra_credito_orig][8] += $sum_excento;
         $this->array_total_credito[$quebra_credito_orig][9]++;
      }
   }
...
$_SESSION['scriptcase']['grid_facturaven_280521']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->credito, $this->credito_orig);
            }
   }
//
