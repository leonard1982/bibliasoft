...
$_SESSION['scriptcase']['grid_facturaven_280521']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['arr_total']['resolucion'];
      }
      else
      {
          $this->array_total_resolucion = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['arr_total']['resolucion'] = $this->array_total_resolucion;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['prefijo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['prefijo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['prefijo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['prefijo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['prefijo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['prefijo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['prefijo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['prefijo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['prefijo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['prefijo'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_resolucion as $i_resolucion => $d_resolucion) {
           if (!in_array($i_resolucion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_resolucion[11] ] = $d_resolucion[10];
               $this->comp_label[0][ $d_resolucion[11] ] = $d_resolucion[10];
           }
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_prefijo("res");
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_total, $sum_subtotal, $sum_valoriva, $sum_base_iva_19, $sum_valor_iva_19, $sum_base_iva_5, $sum_valor_iva_5, $sum_excento, $quebra_resolucion, $quebra_resolucion_orig)
   {
      //----- PJ
      if (!isset($this->array_total_resolucion[$quebra_resolucion_orig]))
      {
         ...
         $this->array_total_resolucion[$quebra_resolucion_orig][4] = $sum_base_iva_19;
         $this->array_total_resolucion[$quebra_resolucion_orig][5] = $sum_valor_iva_19;
         $this->array_total_resolucion[$quebra_resolucion_orig][6] = $sum_base_iva_5;
         $this->array_total_resolucion[$quebra_resolucion_orig][7] = $sum_valor_iva_5;
         $this->array_total_resolucion[$quebra_resolucion_orig][8] = $sum_excento;
         $this->array_total_resolucion[$quebra_resolucion_orig][9] = 1;
         $this->array_total_resolucion[$quebra_resolucion_orig][10] = $quebra_resolucion;
         $this->array_total_resolucion[$quebra_resolucion_orig][11] = $quebra_resolucion_orig;
      }
      else
      {
         ...
         $this->array_total_resolucion[$quebra_resolucion_orig][7] += $sum_valor_iva_5;
         $this->array_total_resolucion[$quebra_resolucion_orig][8] += $sum_excento;
         $this->array_total_resolucion[$quebra_resolucion_orig][9]++;
      }
   }
...
$_SESSION['scriptcase']['grid_facturaven_280521']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->total, $this->subtotal, $this->valoriva, $this->base_iva_19, $this->valor_iva_19, $this->base_iva_5, $this->valor_iva_5, $this->excento, $this->resolucion, $this->resolucion_orig);
            }
   }
//
