...
ORDER BY tipo", $cadapar[0]);
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['cfg_graf']['graf_tipo']))
      {
