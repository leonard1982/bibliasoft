...
$_SESSION['scriptcase']['grid_facturaven_280521']['contr_erro'] = 'off'; 
      ...
      {
          $this->array_total_tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['arr_total']['tipo'];
      }
      else
      {
          $this->array_total_tipo = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['arr_total']['tipo'] = $this->array_total_tipo;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['tipo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['tipo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_order']['tipo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['tipo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['tipo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['tipo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['tipo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['tipo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['tipo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['summarizing_fields_display']['tipo'] as $i_sum => $d_sum)
           {
