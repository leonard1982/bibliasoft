<?php
@session_start() ;
$_SESSION['scriptcase']['grid_facturaven_280521']['sc_process_barr'] = true;
require_once('../grid_facturaven_280521/index.php');
unset($_SESSION['scriptcase']['grid_facturaven_280521']['sc_process_barr']);
$ExportCtrl = new grid_facturaven_280521_export_control;
$ExportCtrl->Export_barr();

class grid_facturaven_280521_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_facturaven_280521']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_facturaven_280521']['glo_nm_path_imag_temp'];
