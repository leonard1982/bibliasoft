...
class grid_facturaven_280521_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $sum_fechaven_base_con_8;
   var $sum_fechaven_valor_con_8;
   var $sum_fechaven_t_iva;
   var $sum_fechaven_imp_bolsa;
   var $fechavenc_Old;
   ...
   var $sum_fechavenc_base_con_8;
   var $sum_fechavenc_valor_con_8;
   var $sum_fechavenc_t_iva;
   var $sum_fechavenc_imp_bolsa;
   var $credito_Old;
   var $arg_sum_credito;
   var $Label_credito;
   ...
   var $sum_credito_base_con_8;
   var $sum_credito_valor_con_8;
   var $sum_credito_t_iva;
   var $sum_credito_imp_bolsa;
   var $vendedor_Old;
   ...
   var $sum_vendedor_base_con_8;
   var $sum_vendedor_valor_con_8;
   var $sum_vendedor_t_iva;
   var $sum_vendedor_imp_bolsa;
   var $resolucion_Old;
   ...
   var $sum_resolucion_base_con_8;
   var $sum_resolucion_valor_con_8;
   var $sum_resolucion_t_iva;
   var $sum_resolucion_imp_bolsa;
   var $tipo_Old;
   var $arg_sum_tipo;
   var $Label_tipo;
   ...
   function monta_xls()
   {
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   nm_limpa_str_grid_facturaven_280521($cadapar[1]);
                   nm_protect_num_grid_facturaven_280521($cadapar[0], $cadapar[1]);
                   if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                   $Tmp_par   = $cadapar[0];
                   $$Tmp_par = $cadapar[1];
                   if ($Tmp_par == "nmgp_opcao")
                   {
                       $_SESSION['sc_session'][$script_case_init]['grid_facturaven_280521']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      if (isset($par_numfacventa)) 
      {
          ...
          nm_limpa_str_grid_facturaven_280521($_SESSION["par_numfacventa"]);
      }
      ...
      if (isset($gIdfac)) 
      {
          ...
          nm_limpa_str_grid_facturaven_280521($_SESSION["gIdfac"]);
      }
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "_NM_SC_")
          {
              $this->Tem_xls_res  = false;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_facturaven_280521/grid_facturaven_280521_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_facturaven_280521_res_xls.class.php");
              $this->Res_xls = new grid_facturaven_280521_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_facturaven_280521.zip";
          $this->Arquivo   .= "_grid_facturaven_280521" . $this->Xls_tp;
          $this->Tit_doc    = "grid_facturaven_280521" . $this->Xls_tp;
          $this->Tit_zip    = "grid_facturaven_280521.zip";
      ...
      $this->Tot = new grid_facturaven_280521_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'];
      $this->Tot->$Gb_geral();
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][1];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "fecha")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][2];
          $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][3];
          $this->sum_valoriva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][4];
          $this->sum_base_iva_19 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][5];
          $this->sum_valor_iva_19 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][6];
          $this->sum_base_iva_5 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][7];
          $this->sum_valor_iva_5 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][8];
          $this->sum_excento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][9];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "vencimiento")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][2];
          $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][3];
          $this->sum_valoriva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][4];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "credito")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][2];
          $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][3];
          $this->sum_valoriva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][4];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "vendedor")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][2];
          $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][3];
          $this->sum_valoriva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][4];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "prefijo")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][2];
          $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][3];
          $this->sum_valoriva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][4];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "tipo")
      {
          $this->sum_total = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][2];
          $this->sum_subtotal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][3];
          $this->sum_valoriva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][4];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "_NM_SC_")
      {
          ...
          $this->sum_valor_iva_5 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][8];
          $this->sum_excento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][9];
          $this->sum_base_con_8 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][10];
          $this->sum_valor_con_8 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][11];
          $this->sum_t_iva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][12];
          $this->sum_imp_bolsa = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][13];
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida'] && !$this->Ini->sc_export_ajax) {
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_facturaven_280521']['glo_nm_path_imag_temp'] . "/");
          $this->pb->setProgressbarMd5($_GET['pbmd5']);
          $this->pb->initialize();
          $this->pb->setReturnUrl("./");
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_280521']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_280521']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_280521']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['usr_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['php_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['field_order'] as $Cada_cmp)
      {
...
$_SESSION['scriptcase']['grid_facturaven_280521']['contr_erro'] = 'off'; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['where_pesq'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['where_resumo'])) 
      { 
          if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['where_pesq'])) 
          { 
              $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['where_resumo']; 
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "_NM_SC_")
         {
         ...
         $this->arg_sum_tipo = " = " . $this->Db->qstr($this->tipo);
          ...
          if ($Cmp_tst != $this->fechaven_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "fecha") 
          {  
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
          ...
          if ($Cmp_tst != $this->fechavenc_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "vencimiento") 
          {  
          ...
          if ($this->credito !== $this->credito_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "credito") 
          {  
          ...
          if ($this->vendedor !== $this->vendedor_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "vendedor") 
          {  
          ...
          if ($this->resolucion !== $this->resolucion_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "prefijo") 
          {  
          ...
          if ($this->tipo !== $this->tipo_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "tipo") 
          {  
...
$_SESSION['scriptcase']['grid_facturaven_280521']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida'])
      { 
      ...
      if ($this->groupby_show == "S") {
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
       if (isset($this->fechaven_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "fecha")
       {
           $this->quebra_fechaven_fecha_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->fechavenc_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "vencimiento")
       {
           $this->quebra_fechavenc_vencimiento_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->credito_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "credito")
       {
           $this->quebra_credito_credito_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->vendedor_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "vendedor")
       {
           $this->quebra_vendedor_vendedor_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->resolucion_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "prefijo")
       {
           $this->quebra_resolucion_prefijo_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->tipo_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] == "tipo")
       {
           $this->quebra_tipo_tipo_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['detalleventa'])) ? $this->New_label['detalleventa'] : "Venta"; 
          if (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off")
          {
   ...
   function NM_export_tipo_doc()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipo_doc, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tipo_doc, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- resolucion
   ...
   function NM_export_imprmirtirilla()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->imprmirtirilla = html_entity_decode($this->imprmirtirilla, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->imprmirtirilla = strip_tags($this->imprmirtirilla);
         $this->imprmirtirilla = NM_charset_to_utf8($this->imprmirtirilla);
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->imprmirtirilla, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->imprmirtirilla, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- idfacven
   ...
   function NM_export_imp_bolsa()
   {
         ...
         if (is_numeric($this->imp_bolsa))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->imp_bolsa);
         $this->Xls_col++;
   }
   //----- print
   ...
   {
         $this->tipo_doc = NM_charset_to_utf8($this->tipo_doc);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tipo_doc;
   ...
   //----- imprmirtirilla
   function NM_sub_cons_imprmirtirilla()
   {
         $this->imprmirtirilla = html_entity_decode($this->imprmirtirilla, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->imprmirtirilla = strip_tags($this->imprmirtirilla);
         $this->imprmirtirilla = NM_charset_to_utf8($this->imprmirtirilla);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->imprmirtirilla;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   //----- imp_bolsa
   function NM_sub_cons_imp_bolsa()
   {
         $this->imp_bolsa = NM_charset_to_utf8($this->imp_bolsa);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->imp_bolsa;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['nolabel'])
       {
 ...
 function quebra_resolucion_prefijo($resolucion) 
 {
   ...
   $this->sum_resolucion_base_iva_19 = $tot_resolucion[5];
   $this->sum_resolucion_valor_iva_19 = $tot_resolucion[6];
   $this->sum_resolucion_base_iva_5 = $tot_resolucion[7];
   $this->sum_resolucion_valor_iva_5 = $tot_resolucion[8];
   $this->sum_resolucion_excento = $tot_resolucion[9];
 ...
 function quebra_tipo_tipo($tipo) 
 {
   ...
   $this->sum_tipo_base_iva_19 = $tot_tipo[5];
   $this->sum_tipo_valor_iva_19 = $tot_tipo[6];
   $this->sum_tipo_base_iva_5 = $tot_tipo[7];
   $this->sum_tipo_valor_iva_5 = $tot_tipo[8];
   $this->sum_tipo_excento = $tot_tipo[9];
   ...
   function quebra_fechaven_fecha_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['field_order'] as $Cada_cmp)
       {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_resolucion_prefijo_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_resolucion_base_iva_19;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_resolucion_valor_iva_19;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_resolucion_base_iva_5;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_resolucion_valor_iva_5;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_resolucion_excento;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_tipo_tipo_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_tipo_base_iva_19;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_tipo_valor_iva_19;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_tipo_base_iva_5;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Cmp_Tot    = $this->sum_tipo_valor_iva_5;
               $prim_cmp = false;
               $Cmp_Tot = NM_charset_to_utf8($Cmp_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Cmp_Tot;
   ...
   function quebra_geral_fecha_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "total" && (!isset($this->NM_cmp_hidden['total']) || $this->NM_cmp_hidden['total'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][2];
               $prim_cmp = false;
           ...
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][3];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][4];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][5];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][6];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][7];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][8];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][9];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   function quebra_geral__NM_SC__bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['field_order'] as $Cada_cmp)
       {
           ...
           elseif ($Cada_cmp == "base_con_8" && (!isset($this->NM_cmp_hidden['base_con_8']) || $this->NM_cmp_hidden['base_con_8'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][10];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif ($Cada_cmp == "valor_con_8" && (!isset($this->NM_cmp_hidden['valor_con_8']) || $this->NM_cmp_hidden['valor_con_8'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][11];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif ($Cada_cmp == "t_iva" && (!isset($this->NM_cmp_hidden['t_iva']) || $this->NM_cmp_hidden['t_iva'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][12];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           elseif ($Cada_cmp == "imp_bolsa" && (!isset($this->NM_cmp_hidden['imp_bolsa']) || $this->NM_cmp_hidden['imp_bolsa'] != "off"))
           {
               $Format_Num = "#,##0";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['tot_geral'][13];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521'][$path_doc_md5][1] = $this->Tit_doc;
...
<form name="Fdown" method="get" action="grid_facturaven_280521_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_facturaven_280521"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<FORM name="F0" method=post action="./"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturaven_280521']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
