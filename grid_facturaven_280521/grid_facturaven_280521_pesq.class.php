...
?>
      ...
      <TD id='SC_resolucion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['resolucion'])) ? $this->New_label['resolucion'] : "PJ"; ?></TD>
...
?>
      ...
      <TD id='SC_numfacven_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "Número"; ?></TD>
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_vendedor" name="vendedor_autocomp" size="51"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 51, allowedChars: '', lettersCase: '', autoTab: false, enterTab: true}">
      ...
      <TD id='SC_observaciones_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['observaciones'])) ? $this->New_label['observaciones'] : "Observaciones"; ?></TD>
...
<?php
 ...
 <OPTION value="0##@@NO"<?php if ($asentada == "0") { echo " selected" ;} ?>>NO</option>
      ...
      <TD id='SC_pagada_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['pagada'])) ? $this->New_label['pagada'] : "Pagada"; ?></TD>
...
<?php
 ...
 <OPTION value="NO##@@NO"<?php if ($pagada == "NO") { echo " selected" ;} ?>>NO</option>
      ...
      <TD id='SC_credito_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['credito'])) ? $this->New_label['credito'] : "Crédito"; ?></TD>
