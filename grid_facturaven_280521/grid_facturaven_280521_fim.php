...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_facturaven_280521"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_facturaven_280521"]);
   }
