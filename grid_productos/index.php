<?php
   ...
   $_SESSION['scriptcase']['grid_productos']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_productos']['glo_nm_path_doc']        = "";
   $_SESSION['scriptcase']['grid_productos']['glo_con_conn_nube']         = "conn_nube";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['grid_productos']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_productos']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['grid_productos']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_productos']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_productos']['save_session']['save_grid_state_session'] = false;
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_productos']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_productos']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_productos']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['grid_productos']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_productos']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_productos']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      $this->sc_lig_target["C_@scinf_agregarnotainv"] = '_self';
      $this->sc_lig_target["C_@scinf_agregarnotainv_@scinf_form_mov_ajusteinv"] = '_self';
      $Tmp_apl_lig = "form_combos";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/form_combos_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/form_combos_ini.txt");
      ...
      $this->sc_lig_target["C_@scinf_escombo"] = '_self';
      $this->sc_lig_target["C_@scinf_escombo_@scinf_form_combos"] = '_self';
      ...
      $this->sc_lig_target["C_@scinf_combo"] = '_self';
      $this->sc_lig_target["C_@scinf_combo_@scinf_form_combos"] = '_self';
...
// 
      ...
      $this->arr_buttons_usr['btn_recalcular']['image']            = "grp__NM__ico__NM__ico_recalcular_32x32.png";
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      $this->conectExtra();
...
/*NM*/            $_SESSION['scriptcase']['grid_productos']['glo_nm_perfil'] = $NM_con_dest;
      ...
      if (!empty($perfil_trab))
      {
          ...
          carrega_perfil($_SESSION['scriptcase']['grid_productos']['glo_con_conn_nube'], $this->path_libs, "S", $this->path_conf);
          $this->nm_con_conn_nube['servidor']               = $_SESSION['scriptcase']['glo_servidor'];
          $this->nm_con_conn_nube['usuario']                = $_SESSION['scriptcase']['glo_usuario'];
          $this->nm_con_conn_nube['banco']                  = $_SESSION['scriptcase']['glo_banco'];
          $this->nm_con_conn_nube['senha']                  = $_SESSION['scriptcase']['glo_senha'];
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_productos']['glo_nm_conexao'], $this->root . $this->path_prod, 'FACILWEBv2', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      $this->Change_Menu = false;
       ...
       { 
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_productos']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_productos']['label'] = "Lista de productos";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  $_SESSION['sc_session'][$script_case_init]['grid_productos']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_productos']['pivot_tabular']);
              }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_All_Groupby'] = array('_NM_SC_' => 'grid', 'familia' => 'grid', 'sc_free_group_by' => 'all');
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_Gb_Free_orig'] = array();
      }
      ...
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          ...
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_Ind_Groupby'] == "_NM_SC_")
      {
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['summarizing_fields_display']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['summarizing_fields_display']['sc_free_group_by'][2] = array('label' => "" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['summarizing_fields_order']['sc_free_group_by'][] = 2;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['summarizing_fields_display']['sc_free_group_by'][3] = array('label' => "Existencia Menor(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")", 'display' => true);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['summarizing_fields_order']['sc_free_group_by'][] = 3;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "NM_Count",
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] = "json_res"; 
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['graf_disp']        = array('Bar', 'Pie', 'Line', 'Area');
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['graf_exibe_val']    = '0';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      ...
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['field_order'][] = "combo";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['field_order'][] = "preciomen3";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['field_order'][] = "precio2";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['field_order'][] = "preciomay";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['usr_cmp_sel']['escombo'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['usr_cmp_sel']['preciomen2'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['usr_cmp_sel']['preciomen3'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['usr_cmp_sel']['precio2'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['usr_cmp_sel']['preciomay'] = "off";
      ...
      { 
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_refresh'] = true;
          } 
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] == "interativ_search")
      { 
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] = 'inicio';
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opc_int_search'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_refresh'] = true;
      } 
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']      = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['grid_pesq']         = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['Grid_search']       = "";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_productos.pdf";
...
//----------------------------------->
      ...
      { 
          ...
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['word_name'] .= ".doc";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_productos/grid_productos_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_productos_json.class.php"); 
          } 
          $this->json  = new grid_productos_json();
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_productos_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
            ...
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['pdf_name'], 1);
                }
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_productos_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_productos_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_productos.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['sc_sql_btn_run']))
{
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'] . ")"; 
              }
          }
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'])) 
      {
          $comando .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'] . ")";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['fast_search'][0] = $in_fields;
   ...
   function SC_proc_interativ_search($Parms)
   {
       ...
       $cmd_sql = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['int_search_sql'][$tmp[0]];
       $vls     = "";
       $bol_numeric = false;
       if ($tmp[3] == "clear_interativ_all") {
           ...
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'][$tmp[0]]);
           if ($tmp[3] != "clear_interativ")
           {
               ...
               if ($tmp[2] == "dt" || $tmp[2] == "dh" || $tmp[2] == "hh")
               {
                   ...
                   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_sep_date']))
                   {
                       $delim  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_sep_date'];
                       $delim1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_sep_date1'];
                   }
               }
           }
       }
       if (!empty($vls))
       {
           $prep = "";
           $bol_has_empty = false;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'][$tmp[0]]['tp_obj'] = $tmp[2];
           foreach ($vls as $cada_val)
           {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'][$tmp[0]]['lab'][$tmp[1]][] = $descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'][$tmp[0]]['val_sel'][] = $cada_val;
               if ($cada_val == "")
               {
                   $bol_has_empty = true;
               }
           ...
           if ($prep == "" && $bol_numeric)
           {
               if (in_array(strtolower($this->nm_tpbanco), $this->nm_bases_postgres))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " is null";
               }
               else
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " = '' or " . $cmd_sql . " is null";
               }
           }
           elseif ($prep == "" && $delim != "")
           {
           ...
           elseif ( $tmp[2] == "bw")
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " between " . $delim . $range_bw[0] .  $delim1 . " and " . $delim . $range_bw[1] .  $delim1 . $str_add_null_or;
           }
           else
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'][$tmp[0]]['val'] = $cmd_sql . " IN (" . $prep . ")" . $str_add_null_or;
           }
       }
      $tmp_cmd = "";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_orig'])) 
      ...
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_fast'])) 
      {
          if (!empty($tmp_cmd)) 
          {
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_fast'] . ")";
          }
          else 
          {
              $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_fast'] . ")";
          }
      }
      ...
      { 
          if (empty($tmp_where)) 
          { 
              $tmp_cmd = "where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_resumo']; 
          } 
          else
          { 
              $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_resumo'] . ")"; 
          } 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_sem_interativ']  = $tmp_cmd;
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'])) 
      {
          $prim = true;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'] as $cmp => $val) 
          {
              if (!$prim)
              {
                 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'] .= " AND ";
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'] .= "(" . $val['val'] . ")";
              $prim = false;
          }
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_interativ'])) 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq'] = $tmp_cmd;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['refresh_interativ'] = (isset($tmp[5])) ? $tmp[5] : "S";
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_productos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_productos']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv2.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_FACILWEBv2'])) {
               $_SESSION['scriptcase']['grid_productos']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_FACILWEBv2'];
           }
       }
   }
...
//
   ...
   function grid_productos_pack_protect_string($sString)
   {
    ...
    function grid_productos_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
