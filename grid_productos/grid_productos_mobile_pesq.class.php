...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_ubicacion"  <?php echo $str_hide_ubicacion?>><INPUT  type="text" id="SC_ubicacion" name="ubicacion" value="<?php echo NM_encode_input($ubicacion) ?>"  size=50 alt="{datatype: 'text', maxLength: 360, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
