...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $codigobar = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['codigobar']; 
          $codigobar_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['codigobar_cond']; 
          $nompro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['nompro']; 
          $nompro_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['nompro_cond']; 
          $idgrup = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idgrup']; 
          $idgrup_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idgrup_cond']; 
          $idpro1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idpro1']; 
          $idpro1_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idpro1_cond']; 
          $idpro2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idpro2']; 
          $idpro2_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idpro2_cond']; 
          $idiva = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idiva']; 
          $idiva_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idiva_cond']; 
          $escombo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['escombo']; 
          $escombo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['escombo_cond']; 
          $stockmen = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['stockmen']; 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-codigobar" id="id_ac_codigobar" name="codigobar_autocomp"><?php if ('' !=  $codigobar) { ?><option value="<?php echo $codigobar ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_nompro_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['nompro'])) ? $this->New_label['nompro'] : "Producto"; ?></TD>
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-nompro" id="id_ac_nompro" name="nompro_autocomp"><?php if ('' !=  $nompro) { ?><option value="<?php echo $nompro ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_idgrup_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idgrup'])) ? $this->New_label['idgrup'] : "Grupo/Familia"; ?></TD>
      
      <INPUT type="hidden" id="SC_idgrup_cond" name="idgrup_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idgrup" <?php echo $str_hide_idgrup?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idgrup" name="idgrup_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idpro1_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idpro1'])) ? $this->New_label['idpro1'] : "Proveedor 1"; ?></TD>
      
      <INPUT type="hidden" id="SC_idpro1_cond" name="idpro1_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idpro1" <?php echo $str_hide_idpro1?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_idpro1" name="idpro1_autocomp" size="70"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 70, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idpro2_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idpro2'])) ? $this->New_label['idpro2'] : "Proveedor 2"; ?></TD>
      
      <INPUT type="hidden" id="SC_idpro2_cond" name="idpro2_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idpro2" <?php echo $str_hide_idpro2?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_idpro2" name="idpro2_autocomp" size="50"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_idiva_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idiva'])) ? $this->New_label['idiva'] : "Impuesto"; ?></TD>
      
      <INPUT type="hidden" id="SC_idiva_cond" name="idiva_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idiva" <?php echo $str_hide_idiva?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['psq_check_ret']['idiva'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['psq_check_ret']['idiva'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD id='SC_escombo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['escombo'])) ? $this->New_label['escombo'] : "Combo"; ?></TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['psq_check_ret']['escombo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['psq_check_ret']['escombo'][] = "SI";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['psq_check_ret']['escombo'][] = "NO";
 ?>
...
<TR>
  <TD class="scFilterFieldFontOdd"><input class="scFilterObjectOdd" type=radio id="SC_escombo" name="escombo" value="NO##@@NO"  <?php if ("NO" == $escombo)  { echo " checked" ;} ?>>NO</TD>
      ...
      <TD id='SC_stockmen_label' class="scFilterLabelEven css_stockmen_fil_label"><?php echo (isset($this->New_label['stockmen'])) ? $this->New_label['stockmen'] : "Stock"; ?></TD>
     <TD class="scFilterFieldEven css_stockmen_fil_line"> 
      <SELECT class="scFilterObjectEven css_stockmen_fil_obj" id="SC_stockmen_cond" name="stockmen_cond" onChange="nm_campos_between(document.getElementById('id_vis_stockmen'), this, 'stockmen')">
     ...
     <TD  class="scFilterFieldEven css_stockmen_fil_line">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_stockmen" <?php echo $str_hide_stockmen?> valign="top">
        <TD class="scFilterFieldFontEven css_stockmen_fil_line">
           <?php
...
$style_cond_in = ($stockmen_cond != "in") ? " style=\"display: none;\"" : ""; 
?>
<INPUT  type="text" id="SC_stockmen_IN" name="stockmen_IN" value="<?php echo NM_encode_input($stockmen_IN) ?>" size=10 alt="{datatype: 'text', maxLength: 10, allowedChars: '0123456789,', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven css_stockmen_fil_obj"<?php echo $style_cond_in ?>>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_stockmen"  <?php echo $str_display_stockmen; ?> class="scFilterFieldFontEven css_stockmen_fil_line">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_stockmen_input_2" name="stockmen_input_2" value="<?php echo NM_encode_input($stockmen_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven css_stockmen_fil_obj">
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_productos";
   ...
   function trata_campos()
   {
      ...
      if (is_array($idiva)) {
          foreach ($idiva as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['psq_check_ret']['idiva'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['psq_check_ret']['escombo'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['codigobar'] = $codigobar; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['codigobar_cond'] = $codigobar_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['nompro'] = $nompro; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['nompro_cond'] = $nompro_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idgrup'] = $idgrup; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idgrup_cond'] = $idgrup_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idpro1'] = $idpro1; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idpro1_cond'] = $idpro1_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idpro2'] = $idpro2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idpro2_cond'] = $idpro2_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idiva'] = $idiva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idiva_cond'] = $idiva_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['escombo'] = $escombo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['escombo_cond'] = $escombo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['stockmen'] = $stockmen; 
   ...
   { 
      ...
      $this->cmp_formatado['idiva'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['campos_busca']['idiva'];
   ...
   { 
      ...
      if (is_array($idiva) && count($idiva) != 0)
      {
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['cond_pesq'] .= $nmgp_tab_label['idiva'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
