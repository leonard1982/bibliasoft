...
class grid_productos_total
{
   ...
   //---- 
   function quebra_geral_familia($res_limit=false)
   {
      global $nada, $nm_lang , $idgrup, $idiva;
      ...
      { 
          $nm_comando = "select count(*) from (SELECT      idprod,     codigobar,     nompro,     unimay,     unimen,     costomay,     costomen,     recmayamen,     preciofull,     preciomen,     stockmay,     stockmen,     idgrup,     idpro1,     idpro2,     idiva,     otro,     otro2,     imagenprod,     escombo,     unidmaymen,     if(maneja_tcs_lfs='LFS',if(unidmaymen='SI',coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)*recmayamen,coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)),(if(unidmaymen='SI',(stockmen*recmayamen),stockmen))) as existencia_menor,    preciomen2,    preciomen3,    precio2,    preciomay,    imagen,    ubicacion FROM      productos ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*) from (SELECT      idprod,     codigobar,     nompro,     unimay,     unimen,     costomay,     costomen,     recmayamen,     preciofull,     preciomen,     stockmay,     stockmen,     idgrup,     idpro1,     idpro2,     idiva,     otro,     otro2,     imagenprod,     escombo,     unidmaymen,     if(maneja_tcs_lfs='LFS',if(unidmaymen='SI',coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)*recmayamen,coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)),(if(unidmaymen='SI',(stockmen*recmayamen),stockmen))) as existencia_menor,    preciomen2,    preciomen3,    precio2,    preciomay,    imagen,    ubicacion FROM      productos ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq']; 
      ...
      if ($rt->fields[0] == 0)
      { 
          if (!isset($Contrl_Interat) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_filtro']) && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq_fast']) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search']))
          {
              $Contrl_Interat = 1;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq']       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_sem_interativ'];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['interativ_search'] = array();
              $this->quebra_geral_familia();
          }
   ...
   function quebra_geral_sc_free_group_by($res_limit=false)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(existencia_menor) from (SELECT      idprod,     codigobar,     nompro,     unimay,     unimen,     costomay,     costomen,     recmayamen,     preciofull,     preciomen,     stockmay,     stockmen,     idgrup,     idpro1,     idpro2,     idiva,     otro,     otro2,     imagenprod,     escombo,     unidmaymen,     if(maneja_tcs_lfs='LFS',if(unidmaymen='SI',coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)*recmayamen,coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)),(if(unidmaymen='SI',(stockmen*recmayamen),stockmen))) as existencia_menor,    preciomen2,    preciomen3,    precio2,    preciomay,    imagen,    ubicacion FROM      productos ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*), sum(existencia_menor) from (SELECT      idprod,     codigobar,     nompro,     unimay,     unimen,     costomay,     costomen,     recmayamen,     preciofull,     preciomen,     stockmay,     stockmen,     idgrup,     idpro1,     idpro2,     idiva,     otro,     otro2,     imagenprod,     escombo,     unidmaymen,     if(maneja_tcs_lfs='LFS',if(unidmaymen='SI',coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)*recmayamen,coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)),(if(unidmaymen='SI',(stockmen*recmayamen),stockmen))) as existencia_menor,    preciomen2,    preciomen3,    precio2,    preciomay,    imagen,    ubicacion FROM      productos ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['tot_geral'][2] = $rt->fields[1]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['contr_total_geral'] = "OK";
   } 
   ...
   //-----  codigobar
   function quebra_codigobar_sc_free_group_by($codigobar, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idgrup, $idiva;
      $tot_codigobar = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_comando = "select count(*), sum(existencia_menor) from (SELECT      idprod,     codigobar,     nompro,     unimay,     unimen,     costomay,     costomen,     recmayamen,     preciofull,     preciomen,     stockmay,     stockmen,     idgrup,     idpro1,     idpro2,     idiva,     otro,     otro2,     imagenprod,     escombo,     unidmaymen,     if(maneja_tcs_lfs='LFS',if(unidmaymen='SI',coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)*recmayamen,coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)),(if(unidmaymen='SI',(stockmen*recmayamen),stockmen))) as existencia_menor,    preciomen2,    preciomen3,    precio2,    preciomay,    imagen,    ubicacion FROM      productos ) nm_sel_esp " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['where_pesq']; 
      ...
      $tot_codigobar[0] = sc_strip_script($codigobar) ; 
      $tot_codigobar[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_codigobar[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_codigobar;
   } 

   //-----  nompro
   function quebra_nompro_sc_free_group_by($nompro, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idgrup, $idiva;
      $tot_nompro = array() ;  
      ...
      $tot_nompro[0] = sc_strip_script($nompro) ; 
      $tot_nompro[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_nompro[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_nompro;
   } 

   //-----  unimay
   function quebra_unimay_sc_free_group_by($unimay, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idgrup, $idiva;
      $tot_unimay = array() ;  
      ...
      $tot_unimay[0] = sc_strip_script($unimay) ; 
      $tot_unimay[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_unimay[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_unimay;
   } 

   //-----  unimen
   function quebra_unimen_sc_free_group_by($unimen, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idgrup, $idiva;
      $tot_unimen = array() ;  
      ...
      $tot_unimen[0] = sc_strip_script($unimen) ; 
      $tot_unimen[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_unimen[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_unimen;
   } 

   //-----  idgrup
   function quebra_idgrup_sc_free_group_by($idgrup, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idgrup, $idiva;
      $tot_idgrup = array() ;  
      ...
      $tot_idgrup[0] = NM_encode_input(sc_strip_script($idgrup)) ; 
      $tot_idgrup[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_idgrup[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_idgrup;
   } 

   //-----  idpro1
   function quebra_idpro1_sc_free_group_by($idpro1, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idgrup, $idiva;
      $tot_idpro1 = array() ;  
      ...
      $tot_idpro1[0] = sc_strip_script($idpro1) ; 
      $tot_idpro1[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_idpro1[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_idpro1;
   } 

   //-----  idiva
   function quebra_idiva_sc_free_group_by($idiva, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idgrup, $idiva;
      $tot_idiva = array() ;  
      ...
      $tot_idiva[0] = NM_encode_input(sc_strip_script($idiva)) ; 
      $tot_idiva[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_idiva[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_idiva;
   } 

   //-----  escombo
   function quebra_escombo_sc_free_group_by($escombo, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $idgrup, $idiva;
      $tot_escombo = array() ;  
      ...
      $tot_escombo[0] = sc_strip_script($escombo) ; 
      $tot_escombo[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_escombo[2] = (string)$rt->fields[1]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_escombo;
   } 
   ...
   function Calc_resumo_sc_free_group_by($destino_resumo)
   {
      ...
      $cmp_sql_def   = array('codigobar' => "codigobar",'nompro' => "nompro",'unimay' => "unimay",'unimen' => "unimen",'idgrup' => "idgrup",'idpro1' => "idpro1",'idiva' => "idiva",'escombo' => "escombo");
      $cmps_quebra_atual = array();
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['SC_Gb_Free_cmp'] as $cmp => $resto)
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['arr_total'] = array();
      foreach ($cmps_quebra_atual as $cmp_gb)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['arr_total'][$cmp_gb] = $this->$Arr_tot_name;
      }
   }
   ...
   function Res_Totaliza_sc_free_group_by($ind_qb, $cmp_tot, $arr_tots, $group, $join, $cmps_quebras, $cmps_quebras1, $cmps_quebras2, $cmps_quebrasS, $Cmp_dim, $cmps_quebra_atual, $cmp_sql_def)
   {
      ...
      $cmp_sql_tp_num = array('idprod' => 'N','costomay' => 'N','costomen' => 'N','recmayamen' => 'N','preciofull' => 'N','preciomen' => 'N','stockmay' => 'N','stockmen' => 'N','idgrup' => 'N','idpro1' => 'N','idpro2' => 'N','idiva' => 'N','otro' => 'N','otro2' => 'N','existencia_menor' => 'N','preciomen2' => 'N','preciomen3' => 'N','precio2' => 'N','preciomay' => 'N');
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
         $cmd_simp = "select count(*), sum(existencia_menor)#@#cmps_quebras#@# from (SELECT      idprod,     codigobar,     nompro,     unimay,     unimen,     costomay,     costomen,     recmayamen,     preciofull,     preciomen,     stockmay,     stockmen,     idgrup,     idpro1,     idpro2,     idiva,     otro,     otro2,     imagenprod,     escombo,     unidmaymen,     if(maneja_tcs_lfs='LFS',if(unidmaymen='SI',coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)*recmayamen,coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)),(if(unidmaymen='SI',(stockmen*recmayamen),stockmen))) as existencia_menor,    preciomen2,    preciomen3,    precio2,    preciomay,    imagen,    ubicacion FROM      productos ) sc_sel_esp " . $where_ok;
         $comando  = "select count(*), sum(SC_metric1)#@#cmps_quebras#@# from (";
         $comando .= "select existencia_menor as SC_metric1, " . $cmps_quebras1 . " from (SELECT      idprod,     codigobar,     nompro,     unimay,     unimen,     costomay,     costomen,     recmayamen,     preciofull,     preciomen,     stockmay,     stockmen,     idgrup,     idpro1,     idpro2,     idiva,     otro,     otro2,     imagenprod,     escombo,     unidmaymen,     if(maneja_tcs_lfs='LFS',if(unidmaymen='SI',coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)*recmayamen,coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)),(if(unidmaymen='SI',(stockmen*recmayamen),stockmen))) as existencia_menor,    preciomen2,    preciomen3,    precio2,    preciomay,    imagen,    ubicacion FROM      productos ) sc_sel_esp1 " . $where_ok . ") SC_sel1 INNER JOIN (";
         $comando .= "select " . $cmps_quebras2 . " from (SELECT      idprod,     codigobar,     nompro,     unimay,     unimen,     costomay,     costomen,     recmayamen,     preciofull,     preciomen,     stockmay,     stockmen,     idgrup,     idpro1,     idpro2,     idiva,     otro,     otro2,     imagenprod,     escombo,     unidmaymen,     if(maneja_tcs_lfs='LFS',if(unidmaymen='SI',coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)*recmayamen,coalesce((select sum(vl.existencia) from vencimiento_lote vl where vl.idproducto=idprod),0)),(if(unidmaymen='SI',(stockmen*recmayamen),stockmen))) as existencia_menor,    preciomen2,    preciomen3,    precio2,    preciomay,    imagen,    ubicacion FROM      productos ) sc_sel_esp2 " . $where_ok . " group by " . $group . $sc_having . ") SC_sel2 ";
         $comando .= " ON " . $join;
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['sql_tot_res']))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['sql_tot_res'] = str_replace("#@#cmps_quebras#@#", "", $comando);
      }
      $comando  = str_replace("#@#cmps_quebras#@#", "," . $cmps_quebras, $comando);
      $comando .= " group by " . $cmps_quebras . " order by " .  $cmps_quebras;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['Res_search_metric_use']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos']['Res_search_metric_use']))
      {
          $comando = $cmd_simp;
          $cmps_S  = "";
      ...
      $format_dimensions['codigobar']['reg'] = "S";
      $format_dimensions['codigobar']['msk'] = "";
      $format_dimensions['nompro']['reg'] = "S";
      $format_dimensions['nompro']['msk'] = "";
      $format_dimensions['unimay']['reg'] = "S";
      $format_dimensions['unimay']['msk'] = "";
      $format_dimensions['unimen']['reg'] = "S";
      $format_dimensions['unimen']['msk'] = "";
      $format_dimensions['idgrup']['reg'] = "S";
      $format_dimensions['idgrup']['msk'] = "";
      $format_dimensions['idpro1']['reg'] = "S";
      $format_dimensions['idpro1']['msk'] = "";
      $format_dimensions['idiva']['reg'] = "S";
      $format_dimensions['idiva']['msk'] = "";
      $format_dimensions['escombo']['reg'] = "S";
      $format_dimensions['escombo']['msk'] = "";
      while (!$rt->EOF)
      {
          $sql_where = "";
          foreach ($Cmp_dim as $Cada_dim => $Ind_sql)
          {
              ...
              if ($Cada_dim == "idgrup") {
                  $this->Lookup->lookup_sc_free_group_by_idgrup($$Cada_dim,  $idgrup);
              }
              if ($Cada_dim == "idpro1") {
                  $this->Lookup->lookup_sc_free_group_by_idpro1($$Cada_dim);
              }
              if ($Cada_dim == "idiva") {
                  $this->Lookup->lookup_sc_free_group_by_idiva($$Cada_dim,  $idiva);
              }
              if ($Cada_dim == "escombo") {
              }
              if (null === $$Cada_dim)
