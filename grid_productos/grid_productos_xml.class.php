...
class grid_productos_xml
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_productos/grid_productos_res_xml.class.php"))
      {
          $this->Tem_xml_res  = false;
      }
...
$_SESSION['scriptcase']['grid_productos']['contr_erro'] = 'off'; 
   ...
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->combo))
         {
             $this->combo = sc_convert_encoding($this->combo, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         if ($this->Xml_tag_label)
         {
         ...
         if ($this->New_Format)
         {
             $this->xml_registro .= " <" . $SC_Label . ">" . $this->trata_dados($this->combo) . "</" . $SC_Label . ">\r\n";
         }
         else
         {
             $this->xml_registro .= " " . $SC_Label . " =\"" . $this->trata_dados($this->combo) . "\"";
         }
   }
   //----- agregarnotainv
