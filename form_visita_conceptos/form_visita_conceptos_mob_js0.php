<form name="F2" method=post 
               action="form_visita_conceptos_mob.php" 
               target="_self"> 
<input type="hidden" name="id_visita_concepto" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_visita_concepto']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_visita_conceptos_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_visita_conceptos_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?>
    ...
    {
        do_ajax_form_visita_conceptos_mob_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_visita_conceptos_mob_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
