<?php
@session_start() ;
$_SESSION['scriptcase']['grid_asientos']['sc_process_barr'] = true;
require_once('../grid_asientos/index.php');
unset($_SESSION['scriptcase']['grid_asientos']['sc_process_barr']);
$ExportCtrl = new grid_asientos_export_control;
$ExportCtrl->Export_barr();

class grid_asientos_export_control
{
