<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalle_notainv']['sc_process_barr'] = true;
require_once('../grid_detalle_notainv/index.php');
unset($_SESSION['scriptcase']['grid_detalle_notainv']['sc_process_barr']);
$ExportCtrl = new grid_detalle_notainv_export_control;
$ExportCtrl->Export_barr();

class grid_detalle_notainv_export_control
{
