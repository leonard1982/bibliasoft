...
<?php
   ...
   $Ord_Cmp = new grid_detalle_notainv_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalle_notainv_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["idpro"] : "Producto";
   ...
   $tab_labels["presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["presentacion"] : "Und.";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["cantidad"] : "C. Conteo";
   $tab_ger_campos['existencia'] = "on";
   $tab_def_campos['existencia'] = "existencia";
   $tab_labels["existencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["existencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["existencia"] : "Exist. en Sist.";
   $tab_ger_campos['movi'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['movi'] = "movi";
   }
   else
   {
       $tab_def_campos['movi'] = "";
   }
   $tab_labels["movi"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["movi"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['labels']["movi"] : "Valor I/E";
   $tab_ger_campos['presentacion'] = "none";
   $tab_ger_campos['movi'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalle_notainv_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalle_notainv']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
