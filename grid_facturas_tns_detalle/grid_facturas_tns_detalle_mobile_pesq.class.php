...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "d_kardexid";$Nm_numeric[] = "d_canmat";$Nm_numeric[] = "d_preciovta";$Nm_numeric[] = "d_parcvta";$Nm_numeric[] = "d_porciva";$Nm_numeric[] = "d_descuento";$Nm_numeric[] = "d_kardexid";$Nm_numeric[] = "d_canmat";$Nm_numeric[] = "d_preciovta";$Nm_numeric[] = "d_parcvta";$Nm_numeric[] = "d_porciva";$Nm_numeric[] = "d_descuento";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_cant_cond" name="cant_cond" onChange="nm_campos_between(document.getElementById('id_vis_cant'), this, 'cant')">
      ...
      <br><span id="id_hide_cant"  <?php echo $str_hide_cant?>><?php
      if ($cant != "")
      {
      $cant_look = substr($this->Db->qstr($cant), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cant" id="id_ac_cant" name="cant_autocomp"><?php if ('' !=  $cant) { ?><option value="<?php echo $cant ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_cant"  <?php echo $str_display_cant; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_cant_input_2" name="cant_input_2" value="<?php echo NM_encode_input($cant_input_2) ?>"  size=18 alt="{datatype: 'text', maxLength: 18, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_d_kardexid_cond" name="d_kardexid_cond" onChange="nm_campos_between(document.getElementById('id_vis_d_kardexid'), this, 'd_kardexid')">
      ...
      <br><span id="id_hide_d_kardexid"  <?php echo $str_hide_d_kardexid?>><?php
      if ($d_kardexid != "")
      {
      $d_kardexid_look = substr($this->Db->qstr($d_kardexid), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-d_kardexid" id="id_ac_d_kardexid" name="d_kardexid_autocomp"><?php if ('' !=  $d_kardexid) { ?><option value="<?php echo $d_kardexid ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_d_kardexid"  <?php echo $str_display_d_kardexid; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_d_kardexid_input_2" name="d_kardexid_input_2" value="<?php echo NM_encode_input($d_kardexid_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_producto_cond" name="producto_cond" onChange="nm_campos_between(document.getElementById('id_vis_producto'), this, 'producto')">
      ...
      <br><span id="id_hide_producto"  <?php echo $str_hide_producto?>><?php
      if ($producto != "")
      {
      $producto_look = substr($this->Db->qstr($producto), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_bd_cond" name="bd_cond" onChange="nm_campos_between(document.getElementById('id_vis_bd'), this, 'bd')">
      ...
      <br><span id="id_hide_bd"  <?php echo $str_hide_bd?>><?php
      if ($bd != "")
      {
      $bd_look = substr($this->Db->qstr($bd), 1, -1); 
      $nmgp_def_dados = array(); 
