...
<?php
   ...
   $Ord_Cmp = new grid_facturas_tns_detalle_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturas_tns_detalle_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['producto'] = "M.CODIGO||' - '||M.DESCRIP";
   }
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["producto"] : "PRODUCTO";
   $tab_ger_campos['bd'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['bd'] = "bd";
   }
   else
   {
       $tab_def_campos['bd'] = "B.CODIGO";
   }
   $tab_labels["bd"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["bd"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["bd"] : "BD";
   $tab_ger_campos['cant'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['cant'] = "cant";
   }
   else
   {
       $tab_def_campos['cant'] = "D.CANMAT";
   }
   $tab_labels["cant"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["cant"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["cant"] : "CANTIDAD";
   ...
   {
       $tab_def_campos['precio'] = "D.PRECIOVTA";
   }
   $tab_labels["precio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["precio"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["precio"] : "PRECIO";
   ...
   {
       $tab_def_campos['total'] = "D.PARCVTA";
   }
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["total"] : "TOTAL";
   ...
   {
       $tab_def_campos['iva'] = "D.PORCIVA";
   }
   $tab_labels["iva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["iva"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["iva"] : "IVA";
   $tab_ger_campos['d_descuento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['d_descuento'] = "d_descuento";
   }
   else
   {
       $tab_def_campos['d_descuento'] = "D.DESCUENTO";
   }
   $tab_labels["d_descuento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["d_descuento"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['labels']["d_descuento"] : "DESCUENTO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturas_tns_detalle_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturas_tns_detalle']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
