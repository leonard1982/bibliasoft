...
class grid_facturas_tns_detalle_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_facturas_tns_detalle_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_facturas_tns_detalle_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_facturas_tns_detalle_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_cant')
      {
          $cant = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_cant($cant);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_d_kardexid')
      {
          $d_kardexid = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_d_kardexid($d_kardexid);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_producto')
      {
          $producto = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_producto($producto);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_bd')
      {
          $bd = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_bd($bd);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_cant($cant)
   {
      $cant = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $cant);
      $cant = str_replace($_SESSION['scriptcase']['reg_conf']['dec_num'], ".", $cant);
      $cant = substr($this->Db->qstr($cant), 1, -1);
            $cant_look = substr($this->Db->qstr($cant), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct D.CANMAT from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and   CAST (D.CANMAT AS TEXT)  like '%" . $cant . "%' order by D.CANMAT"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct D.CANMAT from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and   CAST (D.CANMAT AS VARCHAR)  like '%" . $cant . "%' order by D.CANMAT"; 
      }
      else
      {
          $nm_comando = "select distinct D.CANMAT from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and  D.CANMAT like '%" . $cant . "%' order by D.CANMAT"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_d_kardexid($d_kardexid)
   {
      $d_kardexid = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $d_kardexid);
      $d_kardexid = substr($this->Db->qstr($d_kardexid), 1, -1);
            $d_kardexid_look = substr($this->Db->qstr($d_kardexid), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct D.KARDEXID from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and   CAST (D.KARDEXID AS TEXT)  like '%" . $d_kardexid . "%' order by D.KARDEXID"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct D.KARDEXID from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and   CAST (D.KARDEXID AS VARCHAR)  like '%" . $d_kardexid . "%' order by D.KARDEXID"; 
      }
      else
      {
          $nm_comando = "select distinct D.KARDEXID from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and  D.KARDEXID like '%" . $d_kardexid . "%' order by D.KARDEXID"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_producto($producto)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct M.CODIGO||' - '||M.DESCRIP from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and  M.CODIGO||' - '||M.DESCRIP like '%" . $producto . "%' order by M.CODIGO||' - '||M.DESCRIP"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_bd($bd)
   {
      $bd = substr($this->Db->qstr($bd), 1, -1);
            $bd_look = substr($this->Db->qstr($bd), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct B.CODIGO from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and  B.CODIGO like '%" . $bd . "%' order by B.CODIGO"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "d_kardexid";$Nm_numeric[] = "d_canmat";$Nm_numeric[] = "d_preciovta";$Nm_numeric[] = "d_parcvta";$Nm_numeric[] = "d_porciva";$Nm_numeric[] = "d_descuento";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_facturas_tns_detalle/grid_facturas_tns_detalle_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_facturas_tns_detalle_ajax_search.js"></script>
 <script type="text/javascript" src="grid_facturas_tns_detalle_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_facturas_tns_detalle_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_facturas_tns_detalle']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_facturas_tns_detalle']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
if (count($this->nm_mens_alert) || count($this->Ini->nm_mens_alert)) {
   ...
   if (isset($this->nm_mens_alert) && !empty($this->nm_mens_alert))
   {
       foreach ($this->nm_mens_alert as $i_alert => $mensagem)
       {
           ...
           if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['ajax_nav'])
           { 
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_cant_cond#NMF#' + search_get_sel_txt('SC_cant_cond') + '@NMF@';
  str_out += 'SC_cant#NMF#' + search_get_text('SC_cant') + '@NMF@';
  str_out += 'id_ac_cant#NMF#' + search_get_title('select2-id_ac_cant-container') + '@NMF@';
  str_out += 'SC_cant_input_2#NMF#' + search_get_text('SC_cant_input_2') + '@NMF@';
  str_out += 'SC_d_kardexid_cond#NMF#' + search_get_sel_txt('SC_d_kardexid_cond') + '@NMF@';
  str_out += 'SC_d_kardexid#NMF#' + search_get_text('SC_d_kardexid') + '@NMF@';
  str_out += 'id_ac_d_kardexid#NMF#' + search_get_title('select2-id_ac_d_kardexid-container') + '@NMF@';
  str_out += 'SC_d_kardexid_input_2#NMF#' + search_get_text('SC_d_kardexid_input_2') + '@NMF@';
  str_out += 'SC_producto_cond#NMF#' + search_get_sel_txt('SC_producto_cond') + '@NMF@';
  str_out += 'SC_producto#NMF#' + search_get_text('SC_producto') + '@NMF@';
  str_out += 'id_ac_producto#NMF#' + search_get_title('select2-id_ac_producto-container') + '@NMF@';
  str_out += 'SC_bd_cond#NMF#' + search_get_sel_txt('SC_bd_cond') + '@NMF@';
  str_out += 'SC_bd#NMF#' + search_get_text('SC_bd') + '@NMF@';
  str_out += 'id_ac_bd#NMF#' + search_get_title('select2-id_ac_bd-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-producto").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_producto",
      max_itens: "10",
   ...
   $("#SC_producto").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-bd").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_bd",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_bd").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-cant").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_cant",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_cant").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-d_kardexid").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_d_kardexid",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_d_kardexid").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $cant_cond, $cant, $cant_input_2, $cant_autocomp,
             $d_kardexid_cond, $d_kardexid, $d_kardexid_input_2, $d_kardexid_autocomp,
             $producto_cond, $producto, $producto_autocomp,
             $bd_cond, $bd, $bd_autocomp,
             $nm_url_saida, $nm_apl_dependente, $nmgp_parms, $bprocessa, $nmgp_save_name, $NM_operador, $NM_filters, $nmgp_save_option, $NM_filters_del, $Script_BI;
      $Script_BI = "";
      $this->nmgp_botoes['clear'] = "on";
      $this->nmgp_botoes['save'] = "on";
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturas_tns_detalle']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_facturas_tns_detalle']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_facturas_tns_detalle']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_facturas_tns_detalle", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $cant = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['cant']; 
          $cant_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['cant_input_2']; 
          $cant_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['cant_cond']; 
          $d_kardexid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['d_kardexid']; 
          $d_kardexid_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['d_kardexid_input_2']; 
          $d_kardexid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['d_kardexid_cond']; 
          $producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['producto']; 
          $producto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['producto_cond']; 
          $bd = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['bd']; 
          $bd_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['bd_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['NM_operador']; 
      } 
      if (!isset($cant_cond) || empty($cant_cond))
      {
         $cant_cond = "gt";
      }
      if (!isset($d_kardexid_cond) || empty($d_kardexid_cond))
      {
         $d_kardexid_cond = "gt";
      }
      if (!isset($producto_cond) || empty($producto_cond))
      {
         $producto_cond = "qp";
      }
      if (!isset($bd_cond) || empty($bd_cond))
      {
         $bd_cond = "qp";
      }
      ...
      $str_hide_cant = (in_array($cant_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_d_kardexid = (in_array($d_kardexid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_producto = (in_array($producto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_bd = (in_array($bd_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_cant = ('bw' == $cant_cond) ? $display_aberto : $display_fechado;
      $str_display_d_kardexid = ('bw' == $d_kardexid_cond) ? $display_aberto : $display_fechado;
      $str_display_producto = ('bw' == $producto_cond) ? $display_aberto : $display_fechado;
      $str_display_bd = ('bw' == $bd_cond) ? $display_aberto : $display_fechado;

      if (!isset($cant) || $cant == "")
      {
          $cant = "";
      }
      if (isset($cant) && !empty($cant))
      {
         $tmp_pos = strpos($cant, "##@@");
         if ($tmp_pos === false)
         { }
         ...
         {
         $cant = substr($cant, 0, $tmp_pos);
         }
      }
      if (!isset($d_kardexid) || $d_kardexid == "")
      {
          $d_kardexid = "";
      }
      if (isset($d_kardexid) && !empty($d_kardexid))
      {
         $tmp_pos = strpos($d_kardexid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $d_kardexid = substr($d_kardexid, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_cant_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['cant'])) ? $this->New_label['cant'] : "CANTIDAD"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_cant_cond" name="cant_cond" onChange="nm_campos_between(document.getElementById('id_vis_cant'), this, 'cant')">
       <OPTION value="gt" <?php if ("gt" == $cant_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $cant_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $cant_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $cant_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_cant" <?php echo $str_hide_cant?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['cant'])) ? $this->New_label['cant'] : "CANTIDAD";
 $nmgp_tab_label .= "cant?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct D.CANMAT from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and D.CANMAT = $cant_look order by D.CANMAT"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct D.CANMAT from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and D.CANMAT = $cant_look order by D.CANMAT"; 
      ...
      if (isset($nmgp_def_dados[0][$cant]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$cant];
      }
      else
      {
              nmgp_Form_Num_Val($cant, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'], $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $cant;
      }
?>
<INPUT  type="text" id="SC_cant" name="cant" value="<?php echo NM_encode_input($cant) ?>" size=18 alt="{datatype: 'text', maxLength: 18, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-cant" id="id_ac_cant" name="cant_autocomp"><?php if ('' !=  $cant) { ?><option value="<?php echo $cant ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_cant"  <?php echo $str_display_cant; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_cant_input_2" name="cant_input_2" value="<?php echo NM_encode_input($cant_input_2) ?>"  size=18 alt="{datatype: 'text', maxLength: 18, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_d_kardexid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['d_kardexid'])) ? $this->New_label['d_kardexid'] : "KARDEXID"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_d_kardexid_cond" name="d_kardexid_cond" onChange="nm_campos_between(document.getElementById('id_vis_d_kardexid'), this, 'd_kardexid')">
       <OPTION value="gt" <?php if ("gt" == $d_kardexid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $d_kardexid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $d_kardexid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $d_kardexid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_d_kardexid" <?php echo $str_hide_d_kardexid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['d_kardexid'])) ? $this->New_label['d_kardexid'] : "KARDEXID";
 $nmgp_tab_label .= "d_kardexid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $d_kardexid_look = substr($this->Db->qstr($d_kardexid), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($d_kardexid))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct D.KARDEXID from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and D.KARDEXID = $d_kardexid_look order by D.KARDEXID"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct D.KARDEXID from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and D.KARDEXID = $d_kardexid_look order by D.KARDEXID"; 
      ...
      if (isset($nmgp_def_dados[0][$d_kardexid]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$d_kardexid];
      }
      else
      {
            nmgp_Form_Num_Val($d_kardexid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $d_kardexid;
      }
?>
<INPUT  type="text" id="SC_d_kardexid" name="d_kardexid" value="<?php echo NM_encode_input($d_kardexid) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-d_kardexid" id="id_ac_d_kardexid" name="d_kardexid_autocomp"><?php if ('' !=  $d_kardexid) { ?><option value="<?php echo $d_kardexid ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_d_kardexid"  <?php echo $str_display_d_kardexid; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_d_kardexid_input_2" name="d_kardexid_input_2" value="<?php echo NM_encode_input($d_kardexid_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_producto_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['producto'])) ? $this->New_label['producto'] : "PRODUCTO"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_producto_cond" name="producto_cond" onChange="nm_campos_between(document.getElementById('id_vis_producto'), this, 'producto')">
       <OPTION value="qp" <?php if ("qp" == $producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_producto" <?php echo $str_hide_producto?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['producto'])) ? $this->New_label['producto'] : "PRODUCTO";
 $nmgp_tab_label .= "producto?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $producto_look = substr($this->Db->qstr($producto), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct M.CODIGO||' - '||M.DESCRIP from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and M.CODIGO||' - '||M.DESCRIP = '$producto_look' order by M.CODIGO||' - '||M.DESCRIP"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      {
          $sAutocompValue = $producto;
      }
?>
<INPUT  type="text" id="SC_producto" name="producto" value="<?php echo NM_encode_input($producto) ?>"  size=50 alt="{datatype: 'text', maxLength: 278, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-producto" id="id_ac_producto" name="producto_autocomp"><?php if ('' !=  $producto) { ?><option value="<?php echo $producto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_bd_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['bd'])) ? $this->New_label['bd'] : "BD"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_bd_cond" name="bd_cond" onChange="nm_campos_between(document.getElementById('id_vis_bd'), this, 'bd')">
       <OPTION value="qp" <?php if ("qp" == $bd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $bd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $bd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $bd_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_bd" <?php echo $str_hide_bd?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['bd'])) ? $this->New_label['bd'] : "BD";
 $nmgp_tab_label .= "bd?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $bd_look = substr($this->Db->qstr($bd), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct B.CODIGO from " . $this->Ini->nm_tabela . " where D.KARDEXID='" . $_SESSION['gkardexid'] . "' and B.CODIGO = '$bd_look' order by B.CODIGO"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$bd]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$bd];
      }
      else
      {
          $sAutocompValue = $bd;
...
?>
<INPUT  type="text" id="SC_bd" name="bd" value="<?php echo NM_encode_input($bd) ?>"  size=6 alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-bd" id="id_ac_bd" name="bd_autocomp"><?php if ('' !=  $bd) { ?><option value="<?php echo $bd ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
?>
<?php
   if (is_file("grid_facturas_tns_detalle_help.txt"))
   {
      $Arq_WebHelp = file("grid_facturas_tns_detalle_help.txt"); 
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturas_tns_detalle']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_facturas_tns_detalle']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturas_tns_detalle']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_facturas_tns_detalle']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.cant_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_cant'), document.F1.cant_cond, 'cant');
   document.F1.cant.value = "";
   document.F1.cant_autocomp.value = "";
   $('#select2-id_ac_cant-container').html('<?php echo $this->Val_init_cant['desc'] ?>');;
   document.F1.cant_input_2.value = "";
   document.F1.d_kardexid_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_d_kardexid'), document.F1.d_kardexid_cond, 'd_kardexid');
   document.F1.d_kardexid.value = "";
   document.F1.d_kardexid_autocomp.value = "";
   $('#select2-id_ac_d_kardexid-container').html('<?php echo $this->Val_init_d_kardexid['desc'] ?>');;
   document.F1.d_kardexid_input_2.value = "";
   document.F1.producto_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_producto'), document.F1.producto_cond, 'producto');
   document.F1.producto.value = "";
   document.F1.producto_autocomp.value = "";
   $('#select2-id_ac_producto-container').html('<?php echo $this->Val_init_producto['desc'] ?>');;
   document.F1.bd_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_bd'), document.F1.bd_cond, 'bd');
   document.F1.bd.value = "";
   document.F1.bd_autocomp.value = "";
   $('#select2-id_ac_bd-container').html('<?php echo $this->Val_init_bd['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEB_V2/grid_facturas_tns_detalle";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_facturas_tns_detalle/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_cant_cond'] = 'cond';
      $tp_fields['SC_cant'] = 'text_aut';
      $tp_fields['id_ac_cant'] = 'select2_aut';
      $tp_fields['SC_cant_input_2'] = 'text';
      $tp_fields['SC_d_kardexid_cond'] = 'cond';
      $tp_fields['SC_d_kardexid'] = 'text_aut';
      $tp_fields['id_ac_d_kardexid'] = 'select2_aut';
      $tp_fields['SC_d_kardexid_input_2'] = 'text';
      $tp_fields['SC_producto_cond'] = 'cond';
      $tp_fields['SC_producto'] = 'text_aut';
      $tp_fields['id_ac_producto'] = 'select2_aut';
      $tp_fields['SC_bd_cond'] = 'cond';
      $tp_fields['SC_bd'] = 'text_aut';
      $tp_fields['id_ac_bd'] = 'select2_aut';
   ...
   {
      global $cant_cond, $cant, $cant_input_2, $cant_autocomp,
             $d_kardexid_cond, $d_kardexid, $d_kardexid_input_2, $d_kardexid_autocomp,
             $producto_cond, $producto, $producto_autocomp,
             $bd_cond, $bd, $bd_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($cant_autocomp) && empty($cant))
      {
          $cant = $cant_autocomp;
      }
      if (!empty($d_kardexid_autocomp) && empty($d_kardexid))
      {
          $d_kardexid = $d_kardexid_autocomp;
      }
      if (!empty($producto_autocomp) && empty($producto))
      {
          $producto = $producto_autocomp;
      }
      if (!empty($bd_autocomp) && empty($bd))
      {
          $bd = $bd_autocomp;
      }
      $cant_cond_salva = $cant_cond; 
      if (!isset($cant_input_2) || $cant_input_2 == "")
      {
          $cant_input_2 = $cant;
      }
      $d_kardexid_cond_salva = $d_kardexid_cond; 
      if (!isset($d_kardexid_input_2) || $d_kardexid_input_2 == "")
      {
          $d_kardexid_input_2 = $d_kardexid;
      }
      $producto_cond_salva = $producto_cond; 
      if (!isset($producto_input_2) || $producto_input_2 == "")
      {
          $producto_input_2 = $producto;
      }
      $bd_cond_salva = $bd_cond; 
      if (!isset($bd_input_2) || $bd_input_2 == "")
      {
          $bd_input_2 = $bd;
      }
      if ($cant_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($cant, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      if ($cant_cond != "in")
      {
          if ($C_formatado)
          {
              nm_limpa_valor($cant_input_2, $_SESSION['scriptcase']['reg_conf']['dec_num'], $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
          }
      }
      if ($d_kardexid_cond != "in")
      {
          nm_limpa_numero($d_kardexid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($d_kardexid_cond != "in")
      {
          nm_limpa_numero($d_kardexid_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['cant'] = $cant; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['cant_input_2'] = $cant_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['cant_cond'] = $cant_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['d_kardexid'] = $d_kardexid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['d_kardexid_input_2'] = $d_kardexid_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['d_kardexid_cond'] = $d_kardexid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['producto'] = $producto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['producto_cond'] = $producto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['bd'] = $bd; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['bd_cond'] = $bd_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca'] = $Temp_Busca;
      }
      if ($cant_cond != "in" && $cant_cond != "bw" && !empty($cant) && !is_numeric($cant))
      {
      ...
      if ($cant_cond == "bw" && ((!empty($cant) && !is_numeric($cant)) || (!empty($cant_input_2) && !is_numeric($cant_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : CANTIDAD";
      }
      if ($d_kardexid_cond != "in" && $d_kardexid_cond != "bw" && !empty($d_kardexid) && !is_numeric($d_kardexid))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : KARDEXID";
      }
      if ($d_kardexid_cond == "bw" && ((!empty($d_kardexid) && !is_numeric($d_kardexid)) || (!empty($d_kardexid_input_2) && !is_numeric($d_kardexid_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : KARDEXID";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      $Conteudo = $cant_input_2;
      if (strtoupper($cant_cond) != "II" && strtoupper($cant_cond) != "QP" && strtoupper($cant_cond) != "NP" && strtoupper($cant_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['cant_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($d_kardexid != '') {
      $d_kardexid_look = substr($this->Db->qstr($d_kardexid), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['d_kardexid'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['d_kardexid'] = $cmp1;
      }
      else
      {
          $cmp1 = $d_kardexid;
      ...
      $Conteudo = $d_kardexid_input_2;
      if (strtoupper($d_kardexid_cond) != "II" && strtoupper($d_kardexid_cond) != "QP" && strtoupper($d_kardexid_cond) != "NP" && strtoupper($d_kardexid_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['d_kardexid_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($producto != '') {
      $producto_look = substr($this->Db->qstr($producto), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['producto'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['producto'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['producto'] = $producto;
      }
      $nmgp_def_dados = array();
    if ($bd != '') {
      $bd_look = substr($this->Db->qstr($bd), 1, -1); 
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['bd'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['bd'] = $bd;
      }

      //----- $cant
      $this->Date_part = false;
      if (isset($cant) || $cant_cond == "nu" || $cant_cond == "nn" || $cant_cond == "ep" || $cant_cond == "ne")
      {
         $this->monta_condicao("D.CANMAT", $cant_cond, $cant, $cant_input_2, "cant");
      }

      //----- $d_kardexid
      $this->Date_part = false;
      if (isset($d_kardexid) || $d_kardexid_cond == "nu" || $d_kardexid_cond == "nn" || $d_kardexid_cond == "ep" || $d_kardexid_cond == "ne")
      {
         $this->monta_condicao("D.KARDEXID", $d_kardexid_cond, $d_kardexid, $d_kardexid_input_2, "d_kardexid");
      }

      //----- $producto
      $this->Date_part = false;
      if (isset($producto) || $producto_cond == "nu" || $producto_cond == "nn" || $producto_cond == "ep" || $producto_cond == "ne")
      {
         $this->monta_condicao("M.CODIGO||' - '||M.DESCRIP", $producto_cond, $producto, "", "producto");
      }

      //----- $bd
      $this->Date_part = false;
      if (isset($bd) || $bd_cond == "nu" || $bd_cond == "nn" || $bd_cond == "ep" || $bd_cond == "ne")
      {
         $this->monta_condicao("B.CODIGO", $bd_cond, $bd, "", "bd");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_facturas_tns_detalle']['where_pesq'];
