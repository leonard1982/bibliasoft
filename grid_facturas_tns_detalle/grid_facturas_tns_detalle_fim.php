...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_facturas_tns_detalle"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_facturas_tns_detalle"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_facturas_tns_detalle</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_facturas_tns_detalle']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_facturas_tns_detalle' || $achou)
          {
