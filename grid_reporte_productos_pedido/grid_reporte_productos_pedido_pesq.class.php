...
?>
<INPUT  type="text" id="SC_numero" name="numero" value="<?php echo NM_encode_input($numero) ?>"  size=50 alt="{datatype: 'text', maxLength: 93, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_fin_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fin'])) ? $this->New_label['fin'] : "Creado Fin"; ?></TD>
