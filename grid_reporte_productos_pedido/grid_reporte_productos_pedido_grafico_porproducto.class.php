...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['contr_label_graf']['producto']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['contr_label_graf']['producto']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['contr_label_graf']['producto'];
      }
   }
