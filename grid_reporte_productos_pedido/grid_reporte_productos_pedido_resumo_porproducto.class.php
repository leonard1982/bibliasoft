...
class grid_reporte_productos_pedido_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['arr_total']['producto'];
      }
      else
      {
          $this->array_total_producto = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_order']['porproducto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_order']['porproducto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_order']['porproducto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['porproducto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['porproducto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['porproducto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['porproducto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['porproducto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['porproducto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['porproducto'] as $i_sum => $d_sum)
           {
