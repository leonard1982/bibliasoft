...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reporte_productos_pedido"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_reporte_productos_pedido"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_productos_pedido']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_productos_pedido']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_productos_pedido']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_reporte_productos_pedido']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_reporte_productos_pedido']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_reporte_productos_pedido</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_reporte_productos_pedido']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_reporte_productos_pedido']['embutida_filho'] as $ind => $sc_init)
          {
