...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_reporte_productos_pedido"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_reporte_productos_pedido"]);
   }
