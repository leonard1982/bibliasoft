...
class grid_reporte_productos_pedido_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['arr_total']['fecha'] = $this->array_total_fecha;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['arr_total']['numero'] = $this->array_total_numero;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['arr_total']['cliente'] = $this->array_total_cliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['arr_total']['producto'] = $this->array_total_producto;
   ...
   function completeMatrix()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['labels']['fecha'] = $Lab_fecha; 
       $prep_field['numero'] = $Lab_numero;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['labels']['numero'] = $Lab_numero; 
       $prep_field['cliente'] = $Lab_cliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['labels']['cliente'] = $Lab_cliente; 
       $prep_field['producto'] = $Lab_producto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['labels']['producto'] = $Lab_producto; 
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['pivot_order_level'] = 0;
       }
   ...
   function buildChart()
   {
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
...
{ 
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_reporte_productos_pedido/grid_reporte_productos_pedido_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['SC_Gb_Free_cmp']))
      {
...
//--- 
   ...
   //---- 
   function adiciona_registro($sum_d_cantidad, $sum_costo_parcial, $sum_total, $quebra_fecha, $quebra_numero, $quebra_cliente, $quebra_producto, $quebra_grupo, $quebra_fecha_orig, $quebra_numero_orig, $quebra_cliente_orig, $quebra_producto_orig, $quebra_grupo_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_productos_pedido']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          if (empty($sum_costo_parcial)) {$sum_costo_parcial = '0';}
          ...
          if (!isset($this->' . $arr_name . '))
          {
              ...
              $this->' . $arr_name . '[2] = ' . $sum_costo_parcial . ';
              $this->' . $arr_name . '[3] = ' . $sum_total . ';
              $this->' . $arr_name . '[4] = 1;
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->d_cantidad, $this->costo_parcial, $this->total, $this->fecha, $this->numero, $this->cliente, $this->producto, $this->grupo, $this->fecha_orig,  $this->numero_orig,  $this->cliente_orig,  $this->producto_orig,  $this->grupo_orig);
            }
   }
//
