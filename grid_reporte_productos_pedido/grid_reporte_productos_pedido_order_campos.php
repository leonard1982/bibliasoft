...
<?php
   ...
   $Ord_Cmp = new grid_reporte_productos_pedido_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_reporte_productos_pedido_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["fecha"] : "Fecha";
   ...
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["numero"] : "Numero";
   ...
   $tab_labels["cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["cliente"] : "Cliente";
   ...
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["producto"] : "Producto";
   ...
   $tab_labels["d_cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["d_cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["d_cantidad"] : "Cantidad";
   ...
   $tab_labels["costo_parcial"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["costo_parcial"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["costo_parcial"] : "Costo Parcial";
   ...
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["total"] : "Total";
   ...
   $tab_labels["inicio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["inicio"])) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['labels']["inicio"] : "Creado";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_reporte_productos_pedido_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_reporte_productos_pedido']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
