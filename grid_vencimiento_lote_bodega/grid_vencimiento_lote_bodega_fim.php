...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_vencimiento_lote_bodega"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_vencimiento_lote_bodega"]);
   }
