<?php
@session_start() ;
$_SESSION['scriptcase']['grid_vencimiento_lote_bodega']['sc_process_barr'] = true;
require_once('../grid_vencimiento_lote_bodega/index.php');
unset($_SESSION['scriptcase']['grid_vencimiento_lote_bodega']['sc_process_barr']);
$ExportCtrl = new grid_vencimiento_lote_bodega_export_control;
$ExportCtrl->Export_barr();

class grid_vencimiento_lote_bodega_export_control
{
   function Export_barr()
   {
      ...
      $this->path_prod      = $_SESSION['scriptcase']['grid_vencimiento_lote_bodega']['glo_nm_path_prod'];
      $this->path_imag_temp = $_SESSION['scriptcase']['grid_vencimiento_lote_bodega']['glo_nm_path_imag_temp'];
...
<HEAD>
 <TITLE>Existencia por Fecha de Vencimiento y/o Lote</TITLE>
