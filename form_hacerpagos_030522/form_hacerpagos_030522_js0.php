<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idpago" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idpago']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_030522']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_hacerpagos_030522"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_030522']['where_detal']))
  {
?>  
...
function sc_ncuenta_tercero_onchange()
{
   if($.isEmptyObject(document.getElementById('id_sc_field_ncuenta_tercero').value))
{
   document.getElementById('cap_docapagar').style.display = 'inline-block';
}
else
{
   document.getElementById('cap_docapagar').style.display = 'none';
}

}
function sc_docapagar_onchange()
{
   if($.isEmptyObject(document.getElementById('id_sc_field_ncuenta_tercero').value) &&  !$.isEmptyObject(document.getElementById('id_sc_field_docapagar').value))
{
   document.getElementById('id_sc_field_ncuenta_tercero').style.display = 'none';
document.getElementById('cap_ncuenta_tercero').style.display = 'none';
}
else
{
   document.getElementById('id_sc_field_ncuenta_tercero').style.display = 'inline-block';
   document.getElementById('cap_ncuenta_tercero').style.display = 'inline-block';
}
}
function sc_asent_onchange()
{
   nm_atualiza ('alterar');
}
...
{
   nm_field_disabled("asent=disabled", "I");
...
{
    document.getElementById('form_hacerpagos_030522_form0').style.width='1px';
    document.getElementById('form_hacerpagos_030522_form0').style.height='0px';
    document.getElementById('form_hacerpagos_030522_form0').style.display='none';
    document.getElementById('form_hacerpagos_030522_form0').style.overflow='scroll';
    document.getElementById('form_hacerpagos_030522_form1').style.width='1px';
    document.getElementById('form_hacerpagos_030522_form1').style.height='0px';
    document.getElementById('form_hacerpagos_030522_form1').style.display='none';
    document.getElementById('form_hacerpagos_030522_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_hacerpagos_030522']['pdf_view']) {
?>
...
?>
    ...
    displayChange_page(pag_ativa.substr(27), 'off');
    pag_ativa = N_pagina;
    sc_tab_pag(pag_ativa, 'scTabActive');
    displayChange_page(pag_ativa.substr(27), 'on');
   if ("form_hacerpagos_030522_form0" == N_pagina) {
   ...
   if ("form_hacerpagos_030522_form1" == N_pagina) {
