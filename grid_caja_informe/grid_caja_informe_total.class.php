...
class grid_caja_informe_total
{
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_caja_informe']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_caja_informe']['campos_busca']))
      { 
