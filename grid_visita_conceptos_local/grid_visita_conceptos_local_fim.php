...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_visita_conceptos_local"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_visita_conceptos_local"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_visita_conceptos'] = array();
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_visita_conceptos_local</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_visita_conceptos_local']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_visita_conceptos_local' || $achou)
          {
