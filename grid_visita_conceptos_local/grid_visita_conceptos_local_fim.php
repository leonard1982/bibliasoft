...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_visita_conceptos_local"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_visita_conceptos_local"]);
   }
