...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['contr_label_graf']['idcli']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['contr_label_graf']['idcli']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['contr_label_graf']['idcli'];
      }
   }
...
//
   function grafico_col($campo_grafico)
   {
     ...
     if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_lab']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_lab']))
     {
         $this->calcula_graf_col();
     }
     if ($campo_grafico == "total")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['using_column_chart'] = "total";
         $array_lab        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_lab']['total'];
         $array_val[" "] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_val']['total'];
         $this->Decimais = 2;
         $graf_lab  = "Cliente";
         $graf_val  = "Total";
         $pos = true;
     ...
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['using_column_chart'] = "saldo";
         $array_lab        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_lab']['saldo'];
         $array_val[" "] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_val']['saldo'];
         $this->Decimais = 2;
         $graf_lab  = "Cliente";
         $graf_val  = "Saldo";
         $pos = true;
...
//
   ...
   {
     $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_lab'] = array();
     $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_val'] = array();
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $this->sc_proc_grid = true;
// GROUP BY idcli
     $nmgp_select = "SELECT idcli, SUM(total) FROM ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp"; 
     ...
     {  
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_lab']['total'][] = trim($idcli); 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_val']['total'][] = $sum_total; 
         $rs_graf->MoveNext();
     }  
     $rs_graf->Close();
// GROUP BY idcli
     $nmgp_select = "SELECT idcli, SUM(saldo) FROM ((SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      facturaven WHERE     numfacven!=0  AND  saldo>0 ORDER BY fechavenc ASC) UNION (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3, resolucion FROM      remisiones WHERE     saldo>0 AND credito = 1 ORDER BY fechavenc ASC) ) nm_sel_esp"; 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_pesq']; 
     $nmgp_select .= " GROUP BY idcli"; 
     $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
     $rs_graf = $this->Db->Execute($nmgp_select) ; 
     ...
     {  
         ...
         $this->Lookup->lookup_idcli($idcli, $idcli); 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_lab']['saldo'][] = trim($idcli); 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_val']['saldo'][] = $sum_saldo; 
         $rs_graf->MoveNext();
     }  
     $rs_graf->Close();
   }
...
<?php
   ...
   {
       $sChartTheme = '';
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['using_column_chart']) && "total" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['using_column_chart'])
       {
       $sChartTheme = 'scriptcase__NM__sc_Clean.php';
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['using_column_chart']);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['using_column_chart']) && "saldo" == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['using_column_chart'])
       {
       $sChartTheme = 'scriptcase__NM__sc_Clean.php';
           unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['using_column_chart']);
       }
   ...
   function grafico_flash_xml($arr_param, $arr_series, $newline = "\r\n")
   {
       ...
       $sShowValues = " showValues=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_exibe_val'] . "\"";

       $bDisableLinks = false;
       if ($is_combinat)
       {
           if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['chart_combination_type'], array('angulargauge', 'msstepline', 'stackedarea', 'stackedbar2d', 'stackedbar3d', 'stackedcolumn2d', 'stackedcolumn3d')))
           {
               $bDisableLinks = true;
           }
       ...
       if ($chart_theme)
       {
           ...
           if ($chart_theme['css_chart_font_size'] && '' != $chart_theme['css_chart_font_size'] && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['parms_graf']['graf_font']))
           {
       ...
       {
           $chart_attr[] = "baseFontSize=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['parms_graf']['graf_font'] . "\"";
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['parms_graf']['chartpallet']) && false == $chart_theme)
       {
           $chart_attr[] = "palette=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['parms_graf']['chartpallet'] . "\"";
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['parms_graf']['graf_subtitle_val']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['parms_graf']['graf_subtitle_val'] == 'right')
       {
           $chart_attr[] = "legendPosition=\"RIGHT\"";
       }
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_subtitle_val']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['graf_subtitle_val'] == 'right')
       {
           $chart_attr[] = "legendPosition=\"RIGHT\"";
       }
       ...
       {
           $s_xml .= " paletteColors=\"" . $this->getColorList($arr_series, $_SESSION["sc_session"][$this->Ini->sc_page]["grid_cartera"]["parms_graf"]["paletteColors"]) . "\"";
       }
       ...
       elseif (1 < sizeof($arr_series) || 'Radar' == $tipo || 'Step' == $arr_param['linha_forma'] || $is_combinat)
       {
           ...
           foreach ($arr_series as $arr_serie)
           {
               ...
               if ($is_combinat)
               {
                   ...
                   {
                       $readeras = " renderas=\"" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['comb_field_display_type'][ ($arr_serie['summ_idx'] + 1) ] . "\"";
                   }
...
<?php
   ...
   function grafico_flash_chart($width, $height, $sFileLocal, $export, $arr_charts, $isPDF = 'N')
   {
      ...
      if ($_SESSION['scriptcase']['phantomjs_charts'] && "Y" == $isPDF)
      {
          ...
          $sPhantomCmd  = 'phantomjs "' . $this->Ini->root . $_SESSION['scriptcase']['grid_cartera']['glo_nm_path_imag_temp'] . '/sc_pjs_js_' . $sTmpId . '.js"';
          $iJsDelay     = 150;
          if ('win' != $aOS['os'])
          {
   ...
   {
       $fPhantomChart = @fopen($this->Ini->root . $_SESSION['scriptcase']['grid_cartera']['glo_nm_path_imag_temp'] . '/sc_pjs_php_' . $sTmpId . '.php', 'w');
   ...
   function getChartRenderer($bMulti, $bComb)
   {
       ...
       {
           $tmp_count = 0;
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['summarizing_fields_order'] as $i_sum)
           {
               if ('' != $i_sum && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['summarizing_fields_display'][$i_sum]))
               {
                   $d_sum = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['summarizing_fields_display'][$i_sum];
                   if ($d_sum['display'])
                   {
                       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['summarizing_fields_control'] as $l_field => $d_field)
                       {
