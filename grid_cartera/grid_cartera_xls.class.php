...
class grid_cartera_xls
{
   ...
   function monta_xls()
   {
      ...
      $this->grava_arquivo();
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida']) {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['opcao'] = "";
      }
   }
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          foreach ($todo as $param)
          {
               ...
               if (1 < sizeof($cadapar))
               {
                   ...
                   nm_limpa_str_grid_cartera($cadapar[1]);
                   nm_protect_num_grid_cartera($cadapar[0], $cadapar[1]);
                   if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                   $Tmp_par   = $cadapar[0];
                   $$Tmp_par = $cadapar[1];
                   if ($Tmp_par == "nmgp_opcao")
                   {
                       $_SESSION['sc_session'][$script_case_init]['grid_cartera']['opcao'] = $cadapar[1];
                   }
               }
          }
      }
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "_NM_SC_")
          {
              $this->Tem_xls_res  = false;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "sc_free_group_by" && empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Gb_Free_cmp']))
          {
              $this->Tem_xls_res  = false;
          }
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_cartera/grid_cartera_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_cartera_res_xls.class.php");
              $this->Res_xls = new grid_cartera_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_cartera.zip";
          $this->Arquivo   .= "_grid_cartera" . $this->Xls_tp;
          $this->Tit_doc    = "grid_cartera" . $this->Xls_tp;
          $this->Tit_zip    = "grid_cartera.zip";
      ...
      require_once($this->Ini->path_aplicacao . "grid_cartera_total.class.php"); 
      $this->Tot = new grid_cartera_total($this->Ini->sc_page);
      $this->prep_modulos("Tot");
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'];
      $this->Tot->$Gb_geral();
      $this->count_ger = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['tot_geral'][1];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "fechavencimiento")
      {
          $this->sum_saldo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['tot_geral'][2];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "cliente")
      {
          $this->sum_saldo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['tot_geral'][2];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "_NM_SC_")
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida'] && !$this->Ini->sc_export_ajax) {
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['grid_cartera']['glo_nm_path_imag_temp'] . "/");
          $this->pb->setProgressbarMd5($_GET['pbmd5']);
          $this->pb->initialize();
          $this->pb->setReturnUrl("./");
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cartera']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_cartera']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_cartera']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['usr_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['usr_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['usr_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['php_cmp_sel']))
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->NM_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
          }
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['field_order'] as $Cada_cmp)
      {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_pesq_filtro'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['campos_busca']))
      { 
          $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['campos_busca'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      $nmgp_select_count = "SELECT count(*) AS countTest from (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,    tipo,    concat((select r.prefijo from resdian r where r.Idres=f.resolucion limit 1),'/',f.numfacven) as documento FROM      facturaven f WHERE     numfacven!=0  AND  saldo>0 and tipo in ('FV','RS') and credito='1' ) nm_sel_esp"; 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nmgp_select = "SELECT idcli, tipo, documento, credito, str_replace (convert(char(10),fechaven,102), '.', '-') + ' ' + convert(char(8),fechaven,20), str_replace (convert(char(10),fechavenc,102), '.', '-') + ' ' + convert(char(8),fechavenc,20), total, pagada, saldo, observaciones, idfacven, numfacven, nremision, valoriva, asentada, resolucion from (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,    tipo,    concat((select r.prefijo from resdian r where r.Idres=f.resolucion limit 1),'/',f.numfacven) as documento FROM      facturaven f WHERE     numfacven!=0  AND  saldo>0 and tipo in ('FV','RS') and credito='1' ) nm_sel_esp"; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nmgp_select = "SELECT idcli, tipo, documento, credito, fechaven, fechavenc, total, pagada, saldo, observaciones, idfacven, numfacven, nremision, valoriva, asentada, resolucion from (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,    tipo,    concat((select r.prefijo from resdian r where r.Idres=f.resolucion limit 1),'/',f.numfacven) as documento FROM      facturaven f WHERE     numfacven!=0  AND  saldo>0 and tipo in ('FV','RS') and credito='1' ) nm_sel_esp"; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nmgp_select = "SELECT idcli, tipo, documento, credito, convert(char(23),fechaven,121), convert(char(23),fechavenc,121), total, pagada, saldo, observaciones, idfacven, numfacven, nremision, valoriva, asentada, resolucion from (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,    tipo,    concat((select r.prefijo from resdian r where r.Idres=f.resolucion limit 1),'/',f.numfacven) as documento FROM      facturaven f WHERE     numfacven!=0  AND  saldo>0 and tipo in ('FV','RS') and credito='1' ) nm_sel_esp"; 
      } 
      ...
      { 
          $nmgp_select = "SELECT idcli, tipo, documento, credito, EXTEND(fechaven, YEAR TO DAY), EXTEND(fechavenc, YEAR TO DAY), total, pagada, saldo, observaciones, idfacven, numfacven, nremision, valoriva, asentada, resolucion from (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,    tipo,    concat((select r.prefijo from resdian r where r.Idres=f.resolucion limit 1),'/',f.numfacven) as documento FROM      facturaven f WHERE     numfacven!=0  AND  saldo>0 and tipo in ('FV','RS') and credito='1' ) nm_sel_esp"; 
       } 
      else 
      { 
          $nmgp_select = "SELECT idcli, tipo, documento, credito, fechaven, fechavenc, total, pagada, saldo, observaciones, idfacven, numfacven, nremision, valoriva, asentada, resolucion from (SELECT      idfacven,     numfacven,     nremision,     credito,     fechaven,     fechavenc,     idcli,     subtotal,     valoriva,     total,     pagada,     asentada,     observaciones,     saldo,     adicional,     adicional2,     adicional3,     resolucion,    tipo,    concat((select r.prefijo from resdian r where r.Idres=f.resolucion limit 1),'/',f.numfacven) as documento FROM      facturaven f WHERE     numfacven!=0  AND  saldo>0 and tipo in ('FV','RS') and credito='1' ) nm_sel_esp"; 
      } 
      $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_pesq'];
      $nmgp_select_count .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_pesq'];
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_resumo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_resumo'])) 
      { 
          if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_pesq'])) 
          { 
              $nmgp_select .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_resumo']; 
              $nmgp_select_count .= " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_resumo']; 
          } 
          else
          { 
              $nmgp_select .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_resumo'] . ")"; 
              $nmgp_select_count .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['where_resumo'] . ")"; 
          } 
      } 
      $nmgp_order_by = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['order_grid'];
      ...
      while (!$rs->EOF)
      {
         ...
         $this->numfacven = $rs->fields[11] ;  
         $this->numfacven = (string)$this->numfacven;
         $this->nremision = $rs->fields[12] ;  
         ...
         elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "_NM_SC_")
         {
          ...
          if ($Cmp_tst != $this->fechavenc_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "fechavencimiento") 
          {  
              if (isset($this->fechavenc_Old) && !$prim_gb)
              {
                 $this->quebra_fechavenc_fechavencimiento_bot() ; 
                 if ($this->groupby_show == "S") {
                     $this->Xls_col = 0;
                     $this->Xls_row++;
                 }
              }
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
              ...
              $this->quebra_fechavenc_fechavencimiento($this->fechavenc) ; 
              if ($this->groupby_show == "S") {
                  $this->Xls_col = 0;
                  $this->Xls_row++;
              }
              ...
              {
                 $this->quebra_fechavenc_fechavencimiento_top() ; 
                 if ($this->groupby_show == "S") {
                     $this->Xls_col = 0;
                     $this->Xls_row++;
                 }
          ...
          if ($this->idcli !== $this->idcli_Old && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "cliente") 
          {  
              if (isset($this->idcli_Old) && !$prim_gb)
              {
                 $this->quebra_idcli_cliente_bot() ; 
                 if ($this->groupby_show == "S") {
                     $this->Xls_col = 0;
                     $this->Xls_row++;
                 }
              ...
              $this->quebra_idcli_cliente($this->idcli) ; 
              if ($this->groupby_show == "S") {
                  $this->Xls_col = 0;
                  $this->Xls_row++;
              }
     ...
     $nm_houve_quebra = "N";
         ...
         $_SESSION['scriptcase']['grid_cartera']['contr_erro'] = 'on';
 $dhoy= date('d');
$mhoy= date('m');
$ahoy= date('Y');
...
$_SESSION['scriptcase']['grid_cartera']['contr_erro'] = 'off'; 
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['field_order'] as $Cada_col)
         { 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida'])
      { 
      ...
      if ($this->groupby_show == "S") {
          $this->Xls_col = 0;
          $this->Xls_row++;
       if (isset($this->fechavenc_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "fechavencimiento")
       {
           $this->quebra_fechavenc_fechavencimiento_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
       ...
       if (isset($this->idcli_Old) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] == "cliente")
       {
           $this->quebra_idcli_cliente_bot() ; 
           if ($this->groupby_show == "S") {
               $this->Xls_col = 0;
          ...
          $this->Xls_col = 0;
          $this->Xls_row++;
          $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['SC_Ind_Groupby'] . "_bot";
          $this->$Gb_geral();
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida'])
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
      ...
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['export_sel_columns']['field_order']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['export_sel_columns']['field_order'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['export_sel_columns']['field_order']);
      }
      if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['export_sel_columns']['usr_cmp_sel']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['export_sel_columns']['usr_cmp_sel'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['export_sel_columns']['usr_cmp_sel']);
      }
      $rs->Close();
   }
   function proc_label()
   { 
      ...
      { 
          ...
          $SC_Label = (isset($this->New_label['numfacven'])) ? $this->New_label['numfacven'] : "Documento"; 
          ...
          $SC_Label = (isset($this->New_label['prefijo'])) ? $this->New_label['prefijo'] : "Prefijo Fac"; 
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['nolabel'])
       {
 ...
 function quebra_idcli_cliente($idcli) 
 {
   global $tot_idcli;
   $this->sc_proc_quebra_idcli = true; 
   $this->Tot->quebra_idcli_cliente($idcli, $this->arg_sum_idcli);
   $conteudo = $tot_idcli[0] ;  
   $this->count_idcli = $tot_idcli[1];
   $this->sum_idcli_saldo = $tot_idcli[2];
   $this->campos_quebra_idcli = array(); 
   $conteudo = sc_strip_script($this->idcli); 
   $this->Lookup->lookup_cliente_idcli($conteudo , $this->idcli) ; 
   ...
   function quebra_fechavenc_fechavencimiento_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_fechavenc_fechavencimiento_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0.00";
               $Cmp_Tot    = $this->sum_fechavenc_saldo;
               $prim_cmp = false;
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_idcli_cliente_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_idcli_cliente_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
   ...
   function quebra_geral_fechavencimiento_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       $this->Tot->quebra_geral_fechavencimiento();
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "saldo" && (!isset($this->NM_cmp_hidden['saldo']) || $this->NM_cmp_hidden['saldo'] != "off"))
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['tot_geral'][2];
               $prim_cmp = false;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_file'] = $this->Xls_f;
      }
      $path_doc_md5 = md5($this->Ini->path_imag_temp . "/" . $this->Arquivo);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera'][$path_doc_md5][0] = $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera'][$path_doc_md5][1] = $this->Tit_doc;
...
<HEAD>
 <TITLE>FACTURAS POR COBRAR :: Excel</TITLE>
...
<form name="Fdown" method="get" action="grid_cartera_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="grid_cartera"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<FORM name="F0" method=post action="./"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cartera']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
