...
//  
   ...
   {   
      ...
      { 
          $nm_comando = "SELECT documento + ' - ' + nombres  FROM terceros where idtercero = $idcli AND cliente='SI' order by documento, nombres, tel_cel" ; 
      } 
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
      { 
          $nm_comando = "SELECT concat(documento,' - ', nombres)  FROM terceros where idtercero = $idcli AND cliente='SI' order by documento, nombres, tel_cel" ; 
      } 
