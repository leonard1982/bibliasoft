  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_presupuesto_movimientos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_presupuesto_movimientos_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_presupuesto_movimiento
  function do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_movimiento()
  {
    var nomeCampo_id_presupuesto_movimiento = "id_presupuesto_movimiento";
    var var_id_presupuesto_movimiento = scAjaxGetFieldHidden(nomeCampo_id_presupuesto_movimiento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_movimiento(var_id_presupuesto_movimiento, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_movimiento_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_movimiento

  function do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_movimiento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_presupuesto_movimiento";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_movimiento_cb

  // ---------- Validate id_presupuesto
  function do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto()
  {
    var nomeCampo_id_presupuesto = "id_presupuesto";
    var var_id_presupuesto = scAjaxGetFieldText(nomeCampo_id_presupuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto(var_id_presupuesto, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto

  function do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_presupuesto_cb

  // ---------- Validate id_detalle_presupuesto
  function do_ajax_form_presupuesto_movimientos_mob_validate_id_detalle_presupuesto()
  {
    var nomeCampo_id_detalle_presupuesto = "id_detalle_presupuesto";
    var var_id_detalle_presupuesto = scAjaxGetFieldText(nomeCampo_id_detalle_presupuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_mob_validate_id_detalle_presupuesto(var_id_detalle_presupuesto, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_validate_id_detalle_presupuesto_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_detalle_presupuesto

  function do_ajax_form_presupuesto_movimientos_mob_validate_id_detalle_presupuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_detalle_presupuesto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_detalle_presupuesto_cb

  // ---------- Validate fecha
  function do_ajax_form_presupuesto_movimientos_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_validate_fecha_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_validate_fecha

  function do_ajax_form_presupuesto_movimientos_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_mob_validate_fecha_cb

  // ---------- Validate gastado
  function do_ajax_form_presupuesto_movimientos_mob_validate_gastado()
  {
    var nomeCampo_gastado = "gastado";
    var var_gastado = scAjaxGetFieldText(nomeCampo_gastado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_mob_validate_gastado(var_gastado, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_validate_gastado_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_validate_gastado

  function do_ajax_form_presupuesto_movimientos_mob_validate_gastado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gastado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_mob_validate_gastado_cb

  // ---------- Validate id_banco
  function do_ajax_form_presupuesto_movimientos_mob_validate_id_banco()
  {
    var nomeCampo_id_banco = "id_banco";
    var var_id_banco = scAjaxGetFieldText(nomeCampo_id_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_mob_validate_id_banco(var_id_banco, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_validate_id_banco_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_banco

  function do_ajax_form_presupuesto_movimientos_mob_validate_id_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_banco_cb

  // ---------- Validate tipo_doc
  function do_ajax_form_presupuesto_movimientos_mob_validate_tipo_doc()
  {
    var nomeCampo_tipo_doc = "tipo_doc";
    var var_tipo_doc = scAjaxGetFieldText(nomeCampo_tipo_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_mob_validate_tipo_doc(var_tipo_doc, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_validate_tipo_doc_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_validate_tipo_doc

  function do_ajax_form_presupuesto_movimientos_mob_validate_tipo_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_mob_validate_tipo_doc_cb

  // ---------- Validate id_documento
  function do_ajax_form_presupuesto_movimientos_mob_validate_id_documento()
  {
    var nomeCampo_id_documento = "id_documento";
    var var_id_documento = scAjaxGetFieldText(nomeCampo_id_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_mob_validate_id_documento(var_id_documento, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_validate_id_documento_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_documento

  function do_ajax_form_presupuesto_movimientos_mob_validate_id_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_documento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_mob_validate_id_documento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_presupuesto_movimientos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_presupuesto_movimientos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_presupuesto_movimiento = scAjaxGetFieldHidden("id_presupuesto_movimiento");
    var var_id_presupuesto = scAjaxGetFieldText("id_presupuesto");
    var var_id_detalle_presupuesto = scAjaxGetFieldText("id_detalle_presupuesto");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_gastado = scAjaxGetFieldText("gastado");
    var var_id_banco = scAjaxGetFieldText("id_banco");
    var var_tipo_doc = scAjaxGetFieldText("tipo_doc");
    var var_id_documento = scAjaxGetFieldText("id_documento");
    ...
    scAjaxProcOn();
    x_ajax_form_presupuesto_movimientos_mob_submit_form(var_id_presupuesto_movimiento, var_id_presupuesto, var_id_detalle_presupuesto, var_fecha, var_gastado, var_id_banco, var_tipo_doc, var_id_documento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_presupuesto_movimientos_mob_submit_form_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_submit_form

  function do_ajax_form_presupuesto_movimientos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_presupuesto_movimiento");
      scAjaxHideErrorDisplay("id_presupuesto");
      scAjaxHideErrorDisplay("id_detalle_presupuesto");
      scAjaxHideErrorDisplay("fecha");
      scAjaxHideErrorDisplay("gastado");
      scAjaxHideErrorDisplay("id_banco");
      scAjaxHideErrorDisplay("tipo_doc");
      scAjaxHideErrorDisplay("id_documento");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_presupuesto_movimientos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_presupuesto_movimientos_mob_submit_form_cb
  function do_ajax_form_presupuesto_movimientos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_presupuesto_movimientos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_presupuesto_movimientos_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_presupuesto_movimientos_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_presupuesto_movimientos_mob_navigate_form();
    }
  }

  function perform_ajax_form_presupuesto_movimientos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("tipo_doc");
    scAjaxHideErrorDisplay("id_documento");
    var var_id_presupuesto_movimiento = document.F2.id_presupuesto_movimiento.value;
    ...
    scAjaxProcOn();
    x_ajax_form_presupuesto_movimientos_mob_navigate_form(var_id_presupuesto_movimiento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_presupuesto_movimientos_mob_navigate_form_cb);
  } // do_ajax_form_presupuesto_movimientos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_movimientos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_presupuesto_movimientos_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_presupuesto_movimiento.value = scAjaxGetKeyValue("id_presupuesto_movimiento");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_presupuesto_movimientos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_presupuesto_movimientos_mob_navigate_form_cb
  function do_ajax_form_presupuesto_movimientos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_presupuesto_movimientos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_presupuesto_movimientos_mob_navigate_form_cb_after_alert
  function sc_hide_form_presupuesto_movimientos_mob_form()
  {
  ...
  ajax_field_list[0] = "id_presupuesto_movimiento";
  ajax_field_list[1] = "id_presupuesto";
  ajax_field_list[2] = "id_detalle_presupuesto";
  ajax_field_list[3] = "fecha";
  ajax_field_list[4] = "gastado";
  ajax_field_list[5] = "id_banco";
  ajax_field_list[6] = "tipo_doc";
  ajax_field_list[7] = "id_documento";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_presupuesto_movimiento": {"label": "Id Presupuesto Movimiento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_presupuesto": {"label": "Id Presupuesto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_detalle_presupuesto": {"label": "Id Detalle Presupuesto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "gastado": {"label": "Gastado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_banco": {"label": "Id Banco", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_doc": {"label": "Tipo Doc", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_documento": {"label": "Id Documento", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_presupuesto_movimiento": new Array(),
    "id_presupuesto": new Array(),
    "id_detalle_presupuesto": new Array(),
    "fecha": new Array(),
    "gastado": new Array(),
    "id_banco": new Array(),
    "tipo_doc": new Array(),
    "id_documento": new Array()
  };
  ajax_field_mult["id_presupuesto_movimiento"][1] = "id_presupuesto_movimiento";
  ajax_field_mult["id_presupuesto"][1] = "id_presupuesto";
  ajax_field_mult["id_detalle_presupuesto"][1] = "id_detalle_presupuesto";
  ajax_field_mult["fecha"][1] = "fecha";
  ajax_field_mult["gastado"][1] = "gastado";
  ajax_field_mult["id_banco"][1] = "id_banco";
  ajax_field_mult["tipo_doc"][1] = "tipo_doc";
  ajax_field_mult["id_documento"][1] = "id_documento";

  var ajax_field_id = {
    "id_presupuesto_movimiento": new Array("hidden_field_label_id_presupuesto_movimiento", "hidden_field_data_id_presupuesto_movimiento"),
    "id_presupuesto": new Array("hidden_field_label_id_presupuesto", "hidden_field_data_id_presupuesto"),
    "id_detalle_presupuesto": new Array("hidden_field_label_id_detalle_presupuesto", "hidden_field_data_id_detalle_presupuesto"),
    "fecha": new Array("hidden_field_label_fecha", "hidden_field_data_fecha"),
    "gastado": new Array("hidden_field_label_gastado", "hidden_field_data_gastado"),
    ...
    "id_documento": new Array("hidden_field_label_id_documento", "hidden_field_data_id_documento")
  };

  var ajax_read_only = {
    "id_presupuesto_movimiento": "on",
    "id_presupuesto": "off",
    "id_detalle_presupuesto": "off",
    "fecha": "off",
    "gastado": "off",
    "id_banco": "off",
    "tipo_doc": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("id_presupuesto_movimiento" == sIndex)
    {
    ...
    if ("id_detalle_presupuesto" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
