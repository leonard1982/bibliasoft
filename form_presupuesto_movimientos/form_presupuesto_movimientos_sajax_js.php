  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_presupuesto_movimientos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_presupuesto_movimientos_form();
	}
  ...
  function do_ajax_form_presupuesto_movimientos_validate_id_presupuesto_movimiento()
  {
    ...
    x_ajax_form_presupuesto_movimientos_validate_id_presupuesto_movimiento(var_id_presupuesto_movimiento, var_script_case_init, do_ajax_form_presupuesto_movimientos_validate_id_presupuesto_movimiento_cb);
  } // do_ajax_form_presupuesto_movimientos_validate_id_presupuesto_movimiento

  function do_ajax_form_presupuesto_movimientos_validate_id_presupuesto_movimiento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_validate_id_presupuesto_movimiento_cb

  // ---------- Validate id_presupuesto
  function do_ajax_form_presupuesto_movimientos_validate_id_presupuesto()
  {
    var nomeCampo_id_presupuesto = "id_presupuesto";
    var var_id_presupuesto = scAjaxGetFieldText(nomeCampo_id_presupuesto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_validate_id_presupuesto(var_id_presupuesto, var_script_case_init, do_ajax_form_presupuesto_movimientos_validate_id_presupuesto_cb);
  } // do_ajax_form_presupuesto_movimientos_validate_id_presupuesto

  function do_ajax_form_presupuesto_movimientos_validate_id_presupuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_validate_id_presupuesto_cb

  // ---------- Validate id_detalle_presupuesto
  function do_ajax_form_presupuesto_movimientos_validate_id_detalle_presupuesto()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_validate_id_detalle_presupuesto(var_id_detalle_presupuesto, var_script_case_init, do_ajax_form_presupuesto_movimientos_validate_id_detalle_presupuesto_cb);
  } // do_ajax_form_presupuesto_movimientos_validate_id_detalle_presupuesto

  function do_ajax_form_presupuesto_movimientos_validate_id_detalle_presupuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_validate_id_detalle_presupuesto_cb

  // ---------- Validate fecha
  function do_ajax_form_presupuesto_movimientos_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_presupuesto_movimientos_validate_fecha_cb);
  } // do_ajax_form_presupuesto_movimientos_validate_fecha

  function do_ajax_form_presupuesto_movimientos_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_validate_fecha_cb

  // ---------- Validate gastado
  function do_ajax_form_presupuesto_movimientos_validate_gastado()
  {
    var nomeCampo_gastado = "gastado";
    var var_gastado = scAjaxGetFieldText(nomeCampo_gastado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_validate_gastado(var_gastado, var_script_case_init, do_ajax_form_presupuesto_movimientos_validate_gastado_cb);
  } // do_ajax_form_presupuesto_movimientos_validate_gastado

  function do_ajax_form_presupuesto_movimientos_validate_gastado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gastado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_validate_gastado_cb

  // ---------- Validate id_banco
  function do_ajax_form_presupuesto_movimientos_validate_id_banco()
  {
    var nomeCampo_id_banco = "id_banco";
    var var_id_banco = scAjaxGetFieldText(nomeCampo_id_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_validate_id_banco(var_id_banco, var_script_case_init, do_ajax_form_presupuesto_movimientos_validate_id_banco_cb);
  } // do_ajax_form_presupuesto_movimientos_validate_id_banco

  function do_ajax_form_presupuesto_movimientos_validate_id_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_validate_id_banco_cb

  // ---------- Validate tipo_doc
  function do_ajax_form_presupuesto_movimientos_validate_tipo_doc()
  {
    var nomeCampo_tipo_doc = "tipo_doc";
    var var_tipo_doc = scAjaxGetFieldText(nomeCampo_tipo_doc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_validate_tipo_doc(var_tipo_doc, var_script_case_init, do_ajax_form_presupuesto_movimientos_validate_tipo_doc_cb);
  } // do_ajax_form_presupuesto_movimientos_validate_tipo_doc

  function do_ajax_form_presupuesto_movimientos_validate_tipo_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_validate_tipo_doc_cb

  // ---------- Validate id_documento
  function do_ajax_form_presupuesto_movimientos_validate_id_documento()
  {
    var nomeCampo_id_documento = "id_documento";
    var var_id_documento = scAjaxGetFieldText(nomeCampo_id_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_presupuesto_movimientos_validate_id_documento(var_id_documento, var_script_case_init, do_ajax_form_presupuesto_movimientos_validate_id_documento_cb);
  } // do_ajax_form_presupuesto_movimientos_validate_id_documento

  function do_ajax_form_presupuesto_movimientos_validate_id_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_presupuesto_movimientos_validate_id_documento_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_presupuesto_movimientos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_presupuesto_movimientos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_presupuesto_movimientos_submit_form(var_id_presupuesto_movimiento, var_id_presupuesto, var_id_detalle_presupuesto, var_fecha, var_gastado, var_id_banco, var_tipo_doc, var_id_documento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_presupuesto_movimientos_submit_form_cb);
  } // do_ajax_form_presupuesto_movimientos_submit_form

  function do_ajax_form_presupuesto_movimientos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_presupuesto_movimientos_submit_form_cb_after_alert);
  } // do_ajax_form_presupuesto_movimientos_submit_form_cb
  function do_ajax_form_presupuesto_movimientos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_presupuesto_movimientos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_presupuesto_movimientos_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_presupuesto_movimientos_navigate_form, function() {});
    } else {
      perform_ajax_form_presupuesto_movimientos_navigate_form();
    }
  }

  function perform_ajax_form_presupuesto_movimientos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_presupuesto_movimientos_navigate_form(var_id_presupuesto_movimiento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_presupuesto_movimientos_navigate_form_cb);
  } // do_ajax_form_presupuesto_movimientos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_presupuesto_movimientos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_presupuesto_movimientos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_presupuesto_movimientos_navigate_form_cb_after_alert);
  } // do_ajax_form_presupuesto_movimientos_navigate_form_cb
  function do_ajax_form_presupuesto_movimientos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_presupuesto_movimientos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_presupuesto_movimientos_navigate_form_cb_after_alert
  function sc_hide_form_presupuesto_movimientos_form()
  {
