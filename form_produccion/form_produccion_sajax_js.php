  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_produccion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate numero
  function do_ajax_form_produccion_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_validate_numero(var_numero, var_script_case_init, do_ajax_form_produccion_validate_numero_cb);
  } // do_ajax_form_produccion_validate_numero

  function do_ajax_form_produccion_validate_numero_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_validate_numero_cb

  // ---------- Validate fecha
  function do_ajax_form_produccion_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_produccion_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_produccion_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_produccion_validate_fecha

  function do_ajax_form_produccion_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_validate_fecha_cb

  // ---------- Validate id_bodega
  function do_ajax_form_produccion_validate_id_bodega()
  {
    var nomeCampo_id_bodega = "id_bodega";
    var var_id_bodega = scAjaxGetFieldSelect(nomeCampo_id_bodega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_validate_id_bodega(var_id_bodega, var_script_case_init, do_ajax_form_produccion_validate_id_bodega_cb);
  } // do_ajax_form_produccion_validate_id_bodega

  function do_ajax_form_produccion_validate_id_bodega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_validate_id_bodega_cb

  // ---------- Validate asentada
  function do_ajax_form_produccion_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldSelect(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_produccion_validate_asentada_cb);
  } // do_ajax_form_produccion_validate_asentada

  function do_ajax_form_produccion_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_validate_asentada_cb

  // ---------- Validate observ
  function do_ajax_form_produccion_validate_observ()
  {
    var nomeCampo_observ = "observ";
    var var_observ = scAjaxGetFieldText(nomeCampo_observ);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_validate_observ(var_observ, var_script_case_init, do_ajax_form_produccion_validate_observ_cb);
  } // do_ajax_form_produccion_validate_observ

  function do_ajax_form_produccion_validate_observ_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observ";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_validate_observ_cb

  // ---------- Validate vtotal
  function do_ajax_form_produccion_validate_vtotal()
  {
    var nomeCampo_vtotal = "vtotal";
    var var_vtotal = scAjaxGetFieldHidden(nomeCampo_vtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_validate_vtotal(var_vtotal, var_script_case_init, do_ajax_form_produccion_validate_vtotal_cb);
  } // do_ajax_form_produccion_validate_vtotal

  function do_ajax_form_produccion_validate_vtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vtotal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_validate_vtotal_cb

  // ---------- Validate detalle
  function do_ajax_form_produccion_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_produccion_validate_detalle_cb);
  } // do_ajax_form_produccion_validate_detalle

  function do_ajax_form_produccion_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_validate_detalle_cb

  // ---------- Event onchange asentada
  function do_ajax_form_produccion_event_asentada_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_produccion_event_asentada_onchange(var_vtotal, var_asentada, var_numero, var_script_case_init, do_ajax_form_produccion_event_asentada_onchange_cb);
  } // do_ajax_form_produccion_event_asentada_onchange

  function do_ajax_form_produccion_event_asentada_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "asentada";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produccion_event_asentada_onchange_cb_after_alert);
  } // do_ajax_form_produccion_event_asentada_onchange_cb
  function do_ajax_form_produccion_event_asentada_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produccion_event_asentada_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_produccion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_produccion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_numero = scAjaxGetFieldHidden("numero");
    ...
    scAjaxProcOn();
    x_ajax_form_produccion_submit_form(var_numero, var_fecha, var_id_bodega, var_asentada, var_observ, var_vtotal, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produccion_submit_form_cb);
  } // do_ajax_form_produccion_submit_form

  function do_ajax_form_produccion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_produccion_submit_form_cb_after_alert);
  } // do_ajax_form_produccion_submit_form_cb
  function do_ajax_form_produccion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_produccion_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detalleprod"] = "off";

  function do_ajax_form_produccion_navigate_form()
  {
    perform_ajax_form_produccion_navigate_form();
  }

  function perform_ajax_form_produccion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_detalleprod"] = "on";
    x_ajax_form_produccion_navigate_form(var_idmat, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produccion_navigate_form_cb);
  } // do_ajax_form_produccion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_produccion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_produccion_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detalleprod"] && "nmsc_iframe_liga_form_detalleprod" != scMasterDetailIframe["nmsc_iframe_liga_form_detalleprod"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detalleprod"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detalleprod').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_detalleprod').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_detalleprod').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_produccion_navigate_form_cb_after_alert);
  } // do_ajax_form_produccion_navigate_form_cb
  function do_ajax_form_produccion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('fecha');
...
{
?>
    do_ajax_form_produccion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_produccion_navigate_form_cb_after_alert
  function sc_hide_form_produccion_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detalleprod"])
    {
      return true;
    }
    return false;
