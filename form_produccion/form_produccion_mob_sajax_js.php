  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_produccion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_produccion_mob_form();
	}
...
?>
  ...
  // ---------- Validate numero
  function do_ajax_form_produccion_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_produccion_mob_validate_numero_cb);
  } // do_ajax_form_produccion_mob_validate_numero

  function do_ajax_form_produccion_mob_validate_numero_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_mob_validate_numero_cb

  // ---------- Validate fecha
  function do_ajax_form_produccion_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_produccion_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_produccion_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_produccion_mob_validate_fecha

  function do_ajax_form_produccion_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_mob_validate_fecha_cb

  // ---------- Validate id_bodega
  function do_ajax_form_produccion_mob_validate_id_bodega()
  {
    var nomeCampo_id_bodega = "id_bodega";
    var var_id_bodega = scAjaxGetFieldSelect(nomeCampo_id_bodega);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_mob_validate_id_bodega(var_id_bodega, var_script_case_init, do_ajax_form_produccion_mob_validate_id_bodega_cb);
  } // do_ajax_form_produccion_mob_validate_id_bodega

  function do_ajax_form_produccion_mob_validate_id_bodega_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_bodega";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_mob_validate_id_bodega_cb

  // ---------- Validate asentada
  function do_ajax_form_produccion_mob_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldSelect(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_mob_validate_asentada(var_asentada, var_script_case_init, do_ajax_form_produccion_mob_validate_asentada_cb);
  } // do_ajax_form_produccion_mob_validate_asentada

  function do_ajax_form_produccion_mob_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_mob_validate_asentada_cb

  // ---------- Validate observ
  function do_ajax_form_produccion_mob_validate_observ()
  {
    var nomeCampo_observ = "observ";
    var var_observ = scAjaxGetFieldText(nomeCampo_observ);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_mob_validate_observ(var_observ, var_script_case_init, do_ajax_form_produccion_mob_validate_observ_cb);
  } // do_ajax_form_produccion_mob_validate_observ

  function do_ajax_form_produccion_mob_validate_observ_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observ";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_mob_validate_observ_cb

  // ---------- Validate vtotal
  function do_ajax_form_produccion_mob_validate_vtotal()
  {
    var nomeCampo_vtotal = "vtotal";
    var var_vtotal = scAjaxGetFieldHidden(nomeCampo_vtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_mob_validate_vtotal(var_vtotal, var_script_case_init, do_ajax_form_produccion_mob_validate_vtotal_cb);
  } // do_ajax_form_produccion_mob_validate_vtotal

  function do_ajax_form_produccion_mob_validate_vtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "vtotal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_mob_validate_vtotal_cb

  // ---------- Validate detalle
  function do_ajax_form_produccion_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produccion_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_produccion_mob_validate_detalle_cb);
  } // do_ajax_form_produccion_mob_validate_detalle

  function do_ajax_form_produccion_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produccion_mob_validate_detalle_cb

  // ---------- Event onchange asentada
  function do_ajax_form_produccion_mob_event_asentada_onchange()
  {
    var var_vtotal = scAjaxGetFieldHidden("vtotal");
    var var_asentada = scAjaxGetFieldSelect("asentada");
    var var_numero = scAjaxGetFieldHidden("numero");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_produccion_mob_event_asentada_onchange(var_vtotal, var_asentada, var_numero, var_script_case_init, do_ajax_form_produccion_mob_event_asentada_onchange_cb);
  } // do_ajax_form_produccion_mob_event_asentada_onchange

  function do_ajax_form_produccion_mob_event_asentada_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "asentada";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produccion_mob_event_asentada_onchange_cb_after_alert);
  } // do_ajax_form_produccion_mob_event_asentada_onchange_cb
  function do_ajax_form_produccion_mob_event_asentada_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produccion_mob_event_asentada_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_produccion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_produccion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_numero = scAjaxGetFieldHidden("numero");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_id_bodega = scAjaxGetFieldSelect("id_bodega");
    var var_asentada = scAjaxGetFieldSelect("asentada");
    var var_observ = scAjaxGetFieldText("observ");
    var var_vtotal = scAjaxGetFieldHidden("vtotal");
    var var_idmat = scAjaxGetFieldText("idmat");
    ...
    scAjaxProcOn();
    x_ajax_form_produccion_mob_submit_form(var_numero, var_fecha, var_id_bodega, var_asentada, var_observ, var_vtotal, var_idmat, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produccion_mob_submit_form_cb);
  } // do_ajax_form_produccion_mob_submit_form

  function do_ajax_form_produccion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("id_bodega");
      scAjaxHideErrorDisplay("asentada");
      scAjaxHideErrorDisplay("observ");
      scAjaxHideErrorDisplay("vtotal");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_produccion_mob_submit_form_cb_after_alert);
  } // do_ajax_form_produccion_mob_submit_form_cb
  function do_ajax_form_produccion_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_produccion_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detalleprod_mob"] = "off";

  function do_ajax_form_produccion_mob_navigate_form()
  {
    perform_ajax_form_produccion_mob_navigate_form();
  }

  function perform_ajax_form_produccion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("vtotal");
    scAjaxHideErrorDisplay("detalle");
    var var_idmat = document.F2.idmat.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_detalleprod_mob"] = "on";
    x_ajax_form_produccion_mob_navigate_form(var_idmat, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produccion_mob_navigate_form_cb);
  } // do_ajax_form_produccion_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_produccion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_produccion_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmat.value = scAjaxGetKeyValue("idmat");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detalleprod_mob"] && "nmsc_iframe_liga_form_detalleprod_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_detalleprod_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detalleprod_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detalleprod_mob').contentWindow.nm_move('apl_detalhe', true, '400');
        document.getElementById('nmsc_iframe_liga_form_detalleprod_mob').style.height = "400";
        document.getElementById('nmsc_iframe_liga_form_detalleprod_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_produccion_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_produccion_mob_navigate_form_cb
  function do_ajax_form_produccion_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('fecha');
...
{
?>
    do_ajax_form_produccion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_produccion_mob_navigate_form_cb_after_alert
  function sc_hide_form_produccion_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detalleprod_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[2] = "id_bodega";
  ajax_field_list[3] = "asentada";
  ajax_field_list[4] = "observ";
  ajax_field_list[5] = "vtotal";
  ...
  var ajax_error_list = {
    "numero": {"label": "Número", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha": {"label": "Fecha", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_bodega": {"label": "Área de Producción destino", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "observ": {"label": "Observaciones", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "vtotal": {"label": "Costo total Materia Prima", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["id_bodega"][1] = "id_bodega";
  ajax_field_mult["asentada"][1] = "asentada";
  ajax_field_mult["observ"][1] = "observ";
  ajax_field_mult["vtotal"][1] = "vtotal";
  ...
  var ajax_field_id = {
    ...
    "id_bodega": new Array("hidden_field_label_id_bodega", "hidden_field_data_id_bodega"),
    "asentada": new Array("hidden_field_label_asentada", "hidden_field_data_asentada"),
    "observ": new Array("hidden_field_label_observ", "hidden_field_data_observ"),
    "vtotal": new Array("hidden_field_label_vtotal", "hidden_field_data_vtotal"),
