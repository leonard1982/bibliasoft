...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['opc_ant'] = "inicio";
      }
...
$_SESSION['scriptcase']['form_configuraciones_mob']['contr_erro'] = 'off';
      ...
      $_SESSION['scriptcase']['error_icon']['form_configuraciones_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
    ...
    function ValidateField_cal_valores_decimales(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cal_valores_decimales, 2, 0, -0, 99, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_cal_cantidades_decimales(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->cal_cantidades_decimales, 2, 0, -0, 99, "N") == false)  
              { 
                  $hasError = true;
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_columna_imprimir_ticket'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['columna_imprimir_ticket']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_columna_imprimir_a4'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['columna_imprimir_a4']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_columna_whatsapp'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['columna_whatsapp']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_columna_npedido'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['columna_npedido']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_columna_reg_pdf_propio'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['columna_reg_pdf_propio']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_ver_busqueda_refinada'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['ver_busqueda_refinada']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_validar_codbarras'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['validar_codbarras']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_ver_agregar_nota'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['ver_agregar_nota']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "idconfiguraciones";$nm_numeric[] = "lineasporfactura";$nm_numeric[] = "espaciado";$nm_numeric[] = "refresh_grid_doc";$nm_numeric[] = "dia_limite_pago";$nm_numeric[] = "valor_propina_sugerida";$nm_numeric[] = "cal_valores_decimales";$nm_numeric[] = "cal_cantidades_decimales";
