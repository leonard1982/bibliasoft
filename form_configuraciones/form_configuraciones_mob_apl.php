<?php
//
class form_configuraciones_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->gconsolidararticulos)) 
          {
              $_SESSION['gconsolidararticulos'] = $this->gconsolidararticulos;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_configuraciones_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['initialize'];
          $this->Db = $this->Ini->Db; 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['initialize']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['initialize'])
          {
...
$_SESSION['scriptcase']['form_configuraciones_mob']['contr_erro'] = 'off';
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob'][$I_conf]  = $Conf_opt;
              }
          }
          }
          $this->Ini->init2();
      ...
      $_SESSION['sc_session'][$script_case_init]['form_configuraciones_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_configuraciones_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_configuraciones_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_configuraciones_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_configuraciones_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_configuraciones_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_configuraciones_mob']['label'] = "Configuraciones";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_configuraciones_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_orig'] = " where idconfiguraciones='1'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_pesq'] = " where idconfiguraciones='1'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['insert'] != '')
      {
      ...
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_configuraciones_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_insert'] != '')
      {
      ...
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_configuraciones_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_configuraciones_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['insert'] != '')
      {
      ...
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_configuraciones_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_configuraciones_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_configuraciones_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_configuraciones/form_configuraciones_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_configuraciones_mob_erro.class.php"); 
      }
      ...
      { 
         ...
         { 
             ...
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_configuraciones_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['activar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['botoes']['activar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['final'];
      }
      else
      {
      }
...
$_SESSION['scriptcase']['form_configuraciones_mob']['contr_erro'] = 'off'; 
            ...
            $out1_img_cache = $_SESSION['scriptcase']['form_configuraciones_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['form_configuraciones_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dados_select'])) 
     {
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_configuraciones_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_configuraciones_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_configuraciones_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_configuraciones_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_configuraciones_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_configuraciones_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_configuraciones_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_configuraciones_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
$_SESSION['scriptcase']['form_configuraciones_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_lineasporfactura(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->lineasporfactura, 2, 0, 1, 99, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['php_cmp_required']['lineasporfactura']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['php_cmp_required']['lineasporfactura'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_consolidararticulos(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['php_cmp_required']['consolidararticulos']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['php_cmp_required']['consolidararticulos'] == "on")
        { 
          $hasError = true;
    ...
    function ValidateField_espaciado(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->espaciado, 11, 1, 3.5, 999999999999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_refresh_grid_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->refresh_grid_doc, 4, 0, -0, 9999, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_dia_limite_pago(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->dia_limite_pago, 2, 0, -0, 99, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_valor_propina_sugerida(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->valor_propina_sugerida, 15, 0, -0, 1.0E+15, "N") == false)  
              { 
                  $hasError = true;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idconfiguraciones']['keyVal'] = form_configuraciones_mob_pack_protect_string($this->nmgp_dados_form['idconfiguraciones']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('S') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("S")));
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('N') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("N")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_consolidararticulos'][] = 'S';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_consolidararticulos'][] = 'N';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['consolidararticulos']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_desactivar_control_sesion'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['desactivar_control_sesion']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_noborrar_tmp_enpos'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['noborrar_tmp_enpos']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_validar_correo_enlinea'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['validar_correo_enlinea']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_modificainvpedido'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['modificainvpedido']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_apertura_caja'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['apertura_caja']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_caja_movil'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['caja_movil']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_control_diasmora'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['control_diasmora']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_control_costo'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['control_costo']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_activar_console_log'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['activar_console_log']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_pago_automatico'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['pago_automatico']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('FV') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("FACTURA")));
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('RS') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("REMISIÓN")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_tipodoc_pordefecto_pos'][] = 'FV';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_tipodoc_pordefecto_pos'][] = 'RS';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['tipodoc_pordefecto_pos']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_codproducto_en_facventa'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['codproducto_en_facventa']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_ver_xml_fe'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['ver_xml_fe']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_essociedad'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['essociedad']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_configuraciones_mob_pack_protect_string('SI') => str_replace('<', '&lt;',form_configuraciones_mob_pack_protect_string("")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_grancontr'][] = 'SI';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['grancontr']['valList'][$i] = form_configuraciones_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_idconfiguraciones($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (lineasporfactura, consolidararticulos, serial, fecha, activo, espaciado, nombre_pc, nombre_impre, ruta_bd_tns, ip, refresh_grid_doc, modificainvpedido, caja_movil, integrar_tns, essociedad, grancontr, apertura_caja, control_diasmora, control_costo, activar_console_log, pago_automatico, tipodoc_pordefecto_pos, nube_pedidos, nube_inventario, nube_cartera, nube_tesoreria, nube_agenda, nube_compras, nube_codigo, token, password, codproducto_en_facventa, habilitar_comprobantes, noborrar_tmp_enpos, desactivar_control_sesion, dia_limite_pago, licencia_activa, fecha_activacion, cod_cliente, valor_propina_sugerida, validar_correo_enlinea, ver_xml_fe $compl_insert) VALUES ($this->lineasporfactura, '$this->consolidararticulos', '$this->serial', #$this->fecha#, '$this->activo', $this->espaciado, '$this->nombre_pc', '$this->nombre_impre', '$this->ruta_bd_tns', '$this->ip', $this->refresh_grid_doc, '$this->modificainvpedido', '$this->caja_movil', '$this->integrar_tns', '$this->essociedad', '$this->grancontr', '$this->apertura_caja', '$this->control_diasmora', '$this->control_costo', '$this->activar_console_log', '$this->pago_automatico', '$this->tipodoc_pordefecto_pos', '$this->nube_pedidos', '$this->nube_inventario', '$this->nube_cartera', '$this->nube_tesoreria', '$this->nube_agenda', '$this->nube_compras', '$this->nube_codigo', '$this->token', '$this->password', '$this->codproducto_en_facventa', '$this->habilitar_comprobantes', '$this->noborrar_tmp_enpos', '$this->desactivar_control_sesion', $this->dia_limite_pago, '$this->licencia_activa', #$this->fecha_activacion#, '$this->cod_cliente', $this->valor_propina_sugerida, '$this->validar_correo_enlinea', '$this->ver_xml_fe' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $compl_insert     = ""; 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "lineasporfactura, consolidararticulos, serial, fecha, activo, espaciado, nombre_pc, nombre_impre, ruta_bd_tns, ip, refresh_grid_doc, modificainvpedido, caja_movil, integrar_tns, essociedad, grancontr, apertura_caja, control_diasmora, control_costo, activar_console_log, pago_automatico, tipodoc_pordefecto_pos, nube_pedidos, nube_inventario, nube_cartera, nube_tesoreria, nube_agenda, nube_compras, nube_codigo, token, password, codproducto_en_facventa, habilitar_comprobantes, noborrar_tmp_enpos, desactivar_control_sesion, dia_limite_pago, licencia_activa, fecha_activacion, cod_cliente, valor_propina_sugerida, validar_correo_enlinea, ver_xml_fe $compl_insert) VALUES (" . $NM_seq_auto . "$this->lineasporfactura, '$this->consolidararticulos', '$this->serial', " . $this->Ini->date_delim . $this->fecha . $this->Ini->date_delim1 . ", '$this->activo', $this->espaciado, '$this->nombre_pc', '$this->nombre_impre', '$this->ruta_bd_tns', '$this->ip', $this->refresh_grid_doc, '$this->modificainvpedido', '$this->caja_movil', '$this->integrar_tns', '$this->essociedad', '$this->grancontr', '$this->apertura_caja', '$this->control_diasmora', '$this->control_costo', '$this->activar_console_log', '$this->pago_automatico', '$this->tipodoc_pordefecto_pos', '$this->nube_pedidos', '$this->nube_inventario', '$this->nube_cartera', '$this->nube_tesoreria', '$this->nube_agenda', '$this->nube_compras', '$this->nube_codigo', '$this->token', '$this->password', '$this->codproducto_en_facventa', '$this->habilitar_comprobantes', '$this->noborrar_tmp_enpos', '$this->desactivar_control_sesion', $this->dia_limite_pago, '$this->licencia_activa', " . $this->Ini->date_delim . $this->fecha_activacion . $this->Ini->date_delim1 . ", '$this->cod_cliente', $this->valor_propina_sugerida, '$this->validar_correo_enlinea', '$this->ver_xml_fe' $compl_insert_val)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "lineasporfactura, consolidararticulos, serial, fecha, activo, espaciado, nombre_pc, nombre_impre, ruta_bd_tns, ip, refresh_grid_doc, modificainvpedido, caja_movil, integrar_tns, essociedad, grancontr, apertura_caja, control_diasmora, control_costo, activar_console_log, pago_automatico, tipodoc_pordefecto_pos, nube_pedidos, nube_inventario, nube_cartera, nube_tesoreria, nube_agenda, nube_compras, nube_codigo, token, password, codproducto_en_facventa, habilitar_comprobantes, noborrar_tmp_enpos, desactivar_control_sesion, dia_limite_pago, licencia_activa, fecha_activacion, cod_cliente, valor_propina_sugerida, validar_correo_enlinea, ver_xml_fe $compl_insert) VALUES (" . $NM_seq_auto . "$this->lineasporfactura, '$this->consolidararticulos', '$this->serial', EXTEND('$this->fecha', YEAR TO DAY), '$this->activo', $this->espaciado, '$this->nombre_pc', '$this->nombre_impre', '$this->ruta_bd_tns', '$this->ip', $this->refresh_grid_doc, '$this->modificainvpedido', '$this->caja_movil', '$this->integrar_tns', '$this->essociedad', '$this->grancontr', '$this->apertura_caja', '$this->control_diasmora', '$this->control_costo', '$this->activar_console_log', '$this->pago_automatico', '$this->tipodoc_pordefecto_pos', '$this->nube_pedidos', '$this->nube_inventario', '$this->nube_cartera', '$this->nube_tesoreria', '$this->nube_agenda', '$this->nube_compras', '$this->nube_codigo', '$this->token', '$this->password', '$this->codproducto_en_facventa', '$this->habilitar_comprobantes', '$this->noborrar_tmp_enpos', '$this->desactivar_control_sesion', $this->dia_limite_pago, '$this->licencia_activa', EXTEND('$this->fecha_activacion', YEAR TO FRACTION), '$this->cod_cliente', $this->valor_propina_sugerida, '$this->validar_correo_enlinea', '$this->ver_xml_fe' $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $compl_insert     = ""; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['form_configuraciones_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['parms'] = "idconfiguraciones?#?$this->idconfiguraciones?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['reg_start'] < $qt_geral_reg_form_configuraciones_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opcao']   = '';
          }
      } 
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter_form'] . " and (idconfiguraciones='1') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_configuraciones_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['total'] = $qt_geral_reg_form_configuraciones_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_configuraciones_mob_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $nm_numeric[] = "idconfiguraciones";$nm_numeric[] = "lineasporfactura";$nm_numeric[] = "espaciado";$nm_numeric[] = "refresh_grid_doc";$nm_numeric[] = "dia_limite_pago";$nm_numeric[] = "valor_propina_sugerida";
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_configuraciones_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_configuraciones_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['masterValue']))
{
