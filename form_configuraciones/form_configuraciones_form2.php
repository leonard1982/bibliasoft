...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_columna_imprimir_ticket_label" id="hidden_field_label_columna_imprimir_ticket" style="<?php echo $sStyleHidden_columna_imprimir_ticket; ?>"><span id="id_label_columna_imprimir_ticket"><?php echo $this->nm_new_label['columna_imprimir_ticket']; ?></span></TD>
    <TD class="scFormDataOdd css_columna_imprimir_ticket_line" id="hidden_field_data_columna_imprimir_ticket" style="<?php echo $sStyleHidden_columna_imprimir_ticket; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_columna_imprimir_ticket_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_columna_imprimir_ticket'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_columna_imprimir_a4_label" id="hidden_field_label_columna_imprimir_a4" style="<?php echo $sStyleHidden_columna_imprimir_a4; ?>"><span id="id_label_columna_imprimir_a4"><?php echo $this->nm_new_label['columna_imprimir_a4']; ?></span></TD>
    <TD class="scFormDataOdd css_columna_imprimir_a4_line" id="hidden_field_data_columna_imprimir_a4" style="<?php echo $sStyleHidden_columna_imprimir_a4; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_columna_imprimir_a4_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_columna_imprimir_a4'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_columna_whatsapp_label" id="hidden_field_label_columna_whatsapp" style="<?php echo $sStyleHidden_columna_whatsapp; ?>"><span id="id_label_columna_whatsapp"><?php echo $this->nm_new_label['columna_whatsapp']; ?></span></TD>
    <TD class="scFormDataOdd css_columna_whatsapp_line" id="hidden_field_data_columna_whatsapp" style="<?php echo $sStyleHidden_columna_whatsapp; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_columna_whatsapp_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_columna_whatsapp'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_columna_npedido_label" id="hidden_field_label_columna_npedido" style="<?php echo $sStyleHidden_columna_npedido; ?>"><span id="id_label_columna_npedido"><?php echo $this->nm_new_label['columna_npedido']; ?></span></TD>
    <TD class="scFormDataOdd css_columna_npedido_line" id="hidden_field_data_columna_npedido" style="<?php echo $sStyleHidden_columna_npedido; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_columna_npedido_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_columna_npedido'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_columna_reg_pdf_propio_label" id="hidden_field_label_columna_reg_pdf_propio" style="<?php echo $sStyleHidden_columna_reg_pdf_propio; ?>"><span id="id_label_columna_reg_pdf_propio"><?php echo $this->nm_new_label['columna_reg_pdf_propio']; ?></span></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_columna_reg_pdf_propio'][] = 'SI'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cal_valores_decimales_label" id="hidden_field_label_cal_valores_decimales" style="<?php echo $sStyleHidden_cal_valores_decimales; ?>"><span id="id_label_cal_valores_decimales"><?php echo $this->nm_new_label['cal_valores_decimales']; ?></span></TD>
    <TD class="scFormDataOdd css_cal_valores_decimales_line" id="hidden_field_data_cal_valores_decimales" style="<?php echo $sStyleHidden_cal_valores_decimales; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cal_valores_decimales_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cal_cantidades_decimales_label" id="hidden_field_label_cal_cantidades_decimales" style="<?php echo $sStyleHidden_cal_cantidades_decimales; ?>"><span id="id_label_cal_cantidades_decimales"><?php echo $this->nm_new_label['cal_cantidades_decimales']; ?></span></TD>
    <TD class="scFormDataOdd css_cal_cantidades_decimales_line" id="hidden_field_data_cal_cantidades_decimales" style="<?php echo $sStyleHidden_cal_cantidades_decimales; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cal_cantidades_decimales_line" style="vertical-align: top;padding: 0px">
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_validar_codbarras_label" id="hidden_field_label_validar_codbarras" style="<?php echo $sStyleHidden_validar_codbarras; ?>"><span id="id_label_validar_codbarras"><?php echo $this->nm_new_label['validar_codbarras']; ?></span></TD>
    <TD class="scFormDataOdd css_validar_codbarras_line" id="hidden_field_data_validar_codbarras" style="<?php echo $sStyleHidden_validar_codbarras; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_validar_codbarras_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_validar_codbarras'][] = 'SI'; ?>
