<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="idconfiguraciones" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idconfiguraciones']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_configuraciones_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_activar() 
{ 
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_activar(); }, 500);
      return;
    }
    //se activa
$("#dialog").show();
//abre el frm para autorizar
$( "#dialog").dialog();
} 
function sc_btn_activar_cancel()
{
}
function sc_btn_activar_ok()
{
    //se activa
$("#dialog").show();
//abre el frm para autorizar
...
?>
    ...
    {
        do_ajax_form_configuraciones_mob_navigate_form();
    }
} 
...
{
    NovaJanela = window.open ("form_configuraciones_mob_help.php?nm_cod_campo=" + campo + "&language=<?php echo $this->Ini->path_lang . $this->Ini->str_lang?>&help_css=<?php echo '../_lib/css/' . $this->Ini->str_schema_all . '_form.css'; ?>", "ScriptCase", "height=100, width=300, resizable, scrollbars");
}
...
{
    document.getElementById('form_configuraciones_mob_form0').style.width='1px';
    document.getElementById('form_configuraciones_mob_form0').style.height='0px';
    document.getElementById('form_configuraciones_mob_form0').style.display='none';
    document.getElementById('form_configuraciones_mob_form0').style.overflow='scroll';
    document.getElementById('form_configuraciones_mob_form1').style.width='1px';
    document.getElementById('form_configuraciones_mob_form1').style.height='0px';
    document.getElementById('form_configuraciones_mob_form1').style.display='none';
    document.getElementById('form_configuraciones_mob_form1').style.overflow='scroll';
    document.getElementById('form_configuraciones_mob_form2').style.width='1px';
    document.getElementById('form_configuraciones_mob_form2').style.height='0px';
    document.getElementById('form_configuraciones_mob_form2').style.display='none';
    document.getElementById('form_configuraciones_mob_form2').style.overflow='scroll';
    document.getElementById('form_configuraciones_mob_form3').style.width='1px';
    document.getElementById('form_configuraciones_mob_form3').style.height='0px';
    document.getElementById('form_configuraciones_mob_form3').style.display='none';
    document.getElementById('form_configuraciones_mob_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['pdf_view']) {
?>
