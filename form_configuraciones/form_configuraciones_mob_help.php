<?php
include_once('form_configuraciones_mob_session.php');
@session_start() ;
class form_configuraciones_mob_help
{
...
<?php
        ...
        if ($nm_cod_campo ==  "validar_codbarras")
        {
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
...
<body class="scFormHelpPage">
<?php echo "<b>Validar Codbarras</b><br>" . nl2br("Valida al leer el codigo de barras permitiendo seleccionar precio y cantidad."); ?>
</body>
</html>
<?php
        }
        if ($nm_cod_campo ==  "minutos_inactividad")
        {
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
...
<body class="scFormHelpPage">
<?php echo "<b>Minutos Inactividad</b><br>" . nl2br("Cierra la sesion al pasar los minutos configurados si en ese tiempo no tiene actividad. El rango a parametrizar es de 30 minutos a 1,440 minutos (24 horas)"); ?>
</body>
</html>
<?php
        }
...
$exec_help = new form_configuraciones_mob_help();
?>
