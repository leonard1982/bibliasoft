...
?> 
    ...
    <TD class="scFormDataOdd css_ver_busqueda_refinada_line" id="hidden_field_data_ver_busqueda_refinada" style="<?php echo $sStyleHidden_ver_busqueda_refinada; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ver_busqueda_refinada_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ver_busqueda_refinada_label" style=""><span id="id_label_ver_busqueda_refinada"><?php echo $this->nm_new_label['ver_busqueda_refinada']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_ver_busqueda_refinada'][] = 'SI'; ?>
