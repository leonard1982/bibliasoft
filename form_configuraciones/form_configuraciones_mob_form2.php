...
?> 
    ...
    <TD class="scFormDataOdd css_integrar_tns_line" id="hidden_field_data_integrar_tns" style="<?php echo $sStyleHidden_integrar_tns; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_integrar_tns_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_integrar_tns_label" style=""><span id="id_label_integrar_tns"><?php echo $this->nm_new_label['integrar_tns']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_integrar_tns'][] = 'SI'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_ruta_bd_tns_line" id="hidden_field_data_ruta_bd_tns" style="<?php echo $sStyleHidden_ruta_bd_tns; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_ruta_bd_tns_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_ruta_bd_tns_label" style=""><span id="id_label_ruta_bd_tns"><?php echo $this->nm_new_label['ruta_bd_tns']; ?></span></span><br>
...
?> 
    ...
    <TD class="scFormDataOdd css_habilitar_comprobantes_line" id="hidden_field_data_habilitar_comprobantes" style="<?php echo $sStyleHidden_habilitar_comprobantes; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_habilitar_comprobantes_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_habilitar_comprobantes_label" style=""><span id="id_label_habilitar_comprobantes"><?php echo $this->nm_new_label['habilitar_comprobantes']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['Lookup_habilitar_comprobantes'][] = 'SI'; ?>
