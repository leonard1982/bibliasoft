...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_configuraciones_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_configuraciones_submit_form(var_lineasporfactura, var_consolidararticulos, var_serial, var_fecha, var_activo, var_espaciado, var_nombre_pc, var_nombre_impre, var_refresh_grid_doc, var_desactivar_control_sesion, var_noborrar_tmp_enpos, var_validar_correo_enlinea, var_modificainvpedido, var_apertura_caja, var_caja_movil, var_control_diasmora, var_control_costo, var_activar_console_log, var_pago_automatico, var_tipodoc_pordefecto_pos, var_codproducto_en_facventa, var_dia_limite_pago, var_valor_propina_sugerida, var_ver_xml_fe, var_essociedad, var_grancontr, var_idconfiguraciones, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_configuraciones_submit_form_cb);
