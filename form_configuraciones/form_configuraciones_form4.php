<div id="form_configuraciones_form4" style='<?php echo ($this->tabCssClass["form_configuraciones_form4"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nube_pedidos_label" id="hidden_field_label_nube_pedidos" style="<?php echo $sStyleHidden_nube_pedidos; ?>"><span id="id_label_nube_pedidos"><?php echo $this->nm_new_label['nube_pedidos']; ?></span></TD>
    <TD class="scFormDataOdd css_nube_pedidos_line" id="hidden_field_data_nube_pedidos" style="<?php echo $sStyleHidden_nube_pedidos; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nube_pedidos_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_nube_pedidos'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nube_inventario_label" id="hidden_field_label_nube_inventario" style="<?php echo $sStyleHidden_nube_inventario; ?>"><span id="id_label_nube_inventario"><?php echo $this->nm_new_label['nube_inventario']; ?></span></TD>
    <TD class="scFormDataOdd css_nube_inventario_line" id="hidden_field_data_nube_inventario" style="<?php echo $sStyleHidden_nube_inventario; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nube_inventario_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_nube_inventario'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nube_cartera_label" id="hidden_field_label_nube_cartera" style="<?php echo $sStyleHidden_nube_cartera; ?>"><span id="id_label_nube_cartera"><?php echo $this->nm_new_label['nube_cartera']; ?></span></TD>
    <TD class="scFormDataOdd css_nube_cartera_line" id="hidden_field_data_nube_cartera" style="<?php echo $sStyleHidden_nube_cartera; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nube_cartera_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_nube_cartera'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nube_tesoreria_label" id="hidden_field_label_nube_tesoreria" style="<?php echo $sStyleHidden_nube_tesoreria; ?>"><span id="id_label_nube_tesoreria"><?php echo $this->nm_new_label['nube_tesoreria']; ?></span></TD>
    <TD class="scFormDataOdd css_nube_tesoreria_line" id="hidden_field_data_nube_tesoreria" style="<?php echo $sStyleHidden_nube_tesoreria; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nube_tesoreria_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_nube_tesoreria'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nube_agenda_label" id="hidden_field_label_nube_agenda" style="<?php echo $sStyleHidden_nube_agenda; ?>"><span id="id_label_nube_agenda"><?php echo $this->nm_new_label['nube_agenda']; ?></span></TD>
    <TD class="scFormDataOdd css_nube_agenda_line" id="hidden_field_data_nube_agenda" style="<?php echo $sStyleHidden_nube_agenda; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nube_agenda_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_nube_agenda'][] = 'SI'; ?>
...
?> 
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nube_compras_label" id="hidden_field_label_nube_compras" style="<?php echo $sStyleHidden_nube_compras; ?>"><span id="id_label_nube_compras"><?php echo $this->nm_new_label['nube_compras']; ?></span></TD>
    <TD class="scFormDataOdd css_nube_compras_line" id="hidden_field_data_nube_compras" style="<?php echo $sStyleHidden_nube_compras; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nube_compras_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones']['Lookup_nube_compras'][] = 'SI'; ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nube_codigo_label" id="hidden_field_label_nube_codigo" style="<?php echo $sStyleHidden_nube_codigo; ?>"><span id="id_label_nube_codigo"><?php echo $this->nm_new_label['nube_codigo']; ?></span></TD>
    <TD class="scFormDataOdd css_nube_codigo_line" id="hidden_field_data_nube_codigo" style="<?php echo $sStyleHidden_nube_codigo; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nube_codigo_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_probarnube_label" id="hidden_field_label_probarnube" style="<?php echo $sStyleHidden_probarnube; ?>"><span id="id_label_probarnube"><?php echo $this->nm_new_label['probarnube']; ?></span></TD>
    <TD class="scFormDataOdd css_probarnube_line" id="hidden_field_data_probarnube" style="<?php echo $sStyleHidden_probarnube; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_probarnube_line" style="vertical-align: top;padding: 0px"><?php
