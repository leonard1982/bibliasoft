...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['btn_disabled']['activar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['btn_disabled']['activar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['btn_label']['activar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['btn_label']['activar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['btn_label']['activar'];
        }
?>
<?php echo nmButtonOutput($this->arr_buttons, "activar", "scBtnFn_activar()", "scBtnFn_activar()", "sc_activar_top", "", "" . $buttonMacroLabel . "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "" . $buttonMacroDisabled . "", "", "");?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_minutos_inactividad_line" id="hidden_field_data_minutos_inactividad" style="<?php echo $sStyleHidden_minutos_inactividad; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_minutos_inactividad_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_minutos_inactividad_label" style=""><span id="id_label_minutos_inactividad"><?php echo $this->nm_new_label['minutos_inactividad']; ?></span></span><br>
...
<?php $sStyleHidden_caja_movil_dumb = ('' == $sStyleHidden_caja_movil) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_caja_movil_dumb" style="<?php echo $sStyleHidden_caja_movil_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
