...
<?php $sStyleHidden_validar_correo_enlinea_dumb = ('' == $sStyleHidden_validar_correo_enlinea) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_validar_correo_enlinea_dumb" style="<?php echo $sStyleHidden_validar_correo_enlinea_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
