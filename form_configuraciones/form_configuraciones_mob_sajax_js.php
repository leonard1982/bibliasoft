  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_configuraciones_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_configuraciones_mob_form();
	}
  ...
  function do_ajax_form_configuraciones_mob_validate_lineasporfactura()
  {
    ...
    x_ajax_form_configuraciones_mob_validate_lineasporfactura(var_lineasporfactura, var_script_case_init, do_ajax_form_configuraciones_mob_validate_lineasporfactura_cb);
  } // do_ajax_form_configuraciones_mob_validate_lineasporfactura

  function do_ajax_form_configuraciones_mob_validate_lineasporfactura_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_lineasporfactura_cb

  // ---------- Validate consolidararticulos
  function do_ajax_form_configuraciones_mob_validate_consolidararticulos()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_consolidararticulos(var_consolidararticulos, var_script_case_init, do_ajax_form_configuraciones_mob_validate_consolidararticulos_cb);
  } // do_ajax_form_configuraciones_mob_validate_consolidararticulos

  function do_ajax_form_configuraciones_mob_validate_consolidararticulos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_consolidararticulos_cb

  // ---------- Validate serial
  function do_ajax_form_configuraciones_mob_validate_serial()
  {
    var nomeCampo_serial = "serial";
    var var_serial = scAjaxGetFieldText(nomeCampo_serial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_serial(var_serial, var_script_case_init, do_ajax_form_configuraciones_mob_validate_serial_cb);
  } // do_ajax_form_configuraciones_mob_validate_serial

  function do_ajax_form_configuraciones_mob_validate_serial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "serial";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_serial_cb

  // ---------- Validate fecha
  function do_ajax_form_configuraciones_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldHidden(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_configuraciones_mob_validate_fecha_cb);
  } // do_ajax_form_configuraciones_mob_validate_fecha

  function do_ajax_form_configuraciones_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_fecha_cb

  // ---------- Validate activo
  function do_ajax_form_configuraciones_mob_validate_activo()
  {
    var nomeCampo_activo = "activo";
    var var_activo = scAjaxGetFieldHidden(nomeCampo_activo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_activo(var_activo, var_script_case_init, do_ajax_form_configuraciones_mob_validate_activo_cb);
  } // do_ajax_form_configuraciones_mob_validate_activo

  function do_ajax_form_configuraciones_mob_validate_activo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "activo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_activo_cb

  // ---------- Validate espaciado
  function do_ajax_form_configuraciones_mob_validate_espaciado()
  {
    var nomeCampo_espaciado = "espaciado";
    var var_espaciado = scAjaxGetFieldText(nomeCampo_espaciado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_espaciado(var_espaciado, var_script_case_init, do_ajax_form_configuraciones_mob_validate_espaciado_cb);
  } // do_ajax_form_configuraciones_mob_validate_espaciado

  function do_ajax_form_configuraciones_mob_validate_espaciado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_configuraciones_mob_validate_refresh_grid_doc()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_refresh_grid_doc(var_refresh_grid_doc, var_script_case_init, do_ajax_form_configuraciones_mob_validate_refresh_grid_doc_cb);
  } // do_ajax_form_configuraciones_mob_validate_refresh_grid_doc

  function do_ajax_form_configuraciones_mob_validate_refresh_grid_doc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_refresh_grid_doc_cb

  // ---------- Validate desactivar_control_sesion
  function do_ajax_form_configuraciones_mob_validate_desactivar_control_sesion()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_desactivar_control_sesion(var_desactivar_control_sesion, var_script_case_init, do_ajax_form_configuraciones_mob_validate_desactivar_control_sesion_cb);
  } // do_ajax_form_configuraciones_mob_validate_desactivar_control_sesion

  function do_ajax_form_configuraciones_mob_validate_desactivar_control_sesion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_configuraciones_mob_validate_essociedad()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_essociedad(var_essociedad, var_script_case_init, do_ajax_form_configuraciones_mob_validate_essociedad_cb);
  } // do_ajax_form_configuraciones_mob_validate_essociedad

  function do_ajax_form_configuraciones_mob_validate_essociedad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_essociedad_cb

  // ---------- Validate grancontr
  function do_ajax_form_configuraciones_mob_validate_grancontr()
  {
    var nomeCampo_grancontr = "grancontr";
    var var_grancontr = scAjaxGetFieldCheckbox(nomeCampo_grancontr, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_grancontr(var_grancontr, var_script_case_init, do_ajax_form_configuraciones_mob_validate_grancontr_cb);
  } // do_ajax_form_configuraciones_mob_validate_grancontr

  function do_ajax_form_configuraciones_mob_validate_grancontr_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_grancontr_cb

  // ---------- Validate idconfiguraciones
  function do_ajax_form_configuraciones_mob_validate_idconfiguraciones()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_idconfiguraciones(var_idconfiguraciones, var_script_case_init, do_ajax_form_configuraciones_mob_validate_idconfiguraciones_cb);
  } // do_ajax_form_configuraciones_mob_validate_idconfiguraciones

  function do_ajax_form_configuraciones_mob_validate_idconfiguraciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_configuraciones_mob_validate_ver_busqueda_refinada()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_busqueda_refinada(var_ver_busqueda_refinada, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_busqueda_refinada_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_busqueda_refinada

  function do_ajax_form_configuraciones_mob_validate_ver_busqueda_refinada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_configuraciones_mob_validate_validar_codbarras()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_validar_codbarras(var_validar_codbarras, var_script_case_init, do_ajax_form_configuraciones_mob_validate_validar_codbarras_cb);
  } // do_ajax_form_configuraciones_mob_validate_validar_codbarras

  function do_ajax_form_configuraciones_mob_validate_validar_codbarras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_validar_codbarras_cb
  ...
  function do_ajax_form_configuraciones_mob_validate_ver_grupo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_grupo(var_ver_grupo, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_grupo_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_grupo

  function do_ajax_form_configuraciones_mob_validate_ver_grupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_grupo_cb

  // ---------- Validate ver_codigo
  function do_ajax_form_configuraciones_mob_validate_ver_codigo()
  {
    var nomeCampo_ver_codigo = "ver_codigo";
    var var_ver_codigo = scAjaxGetFieldCheckbox(nomeCampo_ver_codigo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_codigo(var_ver_codigo, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_codigo_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_codigo

  function do_ajax_form_configuraciones_mob_validate_ver_codigo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_codigo_cb

  // ---------- Validate ver_imagen
  function do_ajax_form_configuraciones_mob_validate_ver_imagen()
  {
    var nomeCampo_ver_imagen = "ver_imagen";
    var var_ver_imagen = scAjaxGetFieldCheckbox(nomeCampo_ver_imagen, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_imagen(var_ver_imagen, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_imagen_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_imagen

  function do_ajax_form_configuraciones_mob_validate_ver_imagen_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_imagen_cb

  // ---------- Validate ver_existencia
  function do_ajax_form_configuraciones_mob_validate_ver_existencia()
  {
    var nomeCampo_ver_existencia = "ver_existencia";
    var var_ver_existencia = scAjaxGetFieldCheckbox(nomeCampo_ver_existencia, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_existencia(var_ver_existencia, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_existencia_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_existencia

  function do_ajax_form_configuraciones_mob_validate_ver_existencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_existencia_cb

  // ---------- Validate ver_unidad
  function do_ajax_form_configuraciones_mob_validate_ver_unidad()
  {
    var nomeCampo_ver_unidad = "ver_unidad";
    var var_ver_unidad = scAjaxGetFieldCheckbox(nomeCampo_ver_unidad, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_unidad(var_ver_unidad, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_unidad_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_unidad

  function do_ajax_form_configuraciones_mob_validate_ver_unidad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_unidad_cb

  // ---------- Validate ver_precio
  function do_ajax_form_configuraciones_mob_validate_ver_precio()
  {
    var nomeCampo_ver_precio = "ver_precio";
    var var_ver_precio = scAjaxGetFieldCheckbox(nomeCampo_ver_precio, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_precio(var_ver_precio, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_precio_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_precio

  function do_ajax_form_configuraciones_mob_validate_ver_precio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_precio_cb

  // ---------- Validate ver_impuesto
  function do_ajax_form_configuraciones_mob_validate_ver_impuesto()
  {
    var nomeCampo_ver_impuesto = "ver_impuesto";
    var var_ver_impuesto = scAjaxGetFieldCheckbox(nomeCampo_ver_impuesto, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_impuesto(var_ver_impuesto, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_impuesto_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_impuesto

  function do_ajax_form_configuraciones_mob_validate_ver_impuesto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_impuesto_cb

  // ---------- Validate ver_stock
  function do_ajax_form_configuraciones_mob_validate_ver_stock()
  {
    var nomeCampo_ver_stock = "ver_stock";
    var var_ver_stock = scAjaxGetFieldCheckbox(nomeCampo_ver_stock, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_stock(var_ver_stock, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_stock_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_stock

  function do_ajax_form_configuraciones_mob_validate_ver_stock_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_stock_cb

  // ---------- Validate ver_ubicacion
  function do_ajax_form_configuraciones_mob_validate_ver_ubicacion()
  {
    var nomeCampo_ver_ubicacion = "ver_ubicacion";
    var var_ver_ubicacion = scAjaxGetFieldCheckbox(nomeCampo_ver_ubicacion, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_ubicacion(var_ver_ubicacion, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_ubicacion_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_ubicacion

  function do_ajax_form_configuraciones_mob_validate_ver_ubicacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_ubicacion_cb

  // ---------- Validate ver_costo
  function do_ajax_form_configuraciones_mob_validate_ver_costo()
  {
    var nomeCampo_ver_costo = "ver_costo";
    var var_ver_costo = scAjaxGetFieldCheckbox(nomeCampo_ver_costo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_costo(var_ver_costo, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_costo_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_costo

  function do_ajax_form_configuraciones_mob_validate_ver_costo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_costo_cb

  // ---------- Validate ver_proveedor
  function do_ajax_form_configuraciones_mob_validate_ver_proveedor()
  {
    var nomeCampo_ver_proveedor = "ver_proveedor";
    var var_ver_proveedor = scAjaxGetFieldCheckbox(nomeCampo_ver_proveedor, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_proveedor(var_ver_proveedor, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_proveedor_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_proveedor

  function do_ajax_form_configuraciones_mob_validate_ver_proveedor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_proveedor_cb

  // ---------- Validate ver_combo
  function do_ajax_form_configuraciones_mob_validate_ver_combo()
  {
    var nomeCampo_ver_combo = "ver_combo";
    var var_ver_combo = scAjaxGetFieldCheckbox(nomeCampo_ver_combo, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_combo(var_ver_combo, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_combo_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_combo

  function do_ajax_form_configuraciones_mob_validate_ver_combo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_combo_cb

  // ---------- Validate ver_agregar_nota
  function do_ajax_form_configuraciones_mob_validate_ver_agregar_nota()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_configuraciones_mob_validate_ver_agregar_nota(var_ver_agregar_nota, var_script_case_init, do_ajax_form_configuraciones_mob_validate_ver_agregar_nota_cb);
  } // do_ajax_form_configuraciones_mob_validate_ver_agregar_nota

  function do_ajax_form_configuraciones_mob_validate_ver_agregar_nota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_configuraciones_mob_validate_ver_agregar_nota_cb
  ...
  function do_ajax_form_configuraciones_mob_event_apertura_caja_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_configuraciones_mob_event_apertura_caja_onclick(var_apertura_caja, var_idconfiguraciones, var_script_case_init, do_ajax_form_configuraciones_mob_event_apertura_caja_onclick_cb);
  } // do_ajax_form_configuraciones_mob_event_apertura_caja_onclick

  function do_ajax_form_configuraciones_mob_event_apertura_caja_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "apertura_caja";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_configuraciones_mob_event_apertura_caja_onclick_cb_after_alert);
  } // do_ajax_form_configuraciones_mob_event_apertura_caja_onclick_cb
  function do_ajax_form_configuraciones_mob_event_apertura_caja_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_configuraciones_mob_event_apertura_caja_onclick_cb_after_alert

  // ---------- Event onclick serial
  function do_ajax_form_configuraciones_mob_event_serial_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_configuraciones_mob_event_serial_onclick(var_script_case_init, do_ajax_form_configuraciones_mob_event_serial_onclick_cb);
  } // do_ajax_form_configuraciones_mob_event_serial_onclick

  function do_ajax_form_configuraciones_mob_event_serial_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "serial";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_configuraciones_mob_event_serial_onclick_cb_after_alert);
  } // do_ajax_form_configuraciones_mob_event_serial_onclick_cb
  function do_ajax_form_configuraciones_mob_event_serial_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_configuraciones_mob_event_serial_onclick_cb_after_alert

  // ---------- Event onfocus serial
  function do_ajax_form_configuraciones_mob_event_serial_onfocus()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_configuraciones_mob_event_serial_onfocus(var_script_case_init, do_ajax_form_configuraciones_mob_event_serial_onfocus_cb);
  } // do_ajax_form_configuraciones_mob_event_serial_onfocus

  function do_ajax_form_configuraciones_mob_event_serial_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "serial";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_configuraciones_mob_event_serial_onfocus_cb_after_alert);
  } // do_ajax_form_configuraciones_mob_event_serial_onfocus_cb
  function do_ajax_form_configuraciones_mob_event_serial_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_configuraciones_mob_event_serial_onfocus_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_configuraciones_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_configuraciones_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_configuraciones_mob_submit_form_cb_after_alert);
  } // do_ajax_form_configuraciones_mob_submit_form_cb
  function do_ajax_form_configuraciones_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_configuraciones_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_configuraciones_mob_navigate_form()
  {
    perform_ajax_form_configuraciones_mob_navigate_form();
  }

  function perform_ajax_form_configuraciones_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_configuraciones_mob_navigate_form(var_idconfiguraciones, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_configuraciones_mob_navigate_form_cb);
  } // do_ajax_form_configuraciones_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_configuraciones_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_configuraciones_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_configuraciones_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_configuraciones_mob_navigate_form_cb
  function do_ajax_form_configuraciones_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_configuraciones_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_configuraciones_mob_navigate_form_cb_after_alert
  function sc_hide_form_configuraciones_mob_form()
  {
