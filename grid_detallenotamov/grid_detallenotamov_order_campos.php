<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_detallenotamov']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEBv_2022.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_detallenotamov_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallenotamov_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["producto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["producto"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["producto"] : "Producto";
   $tab_ger_campos['colores'] = "on";
   $tab_def_campos['colores'] = "colores";
   $tab_labels["colores"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["colores"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["colores"] : "Color";
   $tab_ger_campos['tallas'] = "on";
   $tab_def_campos['tallas'] = "tallas";
   $tab_labels["tallas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["tallas"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["tallas"] : "Talla";
   $tab_ger_campos['sabor'] = "on";
   $tab_def_campos['sabor'] = "sabor";
   $tab_labels["sabor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["sabor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["sabor"] : "Sabor";
   $tab_ger_campos['destino'] = "on";
   $tab_def_campos['destino'] = "destino";
   $tab_labels["destino"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["destino"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["destino"] : "Destino";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['presentacion'] = "on";
   $tab_def_campos['presentacion'] = "presentacion";
   $tab_labels["presentacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["presentacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['labels']["presentacion"] : "Presentación";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE>Detalle productos enviados de producción a Ventas</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallenotamov_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallenotamov']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
