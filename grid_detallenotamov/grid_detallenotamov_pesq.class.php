 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idnota_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idnota'])) ? $this->New_label['idnota'] : "Idnota"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idnota_cond" name="idnota_cond" onChange="nm_campos_between(document.getElementById('id_vis_idnota'), this, 'idnota')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idnota" <?php echo $str_hide_idnota?> valign="top">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idnota" id="id_ac_idnota" name="idnota_autocomp"><?php if ('' !=  $idnota) { ?><option value="<?php echo $idnota ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idnota"  <?php echo $str_display_idnota; ?> class="scFilterFieldFontOdd">
      ...
      <TD id='SC_idmovi_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idmovi'])) ? $this->New_label['idmovi'] : "Nota Inv."; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idmovi_cond" name="idmovi_cond" onChange="nm_campos_between(document.getElementById('id_vis_idmovi'), this, 'idmovi')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idmovi" <?php echo $str_hide_idmovi?> valign="top">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-idmovi" id="id_ac_idmovi" name="idmovi_autocomp"><?php if ('' !=  $idmovi) { ?><option value="<?php echo $idmovi ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idmovi"  <?php echo $str_display_idmovi; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idmovi_input_2" name="idmovi_input_2" value="<?php echo NM_encode_input($idmovi_input_2) ?>"  size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-producto" id="id_ac_producto" name="producto_autocomp"><?php if ('' !=  $producto) { ?><option value="<?php echo $producto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_producto"  <?php echo $str_display_producto; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
      ...
      <TD id='SC_destino_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['destino'])) ? $this->New_label['destino'] : "Destino"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_destino_cond" name="destino_cond" onChange="nm_campos_between(document.getElementById('id_vis_destino'), this, 'destino')">
     ...
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_destino" <?php echo $str_hide_destino?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-destino" id="id_ac_destino" name="destino_autocomp"><?php if ('' !=  $destino) { ?><option value="<?php echo $destino ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_destino"  <?php echo $str_display_destino; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_destino_input_2" name="destino_input_2" value="<?php echo NM_encode_input($destino_input_2) ?>"  size=2 alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
