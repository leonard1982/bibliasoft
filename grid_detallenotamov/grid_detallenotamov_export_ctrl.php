<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallenotamov']['sc_process_barr'] = true;
require_once('../grid_detallenotamov/index.php');
unset($_SESSION['scriptcase']['grid_detallenotamov']['sc_process_barr']);
$ExportCtrl = new grid_detallenotamov_export_control;
$ExportCtrl->Export_barr();

class grid_detallenotamov_export_control
{
