...
class grid_detallenotamov_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detallenotamov_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detallenotamov_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detallenotamov_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idnota')
      {
          $idnota = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idnota($idnota);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idmovi')
      {
          $idmovi = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idmovi($idmovi);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_destino')
      {
          $destino = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_destino($destino);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_idnota($idnota)
   {
      $idnota = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idnota);
      $idnota = substr($this->Db->qstr($idnota), 1, -1);
            $idnota_look = substr($this->Db->qstr($idnota), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idnota from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and   CAST (idnota AS TEXT)  like '%" . $idnota . "%' order by idnota"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idnota from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and   CAST (idnota AS VARCHAR)  like '%" . $idnota . "%' order by idnota"; 
      }
      else
      {
          $nm_comando = "select distinct idnota from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and  idnota like '%" . $idnota . "%' order by idnota"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_idmovi($idmovi)
   {
      $idmovi = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idmovi);
      $idmovi = substr($this->Db->qstr($idmovi), 1, -1);
            $idmovi_look = substr($this->Db->qstr($idmovi), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idmovi from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and   CAST (idmovi AS TEXT)  like '%" . $idmovi . "%' order by idmovi"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idmovi from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and   CAST (idmovi AS VARCHAR)  like '%" . $idmovi . "%' order by idmovi"; 
      }
      else
      {
          $nm_comando = "select distinct idmovi from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and  idmovi like '%" . $idmovi . "%' order by idmovi"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   {
      $producto = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $producto);
      $producto = substr($this->Db->qstr($producto), 1, -1);
            $producto_look = substr($this->Db->qstr($producto), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct producto from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and   CAST (producto AS TEXT)  like '%" . $producto . "%' order by producto"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct producto from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and   CAST (producto AS VARCHAR)  like '%" . $producto . "%' order by producto"; 
      }
      else
      {
          $nm_comando = "select distinct producto from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and  producto like '%" . $producto . "%' order by producto"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_destino($destino)
   {
      $destino = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $destino);
      $destino = substr($this->Db->qstr($destino), 1, -1);
            $destino_look = substr($this->Db->qstr($destino), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct destino from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and   CAST (destino AS TEXT)  like '%" . $destino . "%' order by destino"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct destino from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and   CAST (destino AS VARCHAR)  like '%" . $destino . "%' order by destino"; 
      }
      else
      {
          $nm_comando = "select distinct destino from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and  destino like '%" . $destino . "%' order by destino"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idnota";$Nm_numeric[] = "idmovi";$Nm_numeric[] = "producto";$Nm_numeric[] = "destino";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "colores";$Nm_numeric[] = "tallas";$Nm_numeric[] = "sabor";$Nm_numeric[] = "idnota";$Nm_numeric[] = "idmovi";$Nm_numeric[] = "producto";$Nm_numeric[] = "destino";$Nm_numeric[] = "cantidad";$Nm_numeric[] = "colores";$Nm_numeric[] = "tallas";$Nm_numeric[] = "sabor";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detallenotamov/grid_detallenotamov_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detallenotamov_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detallenotamov_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detallenotamov_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallenotamov']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallenotamov']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idnota_cond#NMF#' + search_get_sel_txt('SC_idnota_cond') + '@NMF@';
  str_out += 'SC_idnota#NMF#' + search_get_text('SC_idnota') + '@NMF@';
  str_out += 'id_ac_idnota#NMF#' + search_get_title('select2-id_ac_idnota-container') + '@NMF@';
  str_out += 'SC_idnota_input_2#NMF#' + search_get_text('SC_idnota_input_2') + '@NMF@';
  str_out += 'SC_idmovi_cond#NMF#' + search_get_sel_txt('SC_idmovi_cond') + '@NMF@';
  str_out += 'SC_idmovi#NMF#' + search_get_text('SC_idmovi') + '@NMF@';
  str_out += 'id_ac_idmovi#NMF#' + search_get_title('select2-id_ac_idmovi-container') + '@NMF@';
  str_out += 'SC_idmovi_input_2#NMF#' + search_get_text('SC_idmovi_input_2') + '@NMF@';
  ...
  str_out += 'SC_producto_input_2#NMF#' + search_get_text('SC_producto_input_2') + '@NMF@';
  str_out += 'SC_destino_cond#NMF#' + search_get_sel_txt('SC_destino_cond') + '@NMF@';
  str_out += 'SC_destino#NMF#' + search_get_text('SC_destino') + '@NMF@';
  str_out += 'id_ac_destino#NMF#' + search_get_title('select2-id_ac_destino-container') + '@NMF@';
  str_out += 'SC_destino_input_2#NMF#' + search_get_text('SC_destino_input_2') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  ...
  $(".sc-ui-autocomp-destino").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_destino",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_destino").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-idnota").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idnota",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_idnota").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-idmovi").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idmovi",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_idmovi").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Detalle productos enviados de producción a Ventas</span></td>
...
<?php
   ...
   {
      global 
             $idnota_cond, $idnota, $idnota_input_2, $idnota_autocomp,
             $idmovi_cond, $idmovi, $idmovi_input_2, $idmovi_autocomp,
             $producto_cond, $producto, $producto_input_2, $producto_autocomp,
             $destino_cond, $destino, $destino_input_2, $destino_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idnota = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idnota']; 
          $idnota_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idnota_input_2']; 
          $idnota_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idnota_cond']; 
          $idmovi = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idmovi']; 
          $idmovi_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idmovi_input_2']; 
          $idmovi_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idmovi_cond']; 
          $producto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['producto']; 
          $producto_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['producto_input_2']; 
          $producto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['producto_cond']; 
          $destino = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['destino']; 
          $destino_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['destino_input_2']; 
          $destino_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['destino_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idnota_cond) || empty($idnota_cond))
      {
         $idnota_cond = "gt";
      }
      if (!isset($idmovi_cond) || empty($idmovi_cond))
      {
         $idmovi_cond = "gt";
      }
      ...
      if (!isset($destino_cond) || empty($destino_cond))
      {
         $destino_cond = "gt";
      }
      ...
      $str_hide_idnota = (in_array($idnota_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idmovi = (in_array($idmovi_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_producto = (in_array($producto_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_destino = (in_array($destino_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idnota = ('bw' == $idnota_cond) ? $display_aberto : $display_fechado;
      $str_display_idmovi = ('bw' == $idmovi_cond) ? $display_aberto : $display_fechado;
      $str_display_producto = ('bw' == $producto_cond) ? $display_aberto : $display_fechado;
      $str_display_destino = ('bw' == $destino_cond) ? $display_aberto : $display_fechado;

      if (!isset($idnota) || $idnota == "")
      {
          $idnota = "";
      }
      if (isset($idnota) && !empty($idnota))
      {
         $tmp_pos = strpos($idnota, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idnota = substr($idnota, 0, $tmp_pos);
         }
      }
      if (!isset($idmovi) || $idmovi == "")
      {
          $idmovi = "";
      }
      if (isset($idmovi) && !empty($idmovi))
      {
         $tmp_pos = strpos($idmovi, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idmovi = substr($idmovi, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($destino, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $destino = substr($destino, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
 ...
 $nmgp_tab_label .= "idnota?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idnota_cond" name="idnota_cond" onChange="nm_campos_between(document.getElementById('id_vis_idnota'), this, 'idnota')">
       <OPTION value="gt" <?php if ("gt" == $idnota_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idnota_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idnota_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idnota_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idnota"  <?php echo $str_hide_idnota?>><?php
      if ($idnota != "")
      {
      $idnota_look = substr($this->Db->qstr($idnota), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idnota from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and idnota = $idnota_look order by idnota"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idnota from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and idnota = $idnota_look order by idnota"; 
      ...
      if (isset($nmgp_def_dados[0][$idnota]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idnota];
      }
      else
      {
            nmgp_Form_Num_Val($idnota, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idnota;
      }
?>
<INPUT  type="text" id="SC_idnota" name="idnota" value="<?php echo NM_encode_input($idnota) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idnota" id="id_ac_idnota" name="idnota_autocomp"><?php if ('' !=  $idnota) { ?><option value="<?php echo $idnota ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idnota"  <?php echo $str_display_idnota; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idnota_input_2" name="idnota_input_2" value="<?php echo NM_encode_input($idnota_input_2) ?>"  size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "idmovi?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idmovi_cond" name="idmovi_cond" onChange="nm_campos_between(document.getElementById('id_vis_idmovi'), this, 'idmovi')">
       <OPTION value="gt" <?php if ("gt" == $idmovi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idmovi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idmovi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idmovi_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idmovi"  <?php echo $str_hide_idmovi?>><?php
      if ($idmovi != "")
      {
      $idmovi_look = substr($this->Db->qstr($idmovi), 1, -1); 
      $nmgp_def_dados = array(); 
   if (is_numeric($idmovi))
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idmovi from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and idmovi = $idmovi_look order by idmovi"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idmovi from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and idmovi = $idmovi_look order by idmovi"; 
      ...
      if (isset($nmgp_def_dados[0][$idmovi]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idmovi];
      }
      else
      {
            nmgp_Form_Num_Val($idmovi, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idmovi;
      }
?>
<INPUT  type="text" id="SC_idmovi" name="idmovi" value="<?php echo NM_encode_input($idmovi) ?>" size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-idmovi" id="id_ac_idmovi" name="idmovi_autocomp"><?php if ('' !=  $idmovi) { ?><option value="<?php echo $idmovi ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idmovi"  <?php echo $str_display_idmovi; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idmovi_input_2" name="idmovi_input_2" value="<?php echo NM_encode_input($idmovi_input_2) ?>"  size=12 alt="{datatype: 'integer', maxLength: 12, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_producto_cond" name="producto_cond" onChange="nm_campos_between(document.getElementById('id_vis_producto'), this, 'producto')">
       ...
       <OPTION value="bw" <?php if ("bw" == $producto_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct producto from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and producto = $producto_look order by producto"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct producto from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and producto = $producto_look order by producto"; 
      ...
      {
            nmgp_Form_Num_Val($producto, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $producto;
      }
?>
<INPUT  type="text" id="SC_producto" name="producto" value="<?php echo NM_encode_input($producto) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-producto" id="id_ac_producto" name="producto_autocomp"><?php if ('' !=  $producto) { ?><option value="<?php echo $producto ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_producto"  <?php echo $str_display_producto; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_producto_input_2" name="producto_input_2" value="<?php echo NM_encode_input($producto_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
 ...
 $nmgp_tab_label .= "destino?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_destino_cond" name="destino_cond" onChange="nm_campos_between(document.getElementById('id_vis_destino'), this, 'destino')">
       <OPTION value="gt" <?php if ("gt" == $destino_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $destino_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $destino_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $destino_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_destino"  <?php echo $str_hide_destino?>><?php
      if ($destino != "")
      {
      $destino_look = substr($this->Db->qstr($destino), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct destino from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and destino = $destino_look order by destino"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct destino from " . $this->Ini->nm_tabela . " where idmovi=" . $_SESSION['par_numero'] . " and destino = $destino_look order by destino"; 
      ...
      if (isset($nmgp_def_dados[0][$destino]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$destino];
      }
      else
      {
            nmgp_Form_Num_Val($destino, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $destino;
      }
?>
<INPUT  type="text" id="SC_destino" name="destino" value="<?php echo NM_encode_input($destino) ?>" size=2 alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-destino" id="id_ac_destino" name="destino_autocomp"><?php if ('' !=  $destino) { ?><option value="<?php echo $destino ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_destino"  <?php echo $str_display_destino; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_destino_input_2" name="destino_input_2" value="<?php echo NM_encode_input($destino_input_2) ?>"  size=2 alt="{datatype: 'integer', maxLength: 2, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
...
?>
<?php
   if (is_file("grid_detallenotamov_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallenotamov']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detallenotamov']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idnota_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idnota'), document.F1.idnota_cond, 'idnota');
   document.F1.idnota.value = "";
   document.F1.idnota_autocomp.value = "";
   $('#select2-id_ac_idnota-container').html('<?php echo $this->Val_init_idnota['desc'] ?>');;
   document.F1.idnota_input_2.value = "";
   document.F1.idmovi_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idmovi'), document.F1.idmovi_cond, 'idmovi');
   document.F1.idmovi.value = "";
   document.F1.idmovi_autocomp.value = "";
   $('#select2-id_ac_idmovi-container').html('<?php echo $this->Val_init_idmovi['desc'] ?>');;
   document.F1.idmovi_input_2.value = "";
   ...
   document.F1.producto_input_2.value = "";
   document.F1.destino_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_destino'), document.F1.destino_cond, 'destino');
   document.F1.destino.value = "";
   document.F1.destino_autocomp.value = "";
   $('#select2-id_ac_destino-container').html('<?php echo $this->Val_init_destino['desc'] ?>');;
   document.F1.destino_input_2.value = "";
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_detallenotamov";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idnota_cond'] = 'cond';
      $tp_fields['SC_idnota'] = 'text_aut';
      $tp_fields['id_ac_idnota'] = 'select2_aut';
      $tp_fields['SC_idnota_input_2'] = 'text';
      $tp_fields['SC_idmovi_cond'] = 'cond';
      $tp_fields['SC_idmovi'] = 'text_aut';
      $tp_fields['id_ac_idmovi'] = 'select2_aut';
      $tp_fields['SC_idmovi_input_2'] = 'text';
      $tp_fields['SC_producto_cond'] = 'cond';
      $tp_fields['SC_producto'] = 'text_aut';
      $tp_fields['id_ac_producto'] = 'select2_aut';
      $tp_fields['SC_producto_input_2'] = 'text';
      $tp_fields['SC_destino_cond'] = 'cond';
      $tp_fields['SC_destino'] = 'text_aut';
      $tp_fields['id_ac_destino'] = 'select2_aut';
      $tp_fields['SC_destino_input_2'] = 'text';
   ...
   {
      global $idnota_cond, $idnota, $idnota_input_2, $idnota_autocomp,
             $idmovi_cond, $idmovi, $idmovi_input_2, $idmovi_autocomp,
             $producto_cond, $producto, $producto_input_2, $producto_autocomp,
             $destino_cond, $destino, $destino_input_2, $destino_autocomp, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($idnota_autocomp) && empty($idnota))
      {
          $idnota = $idnota_autocomp;
      }
      if (!empty($idmovi_autocomp) && empty($idmovi))
      {
          $idmovi = $idmovi_autocomp;
      }
      if (!empty($producto_autocomp) && empty($producto))
      {
          $producto = $producto_autocomp;
      }
      if (!empty($destino_autocomp) && empty($destino))
      {
          $destino = $destino_autocomp;
      }
      $idnota_cond_salva = $idnota_cond; 
      if (!isset($idnota_input_2) || $idnota_input_2 == "")
      {
          $idnota_input_2 = $idnota;
      }
      $idmovi_cond_salva = $idmovi_cond; 
      if (!isset($idmovi_input_2) || $idmovi_input_2 == "")
      {
          $idmovi_input_2 = $idmovi;
      }
      ...
      $destino_cond_salva = $destino_cond; 
      if (!isset($destino_input_2) || $destino_input_2 == "")
      {
          $destino_input_2 = $destino;
      }
      if ($idnota_cond != "in")
      {
          nm_limpa_numero($idnota, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idnota_cond != "in")
      {
          nm_limpa_numero($idnota_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idmovi_cond != "in")
      {
          nm_limpa_numero($idmovi, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idmovi_cond != "in")
      {
          nm_limpa_numero($idmovi_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($producto_cond != "in")
      {
      ...
      if ($producto_cond != "in")
      {
          nm_limpa_numero($producto_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($destino_cond != "in")
      {
          nm_limpa_numero($destino, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($destino_cond != "in")
      {
          nm_limpa_numero($destino_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idnota'] = $idnota; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idnota_input_2'] = $idnota_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idnota_cond'] = $idnota_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idmovi'] = $idmovi; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idmovi_input_2'] = $idmovi_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['idmovi_cond'] = $idmovi_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['producto'] = $producto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['producto_input_2'] = $producto_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['producto_cond'] = $producto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['destino'] = $destino; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['destino_input_2'] = $destino_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['destino_cond'] = $destino_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca'] = $Temp_Busca;
      }
      if ($idnota_cond != "in" && $idnota_cond != "bw" && !empty($idnota) && !is_numeric($idnota))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idnota";
      }
      if ($idnota_cond == "bw" && ((!empty($idnota) && !is_numeric($idnota)) || (!empty($idnota_input_2) && !is_numeric($idnota_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idnota";
      }
      if ($idmovi_cond != "in" && $idmovi_cond != "bw" && !empty($idmovi) && !is_numeric($idmovi))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Nota Inv.";
      }
      if ($idmovi_cond == "bw" && ((!empty($idmovi) && !is_numeric($idmovi)) || (!empty($idmovi_input_2) && !is_numeric($idmovi_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Nota Inv.";
      }
      if ($producto_cond != "in" && $producto_cond != "bw" && !empty($producto) && !is_numeric($producto))
      {
      ...
      if ($producto_cond == "bw" && ((!empty($producto) && !is_numeric($producto)) || (!empty($producto_input_2) && !is_numeric($producto_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Producto";
      }
      if ($destino_cond != "in" && $destino_cond != "bw" && !empty($destino) && !is_numeric($destino))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Destino";
      }
      if ($destino_cond == "bw" && ((!empty($destino) && !is_numeric($destino)) || (!empty($destino_input_2) && !is_numeric($destino_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Destino";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idnota'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idnota'] = $cmp1;
      }
      else
      {
          $cmp1 = $idnota;
      ...
      $Conteudo = $idnota_input_2;
      if (strtoupper($idnota_cond) != "II" && strtoupper($idnota_cond) != "QP" && strtoupper($idnota_cond) != "NP" && strtoupper($idnota_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idnota_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($idmovi != '') {
      $idmovi_look = substr($this->Db->qstr($idmovi), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idmovi'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['idmovi'] = $cmp1;
      }
      else
      {
          $cmp1 = $idmovi;
      ...
      $Conteudo = $idmovi_input_2;
      if (strtoupper($idmovi_cond) != "II" && strtoupper($idmovi_cond) != "QP" && strtoupper($idmovi_cond) != "NP" && strtoupper($idmovi_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idmovi_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($producto != '') {
      $producto_look = substr($this->Db->qstr($producto), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['destino'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['destino'] = $cmp1;
      }
      else
      {
          $cmp1 = $destino;
      ...
      $Conteudo = $destino_input_2;
      if (strtoupper($destino_cond) != "II" && strtoupper($destino_cond) != "QP" && strtoupper($destino_cond) != "NP" && strtoupper($destino_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['destino_input_2'] = $Conteudo;

      //----- $idnota
      $this->Date_part = false;
      if (isset($idnota) || $idnota_cond == "nu" || $idnota_cond == "nn" || $idnota_cond == "ep" || $idnota_cond == "ne")
      {
         $this->monta_condicao("idnota", $idnota_cond, $idnota, $idnota_input_2, "idnota");
      }

      //----- $idmovi
      $this->Date_part = false;
      if (isset($idmovi) || $idmovi_cond == "nu" || $idmovi_cond == "nn" || $idmovi_cond == "ep" || $idmovi_cond == "ne")
      {
         $this->monta_condicao("idmovi", $idmovi_cond, $idmovi, $idmovi_input_2, "idmovi");
      }
      ...
      {
         $this->monta_condicao("producto", $producto_cond, $producto, $producto_input_2, "producto");
      }

      //----- $destino
      $this->Date_part = false;
      if (isset($destino) || $destino_cond == "nu" || $destino_cond == "nn" || $destino_cond == "ep" || $destino_cond == "ne")
      {
         $this->monta_condicao("destino", $destino_cond, $destino, $destino_input_2, "destino");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallenotamov']['cond_pesq'] .= $this->NM_operador;
