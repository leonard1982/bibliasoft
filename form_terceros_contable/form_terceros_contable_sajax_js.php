  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_terceros_contable" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_terceros_contable_form();
	}
...
?>
  ...
  // ---------- Validate documento_
  function do_ajax_form_terceros_contable_validate_documento_(iNumLinha)
  {
    var nomeCampo_documento_ = "documento_" + iNumLinha;
    var var_documento_ = scAjaxGetFieldHidden(nomeCampo_documento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contable_validate_documento_(var_documento_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contable_validate_documento__cb);
  } // do_ajax_form_terceros_contable_validate_documento_

  function do_ajax_form_terceros_contable_validate_documento__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contable_validate_documento__cb

  // ---------- Validate nombres_
  function do_ajax_form_terceros_contable_validate_nombres_(iNumLinha)
  {
    var nomeCampo_nombres_ = "nombres_" + iNumLinha;
    var var_nombres_ = scAjaxGetFieldHidden(nomeCampo_nombres_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contable_validate_nombres_(var_nombres_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contable_validate_nombres__cb);
  } // do_ajax_form_terceros_contable_validate_nombres_

  function do_ajax_form_terceros_contable_validate_nombres__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contable_validate_nombres__cb

  // ---------- Validate cliente_
  function do_ajax_form_terceros_contable_validate_cliente_(iNumLinha)
  {
    var nomeCampo_cliente_ = "cliente_" + iNumLinha;
    var var_cliente_ = scAjaxGetFieldHidden(nomeCampo_cliente_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contable_validate_cliente_(var_cliente_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contable_validate_cliente__cb);
  } // do_ajax_form_terceros_contable_validate_cliente_

  function do_ajax_form_terceros_contable_validate_cliente__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contable_validate_cliente__cb

  // ---------- Validate empleado_
  function do_ajax_form_terceros_contable_validate_empleado_(iNumLinha)
  {
    var nomeCampo_empleado_ = "empleado_" + iNumLinha;
    var var_empleado_ = scAjaxGetFieldHidden(nomeCampo_empleado_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contable_validate_empleado_(var_empleado_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contable_validate_empleado__cb);
  } // do_ajax_form_terceros_contable_validate_empleado_

  function do_ajax_form_terceros_contable_validate_empleado__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "empleado_" + iLineNumber;
    }
    else
    {
      sFieldValid = "empleado_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "empleado_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "empleado_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contable_validate_empleado__cb

  // ---------- Validate proveedor_
  function do_ajax_form_terceros_contable_validate_proveedor_(iNumLinha)
  {
    var nomeCampo_proveedor_ = "proveedor_" + iNumLinha;
    var var_proveedor_ = scAjaxGetFieldHidden(nomeCampo_proveedor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contable_validate_proveedor_(var_proveedor_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contable_validate_proveedor__cb);
  } // do_ajax_form_terceros_contable_validate_proveedor_

  function do_ajax_form_terceros_contable_validate_proveedor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contable_validate_proveedor__cb

  // ---------- Validate puc_auxiliar_proveedores_
  function do_ajax_form_terceros_contable_validate_puc_auxiliar_proveedores_(iNumLinha)
  {
    var nomeCampo_puc_auxiliar_proveedores_ = "puc_auxiliar_proveedores_" + iNumLinha;
    var var_puc_auxiliar_proveedores_ = scAjaxGetFieldSelect(nomeCampo_puc_auxiliar_proveedores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contable_validate_puc_auxiliar_proveedores_(var_puc_auxiliar_proveedores_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contable_validate_puc_auxiliar_proveedores__cb);
  } // do_ajax_form_terceros_contable_validate_puc_auxiliar_proveedores_

  function do_ajax_form_terceros_contable_validate_puc_auxiliar_proveedores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "puc_auxiliar_proveedores_" + iLineNumber;
    }
    else
    {
      sFieldValid = "puc_auxiliar_proveedores_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "puc_auxiliar_proveedores_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "puc_auxiliar_proveedores_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contable_validate_puc_auxiliar_proveedores__cb

  // ---------- Validate puc_auxiliar_deudores_
  function do_ajax_form_terceros_contable_validate_puc_auxiliar_deudores_(iNumLinha)
  {
    var nomeCampo_puc_auxiliar_deudores_ = "puc_auxiliar_deudores_" + iNumLinha;
    var var_puc_auxiliar_deudores_ = scAjaxGetFieldSelect(nomeCampo_puc_auxiliar_deudores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contable_validate_puc_auxiliar_deudores_(var_puc_auxiliar_deudores_, iNumLinha, var_script_case_init, do_ajax_form_terceros_contable_validate_puc_auxiliar_deudores__cb);
  } // do_ajax_form_terceros_contable_validate_puc_auxiliar_deudores_

  function do_ajax_form_terceros_contable_validate_puc_auxiliar_deudores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "puc_auxiliar_deudores_" + iLineNumber;
    }
    else
    {
      sFieldValid = "puc_auxiliar_deudores_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "puc_auxiliar_deudores_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "puc_auxiliar_deudores_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_terceros_contable_validate_puc_auxiliar_deudores__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_terceros_contable_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_terceros_contable_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_terceros_contable_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_terceros_contable_add_new_line_cb);
  } // do_ajax_form_terceros_contable_add_new_line

  function do_ajax_form_terceros_contable_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("documento_=disabled;nombres_=disabled;cliente_=disabled;empleado_=disabled;proveedor_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_terceros_contable_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_terceros_contable_backup_line(iNumLinha)
  {
    var var_idtercero_ = scAjaxGetFieldText("idtercero_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_terceros_contable_backup_line(var_idtercero_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_terceros_contable_backup_line_cb);
  } // do_ajax_form_terceros_contable_backup_line

  function do_ajax_form_terceros_contable_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_terceros_contable_backup_line_cb

  function do_ajax_form_terceros_contable_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_terceros_contable_cancel_insert

  function do_ajax_form_terceros_contable_cancel_update(iSeqVert)
  {
    do_ajax_form_terceros_contable_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_terceros_contable_cancel_update

  function do_ajax_form_terceros_contable_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_terceros_contable_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_terceros_contable_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_terceros_contable_table_refresh(var_idtercero_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_contable_table_refresh_cb);
  } //  do_ajax_form_terceros_contable_table_refresh

  function do_ajax_form_terceros_contable_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_terceros_contable_table_refresh_cb_after_alert);
  } // do_ajax_form_terceros_contable_table_refresh_cb
  function do_ajax_form_terceros_contable_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_terceros_contable_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_terceros_contable_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_terceros_contable_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_nombres_ = scAjaxGetFieldHidden("nombres_" + iNumLinha);
    var var_cliente_ = scAjaxGetFieldHidden("cliente_" + iNumLinha);
    var var_empleado_ = scAjaxGetFieldHidden("empleado_" + iNumLinha);
    var var_proveedor_ = scAjaxGetFieldHidden("proveedor_" + iNumLinha);
    var var_puc_auxiliar_proveedores_ = scAjaxGetFieldSelect("puc_auxiliar_proveedores_" + iNumLinha);
    var var_puc_auxiliar_deudores_ = scAjaxGetFieldSelect("puc_auxiliar_deudores_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_terceros_contable_submit_form(var_documento_, var_nombres_, var_cliente_, var_empleado_, var_proveedor_, var_puc_auxiliar_proveedores_, var_puc_auxiliar_deudores_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_terceros_contable_submit_form_cb);
  } // do_ajax_form_terceros_contable_submit_form

  function do_ajax_form_terceros_contable_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("empleado_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("proveedor_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("puc_auxiliar_proveedores_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("puc_auxiliar_deudores_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_terceros_contable_submit_form_cb_after_alert);
  } // do_ajax_form_terceros_contable_submit_form_cb
  function do_ajax_form_terceros_contable_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_terceros_contable_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_terceros_contable_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_terceros_contable_navigate_form, function() {});
    } else {
      perform_ajax_form_terceros_contable_navigate_form();
    }
  }

  function perform_ajax_form_terceros_contable_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("empleado_" + iNavForm);
      scAjaxHideErrorDisplay("proveedor_" + iNavForm);
      scAjaxHideErrorDisplay("puc_auxiliar_proveedores_" + iNavForm);
      scAjaxHideErrorDisplay("puc_auxiliar_deudores_" + iNavForm);
    }
    var var_idtercero_ = document.F2.idtercero_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_terceros_contable_navigate_form(var_idtercero_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_terceros_contable_navigate_form_cb);
  } // do_ajax_form_terceros_contable_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_terceros_contable']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_terceros_contable_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_terceros_contable_navigate_form_cb_after_alert);
  } // do_ajax_form_terceros_contable_navigate_form_cb
  function do_ajax_form_terceros_contable_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_terceros_contable_navigate_form_cb_after_alert
  function sc_hide_form_terceros_contable_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "empleado_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "proveedor_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "puc_auxiliar_proveedores_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "puc_auxiliar_deudores_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["documento_" + iNumLinha] = {"label": "Documento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["nombres_" + iNumLinha] = {"label": "Nombres<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["empleado_" + iNumLinha] = {"label": "Empleado<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["proveedor_" + iNumLinha] = {"label": "Proveedor<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["puc_auxiliar_proveedores_" + iNumLinha] = {"label": "P.U.C Auxiliar Proveedores<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["puc_auxiliar_deudores_" + iNumLinha] = {"label": "P.U.C Auxiliar Deudores<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["empleado_"][iNumLinha] = "empleado_" + iNumLinha;
    ajax_field_mult["proveedor_"][iNumLinha] = "proveedor_" + iNumLinha;
    ajax_field_mult["puc_auxiliar_proveedores_"][iNumLinha] = "puc_auxiliar_proveedores_" + iNumLinha;
    ajax_field_mult["puc_auxiliar_deudores_"][iNumLinha] = "puc_auxiliar_deudores_" + iNumLinha;
    ...
    ajax_field_id["cliente_" + iNumLinha] = new Array("hidden_field_label_cliente_", "hidden_field_data_cliente_" + iNumLinha);
    ajax_field_id["empleado_" + iNumLinha] = new Array("hidden_field_label_empleado_", "hidden_field_data_empleado_" + iNumLinha);
    ajax_field_id["proveedor_" + iNumLinha] = new Array("hidden_field_label_proveedor_", "hidden_field_data_proveedor_" + iNumLinha);
    ajax_field_id["puc_auxiliar_proveedores_" + iNumLinha] = new Array("hidden_field_label_puc_auxiliar_proveedores_", "hidden_field_data_puc_auxiliar_proveedores_" + iNumLinha);
    ajax_field_id["puc_auxiliar_deudores_" + iNumLinha] = new Array("hidden_field_label_puc_auxiliar_deudores_", "hidden_field_data_puc_auxiliar_deudores_" + iNumLinha);
    ajax_error_count["documento_" + iNumLinha] = "off";
    ajax_error_count["nombres_" + iNumLinha] = "off";
    ajax_error_count["cliente_" + iNumLinha] = "off";
    ajax_error_count["empleado_" + iNumLinha] = "off";
    ajax_error_count["proveedor_" + iNumLinha] = "off";
    ajax_error_count["puc_auxiliar_proveedores_" + iNumLinha] = "off";
    ajax_error_count["puc_auxiliar_deudores_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["empleado_" + iNumLinha] = "off";
    ajax_read_only["proveedor_" + iNumLinha] = "off";
    ajax_read_only["puc_auxiliar_proveedores_" + iNumLinha] = "off";
    ajax_read_only["puc_auxiliar_deudores_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["empleado_" + iNumLinha] = "on";
    ajax_read_only["proveedor_" + iNumLinha] = "on";
    ajax_read_only["puc_auxiliar_proveedores_" + iNumLinha] = "on";
    ajax_read_only["puc_auxiliar_deudores_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["empleado_" + iNumLinha] = null;
    ajax_error_list["proveedor_" + iNumLinha] = null;
    ajax_error_list["puc_auxiliar_proveedores_" + iNumLinha] = null;
    ajax_error_list["puc_auxiliar_deudores_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    ...
    "cliente_": new Array(),
    "empleado_": new Array(),
    "proveedor_": new Array(),
    "puc_auxiliar_proveedores_": new Array(),
    "puc_auxiliar_deudores_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["empleado_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["empleado_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["empleado_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["empleado_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["empleado_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["proveedor_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["proveedor_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["proveedor_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["proveedor_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["proveedor_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["puc_auxiliar_proveedores_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["puc_auxiliar_proveedores_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["puc_auxiliar_proveedores_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["puc_auxiliar_proveedores_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["puc_auxiliar_proveedores_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["puc_auxiliar_deudores_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["puc_auxiliar_deudores_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["puc_auxiliar_deudores_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["puc_auxiliar_deudores_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["puc_auxiliar_deudores_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['empleado_'])) ? $this->nmgp_cmp_readonly['empleado_'] : 'off';
?>
    scAjaxFieldRead("empleado_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['proveedor_'])) ? $this->nmgp_cmp_readonly['proveedor_'] : 'off';
?>
    scAjaxFieldRead("proveedor_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['puc_auxiliar_proveedores_'])) ? $this->nmgp_cmp_readonly['puc_auxiliar_proveedores_'] : 'off';
?>
    scAjaxFieldRead("puc_auxiliar_proveedores_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['puc_auxiliar_deudores_'])) ? $this->nmgp_cmp_readonly['puc_auxiliar_deudores_'] : 'off';
?>
    scAjaxFieldRead("puc_auxiliar_deudores_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("empleado_" + iSeq, "on");
    scAjaxFieldRead("proveedor_" + iSeq, "on");
    scAjaxFieldRead("puc_auxiliar_proveedores_" + iSeq, "on");
    scAjaxFieldRead("puc_auxiliar_deudores_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["documento_" + iRow] || "on" == ajax_error_count["nombres_" + iRow] || "on" == ajax_error_count["cliente_" + iRow] || "on" == ajax_error_count["empleado_" + iRow] || "on" == ajax_error_count["proveedor_" + iRow] || "on" == ajax_error_count["puc_auxiliar_proveedores_" + iRow] || "on" == ajax_error_count["puc_auxiliar_deudores_" + iRow]))
    {
      ...
      $("#hidden_field_data_empleado_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_proveedor_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_puc_auxiliar_proveedores_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_puc_auxiliar_deudores_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["documento_" + iRow] && "off" == ajax_error_count["nombres_" + iRow] && "off" == ajax_error_count["cliente_" + iRow] && "off" == ajax_error_count["empleado_" + iRow] && "off" == ajax_error_count["proveedor_" + iRow] && "off" == ajax_error_count["puc_auxiliar_proveedores_" + iRow] && "off" == ajax_error_count["puc_auxiliar_deudores_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["empleado_" + iRow] = "off";
        ajax_error_count["proveedor_" + iRow] = "off";
        ajax_error_count["puc_auxiliar_proveedores_" + iRow] = "off";
        ajax_error_count["puc_auxiliar_deudores_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_empleado_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_proveedor_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_puc_auxiliar_proveedores_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_puc_auxiliar_deudores_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("puc_auxiliar_proveedores_" == sIndex)
    {
    ...
    if ("puc_auxiliar_deudores_" == sIndex)
    {
      scAjaxSetFieldSelect(sIndex, aValue, null);
      updateHeaderFooter(sIndex, aValue);
