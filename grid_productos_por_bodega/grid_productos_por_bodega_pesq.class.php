...
class grid_productos_por_bodega_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_productos_por_bodega_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_productos_por_bodega_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_productos_por_bodega_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_codigo($codigo)
   {
      ...
      $nm_comando = "select distinct p.codigoprod from " . $this->Ini->nm_tabela . " where  p.codigoprod like '%" . $codigo . "%' order by p.codigoprod"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Existencias por Bodega</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_productos_por_bodega/grid_productos_por_bodega_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_productos_por_bodega_ajax_search.js"></script>
 <script type="text/javascript" src="grid_productos_por_bodega_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_productos_por_bodega_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_productos_por_bodega']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_productos_por_bodega']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_b_bodega_cond#NMF#' + search_get_sel_txt('SC_b_bodega_cond') + '@NMF@';
  str_out += 'SC_b_bodega#NMF#' + search_get_Dselelect('SC_b_bodega_dest') + '@NMF@';
  ...
  str_out += 'SC_existencia_IN#NMF#' + search_get_text('SC_existencia_IN') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Existencias por Bodega</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__box_view_32.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $b_bodega_cond, $b_bodega,
             $existencia_cond, $existencia, $existencia_input_2, $existencia_IN,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $codigo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['codigo']; 
          $codigo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['codigo_cond']; 
          $descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['descripcion']; 
          $descripcion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['descripcion_cond']; 
          $b_bodega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['b_bodega']; 
          $b_bodega_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['b_bodega_cond']; 
          $existencia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['existencia']; 
          $existencia_IN = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['existencia_IN']; 
          $existencia_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['existencia_input_2']; 
          $existencia_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['existencia_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['NM_operador']; 
          ...
          { 
              nmgp_Form_Num_Val($existencia, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($existencia_cond) != "II" && strtoupper($existencia_cond) != "QP" && strtoupper($existencia_cond) != "NP" && strtoupper($existencia_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($existencia_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      ...
      if (!isset($b_bodega_cond) || empty($b_bodega_cond))
      {
         $b_bodega_cond = "eq";
      }
      ...
      $str_hide_b_bodega = (in_array($b_bodega_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_b_bodega = ('bw' == $b_bodega_cond) ? $display_aberto : $display_fechado;
      $str_display_existencia = ('bw' == $existencia_cond) ? $display_aberto : $display_fechado;

      // b_bodega
      if (is_array($b_bodega) && !empty($b_bodega))
      {
         $tmp_array = array();
         $b_bodega_val_str = "";
         foreach ($b_bodega as $tmp_val_cmp)
         {
            if ("" != $b_bodega_val_str)
            {
               $b_bodega_val_str .= ",";
...
<?php
      ...
      $codigo_look = substr($this->Db->qstr($codigo), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct p.codigoprod from " . $this->Ini->nm_tabela . " where p.codigoprod = '$codigo_look' order by p.codigoprod"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_codigo" name="codigo" value="<?php echo NM_encode_input($codigo) ?>"  size=50 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-codigo" id="id_ac_codigo" name="codigo_autocomp"><?php if ('' !=  $codigo) { ?><option value="<?php echo $codigo ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-descripcion" id="id_ac_descripcion" name="descripcion_autocomp"><?php if ('' !=  $descripcion) { ?><option value="<?php echo $descripcion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_b_bodega_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['b_bodega'])) ? $this->New_label['b_bodega'] : "Bodega"; ?></TD>
      
      <INPUT type="hidden" id="SC_b_bodega_cond" name="b_bodega_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_b_bodega" <?php echo $str_hide_b_bodega?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['b_bodega'])) ? $this->New_label['b_bodega'] : "Bodega";
 $nmgp_tab_label .= "b_bodega?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      $b_bodega_look = substr($this->Db->qstr($b_bodega), 1, -1); 
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT bodega, bodega  FROM bodegas  ORDER BY bodega"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['psq_check_ret']['b_bodega'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['psq_check_ret']['b_bodega'][] = trim($rs->fields[0]);
...
?>
   <table style="padding: 0px; spacing: 0px; border-width: 0px;"><tr><td>
    <SELECT class="scFilterObjectOdd" id="SC_b_bodega_orig" name="b_bodega_orig" size=7 multiple onDblClick="nm_add_sel('b_bodega_orig', 'b_bodega_dest', 'N' , '')">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            {
               $b_bodega_sel = "";
               foreach ($b_bodega as $Dados)
               {
                   if ($Dados === $nm_opc_cod)
                   {
                       $b_bodega_sel = " disabled =\"disabled\" style=\"color: #A0A0A0\"";
                       break;
                   }
               }
            }
            ...
            {
               $b_bodega_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $b_bodega_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
<?php
      ...
      echo nmButtonOutput($this->arr_buttons, "bpassfld_rightall", "nm_add_all('b_bodega_orig', 'b_bodega_dest', 'N', '');", "nm_add_all('b_bodega_orig', 'b_bodega_dest', 'N', '');", "Bbpassfld_rightall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_right", "nm_add_sel('b_bodega_orig', 'b_bodega_dest', 'N', '');", "nm_add_sel('b_bodega_orig', 'b_bodega_dest', 'N', '');", "Bbpassfld_righ", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_left", "nm_del_sel('b_bodega_dest', 'b_bodega_orig', 'N', '');", "nm_del_sel('b_bodega_dest', 'b_bodega_orig', 'N', '');", "Bbpassfld_left", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
      echo "   <div class='scBtnPassField'>\r\n";
      echo nmButtonOutput($this->arr_buttons, "bpassfld_leftall", "nm_del_all('b_bodega_dest', 'b_bodega_orig', 'N', '');", "nm_del_all('b_bodega_dest', 'b_bodega_orig', 'N', '');", "Bbpassfld_leftall", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
      echo "   </div>\r\n";
?>
   </td>
   <td>
    <SELECT class="scFilterObjectOdd" id="SC_b_bodega_dest" name="b_bodega_dest" size=7 multiple  onDblClick="nm_del_sel('b_bodega_dest', 'b_bodega_orig', 'N' , '')">"
<?php
      $nm_opcoesx = str_replace("?#?@?#?", "?#?@ ?#?", $nmgp_def_dados);
      $nm_opcoes  = explode("?@?", $nm_opcoesx);
      foreach ($nm_opcoes as $nm_opcao)
...
?>
    ...
    <input type="hidden" id="SC_b_bodega" name="b_bodega" value="">
   </td></tr></table>
   <script type="text/javascript">document.F1.b_bodega_dest.selectedIndex = -1;</script>
<?php
?>
...
?>
<INPUT  type="text" id="SC_existencia" name="existencia" value="<?php echo NM_encode_input($existencia) ?>" size=34 alt="{datatype: 'integer', maxLength: 34, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven"<?php echo $style_cond_in ?>>
<?php
$style_cond_in = ($existencia_cond != "in") ? " style=\"display: none;\"" : ""; 
?>
<INPUT  type="text" id="SC_existencia_IN" name="existencia_IN" value="<?php echo NM_encode_input($existencia_IN) ?>" size=34 alt="{datatype: 'text', maxLength: 34, allowedChars: '0123456789,', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven"<?php echo $style_cond_in ?>>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_existencia"  <?php echo $str_display_existencia; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_existencia_input_2" name="existencia_input_2" value="<?php echo NM_encode_input($existencia_input_2) ?>"  size=34 alt="{datatype: 'integer', maxLength: 34, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">
...
<?php
   if (is_file("grid_productos_por_bodega_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_productos_por_bodega']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_productos_por_bodega']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_productos_por_bodega']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_productos_por_bodega']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
   nm_pack('b_bodega_dest', 'b_bodega');
    document.F1.submit();
 }
 function limpa_form()
 {
   ...
   document.F1.b_bodega_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_b_bodega'), document.F1.b_bodega_cond, 'b_bodega');
   nm_del_all('b_bodega_dest', 'b_bodega_orig', 'N', '');
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_productos_por_bodega";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_productos_por_bodega/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      global $codigo_cond, $codigo, $codigo_autocomp,
             $descripcion_cond, $descripcion, $descripcion_autocomp,
             $b_bodega_cond, $b_bodega,
             $existencia_cond, $existencia, $existencia_input_2, $existencia_IN, $nmgp_tab_label;
      ...
      $b_bodega_cond_salva = $b_bodega_cond; 
      if (!isset($b_bodega_input_2) || $b_bodega_input_2 == "")
      {
          $b_bodega_input_2 = $b_bodega;
      }
      ...
      if (is_array($b_bodega)) {
          foreach ($b_bodega as $I => $Val) {
              $tmp_pos = strpos($Val, "##@@");
              if ($tmp_pos === false) {
                  $L_lookup = $Val;
              }
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['psq_check_ret']['b_bodega'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['codigo'] = $codigo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['codigo_cond'] = $codigo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['descripcion'] = $descripcion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['descripcion_cond'] = $descripcion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['b_bodega'] = $b_bodega; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['b_bodega_cond'] = $b_bodega_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['existencia'] = $existencia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['existencia_input_2'] = $existencia_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['existencia_IN'] = $existencia_IN; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['existencia_cond'] = $existencia_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($descripcion != '') {
      ...
      $this->cmp_formatado['b_bodega'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']['b_bodega'];
      $this->cmp_formatado['b_bodega_input_2'] = $b_bodega_input_2;
      $Conteudo = $existencia;
      if (strtoupper($existencia_cond) != "II" && strtoupper($existencia_cond) != "QP" && strtoupper($existencia_cond) != "NP" && strtoupper($existencia_cond) != "IN") 
      { 
      ...
      {
         $this->monta_condicao("p.codigoprod", $codigo_cond, $codigo, "", "codigo");
      }
      ...
      $this->Date_part = false;
      $nm_aspas = "'";
      if ($b_bodega_cond == "nu" || $b_bodega_cond == "nn" || $b_bodega_cond == "ep" || $b_bodega_cond == "ne")
      {
          $b_bodega = array();
      }
      if (is_array($b_bodega) && count($b_bodega) != 0)
      {
         foreach ($b_bodega as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($b_bodega_cond == "df" || $b_bodega_cond == "np")
         {
             $this->comando        .= " b.bodega not in (";
             $this->comando_sum    .= " b.bodega not in (";
             $this->comando_filtro .= " b.bodega not in (";
         }
         else
         {
             $this->comando        .= " b.bodega in (";
             $this->comando_sum    .= " b.bodega in (";
             $this->comando_filtro .= " b.bodega in (";
         }
         $x                     = count($b_bodega);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$b_bodega_cond]) ? $Lang_descr[$b_bodega_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $nmgp_tab_label['b_bodega'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($b_bodega) || $b_bodega_cond == "nu" || $b_bodega_cond == "nn" || $b_bodega_cond == "ep" || $b_bodega_cond == "ne")
      {
         $this->monta_condicao("b.bodega", $b_bodega_cond, $b_bodega, "", "b_bodega");
      }
      ...
      {
         $this->monta_condicao("sum(iv.cantidad)", $existencia_cond, $existencia, $existencia_input_2, "existencia");
      }
      if ($existencia_cond == "in")
      {
          $existencia = $Cmp_save;
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['where_pesq'];
