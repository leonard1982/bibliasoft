...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "sum(iv_cantidad)";$Nm_numeric[] = "sum(iv_cantidad)";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_existencia"  <?php echo $str_hide_existencia?>>
<?php
...
$style_cond_in = ($existencia_cond != "in") ? " style=\"display: none;\"" : ""; 
?>
<INPUT  type="text" id="SC_existencia_IN" name="existencia_IN" value="<?php echo NM_encode_input($existencia_IN) ?>" size=34 alt="{datatype: 'text', maxLength: 34, allowedChars: '0123456789,', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven"<?php echo $style_cond_in ?>>         <BR>
        <SPAN id="id_vis_existencia"  <?php echo $str_display_existencia; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_existencia_input_2" name="existencia_input_2" value="<?php echo NM_encode_input($existencia_input_2) ?>"  size=34 alt="{datatype: 'integer', maxLength: 34, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectEven">         </SPAN>
