...
class grid_productos_por_bodega_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['producto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['producto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['producto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['producto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['producto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['producto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['producto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['producto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['producto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['producto'] as $i_sum => $d_sum)
           {
       ...
       foreach ($this->array_total_descripcion as $i_descripcion => $d_descripcion) {
           if (!in_array($i_descripcion, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_descripcion[3] ] = $d_descripcion[2];
               $this->comp_label[0][ $d_descripcion[3] ] = $d_descripcion[2];
           }
       }
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_descripcion, $quebra_descripcion_orig)
   {
      //----- Descripcion
      if (!isset($this->array_total_descripcion[$quebra_descripcion_orig]))
      {
         $this->array_total_descripcion[$quebra_descripcion_orig][0] = 1;
         $this->array_total_descripcion[$quebra_descripcion_orig][1] = 1;
         $this->array_total_descripcion[$quebra_descripcion_orig][2] = $quebra_descripcion;
         $this->array_total_descripcion[$quebra_descripcion_orig][3] = $quebra_descripcion_orig;
      }
      else
      {
         $this->array_total_descripcion[$quebra_descripcion_orig][0]++;
         $this->array_total_descripcion[$quebra_descripcion_orig][2]++;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['descripcion'] as $campo_descripcion => $dados_descripcion)
      {
         $this->array_total_descripcion[$campo_descripcion][1] = $dados_descripcion[1];
      }
   }
   //---- 
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->descripcion, $this->descripcion_orig);
            }
   }
//
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['order_grid'] = $nmgp_order_by;
      ...
      while (!$this->rs_grid->EOF) 
      {
         ...
         $this->adiciona_registro(sc_strip_script($this->descripcion), sc_strip_script($descripcion_orig));
