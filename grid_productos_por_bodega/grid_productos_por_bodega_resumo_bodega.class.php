...
class grid_productos_por_bodega_resumo
{
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['bodega']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['bodega'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['bodega'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodega'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodega'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodega'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodega'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodega'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodega'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodega'] as $i_sum => $d_sum)
           {
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_b_bodega, $quebra_b_bodega_orig)
   {
      //----- Bodega
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->b_bodega, $this->b_bodega_orig);
            }
   }
//
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['order_grid'] = $nmgp_order_by;
      ...
      while (!$this->rs_grid->EOF) 
      {
         ...
         $this->adiciona_registro(sc_strip_script($this->b_bodega), sc_strip_script($b_bodega_orig));
