...
<?php
   ...
   $Ord_Cmp = new grid_productos_por_bodega_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_productos_por_bodega_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['codigo'] = "p.codigoprod";
   }
   $tab_labels["codigo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["codigo"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["codigo"] : "Codigo";
   ...
   $tab_labels["descripcion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["descripcion"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["descripcion"] : "Descripcion";
   $tab_ger_campos['b_bodega'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['b_bodega'] = "b_bodega";
   }
   else
   {
       $tab_def_campos['b_bodega'] = "b.bodega";
   }
   $tab_labels["b_bodega"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["b_bodega"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["b_bodega"] : "Bodega";
   ...
   {
       $tab_def_campos['existencia'] = "sum(iv.cantidad)";
   }
   $tab_labels["existencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["existencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["existencia"] : "Existencia";
   ...
   {
       $tab_def_campos['unidad'] = "p.unimen";
   }
   $tab_labels["unidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["unidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['labels']["unidad"] : "Unidad";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_productos_por_bodega_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_productos_por_bodega']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
