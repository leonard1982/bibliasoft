...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_por_bodega"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_productos_por_bodega"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_productos_por_bodega</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_productos_por_bodega']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_productos_por_bodega' || $achou)
          {
