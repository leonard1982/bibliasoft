...
class grid_productos_por_bodega_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_b_bodega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['b_bodega'];
          $this->array_total_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['descripcion'];
      }
      else
      {
          $this->array_total_b_bodega = array();
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['tot_geral'][1];
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['codigo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['codigo'] = "Codigo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['descripcion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['descripcion'] = "Descripcion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['b_bodega']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['b_bodega'] = "Bodega"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['existencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['existencia'] = "Existencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['unidad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['labels']['unidad'] = "Unidad"; 
       }
       //-----
       $this->comp_field_nm = array(
           'b_bodega' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['bodegayproducto']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['bodegayproducto'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_order']['bodegayproducto'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodegayproducto'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodegayproducto'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodegayproducto'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodegayproducto'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodegayproducto'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodegayproducto'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['summarizing_fields_display']['bodegayproducto'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_b_bodega as $i_b_bodega => $d_b_bodega) {
           if (!in_array($i_b_bodega, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_b_bodega[3] ] = $d_b_bodega[2];
               $this->comp_label[0][ $d_b_bodega[3] ] = $d_b_bodega[2];
           }
           foreach ($this->array_total_descripcion[$i_b_bodega] as $i_descripcion => $d_descripcion) {
               if (!in_array($i_descripcion, $this->comp_label[1][ $d_b_bodega[3] ], true)) {
                   $this->comp_index[1][ $d_descripcion[3] ] = $d_descripcion[2];
                   $this->comp_label[1][ $d_b_bodega[3] ][ $d_descripcion[3] ] = $d_descripcion[2];
               }
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'b_bodega', 'prot' => '@aspass@'),
           array('name' => 'descripcion', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_b_bodega => $l_b_bodega) {
           if (isset($this->array_total_b_bodega[$i_b_bodega])) {
               $this->comp_group[$i_b_bodega] = array();
           }
           foreach ($this->comp_label[1][$i_b_bodega] as $i_descripcion => $l_descripcion) {
               if (isset($this->array_total_descripcion[$i_b_bodega][$i_descripcion])) {
                   $this->comp_group[$i_b_bodega][$i_descripcion] = array();
               }
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_b_bodega;
       }
       elseif (1 == $level) {
           $return = $this->array_total_descripcion;
       }
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['proc_pdf_vert']){ 
   ...
   function totaliza()
   {
      ...
      $this->array_total_b_bodega = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['b_bodega'];
      $this->array_total_descripcion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['descripcion'];
      ksort($this->array_total_b_bodega);
...
{ 
   ...
   //---- 
   function adiciona_registro($quebra_b_bodega, $quebra_descripcion, $quebra_b_bodega_orig, $quebra_descripcion_orig)
   {
      //----- Bodega
      if (!isset($this->array_total_b_bodega[$quebra_b_bodega_orig]))
      {
         $this->array_total_b_bodega[$quebra_b_bodega_orig][0] = 1;
         $this->array_total_b_bodega[$quebra_b_bodega_orig][1] = 1;
         $this->array_total_b_bodega[$quebra_b_bodega_orig][2] = $quebra_b_bodega;
         $this->array_total_b_bodega[$quebra_b_bodega_orig][3] = $quebra_b_bodega_orig;
      }
      else
      {
         $this->array_total_b_bodega[$quebra_b_bodega_orig][0]++;
         $this->array_total_b_bodega[$quebra_b_bodega_orig][2]++;
      }
      //----- Descripcion
      if (!isset($this->array_total_descripcion[$quebra_b_bodega_orig][$quebra_descripcion_orig]))
      {
         $this->array_total_descripcion[$quebra_b_bodega_orig][$quebra_descripcion_orig][0] = 1;
         $this->array_total_descripcion[$quebra_b_bodega_orig][$quebra_descripcion_orig][1] = 1;
         $this->array_total_descripcion[$quebra_b_bodega_orig][$quebra_descripcion_orig][2] = $quebra_descripcion;
         $this->array_total_descripcion[$quebra_b_bodega_orig][$quebra_descripcion_orig][3] = $quebra_descripcion_orig;
      }
      else
      {
         $this->array_total_descripcion[$quebra_b_bodega_orig][$quebra_descripcion_orig][0]++;
         $this->array_total_descripcion[$quebra_b_bodega_orig][$quebra_descripcion_orig][2]++;
      }
      //----- Total
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['b_bodega'] as $campo_b_bodega => $dados_b_bodega)
      {
         $this->array_total_b_bodega[$campo_b_bodega][1] = $dados_b_bodega[1];
         foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['descripcion'][$campo_b_bodega] as $campo_descripcion => $dados_descripcion)
         {
            $this->array_total_descripcion[$campo_b_bodega][$campo_descripcion][1] = $dados_descripcion[1];
         }
      }
   }
   //---- 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'b_bodega');
     $campos_order = $this->Ini->Get_date_order_groupby("b.bodega", 'asc', $format, $campos_order);
     $format       = $this->Ini->Get_Gb_date_format('', 'descripcion');
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->b_bodega, $this->descripcion, $this->b_bodega_orig,  $this->descripcion_orig);
            }
   }
//
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['order_grid'] = $nmgp_order_by;
      ...
      while (!$this->rs_grid->EOF) 
      {
         ...
         $this->adiciona_registro(sc_strip_script($this->b_bodega), sc_strip_script($this->descripcion), sc_strip_script($b_bodega_orig), sc_strip_script($descripcion_orig));
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['b_bodega'] = $this->array_total_b_bodega;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_productos_por_bodega']['arr_total']['descripcion'] = $this->array_total_descripcion;
      }
   }
