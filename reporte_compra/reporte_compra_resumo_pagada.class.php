...
class reporte_compra_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['arr_total']['pagada'];
      }
      else
      {
          $this->array_total_pagada = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['arr_total']['pagada'] = $this->array_total_pagada;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_order']['pagada']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_order']['pagada'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_order']['pagada'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['pagada'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['pagada'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['pagada'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['pagada'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['pagada'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['pagada'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['pagada'] as $i_sum => $d_sum)
           {
...
{ 
   ...
   //---- 
   function adiciona_registro($sum_subtotal, $sum_valoriva, $sum_total, $sum_a_pagar, $sum_val_ica, $sum_val_ret, $sum_val_retiva, $quebra_pagada, $quebra_pagada_orig)
   {
      //----- Pagada
      if (!isset($this->array_total_pagada[$quebra_pagada_orig]))
      {
         $this->array_total_pagada[$quebra_pagada_orig][0] = 1;
         $this->array_total_pagada[$quebra_pagada_orig][1] = $sum_subtotal;
         $this->array_total_pagada[$quebra_pagada_orig][2] = $sum_valoriva;
         $this->array_total_pagada[$quebra_pagada_orig][3] = $sum_total;
...
$_SESSION['scriptcase']['reporte_compra']['contr_erro'] = 'off'; 
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->subtotal, $this->valoriva, $this->total, $this->a_pagar, $this->val_ica, $this->val_ret, $this->val_retiva, $this->pagada, $this->pagada_orig);
            }
   }
//
