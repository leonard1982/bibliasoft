<?php
@session_start() ;
$_SESSION['scriptcase']['reporte_compra']['sc_process_barr'] = true;
require_once('../reporte_compra/index.php');
unset($_SESSION['scriptcase']['reporte_compra']['sc_process_barr']);
$ExportCtrl = new reporte_compra_export_control;
$ExportCtrl->Export_barr();

class reporte_compra_export_control
{
