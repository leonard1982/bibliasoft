...
class reporte_compra_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['arr_total']['asentada'];
      }
      else
      {
          $this->array_total_asentada = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['arr_total']['asentada'] = $this->array_total_asentada;
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_order']['asentada']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_order']['asentada'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_order']['asentada'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['asentada'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['asentada'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['asentada'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['asentada'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['asentada'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['asentada'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['summarizing_fields_display']['asentada'] as $i_sum => $d_sum)
           {
