...
class reporte_compra_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "reporte_compra/reporte_compra_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "reporte_compra_res_xls.class.php");
              $this->Res_xls = new reporte_compra_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_reporte_compra.zip";
          $this->Arquivo   .= "_reporte_compra" . $this->Xls_tp;
   ...
   function grava_arquivo()
   {
      ...
      $nm_raiz_img  = ""; 
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
      ...
      while (!$rs->EOF)
      {
         ...
         $this->arg_sum_asentada = ($this->asentada == "") ? " is null " : " = " . $this->asentada;
          ...
          {  
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida'] && !$prim_gb && $this->groupby_show == "S") {
...
$_SESSION['scriptcase']['reporte_compra']['contr_erro'] = 'off'; 
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   { 
      ...
      { 
          ...
          if ($Cada_col == "detalle" && (!isset($this->NM_cmp_hidden[$Cada_col]) || $this->NM_cmp_hidden[$Cada_col] != "off"))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_detallecompra']['embutida_label'] = true;
              ...
              if (method_exists($this->reporte_detallecompra, "controle"))
              {
                  ...
                  $this->count_span += $this->Emb_label_cols_detalle;
              }
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_detallecompra']['embutida'] = false;
              $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_detallecompra']['embutida_label'] = false;
              $current_cell_ref = $this->calc_cell($this->Xls_col);
              $SC_Label = NM_charset_to_utf8($SC_Label);
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida'])
              { 
              ...
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida'])
              { 
                  $this->arr_export['label'][$this->Xls_col]['col_span_f'] = $this->Emb_label_cols_detalle;
                  $this->Xls_col++;
              }
              else
              { 
                  $this->Xls_col += $this->Emb_label_cols_detalle;
              } 
          }
      } 
      $this->Xls_col = 0;
   ...
   function NM_export_tmp()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tmp, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->tmp, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   //----- numfacom
   ...
   //----- tmp
   function NM_sub_cons_tmp()
   {
         $this->tmp = NM_charset_to_utf8($this->tmp);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->tmp;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
             ...
             if (isset($_SESSION['scriptcase']['export_return']))
             {
                 ...
                 if (isset($_SESSION['scriptcase']['export_return']['lines']))
                 {
                     ...
                     foreach ($_SESSION['scriptcase']['export_return']['lines'] as $line => $cols)
                     {
                         ...
                         foreach ($cols as $icol => $dados)
                         {
                             $this->Rows_sub_detalle[$this->row_sub][$icol] = $dados;
                             if ($prim_col && $this->row_sub > 1)
                             {
                                 if (isset($this->Rows_sub_detalle[$this->row_sub][$icol]['col_span_i']))
                                 {
                                    $this->Rows_sub_detalle[$this->row_sub][$icol]['col_span_i'] += $this->arr_span['detalle'];
                                 }
                                 else
                                 {
                                    $this->Rows_sub_detalle[$this->row_sub][$icol]['col_span_i'] = $this->arr_span['detalle'];
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['nolabel'])
       {
 ...
 function quebra_asentada_asentada($asentada) 
 {
   ...
   function quebra_idprov_proveedor_bot()
   {
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['field_order'] as $Cada_cmp)
       {
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_proveedor_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "subtotal" && (!isset($this->NM_cmp_hidden['subtotal']) || $this->NM_cmp_hidden['subtotal'] != "off"))
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['tot_geral'][2];
               $prim_cmp = false;
           ...
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['tot_geral'][3];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
           ...
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['tot_geral'][4];
               $prim_cmp = false;
               $Vl_Tot = NM_charset_to_utf8($Vl_Tot);
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['reporte_compra']['embutida']) {
                   $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $Vl_Tot;
