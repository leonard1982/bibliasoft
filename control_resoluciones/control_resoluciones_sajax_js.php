  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_control_resoluciones" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_control_resoluciones_form();
	}
...
?>
  ...
  // ---------- Validate nit
  function do_ajax_control_resoluciones_validate_nit()
  {
    var nomeCampo_nit = "nit";
    var var_nit = scAjaxGetFieldHidden(nomeCampo_nit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_resoluciones_validate_nit(var_nit, var_script_case_init, do_ajax_control_resoluciones_validate_nit_cb);
  } // do_ajax_control_resoluciones_validate_nit

  function do_ajax_control_resoluciones_validate_nit_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_resoluciones_validate_nit_cb

  // ---------- Validate idsoftware
  function do_ajax_control_resoluciones_validate_idsoftware()
  {
    var nomeCampo_idsoftware = "idsoftware";
    var var_idsoftware = scAjaxGetFieldHidden(nomeCampo_idsoftware);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_resoluciones_validate_idsoftware(var_idsoftware, var_script_case_init, do_ajax_control_resoluciones_validate_idsoftware_cb);
  } // do_ajax_control_resoluciones_validate_idsoftware

  function do_ajax_control_resoluciones_validate_idsoftware_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idsoftware";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_resoluciones_validate_idsoftware_cb

  // ---------- Validate token
  function do_ajax_control_resoluciones_validate_token()
  {
    var nomeCampo_token = "token";
    var var_token = scAjaxGetFieldHidden(nomeCampo_token);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_resoluciones_validate_token(var_token, var_script_case_init, do_ajax_control_resoluciones_validate_token_cb);
  } // do_ajax_control_resoluciones_validate_token

  function do_ajax_control_resoluciones_validate_token_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "token";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_resoluciones_validate_token_cb

  // ---------- Validate mensaje
  function do_ajax_control_resoluciones_validate_mensaje()
  {
    var nomeCampo_mensaje = "mensaje";
    var var_mensaje = scAjaxGetFieldHidden(nomeCampo_mensaje);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_control_resoluciones_validate_mensaje(var_mensaje, var_script_case_init, do_ajax_control_resoluciones_validate_mensaje_cb);
  } // do_ajax_control_resoluciones_validate_mensaje

  function do_ajax_control_resoluciones_validate_mensaje_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mensaje";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_control_resoluciones_validate_mensaje_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_control_resoluciones_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_control_resoluciones_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nit = scAjaxGetFieldHidden("nit");
    var var_idsoftware = scAjaxGetFieldHidden("idsoftware");
    var var_token = scAjaxGetFieldHidden("token");
    ...
    scAjaxProcOn();
    x_ajax_control_resoluciones_submit_form(var_nit, var_idsoftware, var_token, var_mensaje, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_control_resoluciones_submit_form_cb);
  } // do_ajax_control_resoluciones_submit_form

  function do_ajax_control_resoluciones_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_control_resoluciones_submit_form_cb_after_alert);
  } // do_ajax_control_resoluciones_submit_form_cb
  function do_ajax_control_resoluciones_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_control_resoluciones_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_control_resoluciones_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_control_resoluciones_navigate_form, function() {});
    } else {
      perform_ajax_control_resoluciones_navigate_form();
    }
  }

  function perform_ajax_control_resoluciones_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_control_resoluciones_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['control_resoluciones']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_control_resoluciones_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_control_resoluciones_navigate_form_cb_after_alert);
  } // do_ajax_control_resoluciones_navigate_form_cb
  function do_ajax_control_resoluciones_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_control_resoluciones_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_control_resoluciones_navigate_form_cb_after_alert
  function sc_hide_control_resoluciones_form()
  {
  ...
  ajax_field_list[0] = "nit";
  ajax_field_list[1] = "idsoftware";
  ajax_field_list[2] = "token";
  ...
  var ajax_error_list = {
    "nit": {"label": "NIT", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idsoftware": {"label": "IdSoftware", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "token": {"label": "Token", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "mensaje": {"label": "Prefijos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
