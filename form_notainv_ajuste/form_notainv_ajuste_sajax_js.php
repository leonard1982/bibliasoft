  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_notainv_ajuste" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_notainv_ajuste_form();
	}
  ...
  function do_ajax_form_notainv_ajuste_validate_prefijonota()
  {
    var nomeCampo_prefijonota = "prefijonota";
    var var_prefijonota = scAjaxGetFieldSelect(nomeCampo_prefijonota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notainv_ajuste_validate_prefijonota(var_prefijonota, var_script_case_init, do_ajax_form_notainv_ajuste_validate_prefijonota_cb);
  } // do_ajax_form_notainv_ajuste_validate_prefijonota

  function do_ajax_form_notainv_ajuste_validate_prefijonota_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notainv_ajuste_validate_prefijonota_cb

  // ---------- Validate numeronota
  function do_ajax_form_notainv_ajuste_validate_numeronota()
  {
    var nomeCampo_numeronota = "numeronota";
    var var_numeronota = scAjaxGetFieldText(nomeCampo_numeronota);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notainv_ajuste_validate_numeronota(var_numeronota, var_script_case_init, do_ajax_form_notainv_ajuste_validate_numeronota_cb);
  } // do_ajax_form_notainv_ajuste_validate_numeronota

  function do_ajax_form_notainv_ajuste_validate_numeronota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notainv_ajuste_validate_numeronota_cb

  // ---------- Validate idtipotran
  function do_ajax_form_notainv_ajuste_validate_idtipotran()
  {
    var nomeCampo_idtipotran = "idtipotran";
    var var_idtipotran = scAjaxGetFieldSelect(nomeCampo_idtipotran);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notainv_ajuste_validate_idtipotran(var_idtipotran, var_script_case_init, do_ajax_form_notainv_ajuste_validate_idtipotran_cb);
  } // do_ajax_form_notainv_ajuste_validate_idtipotran

  function do_ajax_form_notainv_ajuste_validate_idtipotran_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notainv_ajuste_validate_idtipotran_cb

  // ---------- Validate fecha
  function do_ajax_form_notainv_ajuste_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notainv_ajuste_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_notainv_ajuste_validate_fecha_cb);
  } // do_ajax_form_notainv_ajuste_validate_fecha

  function do_ajax_form_notainv_ajuste_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notainv_ajuste_validate_fecha_cb

  // ---------- Validate observaciones
  function do_ajax_form_notainv_ajuste_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notainv_ajuste_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_notainv_ajuste_validate_observaciones_cb);
  } // do_ajax_form_notainv_ajuste_validate_observaciones

  function do_ajax_form_notainv_ajuste_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notainv_ajuste_validate_observaciones_cb

  // ---------- Validate detalle
  function do_ajax_form_notainv_ajuste_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_notainv_ajuste_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_notainv_ajuste_validate_detalle_cb);
  } // do_ajax_form_notainv_ajuste_validate_detalle

  function do_ajax_form_notainv_ajuste_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_notainv_ajuste_validate_detalle_cb

  // ---------- Event onchange idboddes
  function do_ajax_form_notainv_ajuste_event_idboddes_onchange()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_notainv_ajuste_event_idboddes_onchange(var_script_case_init, do_ajax_form_notainv_ajuste_event_idboddes_onchange_cb);
  } // do_ajax_form_notainv_ajuste_event_idboddes_onchange

  function do_ajax_form_notainv_ajuste_event_idboddes_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_notainv_ajuste_event_idboddes_onchange_cb_after_alert);
  } // do_ajax_form_notainv_ajuste_event_idboddes_onchange_cb
  function do_ajax_form_notainv_ajuste_event_idboddes_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_notainv_ajuste_event_idboddes_onchange_cb_after_alert

  // ---------- Event onfocus idboddes
  function do_ajax_form_notainv_ajuste_event_idboddes_onfocus()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_notainv_ajuste_event_idboddes_onfocus(var_script_case_init, do_ajax_form_notainv_ajuste_event_idboddes_onfocus_cb);
  } // do_ajax_form_notainv_ajuste_event_idboddes_onfocus

  function do_ajax_form_notainv_ajuste_event_idboddes_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idboddes";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_notainv_ajuste_event_idboddes_onfocus_cb_after_alert);
  } // do_ajax_form_notainv_ajuste_event_idboddes_onfocus_cb
  function do_ajax_form_notainv_ajuste_event_idboddes_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_notainv_ajuste_event_idboddes_onfocus_cb_after_alert

  // ---------- Event onchange prefijonota
  function do_ajax_form_notainv_ajuste_event_prefijonota_onchange()
  {
    var var_prefijonota = scAjaxGetFieldSelect("prefijonota");
    var var_numeronota = scAjaxGetFieldText("numeronota");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_notainv_ajuste_event_prefijonota_onchange(var_prefijonota, var_numeronota, var_script_case_init, do_ajax_form_notainv_ajuste_event_prefijonota_onchange_cb);
  } // do_ajax_form_notainv_ajuste_event_prefijonota_onchange

  function do_ajax_form_notainv_ajuste_event_prefijonota_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prefijonota";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_notainv_ajuste_event_prefijonota_onchange_cb_after_alert);
  } // do_ajax_form_notainv_ajuste_event_prefijonota_onchange_cb
  function do_ajax_form_notainv_ajuste_event_prefijonota_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_notainv_ajuste_event_prefijonota_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_notainv_ajuste_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_notainv_ajuste_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_prefijonota = scAjaxGetFieldSelect("prefijonota");
    ...
    scAjaxProcOn();
    x_ajax_form_notainv_ajuste_submit_form(var_prefijonota, var_numeronota, var_idtipotran, var_fecha, var_observaciones, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_notainv_ajuste_submit_form_cb);
  } // do_ajax_form_notainv_ajuste_submit_form

  function do_ajax_form_notainv_ajuste_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_notainv_ajuste']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_notainv_ajuste']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_notainv_ajuste']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_notainv_ajuste_submit_form_cb_after_alert);
  } // do_ajax_form_notainv_ajuste_submit_form_cb
  function do_ajax_form_notainv_ajuste_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_notainv_ajuste_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_detallenotainv_ajuste"] = "off";

  function do_ajax_form_notainv_ajuste_navigate_form()
  {
    perform_ajax_form_notainv_ajuste_navigate_form();
  }

  function perform_ajax_form_notainv_ajuste_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_detallenotainv_ajuste"] = "on";
    x_ajax_form_notainv_ajuste_navigate_form(var_idmov, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_notainv_ajuste_navigate_form_cb);
  } // do_ajax_form_notainv_ajuste_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_notainv_ajuste']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_notainv_ajuste_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_detallenotainv_ajuste"] && "nmsc_iframe_liga_form_detallenotainv_ajuste" != scMasterDetailIframe["nmsc_iframe_liga_form_detallenotainv_ajuste"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_detallenotainv_ajuste"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_detallenotainv_ajuste').contentWindow.nm_move('apl_detalhe', true, '500');
        document.getElementById('nmsc_iframe_liga_form_detallenotainv_ajuste').style.height = "500";
        document.getElementById('nmsc_iframe_liga_form_detallenotainv_ajuste').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_notainv_ajuste_navigate_form_cb_after_alert);
  } // do_ajax_form_notainv_ajuste_navigate_form_cb
  function do_ajax_form_notainv_ajuste_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scFocusField('fecha');
...
{
?>
    do_ajax_form_notainv_ajuste_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_notainv_ajuste_navigate_form_cb_after_alert
  function sc_hide_form_notainv_ajuste_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_detallenotainv_ajuste"])
    {
      return true;
    }
    return false;
  ...
  var ajax_error_list = {
    "prefijonota": {"label": "Prefijo Nota", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "numeronota": {"label": "Nota número:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
