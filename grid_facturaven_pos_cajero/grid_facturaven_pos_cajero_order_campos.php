...
<?php
   ...
   $Ord_Cmp = new grid_facturaven_pos_cajero_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_facturaven_pos_cajero_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["asentada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["asentada"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["asentada"] : "Asentada";
   $tab_ger_campos['credito'] = "on";
   $tab_def_campos['credito'] = "credito";
   $tab_labels["credito"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["credito"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["credito"] : "F.Pago";
   $tab_ger_campos['resolucion'] = "on";
   $tab_def_campos['resolucion'] = "resolucion";
   $tab_labels["resolucion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["resolucion"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["resolucion"] : "PJ";
   $tab_ger_campos['numfacven'] = "on";
   $tab_def_campos['numfacven'] = "numfacven";
   $tab_labels["numfacven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["numfacven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["numfacven"] : "Fac No.";
   $tab_ger_campos['fechaven'] = "on";
   $tab_def_campos['fechaven'] = "fechaven";
   $tab_labels["fechaven"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["fechaven"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["fechaven"] : "Fecha venta";
   $tab_ger_campos['idcli'] = "on";
   $tab_def_campos['idcli'] = "idcli";
   $tab_labels["idcli"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["idcli"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["idcli"] : "Cliente";
   $tab_ger_campos['subtotal'] = "on";
   $tab_def_campos['subtotal'] = "subtotal";
   $tab_labels["subtotal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["subtotal"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["subtotal"] : "SubTotal";
   $tab_ger_campos['valoriva'] = "on";
   $tab_def_campos['valoriva'] = "valoriva";
   $tab_labels["valoriva"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["valoriva"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["valoriva"] : "IVA";
   $tab_ger_campos['total'] = "on";
   $tab_def_campos['total'] = "total";
   $tab_labels["total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["total"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["total"] : "Total";
   $tab_ger_campos['adicional'] = "on";
   $tab_def_campos['adicional'] = "adicional";
   $tab_labels["adicional"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["adicional"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["adicional"] : "Desc.";
   $tab_ger_campos['vendedor'] = "on";
   $tab_def_campos['vendedor'] = "vendedor";
   $tab_labels["vendedor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["vendedor"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["vendedor"] : "Vendedor";
   $tab_ger_campos['banco'] = "on";
   $tab_def_campos['banco'] = "banco";
   $tab_labels["banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["banco"] : "Caja";
   ...
   $tab_labels["imprimir"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["imprimir"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["imprimir"] : "PDF";
   $tab_ger_campos['editarpos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['editarpos'] = "editarPos";
   }
   else
   {
       $tab_def_campos['editarpos'] = "";
   }
   $tab_labels["editarpos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["editarpos"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["editarpos"] : "Editar";
   $tab_ger_campos['imprimircopia'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['imprimircopia'] = "imprimircopia";
   }
   else
   {
       $tab_def_campos['imprimircopia'] = "";
   }
   $tab_labels["imprimircopia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["imprimircopia"])) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['labels']["imprimircopia"] : "POS";
   $tab_ger_campos['imprimir'] = "none";
   $tab_ger_campos['editarpos'] = "none";
   $tab_ger_campos['imprimircopia'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_cajero']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_cajero']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_facturaven_pos_cajero']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_facturaven_pos_cajero_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_facturaven_pos_cajero']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
