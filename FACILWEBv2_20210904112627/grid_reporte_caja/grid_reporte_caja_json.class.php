...
class grid_reporte_caja_json
{
   ...
   function inicializa_vars()
   {
      ...
      if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_reporte_caja/grid_reporte_caja_res_json.class.php"))
      {
          $this->Tem_json_res  = false;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['json_label']))
      {
          $this->Json_use_label = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['json_label'];
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['embutida'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['json_format']))
      {
          $this->Json_format = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['json_format'];
      }
...
$_SESSION['scriptcase']['grid_reporte_caja']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          { 
              ...
              require_once($this->Ini->path_aplicacao . "grid_reporte_caja_res_json.class.php");
              $this->Res = new grid_reporte_caja_res_json();
              $this->prep_modulos("Res");
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['json_res_grid'] = true;
              $this->Res->monta_json();
          } 
          if (!$this->Ini->sc_export_ajax) {
          ...
          { 
              ...
              { 
                  $str_zip   = "";
                  $Arq_res   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['json_res_file']['json'];
                  ...
                  unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['json_res_file']['json']);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_reporte_caja']['json_res_grid']);
          } 
      }
