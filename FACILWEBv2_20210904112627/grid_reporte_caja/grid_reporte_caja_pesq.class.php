 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_fecha_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha"; ?> <span class="scFilterRequiredOdd">*</span></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_banco_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['banco'])) ? $this->New_label['banco'] : "Banco/Caja"; ?> <span class="scFilterRequiredOdd">*</span></TD>
...
?>
      ...
      <TD id='SC_prefijo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['prefijo'])) ? $this->New_label['prefijo'] : "Prefijo"; ?> <span class="scFilterRequiredOdd">*</span></TD>
...
?>
<INPUT  type="text" id="SC_correo_receptor" name="correo_receptor" value="<?php echo NM_encode_input($correo_receptor) ?>"  size=60 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<INPUT  type="text" id="SC_asunto" name="asunto" value="<?php echo NM_encode_input($asunto) ?>"  size=80 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
?>
<INPUT  type="text" id="SC_mensaje" name="mensaje" value="<?php echo NM_encode_input($mensaje) ?>"  size=80 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
