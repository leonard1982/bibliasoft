  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_historiales_crm_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_historiales_crm_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_historial_crm
  function do_ajax_form_historiales_crm_mob_validate_id_historial_crm()
  {
    var nomeCampo_id_historial_crm = "id_historial_crm";
    var var_id_historial_crm = scAjaxGetFieldHidden(nomeCampo_id_historial_crm);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_mob_validate_id_historial_crm(var_id_historial_crm, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_id_historial_crm_cb);
  } // do_ajax_form_historiales_crm_mob_validate_id_historial_crm

  function do_ajax_form_historiales_crm_mob_validate_id_historial_crm_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_historial_crm";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_id_historial_crm_cb

  // ---------- Validate fecha
  function do_ajax_form_historiales_crm_mob_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_historiales_crm_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_historiales_crm_mob_validate_fecha

  function do_ajax_form_historiales_crm_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_fecha_cb

  // ---------- Validate tipo
  function do_ajax_form_historiales_crm_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_tipo_cb);
  } // do_ajax_form_historiales_crm_mob_validate_tipo

  function do_ajax_form_historiales_crm_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_tipo_cb

  // ---------- Validate notas
  function do_ajax_form_historiales_crm_mob_validate_notas()
  {
    var nomeCampo_notas = "notas";
    var var_notas = scAjaxGetFieldText(nomeCampo_notas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_mob_validate_notas(var_notas, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_notas_cb);
  } // do_ajax_form_historiales_crm_mob_validate_notas

  function do_ajax_form_historiales_crm_mob_validate_notas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_notas_cb

  // ---------- Validate asesor
  function do_ajax_form_historiales_crm_mob_validate_asesor()
  {
    var nomeCampo_asesor = "asesor";
    var var_asesor = scAjaxGetFieldSelect(nomeCampo_asesor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_mob_validate_asesor(var_asesor, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_asesor_cb);
  } // do_ajax_form_historiales_crm_mob_validate_asesor

  function do_ajax_form_historiales_crm_mob_validate_asesor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asesor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_asesor_cb

  // ---------- Validate motivo
  function do_ajax_form_historiales_crm_mob_validate_motivo()
  {
    var nomeCampo_motivo = "motivo";
    var var_motivo = scAjaxGetFieldSelect(nomeCampo_motivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_mob_validate_motivo(var_motivo, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_motivo_cb);
  } // do_ajax_form_historiales_crm_mob_validate_motivo

  function do_ajax_form_historiales_crm_mob_validate_motivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "motivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_motivo_cb

  // ---------- Validate atendido
  function do_ajax_form_historiales_crm_mob_validate_atendido()
  {
    var nomeCampo_atendido = "atendido";
    var var_atendido = scAjaxGetFieldSelect(nomeCampo_atendido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_mob_validate_atendido(var_atendido, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_atendido_cb);
  } // do_ajax_form_historiales_crm_mob_validate_atendido

  function do_ajax_form_historiales_crm_mob_validate_atendido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "atendido";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_atendido_cb

  // ---------- Validate id_contacto_tercero
  function do_ajax_form_historiales_crm_mob_validate_id_contacto_tercero()
  {
  } // do_ajax_form_historiales_crm_mob_validate_id_contacto_tercero

  function do_ajax_form_historiales_crm_mob_validate_id_contacto_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_contacto_tercero";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_id_contacto_tercero_cb

  // ---------- Validate estado
  function do_ajax_form_historiales_crm_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_estado_cb);
  } // do_ajax_form_historiales_crm_mob_validate_estado

  function do_ajax_form_historiales_crm_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_estado_cb

  // ---------- Validate archivos
  function do_ajax_form_historiales_crm_mob_validate_archivos()
  {
    var nomeCampo_archivos = "archivos";
    var var_archivos = scAjaxGetFieldText(nomeCampo_archivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_mob_validate_archivos(var_archivos, var_script_case_init, do_ajax_form_historiales_crm_mob_validate_archivos_cb);
  } // do_ajax_form_historiales_crm_mob_validate_archivos

  function do_ajax_form_historiales_crm_mob_validate_archivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_mob_validate_archivos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_historiales_crm_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_historiales_crm_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_historial_crm = scAjaxGetFieldHidden("id_historial_crm");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_tipo = scAjaxGetFieldSelect("tipo");
    var var_notas = scAjaxGetFieldText("notas");
    var var_asesor = scAjaxGetFieldSelect("asesor");
    var var_motivo = scAjaxGetFieldSelect("motivo");
    var var_atendido = scAjaxGetFieldSelect("atendido");
    var var_id_contacto_tercero = scAjaxGetFieldText("id_contacto_tercero");
    ...
    scAjaxProcOn();
    x_ajax_form_historiales_crm_mob_submit_form(var_id_historial_crm, var_fecha, var_tipo, var_notas, var_asesor, var_motivo, var_atendido, var_id_contacto_tercero, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_historiales_crm_mob_submit_form_cb);
  } // do_ajax_form_historiales_crm_mob_submit_form

  function do_ajax_form_historiales_crm_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_historial_crm");
      scAjaxHideErrorDisplay("fecha");
      scAjaxHideErrorDisplay("tipo");
      scAjaxHideErrorDisplay("notas");
      scAjaxHideErrorDisplay("asesor");
      scAjaxHideErrorDisplay("motivo");
      scAjaxHideErrorDisplay("atendido");
      scAjaxHideErrorDisplay("id_contacto_tercero");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_historiales_crm_mob_submit_form_cb_after_alert);
  } // do_ajax_form_historiales_crm_mob_submit_form_cb
  function do_ajax_form_historiales_crm_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_historiales_crm_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_historiales_archivos_mob"] = "off";

  function do_ajax_form_historiales_crm_mob_navigate_form()
  {
    perform_ajax_form_historiales_crm_mob_navigate_form();
  }

  function perform_ajax_form_historiales_crm_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("estado");
    scAjaxHideErrorDisplay("archivos");
    var var_id_historial_crm = document.F2.id_historial_crm.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_historiales_archivos_mob"] = "on";
    x_ajax_form_historiales_crm_mob_navigate_form(var_id_historial_crm, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_historiales_crm_mob_navigate_form_cb);
  } // do_ajax_form_historiales_crm_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_historiales_crm_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_historial_crm.value = scAjaxGetKeyValue("id_historial_crm");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_historiales_archivos_mob"] && "nmsc_iframe_liga_form_historiales_archivos_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_historiales_archivos_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_historiales_archivos_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_historiales_archivos_mob').contentWindow.nm_move('apl_detalhe', true, '350');
        document.getElementById('nmsc_iframe_liga_form_historiales_archivos_mob').style.height = "350";
        document.getElementById('nmsc_iframe_liga_form_historiales_archivos_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_historiales_crm_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_historiales_crm_mob_navigate_form_cb
  function do_ajax_form_historiales_crm_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_historiales_crm_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_historiales_crm_mob_navigate_form_cb_after_alert
  function sc_hide_form_historiales_crm_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_historiales_archivos_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "id_historial_crm";
  ajax_field_list[1] = "fecha";
  ajax_field_list[2] = "tipo";
  ajax_field_list[3] = "notas";
  ajax_field_list[4] = "asesor";
  ajax_field_list[5] = "motivo";
  ajax_field_list[6] = "atendido";
  ajax_field_list[7] = "id_contacto_tercero";
  ajax_field_list[8] = "estado";
  ajax_field_list[9] = "archivos";
  ...
  var ajax_error_list = {
    "id_historial_crm": {"label": "Id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "notas": {"label": "Notas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "asesor": {"label": "Asesor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "motivo": {"label": "Motivo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "atendido": {"label": "Atendido", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_contacto_tercero": {"label": "Contacto/Tercero", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "motivo": new Array(),
    "atendido": new Array(),
    "id_contacto_tercero": new Array(),
    "estado": new Array(),
    "archivos": new Array()
  };
  ajax_field_mult["id_historial_crm"][1] = "id_historial_crm";
  ajax_field_mult["fecha"][1] = "fecha";
  ajax_field_mult["tipo"][1] = "tipo";
  ajax_field_mult["notas"][1] = "notas";
  ajax_field_mult["asesor"][1] = "asesor";
  ajax_field_mult["motivo"][1] = "motivo";
  ajax_field_mult["atendido"][1] = "atendido";
  ajax_field_mult["id_contacto_tercero"][1] = "id_contacto_tercero";
  ajax_field_mult["estado"][1] = "estado";
  ajax_field_mult["archivos"][1] = "archivos";

  var ajax_field_id = {
    "id_historial_crm": new Array("hidden_field_label_id_historial_crm", "hidden_field_data_id_historial_crm"),
    ...
    "asesor": new Array("hidden_field_label_asesor", "hidden_field_data_asesor"),
    "motivo": new Array("hidden_field_label_motivo", "hidden_field_data_motivo"),
    "atendido": new Array("hidden_field_label_atendido", "hidden_field_data_atendido"),
    "id_contacto_tercero": new Array("hidden_field_label_id_contacto_tercero", "hidden_field_data_id_contacto_tercero"),
