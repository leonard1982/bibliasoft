...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_historiales_crm_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_historiales_crm_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-id_contacto_tercero", elem).on("focus", function() {
   ...
   var sId = $(this).attr("id").substr(6), sRow = "id_contacto_tercero" != sId ? sId.substr(19) : "";
   sc_form_historiales_crm_id_contacto_tercero_onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_historiales_crm_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_historiales_crm'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_historiales_crm'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] != "R")
{
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['bcancelar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['bcancelar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['bcancelar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['bcancelar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['bcancelar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['btn_crear_contacto']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['btn_crear_contacto']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['btn_crear_contacto']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['btn_crear_contacto']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['btn_crear_contacto'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['btn_crear_tercero']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['btn_crear_tercero']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['btn_crear_tercero']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['btn_crear_tercero']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['btn_crear_tercero'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard']))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['empty_filter'] = true;
       }
  }
?>
<script type="text/javascript">
var pag_ativa = "form_historiales_crm_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_historiales_crm_form0' => array(
            'title' => "Datos",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "form_historiales_crm_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_historiales_crm_form1' => array(
            'title' => "Archivos",
            'class' => $nmgp_num_form == "form_historiales_crm_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Datos' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_historiales_crm_form0']['class'] = 'scTabInactive';
                        }
                        if ('Archivos' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_historiales_crm_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_historiales_crm_form0"]['class'];
?>
   <li id="id_form_historiales_crm_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_historiales_crm_form0')">
     <img src="<?php echo $this->Ini->path_icones ?>/scriptcase__NM__ico__NM__about_24.png" align="absmiddle">
     Datos
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_historiales_crm_form1"]['class'];
?>
   <li id="id_form_historiales_crm_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_historiales_crm_form1')">
...
<div id="form_historiales_crm_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_historial_crm_label" id="hidden_field_label_id_historial_crm" style="<?php echo $sStyleHidden_id_historial_crm; ?>"><span id="id_label_id_historial_crm"><?php echo $this->nm_new_label['id_historial_crm']; ?></span></TD>
    <TD class="scFormDataOdd css_id_historial_crm_line" id="hidden_field_data_id_historial_crm" style="<?php echo $sStyleHidden_id_historial_crm; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_historial_crm_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_id_historial_crm" class="css_id_historial_crm_line" style="<?php echo $sStyleReadLab_id_historial_crm; ?>"><?php echo $this->form_format_readonly("id_historial_crm", $this->form_encode_input($this->id_historial_crm)); ?></span><span id="id_read_off_id_historial_crm" class="css_read_off_id_historial_crm" style="<?php echo $sStyleReadInp_id_historial_crm; ?>"><input type="hidden" name="id_historial_crm" value="<?php echo $this->form_encode_input($id_historial_crm) . "\">"?><span id="id_ajax_label_id_historial_crm"><?php echo nl2br($id_historial_crm); ?></span>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_fecha_label" id="hidden_field_label_fecha" style="<?php echo $sStyleHidden_fecha; ?>"><span id="id_label_fecha"><?php echo $this->nm_new_label['fecha']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['fecha']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['fecha'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_fecha_line" id="hidden_field_data_fecha" style="<?php echo $sStyleHidden_fecha; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_fecha_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_tipo_label" id="hidden_field_label_tipo" style="<?php echo $sStyleHidden_tipo; ?>"><span id="id_label_tipo"><?php echo $this->nm_new_label['tipo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['tipo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['tipo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_tipo'][] = ''; ?>
 <option value="">SELECCIONE</option>
 <option  value="TELEFONICO" <?php  if ($this->tipo == "TELEFONICO") { echo " selected" ;} ?>>TELEFONICO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_tipo'][] = 'TELEFONICO'; ?>
 <option  value="EMAIL" <?php  if ($this->tipo == "EMAIL") { echo " selected" ;} ?>>EMAIL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_tipo'][] = 'EMAIL'; ?>
 <option  value="SMS" <?php  if ($this->tipo == "SMS") { echo " selected" ;} ?>>SMS</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_tipo'][] = 'SMS'; ?>
 <option  value="PRESENCIAL" <?php  if ($this->tipo == "PRESENCIAL") { echo " selected" ;} ?>>PRESENCIAL</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_tipo'][] = 'PRESENCIAL'; ?>
 <option  value="WHATSAPP" <?php  if ($this->tipo == "WHATSAPP") { echo " selected" ;} ?>>WHATSAPP</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_tipo'][] = 'WHATSAPP'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_notas_label" id="hidden_field_label_notas" style="<?php echo $sStyleHidden_notas; ?>"><span id="id_label_notas"><?php echo $this->nm_new_label['notas']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['notas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['notas'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_notas_line" id="hidden_field_data_notas" style="<?php echo $sStyleHidden_notas; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_notas_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_asesor_label" id="hidden_field_label_asesor" style="<?php echo $sStyleHidden_asesor; ?>"><span id="id_label_asesor"><?php echo $this->nm_new_label['asesor']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['asesor']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['asesor'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_asesor']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_asesor'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_asesor']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_asesor'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_asesor'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php
   ...
   echo "\r" ; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_asesor'][] = ''; 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_motivo_label" id="hidden_field_label_motivo" style="<?php echo $sStyleHidden_motivo; ?>"><span id="id_label_motivo"><?php echo $this->nm_new_label['motivo']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['motivo']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['motivo'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_motivo_line" id="hidden_field_data_motivo" style="<?php echo $sStyleHidden_motivo; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_motivo_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_motivo'][] = ''; ?>
 <option value="">SELECCIONE</option>
 <option  value="VENTA" <?php  if ($this->motivo == "VENTA") { echo " selected" ;} ?>>VENTA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_motivo'][] = 'VENTA'; ?>
 <option  value="ASISTENCIA" <?php  if ($this->motivo == "ASISTENCIA") { echo " selected" ;} ?>>ASISTENCIA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_motivo'][] = 'ASISTENCIA'; ?>
 <option  value="SOPORTE" <?php  if ($this->motivo == "SOPORTE") { echo " selected" ;} ?>>SOPORTE</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_motivo'][] = 'SOPORTE'; ?>
 <option  value="COBRO" <?php  if ($this->motivo == "COBRO") { echo " selected" ;} ?>>COBRO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_motivo'][] = 'COBRO'; ?>
 <option  value="DEMO" <?php  if ($this->motivo == "DEMO") { echo " selected" ;} ?>>DEMO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_motivo'][] = 'DEMO'; ?>
 <option  value="DONACION" <?php  if ($this->motivo == "DONACION") { echo " selected" ;} ?>>DONACION</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_motivo'][] = 'DONACION'; ?>
 <option  value="SEGUIMIENTO" <?php  if ($this->motivo == "SEGUIMIENTO") { echo " selected" ;} ?>>SEGUIMIENTO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_motivo'][] = 'SEGUIMIENTO'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_atendido_label" id="hidden_field_label_atendido" style="<?php echo $sStyleHidden_atendido; ?>"><span id="id_label_atendido"><?php echo $this->nm_new_label['atendido']; ?></span></TD>
    <TD class="scFormDataOdd css_atendido_line" id="hidden_field_data_atendido" style="<?php echo $sStyleHidden_atendido; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_atendido_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_atendido'][] = 'terceros'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_atendido'][] = 'contactos'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_id_contacto_tercero_label" id="hidden_field_label_id_contacto_tercero" style="<?php echo $sStyleHidden_id_contacto_tercero; ?>"><span id="id_label_id_contacto_tercero"><?php echo $this->nm_new_label['id_contacto_tercero']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['id_contacto_tercero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['php_cmp_required']['id_contacto_tercero'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_id_contacto_tercero_line" id="hidden_field_data_id_contacto_tercero" style="<?php echo $sStyleHidden_id_contacto_tercero; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_id_contacto_tercero_line" style="vertical-align: top;padding: 0px">
...
$aLookup = array();
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_id_contacto_tercero']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_id_contacto_tercero'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_id_contacto_tercero']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_id_contacto_tercero'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_id_contacto_tercero'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estado_line" id="hidden_field_data_estado" style="<?php echo $sStyleHidden_estado; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estado_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_estado'][] = 'PENDIENTE'; ?>
 <option  value="PROCESO" <?php  if ($this->estado == "PROCESO") { echo " selected" ;} ?>>PROCESO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_estado'][] = 'PROCESO'; ?>
 <option  value="FINALIZADA" <?php  if ($this->estado == "FINALIZADA") { echo " selected" ;} ?>>FINALIZADA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_estado'][] = 'FINALIZADA'; ?>
 <option  value="RECHAZADA" <?php  if ($this->estado == "RECHAZADA") { echo " selected" ;} ?>>RECHAZADA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_estado'][] = 'RECHAZADA'; ?>
 <option  value="ESPERA" <?php  if ($this->estado == "ESPERA") { echo " selected" ;} ?>>ESPERA</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['Lookup_estado'][] = 'ESPERA'; ?>
 </select></span>
</span><?php  }?>
