<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="id_historial_crm" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_historial_crm']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_historiales_crm_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
?> 
function sc_btn_btn_crear_contacto()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_crear_contacto(); }, 500);
      return;
    }
    sc_btn_btn_crear_contacto_ok();
}
function sc_btn_btn_crear_contacto_cancel()
{
}
function sc_btn_btn_crear_contacto_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_grid_contactos_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo ""; ?>', 'inicio', '_blank', '0', '0', 'grid_contactos');
}
function sc_btn_btn_crear_tercero()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_crear_tercero(); }, 500);
      return;
    }
    sc_btn_btn_crear_tercero_ok();
}
function sc_btn_btn_crear_tercero_cancel()
{
}
function sc_btn_btn_crear_tercero_ok()
{
  nm_gp_submit('<?php echo $this->Ini->link_grid_terceros_todos_cons; ?>', '<?php echo $this->nm_location; ?>', '<?php echo ""; ?>', 'inicio', '_blank', '0', '0', 'grid_terceros_todos');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm_mob']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm_mob']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm_mob']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_historiales_crm_mob_form0').style.width='1px';
    document.getElementById('form_historiales_crm_mob_form0').style.height='0px';
    document.getElementById('form_historiales_crm_mob_form0').style.display='none';
    document.getElementById('form_historiales_crm_mob_form0').style.overflow='scroll';
    document.getElementById('form_historiales_crm_mob_form1').style.width='1px';
    document.getElementById('form_historiales_crm_mob_form1').style.height='0px';
    document.getElementById('form_historiales_crm_mob_form1').style.display='none';
    document.getElementById('form_historiales_crm_mob_form1').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm_mob']['pdf_view']) {
?>
...
?>
   ...
   if ("form_historiales_crm_mob_form1" == N_pagina) {
