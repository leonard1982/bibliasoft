  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_historiales_crm" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_historiales_crm_form();
	}
...
?>
  ...
  function do_ajax_form_historiales_crm_validate_id_historial_crm()
  {
    ...
    x_ajax_form_historiales_crm_validate_id_historial_crm(var_id_historial_crm, var_script_case_init, do_ajax_form_historiales_crm_validate_id_historial_crm_cb);
  } // do_ajax_form_historiales_crm_validate_id_historial_crm

  function do_ajax_form_historiales_crm_validate_id_historial_crm_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_id_historial_crm_cb

  // ---------- Validate fecha
  function do_ajax_form_historiales_crm_validate_fecha()
  {
    ...
    setTimeout(function() {
      var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
      x_ajax_form_historiales_crm_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_historiales_crm_validate_fecha_cb);
    }, 200);
  } // do_ajax_form_historiales_crm_validate_fecha

  function do_ajax_form_historiales_crm_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_fecha_cb

  // ---------- Validate tipo
  function do_ajax_form_historiales_crm_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_historiales_crm_validate_tipo_cb);
  } // do_ajax_form_historiales_crm_validate_tipo

  function do_ajax_form_historiales_crm_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_tipo_cb

  // ---------- Validate notas
  function do_ajax_form_historiales_crm_validate_notas()
  {
    var nomeCampo_notas = "notas";
    var var_notas = scAjaxGetFieldText(nomeCampo_notas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_validate_notas(var_notas, var_script_case_init, do_ajax_form_historiales_crm_validate_notas_cb);
  } // do_ajax_form_historiales_crm_validate_notas

  function do_ajax_form_historiales_crm_validate_notas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_notas_cb

  // ---------- Validate asesor
  function do_ajax_form_historiales_crm_validate_asesor()
  {
    var nomeCampo_asesor = "asesor";
    var var_asesor = scAjaxGetFieldSelect(nomeCampo_asesor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_validate_asesor(var_asesor, var_script_case_init, do_ajax_form_historiales_crm_validate_asesor_cb);
  } // do_ajax_form_historiales_crm_validate_asesor

  function do_ajax_form_historiales_crm_validate_asesor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asesor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_asesor_cb

  // ---------- Validate motivo
  function do_ajax_form_historiales_crm_validate_motivo()
  {
    var nomeCampo_motivo = "motivo";
    var var_motivo = scAjaxGetFieldSelect(nomeCampo_motivo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_validate_motivo(var_motivo, var_script_case_init, do_ajax_form_historiales_crm_validate_motivo_cb);
  } // do_ajax_form_historiales_crm_validate_motivo

  function do_ajax_form_historiales_crm_validate_motivo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "motivo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_motivo_cb

  // ---------- Validate atendido
  function do_ajax_form_historiales_crm_validate_atendido()
  {
    var nomeCampo_atendido = "atendido";
    var var_atendido = scAjaxGetFieldSelect(nomeCampo_atendido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_validate_atendido(var_atendido, var_script_case_init, do_ajax_form_historiales_crm_validate_atendido_cb);
  } // do_ajax_form_historiales_crm_validate_atendido

  function do_ajax_form_historiales_crm_validate_atendido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_atendido_cb

  // ---------- Validate id_contacto_tercero
  function do_ajax_form_historiales_crm_validate_id_contacto_tercero()
  {
  } // do_ajax_form_historiales_crm_validate_id_contacto_tercero

  function do_ajax_form_historiales_crm_validate_id_contacto_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_id_contacto_tercero_cb

  // ---------- Validate estado
  function do_ajax_form_historiales_crm_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_validate_estado(var_estado, var_script_case_init, do_ajax_form_historiales_crm_validate_estado_cb);
  } // do_ajax_form_historiales_crm_validate_estado

  function do_ajax_form_historiales_crm_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_estado_cb

  // ---------- Validate archivos
  function do_ajax_form_historiales_crm_validate_archivos()
  {
    var nomeCampo_archivos = "archivos";
    var var_archivos = scAjaxGetFieldText(nomeCampo_archivos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_historiales_crm_validate_archivos(var_archivos, var_script_case_init, do_ajax_form_historiales_crm_validate_archivos_cb);
  } // do_ajax_form_historiales_crm_validate_archivos

  function do_ajax_form_historiales_crm_validate_archivos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_historiales_crm_validate_archivos_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_historiales_crm_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_historiales_crm_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_historiales_crm_submit_form(var_id_historial_crm, var_fecha, var_tipo, var_notas, var_asesor, var_motivo, var_atendido, var_id_contacto_tercero, var_estado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_historiales_crm_submit_form_cb);
  } // do_ajax_form_historiales_crm_submit_form

  function do_ajax_form_historiales_crm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_historiales_crm_submit_form_cb_after_alert);
  } // do_ajax_form_historiales_crm_submit_form_cb
  function do_ajax_form_historiales_crm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_historiales_crm_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_historiales_archivos"] = "off";

  function do_ajax_form_historiales_crm_navigate_form()
  {
    perform_ajax_form_historiales_crm_navigate_form();
  }

  function perform_ajax_form_historiales_crm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_historiales_archivos"] = "on";
    x_ajax_form_historiales_crm_navigate_form(var_id_historial_crm, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_historiales_crm_navigate_form_cb);
  } // do_ajax_form_historiales_crm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_historiales_crm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_historiales_crm_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_historiales_archivos"] && "nmsc_iframe_liga_form_historiales_archivos" != scMasterDetailIframe["nmsc_iframe_liga_form_historiales_archivos"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_historiales_archivos"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_historiales_archivos').contentWindow.nm_move('apl_detalhe', true, '350');
        document.getElementById('nmsc_iframe_liga_form_historiales_archivos').style.height = "350";
        document.getElementById('nmsc_iframe_liga_form_historiales_archivos').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_historiales_crm_navigate_form_cb_after_alert);
  } // do_ajax_form_historiales_crm_navigate_form_cb
  function do_ajax_form_historiales_crm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_historiales_crm_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_historiales_crm_navigate_form_cb_after_alert
  function sc_hide_form_historiales_crm_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_historiales_archivos"])
    {
      return true;
    }
    return false;
