...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_terceros_exportar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_V2_____grid_terceros_exportar"]);
   }
