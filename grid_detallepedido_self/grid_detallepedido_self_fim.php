...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallepedido_self"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallepedido_self"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallepedido_self</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallepedido_self']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_detallepedido_self' || $achou)
          {
