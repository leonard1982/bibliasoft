...
<?php
   ...
   $Ord_Cmp = new grid_detallepedido_self_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detallepedido_self_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_detallepedido_self_json.php");
   }
   ...
   $tab_def_campos['idpedid'] = "idpedid";
   $tab_labels["idpedid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["idpedid"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["idpedid"] : "Idpedid";
   $tab_ger_campos['unidadmayor'] = "on";
   $tab_def_campos['unidadmayor'] = "unidadmayor";
   $tab_labels["unidadmayor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["unidadmayor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["unidadmayor"] : "Unidadmayor";
   $tab_ger_campos['factor'] = "on";
   $tab_def_campos['factor'] = "factor";
   $tab_labels["factor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["factor"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["factor"] : "Factor";
   $tab_ger_campos['idpro'] = "on";
   $tab_def_campos['idpro'] = "idpro";
   $tab_labels["idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["idpro"] : "Producto";
   $tab_ger_campos['idbod'] = "on";
   $tab_def_campos['idbod'] = "idbod";
   $tab_labels["idbod"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["idbod"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["idbod"] : "Bodega";
   $tab_ger_campos['costop'] = "on";
   $tab_def_campos['costop'] = "costop";
   $tab_labels["costop"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["costop"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["costop"] : "Costop";
   $tab_ger_campos['cantidad'] = "on";
   $tab_def_campos['cantidad'] = "cantidad";
   $tab_labels["cantidad"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["cantidad"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["cantidad"] : "Cantidad";
   $tab_ger_campos['valorunit'] = "on";
   $tab_def_campos['valorunit'] = "valorunit";
   $tab_labels["valorunit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["valorunit"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["valorunit"] : "Valorunit";
   $tab_ger_campos['valorpar'] = "on";
   $tab_def_campos['valorpar'] = "valorpar";
   $tab_labels["valorpar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["valorpar"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["valorpar"] : "Valorpar";
   $tab_ger_campos['observ'] = "on";
   $tab_def_campos['observ'] = "observ";
   $tab_labels["observ"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["observ"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["observ"] : "Observ";
   $tab_ger_campos['obs'] = "on";
   $tab_def_campos['obs'] = "obs";
   $tab_labels["obs"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["obs"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["obs"] : "Obs";
   $tab_ger_campos['descr'] = "on";
   $tab_def_campos['descr'] = "descr";
   $tab_labels["descr"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["descr"])) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['labels']["descr"] : "Descr";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - detallepedido_self</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detallepedido_self_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detallepedido_self']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
