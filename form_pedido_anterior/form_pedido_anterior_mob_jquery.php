...
function sc_form_pedido_anterior_numfacven_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_numfacven();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_credito_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_credito();
  scCssBlur(oThis);
}

function sc_form_pedido_anterior_credito_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_event_credito_onchange();
}
...
function sc_form_pedido_anterior_fechaven_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_fechaven();
  scCssBlur(oThis);
}

function sc_form_pedido_anterior_fechaven_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_event_fechaven_onchange();
}
...
function sc_form_pedido_anterior_fechavenc_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_fechavenc();
  scCssBlur(oThis);
}

function sc_form_pedido_anterior_fechavenc_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_event_fechavenc_onchange();
}
...
function sc_form_pedido_anterior_idcli_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_idcli();
  scCssBlur(oThis);
}

function sc_form_pedido_anterior_idcli_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_event_idcli_onchange();
}
...
function sc_form_pedido_anterior_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_subtotal();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_valoriva_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_valoriva();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_total_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_total();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_facturado_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_facturado();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_asentada_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_asentada();
  scCssBlur(oThis);
}

function sc_form_pedido_anterior_asentada_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_event_asentada_onchange();
}
...
function sc_form_pedido_anterior_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_observaciones();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_saldo_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_saldo();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_adicional_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_adicional();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_vendedor_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_vendedor();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_dircliente_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_dircliente();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_numpedido_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_numpedido();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_prefijo_ped_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_prefijo_ped();
  scCssBlur(oThis);
}

function sc_form_pedido_anterior_prefijo_ped_onchange(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_event_prefijo_ped_onchange();
}
...
function sc_form_pedido_anterior_cupo_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_cupo();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_cupodis_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_cupodis();
  scCssBlur(oThis);
}
...
function sc_form_pedido_anterior_detallepedidos_onblur(oThis, iSeqRow) {
  do_ajax_form_pedido_anterior_mob_validate_detallepedidos();
  scCssBlur(oThis);
}
...
function displayChange_field_detallepedidos(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_detallepedido_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_detallepedido_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_pedido_anterior_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechaven" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pedido_anterior_mob_validate_fechaven(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_pedido_anterior_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pedido_anterior_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
