...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_caso' + iSeqRow).bind('blur', function() { sc_form_casos_id_caso_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_casos_id_caso_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fecha' + iSeqRow).bind('blur', function() { sc_form_casos_fecha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_casos_fecha_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_casos_fecha_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_hora' + iSeqRow).bind('blur', function() { sc_form_casos_fecha_hora_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_casos_fecha_hora_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_casos_fecha_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_numero' + iSeqRow).bind('blur', function() { sc_form_casos_numero_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_casos_numero_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo_caso' + iSeqRow).bind('blur', function() { sc_form_casos_tipo_caso_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_casos_tipo_caso_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_medio' + iSeqRow).bind('blur', function() { sc_form_casos_medio_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_casos_medio_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_form_casos_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_casos_observaciones_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_asignado_tercero' + iSeqRow).bind('blur', function() { sc_form_casos_asignado_tercero_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_casos_asignado_tercero_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fecha_asignacion' + iSeqRow).bind('blur', function() { sc_form_casos_fecha_asignacion_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_casos_fecha_asignacion_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_casos_fecha_asignacion_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_asignacion_hora' + iSeqRow).bind('blur', function() { sc_form_casos_fecha_asignacion_hora_onblur(this, iSeqRow) })
                                                   .bind('change', function() { sc_form_casos_fecha_asignacion_hora_onchange(this, iSeqRow) })
                                                   .bind('focus', function() { sc_form_casos_fecha_asignacion_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_cierre' + iSeqRow).bind('blur', function() { sc_form_casos_fecha_cierre_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_casos_fecha_cierre_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_casos_fecha_cierre_onfocus(this, iSeqRow) });
  $('#id_sc_field_fecha_cierre_hora' + iSeqRow).bind('blur', function() { sc_form_casos_fecha_cierre_hora_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_form_casos_fecha_cierre_hora_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_form_casos_fecha_cierre_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_valor' + iSeqRow).bind('blur', function() { sc_form_casos_valor_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_casos_valor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cedula_tercero' + iSeqRow).bind('blur', function() { sc_form_casos_cedula_tercero_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_casos_cedula_tercero_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_notificado' + iSeqRow).bind('blur', function() { sc_form_casos_notificado_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_casos_notificado_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_hora' + iSeqRow).bind('blur', function() { sc_form_casos_hora_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_casos_hora_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_hora_asignacion' + iSeqRow).bind('blur', function() { sc_form_casos_hora_asignacion_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_casos_hora_asignacion_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_hora_cierre' + iSeqRow).bind('blur', function() { sc_form_casos_hora_cierre_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_casos_hora_cierre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_factura' + iSeqRow).bind('blur', function() { sc_form_casos_factura_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_casos_factura_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_form_casos_detalle_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_casos_detalle_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_color1' + iSeqRow).bind('blur', function() { sc_form_casos_color1_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_casos_color1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_color2' + iSeqRow).bind('blur', function() { sc_form_casos_color2_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_casos_color2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tercero_nom' + iSeqRow).bind('blur', function() { sc_form_casos_tercero_nom_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_casos_tercero_nom_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_fac_num' + iSeqRow).bind('blur', function() { sc_form_casos_fac_num_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_casos_fac_num_onchange(this, iSeqRow) })
...
function sc_form_casos_id_caso_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_fecha_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_casos_validate_fecha();
  scCssBlur(oThis);
}

function sc_form_casos_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_casos_fecha_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_fecha_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_casos_numero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_tipo_caso_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_medio_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_asignado_tercero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_fecha_asignacion_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_casos_validate_fecha_asignacion();
  scCssBlur(oThis);
}

function sc_form_casos_fecha_asignacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_casos_fecha_asignacion_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_fecha_asignacion_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_casos_fecha_cierre_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_casos_validate_fecha_cierre();
  scCssBlur(oThis);
}

function sc_form_casos_fecha_cierre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_casos_fecha_cierre_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_fecha_cierre_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_casos_valor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_cedula_tercero_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_notificado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_hora_asignacion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_hora_cierre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_factura_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_detalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_color1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_color2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_tercero_nom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_casos_fac_num_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_casos_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fecha" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_casos_validate_fecha(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fecha_asignacion" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_casos_validate_fecha_asignacion(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    dayNames: ["<?php        echo html_entity_decode($this->Ini->Nm_lang['lang_days_sund'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_mond'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_tued'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_wend'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_thud'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_frid'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>","<?php echo html_entity_decode($this->Ini->Nm_lang['lang_days_satd'], ENT_COMPAT, $_SESSION['scriptcase']['charset']);        ?>"],
...
?>
  ...
  $("#id_sc_field_fecha_cierre" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_casos_validate_fecha_cierre(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_casos')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
