  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_casos_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate numero
  function do_ajax_form_casos_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_casos_mob_validate_numero_cb);
  } // do_ajax_form_casos_mob_validate_numero

  function do_ajax_form_casos_mob_validate_numero_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_numero_cb

  // ---------- Validate fecha
  function do_ajax_form_casos_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_casos_mob_validate_fecha_cb);
  } // do_ajax_form_casos_mob_validate_fecha

  function do_ajax_form_casos_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_fecha_cb

  // ---------- Validate hora
  function do_ajax_form_casos_mob_validate_hora()
  {
    var nomeCampo_hora = "hora";
    var var_hora = scAjaxGetFieldText(nomeCampo_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_hora(var_hora, var_script_case_init, do_ajax_form_casos_mob_validate_hora_cb);
  } // do_ajax_form_casos_mob_validate_hora

  function do_ajax_form_casos_mob_validate_hora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_hora_cb

  // ---------- Validate codigo_cliente
  function do_ajax_form_casos_mob_validate_codigo_cliente()
  {
    var nomeCampo_codigo_cliente = "codigo_cliente";
    var var_codigo_cliente = scAjaxGetFieldText(nomeCampo_codigo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_codigo_cliente(var_codigo_cliente, var_script_case_init, do_ajax_form_casos_mob_validate_codigo_cliente_cb);
  } // do_ajax_form_casos_mob_validate_codigo_cliente

  function do_ajax_form_casos_mob_validate_codigo_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_codigo_cliente_cb

  // ---------- Validate cedula_tercero
  function do_ajax_form_casos_mob_validate_cedula_tercero()
  {
    var nomeCampo_cedula_tercero = "cedula_tercero";
    var var_cedula_tercero = scAjaxGetFieldText(nomeCampo_cedula_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_cedula_tercero(var_cedula_tercero, var_script_case_init, do_ajax_form_casos_mob_validate_cedula_tercero_cb);
  } // do_ajax_form_casos_mob_validate_cedula_tercero

  function do_ajax_form_casos_mob_validate_cedula_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_cedula_tercero_cb

  // ---------- Validate tercero_nom
  function do_ajax_form_casos_mob_validate_tercero_nom()
  {
    var nomeCampo_tercero_nom = "tercero_nom";
    var var_tercero_nom = scAjaxGetFieldText(nomeCampo_tercero_nom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_tercero_nom(var_tercero_nom, var_script_case_init, do_ajax_form_casos_mob_validate_tercero_nom_cb);
  } // do_ajax_form_casos_mob_validate_tercero_nom

  function do_ajax_form_casos_mob_validate_tercero_nom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_tercero_nom_cb

  // ---------- Validate notificado
  function do_ajax_form_casos_mob_validate_notificado()
  {
    var nomeCampo_notificado = "notificado";
    var var_notificado = scAjaxGetFieldText(nomeCampo_notificado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_notificado(var_notificado, var_script_case_init, do_ajax_form_casos_mob_validate_notificado_cb);
  } // do_ajax_form_casos_mob_validate_notificado

  function do_ajax_form_casos_mob_validate_notificado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_notificado_cb

  // ---------- Validate estado
  function do_ajax_form_casos_mob_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_estado(var_estado, var_script_case_init, do_ajax_form_casos_mob_validate_estado_cb);
  } // do_ajax_form_casos_mob_validate_estado

  function do_ajax_form_casos_mob_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_estado_cb

  // ---------- Validate color1
  function do_ajax_form_casos_mob_validate_color1()
  {
    var nomeCampo_color1 = "color1";
    var var_color1 = scAjaxGetFieldHidden(nomeCampo_color1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_color1(var_color1, var_script_case_init, do_ajax_form_casos_mob_validate_color1_cb);
  } // do_ajax_form_casos_mob_validate_color1

  function do_ajax_form_casos_mob_validate_color1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_color1_cb

  // ---------- Validate prioridad
  function do_ajax_form_casos_mob_validate_prioridad()
  {
    var nomeCampo_prioridad = "prioridad";
    var var_prioridad = scAjaxGetFieldSelect(nomeCampo_prioridad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_prioridad(var_prioridad, var_script_case_init, do_ajax_form_casos_mob_validate_prioridad_cb);
  } // do_ajax_form_casos_mob_validate_prioridad

  function do_ajax_form_casos_mob_validate_prioridad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_prioridad_cb

  // ---------- Validate color2
  function do_ajax_form_casos_mob_validate_color2()
  {
    var nomeCampo_color2 = "color2";
    var var_color2 = scAjaxGetFieldHidden(nomeCampo_color2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_color2(var_color2, var_script_case_init, do_ajax_form_casos_mob_validate_color2_cb);
  } // do_ajax_form_casos_mob_validate_color2

  function do_ajax_form_casos_mob_validate_color2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_color2_cb

  // ---------- Validate tipo_caso
  function do_ajax_form_casos_mob_validate_tipo_caso()
  {
    var nomeCampo_tipo_caso = "tipo_caso";
    var var_tipo_caso = scAjaxGetFieldSelect(nomeCampo_tipo_caso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_tipo_caso(var_tipo_caso, var_script_case_init, do_ajax_form_casos_mob_validate_tipo_caso_cb);
  } // do_ajax_form_casos_mob_validate_tipo_caso

  function do_ajax_form_casos_mob_validate_tipo_caso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_tipo_caso_cb

  // ---------- Validate medio
  function do_ajax_form_casos_mob_validate_medio()
  {
    var nomeCampo_medio = "medio";
    var var_medio = scAjaxGetFieldSelect(nomeCampo_medio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_medio(var_medio, var_script_case_init, do_ajax_form_casos_mob_validate_medio_cb);
  } // do_ajax_form_casos_mob_validate_medio

  function do_ajax_form_casos_mob_validate_medio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_medio_cb

  // ---------- Validate observaciones
  function do_ajax_form_casos_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_casos_mob_validate_observaciones_cb);
  } // do_ajax_form_casos_mob_validate_observaciones

  function do_ajax_form_casos_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_observaciones_cb

  // ---------- Validate asignado_tercero
  function do_ajax_form_casos_mob_validate_asignado_tercero()
  {
    var nomeCampo_asignado_tercero = "asignado_tercero";
    var var_asignado_tercero = scAjaxGetFieldSelect(nomeCampo_asignado_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_asignado_tercero(var_asignado_tercero, var_script_case_init, do_ajax_form_casos_mob_validate_asignado_tercero_cb);
  } // do_ajax_form_casos_mob_validate_asignado_tercero

  function do_ajax_form_casos_mob_validate_asignado_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_asignado_tercero_cb

  // ---------- Validate valor
  function do_ajax_form_casos_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldHidden(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_casos_mob_validate_valor_cb);
  } // do_ajax_form_casos_mob_validate_valor

  function do_ajax_form_casos_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_valor_cb

  // ---------- Validate fecha_asignacion
  function do_ajax_form_casos_mob_validate_fecha_asignacion()
  {
    var nomeCampo_fecha_asignacion = "fecha_asignacion";
    var var_fecha_asignacion = scAjaxGetFieldText(nomeCampo_fecha_asignacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_fecha_asignacion(var_fecha_asignacion, var_script_case_init, do_ajax_form_casos_mob_validate_fecha_asignacion_cb);
  } // do_ajax_form_casos_mob_validate_fecha_asignacion

  function do_ajax_form_casos_mob_validate_fecha_asignacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_fecha_asignacion_cb

  // ---------- Validate hora_asignacion
  function do_ajax_form_casos_mob_validate_hora_asignacion()
  {
    var nomeCampo_hora_asignacion = "hora_asignacion";
    var var_hora_asignacion = scAjaxGetFieldText(nomeCampo_hora_asignacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_hora_asignacion(var_hora_asignacion, var_script_case_init, do_ajax_form_casos_mob_validate_hora_asignacion_cb);
  } // do_ajax_form_casos_mob_validate_hora_asignacion

  function do_ajax_form_casos_mob_validate_hora_asignacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_hora_asignacion_cb

  // ---------- Validate fecha_cierre
  function do_ajax_form_casos_mob_validate_fecha_cierre()
  {
    var nomeCampo_fecha_cierre = "fecha_cierre";
    var var_fecha_cierre = scAjaxGetFieldText(nomeCampo_fecha_cierre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_fecha_cierre(var_fecha_cierre, var_script_case_init, do_ajax_form_casos_mob_validate_fecha_cierre_cb);
  } // do_ajax_form_casos_mob_validate_fecha_cierre

  function do_ajax_form_casos_mob_validate_fecha_cierre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_fecha_cierre_cb

  // ---------- Validate hora_cierre
  function do_ajax_form_casos_mob_validate_hora_cierre()
  {
    var nomeCampo_hora_cierre = "hora_cierre";
    var var_hora_cierre = scAjaxGetFieldText(nomeCampo_hora_cierre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_hora_cierre(var_hora_cierre, var_script_case_init, do_ajax_form_casos_mob_validate_hora_cierre_cb);
  } // do_ajax_form_casos_mob_validate_hora_cierre

  function do_ajax_form_casos_mob_validate_hora_cierre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_hora_cierre_cb

  // ---------- Validate factura
  function do_ajax_form_casos_mob_validate_factura()
  {
  } // do_ajax_form_casos_mob_validate_factura

  function do_ajax_form_casos_mob_validate_factura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factura";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_factura_cb

  // ---------- Validate fac_num
  function do_ajax_form_casos_mob_validate_fac_num()
  {
    var nomeCampo_fac_num = "fac_num";
    var var_fac_num = scAjaxGetFieldHidden(nomeCampo_fac_num);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_fac_num(var_fac_num, var_script_case_init, do_ajax_form_casos_mob_validate_fac_num_cb);
  } // do_ajax_form_casos_mob_validate_fac_num

  function do_ajax_form_casos_mob_validate_fac_num_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_num";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_fac_num_cb

  // ---------- Validate detalle
  function do_ajax_form_casos_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_casos_mob_validate_detalle_cb);
  } // do_ajax_form_casos_mob_validate_detalle

  function do_ajax_form_casos_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_detalle_cb

  // ---------- Validate id_caso
  function do_ajax_form_casos_mob_validate_id_caso()
  {
    var nomeCampo_id_caso = "id_caso";
    var var_id_caso = scAjaxGetFieldHidden(nomeCampo_id_caso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_mob_validate_id_caso(var_id_caso, var_script_case_init, do_ajax_form_casos_mob_validate_id_caso_cb);
  } // do_ajax_form_casos_mob_validate_id_caso

  function do_ajax_form_casos_mob_validate_id_caso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_caso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_mob_validate_id_caso_cb

  // ---------- Event onchange codigo_cliente
  function do_ajax_form_casos_mob_event_codigo_cliente_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_casos_mob_event_codigo_cliente_onchange(var_codigo_cliente, var_cedula_tercero, var_tercero_nom, var_script_case_init, do_ajax_form_casos_mob_event_codigo_cliente_onchange_cb);
  } // do_ajax_form_casos_mob_event_codigo_cliente_onchange

  function do_ajax_form_casos_mob_event_codigo_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_mob_event_codigo_cliente_onchange_cb_after_alert);
  } // do_ajax_form_casos_mob_event_codigo_cliente_onchange_cb
  function do_ajax_form_casos_mob_event_codigo_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_mob_event_codigo_cliente_onchange_cb_after_alert

  // ---------- Event onchange estado
  function do_ajax_form_casos_mob_event_estado_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_mob_event_estado_onchange(var_estado, var_color1, var_fecha_cierre, var_hora_cierre, var_script_case_init, do_ajax_form_casos_mob_event_estado_onchange_cb);
  } // do_ajax_form_casos_mob_event_estado_onchange

  function do_ajax_form_casos_mob_event_estado_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_mob_event_estado_onchange_cb_after_alert);
  } // do_ajax_form_casos_mob_event_estado_onchange_cb
  function do_ajax_form_casos_mob_event_estado_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_casos_mob_event_estado_onchange_cb_after_alert

  // ---------- Event onchange prioridad
  function do_ajax_form_casos_mob_event_prioridad_onchange()
  {
    var var_prioridad = scAjaxGetFieldSelect("prioridad");
    var var_color2 = scAjaxGetFieldHidden("color2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_mob_event_prioridad_onchange(var_prioridad, var_color2, var_script_case_init, do_ajax_form_casos_mob_event_prioridad_onchange_cb);
  } // do_ajax_form_casos_mob_event_prioridad_onchange

  function do_ajax_form_casos_mob_event_prioridad_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prioridad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_mob_event_prioridad_onchange_cb_after_alert);
  } // do_ajax_form_casos_mob_event_prioridad_onchange_cb
  function do_ajax_form_casos_mob_event_prioridad_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_casos_mob_event_prioridad_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_casos_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_casos_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_casos_mob_submit_form(var_numero, var_fecha, var_hora, var_codigo_cliente, var_cedula_tercero, var_tercero_nom, var_notificado, var_estado, var_color1, var_prioridad, var_color2, var_tipo_caso, var_medio, var_observaciones, var_asignado_tercero, var_valor, var_fecha_asignacion, var_hora_asignacion, var_fecha_cierre, var_hora_cierre, var_factura, var_fac_num, var_id_caso, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_casos_mob_submit_form_cb);
  } // do_ajax_form_casos_mob_submit_form

  function do_ajax_form_casos_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_casos_mob_submit_form_cb_after_alert);
  } // do_ajax_form_casos_mob_submit_form_cb
  function do_ajax_form_casos_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_casos_novedades"] = "off";

  function do_ajax_form_casos_mob_navigate_form()
  {
    perform_ajax_form_casos_mob_navigate_form();
  }

  function perform_ajax_form_casos_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_casos_mob_navigate_form(var_id_caso, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casos_mob_navigate_form_cb);
  } // do_ajax_form_casos_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_casos_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_casos_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_casos_mob_navigate_form_cb
  function do_ajax_form_casos_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_casos_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_casos_mob_navigate_form_cb_after_alert
  function sc_hide_form_casos_mob_form()
  {
