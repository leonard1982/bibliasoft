  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_casos" == sTestField)
        {
...
?>
  ...
  // ---------- Validate numero
  function do_ajax_form_casos_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldHidden(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_numero(var_numero, var_script_case_init, do_ajax_form_casos_validate_numero_cb);
  } // do_ajax_form_casos_validate_numero

  function do_ajax_form_casos_validate_numero_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_numero_cb

  // ---------- Validate fecha
  function do_ajax_form_casos_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_casos_validate_fecha_cb);
  } // do_ajax_form_casos_validate_fecha

  function do_ajax_form_casos_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_fecha_cb

  // ---------- Validate hora
  function do_ajax_form_casos_validate_hora()
  {
    var nomeCampo_hora = "hora";
    var var_hora = scAjaxGetFieldText(nomeCampo_hora);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_hora(var_hora, var_script_case_init, do_ajax_form_casos_validate_hora_cb);
  } // do_ajax_form_casos_validate_hora

  function do_ajax_form_casos_validate_hora_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_hora_cb

  // ---------- Validate codigo_cliente
  function do_ajax_form_casos_validate_codigo_cliente()
  {
    var nomeCampo_codigo_cliente = "codigo_cliente";
    var var_codigo_cliente = scAjaxGetFieldText(nomeCampo_codigo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_codigo_cliente(var_codigo_cliente, var_script_case_init, do_ajax_form_casos_validate_codigo_cliente_cb);
  } // do_ajax_form_casos_validate_codigo_cliente

  function do_ajax_form_casos_validate_codigo_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo_cliente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_codigo_cliente_cb

  // ---------- Validate cedula_tercero
  function do_ajax_form_casos_validate_cedula_tercero()
  {
    var nomeCampo_cedula_tercero = "cedula_tercero";
    var var_cedula_tercero = scAjaxGetFieldText(nomeCampo_cedula_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_cedula_tercero(var_cedula_tercero, var_script_case_init, do_ajax_form_casos_validate_cedula_tercero_cb);
  } // do_ajax_form_casos_validate_cedula_tercero

  function do_ajax_form_casos_validate_cedula_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cedula_tercero";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_cedula_tercero_cb

  // ---------- Validate tercero_nom
  function do_ajax_form_casos_validate_tercero_nom()
  {
    var nomeCampo_tercero_nom = "tercero_nom";
    var var_tercero_nom = scAjaxGetFieldText(nomeCampo_tercero_nom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_tercero_nom(var_tercero_nom, var_script_case_init, do_ajax_form_casos_validate_tercero_nom_cb);
  } // do_ajax_form_casos_validate_tercero_nom

  function do_ajax_form_casos_validate_tercero_nom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tercero_nom";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_tercero_nom_cb

  // ---------- Validate notificado
  function do_ajax_form_casos_validate_notificado()
  {
    var nomeCampo_notificado = "notificado";
    var var_notificado = scAjaxGetFieldText(nomeCampo_notificado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_notificado(var_notificado, var_script_case_init, do_ajax_form_casos_validate_notificado_cb);
  } // do_ajax_form_casos_validate_notificado

  function do_ajax_form_casos_validate_notificado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notificado";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_notificado_cb

  // ---------- Validate estado
  function do_ajax_form_casos_validate_estado()
  {
    var nomeCampo_estado = "estado";
    var var_estado = scAjaxGetFieldSelect(nomeCampo_estado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_estado(var_estado, var_script_case_init, do_ajax_form_casos_validate_estado_cb);
  } // do_ajax_form_casos_validate_estado

  function do_ajax_form_casos_validate_estado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_estado_cb

  // ---------- Validate color1
  function do_ajax_form_casos_validate_color1()
  {
    var nomeCampo_color1 = "color1";
    var var_color1 = scAjaxGetFieldHidden(nomeCampo_color1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_color1(var_color1, var_script_case_init, do_ajax_form_casos_validate_color1_cb);
  } // do_ajax_form_casos_validate_color1

  function do_ajax_form_casos_validate_color1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_color1_cb

  // ---------- Validate prioridad
  function do_ajax_form_casos_validate_prioridad()
  {
    var nomeCampo_prioridad = "prioridad";
    var var_prioridad = scAjaxGetFieldSelect(nomeCampo_prioridad);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_prioridad(var_prioridad, var_script_case_init, do_ajax_form_casos_validate_prioridad_cb);
  } // do_ajax_form_casos_validate_prioridad

  function do_ajax_form_casos_validate_prioridad_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prioridad";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_prioridad_cb

  // ---------- Validate color2
  function do_ajax_form_casos_validate_color2()
  {
    var nomeCampo_color2 = "color2";
    var var_color2 = scAjaxGetFieldHidden(nomeCampo_color2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_color2(var_color2, var_script_case_init, do_ajax_form_casos_validate_color2_cb);
  } // do_ajax_form_casos_validate_color2

  function do_ajax_form_casos_validate_color2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "color2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_color2_cb

  // ---------- Validate tipo_caso
  function do_ajax_form_casos_validate_tipo_caso()
  {
    var nomeCampo_tipo_caso = "tipo_caso";
    var var_tipo_caso = scAjaxGetFieldSelect(nomeCampo_tipo_caso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_tipo_caso(var_tipo_caso, var_script_case_init, do_ajax_form_casos_validate_tipo_caso_cb);
  } // do_ajax_form_casos_validate_tipo_caso

  function do_ajax_form_casos_validate_tipo_caso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_caso";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_tipo_caso_cb

  // ---------- Validate medio
  function do_ajax_form_casos_validate_medio()
  {
    var nomeCampo_medio = "medio";
    var var_medio = scAjaxGetFieldSelect(nomeCampo_medio);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_medio(var_medio, var_script_case_init, do_ajax_form_casos_validate_medio_cb);
  } // do_ajax_form_casos_validate_medio

  function do_ajax_form_casos_validate_medio_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "medio";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_medio_cb

  // ---------- Validate observaciones
  function do_ajax_form_casos_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_form_casos_validate_observaciones_cb);
  } // do_ajax_form_casos_validate_observaciones

  function do_ajax_form_casos_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_observaciones_cb

  // ---------- Validate asignado_tercero
  function do_ajax_form_casos_validate_asignado_tercero()
  {
    var nomeCampo_asignado_tercero = "asignado_tercero";
    var var_asignado_tercero = scAjaxGetFieldSelect(nomeCampo_asignado_tercero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_asignado_tercero(var_asignado_tercero, var_script_case_init, do_ajax_form_casos_validate_asignado_tercero_cb);
  } // do_ajax_form_casos_validate_asignado_tercero

  function do_ajax_form_casos_validate_asignado_tercero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "asignado_tercero";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_asignado_tercero_cb

  // ---------- Validate valor
  function do_ajax_form_casos_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldHidden(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_valor(var_valor, var_script_case_init, do_ajax_form_casos_validate_valor_cb);
  } // do_ajax_form_casos_validate_valor

  function do_ajax_form_casos_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_valor_cb

  // ---------- Validate fecha_asignacion
  function do_ajax_form_casos_validate_fecha_asignacion()
  {
    var nomeCampo_fecha_asignacion = "fecha_asignacion";
    var var_fecha_asignacion = scAjaxGetFieldText(nomeCampo_fecha_asignacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_fecha_asignacion(var_fecha_asignacion, var_script_case_init, do_ajax_form_casos_validate_fecha_asignacion_cb);
  } // do_ajax_form_casos_validate_fecha_asignacion

  function do_ajax_form_casos_validate_fecha_asignacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha_asignacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_fecha_asignacion_cb

  // ---------- Validate hora_asignacion
  function do_ajax_form_casos_validate_hora_asignacion()
  {
    var nomeCampo_hora_asignacion = "hora_asignacion";
    var var_hora_asignacion = scAjaxGetFieldText(nomeCampo_hora_asignacion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_hora_asignacion(var_hora_asignacion, var_script_case_init, do_ajax_form_casos_validate_hora_asignacion_cb);
  } // do_ajax_form_casos_validate_hora_asignacion

  function do_ajax_form_casos_validate_hora_asignacion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora_asignacion";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_hora_asignacion_cb

  // ---------- Validate fecha_cierre
  function do_ajax_form_casos_validate_fecha_cierre()
  {
    var nomeCampo_fecha_cierre = "fecha_cierre";
    var var_fecha_cierre = scAjaxGetFieldText(nomeCampo_fecha_cierre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_fecha_cierre(var_fecha_cierre, var_script_case_init, do_ajax_form_casos_validate_fecha_cierre_cb);
  } // do_ajax_form_casos_validate_fecha_cierre

  function do_ajax_form_casos_validate_fecha_cierre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_fecha_cierre_cb

  // ---------- Validate hora_cierre
  function do_ajax_form_casos_validate_hora_cierre()
  {
    var nomeCampo_hora_cierre = "hora_cierre";
    var var_hora_cierre = scAjaxGetFieldText(nomeCampo_hora_cierre);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_hora_cierre(var_hora_cierre, var_script_case_init, do_ajax_form_casos_validate_hora_cierre_cb);
  } // do_ajax_form_casos_validate_hora_cierre

  function do_ajax_form_casos_validate_hora_cierre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "hora_cierre";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_hora_cierre_cb

  // ---------- Validate factura
  function do_ajax_form_casos_validate_factura()
  {
  } // do_ajax_form_casos_validate_factura

  function do_ajax_form_casos_validate_factura_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "factura";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_factura_cb

  // ---------- Validate fac_num
  function do_ajax_form_casos_validate_fac_num()
  {
    var nomeCampo_fac_num = "fac_num";
    var var_fac_num = scAjaxGetFieldHidden(nomeCampo_fac_num);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_fac_num(var_fac_num, var_script_case_init, do_ajax_form_casos_validate_fac_num_cb);
  } // do_ajax_form_casos_validate_fac_num

  function do_ajax_form_casos_validate_fac_num_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fac_num";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_fac_num_cb

  // ---------- Validate detalle
  function do_ajax_form_casos_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_casos_validate_detalle_cb);
  } // do_ajax_form_casos_validate_detalle

  function do_ajax_form_casos_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_detalle_cb

  // ---------- Validate id_caso
  function do_ajax_form_casos_validate_id_caso()
  {
    var nomeCampo_id_caso = "id_caso";
    var var_id_caso = scAjaxGetFieldHidden(nomeCampo_id_caso);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_casos_validate_id_caso(var_id_caso, var_script_case_init, do_ajax_form_casos_validate_id_caso_cb);
  } // do_ajax_form_casos_validate_id_caso

  function do_ajax_form_casos_validate_id_caso_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_caso";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_casos_validate_id_caso_cb

  // ---------- Event onchange codigo_cliente
  function do_ajax_form_casos_event_codigo_cliente_onchange()
  {
    var var_codigo_cliente = scAjaxGetFieldText("codigo_cliente");
    var var_cedula_tercero = scAjaxGetFieldText("cedula_tercero");
    var var_tercero_nom = scAjaxGetFieldText("tercero_nom");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_event_codigo_cliente_onchange(var_codigo_cliente, var_cedula_tercero, var_tercero_nom, var_script_case_init, do_ajax_form_casos_event_codigo_cliente_onchange_cb);
  } // do_ajax_form_casos_event_codigo_cliente_onchange

  function do_ajax_form_casos_event_codigo_cliente_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "codigo_cliente";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_event_codigo_cliente_onchange_cb_after_alert);
  } // do_ajax_form_casos_event_codigo_cliente_onchange_cb
  function do_ajax_form_casos_event_codigo_cliente_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_event_codigo_cliente_onchange_cb_after_alert

  // ---------- Event onchange estado
  function do_ajax_form_casos_event_estado_onchange()
  {
    var var_estado = scAjaxGetFieldSelect("estado");
    var var_color1 = scAjaxGetFieldHidden("color1");
    var var_fecha_cierre = scAjaxGetFieldText("fecha_cierre");
    var var_hora_cierre = scAjaxGetFieldText("hora_cierre");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_event_estado_onchange(var_estado, var_color1, var_fecha_cierre, var_hora_cierre, var_script_case_init, do_ajax_form_casos_event_estado_onchange_cb);
  } // do_ajax_form_casos_event_estado_onchange

  function do_ajax_form_casos_event_estado_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "estado";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_event_estado_onchange_cb_after_alert);
  } // do_ajax_form_casos_event_estado_onchange_cb
  function do_ajax_form_casos_event_estado_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_casos_event_estado_onchange_cb_after_alert

  // ---------- Event onchange prioridad
  function do_ajax_form_casos_event_prioridad_onchange()
  {
    var var_prioridad = scAjaxGetFieldSelect("prioridad");
    var var_color2 = scAjaxGetFieldHidden("color2");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_casos_event_prioridad_onchange(var_prioridad, var_color2, var_script_case_init, do_ajax_form_casos_event_prioridad_onchange_cb);
  } // do_ajax_form_casos_event_prioridad_onchange

  function do_ajax_form_casos_event_prioridad_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "prioridad";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_casos_event_prioridad_onchange_cb_after_alert);
  } // do_ajax_form_casos_event_prioridad_onchange_cb
  function do_ajax_form_casos_event_prioridad_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_casos_event_prioridad_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_casos_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_casos_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_numero = scAjaxGetFieldHidden("numero");
    var var_fecha = scAjaxGetFieldText("fecha");
    var var_hora = scAjaxGetFieldText("hora");
    var var_codigo_cliente = scAjaxGetFieldText("codigo_cliente");
    var var_cedula_tercero = scAjaxGetFieldText("cedula_tercero");
    var var_tercero_nom = scAjaxGetFieldText("tercero_nom");
    var var_notificado = scAjaxGetFieldText("notificado");
    var var_estado = scAjaxGetFieldSelect("estado");
    var var_color1 = scAjaxGetFieldHidden("color1");
    var var_prioridad = scAjaxGetFieldSelect("prioridad");
    var var_color2 = scAjaxGetFieldHidden("color2");
    var var_tipo_caso = scAjaxGetFieldSelect("tipo_caso");
    var var_medio = scAjaxGetFieldSelect("medio");
    var var_observaciones = scAjaxGetFieldText("observaciones");
    var var_asignado_tercero = scAjaxGetFieldSelect("asignado_tercero");
    var var_valor = scAjaxGetFieldHidden("valor");
    var var_fecha_asignacion = scAjaxGetFieldText("fecha_asignacion");
    var var_hora_asignacion = scAjaxGetFieldText("hora_asignacion");
    var var_fecha_cierre = scAjaxGetFieldText("fecha_cierre");
    var var_hora_cierre = scAjaxGetFieldText("hora_cierre");
    var var_factura = scAjaxGetFieldHidden("factura");
    var var_fac_num = scAjaxGetFieldHidden("fac_num");
    var var_id_caso = scAjaxGetFieldHidden("id_caso");
    ...
    scAjaxProcOn();
    x_ajax_form_casos_submit_form(var_numero, var_fecha, var_hora, var_codigo_cliente, var_cedula_tercero, var_tercero_nom, var_notificado, var_estado, var_color1, var_prioridad, var_color2, var_tipo_caso, var_medio, var_observaciones, var_asignado_tercero, var_valor, var_fecha_asignacion, var_hora_asignacion, var_fecha_cierre, var_hora_cierre, var_factura, var_fac_num, var_id_caso, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_casos_submit_form_cb);
  } // do_ajax_form_casos_submit_form

  function do_ajax_form_casos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("codigo_cliente");
      scAjaxHideErrorDisplay("cedula_tercero");
      scAjaxHideErrorDisplay("tercero_nom");
      scAjaxHideErrorDisplay("notificado");
      scAjaxHideErrorDisplay("estado");
      scAjaxHideErrorDisplay("color1");
      scAjaxHideErrorDisplay("prioridad");
      scAjaxHideErrorDisplay("color2");
      scAjaxHideErrorDisplay("tipo_caso");
      scAjaxHideErrorDisplay("medio");
      scAjaxHideErrorDisplay("observaciones");
      scAjaxHideErrorDisplay("asignado_tercero");
      scAjaxHideErrorDisplay("valor");
      scAjaxHideErrorDisplay("fecha_asignacion");
      scAjaxHideErrorDisplay("hora_asignacion");
      scAjaxHideErrorDisplay("fecha_cierre");
      scAjaxHideErrorDisplay("hora_cierre");
      scAjaxHideErrorDisplay("factura");
      scAjaxHideErrorDisplay("fac_num");
      scAjaxHideErrorDisplay("detalle");
      scAjaxHideErrorDisplay("id_caso");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_casos_submit_form_cb_after_alert);
  } // do_ajax_form_casos_submit_form_cb
  function do_ajax_form_casos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_casos_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_casos_novedades"] = "off";

  function do_ajax_form_casos_navigate_form()
  {
    perform_ajax_form_casos_navigate_form();
  }

  function perform_ajax_form_casos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("detalle");
    scAjaxHideErrorDisplay("id_caso");
    var var_id_caso = document.F2.id_caso.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_casos_novedades"] = "on";
    x_ajax_form_casos_navigate_form(var_id_caso, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_casos_navigate_form_cb);
  } // do_ajax_form_casos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_casos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_casos_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_caso.value = scAjaxGetKeyValue("id_caso");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_casos_novedades"] && "nmsc_iframe_liga_grid_casos_novedades" != scMasterDetailIframe["nmsc_iframe_liga_grid_casos_novedades"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_casos_novedades"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_casos_novedades').contentWindow.nm_move('apl_detalhe', true, '400');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_casos_navigate_form_cb_after_alert);
  } // do_ajax_form_casos_navigate_form_cb
  function do_ajax_form_casos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_casos_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_casos_navigate_form_cb_after_alert
  function sc_hide_form_casos_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_casos_novedades"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "numero";
  ajax_field_list[1] = "fecha";
  ajax_field_list[2] = "hora";
  ajax_field_list[3] = "codigo_cliente";
  ajax_field_list[4] = "cedula_tercero";
  ajax_field_list[5] = "tercero_nom";
  ajax_field_list[6] = "notificado";
  ajax_field_list[7] = "estado";
  ajax_field_list[8] = "color1";
  ajax_field_list[9] = "prioridad";
  ajax_field_list[10] = "color2";
  ajax_field_list[11] = "tipo_caso";
  ajax_field_list[12] = "medio";
  ajax_field_list[13] = "observaciones";
  ajax_field_list[14] = "asignado_tercero";
  ajax_field_list[15] = "valor";
  ajax_field_list[16] = "fecha_asignacion";
  ajax_field_list[17] = "hora_asignacion";
  ajax_field_list[18] = "fecha_cierre";
  ajax_field_list[19] = "hora_cierre";
  ajax_field_list[20] = "factura";
  ajax_field_list[21] = "fac_num";
  ajax_field_list[22] = "detalle";
  ajax_field_list[23] = "id_caso";
  ...
  var ajax_error_list = {
    ...
    "codigo_cliente": {"label": "No. Contrato", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cedula_tercero": {"label": "Usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tercero_nom": {"label": "Nombre usuario", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "notificado": {"label": "Notificado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "estado": {"label": "Estado", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "color1": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "prioridad": {"label": "Prioridad", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "color2": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_caso": {"label": "Tipo Caso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "asignado_tercero": {"label": "Asignado a", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valor": {"label": "Valor", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_asignacion": {"label": "Fecha Asignacion", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hora_asignacion": {"label": "Hora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fecha_cierre": {"label": "Fecha Cierre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "hora_cierre": {"label": "Hora", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "factura": {"label": "Factura", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "fac_num": {"label": "Facturado con:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detalle": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "id_caso": {"label": "Id Caso", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "fecha": new Array(),
    "hora": new Array(),
    "codigo_cliente": new Array(),
    "cedula_tercero": new Array(),
    "tercero_nom": new Array(),
    "notificado": new Array(),
    "estado": new Array(),
    "color1": new Array(),
    "prioridad": new Array(),
    "color2": new Array(),
    ...
    "asignado_tercero": new Array(),
    "valor": new Array(),
    "fecha_asignacion": new Array(),
    "hora_asignacion": new Array(),
    "fecha_cierre": new Array(),
    "hora_cierre": new Array(),
    "factura": new Array(),
    "fac_num": new Array(),
    "detalle": new Array(),
    "id_caso": new Array()
  ...
  ajax_field_mult["codigo_cliente"][1] = "codigo_cliente";
  ajax_field_mult["cedula_tercero"][1] = "cedula_tercero";
  ajax_field_mult["tercero_nom"][1] = "tercero_nom";
  ajax_field_mult["notificado"][1] = "notificado";
  ajax_field_mult["estado"][1] = "estado";
  ajax_field_mult["color1"][1] = "color1";
  ajax_field_mult["prioridad"][1] = "prioridad";
  ajax_field_mult["color2"][1] = "color2";
  ajax_field_mult["tipo_caso"][1] = "tipo_caso";
  ajax_field_mult["medio"][1] = "medio";
  ajax_field_mult["observaciones"][1] = "observaciones";
  ajax_field_mult["asignado_tercero"][1] = "asignado_tercero";
  ajax_field_mult["valor"][1] = "valor";
  ajax_field_mult["fecha_asignacion"][1] = "fecha_asignacion";
  ajax_field_mult["hora_asignacion"][1] = "hora_asignacion";
  ajax_field_mult["fecha_cierre"][1] = "fecha_cierre";
  ajax_field_mult["hora_cierre"][1] = "hora_cierre";
  ajax_field_mult["factura"][1] = "factura";
  ajax_field_mult["fac_num"][1] = "fac_num";
  ajax_field_mult["detalle"][1] = "detalle";
  ajax_field_mult["id_caso"][1] = "id_caso";
  ...
  var ajax_field_id = {
    ...
    "codigo_cliente": new Array("hidden_field_label_codigo_cliente", "hidden_field_data_codigo_cliente"),
    "cedula_tercero": new Array("hidden_field_label_cedula_tercero", "hidden_field_data_cedula_tercero"),
    "tercero_nom": new Array("hidden_field_label_tercero_nom", "hidden_field_data_tercero_nom"),
    "estado": new Array("hidden_field_label_estado", "hidden_field_data_estado"),
    "color1": new Array("hidden_field_label_color1", "hidden_field_data_color1"),
    "prioridad": new Array("hidden_field_label_prioridad", "hidden_field_data_prioridad"),
    "color2": new Array("hidden_field_label_color2", "hidden_field_data_color2"),
    "tipo_caso": new Array("hidden_field_label_tipo_caso", "hidden_field_data_tipo_caso"),
    ...
    "asignado_tercero": new Array("hidden_field_label_asignado_tercero", "hidden_field_data_asignado_tercero"),
    "valor": new Array("hidden_field_label_valor", "hidden_field_data_valor"),
    "fecha_asignacion": new Array("hidden_field_label_fecha_asignacion", "hidden_field_data_fecha_asignacion"),
    "hora_asignacion": new Array("hidden_field_label_hora_asignacion", "hidden_field_data_hora_asignacion"),
    "fecha_cierre": new Array("hidden_field_label_fecha_cierre", "hidden_field_data_fecha_cierre"),
    "hora_cierre": new Array("hidden_field_label_hora_cierre", "hidden_field_data_hora_cierre"),
    "fac_num": new Array("hidden_field_label_fac_num", "hidden_field_data_fac_num"),
  ...
  var ajax_read_only = {
    ...
    "medio": "off",
    "observaciones": "off",
    "asignado_tercero": "off",
    "valor": "off",
    "fecha_asignacion": "off",
    "hora_asignacion": "off",
    "fecha_cierre": "off",
    "hora_cierre": "off",
    "factura": "off",
