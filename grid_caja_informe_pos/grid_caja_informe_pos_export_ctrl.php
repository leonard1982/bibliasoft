<?php
@session_start() ;
$_SESSION['scriptcase']['grid_caja_informe_pos']['sc_process_barr'] = true;
require_once('../grid_caja_informe_pos/index.php');
unset($_SESSION['scriptcase']['grid_caja_informe_pos']['sc_process_barr']);
$ExportCtrl = new grid_caja_informe_pos_export_control;
$ExportCtrl->Export_barr();

class grid_caja_informe_pos_export_control
{
