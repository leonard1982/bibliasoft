...
class grid_caja_informe_pos_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_caja_informe_pos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_caja_informe_pos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_caja_informe_pos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_caja_informe_pos/grid_caja_informe_pos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_caja_informe_pos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_caja_informe_pos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_caja_informe_pos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_caja_informe_pos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_caja_informe_pos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $banco = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['banco']; 
          $banco_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['banco_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_cond']; 
          $resolucion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['resolucion']; 
          $resolucion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['resolucion_cond']; 
          $correo_receptor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['correo_receptor']; 
          $correo_receptor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['correo_receptor_cond']; 
          $asunto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['asunto']; 
          $asunto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['asunto_cond']; 
          $mensaje = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['mensaje']; 
          $mensaje_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['mensaje_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['NM_operador']; 
      } 
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['psq_check_ret']['banco'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['psq_check_ret']['banco'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD id='SC_fecha_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['fecha'])) ? $this->New_label['fecha'] : "Fecha"; ?> <span class="scFilterRequiredOdd">*</span></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
      ...
      <TD id='SC_resolucion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['resolucion'])) ? $this->New_label['resolucion'] : "Prefijo"; ?> <span class="scFilterRequiredOdd">*</span></TD>
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['psq_check_ret']['resolucion'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['psq_check_ret']['resolucion'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
?>
      ...
      <TD id='SC_correo_receptor_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['correo_receptor'])) ? $this->New_label['correo_receptor'] : "Correo Destino"; ?></TD>
...
?>
<INPUT  type="text" id="SC_correo_receptor" name="correo_receptor" value="<?php echo NM_encode_input($correo_receptor) ?>"  size=60 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_asunto_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['asunto'])) ? $this->New_label['asunto'] : "Asunto"; ?></TD>
...
?>
<INPUT  type="text" id="SC_asunto" name="asunto" value="<?php echo NM_encode_input($asunto) ?>"  size=80 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_mensaje_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['mensaje'])) ? $this->New_label['mensaje'] : "Mensaje"; ?></TD>
...
?>
<INPUT  type="text" id="SC_mensaje" name="mensaje" value="<?php echo NM_encode_input($mensaje) ?>"  size=80 alt="{datatype: 'text', maxLength: 200, allowedChars: '', lettersCase: '', autoTab: false, enterSubmit: true}" class="sc-js-input scFilterObjectEven">
...
<?php
   if (is_file("grid_caja_informe_pos_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['opc_psq'])
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_caja_informe_pos_valida_dia(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_caja_informe_pos_valida_mes(this)});
 }
 function sc_grid_caja_informe_pos_valida_dia(obj)
 {
 ...
 function sc_grid_caja_informe_pos_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_caja_informe_pos";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_caja_informe_pos/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca'];
      }
      $tmp_pos = strpos($banco, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $banco;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['psq_check_ret']['banco'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['psq_check_ret']['resolucion'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['banco'] = $banco; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['banco_cond'] = $banco_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['resolucion'] = $resolucion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['resolucion_cond'] = $resolucion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['correo_receptor'] = $correo_receptor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['correo_receptor_cond'] = $correo_receptor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['asunto'] = $asunto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['asunto_cond'] = $asunto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['mensaje'] = $mensaje; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['mensaje_cond'] = $mensaje_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca'] = $Temp_Busca;
      }
      $banco_LKP = $banco;
      $Tmp_pos = strpos($banco, "##@@");
      if ($Tmp_pos !== false)
...
if (!isset($_SESSION['elprefijo'])) {$_SESSION['elprefijo'] = "";}
if (!isset($this->sc_temp_elprefijo)) {$this->sc_temp_elprefijo = (isset($_SESSION['elprefijo'])) ? $_SESSION['elprefijo'] : "";}
 $this->sc_temp_elprefijo=$resolucion ;
...
$_SESSION['scriptcase']['grid_caja_informe_pos']['contr_erro'] = 'off'; 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca_ant']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca'];
      }
      ...
      if ($fecha_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']['fecha_input_2'] = $val[1];
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['where_pesq_ant'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca_ant'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['campos_busca'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_caja_informe_pos']['cond_pesq'] .= $this->NM_operador;
