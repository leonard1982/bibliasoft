<?php
   ...
   session_start();
    ...
    $exportEmail = new exportEmail_grid_caja_informe_pos(); 
   
class exportEmail_grid_caja_informe_pos
{
    ...
    function exportEmailSend()
    {
        ...
        $return = sc_send_mail_api([
                          ...
                          'settings' =>array (
  'gateway' => 'smtp',
  'smtp_server' => 'mail.solucionesnavarro.com',
  'smtp_port' => '465',
  'smtp_user' => 'facilweb@solucionesnavarro.com',
  'smtp_password' => '..easeing2020',
  'smtp_protocol' => 'SSL',
  'from_email' => 'facilweb@solucionesnavarro.com',
  'from_name' => 'FACILWEB - REPORTE POS',
),
                          'message' => [
...
<HEAD>
 <TITLE><?php echo "Resumen diario POS (Ventas de Contado)"; ?></TITLE>
...
?>
            ...
            function html_export_email_send()
            {
                $.ajax({
                    type: 'POST',
                    url: 'grid_caja_informe_pos_export_email.php',
