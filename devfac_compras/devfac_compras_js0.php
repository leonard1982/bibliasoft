...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="devfac_compras"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
{
  nm_gp_submit('<?php echo $this->Ini->link_blank_devcompras; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "gpidcompra*scin' + var_btn_sc_btn_0_gpidcompra + '*scout"; ?>', '', '_blank', '0', '0', 'blank_devcompras');
}
 NM_tp_critica(1);
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_form']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "R") {
    echo "   sob_iframe += 'parent.';\r\n";
}
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_devfac_compras_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_devfac_compras_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
