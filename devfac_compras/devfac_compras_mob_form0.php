...
<span id="id_read_on_traer_fc" class="sc-ui-readonly-traer_fc css_traer_fc_line" style="<?php echo $sStyleReadLab_traer_fc; ?>"><?php echo $this->form_format_readonly("traer_fc", $this->form_encode_input($this->traer_fc)); ?></span><span id="id_read_off_traer_fc" class="css_read_off_traer_fc<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_traer_fc; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> maxlength=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: true, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   ...
   if (isset($this->Ini->sc_lig_md5["grid_compras_contado"]) && $this->Ini->sc_lig_md5["grid_compras_contado"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutnmgp_parms_ret*scinF1,traer_fc,idfaccom*scoutnm_evt_ret_busca*scinsc_devfac_compras_traer_fc_onchange(this)*scout" . $Sc_iframe_master;
       ...
       $Md5_Lig  = "nmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutnmgp_parms_ret*scinF1,traer_fc,idfaccom*scoutnm_evt_ret_busca*scinsc_devfac_compras_traer_fc_onchange(this)*scout" . $Sc_iframe_master;
   }
?>
