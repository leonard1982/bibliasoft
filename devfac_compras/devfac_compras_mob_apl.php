...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->gidtercero)) 
          {
              $_SESSION['gidtercero'] = $this->gidtercero;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new devfac_compras_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['devfac_compras_mob']['upload_field_info'] = array();
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['sc_modal']))
      {
      ...
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['devfac_compras_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['devfac_compras_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devfac_compras_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devfac_compras_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('devfac_compras_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devfac_compras_mob']['label'] = "DEVOLUCIÓN EN COMPRAS";
      ...
      $_SESSION['scriptcase']['error_icon']['devfac_compras_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['devfac_compras_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_orig'] = " where es_remision='ND'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_pesq'] = " where es_remision='ND'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['devfac_compras_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['devfac_compras_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['insert'];
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("devfac_compras_mob", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'devfac_compras/devfac_compras_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'devfac_compras_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'devfac_compras_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'devfac_compras_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'devfac_compras/devfac_compras_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "devfac_compras_mob_erro.class.php"); 
      }
      $this->Erro      = new devfac_compras_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao']))
         { 
             if ($this->idfaccom != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['Eliminar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['botoes']['Eliminar'];
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['devfac_compras_mob']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['devfac_compras_mob']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select'];
     }
   }
...
//
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(devfac_compras_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', devfac_compras_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['credito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->credito = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['credito'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['fechavenc']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechavenc = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['fechavenc'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['pagada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['pagada'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['id_pedidocom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->id_pedidocom = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['id_pedidocom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['es_remision']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->es_remision = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['es_remision'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['idprov']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['idprov'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['fechacom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechacom = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['fechacom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['numfacom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numfacom = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['numfacom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['formapago']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->formapago = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['formapago'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['asentada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['asentada'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['anulada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->anulada = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']['anulada'];
          } 
          $nm_sc_sv_opcao = $this->nmgp_opcao; 
          $this->nmgp_opcao = "nada"; 
          $this->nm_acessa_banco();
    if ('recarga' == $nm_sc_sv_opcao) {
      $_SESSION['scriptcase']['devfac_compras_mob']['contr_erro'] = 'on';
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "devfac_compras_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="devfac_compras_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="devfac_compras_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="devfac_compras_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->idfaccom) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form']['idfaccom']))
          {
              $varloc_btn_php['idfaccom'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form']['idfaccom'];
          }
          if (!isset($this->total) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form']['total']))
          {
              $varloc_btn_php['total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form']['total'];
          }
          if (!isset($this->num_ndevolucion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form']['num_ndevolucion']))
          {
              $varloc_btn_php['num_ndevolucion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form']['num_ndevolucion'];
          }
      }
      $nm_f_saida = "devfac_compras_mob.php";
...
if ($this->total <>0)
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_devfac_compras_mob';
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_devfac_compras_mob']) || !is_array($this->NM_ajax_info['errList']['geral_devfac_compras_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_devfac_compras_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_devfac_compras_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_num_ndevolucion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->num_ndevolucion, 20, 0, -0, 1.0E+20, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_id_pedidocom(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_pedidocom) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_id_pedidocom']) && !in_array($this->id_pedidocom, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_id_pedidocom']))
               {
                   $hasError = true;
    ...
    function ValidateField_numfacom(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['php_cmp_required']['numfacom']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['php_cmp_required']['numfacom'] == "on")) 
      { 
          if ($this->numfacom == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_idprov(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['php_cmp_required']['idprov']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['php_cmp_required']['idprov'] == "on")) 
      { 
          if ($this->idprov == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_retencion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->retencion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_retencion']) && !in_array($this->retencion, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_retencion']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_reteica(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->reteica) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_reteica']) && !in_array($this->reteica, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_reteica']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_banco(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->banco) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_banco']) && !in_array($this->banco, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_banco']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idfaccom']['keyVal'] = devfac_compras_mob_pack_protect_string($this->nmgp_dados_form['idfaccom']);
              ...
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['total']);
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['total']);
              }
          }
...
$aLookup[] = array(devfac_compras_mob_pack_protect_string('ND') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("N. Dev-")));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_es_remision'][] = 'ND';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['es_remision']['valList'][$i] = devfac_compras_mob_pack_protect_string($v);
          }
...
$aLookup[] = array(devfac_compras_mob_pack_protect_string('0') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_id_pedidocom'][] = '0';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_pedidocom']['valList'][$i] = devfac_compras_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][devfac_compras_mob_pack_protect_string(NM_charset_to_utf8($this->idprov))]) ? $aLookup[0][devfac_compras_mob_pack_protect_string(NM_charset_to_utf8($this->idprov))] : "";
...
$aLookup[] = array(devfac_compras_mob_pack_protect_string('CONTADO') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("CONTADO")));
$aLookup[] = array(devfac_compras_mob_pack_protect_string('CRÉDITO') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("CRÉDITO")));
$aLookup[] = array(devfac_compras_mob_pack_protect_string('DEPÓSITO') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("DEPOSITO")));
$aLookup[] = array(devfac_compras_mob_pack_protect_string('OTRO') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("OTRO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_formapago'][] = 'CONTADO';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_formapago'][] = 'CRÉDITO';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_formapago'][] = 'DEPÓSITO';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_formapago'][] = 'OTRO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['formapago']['valList'][$i] = devfac_compras_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(devfac_compras_mob_pack_protect_string('') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("")));
$aLookup[] = array(devfac_compras_mob_pack_protect_string('DEVUELTA') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("DEVUELTA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_anulada'][] = '';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_anulada'][] = 'DEVUELTA';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['anulada']['valList'][$i] = devfac_compras_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(devfac_compras_mob_pack_protect_string('0') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("NO")));
$aLookup[] = array(devfac_compras_mob_pack_protect_string('1') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_asentada'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_asentada'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['asentada']['valList'][$i] = devfac_compras_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(devfac_compras_mob_pack_protect_string('0.00') => str_replace('<', '&lt;',devfac_compras_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_retencion'][] = '0.00';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (strpos(strtolower($rs->fields[0]), "e")) ? (float)$rs->fields[0] : $rs->fields[0];
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(devfac_compras_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', devfac_compras_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['retencion']['valList'][$i] = devfac_compras_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['Lookup_reteica'][] = '0.00';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['reteica']['valList'][$i] = devfac_compras_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['banco']['valList'][$i] = devfac_compras_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_usuario($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idfaccom)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['devfac_compras_mob']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['devfac_compras_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['parms'] = "idfaccom?#?$this->idfaccom?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      ...
      { 
          ...
          $qt_geral_reg_devfac_compras_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total'] = $qt_geral_reg_devfac_compras_mob;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idfaccom))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_devfac_compras_mob = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] > $qt_geral_reg_devfac_compras_mob)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] = $qt_geral_reg_devfac_compras_mob; 
          }
      } 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total'] + 1; 
      $GLOBALS["NM_ERRO_IBASE"] = 0;  
//---------- 
      if ($this->nmgp_opcao != "novo" && $this->nmgp_opcao != "nada" && $this->nmgp_opcao != "refresh_insert") 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start']) ;  
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['reg_start'] < $qt_geral_reg_devfac_compras_mob;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao']   = '';
          }
      } 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['dados_select'];
                  $this->numfacom = $this->nmgp_dados_select['numfacom'];  
                  $this->formapago = $this->nmgp_dados_select['formapago'];  
                  $this->fechacom = $this->nmgp_dados_select['fechacom'];  
                  $this->fechavenc = $this->nmgp_dados_select['fechavenc'];  
                  $this->idprov = $this->nmgp_dados_select['idprov'];  
                  ...
                  $this->control = $this->nmgp_dados_select['control'];  
                  $this->observaciones = $this->nmgp_dados_select['observaciones'];  
                  $this->saldo = $this->nmgp_dados_select['saldo'];  
                  $this->anulada = $this->nmgp_dados_select['anulada'];  
                  $this->es_remision = $this->nmgp_dados_select['es_remision'];  
                  $this->id_pedidocom = $this->nmgp_dados_select['id_pedidocom'];  
                  $this->retencion = $this->nmgp_dados_select['retencion'];  
                  ...
                  $this->num_ndevolucion = $this->nmgp_dados_select['num_ndevolucion'];  
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("devfac_compras_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter_form'] . " and (es_remision='ND') and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_devfac_compras_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['total'] = $qt_geral_reg_devfac_compras_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          devfac_compras_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "devfac_compras_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "devfac_compras_mob_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras_mob']['retorno_edit'] = "";
   }
