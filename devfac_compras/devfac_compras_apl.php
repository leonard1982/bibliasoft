...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['num_ndevolucion']))
          {
              $this->num_ndevolucion = $this->NM_ajax_info['param']['num_ndevolucion'];
          }
          ...
          if (isset($this->NM_ajax_info['param']['traer_fc']))
          {
              $this->traer_fc = $this->NM_ajax_info['param']['traer_fc'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['devfac_compras']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['devfac_compras']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['devfac_compras']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['devfac_compras']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['devfac_compras']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['devfac_compras']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['devfac_compras']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['devfac_compras']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->gidtercero)) 
          {
              $_SESSION['gidtercero'] = $this->gidtercero;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['devfac_compras']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['devfac_compras']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['devfac_compras']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['devfac_compras']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['devfac_compras']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['devfac_compras']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['devfac_compras']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['devfac_compras']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['devfac_compras']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new devfac_compras_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['devfac_compras']['upload_field_info'] = array();

      $this->Ini->Init_apl_lig = array();
      $this->List_apl_lig = array('blank_devcompras'=>array('type'=>'blank', 'lab'=>'Vista Previa Factura de Compra', 'hint'=>'Vista previa de la Compra', 'img_on'=>'grp__NM__ico__NM__analysis256_24853.png', 'img_off'=>'grp__NM__ico__NM__analysis256_24853.png'));
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_modal']))
      {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['devfac_compras']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['devfac_compras'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devfac_compras']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devfac_compras']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('devfac_compras') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['devfac_compras']['label'] = "DEVOLUCIÓN EN COMPRAS";
      ...
      $this->arr_buttons['sc_btn_0']['hint']             = "Vista previa de la Devolución";
      ...
      $_SESSION['scriptcase']['error_icon']['devfac_compras']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['devfac_compras'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_orig'] = " where es_remision='ND'";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_pesq'] = " where es_remision='ND'";
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['devfac_compras']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['devfac_compras'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['devfac_compras'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("devfac_compras", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'devfac_compras/devfac_compras_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'devfac_compras_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'devfac_compras_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'devfac_compras_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'devfac_compras/devfac_compras_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "devfac_compras_erro.class.php"); 
      }
      $this->Erro      = new devfac_compras_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao']))
         { 
             if ($this->idfaccom != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['devfac_compras']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['Eliminar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['botoes']['Eliminar'];
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['devfac_compras']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['devfac_compras']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      if (isset($this->num_ndevolucion)) { $this->nm_limpa_alfa($this->num_ndevolucion); }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select'];
     }
   }
...
//
      ...
      {
          if ('validate_num_ndevolucion' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'num_ndevolucion');
          }
          ...
          if ('validate_traer_fc' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'traer_fc');
          }
      ...
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6))
      {
          ...
          if ('event_traer_fc_onchange' == $this->NM_ajax_opcao)
          {
              $this->traer_fc_onChange();
          }
          devfac_compras_pack_ajax_response();
          exit;
      }
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_idprov']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_idprov'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_idprov']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_idprov'] = array(); 
    }

   $old_value_num_ndevolucion = $this->num_ndevolucion;
   ...
   $unformatted_value_num_ndevolucion = $this->num_ndevolucion;
   ...
   $this->num_ndevolucion = $old_value_num_ndevolucion;
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(devfac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', devfac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_idprov'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['credito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->credito = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['credito'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['fechavenc']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechavenc = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['fechavenc'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['pagada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['pagada'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['id_pedidocom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->id_pedidocom = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['id_pedidocom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['es_remision']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->es_remision = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['es_remision'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['idprov']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['idprov'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['fechacom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechacom = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['fechacom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['numfacom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numfacom = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['numfacom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['formapago']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->formapago = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['formapago'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['asentada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['asentada'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['anulada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->anulada = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select']['anulada'];
          } 
          $nm_sc_sv_opcao = $this->nmgp_opcao; 
          $this->nmgp_opcao = "nada"; 
          $this->nm_acessa_banco();
    if ('recarga' == $nm_sc_sv_opcao) {
      $_SESSION['scriptcase']['devfac_compras']['contr_erro'] = 'on';
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "devfac_compras.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="devfac_compras_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="devfac_compras"> 
...
<?php
include_once("devfac_compras_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->idfaccom) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form']['idfaccom']))
          {
              $varloc_btn_php['idfaccom'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form']['idfaccom'];
          }
          if (!isset($this->total) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form']['total']))
          {
              $varloc_btn_php['total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form']['total'];
          }
          if (!isset($this->num_ndevolucion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form']['num_ndevolucion']))
          {
              $varloc_btn_php['num_ndevolucion'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form']['num_ndevolucion'];
          }
      }
      $nm_f_saida = "./";
...
if ($this->total <>0)
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_devfac_compras';
...
;
	echo "<script>alertify.alert('Alerta', '¡Nota Tiene Items asociados, por favor elimine datalle primero!', function(){ window.location.href='../grid_compras_dev'; });</script>";
	}
else
	{
	  
      $nm_select = "select iddet from detallecompra where num_ndevolucion=$idfcom"; 
...
;
     ...
     $nm_select ="insert into log set usuario='".$this->sc_temp_gidtercero."',accion='ELIMINAR', observaciones='EL USUARIO ELIMINÓ LA NOTA DE DEV NO: $this->num_ndevolucion .' "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	echo "<script>alertify.alert('Alerta', '¡Nota eliminada con éxito!', function(){ window.location.href='../grid_compras_dev'; });</script>";
	goto salir;
	}
err:;
echo "<script>alertify.alert('Alerta', '¡Nota Tiene Items asociados, por favor elimine datalle primero!', function(){ window.location.href='../grid_compras_dev'; });</script>";
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_devfac_compras']) || !is_array($this->NM_ajax_info['errList']['geral_devfac_compras']))
              {
                  $this->NM_ajax_info['errList']['geral_devfac_compras'] = array();
              }
              $this->NM_ajax_info['errList']['geral_devfac_compras'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ((!is_array($filtro) && ('' == $filtro || 'num_ndevolucion' == $filtro)) || (is_array($filtro) && in_array('num_ndevolucion', $filtro)))
        $this->ValidateField_num_ndevolucion($Campos_Crit, $Campos_Falta, $Campos_Erros);
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'traer_fc' == $filtro)) || (is_array($filtro) && in_array('traer_fc', $filtro)))
        $this->ValidateField_traer_fc($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
//---
    ...
    function ValidateField_num_ndevolucion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->num_ndevolucion != '')  
          { 
              $iTestSize = 20;
              if (strlen($this->num_ndevolucion) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "N° NOTA DEV.:: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['num_ndevolucion']))
                  {
                      $Campos_Erros['num_ndevolucion'] = array();
                  }
                  $Campos_Erros['num_ndevolucion'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['num_ndevolucion']) || !is_array($this->NM_ajax_info['errList']['num_ndevolucion']))
                  {
                      $this->NM_ajax_info['errList']['num_ndevolucion'] = array();
                  }
                  $this->NM_ajax_info['errList']['num_ndevolucion'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->num_ndevolucion, 20, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "N° NOTA DEV.:; " ; 
                  if (!isset($Campos_Erros['num_ndevolucion']))
                  {
                      $Campos_Erros['num_ndevolucion'] = array();
                  }
                  $Campos_Erros['num_ndevolucion'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['num_ndevolucion']) || !is_array($this->NM_ajax_info['errList']['num_ndevolucion']))
                  {
                      $this->NM_ajax_info['errList']['num_ndevolucion'] = array();
                  }
                  $this->NM_ajax_info['errList']['num_ndevolucion'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'num_ndevolucion';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_num_ndevolucion
    ...
    function ValidateField_id_pedidocom(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_pedidocom) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_id_pedidocom']) && !in_array($this->id_pedidocom, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_id_pedidocom']))
               {
                   $hasError = true;
    ...
    function ValidateField_traer_fc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (NM_utf8_strlen($this->traer_fc) > 20) 
          { 
              $hasError = true;
              $Campos_Crit .= "NÚMERO DE LA COMPRA: " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['traer_fc']))
              {
                  $Campos_Erros['traer_fc'] = array();
              }
              $Campos_Erros['traer_fc'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
              if (!isset($this->NM_ajax_info['errList']['traer_fc']) || !is_array($this->NM_ajax_info['errList']['traer_fc']))
              {
                  $this->NM_ajax_info['errList']['traer_fc'] = array();
              }
              $this->NM_ajax_info['errList']['traer_fc'][] = $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr'];
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
    ...
    function ValidateField_numfacom(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['php_cmp_required']['numfacom']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['php_cmp_required']['numfacom'] == "on")) 
      { 
          if ($this->numfacom == "")  
          { 
              $hasError = true;
              $Campos_Falta[] =  "FACTURA AFECTADA:" ; 
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "FACTURA AFECTADA: " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 20 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
              if (!isset($Campos_Erros['numfacom']))
              {
                  $Campos_Erros['numfacom'] = array();
              }
    ...
    function ValidateField_idprov(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['php_cmp_required']['idprov']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['php_cmp_required']['idprov'] == "on")) 
      { 
          if ($this->idprov == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_fechavenc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "FECHA DE LA COMPRA:; " ; 
    ...
    function ValidateField_pagada(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              $hasError = true;
              $Campos_Crit .= "FACTURA PAGADA?: " . $this->Ini->Nm_lang['lang_errm_mxch'] . " 255 " . $this->Ini->Nm_lang['lang_errm_nchr']; 
    ...
    function ValidateField_saldo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->saldo, 12, 0, 0, 0, "S") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_total(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "TOTAL N. DEV:: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->total, 10, 2, 0, 0, "S") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "TOTAL N. DEV:; " ; 
                  if (!isset($Campos_Erros['total']))
                  {
                      $Campos_Erros['total'] = array();
                  }
    ...
    function ValidateField_subtotal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->subtotal, -1))
              {
                  $iTestSize++;
                  $this->subtotal = '-' . substr($this->subtotal, 0, -1);
              }
              ...
              if ($teste_validade->Valor($this->subtotal, 10, 2, 0, 0, "S") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_valoriva(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->valoriva, -1))
              {
                  $iTestSize++;
                  $this->valoriva = '-' . substr($this->valoriva, 0, -1);
              }
              if (strlen($this->valoriva) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "IVA NOTA DEV.:: " . $this->Ini->Nm_lang['lang_errm_size']; 
              ...
              if ($teste_validade->Valor($this->valoriva, 8, 2, 0, 0, "S") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "IVA NOTA DEV.:; " ; 
                  if (!isset($Campos_Erros['valoriva']))
                  {
                      $Campos_Erros['valoriva'] = array();
                  }
    ...
    function ValidateField_retencion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->retencion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_retencion']) && !in_array($this->retencion, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_retencion']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_reteica(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->reteica) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_reteica']) && !in_array($this->reteica, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_reteica']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_banco(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->banco) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_banco']) && !in_array($this->banco, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_banco']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['traer_fc'] = $this->traer_fc;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_form'] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      if ('' !== $this->num_ndevolucion || (!empty($format_fields) && isset($format_fields['num_ndevolucion'])))
      {
          nmgp_Form_Num_Val($this->num_ndevolucion, $this->field_config['num_ndevolucion']['symbol_grp'], $this->field_config['num_ndevolucion']['symbol_dec'], "0", "S", $this->field_config['num_ndevolucion']['format_neg'], "", "", "-", $this->field_config['num_ndevolucion']['symbol_fmt']) ; 
      }
...
//
   ...
   {
          $this->ajax_return_values_num_ndevolucion();
          $this->ajax_return_values_es_remision();
          $this->ajax_return_values_id_pedidocom();
          $this->ajax_return_values_traer_fc();
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idfaccom']['keyVal'] = devfac_compras_pack_protect_string($this->nmgp_dados_form['idfaccom']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['embutida_pai']        = "devfac_compras";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['embutida_form_parms'] = "par_idfaccom*scin" . $this->nmgp_dados_form['idfaccom'] . "*scoutNMSC_inicial*scininicio*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['grid_detallecompra_devfac_script_case_init'] ]['grid_detallecompra_devfac']['total']);
          }
   } // ajax_return_values

          //----- num_ndevolucion
   function ajax_return_values_num_ndevolucion($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("num_ndevolucion", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->num_ndevolucion);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['num_ndevolucion'] = array(
                       'row'    => '',
               'type'    => 'text',
...
$aLookup[] = array(devfac_compras_pack_protect_string('ND') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("N. Dev-")));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_es_remision'][] = 'ND';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['es_remision']['valList'][$i] = devfac_compras_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_id_pedidocom']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_id_pedidocom'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_id_pedidocom']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_id_pedidocom'] = array(); 
}
$aLookup[] = array(devfac_compras_pack_protect_string('0') => str_replace('<', '&lt;',devfac_compras_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_id_pedidocom'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_id_pedidocom'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_pedidocom']['valList'][$i] = devfac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          //----- traer_fc
   function ajax_return_values_traer_fc($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("traer_fc", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->traer_fc);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['traer_fc'] = array(
                       'row'    => '',
               'type'    => 'text',
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][devfac_compras_pack_protect_string(NM_charset_to_utf8($this->idprov))]) ? $aLookup[0][devfac_compras_pack_protect_string(NM_charset_to_utf8($this->idprov))] : "";
...
$aLookup[] = array(devfac_compras_pack_protect_string('CONTADO') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("CONTADO")));
$aLookup[] = array(devfac_compras_pack_protect_string('CRÉDITO') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("CRÉDITO")));
$aLookup[] = array(devfac_compras_pack_protect_string('DEPÓSITO') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("DEPOSITO")));
$aLookup[] = array(devfac_compras_pack_protect_string('OTRO') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("OTRO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_formapago'][] = 'CONTADO';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_formapago'][] = 'CRÉDITO';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_formapago'][] = 'DEPÓSITO';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_formapago'][] = 'OTRO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['formapago']['valList'][$i] = devfac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(devfac_compras_pack_protect_string('') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("")));
$aLookup[] = array(devfac_compras_pack_protect_string('DEVUELTA') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("DEVUELTA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_anulada'][] = '';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_anulada'][] = 'DEVUELTA';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['anulada']['valList'][$i] = devfac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(devfac_compras_pack_protect_string('0') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("NO")));
$aLookup[] = array(devfac_compras_pack_protect_string('1') => str_replace('<', '&lt;',devfac_compras_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_asentada'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_asentada'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['asentada']['valList'][$i] = devfac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_retencion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_retencion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_retencion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_retencion'] = array(); 
}
$aLookup[] = array(devfac_compras_pack_protect_string('0.00') => str_replace('<', '&lt;',devfac_compras_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_retencion'][] = '0.00';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (strpos(strtolower($rs->fields[0]), "e")) ? (float)$rs->fields[0] : $rs->fields[0];
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(devfac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', devfac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_retencion'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['retencion']['valList'][$i] = devfac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_reteica']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_reteica'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_reteica']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_reteica'] = array(); 
}
$aLookup[] = array(devfac_compras_pack_protect_string('0.00') => str_replace('<', '&lt;',devfac_compras_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_reteica'][] = '0.00';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(devfac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', devfac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_reteica'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['reteica']['valList'][$i] = devfac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_banco']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_banco'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_banco']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_banco'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['Lookup_banco'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['banco']['valList'][$i] = devfac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_usuario($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_traer_fc = $this->traer_fc;
}
...
if($this->asentada ==1)
	{
		...
		$this->NM_ajax_info['buttonDisplay']['new'] = $this->nmgp_botoes["new"] = "on";;
		$this->sc_field_readonly("anulada", 'on');
		$this->sc_field_readonly("observaciones", 'on');
		$this->sc_field_readonly("banco", 'on');
		$this->sc_field_readonly("traer_fc", 'on');
	}
else
	{
		$this->Ini->nm_hidden_blocos[4] = "on"; $this->NM_ajax_info['blockDisplay']['4'] = 'on';
		$this->sc_field_readonly("anulada", 'off');
		$this->sc_field_readonly("observaciones", 'off');
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    if (($original_anulada != $this->anulada || (isset($bFlagRead_anulada) && $bFlagRead_anulada)))
    {
        $this->ajax_return_values_anulada(true);
    }
    ...
    if (($original_traer_fc != $this->traer_fc || (isset($bFlagRead_traer_fc) && $bFlagRead_traer_fc)))
    {
        $this->ajax_return_values_traer_fc(true);
    }
}
$_SESSION['scriptcase']['devfac_compras']['contr_erro'] = 'off'; 
      }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idfaccom)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    $original_num_ndevolucion = $this->num_ndevolucion;
...
$this->usuario =$this->sc_temp_gidtercero;
      ...
      $nm_select = "select num_ndevolucion from facturacom order by num_ndevolucion desc limit 1 "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds_fc = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
...
;
if(isset($this->ds_fc[0][0]))
	{
	$this->num_ndevolucion =$this->ds_fc[0][0]+1;
	}
else
	{
	$this->num_ndevolucion =1;
	}
if (isset($this->sc_temp_gidtercero)) { $_SESSION['gidtercero'] = $this->sc_temp_gidtercero;}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_num_ndevolucion != $this->num_ndevolucion || (isset($bFlagRead_num_ndevolucion) && $bFlagRead_num_ndevolucion)))
    {
        $this->ajax_return_values_num_ndevolucion(true);
    }
...
$_SESSION['scriptcase']['devfac_compras']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['traer_fc'] = $this->traer_fc;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "numfacom = '$this->numfacom', formapago = '$this->formapago', fechacom = #$this->fechacom#, fechavenc = #$this->fechavenc#, idprov = $this->idprov, subtotal = $this->subtotal, valoriva = $this->valoriva, total = $this->total, pagada = '$this->pagada', asentada = $this->asentada, control = $this->control, observaciones = '$this->observaciones', saldo = $this->saldo, anulada = '$this->anulada', es_remision = '$this->es_remision', id_pedidocom = $this->id_pedidocom, retencion = $this->retencion, reteica = $this->reteica, reteiva = $this->reteiva, usuario = $this->usuario, banco = $this->banco, num_ndevolucion = $this->num_ndevolucion"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['num_ndevolucion'])) { $this->num_ndevolucion = $NM_val_form['num_ndevolucion']; }
              elseif (isset($this->num_ndevolucion)) { $this->nm_limpa_alfa($this->num_ndevolucion); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('num_ndevolucion', 'es_remision', 'id_pedidocom', 'traer_fc', 'numfacom', 'fechacom', 'idprov', 'formapago', 'fechavenc', 'pagada', 'saldo', 'anulada', 'total', 'subtotal', 'valoriva', 'asentada', 'retencion', 'reteica', 'reteiva', 'banco', 'idfaccom', 'detalle', 'hdetalle', 'prefijo_delpedido', 'observaciones', 'control', 'usuario'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              { 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (numfacom, formapago, fechacom, fechavenc, idprov, subtotal, valoriva, total, asentada, control, observaciones, saldo, anulada, es_remision, id_pedidocom, retencion, reteica, reteiva, usuario, banco, num_ndevolucion $compl_insert) VALUES ('$this->numfacom', '$this->formapago', #$this->fechacom#, #$this->fechavenc#, $this->idprov, $this->subtotal, $this->valoriva, $this->total, $this->asentada, $this->control, '$this->observaciones', $this->saldo, '$this->anulada', '$this->es_remision', $this->id_pedidocom, $this->retencion, $this->reteica, $this->reteiva, $this->usuario, $this->banco, $this->num_ndevolucion $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $compl_insert     = ""; 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numfacom, formapago, fechacom, fechavenc, idprov, subtotal, valoriva, total, asentada, control, observaciones, saldo, anulada, es_remision, id_pedidocom, retencion, reteica, reteiva, usuario, banco, num_ndevolucion $compl_insert) VALUES (" . $NM_seq_auto . "'$this->numfacom', '$this->formapago', " . $this->Ini->date_delim . $this->fechacom . $this->Ini->date_delim1 . ", " . $this->Ini->date_delim . $this->fechavenc . $this->Ini->date_delim1 . ", $this->idprov, $this->subtotal, $this->valoriva, $this->total, $this->asentada, $this->control, '$this->observaciones', $this->saldo, '$this->anulada', '$this->es_remision', $this->id_pedidocom, $this->retencion, $this->reteica, $this->reteiva, $this->usuario, $this->banco, $this->num_ndevolucion $compl_insert_val)"; 
              }
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "numfacom, formapago, fechacom, fechavenc, idprov, subtotal, valoriva, total, asentada, control, observaciones, saldo, anulada, es_remision, id_pedidocom, retencion, reteica, reteiva, usuario, banco, num_ndevolucion $compl_insert) VALUES (" . $NM_seq_auto . "'$this->numfacom', '$this->formapago', EXTEND('$this->fechacom', YEAR TO DAY), EXTEND('$this->fechavenc', YEAR TO DAY), $this->idprov, $this->subtotal, $this->valoriva, $this->total, $this->asentada, $this->control, '$this->observaciones', $this->saldo, '$this->anulada', '$this->es_remision', $this->id_pedidocom, $this->retencion, $this->reteica, $this->reteiva, $this->usuario, $this->banco, $this->num_ndevolucion $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              {
                  $compl_insert     = ""; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] = 0; 
              }
...
$idcomp=$this->traer_fc ;
$fec=$this->fechacom ;

$para=$this->idfaccom ;
if(isset($this->numfacom ) and !empty($this->numfacom ))
	{
	$id=0;
	$idfc=0;
	$idproducto=0;
	...
	$pordesc=0;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_select = "select * from detallecompra where idfaccom='$idcomp'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select * from detallecompra where idfaccom='$idcomp'"; 
...
;
	if(!empty($this->ds[0][0]) or isset($this->ds[0][0]))
	   { $i=0;
     ...
     $nm_select ="insert detallecompra set idfaccom=$idfc, idpro=$idproducto, idbod=$bod, cantidad=($cantidad*-1), valorunit=$vunit, valorpar=$vparcial*-1, iva=$iva*-1, descuento=$desc*-1, tasaiva=$tiva, tasadesc=$tdes, devuelto=0, colores=$col, tallas=$tal, sabor=$sab, descr='$descrip', porc_desc=$pordesc, num_ndevolucion=$para"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
...
$iddeta=substr($this->da , 5);
	...
	$pordesc=0;
		...
		{
		$this->nm_mens_alert[] = "¡Compra no tiene detalle!"; $this->nm_params_alert[] = array(); if ($this->NM_ajax_flag) { $this->sc_ajax_alert("¡Compra no tiene detalle!"); }}
	}
...
$_SESSION['scriptcase']['devfac_compras']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['parms'] = "idfaccom?#?$this->idfaccom?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter'] . ")";
          }
      }
//------------ 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("es_remision='ND'");
      ...
      { 
          ...
          $qt_geral_reg_devfac_compras = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total'] = $qt_geral_reg_devfac_compras;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idfaccom))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_devfac_compras = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] > $qt_geral_reg_devfac_compras)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] = $qt_geral_reg_devfac_compras; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_devfac_compras) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
          { 
              $nmgp_select = "SELECT idfaccom, numfacom, formapago, str_replace (convert(char(10),fechacom,102), '.', '-') + ' ' + convert(char(8),fechacom,20), str_replace (convert(char(10),fechavenc,102), '.', '-') + ' ' + convert(char(8),fechavenc,20), idprov, subtotal, valoriva, total, pagada, asentada, control, observaciones, saldo, anulada, es_remision, id_pedidocom, retencion, reteica, reteiva, usuario, banco, num_ndevolucion from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $nmgp_select = "SELECT idfaccom, numfacom, formapago, convert(char(23),fechacom,121), convert(char(23),fechavenc,121), idprov, subtotal, valoriva, total, pagada, asentada, control, observaciones, saldo, anulada, es_remision, id_pedidocom, retencion, reteica, reteiva, usuario, banco, num_ndevolucion from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT idfaccom, numfacom, formapago, fechacom, fechavenc, idprov, subtotal, valoriva, total, pagada, asentada, control, observaciones, saldo, anulada, es_remision, id_pedidocom, retencion, reteica, reteiva, usuario, banco, num_ndevolucion from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT idfaccom, numfacom, formapago, EXTEND(fechacom, YEAR TO DAY), EXTEND(fechavenc, YEAR TO DAY), idprov, subtotal, valoriva, total, pagada, asentada, control, observaciones, saldo, anulada, es_remision, id_pedidocom, retencion, reteica, reteiva, usuario, banco, num_ndevolucion from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT idfaccom, numfacom, formapago, fechacom, fechavenc, idprov, subtotal, valoriva, total, pagada, asentada, control, observaciones, saldo, anulada, es_remision, id_pedidocom, retencion, reteica, reteiva, usuario, banco, num_ndevolucion from " . $this->Ini->nm_tabela ; 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] < $qt_geral_reg_devfac_compras;
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao']   = '';
          }
      } 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallecompra_devfac']['embutida_parms'] = "par_idfaccom*scin" . $this->nmgp_dados_form['idfaccom'] . "*scoutNMSC_inicial*scininicio*scout";
  }
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
if($this->idfaccom >0 and $this->total <>0)
	{
	if ($this->asentada ==1)
		{
		$this->sc_field_readonly("anulada", 'on');
      ...
      $nm_select = "select numero from terceros_cuentas ORDER BY idtercero_cuenta DESC LIMIT 1"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->d_ct = array();
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          ...
          { 
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                      $this->d_ct[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      { 
          $this->d_ct = false;
          $this->d_ct_erro = $this->Db->ErrorMsg();
      } 
;
		if(isset($this->d_ct[0][0]))
			{
			$vIdcu=$this->d_ct[0][0]+1;
			}
		else
			{
			$vIdcu=1;
		...
		$vNFac='00/'.$this->numfacom ;
		
     $nm_select ="INSERT terceros_cuentas SET  prefijo='00', numero=$vIdcu, fecha='".$this->fechacom ."', tercero='".$this->idprov ."', ie='EGRESO', tipo='DC', numero_documento='$vNFac', valor_total='".$this->total ."', saldo='".$this->total ."', abonos=0, usuario='".$this->sc_temp_gidtercero."', cod_cuenta='00/$vIdcu', pagada='NO'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="DELETE FROM terceros_cuentas where tipo='DC' and fecha='".$this->fechacom ."' and tercero='".$this->idprov ."' and numero_documento like '%".$this->numfacom ."%' "; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
     ...
     $nm_select ="update facturacom set asentada=0 where idfaccom='".$this->idfaccom ."'"; 
         $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select;
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
         $rf = $this->Db->Execute($nm_select);
         if ($rf === false)
	...
	{
	$this->nm_mens_alert[] = "No tiene Nota registrada, NO puede Asentar"; $this->nm_params_alert[] = array(); if ($this->NM_ajax_flag) { $this->sc_ajax_alert("No tiene Nota registrada, NO puede Asentar"); }$this->asentada =0;
	}
...
$modificado_anulada = $this->anulada;
$modificado_observaciones = $this->observaciones;
$modificado_traer_fc = $this->traer_fc;
$this->nm_formatar_campos('subtotal', 'valoriva', 'idfaccom', 'banco', 'formapago', 'total', 'asentada', 'idprov', 'retencion', 'reteica', 'reteiva', 'fechacom', 'numfacom', 'usuario', 'anulada', 'observaciones', 'traer_fc');
...
if ($original_anulada !== $modificado_anulada || isset($this->nmgp_cmp_readonly['anulada']) || (isset($bFlagRead_anulada) && $bFlagRead_anulada))
{
    $this->ajax_return_values_anulada(true);
}
...
if ($original_traer_fc !== $modificado_traer_fc || isset($this->nmgp_cmp_readonly['traer_fc']) || (isset($bFlagRead_traer_fc) && $bFlagRead_traer_fc))
{
    $this->ajax_return_values_traer_fc(true);
}
...
$this->sc_temp_par_idfaccom=$this->idfaccom ;
 ...
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('detalle_devcompra') . "/", $this->nm_location, $this->sc_temp_par_idfaccom, "_self", "ret_self", 440, 630);
 };
...
$original_reteiva = $this->reteiva;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      { 
          $nm_select = "select numfacom, idprov, str_replace (convert(char(10),fechacom,102), '.', '-') + ' ' + convert(char(8),fechacom,20), pagada, retencion, reteica, reteiva  from facturacom where idfaccom='".$this->traer_fc ."'"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
      { 
          $nm_select = "select numfacom, idprov, convert(char(19),fechacom,121), pagada, retencion, reteica, reteiva  from facturacom where idfaccom='".$this->traer_fc ."'"; 
      }
      else
      { 
          $nm_select = "select numfacom, idprov, fechacom, pagada, retencion, reteica, reteiva  from facturacom where idfaccom='".$this->traer_fc ."'"; 
      }
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $this->ds_com = array();
...
if(isset($this->ds_com[0][0]))
	{
	$this->numfacom 	=$this->ds_com[0][0];
	$this->idprov 	=$this->ds_com[0][1];
	$this->fechavenc 	=$this->ds_com[0][2];
	$this->formapago 	='CONTADO';
	$this->pagada 	='NO';
	$this->retencion 	=$this->ds_com[0][4];
	$this->reteica 	=$this->ds_com[0][5];
	$this->reteiva 	=$this->ds_com[0][6];
	}
else
	{
	$this->sc_ajax_message("COMPRA NO REGISTRADA!", "ADVERTENCIA", "", "");
	}
...
$modificado_reteica = $this->reteica;
$modificado_reteiva = $this->reteiva;
$this->nm_formatar_campos('traer_fc', 'numfacom', 'idprov', 'fechavenc', 'formapago', 'pagada', 'retencion', 'reteica', 'reteiva');
if ($original_traer_fc !== $modificado_traer_fc || isset($this->nmgp_cmp_readonly['traer_fc']) || (isset($bFlagRead_traer_fc) && $bFlagRead_traer_fc))
{
    $this->ajax_return_values_traer_fc(true);
}
...
$this->NM_ajax_info['event_field'] = 'traer';
devfac_compras_pack_ajax_response();
exit;
$_SESSION['scriptcase']['devfac_compras']['contr_erro'] = 'off';
}
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("devfac_compras_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter_form'] . " and (es_remision='ND') and (" . $comando . ")";
      }
      else
      {
          $sc_where = " where es_remision='ND' and (" . $comando . ")";
      }
      $nmgp_select = "SELECT count(*) AS countTest from " . $this->Ini->nm_tabela . $sc_where; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      $rt = $this->Db->Execute($nmgp_select) ; 
      ...
      $qt_geral_reg_devfac_compras = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['total'] = $qt_geral_reg_devfac_compras;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          devfac_compras_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "devfac_compras_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['nm_run_menu'] = 2;
       $nmgp_saida_form = "devfac_compras_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['devfac_compras']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function sc_set_focus($sFieldName)
    {
        ...
        $aFocus = array(
                        'num_ndevolucion' => 'num_ndevolucion',
