...
$old_error_handler = set_error_handler("devfac_compras_mob_scriptcase_error_handler");

function devfac_compras_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['devfac_compras_mob']['contr_erro']) && $_SESSION['scriptcase']['devfac_compras_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            global $inicial_devfac_compras_mob;
            $inicial_devfac_compras_mob->contr_devfac_compras_mob->Apl_com_erro = true;
            if ($inicial_devfac_compras_mob->contr_devfac_compras_mob->NM_ajax_flag)
            {
                $inicial_devfac_compras_mob->contr_devfac_compras_mob->NM_ajax_info['errList']['geral_devfac_compras_mob'][] = $msg;
                return;
            }
            devfac_compras_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function devfac_compras_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['devfac_compras_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['devfac_compras_mob'])  ? $_SESSION['scriptcase']['error_icon']['devfac_compras_mob']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['devfac_compras_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['devfac_compras_mob']) ? $_SESSION['scriptcase']['error_span_title']['devfac_compras_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['devfac_compras_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['devfac_compras_mob']) ? $_SESSION['scriptcase']['error_icon_title']['devfac_compras_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['devfac_compras']['error_buffer'] .= ob_get_flush();
}
