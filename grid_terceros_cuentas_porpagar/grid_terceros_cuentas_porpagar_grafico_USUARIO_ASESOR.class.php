...
<?php
   ...
   function inicializa_vars()
   {
      ...
      //---- Label
      $this->label    = array();
      $this->label[0] = "Usuario";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar']['contr_label_graf']['usuario']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar']['contr_label_graf']['usuario']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas_porpagar']['contr_label_graf']['usuario'];
      }
   }
