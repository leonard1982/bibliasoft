  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_detallenotainv_ajuste" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_detallenotainv_ajuste_form();
	}
...
?>
  ...
  // ---------- Validate idpro_
  function do_ajax_form_detallenotainv_ajuste_validate_idpro_(iNumLinha)
  {
  } // do_ajax_form_detallenotainv_ajuste_validate_idpro_

  function do_ajax_form_detallenotainv_ajuste_validate_idpro__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_idpro__cb

  // ---------- Validate colores_
  function do_ajax_form_detallenotainv_ajuste_validate_colores_(iNumLinha)
  {
    var nomeCampo_colores_ = "colores_" + iNumLinha;
    var var_colores_ = scAjaxGetFieldSelect(nomeCampo_colores_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_colores_(var_colores_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_colores__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_colores_

  function do_ajax_form_detallenotainv_ajuste_validate_colores__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_colores__cb

  // ---------- Validate tallas_
  function do_ajax_form_detallenotainv_ajuste_validate_tallas_(iNumLinha)
  {
    var nomeCampo_tallas_ = "tallas_" + iNumLinha;
    var var_tallas_ = scAjaxGetFieldSelect(nomeCampo_tallas_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_tallas_(var_tallas_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_tallas__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_tallas_

  function do_ajax_form_detallenotainv_ajuste_validate_tallas__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_tallas__cb

  // ---------- Validate sabor_
  function do_ajax_form_detallenotainv_ajuste_validate_sabor_(iNumLinha)
  {
    var nomeCampo_sabor_ = "sabor_" + iNumLinha;
    var var_sabor_ = scAjaxGetFieldSelect(nomeCampo_sabor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_sabor_(var_sabor_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_sabor__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_sabor_

  function do_ajax_form_detallenotainv_ajuste_validate_sabor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_sabor__cb

  // ---------- Validate existencia_
  function do_ajax_form_detallenotainv_ajuste_validate_existencia_(iNumLinha)
  {
    var nomeCampo_existencia_ = "existencia_" + iNumLinha;
    var var_existencia_ = scAjaxGetFieldHidden(nomeCampo_existencia_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_existencia_(var_existencia_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_existencia__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_existencia_

  function do_ajax_form_detallenotainv_ajuste_validate_existencia__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_existencia__cb

  // ---------- Validate cantidad_
  function do_ajax_form_detallenotainv_ajuste_validate_cantidad_(iNumLinha)
  {
    var nomeCampo_cantidad_ = "cantidad_" + iNumLinha;
    var var_cantidad_ = scAjaxGetFieldText(nomeCampo_cantidad_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_cantidad_(var_cantidad_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_cantidad__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_cantidad_

  function do_ajax_form_detallenotainv_ajuste_validate_cantidad__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_cantidad__cb

  // ---------- Validate costo_
  function do_ajax_form_detallenotainv_ajuste_validate_costo_(iNumLinha)
  {
    var nomeCampo_costo_ = "costo_" + iNumLinha;
    var var_costo_ = scAjaxGetFieldText(nomeCampo_costo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_costo_(var_costo_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_costo__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_costo_

  function do_ajax_form_detallenotainv_ajuste_validate_costo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "costo_" + iLineNumber;
    }
    else
    {
      sFieldValid = "costo_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "costo_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "costo_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_costo__cb

  // ---------- Validate valorparcial_
  function do_ajax_form_detallenotainv_ajuste_validate_valorparcial_(iNumLinha)
  {
    var nomeCampo_valorparcial_ = "valorparcial_" + iNumLinha;
    var var_valorparcial_ = scAjaxGetFieldText(nomeCampo_valorparcial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_valorparcial_(var_valorparcial_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_valorparcial__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_valorparcial_

  function do_ajax_form_detallenotainv_ajuste_validate_valorparcial__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valorparcial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valorparcial_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valorparcial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valorparcial_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_valorparcial__cb

  // ---------- Validate tipo_
  function do_ajax_form_detallenotainv_ajuste_validate_tipo_(iNumLinha)
  {
    var nomeCampo_tipo_ = "tipo_" + iNumLinha;
    var var_tipo_ = scAjaxGetFieldText(nomeCampo_tipo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_tipo_(var_tipo_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_tipo__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_tipo_

  function do_ajax_form_detallenotainv_ajuste_validate_tipo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_tipo__cb

  // ---------- Validate idbod_
  function do_ajax_form_detallenotainv_ajuste_validate_idbod_(iNumLinha)
  {
    var nomeCampo_idbod_ = "idbod_" + iNumLinha;
    var var_idbod_ = scAjaxGetFieldText(nomeCampo_idbod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_idbod_(var_idbod_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_idbod__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_idbod_

  function do_ajax_form_detallenotainv_ajuste_validate_idbod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_idbod__cb

  // ---------- Validate fecha_
  function do_ajax_form_detallenotainv_ajuste_validate_fecha_(iNumLinha)
  {
    var nomeCampo_fecha_ = "fecha_" + iNumLinha;
    var var_fecha_ = scAjaxGetFieldText(nomeCampo_fecha_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_fecha_(var_fecha_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_fecha__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_fecha_

  function do_ajax_form_detallenotainv_ajuste_validate_fecha__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_fecha__cb

  // ---------- Validate detalle_
  function do_ajax_form_detallenotainv_ajuste_validate_detalle_(iNumLinha)
  {
    var nomeCampo_detalle_ = "detalle_" + iNumLinha;
    var var_detalle_ = scAjaxGetFieldText(nomeCampo_detalle_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_validate_detalle_(var_detalle_, iNumLinha, var_script_case_init, do_ajax_form_detallenotainv_ajuste_validate_detalle__cb);
  } // do_ajax_form_detallenotainv_ajuste_validate_detalle_

  function do_ajax_form_detallenotainv_ajuste_validate_detalle__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_validate_detalle__cb

  // ---------- Refresh idpro_
  function do_ajax_form_detallenotainv_ajuste_refresh_idpro_(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_detallenotainv_ajuste_refresh_idpro_(var_idpro_, var_nmgp_refresh_row, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_detallenotainv_ajuste_refresh_idpro__cb);
  } // do_ajax_form_detallenotainv_ajuste_refresh_idpro_

  function do_ajax_form_detallenotainv_ajuste_refresh_idpro__cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_detallenotainv_ajuste_refresh_idpro__cb

  // ---------- Event onchange cantidad_
  function do_ajax_form_detallenotainv_ajuste_event_cantidad__onchange(iSeqForm)
  {
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_existencia_ = scAjaxGetFieldHidden("existencia_" + iSeqForm);
    var var_costo_ = scAjaxGetFieldText("costo_" + iSeqForm);
    var var_valorparcial_ = scAjaxGetFieldText("valorparcial_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotainv_ajuste_event_cantidad__onchange(var_cantidad_, var_existencia_, var_costo_, var_valorparcial_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotainv_ajuste_event_cantidad__onchange_cb);
  } // do_ajax_form_detallenotainv_ajuste_event_cantidad__onchange

  function do_ajax_form_detallenotainv_ajuste_event_cantidad__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_event_cantidad__onchange_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_event_cantidad__onchange_cb
  function do_ajax_form_detallenotainv_ajuste_event_cantidad__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotainv_ajuste_event_cantidad__onchange_cb_after_alert

  // ---------- Event onfocus cantidad_
  function do_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("idpro_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_costo_ = scAjaxGetFieldText("costo_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn();
    x_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus(var_idpro_, var_cantidad_, var_costo_, var_valorparcial_, var_colores_, var_existencia_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus_cb);
  } // do_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus

  function do_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus_cb
  function do_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotainv_ajuste_event_cantidad__onfocus_cb_after_alert

  // ---------- Event onchange colores_
  function do_ajax_form_detallenotainv_ajuste_event_colores__onchange(iSeqForm)
  {
    var var_colores_ = scAjaxGetFieldSelect("colores_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotainv_ajuste_event_colores__onchange(var_colores_, var_idpro_, var_existencia_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotainv_ajuste_event_colores__onchange_cb);
  } // do_ajax_form_detallenotainv_ajuste_event_colores__onchange

  function do_ajax_form_detallenotainv_ajuste_event_colores__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_event_colores__onchange_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_event_colores__onchange_cb
  function do_ajax_form_detallenotainv_ajuste_event_colores__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotainv_ajuste_event_colores__onchange_cb_after_alert

  // ---------- Event onchange costo_
  function do_ajax_form_detallenotainv_ajuste_event_costo__onchange(iSeqForm)
  {
    var var_costo_ = scAjaxGetFieldText("costo_" + iSeqForm);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iSeqForm);
    var var_valorparcial_ = scAjaxGetFieldText("valorparcial_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotainv_ajuste_event_costo__onchange(var_costo_, var_cantidad_, var_valorparcial_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotainv_ajuste_event_costo__onchange_cb);
  } // do_ajax_form_detallenotainv_ajuste_event_costo__onchange

  function do_ajax_form_detallenotainv_ajuste_event_costo__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_event_costo__onchange_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_event_costo__onchange_cb
  function do_ajax_form_detallenotainv_ajuste_event_costo__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotainv_ajuste_event_costo__onchange_cb_after_alert

  // ---------- Event onchange idpro_
  function do_ajax_form_detallenotainv_ajuste_event_idpro__onchange(iSeqForm)
  {
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_colores_ = scAjaxGetFieldSelect("colores_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotainv_ajuste_event_idpro__onchange(var_idpro_, var_colores_, var_tallas_, var_sabor_, var_costo_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotainv_ajuste_event_idpro__onchange_cb);
  } // do_ajax_form_detallenotainv_ajuste_event_idpro__onchange

  function do_ajax_form_detallenotainv_ajuste_event_idpro__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_event_idpro__onchange_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_event_idpro__onchange_cb
  function do_ajax_form_detallenotainv_ajuste_event_idpro__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_detallenotainv_ajuste_refresh_idpro_(iLineNumber);
    scAjaxRedir();
  } // do_ajax_form_detallenotainv_ajuste_event_idpro__onchange_cb_after_alert

  // ---------- Event onchange sabor_
  function do_ajax_form_detallenotainv_ajuste_event_sabor__onchange(iSeqForm)
  {
    var var_sabor_ = scAjaxGetFieldSelect("sabor_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_colores_ = scAjaxGetFieldSelect("colores_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotainv_ajuste_event_sabor__onchange(var_sabor_, var_idpro_, var_colores_, var_existencia_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotainv_ajuste_event_sabor__onchange_cb);
  } // do_ajax_form_detallenotainv_ajuste_event_sabor__onchange

  function do_ajax_form_detallenotainv_ajuste_event_sabor__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_event_sabor__onchange_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_event_sabor__onchange_cb
  function do_ajax_form_detallenotainv_ajuste_event_sabor__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotainv_ajuste_event_sabor__onchange_cb_after_alert

  // ---------- Event onchange tallas_
  function do_ajax_form_detallenotainv_ajuste_event_tallas__onchange(iSeqForm)
  {
    var var_tallas_ = scAjaxGetFieldSelect("tallas_" + iSeqForm);
    var var_idpro_ = scAjaxGetFieldText("id_ac_idpro_" + iSeqForm);
    var var_colores_ = scAjaxGetFieldSelect("colores_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_detallenotainv_ajuste_event_tallas__onchange(var_tallas_, var_idpro_, var_colores_, var_existencia_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_detallenotainv_ajuste_event_tallas__onchange_cb);
  } // do_ajax_form_detallenotainv_ajuste_event_tallas__onchange

  function do_ajax_form_detallenotainv_ajuste_event_tallas__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_event_tallas__onchange_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_event_tallas__onchange_cb
  function do_ajax_form_detallenotainv_ajuste_event_tallas__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_detallenotainv_ajuste_event_tallas__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_detallenotainv_ajuste_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_detallenotainv_ajuste_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_detallenotainv_ajuste_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_detallenotainv_ajuste_add_new_line_cb);
  } // do_ajax_form_detallenotainv_ajuste_add_new_line

  function do_ajax_form_detallenotainv_ajuste_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_detallenotainv_ajuste_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_detallenotainv_ajuste_backup_line(iNumLinha)
  {
    var var_idinv_ = scAjaxGetFieldText("idinv_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_detallenotainv_ajuste_backup_line(var_idinv_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_detallenotainv_ajuste_backup_line_cb);
  } // do_ajax_form_detallenotainv_ajuste_backup_line

  function do_ajax_form_detallenotainv_ajuste_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_detallenotainv_ajuste_backup_line_cb

  function do_ajax_form_detallenotainv_ajuste_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_detallenotainv_ajuste_cancel_insert

  function do_ajax_form_detallenotainv_ajuste_cancel_update(iSeqVert)
  {
    do_ajax_form_detallenotainv_ajuste_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_detallenotainv_ajuste_cancel_update

  function do_ajax_form_detallenotainv_ajuste_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_detallenotainv_ajuste_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_detallenotainv_ajuste_table_refresh()
  {
    var var_idinv_ = document.F2.idinv_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallenotainv_ajuste_table_refresh(var_idinv_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallenotainv_ajuste_table_refresh_cb);
  } //  do_ajax_form_detallenotainv_ajuste_table_refresh

  function do_ajax_form_detallenotainv_ajuste_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idinv_.value = scAjaxGetKeyValue("idinv_");
    ...
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_table_refresh_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_table_refresh_cb
  function do_ajax_form_detallenotainv_ajuste_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_detallenotainv_ajuste_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_detallenotainv_ajuste_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_detallenotainv_ajuste_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_existencia_ = scAjaxGetFieldHidden("existencia_" + iNumLinha);
    var var_cantidad_ = scAjaxGetFieldText("cantidad_" + iNumLinha);
    var var_costo_ = scAjaxGetFieldText("costo_" + iNumLinha);
    var var_valorparcial_ = scAjaxGetFieldText("valorparcial_" + iNumLinha);
    var var_tipo_ = scAjaxGetFieldText("tipo_" + iNumLinha);
    var var_idbod_ = scAjaxGetFieldText("idbod_" + iNumLinha);
    var var_fecha_ = scAjaxGetFieldText("fecha_" + iNumLinha);
    var var_detalle_ = scAjaxGetFieldText("detalle_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_detallenotainv_ajuste_submit_form(var_idpro_, var_colores_, var_tallas_, var_sabor_, var_existencia_, var_cantidad_, var_costo_, var_valorparcial_, var_tipo_, var_idbod_, var_fecha_, var_detalle_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_detallenotainv_ajuste_submit_form_cb);
  } // do_ajax_form_detallenotainv_ajuste_submit_form

  function do_ajax_form_detallenotainv_ajuste_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("costo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valorparcial_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_submit_form_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_submit_form_cb
  function do_ajax_form_detallenotainv_ajuste_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_detallenotainv_ajuste_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_detallenotainv_ajuste_navigate_form()
  {
    perform_ajax_form_detallenotainv_ajuste_navigate_form();
  }

  function perform_ajax_form_detallenotainv_ajuste_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("costo_" + iNavForm);
      scAjaxHideErrorDisplay("valorparcial_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_detallenotainv_ajuste_navigate_form(var_idinv_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_detallenotainv_ajuste_navigate_form_cb);
  } // do_ajax_form_detallenotainv_ajuste_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_detallenotainv_ajuste']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_detallenotainv_ajuste_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idinv_.value = scAjaxGetKeyValue("idinv_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_detallenotainv_ajuste_navigate_form_cb_after_alert);
  } // do_ajax_form_detallenotainv_ajuste_navigate_form_cb
  function do_ajax_form_detallenotainv_ajuste_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
?>
  ...
  } // do_ajax_form_detallenotainv_ajuste_navigate_form_cb_after_alert
  function sc_hide_form_detallenotainv_ajuste_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "costo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valorparcial_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["existencia_" + iNumLinha] = {"label": "Existencia<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["cantidad_" + iNumLinha] = {"label": "Cantidad Conteo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["costo_" + iNumLinha] = {"label": "Costo<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valorparcial_" + iNumLinha] = {"label": "Valorparcial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["tipo_" + iNumLinha] = {"label": "Movimiento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["detalle_" + iNumLinha] = {"label": "Detalle<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["costo_"][iNumLinha] = "costo_" + iNumLinha;
    ajax_field_mult["valorparcial_"][iNumLinha] = "valorparcial_" + iNumLinha;
    ...
    ajax_error_count["costo_" + iNumLinha] = "off";
    ajax_error_count["valorparcial_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["costo_" + iNumLinha] = "off";
    ajax_read_only["valorparcial_" + iNumLinha] = "off";
...
?>
    ...
    ajax_read_only["costo_" + iNumLinha] = "on";
    ajax_read_only["valorparcial_" + iNumLinha] = "on";
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["costo_" + iNumLinha] = null;
    ajax_error_list["valorparcial_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["costo_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["costo_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["costo_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["costo_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["costo_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["valorparcial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valorparcial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valorparcial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valorparcial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valorparcial_" + iNumLinha]["onfocus"] = new Array();
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['costo_'])) ? $this->nmgp_cmp_readonly['costo_'] : 'off';
?>
    scAjaxFieldRead("costo_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valorparcial_'])) ? $this->nmgp_cmp_readonly['valorparcial_'] : 'off';
?>
    scAjaxFieldRead("valorparcial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("costo_" + iSeq, "on");
    scAjaxFieldRead("valorparcial_" + iSeq, "on");
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idpro_" + iRow] || "on" == ajax_error_count["colores_" + iRow] || "on" == ajax_error_count["tallas_" + iRow] || "on" == ajax_error_count["sabor_" + iRow] || "on" == ajax_error_count["existencia_" + iRow] || "on" == ajax_error_count["cantidad_" + iRow] || "on" == ajax_error_count["costo_" + iRow] || "on" == ajax_error_count["valorparcial_" + iRow] || "on" == ajax_error_count["tipo_" + iRow] || "on" == ajax_error_count["idbod_" + iRow] || "on" == ajax_error_count["fecha_" + iRow] || "on" == ajax_error_count["detalle_" + iRow]))
    {
      ...
      $("#hidden_field_data_costo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valorparcial_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_detalle_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idpro_" + iRow] && "off" == ajax_error_count["colores_" + iRow] && "off" == ajax_error_count["tallas_" + iRow] && "off" == ajax_error_count["sabor_" + iRow] && "off" == ajax_error_count["existencia_" + iRow] && "off" == ajax_error_count["cantidad_" + iRow] && "off" == ajax_error_count["costo_" + iRow] && "off" == ajax_error_count["valorparcial_" + iRow] && "off" == ajax_error_count["tipo_" + iRow] && "off" == ajax_error_count["idbod_" + iRow] && "off" == ajax_error_count["fecha_" + iRow] && "off" == ajax_error_count["detalle_" + iRow]))
    {
      if (bErrorRow)
      {
        ...
        ajax_error_count["costo_" + iRow] = "off";
        ajax_error_count["valorparcial_" + iRow] = "off";
      ...
      $("#hidden_field_data_costo_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valorparcial_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_detalle_" + iRow).removeClass("scFormErrorLine");
    }
  }
