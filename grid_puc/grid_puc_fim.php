...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_puc"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_puc"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_puc'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_puc']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_puc']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_puc']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_puc']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_puc']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_puc']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_puc']['embutida_filho'] as $ind => $sc_init)
          {
