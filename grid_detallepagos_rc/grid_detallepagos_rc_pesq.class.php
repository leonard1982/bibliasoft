...
class grid_detallepagos_rc_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detallepagos_rc_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detallepagos_rc_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detallepagos_rc_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_iddetall($iddetall)
   {
      ...
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and   CAST (iddetall AS TEXT)  like '%" . $iddetall . "%' order by iddetall"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and   CAST (iddetall AS VARCHAR)  like '%" . $iddetall . "%' order by iddetall"; 
      }
      else
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and  iddetall like '%" . $iddetall . "%' order by iddetall"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_idfact($idfact)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and   CAST (idfact AS TEXT)  like '%" . $idfact . "%' order by idfact"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and   CAST (idfact AS VARCHAR)  like '%" . $idfact . "%' order by idfact"; 
      }
      else
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and  idfact like '%" . $idfact . "%' order by idfact"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_idrc($idrc)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and   CAST (idrc AS TEXT)  like '%" . $idrc . "%' order by idrc"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and   CAST (idrc AS VARCHAR)  like '%" . $idrc . "%' order by idrc"; 
      }
      else
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and  idrc like '%" . $idrc . "%' order by idrc"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_idfp($idfp)
   {
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and   CAST (idfp AS TEXT)  like '%" . $idfp . "%' order by idfp"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and   CAST (idfp AS VARCHAR)  like '%" . $idfp . "%' order by idfp"; 
      }
      else
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and  idfp like '%" . $idfp . "%' order by idfp"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detallepagos_rc/grid_detallepagos_rc_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detallepagos_rc_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detallepagos_rc_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detallepagos_rc_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallepagos_rc']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detallepagos_rc']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $iddetall = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['iddetall']; 
          $iddetall_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['iddetall_input_2']; 
          $iddetall_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['iddetall_cond']; 
          $idfact = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfact']; 
          $idfact_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfact_input_2']; 
          $idfact_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfact_cond']; 
          $idrc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idrc']; 
          $idrc_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idrc_input_2']; 
          $idrc_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idrc_cond']; 
          $idfp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfp']; 
          $idfp_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfp_input_2']; 
          $idfp_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfp_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['NM_operador']; 
      } 
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and iddetall = $iddetall_look order by iddetall"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct iddetall from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and iddetall = $iddetall_look order by iddetall"; 
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and idfact = $idfact_look order by idfact"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idfact from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and idfact = $idfact_look order by idfact"; 
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and idrc = $idrc_look order by idrc"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idrc from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and idrc = $idrc_look order by idrc"; 
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and idfp = $idfp_look order by idfp"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idfp from " . $this->Ini->nm_tabela . " where idrc=" . $_SESSION['par_idrc'] . " and idfp = $idfp_look order by idfp"; 
...
?>
<?php
   if (is_file("grid_detallepagos_rc_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos_rc']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detallepagos_rc']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['orig_pesq'] == "grid")
   {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_detallepagos_rc";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function trata_campos()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['iddetall'] = $iddetall; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['iddetall_input_2'] = $iddetall_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['iddetall_cond'] = $iddetall_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfact'] = $idfact; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfact_input_2'] = $idfact_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfact_cond'] = $idfact_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idrc'] = $idrc; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idrc_input_2'] = $idrc_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idrc_cond'] = $idrc_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfp'] = $idfp; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfp_input_2'] = $idfp_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['idfp_cond'] = $idfp_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca'] = $Temp_Busca;
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detallepagos_rc']['cond_pesq'] .= $this->NM_operador;
