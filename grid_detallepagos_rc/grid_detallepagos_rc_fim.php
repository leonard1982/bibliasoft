...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallepagos_rc"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detallepagos_rc"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallepagos_rc']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detallepagos_rc']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detallepagos_rc']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detallepagos_rc']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detallepagos_rc']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_detallepagos_rc</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detallepagos_rc']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detallepagos_rc']['embutida_filho'] as $ind => $sc_init)
          {
