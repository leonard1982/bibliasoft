<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detallepagos_rc']['sc_process_barr'] = true;
require_once('../grid_detallepagos_rc/index.php');
unset($_SESSION['scriptcase']['grid_detallepagos_rc']['sc_process_barr']);
$ExportCtrl = new grid_detallepagos_rc_export_control;
$ExportCtrl->Export_barr();

class grid_detallepagos_rc_export_control
{
