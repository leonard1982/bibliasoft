<?php
@session_start() ;
$_SESSION['scriptcase']['pdfreport_comp_ajuste']['sc_process_barr'] = true;
require_once('../pdfreport_comp_ajuste/index.php');
unset($_SESSION['scriptcase']['pdfreport_comp_ajuste']['sc_process_barr']);
$ExportCtrl = new pdfreport_comp_ajuste_export_control;
$ExportCtrl->Export_barr();

class pdfreport_comp_ajuste_export_control
{
