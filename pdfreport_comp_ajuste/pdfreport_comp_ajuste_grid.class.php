<?php
class pdfreport_comp_ajuste_grid
{
   var $Ini;
   var $Erro;
   var $Pdf;
...
//
   ...
   $_SESSION['scriptcase']['pdfreport_comp_ajuste']['default_font'] = $this->default_font;
   ...
   if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
   {
       ...
       {
           if (in_array("pdfreport_comp_ajuste", $apls_aba))
           {
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
   {
       $this->aba_iframe = true;
   }
...
$_SESSION['scriptcase']['pdfreport_comp_ajuste']['contr_erro'] = 'off'; 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['qt_col_grid'] = 1 ;  
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_comp_ajuste']['cols']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_comp_ajuste']['cols']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['qt_col_grid'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_comp_ajuste']['cols'];  
       unset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_comp_ajuste']['cols']);
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_select']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_select'] = array(); 
   } 
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_quebra']))  
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_grid'] = "" ; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_ant']  = ""; 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_desc'] = "" ; 
   }   
   if (!empty($nmgp_parms) && $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['opcao'] != "pdf")   
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['opcao'] = "igual";
       $rec = "ini";
   }
   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['where_orig']) || $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['prim_cons'] || !empty($nmgp_parms))  
   { 
   ...
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['where_pesq_filtro'];
//
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['tot_geral'][1])) 
   { 
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['sc_total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['tot_geral'][1] ;  
   }
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['where_pesq'];  
//----- 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_grid']) 
        {
   ...
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_grid'])) 
   { 
       $nmgp_order_by = " order by " . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['ordem_desc']; 
   } 
   if (!empty($campos_order_select)) 
   { 
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['order_grid'] = $nmgp_order_by;
...
// 
 function Pdf_image()
 {
   ...
   $this->Pdf->Image($this->NM_raiz_img . $this->Ini->path_img_global . "/usr__NM__bg__NM__Nota Inventario.png", "1", "1", "137", "100", '', '', '', false, 300, '', false, false, 0);
...
//----- 
 function grid($linhas = 0)
 {
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['idmov'] = "Idmov";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['idtipotran'] = "Idtipotran";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['fecha'] = "Fecha";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['idpro'] = "Idpro";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['cantidad'] = "Cantidad";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['idbodorig'] = "Idbodorig";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['idboddes'] = "Idboddes";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['observaciones'] = "Observaciones";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['colores'] = "Colores";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['tallas'] = "Tallas";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['sabor'] = "Sabor";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['numeronota'] = "Numeronota";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['prefijonota'] = "Prefijonota";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['empresa'] = "empresa";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['ladireccion'] = "ladireccion";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['numnit'] = "numnit";
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['labels']['numtele'] = "numtele";
   $HTTP_REFERER = (isset($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : ""; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['seq_dir'] = 0; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['sub_dir'] = array(); 
   $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['where_orig'];
   $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['where_pesq'];
   $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['where_pesq_filtro'];
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['pdfreport_comp_ajuste']['lig_edit']) && $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_comp_ajuste']['lig_edit'] != '')
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['mostra_edit'] = $_SESSION['scriptcase']['sc_apl_conf']['pdfreport_comp_ajuste']['lig_edit'];
   }
...
// 
   ...
   {  
      ...
      $this->Pdf_init();
      $this->Pdf_image();
      while (!$this->rs_grid->EOF && $nm_quant_linhas < $_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['qt_col_grid']) 
      {  
          ...
          { 
              $this->idmov[$this->nm_grid_colunas] = str_replace($_SESSION['sc_session'][$this->Ini->sc_page]['pdfreport_comp_ajuste']['decimal_db'], "", $this->idmov[$this->nm_grid_colunas]); 
          ...
          $this->idboddes[$this->nm_grid_colunas] = sc_strip_script($this->idboddes[$this->nm_grid_colunas]);
          if ($this->idboddes[$this->nm_grid_colunas] === "") 
          { 
              $this->idboddes[$this->nm_grid_colunas] = "" ;  
          } 
          else    
          { 
              nmgp_Form_Num_Val($this->idboddes[$this->nm_grid_colunas], $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          ...
          $this->numtele[$this->nm_grid_colunas] = $this->SC_conv_utf8($this->numtele[$this->nm_grid_colunas]);
            ...
            $cell_idpro = array('posx' => 32, 'posy' => 43, 'data' => $this->idpro[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 11, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_idbodorig = array('posx' => 85, 'posy' => 54, 'data' => $this->idbodorig[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 10, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_observaciones = array('posx' => 10, 'posy' => 73, 'data' => $this->observaciones[$this->nm_grid_colunas], 'width'      => 170, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_empresa = array('posx' => 10, 'posy' => 10, 'data' => $this->SC_conv_utf8('' . $_SESSION['pdfreport_comp_ajuste']['empresa_nombre'] . ''), 'width'      => 100, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_numnit = array('posx' => 10, 'posy' => 13, 'data' => $this->SC_conv_utf8('' . $_SESSION['pdfreport_comp_ajuste']['nit'] . ''), 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_ladireccion = array('posx' => 10, 'posy' => 16, 'data' => $this->SC_conv_utf8('' . $_SESSION['pdfreport_comp_ajuste']['direccion'] . ''), 'width'      => 100, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_numtele = array('posx' => 10, 'posy' => 19, 'data' => $this->SC_conv_utf8('' . $_SESSION['pdfreport_comp_ajuste']['telefono'] . ''), 'width'      => 100, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 8, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_color = array('posx' => 32, 'posy' => 49, 'data' => $this->colores[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 10, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            ...
            $cell_prefijo = array('posx' => 105, 'posy' => 3, 'data' => $this->prefijonota[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 14, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
            $cell_numeronota = array('posx' => 120, 'posy' => 3, 'data' => $this->numeronota[$this->nm_grid_colunas], 'width'      => 0, 'align'      => 'L', 'font_type'  => $this->default_font, 'font_size'  => 14, 'color_r'    => '0', 'color_g'    => '0', 'color_b'    => '0', 'font_style' => $this->default_style);
