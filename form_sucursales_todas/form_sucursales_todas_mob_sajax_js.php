...
?>
  ...
  function perform_ajax_form_sucursales_todas_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_sucursales_todas_mob_navigate_form(var_id_sucursal, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sucursales_todas_mob_navigate_form_cb);
