  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sucursales_todas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sucursales_todas_mob_form();
	}
...
?>
  ...
  // ---------- Validate id_sucursal
  function do_ajax_form_sucursales_todas_mob_validate_id_sucursal()
  {
    var nomeCampo_id_sucursal = "id_sucursal";
    var var_id_sucursal = scAjaxGetFieldHidden(nomeCampo_id_sucursal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_mob_validate_id_sucursal(var_id_sucursal, var_script_case_init, do_ajax_form_sucursales_todas_mob_validate_id_sucursal_cb);
  } // do_ajax_form_sucursales_todas_mob_validate_id_sucursal

  function do_ajax_form_sucursales_todas_mob_validate_id_sucursal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id_sucursal";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_mob_validate_id_sucursal_cb

  // ---------- Validate codigo_suc
  function do_ajax_form_sucursales_todas_mob_validate_codigo_suc()
  {
    var nomeCampo_codigo_suc = "codigo_suc";
    var var_codigo_suc = scAjaxGetFieldText(nomeCampo_codigo_suc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_mob_validate_codigo_suc(var_codigo_suc, var_script_case_init, do_ajax_form_sucursales_todas_mob_validate_codigo_suc_cb);
  } // do_ajax_form_sucursales_todas_mob_validate_codigo_suc

  function do_ajax_form_sucursales_todas_mob_validate_codigo_suc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo_suc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_mob_validate_codigo_suc_cb

  // ---------- Validate observacion_suc
  function do_ajax_form_sucursales_todas_mob_validate_observacion_suc()
  {
    var nomeCampo_observacion_suc = "observacion_suc";
    var var_observacion_suc = scAjaxGetFieldText(nomeCampo_observacion_suc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_mob_validate_observacion_suc(var_observacion_suc, var_script_case_init, do_ajax_form_sucursales_todas_mob_validate_observacion_suc_cb);
  } // do_ajax_form_sucursales_todas_mob_validate_observacion_suc

  function do_ajax_form_sucursales_todas_mob_validate_observacion_suc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "observacion_suc";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_mob_validate_observacion_suc_cb

  // ---------- Validate ip
  function do_ajax_form_sucursales_todas_mob_validate_ip()
  {
    var nomeCampo_ip = "ip";
    var var_ip = scAjaxGetFieldText(nomeCampo_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_mob_validate_ip(var_ip, var_script_case_init, do_ajax_form_sucursales_todas_mob_validate_ip_cb);
  } // do_ajax_form_sucursales_todas_mob_validate_ip

  function do_ajax_form_sucursales_todas_mob_validate_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_mob_validate_ip_cb

  // ---------- Validate puerto
  function do_ajax_form_sucursales_todas_mob_validate_puerto()
  {
    var nomeCampo_puerto = "puerto";
    var var_puerto = scAjaxGetFieldText(nomeCampo_puerto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_mob_validate_puerto(var_puerto, var_script_case_init, do_ajax_form_sucursales_todas_mob_validate_puerto_cb);
  } // do_ajax_form_sucursales_todas_mob_validate_puerto

  function do_ajax_form_sucursales_todas_mob_validate_puerto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puerto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_mob_validate_puerto_cb

  // ---------- Validate nombre_empresa
  function do_ajax_form_sucursales_todas_mob_validate_nombre_empresa()
  {
    var nomeCampo_nombre_empresa = "nombre_empresa";
    var var_nombre_empresa = scAjaxGetFieldText(nomeCampo_nombre_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_mob_validate_nombre_empresa(var_nombre_empresa, var_script_case_init, do_ajax_form_sucursales_todas_mob_validate_nombre_empresa_cb);
  } // do_ajax_form_sucursales_todas_mob_validate_nombre_empresa

  function do_ajax_form_sucursales_todas_mob_validate_nombre_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_mob_validate_nombre_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sucursales_todas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sucursales_todas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_sucursal = scAjaxGetFieldHidden("id_sucursal");
    var var_codigo_suc = scAjaxGetFieldText("codigo_suc");
    var var_observacion_suc = scAjaxGetFieldText("observacion_suc");
    ...
    scAjaxProcOn();
    x_ajax_form_sucursales_todas_mob_submit_form(var_id_sucursal, var_codigo_suc, var_observacion_suc, var_ip, var_puerto, var_nombre_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sucursales_todas_mob_submit_form_cb);
  } // do_ajax_form_sucursales_todas_mob_submit_form

  function do_ajax_form_sucursales_todas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_sucursal");
      scAjaxHideErrorDisplay("codigo_suc");
      scAjaxHideErrorDisplay("observacion_suc");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sucursales_todas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_sucursales_todas_mob_submit_form_cb
  function do_ajax_form_sucursales_todas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sucursales_todas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sucursales_todas_mob_navigate_form()
  {
    perform_ajax_form_sucursales_todas_mob_navigate_form();
  }

  function perform_ajax_form_sucursales_todas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("puerto");
    scAjaxHideErrorDisplay("nombre_empresa");
    var var_id_sucursal = document.F2.id_sucursal.value;
    ...
    scAjaxProcOn();
    x_ajax_form_sucursales_todas_mob_navigate_form(var_id_sucursal, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sucursales_todas_mob_navigate_form_cb);
  } // do_ajax_form_sucursales_todas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sucursales_todas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sucursales_todas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_sucursal.value = scAjaxGetKeyValue("id_sucursal");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sucursales_todas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_sucursales_todas_mob_navigate_form_cb
  function do_ajax_form_sucursales_todas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sucursales_todas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_sucursales_todas_mob_navigate_form_cb_after_alert
  function sc_hide_form_sucursales_todas_mob_form()
  {
  ...
  ajax_field_list[0] = "id_sucursal";
  ajax_field_list[1] = "codigo_suc";
  ajax_field_list[2] = "observacion_suc";
  ajax_field_list[3] = "ip";
  ajax_field_list[4] = "puerto";
  ajax_field_list[5] = "nombre_empresa";
  ...
  var ajax_error_list = {
    "id_sucursal": {"label": "Id Sucursal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "codigo_suc": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "observacion_suc": {"label": "Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ip": {"label": "IP Sucursal Principal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puerto": {"label": "Puerto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "nombre_empresa": {"label": "Empresa Principal", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "id_sucursal": new Array(),
    "codigo_suc": new Array(),
    "observacion_suc": new Array(),
    "ip": new Array(),
    "puerto": new Array(),
    "nombre_empresa": new Array()
  };
  ajax_field_mult["id_sucursal"][1] = "id_sucursal";
  ajax_field_mult["codigo_suc"][1] = "codigo_suc";
  ajax_field_mult["observacion_suc"][1] = "observacion_suc";
  ajax_field_mult["ip"][1] = "ip";
  ajax_field_mult["puerto"][1] = "puerto";
  ajax_field_mult["nombre_empresa"][1] = "nombre_empresa";

  var ajax_field_id = {
    "codigo_suc": new Array("hidden_field_label_codigo_suc", "hidden_field_data_codigo_suc"),
    "observacion_suc": new Array("hidden_field_label_observacion_suc", "hidden_field_data_observacion_suc"),
