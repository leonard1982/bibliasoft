  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_sucursales_todas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_sucursales_todas_form();
	}
  ...
  function do_ajax_form_sucursales_todas_validate_id_sucursal()
  {
    var nomeCampo_id_sucursal = "id_sucursal";
    var var_id_sucursal = scAjaxGetFieldHidden(nomeCampo_id_sucursal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_validate_id_sucursal(var_id_sucursal, var_script_case_init, do_ajax_form_sucursales_todas_validate_id_sucursal_cb);
  } // do_ajax_form_sucursales_todas_validate_id_sucursal

  function do_ajax_form_sucursales_todas_validate_id_sucursal_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_validate_id_sucursal_cb

  // ---------- Validate codigo_suc
  function do_ajax_form_sucursales_todas_validate_codigo_suc()
  {
    var nomeCampo_codigo_suc = "codigo_suc";
    var var_codigo_suc = scAjaxGetFieldText(nomeCampo_codigo_suc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_validate_codigo_suc(var_codigo_suc, var_script_case_init, do_ajax_form_sucursales_todas_validate_codigo_suc_cb);
  } // do_ajax_form_sucursales_todas_validate_codigo_suc

  function do_ajax_form_sucursales_todas_validate_codigo_suc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_validate_codigo_suc_cb

  // ---------- Validate observacion_suc
  function do_ajax_form_sucursales_todas_validate_observacion_suc()
  {
    var nomeCampo_observacion_suc = "observacion_suc";
    var var_observacion_suc = scAjaxGetFieldText(nomeCampo_observacion_suc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_validate_observacion_suc(var_observacion_suc, var_script_case_init, do_ajax_form_sucursales_todas_validate_observacion_suc_cb);
  } // do_ajax_form_sucursales_todas_validate_observacion_suc

  function do_ajax_form_sucursales_todas_validate_observacion_suc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_validate_observacion_suc_cb

  // ---------- Validate ip
  function do_ajax_form_sucursales_todas_validate_ip()
  {
    var nomeCampo_ip = "ip";
    var var_ip = scAjaxGetFieldText(nomeCampo_ip);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_validate_ip(var_ip, var_script_case_init, do_ajax_form_sucursales_todas_validate_ip_cb);
  } // do_ajax_form_sucursales_todas_validate_ip

  function do_ajax_form_sucursales_todas_validate_ip_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ip";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_validate_ip_cb

  // ---------- Validate puerto
  function do_ajax_form_sucursales_todas_validate_puerto()
  {
    var nomeCampo_puerto = "puerto";
    var var_puerto = scAjaxGetFieldText(nomeCampo_puerto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_validate_puerto(var_puerto, var_script_case_init, do_ajax_form_sucursales_todas_validate_puerto_cb);
  } // do_ajax_form_sucursales_todas_validate_puerto

  function do_ajax_form_sucursales_todas_validate_puerto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puerto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_validate_puerto_cb

  // ---------- Validate nombre_empresa
  function do_ajax_form_sucursales_todas_validate_nombre_empresa()
  {
    var nomeCampo_nombre_empresa = "nombre_empresa";
    var var_nombre_empresa = scAjaxGetFieldText(nomeCampo_nombre_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_sucursales_todas_validate_nombre_empresa(var_nombre_empresa, var_script_case_init, do_ajax_form_sucursales_todas_validate_nombre_empresa_cb);
  } // do_ajax_form_sucursales_todas_validate_nombre_empresa

  function do_ajax_form_sucursales_todas_validate_nombre_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_sucursales_todas_validate_nombre_empresa_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_sucursales_todas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_sucursales_todas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_sucursales_todas_submit_form(var_id_sucursal, var_codigo_suc, var_observacion_suc, var_ip, var_puerto, var_nombre_empresa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_sucursales_todas_submit_form_cb);
  } // do_ajax_form_sucursales_todas_submit_form

  function do_ajax_form_sucursales_todas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_sucursales_todas_submit_form_cb_after_alert);
  } // do_ajax_form_sucursales_todas_submit_form_cb
  function do_ajax_form_sucursales_todas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_sucursales_todas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_sucursales_todas_navigate_form()
  {
    perform_ajax_form_sucursales_todas_navigate_form();
  }

  function perform_ajax_form_sucursales_todas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_sucursales_todas_navigate_form(var_id_sucursal, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_sucursales_todas_navigate_form_cb);
  } // do_ajax_form_sucursales_todas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_sucursales_todas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_sucursales_todas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_sucursales_todas_navigate_form_cb_after_alert);
  } // do_ajax_form_sucursales_todas_navigate_form_cb
  function do_ajax_form_sucursales_todas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_sucursales_todas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_sucursales_todas_navigate_form_cb_after_alert
  function sc_hide_form_sucursales_todas_form()
  {
