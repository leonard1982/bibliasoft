...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_kardex"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEB_FE_73_____grid_cloud_kardex"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cloud_kardex'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_cloud_kardex']['embutida_filho'] as $ind => $sc_init)
          {
