<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_cloud_kardex']['glo_nm_path_imag_temp'] . "/sc_apl_default_FACILWEB_FE_73.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_cloud_kardex_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_cloud_kardex_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['prefijo'] = "on";
   $tab_def_campos['prefijo'] = "prefijo";
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["prefijo"] : "Prefijo";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["numero"] : "Numero";
   $tab_ger_campos['numero_fe'] = "on";
   $tab_def_campos['numero_fe'] = "numero_fe";
   $tab_labels["numero_fe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["numero_fe"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["numero_fe"] : "Numero Fe";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["tercero"] : "Tercero";
   $tab_ger_campos['estado'] = "on";
   $tab_def_campos['estado'] = "estado";
   $tab_labels["estado"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["estado"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["estado"] : "Estado";
   $tab_ger_campos['cufe'] = "on";
   $tab_def_campos['cufe'] = "cufe";
   $tab_labels["cufe"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["cufe"])) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['labels']["cufe"] : "Cufe";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_kardex']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_kardex']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_cloud_kardex']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_cloud_kardex_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_cloud_kardex']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
