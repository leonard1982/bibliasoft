...
class menu_notificacion_form_php
{
      var $sc_script_name;
      var $nm_location;
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['menu_notificacion']['sc_apl_link'];
...
';
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['menu_notificacion'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("grid_tbl_sys_message_noti") . "/?nm_run_menu=1&nm_apl_menu=menu_notificacion&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="menu_notificacion"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "menu_notificacion")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'menu_notificacion', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
<?php
   ...
   function Gera_sc_init($apl_menu)
   {
        ...
        $this->menu_sc_init = $_SESSION['scriptcase']['menu_notificacion']['sc_init'][$apl_menu];
...
$controle = new menu_notificacion_form_php();
$controle->init();
?>
