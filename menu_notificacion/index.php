<?php
include_once('menu_notificacion_session.php');
...
if ($_SESSION['scriptcase']['device_mobile'])
{
    ...
    $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod']      = "";
    $_SESSION['scriptcase']['menu_notificacion']['glo_nm_perfil']         = "";
    $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_imag_temp'] = "";
    $_SESSION['scriptcase']['menu_notificacion']['glo_nm_usa_grupo']      = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //end check publication with the prod

ob_start();

class menu_notificacion_class
{
  var $Db;
 ...
 function menu_notificacion_menu()
 {
    global $menu_notificacion_menuData, $nm_data_fixa;
     ...
     { 
         $_SESSION['scriptcase']['str_schema_all'] = $_POST["nmgp_schema"] . "/" . $_POST["nmgp_schema"];
           ...
           $nm_versao_sc  = "" ; 
           $_SESSION['scriptcase']['menu_notificacion']['contr_erro'] = 'off';
           $Campos_Mens_erro = "";
...
$this->menu_orientacao = '';
$this->path_botoes    = '../_lib/img';
$this->path_imag_apl  = $str_root . $path_link . "_lib/img";
$path_help      = $path_link . "_lib/webhelp/";
$path_libs      = $str_root . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'] . "/lib/php";
$path_third     = $str_root . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'] . "/third";
$path_adodb     = $str_root . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'] . "/third/adodb";
$path_apls      = $str_root . substr($path_link, 0, strrpos($path_link, '/'));
$path_img_old   = $str_root . $path_link . "menu_notificacion/img";
$this->path_css = $str_root . $path_link . "_lib/css/";
$_SESSION['scriptcase']['dir_temp'] = $str_root . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_imag_temp'];
...
$this->sc_Include($path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
 if(function_exists('set_php_timezone')) set_php_timezone('menu_notificacion');
...
if (!defined("SC_ERROR_HANDLER"))
{
    ...
    include_once(dirname(__FILE__) . "/menu_notificacion_erro.php");
}
include_once(dirname(__FILE__) . "/menu_notificacion_erro.class.php"); 
$this->Erro = new menu_notificacion_erro();
$str_path = substr($_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'], 0, strrpos($_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'], '/') + 1);
if (!is_file($str_root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
{
    unset($_SESSION['scriptcase']['nm_sc_retorno']);
    unset($_SESSION['scriptcase']['menu_notificacion']['glo_nm_conexao']);
}

/* Definiciones de las rutas */
$menu_notificacion_menuData         = array();
$menu_notificacion_menuData['path'] = array();
$menu_notificacion_menuData['url']  = array();
$NM_dir_atual = getcwd();
if (empty($NM_dir_atual))
{
    $menu_notificacion_menuData['path']['sys'] = (isset($_SERVER['SCRIPT_FILENAME'])) ? $_SERVER['SCRIPT_FILENAME'] : $_SERVER['ORIG_PATH_TRANSLATED'];
    $menu_notificacion_menuData['path']['sys'] = str_replace("\\", '/', $str_path_sys);
    $menu_notificacion_menuData['path']['sys'] = str_replace('//', '/', $str_path_sys);
}
else
{
    $sc_nm_arquivo                                   = explode("/", $_SERVER['PHP_SELF']);
    $menu_notificacion_menuData['path']['sys'] = str_replace("\\", "/", str_replace("\\\\", "\\", getcwd())) . "/" . $sc_nm_arquivo[count($sc_nm_arquivo)-1];
}
$menu_notificacion_menuData['url']['web']   = $_SERVER['PHP_SELF'];
$menu_notificacion_menuData['url']['web']   = str_replace("\\", '/', $menu_notificacion_menuData['url']['web']);
$menu_notificacion_menuData['path']['root'] = substr($menu_notificacion_menuData['path']['sys'],  0, -1 * strlen($menu_notificacion_menuData['url']['web']));
$menu_notificacion_menuData['path']['app']  = substr($menu_notificacion_menuData['path']['sys'],  0, strrpos($menu_notificacion_menuData['path']['sys'],  '/'));
$menu_notificacion_menuData['path']['link'] = substr($menu_notificacion_menuData['path']['app'],  0, strrpos($menu_notificacion_menuData['path']['app'],  '/'));
$menu_notificacion_menuData['path']['link'] = substr($menu_notificacion_menuData['path']['link'], 0, strrpos($menu_notificacion_menuData['path']['link'], '/')) . '/';
$menu_notificacion_menuData['path']['app'] .= '/';
$menu_notificacion_menuData['url']['app']   = substr($menu_notificacion_menuData['url']['web'],  0, strrpos($menu_notificacion_menuData['url']['web'],  '/'));
$menu_notificacion_menuData['url']['link']  = substr($menu_notificacion_menuData['url']['app'],  0, strrpos($menu_notificacion_menuData['url']['app'],  '/'));
if ($_SESSION['scriptcase']['menu_notificacion']['glo_nm_usa_grupo'] == "S")
{
    $menu_notificacion_menuData['url']['link']  = substr($menu_notificacion_menuData['url']['link'], 0, strrpos($menu_notificacion_menuData['url']['link'], '/'));
}
$menu_notificacion_menuData['url']['link']  .= '/';
$menu_notificacion_menuData['url']['app']   .= '/';


$_SESSION['scriptcase']['menu_notificacion']['sc_apl_link'] = $menu_notificacion_menuData['url']['link'];
...
if (isset($_SESSION['scriptcase']['menu_notificacion']['session_timeout']['lang'])) {
    $this->str_lang = $_SESSION['scriptcase']['menu_notificacion']['session_timeout']['lang'];
}
...
if ($_SESSION['scriptcase']['menu_notificacion']['glo_nm_usa_grupo'] != "S")
{
    $this->tab_grupo[0] = "";
     ...
     $_SESSION['scriptcase']['menu_atual'] = "menu_notificacion";
     $_SESSION['scriptcase']['menu_apls']['menu_notificacion'] = array();
     if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
     {
         foreach ($_SESSION['scriptcase']['sc_connection'] as $NM_con_orig => $NM_con_dest)
         {
             if (isset($_SESSION['scriptcase']['menu_notificacion']['glo_nm_conexao']) && $_SESSION['scriptcase']['menu_notificacion']['glo_nm_conexao'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_notificacion']['glo_nm_conexao'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_notificacion']['glo_nm_perfil']) && $_SESSION['scriptcase']['menu_notificacion']['glo_nm_perfil'] == $NM_con_orig)
             {
/*NM*/           $_SESSION['scriptcase']['menu_notificacion']['glo_nm_perfil'] = $NM_con_dest;
             }
             if (isset($_SESSION['scriptcase']['menu_notificacion']['glo_con_' . $NM_con_orig]))
             {
                 $_SESSION['scriptcase']['menu_notificacion']['glo_con_' . $NM_con_orig] = $NM_con_dest;
             }
         }
     }
...
if (isset($_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir'])) {
...
';
    ...
    if ($_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "  </HEAD>\r\n";
        $SS_cod_html .= "   <body>\r\n";
    }
    else {
        ...
        $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir'] . "');\">\r\n";
        $SS_cod_html .= "     </form>\r\n";
    ...
    if ($_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir_tp'] == "R") {
        $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir'] . "');\r\n";
    }
    ...
    $SS_cod_html .= " </body>\r\n";
    $SS_cod_html .= "</HTML>\r\n";
    unset($_SESSION['scriptcase']['menu_notificacion']['session_timeout']);
...
{
    $_SESSION['sc_session'][1]['menu_notificacion']['init'] = $script_case_init;
}
else
if (!isset($_SESSION['sc_session'][1]['menu_notificacion']['init']))
{
    $_SESSION['sc_session'][1]['menu_notificacion']['init'] = "";
}
$script_case_init = $_SESSION['sc_session'][1]['menu_notificacion']['init'];
...
if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir']))
{
...
{ 
    $nm_url_saida = $_SESSION['scriptcase']['sc_saida_menu_notificacion'];
}
elseif (!empty($nm_url_saida))
{
    $_SESSION['scriptcase']['sc_url_saida'][$script_case_init]  = $nm_url_saida;
    $_SESSION['scriptcase']['sc_saida_menu_notificacion'] = $nm_url_saida;
}
else
{
    $_SESSION['scriptcase']['sc_saida_menu_notificacion'] = (isset($_SERVER['HTTP_REFERER']) && !empty($_SERVER['HTTP_REFERER'])) ? $_SERVER['HTTP_REFERER'] : "javascript:window.close()";
}
$this->sc_Include($path_libs . "/nm_ini_lib.php", "F", "nm_dir_normaliza") ; 
/* Dados do menu em sessao */
$_SESSION['nm_menu'] = array('prod' => $str_root . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'] . '/third/COOLjsMenu/',
                              'url' => $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod'] . '/third/COOLjsMenu/');

if ((isset($nmgp_outra_jan) && $nmgp_outra_jan == "true") || (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'menu_notificacion'))
{
    $_SESSION['sc_session'][1]['menu_notificacion']['sc_outra_jan'] = true;
     unset($_SESSION['scriptcase']['sc_outra_jan']);
    $_SESSION['scriptcase']['sc_saida_menu_notificacion'] = "javascript:window.close()";
}
/* Menú de configuración de las variables */
$menu_notificacion_menuData['iframe'] = TRUE;

if (!isset($_SESSION['scriptcase']['sc_apl_seg']))
{
    $_SESSION['scriptcase']['sc_apl_seg'] = array();
}
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("grid_tbl_sys_message_noti") . "/grid_tbl_sys_message_noti_ini.txt");
...
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_sys_message_noti']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_sys_message_noti'] = "on";
    }
}
...
/* Elementos de menú */
$_SESSION['scriptcase']['menu_notificacion']['contr_erro'] = 'on';
...
$(document).ready(function(){
	...
	if(tipoRequest=="file"){
			function refreshData(){
				var request = $.ajax({
					  url: "../blank_mensaje_mostrar/blank_mensaje_mostrar.php",
					  dataType: "JSON"
				});
...
$saida_apl = $_SESSION['scriptcase']['sc_saida_menu_notificacion'];
if (isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_sys_message_noti']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_sys_message_noti']) == "on")
{
    $menu_notificacion_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "|menu_notificacion_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_tbl_sys_message_noti&sc_apl_link=" . urlencode($menu_notificacion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[0] . "||" . $this->menu_notificacion_target('_self') . "|" . "\n";
}
else
{
    $menu_notificacion_menuData['data'] .= "item_1|.|" . $nm_var_lab[0] . "||||_self|disabled\n";
}
...
$menu_notificacion_menuData['data'] = array();
$str_disabled = "N";
$str_link = "menu_notificacion_form_php.php?sc_item_menu=item_1&sc_apl_menu=grid_tbl_sys_message_noti&sc_apl_link=" . urlencode($menu_notificacion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_sys_message_noti']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['grid_tbl_sys_message_noti']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
    ...
    $menu_notificacion_menuData['data'][] = array(
        ...
        'target'   => " item-target=\"" . $this->menu_notificacion_target('_self') . "\"",
        'sc_id'    => "item_1",
...
if (isset($_SESSION['scriptcase']['sc_def_menu']['menu_notificacion']))
{
    $arr_menu_usu = $this->nm_arr_menu_recursiv($_SESSION['scriptcase']['sc_def_menu']['menu_notificacion']);
    $this->nm_gera_menus($str_menu_usu, $arr_menu_usu, 1, 'menu_notificacion');
    $menu_notificacion_menuData['data'] = $str_menu_usu;
}
if (is_file("menu_notificacion_help.txt"))
{
    $Arq_WebHelp = file("menu_notificacion_help.txt"); 
        ...
        foreach ($Tmp as $Cada_help)
        {
            ...
            if (!empty($Tmp1[0]) && isset($Tmp1[1]) && !empty($Tmp1[1]) && $Tmp1[0] == "menu" && is_file($str_root . $path_help . $Tmp1[1]))
            {
                ...
                $menu_notificacion_menuData['data'][] = array(
                    ...
                    'icon_aba' => $icon_aba,
                    'icon_aba_inactive' => $icon_aba_inactive,
                    'target'   => "" . $this->menu_notificacion_target('_blank') . "",
                    'sc_id'    => "item_Help",
                    'disabled' => $str_disabled,
                    'display'     => "text",
                    'display_position'=> "",
...
if (isset($_SESSION['scriptcase']['sc_menu_del']['menu_notificacion']) && !empty($_SESSION['scriptcase']['sc_menu_del']['menu_notificacion']))
{
    $nivel = 0;
    $exclui_menu = false;
    foreach ($menu_notificacion_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_del']['menu_notificacion']))
       {
          $nivel = $cada_menu['level'];
          $exclui_menu = true;
          unset($menu_notificacion_menuData['data'][$i_menu]);
       }
    ...
    $menu_notificacion_menuData['data'] = $Temp_menu;
}

if (isset($_SESSION['scriptcase']['sc_menu_disable']['menu_notificacion']) && !empty($_SESSION['scriptcase']['sc_menu_disable']['menu_notificacion']))
{
    $disable_menu = false;
    foreach ($menu_notificacion_menuData['data'] as $i_menu => $cada_menu)
    {
       if (in_array($cada_menu['id'], $_SESSION['scriptcase']['sc_menu_disable']['menu_notificacion']))
       {
          $nivel = $cada_menu['level'];
          $disable_menu = true;
          $menu_notificacion_menuData['data'][$i_menu]['disabled'] = 'Y';
       }
...
/* Cabecera HTML */
if ($menu_notificacion_menuData['iframe'])
{
    $menu_notificacion_menuData['height'] = '100%';
...
<link rel="stylesheet" type="text/css" href="../_lib/css/_menuTheme/scriptcase_Scriptcase_ScriptCase5_Silver_<?php echo ($this->menu_orientacao!='vertical')?'hor':'vert'; ?>_<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir']; ?>.css<?php if (@is_file($this->path_css . '_menuTheme/' . "scriptcase_Scriptcase_ScriptCase5_Silver" . '_' . (($this->menu_orientacao!='vertical')?'hor':'vert') . '.css')) { echo '?scp=' . md5($this->path_css . '_menuTheme/' . "scriptcase_Scriptcase_ScriptCase5_Silver" . '_' . (($this->menu_orientacao=='horizontal')?'hor':'vert') . '.css'); } ?>" />
<style>
   .scTabText {
   }    <?php
...
{
    $menu_notificacion_menuData['height'] = '30px';
}

/* Archivos JS */
?>
<script type="text/javascript" src="../_lib/lib/js/jquery-3.6.0.min.js"></script>
<script  type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/jquery.contextmenu.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod']; ?>/third/jquery_plugin/contextmenu/contextmenu.css" /> 
...
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['menu_notificacion']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_sweetalert.css" />
<script type="text/javascript" src="menu_notificacion_message.js"></script>
...
Iframe_atual = "menu_notificacion_iframe";
...
<?php
 $seq = 0;
 if(isset($menu_notificacion_menuData['data']) && !empty($menu_notificacion_menuData['data']))
 {
   foreach ($menu_notificacion_menuData['data'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
 ...
 if(isset($menu_notificacion_menuData['data_vertical']) && !empty($menu_notificacion_menuData['data_vertical']))
 {
   foreach ($menu_notificacion_menuData['data_vertical'] as $ind => $dados_menu)
   {
     if ($dados_menu['link'] != "#")
     {
         if(empty($dados_menu['hint']))
...
function createIframe(str_id, str_label, str_hint, str_img_on, str_img_off, str_link, tp_apl)
{
    ...
    iframe.name = 'menu_notificacion_' + str_id + '_iframe';
    iframe.src = str_link;
...
function createAba(str_id)
{
    ...
    var home_style="";
    if(str_id === 'menu_notificacion'){ home_style=";padding-left:4px;min-height:14px;"; }
...
{
    $('#iframe_menu_notificacion').hide();
    if (str_id == "")
    {
        $('#iframe_menu_notificacion').show();
    ...
    for (i = 0; i < Tab_iframes.length; i++) 
    {
        if (Tab_iframes[i] == str_id) 
        {
            ...
            {
                $('#Iframe_control').append('<iframe id="iframe_'+ Tab_iframes[i] +'" name="menu_notificacion_'+ Tab_iframes[i] +'_iframe" frameborder="0" class="scMenuIframe" style="display: none; width: 100%; height: 100%;" src=""></iframe>');
            }
            ...
            Iframe_atual = "menu_notificacion_" + Tab_iframes[i] + '_iframe';
...
{
  str_target_sv = "";
  if (str_id != "iframe_menu_notificacion")
  {
      str_target_sv = str_id + "_iframe";
      str_id        = str_id.replace("menu_notificacion_","");
  }
  ...
  if (typeof str_link !== typeof undefined && str_link !== false) {
    if (str_target == "menu_notificacion_iframe" && str_link != '' && str_link != '#' && str_link != 'javascript:')
    {
        str_target = (str_target_sv != "") ? str_target_sv : str_target;
        mudaIframe(str_id);
        if (str_id != "menu_notificacion")
        {
            $('#links_abas').css('display','');
            $('#id_links_abas').css('display','');
        }
        if (str_id != "menu_notificacion" && Tab_abas[str_id] != 'show')
        {
            createAba(str_id);
      scToggleOverflow();
        }
    ...
    if(str_target != '_blank' && $('#iframe_menu_notificacion').length)
        $('#iframe_menu_notificacion')[0].contentWindow.focus();
  }
}
</script>
<?php
...
<?php echo ($this->menu_orientacao=='vertical')?$this->nm_show_toolbarmenu($col_span, $saida_apl, $menu_notificacion_menuData, $path_imag_cab):''; ?>  <tr class="scMenuHTableCssAlt" id='idMenuLine'>
  <?php
  if($this->menu_orientacao != 'vertical')
  {
    ?>
...
echo $this->menu_notificacion_escreveMenu($menu_notificacion_menuData['data'], $path_imag_cab, $strAlign);
?></tr></table>
</div>
<?php
/* Control de iframe */
...
<?php echo $this->nm_show_toolbarmenu('', $saida_apl, $menu_notificacion_menuData, $path_imag_cab); ?><?php echo $this->nm_gera_degrade(1, $bg_line_degrade, $path_imag_cab); ?>  <tr>
...
?>
    <div id="Iframe_control" style='width:100%; height:100%; margin:0px; padding:0px;'>
      <iframe id="iframe_menu_notificacion" name="menu_notificacion_iframe" frameborder="0" class="scMenuIframe" style="width: 100%; height: 100%;"  src="<?php echo ($NM_scr_iframe != "" ? $NM_scr_iframe : "https://www.scriptcase.net"); ?> " ></iframe>
<?php
}
?></div></td>
  </tr>
...
<div style="width: 100%; height:20px;" class="scMenuHFooter">
        ...
        <span class="scMenuHFooterFont" id="rod_col2"><?php echo "Bienvenido a Scriptcase" ?></span>
</div>    </td>
  </tr>
</table>
</body>
...
/* Control de Target */
function menu_notificacion_escreveMenu($arr_menu, $path_imag_cab = '', $strAlign = '')
{
    global $nm_data_fixa;
    $last      = '';
    $itemClass = ' topfirst';
...
<td <?php echo $strAlign; ?>>
  <div class='mainmenu menu--horizontal'>
      ...
      <div class='menu__container'>
        ...
        <td class='sc-layer-0' style='width:8.87%;text-align:left;'>
...
<!--                   <img src="data:image/svg+xml;utf8;base64," /> <span class="caret"></span> -->
...
function menu_notificacion_target($str_target)
{
    global $menu_notificacion_menuData;
    ...
    elseif ($menu_notificacion_menuData['iframe'])
    {
        return 'menu_notificacion_iframe';
    }
    else
    {
        return $str_target;
...
function nm_show_toolbarmenu($col_span, $saida_apl, $menu_notificacion_menuData, $path_imag_cab)
{
   ...
   function nm_gera_menus(&$str_line_ret, $arr_menu_usu, $int_level, $nome_aplicacao)
   {
       ...
       foreach ($arr_menu_usu as $arr_item)
       {
           ...
           if ('' != $arr_item['link'])
           {
               ...
               {
                    $str_line['link'] = "menu_notificacion_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_notificacion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_usa_grupo'] . ""; 
               }
               else
               {
                    $str_line['link'] = "menu_notificacion_form_php.php?sc_item_menu=" . $arr_item['id'] . "&sc_apl_menu=" . $nome_apl . "&sc_apl_link=" . urlencode($menu_notificacion_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu_notificacion']['glo_nm_usa_grupo'] . ""; 
           ...
           {
                $str_line['target'] = ('' != $arr_item['target'] && '' != $arr_item['link']) ?  $this->menu_notificacion_target( $arr_item['target']) : "_self"; 
           }
   ...
   {
        $_SESSION['scriptcase']['menu_notificacion']['sc_init'][$apl_menu] = rand(2, 10000);
        $_SESSION['sc_session'][$_SESSION['scriptcase']['menu_notificacion']['sc_init'][$apl_menu]] = array();
        return  $_SESSION['scriptcase']['menu_notificacion']['sc_init'][$apl_menu];
   }
    ...
    if (isset($apl_def)) {
        if ($apl_def[0] != "menu_notificacion") {
            ...
            if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                $_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir'] = $apl_def[0];
            }
            else {
                $_SESSION['scriptcase']['menu_notificacion']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
            }
...
$contr_menu_notificacion = new menu_notificacion_class;
$contr_menu_notificacion->menu_notificacion_menu();
