...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras_mob']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras_mob']['insert'];
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['embutida_liga_form_insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['embutida_liga_form_insert'];
      }
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['fac_compras_mob']['insert'] != '')
      {
          ...
          $this->nmgp_botoes['copy']   = $_SESSION['scriptcase']['sc_apl_conf']['fac_compras_mob']['insert'];
      }
      ...
      if ($this->nmgp_opcao == "fast_search")  
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['opcao'] = "inicio";
...
if ($this->total <>0)
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_fac_compras_mob' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
//---------- 
      ...
      { 
          ...
          else
          {
              ...
              if ($this->nmgp_clone == "S" && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['dados_select']))
              {
                  $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['dados_select'];
