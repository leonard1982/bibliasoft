...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_creado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_creado_onblur(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_creado_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_editado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_editado_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_fac_compras_editado_onfocus(this, iSeqRow) });
...
function sc_fac_compras_idfaccom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_idfaccom();
  scCssBlur(oThis);
}
...
function sc_fac_compras_numfacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_numfacom();
  scCssBlur(oThis);
}
...
function sc_fac_compras_formapago_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_formapago();
  scCssBlur(oThis);
}
...
function sc_fac_compras_fechacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_fechacom();
  scCssBlur(oThis);
}
...
function sc_fac_compras_fechavenc_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_fechavenc();
  scCssBlur(oThis);
}
...
function sc_fac_compras_idprov_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_idprov();
  scCssBlur(oThis);
}

function sc_fac_compras_idprov_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_event_idprov_onchange();
}
...
function sc_fac_compras_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_subtotal();
  scCssBlur(oThis);
}
...
function sc_fac_compras_valoriva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_valoriva();
  scCssBlur(oThis);
}
...
function sc_fac_compras_total_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_total();
  scCssBlur(oThis);
}
...
function sc_fac_compras_pagada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_pagada();
  scCssBlur(oThis);
}
...
function sc_fac_compras_asentada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_asentada();
  scCssBlur(oThis);
}

function sc_fac_compras_asentada_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_event_asentada_onchange();
}
...
function sc_fac_compras_control_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_control();
  scCssBlur(oThis);
}
...
function sc_fac_compras_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_observaciones();
  scCssBlur(oThis);
}
...
function sc_fac_compras_saldo_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_saldo();
  scCssBlur(oThis);
}
...
function sc_fac_compras_anulada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_anulada();
  scCssBlur(oThis);
}
...
function sc_fac_compras_es_remision_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_es_remision();
  scCssBlur(oThis);
}
...
function sc_fac_compras_id_pedidocom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_id_pedidocom();
  scCssBlur(oThis);
}

function sc_fac_compras_id_pedidocom_onchange(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_event_id_pedidocom_onchange();
}
...
function sc_fac_compras_retencion_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_retencion();
  scCssBlur(oThis);
}
...
function sc_fac_compras_reteica_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_reteica();
  scCssBlur(oThis);
}
...
function sc_fac_compras_reteiva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_reteiva();
  scCssBlur(oThis);
}
...
function sc_fac_compras_usuario_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_usuario();
  scCssBlur(oThis);
}
...
function sc_fac_compras_banco_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_banco();
  scCssBlur(oThis);
}
...
function sc_fac_compras_creado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_creado();
  scCssBlur(oThis);
}
...
function sc_fac_compras_editado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_editado();
  scCssBlur(oThis);
}
...
function sc_fac_compras_cod_cuenta_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_cod_cuenta();
  scCssBlur(oThis);
}
...
function sc_fac_compras_detalle_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_detalle();
  scCssBlur(oThis);
}
...
function sc_fac_compras_hdetalle_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_hdetalle();
  scCssBlur(oThis);
}

function sc_fac_compras_hdetalle_onclick(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_event_hdetalle_onclick();
}

function sc_fac_compras_hdetalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_fac_compras_mob_event_hdetalle_onfocus();
}

function sc_fac_compras_prefijo_delpedido_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_mob_validate_prefijo_delpedido();
  scCssBlur(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_fac_compras_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechacom" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_mob_validate_fechacom(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_mob_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_mob_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_mob_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'fac_compras_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
