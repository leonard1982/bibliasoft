  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_fac_compras_mob" == sTestField)
        {
...
?>
  ...
  function do_ajax_fac_compras_mob_validate_es_remision()
  {
    var nomeCampo_es_remision = "es_remision";
    var var_es_remision = scAjaxGetFieldSelect(nomeCampo_es_remision);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_es_remision(var_es_remision, var_script_case_init, do_ajax_fac_compras_mob_validate_es_remision_cb);
  } // do_ajax_fac_compras_mob_validate_es_remision

  function do_ajax_fac_compras_mob_validate_es_remision_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_es_remision_cb

  // ---------- Validate id_pedidocom
  function do_ajax_fac_compras_mob_validate_id_pedidocom()
  {
    var nomeCampo_id_pedidocom = "id_pedidocom";
    var var_id_pedidocom = scAjaxGetFieldSelect(nomeCampo_id_pedidocom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_id_pedidocom(var_id_pedidocom, var_script_case_init, do_ajax_fac_compras_mob_validate_id_pedidocom_cb);
  } // do_ajax_fac_compras_mob_validate_id_pedidocom

  function do_ajax_fac_compras_mob_validate_id_pedidocom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_id_pedidocom_cb

  // ---------- Validate numfacom
  function do_ajax_fac_compras_mob_validate_numfacom()
  {
    var nomeCampo_numfacom = "numfacom";
    var var_numfacom = scAjaxGetFieldText(nomeCampo_numfacom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_numfacom(var_numfacom, var_script_case_init, do_ajax_fac_compras_mob_validate_numfacom_cb);
  } // do_ajax_fac_compras_mob_validate_numfacom

  function do_ajax_fac_compras_mob_validate_numfacom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_numfacom_cb

  // ---------- Validate fechacom
  function do_ajax_fac_compras_mob_validate_fechacom()
  {
    var nomeCampo_fechacom = "fechacom";
    var var_fechacom = scAjaxGetFieldText(nomeCampo_fechacom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_fechacom(var_fechacom, var_script_case_init, do_ajax_fac_compras_mob_validate_fechacom_cb);
  } // do_ajax_fac_compras_mob_validate_fechacom

  function do_ajax_fac_compras_mob_validate_fechacom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_fechacom_cb

  // ---------- Validate idprov
  function do_ajax_fac_compras_mob_validate_idprov()
  {
  } // do_ajax_fac_compras_mob_validate_idprov

  function do_ajax_fac_compras_mob_validate_idprov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idprov";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_idprov_cb

  // ---------- Validate formapago
  function do_ajax_fac_compras_mob_validate_formapago()
  {
    var nomeCampo_formapago = "formapago";
    var var_formapago = scAjaxGetFieldSelect(nomeCampo_formapago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_formapago(var_formapago, var_script_case_init, do_ajax_fac_compras_mob_validate_formapago_cb);
  } // do_ajax_fac_compras_mob_validate_formapago

  function do_ajax_fac_compras_mob_validate_formapago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_formapago_cb

  // ---------- Validate fechavenc
  function do_ajax_fac_compras_mob_validate_fechavenc()
  {
    var nomeCampo_fechavenc = "fechavenc";
    var var_fechavenc = scAjaxGetFieldText(nomeCampo_fechavenc);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_fechavenc(var_fechavenc, var_script_case_init, do_ajax_fac_compras_mob_validate_fechavenc_cb);
  } // do_ajax_fac_compras_mob_validate_fechavenc

  function do_ajax_fac_compras_mob_validate_fechavenc_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_fechavenc_cb

  // ---------- Validate total
  function do_ajax_fac_compras_mob_validate_total()
  {
    var nomeCampo_total = "total";
    var var_total = scAjaxGetFieldHidden(nomeCampo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_total(var_total, var_script_case_init, do_ajax_fac_compras_mob_validate_total_cb);
  } // do_ajax_fac_compras_mob_validate_total

  function do_ajax_fac_compras_mob_validate_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "total";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_total_cb

  // ---------- Validate saldo
  function do_ajax_fac_compras_mob_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldHidden(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_saldo(var_saldo, var_script_case_init, do_ajax_fac_compras_mob_validate_saldo_cb);
  } // do_ajax_fac_compras_mob_validate_saldo

  function do_ajax_fac_compras_mob_validate_saldo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_saldo_cb

  // ---------- Validate pagada
  function do_ajax_fac_compras_mob_validate_pagada()
  {
    var nomeCampo_pagada = "pagada";
    var var_pagada = scAjaxGetFieldHidden(nomeCampo_pagada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_pagada(var_pagada, var_script_case_init, do_ajax_fac_compras_mob_validate_pagada_cb);
  } // do_ajax_fac_compras_mob_validate_pagada

  function do_ajax_fac_compras_mob_validate_pagada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pagada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_pagada_cb

  // ---------- Validate anulada
  function do_ajax_fac_compras_mob_validate_anulada()
  {
    var nomeCampo_anulada = "anulada";
    var var_anulada = scAjaxGetFieldSelect(nomeCampo_anulada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_anulada(var_anulada, var_script_case_init, do_ajax_fac_compras_mob_validate_anulada_cb);
  } // do_ajax_fac_compras_mob_validate_anulada

  function do_ajax_fac_compras_mob_validate_anulada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "anulada";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_anulada_cb

  // ---------- Validate asentada
  function do_ajax_fac_compras_mob_validate_asentada()
  {
    var nomeCampo_asentada = "asentada";
    var var_asentada = scAjaxGetFieldSelect(nomeCampo_asentada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_asentada(var_asentada, var_script_case_init, do_ajax_fac_compras_mob_validate_asentada_cb);
  } // do_ajax_fac_compras_mob_validate_asentada

  function do_ajax_fac_compras_mob_validate_asentada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_asentada_cb

  // ---------- Validate subtotal
  function do_ajax_fac_compras_mob_validate_subtotal()
  {
    var nomeCampo_subtotal = "subtotal";
    var var_subtotal = scAjaxGetFieldHidden(nomeCampo_subtotal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_subtotal(var_subtotal, var_script_case_init, do_ajax_fac_compras_mob_validate_subtotal_cb);
  } // do_ajax_fac_compras_mob_validate_subtotal

  function do_ajax_fac_compras_mob_validate_subtotal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_subtotal_cb

  // ---------- Validate valoriva
  function do_ajax_fac_compras_mob_validate_valoriva()
  {
    var nomeCampo_valoriva = "valoriva";
    var var_valoriva = scAjaxGetFieldHidden(nomeCampo_valoriva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_valoriva(var_valoriva, var_script_case_init, do_ajax_fac_compras_mob_validate_valoriva_cb);
  } // do_ajax_fac_compras_mob_validate_valoriva

  function do_ajax_fac_compras_mob_validate_valoriva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_valoriva_cb

  // ---------- Validate retencion
  function do_ajax_fac_compras_mob_validate_retencion()
  {
    var nomeCampo_retencion = "retencion";
    var var_retencion = scAjaxGetFieldSelect(nomeCampo_retencion);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_retencion(var_retencion, var_script_case_init, do_ajax_fac_compras_mob_validate_retencion_cb);
  } // do_ajax_fac_compras_mob_validate_retencion

  function do_ajax_fac_compras_mob_validate_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_retencion_cb

  // ---------- Validate reteica
  function do_ajax_fac_compras_mob_validate_reteica()
  {
    var nomeCampo_reteica = "reteica";
    var var_reteica = scAjaxGetFieldSelect(nomeCampo_reteica);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_reteica(var_reteica, var_script_case_init, do_ajax_fac_compras_mob_validate_reteica_cb);
  } // do_ajax_fac_compras_mob_validate_reteica

  function do_ajax_fac_compras_mob_validate_reteica_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "reteica";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_reteica_cb

  // ---------- Validate reteiva
  function do_ajax_fac_compras_mob_validate_reteiva()
  {
    var nomeCampo_reteiva = "reteiva";
    var var_reteiva = scAjaxGetFieldText(nomeCampo_reteiva);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_reteiva(var_reteiva, var_script_case_init, do_ajax_fac_compras_mob_validate_reteiva_cb);
  } // do_ajax_fac_compras_mob_validate_reteiva

  function do_ajax_fac_compras_mob_validate_reteiva_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "reteiva";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_reteiva_cb

  // ---------- Validate banco
  function do_ajax_fac_compras_mob_validate_banco()
  {
    var nomeCampo_banco = "banco";
    var var_banco = scAjaxGetFieldSelect(nomeCampo_banco);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_banco(var_banco, var_script_case_init, do_ajax_fac_compras_mob_validate_banco_cb);
  } // do_ajax_fac_compras_mob_validate_banco

  function do_ajax_fac_compras_mob_validate_banco_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "banco";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_banco_cb

  // ---------- Validate idfaccom
  function do_ajax_fac_compras_mob_validate_idfaccom()
  {
    var nomeCampo_idfaccom = "idfaccom";
    var var_idfaccom = scAjaxGetFieldHidden(nomeCampo_idfaccom);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_idfaccom(var_idfaccom, var_script_case_init, do_ajax_fac_compras_mob_validate_idfaccom_cb);
  } // do_ajax_fac_compras_mob_validate_idfaccom

  function do_ajax_fac_compras_mob_validate_idfaccom_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_idfaccom_cb

  // ---------- Validate detalle
  function do_ajax_fac_compras_mob_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_detalle(var_detalle, var_script_case_init, do_ajax_fac_compras_mob_validate_detalle_cb);
  } // do_ajax_fac_compras_mob_validate_detalle

  function do_ajax_fac_compras_mob_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_detalle_cb

  // ---------- Validate hdetalle
  function do_ajax_fac_compras_mob_validate_hdetalle()
  {
    var nomeCampo_hdetalle = "hdetalle";
    var var_hdetalle = scAjaxGetFieldText(nomeCampo_hdetalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_hdetalle(var_hdetalle, var_script_case_init, do_ajax_fac_compras_mob_validate_hdetalle_cb);
  } // do_ajax_fac_compras_mob_validate_hdetalle

  function do_ajax_fac_compras_mob_validate_hdetalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_hdetalle_cb

  // ---------- Validate prefijo_delpedido
  function do_ajax_fac_compras_mob_validate_prefijo_delpedido()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_prefijo_delpedido(var_prefijo_delpedido, var_script_case_init, do_ajax_fac_compras_mob_validate_prefijo_delpedido_cb);
  } // do_ajax_fac_compras_mob_validate_prefijo_delpedido

  function do_ajax_fac_compras_mob_validate_prefijo_delpedido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_prefijo_delpedido_cb

  // ---------- Validate observaciones
  function do_ajax_fac_compras_mob_validate_observaciones()
  {
    var nomeCampo_observaciones = "observaciones";
    var var_observaciones = scAjaxGetFieldText(nomeCampo_observaciones);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_observaciones(var_observaciones, var_script_case_init, do_ajax_fac_compras_mob_validate_observaciones_cb);
  } // do_ajax_fac_compras_mob_validate_observaciones

  function do_ajax_fac_compras_mob_validate_observaciones_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_observaciones_cb

  // ---------- Validate control
  function do_ajax_fac_compras_mob_validate_control()
  {
    var nomeCampo_control = "control";
    var var_control = scAjaxGetFieldText(nomeCampo_control);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_control(var_control, var_script_case_init, do_ajax_fac_compras_mob_validate_control_cb);
  } // do_ajax_fac_compras_mob_validate_control

  function do_ajax_fac_compras_mob_validate_control_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "control";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_control_cb

  // ---------- Validate usuario
  function do_ajax_fac_compras_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_fac_compras_mob_validate_usuario_cb);
  } // do_ajax_fac_compras_mob_validate_usuario

  function do_ajax_fac_compras_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_usuario_cb

  // ---------- Validate cod_cuenta
  function do_ajax_fac_compras_mob_validate_cod_cuenta()
  {
    var nomeCampo_cod_cuenta = "cod_cuenta";
    var var_cod_cuenta = scAjaxGetFieldText(nomeCampo_cod_cuenta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_cod_cuenta(var_cod_cuenta, var_script_case_init, do_ajax_fac_compras_mob_validate_cod_cuenta_cb);
  } // do_ajax_fac_compras_mob_validate_cod_cuenta

  function do_ajax_fac_compras_mob_validate_cod_cuenta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_cod_cuenta_cb

  // ---------- Validate creado
  function do_ajax_fac_compras_mob_validate_creado()
  {
    var nomeCampo_creado = "creado";
    var var_creado = scAjaxGetFieldText(nomeCampo_creado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_creado(var_creado, var_script_case_init, do_ajax_fac_compras_mob_validate_creado_cb);
  } // do_ajax_fac_compras_mob_validate_creado

  function do_ajax_fac_compras_mob_validate_creado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "creado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_creado_cb

  // ---------- Validate editado
  function do_ajax_fac_compras_mob_validate_editado()
  {
    var nomeCampo_editado = "editado";
    var var_editado = scAjaxGetFieldText(nomeCampo_editado);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_fac_compras_mob_validate_editado(var_editado, var_script_case_init, do_ajax_fac_compras_mob_validate_editado_cb);
  } // do_ajax_fac_compras_mob_validate_editado

  function do_ajax_fac_compras_mob_validate_editado_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "editado";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_fac_compras_mob_validate_editado_cb

  // ---------- Event onchange asentada
  function do_ajax_fac_compras_mob_event_asentada_onchange()
  {
  ...
  function do_ajax_fac_compras_mob_event_asentada_onchange_cb(sResp)
  {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_fac_compras_mob_event_asentada_onchange_cb_after_alert);
  } // do_ajax_fac_compras_mob_event_asentada_onchange_cb
  function do_ajax_fac_compras_mob_event_asentada_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_fac_compras_mob_event_asentada_onchange_cb_after_alert

  // ---------- Event onclick hdetalle
  function do_ajax_fac_compras_mob_event_hdetalle_onclick()
  {
    var var_idfaccom = scAjaxGetFieldHidden("idfaccom");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_fac_compras_mob_event_hdetalle_onclick(var_idfaccom, var_script_case_init, do_ajax_fac_compras_mob_event_hdetalle_onclick_cb);
  } // do_ajax_fac_compras_mob_event_hdetalle_onclick

  function do_ajax_fac_compras_mob_event_hdetalle_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "hdetalle";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_fac_compras_mob_event_hdetalle_onclick_cb_after_alert);
  } // do_ajax_fac_compras_mob_event_hdetalle_onclick_cb
  function do_ajax_fac_compras_mob_event_hdetalle_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_fac_compras_mob_event_hdetalle_onclick_cb_after_alert

  // ---------- Event onfocus hdetalle
  function do_ajax_fac_compras_mob_event_hdetalle_onfocus()
  {
    var var_idfaccom = scAjaxGetFieldHidden("idfaccom");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_fac_compras_mob_event_hdetalle_onfocus(var_idfaccom, var_script_case_init, do_ajax_fac_compras_mob_event_hdetalle_onfocus_cb);
  } // do_ajax_fac_compras_mob_event_hdetalle_onfocus

  function do_ajax_fac_compras_mob_event_hdetalle_onfocus_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    sFieldValid = "hdetalle";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_fac_compras_mob_event_hdetalle_onfocus_cb_after_alert);
  } // do_ajax_fac_compras_mob_event_hdetalle_onfocus_cb
  function do_ajax_fac_compras_mob_event_hdetalle_onfocus_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_fac_compras_mob_event_hdetalle_onfocus_cb_after_alert

  // ---------- Event onchange id_pedidocom
  function do_ajax_fac_compras_mob_event_id_pedidocom_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_fac_compras_mob_event_id_pedidocom_onchange(var_id_pedidocom, var_idprov, var_prefijo_delpedido, var_observaciones, var_formapago, var_subtotal, var_valoriva, var_total, var_saldo, var_script_case_init, do_ajax_fac_compras_mob_event_id_pedidocom_onchange_cb);
  } // do_ajax_fac_compras_mob_event_id_pedidocom_onchange

  function do_ajax_fac_compras_mob_event_id_pedidocom_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "id_pedidocom";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_fac_compras_mob_event_id_pedidocom_onchange_cb_after_alert);
  } // do_ajax_fac_compras_mob_event_id_pedidocom_onchange_cb
  function do_ajax_fac_compras_mob_event_id_pedidocom_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_fac_compras_mob_event_id_pedidocom_onchange_cb_after_alert

  // ---------- Event onchange idprov
  function do_ajax_fac_compras_mob_event_idprov_onchange()
  {
    var var_idprov = scAjaxGetFieldText("id_ac_idprov");
    var var_fechacom = scAjaxGetFieldText("fechacom");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_fac_compras_mob_event_idprov_onchange(var_idprov, var_fechacom, var_fechavenc, var_formapago, var_script_case_init, do_ajax_fac_compras_mob_event_idprov_onchange_cb);
  } // do_ajax_fac_compras_mob_event_idprov_onchange

  function do_ajax_fac_compras_mob_event_idprov_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idprov";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_fac_compras_mob_event_idprov_onchange_cb_after_alert);
  } // do_ajax_fac_compras_mob_event_idprov_onchange_cb
  function do_ajax_fac_compras_mob_event_idprov_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_fac_compras_mob_event_idprov_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_fac_compras_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_fac_compras_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_fac_compras_mob_submit_form(var_es_remision, var_id_pedidocom, var_numfacom, var_fechacom, var_idprov, var_formapago, var_fechavenc, var_total, var_saldo, var_pagada, var_anulada, var_asentada, var_subtotal, var_valoriva, var_retencion, var_reteica, var_reteiva, var_banco, var_idfaccom, var_hdetalle, var_prefijo_delpedido, var_observaciones, var_control, var_usuario, var_cod_cuenta, var_creado, var_editado, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_fac_compras_mob_submit_form_cb);
  } // do_ajax_fac_compras_mob_submit_form

  function do_ajax_fac_compras_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_fac_compras_mob_submit_form_cb_after_alert);
  } // do_ajax_fac_compras_mob_submit_form_cb
  function do_ajax_fac_compras_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_fac_compras_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_detallecompra_fac"] = "off";

  function do_ajax_fac_compras_mob_navigate_form()
  {
    perform_ajax_fac_compras_mob_navigate_form();
  }

  function perform_ajax_fac_compras_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_detallecompra_fac"] = "on";
    x_ajax_fac_compras_mob_navigate_form(var_idfaccom, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_fac_compras_mob_navigate_form_cb);
  } // do_ajax_fac_compras_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_fac_compras_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_detallecompra_fac"] && "nmsc_iframe_liga_grid_detallecompra_fac" != scMasterDetailIframe["nmsc_iframe_liga_grid_detallecompra_fac"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_detallecompra_fac"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_detallecompra_fac').contentWindow.nm_move('apl_detalhe', true, '600');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_fac_compras_mob_navigate_form_cb_after_alert);
  } // do_ajax_fac_compras_mob_navigate_form_cb
  function do_ajax_fac_compras_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_fac_compras_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
    scAjaxProcOff();
  } // do_ajax_fac_compras_mob_navigate_form_cb_after_alert
  function sc_hide_fac_compras_mob_form()
  {
  ...
  function do_ajax_fac_compras_mob_lkpedt_refresh_idprov()
  {
    var var_idprov = scAjaxGetFieldText("idprov");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "idprov";
    x_ajax_fac_compras_mob_lkpedt_refresh_idprov(var_idprov, nmgp_refresh_fields, var_script_case_init, do_ajax_fac_compras_mob_lkpedt_refresh_idprov_cb);
  } // do_ajax_fac_compras_mob_lkpedt_refresh_idprov

  function do_ajax_fac_compras_mob_lkpedt_refresh_idprov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_fac_compras_mob_lkpedt_refresh_idprov_cb

  function do_ajax_fac_compras_mob_lkpedt_refresh_retencion()
  {
    var var_retencion = scAjaxGetFieldSelect("retencion");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "retencion";
    x_ajax_fac_compras_mob_lkpedt_refresh_retencion(var_retencion, nmgp_refresh_fields, var_script_case_init, do_ajax_fac_compras_mob_lkpedt_refresh_retencion_cb);
  } // do_ajax_fac_compras_mob_lkpedt_refresh_retencion

  function do_ajax_fac_compras_mob_lkpedt_refresh_retencion_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_fac_compras_mob_lkpedt_refresh_retencion_cb

  function do_ajax_fac_compras_mob_lkpedt_refresh_reteica()
  {
    var var_reteica = scAjaxGetFieldSelect("reteica");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "reteica";
    x_ajax_fac_compras_mob_lkpedt_refresh_reteica(var_reteica, nmgp_refresh_fields, var_script_case_init, do_ajax_fac_compras_mob_lkpedt_refresh_reteica_cb);
  } // do_ajax_fac_compras_mob_lkpedt_refresh_reteica

  function do_ajax_fac_compras_mob_lkpedt_refresh_reteica_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_fac_compras_mob_lkpedt_refresh_reteica_cb
  ...
  {
    if ("off" == scStatusDetail["grid_detallecompra_fac"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[2] = "numfacom";
  ajax_field_list[3] = "fechacom";
  ajax_field_list[4] = "idprov";
  ajax_field_list[5] = "formapago";
  ajax_field_list[6] = "fechavenc";
  ajax_field_list[7] = "total";
  ajax_field_list[8] = "saldo";
  ajax_field_list[9] = "pagada";
  ajax_field_list[10] = "anulada";
  ajax_field_list[11] = "asentada";
  ajax_field_list[12] = "subtotal";
  ajax_field_list[13] = "valoriva";
  ajax_field_list[14] = "retencion";
  ajax_field_list[15] = "reteica";
  ajax_field_list[16] = "reteiva";
  ajax_field_list[17] = "banco";
  ajax_field_list[18] = "idfaccom";
  ajax_field_list[19] = "detalle";
  ajax_field_list[20] = "hdetalle";
  ajax_field_list[21] = "prefijo_delpedido";
  ajax_field_list[22] = "observaciones";
  ajax_field_list[23] = "control";
  ajax_field_list[24] = "usuario";
  ajax_field_list[25] = "cod_cuenta";
  ajax_field_list[26] = "creado";
  ajax_field_list[27] = "editado";
  ...
  var ajax_error_list = {
    "es_remision": {"label": "DOCUMENTO ES REMISIÓN?:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "numfacom": {"label": "NÚMERO DE  FACTURA O DOCUMENTO DE COMPRA:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "total": {"label": "COSTO TOTAL DE LA COMPRA:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "valoriva": {"label": "IVA DE LA COMPRA:", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
