...
function scEventControl_init(iSeqRow) {
  ...
  scEventControl_data["hdetalle" + iSeqRow] = {"blur": false, "change": false, "autocomp": false, "original": "", "calculated": ""};
...
function scEventControl_active(iSeqRow) {
  ...
  if (scEventControl_data["hdetalle" + iSeqRow]["blur"]) {
    return true;
  }
  if (scEventControl_data["hdetalle" + iSeqRow]["change"]) {
    return true;
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idfaccom' + iSeqRow).bind('blur', function() { sc_fac_compras_idfaccom_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_idfaccom_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_idfaccom_onfocus(this, iSeqRow) });
  $('#id_sc_field_numfacom' + iSeqRow).bind('blur', function() { sc_fac_compras_numfacom_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_numfacom_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_numfacom_onfocus(this, iSeqRow) });
  $('#id_sc_field_formapago' + iSeqRow).bind('blur', function() { sc_fac_compras_formapago_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_fac_compras_formapago_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_formapago_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechacom' + iSeqRow).bind('blur', function() { sc_fac_compras_fechacom_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_fechacom_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_fechacom_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechavenc' + iSeqRow).bind('blur', function() { sc_fac_compras_fechavenc_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_fac_compras_fechavenc_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_fechavenc_onfocus(this, iSeqRow) });
  $('#id_sc_field_idprov' + iSeqRow).bind('blur', function() { sc_fac_compras_idprov_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_fac_compras_idprov_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_idprov_onfocus(this, iSeqRow) });
  $('#id_sc_field_subtotal' + iSeqRow).bind('blur', function() { sc_fac_compras_subtotal_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_subtotal_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_subtotal_onfocus(this, iSeqRow) });
  $('#id_sc_field_valoriva' + iSeqRow).bind('blur', function() { sc_fac_compras_valoriva_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_valoriva_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_valoriva_onfocus(this, iSeqRow) });
  $('#id_sc_field_total' + iSeqRow).bind('blur', function() { sc_fac_compras_total_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_fac_compras_total_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_total_onfocus(this, iSeqRow) });
  $('#id_sc_field_pagada' + iSeqRow).bind('blur', function() { sc_fac_compras_pagada_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_fac_compras_pagada_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_pagada_onfocus(this, iSeqRow) });
  $('#id_sc_field_asentada' + iSeqRow).bind('blur', function() { sc_fac_compras_asentada_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_asentada_onchange(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_asentada_onfocus(this, iSeqRow) });
  $('#id_sc_field_control' + iSeqRow).bind('blur', function() { sc_fac_compras_control_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_control_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_control_onfocus(this, iSeqRow) });
  $('#id_sc_field_observaciones' + iSeqRow).bind('blur', function() { sc_fac_compras_observaciones_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_fac_compras_observaciones_onchange(this, iSeqRow) })
                                           .bind('focus', function() { sc_fac_compras_observaciones_onfocus(this, iSeqRow) });
  $('#id_sc_field_saldo' + iSeqRow).bind('blur', function() { sc_fac_compras_saldo_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_fac_compras_saldo_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_saldo_onfocus(this, iSeqRow) });
  $('#id_sc_field_anulada' + iSeqRow).bind('blur', function() { sc_fac_compras_anulada_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_anulada_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_anulada_onfocus(this, iSeqRow) });
  $('#id_sc_field_es_remision' + iSeqRow).bind('blur', function() { sc_fac_compras_es_remision_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_fac_compras_es_remision_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_es_remision_onfocus(this, iSeqRow) });
  $('#id_sc_field_id_pedidocom' + iSeqRow).bind('blur', function() { sc_fac_compras_id_pedidocom_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_fac_compras_id_pedidocom_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_fac_compras_id_pedidocom_onfocus(this, iSeqRow) });
  $('#id_sc_field_retencion' + iSeqRow).bind('blur', function() { sc_fac_compras_retencion_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_fac_compras_retencion_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_fac_compras_retencion_onfocus(this, iSeqRow) });
  $('#id_sc_field_reteica' + iSeqRow).bind('blur', function() { sc_fac_compras_reteica_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_reteica_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_reteica_onfocus(this, iSeqRow) });
  $('#id_sc_field_reteiva' + iSeqRow).bind('blur', function() { sc_fac_compras_reteiva_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_reteiva_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_reteiva_onfocus(this, iSeqRow) });
  $('#id_sc_field_usuario' + iSeqRow).bind('blur', function() { sc_fac_compras_usuario_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_usuario_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_usuario_onfocus(this, iSeqRow) });
  $('#id_sc_field_banco' + iSeqRow).bind('blur', function() { sc_fac_compras_banco_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_fac_compras_banco_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_fac_compras_banco_onfocus(this, iSeqRow) });
  $('#id_sc_field_num_ndevolucion' + iSeqRow).bind('change', function() { sc_fac_compras_num_ndevolucion_onchange(this, iSeqRow) });
  $('#id_sc_field_creado' + iSeqRow).bind('blur', function() { sc_fac_compras_creado_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_fac_compras_creado_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_fac_compras_creado_onfocus(this, iSeqRow) });
  $('#id_sc_field_creado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_creado_hora_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_fac_compras_creado_hora_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_fac_compras_creado_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_editado' + iSeqRow).bind('blur', function() { sc_fac_compras_editado_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_editado_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_editado_onfocus(this, iSeqRow) });
  $('#id_sc_field_editado_hora' + iSeqRow).bind('blur', function() { sc_fac_compras_editado_hora_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_fac_compras_editado_hora_onchange(this, iSeqRow) })
                                          .bind('focus', function() { sc_fac_compras_editado_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_cod_cuenta' + iSeqRow).bind('blur', function() { sc_fac_compras_cod_cuenta_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_fac_compras_cod_cuenta_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_fac_compras_cod_cuenta_onfocus(this, iSeqRow) });
  $('#id_sc_field_detalle' + iSeqRow).bind('blur', function() { sc_fac_compras_detalle_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_fac_compras_detalle_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_fac_compras_detalle_onfocus(this, iSeqRow) });
  $('#id_sc_field_hdetalle' + iSeqRow).bind('blur', function() { sc_fac_compras_hdetalle_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_fac_compras_hdetalle_onchange(this, iSeqRow) })
                                      .bind('click', function() { sc_fac_compras_hdetalle_onclick(this, iSeqRow) })
                                      .bind('focus', function() { sc_fac_compras_hdetalle_onfocus(this, iSeqRow) });
  $('#id_sc_field_prefijo_delpedido' + iSeqRow).bind('blur', function() { sc_fac_compras_prefijo_delpedido_onblur(this, iSeqRow) })
                                               .bind('change', function() { sc_fac_compras_prefijo_delpedido_onchange(this, iSeqRow) })
                                               .bind('focus', function() { sc_fac_compras_prefijo_delpedido_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_fac_compras_idfaccom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_idfaccom();
  scCssBlur(oThis);
}

function sc_fac_compras_idfaccom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_idfaccom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_numfacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_numfacom();
  scCssBlur(oThis);
}

function sc_fac_compras_numfacom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_numfacom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_formapago_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_formapago();
  scCssBlur(oThis);
}

function sc_fac_compras_formapago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_formapago_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_fechacom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_fechacom();
  scCssBlur(oThis);
}

function sc_fac_compras_fechacom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_fechacom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_fechavenc_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_fechavenc();
  scCssBlur(oThis);
}

function sc_fac_compras_fechavenc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_fechavenc_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_idprov_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_idprov();
  scCssBlur(oThis);
}

function sc_fac_compras_idprov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_fac_compras_event_idprov_onchange();
}

function sc_fac_compras_idprov_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}

function sc_fac_compras_subtotal_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_subtotal();
  scCssBlur(oThis);
}

function sc_fac_compras_subtotal_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_subtotal_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_valoriva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_valoriva();
  scCssBlur(oThis);
}

function sc_fac_compras_valoriva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_valoriva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_total_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_total();
  scCssBlur(oThis);
}

function sc_fac_compras_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_total_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_pagada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_pagada();
  scCssBlur(oThis);
}

function sc_fac_compras_pagada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_pagada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_asentada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_asentada();
  scCssBlur(oThis);
}

function sc_fac_compras_asentada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_fac_compras_event_asentada_onchange();
}

function sc_fac_compras_asentada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_control_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_control();
  scCssBlur(oThis);
}

function sc_fac_compras_control_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_control_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_observaciones_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_observaciones();
  scCssBlur(oThis);
}

function sc_fac_compras_observaciones_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_observaciones_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_saldo_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_saldo();
  scCssBlur(oThis);
}

function sc_fac_compras_saldo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_saldo_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_anulada_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_anulada();
  scCssBlur(oThis);
}

function sc_fac_compras_anulada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_anulada_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_es_remision_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_es_remision();
  scCssBlur(oThis);
}

function sc_fac_compras_es_remision_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_es_remision_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_id_pedidocom_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_id_pedidocom();
  scCssBlur(oThis);
}

function sc_fac_compras_id_pedidocom_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
  do_ajax_fac_compras_event_id_pedidocom_onchange();
}

function sc_fac_compras_id_pedidocom_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_retencion_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_retencion();
  scCssBlur(oThis);
}

function sc_fac_compras_retencion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_retencion_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_reteica_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_reteica();
  scCssBlur(oThis);
}

function sc_fac_compras_reteica_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_reteica_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_reteiva_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_reteiva();
  scCssBlur(oThis);
}

function sc_fac_compras_reteiva_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_reteiva_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_usuario_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_usuario();
  scCssBlur(oThis);
}

function sc_fac_compras_usuario_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_usuario_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_banco_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_banco();
  scCssBlur(oThis);
}

function sc_fac_compras_banco_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_banco_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_num_ndevolucion_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_creado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_creado();
  scCssBlur(oThis);
}

function sc_fac_compras_creado_hora_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_creado();
  scCssBlur(oThis);
}

function sc_fac_compras_creado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_creado_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_creado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_creado_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_editado_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_editado();
  scCssBlur(oThis);
}

function sc_fac_compras_editado_hora_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_editado();
  scCssBlur(oThis);
}

function sc_fac_compras_editado_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_editado_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_editado_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_editado_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_cod_cuenta_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_cod_cuenta();
  scCssBlur(oThis);
}

function sc_fac_compras_cod_cuenta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_cod_cuenta_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_detalle_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_detalle();
  scCssBlur(oThis);
}

function sc_fac_compras_detalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_detalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_fac_compras_hdetalle_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_hdetalle();
  scCssBlur(oThis);
}

function sc_fac_compras_hdetalle_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_hdetalle_onclick(oThis, iSeqRow) {
  do_ajax_fac_compras_event_hdetalle_onclick();
}

function sc_fac_compras_hdetalle_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
  do_ajax_fac_compras_event_hdetalle_onfocus();
}

function sc_fac_compras_prefijo_delpedido_onblur(oThis, iSeqRow) {
  do_ajax_fac_compras_validate_prefijo_delpedido();
  scCssBlur(oThis);
}

function sc_fac_compras_prefijo_delpedido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_fac_compras_prefijo_delpedido_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function displayChange_block_4(status) {
	...
	displayChange_field("hdetalle", "", status);
}
...
function displayChange_row(row, status) {
	...
	displayChange_field_hdetalle(row, status);
...
function displayChange_field_detalle(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_grid_detallecompra_fac")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_grid_detallecompra_fac")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_hdetalle(row, status) {
}
...
function scHidePage(pageNo) {
	$("#id_fac_compras_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_fechacom" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_validate_fechacom(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_fechavenc" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_validate_fechavenc(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_creado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_validate_creado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_editado" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_fac_compras_validate_editado(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'fac_compras')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
