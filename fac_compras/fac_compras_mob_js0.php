...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="fac_compras_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_Eliminar_ok()
{
    ...
    document.F1.action = "fac_compras_mob.php";
...
{ 
   var sob_iframe = '';
<?php 
if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['embutida_form']) {
...
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['sc_modal']) {
    echo "   sob_iframe += 'parent.';\r\n";
}
?>
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras_mob']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_fac_compras_mob_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_fac_compras_mob_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
