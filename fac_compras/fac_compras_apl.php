...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['fac_compras']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['fac_compras']['opc_ant'] = "inicio";
      }
      ...
      $_SESSION['scriptcase']['error_icon']['fac_compras']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
