...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['fac_compras']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['fac_compras']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['fac_compras']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['fac_compras']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['fac_compras']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['fac_compras']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->par_idfaccom)) 
          {
              $_SESSION['par_idfaccom'] = $this->par_idfaccom;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['fac_compras']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['fac_compras']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['fac_compras']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['fac_compras']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['fac_compras']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['fac_compras']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['fac_compras']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['fac_compras']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['fac_compras']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new fac_compras_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("es");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("es");
      } 
      $_SESSION['sc_session'][$script_case_init]['fac_compras']['upload_field_info'] = array();
      ...
      if (isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_modal']))
      {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['fac_compras']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['fac_compras'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['fac_compras']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['fac_compras']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('fac_compras') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['fac_compras']['label'] = "Editar Compra";
      ...
      $_SESSION['scriptcase']['error_icon']['fac_compras']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Lemon__NM__nm_scriptcase9_Lemon_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['fac_compras'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['fac_compras']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['fac_compras'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['fac_compras'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("fac_compras", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'fac_compras/fac_compras_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'fac_compras_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'fac_compras_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'fac_compras_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'fac_compras/fac_compras_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "fac_compras_erro.class.php"); 
      }
      $this->Erro      = new fac_compras_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao']))
         { 
             if ($this->idfaccom != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['fac_compras']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opc_ant'];
      } 
      ...
      {
          $this->nmgp_botoes['Eliminar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['botoes']['Eliminar'];
          $this->nmgp_botoes['sc_btn_0'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['botoes']['sc_btn_0'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['final'];
      }
      else
      {
      }
...
//
      ...
      $this->sc_insert_on = false;
            ...
            $out1_img_cache = $_SESSION['scriptcase']['fac_compras']['glo_nm_path_imag_temp'] . $file_name;
            $orig_img = $_SESSION['scriptcase']['fac_compras']['glo_nm_path_imag_temp']. '/sc_'.md5(date('YmdHis').basename($_POST['AjaxCheckImg'])).'.gif';
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select'];
     }
   }
...
//
   ...
   $nm_nao_carga = false;
   $nmgp_def_dados = "" ; 
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_idprov']))
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_idprov'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_idprov']); 
   }
   else
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_idprov'] = array(); 
    }
   ...
   if ($nm_comando != "" && $rs = $this->Db->SelectLimit($nm_comando, 10, 0))
   {
       ...
       { 
              ...
              $aLookup[] = array(fac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', fac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_idprov'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['anulada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->anulada = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['anulada'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['observaciones']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->observaciones = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['observaciones'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['banco']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->banco = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['banco'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['credito']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->credito = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['credito'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['fechavenc']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechavenc = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['fechavenc'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['pagada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['pagada'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['id_pedidocom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->id_pedidocom = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['id_pedidocom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['es_remision']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->es_remision = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['es_remision'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['idprov']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['idprov'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['fechacom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->fechacom = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['fechacom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['numfacom']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->numfacom = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['numfacom'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['formapago']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->formapago = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['formapago'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['asentada']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select']['asentada'];
          } 
          $nm_sc_sv_opcao = $this->nmgp_opcao; 
          $this->nmgp_opcao = "nada"; 
          $this->nm_acessa_banco();
    if ('recarga' == $nm_sc_sv_opcao) {
      $_SESSION['scriptcase']['fac_compras']['contr_erro'] = 'on';
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "fac_compras.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="fac_compras_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="fac_compras"> 
...
<?php
include_once("fac_compras_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->idfaccom) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form']['idfaccom']))
          {
              $varloc_btn_php['idfaccom'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form']['idfaccom'];
          }
          if (!isset($this->total) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form']['total']))
          {
              $varloc_btn_php['total'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form']['total'];
          }
          if (!isset($this->numfacom) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form']['numfacom']))
          {
              $varloc_btn_php['numfacom'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form']['numfacom'];
          }
      }
      $nm_f_saida = "./";
...
if ($this->total <>0)
 ...
 {
  $sErrorIndex = ('submit_form' == $this->NM_ajax_opcao) ? 'geral_fac_compras' : substr(substr($this->NM_ajax_opcao, 0, strrpos($this->NM_ajax_opcao, '_')), 6);
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_fac_compras']) || !is_array($this->NM_ajax_info['errList']['geral_fac_compras']))
              {
                  $this->NM_ajax_info['errList']['geral_fac_compras'] = array();
              }
              $this->NM_ajax_info['errList']['geral_fac_compras'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      if ('' == $filtro || 'es_remision' == $filtro)
        $this->ValidateField_es_remision($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'id_pedidocom' == $filtro)
        $this->ValidateField_id_pedidocom($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'numfacom' == $filtro)
        $this->ValidateField_numfacom($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'fechacom' == $filtro)
        $this->ValidateField_fechacom($Campos_Crit, $Campos_Falta, $Campos_Erros);
      if ('' == $filtro || 'idprov' == $filtro)
...
//---
    ...
    function ValidateField_id_pedidocom(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->id_pedidocom) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_id_pedidocom']) && !in_array($this->id_pedidocom, $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_id_pedidocom']))
               {
                   $hasError = true;
    ...
    function ValidateField_numfacom(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['php_cmp_required']['numfacom']) || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['php_cmp_required']['numfacom'] == "on")) 
      { 
          if ($this->numfacom == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_idprov(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['php_cmp_required']['idprov']) || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['php_cmp_required']['idprov'] == "on")) 
      { 
          if ($this->idprov == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_retencion(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->retencion) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_retencion']) && !in_array($this->retencion, $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_retencion']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_reteica(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->reteica) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_reteica']) && !in_array($this->reteica, $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_reteica']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_banco(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->banco) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_banco']) && !in_array($this->banco, $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_banco']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idfaccom']['keyVal'] = fac_compras_pack_protect_string($this->nmgp_dados_form['idfaccom']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['grid_detallecompra_fac_script_case_init'] ]['grid_detallecompra_fac']['embutida_form_full'] = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['grid_detallecompra_fac_script_case_init'] ]['grid_detallecompra_fac']['embutida_form']       = true;
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['grid_detallecompra_fac_script_case_init'] ]['grid_detallecompra_fac']['embutida_pai']        = "fac_compras";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['grid_detallecompra_fac_script_case_init'] ]['grid_detallecompra_fac']['embutida_form_parms'] = "par_idfaccom*scin" . $this->nmgp_dados_form['idfaccom'] . "*scoutNMSC_inicial*scininicio*scoutNMSC_paginacao*scinFULL*scout";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['grid_detallecompra_fac_script_case_init'] ]['grid_detallecompra_fac']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['grid_detallecompra_fac_script_case_init'] ]['grid_detallecompra_fac']['total']);
          }
   } // ajax_return_values
...
$aLookup[] = array(fac_compras_pack_protect_string('NO') => str_replace('<', '&lt;',fac_compras_pack_protect_string("NO")));
$aLookup[] = array(fac_compras_pack_protect_string('SI') => str_replace('<', '&lt;',fac_compras_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_es_remision'][] = 'NO';
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_es_remision'][] = 'SI';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['es_remision']['valList'][$i] = fac_compras_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_id_pedidocom']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_id_pedidocom'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_id_pedidocom']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_id_pedidocom'] = array(); 
}
$aLookup[] = array(fac_compras_pack_protect_string('0') => str_replace('<', '&lt;',fac_compras_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_id_pedidocom'][] = '0';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_id_pedidocom'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['id_pedidocom']['valList'][$i] = fac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          $val_output = isset($aLookup[0][fac_compras_pack_protect_string(NM_charset_to_utf8($this->idprov))]) ? $aLookup[0][fac_compras_pack_protect_string(NM_charset_to_utf8($this->idprov))] : "";
...
$aLookup[] = array(fac_compras_pack_protect_string('CONTADO') => str_replace('<', '&lt;',fac_compras_pack_protect_string("CONTADO")));
$aLookup[] = array(fac_compras_pack_protect_string('CRÉDITO') => str_replace('<', '&lt;',fac_compras_pack_protect_string("CRÉDITO")));
$aLookup[] = array(fac_compras_pack_protect_string('DEPÓSITO') => str_replace('<', '&lt;',fac_compras_pack_protect_string("DEPOSITO")));
$aLookup[] = array(fac_compras_pack_protect_string('OTRO') => str_replace('<', '&lt;',fac_compras_pack_protect_string("OTRO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_formapago'][] = 'CONTADO';
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_formapago'][] = 'CRÉDITO';
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_formapago'][] = 'DEPÓSITO';
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_formapago'][] = 'OTRO';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['formapago']['valList'][$i] = fac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(fac_compras_pack_protect_string('') => str_replace('<', '&lt;',fac_compras_pack_protect_string("")));
$aLookup[] = array(fac_compras_pack_protect_string('DEVUELTA') => str_replace('<', '&lt;',fac_compras_pack_protect_string("DEVUELTA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_anulada'][] = '';
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_anulada'][] = 'DEVUELTA';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['anulada']['valList'][$i] = fac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(fac_compras_pack_protect_string('0') => str_replace('<', '&lt;',fac_compras_pack_protect_string("NO")));
$aLookup[] = array(fac_compras_pack_protect_string('1') => str_replace('<', '&lt;',fac_compras_pack_protect_string("SI")));
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_asentada'][] = '0';
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_asentada'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['asentada']['valList'][$i] = fac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_retencion']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_retencion'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_retencion']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_retencion'] = array(); 
}
$aLookup[] = array(fac_compras_pack_protect_string('0.00') => str_replace('<', '&lt;',fac_compras_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_retencion'][] = '0.00';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (strpos(strtolower($rs->fields[0]), "e")) ? (float)$rs->fields[0] : $rs->fields[0];
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(fac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', fac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_retencion'][] = $rs->fields[0];
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['retencion']['valList'][$i] = fac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_reteica']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_reteica'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_reteica']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_reteica'] = array(); 
}
$aLookup[] = array(fac_compras_pack_protect_string('0.00') => str_replace('<', '&lt;',fac_compras_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_reteica'][] = '0.00';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $rs->fields[0] = (string)$rs->fields[0];
              $aLookup[] = array(fac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', fac_compras_pack_protect_string(NM_charset_to_utf8($rs->fields[0]))));
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_reteica'][] = $rs->fields[0];
              $nmgp_def_dados .= $rs->fields[0] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $rs->MoveNext() ; 
       } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['reteica']['valList'][$i] = fac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_banco']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_banco'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_banco']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_banco'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['Lookup_banco'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['banco']['valList'][$i] = fac_compras_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_editado($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idfaccom)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
...
$_SESSION['scriptcase']['fac_compras']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] = 0; 
              }
...
$_SESSION['scriptcase']['fac_compras']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['parms'] = "idfaccom?#?$this->idfaccom?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_fac_compras = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total'] = $qt_geral_reg_fac_compras;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->idfaccom))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] = $Count_start;
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_fac_compras = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] > $qt_geral_reg_fac_compras)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] = $qt_geral_reg_fac_compras; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_fac_compras) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] < $qt_geral_reg_fac_compras;
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("fac_compras_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_fac_compras = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['total'] = $qt_geral_reg_fac_compras;
      $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          fac_compras_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "fac_compras_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['nm_run_menu'] = 2;
       $nmgp_saida_form = "fac_compras_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['fac_compras']['retorno_edit'] = "";
   }
