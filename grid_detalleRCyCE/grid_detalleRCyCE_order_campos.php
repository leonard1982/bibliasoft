...
<?php
   ...
   $Ord_Cmp = new grid_detalleRCyCE_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_detalleRCyCE_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['dp_idrc'] = "dp_idrc";
   }
   else
   {
       $tab_def_campos['dp_idrc'] = "dp.idrc";
   }
   $tab_labels["dp_idrc"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_idrc"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_idrc"] : "RC";
   $tab_ger_campos['rc_fecharecibo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rc_fecharecibo'] = "rc_fecharecibo";
   }
   else
   {
       $tab_def_campos['rc_fecharecibo'] = "rc.fecharecibo";
   }
   $tab_labels["rc_fecharecibo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["rc_fecharecibo"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["rc_fecharecibo"] : "Fecha RC";
   $tab_ger_campos['dp_id_pago'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dp_id_pago'] = "dp_id_pago";
   }
   else
   {
       $tab_def_campos['dp_id_pago'] = "dp.id_pago";
   }
   $tab_labels["dp_id_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_id_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_id_pago"] : "CE";
   $tab_ger_campos['p_fecpago'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['p_fecpago'] = "p_fecpago";
   }
   else
   {
       $tab_def_campos['p_fecpago'] = "p.fecpago";
   }
   $tab_labels["p_fecpago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["p_fecpago"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["p_fecpago"] : "Fecha CE";
   $tab_ger_campos['dp_idfp'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dp_idfp'] = "dp_idfp";
   }
   else
   {
       $tab_def_campos['dp_idfp'] = "dp.idfp";
   }
   $tab_labels["dp_idfp"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_idfp"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_idfp"] : "Forma de pago";
   $tab_ger_campos['dp_monto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dp_monto'] = "dp_monto";
   }
   else
   {
       $tab_def_campos['dp_monto'] = "dp.monto";
   }
   $tab_labels["dp_monto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_monto"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_monto"] : "Monto";
   $tab_ger_campos['dp_banco'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dp_banco'] = "dp_banco";
   }
   else
   {
       $tab_def_campos['dp_banco'] = "dp.banco";
   }
   $tab_labels["dp_banco"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_banco"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_banco"] : "Banco";
   $tab_ger_campos['dp_numcheque'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dp_numcheque'] = "dp_numcheque";
   }
   else
   {
       $tab_def_campos['dp_numcheque'] = "dp.numcheque";
   }
   $tab_labels["dp_numcheque"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_numcheque"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_numcheque"] : "N° cheque";
   $tab_ger_campos['dp_fechacob'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['dp_fechacob'] = "dp_fechacob";
   }
   else
   {
       $tab_def_campos['dp_fechacob'] = "dp.fechacob";
   }
   $tab_labels["dp_fechacob"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_fechacob"])) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['labels']["dp_fechacob"] : "Fecha Ch.";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_detalleRCyCE_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_detalleRCyCE']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
