<?php
@session_start() ;
$_SESSION['scriptcase']['grid_detalleRCyCE']['sc_process_barr'] = true;
require_once('../grid_detalleRCyCE/index.php');
unset($_SESSION['scriptcase']['grid_detalleRCyCE']['sc_process_barr']);
$ExportCtrl = new grid_detalleRCyCE_export_control;
$ExportCtrl->Export_barr();

class grid_detalleRCyCE_export_control
{
