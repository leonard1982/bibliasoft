...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleRCyCE"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_detalleRCyCE"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleRCyCE']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleRCyCE']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_detalleRCyCE']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_detalleRCyCE']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_detalleRCyCE']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_detalleRCyCE']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_detalleRCyCE']['embutida_filho'] as $ind => $sc_init)
          {
