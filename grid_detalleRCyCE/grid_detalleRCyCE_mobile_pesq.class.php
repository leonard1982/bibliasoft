...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "rc.fecharecibo";$Nm_datas[] = "rc_fecharecibo";$Nm_datas[] = "dp.fechacob";$Nm_datas[] = "dp_fechacob";$Nm_datas[] = "p.fecpago";$Nm_datas[] = "p_fecpago";$Nm_numeric[] = "dp_iddetall";$Nm_numeric[] = "dp_idfact";$Nm_numeric[] = "dp_idrc";$Nm_numeric[] = "dp_idfp";$Nm_numeric[] = "dp_monto";$Nm_numeric[] = "dp_id_pago";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_rc_fecharecibo_cond" name="rc_fecharecibo_cond" onChange="nm_campos_between(document.getElementById('id_vis_rc_fecharecibo'), this, 'rc_fecharecibo')">
      ...
      <br><span id="id_hide_rc_fecharecibo"  <?php echo $str_hide_rc_fecharecibo?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_rc_fecharecibo"  <?php echo $str_display_rc_fecharecibo; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_p_fecpago_cond" name="p_fecpago_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_fecpago'), this, 'p_fecpago')">
      ...
      <br><span id="id_hide_p_fecpago"  <?php echo $str_hide_p_fecpago?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_p_fecpago"  <?php echo $str_display_p_fecpago; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?> 
         <BR>
