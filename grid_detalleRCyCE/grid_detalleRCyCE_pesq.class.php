...
class grid_detalleRCyCE_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_detalleRCyCE_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_detalleRCyCE_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_detalleRCyCE_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "dp_iddetall";$Nm_numeric[] = "dp_idfact";$Nm_numeric[] = "dp_idrc";$Nm_numeric[] = "dp_idfp";$Nm_numeric[] = "dp_monto";$Nm_numeric[] = "dp_id_pago";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "rc.fecharecibo";$Nm_datas[] = "rc_fecharecibo";$Nm_datas[] = "dp.fechacob";$Nm_datas[] = "dp_fechacob";$Nm_datas[] = "p.fecpago";$Nm_datas[] = "p_fecpago";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
<HTML>
<HEAD>
 <TITLE>Detalle Ingresos - Egresos</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_detalleRCyCE/grid_detalleRCyCE_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_detalleRCyCE_ajax_search.js"></script>
 <script type="text/javascript" src="grid_detalleRCyCE_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_detalleRCyCE_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detalleRCyCE']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_detalleRCyCE']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_rc_fecharecibo_cond#NMF#' + search_get_sel_txt('SC_rc_fecharecibo_cond') + '@NMF@';
  str_out += 'SC_rc_fecharecibo_dia#NMF#' + search_get_sel_txt('SC_rc_fecharecibo_dia') + '@NMF@';
  str_out += 'SC_rc_fecharecibo_mes#NMF#' + search_get_sel_txt('SC_rc_fecharecibo_mes') + '@NMF@';
  str_out += 'SC_rc_fecharecibo_ano#NMF#' + search_get_sel_txt('SC_rc_fecharecibo_ano') + '@NMF@';
  str_out += 'SC_rc_fecharecibo_input_2_dia#NMF#' + search_get_sel_txt('SC_rc_fecharecibo_input_2_dia') + '@NMF@';
  str_out += 'SC_rc_fecharecibo_input_2_mes#NMF#' + search_get_sel_txt('SC_rc_fecharecibo_input_2_mes') + '@NMF@';
  str_out += 'SC_rc_fecharecibo_input_2_ano#NMF#' + search_get_sel_txt('SC_rc_fecharecibo_input_2_ano') + '@NMF@';
  str_out += 'SC_p_fecpago_cond#NMF#' + search_get_sel_txt('SC_p_fecpago_cond') + '@NMF@';
  str_out += 'SC_p_fecpago_dia#NMF#' + search_get_sel_txt('SC_p_fecpago_dia') + '@NMF@';
  str_out += 'SC_p_fecpago_mes#NMF#' + search_get_sel_txt('SC_p_fecpago_mes') + '@NMF@';
  str_out += 'SC_p_fecpago_ano#NMF#' + search_get_sel_txt('SC_p_fecpago_ano') + '@NMF@';
  str_out += 'SC_p_fecpago_input_2_dia#NMF#' + search_get_sel_txt('SC_p_fecpago_input_2_dia') + '@NMF@';
  str_out += 'SC_p_fecpago_input_2_mes#NMF#' + search_get_sel_txt('SC_p_fecpago_input_2_mes') + '@NMF@';
  str_out += 'SC_p_fecpago_input_2_ano#NMF#' + search_get_sel_txt('SC_p_fecpago_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Detalle Ingresos - Egresos</span></td>
...
<?php
   ...
   {
      global 
             $rc_fecharecibo_cond, $rc_fecharecibo, $rc_fecharecibo_dia, $rc_fecharecibo_mes, $rc_fecharecibo_ano, $rc_fecharecibo_input_2_dia, $rc_fecharecibo_input_2_mes, $rc_fecharecibo_input_2_ano,
             $p_fecpago_cond, $p_fecpago, $p_fecpago_dia, $p_fecpago_mes, $p_fecpago_ano, $p_fecpago_input_2_dia, $p_fecpago_input_2_mes, $p_fecpago_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $rc_fecharecibo_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_dia']; 
          $rc_fecharecibo_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_mes']; 
          $rc_fecharecibo_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_ano']; 
          $rc_fecharecibo_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_input_2_dia']; 
          $rc_fecharecibo_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_input_2_mes']; 
          $rc_fecharecibo_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_input_2_ano']; 
          $rc_fecharecibo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_cond']; 
          $p_fecpago_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_dia']; 
          $p_fecpago_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_mes']; 
          $p_fecpago_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_ano']; 
          $p_fecpago_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_input_2_dia']; 
          $p_fecpago_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_input_2_mes']; 
          $p_fecpago_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_input_2_ano']; 
          $p_fecpago_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['NM_operador']; 
      } 
      if (!isset($rc_fecharecibo_cond) || empty($rc_fecharecibo_cond))
      {
         $rc_fecharecibo_cond = "eq";
      }
      if (!isset($p_fecpago_cond) || empty($p_fecpago_cond))
      {
         $p_fecpago_cond = "eq";
      }
      ...
      $str_hide_rc_fecharecibo = (in_array($rc_fecharecibo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_p_fecpago = (in_array($p_fecpago_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_rc_fecharecibo = ('bw' == $rc_fecharecibo_cond) ? $display_aberto : $display_fechado;
      $str_display_p_fecpago = ('bw' == $p_fecpago_cond) ? $display_aberto : $display_fechado;

      if (!isset($rc_fecharecibo) || $rc_fecharecibo == "")
      {
          $rc_fecharecibo = "";
      }
      if (isset($rc_fecharecibo) && !empty($rc_fecharecibo))
      {
         $tmp_pos = strpos($rc_fecharecibo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $rc_fecharecibo = substr($rc_fecharecibo, 0, $tmp_pos);
         }
      }
      if (!isset($p_fecpago) || $p_fecpago == "")
      {
          $p_fecpago = "";
      }
      if (isset($p_fecpago) && !empty($p_fecpago))
      {
         $tmp_pos = strpos($p_fecpago, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $p_fecpago = substr($p_fecpago, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_rc_fecharecibo_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['rc_fecharecibo'])) ? $this->New_label['rc_fecharecibo'] : "Fecha RC"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_rc_fecharecibo_cond" name="rc_fecharecibo_cond" onChange="nm_campos_between(document.getElementById('id_vis_rc_fecharecibo'), this, 'rc_fecharecibo')">
       <OPTION value="eq" <?php if ("eq" == $rc_fecharecibo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $rc_fecharecibo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $rc_fecharecibo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $rc_fecharecibo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_rc_fecharecibo" <?php echo $str_hide_rc_fecharecibo?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['rc_fecharecibo'])) ? $this->New_label['rc_fecharecibo'] : "Fecha RC";
 $nmgp_tab_label .= "rc_fecharecibo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<?php
  ...
  {
?>
<span id='id_date_part_rc_fecharecibo_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rc_fecharecibo_dia" name="rc_fecharecibo_dia" value="<?php echo NM_encode_input($rc_fecharecibo_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rc_fecharecibo_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rc_fecharecibo_mes" name="rc_fecharecibo_mes" value="<?php echo NM_encode_input($rc_fecharecibo_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rc_fecharecibo_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rc_fecharecibo_ano" name="rc_fecharecibo_ano" value="<?php echo NM_encode_input($rc_fecharecibo_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_rc_fecharecibo"  class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_rc_fecharecibo"  <?php echo $str_display_rc_fecharecibo; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_rc_fecharecibo_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rc_fecharecibo_input_2_dia" name="rc_fecharecibo_input_2_dia" value="<?php echo NM_encode_input($rc_fecharecibo_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rc_fecharecibo_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rc_fecharecibo_input_2_mes" name="rc_fecharecibo_input_2_mes" value="<?php echo NM_encode_input($rc_fecharecibo_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_rc_fecharecibo_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_rc_fecharecibo_input_2_ano" name="rc_fecharecibo_input_2_ano" value="<?php echo NM_encode_input($rc_fecharecibo_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
      ...
      <TD id='SC_p_fecpago_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['p_fecpago'])) ? $this->New_label['p_fecpago'] : "Fecha CE"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_p_fecpago_cond" name="p_fecpago_cond" onChange="nm_campos_between(document.getElementById('id_vis_p_fecpago'), this, 'p_fecpago')">
       <OPTION value="eq" <?php if ("eq" == $p_fecpago_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="gt" <?php if ("gt" == $p_fecpago_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $p_fecpago_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $p_fecpago_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_p_fecpago" <?php echo $str_hide_p_fecpago?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['p_fecpago'])) ? $this->New_label['p_fecpago'] : "Fecha CE";
 $nmgp_tab_label .= "p_fecpago?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecpago_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_p_fecpago_dia" name="p_fecpago_dia" value="<?php echo NM_encode_input($p_fecpago_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecpago_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_p_fecpago_mes" name="p_fecpago_mes" value="<?php echo NM_encode_input($p_fecpago_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecpago_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_p_fecpago_ano" name="p_fecpago_ano" value="<?php echo NM_encode_input($p_fecpago_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
        <SPAN id="id_css_p_fecpago"  class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_p_fecpago"  <?php echo $str_display_p_fecpago; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecpago_input_2_DD' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_p_fecpago_input_2_dia" name="p_fecpago_input_2_dia" value="<?php echo NM_encode_input($p_fecpago_input_2_dia); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecpago_input_2_MM' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_p_fecpago_input_2_mes" name="p_fecpago_input_2_mes" value="<?php echo NM_encode_input($p_fecpago_input_2_mes); ?>" size="2" alt="{datatype: 'mask', maskList: '99', alignRight: true, maxLength: 2, autoTab: true, enterTab: false}">
</span>
...
<?php
  ...
  {
?>
<span id='id_date_part_p_fecpago_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_p_fecpago_input_2_ano" name="p_fecpago_input_2_ano" value="<?php echo NM_encode_input($p_fecpago_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 </span>
...
?>
<?php
   if (is_file("grid_detalleRCyCE_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_detalleRCyCE']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_detalleRCyCE']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.rc_fecharecibo_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_rc_fecharecibo'), document.F1.rc_fecharecibo_cond, 'rc_fecharecibo');
   document.F1.rc_fecharecibo_dia.value = "";
   document.F1.rc_fecharecibo_mes.value = "";
   document.F1.rc_fecharecibo_ano.value = "";
   document.F1.rc_fecharecibo_input_2_dia.value = "";
   document.F1.rc_fecharecibo_input_2_mes.value = "";
   document.F1.rc_fecharecibo_input_2_ano.value = "";
   document.F1.p_fecpago_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_p_fecpago'), document.F1.p_fecpago_cond, 'p_fecpago');
   document.F1.p_fecpago_dia.value = "";
   document.F1.p_fecpago_mes.value = "";
   document.F1.p_fecpago_ano.value = "";
   document.F1.p_fecpago_input_2_dia.value = "";
   document.F1.p_fecpago_input_2_mes.value = "";
   document.F1.p_fecpago_input_2_ano.value = "";
 }
 function SC_carga_evt_jquery()
 {
    $('#SC_p_fecpago_dia').bind('change', function() {sc_grid_detalleRCyCE_valida_dia(this)});
    $('#SC_p_fecpago_input_2_dia').bind('change', function() {sc_grid_detalleRCyCE_valida_dia(this)});
    $('#SC_p_fecpago_input_2_mes').bind('change', function() {sc_grid_detalleRCyCE_valida_mes(this)});
    $('#SC_p_fecpago_mes').bind('change', function() {sc_grid_detalleRCyCE_valida_mes(this)});
    $('#SC_rc_fecharecibo_dia').bind('change', function() {sc_grid_detalleRCyCE_valida_dia(this)});
    $('#SC_rc_fecharecibo_input_2_dia').bind('change', function() {sc_grid_detalleRCyCE_valida_dia(this)});
    $('#SC_rc_fecharecibo_input_2_mes').bind('change', function() {sc_grid_detalleRCyCE_valida_mes(this)});
    $('#SC_rc_fecharecibo_mes').bind('change', function() {sc_grid_detalleRCyCE_valida_mes(this)});
 }
 function sc_grid_detalleRCyCE_valida_dia(obj)
 {
 ...
 function sc_grid_detalleRCyCE_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_detalleRCyCE";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_rc_fecharecibo_cond'] = 'cond';
      $tp_fields['SC_rc_fecharecibo_dia'] = 'text';
      $tp_fields['SC_rc_fecharecibo_mes'] = 'text';
      $tp_fields['SC_rc_fecharecibo_ano'] = 'text';
      $tp_fields['SC_rc_fecharecibo_input_2_dia'] = 'text';
      $tp_fields['SC_rc_fecharecibo_input_2_mes'] = 'text';
      $tp_fields['SC_rc_fecharecibo_input_2_ano'] = 'text';
      $tp_fields['SC_p_fecpago_cond'] = 'cond';
      $tp_fields['SC_p_fecpago_dia'] = 'text';
      $tp_fields['SC_p_fecpago_mes'] = 'text';
      $tp_fields['SC_p_fecpago_ano'] = 'text';
      $tp_fields['SC_p_fecpago_input_2_dia'] = 'text';
      $tp_fields['SC_p_fecpago_input_2_mes'] = 'text';
      $tp_fields['SC_p_fecpago_input_2_ano'] = 'text';
   ...
   {
      global $rc_fecharecibo_cond, $rc_fecharecibo, $rc_fecharecibo_dia, $rc_fecharecibo_mes, $rc_fecharecibo_ano, $rc_fecharecibo_input_2_dia, $rc_fecharecibo_input_2_mes, $rc_fecharecibo_input_2_ano,
             $p_fecpago_cond, $p_fecpago, $p_fecpago_dia, $p_fecpago_mes, $p_fecpago_ano, $p_fecpago_input_2_dia, $p_fecpago_input_2_mes, $p_fecpago_input_2_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $rc_fecharecibo_cond_salva = $rc_fecharecibo_cond; 
      if (!isset($rc_fecharecibo_input_2_dia) || $rc_fecharecibo_input_2_dia == "")
      {
          $rc_fecharecibo_input_2_dia = $rc_fecharecibo_dia;
      }
      if (!isset($rc_fecharecibo_input_2_mes) || $rc_fecharecibo_input_2_mes == "")
      {
          $rc_fecharecibo_input_2_mes = $rc_fecharecibo_mes;
      }
      if (!isset($rc_fecharecibo_input_2_ano) || $rc_fecharecibo_input_2_ano == "")
      {
          $rc_fecharecibo_input_2_ano = $rc_fecharecibo_ano;
      }
      $p_fecpago_cond_salva = $p_fecpago_cond; 
      if (!isset($p_fecpago_input_2_dia) || $p_fecpago_input_2_dia == "")
      {
          $p_fecpago_input_2_dia = $p_fecpago_dia;
      }
      if (!isset($p_fecpago_input_2_mes) || $p_fecpago_input_2_mes == "")
      {
          $p_fecpago_input_2_mes = $p_fecpago_mes;
      }
      if (!isset($p_fecpago_input_2_ano) || $p_fecpago_input_2_ano == "")
      {
          $p_fecpago_input_2_ano = $p_fecpago_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_dia'] = $rc_fecharecibo_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_mes'] = $rc_fecharecibo_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_ano'] = $rc_fecharecibo_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_input_2_dia'] = $rc_fecharecibo_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_input_2_mes'] = $rc_fecharecibo_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_input_2_ano'] = $rc_fecharecibo_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_cond'] = $rc_fecharecibo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_dia'] = $p_fecpago_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_mes'] = $p_fecpago_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_ano'] = $p_fecpago_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_input_2_dia'] = $p_fecpago_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_input_2_mes'] = $p_fecpago_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_input_2_ano'] = $p_fecpago_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_cond'] = $p_fecpago_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($rc_fecharecibo_cond != "bi_TP")
      {
          $rc_fecharecibo_cond = strtoupper($rc_fecharecibo_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $rc_fecharecibo_ano;
          $Dtxt .= $rc_fecharecibo_mes;
          $Dtxt .= $rc_fecharecibo_dia;
          $val[0]['ano'] = $rc_fecharecibo_ano;
          $val[0]['mes'] = $rc_fecharecibo_mes;
          $val[0]['dia'] = $rc_fecharecibo_dia;
          if ($rc_fecharecibo_cond == "BW")
          {
              $val[1]['ano'] = $rc_fecharecibo_input_2_ano;
              $val[1]['mes'] = $rc_fecharecibo_input_2_mes;
              $val[1]['dia'] = $rc_fecharecibo_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $rc_fecharecibo_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $rc_fecharecibo_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $rc_fecharecibo = $val[0];
          $this->cmp_formatado['rc_fecharecibo'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['rc_fecharecibo'], "YYYY-MM-DD");
          $this->cmp_formatado['rc_fecharecibo'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($rc_fecharecibo_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $rc_fecharecibo_input_2     = $val[1];
              $this->cmp_formatado['rc_fecharecibo_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['rc_fecharecibo_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['rc_fecharecibo_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['rc_fecharecibo_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $rc_fecharecibo_cond == "NU" || $rc_fecharecibo_cond == "NN"|| $rc_fecharecibo_cond == "EP"|| $rc_fecharecibo_cond == "NE")
          {
              $this->monta_condicao("rc.fecharecibo", $rc_fecharecibo_cond, $rc_fecharecibo, $rc_fecharecibo_input_2, 'rc_fecharecibo', 'DATE');
          }
      }

      //----- $p_fecpago
      $this->Date_part = false;
      if ($p_fecpago_cond != "bi_TP")
      {
          $p_fecpago_cond = strtoupper($p_fecpago_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $p_fecpago_ano;
          $Dtxt .= $p_fecpago_mes;
          $Dtxt .= $p_fecpago_dia;
          $val[0]['ano'] = $p_fecpago_ano;
          $val[0]['mes'] = $p_fecpago_mes;
          $val[0]['dia'] = $p_fecpago_dia;
          if ($p_fecpago_cond == "BW")
          {
              $val[1]['ano'] = $p_fecpago_input_2_ano;
              $val[1]['mes'] = $p_fecpago_input_2_mes;
              $val[1]['dia'] = $p_fecpago_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          {
              $this->nm_prep_date($val, "DT", "DATETIME", $p_fecpago_cond, "", "data");
          }
          else
          {
              $this->nm_prep_date($val, "DT", "DATE", $p_fecpago_cond, "", "data");
          }
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $p_fecpago = $val[0];
          $this->cmp_formatado['p_fecpago'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['p_fecpago'], "YYYY-MM-DD");
          $this->cmp_formatado['p_fecpago'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          if ($p_fecpago_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $p_fecpago_input_2     = $val[1];
              $this->cmp_formatado['p_fecpago_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']['p_fecpago_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['p_fecpago_input_2'], "YYYY-MM-DD");
              $this->cmp_formatado['p_fecpago_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DT", "dmY"));
          }
          if (!empty($Dtxt) || $p_fecpago_cond == "NU" || $p_fecpago_cond == "NN"|| $p_fecpago_cond == "EP"|| $p_fecpago_cond == "NE")
          {
              $this->monta_condicao("p.fecpago", $p_fecpago_cond, $p_fecpago, $p_fecpago_input_2, 'p_fecpago', 'DATE');
          }
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_detalleRCyCE']['where_pesq'];
