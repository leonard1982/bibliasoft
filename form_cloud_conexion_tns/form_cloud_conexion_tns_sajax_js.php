  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_conexion_tns" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_conexion_tns_form();
	}
  ...
  // ---------- Validate ip_servidor
  function do_ajax_form_cloud_conexion_tns_validate_ip_servidor()
  {
    var nomeCampo_ip_servidor = "ip_servidor";
    var var_ip_servidor = scAjaxGetFieldText(nomeCampo_ip_servidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_validate_ip_servidor(var_ip_servidor, var_script_case_init, do_ajax_form_cloud_conexion_tns_validate_ip_servidor_cb);
  } // do_ajax_form_cloud_conexion_tns_validate_ip_servidor

  function do_ajax_form_cloud_conexion_tns_validate_ip_servidor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ip_servidor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_validate_ip_servidor_cb

  // ---------- Validate puerto
  function do_ajax_form_cloud_conexion_tns_validate_puerto()
  {
    var nomeCampo_puerto = "puerto";
    var var_puerto = scAjaxGetFieldText(nomeCampo_puerto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_validate_puerto(var_puerto, var_script_case_init, do_ajax_form_cloud_conexion_tns_validate_puerto_cb);
  } // do_ajax_form_cloud_conexion_tns_validate_puerto

  function do_ajax_form_cloud_conexion_tns_validate_puerto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puerto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_validate_puerto_cb

  // ---------- Validate ruta_bd
  function do_ajax_form_cloud_conexion_tns_validate_ruta_bd()
  {
    var nomeCampo_ruta_bd = "ruta_bd";
    var var_ruta_bd = scAjaxGetFieldText(nomeCampo_ruta_bd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_validate_ruta_bd(var_ruta_bd, var_script_case_init, do_ajax_form_cloud_conexion_tns_validate_ruta_bd_cb);
  } // do_ajax_form_cloud_conexion_tns_validate_ruta_bd

  function do_ajax_form_cloud_conexion_tns_validate_ruta_bd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruta_bd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_validate_ruta_bd_cb

  // ---------- Validate id_empresa
  function do_ajax_form_cloud_conexion_tns_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldText(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_conexion_tns_validate_id_empresa_cb);
  } // do_ajax_form_cloud_conexion_tns_validate_id_empresa

  function do_ajax_form_cloud_conexion_tns_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_validate_id_empresa_cb

  // ---------- Validate ruta_bd_admin
  function do_ajax_form_cloud_conexion_tns_validate_ruta_bd_admin()
  {
    var nomeCampo_ruta_bd_admin = "ruta_bd_admin";
    var var_ruta_bd_admin = scAjaxGetFieldText(nomeCampo_ruta_bd_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_validate_ruta_bd_admin(var_ruta_bd_admin, var_script_case_init, do_ajax_form_cloud_conexion_tns_validate_ruta_bd_admin_cb);
  } // do_ajax_form_cloud_conexion_tns_validate_ruta_bd_admin

  function do_ajax_form_cloud_conexion_tns_validate_ruta_bd_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruta_bd_admin";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_validate_ruta_bd_admin_cb

  // ---------- Validate ruta_bd_anterior
  function do_ajax_form_cloud_conexion_tns_validate_ruta_bd_anterior()
  {
    var nomeCampo_ruta_bd_anterior = "ruta_bd_anterior";
    var var_ruta_bd_anterior = scAjaxGetFieldText(nomeCampo_ruta_bd_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_validate_ruta_bd_anterior(var_ruta_bd_anterior, var_script_case_init, do_ajax_form_cloud_conexion_tns_validate_ruta_bd_anterior_cb);
  } // do_ajax_form_cloud_conexion_tns_validate_ruta_bd_anterior

  function do_ajax_form_cloud_conexion_tns_validate_ruta_bd_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruta_bd_anterior";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_validate_ruta_bd_anterior_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_conexion_tns_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_conexion_tns_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_ip_servidor = scAjaxGetFieldText("ip_servidor");
    var var_puerto = scAjaxGetFieldText("puerto");
    var var_ruta_bd = scAjaxGetFieldText("ruta_bd");
    var var_id_empresa = scAjaxGetFieldText("id_empresa");
    var var_ruta_bd_admin = scAjaxGetFieldText("ruta_bd_admin");
    var var_ruta_bd_anterior = scAjaxGetFieldText("ruta_bd_anterior");
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_conexion_tns_submit_form(var_ip_servidor, var_puerto, var_ruta_bd, var_id_empresa, var_ruta_bd_admin, var_ruta_bd_anterior, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_conexion_tns_submit_form_cb);
  } // do_ajax_form_cloud_conexion_tns_submit_form

  function do_ajax_form_cloud_conexion_tns_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("ip_servidor");
      scAjaxHideErrorDisplay("puerto");
      scAjaxHideErrorDisplay("ruta_bd");
      scAjaxHideErrorDisplay("id_empresa");
      scAjaxHideErrorDisplay("ruta_bd_admin");
      scAjaxHideErrorDisplay("ruta_bd_anterior");
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_conexion_tns']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_conexion_tns']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_conexion_tns']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_conexion_tns_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_conexion_tns_submit_form_cb
  function do_ajax_form_cloud_conexion_tns_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_conexion_tns_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_conexion_tns_navigate_form()
  {
    perform_ajax_form_cloud_conexion_tns_navigate_form();
  }

  function perform_ajax_form_cloud_conexion_tns_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("ruta_bd_admin");
    scAjaxHideErrorDisplay("ruta_bd_anterior");
    var var_id_conexion_tns = document.F2.id_conexion_tns.value;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_conexion_tns_navigate_form(var_id_conexion_tns, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_conexion_tns_navigate_form_cb);
  } // do_ajax_form_cloud_conexion_tns_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_conexion_tns']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_conexion_tns_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.id_conexion_tns.value = scAjaxGetKeyValue("id_conexion_tns");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_conexion_tns_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_conexion_tns_navigate_form_cb
  function do_ajax_form_cloud_conexion_tns_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_conexion_tns_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cloud_conexion_tns_navigate_form_cb_after_alert
  function sc_hide_form_cloud_conexion_tns_form()
  {
  ...
  ajax_field_list[0] = "ip_servidor";
  ajax_field_list[1] = "puerto";
  ajax_field_list[2] = "ruta_bd";
  ajax_field_list[3] = "id_empresa";
  ajax_field_list[4] = "ruta_bd_admin";
  ajax_field_list[5] = "ruta_bd_anterior";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "ip_servidor": {"label": "IP Servidor tns", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "puerto": {"label": "Puerto", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ruta_bd": {"label": "Ruta BD TNS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "ruta_bd_admin": {"label": "Ruta Bd Admin", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ruta_bd_anterior": {"label": "Ruta BD TNS año anterior", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "ip_servidor": new Array(),
    "puerto": new Array(),
    "ruta_bd": new Array(),
    "id_empresa": new Array(),
    "ruta_bd_admin": new Array(),
    "ruta_bd_anterior": new Array()
  };
  ajax_field_mult["ip_servidor"][1] = "ip_servidor";
  ajax_field_mult["puerto"][1] = "puerto";
  ajax_field_mult["ruta_bd"][1] = "ruta_bd";
  ajax_field_mult["id_empresa"][1] = "id_empresa";
  ajax_field_mult["ruta_bd_admin"][1] = "ruta_bd_admin";
  ajax_field_mult["ruta_bd_anterior"][1] = "ruta_bd_anterior";

  var ajax_field_id = {
    "ip_servidor": new Array("hidden_field_label_ip_servidor", "hidden_field_data_ip_servidor"),
    "puerto": new Array("hidden_field_label_puerto", "hidden_field_data_puerto"),
    "ruta_bd": new Array("hidden_field_label_ruta_bd", "hidden_field_data_ruta_bd"),
    "ruta_bd_anterior": new Array("hidden_field_label_ruta_bd_anterior", "hidden_field_data_ruta_bd_anterior")
  };
