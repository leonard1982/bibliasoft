  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cloud_conexion_tns_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cloud_conexion_tns_mob_form();
	}
  ...
  function do_ajax_form_cloud_conexion_tns_mob_validate_ip_servidor()
  {
    var nomeCampo_ip_servidor = "ip_servidor";
    var var_ip_servidor = scAjaxGetFieldText(nomeCampo_ip_servidor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_mob_validate_ip_servidor(var_ip_servidor, var_script_case_init, do_ajax_form_cloud_conexion_tns_mob_validate_ip_servidor_cb);
  } // do_ajax_form_cloud_conexion_tns_mob_validate_ip_servidor

  function do_ajax_form_cloud_conexion_tns_mob_validate_ip_servidor_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_mob_validate_ip_servidor_cb

  // ---------- Validate puerto
  function do_ajax_form_cloud_conexion_tns_mob_validate_puerto()
  {
    var nomeCampo_puerto = "puerto";
    var var_puerto = scAjaxGetFieldText(nomeCampo_puerto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_mob_validate_puerto(var_puerto, var_script_case_init, do_ajax_form_cloud_conexion_tns_mob_validate_puerto_cb);
  } // do_ajax_form_cloud_conexion_tns_mob_validate_puerto

  function do_ajax_form_cloud_conexion_tns_mob_validate_puerto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "puerto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_mob_validate_puerto_cb

  // ---------- Validate ruta_bd
  function do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd()
  {
    var nomeCampo_ruta_bd = "ruta_bd";
    var var_ruta_bd = scAjaxGetFieldText(nomeCampo_ruta_bd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd(var_ruta_bd, var_script_case_init, do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_cb);
  } // do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd

  function do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ruta_bd";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_cb

  // ---------- Validate id_empresa
  function do_ajax_form_cloud_conexion_tns_mob_validate_id_empresa()
  {
    var nomeCampo_id_empresa = "id_empresa";
    var var_id_empresa = scAjaxGetFieldText(nomeCampo_id_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_mob_validate_id_empresa(var_id_empresa, var_script_case_init, do_ajax_form_cloud_conexion_tns_mob_validate_id_empresa_cb);
  } // do_ajax_form_cloud_conexion_tns_mob_validate_id_empresa

  function do_ajax_form_cloud_conexion_tns_mob_validate_id_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_mob_validate_id_empresa_cb

  // ---------- Validate ruta_bd_admin
  function do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_admin()
  {
    var nomeCampo_ruta_bd_admin = "ruta_bd_admin";
    var var_ruta_bd_admin = scAjaxGetFieldText(nomeCampo_ruta_bd_admin);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_admin(var_ruta_bd_admin, var_script_case_init, do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_admin_cb);
  } // do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_admin

  function do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_admin_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_admin_cb

  // ---------- Validate ruta_bd_anterior
  function do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_anterior()
  {
    var nomeCampo_ruta_bd_anterior = "ruta_bd_anterior";
    var var_ruta_bd_anterior = scAjaxGetFieldText(nomeCampo_ruta_bd_anterior);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_anterior(var_ruta_bd_anterior, var_script_case_init, do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_anterior_cb);
  } // do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_anterior

  function do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_anterior_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cloud_conexion_tns_mob_validate_ruta_bd_anterior_cb
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_cloud_conexion_tns_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cloud_conexion_tns_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_id_conexion_tns = scAjaxGetFieldText("id_conexion_tns");
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_conexion_tns_mob_submit_form(var_ip_servidor, var_puerto, var_ruta_bd, var_id_empresa, var_ruta_bd_admin, var_ruta_bd_anterior, var_id_conexion_tns, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cloud_conexion_tns_mob_submit_form_cb);
  } // do_ajax_form_cloud_conexion_tns_mob_submit_form

  function do_ajax_form_cloud_conexion_tns_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cloud_conexion_tns_mob_submit_form_cb_after_alert);
  } // do_ajax_form_cloud_conexion_tns_mob_submit_form_cb
  function do_ajax_form_cloud_conexion_tns_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cloud_conexion_tns_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cloud_conexion_tns_mob_navigate_form()
  {
    perform_ajax_form_cloud_conexion_tns_mob_navigate_form();
  }

  function perform_ajax_form_cloud_conexion_tns_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cloud_conexion_tns_mob_navigate_form(var_id_conexion_tns, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cloud_conexion_tns_mob_navigate_form_cb);
  } // do_ajax_form_cloud_conexion_tns_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cloud_conexion_tns_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cloud_conexion_tns_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cloud_conexion_tns_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_cloud_conexion_tns_mob_navigate_form_cb
  function do_ajax_form_cloud_conexion_tns_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cloud_conexion_tns_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_cloud_conexion_tns_mob_navigate_form_cb_after_alert
  function sc_hide_form_cloud_conexion_tns_mob_form()
  {
