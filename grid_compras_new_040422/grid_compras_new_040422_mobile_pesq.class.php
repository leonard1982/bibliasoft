...
class grid_compras_new_040422_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['path_libs_php'] = $this->Ini->path_lib_php;
   ...
   function init()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['opcao'] = "igual";
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_compras_new_040422_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_compras_new_040422_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_compras_new_040422_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_compras_new_040422/grid_compras_new_040422_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_compras_new_040422_ajax_search.js"></script>
 <script type="text/javascript" src="grid_compras_new_040422_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_compras_new_040422_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_compras_new_040422']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_compras_new_040422']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $fechacom_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_dia']; 
          $fechacom_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_mes']; 
          $fechacom_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_ano']; 
          $fechacom_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_input_2_dia']; 
          $fechacom_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_input_2_mes']; 
          $fechacom_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_input_2_ano']; 
          $fechacom_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_cond']; 
          $numfacom = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['numfacom']; 
          $numfacom_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['numfacom_cond']; 
          $idprov = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['idprov']; 
          $idprov_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['idprov_cond']; 
          $pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['pagada']; 
          $pagada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['pagada_cond']; 
          $asentada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['asentada']; 
          $asentada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['asentada_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['NM_operador']; 
      } 
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['psq_check_ret']['pagada'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['psq_check_ret']['pagada'][] = "SI";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['psq_check_ret']['pagada'][] = "NO";
 ?>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['psq_check_ret']['asentada'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['psq_check_ret']['asentada'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['psq_check_ret']['asentada'][] = "0";
 ?>
...
<?php
   if (is_file("grid_compras_new_040422_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_040422']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_040422']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_040422']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_compras_new_040422']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    $('#SC_fechacom_dia').bind('change', function() {sc_grid_compras_new_040422_valida_dia(this)});
    $('#SC_fechacom_input_2_dia').bind('change', function() {sc_grid_compras_new_040422_valida_dia(this)});
    $('#SC_fechacom_input_2_mes').bind('change', function() {sc_grid_compras_new_040422_valida_mes(this)});
    $('#SC_fechacom_mes').bind('change', function() {sc_grid_compras_new_040422_valida_mes(this)});
 }
 function sc_grid_compras_new_040422_valida_dia(obj)
 {
 ...
 function sc_grid_compras_new_040422_valida_mes(obj)
 {
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_compras_new_040422";
   ...
   function inicializa_vars()
   {
      ...
      $this->nm_data = new nm_data("es");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] = "";
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_compras_new_040422/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function trata_campos()
   {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['psq_check_ret']['pagada'])) {
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['psq_check_ret']['asentada'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_dia'] = $fechacom_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_mes'] = $fechacom_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_ano'] = $fechacom_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_input_2_dia'] = $fechacom_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_input_2_mes'] = $fechacom_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_input_2_ano'] = $fechacom_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_cond'] = $fechacom_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['numfacom'] = $numfacom; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['numfacom_cond'] = $numfacom_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['idprov'] = $idprov; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['idprov_cond'] = $idprov_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['pagada'] = $pagada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['pagada_cond'] = $pagada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['asentada'] = $asentada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['asentada_cond'] = $asentada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca'] = $Temp_Busca;
      }
   ...
   { 
      ...
      if ($fechacom_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom'] = $val[0];
          ...
          if ($fechacom_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']['fechacom_input_2'] = $val[1];
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['fast_search']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq_interativ'] = "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['interativ_search'] = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['int_search_dados'] = array();
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq_filtro'] = "";
      }
      else
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['contr_array_resumo'] = "NAO";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['contr_total_geral']  = "NAO";
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['tot_geral']);
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['where_pesq'];
