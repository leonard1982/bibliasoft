...
class grid_compras_new_040422_res_rtf
{
   var $Erro;
   var $Ini;
   var $Res;
   ...
   function gera_texto_tag()
   {
      ...
      $this->comp_field   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['pivot_group_by'];
      ...
      $this->build_labels = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['arr_export']['label'];
      $this->build_data   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['arr_export']['data'];
   ...
   function formatValue($group, $valor_campo)
   {
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['SC_Ind_Groupby'] == "tipo_com")
       {
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['SC_Ind_Groupby'] == "prefijo_com")
       {
       }
       return $valor_campo;
   }
