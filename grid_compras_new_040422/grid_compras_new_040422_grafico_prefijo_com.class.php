...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['contr_label_graf']['prefijo_com']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['contr_label_graf']['prefijo_com']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['contr_label_graf']['prefijo_com'];
      }
   }
