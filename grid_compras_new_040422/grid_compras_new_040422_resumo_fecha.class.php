...
class grid_compras_new_040422_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_fechacom = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['arr_total']['fechacom'];
      }
      else
      {
          $this->array_total_fechacom = array();
   ...
   function completeMatrix()
   {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_order']['fecha']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_order']['fecha'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_order']['fecha'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_display']['fecha'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_display']['fecha'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_display']['fecha'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_display']['fecha'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_display']['fecha'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_display']['fecha'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['summarizing_fields_display']['fecha'] as $i_sum => $d_sum)
           {
...
//--- 
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['arr_total']['fechacom'] as $campo_fechacom => $dados_fechacom)
      {
...
$_SESSION['scriptcase']['grid_compras_new_040422']['contr_erro'] = 'off';
     ...
     $this->fechacom = $this->Ini->GB_date_format($TP_Time . $fechacom_SV, $Format_tst, $Prefix_dat); 
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_compras_new_040422']['arr_total']['fechacom'] = $this->array_total_fechacom;
      }
   }
