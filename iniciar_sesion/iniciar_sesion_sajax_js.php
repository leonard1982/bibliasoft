  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_iniciar_sesion" == sTestField)
        {
...
?>
  ...
  // ---------- Validate licencia
  function do_ajax_iniciar_sesion_validate_licencia()
  {
    var nomeCampo_licencia = "licencia";
    var var_licencia = scAjaxGetFieldHidden(nomeCampo_licencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_validate_licencia(var_licencia, var_script_case_init, do_ajax_iniciar_sesion_validate_licencia_cb);
  } // do_ajax_iniciar_sesion_validate_licencia

  function do_ajax_iniciar_sesion_validate_licencia_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_validate_licencia_cb

  // ---------- Validate empresa
  function do_ajax_iniciar_sesion_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldSelect(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_validate_empresa(var_empresa, var_script_case_init, do_ajax_iniciar_sesion_validate_empresa_cb);
  } // do_ajax_iniciar_sesion_validate_empresa

  function do_ajax_iniciar_sesion_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_validate_empresa_cb

  // ---------- Validate usuario
  function do_ajax_iniciar_sesion_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_validate_usuario(var_usuario, var_script_case_init, do_ajax_iniciar_sesion_validate_usuario_cb);
  } // do_ajax_iniciar_sesion_validate_usuario

  function do_ajax_iniciar_sesion_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_validate_usuario_cb

  // ---------- Validate password
  function do_ajax_iniciar_sesion_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_validate_password(var_password, var_script_case_init, do_ajax_iniciar_sesion_validate_password_cb);
  } // do_ajax_iniciar_sesion_validate_password

  function do_ajax_iniciar_sesion_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_validate_password_cb

  // ---------- Validate version_actual
  function do_ajax_iniciar_sesion_validate_version_actual()
  {
    var nomeCampo_version_actual = "version_actual";
    var var_version_actual = scAjaxGetFieldHidden(nomeCampo_version_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_validate_version_actual(var_version_actual, var_script_case_init, do_ajax_iniciar_sesion_validate_version_actual_cb);
  } // do_ajax_iniciar_sesion_validate_version_actual

  function do_ajax_iniciar_sesion_validate_version_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_validate_version_actual_cb

  // ---------- Validate logo
  function do_ajax_iniciar_sesion_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_validate_logo(var_logo, var_script_case_init, do_ajax_iniciar_sesion_validate_logo_cb);
  } // do_ajax_iniciar_sesion_validate_logo

  function do_ajax_iniciar_sesion_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_validate_logo_cb

  // ---------- Validate administrar
  function do_ajax_iniciar_sesion_validate_administrar()
  {
    var nomeCampo_administrar = "administrar";
    var var_administrar = scAjaxGetFieldText(nomeCampo_administrar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_validate_administrar(var_administrar, var_script_case_init, do_ajax_iniciar_sesion_validate_administrar_cb);
  } // do_ajax_iniciar_sesion_validate_administrar

  function do_ajax_iniciar_sesion_validate_administrar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_validate_administrar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_iniciar_sesion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_iniciar_sesion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_iniciar_sesion_submit_form(var_licencia, var_empresa, var_usuario, var_password, var_version_actual, var_logo, var_administrar, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_iniciar_sesion_submit_form_cb);
  } // do_ajax_iniciar_sesion_submit_form

  function do_ajax_iniciar_sesion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_iniciar_sesion_submit_form_cb_after_alert);
  } // do_ajax_iniciar_sesion_submit_form_cb
  function do_ajax_iniciar_sesion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_iniciar_sesion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_iniciar_sesion_navigate_form()
  {
    perform_ajax_iniciar_sesion_navigate_form();
  }

  function perform_ajax_iniciar_sesion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_iniciar_sesion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['iniciar_sesion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_iniciar_sesion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_iniciar_sesion_navigate_form_cb_after_alert);
  } // do_ajax_iniciar_sesion_navigate_form_cb
  function do_ajax_iniciar_sesion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_iniciar_sesion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_iniciar_sesion_navigate_form_cb_after_alert
  function sc_hide_iniciar_sesion_form()
  {
