  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_iniciar_sesion_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_iniciar_sesion_mob_form();
	}
...
?>
  ...
  // ---------- Validate licencia
  function do_ajax_iniciar_sesion_mob_validate_licencia()
  {
    var nomeCampo_licencia = "licencia";
    var var_licencia = scAjaxGetFieldHidden(nomeCampo_licencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_mob_validate_licencia(var_licencia, var_script_case_init, do_ajax_iniciar_sesion_mob_validate_licencia_cb);
  } // do_ajax_iniciar_sesion_mob_validate_licencia

  function do_ajax_iniciar_sesion_mob_validate_licencia_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_mob_validate_licencia_cb

  // ---------- Validate empresa
  function do_ajax_iniciar_sesion_mob_validate_empresa()
  {
    var nomeCampo_empresa = "empresa";
    var var_empresa = scAjaxGetFieldSelect(nomeCampo_empresa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_mob_validate_empresa(var_empresa, var_script_case_init, do_ajax_iniciar_sesion_mob_validate_empresa_cb);
  } // do_ajax_iniciar_sesion_mob_validate_empresa

  function do_ajax_iniciar_sesion_mob_validate_empresa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "empresa";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_mob_validate_empresa_cb

  // ---------- Validate usuario
  function do_ajax_iniciar_sesion_mob_validate_usuario()
  {
    var nomeCampo_usuario = "usuario";
    var var_usuario = scAjaxGetFieldText(nomeCampo_usuario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_mob_validate_usuario(var_usuario, var_script_case_init, do_ajax_iniciar_sesion_mob_validate_usuario_cb);
  } // do_ajax_iniciar_sesion_mob_validate_usuario

  function do_ajax_iniciar_sesion_mob_validate_usuario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_mob_validate_usuario_cb

  // ---------- Validate password
  function do_ajax_iniciar_sesion_mob_validate_password()
  {
    var nomeCampo_password = "password";
    var var_password = scAjaxGetFieldText(nomeCampo_password);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_mob_validate_password(var_password, var_script_case_init, do_ajax_iniciar_sesion_mob_validate_password_cb);
  } // do_ajax_iniciar_sesion_mob_validate_password

  function do_ajax_iniciar_sesion_mob_validate_password_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_mob_validate_password_cb

  // ---------- Validate version_actual
  function do_ajax_iniciar_sesion_mob_validate_version_actual()
  {
    var nomeCampo_version_actual = "version_actual";
    var var_version_actual = scAjaxGetFieldHidden(nomeCampo_version_actual);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_mob_validate_version_actual(var_version_actual, var_script_case_init, do_ajax_iniciar_sesion_mob_validate_version_actual_cb);
  } // do_ajax_iniciar_sesion_mob_validate_version_actual

  function do_ajax_iniciar_sesion_mob_validate_version_actual_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "version_actual";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_mob_validate_version_actual_cb

  // ---------- Validate logo
  function do_ajax_iniciar_sesion_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_mob_validate_logo(var_logo, var_script_case_init, do_ajax_iniciar_sesion_mob_validate_logo_cb);
  } // do_ajax_iniciar_sesion_mob_validate_logo

  function do_ajax_iniciar_sesion_mob_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_mob_validate_logo_cb

  // ---------- Validate administrar
  function do_ajax_iniciar_sesion_mob_validate_administrar()
  {
    var nomeCampo_administrar = "administrar";
    var var_administrar = scAjaxGetFieldText(nomeCampo_administrar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_iniciar_sesion_mob_validate_administrar(var_administrar, var_script_case_init, do_ajax_iniciar_sesion_mob_validate_administrar_cb);
  } // do_ajax_iniciar_sesion_mob_validate_administrar

  function do_ajax_iniciar_sesion_mob_validate_administrar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "administrar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_iniciar_sesion_mob_validate_administrar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_iniciar_sesion_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_iniciar_sesion_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_licencia = scAjaxGetFieldHidden("licencia");
    ...
    var var_version_actual = scAjaxGetFieldHidden("version_actual");
    var var_logo = "";
    var var_administrar = scAjaxGetFieldText("administrar");
    ...
    scAjaxProcOn();
    x_ajax_iniciar_sesion_mob_submit_form(var_licencia, var_empresa, var_usuario, var_password, var_version_actual, var_logo, var_administrar, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_iniciar_sesion_mob_submit_form_cb);
  } // do_ajax_iniciar_sesion_mob_submit_form

  function do_ajax_iniciar_sesion_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_iniciar_sesion_mob_submit_form_cb_after_alert);
  } // do_ajax_iniciar_sesion_mob_submit_form_cb
  function do_ajax_iniciar_sesion_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_iniciar_sesion_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_iniciar_sesion_mob_navigate_form()
  {
    perform_ajax_iniciar_sesion_mob_navigate_form();
  }

  function perform_ajax_iniciar_sesion_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
  ...
  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['iniciar_sesion_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_iniciar_sesion_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_iniciar_sesion_mob_navigate_form_cb_after_alert);
  } // do_ajax_iniciar_sesion_mob_navigate_form_cb
  function do_ajax_iniciar_sesion_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_iniciar_sesion_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_iniciar_sesion_mob_navigate_form_cb_after_alert
  function sc_hide_iniciar_sesion_mob_form()
  {
  ...
  var ajax_error_list = {
    ...
    "version_actual": {"label": "Versión", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "logo": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "administrar": {"label": "Enlaces", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "usuario": new Array(),
    "password": new Array(),
    "version_actual": new Array(),
    "logo": new Array(),
    "administrar": new Array()
  };
  ...
  ajax_field_mult["version_actual"][1] = "version_actual";
  ajax_field_mult["logo"][1] = "logo";
  ajax_field_mult["administrar"][1] = "administrar";
  ...
  var ajax_field_id = {
    ...
    "version_actual": new Array("hidden_field_label_version_actual", "hidden_field_data_version_actual"),
    "logo": new Array("hidden_field_label_logo", "hidden_field_data_logo"),
    "administrar": new Array("hidden_field_label_administrar", "hidden_field_data_administrar")
  };
