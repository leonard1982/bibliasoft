...
class grid_contactos_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_contactos_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_contactos_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_contactos_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";$Nm_datas[] = "ultimo_contacto";$Nm_datas[] = "ultimo_contacto";$Nm_numeric[] = "id_contacto";$Nm_numeric[] = "clasificacion";$Nm_numeric[] = "numero_contactos";$Nm_numeric[] = "asesor";
      ...
      $Nm_datas[] = "creado";$Nm_datas[] = "creado";$Nm_datas[] = "editado";$Nm_datas[] = "editado";$Nm_datas[] = "ultimo_contacto";$Nm_datas[] = "ultimo_contacto";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_contactos/grid_contactos_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_contactos_ajax_search.js"></script>
 <script type="text/javascript" src="grid_contactos_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_contactos_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_contactos']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_contactos']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_clasificacion#NMF#' + search_get_select('SC_clasificacion') + '@NMF@';
  str_out += 'SC_inactivo_cond#NMF#' + search_get_sel_txt('SC_inactivo_cond') + '@NMF@';
  str_out += 'SC_inactivo#NMF#' + search_get_select('SC_inactivo') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Contactos</span></td>
            <td id="lin1_col2" class="scFilterHeaderFont"><span><IMG src="<?php echo $this->Ini->path_imag_cab; ?>/scriptcase__NM__ico__NM__contacts.png" border="0"></span></td>
        </tr>
    </table>		 
 </div>
</div>
...
<?php
   ...
   function monta_form()
   {
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['nombres']; 
          $nombres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['nombres_cond']; 
          $direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['direccion']; 
          $direccion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['direccion_cond']; 
          $clasificacion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['clasificacion']; 
          $clasificacion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['clasificacion_cond']; 
          $inactivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['inactivo']; 
          $inactivo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['inactivo_cond']; 
          $asesor = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['asesor']; 
          $asesor_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['asesor_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($clasificacion_cond) || empty($clasificacion_cond))
      {
         $clasificacion_cond = "eq";
      }
      if (!isset($inactivo_cond) || empty($inactivo_cond))
      {
         $inactivo_cond = "eq";
      }
      ...
      $str_hide_inactivo = (in_array($inactivo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($inactivo) || $inactivo == "")
      {
          $inactivo = "";
      }
      if (isset($inactivo) && !empty($inactivo))
      {
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_nombres"  <?php echo $str_hide_nombres?>><?php
      if ($nombres != "")
      {
      $nombres_look = substr($this->Db->qstr($nombres), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_nombres" name="nombres" value="<?php echo NM_encode_input($nombres) ?>"  size=50 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-nombres" id="id_ac_nombres" name="nombres_autocomp"><?php if ('' !=  $nombres) { ?><option value="<?php echo $nombres ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <INPUT type="hidden" id="SC_direccion_cond" name="direccion_cond" value="qp">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_direccion"  <?php echo $str_hide_direccion?>><?php
      if ($direccion != "")
      {
      $direccion_look = substr($this->Db->qstr($direccion), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<INPUT  type="text" id="SC_direccion" name="direccion" value="<?php echo NM_encode_input($direccion) ?>"  size=50 alt="{datatype: 'text', maxLength: 120, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-direccion" id="id_ac_direccion" name="direccion_autocomp"><?php if ('' !=  $direccion) { ?><option value="<?php echo $direccion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <INPUT type="hidden" id="SC_clasificacion_cond" name="clasificacion_cond" value="eq">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_clasificacion"  <?php echo $str_hide_clasificacion?>>
<?php
      $clasificacion_look = substr($this->Db->qstr($clasificacion), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['clasificacion'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['clasificacion'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_clasificacion">
      <SELECT class="scFilterObjectOdd" id="SC_clasificacion" name="clasificacion"  size="1">
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $clasificacion)
            {
                    $clasificacion_sel = ($nm_opc_cod === $clasificacion) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $clasificacion_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <INPUT type="hidden" id="SC_inactivo_cond" name="inactivo_cond" value="eq">

    <TD nowrap class="scFilterLabelEven" style="vertical-align: top" > <?php
 $SC_Label = (isset($this->New_label['inactivo'])) ? $this->New_label['inactivo'] : "Inactivo";
 $nmgp_tab_label .= "inactivo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_inactivo"  <?php echo $str_hide_inactivo?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['inactivo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['inactivo'][] = "NO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['inactivo'][] = "SI";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_inactivo"  name="inactivo"  size="1">
 <OPTION value="NO##@@NO"<?php if ($inactivo == "NO") { echo " selected" ;} ?>>NO</option>
 <OPTION value="SI##@@SI"<?php if ($inactivo == "SI") { echo " selected" ;} ?>>SI</option>
 </SELECT>
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_asesor"  <?php echo $str_hide_asesor?>>
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['asesor'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['asesor'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
   if (is_file("grid_contactos_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_contactos']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_contactos']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.clasificacion_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_clasificacion'), document.F1.clasificacion_cond, 'clasificacion');
   document.F1.clasificacion.value = "";
   document.F1.inactivo_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_inactivo'), document.F1.inactivo_cond, 'inactivo');
   document.F1.inactivo.value = "";
 ...
 {
    if (Field == 'all' || Field == 'clasificacion') {
       Sc_carga_select2_clasificacion();
    }
    if (Field == 'all' || Field == 'inactivo') {
       Sc_carga_select2_inactivo();
    }
    if (Field == 'all' || Field == 'asesor') {
       Sc_carga_select2_asesor();
    }
 }
 function Sc_carga_select2_clasificacion()
 {
  $("#SC_clasificacion").select2(
    {
      language: {
        noResults: function() {
          return "<?php echo $this->Ini->Nm_lang['lang_autocomp_notfound'] ?>";
 ...
 function Sc_carga_select2_inactivo()
 {
  $("#SC_inactivo").select2(
    {
      language: {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_clasificacion'] = 'select';
      $tp_fields['SC_inactivo_cond'] = 'cond';
      $tp_fields['SC_inactivo'] = 'select';
   ...
   {
      global $nombres_cond, $nombres, $nombres_autocomp,
             $direccion_cond, $direccion, $direccion_autocomp,
             $clasificacion_cond, $clasificacion,
             $inactivo_cond, $inactivo,
             $asesor_cond, $asesor, $nmgp_tab_label;
      ...
      $inactivo_cond_salva = $inactivo_cond; 
      if (!isset($inactivo_input_2) || $inactivo_input_2 == "")
      {
          $inactivo_input_2 = $inactivo;
      }
      ...
      $tmp_pos = strpos($clasificacion, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $clasificacion;
      }
      else {
          $L_lookup = substr($clasificacion, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['clasificacion'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($inactivo, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['inactivo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Inactivo : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($asesor, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $asesor;
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['psq_check_ret']['asesor'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['nombres'] = $nombres; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['nombres_cond'] = $nombres_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['direccion'] = $direccion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['direccion_cond'] = $direccion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['clasificacion'] = $clasificacion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['clasificacion_cond'] = $clasificacion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['inactivo'] = $inactivo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['inactivo_cond'] = $inactivo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['asesor'] = $asesor; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['asesor_cond'] = $asesor_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($direccion != '') {
      ...
      $Conteudo = $clasificacion;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['clasificacion'] = $Conteudo;
      $Conteudo = $inactivo;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['inactivo'] = $Conteudo;
      $Conteudo = $asesor;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      ...
      {
         $this->monta_condicao("clasificacion", $clasificacion_cond, $clasificacion, "", "clasificacion");
      }
      ...
      if (isset($inactivo))
      {
         $this->monta_condicao("inactivo", $inactivo_cond, $inactivo, "", "inactivo");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "clasificacion" : return ('class="scFilterObjectOdd"'); break;
