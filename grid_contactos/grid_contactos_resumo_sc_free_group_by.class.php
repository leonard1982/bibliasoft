...
class grid_contactos_resumo
{
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_nombres;
   var $array_total_direccion;
   var $array_total_observaciones;
   var $array_total_pais;
   var $array_total_ciudad;
   var $array_total_clasificacion;
   var $array_total_inactivo;
   var $array_total_creado;
   var $array_total_editado;
   var $array_total_ultimo_contacto;
   var $array_total_numero_contactos;
   var $array_total_asesor;
   ...
   var $sc_proc_quebra_pais;
   var $count_pais;
   var $sc_proc_quebra_ciudad;
   var $count_ciudad;
   var $sc_proc_quebra_clasificacion;
   var $count_clasificacion;
   var $sc_proc_quebra_inactivo;
   var $count_inactivo;
   var $sc_proc_quebra_creado;
   var $count_creado;
   var $sc_proc_quebra_editado;
   var $count_editado;
   var $sc_proc_quebra_ultimo_contacto;
   var $count_ultimo_contacto;
   var $sc_proc_quebra_numero_contactos;
   var $count_numero_contactos;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_nombres          = array();
      $this->array_total_direccion        = array();
      $this->array_total_observaciones    = array();
      $this->array_total_pais             = array();
      $this->array_total_ciudad           = array();
      $this->array_total_clasificacion    = array();
      $this->array_total_inactivo         = array();
      $this->array_total_creado           = array();
      $this->array_total_editado          = array();
      $this->array_total_ultimo_contacto  = array();
      $this->array_total_numero_contactos = array();
      $this->array_total_asesor           = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_contactos'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_contactos'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_contactos']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['grid_contactos']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['grid_contactos']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
   ...
   { 
	...
	function generateChartImages() {
		...
		$this->Graf         = new grid_contactos_grafico();
		$this->Graf->Db     = $this->Db;
		$this->Graf->Erro   = $this->Erro;
		$this->Graf->Ini    = $this->Ini;
		$this->Graf->Lookup = $this->Lookup;

		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_contactos']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_contactos']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['campos_busca'];
       ...
       $this->inactivo = $Busca_temp['inactivo']; 
       $tmp_pos = strpos($this->inactivo, "##@@");
       if ($tmp_pos !== false && !is_array($this->inactivo))
       {
           $this->inactivo = substr($this->inactivo, 0, $tmp_pos);
       }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['res_hrz'];
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']) && !$this->NM_export)
      {
          foreach ($_SESSION['scriptcase']['sc_aba_iframe'] as $aba => $apls_aba)
          {
              if (in_array("grid_contactos", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              $Arr_tot_name = "array_total_" . $cmp_gb;
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['tot_geral'][1];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['nombres'] = $this->array_total_nombres;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['direccion'] = $this->array_total_direccion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['observaciones'] = $this->array_total_observaciones;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['pais'] = $this->array_total_pais;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['ciudad'] = $this->array_total_ciudad;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['clasificacion'] = $this->array_total_clasificacion;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['inactivo'] = $this->array_total_inactivo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['creado'] = $this->array_total_creado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['editado'] = $this->array_total_editado;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['ultimo_contacto'] = $this->array_total_ultimo_contacto;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['numero_contactos'] = $this->array_total_numero_contactos;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total']['asesor'] = $this->array_total_asesor;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['json_use_label'])
       {
          $Lab_nombres = "nombres";
          $Lab_direccion = "direccion";
          $Lab_observaciones = "observaciones";
          $Lab_pais = "pais";
          $Lab_ciudad = "ciudad";
          $Lab_clasificacion = "clasificacion";
          $Lab_inactivo = "inactivo";
          $Lab_creado = "creado";
          $Lab_editado = "editado";
          $Lab_ultimo_contacto = "ultimo_contacto";
          $Lab_numero_contactos = "numero_contactos";
          $Lab_asesor = "asesor";
       }
       else
       {
       ...
       $Lab_creado = "Creado";
       $Lab_editado = "Editado";
       $Lab_ultimo_contacto = "Ultimo Contacto";
       $Lab_numero_contactos = "N.Contactos";
       $Lab_asesor = "Asesor";
       }
       $prep_field = array();
       $prep_field['nombres'] = $Lab_nombres;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['nombres'] = $Lab_nombres; 
       $prep_field['direccion'] = $Lab_direccion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['direccion'] = $Lab_direccion; 
       $prep_field['observaciones'] = $Lab_observaciones;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['observaciones'] = $Lab_observaciones; 
       $prep_field['pais'] = $Lab_pais;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['pais'] = $Lab_pais; 
       $prep_field['ciudad'] = $Lab_ciudad;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['ciudad'] = $Lab_ciudad; 
       $prep_field['clasificacion'] = $Lab_clasificacion;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['clasificacion'] = $Lab_clasificacion; 
       $prep_field['inactivo'] = $Lab_inactivo;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['inactivo'] = $Lab_inactivo; 
       $prep_field['creado'] = $Lab_creado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['creado'] = $Lab_creado; 
       $prep_field['editado'] = $Lab_editado;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['editado'] = $Lab_editado; 
       $prep_field['ultimo_contacto'] = $Lab_ultimo_contacto;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['ultimo_contacto'] = $Lab_ultimo_contacto; 
       $prep_field['numero_contactos'] = $Lab_numero_contactos;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['numero_contactos'] = $Lab_numero_contactos; 
       $prep_field['asesor'] = $Lab_asesor;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['asesor'] = $Lab_asesor; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['nombres']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['nombres'] = "Nombres"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['direccion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['direccion'] = "Direccion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['inactivo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['inactivo'] = "Inactivo"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['ultimo_contacto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['ultimo_contacto'] = "Ultimo Contacto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['numero_contactos']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['numero_contactos'] = "N.Contactos"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['asesor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['asesor'] = "Asesor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['observaciones']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['observaciones'] = "Observaciones"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['pais']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['pais'] = "Pais"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['ciudad']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['ciudad'] = "Ciudad"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['clasificacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['clasificacion'] = "Clasificacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['creado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['creado'] = "Creado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['editado']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['editado'] = "Editado"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['id_contacto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['labels']['id_contacto'] = "Id Contacto"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['nombres']['alin'] = "''";
       $Arr_parms['nombres']['link'] = "S";
       $Arr_parms['direccion']['alin'] = "''";
       $Arr_parms['direccion']['link'] = "S";
       $Arr_parms['observaciones']['alin'] = "''";
       $Arr_parms['observaciones']['link'] = "S";
       $Arr_parms['pais']['alin'] = "''";
       $Arr_parms['pais']['link'] = "S";
       $Arr_parms['ciudad']['alin'] = "''";
       $Arr_parms['ciudad']['link'] = "S";
       $Arr_parms['clasificacion']['alin'] = "''";
       $Arr_parms['clasificacion']['link'] = "S";
       $Arr_parms['inactivo']['alin'] = "''";
       $Arr_parms['inactivo']['link'] = "S";
       $Arr_parms['creado']['alin'] = "''";
       $Arr_parms['creado']['link'] = "S";
       $Arr_parms['editado']['alin'] = "''";
       $Arr_parms['editado']['link'] = "S";
       $Arr_parms['ultimo_contacto']['alin'] = "''";
       $Arr_parms['ultimo_contacto']['link'] = "S";
       $Arr_parms['numero_contactos']['alin'] = "''";
       $Arr_parms['numero_contactos']['link'] = "S";
       $Arr_parms['asesor']['alin'] = "''";
       $Arr_parms['asesor']['link'] = "S";
       $Arr_parms['nombres']['fill'] = "true";
       $Arr_parms['nombres']['order'] = "label";
       $Arr_parms['nombres']['order_start'] = 'asc';
       $Arr_parms['nombres']['order_invert'] = 'false';
       $Arr_parms['nombres']['order_enabled'] = 'false';
       $Arr_parms['direccion']['fill'] = "true";
       $Arr_parms['direccion']['order'] = "label";
       $Arr_parms['direccion']['order_start'] = 'asc';
       $Arr_parms['direccion']['order_invert'] = 'false';
       $Arr_parms['direccion']['order_enabled'] = 'false';
       ...
       $Arr_parms['pais']['fill'] = "true";
       $Arr_parms['pais']['order'] = "label";
       $Arr_parms['pais']['order_start'] = 'asc';
       $Arr_parms['pais']['order_invert'] = 'false';
       $Arr_parms['pais']['order_enabled'] = 'false';
       $Arr_parms['ciudad']['fill'] = "true";
       $Arr_parms['ciudad']['order'] = "label";
       $Arr_parms['ciudad']['order_start'] = 'asc';
       $Arr_parms['ciudad']['order_invert'] = 'false';
       $Arr_parms['ciudad']['order_enabled'] = 'false';
       $Arr_parms['clasificacion']['fill'] = "true";
       $Arr_parms['clasificacion']['order'] = "label";
       $Arr_parms['clasificacion']['order_start'] = 'asc';
       $Arr_parms['clasificacion']['order_invert'] = 'false';
       $Arr_parms['clasificacion']['order_enabled'] = 'false';
       $Arr_parms['inactivo']['fill'] = "true";
       $Arr_parms['inactivo']['order'] = "label";
       $Arr_parms['inactivo']['order_start'] = 'asc';
       $Arr_parms['inactivo']['order_invert'] = 'false';
       $Arr_parms['inactivo']['order_enabled'] = 'false';
       $Arr_parms['creado']['fill'] = "true";
       $Arr_parms['creado']['order'] = "value";
       $Arr_parms['creado']['order_start'] = 'asc';
       $Arr_parms['creado']['order_invert'] = 'false';
       $Arr_parms['creado']['order_enabled'] = 'false';
       $Arr_parms['editado']['fill'] = "true";
       $Arr_parms['editado']['order'] = "value";
       $Arr_parms['editado']['order_start'] = 'asc';
       $Arr_parms['editado']['order_invert'] = 'false';
       $Arr_parms['editado']['order_enabled'] = 'false';
       $Arr_parms['ultimo_contacto']['fill'] = "true";
       $Arr_parms['ultimo_contacto']['order'] = "value";
       $Arr_parms['ultimo_contacto']['order_start'] = 'asc';
       $Arr_parms['ultimo_contacto']['order_invert'] = 'false';
       $Arr_parms['ultimo_contacto']['order_enabled'] = 'false';
       $Arr_parms['numero_contactos']['fill'] = "true";
       $Arr_parms['numero_contactos']['order'] = "label";
       $Arr_parms['numero_contactos']['order_start'] = 'asc';
       $Arr_parms['numero_contactos']['order_invert'] = 'false';
       $Arr_parms['numero_contactos']['order_enabled'] = 'false';
       $Arr_parms['asesor']['fill'] = "true";
       $Arr_parms['asesor']['order'] = "label";
       $Arr_parms['asesor']['order_start'] = 'asc';
       $Arr_parms['asesor']['order_invert'] = 'false';
       $Arr_parms['asesor']['order_enabled'] = 'false';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['nombres'] = array(0 => 'nombres', 1 => '@aspass@');
       $prep_links_fl['direccion'] = array(0 => 'direccion', 1 => '@aspass@');
       $prep_links_fl['observaciones'] = array(0 => 'observaciones', 1 => '@aspass@');
       $prep_links_fl['pais'] = array(0 => 'pais', 1 => '@aspass@');
       $prep_links_fl['ciudad'] = array(0 => 'ciudad', 1 => '@aspass@');
       $prep_links_fl['clasificacion'] = array(0 => 'clasificacion', 1 => '');
       $prep_links_fl['inactivo'] = array(0 => 'inactivo', 1 => '@aspass@');
       $prep_links_fl['creado'] = array(0 => 'creado', 1 => '@aspass@');
       $prep_links_fl['editado'] = array(0 => 'editado', 1 => '@aspass@');
       $prep_links_fl['ultimo_contacto'] = array(0 => 'ultimo_contacto', 1 => '@aspass@');
       $prep_links_fl['numero_contactos'] = array(0 => 'numero_contactos', 1 => '');
       $prep_links_fl['asesor'] = array(0 => 'asesor', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_contactos@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['proc_pdf_vert'])
   {
   ...
   function buildChart()
   {
       ...
       $prep_chart_config = array(
           ...
           '1' => array(
               ...
               'label_x'  => $this->getChartText(strip_tags($Lab_nombres)),
           ...
           '1' => array(
               ...
               'field_x'  => 'direccion',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_direccion)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'pais',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_pais)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'ciudad',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_ciudad)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'clasificacion',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_clasificacion)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'inactivo',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_inactivo)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'creado',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_creado)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'editado',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_editado)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'ultimo_contacto' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'ultimo_contacto',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_ultimo_contacto)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           'numero_contactos' => array(
           '1' => array(
               'title'    => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'numero_contactos',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_numero_contactos)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
           ...
           '1' => array(
               ...
               'field_x'  => 'asesor',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_asesor)),
               'label_y'  => $this->getChartText(strip_tags("" .  $this->Ini->Nm_lang['lang_btns_smry_msge_cnt'] . "")),
               'format'   => $this->formatChartValue(1),
           ),
           ),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts'];
	}
	...
	function filterChartsBySummarization() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao)) {
			...
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['summarizing_fields_display']['sc_free_group_by'] as $fieldIndex => $fieldData) {
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_contactos_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_contactos_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_export']['data']  = $this->build_data;
           return;
       }

       $nm_saida->saida("<tr id=\"summary_body\">\r\n");
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['ajax_nav'])
       { 
           $_SESSION['scriptcase']['saida_html'] = "";
       } 
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function drawMatrixLabels()
   {
       ...
       $nm_saida->saida("    <script type=\"text/javascript\">\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['embutida'])
       { 
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_contactos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_contactos']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_contactos']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_contactos']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_contactos_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] = "print";
      ...
      $this->Total   = new grid_contactos_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['arr_total'][$cmp_gb];
      }
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['doc_word'])
{
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Contactos</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_contactos_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_contactos_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_contactos_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_contactos/grid_contactos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_contactos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_contactos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_contactos_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['num_css'] . '.css');
...
$nm_saida->saida("      url: \"grid_contactos_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_contactos/grid_contactos_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_contactos/grid_contactos_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_opc=resumo&nm_cor=PB&nm_res_cons=s&nm_ini_prt_res=resume&nm_all_modules=grid,resume,chart&password=n&origem=res&language=es&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      {
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_contactos/grid_contactos_config_graf_flash.php?nome_apl=grid_contactos&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_contactos/grid_contactos_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_contactos/grid_contactos_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_contactos_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
            $Arq_WebHelp = file("grid_contactos_help.txt"); 
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_contactos']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_contactos']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_contactos_config_pivot.php?nome_apl=grid_contactos&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_contactos_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_contactos_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_contactos_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_contactos_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['grid_contactos_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_contactos@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   $nm_saida->saida("               nm_submit_modal(\"" . $this->Ini->path_link . "grid_contactos/grid_contactos_export_email.php?script_case_init={$this->Ini->sc_page}&path_img={$this->Ini->path_img_global}&path_btn={$this->Ini->path_botoes}&sType=pdf_res&sAdd=__E__nmgp_tipo_pdf=\" + z + \"__E__sc_parms_pdf=\" + p + \"__E__sc_create_charts=\" + crt + \"__E__sc_graf_pdf=\" + g + \"__E__chart_level=\" + chart_level + \"__E__SC_module_export=\" + SC_module_export + \"__E__use_pass_pdf=\" + use_pass_pdf + \"__E__pdf_all_cab=\" + pdf_all_cab + \"__E__pdf_all_label=\" +  pdf_all_label + \"__E__pdf_label_group=\" +  pdf_label_group + \"__E__pdf_zip=\" +  pdf_zip + \"&nm_opc=pdf&KeepThis=true&TB_iframe=true&modal=true\", '');\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_contactos_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_contactos/grid_contactos_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_contactos_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_contactos_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $direccion = $Busca_temp['direccion']; 
          $tmp_pos = strpos($direccion, "##@@");
          if ($tmp_pos !== false && !is_array($direccion))
          {
              $direccion = substr($direccion, 0, $tmp_pos);
          }
          $clasificacion = $Busca_temp['clasificacion']; 
          $tmp_pos = strpos($clasificacion, "##@@");
          if ($tmp_pos !== false && !is_array($clasificacion))
          {
              $clasificacion = substr($clasificacion, 0, $tmp_pos);
          }
          $inactivo = $Busca_temp['inactivo']; 
          $tmp_pos = strpos($inactivo, "##@@");
          if ($tmp_pos !== false && !is_array($inactivo))
          {
              $inactivo = substr($inactivo, 0, $tmp_pos);
          }
          $asesor = $Busca_temp['asesor']; 
          $tmp_pos = strpos($asesor, "##@@");
          if ($tmp_pos !== false && !is_array($asesor))
          {
              $asesor = substr($asesor, 0, $tmp_pos);
          }
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['cond_pesq'], 0, $trab_pos);
   ...
   //---- 
   function adiciona_registro($quebra_nombres, $quebra_direccion, $quebra_observaciones, $quebra_pais, $quebra_ciudad, $quebra_clasificacion, $quebra_inactivo, $quebra_creado, $quebra_editado, $quebra_ultimo_contacto, $quebra_numero_contactos, $quebra_asesor, $quebra_nombres_orig, $quebra_direccion_orig, $quebra_observaciones_orig, $quebra_pais_orig, $quebra_ciudad_orig, $quebra_clasificacion_orig, $quebra_inactivo_orig, $quebra_creado_orig, $quebra_editado_orig, $quebra_ultimo_contacto_orig, $quebra_numero_contactos_orig, $quebra_asesor_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT nombres, direccion, inactivo, str_replace (convert(char(10),ultimo_contacto,102), '.', '-') + ' ' + convert(char(8),ultimo_contacto,20), numero_contactos, asesor, observaciones, pais, ciudad, clasificacion, str_replace (convert(char(10),creado,102), '.', '-') + ' ' + convert(char(8),creado,20), str_replace (convert(char(10),editado,102), '.', '-') + ' ' + convert(char(8),editado,20), id_contacto from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT nombres, direccion, inactivo, ultimo_contacto, numero_contactos, asesor, observaciones, pais, ciudad, clasificacion, creado, editado, id_contacto from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT nombres, direccion, inactivo, convert(char(23),ultimo_contacto,121), numero_contactos, asesor, observaciones, pais, ciudad, clasificacion, convert(char(23),creado,121), convert(char(23),editado,121), id_contacto from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT nombres, direccion, inactivo, ultimo_contacto, numero_contactos, asesor, observaciones, pais, ciudad, clasificacion, creado, editado, id_contacto from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['where_pesq']; 
     $campos_order = "";
     foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_contactos']['SC_Gb_Free_sql'] as $cmp_var => $resto)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->nombres = $rs_res->fields[0] ;  
            $this->direccion = $rs_res->fields[1] ;  
            $this->inactivo = $rs_res->fields[2] ;  
            $this->ultimo_contacto = $rs_res->fields[3] ;  
            $this->numero_contactos = $rs_res->fields[4] ;  
            $this->asesor = $rs_res->fields[5] ;  
            $this->observaciones = $rs_res->fields[6] ;  
            $this->pais = $rs_res->fields[7] ;  
            $this->ciudad = $rs_res->fields[8] ;  
            $this->clasificacion = $rs_res->fields[9] ;  
            $this->creado = $rs_res->fields[10] ;  
            $this->editado = $rs_res->fields[11] ;  
            $this->id_contacto = $rs_res->fields[12] ;  
            $this->nombres_orig = $this->nombres;
            $this->direccion_orig = $this->direccion;
            $this->observaciones_orig = $this->observaciones;
            $this->pais_orig = $this->pais;
            $this->ciudad_orig = $this->ciudad;
            $this->clasificacion_orig = $this->clasificacion;
            $this->inactivo_orig = $this->inactivo;
            $this->creado_orig = $this->creado;
            $this->editado_orig = $this->editado;
            $this->ultimo_contacto_orig = $this->ultimo_contacto;
            $this->numero_contactos_orig = $this->numero_contactos;
            $this->asesor_orig = $this->asesor;
            nmgp_Form_Num_Val($this->numero_contactos, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->nombres, $this->direccion, $this->observaciones, $this->pais, $this->ciudad, $this->clasificacion, $this->inactivo, $this->creado, $this->editado, $this->ultimo_contacto, $this->numero_contactos, $this->asesor, $this->nombres_orig,  $this->direccion_orig,  $this->observaciones_orig,  $this->pais_orig,  $this->ciudad_orig,  $this->clasificacion_orig,  $this->inactivo_orig,  $this->creado_orig,  $this->editado_orig,  $this->ultimo_contacto_orig,  $this->numero_contactos_orig,  $this->asesor_orig);
            }
   }
//
