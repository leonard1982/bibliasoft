...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-direccion" id="id_ac_direccion" name="direccion_autocomp"><?php if ('' !=  $direccion) { ?><option value="<?php echo $direccion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_clasificacion_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['clasificacion'])) ? $this->New_label['clasificacion'] : "Clasificacion"; ?></TD>
...
?>
      ...
      <TD id='SC_inactivo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['inactivo'])) ? $this->New_label['inactivo'] : "Inactivo"; ?></TD>
      
      <INPUT type="hidden" id="SC_inactivo_cond" name="inactivo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_inactivo" <?php echo $str_hide_inactivo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
