...
<?php
   ...
   $Sel_Groupby = new grid_contactos_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_contactos_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   if ($this->restore) {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['all']['SC_Ind_Groupby'];
   }
   else {
       $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Ind_Groupby'];
   }
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       if (count($campos_sel) != count($_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_Free_cmp']))
       {
       ...
       {
          $Arr_temp = array();
           foreach ($_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_Free_cmp'] as $Cada_cmp => $Resto)
           {
               $Arr_temp[] = $Cada_cmp;
           }
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['Page_break_PDF']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['arr_total']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_order_start']);
       unset($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_tabular']);
           $tab_arr_groubby_cmp = array();
           $tab_arr_groubby_sql = array();
           $tab_arr_groubby_cmp['nombres'] = array('cmp' => "nombres", 'ind' => 0, 'format' => "");
           $tab_arr_groubby_cmp['direccion'] = array('cmp' => "direccion", 'ind' => 1, 'format' => "");
           $tab_arr_groubby_cmp['observaciones'] = array('cmp' => "observaciones", 'ind' => 2, 'format' => "");
           $tab_arr_groubby_cmp['pais'] = array('cmp' => "pais", 'ind' => 3, 'format' => "");
           $tab_arr_groubby_cmp['ciudad'] = array('cmp' => "ciudad", 'ind' => 4, 'format' => "");
           $tab_arr_groubby_cmp['clasificacion'] = array('cmp' => "clasificacion", 'ind' => 5, 'format' => "");
           $tab_arr_groubby_cmp['inactivo'] = array('cmp' => "inactivo", 'ind' => 6, 'format' => "");
           $tab_arr_groubby_cmp['creado'] = array('cmp' => "creado", 'ind' => 7, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['editado'] = array('cmp' => "editado", 'ind' => 8, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['ultimo_contacto'] = array('cmp' => "ultimo_contacto", 'ind' => 9, 'format' => "YYYYMMDD2");
           $tab_arr_groubby_cmp['numero_contactos'] = array('cmp' => "numero_contactos", 'ind' => 10, 'format' => "");
           $tab_arr_groubby_cmp['asesor'] = array('cmp' => "asesor", 'ind' => 11, 'format' => "");
           $tab_arr_groubby_sql[0] = array('cmp' => "nombres", 'ord' => 'asc');
           $tab_arr_groubby_sql[1] = array('cmp' => "direccion", 'ord' => 'asc');
           $tab_arr_groubby_sql[2] = array('cmp' => "observaciones", 'ord' => 'asc');
           $tab_arr_groubby_sql[3] = array('cmp' => "pais", 'ord' => 'asc');
           $tab_arr_groubby_sql[4] = array('cmp' => "ciudad", 'ord' => 'asc');
           $tab_arr_groubby_sql[5] = array('cmp' => "clasificacion", 'ord' => 'asc');
           $tab_arr_groubby_sql[6] = array('cmp' => "inactivo", 'ord' => 'asc');
           $tab_arr_groubby_sql[7] = array('cmp' => "creado", 'ord' => 'asc');
           $tab_arr_groubby_sql[8] = array('cmp' => "editado", 'ord' => 'asc');
           $tab_arr_groubby_sql[9] = array('cmp' => "ultimo_contacto", 'ord' => 'asc');
           $tab_arr_groubby_sql[10] = array('cmp' => "numero_contactos", 'ord' => 'asc');
           $tab_arr_groubby_sql[11] = array('cmp' => "asesor", 'ord' => 'asc');
           $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_Free_cmp']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_Free_sql']  = array();
           $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_date_format']['sc_free_group_by'] = array();
           $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_Free_orig'] = array();
           foreach ($campos_sel as $cada_cmp)
           {
               if (!empty($cada_cmp))
               {
                   $ind = $tab_arr_groubby_cmp[$cada_cmp]['ind'];
                   $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_Free_cmp'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['cmp'];
                   $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_Free_sql'][$cada_cmp][$tab_arr_groubby_sql[$ind]['cmp']] = $tab_arr_groubby_sql[$ind]['ord'];
                   $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_date_format']['sc_free_group_by'][$cada_cmp] = $tab_arr_groubby_cmp[$cada_cmp]['format'];
               }
           }
   }
   if ($sel_groupby == "sc_free_group_by")
   {
       ...
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_x_axys'] = $xaxys_list;
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_y_axys'] = $yaxys_list;
   }
   if ($opc_ret == "resumo" && !empty($this->summ_fields))
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       if(isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_display'][ $sel_groupby ]))
       {
           foreach ($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_display'][ $sel_groupby ] as $i_sum => $d_sum)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_display'][ $sel_groupby ][$i_sum]['display'] = in_array($i_sum, $summ_fields);
           }
       }
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_order'][ $sel_groupby ] = $summ_fields;
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_drill_down'] = $this->drill_down;
   }
?>
    <script language="javascript"> 
<?php
...
function Sel_processa_form()
{
   ...
   $arr_campos_free['nombres'] = "Nombres";
   $arr_campos_free['direccion'] = "Direccion";
   $arr_campos_free['observaciones'] = "Observaciones";
   $arr_campos_free['pais'] = "Pais";
   $arr_campos_free['ciudad'] = "Ciudad";
   $arr_campos_free['clasificacion'] = "Clasificacion";
   $arr_campos_free['inactivo'] = "Inactivo";
   $arr_campos_free['creado'] = "Creado";
   $arr_campos_free['editado'] = "Editado";
   $arr_campos_free['ultimo_contacto'] = "Ultimo Contacto";
   $arr_campos_free['numero_contactos'] = "N.Contactos";
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_contactos_sel_groupby.php",
    data: {
...
<?php
if ($this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
...
elseif (!$this->restore && $bSummaryPage && isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_control']))
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_control'] as $quebra_nome => $_arr_fields)
    {
        if(is_array($_arr_fields))
        {
            foreach ($_arr_fields as $_key_total => $d_field)
...
{
  $max_height = 1;
  if ($this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
  ...
  elseif (!$this->restore && isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_display']))
  {
    foreach ($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_display'] as $_quebra_nome => $_i_sum)
    {
      if (count($_i_sum) > $max_height)
      {
          $max_height = count($_i_sum);
...
<?php
if ($bSummaryPage && $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Ind_Groupby'] == "sc_free_group_by") {
?>
   if (fieldList == "") {
...
?>
  <td>
<?php
     if (!in_array("sc_free_group_by", $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Groupby_hide']))
     {
...
<?php
        ...
        $arr_tmp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] : $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Gb_Free_cmp'];
...
<?php
        ...
        {
            if ($this->restore) {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['pivot_x_axys']);
            }
            else {
                $xAxysGroupCount = count($_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_x_axys']);
            }
        }
...
<?php
        if ($bSummaryPage)
        {
            ...
            {
                $arr_pivot_x_axys = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['pivot_x_axys'] : $_SESSION['sc_session'][$sc_init]['grid_contactos']['pivot_x_axys'];
...
<?php
   ...
   if ($bSummaryPage)
   {
       ...
       if (!isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_control'])) {
           $arr_filds = array();
       }
       else {
           $arr_filds = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['summarizing_fields_control'] : $_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_control'];
       }
    if (isset($arr_filds))
    {
?>
...
<?php
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_display'])) {
              $arr_disp = array();
          }
          else {
                 $arr_disp = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['summarizing_fields_display'] : $_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_display'];
          }
          if (!isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_order'])) {
              $arr_ord = array();
          }
          else {
              $arr_ord  = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['res']['summarizing_fields_order']   : $_SESSION['sc_session'][$sc_init]['grid_contactos']['summarizing_fields_order'];
          }
...
<script type="text/javascript">
   ...
   if ($this->restore) {
       $oJson = new Services_JSON();
        ob_end_clean();
        if ($_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['all']['SC_Ind_Groupby'] == "sc_free_group_by") {
           $this->Arr_result['run_js'][] = "scShowFree()";
        } else {
           $this->Arr_result['set_var'][] = array('var' => 'actual_static_gb', 'value' => $_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb']['all']['SC_Ind_Groupby']);
...
<?php
   $disp_rest = "none";
   foreach ($_SESSION['sc_session'][$sc_init]['grid_contactos']['dados_orig_gb'] as $tp => $fields) {
       foreach ($fields as $name => $data) {
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contactos'][$name])) {
               if ($tp == "all" && ($name != "SC_Gb_Free_cmp" || $_SESSION['sc_session'][$sc_init]['grid_contactos']['SC_Ind_Groupby'] == "sc_free_group_by")) {
                   if ($data != $_SESSION['sc_session'][$sc_init]['grid_contactos'][$name]) {
                       $disp_rest = "";
                       break;
                   }
               }
               elseif ($tp == "res" && $bSummaryPage && $data != $_SESSION['sc_session'][$sc_init]['grid_contactos'][$name]) {
                   $disp_rest = "";
                   break;
               }
           }
