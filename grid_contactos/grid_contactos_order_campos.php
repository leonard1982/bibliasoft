...
<?php
   ...
   $Ord_Cmp = new grid_contactos_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contactos_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["nombres"] : "Nombres";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['inactivo'] = "on";
   $tab_def_campos['inactivo'] = "inactivo";
   $tab_labels["inactivo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["inactivo"])) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["inactivo"] : "Inactivo";
   $tab_ger_campos['ultimo_contacto'] = "on";
   $tab_def_campos['ultimo_contacto'] = "ultimo_contacto";
   $tab_labels["ultimo_contacto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["ultimo_contacto"])) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["ultimo_contacto"] : "Ultimo Contacto";
   $tab_ger_campos['numero_contactos'] = "on";
   $tab_def_campos['numero_contactos'] = "numero_contactos";
   $tab_labels["numero_contactos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["numero_contactos"])) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["numero_contactos"] : "N.Contactos";
   $tab_ger_campos['asesor'] = "on";
   $tab_def_campos['asesor'] = "asesor";
   $tab_labels["asesor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["asesor"])) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['labels']["asesor"] : "Asesor";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contactos']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contactos']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contactos_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contactos']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
