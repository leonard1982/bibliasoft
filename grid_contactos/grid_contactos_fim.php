...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_contactos"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_contactos"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_contactos'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contactos']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contactos']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contactos']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contactos']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contactos']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contactos']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contactos']['embutida_filho'] as $ind => $sc_init)
          {
