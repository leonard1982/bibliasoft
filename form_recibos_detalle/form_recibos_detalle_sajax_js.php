  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recibos_detalle" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_recibos_detalle_form();
	}
...
?>
  ...
  function do_ajax_form_recibos_detalle_validate_id_recibo_detalle()
  {
    ...
    x_ajax_form_recibos_detalle_validate_id_recibo_detalle(var_id_recibo_detalle, var_script_case_init, do_ajax_form_recibos_detalle_validate_id_recibo_detalle_cb);
  } // do_ajax_form_recibos_detalle_validate_id_recibo_detalle

  function do_ajax_form_recibos_detalle_validate_id_recibo_detalle_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_detalle_validate_id_recibo_detalle_cb

  // ---------- Validate documento
  function do_ajax_form_recibos_detalle_validate_documento()
  {
    var nomeCampo_documento = "documento";
    var var_documento = scAjaxGetFieldSelect(nomeCampo_documento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_detalle_validate_documento(var_documento, var_script_case_init, do_ajax_form_recibos_detalle_validate_documento_cb);
  } // do_ajax_form_recibos_detalle_validate_documento

  function do_ajax_form_recibos_detalle_validate_documento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_detalle_validate_documento_cb

  // ---------- Validate concepto
  function do_ajax_form_recibos_detalle_validate_concepto()
  {
    var nomeCampo_concepto = "concepto";
    var var_concepto = scAjaxGetFieldSelect(nomeCampo_concepto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_detalle_validate_concepto(var_concepto, var_script_case_init, do_ajax_form_recibos_detalle_validate_concepto_cb);
  } // do_ajax_form_recibos_detalle_validate_concepto

  function do_ajax_form_recibos_detalle_validate_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_detalle_validate_concepto_cb

  // ---------- Validate valor_a_pagar
  function do_ajax_form_recibos_detalle_validate_valor_a_pagar()
  {
    var nomeCampo_valor_a_pagar = "valor_a_pagar";
    var var_valor_a_pagar = scAjaxGetFieldText(nomeCampo_valor_a_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_detalle_validate_valor_a_pagar(var_valor_a_pagar, var_script_case_init, do_ajax_form_recibos_detalle_validate_valor_a_pagar_cb);
  } // do_ajax_form_recibos_detalle_validate_valor_a_pagar

  function do_ajax_form_recibos_detalle_validate_valor_a_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_detalle_validate_valor_a_pagar_cb

  // ---------- Validate id_recibo
  function do_ajax_form_recibos_detalle_validate_id_recibo()
  {
    var nomeCampo_id_recibo = "id_recibo";
    var var_id_recibo = scAjaxGetFieldText(nomeCampo_id_recibo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_detalle_validate_id_recibo(var_id_recibo, var_script_case_init, do_ajax_form_recibos_detalle_validate_id_recibo_cb);
  } // do_ajax_form_recibos_detalle_validate_id_recibo

  function do_ajax_form_recibos_detalle_validate_id_recibo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_detalle_validate_id_recibo_cb

  // ---------- Validate detalle
  function do_ajax_form_recibos_detalle_validate_detalle()
  {
    var nomeCampo_detalle = "detalle";
    var var_detalle = scAjaxGetFieldText(nomeCampo_detalle);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recibos_detalle_validate_detalle(var_detalle, var_script_case_init, do_ajax_form_recibos_detalle_validate_detalle_cb);
  } // do_ajax_form_recibos_detalle_validate_detalle

  function do_ajax_form_recibos_detalle_validate_detalle_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detalle";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recibos_detalle_validate_detalle_cb

  // ---------- Event onchange documento
  function do_ajax_form_recibos_detalle_event_documento_onchange()
  {
    var var_documento = scAjaxGetFieldSelect("documento");
    var var_valor_a_pagar = scAjaxGetFieldText("valor_a_pagar");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recibos_detalle_event_documento_onchange(var_documento, var_valor_a_pagar, var_script_case_init, do_ajax_form_recibos_detalle_event_documento_onchange_cb);
  } // do_ajax_form_recibos_detalle_event_documento_onchange

  function do_ajax_form_recibos_detalle_event_documento_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "documento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recibos_detalle_event_documento_onchange_cb_after_alert);
  } // do_ajax_form_recibos_detalle_event_documento_onchange_cb
  function do_ajax_form_recibos_detalle_event_documento_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recibos_detalle_event_documento_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recibos_detalle_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recibos_detalle_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_recibos_detalle_submit_form(var_id_recibo_detalle, var_documento, var_concepto, var_valor_a_pagar, var_id_recibo, var_detalle, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recibos_detalle_submit_form_cb);
  } // do_ajax_form_recibos_detalle_submit_form

  function do_ajax_form_recibos_detalle_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scLigEditLookupCall();
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_detalle']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_detalle']['dashboard_info']['under_dashboard']) {
?>
      var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_detalle']['dashboard_info']['parent_widget']; ?>']");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recibos_detalle_submit_form_cb_after_alert);
  } // do_ajax_form_recibos_detalle_submit_form_cb
  function do_ajax_form_recibos_detalle_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recibos_detalle_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_recibos_detalle_navigate_form()
  {
    perform_ajax_form_recibos_detalle_navigate_form();
  }

  function perform_ajax_form_recibos_detalle_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_recibos_detalle_navigate_form(var_id_recibo_detalle, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recibos_detalle_navigate_form_cb);
  } // do_ajax_form_recibos_detalle_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_detalle']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recibos_detalle_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recibos_detalle_navigate_form_cb_after_alert);
  } // do_ajax_form_recibos_detalle_navigate_form_cb
  function do_ajax_form_recibos_detalle_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_recibos_detalle_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_recibos_detalle_navigate_form_cb_after_alert
  function sc_hide_form_recibos_detalle_form()
  {
  ...
  function do_ajax_form_recibos_detalle_lkpedt_refresh_concepto()
  {
    var var_concepto = scAjaxGetFieldSelect("concepto");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_fields = "concepto";
    x_ajax_form_recibos_detalle_lkpedt_refresh_concepto(var_concepto, nmgp_refresh_fields, var_script_case_init, do_ajax_form_recibos_detalle_lkpedt_refresh_concepto_cb);
  } // do_ajax_form_recibos_detalle_lkpedt_refresh_concepto

  function do_ajax_form_recibos_detalle_lkpedt_refresh_concepto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_recibos_detalle_lkpedt_refresh_concepto_cb
