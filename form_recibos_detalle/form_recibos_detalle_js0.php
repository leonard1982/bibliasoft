<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="id_recibo_detalle" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_recibo_detalle']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_detalle']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_recibos_detalle"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recibos_detalle']['where_detal']))
  {
?>  
