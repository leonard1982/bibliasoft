<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="correo" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['correo']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_CORREOS_VALIDADOS']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_CORREOS_VALIDADOS"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_CORREOS_VALIDADOS']['where_detal']))
  {
?>  
...
?>
    ...
    {
        do_ajax_form_CORREOS_VALIDADOS_navigate_form();
    }
} 
...
?>
    ...
    { 
       ...
       {
           Nm_Proc_Atualiz = true;
           do_ajax_form_CORREOS_VALIDADOS_submit_form();
       }
    } 
    if (Nm_submit_ok)
    { 
