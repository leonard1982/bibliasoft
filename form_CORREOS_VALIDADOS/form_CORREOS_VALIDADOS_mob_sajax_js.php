  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_CORREOS_VALIDADOS_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_CORREOS_VALIDADOS_mob_form();
	}
  ...
  // ---------- Validate correo
  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_correo()
  {
    var nomeCampo_correo = "correo";
    var var_correo = scAjaxGetFieldText(nomeCampo_correo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_CORREOS_VALIDADOS_mob_validate_correo(var_correo, var_script_case_init, do_ajax_form_CORREOS_VALIDADOS_mob_validate_correo_cb);
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_correo

  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_correo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_correo_cb

  // ---------- Validate nit
  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_nit()
  {
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_nit

  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_nit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_nit_cb

  // ---------- Validate fecha
  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_fecha()
  {
    var nomeCampo_fecha = "fecha";
    var var_fecha = scAjaxGetFieldText(nomeCampo_fecha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_CORREOS_VALIDADOS_mob_validate_fecha(var_fecha, var_script_case_init, do_ajax_form_CORREOS_VALIDADOS_mob_validate_fecha_cb);
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_fecha

  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_fecha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "fecha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_fecha_cb

  // ---------- Validate valido
  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_valido()
  {
    var nomeCampo_valido = "valido";
    var var_valido = scAjaxGetFieldRadio(nomeCampo_valido);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_CORREOS_VALIDADOS_mob_validate_valido(var_valido, var_script_case_init, do_ajax_form_CORREOS_VALIDADOS_mob_validate_valido_cb);
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_valido

  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_valido_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valido";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_valido_cb

  // ---------- Validate json
  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_json()
  {
    var nomeCampo_json = "json";
    var var_json = scAjaxGetFieldText(nomeCampo_json);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_CORREOS_VALIDADOS_mob_validate_json(var_json, var_script_case_init, do_ajax_form_CORREOS_VALIDADOS_mob_validate_json_cb);
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_json

  function do_ajax_form_CORREOS_VALIDADOS_mob_validate_json_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "json";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_CORREOS_VALIDADOS_mob_validate_json_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_CORREOS_VALIDADOS_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_CORREOS_VALIDADOS_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_valido = scAjaxGetFieldRadio("valido");
    var var_json = scAjaxGetFieldText("json");
    ...
    scAjaxProcOn();
    x_ajax_form_CORREOS_VALIDADOS_mob_submit_form(var_correo, var_nit, var_fecha, var_valido, var_json, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_CORREOS_VALIDADOS_mob_submit_form_cb);
  } // do_ajax_form_CORREOS_VALIDADOS_mob_submit_form

  function do_ajax_form_CORREOS_VALIDADOS_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("valido");
      scAjaxHideErrorDisplay("json");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_CORREOS_VALIDADOS_mob_submit_form_cb_after_alert);
  } // do_ajax_form_CORREOS_VALIDADOS_mob_submit_form_cb
  function do_ajax_form_CORREOS_VALIDADOS_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_CORREOS_VALIDADOS_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_CORREOS_VALIDADOS_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_CORREOS_VALIDADOS_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_CORREOS_VALIDADOS_mob_navigate_form();
    }
  }

  function perform_ajax_form_CORREOS_VALIDADOS_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("valido");
    scAjaxHideErrorDisplay("json");
    var var_correo = document.F2.correo.value;
    ...
    scAjaxProcOn();
    x_ajax_form_CORREOS_VALIDADOS_mob_navigate_form(var_correo, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_CORREOS_VALIDADOS_mob_navigate_form_cb);
  } // do_ajax_form_CORREOS_VALIDADOS_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_CORREOS_VALIDADOS_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_CORREOS_VALIDADOS_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.correo.value = scAjaxGetKeyValue("correo");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_CORREOS_VALIDADOS_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_CORREOS_VALIDADOS_mob_navigate_form_cb
  function do_ajax_form_CORREOS_VALIDADOS_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_CORREOS_VALIDADOS_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_CORREOS_VALIDADOS_mob_navigate_form_cb_after_alert
  function sc_hide_form_CORREOS_VALIDADOS_mob_form()
  {
  ...
  ajax_field_list[0] = "correo";
  ajax_field_list[1] = "nit";
  ajax_field_list[2] = "fecha";
  ajax_field_list[3] = "valido";
  ajax_field_list[4] = "json";
  ...
  var ajax_error_list = {
    ...
    "valido": {"label": "VALIDO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "json": {"label": "JSON", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["valido"][1] = "valido";
  ajax_field_mult["json"][1] = "json";
  ...
  var ajax_field_id = {
    ...
    "valido": new Array("hidden_field_label_valido", "hidden_field_data_valido"),
    "json": new Array("hidden_field_label_json", "hidden_field_data_json")
  };
