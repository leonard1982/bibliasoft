   ...
   function completeMatrix()
   {
       ...
       foreach ($this->array_total_tercero as $i_tercero => $d_tercero) {
           ...
           foreach ($this->array_total_cod_cuenta[$i_tercero] as $i_cod_cuenta => $d_cod_cuenta) {
               if (!in_array($i_cod_cuenta, $this->comp_label[1][ $d_tercero[3] ], true)) {
                   $this->comp_index[1][ $d_cod_cuenta[3] ] = $d_cod_cuenta[2];
                   $this->comp_label[1][ $d_tercero[3] ][ $d_cod_cuenta[3] ] = $d_cod_cuenta[2];
               }
           }
       }
...
$nm_saida->saida("     " . $res_sem_reg . "</TD> </TR>\r\n");
   ...
   function totaliza()
   {
      $this->total->resumo_tercero_cuenta("res", $this->array_total_tercero, $this->array_total_cod_cuenta);
...
//--- 
   ...
   function adiciona_registro($sum_valor_total, $quebra_tercero, $quebra_cod_cuenta, $quebra_tercero_orig, $quebra_cod_cuenta_orig)
   {
      ...
      if (!isset($this->array_total_cod_cuenta[$quebra_tercero_orig][$quebra_cod_cuenta_orig]))
      {
         ...
         $this->array_total_cod_cuenta[$quebra_tercero_orig][$quebra_cod_cuenta_orig][2] = $quebra_cod_cuenta;
         $this->array_total_cod_cuenta[$quebra_tercero_orig][$quebra_cod_cuenta_orig][3] = $quebra_cod_cuenta_orig;
      }
      else
      {
