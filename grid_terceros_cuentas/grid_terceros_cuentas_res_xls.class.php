...
class grid_terceros_cuentas_res_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   //---- 
   function grid_terceros_cuentas_xls()
   {
   }
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".xlsx";
      $this->Tit_doc    = "grid_terceros_cuentas.xlsx";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['xls_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['xls_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['xls_name']);
      }
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['arr_export']['data'];
      $b_display = false;
      $contr_rowspan = array();
      $contr_colspan = array();
      ...
      $objWriter = PHPExcel_IOFactory::createWriter($this->Xls_dados, 'Excel2007');
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE>Cuenta Terceros :: Excel</TITLE>
