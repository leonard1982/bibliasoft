...
class grid_terceros_cuentas_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_cod_cuenta = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['arr_total']['cod_cuenta'];
      }
      else
      {
          $this->array_total_cod_cuenta = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['arr_total']['cod_cuenta'] = $this->array_total_cod_cuenta;
