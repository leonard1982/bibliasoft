<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_terceros_cuentas_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_terceros_cuentas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_converte["prefijo"]   = "prefijo";
   $tab_labels["prefijo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["prefijo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["prefijo"] : "PJ";
   $tab_ger_campos['numero'] = "on";
   $tab_def_campos['numero'] = "numero";
   $tab_converte["numero"]   = "numero";
   $tab_labels["numero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["numero"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["numero"] : "Numero";
   $tab_ger_campos['fecha'] = "on";
   $tab_def_campos['fecha'] = "fecha";
   $tab_converte["fecha"]   = "fecha";
   $tab_labels["fecha"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["fecha"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["fecha"] : "Fecha";
   $tab_ger_campos['tercero'] = "on";
   $tab_def_campos['tercero'] = "tercero";
   $tab_converte["tercero"]   = "tercero";
   $tab_labels["tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["tercero"] : "Tercero";
   $tab_ger_campos['ie'] = "on";
   $tab_def_campos['ie'] = "ie";
   $tab_converte["ie"]   = "ie";
   $tab_labels["ie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["ie"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["ie"] : "IE";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_converte["tipo"]   = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["tipo"] : "Tipo";
   $tab_ger_campos['numero_documento'] = "on";
   $tab_def_campos['numero_documento'] = "numero_documento";
   $tab_converte["numero_documento"]   = "numero_documento";
   $tab_labels["numero_documento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["numero_documento"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["numero_documento"] : "Documento";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_converte["valor_total"]   = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["valor_total"] : "Valor";
   $tab_ger_campos['saldo'] = "on";
   $tab_def_campos['saldo'] = "saldo";
   $tab_converte["saldo"]   = "saldo";
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["saldo"] : "Saldo";
   $tab_ger_campos['usuario'] = "on";
   $tab_def_campos['usuario'] = "usuario";
   $tab_converte["usuario"]   = "usuario";
   $tab_labels["usuario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["usuario"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["usuario"] : "Usuario";
   $tab_ger_campos['tipo_tercero'] = "on";
   $tab_def_campos['tipo_tercero'] = "tipo_tercero";
   $tab_converte["tipo_tercero"]   = "tipo_tercero";
   $tab_labels["tipo_tercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["tipo_tercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["tipo_tercero"] : "Tipo Tercero";
   $tab_ger_campos['cod_cuenta'] = "on";
   $tab_def_campos['cod_cuenta'] = "cod_cuenta";
   $tab_converte["cod_cuenta"]   = "cod_cuenta";
   $tab_labels["cod_cuenta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["cod_cuenta"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["cod_cuenta"] : "Cuenta";
   $tab_ger_campos['pagada'] = "on";
   $tab_def_campos['pagada'] = "pagada";
   $tab_converte["pagada"]   = "pagada";
   $tab_labels["pagada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["pagada"])) ? $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['labels']["pagada"] : "Pagada";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_terceros_cuentas_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
