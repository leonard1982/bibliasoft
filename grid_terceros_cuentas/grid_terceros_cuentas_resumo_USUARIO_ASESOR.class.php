...
class grid_terceros_cuentas_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['arr_total']['usuario'];
      }
      else
      {
          $this->array_total_usuario = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['arr_total']['usuario'] = $this->array_total_usuario;
