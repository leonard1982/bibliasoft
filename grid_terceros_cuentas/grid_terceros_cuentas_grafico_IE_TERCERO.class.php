...
<?php
   ...
   function inicializa_vars()
   {
      ...
      $this->label[1] = "IE";
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['contr_label_graf']['ie']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['contr_label_graf']['ie']))
      {
         $this->label[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['contr_label_graf']['ie'];
      }
   }
