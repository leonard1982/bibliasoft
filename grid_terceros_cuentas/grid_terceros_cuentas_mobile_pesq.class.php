...
class grid_terceros_cuentas_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
    ...
    * @access  public
    */
   function grid_terceros_cuentas_pesq()
   {
   }
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_terceros_cuentas_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_terceros_cuentas_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_terceros_cuentas_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function lookup_ajax_numero($numero)
   {
      ...
      {
          $nm_comando = "select distinct numero from (SELECT      idtercero_cuenta,     prefijo,     numero,     fecha,     tercero,     ie,     tipo,     numero_documento,     valor_total,     saldo,     observaciones,     abonos,     usuario,     ultimo_abono,     fecha_uabono,     creado,     editado,     automatico,     (select if(t.cliente='SI','CLIENTES',if(t.proveedor='SI','PROVEEDORES','OTROS')) from terceros t where t.idtercero=tercero) as tipo_tercero,     cod_cuenta,     pagada FROM      terceros_cuentas ) nm_sel_esp where   CAST (numero AS TEXT)  like '%" . $numero . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct numero from (SELECT      idtercero_cuenta,     prefijo,     numero,     fecha,     tercero,     ie,     tipo,     numero_documento,     valor_total,     saldo,     observaciones,     abonos,     usuario,     ultimo_abono,     fecha_uabono,     creado,     editado,     automatico,     (select if(t.cliente='SI','CLIENTES',if(t.proveedor='SI','PROVEEDORES','OTROS')) from terceros t where t.idtercero=tercero) as tipo_tercero,     cod_cuenta,     pagada FROM      terceros_cuentas ) nm_sel_esp where  numero like '%" . $numero . "%'"; 
      }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "fecha";$Nm_datas[] = "fecha_uabono";$Nm_numeric[] = "idtercero_cuenta";$Nm_numeric[] = "numero";$Nm_numeric[] = "tercero";$Nm_numeric[] = "valor_total";$Nm_numeric[] = "saldo";$Nm_numeric[] = "abonos";
      ...
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_terceros_cuentas/grid_terceros_cuentas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_terceros_cuentas_ajax_search.js"></script>
 <script type="text/javascript" src="grid_terceros_cuentas_ajax.js"></script>
 <script type="text/javascript">
...
function NM_hide_menu()
{
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_ie_cond#NMF#' + search_get_sel_txt('SC_ie_cond') + '@NMF@';
  str_out += 'SC_ie#NMF#' + search_get_select('SC_ie') + '@NMF@';
  ...
  str_out += 'SC_tipo_tercero_cond#NMF#' + search_get_sel_txt('SC_tipo_tercero_cond') + '@NMF@';
  str_out += 'SC_tipo_tercero#NMF#' + search_get_select('SC_tipo_tercero') + '@NMF@';
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span>Cuenta Terceros</span></td>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $tipo_tercero_cond, $tipo_tercero,
             $pagada_cond, $pagada,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $prefijo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['prefijo']; 
          $prefijo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['prefijo_cond']; 
          $numero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['numero']; 
          $numero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['numero_cond']; 
          $fecha_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_dia']; 
          $fecha_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_mes']; 
          $fecha_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_ano']; 
          $fecha_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_input_2_dia']; 
          $fecha_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_input_2_mes']; 
          $fecha_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_input_2_ano']; 
          $fecha_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_cond']; 
          $tercero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tercero']; 
          $tercero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tercero_cond']; 
          $ie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['ie']; 
          $ie_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['ie_cond']; 
          $tipo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tipo']; 
          $tipo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tipo_cond']; 
          $numero_documento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['numero_documento']; 
          $numero_documento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['numero_documento_cond']; 
          $usuario = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['usuario']; 
          $usuario_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['usuario_cond']; 
          $tipo_tercero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tipo_tercero']; 
          $tipo_tercero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tipo_tercero_cond']; 
          $pagada = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['pagada']; 
          $pagada_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['pagada_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['NM_operador']; 
      } 
      ...
      if (!isset($ie_cond) || empty($ie_cond))
      {
         $ie_cond = "eq";
      }
      ...
      if (!isset($tipo_tercero_cond) || empty($tipo_tercero_cond))
      {
         $tipo_tercero_cond = "eq";
      }
      ...
      $str_hide_ie = (in_array($ie_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_hide_tipo_tercero = (in_array($tipo_tercero_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      if (!isset($tipo_tercero) || $tipo_tercero == "")
      {
          $tipo_tercero = "";
      }
      if (isset($tipo_tercero) && !empty($tipo_tercero))
      {
...
<?php
   if (is_file("grid_terceros_cuentas_help.txt"))
   {
...
<?php
      ...
      $nmgp_def_dados = "" ; 
      $nm_comando = "SELECT prefijo, prefijo  FROM resdian  ORDER BY prefijo"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['prefijo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['prefijo'][] = trim($rs->fields[0]);
...
<?php echo $SC_Label ?><br><span id="id_hide_numero"  <?php echo $str_hide_numero?>><?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct numero from (SELECT      idtercero_cuenta,     prefijo,     numero,     fecha,     tercero,     ie,     tipo,     numero_documento,     valor_total,     saldo,     observaciones,     abonos,     usuario,     ultimo_abono,     fecha_uabono,     creado,     editado,     automatico,     (select if(t.cliente='SI','CLIENTES',if(t.proveedor='SI','PROVEEDORES','OTROS')) from terceros t where t.idtercero=tercero) as tipo_tercero,     cod_cuenta,     pagada FROM      terceros_cuentas ) nm_sel_esp where numero = $numero_look"; 
      }
      else
      {
          $nm_comando = "select distinct numero from (SELECT      idtercero_cuenta,     prefijo,     numero,     fecha,     tercero,     ie,     tipo,     numero_documento,     valor_total,     saldo,     observaciones,     abonos,     usuario,     ultimo_abono,     fecha_uabono,     creado,     editado,     automatico,     (select if(t.cliente='SI','CLIENTES',if(t.proveedor='SI','PROVEEDORES','OTROS')) from terceros t where t.idtercero=tercero) as tipo_tercero,     cod_cuenta,     pagada FROM      terceros_cuentas ) nm_sel_esp where numero = $numero_look"; 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_tercero" name="tercero_autocomp" size="60" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_ie_cond" name="ie_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd" > <?php
 $SC_Label = (isset($this->New_label['ie'])) ? $this->New_label['ie'] : "IE";
 $nmgp_tab_label .= "ie?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_ie"  <?php echo $str_hide_ie?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['ie'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['ie'][] = "INGRESO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['ie'][] = "EGRESO";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_ie"  name="ie"  size="1">
 <OPTION value="">TODOS</option>
 <OPTION value="INGRESO##@@INGRESO"<?php if ($ie == "INGRESO") { echo " selected" ;} ?>>INGRESO</option>
 <OPTION value="EGRESO##@@EGRESO"<?php if ($ie == "EGRESO") { echo " selected" ;} ?>>EGRESO</option>
 </SELECT>
 </TD>
...
<?php echo $SC_Label ?><br>
      <SELECT class="scFilterObjectEven" id="SC_tipo_cond" name="tipo_cond" onChange="nm_campos_between(document.getElementById('id_vis_tipo'), this, 'tipo')">
       ...
       <OPTION value="df" <?php if ("df" == $tipo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_dife'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_tipo"  <?php echo $str_hide_tipo?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo'][] = "FV";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo'][] = "RS";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo'][] = "FC";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo'][] = "CE";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo'][] = "RC";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo'][] = "OO";
 ?>

 <SELECT class="scFilterObjectEven" id="SC_tipo"  name="tipo" onChange="nm_refresh_form()" size="1">
 <OPTION value="">SELECCIONE</option>
 <OPTION value="FV##@@VENTA"<?php if ($tipo == "FV") { echo " selected" ;} ?>>VENTA</option>
 <OPTION value="RS##@@REMISION"<?php if ($tipo == "RS") { echo " selected" ;} ?>>REMISION</option>
 <OPTION value="FC##@@COMPRA"<?php if ($tipo == "FC") { echo " selected" ;} ?>>COMPRA</option>
 <OPTION value="CE##@@EGRESO"<?php if ($tipo == "CE") { echo " selected" ;} ?>>EGRESO</option>
 <OPTION value="RC##@@RECIBO"<?php if ($tipo == "RC") { echo " selected" ;} ?>>RECIBO</option>
 <OPTION value="OO##@@GENERAL"<?php if ($tipo == "OO") { echo " selected" ;} ?>>GENERAL</option>
 </SELECT>
 </TD>
...
<?php echo $SC_Label ?><br><span id="id_hide_numero_documento"  <?php echo $str_hide_numero_documento?>><?php
      $numero_documento_look = substr($this->Db->qstr($numero_documento), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct numero_documento from (SELECT      idtercero_cuenta,     prefijo,     numero,     fecha,     tercero,     ie,     tipo,     numero_documento,     valor_total,     saldo,     observaciones,     abonos,     usuario,     ultimo_abono,     fecha_uabono,     creado,     editado,     automatico,     (select if(t.cliente='SI','CLIENTES',if(t.proveedor='SI','PROVEEDORES','OTROS')) from terceros t where t.idtercero=tercero) as tipo_tercero,     cod_cuenta,     pagada FROM      terceros_cuentas ) nm_sel_esp where numero_documento = '$numero_documento_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_usuario" name="usuario_autocomp" size="60" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
      ...
      <INPUT type="hidden" id="SC_tipo_tercero_cond" name="tipo_tercero_cond" value="eq">

    <TD nowrap class="scFilterLabelOdd" > <?php
 $SC_Label = (isset($this->New_label['tipo_tercero'])) ? $this->New_label['tipo_tercero'] : "Tipo Tercero";
 $nmgp_tab_label .= "tipo_tercero?#?" . $SC_Label . "?@?";
 $date_sep_bw = "";
?>
<?php echo $SC_Label ?><br><span id="id_hide_tipo_tercero"  <?php echo $str_hide_tipo_tercero?>> 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo_tercero'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo_tercero'][] = "CLIENTES";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo_tercero'][] = "PROVEEDORES";
 ?>

 <SELECT class="scFilterObjectOdd" id="SC_tipo_tercero"  name="tipo_tercero"  size="1">
 <OPTION value="">TODOS</option>
 <OPTION value="CLIENTES##@@CLIENTES"<?php if ($tipo_tercero == "CLIENTES") { echo " selected" ;} ?>>CLIENTES</option>
 <OPTION value="PROVEEDORES##@@PROVEEDORES"<?php if ($tipo_tercero == "PROVEEDORES") { echo " selected" ;} ?>>PROVEEDORES</option>
 </SELECT>
 </TD>
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['pagada'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['pagada'][] = "NO";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['pagada'][] = "SI";
 ?>
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['opc_psq'] && !$this->aba_iframe))
   {
...
?>
   ...
   <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   nm_campos_between(document.getElementById('id_vis_ie'), document.F1.ie_cond, 'ie');
   document.F1.ie.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_tipo_tercero'), document.F1.tipo_tercero_cond, 'tipo_tercero');
   document.F1.tipo_tercero.value = "";
   nm_campos_between(document.getElementById('id_vis_pagada'), document.F1.pagada_cond, 'pagada');
   document.F1.pagada.value = "";
   document.F1.tipo_cond.selectedIndex = 0;
 }
function nm_tabula(obj, tam, cond)
{
 ...
 {
    $('#SC_fecha_dia').bind('change', function() {sc_grid_terceros_cuentas_valida_dia(this)});
    $('#SC_fecha_input_2_dia').bind('change', function() {sc_grid_terceros_cuentas_valida_dia(this)});
    $('#SC_fecha_input_2_mes').bind('change', function() {sc_grid_terceros_cuentas_valida_mes(this)});
    $('#SC_fecha_mes').bind('change', function() {sc_grid_terceros_cuentas_valida_mes(this)});
 }
 function sc_grid_terceros_cuentas_valida_dia(obj)
 {
 ...
 function sc_grid_terceros_cuentas_valida_mes(obj)
 {
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro()
   {
      ...
      $tp_fields['SC_ie_cond'] = 'cond';
      $tp_fields['SC_ie'] = 'select';
      ...
      $tp_fields['SC_tipo_tercero_cond'] = 'cond';
      $tp_fields['SC_tipo_tercero'] = 'select';
   ...
   function trata_campos()
   {
      global $prefijo_cond, $prefijo,
             ...
             $usuario_cond, $usuario, $usuario_autocomp,
             $tipo_tercero_cond, $tipo_tercero,
             $pagada_cond, $pagada, $nmgp_tab_label;
      ...
      $ie_cond_salva = $ie_cond; 
      if (!isset($ie_input_2) || $ie_input_2 == "")
      {
          $ie_input_2 = $ie;
      }
      ...
      $tipo_tercero_cond_salva = $tipo_tercero_cond; 
      if (!isset($tipo_tercero_input_2) || $tipo_tercero_input_2 == "")
      {
          $tipo_tercero_input_2 = $tipo_tercero;
      }
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['prefijo'])) {
      ...
      if ($tmp_pos === false) {
          ...
          $L_lookup = substr($ie, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['ie'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "IE : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($tipo, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $tipo;
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Tipo : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($tipo_tercero, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $tipo_tercero;
      }
      else {
          $L_lookup = substr($tipo_tercero, 0, $tmp_pos);
      }
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['tipo_tercero'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Tipo Tercero : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $tmp_pos = strpos($pagada, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $pagada;
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['psq_check_ret']['pagada'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['prefijo'] = $prefijo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['prefijo_cond'] = $prefijo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['numero'] = $numero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['numero_cond'] = $numero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_dia'] = $fecha_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_mes'] = $fecha_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_ano'] = $fecha_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_input_2_dia'] = $fecha_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_input_2_mes'] = $fecha_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_input_2_ano'] = $fecha_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_cond'] = $fecha_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tercero'] = $tercero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tercero_cond'] = $tercero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['ie'] = $ie; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['ie_cond'] = $ie_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tipo'] = $tipo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tipo_cond'] = $tipo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['numero_documento'] = $numero_documento; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['numero_documento_cond'] = $numero_documento_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['usuario'] = $usuario; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['usuario_cond'] = $usuario_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tipo_tercero'] = $tipo_tercero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['tipo_tercero_cond'] = $tipo_tercero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['pagada'] = $pagada; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['pagada_cond'] = $pagada_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['NM_operador'] = $this->NM_operador; 
   ...
   { 
      ...
      $this->cmp_formatado['ie'] = $Conteudo;
      $Conteudo = $tipo;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      ...
      $Conteudo = $tipo_tercero;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['tipo_tercero'] = $Conteudo;
      $Conteudo = $pagada;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      ...
      if ($fecha_cond != "TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha'] = $val[0];
          ...
          if ($fecha_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']['fecha_input_2'] = $val[1];
      ...
      if (isset($ie))
      {
         $this->monta_condicao("ie", $ie_cond, $ie, "", "ie");
      }
      ...
      {
         $this->monta_condicao("tipo_tercero", $tipo_tercero_cond, $tipo_tercero, "", "tipo_tercero");
      }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['where_pesq_ant'] = $this->comando . $this->comando_fim;
