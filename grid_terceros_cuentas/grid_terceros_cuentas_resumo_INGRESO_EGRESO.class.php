...
class grid_terceros_cuentas_resumo
{
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          $this->array_total_ie = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['arr_total']['ie'];
      }
      else
      {
          $this->array_total_ie = array();
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_terceros_cuentas']['arr_total']['ie'] = $this->array_total_ie;
