<?php
   ...
   $Sel_Groupby = new grid_terceros_cuentas_sel_Groupby(); 
   $Sel_Groupby->Sel_Groupby_init();
   
class grid_terceros_cuentas_sel_Groupby
{
function Sel_Groupby_init()
{
   ...
   $groupby_atual = $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Ind_Groupby'];
...
function Sel_processa_out($sel_groupby)
{
   ...
   {
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Ind_Groupby']     = $sel_groupby;
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['contr_array_resumo'] = "NAO";
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['contr_total_geral']  = "NAO";
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_quebra']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['ordem_select']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['tot_geral']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_group_by']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_x_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_y_axys']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_fill']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_order']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_order_col']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_order_level']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_order_sort']);
       unset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['pivot_tabular']);
   }
   if ($opc_ret == "resumo")
   {
       $summ_fields = explode("@?@", $this->summ_fields);
       foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_display'] as $i_sum => $d_sum)
       {
           $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_display'][$i_sum]['display'] = in_array($i_sum, $summ_fields);
       }
       $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_order'] = $summ_fields;
   }
?>
...
?>
 <script language="javascript" type="text/javascript">
  function scSubmitGroupBy(sPos) {
   $.ajax({
    type: "POST",
    url: "grid_terceros_cuentas_sel_groupby.php",
    data: {
...
{
    $aOptions = array();
    foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_control'] as $l_field => $d_field)
    {
...
{
?>
   $("#sc_id_summ_available").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_display']) * 29 ?>px");
   $("#sc_id_summ_selected").css("min-height", "<?php echo sizeof($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_display']) * 29 ?>px");
<?php
}
?>
  }
...
<?php
    ...
    $iTabCount            = 0;
    foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_All_Groupby'] as $QB => $Tp)
    {
        if (!in_array($QB, $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Groupby_hide']))
        {
...
?>
 <tr id="sc_id_static_groupby">
  <td>
<?php
     if (!in_array("INGRESO_EGRESO", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Groupby_hide']))
     {
...
?>
<?php
     if (!in_array("TERCERO", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Groupby_hide']))
     {
...
?>
<?php
     if (!in_array("IE_TERCERO", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Groupby_hide']))
     {
...
?>
<?php
     if (!in_array("USUARIO_ASESOR", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Groupby_hide']))
     {
...
?>
<?php
     if (!in_array("cuenta", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Groupby_hide']))
     {
...
?>
<?php
     if (!in_array("tercero_cuenta", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Groupby_hide']))
     {
...
?>
<?php
     if (!in_array("_NM_SC_", $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['SC_Groupby_hide']))
     {
        if ($opc_ret != "resumo")
        {
...
<?php
        foreach ($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_order'] as $i_sum)
        {
            if ('' != $i_sum && isset($_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_display'][$i_sum]))
            {
                $d_sum = $_SESSION['sc_session'][$sc_init]['grid_terceros_cuentas']['summarizing_fields_display'][$i_sum];
                if ($d_sum['display'])
                {
                    $sLabel = $d_sum['label'];
                    $sId    = '';
