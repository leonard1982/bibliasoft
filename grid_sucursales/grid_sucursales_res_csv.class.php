...
class grid_sucursales_res_csv
{
   ...
   function monta_csv()
   {
      ...
      $this->grava_arquivo();
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['csv_res_grid']))
      {
          return;
      }
   ...
   function inicializa_vars()
   {
      ...
      $this->Res           = new grid_sucursales_resumo("out");
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['csv_res_grid']) && !$this->Ini->sc_export_ajax) {
   ...
   function grava_arquivo()
   {
      ...
      $this->array_titulos = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['arr_export']['label'];
      $this->array_linhas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['arr_export']['data'];
      $this->comp_y_axys  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['pivot_y_axys'];
      $this->comp_tabular = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['pivot_tabular'];
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['csv_res_grid']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['csv_res_file'] = $this->Csv_f;
      }
