...
class grid_sucursales_pesq
{
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_sucursales_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_sucursales_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_sucursales_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idsucursal')
      {
          $idsucursal = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idsucursal($idsucursal);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_sucursal')
      {
          $sucursal = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_sucursal($sucursal);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
      ...
      if ($this->NM_ajax_opcao == 'autocomp_idtercero')
      {
          $idtercero = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_idtercero($idtercero);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_idsucursal($idsucursal)
   {
      $idsucursal = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idsucursal);
      $idsucursal = substr($this->Db->qstr($idsucursal), 1, -1);
            $idsucursal_look = substr($this->Db->qstr($idsucursal), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idsucursal from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and   CAST (idsucursal AS TEXT)  like '%" . $idsucursal . "%' order by idsucursal"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idsucursal from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and   CAST (idsucursal AS VARCHAR)  like '%" . $idsucursal . "%' order by idsucursal"; 
      }
      else
      {
          $nm_comando = "select distinct idsucursal from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and  idsucursal like '%" . $idsucursal . "%' order by idsucursal"; 
      }
      unset($cmp1,$cmp2);
   ...
   function lookup_ajax_sucursal($sucursal)
   {
      $sucursal = substr($this->Db->qstr($sucursal), 1, -1);
            $sucursal_look = substr($this->Db->qstr($sucursal), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct sucursal from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and  sucursal like '%" . $sucursal . "%' order by sucursal"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function lookup_ajax_idtercero($idtercero)
   {
      $idtercero = str_replace($_SESSION['scriptcase']['reg_conf']['grup_num'], "", $idtercero);
      $idtercero = substr($this->Db->qstr($idtercero), 1, -1);
            $idtercero_look = substr($this->Db->qstr($idtercero), 1, -1); 
      $nmgp_def_dados = array(); 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idtercero from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and   CAST (idtercero AS TEXT)  like '%" . $idtercero . "%' order by idtercero"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idtercero from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and   CAST (idtercero AS VARCHAR)  like '%" . $idtercero . "%' order by idtercero"; 
      }
      else
      {
          $nm_comando = "select distinct idtercero from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and  idtercero like '%" . $idtercero . "%' order by idtercero"; 
      }
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
   ...
   function lookup_ajax_direccion($direccion)
   {
      $direccion = substr($this->Db->qstr($direccion), 1, -1);
            $direccion_look = substr($this->Db->qstr($direccion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct direccion from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and  direccion like '%" . $direccion . "%' order by direccion"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "idsucursal";$Nm_numeric[] = "idtercero";$Nm_numeric[] = "departamento";$Nm_numeric[] = "municipio";$Nm_numeric[] = "idsucursal";$Nm_numeric[] = "idtercero";$Nm_numeric[] = "departamento";$Nm_numeric[] = "municipio";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_sucursales/grid_sucursales_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_sucursales_ajax_search.js"></script>
 <script type="text/javascript" src="grid_sucursales_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_sucursales_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sucursales']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_sucursales']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idsucursal_cond#NMF#' + search_get_sel_txt('SC_idsucursal_cond') + '@NMF@';
  str_out += 'SC_idsucursal#NMF#' + search_get_text('SC_idsucursal') + '@NMF@';
  str_out += 'id_ac_idsucursal#NMF#' + search_get_title('select2-id_ac_idsucursal-container') + '@NMF@';
  str_out += 'SC_idsucursal_input_2#NMF#' + search_get_text('SC_idsucursal_input_2') + '@NMF@';
  str_out += 'SC_sucursal_cond#NMF#' + search_get_sel_txt('SC_sucursal_cond') + '@NMF@';
  str_out += 'SC_sucursal#NMF#' + search_get_text('SC_sucursal') + '@NMF@';
  str_out += 'id_ac_sucursal#NMF#' + search_get_title('select2-id_ac_sucursal-container') + '@NMF@';
  str_out += 'SC_idtercero_cond#NMF#' + search_get_sel_txt('SC_idtercero_cond') + '@NMF@';
  str_out += 'SC_idtercero#NMF#' + search_get_text('SC_idtercero') + '@NMF@';
  str_out += 'id_ac_idtercero#NMF#' + search_get_title('select2-id_ac_idtercero-container') + '@NMF@';
  str_out += 'SC_idtercero_input_2#NMF#' + search_get_text('SC_idtercero_input_2') + '@NMF@';
  ...
  str_out += 'id_ac_direccion#NMF#' + search_get_title('select2-id_ac_direccion-container') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-idsucursal").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idsucursal",
      max_itens: "10",
   ...
   $("#SC_idsucursal").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-sucursal").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_sucursal",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_sucursal").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-idtercero").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      q: params.term,
      nmgp_opcao: "ajax_autocomp",
      nmgp_parms: "NM_ajax_opcao?#?autocomp_idtercero",
      max_itens: "10",
      script_case_init: <?php echo $this->Ini->sc_page ?>
     }
     return query;
   ...
   $("#SC_idtercero").val(e.params.data.id);
  });
  $(".sc-ui-autocomp-direccion").on("focus", function() {
  }).on("blur", function() {
  }).on("keydown", function(e) {
   if(e.keyCode == $.ui.keyCode.TAB && $(".ui-autocomplete").filter(":visible").length) {
    e.keyCode = $.ui.keyCode.DOWN;
   ...
   $("#SC_direccion").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div style="width: 100%">
 ...
 <div style="height:37px; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - sucursales</span></td>
...
<?php
   ...
   {
      global 
             $idsucursal_cond, $idsucursal, $idsucursal_input_2, $idsucursal_autocomp,
             $sucursal_cond, $sucursal, $sucursal_autocomp,
             $idtercero_cond, $idtercero, $idtercero_input_2, $idtercero_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $idsucursal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idsucursal']; 
          $idsucursal_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idsucursal_input_2']; 
          $idsucursal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idsucursal_cond']; 
          $sucursal = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['sucursal']; 
          $sucursal_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['sucursal_cond']; 
          $idtercero = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idtercero']; 
          $idtercero_input_2 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idtercero_input_2']; 
          $idtercero_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idtercero_cond']; 
          $direccion = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['direccion']; 
          $direccion_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['direccion_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['NM_operador']; 
      } 
      if (!isset($idsucursal_cond) || empty($idsucursal_cond))
      {
         $idsucursal_cond = "gt";
      }
      if (!isset($sucursal_cond) || empty($sucursal_cond))
      {
         $sucursal_cond = "qp";
      }
      if (!isset($idtercero_cond) || empty($idtercero_cond))
      {
         $idtercero_cond = "gt";
      }
      ...
      $str_hide_idsucursal = (in_array($idsucursal_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_sucursal = (in_array($sucursal_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idtercero = (in_array($idtercero_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_direccion = (in_array($direccion_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_idsucursal = ('bw' == $idsucursal_cond) ? $display_aberto : $display_fechado;
      $str_display_sucursal = ('bw' == $sucursal_cond) ? $display_aberto : $display_fechado;
      $str_display_idtercero = ('bw' == $idtercero_cond) ? $display_aberto : $display_fechado;
      $str_display_direccion = ('bw' == $direccion_cond) ? $display_aberto : $display_fechado;

      if (!isset($idsucursal) || $idsucursal == "")
      {
          $idsucursal = "";
      }
      if (isset($idsucursal) && !empty($idsucursal))
      {
         $tmp_pos = strpos($idsucursal, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idsucursal = substr($idsucursal, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($idtercero) || $idtercero == "")
      {
          $idtercero = "";
      }
      if (isset($idtercero) && !empty($idtercero))
      {
         $tmp_pos = strpos($idtercero, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $idtercero = substr($idtercero, 0, $tmp_pos);
         }
      }
...
?>
 ...
 $nmgp_tab_label .= "idsucursal?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idsucursal_cond" name="idsucursal_cond" onChange="nm_campos_between(document.getElementById('id_vis_idsucursal'), this, 'idsucursal')">
       <OPTION value="gt" <?php if ("gt" == $idsucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idsucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idsucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idsucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idsucursal"  <?php echo $str_hide_idsucursal?>><?php
      if ($idsucursal != "")
      {
      $idsucursal_look = substr($this->Db->qstr($idsucursal), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idsucursal from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and idsucursal = $idsucursal_look order by idsucursal"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idsucursal from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and idsucursal = $idsucursal_look order by idsucursal"; 
      ...
      if (isset($nmgp_def_dados[0][$idsucursal]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idsucursal];
      }
      else
      {
            nmgp_Form_Num_Val($idsucursal, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idsucursal;
      }
?>
<INPUT  type="text" id="SC_idsucursal" name="idsucursal" value="<?php echo NM_encode_input($idsucursal) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idsucursal" id="id_ac_idsucursal" name="idsucursal_autocomp"><?php if ('' !=  $idsucursal) { ?><option value="<?php echo $idsucursal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idsucursal"  <?php echo $str_display_idsucursal; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idsucursal_input_2" name="idsucursal_input_2" value="<?php echo NM_encode_input($idsucursal_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_sucursal_cond" name="sucursal_cond" onChange="nm_campos_between(document.getElementById('id_vis_sucursal'), this, 'sucursal')">
       <OPTION value="qp" <?php if ("qp" == $sucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $sucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $sucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $sucursal_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_sucursal"  <?php echo $str_hide_sucursal?>><?php
      if ($sucursal != "")
      {
      $sucursal_look = substr($this->Db->qstr($sucursal), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct sucursal from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and sucursal = '$sucursal_look' order by sucursal"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$sucursal]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$sucursal];
      }
      else
      {
          $sAutocompValue = $sucursal;
      }
?>
<INPUT  type="text" id="SC_sucursal" name="sucursal" value="<?php echo NM_encode_input($sucursal) ?>"  size=12 alt="{datatype: 'text', maxLength: 12, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-sucursal" id="id_ac_sucursal" name="sucursal_autocomp"><?php if ('' !=  $sucursal) { ?><option value="<?php echo $sucursal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
 ...
 $nmgp_tab_label .= "idtercero?#?" . $SC_Label . "?@?";
 $date_sep_bw = " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idtercero_cond" name="idtercero_cond" onChange="nm_campos_between(document.getElementById('id_vis_idtercero'), this, 'idtercero')">
       <OPTION value="gt" <?php if ("gt" == $idtercero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idtercero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idtercero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="bw" <?php if ("bw" == $idtercero_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_betw'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_idtercero"  <?php echo $str_hide_idtercero?>><?php
      if ($idtercero != "")
      {
      $idtercero_look = substr($this->Db->qstr($idtercero), 1, -1); 
      $nmgp_def_dados = array(); 
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct idtercero from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and idtercero = $idtercero_look order by idtercero"; 
      }
      elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sybase))
      {
          $nm_comando = "select distinct idtercero from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and idtercero = $idtercero_look order by idtercero"; 
      ...
      if (isset($nmgp_def_dados[0][$idtercero]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$idtercero];
      }
      else
      {
            nmgp_Form_Num_Val($idtercero, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "2", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          $sAutocompValue = $idtercero;
      }
?>
<INPUT  type="text" id="SC_idtercero" name="idtercero" value="<?php echo NM_encode_input($idtercero) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idtercero" id="id_ac_idtercero" name="idtercero_autocomp"><?php if ('' !=  $idtercero) { ?><option value="<?php echo $idtercero ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>         <BR>
        <SPAN id="id_vis_idtercero"  <?php echo $str_display_idtercero; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idtercero_input_2" name="idtercero_input_2" value="<?php echo NM_encode_input($idtercero_input_2) ?>"  size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">         </SPAN>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      $direccion_look = substr($this->Db->qstr($direccion), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct direccion from " . $this->Ini->nm_tabela . " where idtercero=" . $_SESSION['cliente'] . " and direccion = '$direccion_look' order by direccion"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
...
?>
<INPUT  type="text" id="SC_direccion" name="direccion" value="<?php echo NM_encode_input($direccion) ?>"  size=50 alt="{datatype: 'text', maxLength: 60, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-direccion" id="id_ac_direccion" name="direccion_autocomp"><?php if ('' !=  $direccion) { ?><option value="<?php echo $direccion ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
...
?>
<?php
   if (is_file("grid_sucursales_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sucursales']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_sucursales']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_sucursales']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_sucursales']['start'] == 'filter')
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idsucursal_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idsucursal'), document.F1.idsucursal_cond, 'idsucursal');
   document.F1.idsucursal.value = "";
   document.F1.idsucursal_autocomp.value = "";
   $('#select2-id_ac_idsucursal-container').html('<?php echo $this->Val_init_idsucursal['desc'] ?>');;
   document.F1.idsucursal_input_2.value = "";
   document.F1.sucursal_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_sucursal'), document.F1.sucursal_cond, 'sucursal');
   document.F1.sucursal.value = "";
   document.F1.sucursal_autocomp.value = "";
   $('#select2-id_ac_sucursal-container').html('<?php echo $this->Val_init_sucursal['desc'] ?>');;
   document.F1.idtercero_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idtercero'), document.F1.idtercero_cond, 'idtercero');
   document.F1.idtercero.value = "";
   document.F1.idtercero_autocomp.value = "";
   $('#select2-id_ac_idtercero-container').html('<?php echo $this->Val_init_idtercero['desc'] ?>');;
   document.F1.idtercero_input_2.value = "";
   ...
   $('#select2-id_ac_direccion-container').html('<?php echo $this->Val_init_direccion['desc'] ?>');;
   Sc_carga_select2('all');
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "FACILWEBv_2022/grid_sucursales";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idsucursal_cond'] = 'cond';
      $tp_fields['SC_idsucursal'] = 'text_aut';
      $tp_fields['id_ac_idsucursal'] = 'select2_aut';
      $tp_fields['SC_idsucursal_input_2'] = 'text';
      $tp_fields['SC_sucursal_cond'] = 'cond';
      $tp_fields['SC_sucursal'] = 'text_aut';
      $tp_fields['id_ac_sucursal'] = 'select2_aut';
      $tp_fields['SC_idtercero_cond'] = 'cond';
      $tp_fields['SC_idtercero'] = 'text_aut';
      $tp_fields['id_ac_idtercero'] = 'select2_aut';
      $tp_fields['SC_idtercero_input_2'] = 'text';
      $tp_fields['SC_direccion_cond'] = 'cond';
      $tp_fields['SC_direccion'] = 'text_aut';
      $tp_fields['id_ac_direccion'] = 'select2_aut';
   ...
   {
      global $idsucursal_cond, $idsucursal, $idsucursal_input_2, $idsucursal_autocomp,
             $sucursal_cond, $sucursal, $sucursal_autocomp,
             $idtercero_cond, $idtercero, $idtercero_input_2, $idtercero_autocomp,
      ...
      if (!empty($idsucursal_autocomp) && empty($idsucursal))
      {
          $idsucursal = $idsucursal_autocomp;
      }
      if (!empty($sucursal_autocomp) && empty($sucursal))
      {
          $sucursal = $sucursal_autocomp;
      }
      if (!empty($idtercero_autocomp) && empty($idtercero))
      {
          $idtercero = $idtercero_autocomp;
      }
      if (!empty($direccion_autocomp) && empty($direccion))
      {
          $direccion = $direccion_autocomp;
      }
      $idsucursal_cond_salva = $idsucursal_cond; 
      if (!isset($idsucursal_input_2) || $idsucursal_input_2 == "")
      {
          $idsucursal_input_2 = $idsucursal;
      }
      ...
      $idtercero_cond_salva = $idtercero_cond; 
      if (!isset($idtercero_input_2) || $idtercero_input_2 == "")
      {
          $idtercero_input_2 = $idtercero;
      }
      ...
      if ($idsucursal_cond != "in")
      {
          nm_limpa_numero($idsucursal, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idsucursal_cond != "in")
      {
          nm_limpa_numero($idsucursal_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idtercero_cond != "in")
      {
          nm_limpa_numero($idtercero, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idtercero_cond != "in")
      {
          nm_limpa_numero($idtercero_input_2, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idsucursal'] = $idsucursal; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idsucursal_input_2'] = $idsucursal_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idsucursal_cond'] = $idsucursal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['sucursal'] = $sucursal; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['sucursal_cond'] = $sucursal_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idtercero'] = $idtercero; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idtercero_input_2'] = $idtercero_input_2; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['idtercero_cond'] = $idtercero_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['direccion'] = $direccion; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['direccion_cond'] = $direccion_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca'] = $Temp_Busca;
      }
      if ($idsucursal_cond != "in" && $idsucursal_cond != "bw" && !empty($idsucursal) && !is_numeric($idsucursal))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idsucursal";
      }
      if ($idsucursal_cond == "bw" && ((!empty($idsucursal) && !is_numeric($idsucursal)) || (!empty($idsucursal_input_2) && !is_numeric($idsucursal_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idsucursal";
      }
      if ($idtercero_cond != "in" && $idtercero_cond != "bw" && !empty($idtercero) && !is_numeric($idtercero))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idtercero";
      }
      if ($idtercero_cond == "bw" && ((!empty($idtercero) && !is_numeric($idtercero)) || (!empty($idtercero_input_2) && !is_numeric($idtercero_input_2)) ))
      {
          if (!empty($this->Campos_Mens_erro)){$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= $this->Ini->Nm_lang['lang_errm_ajax_data'] . " : Idtercero";
      }
      if (!empty($this->Campos_Mens_erro)) 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idsucursal'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['idsucursal'] = $cmp1;
      }
      else
      {
          $cmp1 = $idsucursal;
      ...
      $Conteudo = $idsucursal_input_2;
      if (strtoupper($idsucursal_cond) != "II" && strtoupper($idsucursal_cond) != "QP" && strtoupper($idsucursal_cond) != "NP" && strtoupper($idsucursal_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['idsucursal_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($sucursal != '') {
      $sucursal_look = substr($this->Db->qstr($sucursal), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['sucursal'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['sucursal'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['sucursal'] = $sucursal;
      }
      $nmgp_def_dados = array();
    if ($idtercero != '') {
      $idtercero_look = substr($this->Db->qstr($idtercero), 1, -1); 
   ...
   { 
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['idtercero'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          ...
          $this->cmp_formatado['idtercero'] = $cmp1;
      }
      else
      {
          $cmp1 = $idtercero;
      ...
      $Conteudo = $idtercero_input_2;
      if (strtoupper($idtercero_cond) != "II" && strtoupper($idtercero_cond) != "QP" && strtoupper($idtercero_cond) != "NP" && strtoupper($idtercero_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idtercero_input_2'] = $Conteudo;
      $nmgp_def_dados = array();
    if ($direccion != '') {
      $direccion_look = substr($this->Db->qstr($direccion), 1, -1); 
      $nmgp_def_dados = array(); 
      ...
      if (isset($idsucursal) || $idsucursal_cond == "nu" || $idsucursal_cond == "nn" || $idsucursal_cond == "ep" || $idsucursal_cond == "ne")
      {
         $this->monta_condicao("idsucursal", $idsucursal_cond, $idsucursal, $idsucursal_input_2, "idsucursal");
      }

      //----- $sucursal
      $this->Date_part = false;
      if (isset($sucursal) || $sucursal_cond == "nu" || $sucursal_cond == "nn" || $sucursal_cond == "ep" || $sucursal_cond == "ne")
      {
      ...
      //----- $idtercero
      $this->Date_part = false;
      if (isset($idtercero) || $idtercero_cond == "nu" || $idtercero_cond == "nn" || $idtercero_cond == "ep" || $idtercero_cond == "ne")
      {
         $this->monta_condicao("idtercero", $idtercero_cond, $idtercero, $idtercero_input_2, "idtercero");
      }
      ...
      {
         $this->monta_condicao("direccion", $direccion_cond, $direccion, "", "direccion");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_pesq_fast'] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['fast_search']);
      if ("" == $this->comando_filtro)
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_orig'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_sucursales']['where_pesq'];
