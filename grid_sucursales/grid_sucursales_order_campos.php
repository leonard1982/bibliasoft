...
<?php
   ...
   $Ord_Cmp = new grid_sucursales_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_sucursales_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_sucursales_json.php");
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['idsucursal'] = "on";
   $tab_def_campos['idsucursal'] = "idsucursal";
   $tab_labels["idsucursal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["idsucursal"])) ? $_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["idsucursal"] : "Idsucursal";
   $tab_ger_campos['sucursal'] = "on";
   $tab_def_campos['sucursal'] = "sucursal";
   $tab_labels["sucursal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["sucursal"])) ? $_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["sucursal"] : "Sucursal";
   $tab_ger_campos['idtercero'] = "on";
   $tab_def_campos['idtercero'] = "idtercero";
   $tab_labels["idtercero"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["idtercero"])) ? $_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["idtercero"] : "Idtercero";
   $tab_ger_campos['direccion'] = "on";
   $tab_def_campos['direccion'] = "direccion";
   $tab_labels["direccion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["direccion"])) ? $_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["direccion"] : "Direccion";
   $tab_ger_campos['departamento'] = "on";
   $tab_def_campos['departamento'] = "departamento";
   $tab_labels["departamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["departamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["departamento"] : "Departamento";
   $tab_ger_campos['municipio'] = "on";
   $tab_def_campos['municipio'] = "municipio";
   $tab_labels["municipio"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["municipio"])) ? $_SESSION['sc_session'][$sc_init]['grid_sucursales']['labels']["municipio"] : "Municipio";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_sucursales']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_sucursales']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> - sucursales</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_sucursales_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_sucursales']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
