...
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_srch_titl'] ?> - sucursales</TITLE>
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idsucursal_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idsucursal'])) ? $this->New_label['idsucursal'] : "Idsucursal"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idsucursal_cond" name="idsucursal_cond" onChange="nm_campos_between(document.getElementById('id_vis_idsucursal'), this, 'idsucursal')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idsucursal" <?php echo $str_hide_idsucursal?> valign="top">
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idsucursal" id="id_ac_idsucursal" name="idsucursal_autocomp"><?php if ('' !=  $idsucursal) { ?><option value="<?php echo $idsucursal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idsucursal"  <?php echo $str_display_idsucursal; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <INPUT type="text" id="SC_idsucursal_input_2" name="idsucursal_input_2" value="<?php echo NM_encode_input($idsucursal_input_2) ?>"  size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input sc-js-input scFilterObjectOdd">
     ...
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_sucursal_cond" name="sucursal_cond" onChange="nm_campos_between(document.getElementById('id_vis_sucursal'), this, 'sucursal')">
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-sucursal" id="id_ac_sucursal" name="sucursal_autocomp"><?php if ('' !=  $sucursal) { ?><option value="<?php echo $sucursal ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
      ...
      <TD id='SC_idtercero_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idtercero'])) ? $this->New_label['idtercero'] : "Idtercero"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idtercero_cond" name="idtercero_cond" onChange="nm_campos_between(document.getElementById('id_vis_idtercero'), this, 'idtercero')">
     ...
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idtercero" <?php echo $str_hide_idtercero?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-idtercero" id="id_ac_idtercero" name="idtercero_autocomp"><?php if ('' !=  $idtercero) { ?><option value="<?php echo $idtercero ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>        </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_idtercero"  <?php echo $str_display_idtercero; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
