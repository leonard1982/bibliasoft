  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_aplicaciones_permisos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_aplicaciones_permisos_form();
	}
...
?>
  ...
  // ---------- Validate usuario_
  function do_ajax_form_aplicaciones_permisos_validate_usuario_(iNumLinha)
  {
    var nomeCampo_usuario_ = "usuario_" + iNumLinha;
    var var_usuario_ = scAjaxGetFieldSelect(nomeCampo_usuario_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_permisos_validate_usuario_(var_usuario_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_permisos_validate_usuario__cb);
  } // do_ajax_form_aplicaciones_permisos_validate_usuario_

  function do_ajax_form_aplicaciones_permisos_validate_usuario__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_permisos_validate_usuario__cb

  // ---------- Validate item_menu_
  function do_ajax_form_aplicaciones_permisos_validate_item_menu_(iNumLinha)
  {
    var nomeCampo_item_menu_ = "item_menu_" + iNumLinha;
    var var_item_menu_ = scAjaxGetFieldSelect(nomeCampo_item_menu_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_permisos_validate_item_menu_(var_item_menu_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_permisos_validate_item_menu__cb);
  } // do_ajax_form_aplicaciones_permisos_validate_item_menu_

  function do_ajax_form_aplicaciones_permisos_validate_item_menu__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_permisos_validate_item_menu__cb

  // ---------- Validate idpermisos_
  function do_ajax_form_aplicaciones_permisos_validate_idpermisos_(iNumLinha)
  {
    var nomeCampo_idpermisos_ = "idpermisos_" + iNumLinha;
    var var_idpermisos_ = scAjaxGetFieldHidden(nomeCampo_idpermisos_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_permisos_validate_idpermisos_(var_idpermisos_, iNumLinha, var_script_case_init, do_ajax_form_aplicaciones_permisos_validate_idpermisos__cb);
  } // do_ajax_form_aplicaciones_permisos_validate_idpermisos_

  function do_ajax_form_aplicaciones_permisos_validate_idpermisos__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idpermisos_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpermisos_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idpermisos_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpermisos_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_aplicaciones_permisos_validate_idpermisos__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_aplicaciones_permisos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_aplicaciones_permisos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_aplicaciones_permisos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_aplicaciones_permisos_add_new_line_cb);
  } // do_ajax_form_aplicaciones_permisos_add_new_line

  function do_ajax_form_aplicaciones_permisos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_aplicaciones_permisos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_aplicaciones_permisos_backup_line(iNumLinha)
  {
    var var_idpermisos_ = scAjaxGetFieldHidden("idpermisos_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_aplicaciones_permisos_backup_line(var_idpermisos_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_aplicaciones_permisos_backup_line_cb);
  } // do_ajax_form_aplicaciones_permisos_backup_line

  function do_ajax_form_aplicaciones_permisos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_aplicaciones_permisos_backup_line_cb

  function do_ajax_form_aplicaciones_permisos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_aplicaciones_permisos_cancel_insert

  function do_ajax_form_aplicaciones_permisos_cancel_update(iSeqVert)
  {
    do_ajax_form_aplicaciones_permisos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_aplicaciones_permisos_cancel_update

  function do_ajax_form_aplicaciones_permisos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_aplicaciones_permisos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_aplicaciones_permisos_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_aplicaciones_permisos_table_refresh(var_idpermisos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aplicaciones_permisos_table_refresh_cb);
  } //  do_ajax_form_aplicaciones_permisos_table_refresh

  function do_ajax_form_aplicaciones_permisos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_aplicaciones_permisos_table_refresh_cb_after_alert);
  } // do_ajax_form_aplicaciones_permisos_table_refresh_cb
  function do_ajax_form_aplicaciones_permisos_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_aplicaciones_permisos_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_aplicaciones_permisos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_aplicaciones_permisos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_item_menu_ = scAjaxGetFieldSelect("item_menu_" + iNumLinha);
    var var_idpermisos_ = scAjaxGetFieldHidden("idpermisos_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_aplicaciones_permisos_submit_form(var_usuario_, var_item_menu_, var_idpermisos_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_aplicaciones_permisos_submit_form_cb);
  } // do_ajax_form_aplicaciones_permisos_submit_form

  function do_ajax_form_aplicaciones_permisos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("idpermisos_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_aplicaciones_permisos_submit_form_cb_after_alert);
  } // do_ajax_form_aplicaciones_permisos_submit_form_cb
  function do_ajax_form_aplicaciones_permisos_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_aplicaciones_permisos_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_aplicaciones_permisos_navigate_form()
  {
    perform_ajax_form_aplicaciones_permisos_navigate_form();
  }

  function perform_ajax_form_aplicaciones_permisos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_aplicaciones_permisos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("idpermisos_" + iNavForm);
    }
    var var_idpermisos_ = document.F2.idpermisos_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_aplicaciones_permisos_navigate_form(var_idpermisos_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_aplicaciones_permisos_navigate_form_cb);
  } // do_ajax_form_aplicaciones_permisos_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_aplicaciones_permisos']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_aplicaciones_permisos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_aplicaciones_permisos_navigate_form_cb_after_alert);
  } // do_ajax_form_aplicaciones_permisos_navigate_form_cb
  function do_ajax_form_aplicaciones_permisos_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_aplicaciones_permisos_navigate_form_cb_after_alert
  function sc_hide_form_aplicaciones_permisos_form()
  {
  ...
  function do_ajax_form_aplicaciones_permisos_lkpedt_refresh_usuario_(iSeq)
  {
    var var_usuario_ = scAjaxGetFieldSelect("usuario_");
    var var_script_case_init = document.F1.script_case_init.value;
    var nmgp_refresh_row = iSeq;
    var nmgp_refresh_fields = "usuario_";
    x_ajax_form_aplicaciones_permisos_lkpedt_refresh_usuario_(var_usuario_, nmgp_refresh_row, nmgp_refresh_fields, var_script_case_init, do_ajax_form_aplicaciones_permisos_lkpedt_refresh_usuario__cb);
  } // do_ajax_form_aplicaciones_permisos_lkpedt_refresh_usuario_

  function do_ajax_form_aplicaciones_permisos_lkpedt_refresh_usuario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    scAjaxSetFields(false);
    scAjaxSetVariables();
  } // do_ajax_form_aplicaciones_permisos_lkpedt_refresh_usuario__cb
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idpermisos_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["usuario_" + iNumLinha] = {"label": "Grupo Usuario<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["item_menu_" + iNumLinha] = {"label": "Item Menu<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idpermisos_" + iNumLinha] = {"label": "Idpermisos<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["usuario_"][iNumLinha] = "usuario_" + iNumLinha;
    ajax_field_mult["item_menu_"][iNumLinha] = "item_menu_" + iNumLinha;
    ajax_field_mult["idpermisos_"][iNumLinha] = "idpermisos_" + iNumLinha;
    ...
    ajax_error_count["idpermisos_" + iNumLinha] = "off";
<?php
...
?>
    ...
    ajax_read_only["idpermisos_" + iNumLinha] = "on";
<?php
}
else
{
...
?>
  ...
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["idpermisos_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["idpermisos_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpermisos_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpermisos_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpermisos_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpermisos_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpermisos_'])) ? $this->nmgp_cmp_readonly['idpermisos_'] : 'on';
?>
    scAjaxFieldRead("idpermisos_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }
  ...
  function mdCloseObjects(iSeq)
  {
    ...
    scAjaxFieldRead("idpermisos_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["usuario_" + iRow] || "on" == ajax_error_count["item_menu_" + iRow] || "on" == ajax_error_count["idpermisos_" + iRow]))
    {
      ...
      $("#hidden_field_data_idpermisos_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["usuario_" + iRow] && "off" == ajax_error_count["item_menu_" + iRow] && "off" == ajax_error_count["idpermisos_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["usuario_" + iRow] = "off";
        ajax_error_count["item_menu_" + iRow] = "off";
        ajax_error_count["idpermisos_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idpermisos_" + iRow).removeClass("scFormErrorLine");
    }
  }
