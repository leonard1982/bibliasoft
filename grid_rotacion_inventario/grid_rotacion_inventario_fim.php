...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_rotacion_inventario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv_2022_____grid_rotacion_inventario"]);
   }
   ...
   $fecha_janela = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['sc_outra_jan'])
   {
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_rotacion_inventario</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_rotacion_inventario']['embutida_filho'] as $ind => $sc_init)
          {
      ...
      {
          if ($nome_apl == 'grid_rotacion_inventario' || $achou)
          {
