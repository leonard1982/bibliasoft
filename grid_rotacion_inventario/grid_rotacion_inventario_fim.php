...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_rotacion_inventario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["FACILWEBv2_____grid_rotacion_inventario"]);
   }
