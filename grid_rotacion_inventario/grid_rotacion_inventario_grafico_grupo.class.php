...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_label_graf']['g_nomgrupo']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_label_graf']['g_nomgrupo']))
      {
         $this->label[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_label_graf']['g_nomgrupo'];
      }
   }
