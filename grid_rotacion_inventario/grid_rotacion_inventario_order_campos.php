...
<?php
   ...
   $Ord_Cmp = new grid_rotacion_inventario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_rotacion_inventario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select_orig'] = array();
   }
   $this->restore = isset($_POST['restore']) ? true : false;
   if ($this->restore && !class_exists('Services_JSON')) {
       include_once("grid_rotacion_inventario_json.php");
   }
   ...
   $tab_labels     = array();
   $tab_ger_campos['d_idpro'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['d_idpro'] = "d_idpro";
   }
   else
   {
       $tab_def_campos['d_idpro'] = "d.idpro";
   }
   $tab_labels["d_idpro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['labels']["d_idpro"])) ? $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['labels']["d_idpro"] : "Producto";
   ...
   $tab_labels["existencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['labels']["existencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['labels']["existencia"] : "Existencia";
   $tab_ger_campos['vendido'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['vendido'] = "vendido";
   }
   else
   {
       $tab_def_campos['vendido'] = "sum(d.cantidad)";
   }
   $tab_labels["vendido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['labels']["vendido"])) ? $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['labels']["vendido"] : "Vendido";
   $tab_ger_campos['rotacion'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['rotacion'] = "rotacion";
   }
   else
   {
       $tab_def_campos['rotacion'] = "(sum(d.cantidad)/p.stockmen)";
   }
   $tab_labels["rotacion"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['labels']["rotacion"])) ? $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['labels']["rotacion"] : "Rotacion";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_rotacion_inventario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_rotacion_inventario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
