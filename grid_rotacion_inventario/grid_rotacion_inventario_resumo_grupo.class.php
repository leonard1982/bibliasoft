...
class grid_rotacion_inventario_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $sum_existencia;
   var $sum_vendido;
   var $sc_proc_quebra_g_nomgrupo;
   var $count_g_nomgrupo;
   var $sum_g_nomgrupo_existencia;
   var $sum_g_nomgrupo_vendido;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_g_nomgrupo = array();
   ...
   function initializeButtons()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_rotacion_inventario'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['grid_rotacion_inventario'];
   ...
   { 
	...
	function generateChartImages() {
		...
		$this->Graf         = new grid_rotacion_inventario_grafico();
		$this->Graf->Db     = $this->Db;
		$this->Graf->Erro   = $this->Erro;
		$this->Graf->Ini    = $this->Ini;
		$this->Graf->Lookup = $this->Lookup;

		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_rotacion_inventario']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_rotacion_inventario']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
      ...
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_pesq_filtro'];
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['campos_busca']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['campos_busca']))
     { 
         $Busca_temp = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['campos_busca'];
       ...
       $this->g_nomgrupo = $Busca_temp['g_nomgrupo']; 
       $tmp_pos = strpos($this->g_nomgrupo, "##@@");
       if ($tmp_pos !== false && !is_array($this->g_nomgrupo))
       {
           $this->g_nomgrupo = substr($this->g_nomgrupo, 0, $tmp_pos);
       }
       $this->d_idpro = $Busca_temp['d_idpro']; 
       $tmp_pos = strpos($this->d_idpro, "##@@");
       if ($tmp_pos !== false && !is_array($this->d_idpro))
       {
           $this->d_idpro = substr($this->d_idpro, 0, $tmp_pos);
       }
       ...
       $this->rotacion = $Busca_temp['rotacion']; 
       $tmp_pos = strpos($this->rotacion, "##@@");
       if ($tmp_pos !== false && !is_array($this->rotacion))
       {
           $this->rotacion = substr($this->rotacion, 0, $tmp_pos);
       }
       $rotacion_2 = $Busca_temp['rotacion_input_2']; 
       $this->rotacion_2 = $Busca_temp['rotacion_input_2']; 
     } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "pdf")
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['res_hrz'];
      $dir_raiz          = strrpos($_SERVER['PHP_SELF'],"/") ;  
      $dir_raiz          = substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_total_geral'] == "OK")
      {
          $this->array_total_g_nomgrupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['g_nomgrupo'];
      }
      else
      {
          $this->array_total_g_nomgrupo = array();
          $this->totaliza_php_grupo();
      }
      $this->array_total_geral = array();
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'][3];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['json_use_label'])
       {
          $Lab_g_nomgrupo = "g.nomgrupo";
       }
       else
       {
       $Lab_g_nomgrupo = "Grupo/Familia";
       }
       $this->comp_field = array(
           $Lab_g_nomgrupo,
       );
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['g_nomgrupo'] = $Lab_g_nomgrupo; 

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['d_idpro']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['d_idpro'] = "Producto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['existencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['existencia'] = "Existencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['vendido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['vendido'] = "Vendido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['rotacion']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['rotacion'] = "Rotacion"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['g_nomgrupo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['g_nomgrupo'] = "Grupo/Familia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['f_fechaven']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['labels']['f_fechaven'] = "Fecha"; 
       }
       //-----
       $this->comp_field_nm = array(
           'g_nomgrupo' => 0,
       ...
       //-----
       $this->comp_sum = array(
           2 => "Vendido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
           3 => "Existencia(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_order']['grupo']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_order']['grupo'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_order']['grupo'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['grupo'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['grupo'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['grupo'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['grupo'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['grupo'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['grupo'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['summarizing_fields_display']['grupo'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "vendido", 'show' => true),
           3 => array('field' => "existencia", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_vendido_sum",
           3 => "css_existencia_sum",
       );
       ...
       //-----
       foreach ($this->array_total_g_nomgrupo as $i_g_nomgrupo => $d_g_nomgrupo) {
           if (!in_array($i_g_nomgrupo, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_g_nomgrupo[4] ] = $d_g_nomgrupo[3];
               $this->comp_label[0][ $d_g_nomgrupo[4] ] = $d_g_nomgrupo[3];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'g_nomgrupo', 'prot' => '@aspass@'),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_g_nomgrupo => $l_g_nomgrupo) {
           if (isset($this->array_total_g_nomgrupo[$i_g_nomgrupo])) {
               $this->comp_group[$i_g_nomgrupo] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_g_nomgrupo;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_rotacion_inventario@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function makeTabular(&$a_data)
   {
       ...
       {
           $a_labels = array();
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['proc_pdf_vert'])
   {
   ...
   function buildChart()
   {
       ...
       $this->comp_chart_config = array(
           '0|1' => array(
               'title'    => $this->getChartText(strip_tags("Vendido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'g.nomgrupo',
               'field_y'  => $this->comp_sum_nm[2],
               'label_x'  => $this->getChartText(strip_tags($Lab_g_nomgrupo)),
               'label_y'  => $this->getChartText(strip_tags("Vendido(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'format'   => $this->formatChartValue(1),
           ),
           '0|2' => array(
               'title'    => $this->getChartText(strip_tags("Existencia(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
               'show_sub' => true,
               'subtitle' => "",
               'field_x'  => 'g.nomgrupo',
               'field_y'  => $this->comp_sum_nm[3],
               'label_x'  => $this->getChartText(strip_tags($Lab_g_nomgrupo)),
               'label_y'  => $this->getChartText(strip_tags("Existencia(" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . ")")),
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_grid_rotacion_inventario_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_grid_rotacion_inventario_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
   ...
   function drawMatrixLabels()
   {
       ...
       $nm_saida->saida("    <script type=\"text/javascript\">\r\n");
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['embutida'])
       { 
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_rotacion_inventario']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css_bw']['grid_rotacion_inventario']) . "_";
               } 
           } 
           else 
           { 
               if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_rotacion_inventario']))
               {
                   $compl_css = str_replace(".", "_", $_SESSION['sc_session'][$this->Ini->sc_page]['SC_sub_css']['grid_rotacion_inventario']) . "_";
               } 
           }
       }
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "grid_rotacion_inventario_total.class.php"); 
      }
      $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['print_all'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['doc_word'] || $this->Ini->sc_export_ajax_img)
      { 
      ...
      if ($this->Print_All)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] = "print";
      ...
      $this->Total   = new grid_rotacion_inventario_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'] as $ind => $val)
      {
          if ($ind > 0)
          {
      ...
      $this->array_total_g_nomgrupo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['g_nomgrupo'];
      ksort($this->array_total_g_nomgrupo);
   }
...
if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['doc_word'])
{
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>Rotación de Inventario</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['doc_word'])
{
      ...
      { 
           ...
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_rotacion_inventario_ajax.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\">\r\n");
           ...
           $nm_saida->saida(" </script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_rotacion_inventario_jquery-3.6.0.min.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"grid_rotacion_inventario_message.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput.js\"></script>\r\n");
           $nm_saida->saida(" <script type=\"text/javascript\" src=\"../_lib/lib/js/jquery.scInput2.js\"></script>\r\n");
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_rotacion_inventario/grid_rotacion_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" href=\"" . $this->Ini->path_prod . "/third/jquery_plugin/thickbox/thickbox.css\" type=\"text/css\" media=\"screen\" />\r\n");
           $nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/buttons/" . $this->Ini->Str_btn_css . "\" /> \r\n");
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['num_css']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['num_css'] = rand(0, 1000);
      }
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_rotacion_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_rotacion_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_rotacion_inventario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['num_css'] . '.css');
...
$nm_saida->saida("      url: \"grid_rotacion_inventario_save_grid.php\",\r\n");
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['doc_word']) 
      {
      ...
      {
          $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['remove_margin'] ? 'margin: 0;' : '';
          $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['remove_border'] ? 'border-width: 0;' : '';
          $vertical_center = '';
          $nm_saida->saida(" <BODY id=\"grid_summary\" class=\"" . $this->css_scGridPage . "\" style=\"" . $remove_margin . $vertical_center . "\">\r\n");
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($this->nmgp_botoes['chart_conf'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bconf_graf", "", "", "Rgraf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_rotacion_inventario/grid_rotacion_inventario_config_graf_flash.php?nome_apl=grid_rotacion_inventario&campo_apl=nm_resumo_graf&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&tp_apl=cns_htm&KeepThis=true&TB_iframe=true&height=450&width=400&modal=true", "", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_rotacion_inventario/grid_rotacion_inventario_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_rotacion_inventario/grid_rotacion_inventario_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_rotacion_inventario_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_rotacion_inventario']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_rotacion_inventario']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_rotacion_inventario_config_pivot.php?nome_apl=grid_rotacion_inventario&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=es&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("                  action=\"grid_rotacion_inventario_iframe_prt.php\" \r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida("               document.Fdoc_word.action = \"grid_rotacion_inventario_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("               document.Fprint.action = \"grid_rotacion_inventario_export_ctrl.php\";\r\n");
      $nm_saida->saida("           }\r\n");
      $nm_saida->saida("           else\r\n");
      $nm_saida->saida("           {\r\n");
      ...
      $nm_saida->saida("               document.Fexport.action = \"grid_rotacion_inventario_export_ctrl.php\";\r\n");
      ...
      $nm_saida->saida("       document.F3.SC_module_export.value = z;\r\n");
      $nm_saida->saida("  }\r\n");
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['grid_rotacion_inventario_iframe_params'] = array(
      ...
      $Md5_pdf    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_rotacion_inventario@SC_par@" . md5($prep_parm_pdf);
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['Md5_pdf'][md5($prep_parm_pdf)] = $prep_parm_pdf;
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_rotacion_inventario_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_rotacion_inventario/grid_rotacion_inventario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       $this->Print_All = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['print_all'];
       if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pdf_res'])
       {
           $nm_saida->saida("<TR>\r\n");
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
 function grafico_pdf()
 {
   ...
   $this->Graf->Ini    = $this->Ini;
   $this->Graf->Lookup = $this->Lookup;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['skip_charts']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['skip_charts']))
   {
       ...
       $iChartCount = 1;
       $iChartTotal = sizeof($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts']);
 ...
 { 
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['pivot_charts'] as $chart_index => $chart_data)
       {
           if (!$prim_graf)
           {
 ...
 { 
           ...
           if ($this->progress_fp)
           {
               grid_rotacion_inventario_pdf_progress_call($this->progress_tot . "_#NM#_" . $this->progress_now . "_#NM#_" . $sChartLang . " " . $iChartCount . "...\n", $this->Ini->Nm_lang, true);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['this_chart_label'] = '';
       ...
       if ($bChartFP)
       {
           ...
           grid_rotacion_inventario_pdf_progress_call(100 . "_#NM#_" . 90 . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
           fwrite($this->progress_fp, 90 . "_#NM#_" . $lang_protect . "...\n");
           fclose($this->progress_fp);
       }
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['charts_html']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['charts_html'])
       {
            $nm_saida->saida("<script type=\"text/javascript\">\r\n");
            $nm_saida->saida("{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['charts_html']}\r\n");
            $nm_saida->saida("</script>\r\n");
       }
   }
       $nm_saida->saida("</body>\r\n");
...
//--- 
 ...
 {
   global $nm_saida, $nm_lang;
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['chart_list']))
   {
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['chart_list'] as $arr_chart)
       {
           $nm_saida->saida("<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>\r\n");
       $nm_saida->saida("<b><div style=\"height:1px;overflow:hidden\"><H1 style=\"font-size:0;padding:1px\">" . $this->Ini->Nm_lang['lang_btns_chrt_pdff_hint'] . "</H1></div></b>\r\n");
           $nm_saida->saida("<table><tr><td>\r\n");
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $g_nomgrupo = $Busca_temp['g_nomgrupo']; 
          $tmp_pos = strpos($g_nomgrupo, "##@@");
          if ($tmp_pos !== false && !is_array($g_nomgrupo))
          {
              $g_nomgrupo = substr($g_nomgrupo, 0, $tmp_pos);
          }
          $d_idpro = $Busca_temp['d_idpro']; 
          $tmp_pos = strpos($d_idpro, "##@@");
          if ($tmp_pos !== false && !is_array($d_idpro))
          {
              $d_idpro = substr($d_idpro, 0, $tmp_pos);
          }
          $existencia = $Busca_temp['existencia']; 
          $tmp_pos = strpos($existencia, "##@@");
          if ($tmp_pos !== false && !is_array($existencia))
          {
              $existencia = substr($existencia, 0, $tmp_pos);
          }
          $existencia_2 = $Busca_temp['existencia_input_2']; 
          $vendido = $Busca_temp['vendido']; 
          $tmp_pos = strpos($vendido, "##@@");
          if ($tmp_pos !== false && !is_array($vendido))
          {
              $vendido = substr($vendido, 0, $tmp_pos);
          }
          $vendido_2 = $Busca_temp['vendido_input_2']; 
          $rotacion = $Busca_temp['rotacion']; 
          $tmp_pos = strpos($rotacion, "##@@");
          if ($tmp_pos !== false && !is_array($rotacion))
          {
              $rotacion = substr($rotacion, 0, $tmp_pos);
          }
          $rotacion_2 = $Busca_temp['rotacion_input_2']; 
      } 
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['cond_pesq']))
      {  
          $pos       = 0;
          $trab_pos  = false;
          $pos_tmp   = true; 
          $tmp       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['cond_pesq'];
          while ($pos_tmp)
          {
             $pos = strpos($tmp, "##*@@", $pos);
             if ($pos !== false)
          ...
          $nm_cond_filtro_or  = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['cond_pesq'], $trab_pos + 5) == "or")  ? " " . trim($this->Ini->Nm_lang['lang_srch_orr_cond']) . " " : "";
          $nm_cond_filtro_and = (substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['cond_pesq'], $trab_pos + 5) == "and") ? " " . trim($this->Ini->Nm_lang['lang_srch_and_cond']) . " " : "";
          $nm_cab_filtro   = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['cond_pesq'], 0, $trab_pos);
     ...
     {
         $this->Ini->Img_export_zip[] = $this->Ini->root . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__box_next_32.png";
         $img_LIN1_COL3 = "scriptcase__NM__ico__NM__box_next_32.png";
     }
     elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['doc_word'] || $this->Ini->sc_export_ajax_img)
     {
         $loc_img_word = $this->Ini->root . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__box_next_32.png";
     ...
     {
         $img_LIN1_COL3 = $this->NM_raiz_img . $this->Ini->path_imag_cab . "/scriptcase__NM__ico__NM__box_next_32.png";
     }
      ...
      $nm_saida->saida("          Rotación de Inventario\r\n");
      $nm_saida->saida("        </TD>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_existencia, $sum_vendido, $quebra_g_nomgrupo, $quebra_g_nomgrupo_orig)
   {
      //----- Grupo/Familia
      if (!isset($this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig]))
      {
         $this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig][0] = 1;
         $this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig][1] = $sum_existencia;
         $this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig][2] = $sum_vendido;
         $this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig][3] = $quebra_g_nomgrupo;
         $this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig][4] = $quebra_g_nomgrupo_orig;
      }
      else
      {
         $this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig][0]++;
         $this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig][1] += $sum_existencia;
         $this->array_total_g_nomgrupo[$quebra_g_nomgrupo_orig][2] += $sum_vendido;
      }
      //----- Total
      if (empty($this->array_total_geral))
      {
         ...
         $this->array_total_geral[1] = $sum_existencia;
         $this->array_total_geral[2] = $sum_vendido;
      }
      else
      {
   ...
   {
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['g_nomgrupo'] as $campo_g_nomgrupo => $dados_g_nomgrupo)
      {
         $this->array_total_g_nomgrupo[$campo_g_nomgrupo][2] = $dados_g_nomgrupo[1];
         $this->array_total_g_nomgrupo[$campo_g_nomgrupo][1] = $dados_g_nomgrupo[2];
      }
   }
   //---- 
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
         $nmgp_select = "SELECT d.idpro as d_idpro, p.stockmen as existencia, sum(d.cantidad) as vendido, (sum(d.cantidad)/p.stockmen) as rotacion, g.nomgrupo as g_nomgrupo, str_replace (convert(char(10),f.fechaven,102), '.', '-') + ' ' + convert(char(8),f.fechaven,20) as f_fechaven from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
     { 
         $nmgp_select = "SELECT d.idpro as d_idpro, p.stockmen as existencia, sum(d.cantidad) as vendido, (sum(d.cantidad)/p.stockmen) as rotacion, g.nomgrupo as g_nomgrupo, f.fechaven as f_fechaven from " . $this->Ini->nm_tabela; 
     } 
     elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
     { 
         $nmgp_select = "SELECT d.idpro as d_idpro, p.stockmen as existencia, sum(d.cantidad) as vendido, (sum(d.cantidad)/p.stockmen) as rotacion, g.nomgrupo as g_nomgrupo, convert(char(23),f.fechaven,121) as f_fechaven from " . $this->Ini->nm_tabela; 
     } 
     else 
     { 
         $nmgp_select = "SELECT d.idpro as d_idpro, p.stockmen as existencia, sum(d.cantidad) as vendido, (sum(d.cantidad)/p.stockmen) as rotacion, g.nomgrupo as g_nomgrupo, f.fechaven as f_fechaven from " . $this->Ini->nm_tabela; 
     } 
     $nmgp_select .= " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_pesq']; 
     $nmgp_select .= " group by d.idpro"; 
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'g_nomgrupo');
     $campos_order = $this->Ini->Get_date_order_groupby("g.nomgrupo", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->d_idpro = $rs_res->fields[0] ;  
            $this->existencia = $rs_res->fields[1] ;  
            $this->vendido = $rs_res->fields[2] ;  
            $this->rotacion = $rs_res->fields[3] ;  
            $this->g_nomgrupo = $rs_res->fields[4] ;  
            $this->f_fechaven = $rs_res->fields[5] ;  
            $this->look_d_idpro = $this->d_idpro; 
            $this->Lookup->lookup_d_idpro($this->look_d_idpro, $this->d_idpro) ; 
            $this->g_nomgrupo_orig = $this->g_nomgrupo;
            $this->d_idpro = $this->look_d_idpro ;
            nmgp_Form_Num_Val($this->vendido, "", "", "0", "", "", "", "N:", "") ; 
            nmgp_Form_Num_Val($this->existencia, "", "", "0", "", "", "", "N:", "") ; 
            nmgp_Form_Num_Val($this->rotacion, "", "", "0", "", "", "", "N:", "") ; 
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->existencia, $this->vendido, $this->g_nomgrupo, $this->g_nomgrupo_orig);
            }
   }
//
   ...
   function totaliza_php_grupo()
   {
      $this->sc_proc_grid = true;
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['where_pesq_filtro'];
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_total_geral'] == "OK")
      {
          return;
      }
      //----- 
      ...
      { 
         $nmgp_select = "SELECT d.idpro as d_idpro, p.stockmen as existencia, sum(d.cantidad) as vendido, (sum(d.cantidad)/p.stockmen) as rotacion, g.nomgrupo as g_nomgrupo, EXTEND(f.fechaven, YEAR TO DAY) as f_fechaven from " . $this->Ini->nm_tabela; 
      } 
      else 
      { 
         $nmgp_select = "SELECT d.idpro as d_idpro, p.stockmen as existencia, sum(d.cantidad) as vendido, (sum(d.cantidad)/p.stockmen) as rotacion, g.nomgrupo as g_nomgrupo, f.fechaven as f_fechaven from " . $this->Ini->nm_tabela; 
   ...
   $nmgp_order_by = ""; 
   $campos_order_select = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['ordem_select'] as $campo => $ordem) 
   {
        if ($campo != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['ordem_grid']) 
        {
   ...
   $campos_order = "";
   foreach($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['ordem_quebra'] as $campo => $resto) 
   {
       foreach($resto as $sqldef => $ordem) 
       {
           $format       = $this->Ini->Get_Gb_date_format($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Ind_Groupby'], $campo);
           $campos_order = $this->Ini->Get_date_order_groupby($sqldef, $ordem, $format, $campos_order);
       }
   }
   if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['ordem_grid'])) 
   { 
       if (!empty($campos_order)) 
       { 
           $campos_order .= ", ";
       } 
       $nmgp_order_by = " order by " . $campos_order . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['ordem_grid'] . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['ordem_desc']; 
   } 
   ...
   $nmgp_select .= $nmgp_order_by; 
   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['order_grid'] = $nmgp_order_by;
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nmgp_select; 
      ...
      {
         $this->d_idpro = $this->rs_grid->fields[0] ;  
         $this->d_idpro = (string)$this->d_idpro;  
         $this->existencia = $this->rs_grid->fields[1] ;  
         ...
         $this->vendido = $this->rs_grid->fields[2] ;  
         $this->vendido = (strpos(strtolower($this->vendido), "e")) ? (float)$this->vendido : $this->vendido; 
         $this->vendido = (string)$this->vendido;  
         $this->rotacion = $this->rs_grid->fields[3] ;  
         $this->rotacion = (strpos(strtolower($this->rotacion), "e")) ? (float)$this->rotacion : $this->rotacion; 
         $this->rotacion = (string)$this->rotacion;  
         $this->g_nomgrupo = $this->rs_grid->fields[4] ;  
         $this->f_fechaven = $this->rs_grid->fields[5] ;  
         if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_orig']))
         {
             foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_orig'] as $Cmp_clone => $Cmp_orig)
             {
                 $this->$Cmp_clone = $this->$Cmp_orig;
             }
         }
         $g_nomgrupo_orig = $this->g_nomgrupo;
         $f_fechaven_orig = $this->f_fechaven;
         $d_idpro_orig = $this->d_idpro;
         $vendido_orig = $this->vendido;
         $existencia_orig = $this->existencia;
         $rotacion_orig = $this->rotacion;
         $this->arg_sum_d_idpro = " = " . $this->d_idpro;
         $this->arg_sum_existencia = " = " . $this->existencia;
         $this->arg_sum_rotacion = " = " . $this->rotacion;
         $this->arg_sum_g_nomgrupo = " = " . $this->Db->qstr($this->g_nomgrupo);
         $this->arg_sum_f_fechaven = " = " . $this->Db->qstr($this->f_fechaven);
         $this->GB_d_idpro = $this->d_idpro;
         $this->Lookup->lookup_d_idpro($this->GB_d_idpro, $this->d_idpro) ; 
         $this->GB_d_idpro = $this->d_idpro;
         nmgp_Form_Num_Val($this->GB_d_idpro, "", "", "0", "", "", "", "N:", "") ; 
         $this->GB_existencia = $this->existencia;
         nmgp_Form_Num_Val($this->GB_existencia, "", "", "0", "", "", "", "N:", "") ; 
         $this->GB_rotacion = $this->rotacion;
         nmgp_Form_Num_Val($this->GB_rotacion, "", "", "0", "", "", "", "N:", "") ; 
         $conteudo_x =  $this->f_fechaven;
         nm_conv_limpa_dado($conteudo_x, "YYYY-MM-DD");
         if (is_numeric($conteudo_x) && strlen($conteudo_x) > 0) 
         { 
             $this->nm_data->SetaData($this->f_fechaven, "YYYY-MM-DD  ");
             $this->f_fechaven = $this->nm_data->FormataSaida("ddmmaaaa");
         } 
         $this->adiciona_registro(NM_encode_input(sc_strip_script($this->existencia)), NM_encode_input(sc_strip_script($this->vendido)), sc_strip_script($this->g_nomgrupo), sc_strip_script($g_nomgrupo_orig));
         $this->rs_grid->MoveNext();
      }
      $this->finaliza_arrays();
      $this->rs_grid->Close();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'][2] = $this->array_total_geral[1];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'][3] = $this->array_total_geral[2];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_array_resumo'] = "OK";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . "";
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['tot_geral'][1] = $this->array_total_geral[0];
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['contr_total_geral'] = "OK";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Ind_Groupby'] == "grupo")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['arr_total']['g_nomgrupo'] = $this->array_total_g_nomgrupo;
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_rotacion_inventario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              eval ('$_SESSION["sc_session"][' . $this->Ini->sc_page . ']["grid_rotacion_inventario"]["arr_total"]["' . $cmp_gb . '"] = $this->array_total_' .  $cmp_gb . ';');
          }
      }
   }
